...
N_NIMCALL(void, TMP2987)(void* p, NI op);
...
STRING_LITERAL(TMP2980, "0 <= elem ", 10);
...
N_NIMCALL(NIM_BOOL, bitsetin_213055)(tbitset213008* x, NI64 e) {
	...
	nimln(34, "bitsets.nim");
	nimln(34, "bitsets.nim");
	TMP2978 = divInt64(e, 8);
	if ((NU)((NI64)(TMP2978)) >= (NU)(x->Sup.len)) raiseIndexError();
	nimln(34, "bitsets.nim");
	nimln(34, "bitsets.nim");
	nimln(34, "bitsets.nim");
	TMP2979 = modInt64(e, 8);
	result = !(((NI8)(x->data[(NI64)(TMP2978)] & ((NI8)(NU8)(NU)((NI)((NU32)(1) << (NU32)(((NI) ((NI64)(TMP2979)))))))) == ((NI8) 0)));
	popFrame();
	return result;
}
...
N_NIMCALL(void, bitsetincl_213043)(tbitset213008** x, NI64 elem) {
	...
	nimln(38, "bitsets.nim");
	{
		...
		if (!!((0 <= elem))) goto LA3;
		nimln(38, "bitsets.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP2980));
	}
	LA3: ;
	...
	(*x)->data[(NI64)(TMP2981)] = (NI8)((*x)->data[(NI64)(TMP2982)] | ((NI8)(NU8)(NU)((NI)((NU32)(1) << (NU32)(((NI) ((NI64)(TMP2983))))))));
	popFrame();
}
...
N_NIMCALL(void, bitsetexcl_213049)(tbitset213008** x, NI64 elem) {
	...
	(*x)->data[(NI64)(TMP2984)] = (NI8)((*x)->data[(NI64)(TMP2985)] & (NI8)((NU8) ~(((NI8)(NU8)(NU)((NI)((NU32)(1) << (NU32)(((NI) ((NI64)(TMP2986))))))))));
	popFrame();
}
N_NIMCALL(void, TMP2987)(void* p, NI op) {
	tbitset213008* a;
