...
static NIM_CONST TY104134 TMP6796 = {
0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY104134 TMP6797 = {
...
N_NIMCALL(void, initoptparser_416618)(NimStringDesc* cmdline, toptparser416606* Result) {
	...
	LA3: ;
	{
		...
		unsureAsgnRef((void**) &(*Result).Cmd, copyString(((NimStringDesc*) &TMP6792)));
		i_416630 = 0;
		HEX3Atmp_416632 = 0;
...
appendChar(LOC7, 32);
	...
	unsureAsgnRef((void**) &(*Result).Key, copyString(((NimStringDesc*) &TMP6795)));
	nimln(54, "parseopt.nim");
	unsureAsgnRef((void**) &(*Result).Val, copyString(((NimStringDesc*) &TMP6795)));
	popFrame();
}
...
N_NIMCALL(void, handleshortoption_416882)(toptparser416606* p) {
	...
	nimln(79, "parseopt.nim");
	{
		...
		i = parseword_416802((*p).Cmd, i, &(*p).Val, TMP6796);
	}
	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser416606* p) {
	...
	case 45:
	{
		...
		nimln(104, "parseopt.nim");
		{
			...
			i = parseword_416802((*p).Cmd, i, &(*p).Key, TMP6797);
			...
			nimln(109, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_416802((*p).Cmd, i, &(*p).Val, TMP6796);
			}
			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_416802((*p).Cmd, i, &(*p).Key, TMP6796);
	}
	break;
	}
	BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser416606* p) {
	...
	nimln(125, "parseopt.nim");
	nimln(125, "parseopt.nim");
	TMP6798 = subInt((*p).Cmd->Sup.len, 1);
	LOC1 = 0;
	LOC1 = copyStrLast((*p).Cmd, (*p).Pos, (NI32)(TMP6798));
...
static TNimNode* TMP6800[6];
static TNimNode* TMP6801[4];
NI TMP6803;
static char* NIM_CONST TMP6802[4] = {
"cmdEnd", 
"cmdArgument", 
"cmdLongoption", 
"cmdShortOption"};
static TNimNode TMP6790[12];
...
TMP6800[0] = &TMP6790[1];
TMP6790[1].kind = 1;
TMP6790[1].offset = offsetof(toptparser416606, Cmd);
TMP6790[1].typ = (&NTI143);
TMP6790[1].name = "cmd";
TMP6800[1] = &TMP6790[2];
TMP6790[2].kind = 1;
TMP6790[2].offset = offsetof(toptparser416606, Pos);
TMP6790[2].typ = (&NTI105);
TMP6790[2].name = "pos";
TMP6800[2] = &TMP6790[3];
TMP6790[3].kind = 1;
TMP6790[3].offset = offsetof(toptparser416606, Inshortstate);
TMP6790[3].typ = (&NTI132);
TMP6790[3].name = "inShortState";
TMP6800[3] = &TMP6790[4];
NTI416604.size = sizeof(NU8);
NTI416604.kind = 14;
NTI416604.base = 0;
NTI416604.flags = 3;
for (TMP6803 = 0; TMP6803 < 4; TMP6803++) {
TMP6790[TMP6803+5].kind = 1;
TMP6790[TMP6803+5].offset = TMP6803;
TMP6790[TMP6803+5].name = TMP6802[TMP6803];
TMP6801[TMP6803] = &TMP6790[TMP6803+5];
}
TMP6790[9].len = 4; TMP6790[9].kind = 2; TMP6790[9].sons = &TMP6801[0];
NTI416604.node = &TMP6790[9];
TMP6790[4].kind = 1;
TMP6790[4].offset = offsetof(toptparser416606, Kind);
TMP6790[4].typ = (&NTI416604);
TMP6790[4].name = "kind";
TMP6800[4] = &TMP6790[10];
TMP6790[10].kind = 1;
TMP6790[10].offset = offsetof(toptparser416606, Key);
TMP6790[10].typ = (&NTI143);
TMP6790[10].name = "key";
TMP6800[5] = &TMP6790[11];
TMP6790[11].kind = 1;
TMP6790[11].offset = offsetof(toptparser416606, Val);
TMP6790[11].typ = (&NTI143);
TMP6790[11].name = "val";
TMP6790[0].len = 6; TMP6790[0].kind = 2; TMP6790[0].sons = &TMP6800[0];
NTI416606.node = &TMP6790[0];
}
