...
N_NIMCALL(void, TMP3788)(void* p, NI op);
...
43}
;
STRING_LITERAL(TMP3791, "\012", 1);
STRING_LITERAL(TMP3793, "", 0);
STRING_LITERAL(TMP3795, "\012\012", 2);
STRING_LITERAL(TMP3797, "* ", 2);
STRING_LITERAL(TMP3798, "(#) ", 4);
STRING_LITERAL(TMP3799, "  ", 2);
STRING_LITERAL(TMP3803, "| ", 2);
STRING_LITERAL(TMP3804, "`", 1);
STRING_LITERAL(TMP3805, "`_", 2);
STRING_LITERAL(TMP3806, " <", 2);
STRING_LITERAL(TMP3807, ">`_", 3);
STRING_LITERAL(TMP3808, "`:", 2);
STRING_LITERAL(TMP3809, "`:sub:", 6);
STRING_LITERAL(TMP3810, "`:sup:", 6);
STRING_LITERAL(TMP3811, "`:idx:", 6);
STRING_LITERAL(TMP3812, "*", 1);
STRING_LITERAL(TMP3813, "**", 2);
STRING_LITERAL(TMP3814, "***", 3);
STRING_LITERAL(TMP3815, "``", 2);
STRING_LITERAL(TMP3816, "\\", 1);
STRING_LITERAL(TMP3817, "\\\\", 2);
STRING_LITERAL(TMP3818, ".. index::\012", 11);
STRING_LITERAL(TMP3819, ".. contents::", 13);
STRING_LITERAL(TMP3820, "Error: cannot render: ", 22);
...
N_NIMCALL(trstnode271016*, lastson_271148)(trstnode271016* n) {
	...
	nimln(87, "rstast.nim");
	nimln(87, "rstast.nim");
	TMP3789 = subInt((*n).Sons->Sup.len, 1);
	if ((NU)((NI32)(TMP3789)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP3789)];
	popFrame();
	return result;
}
...
N_NIMCALL(void, renderrstsons_271214)(trendercontext271202* d, trstnode271016* n, NimStringDesc** result) {
	...
	nimln(104, "rstast.nim");
	LOC1 = len_271087(n);
	TMP3790 = subInt(LOC1, 1);
	HEX3Atmp_271230 = (NI32)(TMP3790);
...
appendString((*result), ind);
		...
		nimln(123, "rstast.nim");
		nimln(123, "rstast.nim");
		TMP3792 = subInt((*result)->Sup.len, oldlen);
		headlinelen = (NI32)(TMP3792);
...
appendString((*result), ind);
		...
		headline = copyString(((NimStringDesc*) &TMP3793));
		nimln(133, "rstast.nim");
		renderrstsons_271214(d, n, &headline);
		nimln(135, "rstast.nim");
		nimln(135, "rstast.nim");
		nimln(135, "rstast.nim");
		TMP3794 = subInt(headline->Sup.len, (*d).Indent);
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI32)(TMP3794), lvltochar_271244[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		nimln(146, "rstast.nim");
		nimln(146, "rstast.nim");
		TMP3796 = subInt(78, (*d).Indent);
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI32)(TMP3796), 45);
...
appendString((*result), ind);
	...
	case ((NU8) 6):
	{
		...
		tmp = copyString(((NimStringDesc*) &TMP3793));
...
appendString((*result), ((NimStringDesc*) &TMP3799));
	...
	case ((NU8) 14):
	{
		...
		nimln(191, "rstast.nim");
		nimln(191, "rstast.nim");
		TMP3800 = addInt(tmp->Sup.len, 3);
		l = (((NI32)(TMP3800) >= 30) ? (NI32)(TMP3800) : 30);
...
appendString((*result), tmp);
		...
		nimln(199, "rstast.nim");
		nimln(199, "rstast.nim");
		TMP3801 = subInt(l, tmp->Sup.len);
		TMP3802 = subInt((NI32)(TMP3801), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI32)(TMP3802), 32);
...
appendString((*result), (*n).Text);
	...
	case ((NU8) 64):
	{
		nimln(265, "rstast.nim");
		{
			...
			if (!(LOC48)) goto LA49;
			nimln(265, "rstast.nim");
			LOC48 = eqStrings((*n).Text, ((NimStringDesc*) &TMP3816));
			LA49: ;
			if (!LOC48) goto LA50;
...
appendString((*result), ((NimStringDesc*) &TMP3819));
	}
	break;
	default:
	{
...
appendString(LOC60, ((NimStringDesc*) &TMP3820));
...
static TNimNode* TMP3783[4];
static TNimNode* TMP3784[65];
NI TMP3786;
static char* NIM_CONST TMP3785[65] = {
"rnInner", 
"rnHeadline", 
"rnOverline", 
"rnTransition", 
...
NTI271010.base = 0;
NTI271010.flags = 3;
for (TMP3786 = 0; TMP3786 < 65; TMP3786++) {
TMP3781[TMP3786+2].kind = 1;
TMP3781[TMP3786+2].offset = TMP3786;
TMP3781[TMP3786+2].name = TMP3785[TMP3786];
TMP3784[TMP3786] = &TMP3781[TMP3786+2];
}
TMP3781[67].len = 65; TMP3781[67].kind = 2; TMP3781[67].sons = &TMP3784[0];
NTI271010.node = &TMP3781[67];
TMP3781[1].kind = 1;
TMP3781[1].offset = offsetof(trstnode271016, Kind);
TMP3781[1].typ = (&NTI271010);
TMP3781[1].name = "kind";
TMP3783[1] = &TMP3781[68];
TMP3781[68].kind = 1;
TMP3781[68].offset = offsetof(trstnode271016, Text);
TMP3781[68].typ = (&NTI143);
TMP3781[68].name = "text";
TMP3783[2] = &TMP3781[69];
TMP3781[69].kind = 1;
TMP3781[69].offset = offsetof(trstnode271016, Level);
TMP3781[69].typ = (&NTI105);
TMP3781[69].name = "level";
TMP3783[3] = &TMP3781[70];
TMP3781[70].kind = 1;
TMP3781[70].offset = offsetof(trstnode271016, Sons);
TMP3781[70].typ = (&NTI271092);
TMP3781[70].name = "sons";
TMP3781[0].len = 4; TMP3781[0].kind = 2; TMP3781[0].sons = &TMP3783[0];
NTI271016.node = &TMP3781[0];
NTI271012.size = sizeof(trstnode271016*);
NTI271012.kind = 22;
NTI271012.base = (&NTI271016);
NTI271012.flags = 2;
NTI271012.marker = TMP3788;
}
