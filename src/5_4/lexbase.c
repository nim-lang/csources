...
N_NIMCALL(void, fillbuffer_382070)(tbaselexer382014* l) {
	...
	nimln(80, "lexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI32)(TMP6599)])), (NI32)(TMP6600));
	}
	LA11: ;
	...
	TMP6602 = mulInt((NI32)(TMP6601), 1);
	LOC13 = readdata_133730((*l).Input, ((void*) (&(*l).Buf[tocopy])), (NI32)(TMP6602));
	TMP6603 = divInt(LOC13, 1);
	charsread = (NI32)(TMP6603);
	...
	nimln(86, "lexbase.nim");
	{
		...
		if (!(charsread < (NI32)(TMP6605))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI32)(TMP6607);
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				TMP6608 = mulInt((*l).Buflen, 1);
				LOC32 = realloc_4007(((void*) ((*l).Buf)), (NI32)(TMP6608));
				...
				nimln(105, "lexbase.nim");
				{
					...
					if (!!(((NI32)(TMP6609) == oldbuflen))) goto LA35;
					nimln(105, "lexbase.nim");
				...
				LOC37 = readdata_133730((*l).Input, ((void*) (&(*l).Buf[oldbuflen])), (NI32)(TMP6611));
				TMP6612 = divInt(LOC37, 1);
				charsread = (NI32)(TMP6612);
...
N_NIMCALL(void, open_382024)(tbaselexer382014* l, tstream133630* input, NI buflen) {
	...
	LOC9 = alloc_4001((NI32)(TMP6622));
	(*l).Buf = ((NCSTRING) (LOC9));
	nimln(148, "lexbase.nim");
	nimln(148, "lexbase.nim");
	TMP6623 = subInt(buflen, 1);
	(*l).Sentinel = (NI32)(TMP6623);
...
N_NIMCALL(NI, getcolnumber_382043)(tbaselexer382014* l, NI pos) {
	...
	if ((NI32)(TMP6624) == (-2147483647 -1)) raiseOverflow();
	result = (NI32)abs((NI32)(TMP6624));
	popFrame();
	return result;
}
