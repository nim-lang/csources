...
N_NIMCALL(NI32, strcrc32_124025)(NimStringDesc* s) {
	...
	HEX3Atmp_124860 = (NI32)(TMP438);
	nimln(1274, "system.nim");
	res_124862 = 0;
	nimln(1275, "system.nim");
	while (1) {
		nimln(1275, "system.nim");
		if (!(res_124862 <= HEX3Atmp_124860)) goto LA1;
		nimln(1274, "system.nim");
		i_124859 = res_124862;
		nimln(86, "crc.nim");
		if ((NU)(i_124859) > (NU)(s->Sup.len)) raiseIndexError();
		result = updatecrc32_124015(s->data[i_124859], result);
		nimln(1277, "system.nim");
		res_124862 = addInt(res_124862, 1);
	} LA1: ;
	popFrame();
	return result;
}
...
N_NIMCALL(NI32, HEX3EHEX3C_124867)(NI32 c, NimStringDesc* s) {
	...
	HEX3Atmp_124880 = (NI32)(TMP439);
	nimln(1281, "system.nim");
	res_124882 = 0;
	nimln(1282, "system.nim");
	while (1) {
		nimln(1282, "system.nim");
		if (!(res_124882 <= HEX3Atmp_124880)) goto LA1;
		nimln(1281, "system.nim");
		i_124879 = res_124882;
		nimln(90, "crc.nim");
		if ((NU)(i_124879) > (NU)(s->Sup.len)) raiseIndexError();
		result = updatecrc32_124015(s->data[i_124879], result);
		nimln(1284, "system.nim");
		res_124882 = addInt(res_124882, 1);
	} LA1: ;
	popFrame();
	return result;
}
...
N_NIMCALL(NI32, crcfrombuf_124020)(void* buf, NI length) {
	...
	HEX3Atmp_124911 = (NI32)(TMP440);
	nimln(1274, "system.nim");
	res_124913 = 0;
	nimln(1275, "system.nim");
	while (1) {
		nimln(1275, "system.nim");
		if (!(res_124913 <= HEX3Atmp_124911)) goto LA1;
		nimln(1274, "system.nim");
		i_124909 = res_124913;
		nimln(99, "crc.nim");
		if ((NU)(i_124909) > (NU)(10000000)) raiseIndexError();
		result = updatecrc32_124010(p[(i_124909)- 0], result);
		nimln(1277, "system.nim");
		res_124913 = addInt(res_124913, 1);
	} LA1: ;
	popFrame();
	return result;
}
...
N_NIMCALL(NI32, crcfromfile_124029)(NimStringDesc* filename) {
	...
	while (1) {
		...
		HEX3Atmp_124941 = (NI32)(TMP441);
		nimln(1274, "system.nim");
		res_124943 = 0;
		nimln(1275, "system.nim");
		while (1) {
			nimln(1275, "system.nim");
			if (!(res_124943 <= HEX3Atmp_124941)) goto LA7;
			nimln(1274, "system.nim");
			i_124938 = res_124943;
			nimln(113, "crc.nim");
			if ((NU)(i_124938) > (NU)(10000000)) raiseIndexError();
			result = updatecrc32_124010(p[(i_124938)- 0], result);
			nimln(1277, "system.nim");
			res_124943 = addInt(res_124943, 1);
		} LA7: ;
		nimln(114, "crc.nim");
		{
