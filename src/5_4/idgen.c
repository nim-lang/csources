...
STRING_LITERAL(TMP1886, "nimrod.gid", 10);
...
static N_INLINE(void, setid_168436)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP1881 = addInt(id, 1);
	gfrontendid_168005 = ((gfrontendid_168005 >= (NI32)(TMP1881)) ? gfrontendid_168005 : (NI32)(TMP1881));
	popFrame();
}
...
N_NIMCALL(void, idsynchronizationpoint_168445)(NI idrange) {
	...
	nimln(41, "idgen.nim");
	nimln(41, "idgen.nim");
	TMP1882 = divInt(gfrontendid_168005, idrange);
	TMP1883 = addInt((NI32)(TMP1882), 1);
	TMP1884 = mulInt((NI32)(TMP1883), idrange);
	TMP1885 = addInt((NI32)(TMP1884), 1);
	gfrontendid_168005 = (NI32)(TMP1885);
	popFrame();
}
...
N_NIMCALL(NimStringDesc*, togid_168450)(NimStringDesc* f) {
	...
	result = 0;
	nimln(47, "idgen.nim");
	result = completegeneratedfilepath_105438(((NimStringDesc*) &TMP1886), NIM_TRUE);
	popFrame();
	return result;
}
