...
STRING_LITERAL(TMP6799, "", 0);
STRING_LITERAL(TMP6806, "server.type", 11);
STRING_LITERAL(TMP6807, "stdin", 5);
STRING_LITERAL(TMP6808, "tcp", 3);
STRING_LITERAL(TMP6809, "quit", 4);
STRING_LITERAL(TMP6814, "server.port", 11);
STRING_LITERAL(TMP6815, "server.address", 14);
STRING_LITERAL(TMP6840, "\015\012", 2);
STRING_LITERAL(TMP6841, "Invalid server.type:", 20);
	...
	while (1) {
		...
		case ((NU8) 3):
		{
			...
			nimln(41, "service.nim");
			{
				...
				nimln(42, "service.nim");
				nimln(42, "service.nim");
				TMP6804 = subInt(bracketle, 1);
				key = copyStrLast(p.Key, 0, (NI32)(TMP6804));
				nimln(43, "service.nim");
				nimln(43, "service.nim");
				LOC8 = 0;
				nimln(43, "service.nim");
				nimln(43, "service.nim");
				TMP6805 = addInt(bracketle, 1);
				LOC9 = 0;
				LOC9 = copyStr(p.Key, (NI32)(TMP6805));
...
N_NIMCALL(void, serve_418077)(TY418079 action) {
	...
	typ = getconfigvar_105291(((NimStringDesc*) &TMP6806));
	nimln(73, "service.nim");
	if (eqStrings(typ, ((NimStringDesc*) &TMP6807))) goto LA1;
	if (eqStrings(typ, ((NimStringDesc*) &TMP6808))) goto LA2;
	if (eqStrings(typ, ((NimStringDesc*) &TMP6799))) goto LA2;
	goto LA3;
	LA1: ;
	{
		...
		while (1) {
			...
			{
				nimln(77, "service.nim");
				if (!eqStrings(line, ((NimStringDesc*) &TMP6809))) goto LA9;
				nimln(77, "service.nim");
				exit(0);
			}
			LA9: ;
			...
			printf("%s\012", (((NimStringDesc*) &TMP6799))->data);
	...
	LA2: ;
	{
		...
		p = getconfigvar_105291(((NimStringDesc*) &TMP6814));
		...
		nimln(86, "service.nim");
		LOC19 = 0;
		LOC19 = getconfigvar_105291(((NimStringDesc*) &TMP6815));
		bindaddr_112552(server, port, LOC19);
		nimln(87, "service.nim");
		inp = copyString(((NimStringDesc*) &TMP6799));
		...
		while (1) {
			...
			send_120404(stdoutsocket_128876, ((NimStringDesc*) &TMP6840));
	...
	LA3: ;
	{
		...
		printf("%s%s\012", (((NimStringDesc*) &TMP6841))->data, (typ)->data);
...
N_NOINLINE(void, serviceInit)(void) {
	...
	LOC1 = 0;
	LOC1 = curcaascmd_418003; curcaascmd_418003 = copyStringRC1(((NimStringDesc*) &TMP6799));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(23, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_418004; lastcaascmd_418004 = copyStringRC1(((NimStringDesc*) &TMP6799));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(26, "service.nim");
	LOC3 = 0;
	LOC3 = arguments_418005; arguments_418005 = copyStringRC1(((NimStringDesc*) &TMP6799));
