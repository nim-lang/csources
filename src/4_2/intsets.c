...
static N_INLINE(NIM_BOOL, mustrehash_166052)(NI length, NI counter) {
	...
	LOC5 = ((NI64)(TMP1857) < (NI64)(TMP1858));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
...
static N_INLINE(NI, nexttry_166207)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1860 = mulInt(5, h);
	TMP1861 = addInt((NI64)(TMP1860), 1);
	result = (NI)((NI64)(TMP1861) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, intsetenlarge_166604)(tintset166041* t) {
	...
	TMP1865 = mulInt((NI64)(TMP1864), 2);
	TMP1866 = subInt((NI64)(TMP1865), 1);
	(*t).Max = (NI64)(TMP1866);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1867 = addInt((*t).Max, 1);
	n = (ttrunkseq166039*) newSeq((&NTI166039), (NI64)(TMP1867));
	i_166630 = 0;
...
N_NIMCALL(ttrunk166037*, intsetput_166659)(tintset166041* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = mustrehash_166052((NI64)(TMP1871), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
