...
STRING_LITERAL(TMP6763, "logpass: context is not nil", 27);
NIM_CONST tpass218015 verbosepass_413043 = {verboseopen_413005,
NIM_NIL,
verboseprocess_413013,
NIM_NIL}
;
static NIM_CONST TY169850 TMP6764 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP6765, "sons", 4);
static NIM_CONST TY169850 TMP6767 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP6768, "sym", 3);
...
N_NIMCALL(tnode169647*, verboseprocess_413013)(tpasscontext218003* context, tnode169647* n) {
	...
	nimln(22, "passaux.nim");
	{
		...
		nimln(22, "passaux.nim");
		internalerror_129699(((NimStringDesc*) &TMP6763));
	}
	LA3: ;
...
static N_INLINE(NI, sonslen_170003)(tnode169647* n) {
	...
	{
		nimln(1175, "ast.nim");
		if (((TMP6764[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP6765));
...
N_NIMCALL(tnode169647*, cleanup_413045)(tpasscontext218003* c, tnode169647* n) {
	...
	case ((NU8) 114):
	{
		...
		TMP6766 = subInt(LOC8, 1);
		HEX3Atmp_413145 = (NI64)(TMP6766);
	...
	case ((NU8) 80):
	{
		nimln(39, "passaux.nim");
		{
			...
			if (((TMP6764[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP6765));
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!(((TMP6767[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP6768));
			...
			nimln(41, "passaux.nim");
			{
				...
				if (((TMP6764[(*(*s).Ast).Kind/8] &(1<<((*(*s).Ast).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP6765));
