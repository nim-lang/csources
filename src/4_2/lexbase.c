...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP6593, "L.sentinel < L.bufLen ", 22);
STRING_LITERAL(TMP6596, "0 <= toCopy ", 12);
STRING_LITERAL(TMP6604, "s < L.bufLen ", 13);
STRING_LITERAL(TMP6608, "L.bufLen - oldBufLen == oldBufLen ", 34);
STRING_LITERAL(TMP6614, "pos <= L.sentinel ", 18);
STRING_LITERAL(TMP6616, "L.buf[pos] == \'\\x0D\' ", 21);
STRING_LITERAL(TMP6617, "L.buf[pos] == \'\\x0A\' ", 21);
STRING_LITERAL(TMP6618, "0 < bufLen ", 11);
STRING_LITERAL(TMP6619, "not input == nil ", 17);
STRING_LITERAL(TMP6623, "", 0);
STRING_LITERAL(TMP6624, "\012", 1);
STRING_LITERAL(TMP6625, "^\012", 2);
...
N_NIMCALL(void, fillbuffer_382070)(tbaselexer382014* l) {
	...
	nimln(77, "lexbase.nim");
	{
		...
		nimln(77, "lexbase.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP6593));
	}
	LA3: ;
	nimln(78, "lexbase.nim");
	nimln(78, "lexbase.nim");
	nimln(78, "lexbase.nim");
	TMP6594 = subInt((*l).Buflen, (*l).Sentinel);
	TMP6595 = subInt((NI64)(TMP6594), 1);
	tocopy = (NI64)(TMP6595);
	nimln(79, "lexbase.nim");
	{
		...
		nimln(79, "lexbase.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP6596));
	}
	LA7: ;
	nimln(80, "lexbase.nim");
	{
		...
		nimln(81, "lexbase.nim");
		TMP6597 = addInt((*l).Sentinel, 1);
		nimln(81, "lexbase.nim");
		TMP6598 = mulInt(tocopy, 1);
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP6597)])), (NI64)(TMP6598));
	}
	LA11: ;
	...
	TMP6600 = mulInt((NI64)(TMP6599), 1);
	LOC13 = readdata_133730((*l).Input, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP6600));
	TMP6601 = divInt(LOC13, 1);
	charsread = (NI64)(TMP6601);
	nimln(85, "lexbase.nim");
	nimln(85, "lexbase.nim");
	TMP6602 = addInt(tocopy, charsread);
	s = (NI64)(TMP6602);
	nimln(86, "lexbase.nim");
	{
		...
		nimln(86, "lexbase.nim");
		nimln(86, "lexbase.nim");
		TMP6603 = addInt((*l).Sentinel, 1);
		if (!(charsread < (NI64)(TMP6603))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			nimln(93, "lexbase.nim");
			{
				...
				nimln(93, "lexbase.nim");
				hiddenraiseassert_71620(((NimStringDesc*) &TMP6604));
			}
			LA22: ;
			...
			LA29: ;
			{
				...
				nimln(103, "lexbase.nim");
				TMP6605 = mulInt((*l).Buflen, 2);
				(*l).Buflen = (NI64)(TMP6605);
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				TMP6606 = mulInt((*l).Buflen, 1);
				LOC32 = realloc_4007(((void*) ((*l).Buf)), (NI64)(TMP6606));
				...
				nimln(105, "lexbase.nim");
				{
					...
					nimln(105, "lexbase.nim");
					nimln(105, "lexbase.nim");
					TMP6607 = subInt((*l).Buflen, oldbuflen);
					if (!!(((NI64)(TMP6607) == oldbuflen))) goto LA35;
					nimln(105, "lexbase.nim");
					hiddenraiseassert_71620(((NimStringDesc*) &TMP6608));
				}
				LA35: ;
				...
				nimln(106, "lexbase.nim");
				nimln(107, "lexbase.nim");
				TMP6609 = mulInt(oldbuflen, 1);
				LOC37 = readdata_133730((*l).Input, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP6609));
				TMP6610 = divInt(LOC37, 1);
				charsread = (NI64)(TMP6610);
				nimln(108, "lexbase.nim");
				{
					...
					(*l).Buf[(NI64)(TMP6611)] = 0;
					nimln(110, "lexbase.nim");
					nimln(110, "lexbase.nim");
					TMP6612 = addInt(oldbuflen, charsread);
					(*l).Sentinel = (NI64)(TMP6612);
...
N_NIMCALL(void, open_382024)(tbaselexer382014* l, tstream133630* input, NI buflen) {
	...
	nimln(147, "lexbase.nim");
	nimln(147, "lexbase.nim");
	TMP6620 = mulInt(buflen, 1);
	LOC9 = alloc_4001((NI64)(TMP6620));
	(*l).Buf = ((NCSTRING) (LOC9));
	nimln(148, "lexbase.nim");
	nimln(148, "lexbase.nim");
	TMP6621 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP6621);
...
N_NIMCALL(NI, getcolnumber_382043)(tbaselexer382014* l, NI pos) {
	...
	nimln(155, "lexbase.nim");
	nimln(155, "lexbase.nim");
	TMP6622 = subInt(pos, (*l).Linestart);
	if ((NI64)(TMP6622) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP6622));
	popFrame();
	return result;
}
...
appendString(result, ((NimStringDesc*) &TMP6624));
...
appendString(LOC6, ((NimStringDesc*) &TMP6625));
...
static TNimNode* TMP6748[8];
static TNimNode TMP6591[9];
...
TMP6748[0] = &TMP6591[1];
TMP6591[1].kind = 1;
TMP6591[1].offset = offsetof(tbaselexer382014, Bufpos);
TMP6591[1].typ = (&NTI105);
TMP6591[1].name = "bufpos";
TMP6748[1] = &TMP6591[2];
TMP6591[2].kind = 1;
TMP6591[2].offset = offsetof(tbaselexer382014, Buf);
TMP6591[2].typ = (&NTI145);
TMP6591[2].name = "buf";
TMP6748[2] = &TMP6591[3];
TMP6591[3].kind = 1;
TMP6591[3].offset = offsetof(tbaselexer382014, Buflen);
TMP6591[3].typ = (&NTI105);
TMP6591[3].name = "bufLen";
TMP6748[3] = &TMP6591[4];
TMP6591[4].kind = 1;
TMP6591[4].offset = offsetof(tbaselexer382014, Input);
TMP6591[4].typ = (&NTI133628);
TMP6591[4].name = "input";
TMP6748[4] = &TMP6591[5];
TMP6591[5].kind = 1;
TMP6591[5].offset = offsetof(tbaselexer382014, Linenumber);
TMP6591[5].typ = (&NTI105);
TMP6591[5].name = "LineNumber";
TMP6748[5] = &TMP6591[6];
TMP6591[6].kind = 1;
TMP6591[6].offset = offsetof(tbaselexer382014, Sentinel);
TMP6591[6].typ = (&NTI105);
TMP6591[6].name = "sentinel";
TMP6748[6] = &TMP6591[7];
TMP6591[7].kind = 1;
TMP6591[7].offset = offsetof(tbaselexer382014, Linestart);
TMP6591[7].typ = (&NTI105);
TMP6591[7].name = "lineStart";
TMP6748[7] = &TMP6591[8];
TMP6591[8].kind = 1;
TMP6591[8].offset = offsetof(tbaselexer382014, Fileopened);
TMP6591[8].typ = (&NTI132);
TMP6591[8].name = "fileOpened";
TMP6591[0].len = 8; TMP6591[0].kind = 2; TMP6591[0].sons = &TMP6748[0];
NTI382014.node = &TMP6591[0];
}
