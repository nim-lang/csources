...
STRING_LITERAL(TMP326, "nimcache", 8);
STRING_LITERAL(TMP330, "cannot create directory: ", 25);
STRING_LITERAL(TMP332, "nim", 3);
STRING_LITERAL(TMP338, "not \'\\0\' == sep ", 16);
STRING_LITERAL(TMP340, "lib", 3);
static NIM_CONST TY104134 TMP342 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x43, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP344, "true", 4);
STRING_LITERAL(TMP6985, "\012", 1);
...
N_NIMCALL(NimStringDesc*, removetrailingdirsep_105410)(NimStringDesc* path) {
	...
	nimln(200, "options.nim");
	{
		...
		if ((NU)((NI64)(TMP323)) > (NU)(path->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(path->data[(NI64)(TMP323)]) == (NU8)(47));
		LA4: ;
		if (!LOC3) goto LA5;
		...
		nimln(201, "options.nim");
		nimln(201, "options.nim");
		TMP324 = subInt(path->Sup.len, 2);
		result = copyStrLast(path, 0, (NI64)(TMP324));
	}
	goto LA1;
	LA5: ;
	{
...
N_NIMCALL(NimStringDesc*, getgeneratedpath_105418)(void) {
	...
	LA3: ;
	{
		...
		result = HEX2F_94062(LOC6, ((NimStringDesc*) &TMP326));
	}
	LA1: ;
	popFrame();
	return result;
...
N_NIMCALL(NimStringDesc*, completegeneratedfilepath_105438)(NimStringDesc* f, NIM_BOOL createsubdir) {
	...
	nimln(220, "options.nim");
	{
		...
		pushSafePoint(&TMP327);
		TMP327.status = setjmp(TMP327.context);
		if (TMP327.status == 0) {
...
appendString(LOC10, ((NimStringDesc*) &TMP330));
appendString(LOC10, subdir);
		...
		if (TMP327.status != 0) reraiseException();
	}
	LA4: ;
...
static N_INLINE(NimStringDesc*, findmodule_105538)(NimStringDesc* modulename) {
	...
	nimln(263, "options.nim");
	LOC1 = 0;
	LOC1 = nosaddFileExt(modulename, ((NimStringDesc*) &TMP332));
...
N_NIMCALL(void, libcandidates_105544)(NimStringDesc* s, TY9355** dest) {
	...
	nimln(267, "options.nim");
	TMP333 = addInt(le, 1);
	ri = nsuFindChar(s, 41, (NI64)(TMP333));
	nimln(268, "options.nim");
	{
		...
		nimln(269, "options.nim");
		TMP334 = subInt(le, 1);
		prefix = copyStrLast(s, 0, (NI64)(TMP334));
		nimln(270, "options.nim");
		nimln(270, "options.nim");
		nimln(270, "options.nim");
		TMP335 = addInt(ri, 1);
		suffix = copyStr(s, (NI64)(TMP335));
		middle_105556 = 0;
		HEX3Atmp_105573 = 0;
		...
		nimln(271, "options.nim");
		TMP337 = subInt(ri, 1);
		HEX3Atmp_105573 = copyStrLast(s, (NI64)(TMP336), (NI64)(TMP337));
		...
		nimln(248, "strutils.nim");
		{
			...
			nimln(248, "strutils.nim");
			hiddenraiseassert_71620(((NimStringDesc*) &TMP338));
		}
		LA9: ;
		nimln(249, "strutils.nim");
		{
			...
			while (1) {
				...
				nimln(254, "strutils.nim");
				nimln(254, "strutils.nim");
				TMP339 = subInt(last_105575, 1);
				middle_105556 = copyStrLast(HEX3Atmp_105573, first_105577, (NI64)(TMP339));
...
N_NIMCALL(NimStringDesc*, canondynlibname_105582)(NimStringDesc* s) {
	...
	ende = nsuFindCharSet(s, TMP342, 0);
	nimln(279, "options.nim");
	{
		...
		nimln(280, "options.nim");
		nimln(280, "options.nim");
		TMP343 = subInt(ende, 1);
		result = copyStrLast(s, start, (NI64)(TMP343));
	}
	goto LA7;
	LA9: ;
	{
...
N_NIMCALL(void, incldynliboverride_105591)(NimStringDesc* lib) {
	...
	nstPut(gdlloverrides_105189, LOC1, ((NimStringDesc*) &TMP344));
	popFrame();
}
...
static TNimNode* TMP1930[22];
NI TMP1932;
static char* NIM_CONST TMP1931[22] = {
"optNone", 
"optObjCheck", 
"optFieldCheck", 
"optRangeCheck", 
...
"optImplicitStatic", 
"optPatterns"};
static TNimNode* TMP2926[20];
NI TMP2928;
static char* NIM_CONST TMP2927[20] = {
"cmdNone", 
"cmdCompileToC", 
"cmdCompileToCpp", 
"cmdCompileToOC", 
...
"cmdInteractive", 
"cmdRun"};
static TNimNode* TMP6993[32];
NI TMP6995;
static char* NIM_CONST TMP6994[32] = {
"gloptNone", 
"optForceFullMake", 
"optDeadCodeElim", 
"optListCmd", 
...
NTI105008.base = 0;
NTI105008.flags = 3;
for (TMP1932 = 0; TMP1932 < 22; TMP1932++) {
TMP249[TMP1932+0].kind = 1;
TMP249[TMP1932+0].offset = TMP1932;
TMP249[TMP1932+0].name = TMP1931[TMP1932];
TMP1930[TMP1932] = &TMP249[TMP1932+0];
}
TMP249[22].len = 22; TMP249[22].kind = 2; TMP249[22].sons = &TMP1930[0];
...
NTI105016.base = 0;
NTI105016.flags = 3;
for (TMP2928 = 0; TMP2928 < 20; TMP2928++) {
TMP249[TMP2928+24].kind = 1;
TMP249[TMP2928+24].offset = TMP2928;
TMP249[TMP2928+24].name = TMP2927[TMP2928];
TMP2926[TMP2928] = &TMP249[TMP2928+24];
}
TMP249[44].len = 20; TMP249[44].kind = 2; TMP249[44].sons = &TMP2926[0];
NTI105016.node = &TMP249[44];
NTI105012.size = sizeof(NU8);
NTI105012.kind = 14;
NTI105012.base = 0;
NTI105012.flags = 3;
for (TMP6995 = 0; TMP6995 < 32; TMP6995++) {
TMP249[TMP6995+45].kind = 1;
TMP249[TMP6995+45].offset = TMP6995;
TMP249[TMP6995+45].name = TMP6994[TMP6995];
TMP6993[TMP6995] = &TMP249[TMP6995+45];
}
TMP249[77].len = 32; TMP249[77].kind = 2; TMP249[77].sons = &TMP6993[0];
