...
STRING_LITERAL(TMP2795, "newFileSize == -1 or not mode == fmRead ", 40);
...
static TNimNode* TMP2876[3];
static TNimNode TMP2793[4];
...
TMP2876[0] = &TMP2793[1];
TMP2793[1].kind = 1;
TMP2793[1].offset = offsetof(tmemfile205204, Mem);
TMP2793[1].typ = (&NTI147);
TMP2793[1].name = "mem";
TMP2876[1] = &TMP2793[2];
TMP2793[2].kind = 1;
TMP2793[2].offset = offsetof(tmemfile205204, Size);
TMP2793[2].typ = (&NTI105);
TMP2793[2].name = "size";
TMP2876[2] = &TMP2793[3];
TMP2793[3].kind = 1;
TMP2793[3].offset = offsetof(tmemfile205204, Handle);
TMP2793[3].typ = (&NTI3701);
TMP2793[3].name = "handle";
TMP2793[0].len = 3; TMP2793[0].kind = 2; TMP2793[0].sons = &TMP2876[0];
NTI205204.node = &TMP2793[0];
}
