...
STRING_LITERAL(TMP320, "/path/a.out", 11);
STRING_LITERAL(TMP322, "unknown OS error", 16);
STRING_LITERAL(TMP1459, "HOME", 4);
STRING_LITERAL(TMP1460, "/", 1);
STRING_LITERAL(TMP1835, "/.config/", 9);
STRING_LITERAL(TMP6792, "invalid index", 13);
...
N_NIMCALL(NimStringDesc*, nosgetHomeDir)(void) {
	...
	nimln(1432, "os.nim");
	LOC2 = 0;
	LOC2 = getenv_95823(((NimStringDesc*) &TMP1459));
	LOC1 = rawNewString(LOC2->Sup.len + 1);
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP1460));
	result = LOC1;
	goto BeforeRet;
	BeforeRet: ;
	popFrame();
...
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP1835));
	result = LOC1;
	goto BeforeRet;
	BeforeRet: ;
	popFrame();
...
N_NIMCALL(NimStringDesc*, nosparentDir)(NimStringDesc* path) {
	...
	nimln(558, "os.nim");
	{
		...
		nimln(558, "os.nim");
		nimln(558, "os.nim");
		TMP1843 = subInt(path->Sup.len, 1);
		if ((NU)((NI64)(TMP1843)) > (NU)(path->Sup.len)) raiseIndexError();
		if (!(((NU8)(path->data[(NI64)(TMP1843)])) == ((NU8)(47)) || ((NU8)(path->data[(NI64)(TMP1843)])) == ((NU8)(47)))) goto LA3;
		nimln(559, "os.nim");
		q = 2;
	}
	LA3: ;
	...
	nimln(560, "os.nim");
	nimln(560, "os.nim");
	TMP1844 = subInt(path->Sup.len, q);
	HEX3Atmp_94137 = (NI64)(TMP1844);
	nimln(1265, "system.nim");
	...
	nimln(564, "os.nim");
	{
		...
		nimln(565, "os.nim");
		nimln(565, "os.nim");
		TMP1845 = subInt(seppos, 1);
		result = copyStrLast(path, 0, (NI64)(TMP1845));
	}
	goto LA10;
	LA12: ;
	{
...
N_NIMCALL(NI, paramcount_98633)(void) {
	...
	nimln(1480, "os.nim");
	nimln(1480, "os.nim");
	TMP6791 = subInt(cmdCount, ((NI32) 1));
	if (TMP6791 < (-2147483647 -1) || TMP6791 > 2147483647) raiseOverflow();
	result = ((NI) ((NI32)(TMP6791)));
	goto BeforeRet;
	BeforeRet: ;
	popFrame();
	return result;
...
N_NIMCALL(NimStringDesc*, paramstr_98605)(NI i) {
	...
	nimln(1797, "system.nim");
	LOC7 = 0;
	LOC7 = (*e_98613).Sup.Sup.message; (*e_98613).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP6792));
	if (LOC7) nimGCunrefNoCycle(LOC7);
	nimln(1478, "os.nim");
