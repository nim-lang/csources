...
STRING_LITERAL(TMP1884, "nimrod.gid", 10);
...
static N_INLINE(void, setid_168436)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP1879 = addInt(id, 1);
	gfrontendid_168005 = ((gfrontendid_168005 >= (NI64)(TMP1879)) ? gfrontendid_168005 : (NI64)(TMP1879));
	popFrame();
}
...
N_NIMCALL(void, idsynchronizationpoint_168445)(NI idrange) {
	...
	nimln(41, "idgen.nim");
	nimln(41, "idgen.nim");
	TMP1880 = divInt(gfrontendid_168005, idrange);
	TMP1881 = addInt((NI64)(TMP1880), 1);
	TMP1882 = mulInt((NI64)(TMP1881), idrange);
	TMP1883 = addInt((NI64)(TMP1882), 1);
	gfrontendid_168005 = (NI64)(TMP1883);
	popFrame();
}
...
N_NIMCALL(NimStringDesc*, togid_168450)(NimStringDesc* f) {
	...
	result = 0;
	nimln(47, "idgen.nim");
	result = completegeneratedfilepath_105438(((NimStringDesc*) &TMP1884), NIM_TRUE);
	popFrame();
	return result;
}
