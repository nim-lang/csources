...
STRING_LITERAL(TMP853, "id == 0 or id == result.id ", 27);
STRING_LITERAL(TMP857, ":anonymous", 10);
...
N_NIMCALL(NI, cmpignorestyle_131032)(NCSTRING a, NCSTRING b, NI blen) {
	...
	while (1) {
		...
		nimln(40, "idents.nim");
		{
			...
			nimln(40, "idents.nim");
			nimln(40, "idents.nim");
			TMP849 = addInt(((NI) (((NU8)(aa)))), 32);
			aa = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP849), 0, 255))));
		}
		LA8: ;
		nimln(41, "idents.nim");
		{
			...
			nimln(41, "idents.nim");
			nimln(41, "idents.nim");
			TMP850 = addInt(((NI) (((NU8)(bb)))), 32);
			bb = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP850), 0, 255))));
		}
		LA14: ;
		nimln(42, "idents.nim");
		nimln(42, "idents.nim");
...
N_NIMCALL(NI, cmpexact_131155)(NCSTRING a, NCSTRING b, NI blen) {
	...
	while (1) {
		...
		nimln(56, "idents.nim");
		nimln(56, "idents.nim");
		TMP852 = subInt(((NI) (((NU8)(aa)))), ((NI) (((NU8)(bb)))));
		result = (NI64)(TMP852);
		nimln(57, "idents.nim");
		{
			NIM_BOOL LOC4;
...
N_NIMCALL(tident131015*, getident_131208)(NCSTRING identifier, NI length, NI h) {
	...
	while (1) {
		...
		LA5: ;
		{
			...
			nimln(79, "idents.nim");
			{
				...
				if (!!(LOC17)) goto LA19;
				nimln(79, "idents.nim");
				hiddenraiseassert_71620(((NimStringDesc*) &TMP853));
			}
			LA19: ;
			nimln(80, "idents.nim");
			id = (*result).Sup.Id;
	...
	nimln(86, "idents.nim");
	nimln(86, "idents.nim");
	TMP856 = subInt(length, 1);
	HEX3Atmp_131440 = (NI64)(TMP856);
...
N_NOINLINE(void, identsInit)(void) {
	...
	asgnRefNoCycle((void**) &idanon_131468, getident_131448(((NimStringDesc*) &TMP857)));
	popFrame();
}

N_NOINLINE(void, identsDatInit)(void) {
static TNimNode* TMP854[3];
static TNimNode TMP847[5];
NTI131009.size = sizeof(tidobj131009);
NTI131009.kind = 17;
NTI131009.base = (&NTI1009);
NTI131009.flags = 3;
TMP847[0].kind = 1;
TMP847[0].offset = offsetof(tidobj131009, Id);
TMP847[0].typ = (&NTI105);
TMP847[0].name = "id";
NTI131009.node = &TMP847[0];
...
TMP854[0] = &TMP847[2];
TMP847[2].kind = 1;
TMP847[2].offset = offsetof(tident131015, S);
TMP847[2].typ = (&NTI143);
TMP847[2].name = "s";
TMP854[1] = &TMP847[3];
TMP847[3].kind = 1;
TMP847[3].offset = offsetof(tident131015, Next);
TMP847[3].typ = (&NTI131013);
TMP847[3].name = "next";
TMP854[2] = &TMP847[4];
TMP847[4].kind = 1;
TMP847[4].offset = offsetof(tident131015, H);
TMP847[4].typ = (&NTI101009);
TMP847[4].name = "h";
TMP847[1].len = 3; TMP847[1].kind = 2; TMP847[1].sons = &TMP854[0];
NTI131015.node = &TMP847[1];
NTI131013.size = sizeof(tident131015*);
NTI131013.kind = 22;
NTI131013.base = (&NTI131015);
NTI131013.flags = 2;
NTI131013.marker = TMP855;
NTI131011.size = sizeof(tidobj131009*);
NTI131011.kind = 22;
NTI131011.base = (&NTI131009);
NTI131011.flags = 2;
NTI131011.marker = TMP1960;
}
