...
N_NIMCALL(void, TMP6785)(void* p, NI op);
...
N_NIMCALL(tnode169647*, close_415012)(tpasscontext218003* p, tnode169647* n) {
	...
	nimln(25, "docgen2.nim");
	{
		...
		writeoutput_286003((*g).Doc, LOC7, ((NimStringDesc*) &TMP6783), usewarning);
		nimln(27, "docgen2.nim");
		pushSafePoint(&TMP6784);
		TMP6784.status = setjmp(TMP6784.context);
		if (TMP6784.status == 0) {
		...
		if (TMP6784.status != 0) reraiseException();
	}
	LA5: ;
	popFrame();
	return result;
...
static TNimNode* TMP6782[2];
static TNimNode TMP6780[3];
...
TMP6782[0] = &TMP6780[1];
TMP6780[1].kind = 1;
TMP6780[1].offset = offsetof(tgen415006, Doc);
TMP6780[1].typ = (&NTI284007);
TMP6780[1].name = "doc";
TMP6782[1] = &TMP6780[2];
TMP6780[2].kind = 1;
TMP6780[2].offset = offsetof(tgen415006, Module);
TMP6780[2].typ = (&NTI169645);
TMP6780[2].name = "module";
TMP6780[0].len = 2; TMP6780[0].kind = 2; TMP6780[0].sons = &TMP6782[0];
NTI415006.node = &TMP6780[0];
NTI415008.size = sizeof(tgen415006*);
NTI415008.kind = 22;
NTI415008.base = (&NTI415006);
NTI415008.flags = 2;
NTI415008.marker = TMP6785;
}
