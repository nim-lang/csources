...
N_NIMCALL(tnode169647*, close_415012)(tpasscontext218003* p, tnode169647* n) {
	...
	nimln(25, "docgen2.nim");
	{
		...
		writeoutput_286003((*g).Doc, LOC7, ((NimStringDesc*) &TMP6782), usewarning);
		nimln(27, "docgen2.nim");
		pushSafePoint(&TMP6783);
		TMP6783.status = setjmp(TMP6783.context);
		if (TMP6783.status == 0) {
		...
		if (TMP6783.status != 0) reraiseException();
	}
	LA5: ;
	popFrame();
	return result;
...
static TNimNode* TMP6781[2];
static TNimNode TMP6779[3];
...
TMP6781[0] = &TMP6779[1];
TMP6779[1].kind = 1;
TMP6779[1].offset = offsetof(tgen415006, Doc);
TMP6779[1].typ = (&NTI284007);
TMP6779[1].name = "doc";
TMP6781[1] = &TMP6779[2];
TMP6779[2].kind = 1;
TMP6779[2].offset = offsetof(tgen415006, Module);
TMP6779[2].typ = (&NTI169645);
TMP6779[2].name = "module";
TMP6779[0].len = 2; TMP6779[0].kind = 2; TMP6779[0].sons = &TMP6781[0];
NTI415006.node = &TMP6779[0];
NTI415008.size = sizeof(tgen415006*);
NTI415008.kind = 22;
NTI415008.base = (&NTI415006);
NTI415008.flags = 2;
NTI415008.marker = TMP6784;
}
