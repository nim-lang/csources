...
N_NIMCALL(NI, cmpignorestyle_131032)(NCSTRING a, NCSTRING b, NI blen) {
	...
	while (1) {
		...
		nimln(40, "idents.nim");
		{
			...
			aa = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP848), 0, 255))));
		}
		LA8: ;
		nimln(41, "idents.nim");
		{
			...
			bb = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP849), 0, 255))));
		}
		LA14: ;
		nimln(42, "idents.nim");
		nimln(42, "idents.nim");
...
N_NIMCALL(tident131015*, getident_131208)(NCSTRING identifier, NI length, NI h) {
	...
	nimln(89, "idents.nim");
	{
		...
		nimln(91, "idents.nim");
		nimln(91, "idents.nim");
		if (wordcounter_131206 == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
		(*result).Sup.Id = ((NI64)-(wordcounter_131206));
	}
	goto LA22;
	LA24: ;
	{
