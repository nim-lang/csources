...
N_NIMCALL(tnode169647*, semnodekindconstraints_269363)(tnode169647* p) {
	...
	nimln(124, "parampatterns.nim");
	{
		...
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_129687((*p).Info, ((NimStringDesc*) &TMP3762));
		}
		LA14: ;
	}
	goto LA5;
...
N_NIMCALL(NIM_BOOL, matchnodekinds_269914)(tnode169647* p, tnode169647* n) {
	...
	while (1) {
		...
		case ((NU8) 4):
		{
			...
			stack[((NI64)(TMP3771))- 0] = !(stack[((NI64)(TMP3772))- 0]);
		}
		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(251, "parampatterns.nim");
			TMP3773 = addInt(pc, 1);
			if ((NU)((NI64)(TMP3773)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3773)])), ((NU8) 0), ((NU8) 22)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3774)])), ((NU8) 0), ((NU8) 151)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
