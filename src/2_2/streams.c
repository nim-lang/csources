...
STRING_LITERAL(TMP887, "\012", 1);
STRING_LITERAL(TMP888, "", 0);
STRING_LITERAL(TMP894, "cannot write to stream", 22);
STRING_LITERAL(TMP6987, "cannot read from stream", 23);
...
N_NIMCALL(void, writeln_133777)(tstream133630* s, NimStringDesc** args, NI argsLen0) {
	...
	write_133771(s, ((NimStringDesc*) &TMP887));
	popFrame();
}
...
N_NIMCALL(NimStringDesc*, readline_133993)(tstream133630* s) {
	...
	result = copyString(((NimStringDesc*) &TMP888));
...
N_NIMCALL(NI, ssreaddata_134044)(tstream133630* s_134046, void* buffer, NI buflen) {
	...
	nimln(214, "streams.nim");
	nimln(214, "streams.nim");
	TMP891 = subInt((*s).Data->Sup.len, (*s).Pos);
	result = ((buflen <= (NI64)(TMP891)) ? buflen : (NI64)(TMP891));
...
N_NIMCALL(void, sswritedata_134072)(tstream133630* s_134074, void* buffer, NI buflen) {
	...
	nimln(221, "streams.nim");
	{
		...
		nimln(222, "streams.nim");
		nimln(222, "streams.nim");
		TMP892 = addInt((*s).Data->Sup.len, buflen);
		(*s).Data = setLengthStr((*s).Data, (NI64)(TMP892));
...
N_NIMCALL(void, fswritedata_134176)(tstream133630* s, void* buffer, NI buflen) {
	...
	nimln(260, "streams.nim");
	{
		...
		LOC6 = 0;
		LOC6 = neweio_133605(((NimStringDesc*) &TMP894));
		nimln(261, "streams.nim");
...
N_NIMCALL(void, read_133821)(tstream133630* s, NIM_BOOL* result) {
	...
	nimln(117, "streams.nim");
	{
		...
		LOC6 = 0;
		LOC6 = neweio_133605(((NimStringDesc*) &TMP6987));
		nimln(118, "streams.nim");
		raiseException((E_Base*)LOC6, "EIO");
	}
	LA4: ;
...
static TNimNode* TMP889[7];
static TNimNode* TMP890[2];
static TNimNode TMP885[12];
...
NTI133631.flags = 3;
TMP885[1].kind = 1;
TMP885[1].offset = offsetof(tstream133630, Closeimpl);
TMP885[1].typ = (&NTI133631);
TMP885[1].name = "closeImpl";
TMP889[1] = &TMP885[2];
...
NTI133635.flags = 3;
TMP885[2].kind = 1;
TMP885[2].offset = offsetof(tstream133630, Atendimpl);
TMP885[2].typ = (&NTI133635);
TMP885[2].name = "atEndImpl";
TMP889[2] = &TMP885[3];
...
NTI133639.flags = 3;
TMP885[3].kind = 1;
TMP885[3].offset = offsetof(tstream133630, Setpositionimpl);
TMP885[3].typ = (&NTI133639);
TMP885[3].name = "setPositionImpl";
TMP889[3] = &TMP885[4];
...
NTI133644.flags = 3;
TMP885[4].kind = 1;
TMP885[4].offset = offsetof(tstream133630, Getpositionimpl);
TMP885[4].typ = (&NTI133644);
TMP885[4].name = "getPositionImpl";
TMP889[4] = &TMP885[5];
...
NTI133648.flags = 3;
TMP885[5].kind = 1;
TMP885[5].offset = offsetof(tstream133630, Readdataimpl);
TMP885[5].typ = (&NTI133648);
TMP885[5].name = "readDataImpl";
TMP889[5] = &TMP885[6];
...
NTI133654.flags = 3;
TMP885[6].kind = 1;
TMP885[6].offset = offsetof(tstream133630, Writedataimpl);
TMP885[6].typ = (&NTI133654);
TMP885[6].name = "writeDataImpl";
TMP889[6] = &TMP885[7];
...
NTI133660.flags = 3;
TMP885[7].kind = 1;
TMP885[7].offset = offsetof(tstream133630, Flushimpl);
TMP885[7].typ = (&NTI133660);
TMP885[7].name = "flushImpl";
TMP885[0].len = 7; TMP885[0].kind = 2; TMP885[0].sons = &TMP889[0];
NTI133630.node = &TMP885[0];
...
TMP890[0] = &TMP885[9];
TMP885[9].kind = 1;
TMP885[9].offset = offsetof(tstringstream134006, Data);
TMP885[9].typ = (&NTI143);
TMP885[9].name = "data";
TMP890[1] = &TMP885[10];
TMP885[10].kind = 1;
TMP885[10].offset = offsetof(tstringstream134006, Pos);
TMP885[10].typ = (&NTI105);
TMP885[10].name = "pos";
TMP885[8].len = 2; TMP885[8].kind = 2; TMP885[8].sons = &TMP890[0];
NTI134006.node = &TMP885[8];
NTI134004.size = sizeof(tstringstream134006*);
NTI134004.kind = 22;
NTI134004.base = (&NTI134006);
NTI134004.flags = 2;
NTI134004.marker = TMP893;
NTI134125.size = sizeof(tfilestream134125);
NTI134125.kind = 17;
NTI134125.base = (&NTI133630);
NTI134125.flags = 3;
TMP885[11].kind = 1;
TMP885[11].offset = offsetof(tfilestream134125, F);
TMP885[11].typ = (&NTI9004);
TMP885[11].name = "f";
NTI134125.node = &TMP885[11];
NTI134123.size = sizeof(tfilestream134125*);
NTI134123.kind = 22;
NTI134123.base = (&NTI134125);
NTI134123.flags = 2;
NTI134123.marker = TMP895;
NTI133628.size = sizeof(tstream133630*);
NTI133628.kind = 22;
NTI133628.base = (&NTI133630);
NTI133628.flags = 2;
NTI133628.marker = TMP902;
}
