...
STRING_LITERAL(TMP319, "/proc/self/exe", 14);
STRING_LITERAL(TMP321, "unknown OS error", 16);
STRING_LITERAL(TMP1458, "HOME", 4);
STRING_LITERAL(TMP1459, "/", 1);
STRING_LITERAL(TMP1834, "/.config/", 9);
STRING_LITERAL(TMP6791, "invalid index", 13);
...
N_NIMCALL(NimStringDesc*, nosgetAppFilename)(void) {
	...
	result = 0;
	nimln(1526, "os.nim");
	result = getapplaux_98804(((NimStringDesc*) &TMP319));
	popFrame();
	return result;
}
...
N_NIMCALL(void, oserror_92005)(NI32 errorcode) {
	...
	nimln(260, "os.nim");
	{
		...
		LOC5 = 0;
		LOC5 = (*e_92011).Sup.Sup.Sup.message; (*e_92011).Sup.Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP321));
...
N_NIMCALL(void, noscreateDir)(NimStringDesc* dir) {
	...
	nimln(1198, "os.nim");
	nimln(1198, "os.nim");
	TMP327 = subInt(dir->Sup.len, 1);
	HEX3Atmp_97219 = (NI64)(TMP327);
	nimln(1281, "system.nim");
	res_97221 = 1;
	nimln(1282, "system.nim");
	while (1) {
		...
		nimln(1199, "os.nim");
		{
			...
			LA8: ;
			{
				...
				nimln(1203, "os.nim");
				nimln(1203, "os.nim");
				TMP328 = subInt(i_97208, 1);
				LOC11 = 0;
				LOC11 = copyStrLast(dir, 0, (NI64)(TMP328));
...
N_NIMCALL(NimStringDesc*, nosextractFilename)(NimStringDesc* path) {
	...
	nimln(654, "os.nim");
	{
		...
		nimln(654, "os.nim");
		nimln(654, "os.nim");
		TMP781 = subInt(path->Sup.len, 1);
		if ((NU)((NI64)(TMP781)) > (NU)(path->Sup.len)) raiseIndexError();
		LOC3 = (((NU8)(path->data[(NI64)(TMP781)])) == ((NU8)(47)) || ((NU8)(path->data[(NI64)(TMP781)])) == ((NU8)(47)));
		LA4: ;
		if (!LOC3) goto LA5;
		nimln(655, "os.nim");
		result = copyString(((NimStringDesc*) &TMP286));
...
N_NIMCALL(void, nossleep)(NI milsecs) {
	...
	nimln(1575, "os.nim");
	nimln(1575, "os.nim");
	TMP906 = divInt(milsecs, 1000);
	a.tv_sec = (NI64)(TMP906);
	nimln(1576, "os.nim");
	nimln(1576, "os.nim");
	nimln(1576, "os.nim");
	nimln(1576, "os.nim");
	TMP907 = modInt(milsecs, 1000);
	TMP908 = mulInt(((NI) ((NI64)(TMP907))), 1000);
	TMP909 = mulInt(((NI) ((NI64)(TMP908))), 1000);
	a.tv_nsec = ((NI) ((NI64)(TMP909)));
	nimln(1577, "os.nim");
	nimln(1577, "os.nim");
	LOC1 = nanosleep(&a, &b);
	popFrame();
...
N_NIMCALL(NimStringDesc*, nosgetHomeDir)(void) {
	...
	nimln(1432, "os.nim");
	LOC2 = 0;
	LOC2 = getenv_95823(((NimStringDesc*) &TMP1458));
	LOC1 = rawNewString(LOC2->Sup.len + 1);
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP1459));
	result = LOC1;
	goto BeforeRet;
	BeforeRet: ;
	popFrame();
...
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP1834));
	result = LOC1;
	goto BeforeRet;
	BeforeRet: ;
	popFrame();
...
N_NIMCALL(NimStringDesc*, nosparentDir)(NimStringDesc* path) {
	...
	nimln(558, "os.nim");
	{
		...
		nimln(558, "os.nim");
		nimln(558, "os.nim");
		TMP1842 = subInt(path->Sup.len, 1);
		if ((NU)((NI64)(TMP1842)) > (NU)(path->Sup.len)) raiseIndexError();
		if (!(((NU8)(path->data[(NI64)(TMP1842)])) == ((NU8)(47)) || ((NU8)(path->data[(NI64)(TMP1842)])) == ((NU8)(47)))) goto LA3;
		nimln(559, "os.nim");
		q = 2;
	}
	LA3: ;
	...
	nimln(560, "os.nim");
	nimln(560, "os.nim");
	TMP1843 = subInt(path->Sup.len, q);
	HEX3Atmp_94137 = (NI64)(TMP1843);
	nimln(1265, "system.nim");
	...
	nimln(564, "os.nim");
	{
		...
		nimln(565, "os.nim");
		nimln(565, "os.nim");
		TMP1844 = subInt(seppos, 1);
		result = copyStrLast(path, 0, (NI64)(TMP1844));
	}
	goto LA10;
	LA12: ;
	{
...
N_NIMCALL(NI, paramcount_98633)(void) {
	...
	nimln(1480, "os.nim");
	nimln(1480, "os.nim");
	TMP6790 = subInt(cmdCount, ((NI32) 1));
	if (TMP6790 < (-2147483647 -1) || TMP6790 > 2147483647) raiseOverflow();
	result = ((NI) ((NI32)(TMP6790)));
	goto BeforeRet;
	BeforeRet: ;
	popFrame();
	return result;
...
N_NIMCALL(NimStringDesc*, paramstr_98605)(NI i) {
	...
	nimln(1797, "system.nim");
	LOC7 = 0;
	LOC7 = (*e_98613).Sup.Sup.message; (*e_98613).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP6791));
	if (LOC7) nimGCunrefNoCycle(LOC7);
	nimln(1478, "os.nim");
