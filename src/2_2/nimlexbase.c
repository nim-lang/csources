...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP1564, "L.sentinel < L.bufLen ", 22);
STRING_LITERAL(TMP1567, "0 <= toCopy ", 12);
STRING_LITERAL(TMP1575, "s < L.bufLen ", 13);
STRING_LITERAL(TMP1579, "L.bufLen - oldBufLen == oldBufLen ", 34);
STRING_LITERAL(TMP1585, "pos <= L.sentinel ", 18);
STRING_LITERAL(TMP1587, "L.buf[pos] == \'\\x0D\' ", 21);
STRING_LITERAL(TMP1588, "L.buf[pos] == \'\\x0A\' ", 21);
STRING_LITERAL(TMP1589, "0 < bufLen ", 11);
STRING_LITERAL(TMP1593, "", 0);
STRING_LITERAL(TMP1594, "\012", 1);
STRING_LITERAL(TMP1595, "^\012", 2);
...
N_NIMCALL(void, fillbuffer_160073)(tbaselexer160018* l) {
	...
	nimln(82, "nimlexbase.nim");
	{
		...
		nimln(82, "nimlexbase.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP1564));
	}
	LA3: ;
	nimln(83, "nimlexbase.nim");
	nimln(83, "nimlexbase.nim");
	nimln(83, "nimlexbase.nim");
	TMP1565 = subInt((*l).Buflen, (*l).Sentinel);
	TMP1566 = subInt((NI64)(TMP1565), 1);
	tocopy = (NI64)(TMP1566);
	...
	nimln(85, "nimlexbase.nim");
	{
		...
		nimln(86, "nimlexbase.nim");
		TMP1568 = addInt((*l).Sentinel, 1);
		nimln(86, "nimlexbase.nim");
		TMP1569 = mulInt(tocopy, 1);
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP1568)])), (NI64)(TMP1569));
	}
	LA11: ;
	...
	TMP1571 = mulInt((NI64)(TMP1570), 1);
	LOC13 = llstreamread_159242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP1571));
	TMP1572 = divInt(LOC13, 1);
	charsread = (NI64)(TMP1572);
	nimln(90, "nimlexbase.nim");
	nimln(90, "nimlexbase.nim");
	TMP1573 = addInt(tocopy, charsread);
	s = (NI64)(TMP1573);
	nimln(91, "nimlexbase.nim");
	{
		...
		if (!(charsread < (NI64)(TMP1574))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				nimln(108, "nimlexbase.nim");
				TMP1576 = mulInt((*l).Buflen, 2);
				(*l).Buflen = (NI64)(TMP1576);
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				TMP1577 = mulInt((*l).Buflen, 1);
				LOC32 = realloc_4007(((void*) ((*l).Buf)), (NI64)(TMP1577));
				...
				nimln(110, "nimlexbase.nim");
				{
					...
					nimln(110, "nimlexbase.nim");
					nimln(110, "nimlexbase.nim");
					TMP1578 = subInt((*l).Buflen, oldbuflen);
					if (!!(((NI64)(TMP1578) == oldbuflen))) goto LA35;
					nimln(110, "nimlexbase.nim");
					hiddenraiseassert_71620(((NimStringDesc*) &TMP1579));
				}
				LA35: ;
				...
				nimln(111, "nimlexbase.nim");
				nimln(112, "nimlexbase.nim");
				TMP1580 = mulInt(oldbuflen, 1);
				LOC37 = llstreamread_159242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP1580));
				TMP1581 = divInt(LOC37, 1);
				charsread = (NI64)(TMP1581);
				nimln(113, "nimlexbase.nim");
				{
					...
					nimln(114, "nimlexbase.nim");
					TMP1582 = addInt(oldbuflen, charsread);
					(*l).Buf[(NI64)(TMP1582)] = 0;
					nimln(115, "nimlexbase.nim");
					nimln(115, "nimlexbase.nim");
					TMP1583 = addInt(oldbuflen, charsread);
					(*l).Sentinel = (NI64)(TMP1583);
...
N_NIMCALL(NI, handlecr_160051)(tbaselexer160018* l, NI pos) {
	...
	nimln(130, "nimlexbase.nim");
	{
		...
		nimln(130, "nimlexbase.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP1587));
	}
	LA3: ;
...
N_NIMCALL(void, openbaselexer_160027)(tbaselexer160018* l, tllstream159204* inputstream, NI buflen) {
	...
	nimln(150, "nimlexbase.nim");
	nimln(150, "nimlexbase.nim");
	TMP1590 = mulInt(buflen, 1);
	LOC5 = alloc_4001((NI64)(TMP1590));
	(*l).Buf = ((NCSTRING) (LOC5));
	nimln(151, "nimlexbase.nim");
	nimln(151, "nimlexbase.nim");
	TMP1591 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP1591);
...
N_NIMCALL(NI, getcolnumber_160046)(tbaselexer160018* l, NI pos) {
	...
	nimln(159, "nimlexbase.nim");
	nimln(159, "nimlexbase.nim");
	TMP1592 = subInt(pos, (*l).Linestart);
	if ((NI64)(TMP1592) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP1592));
	popFrame();
	return result;
}
...
N_NIMCALL(NimStringDesc*, getcurrentline_160041)(tbaselexer160018* l, NIM_BOOL marker) {
	...
	result = copyString(((NimStringDesc*) &TMP1593));
...
appendString(result, ((NimStringDesc*) &TMP1594));
...
appendString(LOC6, ((NimStringDesc*) &TMP1595));
...
static TNimNode* TMP1832[7];
static TNimNode TMP1539[8];
...
TMP1832[0] = &TMP1539[1];
TMP1539[1].kind = 1;
TMP1539[1].offset = offsetof(tbaselexer160018, Bufpos);
TMP1539[1].typ = (&NTI105);
TMP1539[1].name = "bufpos";
TMP1832[1] = &TMP1539[2];
TMP1539[2].kind = 1;
TMP1539[2].offset = offsetof(tbaselexer160018, Buf);
TMP1539[2].typ = (&NTI145);
TMP1539[2].name = "buf";
TMP1832[2] = &TMP1539[3];
TMP1539[3].kind = 1;
TMP1539[3].offset = offsetof(tbaselexer160018, Buflen);
TMP1539[3].typ = (&NTI105);
TMP1539[3].name = "bufLen";
TMP1832[3] = &TMP1539[4];
TMP1539[4].kind = 1;
TMP1539[4].offset = offsetof(tbaselexer160018, Stream);
TMP1539[4].typ = (&NTI159206);
TMP1539[4].name = "stream";
TMP1832[4] = &TMP1539[5];
TMP1539[5].kind = 1;
TMP1539[5].offset = offsetof(tbaselexer160018, Linenumber);
TMP1539[5].typ = (&NTI105);
TMP1539[5].name = "LineNumber";
TMP1832[5] = &TMP1539[6];
TMP1539[6].kind = 1;
TMP1539[6].offset = offsetof(tbaselexer160018, Sentinel);
TMP1539[6].typ = (&NTI105);
TMP1539[6].name = "sentinel";
TMP1832[6] = &TMP1539[7];
TMP1539[7].kind = 1;
TMP1539[7].offset = offsetof(tbaselexer160018, Linestart);
TMP1539[7].typ = (&NTI105);
TMP1539[7].name = "lineStart";
TMP1539[0].len = 7; TMP1539[0].kind = 2; TMP1539[0].sons = &TMP1832[0];
NTI160018.node = &TMP1539[0];
}
