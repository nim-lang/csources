...
static NIM_CONST TY169850 TMP3068 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3069, "ident", 5);
static NIM_CONST TY169850 TMP3070 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3071, "sym", 3);
static NIM_CONST TY169850 TMP3072 = {
0xE0, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3073, "intVal", 6);
static NIM_CONST TY169850 TMP3074 = {
0x00, 0x00, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3075, "floatVal", 8);
static NIM_CONST TY169850 TMP3076 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3077, "strVal", 6);
static NIM_CONST TY169850 TMP3078 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3079, "sons", 4);
STRING_LITERAL(TMP3084, "data[h].key == nil ", 19);
STRING_LITERAL(TMP3085, "not t.data[index].key == nil ", 29);
...
N_NIMCALL(NI, hashtree_219014)(tnode169647* n) {
	...
	default:
	{
		...
		TMP3080 = subInt(LOC25, 1);
		HEX3Atmp_219159 = (NI64)(TMP3080);
	...
	LA3: ;
	{
		...
		default:
		{
			nimln(49, "treetab.nim");
			{
				...
				TMP3081 = subInt(LOC25, 1);
				HEX3Atmp_219337 = (NI64)(TMP3081);
				nimln(1274, "system.nim");
				res_219339 = 0;
				nimln(1275, "system.nim");
				while (1) {
...
static N_INLINE(NI, nexttry_176196)(NI h, NI maxhash) {
	...
	nimln(449, "astalgo.nim");
	TMP3082 = mulInt(5, h);
	TMP3083 = addInt((NI64)(TMP3082), 1);
	result = (NI)((NI64)(TMP3083) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, nodetablerawinsert_219378)(tnodepairseq169703** data, NI k, tnode169647* key, NI val) {
	...
	nimln(72, "treetab.nim");
	{
		...
		nimln(72, "treetab.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP3084));
	}
	LA4: ;
...
N_NIMCALL(void, nodetableput_219605)(tnodetable169705* t, tnode169647* key, NI val) {
	...
	nimln(81, "treetab.nim");
	{
		...
		nimln(82, "treetab.nim");
		{
			...
			nimln(82, "treetab.nim");
			hiddenraiseassert_71620(((NimStringDesc*) &TMP3085));
		}
		LA7: ;
	...
	LA3: ;
	{
		nimln(85, "treetab.nim");
		{
			...
			nimln(86, "treetab.nim");
			nimln(86, "treetab.nim");
			TMP3086 = mulInt((*t).Data->Sup.len, 2);
			n = (tnodepairseq169703*) newSeq((&NTI169703), (NI64)(TMP3086));
			i_219837 = 0;
			HEX3Atmp_219874 = 0;
...
N_NIMCALL(NI, nodetabletestorset_219881)(tnodetable169705* t, tnode169647* key, NI val) {
	...
	LA3: ;
	{
		nimln(102, "treetab.nim");
		{
			...
			nimln(103, "treetab.nim");
			nimln(103, "treetab.nim");
			TMP3087 = mulInt((*t).Data->Sup.len, 2);
			n = (tnodepairseq169703*) newSeq((&NTI169703), (NI64)(TMP3087));
			i_220037 = 0;
			HEX3Atmp_220074 = 0;
