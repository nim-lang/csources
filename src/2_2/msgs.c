...
N_NIMCALL(trope126007*, makecstring_128446)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(460, "msgs.nim");
		{
			...
			TMP780 = modInt((NI64)(TMP779), 64);
			if (!(((NI) ((NI64)(TMP780))) == 0)) goto LA4;
			nimln(461, "msgs.nim");
			res = addChar(res, 34);
			nimln(462, "msgs.nim");
...
N_NIMCALL(void, suggestquit_128921)(void) {
	...
	LA3: ;
	{
		...
		nimln(1797, "system.nim");
		LOC8 = 0;
		LOC8 = (*e_128925).Sup.message; (*e_128925).Sup.message = copyStringRC1(((NimStringDesc*) &TMP789));
...
N_NIMCALL(void, popinfocontext_129033)(void) {
	...
	nimln(575, "msgs.nim");
	nimln(575, "msgs.nim");
	TMP792 = subInt(msgcontext_128979->Sup.len, 1);
	msgcontext_128979 = (TY128959*) setLengthSeq(&(msgcontext_128979)->Sup, sizeof(tlineinfo128308), (NI64)(TMP792));
	popFrame();
}
	...
	while (1) {
		...
		nimln(658, "msgs.nim");
		{
			...
			nimln(659, "msgs.nim");
			{
				...
				nimln(660, "msgs.nim");
				if ((NU)(i_129321) >= (NU)(checkpoints_129174->Sup.len)) raiseIndexError();
				TMP823 = subInt(current.Col, checkpoints_129174->data[i_129321].Col);
...
N_NIMCALL(void, writecontext_129416)(tlineinfo128308 lastinfo) {
	...
	nimln(694, "msgs.nim");
	nimln(694, "msgs.nim");
	TMP824 = subInt(msgcontext_128979->Sup.len, 1);
	HEX3Atmp_129441 = (NI64)(TMP824);
	nimln(1274, "system.nim");
	res_129443 = 0;
	nimln(1275, "system.nim");
	while (1) {
		...
		nimln(695, "msgs.nim");
		{
			...
			nimln(699, "msgs.nim");
			LOC10[3] = getmessagestr_129292(((NU16) 184), ((NimStringDesc*) &TMP783));
			LOC11 = 0;
...
static N_INLINE(NI, nexttry_108407)(NI h, NI maxhash) {
	...
	nimln(70, "tables.nim");
	TMP6972 = mulInt(5, h);
	TMP6973 = addInt((NI64)(TMP6972), 1);
	result = (NI)((NI64)(TMP6973) & maxhash);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, mustrehash_108283)(NI length, NI counter) {
	...
	LOC5 = ((NI64)(TMP6975) < (NI64)(TMP6976));
	if (LOC5) goto LA6;
	nimln(67, "tables.nim");
	nimln(67, "tables.nim");
...
N_NIMCALL(void, enlarge_128637)(ttable128335* t) {
	...
	n = (tkeyvaluepairseq128340*) newSeq((&NTI128340), (NI64)(TMP6978));
	i_128674 = 0;
	HEX3Atmp_128723 = 0;
...
N_NOINLINE(void, msgsInit)(void) {
	...
	LOC7.ClPrc = ((TMP841) (HEX3Aanonymous_129824)); LOC7.ClEnv = NIM_NIL;
