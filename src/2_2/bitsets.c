...
STRING_LITERAL(TMP2977, "0 <= elem ", 10);
...
N_NIMCALL(NIM_BOOL, bitsetin_213055)(tbitset213008* x, NI64 e) {
	...
	nimln(34, "bitsets.nim");
	nimln(34, "bitsets.nim");
	TMP2975 = divInt64(e, 8);
	if ((NU)((NI64)(TMP2975)) >= (NU)(x->Sup.len)) raiseIndexError();
	nimln(34, "bitsets.nim");
	nimln(34, "bitsets.nim");
	nimln(34, "bitsets.nim");
	TMP2976 = modInt64(e, 8);
	result = !(((NI8)(x->data[(NI64)(TMP2975)] & ((NI8)(NU8)(NU)((NI)((NU64)(1) << (NU64)(((NI) ((NI64)(TMP2976)))))))) == ((NI8) 0)));
	popFrame();
	return result;
}
...
N_NIMCALL(void, bitsetincl_213043)(tbitset213008** x, NI64 elem) {
	...
	nimln(38, "bitsets.nim");
	{
		...
		if (!!((0 <= elem))) goto LA3;
		nimln(38, "bitsets.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP2977));
	}
	LA3: ;
	...
	(*x)->data[(NI64)(TMP2978)] = (NI8)((*x)->data[(NI64)(TMP2979)] | ((NI8)(NU8)(NU)((NI)((NU64)(1) << (NU64)(((NI) ((NI64)(TMP2980))))))));
	popFrame();
}
...
N_NIMCALL(void, bitsetexcl_213049)(tbitset213008** x, NI64 elem) {
	...
	nimln(44, "bitsets.nim");
	nimln(44, "bitsets.nim");
	TMP2983 = modInt64(elem, 8);
	(*x)->data[(NI64)(TMP2981)] = (NI8)((*x)->data[(NI64)(TMP2982)] & (NI8)((NU8) ~(((NI8)(NU8)(NU)((NI)((NU64)(1) << (NU64)(((NI) ((NI64)(TMP2983))))))))));
	popFrame();
}
N_NIMCALL(void, TMP2984)(void* p, NI op) {
	tbitset213008* a;
