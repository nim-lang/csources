...
N_NIMCALL(tfilestream133125*, newfilestream_133182)(FILE* f);
...
N_NIMCALL(tprocess134203*, startcmd_134246)(NimStringDesc* command, NU8 options) {
	...
	a = (TY9355*) newSeq((&NTI9355), (NI32)(TMP892));
	i_134291 = 0;
	HEX3Atmp_134293 = 0;
	nimln(86, "osproc.nim");
	nimln(86, "osproc.nim");
	...
	while (1) {
		...
		if ((NU)((NI32)(TMP894)) >= (NU)(a->Sup.len)) raiseIndexError();
		if ((NU)(i_134291) >= (NU)(c->Sup.len)) raiseIndexError();
		LOC2 = 0;
		LOC2 = a->data[(NI32)(TMP894)]; a->data[(NI32)(TMP894)] = copyStringRC1(c->data[i_134291]);
...
N_NIMCALL(NCSTRING*, tocstringarray_135424)(NimStringDesc** b, NI bLen0, NimStringDesc** a, NI aLen0) {
	...
	TMP913 = addInt((NI32)(TMP912), 1);
	TMP914 = mulInt((NI32)(TMP913), 4);
	LOC1 = alloc0_4004((NI32)(TMP914));
	...
	while (1) {
		...
		memcpy(((void*) (result[(i_135448)- 0])), ((void*) (b[i_135448]->data)), (NI32)(TMP916));
		nimln(1284, "system.nim");
	...
	while (1) {
		...
		if ((NU)((NI32)(TMP917)) > (NU)(50000)) raiseIndexError();
		nimln(500, "osproc.nim");
		nimln(500, "osproc.nim");
		nimln(500, "osproc.nim");
		if ((NU)(i_135456) >= (NU)(aLen0)) raiseIndexError();
		TMP918 = addInt(a[i_135456]->Sup.len, 1);
		LOC5 = alloc_4001((NI32)(TMP918));
		result[((NI32)(TMP917))- 0] = ((NCSTRING) (LOC5));
		nimln(501, "osproc.nim");
		nimln(501, "osproc.nim");
		nimln(501, "osproc.nim");
		TMP919 = addInt(i_135456, bLen0);
		if ((NU)((NI32)(TMP919)) > (NU)(50000)) raiseIndexError();
		if ((NU)(i_135456) >= (NU)(aLen0)) raiseIndexError();
		nimln(501, "osproc.nim");
		nimln(501, "osproc.nim");
		if ((NU)(i_135456) >= (NU)(aLen0)) raiseIndexError();
		TMP920 = addInt(a[i_135456]->Sup.len, 1);
		memcpy(((void*) (result[((NI32)(TMP919))- 0])), ((void*) (a[i_135456]->data)), (NI32)(TMP920));
		nimln(1284, "system.nim");
...
N_NIMCALL(NCSTRING*, tocstringarray_135482)(tstringtable103609* t) {
	...
	TMP922 = mulInt((NI32)(TMP921), 4);
	LOC2 = alloc0_4004((NI32)(TMP922));
...
appendString(LOC8, val_135489);
			...
			memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI32)(TMP925));
...
N_NIMCALL(NCSTRING*, envtocstringarray_135515)(void) {
	...
	while (1) {
		...
		key_135519 = copyStrLast(environment_95235->data[i_135552], 0, (NI32)(TMP926));
		nimln(1036, "os.nim");
		nimln(1036, "os.nim");
		if ((NU)(i_135552) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		nimln(1036, "os.nim");
		TMP927 = addInt(p_135558, 1);
		val_135520 = copyStr(environment_95235->data[i_135552], (NI32)(TMP927));
	...
	TMP929 = mulInt((NI32)(TMP928), 4);
	LOC2 = alloc0_4004((NI32)(TMP929));
	result = ((NCSTRING*) (LOC2));
	...
	while (1) {
		...
		key_135535 = copyStrLast(environment_95235->data[i_135568], 0, (NI32)(TMP930));
		nimln(1036, "os.nim");
		nimln(1036, "os.nim");
		if ((NU)(i_135568) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		nimln(1036, "os.nim");
		TMP931 = addInt(p_135574, 1);
		val_135536 = copyStr(environment_95235->data[i_135568], (NI32)(TMP931));
...
appendString(LOC4, val_135536);
		...
		memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI32)(TMP933));
...
N_NIMCALL(void, pruneprocessset_136136)(TY135003** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(727, "osproc.nim");
		{
			...
			nimln(728, "osproc.nim");
			TMP940 = subInt(l, 1);
			if ((NU)((NI32)(TMP940)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRefNoCycle((void**) &(*s)->data[i], (*s)->data[(NI32)(TMP940)]);
...
N_NIMCALL(NI, select_135301)(TY135003** readfds, NI timeout) {
	...
	nimln(743, "osproc.nim");
	{
		...
		nimln(744, "osproc.nim");
		TMP942 = addInt(m, 1);
		LOC5 = select(((int) ((NI32)(TMP942))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		nimln(746, "osproc.nim");
		TMP943 = addInt(m, 1);
		LOC7 = select(((int) ((NI32)(TMP943))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
