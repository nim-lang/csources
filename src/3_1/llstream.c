...
N_NIMCALL(NI, counttriples_158661)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1548 = addInt(i, 1);
			if ((NU)((NI32)(TMP1548)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI32)(TMP1548)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			...
			LOC4 = ((NU8)(s->data[(NI32)(TMP1549)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
appendString((*s).S, ((NimStringDesc*) &TMP1552));
	...
	result = ((buflen <= (NI32)(TMP1553)) ? buflen : (NI32)(TMP1553));
...
N_NIMCALL(NI, llstreamread_158242)(tllstream158204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		nimln(136, "llstream.nim");
		{
			...
			if ((NU)((NI32)(TMP1555)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI32)(TMP1555)])), result);
...
N_NIMCALL(void, llstreamwrite_158268)(tllstream158204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			(*s).S = setLengthStr((*s).S, (NI32)(TMP1556));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1557 = addInt(0, (*s).Wr);
			if ((NU)((NI32)(TMP1557)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI32)(TMP1557)])), buf, buflen);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_158254)(tllstream158204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI32)(TMP1558));
			nimln(223, "llstream.nim");
			nimln(223, "llstream.nim");
			TMP1559 = addInt(i, 0);
			if ((NU)((NI32)(TMP1559)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_9317((*s).F, ((void*) (&result->data[(NI32)(TMP1559)])), 2048);
