...
N_NIMCALL(NimStringDesc*, getenv_95823)(NimStringDesc* key) {
	...
	nimln(990, "os.nim");
	{
		...
		result = copyStr(environment_95235->data[i], (NI32)(TMP283));
		goto BeforeRet;
	}
	goto LA1;
	LA3: ;
...
appendString(LOC5, LOC6);
	...
	LA3: ;
	{
		...
		LOC9 = 0;
		LOC9 = copyStrLast(filename, 0, (NI32)(TMP306));
		nimln(700, "os.nim");
		LOC10 = 0;
...
N_NIMCALL(void, nosSplitPath)(NimStringDesc* path, TY81913* Result) {
	...
	nimln(540, "os.nim");
	{
		...
		unsureAsgnRef((void**) &(*Result).Field0, copyStrLast(path, 0, (NI32)(TMP308)));
		nimln(542, "os.nim");
		nimln(542, "os.nim");
		nimln(542, "os.nim");
		TMP309 = addInt(seppos, 1);
		unsureAsgnRef((void**) &(*Result).Field1, copyStr(path, (NI32)(TMP309)));
	}
	goto LA6;
	LA8: ;
	{
...
N_NIMCALL(void, nossplitFile)(NimStringDesc* path, TY94237* Result) {
	...
	nimln(634, "os.nim");
	{
		...
		if ((NU)((NI32)(TMP310)) > (NU)(path->Sup.len)) raiseIndexError();
		LOC3 = (((NU8)(path->data[(NI32)(TMP310)])) == ((NU8)(47)) || ((NU8)(path->data[(NI32)(TMP310)])) == ((NU8)(47)));
		LA4: ;
		if (!LOC3) goto LA5;
		nimln(635, "os.nim");
	...
	LA5: ;
	{
		...
		while (1) {
			...
			nimln(640, "os.nim");
			{
				...
				nimln(641, "os.nim");
				{
					...
					LOC15 = !((((NU8)(path->data[(NI32)(TMP312)])) == ((NU8)(47)) || ((NU8)(path->data[(NI32)(TMP312)])) == ((NU8)(47))));
					LA18: ;
					if (!LOC15) goto LA19;
					nimln(642, "os.nim");
					dotpos = i_94262;
		...
		unsureAsgnRef((void**) &(*Result).Field0, copyStrLast(path, 0, (NI32)(TMP313)));
		nimln(647, "os.nim");
		nimln(647, "os.nim");
		nimln(647, "os.nim");
		...
		unsureAsgnRef((void**) &(*Result).Field1, copyStrLast(path, (NI32)(TMP314), (NI32)(TMP315)));
		nimln(648, "os.nim");
		nimln(648, "os.nim");
...
N_NIMCALL(NimStringDesc*, nosJoinPath)(NimStringDesc* head, NimStringDesc* tail) {
	...
	LA3: ;
	{
		...
		if ((NU)((NI32)(TMP320)) > (NU)(head->Sup.len)) raiseIndexError();
		if (!(((NU8)(head->data[(NI32)(TMP320)])) == ((NU8)(47)) || ((NU8)(head->data[(NI32)(TMP320)])) == ((NU8)(47)))) goto LA6;
		nimln(491, "os.nim");
		{
			NimStringDesc* LOC12;
			NimStringDesc* LOC13;
	...
	while (1) {
		...
		nimln(1199, "os.nim");
		{
			...
			LA8: ;
			{
				...
				LOC11 = 0;
				LOC11 = copyStrLast(dir, 0, (NI32)(TMP324));
...
N_NIMCALL(NimStringDesc*, nosextractFilename)(NimStringDesc* path) {
	...
	nimln(654, "os.nim");
	{
		...
		if ((NU)((NI32)(TMP777)) > (NU)(path->Sup.len)) raiseIndexError();
		LOC3 = (((NU8)(path->data[(NI32)(TMP777)])) == ((NU8)(47)) || ((NU8)(path->data[(NI32)(TMP777)])) == ((NU8)(47)));
		LA4: ;
		if (!LOC3) goto LA5;
		nimln(655, "os.nim");
		result = copyString(((NimStringDesc*) &TMP284));
...
N_NIMCALL(void, nossleep)(NI milsecs) {
	...
	a.tv_sec = (NI32)(TMP902);
	nimln(1576, "os.nim");
	nimln(1576, "os.nim");
	nimln(1576, "os.nim");
	nimln(1576, "os.nim");
	TMP903 = modInt(milsecs, 1000);
	TMP904 = mulInt(((NI) ((NI32)(TMP903))), 1000);
	TMP905 = mulInt(((NI) ((NI32)(TMP904))), 1000);
	a.tv_nsec = ((NI) ((NI32)(TMP905)));
	nimln(1577, "os.nim");
	nimln(1577, "os.nim");
	LOC1 = nanosleep(&a, &b);
	popFrame();
...
N_NIMCALL(NimStringDesc*, nosparentDir)(NimStringDesc* path) {
	...
	nimln(558, "os.nim");
	{
		...
		if ((NU)((NI32)(TMP1838)) > (NU)(path->Sup.len)) raiseIndexError();
		if (!(((NU8)(path->data[(NI32)(TMP1838)])) == ((NU8)(47)) || ((NU8)(path->data[(NI32)(TMP1838)])) == ((NU8)(47)))) goto LA3;
		nimln(559, "os.nim");
		q = 2;
	}
	LA3: ;
	...
	nimln(564, "os.nim");
	{
		...
		result = copyStrLast(path, 0, (NI32)(TMP1840));
	}
	goto LA10;
	LA12: ;
	{
