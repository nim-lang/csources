...
N_NIMCALL(void, setintlittype_211395)(tnode168647* result);
...
N_NIMCALL(ttype168681*, getintlittype_211292)(tnode168647* literal) {
	...
	nimln(106, "magicsys.nim");
	{
		...
		result = inttypecache_211220[(((NI)chckRange64(value, (-2147483647 -1), 2147483647)))- -5];
		nimln(108, "magicsys.nim");
		{
			...
			if (((NI)chckRange64(value, (-2147483647 -1), 2147483647)) < -5 || ((NI)chckRange64(value, (-2147483647 -1), 2147483647)) > 64) raiseIndexError();
			asgnRefNoCycle((void**) &inttypecache_211220[(((NI)chckRange64(value, (-2147483647 -1), 2147483647)))- -5], result);
		}
		LA9: ;
	}
	goto LA1;
...
N_NIMCALL(void, setintlittype_211395)(tnode168647* result) {
	...
	default:
	{
		...
		internalerror_128690((*result).Info, ((NimStringDesc*) &TMP2966));
	}
	break;
	}
	popFrame();
