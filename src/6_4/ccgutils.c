...
static N_INLINE(ttype169681*, lastson_170015)(ttype169681* n) {
	...
	if ((NU)((NI32)(TMP5255)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP5255)];
	popFrame();
	return result;
}
...
N_NIMCALL(ttype169681*, getuniquetype_336401)(ttype169681* key) {
	...
	case ((NU8) 51):
	{
		...
		internalerror_129702(((NimStringDesc*) &TMP5253));
	}
	break;
	case ((NU8) 12):
	{
		nimln(92, "ccgutils.nim");
		internalerror_129702(((NimStringDesc*) &TMP5254));
	}
	break;
	case ((NU8) 11):
	case ((NU8) 13):
...
N_NIMCALL(trope126007*, makellvmstring_336606)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(170, "ccgutils.nim");
		{
			...
			TMP5260 = modInt((NI32)(TMP5259), 64);
			if (!(((NI) ((NI32)(TMP5260))) == 0)) goto LA4;
