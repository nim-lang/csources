...
STRING_LITERAL(TMP6801, "", 0);
STRING_LITERAL(TMP6808, "server.type", 11);
STRING_LITERAL(TMP6809, "stdin", 5);
STRING_LITERAL(TMP6810, "tcp", 3);
STRING_LITERAL(TMP6811, "quit", 4);
STRING_LITERAL(TMP6816, "server.port", 11);
STRING_LITERAL(TMP6817, "server.address", 14);
STRING_LITERAL(TMP6842, "\015\012", 2);
STRING_LITERAL(TMP6843, "Invalid server.type:", 20);
	...
	while (1) {
		...
		case ((NU8) 3):
		{
			...
			nimln(41, "service.nim");
			{
				...
				nimln(42, "service.nim");
				nimln(42, "service.nim");
				TMP6806 = subInt(bracketle, 1);
				key = copyStrLast(p.Key, 0, (NI32)(TMP6806));
				nimln(43, "service.nim");
				nimln(43, "service.nim");
				LOC8 = 0;
				nimln(43, "service.nim");
				nimln(43, "service.nim");
				TMP6807 = addInt(bracketle, 1);
				LOC9 = 0;
				LOC9 = copyStr(p.Key, (NI32)(TMP6807));
...
N_NIMCALL(void, serve_418077)(TY418079 action) {
	...
	typ = getconfigvar_105291(((NimStringDesc*) &TMP6808));
	nimln(73, "service.nim");
	if (eqStrings(typ, ((NimStringDesc*) &TMP6809))) goto LA1;
	if (eqStrings(typ, ((NimStringDesc*) &TMP6810))) goto LA2;
	...
	LA1: ;
	{
		...
		while (1) {
			...
			{
				nimln(77, "service.nim");
				if (!eqStrings(line, ((NimStringDesc*) &TMP6811))) goto LA9;
				nimln(77, "service.nim");
				exit(0);
			}
			LA9: ;
			...
			printf("%s\012", (((NimStringDesc*) &TMP6801))->data);
	...
	LA2: ;
	{
		...
		p = getconfigvar_105291(((NimStringDesc*) &TMP6816));
		...
		nimln(86, "service.nim");
		LOC19 = 0;
		LOC19 = getconfigvar_105291(((NimStringDesc*) &TMP6817));
		bindaddr_112552(server, port, LOC19);
		nimln(87, "service.nim");
		inp = copyString(((NimStringDesc*) &TMP6801));
		...
		while (1) {
			...
			send_120404(stdoutsocket_128876, ((NimStringDesc*) &TMP6842));
	...
	LA3: ;
	{
		...
		printf("%s%s\012", (((NimStringDesc*) &TMP6843))->data, (typ)->data);
...
N_NOINLINE(void, serviceInit)(void) {
	...
	LOC1 = 0;
	LOC1 = curcaascmd_418003; curcaascmd_418003 = copyStringRC1(((NimStringDesc*) &TMP6801));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(23, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_418004; lastcaascmd_418004 = copyStringRC1(((NimStringDesc*) &TMP6801));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(26, "service.nim");
	LOC3 = 0;
	LOC3 = arguments_418005; arguments_418005 = copyStringRC1(((NimStringDesc*) &TMP6801));
