	...
	case ((NU8) 3):
	{
		...
		nimln(26, "evaltempl.nim");
		{
			...
			LA8: ;
			{
				...
				nimln(40, "evaltempl.nim");
				LOC29 = 0;
				LOC29 = newsymnode_170095(x, (*templ).Info);
...
N_NIMCALL(tnode168647*, evaltemplateargs_244201)(tnode168647* n, tsym168677* s) {
	...
	nimln(86, "evaltempl.nim");
	{
		...
		if (!(f < a)) goto LA5;
		nimln(86, "evaltempl.nim");
		globalerror_128660((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP3372));
	}
	LA5: ;
	...
	while (1) {
		...
		nimln(91, "evaltempl.nim");
		{
			...
			localerror_128673((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP3372));
		}
		LA17: ;
...
N_NIMCALL(tnode168647*, evaltemplate_244280)(tnode168647* n, tsym168677* tmpl, tsym168677* gensymowner) {
	...
	nimln(100, "evaltempl.nim");
	{
		...
		globalerror_128660((*n).Info, ((NU16) 183), ((NimStringDesc*) &TMP3372));
	...
	body = getbody_208576(tmpl);
	nimln(112, "evaltempl.nim");
	{
		NIM_BOOL LOC7;
		nimln(112, "evaltempl.nim");
		LOC7 = isatom_173442(body);
		if (!LOC7) goto LA8;
		...
		LA13: ;
		{
			...
			globalerror_128660((*result).Info, ((NU16) 1), LOC16);
		}
		LA10: ;
	}
	goto LA5;
