...
N_NIMCALL(tstringtable103609*, nstnewStringTableWithTableConstr)(TY81915* keyvaluepairs, NI keyvaluepairsLen0, NU8 mode);
...
extern TNimType NTI81915; /* tuple[nonDST: string, DST: string] */
...
static N_INLINE(NI, nexttry_103807)(NI h, NI maxhash) {
	...
	nimln(89, "strtabs.nim");
	TMP273 = mulInt(5, h);
	TMP274 = addInt((NI64)(TMP273), 1);
	result = (NI)((NI64)(TMP274) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, enlarge_103881)(tstringtable103609* t) {
	...
	n = (tkeyvaluepairseq103607*) newSeq((&NTI103607), (NI64)(TMP278));
	i_103913 = 0;
	HEX3Atmp_103925 = 0;
...
N_NIMCALL(tstringtable103609*, nstnewStringTableWithPairs)(NimStringDesc** keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	...
	while (1) {
		...
		nimln(176, "strtabs.nim");
		TMP290 = addInt(i, 1);
		if ((NU)((NI64)(TMP290)) >= (NU)(keyvaluepairsLen0)) raiseIndexError();
		nstPut(result, keyvaluepairs[i], keyvaluepairs[(NI64)(TMP290)]);
...
N_NIMCALL(NimStringDesc*, nstFormat)(NimStringDesc* f, tstringtable103609* t, NU8 flags) {
	...
	while (1) {
		...
		nimln(197, "strtabs.nim");
		{
			...
			nimln(198, "strtabs.nim");
			TMP291 = addInt(i, 1);
			if ((NU)((NI64)(TMP291)) > (NU)(f->Sup.len)) raiseIndexError();
			switch (((NU8)(f->data[(NI64)(TMP291)]))) {
			case 36:
			{
			...
			case 123:
			{
				...
				TMP294 = subInt(j, 1);
				LOC11 = 0;
				LOC11 = copyStrLast(f, (NI64)(TMP293), (NI64)(TMP294));
				LOC12 = 0;
...
appendString(result, LOC12);
			...
			case 95:
			{
				...
				TMP298 = subInt(j, 1);
				LOC17 = 0;
				LOC17 = copyStrLast(f, (NI64)(TMP297), (NI64)(TMP298));
				LOC18 = 0;
