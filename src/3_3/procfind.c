...
N_NIMCALL(NIM_BOOL, equalgenericparams_261008)(tnode168647* proca, tnode168647* procb) {
	...
	while (1) {
		...
		nimln(19, "procfind.nim");
		{
			...
			internalerror_128687((*proca).Info, ((NimStringDesc*) &TMP3616));
		...
		nimln(22, "procfind.nim");
		{
			...
			internalerror_128687((*procb).Info, ((NimStringDesc*) &TMP3616));
...
N_NIMCALL(tsym168677*, searchforproc_261126)(tcontext254019* c, tscope168671* scope, tsym168677* fn) {
	...
	nimln(39, "procfind.nim");
	{
		NIM_BOOL LOC3;
		nimln(39, "procfind.nim");
		LOC3 = isgenericroutine_173345(fn);
		if (!LOC3) goto LA4;
		...
		while (1) {
			...
			nimln(44, "procfind.nim");
			{
				...
				if (!(LOC9)) goto LA10;
				nimln(44, "procfind.nim");
				LOC9 = isgenericroutine_173345(result);
				LA10: ;
				if (!LOC9) goto LA11;
	...
	LA4: ;
	{
		...
		while (1) {
			...
			nimln(55, "procfind.nim");
			{
				...
				nimln(55, "procfind.nim");
				nimln(55, "procfind.nim");
				LOC27 = isgenericroutine_173345(result);
				LOC25 = !(LOC27);
				LA26: ;
				if (!LOC25) goto LA28;
				...
				case ((NU8) 2):
				{
					...
					localerror_128673((*fn).Info, ((NU16) 66), (*(*fn).Name).S);
