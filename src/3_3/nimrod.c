...
STRING_LITERAL(TMP6961, "./", 2);
STRING_LITERAL(TMP6962, "", 0);
STRING_LITERAL(TMP6964, "nimrod.cfg", 10);
STRING_LITERAL(TMP6965, "js", 2);
STRING_LITERAL(TMP6966, "node ", 5);
...
extern NimStringDesc* arguments_417005;
...
appendString(LOC7, ((NimStringDesc*) &TMP6961));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
N_NIMCALL(void, handlecmdline_422603)(void) {
	...
	nimln(35, "nimrod.nim");
	{
		...
		if (!(LOC3 == 0)) goto LA4;
		nimln(36, "nimrod.nim");
		writecommandlineusage_141002();
	}
	goto LA1;
	LA4: ;
	{
		nimln(39, "nimrod.nim");
		processcmdline_417007(((NU8) 0), ((NimStringDesc*) &TMP6962));
		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP6963;
			TY94237 p;
			...
			nimln(41, "nimrod.nim");
			pushSafePoint(&TMP6963);
			TMP6963.status = setjmp(TMP6963.context);
			if (TMP6963.status == 0) {
				nimln(42, "nimrod.nim");
			...
			if (TMP6963.status != 0) reraiseException();
			nimln(45, "nimrod.nim");
			chckNil((void*)&p);
		...
		LA7: ;
		nimln(50, "nimrod.nim");
		loadconfigs_164454(((NimStringDesc*) &TMP6964));
		nimln(53, "nimrod.nim");
		initvars_137646();
		nimln(54, "nimrod.nim");
		processcmdline_417007(((NU8) 1), ((NimStringDesc*) &TMP6962));
		nimln(55, "nimrod.nim");
		maincommand_420812();
		nimln(56, "nimrod.nim");
		{
		...
		{
			nimln(58, "nimrod.nim");
			if (!(gerrorcounter_127868 == 0)) goto LA25;
			nimln(62, "nimrod.nim");
			{
				...
				nimln(63, "nimrod.nim");
				{
					...
					nimln(65, "nimrod.nim");
					LOC35 = 0;
					LOC35 = nosChangeFileExt(gprojectfull_105193, ((NimStringDesc*) &TMP6965));
					LOC36 = 0;
					LOC36 = prependcurdir_422401(LOC35);
					LOC37 = 0;
					LOC37 = completecfilepath_137675(LOC36, NIM_TRUE);
					ex = quoteifcontainswhite_78720(LOC37);
					nimln(66, "nimrod.nim");
					nimln(66, "nimrod.nim");
					LOC38 = 0;
					LOC38 = rawNewString(ex->Sup.len + arguments_417005->Sup.len + 6);
appendString(LOC38, ((NimStringDesc*) &TMP6966));
appendString(LOC38, ex);
appendChar(LOC38, 32);
appendString(LOC38, arguments_417005);
					execexternalprogram_137707(LOC38);
				}
				goto LA31;
				LA33: ;
				{
					...
					nimln(69, "nimrod.nim");
					LOC40 = 0;
					LOC40 = nosChangeFileExt(gprojectfull_105193, ((NimStringDesc*) &TMP6962));
					LOC41 = 0;
					LOC41 = prependcurdir_422401(LOC40);
					ex = quoteifcontainswhite_78720(LOC41);
					nimln(70, "nimrod.nim");
					nimln(70, "nimrod.nim");
					LOC42 = 0;
					LOC42 = rawNewString(ex->Sup.len + arguments_417005->Sup.len + 1);
appendString(LOC42, ex);
appendChar(LOC42, 32);
appendString(LOC42, arguments_417005);
					execexternalprogram_137707(LOC42);
				}
				LA31: ;
			}
			LA29: ;
...
N_NOINLINE(void, nimrodInit)(void) {
	...
	initdefines_131067();
	nimln(79, "nimrod.nim");
	handlecmdline_422603();
	nimln(80, "nimrod.nim");
	nimln(692, "system.nim");
	exit(((NI) (((NI8) ((0 < gerrorcounter_127868))))));
	popFrame();
}
