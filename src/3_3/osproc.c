...
typedef struct TY135003 TY135003;
...
struct TY135003 {
  TGenericSeq Sup;
  tprocess134203* data[SEQ_DECL_SIZE];
};
...
N_NIMCALL(NI, nospprocessID)(tprocess134203* p);
...
N_NIMCALL(NimStringDesc*, addcmdargs_135404)(NimStringDesc* command, NimStringDesc** args, NI argsLen0);
N_NIMCALL(NimStringDesc*, quoteifcontainswhite_78720)(NimStringDesc* s);
N_NIMCALL(NCSTRING*, tocstringarray_135424)(NimStringDesc** b, NI bLen0, NimStringDesc** a, NI aLen0);
N_NOCONV(void*, alloc0_4004)(NI size);
N_NIMCALL(NI, mulInt)(NI a, NI b);
N_NOCONV(void*, alloc_4001)(NI size);
N_NIMCALL(NCSTRING*, tocstringarray_135482)(tstringtable103609* t);
N_NIMCALL(NI, nstlen)(tstringtable103609* t);
N_NIMCALL(NCSTRING*, envtocstringarray_135515)(void);
...
N_NIMCALL(tprocess134203*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, tstringtable103609* env, NU8 options);
...
N_NIMCALL(void, nospclose)(tprocess134203* p);
N_NIMCALL(void, close_132675)(tstream132630* s);
N_NIMCALL(void, nospsuspend)(tprocess134203* p);
N_NIMCALL(void, nospresume)(tprocess134203* p);
N_NIMCALL(NIM_BOOL, nosprunning)(tprocess134203* p);
N_NIMCALL(void, nospterminate)(tprocess134203* p);
N_NIMCALL(NI, nospwaitForExit)(tprocess134203* p, NI timeout);
N_NIMCALL(NI, peekexitcode_134331)(tprocess134203* p);
N_NIMCALL(void, createstream_136009)(tstream132630** stream, NI32* handle, NU8 filemode);
...
N_NIMCALL(tstream132630*, nosperrorStream)(tprocess134203* p);
N_NIMCALL(NI, nospexecCmd)(NimStringDesc* command);
N_NIMCALL(void, createfdset_136082)(fd_set* fd, TY135003* s, NI* m);
N_NIMCALL(void, pruneprocessset_136136)(TY135003** s, fd_set* fd);
N_NIMCALL(TGenericSeq*, setLengthSeq)(TGenericSeq* seq, NI elemsize, NI newlen);
N_NIMCALL(NI, select_135301)(TY135003** readfds, NI timeout);
static N_INLINE(NI, chckRange)(NI i, NI a, NI b);
N_NOINLINE(void, raiseRangeError)(NI64 val);
N_NIMCALL(void, execcmdex_136402)(NimStringDesc* command, NU8 options, TY71482* Result);
STRING_LITERAL(TMP895, "", 0);
STRING_LITERAL(TMP896, "0 < n ", 6);
STRING_LITERAL(TMP908, "", 0);
STRING_LITERAL(TMP909, "\012", 1);
STRING_LITERAL(TMP911, " ", 1);
STRING_LITERAL(TMP923, "=", 1);
STRING_LITERAL(TMP935, "sh", 2);
STRING_LITERAL(TMP936, "-c", 2);
NIM_CONST TY105434 TMP934 = {((NimStringDesc*) &TMP935),
((NimStringDesc*) &TMP936)}
;
NIM_CONST TY71482 TMP944 = {((NimStringDesc*) &TMP908),
-1}
;
...
TNimType NTI134205; /* PProcess */
TNimType NTI135003; /* seq[PProcess] */
...
N_NIMCALL(tprocess134203*, startcmd_134246)(NimStringDesc* command, NU8 options) {
	...
	nimln(85, "osproc.nim");
	nimln(85, "osproc.nim");
	TMP892 = subInt(c->Sup.len, 1);
	a = (TY9355*) newSeq((&NTI9355), (NI64)(TMP892));
	i_134291 = 0;
	HEX3Atmp_134293 = 0;
	nimln(86, "osproc.nim");
	nimln(86, "osproc.nim");
	nimln(86, "osproc.nim");
	TMP893 = subInt(c->Sup.len, 1);
	HEX3Atmp_134293 = (NI64)(TMP893);
	...
	while (1) {
		...
		NimStringDesc* LOC2;
		nimln(1282, "system.nim");
		if (!(res_134295 <= HEX3Atmp_134293)) goto LA1;
		nimln(1281, "system.nim");
		i_134291 = res_134295;
		nimln(86, "osproc.nim");
		nimln(86, "osproc.nim");
		TMP894 = subInt(i_134291, 1);
		if ((NU)((NI64)(TMP894)) >= (NU)(a->Sup.len)) raiseIndexError();
		if ((NU)(i_134291) >= (NU)(c->Sup.len)) raiseIndexError();
		LOC2 = 0;
		LOC2 = a->data[(NI64)(TMP894)]; a->data[(NI64)(TMP894)] = copyStringRC1(c->data[i_134291]);
		if (LOC2) nimGCunrefNoCycle(LOC2);
		nimln(1284, "system.nim");
		res_134295 = addInt(res_134295, 1);
	} LA1: ;
	nimln(87, "osproc.nim");
	if ((NU)(0) >= (NU)(c->Sup.len)) raiseIndexError();
	result = nospstartProcess(c->data[0], ((NimStringDesc*) &TMP895), a->data, a->Sup.len, NIM_NIL, options);
	popFrame();
	return result;
}
...
N_NIMCALL(NI, nospcountProcessors)(void) {
	...
	numcpu = 0;
	len = 0;
	nimln(153, "osproc.nim");
	mib[(0)- 0] = ((int) 6);
	nimln(154, "osproc.nim");
	mib[(1)- 0] = ((int) 25);
	nimln(155, "osproc.nim");
	len = 8;
	nimln(156, "osproc.nim");
	nimln(156, "osproc.nim");
	LOC1 = sysctl(mib, ((int) 2), ((void*) (&numcpu)), &len, NIM_NIL, 0);
	nimln(157, "osproc.nim");
	{
		int LOC6;
		nimln(157, "osproc.nim");
...
N_NIMCALL(NI, nospexecProcesses)(NimStringDesc** cmds, NI cmdsLen0, NU8 options_134624, NI n) {
	...
	nimln(181, "osproc.nim");
	{
		...
		if (!!((0 < n))) goto LA3;
		nimln(181, "osproc.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP896));
	}
	LA3: ;
	nimln(182, "osproc.nim");
	{
		...
		nimln(186, "osproc.nim");
		TMP901 = subInt(m, 1);
		HEX3Atmp_135278 = (NI64)(TMP901);
		nimln(1281, "system.nim");
		res_135280 = 0;
		nimln(1282, "system.nim");
		while (1) {
			nimln(1282, "system.nim");
			if (!(res_135280 <= HEX3Atmp_135278)) goto LA9;
			nimln(1281, "system.nim");
			i_135034 = res_135280;
			nimln(187, "osproc.nim");
			if ((NU)(i_135034) >= (NU)(q->Sup.len)) raiseIndexError();
			if ((NU)(i_135034) >= (NU)(cmdsLen0)) raiseIndexError();
			asgnRefNoCycle((void**) &q->data[i_135034], startcmd_134246(cmds[i_135034], options));
			nimln(1284, "system.nim");
			res_135280 = addInt(res_135280, 1);
		} LA9: ;
		...
		while (1) {
			...
			nimln(206, "osproc.nim");
			TMP906 = subInt(n, 1);
			HEX3Atmp_135282 = (NI64)(TMP906);
			nimln(1281, "system.nim");
			res_135284 = 0;
			nimln(1282, "system.nim");
			while (1) {
				nimln(1282, "system.nim");
				if (!(res_135284 <= HEX3Atmp_135282)) goto LA11;
				nimln(1281, "system.nim");
				r_135211 = res_135284;
				nimln(207, "osproc.nim");
				{
					...
					nimln(207, "osproc.nim");
					nimln(207, "osproc.nim");
					if ((NU)(r_135211) >= (NU)(q->Sup.len)) raiseIndexError();
					LOC14 = nosprunning(q->data[r_135211]);
					if (!!(LOC14)) goto LA15;
					nimln(209, "osproc.nim");
					nimln(209, "osproc.nim");
					nimln(209, "osproc.nim");
					if ((NU)(r_135211) >= (NU)(q->Sup.len)) raiseIndexError();
					LOC17 = nospwaitForExit(q->data[r_135211], -1);
					...
					nimln(210, "osproc.nim");
					{
						...
						nimln(684, "system.nim");
						if ((NU)(r_135211) >= (NU)(q->Sup.len)) raiseIndexError();
						if (!!((q->data[r_135211] == NIM_NIL))) goto LA20;
						nimln(210, "osproc.nim");
						if ((NU)(r_135211) >= (NU)(q->Sup.len)) raiseIndexError();
						nospclose(q->data[r_135211]);
					}
					LA20: ;
					nimln(211, "osproc.nim");
					if ((NU)(r_135211) >= (NU)(q->Sup.len)) raiseIndexError();
					if ((NU)(i) >= (NU)(cmdsLen0)) raiseIndexError();
					asgnRefNoCycle((void**) &q->data[r_135211], startcmd_134246(cmds[i], options));
				...
				LA15: ;
				nimln(1284, "system.nim");
				res_135284 = addInt(res_135284, 1);
			} LA11: ;
		} LA10: ;
		j_135248 = 0;
		HEX3Atmp_135286 = 0;
		...
		while (1) {
			NI LOC31;
			nimln(1282, "system.nim");
			if (!(res_135288 <= HEX3Atmp_135286)) goto LA26;
			nimln(1281, "system.nim");
			j_135248 = res_135288;
			nimln(215, "osproc.nim");
			{
				nimln(684, "system.nim");
				nimln(684, "system.nim");
				if ((NU)(j_135248) >= (NU)(q->Sup.len)) raiseIndexError();
				if (!!((q->data[j_135248] == NIM_NIL))) goto LA29;
				nimln(215, "osproc.nim");
				if ((NU)(j_135248) >= (NU)(q->Sup.len)) raiseIndexError();
				nospclose(q->data[j_135248]);
			}
			LA29: ;
			...
			nimln(216, "osproc.nim");
			if ((NU)(j_135248) >= (NU)(q->Sup.len)) raiseIndexError();
			LOC31 = nospwaitForExit(q->data[j_135248], -1);
			result = ((LOC31 >= result) ? LOC31 : result);
			nimln(1284, "system.nim");
			res_135288 = addInt(res_135288, 1);
		} LA26: ;
	}
	goto LA5;
	LA7: ;
	{
		...
		while (1) {
			...
			NI LOC34;
			nimln(1282, "system.nim");
			if (!(res_135292 <= HEX3Atmp_135290)) goto LA33;
			nimln(1281, "system.nim");
			i_135271 = res_135292;
			nimln(219, "osproc.nim");
			if ((NU)(i_135271) >= (NU)(cmdsLen0)) raiseIndexError();
			p = startcmd_134246(cmds[i_135271], options);
			...
			nospclose(p);
			nimln(1284, "system.nim");
			res_135292 = addInt(res_135292, 1);
		} LA33: ;
	}
	LA5: ;
	popFrame();
...
N_NIMCALL(NimStringDesc*, nospexecProcess)(NimStringDesc* command, NU8 options) {
	...
	p = startcmd_134246(command, options);
	nimln(237, "osproc.nim");
	outp = nospoutputStream(p);
	nimln(238, "osproc.nim");
	result = copyString(((NimStringDesc*) &TMP908));
	...
	while (1) {
		nimln(241, "osproc.nim");
		{
			NIM_BOOL LOC4;
			nimln(241, "osproc.nim");
			LOC4 = readline_132979(outp, &line);
			if (!LOC4) goto LA5;
...
appendString(result, ((NimStringDesc*) &TMP909));
		}
		goto LA2;
		LA5: ;
		{
...
N_NIMCALL(NimStringDesc*, addcmdargs_135404)(NimStringDesc* command, NimStringDesc** args, NI argsLen0) {
	...
	while (1) {
		NimStringDesc* LOC2;
		nimln(1282, "system.nim");
		if (!(res_135420 <= HEX3Atmp_135418)) goto LA1;
		nimln(1281, "system.nim");
		i_135417 = res_135420;
		nimln(491, "osproc.nim");
		result = resizeString(result, 1);
appendString(result, ((NimStringDesc*) &TMP911));
		nimln(492, "osproc.nim");
		nimln(492, "osproc.nim");
		if ((NU)(i_135417) >= (NU)(argsLen0)) raiseIndexError();
		LOC2 = 0;
		LOC2 = quoteifcontainswhite_78720(args[i_135417]);
		result = resizeString(result, LOC2->Sup.len + 0);
appendString(result, LOC2);
		nimln(1284, "system.nim");
		res_135420 = addInt(res_135420, 1);
	} LA1: ;
	popFrame();
	return result;
}
...
N_NIMCALL(NCSTRING*, tocstringarray_135424)(NimStringDesc** b, NI bLen0, NimStringDesc** a, NI aLen0) {
	...
	nimln(495, "osproc.nim");
	nimln(495, "osproc.nim");
	TMP912 = addInt(aLen0, bLen0);
	TMP913 = addInt((NI64)(TMP912), 1);
	TMP914 = mulInt((NI64)(TMP913), 8);
	LOC1 = alloc0_4004((NI64)(TMP914));
	result = ((NCSTRING*) (LOC1));
	i_135448 = 0;
	HEX3Atmp_135470 = 0;
	nimln(496, "osproc.nim");
	nimln(496, "osproc.nim");
	HEX3Atmp_135470 = (bLen0-1);
	nimln(1281, "system.nim");
	res_135472 = 0;
	nimln(1282, "system.nim");
	while (1) {
		...
		NI TMP916;
		nimln(1282, "system.nim");
		if (!(res_135472 <= HEX3Atmp_135470)) goto LA2;
		nimln(1281, "system.nim");
		i_135448 = res_135472;
		nimln(497, "osproc.nim");
		if ((NU)(i_135448) > (NU)(50000)) raiseIndexError();
		nimln(497, "osproc.nim");
		nimln(497, "osproc.nim");
		nimln(497, "osproc.nim");
		if ((NU)(i_135448) >= (NU)(bLen0)) raiseIndexError();
		TMP915 = addInt(b[i_135448]->Sup.len, 1);
		LOC3 = alloc_4001((NI64)(TMP915));
		result[(i_135448)- 0] = ((NCSTRING) (LOC3));
		...
		nimln(498, "osproc.nim");
		if ((NU)(i_135448) >= (NU)(bLen0)) raiseIndexError();
		TMP916 = addInt(b[i_135448]->Sup.len, 1);
		memcpy(((void*) (result[(i_135448)- 0])), ((void*) (b[i_135448]->data)), (NI64)(TMP916));
		nimln(1284, "system.nim");
		res_135472 = addInt(res_135472, 1);
	} LA2: ;
	i_135456 = 0;
	HEX3Atmp_135475 = 0;
	nimln(499, "osproc.nim");
	nimln(499, "osproc.nim");
	HEX3Atmp_135475 = (aLen0-1);
	nimln(1281, "system.nim");
	res_135477 = 0;
	nimln(1282, "system.nim");
	while (1) {
		...
		NI TMP920;
		nimln(1282, "system.nim");
		if (!(res_135477 <= HEX3Atmp_135475)) goto LA4;
		nimln(1281, "system.nim");
		i_135456 = res_135477;
		nimln(500, "osproc.nim");
		nimln(500, "osproc.nim");
		nimln(500, "osproc.nim");
		TMP917 = addInt(i_135456, bLen0);
		if ((NU)((NI64)(TMP917)) > (NU)(50000)) raiseIndexError();
		nimln(500, "osproc.nim");
		nimln(500, "osproc.nim");
		nimln(500, "osproc.nim");
		if ((NU)(i_135456) >= (NU)(aLen0)) raiseIndexError();
		TMP918 = addInt(a[i_135456]->Sup.len, 1);
		LOC5 = alloc_4001((NI64)(TMP918));
		result[((NI64)(TMP917))- 0] = ((NCSTRING) (LOC5));
		nimln(501, "osproc.nim");
		nimln(501, "osproc.nim");
		nimln(501, "osproc.nim");
		TMP919 = addInt(i_135456, bLen0);
		if ((NU)((NI64)(TMP919)) > (NU)(50000)) raiseIndexError();
		if ((NU)(i_135456) >= (NU)(aLen0)) raiseIndexError();
		nimln(501, "osproc.nim");
		nimln(501, "osproc.nim");
		if ((NU)(i_135456) >= (NU)(aLen0)) raiseIndexError();
		TMP920 = addInt(a[i_135456]->Sup.len, 1);
		memcpy(((void*) (result[((NI64)(TMP919))- 0])), ((void*) (a[i_135456]->data)), (NI64)(TMP920));
		nimln(1284, "system.nim");
		res_135477 = addInt(res_135477, 1);
	} LA4: ;
	popFrame();
	return result;
}
...
N_NIMCALL(NCSTRING*, tocstringarray_135482)(tstringtable103609* t) {
	...
	void* LOC2;
	NI i;
	NimStringDesc* key_135488;
	NimStringDesc* val_135489;
	NI h_135508;
	NI HEX3Atmp_135510;
	NI res_135512;
	nimfr("ToCStringArray", "osproc.nim")
	...
	nimln(504, "osproc.nim");
	LOC1 = nstlen(t);
	TMP921 = addInt(LOC1, 1);
	TMP922 = mulInt((NI64)(TMP921), 8);
	LOC2 = alloc0_4004((NI64)(TMP922));
	...
	nimln(40, "strtabs.nim");
	HEX3Atmp_135510 = ((*t).Data->Sup.len-1);
	nimln(1281, "system.nim");
	res_135512 = 0;
	nimln(1282, "system.nim");
	while (1) {
		nimln(1282, "system.nim");
		if (!(res_135512 <= HEX3Atmp_135510)) goto LA3;
		nimln(1281, "system.nim");
		h_135508 = res_135512;
		nimln(41, "strtabs.nim");
		{
			...
			nimln(41, "strtabs.nim");
			nimln(41, "strtabs.nim");
			if ((NU)(h_135508) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			if (!!((*t).Data->data[h_135508].Field0 == 0)) goto LA6;
			nimln(42, "strtabs.nim");
			if ((NU)(h_135508) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			key_135488 = (*t).Data->data[h_135508].Field0;
			nimln(42, "strtabs.nim");
			if ((NU)(h_135508) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			val_135489 = (*t).Data->data[h_135508].Field1;
			nimln(507, "osproc.nim");
			nimln(507, "osproc.nim");
			LOC8 = 0;
			LOC8 = rawNewString(key_135488->Sup.len + val_135489->Sup.len + 1);
appendString(LOC8, key_135488);
appendString(LOC8, ((NimStringDesc*) &TMP923));
appendString(LOC8, val_135489);
			x = LOC8;
			...
			nimln(508, "osproc.nim");
			nimln(508, "osproc.nim");
			TMP924 = addInt(x->Sup.len, 1);
			LOC9 = alloc_4001((NI64)(TMP924));
			...
			nimln(509, "osproc.nim");
			nimln(509, "osproc.nim");
			TMP925 = addInt(x->Sup.len, 1);
			memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI64)(TMP925));
			nimln(510, "osproc.nim");
			i = addInt(i, 1);
		}
		LA6: ;
		nimln(1284, "system.nim");
		res_135512 = addInt(res_135512, 1);
	} LA3: ;
	popFrame();
	return result;
}
...
N_NIMCALL(NCSTRING*, envtocstringarray_135515)(void) {
	NCSTRING* result;
	NI counter;
	NimStringDesc* key_135519;
	NimStringDesc* val_135520;
	NI i_135552;
	NI HEX3Atmp_135554;
	NI res_135556;
	NI TMP928;
	...
	void* LOC2;
	NI i;
	NimStringDesc* key_135535;
	NimStringDesc* val_135536;
	NI i_135568;
	NI HEX3Atmp_135570;
	NI res_135572;
	...
	nimln(1033, "os.nim");
	nimln(1033, "os.nim");
	HEX3Atmp_135554 = (environment_95235->Sup.len-1);
	nimln(1281, "system.nim");
	res_135556 = 0;
	nimln(1282, "system.nim");
	while (1) {
		...
		NI TMP927;
		nimln(1282, "system.nim");
		if (!(res_135556 <= HEX3Atmp_135554)) goto LA1;
		nimln(1281, "system.nim");
		i_135552 = res_135556;
		nimln(1034, "os.nim");
		if ((NU)(i_135552) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		p_135558 = nsuFindChar(environment_95235->data[i_135552], 61, 0);
		nimln(1035, "os.nim");
		nimln(1035, "os.nim");
		if ((NU)(i_135552) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		nimln(1035, "os.nim");
		TMP926 = subInt(p_135558, 1);
		key_135519 = copyStrLast(environment_95235->data[i_135552], 0, (NI64)(TMP926));
		nimln(1036, "os.nim");
		nimln(1036, "os.nim");
		if ((NU)(i_135552) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		nimln(1036, "os.nim");
		TMP927 = addInt(p_135558, 1);
		val_135520 = copyStr(environment_95235->data[i_135552], (NI64)(TMP927));
		nimln(514, "osproc.nim");
		counter = addInt(counter, 1);
		nimln(1284, "system.nim");
		res_135556 = addInt(res_135556, 1);
	} LA1: ;
	nimln(515, "osproc.nim");
	nimln(515, "osproc.nim");
	nimln(515, "osproc.nim");
	nimln(515, "osproc.nim");
	TMP928 = addInt(counter, 1);
	TMP929 = mulInt((NI64)(TMP928), 8);
	LOC2 = alloc0_4004((NI64)(TMP929));
	result = ((NCSTRING*) (LOC2));
	...
	nimln(1033, "os.nim");
	nimln(1033, "os.nim");
	HEX3Atmp_135570 = (environment_95235->Sup.len-1);
	nimln(1281, "system.nim");
	res_135572 = 0;
	nimln(1282, "system.nim");
	while (1) {
		...
		NI TMP933;
		nimln(1282, "system.nim");
		if (!(res_135572 <= HEX3Atmp_135570)) goto LA3;
		nimln(1281, "system.nim");
		i_135568 = res_135572;
		nimln(1034, "os.nim");
		if ((NU)(i_135568) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		p_135574 = nsuFindChar(environment_95235->data[i_135568], 61, 0);
		nimln(1035, "os.nim");
		nimln(1035, "os.nim");
		if ((NU)(i_135568) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		nimln(1035, "os.nim");
		TMP930 = subInt(p_135574, 1);
		key_135535 = copyStrLast(environment_95235->data[i_135568], 0, (NI64)(TMP930));
		nimln(1036, "os.nim");
		nimln(1036, "os.nim");
		if ((NU)(i_135568) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		nimln(1036, "os.nim");
		TMP931 = addInt(p_135574, 1);
		val_135536 = copyStr(environment_95235->data[i_135568], (NI64)(TMP931));
		nimln(518, "osproc.nim");
		nimln(518, "osproc.nim");
		LOC4 = 0;
		LOC4 = rawNewString(key_135535->Sup.len + val_135536->Sup.len + 1);
appendString(LOC4, key_135535);
appendString(LOC4, ((NimStringDesc*) &TMP923));
appendString(LOC4, val_135536);
		x = LOC4;
		...
		nimln(519, "osproc.nim");
		nimln(519, "osproc.nim");
		TMP932 = addInt(x->Sup.len, 1);
		LOC5 = alloc_4001((NI64)(TMP932));
		...
		nimln(520, "osproc.nim");
		nimln(520, "osproc.nim");
		TMP933 = addInt(x->Sup.len, 1);
		memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI64)(TMP933));
		nimln(521, "osproc.nim");
		i = addInt(i, 1);
		nimln(1284, "system.nim");
		res_135572 = addInt(res_135572, 1);
	} LA3: ;
	popFrame();
	return result;
}
...
N_NIMCALL(tprocess134203*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, tstringtable103609* env, NU8 options) {
	...
	result = (tprocess134203*) newObj((&NTI134205), sizeof(tprocess134203));
	(*result).Sup.m_type = (&NTI134203);
	...
	nimln(568, "osproc.nim");
	{
		...
		nimln(568, "osproc.nim");
		e = envtocstringarray_135515();
	}
	goto LA104;
	LA106: ;
	{
		nimln(568, "osproc.nim");
		e = tocstringarray_135482(env);
	}
	LA104: ;
	a = 0;
	res = 0;
	...
	nimln(572, "osproc.nim");
	{
		...
		a = tocstringarray_135424(LOC117, 1, args, argsLen0);
	...
	LA115: ;
	{
		...
		x = addcmdargs_135404(command, args, argsLen0);
		nimln(577, "osproc.nim");
		memset((void*)LOC119, 0, sizeof(LOC119));
		LOC119[0] = copyString(x);
		a = tocstringarray_135424(TMP934, 2, LOC119, 1);
	...
	nimln(623, "osproc.nim");
	{
		...
		nimln(624, "osproc.nim");
		LOC131 = 0;
		LOC131 = nsuJoinSep(args, argsLen0, ((NimStringDesc*) &TMP911));
		printf("%s%s%s\012", (command)->data, (((NimStringDesc*) &TMP911))->data, (LOC131)->data);
	}
	LA129: ;
...
N_NIMCALL(void, createstream_136009)(tstream132630** stream, NI32* handle, NU8 filemode) {
	...
	nimln(695, "osproc.nim");
	LOC7 = 0;
	LOC7 = newfilestream_133183(f);
	unsureAsgnRef((void**) &(*stream), &LOC7->Sup);
	popFrame();
}

N_NIMCALL(tstream132630*, nospinputStream)(tprocess134203* p) {
	tstream132630* result;
	...
	nimln(698, "osproc.nim");
	{
		...
		createstream_136009(&(*p).Instream, &(*p).Inputhandle, ((NU8) 1));
	}
	LA3: ;
...
N_NIMCALL(tstream132630*, nospoutputStream)(tprocess134203* p) {
	...
	nimln(703, "osproc.nim");
	{
		...
		createstream_136009(&(*p).Outstream, &(*p).Outputhandle, ((NU8) 0));
	}
	LA3: ;
...
N_NIMCALL(tstream132630*, nosperrorStream)(tprocess134203* p) {
	...
	nimln(708, "osproc.nim");
	{
		...
		createstream_136009(&(*p).Errstream, &(*p).Errorhandle, ((NU8) 0));
	}
	LA3: ;
...
N_NIMCALL(void, createfdset_136082)(fd_set* fd, TY135003* s, NI* m) {
	...
	while (1) {
		nimln(1367, "system.nim");
		nimln(1367, "system.nim");
		if (!(i_136133 < s->Sup.len)) goto LA1;
		nimln(1368, "system.nim");
		if ((NU)(i_136133) >= (NU)(s->Sup.len)) raiseIndexError();
		i_136125 = s->data[i_136133];
		nimln(720, "osproc.nim");
		nimln(720, "osproc.nim");
		(*m) = (((*m) >= ((NI) ((*i_136125).Outputhandle))) ? (*m) : ((NI) ((*i_136125).Outputhandle)));
		nimln(721, "osproc.nim");
		FD_SET((*i_136125).Outputhandle, fd);
		nimln(1369, "system.nim");
		i_136133 = addInt(i_136133, 1);
	} LA1: ;
	popFrame();
}
...
N_NIMCALL(void, pruneprocessset_136136)(TY135003** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(727, "osproc.nim");
		{
			...
			nimln(728, "osproc.nim");
			TMP940 = subInt(l, 1);
			if ((NU)((NI64)(TMP940)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRefNoCycle((void**) &(*s)->data[i], (*s)->data[(NI64)(TMP940)]);
	...
	(*s) = (TY135003*) setLengthSeq(&((*s))->Sup, sizeof(tprocess134203*), l);
	popFrame();
}
...
N_NIMCALL(NI, select_135301)(TY135003** readfds, NI timeout) {
	...
	nimln(737, "osproc.nim");
	TMP941 = mulInt(timeout, 1000);
	tv.tv_usec = (NI64)(TMP941);
	memset((void*)&rd, 0, sizeof(rd));
	nimln(740, "osproc.nim");
	m = 0;
	nimln(741, "osproc.nim");
	createfdset_136082(&rd, (*readfds), &m);
	nimln(743, "osproc.nim");
	{
		...
		nimln(744, "osproc.nim");
		TMP942 = addInt(m, 1);
		LOC5 = select(((int)chckRange((NI64)(TMP942), ((int) (-2147483647 -1)), ((int) 2147483647))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		nimln(746, "osproc.nim");
		TMP943 = addInt(m, 1);
		LOC7 = select(((int)chckRange((NI64)(TMP943), ((int) (-2147483647 -1)), ((int) 2147483647))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
	nimln(748, "osproc.nim");
	pruneprocessset_136136(readfds, &rd);
	popFrame();
	return result;
}
...
N_NIMCALL(void, execcmdex_136402)(NimStringDesc* command, NU8 options, TY71482* Result) {
	...
	unsureAsgnRef((void**) &(*Result).Field0, copyString(TMP944.Field0));
	(*Result).Field1 = TMP944.Field1;
...
appendString((*Result).Field0, ((NimStringDesc*) &TMP909));
		}
		goto LA2;
		LA5: ;
		{
			nimln(766, "osproc.nim");
			(*Result).Field1 = peekexitcode_134331(p);
...
static TNimNode* TMP897[8];
static TNimNode TMP879[9];
NTI134203.size = sizeof(tprocess134203);
NTI134203.kind = 17;
NTI134203.base = (&NTI1009);
NTI134203.flags = 2;
TMP897[0] = &TMP879[1];
TMP879[1].kind = 1;
TMP879[1].offset = offsetof(tprocess134203, Inputhandle);
TMP879[1].typ = (&NTI9008);
TMP879[1].name = "inputHandle";
TMP897[1] = &TMP879[2];
TMP879[2].kind = 1;
TMP879[2].offset = offsetof(tprocess134203, Outputhandle);
TMP879[2].typ = (&NTI9008);
TMP879[2].name = "outputHandle";
TMP897[2] = &TMP879[3];
TMP879[3].kind = 1;
TMP879[3].offset = offsetof(tprocess134203, Errorhandle);
TMP879[3].typ = (&NTI9008);
TMP879[3].name = "errorHandle";
TMP897[3] = &TMP879[4];
TMP879[4].kind = 1;
TMP879[4].offset = offsetof(tprocess134203, Instream);
TMP879[4].typ = (&NTI132628);
TMP879[4].name = "inStream";
TMP897[4] = &TMP879[5];
TMP879[5].kind = 1;
TMP879[5].offset = offsetof(tprocess134203, Outstream);
TMP879[5].typ = (&NTI132628);
TMP879[5].name = "outStream";
TMP897[5] = &TMP879[6];
TMP879[6].kind = 1;
TMP879[6].offset = offsetof(tprocess134203, Errstream);
TMP879[6].typ = (&NTI132628);
TMP879[6].name = "errStream";
TMP897[6] = &TMP879[7];
TMP879[7].kind = 1;
TMP879[7].offset = offsetof(tprocess134203, Id);
TMP879[7].typ = (&NTI84455);
TMP879[7].name = "id";
TMP897[7] = &TMP879[8];
TMP879[8].kind = 1;
TMP879[8].offset = offsetof(tprocess134203, Exitcode);
TMP879[8].typ = (&NTI3701);
TMP879[8].name = "exitCode";
TMP879[0].len = 8; TMP879[0].kind = 2; TMP879[0].sons = &TMP897[0];
NTI134203.node = &TMP879[0];
NTI134205.size = sizeof(tprocess134203*);
NTI134205.kind = 22;
NTI134205.base = (&NTI134203);
NTI134205.flags = 2;
NTI134205.marker = TMP899;
NTI135003.size = sizeof(TY135003*);
NTI135003.kind = 24;
NTI135003.base = (&NTI134205);
NTI135003.flags = 2;
NTI135003.marker = TMP900;
}
