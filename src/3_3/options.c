...
N_NIMCALL(NimStringDesc*, removetrailingdirsep_105410)(NimStringDesc* path) {
	...
	nimln(200, "options.nim");
	{
		...
		if ((NU)((NI64)(TMP318)) > (NU)(path->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(path->data[(NI64)(TMP318)]) == (NU8)(47));
		LA4: ;
		if (!LOC3) goto LA5;
		...
		result = copyStrLast(path, 0, (NI64)(TMP319));
	}
	goto LA1;
	LA5: ;
	{
...
N_NIMCALL(void, libcandidates_105544)(NimStringDesc* s, TY9355** dest) {
	...
	nimln(267, "options.nim");
	TMP328 = addInt(le, 1);
	ri = nsuFindChar(s, 41, (NI64)(TMP328));
	nimln(268, "options.nim");
	{
		...
		nimln(269, "options.nim");
		TMP329 = subInt(le, 1);
		prefix = copyStrLast(s, 0, (NI64)(TMP329));
		nimln(270, "options.nim");
		nimln(270, "options.nim");
		nimln(270, "options.nim");
		TMP330 = addInt(ri, 1);
		suffix = copyStr(s, (NI64)(TMP330));
		middle_105556 = 0;
		HEX3Atmp_105573 = 0;
		...
		nimln(271, "options.nim");
		TMP332 = subInt(ri, 1);
		HEX3Atmp_105573 = copyStrLast(s, (NI64)(TMP331), (NI64)(TMP332));
		...
		nimln(249, "strutils.nim");
		{
			...
			while (1) {
				...
				middle_105556 = copyStrLast(HEX3Atmp_105573, first_105577, (NI64)(TMP334));
...
N_NIMCALL(NimStringDesc*, canondynlibname_105582)(NimStringDesc* s) {
	...
	nimln(279, "options.nim");
	{
		...
		result = copyStrLast(s, start, (NI64)(TMP338));
	}
	goto LA7;
	LA9: ;
	{
