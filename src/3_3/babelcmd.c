...
N_NIMCALL(NI, versionsplitpos_140012)(NimStringDesc* s);
static N_INLINE(NI, subInt)(NI a, NI b);
N_NOINLINE(void, raiseOverflow)(void);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(NIM_BOOL, HEX3CHEX2E_140045)(NimStringDesc* a, NimStringDesc* b);
static N_INLINE(NIM_BOOL, eqStrings)(NimStringDesc* a, NimStringDesc* b);
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NIMCALL(void, addpackage_140115)(tstringtable103609* packages, NimStringDesc* p);
...
N_NIMCALL(void, addbabelpath_140141)(NimStringDesc* p, tlineinfo127308 info);
N_NIMCALL(void, message_128680)(tlineinfo127308 info, NU16 msg, NimStringDesc* arg);
N_NIMCALL(void, addpathwithnimfiles_140148)(NimStringDesc* p, tlineinfo127308 info);
N_NIMCALL(NIM_BOOL, hasnimfile_140152)(NimStringDesc* dir);
...
N_NIMCALL(void, addpathrec_140191)(NimStringDesc* dir, tlineinfo127308 info);
...
STRING_LITERAL(TMP1341, "head", 4);
STRING_LITERAL(TMP1344, ".", 1);
STRING_LITERAL(TMP1345, "..", 2);
STRING_LITERAL(TMP1349, ".nim", 4);
...
N_NIMCALL(NIM_BOOL, HEX3CHEX2E_140045)(NimStringDesc* a, NimStringDesc* b) {
	...
	{
		nimln(28, "babelcmd.nim");
		if (!eqStrings(a, ((NimStringDesc*) &TMP1341))) goto LA3;
		nimln(28, "babelcmd.nim");
		nimln(28, "babelcmd.nim");
		result = NIM_FALSE;
		goto BeforeRet;
...
N_NIMCALL(void, addpackage_140115)(tstringtable103609* packages, NimStringDesc* p) {
	...
	x = versionsplitpos_140012(p);
	nimln(48, "babelcmd.nim");
	nimln(48, "babelcmd.nim");
	nimln(48, "babelcmd.nim");
	TMP1342 = subInt(x, 1);
	name = copyStrLast(p, 0, (NI64)(TMP1342));
	nimln(49, "babelcmd.nim");
	{
		...
		nimln(50, "babelcmd.nim");
		TMP1343 = addInt(x, 1);
		version = copyStr(p, (NI64)(TMP1343));
		nimln(51, "babelcmd.nim");
		{
			...
			LOC8 = HEX3CHEX2E_140045(LOC7, version);
			if (!LOC8) goto LA9;
	...
	LA3: ;
	{
		...
		nstPut(packages, name, ((NimStringDesc*) &TMP1341));
	}
	LA1: ;
	popFrame();
}
...
N_NIMCALL(void, addbabelpath_140141)(NimStringDesc* p, tlineinfo127308 info) {
	...
	nimln(62, "babelcmd.nim");
	{
		...
		nimln(63, "babelcmd.nim");
		{
			...
			nimln(63, "babelcmd.nim");
			message_128680(info, ((NU16) 256), p);
		}
		LA8: ;
...
N_NIMCALL(NIM_BOOL, hasnimfile_140152)(NimStringDesc* dir) {
	...
	path_140157 = 0;
	nimln(1111, "os.nim");
	d_140165 = opendir(dir->data);
	nimln(1112, "os.nim");
	{
		int LOC37;
		nimln(684, "system.nim");
		nimln(684, "system.nim");
		if (!!((d_140165 == NIM_NIL))) goto LA3;
		nimln(1113, "os.nim");
		while (1) {
			struct dirent* x_140167;
			NimStringDesc* y_140169;
			nimln(1114, "os.nim");
			x_140167 = readdir(d_140165);
			nimln(1115, "os.nim");
			{
				nimln(1115, "os.nim");
				if (!(x_140167 == NIM_NIL)) goto LA8;
				nimln(1115, "os.nim");
				goto LA5;
			}
			LA8: ;
			nimln(1116, "os.nim");
			nimln(1116, "os.nim");
			y_140169 = cstrToNimstr(((NCSTRING) ((*x_140167).d_name)));
			nimln(1117, "os.nim");
			{
				NIM_BOOL LOC12;
				struct stat s_140171;
				NU8 k_140173;
				nimln(1117, "os.nim");
				nimln(684, "system.nim");
				nimln(684, "system.nim");
				LOC12 = !(eqStrings(y_140169, ((NimStringDesc*) &TMP1344)));
				if (!(LOC12)) goto LA13;
				nimln(684, "system.nim");
				nimln(684, "system.nim");
				LOC12 = !(eqStrings(y_140169, ((NimStringDesc*) &TMP1345)));
				LA13: ;
				if (!LOC12) goto LA14;
				memset((void*)&s_140171, 0, sizeof(s_140171));
				nimln(1119, "os.nim");
				y_140169 = HEX2F_94062(dir, y_140169);
				nimln(1120, "os.nim");
				{
					int LOC18;
					nimln(1120, "os.nim");
					nimln(1120, "os.nim");
					LOC18 = lstat(y_140169->data, &s_140171);
				...
				nimln(1122, "os.nim");
				{
					NIM_BOOL LOC23;
					nimln(1122, "os.nim");
					LOC23 = S_ISDIR(s_140171.st_mode);
					if (!LOC23) goto LA24;
					nimln(1122, "os.nim");
					k_140173 = ((NU8) 2);
				}
				...
				nimln(1123, "os.nim");
				{
					NIM_BOOL LOC28;
					nimln(1123, "os.nim");
					LOC28 = S_ISLNK(s_140171.st_mode);
					if (!LOC28) goto LA29;
					nimln(1123, "os.nim");
					nimln(1123, "os.nim");
					k_140173 = addInt(k_140173, 1);
				}
				LA29: ;
				nimln(1121, "os.nim");
				kind_140156 = k_140173;
				nimln(1116, "os.nim");
				path_140157 = y_140169;
				nimln(69, "babelcmd.nim");
				{
					NIM_BOOL LOC33;
					nimln(69, "babelcmd.nim");
					nimln(69, "babelcmd.nim");
					LOC33 = (kind_140156 == ((NU8) 0));
					if (!(LOC33)) goto LA34;
					nimln(69, "babelcmd.nim");
					LOC33 = nsuEndsWith(path_140157, ((NimStringDesc*) &TMP1349));
					LA34: ;
					if (!LOC33) goto LA35;
...
N_NIMCALL(void, addpathwithnimfiles_140148)(NimStringDesc* p, tlineinfo127308 info) {
	...
	nimln(72, "babelcmd.nim");
	{
		NIM_BOOL LOC3;
		nimln(72, "babelcmd.nim");
		LOC3 = hasnimfile_140152(p);
		if (!LOC3) goto LA4;
		nimln(73, "babelcmd.nim");
		addbabelpath_140141(p, info);
	}
	goto LA1;
	LA4: ;
	{
		NU8 kind_140176;
		NimStringDesc* p2_140177;
		DIR* d_140179;
		kind_140176 = 0;
		p2_140177 = 0;
		nimln(1111, "os.nim");
		d_140179 = opendir(p->data);
		nimln(1112, "os.nim");
		{
			int LOC42;
			nimln(684, "system.nim");
			nimln(684, "system.nim");
			if (!!((d_140179 == NIM_NIL))) goto LA9;
			nimln(1113, "os.nim");
			while (1) {
				struct dirent* x_140181;
				NimStringDesc* y_140183;
				nimln(1114, "os.nim");
				x_140181 = readdir(d_140179);
				nimln(1115, "os.nim");
				{
					nimln(1115, "os.nim");
					if (!(x_140181 == NIM_NIL)) goto LA14;
					nimln(1115, "os.nim");
					goto LA11;
				}
				LA14: ;
				nimln(1116, "os.nim");
				nimln(1116, "os.nim");
				y_140183 = cstrToNimstr(((NCSTRING) ((*x_140181).d_name)));
				nimln(1117, "os.nim");
				{
					NIM_BOOL LOC18;
					struct stat s_140185;
					NU8 k_140187;
					nimln(1117, "os.nim");
					nimln(684, "system.nim");
					nimln(684, "system.nim");
					LOC18 = !(eqStrings(y_140183, ((NimStringDesc*) &TMP1344)));
					if (!(LOC18)) goto LA19;
					nimln(684, "system.nim");
					nimln(684, "system.nim");
					LOC18 = !(eqStrings(y_140183, ((NimStringDesc*) &TMP1345)));
					LA19: ;
					if (!LOC18) goto LA20;
					memset((void*)&s_140185, 0, sizeof(s_140185));
					nimln(1119, "os.nim");
					y_140183 = HEX2F_94062(p, y_140183);
					nimln(1120, "os.nim");
					{
						int LOC24;
						nimln(1120, "os.nim");
						nimln(1120, "os.nim");
						LOC24 = lstat(y_140183->data, &s_140185);
					...
					nimln(1122, "os.nim");
					{
						NIM_BOOL LOC29;
						nimln(1122, "os.nim");
						LOC29 = S_ISDIR(s_140185.st_mode);
						if (!LOC29) goto LA30;
						nimln(1122, "os.nim");
						k_140187 = ((NU8) 2);
					}
					...
					nimln(1123, "os.nim");
					{
						NIM_BOOL LOC34;
						nimln(1123, "os.nim");
						LOC34 = S_ISLNK(s_140185.st_mode);
						if (!LOC34) goto LA35;
						nimln(1123, "os.nim");
						nimln(1123, "os.nim");
						k_140187 = addInt(k_140187, 1);
					}
					LA35: ;
					nimln(1121, "os.nim");
					kind_140176 = k_140187;
					nimln(1116, "os.nim");
					p2_140177 = y_140183;
					nimln(76, "babelcmd.nim");
					{
						NIM_BOOL LOC39;
						nimln(76, "babelcmd.nim");
						LOC39 = hasnimfile_140152(p2_140177);
						if (!LOC39) goto LA40;
						nimln(76, "babelcmd.nim");
						addbabelpath_140141(p2_140177, info);
					}
					LA40: ;
				}
				LA20: ;
...
N_NIMCALL(void, addpathrec_140191)(NimStringDesc* dir, tlineinfo127308 info) {
	...
	NI TMP1350;
	NU8 k_140219;
	NimStringDesc* p_140220;
	DIR* d_140229;
	NimStringDesc* p_140227;
	NimStringDesc* key_140239;
	NimStringDesc* val_140241;
	NI h_140243;
	NI HEX3Atmp_140245;
	NI res_140247;
	...
	p_140220 = 0;
	nimln(1111, "os.nim");
	d_140229 = opendir(dir->data);
	nimln(1112, "os.nim");
	{
		int LOC41;
		nimln(684, "system.nim");
		nimln(684, "system.nim");
		if (!!((d_140229 == NIM_NIL))) goto LA7;
		nimln(1113, "os.nim");
		while (1) {
			struct dirent* x_140231;
			NimStringDesc* y_140233;
			nimln(1114, "os.nim");
			x_140231 = readdir(d_140229);
			nimln(1115, "os.nim");
			{
				nimln(1115, "os.nim");
				if (!(x_140231 == NIM_NIL)) goto LA12;
				nimln(1115, "os.nim");
				goto LA9;
			}
			LA12: ;
			nimln(1116, "os.nim");
			nimln(1116, "os.nim");
			y_140233 = cstrToNimstr(((NCSTRING) ((*x_140231).d_name)));
			nimln(1117, "os.nim");
			{
				NIM_BOOL LOC16;
				struct stat s_140235;
				NU8 k_140237;
				nimln(1117, "os.nim");
				nimln(684, "system.nim");
				nimln(684, "system.nim");
				LOC16 = !(eqStrings(y_140233, ((NimStringDesc*) &TMP1344)));
				if (!(LOC16)) goto LA17;
				nimln(684, "system.nim");
				nimln(684, "system.nim");
				LOC16 = !(eqStrings(y_140233, ((NimStringDesc*) &TMP1345)));
				LA17: ;
				if (!LOC16) goto LA18;
				memset((void*)&s_140235, 0, sizeof(s_140235));
				nimln(1119, "os.nim");
				y_140233 = HEX2F_94062(dir, y_140233);
				nimln(1120, "os.nim");
				{
					int LOC22;
					nimln(1120, "os.nim");
					nimln(1120, "os.nim");
					LOC22 = lstat(y_140233->data, &s_140235);
				...
				nimln(1122, "os.nim");
				{
					NIM_BOOL LOC27;
					nimln(1122, "os.nim");
					LOC27 = S_ISDIR(s_140235.st_mode);
					if (!LOC27) goto LA28;
					nimln(1122, "os.nim");
					k_140237 = ((NU8) 2);
				}
				...
				nimln(1123, "os.nim");
				{
					NIM_BOOL LOC32;
					nimln(1123, "os.nim");
					LOC32 = S_ISLNK(s_140235.st_mode);
					if (!LOC32) goto LA33;
					nimln(1123, "os.nim");
					nimln(1123, "os.nim");
					k_140237 = addInt(k_140237, 1);
				}
				LA33: ;
				nimln(1121, "os.nim");
				k_140219 = k_140237;
				...
				nimln(83, "babelcmd.nim");
				{
					...
					nimln(83, "babelcmd.nim");
					nimln(83, "babelcmd.nim");
					LOC37 = (k_140219 == ((NU8) 2));
					if (!(LOC37)) goto LA38;
					nimln(684, "system.nim");
					nimln(684, "system.nim");
					if ((NU)(pos) > (NU)(p_140220->Sup.len)) raiseIndexError();
					LOC37 = !(((NU8)(p_140220->data[pos]) == (NU8)(46)));
					LA38: ;
					if (!LOC37) goto LA39;
					nimln(84, "babelcmd.nim");
					addpackage_140115(packages, p_140220);
				}
				LA39: ;
			}
			LA18: ;
	...
	nimln(40, "strtabs.nim");
	HEX3Atmp_140245 = ((*packages).Data->Sup.len-1);
	nimln(1281, "system.nim");
	res_140247 = 0;
	nimln(1282, "system.nim");
	while (1) {
		nimln(1282, "system.nim");
		if (!(res_140247 <= HEX3Atmp_140245)) goto LA42;
		nimln(1281, "system.nim");
		h_140243 = res_140247;
		nimln(41, "strtabs.nim");
		{
			NimStringDesc* res_140249;
			nimln(41, "strtabs.nim");
			nimln(41, "strtabs.nim");
			if ((NU)(h_140243) >= (NU)((*packages).Data->Sup.len)) raiseIndexError();
			if (!!((*packages).Data->data[h_140243].Field0 == 0)) goto LA45;
			nimln(42, "strtabs.nim");
			if ((NU)(h_140243) >= (NU)((*packages).Data->Sup.len)) raiseIndexError();
			key_140239 = (*packages).Data->data[h_140243].Field0;
			nimln(42, "strtabs.nim");
			if ((NU)(h_140243) >= (NU)((*packages).Data->Sup.len)) raiseIndexError();
			val_140241 = (*packages).Data->data[h_140243].Field1;
			nimln(58, "babelcmd.nim");
			nimln(58, "babelcmd.nim");
			{
				nimln(58, "babelcmd.nim");
				if (!eqStrings(val_140241, ((NimStringDesc*) &TMP1341))) goto LA49;
				res_140249 = key_140239;
			}
			goto LA47;
			LA49: ;
			{
				...
				nimln(58, "babelcmd.nim");
				LOC52 = 0;
				LOC52 = rawNewString(key_140239->Sup.len + val_140241->Sup.len + 1);
appendString(LOC52, key_140239);
appendChar(LOC52, 45);
appendString(LOC52, val_140241);
				res_140249 = LOC52;
			}
			LA47: ;
			nimln(58, "babelcmd.nim");
			...
			addbabelpath_140141(p_140227, info);
		}
		LA45: ;
		nimln(1284, "system.nim");
		res_140247 = addInt(res_140247, 1);
	} LA42: ;
	popFrame();
}
...
N_NIMCALL(void, babelpath_140254)(NimStringDesc* path, tlineinfo127308 info) {
	...
	addpathrec_140191(path, info);
	nimln(90, "babelcmd.nim");
	addbabelpath_140141(path, info);
	popFrame();
}
