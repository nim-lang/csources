...
STRING_LITERAL(TMP317, "unknown OS error", 16);
STRING_LITERAL(TMP1454, "HOME", 4);
STRING_LITERAL(TMP1455, "/", 1);
STRING_LITERAL(TMP1830, "/.config/", 9);
STRING_LITERAL(TMP6787, "invalid index", 13);
...
N_NIMCALL(NimStringDesc*, getenv_95823)(NimStringDesc* key) {
	...
	nimln(990, "os.nim");
	{
		...
		TMP283 = addInt(LOC5, 1);
		result = copyStr(environment_95235->data[i], (NI64)(TMP283));
		goto BeforeRet;
	}
	goto LA1;
	LA3: ;
...
appendString(LOC5, LOC6);
	...
	LA3: ;
	{
		...
		nimln(700, "os.nim");
		nimln(700, "os.nim");
		TMP306 = subInt(extpos, 1);
		LOC9 = 0;
		LOC9 = copyStrLast(filename, 0, (NI64)(TMP306));
		nimln(700, "os.nim");
		LOC10 = 0;
...
N_NIMCALL(void, nosSplitPath)(NimStringDesc* path, TY81915* Result) {
	...
	nimln(536, "os.nim");
	nimln(536, "os.nim");
	TMP307 = subInt(path->Sup.len, 1);
	HEX3Atmp_94097 = (NI64)(TMP307);
	nimln(1265, "system.nim");
	...
	nimln(540, "os.nim");
	{
		...
		nimln(541, "os.nim");
		nimln(541, "os.nim");
		TMP308 = subInt(seppos, 1);
		unsureAsgnRef((void**) &(*Result).Field0, copyStrLast(path, 0, (NI64)(TMP308)));
		nimln(542, "os.nim");
		nimln(542, "os.nim");
		nimln(542, "os.nim");
		TMP309 = addInt(seppos, 1);
		unsureAsgnRef((void**) &(*Result).Field1, copyStr(path, (NI64)(TMP309)));
	}
	goto LA6;
	LA8: ;
	{
		nimln(544, "os.nim");
		unsureAsgnRef((void**) &(*Result).Field0, copyString(((NimStringDesc*) &TMP284)));
		nimln(545, "os.nim");
...
N_NIMCALL(void, nossplitFile)(NimStringDesc* path, TY94237* Result) {
	...
	nimln(634, "os.nim");
	{
		...
		nimln(634, "os.nim");
		nimln(634, "os.nim");
		TMP310 = subInt(path->Sup.len, 1);
		if ((NU)((NI64)(TMP310)) > (NU)(path->Sup.len)) raiseIndexError();
		LOC3 = (((NU8)(path->data[(NI64)(TMP310)])) == ((NU8)(47)) || ((NU8)(path->data[(NI64)(TMP310)])) == ((NU8)(47)));
		LA4: ;
		if (!LOC3) goto LA5;
		nimln(635, "os.nim");
		unsureAsgnRef((void**) &(*Result).Field0, copyString(path));
		unsureAsgnRef((void**) &(*Result).Field1, copyString(((NimStringDesc*) &TMP284)));
		unsureAsgnRef((void**) &(*Result).Field2, copyString(((NimStringDesc*) &TMP284)));
	}
	goto LA1;
	LA5: ;
	{
		...
		nimln(639, "os.nim");
		nimln(639, "os.nim");
		TMP311 = subInt(path->Sup.len, 1);
		HEX3Atmp_94285 = (NI64)(TMP311);
		nimln(1265, "system.nim");
		...
		while (1) {
			...
			nimln(640, "os.nim");
			{
				...
				nimln(641, "os.nim");
				{
					...
					nimln(717, "system.nim");
					nimln(642, "os.nim");
					TMP312 = subInt(i_94262, 1);
					if ((NU)((NI64)(TMP312)) > (NU)(path->Sup.len)) raiseIndexError();
					LOC15 = !((((NU8)(path->data[(NI64)(TMP312)])) == ((NU8)(47)) || ((NU8)(path->data[(NI64)(TMP312)])) == ((NU8)(47))));
					LA18: ;
					if (!LOC15) goto LA19;
					nimln(642, "os.nim");
					dotpos = i_94262;
		...
		nimln(646, "os.nim");
		nimln(646, "os.nim");
		TMP313 = subInt(seppos, 1);
		unsureAsgnRef((void**) &(*Result).Field0, copyStrLast(path, 0, (NI64)(TMP313)));
		nimln(647, "os.nim");
		nimln(647, "os.nim");
		nimln(647, "os.nim");
		TMP314 = addInt(seppos, 1);
		nimln(647, "os.nim");
		TMP315 = subInt(dotpos, 1);
		unsureAsgnRef((void**) &(*Result).Field1, copyStrLast(path, (NI64)(TMP314), (NI64)(TMP315)));
		nimln(648, "os.nim");
		nimln(648, "os.nim");
...
N_NIMCALL(void, oserror_92005)(NI32 errorcode) {
	...
	nimln(260, "os.nim");
	{
		...
		LOC5 = 0;
		LOC5 = (*e_92011).Sup.Sup.Sup.message; (*e_92011).Sup.Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP317));
...
N_NIMCALL(NimStringDesc*, nosJoinPath)(NimStringDesc* head, NimStringDesc* tail) {
	...
	LA3: ;
	{
		...
		nimln(490, "os.nim");
		nimln(490, "os.nim");
		TMP320 = subInt(head->Sup.len, 1);
		if ((NU)((NI64)(TMP320)) > (NU)(head->Sup.len)) raiseIndexError();
		if (!(((NU8)(head->data[(NI64)(TMP320)])) == ((NU8)(47)) || ((NU8)(head->data[(NI64)(TMP320)])) == ((NU8)(47)))) goto LA6;
		nimln(491, "os.nim");
		{
			NimStringDesc* LOC12;
			NimStringDesc* LOC13;
...
N_NIMCALL(void, noscreateDir)(NimStringDesc* dir) {
	...
	nimln(1198, "os.nim");
	nimln(1198, "os.nim");
	TMP323 = subInt(dir->Sup.len, 1);
	HEX3Atmp_97219 = (NI64)(TMP323);
	nimln(1281, "system.nim");
	res_97221 = 1;
	nimln(1282, "system.nim");
	while (1) {
		...
		nimln(1199, "os.nim");
		{
			...
			LA8: ;
			{
				...
				nimln(1203, "os.nim");
				nimln(1203, "os.nim");
				TMP324 = subInt(i_97208, 1);
				LOC11 = 0;
				LOC11 = copyStrLast(dir, 0, (NI64)(TMP324));
...
N_NIMCALL(NimStringDesc*, nosextractFilename)(NimStringDesc* path) {
	...
	nimln(654, "os.nim");
	{
		...
		nimln(654, "os.nim");
		nimln(654, "os.nim");
		TMP777 = subInt(path->Sup.len, 1);
		if ((NU)((NI64)(TMP777)) > (NU)(path->Sup.len)) raiseIndexError();
		LOC3 = (((NU8)(path->data[(NI64)(TMP777)])) == ((NU8)(47)) || ((NU8)(path->data[(NI64)(TMP777)])) == ((NU8)(47)));
		LA4: ;
		if (!LOC3) goto LA5;
		nimln(655, "os.nim");
		result = copyString(((NimStringDesc*) &TMP284));
...
N_NIMCALL(TY9355*, nosparseCmdLine)(NimStringDesc* c) {
	...
	i = 0;
	nimln(1252, "os.nim");
	a = copyString(((NimStringDesc*) &TMP284));
	nimln(1253, "os.nim");
	while (1) {
		NimStringDesc* LOC16;
		nimln(1254, "os.nim");
...
N_NIMCALL(void, nossleep)(NI milsecs) {
	...
	nimln(1575, "os.nim");
	nimln(1575, "os.nim");
	TMP902 = divInt(milsecs, 1000);
	a.tv_sec = (NI64)(TMP902);
	nimln(1576, "os.nim");
	nimln(1576, "os.nim");
	nimln(1576, "os.nim");
	nimln(1576, "os.nim");
	TMP903 = modInt(milsecs, 1000);
	TMP904 = mulInt(((NI) ((NI64)(TMP903))), 1000);
	TMP905 = mulInt(((NI) ((NI64)(TMP904))), 1000);
	a.tv_nsec = ((NI) ((NI64)(TMP905)));
	nimln(1577, "os.nim");
	nimln(1577, "os.nim");
	LOC1 = nanosleep(&a, &b);
	popFrame();
...
N_NIMCALL(NimStringDesc*, nosgetHomeDir)(void) {
	...
	nimln(1432, "os.nim");
	LOC2 = 0;
	LOC2 = getenv_95823(((NimStringDesc*) &TMP1454));
	LOC1 = rawNewString(LOC2->Sup.len + 1);
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP1455));
	result = LOC1;
	goto BeforeRet;
	BeforeRet: ;
	popFrame();
...
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP1830));
	result = LOC1;
	goto BeforeRet;
	BeforeRet: ;
	popFrame();
...
N_NIMCALL(NimStringDesc*, nosparentDir)(NimStringDesc* path) {
	...
	nimln(558, "os.nim");
	{
		...
		nimln(558, "os.nim");
		nimln(558, "os.nim");
		TMP1838 = subInt(path->Sup.len, 1);
		if ((NU)((NI64)(TMP1838)) > (NU)(path->Sup.len)) raiseIndexError();
		if (!(((NU8)(path->data[(NI64)(TMP1838)])) == ((NU8)(47)) || ((NU8)(path->data[(NI64)(TMP1838)])) == ((NU8)(47)))) goto LA3;
		nimln(559, "os.nim");
		q = 2;
	}
	LA3: ;
	...
	nimln(560, "os.nim");
	nimln(560, "os.nim");
	TMP1839 = subInt(path->Sup.len, q);
	HEX3Atmp_94137 = (NI64)(TMP1839);
	nimln(1265, "system.nim");
	...
	nimln(564, "os.nim");
	{
		...
		nimln(565, "os.nim");
		nimln(565, "os.nim");
		TMP1840 = subInt(seppos, 1);
		result = copyStrLast(path, 0, (NI64)(TMP1840));
	}
	goto LA10;
	LA12: ;
	{
...
N_NIMCALL(NI, paramcount_98633)(void) {
	...
	nimln(1480, "os.nim");
	nimln(1480, "os.nim");
	TMP6786 = subInt(cmdCount, ((NI32) 1));
	if (TMP6786 < (-2147483647 -1) || TMP6786 > 2147483647) raiseOverflow();
	result = ((NI) ((NI32)(TMP6786)));
	goto BeforeRet;
	BeforeRet: ;
	popFrame();
	return result;
...
N_NIMCALL(NimStringDesc*, paramstr_98605)(NI i) {
	...
	nimln(1797, "system.nim");
	LOC7 = 0;
	LOC7 = (*e_98613).Sup.Sup.message; (*e_98613).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP6787));
	if (LOC7) nimGCunrefNoCycle(LOC7);
	nimln(1478, "os.nim");
