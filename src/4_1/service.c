...
STRING_LITERAL(TMP6797, "", 0);
STRING_LITERAL(TMP6804, "server.type", 11);
STRING_LITERAL(TMP6805, "stdin", 5);
STRING_LITERAL(TMP6806, "tcp", 3);
STRING_LITERAL(TMP6807, "quit", 4);
STRING_LITERAL(TMP6812, "server.port", 11);
STRING_LITERAL(TMP6813, "server.address", 14);
STRING_LITERAL(TMP6838, "\015\012", 2);
STRING_LITERAL(TMP6839, "Invalid server.type:", 20);
NimStringDesc* curcaascmd_418003;
extern TFrame* frameptr_12027;
extern tgcheap40816 gch_40842;
NimStringDesc* lastcaascmd_418004;
NimStringDesc* arguments_418005;
extern TNimType NTI416606; /* TOptParser */
...
extern tsocketimpl110806* stdoutsocket_128876;
...
N_NIMCALL(void, processcmdline_418007)(NU8 pass, NimStringDesc* cmd) {
	...
	p.Sup.m_type = (&NTI416606);
	initoptparser_416618(cmd, &p);
	...
	while (1) {
		...
		case ((NU8) 3):
		{
			...
			nimln(41, "service.nim");
			{
				...
				nimln(42, "service.nim");
				nimln(42, "service.nim");
				TMP6802 = subInt(bracketle, 1);
				key = copyStrLast(p.Key, 0, (NI32)(TMP6802));
				nimln(43, "service.nim");
				nimln(43, "service.nim");
				LOC8 = 0;
				nimln(43, "service.nim");
				nimln(43, "service.nim");
				TMP6803 = addInt(bracketle, 1);
				LOC9 = 0;
				LOC9 = copyStr(p.Key, (NI32)(TMP6803));
...
appendString(LOC8, p.Val);
				...
				processswitch_142016(key, val, pass, gcmdlineinfo_128802);
			}
			goto LA4;
			LA6: ;
			{
				nimln(46, "service.nim");
				processswitch_142016(p.Key, p.Val, pass, gcmdlineinfo_128802);
			}
			LA4: ;
		}
		break;
		case ((NU8) 1):
		{
			...
			LA14: ;
			{
				...
				nimln(52, "service.nim");
				{
					...
					asgnRefNoCycle((void**) &arguments_418005, npocmdLineRest(&p));
	...
	nimln(59, "service.nim");
	{
		...
		nimln(60, "service.nim");
		{
			...
			nimln(684, "system.nim");
			nimln(684, "system.nim");
			LOC33 = !(((arguments_418005) && (arguments_418005)->Sup.len == 0));
			LA34: ;
			if (!LOC33) goto LA35;
			nimln(61, "service.nim");
			memset((void*)LOC37, 0, sizeof(LOC37));
			rawmessage_129451(((NU16) 57), LOC37, 0);
		}
		LA35: ;
	}
	LA29: ;
...
N_NIMCALL(void, serve_418077)(TY418079 action) {
	...
	typ = getconfigvar_105291(((NimStringDesc*) &TMP6804));
	nimln(73, "service.nim");
	if (eqStrings(typ, ((NimStringDesc*) &TMP6805))) goto LA1;
	if (eqStrings(typ, ((NimStringDesc*) &TMP6806))) goto LA2;
	if (eqStrings(typ, ((NimStringDesc*) &TMP6797))) goto LA2;
	goto LA3;
	LA1: ;
	{
		...
		while (1) {
			...
			{
				nimln(77, "service.nim");
				if (!eqStrings(line, ((NimStringDesc*) &TMP6807))) goto LA9;
				nimln(77, "service.nim");
				exit(0);
			}
			LA9: ;
			...
			LOC11 = 0;
			LOC11 = curcaascmd_418003; curcaascmd_418003 = copyStringRC1(line);
			if (LOC11) nimGCunrefNoCycle(LOC11);
			nimln(66, "service.nim");
			processcmdline_418007(((NU8) 1), line);
			...
			printf("%s\012", (((NimStringDesc*) &TMP6797))->data);
	...
	LA2: ;
	{
		...
		p = getconfigvar_105291(((NimStringDesc*) &TMP6812));
		...
		nimln(86, "service.nim");
		LOC19 = 0;
		LOC19 = getconfigvar_105291(((NimStringDesc*) &TMP6813));
		bindaddr_112552(server, port, LOC19);
		nimln(87, "service.nim");
		inp = copyString(((NimStringDesc*) &TMP6797));
		nimln(88, "service.nim");
		listen_112405(server, SOMAXCONN);
		nimln(89, "service.nim");
		if (stdoutsocket_128876) nimGCunrefNoCycle(stdoutsocket_128876);
		stdoutsocket_128876 = (tsocketimpl110806*) newObjRC1((&NTI110808), sizeof(tsocketimpl110806));
		nimln(90, "service.nim");
		while (1) {
			NimStringDesc* LOC21;
			nimln(91, "service.nim");
			accept_114201(server, &stdoutsocket_128876);
			nimln(92, "service.nim");
			readline_118831(stdoutsocket_128876, &inp, -1);
			nimln(65, "service.nim");
			LOC21 = 0;
			LOC21 = curcaascmd_418003; curcaascmd_418003 = copyStringRC1(inp);
			if (LOC21) nimGCunrefNoCycle(LOC21);
			nimln(66, "service.nim");
			processcmdline_418007(((NU8) 1), inp);
			nimln(67, "service.nim");
			action();
			nimln(68, "service.nim");
			gdirtybufferidx_105123 = ((NI32) 0);
			...
			send_120405(stdoutsocket_128876, ((NimStringDesc*) &TMP6838));
			nimln(95, "service.nim");
			close_114264(stdoutsocket_128876);
		}
	}
	goto LA4;
	LA3: ;
	{
		...
		printf("%s%s\012", (((NimStringDesc*) &TMP6839))->data, (typ)->data);
...
N_NOINLINE(void, serviceInit)(void) {
	...
	LOC1 = 0;
	LOC1 = curcaascmd_418003; curcaascmd_418003 = copyStringRC1(((NimStringDesc*) &TMP6797));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(23, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_418004; lastcaascmd_418004 = copyStringRC1(((NimStringDesc*) &TMP6797));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(26, "service.nim");
	LOC3 = 0;
	LOC3 = arguments_418005; arguments_418005 = copyStringRC1(((NimStringDesc*) &TMP6797));
