...
STRING_LITERAL(TMP1856, "counter < length ", 17);
STRING_LITERAL(TMP1862, "not data[h] == desc ", 20);
STRING_LITERAL(TMP1863, "data[h] == nil ", 15);
STRING_LITERAL(TMP1872, "t.data[h] == nil ", 17);
STRING_LITERAL(TMP1873, "dest.data[h] == nil ", 20);
...
static N_INLINE(NIM_BOOL, mustrehash_166052)(NI length, NI counter) {
	...
	nimln(47, "intsets.nim");
	{
		...
		nimln(47, "intsets.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP1856));
	}
	LA3: ;
	...
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	TMP1857 = mulInt(length, 2);
	nimln(48, "intsets.nim");
	TMP1858 = mulInt(counter, 3);
	LOC5 = ((NI32)(TMP1857) < (NI32)(TMP1858));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	TMP1859 = subInt(length, counter);
	LOC5 = ((NI32)(TMP1859) < 4);
	LA6: ;
	result = LOC5;
	popFrame();
...
static N_INLINE(NI, nexttry_166207)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1860 = mulInt(5, h);
	TMP1861 = addInt((NI32)(TMP1860), 1);
	result = (NI)((NI32)(TMP1861) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, intsetrawinsert_166234)(tintset166041 t, ttrunkseq166039** data, ttrunk166037* desc) {
	...
	nimln(66, "intsets.nim");
	{
		...
		nimln(66, "intsets.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP1863));
	}
	LA8: ;
...
N_NIMCALL(void, intsetenlarge_166604)(tintset166041* t) {
	...
	nimln(72, "intsets.nim");
	nimln(72, "intsets.nim");
	TMP1864 = addInt((*t).Max, 1);
	TMP1865 = mulInt((NI32)(TMP1864), 2);
	TMP1866 = subInt((NI32)(TMP1865), 1);
	(*t).Max = (NI32)(TMP1866);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1867 = addInt((*t).Max, 1);
	n = (ttrunkseq166039*) newSeq((&NTI166039), (NI32)(TMP1867));
	i_166630 = 0;
...
N_NIMCALL(ttrunk166037*, intsetput_166659)(tintset166041* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		nimln(84, "intsets.nim");
		nimln(84, "intsets.nim");
		TMP1871 = addInt((*t).Max, 1);
		LOC8 = mustrehash_166052((NI32)(TMP1871), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
...
N_NIMCALL(void, assign_166916)(tintset166041* dest, tintset166041 src) {
	...
	while (1) {
		...
		nimln(152, "intsets.nim");
		{
			...
			nimln(152, "intsets.nim");
			hiddenraiseassert_71620(((NimStringDesc*) &TMP1873));
		}
		LA5: ;
		n = 0;
...
N_NIMCALL(NimStringDesc*, HEX24_167086)(tintset166041 s) {
	...
	result = copyString(((NimStringDesc*) &TMP1874));
	key_167091 = 0;
...
appendString(result, ((NimStringDesc*) &TMP1876));
	popFrame();
	return result;
}
...
static TNimNode* TMP1868[3];
static TNimNode* TMP3276[4];
static TNimNode TMP1854[9];
NTI166037.size = sizeof(ttrunk166037);
NTI166037.kind = 18;
NTI166037.base = 0;
TMP1868[0] = &TMP1854[1];
TMP1854[1].kind = 1;
TMP1854[1].offset = offsetof(ttrunk166037, Next);
TMP1854[1].typ = (&NTI166035);
TMP1854[1].name = "next";
TMP1868[1] = &TMP1854[2];
TMP1854[2].kind = 1;
TMP1854[2].offset = offsetof(ttrunk166037, Key);
TMP1854[2].typ = (&NTI105);
TMP1854[2].name = "key";
TMP1868[2] = &TMP1854[3];
TMP1854[3].kind = 1;
TMP1854[3].offset = offsetof(ttrunk166037, Bits);
TMP1854[3].typ = (&NTI21621);
TMP1854[3].name = "bits";
TMP1854[0].len = 3; TMP1854[0].kind = 2; TMP1854[0].sons = &TMP1868[0];
NTI166037.node = &TMP1854[0];
NTI166035.size = sizeof(ttrunk166037*);
NTI166035.kind = 22;
NTI166035.base = (&NTI166037);
NTI166035.marker = TMP1869;
NTI166039.size = sizeof(ttrunkseq166039*);
NTI166039.kind = 24;
NTI166039.base = (&NTI166035);
NTI166039.flags = 2;
NTI166039.marker = TMP1870;
...
TMP3276[0] = &TMP1854[5];
TMP1854[5].kind = 1;
TMP1854[5].offset = offsetof(tintset166041, Counter);
TMP1854[5].typ = (&NTI105);
TMP1854[5].name = "counter";
TMP3276[1] = &TMP1854[6];
TMP1854[6].kind = 1;
TMP1854[6].offset = offsetof(tintset166041, Max);
TMP1854[6].typ = (&NTI105);
TMP1854[6].name = "max";
TMP3276[2] = &TMP1854[7];
TMP1854[7].kind = 1;
TMP1854[7].offset = offsetof(tintset166041, Head);
TMP1854[7].typ = (&NTI166035);
TMP1854[7].name = "head";
TMP3276[3] = &TMP1854[8];
TMP1854[8].kind = 1;
TMP1854[8].offset = offsetof(tintset166041, Data);
TMP1854[8].typ = (&NTI166039);
TMP1854[8].name = "data";
TMP1854[4].len = 4; TMP1854[4].kind = 2; TMP1854[4].sons = &TMP3276[0];
NTI166041.node = &TMP1854[4];
}
