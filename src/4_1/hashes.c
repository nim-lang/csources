...
N_NIMCALL(NI, hash_101825)(NimStringDesc* x) {
	...
	nimln(93, "hashes.nim");
	nimln(93, "hashes.nim");
	TMP263 = subInt(x->Sup.len, 1);
	HEX3Atmp_101845 = (NI32)(TMP263);
	...
	while (1) {
		...
		i_101864 = res_101909;
		{
			...
			nimln(104, "hashes.nim");
			{
				...
				c = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP265), 0, 255))));
			}
			LA9: ;
...
N_NIMCALL(NI, hashignorecase_101915)(NimStringDesc* x) {
	...
	nimln(112, "hashes.nim");
	nimln(112, "hashes.nim");
	TMP266 = subInt(x->Sup.len, 1);
	HEX3Atmp_101969 = (NI32)(TMP266);
	nimln(1281, "system.nim");
	res_101971 = 0;
	nimln(1282, "system.nim");
	while (1) {
		...
		nimln(114, "hashes.nim");
		{
			...
			nimln(115, "hashes.nim");
			nimln(115, "hashes.nim");
			TMP267 = addInt(((NI) (((NU8)(c)))), 32);
			c = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP267), 0, 255))));
		}
		LA4: ;
