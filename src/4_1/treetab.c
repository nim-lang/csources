...
static N_INLINE(NI, nexttry_176196)(NI h, NI maxhash) {
	...
	nimln(449, "astalgo.nim");
	TMP3083 = mulInt(5, h);
	TMP3084 = addInt((NI32)(TMP3083), 1);
	result = (NI)((NI32)(TMP3084) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(NI, nodetabletestorset_219881)(tnodetable169705* t, tnode169647* key, NI val) {
	...
	LA3: ;
	{
		nimln(102, "treetab.nim");
		{
			...
			n = (tnodepairseq169703*) newSeq((&NTI169703), (NI32)(TMP3088));
			i_220037 = 0;
			HEX3Atmp_220074 = 0;
