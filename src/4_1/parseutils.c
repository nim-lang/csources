...
N_NIMCALL(NI, rawparseint_74996)(NimStringDesc* s, NI64* b, NI start) {
	...
	nimln(200, "parseutils.nim");
	{
		...
		while (1) {
			...
			TMP1068 = subInt64((NI64)(TMP1066), ((NI64) ((NI32)(TMP1067))));
			(*b) = (NI64)(TMP1068);
...
N_NIMCALL(NI, npuParseBiggestFloat)(NimStringDesc* s, NF64* number, NI start) {
	...
	nimln(261, "parseutils.nim");
	{
		...
		nimln(262, "parseutils.nim");
		{
			...
			LOC16 = ((NU8)(s->data[(NI32)(TMP1755)]) == (NU8)(65));
			if (LOC16) goto LA17;
			nimln(262, "parseutils.nim");
			nimln(262, "parseutils.nim");
			TMP1756 = addInt(i, 1);
			if ((NU)((NI32)(TMP1756)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC16 = ((NU8)(s->data[(NI32)(TMP1756)]) == (NU8)(97));
			LA17: ;
			if (!LOC16) goto LA18;
			nimln(263, "parseutils.nim");
			{
				...
				LOC22 = ((NU8)(s->data[(NI32)(TMP1757)]) == (NU8)(78));
				if (LOC22) goto LA23;
				nimln(263, "parseutils.nim");
				nimln(263, "parseutils.nim");
				TMP1758 = addInt(i, 2);
				if ((NU)((NI32)(TMP1758)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC22 = ((NU8)(s->data[(NI32)(TMP1758)]) == (NU8)(110));
				LA23: ;
				if (!LOC22) goto LA24;
				nimln(264, "parseutils.nim");
				{
					...
					if (!!((((NU8)(s->data[(NI32)(TMP1759)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI32)(TMP1759)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI32)(TMP1759)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI32)(TMP1759)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI32)(TMP1759)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI32)(TMP1759)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI32)(TMP1759)])) == ((NU8)(95))))) goto LA28;
					...
					nimln(266, "parseutils.nim");
					TMP1760 = addInt(i, 3);
					TMP1761 = subInt((NI32)(TMP1760), start);
					result = (NI32)(TMP1761);
					goto BeforeRet;
				}
				LA28: ;
	...
	nimln(268, "parseutils.nim");
	{
		...
		nimln(269, "parseutils.nim");
		{
			...
			LOC38 = ((NU8)(s->data[(NI32)(TMP1762)]) == (NU8)(78));
			if (LOC38) goto LA39;
			nimln(269, "parseutils.nim");
			nimln(269, "parseutils.nim");
			TMP1763 = addInt(i, 1);
			if ((NU)((NI32)(TMP1763)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC38 = ((NU8)(s->data[(NI32)(TMP1763)]) == (NU8)(110));
			LA39: ;
			if (!LOC38) goto LA40;
			nimln(270, "parseutils.nim");
			{
				...
				LOC44 = ((NU8)(s->data[(NI32)(TMP1764)]) == (NU8)(70));
				if (LOC44) goto LA45;
				nimln(270, "parseutils.nim");
				nimln(270, "parseutils.nim");
				TMP1765 = addInt(i, 2);
				if ((NU)((NI32)(TMP1765)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC44 = ((NU8)(s->data[(NI32)(TMP1765)]) == (NU8)(102));
				LA45: ;
				if (!LOC44) goto LA46;
				nimln(271, "parseutils.nim");
				{
					...
					nimln(271, "parseutils.nim");
					TMP1766 = addInt(i, 3);
					if ((NU)((NI32)(TMP1766)) > (NU)(s->Sup.len)) raiseIndexError();
					if (!!((((NU8)(s->data[(NI32)(TMP1766)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI32)(TMP1766)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI32)(TMP1766)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI32)(TMP1766)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI32)(TMP1766)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI32)(TMP1766)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI32)(TMP1766)])) == ((NU8)(95))))) goto LA50;
					...
					nimln(273, "parseutils.nim");
					TMP1767 = addInt(i, 3);
					TMP1768 = subInt((NI32)(TMP1767), start);
					result = (NI32)(TMP1768);
					goto BeforeRet;
				}
				LA50: ;
	...
	while (1) {
		...
		(*number) = ((NF64) (((((NF) ((*number))) * 1.0000000000000000e+01) + ((double) (((NI) ((NI32)(TMP1769))))))));
	...
	nimln(282, "parseutils.nim");
	{
		...
		while (1) {
			...
			(*number) = ((NF64) (((((NF) ((*number))) * 1.0000000000000000e+01) + ((double) (((NI) ((NI32)(TMP1770))))))));
	...
	nimln(296, "parseutils.nim");
	{
		...
		while (1) {
			...
			nimln(306, "parseutils.nim");
			if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
			TMP1772 = addInt((NI32)(TMP1771), ((NI) (((NU8)(s->data[i])))));
			TMP1773 = subInt((NI32)(TMP1772), 48);
			exponent = (NI32)(TMP1773);
