...
static N_INLINE(void, setid_168436)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP1879 = addInt(id, 1);
	gfrontendid_168005 = ((gfrontendid_168005 >= (NI32)(TMP1879)) ? gfrontendid_168005 : (NI32)(TMP1879));
	popFrame();
}
...
N_NIMCALL(void, idsynchronizationpoint_168445)(NI idrange) {
	...
	TMP1881 = addInt((NI32)(TMP1880), 1);
	TMP1882 = mulInt((NI32)(TMP1881), idrange);
	TMP1883 = addInt((NI32)(TMP1882), 1);
	gfrontendid_168005 = (NI32)(TMP1883);
	popFrame();
}
