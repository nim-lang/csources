...
static N_INLINE(tnode169647*, lastson_170011)(tnode169647* n) {
	...
	if ((NU)((NI64)(TMP4760)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI64)(TMP4760)];
	popFrame();
	return result;
}
...
N_NIMCALL(NU8, ispartofaux_300018)(tnode169647* n, ttype169681* b, tintset166041* marker) {
	...
	case ((NU8) 132):
	{
		...
		while (1) {
			...
			default:
			{
				...
				internalerror_129699(((NimStringDesc*) &TMP4761));
			}
			break;
			}
			nimln(1277, "system.nim");
	...
	default:
	{
		...
		internalerror_129687((*n).Info, ((NimStringDesc*) &TMP4764));
	}
	break;
	}
	BeforeRet: ;
...
static N_INLINE(ttype169681*, lastson_170015)(ttype169681* n) {
	...
	if ((NU)((NI64)(TMP4765)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP4765)];
	popFrame();
	return result;
}
