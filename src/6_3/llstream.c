...
N_NIMCALL(NI, counttriples_159661)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1558 = addInt(i, 1);
			if ((NU)((NI64)(TMP1558)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI64)(TMP1558)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1559 = addInt(i, 2);
			if ((NU)((NI64)(TMP1559)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI64)(TMP1559)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
appendString((*s).S, ((NimStringDesc*) &TMP1562));
	...
	result = ((buflen <= (NI64)(TMP1563)) ? buflen : (NI64)(TMP1563));
...
N_NIMCALL(NI, llstreamread_159242)(tllstream159204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		result = ((buflen <= (NI64)(TMP1564)) ? buflen : (NI64)(TMP1564));
		nimln(136, "llstream.nim");
		{
			...
			if ((NU)((NI64)(TMP1565)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI64)(TMP1565)])), result);
...
N_NIMCALL(void, llstreamwrite_159268)(tllstream159204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			(*s).S = setLengthStr((*s).S, (NI64)(TMP1566));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1567 = addInt(0, (*s).Wr);
			if ((NU)((NI64)(TMP1567)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI64)(TMP1567)])), buf, buflen);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_159254)(tllstream159204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI64)(TMP1568));
			nimln(223, "llstream.nim");
			nimln(223, "llstream.nim");
			TMP1569 = addInt(i, 0);
			if ((NU)((NI64)(TMP1569)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_9317((*s).F, ((void*) (&result->data[(NI64)(TMP1569)])), 2048);
