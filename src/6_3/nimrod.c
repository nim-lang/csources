...
STRING_LITERAL(TMP6970, "./", 2);
STRING_LITERAL(TMP6971, "", 0);
STRING_LITERAL(TMP6973, "nimrod.cfg", 10);
STRING_LITERAL(TMP6974, "js", 2);
STRING_LITERAL(TMP6975, "node ", 5);
...
appendString(LOC7, ((NimStringDesc*) &TMP6970));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
N_NIMCALL(void, handlecmdline_423603)(void) {
	...
	{
		nimln(39, "nimrod.nim");
		processcmdline_418007(((NU8) 0), ((NimStringDesc*) &TMP6971));
		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP6972;
			TY94237 p;
			...
			nimln(41, "nimrod.nim");
			pushSafePoint(&TMP6972);
			TMP6972.status = setjmp(TMP6972.context);
			if (TMP6972.status == 0) {
				nimln(42, "nimrod.nim");
			...
			if (TMP6972.status != 0) reraiseException();
			nimln(45, "nimrod.nim");
			chckNil((void*)&p);
		...
		LA7: ;
		nimln(50, "nimrod.nim");
		loadconfigs_165454(((NimStringDesc*) &TMP6973));
		nimln(53, "nimrod.nim");
		initvars_138646();
		nimln(54, "nimrod.nim");
		processcmdline_418007(((NU8) 1), ((NimStringDesc*) &TMP6971));
		nimln(55, "nimrod.nim");
		maincommand_421812();
		nimln(56, "nimrod.nim");
		{
		...
		nimln(58, "nimrod.nim");
		{
			...
			nimln(62, "nimrod.nim");
			{
				...
				nimln(63, "nimrod.nim");
				{
					...
					nimln(65, "nimrod.nim");
					LOC35 = 0;
					LOC35 = nosChangeFileExt(gprojectfull_105193, ((NimStringDesc*) &TMP6974));
					LOC36 = 0;
...
appendString(LOC38, ((NimStringDesc*) &TMP6975));
...
appendString(LOC38, arguments_418005);
				...
				LA33: ;
				{
					...
					nimln(69, "nimrod.nim");
					LOC40 = 0;
					LOC40 = nosChangeFileExt(gprojectfull_105193, ((NimStringDesc*) &TMP6971));
					LOC41 = 0;
