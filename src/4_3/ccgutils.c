...
static N_INLINE(ttype169681*, lastson_170015)(ttype169681* n) {
	...
	if ((NU)((NI64)(TMP5250)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP5250)];
	popFrame();
	return result;
}
...
N_NIMCALL(ttype169681*, getuniquetype_336401)(ttype169681* key) {
	...
	case ((NU8) 12):
	{
		...
		internalerror_129699(((NimStringDesc*) &TMP5249));
	}
	break;
	case ((NU8) 11):
	case ((NU8) 13):
...
N_NIMCALL(trope126007*, makellvmstring_336606)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(170, "ccgutils.nim");
		{
			...
			TMP5255 = modInt((NI64)(TMP5254), 64);
			if (!(((NI) ((NI64)(TMP5255))) == 0)) goto LA4;
