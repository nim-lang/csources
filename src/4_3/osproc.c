...
STRING_LITERAL(TMP940, "sh", 2);
STRING_LITERAL(TMP941, "-c", 2);
NIM_CONST TY105434 TMP939 = {((NimStringDesc*) &TMP940),
((NimStringDesc*) &TMP941)}
;
NIM_CONST TY71482 TMP949 = {((NimStringDesc*) &TMP913),
-1}
;
...
N_NIMCALL(tprocess135203*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, tstringtable103609* env, NU8 options) {
	...
	LA115: ;
	{
		...
		a = tocstringarray_136424(TMP939, 2, LOC119, 1);
	...
	nimln(623, "osproc.nim");
	{
		...
		nimln(624, "osproc.nim");
		LOC131 = 0;
		LOC131 = nsuJoinSep(args, argsLen0, ((NimStringDesc*) &TMP916));
		printf("%s%s%s\012", (command)->data, (((NimStringDesc*) &TMP916))->data, (LOC131)->data);
	}
	LA129: ;
...
N_NIMCALL(void, pruneprocessset_137136)(TY136003** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(727, "osproc.nim");
		{
			...
			nimln(728, "osproc.nim");
			TMP945 = subInt(l, 1);
			if ((NU)((NI64)(TMP945)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRefNoCycle((void**) &(*s)->data[i], (*s)->data[(NI64)(TMP945)]);
...
N_NIMCALL(NI, select_136301)(TY136003** readfds, NI timeout) {
	...
	nimln(737, "osproc.nim");
	TMP946 = mulInt(timeout, 1000);
	tv.tv_usec = (NI64)(TMP946);
	...
	nimln(743, "osproc.nim");
	{
		...
		nimln(744, "osproc.nim");
		TMP947 = addInt(m, 1);
		LOC5 = select(((int)chckRange((NI64)(TMP947), ((int) (-2147483647 -1)), ((int) 2147483647))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		nimln(746, "osproc.nim");
		TMP948 = addInt(m, 1);
		LOC7 = select(((int)chckRange((NI64)(TMP948), ((int) (-2147483647 -1)), ((int) 2147483647))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
...
N_NIMCALL(void, execcmdex_137402)(NimStringDesc* command, NU8 options, TY71482* Result) {
	...
	unsureAsgnRef((void**) &(*Result).Field0, copyString(TMP949.Field0));
	(*Result).Field1 = TMP949.Field1;
