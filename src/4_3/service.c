	...
	while (1) {
		...
		case ((NU8) 3):
		{
			...
			nimln(41, "service.nim");
			{
				...
				key = copyStrLast(p.Key, 0, (NI64)(TMP6802));
				...
				LOC9 = 0;
				LOC9 = copyStr(p.Key, (NI64)(TMP6803));
...
appendString(LOC8, p.Val);
				...
				processswitch_142016(key, val, pass, gcmdlineinfo_128801);
			}
			goto LA4;
			LA6: ;
			{
				nimln(46, "service.nim");
				processswitch_142016(p.Key, p.Val, pass, gcmdlineinfo_128801);
			}
			LA4: ;
		}
		break;
...
N_NIMCALL(void, serve_418077)(TY418079 action) {
	...
	LA2: ;
	{
		...
		while (1) {
			...
			send_120404(stdoutsocket_128873, ((NimStringDesc*) &TMP6838));
