...
N_NIMCALL(trstnode271016*, lastson_271148)(trstnode271016* n) {
	...
	if ((NU)((NI64)(TMP3787)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP3787)];
	popFrame();
	return result;
}
...
appendString((*result), ind);
		...
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI64)(TMP3792), lvltochar_271244[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI64)(TMP3794), 45);
...
appendString((*result), ((NimStringDesc*) &TMP3797));
	...
	case ((NU8) 14):
	{
		...
		l = (((NI64)(TMP3798) >= 30) ? (NI64)(TMP3798) : 30);
...
appendString((*result), tmp);
		...
		TMP3800 = subInt((NI64)(TMP3799), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI64)(TMP3800), 32);
