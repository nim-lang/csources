...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP1565, "L.sentinel < L.bufLen ", 22);
STRING_LITERAL(TMP1568, "0 <= toCopy ", 12);
STRING_LITERAL(TMP1576, "s < L.bufLen ", 13);
STRING_LITERAL(TMP1580, "L.bufLen - oldBufLen == oldBufLen ", 34);
STRING_LITERAL(TMP1586, "pos <= L.sentinel ", 18);
STRING_LITERAL(TMP1588, "L.buf[pos] == \'\\x0D\' ", 21);
STRING_LITERAL(TMP1589, "L.buf[pos] == \'\\x0A\' ", 21);
STRING_LITERAL(TMP1590, "0 < bufLen ", 11);
STRING_LITERAL(TMP1594, "", 0);
STRING_LITERAL(TMP1595, "\012", 1);
STRING_LITERAL(TMP1596, "^\012", 2);
...
N_NIMCALL(void, fillbuffer_160073)(tbaselexer160018* l) {
	...
	nimln(82, "nimlexbase.nim");
	{
		...
		nimln(82, "nimlexbase.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP1565));
	}
	LA3: ;
	nimln(83, "nimlexbase.nim");
	nimln(83, "nimlexbase.nim");
	nimln(83, "nimlexbase.nim");
	TMP1566 = subInt((*l).Buflen, (*l).Sentinel);
	TMP1567 = subInt((NI64)(TMP1566), 1);
	tocopy = (NI64)(TMP1567);
	nimln(84, "nimlexbase.nim");
	{
		...
		nimln(84, "nimlexbase.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP1568));
	}
	LA7: ;
	nimln(85, "nimlexbase.nim");
	{
		...
		nimln(86, "nimlexbase.nim");
		TMP1569 = addInt((*l).Sentinel, 1);
		nimln(86, "nimlexbase.nim");
		TMP1570 = mulInt(tocopy, 1);
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP1569)])), (NI64)(TMP1570));
	}
	LA11: ;
	...
	TMP1572 = mulInt((NI64)(TMP1571), 1);
	LOC13 = llstreamread_159242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP1572));
	TMP1573 = divInt(LOC13, 1);
	charsread = (NI64)(TMP1573);
	nimln(90, "nimlexbase.nim");
	nimln(90, "nimlexbase.nim");
	TMP1574 = addInt(tocopy, charsread);
	s = (NI64)(TMP1574);
	nimln(91, "nimlexbase.nim");
	{
		...
		nimln(91, "nimlexbase.nim");
		nimln(91, "nimlexbase.nim");
		TMP1575 = addInt((*l).Sentinel, 1);
		if (!(charsread < (NI64)(TMP1575))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			nimln(98, "nimlexbase.nim");
			{
				...
				nimln(98, "nimlexbase.nim");
				hiddenraiseassert_71620(((NimStringDesc*) &TMP1576));
			}
			LA22: ;
			...
			LA29: ;
			{
				...
				nimln(108, "nimlexbase.nim");
				TMP1577 = mulInt((*l).Buflen, 2);
				(*l).Buflen = (NI64)(TMP1577);
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				TMP1578 = mulInt((*l).Buflen, 1);
				LOC32 = realloc_4007(((void*) ((*l).Buf)), (NI64)(TMP1578));
				...
				nimln(110, "nimlexbase.nim");
				{
					...
					nimln(110, "nimlexbase.nim");
					nimln(110, "nimlexbase.nim");
					TMP1579 = subInt((*l).Buflen, oldbuflen);
					if (!!(((NI64)(TMP1579) == oldbuflen))) goto LA35;
					nimln(110, "nimlexbase.nim");
					hiddenraiseassert_71620(((NimStringDesc*) &TMP1580));
				}
				LA35: ;
				...
				nimln(111, "nimlexbase.nim");
				nimln(112, "nimlexbase.nim");
				TMP1581 = mulInt(oldbuflen, 1);
				LOC37 = llstreamread_159242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP1581));
				TMP1582 = divInt(LOC37, 1);
				charsread = (NI64)(TMP1582);
				nimln(113, "nimlexbase.nim");
				{
					...
					nimln(114, "nimlexbase.nim");
					TMP1583 = addInt(oldbuflen, charsread);
					(*l).Buf[(NI64)(TMP1583)] = 0;
					nimln(115, "nimlexbase.nim");
					nimln(115, "nimlexbase.nim");
					TMP1584 = addInt(oldbuflen, charsread);
					(*l).Sentinel = (NI64)(TMP1584);
...
N_NIMCALL(NI, fillbaselexer_160813)(tbaselexer160018* l, NI pos) {
	...
	nimln(120, "nimlexbase.nim");
	{
		...
		nimln(120, "nimlexbase.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP1586));
	}
	LA3: ;
...
N_NIMCALL(NI, handlelf_160057)(tbaselexer160018* l, NI pos) {
	...
	nimln(137, "nimlexbase.nim");
	{
		...
		nimln(137, "nimlexbase.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP1589));
	}
	LA3: ;
...
N_NIMCALL(void, openbaselexer_160027)(tbaselexer160018* l, tllstream159204* inputstream, NI buflen) {
	...
	nimln(150, "nimlexbase.nim");
	nimln(150, "nimlexbase.nim");
	TMP1591 = mulInt(buflen, 1);
	LOC5 = alloc_4001((NI64)(TMP1591));
	(*l).Buf = ((NCSTRING) (LOC5));
	nimln(151, "nimlexbase.nim");
	nimln(151, "nimlexbase.nim");
	TMP1592 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP1592);
...
N_NIMCALL(NI, getcolnumber_160046)(tbaselexer160018* l, NI pos) {
	...
	nimln(159, "nimlexbase.nim");
	nimln(159, "nimlexbase.nim");
	TMP1593 = subInt(pos, (*l).Linestart);
	if ((NI64)(TMP1593) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP1593));
	popFrame();
	return result;
}
...
N_NIMCALL(NimStringDesc*, getcurrentline_160041)(tbaselexer160018* l, NIM_BOOL marker) {
	...
	result = copyString(((NimStringDesc*) &TMP1594));
...
appendString(result, ((NimStringDesc*) &TMP1595));
...
appendString(LOC6, ((NimStringDesc*) &TMP1596));
...
static TNimNode* TMP1833[7];
static TNimNode TMP1540[8];
...
TMP1833[0] = &TMP1540[1];
TMP1540[1].kind = 1;
TMP1540[1].offset = offsetof(tbaselexer160018, Bufpos);
TMP1540[1].typ = (&NTI105);
TMP1540[1].name = "bufpos";
TMP1833[1] = &TMP1540[2];
TMP1540[2].kind = 1;
TMP1540[2].offset = offsetof(tbaselexer160018, Buf);
TMP1540[2].typ = (&NTI145);
TMP1540[2].name = "buf";
TMP1833[2] = &TMP1540[3];
TMP1540[3].kind = 1;
TMP1540[3].offset = offsetof(tbaselexer160018, Buflen);
TMP1540[3].typ = (&NTI105);
TMP1540[3].name = "bufLen";
TMP1833[3] = &TMP1540[4];
TMP1540[4].kind = 1;
TMP1540[4].offset = offsetof(tbaselexer160018, Stream);
TMP1540[4].typ = (&NTI159206);
TMP1540[4].name = "stream";
TMP1833[4] = &TMP1540[5];
TMP1540[5].kind = 1;
TMP1540[5].offset = offsetof(tbaselexer160018, Linenumber);
TMP1540[5].typ = (&NTI105);
TMP1540[5].name = "LineNumber";
TMP1833[5] = &TMP1540[6];
TMP1540[6].kind = 1;
TMP1540[6].offset = offsetof(tbaselexer160018, Sentinel);
TMP1540[6].typ = (&NTI105);
TMP1540[6].name = "sentinel";
TMP1833[6] = &TMP1540[7];
TMP1540[7].kind = 1;
TMP1540[7].offset = offsetof(tbaselexer160018, Linestart);
TMP1540[7].typ = (&NTI105);
TMP1540[7].name = "lineStart";
TMP1540[0].len = 7; TMP1540[0].kind = 2; TMP1540[0].sons = &TMP1833[0];
NTI160018.node = &TMP1540[0];
}
