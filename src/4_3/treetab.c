...
static NIM_CONST TY169850 TMP3069 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3070, "ident", 5);
static NIM_CONST TY169850 TMP3071 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3072, "sym", 3);
...
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3076, "floatVal", 8);
static NIM_CONST TY169850 TMP3077 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3078, "strVal", 6);
static NIM_CONST TY169850 TMP3079 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3080, "sons", 4);
STRING_LITERAL(TMP3085, "data[h].key == nil ", 19);
STRING_LITERAL(TMP3086, "not t.data[index].key == nil ", 29);
	...
	LA3: ;
	{
		...
		default:
		{
			nimln(49, "treetab.nim");
			{
				...
				TMP3082 = subInt(LOC25, 1);
				HEX3Atmp_219337 = (NI64)(TMP3082);
				nimln(1274, "system.nim");
				res_219339 = 0;
				nimln(1275, "system.nim");
				while (1) {
...
static N_INLINE(NI, nexttry_176196)(NI h, NI maxhash) {
	...
	nimln(449, "astalgo.nim");
	TMP3083 = mulInt(5, h);
	TMP3084 = addInt((NI64)(TMP3083), 1);
	result = (NI)((NI64)(TMP3084) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, nodetableput_219605)(tnodetable169705* t, tnode169647* key, NI val) {
	...
	nimln(81, "treetab.nim");
	{
		...
		nimln(82, "treetab.nim");
		{
			...
			nimln(82, "treetab.nim");
			hiddenraiseassert_71620(((NimStringDesc*) &TMP3086));
		}
		LA7: ;
...
N_NIMCALL(NI, nodetabletestorset_219881)(tnodetable169705* t, tnode169647* key, NI val) {
	...
	LA3: ;
	{
		nimln(102, "treetab.nim");
		{
			...
			nimln(103, "treetab.nim");
			nimln(103, "treetab.nim");
			TMP3088 = mulInt((*t).Data->Sup.len, 2);
			n = (tnodepairseq169703*) newSeq((&NTI169703), (NI64)(TMP3088));
			i_220037 = 0;
			HEX3Atmp_220074 = 0;
