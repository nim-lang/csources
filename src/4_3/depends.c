...
N_NIMCALL(void, TMP6779)(void* p, NI op);
...
STRING_LITERAL(TMP6771, "$1 -> $2;$n", 11);
static NIM_CONST TY169850 TMP6772 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP6773, "sons", 4);
STRING_LITERAL(TMP6776, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP6777, "", 0);
STRING_LITERAL(TMP6778, "dot", 3);
...
N_NIMCALL(void, adddependencyaux_414018)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	appf_126085(&gdotgraph_414015, ((NimStringDesc*) &TMP6771), LOC1, 2);
	popFrame();
}
...
static N_INLINE(NI, sonslen_170003)(tnode169647* n) {
	...
	{
		nimln(1175, "ast.nim");
		if (((TMP6772[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP6773));
...
N_NIMCALL(tnode169647*, adddotdependency_414030)(tpasscontext218003* c, tnode169647* n) {
	...
	case ((NU8) 115):
	{
		...
		TMP6774 = subInt(LOC2, 1);
		HEX3Atmp_414086 = (NI64)(TMP6774);
	...
	case ((NU8) 125):
	{
		...
		TMP6775 = subInt(LOC6, 1);
		HEX3Atmp_414090 = (NI64)(TMP6775);
		nimln(1274, "system.nim");
		res_414092 = 0;
		nimln(1275, "system.nim");
		while (1) {
...
N_NIMCALL(void, generatedot_414005)(NimStringDesc* project) {
	...
	LOC3 = 0;
	LOC3 = nosChangeFileExt(LOC2, ((NimStringDesc*) &TMP6777));
	LOC1[0] = torope_126058(LOC3);
	LOC1[1] = gdotgraph_414015;
	LOC4 = 0;
	LOC4 = ropef_126079(((NimStringDesc*) &TMP6776), LOC1, 2);
	nimln(47, "depends.nim");
	LOC5 = 0;
	LOC5 = nosChangeFileExt(project, ((NimStringDesc*) &TMP6778));
...
static TNimNode TMP6769[1];
NTI414010.size = sizeof(tgen414010);
NTI414010.kind = 17;
NTI414010.base = (&NTI218003);
NTI414010.flags = 2;
TMP6769[0].kind = 1;
TMP6769[0].offset = offsetof(tgen414010, Module);
TMP6769[0].typ = (&NTI169645);
TMP6769[0].name = "module";
NTI414010.node = &TMP6769[0];
NTI414012.size = sizeof(tgen414010*);
NTI414012.kind = 22;
NTI414012.base = (&NTI414010);
NTI414012.flags = 2;
NTI414012.marker = TMP6779;
}
