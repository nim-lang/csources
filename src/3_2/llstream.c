...
N_NIMCALL(void, TMP1543)(void* p, NI op);
...
N_NIMCALL(tllstream158204*, llstreamopen_158232)(void);
N_NIMCALL(tllstream158204*, llstreamopenstdin_158235)(void);
N_NIMCALL(void, llstreamclose_158238)(tllstream158204* s);
N_NIMCALL(NIM_BOOL, readlinefromstdin_158391)(NimStringDesc* prompt, NimStringDesc** line);
N_NIMCALL(void, write_9262)(FILE* f, NimStringDesc* s);
N_NIMCALL(NIM_BOOL, readline_9286)(FILE* f, NimStringDesc** line);
N_NIMCALL(NIM_BOOL, endswith_158602)(NimStringDesc* x, TY104134 s);
static N_INLINE(NI, subInt)(NI a, NI b);
N_NOINLINE(void, raiseOverflow)(void);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(NIM_BOOL, endswithopr_158638)(NimStringDesc* x);
static N_INLINE(NIM_BOOL, continueline_158644)(NimStringDesc* line, NIM_BOOL intriplestring);
N_NIMCALL(NI, counttriples_158661)(NimStringDesc* s);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NIMCALL(NI, llreadfromstdin_158707)(tllstream158204* s, void* buf, NI buflen);
...
N_NIMCALL(void, llstreamwrite_158268)(tllstream158204* s, void* buf, NI buflen);
N_NIMCALL(NimStringDesc*, llstreamreadall_158254)(tllstream158204* s);
N_NIMCALL(NimStringDesc*, copyStr)(NimStringDesc* s, NI start);
N_NIMCALL(NimStringDesc*, copyStr)(NimStringDesc* s, NI first);
N_NIMCALL(NimStringDesc*, mnewString)(NI len);
N_NIMCALL(NimStringDesc*, mnewString)(NI len);
STRING_LITERAL(TMP1544, "", 0);
NIM_CONST TY104134 linecontinuationoprs_158633 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
NIM_CONST TY104134 additionallinecontinuationoprs_158635 = {
0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x24,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY104134 TMP1546 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY104134 TMP1547 = {
0x00, 0x00, 0x00, 0x00, 0x7A, 0xBC, 0x00, 0xF4,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP1550, ">>> ", 4);
STRING_LITERAL(TMP1551, "... ", 4);
STRING_LITERAL(TMP1552, "\012", 1);
extern TNimType NTI1009; /* TObject */
TNimType NTI158204; /* TLLStream */
TNimType NTI158202; /* TLLStreamKind */
extern TNimType NTI9004; /* TFile */
extern TNimType NTI143; /* string */
extern TNimType NTI105; /* int */
TNimType NTI158206; /* PLLStream */
...
N_NIMCALL(tllstream158204*, llstreamopen_158218)(NimStringDesc* data) {
	...
	result = (tllstream158204*) newObj((&NTI158206), sizeof(tllstream158204));
	(*result).Sup.m_type = (&NTI158204);
...
N_NIMCALL(tllstream158204*, llstreamopenstdin_158235)(void) {
	...
	LOC1 = 0;
	LOC1 = (*result).S; (*result).S = copyStringRC1(((NimStringDesc*) &TMP1544));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
N_NIMCALL(NIM_BOOL, endswithopr_158638)(NimStringDesc* x) {
	...
	result = endswith_158602(x, TMP1546);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_158644)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_158602(line, TMP1547);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(NI, counttriples_158661)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1548 = addInt(i, 1);
			if ((NU)((NI64)(TMP1548)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI64)(TMP1548)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			...
			LOC4 = ((NU8)(s->data[(NI64)(TMP1549)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
N_NIMCALL(NI, llreadfromstdin_158707)(tllstream158204* s, void* buf, NI buflen) {
	...
	LOC1 = 0;
	LOC1 = (*s).S; (*s).S = copyStringRC1(((NimStringDesc*) &TMP1544));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	...
	while (1) {
		...
		nimln(119, "llstream.nim");
		{
			...
			LOC3 = copyString(((NimStringDesc*) &TMP1550));
		}
		goto LA4;
		LA6: ;
		{
		...
		LA4: ;
		LOC9 = readlinefromstdin_158391(LOC3, &line);
		if (!LOC9) goto LA2;
...
appendString((*s).S, ((NimStringDesc*) &TMP1552));
		nimln(122, "llstream.nim");
		nimln(122, "llstream.nim");
		LOC10 = counttriples_158661(line);
		...
		nimln(123, "llstream.nim");
		{
			...
			nimln(123, "llstream.nim");
			nimln(123, "llstream.nim");
			LOC13 = continueline_158644(line, (((NI) ((NI)(triples & 1))) == 1));
			if (!!(LOC13)) goto LA14;
			nimln(123, "llstream.nim");
			goto LA2;
		}
	...
	nimln(125, "llstream.nim");
	nimln(125, "llstream.nim");
	TMP1553 = subInt((*s).S->Sup.len, (*s).Rd);
	result = ((buflen <= (NI64)(TMP1553)) ? buflen : (NI64)(TMP1553));
...
N_NIMCALL(NI, llstreamread_158242)(tllstream158204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		nimln(136, "llstream.nim");
		{
			...
			nimln(137, "llstream.nim");
			TMP1555 = addInt(0, (*s).Rd);
			if ((NU)((NI64)(TMP1555)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI64)(TMP1555)])), result);
	...
	case ((NU8) 3):
	{
		...
		result = llreadfromstdin_158707(s, buf, buflen);
	}
	break;
	}
	popFrame();
...
N_NIMCALL(void, llstreamwriteln_158274)(tllstream158204* s, NimStringDesc* data) {
	...
	llstreamwrite_158258(s, data);
	nimln(180, "llstream.nim");
	llstreamwrite_158258(s, ((NimStringDesc*) &TMP1552));
	popFrame();
}
...
N_NIMCALL(void, llstreamwrite_158268)(tllstream158204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			nimln(200, "llstream.nim");
			nimln(200, "llstream.nim");
			TMP1556 = addInt((*s).S->Sup.len, buflen);
			(*s).S = setLengthStr((*s).S, (NI64)(TMP1556));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1557 = addInt(0, (*s).Wr);
			if ((NU)((NI64)(TMP1557)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI64)(TMP1557)])), buf, buflen);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_158254)(tllstream158204* s) {
	...
	case ((NU8) 3):
	{
		...
		result = copyString(((NimStringDesc*) &TMP1544));
	}
	break;
	case ((NU8) 1):
	{
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			nimln(222, "llstream.nim");
			TMP1558 = addInt(i, 2048);
			result = setLengthStr(result, (NI64)(TMP1558));
			nimln(223, "llstream.nim");
			nimln(223, "llstream.nim");
			TMP1559 = addInt(i, 0);
			if ((NU)((NI64)(TMP1559)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_9317((*s).F, ((void*) (&result->data[(NI64)(TMP1559)])), 2048);
...
"llsFile", 
"llsStdIn"};
static TNimNode TMP1537[12];
NTI158204.size = sizeof(tllstream158204);
NTI158204.kind = 17;
NTI158204.base = (&NTI1009);
NTI158204.flags = 2;
TMP1539[0] = &TMP1537[1];
NTI158202.size = sizeof(NU8);
NTI158202.kind = 14;
NTI158202.base = 0;
NTI158202.flags = 3;
for (TMP1542 = 0; TMP1542 < 4; TMP1542++) {
TMP1537[TMP1542+2].kind = 1;
TMP1537[TMP1542+2].offset = TMP1542;
TMP1537[TMP1542+2].name = TMP1541[TMP1542];
TMP1540[TMP1542] = &TMP1537[TMP1542+2];
}
TMP1537[6].len = 4; TMP1537[6].kind = 2; TMP1537[6].sons = &TMP1540[0];
NTI158202.node = &TMP1537[6];
TMP1537[1].kind = 1;
TMP1537[1].offset = offsetof(tllstream158204, Kind);
TMP1537[1].typ = (&NTI158202);
TMP1537[1].name = "kind";
TMP1539[1] = &TMP1537[7];
TMP1537[7].kind = 1;
TMP1537[7].offset = offsetof(tllstream158204, F);
TMP1537[7].typ = (&NTI9004);
TMP1537[7].name = "f";
TMP1539[2] = &TMP1537[8];
TMP1537[8].kind = 1;
TMP1537[8].offset = offsetof(tllstream158204, S);
TMP1537[8].typ = (&NTI143);
TMP1537[8].name = "s";
TMP1539[3] = &TMP1537[9];
TMP1537[9].kind = 1;
TMP1537[9].offset = offsetof(tllstream158204, Rd);
TMP1537[9].typ = (&NTI105);
TMP1537[9].name = "rd";
TMP1539[4] = &TMP1537[10];
TMP1537[10].kind = 1;
TMP1537[10].offset = offsetof(tllstream158204, Wr);
TMP1537[10].typ = (&NTI105);
TMP1537[10].name = "wr";
TMP1539[5] = &TMP1537[11];
TMP1537[11].kind = 1;
TMP1537[11].offset = offsetof(tllstream158204, Lineoffset);
TMP1537[11].typ = (&NTI105);
TMP1537[11].name = "lineOffset";
TMP1537[0].len = 6; TMP1537[0].kind = 2; TMP1537[0].sons = &TMP1539[0];
NTI158204.node = &TMP1537[0];
NTI158206.size = sizeof(tllstream158204*);
NTI158206.kind = 22;
NTI158206.base = (&NTI158204);
NTI158206.flags = 2;
NTI158206.marker = TMP1543;
}
