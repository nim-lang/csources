...
STRING_LITERAL(TMP2790, "newFileSize == -1 or not mode == fmRead ", 40);
extern TFrame* frameptr_12027;
TNimType NTI204204; /* TMemFile */
...
static TNimNode* TMP2871[3];
static TNimNode TMP2788[4];
NTI204204.size = sizeof(tmemfile204204);
NTI204204.kind = 18;
NTI204204.base = 0;
NTI204204.flags = 3;
TMP2871[0] = &TMP2788[1];
TMP2788[1].kind = 1;
TMP2788[1].offset = offsetof(tmemfile204204, Mem);
TMP2788[1].typ = (&NTI147);
TMP2788[1].name = "mem";
TMP2871[1] = &TMP2788[2];
TMP2788[2].kind = 1;
TMP2788[2].offset = offsetof(tmemfile204204, Size);
TMP2788[2].typ = (&NTI105);
TMP2788[2].name = "size";
TMP2871[2] = &TMP2788[3];
TMP2788[3].kind = 1;
TMP2788[3].offset = offsetof(tmemfile204204, Handle);
TMP2788[3].typ = (&NTI3701);
TMP2788[3].name = "handle";
TMP2788[0].len = 3; TMP2788[0].kind = 2; TMP2788[0].sons = &TMP2871[0];
NTI204204.node = &TMP2788[0];
}
