...
static N_INLINE(void, setid_167436)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP1874 = addInt(id, 1);
	gfrontendid_167005 = ((gfrontendid_167005 >= (NI64)(TMP1874)) ? gfrontendid_167005 : (NI64)(TMP1874));
	popFrame();
}
...
N_NIMCALL(void, idsynchronizationpoint_167445)(NI idrange) {
	...
	TMP1876 = addInt((NI64)(TMP1875), 1);
	TMP1877 = mulInt((NI64)(TMP1876), idrange);
	TMP1878 = addInt((NI64)(TMP1877), 1);
	gfrontendid_167005 = (NI64)(TMP1878);
	popFrame();
}
