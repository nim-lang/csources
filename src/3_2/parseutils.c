...
N_NIMCALL(NI, rawparseint_74996)(NimStringDesc* s, NI64* b, NI start) {
	...
	nimln(200, "parseutils.nim");
	{
		...
		while (1) {
			...
			TMP1063 = subInt64((NI64)(TMP1061), ((NI64) ((NI64)(TMP1062))));
			(*b) = (NI64)(TMP1063);
...
N_NIMCALL(NI, npuParseBiggestFloat)(NimStringDesc* s, NF64* number, NI start) {
	...
	nimln(261, "parseutils.nim");
	{
		...
		nimln(262, "parseutils.nim");
		{
			...
			nimln(262, "parseutils.nim");
			TMP1750 = addInt(i, 1);
			if ((NU)((NI64)(TMP1750)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC16 = ((NU8)(s->data[(NI64)(TMP1750)]) == (NU8)(65));
			if (LOC16) goto LA17;
			nimln(262, "parseutils.nim");
			nimln(262, "parseutils.nim");
			TMP1751 = addInt(i, 1);
			if ((NU)((NI64)(TMP1751)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC16 = ((NU8)(s->data[(NI64)(TMP1751)]) == (NU8)(97));
			LA17: ;
			if (!LOC16) goto LA18;
			nimln(263, "parseutils.nim");
			{
				...
				LOC22 = ((NU8)(s->data[(NI64)(TMP1752)]) == (NU8)(78));
				if (LOC22) goto LA23;
				nimln(263, "parseutils.nim");
				nimln(263, "parseutils.nim");
				TMP1753 = addInt(i, 2);
				if ((NU)((NI64)(TMP1753)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC22 = ((NU8)(s->data[(NI64)(TMP1753)]) == (NU8)(110));
				LA23: ;
				if (!LOC22) goto LA24;
				nimln(264, "parseutils.nim");
				{
					...
					if (!!((((NU8)(s->data[(NI64)(TMP1754)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI64)(TMP1754)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI64)(TMP1754)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI64)(TMP1754)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI64)(TMP1754)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI64)(TMP1754)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI64)(TMP1754)])) == ((NU8)(95))))) goto LA28;
					...
					nimln(266, "parseutils.nim");
					TMP1755 = addInt(i, 3);
					TMP1756 = subInt((NI64)(TMP1755), start);
					result = (NI64)(TMP1756);
					goto BeforeRet;
				}
				LA28: ;
	...
	nimln(268, "parseutils.nim");
	{
		...
		nimln(269, "parseutils.nim");
		{
			...
			LOC38 = ((NU8)(s->data[(NI64)(TMP1757)]) == (NU8)(78));
			if (LOC38) goto LA39;
			nimln(269, "parseutils.nim");
			nimln(269, "parseutils.nim");
			TMP1758 = addInt(i, 1);
			if ((NU)((NI64)(TMP1758)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC38 = ((NU8)(s->data[(NI64)(TMP1758)]) == (NU8)(110));
			LA39: ;
			if (!LOC38) goto LA40;
			nimln(270, "parseutils.nim");
			{
				...
				LOC44 = ((NU8)(s->data[(NI64)(TMP1759)]) == (NU8)(70));
				if (LOC44) goto LA45;
				nimln(270, "parseutils.nim");
				nimln(270, "parseutils.nim");
				TMP1760 = addInt(i, 2);
				if ((NU)((NI64)(TMP1760)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC44 = ((NU8)(s->data[(NI64)(TMP1760)]) == (NU8)(102));
				LA45: ;
				if (!LOC44) goto LA46;
				nimln(271, "parseutils.nim");
				{
					...
					if (!!((((NU8)(s->data[(NI64)(TMP1761)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI64)(TMP1761)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI64)(TMP1761)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI64)(TMP1761)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI64)(TMP1761)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI64)(TMP1761)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI64)(TMP1761)])) == ((NU8)(95))))) goto LA50;
	...
	while (1) {
		...
		(*number) = ((NF64) (((((NF) ((*number))) * 1.0000000000000000e+01) + ((double) (((NI) ((NI64)(TMP1764))))))));
	...
	nimln(296, "parseutils.nim");
	{
		...
		while (1) {
			...
			nimln(306, "parseutils.nim");
			if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
			TMP1767 = addInt((NI64)(TMP1766), ((NI) (((NU8)(s->data[i])))));
			TMP1768 = subInt((NI64)(TMP1767), 48);
			exponent = (NI64)(TMP1768);
