...
extern tsocketimpl110806* stdoutsocket_127873;
...
appendString(LOC8, p.Val);
				...
				processswitch_141016(key, val, pass, gcmdlineinfo_127801);
			}
			goto LA4;
			LA6: ;
			{
				nimln(46, "service.nim");
				processswitch_141016(p.Key, p.Val, pass, gcmdlineinfo_127801);
			}
			LA4: ;
		}
		break;
	...
	nimln(59, "service.nim");
	{
		...
		nimln(60, "service.nim");
		{
			...
			rawmessage_128448(((NU16) 57), LOC37, 0);
		}
		LA35: ;
	}
	LA29: ;
...
N_NIMCALL(void, serve_417077)(TY417079 action) {
	...
	LA2: ;
	{
		...
		if (stdoutsocket_127873) nimGCunrefNoCycle(stdoutsocket_127873);
		stdoutsocket_127873 = (tsocketimpl110806*) newObjRC1((&NTI110808), sizeof(tsocketimpl110806));
		nimln(90, "service.nim");
		while (1) {
			NimStringDesc* LOC21;
			nimln(91, "service.nim");
			accept_114201(server, &stdoutsocket_127873);
			nimln(92, "service.nim");
			readline_118831(stdoutsocket_127873, &inp, -1);
			nimln(65, "service.nim");
			LOC21 = 0;
			...
			send_120203(stdoutsocket_127873, ((NimStringDesc*) &TMP6833));
			nimln(95, "service.nim");
			close_114264(stdoutsocket_127873);
		}
	}
	goto LA4;
	LA3: ;
