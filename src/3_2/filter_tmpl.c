...
N_NIMCALL(void, parseline_192151)(ttmplparser192015* p) {
	...
	LA6: ;
	{
		...
		case ((NU8) 20):
		{
			...
			LA19: ;
			{
				...
				localerror_128673((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP2526));
			}
			LA17: ;
		...
		case ((NU8) 24):
		{
			...
			LOC27 = 0;
			LOC27 = nsuRepeatChar((NI64)(TMP2528), 32);
	...
	LA9: ;
	{
		...
		case ((NU8) 1):
		{
			...
			LOC42 = 0;
			LOC42 = nsuRepeatChar((NI64)(TMP2530), 32);
				...
				nimln(150, "filter_tmpl.nim");
				{
					...
					case 123:
					{
						...
						while (1) {
							...
							case 0:
							{
								...
								localerror_128673((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP2537));
					...
					default:
					{
						...
						LA76: ;
						{
							...
							localerror_128673((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP2538));
						}
						LA74: ;
					}
					break;
...
N_NIMCALL(tllstream158204*, filtertmpl_192005)(tllstream158204* stdin_192007, NimStringDesc* filename, tnode168647* call) {
	...
	p.Info = newlineinfo_127776(filename, 0, 0);
