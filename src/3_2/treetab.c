...
N_NIMCALL(NIM_BOOL, treesequivalent_218166)(tnode168647* a, tnode168647* b);
static N_INLINE(NIM_BOOL, eqStrings)(NimStringDesc* a, NimStringDesc* b);
N_NIMCALL(NIM_BOOL, sametypeornil_199258)(ttype168681* a, ttype168681* b, NU8 flags);
N_NIMCALL(NI, nodetablerawget_218344)(tnodetable168705 t, NI k, tnode168647* key);
static N_INLINE(NI, nexttry_175196)(NI h, NI maxhash);
N_NIMCALL(NI, mulInt)(NI a, NI b);
N_NIMCALL(NI, nodetableget_218366)(tnodetable168705 t, tnode168647* key);
N_NIMCALL(void, nodetablerawinsert_218378)(tnodepairseq168703** data, NI k, tnode168647* key, NI val);
...
N_NIMCALL(NI, hashtree_218014)(tnode168647* n) {
	...
	default:
	{
		...
		while (1) {
			NI LOC27;
			nimln(1275, "system.nim");
			if (!(res_218161 <= HEX3Atmp_218159)) goto LA26;
			nimln(1274, "system.nim");
			i_218141 = res_218161;
			...
			res_218161 = addInt(res_218161, 1);
		} LA26: ;
	}
	break;
	}
	...
	LA3: ;
	{
		...
		default:
		{
			nimln(49, "treetab.nim");
			{
				...
				HEX3Atmp_218337 = (NI64)(TMP3077);
				nimln(1274, "system.nim");
				res_218339 = 0;
				nimln(1275, "system.nim");
				while (1) {
					nimln(1275, "system.nim");
					if (!(res_218339 <= HEX3Atmp_218337)) goto LA26;
					nimln(1274, "system.nim");
					i_218316 = res_218339;
					nimln(51, "treetab.nim");
					{
						...
						if ((NU)(i_218316) >= (NU)((*a).kindU.S6.Sons->Sup.len)) raiseIndexError();
						if (((TMP3074[(*b).Kind/8] &(1<<((*b).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3075));
						if ((NU)(i_218316) >= (NU)((*b).kindU.S6.Sons->Sup.len)) raiseIndexError();
						LOC29 = treesequivalent_218166((*a).kindU.S6.Sons->data[i_218316], (*b).kindU.S6.Sons->data[i_218316]);
						if (!!(LOC29)) goto LA30;
						nimln(51, "treetab.nim");
						goto BeforeRet;
					}
					LA30: ;
					nimln(1277, "system.nim");
					res_218339 = addInt(res_218339, 1);
				} LA26: ;
...
static N_INLINE(NI, nexttry_175196)(NI h, NI maxhash) {
	...
	nimln(449, "astalgo.nim");
	TMP3078 = mulInt(5, h);
	TMP3079 = addInt((NI64)(TMP3078), 1);
	result = (NI)((NI64)(TMP3079) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(NI, nodetablerawget_218344)(tnodetable168705 t, NI k, tnode168647* key) {
	...
	while (1) {
		...
		nimln(58, "treetab.nim");
		{
			...
			nimln(58, "treetab.nim");
			if ((NU)(h) >= (NU)(t.Data->Sup.len)) raiseIndexError();
			LOC4 = treesequivalent_218166(t.Data->data[h].Key, key);
			LA5: ;
			if (!LOC4) goto LA6;
...
N_NIMCALL(NI, nodetableget_218366)(tnodetable168705 t, tnode168647* key) {
	...
	index = nodetablerawget_218344(t, LOC1, key);
...
N_NIMCALL(void, nodetableput_218605)(tnodetable168705* t, tnode168647* key, NI val) {
	...
	index = nodetablerawget_218344((*t), k, key);
	...
	LA3: ;
	{
		nimln(85, "treetab.nim");
		{
			...
			n = (tnodepairseq168703*) newSeq((&NTI168703), (NI64)(TMP3082));
			i_218837 = 0;
			HEX3Atmp_218874 = 0;
			...
			while (1) {
				...
				nimln(88, "treetab.nim");
				{
					...
					if ((NU)(i_218837) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
					if ((NU)(i_218837) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
					nodetablerawinsert_218378(&n, (*t).Data->data[i_218837].H, (*t).Data->data[i_218837].Key, (*t).Data->data[i_218837].Val);
				}
				LA18: ;
				nimln(1277, "system.nim");
		...
		nodetablerawinsert_218378(&(*t).Data, k, key, val);
...
N_NIMCALL(NI, nodetabletestorset_218881)(tnodetable168705* t, tnode168647* key, NI val) {
	...
	LA3: ;
	{
		nimln(102, "treetab.nim");
		{
			...
			n = (tnodepairseq168703*) newSeq((&NTI168703), (NI64)(TMP3083));
			i_219037 = 0;
			HEX3Atmp_219074 = 0;
			...
			while (1) {
				...
				nimln(105, "treetab.nim");
				{
					...
					if ((NU)(i_219037) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
					if ((NU)(i_219037) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
					nodetablerawinsert_218378(&n, (*t).Data->data[i_219037].H, (*t).Data->data[i_219037].Key, (*t).Data->data[i_219037].Val);
				}
				LA18: ;
				nimln(1277, "system.nim");
