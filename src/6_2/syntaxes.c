...
STRING_LITERAL(TMP2558, "standard", 8);
STRING_LITERAL(TMP2559, "braces", 6);
STRING_LITERAL(TMP2560, "endx", 4);
NIM_CONST TY194015 parsernames_194014 = {((NimStringDesc*) &TMP2558),
((NimStringDesc*) &TMP2559),
((NimStringDesc*) &TMP2560)}
;
STRING_LITERAL(TMP2561, "none", 4);
STRING_LITERAL(TMP2562, "stdtmpl", 7);
STRING_LITERAL(TMP2563, "replace", 7);
STRING_LITERAL(TMP2564, "strip", 5);
NIM_CONST TY194020 filternames_194019 = {((NimStringDesc*) &TMP2561),
((NimStringDesc*) &TMP2562),
((NimStringDesc*) &TMP2563),
((NimStringDesc*) &TMP2564)}
;
STRING_LITERAL(TMP2569, "parser to implement", 19);
static NIM_CONST TY169850 TMP2573 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2574, "sons", 4);
static NIM_CONST TY169850 TMP2575 = {
...
N_NIMCALL(tnode169647*, parseall_194046)(tparsers194026* p) {
	...
	case ((NU8) 2):
	{
		...
		internalerror_129699(((NimStringDesc*) &TMP2569));
...
N_NIMCALL(NIM_BOOL, containsshebang_194097)(NimStringDesc* s, NI i) {
	...
	nimln(84, "syntaxes.nim");
	{
		...
		nimln(84, "syntaxes.nim");
		TMP2570 = addInt(i, 1);
		if ((NU)((NI64)(TMP2570)) > (NU)(s->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(s->data[(NI64)(TMP2570)]) == (NU8)(33));
		LA4: ;
		if (!LOC3) goto LA5;
...
N_NIMCALL(tnode169647*, parsepipe_194127)(NimStringDesc* filename, tllstream159204* inputstream) {
	...
	nimln(92, "syntaxes.nim");
	{
		...
		nimln(99, "syntaxes.nim");
		{
			...
			nimln(99, "syntaxes.nim");
			TMP2572 = addInt(i, 1);
			if ((NU)((NI64)(TMP2572)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC14 = ((NU8)(line->data[(NI64)(TMP2572)]) == (NU8)(33));
			LA15: ;
			if (!LOC14) goto LA16;
...
N_NIMCALL(tident131015*, getcallee_194283)(tnode169647* n) {
	...
	nimln(121, "syntaxes.nim");
	{
		...
		if (!(LOC3)) goto LA4;
		nimln(121, "syntaxes.nim");
		if (((TMP2573[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2574));
		...
		if (((TMP2573[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2574));
		if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP2575[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2576));
...
N_NIMCALL(tllstream159204*, evalpipe_194384)(tparsers194026* p, tnode169647* n, NimStringDesc* filename, tllstream159204* start) {
	...
	nimln(152, "syntaxes.nim");
	{
		...
		if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP2575[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2576));
		LOC7 = identeq_131461((*(*n).kindU.S6.Sons->data[0]).kindU.S5.Ident, ((NimStringDesc*) &TMP2577));
		LA10: ;
		if (!LOC7) goto LA11;
		i_194448 = 0;
		nimln(1274, "system.nim");
...
static TNimNode* TMP2566[3];
NI TMP2568;
static char* NIM_CONST TMP2567[3] = {
"skinStandard", 
"skinBraces", 
"skinEndX"};
static TNimNode TMP2194[7];
...
NTI194005.base = 0;
NTI194005.flags = 3;
for (TMP2568 = 0; TMP2568 < 3; TMP2568++) {
TMP2194[TMP2568+2].kind = 1;
TMP2194[TMP2568+2].offset = TMP2568;
TMP2194[TMP2568+2].name = TMP2567[TMP2568];
TMP2566[TMP2568] = &TMP2194[TMP2568+2];
}
TMP2194[5].len = 3; TMP2194[5].kind = 2; TMP2194[5].sons = &TMP2566[0];
NTI194005.node = &TMP2194[5];
TMP2194[1].kind = 1;
TMP2194[1].offset = offsetof(tparsers194026, Skin);
TMP2194[1].typ = (&NTI194005);
TMP2194[1].name = "skin";
TMP2565[1] = &TMP2194[6];
TMP2194[6].kind = 1;
TMP2194[6].offset = offsetof(tparsers194026, Parser);
TMP2194[6].typ = (&NTI183203);
TMP2194[6].name = "parser";
TMP2194[0].len = 2; TMP2194[0].kind = 2; TMP2194[0].sons = &TMP2565[0];
NTI194026.node = &TMP2194[0];
}
