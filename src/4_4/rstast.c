...
N_NIMCALL(void, TMP3786)(void* p, NI op);
...
43}
;
STRING_LITERAL(TMP3789, "\012", 1);
STRING_LITERAL(TMP3791, "", 0);
STRING_LITERAL(TMP3793, "\012\012", 2);
STRING_LITERAL(TMP3795, "* ", 2);
STRING_LITERAL(TMP3796, "(#) ", 4);
STRING_LITERAL(TMP3797, "  ", 2);
STRING_LITERAL(TMP3801, "| ", 2);
STRING_LITERAL(TMP3802, "`", 1);
STRING_LITERAL(TMP3803, "`_", 2);
STRING_LITERAL(TMP3804, " <", 2);
STRING_LITERAL(TMP3805, ">`_", 3);
STRING_LITERAL(TMP3806, "`:", 2);
STRING_LITERAL(TMP3807, "`:sub:", 6);
STRING_LITERAL(TMP3808, "`:sup:", 6);
STRING_LITERAL(TMP3809, "`:idx:", 6);
...
STRING_LITERAL(TMP3816, ".. index::\012", 11);
STRING_LITERAL(TMP3817, ".. contents::", 13);
STRING_LITERAL(TMP3818, "Error: cannot render: ", 22);
...
N_NIMCALL(trstnode271016*, lastson_271148)(trstnode271016* n) {
	...
	nimln(87, "rstast.nim");
	nimln(87, "rstast.nim");
	TMP3787 = subInt((*n).Sons->Sup.len, 1);
	if ((NU)((NI32)(TMP3787)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP3787)];
	popFrame();
	return result;
}
...
N_NIMCALL(void, renderrstsons_271214)(trendercontext271202* d, trstnode271016* n, NimStringDesc** result) {
	...
	nimln(104, "rstast.nim");
	LOC1 = len_271087(n);
	TMP3788 = subInt(LOC1, 1);
	HEX3Atmp_271230 = (NI32)(TMP3788);
...
appendString((*result), ind);
		...
		nimln(123, "rstast.nim");
		nimln(123, "rstast.nim");
		TMP3790 = subInt((*result)->Sup.len, oldlen);
		headlinelen = (NI32)(TMP3790);
...
appendString((*result), ind);
		...
		headline = copyString(((NimStringDesc*) &TMP3791));
		nimln(133, "rstast.nim");
		renderrstsons_271214(d, n, &headline);
		nimln(135, "rstast.nim");
		nimln(135, "rstast.nim");
		nimln(135, "rstast.nim");
		TMP3792 = subInt(headline->Sup.len, (*d).Indent);
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI32)(TMP3792), lvltochar_271244[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		nimln(146, "rstast.nim");
		nimln(146, "rstast.nim");
		TMP3794 = subInt(78, (*d).Indent);
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI32)(TMP3794), 45);
...
appendString((*result), ind);
	...
	case ((NU8) 6):
	{
		...
		tmp = copyString(((NimStringDesc*) &TMP3791));
...
appendString((*result), ((NimStringDesc*) &TMP3797));
	...
	case ((NU8) 14):
	{
		...
		nimln(191, "rstast.nim");
		nimln(191, "rstast.nim");
		TMP3798 = addInt(tmp->Sup.len, 3);
		l = (((NI32)(TMP3798) >= 30) ? (NI32)(TMP3798) : 30);
...
appendString((*result), tmp);
		...
		nimln(199, "rstast.nim");
		nimln(199, "rstast.nim");
		TMP3799 = subInt(l, tmp->Sup.len);
		TMP3800 = subInt((NI32)(TMP3799), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI32)(TMP3800), 32);
...
appendString((*result), (*n).Text);
	...
	case ((NU8) 64):
	{
		nimln(265, "rstast.nim");
		{
			...
			if (!(LOC48)) goto LA49;
			nimln(265, "rstast.nim");
			LOC48 = eqStrings((*n).Text, ((NimStringDesc*) &TMP3814));
			LA49: ;
			if (!LOC48) goto LA50;
...
appendString(LOC60, ((NimStringDesc*) &TMP3818));
...
static TNimNode* TMP3781[4];
static TNimNode* TMP3782[65];
NI TMP3784;
static char* NIM_CONST TMP3783[65] = {
"rnInner", 
"rnHeadline", 
"rnOverline", 
"rnTransition", 
...
NTI271010.base = 0;
NTI271010.flags = 3;
for (TMP3784 = 0; TMP3784 < 65; TMP3784++) {
TMP3779[TMP3784+2].kind = 1;
TMP3779[TMP3784+2].offset = TMP3784;
TMP3779[TMP3784+2].name = TMP3783[TMP3784];
TMP3782[TMP3784] = &TMP3779[TMP3784+2];
}
TMP3779[67].len = 65; TMP3779[67].kind = 2; TMP3779[67].sons = &TMP3782[0];
NTI271010.node = &TMP3779[67];
TMP3779[1].kind = 1;
TMP3779[1].offset = offsetof(trstnode271016, Kind);
TMP3779[1].typ = (&NTI271010);
TMP3779[1].name = "kind";
TMP3781[1] = &TMP3779[68];
TMP3779[68].kind = 1;
TMP3779[68].offset = offsetof(trstnode271016, Text);
TMP3779[68].typ = (&NTI143);
TMP3779[68].name = "text";
TMP3781[2] = &TMP3779[69];
TMP3779[69].kind = 1;
TMP3779[69].offset = offsetof(trstnode271016, Level);
TMP3779[69].typ = (&NTI105);
TMP3779[69].name = "level";
TMP3781[3] = &TMP3779[70];
TMP3779[70].kind = 1;
TMP3779[70].offset = offsetof(trstnode271016, Sons);
TMP3779[70].typ = (&NTI271092);
TMP3779[70].name = "sons";
TMP3779[0].len = 4; TMP3779[0].kind = 2; TMP3779[0].sons = &TMP3781[0];
NTI271016.node = &TMP3779[0];
NTI271012.size = sizeof(trstnode271016*);
NTI271012.kind = 22;
NTI271012.base = (&NTI271016);
NTI271012.flags = 2;
NTI271012.marker = TMP3786;
}
