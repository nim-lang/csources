...
static NIM_CONST TY169850 TMP5244 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5245, "sons", 4);
extern NIM_CONST TY123460 cpu_123459;
STRING_LITERAL(TMP5248, "value expected, but got a type", 30);
STRING_LITERAL(TMP5249, "GetUniqueType", 13);
STRING_LITERAL(TMP5251, "\"", 1);
STRING_LITERAL(TMP5252, "c\"", 2);
STRING_LITERAL(TMP5256, "\\00\"", 4);
...
static N_INLINE(NI, len_170082)(tnode169647* n) {
	...
	{
		nimln(852, "ast.nim");
		if (((TMP5244[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP5245));
...
N_NIMCALL(NI64, hashstring_336092)(NimStringDesc* s) {
	...
	LA3: ;
	{
		...
		nimln(46, "ccgutils.nim");
		nimln(46, "ccgutils.nim");
		TMP5247 = subInt(s->Sup.len, 1);
		HEX3Atmp_336182 = (NI32)(TMP5247);
		nimln(1274, "system.nim");
		res_336184 = 0;
		nimln(1275, "system.nim");
		while (1) {
...
static N_INLINE(ttype169681*, lastson_170015)(ttype169681* n) {
	...
	if ((NU)((NI32)(TMP5250)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP5250)];
	popFrame();
	return result;
}
...
N_NIMCALL(ttype169681*, getuniquetype_336401)(ttype169681* key) {
	...
	case ((NU8) 51):
	{
		...
		internalerror_129702(((NimStringDesc*) &TMP5248));
	}
	break;
	case ((NU8) 12):
	{
		nimln(92, "ccgutils.nim");
		internalerror_129702(((NimStringDesc*) &TMP5249));
	}
	break;
	case ((NU8) 11):
	case ((NU8) 13):
...
N_NIMCALL(NimStringDesc*, makesinglelinecstring_336596)(NimStringDesc* s) {
	...
	result = copyString(((NimStringDesc*) &TMP5251));
	c_336600 = 0;
...
N_NIMCALL(trope126007*, makellvmstring_336606)(NimStringDesc* s) {
	...
	res = copyString(((NimStringDesc*) &TMP5252));
	i_336620 = 0;
	HEX3Atmp_336630 = 0;
	nimln(169, "ccgutils.nim");
	nimln(169, "ccgutils.nim");
	nimln(169, "ccgutils.nim");
	TMP5253 = subInt(s->Sup.len, 1);
	HEX3Atmp_336630 = (NI32)(TMP5253);
	nimln(1274, "system.nim");
	res_336632 = 0;
	nimln(1275, "system.nim");
	while (1) {
		...
		nimln(170, "ccgutils.nim");
		{
			...
			nimln(170, "ccgutils.nim");
			nimln(170, "ccgutils.nim");
			TMP5254 = addInt(i_336620, 1);
			TMP5255 = modInt((NI32)(TMP5254), 64);
			if (!(((NI) ((NI32)(TMP5255))) == 0)) goto LA4;
...
appendString(res, ((NimStringDesc*) &TMP5256));
