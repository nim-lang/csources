...
static N_INLINE(tnode169647*, lastson_170011)(tnode169647* n) {
	...
	if ((NU)((NI32)(TMP4755)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI32)(TMP4755)];
	popFrame();
	return result;
}
...
N_NIMCALL(NU8, ispartofaux_300018)(tnode169647* n, ttype169681* b, tintset166041* marker) {
	...
	case ((NU8) 132):
	{
		...
		while (1) {
			...
			default:
			{
				...
				internalerror_129702(((NimStringDesc*) &TMP4756));
			}
			break;
			}
			nimln(1277, "system.nim");
	...
	default:
	{
		...
		internalerror_129690((*n).Info, ((NimStringDesc*) &TMP4759));
	}
	break;
	}
	BeforeRet: ;
...
static N_INLINE(ttype169681*, lastson_170015)(ttype169681* n) {
	...
	if ((NU)((NI32)(TMP4760)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP4760)];
	popFrame();
	return result;
}
