...
N_NIMCALL(void, patternerror_269036)(tnode169647* n);
...
static N_INLINE(void, add_269042)(NimStringDesc** code, NU8 op);
...
N_NIMCALL(void, compileconstraints_269088)(tnode169647* p, NimStringDesc** result);
...
N_NIMCALL(tnode169647*, semnodekindconstraints_269363)(tnode169647* p);
...
N_NIMCALL(NU8, checkforsideeffects_269500)(tnode169647* n);
static N_INLINE(NIM_BOOL, isroutine_174367)(tsym169677* s);
N_NIMCALL(NU8, isassignable_269669)(tsym169677* owner, tnode169647* n);
...
static NIM_CONST TY169850 TMP3739 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3740, "strVal", 6);
static NIM_CONST TY169850 TMP3741 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3742, "sons", 4);
static NIM_CONST TY169850 TMP3743 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3744, "ident", 5);
STRING_LITERAL(TMP3745, "|", 1);
STRING_LITERAL(TMP3746, "&", 1);
STRING_LITERAL(TMP3747, "~", 1);
STRING_LITERAL(TMP3748, "atom", 4);
STRING_LITERAL(TMP3749, "lit", 3);
STRING_LITERAL(TMP3750, "sym", 3);
STRING_LITERAL(TMP3751, "ident", 5);
STRING_LITERAL(TMP3752, "call", 4);
STRING_LITERAL(TMP3753, "alias", 5);
STRING_LITERAL(TMP3754, "noalias", 7);
STRING_LITERAL(TMP3755, "lvalue", 6);
STRING_LITERAL(TMP3756, "local", 5);
STRING_LITERAL(TMP3757, "sideeffect", 10);
STRING_LITERAL(TMP3758, "nosideeffect", 12);
STRING_LITERAL(TMP3760, "compiler/parampatterns.nim", 26);
NIM_CONST TY71482 TMP3759 = {((NimStringDesc*) &TMP3760),
100}
;
NIM_CONST TY71482 TMP3761 = {((NimStringDesc*) &TMP3760),
107}
;
STRING_LITERAL(TMP3762, "p.Kind == nkCurlyExpr ", 22);
STRING_LITERAL(TMP3763, "parameter pattern too complex", 29);
static NIM_CONST TY169850 TMP3764 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3765, "sym", 3);
...
N_NIMCALL(void, patternerror_269036)(tnode169647* n) {
	...
	localerror_129676((*n).Info, ((NU16) 1), LOC1);
	popFrame();
}
...
N_NIMCALL(NU8, whichalias_269055)(tsym169677* p) {
	...
	nimln(51, "parampatterns.nim");
	{
		...
		nimln(52, "parampatterns.nim");
		if (!(((TMP3739[(*(*p).Constraint).Kind/8] &(1<<((*(*p).Constraint).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3740));
...
static N_INLINE(NI, len_170082)(tnode169647* n) {
	...
	{
		nimln(852, "ast.nim");
		if (((TMP3741[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3742));
...
N_NIMCALL(void, compileconstraints_269088)(tnode169647* p, NimStringDesc** result) {
	...
	case ((NU8) 32):
	{
		...
		nimln(59, "parampatterns.nim");
		{
			nimln(684, "system.nim");
			nimln(684, "system.nim");
			if (((TMP3741[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3742));
			...
			if (((TMP3741[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3742));
			if ((NU)(0) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
			patternerror_269036((*p).kindU.S6.Sons->data[0]);
		...
		if (((TMP3741[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3742));
		if ((NU)(0) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3743[(*(*p).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*p).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3744));
		...
		nimln(63, "parampatterns.nim");
		{
			...
			nimln(64, "parampatterns.nim");
			{
				...
				nimln(64, "parampatterns.nim");
				nimln(64, "parampatterns.nim");
				LOC13 = eqStrings((*op).S, ((NimStringDesc*) &TMP3745));
				if (LOC13) goto LA14;
				nimln(64, "parampatterns.nim");
				LOC13 = ((*op).Sup.Id == 47);
				LA14: ;
				...
				compileconstraints_269088((*p).kindU.S6.Sons->data[1], result);
				nimln(66, "parampatterns.nim");
				if (((TMP3741[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3742));
				if ((NU)(2) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
				compileconstraints_269088((*p).kindU.S6.Sons->data[2], result);
				nimln(67, "parampatterns.nim");
				add_269042(result, ((NU8) 2));
			}
			goto LA11;
			LA15: ;
			{
				...
				nimln(68, "parampatterns.nim");
				LOC18 = eqStrings((*op).S, ((NimStringDesc*) &TMP3746));
				if (LOC18) goto LA19;
				nimln(68, "parampatterns.nim");
				LOC18 = ((*op).Sup.Id == 2);
				LA19: ;
				...
				add_269042(result, ((NU8) 3));
			}
			goto LA11;
			LA20: ;
			{
				nimln(73, "parampatterns.nim");
				patternerror_269036(p);
			}
			LA11: ;
		}
		goto LA6;
		LA9: ;
		{
			...
			nimln(74, "parampatterns.nim");
			nimln(74, "parampatterns.nim");
			LOC27 = eqStrings((*op).S, ((NimStringDesc*) &TMP3747));
			if (LOC27) goto LA28;
			nimln(74, "parampatterns.nim");
			LOC27 = ((*op).Sup.Id == 43);
			LA28: ;
	...
	case ((NU8) 37):
	{
		nimln(80, "parampatterns.nim");
		{
			...
			if (((TMP3741[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3742));
			if ((NU)(0) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
			compileconstraints_269088((*p).kindU.S6.Sons->data[0], result);
		}
		goto LA33;
		LA36: ;
		{
	...
	case ((NU8) 2):
	{
		...
		if (!(((TMP3743[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3744));
		spec = nsuNormalize((*(*p).kindU.S5.Ident).S);
		nimln(86, "parampatterns.nim");
		switch (hashString(spec) & 15) {
		case 1: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3758))) goto LA50;
break;
		case 3: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3754))) goto LA46;
if (eqStrings(spec, ((NimStringDesc*) &TMP3755))) goto LA47;
if (eqStrings(spec, ((NimStringDesc*) &TMP3757))) goto LA49;
break;
		case 4: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3750))) goto LA42;
break;
		case 6: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3751))) goto LA43;
if (eqStrings(spec, ((NimStringDesc*) &TMP3756))) goto LA48;
break;
		case 11: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3748))) goto LA40;
break;
		case 12: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3749))) goto LA41;
break;
		case 13: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3752))) goto LA44;
break;
		case 14: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3753))) goto LA45;
break;
		}
		goto LA51;
		LA40: ;
		{
			...
			add_269042(result, ((NU8) 6));
		}
		goto LA52;
		LA41: ;
		{
			nimln(88, "parampatterns.nim");
			add_269042(result, ((NU8) 7));
		}
		goto LA52;
		LA42: ;
		{
			nimln(89, "parampatterns.nim");
			add_269042(result, ((NU8) 5));
		}
		goto LA52;
		LA43: ;
		{
			nimln(90, "parampatterns.nim");
			add_269042(result, ((NU8) 8));
		}
		goto LA52;
		LA44: ;
		{
			nimln(91, "parampatterns.nim");
			add_269042(result, ((NU8) 9));
		}
		goto LA52;
		LA45: ;
		{
		...
		LA47: ;
		{
			...
			add_269042(result, ((NU8) 12));
		}
		goto LA52;
		LA48: ;
		{
			nimln(95, "parampatterns.nim");
			add_269042(result, ((NU8) 13));
		}
		goto LA52;
		LA49: ;
		{
			nimln(96, "parampatterns.nim");
			add_269042(result, ((NU8) 14));
		}
		goto LA52;
		LA50: ;
		{
			nimln(97, "parampatterns.nim");
			add_269042(result, ((NU8) 15));
		}
		goto LA52;
		LA51: ;
		{
			...
			nimln(793, "msgs.nim");
			{
				...
				nimln(793, "msgs.nim");
				LOC69 = 0;
				LOC69 = HEX24_129780(TMP3759);
				internalerror_129702(LOC69);
			}
			LA67: ;
			i_269283 = 0;
			...
			while (1) {
				nimln(1282, "system.nim");
				if (!(res_269352 <= ((NU8) 22))) goto LA70;
				nimln(1281, "system.nim");
				i_269283 = res_269352;
			...
			nimln(793, "msgs.nim");
			{
				...
				nimln(793, "msgs.nim");
				LOC81 = 0;
				LOC81 = HEX24_129780(TMP3761);
				internalerror_129702(LOC81);
			}
			LA79: ;
			i_269337 = 0;
			nimln(1281, "system.nim");
			...
			while (1) {
				nimln(1282, "system.nim");
				if (!(res_269357 <= ((NU8) 151))) goto LA82;
				nimln(1281, "system.nim");
				i_269337 = res_269357;
				nimln(109, "parampatterns.nim");
				{
					...
					nimln(109, "parampatterns.nim");
					nimln(109, "parampatterns.nim");
					LOC85 = nsuCmpIgnoreStyle(reprEnum(i_269337, (&NTI169022)), spec);
					if (!(LOC85 == 0)) goto LA86;
					nimln(110, "parampatterns.nim");
					add_269042(result, ((NU8) 11));
					nimln(111, "parampatterns.nim");
					nimln(111, "parampatterns.nim");
					nimln(111, "parampatterns.nim");
					(*result) = addChar((*result), ((NIM_CHAR) (((NI) (i_269337)))));
					nimln(112, "parampatterns.nim");
					goto BeforeRet;
				}
				LA86: ;
				nimln(1284, "system.nim");
				res_269357 = addInt(res_269357, 1);
			} LA82: ;
...
N_NIMCALL(tnode169647*, semnodekindconstraints_269363)(tnode169647* p) {
	...
	nimln(120, "parampatterns.nim");
	{
		...
		nimln(120, "parampatterns.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP3762));
	}
	LA3: ;
	nimln(121, "parampatterns.nim");
	result = newnodei_169921(((NU8) 20), (*p).Info);
	nimln(122, "parampatterns.nim");
	if (!(((TMP3739[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3740));
	nimln(122, "parampatterns.nim");
	...
	nimln(124, "parampatterns.nim");
	{
		...
		nimln(125, "parampatterns.nim");
		LOC10 = len_170082(p);
		HEX3Atmp_269487 = subInt(LOC10, 1);
		nimln(1281, "system.nim");
		res_269489 = 1;
		nimln(1282, "system.nim");
		while (1) {
			nimln(1282, "system.nim");
			if (!(res_269489 <= HEX3Atmp_269487)) goto LA11;
			nimln(1281, "system.nim");
			i_269442 = res_269489;
			nimln(126, "parampatterns.nim");
			if (((TMP3741[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3742));
			if ((NU)(i_269442) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!(((TMP3739[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3740));
			compileconstraints_269088((*p).kindU.S6.Sons->data[i_269442], &(*result).kindU.S3.Strval);
			nimln(1284, "system.nim");
			res_269489 = addInt(res_269489, 1);
		} LA11: ;
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_129690((*p).Info, ((NimStringDesc*) &TMP3763));
		}
		LA14: ;
	}
	goto LA5;
	...
	if (!(((TMP3739[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3740));
	add_269042(&(*result).kindU.S3.Strval, ((NU8) 1));
	popFrame();
	return result;
}
...
N_NIMCALL(NU8, checkforsideeffects_269500)(tnode169647* n) {
	...
	case ((NU8) 32):
	{
		...
		nimln(143, "parampatterns.nim");
		{
			...
			if (!(LOC4)) goto LA5;
			nimln(143, "parampatterns.nim");
			if (!(((TMP3764[(*op).Kind/8] &(1<<((*op).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3765));
			LOC4 = isroutine_174367((*op).kindU.S4.Sym);
			LA5: ;
			if (!LOC4) goto LA6;
		...
		nimln(156, "parampatterns.nim");
		LOC16 = len_170082(n);
		HEX3Atmp_269650 = subInt(LOC16, 1);
		nimln(1281, "system.nim");
		res_269652 = 0;
		nimln(1282, "system.nim");
		while (1) {
			NU8 ret;
			nimln(1282, "system.nim");
			if (!(res_269652 <= HEX3Atmp_269650)) goto LA17;
			nimln(1281, "system.nim");
			i_269575 = res_269652;
			nimln(157, "parampatterns.nim");
			if (((TMP3741[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3742));
			if ((NU)(i_269575) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			ret = checkforsideeffects_269500((*n).kindU.S6.Sons->data[i_269575]);
			...
			LA18: ;
			nimln(1284, "system.nim");
			res_269652 = addInt(res_269652, 1);
		} LA17: ;
	}
	break;
	case ((NU8) 0) ... ((NU8) 23):
	...
	default:
	{
		...
		nimln(165, "parampatterns.nim");
		LOC29 = len_170082(n);
		HEX3Atmp_269654 = subInt(LOC29, 1);
		nimln(1281, "system.nim");
		res_269656 = 0;
		nimln(1282, "system.nim");
		while (1) {
			NU8 ret;
			nimln(1282, "system.nim");
			if (!(res_269656 <= HEX3Atmp_269654)) goto LA30;
			nimln(1281, "system.nim");
			i_269620 = res_269656;
			nimln(166, "parampatterns.nim");
			if (((TMP3741[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3742));
			if ((NU)(i_269620) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			ret = checkforsideeffects_269500((*n).kindU.S6.Sons->data[i_269620]);
			...
			LA31: ;
			nimln(1284, "system.nim");
			res_269656 = addInt(res_269656, 1);
		} LA30: ;
	}
	break;
	}
...
N_NIMCALL(NU8, isassignable_269669)(tsym169677* owner, tnode169647* n) {
	...
	case ((NU8) 3):
	{
		...
		{
			nimln(716, "system.nim");
			if (!(((TMP3764[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3765));
	...
	case ((NU8) 45):
	{
		nimln(192, "parampatterns.nim");
		{
			...
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC18 = 0;
			LOC18 = skiptypes_196116((*(*n).kindU.S6.Sons->data[0]).Typ, IL64(211106232576000));
		...
		LA19: ;
		{
			...
			if (((TMP3741[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3742));
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			result = isassignable_269669(owner, (*n).kindU.S6.Sons->data[0]);
		}
		LA16: ;
		nimln(197, "parampatterns.nim");
		{
			...
			if (!(((TMP3764[(*(*n).kindU.S6.Sons->data[1]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[1]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3765));
	...
	case ((NU8) 42):
	{
		nimln(200, "parampatterns.nim");
		{
			...
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC31 = 0;
			LOC31 = skiptypes_196116((*(*n).kindU.S6.Sons->data[0]).Typ, IL64(211106232576000));
	...
	case ((NU8) 60):
	{
		nimln(208, "parampatterns.nim");
		{
			...
			nimln(208, "parampatterns.nim");
			LOC38 = 0;
			LOC38 = skiptypes_196116((*n).Typ, IL64(211106247256064));
			if (!((*LOC38).Kind == ((NU8) 27) || (*LOC38).Kind == ((NU8) 18) || (*LOC38).Kind == ((NU8) 17))) goto LA39;
			nimln(210, "parampatterns.nim");
			if (((TMP3741[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3742));
			if ((NU)(1) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			result = isassignable_269669(owner, (*n).kindU.S6.Sons->data[1]);
		}
		goto LA36;
		LA39: ;
		{
			...
			if (((TMP3741[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3742));
			if ((NU)(1) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC42 = comparetypes_201867((*n).Typ, (*(*n).kindU.S6.Sons->data[1]).Typ, ((NU8) 1), 0);
			if (!LOC42) goto LA43;
...
N_NIMCALL(NIM_BOOL, matchnodekinds_269914)(tnode169647* p, tnode169647* n) {
	...
	while (1) {
		...
		case ((NU8) 2):
		{
			...
			LOC4 = stack[((NI32)(TMP3767))- 0];
			if (LOC4) goto LA5;
			nimln(239, "parampatterns.nim");
			TMP3768 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3768)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI32)(TMP3768))- 0];
			LA5: ;
			stack[((NI32)(TMP3766))- 0] = LOC4;
		...
		case ((NU8) 3):
		{
			...
			nimln(242, "parampatterns.nim");
			TMP3770 = subInt(sp, 1);
			if ((NU)((NI32)(TMP3770)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI32)(TMP3770))- 0];
			if (!(LOC7)) goto LA8;
			nimln(242, "parampatterns.nim");
			TMP3771 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3771)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI32)(TMP3771))- 0];
			LA8: ;
			stack[((NI32)(TMP3769))- 0] = LOC7;
		...
		case ((NU8) 4):
		{
			...
			nimln(244, "parampatterns.nim");
			TMP3773 = subInt(sp, 1);
			if ((NU)((NI32)(TMP3773)) > (NU)(64)) raiseIndexError();
			stack[((NI32)(TMP3772))- 0] = !(stack[((NI32)(TMP3773))- 0]);
		}
		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(251, "parampatterns.nim");
			TMP3774 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3774)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3774)])), ((NU8) 0), ((NU8) 22)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			nimln(255, "parampatterns.nim");
			TMP3775 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3775)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3775)])), ((NU8) 0), ((NU8) 151)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 12):
		{
			...
			LOC20 = isassignable_269669(NIM_NIL, n);
		...
		case ((NU8) 13):
		{
			...
			nimln(259, "parampatterns.nim");
			LOC22 = isassignable_269669(NIM_NIL, n);
		...
		case ((NU8) 14):
		{
			...
			nimln(260, "parampatterns.nim");
			LOC24 = checkforsideeffects_269500(n);
		...
		case ((NU8) 15):
		{
			...
			LOC26 = checkforsideeffects_269500(n);
	...
	nimln(263, "parampatterns.nim");
	TMP3776 = subInt(sp, 1);
	if ((NU)((NI32)(TMP3776)) > (NU)(64)) raiseIndexError();
	result = stack[((NI32)(TMP3776))- 0];
	popFrame();
	return result;
}
