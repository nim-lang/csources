...
STRING_LITERAL(TMP1346, "head", 4);
STRING_LITERAL(TMP1349, ".", 1);
STRING_LITERAL(TMP1350, "..", 2);
STRING_LITERAL(TMP1354, ".nim", 4);
...
N_NIMCALL(NIM_BOOL, HEX3CHEX2E_141045)(NimStringDesc* a, NimStringDesc* b) {
	...
	{
		nimln(28, "babelcmd.nim");
		if (!eqStrings(a, ((NimStringDesc*) &TMP1346))) goto LA3;
		nimln(28, "babelcmd.nim");
		nimln(28, "babelcmd.nim");
		result = NIM_FALSE;
		goto BeforeRet;
...
N_NIMCALL(void, addpackage_141115)(tstringtable103609* packages, NimStringDesc* p) {
	...
	nimln(48, "babelcmd.nim");
	TMP1347 = subInt(x, 1);
	name = copyStrLast(p, 0, (NI32)(TMP1347));
	nimln(49, "babelcmd.nim");
	{
		...
		nimln(50, "babelcmd.nim");
		TMP1348 = addInt(x, 1);
		version = copyStr(p, (NI32)(TMP1348));
	...
	LA3: ;
	{
		...
		nstPut(packages, name, ((NimStringDesc*) &TMP1346));
	}
	LA1: ;
	popFrame();
}
...
N_NIMCALL(void, addbabelpath_141141)(NimStringDesc* p, tlineinfo128308 info) {
	...
	nimln(62, "babelcmd.nim");
	{
		...
		nimln(63, "babelcmd.nim");
		{
			...
			nimln(63, "babelcmd.nim");
			message_129683(info, ((NU16) 256), p);
		}
		LA8: ;
	...
	nimln(1112, "os.nim");
	{
		...
		while (1) {
			...
			nimln(1117, "os.nim");
			{
				...
				nimln(684, "system.nim");
				nimln(684, "system.nim");
				LOC12 = !(eqStrings(y_141169, ((NimStringDesc*) &TMP1349)));
				if (!(LOC12)) goto LA13;
				nimln(684, "system.nim");
				nimln(684, "system.nim");
				LOC12 = !(eqStrings(y_141169, ((NimStringDesc*) &TMP1350)));
				LA13: ;
				if (!LOC12) goto LA14;
				...
				nimln(69, "babelcmd.nim");
				{
					...
					if (!(LOC33)) goto LA34;
					nimln(69, "babelcmd.nim");
					LOC33 = nsuEndsWith(path_141157, ((NimStringDesc*) &TMP1354));
					LA34: ;
					if (!LOC33) goto LA35;
		...
		nimln(1112, "os.nim");
		{
			...
			while (1) {
				...
				nimln(1117, "os.nim");
				{
					...
					nimln(684, "system.nim");
					nimln(684, "system.nim");
					LOC18 = !(eqStrings(y_141183, ((NimStringDesc*) &TMP1349)));
					if (!(LOC18)) goto LA19;
					nimln(684, "system.nim");
					nimln(684, "system.nim");
					LOC18 = !(eqStrings(y_141183, ((NimStringDesc*) &TMP1350)));
					LA19: ;
					if (!LOC18) goto LA20;
...
N_NIMCALL(void, addpathrec_141191)(NimStringDesc* dir, tlineinfo128308 info) {
	...
	nimln(1112, "os.nim");
	{
		...
		while (1) {
			...
			nimln(1117, "os.nim");
			{
				...
				nimln(684, "system.nim");
				nimln(684, "system.nim");
				LOC16 = !(eqStrings(y_141233, ((NimStringDesc*) &TMP1349)));
				if (!(LOC16)) goto LA17;
				nimln(684, "system.nim");
				nimln(684, "system.nim");
				LOC16 = !(eqStrings(y_141233, ((NimStringDesc*) &TMP1350)));
				LA17: ;
				if (!LOC16) goto LA18;
	...
	while (1) {
		...
		nimln(41, "strtabs.nim");
		{
			...
			{
				nimln(58, "babelcmd.nim");
				if (!eqStrings(val_141241, ((NimStringDesc*) &TMP1346))) goto LA49;
