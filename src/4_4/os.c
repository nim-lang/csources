...
N_NIMCALL(NimStringDesc*, nosparentDir)(NimStringDesc* path) {
	...
	nimln(558, "os.nim");
	{
		...
		if ((NU)((NI32)(TMP1843)) > (NU)(path->Sup.len)) raiseIndexError();
		if (!(((NU8)(path->data[(NI32)(TMP1843)])) == ((NU8)(47)) || ((NU8)(path->data[(NI32)(TMP1843)])) == ((NU8)(47)))) goto LA3;
		nimln(559, "os.nim");
		q = 2;
	}
	LA3: ;
	...
	nimln(564, "os.nim");
	{
		...
		result = copyStrLast(path, 0, (NI32)(TMP1845));
	}
	goto LA10;
	LA12: ;
	{
