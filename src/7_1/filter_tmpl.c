...
N_NIMCALL(void, parseline_193151)(ttmplparser193015* p) {
	...
	LA6: ;
	{
		...
		case ((NU8) 20):
		{
			...
			LA19: ;
			{
				...
				localerror_129676((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP2536));
			}
			LA17: ;
		...
		case ((NU8) 24):
		{
			...
			LOC27 = 0;
			LOC27 = nsuRepeatChar((NI32)(TMP2538), 32);
	...
	LA9: ;
	{
		...
		case ((NU8) 1):
		{
			...
			LOC42 = 0;
			LOC42 = nsuRepeatChar((NI32)(TMP2540), 32);
				...
				nimln(150, "filter_tmpl.nim");
				{
					...
					case 123:
					{
						...
						while (1) {
							...
							case 0:
							{
								...
								localerror_129676((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP2547));
					...
					default:
					{
						...
						LA76: ;
						{
							...
							localerror_129676((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP2548));
						}
						LA74: ;
					}
					break;
