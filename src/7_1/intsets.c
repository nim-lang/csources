...
STRING_LITERAL(TMP1861, "counter < length ", 17);
STRING_LITERAL(TMP1867, "not data[h] == desc ", 20);
STRING_LITERAL(TMP1868, "data[h] == nil ", 15);
STRING_LITERAL(TMP1877, "t.data[h] == nil ", 17);
STRING_LITERAL(TMP1878, "dest.data[h] == nil ", 20);
STRING_LITERAL(TMP1879, "{", 1);
STRING_LITERAL(TMP1880, ", ", 2);
STRING_LITERAL(TMP1881, "}", 1);
...
static N_INLINE(NIM_BOOL, mustrehash_166052)(NI length, NI counter) {
	...
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	TMP1862 = mulInt(length, 2);
	nimln(48, "intsets.nim");
	TMP1863 = mulInt(counter, 3);
	LOC5 = ((NI32)(TMP1862) < (NI32)(TMP1863));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	TMP1864 = subInt(length, counter);
	LOC5 = ((NI32)(TMP1864) < 4);
	LA6: ;
	result = LOC5;
	popFrame();
...
static N_INLINE(NI, nexttry_166207)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1865 = mulInt(5, h);
	TMP1866 = addInt((NI32)(TMP1865), 1);
	result = (NI)((NI32)(TMP1866) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, intsetenlarge_166604)(tintset166041* t) {
	...
	TMP1870 = mulInt((NI32)(TMP1869), 2);
	TMP1871 = subInt((NI32)(TMP1870), 1);
	(*t).Max = (NI32)(TMP1871);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1872 = addInt((*t).Max, 1);
	n = (ttrunkseq166039*) newSeq((&NTI166039), (NI32)(TMP1872));
	i_166630 = 0;
...
N_NIMCALL(ttrunk166037*, intsetput_166659)(tintset166041* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		nimln(84, "intsets.nim");
		nimln(84, "intsets.nim");
		TMP1876 = addInt((*t).Max, 1);
		LOC8 = mustrehash_166052((NI32)(TMP1876), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
	...
	nimln(88, "intsets.nim");
	{
		...
		nimln(88, "intsets.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP1877));
	}
	LA14: ;
...
N_NIMCALL(void, assign_166916)(tintset166041* dest, tintset166041 src) {
	...
	while (1) {
		...
		nimln(152, "intsets.nim");
		{
			...
			nimln(152, "intsets.nim");
			hiddenraiseassert_71620(((NimStringDesc*) &TMP1878));
		}
		LA5: ;
		n = 0;
...
N_NIMCALL(NimStringDesc*, HEX24_167086)(tintset166041 s) {
	...
	result = copyString(((NimStringDesc*) &TMP1879));
	key_167091 = 0;
...
appendString(result, ((NimStringDesc*) &TMP1880));
					}
					LA10: ;
...
appendString(result, ((NimStringDesc*) &TMP1881));
	popFrame();
	return result;
}
...
static TNimNode* TMP1873[3];
static TNimNode* TMP3281[4];
static TNimNode TMP1859[9];
NTI166037.size = sizeof(ttrunk166037);
NTI166037.kind = 18;
NTI166037.base = 0;
TMP1873[0] = &TMP1859[1];
TMP1859[1].kind = 1;
TMP1859[1].offset = offsetof(ttrunk166037, Next);
TMP1859[1].typ = (&NTI166035);
TMP1859[1].name = "next";
TMP1873[1] = &TMP1859[2];
TMP1859[2].kind = 1;
TMP1859[2].offset = offsetof(ttrunk166037, Key);
TMP1859[2].typ = (&NTI105);
TMP1859[2].name = "key";
TMP1873[2] = &TMP1859[3];
TMP1859[3].kind = 1;
TMP1859[3].offset = offsetof(ttrunk166037, Bits);
TMP1859[3].typ = (&NTI21621);
TMP1859[3].name = "bits";
TMP1859[0].len = 3; TMP1859[0].kind = 2; TMP1859[0].sons = &TMP1873[0];
NTI166037.node = &TMP1859[0];
NTI166035.size = sizeof(ttrunk166037*);
NTI166035.kind = 22;
NTI166035.base = (&NTI166037);
NTI166035.marker = TMP1874;
NTI166039.size = sizeof(ttrunkseq166039*);
NTI166039.kind = 24;
NTI166039.base = (&NTI166035);
NTI166039.flags = 2;
NTI166039.marker = TMP1875;
...
TMP3281[0] = &TMP1859[5];
TMP1859[5].kind = 1;
TMP1859[5].offset = offsetof(tintset166041, Counter);
TMP1859[5].typ = (&NTI105);
TMP1859[5].name = "counter";
TMP3281[1] = &TMP1859[6];
TMP1859[6].kind = 1;
TMP1859[6].offset = offsetof(tintset166041, Max);
TMP1859[6].typ = (&NTI105);
TMP1859[6].name = "max";
TMP3281[2] = &TMP1859[7];
TMP1859[7].kind = 1;
TMP1859[7].offset = offsetof(tintset166041, Head);
TMP1859[7].typ = (&NTI166035);
TMP1859[7].name = "head";
TMP3281[3] = &TMP1859[8];
TMP1859[8].kind = 1;
TMP1859[8].offset = offsetof(tintset166041, Data);
TMP1859[8].typ = (&NTI166039);
TMP1859[8].name = "data";
TMP1859[4].len = 4; TMP1859[4].kind = 2; TMP1859[4].sons = &TMP3281[0];
NTI166041.node = &TMP1859[4];
}
