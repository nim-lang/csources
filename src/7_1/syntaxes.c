...
N_NIMCALL(tnode169647*, parseall_194046)(tparsers194026* p) {
	...
	case ((NU8) 2):
	{
		...
		internalerror_129702(((NimStringDesc*) &TMP2569));
...
N_NIMCALL(NIM_BOOL, containsshebang_194097)(NimStringDesc* s, NI i) {
	...
	nimln(84, "syntaxes.nim");
	{
		...
		nimln(84, "syntaxes.nim");
		TMP2570 = addInt(i, 1);
		if ((NU)((NI32)(TMP2570)) > (NU)(s->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(s->data[(NI32)(TMP2570)]) == (NU8)(33));
		LA4: ;
		if (!LOC3) goto LA5;
...
N_NIMCALL(tnode169647*, parsepipe_194127)(NimStringDesc* filename, tllstream159204* inputstream) {
	...
	nimln(92, "syntaxes.nim");
	{
		...
		nimln(99, "syntaxes.nim");
		{
			...
			nimln(99, "syntaxes.nim");
			TMP2572 = addInt(i, 1);
			if ((NU)((NI32)(TMP2572)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC14 = ((NU8)(line->data[(NI32)(TMP2572)]) == (NU8)(33));
			LA15: ;
			if (!LOC14) goto LA16;
