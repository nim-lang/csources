...
N_NIMCALL(NIM_BOOL, treesequivalent_223166)(tnode173647* a, tnode173647* b);
static N_INLINE(NIM_BOOL, eqStrings)(NimStringDesc* a, NimStringDesc* b);
N_NIMCALL(NIM_BOOL, sametypeornil_204258)(ttype173681* a, ttype173681* b, NU8 flags);
N_NIMCALL(NI, nodetablerawget_223344)(tnodetable173705 t, NI k, tnode173647* key);
static N_INLINE(NI, nexttry_180196)(NI h, NI maxhash);
N_NIMCALL(NI, mulInt)(NI a, NI b);
N_NIMCALL(NI, nodetableget_223366)(tnodetable173705 t, tnode173647* key);
N_NIMCALL(void, nodetablerawinsert_223378)(tnodepairseq173703** data, NI k, tnode173647* key, NI val);
...
N_NIMCALL(NI, hashtree_223014)(tnode173647* n) {
	...
	case ((NU8) 5) ... ((NU8) 15):
	{
		nimln(26, "treetab.nim");
		{
			...
			if (!(((TMP3069[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3070));
			result = HEX21HEX26_105011(result, ((NI) ((*n).kindU.S1.Intval)));
		}
		LA13: ;
	}
	break;
	...
	default:
	{
		...
		while (1) {
			NI LOC27;
			nimln(1275, "system.nim");
			if (!(res_223161 <= HEX3Atmp_223159)) goto LA26;
			nimln(1274, "system.nim");
			i_223141 = res_223161;
			...
			res_223161 = addInt(res_223161, 1);
		} LA26: ;
	}
	break;
	}
	...
	LA3: ;
	{
		...
		default:
		{
			nimln(49, "treetab.nim");
			{
				...
				HEX3Atmp_223337 = (NI64)(TMP3078);
				nimln(1274, "system.nim");
				res_223339 = 0;
				nimln(1275, "system.nim");
				while (1) {
					nimln(1275, "system.nim");
					if (!(res_223339 <= HEX3Atmp_223337)) goto LA26;
					nimln(1274, "system.nim");
					i_223316 = res_223339;
					nimln(51, "treetab.nim");
					{
						...
						if ((NU)(i_223316) >= (NU)((*a).kindU.S6.Sons->Sup.len)) raiseIndexError();
						if (((TMP3075[(*b).Kind/8] &(1<<((*b).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3076));
						if ((NU)(i_223316) >= (NU)((*b).kindU.S6.Sons->Sup.len)) raiseIndexError();
						LOC29 = treesequivalent_223166((*a).kindU.S6.Sons->data[i_223316], (*b).kindU.S6.Sons->data[i_223316]);
						if (!!(LOC29)) goto LA30;
						nimln(51, "treetab.nim");
						goto BeforeRet;
					}
					LA30: ;
					nimln(1277, "system.nim");
					res_223339 = addInt(res_223339, 1);
				} LA26: ;
...
static N_INLINE(NI, nexttry_180196)(NI h, NI maxhash) {
	...
	nimln(449, "astalgo.nim");
	TMP3079 = mulInt(5, h);
	TMP3080 = addInt((NI64)(TMP3079), 1);
	result = (NI)((NI64)(TMP3080) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(NI, nodetablerawget_223344)(tnodetable173705 t, NI k, tnode173647* key) {
	...
	while (1) {
		...
		nimln(58, "treetab.nim");
		{
			...
			nimln(58, "treetab.nim");
			if ((NU)(h) >= (NU)(t.Data->Sup.len)) raiseIndexError();
			LOC4 = treesequivalent_223166(t.Data->data[h].Key, key);
			LA5: ;
			if (!LOC4) goto LA6;
...
N_NIMCALL(NI, nodetableget_223366)(tnodetable173705 t, tnode173647* key) {
	...
	index = nodetablerawget_223344(t, LOC1, key);
...
N_NIMCALL(void, nodetableput_223605)(tnodetable173705* t, tnode173647* key, NI val) {
	...
	index = nodetablerawget_223344((*t), k, key);
	...
	LA3: ;
	{
		nimln(85, "treetab.nim");
		{
			...
			n = (tnodepairseq173703*) newSeq((&NTI173703), (NI64)(TMP3083));
			i_223837 = 0;
			HEX3Atmp_223874 = 0;
			...
			while (1) {
				...
				nimln(88, "treetab.nim");
				{
					...
					if ((NU)(i_223837) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
					if ((NU)(i_223837) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
					nodetablerawinsert_223378(&n, (*t).Data->data[i_223837].H, (*t).Data->data[i_223837].Key, (*t).Data->data[i_223837].Val);
				}
				LA18: ;
				nimln(1277, "system.nim");
		...
		nodetablerawinsert_223378(&(*t).Data, k, key, val);
...
N_NIMCALL(NI, nodetabletestorset_223881)(tnodetable173705* t, tnode173647* key, NI val) {
	...
	LA3: ;
	{
		nimln(102, "treetab.nim");
		{
			...
			n = (tnodepairseq173703*) newSeq((&NTI173703), (NI64)(TMP3084));
			i_224037 = 0;
			HEX3Atmp_224074 = 0;
			...
			while (1) {
				...
				nimln(105, "treetab.nim");
				{
					...
					if ((NU)(i_224037) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
					if ((NU)(i_224037) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
					nodetablerawinsert_223378(&n, (*t).Data->data[i_224037].H, (*t).Data->data[i_224037].Key, (*t).Data->data[i_224037].Val);
				}
				LA18: ;
				nimln(1277, "system.nim");
