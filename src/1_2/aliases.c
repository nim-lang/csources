...
N_NIMCALL(NU8, ispartofaux_304018)(tnode173647* n, ttype173681* b, tintset170041* marker) {
	...
	case ((NU8) 132):
	{
		...
		while (1) {
			...
			default:
			{
				...
				internalerror_132699(((NimStringDesc*) &TMP4751));
			}
			break;
			}
			nimln(1277, "system.nim");
	...
	default:
	{
		...
		internalerror_132687((*n).Info, ((NimStringDesc*) &TMP4754));
	}
	break;
	}
	BeforeRet: ;
