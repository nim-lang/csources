...
N_NIMCALL(void, enlarge_107881)(tstringtable107609* t) {
	...
	n = (tkeyvaluepairseq107607*) newSeq((&NTI107607), (NI64)(TMP293));
	i_107913 = 0;
	HEX3Atmp_107925 = 0;
...
N_NIMCALL(tstringtable107609*, nstnewStringTableWithPairs)(NimStringDesc** keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	...
	while (1) {
		...
		nimln(176, "strtabs.nim");
		TMP306 = addInt(i, 1);
		if ((NU)((NI64)(TMP306)) >= (NU)(keyvaluepairsLen0)) raiseIndexError();
		nstPut(result, keyvaluepairs[i], keyvaluepairs[(NI64)(TMP306)]);
...
N_NIMCALL(NimStringDesc*, nstFormat)(NimStringDesc* f, tstringtable107609* t, NU8 flags) {
	...
	while (1) {
		...
		nimln(197, "strtabs.nim");
		{
			...
			nimln(198, "strtabs.nim");
			TMP307 = addInt(i, 1);
			if ((NU)((NI64)(TMP307)) > (NU)(f->Sup.len)) raiseIndexError();
			switch (((NU8)(f->data[(NI64)(TMP307)]))) {
			case 36:
			{
			...
			case 123:
			{
				...
				TMP310 = subInt(j, 1);
				LOC11 = 0;
				LOC11 = copyStrLast(f, (NI64)(TMP309), (NI64)(TMP310));
				LOC12 = 0;
...
appendString(result, LOC12);
			...
			case 95:
			{
				...
				TMP314 = subInt(j, 1);
				LOC17 = 0;
				LOC17 = copyStrLast(f, (NI64)(TMP313), (NI64)(TMP314));
				LOC18 = 0;
