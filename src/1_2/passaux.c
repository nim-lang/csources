...
N_NIMCALL(tpasscontext222003*, verboseopen_417005)(tsym173677* s) {
	...
	nimln(18, "passaux.nim");
	{
		...
		nimln(18, "passaux.nim");
		rawmessage_132518(((NU16) 252), (*(*s).Name).S);
	}
	LA3: ;
	popFrame();
	return result;
...
N_NIMCALL(tnode173647*, verboseprocess_417013)(tpasscontext222003* context, tnode173647* n) {
	...
	nimln(22, "passaux.nim");
	{
		...
		nimln(22, "passaux.nim");
		internalerror_132699(((NimStringDesc*) &TMP6759));
	}
	LA3: ;
	nimln(23, "passaux.nim");
	{
		...
		gnotes_131867 |=((NI64)(1)<<(((((NU16) 252)- 220))%(sizeof(NI64)*8)));
		nimln(27, "passaux.nim");
		nimln(27, "passaux.nim");
		LOC9 = 0;
		LOC9 = nimIntToStr(gbackendid_172006);
		message_132680((*n).Info, ((NU16) 252), LOC9);
	}
	LA7: ;
	popFrame();
	return result;
