...
N_NIMCALL(NF64, tentothepowerof_77356)(NI b_77358);
static N_INLINE(void, HEX2AHEX3D_77366)(NF64* x, NF64 y);
static N_INLINE(void, HEX2AHEX3D_77377)(NF* x, NF y);
...
N_NIMCALL(NI, rawparseint_77196)(NimStringDesc* s, NI64* b, NI start) {
	...
	nimln(200, "parseutils.nim");
	{
		...
		while (1) {
			...
			TMP920 = subInt64((NI64)(TMP918), ((NI64) ((NI64)(TMP919))));
			(*b) = (NI64)(TMP920);
...
N_NIMCALL(NF64, tentothepowerof_77356)(NI b_77358) {
	...
	while (1) {
		nimln(239, "parseutils.nim");
		{
			...
			HEX2AHEX3D_77366(&result, ((NF64) (a)));
		}
		LA4: ;
...
N_NIMCALL(NI, npuParseBiggestFloat)(NimStringDesc* s, NF64* number, NI start) {
	...
	nimln(261, "parseutils.nim");
	{
		...
		nimln(262, "parseutils.nim");
		{
			...
			nimln(262, "parseutils.nim");
			TMP1751 = addInt(i, 1);
			if ((NU)((NI64)(TMP1751)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC16 = ((NU8)(s->data[(NI64)(TMP1751)]) == (NU8)(65));
			if (LOC16) goto LA17;
			nimln(262, "parseutils.nim");
			nimln(262, "parseutils.nim");
			TMP1752 = addInt(i, 1);
			if ((NU)((NI64)(TMP1752)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC16 = ((NU8)(s->data[(NI64)(TMP1752)]) == (NU8)(97));
			LA17: ;
			if (!LOC16) goto LA18;
			nimln(263, "parseutils.nim");
			{
				...
				nimln(263, "parseutils.nim");
				TMP1753 = addInt(i, 2);
				if ((NU)((NI64)(TMP1753)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC22 = ((NU8)(s->data[(NI64)(TMP1753)]) == (NU8)(78));
				if (LOC22) goto LA23;
				nimln(263, "parseutils.nim");
				nimln(263, "parseutils.nim");
				TMP1754 = addInt(i, 2);
				if ((NU)((NI64)(TMP1754)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC22 = ((NU8)(s->data[(NI64)(TMP1754)]) == (NU8)(110));
				LA23: ;
				if (!LOC22) goto LA24;
				nimln(264, "parseutils.nim");
				{
					...
					nimln(264, "parseutils.nim");
					TMP1755 = addInt(i, 3);
					if ((NU)((NI64)(TMP1755)) > (NU)(s->Sup.len)) raiseIndexError();
					if (!!((((NU8)(s->data[(NI64)(TMP1755)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI64)(TMP1755)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI64)(TMP1755)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI64)(TMP1755)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI64)(TMP1755)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI64)(TMP1755)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI64)(TMP1755)])) == ((NU8)(95))))) goto LA28;
					...
					nimln(266, "parseutils.nim");
					TMP1756 = addInt(i, 3);
					TMP1757 = subInt((NI64)(TMP1756), start);
					result = (NI64)(TMP1757);
					goto BeforeRet;
				}
				LA28: ;
	...
	nimln(268, "parseutils.nim");
	{
		...
		nimln(269, "parseutils.nim");
		{
			...
			nimln(269, "parseutils.nim");
			TMP1758 = addInt(i, 1);
			if ((NU)((NI64)(TMP1758)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC38 = ((NU8)(s->data[(NI64)(TMP1758)]) == (NU8)(78));
			if (LOC38) goto LA39;
			nimln(269, "parseutils.nim");
			nimln(269, "parseutils.nim");
			TMP1759 = addInt(i, 1);
			if ((NU)((NI64)(TMP1759)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC38 = ((NU8)(s->data[(NI64)(TMP1759)]) == (NU8)(110));
			LA39: ;
			if (!LOC38) goto LA40;
			nimln(270, "parseutils.nim");
			{
				...
				nimln(270, "parseutils.nim");
				TMP1760 = addInt(i, 2);
				if ((NU)((NI64)(TMP1760)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC44 = ((NU8)(s->data[(NI64)(TMP1760)]) == (NU8)(70));
				if (LOC44) goto LA45;
				nimln(270, "parseutils.nim");
				nimln(270, "parseutils.nim");
				TMP1761 = addInt(i, 2);
				if ((NU)((NI64)(TMP1761)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC44 = ((NU8)(s->data[(NI64)(TMP1761)]) == (NU8)(102));
				LA45: ;
				if (!LOC44) goto LA46;
				nimln(271, "parseutils.nim");
				{
					...
					nimln(271, "parseutils.nim");
					TMP1762 = addInt(i, 3);
					if ((NU)((NI64)(TMP1762)) > (NU)(s->Sup.len)) raiseIndexError();
					if (!!((((NU8)(s->data[(NI64)(TMP1762)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI64)(TMP1762)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI64)(TMP1762)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI64)(TMP1762)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI64)(TMP1762)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI64)(TMP1762)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI64)(TMP1762)])) == ((NU8)(95))))) goto LA50;
					...
					nimln(273, "parseutils.nim");
					TMP1763 = addInt(i, 3);
					TMP1764 = subInt((NI64)(TMP1763), start);
					result = (NI64)(TMP1764);
					goto BeforeRet;
				}
				LA50: ;
	...
	while (1) {
		...
		(*number) = ((NF64) (((((NF) ((*number))) * 1.0000000000000000e+01) + ((double) (((NI) ((NI64)(TMP1765))))))));
	...
	nimln(282, "parseutils.nim");
	{
		...
		while (1) {
			...
			(*number) = ((NF64) (((((NF) ((*number))) * 1.0000000000000000e+01) + ((double) (((NI) ((NI64)(TMP1766))))))));
	...
	nimln(296, "parseutils.nim");
	{
		...
		while (1) {
			...
			nimln(306, "parseutils.nim");
			if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
			TMP1768 = addInt((NI64)(TMP1767), ((NI) (((NU8)(s->data[i])))));
			TMP1769 = subInt((NI64)(TMP1768), 48);
			exponent = (NI64)(TMP1769);
	...
	hd = tentothepowerof_77356(exponent);
