...
N_NIMCALL(ttype173681*, getuniquetype_340401)(ttype173681* key) {
	...
	case ((NU8) 51):
	{
		...
		internalerror_132702(((NimStringDesc*) &TMP5243));
	}
	break;
	case ((NU8) 12):
	{
		nimln(92, "ccgutils.nim");
		internalerror_132702(((NimStringDesc*) &TMP5244));
	}
	break;
	case ((NU8) 11):
	case ((NU8) 13):
