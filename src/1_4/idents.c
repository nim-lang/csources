...
N_NIMCALL(NI, cmpignorestyle_134032)(NCSTRING a, NCSTRING b, NI blen) {
	...
	while (1) {
		...
		nimln(40, "idents.nim");
		{
			...
			aa = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP860), 0, 255))));
		}
		LA8: ;
		nimln(41, "idents.nim");
		{
			...
			bb = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP861), 0, 255))));
		}
		LA14: ;
		nimln(42, "idents.nim");
		nimln(42, "idents.nim");
...
N_NIMCALL(tident134015*, getident_134208)(NCSTRING identifier, NI length, NI h) {
	...
	nimln(89, "idents.nim");
	{
		...
		nimln(91, "idents.nim");
		nimln(91, "idents.nim");
		if (wordcounter_134206 == (-2147483647 -1)) raiseOverflow();
		(*result).Sup.Id = ((NI32)-(wordcounter_134206));
	}
	goto LA22;
	LA24: ;
	{
