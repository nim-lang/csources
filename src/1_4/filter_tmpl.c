...
N_NIMCALL(void, parseline_197151)(ttmplparser197015* p) {
	...
	LA6: ;
	{
		...
		case ((NU8) 20):
		{
			...
			LA19: ;
			{
				...
				localerror_132676((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP2527));
			}
			LA17: ;
		...
		case ((NU8) 24):
		{
			...
			LOC27 = 0;
			LOC27 = nsuRepeatChar((NI32)(TMP2529), 32);
	...
	LA9: ;
	{
		...
		case ((NU8) 1):
		{
			...
			LOC42 = 0;
			LOC42 = nsuRepeatChar((NI32)(TMP2531), 32);
				...
				nimln(150, "filter_tmpl.nim");
				{
					...
					case 123:
					{
						...
						while (1) {
							...
							case 0:
							{
								...
								localerror_132676((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP2538));
					...
					default:
					{
						...
						LA76: ;
						{
							...
							localerror_132676((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP2539));
						}
						LA74: ;
					}
					break;
...
N_NIMCALL(tllstream163204*, filtertmpl_197005)(tllstream163204* stdin_197007, NimStringDesc* filename, tnode173647* call) {
	...
	p.Info = newlineinfo_131777(filename, 0, 0);
