...
static N_INLINE(NI, nexttry_103807)(NI h, NI maxhash) {
	...
	nimln(89, "strtabs.nim");
	TMP275 = mulInt(5, h);
	TMP276 = addInt((NI32)(TMP275), 1);
	result = (NI)((NI32)(TMP276) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, enlarge_103881)(tstringtable103609* t) {
	...
	n = (tkeyvaluepairseq103607*) newSeq((&NTI103607), (NI32)(TMP280));
	i_103913 = 0;
	HEX3Atmp_103925 = 0;
...
N_NIMCALL(tstringtable103609*, nstnewStringTableWithPairs)(NimStringDesc** keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	...
	while (1) {
		...
		nimln(176, "strtabs.nim");
		TMP292 = addInt(i, 1);
		if ((NU)((NI32)(TMP292)) >= (NU)(keyvaluepairsLen0)) raiseIndexError();
		nstPut(result, keyvaluepairs[i], keyvaluepairs[(NI32)(TMP292)]);
...
N_NIMCALL(NimStringDesc*, nstFormat)(NimStringDesc* f, tstringtable103609* t, NU8 flags) {
	...
	while (1) {
		...
		nimln(197, "strtabs.nim");
		{
			...
			nimln(198, "strtabs.nim");
			TMP293 = addInt(i, 1);
			if ((NU)((NI32)(TMP293)) > (NU)(f->Sup.len)) raiseIndexError();
			switch (((NU8)(f->data[(NI32)(TMP293)]))) {
			case 36:
			{
			...
			case 123:
			{
				...
				TMP296 = subInt(j, 1);
				LOC11 = 0;
				LOC11 = copyStrLast(f, (NI32)(TMP295), (NI32)(TMP296));
				LOC12 = 0;
...
appendString(result, LOC12);
			...
			case 95:
			{
				...
				TMP300 = subInt(j, 1);
				LOC17 = 0;
				LOC17 = copyStrLast(f, (NI32)(TMP299), (NI32)(TMP300));
				LOC18 = 0;
