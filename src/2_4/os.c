	...
	while (1) {
		...
		nimln(1199, "os.nim");
		{
			...
			LA8: ;
			{
				...
				LOC11 = 0;
				LOC11 = copyStrLast(dir, 0, (NI32)(TMP328));
...
N_NIMCALL(NimStringDesc*, nosextractFilename)(NimStringDesc* path) {
	...
	nimln(654, "os.nim");
	{
		...
		if ((NU)((NI32)(TMP781)) > (NU)(path->Sup.len)) raiseIndexError();
		LOC3 = (((NU8)(path->data[(NI32)(TMP781)])) == ((NU8)(47)) || ((NU8)(path->data[(NI32)(TMP781)])) == ((NU8)(47)));
		LA4: ;
		if (!LOC3) goto LA5;
		nimln(655, "os.nim");
		result = copyString(((NimStringDesc*) &TMP286));
...
N_NIMCALL(void, nossleep)(NI milsecs) {
	...
	a.tv_sec = (NI32)(TMP906);
	nimln(1576, "os.nim");
	nimln(1576, "os.nim");
	nimln(1576, "os.nim");
	nimln(1576, "os.nim");
	TMP907 = modInt(milsecs, 1000);
	TMP908 = mulInt(((NI) ((NI32)(TMP907))), 1000);
	TMP909 = mulInt(((NI) ((NI32)(TMP908))), 1000);
	a.tv_nsec = ((NI) ((NI32)(TMP909)));
	nimln(1577, "os.nim");
	nimln(1577, "os.nim");
	LOC1 = nanosleep(&a, &b);
	popFrame();
...
N_NIMCALL(NimStringDesc*, nosparentDir)(NimStringDesc* path) {
	...
	nimln(558, "os.nim");
	{
		...
		if ((NU)((NI32)(TMP1842)) > (NU)(path->Sup.len)) raiseIndexError();
		if (!(((NU8)(path->data[(NI32)(TMP1842)])) == ((NU8)(47)) || ((NU8)(path->data[(NI32)(TMP1842)])) == ((NU8)(47)))) goto LA3;
		nimln(559, "os.nim");
		q = 2;
	}
	LA3: ;
	...
	nimln(564, "os.nim");
	{
		...
		result = copyStrLast(path, 0, (NI32)(TMP1844));
	}
	goto LA10;
	LA12: ;
	{
