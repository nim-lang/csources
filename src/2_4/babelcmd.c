...
STRING_LITERAL(TMP1345, "head", 4);
STRING_LITERAL(TMP1348, ".", 1);
STRING_LITERAL(TMP1349, "..", 2);
STRING_LITERAL(TMP1353, ".nim", 4);
...
N_NIMCALL(NIM_BOOL, HEX3CHEX2E_141045)(NimStringDesc* a, NimStringDesc* b) {
	...
	{
		nimln(28, "babelcmd.nim");
		if (!eqStrings(a, ((NimStringDesc*) &TMP1345))) goto LA3;
		nimln(28, "babelcmd.nim");
		nimln(28, "babelcmd.nim");
		result = NIM_FALSE;
		goto BeforeRet;
...
N_NIMCALL(void, addpackage_141115)(tstringtable103609* packages, NimStringDesc* p) {
	...
	nimln(48, "babelcmd.nim");
	TMP1346 = subInt(x, 1);
	name = copyStrLast(p, 0, (NI32)(TMP1346));
	nimln(49, "babelcmd.nim");
	{
		...
		nimln(50, "babelcmd.nim");
		TMP1347 = addInt(x, 1);
		version = copyStr(p, (NI32)(TMP1347));
	...
	LA3: ;
	{
		...
		nstPut(packages, name, ((NimStringDesc*) &TMP1345));
	}
	LA1: ;
	popFrame();
}
	...
	nimln(1112, "os.nim");
	{
		...
		while (1) {
			...
			nimln(1117, "os.nim");
			{
				...
				nimln(684, "system.nim");
				nimln(684, "system.nim");
				LOC12 = !(eqStrings(y_141169, ((NimStringDesc*) &TMP1348)));
				if (!(LOC12)) goto LA13;
				nimln(684, "system.nim");
				nimln(684, "system.nim");
				...
				nimln(69, "babelcmd.nim");
				{
					...
					if (!(LOC33)) goto LA34;
					nimln(69, "babelcmd.nim");
					LOC33 = nsuEndsWith(path_141157, ((NimStringDesc*) &TMP1353));
					LA34: ;
					if (!LOC33) goto LA35;
		...
		nimln(1112, "os.nim");
		{
			...
			while (1) {
				...
				nimln(1117, "os.nim");
				{
					...
					nimln(684, "system.nim");
					nimln(684, "system.nim");
					LOC18 = !(eqStrings(y_141183, ((NimStringDesc*) &TMP1348)));
					if (!(LOC18)) goto LA19;
					nimln(684, "system.nim");
					nimln(684, "system.nim");
...
N_NIMCALL(void, addpathrec_141191)(NimStringDesc* dir, tlineinfo128308 info) {
	...
	nimln(1112, "os.nim");
	{
		...
		while (1) {
			...
			nimln(1117, "os.nim");
			{
				...
				nimln(684, "system.nim");
				nimln(684, "system.nim");
				LOC16 = !(eqStrings(y_141233, ((NimStringDesc*) &TMP1348)));
				if (!(LOC16)) goto LA17;
				nimln(684, "system.nim");
				nimln(684, "system.nim");
	...
	while (1) {
		...
		nimln(41, "strtabs.nim");
		{
			...
			{
				nimln(58, "babelcmd.nim");
				if (!eqStrings(val_141241, ((NimStringDesc*) &TMP1345))) goto LA49;
