...
STRING_LITERAL(TMP857, "true", 4);
STRING_LITERAL(TMP858, "false", 5);
STRING_LITERAL(TMP859, "nimrod", 6);
STRING_LITERAL(TMP860, "nimhygiene", 10);
STRING_LITERAL(TMP861, "niminheritable", 14);
STRING_LITERAL(TMP862, "nimmixin", 8);
STRING_LITERAL(TMP863, "nimeffects", 10);
STRING_LITERAL(TMP864, "nimbabel", 8);
STRING_LITERAL(TMP865, "nimsuperops", 11);
STRING_LITERAL(TMP866, "x86", 3);
STRING_LITERAL(TMP867, "itanium", 7);
STRING_LITERAL(TMP868, "x8664", 5);
STRING_LITERAL(TMP869, "msdos", 5);
STRING_LITERAL(TMP870, "mswindows", 9);
STRING_LITERAL(TMP871, "win32", 5);
STRING_LITERAL(TMP872, "unix", 4);
STRING_LITERAL(TMP873, "posix", 5);
STRING_LITERAL(TMP874, "sunos", 5);
STRING_LITERAL(TMP875, "bsd", 3);
STRING_LITERAL(TMP876, "macintosh", 9);
STRING_LITERAL(TMP877, "cpu", 3);
extern NIM_CONST TY123460 cpu_123459;
extern NIM_CONST TY123455 endiantostr_123454;
extern NIM_CONST TY123060 os_123059;
STRING_LITERAL(TMP880, "emulatedthreadvars", 18);
...
N_NIMCALL(void, definesymbol_132006)(NimStringDesc* symbol) {
	...
	nstPut(gsymbols_132003, symbol, ((NimStringDesc*) &TMP857));
	popFrame();
}
...
N_NIMCALL(NIM_BOOL, isdefined_132016)(NimStringDesc* symbol) {
	...
	nimln(26, "condsyms.nim");
	{
		...
		result = eqStrings(LOC6, ((NimStringDesc*) &TMP857));
	}
	LA4: ;
	popFrame();
	return result;
...
N_NIMCALL(NI, countdefinedsymbols_132041)(void) {
	...
	while (1) {
		...
		nimln(41, "strtabs.nim");
		{
			...
			{
				nimln(38, "condsyms.nim");
				if (!eqStrings(val_132045, ((NimStringDesc*) &TMP857))) goto LA8;
				nimln(38, "condsyms.nim");
...
N_NIMCALL(void, initdefines_132067)(void) {
	...
	definesymbol_132006(((NimStringDesc*) &TMP859));
...
appendString(LOC13, ((NimStringDesc*) &TMP877));
