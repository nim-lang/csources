...
STRING_LITERAL(TMP304, "", 0);
STRING_LITERAL(TMP321, "nimcache", 8);
STRING_LITERAL(TMP325, "cannot create directory: ", 25);
STRING_LITERAL(TMP327, "nim", 3);
STRING_LITERAL(TMP333, "not \'\\0\' == sep ", 16);
STRING_LITERAL(TMP335, "lib", 3);
static NIM_CONST TY104134 TMP337 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x43, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP339, "true", 4);
...
N_NIMCALL(NimStringDesc*, removetrailingdirsep_105410)(NimStringDesc* path) {
	...
	nimln(200, "options.nim");
	{
		...
		if ((NU)((NI32)(TMP318)) > (NU)(path->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(path->data[(NI32)(TMP318)]) == (NU8)(47));
		LA4: ;
		if (!LOC3) goto LA5;
		...
		nimln(201, "options.nim");
		nimln(201, "options.nim");
		TMP319 = subInt(path->Sup.len, 2);
		result = copyStrLast(path, 0, (NI32)(TMP319));
	}
	goto LA1;
	LA5: ;
	{
...
N_NIMCALL(NimStringDesc*, getgeneratedpath_105418)(void) {
	...
	LA3: ;
	{
		...
		result = HEX2F_94062(LOC6, ((NimStringDesc*) &TMP321));
	}
	LA1: ;
	popFrame();
	return result;
...
N_NIMCALL(NimStringDesc*, completegeneratedfilepath_105438)(NimStringDesc* f, NIM_BOOL createsubdir) {
	...
	nimln(220, "options.nim");
	{
		...
		pushSafePoint(&TMP322);
		TMP322.status = setjmp(TMP322.context);
		if (TMP322.status == 0) {
...
appendString(LOC10, ((NimStringDesc*) &TMP325));
appendString(LOC10, subdir);
		...
		if (TMP322.status != 0) reraiseException();
	}
	LA4: ;
...
N_NIMCALL(NimStringDesc*, rawfindfile_105498)(NimStringDesc* f) {
	...
	result = copyString(((NimStringDesc*) &TMP304));
	BeforeRet: ;
	popFrame();
	return result;
}
...
static N_INLINE(NimStringDesc*, findmodule_105538)(NimStringDesc* modulename) {
	...
	nimln(263, "options.nim");
	LOC1 = 0;
	LOC1 = nosaddFileExt(modulename, ((NimStringDesc*) &TMP327));
...
N_NIMCALL(void, libcandidates_105544)(NimStringDesc* s, TY9355** dest) {
	...
	nimln(267, "options.nim");
	TMP328 = addInt(le, 1);
	ri = nsuFindChar(s, 41, (NI32)(TMP328));
	nimln(268, "options.nim");
	{
		...
		nimln(269, "options.nim");
		TMP329 = subInt(le, 1);
		prefix = copyStrLast(s, 0, (NI32)(TMP329));
		nimln(270, "options.nim");
		nimln(270, "options.nim");
		nimln(270, "options.nim");
		TMP330 = addInt(ri, 1);
		suffix = copyStr(s, (NI32)(TMP330));
		middle_105556 = 0;
		HEX3Atmp_105573 = 0;
		...
		nimln(271, "options.nim");
		TMP332 = subInt(ri, 1);
		HEX3Atmp_105573 = copyStrLast(s, (NI32)(TMP331), (NI32)(TMP332));
		...
		nimln(248, "strutils.nim");
		{
			...
			nimln(248, "strutils.nim");
			hiddenraiseassert_71620(((NimStringDesc*) &TMP333));
		}
		LA9: ;
		nimln(249, "strutils.nim");
		{
			...
			while (1) {
				...
				nimln(254, "strutils.nim");
				nimln(254, "strutils.nim");
				TMP334 = subInt(last_105575, 1);
				middle_105556 = copyStrLast(HEX3Atmp_105573, first_105577, (NI32)(TMP334));
...
N_NIMCALL(NimStringDesc*, canondynlibname_105582)(NimStringDesc* s) {
	...
	ende = nsuFindCharSet(s, TMP337, 0);
	nimln(279, "options.nim");
	{
		...
		nimln(280, "options.nim");
		nimln(280, "options.nim");
		TMP338 = subInt(ende, 1);
		result = copyStrLast(s, start, (NI32)(TMP338));
	}
	goto LA7;
	LA9: ;
	{
...
N_NIMCALL(void, incldynliboverride_105591)(NimStringDesc* lib) {
	...
	nstPut(gdlloverrides_105189, LOC1, ((NimStringDesc*) &TMP339));
	popFrame();
}
...
N_NOINLINE(void, optionsInit)(void) {
	...
	LOC1 = 0;
	LOC1 = outfile_105114; outfile_105114 = copyStringRC1(((NimStringDesc*) &TMP304));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(102, "options.nim");
	LOC2 = 0;
	LOC2 = headerfile_105115; headerfile_105115 = copyStringRC1(((NimStringDesc*) &TMP304));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(103, "options.nim");
	gverbosity_105116 = 1;
	nimln(106, "options.nim");
	LOC3 = 0;
	LOC3 = gevalexpr_105119; gevalexpr_105119 = copyStringRC1(((NimStringDesc*) &TMP304));
	...
	LOC4 = 0;
	LOC4 = libpath_105190; libpath_105190 = copyStringRC1(((NimStringDesc*) &TMP304));
	if (LOC4) nimGCunrefNoCycle(LOC4);
	nimln(145, "options.nim");
	LOC5 = 0;
	LOC5 = gprojectname_105191; gprojectname_105191 = copyStringRC1(((NimStringDesc*) &TMP304));
	if (LOC5) nimGCunrefNoCycle(LOC5);
	nimln(146, "options.nim");
	LOC6 = 0;
	LOC6 = gprojectpath_105192; gprojectpath_105192 = copyStringRC1(((NimStringDesc*) &TMP304));
	if (LOC6) nimGCunrefNoCycle(LOC6);
	nimln(147, "options.nim");
	LOC7 = 0;
	LOC7 = gprojectfull_105193; gprojectfull_105193 = copyStringRC1(((NimStringDesc*) &TMP304));
	if (LOC7) nimGCunrefNoCycle(LOC7);
	nimln(149, "options.nim");
	LOC8 = 0;
	LOC8 = optmainmodule_105195; optmainmodule_105195 = copyStringRC1(((NimStringDesc*) &TMP304));
	if (LOC8) nimGCunrefNoCycle(LOC8);
	nimln(150, "options.nim");
	LOC9 = 0;
	LOC9 = nimcachedir_105196; nimcachedir_105196 = copyStringRC1(((NimStringDesc*) &TMP304));
	if (LOC9) nimGCunrefNoCycle(LOC9);
	nimln(151, "options.nim");
	LOC10 = 0;
	LOC10 = command_105197; command_105197 = copyStringRC1(((NimStringDesc*) &TMP304));
...
static TNimNode* TMP1925[22];
NI TMP1927;
static char* NIM_CONST TMP1926[22] = {
"optNone", 
"optObjCheck", 
"optFieldCheck", 
"optRangeCheck", 
...
"optImplicitStatic", 
"optPatterns"};
static TNimNode* TMP2921[20];
NI TMP2923;
static char* NIM_CONST TMP2922[20] = {
"cmdNone", 
"cmdCompileToC", 
"cmdCompileToCpp", 
"cmdCompileToOC", 
...
"cmdInteractive", 
"cmdRun"};
static TNimNode* TMP6988[32];
NI TMP6990;
static char* NIM_CONST TMP6989[32] = {
"gloptNone", 
"optForceFullMake", 
"optDeadCodeElim", 
"optListCmd", 
...
"optGenIndex", 
"optEmbedOrigSrc"};
static TNimNode TMP247[78];
NTI105008.size = sizeof(NU8);
NTI105008.kind = 14;
NTI105008.base = 0;
NTI105008.flags = 3;
for (TMP1927 = 0; TMP1927 < 22; TMP1927++) {
TMP247[TMP1927+0].kind = 1;
TMP247[TMP1927+0].offset = TMP1927;
TMP247[TMP1927+0].name = TMP1926[TMP1927];
TMP1925[TMP1927] = &TMP247[TMP1927+0];
}
TMP247[22].len = 22; TMP247[22].kind = 2; TMP247[22].sons = &TMP1925[0];
NTI105008.node = &TMP247[22];
NTI105103.size = sizeof(NU32);
NTI105103.kind = 19;
NTI105103.base = (&NTI105008);
NTI105103.flags = 3;
TMP247[23].len = 0; TMP247[23].kind = 0;
NTI105103.node = &TMP247[23];
NTI105016.size = sizeof(NU8);
NTI105016.kind = 14;
NTI105016.base = 0;
NTI105016.flags = 3;
for (TMP2923 = 0; TMP2923 < 20; TMP2923++) {
TMP247[TMP2923+24].kind = 1;
TMP247[TMP2923+24].offset = TMP2923;
TMP247[TMP2923+24].name = TMP2922[TMP2923];
TMP2921[TMP2923] = &TMP247[TMP2923+24];
}
TMP247[44].len = 20; TMP247[44].kind = 2; TMP247[44].sons = &TMP2921[0];
NTI105016.node = &TMP247[44];
NTI105012.size = sizeof(NU8);
NTI105012.kind = 14;
NTI105012.base = 0;
NTI105012.flags = 3;
for (TMP6990 = 0; TMP6990 < 32; TMP6990++) {
TMP247[TMP6990+45].kind = 1;
TMP247[TMP6990+45].offset = TMP6990;
TMP247[TMP6990+45].name = TMP6989[TMP6990];
TMP6988[TMP6990] = &TMP247[TMP6990+45];
}
TMP247[77].len = 32; TMP247[77].kind = 2; TMP247[77].sons = &TMP6988[0];
NTI105012.node = &TMP247[77];
}
