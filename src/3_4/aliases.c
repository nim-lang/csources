...
N_NIMCALL(NU8, ispartofaux_299018)(tnode168647* n, ttype168681* b, tintset165041* marker) {
	...
	case ((NU8) 132):
	{
		...
		while (1) {
			...
			default:
			{
				...
				internalerror_128702(((NimStringDesc*) &TMP4751));
			}
			break;
			}
			nimln(1277, "system.nim");
	...
	default:
	{
		...
		internalerror_128690((*n).Info, ((NimStringDesc*) &TMP4754));
	}
	break;
	}
	BeforeRet: ;
