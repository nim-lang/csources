...
N_NIMCALL(NI, fsreaddata_133167)(tstream132630* s, void* buffer, NI buflen);
N_NIMCALL(NI, readbuffer_9317)(FILE* f, void* buffer, NI len);
N_NIMCALL(void, fswritedata_133175)(tstream132630* s, void* buffer, NI buflen);
...
N_NIMCALL(NI, ssreaddata_133044)(tstream132630* s_133046, void* buffer, NI buflen) {
	...
	result = ((buflen <= (NI32)(TMP887)) ? buflen : (NI32)(TMP887));
...
N_NIMCALL(void, sswritedata_133072)(tstream132630* s_133074, void* buffer, NI buflen) {
	...
	nimln(221, "streams.nim");
	{
		...
		(*s).Data = setLengthStr((*s).Data, (NI32)(TMP888));
...
N_NIMCALL(tfilestream133125*, newfilestream_133182)(FILE* f) {
	...
	(*result).Sup.Readdataimpl = fsreaddata_133167;
	nimln(272, "streams.nim");
	(*result).Sup.Writedataimpl = fswritedata_133175;
