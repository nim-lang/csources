...
N_NIMCALL(NimStringDesc*, togid_167450)(NimStringDesc* f);
...
STRING_LITERAL(TMP1879, "nimrod.gid", 10);
STRING_LITERAL(TMP6984, "\012", 1);
NI gfrontendid_167005;
NI gbackendid_167006;
...
static N_INLINE(void, setid_167436)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP1874 = addInt(id, 1);
	gfrontendid_167005 = ((gfrontendid_167005 >= (NI32)(TMP1874)) ? gfrontendid_167005 : (NI32)(TMP1874));
	popFrame();
}
...
N_NIMCALL(void, idsynchronizationpoint_167445)(NI idrange) {
	...
	nimln(41, "idgen.nim");
	nimln(41, "idgen.nim");
	TMP1875 = divInt(gfrontendid_167005, idrange);
	TMP1876 = addInt((NI32)(TMP1875), 1);
	TMP1877 = mulInt((NI32)(TMP1876), idrange);
	TMP1878 = addInt((NI32)(TMP1877), 1);
	gfrontendid_167005 = (NI32)(TMP1878);
	popFrame();
}
...
N_NIMCALL(NimStringDesc*, togid_167450)(NimStringDesc* f) {
	...
	result = 0;
	nimln(47, "idgen.nim");
	result = completegeneratedfilepath_105438(((NimStringDesc*) &TMP1879), NIM_TRUE);
	popFrame();
	return result;
}
...
N_NIMCALL(void, savemaxids_167456)(NimStringDesc* project) {
	...
	nimln(50, "idgen.nim");
	LOC1 = 0;
	LOC1 = togid_167450(project);
	f = open_9032(LOC1, ((NU8) 1), -1);
	nimln(51, "idgen.nim");
	memset((void*)LOC2, 0, sizeof(LOC2));
	nimln(51, "idgen.nim");
	nimln(51, "idgen.nim");
	LOC2[0] = nimIntToStr(gfrontendid_167005);
	writeln_105451(f, LOC2, 1);
	nimln(52, "idgen.nim");
	memset((void*)LOC3, 0, sizeof(LOC3));
	nimln(52, "idgen.nim");
	nimln(52, "idgen.nim");
	LOC3[0] = nimIntToStr(gbackendid_167006);
	...
	nimln(57, "idgen.nim");
	{
		...
		nimln(59, "idgen.nim");
		{
			...
			nimln(61, "idgen.nim");
			{
				...
				nimln(63, "idgen.nim");
				nimln(63, "idgen.nim");
				gfrontendid_167005 = ((gfrontendid_167005 >= frontendid) ? gfrontendid_167005 : frontendid);
				nimln(64, "idgen.nim");
				nimln(64, "idgen.nim");
				gbackendid_167006 = ((gbackendid_167006 >= backendid) ? gbackendid_167006 : backendid);
			}
			LA15: ;
		}
		LA10: ;
