...
N_NIMCALL(void, patternerror_268036)(tnode168647* n) {
	...
	localerror_128676((*n).Info, ((NU16) 1), LOC1);
	popFrame();
}
...
break;
		...
		LA51: ;
		{
			...
			nimln(793, "msgs.nim");
			{
				...
				nimln(793, "msgs.nim");
				LOC69 = 0;
				LOC69 = HEX24_128780(TMP3754);
				internalerror_128702(LOC69);
			}
			LA67: ;
			i_268283 = 0;
			...
			nimln(793, "msgs.nim");
			{
				...
				nimln(793, "msgs.nim");
				LOC81 = 0;
				LOC81 = HEX24_128780(TMP3756);
				internalerror_128702(LOC81);
			}
			LA79: ;
			i_268337 = 0;
			nimln(1281, "system.nim");
...
N_NIMCALL(tnode168647*, semnodekindconstraints_268363)(tnode168647* p) {
	...
	nimln(124, "parampatterns.nim");
	{
		...
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_128690((*p).Info, ((NimStringDesc*) &TMP3758));
		}
		LA14: ;
	}
	goto LA5;
...
N_NIMCALL(NU8, checkforsideeffects_268500)(tnode168647* n) {
	...
	case ((NU8) 32):
	{
		...
		nimln(143, "parampatterns.nim");
		{
			...
			LOC4 = isroutine_173367((*op).kindU.S4.Sym);
			LA5: ;
			if (!LOC4) goto LA6;
...
N_NIMCALL(NIM_BOOL, matchnodekinds_268914)(tnode168647* p, tnode168647* n) {
	...
	while (1) {
		...
		case ((NU8) 2):
		{
			...
			nimln(239, "parampatterns.nim");
			TMP3761 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3761)) > (NU)(64)) raiseIndexError();
			nimln(239, "parampatterns.nim");
			nimln(239, "parampatterns.nim");
			TMP3762 = subInt(sp, 1);
			if ((NU)((NI32)(TMP3762)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI32)(TMP3762))- 0];
			if (LOC4) goto LA5;
			nimln(239, "parampatterns.nim");
			TMP3763 = subInt(sp, 2);
		...
		case ((NU8) 4):
		{
			...
			stack[((NI32)(TMP3767))- 0] = !(stack[((NI32)(TMP3768))- 0]);
		}
		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(251, "parampatterns.nim");
			TMP3769 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3769)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3769)])), ((NU8) 0), ((NU8) 22)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3770)])), ((NU8) 0), ((NU8) 151)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
