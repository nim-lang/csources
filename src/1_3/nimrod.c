...
N_NIMCALL(NimStringDesc*, prependcurdir_427401)(NimStringDesc* f);
N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src);
static N_INLINE(void, nimFrame)(TFrame* s);
static N_INLINE(void, popFrame)(void);
N_NIMCALL(void, handlecmdline_427603)(void);
...
STRING_LITERAL(TMP6961, "", 0);
STRING_LITERAL(TMP6963, "nimrod.cfg", 10);
STRING_LITERAL(TMP6964, "js", 2);
STRING_LITERAL(TMP6965, "node ", 5);
STRING_LITERAL(TMP6966, "exe", 3);
...
extern NimStringDesc* arguments_422005;
...
N_NIMCALL(void, handlecmdline_427603)(void) {
	...
	nimln(35, "nimrod.nim");
	{
		...
		if (!(LOC3 == 0)) goto LA4;
		nimln(36, "nimrod.nim");
		writecommandlineusage_146002();
	}
	goto LA1;
	LA4: ;
	{
		nimln(39, "nimrod.nim");
		processcmdline_422007(((NU8) 0), ((NimStringDesc*) &TMP6961));
		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP6962;
			TY95837 p;
			...
			nimln(684, "system.nim");
			nimln(684, "system.nim");
			if (!!(((gprojectname_109191) && (gprojectname_109191)->Sup.len == 0))) goto LA9;
			nimln(41, "nimrod.nim");
			pushSafePoint(&TMP6962);
			TMP6962.status = setjmp(TMP6962.context);
			if (TMP6962.status == 0) {
				nimln(42, "nimrod.nim");
				asgnRefNoCycle((void**) &gprojectfull_109193, canonicalizepath_109315(gprojectname_109191));
				popSafePoint();
			}
			else {
				popSafePoint();
				...
				if (isObj(getCurrentException()->Sup.m_type, (&NTI1035))) {
					...
					nimln(44, "nimrod.nim");
					LOC14 = 0;
					LOC14 = gprojectfull_109193; gprojectfull_109193 = copyStringRC1(gprojectname_109191);
					if (LOC14) nimGCunrefNoCycle(LOC14);
					popCurrentException();
				}
			}
			if (TMP6962.status != 0) reraiseException();
			nimln(45, "nimrod.nim");
			chckNil((void*)&p);
			memset((void*)&p, 0, sizeof(p));
			nossplitFile(gprojectfull_109193, &p);
			nimln(46, "nimrod.nim");
			LOC15 = 0;
			LOC15 = gprojectpath_109192; gprojectpath_109192 = copyStringRC1(p.Field0);
			if (LOC15) nimGCunrefNoCycle(LOC15);
			nimln(47, "nimrod.nim");
			LOC16 = 0;
			LOC16 = gprojectname_109191; gprojectname_109191 = copyStringRC1(p.Field1);
		...
		{
			nimln(49, "nimrod.nim");
			asgnRefNoCycle((void**) &gprojectpath_109192, nosgetCurrentDir());
		}
		LA7: ;
		nimln(50, "nimrod.nim");
		loadconfigs_169454(((NimStringDesc*) &TMP6963));
		nimln(53, "nimrod.nim");
		initvars_142646();
		nimln(54, "nimrod.nim");
		processcmdline_422007(((NU8) 1), ((NimStringDesc*) &TMP6961));
		nimln(55, "nimrod.nim");
		maincommand_425812();
		nimln(56, "nimrod.nim");
		{
		...
		{
			nimln(58, "nimrod.nim");
			if (!(gerrorcounter_131868 == 0)) goto LA25;
			nimln(62, "nimrod.nim");
			{
				nimln(716, "system.nim");
				if (!((gglobaloptions_109108 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				nimln(63, "nimrod.nim");
				{
					NimStringDesc* ex;
					NimStringDesc* LOC35;
					...
					NimStringDesc* LOC38;
					nimln(63, "nimrod.nim");
					if (!(gcmd_109110 == ((NU8) 4))) goto LA33;
					nimln(64, "nimrod.nim");
					nimln(65, "nimrod.nim");
					nimln(65, "nimrod.nim");
					nimln(65, "nimrod.nim");
					LOC35 = 0;
					LOC35 = nosChangeFileExt(gprojectfull_109193, ((NimStringDesc*) &TMP6964));
					LOC36 = 0;
					LOC36 = prependcurdir_427401(LOC35);
					LOC37 = 0;
					LOC37 = completecfilepath_142675(LOC36, NIM_TRUE);
					ex = quoteifcontainswhite_81720(LOC37);
					nimln(66, "nimrod.nim");
					nimln(66, "nimrod.nim");
					LOC38 = 0;
					LOC38 = rawNewString(ex->Sup.len + arguments_422005->Sup.len + 6);
appendString(LOC38, ((NimStringDesc*) &TMP6965));
appendString(LOC38, ex);
appendChar(LOC38, 32);
appendString(LOC38, arguments_422005);
					execexternalprogram_142707(LOC38);
				}
				goto LA31;
				LA33: ;
				{
					...
					nimln(69, "nimrod.nim");
					LOC40 = 0;
					LOC40 = nosChangeFileExt(gprojectfull_109193, ((NimStringDesc*) &TMP6966));
					LOC41 = 0;
					LOC41 = prependcurdir_427401(LOC40);
					ex = quoteifcontainswhite_81720(LOC41);
					nimln(70, "nimrod.nim");
					nimln(70, "nimrod.nim");
					LOC42 = 0;
					LOC42 = rawNewString(ex->Sup.len + arguments_422005->Sup.len + 1);
appendString(LOC42, ex);
appendChar(LOC42, 32);
appendString(LOC42, arguments_422005);
					execexternalprogram_142707(LOC42);
				}
				LA31: ;
			}
			LA29: ;
...
N_NOINLINE(void, nimrodInit)(void) {
	...
	initdefines_135067();
	nimln(79, "nimrod.nim");
	handlecmdline_427603();
	nimln(80, "nimrod.nim");
	nimln(692, "system.nim");
	exit(((NI) (((NI8) ((0 < gerrorcounter_131868))))));
	popFrame();
}
