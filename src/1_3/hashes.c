	...
	while (1) {
		...
		i_105864 = res_105909;
		{
			...
			nimln(104, "hashes.nim");
			{
				...
				c = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP278), 0, 255))));
			}
			LA9: ;
...
N_NIMCALL(NI, hashignorecase_105915)(NimStringDesc* x) {
	...
	while (1) {
		...
		nimln(114, "hashes.nim");
		{
			...
			c = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP280), 0, 255))));
		}
		LA4: ;
