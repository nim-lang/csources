...
N_NIMCALL(void, fillbuffer_160073)(tbaselexer160018* l) {
	...
	nimln(85, "nimlexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI32)(TMP1568)])), (NI32)(TMP1569));
	}
	LA11: ;
	...
	TMP1571 = mulInt((NI32)(TMP1570), 1);
	LOC13 = llstreamread_159242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI32)(TMP1571));
	TMP1572 = divInt(LOC13, 1);
	charsread = (NI32)(TMP1572);
	...
	nimln(91, "nimlexbase.nim");
	{
		...
		if (!(charsread < (NI32)(TMP1574))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI32)(TMP1576);
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				TMP1577 = mulInt((*l).Buflen, 1);
				LOC32 = realloc_4007(((void*) ((*l).Buf)), (NI32)(TMP1577));
				...
				nimln(110, "nimlexbase.nim");
				{
					...
					if (!!(((NI32)(TMP1578) == oldbuflen))) goto LA35;
					nimln(110, "nimlexbase.nim");
				...
				LOC37 = llstreamread_159242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI32)(TMP1580));
				TMP1581 = divInt(LOC37, 1);
				charsread = (NI32)(TMP1581);
...
N_NIMCALL(void, openbaselexer_160027)(tbaselexer160018* l, tllstream159204* inputstream, NI buflen) {
	...
	LOC5 = alloc_4001((NI32)(TMP1590));
	(*l).Buf = ((NCSTRING) (LOC5));
	nimln(151, "nimlexbase.nim");
	nimln(151, "nimlexbase.nim");
	TMP1591 = subInt(buflen, 1);
	(*l).Sentinel = (NI32)(TMP1591);
...
N_NIMCALL(NI, getcolnumber_160046)(tbaselexer160018* l, NI pos) {
	...
	if ((NI32)(TMP1592) == (-2147483647 -1)) raiseOverflow();
	result = (NI32)abs((NI32)(TMP1592));
	popFrame();
	return result;
}
