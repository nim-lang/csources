...
static NIM_CONST TY169850 TMP3738 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3739, "strVal", 6);
static NIM_CONST TY169850 TMP3740 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3741, "sons", 4);
static NIM_CONST TY169850 TMP3742 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3743, "ident", 5);
STRING_LITERAL(TMP3744, "|", 1);
STRING_LITERAL(TMP3745, "&", 1);
STRING_LITERAL(TMP3746, "~", 1);
STRING_LITERAL(TMP3747, "atom", 4);
STRING_LITERAL(TMP3748, "lit", 3);
STRING_LITERAL(TMP3749, "sym", 3);
STRING_LITERAL(TMP3750, "ident", 5);
STRING_LITERAL(TMP3751, "call", 4);
STRING_LITERAL(TMP3752, "alias", 5);
STRING_LITERAL(TMP3753, "noalias", 7);
STRING_LITERAL(TMP3754, "lvalue", 6);
STRING_LITERAL(TMP3755, "local", 5);
STRING_LITERAL(TMP3756, "sideeffect", 10);
STRING_LITERAL(TMP3757, "nosideeffect", 12);
STRING_LITERAL(TMP3759, "compiler/parampatterns.nim", 26);
NIM_CONST TY71482 TMP3758 = {((NimStringDesc*) &TMP3759),
100}
;
NIM_CONST TY71482 TMP3760 = {((NimStringDesc*) &TMP3759),
107}
;
STRING_LITERAL(TMP3761, "p.Kind == nkCurlyExpr ", 22);
STRING_LITERAL(TMP3762, "parameter pattern too complex", 29);
static NIM_CONST TY169850 TMP3763 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3764, "sym", 3);
...
N_NIMCALL(NU8, whichalias_269055)(tsym169677* p) {
	...
	nimln(51, "parampatterns.nim");
	{
		...
		nimln(52, "parampatterns.nim");
		if (!(((TMP3738[(*(*p).Constraint).Kind/8] &(1<<((*(*p).Constraint).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3739));
...
N_NIMCALL(void, compileconstraints_269088)(tnode169647* p, NimStringDesc** result) {
	...
	case ((NU8) 32):
	{
		...
		nimln(59, "parampatterns.nim");
		{
			nimln(684, "system.nim");
			nimln(684, "system.nim");
			if (((TMP3740[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3741));
		...
		if (((TMP3740[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3741));
		if ((NU)(0) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3742[(*(*p).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*p).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3743));
		...
		nimln(63, "parampatterns.nim");
		{
			...
			nimln(64, "parampatterns.nim");
			{
				...
				nimln(64, "parampatterns.nim");
				nimln(64, "parampatterns.nim");
				LOC13 = eqStrings((*op).S, ((NimStringDesc*) &TMP3744));
				if (LOC13) goto LA14;
				nimln(64, "parampatterns.nim");
				LOC13 = ((*op).Sup.Id == 47);
				LA14: ;
			...
			LA15: ;
			{
				...
				nimln(68, "parampatterns.nim");
				LOC18 = eqStrings((*op).S, ((NimStringDesc*) &TMP3745));
				if (LOC18) goto LA19;
				nimln(68, "parampatterns.nim");
				LOC18 = ((*op).Sup.Id == 2);
				LA19: ;
		...
		LA9: ;
		{
			...
			nimln(74, "parampatterns.nim");
			nimln(74, "parampatterns.nim");
			LOC27 = eqStrings((*op).S, ((NimStringDesc*) &TMP3746));
			if (LOC27) goto LA28;
			nimln(74, "parampatterns.nim");
			LOC27 = ((*op).Sup.Id == 43);
			LA28: ;
	...
	case ((NU8) 2):
	{
		...
		if (!(((TMP3742[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3743));
		spec = nsuNormalize((*(*p).kindU.S5.Ident).S);
		nimln(86, "parampatterns.nim");
		switch (hashString(spec) & 15) {
		case 1: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3757))) goto LA50;
break;
		case 3: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3753))) goto LA46;
if (eqStrings(spec, ((NimStringDesc*) &TMP3754))) goto LA47;
if (eqStrings(spec, ((NimStringDesc*) &TMP3756))) goto LA49;
break;
		case 4: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3749))) goto LA42;
break;
		case 6: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3750))) goto LA43;
if (eqStrings(spec, ((NimStringDesc*) &TMP3755))) goto LA48;
break;
		case 11: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3747))) goto LA40;
break;
		case 12: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3748))) goto LA41;
break;
		case 13: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3751))) goto LA44;
break;
		case 14: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3752))) goto LA45;
break;
		}
		goto LA51;
		LA40: ;
...
N_NIMCALL(tnode169647*, semnodekindconstraints_269363)(tnode169647* p) {
	...
	nimln(120, "parampatterns.nim");
	{
		...
		nimln(120, "parampatterns.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP3761));
	}
	LA3: ;
	nimln(121, "parampatterns.nim");
	result = newnodei_169921(((NU8) 20), (*p).Info);
	nimln(122, "parampatterns.nim");
	if (!(((TMP3738[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3739));
	nimln(122, "parampatterns.nim");
	...
	nimln(124, "parampatterns.nim");
	{
		...
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_129690((*p).Info, ((NimStringDesc*) &TMP3762));
		}
		LA14: ;
	}
	goto LA5;
...
N_NIMCALL(NU8, checkforsideeffects_269500)(tnode169647* n) {
	...
	case ((NU8) 32):
	{
		...
		nimln(143, "parampatterns.nim");
		{
			...
			if (!(LOC4)) goto LA5;
			nimln(143, "parampatterns.nim");
			if (!(((TMP3763[(*op).Kind/8] &(1<<((*op).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3764));
...
N_NIMCALL(NU8, isassignable_269669)(tsym169677* owner, tnode169647* n) {
	...
	case ((NU8) 45):
	{
		...
		nimln(197, "parampatterns.nim");
		{
			...
			if (!(((TMP3763[(*(*n).kindU.S6.Sons->data[1]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[1]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3764));
...
N_NIMCALL(NIM_BOOL, matchnodekinds_269914)(tnode169647* p, tnode169647* n) {
	...
	while (1) {
		...
		case ((NU8) 4):
		{
			...
			stack[((NI32)(TMP3771))- 0] = !(stack[((NI32)(TMP3772))- 0]);
		}
		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(251, "parampatterns.nim");
			TMP3773 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3773)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3773)])), ((NU8) 0), ((NU8) 22)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3774)])), ((NU8) 0), ((NU8) 151)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
