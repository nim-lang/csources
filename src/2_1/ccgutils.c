...
static N_INLINE(ttype169681*, lastson_170015)(ttype169681* n) {
	...
	if ((NU)((NI32)(TMP5249)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP5249)];
	popFrame();
	return result;
}
...
N_NIMCALL(ttype169681*, getuniquetype_336401)(ttype169681* key) {
	...
	case ((NU8) 51):
	{
		...
		internalerror_129702(((NimStringDesc*) &TMP5247));
	}
	break;
	case ((NU8) 12):
	{
...
N_NIMCALL(trope126007*, makellvmstring_336606)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(170, "ccgutils.nim");
		{
			...
			TMP5254 = modInt((NI32)(TMP5253), 64);
			if (!(((NI) ((NI32)(TMP5254))) == 0)) goto LA4;
