...
43}
;
STRING_LITERAL(TMP3788, "\012", 1);
STRING_LITERAL(TMP3790, "", 0);
STRING_LITERAL(TMP3792, "\012\012", 2);
STRING_LITERAL(TMP3794, "* ", 2);
STRING_LITERAL(TMP3795, "(#) ", 4);
STRING_LITERAL(TMP3796, "  ", 2);
STRING_LITERAL(TMP3800, "| ", 2);
STRING_LITERAL(TMP3801, "`", 1);
STRING_LITERAL(TMP3802, "`_", 2);
STRING_LITERAL(TMP3803, " <", 2);
STRING_LITERAL(TMP3804, ">`_", 3);
STRING_LITERAL(TMP3805, "`:", 2);
STRING_LITERAL(TMP3806, "`:sub:", 6);
STRING_LITERAL(TMP3807, "`:sup:", 6);
STRING_LITERAL(TMP3808, "`:idx:", 6);
STRING_LITERAL(TMP3809, "*", 1);
STRING_LITERAL(TMP3810, "**", 2);
STRING_LITERAL(TMP3811, "***", 3);
STRING_LITERAL(TMP3812, "``", 2);
STRING_LITERAL(TMP3813, "\\", 1);
STRING_LITERAL(TMP3814, "\\\\", 2);
STRING_LITERAL(TMP3815, ".. index::\012", 11);
STRING_LITERAL(TMP3816, ".. contents::", 13);
STRING_LITERAL(TMP3817, "Error: cannot render: ", 22);
...
N_NIMCALL(trstnode271016*, lastson_271148)(trstnode271016* n) {
	...
	nimln(87, "rstast.nim");
	nimln(87, "rstast.nim");
	TMP3786 = subInt((*n).Sons->Sup.len, 1);
	if ((NU)((NI32)(TMP3786)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP3786)];
	popFrame();
	return result;
}
...
N_NIMCALL(void, renderrstsons_271214)(trendercontext271202* d, trstnode271016* n, NimStringDesc** result) {
	...
	nimln(104, "rstast.nim");
	LOC1 = len_271087(n);
	TMP3787 = subInt(LOC1, 1);
	HEX3Atmp_271230 = (NI32)(TMP3787);
...
appendString((*result), ind);
		...
		nimln(123, "rstast.nim");
		nimln(123, "rstast.nim");
		TMP3789 = subInt((*result)->Sup.len, oldlen);
		headlinelen = (NI32)(TMP3789);
...
appendString((*result), ind);
		...
		headline = copyString(((NimStringDesc*) &TMP3790));
		nimln(133, "rstast.nim");
		renderrstsons_271214(d, n, &headline);
		nimln(135, "rstast.nim");
		nimln(135, "rstast.nim");
		nimln(135, "rstast.nim");
		TMP3791 = subInt(headline->Sup.len, (*d).Indent);
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI32)(TMP3791), lvltochar_271244[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		nimln(146, "rstast.nim");
		nimln(146, "rstast.nim");
		TMP3793 = subInt(78, (*d).Indent);
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI32)(TMP3793), 45);
...
appendString((*result), ind);
	...
	case ((NU8) 6):
	{
		...
		tmp = copyString(((NimStringDesc*) &TMP3790));
...
appendString((*result), ((NimStringDesc*) &TMP3796));
	...
	case ((NU8) 14):
	{
		...
		nimln(191, "rstast.nim");
		nimln(191, "rstast.nim");
		TMP3797 = addInt(tmp->Sup.len, 3);
		l = (((NI32)(TMP3797) >= 30) ? (NI32)(TMP3797) : 30);
...
appendString((*result), tmp);
		...
		nimln(199, "rstast.nim");
		nimln(199, "rstast.nim");
		TMP3798 = subInt(l, tmp->Sup.len);
		TMP3799 = subInt((NI32)(TMP3798), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI32)(TMP3799), 32);
...
appendString((*result), (*n).Text);
	...
	case ((NU8) 64):
	{
		nimln(265, "rstast.nim");
		{
			...
			if (!(LOC48)) goto LA49;
			nimln(265, "rstast.nim");
			LOC48 = eqStrings((*n).Text, ((NimStringDesc*) &TMP3813));
			LA49: ;
			if (!LOC48) goto LA50;
...
appendString(LOC60, ((NimStringDesc*) &TMP3817));
...
static TNimNode* TMP3780[4];
static TNimNode* TMP3781[65];
NI TMP3783;
static char* NIM_CONST TMP3782[65] = {
"rnInner", 
"rnHeadline", 
"rnOverline", 
"rnTransition", 
...
NTI271010.base = 0;
NTI271010.flags = 3;
for (TMP3783 = 0; TMP3783 < 65; TMP3783++) {
TMP3778[TMP3783+2].kind = 1;
TMP3778[TMP3783+2].offset = TMP3783;
TMP3778[TMP3783+2].name = TMP3782[TMP3783];
TMP3781[TMP3783] = &TMP3778[TMP3783+2];
}
TMP3778[67].len = 65; TMP3778[67].kind = 2; TMP3778[67].sons = &TMP3781[0];
NTI271010.node = &TMP3778[67];
TMP3778[1].kind = 1;
TMP3778[1].offset = offsetof(trstnode271016, Kind);
TMP3778[1].typ = (&NTI271010);
TMP3778[1].name = "kind";
TMP3780[1] = &TMP3778[68];
TMP3778[68].kind = 1;
TMP3778[68].offset = offsetof(trstnode271016, Text);
TMP3778[68].typ = (&NTI143);
TMP3778[68].name = "text";
TMP3780[2] = &TMP3778[69];
TMP3778[69].kind = 1;
TMP3778[69].offset = offsetof(trstnode271016, Level);
TMP3778[69].typ = (&NTI105);
TMP3778[69].name = "level";
TMP3780[3] = &TMP3778[70];
TMP3778[70].kind = 1;
TMP3778[70].offset = offsetof(trstnode271016, Sons);
TMP3778[70].typ = (&NTI271092);
TMP3778[70].name = "sons";
TMP3778[0].len = 4; TMP3778[0].kind = 2; TMP3778[0].sons = &TMP3780[0];
NTI271016.node = &TMP3778[0];
NTI271012.size = sizeof(trstnode271016*);
NTI271012.kind = 22;
NTI271012.base = (&NTI271016);
NTI271012.flags = 2;
NTI271012.marker = TMP3785;
}
