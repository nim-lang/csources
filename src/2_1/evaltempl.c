...
static NIM_CONST TY169850 TMP3369 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3370, "sym", 3);
static NIM_CONST TY169850 TMP3371 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3372, "sons", 4);
STRING_LITERAL(TMP3374, "compiler/evaltempl.nim", 22);
NIM_CONST TY71482 TMP3373 = {((NimStringDesc*) &TMP3374),
34}
;
STRING_LITERAL(TMP3376, "", 0);
...
N_NIMCALL(void, evaltemplateaux_245011)(tnode169647* templ, tnode169647* actual, templctx245006* c, tnode169647* result) {
	...
	case ((NU8) 3):
	{
		...
		if (!(((TMP3369[(*templ).Kind/8] &(1<<((*templ).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3370));
		...
		nimln(26, "evaltempl.nim");
		{
			...
			nimln(27, "evaltempl.nim");
			{
				...
				if (((TMP3371[(*actual).Kind/8] &(1<<((*actual).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3372));
				...
				nimln(29, "evaltempl.nim");
				{
					...
					while (1) {
						...
						i_245101 = res_245105;
						nimln(1376, "ast.nim");
						if (((TMP3371[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3372));
	...
	default:
	{
		...
		TMP3375 = subInt(LOC35, 1);
		HEX3Atmp_245106 = (NI32)(TMP3375);
		...
		while (1) {
			...
			if (((TMP3371[(*templ).Kind/8] &(1<<((*templ).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3372));
...
N_NIMCALL(tnode169647*, evaltemplateargs_245201)(tnode169647* n, tsym169677* s) {
	...
	nimln(86, "evaltempl.nim");
	{
		...
		if (!(f < a)) goto LA5;
		nimln(86, "evaltempl.nim");
		globalerror_129663((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP3376));
	}
	LA5: ;
	...
	while (1) {
		...
		{
			nimln(90, "evaltempl.nim");
			if (((TMP3371[(*(*(*s).Typ).N).Kind/8] &(1<<((*(*(*s).Typ).N).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3372));
			if ((NU)(i_245218) >= (NU)((*(*(*s).Typ).N).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!(((TMP3369[(*(*(*(*s).Typ).N).kindU.S6.Sons->data[i_245218]).Kind/8] &(1<<((*(*(*(*s).Typ).N).kindU.S6.Sons->data[i_245218]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3370));
		...
		nimln(91, "evaltempl.nim");
		{
			...
			localerror_129676((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP3376));
		}
		LA17: ;
...
N_NIMCALL(tnode169647*, evaltemplate_245280)(tnode169647* n, tsym169677* tmpl, tsym169677* gensymowner) {
	...
	nimln(100, "evaltempl.nim");
	{
		...
		globalerror_129663((*n).Info, ((NU16) 183), ((NimStringDesc*) &TMP3376));
	...
	nimln(112, "evaltempl.nim");
	{
		...
		nimln(115, "evaltempl.nim");
		{
			...
			nimln(115, "evaltempl.nim");
			if (((TMP3371[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3372));
	...
	LA8: ;
	{
		...
		TMP3378 = subInt(LOC18, 1);
		HEX3Atmp_245351 = (NI32)(TMP3378);
		nimln(1274, "system.nim");
		res_245353 = 0;
		nimln(1275, "system.nim");
		while (1) {
			...
			if (((TMP3371[(*body).Kind/8] &(1<<((*body).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3372));
