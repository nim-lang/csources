...
N_NIMCALL(void, fillbuffer_382070)(tbaselexer382014* l) {
	...
	nimln(80, "lexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI32)(TMP6596)])), (NI32)(TMP6597));
	}
	LA11: ;
	...
	TMP6599 = mulInt((NI32)(TMP6598), 1);
	LOC13 = readdata_133730((*l).Input, ((void*) (&(*l).Buf[tocopy])), (NI32)(TMP6599));
	TMP6600 = divInt(LOC13, 1);
	charsread = (NI32)(TMP6600);
	...
	nimln(86, "lexbase.nim");
	{
		...
		if (!(charsread < (NI32)(TMP6602))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI32)(TMP6604);
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				TMP6605 = mulInt((*l).Buflen, 1);
				LOC32 = realloc_4007(((void*) ((*l).Buf)), (NI32)(TMP6605));
				...
				nimln(105, "lexbase.nim");
				{
					...
					if (!!(((NI32)(TMP6606) == oldbuflen))) goto LA35;
					nimln(105, "lexbase.nim");
				...
				LOC37 = readdata_133730((*l).Input, ((void*) (&(*l).Buf[oldbuflen])), (NI32)(TMP6608));
				TMP6609 = divInt(LOC37, 1);
				charsread = (NI32)(TMP6609);
...
N_NIMCALL(void, open_382024)(tbaselexer382014* l, tstream133630* input, NI buflen) {
	...
	LOC9 = alloc_4001((NI32)(TMP6619));
	(*l).Buf = ((NCSTRING) (LOC9));
	nimln(148, "lexbase.nim");
	nimln(148, "lexbase.nim");
	TMP6620 = subInt(buflen, 1);
	(*l).Sentinel = (NI32)(TMP6620);
...
N_NIMCALL(NI, getcolnumber_382043)(tbaselexer382014* l, NI pos) {
	...
	if ((NI32)(TMP6621) == (-2147483647 -1)) raiseOverflow();
	result = (NI32)abs((NI32)(TMP6621));
	popFrame();
	return result;
}
