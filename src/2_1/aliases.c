...
static NIM_CONST TY169850 TMP4749 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4750, "sons", 4);
STRING_LITERAL(TMP4752, "n.sons[0].Kind == nkSym ", 24);
STRING_LITERAL(TMP4755, "isPartOfAux(record case branch)", 31);
static NIM_CONST TY169850 TMP4756 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4757, "sym", 3);
STRING_LITERAL(TMP4758, "isPartOfAux()", 13);
...
static N_INLINE(NI, sonslen_170003)(tnode169647* n) {
	...
	{
		nimln(1175, "ast.nim");
		if (((TMP4749[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4750));
...
static N_INLINE(tnode169647*, lastson_170011)(tnode169647* n) {
	...
	TMP4754 = subInt(LOC1, 1);
	if ((NU)((NI32)(TMP4754)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI32)(TMP4754)];
	popFrame();
	return result;
}
...
N_NIMCALL(NU8, ispartofaux_300018)(tnode169647* n, ttype169681* b, tintset166041* marker) {
	...
	case ((NU8) 131):
	{
		...
		TMP4751 = subInt(LOC2, 1);
		HEX3Atmp_300262 = (NI32)(TMP4751);
	...
	case ((NU8) 132):
	{
		...
		nimln(29, "aliases.nim");
		{
			...
			nimln(29, "aliases.nim");
			hiddenraiseassert_71620(((NimStringDesc*) &TMP4752));
		}
		LA11: ;
		...
		TMP4753 = subInt(LOC17, 1);
		HEX3Atmp_300266 = (NI32)(TMP4753);
		nimln(1274, "system.nim");
		res_300268 = 1;
		nimln(1275, "system.nim");
		while (1) {
			...
			default:
			{
				...
				internalerror_129702(((NimStringDesc*) &TMP4755));
			}
			break;
			}
			nimln(1277, "system.nim");
	...
	case ((NU8) 3):
	{
		...
		if (!(((TMP4756[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4757));
	...
	default:
	{
		...
		internalerror_129690((*n).Info, ((NimStringDesc*) &TMP4758));
	}
	break;
	}
	BeforeRet: ;
...
static N_INLINE(ttype169681*, lastson_170015)(ttype169681* n) {
	...
	TMP4759 = subInt(LOC1, 1);
	if ((NU)((NI32)(TMP4759)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP4759)];
	popFrame();
	return result;
}
...
N_NIMCALL(NU8, ispartofaux_300011)(ttype169681* a, ttype169681* b, tintset166041* marker) {
	...
	case ((NU8) 18):
	{
		...
		TMP4760 = subInt(LOC25, 1);
		HEX3Atmp_300324 = (NI32)(TMP4760);
		nimln(1274, "system.nim");
		res_300326 = 0;
		nimln(1275, "system.nim");
		while (1) {
...
N_NIMCALL(NU8, ispartof_300340)(tnode169647* a, tnode169647* b) {
	...
	nimln(94, "aliases.nim");
	{
		...
		case ((NU8) 3):
		{
			...
			{
				nimln(99, "aliases.nim");
				if (!(((TMP4756[(*a).Kind/8] &(1<<((*a).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4757));
				if (!(((TMP4756[(*b).Kind/8] &(1<<((*b).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4757));
		...
		case ((NU8) 45):
		{
			...
			nimln(128, "aliases.nim");
			{
				...
				nimln(130, "aliases.nim");
				{
					...
					if (!(((TMP4756[(*LOC81).Kind/8] &(1<<((*LOC81).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4757));
					nimln(130, "aliases.nim");
					LOC82 = 0;
					LOC82 = HEX5BHEX5D_170276(b, 1);
					if (!(((TMP4756[(*LOC82).Kind/8] &(1<<((*LOC82).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4757));
