...
N_NIMCALL(void, TMP1547)(void* p, NI op);
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY104134 TMP1550 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
...
N_NIMCALL(tllstream159204*, llstreamopenstdin_159235)(void) {
	...
	LOC1 = 0;
	LOC1 = (*result).S; (*result).S = copyStringRC1(((NimStringDesc*) &TMP1548));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
N_NIMCALL(NIM_BOOL, endswithopr_159638)(NimStringDesc* x) {
	...
	result = endswith_159602(x, TMP1550);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_159644)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_159602(line, TMP1551);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(NI, counttriples_159661)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1552 = addInt(i, 1);
			if ((NU)((NI32)(TMP1552)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI32)(TMP1552)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1553 = addInt(i, 2);
			if ((NU)((NI32)(TMP1553)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI32)(TMP1553)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
N_NIMCALL(NI, llreadfromstdin_159707)(tllstream159204* s, void* buf, NI buflen) {
	...
	LOC1 = 0;
	LOC1 = (*s).S; (*s).S = copyStringRC1(((NimStringDesc*) &TMP1548));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	...
	while (1) {
		...
		nimln(119, "llstream.nim");
		{
			...
			LOC3 = copyString(((NimStringDesc*) &TMP1554));
		}
		goto LA4;
		LA6: ;
		{
...
appendString((*s).S, ((NimStringDesc*) &TMP1556));
	...
	nimln(125, "llstream.nim");
	nimln(125, "llstream.nim");
	TMP1557 = subInt((*s).S->Sup.len, (*s).Rd);
	result = ((buflen <= (NI32)(TMP1557)) ? buflen : (NI32)(TMP1557));
...
N_NIMCALL(NI, llstreamread_159242)(tllstream159204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		result = ((buflen <= (NI32)(TMP1558)) ? buflen : (NI32)(TMP1558));
		nimln(136, "llstream.nim");
		{
			...
			nimln(137, "llstream.nim");
			TMP1559 = addInt(0, (*s).Rd);
			if ((NU)((NI32)(TMP1559)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI32)(TMP1559)])), result);
...
N_NIMCALL(void, llstreamwriteln_159274)(tllstream159204* s, NimStringDesc* data) {
	...
	llstreamwrite_159258(s, ((NimStringDesc*) &TMP1556));
	popFrame();
}
...
N_NIMCALL(void, llstreamwrite_159268)(tllstream159204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			nimln(200, "llstream.nim");
			nimln(200, "llstream.nim");
			TMP1560 = addInt((*s).S->Sup.len, buflen);
			(*s).S = setLengthStr((*s).S, (NI32)(TMP1560));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1561 = addInt(0, (*s).Wr);
			if ((NU)((NI32)(TMP1561)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI32)(TMP1561)])), buf, buflen);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_159254)(tllstream159204* s) {
	...
	case ((NU8) 3):
	{
		...
		result = copyString(((NimStringDesc*) &TMP1548));
	}
	break;
	case ((NU8) 1):
	{
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			nimln(222, "llstream.nim");
			TMP1562 = addInt(i, 2048);
			result = setLengthStr(result, (NI32)(TMP1562));
			nimln(223, "llstream.nim");
			nimln(223, "llstream.nim");
			TMP1563 = addInt(i, 0);
			if ((NU)((NI32)(TMP1563)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_9317((*s).F, ((void*) (&result->data[(NI32)(TMP1563)])), 2048);
...
static TNimNode* TMP1543[6];
static TNimNode* TMP1544[4];
NI TMP1546;
static char* NIM_CONST TMP1545[4] = {
"llsNone", 
"llsString", 
"llsFile", 
"llsStdIn"};
static TNimNode TMP1541[12];
...
NTI159202.base = 0;
NTI159202.flags = 3;
for (TMP1546 = 0; TMP1546 < 4; TMP1546++) {
TMP1541[TMP1546+2].kind = 1;
TMP1541[TMP1546+2].offset = TMP1546;
TMP1541[TMP1546+2].name = TMP1545[TMP1546];
TMP1544[TMP1546] = &TMP1541[TMP1546+2];
}
TMP1541[6].len = 4; TMP1541[6].kind = 2; TMP1541[6].sons = &TMP1544[0];
NTI159202.node = &TMP1541[6];
TMP1541[1].kind = 1;
TMP1541[1].offset = offsetof(tllstream159204, Kind);
TMP1541[1].typ = (&NTI159202);
TMP1541[1].name = "kind";
TMP1543[1] = &TMP1541[7];
TMP1541[7].kind = 1;
TMP1541[7].offset = offsetof(tllstream159204, F);
TMP1541[7].typ = (&NTI9004);
TMP1541[7].name = "f";
TMP1543[2] = &TMP1541[8];
TMP1541[8].kind = 1;
TMP1541[8].offset = offsetof(tllstream159204, S);
TMP1541[8].typ = (&NTI143);
TMP1541[8].name = "s";
TMP1543[3] = &TMP1541[9];
TMP1541[9].kind = 1;
TMP1541[9].offset = offsetof(tllstream159204, Rd);
TMP1541[9].typ = (&NTI105);
TMP1541[9].name = "rd";
TMP1543[4] = &TMP1541[10];
TMP1541[10].kind = 1;
TMP1541[10].offset = offsetof(tllstream159204, Wr);
TMP1541[10].typ = (&NTI105);
TMP1541[10].name = "wr";
TMP1543[5] = &TMP1541[11];
TMP1541[11].kind = 1;
TMP1541[11].offset = offsetof(tllstream159204, Lineoffset);
TMP1541[11].typ = (&NTI105);
TMP1541[11].name = "lineOffset";
TMP1541[0].len = 6; TMP1541[0].kind = 2; TMP1541[0].sons = &TMP1543[0];
NTI159204.node = &TMP1541[0];
NTI159206.size = sizeof(tllstream159204*);
NTI159206.kind = 22;
NTI159206.base = (&NTI159204);
NTI159206.flags = 2;
NTI159206.marker = TMP1547;
}
