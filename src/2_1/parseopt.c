...
STRING_LITERAL(TMP6789, "", 0);
STRING_LITERAL(TMP6792, "", 0);
static NIM_CONST TY104134 TMP6793 = {
...
N_NIMCALL(void, initoptparser_416618)(NimStringDesc* cmdline, toptparser416606* Result) {
	...
	LA3: ;
	{
		...
		unsureAsgnRef((void**) &(*Result).Cmd, copyString(((NimStringDesc*) &TMP6789)));
		i_416630 = 0;
		HEX3Atmp_416632 = 0;
...
appendChar(LOC7, 32);
	...
	unsureAsgnRef((void**) &(*Result).Key, copyString(((NimStringDesc*) &TMP6792)));
	nimln(54, "parseopt.nim");
	unsureAsgnRef((void**) &(*Result).Val, copyString(((NimStringDesc*) &TMP6792)));
	popFrame();
}
...
N_NIMCALL(void, handleshortoption_416882)(toptparser416606* p) {
	...
	nimln(79, "parseopt.nim");
	{
		...
		i = parseword_416802((*p).Cmd, i, &(*p).Val, TMP6793);
	}
	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser416606* p) {
	...
	case 45:
	{
		...
		nimln(104, "parseopt.nim");
		{
			...
			i = parseword_416802((*p).Cmd, i, &(*p).Key, TMP6794);
			...
			nimln(109, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_416802((*p).Cmd, i, &(*p).Val, TMP6793);
			}
			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_416802((*p).Cmd, i, &(*p).Key, TMP6793);
	}
	break;
	}
	BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser416606* p) {
	...
	nimln(125, "parseopt.nim");
	nimln(125, "parseopt.nim");
	TMP6795 = subInt((*p).Cmd->Sup.len, 1);
	LOC1 = 0;
	LOC1 = copyStrLast((*p).Cmd, (*p).Pos, (NI32)(TMP6795));
...
static TNimNode* TMP6797[6];
static TNimNode* TMP6798[4];
NI TMP6800;
static char* NIM_CONST TMP6799[4] = {
"cmdEnd", 
"cmdArgument", 
"cmdLongoption", 
"cmdShortOption"};
static TNimNode TMP6787[12];
...
TMP6797[0] = &TMP6787[1];
TMP6787[1].kind = 1;
TMP6787[1].offset = offsetof(toptparser416606, Cmd);
TMP6787[1].typ = (&NTI143);
TMP6787[1].name = "cmd";
TMP6797[1] = &TMP6787[2];
TMP6787[2].kind = 1;
TMP6787[2].offset = offsetof(toptparser416606, Pos);
TMP6787[2].typ = (&NTI105);
TMP6787[2].name = "pos";
TMP6797[2] = &TMP6787[3];
TMP6787[3].kind = 1;
TMP6787[3].offset = offsetof(toptparser416606, Inshortstate);
TMP6787[3].typ = (&NTI132);
TMP6787[3].name = "inShortState";
TMP6797[3] = &TMP6787[4];
NTI416604.size = sizeof(NU8);
NTI416604.kind = 14;
NTI416604.base = 0;
NTI416604.flags = 3;
for (TMP6800 = 0; TMP6800 < 4; TMP6800++) {
TMP6787[TMP6800+5].kind = 1;
TMP6787[TMP6800+5].offset = TMP6800;
TMP6787[TMP6800+5].name = TMP6799[TMP6800];
TMP6798[TMP6800] = &TMP6787[TMP6800+5];
}
TMP6787[9].len = 4; TMP6787[9].kind = 2; TMP6787[9].sons = &TMP6798[0];
NTI416604.node = &TMP6787[9];
TMP6787[4].kind = 1;
TMP6787[4].offset = offsetof(toptparser416606, Kind);
TMP6787[4].typ = (&NTI416604);
TMP6787[4].name = "kind";
TMP6797[4] = &TMP6787[10];
TMP6787[10].kind = 1;
TMP6787[10].offset = offsetof(toptparser416606, Key);
TMP6787[10].typ = (&NTI143);
TMP6787[10].name = "key";
TMP6797[5] = &TMP6787[11];
TMP6787[11].kind = 1;
TMP6787[11].offset = offsetof(toptparser416606, Val);
TMP6787[11].typ = (&NTI143);
TMP6787[11].name = "val";
TMP6787[0].len = 6; TMP6787[0].kind = 2; TMP6787[0].sons = &TMP6797[0];
NTI416606.node = &TMP6787[0];
}
