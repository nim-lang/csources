...
static NIM_CONST TY169850 TMP2508 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2509, "sons", 4);
static NIM_CONST TY169850 TMP2511 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2512, "ident", 5);
static NIM_CONST TY169850 TMP2513 = {
0xE0, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2514, "intVal", 6);
static NIM_CONST TY169850 TMP2515 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2516, "strVal", 6);
STRING_LITERAL(TMP2517, "true", 4);
STRING_LITERAL(TMP2518, "false", 5);
STRING_LITERAL(TMP2519, "startswith", 10);
STRING_LITERAL(TMP2520, "", 0);
STRING_LITERAL(TMP2521, "leading", 7);
STRING_LITERAL(TMP2522, "trailing", 8);
STRING_LITERAL(TMP2524, "sub", 3);
STRING_LITERAL(TMP2525, "by", 2);
...
static N_INLINE(NI, sonslen_170003)(tnode169647* n) {
	...
	{
		nimln(1175, "ast.nim");
		if (((TMP2508[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2509));
...
N_NIMCALL(tnode169647*, getarg_192042)(tnode169647* n, NimStringDesc* name, NI pos) {
	...
	TMP2510 = subInt(LOC5, 1);
	HEX3Atmp_192169 = (NI32)(TMP2510);
	...
	while (1) {
		...
		nimln(31, "filters.nim");
		{
			...
			nimln(32, "filters.nim");
			{
				...
				if (((TMP2508[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2509));
				if ((NU)(i_192066) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP2508[(*(*n).kindU.S6.Sons->data[i_192066]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_192066]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2509));
			...
			nimln(33, "filters.nim");
			{
				...
				if (((TMP2508[(*(*n).kindU.S6.Sons->data[i_192066]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_192066]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2509));
				if ((NU)(0) >= (NU)((*(*n).kindU.S6.Sons->data[i_192066]).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (!(((TMP2511[(*(*(*n).kindU.S6.Sons->data[i_192066]).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*(*n).kindU.S6.Sons->data[i_192066]).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2512));
...
N_NIMCALL(NIM_CHAR, chararg_192014)(tnode169647* n, NimStringDesc* name, NI pos, NIM_CHAR default_192019) {
	...
	LA3: ;
	{
		...
		nimln(41, "filters.nim");
		nimln(41, "filters.nim");
		if (!(((TMP2513[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2514));
...
N_NIMCALL(NimStringDesc*, strarg_192021)(tnode169647* n, NimStringDesc* name, NI pos, NimStringDesc* default_192026) {
	...
	LA3: ;
	{
		...
		if (!(((TMP2515[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2516));
...
N_NIMCALL(NIM_BOOL, boolarg_192028)(tnode169647* n, NimStringDesc* name, NI pos, NIM_BOOL default_192033) {
	...
	LA3: ;
	{
		...
		LOC6 = identeq_131461((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2517));
		LA7: ;
		if (!LOC6) goto LA8;
		nimln(53, "filters.nim");
		result = NIM_TRUE;
	...
	LA8: ;
	{
		...
		nimln(54, "filters.nim");
		if (!(((TMP2511[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2512));
		LOC11 = identeq_131461((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2518));
		LA12: ;
		if (!LOC11) goto LA13;
		nimln(54, "filters.nim");
		result = NIM_FALSE;
...
N_NIMCALL(tllstream159204*, filterstrip_192008)(tllstream159204* stdin_192010, NimStringDesc* filename, tnode169647* call) {
	...
	pattern = strarg_192021(call, ((NimStringDesc*) &TMP2519), 1, ((NimStringDesc*) &TMP2520));
	nimln(59, "filters.nim");
	leading = boolarg_192028(call, ((NimStringDesc*) &TMP2521), 2, NIM_TRUE);
	nimln(60, "filters.nim");
	trailing = boolarg_192028(call, ((NimStringDesc*) &TMP2522), 3, NIM_TRUE);
	nimln(61, "filters.nim");
	result = llstreamopen_159218(((NimStringDesc*) &TMP2520));
...
N_NIMCALL(tllstream159204*, filterreplace_192002)(tllstream159204* stdin_192004, NimStringDesc* filename, tnode169647* call) {
	...
	sub = strarg_192021(call, ((NimStringDesc*) &TMP2524), 1, ((NimStringDesc*) &TMP2520));
	...
	by = strarg_192021(call, ((NimStringDesc*) &TMP2525), 2, ((NimStringDesc*) &TMP2520));
