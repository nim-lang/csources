...
STRING_LITERAL(TMP2797, "newFileSize == -1 or not mode == fmRead ", 40);
...
N_NIMCALL(tmemfile205204, open_205210)(NimStringDesc* filename, NU8 mode, NI mappedsize, NI offset, NI newfilesize) {
	...
	nimln(45, "memfiles.nim");
	{
		...
		if (!!(LOC3)) goto LA5;
		nimln(45, "memfiles.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP2797));
	}
	LA5: ;
...
static TNimNode* TMP2878[3];
static TNimNode TMP2795[4];
...
TMP2878[0] = &TMP2795[1];
TMP2795[1].kind = 1;
TMP2795[1].offset = offsetof(tmemfile205204, Mem);
TMP2795[1].typ = (&NTI147);
TMP2795[1].name = "mem";
TMP2878[1] = &TMP2795[2];
TMP2795[2].kind = 1;
TMP2795[2].offset = offsetof(tmemfile205204, Size);
TMP2795[2].typ = (&NTI105);
TMP2795[2].name = "size";
TMP2878[2] = &TMP2795[3];
TMP2795[3].kind = 1;
TMP2795[3].offset = offsetof(tmemfile205204, Handle);
TMP2795[3].typ = (&NTI3701);
TMP2795[3].name = "handle";
TMP2795[0].len = 3; TMP2795[0].kind = 2; TMP2795[0].sons = &TMP2878[0];
NTI205204.node = &TMP2795[0];
}
