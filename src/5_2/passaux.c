...
STRING_LITERAL(TMP6765, "logpass: context is not nil", 27);
...
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP6767, "sons", 4);
static NIM_CONST TY169850 TMP6769 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP6770, "sym", 3);
...
N_NIMCALL(tnode169647*, verboseprocess_413013)(tpasscontext218003* context, tnode169647* n) {
	...
	nimln(22, "passaux.nim");
	{
		...
		nimln(22, "passaux.nim");
		internalerror_129699(((NimStringDesc*) &TMP6765));
	}
	LA3: ;
...
N_NIMCALL(tnode169647*, cleanup_413045)(tpasscontext218003* c, tnode169647* n) {
	...
	case ((NU8) 114):
	{
		...
		TMP6768 = subInt(LOC8, 1);
		HEX3Atmp_413145 = (NI64)(TMP6768);
	...
	case ((NU8) 80):
	{
		nimln(39, "passaux.nim");
		{
			...
			if (((TMP6766[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP6767));
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!(((TMP6769[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP6770));
			...
			nimln(41, "passaux.nim");
			{
				...
				if (((TMP6766[(*(*s).Ast).Kind/8] &(1<<((*(*s).Ast).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP6767));
