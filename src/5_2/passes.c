...
static NIM_CONST TY169850 TMP3054 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3055, "sons", 4);
...
N_NIMCALL(NIM_BOOL, astneeded_218082)(tsym169677* s) {
	...
	nimln(73, "passes.nim");
	{
		...
		if (!(LOC3)) goto LA8;
		nimln(76, "passes.nim");
		if (((TMP3054[(*(*s).Ast).Kind/8] &(1<<((*(*s).Ast).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3055));
...
static N_INLINE(NI, sonslen_170003)(tnode169647* n) {
	...
	{
		nimln(1175, "ast.nim");
		if (((TMP3054[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3055));
...
N_NIMCALL(void, processmodule_218049)(tsym169677* module, tllstream159204* stream, trodreader207023* rd) {
	...
	LA3: ;
	{
		...
		TMP3062 = subInt(LOC34, 1);
		HEX3Atmp_218549 = (NI64)(TMP3062);
		nimln(1274, "system.nim");
		res_218551 = 0;
		nimln(1275, "system.nim");
		while (1) {
...
static TNimNode TMP2943[1];
NTI218003.size = sizeof(tpasscontext218003);
NTI218003.kind = 17;
NTI218003.base = (&NTI1009);
NTI218003.flags = 3;
TMP2943[0].kind = 1;
TMP2943[0].offset = offsetof(tpasscontext218003, Fromcache);
TMP2943[0].typ = (&NTI132);
TMP2943[0].name = "fromCache";
NTI218003.node = &TMP2943[0];
}
