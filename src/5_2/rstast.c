...
N_NIMCALL(trstnode271016*, lastson_271148)(trstnode271016* n) {
	...
	if ((NU)((NI64)(TMP3789)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP3789)];
	popFrame();
	return result;
}
...
appendString((*result), ind);
		...
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI64)(TMP3794), lvltochar_271244[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI64)(TMP3796), 45);
...
appendString((*result), ((NimStringDesc*) &TMP3799));
	...
	case ((NU8) 14):
	{
		...
		l = (((NI64)(TMP3800) >= 30) ? (NI64)(TMP3800) : 30);
...
appendString((*result), tmp);
		...
		TMP3802 = subInt((NI64)(TMP3801), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI64)(TMP3802), 32);
