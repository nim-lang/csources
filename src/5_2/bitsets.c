...
N_NIMCALL(NIM_BOOL, bitsetin_213055)(tbitset213008* x, NI64 e) {
	...
	result = !(((NI8)(x->data[(NI64)(TMP2978)] & ((NI8)(NU8)(NU)((NI)((NU64)(1) << (NU64)(((NI) ((NI64)(TMP2979)))))))) == ((NI8) 0)));
	popFrame();
	return result;
}
...
N_NIMCALL(void, bitsetincl_213043)(tbitset213008** x, NI64 elem) {
	...
	(*x)->data[(NI64)(TMP2981)] = (NI8)((*x)->data[(NI64)(TMP2982)] | ((NI8)(NU8)(NU)((NI)((NU64)(1) << (NU64)(((NI) ((NI64)(TMP2983))))))));
	popFrame();
}
...
N_NIMCALL(void, bitsetexcl_213049)(tbitset213008** x, NI64 elem) {
	...
	(*x)->data[(NI64)(TMP2984)] = (NI8)((*x)->data[(NI64)(TMP2985)] & (NI8)((NU8) ~(((NI8)(NU8)(NU)((NI)((NU64)(1) << (NU64)(((NI) ((NI64)(TMP2986))))))))));
	popFrame();
}
N_NIMCALL(void, TMP2987)(void* p, NI op) {
	tbitset213008* a;
