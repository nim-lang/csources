...
STRING_LITERAL(TMP2555, "standard", 8);
STRING_LITERAL(TMP2556, "braces", 6);
STRING_LITERAL(TMP2557, "endx", 4);
NIM_CONST TY194015 parsernames_194014 = {((NimStringDesc*) &TMP2555),
((NimStringDesc*) &TMP2556),
((NimStringDesc*) &TMP2557)}
;
STRING_LITERAL(TMP2558, "none", 4);
STRING_LITERAL(TMP2559, "stdtmpl", 7);
STRING_LITERAL(TMP2560, "replace", 7);
STRING_LITERAL(TMP2561, "strip", 5);
NIM_CONST TY194020 filternames_194019 = {((NimStringDesc*) &TMP2558),
((NimStringDesc*) &TMP2559),
((NimStringDesc*) &TMP2560),
((NimStringDesc*) &TMP2561)}
;
STRING_LITERAL(TMP2566, "parser to implement", 19);
static NIM_CONST TY169850 TMP2570 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2571, "sons", 4);
static NIM_CONST TY169850 TMP2572 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2573, "ident", 5);
...
N_NIMCALL(tnode169647*, parseall_194046)(tparsers194026* p) {
	...
	case ((NU8) 2):
	{
		...
		internalerror_129699(((NimStringDesc*) &TMP2566));
...
N_NIMCALL(NIM_BOOL, containsshebang_194097)(NimStringDesc* s, NI i) {
	...
	nimln(84, "syntaxes.nim");
	{
		...
		nimln(84, "syntaxes.nim");
		TMP2567 = addInt(i, 1);
		if ((NU)((NI64)(TMP2567)) > (NU)(s->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(s->data[(NI64)(TMP2567)]) == (NU8)(33));
		LA4: ;
		if (!LOC3) goto LA5;
...
N_NIMCALL(tnode169647*, parsepipe_194127)(NimStringDesc* filename, tllstream159204* inputstream) {
	...
	nimln(92, "syntaxes.nim");
	{
		...
		nimln(99, "syntaxes.nim");
		{
			...
			nimln(99, "syntaxes.nim");
			TMP2569 = addInt(i, 1);
			if ((NU)((NI64)(TMP2569)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC14 = ((NU8)(line->data[(NI64)(TMP2569)]) == (NU8)(33));
			LA15: ;
			if (!LOC14) goto LA16;
...
N_NIMCALL(tident131015*, getcallee_194283)(tnode169647* n) {
	...
	nimln(121, "syntaxes.nim");
	{
		...
		if (((TMP2570[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2571));
		if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP2572[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2573));
...
N_NIMCALL(tllstream159204*, evalpipe_194384)(tparsers194026* p, tnode169647* n, NimStringDesc* filename, tllstream159204* start) {
	...
	nimln(152, "syntaxes.nim");
	{
		...
		if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP2572[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2573));
		LOC7 = identeq_131461((*(*n).kindU.S6.Sons->data[0]).kindU.S5.Ident, ((NimStringDesc*) &TMP2574));
		LA10: ;
		if (!LOC7) goto LA11;
		i_194448 = 0;
		nimln(1274, "system.nim");
...
static TNimNode* TMP2562[2];
static TNimNode* TMP2563[3];
NI TMP2565;
static char* NIM_CONST TMP2564[3] = {
"skinStandard", 
"skinBraces", 
"skinEndX"};
static TNimNode TMP2191[7];
...
NTI194005.base = 0;
NTI194005.flags = 3;
for (TMP2565 = 0; TMP2565 < 3; TMP2565++) {
TMP2191[TMP2565+2].kind = 1;
TMP2191[TMP2565+2].offset = TMP2565;
TMP2191[TMP2565+2].name = TMP2564[TMP2565];
TMP2563[TMP2565] = &TMP2191[TMP2565+2];
}
TMP2191[5].len = 3; TMP2191[5].kind = 2; TMP2191[5].sons = &TMP2563[0];
NTI194005.node = &TMP2191[5];
TMP2191[1].kind = 1;
TMP2191[1].offset = offsetof(tparsers194026, Skin);
TMP2191[1].typ = (&NTI194005);
TMP2191[1].name = "skin";
TMP2562[1] = &TMP2191[6];
TMP2191[6].kind = 1;
TMP2191[6].offset = offsetof(tparsers194026, Parser);
TMP2191[6].typ = (&NTI183203);
TMP2191[6].name = "parser";
TMP2191[0].len = 2; TMP2191[0].kind = 2; TMP2191[0].sons = &TMP2562[0];
NTI194026.node = &TMP2191[0];
}
