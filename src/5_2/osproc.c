...
STRING_LITERAL(TMP901, "0 < n ", 6);
STRING_LITERAL(TMP913, "", 0);
STRING_LITERAL(TMP914, "\012", 1);
STRING_LITERAL(TMP916, " ", 1);
STRING_LITERAL(TMP928, "=", 1);
STRING_LITERAL(TMP939, "setpgid call failed: ", 21);
STRING_LITERAL(TMP941, "sh", 2);
STRING_LITERAL(TMP942, "-c", 2);
NIM_CONST TY105434 TMP940 = {((NimStringDesc*) &TMP941),
((NimStringDesc*) &TMP942)}
;
STRING_LITERAL(TMP943, "execve call failed: ", 20);
NIM_CONST TY71482 TMP951 = {((NimStringDesc*) &TMP913),
-1}
;
...
N_NIMCALL(tprocess135203*, startcmd_135246)(NimStringDesc* command, NU8 options) {
	...
	a = (TY9355*) newSeq((&NTI9355), (NI64)(TMP897));
	i_135291 = 0;
	HEX3Atmp_135293 = 0;
	nimln(86, "osproc.nim");
	nimln(86, "osproc.nim");
	nimln(86, "osproc.nim");
	TMP898 = subInt(c->Sup.len, 1);
	HEX3Atmp_135293 = (NI64)(TMP898);
	...
	while (1) {
		...
		nimln(86, "osproc.nim");
		nimln(86, "osproc.nim");
		TMP899 = subInt(i_135291, 1);
		if ((NU)((NI64)(TMP899)) >= (NU)(a->Sup.len)) raiseIndexError();
		if ((NU)(i_135291) >= (NU)(c->Sup.len)) raiseIndexError();
		LOC2 = 0;
		LOC2 = a->data[(NI64)(TMP899)]; a->data[(NI64)(TMP899)] = copyStringRC1(c->data[i_135291]);
	...
	result = nospstartProcess(c->data[0], ((NimStringDesc*) &TMP900), a->data, a->Sup.len, NIM_NIL, options);
	popFrame();
	return result;
}
...
N_NIMCALL(NI, nospexecProcesses)(NimStringDesc** cmds, NI cmdsLen0, NU8 options_135624, NI n) {
	...
	nimln(181, "osproc.nim");
	{
		...
		if (!!((0 < n))) goto LA3;
		nimln(181, "osproc.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP901));
	}
	LA3: ;
...
appendString(result, ((NimStringDesc*) &TMP914));
		}
		goto LA2;
		LA5: ;
		{
...
N_NIMCALL(NimStringDesc*, addcmdargs_136404)(NimStringDesc* command, NimStringDesc** args, NI argsLen0) {
	...
	while (1) {
		...
		result = resizeString(result, 1);
appendString(result, ((NimStringDesc*) &TMP916));
...
N_NIMCALL(NCSTRING*, tocstringarray_136424)(NimStringDesc** b, NI bLen0, NimStringDesc** a, NI aLen0) {
	...
	nimln(495, "osproc.nim");
	nimln(495, "osproc.nim");
	TMP917 = addInt(aLen0, bLen0);
	TMP918 = addInt((NI64)(TMP917), 1);
	TMP919 = mulInt((NI64)(TMP918), 8);
	LOC1 = alloc0_4004((NI64)(TMP919));
	...
	while (1) {
		...
		nimln(498, "osproc.nim");
		if ((NU)(i_136448) >= (NU)(bLen0)) raiseIndexError();
		TMP921 = addInt(b[i_136448]->Sup.len, 1);
		memcpy(((void*) (result[(i_136448)- 0])), ((void*) (b[i_136448]->data)), (NI64)(TMP921));
		nimln(1284, "system.nim");
	...
	while (1) {
		...
		nimln(500, "osproc.nim");
		nimln(500, "osproc.nim");
		TMP922 = addInt(i_136456, bLen0);
		if ((NU)((NI64)(TMP922)) > (NU)(50000)) raiseIndexError();
		nimln(500, "osproc.nim");
		nimln(500, "osproc.nim");
		nimln(500, "osproc.nim");
		if ((NU)(i_136456) >= (NU)(aLen0)) raiseIndexError();
		TMP923 = addInt(a[i_136456]->Sup.len, 1);
		LOC5 = alloc_4001((NI64)(TMP923));
		result[((NI64)(TMP922))- 0] = ((NCSTRING) (LOC5));
		nimln(501, "osproc.nim");
		nimln(501, "osproc.nim");
		nimln(501, "osproc.nim");
		TMP924 = addInt(i_136456, bLen0);
		if ((NU)((NI64)(TMP924)) > (NU)(50000)) raiseIndexError();
		if ((NU)(i_136456) >= (NU)(aLen0)) raiseIndexError();
		nimln(501, "osproc.nim");
		nimln(501, "osproc.nim");
		if ((NU)(i_136456) >= (NU)(aLen0)) raiseIndexError();
		TMP925 = addInt(a[i_136456]->Sup.len, 1);
		memcpy(((void*) (result[((NI64)(TMP924))- 0])), ((void*) (a[i_136456]->data)), (NI64)(TMP925));
		nimln(1284, "system.nim");
...
N_NIMCALL(NCSTRING*, tocstringarray_136482)(tstringtable103609* t) {
	...
	nimln(504, "osproc.nim");
	LOC1 = nstlen(t);
	TMP926 = addInt(LOC1, 1);
	TMP927 = mulInt((NI64)(TMP926), 8);
	LOC2 = alloc0_4004((NI64)(TMP927));
...
appendString(LOC8, ((NimStringDesc*) &TMP928));
appendString(LOC8, val_136489);
			...
			nimln(509, "osproc.nim");
			nimln(509, "osproc.nim");
			TMP930 = addInt(x->Sup.len, 1);
			memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI64)(TMP930));
...
N_NIMCALL(NCSTRING*, envtocstringarray_136515)(void) {
	...
	while (1) {
		...
		if ((NU)(i_136552) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		nimln(1035, "os.nim");
		TMP931 = subInt(p_136558, 1);
		key_136519 = copyStrLast(environment_95235->data[i_136552], 0, (NI64)(TMP931));
		nimln(1036, "os.nim");
		nimln(1036, "os.nim");
		if ((NU)(i_136552) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		nimln(1036, "os.nim");
		TMP932 = addInt(p_136558, 1);
		val_136520 = copyStr(environment_95235->data[i_136552], (NI64)(TMP932));
	...
	nimln(515, "osproc.nim");
	nimln(515, "osproc.nim");
	TMP933 = addInt(counter, 1);
	TMP934 = mulInt((NI64)(TMP933), 8);
	LOC2 = alloc0_4004((NI64)(TMP934));
	result = ((NCSTRING*) (LOC2));
	...
	while (1) {
		...
		if ((NU)(i_136568) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		nimln(1035, "os.nim");
		TMP935 = subInt(p_136574, 1);
		key_136535 = copyStrLast(environment_95235->data[i_136568], 0, (NI64)(TMP935));
		nimln(1036, "os.nim");
		nimln(1036, "os.nim");
		if ((NU)(i_136568) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		nimln(1036, "os.nim");
		TMP936 = addInt(p_136574, 1);
		val_136536 = copyStr(environment_95235->data[i_136568], (NI64)(TMP936));
		nimln(518, "osproc.nim");
		nimln(518, "osproc.nim");
		LOC4 = 0;
		LOC4 = rawNewString(key_136535->Sup.len + val_136536->Sup.len + 1);
appendString(LOC4, key_136535);
appendString(LOC4, ((NimStringDesc*) &TMP928));
appendString(LOC4, val_136536);
		...
		nimln(520, "osproc.nim");
		nimln(520, "osproc.nim");
		TMP938 = addInt(x->Sup.len, 1);
		memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI64)(TMP938));
...
appendString(LOC67, ((NimStringDesc*) &TMP939));
appendString(LOC67, LOC69);
		...
		LA76: ;
		{
			...
			a = tocstringarray_136424(TMP940, 2, LOC88, 1);
...
appendString(LOC97, ((NimStringDesc*) &TMP943));
appendString(LOC97, LOC99);
	...
	nimln(623, "osproc.nim");
	{
		...
		nimln(624, "osproc.nim");
		LOC104 = 0;
		LOC104 = nsuJoinSep(args, argsLen0, ((NimStringDesc*) &TMP916));
		printf("%s%s%s\012", (command)->data, (((NimStringDesc*) &TMP916))->data, (LOC104)->data);
	}
	LA102: ;
...
N_NIMCALL(void, pruneprocessset_137130)(TY136003** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(727, "osproc.nim");
		{
			...
			nimln(728, "osproc.nim");
			TMP947 = subInt(l, 1);
			if ((NU)((NI64)(TMP947)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRefNoCycle((void**) &(*s)->data[i], (*s)->data[(NI64)(TMP947)]);
...
N_NIMCALL(NI, select_136301)(TY136003** readfds, NI timeout) {
	...
	nimln(737, "osproc.nim");
	TMP948 = mulInt(timeout, 1000);
	tv.tv_usec = (NI64)(TMP948);
	...
	nimln(743, "osproc.nim");
	{
		...
		nimln(744, "osproc.nim");
		TMP949 = addInt(m, 1);
		LOC5 = select(((int)chckRange((NI64)(TMP949), ((int) (-2147483647 -1)), ((int) 2147483647))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		nimln(746, "osproc.nim");
		TMP950 = addInt(m, 1);
		LOC7 = select(((int)chckRange((NI64)(TMP950), ((int) (-2147483647 -1)), ((int) 2147483647))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
...
N_NIMCALL(void, execcmdex_137402)(NimStringDesc* command, NU8 options, TY71482* Result) {
	...
	unsureAsgnRef((void**) &(*Result).Field0, copyString(TMP951.Field0));
	(*Result).Field1 = TMP951.Field1;
...
appendString((*Result).Field0, ((NimStringDesc*) &TMP914));
		}
		goto LA2;
		LA5: ;
		{
...
TMP902[0] = &TMP884[1];
TMP884[1].kind = 1;
TMP884[1].offset = offsetof(tprocess135203, Inputhandle);
TMP884[1].typ = (&NTI9008);
TMP884[1].name = "inputHandle";
TMP902[1] = &TMP884[2];
TMP884[2].kind = 1;
TMP884[2].offset = offsetof(tprocess135203, Outputhandle);
TMP884[2].typ = (&NTI9008);
TMP884[2].name = "outputHandle";
TMP902[2] = &TMP884[3];
TMP884[3].kind = 1;
TMP884[3].offset = offsetof(tprocess135203, Errorhandle);
TMP884[3].typ = (&NTI9008);
TMP884[3].name = "errorHandle";
TMP902[3] = &TMP884[4];
TMP884[4].kind = 1;
TMP884[4].offset = offsetof(tprocess135203, Instream);
TMP884[4].typ = (&NTI133628);
TMP884[4].name = "inStream";
TMP902[4] = &TMP884[5];
TMP884[5].kind = 1;
TMP884[5].offset = offsetof(tprocess135203, Outstream);
TMP884[5].typ = (&NTI133628);
TMP884[5].name = "outStream";
TMP902[5] = &TMP884[6];
TMP884[6].kind = 1;
TMP884[6].offset = offsetof(tprocess135203, Errstream);
TMP884[6].typ = (&NTI133628);
TMP884[6].name = "errStream";
TMP902[6] = &TMP884[7];
TMP884[7].kind = 1;
TMP884[7].offset = offsetof(tprocess135203, Id);
TMP884[7].typ = (&NTI84455);
TMP884[7].name = "id";
TMP902[7] = &TMP884[8];
TMP884[8].kind = 1;
TMP884[8].offset = offsetof(tprocess135203, Exitcode);
TMP884[8].typ = (&NTI3701);
TMP884[8].name = "exitCode";
TMP884[0].len = 8; TMP884[0].kind = 2; TMP884[0].sons = &TMP902[0];
NTI135203.node = &TMP884[0];
NTI135205.size = sizeof(tprocess135203*);
NTI135205.kind = 22;
NTI135205.base = (&NTI135203);
NTI135205.flags = 2;
NTI135205.marker = TMP904;
NTI136003.size = sizeof(TY136003*);
NTI136003.kind = 24;
NTI136003.base = (&NTI135205);
NTI136003.flags = 2;
NTI136003.marker = TMP905;
}
