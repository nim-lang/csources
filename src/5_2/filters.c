...
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2512, "sons", 4);
static NIM_CONST TY169850 TMP2514 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2515, "ident", 5);
static NIM_CONST TY169850 TMP2516 = {
0xE0, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2517, "intVal", 6);
static NIM_CONST TY169850 TMP2518 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2519, "strVal", 6);
STRING_LITERAL(TMP2520, "true", 4);
STRING_LITERAL(TMP2521, "false", 5);
STRING_LITERAL(TMP2522, "startswith", 10);
STRING_LITERAL(TMP2523, "", 0);
STRING_LITERAL(TMP2524, "leading", 7);
STRING_LITERAL(TMP2525, "trailing", 8);
STRING_LITERAL(TMP2527, "sub", 3);
STRING_LITERAL(TMP2528, "by", 2);
...
static N_INLINE(NI, sonslen_170003)(tnode169647* n) {
	...
	{
		nimln(1175, "ast.nim");
		if (((TMP2511[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2512));
...
N_NIMCALL(tnode169647*, getarg_192042)(tnode169647* n, NimStringDesc* name, NI pos) {
	...
	TMP2513 = subInt(LOC5, 1);
	HEX3Atmp_192169 = (NI64)(TMP2513);
	...
	while (1) {
		...
		nimln(31, "filters.nim");
		{
			...
			nimln(32, "filters.nim");
			{
				...
				if (((TMP2511[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2512));
				if ((NU)(i_192066) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP2511[(*(*n).kindU.S6.Sons->data[i_192066]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_192066]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2512));
			...
			nimln(33, "filters.nim");
			{
				...
				if (((TMP2511[(*(*n).kindU.S6.Sons->data[i_192066]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_192066]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2512));
				if ((NU)(0) >= (NU)((*(*n).kindU.S6.Sons->data[i_192066]).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (!(((TMP2514[(*(*(*n).kindU.S6.Sons->data[i_192066]).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*(*n).kindU.S6.Sons->data[i_192066]).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2515));
...
N_NIMCALL(NimStringDesc*, strarg_192021)(tnode169647* n, NimStringDesc* name, NI pos, NimStringDesc* default_192026) {
	...
	LA3: ;
	{
		...
		if (!(((TMP2518[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2519));
...
N_NIMCALL(NIM_BOOL, boolarg_192028)(tnode169647* n, NimStringDesc* name, NI pos, NIM_BOOL default_192033) {
	...
	LA3: ;
	{
		...
		LOC6 = identeq_131461((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2520));
		LA7: ;
		if (!LOC6) goto LA8;
		nimln(53, "filters.nim");
		result = NIM_TRUE;
	...
	LA8: ;
	{
		...
		nimln(54, "filters.nim");
		if (!(((TMP2514[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2515));
		LOC11 = identeq_131461((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2521));
		LA12: ;
		if (!LOC11) goto LA13;
		nimln(54, "filters.nim");
		result = NIM_FALSE;
...
N_NIMCALL(tllstream159204*, filterstrip_192008)(tllstream159204* stdin_192010, NimStringDesc* filename, tnode169647* call) {
	...
	pattern = strarg_192021(call, ((NimStringDesc*) &TMP2522), 1, ((NimStringDesc*) &TMP2523));
	nimln(59, "filters.nim");
	leading = boolarg_192028(call, ((NimStringDesc*) &TMP2524), 2, NIM_TRUE);
	nimln(60, "filters.nim");
	trailing = boolarg_192028(call, ((NimStringDesc*) &TMP2525), 3, NIM_TRUE);
	nimln(61, "filters.nim");
	result = llstreamopen_159218(((NimStringDesc*) &TMP2523));
...
N_NIMCALL(tllstream159204*, filterreplace_192002)(tllstream159204* stdin_192004, NimStringDesc* filename, tnode169647* call) {
	...
	sub = strarg_192021(call, ((NimStringDesc*) &TMP2527), 1, ((NimStringDesc*) &TMP2523));
	...
	by = strarg_192021(call, ((NimStringDesc*) &TMP2528), 2, ((NimStringDesc*) &TMP2523));
