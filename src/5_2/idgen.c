...
static N_INLINE(void, setid_168436)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP1881 = addInt(id, 1);
	gfrontendid_168005 = ((gfrontendid_168005 >= (NI64)(TMP1881)) ? gfrontendid_168005 : (NI64)(TMP1881));
	popFrame();
}
...
N_NIMCALL(void, idsynchronizationpoint_168445)(NI idrange) {
	...
	TMP1884 = mulInt((NI64)(TMP1883), idrange);
	TMP1885 = addInt((NI64)(TMP1884), 1);
	gfrontendid_168005 = (NI64)(TMP1885);
	popFrame();
}
