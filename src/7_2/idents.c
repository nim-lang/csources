...
STRING_LITERAL(TMP856, "id == 0 or id == result.id ", 27);
STRING_LITERAL(TMP860, ":anonymous", 10);
...
N_NIMCALL(NI, cmpignorestyle_131032)(NCSTRING a, NCSTRING b, NI blen) {
	...
	while (1) {
		...
		nimln(40, "idents.nim");
		{
			...
			nimln(40, "idents.nim");
			nimln(40, "idents.nim");
			TMP852 = addInt(((NI) (((NU8)(aa)))), 32);
			aa = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP852), 0, 255))));
		}
		LA8: ;
		nimln(41, "idents.nim");
		{
			...
			nimln(41, "idents.nim");
			nimln(41, "idents.nim");
			TMP853 = addInt(((NI) (((NU8)(bb)))), 32);
			bb = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP853), 0, 255))));
		}
		LA14: ;
		nimln(42, "idents.nim");
		nimln(42, "idents.nim");
		nimln(42, "idents.nim");
		nimln(42, "idents.nim");
		TMP854 = subInt(((NI) (((NU8)(aa)))), ((NI) (((NU8)(bb)))));
		result = (NI64)(TMP854);
		nimln(43, "idents.nim");
		{
			NIM_BOOL LOC18;
...
N_NIMCALL(NI, cmpexact_131155)(NCSTRING a, NCSTRING b, NI blen) {
	...
	while (1) {
		...
		nimln(56, "idents.nim");
		nimln(56, "idents.nim");
		TMP855 = subInt(((NI) (((NU8)(aa)))), ((NI) (((NU8)(bb)))));
		result = (NI64)(TMP855);
		nimln(57, "idents.nim");
		{
			NIM_BOOL LOC4;
...
N_NIMCALL(tident131015*, getident_131208)(NCSTRING identifier, NI length, NI h) {
	...
	while (1) {
		...
		LA5: ;
		{
			...
			nimln(79, "idents.nim");
			{
				...
				if (!!(LOC17)) goto LA19;
				nimln(79, "idents.nim");
				hiddenraiseassert_71620(((NimStringDesc*) &TMP856));
			}
			LA19: ;
			nimln(80, "idents.nim");
			id = (*result).Sup.Id;
	...
	nimln(86, "idents.nim");
	nimln(86, "idents.nim");
	TMP859 = subInt(length, 1);
	HEX3Atmp_131440 = (NI64)(TMP859);
...
N_NOINLINE(void, identsInit)(void) {
	...
	asgnRefNoCycle((void**) &idanon_131468, getident_131448(((NimStringDesc*) &TMP860)));
	popFrame();
}

N_NOINLINE(void, identsDatInit)(void) {
static TNimNode* TMP857[3];
static TNimNode TMP850[5];
NTI131009.size = sizeof(tidobj131009);
NTI131009.kind = 17;
NTI131009.base = (&NTI1009);
NTI131009.flags = 3;
TMP850[0].kind = 1;
TMP850[0].offset = offsetof(tidobj131009, Id);
TMP850[0].typ = (&NTI105);
TMP850[0].name = "id";
NTI131009.node = &TMP850[0];
...
TMP857[0] = &TMP850[2];
TMP850[2].kind = 1;
TMP850[2].offset = offsetof(tident131015, S);
TMP850[2].typ = (&NTI143);
TMP850[2].name = "s";
TMP857[1] = &TMP850[3];
TMP850[3].kind = 1;
TMP850[3].offset = offsetof(tident131015, Next);
TMP850[3].typ = (&NTI131013);
TMP850[3].name = "next";
TMP857[2] = &TMP850[4];
TMP850[4].kind = 1;
TMP850[4].offset = offsetof(tident131015, H);
TMP850[4].typ = (&NTI101009);
TMP850[4].name = "h";
TMP850[1].len = 3; TMP850[1].kind = 2; TMP850[1].sons = &TMP857[0];
NTI131015.node = &TMP850[1];
NTI131013.size = sizeof(tident131015*);
NTI131013.kind = 22;
NTI131013.base = (&NTI131015);
NTI131013.flags = 2;
NTI131013.marker = TMP858;
NTI131011.size = sizeof(tidobj131009*);
NTI131011.kind = 22;
NTI131011.base = (&NTI131009);
NTI131011.flags = 2;
NTI131011.marker = TMP1965;
}
