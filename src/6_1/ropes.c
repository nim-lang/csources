...
N_NIMCALL(void, ropeseqinsert_126403)(tropeseq126009** rs, trope126007* r, NI at) {
	...
	nimln(164, "ropes.nim");
	{
		...
		(*rs) = (tropeseq126009*) setLengthSeq(&((*rs))->Sup, sizeof(trope126007*), ((NI)chckRange((NI32)(TMP448), (-2147483647 -1), 2147483647)));
	}
	goto LA1;
	LA3: ;
	{
		...
		(*rs) = (tropeseq126009*) setLengthSeq(&((*rs))->Sup, sizeof(trope126007*), (NI32)(TMP449));
	}
	LA1: ;
	i_126453 = 0;
	HEX3Atmp_126454 = 0;
	...
	HEX3Atmp_126454 = ((NI)chckRange((NI32)(TMP450), (-2147483647 -1), 2147483647));
	...
	while (1) {
		...
		if ((NU)((NI32)(TMP451)) >= (NU)((*rs)->Sup.len)) raiseIndexError();
		asgnRefNoCycle((void**) &(*rs)->data[i_126453], (*rs)->data[(NI32)(TMP451)]);
...
N_NIMCALL(trope126007*, ropef_126079)(NimStringDesc* frmt, trope126007** args, NI argsLen0) {
	...
	while (1) {
		...
		nimln(248, "ropes.nim");
		{
			...
			case 48 ... 57:
			{
				...
				while (1) {
					...
					nimln(261, "ropes.nim");
					if ((NU)(i) > (NU)(frmt->Sup.len)) raiseIndexError();
					TMP462 = addInt((NI32)(TMP461), ((NI) (((NU8)(frmt->data[i])))));
					TMP463 = subInt((NI32)(TMP462), 48);
					j = (NI32)(TMP463);
					nimln(262, "ropes.nim");
					i = addInt(i, 1);
					nimln(263, "ropes.nim");
				...
				LA18: ;
				{
					...
					nimln(268, "ropes.nim");
					TMP468 = subInt(j, 1);
					if ((NU)((NI32)(TMP468)) >= (NU)(argsLen0)) raiseIndexError();
					app_126040(&result, args[(NI32)(TMP468)]);
				}
				LA16: ;
			}
			break;
		...
		nimln(281, "ropes.nim");
		{
			...
			nimln(281, "ropes.nim");
			TMP470 = subInt(i, 1);
			if (!(start <= (NI32)(TMP470))) goto LA34;
			nimln(282, "ropes.nim");
			nimln(282, "ropes.nim");
			nimln(282, "ropes.nim");
			TMP471 = subInt(i, 1);
			LOC36 = 0;
			LOC36 = copyStrLast(frmt, start, (NI32)(TMP471));
