...
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2515, "sons", 4);
static NIM_CONST TY169850 TMP2517 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2518, "ident", 5);
static NIM_CONST TY169850 TMP2519 = {
0xE0, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2520, "intVal", 6);
static NIM_CONST TY169850 TMP2521 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2522, "strVal", 6);
STRING_LITERAL(TMP2523, "true", 4);
STRING_LITERAL(TMP2524, "false", 5);
STRING_LITERAL(TMP2525, "startswith", 10);
STRING_LITERAL(TMP2526, "", 0);
STRING_LITERAL(TMP2527, "leading", 7);
STRING_LITERAL(TMP2528, "trailing", 8);
STRING_LITERAL(TMP2530, "sub", 3);
STRING_LITERAL(TMP2531, "by", 2);
...
static N_INLINE(NI, sonslen_170003)(tnode169647* n) {
	...
	{
		nimln(1175, "ast.nim");
		if (((TMP2514[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2515));
...
N_NIMCALL(tnode169647*, getarg_192042)(tnode169647* n, NimStringDesc* name, NI pos) {
	...
	TMP2516 = subInt(LOC5, 1);
	HEX3Atmp_192169 = (NI32)(TMP2516);
	...
	while (1) {
		...
		nimln(31, "filters.nim");
		{
			...
			nimln(32, "filters.nim");
			{
				...
				if (((TMP2514[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2515));
				if ((NU)(i_192066) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP2514[(*(*n).kindU.S6.Sons->data[i_192066]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_192066]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2515));
			...
			nimln(33, "filters.nim");
			{
				...
				if (((TMP2514[(*(*n).kindU.S6.Sons->data[i_192066]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_192066]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2515));
				if ((NU)(0) >= (NU)((*(*n).kindU.S6.Sons->data[i_192066]).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (!(((TMP2517[(*(*(*n).kindU.S6.Sons->data[i_192066]).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*(*n).kindU.S6.Sons->data[i_192066]).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2518));
...
N_NIMCALL(NIM_CHAR, chararg_192014)(tnode169647* n, NimStringDesc* name, NI pos, NIM_CHAR default_192019) {
	...
	LA3: ;
	{
		...
		nimln(41, "filters.nim");
		nimln(41, "filters.nim");
		if (!(((TMP2519[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2520));
...
N_NIMCALL(NimStringDesc*, strarg_192021)(tnode169647* n, NimStringDesc* name, NI pos, NimStringDesc* default_192026) {
	...
	LA3: ;
	{
		...
		if (!(((TMP2521[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2522));
...
N_NIMCALL(NIM_BOOL, boolarg_192028)(tnode169647* n, NimStringDesc* name, NI pos, NIM_BOOL default_192033) {
	...
	LA3: ;
	{
		...
		if (!(LOC6)) goto LA7;
		nimln(53, "filters.nim");
		if (!(((TMP2517[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2518));
		LOC6 = identeq_131461((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2523));
		LA7: ;
		if (!LOC6) goto LA8;
		nimln(53, "filters.nim");
		result = NIM_TRUE;
	...
	LA8: ;
	{
		...
		nimln(54, "filters.nim");
		if (!(((TMP2517[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2518));
		LOC11 = identeq_131461((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2524));
		LA12: ;
		if (!LOC11) goto LA13;
		nimln(54, "filters.nim");
		result = NIM_FALSE;
...
N_NIMCALL(tllstream159204*, filterstrip_192008)(tllstream159204* stdin_192010, NimStringDesc* filename, tnode169647* call) {
	...
	pattern = strarg_192021(call, ((NimStringDesc*) &TMP2525), 1, ((NimStringDesc*) &TMP2526));
	nimln(59, "filters.nim");
	leading = boolarg_192028(call, ((NimStringDesc*) &TMP2527), 2, NIM_TRUE);
	nimln(60, "filters.nim");
	trailing = boolarg_192028(call, ((NimStringDesc*) &TMP2528), 3, NIM_TRUE);
	nimln(61, "filters.nim");
	result = llstreamopen_159218(((NimStringDesc*) &TMP2526));
...
N_NIMCALL(tllstream159204*, filterreplace_192002)(tllstream159204* stdin_192004, NimStringDesc* filename, tnode169647* call) {
	...
	sub = strarg_192021(call, ((NimStringDesc*) &TMP2530), 1, ((NimStringDesc*) &TMP2526));
	...
	by = strarg_192021(call, ((NimStringDesc*) &TMP2531), 2, ((NimStringDesc*) &TMP2526));
