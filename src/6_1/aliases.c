...
static NIM_CONST TY169850 TMP4755 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4756, "sons", 4);
STRING_LITERAL(TMP4758, "n.sons[0].Kind == nkSym ", 24);
STRING_LITERAL(TMP4761, "isPartOfAux(record case branch)", 31);
static NIM_CONST TY169850 TMP4762 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4763, "sym", 3);
STRING_LITERAL(TMP4764, "isPartOfAux()", 13);
...
static N_INLINE(NI, sonslen_170003)(tnode169647* n) {
	...
	{
		nimln(1175, "ast.nim");
		if (((TMP4755[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4756));
...
static N_INLINE(tnode169647*, lastson_170011)(tnode169647* n) {
	...
	if ((NU)((NI32)(TMP4760)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI32)(TMP4760)];
	popFrame();
	return result;
}
...
N_NIMCALL(NU8, ispartofaux_300018)(tnode169647* n, ttype169681* b, tintset166041* marker) {
	...
	case ((NU8) 131):
	{
		...
		TMP4757 = subInt(LOC2, 1);
		HEX3Atmp_300262 = (NI32)(TMP4757);
	...
	case ((NU8) 132):
	{
		...
		nimln(29, "aliases.nim");
		{
			...
			nimln(29, "aliases.nim");
			hiddenraiseassert_71620(((NimStringDesc*) &TMP4758));
		}
		LA11: ;
		...
		TMP4759 = subInt(LOC17, 1);
		HEX3Atmp_300266 = (NI32)(TMP4759);
		nimln(1274, "system.nim");
		res_300268 = 1;
		nimln(1275, "system.nim");
		while (1) {
			...
			default:
			{
				...
				internalerror_129702(((NimStringDesc*) &TMP4761));
			}
			break;
			}
			nimln(1277, "system.nim");
	...
	default:
	{
		...
		internalerror_129690((*n).Info, ((NimStringDesc*) &TMP4764));
	}
	break;
	}
	BeforeRet: ;
...
static N_INLINE(ttype169681*, lastson_170015)(ttype169681* n) {
	...
	TMP4765 = subInt(LOC1, 1);
	if ((NU)((NI32)(TMP4765)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP4765)];
	popFrame();
	return result;
}
...
N_NIMCALL(NU8, ispartofaux_300011)(ttype169681* a, ttype169681* b, tintset166041* marker) {
	...
	case ((NU8) 18):
	{
		...
		TMP4766 = subInt(LOC25, 1);
		HEX3Atmp_300324 = (NI32)(TMP4766);
		nimln(1274, "system.nim");
		res_300326 = 0;
		nimln(1275, "system.nim");
		while (1) {
...
N_NIMCALL(NU8, ispartof_300340)(tnode169647* a, tnode169647* b) {
	...
	nimln(94, "aliases.nim");
	{
		...
		case ((NU8) 3):
		{
			...
			{
				nimln(99, "aliases.nim");
				if (!(((TMP4762[(*a).Kind/8] &(1<<((*a).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4763));
				if (!(((TMP4762[(*b).Kind/8] &(1<<((*b).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4763));
		...
		case ((NU8) 45):
		{
			...
			nimln(128, "aliases.nim");
			{
				...
				nimln(130, "aliases.nim");
				{
					...
					if (!(((TMP4762[(*LOC81).Kind/8] &(1<<((*LOC81).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4763));
					nimln(130, "aliases.nim");
					LOC82 = 0;
					LOC82 = HEX5BHEX5D_170276(b, 1);
					if (!(((TMP4762[(*LOC82).Kind/8] &(1<<((*LOC82).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4763));
