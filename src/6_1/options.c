...
STRING_LITERAL(TMP329, "nimcache", 8);
STRING_LITERAL(TMP333, "cannot create directory: ", 25);
STRING_LITERAL(TMP335, "nim", 3);
STRING_LITERAL(TMP341, "not \'\\0\' == sep ", 16);
STRING_LITERAL(TMP343, "lib", 3);
static NIM_CONST TY104134 TMP345 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x43, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP347, "true", 4);
...
N_NIMCALL(NimStringDesc*, removetrailingdirsep_105410)(NimStringDesc* path) {
	...
	nimln(200, "options.nim");
	{
		...
		if ((NU)((NI32)(TMP327)) > (NU)(path->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(path->data[(NI32)(TMP327)]) == (NU8)(47));
		LA4: ;
		if (!LOC3) goto LA5;
		...
		nimln(201, "options.nim");
		nimln(201, "options.nim");
		TMP328 = subInt(path->Sup.len, 2);
		result = copyStrLast(path, 0, (NI32)(TMP328));
	}
	goto LA1;
	LA5: ;
	{
...
N_NIMCALL(NimStringDesc*, getgeneratedpath_105418)(void) {
	...
	LA3: ;
	{
		...
		result = HEX2F_94062(LOC6, ((NimStringDesc*) &TMP329));
	}
	LA1: ;
	popFrame();
	return result;
...
N_NIMCALL(NimStringDesc*, completegeneratedfilepath_105438)(NimStringDesc* f, NIM_BOOL createsubdir) {
	...
	nimln(220, "options.nim");
	{
		...
		pushSafePoint(&TMP330);
		TMP330.status = setjmp(TMP330.context);
		if (TMP330.status == 0) {
...
appendString(LOC10, ((NimStringDesc*) &TMP333));
appendString(LOC10, subdir);
		...
		if (TMP330.status != 0) reraiseException();
	}
	LA4: ;
...
static N_INLINE(NimStringDesc*, findmodule_105538)(NimStringDesc* modulename) {
	...
	nimln(263, "options.nim");
	LOC1 = 0;
	LOC1 = nosaddFileExt(modulename, ((NimStringDesc*) &TMP335));
...
N_NIMCALL(void, libcandidates_105544)(NimStringDesc* s, TY9355** dest) {
	...
	nimln(267, "options.nim");
	TMP336 = addInt(le, 1);
	ri = nsuFindChar(s, 41, (NI32)(TMP336));
	nimln(268, "options.nim");
	{
		...
		nimln(269, "options.nim");
		TMP337 = subInt(le, 1);
		prefix = copyStrLast(s, 0, (NI32)(TMP337));
		nimln(270, "options.nim");
		nimln(270, "options.nim");
		nimln(270, "options.nim");
		TMP338 = addInt(ri, 1);
		suffix = copyStr(s, (NI32)(TMP338));
		middle_105556 = 0;
		HEX3Atmp_105573 = 0;
		...
		nimln(271, "options.nim");
		TMP340 = subInt(ri, 1);
		HEX3Atmp_105573 = copyStrLast(s, (NI32)(TMP339), (NI32)(TMP340));
		...
		nimln(248, "strutils.nim");
		{
			...
			nimln(248, "strutils.nim");
			hiddenraiseassert_71620(((NimStringDesc*) &TMP341));
		}
		LA9: ;
		nimln(249, "strutils.nim");
		{
			...
			while (1) {
				...
				nimln(254, "strutils.nim");
				nimln(254, "strutils.nim");
				TMP342 = subInt(last_105575, 1);
				middle_105556 = copyStrLast(HEX3Atmp_105573, first_105577, (NI32)(TMP342));
...
N_NIMCALL(NimStringDesc*, canondynlibname_105582)(NimStringDesc* s) {
	...
	ende = nsuFindCharSet(s, TMP345, 0);
	nimln(279, "options.nim");
	{
		...
		nimln(280, "options.nim");
		nimln(280, "options.nim");
		TMP346 = subInt(ende, 1);
		result = copyStrLast(s, start, (NI32)(TMP346));
	}
	goto LA7;
	LA9: ;
	{
...
N_NIMCALL(void, incldynliboverride_105591)(NimStringDesc* lib) {
	...
	nstPut(gdlloverrides_105189, LOC1, ((NimStringDesc*) &TMP347));
	popFrame();
}
...
static TNimNode* TMP1935[22];
NI TMP1937;
static char* NIM_CONST TMP1936[22] = {
"optNone", 
"optObjCheck", 
"optFieldCheck", 
"optRangeCheck", 
...
"optImplicitStatic", 
"optPatterns"};
static TNimNode* TMP2931[20];
NI TMP2933;
static char* NIM_CONST TMP2932[20] = {
"cmdNone", 
"cmdCompileToC", 
"cmdCompileToCpp", 
"cmdCompileToOC", 
...
"cmdInteractive", 
"cmdRun"};
static TNimNode* TMP6997[32];
NI TMP6999;
static char* NIM_CONST TMP6998[32] = {
"gloptNone", 
"optForceFullMake", 
"optDeadCodeElim", 
"optListCmd", 
...
NTI105008.base = 0;
NTI105008.flags = 3;
for (TMP1937 = 0; TMP1937 < 22; TMP1937++) {
TMP249[TMP1937+0].kind = 1;
TMP249[TMP1937+0].offset = TMP1937;
TMP249[TMP1937+0].name = TMP1936[TMP1937];
TMP1935[TMP1937] = &TMP249[TMP1937+0];
}
TMP249[22].len = 22; TMP249[22].kind = 2; TMP249[22].sons = &TMP1935[0];
...
NTI105016.base = 0;
NTI105016.flags = 3;
for (TMP2933 = 0; TMP2933 < 20; TMP2933++) {
TMP249[TMP2933+24].kind = 1;
TMP249[TMP2933+24].offset = TMP2933;
TMP249[TMP2933+24].name = TMP2932[TMP2933];
TMP2931[TMP2933] = &TMP249[TMP2933+24];
}
TMP249[44].len = 20; TMP249[44].kind = 2; TMP249[44].sons = &TMP2931[0];
NTI105016.node = &TMP249[44];
NTI105012.size = sizeof(NU8);
NTI105012.kind = 14;
NTI105012.base = 0;
NTI105012.flags = 3;
for (TMP6999 = 0; TMP6999 < 32; TMP6999++) {
TMP249[TMP6999+45].kind = 1;
TMP249[TMP6999+45].offset = TMP6999;
TMP249[TMP6999+45].name = TMP6998[TMP6999];
TMP6997[TMP6999] = &TMP249[TMP6999+45];
}
TMP249[77].len = 32; TMP249[77].kind = 2; TMP249[77].sons = &TMP6997[0];
