...
STRING_LITERAL(TMP6795, "", 0);
STRING_LITERAL(TMP6797, "", 0);
static NIM_CONST TY104134 TMP6798 = {
0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY104134 TMP6799 = {
...
N_NIMCALL(void, initoptparser_416618)(NimStringDesc* cmdline, toptparser416606* Result) {
	...
	LA3: ;
	{
		...
		unsureAsgnRef((void**) &(*Result).Cmd, copyString(((NimStringDesc*) &TMP6795)));
		i_416630 = 0;
		HEX3Atmp_416632 = 0;
...
appendChar(LOC7, 32);
	...
	unsureAsgnRef((void**) &(*Result).Key, copyString(((NimStringDesc*) &TMP6797)));
	nimln(54, "parseopt.nim");
	unsureAsgnRef((void**) &(*Result).Val, copyString(((NimStringDesc*) &TMP6797)));
	popFrame();
}
...
N_NIMCALL(void, handleshortoption_416882)(toptparser416606* p) {
	...
	nimln(79, "parseopt.nim");
	{
		...
		i = parseword_416802((*p).Cmd, i, &(*p).Val, TMP6798);
	}
	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser416606* p) {
	...
	case 45:
	{
		...
		nimln(104, "parseopt.nim");
		{
			...
			i = parseword_416802((*p).Cmd, i, &(*p).Key, TMP6799);
			...
			nimln(109, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_416802((*p).Cmd, i, &(*p).Val, TMP6798);
			}
			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_416802((*p).Cmd, i, &(*p).Key, TMP6798);
	}
	break;
	}
	BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser416606* p) {
	...
	nimln(125, "parseopt.nim");
	nimln(125, "parseopt.nim");
	TMP6800 = subInt((*p).Cmd->Sup.len, 1);
	LOC1 = 0;
	LOC1 = copyStrLast((*p).Cmd, (*p).Pos, (NI32)(TMP6800));
...
static TNimNode* TMP6802[6];
static TNimNode* TMP6803[4];
NI TMP6805;
static char* NIM_CONST TMP6804[4] = {
"cmdEnd", 
"cmdArgument", 
"cmdLongoption", 
"cmdShortOption"};
static TNimNode TMP6793[12];
...
TMP6802[0] = &TMP6793[1];
TMP6793[1].kind = 1;
TMP6793[1].offset = offsetof(toptparser416606, Cmd);
TMP6793[1].typ = (&NTI143);
TMP6793[1].name = "cmd";
TMP6802[1] = &TMP6793[2];
TMP6793[2].kind = 1;
TMP6793[2].offset = offsetof(toptparser416606, Pos);
TMP6793[2].typ = (&NTI105);
TMP6793[2].name = "pos";
TMP6802[2] = &TMP6793[3];
TMP6793[3].kind = 1;
TMP6793[3].offset = offsetof(toptparser416606, Inshortstate);
TMP6793[3].typ = (&NTI132);
TMP6793[3].name = "inShortState";
TMP6802[3] = &TMP6793[4];
NTI416604.size = sizeof(NU8);
NTI416604.kind = 14;
NTI416604.base = 0;
NTI416604.flags = 3;
for (TMP6805 = 0; TMP6805 < 4; TMP6805++) {
TMP6793[TMP6805+5].kind = 1;
TMP6793[TMP6805+5].offset = TMP6805;
TMP6793[TMP6805+5].name = TMP6804[TMP6805];
TMP6803[TMP6805] = &TMP6793[TMP6805+5];
}
TMP6793[9].len = 4; TMP6793[9].kind = 2; TMP6793[9].sons = &TMP6803[0];
NTI416604.node = &TMP6793[9];
TMP6793[4].kind = 1;
TMP6793[4].offset = offsetof(toptparser416606, Kind);
TMP6793[4].typ = (&NTI416604);
TMP6793[4].name = "kind";
TMP6802[4] = &TMP6793[10];
TMP6793[10].kind = 1;
TMP6793[10].offset = offsetof(toptparser416606, Key);
TMP6793[10].typ = (&NTI143);
TMP6793[10].name = "key";
TMP6802[5] = &TMP6793[11];
TMP6793[11].kind = 1;
TMP6793[11].offset = offsetof(toptparser416606, Val);
TMP6793[11].typ = (&NTI143);
TMP6793[11].name = "val";
TMP6793[0].len = 6; TMP6793[0].kind = 2; TMP6793[0].sons = &TMP6802[0];
NTI416606.node = &TMP6793[0];
}
