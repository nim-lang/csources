...
N_NIMCALL(NI, parseword_420802)(NimStringDesc* s, NI i, NimStringDesc** w, TY108134 delim);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(NimStringDesc*, addChar)(NimStringDesc* s, NIM_CHAR c);
N_NIMCALL(void, handleshortoption_420882)(toptparser420606* p);
...
STRING_LITERAL(TMP6786, "", 0);
STRING_LITERAL(TMP6788, "", 0);
static NIM_CONST TY108134 TMP6789 = {
0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY108134 TMP6790 = {
...
N_NIMCALL(void, initoptparser_420618)(NimStringDesc* cmdline, toptparser420606* Result) {
	...
	LA3: ;
	{
		...
		unsureAsgnRef((void**) &(*Result).Cmd, copyString(((NimStringDesc*) &TMP6786)));
		i_420630 = 0;
		HEX3Atmp_420632 = 0;
		nimln(50, "parseopt.nim");
		HEX3Atmp_420632 = nosparamCount();
		...
		while (1) {
			...
			NimStringDesc* LOC9;
			nimln(1275, "system.nim");
			if (!(res_420634 <= HEX3Atmp_420632)) goto LA6;
			nimln(1274, "system.nim");
			i_420630 = res_420634;
			...
			nimln(51, "parseopt.nim");
			LOC8 = 0;
			LOC8 = nosparamStr(i_420630);
			LOC9 = 0;
			LOC9 = quoteifcontainswhite_81720(LOC8);
...
appendChar(LOC7, 32);
			...
			res_420634 = addInt(res_420634, 1);
		} LA6: ;
	}
	LA1: ;
...
N_NIMCALL(void, handleshortoption_420882)(toptparser420606* p) {
	...
	nimln(79, "parseopt.nim");
	{
		...
		i = parseword_420802((*p).Cmd, i, &(*p).Val, TMP6789);
	}
	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser420606* p) {
	...
	case 45:
	{
		...
		nimln(104, "parseopt.nim");
		{
			...
			i = parseword_420802((*p).Cmd, i, &(*p).Key, TMP6790);
			...
			nimln(109, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_420802((*p).Cmd, i, &(*p).Val, TMP6789);
			}
			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_420802((*p).Cmd, i, &(*p).Key, TMP6789);
	}
	break;
	}
	BeforeRet: ;
...
"cmdLongoption", 
"cmdShortOption"};
static TNimNode TMP6784[12];
NTI420606.size = sizeof(toptparser420606);
NTI420606.kind = 17;
NTI420606.base = (&NTI1009);
NTI420606.flags = 2;
TMP6793[0] = &TMP6784[1];
TMP6784[1].kind = 1;
TMP6784[1].offset = offsetof(toptparser420606, Cmd);
TMP6784[1].typ = (&NTI143);
TMP6784[1].name = "cmd";
TMP6793[1] = &TMP6784[2];
TMP6784[2].kind = 1;
TMP6784[2].offset = offsetof(toptparser420606, Pos);
TMP6784[2].typ = (&NTI105);
TMP6784[2].name = "pos";
TMP6793[2] = &TMP6784[3];
TMP6784[3].kind = 1;
TMP6784[3].offset = offsetof(toptparser420606, Inshortstate);
TMP6784[3].typ = (&NTI132);
TMP6784[3].name = "inShortState";
TMP6793[3] = &TMP6784[4];
NTI420604.size = sizeof(NU8);
NTI420604.kind = 14;
NTI420604.base = 0;
NTI420604.flags = 3;
for (TMP6796 = 0; TMP6796 < 4; TMP6796++) {
TMP6784[TMP6796+5].kind = 1;
TMP6784[TMP6796+5].offset = TMP6796;
TMP6784[TMP6796+5].name = TMP6795[TMP6796];
TMP6794[TMP6796] = &TMP6784[TMP6796+5];
}
TMP6784[9].len = 4; TMP6784[9].kind = 2; TMP6784[9].sons = &TMP6794[0];
NTI420604.node = &TMP6784[9];
TMP6784[4].kind = 1;
TMP6784[4].offset = offsetof(toptparser420606, Kind);
TMP6784[4].typ = (&NTI420604);
TMP6784[4].name = "kind";
TMP6793[4] = &TMP6784[10];
TMP6784[10].kind = 1;
TMP6784[10].offset = offsetof(toptparser420606, Key);
TMP6784[10].typ = (&NTI143);
TMP6784[10].name = "key";
TMP6793[5] = &TMP6784[11];
TMP6784[11].kind = 1;
TMP6784[11].offset = offsetof(toptparser420606, Val);
TMP6784[11].typ = (&NTI143);
TMP6784[11].name = "val";
TMP6784[0].len = 6; TMP6784[0].kind = 2; TMP6784[0].sons = &TMP6793[0];
NTI420606.node = &TMP6784[0];
}
