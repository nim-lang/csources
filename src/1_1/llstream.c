...
N_NIMCALL(NI, counttriples_163661)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1549 = addInt(i, 1);
			if ((NU)((NI32)(TMP1549)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI32)(TMP1549)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1550 = addInt(i, 2);
			if ((NU)((NI32)(TMP1550)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI32)(TMP1550)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
appendString((*s).S, ((NimStringDesc*) &TMP1553));
	...
	result = ((buflen <= (NI32)(TMP1554)) ? buflen : (NI32)(TMP1554));
...
N_NIMCALL(NI, llstreamread_163242)(tllstream163204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		result = ((buflen <= (NI32)(TMP1555)) ? buflen : (NI32)(TMP1555));
		nimln(136, "llstream.nim");
		{
			...
			if ((NU)((NI32)(TMP1556)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI32)(TMP1556)])), result);
...
N_NIMCALL(void, llstreamwrite_163268)(tllstream163204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			(*s).S = setLengthStr((*s).S, (NI32)(TMP1557));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1558 = addInt(0, (*s).Wr);
			if ((NU)((NI32)(TMP1558)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI32)(TMP1558)])), buf, buflen);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_163254)(tllstream163204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI32)(TMP1559));
			nimln(223, "llstream.nim");
			nimln(223, "llstream.nim");
			TMP1560 = addInt(i, 0);
			if ((NU)((NI32)(TMP1560)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_9317((*s).F, ((void*) (&result->data[(NI32)(TMP1560)])), 2048);
