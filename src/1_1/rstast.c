...
N_NIMCALL(trstnode275016*, lastson_275148)(trstnode275016* n) {
	...
	if ((NU)((NI32)(TMP3783)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP3783)];
	popFrame();
	return result;
}
...
appendString((*result), ind);
		...
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI32)(TMP3788), lvltochar_275244[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI32)(TMP3790), 45);
...
appendString((*result), ((NimStringDesc*) &TMP3793));
	...
	case ((NU8) 14):
	{
		...
		l = (((NI32)(TMP3794) >= 30) ? (NI32)(TMP3794) : 30);
...
appendString((*result), tmp);
		...
		TMP3796 = subInt((NI32)(TMP3795), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI32)(TMP3796), 32);
