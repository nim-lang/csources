...
N_NIMCALL(void, fillbuffer_164073)(tbaselexer164018* l) {
	...
	nimln(85, "nimlexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI32)(TMP1565)])), (NI32)(TMP1566));
	}
	LA11: ;
	...
	TMP1568 = mulInt((NI32)(TMP1567), 1);
	LOC13 = llstreamread_163242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI32)(TMP1568));
	TMP1569 = divInt(LOC13, 1);
	charsread = (NI32)(TMP1569);
	...
	nimln(91, "nimlexbase.nim");
	{
		...
		if (!(charsread < (NI32)(TMP1571))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI32)(TMP1573);
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				TMP1574 = mulInt((*l).Buflen, 1);
				LOC32 = realloc_4007(((void*) ((*l).Buf)), (NI32)(TMP1574));
				...
				nimln(110, "nimlexbase.nim");
				{
					...
					if (!!(((NI32)(TMP1575) == oldbuflen))) goto LA35;
					nimln(110, "nimlexbase.nim");
				...
				LOC37 = llstreamread_163242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI32)(TMP1577));
...
N_NIMCALL(void, openbaselexer_164027)(tbaselexer164018* l, tllstream163204* inputstream, NI buflen) {
	...
	LOC5 = alloc_4001((NI32)(TMP1587));
	(*l).Buf = ((NCSTRING) (LOC5));
	nimln(151, "nimlexbase.nim");
	nimln(151, "nimlexbase.nim");
	TMP1588 = subInt(buflen, 1);
	(*l).Sentinel = (NI32)(TMP1588);
...
N_NIMCALL(NI, getcolnumber_164046)(tbaselexer164018* l, NI pos) {
	...
	if ((NI32)(TMP1589) == (-2147483647 -1)) raiseOverflow();
	result = (NI32)abs((NI32)(TMP1589));
	popFrame();
	return result;
}
