	...
	case ((NU8) 3):
	{
		...
		nimln(26, "evaltempl.nim");
		{
			...
			LA8: ;
			{
				...
				nimln(40, "evaltempl.nim");
				LOC29 = 0;
				LOC29 = newsymnode_175096(x, (*templ).Info);
...
N_NIMCALL(tnode173647*, evaltemplateargs_249201)(tnode173647* n, tsym173677* s) {
	...
	nimln(86, "evaltempl.nim");
	{
		...
		if (!(f < a)) goto LA5;
		nimln(86, "evaltempl.nim");
		globalerror_132663((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP3373));
	}
	LA5: ;
	...
	while (1) {
		...
		nimln(91, "evaltempl.nim");
		{
			...
			localerror_132676((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP3373));
		}
		LA17: ;
...
N_NIMCALL(tnode173647*, evaltemplate_249280)(tnode173647* n, tsym173677* tmpl, tsym173677* gensymowner) {
	...
	nimln(100, "evaltempl.nim");
	{
		...
		globalerror_132663((*n).Info, ((NU16) 183), ((NimStringDesc*) &TMP3373));
	...
	body = getbody_213577(tmpl);
	nimln(112, "evaltempl.nim");
	{
		NIM_BOOL LOC7;
		nimln(112, "evaltempl.nim");
		LOC7 = isatom_178441(body);
		if (!LOC7) goto LA8;
		...
		LA13: ;
		{
			...
			globalerror_132663((*result).Info, ((NU16) 1), LOC16);
		}
		LA10: ;
	}
	goto LA5;
