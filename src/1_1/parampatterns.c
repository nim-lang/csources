...
N_NIMCALL(void, patternerror_273036)(tnode173647* n) {
	...
	localerror_132676((*n).Info, ((NU16) 1), LOC1);
	popFrame();
}
...
break;
		...
		LA51: ;
		{
			...
			nimln(793, "msgs.nim");
			{
				...
				nimln(793, "msgs.nim");
				LOC69 = 0;
				LOC69 = HEX24_132780(TMP3755);
				internalerror_132702(LOC69);
			}
			LA67: ;
			i_273283 = 0;
			...
			nimln(793, "msgs.nim");
			{
				...
				nimln(793, "msgs.nim");
				LOC81 = 0;
				LOC81 = HEX24_132780(TMP3757);
				internalerror_132702(LOC81);
			}
			LA79: ;
			i_273337 = 0;
			nimln(1281, "system.nim");
...
N_NIMCALL(tnode173647*, semnodekindconstraints_273363)(tnode173647* p) {
	...
	nimln(124, "parampatterns.nim");
	{
		...
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_132690((*p).Info, ((NimStringDesc*) &TMP3759));
		}
		LA14: ;
	}
	goto LA5;
...
N_NIMCALL(NU8, checkforsideeffects_273500)(tnode173647* n) {
	...
	case ((NU8) 32):
	{
		...
		nimln(143, "parampatterns.nim");
		{
			...
			LOC4 = isroutine_178367((*op).kindU.S4.Sym);
			LA5: ;
			if (!LOC4) goto LA6;
...
N_NIMCALL(NIM_BOOL, matchnodekinds_273914)(tnode173647* p, tnode173647* n) {
	...
	while (1) {
		...
		case ((NU8) 2):
		{
			...
			nimln(239, "parampatterns.nim");
			TMP3762 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3762)) > (NU)(64)) raiseIndexError();
			nimln(239, "parampatterns.nim");
			nimln(239, "parampatterns.nim");
			TMP3763 = subInt(sp, 1);
			if ((NU)((NI32)(TMP3763)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI32)(TMP3763))- 0];
			if (LOC4) goto LA5;
			nimln(239, "parampatterns.nim");
			TMP3764 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3764)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI32)(TMP3764))- 0];
			LA5: ;
			stack[((NI32)(TMP3762))- 0] = LOC4;
		...
		case ((NU8) 3):
		{
			...
			nimln(242, "parampatterns.nim");
			TMP3765 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3765)) > (NU)(64)) raiseIndexError();
			nimln(242, "parampatterns.nim");
			nimln(242, "parampatterns.nim");
			TMP3766 = subInt(sp, 1);
			if ((NU)((NI32)(TMP3766)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI32)(TMP3766))- 0];
			if (!(LOC7)) goto LA8;
			nimln(242, "parampatterns.nim");
			TMP3767 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3767)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI32)(TMP3767))- 0];
			LA8: ;
			stack[((NI32)(TMP3765))- 0] = LOC7;
		...
		case ((NU8) 4):
		{
			...
			nimln(244, "parampatterns.nim");
			TMP3768 = subInt(sp, 1);
			if ((NU)((NI32)(TMP3768)) > (NU)(64)) raiseIndexError();
			nimln(244, "parampatterns.nim");
			nimln(244, "parampatterns.nim");
			TMP3769 = subInt(sp, 1);
			if ((NU)((NI32)(TMP3769)) > (NU)(64)) raiseIndexError();
			stack[((NI32)(TMP3768))- 0] = !(stack[((NI32)(TMP3769))- 0]);
		}
		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(251, "parampatterns.nim");
			TMP3770 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3770)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3770)])), ((NU8) 0), ((NU8) 22)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			nimln(255, "parampatterns.nim");
			TMP3771 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3771)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3771)])), ((NU8) 0), ((NU8) 151)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
	...
	nimln(263, "parampatterns.nim");
	TMP3772 = subInt(sp, 1);
	if ((NU)((NI32)(TMP3772)) > (NU)(64)) raiseIndexError();
	result = stack[((NI32)(TMP3772))- 0];
	popFrame();
	return result;
}
