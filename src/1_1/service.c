...
extern tsocketimpl114806* stdoutsocket_131876;
...
appendString(LOC8, p.Val);
				...
				processswitch_146016(key, val, pass, gcmdlineinfo_131802);
			}
			goto LA4;
			LA6: ;
			{
				nimln(46, "service.nim");
				processswitch_146016(p.Key, p.Val, pass, gcmdlineinfo_131802);
			}
			LA4: ;
		}
		break;
	...
	nimln(59, "service.nim");
	{
		...
		nimln(60, "service.nim");
		{
			...
			rawmessage_132451(((NU16) 57), LOC37, 0);
		}
		LA35: ;
	}
	LA29: ;
...
N_NIMCALL(void, serve_422077)(TY422079 action) {
	...
	LA2: ;
	{
		...
		if (stdoutsocket_131876) nimGCunrefNoCycle(stdoutsocket_131876);
		stdoutsocket_131876 = (tsocketimpl114806*) newObjRC1((&NTI114808), sizeof(tsocketimpl114806));
		nimln(90, "service.nim");
		while (1) {
			NimStringDesc* LOC21;
			nimln(91, "service.nim");
			accept_118201(server, &stdoutsocket_131876);
			nimln(92, "service.nim");
			readline_122831(stdoutsocket_131876, &inp, -1);
			nimln(65, "service.nim");
			LOC21 = 0;
			...
			send_124204(stdoutsocket_131876, ((NimStringDesc*) &TMP6833));
			nimln(95, "service.nim");
			close_118264(stdoutsocket_131876);
		}
	}
	goto LA4;
	LA3: ;
