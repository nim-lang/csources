...
typedef N_CLOSURE_PTR(void, TMP455) (NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
...
N_NIMCALL(void, TMP449)(void* p, NI op);
...
STRING_LITERAL(TMP444, "RopeInvariant(result) ", 22);
STRING_LITERAL(TMP450, "not it.data == nil ", 19);
STRING_LITERAL(TMP451, "resultLen <= len(result) ", 25);
STRING_LITERAL(TMP452, "", 0);
STRING_LITERAL(TMP454, "not it == nil ", 14);
STRING_LITERAL(TMP457, "$", 1);
...
N_NIMCALL(trope126007*, torope_126058)(NimStringDesc* s) {
	...
	nimln(160, "ropes.nim");
	{
		...
		if (!!(LOC8)) goto LA9;
		nimln(160, "ropes.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP444));
	}
	LA9: ;
	popFrame();
	return result;
...
N_NIMCALL(void, ropeseqinsert_126403)(tropeseq126009** rs, trope126007* r, NI at) {
	...
	nimln(164, "ropes.nim");
	{
		...
		nimln(165, "ropes.nim");
		nimln(165, "ropes.nim");
		TMP445 = addInt(((NI) (at)), 1);
		(*rs) = (tropeseq126009*) setLengthSeq(&((*rs))->Sup, sizeof(trope126007*), ((NI) ((NI64)(TMP445))));
	}
	goto LA1;
	LA3: ;
	{
		...
		nimln(167, "ropes.nim");
		nimln(167, "ropes.nim");
		TMP446 = addInt(length, 1);
		(*rs) = (tropeseq126009*) setLengthSeq(&((*rs))->Sup, sizeof(trope126007*), (NI64)(TMP446));
	}
	LA1: ;
	i_126453 = 0;
	HEX3Atmp_126454 = 0;
	nimln(168, "ropes.nim");
	nimln(168, "ropes.nim");
	TMP447 = addInt(((NI) (at)), 1);
	HEX3Atmp_126454 = ((NI) ((NI64)(TMP447)));
	...
	while (1) {
		...
		nimln(169, "ropes.nim");
		TMP448 = subInt(i_126453, 1);
		if ((NU)((NI64)(TMP448)) >= (NU)((*rs)->Sup.len)) raiseIndexError();
		asgnRefNoCycle((void**) &(*rs)->data[i_126453], (*rs)->data[(NI64)(TMP448)]);
...
N_NIMCALL(void, newrecropetostr_126460)(NimStringDesc** result, NI* resultlen, trope126007* r) {
	...
	while (1) {
		...
		nimln(182, "ropes.nim");
		{
			...
			nimln(182, "ropes.nim");
			hiddenraiseassert_71620(((NimStringDesc*) &TMP451));
		}
		LA10: ;
	} LA2: ;
	popFrame();
...
N_NIMCALL(NimStringDesc*, ropetostr_126075)(trope126007* p) {
	...
	nimln(185, "ropes.nim");
	{
		...
		nimln(186, "ropes.nim");
		result = copyString(((NimStringDesc*) &TMP452));
	}
	goto LA1;
	LA3: ;
	{
...
N_NIMCALL(trope126007*, con_126020)(trope126007* a, trope126007* b) {
	...
	LA6: ;
	{
		...
		nimln(197, "ropes.nim");
		nimln(197, "ropes.nim");
		TMP453 = addInt((*a).Length, (*b).Length);
		(*result).Length = (NI64)(TMP453);
		nimln(198, "ropes.nim");
	...
	while (1) {
		...
		while (1) {
			...
			nimln(226, "ropes.nim");
			{
				...
				nimln(226, "ropes.nim");
				hiddenraiseassert_71620(((NimStringDesc*) &TMP454));
			}
			LA6: ;
		} LA3: ;
		nimln(227, "ropes.nim");
...
N_NIMCALL(void, writerope_127407)(trope126007* head, NimStringDesc* filename, NIM_BOOL usewarning) {
	...
	{
		nimln(236, "ropes.nim");
		errorhandler_126108.ClEnv? errorhandler_126108.ClPrc(((NU8) 0), filename, usewarning, errorhandler_126108.ClEnv) : ((TMP455)(errorhandler_126108.ClPrc))(((NU8) 0), filename, usewarning);
	}
	LA1: ;
	popFrame();
}
...
N_NIMCALL(trope126007*, ropef_126079)(NimStringDesc* frmt, trope126007** args, NI argsLen0) {
	...
	while (1) {
		...
		nimln(247, "ropes.nim");
		nimln(247, "ropes.nim");
		TMP456 = subInt(length, 1);
		if (!(i <= (NI64)(TMP456))) goto LA1;
		nimln(248, "ropes.nim");
		{
			nimln(248, "ropes.nim");
			...
			{
				nimln(252, "ropes.nim");
				app_126046(&result, ((NimStringDesc*) &TMP457));
				nimln(253, "ropes.nim");
				i = addInt(i, 1);
			}
			break;
			...
			case 48 ... 57:
			{
				...
				while (1) {
					...
					nimln(261, "ropes.nim");
					if ((NU)(i) > (NU)(frmt->Sup.len)) raiseIndexError();
					TMP459 = addInt((NI64)(TMP458), ((NI) (((NU8)(frmt->data[i])))));
					TMP460 = subInt((NI64)(TMP459), 48);
					j = (NI64)(TMP460);
					nimln(262, "ropes.nim");
					i = addInt(i, 1);
					nimln(263, "ropes.nim");
					{
						...
						nimln(263, "ropes.nim");
						nimln(263, "ropes.nim");
						TMP461 = addInt(length, 0);
						TMP462 = subInt((NI64)(TMP461), 1);
						LOC12 = ((NI64)(TMP462) < i);
						if (LOC12) goto LA13;
						nimln(263, "ropes.nim");
				...
				nimln(265, "ropes.nim");
				{
					...
					nimln(265, "ropes.nim");
					nimln(265, "ropes.nim");
					TMP463 = addInt((argsLen0-1), 1);
					if (!((NI64)(TMP463) < j)) goto LA18;
					nimln(266, "ropes.nim");
					nimln(266, "ropes.nim");
					LOC20 = 0;
					LOC20 = nimIntToStr(j);
					errorhandler_126108.ClEnv? errorhandler_126108.ClPrc(((NU8) 1), LOC20, NIM_FALSE, errorhandler_126108.ClEnv) : ((TMP464)(errorhandler_126108.ClPrc))(((NU8) 1), LOC20, NIM_FALSE);
				}
				goto LA16;
				LA18: ;
				{
					...
					nimln(268, "ropes.nim");
					TMP465 = subInt(j, 1);
					if ((NU)((NI64)(TMP465)) >= (NU)(argsLen0)) raiseIndexError();
					app_126040(&result, args[(NI64)(TMP465)]);
				}
				LA16: ;
			}
			break;
			...
			default:
			{
				...
				errorhandler_126108.ClEnv? errorhandler_126108.ClPrc(((NU8) 1), LOC25, NIM_FALSE, errorhandler_126108.ClEnv) : ((TMP466)(errorhandler_126108.ClPrc))(((NU8) 1), LOC25, NIM_FALSE);
			}
			break;
			}
		}
		...
		nimln(281, "ropes.nim");
		{
			...
			nimln(281, "ropes.nim");
			TMP467 = subInt(i, 1);
			if (!(start <= (NI64)(TMP467))) goto LA34;
			nimln(282, "ropes.nim");
			nimln(282, "ropes.nim");
			nimln(282, "ropes.nim");
			TMP468 = subInt(i, 1);
			LOC36 = 0;
			LOC36 = copyStrLast(frmt, start, (NI64)(TMP468));
...
N_NIMCALL(NIM_BOOL, auxropeequalsfile_127631)(trope126007* r, FILE** bin, void* buf) {
	...
	nimln(300, "ropes.nim");
	{
		...
		nimln(301, "ropes.nim");
		{
			...
			nimln(302, "ropes.nim");
			errorhandler_126108.ClEnv? errorhandler_126108.ClPrc(((NU8) 2), (*r).Data, NIM_FALSE, errorhandler_126108.ClEnv) : ((TMP469)(errorhandler_126108.ClPrc))(((NU8) 2), (*r).Data, NIM_FALSE);
			nimln(303, "ropes.nim");
			goto BeforeRet;
		}
		LA7: ;
...
N_NIMCALL(NI32, crcfromropeaux_127656)(trope126007* r, NI32 startval) {
	...
	nimln(324, "ropes.nim");
	{
		...
		nimln(326, "ropes.nim");
		nimln(326, "ropes.nim");
		TMP470 = subInt((*r).Data->Sup.len, 1);
		HEX3Atmp_127670 = (NI64)(TMP470);
		nimln(1274, "system.nim");
		res_127672 = 0;
		nimln(1275, "system.nim");
		while (1) {
...
static TNimNode* TMP442[4];
static TNimNode TMP362[5];
...
TMP442[0] = &TMP362[1];
TMP362[1].kind = 1;
TMP362[1].offset = offsetof(trope126007, Left);
TMP362[1].typ = (&NTI126005);
TMP362[1].name = "left";
TMP442[1] = &TMP362[2];
TMP362[2].kind = 1;
TMP362[2].offset = offsetof(trope126007, Right);
TMP362[2].typ = (&NTI126005);
TMP362[2].name = "right";
TMP442[2] = &TMP362[3];
TMP362[3].kind = 1;
TMP362[3].offset = offsetof(trope126007, Length);
TMP362[3].typ = (&NTI105);
TMP362[3].name = "length";
TMP442[3] = &TMP362[4];
TMP362[4].kind = 1;
TMP362[4].offset = offsetof(trope126007, Data);
TMP362[4].typ = (&NTI143);
TMP362[4].name = "data";
TMP362[0].len = 4; TMP362[0].kind = 2; TMP362[0].sons = &TMP442[0];
NTI126007.node = &TMP362[0];
NTI126005.size = sizeof(trope126007*);
NTI126005.kind = 22;
NTI126005.base = (&NTI126007);
NTI126005.flags = 2;
NTI126005.marker = TMP443;
NTI126009.size = sizeof(tropeseq126009*);
NTI126009.kind = 24;
NTI126009.base = (&NTI126005);
NTI126009.flags = 2;
NTI126009.marker = TMP449;
}
