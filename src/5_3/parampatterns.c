...
N_NIMCALL(tnode169647*, semnodekindconstraints_269363)(tnode169647* p) {
	...
	nimln(124, "parampatterns.nim");
	{
		...
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_129687((*p).Info, ((NimStringDesc*) &TMP3765));
		}
		LA14: ;
	}
	goto LA5;
...
N_NIMCALL(NIM_BOOL, matchnodekinds_269914)(tnode169647* p, tnode169647* n) {
	...
	while (1) {
		...
		case ((NU8) 2):
		{
			...
			LOC4 = stack[((NI64)(TMP3769))- 0];
			if (LOC4) goto LA5;
			nimln(239, "parampatterns.nim");
			TMP3770 = subInt(sp, 2);
			if ((NU)((NI64)(TMP3770)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI64)(TMP3770))- 0];
			LA5: ;
			stack[((NI64)(TMP3768))- 0] = LOC4;
		...
		case ((NU8) 3):
		{
			...
			LOC7 = stack[((NI64)(TMP3772))- 0];
			if (!(LOC7)) goto LA8;
			nimln(242, "parampatterns.nim");
			TMP3773 = subInt(sp, 2);
			if ((NU)((NI64)(TMP3773)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI64)(TMP3773))- 0];
			LA8: ;
			stack[((NI64)(TMP3771))- 0] = LOC7;
		...
		case ((NU8) 4):
		{
			...
			nimln(244, "parampatterns.nim");
			TMP3774 = subInt(sp, 1);
			if ((NU)((NI64)(TMP3774)) > (NU)(64)) raiseIndexError();
			nimln(244, "parampatterns.nim");
			nimln(244, "parampatterns.nim");
			TMP3775 = subInt(sp, 1);
			if ((NU)((NI64)(TMP3775)) > (NU)(64)) raiseIndexError();
			stack[((NI64)(TMP3774))- 0] = !(stack[((NI64)(TMP3775))- 0]);
		}
		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(251, "parampatterns.nim");
			TMP3776 = addInt(pc, 1);
			if ((NU)((NI64)(TMP3776)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3776)])), ((NU8) 0), ((NU8) 22)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			nimln(255, "parampatterns.nim");
			TMP3777 = addInt(pc, 1);
			if ((NU)((NI64)(TMP3777)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3777)])), ((NU8) 0), ((NU8) 151)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
	...
	nimln(263, "parampatterns.nim");
	TMP3778 = subInt(sp, 1);
	if ((NU)((NI64)(TMP3778)) > (NU)(64)) raiseIndexError();
	result = stack[((NI64)(TMP3778))- 0];
	popFrame();
	return result;
}
