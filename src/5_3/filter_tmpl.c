...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP2531, "\012", 1);
STRING_LITERAL(TMP2532, "", 0);
STRING_LITERAL(TMP2533, "end", 3);
STRING_LITERAL(TMP2534, "#end", 4);
static NIM_CONST TY104134 TMP2536 = {
...
STRING_LITERAL(TMP2540, "\\x", 2);
STRING_LITERAL(TMP2541, "\\\\", 2);
STRING_LITERAL(TMP2542, "\\\'", 2);
STRING_LITERAL(TMP2543, "\\\"", 2);
STRING_LITERAL(TMP2544, "}", 1);
STRING_LITERAL(TMP2545, "$", 1);
STRING_LITERAL(TMP2546, "\\n\"", 3);
STRING_LITERAL(TMP2547, "subschar", 8);
STRING_LITERAL(TMP2548, "metachar", 8);
STRING_LITERAL(TMP2549, "emit", 4);
STRING_LITERAL(TMP2550, "result.add", 10);
STRING_LITERAL(TMP2551, "conc", 4);
STRING_LITERAL(TMP2552, " & ", 3);
STRING_LITERAL(TMP2553, "tostring", 8);
...
N_NIMCALL(void, newline_193038)(ttmplparser193015* p) {
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		nimln(42, "filter_tmpl.nim");
		llstreamwrite_159258((*p).Outp, ((NimStringDesc*) &TMP2531));
	}
	LA4: ;
...
N_NIMCALL(void, parseline_193151)(ttmplparser193015* p) {
	...
	LA6: ;
	{
		...
		keyw = copyString(((NimStringDesc*) &TMP2532));
		...
		case ((NU8) 20):
		{
			...
			LA19: ;
			{
				...
				localerror_129673((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP2533));
			}
			LA17: ;
		...
		case ((NU8) 24):
		{
			...
			nimln(99, "filter_tmpl.nim");
			nimln(99, "filter_tmpl.nim");
			TMP2535 = subInt((*p).Indent, 2);
			LOC27 = 0;
			LOC27 = nsuRepeatChar((NI64)(TMP2535), 32);
		...
		case ((NU8) 61):
		{
			...
			nimln(104, "filter_tmpl.nim");
			{
				...
				nimln(104, "filter_tmpl.nim");
				nimln(104, "filter_tmpl.nim");
				LOC34 = contains_78741((*p).X, TMP2536);
				if (!!(LOC34)) goto LA35;
	...
	LA9: ;
	{
		...
		case ((NU8) 1):
		{
			...
			nimln(123, "filter_tmpl.nim");
			nimln(123, "filter_tmpl.nim");
			TMP2537 = addInt((*p).Indent, 2);
			LOC42 = 0;
			LOC42 = nsuRepeatChar((NI64)(TMP2537), 32);
				...
				nimln(150, "filter_tmpl.nim");
				{
					...
					case 123:
					{
						...
						while (1) {
							...
							case 0:
							{
								...
								localerror_129673((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP2544));
					...
					default:
					{
						...
						LA76: ;
						{
							...
							localerror_129673((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP2545));
						}
						LA74: ;
					}
					break;
...
N_NIMCALL(tllstream159204*, filtertmpl_193005)(tllstream159204* stdin_193007, NimStringDesc* filename, tnode169647* call) {
	...
	p.Outp = llstreamopen_159218(((NimStringDesc*) &TMP2532));
	nimln(209, "filter_tmpl.nim");
	p.Inp = stdin_193007;
	nimln(210, "filter_tmpl.nim");
	p.Subschar = chararg_192014(call, ((NimStringDesc*) &TMP2547), 1, 36);
	nimln(211, "filter_tmpl.nim");
	p.Nimdirective = chararg_192014(call, ((NimStringDesc*) &TMP2548), 2, 35);
	nimln(212, "filter_tmpl.nim");
	p.Emit = strarg_192021(call, ((NimStringDesc*) &TMP2549), 3, ((NimStringDesc*) &TMP2550));
	nimln(213, "filter_tmpl.nim");
	p.Conc = strarg_192021(call, ((NimStringDesc*) &TMP2551), 4, ((NimStringDesc*) &TMP2552));
	nimln(214, "filter_tmpl.nim");
	p.Tostr = strarg_192021(call, ((NimStringDesc*) &TMP2553), 5, ((NimStringDesc*) &TMP2545));
	...
	while (1) {
		...
		nimln(217, "filter_tmpl.nim");
		TMP2554 = addInt(p.Info.Line, ((NI16) 1));
		if (TMP2554 < -32768 || TMP2554 > 32767) raiseOverflow();
		p.Info.Line = (NI16)(TMP2554);
