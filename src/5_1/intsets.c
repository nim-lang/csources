...
static N_INLINE(NIM_BOOL, mustrehash_166052)(NI length, NI counter) {
	...
	LOC5 = ((NI32)(TMP1859) < (NI32)(TMP1860));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
...
static N_INLINE(NI, nexttry_166207)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1862 = mulInt(5, h);
	TMP1863 = addInt((NI32)(TMP1862), 1);
	result = (NI)((NI32)(TMP1863) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, intsetenlarge_166604)(tintset166041* t) {
	...
	TMP1867 = mulInt((NI32)(TMP1866), 2);
	TMP1868 = subInt((NI32)(TMP1867), 1);
	(*t).Max = (NI32)(TMP1868);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1869 = addInt((*t).Max, 1);
	n = (ttrunkseq166039*) newSeq((&NTI166039), (NI32)(TMP1869));
	i_166630 = 0;
...
N_NIMCALL(ttrunk166037*, intsetput_166659)(tintset166041* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = mustrehash_166052((NI32)(TMP1873), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
