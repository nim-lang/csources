...
STRING_LITERAL(TMP2947, "tab", 3);
STRING_LITERAL(TMP2948, "int", 3);
STRING_LITERAL(TMP2949, "int8", 4);
STRING_LITERAL(TMP2950, "int16", 5);
STRING_LITERAL(TMP2951, "int32", 5);
STRING_LITERAL(TMP2952, "int64", 5);
STRING_LITERAL(TMP2953, "uint", 4);
STRING_LITERAL(TMP2954, "uint8", 5);
STRING_LITERAL(TMP2955, "uint16", 6);
STRING_LITERAL(TMP2956, "uint32", 6);
STRING_LITERAL(TMP2957, "uint64", 6);
STRING_LITERAL(TMP2958, "float", 5);
STRING_LITERAL(TMP2959, "float32", 7);
STRING_LITERAL(TMP2960, "float64", 7);
STRING_LITERAL(TMP2961, "float128", 8);
STRING_LITERAL(TMP2962, "bool", 4);
STRING_LITERAL(TMP2963, "char", 4);
STRING_LITERAL(TMP2964, "string", 6);
STRING_LITERAL(TMP2965, "cstring", 7);
STRING_LITERAL(TMP2966, "pointer", 7);
STRING_LITERAL(TMP2967, "request for typekind: ", 22);
STRING_LITERAL(TMP2968, "wanted: ", 8);
STRING_LITERAL(TMP2969, " got: ", 6);
STRING_LITERAL(TMP2970, "type not found: ", 16);
static NIM_CONST TY169850 TMP2971 = {
0xE0, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2972, "intVal", 6);
STRING_LITERAL(TMP2973, "invalid int size", 16);
...
N_NIMCALL(tsym169677*, getsyssym_212034)(NimStringDesc* name) {
	...
	if (!(((64 &(1<<(((*systemmodule_212011).Kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2947));
	nimln(39, "magicsys.nim");
	LOC1 = 0;
...
appendString(LOC26, ((NimStringDesc*) &TMP2967));
...
appendString(LOC31, ((NimStringDesc*) &TMP2968));
appendString(LOC31, reprEnum(kind, (&NTI169234)));
appendString(LOC31, ((NimStringDesc*) &TMP2969));
...
appendString(LOC36, ((NimStringDesc*) &TMP2970));
...
N_NIMCALL(ttype169681*, getintlittype_212292)(tnode169647* literal) {
	...
	if (!(((TMP2971[(*literal).Kind/8] &(1<<((*literal).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2972));
...
N_NIMCALL(void, setintlittype_212395)(tnode169647* result) {
	...
	default:
	{
		...
		internalerror_129690((*result).Info, ((NimStringDesc*) &TMP2973));
	}
	break;
	}
	popFrame();
