...
static N_INLINE(trope126007**, s_337159)(tcproc337024* p, NU8 s) {
	...
	nimln(124, "cgendata.nim");
	nimln(124, "cgendata.nim");
	TMP5269 = subInt((*p).Blocks->Sup.len, 1);
	if ((NU)((NI32)(TMP5269)) >= (NU)((*p).Blocks->Sup.len)) raiseIndexError();
	result = &(*p).Blocks->data[(NI32)(TMP5269)].Sections[(s)- 0];
	popFrame();
	return result;
}
...
static TNimNode* TMP5261[25];
static TNimNode* TMP5262[14];
static TNimNode* TMP5263[6];
static TNimNode TMP5259[48];
NTI337028.size = sizeof(tcgen337028);
NTI337028.kind = 17;
NTI337028.base = (&NTI218003);
TMP5261[0] = &TMP5259[1];
TMP5259[1].kind = 1;
TMP5259[1].offset = offsetof(tcgen337028, Module);
TMP5259[1].typ = (&NTI169645);
TMP5259[1].name = "module";
TMP5261[1] = &TMP5259[2];
TMP5259[2].kind = 1;
TMP5259[2].offset = offsetof(tcgen337028, Filename);
TMP5259[2].typ = (&NTI143);
TMP5259[2].name = "filename";
TMP5261[2] = &TMP5259[3];
...
NTI337012.flags = 2;
TMP5259[3].kind = 1;
TMP5259[3].offset = offsetof(tcgen337028, S);
TMP5259[3].typ = (&NTI337012);
TMP5259[3].name = "s";
TMP5261[3] = &TMP5259[4];
TMP5259[4].kind = 1;
TMP5259[4].offset = offsetof(tcgen337028, Preventstacktrace);
TMP5259[4].typ = (&NTI132);
TMP5259[4].name = "PreventStackTrace";
TMP5261[4] = &TMP5259[5];
TMP5259[5].kind = 1;
TMP5259[5].offset = offsetof(tcgen337028, Usesthreadvars);
TMP5259[5].typ = (&NTI132);
TMP5259[5].name = "usesThreadVars";
TMP5261[5] = &TMP5259[6];
TMP5259[6].kind = 1;
TMP5259[6].offset = offsetof(tcgen337028, Framedeclared);
TMP5259[6].typ = (&NTI132);
TMP5259[6].name = "FrameDeclared";
TMP5261[6] = &TMP5259[7];
TMP5259[7].kind = 1;
TMP5259[7].offset = offsetof(tcgen337028, Isheaderfile);
TMP5259[7].typ = (&NTI132);
TMP5259[7].name = "isHeaderFile";
TMP5261[7] = &TMP5259[8];
TMP5259[8].kind = 1;
TMP5259[8].offset = offsetof(tcgen337028, Cfilename);
TMP5259[8].typ = (&NTI143);
TMP5259[8].name = "cfilename";
TMP5261[8] = &TMP5259[9];
TMP5259[9].kind = 1;
TMP5259[9].offset = offsetof(tcgen337028, Typecache);
TMP5259[9].typ = (&NTI169693);
TMP5259[9].name = "typeCache";
TMP5261[9] = &TMP5259[10];
TMP5259[10].kind = 1;
TMP5259[10].offset = offsetof(tcgen337028, Forwtypecache);
TMP5259[10].typ = (&NTI169693);
TMP5259[10].name = "forwTypeCache";
TMP5261[10] = &TMP5259[11];
TMP5259[11].kind = 1;
TMP5259[11].offset = offsetof(tcgen337028, Declaredthings);
TMP5259[11].typ = (&NTI166041);
TMP5259[11].name = "declaredThings";
TMP5261[11] = &TMP5259[12];
TMP5259[12].kind = 1;
TMP5259[12].offset = offsetof(tcgen337028, Declaredprotos);
TMP5259[12].typ = (&NTI166041);
TMP5259[12].name = "declaredProtos";
TMP5261[12] = &TMP5259[13];
TMP5259[13].kind = 1;
TMP5259[13].offset = offsetof(tcgen337028, Headerfiles);
TMP5259[13].typ = (&NTI100017);
TMP5259[13].name = "headerFiles";
TMP5261[13] = &TMP5259[14];
TMP5259[14].kind = 1;
TMP5259[14].offset = offsetof(tcgen337028, Typeinfomarker);
TMP5259[14].typ = (&NTI166041);
TMP5259[14].name = "typeInfoMarker";
TMP5261[14] = &TMP5259[15];
NTI337024.size = sizeof(tcproc337024);
NTI337024.kind = 18;
NTI337024.base = 0;
TMP5262[0] = &TMP5259[17];
TMP5259[17].kind = 1;
TMP5259[17].offset = offsetof(tcproc337024, Prc);
TMP5259[17].typ = (&NTI169645);
TMP5259[17].name = "prc";
TMP5262[1] = &TMP5259[18];
TMP5259[18].kind = 1;
TMP5259[18].offset = offsetof(tcproc337024, Beforeretneeded);
TMP5259[18].typ = (&NTI132);
TMP5259[18].name = "BeforeRetNeeded";
TMP5262[2] = &TMP5259[19];
TMP5259[19].kind = 1;
TMP5259[19].offset = offsetof(tcproc337024, Threadvaraccessed);
TMP5259[19].typ = (&NTI132);
TMP5259[19].name = "ThreadVarAccessed";
TMP5262[3] = &TMP5259[20];
TMP5259[20].kind = 1;
TMP5259[20].offset = offsetof(tcproc337024, Nestedtrystmts);
TMP5259[20].typ = (&NTI169641);
TMP5259[20].name = "nestedTryStmts";
TMP5262[4] = &TMP5259[21];
TMP5259[21].kind = 1;
TMP5259[21].offset = offsetof(tcproc337024, Inexceptblock);
TMP5259[21].typ = (&NTI105);
TMP5259[21].name = "inExceptBlock";
TMP5262[5] = &TMP5259[22];
TMP5259[22].kind = 1;
TMP5259[22].offset = offsetof(tcproc337024, Labels);
TMP5259[22].typ = (&NTI1005);
TMP5259[22].name = "labels";
TMP5262[6] = &TMP5259[23];
NTI337022.size = sizeof(tblock337022);
NTI337022.kind = 18;
NTI337022.base = 0;
NTI337022.flags = 2;
TMP5263[0] = &TMP5259[25];
TMP5259[25].kind = 1;
TMP5259[25].offset = offsetof(tblock337022, Id);
TMP5259[25].typ = (&NTI105);
TMP5259[25].name = "id";
TMP5263[1] = &TMP5259[26];
TMP5259[26].kind = 1;
TMP5259[26].offset = offsetof(tblock337022, Label);
TMP5259[26].typ = (&NTI126005);
TMP5259[26].name = "label";
TMP5263[2] = &TMP5259[27];
NTI337016.size = sizeof(tcprocsections337016);
NTI337016.kind = 16;
NTI337016.base = (&NTI126005);
NTI337016.flags = 2;
TMP5259[27].kind = 1;
TMP5259[27].offset = offsetof(tblock337022, Sections);
TMP5259[27].typ = (&NTI337016);
TMP5259[27].name = "sections";
TMP5263[3] = &TMP5259[28];
TMP5259[28].kind = 1;
TMP5259[28].offset = offsetof(tblock337022, Isloop);
TMP5259[28].typ = (&NTI132);
TMP5259[28].name = "isLoop";
TMP5263[4] = &TMP5259[29];
TMP5259[29].kind = 1;
TMP5259[29].offset = offsetof(tblock337022, Nestedtrystmts);
TMP5259[29].typ = (&NTI109);
TMP5259[29].name = "nestedTryStmts";
TMP5263[5] = &TMP5259[30];
TMP5259[30].kind = 1;
TMP5259[30].offset = offsetof(tblock337022, Framelen);
TMP5259[30].typ = (&NTI109);
TMP5259[30].name = "frameLen";
TMP5259[24].len = 6; TMP5259[24].kind = 2; TMP5259[24].sons = &TMP5263[0];
NTI337022.node = &TMP5259[24];
NTI337089.size = sizeof(TY337089*);
NTI337089.kind = 24;
NTI337089.base = (&NTI337022);
NTI337089.flags = 2;
NTI337089.marker = TMP5264;
TMP5259[23].kind = 1;
TMP5259[23].offset = offsetof(tcproc337024, Blocks);
TMP5259[23].typ = (&NTI337089);
TMP5259[23].name = "blocks";
TMP5262[7] = &TMP5259[31];
TMP5259[31].kind = 1;
TMP5259[31].offset = offsetof(tcproc337024, Breakidx);
TMP5259[31].typ = (&NTI105);
TMP5259[31].name = "breakIdx";
TMP5262[8] = &TMP5259[32];
TMP5259[32].kind = 1;
TMP5259[32].offset = offsetof(tcproc337024, Options);
TMP5259[32].typ = (&NTI105103);
TMP5259[32].name = "options";
TMP5262[9] = &TMP5259[33];
TMP5259[33].kind = 1;
TMP5259[33].offset = offsetof(tcproc337024, Maxframelen);
TMP5259[33].typ = (&NTI105);
TMP5259[33].name = "maxFrameLen";
TMP5262[10] = &TMP5259[34];
TMP5259[34].kind = 1;
TMP5259[34].offset = offsetof(tcproc337024, Module);
TMP5259[34].typ = (&NTI337018);
TMP5259[34].name = "module";
TMP5262[11] = &TMP5259[35];
TMP5259[35].kind = 1;
TMP5259[35].offset = offsetof(tcproc337024, Withinloop);
TMP5259[35].typ = (&NTI105);
TMP5259[35].name = "withinLoop";
TMP5262[12] = &TMP5259[36];
TMP5259[36].kind = 1;
TMP5259[36].offset = offsetof(tcproc337024, Gcframeid);
TMP5259[36].typ = (&NTI1005);
TMP5259[36].name = "gcFrameId";
TMP5262[13] = &TMP5259[37];
TMP5259[37].kind = 1;
TMP5259[37].offset = offsetof(tcproc337024, Gcframetype);
TMP5259[37].typ = (&NTI126005);
TMP5259[37].name = "gcFrameType";
TMP5259[16].len = 14; TMP5259[16].kind = 2; TMP5259[16].sons = &TMP5262[0];
NTI337024.node = &TMP5259[16];
NTI337020.size = sizeof(tcproc337024*);
NTI337020.kind = 22;
NTI337020.base = (&NTI337024);
NTI337020.marker = TMP5265;
TMP5259[15].kind = 1;
TMP5259[15].offset = offsetof(tcgen337028, Initproc);
TMP5259[15].typ = (&NTI337020);
TMP5259[15].name = "initProc";
TMP5261[15] = &TMP5259[38];
TMP5259[38].kind = 1;
TMP5259[38].offset = offsetof(tcgen337028, Preinitproc);
TMP5259[38].typ = (&NTI337020);
TMP5259[38].name = "preInitProc";
TMP5261[16] = &TMP5259[39];
TMP5259[39].kind = 1;
TMP5259[39].offset = offsetof(tcgen337028, Typestack);
TMP5259[39].typ = (&NTI169679);
TMP5259[39].name = "typeStack";
TMP5261[17] = &TMP5259[40];
TMP5259[40].kind = 1;
TMP5259[40].offset = offsetof(tcgen337028, Datacache);
TMP5259[40].typ = (&NTI169705);
TMP5259[40].name = "dataCache";
TMP5261[18] = &TMP5259[41];
TMP5259[41].kind = 1;
TMP5259[41].offset = offsetof(tcgen337028, Forwardedprocs);
TMP5259[41].typ = (&NTI169649);
TMP5259[41].name = "forwardedProcs";
TMP5261[19] = &TMP5259[42];
TMP5259[42].kind = 1;
TMP5259[42].offset = offsetof(tcgen337028, Typenodes);
TMP5259[42].typ = (&NTI105);
TMP5259[42].name = "typeNodes";
TMP5261[20] = &TMP5259[43];
TMP5259[43].kind = 1;
TMP5259[43].offset = offsetof(tcgen337028, Nimtypes);
TMP5259[43].typ = (&NTI105);
TMP5259[43].name = "nimTypes";
TMP5261[21] = &TMP5259[44];
TMP5259[44].kind = 1;
TMP5259[44].offset = offsetof(tcgen337028, Typenodesname);
TMP5259[44].typ = (&NTI126005);
TMP5259[44].name = "typeNodesName";
TMP5261[22] = &TMP5259[45];
TMP5259[45].kind = 1;
TMP5259[45].offset = offsetof(tcgen337028, Nimtypesname);
TMP5259[45].typ = (&NTI126005);
TMP5259[45].name = "nimTypesName";
TMP5261[23] = &TMP5259[46];
TMP5259[46].kind = 1;
TMP5259[46].offset = offsetof(tcgen337028, Labels);
TMP5259[46].typ = (&NTI1005);
TMP5259[46].name = "labels";
TMP5261[24] = &TMP5259[47];
NTI337122.size = sizeof(TY337122);
NTI337122.kind = 16;
NTI337122.base = (&NTI126005);
NTI337122.flags = 2;
TMP5259[47].kind = 1;
TMP5259[47].offset = offsetof(tcgen337028, Extensionloaders);
TMP5259[47].typ = (&NTI337122);
TMP5259[47].name = "extensionLoaders";
TMP5259[0].len = 25; TMP5259[0].kind = 2; TMP5259[0].sons = &TMP5261[0];
NTI337028.node = &TMP5259[0];
NTI337018.size = sizeof(tcgen337028*);
NTI337018.kind = 22;
NTI337018.base = (&NTI337028);
NTI337018.marker = TMP5267;
NTI337130.size = sizeof(TY337130*);
NTI337130.kind = 24;
NTI337130.base = (&NTI337018);
NTI337130.flags = 2;
NTI337130.marker = TMP5268;
}
