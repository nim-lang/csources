...
N_NIMCALL(NimStringDesc*, removetrailingdirsep_105410)(NimStringDesc* path) {
	...
	nimln(200, "options.nim");
	{
		...
		if ((NU)((NI32)(TMP323)) > (NU)(path->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(path->data[(NI32)(TMP323)]) == (NU8)(47));
		LA4: ;
		if (!LOC3) goto LA5;
		...
		result = copyStrLast(path, 0, (NI32)(TMP324));
	}
	goto LA1;
	LA5: ;
	{
...
N_NIMCALL(void, libcandidates_105544)(NimStringDesc* s, TY9355** dest) {
	...
	nimln(267, "options.nim");
	TMP333 = addInt(le, 1);
	ri = nsuFindChar(s, 41, (NI32)(TMP333));
	nimln(268, "options.nim");
	{
		...
		nimln(269, "options.nim");
		TMP334 = subInt(le, 1);
		prefix = copyStrLast(s, 0, (NI32)(TMP334));
		nimln(270, "options.nim");
		nimln(270, "options.nim");
		nimln(270, "options.nim");
		TMP335 = addInt(ri, 1);
		suffix = copyStr(s, (NI32)(TMP335));
		middle_105556 = 0;
		HEX3Atmp_105573 = 0;
		...
		nimln(271, "options.nim");
		TMP337 = subInt(ri, 1);
		HEX3Atmp_105573 = copyStrLast(s, (NI32)(TMP336), (NI32)(TMP337));
		...
		nimln(249, "strutils.nim");
		{
			...
			while (1) {
				...
				middle_105556 = copyStrLast(HEX3Atmp_105573, first_105577, (NI32)(TMP339));
...
N_NIMCALL(NimStringDesc*, canondynlibname_105582)(NimStringDesc* s) {
	...
	nimln(279, "options.nim");
	{
		...
		result = copyStrLast(s, start, (NI32)(TMP343));
	}
	goto LA7;
	LA9: ;
	{
...
static TNimNode* TMP1932[22];
NI TMP1934;
static char* NIM_CONST TMP1933[22] = {
"optNone", 
"optObjCheck", 
"optFieldCheck", 
"optRangeCheck", 
...
"optImplicitStatic", 
"optPatterns"};
static TNimNode* TMP2928[20];
NI TMP2930;
static char* NIM_CONST TMP2929[20] = {
"cmdNone", 
"cmdCompileToC", 
"cmdCompileToCpp", 
"cmdCompileToOC", 
...
"cmdInteractive", 
"cmdRun"};
static TNimNode* TMP6995[32];
NI TMP6997;
static char* NIM_CONST TMP6996[32] = {
"gloptNone", 
"optForceFullMake", 
"optDeadCodeElim", 
"optListCmd", 
...
NTI105008.base = 0;
NTI105008.flags = 3;
for (TMP1934 = 0; TMP1934 < 22; TMP1934++) {
TMP249[TMP1934+0].kind = 1;
TMP249[TMP1934+0].offset = TMP1934;
TMP249[TMP1934+0].name = TMP1933[TMP1934];
TMP1932[TMP1934] = &TMP249[TMP1934+0];
}
TMP249[22].len = 22; TMP249[22].kind = 2; TMP249[22].sons = &TMP1932[0];
...
NTI105016.base = 0;
NTI105016.flags = 3;
for (TMP2930 = 0; TMP2930 < 20; TMP2930++) {
TMP249[TMP2930+24].kind = 1;
TMP249[TMP2930+24].offset = TMP2930;
TMP249[TMP2930+24].name = TMP2929[TMP2930];
TMP2928[TMP2930] = &TMP249[TMP2930+24];
}
TMP249[44].len = 20; TMP249[44].kind = 2; TMP249[44].sons = &TMP2928[0];
NTI105016.node = &TMP249[44];
NTI105012.size = sizeof(NU8);
NTI105012.kind = 14;
NTI105012.base = 0;
NTI105012.flags = 3;
for (TMP6997 = 0; TMP6997 < 32; TMP6997++) {
TMP249[TMP6997+45].kind = 1;
TMP249[TMP6997+45].offset = TMP6997;
TMP249[TMP6997+45].name = TMP6996[TMP6997];
TMP6995[TMP6997] = &TMP249[TMP6997+45];
}
TMP249[77].len = 32; TMP249[77].kind = 2; TMP249[77].sons = &TMP6995[0];
