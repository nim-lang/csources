...
STRING_LITERAL(TMP1076, "overflow", 8);
...
N_NIMCALL(NI, rawparseint_74996)(NimStringDesc* s, NI64* b, NI start) {
	...
	nimln(200, "parseutils.nim");
	{
		...
		while (1) {
			...
			nimln(203, "parseutils.nim");
			nimln(203, "parseutils.nim");
			TMP1071 = mulInt64((*b), 10);
			nimln(203, "parseutils.nim");
			nimln(203, "parseutils.nim");
			if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
			TMP1072 = subInt(((NI) (((NU8)(s->data[i])))), 48);
			TMP1073 = subInt64((NI64)(TMP1071), ((NI64) ((NI64)(TMP1072))));
			(*b) = (NI64)(TMP1073);
		...
		nimln(206, "parseutils.nim");
		TMP1074 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP1074);
		nimln(207, "parseutils.nim");
		nimln(207, "parseutils.nim");
		TMP1075 = subInt(i, start);
		result = (NI64)(TMP1075);
	}
	LA10: ;
	popFrame();
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	nimln(228, "parseutils.nim");
	{
		...
		LOC9 = 0;
		LOC9 = (*e_75128).Sup.Sup.Sup.message; (*e_75128).Sup.Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1076));
...
N_NIMCALL(NI, npuParseBiggestFloat)(NimStringDesc* s, NF64* number, NI start) {
	...
	nimln(261, "parseutils.nim");
	{
		...
		nimln(262, "parseutils.nim");
		{
			...
			LOC16 = ((NU8)(s->data[(NI64)(TMP1760)]) == (NU8)(65));
			if (LOC16) goto LA17;
			nimln(262, "parseutils.nim");
			nimln(262, "parseutils.nim");
			TMP1761 = addInt(i, 1);
			if ((NU)((NI64)(TMP1761)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC16 = ((NU8)(s->data[(NI64)(TMP1761)]) == (NU8)(97));
			LA17: ;
			if (!LOC16) goto LA18;
			nimln(263, "parseutils.nim");
			{
				...
				LOC22 = ((NU8)(s->data[(NI64)(TMP1762)]) == (NU8)(78));
				if (LOC22) goto LA23;
				nimln(263, "parseutils.nim");
				nimln(263, "parseutils.nim");
				TMP1763 = addInt(i, 2);
				if ((NU)((NI64)(TMP1763)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC22 = ((NU8)(s->data[(NI64)(TMP1763)]) == (NU8)(110));
				LA23: ;
				if (!LOC22) goto LA24;
				nimln(264, "parseutils.nim");
				{
					...
					if (!!((((NU8)(s->data[(NI64)(TMP1764)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI64)(TMP1764)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI64)(TMP1764)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI64)(TMP1764)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI64)(TMP1764)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI64)(TMP1764)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI64)(TMP1764)])) == ((NU8)(95))))) goto LA28;
					...
					nimln(266, "parseutils.nim");
					TMP1765 = addInt(i, 3);
					TMP1766 = subInt((NI64)(TMP1765), start);
					result = (NI64)(TMP1766);
					goto BeforeRet;
				}
				LA28: ;
	...
	nimln(268, "parseutils.nim");
	{
		...
		nimln(269, "parseutils.nim");
		{
			...
			LOC38 = ((NU8)(s->data[(NI64)(TMP1767)]) == (NU8)(78));
			if (LOC38) goto LA39;
			nimln(269, "parseutils.nim");
			nimln(269, "parseutils.nim");
			TMP1768 = addInt(i, 1);
			if ((NU)((NI64)(TMP1768)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC38 = ((NU8)(s->data[(NI64)(TMP1768)]) == (NU8)(110));
			LA39: ;
			if (!LOC38) goto LA40;
			nimln(270, "parseutils.nim");
			{
				...
				nimln(270, "parseutils.nim");
				TMP1769 = addInt(i, 2);
				if ((NU)((NI64)(TMP1769)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC44 = ((NU8)(s->data[(NI64)(TMP1769)]) == (NU8)(70));
				if (LOC44) goto LA45;
				nimln(270, "parseutils.nim");
				nimln(270, "parseutils.nim");
				TMP1770 = addInt(i, 2);
				if ((NU)((NI64)(TMP1770)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC44 = ((NU8)(s->data[(NI64)(TMP1770)]) == (NU8)(102));
				LA45: ;
				if (!LOC44) goto LA46;
				nimln(271, "parseutils.nim");
				{
					...
					if (!!((((NU8)(s->data[(NI64)(TMP1771)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI64)(TMP1771)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI64)(TMP1771)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI64)(TMP1771)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI64)(TMP1771)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI64)(TMP1771)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI64)(TMP1771)])) == ((NU8)(95))))) goto LA50;
					...
					nimln(273, "parseutils.nim");
					TMP1772 = addInt(i, 3);
					TMP1773 = subInt((NI64)(TMP1772), start);
					result = (NI64)(TMP1773);
					goto BeforeRet;
				}
				LA50: ;
	...
	while (1) {
		...
		nimln(278, "parseutils.nim");
		if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
		TMP1774 = subInt(((NI) (((NU8)(s->data[i])))), 48);
		(*number) = ((NF64) (((((NF) ((*number))) * 1.0000000000000000e+01) + ((double) (((NI) ((NI64)(TMP1774))))))));
	...
	nimln(282, "parseutils.nim");
	{
		...
		while (1) {
			...
			nimln(288, "parseutils.nim");
			if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
			TMP1775 = subInt(((NI) (((NU8)(s->data[i])))), 48);
			(*number) = ((NF64) (((((NF) ((*number))) * 1.0000000000000000e+01) + ((double) (((NI) ((NI64)(TMP1775))))))));
	...
	nimln(296, "parseutils.nim");
	{
		...
		while (1) {
			...
			nimln(306, "parseutils.nim");
			nimln(306, "parseutils.nim");
			TMP1776 = mulInt(exponent, 10);
			nimln(306, "parseutils.nim");
			if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
			TMP1777 = addInt((NI64)(TMP1776), ((NI) (((NU8)(s->data[i])))));
			TMP1778 = subInt((NI64)(TMP1777), 48);
			exponent = (NI64)(TMP1778);
