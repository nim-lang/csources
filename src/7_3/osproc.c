...
N_NIMCALL(void, createstream_137003)(tstream133630** stream, NI32* handle, NU8 filemode);
...
N_NIMCALL(void, createfdset_137076)(fd_set* fd, TY136003* s, NI* m);
N_NIMCALL(void, pruneprocessset_137130)(TY136003** s, fd_set* fd);
...
STRING_LITERAL(TMP904, "0 < n ", 6);
STRING_LITERAL(TMP916, "", 0);
STRING_LITERAL(TMP917, "\012", 1);
STRING_LITERAL(TMP919, " ", 1);
STRING_LITERAL(TMP931, "=", 1);
STRING_LITERAL(TMP942, "setpgid call failed: ", 21);
STRING_LITERAL(TMP944, "sh", 2);
STRING_LITERAL(TMP945, "-c", 2);
NIM_CONST TY105434 TMP943 = {((NimStringDesc*) &TMP944),
((NimStringDesc*) &TMP945)}
;
STRING_LITERAL(TMP946, "execve call failed: ", 20);
NIM_CONST TY71482 TMP954 = {((NimStringDesc*) &TMP916),
-1}
;
...
N_NIMCALL(tprocess135203*, startcmd_135246)(NimStringDesc* command, NU8 options) {
	...
	nimln(85, "osproc.nim");
	nimln(85, "osproc.nim");
	TMP900 = subInt(c->Sup.len, 1);
	a = (TY9355*) newSeq((&NTI9355), (NI64)(TMP900));
	i_135291 = 0;
	HEX3Atmp_135293 = 0;
	nimln(86, "osproc.nim");
	nimln(86, "osproc.nim");
	nimln(86, "osproc.nim");
	TMP901 = subInt(c->Sup.len, 1);
	HEX3Atmp_135293 = (NI64)(TMP901);
	...
	while (1) {
		...
		nimln(86, "osproc.nim");
		nimln(86, "osproc.nim");
		TMP902 = subInt(i_135291, 1);
		if ((NU)((NI64)(TMP902)) >= (NU)(a->Sup.len)) raiseIndexError();
		if ((NU)(i_135291) >= (NU)(c->Sup.len)) raiseIndexError();
		LOC2 = 0;
		LOC2 = a->data[(NI64)(TMP902)]; a->data[(NI64)(TMP902)] = copyStringRC1(c->data[i_135291]);
	...
	result = nospstartProcess(c->data[0], ((NimStringDesc*) &TMP903), a->data, a->Sup.len, NIM_NIL, options);
	popFrame();
	return result;
}
...
N_NIMCALL(NI, nospexecProcesses)(NimStringDesc** cmds, NI cmdsLen0, NU8 options_135624, NI n) {
	...
	nimln(181, "osproc.nim");
	{
		...
		if (!!((0 < n))) goto LA3;
		nimln(181, "osproc.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP904));
	}
	LA3: ;
...
N_NIMCALL(NimStringDesc*, nospexecProcess)(NimStringDesc* command, NU8 options) {
	...
	result = copyString(((NimStringDesc*) &TMP916));
...
appendString(result, ((NimStringDesc*) &TMP917));
		}
		goto LA2;
		LA5: ;
		{
...
N_NIMCALL(NimStringDesc*, addcmdargs_136404)(NimStringDesc* command, NimStringDesc** args, NI argsLen0) {
	...
	while (1) {
		...
		result = resizeString(result, 1);
appendString(result, ((NimStringDesc*) &TMP919));
...
N_NIMCALL(NCSTRING*, tocstringarray_136424)(NimStringDesc** b, NI bLen0, NimStringDesc** a, NI aLen0) {
	...
	nimln(495, "osproc.nim");
	nimln(495, "osproc.nim");
	TMP920 = addInt(aLen0, bLen0);
	TMP921 = addInt((NI64)(TMP920), 1);
	TMP922 = mulInt((NI64)(TMP921), 8);
	LOC1 = alloc0_4004((NI64)(TMP922));
	...
	while (1) {
		...
		TMP923 = addInt(b[i_136448]->Sup.len, 1);
		LOC3 = alloc_4001((NI64)(TMP923));
		...
		nimln(498, "osproc.nim");
		if ((NU)(i_136448) >= (NU)(bLen0)) raiseIndexError();
		TMP924 = addInt(b[i_136448]->Sup.len, 1);
		memcpy(((void*) (result[(i_136448)- 0])), ((void*) (b[i_136448]->data)), (NI64)(TMP924));
		nimln(1284, "system.nim");
	...
	while (1) {
		...
		nimln(500, "osproc.nim");
		nimln(500, "osproc.nim");
		TMP925 = addInt(i_136456, bLen0);
		if ((NU)((NI64)(TMP925)) > (NU)(50000)) raiseIndexError();
		nimln(500, "osproc.nim");
		nimln(500, "osproc.nim");
		nimln(500, "osproc.nim");
		if ((NU)(i_136456) >= (NU)(aLen0)) raiseIndexError();
		TMP926 = addInt(a[i_136456]->Sup.len, 1);
		LOC5 = alloc_4001((NI64)(TMP926));
		result[((NI64)(TMP925))- 0] = ((NCSTRING) (LOC5));
		nimln(501, "osproc.nim");
		nimln(501, "osproc.nim");
		nimln(501, "osproc.nim");
		TMP927 = addInt(i_136456, bLen0);
		if ((NU)((NI64)(TMP927)) > (NU)(50000)) raiseIndexError();
		if ((NU)(i_136456) >= (NU)(aLen0)) raiseIndexError();
		nimln(501, "osproc.nim");
		nimln(501, "osproc.nim");
		if ((NU)(i_136456) >= (NU)(aLen0)) raiseIndexError();
		TMP928 = addInt(a[i_136456]->Sup.len, 1);
		memcpy(((void*) (result[((NI64)(TMP927))- 0])), ((void*) (a[i_136456]->data)), (NI64)(TMP928));
		nimln(1284, "system.nim");
...
N_NIMCALL(NCSTRING*, tocstringarray_136482)(tstringtable103609* t) {
	...
	nimln(504, "osproc.nim");
	LOC1 = nstlen(t);
	TMP929 = addInt(LOC1, 1);
	TMP930 = mulInt((NI64)(TMP929), 8);
	LOC2 = alloc0_4004((NI64)(TMP930));
...
appendString(LOC8, ((NimStringDesc*) &TMP931));
...
N_NIMCALL(NCSTRING*, envtocstringarray_136515)(void) {
	...
	while (1) {
		...
		if ((NU)(i_136552) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		nimln(1035, "os.nim");
		TMP934 = subInt(p_136558, 1);
		key_136519 = copyStrLast(environment_95235->data[i_136552], 0, (NI64)(TMP934));
		nimln(1036, "os.nim");
		nimln(1036, "os.nim");
		if ((NU)(i_136552) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		nimln(1036, "os.nim");
		TMP935 = addInt(p_136558, 1);
		val_136520 = copyStr(environment_95235->data[i_136552], (NI64)(TMP935));
	...
	nimln(515, "osproc.nim");
	nimln(515, "osproc.nim");
	TMP936 = addInt(counter, 1);
	TMP937 = mulInt((NI64)(TMP936), 8);
	LOC2 = alloc0_4004((NI64)(TMP937));
	result = ((NCSTRING*) (LOC2));
	...
	while (1) {
		...
		if ((NU)(i_136568) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		nimln(1035, "os.nim");
		TMP938 = subInt(p_136574, 1);
		key_136535 = copyStrLast(environment_95235->data[i_136568], 0, (NI64)(TMP938));
		nimln(1036, "os.nim");
		nimln(1036, "os.nim");
		if ((NU)(i_136568) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		nimln(1036, "os.nim");
		TMP939 = addInt(p_136574, 1);
		val_136536 = copyStr(environment_95235->data[i_136568], (NI64)(TMP939));
		nimln(518, "osproc.nim");
		nimln(518, "osproc.nim");
		LOC4 = 0;
		LOC4 = rawNewString(key_136535->Sup.len + val_136536->Sup.len + 1);
appendString(LOC4, key_136535);
appendString(LOC4, ((NimStringDesc*) &TMP931));
appendString(LOC4, val_136536);
		...
		nimln(519, "osproc.nim");
		nimln(519, "osproc.nim");
		TMP940 = addInt(x->Sup.len, 1);
		LOC5 = alloc_4001((NI64)(TMP940));
		...
		nimln(520, "osproc.nim");
		nimln(520, "osproc.nim");
		TMP941 = addInt(x->Sup.len, 1);
		memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI64)(TMP941));
...
appendString(LOC67, ((NimStringDesc*) &TMP942));
appendString(LOC67, LOC69);
		...
		nimln(607, "osproc.nim");
		{
			...
			a = tocstringarray_136424(LOC78, 1, args, argsLen0);
			...
			LA81: ;
			{
				NCSTRING* LOC85;
				int LOC86;
				nimln(612, "osproc.nim");
				nimln(612, "osproc.nim");
				nimln(612, "osproc.nim");
				LOC85 = tocstringarray_136482(env);
		...
		LA76: ;
		{
			...
			NCSTRING* a;
			TY105474 LOC88;
			nimln(614, "osproc.nim");
			x = addcmdargs_136404(command, args, argsLen0);
			nimln(615, "osproc.nim");
			memset((void*)LOC88, 0, sizeof(LOC88));
			LOC88[0] = copyString(x);
			a = tocstringarray_136424(TMP943, 2, LOC88, 1);
			nimln(616, "osproc.nim");
			{
				int LOC93;
				nimln(616, "osproc.nim");
				if (!(env == NIM_NIL)) goto LA91;
				nimln(617, "osproc.nim");
				nimln(617, "osproc.nim");
			...
			LA91: ;
			{
				...
				nimln(619, "osproc.nim");
				nimln(619, "osproc.nim");
				LOC95 = tocstringarray_136482(env);
...
appendString(LOC97, ((NimStringDesc*) &TMP946));
appendString(LOC97, LOC99);
	...
	nimln(623, "osproc.nim");
	{
		...
		nimln(624, "osproc.nim");
		LOC104 = 0;
		LOC104 = nsuJoinSep(args, argsLen0, ((NimStringDesc*) &TMP919));
		printf("%s%s%s\012", (command)->data, (((NimStringDesc*) &TMP919))->data, (LOC104)->data);
	}
	LA102: ;
...
N_NIMCALL(tstream133630*, nospinputStream)(tprocess135203* p) {
	...
	nimln(698, "osproc.nim");
	{
		...
		createstream_137003(&(*p).Instream, &(*p).Inputhandle, ((NU8) 1));
	}
	LA3: ;
...
N_NIMCALL(tstream133630*, nospoutputStream)(tprocess135203* p) {
	...
	nimln(703, "osproc.nim");
	{
		...
		createstream_137003(&(*p).Outstream, &(*p).Outputhandle, ((NU8) 0));
	}
	LA3: ;
...
N_NIMCALL(tstream133630*, nosperrorStream)(tprocess135203* p) {
	...
	nimln(708, "osproc.nim");
	{
		...
		createstream_137003(&(*p).Errstream, &(*p).Errorhandle, ((NU8) 0));
	}
	LA3: ;
...
N_NIMCALL(void, createfdset_137076)(fd_set* fd, TY136003* s, NI* m) {
	...
	while (1) {
		nimln(1367, "system.nim");
		nimln(1367, "system.nim");
		if (!(i_137127 < s->Sup.len)) goto LA1;
		nimln(1368, "system.nim");
		if ((NU)(i_137127) >= (NU)(s->Sup.len)) raiseIndexError();
		i_137119 = s->data[i_137127];
		nimln(720, "osproc.nim");
		nimln(720, "osproc.nim");
		(*m) = (((*m) >= ((NI) ((*i_137119).Outputhandle))) ? (*m) : ((NI) ((*i_137119).Outputhandle)));
		nimln(721, "osproc.nim");
		FD_SET((*i_137119).Outputhandle, fd);
		nimln(1369, "system.nim");
		i_137127 = addInt(i_137127, 1);
	} LA1: ;
	popFrame();
}
...
N_NIMCALL(void, pruneprocessset_137130)(TY136003** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(727, "osproc.nim");
		{
			...
			nimln(728, "osproc.nim");
			TMP950 = subInt(l, 1);
			if ((NU)((NI64)(TMP950)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRefNoCycle((void**) &(*s)->data[i], (*s)->data[(NI64)(TMP950)]);
...
N_NIMCALL(NI, select_136301)(TY136003** readfds, NI timeout) {
	...
	nimln(737, "osproc.nim");
	TMP951 = mulInt(timeout, 1000);
	tv.tv_usec = (NI64)(TMP951);
	memset((void*)&rd, 0, sizeof(rd));
	nimln(740, "osproc.nim");
	m = 0;
	nimln(741, "osproc.nim");
	createfdset_137076(&rd, (*readfds), &m);
	nimln(743, "osproc.nim");
	{
		...
		nimln(744, "osproc.nim");
		TMP952 = addInt(m, 1);
		LOC5 = select(((int)chckRange((NI64)(TMP952), ((int) (-2147483647 -1)), ((int) 2147483647))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		nimln(746, "osproc.nim");
		TMP953 = addInt(m, 1);
		LOC7 = select(((int)chckRange((NI64)(TMP953), ((int) (-2147483647 -1)), ((int) 2147483647))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
	nimln(748, "osproc.nim");
	pruneprocessset_137130(readfds, &rd);
	popFrame();
	return result;
}
...
N_NIMCALL(void, execcmdex_137402)(NimStringDesc* command, NU8 options, TY71482* Result) {
	...
	unsureAsgnRef((void**) &(*Result).Field0, copyString(TMP954.Field0));
	(*Result).Field1 = TMP954.Field1;
...
appendString((*Result).Field0, ((NimStringDesc*) &TMP917));
		}
		goto LA2;
		LA5: ;
		{
...
static TNimNode* TMP905[8];
static TNimNode TMP887[9];
...
TMP905[0] = &TMP887[1];
TMP887[1].kind = 1;
TMP887[1].offset = offsetof(tprocess135203, Inputhandle);
TMP887[1].typ = (&NTI9008);
TMP887[1].name = "inputHandle";
TMP905[1] = &TMP887[2];
TMP887[2].kind = 1;
TMP887[2].offset = offsetof(tprocess135203, Outputhandle);
TMP887[2].typ = (&NTI9008);
TMP887[2].name = "outputHandle";
TMP905[2] = &TMP887[3];
TMP887[3].kind = 1;
TMP887[3].offset = offsetof(tprocess135203, Errorhandle);
TMP887[3].typ = (&NTI9008);
TMP887[3].name = "errorHandle";
TMP905[3] = &TMP887[4];
TMP887[4].kind = 1;
TMP887[4].offset = offsetof(tprocess135203, Instream);
TMP887[4].typ = (&NTI133628);
TMP887[4].name = "inStream";
TMP905[4] = &TMP887[5];
TMP887[5].kind = 1;
TMP887[5].offset = offsetof(tprocess135203, Outstream);
TMP887[5].typ = (&NTI133628);
TMP887[5].name = "outStream";
TMP905[5] = &TMP887[6];
TMP887[6].kind = 1;
TMP887[6].offset = offsetof(tprocess135203, Errstream);
TMP887[6].typ = (&NTI133628);
TMP887[6].name = "errStream";
TMP905[6] = &TMP887[7];
TMP887[7].kind = 1;
TMP887[7].offset = offsetof(tprocess135203, Id);
TMP887[7].typ = (&NTI84455);
TMP887[7].name = "id";
TMP905[7] = &TMP887[8];
TMP887[8].kind = 1;
TMP887[8].offset = offsetof(tprocess135203, Exitcode);
TMP887[8].typ = (&NTI3701);
TMP887[8].name = "exitCode";
TMP887[0].len = 8; TMP887[0].kind = 2; TMP887[0].sons = &TMP905[0];
NTI135203.node = &TMP887[0];
NTI135205.size = sizeof(tprocess135203*);
NTI135205.kind = 22;
NTI135205.base = (&NTI135203);
NTI135205.flags = 2;
NTI135205.marker = TMP907;
NTI136003.size = sizeof(TY136003*);
NTI136003.kind = 24;
NTI136003.base = (&NTI135205);
NTI136003.flags = 2;
NTI136003.marker = TMP908;
}
