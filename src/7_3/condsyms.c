...
STRING_LITERAL(TMP861, "true", 4);
STRING_LITERAL(TMP862, "false", 5);
STRING_LITERAL(TMP863, "nimrod", 6);
STRING_LITERAL(TMP864, "nimhygiene", 10);
STRING_LITERAL(TMP865, "niminheritable", 14);
STRING_LITERAL(TMP866, "nimmixin", 8);
STRING_LITERAL(TMP867, "nimeffects", 10);
STRING_LITERAL(TMP868, "nimbabel", 8);
STRING_LITERAL(TMP869, "nimsuperops", 11);
STRING_LITERAL(TMP870, "x86", 3);
STRING_LITERAL(TMP871, "itanium", 7);
STRING_LITERAL(TMP872, "x8664", 5);
STRING_LITERAL(TMP873, "msdos", 5);
STRING_LITERAL(TMP874, "mswindows", 9);
STRING_LITERAL(TMP875, "win32", 5);
STRING_LITERAL(TMP876, "unix", 4);
STRING_LITERAL(TMP877, "posix", 5);
STRING_LITERAL(TMP878, "sunos", 5);
STRING_LITERAL(TMP879, "bsd", 3);
STRING_LITERAL(TMP880, "macintosh", 9);
STRING_LITERAL(TMP881, "cpu", 3);
extern NIM_CONST TY123460 cpu_123459;
extern NIM_CONST TY123455 endiantostr_123454;
extern NIM_CONST TY123060 os_123059;
STRING_LITERAL(TMP884, "emulatedthreadvars", 18);
...
N_NIMCALL(void, definesymbol_132006)(NimStringDesc* symbol) {
	...
	nstPut(gsymbols_132003, symbol, ((NimStringDesc*) &TMP861));
	popFrame();
}
...
N_NIMCALL(void, undefsymbol_132011)(NimStringDesc* symbol) {
	...
	nstPut(gsymbols_132003, symbol, ((NimStringDesc*) &TMP862));
	popFrame();
}
...
N_NIMCALL(NIM_BOOL, isdefined_132016)(NimStringDesc* symbol) {
	...
	nimln(26, "condsyms.nim");
	{
		...
		result = eqStrings(LOC6, ((NimStringDesc*) &TMP861));
	}
	LA4: ;
	popFrame();
	return result;
...
N_NIMCALL(NI, countdefinedsymbols_132041)(void) {
	...
	while (1) {
		...
		nimln(41, "strtabs.nim");
		{
			...
			{
				nimln(38, "condsyms.nim");
				if (!eqStrings(val_132045, ((NimStringDesc*) &TMP861))) goto LA8;
				nimln(38, "condsyms.nim");
...
N_NIMCALL(void, initdefines_132067)(void) {
	...
	case ((NU8) 7):
	{
		...
		definesymbol_132006(((NimStringDesc*) &TMP878));
	...
	case ((NU8) 11):
	{
		...
		definesymbol_132006(((NimStringDesc*) &TMP879));
	...
	case ((NU8) 18):
	{
		...
		definesymbol_132006(((NimStringDesc*) &TMP880));
	}
	break;
	case ((NU8) 19):
	{
...
appendString(LOC13, ((NimStringDesc*) &TMP881));
appendString(LOC13, LOC14);
	...
	nimln(87, "condsyms.nim");
	{
		...
		definesymbol_132006(((NimStringDesc*) &TMP884));
	}
	LA18: ;
	popFrame();
}
