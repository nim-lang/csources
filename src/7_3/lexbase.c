...
N_NIMCALL(void, fillbuffer_382070)(tbaselexer382014* l) {
	...
	nimln(80, "lexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP6602)])), (NI64)(TMP6603));
	}
	LA11: ;
	...
	TMP6605 = mulInt((NI64)(TMP6604), 1);
	LOC13 = readdata_133730((*l).Input, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP6605));
	TMP6606 = divInt(LOC13, 1);
	charsread = (NI64)(TMP6606);
	...
	nimln(86, "lexbase.nim");
	{
		...
		if (!(charsread < (NI64)(TMP6608))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI64)(TMP6610);
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				TMP6611 = mulInt((*l).Buflen, 1);
				LOC32 = realloc_4007(((void*) ((*l).Buf)), (NI64)(TMP6611));
				...
				nimln(105, "lexbase.nim");
				{
					...
					if (!!(((NI64)(TMP6612) == oldbuflen))) goto LA35;
					nimln(105, "lexbase.nim");
				...
				LOC37 = readdata_133730((*l).Input, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP6614));
				TMP6615 = divInt(LOC37, 1);
				charsread = (NI64)(TMP6615);
...
N_NIMCALL(void, open_382024)(tbaselexer382014* l, tstream133630* input, NI buflen) {
	...
	LOC9 = alloc_4001((NI64)(TMP6625));
	(*l).Buf = ((NCSTRING) (LOC9));
	nimln(148, "lexbase.nim");
	nimln(148, "lexbase.nim");
	TMP6626 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP6626);
...
N_NIMCALL(NI, getcolnumber_382043)(tbaselexer382014* l, NI pos) {
	...
	if ((NI64)(TMP6627) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP6627));
	popFrame();
	return result;
}
