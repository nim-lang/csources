...
typedef N_CLOSURE_PTR(void, TMP458) (NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
typedef N_CLOSURE_PTR(void, TMP467) (NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
typedef N_CLOSURE_PTR(void, TMP469) (NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
typedef N_CLOSURE_PTR(void, TMP472) (NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
...
N_NIMCALL(void, TMP452)(void* p, NI op);
...
STRING_LITERAL(TMP447, "RopeInvariant(result) ", 22);
STRING_LITERAL(TMP453, "not it.data == nil ", 19);
STRING_LITERAL(TMP454, "resultLen <= len(result) ", 25);
STRING_LITERAL(TMP455, "", 0);
STRING_LITERAL(TMP457, "not it == nil ", 14);
...
N_NIMCALL(trope126007*, torope_126058)(NimStringDesc* s) {
	...
	nimln(160, "ropes.nim");
	{
		...
		if (!!(LOC8)) goto LA9;
		nimln(160, "ropes.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP447));
	}
	LA9: ;
	popFrame();
	return result;
...
N_NIMCALL(void, ropeseqinsert_126403)(tropeseq126009** rs, trope126007* r, NI at) {
	...
	nimln(164, "ropes.nim");
	{
		...
		nimln(165, "ropes.nim");
		nimln(165, "ropes.nim");
		TMP448 = addInt(((NI) (at)), 1);
		(*rs) = (tropeseq126009*) setLengthSeq(&((*rs))->Sup, sizeof(trope126007*), ((NI) ((NI64)(TMP448))));
	}
	goto LA1;
	LA3: ;
	{
		...
		nimln(167, "ropes.nim");
		nimln(167, "ropes.nim");
		TMP449 = addInt(length, 1);
		(*rs) = (tropeseq126009*) setLengthSeq(&((*rs))->Sup, sizeof(trope126007*), (NI64)(TMP449));
	}
	LA1: ;
	i_126453 = 0;
	HEX3Atmp_126454 = 0;
	nimln(168, "ropes.nim");
	nimln(168, "ropes.nim");
	TMP450 = addInt(((NI) (at)), 1);
	HEX3Atmp_126454 = ((NI) ((NI64)(TMP450)));
	...
	while (1) {
		...
		nimln(169, "ropes.nim");
		TMP451 = subInt(i_126453, 1);
		if ((NU)((NI64)(TMP451)) >= (NU)((*rs)->Sup.len)) raiseIndexError();
		asgnRefNoCycle((void**) &(*rs)->data[i_126453], (*rs)->data[(NI64)(TMP451)]);
...
N_NIMCALL(NimStringDesc*, ropetostr_126075)(trope126007* p) {
	...
	nimln(185, "ropes.nim");
	{
		...
		nimln(186, "ropes.nim");
		result = copyString(((NimStringDesc*) &TMP455));
	}
	goto LA1;
	LA3: ;
	{
...
N_NIMCALL(trope126007*, con_126020)(trope126007* a, trope126007* b) {
	...
	LA6: ;
	{
		...
		nimln(197, "ropes.nim");
		nimln(197, "ropes.nim");
		TMP456 = addInt((*a).Length, (*b).Length);
		(*result).Length = (NI64)(TMP456);
		nimln(198, "ropes.nim");
	...
	while (1) {
		...
		while (1) {
			...
			nimln(226, "ropes.nim");
			{
				...
				nimln(226, "ropes.nim");
				hiddenraiseassert_71620(((NimStringDesc*) &TMP457));
			}
			LA6: ;
		} LA3: ;
		nimln(227, "ropes.nim");
...
N_NIMCALL(void, writerope_127407)(trope126007* head, NimStringDesc* filename, NIM_BOOL usewarning) {
	...
	{
		nimln(236, "ropes.nim");
		errorhandler_126108.ClEnv? errorhandler_126108.ClPrc(((NU8) 0), filename, usewarning, errorhandler_126108.ClEnv) : ((TMP458)(errorhandler_126108.ClPrc))(((NU8) 0), filename, usewarning);
	}
	LA1: ;
	popFrame();
}
...
N_NIMCALL(trope126007*, ropef_126079)(NimStringDesc* frmt, trope126007** args, NI argsLen0) {
	...
	while (1) {
		...
		nimln(247, "ropes.nim");
		nimln(247, "ropes.nim");
		TMP459 = subInt(length, 1);
		if (!(i <= (NI64)(TMP459))) goto LA1;
		nimln(248, "ropes.nim");
		{
			nimln(248, "ropes.nim");
			...
			{
				nimln(252, "ropes.nim");
				app_126046(&result, ((NimStringDesc*) &TMP460));
				nimln(253, "ropes.nim");
				i = addInt(i, 1);
			}
			break;
			...
			case 48 ... 57:
			{
				...
				while (1) {
					...
					nimln(261, "ropes.nim");
					if ((NU)(i) > (NU)(frmt->Sup.len)) raiseIndexError();
					TMP462 = addInt((NI64)(TMP461), ((NI) (((NU8)(frmt->data[i])))));
					TMP463 = subInt((NI64)(TMP462), 48);
					j = (NI64)(TMP463);
					nimln(262, "ropes.nim");
					i = addInt(i, 1);
					nimln(263, "ropes.nim");
					{
						...
						nimln(263, "ropes.nim");
						nimln(263, "ropes.nim");
						TMP464 = addInt(length, 0);
						TMP465 = subInt((NI64)(TMP464), 1);
						LOC12 = ((NI64)(TMP465) < i);
						if (LOC12) goto LA13;
						nimln(263, "ropes.nim");
				...
				nimln(265, "ropes.nim");
				{
					...
					nimln(265, "ropes.nim");
					nimln(265, "ropes.nim");
					TMP466 = addInt((argsLen0-1), 1);
					if (!((NI64)(TMP466) < j)) goto LA18;
					nimln(266, "ropes.nim");
					nimln(266, "ropes.nim");
					LOC20 = 0;
					LOC20 = nimIntToStr(j);
					errorhandler_126108.ClEnv? errorhandler_126108.ClPrc(((NU8) 1), LOC20, NIM_FALSE, errorhandler_126108.ClEnv) : ((TMP467)(errorhandler_126108.ClPrc))(((NU8) 1), LOC20, NIM_FALSE);
				}
				goto LA16;
				LA18: ;
				{
					...
					nimln(268, "ropes.nim");
					TMP468 = subInt(j, 1);
					if ((NU)((NI64)(TMP468)) >= (NU)(argsLen0)) raiseIndexError();
					app_126040(&result, args[(NI64)(TMP468)]);
				}
				LA16: ;
			}
			break;
			...
			default:
			{
				...
				errorhandler_126108.ClEnv? errorhandler_126108.ClPrc(((NU8) 1), LOC25, NIM_FALSE, errorhandler_126108.ClEnv) : ((TMP469)(errorhandler_126108.ClPrc))(((NU8) 1), LOC25, NIM_FALSE);
			}
			break;
			}
		}
		...
		nimln(281, "ropes.nim");
		{
			...
			nimln(281, "ropes.nim");
			TMP470 = subInt(i, 1);
			if (!(start <= (NI64)(TMP470))) goto LA34;
			nimln(282, "ropes.nim");
			nimln(282, "ropes.nim");
			nimln(282, "ropes.nim");
			TMP471 = subInt(i, 1);
			LOC36 = 0;
			LOC36 = copyStrLast(frmt, start, (NI64)(TMP471));
...
N_NIMCALL(NIM_BOOL, auxropeequalsfile_127631)(trope126007* r, FILE** bin, void* buf) {
	...
	nimln(300, "ropes.nim");
	{
		...
		nimln(301, "ropes.nim");
		{
			...
			nimln(302, "ropes.nim");
			errorhandler_126108.ClEnv? errorhandler_126108.ClPrc(((NU8) 2), (*r).Data, NIM_FALSE, errorhandler_126108.ClEnv) : ((TMP472)(errorhandler_126108.ClPrc))(((NU8) 2), (*r).Data, NIM_FALSE);
			nimln(303, "ropes.nim");
			goto BeforeRet;
		}
		LA7: ;
...
N_NIMCALL(NI32, crcfromropeaux_127656)(trope126007* r, NI32 startval) {
	...
	nimln(324, "ropes.nim");
	{
		...
		nimln(326, "ropes.nim");
		nimln(326, "ropes.nim");
		TMP473 = subInt((*r).Data->Sup.len, 1);
		HEX3Atmp_127670 = (NI64)(TMP473);
		nimln(1274, "system.nim");
		res_127672 = 0;
		nimln(1275, "system.nim");
		while (1) {
...
TMP445[0] = &TMP365[1];
TMP365[1].kind = 1;
TMP365[1].offset = offsetof(trope126007, Left);
TMP365[1].typ = (&NTI126005);
TMP365[1].name = "left";
TMP445[1] = &TMP365[2];
TMP365[2].kind = 1;
TMP365[2].offset = offsetof(trope126007, Right);
TMP365[2].typ = (&NTI126005);
TMP365[2].name = "right";
TMP445[2] = &TMP365[3];
TMP365[3].kind = 1;
TMP365[3].offset = offsetof(trope126007, Length);
TMP365[3].typ = (&NTI105);
TMP365[3].name = "length";
TMP445[3] = &TMP365[4];
TMP365[4].kind = 1;
TMP365[4].offset = offsetof(trope126007, Data);
TMP365[4].typ = (&NTI143);
TMP365[4].name = "data";
TMP365[0].len = 4; TMP365[0].kind = 2; TMP365[0].sons = &TMP445[0];
NTI126007.node = &TMP365[0];
NTI126005.size = sizeof(trope126007*);
NTI126005.kind = 22;
NTI126005.base = (&NTI126007);
NTI126005.flags = 2;
NTI126005.marker = TMP446;
NTI126009.size = sizeof(tropeseq126009*);
NTI126009.kind = 24;
NTI126009.base = (&NTI126005);
NTI126009.flags = 2;
NTI126009.marker = TMP452;
}
