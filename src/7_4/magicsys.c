...
N_NIMCALL(void, setintlittype_212395)(tnode169647* result);
...
N_NIMCALL(ttype169681*, getintlittype_212292)(tnode169647* literal) {
	...
	nimln(106, "magicsys.nim");
	{
		...
		result = inttypecache_212220[(((NI)chckRange64(value, (-2147483647 -1), 2147483647)))- -5];
		nimln(108, "magicsys.nim");
		{
			...
			if (((NI)chckRange64(value, (-2147483647 -1), 2147483647)) < -5 || ((NI)chckRange64(value, (-2147483647 -1), 2147483647)) > 64) raiseIndexError();
			asgnRefNoCycle((void**) &inttypecache_212220[(((NI)chckRange64(value, (-2147483647 -1), 2147483647)))- -5], result);
		}
		LA9: ;
	}
	goto LA1;
...
N_NIMCALL(void, setintlittype_212395)(tnode169647* result) {
	...
	default:
	{
		...
		internalerror_129690((*result).Info, ((NimStringDesc*) &TMP2976));
	}
	break;
	}
	popFrame();
