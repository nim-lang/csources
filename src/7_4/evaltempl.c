...
static NIM_CONST TY169850 TMP3375 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3376, "sym", 3);
static NIM_CONST TY169850 TMP3377 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3378, "sons", 4);
STRING_LITERAL(TMP3380, "compiler/evaltempl.nim", 22);
NIM_CONST TY71482 TMP3379 = {((NimStringDesc*) &TMP3380),
34}
;
STRING_LITERAL(TMP3382, "", 0);
...
N_NIMCALL(void, evaltemplateaux_245011)(tnode169647* templ, tnode169647* actual, templctx245006* c, tnode169647* result) {
	...
	case ((NU8) 3):
	{
		...
		if (!(((TMP3375[(*templ).Kind/8] &(1<<((*templ).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3376));
		...
		nimln(26, "evaltempl.nim");
		{
			...
			nimln(27, "evaltempl.nim");
			{
				...
				if (((TMP3377[(*actual).Kind/8] &(1<<((*actual).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3378));
				...
				nimln(29, "evaltempl.nim");
				{
					...
					while (1) {
						...
						i_245101 = res_245105;
						nimln(1376, "ast.nim");
						if (((TMP3377[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3378));
			...
			LA8: ;
			{
				...
				nimln(40, "evaltempl.nim");
				LOC29 = 0;
				LOC29 = newsymnode_171096(x, (*templ).Info);
	...
	default:
	{
		...
		TMP3381 = subInt(LOC35, 1);
		HEX3Atmp_245106 = (NI32)(TMP3381);
		...
		while (1) {
			...
			if (((TMP3377[(*templ).Kind/8] &(1<<((*templ).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3378));
...
N_NIMCALL(tnode169647*, evaltemplateargs_245201)(tnode169647* n, tsym169677* s) {
	...
	nimln(86, "evaltempl.nim");
	{
		...
		if (!(f < a)) goto LA5;
		nimln(86, "evaltempl.nim");
		globalerror_129663((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP3382));
	}
	LA5: ;
	...
	while (1) {
		...
		{
			nimln(90, "evaltempl.nim");
			if (((TMP3377[(*(*(*s).Typ).N).Kind/8] &(1<<((*(*(*s).Typ).N).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3378));
			if ((NU)(i_245218) >= (NU)((*(*(*s).Typ).N).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!(((TMP3375[(*(*(*(*s).Typ).N).kindU.S6.Sons->data[i_245218]).Kind/8] &(1<<((*(*(*(*s).Typ).N).kindU.S6.Sons->data[i_245218]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3376));
		...
		nimln(91, "evaltempl.nim");
		{
			...
			localerror_129676((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP3382));
		}
		LA17: ;
...
N_NIMCALL(tnode169647*, evaltemplate_245280)(tnode169647* n, tsym169677* tmpl, tsym169677* gensymowner) {
	...
	nimln(100, "evaltempl.nim");
	{
		...
		globalerror_129663((*n).Info, ((NU16) 183), ((NimStringDesc*) &TMP3382));
	...
	body = getbody_209577(tmpl);
	nimln(112, "evaltempl.nim");
	{
		NIM_BOOL LOC7;
		nimln(112, "evaltempl.nim");
		LOC7 = isatom_174441(body);
		if (!LOC7) goto LA8;
		...
		LA13: ;
		{
			...
			globalerror_129663((*result).Info, ((NU16) 1), LOC16);
		}
		LA10: ;
	}
	goto LA5;
	LA8: ;
	{
		...
		TMP3384 = subInt(LOC18, 1);
		HEX3Atmp_245351 = (NI32)(TMP3384);
		nimln(1274, "system.nim");
		res_245353 = 0;
		nimln(1275, "system.nim");
		while (1) {
			...
			if (((TMP3377[(*body).Kind/8] &(1<<((*body).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3378));
