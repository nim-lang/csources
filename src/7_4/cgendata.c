...
static N_INLINE(trope126007**, s_337159)(tcproc337024* p, NU8 s) {
	...
	nimln(124, "cgendata.nim");
	nimln(124, "cgendata.nim");
	TMP5272 = subInt((*p).Blocks->Sup.len, 1);
	if ((NU)((NI32)(TMP5272)) >= (NU)((*p).Blocks->Sup.len)) raiseIndexError();
	result = &(*p).Blocks->data[(NI32)(TMP5272)].Sections[(s)- 0];
	popFrame();
	return result;
}
...
static TNimNode* TMP5264[25];
static TNimNode* TMP5265[14];
static TNimNode* TMP5266[6];
static TNimNode TMP5262[48];
NTI337028.size = sizeof(tcgen337028);
NTI337028.kind = 17;
NTI337028.base = (&NTI218003);
TMP5264[0] = &TMP5262[1];
TMP5262[1].kind = 1;
TMP5262[1].offset = offsetof(tcgen337028, Module);
TMP5262[1].typ = (&NTI169645);
TMP5262[1].name = "module";
TMP5264[1] = &TMP5262[2];
TMP5262[2].kind = 1;
TMP5262[2].offset = offsetof(tcgen337028, Filename);
TMP5262[2].typ = (&NTI143);
TMP5262[2].name = "filename";
TMP5264[2] = &TMP5262[3];
...
NTI337012.flags = 2;
TMP5262[3].kind = 1;
TMP5262[3].offset = offsetof(tcgen337028, S);
TMP5262[3].typ = (&NTI337012);
TMP5262[3].name = "s";
TMP5264[3] = &TMP5262[4];
TMP5262[4].kind = 1;
TMP5262[4].offset = offsetof(tcgen337028, Preventstacktrace);
TMP5262[4].typ = (&NTI132);
TMP5262[4].name = "PreventStackTrace";
TMP5264[4] = &TMP5262[5];
TMP5262[5].kind = 1;
TMP5262[5].offset = offsetof(tcgen337028, Usesthreadvars);
TMP5262[5].typ = (&NTI132);
TMP5262[5].name = "usesThreadVars";
TMP5264[5] = &TMP5262[6];
TMP5262[6].kind = 1;
TMP5262[6].offset = offsetof(tcgen337028, Framedeclared);
TMP5262[6].typ = (&NTI132);
TMP5262[6].name = "FrameDeclared";
TMP5264[6] = &TMP5262[7];
TMP5262[7].kind = 1;
TMP5262[7].offset = offsetof(tcgen337028, Isheaderfile);
TMP5262[7].typ = (&NTI132);
TMP5262[7].name = "isHeaderFile";
TMP5264[7] = &TMP5262[8];
TMP5262[8].kind = 1;
TMP5262[8].offset = offsetof(tcgen337028, Cfilename);
TMP5262[8].typ = (&NTI143);
TMP5262[8].name = "cfilename";
TMP5264[8] = &TMP5262[9];
TMP5262[9].kind = 1;
TMP5262[9].offset = offsetof(tcgen337028, Typecache);
TMP5262[9].typ = (&NTI169693);
TMP5262[9].name = "typeCache";
TMP5264[9] = &TMP5262[10];
TMP5262[10].kind = 1;
TMP5262[10].offset = offsetof(tcgen337028, Forwtypecache);
TMP5262[10].typ = (&NTI169693);
TMP5262[10].name = "forwTypeCache";
TMP5264[10] = &TMP5262[11];
TMP5262[11].kind = 1;
TMP5262[11].offset = offsetof(tcgen337028, Declaredthings);
TMP5262[11].typ = (&NTI166041);
TMP5262[11].name = "declaredThings";
TMP5264[11] = &TMP5262[12];
TMP5262[12].kind = 1;
TMP5262[12].offset = offsetof(tcgen337028, Declaredprotos);
TMP5262[12].typ = (&NTI166041);
TMP5262[12].name = "declaredProtos";
TMP5264[12] = &TMP5262[13];
TMP5262[13].kind = 1;
TMP5262[13].offset = offsetof(tcgen337028, Headerfiles);
TMP5262[13].typ = (&NTI100017);
TMP5262[13].name = "headerFiles";
TMP5264[13] = &TMP5262[14];
TMP5262[14].kind = 1;
TMP5262[14].offset = offsetof(tcgen337028, Typeinfomarker);
TMP5262[14].typ = (&NTI166041);
TMP5262[14].name = "typeInfoMarker";
TMP5264[14] = &TMP5262[15];
NTI337024.size = sizeof(tcproc337024);
NTI337024.kind = 18;
NTI337024.base = 0;
TMP5265[0] = &TMP5262[17];
TMP5262[17].kind = 1;
TMP5262[17].offset = offsetof(tcproc337024, Prc);
TMP5262[17].typ = (&NTI169645);
TMP5262[17].name = "prc";
TMP5265[1] = &TMP5262[18];
TMP5262[18].kind = 1;
TMP5262[18].offset = offsetof(tcproc337024, Beforeretneeded);
TMP5262[18].typ = (&NTI132);
TMP5262[18].name = "BeforeRetNeeded";
TMP5265[2] = &TMP5262[19];
TMP5262[19].kind = 1;
TMP5262[19].offset = offsetof(tcproc337024, Threadvaraccessed);
TMP5262[19].typ = (&NTI132);
TMP5262[19].name = "ThreadVarAccessed";
TMP5265[3] = &TMP5262[20];
TMP5262[20].kind = 1;
TMP5262[20].offset = offsetof(tcproc337024, Nestedtrystmts);
TMP5262[20].typ = (&NTI169641);
TMP5262[20].name = "nestedTryStmts";
TMP5265[4] = &TMP5262[21];
TMP5262[21].kind = 1;
TMP5262[21].offset = offsetof(tcproc337024, Inexceptblock);
TMP5262[21].typ = (&NTI105);
TMP5262[21].name = "inExceptBlock";
TMP5265[5] = &TMP5262[22];
TMP5262[22].kind = 1;
TMP5262[22].offset = offsetof(tcproc337024, Labels);
TMP5262[22].typ = (&NTI1005);
TMP5262[22].name = "labels";
TMP5265[6] = &TMP5262[23];
NTI337022.size = sizeof(tblock337022);
NTI337022.kind = 18;
NTI337022.base = 0;
NTI337022.flags = 2;
TMP5266[0] = &TMP5262[25];
TMP5262[25].kind = 1;
TMP5262[25].offset = offsetof(tblock337022, Id);
TMP5262[25].typ = (&NTI105);
TMP5262[25].name = "id";
TMP5266[1] = &TMP5262[26];
TMP5262[26].kind = 1;
TMP5262[26].offset = offsetof(tblock337022, Label);
TMP5262[26].typ = (&NTI126005);
TMP5262[26].name = "label";
TMP5266[2] = &TMP5262[27];
NTI337016.size = sizeof(tcprocsections337016);
NTI337016.kind = 16;
NTI337016.base = (&NTI126005);
NTI337016.flags = 2;
TMP5262[27].kind = 1;
TMP5262[27].offset = offsetof(tblock337022, Sections);
TMP5262[27].typ = (&NTI337016);
TMP5262[27].name = "sections";
TMP5266[3] = &TMP5262[28];
TMP5262[28].kind = 1;
TMP5262[28].offset = offsetof(tblock337022, Isloop);
TMP5262[28].typ = (&NTI132);
TMP5262[28].name = "isLoop";
TMP5266[4] = &TMP5262[29];
TMP5262[29].kind = 1;
TMP5262[29].offset = offsetof(tblock337022, Nestedtrystmts);
TMP5262[29].typ = (&NTI109);
TMP5262[29].name = "nestedTryStmts";
TMP5266[5] = &TMP5262[30];
TMP5262[30].kind = 1;
TMP5262[30].offset = offsetof(tblock337022, Framelen);
TMP5262[30].typ = (&NTI109);
TMP5262[30].name = "frameLen";
TMP5262[24].len = 6; TMP5262[24].kind = 2; TMP5262[24].sons = &TMP5266[0];
NTI337022.node = &TMP5262[24];
NTI337089.size = sizeof(TY337089*);
NTI337089.kind = 24;
NTI337089.base = (&NTI337022);
NTI337089.flags = 2;
NTI337089.marker = TMP5267;
TMP5262[23].kind = 1;
TMP5262[23].offset = offsetof(tcproc337024, Blocks);
TMP5262[23].typ = (&NTI337089);
TMP5262[23].name = "blocks";
TMP5265[7] = &TMP5262[31];
TMP5262[31].kind = 1;
TMP5262[31].offset = offsetof(tcproc337024, Breakidx);
TMP5262[31].typ = (&NTI105);
TMP5262[31].name = "breakIdx";
TMP5265[8] = &TMP5262[32];
TMP5262[32].kind = 1;
TMP5262[32].offset = offsetof(tcproc337024, Options);
TMP5262[32].typ = (&NTI105103);
TMP5262[32].name = "options";
TMP5265[9] = &TMP5262[33];
TMP5262[33].kind = 1;
TMP5262[33].offset = offsetof(tcproc337024, Maxframelen);
TMP5262[33].typ = (&NTI105);
TMP5262[33].name = "maxFrameLen";
TMP5265[10] = &TMP5262[34];
TMP5262[34].kind = 1;
TMP5262[34].offset = offsetof(tcproc337024, Module);
TMP5262[34].typ = (&NTI337018);
TMP5262[34].name = "module";
TMP5265[11] = &TMP5262[35];
TMP5262[35].kind = 1;
TMP5262[35].offset = offsetof(tcproc337024, Withinloop);
TMP5262[35].typ = (&NTI105);
TMP5262[35].name = "withinLoop";
TMP5265[12] = &TMP5262[36];
TMP5262[36].kind = 1;
TMP5262[36].offset = offsetof(tcproc337024, Gcframeid);
TMP5262[36].typ = (&NTI1005);
TMP5262[36].name = "gcFrameId";
TMP5265[13] = &TMP5262[37];
TMP5262[37].kind = 1;
TMP5262[37].offset = offsetof(tcproc337024, Gcframetype);
TMP5262[37].typ = (&NTI126005);
TMP5262[37].name = "gcFrameType";
TMP5262[16].len = 14; TMP5262[16].kind = 2; TMP5262[16].sons = &TMP5265[0];
NTI337024.node = &TMP5262[16];
NTI337020.size = sizeof(tcproc337024*);
NTI337020.kind = 22;
NTI337020.base = (&NTI337024);
NTI337020.marker = TMP5268;
TMP5262[15].kind = 1;
TMP5262[15].offset = offsetof(tcgen337028, Initproc);
TMP5262[15].typ = (&NTI337020);
TMP5262[15].name = "initProc";
TMP5264[15] = &TMP5262[38];
TMP5262[38].kind = 1;
TMP5262[38].offset = offsetof(tcgen337028, Preinitproc);
TMP5262[38].typ = (&NTI337020);
TMP5262[38].name = "preInitProc";
TMP5264[16] = &TMP5262[39];
TMP5262[39].kind = 1;
TMP5262[39].offset = offsetof(tcgen337028, Typestack);
TMP5262[39].typ = (&NTI169679);
TMP5262[39].name = "typeStack";
TMP5264[17] = &TMP5262[40];
TMP5262[40].kind = 1;
TMP5262[40].offset = offsetof(tcgen337028, Datacache);
TMP5262[40].typ = (&NTI169705);
TMP5262[40].name = "dataCache";
TMP5264[18] = &TMP5262[41];
TMP5262[41].kind = 1;
TMP5262[41].offset = offsetof(tcgen337028, Forwardedprocs);
TMP5262[41].typ = (&NTI169649);
TMP5262[41].name = "forwardedProcs";
TMP5264[19] = &TMP5262[42];
TMP5262[42].kind = 1;
TMP5262[42].offset = offsetof(tcgen337028, Typenodes);
TMP5262[42].typ = (&NTI105);
TMP5262[42].name = "typeNodes";
TMP5264[20] = &TMP5262[43];
TMP5262[43].kind = 1;
TMP5262[43].offset = offsetof(tcgen337028, Nimtypes);
TMP5262[43].typ = (&NTI105);
TMP5262[43].name = "nimTypes";
TMP5264[21] = &TMP5262[44];
TMP5262[44].kind = 1;
TMP5262[44].offset = offsetof(tcgen337028, Typenodesname);
TMP5262[44].typ = (&NTI126005);
TMP5262[44].name = "typeNodesName";
TMP5264[22] = &TMP5262[45];
TMP5262[45].kind = 1;
TMP5262[45].offset = offsetof(tcgen337028, Nimtypesname);
TMP5262[45].typ = (&NTI126005);
TMP5262[45].name = "nimTypesName";
TMP5264[23] = &TMP5262[46];
TMP5262[46].kind = 1;
TMP5262[46].offset = offsetof(tcgen337028, Labels);
TMP5262[46].typ = (&NTI1005);
TMP5262[46].name = "labels";
TMP5264[24] = &TMP5262[47];
NTI337122.size = sizeof(TY337122);
NTI337122.kind = 16;
NTI337122.base = (&NTI126005);
NTI337122.flags = 2;
TMP5262[47].kind = 1;
TMP5262[47].offset = offsetof(tcgen337028, Extensionloaders);
TMP5262[47].typ = (&NTI337122);
TMP5262[47].name = "extensionLoaders";
TMP5262[0].len = 25; TMP5262[0].kind = 2; TMP5262[0].sons = &TMP5264[0];
NTI337028.node = &TMP5262[0];
NTI337018.size = sizeof(tcgen337028*);
NTI337018.kind = 22;
NTI337018.base = (&NTI337028);
NTI337018.marker = TMP5270;
NTI337130.size = sizeof(TY337130*);
NTI337130.kind = 24;
NTI337130.base = (&NTI337018);
NTI337130.flags = 2;
NTI337130.marker = TMP5271;
}
