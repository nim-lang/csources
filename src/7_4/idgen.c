...
static N_INLINE(void, setid_168436)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP1884 = addInt(id, 1);
	gfrontendid_168005 = ((gfrontendid_168005 >= (NI32)(TMP1884)) ? gfrontendid_168005 : (NI32)(TMP1884));
	popFrame();
}
...
N_NIMCALL(void, idsynchronizationpoint_168445)(NI idrange) {
	...
	TMP1886 = addInt((NI32)(TMP1885), 1);
	TMP1887 = mulInt((NI32)(TMP1886), idrange);
	TMP1888 = addInt((NI32)(TMP1887), 1);
	gfrontendid_168005 = (NI32)(TMP1888);
	popFrame();
}
