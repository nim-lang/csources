...
N_NIMCALL(tprocess135203*, startcmd_135246)(NimStringDesc* command, NU8 options) {
	...
	a = (TY9355*) newSeq((&NTI9355), (NI32)(TMP900));
	i_135291 = 0;
	HEX3Atmp_135293 = 0;
	nimln(86, "osproc.nim");
	nimln(86, "osproc.nim");
	...
	while (1) {
		...
		if ((NU)((NI32)(TMP902)) >= (NU)(a->Sup.len)) raiseIndexError();
		if ((NU)(i_135291) >= (NU)(c->Sup.len)) raiseIndexError();
		LOC2 = 0;
		LOC2 = a->data[(NI32)(TMP902)]; a->data[(NI32)(TMP902)] = copyStringRC1(c->data[i_135291]);
...
N_NIMCALL(NCSTRING*, tocstringarray_136424)(NimStringDesc** b, NI bLen0, NimStringDesc** a, NI aLen0) {
	...
	TMP921 = addInt((NI32)(TMP920), 1);
	TMP922 = mulInt((NI32)(TMP921), 4);
	LOC1 = alloc0_4004((NI32)(TMP922));
	...
	while (1) {
		...
		memcpy(((void*) (result[(i_136448)- 0])), ((void*) (b[i_136448]->data)), (NI32)(TMP924));
		nimln(1284, "system.nim");
	...
	while (1) {
		...
		if ((NU)((NI32)(TMP925)) > (NU)(50000)) raiseIndexError();
		nimln(500, "osproc.nim");
		nimln(500, "osproc.nim");
		nimln(500, "osproc.nim");
		if ((NU)(i_136456) >= (NU)(aLen0)) raiseIndexError();
		TMP926 = addInt(a[i_136456]->Sup.len, 1);
		LOC5 = alloc_4001((NI32)(TMP926));
		result[((NI32)(TMP925))- 0] = ((NCSTRING) (LOC5));
		nimln(501, "osproc.nim");
		nimln(501, "osproc.nim");
		nimln(501, "osproc.nim");
		TMP927 = addInt(i_136456, bLen0);
		if ((NU)((NI32)(TMP927)) > (NU)(50000)) raiseIndexError();
		if ((NU)(i_136456) >= (NU)(aLen0)) raiseIndexError();
		nimln(501, "osproc.nim");
		nimln(501, "osproc.nim");
		if ((NU)(i_136456) >= (NU)(aLen0)) raiseIndexError();
		TMP928 = addInt(a[i_136456]->Sup.len, 1);
		memcpy(((void*) (result[((NI32)(TMP927))- 0])), ((void*) (a[i_136456]->data)), (NI32)(TMP928));
		nimln(1284, "system.nim");
...
N_NIMCALL(NCSTRING*, tocstringarray_136482)(tstringtable103609* t) {
	...
	TMP930 = mulInt((NI32)(TMP929), 4);
	LOC2 = alloc0_4004((NI32)(TMP930));
...
N_NIMCALL(NCSTRING*, envtocstringarray_136515)(void) {
	...
	while (1) {
		...
		key_136519 = copyStrLast(environment_95235->data[i_136552], 0, (NI32)(TMP934));
		nimln(1036, "os.nim");
		nimln(1036, "os.nim");
		if ((NU)(i_136552) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		nimln(1036, "os.nim");
		TMP935 = addInt(p_136558, 1);
		val_136520 = copyStr(environment_95235->data[i_136552], (NI32)(TMP935));
	...
	TMP937 = mulInt((NI32)(TMP936), 4);
	LOC2 = alloc0_4004((NI32)(TMP937));
	result = ((NCSTRING*) (LOC2));
	...
	while (1) {
		...
		key_136535 = copyStrLast(environment_95235->data[i_136568], 0, (NI32)(TMP938));
		nimln(1036, "os.nim");
		nimln(1036, "os.nim");
		if ((NU)(i_136568) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		nimln(1036, "os.nim");
		TMP939 = addInt(p_136574, 1);
		val_136536 = copyStr(environment_95235->data[i_136568], (NI32)(TMP939));
...
appendString(LOC4, val_136536);
		...
		memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI32)(TMP941));
...
N_NIMCALL(void, pruneprocessset_137130)(TY136003** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(727, "osproc.nim");
		{
			...
			nimln(728, "osproc.nim");
			TMP950 = subInt(l, 1);
			if ((NU)((NI32)(TMP950)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRefNoCycle((void**) &(*s)->data[i], (*s)->data[(NI32)(TMP950)]);
...
N_NIMCALL(NI, select_136301)(TY136003** readfds, NI timeout) {
	...
	nimln(743, "osproc.nim");
	{
		...
		nimln(744, "osproc.nim");
		TMP952 = addInt(m, 1);
		LOC5 = select(((int) ((NI32)(TMP952))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		nimln(746, "osproc.nim");
		TMP953 = addInt(m, 1);
		LOC7 = select(((int) ((NI32)(TMP953))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
