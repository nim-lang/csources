...
N_NIMCALL(NI, counttriples_159661)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1552 = addInt(i, 1);
			if ((NU)((NI64)(TMP1552)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI64)(TMP1552)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			...
			LOC4 = ((NU8)(s->data[(NI64)(TMP1553)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
appendString((*s).S, ((NimStringDesc*) &TMP1556));
	...
	result = ((buflen <= (NI64)(TMP1557)) ? buflen : (NI64)(TMP1557));
...
N_NIMCALL(NI, llstreamread_159242)(tllstream159204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		nimln(136, "llstream.nim");
		{
			...
			if ((NU)((NI64)(TMP1559)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI64)(TMP1559)])), result);
...
N_NIMCALL(void, llstreamwrite_159268)(tllstream159204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			(*s).S = setLengthStr((*s).S, (NI64)(TMP1560));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1561 = addInt(0, (*s).Wr);
			if ((NU)((NI64)(TMP1561)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI64)(TMP1561)])), buf, buflen);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_159254)(tllstream159204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI64)(TMP1562));
			nimln(223, "llstream.nim");
			nimln(223, "llstream.nim");
			TMP1563 = addInt(i, 0);
			if ((NU)((NI64)(TMP1563)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_9317((*s).F, ((void*) (&result->data[(NI64)(TMP1563)])), 2048);
