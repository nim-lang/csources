...
static N_INLINE(void, setid_168436)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP1878 = addInt(id, 1);
	gfrontendid_168005 = ((gfrontendid_168005 >= (NI64)(TMP1878)) ? gfrontendid_168005 : (NI64)(TMP1878));
	popFrame();
}
...
N_NIMCALL(void, idsynchronizationpoint_168445)(NI idrange) {
	...
	TMP1880 = addInt((NI64)(TMP1879), 1);
	TMP1881 = mulInt((NI64)(TMP1880), idrange);
	TMP1882 = addInt((NI64)(TMP1881), 1);
	gfrontendid_168005 = (NI64)(TMP1882);
	popFrame();
}
