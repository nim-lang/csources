...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP2528, "\012", 1);
STRING_LITERAL(TMP2529, "", 0);
STRING_LITERAL(TMP2530, "end", 3);
STRING_LITERAL(TMP2531, "#end", 4);
static NIM_CONST TY104134 TMP2533 = {
...
STRING_LITERAL(TMP2537, "\\x", 2);
STRING_LITERAL(TMP2538, "\\\\", 2);
STRING_LITERAL(TMP2539, "\\\'", 2);
STRING_LITERAL(TMP2540, "\\\"", 2);
STRING_LITERAL(TMP2541, "}", 1);
STRING_LITERAL(TMP2542, "$", 1);
STRING_LITERAL(TMP2543, "\\n\"", 3);
STRING_LITERAL(TMP2544, "subschar", 8);
STRING_LITERAL(TMP2545, "metachar", 8);
STRING_LITERAL(TMP2546, "emit", 4);
STRING_LITERAL(TMP2547, "result.add", 10);
STRING_LITERAL(TMP2548, "conc", 4);
STRING_LITERAL(TMP2549, " & ", 3);
STRING_LITERAL(TMP2550, "tostring", 8);
...
N_NIMCALL(void, newline_193038)(ttmplparser193015* p) {
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		nimln(42, "filter_tmpl.nim");
		llstreamwrite_159258((*p).Outp, ((NimStringDesc*) &TMP2528));
	}
	LA4: ;
...
N_NIMCALL(void, parseline_193151)(ttmplparser193015* p) {
	...
	LA6: ;
	{
		...
		keyw = copyString(((NimStringDesc*) &TMP2529));
		...
		case ((NU8) 20):
		{
			...
			LA19: ;
			{
				...
				localerror_129673((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP2530));
			}
			LA17: ;
		...
		case ((NU8) 24):
		{
			...
			nimln(99, "filter_tmpl.nim");
			nimln(99, "filter_tmpl.nim");
			TMP2532 = subInt((*p).Indent, 2);
			LOC27 = 0;
			LOC27 = nsuRepeatChar((NI64)(TMP2532), 32);
		...
		case ((NU8) 61):
		{
			...
			nimln(104, "filter_tmpl.nim");
			{
				...
				nimln(104, "filter_tmpl.nim");
				nimln(104, "filter_tmpl.nim");
				LOC34 = contains_78741((*p).X, TMP2533);
				if (!!(LOC34)) goto LA35;
	...
	LA9: ;
	{
		...
		case ((NU8) 1):
		{
			...
			nimln(123, "filter_tmpl.nim");
			nimln(123, "filter_tmpl.nim");
			TMP2534 = addInt((*p).Indent, 2);
			LOC42 = 0;
			LOC42 = nsuRepeatChar((NI64)(TMP2534), 32);
			llstreamwrite_159258((*p).Outp, LOC42);
			nimln(124, "filter_tmpl.nim");
			llstreamwrite_159258((*p).Outp, ((NimStringDesc*) &TMP2535));
		}
		break;
		case ((NU8) 0):
		{
				...
				nimln(150, "filter_tmpl.nim");
				{
					...
					case 123:
					{
						...
						while (1) {
							...
							case 0:
							{
								...
								localerror_129673((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP2541));
					...
					default:
					{
						...
						LA76: ;
						{
							...
							localerror_129673((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP2542));
						}
						LA74: ;
					}
					break;
...
N_NIMCALL(tllstream159204*, filtertmpl_193005)(tllstream159204* stdin_193007, NimStringDesc* filename, tnode169647* call) {
	...
	p.Outp = llstreamopen_159218(((NimStringDesc*) &TMP2529));
	nimln(209, "filter_tmpl.nim");
	p.Inp = stdin_193007;
	nimln(210, "filter_tmpl.nim");
	p.Subschar = chararg_192014(call, ((NimStringDesc*) &TMP2544), 1, 36);
	nimln(211, "filter_tmpl.nim");
	p.Nimdirective = chararg_192014(call, ((NimStringDesc*) &TMP2545), 2, 35);
	nimln(212, "filter_tmpl.nim");
	p.Emit = strarg_192021(call, ((NimStringDesc*) &TMP2546), 3, ((NimStringDesc*) &TMP2547));
	nimln(213, "filter_tmpl.nim");
	p.Conc = strarg_192021(call, ((NimStringDesc*) &TMP2548), 4, ((NimStringDesc*) &TMP2549));
	nimln(214, "filter_tmpl.nim");
	p.Tostr = strarg_192021(call, ((NimStringDesc*) &TMP2550), 5, ((NimStringDesc*) &TMP2542));
	...
	while (1) {
		...
		nimln(217, "filter_tmpl.nim");
		TMP2551 = addInt(p.Info.Line, ((NI16) 1));
		if (TMP2551 < -32768 || TMP2551 > 32767) raiseOverflow();
		p.Info.Line = (NI16)(TMP2551);
