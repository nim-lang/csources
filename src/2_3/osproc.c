...
N_NIMCALL(tprocess135203*, startcmd_135246)(NimStringDesc* command, NU8 options) {
	...
	a = (TY9355*) newSeq((&NTI9355), (NI64)(TMP896));
	i_135291 = 0;
	HEX3Atmp_135293 = 0;
	nimln(86, "osproc.nim");
	nimln(86, "osproc.nim");
	...
	while (1) {
		...
		if ((NU)((NI64)(TMP898)) >= (NU)(a->Sup.len)) raiseIndexError();
		if ((NU)(i_135291) >= (NU)(c->Sup.len)) raiseIndexError();
		LOC2 = 0;
		LOC2 = a->data[(NI64)(TMP898)]; a->data[(NI64)(TMP898)] = copyStringRC1(c->data[i_135291]);
...
N_NIMCALL(NCSTRING*, tocstringarray_136424)(NimStringDesc** b, NI bLen0, NimStringDesc** a, NI aLen0) {
	...
	TMP917 = addInt((NI64)(TMP916), 1);
	TMP918 = mulInt((NI64)(TMP917), 8);
	LOC1 = alloc0_4004((NI64)(TMP918));
	...
	while (1) {
		...
		memcpy(((void*) (result[(i_136448)- 0])), ((void*) (b[i_136448]->data)), (NI64)(TMP920));
		nimln(1284, "system.nim");
	...
	while (1) {
		...
		if ((NU)((NI64)(TMP921)) > (NU)(50000)) raiseIndexError();
		nimln(500, "osproc.nim");
		nimln(500, "osproc.nim");
		nimln(500, "osproc.nim");
		if ((NU)(i_136456) >= (NU)(aLen0)) raiseIndexError();
		TMP922 = addInt(a[i_136456]->Sup.len, 1);
		LOC5 = alloc_4001((NI64)(TMP922));
		result[((NI64)(TMP921))- 0] = ((NCSTRING) (LOC5));
		nimln(501, "osproc.nim");
		nimln(501, "osproc.nim");
		nimln(501, "osproc.nim");
		TMP923 = addInt(i_136456, bLen0);
		if ((NU)((NI64)(TMP923)) > (NU)(50000)) raiseIndexError();
		if ((NU)(i_136456) >= (NU)(aLen0)) raiseIndexError();
		nimln(501, "osproc.nim");
		nimln(501, "osproc.nim");
		if ((NU)(i_136456) >= (NU)(aLen0)) raiseIndexError();
		TMP924 = addInt(a[i_136456]->Sup.len, 1);
		memcpy(((void*) (result[((NI64)(TMP923))- 0])), ((void*) (a[i_136456]->data)), (NI64)(TMP924));
		nimln(1284, "system.nim");
...
N_NIMCALL(NCSTRING*, tocstringarray_136482)(tstringtable103609* t) {
	...
	TMP926 = mulInt((NI64)(TMP925), 8);
	LOC2 = alloc0_4004((NI64)(TMP926));
...
appendString(LOC8, val_136489);
			...
			memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI64)(TMP929));
...
N_NIMCALL(NCSTRING*, envtocstringarray_136515)(void) {
	...
	while (1) {
		...
		key_136519 = copyStrLast(environment_95235->data[i_136552], 0, (NI64)(TMP930));
		nimln(1036, "os.nim");
		nimln(1036, "os.nim");
		if ((NU)(i_136552) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		nimln(1036, "os.nim");
		TMP931 = addInt(p_136558, 1);
		val_136520 = copyStr(environment_95235->data[i_136552], (NI64)(TMP931));
	...
	TMP933 = mulInt((NI64)(TMP932), 8);
	LOC2 = alloc0_4004((NI64)(TMP933));
	result = ((NCSTRING*) (LOC2));
	...
	while (1) {
		...
		key_136535 = copyStrLast(environment_95235->data[i_136568], 0, (NI64)(TMP934));
		nimln(1036, "os.nim");
		nimln(1036, "os.nim");
		if ((NU)(i_136568) >= (NU)(environment_95235->Sup.len)) raiseIndexError();
		nimln(1036, "os.nim");
		TMP935 = addInt(p_136574, 1);
		val_136536 = copyStr(environment_95235->data[i_136568], (NI64)(TMP935));
...
appendString(LOC4, val_136536);
		...
		memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI64)(TMP937));
...
N_NIMCALL(void, pruneprocessset_137136)(TY136003** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(727, "osproc.nim");
		{
			...
			nimln(728, "osproc.nim");
			TMP944 = subInt(l, 1);
			if ((NU)((NI64)(TMP944)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRefNoCycle((void**) &(*s)->data[i], (*s)->data[(NI64)(TMP944)]);
...
N_NIMCALL(NI, select_136301)(TY136003** readfds, NI timeout) {
	...
	nimln(743, "osproc.nim");
	{
		...
		nimln(744, "osproc.nim");
		TMP946 = addInt(m, 1);
		LOC5 = select(((int)chckRange((NI64)(TMP946), ((int) (-2147483647 -1)), ((int) 2147483647))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		nimln(746, "osproc.nim");
		TMP947 = addInt(m, 1);
		LOC7 = select(((int)chckRange((NI64)(TMP947), ((int) (-2147483647 -1)), ((int) 2147483647))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
