...
STRING_LITERAL(TMP271, "counter < length ", 17);
STRING_LITERAL(TMP277, "", 0);
STRING_LITERAL(TMP279, "key does not exist: ", 20);
STRING_LITERAL(TMP283, "format string: key not found: ", 30);
...
N_NIMCALL(NIM_BOOL, mustrehash_103710)(NI length, NI counter) {
	...
	nimln(85, "strtabs.nim");
	{
		...
		nimln(85, "strtabs.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP271));
	}
	LA3: ;
	...
	nimln(86, "strtabs.nim");
	nimln(86, "strtabs.nim");
	TMP272 = mulInt(length, 2);
	nimln(86, "strtabs.nim");
	TMP273 = mulInt(counter, 3);
	LOC5 = ((NI64)(TMP272) < (NI64)(TMP273));
	if (LOC5) goto LA6;
	nimln(86, "strtabs.nim");
	nimln(86, "strtabs.nim");
	TMP274 = subInt(length, counter);
	LOC5 = ((NI64)(TMP274) < 4);
	LA6: ;
	result = LOC5;
	popFrame();
...
static N_INLINE(NI, nexttry_103807)(NI h, NI maxhash) {
	...
	nimln(89, "strtabs.nim");
	TMP275 = mulInt(5, h);
	TMP276 = addInt((NI64)(TMP275), 1);
	result = (NI)((NI64)(TMP276) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(NimStringDesc*, nstGet)(tstringtable103609* t, NimStringDesc* key) {
	...
	LA3: ;
	{
		...
		result = copyString(((NimStringDesc*) &TMP277));
	}
	LA1: ;
	popFrame();
	return result;
...
appendString(LOC6, ((NimStringDesc*) &TMP279));
...
N_NIMCALL(void, enlarge_103881)(tstringtable103609* t) {
	...
	nimln(128, "strtabs.nim");
	nimln(128, "strtabs.nim");
	TMP280 = mulInt((*t).Data->Sup.len, 2);
	n = (tkeyvaluepairseq103607*) newSeq((&NTI103607), (NI64)(TMP280));
	i_103913 = 0;
	HEX3Atmp_103925 = 0;
...
appendString(LOC1, ((NimStringDesc*) &TMP283));
appendString(LOC1, s);
...
N_NIMCALL(tstringtable103609*, nstnewStringTableWithPairs)(NimStringDesc** keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	...
	while (1) {
		...
		nimln(176, "strtabs.nim");
		TMP292 = addInt(i, 1);
		if ((NU)((NI64)(TMP292)) >= (NU)(keyvaluepairsLen0)) raiseIndexError();
		nstPut(result, keyvaluepairs[i], keyvaluepairs[(NI64)(TMP292)]);
...
N_NIMCALL(NimStringDesc*, nstFormat)(NimStringDesc* f, tstringtable103609* t, NU8 flags) {
	...
	while (1) {
		...
		nimln(197, "strtabs.nim");
		{
			...
			nimln(198, "strtabs.nim");
			TMP293 = addInt(i, 1);
			if ((NU)((NI64)(TMP293)) > (NU)(f->Sup.len)) raiseIndexError();
			switch (((NU8)(f->data[(NI64)(TMP293)]))) {
			case 36:
			{
			...
			case 123:
			{
				...
				TMP296 = subInt(j, 1);
				LOC11 = 0;
				LOC11 = copyStrLast(f, (NI64)(TMP295), (NI64)(TMP296));
				LOC12 = 0;
...
appendString(result, LOC12);
			...
			case 95:
			{
				...
				TMP300 = subInt(j, 1);
				LOC17 = 0;
				LOC17 = copyStrLast(f, (NI64)(TMP299), (NI64)(TMP300));
				LOC18 = 0;
...
static TNimNode* TMP287[3];
static TNimNode* TMP288[3];
NI TMP290;
static char* NIM_CONST TMP289[3] = {
"modeCaseSensitive", 
"modeCaseInsensitive", 
"modeStyleInsensitive"};
static TNimNode TMP259[8];
NTI103607.size = sizeof(tkeyvaluepairseq103607*);
NTI103607.kind = 24;
NTI103607.base = (&NTI81915);
NTI103607.flags = 2;
NTI103607.marker = TMP282;
...
TMP287[0] = &TMP259[1];
TMP259[1].kind = 1;
TMP259[1].offset = offsetof(tstringtable103609, Counter);
TMP259[1].typ = (&NTI105);
TMP259[1].name = "counter";
TMP287[1] = &TMP259[2];
TMP259[2].kind = 1;
TMP259[2].offset = offsetof(tstringtable103609, Data);
TMP259[2].typ = (&NTI103607);
TMP259[2].name = "data";
TMP287[2] = &TMP259[3];
...
NTI103603.base = 0;
NTI103603.flags = 3;
for (TMP290 = 0; TMP290 < 3; TMP290++) {
TMP259[TMP290+4].kind = 1;
TMP259[TMP290+4].offset = TMP290;
TMP259[TMP290+4].name = TMP289[TMP290];
TMP288[TMP290] = &TMP259[TMP290+4];
}
TMP259[7].len = 3; TMP259[7].kind = 2; TMP259[7].sons = &TMP288[0];
NTI103603.node = &TMP259[7];
TMP259[3].kind = 1;
TMP259[3].offset = offsetof(tstringtable103609, Mode);
TMP259[3].typ = (&NTI103603);
TMP259[3].name = "mode";
TMP259[0].len = 3; TMP259[0].kind = 2; TMP259[0].sons = &TMP287[0];
NTI103609.node = &TMP259[0];
NTI103611.size = sizeof(tstringtable103609*);
NTI103611.kind = 22;
NTI103611.base = (&NTI103609);
NTI103611.flags = 2;
NTI103611.marker = TMP291;
}
