...
STRING_LITERAL(TMP365, "DOS", 3);
STRING_LITERAL(TMP366, "..", 2);
STRING_LITERAL(TMP367, "$1.dll", 6);
STRING_LITERAL(TMP368, "/", 1);
STRING_LITERAL(TMP369, ".obj", 4);
STRING_LITERAL(TMP370, "\015\012", 2);
STRING_LITERAL(TMP371, ";", 1);
STRING_LITERAL(TMP372, "\\", 1);
STRING_LITERAL(TMP373, ".bat", 4);
STRING_LITERAL(TMP374, ".", 1);
STRING_LITERAL(TMP375, ".exe", 4);
STRING_LITERAL(TMP376, "Windows", 7);
STRING_LITERAL(TMP377, "OS2", 3);
STRING_LITERAL(TMP378, "Linux", 5);
STRING_LITERAL(TMP379, "lib$1.so", 8);
STRING_LITERAL(TMP380, ".o", 2);
STRING_LITERAL(TMP381, "\012", 1);
STRING_LITERAL(TMP382, ":", 1);
STRING_LITERAL(TMP383, ".sh", 3);
STRING_LITERAL(TMP384, "", 0);
STRING_LITERAL(TMP385, "MorphOS", 7);
STRING_LITERAL(TMP386, "SkyOS", 5);
STRING_LITERAL(TMP387, "Solaris", 7);
STRING_LITERAL(TMP388, "Irix", 4);
STRING_LITERAL(TMP389, "NetBSD", 6);
STRING_LITERAL(TMP390, "FreeBSD", 7);
STRING_LITERAL(TMP391, "OpenBSD", 7);
STRING_LITERAL(TMP392, "AIX", 3);
STRING_LITERAL(TMP393, "PalmOS", 6);
STRING_LITERAL(TMP394, "QNX", 3);
STRING_LITERAL(TMP395, "Amiga", 5);
STRING_LITERAL(TMP396, "$1.library", 10);
STRING_LITERAL(TMP397, "Atari", 5);
STRING_LITERAL(TMP398, ".tpp", 4);
STRING_LITERAL(TMP399, "Netware", 7);
STRING_LITERAL(TMP400, "$1.nlm", 6);
STRING_LITERAL(TMP401, ".nlm", 4);
STRING_LITERAL(TMP402, "MacOS", 5);
STRING_LITERAL(TMP403, "::", 2);
STRING_LITERAL(TMP404, "$1Lib", 5);
STRING_LITERAL(TMP405, "\015", 1);
STRING_LITERAL(TMP406, ",", 1);
STRING_LITERAL(TMP407, "MacOSX", 6);
STRING_LITERAL(TMP408, "lib$1.dylib", 11);
STRING_LITERAL(TMP409, "Haiku", 5);
STRING_LITERAL(TMP410, "JS", 2);
STRING_LITERAL(TMP411, "NimrodVM", 8);
STRING_LITERAL(TMP412, "Standalone", 10);
NIM_CONST TY123060 os_123059 = {{((NimStringDesc*) &TMP365),
...
;
STRING_LITERAL(TMP413, "littleEndian", 12);
STRING_LITERAL(TMP414, "bigEndian", 9);
NIM_CONST TY123455 endiantostr_123454 = {((NimStringDesc*) &TMP413),
((NimStringDesc*) &TMP414)}
;
STRING_LITERAL(TMP415, "i386", 4);
STRING_LITERAL(TMP416, "m68k", 4);
STRING_LITERAL(TMP417, "alpha", 5);
STRING_LITERAL(TMP418, "powerpc", 7);
STRING_LITERAL(TMP419, "powerpc64", 9);
STRING_LITERAL(TMP420, "sparc", 5);
STRING_LITERAL(TMP421, "vm", 2);
STRING_LITERAL(TMP422, "ia64", 4);
STRING_LITERAL(TMP423, "amd64", 5);
STRING_LITERAL(TMP424, "mips", 4);
STRING_LITERAL(TMP425, "arm", 3);
STRING_LITERAL(TMP426, "js", 2);
STRING_LITERAL(TMP427, "nimrodvm", 8);
STRING_LITERAL(TMP428, "avr", 3);
NIM_CONST TY123460 cpu_123459 = {{((NimStringDesc*) &TMP415),
32,
((NU8) 0),
64,
32}
...
;
STRING_LITERAL(TMP429, "not c == cpuNone ", 17);
STRING_LITERAL(TMP430, "not o == osNone ", 16);
STRING_LITERAL(TMP434, "linux", 5);
...
N_NIMCALL(void, settarget_123586)(NU8 o, NU8 c) {
	...
	nimln(198, "platform.nim");
	{
		...
		if (!!(!((c == ((NU8) 0))))) goto LA3;
		nimln(198, "platform.nim");
		hiddenraiseassert_71620(((NimStringDesc*) &TMP429));
	}
	LA3: ;
	...
	TMP431 = divInt(cpu_123459[(c)- 1].Field1, 8);
	intsize_123577 = (NI64)(TMP431);
	nimln(204, "platform.nim");
	nimln(204, "platform.nim");
	if (c < 1 || c > 14) raiseIndexError();
	TMP432 = divInt(cpu_123459[(c)- 1].Field3, 8);
	floatsize_123578 = (NI64)(TMP432);
	nimln(205, "platform.nim");
	nimln(205, "platform.nim");
	if (c < 1 || c > 14) raiseIndexError();
	TMP433 = divInt(cpu_123459[(c)- 1].Field4, 8);
	ptrsize_123579 = (NI64)(TMP433);
...
N_NOINLINE(void, platformInit)(void) {
	...
	hostos_123563 = nametoos_123569(((NimStringDesc*) &TMP434));
