...
static NIM_CONST TY169850 TMP5243 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5244, "sons", 4);
extern NIM_CONST TY123460 cpu_123459;
STRING_LITERAL(TMP5247, "value expected, but got a type", 30);
STRING_LITERAL(TMP5248, "GetUniqueType", 13);
STRING_LITERAL(TMP5250, "\"", 1);
STRING_LITERAL(TMP5251, "c\"", 2);
STRING_LITERAL(TMP5255, "\\00\"", 4);
...
static N_INLINE(NI, len_170082)(tnode169647* n) {
	...
	{
		nimln(852, "ast.nim");
		if (((TMP5243[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP5244));
...
N_NIMCALL(NI64, hashstring_336092)(NimStringDesc* s) {
	...
	nimln(32, "ccgutils.nim");
	{
		...
		nimln(36, "ccgutils.nim");
		nimln(36, "ccgutils.nim");
		TMP5245 = subInt(s->Sup.len, 1);
		HEX3Atmp_336177 = (NI64)(TMP5245);
	...
	LA3: ;
	{
		...
		nimln(46, "ccgutils.nim");
		nimln(46, "ccgutils.nim");
		TMP5246 = subInt(s->Sup.len, 1);
		HEX3Atmp_336182 = (NI64)(TMP5246);
		nimln(1274, "system.nim");
		res_336184 = 0;
		nimln(1275, "system.nim");
		while (1) {
...
static N_INLINE(ttype169681*, lastson_170015)(ttype169681* n) {
	...
	TMP5249 = subInt(LOC1, 1);
	if ((NU)((NI64)(TMP5249)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP5249)];
	popFrame();
	return result;
}
...
N_NIMCALL(ttype169681*, getuniquetype_336401)(ttype169681* key) {
	...
	case ((NU8) 51):
	{
		...
		internalerror_129699(((NimStringDesc*) &TMP5247));
	}
	break;
	case ((NU8) 12):
	{
		nimln(92, "ccgutils.nim");
		internalerror_129699(((NimStringDesc*) &TMP5248));
	}
	break;
	case ((NU8) 11):
	case ((NU8) 13):
...
N_NIMCALL(NimStringDesc*, makesinglelinecstring_336596)(NimStringDesc* s) {
	...
	result = copyString(((NimStringDesc*) &TMP5250));
	c_336600 = 0;
...
N_NIMCALL(trope126007*, makellvmstring_336606)(NimStringDesc* s) {
	...
	res = copyString(((NimStringDesc*) &TMP5251));
	i_336620 = 0;
	HEX3Atmp_336630 = 0;
	nimln(169, "ccgutils.nim");
	nimln(169, "ccgutils.nim");
	nimln(169, "ccgutils.nim");
	TMP5252 = subInt(s->Sup.len, 1);
	HEX3Atmp_336630 = (NI64)(TMP5252);
	nimln(1274, "system.nim");
	res_336632 = 0;
	nimln(1275, "system.nim");
	while (1) {
		...
		nimln(170, "ccgutils.nim");
		{
			...
			nimln(170, "ccgutils.nim");
			nimln(170, "ccgutils.nim");
			TMP5253 = addInt(i_336620, 1);
			TMP5254 = modInt((NI64)(TMP5253), 64);
			if (!(((NI) ((NI64)(TMP5254))) == 0)) goto LA4;
...
appendString(res, ((NimStringDesc*) &TMP5255));
