...
static NIM_CONST TY192025 TMP5611 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5612, "sons", 4);
STRING_LITERAL(TMP5614, "n.sons[0].kind == nkSym ", 24);
STRING_LITERAL(TMP5617, "isPartOfAux(record case branch)", 31);
static NIM_CONST TY192025 TMP5618 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5619, "sym", 3);
STRING_LITERAL(TMP5620, "isPartOfAux()", 13);
...
static N_INLINE(NI, sonslen_192191)(tnode191813* n) {
	...
	{
		nimln(1300, "ast.nim");
		if (((TMP5611[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP5612));
...
static N_INLINE(tnode191813*, lastson_192199)(tnode191813* n) {
	...
	TMP5616 = subInt(LOC1, 1);
	if ((NU)((NI32)(TMP5616)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI32)(TMP5616)];
	popFrame();
	return result;
}
...
N_NIMCALL(NU8, ispartofaux_416020)(tnode191813* n, ttype191847* b, tintset188047* marker) {
	...
	case ((NU8) 136):
	{
		...
		TMP5613 = subInt(LOC2, 1);
		HEX3Atmp_416311 = (NI32)(TMP5613);
	...
	case ((NU8) 137):
	{
		...
		nimln(29, "aliases.nim");
		{
			...
			nimln(29, "aliases.nim");
			failedassertimpl_81621(((NimStringDesc*) &TMP5614));
		}
		LA11: ;
		...
		TMP5615 = subInt(LOC17, 1);
		HEX3Atmp_416315 = (NI32)(TMP5615);
		nimln(1451, "system.nim");
		res_416317 = 1;
		nimln(1452, "system.nim");
		while (1) {
			...
			default:
			{
				...
				internalerror_168606(((NimStringDesc*) &TMP5617));
			}
			break;
			}
			nimln(1454, "system.nim");
	...
	case ((NU8) 3):
	{
		...
		if (!(((TMP5618[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5619));
	...
	default:
	{
		...
		internalerror_168591((*n).Info, ((NimStringDesc*) &TMP5620));
	}
	break;
	}
	BeforeRet: ;
...
static N_INLINE(ttype191847*, lastson_192203)(ttype191847* n) {
	...
	if ((NU)((NI32)(TMP5621)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP5621)];
	popFrame();
	return result;
}
...
N_NIMCALL(NU8, ispartofaux_416013)(ttype191847* a, ttype191847* b, tintset188047* marker) {
	...
	case ((NU8) 18):
	{
		...
		TMP5622 = subInt(LOC25, 1);
		HEX3Atmp_416395 = (NI32)(TMP5622);
		nimln(1451, "system.nim");
		res_416397 = 0;
		nimln(1452, "system.nim");
		while (1) {
...
N_NIMCALL(NU8, ispartof_416411)(tnode191813* a, tnode191813* b) {
	...
	nimln(94, "aliases.nim");
	{
		...
		case ((NU8) 3):
		{
			...
			{
				nimln(99, "aliases.nim");
				if (!(((TMP5618[(*a).Kind/8] &(1<<((*a).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5619));
				if (!(((TMP5618[(*b).Kind/8] &(1<<((*b).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5619));
		...
		case ((NU8) 45):
		{
			...
			nimln(128, "aliases.nim");
			{
				...
				nimln(130, "aliases.nim");
				{
					...
					if (!(((TMP5618[(*LOC81).Kind/8] &(1<<((*LOC81).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5619));
					nimln(130, "aliases.nim");
					LOC82 = 0;
					LOC82 = HEX5BHEX5D_192711(b, 1);
					if (!(((TMP5618[(*LOC82).Kind/8] &(1<<((*LOC82).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5619));
