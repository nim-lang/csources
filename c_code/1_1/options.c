...
N_NIMCALL(NimStringDesc*, removetrailingdirsep_138410)(NimStringDesc* path) {
	...
	nimln(206, "options.nim");
	{
		...
		LOC3 = ((NU8)(path->data[(NI32)(TMP422)]) == (NU8)(92));
		LA4: ;
		if (!LOC3) goto LA5;
...
N_NIMCALL(void, libcandidates_139321)(NimStringDesc* s, TY10865** dest) {
	...
	nimln(347, "options.nim");
	{
		...
		nimln(350, "options.nim");
		TMP441 = subInt(ri, 1);
		HEX3Atmp_139351 = copyStrLast(s, (NI32)(TMP440), (NI32)(TMP441));
		...
		nimln(259, "strutils.nim");
		{
			...
			while (1) {
				...
				middle_139332 = copyStrLast(HEX3Atmp_139351, first_139355, (NI32)(TMP443));
