...
N_NIMCALL(trstnode297009*, lastson_297146)(trstnode297009* n) {
	...
	if ((NU)((NI32)(TMP3772)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP3772)];
	popFrame();
	return result;
}
...
appendString((*result), ind);
		...
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI32)(TMP3777), lvltochar_297257[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI32)(TMP3779), 45);
...
appendString((*result), ((NimStringDesc*) &TMP3782));
	...
	case ((NU8) 14):
	{
		...
		l = (((NI32)(TMP3783) >= 30) ? (NI32)(TMP3783) : 30);
...
appendString((*result), tmp);
		...
		TMP3785 = subInt((NI32)(TMP3784), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI32)(TMP3785), 32);
