...
extern TNimType NTI21218; /* array[0..15, int] */
...
N_NIMCALL(void, intsetenlarge_170604)(tintset170043* t) {
	...
	n = (ttrunkseq170041*) newSeq((&NTI170041), (NI32)(TMP1917));
	i_170629 = 0;
...
N_NIMCALL(ttrunk170039*, intsetput_170661)(tintset170043* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_170054((NI32)(TMP1921), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
...
N_NIMCALL(NIM_BOOL, contains_170817)(tintset170043 s, NI key) {
	...
	nimln(97, "intsets.nim");
	t = intsetget_170212(s, (NI)((NU32)(key) >> (NU32)(9)));
...
N_NIMCALL(void, incl_170840)(tintset170043* s, NI key) {
	...
	nimln(106, "intsets.nim");
	t = intsetput_170661(s, (NI)((NU32)(key) >> (NU32)(9)));
...
N_NIMCALL(NimStringDesc*, HEX24_171076)(tintset170043 s) {
	...
	while (1) {
		...
		while (1) {
			...
			NI j_171090;
			nimln(169, "intsets.nim");
			if (!(i_171086 <= 15)) goto LA2;
			nimln(170, "intsets.nim");
			if ((NU)(i_171086) > (NU)(15)) raiseIndexError();
			...
			while (1) {
				...
				nimln(175, "intsets.nim");
				{
					...
					nimln(176, "intsets.nim");
					nimln(176, "intsets.nim");
					key_171081 = (NI)((NI)((NU32)((*r_171084).Key) << (NU32)(9)) | (NI)((NU32)((NI)((NU32)(i_171086) << (NU32)(5))) + (NU32)(j_171090)));
...
appendString(result, LOC12);
				...
				nimln(178, "intsets.nim");
				w_171088 = (NI)((NU32)(w_171088) >> (NU32)(1));
			} LA3: ;
