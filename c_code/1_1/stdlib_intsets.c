...
N_NIMCALL(void, intsetenlarge_206614)(intset206056* t) {
	...
	n = (ttrunkseq206054*) newSeq((&NTI206054), (NI32)((*t).Max + ((NI) 1)));
	{
		NI i_206642;
		NI res_206670;
		i_206642 = 0;
...
{	result = 0;
	...
	}
	{
		NIM_BOOL LOC9;
		LOC9 = 0;
		LOC9 = mustrehash_206073((NI32)((*t).Max + ((NI) 1)), (*t).Counter);
		if (!LOC9) goto LA10;
...
N_NIMCALL(void, incl_206856)(intset206056* s, NI key) {
	ttrunk206052* t;
	NI u;
	t = intsetput_206689(s, (NI)((NU32)(key) >> (NU32)(((NI) 9))));
	u = (NI)(key & ((NI) 511));
...
N_NIMCALL(NIM_BOOL, containsorincl_206898)(intset206056* s, NI key) {
	...
	ttrunk206052* t;
	result = 0;
	t = intsetget_206218((*s), (NI)((NU32)(key) >> (NU32)(((NI) 9))));
	{
		NI u;
