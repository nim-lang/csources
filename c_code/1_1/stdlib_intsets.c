...
extern TNimType NTI22618; /* array[0..15, int] */
...
static N_INLINE(NIM_BOOL, mustrehash_184058)(NI length, NI counter) {
	...
	LOC5 = ((NI32)(TMP1934) < (NI32)(TMP1935));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
...
static N_INLINE(NI, nexttry_184206)(NI h, NI maxhash) {
	...
	result = (NI)((NI32)(TMP1938) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, intsetenlarge_184621)(tintset184047* t) {
	...
	TMP1942 = mulInt((NI32)(TMP1941), 2);
	TMP1943 = subInt((NI32)(TMP1942), 1);
	(*t).Max = (NI32)(TMP1943);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1944 = addInt((*t).Max, 1);
	n = (ttrunkseq184045*) newSeq((&NTI184045), (NI32)(TMP1944));
	i_184655 = 0;
...
N_NIMCALL(ttrunk184043*, intsetput_184696)(tintset184047* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_184058((NI32)(TMP1948), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
