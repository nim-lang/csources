...
N_NIMCALL(void, TMP1050)(void* p, NI op);
...
NTI189054.flags = 2;
NTI189054.marker = TMP1050;
TMP725[8].kind = 1;
TMP725[8].offset = offsetof(Intset189056, data);
TMP725[8].typ = (&NTI189054);
TMP725[8].name = "data";
TMP725[0].len = 4; TMP725[0].kind = 2; TMP725[0].sons = &TMP1047[0];
