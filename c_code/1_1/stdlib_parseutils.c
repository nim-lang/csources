...
N_NIMCALL(NI, nimParseBiggestFloat)(NimStringDesc* s, NF* number, NI start);
N_NIMCALL(NI, rawparseint_95208)(NimStringDesc* s, NI64* b, NI start);
...
STRING_LITERAL(TMP1378, "overflow", 8);
	...
	LA1: ;
	{
		...
		(*b) = IL64(0);
		{
			while (1) {
				...
				TMP1082 = mulInt64((*b), IL64(10));
				TMP1083 = subInt(((NI) (((NU8)(s->data[i])))), 48);
				TMP1084 = subInt64((NI64)(TMP1082), ((NI64) ((NI32)(TMP1083))));
				(*b) = (NI64)(TMP1084);
				i = addInt(i, 1);
				{
					while (1) {
		...
		TMP1085 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP1085);
		TMP1086 = subInt(i, start);
		result = (NI32)(TMP1086);
	}
	LA10: ;
	return result;
...
N_NIMCALL(NI, npuParseBiggestInt)(NimStringDesc* s, NI64* number, NI start) {
	...
	result = 0;
	res = 0;
	result = rawparseint_95208(s, (&res), start);
	(*number) = res;
	return result;
}
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	result = npuParseBiggestInt(s, (&res), start);
	{
		...
		if (!LOC3) goto LA7;
		e_95369 = 0;
		e_95369 = (overflowerror3443*) newObj((&NTI22601), sizeof(overflowerror3443));
		(*e_95369).Sup.Sup.Sup.m_type = (&NTI3443);
		LOC9 = 0;
		LOC9 = (*e_95369).Sup.Sup.message; (*e_95369).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1378));
		if (LOC9) nimGCunrefNoCycle(LOC9);
		raiseException((Exception*)e_95369, "OverflowError");
	}
	goto LA1;
	LA7: ;
	{
