...
N_NIMCALL(NI, npuParseHex)(NimStringDesc* s, NI* number, NI start, NI maxLen) {
	...
	LA12_: ;
	{
		while (1) {
			...
			case 48 ... 57:
			{
				(*number) = (NI)((NI)((NU32)((*number)) << (NU32)(((NI) 4))) | ((NI) ((NI)(((NI) (((NU8)(s->data[i])))) - ((NI) 48)))));
				foundDigit = NIM_TRUE;
			}
			break;
			case 97 ... 102:
			{
				(*number) = (NI)((NI)((NU32)((*number)) << (NU32)(((NI) 4))) | ((NI) ((NI)(((NI) ((NI)(((NI) (((NU8)(s->data[i])))) - ((NI) 97)))) + ((NI) 10)))));
				foundDigit = NIM_TRUE;
			}
			break;
			case 65 ... 70:
			{
				(*number) = (NI)((NI)((NU32)((*number)) << (NU32)(((NI) 4))) | ((NI) ((NI)(((NI) ((NI)(((NI) (((NU8)(s->data[i])))) - ((NI) 65)))) + ((NI) 10)))));
				foundDigit = NIM_TRUE;
			}
			break;
			default:
