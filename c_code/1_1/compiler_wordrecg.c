...
N_NIMCALL(void, initspecials_273373_1391470768)(void);
...
NIM_CONST TY273336 specialwords_273332_1391470768 = {((NimStringDesc*) &T1391470768_2),
...
N_NIMCALL(void, initspecials_273373_1391470768)(void) {
	{
		Tspecialword273003 s_273414_1391470768;
		NI res_273426_1391470768;
		s_273414_1391470768 = (Tspecialword273003)0;
		res_273426_1391470768 = ((NI) 1);
		{
			while (1) {
				NI LOC4;
				Tident197010* LOC5;
				if (!(res_273426_1391470768 <= ((NI) 263))) goto LA3;
				s_273414_1391470768 = ((Tspecialword273003) (res_273426_1391470768));
				LOC4 = (NI)0;
				LOC4 = hashignorestyle_149892_213663784(specialwords_273332_1391470768[(s_273414_1391470768)- 0]);
				LOC5 = (Tident197010*)0;
				LOC5 = getident_197445_791273810(specialwords_273332_1391470768[(s_273414_1391470768)- 0], LOC4);
				(*LOC5).Sup.id = ((NI) (s_273414_1391470768));
				res_273426_1391470768 += ((NI) 1);
			} LA3: ;
		}
	}
...
N_NIMCALL(Tspecialword273003, whichkeyword_273365_1391470768)(Tident197010* id0) {
	...
	LA3: ;
	{
		result0 = ((Tspecialword273003) ((*id0).Sup.id));
	}
	LA1: ;
	return result0;
}
...
N_NIMCALL(Tspecialword273003, whichkeyword_273369_1391470768)(NimStringDesc* id0) {
	...
	result0 = (Tspecialword273003)0;
	LOC1 = (Tident197010*)0;
	LOC1 = getident_197441_791273810(id0);
	result0 = whichkeyword_273365_1391470768(LOC1);
	return result0;
}
...
{	result0 = (NI)0;
	{
		NI i_273356_1391470768;
		NI HEX3Atmp_273358_1391470768;
		NI res_273361_1391470768;
		i_273356_1391470768 = (NI)0;
		HEX3Atmp_273358_1391470768 = (NI)0;
		HEX3Atmp_273358_1391470768 = (a0Len0-1);
		res_273361_1391470768 = ((NI) 0);
		{
			while (1) {
				if (!(res_273361_1391470768 <= HEX3Atmp_273358_1391470768)) goto LA3;
				i_273356_1391470768 = res_273361_1391470768;
				{
					NI LOC6;
					LOC6 = (NI)0;
					LOC6 = nsuCmpIgnoreStyle(a0[i_273356_1391470768], s0);
					if (!(LOC6 == ((NI) 0))) goto LA7;
					result0 = i_273356_1391470768;
					goto BeforeRet;
				}
				LA7: ;
				res_273361_1391470768 += ((NI) 1);
			} LA3: ;
		}
	}
	result0 = ((NI) -1);
...
NIM_EXTERNC N_NOINLINE(void, compiler_wordrecgInit000)(void) {
	initspecials_273373_1391470768();
}
