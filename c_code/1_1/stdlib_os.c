...
N_NIMCALL(void, nossplitPath)(NimStringDesc* path, keyvaluepair132008* Result) {
	...
	seppos = -1;
	{
		...
		i_116131 = 0;
		HEX3Atmp_116147 = 0;
		HEX3Atmp_116147 = (NI32)(path->Sup.len - 1);
...
N_NIMCALL(NI, searchextpos_116351)(NimStringDesc* s) {
	...
	result = -1;
	{
		...
		i_116366 = 0;
		HEX3Atmp_116382 = 0;
		HEX3Atmp_116382 = (NI32)(s->Sup.len - 1);
...
N_NIMCALL(void, nossplitFile)(NimStringDesc* path, TY116404* Result) {
	...
	LA5: ;
	{
		...
		dotpos = path->Sup.len;
		{
			...
			i_116437 = 0;
			HEX3Atmp_116468 = 0;
			HEX3Atmp_116468 = (NI32)(path->Sup.len - 1);
				...
				while (1) {
					...
					i_116437 = res_116471;
					{
						if (!((NU8)(path->data[i_116437]) == (NU8)(46))) goto LA13;
						{
							...
							LOC17 = LOC18;
							if (!(LOC17)) goto LA20;
							LOC17 = !((((NU8)(path->data[(NI32)(i_116437 - 1)])) == ((NU8)(92)) || ((NU8)(path->data[(NI32)(i_116437 - 1)])) == ((NU8)(47))));
							LA20: ;
							if (!LOC17) goto LA21;
							dotpos = i_116437;
						}
...
N_NIMCALL(NI, parentdirpos_116166)(NimStringDesc* path) {
	...
	q = 1;
	{
		if (!(((NU8)(path->data[(NI32)(path->Sup.len - 1)])) == ((NU8)(92)) || ((NU8)(path->data[(NI32)(path->Sup.len - 1)])) == ((NU8)(47)))) goto LA3;
		q = 2;
	}
	LA3: ;
	{
		...
		i_116196 = 0;
		HEX3Atmp_116212 = 0;
		HEX3Atmp_116212 = (NI32)(path->Sup.len - q);
...
N_NIMCALL(void, noscreateDir)(NimStringDesc* dir) {
	...
	omitnext = NIM_FALSE;
	{
		...
		i_122611 = 0;
		HEX3Atmp_122627 = 0;
		HEX3Atmp_122627 = (NI32)(dir->Sup.len - 1);
		res_122630 = 1;
		{
			while (1) {
				...
				i_122611 = res_122630;
				{
					...
					LA10: ;
					{
						NimStringDesc* LOC13;
						LOC13 = 0;
						LOC13 = copyStrLast(dir, 0, (NI32)(i_122611 - 1));
					...
					case 92:
					{
						...
						}
						{
							if (!((NU8)(c->data[j]) == (NU8)(34))) goto LA23;
							{
								...
								k_123625 = 0;
								HEX3Atmp_123710 = 0;
								HEX3Atmp_123710 = (NI32)((NI32)(j - i) / 2);
								res_123713 = 1;
								{
									while (1) {
...
N_NIMCALL(NI, nosparamCount)(void) {
	...
	LA3: ;
	result = (NI32)(ownargv_124609->Sup.len - 1);
	return result;
}
...
N_NIMCALL(NimStringDesc*, getenv_120841)(NimStringDesc* key) {
	...
	i = findenvvar_120804(key);
	{
		...
		result = copyStr(environment_120209->data[i], (NI32)(LOC5 + 1));
		goto BeforeRet;
	}
	goto LA1;
	LA3: ;
...
N_NIMCALL(NimStringDesc*, expandtilde_126447)(NimStringDesc* path) {
	...
	result = 0;
	{
		...
		LOC11 = 0;
		LOC11 = nosgetHomeDir();
		LOC12 = HEX2EHEX2E_93694(2, (NI32)(path->Sup.len - 1));
		LOC13 = 0;
