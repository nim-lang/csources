...
N_NIMCALL(Tnode216790*, semlocals_424005)(Tcontext266020* c, Tnode216790* n) {
	...
	result = 0;
	counter = ((NI) 0);
	tupletype = newtypes_266185(((NU8) 18), c);
					...
					s_424084 = inittabiter_223073((&it_424082), HEX3Atmp_424079);
					{
						while (1) {
							...
							it_424024 = s_424084;
							{
								...
								if (!LOC13) goto LA16;
								LOC18 = 0;
								LOC18 = getcurrowner_266210();
								field = newsym_217684(((NU8) 18), (*it_424024).name, LOC18, (*n).info);
								...
								addsonskipintlit_260678(tupletype, (*field).typ);
