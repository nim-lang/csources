...
static N_INLINE(NIM_BOOL, mustrehash_140414)(NI length, NI counter) {
	...
	nimln(108, "tables.nim");
	{
		...
		nimln(108, "tables.nim");
		failedassertimpl_81621(((NimStringDesc*) &TMP455));
	}
	LA3: ;
...
N_NIMCALL(void, inittable_166552)(NI initialsize_166557, ttable166560* Result) {
	...
	nimln(209, "tables.nim");
	{
		...
		if (!!(LOC3)) goto LA4;
		nimln(209, "tables.nim");
		failedassertimpl_81621(((NimStringDesc*) &TMP887));
	}
	LA4: ;
...
N_NIMCALL(void, enlarge_166886)(ttable166560* t_166895) {
	...
	nimln(158, "tables.nim");
	nimln(158, "tables.nim");
	TMP904 = mulInt((*t_166895).Data->Sup.len, 2);
	n = (tkeyvaluepairseq166563*) newSeq((&NTI166563), (NI32)(TMP904));
	i_166941 = 0;
	HEX3Atmp_167011 = 0;
...
NTI140010.node = &TMP453[5];
TMP453[1].kind = 1;
TMP453[1].offset = offsetof(tkeyvaluepair166566, Field0);
TMP453[1].typ = (&NTI140010);
TMP453[1].name = "Field0";
TMP888[1] = &TMP453[6];
TMP453[6].kind = 1;
TMP453[6].offset = offsetof(tkeyvaluepair166566, Field1);
TMP453[6].typ = (&NTI143);
TMP453[6].name = "Field1";
TMP888[2] = &TMP453[7];
TMP453[7].kind = 1;
TMP453[7].offset = offsetof(tkeyvaluepair166566, Field2);
TMP453[7].typ = (&NTI112);
TMP453[7].name = "Field2";
TMP453[0].len = 3; TMP453[0].kind = 2; TMP453[0].sons = &TMP888[0];
NTI166566.node = &TMP453[0];
NTI166563.size = sizeof(tkeyvaluepairseq166563*);
NTI166563.kind = 24;
NTI166563.base = (&NTI166566);
NTI166563.flags = 2;
NTI166563.marker = TMP892;
...
TMP893[0] = &TMP453[9];
TMP453[9].kind = 1;
TMP453[9].offset = offsetof(ttable166560, Data);
TMP453[9].typ = (&NTI166563);
TMP453[9].name = "data";
TMP893[1] = &TMP453[10];
TMP453[10].kind = 1;
TMP453[10].offset = offsetof(ttable166560, Counter);
TMP453[10].typ = (&NTI106);
TMP453[10].name = "counter";
TMP453[8].len = 2; TMP453[8].kind = 2; TMP453[8].sons = &TMP893[0];
NTI166560.node = &TMP453[8];
}
