...
STRING_LITERAL(TMP1347, "startswith", 10);
STRING_LITERAL(TMP1348, "", 0);
STRING_LITERAL(TMP1349, "true", 4);
STRING_LITERAL(TMP1350, "false", 5);
STRING_LITERAL(TMP1351, "leading", 7);
STRING_LITERAL(TMP1352, "trailing", 8);
STRING_LITERAL(TMP1353, "sub", 3);
STRING_LITERAL(TMP1354, "by", 2);
...
N_NIMCALL(NIM_BOOL, boolarg_256038)(tnode224819* n, NimStringDesc* name, NI pos, NIM_BOOL default_256043) {
	...
	LA3: ;
	{
		...
		LOC6 = ((*x).Kind == ((NU8) 2));
		if (!(LOC6)) goto LA7;
		LOC6 = identeq_200493((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP1349));
		LA7: ;
		if (!LOC6) goto LA8;
		result = NIM_TRUE;
	}
	...
	LA8: ;
	{
		...
		LOC11 = ((*x).Kind == ((NU8) 2));
		if (!(LOC11)) goto LA12;
		LOC11 = identeq_200493((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP1350));
		LA12: ;
		if (!LOC11) goto LA13;
		result = NIM_FALSE;
	}
...
N_NIMCALL(tllstream211204*, filterstrip_256012)(tllstream211204* stdin_256014, NimStringDesc* filename, tnode224819* call) {
	...
	NimStringDesc* line;
	result = 0;
	pattern = strarg_256029(call, ((NimStringDesc*) &TMP1347), 1, ((NimStringDesc*) &TMP1348));
	leading = boolarg_256038(call, ((NimStringDesc*) &TMP1351), 2, NIM_TRUE);
	trailing = boolarg_256038(call, ((NimStringDesc*) &TMP1352), 3, NIM_TRUE);
	result = llstreamopen_211220(((NimStringDesc*) &TMP1348));
...
N_NIMCALL(tllstream211204*, filterreplace_256004)(tllstream211204* stdin_256006, NimStringDesc* filename, tnode224819* call) {
	...
	NimStringDesc* line;
	result = 0;
	sub = strarg_256029(call, ((NimStringDesc*) &TMP1353), 1, ((NimStringDesc*) &TMP1348));
	{
		if (!(sub->Sup.len == 0)) goto LA3;
		invalidpragma_256047(call);
	}
	LA3: ;
	by = strarg_256029(call, ((NimStringDesc*) &TMP1354), 2, ((NimStringDesc*) &TMP1348));
	result = llstreamopen_211220(((NimStringDesc*) &TMP1348));
	line = rawNewString(80);
	{
		while (1) {
