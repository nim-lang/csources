...
NIM_CONST TY178066 crc32table_178065 = {0,
1996959894,
-301047508,
-1727442502,
124634137,
...
{	result = 0;
	...
	result = ((NI32) -1);
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = open_13003(&bin, filename, ((NU8) 0), -1);
		if (!!(LOC3)) goto LA4;
		goto BeforeRet;
	}
	LA4: ;
	...
	p = ((NI8*) (buf));
	{
		while (1) {
			NI readbytes;
			readbytes = readbuffer_13427(bin, buf, 8000);
			{
				NI i_178643;
				NI HEX3Atmp_178648;
				NI res_178651;
				i_178643 = 0;
				HEX3Atmp_178648 = 0;
				HEX3Atmp_178648 = (NI32)(readbytes - 1);
				res_178651 = 0;
				{
					while (1) {
						if (!(res_178651 <= HEX3Atmp_178648)) goto LA10;
						i_178643 = res_178651;
						result = updatecrc32_178019(p[(i_178643)- 0], result);
						res_178651 += 1;
					} LA10: ;
				}
			}
			{
				if (!!((readbytes == 8000))) goto LA13;
				goto LA6;
			}
			LA13: ;
		}
...
N_NIMCALL(NI32, HEX3EHEX3C_178533)(NI32 c, NimStringDesc* s) {
	...
	result = c;
	{
		...
		i_178548 = 0;
		HEX3Atmp_178550 = 0;
		HEX3Atmp_178550 = (NI32)(s->Sup.len - 1);
		res_178553 = 0;
		{
			while (1) {
				if (!(res_178553 <= HEX3Atmp_178550)) goto LA3;
				i_178548 = res_178553;
				result = updatecrc32_178026(s->data[i_178548], result);
				res_178553 += 1;
			} LA3: ;
		}
	}
