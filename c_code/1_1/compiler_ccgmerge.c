...
NIM_CONST TY458013 Cfilesectionnames_458012 = {((NimStringDesc*) &TMP4272),
...
NIM_CONST TY458019 Cprocsectionnames_458018 = {((NimStringDesc*) &TMP4290),
...
N_NIMCALL(void, readkey_458466)(Tbaselexer180024* L, NimStringDesc** result) {
	...
	}
	{
		...
		internalerror_166234(((NimStringDesc*) &TMP4193));
	}
	LA5: ;
...
N_NIMCALL(void, readtypecache_458524)(Tbaselexer180024* L, Tidtable192861* result) {
	{
		...
		internalerror_166234(((NimStringDesc*) &TMP4200));
	}
	LA3: ;
	(*L).bufpos += ((NI) 1);
	{
...
appendString(r, tnl_160626);
			...
			case 0:
			{
				internalerror_166234(((NimStringDesc*) &TMP4270));
				goto LA1;
			}
			break;
			default:
...
appendString(LOC34, k);
			...
			LA18: ;
			{
				internalerror_166234(((NimStringDesc*) &TMP4294));
			}
			LA11: ;
		}
	} LA5: ;
...
N_NIMCALL(Ropeobj162009*, gensectionstart_458106)(NU8 ps) {
	...
	result = 0;
	{
		...
		add_162545(&result, ((NimStringDesc*) &TMP4299));
