...
;
STRING_LITERAL(TMP125, "windows", 7);
STRING_LITERAL(TMP1476, "littleEndian", 12);
STRING_LITERAL(TMP1477, "bigEndian", 9);
NIM_CONST TY176491 endiantostr_176490 = {((NimStringDesc*) &TMP1476),
((NimStringDesc*) &TMP1477)}
;
NU8 targetcpu_176600;
NU8 hostcpu_176601;
NU8 targetos_176602;
NU8 hostos_176603;
NI intsize_176623;
...
{	result = 0;
	{
		...
		{
			while (1) {
				if (!(res_177437 <= ((NU8) 14))) goto LA3;
				i_177432 = res_177437;
				{
					NI LOC6;
					LOC6 = 0;
					LOC6 = nsuCmpIgnoreStyle(name, cpu_176496[(i_177432)- 1].Field0);
...
{	result = 0;
	{
		...
		{
			while (1) {
				if (!(res_177237 <= ((NU8) 24))) goto LA3;
				i_177232 = res_177237;
				{
					NI LOC6;
					LOC6 = 0;
					LOC6 = nsuCmpIgnoreStyle(name, os_176070[(i_177232)- 1].Field0);
					if (!(LOC6 == ((NI) 0))) goto LA7;
					result = i_177232;
					goto BeforeRet;
				}
...
N_NIMCALL(void, settarget_176634)(NU8 o, NU8 c) {
	...
	targetcpu_176600 = c;
	targetos_176602 = o;
	intsize_176623 = (NI32)(cpu_176496[(c)- 1].Field1 / ((NI) 8));
	floatsize_176624 = (NI32)(cpu_176496[(c)- 1].Field3 / ((NI) 8));
	ptrsize_176625 = (NI32)(cpu_176496[(c)- 1].Field4 / ((NI) 8));
	LOC1 = 0;
	LOC1 = tnl_176626; tnl_176626 = copyStringRC1(os_176070[(o)- 1].Field5);
	if (LOC1) nimGCunrefNoCycle(LOC1);
}
NIM_EXTERNC N_NOINLINE(void, compiler_platformInit)(void) {
	hostcpu_176601 = nametocpu_176617(((NimStringDesc*) &TMP61));
	hostos_176603 = nametoos_176611(((NimStringDesc*) &TMP125));
	settarget_176634(hostos_176603, hostcpu_176601);
}
