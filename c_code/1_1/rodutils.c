...
N_NIMCALL(void, hexchar_199064)(NIM_CHAR c, NI* xi) {
	...
	case 65 ... 70:
	{
		...
		TMP2097 = addInt(((NI) ((NI32)(TMP2096))), 10);
...
N_NIMCALL(NimStringDesc*, decodestr_199126)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 92:
		{
			...
			nimln(49, "rodutils.nim");
			TMP2099 = subInt(i, 2);
			hexchar_199064(s[(NI32)(TMP2099)], &xi);
			nimln(50, "rodutils.nim");
			nimln(50, "rodutils.nim");
			TMP2100 = subInt(i, 1);
			hexchar_199064(s[(NI32)(TMP2100)], &xi);
...
N_NIMCALL(void, encodevbiggestintaux_199198)(NI64 x, NimStringDesc** result) {
	...
	LA8: ;
	{
		...
		TMP2106 = addInt((NI32)(TMP2105), 128);
		d_199204 = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP2106), 0, 255))));
	}
	LA6: ;
...
N_NIMCALL(void, encodevintaux_199231)(NI x, NimStringDesc** result) {
	...
	nimln(71, "rodutils.nim");
	{
		...
		if ((NI32)(TMP2108) == (-2147483647 -1)) raiseOverflow();
		v_199239 = ((NI32)-((NI32)(TMP2108)));
		nimln(74, "rodutils.nim");
		nimln(74, "rodutils.nim");
	...
	LA8: ;
	{
		...
		TMP2111 = addInt((NI32)(TMP2110), 128);
		d_199237 = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP2111), 0, 255))));
	}
	LA6: ;
	nimln(80, "rodutils.nim");
	{
...
N_NIMCALL(void, encodevint_199256)(NI x, NimStringDesc** result) {
	...
	nimln(98, "rodutils.nim");
	encodevintaux_199231((NI)((NU32)(x) + (NU32)(5)), result);
	popFrame();
}
...
N_NIMCALL(NI, decodevint_199305)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 48 ... 57:
		{
			...
			TMP2115 = subInt((NI32)(TMP2113), ((NI) ((NI32)(TMP2114))));
			result = (NI32)(TMP2115);
		}
		break;
		case 97 ... 122:
		{
			...
			TMP2118 = addInt(((NI) ((NI32)(TMP2117))), 10);
			TMP2119 = subInt((NI32)(TMP2116), ((NI) ((NI32)(TMP2118))));
			result = (NI32)(TMP2119);
		}
		break;
		case 65 ... 90:
		{
			...
			TMP2122 = addInt(((NI) ((NI32)(TMP2121))), 36);
		...
		case 128 ... 255:
		{
			...
			TMP2126 = addInt(((NI) ((NI32)(TMP2125))), 62);
	...
	result = (NI)((NU32)((NI32)(TMP2128)) - (NU32)(5));
...
N_NIMCALL(NI64, decodevbiggestint_199530)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 48 ... 57:
		{
			...
			TMP2131 = subInt64((NI64)(TMP2129), ((NI64) ((NI32)(TMP2130))));
			result = (NI64)(TMP2131);
		}
		break;
		case 97 ... 122:
		{
			...
			TMP2134 = addInt(((NI) ((NI32)(TMP2133))), 10);
			TMP2135 = subInt64((NI64)(TMP2132), ((NI64) ((NI32)(TMP2134))));
			result = (NI64)(TMP2135);
		}
		break;
		case 65 ... 90:
		{
			...
			TMP2138 = addInt(((NI) ((NI32)(TMP2137))), 36);
		...
		case 128 ... 255:
		{
			...
			TMP2142 = addInt(((NI) ((NI32)(TMP2141))), 62);
