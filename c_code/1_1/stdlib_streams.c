...
N_LIB_PRIVATE N_NIMCALL(NI, fsReadData_7P4Enb2Vt3iOCL5K9cnGqYw)(tyObject_StreamObj_RShkcoDOPnoCVhtpN1hDPQ* s, void* buffer, NI bufLen) {
	NI result;
	result = (NI)0;
	result = readBuffer_nZ0pNe9cd9cXtoayexCiaDtA_2((*((tyObject_FileStreamObj_qoDM8xYRV40zbhS9acPNT9bw*) (s))).f, buffer, ((NI) (bufLen)));
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(void, fsWriteData_mrtMhMXvYVpi5Svw9bWueBw)(tyObject_StreamObj_RShkcoDOPnoCVhtpN1hDPQ* s, void* buffer, NI bufLen) {
	{
		...
		T3_ = (NI)0;
		T3_ = writeBuffer_nZ0pNe9cd9cXtoayexCiaDtA((*((tyObject_FileStreamObj_qoDM8xYRV40zbhS9acPNT9bw*) (s))).f, buffer, ((NI) (bufLen)));
