...
N_NIMCALL(NIM_BOOL, cyclictreeaux_241044)(Tnode216790* n, Tnode216790* s);
N_NIMCALL(NIM_BOOL, hasson_241007)(Tnode216790* father, Tnode216790* son);
N_NIMCALL(void, addson_218807)(Tnode216790* father, Tnode216790* son);
N_NIMCALL(void, delson_220495)(Tnode216790* father, NI idx);
N_NIMCALL(void, unneststmts_241550)(Tnode216790* n, Tnode216790* result);
		...
		{
			{
				...
				if (!(LOC26 == LOC27)) goto LA28;
				{
					...
					HEX3Atmp_241189 = 0;
					LOC31 = 0;
					LOC31 = sonslen_219351(a);
					HEX3Atmp_241189 = (NI)(LOC31 - ((NI) 1));
					res_241192 = ((NI) 0);
					{
						while (1) {
							if (!(res_241192 <= HEX3Atmp_241189)) goto LA33;
							i_241185 = res_241192;
							{
								NIM_BOOL LOC36;
								LOC36 = 0;
								LOC36 = exprstructuralequivalent_241099((*a).kindU.S6.sons->data[i_241185], (*b).kindU.S6.sons->data[i_241185], strictsymequality);
								if (!!(LOC36)) goto LA37;
								goto BeforeRet;
							}
							LA37: ;
...
{	result = 0;
	{
		...
		HEX3Atmp_241037 = 0;
		LOC2 = 0;
		LOC2 = sonslen_219351(father);
		HEX3Atmp_241037 = (NI)(LOC2 - ((NI) 1));
		res_241040 = ((NI) 0);
		{
			while (1) {
				if (!(res_241040 <= HEX3Atmp_241037)) goto LA4;
				i_241023 = res_241040;
				{
					if (!((*father).kindU.S6.sons->data[i_241023] == son)) goto LA7;
					result = NIM_TRUE;
					goto BeforeRet;
				}
				LA7: ;
...
{	result = 0;
	...
	addson_218807(s, n);
	{
		if (!!(((*n).kind >= ((NU8) 1) && (*n).kind <= ((NU8) 23)))) goto LA12;
		{
			...
			HEX3Atmp_241087 = (NI)(LOC15 - ((NI) 1));
			res_241090 = ((NI) 0);
			{
				while (1) {
					if (!(res_241090 <= HEX3Atmp_241087)) goto LA17;
					i_241084 = res_241090;
					{
						NIM_BOOL LOC20;
						LOC20 = 0;
						LOC20 = cyclictreeaux_241044((*n).kindU.S6.sons->data[i_241084], s);
						if (!LOC20) goto LA21;
						result = NIM_TRUE;
						goto BeforeRet;
					}
...
N_NIMCALL(NIM_BOOL, cyclictree_241094)(Tnode216790* n) {
	...
	Tnode216790* s;
	result = 0;
	s = newnodei_218248(((NU8) 1), (*n).info);
	result = cyclictreeaux_241044(n, s);
	return result;
}
...
N_NIMCALL(void, unneststmts_241550)(Tnode216790* n, Tnode216790* result) {
	{
		if (!((*n).kind == ((NU8) 115))) goto LA3;
		{
			...
			x_241563 = 0;
			{
				...
				LOC7 = 0;
				LOC7 = len_217059(n);
				HEX3Atmp_241582 = (LOC7 - 1);
				res_241584 = ((NI) 0);
				{
					while (1) {
						if (!(res_241584 <= HEX3Atmp_241582)) goto LA9;
						i_241580 = res_241584;
						x_241563 = (*n).kindU.S6.sons->data[i_241580];
						unneststmts_241550(x_241563, result);
						res_241584 += ((NI) 1);
					} LA9: ;
				}
			}
...
N_NIMCALL(Tnode216790*, flattenstmts_241587)(Tnode216790* n) {
	...
	unneststmts_241550(n, result);
	{
		NI LOC3;
		LOC3 = 0;
		LOC3 = len_217059(result);
...
N_NIMCALL(Tnode216790*, extractrange_241593)(NU8 k, Tnode216790* n, NI a, NI b) {
	Tnode216790* result;
	result = 0;
	result = newnodei_218401(k, (*n).info, (NI)((NI)(b - a) + ((NI) 1)));
	{
		NI i_241609;
		NI HEX3Atmp_241613;
		NI res_241616;
		i_241609 = 0;
		HEX3Atmp_241613 = 0;
		HEX3Atmp_241613 = (NI)(b - a);
		res_241616 = ((NI) 0);
		{
			while (1) {
				if (!(res_241616 <= HEX3Atmp_241613)) goto LA3;
				i_241609 = res_241616;
				asgnRefNoCycle((void**) (&(*result).kindU.S6.sons->data[i_241609]), (*n).kindU.S6.sons->data[(NI)(i_241609 + a)]);
				res_241616 += ((NI) 1);
			} LA3: ;
		}
	}
...
{	result = 0;
	...
	case ((NU8) 59):
	{
		result = isdeepconstexpr_241361((*n).kindU.S6.sons->data[((NI) 1)]);
	}
	break;
	case ((NU8) 39):
	case ((NU8) 41):
	...
	case ((NU8) 155):
	{
		...
		Ttype216828* LOC15;
		{
			...
			LOC5 = 0;
			LOC5 = len_217059(n);
			HEX3Atmp_241405 = (LOC5 - 1);
			res_241408 = ((NI) 0);
			{
				while (1) {
					if (!(res_241408 <= HEX3Atmp_241405)) goto LA7;
					i_241384 = res_241408;
					{
						NIM_BOOL LOC10;
						LOC10 = 0;
						LOC10 = isdeepconstexpr_241361((*n).kindU.S6.sons->data[i_241384]);
						if (!!(LOC10)) goto LA11;
						result = NIM_FALSE;
						goto BeforeRet;
					}
		...
		if (LOC13) goto LA14;
		LOC15 = 0;
		LOC15 = skiptypes_220113((*n).typ, 10240);
...
N_NIMCALL(NU16, whichpragma_241525)(Tnode216790* n) {
	...
	LA1: ;
	{
		...
		result = whichkeyword_198362((*key).kindU.S5.ident);
	}
	LA8: ;
	return result;
}
