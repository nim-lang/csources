...
N_NIMCALL(void, renderaux_328742)(trstgenerator328016* d, trstnode313011* n, NimStringDesc** result) {
	{
		...
		LOC2 = 0;
		LOC2 = len_313084(n);
		HEX3Atmp_328762 = (NI32)(LOC2 - ((NI) 1));
		res_328765 = ((NI) 0);
		{
			while (1) {
...
N_NIMCALL(void, renderheadline_333862)(trstgenerator328016* d, trstnode313011* n, NimStringDesc** result) {
	...
	tmp = copyString(((NimStringDesc*) &TMP2141));
	{
		...
		LOC2 = 0;
		LOC2 = len_313084(n);
		HEX3Atmp_334006 = (NI32)(LOC2 - ((NI) 1));
		res_334009 = ((NI) 0);
		{
			while (1) {
...
appendString(LOC14, LOC15);
	refname = LOC14;
	{
		...
		(*d).Tocpart = (TY328034*) setLengthSeq(&((*d).Tocpart)->Sup, sizeof(ttocentry328012), (NI32)(length + ((NI) 1)));
		LOC20 = 0;
...
N_NIMCALL(void, renderoverline_334045)(trstgenerator328016* d, trstnode313011* n, NimStringDesc** result) {
	{
		if (!((*d).Meta[(((NU8) 1))- 0]->Sup.len == ((NI) 0))) goto LA3;
		{
			...
			LOC6 = 0;
			LOC6 = len_313084(n);
			HEX3Atmp_334108 = (NI32)(LOC6 - ((NI) 1));
			res_334111 = ((NI) 0);
			{
				while (1) {
	...
	LA3: ;
	{
		if (!((*d).Meta[(((NU8) 2))- 0]->Sup.len == ((NI) 0))) goto LA10;
		{
			...
			LOC13 = 0;
			LOC13 = len_313084(n);
			HEX3Atmp_334116 = (NI32)(LOC13 - ((NI) 1));
			res_334119 = ((NI) 0);
			{
				while (1) {
	...
	LA10: ;
	{
		...
		tmp = copyString(((NimStringDesc*) &TMP2141));
		{
			...
			LOC18 = 0;
			LOC18 = len_313084(n);
			HEX3Atmp_334124 = (NI32)(LOC18 - ((NI) 1));
			res_334127 = ((NI) 0);
			{
				while (1) {
...
N_NIMCALL(void, renderaux_328784)(trstgenerator328016* d, trstnode313011* n, NimStringDesc* frmta, NimStringDesc* frmtb, NimStringDesc** result) {
	...
	tmp = copyString(((NimStringDesc*) &TMP2141));
	{
		...
		LOC2 = 0;
		LOC2 = len_313084(n);
		HEX3Atmp_328825 = (NI32)(LOC2 - ((NI) 1));
		res_328828 = ((NI) 0);
		{
			while (1) {
	...
	{
		{
			...
			i_328605 = 0;
			HEX3Atmp_328616 = 0;
			HEX3Atmp_328616 = (NI32)(s->Sup.len - ((NI) 1));
			res_328619 = ((NI) 0);
			{
				while (1) {
...
N_NIMCALL(void, renderindexterm_329066)(trstgenerator328016* d, trstnode313011* n_329069, NimStringDesc** result) {
	...
	refname = rstnodetorefname_314061(n_329069);
	{
		...
		HEX5BHEX5DHEX3D_329148((&(*d).Seenindexterms), refname, (NI32)(LOC6 + ((NI) 1)));
	}
	goto LA1;
	LA4: ;
	{
...
{	{
	...
	case ((NU8) 13):
	{
		...
		tmp = copyString(((NimStringDesc*) &TMP2141));
		{
			...
			LOC19 = 0;
			LOC19 = len_313084(n);
			HEX3Atmp_335853 = (NI32)(LOC19 - ((NI) 1));
			res_335856 = ((NI) 0);
			{
				while (1) {
	...
	{
		{
			...
			if (!(((NI) 1) <= LOC55)) goto LA56;
			{
				...
				renderrsttoout_328732(d, (*n).Sons->data[((NI) 0)], result);
				{
					...
					LOC63 = 0;
					LOC63 = len_313084(n);
					HEX3Atmp_335861 = (NI32)(LOC63 - ((NI) 1));
					res_335864 = ((NI) 1);
					{
						while (1) {
								...
								res_333681 = rawNewString(((NI) 80));
								{
									while (1) {
										...
										line_331872 = res_333681;
										{
											...
											LA37: ;
											fileentries = (TY331711*) setLengthSeq(&(fileentries)->Sup, sizeof(tindexentry329398), (NI32)(f + ((NI) 1)));
											asgnRefNoCycle((void**) (&fileentries->data[f].Keyword), copyStrLast(line_331872, ((NI) 0), (NI32)(s - ((NI) 1))));
											asgnRefNoCycle((void**) (&fileentries->data[f].Link), copyStr(line_331872, (NI32)(s + ((NI) 1))));
											{
												NIM_BOOL LOC41;
												LOC41 = 0;
									...
									res_333688 = ((NI) 0);
									{
										while (1) {
											...
											i_332028 = res_333688;
											{
												...
												LA68: ;
												(*Result).Field1 = (TY331711*) setLengthSeq(&((*Result).Field1)->Sup, sizeof(tindexentry329398), (NI32)(l + ((NI) 1)));
												LOC70 = 0;
...
{	result = 0;
	...
	LA3: ;
	{
		...
		result = nsuRepeatStr(((NimStringDesc*) &TMP4898), (NI32)(newlevel - (*level)));
	}
	goto LA5;
	LA7: ;
	{
		result = nsuRepeatStr(((NimStringDesc*) &TMP4899), (NI32)((*level) - newlevel));
	}
	LA5: ;
	(*level) = newlevel;
	}BeforeRet: ;
		...
		l_330408 = entries->Sup.len;
		{
			while (1) {
				...
				rawtext = LOC5.Field1;
				{
					...
					levels->data[l_330077].Field0 = (NI32)(level + ((NI) 1));
					LOC10 = 0;
					...
					while (1) {
						...
						j = i_329844;
						{
							while (1) {
								NI LOC14;
								LOC14 = 0;
								LOC14 = cmp_329432(a[(NI32)(j - h)], v);
								if (!(((NI) 0) <= LOC14)) goto LA13;
								HEX3CHEX2D_329807((&a[j]), a[(NI32)(j - h)]);
								j = (NI32)(j - h);
								{
									if (!(j < h)) goto LA17;
									goto LA12;
...
N_NIMCALL(NimStringDesc*, generatesymbolindex_329895)(TY331711* symbols) {
	...
	i = ((NI) 0);
	{
		while (1) {
			...
			LOC3 = HEX2EHEX2E_108273(((NI) 1), (NI32)((keyword->Sup.len-1) - ((NI) 1)));
