	...
	while (1) {
		...
		case ((NU8) 3):
		{
			...
			nimln(43, "service.nim");
			{
				...
				key = copyStrLast(p.Key, 0, (NI32)(TMP7639));
				...
				LOC9 = 0;
				LOC9 = copyStr(p.Key, (NI32)(TMP7640));
...
N_NIMCALL(void, serve_528292)(TY528294 action) {
	...
	LA2: ;
	{
		...
		while (1) {
			...
			send_163404(stdoutsocket_167192, ((NimStringDesc*) &TMP7676));
...
N_NOINLINE(void, serviceInit)(void) {
	...
	LOC1 = 0;
	LOC1 = curcaascmd_528203; curcaascmd_528203 = copyStringRC1(((NimStringDesc*) &TMP7634));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(25, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_528204; lastcaascmd_528204 = copyStringRC1(((NimStringDesc*) &TMP7634));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(28, "service.nim");
	LOC3 = 0;
	LOC3 = arguments_528205; arguments_528205 = copyStringRC1(((NimStringDesc*) &TMP7634));
