...
static N_INLINE(NI, nexttry_196192)(NI h, NI maxhash) {
	...
	nimln(465, "astalgo.nim");
	TMP3201 = mulInt(5, h);
	TMP3202 = addInt((NI32)(TMP3201), 1);
	result = (NI)((NI32)(TMP3202) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, nodetableput_247622)(tnodetable187871* t, tnode187813* key, NI val) {
	...
	LA3: ;
	{
		nimln(85, "treetab.nim");
		{
			...
			n = (tnodepairseq187869*) newSeq((&NTI187869), (NI32)(TMP3205));
			i_247868 = 0;
			HEX3Atmp_247921 = 0;
...
N_NIMCALL(NI, nodetabletestorset_247928)(tnodetable187871* t, tnode187813* key, NI val) {
	...
	LA3: ;
	{
		nimln(102, "treetab.nim");
		{
			...
			n = (tnodepairseq187869*) newSeq((&NTI187869), (NI32)(TMP3206));
			i_248068 = 0;
			HEX3Atmp_248121 = 0;
