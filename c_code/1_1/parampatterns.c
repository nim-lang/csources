...
N_NIMCALL(NIM_BOOL, matchnodekinds_281344)(tnode191813* p, tnode191813* n) {
	...
	while (1) {
		...
		case ((NU8) 4):
		{
			...
			stack[((NI32)(TMP3600))- 0] = !(stack[((NI32)(TMP3601))- 0]);
		}
		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3602)])), ((NU8) 0), ((NU8) 24)));
			nimln(233, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3603)])), ((NU8) 0), ((NU8) 156)));
			nimln(233, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
