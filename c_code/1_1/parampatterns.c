...
NIM_CONST TY86135 TMP2992 = {((NimStringDesc*) &TMP2993),
100}
;
NIM_CONST TY86135 TMP2994 = {((NimStringDesc*) &TMP2993),
107}
;
...
N_NIMCALL(NU8, checkforsideeffects_320747)(tnode224819* n) {
	...
	case ((NU8) 32):
	{
		...
		op = (*n).kindU.S6.Sons->data[0];
		{
			...
			LOC4 = ((*op).Kind == ((NU8) 3));
			if (!(LOC4)) goto LA5;
			LOC4 = isroutine_231780((*op).kindU.S4.Sym);
			LA5: ;
			if (!LOC4) goto LA6;
			s = (*op).kindU.S4.Sym;
			{
...
N_NIMCALL(tnode224819*, semnodekindconstraints_320527)(tnode224819* p) {
	...
	(*result).kindU.S3.Strval = addChar((*result).kindU.S3.Strval, 1);
	{
		...
		}
		{
			...
			internalerror_197970((*p).Info, ((NimStringDesc*) &TMP2995));
		}
		LA12: ;
	}
	goto LA1;
