...
N_NIMCALL(NU8, checkforsideeffects_276740)(tnode187813* n) {
	...
	case ((NU8) 32):
	{
		...
		nimln(143, "parampatterns.nim");
		{
			...
			LOC4 = isroutine_194040((*op).kindU.S4.Sym);
			LA5: ;
			if (!LOC4) goto LA6;
...
N_NIMCALL(NIM_BOOL, matchnodekinds_277321)(tnode187813* p, tnode187813* n) {
	...
	while (1) {
		...
		case ((NU8) 2):
		{
			...
			nimln(239, "parampatterns.nim");
			TMP3593 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3593)) > (NU)(64)) raiseIndexError();
			nimln(239, "parampatterns.nim");
			LOC4 = 0;
			nimln(239, "parampatterns.nim");
			TMP3594 = subInt(sp, 1);
			if ((NU)((NI32)(TMP3594)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI32)(TMP3594))- 0];
			if (LOC4) goto LA5;
			nimln(239, "parampatterns.nim");
			TMP3595 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3595)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI32)(TMP3595))- 0];
			LA5: ;
			stack[((NI32)(TMP3593))- 0] = LOC4;
		...
		case ((NU8) 3):
		{
			...
			LOC7 = stack[((NI32)(TMP3597))- 0];
			if (!(LOC7)) goto LA8;
			nimln(242, "parampatterns.nim");
			TMP3598 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3598)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI32)(TMP3598))- 0];
			LA8: ;
			stack[((NI32)(TMP3596))- 0] = LOC7;
		...
		case ((NU8) 4):
		{
			...
			stack[((NI32)(TMP3599))- 0] = !(stack[((NI32)(TMP3600))- 0]);
		}
		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(251, "parampatterns.nim");
			TMP3601 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3601)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3601)])), ((NU8) 0), ((NU8) 24)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			nimln(255, "parampatterns.nim");
			TMP3602 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3602)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3602)])), ((NU8) 0), ((NU8) 156)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
