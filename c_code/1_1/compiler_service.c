...
extern tsocketimpl125605* stdoutsocket_138084;
	...
	while (1) {
		...
		case ((NU8) 3):
		{
			...
			nimln(43, "service.nim");
			{
				...
				key = copyStrLast(p.Key, 0, (NI32)(TMP7036));
				...
				LOC9 = 0;
				LOC9 = copyStr(p.Key, (NI32)(TMP7037));
...
appendString(LOC8, p.Val);
				...
				processswitch_153016(key, val, pass, gcmdlineinfo_138009);			}			goto LA4;
			LA6: ;
			{
				nimln(48, "service.nim");
				processswitch_153016(p.Key, p.Val, pass, gcmdlineinfo_138009);			}			LA4: ;
		}		break;
		case ((NU8) 1):
		{
...
N_NIMCALL(void, serve_420277)(TY420279 action) {
	...
	LA2: ;
	{
		...
		stdoutsocket_138084 = (tsocketimpl125605*) newObjRC1((&NTI125607), sizeof(tsocketimpl125605));
		nimln(93, "service.nim");
		while (1) {
			NimStringDesc* LOC21;
			nimln(94, "service.nim");
			accept_129201(server, &stdoutsocket_138084);			nimln(95, "service.nim");
			readline_133830(stdoutsocket_138084, &inp, -1);			nimln(67, "service.nim");
			LOC21 = 0;
			...
			send_135204(stdoutsocket_138084, ((NimStringDesc*) &TMP7072));			nimln(98, "service.nim");
			close_129258(stdoutsocket_138084);		}	}	goto LA4;
	LA3: ;
	{
