...
N_NIMCALL(void, fillbuffer_216201_1314243012)(Baselexer216007* L0);
...
N_NIMCALL(void, open_218223_1314243012)(Baselexer216007* L0, Streamobj156818* input0, NI buflen0, char136Set refillchars0) {
	...
	(*L0).linestart = ((NI) 0);
	(*L0).linenumber = ((NI) 1);
	fillbuffer_216201_1314243012(L0);
	skiputf8bom_218201_1314243012(L0);
}
...
N_NIMCALL(NI, handlecr_217601_1314243012)(Baselexer216007* L0, NI pos0) {
	...
	result0 = (NI)0;
	(*L0).linenumber += ((NI) 1);
	result0 = fillbaselexer_217409_1314243012(L0, pos0);
	{
		if (!((NU8)((*L0).buf[result0]) == (NU8)(10))) goto LA3;
		result0 = fillbaselexer_217409_1314243012(L0, result0);
	}
	LA3: ;
