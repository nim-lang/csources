...
static N_INLINE(NI, nexttry_113805)(NI h, NI maxhash) {
	...
	nimln(89, "strtabs.nim");
	TMP295 = mulInt(5, h);
	TMP296 = addInt((NI32)(TMP295), 1);
	result = (NI)((NI32)(TMP296) & maxhash);
	popFrame();
	return result;
}
N_NIMCALL(NI, rawget_113812)(tstringtable113610* t, NimStringDesc* key) {
...
N_NIMCALL(void, enlarge_113876)(tstringtable113610* t) {
	...
	n = (tkeyvaluepairseq113608*) newSeq((&NTI113608), (NI32)(TMP300));
	i_113907 = 0;
	HEX3Atmp_113921 = 0;
...
N_NIMCALL(tstringtable113610*, nstnewStringTableWithPairs)(NimStringDesc** keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	...
	while (1) {
		...
		nstPut(result, keyvaluepairs[i], keyvaluepairs[(NI32)(TMP313)]);		nimln(177, "strtabs.nim");
		i = addInt(i, 2);
	} LA1: ;
	popFrame();
	return result;
