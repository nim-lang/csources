...
N_LIB_PRIVATE N_NIMCALL(tyObject_PTerminalcolonObjectType__EcU8GhMNGo9bGDXbfqZ82og*, newTerminal_Xqu71GJoz9bsJBdRC0m9cqrA)(void);
N_NIMCALL(void*, newObj)(TNimType* typ, NI size);
N_LIB_PRIVATE N_NIMCALL(void, initTerminal_5wvPzFalXz1eZEj3h1czDw)(tyObject_PTerminalcolonObjectType__EcU8GhMNGo9bGDXbfqZ82og* term);
...
tyProc_oew1DfaGl5XhHmnBK0HYXQ Dl_318306_;
tyProc_uryidYWkntM7ddjZSyxvyQ Dl_318316_;
tyProc_vjGHiWUJwFzOgSxDffBb6Q Dl_318318_;
extern tyObject_GcHeap_1TRH1TZMaVZTnLNcIHuNFQ gch_IcYaEuuWivYAS86vFMTS3Q;
tyProc_oPCjp4xTgEl9a8fqSzOv8lw Dl_318493_;
...
N_LIB_PRIVATE N_NIMCALL(void, initTerminal_5wvPzFalXz1eZEj3h1czDw)(tyObject_PTerminalcolonObjectType__EcU8GhMNGo9bGDXbfqZ82og* term) {
	NI hStdoutTemp;
	NI hStderrTemp;
	hStdoutTemp = Dl_229620_(((NI32) -11));
	{
		NI T3_;
		NI T4_;
		NI32 T5_;
		...
		T4_ = Dl_318316_();
		T5_ = (NI32)0;
		T5_ = Dl_318306_(T3_, hStdoutTemp, T4_, (&(*term).hStdout), ((NI32) 0), ((NI32) 1), ((NI32) 2));
		if (!(T5_ == ((NI32) 0))) goto LA6_;
	}
	LA6_: ;
	hStderrTemp = Dl_229620_(((NI32) -12));
	{
		NI T10_;
		NI T11_;
		NI32 T12_;
		...
		T11_ = Dl_318316_();
		T12_ = (NI32)0;
		T12_ = Dl_318306_(T10_, hStderrTemp, T11_, (&(*term).hStderr), ((NI32) 0), ((NI32) 1), ((NI32) 2));
		if (!(T12_ == ((NI32) 0))) goto LA13_;
	}
	LA13_: ;
	(*term).oldStdoutAttr = getAttributes_PnaHeFPQ8QlJWgnEjaRyCg((*term).hStdout);
	(*term).oldStderrAttr = getAttributes_PnaHeFPQ8QlJWgnEjaRyCg((*term).hStderr);
}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_PTerminalcolonObjectType__EcU8GhMNGo9bGDXbfqZ82og*, newTerminal_Xqu71GJoz9bsJBdRC0m9cqrA)(void) {
	...
	initTerminal_5wvPzFalXz1eZEj3h1czDw(result);
	return result;
}
...
static N_INLINE(tyObject_PTerminalcolonObjectType__EcU8GhMNGo9bGDXbfqZ82og*, getTerminal_eaf5C0KoL9blsRnH3dpKg9cAterminal)(void) {
	...
	result = (tyObject_PTerminalcolonObjectType__EcU8GhMNGo9bGDXbfqZ82og*)0;
	{
		...
		asgnRefNoCycle((void**) (&gTerm_wkpx9csKte2r1l45yvskIcA), newTerminal_Xqu71GJoz9bsJBdRC0m9cqrA());
	}
	LA3_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, resetAttributes_C9brcOCfawV8VFMwyfSRaWQ)(FILE* f) {
	...
	term = getTerminal_eaf5C0KoL9blsRnH3dpKg9cAterminal();
	{
		...
		if (!(f == stderr)) goto LA3_;
		T5_ = (NI32)0;
		T5_ = Dl_318493_((*term).hStderr, (*term).oldStderrAttr);
		T5_;
	}
	goto LA1_;
	LA3_: ;
	{
		NI32 T7_;
		T7_ = (NI32)0;
		T7_ = Dl_318493_((*term).hStdout, (*term).oldStdoutAttr);
		T7_;
	}
	LA1_: ;
}
...
N_LIB_PRIVATE N_NIMCALL(void, setForegroundColor_pQ6uHp6t9ccVTSBEnIyzxsA)(FILE* f, tyEnum_ForegroundColor_ez9ah4IgQc0AbdW68acioDg fg, NIM_BOOL bright) {
	...
	LA11_: ;
	{
		...
		T20_ = (NI32)0;
		T20_ = Dl_318493_(h, ((NI16)(NU16)(NU)(((NI) ((NI16)(old | defaultForegroundColor_6AZwdPXNbiAiBenoe9ctX8Q))))));
		T20_;
	}
	goto LA16_;
	LA18_: ;
	{
		NI32 T22_;
		T22_ = (NI32)0;
		T22_ = Dl_318493_(h, ((NI16)(NU16)(NU)((NI)(((NI) (old)) | lookup_iBTamPHB6H8lJIzDyv8epw[(fg)- 30]))));
		T22_;
	}
	LA16_: ;
}
...
static TNimNode* TM_CN3raB9atujkEiPpxYAdlgQ_2[7];
...
TM_CN3raB9atujkEiPpxYAdlgQ_2[3] = &TM_CN3raB9atujkEiPpxYAdlgQ_0[4];
...
TM_CN3raB9atujkEiPpxYAdlgQ_2[4] = &TM_CN3raB9atujkEiPpxYAdlgQ_0[5];
...
TM_CN3raB9atujkEiPpxYAdlgQ_2[5] = &TM_CN3raB9atujkEiPpxYAdlgQ_0[6];
...
TM_CN3raB9atujkEiPpxYAdlgQ_2[6] = &TM_CN3raB9atujkEiPpxYAdlgQ_0[7];
...
TM_CN3raB9atujkEiPpxYAdlgQ_0[0].len = 7; TM_CN3raB9atujkEiPpxYAdlgQ_0[0].kind = 2; TM_CN3raB9atujkEiPpxYAdlgQ_0[0].sons = &TM_CN3raB9atujkEiPpxYAdlgQ_2[0];
...
if (!((TM_CN3raB9atujkEiPpxYAdlgQ_4 = nimLoadLibrary(((NimStringDesc*) &TM_CN3raB9atujkEiPpxYAdlgQ_6)))
	...
	Dl_318306_ = (tyProc_oew1DfaGl5XhHmnBK0HYXQ) nimGetProcAddr(TM_CN3raB9atujkEiPpxYAdlgQ_4, "DuplicateHandle");
	Dl_318316_ = (tyProc_uryidYWkntM7ddjZSyxvyQ) nimGetProcAddr(TM_CN3raB9atujkEiPpxYAdlgQ_4, "GetCurrentProcess");
	Dl_318318_ = (tyProc_vjGHiWUJwFzOgSxDffBb6Q) nimGetProcAddr(TM_CN3raB9atujkEiPpxYAdlgQ_4, "GetConsoleScreenBufferInfo");
	Dl_318493_ = (tyProc_oPCjp4xTgEl9a8fqSzOv8lw) nimGetProcAddr(TM_CN3raB9atujkEiPpxYAdlgQ_4, "SetConsoleTextAttribute");
}
