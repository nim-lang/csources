...
N_NIMCALL(void, setintlittype_218430)(tnode173659* result);
...
N_NIMCALL(ttype173693*, getintlittype_218317)(tnode173659* literal) {
	...
	nimln(106, "magicsys.nim");
	{
		...
		result = inttypecache_218243[(((NI)chckRange64(value, (-2147483647 -1), 2147483647)))- -5];
		nimln(108, "magicsys.nim");
		{
			...
			if (((NI)chckRange64(value, (-2147483647 -1), 2147483647)) < -5 || ((NI)chckRange64(value, (-2147483647 -1), 2147483647)) > 64) raiseIndexError();
			asgnRefNoCycle((void**) &inttypecache_218243[(((NI)chckRange64(value, (-2147483647 -1), 2147483647)))- -5], result);
		}		LA9: ;
	}	goto LA1;
	LA5: ;
	{
