...
STRING_LITERAL(T_6xNBOpPeN0DsJ34t7RoSng_9, "js", 2);
STRING_LITERAL(T_6xNBOpPeN0DsJ34t7RoSng_10, " ", 1);
STRING_LITERAL(T_6xNBOpPeN0DsJ34t7RoSng_11, "php", 3);
STRING_LITERAL(T_6xNBOpPeN0DsJ34t7RoSng_12, "php ", 4);
STRING_LITERAL(T_6xNBOpPeN0DsJ34t7RoSng_13, "exe", 3);
...
{	{
	...
	LA4: ;
	{
		...
		processcmdline_tw2pZl8Nisz38VPmsT5WZA(((Tcmdlinepass_IiBn9cB6WYIMDHOT44O82wA) 0), ((NimStringDesc*) &T_6xNBOpPeN0DsJ34t7RoSng_2));
		{
			...
			asgnRefNoCycle((void**) (&gprojectpath_RQlrqBW2RHkKfot9caCcOtQ), canonicalizepath_hXI3LWBWedZbdPyAYn0KOQ(LOC13));
		...
		LA9: ;
		{
			...
			LA21: ;
			asgnRefNoCycle((void**) (&gprojectpath_RQlrqBW2RHkKfot9caCcOtQ), canonicalizepath_hXI3LWBWedZbdPyAYn0KOQ(dir0));
		...
		LA15: ;
		{
			...
			asgnRefNoCycle((void**) (&gprojectpath_RQlrqBW2RHkKfot9caCcOtQ), canonicalizepath_hXI3LWBWedZbdPyAYn0KOQ(LOC28));
		}
		LA7: ;
		...
		maincommand_9ckTkd2AM27sYCvHGluAXLg(LOC48, cache0);
		{
			...
			printf("%s\015\012", LOC55? (LOC55)->data:"nil");
			fflush(stdout);
		}
		LA53: ;
		{
			if (!(gerrorcounter_BdMIKofstJQD5Y2GBaRdzQ == ((NI) 0))) goto LA58;
			{
				if (!((gglobaloptions_j042VVDC9cT5ENYoXnmhhVg &((NU64)1<<((NU)(((Tglobaloption_RAfAEZqjnKMDumgyKKc1qw) 13))&63U)))!=0)) goto LA62;
				{
					...
					LA70: ;
					{
						...
						LOC74 = noschangeFileExt(gprojectfull_V1rcVHDANDR4ly2ul00asg, ((NimStringDesc*) &T_6xNBOpPeN0DsJ34t7RoSng_9));
						LOC75 = (NimStringDesc*)0;
						LOC75 = prependcurdir_GjIeuxoFFHzgsN9aaFgTDcg(LOC74);
						LOC76 = (NimStringDesc*)0;
						LOC76 = completecfilepath_XziFVTv1mJIlNEw2aMU1Ig(LOC75, NIM_TRUE);
...
appendString(LOC77, ((NimStringDesc*) &T_6xNBOpPeN0DsJ34t7RoSng_10));
...
appendString(LOC77, arguments_J4sVmqKDJ3MkfxziRX9cODA);
				...
				LA66: ;
				{
					...
					LA84: ;
					{
						...
						LOC88 = noschangeFileExt(gprojectfull_V1rcVHDANDR4ly2ul00asg, ((NimStringDesc*) &T_6xNBOpPeN0DsJ34t7RoSng_11));
						LOC89 = (NimStringDesc*)0;
						LOC89 = prependcurdir_GjIeuxoFFHzgsN9aaFgTDcg(LOC88);
						LOC90 = (NimStringDesc*)0;
						LOC90 = completecfilepath_XziFVTv1mJIlNEw2aMU1Ig(LOC89, NIM_TRUE);
						ex0 = nospquoteShell(LOC90);
					}
					LA82: ;
					LOC91 = (NimStringDesc*)0;
					LOC91 = rawNewString(ex0->Sup.len + arguments_J4sVmqKDJ3MkfxziRX9cODA->Sup.len + 5);
appendString(LOC91, ((NimStringDesc*) &T_6xNBOpPeN0DsJ34t7RoSng_12));
...
appendString(LOC91, arguments_J4sVmqKDJ3MkfxziRX9cODA);
				...
				LA80: ;
				{
					...
					LA95: ;
					{
						...
						LOC98 = noschangeFileExt(gprojectfull_V1rcVHDANDR4ly2ul00asg, ((NimStringDesc*) &T_6xNBOpPeN0DsJ34t7RoSng_13));
