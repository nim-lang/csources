...
{	{
	...
	LA4: ;
	{
		...
		scriptfile = noschangeFileExt(gprojectfull_163201, ((NimStringDesc*) &TMP2066));
		{
			...
			if (!LOC25) goto LA26;
			runnimscript_537201(scriptfile);
			{
		...
		maincommand_534610();
		{
			...
			if (!(LOC44)) goto LA45;
			LOC44 = ((gnotes_185080 &((NU64)1<<((NU)((((NU16) 289)- 237))&63U)))!=0);
			LA45: ;
			if (!LOC44) goto LA46;
			LOC48 = 0;
		...
		LA46: ;
		{
			if (!(gerrorcounter_185081 == ((NI) 0))) goto LA51;
			{
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	...
	msgquit_185152(((NI8) ((((NI) 0) < gerrorcounter_185081))));
}
