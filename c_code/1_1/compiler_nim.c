...
STRING_LITERAL(TM_6xNBOpPeN0DsJ34t7RoSng_9, "js", 2);
STRING_LITERAL(TM_6xNBOpPeN0DsJ34t7RoSng_10, " ", 1);
STRING_LITERAL(TM_6xNBOpPeN0DsJ34t7RoSng_11, "php", 3);
STRING_LITERAL(TM_6xNBOpPeN0DsJ34t7RoSng_12, "php ", 4);
STRING_LITERAL(TM_6xNBOpPeN0DsJ34t7RoSng_13, "exe", 3);
...
{	{
	...
	LA4_: ;
	{
		...
		processCmdLine_tw2pZl8Nisz38VPmsT5WZA(((tyEnum_TCmdLinePass_IiBn9cB6WYIMDHOT44O82wA) 0), ((NimStringDesc*) &TM_6xNBOpPeN0DsJ34t7RoSng_2));
		{
			...
			asgnRefNoCycle((void**) (&gProjectPath_RQlrqBW2RHkKfot9caCcOtQ), canonicalizePath_hXI3LWBWedZbdPyAYn0KOQ(T13_));
		...
		LA9_: ;
		{
			...
			if (TM_6xNBOpPeN0DsJ34t7RoSng_5.status == 0) {
				asgnRefNoCycle((void**) (&gProjectFull_V1rcVHDANDR4ly2ul00asg), canonicalizePath_hXI3LWBWedZbdPyAYn0KOQ(gProjectName_QOoHniL6MYtzlAjpv8zzdA));
				popSafePoint();
			}
			else {
				popSafePoint();
			...
			LA21_: ;
			asgnRefNoCycle((void**) (&gProjectPath_RQlrqBW2RHkKfot9caCcOtQ), canonicalizePath_hXI3LWBWedZbdPyAYn0KOQ(dir));
		...
		LA15_: ;
		{
			...
			asgnRefNoCycle((void**) (&gProjectPath_RQlrqBW2RHkKfot9caCcOtQ), canonicalizePath_hXI3LWBWedZbdPyAYn0KOQ(T28_));
		}
		LA7_: ;
		...
		scriptFile = noschangeFileExt(gProjectFull_V1rcVHDANDR4ly2ul00asg, ((NimStringDesc*) &TM_6xNBOpPeN0DsJ34t7RoSng_7));
		{
			NIM_BOOL T31_;
			T31_ = (NIM_BOOL)0;
			T31_ = fileExists_yTPrfdEKg9cKCeSFUA6popQmodulepaths(scriptFile);
			if (!T31_) goto LA32_;
		...
		LA32_: ;
		{
			...
			T40_ = (NIM_BOOL)0;
			T40_ = fileExists_yTPrfdEKg9cKCeSFUA6popQmodulepaths(T39_);
			if (!T40_) goto LA41_;
			...
			if (!(gErrorCounter_BdMIKofstJQD5Y2GBaRdzQ == ((NI) 0))) goto LA58_;
			{
				if (!((gGlobalOptions_j042VVDC9cT5ENYoXnmhhVg &(1U<<((NU)(((tyEnum_TGlobalOption_RAfAEZqjnKMDumgyKKc1qw) 12))&31U)))!=0)) goto LA62_;
				{
					...
					LA70_: ;
					{
						...
						T74_ = noschangeFileExt(gProjectFull_V1rcVHDANDR4ly2ul00asg, ((NimStringDesc*) &TM_6xNBOpPeN0DsJ34t7RoSng_9));
...
appendString(T77_, ((NimStringDesc*) &TM_6xNBOpPeN0DsJ34t7RoSng_10));
...
appendString(T77_, arguments_J4sVmqKDJ3MkfxziRX9cODA);
				...
				LA66_: ;
				{
					...
					LA84_: ;
					{
						...
						T88_ = noschangeFileExt(gProjectFull_V1rcVHDANDR4ly2ul00asg, ((NimStringDesc*) &TM_6xNBOpPeN0DsJ34t7RoSng_11));
...
appendString(T91_, ((NimStringDesc*) &TM_6xNBOpPeN0DsJ34t7RoSng_12));
...
appendString(T91_, arguments_J4sVmqKDJ3MkfxziRX9cODA);
				...
				LA80_: ;
				{
					...
					LA95_: ;
					{
						...
						T98_ = noschangeFileExt(gProjectFull_V1rcVHDANDR4ly2ul00asg, ((NimStringDesc*) &TM_6xNBOpPeN0DsJ34t7RoSng_13));
