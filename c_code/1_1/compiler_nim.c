...
{	{
	...
	LA4: ;
	{
		...
		scriptfile0 = noschangeFileExt(gprojectfull_168211_2607990831, ((NimStringDesc*) &T957294627_7));
		{
			...
			if (!LOC25) goto LA26;
			runnimscript_594217_3062286716(scriptfile0, NIM_FALSE);
			{
		...
		LA26: ;
		{
			...
			runnimscript_594217_3062286716(LOC37, NIM_FALSE);
		}
		goto LA23;
		LA35: ;
		LA23: ;
		...
		maincommand_591610_6460232();
		{
			...
			if (!(LOC44)) goto LA45;
			LOC44 = ((gnotes_190071_155036129 &((NU64)1<<((NU)((((Tmsgkind189002) 289)- 237))&63U)))!=0);
			LA45: ;
			if (!LOC44) goto LA46;
		...
		LA46: ;
		{
			if (!(gerrorcounter_190072_155036129 == ((NI) 0))) goto LA51;
			{
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	...
	msgquit_190149_155036129(((NI8) ((((NI) 0) < gerrorcounter_190072_155036129))));
}
