...
N_NIMCALL(void, hswritedata_146631)(tstream143629* s_146633, void* buffer, NI buflen);
N_NIMCALL(tfilehandlestream146605*, newfilehandlestream_146643)(NI handle);
N_NIMCALL(void, TMP981)(void* p, NI op);
N_NIMCALL(void*, newObj)(TNimType* typ, NI size);
N_NIMCALL(NCSTRING, buildcommandline_146660)(NimStringDesc* a, NimStringDesc** args, NI argsLen0);
N_NOCONV(void*, alloc0_4004)(NI size);
N_NIMCALL(NCSTRING, buildenv_146684)(tstringtable113610* env);
N_NIMCALL(void, createpipehandles_146731)(NI* rdhandle, NI* wrhandle);
static N_INLINE(void, fileclose_146745)(NI h);
...
N_NIMCALL(tprocess145203*, startcmd_145428)(NimStringDesc* command, NU8 options) {
	...
	a = (TY9552*) newSeq((&NTI9552), (NI32)(TMP958));
	i_145473 = 0;
	HEX3Atmp_145475 = 0;
	...
	while (1) {
		...
		if ((NU)((NI32)(TMP960)) >= (NU)(a->Sup.len)) raiseIndexError();
		if ((NU)(i_145473) >= (NU)(c->Sup.len)) raiseIndexError();
		LOC2 = 0;
		LOC2 = a->data[(NI32)(TMP960)]; a->data[(NI32)(TMP960)] = copyStringRC1(c->data[i_145473]);
...
N_NIMCALL(NI, hsreaddata_146617)(tstream143629* s_146619, void* buffer, NI buflen) {
	...
	a = Dl_89824((*s).Handle, buffer, ((int) (buflen)), &br, NIM_NIL);
...
N_NIMCALL(void, hswritedata_146631)(tstream143629* s_146633, void* buffer, NI buflen) {
	...
	if (s_146633) chckObj((*s_146633).Sup.m_type, (&NTI146605));
	s = ((tfilehandlestream146605*) (s_146633));
	byteswritten = 0;
	nimln(350, "osproc.nim");
	a = Dl_89833((*s).Handle, buffer, ((int) (buflen)), &byteswritten, NIM_NIL);
...
N_NIMCALL(tfilehandlestream146605*, newfilehandlestream_146643)(NI handle) {
	...
	(*result).Sup.Writedataimpl = hswritedata_146631;
	popFrame();
	return result;
}
N_NIMCALL(NCSTRING, buildcommandline_146660)(NimStringDesc* a, NimStringDesc** args, NI argsLen0) {
	...
	while (1) {
		NimStringDesc* LOC2;
		nimln(1309, "system.nim");
		if (!(res_146679 <= HEX3Atmp_146677)) goto LA1;
		nimln(1308, "system.nim");
		i_146676 = res_146679;
		...
		nimln(365, "osproc.nim");
		if ((NU)(i_146676) >= (NU)(argsLen0)) raiseIndexError();
		LOC2 = 0;
		LOC2 = nospquoteShell(args[i_146676]);
		res = resizeString(res, LOC2->Sup.len + 0);
appendString(res, LOC2);
		nimln(1311, "system.nim");
		res_146679 = addInt(res_146679, 1);
	} LA1: ;
...
N_NIMCALL(NCSTRING, buildenv_146684)(tstringtable113610* env) {
	NCSTRING result;
	NI l;
	NimStringDesc* key_146689;
	NimStringDesc* val_146690;
	NI h_146716;
	NI HEX3Atmp_146718;
	NI res_146720;
	NI TMP985;
	void* LOC6;
	NimStringDesc* key_146701;
	NimStringDesc* val_146702;
	NI h_146723;
	NI HEX3Atmp_146725;
	NI res_146727;
	...
	nimln(40, "strtabs.nim");
	HEX3Atmp_146718 = ((*env).Data->Sup.len-1);
	nimln(1308, "system.nim");
	res_146720 = 0;
	nimln(1309, "system.nim");
	while (1) {
		nimln(1309, "system.nim");
		if (!(res_146720 <= HEX3Atmp_146718)) goto LA1;
		nimln(1308, "system.nim");
		h_146716 = res_146720;
		nimln(41, "strtabs.nim");
		{
			...
			nimln(41, "strtabs.nim");
			nimln(41, "strtabs.nim");
			if ((NU)(h_146716) >= (NU)((*env).Data->Sup.len)) raiseIndexError();
			if (!!((*env).Data->data[h_146716].Field0 == 0)) goto LA4;
			nimln(42, "strtabs.nim");
			if ((NU)(h_146716) >= (NU)((*env).Data->Sup.len)) raiseIndexError();
			key_146689 = (*env).Data->data[h_146716].Field0;
			nimln(42, "strtabs.nim");
			if ((NU)(h_146716) >= (NU)((*env).Data->Sup.len)) raiseIndexError();
			val_146690 = (*env).Data->data[h_146716].Field1;
			nimln(371, "osproc.nim");
			nimln(371, "osproc.nim");
			nimln(371, "osproc.nim");
			nimln(371, "osproc.nim");
			nimln(371, "osproc.nim");
			TMP983 = addInt(key_146689->Sup.len, val_146690->Sup.len);
			TMP984 = addInt((NI32)(TMP983), 2);
			l = addInt(l, (NI32)(TMP984));
		}		LA4: ;
		nimln(1311, "system.nim");
	...
	nimln(40, "strtabs.nim");
	nimln(40, "strtabs.nim");
	HEX3Atmp_146725 = ((*env).Data->Sup.len-1);
	nimln(1308, "system.nim");
	res_146727 = 0;
	nimln(1309, "system.nim");
	while (1) {
		nimln(1309, "system.nim");
		if (!(res_146727 <= HEX3Atmp_146725)) goto LA7;
		nimln(1308, "system.nim");
		h_146723 = res_146727;
		nimln(41, "strtabs.nim");
		{
			...
			nimln(41, "strtabs.nim");
			nimln(41, "strtabs.nim");
			if ((NU)(h_146723) >= (NU)((*env).Data->Sup.len)) raiseIndexError();
			if (!!((*env).Data->data[h_146723].Field0 == 0)) goto LA10;
			nimln(42, "strtabs.nim");
			if ((NU)(h_146723) >= (NU)((*env).Data->Sup.len)) raiseIndexError();
			key_146701 = (*env).Data->data[h_146723].Field0;
			nimln(42, "strtabs.nim");
			if ((NU)(h_146723) >= (NU)((*env).Data->Sup.len)) raiseIndexError();
			val_146702 = (*env).Data->data[h_146723].Field1;
			nimln(375, "osproc.nim");
			nimln(375, "osproc.nim");
			LOC12 = 0;
			LOC12 = rawNewString(key_146701->Sup.len + val_146702->Sup.len + 1);
appendString(LOC12, key_146701);
appendString(LOC12, ((NimStringDesc*) &TMP986));
appendString(LOC12, val_146702);
			x = LOC12;
			nimln(376, "osproc.nim");
			nimln(376, "osproc.nim");
			nimln(376, "osproc.nim");
			TMP987 = addInt(x->Sup.len, 1);
			memcpy(((void*) (&result[l])), ((void*) (x->data)), (NI32)(TMP987));			nimln(377, "osproc.nim");
			nimln(377, "osproc.nim");
			nimln(377, "osproc.nim");
			TMP988 = addInt(x->Sup.len, 1);
			l = addInt(l, (NI32)(TMP988));
		}		LA10: ;
		nimln(1311, "system.nim");
		res_146727 = addInt(res_146727, 1);
	} LA7: ;
	popFrame();
	return result;
}
N_NIMCALL(void, createpipehandles_146731)(NI* rdhandle, NI* wrhandle) {
	...
	nimln(388, "osproc.nim");
	piinheritablepipe.Nlength = ((int) (((NI)sizeof(tsecurityattributes89653))));
...
N_NIMCALL(tprocess145203*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, tstringtable113610* env, NU8 options) {
	...
	nimln(408, "osproc.nim");
	si.Cb = ((int) (((NI)sizeof(tstartupinfo89655))));
	nimln(409, "osproc.nim");
	{
		...
		createpipehandles_146731(&si.Hstdinput, &hi);		nimln(412, "osproc.nim");
		createpipehandles_146731(&ho, &si.Hstdoutput);		nimln(413, "osproc.nim");
		{
			nimln(730, "system.nim");
		...
		LA7: ;
		{
			...
			createpipehandles_146731(&he, &si.Hstderror);		}		LA5: ;
	...
	cmdl = buildcommandline_146660(command, args, argsLen0);
	...
	nimln(451, "osproc.nim");
	{
		...
		fileclose_146745(si.Hstdinput);		nimln(453, "osproc.nim");
		fileclose_146745(si.Hstdoutput);		nimln(454, "osproc.nim");
		{
			nimln(731, "system.nim");
			nimln(731, "system.nim");
			if (!!(((options &(1<<((((NU8) 2))&7)))!=0))) goto LA31;
			nimln(455, "osproc.nim");
			fileclose_146745(si.Hstderror);		}		LA31: ;
	}	LA27: ;
...
N_NIMCALL(NI, nospwaitForExit)(tprocess145203* p, NI timeout) {
	...
	nimln(488, "osproc.nim");
	LOC1 = 0;
	LOC1 = Dl_90010((*p).Fprocesshandle, ((NI32) (timeout)));
	res = 0;
...
N_NIMCALL(tstream143629*, nospinputStream)(tprocess145203* p) {
	...
	nimln(504, "osproc.nim");
	LOC1 = 0;
	LOC1 = newfilehandlestream_146643(((NI) ((*p).Inhandle)));
	result = &LOC1->Sup;
	popFrame();
	return result;
}
N_NIMCALL(tstream143629*, nospoutputStream)(tprocess145203* p) {
	...
	nimln(507, "osproc.nim");
	LOC1 = 0;
	LOC1 = newfilehandlestream_146643(((NI) ((*p).Outhandle)));
	result = &LOC1->Sup;
	popFrame();
	return result;
}
N_NIMCALL(tstream143629*, nosperrorStream)(tprocess145203* p) {
	...
	nimln(510, "osproc.nim");
	LOC1 = 0;
	LOC1 = newfilehandlestream_146643(((NI) ((*p).Errhandle)));
	result = &LOC1->Sup;
	popFrame();
	return result;
}
...
N_NIMCALL(NI, select_146502)(TY146202** readfds, NI timeout) {
	...
	nimln(547, "osproc.nim");
	ret = Dl_91378(((NI32) ((*readfds)->Sup.len)), rfds, ((NI32) 0), ((NI32) (timeout)));
