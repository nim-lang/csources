...
N_NIMCALL(void, fillbuffer_177072)(tbaselexer177018* l) {
	...
	nimln(85, "nimlexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI32)(TMP1650)])), (NI32)(TMP1651));
	}
	LA11: ;
	...
	TMP1653 = mulInt((NI32)(TMP1652), 1);
	LOC13 = 0;
	LOC13 = llstreamread_175242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI32)(TMP1653));
	TMP1654 = divInt(LOC13, 1);
	charsread = (NI32)(TMP1654);
	...
	nimln(91, "nimlexbase.nim");
	{
		...
		if (!(charsread < (NI32)(TMP1656))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI32)(TMP1658);
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				TMP1659 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4631(((void*) ((*l).Buf)), (NI32)(TMP1659));
				...
				nimln(110, "nimlexbase.nim");
				{
					...
					if (!!(((NI32)(TMP1660) == oldbuflen))) goto LA35;
					nimln(110, "nimlexbase.nim");
				...
				LOC37 = 0;
				LOC37 = llstreamread_175242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI32)(TMP1662));
				TMP1663 = divInt(LOC37, 1);
				charsread = (NI32)(TMP1663);
...
N_NIMCALL(NI, getcolnumber_177045)(tbaselexer177018* l, NI pos) {
	...
	if ((NI32)(TMP1674) == (-2147483647 -1)) raiseOverflow();
	result = (NI32)abs((NI32)(TMP1674));
	popFrame();
	return result;
}
