...
N_NIMCALL(tnode191813*, close_525014)(tpasscontext250003* p, tnode191813* n) {
	...
	nimln(25, "docgen2.nim");
	{
		...
		writeoutput_348719((*g).Doc, LOC7, ((NimStringDesc*) &TMP7615), usewarning);
		nimln(27, "docgen2.nim");
		pushSafePoint(&TMP7616);
		TMP7616.status = setjmp(TMP7616.context);
		if (TMP7616.status == 0) {
		...
		if (TMP7616.status != 0) reraiseException();
	}
	LA5: ;
	popFrame();
	return result;
...
static TNimNode* TMP7614[2];
static TNimNode TMP7612[3];
NTI525008.size = sizeof(tgen525008);
NTI525008.kind = 17;
NTI525008.base = (&NTI250003);
TMP7614[0] = &TMP7612[1];
TMP7612[1].kind = 1;
TMP7612[1].offset = offsetof(tgen525008, Doc);
TMP7612[1].typ = (&NTI345007);
TMP7612[1].name = "doc";
TMP7614[1] = &TMP7612[2];
TMP7612[2].kind = 1;
TMP7612[2].offset = offsetof(tgen525008, Module);
TMP7612[2].typ = (&NTI191811);
TMP7612[2].name = "module";
TMP7612[0].len = 2; TMP7612[0].kind = 2; TMP7612[0].sons = &TMP7614[0];
NTI525008.node = &TMP7612[0];
NTI525010.size = sizeof(tgen525008*);
NTI525010.kind = 22;
NTI525010.base = (&NTI525008);
NTI525010.marker = TMP7617;
}
