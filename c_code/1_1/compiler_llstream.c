...
N_NIMCALL(NI, counttriples_163462)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1604 = addInt(i, 1);
			if ((NU)((NI32)(TMP1604)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI32)(TMP1604)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1605 = addInt(i, 2);
			if ((NU)((NI32)(TMP1605)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI32)(TMP1605)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
appendString((*s).S, ((NimStringDesc*) &TMP1608));
	...
	result = ((buflen <= (NI32)(TMP1609)) ? buflen : (NI32)(TMP1609));
...
N_NIMCALL(NI, llstreamread_163242)(tllstream163204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		result = ((buflen <= (NI32)(TMP1610)) ? buflen : (NI32)(TMP1610));
		nimln(136, "llstream.nim");
		{
			...
			if ((NU)((NI32)(TMP1611)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI32)(TMP1611)])), result);			nimln(138, "llstream.nim");
			(*s).Rd = addInt((*s).Rd, result);
		}		LA5: ;
	}	break;
	case ((NU8) 2):
...
N_NIMCALL(void, llstreamwrite_163268)(tllstream163204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			(*s).S = setLengthStr((*s).S, (NI32)(TMP1612));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1613 = addInt(0, (*s).Wr);
			if ((NU)((NI32)(TMP1613)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI32)(TMP1613)])), buf, buflen);			nimln(202, "llstream.nim");
...
N_NIMCALL(NimStringDesc*, llstreamreadall_163254)(tllstream163204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI32)(TMP1614));
			nimln(223, "llstream.nim");
			nimln(223, "llstream.nim");
			TMP1615 = addInt(i, 0);
			if ((NU)((NI32)(TMP1615)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_9514((*s).F, ((void*) (&result->data[(NI32)(TMP1615)])), 2048);
