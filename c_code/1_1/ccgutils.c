...
static N_INLINE(ttype191847*, lastson_192203)(ttype191847* n) {
	...
	if ((NU)((NI32)(TMP6193)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP6193)];
	popFrame();
	return result;
}
...
N_NIMCALL(trope148007*, makellvmstring_469723)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(190, "ccgutils.nim");
		{
			...
			TMP6203 = modInt((NI32)(TMP6202), 64);
			if (!(((NI) ((NI32)(TMP6203))) == 0)) goto LA4;
