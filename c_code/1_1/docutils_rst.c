...
N_NIMCALL(NIM_BOOL, isdeflist_326905)(trstparser322659* p) {
	...
	LOC1 = LOC2;
	if (!(LOC1)) goto LA4;
	LOC1 = !(eqStrings((*p).Tok->data[(NI32)(j - 2)].Symbol, ((NimStringDesc*) &TMP2515)));
	LA4: ;
	result = LOC1;
	return result;
}
	...
	{
		{
			NIM_BOOL LOC4;
			LOC4 = 0;
			LOC4 = match_323995(p, (NI32)((*p).Idx + 1), ((NimStringDesc*) &TMP2511));
			if (!LOC4) goto LA5;
			result = ((NU8) 3);
		}
		goto LA2;
		LA5: ;
		{
			NIM_BOOL LOC8;
			LOC8 = 0;
			LOC8 = match_323995(p, (NI32)((*p).Idx + 1), ((NimStringDesc*) &TMP2512));
			if (!LOC8) goto LA9;
			result = ((NU8) 29);
		}
		goto LA2;
		LA9: ;
		{
			NIM_BOOL LOC12;
			LOC12 = 0;
			LOC12 = match_323995(p, (NI32)((*p).Idx + 1), ((NimStringDesc*) &TMP2513));
			if (!LOC12) goto LA13;
			result = ((NU8) 2);
		}
		goto LA2;
		...
		(*p).Idx += 2;
		{
			while (1) {
				...
				add_321183(result, item);
				{
					...
					LOC10 = LOC11;
					if (!(LOC10)) goto LA13;
					LOC10 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2519));
					LA13: ;
					LOC9 = LOC10;
					if (!(LOC9)) goto LA14;
					LOC9 = ((*p).Tok->data[(NI32)((*p).Idx + 2)].Kind == ((NU8) 2));
...
{	result = 0;
	...
	LOC5 = LOC6;
	if (LOC5) goto LA8;
	LOC5 = ((TMP2542[((NU8)((*p).Tok->data[(NI32)((*p).Idx - 1)].Symbol->data[0]))/8] &(1<<(((NU8)((*p).Tok->data[(NI32)((*p).Idx - 1)].Symbol->data[0]))%8)))!=0);
	LA8: ;
	result = LOC5;
	{
		if (!!(result)) goto LA11;
	...
	LA15: ;
	{
		...
		{
			if (!eqStrings((*p).Tok->data[(NI32)((*p).Idx - 1)].Symbol, ((NimStringDesc*) &TMP2543))) goto LA23;
			result = NIM_FALSE;
		}
		goto LA21;
		LA23: ;
...
{	result = 0;
	...
	if (LOC9) goto LA10;
	LOC9 = ((TMP2545[((NU8)((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol->data[0]))/8] &(1<<(((NU8)((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol->data[0]))%8)))!=0);
	LA10: ;
	result = LOC9;
	{
		if (!!(result)) goto LA13;
	...
	LA13: ;
	{
		if (!(0 < (*p).Idx)) goto LA17;
		{
			...
			if (!(LOC21)) goto LA22;
			LOC21 = eqStrings((*p).Tok->data[(NI32)((*p).Idx - 1)].Symbol, ((NimStringDesc*) &TMP2543));
			LA22: ;
			if (!LOC21) goto LA23;
			result = NIM_FALSE;
		}
...
N_NIMCALL(trstnode321011*, parsepostfix_324275)(trstparser322659* p, trstnode321011* n) {
	...
	result = n;
	{
		...
		(*p).Idx += 1;
		{
			...
			trstnode321011* b;
			LOC8 = 0;
			LOC8 = eqStrings((*p).Tok->data[(NI32)((*p).Idx - 2)].Symbol, ((NimStringDesc*) &TMP2551));
			if (!(LOC8)) goto LA9;
			LOC8 = eqStrings((*p).Tok->data[(NI32)((*p).Idx - 3)].Symbol, ((NimStringDesc*) &TMP2553));
			LA9: ;
			if (!LOC8) goto LA10;
	...
	LA4: ;
	{
		...
		if (!LOC24) goto LA25;
		{
			if (!eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2555))) goto LA29;
			(*n).Kind = ((NU8) 56);
		}
		goto LA27;
		LA29: ;
		{
			if (!eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2556))) goto LA32;
			(*n).Kind = ((NU8) 61);
		}
		goto LA27;
		LA32: ;
		{
			if (!eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2557))) goto LA35;
			(*n).Kind = ((NU8) 58);
		}
		goto LA27;
		LA35: ;
		{
			if (!eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2558))) goto LA38;
			(*n).Kind = ((NU8) 57);
		}
		goto LA27;
		LA38: ;
		{
			NIM_BOOL LOC41;
			LOC41 = 0;
			LOC41 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2559));
			if (LOC41) goto LA42;
			LOC41 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2560));
			LA42: ;
			if (!LOC41) goto LA43;
			(*n).Kind = ((NU8) 54);
		}
		...
		LA43: ;
		{
			NIM_BOOL LOC46;
			LOC46 = 0;
			LOC46 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2561));
			if (LOC46) goto LA47;
			LOC46 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2562));
			LA47: ;
			if (!LOC46) goto LA48;
			(*n).Kind = ((NU8) 55);
		}
...
N_NIMCALL(NIM_BOOL, isurl_324601)(trstparser322659* p, NI i) {
	...
	LOC2 = 0;
	LOC3 = 0;
	LOC3 = eqStrings((*p).Tok->data[(NI32)(i + 1)].Symbol, ((NimStringDesc*) &TMP2621));
	if (!(LOC3)) goto LA4;
	LOC3 = eqStrings((*p).Tok->data[(NI32)(i + 2)].Symbol, ((NimStringDesc*) &TMP2622));
	LA4: ;
	LOC2 = LOC3;
	if (!(LOC2)) goto LA5;
...
N_NIMCALL(trstnode321011*, parsefields_325761)(trstparser322659* p) {
	...
	atstart = LOC1;
	{
		...
		if (!(LOC6)) goto LA7;
		LOC6 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2621));
		LA7: ;
		LOC5 = LOC6;
		if (LOC5) goto LA8;
		LOC5 = atstart;
		...
		LA18: ;
		{
			while (1) {
				...
				add_321183(result, LOC22);
				{
					...
					LOC25 = LOC26;
					if (!(LOC25)) goto LA28;
					LOC25 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2621));
					LA28: ;
					if (!LOC25) goto LA29;
					(*p).Idx += 1;
				}
...
N_NIMCALL(trstnode321011*, parsedirective_329023)(trstparser322659* p, NU8 flags) {
	...
	add_321183(result, args);
	{
		if (!((flags &(1<<((((NU8) 1))&7)))!=0)) goto LA28;
		{
			...
			LOC32 = LOC33;
			if (!(LOC32)) goto LA35;
			LOC32 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2621));
			LA35: ;
			if (!LOC32) goto LA36;
...
N_NIMCALL(trstnode321011*, parsedefinitionlist_328427)(trstparser322659* p) {
	...
	j = (NI32)(LOC1 - 1);
	{
		...
		LOC4 = LOC5;
		if (!(LOC4)) goto LA10;
		LOC4 = !(eqStrings((*p).Tok->data[(NI32)(j - 1)].Symbol, ((NimStringDesc*) &TMP2515)));
		LA10: ;
		if (!LOC4) goto LA11;
		col = (*p).Tok->data[(*p).Idx].Col;
		result = newrstnode_321105(((NU8) 9));
		{
			while (1) {
				...
				parseline_325683(p, a);
				{
					...
					LOC18 = LOC19;
					if (!(LOC18)) goto LA22;
					LOC18 = !(eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2515)));
					LA22: ;
					LOC17 = LOC18;
					if (!(LOC17)) goto LA23;
				...
				LA15: ;
				{
					...
					j = (NI32)(LOC33 - 1);
					{
						...
						LOC37 = LOC38;
						if (!(LOC37)) goto LA42;
						LOC37 = !(eqStrings((*p).Tok->data[(NI32)(j - 1)].Symbol, ((NimStringDesc*) &TMP2515)));
						LA42: ;
						LOC36 = LOC37;
						if (!(LOC36)) goto LA43;
