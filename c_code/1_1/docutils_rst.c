...
N_NIMCALL(NIM_BOOL, isdeflist_299676)(trstparser296677* p) {
	...
	LOC1 = LOC2;
	if (!(LOC1)) goto LA4;
	LOC1 = !(eqStrings((*p).Tok->data[(NI32)(j - 2)].Symbol, ((NimStringDesc*) &TMP2371)));
	LA4: ;
	result = LOC1;
	return result;
}
	...
	{
		{
			NIM_BOOL LOC4;
			LOC4 = 0;
			LOC4 = match_297647(p, (NI32)((*p).Idx + 1), ((NimStringDesc*) &TMP2367));
			if (!LOC4) goto LA5;
			result = ((NU8) 3);
		}
		goto LA2;
		LA5: ;
		{
			NIM_BOOL LOC8;
			LOC8 = 0;
			LOC8 = match_297647(p, (NI32)((*p).Idx + 1), ((NimStringDesc*) &TMP2368));
			if (!LOC8) goto LA9;
			result = ((NU8) 29);
		}
		goto LA2;
		LA9: ;
		{
			NIM_BOOL LOC12;
			LOC12 = 0;
			LOC12 = match_297647(p, (NI32)((*p).Idx + 1), ((NimStringDesc*) &TMP2369));
			if (!LOC12) goto LA13;
			result = ((NU8) 2);
		}
		goto LA2;
	...
	result = NIM_NIL;
	{
		...
		while (1) {
			...
			add_295163(result, item);
			{
				...
				LOC9 = LOC10;
				if (!(LOC9)) goto LA12;
				LOC9 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2375));
				LA12: ;
				LOC8 = LOC9;
				if (!(LOC8)) goto LA13;
				LOC8 = ((*p).Tok->data[(NI32)((*p).Idx + 2)].Kind == ((NU8) 2));
...
N_NIMCALL(NIM_BOOL, isinlinemarkupstart_297594)(trstparser296677* p, NimStringDesc* markup) {
	...
	LOC5 = LOC6;
	if (LOC5) goto LA8;
	LOC5 = ((TMP2397[((NU8)((*p).Tok->data[(NI32)((*p).Idx - 1)].Symbol->data[0]))/8] &(1<<(((NU8)((*p).Tok->data[(NI32)((*p).Idx - 1)].Symbol->data[0]))%8)))!=0);
	LA8: ;
	result = LOC5;
	{
		if (!!(result)) goto LA11;
	...
	LA15: ;
	{
		...
		{
			if (!eqStrings((*p).Tok->data[(NI32)((*p).Idx - 1)].Symbol, ((NimStringDesc*) &TMP2398))) goto LA23;
			result = NIM_FALSE;
		}
		goto LA21;
		LA23: ;
...
N_NIMCALL(NIM_BOOL, isinlinemarkupend_297544)(trstparser296677* p, NimStringDesc* markup) {
	...
	if (LOC9) goto LA10;
	LOC9 = ((TMP2400[((NU8)((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol->data[0]))/8] &(1<<(((NU8)((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol->data[0]))%8)))!=0);
	LA10: ;
	result = LOC9;
	{
		if (!!(result)) goto LA13;
	...
	LA13: ;
	{
		if (!(0 < (*p).Idx)) goto LA17;
		{
			...
			if (!(LOC21)) goto LA22;
			LOC21 = eqStrings((*p).Tok->data[(NI32)((*p).Idx - 1)].Symbol, ((NimStringDesc*) &TMP2398));
			LA22: ;
			if (!LOC21) goto LA23;
			result = NIM_FALSE;
		}
...
N_NIMCALL(trstnode295009*, parsepostfix_297897)(trstparser296677* p, trstnode295009* n) {
	...
	result = n;
	{
		...
		(*p).Idx += 1;
		{
			...
			trstnode295009* b;
			LOC8 = 0;
			LOC8 = eqStrings((*p).Tok->data[(NI32)((*p).Idx - 2)].Symbol, ((NimStringDesc*) &TMP2406));
			if (!(LOC8)) goto LA9;
			LOC8 = eqStrings((*p).Tok->data[(NI32)((*p).Idx - 3)].Symbol, ((NimStringDesc*) &TMP2408));
			LA9: ;
			if (!LOC8) goto LA10;
	...
	LA4: ;
	{
		...
		if (!LOC24) goto LA25;
		{
			if (!eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2410))) goto LA29;
			(*n).Kind = ((NU8) 56);
		}
		goto LA27;
		LA29: ;
		{
			if (!eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2411))) goto LA32;
			(*n).Kind = ((NU8) 61);
		}
		goto LA27;
		LA32: ;
		{
			if (!eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2412))) goto LA35;
			(*n).Kind = ((NU8) 58);
		}
		goto LA27;
		LA35: ;
		{
			if (!eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2413))) goto LA38;
			(*n).Kind = ((NU8) 57);
		}
		goto LA27;
		LA38: ;
		{
			NIM_BOOL LOC41;
			LOC41 = 0;
			LOC41 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2414));
			if (LOC41) goto LA42;
			LOC41 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2415));
			LA42: ;
			if (!LOC41) goto LA43;
			(*n).Kind = ((NU8) 54);
		}
		...
		LA43: ;
		{
			NIM_BOOL LOC46;
			LOC46 = 0;
			LOC46 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2416));
			if (LOC46) goto LA47;
			LOC46 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2417));
			LA47: ;
			if (!LOC46) goto LA48;
			(*n).Kind = ((NU8) 55);
		}
...
N_NIMCALL(NIM_BOOL, isurl_298201)(trstparser296677* p, NI i) {
	...
	LOC2 = 0;
	LOC3 = 0;
	LOC3 = eqStrings((*p).Tok->data[(NI32)(i + 1)].Symbol, ((NimStringDesc*) &TMP2476));
	if (!(LOC3)) goto LA4;
	LOC3 = eqStrings((*p).Tok->data[(NI32)(i + 2)].Symbol, ((NimStringDesc*) &TMP2477));
	LA4: ;
	LOC2 = LOC3;
	if (!(LOC2)) goto LA5;
...
N_NIMCALL(trstnode295009*, parsefields_299348)(trstparser296677* p) {
	...
	atstart = LOC1;
	{
		...
		if (!(LOC6)) goto LA7;
		LOC6 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2476));
		LA7: ;
		LOC5 = LOC6;
		if (LOC5) goto LA8;
		LOC5 = atstart;
		...
		while (1) {
			...
			add_295163(result, LOC21);
			{
				...
				LOC24 = LOC25;
				if (!(LOC24)) goto LA27;
				LOC24 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2476));
				LA27: ;
				if (!LOC24) goto LA28;
				(*p).Idx += 1;
			}
...
N_NIMCALL(trstnode295009*, parsedirective_301617)(trstparser296677* p, NU8 flags) {
	...
	add_295163(result, args);
	{
		if (!((flags &(1<<((((NU8) 1))&7)))!=0)) goto LA26;
		{
			...
			LOC30 = LOC31;
			if (!(LOC30)) goto LA33;
			LOC30 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2476));
			LA33: ;
			if (!LOC30) goto LA34;
...
N_NIMCALL(trstnode295009*, parsedefinitionlist_301193)(trstparser296677* p) {
	...
	j = (NI32)(LOC1 - 1);
	{
		...
		LOC4 = LOC5;
		if (!(LOC4)) goto LA10;
		LOC4 = !(eqStrings((*p).Tok->data[(NI32)(j - 1)].Symbol, ((NimStringDesc*) &TMP2371)));
		LA10: ;
		if (!LOC4) goto LA11;
		col = (*p).Tok->data[(*p).Idx].Col;
		...
		while (1) {
			...
			parseline_299296(p, a);
			{
				...
				LOC17 = LOC18;
				if (!(LOC17)) goto LA21;
				LOC17 = !(eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2371)));
				LA21: ;
				LOC16 = LOC17;
				if (!(LOC16)) goto LA22;
			...
			LA14: ;
			{
				...
				j = (NI32)(LOC32 - 1);
				{
					...
					LOC36 = LOC37;
					if (!(LOC36)) goto LA41;
					LOC36 = !(eqStrings((*p).Tok->data[(NI32)(j - 1)].Symbol, ((NimStringDesc*) &TMP2371)));
					LA41: ;
					LOC35 = LOC36;
					if (!(LOC35)) goto LA42;
