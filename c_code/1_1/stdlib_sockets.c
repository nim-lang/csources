...
N_NIMCALL(NI, select_190017)(TY191015** readfds, NI timeout);
...
N_NIMCALL(void, createfdset_189418)(tfdset104664* fd, TY191015* s, NI* m);
...
N_NIMCALL(NI, readintobuf_190048)(tsocketimpl182607* socket, NI32 flags);
...
N_NIMCALL(void, send_192808)(tsocketimpl182607* socket, NimStringDesc* data) {
	NI sent;
	{
		valueerror3249* e_192814;
		NimStringDesc* LOC5;
		if (!(*socket).Nonblocking) goto LA3;
		e_192814 = 0;
		e_192814 = (valueerror3249*) newObj((&NTI21201), sizeof(valueerror3249));
		(*e_192814).Sup.Sup.m_type = (&NTI3249);
		LOC5 = 0;
		LOC5 = (*e_192814).Sup.message; (*e_192814).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1980));
		if (LOC5) nimGCunrefNoCycle(LOC5);
		raiseException((Exception*)e_192814, "ValueError");
	}
	LA3: ;
...
appendString(LOC22, ((NimStringDesc*) &TMP4843));
		...
		selret = select_190017(&s, (NI32)(timeout - ((NI) (((NF)((*waited)) * (NF)(1.0000000000000000e+003))))));
		{
			NI32 LOC28;
...
N_NIMCALL(NI, recv_190302)(tsocketimpl182607* socket, void* data, NI size) {
	...
	LA3: ;
	{
		...
		if (!(*socket).Isbuffered) goto LA7;
		{
			...
			res = readintobuf_190048(socket, ((NI32) 0));
			{
				if (!(res <= 0)) goto LA15;
				{
...
N_NIMCALL(void, readline_191447)(tsocketimpl182607* socket, NimStringDesc** line, NI timeout) {
	...
	(*line) = setLengthStr((*line), 0);
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_190618(socket, &waited, timeout, 1, ((NimStringDesc*) &TMP4845));
			...
			LA4: ;
			{
				...
				LOC15 = 0;
				LOC15 = waitfor_190618(socket, &waited, timeout, 1, ((NimStringDesc*) &TMP4845));
