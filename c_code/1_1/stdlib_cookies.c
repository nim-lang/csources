...
N_NIMCALL(NimStringDesc*, setcookie_339117)(NimStringDesc* key, NimStringDesc* value, ttimeinfo99403* expires, NimStringDesc* domain, NimStringDesc* path, NIM_BOOL noname);
N_NIMCALL(NimStringDesc*, format_101399)(ttimeinfo99403* info, NimStringDesc* f);
STRING_LITERAL(TMP4682, "", 0);
STRING_LITERAL(TMP4683, "Set-Cookie: ", 12);
STRING_LITERAL(TMP4684, "=", 1);
STRING_LITERAL(TMP4685, "; Domain=", 9);
STRING_LITERAL(TMP4686, "; Path=", 7);
STRING_LITERAL(TMP4687, "; Expires=", 10);
STRING_LITERAL(TMP4688, "ddd\',\' dd MMM yyyy HH:mm:ss \'UTC\'", 33);
...
N_NIMCALL(tstringtable123810*, parsecookies_339012)(NimStringDesc* s) {
	...
	while (1) {
		...
		TMP4681 = subInt(i, 1);
		LOC16 = 0;
		LOC16 = copyStrLast(s, valstart, (NI32)(TMP4681));
...
N_NIMCALL(NimStringDesc*, setcookie_339106)(NimStringDesc* key, NimStringDesc* value, NimStringDesc* domain, NimStringDesc* path, NimStringDesc* expires, NIM_BOOL noname) {
	...
	result = copyString(((NimStringDesc*) &TMP4682));
...
appendString(LOC5, ((NimStringDesc*) &TMP4684));
...
appendString(LOC10, ((NimStringDesc*) &TMP4685));
...
appendString(LOC15, ((NimStringDesc*) &TMP4686));
...
appendString(LOC20, ((NimStringDesc*) &TMP4687));
...
N_NIMCALL(NimStringDesc*, setcookie_339117)(NimStringDesc* key, NimStringDesc* value, ttimeinfo99403* expires, NimStringDesc* domain, NimStringDesc* path, NIM_BOOL noname) {
	...
	LOC1 = 0;
	LOC1 = format_101399(expires, ((NimStringDesc*) &TMP4688));
