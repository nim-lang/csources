...
N_NIMCALL(NimStringDesc*, setcookie_335106)(NimStringDesc* key, NimStringDesc* value, NimStringDesc* domain, NimStringDesc* path, NimStringDesc* expires, NIM_BOOL noname);
N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src);
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src);
N_NIMCALL(NimStringDesc*, resizeString)(NimStringDesc* dest, NI addlen);
N_NIMCALL(NimStringDesc*, rawNewString)(NI space);
N_NIMCALL(NimStringDesc*, setcookie_335117)(NimStringDesc* key, NimStringDesc* value, ttimeinfo99403* expires, NimStringDesc* domain, NimStringDesc* path, NIM_BOOL noname);
N_NIMCALL(NimStringDesc*, format_101399)(ttimeinfo99403* info, NimStringDesc* f);
STRING_LITERAL(TMP4681, "", 0);
STRING_LITERAL(TMP4682, "Set-Cookie: ", 12);
STRING_LITERAL(TMP4683, "=", 1);
STRING_LITERAL(TMP4684, "; Domain=", 9);
STRING_LITERAL(TMP4685, "; Path=", 7);
STRING_LITERAL(TMP4686, "; Expires=", 10);
STRING_LITERAL(TMP4687, "ddd\',\' dd MMM yyyy HH:mm:ss \'UTC\'", 33);
...
N_NIMCALL(tstringtable123810*, parsecookies_335012)(NimStringDesc* s) {
	...
	while (1) {
		...
		TMP4680 = subInt(i, 1);
		LOC16 = 0;
		LOC16 = copyStrLast(s, valstart, (NI32)(TMP4680));
...
N_NIMCALL(NimStringDesc*, setcookie_335106)(NimStringDesc* key, NimStringDesc* value, NimStringDesc* domain, NimStringDesc* path, NimStringDesc* expires, NIM_BOOL noname) {
	...
	result = copyString(((NimStringDesc*) &TMP4681));
...
appendString(LOC5, ((NimStringDesc*) &TMP4683));
...
appendString(LOC10, ((NimStringDesc*) &TMP4684));
...
appendString(LOC15, ((NimStringDesc*) &TMP4685));
...
appendString(LOC20, ((NimStringDesc*) &TMP4686));
...
N_NIMCALL(NimStringDesc*, setcookie_335117)(NimStringDesc* key, NimStringDesc* value, ttimeinfo99403* expires, NimStringDesc* domain, NimStringDesc* path, NIM_BOOL noname) {
	...
	LOC1 = 0;
	LOC1 = format_101399(expires, ((NimStringDesc*) &TMP4687));
	result = setcookie_335106(key, value, domain, path, LOC1, noname);
	goto BeforeRet;
	BeforeRet: ;
	popFrame();
	return result;
