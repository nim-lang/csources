...
NIM_CONST TY545013 cfilesectionnames_545012 = {((NimStringDesc*) &TMP4113),
...
NIM_CONST TY545019 cprocsectionnames_545018 = {((NimStringDesc*) &TMP4131),
...
N_NIMCALL(void, readkey_545535)(tbaselexer213024* l, NimStringDesc** result) {
	...
	}
	{
		...
		internalerror_197989(((NimStringDesc*) &TMP4032));
	}
	LA5: ;
	(*l).Bufpos = (NI32)(pos + 1);
}
...
N_NIMCALL(void, readtypecache_545607)(tbaselexer213024* l, tidtable224867* result) {
	{
		...
		internalerror_197989(((NimStringDesc*) &TMP4039));
	}
	LA3: ;
	(*l).Bufpos += 1;
	{
...
appendString(r, tnl_174613);
			...
			case 0:
			{
				internalerror_197989(((NimStringDesc*) &TMP4111));
				goto LA1;
			}
			break;
			default:
...
appendString(LOC34, k);
			...
			LA18: ;
			{
				internalerror_197989(((NimStringDesc*) &TMP4135));
			}
			LA11: ;
		}
	} LA5: ;
...
N_NIMCALL(trope177009*, gensectionstart_545126)(NU8 ps) {
	...
	result = 0;
	{
		...
		app_177060(&result, ((NimStringDesc*) &TMP4141));
