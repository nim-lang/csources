...
N_NIMCALL(Tctx244048*, newctx_244281)(Tsym192843* module) {
	...
	LOC3 = 0;
	LOC3 = (*LOC1).errorflag; (*LOC1).errorflag = copyStringRC1(((NimStringDesc*) &TMP2698));
...
static TNimNode* TMP1936[18];
static TNimNode* TMP1938[4];
static TNimNode* TMP1939[2];
static TNimNode* TMP1942[2];
static TNimNode* TMP1943[9];
NI TMP1945;
static char* NIM_CONST TMP1944[9] = {
"slotEmpty", 
"slotFixedVar", 
"slotFixedLet", 
"slotTempUnknown", 
...
"slotTempComplex", 
"slotTempPerm"};
static TNimNode* TMP1947[5];
NI TMP1949;
static char* NIM_CONST TMP1948[5] = {
"emRepl", 
"emConst", 
"emOptimize", 
"emStaticExpr", 
...
NI TMP1952;
static char* NIM_CONST TMP1951[3] = {
"allowCast", 
"allowFFI", 
"allowInfiniteLoops"};
...
NTI244038.base = 0;
NTI244038.flags = 3;
for (TMP1945 = 0; TMP1945 < 9; TMP1945++) {
TMP854[TMP1945+20].kind = 1;
TMP854[TMP1945+20].offset = TMP1945;
TMP854[TMP1945+20].name = TMP1944[TMP1945];
TMP1943[TMP1945] = &TMP854[TMP1945+20];
}
TMP854[29].len = 9; TMP854[29].kind = 2; TMP854[29].sons = &TMP1943[0];
NTI244038.node = &TMP854[29];
TMP854[19].kind = 1;
TMP854[19].offset = offsetof(TY244239, Field1);
TMP854[19].typ = (&NTI244038);
TMP854[19].name = "Field1";
TMP854[17].len = 2; TMP854[17].kind = 2; TMP854[17].sons = &TMP1942[0];
...
TMP1936[10] = &TMP854[32];
TMP854[32].kind = 1;
TMP854[32].offset = offsetof(Tctx244048, callsite);
TMP854[32].typ = (&NTI192805);
TMP854[32].name = "callsite";
TMP1936[11] = &TMP854[33];
NTI244032.size = sizeof(NU8);
NTI244032.kind = 14;
NTI244032.base = 0;
NTI244032.flags = 3;
for (TMP1949 = 0; TMP1949 < 5; TMP1949++) {
TMP854[TMP1949+34].kind = 1;
TMP854[TMP1949+34].offset = TMP1949;
TMP854[TMP1949+34].name = TMP1948[TMP1949];
TMP1947[TMP1949] = &TMP854[TMP1949+34];
}
TMP854[39].len = 5; TMP854[39].kind = 2; TMP854[39].sons = &TMP1947[0];
NTI244032.node = &TMP854[39];
TMP854[33].kind = 1;
TMP854[33].offset = offsetof(Tctx244048, mode);
TMP854[33].typ = (&NTI244032);
TMP854[33].name = "mode";
TMP1936[12] = &TMP854[40];
NTI244034.size = sizeof(NU8);
NTI244034.kind = 14;
NTI244034.base = 0;
NTI244034.flags = 3;
for (TMP1952 = 0; TMP1952 < 3; TMP1952++) {
TMP854[TMP1952+41].kind = 1;
TMP854[TMP1952+41].offset = TMP1952;
TMP854[TMP1952+41].name = TMP1951[TMP1952];
TMP1950[TMP1952] = &TMP854[TMP1952+41];
}
TMP854[44].len = 3; TMP854[44].kind = 2; TMP854[44].sons = &TMP1950[0];
