...
N_NIMCALL(void, createfdset_543435)(tfdset105664* fd, TY548228* s, NI* m);
...
N_NIMCALL(NI, select_543711)(TY548228** readfds, NI timeout) {
	...
	m = 0;
	createfdset_543435((&rd), (*readfds), (&m));
	{
		int LOC5;
		if (!!((timeout == -1))) goto LA3;
		LOC5 = 0;
		LOC5 = Dl_105925(((int) ((NI32)(m + 1))), (&rd), NIM_NIL, NIM_NIL, (&tv));
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		int LOC7;
		LOC7 = 0;
		LOC7 = Dl_105925(((int) ((NI32)(m + 1))), (&rd), NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
