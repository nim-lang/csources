...
typedef NIM_CHAR TY101669[6];
typedef NIM_CHAR TY101672[2501];
typedef NIM_CHAR TY101664[3];
...
N_NOINLINE(void, invalidformatstring_101759)(void);
...
N_NIMCALL(NI, findnormalized_101730)(NimStringDesc* x, NimStringDesc** inarray, NI inarrayLen0);
...
NIM_CONST TY101664 floatformattochar_101663 = {103,
102,
101}
;
...
N_NOINLINE(void, invalidformatstring_101759)(void) {
	Valueerror3449* e_101763;
	NimStringDesc* LOC1;
	e_101763 = 0;
	e_101763 = (Valueerror3449*) newObj((&NTI22201), sizeof(Valueerror3449));
	(*e_101763).Sup.Sup.m_type = (&NTI3449);
	LOC1 = 0;
	LOC1 = (*e_101763).Sup.message; (*e_101763).Sup.message = copyStringRC1(((NimStringDesc*) &TMP147));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_101763, "ValueError");
}
...
appendString((*s), a[idx]);
				...
				case 123:
				{
					...
					x = findnormalized_101730(LOC32, a, aLen0);
					{
						NIM_BOOL LOC35;
						LOC35 = 0;
						LOC35 = (((NI) 0) <= x);
...
appendString((*s), a[(NI)(x + ((NI) 1))]);
				...
				case 95:
				{
					...
					x = findnormalized_101730(LOC43, a, aLen0);
					{
						NIM_BOOL LOC46;
						LOC46 = 0;
						LOC46 = (((NI) 0) <= x);
...
N_NIMCALL(NimStringDesc*, nsuToBin)(NI64 x, NI len) {
	...
	result = mnewString(((NI) (len)));
	{
		...
		j_101013 = 0;
		HEX3Atmp_101025 = 0;
		HEX3Atmp_101025 = (NI)(((NI) (len)) - ((NI) 1));
		res_101028 = ((NI) (HEX3Atmp_101025));
		{
			while (1) {
				if (!(((NI) 0) <= res_101028)) goto LA3;
				j_101013 = ((NI) (res_101028));
...
N_NIMCALL(NimStringDesc*, nsuToOct)(NI64 x, NI len) {
	...
	result = mnewString(((NI) (len)));
	{
		...
		j_100813 = 0;
		HEX3Atmp_100825 = 0;
		HEX3Atmp_100825 = (NI)(((NI) (len)) - ((NI) 1));
		res_100828 = ((NI) (HEX3Atmp_100825));
		{
			while (1) {
				if (!(((NI) 0) <= res_100828)) goto LA3;
				j_100813 = ((NI) (res_100828));
...
appendString(result, prefix);
	{
		...
		c_101131 = 0;
		i_101143 = ((NI) 0);
		L_101145 = (s ? s->Sup.len : 0);
		{
			while (1) {
				if (!(i_101143 < L_101145)) goto LA3;
				c_101131 = s->data[i_101143];
				switch (((NU8)(c_101131))) {
				case 0 ... 31:
				case 128 ... 255:
				{
...
appendString(result, ((NimStringDesc*) &TMP2091));
					LOC5 = 0;
					LOC5 = nsuToHex(((NI64) (((NU8)(c_101131)))), ((NI) 2));
...
appendString(result, ((NimStringDesc*) &TMP2094));
				...
				default:
				{
					result = addChar(result, c_101131);
				}
				break;
				}
				i_101143 += ((NI) 1);
...
N_NIMCALL(NimStringDesc*, nsuformatBiggestFloat)(NF f, NU8 format, NI precision) {
	...
	frmtstr[(((NI) 0))- 0] = 37;
	{
		...
		frmtstr[(((NI) 2))- 0] = 46;
		frmtstr[(((NI) 3))- 0] = 42;
		frmtstr[(((NI) 4))- 0] = floatformattochar_101663[(format)- 0];
		frmtstr[(((NI) 5))- 0] = 0;
	...
	LA3: ;
	{
		frmtstr[(((NI) 1))- 0] = floatformattochar_101663[(format)- 0];
		frmtstr[(((NI) 2))- 0] = 0;
...
N_NIMCALL(NimStringDesc*, nsuInsertSep)(NimStringDesc* s, NIM_CHAR sep, NI digits) {
	...
	L -= ((NI) 1);
	{
		...
		i_101074 = 0;
		HEX3Atmp_101103 = 0;
		HEX3Atmp_101103 = (NI)((s ? s->Sup.len : 0) - ((NI) 1));
		res_101106 = HEX3Atmp_101103;
		{
			while (1) {
				if (!(((NI) 0) <= res_101106)) goto LA3;
				i_101074 = res_101106;
				{
...
N_NIMCALL(NimStringDesc*, formatsize_101697)(NI64 bytes, NIM_CHAR decimalsep) {
	...
	{
		NimStringDesc* bs_101719;
		NimStringDesc* LOC5;
		NimStringDesc* LOC6;
		NimStringDesc* LOC7;
		NimStringDesc* LOC8;
		if (!!((gigabytes == IL64(0)))) goto LA3;
		bs_101719 = nimInt64ToStr(megabytes);
		LOC5 = 0;
		LOC6 = 0;
		...
		LOC8 = 0;
		LOC8 = copyStrLast(bs_101719, ((NI) 0), ((NI) 2));
...
appendString(LOC5, ((NimStringDesc*) &TMP5006));
	...
	LA3: ;
	{
		NimStringDesc* bs_101721;
		NimStringDesc* LOC12;
		NimStringDesc* LOC13;
		NimStringDesc* LOC14;
		NimStringDesc* LOC15;
		if (!!((megabytes == IL64(0)))) goto LA10;
		bs_101721 = nimInt64ToStr(kilobytes);
		LOC12 = 0;
		LOC13 = 0;
		...
		LOC15 = 0;
		LOC15 = copyStrLast(bs_101721, ((NI) 0), ((NI) 2));
...
appendString(LOC12, ((NimStringDesc*) &TMP5007));
	...
	LA10: ;
	{
		NimStringDesc* bs_101723;
		NimStringDesc* LOC19;
		NimStringDesc* LOC20;
		NimStringDesc* LOC21;
		NimStringDesc* LOC22;
		if (!!((kilobytes == IL64(0)))) goto LA17;
		bs_101723 = nimInt64ToStr(bytes);
		LOC19 = 0;
		LOC20 = 0;
		...
		LOC22 = 0;
		LOC22 = copyStrLast(bs_101723, ((NI) 0), ((NI) 2));
