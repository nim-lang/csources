	...
	num = ((NI) 0);
	{
		while (1) {
			if (!(i < (formatstr ? formatstr->Sup.len : 0))) goto LA2;
			{
				...
				{
					{
						if (!((NU32)((aLen_0-1)) < (NU32)(num))) goto LA10_;
...
appendString((*s), a[num]);
				...
				case 45:
				{
					...
					LA20_: ;
					{
						if (!((NU32)((aLen_0-1)) < (NU32)(idx))) goto LA27_;
						invalidFormatString_61EJWW6vRISEo9a8gt0tusw();
					}
					LA27_: ;
...
appendString((*s), a[idx]);
				...
				case 123:
				{
					...
					}
					{
						...
						LA49_: ;
						{
							if (!((NU32)((aLen_0-1)) < (NU32)(idx_2))) goto LA56_;
							invalidFormatString_61EJWW6vRISEo9a8gt0tusw();
						}
						LA56_: ;
...
{	result = (NI)0;
	...
	found = memchr(((void*) ((&s->data[start]))), sub, (NI)((NI)(last_2 - ((NI) (start))) + ((NI) 1)));
	{
		...
		result = (NI)((NU32)(((NI) (ptrdiff_t) (found))) - (NU32)(((NI) (s->data))));
		goto BeforeRet_;
	}
	LA8_: ;
	result = ((NI) -1);
...
N_LIB_PRIVATE N_NIMCALL(NI, nsuParseHexInt)(NimStringDesc* s) {
	...
	LA1_: ;
	{
		while (1) {
			...
			case 48 ... 57:
			{
				result = (NI)((NI)((NU32)(result) << (NU32)(((NI) 4))) | (NI)(((NU8)(s->data[i])) - ((NI) 48)));
				i += ((NI) 1);
			}
			break;
			case 97 ... 102:
			{
				result = (NI)((NI)((NU32)(result) << (NU32)(((NI) 4))) | (NI)((NI)(((NU8)(s->data[i])) - ((NI) 97)) + ((NI) 10)));
				i += ((NI) 1);
			}
			break;
			case 65 ... 70:
			{
				result = (NI)((NI)((NU32)(result) << (NU32)(((NI) 4))) | (NI)((NI)(((NU8)(s->data[i])) - ((NI) 65)) + ((NI) 10)));
				i += ((NI) 1);
			}
			break;
			case 0:
...
appendString((*s), ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_10));
		n = ((NU8)(c));
		(*s) = addChar((*s), ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_5)->data[(NI)((NU32)((NI)(n & ((NI) 240))) >> (NU32)(((NI) 4)))]);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuformatBiggestFloat)(NF f, tyEnum_FloatFormatMode_pNvEoaqwoxKyoASD11vSgQ format, NI precision, NIM_CHAR decimalSep) {
	...
	}
	{
		...
		if (!(T17_)) goto LA18_;
		T19_ = (NIM_CHAR)0;
		T19_ = X5BX5D__OfW9cXEAVaB9aahBBWfdc49cgos(result, ((NI) 4));
		T17_ = ((NU8)(T19_) == (NU8)(43));
		LA18_: ;
		T16_ = T17_;
		if (!(T16_)) goto LA20_;
		T21_ = (NIM_CHAR)0;
		T21_ = X5BX5D__OfW9cXEAVaB9aahBBWfdc49cgos(result, ((NI) 3));
		T16_ = ((NU8)(T21_) == (NU8)(48));
		LA20_: ;
		if (!T16_) goto LA22_;
		T24_ = (NIM_CHAR)0;
		T24_ = X5BX5D__OfW9cXEAVaB9aahBBWfdc49cgos(result, ((NI) 2));
		X5BX5Deq__jv3AJg832RrSrE059bE9cClgstrutils((&result), ((NI) 3), T24_);
		T25_ = (NIM_CHAR)0;
		T25_ = X5BX5D__OfW9cXEAVaB9aahBBWfdc49cgos(result, ((NI) 1));
