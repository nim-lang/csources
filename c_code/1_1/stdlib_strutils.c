...
static N_INLINE(void, X5BX5Deq__jv3AJg832RrSrE059bE9cClgstrutils)(NimStringDesc** s, NI i, NIM_CHAR x);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuformatBiggestFloat)(NF f, tyEnum_FloatFormatMode_pNvEoaqwoxKyoASD11vSgQ format, NI precision, NIM_CHAR decimalSep) {
	...
	}
	{
		...
		if (!(T17_)) goto LA18_;
		T19_ = (NIM_CHAR)0;
		T19_ = X5BX5D__OfW9cXEAVaB9aahBBWfdc49cgpathutils(result, ((NI) 4));
		T17_ = ((NU8)(T19_) == (NU8)(43));
		LA18_: ;
		T16_ = T17_;
		if (!(T16_)) goto LA20_;
		T21_ = (NIM_CHAR)0;
		T21_ = X5BX5D__OfW9cXEAVaB9aahBBWfdc49cgpathutils(result, ((NI) 3));
		T16_ = ((NU8)(T21_) == (NU8)(48));
		LA20_: ;
		if (!T16_) goto LA22_;
		T24_ = (NIM_CHAR)0;
		T24_ = X5BX5D__OfW9cXEAVaB9aahBBWfdc49cgpathutils(result, ((NI) 2));
		X5BX5Deq__jv3AJg832RrSrE059bE9cClgstrutils((&result), ((NI) 3), T24_);
		T25_ = (NIM_CHAR)0;
		T25_ = X5BX5D__OfW9cXEAVaB9aahBBWfdc49cgpathutils(result, ((NI) 1));
		X5BX5Deq__jv3AJg832RrSrE059bE9cClgstrutils((&result), ((NI) 2), T25_);
