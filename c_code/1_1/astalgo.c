...
N_NIMCALL(void, strtableenlarge_239628)(tstrtable224823* t) {
	...
	tsymseq224821* LOC8;
	n = 0;
	n = (tsymseq224821*) newSeq((&NTI224821), (NI32)((*t).Data->Sup.len * 2));
	{
		NI i_239672;
		NI HEX3Atmp_239708;
		NI res_239711;
	...
	unsureAsgnRef((void**) &(*x).Data, (tiipairseq234272*) newSeq((&NTI234272), 8));
	{
		...
		res_242231 = 0;
		{
			while (1) {
				...
				i_242227 = res_242231;
				(*x).Data->data[i_242227].Key = (-2147483647 -1);
				res_242231 += 1;
			} LA3: ;
		}
	}
	...
	{
		{
			...
			if (!LOC8) goto LA9;
			n = 0;
			n = (tiipairseq234272*) newSeq((&NTI234272), (NI32)((*t).Data->Sup.len * 2));
			{
				NI i_242852;
				NI HEX3Atmp_242897;
				NI res_242900;
				...
				res_242900 = 0;
				{
					while (1) {
						...
						i_242852 = res_242900;
						n->data[i_242852].Key = (-2147483647 -1);
						res_242900 += 1;
					} LA13: ;
				}
			}
			{
				...
				res_242906 = 0;
				{
					while (1) {
						...
						i_242865 = res_242906;
						{
							if (!!(((*t).Data->data[i_242865].Key == (-2147483647 -1)))) goto LA19;
	...
	{
		{
			...
			LOC8 = mustrehash_234249((*t).Data->Sup.len, (*t).Counter);
			if (!LOC8) goto LA9;
			n = (tidpairseq224865*) newSeq((&NTI224865), (NI32)((*t).Data->Sup.len * 2));
			{
				NI i_241251;
				NI HEX3Atmp_241432;
				NI res_241435;
	...
	{
		{
			...
			if (!LOC8) goto LA9;
			n = 0;
			n = (tidnodepairseq224871*) newSeq((&NTI224871), (NI32)((*t).Data->Sup.len * 2));
			{
				NI i_242052;
				NI HEX3Atmp_242101;
				NI res_242104;
