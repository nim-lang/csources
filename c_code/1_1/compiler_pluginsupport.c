...
N_NIMCALL(NIM_BOOL, pluginMatches_ZxRIxIPz6KEzS46409cXbMQ)(tyObject_PlugincolonObjectType__Uu1LqDHJFBlEhtebT6KPZg* p, tyObject_TSym_AXG7xcvKqaxY6koRX1xkCw* s);
...
{	result = (NIM_BOOL)0;
	...
	package = (*module).owner;
	{
		...
		if (T16_) goto LA17_;
		T16_ = !(((*package).kind == ((tyEnum_TSymKind_cNCW9acsSznmEccl1fgQwkw) 23)));
		LA17_: ;
		T15_ = T16_;
		if (T15_) goto LA18_;
...
N_NIMCALL(tyProc_AKW0Vo9cFIVu0NCvmOexsSA, getPlugin_pMDBLRQbm0gZ0UsFk9bp9aVw)(tyObject_TSym_AXG7xcvKqaxY6koRX1xkCw* fn) {
