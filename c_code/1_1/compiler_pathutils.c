...
N_LIB_PRIVATE N_NIMCALL(tyTuple_1v9bKyksXWMsm0vNwmZ4EuQ, next_1oYQCMEoqqYiYLTV7RQGrw)(tyObject_PathIter_Wgg01gIW13LJwKz0JmSKrg* it, NimStringDesc* x) {
	...
	{
		{
			while (1) {
				...
				if (!(T10_)) goto LA11_;
				T10_ = !((((NU8)(x->data[(*it).i])) == ((NU8)(92)) || ((NU8)(x->data[(*it).i])) == ((NU8)(47))));
				LA11_: ;
				if (!T10_) goto LA9;
				(*it).i += ((NI) 1);
			} LA9: ;
	...
	LA12_: ;
	{
		while (1) {
			...
			if (!(T22_)) goto LA23_;
			T22_ = (((NU8)(x->data[(*it).i])) == ((NU8)(92)) || ((NU8)(x->data[(*it).i])) == ((NU8)(47)));
			LA23_: ;
			if (!T22_) goto LA21;
			(*it).i += ((NI) 1);
		} LA21: ;
				...
				LA9_: ;
				{
					...
					d = ((*result) ? (*result)->Sup.len : 0);
					{
						while (1) {
							...
							if (!(T18_)) goto LA19_;
							T18_ = !(((NU8)((*result)->data[(NI)(d - ((NI) 1))]) == (NU8)(92)));
							LA19_: ;
							if (!T18_) goto LA17;
							d -= ((NI) 1);
						} LA17: ;
