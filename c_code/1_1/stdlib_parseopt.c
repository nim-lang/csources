...
N_NIMCALL(NI, parseword_527002)(NimStringDesc* s, NI i, NimStringDesc** w, TY124387 delim);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(NimStringDesc*, addChar)(NimStringDesc* s, NIM_CHAR c);
N_NIMCALL(void, handleshortoption_527106)(toptparser526807* p);
...
N_NIMCALL(void, handleshortoption_527106)(toptparser526807* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_527002((*p).Cmd, i, &(*p).Val, TMP7631);
	}
	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser526807* p) {
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_527002((*p).Cmd, i, &(*p).Key, TMP7632);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_527002((*p).Cmd, i, &(*p).Val, TMP7631);
			}
			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_527002((*p).Cmd, i, &(*p).Key, TMP7631);
	}
	break;
	}
	BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser526807* p) {
	...
	LOC1 = 0;
	LOC1 = copyStrLast((*p).Cmd, (*p).Pos, (NI32)(TMP7633));
...
NTI526807.size = sizeof(toptparser526807);
NTI526807.kind = 17;
NTI526807.base = (&NTI2409);
TMP7635[0] = &TMP7620[1];
TMP7620[1].kind = 1;
TMP7620[1].offset = offsetof(toptparser526807, Cmd);
TMP7620[1].typ = (&NTI143);
TMP7620[1].name = "cmd";
TMP7635[1] = &TMP7620[2];
TMP7620[2].kind = 1;
TMP7620[2].offset = offsetof(toptparser526807, Pos);
TMP7620[2].typ = (&NTI106);
TMP7620[2].name = "pos";
TMP7635[2] = &TMP7620[3];
TMP7620[3].kind = 1;
TMP7620[3].offset = offsetof(toptparser526807, Inshortstate);
TMP7620[3].typ = (&NTI134);
TMP7620[3].name = "inShortState";
TMP7635[3] = &TMP7620[4];
NTI526805.size = sizeof(NU8);
NTI526805.kind = 14;
NTI526805.base = 0;
NTI526805.flags = 3;
...
NTI526805.node = &TMP7620[9];
TMP7620[4].kind = 1;
TMP7620[4].offset = offsetof(toptparser526807, Kind);
TMP7620[4].typ = (&NTI526805);
TMP7620[4].name = "kind";
TMP7635[4] = &TMP7620[10];
TMP7620[10].kind = 1;
TMP7620[10].offset = offsetof(toptparser526807, Key);
TMP7620[10].typ = (&NTI143);
TMP7620[10].name = "key";
TMP7635[5] = &TMP7620[11];
TMP7620[11].kind = 1;
TMP7620[11].offset = offsetof(toptparser526807, Val);
TMP7620[11].typ = (&NTI143);
TMP7620[11].name = "val";
TMP7620[0].len = 6; TMP7620[0].kind = 2; TMP7620[0].sons = &TMP7635[0];
NTI526807.node = &TMP7620[0];
}
