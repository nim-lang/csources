...
N_NIMCALL(NI, parseword_524002)(NimStringDesc* s, NI i, NimStringDesc** w, TY124387 delim);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(NimStringDesc*, addChar)(NimStringDesc* s, NIM_CHAR c);
N_NIMCALL(void, handleshortoption_524106)(toptparser523807* p);
...
STRING_LITERAL(TMP7627, "", 0);
STRING_LITERAL(TMP7635, "", 0);
static NIM_CONST TY124387 TMP7636 = {
0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY124387 TMP7637 = {
...
N_NIMCALL(void, initoptparser_523819)(NimStringDesc* cmdline, toptparser523807* Result) {
	...
	LA3: ;
	{
		...
		unsureAsgnRef((void**) &(*Result).Cmd, copyString(((NimStringDesc*) &TMP7627)));
		i_523835 = 0;
		HEX3Atmp_523837 = 0;
		nimln(53, "parseopt.nim");
		HEX3Atmp_523837 = nosparamCount();
		...
		while (1) {
			...
			NimStringDesc* LOC9;
			nimln(1451, "system.nim");
			if (!(res_523839 <= HEX3Atmp_523837)) goto LA6;
			nimln(1450, "system.nim");
			i_523835 = res_523839;
...
appendChar(LOC7, 32);
			...
			res_523839 = addInt(res_523839, 1);
		} LA6: ;
	}
	LA1: ;
...
N_NIMCALL(void, handleshortoption_524106)(toptparser523807* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_524002((*p).Cmd, i, &(*p).Val, TMP7636);
	}
	LA4: ;
...
"cmdLongoption", 
"cmdShortOption"};
static TNimNode TMP7625[12];
NTI523807.size = sizeof(toptparser523807);
NTI523807.kind = 17;
NTI523807.base = (&NTI2409);
TMP7640[0] = &TMP7625[1];
TMP7625[1].kind = 1;
TMP7625[1].offset = offsetof(toptparser523807, Cmd);
TMP7625[1].typ = (&NTI143);
TMP7625[1].name = "cmd";
TMP7640[1] = &TMP7625[2];
TMP7625[2].kind = 1;
TMP7625[2].offset = offsetof(toptparser523807, Pos);
TMP7625[2].typ = (&NTI106);
TMP7625[2].name = "pos";
TMP7640[2] = &TMP7625[3];
TMP7625[3].kind = 1;
TMP7625[3].offset = offsetof(toptparser523807, Inshortstate);
TMP7625[3].typ = (&NTI134);
TMP7625[3].name = "inShortState";
TMP7640[3] = &TMP7625[4];
NTI523805.size = sizeof(NU8);
NTI523805.kind = 14;
NTI523805.base = 0;
NTI523805.flags = 3;
for (TMP7643 = 0; TMP7643 < 4; TMP7643++) {
TMP7625[TMP7643+5].kind = 1;
TMP7625[TMP7643+5].offset = TMP7643;
TMP7625[TMP7643+5].name = TMP7642[TMP7643];
TMP7641[TMP7643] = &TMP7625[TMP7643+5];
}
TMP7625[9].len = 4; TMP7625[9].kind = 2; TMP7625[9].sons = &TMP7641[0];
NTI523805.node = &TMP7625[9];
TMP7625[4].kind = 1;
TMP7625[4].offset = offsetof(toptparser523807, Kind);
TMP7625[4].typ = (&NTI523805);
TMP7625[4].name = "kind";
TMP7640[4] = &TMP7625[10];
TMP7625[10].kind = 1;
TMP7625[10].offset = offsetof(toptparser523807, Key);
TMP7625[10].typ = (&NTI143);
TMP7625[10].name = "key";
TMP7640[5] = &TMP7625[11];
TMP7625[11].kind = 1;
TMP7625[11].offset = offsetof(toptparser523807, Val);
TMP7625[11].typ = (&NTI143);
TMP7625[11].name = "val";
TMP7625[0].len = 6; TMP7625[0].kind = 2; TMP7625[0].sons = &TMP7640[0];
NTI523807.node = &TMP7625[0];
}
