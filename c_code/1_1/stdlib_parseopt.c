...
N_NIMCALL(NimStringDesc*, quote_276489_4065315820)(NimStringDesc* s0);
...
N_NIMCALL(NI, parseword_276420_4065315820)(NimStringDesc* s0, NI i0, NimStringDesc** w0, char136Set delim0);
...
N_NIMCALL(void, handleshortoption_276601_4065315820)(Optparser276405* p0);
...
TNimType NTI276405; /* OptParser */
extern TNimType NTI138; /* string */
extern TNimType NTI104; /* int */
extern TNimType NTI130; /* bool */
TNimType NTI276403; /* CmdLineKind */
...
N_NIMCALL(NimStringDesc*, quote_276489_4065315820)(NimStringDesc* s0) {
	...
	result0 = (NimStringDesc*)0;
	{
		...
		if (!LOC3) goto LA6;
		{
			...
			i0 = parseword_276420_4065315820(s0, ((NI) 0), (&result0), T4065315820_8);
			{
...
N_NIMCALL(void, initoptparser_276527_4065315820)(NimStringDesc* cmdline0, Optparser276405* Result) {
	...
	LA3: ;
	{
		...
		{
			NI i_276542_4065315820;
			NI HEX3Atmp_276545_4065315820;
			NI res_276548_4065315820;
			i_276542_4065315820 = (NI)0;
			HEX3Atmp_276545_4065315820 = (NI)0;
			HEX3Atmp_276545_4065315820 = nosparamCount();
			res_276548_4065315820 = ((NI) 1);
			{
				while (1) {
					NimStringDesc* LOC9;
					NimStringDesc* LOC10;
					if (!(res_276548_4065315820 <= HEX3Atmp_276545_4065315820)) goto LA8;
					i_276542_4065315820 = res_276548_4065315820;
					LOC9 = (NimStringDesc*)0;
					LOC9 = nosparamStr(i_276542_4065315820);
					LOC10 = (NimStringDesc*)0;
					LOC10 = quote_276489_4065315820(LOC9);
...
appendString((*Result).cmd, LOC10);
	...
	LA1: ;
	(*Result).kind = ((Cmdlinekind276403) 0);
...
N_NIMCALL(void, handleshortoption_276601_4065315820)(Optparser276405* p0) {
	...
	}
	{
		...
		i0 = parseword_276420_4065315820((*p0).cmd, i0, (&(*p0).val), T4065315820_10);
	}
	LA5: ;
	{
...
{	i0 = (*p0).pos;
	...
	(*p0).val = setLengthStr((*p0).val, ((NI) 0));
	{
		...
		handleshortoption_276601_4065315820(p0);
		goto BeforeRet;
	}
	LA5: ;
	...
	case 45:
	{
		i0 += ((NI) 1);
		{
			...
			(*p0).kind = ((Cmdlinekind276403) 2);
			i0 += ((NI) 1);
			i0 = parseword_276420_4065315820((*p0).cmd, i0, (&(*p0).key), T4065315820_8);
			{
				while (1) {
			...
			}
			{
				...
				(*p0).pos = parseword_276420_4065315820((*p0).cmd, i0, (&(*p0).val), T4065315820_10);
			}
			goto LA15;
			LA17: ;
			{
	...
	default:
	{
		(*p0).kind = ((Cmdlinekind276403) 1);
		(*p0).pos = parseword_276420_4065315820((*p0).cmd, i0, (&(*p0).key), T4065315820_10);
	}
	break;
	}
	}BeforeRet: ;
...
NTI276403.node = &T4065315820_0[9];
T4065315820_0[4].kind = 1;
T4065315820_0[4].offset = offsetof(Optparser276405, kind);
T4065315820_0[4].typ = (&NTI276403);
T4065315820_0[4].name = "kind";
T4065315820_2[4] = &T4065315820_0[10];
T4065315820_0[10].kind = 1;
T4065315820_0[10].offset = offsetof(Optparser276405, key);
T4065315820_0[10].typ = (&NTI138);
T4065315820_0[10].name = "key";
T4065315820_2[5] = &T4065315820_0[11];
T4065315820_0[11].kind = 1;
T4065315820_0[11].offset = offsetof(Optparser276405, val);
...
NTI276405.node = &T4065315820_0[0];
}
