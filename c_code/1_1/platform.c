...
N_NIMCALL(void, settarget_174621)(NU8 o, NU8 c) {
	...
	targetcpu_174587 = c;
	targetos_174589 = o;
	intsize_174610 = (NI32)(cpu_174480[(c)- 1].Field1 / 8);
	floatsize_174611 = (NI32)(cpu_174480[(c)- 1].Field3 / 8);
	ptrsize_174612 = (NI32)(cpu_174480[(c)- 1].Field4 / 8);
	LOC1 = 0;
	LOC1 = tnl_174613; tnl_174613 = copyStringRC1(os_174069[(o)- 1].Field5);
	if (LOC1) nimGCunrefNoCycle(LOC1);
}
NIM_EXTERNC N_NOINLINE(void, HEX00_platformInit)(void) {
	hostcpu_174588 = nametocpu_174604(((NimStringDesc*) &TMP61));
