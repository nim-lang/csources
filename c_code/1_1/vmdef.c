...
NTI249229.flags = 2;
NTI249229.marker = TMP3210;
TMP3207[1].kind = 1;
TMP3207[1].offset = offsetof(tctx249037, Code);
TMP3207[1].typ = (&NTI249229);
TMP3207[1].name = "code";
TMP3209[1] = &TMP3207[2];
TMP3207[2].kind = 1;
TMP3207[2].offset = offsetof(tctx249037, Debug);
TMP3207[2].typ = (&NTI164208);
TMP3207[2].name = "debug";
TMP3209[2] = &TMP3207[3];
TMP3207[3].kind = 1;
TMP3207[3].offset = offsetof(tctx249037, Globals);
TMP3207[3].typ = (&NTI187805);
TMP3207[3].name = "globals";
TMP3209[3] = &TMP3207[4];
TMP3207[4].kind = 1;
TMP3207[4].offset = offsetof(tctx249037, Constants);
TMP3207[4].typ = (&NTI187805);
TMP3207[4].name = "constants";
TMP3209[4] = &TMP3207[5];
TMP3207[5].kind = 1;
TMP3207[5].offset = offsetof(tctx249037, Types);
TMP3207[5].typ = (&NTI187845);
TMP3207[5].name = "types";
TMP3209[5] = &TMP3207[6];
TMP3207[6].kind = 1;
TMP3207[6].offset = offsetof(tctx249037, Currentexceptiona);
TMP3207[6].typ = (&NTI187805);
TMP3207[6].name = "currentExceptionA";
TMP3209[6] = &TMP3207[7];
TMP3207[7].kind = 1;
TMP3207[7].offset = offsetof(tctx249037, Currentexceptionb);
TMP3207[7].typ = (&NTI187805);
TMP3207[7].name = "currentExceptionB";
TMP3209[7] = &TMP3207[8];
TMP3207[8].kind = 1;
TMP3207[8].offset = offsetof(tctx249037, Exceptioninstr);
...
TMP3207[13].kind = 1;
TMP3207[13].offset = offsetof(tblock249023, Label);
TMP3207[13].typ = (&NTI187811);
...
NTI249198.flags = 2;
NTI249198.marker = TMP3213;
TMP3207[14].kind = 1;
TMP3207[14].offset = offsetof(tblock249023, Fixups);
TMP3207[14].typ = (&NTI249198);
TMP3207[14].name = "fixups";
TMP3207[12].len = 2; TMP3207[12].kind = 2; TMP3207[12].sons = &TMP3212[0];
NTI249023.node = &TMP3207[12];
NTI249217.size = sizeof(TY249217*);
NTI249217.kind = 24;
NTI249217.base = (&NTI249023);
NTI249217.flags = 2;
NTI249217.marker = TMP3214;
TMP3207[11].kind = 1;
TMP3207[11].offset = offsetof(pprocHEX3Aobjecttype249216, Blocks);
TMP3207[11].typ = (&NTI249217);
TMP3207[11].name = "blocks";
TMP3211[1] = &TMP3207[15];
TMP3207[15].kind = 1;
TMP3207[15].offset = offsetof(pprocHEX3Aobjecttype249216, Sym);
TMP3207[15].typ = (&NTI187811);
TMP3207[15].name = "sym";
...
TMP3207[18].kind = 1;
TMP3207[18].offset = offsetof(TY249223, Field0);
...
NTI249031.node = &TMP3207[28];
TMP3207[19].kind = 1;
TMP3207[19].offset = offsetof(TY249223, Field1);
TMP3207[19].typ = (&NTI249031);
TMP3207[19].name = "Field1";
TMP3207[17].len = 2; TMP3207[17].kind = 2; TMP3207[17].sons = &TMP3215[0];
NTI249223.node = &TMP3207[17];
NTI249220.size = sizeof(TY249220);
NTI249220.kind = 16;
NTI249220.base = (&NTI249223);
NTI249220.flags = 3;
TMP3207[16].kind = 1;
TMP3207[16].offset = offsetof(pprocHEX3Aobjecttype249216, Slots);
TMP3207[16].typ = (&NTI249220);
TMP3207[16].name = "slots";
TMP3211[3] = &TMP3207[29];
TMP3207[29].kind = 1;
TMP3207[29].offset = offsetof(pprocHEX3Aobjecttype249216, Maxslots);
TMP3207[29].typ = (&NTI106);
TMP3207[29].name = "maxSlots";
TMP3207[10].len = 4; TMP3207[10].kind = 2; TMP3207[10].sons = &TMP3211[0];
NTI249216.node = &TMP3207[10];
NTI249033.size = sizeof(pprocHEX3Aobjecttype249216*);
NTI249033.kind = 22;
NTI249033.base = (&NTI249216);
NTI249033.flags = 2;
NTI249033.marker = TMP3219;
TMP3207[9].kind = 1;
TMP3207[9].offset = offsetof(tctx249037, Prc);
TMP3207[9].typ = (&NTI249033);
TMP3207[9].name = "prc";
TMP3209[9] = &TMP3207[30];
TMP3207[30].kind = 1;
TMP3207[30].offset = offsetof(tctx249037, Module);
TMP3207[30].typ = (&NTI187811);
TMP3207[30].name = "module";
TMP3209[10] = &TMP3207[31];
TMP3207[31].kind = 1;
TMP3207[31].offset = offsetof(tctx249037, Callsite);
TMP3207[31].typ = (&NTI187805);
...
NTI249025.node = &TMP3207[38];
TMP3207[32].kind = 1;
TMP3207[32].offset = offsetof(tctx249037, Mode);
TMP3207[32].typ = (&NTI249025);
...
NTI249027.node = &TMP3207[43];
NTI249029.size = sizeof(NU8);
NTI249029.kind = 19;
NTI249029.base = (&NTI249027);
NTI249029.flags = 3;
TMP3207[44].len = 0; TMP3207[44].kind = 0;
NTI249029.node = &TMP3207[44];
TMP3207[39].kind = 1;
TMP3207[39].offset = offsetof(tctx249037, Features);
TMP3207[39].typ = (&NTI249029);
TMP3207[39].name = "features";
TMP3209[13] = &TMP3207[45];
TMP3207[45].kind = 1;
TMP3207[45].offset = offsetof(tctx249037, Traceactive);
TMP3207[45].typ = (&NTI134);
TMP3207[45].name = "traceActive";
TMP3209[14] = &TMP3207[46];
TMP3207[46].kind = 1;
TMP3207[46].offset = offsetof(tctx249037, Loopiterations);
TMP3207[46].typ = (&NTI106);
TMP3207[46].name = "loopIterations";
TMP3207[0].len = 15; TMP3207[0].kind = 2; TMP3207[0].sons = &TMP3209[0];
NTI249037.node = &TMP3207[0];
NTI249035.size = sizeof(tctx249037*);
NTI249035.kind = 22;
NTI249035.base = (&NTI249037);
NTI249035.marker = TMP3226;
NTI249021.size = sizeof(NU8);
NTI249021.kind = 14;
NTI249021.base = 0;
NTI249021.flags = 3;
for (TMP5317 = 0; TMP5317 < 153; TMP5317++) {
TMP3207[TMP5317+47].kind = 1;
TMP3207[TMP5317+47].offset = TMP5317;
TMP3207[TMP5317+47].name = TMP5316[TMP5317];
TMP5315[TMP5317] = &TMP3207[TMP5317+47];
}
TMP3207[200].len = 153; TMP3207[200].kind = 2; TMP3207[200].sons = &TMP5315[0];
NTI249021.node = &TMP3207[200];
}
