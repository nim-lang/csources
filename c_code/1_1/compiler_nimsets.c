...
N_NIMCALL(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*, toTreeSet_T7faK845phyHxY50P3qxIQ)(tySequence_pxbIse2JUQkJU0n9blV9bY5g* s, tyObject_TType_LTUWCZolpovw9cWE3JBWSUw* settype, tyObject_TLineInfo_T9c3PM9bs7WZ4LIQfEici9cZw info);
...
N_NIMCALL(NIM_BOOL, emptyRange_GLYFox9ciWitxKuirhftGHg_2)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* a, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* b) {
	NIM_BOOL result;
	NIM_BOOL T1_;
	result = (NIM_BOOL)0;
	T1_ = (NIM_BOOL)0;
