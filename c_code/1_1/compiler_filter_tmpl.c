...
N_NIMCALL(NIM_CHAR, charArg_9a2s5yGJN0q64pYjhEbI1pQ)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n, NimStringDesc* name, NI pos, NIM_CHAR default_0);
N_NIMCALL(NimStringDesc*, strArg_hrsET2VpzHuUBdZObITwmQ)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n, NimStringDesc* name, NI pos, NimStringDesc* default_0);
...
N_NIMCALL(void, parseLine_Seop6SJMf7a68kj2jl0nsQ)(tyObject_TTmplParser_hVXV9cC75rOvsaODz9bp1zeg* p);
N_NIMCALL(void, newLine_P1DA7WwGEY1zF3DfWYV6Pg)(tyObject_TTmplParser_hVXV9cC75rOvsaODz9bp1zeg* p);
...
N_NIMCALL(void, scanPar_UZozihWMkEBOt7RUxfUnzw)(tyObject_TTmplParser_hVXV9cC75rOvsaODz9bp1zeg* p, NI d);
...
static NIM_CONST tySet_tyChar_nmiMWKVIe46vacnhAFrQvw TM_paI0W78l0CRDBLjAHJxn6w_36 = {
...
break;
		...
		LA18_: ;
		{
			...
			{
				(*p).info.col = ((NI16) (j));
				localError_VpilfPWbplGz6ny7O9cfr2g((*p).info, ((tyEnum_TMsgKind_IGAWgv9aR2KqPKJfPZPEWaw) 168), ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_12));
			}
			LA25_: ;
				...
				{
					{
						...
						case 123:
						{
							...
							curly = ((NI) 0);
							{
								while (1) {
									...
									case 0:
									{
										localError_VpilfPWbplGz6ny7O9cfr2g((*p).info, ((tyEnum_TMsgKind_IGAWgv9aR2KqPKJfPZPEWaw) 194), ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_43));
										goto LA67;
									}
									break;
									case 123:
						...
						default:
						{
							...
							{
								(*p).info.col = ((NI16) (j));
								localError_VpilfPWbplGz6ny7O9cfr2g((*p).info, ((tyEnum_TMsgKind_IGAWgv9aR2KqPKJfPZPEWaw) 172), ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_10));
							}
							LA85_: ;
						}
						break;
