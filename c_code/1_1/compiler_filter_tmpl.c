...
STRING_LITERAL(TMP1339, "", 0);
STRING_LITERAL(TMP1340, "subschar", 8);
STRING_LITERAL(TMP1341, "metachar", 8);
STRING_LITERAL(TMP1342, "emit", 4);
STRING_LITERAL(TMP1343, "result.add", 10);
STRING_LITERAL(TMP1344, "conc", 4);
STRING_LITERAL(TMP1345, " & ", 3);
STRING_LITERAL(TMP1346, "tostring", 8);
STRING_LITERAL(TMP1347, "$", 1);
STRING_LITERAL(TMP1348, "\015\012", 2);
STRING_LITERAL(TMP1350, "end", 3);
STRING_LITERAL(TMP1351, "#end", 4);
static NIM_CONST TY197407 TMP1352 = {
...
STRING_LITERAL(TMP1355, "\\x", 2);
STRING_LITERAL(TMP1356, "\\\\", 2);
STRING_LITERAL(TMP1357, "\\\'", 2);
STRING_LITERAL(TMP1358, "\\\"", 2);
STRING_LITERAL(TMP1359, "}", 1);
STRING_LITERAL(TMP1360, "\\n\"", 3);
...
N_NIMCALL(void, parseline_240174)(ttmplparser240020* p) {
	...
	LA7: ;
	{
		...
		d = j;
		keyw = copyString(((NimStringDesc*) &TMP1339));
		{
			while (1) {
		...
		case ((NU8) 21):
		{
			...
			{
				(*p).Info.Col = ((NI16) (j));
				localerror_184637((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP1350));
			}
			LA20: ;
			LOC25 = 0;
		...
		case ((NU8) 61):
		{
			...
			llstreamwrite_197713((*p).Outp, LOC34);
			{
				NIM_BOOL LOC37;
				LOC37 = 0;
				LOC37 = contains_100267((*p).X, TMP1352);
				if (!!(LOC37)) goto LA38;
				(*p).Indent += 2;
			}
			LA38: ;
	...
	LA10: ;
	{
		...
		case ((NU8) 1):
		{
			...
			llstreamwrite_197713((*p).Outp, ((NimStringDesc*) &TMP1353));
		}
		break;
		case ((NU8) 0):
		{
		...
		(*p).State = ((NU8) 1);
		{
			while (1) {
				...
				{
					NimStringDesc* LOC52;
					llstreamwrite_197713((*p).Outp, ((NimStringDesc*) &TMP1355));
					LOC52 = 0;
				...
				case 92:
				{
					llstreamwrite_197713((*p).Outp, ((NimStringDesc*) &TMP1356));
					j += 1;
				}
				break;
				case 39:
				{
					llstreamwrite_197713((*p).Outp, ((NimStringDesc*) &TMP1357));
					j += 1;
				}
				break;
				case 34:
				{
					llstreamwrite_197713((*p).Outp, ((NimStringDesc*) &TMP1358));
					j += 1;
				}
				break;
				default:
				{
					{
						...
						case 123:
						{
							...
							curly = 0;
							{
								while (1) {
									...
									case 0:
									{
										localerror_184637((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP1359));
										goto LA62;
									}
									break;
									case 123:
						...
						default:
						{
							...
							{
								(*p).Info.Col = ((NI16) (j));
								localerror_184637((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP1347));
							}
							LA80: ;
						}
						break;
		...
		llstreamwrite_197713((*p).Outp, ((NimStringDesc*) &TMP1360));
	}
	LA3: ;
}
...
N_NIMCALL(tllstream197204*, filtertmpl_240009)(tllstream197204* stdin_240011, NimStringDesc* filename, tnode210818* call) {
	...
	p.Info = newlineinfo_182956(filename, 0, 0);
	p.Outp = llstreamopen_197220(((NimStringDesc*) &TMP1339));
	p.Inp = stdin_240011;
	p.Subschar = chararg_239020(call, ((NimStringDesc*) &TMP1340), 1, 36);
	p.Nimdirective = chararg_239020(call, ((NimStringDesc*) &TMP1341), 2, 35);
	p.Emit = strarg_239029(call, ((NimStringDesc*) &TMP1342), 3, ((NimStringDesc*) &TMP1343));
	p.Conc = strarg_239029(call, ((NimStringDesc*) &TMP1344), 4, ((NimStringDesc*) &TMP1345));
	p.Tostr = strarg_239029(call, ((NimStringDesc*) &TMP1346), 5, ((NimStringDesc*) &TMP1347));
