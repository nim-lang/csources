...
N_NIMCALL(void, methoddef_418824)(tsym224849* s, NIM_BOOL fromcache) {
	...
	asgnRefNoCycle((void**) &gmethods_418315->data[gmethods_418315->Sup.len-1].Field1, LOC10.Field1);
	{
		...
		internalerror_197970((*s).Info, ((NimStringDesc*) &TMP3126));
	}
	LA14: ;
	BeforeRet: ;
}
...
N_NIMCALL(tsym224849*, gendispatcher_419235)(tsymseq224821* methods, intset221056 relevantcols) {
	...
	ands = getsyssym_281054(((NimStringDesc*) &TMP4050));
	iss = getsyssym_281054(((NimStringDesc*) &TMP4051));
	{
		NI meth_419271;
		NI HEX3Atmp_419470;
		NI res_419473;
...
TMP939[0] = &TMP937[1];
TMP937[1].kind = 1;
TMP937[1].offset = offsetof(TY418292, Field0);
TMP937[1].typ = (&NTI224821);
TMP937[1].name = "Field0";
TMP939[1] = &TMP937[2];
TMP937[2].kind = 1;
TMP937[2].offset = offsetof(TY418292, Field1);
TMP937[2].typ = (&NTI224817);
TMP937[2].name = "Field1";
TMP937[0].len = 2; TMP937[0].kind = 2; TMP937[0].sons = &TMP939[0];
NTI418292.node = &TMP937[0];
NTI418291.size = sizeof(TY418291*);
NTI418291.kind = 24;
NTI418291.base = (&NTI418292);
NTI418291.flags = 2;
NTI418291.marker = TMP940;
}
