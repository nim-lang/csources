...
N_NIMCALL(NimStringDesc*, decodestr_179114)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 92:
		{
			...
			nimln(49, "rodutils.nim");
			TMP2070 = subInt(i, 2);
			hexchar_179058(s[(NI32)(TMP2070)], &xi);			nimln(50, "rodutils.nim");
			nimln(50, "rodutils.nim");
			TMP2071 = subInt(i, 1);
			hexchar_179058(s[(NI32)(TMP2071)], &xi);			nimln(51, "rodutils.nim");
...
N_NIMCALL(void, encodevbiggestintaux_179161)(NI64 x, NimStringDesc** result) {
	...
	LA8: ;
	{
		...
		d_179167 = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP2077), 0, 255))));
	}	LA6: ;
...
N_NIMCALL(void, encodevintaux_179193)(NI x, NimStringDesc** result) {
	...
	LA8: ;
	{
		...
		d_179199 = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP2082), 0, 255))));
	}	LA6: ;
	nimln(80, "rodutils.nim");
	{
		nimln(698, "system.nim");
...
N_NIMCALL(void, encodevint_179218)(NI x, NimStringDesc** result) {
	...
	nimln(98, "rodutils.nim");
	encodevintaux_179193((NI)((NU32)(x) + (NU32)(5)), result);	popFrame();
}
N_NIMCALL(NI, decodevint_179239)(NCSTRING s, NI* pos) {
	NI result;
	NI i_179246;
