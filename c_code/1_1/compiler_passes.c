...
N_NIMCALL(void, processimplicits_265633)(TY121608* implicits, NU8 nodekind, tpasscontext265005** a);
...
N_NIMCALL(void, openpasses_265316)(tpasscontext265005** a, tsym210848* module) {
	{
		...
		i_265333 = 0;
		HEX3Atmp_265342 = 0;
		HEX3Atmp_265342 = (NI32)(gpasseslen_265190 - 1);
		res_265345 = 0;
		{
			while (1) {
...
{	result = 0;
	m = n;
	{
		...
		i_265492 = 0;
		HEX3Atmp_265512 = 0;
		HEX3Atmp_265512 = (NI32)(gpasseslen_265190 - 1);
		res_265515 = 0;
		{
			while (1) {
...
N_NIMCALL(void, processimplicits_265633)(TY121608* implicits, NU8 nodekind, tpasscontext265005** a) {
	{
		...
		l_265661 = implicits->Sup.len;
		{
			while (1) {
				...
				importstmt = newnodei_211140(nodekind, gcmdlineinfo_183007);
				str = newstrnode_211120(((NU8) 20), module_265652);
				(*str).Info = gcmdlineinfo_183007;
...
N_NIMCALL(void, closepasses_265426)(tpasscontext265005** a) {
	...
	m = NIM_NIL;
	{
		...
		i_265443 = 0;
		HEX3Atmp_265453 = 0;
		HEX3Atmp_265453 = (NI32)(gpasseslen_265190 - 1);
		res_265456 = 0;
		{
			while (1) {
...
N_NIMCALL(void, openpassescached_265362)(tpasscontext265005** a, tsym210848* module, trodreader256030* rd) {
	{
		...
		i_265380 = 0;
		HEX3Atmp_265406 = 0;
		HEX3Atmp_265406 = (NI32)(gpasseslen_265190 - 1);
		res_265409 = 0;
		{
			while (1) {
...
N_NIMCALL(void, processtoplevelstmtcached_265532)(tnode210818* n, tpasscontext265005** a) {
	...
	m = n;
	{
		...
		i_265550 = 0;
		HEX3Atmp_265559 = 0;
		HEX3Atmp_265559 = (NI32)(gpasseslen_265190 - 1);
		res_265562 = 0;
		{
			while (1) {
...
N_NIMCALL(void, closepassescached_265579)(tpasscontext265005** a) {
	...
	m = NIM_NIL;
	{
		...
		i_265596 = 0;
		HEX3Atmp_265613 = 0;
		HEX3Atmp_265613 = (NI32)(gpasseslen_265190 - 1);
		res_265616 = 0;
		{
			while (1) {
...
{	memset((void*)(&p), 0, sizeof(p));
	...
	LA3: ;
	{
		...
		n = loadinitsection_256077(rd);
		{
			...
			HEX3Atmp_265808 = (NI32)(LOC37 - 1);
			res_265811 = 0;
			{
				while (1) {
					if (!(res_265811 <= HEX3Atmp_265808)) goto LA39;
					i_265797 = res_265811;
