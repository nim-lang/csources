...
STRING_LITERAL(TM_6xNBOpPeN0DsJ34t7RoSng_17, "exe", 3);
STRING_LITERAL(TM_6xNBOpPeN0DsJ34t7RoSng_18, "cmd", 3);
STRING_LITERAL(TM_6xNBOpPeN0DsJ34t7RoSng_19, "bat", 3);
NIM_CONST tyArray_24KAM9afIUgUaqBaEBB6r9bg TM_6xNBOpPeN0DsJ34t7RoSng_16 = {((NimStringDesc*) &TM_6xNBOpPeN0DsJ34t7RoSng_17),
((NimStringDesc*) &TM_6xNBOpPeN0DsJ34t7RoSng_18),
((NimStringDesc*) &TM_6xNBOpPeN0DsJ34t7RoSng_19)}
;
STRING_LITERAL(TM_6xNBOpPeN0DsJ34t7RoSng_20, "node", 4);
STRING_LITERAL(TM_6xNBOpPeN0DsJ34t7RoSng_21, "iojs", 4);
static N_NIMCALL(void, TM_6xNBOpPeN0DsJ34t7RoSng_2)(void) {
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, findNodeJs_x9cLYBEr4jpszRAI8Xsy9cxQ)(void) {
	...
	result = findExe_9cov9c3aI19bfbEIyMe9bNCSEA(((NimStringDesc*) &TM_6xNBOpPeN0DsJ34t7RoSng_15), NIM_TRUE, TM_6xNBOpPeN0DsJ34t7RoSng_16, 3);
	{
		if (!((result ? result->Sup.len : 0) == 0)) goto LA3_;
		result = findExe_9cov9c3aI19bfbEIyMe9bNCSEA(((NimStringDesc*) &TM_6xNBOpPeN0DsJ34t7RoSng_20), NIM_TRUE, TM_6xNBOpPeN0DsJ34t7RoSng_16, 3);
	}
	LA3_: ;
	{
		if (!((result ? result->Sup.len : 0) == 0)) goto LA7_;
		result = findExe_9cov9c3aI19bfbEIyMe9bNCSEA(((NimStringDesc*) &TM_6xNBOpPeN0DsJ34t7RoSng_21), NIM_TRUE, TM_6xNBOpPeN0DsJ34t7RoSng_16, 3);
	}
	LA7_: ;
	return result;
}
