...
N_NIMCALL(void, fillbuffer_281058_4037054349)(Tbaselexer281015* L0);
...
N_NIMCALL(void, skiputf8bom_282410_4037054349)(Tbaselexer281015* L0);
N_NIMCALL(NI, fillbaselexer_281809_4037054349)(Tbaselexer281015* L0, NI pos0);
...
TNimType NTI281015; /* TBaseLexer */
extern TNimType NTI104; /* int */
extern TNimType NTI140; /* cstring */
extern TNimType NTI280206; /* PLLStream */
...
N_NIMCALL(void, fillbuffer_281058_4037054349)(Tbaselexer281015* L0) {
	...
	LA3: ;
	LOC5 = (NI)0;
	LOC5 = llstreamread_280530_597494479((*L0).stream, ((void*) ((&(*L0).buf[tocopy0]))), (NI)((NI)((*L0).sentinel + ((NI) 1)) * ((NI) 1)));
		...
		s0 -= ((NI) 1);
		{
			while (1) {
				...
				LA19: ;
				{
					...
					LOC23 = (NI)0;
					LOC23 = llstreamread_280530_597494479((*L0).stream, ((void*) ((&(*L0).buf[oldbuflen0]))), (NI)(oldbuflen0 * ((NI) 1)));
...
N_NIMCALL(void, openbaselexer_281023_4037054349)(Tbaselexer281015* L0, Tllstream280204* inputstream0, NI buflen0) {
	...
	fillbuffer_281058_4037054349(L0);
	skiputf8bom_282410_4037054349(L0);
}
...
N_NIMCALL(NI, handlecr_281042_4037054349)(Tbaselexer281015* L0, NI pos0) {
	...
	result0 = (NI)0;
	(*L0).linenumber += ((NI) 1);
	result0 = fillbaselexer_281809_4037054349(L0, pos0);
	{
		if (!((NU8)((*L0).buf[result0]) == (NU8)(10))) goto LA3;
		result0 = fillbaselexer_281809_4037054349(L0, result0);
	}
	LA3: ;
	return result0;
}
...
N_NIMCALL(void, closebaselexer_281030_4037054349)(Tbaselexer281015* L0) {
	...
	llstreamclose_280278_597494479((*L0).stream);
}
...
NTI281015.node = &T4037054349_0[0];
}
