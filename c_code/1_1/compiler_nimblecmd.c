...
N_NIMCALL(void, addPackage_mPfTsfux8gBVeyQ8xwDYTQ)(tyObject_StringTableObj_DKRIdH9c9cKI7YpQb9c0wKlEw* packages, NimStringDesc* p) {
	...
	version = newVersion_2tUj1VbvNWvoeXROqIRlGw(ver);
	{
		...
		T4_ = (NIM_BOOL)0;
		T5_ = (NimStringDesc*)0;
		T5_ = getOrDefault_sPC3Tb9bX9b1TxdHlL7x9cN3Q(packages, name, ((NimStringDesc*) &TM_asNQM9aynXXg9ccUABbReyew_4));
		T6_ = (NimStringDesc*)0;
...
N_NIMCALL(void, addNimblePath_Io0tiMEKgDlbf67BdbC9cWw)(NimStringDesc* p, tyObject_TLineInfo_T9c3PM9bs7WZ4LIQfEici9cZw info) {
	...
	nimbleLinks = result;
	{
		...
		NimStringDesc* T42_;
		T39_ = (nimbleLinks ? nimbleLinks->Sup.len : 0);
		if (!(((NI) 0) < T39_)) goto LA40_;
		T42_ = (NimStringDesc*)0;
		T42_ = readFile_T9cm5LIRX2tKEH9aREBZ8A0w(nimbleLinks->data[((NI) 0)]);
		nimbleLinkLines = nsuSplitLines(T42_);
		path = copyString(nimbleLinkLines->data[((NI) 1)]);
		{
			NIM_BOOL T45_;
			T45_ = (NIM_BOOL)0;
			T45_ = nosisAbsolute(path);
			if (!!(T45_)) goto LA46_;
	...
	LA40_: ;
	{
		NIM_BOOL T50_;
		T50_ = (NIM_BOOL)0;
		T50_ = contains_jPdUhZfr9a8sH2V3ZBDljzwnimblecmd(searchPaths_XRBeXIYowTeRSkTUFC0m2w->data, searchPaths_XRBeXIYowTeRSkTUFC0m2w->Sup.len, path);
		if (!!(T50_)) goto LA51_;
	...
	}
	{
		...
		p_2 = (NimStringDesc*)0;
		{
			...
			val = (NimStringDesc*)0;
			{
				...
				h_2 = (NI)0;
				colontmp_ = (NI)0;
				T51_ = ((*packages).data ? ((*packages).data->Sup.len-1) : -1);
				colontmp_ = T51_;
				res = ((NI) 0);
				{
					while (1) {
						if (!(res <= colontmp_)) goto LA53;
						h_2 = res;
						{
							NimStringDesc* res_2;
							if (!!(((*packages).data->data[h_2].Field0 == 0))) goto LA56_;
							key = (*packages).data->data[h_2].Field0;
							val = (*packages).data->data[h_2].Field1;
							{
								if (!((val ? val->Sup.len : 0) == ((NI) 0))) goto LA60_;
								res_2 = key;
							}
							goto LA58_;
							LA60_: ;
							{
								...
								T63_ = rawNewString(key->Sup.len + val->Sup.len + 1);
