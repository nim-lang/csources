...
typedef NU16 TSpecialWord_nVgi9bpIkxJQ8xdkRBooyzw;
...
N_NIMCALL(TIdent_4umxGerWTHGPwUms7Yqu3g*, getIdent_BlDQd0MZ58qhFoyY3ZHQIA)(IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw* self, NimStringDesc* identifier, NI h);
IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw* legacy_AHP7NxhjlnSC9cf2jfY1fFg;
...
static N_NIMCALL(void, Marker_TY_lnkYNZP9asc88UfiEGjLrbA)(void* p, NI op) {
	IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw* a;
	NI T1_;
	a = (IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw*)p;
	T1_ = (NI)0;
...
N_NIMCALL(TIdent_4umxGerWTHGPwUms7Yqu3g*, getIdent_62GxCdwHvMBvMwCLnw1wyg)(IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw* self, NCSTRING identifier, NI length, NI h) {
	...
	NI idx;
	TIdent_4umxGerWTHGPwUms7Yqu3g* last;
	NI id;
{	result = (TIdent_4umxGerWTHGPwUms7Yqu3g*)0;
	...
	result = (TIdent_4umxGerWTHGPwUms7Yqu3g*) newObj((&NTI_1nh2T19a2BrGbBBQRS39bxRw_), sizeof(TIdent_4umxGerWTHGPwUms7Yqu3g));
	...
	asgnRefNoCycle((void**) (&(*self).buckets[(idx)- 0]), result);
	{
		...
		(*result).Sup.id = ((NI32)-((*self).wordCounter));
	}
	goto LA19_;
	LA21_: ;
	{
...
N_NIMCALL(IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw*, newIdentCache_9basvGvZH4FwEO4MVbYyP9aA)(void) {
	IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw* result;
	result = (IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw*)0;
	{
		IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw* T5_;
		if (!(legacy_AHP7NxhjlnSC9cf2jfY1fFg == 0)) goto LA3_;
		T5_ = (IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw*)0;
		T5_ = (IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw*) newObj((&NTI_lnkYNZP9asc88UfiEGjLrbA_), sizeof(IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw));
		result = T5_;
		...
		{
			TSpecialWord_nVgi9bpIkxJQ8xdkRBooyzw s;
			NI res;
			s = (TSpecialWord_nVgi9bpIkxJQ8xdkRBooyzw)0;
			res = ((NI) 1);
			{
				while (1) {
					NI T9_;
					...
					s = ((TSpecialWord_nVgi9bpIkxJQ8xdkRBooyzw) (res));
					T9_ = (NI)0;
...
N_NIMCALL(TSpecialWord_ycbpMCRV6Cd2eBh3X9biEiw, whichKeyword_WhYAAh6vF1PoyH6Hsspu4Q)(TIdent_4umxGerWTHGPwUms7Yqu3g* id) {
	...
	LA3_: ;
	{
		result = ((TSpecialWord_ycbpMCRV6Cd2eBh3X9biEiw) ((*id).Sup.id));
	}
	LA1_: ;
	return result;
}
...
NTI_TzLHS09bRH9a0TYLs39cqcNaw_.size = sizeof(IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw);
...
NTI_raN9cHVgzmvaXisezY9aGg9cg_.size = sizeof(TIdObj_raN9cHVgzmvaXisezY9aGg9cg);
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_0[2].offset = offsetof(TIdObj_raN9cHVgzmvaXisezY9aGg9cg, id);
...
NTI_4umxGerWTHGPwUms7Yqu3g_.size = sizeof(TIdent_4umxGerWTHGPwUms7Yqu3g);
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_0[4].offset = offsetof(TIdent_4umxGerWTHGPwUms7Yqu3g, s);
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_0[5].offset = offsetof(TIdent_4umxGerWTHGPwUms7Yqu3g, next);
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_0[6].offset = offsetof(TIdent_4umxGerWTHGPwUms7Yqu3g, h);
...
NTI_1nh2T19a2BrGbBBQRS39bxRw_.size = sizeof(TIdent_4umxGerWTHGPwUms7Yqu3g*);
...
NTI_1nh2T19a2BrGbBBQRS39bxRw_.marker = Marker_TY_1nh2T19a2BrGbBBQRS39bxRw;
NTI_CBfZt49asUfAsBVM7a3Rc9cw_.size = sizeof(TY_CBfZt49asUfAsBVM7a3Rc9cw);
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_0[1].offset = offsetof(IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw, buckets);
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_0[7].offset = offsetof(IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw, wordCounter);
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_0[8].offset = offsetof(IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw, idAnon);
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_0[9].offset = offsetof(IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw, idDelegator);
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_0[10].offset = offsetof(IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw, emptyIdent);
...
NTI_lnkYNZP9asc88UfiEGjLrbA_.size = sizeof(IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw*);
...
NTI_lnkYNZP9asc88UfiEGjLrbA_.marker = Marker_TY_lnkYNZP9asc88UfiEGjLrbA;
NTI_GFuL0q6Yj4iJze0S9cdD9avg_.size = sizeof(TIdObj_raN9cHVgzmvaXisezY9aGg9cg*);
NTI_GFuL0q6Yj4iJze0S9cdD9avg_.kind = 22;
NTI_GFuL0q6Yj4iJze0S9cdD9avg_.base = (&NTI_raN9cHVgzmvaXisezY9aGg9cg_);
NTI_GFuL0q6Yj4iJze0S9cdD9avg_.marker = Marker_TY_GFuL0q6Yj4iJze0S9cdD9avg;
}
