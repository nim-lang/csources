...
{	result0 = (NimStringDesc*)0;
	...
	case ((Tnodekind290020) 22):
	{
		...
		if (T2178338529_2.status == 0) {
			...
			LOC3 = tofullpath_190264_155036129((*n0).info.fileindex);
...
N_NIMCALL(NI32, checkmodulename_346051_2178338529)(Tnode290802* n0) {
	...
	LOC1 = tofullpath_190264_155036129((*n0).info.fileindex);
	...
	LA4: ;
	{
		result0 = fileinfoidx_190008_155036129(fullpath0);
	}
	LA2: ;
	return result0;
}
...
N_NIMCALL(void, rawimportsymbol_346058_2178338529)(Tcontext342020* c0, Tsym290834* s0) {
	...
	strtableadd_297040_2984716966((&(*(*c0).importtable).symbols), s0);
	{
		...
		etyp0 = (*s0).typ;
		{
			NIM_BOOL LOC17;
			LOC17 = (NIM_BOOL)0;
			LOC17 = ((*etyp0).kind == ((Ttypekind290244) 1) || (*etyp0).kind == ((Ttypekind290244) 14));
			if (!(LOC17)) goto LA18;
	...
	LA13: ;
	{
		...
		LA42: ;
		{
			NIM_BOOL LOC46;
			LOC46 = (NIM_BOOL)0;
			LOC46 = haspattern_295337_850551059(s0);
			if (!LOC46) goto LA47;
			addpattern_342432_893308950(c0, s0);
		}
		LA47: ;
	}
	LA11: ;
