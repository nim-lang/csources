...
STRING_LITERAL(T_NsDkQfDe2CjzDqtBRW9bqQg_10, "\015\012", 2);
...
{	result0 = (NimStringDesc*)0;
	...
	case ((Tnodekind_G4E4Gxe7oI2Cm03rkiOzQw) 22):
	{
		...
		T_NsDkQfDe2CjzDqtBRW9bqQg_4.status = setjmp(T_NsDkQfDe2CjzDqtBRW9bqQg_4.context);
...
N_NIMCALL(NI32, checkmodulename_Kg51K0T2kZ3LqXLFR6u83g)(Tnode_bROa11lyF5vxEN9aYNbHmhw* n0, NIM_BOOL dolocalerror0) {
	...
	fullpath0 = findmodule_N9bn61ftY1WAixmRRVO8jng(modulename0, LOC1);
	{
...
N_NIMCALL(void, rawimportsymbol_7qtiNe9cOtkp0iv0cUito5g)(Tcontext_5TfOJKwTttj3W1t1tMzWUQ* c0, Tsym_AXG7xcvKqaxY6koRX1xkCw* s0) {
	...
	strtableadd_Tcb9aDxXz9ch8cAXKFCMrlbA((&(*(*c0).importtable).symbols), s0);
	{
		...
		etyp0 = (*s0).typ;
		{
			NIM_BOOL LOC17;
			LOC17 = (NIM_BOOL)0;
			LOC17 = ((*etyp0).kind == ((Ttypekind_9a3YiReNVD0IJHWFKgXRe9ag) 1) || (*etyp0).kind == ((Ttypekind_9a3YiReNVD0IJHWFKgXRe9ag) 14));
			if (!(LOC17)) goto LA18;
