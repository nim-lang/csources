...
N_NIMCALL(tsym187843*, ithfield_416007)(tnode187813* n, NI field) {
	...
	case ((NU8) 136):
	{
		...
		while (1) {
			...
			result = ithfield_416007((*n).kindU.S6.Sons->data[i_416024], (NI32)(TMP5673));
	...
	case ((NU8) 137):
	{
		...
		result = ithfield_416007((*n).kindU.S6.Sons->data[0], (NI32)(TMP5675));
		...
		while (1) {
			...
			case ((NU8) 88):
			{
				...
				result = ithfield_416007(LOC20, (NI32)(TMP5678));
