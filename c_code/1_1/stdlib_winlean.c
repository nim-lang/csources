...
typedef NI8 TY98279[8];
typedef N_STDCALL_PTR(void, poverlappedcompletionroutine98210) (NI32 para1, NI32 para2, toverlapped98206* para3);
typedef N_STDCALL_PTR(int, TY98298) (NI s, NI32 dwiocontrolcode, void* lpvinbuffer, NI32 cbinbuffer, void* lpvoutbuffer, NI32 cboutbuffer, NI32* lpcbbytesreturned, toverlapped98206* lpoverlapped, poverlappedcompletionroutine98210 lpcompletionroutine);
typedef N_STDCALL_PTR(int, TY98315) (NI s, WSABUF* buf, NI32 bufcount, NI32* bytesreceived, NI32* flags, toverlapped98206* lpoverlapped, poverlappedcompletionroutine98210 completionproc);
typedef N_STDCALL_PTR(int, TY98326) (NI s, WSABUF* buf, NI32 bufcount, NI32* bytessent, NI32 flags, toverlapped98206* lpoverlapped, poverlappedcompletionroutine98210 completionproc);
typedef N_STDCALL_PTR(NI32, TY98341) (tfiletime95868* lpidletime, tfiletime95868* lpkerneltime, tfiletime95868* lpusertime);
typedef N_STDCALL_PTR(NI32, TY98348) (NI hprocess, tfiletime95868* lpcreationtime, tfiletime95868* lpexittime, tfiletime95868* lpkerneltime, tfiletime95868* lpusertime);
...
NIM_CONST TY98279 TMP148 = {((NI8) -114),
((NI8) -23),
((NI8) 118),
((NI8) -27),
((NI8) -116),
...
((NI8) 62)}
;
NIM_CONST TY98279 TMP149 = {((NI8) -107),
((NI8) -54),
((NI8) 0),
((NI8) -128),
((NI8) 95),
...
TY98243 Dl_98242;
TY98250 Dl_98249;
tguid98212 wsaidconnectex_98281;
tguid98212 wsaidacceptex_98285;
tguid98212 wsaidgetacceptexsockaddrs_98289;
TY98298 Dl_98297;
TY98315 Dl_98314;
TY98326 Dl_98325;
TY98341 Dl_98340;
...
N_NOINLINE(void, stdlibwinleanInit)(void) {
	...
	wsaidgetacceptexsockaddrs_98289 = LOC3;
	popFrame();
}
