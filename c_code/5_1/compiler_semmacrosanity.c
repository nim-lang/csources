...
STRING_LITERAL(TMP3465, "ithField", 8);
STRING_LITERAL(TMP3466, "ithField(record case branch)", 28);
STRING_LITERAL(TMP3467, "invalid field at index ", 23);
STRING_LITERAL(TMP3469, "compiler/semmacrosanity.nim", 27);
NIM_CONST TY88487 TMP3468 = {((NimStringDesc*) &TMP3469),
((NI) 47)}
;
STRING_LITERAL(TMP3470, "() must have a tuple type", 25);
STRING_LITERAL(TMP3471, "[] must have some form of array type", 36);
STRING_LITERAL(TMP3472, "{} must have the set type", 25);
STRING_LITERAL(TMP3473, "float literal must have some float type", 39);
STRING_LITERAL(TMP3474, "integer literal must have some int type", 39);
STRING_LITERAL(TMP3475, "string literal must be of some string type", 42);
STRING_LITERAL(TMP3476, "nil literal must be of some pointer type", 40);
		...
		LA17: ;
		{
			...
			res_418095 = ((NI) 1);
			{
				while (1) {
					...
					default:
					{
						internalerror_187100((*n).info, ((NimStringDesc*) &TMP3466));
					}
					break;
					}
					res_418095 += ((NI) 1);
...
appendString(LOC10, ((NimStringDesc*) &TMP3467));
...
appendString(LOC32, ((NimStringDesc*) &TMP3467));
appendString(LOC32, LOC33);
	...
	case ((NU8) 23):
	{
		...
		LA86: ;
		{
			globalerror_187076((*n).info, ((NimStringDesc*) &TMP3476));
		}
		LA84: ;
	}
	break;
