...
{	result = 0;
	...
	{
		{
			...
			HEX3Atmp_432110 = (NI32)(LOC3 - 1);
			res_432113 = 0;
			{
				while (1) {
					if (!(res_432113 <= HEX3Atmp_432110)) goto LA5;
					i_432029 = res_432113;
					result = ithfield_432012((*n).kindU.S6.Sons->data[i_432029], (NI32)(field - i_432029));
					{
	...
	case ((NU8) 138):
	{
		...
		LA13: ;
		result = ithfield_432012((*n).kindU.S6.Sons->data[0], (NI32)(field - 1));
		{
			...
			res_432119 = 1;
			{
				while (1) {
					...
					case ((NU8) 88):
					{
						...
						result = ithfield_432012(LOC24, (NI32)(field - 1));
						{
