...
N_NIMCALL(void, openbaselexer_163027)(tbaselexer163018* l, tllstream162204* inputstream, NI buflen) {
	...
	LOC5 = 0;
	LOC5 = alloc_4001((NI32)(TMP1647));
	(*l).Buf = ((NCSTRING) (LOC5));
	nimln(151, "nimlexbase.nim");
	nimln(151, "nimlexbase.nim");
	TMP1648 = subInt(buflen, 1);
	(*l).Sentinel = (NI32)(TMP1648);
...
N_NIMCALL(NI, getcolnumber_163045)(tbaselexer163018* l, NI pos) {
	...
	if ((NI32)(TMP1649) == (-2147483647 -1)) raiseOverflow();
	result = (NI32)abs((NI32)(TMP1649));
	popFrame();
	return result;
}
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src) {
...
TMP1890[0] = &TMP1596[1];
TMP1596[1].kind = 1;
TMP1596[1].offset = offsetof(tbaselexer163018, Bufpos);
TMP1596[1].typ = (&NTI105);
TMP1596[1].name = "bufpos";
TMP1890[1] = &TMP1596[2];
TMP1596[2].kind = 1;
TMP1596[2].offset = offsetof(tbaselexer163018, Buf);
TMP1596[2].typ = (&NTI144);
TMP1596[2].name = "buf";
TMP1890[2] = &TMP1596[3];
TMP1596[3].kind = 1;
TMP1596[3].offset = offsetof(tbaselexer163018, Buflen);
TMP1596[3].typ = (&NTI105);
TMP1596[3].name = "bufLen";
TMP1890[3] = &TMP1596[4];
TMP1596[4].kind = 1;
TMP1596[4].offset = offsetof(tbaselexer163018, Stream);
TMP1596[4].typ = (&NTI162206);
TMP1596[4].name = "stream";
TMP1890[4] = &TMP1596[5];
TMP1596[5].kind = 1;
TMP1596[5].offset = offsetof(tbaselexer163018, Linenumber);
TMP1596[5].typ = (&NTI105);
TMP1596[5].name = "LineNumber";
TMP1890[5] = &TMP1596[6];
TMP1596[6].kind = 1;
TMP1596[6].offset = offsetof(tbaselexer163018, Sentinel);
TMP1596[6].typ = (&NTI105);
TMP1596[6].name = "sentinel";
TMP1890[6] = &TMP1596[7];
TMP1596[7].kind = 1;
TMP1596[7].offset = offsetof(tbaselexer163018, Linestart);
TMP1596[7].typ = (&NTI105);
TMP1596[7].name = "lineStart";
TMP1596[0].len = 7; TMP1596[0].kind = 2; TMP1596[0].sons = &TMP1890[0];
NTI163018.node = &TMP1596[0];
}
