...
STRING_LITERAL(TMP3117, "method has lock level $1, but another method has $2", 51);
STRING_LITERAL(TMP3125, "no method dispatcher found", 26);
STRING_LITERAL(TMP3126, "cgmeth.genConv", 14);
STRING_LITERAL(TMP3127, "cgmeth.genConv: no upcast allowed", 33);
STRING_LITERAL(TMP3128, "cgmeth.genConv: no downcast allowed", 35);
STRING_LITERAL(TMP4049, "and", 3);
STRING_LITERAL(TMP4050, "of", 2);
...
N_NIMCALL(void, fixupdispatcher_418628)(tsym224849* meth, tsym224849* disp) {
	...
	LA13: ;
	{
		...
		LOC21 = 0;
		LOC21 = nsuFormatOpenArray(((NimStringDesc*) &TMP3117), LOC20, 2);
...
N_NIMCALL(void, methoddef_418824)(tsym224849* s, NIM_BOOL fromcache) {
	...
	asgnRefNoCycle((void**) &gmethods_418315->data[gmethods_418315->Sup.len-1].Field1, LOC10.Field1);
	{
		...
		internalerror_197970((*s).Info, ((NimStringDesc*) &TMP3125));
	}
	LA14: ;
	BeforeRet: ;
}
	...
	source = skiptypes_229245((*n).Typ, IL64(211106247256320));
	{
		...
		LA13: ;
		{
			...
			addson_225290(result, n);
			{
				...
				internalerror_197970((*n).Info, ((NimStringDesc*) &TMP3128));
			}
			LA24: ;
		}
		goto LA11;
...
N_NIMCALL(tsym224849*, gendispatcher_419235)(tsymseq224821* methods, intset221056 relevantcols) {
	...
	ands = getsyssym_281054(((NimStringDesc*) &TMP4049));
	iss = getsyssym_281054(((NimStringDesc*) &TMP4050));
	{
		NI meth_419271;
		NI HEX3Atmp_419470;
		NI res_419473;
