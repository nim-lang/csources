...
N_NIMCALL(NI, cmpignorestyle_165036)(NCSTRING a, NCSTRING b, NI blen) {
	...
	while (1) {
		...
		nimln(43, "idents.nim");
		{
			...
			aa = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP969), 0, 255))));
		}
		LA16: ;
		nimln(44, "idents.nim");
		{
			...
			bb = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP970), 0, 255))));
		}
		LA22: ;
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
...
N_NIMCALL(tident165019*, getident_165250)(NCSTRING identifier, NI length, NI h) {
	...
	nimln(92, "idents.nim");
	{
		...
		nimln(94, "idents.nim");
		nimln(94, "idents.nim");
		if (wordcounter_165248 == (-2147483647 -1)) raiseOverflow();
		(*result).Sup.Id = ((NI32)-(wordcounter_165248));
	}
	goto LA22;
	LA24: ;
	{
