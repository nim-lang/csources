...
STRING_LITERAL(TMP3020, "tab", 3);
STRING_LITERAL(TMP3021, "int", 3);
STRING_LITERAL(TMP3022, "int8", 4);
STRING_LITERAL(TMP3023, "int16", 5);
STRING_LITERAL(TMP3024, "int32", 5);
STRING_LITERAL(TMP3025, "int64", 5);
...
STRING_LITERAL(TMP3031, "float", 5);
STRING_LITERAL(TMP3032, "float32", 7);
STRING_LITERAL(TMP3033, "float64", 7);
STRING_LITERAL(TMP3034, "float128", 8);
STRING_LITERAL(TMP3035, "bool", 4);
STRING_LITERAL(TMP3036, "char", 4);
STRING_LITERAL(TMP3037, "string", 6);
STRING_LITERAL(TMP3038, "cstring", 7);
STRING_LITERAL(TMP3039, "pointer", 7);
STRING_LITERAL(TMP3040, "request for typekind: ", 22);
STRING_LITERAL(TMP3041, "wanted: ", 8);
STRING_LITERAL(TMP3042, " got: ", 6);
STRING_LITERAL(TMP3043, "type not found: ", 16);
static NIM_CONST TY172865 TMP3044 = {
0xE0, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3045, "intVal", 6);
STRING_LITERAL(TMP3046, "invalid int size", 16);
...
N_NIMCALL(tsym172689*, getsyssym_217037)(NimStringDesc* name) {
	...
	if (!(((64 &(1<<(((*systemmodule_217014).Kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3020));
	nimln(39, "magicsys.nim");
	LOC1 = 0;
...
appendString(LOC26, ((NimStringDesc*) &TMP3040));
...
appendString(LOC31, ((NimStringDesc*) &TMP3041));
appendString(LOC31, reprEnum(kind, (&NTI172236)));
appendString(LOC31, ((NimStringDesc*) &TMP3042));
...
appendString(LOC36, ((NimStringDesc*) &TMP3043));
...
N_NIMCALL(ttype172693*, getintlittype_217317)(tnode172659* literal) {
	...
	if (!(((TMP3044[(*literal).Kind/8] &(1<<((*literal).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3045));
...
N_NIMCALL(void, setintlittype_217430)(tnode172659* result) {
	...
	if (!(((TMP3044[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3045));
	...
	default:
	{
		...
		internalerror_139369((*result).Info, ((NimStringDesc*) &TMP3046));	}	break;
	}
	popFrame();
}
N_NIMCALL(tsym172689*, getcompilerproc_217025)(NimStringDesc* name) {
