...
N_NIMCALL(void, enlarge_180675)(table180376* t) {
	...
	n = 0;
	n = (keyvaluepairseq180379*) newSeq((&NTI180379), (NI32)((*t).Data->Sup.len * ((NI) 2)));
	LOC1 = 0;
	LOC1 = (*t).Data;
...
N_NIMCALL(void, enlarge_327185)(table326052* t) {
	...
	n = 0;
	n = (keyvaluepairseq326055*) newSeq((&NTI326055), (NI32)((*t).Data->Sup.len * ((NI) 2)));
	LOC1 = 0;
	LOC1 = (*t).Data;
	unsureAsgnRef((void**) (&(*t).Data), n);
	n = LOC1;
...
N_NIMCALL(void, enlarge_330109)(table327411* t) {
	...
	n = 0;
	n = (keyvaluepairseq327414*) newSeq((&NTI327414), (NI32)((*t).Data->Sup.len * ((NI) 2)));
	LOC1 = 0;
	LOC1 = (*t).Data;
	unsureAsgnRef((void**) (&(*t).Data), n);
	n = LOC1;
...
static TNimNode* TMP2473[3];
static TNimNode* TMP4714[2];
static TNimNode* TMP4872[3];
...
TMP53[11].len = 2; TMP53[11].kind = 2; TMP53[11].sons = &TMP4714[0];
