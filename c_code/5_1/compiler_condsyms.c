			...
			res_167233 = ((NI) 0);
			{
				while (1) {
					...
					h_167229 = res_167233;
					{
						...
						{
							if (!!(eqStrings(val_167215, ((NimStringDesc*) &TMP1466)))) goto LA11;
							result += ((NI) 1);
						}
						LA11: ;
					}
...
N_NIMCALL(void, definesymbol_167013)(NimStringDesc* symbol) {
	nstPut(gsymbols_167004, symbol, ((NimStringDesc*) &TMP1514));
}
...
N_NIMCALL(void, initdefines_167254)(void) {
	...
	definesymbol_167013(((NimStringDesc*) &TMP1528));
}

N_NIMCALL(void, undefsymbol_167022)(NimStringDesc* symbol) {
	nstPut(gsymbols_167004, symbol, ((NimStringDesc*) &TMP1466));
}
