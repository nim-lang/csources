	...
	while (1) {
		...
		case ((NU8) 3):
		{
			...
			nimln(43, "service.nim");
			{
				...
				key = copyStrLast(p.Key, 0, (NI32)(TMP7044));
				...
				LOC9 = 0;
				LOC9 = copyStr(p.Key, (NI32)(TMP7045));
...
N_NIMCALL(void, serve_419277)(TY419279 action) {
	...
	LA2: ;
	{
		...
		while (1) {
			...
			send_134404(stdoutsocket_138084, ((NimStringDesc*) &TMP7080));			nimln(98, "service.nim");
	...
	LOC1 = 0;
	LOC1 = curcaascmd_419203; curcaascmd_419203 = copyStringRC1(((NimStringDesc*) &TMP7039));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(25, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_419204; lastcaascmd_419204 = copyStringRC1(((NimStringDesc*) &TMP7039));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(28, "service.nim");
	LOC3 = 0;
	LOC3 = arguments_419205; arguments_419205 = copyStringRC1(((NimStringDesc*) &TMP7039));
