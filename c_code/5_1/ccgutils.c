...
STRING_LITERAL(TMP3327, "GetUniqueType", 13);
STRING_LITERAL(TMP3334, "N", 1);
STRING_LITERAL(TMP3335, "HEX", 3);
STRING_LITERAL(TMP3426, "\"", 1);
STRING_LITERAL(TMP3933, "c\"", 2);
STRING_LITERAL(TMP3934, "\\00\"", 4);
...
N_NIMCALL(ttype224855*, getuniquetype_543401)(ttype224855* key) {
	...
	case ((NU8) 58):
	{
		internalerror_197989(((NimStringDesc*) &TMP3327));
	}
	break;
	case ((NU8) 13):
	{
...
N_NIMCALL(NimStringDesc*, mangle_543763)(NimStringDesc* name) {
	...
	case 48 ... 57:
	{
		...
		LOC4 = 0;
		LOC4 = rawNewString(2);
appendString(LOC4, ((NimStringDesc*) &TMP3334));
...
appendString(LOC6, ((NimStringDesc*) &TMP3335));
...
appendString(LOC16, ((NimStringDesc*) &TMP3335));
...
N_NIMCALL(NimStringDesc*, makesinglelinecstring_543737)(NimStringDesc* s) {
	NimStringDesc* result;
	result = 0;
	result = copyString(((NimStringDesc*) &TMP3426));
	{
		NIM_CHAR c_543741;
		NI i_543745;
		NI l_543747;
...
N_NIMCALL(trope177009*, makellvmstring_543816)(NimStringDesc* s) {
	...
	result = 0;
	result = NIM_NIL;
	res = copyString(((NimStringDesc*) &TMP3933));
	{
		NI i_543834;
		NI HEX3Atmp_543847;
		NI res_543850;
...
appendString(res, ((NimStringDesc*) &TMP3934));
	LOC12 = 0;
