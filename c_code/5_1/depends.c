...
static NIM_CONST TY192025 TMP7612 = {
...
NIM_CONST tpass250015 gendependpass_524152 = {myopen_524128,
NIM_NIL,
adddotdependency_524031,
NIM_NIL}
;
trope148007* gdotgraph_524017;
...
N_NIMCALL(void, adddependencyaux_524020)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	appf_148085(&gdotgraph_524017, ((NimStringDesc*) &TMP7611), LOC1, 2);
	popFrame();
}
...
N_NIMCALL(tnode191813*, adddotdependency_524031)(tpasscontext250003* c, tnode191813* n) {
	...
	case ((NU8) 115):
	{
		...
		while (1) {
			...
			imported = getmodulename_259012((*n).kindU.S6.Sons->data[i_524049]);
...
N_NIMCALL(void, generatedot_524007)(NimStringDesc* project) {
	...
	LOC4 = 0;
	LOC4 = ropef_148079(((NimStringDesc*) &TMP7616), LOC1, 2);
...
NTI524012.kind = 17;
NTI524012.base = (&NTI250003);
TMP7609[0].kind = 1;
TMP7609[0].offset = offsetof(tgen524012, Module);
TMP7609[0].typ = (&NTI191811);
TMP7609[0].name = "module";
NTI524012.node = &TMP7609[0];
NTI524014.size = sizeof(tgen524012*);
NTI524014.kind = 22;
NTI524014.base = (&NTI524012);
NTI524014.marker = TMP7619;
}
