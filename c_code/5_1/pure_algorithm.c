...
typedef N_CLOSURE_PTR(NI, TMP4980) (tsym172689* x, tsym172689* y);
typedef NIM_CHAR TY611[100000001];
struct NimStringDesc {
  TGenericSeq Sup;
TY611 data;
};
typedef N_CLOSURE_PTR(NI, TMP4982) (tsym172689* x, tsym172689* y);
struct tentry322943 {
NI Pos;
tsym172689* Sym;
};
...
typedef N_CLOSURE_PTR(NI, TMP4999) (tentry322943 x, tentry322943 y);
typedef N_CLOSURE_PTR(NI, TMP5000) (tentry322943 x, tentry322943 y);
struct TNimObject {
TNimType* m_type;
};
struct tidobj141011 {
...
N_NIMCALL(void, merge_320761)(tsym172689** a, NI aLen0, tsym172689** b, NI bLen0, NI lo, NI m, NI hi, TY320724 cmp, NU8 order) {
	...
	nimln(71, "algorithm.nim");
	{
		...
		nimln(71, "algorithm.nim");
		TMP4979 = addInt(m, 1);
		if ((NU)((NI32)(TMP4979)) >= (NU)(aLen0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI32)(TMP4979)], cmp.ClEnv) : ((TMP4980)(cmp.ClPrc))(a[m], a[(NI32)(TMP4979)]);
		LOC4 = 0;
...
N_NIMCALL(void, sort_320717)(tsym172689** a, NI aLen0, TY320724 cmp, NU8 order) {
	...
	nimln(125, "algorithm.nim");
	TMP4976 = divInt(n, 2);
	b = (tsymseq172661*) newSeq((&NTI172661), (NI32)(TMP4976));
	...
	while (1) {
		...
		while (1) {
			...
			nimln(130, "algorithm.nim");
			TMP4983 = subInt(m, s);
			TMP4984 = addInt((NI32)(TMP4983), 1);
			nimln(130, "algorithm.nim");
			TMP4985 = addInt(m, s);
			merge_320761(a, aLen0, b->data, b->Sup.len, (((NI32)(TMP4984) >= 0) ? (NI32)(TMP4984) : 0), m, (NI32)(TMP4985), cmp, order);			nimln(131, "algorithm.nim");
			nimln(131, "algorithm.nim");
			TMP4986 = mulInt(s, 2);
			m = subInt(m, (NI32)(TMP4986));
		} LA2: ;
...
N_NIMCALL(void, merge_323468)(tentry322943* a, NI aLen0, tentry322943* b, NI bLen0, NI lo, NI m, NI hi, TY323431 cmp, NU8 order) {
	...
	nimln(71, "algorithm.nim");
	{
		...
		nimln(71, "algorithm.nim");
		TMP4998 = addInt(m, 1);
		if ((NU)((NI32)(TMP4998)) >= (NU)(aLen0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI32)(TMP4998)], cmp.ClEnv) : ((TMP4999)(cmp.ClPrc))(a[m], a[(NI32)(TMP4998)]);
		LOC4 = 0;
		LOC4 = HEX2A_318040(LOC3, order);
		if (!(LOC4 <= 0)) goto LA5;
		nimln(71, "algorithm.nim");
...
N_NIMCALL(void, sort_323424)(tentry322943* a, NI aLen0, TY323431 cmp, NU8 order) {
	...
	nimln(125, "algorithm.nim");
	TMP4995 = divInt(n, 2);
	b = (TY322950*) newSeq((&NTI322950), (NI32)(TMP4995));
	nimln(126, "algorithm.nim");
	s = 1;
	nimln(127, "algorithm.nim");
	while (1) {
		...
		while (1) {
			...
			nimln(130, "algorithm.nim");
			TMP5001 = subInt(m, s);
			TMP5002 = addInt((NI32)(TMP5001), 1);
			nimln(130, "algorithm.nim");
			TMP5003 = addInt(m, s);
			merge_323468(a, aLen0, b->data, b->Sup.len, (((NI32)(TMP5002) >= 0) ? (NI32)(TMP5002) : 0), m, (NI32)(TMP5003), cmp, order);			nimln(131, "algorithm.nim");
			nimln(131, "algorithm.nim");
			TMP5004 = mulInt(s, 2);
			m = subInt(m, (NI32)(TMP5004));
		} LA2: ;
		nimln(132, "algorithm.nim");
		nimln(132, "algorithm.nim");
		TMP5005 = mulInt(s, 2);
