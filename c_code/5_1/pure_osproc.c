...
appendString(LOC67, LOC69);
		...
		LA76: ;
		{
			...
			a = tocstringarray_146626(TMP984, 2, LOC88, 1);
...
N_NIMCALL(void, pruneprocessset_147395)(TY146202** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(803, "osproc.nim");
		{
			...
			nimln(804, "osproc.nim");
			TMP990 = subInt(l, 1);
			if ((NU)((NI32)(TMP990)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRefNoCycle((void**) &(*s)->data[i], (*s)->data[(NI32)(TMP990)]);
...
N_NIMCALL(NI, select_146502)(TY146202** readfds, NI timeout) {
	...
	createfdset_147340(&rd, (*readfds), &m);	nimln(819, "osproc.nim");
	{
		...
		TMP992 = addInt(m, 1);
		LOC5 = 0;
		LOC5 = select(((int) ((NI32)(TMP992))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}	goto LA1;
	LA3: ;
	{
		...
		TMP993 = addInt(m, 1);
		LOC7 = 0;
		LOC7 = select(((int) ((NI32)(TMP993))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}	LA1: ;
