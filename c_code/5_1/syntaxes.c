...
STRING_LITERAL(TMP2694, "standard", 8);
STRING_LITERAL(TMP2695, "strongspaces", 12);
STRING_LITERAL(TMP2696, "braces", 6);
STRING_LITERAL(TMP2697, "endx", 4);
NIM_CONST TY224016 parsernames_224015 = {((NimStringDesc*) &TMP2694),
((NimStringDesc*) &TMP2695),
((NimStringDesc*) &TMP2696),
((NimStringDesc*) &TMP2697)}
;
STRING_LITERAL(TMP2698, "none", 4);
STRING_LITERAL(TMP2699, "stdtmpl", 7);
STRING_LITERAL(TMP2700, "replace", 7);
STRING_LITERAL(TMP2701, "strip", 5);
NIM_CONST TY224022 filternames_224021 = {((NimStringDesc*) &TMP2698),
((NimStringDesc*) &TMP2699),
((NimStringDesc*) &TMP2700),
((NimStringDesc*) &TMP2701)}
;
STRING_LITERAL(TMP2706, "parser to implement", 19);
...
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2713, "ident", 5);
...
N_NIMCALL(tnode191813*, parseall_224049)(tparsers224029* p) {
	...
	case ((NU8) 3):
	{
		...
		internalerror_168606(((NimStringDesc*) &TMP2706));
...
N_NIMCALL(NIM_BOOL, containsshebang_224100)(NimStringDesc* s, NI i) {
	...
	nimln(83, "syntaxes.nim");
	{
		...
		nimln(83, "syntaxes.nim");
		TMP2707 = addInt(i, 1);
		if ((NU)((NI32)(TMP2707)) > (NU)(s->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(s->data[(NI32)(TMP2707)]) == (NU8)(33));
		LA4: ;
		if (!LOC3) goto LA5;
...
N_NIMCALL(tnode191813*, parsepipe_224138)(NimStringDesc* filename, tllstream179204* inputstream) {
	...
	nimln(91, "syntaxes.nim");
	{
		...
		nimln(98, "syntaxes.nim");
		{
			...
			nimln(98, "syntaxes.nim");
			TMP2709 = addInt(i, 1);
			if ((NU)((NI32)(TMP2709)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC14 = ((NU8)(line->data[(NI32)(TMP2709)]) == (NU8)(33));
			LA15: ;
			if (!LOC14) goto LA16;
...
N_NIMCALL(tident170019*, getcallee_224333)(tnode191813* n) {
	...
	nimln(120, "syntaxes.nim");
	{
		...
		if (((TMP2710[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2711));
		if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP2712[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2713));
...
N_NIMCALL(tllstream179204*, evalpipe_224461)(tparsers224029* p, tnode191813* n, NimStringDesc* filename, tllstream179204* start) {
	...
	nimln(151, "syntaxes.nim");
	{
		...
		if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP2712[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2713));
		LOC7 = identeq_170469((*(*n).kindU.S6.Sons->data[0]).kindU.S5.Ident, ((NimStringDesc*) &TMP2714));
		LA10: ;
		if (!LOC7) goto LA11;
		i_224550 = 0;
		nimln(1451, "system.nim");
...
static TNimNode* TMP2702[2];
static TNimNode* TMP2703[4];
NI TMP2705;
static char* NIM_CONST TMP2704[4] = {
"skinStandard", 
"skinStrongSpaces", 
"skinBraces", 
"skinEndX"};
...
NTI224005.base = 0;
NTI224005.flags = 3;
for (TMP2705 = 0; TMP2705 < 4; TMP2705++) {
TMP2287[TMP2705+2].kind = 1;
TMP2287[TMP2705+2].offset = TMP2705;
TMP2287[TMP2705+2].name = TMP2704[TMP2705];
TMP2703[TMP2705] = &TMP2287[TMP2705+2];
}
TMP2287[6].len = 4; TMP2287[6].kind = 2; TMP2287[6].sons = &TMP2703[0];
NTI224005.node = &TMP2287[6];
TMP2287[1].kind = 1;
TMP2287[1].offset = offsetof(tparsers224029, Skin);
TMP2287[1].typ = (&NTI224005);
TMP2287[1].name = "skin";
TMP2702[1] = &TMP2287[7];
TMP2287[7].kind = 1;
TMP2287[7].offset = offsetof(tparsers224029, Parser);
TMP2287[7].typ = (&NTI209203);
TMP2287[7].name = "parser";
TMP2287[0].len = 2; TMP2287[0].kind = 2; TMP2287[0].sons = &TMP2702[0];
NTI224029.node = &TMP2287[0];
}
