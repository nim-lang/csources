...
N_NIMCALL(void, merge_356843)(tsym185843** a_356851, NI a_356851Len0, tsym185843** b_356859, NI b_356859Len0, NI lo_356863, NI m_356865, NI hi_356867, TY356801 cmp_356875, NU8 order_356878) {
	...
	nimln(101, "algorithm.nim");
	{
		...
		if ((NU)((NI32)(TMP5098)) >= (NU)(a_356851Len0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp_356875.ClEnv? cmp_356875.ClPrc(a_356851[m_356865], a_356851[(NI32)(TMP5098)], cmp_356875.ClEnv):((TMP5099)(cmp_356875.ClPrc))(a_356851[m_356865], a_356851[(NI32)(TMP5098)]);
		LOC4 = 0;
...
N_NIMCALL(void, merge_360227)(tentry359566* a_360235, NI a_360235Len0, tentry359566* b_360243, NI b_360243Len0, NI lo_360247, NI m_360249, NI hi_360251, TY360185 cmp_360259, NU8 order_360262) {
	...
	nimln(101, "algorithm.nim");
	{
		...
		if ((NU)((NI32)(TMP5117)) >= (NU)(a_360235Len0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp_360259.ClEnv? cmp_360259.ClPrc(a_360235[m_360249], a_360235[(NI32)(TMP5117)], cmp_360259.ClEnv):((TMP5118)(cmp_360259.ClPrc))(a_360235[m_360249], a_360235[(NI32)(TMP5117)]);
		LOC4 = 0;
