...
{	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI32)(m + ((NI) 1))], cmp.ClEnv):((TMP2662)(cmp.ClPrc))(a[m], a[(NI32)(m + ((NI) 1))]);
		LOC4 = 0;
...
{	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI32)(m + ((NI) 1))], cmp.ClEnv):((TMP4884)(cmp.ClPrc))(a[m], a[(NI32)(m + ((NI) 1))]);
		LOC4 = 0;
		LOC4 = HEX2A_325020(LOC3, order);
		if (!(LOC4 <= ((NI) 0))) goto LA5;
		goto BeforeRet;
