...
STRING_LITERAL(TMP1340, "startswith", 10);
STRING_LITERAL(TMP1341, "", 0);
STRING_LITERAL(TMP1342, "true", 4);
STRING_LITERAL(TMP1343, "false", 5);
STRING_LITERAL(TMP1344, "leading", 7);
STRING_LITERAL(TMP1345, "trailing", 8);
STRING_LITERAL(TMP1346, "sub", 3);
STRING_LITERAL(TMP1347, "by", 2);
...
N_NIMCALL(NIM_BOOL, boolarg_256038)(tnode224819* n, NimStringDesc* name, NI pos, NIM_BOOL default_256043) {
	...
	LA3: ;
	{
		...
		LOC6 = ((*x).Kind == ((NU8) 2));
		if (!(LOC6)) goto LA7;
		LOC6 = identeq_200493((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP1342));
		LA7: ;
		if (!LOC6) goto LA8;
		result = NIM_TRUE;
	}
	...
	LA8: ;
	{
		...
		LOC11 = ((*x).Kind == ((NU8) 2));
		if (!(LOC11)) goto LA12;
		LOC11 = identeq_200493((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP1343));
		LA12: ;
		if (!LOC11) goto LA13;
		result = NIM_FALSE;
	}
...
N_NIMCALL(tllstream211204*, filterstrip_256012)(tllstream211204* stdin_256014, NimStringDesc* filename, tnode224819* call) {
	...
	NimStringDesc* line;
	result = 0;
	pattern = strarg_256029(call, ((NimStringDesc*) &TMP1340), 1, ((NimStringDesc*) &TMP1341));
	leading = boolarg_256038(call, ((NimStringDesc*) &TMP1344), 2, NIM_TRUE);
	trailing = boolarg_256038(call, ((NimStringDesc*) &TMP1345), 3, NIM_TRUE);
	result = llstreamopen_211220(((NimStringDesc*) &TMP1341));
...
N_NIMCALL(tllstream211204*, filterreplace_256004)(tllstream211204* stdin_256006, NimStringDesc* filename, tnode224819* call) {
	...
	NimStringDesc* line;
	result = 0;
	sub = strarg_256029(call, ((NimStringDesc*) &TMP1346), 1, ((NimStringDesc*) &TMP1341));
	{
		if (!(sub->Sup.len == 0)) goto LA3;
		invalidpragma_256047(call);
	}
	LA3: ;
	by = strarg_256029(call, ((NimStringDesc*) &TMP1347), 2, ((NimStringDesc*) &TMP1341));
	result = llstreamopen_211220(((NimStringDesc*) &TMP1341));
	line = rawNewString(80);
	{
		while (1) {
