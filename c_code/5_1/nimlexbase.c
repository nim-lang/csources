...
N_NIMCALL(void, fillbuffer_181072)(tbaselexer181018* l) {
	...
	nimln(85, "nimlexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI32)(TMP1658)])), (NI32)(TMP1659));
	}
	LA11: ;
	...
	TMP1661 = mulInt((NI32)(TMP1660), 1);
	LOC13 = 0;
	LOC13 = llstreamread_179242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI32)(TMP1661));
	TMP1662 = divInt(LOC13, 1);
	charsread = (NI32)(TMP1662);
	...
	nimln(91, "nimlexbase.nim");
	{
		...
		if (!(charsread < (NI32)(TMP1664))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI32)(TMP1666);
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				TMP1667 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4631(((void*) ((*l).Buf)), (NI32)(TMP1667));
				...
				nimln(110, "nimlexbase.nim");
				{
					...
					if (!!(((NI32)(TMP1668) == oldbuflen))) goto LA35;
					nimln(110, "nimlexbase.nim");
				...
				LOC37 = 0;
				LOC37 = llstreamread_179242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI32)(TMP1670));
				TMP1671 = divInt(LOC37, 1);
				charsread = (NI32)(TMP1671);
...
N_NIMCALL(void, openbaselexer_181027)(tbaselexer181018* l, tllstream179204* inputstream, NI buflen) {
	...
	LOC5 = 0;
	LOC5 = alloc_4601((NI32)(TMP1680));
	(*l).Buf = ((NCSTRING) (LOC5));
	nimln(151, "nimlexbase.nim");
	nimln(151, "nimlexbase.nim");
	TMP1681 = subInt(buflen, 1);
	(*l).Sentinel = (NI32)(TMP1681);
...
N_NIMCALL(NI, getcolnumber_181045)(tbaselexer181018* l, NI pos) {
	...
	if ((NI32)(TMP1682) == (-2147483647 -1)) raiseOverflow();
	result = (NI32)abs((NI32)(TMP1682));
	popFrame();
	return result;
}
