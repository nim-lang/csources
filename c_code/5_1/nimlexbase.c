...
N_NIMCALL(void, fillbuffer_175072)(tbaselexer175018* l) {
	...
	nimln(85, "nimlexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI32)(TMP1652)])), (NI32)(TMP1653));
	}
	LA11: ;
	...
	TMP1655 = mulInt((NI32)(TMP1654), 1);
	LOC13 = 0;
	LOC13 = llstreamread_173242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI32)(TMP1655));
	TMP1656 = divInt(LOC13, 1);
	charsread = (NI32)(TMP1656);
	...
	nimln(91, "nimlexbase.nim");
	{
		...
		if (!(charsread < (NI32)(TMP1658))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI32)(TMP1660);
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				TMP1661 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4631(((void*) ((*l).Buf)), (NI32)(TMP1661));
				...
				nimln(110, "nimlexbase.nim");
				{
					...
					if (!!(((NI32)(TMP1662) == oldbuflen))) goto LA35;
					nimln(110, "nimlexbase.nim");
				...
				LOC37 = 0;
				LOC37 = llstreamread_173242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI32)(TMP1664));
				TMP1665 = divInt(LOC37, 1);
				charsread = (NI32)(TMP1665);
...
N_NIMCALL(NI, getcolnumber_175045)(tbaselexer175018* l, NI pos) {
	...
	if ((NI32)(TMP1676) == (-2147483647 -1)) raiseOverflow();
	result = (NI32)abs((NI32)(TMP1676));
	popFrame();
	return result;
}
