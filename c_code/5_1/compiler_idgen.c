...
STRING_LITERAL(TMP1941, "nimrod.gid", 10);
STRING_LITERAL(TMP1942, "\012", 1);
...
static N_INLINE(void, setid_171432)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP1936 = addInt(id, 1);
	gfrontendid_171006 = ((gfrontendid_171006 >= (NI32)(TMP1936)) ? gfrontendid_171006 : (NI32)(TMP1936));
	popFrame();
}
static N_INLINE(NI, divInt)(NI a, NI b) {
	NI result;
...
N_NIMCALL(void, idsynchronizationpoint_171440)(NI idrange) {
	...
	nimln(41, "idgen.nim");
	nimln(41, "idgen.nim");
	TMP1937 = divInt(gfrontendid_171006, idrange);
	TMP1938 = addInt((NI32)(TMP1937), 1);
	TMP1939 = mulInt((NI32)(TMP1938), idrange);
	TMP1940 = addInt((NI32)(TMP1939), 1);
	gfrontendid_171006 = (NI32)(TMP1940);
	popFrame();
}
N_NIMCALL(NimStringDesc*, togid_171445)(NimStringDesc* f) {
	...
	result = 0;
	nimln(47, "idgen.nim");
	result = completegeneratedfilepath_114490(((NimStringDesc*) &TMP1941), NIM_TRUE);
	popFrame();
	return result;
}
static N_INLINE(void, writeln_114502)(FILE* f, NimStringDesc** x, NI xLen0) {
	...
	nimln(160, "sysio.nim");
	write_9459(f, ((NimStringDesc*) &TMP1942));	popFrame();
}
N_NIMCALL(void, savemaxids_171451)(NimStringDesc* project) {
	FILE* f;
	NimStringDesc* LOC1;
