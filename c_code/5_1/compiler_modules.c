...
N_NIMCALL(tyObject_TSym_AXG7xcvKqaxY6koRX1xkCw*, newModule_x9bAmXhM9bUiXGO4VWhXsPNg)(tyObject_ModuleGraphcolonObjectType__RZI3hCs0FTPYx8StfC81qQ* graph, NI32 fileIdx);
...
N_NIMCALL(tyObject_TLLStream_IHsOGFu33dIY69a9bLlFHlHw*, llStreamOpen_8hTxoBHhwtwZR9cM9bBLMsCQ)(FILE* f);
...
N_NIMCALL(tyObject_TSym_AXG7xcvKqaxY6koRX1xkCw*, newModule_x9bAmXhM9bUiXGO4VWhXsPNg)(tyObject_ModuleGraphcolonObjectType__RZI3hCs0FTPYx8StfC81qQ* graph, NI32 fileIdx) {
	...
	packSym = strTableGet_lwInE2j9aCwWqT2bvslVRNA((*graph).packageSyms, pack);
	{
		...
		packSym = newSym_2uJTpCZGZAi7a4eAm1ds8Q(((tyEnum_TSymKind_cNCW9acsSznmEccl1fgQwkw) 23), T16_, NIM_NIL, (*result).info);
	...
	existing = strTableGet_lwInE2j9aCwWqT2bvslVRNA((*packSym).kindU.S3.tab, (*result).name);
	{
		...
		T29_ = toFullPath_7s19cb7WBgztz9aqEBzwwuqA((*existing).info.fileIndex);
...
{	result = (tyObject_TSym_AXG7xcvKqaxY6koRX1xkCw*)0;
	result = getModule_pXsjDtOjTbIc0Z4pPVTuIA(graph, fileIdx);
	{
		...
		tyObject_TLLStream_IHsOGFu33dIY69a9bLlFHlHw* T18_;
		NIM_BOOL T26_;
		...
		LA9_: ;
		T18_ = (tyObject_TLLStream_IHsOGFu33dIY69a9bLlFHlHw*)0;
		{
			NIM_BOOL T21_;
			T21_ = (NIM_BOOL)0;
			T21_ = ((flags &((NU64)1<<((NU)(((tyEnum_TSymFlag_K9ay6LWMat9bUiT9bIbMxpDHw) 12))&63U)))!=0);
			if (!(T21_)) goto LA22_;
	...
	{
		NIM_BOOL T28_;
		tyObject_TLLStream_IHsOGFu33dIY69a9bLlFHlHw* T31_;
		NIM_BOOL T39_;
		T28_ = (NIM_BOOL)0;
		...
		T31_ = (tyObject_TLLStream_IHsOGFu33dIY69a9bLlFHlHw*)0;
		{
			NIM_BOOL T34_;
			T34_ = (NIM_BOOL)0;
			T34_ = ((flags &((NU64)1<<((NU)(((tyEnum_TSymFlag_K9ay6LWMat9bUiT9bIbMxpDHw) 12))&63U)))!=0);
			if (!(T34_)) goto LA35_;
...
N_NIMCALL(void, wantMainModule_PaLBcYS9amHGl2vf0V7P07w)(void) {
	NimStringDesc* T5_;
	{
		...
		fatal_VpilfPWbplGz6ny7O9cfr2g_4(gCmdLineInfo_yhfh3fjBy4h9bf6keLoh9aXQ, ((tyEnum_TMsgKind_IGAWgv9aR2KqPKJfPZPEWaw) 192), ((NimStringDesc*) &TM_M5T16KOkc0tDi9bZeKl6v1w_6));
	}
	LA3_: ;
	T5_ = (NimStringDesc*)0;
