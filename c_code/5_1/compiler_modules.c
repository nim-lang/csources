...
((NI) 41)}
;
STRING_LITERAL(TMP4220, "", 0);
STRING_LITERAL(TMP4221, "nim", 3);
STRING_LITERAL(TMP4222, "system.nim", 10);
STRING_LITERAL(TMP4937, "stdin", 5);
...
N_NIMCALL(void, wantmainmodule_529922)(void) {
	NimStringDesc* LOC5;
	{
		...
		fatal_182360(gcmdlineinfo_180925, ((NU16) 186), ((NimStringDesc*) &TMP4220));
	}
	LA3: ;
	LOC5 = 0;
	LOC5 = nosaddFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP4221));
...
N_NIMCALL(void, compilesystemmodule_529901)(void) {
	{
		...
		LOC5 = 0;
		LOC5 = HEX2F_117292(libpath_169233, ((NimStringDesc*) &TMP4222));
...
N_NIMCALL(void, compileproject_529985)(NI32 projectfileidx) {
	...
	LOC1 = 0;
	LOC1 = HEX2F_117292(libpath_169233, ((NimStringDesc*) &TMP4222));
...
N_NIMCALL(tsym207843*, makestdinmodule_530003)(void) {
	...
	result = 0;
	{
		...
		LOC5 = 0;
		LOC5 = fileinfoidx_180857(((NimStringDesc*) &TMP4937));
