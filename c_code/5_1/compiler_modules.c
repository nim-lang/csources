...
STRING_LITERAL(TMP4144, "nim", 3);
STRING_LITERAL(TMP4145, "system.nim", 10);
...
N_NIMCALL(void, wantmainmodule_554005)(void) {
	NimStringDesc* LOC5;
	{
		...
		fatal_183605(gcmdlineinfo_182007, ((NU16) 186), ((NimStringDesc*) &TMP4143));
	}
	LA3: ;
	LOC5 = 0;
	LOC5 = nosaddFileExt(gprojectfull_170239, ((NimStringDesc*) &TMP4144));
...
N_NIMCALL(void, compilesystemmodule_553979)(void) {
	{
		...
		LOC5 = 0;
		LOC5 = HEX2F_118299(libpath_170236, ((NimStringDesc*) &TMP4145));
...
N_NIMCALL(void, compileproject_554068)(NI32 projectfileidx) {
	...
	LOC1 = 0;
	LOC1 = HEX2F_118299(libpath_170236, ((NimStringDesc*) &TMP4145));
...
N_NIMCALL(tsym209848*, makestdinmodule_554088)(void) {
	...
	result = 0;
	{
		...
		LOC5 = 0;
		LOC5 = fileinfoidx_181931(((NimStringDesc*) &TMP4855));
