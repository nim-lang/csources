...
STRING_LITERAL(TMP1913, "counter < length ", 17);
STRING_LITERAL(TMP1919, "not (data[h] == desc) ", 22);
STRING_LITERAL(TMP1920, "data[h] == nil ", 15);
STRING_LITERAL(TMP1929, "t.data[h] == nil ", 17);
STRING_LITERAL(TMP1930, "dest.data[h] == nil ", 20);
STRING_LITERAL(TMP1931, "{", 1);
STRING_LITERAL(TMP1932, ", ", 2);
STRING_LITERAL(TMP1933, "}", 1);
...
static N_INLINE(NIM_BOOL, mustrehash_169054)(NI length, NI counter) {
	...
	nimln(47, "intsets.nim");
	{
		...
		nimln(47, "intsets.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP1913));	}	LA3: ;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	LOC5 = 0;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	TMP1914 = mulInt(length, 2);
	nimln(48, "intsets.nim");
	TMP1915 = mulInt(counter, 3);
	LOC5 = ((NI32)(TMP1914) < (NI32)(TMP1915));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	TMP1916 = subInt(length, counter);
	LOC5 = ((NI32)(TMP1916) < 4);
	LA6: ;
	result = LOC5;
	popFrame();
...
static N_INLINE(NI, nexttry_169205)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1917 = mulInt(5, h);
	TMP1918 = addInt((NI32)(TMP1917), 1);
	result = (NI)((NI32)(TMP1918) & maxhash);
	popFrame();
	return result;
}
N_NIMCALL(ttrunk169039*, intsetget_169212)(tintset169043 t, NI key) {
...
N_NIMCALL(void, intsetrawinsert_169233)(tintset169043 t, ttrunkseq169041** data, ttrunk169039* desc) {
	...
	while (1) {
		...
		nimln(64, "intsets.nim");
		{
			...
			nimln(64, "intsets.nim");
			hiddenraiseassert_76017(((NimStringDesc*) &TMP1919));		}		LA4: ;
	...
	nimln(66, "intsets.nim");
	{
		...
		nimln(66, "intsets.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP1920));	}	LA8: ;
...
N_NIMCALL(void, intsetenlarge_169604)(tintset169043* t) {
	...
	TMP1922 = mulInt((NI32)(TMP1921), 2);
	TMP1923 = subInt((NI32)(TMP1922), 1);
	(*t).Max = (NI32)(TMP1923);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1924 = addInt((*t).Max, 1);
	n = (ttrunkseq169041*) newSeq((&NTI169041), (NI32)(TMP1924));
	i_169629 = 0;
...
N_NIMCALL(ttrunk169039*, intsetput_169661)(tintset169043* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		nimln(84, "intsets.nim");
		nimln(84, "intsets.nim");
		TMP1928 = addInt((*t).Max, 1);
		LOC8 = 0;
		LOC8 = mustrehash_169054((NI32)(TMP1928), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
	...
	nimln(88, "intsets.nim");
	{
		...
		nimln(88, "intsets.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP1929));	}	LA14: ;
...
N_NIMCALL(void, assign_169914)(tintset169043* dest, tintset169043 src) {
	...
	while (1) {
		...
		nimln(152, "intsets.nim");
		{
			...
			nimln(152, "intsets.nim");
			hiddenraiseassert_76017(((NimStringDesc*) &TMP1930));		}		LA5: ;
		n = 0;
...
N_NIMCALL(NimStringDesc*, HEX24_170076)(tintset169043 s) {
	...
	result = copyString(((NimStringDesc*) &TMP1931));
	key_170081 = 0;
...
appendString(result, ((NimStringDesc*) &TMP1932));
					}					LA10: ;
...
appendString(result, ((NimStringDesc*) &TMP1933));
	popFrame();
	return result;
}
static N_INLINE(NIM_BOOL, empty_170096)(tintset169043 s) {
...
static TNimNode* TMP1925[3];
static TNimNode* TMP3351[4];
static TNimNode TMP1911[9];
NTI169039.size = sizeof(ttrunk169039);
NTI169039.kind = 18;
NTI169039.base = 0;
TMP1925[0] = &TMP1911[1];
TMP1911[1].kind = 1;
TMP1911[1].offset = offsetof(ttrunk169039, Next);
TMP1911[1].typ = (&NTI169037);
TMP1911[1].name = "next";
TMP1925[1] = &TMP1911[2];
TMP1911[2].kind = 1;
TMP1911[2].offset = offsetof(ttrunk169039, Key);
TMP1911[2].typ = (&NTI105);
TMP1911[2].name = "key";
TMP1925[2] = &TMP1911[3];
TMP1911[3].kind = 1;
TMP1911[3].offset = offsetof(ttrunk169039, Bits);
TMP1911[3].typ = (&NTI21418);
TMP1911[3].name = "bits";
TMP1911[0].len = 3; TMP1911[0].kind = 2; TMP1911[0].sons = &TMP1925[0];
NTI169039.node = &TMP1911[0];
NTI169037.size = sizeof(ttrunk169039*);
NTI169037.kind = 22;
NTI169037.base = (&NTI169039);
NTI169037.marker = TMP1926;
NTI169041.size = sizeof(ttrunkseq169041*);
NTI169041.kind = 24;
NTI169041.base = (&NTI169037);
NTI169041.flags = 2;
NTI169041.marker = TMP1927;
...
TMP3351[0] = &TMP1911[5];
TMP1911[5].kind = 1;
TMP1911[5].offset = offsetof(tintset169043, Counter);
TMP1911[5].typ = (&NTI105);
TMP1911[5].name = "counter";
TMP3351[1] = &TMP1911[6];
TMP1911[6].kind = 1;
TMP1911[6].offset = offsetof(tintset169043, Max);
TMP1911[6].typ = (&NTI105);
TMP1911[6].name = "max";
TMP3351[2] = &TMP1911[7];
TMP1911[7].kind = 1;
TMP1911[7].offset = offsetof(tintset169043, Head);
TMP1911[7].typ = (&NTI169037);
TMP1911[7].name = "head";
TMP3351[3] = &TMP1911[8];
TMP1911[8].kind = 1;
TMP1911[8].offset = offsetof(tintset169043, Data);
TMP1911[8].typ = (&NTI169041);
TMP1911[8].name = "data";
TMP1911[4].len = 4; TMP1911[4].kind = 2; TMP1911[4].sons = &TMP3351[0];
NTI169043.node = &TMP1911[4];
}
