...
STRING_LITERAL(TMP2980, "atom", 4);
STRING_LITERAL(TMP2981, "lit", 3);
STRING_LITERAL(TMP2982, "sym", 3);
STRING_LITERAL(TMP2983, "ident", 5);
STRING_LITERAL(TMP2984, "call", 4);
STRING_LITERAL(TMP2985, "alias", 5);
STRING_LITERAL(TMP2986, "noalias", 7);
STRING_LITERAL(TMP2987, "lvalue", 6);
STRING_LITERAL(TMP2988, "local", 5);
STRING_LITERAL(TMP2989, "sideeffect", 10);
STRING_LITERAL(TMP2990, "nosideeffect", 12);
STRING_LITERAL(TMP2992, "parampatterns.nim", 17);
NIM_CONST TY84535 TMP2991 = {((NimStringDesc*) &TMP2992),
100}
;
NIM_CONST TY84535 TMP2993 = {((NimStringDesc*) &TMP2992),
107}
;
STRING_LITERAL(TMP2994, "parameter pattern too complex", 29);
...
N_NIMCALL(void, compileconstraints_320129)(tnode224819* p, NimStringDesc** result) {
	...
	case ((NU8) 32):
	{
		...
		op = (*(*p).kindU.S6.Sons->data[0]).kindU.S5.Ident;
		{
			...
			if (!(LOC8 == 3)) goto LA9;
			{
				NIM_BOOL LOC13;
				LOC13 = 0;
				LOC13 = eqStrings((*op).S, ((NimStringDesc*) &TMP2977));
				if (LOC13) goto LA14;
				LOC13 = ((*op).Sup.Id == 46);
				LA14: ;
				if (!LOC13) goto LA15;
			...
			LA15: ;
			{
				NIM_BOOL LOC18;
				LOC18 = 0;
				LOC18 = eqStrings((*op).S, ((NimStringDesc*) &TMP2978));
				if (LOC18) goto LA19;
				LOC18 = ((*op).Sup.Id == 2);
				LA19: ;
				if (!LOC18) goto LA20;
		...
		LA9: ;
		{
			...
			if (!(LOC24)) goto LA26;
			LOC27 = 0;
			LOC27 = eqStrings((*op).S, ((NimStringDesc*) &TMP2979));
			if (LOC27) goto LA28;
			LOC27 = ((*op).Sup.Id == 42);
			LA28: ;
			LOC24 = LOC27;
	...
	case ((NU8) 2):
	{
		...
		case 1: 
if (eqStrings(spec, ((NimStringDesc*) &TMP2990))) goto LA50;
break;
		case 3: 
if (eqStrings(spec, ((NimStringDesc*) &TMP2986))) goto LA46;
if (eqStrings(spec, ((NimStringDesc*) &TMP2987))) goto LA47;
if (eqStrings(spec, ((NimStringDesc*) &TMP2989))) goto LA49;
break;
		case 4: 
if (eqStrings(spec, ((NimStringDesc*) &TMP2982))) goto LA42;
break;
		case 6: 
if (eqStrings(spec, ((NimStringDesc*) &TMP2983))) goto LA43;
if (eqStrings(spec, ((NimStringDesc*) &TMP2988))) goto LA48;
break;
		case 11: 
if (eqStrings(spec, ((NimStringDesc*) &TMP2980))) goto LA40;
break;
		case 12: 
if (eqStrings(spec, ((NimStringDesc*) &TMP2981))) goto LA41;
break;
		case 13: 
if (eqStrings(spec, ((NimStringDesc*) &TMP2984))) goto LA44;
break;
		case 14: 
if (eqStrings(spec, ((NimStringDesc*) &TMP2985))) goto LA45;
break;
		}
		goto LA51;
		LA40: ;
...
N_NIMCALL(tnode224819*, semnodekindconstraints_320527)(tnode224819* p) {
	...
	(*result).kindU.S3.Strval = addChar((*result).kindU.S3.Strval, 1);
	{
		...
		}
		{
			...
			internalerror_197970((*p).Info, ((NimStringDesc*) &TMP2994));
		}
		LA12: ;
	}
	goto LA1;
