...
N_NIMCALL(NIM_BOOL, matchnodekinds_275321)(tnode185813* p, tnode185813* n) {
	...
	while (1) {
		...
		case ((NU8) 4):
		{
			...
			stack[((NI32)(TMP3604))- 0] = !(stack[((NI32)(TMP3605))- 0]);
		}
		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(251, "parampatterns.nim");
			TMP3606 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3606)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3606)])), ((NU8) 0), ((NU8) 24)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3607)])), ((NU8) 0), ((NU8) 156)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
