...
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_6, "\0120 <= bufsize ", 14);
...
{	result = (NimStringDesc*)0;
	result = paramStr_eYicl3uwirn1ppNz7OCowg(((NI) 0));
	{
		...
		if (!T3_) goto LA5_;
		{
			...
			colontmp_ = getEnv_9b1nh9cAHhSLlHOPz8lCk5FA(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_5), ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_2));
			last = ((NI) 0);
			splits = ((NI) -1);
			{
				while (1) {
...
{	result = (NimStringDesc*)0;
	...
	LA4_: ;
	path = getEnv_9b1nh9cAHhSLlHOPz8lCk5FA(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_5), ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_2));
	{
