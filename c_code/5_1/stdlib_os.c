...
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_7, "\012  0 <= bufsize ", 16);
...
N_NIMCALL(NimStringDesc*, getApplFreebsd_Mvl1mQZZxpEWtJIYJ85UWw)(void) {
	...
	memcpy((void*)req, (NIM_CONST void*)TM_yu6cxgKBBXbNsTkT9cyMd4g_3, sizeof(tyArray_VR9bNthWayFgb5M9avIR8bkA));
	{
		while (1) {
			int res;
...
{	result = (NimStringDesc*)0;
	result = paramStr_eYicl3uwirn1ppNz7OCowg(((NI) 0));
	{
		...
		if (!T3_) goto LA5_;
		{
			...
			colontmp_ = getEnv_rVXof6qIUKJ3J9cw79conT2g(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_5));
			last = ((NI) 0);
			splits = ((NI) -1);
			{
...
N_NIMCALL(NIM_BOOL, rawCreateDir_V86QyZrcGMPX0W9bv1Q53ww_2)(NimStringDesc* dir) {
	...
	LA6_: ;
	{
		...
		raiseOSError_bEwAamo1N7TKcaU9akpiyIg(T10_, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_2));
	}
	LA1_: ;
	return result;
}
...
{	result = (NimStringDesc*)0;
	...
	path = getEnv_rVXof6qIUKJ3J9cw79conT2g(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_5));
	{
