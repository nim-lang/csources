...
NIM_CONST TY_VR9bNthWayFgb5M9avIR8bkA T_yu6cxgKBBXbNsTkT9cyMd4g_6 = {((int) 1),
((int) 14),
((int) 12),
((NI32) -1)}
;
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_7, "invalid index", 13);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_8, "PATH", 4);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_9, "Failed to create the directory", 30);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_10, "HOME", 4);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_11, "/", 1);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_12, "\012  0 <= bufsize ", 16);
NIM_CONST TY_nHXaesL0DJZHyVS07ARPRA Exeexts_ONrgkgAZ9bh6KVTWl4XeOSw = {((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_3)}
;
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_13, "/.config/", 9);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_15, ".", 1);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_16, "..", 2);
static N_NIMCALL(void, Marker_TY_sM4lkSb7zS6F7OVMvW9cffQ)(void* p, NI op) {
...
N_NIMCALL(NimStringDesc*, getapplfreebsd_Mvl1mQZZxpEWtJIYJ85UWw)(void) {
	NimStringDesc* result0;
	size_t pathlength0;
	TY_VR9bNthWayFgb5M9avIR8bkA req0;
	result0 = (NimStringDesc*)0;
	pathlength0 = ((size_t) 1024);
	result0 = mnewString(((NI) (pathlength0)));
	memset((void*)req0, 0, sizeof(req0));
	memcpy((void*)req0, (NIM_CONST void*)T_yu6cxgKBBXbNsTkT9cyMd4g_6, sizeof(TY_VR9bNthWayFgb5M9avIR8bkA));
	{
		while (1) {
			int res0;
			res0 = sysctl((&req0[(((NI) 0))- 0]), ((unsigned int) 4), ((void*) ((&result0->data[((NI) 0)]))), (&pathlength0), NIM_NIL, ((NI) 0));
			{
				NI32 err0;
				if (!(res0 < ((NI32) 0))) goto LA5;
				err0 = oslasterror_pMOMIZAQaKFp1XoL58mjVg();
				{
					if (!(err0 == ENOMEM)) goto LA9;
					result0 = mnewString(((NI) (pathlength0)));
				}
				goto LA7;
				LA9: ;
			...
			LA5: ;
			{
				result0 = setLengthStr(result0, ((NI) (pathlength0)));
				goto LA1;
			}
			LA3: ;
		}
...
{	result0 = (NimStringDesc*)0;
	...
	LOC7 = (NimStringDesc*)0;
	LOC7 = (*e_9c9avxASFO8rHZknrsDnVzEA).Sup.message; (*e_9c9avxASFO8rHZknrsDnVzEA).Sup.message = copyStringRC1(((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_7));
...
{	result0 = (NimStringDesc*)0;
	result0 = paramstr_eYicl3uwirn1ppNz7OCowg(((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			HEX3Atmp_FJT9c9bnJ3EGi20yEwysG8Fg = getenv_8zNgT9bxx7m9cTt2TeVdTdIw(((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_8));
...
N_NIMCALL(NimStringDesc*, nosgetAppFilename)(void) {
	NimStringDesc* result0;
	result0 = (NimStringDesc*)0;
	result0 = getapplfreebsd_Mvl1mQZZxpEWtJIYJ85UWw();
	{
		if (!((result0 ? result0->Sup.len : 0) == ((NI) 0))) goto LA3;
		result0 = getapplheuristic_Mvl1mQZZxpEWtJIYJ85UWw_2();
	}
	LA3: ;
	return result0;
}
...
N_NIMCALL(NIM_BOOL, rawcreatedir_V86QyZrcGMPX0W9bv1Q53ww_2)(NimStringDesc* dir0) {
	...
	LA6: ;
	{
		...
		raiseoserror_K9a7YBjj81Bse0N0Fg7MFIA(LOC10, ((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_3));
	}
	LA1: ;
	return result0;
}
...
N_NIMCALL(NIM_BOOL, existsorcreatedir_V86QyZrcGMPX0W9bv1Q53ww)(NimStringDesc* dir0) {
	...
	result0 = !(LOC1);
	{
		if (!result0) goto LA4;
		{
			...
			LOC11 = (*e_4he5nelRQAcl1XtPfaowrQ).Sup.Sup.message; (*e_4he5nelRQAcl1XtPfaowrQ).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_9));
...
{	result0 = (NimStringDesc*)0;
	...
	LOC2 = getenv_8zNgT9bxx7m9cTt2TeVdTdIw(((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_10));
	LOC1 = rawNewString(LOC2->Sup.len + 1);
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_11));
	result0 = LOC1;
	goto BeforeRet;
	}BeforeRet: ;
	return result0;
			...
			LA7: ;
			{
				...
				err0 = oslasterror_pMOMIZAQaKFp1XoL58mjVg();
				{
					...
					bufsize0 = (NI)((NU32)(bufsize0) << (NU32)(((NI) 1)));
					{
						...
						raiseassert_PpfSiTIeNpMAb9a5o6SglJw_2(((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_12));
					}
					LA17: ;
					result0 = mnewString(((NI) (bufsize0)));
				}
...
{	result0 = (NimStringDesc*)0;
	...
	path0 = getenv_8zNgT9bxx7m9cTt2TeVdTdIw(((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_8));
	{
...
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_13));
	result0 = LOC1;
	goto BeforeRet;
	}BeforeRet: ;
	return result0;
...
N_NIMCALL(void, nosremoveDir)(NimStringDesc* dir0) {
	{
		...
		{
			TSafePoint T_yu6cxgKBBXbNsTkT9cyMd4g_14;
			if (!!((d_Snew50d2sxhgjxplaladWA == NIM_NIL))) goto LA4;
			pushSafePoint(&T_yu6cxgKBBXbNsTkT9cyMd4g_14);
			T_yu6cxgKBBXbNsTkT9cyMd4g_14.status = _setjmp(T_yu6cxgKBBXbNsTkT9cyMd4g_14.context);
			if (T_yu6cxgKBBXbNsTkT9cyMd4g_14.status == 0) {
				{
					while (1) {
						{
							...
							y_nqt04gTLPSvk7lCmOg2cqg = cstrToNimstr(((NCSTRING) ((*x_aQYTEBuHrMi9cGfwwrddjfg).d_name)));
							{
								...
								LOC16 = (NIM_BOOL)0;
								LOC16 = !(eqStrings(y_nqt04gTLPSvk7lCmOg2cqg, ((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_15)));
								if (!(LOC16)) goto LA17;
								LOC16 = !(eqStrings(y_nqt04gTLPSvk7lCmOg2cqg, ((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_16)));
								LA17: ;
								if (!LOC16) goto LA18;
								...
								k_3L6up3asmYrsS0W9b26IJmg = ((Pathcomponent_9c1SIU9cO1wHcl09b703A9cDrg) 0);
								{
									...
									LA30: ;
									{
										if (!((*x_aQYTEBuHrMi9cGfwwrddjfg).d_type == ((NI8) 10))) goto LA34;
										{
											NIM_BOOL LOC38;
											LOC38 = (NIM_BOOL)0;
											LOC38 = direxists_wf0Ae3eLXw0lSNEFJMV3ognimblecmd(y_nqt04gTLPSvk7lCmOg2cqg);
											if (!LOC38) goto LA39;
			...
			if (T_yu6cxgKBBXbNsTkT9cyMd4g_14.status != 0) reraiseException();
		}
		LA4: ;
	}
