...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, getApplFreebsd_Mvl1mQZZxpEWtJIYJ85UWw)(void);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, getApplHeuristic_Mvl1mQZZxpEWtJIYJ85UWw_2)(void);
...
NIM_CONST tyArray_VR9bNthWayFgb5M9avIR8bkA TM_yu6cxgKBBXbNsTkT9cyMd4g_3 = {((int) 1),
((int) 14),
((int) 12),
((NI32) -1)}
;
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_4, "PATH", 4);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_5, "/Users/andreasrumpf-mac/projects/nim/lib/pure/os.nim(282, 19) `"
"\0120 <= bufsize` ", 78);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_6, "Failed to create \'", 18);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_7, "\'", 1);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_9, ".", 1);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_10, "..", 2);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, getApplFreebsd_Mvl1mQZZxpEWtJIYJ85UWw)(void) {
	...
	nimCopyMem((void*)req, (NIM_CONST void*)TM_yu6cxgKBBXbNsTkT9cyMd4g_3, sizeof(tyArray_VR9bNthWayFgb5M9avIR8bkA));
	{
		while (1) {
			int res;
...
{	result = (NimStringDesc*)0;
	result = paramStr_eYicl3uwirn1ppNz7OCowg(((NI) 0));
	{
		...
		if (!T3_) goto LA5_;
		{
			...
			colontmp_ = getEnv_9b1nh9cAHhSLlHOPz8lCk5FA(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_4), ((NimStringDesc*) NIM_NIL));
			last = ((NI) 0);
			splits = ((NI) -1);
			{
				while (1) {
			...
			LA7_: ;
			{
				...
				err = osLastError_tNPXXFl9cb3BG0pJKzUn9bew();
				{
					...
					bufsize = (NI)((NU32)(bufsize) << (NU32)(((NI) 1)));
					{
						...
						failedAssertImpl_aDmpBTs9cPuXp0Mp9cfiNeyA(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_5));
					}
					LA17_: ;
					result = mnewString(((NI) (bufsize)));
				}
...
appendString(T11_, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_6));
...
N_LIB_PRIVATE N_NIMCALL(void, noscopyFile)(NimStringDesc* source, NimStringDesc* dest) {
	...
	LA10_: ;
	buf = alloc_4cubgSerkjpuLcj5MXjiLw(((NI) 8000));
	{
		while (1) {
			NI bytesread;
...
{	result = (NimStringDesc*)0;
	...
	LA8_: ;
	path = getEnv_9b1nh9cAHhSLlHOPz8lCk5FA(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_4), ((NimStringDesc*) NIM_NIL));
	{
...
N_LIB_PRIVATE N_NIMCALL(NI, nosexecShellCmd)(NimStringDesc* command) {
	...
	result = ((NI) ((NI32)((NU32)(T1_) >> (NU32)(((NI) 8)))));
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(void, nosremoveDir)(NimStringDesc* dir) {
	{
		...
		d = opendir(nimToCStringConv(dir));
		{
			...
			TM_yu6cxgKBBXbNsTkT9cyMd4g_8.status = _setjmp(TM_yu6cxgKBBXbNsTkT9cyMd4g_8.context);
					...
					while (1) {
						{
							...
							y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
							{
								...
								T16_ = (NIM_BOOL)0;
								T16_ = !(eqStrings(y, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_9)));
								if (!(T16_)) goto LA17_;
...
N_LIB_PRIVATE N_NIMCALL(void, nosmoveFile)(NimStringDesc* source, NimStringDesc* dest) {
	{
		...
		TM_yu6cxgKBBXbNsTkT9cyMd4g_11.status = _setjmp(TM_yu6cxgKBBXbNsTkT9cyMd4g_11.context);
