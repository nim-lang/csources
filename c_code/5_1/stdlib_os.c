...
N_NIMCALL(void, nossplitPath)(NimStringDesc* path, keyvaluepair132008* Result) {
	...
	seppos = -1;
	{
		...
		i_118331 = 0;
		HEX3Atmp_118347 = 0;
		HEX3Atmp_118347 = (NI32)(path->Sup.len - 1);
...
N_NIMCALL(NI, searchextpos_118551)(NimStringDesc* s) {
	...
	result = -1;
	{
		...
		i_118566 = 0;
		HEX3Atmp_118582 = 0;
		HEX3Atmp_118582 = (NI32)(s->Sup.len - 1);
...
N_NIMCALL(void, nossplitFile)(NimStringDesc* path, TY118604* Result) {
	...
	LA5: ;
	{
		...
		dotpos = path->Sup.len;
		{
			...
			i_118637 = 0;
			HEX3Atmp_118668 = 0;
			HEX3Atmp_118668 = (NI32)(path->Sup.len - 1);
				...
				while (1) {
					...
					i_118637 = res_118671;
					{
						if (!((NU8)(path->data[i_118637]) == (NU8)(46))) goto LA13;
						{
							...
							LOC17 = LOC18;
							if (!(LOC17)) goto LA20;
							LOC17 = !((((NU8)(path->data[(NI32)(i_118637 - 1)])) == ((NU8)(47)) || ((NU8)(path->data[(NI32)(i_118637 - 1)])) == ((NU8)(47))));
							LA20: ;
							if (!LOC17) goto LA21;
							dotpos = i_118637;
						}
...
{	result = 0;
	i = findenvvar_121405(key);
	{
		...
		result = copyStr(environment_120809->data[i], (NI32)(LOC5 + 1));
		goto BeforeRet;
	}
	goto LA1;
	LA3: ;
		...
		if (!LOC3) goto LA5;
		{
			...
			last_125415 = 0;
			{
				while (1) {
					...
					{
						NimStringDesc* x;
						if (!(first_125417 <= (NI32)(last_125415 - 1))) goto LA18;
						p_125403 = copyStrLast(HEX3Atmp_125410, first_125417, (NI32)(last_125415 - 1));
...
{	result = 0;
	...
	LA5: ;
	{
		...
		i_118396 = 0;
		HEX3Atmp_118412 = 0;
		HEX3Atmp_118412 = (NI32)(path->Sup.len - q);
...
N_NIMCALL(void, noscreateDir)(NimStringDesc* dir) {
	...
	omitnext = NIM_FALSE;
	{
		...
		i_123011 = 0;
		HEX3Atmp_123027 = 0;
		HEX3Atmp_123027 = (NI32)(dir->Sup.len - 1);
		res_123030 = 1;
		{
			while (1) {
				...
				i_123011 = res_123030;
				{
					...
					LA10: ;
					{
						NimStringDesc* LOC13;
						LOC13 = 0;
						LOC13 = copyStrLast(dir, 0, (NI32)(i_123011 - 1));
