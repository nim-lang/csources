...
typedef N_CLOSURE_PTR(NI, TMP4765) (NimStringDesc* x_360547, NimStringDesc* y_360549, void* ClEnv);
typedef struct {
N_NIMCALL_PTR(NI, ClPrc) (tindexentry357264 x_358566, tindexentry357264 y_358568, void* ClEnv);
void* ClEnv;
} TY358572;
typedef N_CLOSURE_PTR(NI, TMP4769) (tindexentry357264 x_359592, tindexentry357264 y_359594, void* ClEnv);
typedef N_CLOSURE_PTR(NI, TMP4779) (tindexentry357264 x_358549, tindexentry357264 y_358551, void* ClEnv);
struct TY357880 {
NI Field0;
NimStringDesc* Field1;
};
...
N_NIMCALL(void, TMP4781)(void* p, NI op);
...
STRING_LITERAL(TMP4602, ".nim", 4);
STRING_LITERAL(TMP4603, "Module ", 7);
STRING_LITERAL(TMP4604, "split.item.toc", 14);
STRING_LITERAL(TMP4677, "<li><a class=\"reference\" id=\"$1_toc\" href=\"#$1\">$2</a></li>\012", 60);
STRING_LITERAL(TMP4678, "\\item\\label{$1_toc} $2\\ref{$1}\012", 31);
STRING_LITERAL(TMP4679, "<ul class=\"simple\">$1</ul>", 26);
STRING_LITERAL(TMP4680, "\\begin{enumerate}$1\\end{enumerate}", 34);
STRING_LITERAL(TMP4759, ".", 1);
STRING_LITERAL(TMP4760, "..", 2);
STRING_LITERAL(TMP4761, ".idx", 4);
STRING_LITERAL(TMP4762, "doc_toc_", 8);
STRING_LITERAL(TMP4766, "Documents: ", 11);
STRING_LITERAL(TMP4770, "<a href=\"", 9);
STRING_LITERAL(TMP4771, "\">", 2);
STRING_LITERAL(TMP4772, "</a>", 4);
STRING_LITERAL(TMP4773, ", ", 2);
STRING_LITERAL(TMP4774, ".<br>", 5);
STRING_LITERAL(TMP4775, "<p />", 5);
STRING_LITERAL(TMP4776, "Modules: ", 9);
STRING_LITERAL(TMP4777, ".html\">", 7);
STRING_LITERAL(TMP4778, "<h2>Documentation files</h2>\012", 29);
STRING_LITERAL(TMP4782, "<ul>\012", 5);
STRING_LITERAL(TMP4783, "<ul>", 4);
STRING_LITERAL(TMP4784, "</ul>", 5);
STRING_LITERAL(TMP4785, "<li><a href=\"", 13);
STRING_LITERAL(TMP4786, "</a>\012", 5);
STRING_LITERAL(TMP4787, "</ul>\012", 6);
STRING_LITERAL(TMP4788, "<ul><li><a href=\"", 17);
STRING_LITERAL(TMP4789, "<h2>API symbols</h2>\012", 21);
STRING_LITERAL(TMP4790, "<dt><span>$1:</span></dt><ul class=\"simple\"><dd>\012", 49);
STRING_LITERAL(TMP4791, "<li><a class=\"reference external\"\012          title=\"$3\" href=\"$1"
"\">$2</a></li>\012          ", 87);
STRING_LITERAL(TMP4792, "<li><a class=\"reference external\" href=\"$1\">$2</a></li>\012       "
"   ", 66);
STRING_LITERAL(TMP4793, "</ul></dd>\012", 11);
...
N_NIMCALL(void, initrstgenerator_356072)(trstgenerator356016* g, NU8 target, stringtableobj131012* config, NimStringDesc* filename, NU8 options, tfindfilehandler342023 findfile, tmsghandler342021 msghandler) {
	...
	{
		NimStringDesc* LOC5;
		if (!eqStrings(fileparts.Field2, ((NimStringDesc*) &TMP4602))) goto LA3;
		LOC5 = 0;
		LOC5 = rawNewString(fileparts.Field1->Sup.len + 7);
appendString(LOC5, ((NimStringDesc*) &TMP4603));
appendString(LOC5, fileparts.Field1);
	...
	s = nstGet(config, ((NimStringDesc*) &TMP4604));
	{
		if (!!(((s) && (s)->Sup.len == 0))) goto LA8;
...
N_NIMCALL(void, rendertocentry_362538)(trstgenerator356016* d, ttocentry356012 e, NimStringDesc** result) {
	...
	dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP4677), ((NimStringDesc*) &TMP4678), LOC1, 2);
}
...
N_NIMCALL(void, rendertocentries_362554)(trstgenerator356016* d, NI* j, NI lvl, NimStringDesc** result) {
	...
	} LA1: ;
	{
		...
		dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP4679), ((NimStringDesc*) &TMP4680), LOC15, 1);
	}
	goto LA11;
	LA13: ;
	{
			...
			if (!!((d_362101 == NIM_NIL))) goto LA4;
			{
				while (1) {
					...
					y_362105 = cstrToNimstr(((NCSTRING) ((*x_362103).d_name)));
					{
						...
						if (!(LOC14)) goto LA15;
						LOC14 = !(eqStrings(y_362105, ((NimStringDesc*) &TMP4760)));
						LA15: ;
						if (!LOC14) goto LA16;
						...
						path_360056 = y_362105;
						{
							...
							if (!(LOC35)) goto LA36;
							LOC35 = nsuEndsWith(path_360056, ((NimStringDesc*) &TMP4761));
							LA36: ;
							if (!LOC35) goto LA37;
							fileentries = 0;
...
appendString(LOC86, ((NimStringDesc*) &TMP4762));
appendString(LOC86, LOC88);
	...
	LOC90.ClPrc = ((TMP4765) (cmp_4528)); LOC90.ClEnv = NIM_NIL;
...
N_NIMCALL(NimStringDesc*, generatedocumentationjumps_359423)(table357277 docs) {
	...
	NimStringDesc* LOC20;
	result_359426 = 0;
	result_359426 = copyString(((NimStringDesc*) &TMP4766));
	...
	memset((void*)&LOC13, 0, sizeof(LOC13));
	LOC13.ClPrc = ((TMP4769) (cmp_357298)); LOC13.ClEnv = NIM_NIL;
...
appendString(LOC17, ((NimStringDesc*) &TMP4772));
	...
	LOC19 = 0;
	LOC20 = 0;
	LOC20 = nsuJoinSep(chunks->data, chunks->Sup.len, ((NimStringDesc*) &TMP4773));
	LOC19 = rawNewString(LOC20->Sup.len + 5);
appendString(LOC19, LOC20);
appendString(LOC19, ((NimStringDesc*) &TMP4774));
...
appendString(LOC4, ((NimStringDesc*) &TMP4770));
appendString(LOC4, name_359757);
appendString(LOC4, ((NimStringDesc*) &TMP4777));
appendString(LOC4, name_359757);
appendString(LOC4, ((NimStringDesc*) &TMP4772));
				chunks = (TY119408*) incrSeq(&(chunks)->Sup, sizeof(NimStringDesc*));
				LOC5 = 0;
	...
	LOC6 = 0;
	LOC7 = 0;
	LOC7 = nsuJoinSep(chunks->data, chunks->Sup.len, ((NimStringDesc*) &TMP4773));
	LOC6 = rawNewString(LOC7->Sup.len + 5);
appendString(LOC6, LOC7);
appendString(LOC6, ((NimStringDesc*) &TMP4774));
...
N_NIMCALL(NimStringDesc*, indenttolevel_357860)(NI* level, NI newlevel) {
	...
	LA3: ;
	{
		...
		result = nsuRepeatStr((NI32)(newlevel - (*level)), ((NimStringDesc*) &TMP4783));
	}
	goto LA5;
	LA7: ;
	{
		result = nsuRepeatStr((NI32)((*level) - newlevel), ((NimStringDesc*) &TMP4784));
	}
	LA5: ;
	(*level) = newlevel;
	BeforeRet: ;
...
appendString(LOC22, ((NimStringDesc*) &TMP4771));
...
appendString(LOC23, ((NimStringDesc*) &TMP4787));
...
N_NIMCALL(NimStringDesc*, generatedocumentationindex_358231)(table357277 docs) {
	...
	memset((void*)&LOC13, 0, sizeof(LOC13));
	LOC13.ClPrc = ((TMP4779) (cmp_357298)); LOC13.ClEnv = NIM_NIL;
	sort_358553(titles->data, titles->Sup.len, LOC13, ((NU8) 1));
	{
...
appendString(LOC18, ((NimStringDesc*) &TMP4771));
...
N_NIMCALL(NimStringDesc*, generatesymbolindex_357695)(TY359804* symbols) {
	...
	i = 0;
	{
		while (1) {
			...
			nsuAddf(&result, ((NimStringDesc*) &TMP4790), LOC3, 1);
			j = i;
			{
				while (1) {
					NIM_BOOL LOC6;
					...
					LA13: ;
					{
						...
						nsuAddf(&result, ((NimStringDesc*) &TMP4791), LOC22, 3);
					}
					goto LA18;
					LA20: ;
					{
						...
						nsuAddf(&result, ((NimStringDesc*) &TMP4792), LOC24, 2);
					}
					LA18: ;
					j += 1;
				} LA5: ;
...
static TNimNode* TMP4593[13];
static TNimNode* TMP4594[2];
NI TMP4596;
static char* NIM_CONST TMP4595[2] = {
"outHtml", 
"outLatex"};
static TNimNode* TMP4597[3];
static TNimNode* TMP4756[4];
static TNimNode* TMP4780[2];
...
NTI356010.base = 0;
NTI356010.flags = 3;
for (TMP4596 = 0; TMP4596 < 2; TMP4596++) {
TMP882[TMP4596+2].kind = 1;
TMP882[TMP4596+2].offset = TMP4596;
TMP882[TMP4596+2].name = TMP4595[TMP4596];
TMP4594[TMP4596] = &TMP882[TMP4596+2];
}
TMP882[4].len = 2; TMP882[4].kind = 2; TMP882[4].sons = &TMP4594[0];
...
TMP882[8].len = 3; TMP882[8].kind = 2; TMP882[8].sons = &TMP4597[0];
NTI356012.node = &TMP882[8];
NTI356032.size = sizeof(TY356032*);
NTI356032.kind = 24;
NTI356032.base = (&NTI356012);
NTI356032.flags = 2;
NTI356032.marker = TMP4598;
TMP882[7].kind = 1;
...
TMP882[21].len = 4; TMP882[21].kind = 2; TMP882[21].sons = &TMP4756[0];
NTI357264.node = &TMP882[21];
NTI359804.size = sizeof(TY359804*);
NTI359804.kind = 24;
NTI359804.base = (&NTI357264);
NTI359804.flags = 2;
NTI359804.marker = TMP4757;
...
TMP882[26].len = 2; TMP882[26].kind = 2; TMP882[26].sons = &TMP4780[0];
NTI357880.node = &TMP882[26];
NTI357879.size = sizeof(TY357879*);
NTI357879.kind = 24;
NTI357879.base = (&NTI357880);
NTI357879.flags = 2;
NTI357879.marker = TMP4781;
}
