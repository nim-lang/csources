...
STRING_LITERAL(TMP4071, "NIM_merge_INFO", 14);
STRING_LITERAL(TMP4072, "typeCache", 9);
STRING_LITERAL(TMP4073, "declared", 8);
STRING_LITERAL(TMP4074, "typeInfo", 8);
STRING_LITERAL(TMP4075, "labels", 6);
STRING_LITERAL(TMP4076, "hasframe", 8);
STRING_LITERAL(TMP4077, "ccgmerge: \'{\' expected", 22);
STRING_LITERAL(TMP4078, "ccgmerge: unkown key: ", 22);
STRING_LITERAL(TMP4147, "ccgmerge: expected: /*\011NIM_merge_END:*/", 39);
STRING_LITERAL(TMP4148, "/*\011NIM_merge_END:*/", 19);
STRING_LITERAL(TMP4149, "", 0);
STRING_LITERAL(TMP4150, "NIM_merge_HEADERS", 17);
STRING_LITERAL(TMP4151, "NIM_merge_FORWARD_TYPES", 23);
STRING_LITERAL(TMP4152, "NIM_merge_TYPES", 15);
STRING_LITERAL(TMP4153, "NIM_merge_SEQ_TYPES", 19);
STRING_LITERAL(TMP4154, "NIM_merge_FIELD_INFO", 20);
STRING_LITERAL(TMP4155, "NIM_merge_TYPE_INFO", 19);
STRING_LITERAL(TMP4156, "NIM_merge_PROC_HEADERS", 22);
STRING_LITERAL(TMP4157, "NIM_merge_DATA", 14);
STRING_LITERAL(TMP4158, "NIM_merge_VARS", 14);
STRING_LITERAL(TMP4159, "NIM_merge_PROCS", 15);
STRING_LITERAL(TMP4160, "NIM_merge_INIT_PROC", 19);
STRING_LITERAL(TMP4161, "NIM_merge_TYPE_INIT1", 20);
STRING_LITERAL(TMP4162, "NIM_merge_TYPE_INIT2", 20);
STRING_LITERAL(TMP4163, "NIM_merge_TYPE_INIT3", 20);
STRING_LITERAL(TMP4164, "NIM_merge_DEBUG_INIT", 20);
STRING_LITERAL(TMP4165, "NIM_merge_DYNLIB_INIT", 21);
STRING_LITERAL(TMP4166, "NIM_merge_DYNLIB_DEINIT", 23);
NIM_CONST TY486013 cfilesectionnames_486012 = {((NimStringDesc*) &TMP4149),
...
;
STRING_LITERAL(TMP4167, "NIM_merge_PROC_LOCALS", 21);
STRING_LITERAL(TMP4168, "NIM_merge_PROC_INIT", 19);
STRING_LITERAL(TMP4169, "NIM_merge_PROC_BODY", 19);
NIM_CONST TY486019 cprocsectionnames_486018 = {((NimStringDesc*) &TMP4167),
((NimStringDesc*) &TMP4168),
((NimStringDesc*) &TMP4169)}
;
STRING_LITERAL(TMP4170, "ccgmerge: unknown section: ", 27);
STRING_LITERAL(TMP4171, "ccgmerge: \'*/\' expected", 23);
STRING_LITERAL(TMP4175, "/*\011", 3);
STRING_LITERAL(TMP4176, ":*/", 3);
STRING_LITERAL(TMP4184, "/*\011NIM_merge_INFO:", 18);
STRING_LITERAL(TMP4185, "typeCache:{", 11);
STRING_LITERAL(TMP4186, "declared:{", 10);
STRING_LITERAL(TMP4187, "typeInfo:{", 10);
STRING_LITERAL(TMP4188, "labels:", 7);
STRING_LITERAL(TMP4189, " hasframe:", 10);
...
N_NIMCALL(void, readkey_486535)(tbaselexer197024* l, NimStringDesc** result) {
	...
	}
	{
		...
		internalerror_183688(((NimStringDesc*) &TMP4070));
	}
	LA5: ;
	(*l).Bufpos = (NI32)(pos + 1);
}
...
N_NIMCALL(void, readtypecache_486607)(tbaselexer197024* l, tidtable209866* result) {
	{
		...
		internalerror_183688(((NimStringDesc*) &TMP4077));
	}
	LA3: ;
	(*l).Bufpos += 1;
	{
...
N_NIMCALL(void, processmergeinfo_486711)(tbaselexer197024* l, tcgen485035* m) {
	...
	k = rawNewString(9);
	{
		while (1) {
			...
			LA7: ;
			readkey_486535(l, (&k));
			if (eqStrings(k, ((NimStringDesc*) &TMP4072))) goto LA9;
			if (eqStrings(k, ((NimStringDesc*) &TMP4073))) goto LA10;
			if (eqStrings(k, ((NimStringDesc*) &TMP4074))) goto LA11;
			if (eqStrings(k, ((NimStringDesc*) &TMP4075))) goto LA12;
			if (eqStrings(k, ((NimStringDesc*) &TMP4076))) goto LA13;
			goto LA14;
			LA9: ;
			{
...
appendString(LOC24, ((NimStringDesc*) &TMP4078));
...
{	s_486820 = llstreamopen_196273(cfilename, ((NU8) 0));
	...
	k = rawNewString(23);
	{
		while (1) {
			...
			readkey_486535((&l), (&k));
			{
				if (!eqStrings(k, ((NimStringDesc*) &TMP4071))) goto LA13;
...
N_NIMCALL(NIM_BOOL, atendmark_486456)(NCSTRING buf, NI pos) {
	...
	s = 0;
	{
		while (1) {
			...
			LOC3 = (s < 19);
			if (!(LOC3)) goto LA4;
			LOC3 = ((NU8)(buf[(NI32)(pos + s)]) == (NU8)(((NimStringDesc*) &TMP4148)->data[s]));
			LA4: ;
			if (!LOC3) goto LA2;
			s += 1;
		} LA2: ;
...
appendString(r, tnl_175629);
			...
			case 0:
			{
				internalerror_183688(((NimStringDesc*) &TMP4147));
				goto LA1;
			}
			break;
			default:
...
appendString(LOC34, ((NimStringDesc*) &TMP4170));
appendString(LOC34, k);
			...
			LA18: ;
			{
				internalerror_183688(((NimStringDesc*) &TMP4171));
			}
			LA11: ;
		}
	} LA5: ;
...
N_NIMCALL(trope178009*, gensectionstart_486126)(NU8 ps) {
	...
	result = 0;
	{
		...
		app_178060(&result, ((NimStringDesc*) &TMP4176));
...
appendString(LOC5, ((NimStringDesc*) &TMP4148));
...
{	result = 0;
	...
	LA3: ;
	s = copyString(((NimStringDesc*) &TMP4184));
	s = resizeString(s, tnl_175629->Sup.len + 0);
appendString(s, tnl_175629);
	s = resizeString(s, 11);
...
appendString(s, tnl_175629);
	s = resizeString(s, 2);
appendString(s, ((NimStringDesc*) &TMP4190));
