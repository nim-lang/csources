...
STRING_LITERAL(TMP2027, "", 0);
STRING_LITERAL(TMP2028, "-", 1);
STRING_LITERAL(TMP2029, "stdinfile", 9);
STRING_LITERAL(TMP2058, "nim.cfg", 7);
STRING_LITERAL(TMP2059, "nims", 4);
STRING_LITERAL(TMP3722, "config.nims", 11);
STRING_LITERAL(TMP5310, "./", 2);
...
appendString(LOC7, ((NimStringDesc*) &TMP5310));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
{	{
	...
	LA4: ;
	{
		...
		processcmdline_530203(((NU8) 0), ((NimStringDesc*) &TMP2027));
		{
			NimStringDesc* LOC11;
			NimStringDesc* LOC12;
			if (!eqStrings(gprojectname_160199, ((NimStringDesc*) &TMP2028))) goto LA9;
			LOC11 = 0;
			LOC11 = gprojectname_160199; gprojectname_160199 = copyStringRC1(((NimStringDesc*) &TMP2029));
			if (LOC11) nimGCunrefNoCycle(LOC11);
			LOC12 = 0;
			LOC12 = gprojectfull_160201; gprojectfull_160201 = copyStringRC1(((NimStringDesc*) &TMP2029));
		...
		LA9: ;
		{
			...
			pushSafePoint(&TMP2030);
			TMP2030.status = _setjmp(TMP2030.context);
			if (TMP2030.status == 0) {
			...
			if (TMP2030.status != 0) reraiseException();
		...
		LA7: ;
		loadconfigs_210603(((NimStringDesc*) &TMP2058));
		scriptfile = noschangeFileExt(gprojectfull_160201, ((NimStringDesc*) &TMP2059));
		{
			NIM_BOOL LOC25;
			LOC25 = 0;
			LOC25 = fileexists_121804(scriptfile);
			if (!LOC25) goto LA26;
			runnimscript_535202(scriptfile);
			{
		...
		LA26: ;
		{
			...
			NimStringDesc* LOC37;
			LOC33 = 0;
			LOC33 = HEX2F_118465(gprojectpath_160200, ((NimStringDesc*) &TMP3722));
			LOC34 = 0;
			LOC34 = fileexists_121804(LOC33);
			if (!LOC34) goto LA35;
			LOC37 = 0;
			LOC37 = HEX2F_118465(gprojectpath_160200, ((NimStringDesc*) &TMP3722));
			runnimscript_535202(LOC37);
		}
		goto LA23;
		LA35: ;
		LA23: ;
		initvars_194834();
		processcmdline_530203(((NU8) 1), ((NimStringDesc*) &TMP2027));
		{
		...
		maincommand_532610();
		{
			...
			if (!(LOC44)) goto LA45;
			LOC44 = ((gnotes_183080 &((NU64)1<<((NU)((((NU16) 289)- 237))&63U)))!=0);
			LA45: ;
			if (!LOC44) goto LA46;
			LOC48 = 0;
		...
		LA46: ;
		{
			if (!(gerrorcounter_183081 == ((NI) 0))) goto LA51;
			{
				if (!((gglobaloptions_160121 &(1U<<((NU)(((NU8) 13))&31U)))!=0)) goto LA55;
				{
					...
					LA63: ;
					{
						...
						NimStringDesc* LOC69;
						LOC67 = 0;
						LOC67 = noschangeFileExt(gprojectfull_160201, ((NimStringDesc*) &TMP5311));
						LOC68 = 0;
...
appendString(LOC70, arguments_201699);
				...
				LA59: ;
				{
					...
					LA75: ;
					{
						NimStringDesc* LOC78;
						LOC78 = 0;
						LOC78 = noschangeFileExt(gprojectfull_160201, ((NimStringDesc*) &TMP2027));
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	...
	msgquit_183152(((NI8) ((((NI) 0) < gerrorcounter_183081))));
}
