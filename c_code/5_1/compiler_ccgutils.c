...
static NIM_CONST TY172865 TMP5592 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5593, "sons", 4);
extern NIM_CONST TY119461 cpu_119460;
STRING_LITERAL(TMP5596, "value expected, but got a type", 30);
STRING_LITERAL(TMP5597, "GetUniqueType", 13);
STRING_LITERAL(TMP5599, "\"", 1);
STRING_LITERAL(TMP5600, "c\"", 2);
STRING_LITERAL(TMP5604, "\\00\"", 4);
...
static N_INLINE(NI, len_173102)(tnode172659* n) {
	...
	{
		nimln(873, "ast.nim");
		if (((TMP5592[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP5593));
...
N_NIMCALL(NI64, hashstring_367102)(NimStringDesc* s) {
	...
	LA3: ;
	{
		...
		nimln(46, "ccgutils.nim");
		nimln(46, "ccgutils.nim");
		TMP5595 = subInt(s->Sup.len, 1);
		HEX3Atmp_367180 = (NI32)(TMP5595);
		nimln(1301, "system.nim");
		res_367182 = 0;
		nimln(1302, "system.nim");
		while (1) {
...
static N_INLINE(ttype172693*, lastson_173034)(ttype172693* n) {
	...
	TMP5598 = subInt(LOC1, 1);
	if ((NU)((NI32)(TMP5598)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP5598)];
	popFrame();
	return result;
}
N_NIMCALL(ttype172693*, getuniquetype_367401)(ttype172693* key) {
	...
	case ((NU8) 55):
	{
		...
		internalerror_139383(((NimStringDesc*) &TMP5596));	}	break;
	case ((NU8) 12):
	{
		nimln(92, "ccgutils.nim");
		internalerror_139383(((NimStringDesc*) &TMP5597));	}	break;
	case ((NU8) 11):
	case ((NU8) 13):
	case ((NU8) 15):
	case ((NU8) 47):
...
N_NIMCALL(NimStringDesc*, makesinglelinecstring_367611)(NimStringDesc* s) {
	...
	result = copyString(((NimStringDesc*) &TMP5599));
	c_367615 = 0;
...
N_NIMCALL(trope121007*, makellvmstring_367621)(NimStringDesc* s) {
	...
	res = copyString(((NimStringDesc*) &TMP5600));
	i_367636 = 0;
	HEX3Atmp_367647 = 0;
	nimln(169, "ccgutils.nim");
	nimln(169, "ccgutils.nim");
	nimln(169, "ccgutils.nim");
	TMP5601 = subInt(s->Sup.len, 1);
	HEX3Atmp_367647 = (NI32)(TMP5601);
	nimln(1301, "system.nim");
	res_367649 = 0;
	nimln(1302, "system.nim");
	while (1) {
		...
		nimln(170, "ccgutils.nim");
		{
			...
			nimln(170, "ccgutils.nim");
			nimln(170, "ccgutils.nim");
			TMP5602 = addInt(i_367636, 1);
			TMP5603 = modInt((NI32)(TMP5602), 64);
			if (!(((NI) ((NI32)(TMP5603))) == 0)) goto LA4;
...
appendString(res, ((NimStringDesc*) &TMP5604));
