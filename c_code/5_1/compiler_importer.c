...
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3605, "strVal", 6);
static NIM_CONST TY172865 TMP3606 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3607, "ident", 5);
static NIM_CONST TY172865 TMP3608 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3609, "sym", 3);
static NIM_CONST TY172865 TMP3610 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3611, "sons", 4);
STRING_LITERAL(TMP3612, "as", 2);
...
STRING_LITERAL(TMP3619, "rawImportSymbol", 15);
STRING_LITERAL(TMP3620, "tab", 3);
STRING_LITERAL(TMP3621, "importSymbol: 2", 15);
STRING_LITERAL(TMP3622, "importSymbol: 3", 15);
STRING_LITERAL(TMP3623, "importAllSymbols: ", 18);
STRING_LITERAL(TMP3624, "a.Kind == nkSym ", 16);
STRING_LITERAL(TMP3625, "\'export except\' not implemented", 31);
STRING_LITERAL(TMP3627, "module alias must be an identifier", 34);
...
N_NIMCALL(NimStringDesc*, getmodulename_266012)(tnode172659* n) {
	...
	case ((NU8) 29):
	{
		...
		nimln(31, "importer.nim");
		{
			...
			LOC7 = 0;
			nimln(31, "importer.nim");
			if (((TMP3610[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3611));
			...
			if (((TMP3610[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3611));
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!(((TMP3606[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3607));
			nimln(31, "importer.nim");
			LOC9 = 0;
			LOC9 = getident_141443(((NimStringDesc*) &TMP3612));
		...
		result = nsuReplaceStr(LOC13, ((NimStringDesc*) &TMP3613), ((NimStringDesc*) &TMP3614));
	}	break;
	case ((NU8) 45):
	{
		NimStringDesc* LOC15;
		...
		result = nsuReplaceStr(LOC15, ((NimStringDesc*) &TMP3615), ((NimStringDesc*) &TMP3616));
	}	break;
	case ((NU8) 78):
	{
	...
	default:
	{
		...
		LOC19 = 0;
		LOC19 = nsuFormatSingleElem(((NimStringDesc*) &TMP3617), LOC18);
...
static N_INLINE(NIM_BOOL, haspattern_177877)(tsym172689* s) {
	...
	nimln(698, "system.nim");
	nimln(698, "system.nim");
	if (((TMP3610[(*(*s).Ast).Kind/8] &(1<<((*(*s).Ast).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3611));
...
N_NIMCALL(void, rawimportsymbol_266189)(tcontext263019* c, tsym172689* s) {
	...
	strtableadd_179078(&(*(*c).Importtable).Symbols, s);	nimln(71, "importer.nim");
	{
		...
		nimln(73, "importer.nim");
		{
			...
			TMP3618 = subInt(LOC21, 1);
			HEX3Atmp_266326 = (NI32)(TMP3618);
			...
			while (1) {
				...
				if (((TMP3610[(*(*etyp).N).Kind/8] &(1<<((*(*etyp).N).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3611));
				if ((NU)(j_266258) >= (NU)((*(*etyp).N).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (!(((TMP3608[(*(*(*etyp).N).kindU.S6.Sons->data[j_266258]).Kind/8] &(1<<((*(*(*etyp).N).kindU.S6.Sons->data[j_266258]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3609));
				...
				nimln(76, "importer.nim");
				{
					...
					internalerror_139369((*s).Info, ((NimStringDesc*) &TMP3619));				}				LA25: ;
...
N_NIMCALL(void, importsymbol_266334)(tcontext263019* c, tnode172659* n, tsym172689* frommod) {
	...
	if (!(((64 &(1<<(((*frommod).Kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3620));
	...
	LA3: ;
	{
		...
		nimln(102, "importer.nim");
		{
			...
			internalerror_139369((*n).Info, ((NimStringDesc*) &TMP3621));		}		LA12: ;
		...
		case ((NU8) 15):
		{
			...
			while (1) {
				...
				nimln(111, "importer.nim");
				{
					...
					nimln(111, "importer.nim");
					internalerror_139369((*n).Info, ((NimStringDesc*) &TMP3622));				}				LA18: ;
...
appendString(LOC14, ((NimStringDesc*) &TMP3623));
...
N_NIMCALL(void, importforwarded_266511)(tcontext263019* c, tnode172659* n, tintset169043 exceptset) {
	...
	case ((NU8) 117):
	{
		...
		while (1) {
			...
			nimln(137, "importer.nim");
			{
				...
				nimln(137, "importer.nim");
				hiddenraiseassert_76017(((NimStringDesc*) &TMP3624));			}			LA10: ;
			nimln(138, "importer.nim");
			if (!(((TMP3608[(*a_266524).Kind/8] &(1<<((*a_266524).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3609));
	...
	case ((NU8) 118):
	{
		...
		localerror_139349((*n).Info, ((NU16) 4), ((NimStringDesc*) &TMP3625));	}	break;
	default:
	{
		NI i_266630;
		NI HEX3Atmp_266648;
		...
		TMP3626 = subInt(LOC24, 1);
		HEX3Atmp_266648 = (NI32)(TMP3626);
		nimln(1308, "system.nim");
		res_266650 = 0;
		nimln(1309, "system.nim");
		while (1) {
...
N_NIMCALL(tsym172689*, importmoduleas_266656)(tnode172659* n, tsym172689* realmodule) {
	...
	LA3: ;
	{
		...
		localerror_139349((*n).Info, ((NU16) 4), ((NimStringDesc*) &TMP3627));	}	goto LA1;
	LA9: ;
	{
		nimln(698, "system.nim");
		nimln(698, "system.nim");
		if (((TMP3610[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3611));
		if ((NU)(1) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3606[(*(*n).kindU.S6.Sons->data[1]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[1]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3607));
...
N_NIMCALL(tnode172659*, evalimport_266002)(tcontext263019* c, tnode172659* n) {
	...
	TMP3628 = subInt(LOC1, 1);
	HEX3Atmp_266804 = (NI32)(TMP3628);
	nimln(1301, "system.nim");
	res_266806 = 0;
	nimln(1302, "system.nim");
	while (1) {
...
N_NIMCALL(tnode172659*, evalfrom_266007)(tcontext263019* c, tnode172659* n) {
	...
	nimln(180, "importer.nim");
	{
		...
		TMP3629 = subInt(LOC5, 1);
		HEX3Atmp_266891 = (NI32)(TMP3629);
		nimln(1301, "system.nim");
		res_266893 = 1;
		nimln(1302, "system.nim");
		while (1) {
