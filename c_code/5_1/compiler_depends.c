...
static NIM_CONST TY172865 TMP7013 = {
...
N_NIMCALL(void, adddependencyaux_415019)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	appf_121085(&gdotgraph_415016, ((NimStringDesc*) &TMP7012), LOC1, 2);	popFrame();
}
static N_INLINE(NI, sonslen_173022)(tnode172659* n) {
	NI result;
...
NTI415011.flags = 2;
TMP7010[0].kind = 1;
TMP7010[0].offset = offsetof(tgen415011, Module);
TMP7010[0].typ = (&NTI172657);
TMP7010[0].name = "module";
NTI415011.node = &TMP7010[0];
NTI415013.size = sizeof(tgen415011*);
NTI415013.kind = 22;
NTI415013.base = (&NTI415011);
NTI415013.flags = 2;
NTI415013.marker = TMP7020;
}
