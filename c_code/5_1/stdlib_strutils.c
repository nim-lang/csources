...
101}
;
STRING_LITERAL(TMP5292, "GB", 2);
STRING_LITERAL(TMP5293, "MB", 2);
STRING_LITERAL(TMP5294, "KB", 2);
STRING_LITERAL(TMP5295, "B", 1);
...
appendString(LOC19, ((NimStringDesc*) &TMP5294));
		result = LOC19;
	}
	goto LA1;
	LA17: ;
...
appendString(LOC24, ((NimStringDesc*) &TMP5295));
		result = LOC24;
	}
	LA1: ;
	return result;
