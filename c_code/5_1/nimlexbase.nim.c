...
N_LIB_PRIVATE N_NIMCALL(void, fillBuffer_X9aea9bJavePT9cGIdd7JRH7Q)(tyObject_TBaseLexer_jTxk7Uc2dfr9aTDL2dZhO9ag* L) {
	...
	LA7_: ;
	{
		...
		moveMem_M04YC71iJg1N7gBF3HZTng_2system(((void*) ((&(*L).buf->data[((NI) 0)]))), ((void*) ((&(*L).buf->data[(NI)(TM_jNFaG9cOzyJSKBcIonhGRGw_9)]))), ((NI)chckRange(toCopy, ((NI) 0), ((NI) 2147483647))));
	}
	LA11_: ;
		...
		s = (NI)(TM_jNFaG9cOzyJSKBcIonhGRGw_13);
		{
			while (1) {
				...
				LA30_: ;
				{
					...
					unsureAsgnRef((void**) (&(*L).buf), setLengthStr((*L).buf, ((NI)chckRange((NI)(TM_jNFaG9cOzyJSKBcIonhGRGw_16), ((NI) 0), ((NI) 2147483647)))));
					{
...
N_LIB_PRIVATE N_NIMCALL(NI, getColNumber_D0ufm9c9azweHuDkFTPoIzqQ)(tyObject_TBaseLexer_jTxk7Uc2dfr9aTDL2dZhO9ag* L, NI pos) {
	...
	if ((NI)(TM_jNFaG9cOzyJSKBcIonhGRGw_24) == (-2147483647 -1)) raiseOverflow();
