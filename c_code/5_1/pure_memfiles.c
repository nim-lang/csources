...
TMP2947[0] = &TMP2864[1];
TMP2864[1].kind = 1;
TMP2864[1].offset = offsetof(tmemfile210204, Mem);
TMP2864[1].typ = (&NTI146);
TMP2864[1].name = "mem";
TMP2947[1] = &TMP2864[2];
TMP2864[2].kind = 1;
TMP2864[2].offset = offsetof(tmemfile210204, Size);
TMP2864[2].typ = (&NTI105);
TMP2864[2].name = "size";
TMP2947[2] = &TMP2864[3];
TMP2864[3].kind = 1;
TMP2864[3].offset = offsetof(tmemfile210204, Handle);
TMP2864[3].typ = (&NTI3809);
TMP2864[3].name = "handle";
TMP2864[0].len = 3; TMP2864[0].kind = 2; TMP2864[0].sons = &TMP2947[0];
NTI210204.node = &TMP2864[0];
}
