...
N_NIMCALL(void, TMP1604)(void* p, NI op);
...
N_NIMCALL(tllstream162204*, llstreamopen_162232)(void);
N_NIMCALL(tllstream162204*, llstreamopenstdin_162235)(void);
N_NIMCALL(void, llstreamclose_162238)(tllstream162204* s);
N_NIMCALL(NIM_BOOL, readlinefromstdin_162376)(NimStringDesc* prompt, NimStringDesc** line);
N_NIMCALL(void, write_9459)(FILE* f, NimStringDesc* s);
N_NIMCALL(NIM_BOOL, readline_9483)(FILE* f, NimStringDesc** line);
N_NIMCALL(NIM_BOOL, endswith_162402)(NimStringDesc* x, TY113118 s);
static N_INLINE(NI, subInt)(NI a, NI b);
N_NOINLINE(void, raiseOverflow)(void);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(NIM_BOOL, endswithopr_162437)(NimStringDesc* x);
static N_INLINE(NIM_BOOL, continueline_162443)(NimStringDesc* line, NIM_BOOL intriplestring);
N_NIMCALL(NI, counttriples_162462)(NimStringDesc* s);
...
N_NIMCALL(void, llstreamwrite_162268)(tllstream162204* s, void* buf, NI buflen);
N_NIMCALL(NimStringDesc*, llstreamreadall_162254)(tllstream162204* s);
N_NIMCALL(NimStringDesc*, copyStr)(NimStringDesc* s, NI start);
N_NIMCALL(NimStringDesc*, copyStr)(NimStringDesc* s, NI first);
N_NIMCALL(NimStringDesc*, mnewString)(NI len);
N_NIMCALL(NimStringDesc*, mnewString)(NI len);
STRING_LITERAL(TMP1605, "", 0);
NIM_CONST TY113118 linecontinuationoprs_162432 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
NIM_CONST TY113118 additionallinecontinuationoprs_162434 = {
0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x24,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY113118 TMP1607 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY113118 TMP1608 = {
0x00, 0x00, 0x00, 0x00, 0x7A, 0xBC, 0x00, 0xF4,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP1611, ">>> ", 4);
STRING_LITERAL(TMP1612, "... ", 4);
STRING_LITERAL(TMP1613, "\012", 1);
extern TNimType NTI1009; /* TObject */
TNimType NTI162204; /* TLLStream */
TNimType NTI162202; /* TLLStreamKind */
extern TNimType NTI9004; /* TFile */
extern TNimType NTI142; /* string */
extern TNimType NTI105; /* int */
TNimType NTI162206; /* PLLStream */
...
N_NIMCALL(tllstream162204*, llstreamopen_162218)(NimStringDesc* data) {
	...
	result = (tllstream162204*) newObj((&NTI162206), sizeof(tllstream162204));
	(*result).Sup.m_type = (&NTI162204);
...
N_NIMCALL(tllstream162204*, llstreamopenstdin_162235)(void) {
	...
	LOC1 = 0;
	LOC1 = (*result).S; (*result).S = copyStringRC1(((NimStringDesc*) &TMP1605));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
N_NIMCALL(NIM_BOOL, endswithopr_162437)(NimStringDesc* x) {
	...
	result = endswith_162402(x, TMP1607);
	popFrame();
	return result;
}
static N_INLINE(NIM_BOOL, continueline_162443)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_162402(line, TMP1608);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(NI, counttriples_162462)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1609 = addInt(i, 1);
			if ((NU)((NI32)(TMP1609)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI32)(TMP1609)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1610 = addInt(i, 2);
			if ((NU)((NI32)(TMP1610)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI32)(TMP1610)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
N_NIMCALL(NI, llreadfromstdin_162501)(tllstream162204* s, void* buf, NI buflen) {
	...
	LOC1 = 0;
	LOC1 = (*s).S; (*s).S = copyStringRC1(((NimStringDesc*) &TMP1605));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	...
	while (1) {
		...
		nimln(119, "llstream.nim");
		{
			...
			LOC3 = copyString(((NimStringDesc*) &TMP1611));
		}		goto LA4;
		LA6: ;
		{
			LOC3 = copyString(((NimStringDesc*) &TMP1612));
		}		LA4: ;
		LOC9 = 0;
...
appendString((*s).S, ((NimStringDesc*) &TMP1613));
	...
	nimln(125, "llstream.nim");
	nimln(125, "llstream.nim");
	TMP1614 = subInt((*s).S->Sup.len, (*s).Rd);
	result = ((buflen <= (NI32)(TMP1614)) ? buflen : (NI32)(TMP1614));
...
N_NIMCALL(NI, llstreamread_162242)(tllstream162204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		nimln(135, "llstream.nim");
		nimln(135, "llstream.nim");
		TMP1615 = subInt((*s).S->Sup.len, (*s).Rd);
		result = ((buflen <= (NI32)(TMP1615)) ? buflen : (NI32)(TMP1615));
		nimln(136, "llstream.nim");
		{
			...
			nimln(137, "llstream.nim");
			TMP1616 = addInt(0, (*s).Rd);
			if ((NU)((NI32)(TMP1616)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI32)(TMP1616)])), result);			nimln(138, "llstream.nim");
			(*s).Rd = addInt((*s).Rd, result);
		}		LA5: ;
	}	break;
	case ((NU8) 2):
	...
	case ((NU8) 3):
	{
		...
		result = llreadfromstdin_162501(s, buf, buflen);
	}	break;
	}
	popFrame();
	return result;
...
N_NIMCALL(void, llstreamwriteln_162274)(tllstream162204* s, NimStringDesc* data) {
	...
	llstreamwrite_162258(s, data);	nimln(180, "llstream.nim");
	llstreamwrite_162258(s, ((NimStringDesc*) &TMP1613));	popFrame();
}
N_NIMCALL(void, llstreamwrite_162263)(tllstream162204* s, NIM_CHAR data) {
	NIM_CHAR c;
	nimfr("LLStreamWrite", "llstream.nim")
...
N_NIMCALL(void, llstreamwrite_162268)(tllstream162204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			nimln(200, "llstream.nim");
			nimln(200, "llstream.nim");
			TMP1617 = addInt((*s).S->Sup.len, buflen);
			(*s).S = setLengthStr((*s).S, (NI32)(TMP1617));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1618 = addInt(0, (*s).Wr);
			if ((NU)((NI32)(TMP1618)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI32)(TMP1618)])), buf, buflen);			nimln(202, "llstream.nim");
...
N_NIMCALL(NimStringDesc*, llstreamreadall_162254)(tllstream162204* s) {
	...
	case ((NU8) 3):
	{
		...
		result = copyString(((NimStringDesc*) &TMP1605));
	}	break;
	case ((NU8) 1):
	{
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			nimln(222, "llstream.nim");
			TMP1619 = addInt(i, 2048);
			result = setLengthStr(result, (NI32)(TMP1619));
			nimln(223, "llstream.nim");
			nimln(223, "llstream.nim");
			TMP1620 = addInt(i, 0);
			if ((NU)((NI32)(TMP1620)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_9514((*s).F, ((void*) (&result->data[(NI32)(TMP1620)])), 2048);
...
static TNimNode* TMP1600[6];
static TNimNode* TMP1601[4];
NI TMP1603;
static char* NIM_CONST TMP1602[4] = {
"llsNone", 
"llsString", 
"llsFile", 
"llsStdIn"};
static TNimNode TMP1598[12];
NTI162204.size = sizeof(tllstream162204);
NTI162204.kind = 17;
NTI162204.base = (&NTI1009);
NTI162204.flags = 2;
TMP1600[0] = &TMP1598[1];
NTI162202.size = sizeof(NU8);
NTI162202.kind = 14;
NTI162202.base = 0;
NTI162202.flags = 3;
for (TMP1603 = 0; TMP1603 < 4; TMP1603++) {
TMP1598[TMP1603+2].kind = 1;
TMP1598[TMP1603+2].offset = TMP1603;
TMP1598[TMP1603+2].name = TMP1602[TMP1603];
TMP1601[TMP1603] = &TMP1598[TMP1603+2];
}
TMP1598[6].len = 4; TMP1598[6].kind = 2; TMP1598[6].sons = &TMP1601[0];
NTI162202.node = &TMP1598[6];
TMP1598[1].kind = 1;
TMP1598[1].offset = offsetof(tllstream162204, Kind);
TMP1598[1].typ = (&NTI162202);
TMP1598[1].name = "kind";
TMP1600[1] = &TMP1598[7];
TMP1598[7].kind = 1;
TMP1598[7].offset = offsetof(tllstream162204, F);
TMP1598[7].typ = (&NTI9004);
TMP1598[7].name = "f";
TMP1600[2] = &TMP1598[8];
TMP1598[8].kind = 1;
TMP1598[8].offset = offsetof(tllstream162204, S);
TMP1598[8].typ = (&NTI142);
TMP1598[8].name = "s";
TMP1600[3] = &TMP1598[9];
TMP1598[9].kind = 1;
TMP1598[9].offset = offsetof(tllstream162204, Rd);
TMP1598[9].typ = (&NTI105);
TMP1598[9].name = "rd";
TMP1600[4] = &TMP1598[10];
TMP1598[10].kind = 1;
TMP1598[10].offset = offsetof(tllstream162204, Wr);
TMP1598[10].typ = (&NTI105);
TMP1598[10].name = "wr";
TMP1600[5] = &TMP1598[11];
TMP1598[11].kind = 1;
TMP1598[11].offset = offsetof(tllstream162204, Lineoffset);
TMP1598[11].typ = (&NTI105);
TMP1598[11].name = "lineOffset";
TMP1598[0].len = 6; TMP1598[0].kind = 2; TMP1598[0].sons = &TMP1600[0];
NTI162204.node = &TMP1598[0];
NTI162206.size = sizeof(tllstream162204*);
NTI162206.kind = 22;
NTI162206.base = (&NTI162204);
NTI162206.flags = 2;
NTI162206.marker = TMP1604;
}
