...
N_NIMCALL(pid_t, startprocessauxfork_142001)(tstartprocessdata141951* data) {
	...
	TMP2838.status = _setjmp(TMP2838.context);
	if (TMP2838.status == 0) {
		pid_t volatile pid;
		tstartprocessdata141951 volatile datacopy;
		int LOC12;
		int volatile error;
	...
	if (TMP2835.status == 0) {
		...
		if (TMP2837.status == 0) {
			...
			pid = startprocessauxfork_142001(&data);
			{
				...
				LOC43 = 0;
				LOC43 = nsuJoinSep(args, argsLen0, ((NimStringDesc*) &TMP2839));
				printf("%s%s%s\012", (command)->data, (((NimStringDesc*) &TMP2839))->data, (LOC43)->data);
			}
			LA41: ;
			(*result).Id = pid;
			{
...
N_NIMCALL(processobj140402*, startcmd_140644)(NimStringDesc* command, NU8 options) {
	...
	result = nospstartProcess(command, ((NimStringDesc*) &TMP2840), LOC1, 0, NIM_NIL, (options | 4));
	return result;
}
		...
		m = ((n <= cmdsLen0) ? n : cmdsLen0);
		{
			...
			res_141516 = 0;
			{
				while (1) {
					...
					i_141241 = res_141516;
					{
						if (!!((beforerunevent.ClPrc == TMP4181.ClPrc && beforerunevent.ClEnv == TMP4181.ClEnv))) goto LA10;
						beforerunevent.ClEnv? beforerunevent.ClPrc(i_141241, beforerunevent.ClEnv):((TMP4182)(beforerunevent.ClPrc))(i_141241);
					}
					LA10: ;
					...
					res_141523 = 0;
					{
						while (1) {
							...
							r_141413 = res_141523;
							{
								...
								LA25: ;
								{
									if (!!((beforerunevent.ClPrc == TMP4181.ClPrc && beforerunevent.ClEnv == TMP4181.ClEnv))) goto LA29;
									beforerunevent.ClEnv? beforerunevent.ClPrc(i, beforerunevent.ClEnv):((TMP4183)(beforerunevent.ClPrc))(i);
								}
								LA29: ;
	...
	{
		{
			...
			res_141535 = 0;
			{
				while (1) {
					...
					i_141497 = res_141535;
					{
						if (!!((beforerunevent.ClPrc == TMP4181.ClPrc && beforerunevent.ClEnv == TMP4181.ClEnv))) goto LA49;
						beforerunevent.ClEnv? beforerunevent.ClPrc(i_141497, beforerunevent.ClEnv):((TMP4184)(beforerunevent.ClPrc))(i_141497);
					}
					LA49: ;
