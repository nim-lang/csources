...
N_NIMCALL(void, createstream_145443)(Streamobj137027** stream, int* handle, NU8 filemode);
...
static NIM_CONST TY177407 TMP1768 = {
...
STRING_LITERAL(TMP2896, " ", 1);
static NIM_CONST TY170656 TMP4340 = {NIM_NIL,NIM_NIL};
...
{	result = 0;
	...
	LA3: ;
	safe = allcharsinset_97459(s, TMP1768);
	{
		if (!safe) goto LA7;
		result = copyString(s);
		goto BeforeRet;
...
{	result = 0;
	...
	TMP2895.status = _setjmp(TMP2895.context);
	if (TMP2895.status == 0) {
		pid_t volatile pid;
	...
	if (TMP2892.status == 0) {
		...
		if (TMP2894.status == 0) {
			...
			pid = startprocessauxfork_144001((&data));
			{
				...
				LOC43 = 0;
				LOC43 = nsuJoinSep(args, argsLen0, ((NimStringDesc*) &TMP2896));
				printf("%s%s%s\012", command? (command)->data:"nil", ((NimStringDesc*) &TMP2896)? (((NimStringDesc*) &TMP2896))->data:"nil", LOC43? (LOC43)->data:"nil");
			}
			LA41: ;
			(*result).id = pid;
			{
...
{	result = 0;
	{
		...
		createstream_145443(&(*p).instream, (&(*p).inhandle), ((NU8) 1));
	}
	LA3: ;
	result = (*p).instream;
	goto BeforeRet;
...
{	result = 0;
	{
		...
		createstream_145443(&(*p).outstream, (&(*p).outhandle), ((NU8) 0));
	}
	LA3: ;
	result = (*p).outstream;
	goto BeforeRet;
			...
			res_143539 = ((NI) 0);
			{
				while (1) {
					...
					i_143235 = res_143539;
					{
						...
						beforerunevent.ClEnv? beforerunevent.ClPrc(i_143235, beforerunevent.ClEnv):((TMP4341)(beforerunevent.ClPrc))(i_143235);
					}
					LA10: ;
					memset((void*)LOC12, 0, sizeof(LOC12));
					asgnRef((void**) (&q->data[i_143235]), nospstartProcess(cmds[i_143235], ((NimStringDesc*) &TMP4342), LOC12, 0, NIM_NIL, (options | 4)));
					res_143539 += ((NI) 1);
				} LA7: ;
			}
		}
						...
						while (1) {
							...
							r_143413 = res_143548;
							{
								...
								LA26: ;
								{
									...
									beforerunevent.ClEnv? beforerunevent.ClPrc(i, beforerunevent.ClEnv):((TMP4343)(beforerunevent.ClPrc))(i);
								}
								LA30: ;
								memset((void*)LOC32, 0, sizeof(LOC32));
								asgnRef((void**) (&q->data[r_143413]), nospstartProcess(cmds[i], ((NimStringDesc*) &TMP4342), LOC32, 0, NIM_NIL, (options | 4)));
								i += ((NI) 1);
								{
			...
			res_143564 = ((NI) 0);
			{
				while (1) {
					...
					i_143502 = res_143564;
					{
						...
						beforerunevent.ClEnv? beforerunevent.ClPrc(i_143502, beforerunevent.ClEnv):((TMP4344)(beforerunevent.ClPrc))(i_143502);
					}
					LA51: ;
					memset((void*)LOC53, 0, sizeof(LOC53));
					p = nospstartProcess(cmds[i_143502], ((NimStringDesc*) &TMP4342), LOC53, 0, NIM_NIL, (options | 4));
					LOC54 = 0;
