...
N_NIMCALL(NCSTRING*, envtocstringarray_142855)(void) {
		...
		getenvvarsc_121002();
		{
			...
			res_142899 = 0;
			{
				while (1) {
					...
					key_142859 = copyStrLast(environment_120809->data[i_142895], 0, (NI32)(p_142901 - 1));
					val_142860 = copyStr(environment_120809->data[i_142895], (NI32)(p_142901 + 1));
					counter += 1;
					res_142899 += 1;
				} LA4: ;
			}
	...
	LOC5 = 0;
	LOC5 = alloc0_6017((NI32)((NI32)(counter + 1) * 4));
		...
		getenvvarsc_121002();
		{
			...
			res_142918 = 0;
			{
				while (1) {
					...
					key_142875 = copyStrLast(environment_120809->data[i_142914], 0, (NI32)(p_142920 - 1));
					val_142876 = copyStr(environment_120809->data[i_142914], (NI32)(p_142920 + 1));
					LOC10 = 0;
...
appendString(LOC10, val_142876);
					x = LOC10;
					LOC11 = 0;
					LOC11 = alloc_6001((NI32)(x->Sup.len + 1));
...
N_NIMCALL(NCSTRING*, envtocstringarray_142806)(stringtableobj132012* t) {
	...
	LOC1 = nstlen(t);
	LOC2 = 0;
	LOC2 = alloc0_6017((NI32)((NI32)(LOC1 + 1) * 4));
...
appendString(LOC11, val_142813);
						x = LOC11;
						LOC12 = 0;
						LOC12 = alloc_6001((NI32)(x->Sup.len + 1));
