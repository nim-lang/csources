...
N_NIMCALL(NI, rawparseint_80973)(NimStringDesc* s, NI64* b, NI start) {
	...
	nimln(200, "parseutils.nim");
	{
		...
		while (1) {
			...
			TMP1113 = subInt64((NI64)(TMP1111), ((NI64) ((NI32)(TMP1112))));
			(*b) = (NI64)(TMP1113);
...
N_NIMCALL(NI, npuParseBiggestFloat)(NimStringDesc* s, NF* number, NI start) {
	...
	nimln(261, "parseutils.nim");
	{
		...
		nimln(262, "parseutils.nim");
		{
			...
			LOC16 = ((NU8)(s->data[(NI32)(TMP1813)]) == (NU8)(65));
			if (LOC16) goto LA17;
			nimln(262, "parseutils.nim");
			nimln(262, "parseutils.nim");
			TMP1814 = addInt(i, 1);
			if ((NU)((NI32)(TMP1814)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC16 = ((NU8)(s->data[(NI32)(TMP1814)]) == (NU8)(97));
			LA17: ;
			if (!LOC16) goto LA18;
			nimln(263, "parseutils.nim");
			{
				...
				LOC22 = ((NU8)(s->data[(NI32)(TMP1815)]) == (NU8)(78));
				if (LOC22) goto LA23;
				nimln(263, "parseutils.nim");
				nimln(263, "parseutils.nim");
				TMP1816 = addInt(i, 2);
				if ((NU)((NI32)(TMP1816)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC22 = ((NU8)(s->data[(NI32)(TMP1816)]) == (NU8)(110));
				LA23: ;
				if (!LOC22) goto LA24;
				nimln(264, "parseutils.nim");
				{
					...
					if (!!((((NU8)(s->data[(NI32)(TMP1817)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI32)(TMP1817)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI32)(TMP1817)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI32)(TMP1817)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI32)(TMP1817)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI32)(TMP1817)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI32)(TMP1817)])) == ((NU8)(95))))) goto LA28;
	...
	nimln(268, "parseutils.nim");
	{
		...
		nimln(269, "parseutils.nim");
		{
			...
			LOC38 = ((NU8)(s->data[(NI32)(TMP1820)]) == (NU8)(78));
			if (LOC38) goto LA39;
			nimln(269, "parseutils.nim");
			nimln(269, "parseutils.nim");
			TMP1821 = addInt(i, 1);
			if ((NU)((NI32)(TMP1821)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC38 = ((NU8)(s->data[(NI32)(TMP1821)]) == (NU8)(110));
			LA39: ;
			if (!LOC38) goto LA40;
			nimln(270, "parseutils.nim");
			{
				...
				nimln(270, "parseutils.nim");
				TMP1822 = addInt(i, 2);
				if ((NU)((NI32)(TMP1822)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC44 = ((NU8)(s->data[(NI32)(TMP1822)]) == (NU8)(70));
				if (LOC44) goto LA45;
				nimln(270, "parseutils.nim");
				nimln(270, "parseutils.nim");
				TMP1823 = addInt(i, 2);
				if ((NU)((NI32)(TMP1823)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC44 = ((NU8)(s->data[(NI32)(TMP1823)]) == (NU8)(102));
				LA45: ;
				if (!LOC44) goto LA46;
				nimln(271, "parseutils.nim");
				{
					...
					if (!!((((NU8)(s->data[(NI32)(TMP1824)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI32)(TMP1824)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI32)(TMP1824)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI32)(TMP1824)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI32)(TMP1824)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI32)(TMP1824)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI32)(TMP1824)])) == ((NU8)(95))))) goto LA50;
					...
					nimln(273, "parseutils.nim");
					TMP1825 = addInt(i, 3);
					TMP1826 = subInt((NI32)(TMP1825), start);
					result = (NI32)(TMP1826);
					goto BeforeRet;
				}				LA50: ;
			}			LA46: ;
	...
	while (1) {
		...
		(*number) = ((NF)(((NF)((*number)) * (NF)(1.0000000000000000e+01))) + (NF)(((double) (((NI) ((NI32)(TMP1827)))))));
	...
	nimln(282, "parseutils.nim");
	{
		...
		while (1) {
			...
			(*number) = ((NF)(((NF)((*number)) * (NF)(1.0000000000000000e+01))) + (NF)(((double) (((NI) ((NI32)(TMP1828)))))));
	...
	nimln(296, "parseutils.nim");
	{
		...
		while (1) {
			...
			nimln(306, "parseutils.nim");
			if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
			TMP1830 = addInt((NI32)(TMP1829), ((NI) (((NU8)(s->data[i])))));
			TMP1831 = subInt((NI32)(TMP1830), 48);
			exponent = (NI32)(TMP1831);
