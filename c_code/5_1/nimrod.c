...
STRING_LITERAL(TMP4786, "js", 2);
STRING_LITERAL(TMP4787, "node ", 5);
...
appendString(LOC7, ((NimStringDesc*) &TMP4785));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
			...
			if (!(gerrorcounter_195306 == 0)) goto LA25;
			{
				if (!((gglobaloptions_165118 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				{
					...
					LA37: ;
					{
						...
						NimStringDesc* LOC43;
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_165237, ((NimStringDesc*) &TMP4786));
						LOC42 = 0;
...
appendString(LOC44, ((NimStringDesc*) &TMP4787));
