...
static N_INLINE(trope121007**, s_368161)(tcproc368025* p, NU8 s) {
	...
	if ((NU)((NI32)(TMP5615)) >= (NU)((*p).Blocks->Sup.len)) raiseIndexError();
	result = &(*p).Blocks->data[(NI32)(TMP5615)].Sections[(s)- 0];
	popFrame();
	return result;
}
static N_INLINE(trope121007**, procsec_368178)(tcproc368025* p, NU8 s) {
...
TMP5607[0] = &TMP5605[1];
TMP5605[1].kind = 1;
TMP5605[1].offset = offsetof(tcgen368029, Module);
TMP5605[1].typ = (&NTI172657);
TMP5605[1].name = "module";
TMP5607[1] = &TMP5605[2];
TMP5605[2].kind = 1;
TMP5605[2].offset = offsetof(tcgen368029, Filename);
...
NTI368013.flags = 2;
TMP5605[3].kind = 1;
TMP5605[3].offset = offsetof(tcgen368029, S);
TMP5605[3].typ = (&NTI368013);
TMP5605[3].name = "s";
TMP5607[3] = &TMP5605[4];
TMP5605[4].kind = 1;
TMP5605[4].offset = offsetof(tcgen368029, Preventstacktrace);
TMP5605[4].typ = (&NTI133);
TMP5605[4].name = "PreventStackTrace";
TMP5607[4] = &TMP5605[5];
TMP5605[5].kind = 1;
TMP5605[5].offset = offsetof(tcgen368029, Usesthreadvars);
TMP5605[5].typ = (&NTI133);
TMP5605[5].name = "usesThreadVars";
TMP5607[5] = &TMP5605[6];
TMP5605[6].kind = 1;
TMP5605[6].offset = offsetof(tcgen368029, Framedeclared);
TMP5605[6].typ = (&NTI133);
TMP5605[6].name = "FrameDeclared";
TMP5607[6] = &TMP5605[7];
TMP5605[7].kind = 1;
TMP5605[7].offset = offsetof(tcgen368029, Isheaderfile);
TMP5605[7].typ = (&NTI133);
TMP5605[7].name = "isHeaderFile";
TMP5607[7] = &TMP5605[8];
TMP5605[8].kind = 1;
TMP5605[8].offset = offsetof(tcgen368029, Includesstringh);
TMP5605[8].typ = (&NTI133);
TMP5605[8].name = "includesStringh";
TMP5607[8] = &TMP5605[9];
TMP5605[9].kind = 1;
TMP5605[9].offset = offsetof(tcgen368029, Cfilename);
TMP5605[9].typ = (&NTI142);
TMP5605[9].name = "cfilename";
TMP5607[9] = &TMP5605[10];
TMP5605[10].kind = 1;
TMP5605[10].offset = offsetof(tcgen368029, Typecache);
TMP5605[10].typ = (&NTI172705);
TMP5605[10].name = "typeCache";
TMP5607[10] = &TMP5605[11];
TMP5605[11].kind = 1;
TMP5605[11].offset = offsetof(tcgen368029, Forwtypecache);
TMP5605[11].typ = (&NTI172705);
TMP5605[11].name = "forwTypeCache";
TMP5607[11] = &TMP5605[12];
TMP5605[12].kind = 1;
TMP5605[12].offset = offsetof(tcgen368029, Declaredthings);
TMP5605[12].typ = (&NTI169043);
TMP5605[12].name = "declaredThings";
TMP5607[12] = &TMP5605[13];
TMP5605[13].kind = 1;
TMP5605[13].offset = offsetof(tcgen368029, Declaredprotos);
TMP5605[13].typ = (&NTI169043);
TMP5605[13].name = "declaredProtos";
TMP5607[13] = &TMP5605[14];
TMP5605[14].kind = 1;
TMP5605[14].offset = offsetof(tcgen368029, Headerfiles);
TMP5605[14].typ = (&NTI109020);
TMP5605[14].name = "headerFiles";
TMP5607[14] = &TMP5605[15];
TMP5605[15].kind = 1;
TMP5605[15].offset = offsetof(tcgen368029, Typeinfomarker);
TMP5605[15].typ = (&NTI169043);
...
TMP5605[18].kind = 1;
TMP5605[18].offset = offsetof(tcproc368025, Prc);
TMP5605[18].typ = (&NTI172657);
TMP5605[18].name = "prc";
TMP5608[1] = &TMP5605[19];
TMP5605[19].kind = 1;
TMP5605[19].offset = offsetof(tcproc368025, Beforeretneeded);
TMP5605[19].typ = (&NTI133);
TMP5605[19].name = "BeforeRetNeeded";
TMP5608[2] = &TMP5605[20];
TMP5605[20].kind = 1;
TMP5605[20].offset = offsetof(tcproc368025, Threadvaraccessed);
TMP5605[20].typ = (&NTI133);
TMP5605[20].name = "ThreadVarAccessed";
TMP5608[3] = &TMP5605[21];
TMP5605[21].kind = 1;
TMP5605[21].offset = offsetof(tcproc368025, Nestedtrystmts);
TMP5605[21].typ = (&NTI172653);
TMP5605[21].name = "nestedTryStmts";
TMP5608[4] = &TMP5605[22];
TMP5605[22].kind = 1;
TMP5605[22].offset = offsetof(tcproc368025, Inexceptblock);
TMP5605[22].typ = (&NTI105);
TMP5605[22].name = "inExceptBlock";
TMP5608[5] = &TMP5605[23];
TMP5605[23].kind = 1;
TMP5605[23].offset = offsetof(tcproc368025, Labels);
TMP5605[23].typ = (&NTI67896);
...
TMP5605[26].kind = 1;
TMP5605[26].offset = offsetof(tblock368023, Id);
TMP5605[26].typ = (&NTI105);
TMP5605[26].name = "id";
TMP5609[1] = &TMP5605[27];
TMP5605[27].kind = 1;
TMP5605[27].offset = offsetof(tblock368023, Label);
...
NTI368017.flags = 2;
TMP5605[28].kind = 1;
TMP5605[28].offset = offsetof(tblock368023, Sections);
TMP5605[28].typ = (&NTI368017);
TMP5605[28].name = "sections";
TMP5609[3] = &TMP5605[29];
TMP5605[29].kind = 1;
TMP5605[29].offset = offsetof(tblock368023, Isloop);
TMP5605[29].typ = (&NTI133);
TMP5605[29].name = "isLoop";
TMP5609[4] = &TMP5605[30];
TMP5605[30].kind = 1;
TMP5605[30].offset = offsetof(tblock368023, Nestedtrystmts);
TMP5605[30].typ = (&NTI109);
TMP5605[30].name = "nestedTryStmts";
TMP5609[5] = &TMP5605[31];
TMP5605[31].kind = 1;
TMP5605[31].offset = offsetof(tblock368023, Framelen);
TMP5605[31].typ = (&NTI109);
TMP5605[31].name = "frameLen";
TMP5605[25].len = 6; TMP5605[25].kind = 2; TMP5605[25].sons = &TMP5609[0];
NTI368023.node = &TMP5605[25];
NTI368090.size = sizeof(TY368090*);
NTI368090.kind = 24;
NTI368090.base = (&NTI368023);
NTI368090.flags = 2;
NTI368090.marker = TMP5610;
TMP5605[24].kind = 1;
TMP5605[24].offset = offsetof(tcproc368025, Blocks);
TMP5605[24].typ = (&NTI368090);
TMP5605[24].name = "blocks";
TMP5608[7] = &TMP5605[32];
TMP5605[32].kind = 1;
TMP5605[32].offset = offsetof(tcproc368025, Breakidx);
TMP5605[32].typ = (&NTI105);
TMP5605[32].name = "breakIdx";
TMP5608[8] = &TMP5605[33];
TMP5605[33].kind = 1;
TMP5605[33].offset = offsetof(tcproc368025, Options);
TMP5605[33].typ = (&NTI114104);
TMP5605[33].name = "options";
TMP5608[9] = &TMP5605[34];
TMP5605[34].kind = 1;
TMP5605[34].offset = offsetof(tcproc368025, Maxframelen);
TMP5605[34].typ = (&NTI105);
TMP5605[34].name = "maxFrameLen";
TMP5608[10] = &TMP5605[35];
TMP5605[35].kind = 1;
TMP5605[35].offset = offsetof(tcproc368025, Module);
TMP5605[35].typ = (&NTI368019);
TMP5605[35].name = "module";
TMP5608[11] = &TMP5605[36];
TMP5605[36].kind = 1;
TMP5605[36].offset = offsetof(tcproc368025, Withinloop);
TMP5605[36].typ = (&NTI105);
TMP5605[36].name = "withinLoop";
TMP5608[12] = &TMP5605[37];
TMP5605[37].kind = 1;
TMP5605[37].offset = offsetof(tcproc368025, Gcframeid);
TMP5605[37].typ = (&NTI67896);
TMP5605[37].name = "gcFrameId";
TMP5608[13] = &TMP5605[38];
TMP5605[38].kind = 1;
TMP5605[38].offset = offsetof(tcproc368025, Gcframetype);
TMP5605[38].typ = (&NTI121005);
TMP5605[38].name = "gcFrameType";
TMP5605[17].len = 14; TMP5605[17].kind = 2; TMP5605[17].sons = &TMP5608[0];
NTI368025.node = &TMP5605[17];
NTI368021.size = sizeof(tcproc368025*);
NTI368021.kind = 22;
NTI368021.base = (&NTI368025);
NTI368021.marker = TMP5611;
TMP5605[16].kind = 1;
TMP5605[16].offset = offsetof(tcgen368029, Initproc);
TMP5605[16].typ = (&NTI368021);
TMP5605[16].name = "initProc";
TMP5607[16] = &TMP5605[39];
TMP5605[39].kind = 1;
TMP5605[39].offset = offsetof(tcgen368029, Postinitproc);
TMP5605[39].typ = (&NTI368021);
TMP5605[39].name = "postInitProc";
TMP5607[17] = &TMP5605[40];
TMP5605[40].kind = 1;
TMP5605[40].offset = offsetof(tcgen368029, Preinitproc);
TMP5605[40].typ = (&NTI368021);
TMP5605[40].name = "preInitProc";
TMP5607[18] = &TMP5605[41];
TMP5605[41].kind = 1;
TMP5605[41].offset = offsetof(tcgen368029, Typestack);
TMP5605[41].typ = (&NTI172691);
TMP5605[41].name = "typeStack";
TMP5607[19] = &TMP5605[42];
TMP5605[42].kind = 1;
TMP5605[42].offset = offsetof(tcgen368029, Datacache);
TMP5605[42].typ = (&NTI172717);
TMP5605[42].name = "dataCache";
TMP5607[20] = &TMP5605[43];
TMP5605[43].kind = 1;
TMP5605[43].offset = offsetof(tcgen368029, Forwardedprocs);
TMP5605[43].typ = (&NTI172661);
TMP5605[43].name = "forwardedProcs";
TMP5607[21] = &TMP5605[44];
TMP5605[44].kind = 1;
TMP5605[44].offset = offsetof(tcgen368029, Typenodes);
TMP5605[44].typ = (&NTI105);
TMP5605[44].name = "typeNodes";
TMP5607[22] = &TMP5605[45];
TMP5605[45].kind = 1;
TMP5605[45].offset = offsetof(tcgen368029, Nimtypes);
TMP5605[45].typ = (&NTI105);
TMP5605[45].name = "nimTypes";
TMP5607[23] = &TMP5605[46];
TMP5605[46].kind = 1;
TMP5605[46].offset = offsetof(tcgen368029, Typenodesname);
TMP5605[46].typ = (&NTI121005);
TMP5605[46].name = "typeNodesName";
TMP5607[24] = &TMP5605[47];
TMP5605[47].kind = 1;
TMP5605[47].offset = offsetof(tcgen368029, Nimtypesname);
TMP5605[47].typ = (&NTI121005);
TMP5605[47].name = "nimTypesName";
TMP5607[25] = &TMP5605[48];
TMP5605[48].kind = 1;
TMP5605[48].offset = offsetof(tcgen368029, Labels);
TMP5605[48].typ = (&NTI67896);
