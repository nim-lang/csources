...
N_NIMCALL(NIM_BOOL, isdefined_166016)(NimStringDesc* symbol);
...
STRING_LITERAL(TMP979, "true", 4);
STRING_LITERAL(TMP980, "false", 5);
STRING_LITERAL(TMP981, "nimrod", 6);
STRING_LITERAL(TMP982, "nimhygiene", 10);
STRING_LITERAL(TMP983, "niminheritable", 14);
STRING_LITERAL(TMP984, "nimmixin", 8);
STRING_LITERAL(TMP985, "nimeffects", 10);
STRING_LITERAL(TMP986, "nimbabel", 8);
STRING_LITERAL(TMP987, "nimcomputedgoto", 15);
STRING_LITERAL(TMP988, "nimunion", 8);
STRING_LITERAL(TMP989, "nimnewshared", 12);
STRING_LITERAL(TMP990, "nimrequiresnimframe", 19);
STRING_LITERAL(TMP991, "x86", 3);
STRING_LITERAL(TMP992, "itanium", 7);
STRING_LITERAL(TMP993, "x8664", 5);
STRING_LITERAL(TMP994, "msdos", 5);
STRING_LITERAL(TMP995, "mswindows", 9);
STRING_LITERAL(TMP996, "win32", 5);
STRING_LITERAL(TMP997, "unix", 4);
STRING_LITERAL(TMP998, "posix", 5);
STRING_LITERAL(TMP999, "sunos", 5);
STRING_LITERAL(TMP1000, "bsd", 3);
STRING_LITERAL(TMP1001, "macintosh", 9);
STRING_LITERAL(TMP1002, "cpu", 3);
extern NIM_CONST TY140469 cpu_140468;
extern NIM_CONST TY140463 endiantostr_140462;
extern NIM_CONST TY140064 os_140063;
STRING_LITERAL(TMP1005, "emulatedthreadvars", 18);
tstringtable120810* gsymbols_166003;
...
N_NIMCALL(void, definesymbol_166006)(NimStringDesc* symbol) {
	...
	nstPut(gsymbols_166003, symbol, ((NimStringDesc*) &TMP979));
	popFrame();
}
...
N_NIMCALL(void, undefsymbol_166011)(NimStringDesc* symbol) {
	...
	nstPut(gsymbols_166003, symbol, ((NimStringDesc*) &TMP980));
	popFrame();
}
...
N_NIMCALL(NIM_BOOL, isdefined_166016)(NimStringDesc* symbol) {
	...
	nimln(26, "condsyms.nim");
	{
		...
		nimln(26, "condsyms.nim");
		LOC3 = 0;
		LOC3 = nsthasKey(gsymbols_166003, symbol);
		if (!LOC3) goto LA4;
		nimln(27, "condsyms.nim");
		nimln(27, "condsyms.nim");
		nimln(27, "condsyms.nim");
		LOC6 = 0;
		LOC6 = nstGet(gsymbols_166003, symbol);
		result = eqStrings(LOC6, ((NimStringDesc*) &TMP979));
	}
	LA4: ;
	popFrame();
	return result;
...
N_NIMCALL(NIM_BOOL, isdefined_166022)(tident165019* symbol) {
	...
	result = isdefined_166016((*symbol).S);
	popFrame();
	return result;
}
...
N_NIMCALL(NI, countdefinedsymbols_166042)(void) {
	NI result;
	NimStringDesc* key_166045;
	NimStringDesc* val_166046;
	NI h_166064;
	NI HEX3Atmp_166066;
	NI res_166068;
	...
	nimln(40, "strtabs.nim");
	HEX3Atmp_166066 = ((*gsymbols_166003).Data->Sup.len-1);
	nimln(1457, "system.nim");
	res_166068 = 0;
	nimln(1458, "system.nim");
	while (1) {
		nimln(1458, "system.nim");
		if (!(res_166068 <= HEX3Atmp_166066)) goto LA1;
		nimln(1457, "system.nim");
		h_166064 = res_166068;
		nimln(41, "strtabs.nim");
		{
			nimln(41, "strtabs.nim");
			nimln(41, "strtabs.nim");
			if ((NU)(h_166064) >= (NU)((*gsymbols_166003).Data->Sup.len)) raiseIndexError();
			if (!!((*gsymbols_166003).Data->data[h_166064].Field0 == 0)) goto LA4;
			nimln(42, "strtabs.nim");
			if ((NU)(h_166064) >= (NU)((*gsymbols_166003).Data->Sup.len)) raiseIndexError();
			key_166045 = (*gsymbols_166003).Data->data[h_166064].Field0;
			nimln(42, "strtabs.nim");
			if ((NU)(h_166064) >= (NU)((*gsymbols_166003).Data->Sup.len)) raiseIndexError();
			val_166046 = (*gsymbols_166003).Data->data[h_166064].Field1;
			nimln(38, "condsyms.nim");
			{
				nimln(38, "condsyms.nim");
				if (!eqStrings(val_166046, ((NimStringDesc*) &TMP979))) goto LA8;
				nimln(38, "condsyms.nim");
		...
		res_166068 = addInt(res_166068, 1);
	} LA1: ;
	popFrame();
	return result;
}
...
N_NIMCALL(void, initdefines_166072)(void) {
	...
	asgnRef((void**) &gsymbols_166003, nstnewStringTable(((NU8) 2)));
	nimln(42, "condsyms.nim");
	definesymbol_166006(((NimStringDesc*) &TMP981));
	nimln(44, "condsyms.nim");
	definesymbol_166006(((NimStringDesc*) &TMP982));
	nimln(45, "condsyms.nim");
	definesymbol_166006(((NimStringDesc*) &TMP983));
	nimln(46, "condsyms.nim");
	definesymbol_166006(((NimStringDesc*) &TMP984));
	nimln(47, "condsyms.nim");
	definesymbol_166006(((NimStringDesc*) &TMP985));
	nimln(48, "condsyms.nim");
	definesymbol_166006(((NimStringDesc*) &TMP986));
	nimln(49, "condsyms.nim");
	definesymbol_166006(((NimStringDesc*) &TMP987));
	nimln(50, "condsyms.nim");
	definesymbol_166006(((NimStringDesc*) &TMP988));
	nimln(51, "condsyms.nim");
	definesymbol_166006(((NimStringDesc*) &TMP989));
	nimln(52, "condsyms.nim");
	definesymbol_166006(((NimStringDesc*) &TMP990));
	nimln(55, "condsyms.nim");
	switch (targetcpu_140573) {
	case ((NU8) 1):
	{
		nimln(56, "condsyms.nim");
		definesymbol_166006(((NimStringDesc*) &TMP991));
	}
	break;
	case ((NU8) 8):
	{
		nimln(57, "condsyms.nim");
		definesymbol_166006(((NimStringDesc*) &TMP992));
	}
	break;
	case ((NU8) 9):
	{
		nimln(58, "condsyms.nim");
		definesymbol_166006(((NimStringDesc*) &TMP993));
	}
	break;
	default:
	{
	...
	switch (targetos_140575) {
	case ((NU8) 1):
	{
		nimln(62, "condsyms.nim");
		definesymbol_166006(((NimStringDesc*) &TMP994));
	}
	break;
	case ((NU8) 2):
	{
		nimln(64, "condsyms.nim");
		definesymbol_166006(((NimStringDesc*) &TMP995));
		nimln(65, "condsyms.nim");
		definesymbol_166006(((NimStringDesc*) &TMP996));
	}
	break;
	case ((NU8) 4):
	case ((NU8) 5):
	...
	case ((NU8) 20):
	{
		...
		definesymbol_166006(((NimStringDesc*) &TMP997));
		nimln(70, "condsyms.nim");
		definesymbol_166006(((NimStringDesc*) &TMP998));
	}
	break;
	case ((NU8) 7):
	{
		nimln(72, "condsyms.nim");
		definesymbol_166006(((NimStringDesc*) &TMP999));
	...
	case ((NU8) 11):
	{
		...
		definesymbol_166006(((NimStringDesc*) &TMP1000));
	...
	case ((NU8) 18):
	{
		...
		definesymbol_166006(((NimStringDesc*) &TMP1001));
	}
	break;
	case ((NU8) 19):
	{
	...
	LOC14 = 0;
	LOC14 = nimIntToStr(cpu_140468[(targetcpu_140573)- 1].Field4);
	LOC13 = rawNewString(LOC14->Sup.len + 3);
appendString(LOC13, ((NimStringDesc*) &TMP1002));
appendString(LOC13, LOC14);
	definesymbol_166006(LOC13);
	nimln(87, "condsyms.nim");
	nimln(87, "condsyms.nim");
	if (targetcpu_140573 < 1 || targetcpu_140573 > 14) raiseIndexError();
	LOC15 = 0;
	LOC15 = nsuNormalize(endiantostr_140462[(cpu_140468[(targetcpu_140573)- 1].Field2)- 0]);
	definesymbol_166006(LOC15);
	nimln(88, "condsyms.nim");
	if (targetcpu_140573 < 1 || targetcpu_140573 > 14) raiseIndexError();
	definesymbol_166006(cpu_140468[(targetcpu_140573)- 1].Field0);
	nimln(89, "condsyms.nim");
	if (targetos_140575 < 1 || targetos_140575 > 23) raiseIndexError();
	definesymbol_166006(os_140063[(targetos_140575)- 1].Field0);
	nimln(90, "condsyms.nim");
	{
		nimln(90, "condsyms.nim");
		if (targetos_140575 < 1 || targetos_140575 > 23) raiseIndexError();
		if (!((os_140063[(targetos_140575)- 1].Field12 &(1<<((((NU8) 3))&7)))!=0)) goto LA18;
		nimln(91, "condsyms.nim");
		definesymbol_166006(((NimStringDesc*) &TMP1005));
	}
	LA18: ;
	popFrame();
}
