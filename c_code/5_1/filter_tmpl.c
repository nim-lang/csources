...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP2670, "\012", 1);
STRING_LITERAL(TMP2671, "", 0);
STRING_LITERAL(TMP2672, "end", 3);
STRING_LITERAL(TMP2673, "#end", 4);
static NIM_CONST TY123387 TMP2675 = {
...
STRING_LITERAL(TMP2679, "\\x", 2);
STRING_LITERAL(TMP2680, "\\\\", 2);
STRING_LITERAL(TMP2681, "\\\'", 2);
STRING_LITERAL(TMP2682, "\\\"", 2);
STRING_LITERAL(TMP2683, "}", 1);
STRING_LITERAL(TMP2684, "$", 1);
STRING_LITERAL(TMP2685, "\\n\"", 3);
STRING_LITERAL(TMP2686, "subschar", 8);
STRING_LITERAL(TMP2687, "metachar", 8);
STRING_LITERAL(TMP2688, "emit", 4);
STRING_LITERAL(TMP2689, "result.add", 10);
STRING_LITERAL(TMP2690, "conc", 4);
STRING_LITERAL(TMP2691, " & ", 3);
STRING_LITERAL(TMP2692, "tostring", 8);
...
N_NIMCALL(void, parseline_223177)(ttmplparser223017* p) {
	...
	LA6: ;
	{
		...
		keyw = copyString(((NimStringDesc*) &TMP2671));
		...
		case ((NU8) 20):
		{
			...
			LA19: ;
			{
				...
				localerror_168571((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP2672));
			}
			LA17: ;
		...
		case ((NU8) 24):
		{
			...
			nimln(99, "filter_tmpl.nim");
			nimln(99, "filter_tmpl.nim");
			TMP2674 = subInt((*p).Indent, 2);
			LOC27 = 0;
			LOC27 = nsuRepeatChar((NI32)(TMP2674), 32);
		...
		case ((NU8) 60):
		{
			...
			nimln(104, "filter_tmpl.nim");
			{
				...
				nimln(104, "filter_tmpl.nim");
				LOC34 = 0;
				LOC34 = contains_91258((*p).X, TMP2675);
				if (!!(LOC34)) goto LA35;
	...
	LA9: ;
	{
		...
		case ((NU8) 1):
		{
			...
			nimln(123, "filter_tmpl.nim");
			nimln(123, "filter_tmpl.nim");
			TMP2676 = addInt((*p).Indent, 2);
			LOC42 = 0;
			LOC42 = nsuRepeatChar((NI32)(TMP2676), 32);
		...
		while (1) {
			...
			case 39:
			{
				...
				llstreamwrite_179258((*p).Outp, ((NimStringDesc*) &TMP2681));
			...
			case 34:
			{
				...
				llstreamwrite_179258((*p).Outp, ((NimStringDesc*) &TMP2682));
				...
				nimln(150, "filter_tmpl.nim");
				{
					...
					case 123:
					{
						...
						while (1) {
							...
							case 0:
							{
								...
								localerror_168571((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP2683));
					...
					default:
					{
						...
						LA76: ;
						{
							...
							localerror_168571((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP2684));
						}
						LA74: ;
					}
					break;
		...
		llstreamwrite_179258((*p).Outp, ((NimStringDesc*) &TMP2685));
	}
	LA2: ;
	popFrame();
}
...
N_NIMCALL(tllstream179204*, filtertmpl_223007)(tllstream179204* stdin_223009, NimStringDesc* filename, tnode191813* call) {
	...
	p.Outp = llstreamopen_179218(((NimStringDesc*) &TMP2671));
	nimln(209, "filter_tmpl.nim");
	p.Inp = stdin_223009;
	nimln(210, "filter_tmpl.nim");
	p.Subschar = chararg_222014(call, ((NimStringDesc*) &TMP2686), 1, 36);
	nimln(211, "filter_tmpl.nim");
	p.Nimdirective = chararg_222014(call, ((NimStringDesc*) &TMP2687), 2, 35);
	nimln(212, "filter_tmpl.nim");
	p.Emit = strarg_222021(call, ((NimStringDesc*) &TMP2688), 3, ((NimStringDesc*) &TMP2689));
	nimln(213, "filter_tmpl.nim");
	p.Conc = strarg_222021(call, ((NimStringDesc*) &TMP2690), 4, ((NimStringDesc*) &TMP2691));
	nimln(214, "filter_tmpl.nim");
	p.Tostr = strarg_222021(call, ((NimStringDesc*) &TMP2692), 5, ((NimStringDesc*) &TMP2684));
	...
	while (1) {
		...
		nimln(217, "filter_tmpl.nim");
		TMP2693 = addInt(p.Info.Line, ((NI16) 1));
		if (TMP2693 < -32768 || TMP2693 > 32767) raiseOverflow();
		p.Info.Line = (NI16)(TMP2693);
