...
static NIM_CONST TY172865 TMP3062 = {
...
N_NIMCALL(NIM_BOOL, inset_219013)(tnode172659* s, tnode172659* elem) {
	...
	nimln(34, "nimsets.nim");
	{
		...
		internalerror_139369((*s).Info, ((NimStringDesc*) &TMP3061));		nimln(36, "nimsets.nim");
	...
	while (1) {
		...
		nimln(38, "nimsets.nim");
		{
			...
			nimln(39, "nimsets.nim");
			{
				...
				if (((TMP3062[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3063));
				if ((NU)(i_219090) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP3062[(*(*s).kindU.S6.Sons->data[i_219090]).Kind/8] &(1<<((*(*s).kindU.S6.Sons->data[i_219090]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3063));
...
N_NIMCALL(NIM_BOOL, someinset_219018)(tnode172659* s, tnode172659* a, tnode172659* b) {
	...
	nimln(63, "nimsets.nim");
	{
		...
		internalerror_139369((*s).Info, ((NimStringDesc*) &TMP3065));		nimln(65, "nimsets.nim");
	...
	while (1) {
		...
		nimln(67, "nimsets.nim");
		{
			...
			nimln(68, "nimsets.nim");
			{
				...
				if (((TMP3062[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3063));
				if ((NU)(i_219314) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP3062[(*(*s).kindU.S6.Sons->data[i_219314]).Kind/8] &(1<<((*(*s).kindU.S6.Sons->data[i_219314]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3063));
...
N_NIMCALL(NIM_BOOL, sethasrange_219029)(tnode172659* s) {
	...
	nimln(162, "nimsets.nim");
	{
		...
		internalerror_139369((*s).Info, ((NimStringDesc*) &TMP3079));		nimln(164, "nimsets.nim");
