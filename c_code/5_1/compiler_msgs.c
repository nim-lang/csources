...
N_NIMCALL(void, suggestwriteln_183120)(NimStringDesc* s) {
	{
		...
		LA7: ;
		{
			writelnhook_183117.ClEnv? writelnhook_183117.ClPrc(s, writelnhook_183117.ClEnv):((TMP2099)(writelnhook_183117.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, suggestquit_183158)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_183163).Sup.message; (*e_183163).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2824));
	if (LOC1) nimGCunrefNoCycle(LOC1);
