...
typedef N_CLOSURE_PTR(void, TMP1990) (NimStringDesc* output);
...
868}
;
STRING_LITERAL(TMP2708, "suggest done", 12);
STRING_LITERAL(TMP3056, "(", 1);
STRING_LITERAL(TMP3057, ",", 1);
STRING_LITERAL(TMP3058, ")", 1);
NIM_CONST TY85545 TMP3625 = {((NimStringDesc*) &TMP1050),
875}
;
...
N_NIMCALL(void, suggestwriteln_182190)(NimStringDesc* s) {
	{
		...
		LA7: ;
		{
			writelnhook_182172.ClEnv? writelnhook_182172.ClPrc(s, writelnhook_182172.ClEnv):((TMP1990)(writelnhook_182172.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, suggestquit_182449)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_182453).Sup.message; (*e_182453).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2708));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
static TNimNode* TMP1984[277];
NI TMP1986;
static char* NIM_CONST TMP1985[277] = {
"errUnknown", 
"errIllFormedAstX", 
"errInternal", 
"errCannotOpenFile", 
...
NTI181005.base = 0;
NTI181005.flags = 3;
for (TMP1986 = 0; TMP1986 < 277; TMP1986++) {
TMP19[TMP1986+12].kind = 1;
TMP19[TMP1986+12].offset = TMP1986;
TMP19[TMP1986+12].name = TMP1985[TMP1986];
TMP1984[TMP1986] = &TMP19[TMP1986+12];
}
TMP19[289].len = 277; TMP19[289].kind = 2; TMP19[289].sons = &TMP1984[0];
