...
STRING_LITERAL(TMP2618, "standard", 8);
STRING_LITERAL(TMP2619, "braces", 6);
STRING_LITERAL(TMP2620, "endx", 4);
NIM_CONST TY198015 parsernames_198014 = {((NimStringDesc*) &TMP2618),
((NimStringDesc*) &TMP2619),
((NimStringDesc*) &TMP2620)}
;
STRING_LITERAL(TMP2621, "none", 4);
STRING_LITERAL(TMP2622, "stdtmpl", 7);
STRING_LITERAL(TMP2623, "replace", 7);
STRING_LITERAL(TMP2624, "strip", 5);
NIM_CONST TY198020 filternames_198019 = {((NimStringDesc*) &TMP2621),
((NimStringDesc*) &TMP2622),
((NimStringDesc*) &TMP2623),
((NimStringDesc*) &TMP2624)}
;
STRING_LITERAL(TMP2629, "parser to implement", 19);
static NIM_CONST TY172865 TMP2633 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2634, "sons", 4);
static NIM_CONST TY172865 TMP2635 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2636, "ident", 5);
...
N_NIMCALL(tnode172659*, parseall_198046)(tparsers198026* p) {
	...
	case ((NU8) 2):
	{
		...
		internalerror_139383(((NimStringDesc*) &TMP2629));		nimln(63, "syntaxes.nim");
...
N_NIMCALL(tnode172659*, parsetoplevelstmt_198051)(tparsers198026* p) {
	...
	case ((NU8) 2):
	{
		...
		internalerror_139383(((NimStringDesc*) &TMP2629));		nimln(74, "syntaxes.nim");
		result = emptynode_173505;
	}	break;
	}
	popFrame();
...
N_NIMCALL(NIM_BOOL, containsshebang_198097)(NimStringDesc* s, NI i) {
	...
	nimln(84, "syntaxes.nim");
	{
		...
		nimln(84, "syntaxes.nim");
		TMP2630 = addInt(i, 1);
		if ((NU)((NI32)(TMP2630)) > (NU)(s->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(s->data[(NI32)(TMP2630)]) == (NU8)(33));
		LA4: ;
		if (!LOC3) goto LA5;
...
N_NIMCALL(tnode172659*, parsepipe_198126)(NimStringDesc* filename, tllstream162204* inputstream) {
	...
	nimln(92, "syntaxes.nim");
	{
		...
		nimln(99, "syntaxes.nim");
		{
			...
			nimln(99, "syntaxes.nim");
			TMP2632 = addInt(i, 1);
			if ((NU)((NI32)(TMP2632)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC14 = ((NU8)(line->data[(NI32)(TMP2632)]) == (NU8)(33));
			LA15: ;
			if (!LOC14) goto LA16;
...
N_NIMCALL(tident141017*, getcallee_198281)(tnode172659* n) {
	...
	LA5: ;
	{
		...
		if (!(((TMP2635[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2636));
...
N_NIMCALL(tllstream162204*, evalpipe_198391)(tparsers198026* p, tnode172659* n, NimStringDesc* filename, tllstream162204* start) {
	...
	nimln(152, "syntaxes.nim");
	{
		...
		if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP2635[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2636));
		LOC7 = identeq_141456((*(*n).kindU.S6.Sons->data[0]).kindU.S5.Ident, ((NimStringDesc*) &TMP2637));
		LA10: ;
		if (!LOC7) goto LA11;
		i_198465 = 0;
		nimln(1301, "system.nim");
...
TMP2254[TMP2628+2].kind = 1;
TMP2254[TMP2628+2].offset = TMP2628;
TMP2254[TMP2628+2].name = TMP2627[TMP2628];
TMP2626[TMP2628] = &TMP2254[TMP2628+2];
}
TMP2254[5].len = 3; TMP2254[5].kind = 2; TMP2254[5].sons = &TMP2626[0];
NTI198005.node = &TMP2254[5];
TMP2254[1].kind = 1;
TMP2254[1].offset = offsetof(tparsers198026, Skin);
TMP2254[1].typ = (&NTI198005);
TMP2254[1].name = "skin";
TMP2625[1] = &TMP2254[6];
TMP2254[6].kind = 1;
TMP2254[6].offset = offsetof(tparsers198026, Parser);
TMP2254[6].typ = (&NTI186203);
TMP2254[6].name = "parser";
TMP2254[0].len = 2; TMP2254[0].kind = 2; TMP2254[0].sons = &TMP2625[0];
NTI198026.node = &TMP2254[0];
}
