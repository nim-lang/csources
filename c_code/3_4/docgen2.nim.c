...
N_LIB_PRIVATE N_NIMCALL(tyObject_TPassContext_Hb6rFM0ecvtlLf2kv9aU75w*, myOpenJson_XkBOXGkEnDAtwimfvAgjZQ)(tyObject_ModuleGraphcolonObjectType__RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w* module) {
	...
	T1_ = (NimStringDesc*)0;
	T1_ = toFullPath_VW1RaR1l9c9bPnJxr1KuvIrg((*graph).config, ((NI32)chckRange((*module).position, ((NI32) (-2147483647 -1)), ((NI32) 2147483647))));
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*, processNodeJson_89cQsBb9a40vsSUZ26PjkTPQ)(tyObject_TPassContext_Hb6rFM0ecvtlLf2kv9aU75w* c, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	result = n;
	if (c) chckObj((*c).Sup.m_type, (&NTI_QzRwKNjgUGyiY7E27E59ayg_));
	g = ((tyObject_TGen_QzRwKNjgUGyiY7E27E59ayg*) (c));
	{
		...
		T4_ = (NIM_BOOL)0;
		T5_ = (NIM_BOOL)0;
		T5_ = ((*(*(*g).module).owner).Sup.id == (*(*(*g).doc).conf).mainPackageId);
		if (!(T5_)) goto LA6_;
		T5_ = (((*(*(*g).doc).conf).globalOptions &((NU64)1<<((NU)(((tyEnum_TGlobalOption_RAfAEZqjnKMDumgyKKc1qw) 33))&63U)))!=0);
		LA6_: ;
		T4_ = T5_;
		if (T4_) goto LA7_;
		T4_ = (((*(*g).module).flags &((NU64)1<<((NU)(((tyEnum_TSymFlag_K9ay6LWMat9bUiT9bIbMxpDHw) 12))&63U)))!=0);
		LA7_: ;
		T3_ = T4_;
		if (T3_) goto LA8_;
		T3_ = ((*(*g).config).projectMainIdx == (*(*g).module).info.fileIndex);
		LA8_: ;
		if (!T3_) goto LA9_;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*, closeJson_GrB9cG0YoTacDwWggL1RK7g)(tyObject_ModuleGraphcolonObjectType__RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TPassContext_Hb6rFM0ecvtlLf2kv9aU75w* p, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	NIM_BOOL useWarning;
	result = (tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*)0;
	if (p) chckObj((*p).Sup.m_type, (&NTI_QzRwKNjgUGyiY7E27E59ayg_));
	...
	useWarning = !((((*(*g).module).flags &((NU64)1<<((NU)(((tyEnum_TSymFlag_K9ay6LWMat9bUiT9bIbMxpDHw) 12))&63U)))!=0));
	{
		...
		if (TM_87tQLGE73DKq5cz9cph1IqQ_4.status == 0) {
			generateIndex_6UjzL2rSgVAuceHWxn9c01Q_2((*g).doc);
			popSafePoint();
		}
		else {
			popSafePoint();
...
static TNimNode* TM_87tQLGE73DKq5cz9cph1IqQ_2_3[3];
static TNimNode TM_87tQLGE73DKq5cz9cph1IqQ_0[4];
...
TM_87tQLGE73DKq5cz9cph1IqQ_2_3[0] = &TM_87tQLGE73DKq5cz9cph1IqQ_0[1];
...
TM_87tQLGE73DKq5cz9cph1IqQ_2_3[1] = &TM_87tQLGE73DKq5cz9cph1IqQ_0[2];
...
TM_87tQLGE73DKq5cz9cph1IqQ_2_3[2] = &TM_87tQLGE73DKq5cz9cph1IqQ_0[3];
TM_87tQLGE73DKq5cz9cph1IqQ_0[3].kind = 1;
TM_87tQLGE73DKq5cz9cph1IqQ_0[3].offset = offsetof(tyObject_TGen_QzRwKNjgUGyiY7E27E59ayg, config);
TM_87tQLGE73DKq5cz9cph1IqQ_0[3].typ = (&NTI_a8lycfSA25OQltN3OMeBsA_);
TM_87tQLGE73DKq5cz9cph1IqQ_0[3].name = "config";
TM_87tQLGE73DKq5cz9cph1IqQ_0[0].len = 3; TM_87tQLGE73DKq5cz9cph1IqQ_0[0].kind = 2; TM_87tQLGE73DKq5cz9cph1IqQ_0[0].sons = &TM_87tQLGE73DKq5cz9cph1IqQ_2_3[0];
