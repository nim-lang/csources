...
{	result = 0;
	...
	case ((NU8) 30):
	{
		NimStringDesc* LOC12;
		{
			...
			if (!(LOC7)) goto LA8;
			LOC9 = 0;
			LOC9 = getident_166463(((NimStringDesc*) &TMP3459));
...
N_NIMCALL(NI32, checkmodulename_250064)(Tnode190813* n) {
	...
	LOC1 = 0;
	LOC1 = tofullpath_163284((*n).info.fileindex);
	...
	LA4: ;
	{
		result = fileinfoidx_162858(fullpath);
	}
	LA2: ;
	return result;
}
...
N_NIMCALL(Tsym190843*, importmoduleas_250671)(Tnode190813* n, Tsym190843* realmodule) {
	...
	LA3: ;
	{
		...
		LA8: ;
		if (!LOC6) goto LA9;
		localerror_164171((*n).info, ((NU16) 4), ((NimStringDesc*) &TMP3464));
	}
	goto LA1;
	LA9: ;
	{
				...
				res_250216 = ((NI) 0);
				{
					while (1) {
						...
						e = (*(*(*etyp).n).kindU.S6.sons->data[j_250157]).kindU.S4.sym;
						{
							...
							internalerror_164215((*s).info, ((NimStringDesc*) &TMP3467));
						}
						LA27: ;
...
N_NIMCALL(void, importsymbol_250241)(Tcontext243023* c, Tnode190813* n, Tsym190843* frommod) {
	...
	LA3: ;
	{
		...
		LA8: ;
		{
			...
			internalerror_164215((*n).info, ((NimStringDesc*) &TMP3469));
		}
		LA12: ;
		switch ((*s).kind) {
		case ((NU8) 12):
