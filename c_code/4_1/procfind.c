...
static NIM_CONST TY186025 TMP3437 = {
...
static NIM_CONST TY186025 TMP3441 = {
...
N_NIMCALL(NIM_BOOL, equalgenericparams_264007)(tnode185813* proca, tnode185813* procb) {
	...
	while (1) {
		...
		nimln(19, "procfind.nim");
		{
			...
			internalerror_163591((*proca).Info, ((NimStringDesc*) &TMP3440));
		...
		nimln(22, "procfind.nim");
		{
			...
			internalerror_163591((*procb).Info, ((NimStringDesc*) &TMP3440));
		...
		if (((TMP3437[(*proca).Kind/8] &(1<<((*proca).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3438));
		if ((NU)(i_264024) >= (NU)((*proca).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3441[(*(*proca).kindU.S6.Sons->data[i_264024]).Kind/8] &(1<<((*(*proca).kindU.S6.Sons->data[i_264024]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3442));
		a = (*(*proca).kindU.S6.Sons->data[i_264024]).kindU.S4.Sym;
		nimln(26, "procfind.nim");
		if (((TMP3437[(*procb).Kind/8] &(1<<((*procb).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3438));
		if ((NU)(i_264024) >= (NU)((*procb).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3441[(*(*procb).kindU.S6.Sons->data[i_264024]).Kind/8] &(1<<((*(*procb).kindU.S6.Sons->data[i_264024]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3442));
