...
static NIM_CONST TY172865 TMP3126 = {
...
NTI223003.flags = 3;
TMP3014[0].kind = 1;
TMP3014[0].offset = offsetof(tpasscontext223003, Fromcache);
TMP3014[0].typ = (&NTI133);
TMP3014[0].name = "fromCache";
NTI223003.node = &TMP3014[0];
}
