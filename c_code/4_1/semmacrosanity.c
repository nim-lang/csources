...
static NIM_CONST TY186025 TMP5673 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5674, "sons", 4);
STRING_LITERAL(TMP5677, "ithField", 8);
STRING_LITERAL(TMP5682, "ithField(record case branch)", 28);
static NIM_CONST TY186025 TMP5683 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5684, "sym", 3);
STRING_LITERAL(TMP5685, "invalid field at index ", 23);
STRING_LITERAL(TMP5686, "() must have an object or tuple type", 36);
STRING_LITERAL(TMP5687, "[] must have some form of array type", 36);
STRING_LITERAL(TMP5688, "{} must have the set type", 25);
STRING_LITERAL(TMP5689, "float literal must have some float type", 39);
STRING_LITERAL(TMP5690, "integer literal must have some int type", 39);
STRING_LITERAL(TMP5691, "string literal must be of some string type", 42);
STRING_LITERAL(TMP5692, "nil literal must be of some pointer type", 40);
...
static N_INLINE(NI, sonslen_186191)(tnode185813* n) {
	...
	{
		nimln(1301, "ast.nim");
		if (((TMP5673[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP5674));
...
static N_INLINE(tnode185813*, lastson_186199)(tnode185813* n) {
	...
	TMP5680 = subInt(LOC1, 1);
	if ((NU)((NI32)(TMP5680)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI32)(TMP5680)];
	popFrame();
	return result;
}
...
N_NIMCALL(tsym185843*, ithfield_414007)(tnode185813* n, NI field) {
	...
	case ((NU8) 136):
	{
		...
		TMP5675 = subInt(LOC2, 1);
		HEX3Atmp_414182 = (NI32)(TMP5675);
		...
		while (1) {
			...
			nimln(20, "semmacrosanity.nim");
			TMP5676 = subInt(field, i_414024);
			result = ithfield_414007((*n).kindU.S6.Sons->data[i_414024], (NI32)(TMP5676));
	...
	case ((NU8) 137):
	{
		...
		nimln(23, "semmacrosanity.nim");
		{
			...
			nimln(23, "semmacrosanity.nim");
			internalerror_163591((*n).Info, ((NimStringDesc*) &TMP5677));
		}
		LA11: ;
		...
		result = ithfield_414007((*n).kindU.S6.Sons->data[0], (NI32)(TMP5678));
		...
		TMP5679 = subInt(LOC17, 1);
		HEX3Atmp_414186 = (NI32)(TMP5679);
		nimln(1450, "system.nim");
		res_414188 = 1;
		nimln(1451, "system.nim");
		while (1) {
			...
			case ((NU8) 88):
			{
				...
				result = ithfield_414007(LOC20, (NI32)(TMP5681));
			...
			default:
			{
				...
				internalerror_163591((*n).Info, ((NimStringDesc*) &TMP5682));
			}
			break;
			}
			nimln(1453, "system.nim");
	...
	case ((NU8) 3):
	{
		nimln(33, "semmacrosanity.nim");
		{
			...
			nimln(33, "semmacrosanity.nim");
			if (!(((TMP5683[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5684));
...
appendString(LOC12, ((NimStringDesc*) &TMP5685));
...
appendString(LOC25, ((NimStringDesc*) &TMP5685));
appendString(LOC25, LOC26);
		...
		LA31: ;
		{
			...
			globalerror_163565((*n).Info, ((NimStringDesc*) &TMP5686));
		}
		LA2: ;
	}
	break;
	case ((NU8) 41):
	{
		...
		LA37: ;
		{
			...
			globalerror_163565((*n).Info, ((NimStringDesc*) &TMP5687));
		}
		LA35: ;
	}
	break;
	case ((NU8) 39):
	{
		...
		LA46: ;
		{
			...
			globalerror_163565((*n).Info, ((NimStringDesc*) &TMP5688));
		}
		LA44: ;
	}
	break;
