...
static NIM_CONST TY192025 TMP6196 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP6197, "sons", 4);
extern NIM_CONST TY145469 cpu_145468;
STRING_LITERAL(TMP6200, "GetUniqueType", 13);
STRING_LITERAL(TMP6202, "\"", 1);
STRING_LITERAL(TMP6203, "len(a) == L string modified while iterating over it", 51);
STRING_LITERAL(TMP6204, "", 0);
STRING_LITERAL(TMP6205, "N", 1);
STRING_LITERAL(TMP6206, "HEX", 3);
STRING_LITERAL(TMP6208, "c\"", 2);
STRING_LITERAL(TMP6212, "\\00\"", 4);
...
static N_INLINE(NI, len_192274)(tnode191813* n) {
	...
	{
		nimln(957, "ast.nim");
		if (((TMP6196[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP6197));
...
N_NIMCALL(NI64, hashstring_469123)(NimStringDesc* s) {
	...
	nimln(32, "ccgutils.nim");
	{
		...
		nimln(36, "ccgutils.nim");
		nimln(36, "ccgutils.nim");
		TMP6198 = subInt(s->Sup.len, 1);
		HEX3Atmp_469208 = (NI32)(TMP6198);
...
static N_INLINE(ttype191847*, lastson_192203)(ttype191847* n) {
	...
	TMP6201 = subInt(LOC1, 1);
	if ((NU)((NI32)(TMP6201)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP6201)];
	popFrame();
	return result;
}
...
N_NIMCALL(ttype191847*, getuniquetype_469401)(ttype191847* key) {
	...
	case ((NU8) 58):
	{
		...
		internalerror_168606(((NimStringDesc*) &TMP6200));
	}
	break;
	case ((NU8) 11):
	case ((NU8) 13):
...
appendString(result, LOC2);
		...
		nimln(2807, "system.nim");
		{
			...
			nimln(2807, "system.nim");
			failedassertimpl_80421(((NimStringDesc*) &TMP6203));
		}
		LA5: ;
	} LA1: ;
...
N_NIMCALL(NimStringDesc*, mangle_469684)(NimStringDesc* name) {
	...
	case 48 ... 57:
	{
		...
		if ((NU)(0) > (NU)(name->Sup.len)) raiseIndexError();
		LOC4 = rawNewString(2);
appendString(LOC4, ((NimStringDesc*) &TMP6205));
...
appendString(LOC6, ((NimStringDesc*) &TMP6206));
appendString(LOC6, LOC7);
	...
	nimln(173, "ccgutils.nim");
	nimln(173, "ccgutils.nim");
	TMP6207 = subInt(name->Sup.len, 1);
	HEX3Atmp_469716 = (NI32)(TMP6207);
	nimln(1458, "system.nim");
	res_469718 = 1;
	nimln(1459, "system.nim");
	while (1) {
...
appendString(LOC14, ((NimStringDesc*) &TMP6206));
...
N_NIMCALL(trope148007*, makellvmstring_469723)(NimStringDesc* s) {
	...
	res = copyString(((NimStringDesc*) &TMP6208));
	i_469741 = 0;
	HEX3Atmp_469753 = 0;
	nimln(189, "ccgutils.nim");
	nimln(189, "ccgutils.nim");
	nimln(189, "ccgutils.nim");
	TMP6209 = subInt(s->Sup.len, 1);
	HEX3Atmp_469753 = (NI32)(TMP6209);
	nimln(1451, "system.nim");
	res_469755 = 0;
	nimln(1452, "system.nim");
	while (1) {
		...
		nimln(190, "ccgutils.nim");
		{
			...
			nimln(190, "ccgutils.nim");
			nimln(190, "ccgutils.nim");
			TMP6210 = addInt(i_469741, 1);
			TMP6211 = modInt((NI32)(TMP6210), 64);
			if (!(((NI) ((NI32)(TMP6211))) == 0)) goto LA4;
...
appendString(res, ((NimStringDesc*) &TMP6212));
