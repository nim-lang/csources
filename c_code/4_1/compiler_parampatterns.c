...
STRING_LITERAL(TMP3292, "atom", 4);
STRING_LITERAL(TMP3293, "lit", 3);
STRING_LITERAL(TMP3294, "sym", 3);
STRING_LITERAL(TMP3295, "ident", 5);
STRING_LITERAL(TMP3296, "call", 4);
STRING_LITERAL(TMP3297, "alias", 5);
STRING_LITERAL(TMP3298, "noalias", 7);
STRING_LITERAL(TMP3299, "lvalue", 6);
STRING_LITERAL(TMP3300, "local", 5);
STRING_LITERAL(TMP3301, "sideeffect", 10);
STRING_LITERAL(TMP3302, "nosideeffect", 12);
STRING_LITERAL(TMP3304, "compiler/parampatterns.nim", 26);
NIM_CONST TY88487 TMP3303 = {((NimStringDesc*) &TMP3304),
((NI) 100)}
;
NIM_CONST TY88487 TMP3305 = {((NimStringDesc*) &TMP3304),
((NI) 107)}
;
STRING_LITERAL(TMP3306, "parameter pattern too complex", 29);
...
{	switch ((*p).kind) {
	...
	case ((NU8) 32):
	{
		...
		op = (*(*p).kindU.S6.sons->data[((NI) 0)]).kindU.S5.ident;
		{
			...
			if (!(LOC8 == ((NI) 3))) goto LA9;
			{
				NIM_BOOL LOC13;
				LOC13 = 0;
				LOC13 = eqStrings((*op).s, ((NimStringDesc*) &TMP3289));
				if (LOC13) goto LA14;
			...
			LA15: ;
			{
				NIM_BOOL LOC18;
				LOC18 = 0;
				LOC18 = eqStrings((*op).s, ((NimStringDesc*) &TMP3290));
				if (LOC18) goto LA19;
		...
		LA9: ;
		{
			...
			if (!(LOC24)) goto LA26;
			LOC27 = 0;
			LOC27 = eqStrings((*op).s, ((NimStringDesc*) &TMP3291));
			if (LOC27) goto LA28;
	...
	case ((NU8) 2):
	{
		...
		case 1: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3302))) goto LA50;
break;
		case 3: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3298))) goto LA46;
if (eqStrings(spec, ((NimStringDesc*) &TMP3299))) goto LA47;
if (eqStrings(spec, ((NimStringDesc*) &TMP3301))) goto LA49;
break;
		case 4: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3294))) goto LA42;
break;
		case 6: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3295))) goto LA43;
if (eqStrings(spec, ((NimStringDesc*) &TMP3300))) goto LA48;
break;
		case 11: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3292))) goto LA40;
break;
		case 12: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3293))) goto LA41;
break;
		case 13: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3296))) goto LA44;
break;
		case 14: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3297))) goto LA45;
break;
		}
		goto LA51;
		LA40: ;
...
N_NIMCALL(Tnode214790*, semnodekindconstraints_286446)(Tnode214790* p) {
	...
	(*result).kindU.S3.strval = addChar((*result).kindU.S3.strval, 1);
	{
		...
		}
		{
			...
			internalerror_187100((*p).info, ((NimStringDesc*) &TMP3306));
		}
		LA12: ;
	}
	goto LA1;
