...
N_NIMCALL(void, handleshortoption_527106)(toptparser526807* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_527002((*p).Cmd, i, &(*p).Val, TMP7634);
	}
	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser526807* p) {
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_527002((*p).Cmd, i, &(*p).Key, TMP7635);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_527002((*p).Cmd, i, &(*p).Val, TMP7634);
			}
			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_527002((*p).Cmd, i, &(*p).Key, TMP7634);
	}
	break;
	}
	BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser526807* p) {
	...
	LOC1 = 0;
	LOC1 = copyStrLast((*p).Cmd, (*p).Pos, (NI32)(TMP7636));
...
TMP7638[0] = &TMP7628[1];
TMP7628[1].kind = 1;
TMP7628[1].offset = offsetof(toptparser526807, Cmd);
TMP7628[1].typ = (&NTI143);
TMP7628[1].name = "cmd";
TMP7638[1] = &TMP7628[2];
TMP7628[2].kind = 1;
TMP7628[2].offset = offsetof(toptparser526807, Pos);
TMP7628[2].typ = (&NTI106);
TMP7628[2].name = "pos";
TMP7638[2] = &TMP7628[3];
TMP7628[3].kind = 1;
TMP7628[3].offset = offsetof(toptparser526807, Inshortstate);
...
NTI526805.node = &TMP7628[9];
TMP7628[4].kind = 1;
TMP7628[4].offset = offsetof(toptparser526807, Kind);
TMP7628[4].typ = (&NTI526805);
TMP7628[4].name = "kind";
TMP7638[4] = &TMP7628[10];
TMP7628[10].kind = 1;
TMP7628[10].offset = offsetof(toptparser526807, Key);
TMP7628[10].typ = (&NTI143);
TMP7628[10].name = "key";
TMP7638[5] = &TMP7628[11];
TMP7628[11].kind = 1;
TMP7628[11].offset = offsetof(toptparser526807, Val);
TMP7628[11].typ = (&NTI143);
TMP7628[11].name = "val";
TMP7628[0].len = 6; TMP7628[0].kind = 2; TMP7628[0].sons = &TMP7638[0];
NTI526807.node = &TMP7628[0];
}
