...
N_NIMCALL(NU8, checkdepmem_553491)(NI32 fileidx);
...
N_NIMCALL(void, docrc_553158)(NI32 fileidx) {
	{
		...
		LOC5 = 0;
		LOC5 = tofilename_182628(fileidx);
...
N_NIMCALL(tsym209848*, newmodule_553649)(NI32 fileidx) {
	...
	(*result).Sup.Id = -1;
	(*result).Kind = ((NU8) 6);
	filename = tofullpath_182640(fileidx);
	...
	LA5: ;
	(*result).Info = newlineinfo_181944(fileidx, 1, 1);
	LOC7 = 0;
...
N_NIMCALL(NIM_BOOL, crcchanged_553113)(NI32 fileidx) {
	...
	case ((NU8) 1):
	{
		...
		NimStringDesc* LOC11;
		LOC11 = 0;
		LOC11 = tofilename_182628(fileidx);
	...
	case ((NU8) 0):
	{
		NimStringDesc* LOC18;
		LOC18 = 0;
		LOC18 = tofilename_182628(fileidx);
		...
		gmemcachedata_553079->data[fileidx].Needsrecompile = ((NU8) 3);
		{
			...
			l_553633 = HEX3Atmp_553628->Sup.len;
			{
				while (1) {
					...
					d = checkdepmem_553491(dep_553611);
					{
	...
	{
		{
			NU8 LOC25;
			LOC25 = 0;
			LOC25 = checkdepmem_553491(fileidx);
...
N_NIMCALL(void, wantmainmodule_554005)(void) {
	NimStringDesc* LOC5;
	{
		...
		fatal_183605(gcmdlineinfo_182007, ((NU16) 186), ((NimStringDesc*) &TMP4142));
	}
	LA3: ;
	LOC5 = 0;
	LOC5 = nosaddFileExt(gprojectfull_170239, ((NimStringDesc*) &TMP4143));
	gprojectmainidx_170240 = fileinfoidx_181931(LOC5);
}
...
N_NIMCALL(void, compilesystemmodule_553979)(void) {
	{
		...
		systemfileidx_181443 = fileinfoidx_181931(LOC5);
		LOC6 = 0;
...
N_NIMCALL(void, compileproject_554068)(NI32 projectfileidx) {
	...
	systemfileidx = fileinfoidx_181931(LOC1);
	{
...
N_NIMCALL(tsym209848*, makestdinmodule_554088)(void) {
	...
	result = 0;
	{
		...
		LOC5 = 0;
		LOC5 = fileinfoidx_181931(((NimStringDesc*) &TMP4854));
...
N_NIMCALL(void, resetallmodules_553439)(void) {
	{
		...
		i_553451 = 0;
		HEX3Atmp_553471 = 0;
		HEX3Atmp_553471 = (gcompiledmodules_553057->Sup.len-1);
		res_553474 = 0;
		{
			while (1) {
				if (!(res_553474 <= HEX3Atmp_553471)) goto LA3;
				i_553451 = res_553474;
				{
