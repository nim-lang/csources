...
STRING_LITERAL(TMP7638, "", 0);
STRING_LITERAL(TMP7645, "server.type", 11);
STRING_LITERAL(TMP7646, "stdin", 5);
STRING_LITERAL(TMP7647, "tcp", 3);
STRING_LITERAL(TMP7648, "quit", 4);
STRING_LITERAL(TMP7653, "server.port", 11);
STRING_LITERAL(TMP7654, "server.address", 14);
STRING_LITERAL(TMP7680, "\015\012", 2);
STRING_LITERAL(TMP7681, "Invalid server.type:", 20);
...
extern tsocketimpl148605* stdoutsocket_162192;
	...
	while (1) {
		...
		case ((NU8) 3):
		{
			...
			nimln(43, "service.nim");
			{
				...
				nimln(44, "service.nim");
				nimln(44, "service.nim");
				TMP7643 = subInt(bracketle, 1);
				key = copyStrLast(p.Key, 0, (NI32)(TMP7643));
				nimln(45, "service.nim");
				nimln(45, "service.nim");
				LOC8 = 0;
				nimln(45, "service.nim");
				nimln(45, "service.nim");
				TMP7644 = addInt(bracketle, 1);
				LOC9 = 0;
				LOC9 = copyStr(p.Key, (NI32)(TMP7644));
...
appendString(LOC8, p.Val);
				...
				processswitch_171016(key, val, pass, gcmdlineinfo_162104);
			}
			goto LA4;
			LA6: ;
			{
				nimln(48, "service.nim");
				processswitch_171016(p.Key, p.Val, pass, gcmdlineinfo_162104);
			}
			LA4: ;
		}
		break;
		case ((NU8) 1):
		{
			...
			LA14: ;
			{
				...
				nimln(54, "service.nim");
				{
					...
					asgnRefNoCycle((void**) &gprojectname_135206, nosunixToNativePath(p.Key, ((NimStringDesc*) &TMP7638)));
...
N_NIMCALL(void, serve_523292)(TY523294 action) {
	...
	typ = getconfigvar_135311(((NimStringDesc*) &TMP7645));
	nimln(75, "service.nim");
	if (eqStrings(typ, ((NimStringDesc*) &TMP7646))) goto LA1;
	if (eqStrings(typ, ((NimStringDesc*) &TMP7647))) goto LA2;
	...
	LA1: ;
	{
		...
		while (1) {
			...
			{
				nimln(79, "service.nim");
				if (!eqStrings(line, ((NimStringDesc*) &TMP7648))) goto LA9;
				nimln(79, "service.nim");
				exit(0);
			}
			LA9: ;
			...
			printf("%s\012", (((NimStringDesc*) &TMP7638))->data);
	...
	LA2: ;
	{
		...
		p = getconfigvar_135311(((NimStringDesc*) &TMP7653));
		...
		nimln(90, "service.nim");
		LOC24 = 0;
		LOC24 = getconfigvar_135311(((NimStringDesc*) &TMP7654));
		bindaddr_150584(server, port, LOC24);
		nimln(91, "service.nim");
		inp = copyString(((NimStringDesc*) &TMP7638));
		nimln(92, "service.nim");
		listen_150405(server, SOMAXCONN);
		nimln(93, "service.nim");
		if (stdoutsocket_162192) nimGCunrefNoCycle(stdoutsocket_162192);
		stdoutsocket_162192 = (tsocketimpl148605*) newObjRC1((&NTI148607), sizeof(tsocketimpl148605));
		nimln(94, "service.nim");
		while (1) {
			NimStringDesc* LOC26;
			nimln(95, "service.nim");
			accept_152201(server, &stdoutsocket_162192);
			nimln(96, "service.nim");
			readline_157033(stdoutsocket_162192, &inp, -1);
			nimln(67, "service.nim");
			LOC26 = 0;
			...
			send_158605(stdoutsocket_162192, ((NimStringDesc*) &TMP7680));
			nimln(99, "service.nim");
			close_152266(stdoutsocket_162192);
		}
	}
	goto LA4;
	LA3: ;
	{
		...
		printf("%s%s\012", (((NimStringDesc*) &TMP7681))->data, (typ)->data);
...
N_NOINLINE(void, serviceInit)(void) {
	...
	LOC1 = 0;
	LOC1 = curcaascmd_523203; curcaascmd_523203 = copyStringRC1(((NimStringDesc*) &TMP7638));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(25, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_523204; lastcaascmd_523204 = copyStringRC1(((NimStringDesc*) &TMP7638));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(28, "service.nim");
	LOC3 = 0;
	LOC3 = arguments_523205; arguments_523205 = copyStringRC1(((NimStringDesc*) &TMP7638));
