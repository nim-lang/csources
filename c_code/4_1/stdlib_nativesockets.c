...
NI TMP5263;
static char* NIM_CONST TMP5262[3] = {
"AF_UNIX", 
"AF_INET", 
"AF_INET6"};
static TNimNode* TMP5264[4];
NI TMP5266;
static char* NIM_CONST TMP5265[4] = {
"SOCK_STREAM", 
"SOCK_DGRAM", 
"SOCK_RAW", 
"SOCK_SEQPACKET"};
...
NI TMP5269;
static char* NIM_CONST TMP5268[6] = {
"IPPROTO_TCP", 
"IPPROTO_UDP", 
"IPPROTO_IP", 
"IPPROTO_IPV6", 
...
NTI516604.base = 0;
NTI516604.flags = 3;
for (TMP5263 = 0; TMP5263 < 3; TMP5263++) {
TMP1191[TMP5263+0].kind = 1;
TMP1191[TMP5263+0].offset = TMP5263;
TMP1191[TMP5263+0].name = TMP5262[TMP5263];
TMP5261[TMP5263] = &TMP1191[TMP5263+0];
}
TMP1191[0].offset = 0;
TMP1191[1].offset = 2;
TMP1191[2].offset = 23;
TMP1191[3].len = 3; TMP1191[3].kind = 2; TMP1191[3].sons = &TMP5261[0];
...
NTI516606.base = 0;
NTI516606.flags = 3;
for (TMP5266 = 0; TMP5266 < 4; TMP5266++) {
TMP1191[TMP5266+4].kind = 1;
TMP1191[TMP5266+4].offset = TMP5266;
TMP1191[TMP5266+4].name = TMP5265[TMP5266];
TMP5264[TMP5266] = &TMP1191[TMP5266+4];
}
TMP1191[4].offset = 1;
TMP1191[5].offset = 2;
TMP1191[6].offset = 3;
TMP1191[7].offset = 5;
TMP1191[8].len = 4; TMP1191[8].kind = 2; TMP1191[8].sons = &TMP5264[0];
...
NTI516608.base = 0;
NTI516608.flags = 3;
for (TMP5269 = 0; TMP5269 < 6; TMP5269++) {
TMP1191[TMP5269+9].kind = 1;
TMP1191[TMP5269+9].offset = TMP5269;
TMP1191[TMP5269+9].name = TMP5268[TMP5269];
TMP5267[TMP5269] = &TMP1191[TMP5269+9];
}
TMP1191[9].offset = 6;
...
TMP1191[15].len = 6; TMP1191[15].kind = 2; TMP1191[15].sons = &TMP5267[0];
