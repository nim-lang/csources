...
STRING_LITERAL(TMP2825, ".nimfix", 7);
static NIM_CONST TY202404 TMP2834 = {
0x00, 0x24, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2835, "\015\012", 2);
STRING_LITERAL(TMP2836, "\012", 1);
...
N_NIMCALL(void, loadfile_268029)(Tlineinfo182337 info) {
	...
	LA3: ;
	{
		...
		gsourcefiles_268027->data[i].isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP2825));
		{
		...
		LOC17 = 0;
		LOC17 = &LOC16->Sup;
		open_267223((&lex), LOC17, ((NI) 8192), TMP2834);
		pos = lex.bufpos;
		{
			while (1) {
				...
				case 13:
				{
					NimStringDesc* LOC21;
					LOC21 = 0;
					LOC21 = gsourcefiles_268027->data[i].newline; gsourcefiles_268027->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP2835));
				...
				case 0:
				{
					NimStringDesc* LOC23;
					LOC23 = 0;
					LOC23 = gsourcefiles_268027->data[i].newline; gsourcefiles_268027->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP2836));
