...
N_NIMCALL(void, handleCmdLine_9cY64ywAS3hWchkzksTFxCw)(tyObject_IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw* cache, tyObject_ConfigRefcolonObjectType__LaK09ayL9alwKUad7rts0rTw* config);
N_NIMCALL(NI, paramCount_T74rCHY8RMV0X07YnKmggw)(void);
N_NIMCALL(void, writeCommandLineUsage_t59c14FW7IpJTxVWyUYociQ)(void);
N_NIMCALL(void, processCmdLine_tw2pZl8Nisz38VPmsT5WZA)(tyEnum_TCmdLinePass_IiBn9cB6WYIMDHOT44O82wA pass, NimStringDesc* cmd);
...
N_NIMCALL(void, loadConfigs_WqwTOVMOtH9bbKoR9aEgkgLQ)(NimStringDesc* cfg, tyObject_ConfigRefcolonObjectType__LaK09ayL9alwKUad7rts0rTw* config);
...
{	{
	...
	LA4_: ;
	{
		...
		processCmdLine_tw2pZl8Nisz38VPmsT5WZA(((tyEnum_TCmdLinePass_IiBn9cB6WYIMDHOT44O82wA) 1), ((NimStringDesc*) &TM_6xNBOpPeN0DsJ34t7RoSng_2));
		{
			...
			rawMessage_tBJ8mvo7MzzirsGkrHVc9cw(((tyEnum_TMsgKind_IGAWgv9aR2KqPKJfPZPEWaw) 185), command_zo83h8QWwtDIGDuqkGhjqg);
		}
		LA46_: ;
		...
		mainCommand_9ckTkd2AM27sYCvHGluAXLg(T48_, cache);
		{
			...
			if (!(T51_)) goto LA52_;
			T51_ = ((gNotes_ra0BBMaJz6cOxn1JA3c6Bg &((NU64)1<<((NU)((((tyEnum_TMsgKind_P7z69ae9cO2FQBJme8oWEJoA) 292)- 240))&63U)))!=0);
			LA52_: ;
			if (!T51_) goto LA53_;
...
appendString(T77_, arguments_J4sVmqKDJ3MkfxziRX9cODA);
					execExternalProgram_Pv5NVuLJkhqF9a3uo9aKpTxw(T77_, ((tyEnum_TMsgKind_IGAWgv9aR2KqPKJfPZPEWaw) 287));
				}
				goto LA64_;
				LA66_: ;
				{
...
appendString(T91_, arguments_J4sVmqKDJ3MkfxziRX9cODA);
					execExternalProgram_Pv5NVuLJkhqF9a3uo9aKpTxw(T91_, ((tyEnum_TMsgKind_IGAWgv9aR2KqPKJfPZPEWaw) 287));
				}
				goto LA64_;
				LA80_: ;
				{
...
appendString(T99_, arguments_J4sVmqKDJ3MkfxziRX9cODA);
					execExternalProgram_Pv5NVuLJkhqF9a3uo9aKpTxw(T99_, ((tyEnum_TMsgKind_IGAWgv9aR2KqPKJfPZPEWaw) 287));
				}
				LA64_: ;
			}
			LA62_: ;
