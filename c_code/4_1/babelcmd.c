...
N_NIMCALL(NIM_BOOL, HEX3CHEX2E_204074)(NimStringDesc* a, NimStringDesc* b) {
	...
	result = 0;
	{
		if (!eqStrings(a, ((NimStringDesc*) &TMP1266))) goto LA3;
		result = NIM_FALSE;
		goto BeforeRet;
	}
	LA3: ;
...
N_NIMCALL(void, addpackage_204151)(stringtableobj127812* packages, NimStringDesc* p) {
	...
	LA3: ;
	{
		nstPut(packages, name, ((NimStringDesc*) &TMP1266));
	}
	LA1: ;
}
			...
			if (!!((d_204329 == NIM_NIL))) goto LA8;
			{
				while (1) {
					...
					y_204333 = cstrToNimstr(((NCSTRING) ((*x_204331).d_name)));
					{
						...
						if (!(LOC18)) goto LA19;
						LOC18 = !(eqStrings(y_204333, ((NimStringDesc*) &TMP1265)));
						LA19: ;
						if (!LOC18) goto LA20;
				...
				res_204351 = 0;
				{
					while (1) {
						...
						h_204347 = res_204351;
						{
							...
							{
								if (!eqStrings(val_204345, ((NimStringDesc*) &TMP1266))) goto LA55;
