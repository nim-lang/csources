...
;
STRING_LITERAL(TMP121, "solaris", 7);
STRING_LITERAL(TMP1445, "littleEndian", 12);
STRING_LITERAL(TMP1446, "bigEndian", 9);
NIM_CONST TY174475 endiantostr_174474 = {((NimStringDesc*) &TMP1445),
...
NIM_EXTERNC N_NOINLINE(void, HEX00_platformInit)(void) {
	hostcpu_174588 = nametocpu_174604(((NimStringDesc*) &TMP59));
