...
N_NIMCALL(NI, counttriples_179676)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1642 = addInt(i, 1);
			if ((NU)((NI32)(TMP1642)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI32)(TMP1642)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1643 = addInt(i, 2);
			if ((NU)((NI32)(TMP1643)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI32)(TMP1643)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
appendString((*s).S, ((NimStringDesc*) &TMP1646));
	...
	result = ((buflen <= (NI32)(TMP1647)) ? buflen : (NI32)(TMP1647));
...
N_NIMCALL(NI, llstreamread_179242)(tllstream179204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		result = ((buflen <= (NI32)(TMP1648)) ? buflen : (NI32)(TMP1648));
		nimln(136, "llstream.nim");
		{
			...
			memcpy(buf, ((void*) (&(*s).S->data[(NI32)(TMP1649)])), result);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_179254)(tllstream179204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI32)(TMP1652));
			nimln(222, "llstream.nim");
			nimln(222, "llstream.nim");
			TMP1653 = addInt(i, 0);
			if ((NU)((NI32)(TMP1653)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_10827((*s).F, ((void*) (&result->data[(NI32)(TMP1653)])), 2048);
