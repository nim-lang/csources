...
static NIM_CONST TY177407 TMP1865 = {
			...
			current_153888 = copyString(path);
			{
				while (1) {
					...
					parents += ((NI) 1);
					{
						...
						file_153841 = 0;
						HEX3Atmp_153855 = 0;
						HEX3Atmp_153855 = HEX2F_118292(d_153831, ((NimStringDesc*) &TMP1434));
					...
					}
					{
						...
						file_153842 = 0;
						HEX3Atmp_153871 = 0;
						HEX3Atmp_153871 = HEX2F_118292(d_153831, ((NimStringDesc*) &TMP1435));
...
N_NIMCALL(NimStringDesc*, getgeneratedpath_153428)(void) {
	...
	LA3: ;
	{
		...
		result = HEX2F_118292(LOC6, ((NimStringDesc*) &TMP1436));
	}
	LA1: ;
	return result;
}
...
N_NIMCALL(void, incldynliboverride_154472)(NimStringDesc* lib) {
	...
	nstPut(gdlloverrides_153232, LOC1, ((NimStringDesc*) &TMP1866));
}
