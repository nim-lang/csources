...
STRING_LITERAL(TMP1937, "length > counter ", 17);
STRING_LITERAL(TMP1943, "data[h] != desc ", 16);
STRING_LITERAL(TMP1944, "data[h] == nil ", 15);
STRING_LITERAL(TMP1953, "t.data[h] == nil ", 17);
STRING_LITERAL(TMP1954, "dest.data[h] == nil ", 20);
STRING_LITERAL(TMP1955, "{", 1);
STRING_LITERAL(TMP1956, ", ", 2);
STRING_LITERAL(TMP1957, "}", 1);
...
static N_INLINE(NIM_BOOL, mustrehash_182058)(NI length, NI counter) {
	...
	nimln(47, "intsets.nim");
	{
		...
		nimln(47, "intsets.nim");
		failedassertimpl_79821(((NimStringDesc*) &TMP1937));
	}
	LA3: ;
	...
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	TMP1938 = mulInt(length, 2);
	nimln(48, "intsets.nim");
	TMP1939 = mulInt(counter, 3);
	LOC5 = ((NI32)(TMP1938) < (NI32)(TMP1939));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	TMP1940 = subInt(length, counter);
	LOC5 = ((NI32)(TMP1940) < 4);
	LA6: ;
	result = LOC5;
	popFrame();
...
static N_INLINE(NI, nexttry_182206)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1941 = mulInt(5, h);
	TMP1942 = addInt((NI32)(TMP1941), 1);
	result = (NI)((NI32)(TMP1942) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, intsetrawinsert_182239)(tintset182047 t, ttrunkseq182045** data, ttrunk182043* desc) {
	...
	while (1) {
		...
		nimln(64, "intsets.nim");
		{
			...
			nimln(64, "intsets.nim");
			failedassertimpl_79821(((NimStringDesc*) &TMP1943));
		}
		LA4: ;
...
N_NIMCALL(void, intsetenlarge_182621)(tintset182047* t) {
	...
	nimln(72, "intsets.nim");
	nimln(72, "intsets.nim");
	TMP1945 = addInt((*t).Max, 1);
	TMP1946 = mulInt((NI32)(TMP1945), 2);
	TMP1947 = subInt((NI32)(TMP1946), 1);
	(*t).Max = (NI32)(TMP1947);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1948 = addInt((*t).Max, 1);
	n = (ttrunkseq182045*) newSeq((&NTI182045), (NI32)(TMP1948));
	i_182655 = 0;
...
N_NIMCALL(ttrunk182043*, intsetput_182696)(tintset182047* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_182058((NI32)(TMP1952), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
	...
	nimln(88, "intsets.nim");
	{
		...
		nimln(88, "intsets.nim");
		failedassertimpl_79821(((NimStringDesc*) &TMP1953));
	}
	LA14: ;
...
N_NIMCALL(NimStringDesc*, HEX24_183322)(tintset182047 s) {
	...
	result = copyString(((NimStringDesc*) &TMP1955));
	key_183327 = 0;
...
appendString(result, ((NimStringDesc*) &TMP1956));
					}
					LA10: ;
...
static TNimNode* TMP1949[3];
static TNimNode* TMP3243[4];
static TNimNode TMP1935[9];
NTI182043.size = sizeof(ttrunk182043);
NTI182043.kind = 18;
NTI182043.base = 0;
TMP1949[0] = &TMP1935[1];
TMP1935[1].kind = 1;
TMP1935[1].offset = offsetof(ttrunk182043, Next);
TMP1935[1].typ = (&NTI182041);
TMP1935[1].name = "next";
TMP1949[1] = &TMP1935[2];
TMP1935[2].kind = 1;
TMP1935[2].offset = offsetof(ttrunk182043, Key);
TMP1935[2].typ = (&NTI106);
TMP1935[2].name = "key";
TMP1949[2] = &TMP1935[3];
TMP1935[3].kind = 1;
TMP1935[3].offset = offsetof(ttrunk182043, Bits);
TMP1935[3].typ = (&NTI22818);
TMP1935[3].name = "bits";
TMP1935[0].len = 3; TMP1935[0].kind = 2; TMP1935[0].sons = &TMP1949[0];
NTI182043.node = &TMP1935[0];
NTI182041.size = sizeof(ttrunk182043*);
NTI182041.kind = 22;
NTI182041.base = (&NTI182043);
NTI182041.marker = TMP1950;
NTI182045.size = sizeof(ttrunkseq182045*);
NTI182045.kind = 24;
NTI182045.base = (&NTI182041);
NTI182045.flags = 2;
NTI182045.marker = TMP1951;
...
TMP3243[0] = &TMP1935[5];
TMP1935[5].kind = 1;
TMP1935[5].offset = offsetof(tintset182047, Counter);
TMP1935[5].typ = (&NTI106);
TMP1935[5].name = "counter";
TMP3243[1] = &TMP1935[6];
TMP1935[6].kind = 1;
TMP1935[6].offset = offsetof(tintset182047, Max);
TMP1935[6].typ = (&NTI106);
TMP1935[6].name = "max";
TMP3243[2] = &TMP1935[7];
TMP1935[7].kind = 1;
TMP1935[7].offset = offsetof(tintset182047, Head);
TMP1935[7].typ = (&NTI182041);
TMP1935[7].name = "head";
TMP3243[3] = &TMP1935[8];
TMP1935[8].kind = 1;
TMP1935[8].offset = offsetof(tintset182047, Data);
TMP1935[8].typ = (&NTI182045);
TMP1935[8].name = "data";
TMP1935[4].len = 4; TMP1935[4].kind = 2; TMP1935[4].sons = &TMP3243[0];
NTI182047.node = &TMP1935[4];
}
