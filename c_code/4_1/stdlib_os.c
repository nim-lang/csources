		...
		while (1) {
			...
			LA7: ;
			{
				...
				err0 = oslasterror_pMOMIZAQaKFp1XoL58mjVg();
				{
					...
					bufsize0 = (NI)((NU32)(bufsize0) << (NU32)(((NI) 1)));
					{
...
N_NIMCALL(void, noscopyFile)(NimStringDesc* source0, NimStringDesc* dest0) {
	...
	LA10: ;
	buf0 = alloc_4cubgSerkjpuLcj5MXjiLw_2(((NI) 8000));
	{
		while (1) {
			NI bytesread0;
			bytesread0 = readbuffer_nZ0pNe9cd9cXtoayexCiaDtA_2(s0, buf0, ((NI) 8000));
			{
				NI byteswritten0;
				if (!(((NI) 0) < bytesread0)) goto LA17;
				byteswritten0 = writebuffer_nZ0pNe9cd9cXtoayexCiaDtA(d0, buf0, ((NI) (bytesread0)));
				{
					NI32 LOC23;
