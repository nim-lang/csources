...
N_NIMCALL(NCSTRING*, envtocstringarray_128841)(void) {
	...
	while (1) {
		...
		key_128845 = copyStrLast(environment_111806->data[i_128886], 0, (NI32)(TMP367));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_128886) >= (NU)(environment_111806->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP368 = addInt(p_128892, 1);
		val_128846 = copyStr(environment_111806->data[i_128886], (NI32)(TMP368));
	...
	while (1) {
		...
		key_128865 = copyStrLast(environment_111806->data[i_128902], 0, (NI32)(TMP371));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_128902) >= (NU)(environment_111806->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP372 = addInt(p_128908, 1);
		val_128866 = copyStr(environment_111806->data[i_128902], (NI32)(TMP372));
