...
N_NIMCALL(NCSTRING*, envtocstringarray_126841)(void) {
	...
	while (1) {
		...
		key_126845 = copyStrLast(environment_110806->data[i_126886], 0, (NI32)(TMP367));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_126886) >= (NU)(environment_110806->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP368 = addInt(p_126892, 1);
		val_126846 = copyStr(environment_110806->data[i_126886], (NI32)(TMP368));
	...
	while (1) {
		...
		key_126865 = copyStrLast(environment_110806->data[i_126902], 0, (NI32)(TMP371));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_126902) >= (NU)(environment_110806->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP372 = addInt(p_126908, 1);
		val_126866 = copyStr(environment_110806->data[i_126902], (NI32)(TMP372));
