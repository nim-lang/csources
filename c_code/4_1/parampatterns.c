...
N_NIMCALL(NIM_BOOL, matchnodekinds_281344)(tnode191813* p, tnode191813* n) {
	...
	while (1) {
		...
		case ((NU8) 2):
		{
			...
			LOC4 = stack[((NI32)(TMP3605))- 0];
			if (LOC4) goto LA5;
			nimln(242, "parampatterns.nim");
			TMP3606 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3606)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI32)(TMP3606))- 0];
			LA5: ;
			stack[((NI32)(TMP3604))- 0] = LOC4;
		...
		case ((NU8) 3):
		{
			...
			LOC7 = stack[((NI32)(TMP3608))- 0];
			if (!(LOC7)) goto LA8;
			nimln(245, "parampatterns.nim");
			TMP3609 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3609)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI32)(TMP3609))- 0];
			LA8: ;
			stack[((NI32)(TMP3607))- 0] = LOC7;
		...
		case ((NU8) 4):
		{
			...
			stack[((NI32)(TMP3610))- 0] = !(stack[((NI32)(TMP3611))- 0]);
		}
		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(254, "parampatterns.nim");
			TMP3612 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3612)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3612)])), ((NU8) 0), ((NU8) 24)));
			nimln(233, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			nimln(258, "parampatterns.nim");
			TMP3613 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3613)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3613)])), ((NU8) 0), ((NU8) 156)));
			nimln(233, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
	...
	nimln(266, "parampatterns.nim");
	TMP3614 = subInt(sp, 1);
	if ((NU)((NI32)(TMP3614)) > (NU)(64)) raiseIndexError();
	result = stack[((NI32)(TMP3614))- 0];
	popFrame();
	return result;
}
