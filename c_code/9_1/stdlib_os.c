			...
			if (TM_yu6cxgKBBXbNsTkT9cyMd4g_13.status == 0) {
				{
					while (1) {
						...
						y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
						{
							...
							T15_ = (NIM_BOOL)0;
							T15_ = !(eqStrings(y, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_14)));
							if (!(T15_)) goto LA16_;
							T15_ = !(eqStrings(y, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_15)));
							LA16_: ;
							if (!T15_) goto LA17_;
							memset((void*)(&s), 0, sizeof(s));
							{
...
N_NIMCALL(void, nosmoveFile)(NimStringDesc* source, NimStringDesc* dest) {
	{
		...
		err = osLastError_YyC2FKP9bqQiUDq2XVqW9acA();
		{
			...
			TM_yu6cxgKBBXbNsTkT9cyMd4g_16.status = setjmp(TM_yu6cxgKBBXbNsTkT9cyMd4g_16.context);
