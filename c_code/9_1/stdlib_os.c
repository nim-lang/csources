...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, getApplHaiku_cIsnssr9auuNc29cT9bLoxiqg)(void);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nosgetAppFilename)(void) {
	NimStringDesc* result;
	result = (NimStringDesc*)0;
	result = getApplHaiku_cIsnssr9auuNc29cT9bLoxiqg();
	{
...
N_LIB_PRIVATE N_NIMCALL(void, nosremoveDir)(NimStringDesc* dir) {
	{
		...
		d = opendir(nimToCStringConv(dir));
		{
			...
			TM_yu6cxgKBBXbNsTkT9cyMd4g_7.status = setjmp(TM_yu6cxgKBBXbNsTkT9cyMd4g_7.context);
			if (TM_yu6cxgKBBXbNsTkT9cyMd4g_7.status == 0) {
				{
					while (1) {
						...
						y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
						{
							...
							T15_ = (NIM_BOOL)0;
							T15_ = !(eqStrings(y, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_8)));
							if (!(T15_)) goto LA16_;
							T15_ = !(eqStrings(y, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_9)));
							LA16_: ;
							if (!T15_) goto LA17_;
							nimZeroMem((void*)(&s), sizeof(struct stat));
							{
...
N_LIB_PRIVATE N_NIMCALL(void, nosmoveFile)(NimStringDesc* source, NimStringDesc* dest) {
	{
		...
		TM_yu6cxgKBBXbNsTkT9cyMd4g_10.status = setjmp(TM_yu6cxgKBBXbNsTkT9cyMd4g_10.context);
