...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w*, searchForProcNew_WIQjdZgnZBgByteqPM0pPw_2)(tyObject_TContext_C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TScope_1cQRXW6aAknk7ywAwjH3nw* scope, tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w* fn);
...
{	result = (tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w*)0;
	...
	result = initIdentIter_9bOoZ7latEpanbVkjFO7xFQ((&it), (*scope).symbols, (*fn).name);
	{
		while (1) {
				...
				{
					{
						...
						T15_[1] = dollar__aQsiZUvE4SFfnWyKx1JgKA_2((*(*c).graph).config, (*result).info);
			...
			LA5_: ;
			result = nextIdentIter_9bSCoSykDuXHhkzoBXiof6Q((&it), (*scope).symbols);
		} LA2: ;
	}
	}BeforeRet_: ;
	return result;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w*, searchForProc_WIQjdZgnZBgByteqPM0pPw)(tyObject_TContext_C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TScope_1cQRXW6aAknk7ywAwjH3nw* scope, tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w* fn) {
	tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w* result;
	result = (tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w*)0;
	result = searchForProcNew_WIQjdZgnZBgByteqPM0pPw_2(c, scope, fn);
	return result;
}
