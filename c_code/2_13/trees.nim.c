...
static N_INLINE(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*, pop_jgHhw9bd9a38Xqyz0a3Aayngsystem)(tySequence_ehmV9bTklH2Gt9cXHV9c0HLeQ** s) {
	...
	result = (*s)->data[L];
	unsureAsgnRef((void**) (&(*s)), (tySequence_ehmV9bTklH2Gt9cXHV9c0HLeQ*) setLengthSeqV2(&((*s))->Sup, (&NTI_ehmV9bTklH2Gt9cXHV9c0HLeQ_), ((NI)chckRange(L, ((NI) 0), ((NI) 2147483647)))));
	return result;
}
...
{	result = (NIM_BOOL)0;
	...
	case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 44):
	{
		...
		LA14_: ;
		{
			...
			{
				if (!((*t).kind == ((tyEnum_TTypeKind_9a3YiReNVD0IJHWFKgXRe9ag) 22) || (*t).kind == ((tyEnum_TTypeKind_9a3YiReNVD0IJHWFKgXRe9ag) 21))) goto LA19_;
				result = NIM_FALSE;
				goto BeforeRet_;
			}
			LA19_: ;
