...
N_NIMCALL(NI, rawparseint_85531)(NimStringDesc* s, NI64* b, NI start) {
	...
	nimln(200, "parseutils.nim");
	{
		...
		while (1) {
			...
			TMP1133 = subInt64((NI64)(TMP1131), ((NI64) ((NI64)(TMP1132))));
			(*b) = (NI64)(TMP1133);
...
N_NIMCALL(NI, npuParseBiggestFloat)(NimStringDesc* s, NF* number, NI start) {
	...
	nimln(261, "parseutils.nim");
	{
		...
		nimln(262, "parseutils.nim");
		{
			...
			LOC16 = ((NU8)(s->data[(NI64)(TMP1841)]) == (NU8)(65));
			if (LOC16) goto LA17;
			nimln(262, "parseutils.nim");
			nimln(262, "parseutils.nim");
			TMP1842 = addInt(i, 1);
			if ((NU)((NI64)(TMP1842)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC16 = ((NU8)(s->data[(NI64)(TMP1842)]) == (NU8)(97));
			LA17: ;
			if (!LOC16) goto LA18;
			nimln(263, "parseutils.nim");
			{
				...
				LOC22 = ((NU8)(s->data[(NI64)(TMP1843)]) == (NU8)(78));
				if (LOC22) goto LA23;
				nimln(263, "parseutils.nim");
				nimln(263, "parseutils.nim");
				TMP1844 = addInt(i, 2);
				if ((NU)((NI64)(TMP1844)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC22 = ((NU8)(s->data[(NI64)(TMP1844)]) == (NU8)(110));
				LA23: ;
				if (!LOC22) goto LA24;
				nimln(264, "parseutils.nim");
				{
					...
					if (!!((((NU8)(s->data[(NI64)(TMP1845)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI64)(TMP1845)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI64)(TMP1845)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI64)(TMP1845)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI64)(TMP1845)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI64)(TMP1845)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI64)(TMP1845)])) == ((NU8)(95))))) goto LA28;
					...
					nimln(266, "parseutils.nim");
					TMP1846 = addInt(i, 3);
					TMP1847 = subInt((NI64)(TMP1846), start);
					result = (NI64)(TMP1847);
					goto BeforeRet;
				}
				LA28: ;
	...
	nimln(268, "parseutils.nim");
	{
		...
		nimln(269, "parseutils.nim");
		{
			...
			LOC38 = ((NU8)(s->data[(NI64)(TMP1848)]) == (NU8)(78));
			if (LOC38) goto LA39;
			nimln(269, "parseutils.nim");
			nimln(269, "parseutils.nim");
			TMP1849 = addInt(i, 1);
			if ((NU)((NI64)(TMP1849)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC38 = ((NU8)(s->data[(NI64)(TMP1849)]) == (NU8)(110));
			LA39: ;
			if (!LOC38) goto LA40;
			nimln(270, "parseutils.nim");
			{
				...
				LOC44 = ((NU8)(s->data[(NI64)(TMP1850)]) == (NU8)(70));
				if (LOC44) goto LA45;
				nimln(270, "parseutils.nim");
				nimln(270, "parseutils.nim");
				TMP1851 = addInt(i, 2);
				if ((NU)((NI64)(TMP1851)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC44 = ((NU8)(s->data[(NI64)(TMP1851)]) == (NU8)(102));
				LA45: ;
				if (!LOC44) goto LA46;
				nimln(271, "parseutils.nim");
				{
					...
					if (!!((((NU8)(s->data[(NI64)(TMP1852)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI64)(TMP1852)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI64)(TMP1852)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI64)(TMP1852)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI64)(TMP1852)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI64)(TMP1852)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI64)(TMP1852)])) == ((NU8)(95))))) goto LA50;
	...
	nimln(282, "parseutils.nim");
	{
		...
		while (1) {
			...
			(*number) = ((NF)(((NF)((*number)) * (NF)(1.0000000000000000e+001))) + (NF)(((double) (((NI) ((NI64)(TMP1856)))))));
	...
	nimln(296, "parseutils.nim");
	{
		...
		while (1) {
			...
			nimln(306, "parseutils.nim");
			if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
			TMP1858 = addInt((NI64)(TMP1857), ((NI) (((NU8)(s->data[i])))));
			TMP1859 = subInt((NI64)(TMP1858), 48);
			exponent = (NI64)(TMP1859);
