...
STRING_LITERAL(TMP1372, "overflow", 8);
	...
	LA1: ;
	{
		...
		(*b) = IL64(0);
		{
			while (1) {
				...
				TMP1070 = mulInt64((*b), IL64(10));
				TMP1071 = subInt(((NI) (((NU8)(s->data[i])))), 48);
				TMP1072 = subInt64((NI64)(TMP1070), ((NI64) ((NI64)(TMP1071))));
				(*b) = (NI64)(TMP1072);
				i = addInt(i, 1);
				{
					while (1) {
		...
		TMP1073 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP1073);
		TMP1074 = subInt(i, start);
		result = (NI64)(TMP1074);
	}
	LA10: ;
	return result;
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	result = npuParseBiggestInt(s, (&res), start);
	{
		...
		LOC9 = 0;
		LOC9 = (*e_93169).Sup.Sup.message; (*e_93169).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1372));
