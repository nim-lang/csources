...
N_NIMCALL(void, addescaped_410021_678639433)(NimStringDesc** result0, NimStringDesc* s0);
...
N_NIMCALL(void, addescaped_410021_678639433)(NimStringDesc** result0, NimStringDesc* s0) {
	{
		NIM_CHAR c_410027_678639433;
		NI i_410031_678639433;
		NI L_410033_678639433;
		c_410027_678639433 = (NIM_CHAR)0;
		i_410031_678639433 = ((NI) 0);
		L_410033_678639433 = (s0 ? s0->Sup.len : 0);
		{
			while (1) {
				if (!(i_410031_678639433 < L_410033_678639433)) goto LA3;
				c_410027_678639433 = s0->data[i_410031_678639433];
				switch (((NU8)(c_410027_678639433))) {
				case 60:
				{
...
appendString((*result0), ((NimStringDesc*) &T678639433_7));
				...
				default:
				{
					(*result0) = addChar((*result0), c_410027_678639433);
				}
				break;
				}
				i_410031_678639433 += ((NI) 1);
			} LA3: ;
		}
	}
}
...
N_NIMCALL(NimStringDesc*, escape_410034_678639433)(NimStringDesc* s0) {
	...
	addescaped_410021_678639433((&result0), s0);
	return result0;
}
