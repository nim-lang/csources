...
N_NIMCALL(tnode225819*, extractrange_261419)(NU8 k, tnode225819* n, NI a, NI b) {
	...
	result = newnodei_228007(k, (*n).Info, (NI64)((NI64)(b - a) + 1));
	{
		...
		i_261436 = 0;
		HEX3Atmp_261466 = 0;
		HEX3Atmp_261466 = (NI64)(b - a);
		res_261469 = 0;
		{
			while (1) {
				if (!(res_261469 <= HEX3Atmp_261466)) goto LA3;
				i_261436 = res_261469;
				asgnRefNoCycle((void**) &(*result).kindU.S6.Sons->data[i_261436], (*n).kindU.S6.Sons->data[(NI64)(i_261436 + a)]);
				res_261469 += 1;
			} LA3: ;
		}
	}
