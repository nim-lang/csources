...
N_NIMCALL(NI, nodetablerawget_287509)(tnodetable225879 t, NI k, tnode225819* key);
N_NIMCALL(NIM_BOOL, treesequivalent_287243)(tnode225819* a, tnode225819* b);
...
N_NIMCALL(void, nodetablerawinsert_287562)(tnodepairseq225877** data, NI k, tnode225819* key, NI val);
	...
	{
		{
			...
			HEX3Atmp_287223 = (NI64)(LOC26 - 1);
			res_287226 = 0;
			{
				while (1) {
					NI LOC29;
					if (!(res_287226 <= HEX3Atmp_287223)) goto LA28;
					i_287202 = res_287226;
					LOC29 = 0;
		...
		{
			{
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					HEX3Atmp_287489 = (NI64)(LOC26 - 1);
					res_287492 = 0;
					{
						while (1) {
							if (!(res_287492 <= HEX3Atmp_287489)) goto LA28;
							i_287459 = res_287492;
							{
								NIM_BOOL LOC31;
								LOC31 = 0;
								LOC31 = treesequivalent_287243((*a).kindU.S6.Sons->data[i_287459], (*b).kindU.S6.Sons->data[i_287459]);
								if (!!(LOC31)) goto LA32;
								goto BeforeRet;
							}
							LA32: ;
	...
	h = (NI)(k & (t.Data->Sup.len-1));
	{
		while (1) {
			if (!!((t.Data->data[h].Key == NIM_NIL))) goto LA2;
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = treesequivalent_287243(t.Data->data[h].Key, key);
				LA6: ;
				if (!LOC5) goto LA7;
				result = h;
				goto BeforeRet;
...
N_NIMCALL(NI, nodetabletestorset_288121)(tnodetable225879* t, tnode225819* key, NI val) {
	...
	index = nodetablerawget_287509((*t), k, key);
	{
		if (!(0 <= index)) goto LA3;
	...
	{
		{
			...
			if (!LOC8) goto LA9;
			n = (tnodepairseq225877*) newSeq((&NTI225877), (NI64)((*t).Data->Sup.len * 2));
			{
				NI i_288251;
				NI HEX3Atmp_288301;
				NI res_288304;
				...
				res_288304 = 0;
				{
					while (1) {
						...
						i_288251 = res_288304;
						{
							...
							nodetablerawinsert_287562(&n, (*t).Data->data[i_288251].H, (*t).Data->data[i_288251].Key, (*t).Data->data[i_288251].Val);
						}
						LA16: ;
						res_288304 += 1;
					} LA13: ;
		...
		LA9: ;
		nodetablerawinsert_287562(&(*t).Data, k, key, val);
		result = val;
		(*t).Counter += 1;
	}
	LA1: ;
