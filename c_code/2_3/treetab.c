...
N_NIMCALL(NIM_BOOL, treesequivalent_252224)(tnode192813* a, tnode192813* b);
static N_INLINE(NIM_BOOL, eqStrings)(NimStringDesc* a, NimStringDesc* b);
N_NIMCALL(NIM_BOOL, sametypeornil_233151)(ttype192847* a, ttype192847* b, NU8 flags);
N_NIMCALL(NI, nodetablerawget_252476)(tnodetable192871 t, NI k, tnode192813* key);
static N_INLINE(NI, nexttry_201192)(NI h, NI maxhash);
N_NIMCALL(NI, mulInt)(NI a, NI b);
N_NIMCALL(NI, nodetableget_252504)(tnodetable192871 t, tnode192813* key);
N_NIMCALL(void, nodetablerawinsert_252515)(tnodepairseq192869** data, NI k, tnode192813* key, NI val);
...
N_NIMCALL(NI, hashtree_252022)(tnode192813* n) {
	...
	default:
	{
		...
		while (1) {
			NI LOC27;
			nimln(1452, "system.nim");
			if (!(res_252219 <= HEX3Atmp_252217)) goto LA26;
			nimln(1451, "system.nim");
			i_252197 = res_252219;
			...
			res_252219 = addInt(res_252219, 1);
		} LA26: ;
	}
	break;
	}
	...
	LA3: ;
	{
		...
		default:
		{
			nimln(49, "treetab.nim");
			{
				...
				HEX3Atmp_252469 = (NI64)(TMP3213);
				nimln(1451, "system.nim");
				res_252471 = 0;
				nimln(1452, "system.nim");
				while (1) {
					nimln(1452, "system.nim");
					if (!(res_252471 <= HEX3Atmp_252469)) goto LA26;
					nimln(1451, "system.nim");
					i_252440 = res_252471;
					nimln(51, "treetab.nim");
					{
						...
						if ((NU)(i_252440) >= (NU)((*a).kindU.S6.Sons->Sup.len)) raiseIndexError();
						if (((TMP3210[(*b).Kind/8] &(1<<((*b).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3211));
						if ((NU)(i_252440) >= (NU)((*b).kindU.S6.Sons->Sup.len)) raiseIndexError();
						LOC29 = 0;
						LOC29 = treesequivalent_252224((*a).kindU.S6.Sons->data[i_252440], (*b).kindU.S6.Sons->data[i_252440]);
						if (!!(LOC29)) goto LA30;
						nimln(51, "treetab.nim");
						goto BeforeRet;
					}
					LA30: ;
					nimln(1454, "system.nim");
					res_252471 = addInt(res_252471, 1);
				} LA26: ;
...
static N_INLINE(NI, nexttry_201192)(NI h, NI maxhash) {
	...
	nimln(465, "astalgo.nim");
	TMP3214 = mulInt(5, h);
	TMP3215 = addInt((NI64)(TMP3214), 1);
	result = (NI)((NI64)(TMP3215) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(NI, nodetablerawget_252476)(tnodetable192871 t, NI k, tnode192813* key) {
	...
	while (1) {
		...
		nimln(58, "treetab.nim");
		{
			...
			nimln(58, "treetab.nim");
			if ((NU)(h) >= (NU)(t.Data->Sup.len)) raiseIndexError();
			LOC4 = treesequivalent_252224(t.Data->data[h].Key, key);
			LA5: ;
			if (!LOC4) goto LA6;
...
N_NIMCALL(NI, nodetableget_252504)(tnodetable192871 t, tnode192813* key) {
	...
	index = nodetablerawget_252476(t, LOC1, key);
...
N_NIMCALL(void, nodetableput_252622)(tnodetable192871* t, tnode192813* key, NI val) {
	...
	index = nodetablerawget_252476((*t), k, key);
	...
	LA3: ;
	{
		nimln(85, "treetab.nim");
		{
			...
			n = (tnodepairseq192869*) newSeq((&NTI192869), (NI64)(TMP3218));
			i_252868 = 0;
			HEX3Atmp_252921 = 0;
			...
			while (1) {
				...
				nimln(88, "treetab.nim");
				{
					...
					if ((NU)(i_252868) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
					if ((NU)(i_252868) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
					nodetablerawinsert_252515(&n, (*t).Data->data[i_252868].H, (*t).Data->data[i_252868].Key, (*t).Data->data[i_252868].Val);
				}
				LA18: ;
				nimln(1454, "system.nim");
		...
		nodetablerawinsert_252515(&(*t).Data, k, key, val);
...
N_NIMCALL(NI, nodetabletestorset_252928)(tnodetable192871* t, tnode192813* key, NI val) {
	...
	LA3: ;
	{
		nimln(102, "treetab.nim");
		{
			...
			n = (tnodepairseq192869*) newSeq((&NTI192869), (NI64)(TMP3219));
			i_253068 = 0;
			HEX3Atmp_253121 = 0;
			...
			while (1) {
				...
				nimln(105, "treetab.nim");
				{
					...
					if ((NU)(i_253068) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
					if ((NU)(i_253068) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
					nodetablerawinsert_252515(&n, (*t).Data->data[i_253068].H, (*t).Data->data[i_253068].Key, (*t).Data->data[i_253068].Val);
				}
				LA18: ;
				nimln(1454, "system.nim");
