...
typedef struct TY127203 TY127203;
...
typedef struct tstartprocessdata127715 tstartprocessdata127715;
...
typedef int TY127720[2];
struct  tstartprocessdata127715  {
NCSTRING Syscommand;
NCSTRING* Sysargs;
NCSTRING* Sysenv;
NCSTRING Workingdir;
...
struct TY127203 {
  TGenericSeq Sup;
  tprocess126203* data[SEQ_DECL_SIZE];
};
...
N_NIMCALL(NI, nospprocessID)(tprocess126203* p);
N_NIMCALL(int, nospinputHandle)(tprocess126203* p);
N_NIMCALL(int, nospoutputHandle)(tprocess126203* p);
N_NIMCALL(int, nosperrorHandle)(tprocess126203* p);
...
N_NIMCALL(NCSTRING*, envtocstringarray_127604)(tstringtable120810* t);
N_NOCONV(void*, alloc0_4616)(NI size);
N_NIMCALL(NI, nstlen)(tstringtable120810* t);
N_NIMCALL(NI, mulInt)(NI a, NI b);
N_NOCONV(void*, alloc_4601)(NI size);
N_NIMCALL(NCSTRING*, envtocstringarray_127641)(void);
...
N_NIMCALL(pid_t, startprocessauxspawn_127801)(tstartprocessdata127715* data);
...
N_NIMCALL(pid_t, startprocessauxfork_127804)(tstartprocessdata127715* data);
static N_INLINE(void, pushSafePoint)(TSafePoint* s);
N_CDECL(void, startprocessafterfork_127807)(tstartprocessdata127715* data);
N_NIMCALL(void, startprocessfail_128623)(tstartprocessdata127715* data);
N_NOINLINE(void, nososError)(NimStringDesc* msg);
static N_INLINE(void, popSafePoint)(void);
static N_INLINE(void, setFrame)(TFrame* s);
N_NIMCALL(void, reraiseException)(void);
N_NIMCALL(tprocess126203*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, tstringtable120810* env, NU8 options);
...
N_NIMCALL(void, nospclose)(tprocess126203* p);
N_NIMCALL(void, close_123676)(tstream123629* s);
N_NIMCALL(void, nospsuspend)(tprocess126203* p);
N_NIMCALL(void, nospresume)(tprocess126203* p);
N_NIMCALL(NIM_BOOL, nosprunning)(tprocess126203* p);
N_NIMCALL(void, nospterminate)(tprocess126203* p);
N_NIMCALL(NI, nospwaitForExit)(tprocess126203* p, NI timeout);
N_NIMCALL(NI, peekexitcode_126496)(tprocess126203* p);
N_NIMCALL(void, createstream_129117)(tstream123629** stream, NI32* handle, NU8 filemode);
...
N_NIMCALL(tstream123629*, nosperrorStream)(tprocess126203* p);
N_NIMCALL(NI, nospexecCmd)(NimStringDesc* command);
N_NIMCALL(void, createfdset_129402)(fd_set* fd, TY127203* s, NI* m);
N_NIMCALL(void, pruneprocessset_129634)(TY127203** s, fd_set* fd);
N_NIMCALL(TGenericSeq*, setLengthSeq)(TGenericSeq* seq, NI elemsize, NI newlen);
N_NIMCALL(NI, select_127521)(TY127203** readfds, NI timeout);
static N_INLINE(NI, chckRange)(NI i, NI a, NI b);
N_NOINLINE(void, raiseRangeError)(NI64 val);
N_NIMCALL(void, execcmdex_129802)(NimStringDesc* command, NU8 options, TY129808* Result);
static NIM_CONST TY121387 TMP330 = {
...
STRING_LITERAL(TMP332, "\"", 1);
STRING_LITERAL(TMP333, "\\\"", 2);
STRING_LITERAL(TMP334, "len(a) == L string modified while iterating over it", 51);
NIM_CONST TY121387 safeunixchars_126243 = {
0x00, 0x00, 0x00, 0x00, 0x20, 0xE8, 0xFF, 0x27,
0xFF, 0xFF, 0xFF, 0x87, 0xFE, 0xFF, 0xFF, 0x07,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP335, "\'\'", 2);
static NIM_CONST TY121387 TMP337 = {
0x00, 0x00, 0x00, 0x00, 0x20, 0xE8, 0xFF, 0x27,
0xFF, 0xFF, 0xFF, 0x87, 0xFE, 0xFF, 0xFF, 0x07,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP338, "\'", 1);
STRING_LITERAL(TMP349, "\'\"\'\"\'", 5);
STRING_LITERAL(TMP350, "n > 0 ", 6);
STRING_LITERAL(TMP362, "", 0);
STRING_LITERAL(TMP363, "\012", 1);
STRING_LITERAL(TMP366, "=", 1);
STRING_LITERAL(TMP380, "/bin/sh", 7);
STRING_LITERAL(TMP381, "-c", 2);
STRING_LITERAL(TMP382, "args.len == 0 `args` has to be empty when using poEvalCommand.", 62);
STRING_LITERAL(TMP385, " ", 1);
STRING_LITERAL(TMP388, "(len|len|len|len|len)(a) (==|==|==|==|==|==|==|==|==|==|==|==|="
"=|==|==|==|==|==|==|==)\015\012    L seq modified while iterating over"
" it", 130);
NIM_CONST TY129808 TMP393 = {((NimStringDesc*) &TMP362),
-1}
;
extern TFrame* frameptr_13038;
extern TNimType NTI2409; /* TObject */
TNimType NTI126203; /* TProcess */
...
TNimType NTI126205; /* PProcess */
TNimType NTI127203; /* seq[PProcess] */
...
N_NIMCALL(NimStringDesc*, nospquoteShellWindows)(NimStringDesc* s) {
	...
	nimln(60, "osproc.nim");
	backslashbuff = copyString(((NimStringDesc*) &TMP331));
	nimln(61, "osproc.nim");
	{
		if (!needquote) goto LA5;
		nimln(62, "osproc.nim");
		result = resizeString(result, 1);
appendString(result, ((NimStringDesc*) &TMP332));
	}
	LA5: ;
	c_126231 = 0;
	...
	while (1) {
		nimln(2806, "system.nim");
		if (!(i_126233 < l_126235)) goto LA7;
		nimln(2807, "system.nim");
		if ((NU)(i_126233) > (NU)(s->Sup.len)) raiseIndexError();
		c_126231 = s->data[i_126233];
		nimln(65, "osproc.nim");
		{
			nimln(65, "osproc.nim");
			if (!((NU8)(c_126231) == (NU8)(92))) goto LA10;
			nimln(66, "osproc.nim");
			backslashbuff = addChar(backslashbuff, c_126231);
		}
		goto LA8;
		LA10: ;
		{
			nimln(67, "osproc.nim");
			if (!((NU8)(c_126231) == (NU8)(34))) goto LA13;
			nimln(68, "osproc.nim");
...
appendString(result, backslashbuff);
			...
			LA18: ;
			nimln(76, "osproc.nim");
			result = addChar(result, c_126231);
		}
		LA8: ;
		nimln(2808, "system.nim");
		i_126233 = addInt(i_126233, 1);
		nimln(2809, "system.nim");
		{
			nimln(2809, "system.nim");
			nimln(2809, "system.nim");
			nimln(2809, "system.nim");
			if (!!((s->Sup.len == l_126235))) goto LA22;
			nimln(2809, "system.nim");
...
N_NIMCALL(NimStringDesc*, nospquoteShellPosix)(NimStringDesc* s) {
	...
	LA3: ;
	nimln(89, "osproc.nim");
	safe = allcharsinset_89836(s, TMP337);
	nimln(91, "osproc.nim");
	{
		if (!safe) goto LA7;
		nimln(92, "osproc.nim");
	...
	LA7: ;
	{
		...
		nimln(94, "osproc.nim");
		LOC11 = 0;
		LOC11 = nsuReplaceStr(s, ((NimStringDesc*) &TMP338), ((NimStringDesc*) &TMP349));
		LOC10 = rawNewString(LOC11->Sup.len + 2);
appendString(LOC10, ((NimStringDesc*) &TMP338));
...
N_NIMCALL(tprocess126203*, startcmd_126434)(NimStringDesc* command, NU8 options) {
	...
	nimln(155, "osproc.nim");
	result = nospstartProcess(command, ((NimStringDesc*) &TMP331), LOC1, 0, NIM_NIL, (options | 4));
	popFrame();
	return result;
}
...
N_NIMCALL(NI, nospexecProcesses)(NimStringDesc** cmds, NI cmdsLen0, NU8 options_126808, NI n) {
	...
	nimln(276, "osproc.nim");
	{
		...
		if (!!((0 < n))) goto LA3;
		nimln(276, "osproc.nim");
		failedassertimpl_79821(((NimStringDesc*) &TMP350));
	}
	LA3: ;
	nimln(277, "osproc.nim");
	{
		...
		nimln(281, "osproc.nim");
		TMP355 = subInt(m, 1);
		HEX3Atmp_127498 = (NI64)(TMP355);
		nimln(1457, "system.nim");
		res_127500 = 0;
		nimln(1458, "system.nim");
		while (1) {
			nimln(1458, "system.nim");
			if (!(res_127500 <= HEX3Atmp_127498)) goto LA9;
			nimln(1457, "system.nim");
			i_127242 = res_127500;
			nimln(282, "osproc.nim");
			if ((NU)(i_127242) >= (NU)(q->Sup.len)) raiseIndexError();
			if ((NU)(i_127242) >= (NU)(cmdsLen0)) raiseIndexError();
			asgnRef((void**) &q->data[i_127242], startcmd_126434(cmds[i_127242], options));
			nimln(1460, "system.nim");
			res_127500 = addInt(res_127500, 1);
		} LA9: ;
		...
		while (1) {
			...
			nimln(301, "osproc.nim");
			TMP360 = subInt(n, 1);
			HEX3Atmp_127502 = (NI64)(TMP360);
			nimln(1457, "system.nim");
			res_127504 = 0;
			nimln(1458, "system.nim");
			while (1) {
				nimln(1458, "system.nim");
				if (!(res_127504 <= HEX3Atmp_127502)) goto LA11;
				nimln(1457, "system.nim");
				r_127413 = res_127504;
				nimln(302, "osproc.nim");
				{
					...
					nimln(302, "osproc.nim");
					nimln(302, "osproc.nim");
					if ((NU)(r_127413) >= (NU)(q->Sup.len)) raiseIndexError();
					LOC14 = 0;
					LOC14 = nosprunning(q->data[r_127413]);
					if (!!(LOC14)) goto LA15;
					...
					if ((NU)(r_127413) >= (NU)(q->Sup.len)) raiseIndexError();
					LOC17 = 0;
					LOC17 = nospwaitForExit(q->data[r_127413], -1);
					...
					nimln(305, "osproc.nim");
					{
						...
						nimln(305, "osproc.nim");
						if ((NU)(r_127413) >= (NU)(q->Sup.len)) raiseIndexError();
						if (!!((q->data[r_127413] == NIM_NIL))) goto LA20;
						nimln(305, "osproc.nim");
						if ((NU)(r_127413) >= (NU)(q->Sup.len)) raiseIndexError();
						nospclose(q->data[r_127413]);
					}
					LA20: ;
					nimln(306, "osproc.nim");
					if ((NU)(r_127413) >= (NU)(q->Sup.len)) raiseIndexError();
					if ((NU)(i) >= (NU)(cmdsLen0)) raiseIndexError();
					asgnRef((void**) &q->data[r_127413], startcmd_126434(cmds[i], options));
				...
				LA15: ;
				nimln(1460, "system.nim");
				res_127504 = addInt(res_127504, 1);
			} LA11: ;
		} LA10: ;
		j_127461 = 0;
		HEX3Atmp_127506 = 0;
		...
		while (1) {
			NI LOC27;
			nimln(1458, "system.nim");
			if (!(res_127508 <= HEX3Atmp_127506)) goto LA26;
			nimln(1457, "system.nim");
			j_127461 = res_127508;
			nimln(310, "osproc.nim");
			nimln(310, "osproc.nim");
			nimln(310, "osproc.nim");
			if ((NU)(j_127461) >= (NU)(q->Sup.len)) raiseIndexError();
			LOC27 = 0;
			LOC27 = nospwaitForExit(q->data[j_127461], -1);
			...
			nimln(311, "osproc.nim");
			{
				...
				nimln(311, "osproc.nim");
				if ((NU)(j_127461) >= (NU)(q->Sup.len)) raiseIndexError();
				if (!!((q->data[j_127461] == NIM_NIL))) goto LA30;
				nimln(311, "osproc.nim");
				if ((NU)(j_127461) >= (NU)(q->Sup.len)) raiseIndexError();
				nospclose(q->data[j_127461]);
			}
			LA30: ;
			nimln(1460, "system.nim");
			res_127508 = addInt(res_127508, 1);
		} LA26: ;
	}
	goto LA5;
	LA7: ;
	{
		...
		while (1) {
			...
			NI LOC34;
			nimln(1458, "system.nim");
			if (!(res_127512 <= HEX3Atmp_127510)) goto LA33;
			nimln(1457, "system.nim");
			i_127492 = res_127512;
			nimln(314, "osproc.nim");
			if ((NU)(i_127492) >= (NU)(cmdsLen0)) raiseIndexError();
			p = startcmd_126434(cmds[i_127492], options);
			...
			nospclose(p);
			nimln(1460, "system.nim");
			res_127512 = addInt(res_127512, 1);
		} LA33: ;
	}
	LA5: ;
	popFrame();
...
N_NIMCALL(NimStringDesc*, nospexecProcess)(NimStringDesc* command, NimStringDesc** args, NI argsLen0, tstringtable120810* env, NU8 options) {
	...
	p = nospstartProcess(command, ((NimStringDesc*) &TMP331), args, argsLen0, env, options);
...
N_NIMCALL(NCSTRING*, envtocstringarray_127604)(tstringtable120810* t) {
	...
	void* LOC2;
	NI i;
	NimStringDesc* key_127610;
	NimStringDesc* val_127611;
	NI h_127634;
	NI HEX3Atmp_127636;
	NI res_127638;
	...
	LOC1 = 0;
	LOC1 = nstlen(t);
	TMP364 = addInt(LOC1, 1);
	TMP365 = mulInt((NI64)(TMP364), 8);
	LOC2 = 0;
	LOC2 = alloc0_4616((NI64)(TMP365));
	...
	nimln(40, "strtabs.nim");
	HEX3Atmp_127636 = ((*t).Data->Sup.len-1);
	nimln(1457, "system.nim");
	res_127638 = 0;
	nimln(1458, "system.nim");
	while (1) {
		nimln(1458, "system.nim");
		if (!(res_127638 <= HEX3Atmp_127636)) goto LA3;
		nimln(1457, "system.nim");
		h_127634 = res_127638;
		nimln(41, "strtabs.nim");
		{
			...
			nimln(41, "strtabs.nim");
			nimln(41, "strtabs.nim");
			if ((NU)(h_127634) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			if (!!((*t).Data->data[h_127634].Field0 == 0)) goto LA6;
			nimln(42, "strtabs.nim");
			if ((NU)(h_127634) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			key_127610 = (*t).Data->data[h_127634].Field0;
			nimln(42, "strtabs.nim");
			if ((NU)(h_127634) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			val_127611 = (*t).Data->data[h_127634].Field1;
			nimln(591, "osproc.nim");
			nimln(591, "osproc.nim");
			LOC8 = 0;
			LOC8 = rawNewString(key_127610->Sup.len + val_127611->Sup.len + 1);
appendString(LOC8, key_127610);
appendString(LOC8, ((NimStringDesc*) &TMP366));
appendString(LOC8, val_127611);
			x = LOC8;
			...
			nimln(592, "osproc.nim");
			nimln(592, "osproc.nim");
			TMP367 = addInt(x->Sup.len, 1);
			LOC9 = 0;
			LOC9 = alloc_4601((NI64)(TMP367));
			...
			memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI64)(TMP368));
			nimln(594, "osproc.nim");
			i = addInt(i, 1);
		}
		LA6: ;
		nimln(1460, "system.nim");
		res_127638 = addInt(res_127638, 1);
	} LA3: ;
	popFrame();
	return result;
}
...
N_NIMCALL(NCSTRING*, envtocstringarray_127641)(void) {
	NCSTRING* result;
	NI counter;
	NimStringDesc* key_127645;
	NimStringDesc* val_127646;
	NI i_127686;
	NI HEX3Atmp_127688;
	NI res_127690;
	NI TMP371;
	...
	void* LOC2;
	NI i;
	NimStringDesc* key_127665;
	NimStringDesc* val_127666;
	NI i_127702;
	NI HEX3Atmp_127704;
	NI res_127706;
	nimfr("envToCStringArray", "osproc.nim")
	...
	nimln(1181, "os.nim");
	nimln(1181, "os.nim");
	HEX3Atmp_127688 = (environment_110806->Sup.len-1);
	nimln(1457, "system.nim");
	res_127690 = 0;
	nimln(1458, "system.nim");
	while (1) {
		...
		NI TMP370;
		nimln(1458, "system.nim");
		if (!(res_127690 <= HEX3Atmp_127688)) goto LA1;
		nimln(1457, "system.nim");
		i_127686 = res_127690;
		nimln(1182, "os.nim");
		if ((NU)(i_127686) >= (NU)(environment_110806->Sup.len)) raiseIndexError();
		p_127692 = nsuFindChar(environment_110806->data[i_127686], 61, 0);
		nimln(1183, "os.nim");
		nimln(1183, "os.nim");
		if ((NU)(i_127686) >= (NU)(environment_110806->Sup.len)) raiseIndexError();
		nimln(1183, "os.nim");
		TMP369 = subInt(p_127692, 1);
		key_127645 = copyStrLast(environment_110806->data[i_127686], 0, (NI64)(TMP369));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_127686) >= (NU)(environment_110806->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP370 = addInt(p_127692, 1);
		val_127646 = copyStr(environment_110806->data[i_127686], (NI64)(TMP370));
		nimln(598, "osproc.nim");
		counter = addInt(counter, 1);
		nimln(1460, "system.nim");
		res_127690 = addInt(res_127690, 1);
	} LA1: ;
	nimln(599, "osproc.nim");
	nimln(599, "osproc.nim");
	nimln(599, "osproc.nim");
	nimln(599, "osproc.nim");
	TMP371 = addInt(counter, 1);
	TMP372 = mulInt((NI64)(TMP371), 8);
	LOC2 = 0;
	LOC2 = alloc0_4616((NI64)(TMP372));
	result = ((NCSTRING*) (LOC2));
	...
	nimln(1181, "os.nim");
	nimln(1181, "os.nim");
	HEX3Atmp_127704 = (environment_110806->Sup.len-1);
	nimln(1457, "system.nim");
	res_127706 = 0;
	nimln(1458, "system.nim");
	while (1) {
		...
		NI TMP376;
		nimln(1458, "system.nim");
		if (!(res_127706 <= HEX3Atmp_127704)) goto LA3;
		nimln(1457, "system.nim");
		i_127702 = res_127706;
		nimln(1182, "os.nim");
		if ((NU)(i_127702) >= (NU)(environment_110806->Sup.len)) raiseIndexError();
		p_127708 = nsuFindChar(environment_110806->data[i_127702], 61, 0);
		nimln(1183, "os.nim");
		nimln(1183, "os.nim");
		if ((NU)(i_127702) >= (NU)(environment_110806->Sup.len)) raiseIndexError();
		nimln(1183, "os.nim");
		TMP373 = subInt(p_127708, 1);
		key_127665 = copyStrLast(environment_110806->data[i_127702], 0, (NI64)(TMP373));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_127702) >= (NU)(environment_110806->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP374 = addInt(p_127708, 1);
		val_127666 = copyStr(environment_110806->data[i_127702], (NI64)(TMP374));
		nimln(602, "osproc.nim");
		nimln(602, "osproc.nim");
		LOC4 = 0;
		LOC4 = rawNewString(key_127665->Sup.len + val_127666->Sup.len + 1);
appendString(LOC4, key_127665);
appendString(LOC4, ((NimStringDesc*) &TMP366));
appendString(LOC4, val_127666);
		x = LOC4;
		...
		nimln(603, "osproc.nim");
		nimln(603, "osproc.nim");
		TMP375 = addInt(x->Sup.len, 1);
		LOC5 = 0;
		LOC5 = alloc_4601((NI64)(TMP375));
		...
		memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI64)(TMP376));
		nimln(605, "osproc.nim");
		i = addInt(i, 1);
		nimln(1460, "system.nim");
		res_127706 = addInt(res_127706, 1);
	} LA3: ;
	popFrame();
	return result;
}
...
N_NIMCALL(pid_t, startprocessauxfork_127804)(tstartprocessdata127715* data) {
	...
	pushSafePoint(&TMP379);
	TMP379.status = setjmp(TMP379.context);
	if (TMP379.status == 0) {
		pid_t volatile pid;
		tstartprocessdata127715 volatile datacopy;
		int LOC12;
		int volatile error;
		...
		nimln(778, "osproc.nim");
		{
			...
			startprocessafterfork_127807(&datacopy);
	...
	if (TMP379.status != 0) reraiseException();
	BeforeRet: ;
	popFrame();
	return result;
}
...
N_NIMCALL(tprocess126203*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, tstringtable120810* env, NU8 options) {
	...
	result = (tprocess126203*) newObj((&NTI126205), sizeof(tprocess126203));
	(*result).Sup.m_type = (&NTI126203);
	...
	nimln(643, "osproc.nim");
	{
		...
		nimln(646, "osproc.nim");
		{
			...
			nimln(646, "osproc.nim");
			failedassertimpl_79821(((NimStringDesc*) &TMP382));
		}
		LA27: ;
	}
	goto LA17;
	LA19: ;
	{
		...
		while (1) {
			...
			nimln(1531, "system.nim");
			nimln(1531, "system.nim");
			if (!(i_128287 < argsLen0)) goto LA32;
			nimln(1532, "system.nim");
			if ((NU)(i_128287) >= (NU)(argsLen0)) raiseIndexError();
			arg_128037 = args[i_128287];
			nimln(651, "osproc.nim");
			sysargsraw = (TY10665*) incrSeq(&(sysargsraw)->Sup, sizeof(NimStringDesc*));
			LOC33 = 0;
			LOC33 = sysargsraw->data[sysargsraw->Sup.len-1]; sysargsraw->data[sysargsraw->Sup.len-1] = copyStringRC1(arg_128037);
			if (LOC33) nimGCunrefNoCycle(LOC33);
			nimln(1533, "system.nim");
			i_128287 = addInt(i_128287, 1);
		} LA32: ;
	}
	LA17: ;
	pid = 0;
	...
	pushSafePoint(&TMP383);
	TMP383.status = setjmp(TMP383.context);
	if (TMP383.status == 0) {
		...
		nimln(658, "osproc.nim");
		{
			...
			sysenv = envtocstringarray_127641();
		}
		goto LA35;
		LA37: ;
		{
			nimln(661, "osproc.nim");
			sysenv = envtocstringarray_127604(env);
		}
		LA35: ;
		...
		if (TMP384.status == 0) {
			tstartprocessdata127715 volatile data;
			...
			pid = startprocessauxfork_127804(&data);
			nimln(685, "osproc.nim");
			{
				...
				nimln(686, "osproc.nim");
				LOC45 = 0;
				LOC45 = nsuJoinSep(args, argsLen0, ((NimStringDesc*) &TMP385));
				printf("%s%s%s\012", (command)->data, (((NimStringDesc*) &TMP385))->data, (LOC45)->data);
			}
			LA43: ;
	...
	if (TMP383.status != 0) reraiseException();
	popFrame();
	return result;
}
...
N_NIMCALL(tstream123629*, nospinputStream)(tprocess126203* p) {
	...
	nimln(892, "osproc.nim");
	{
		...
		createstream_129117(&(*p).Instream, &(*p).Inhandle, ((NU8) 1));
	}
	LA3: ;
...
N_NIMCALL(tstream123629*, nospoutputStream)(tprocess126203* p) {
	...
	nimln(897, "osproc.nim");
	{
		...
		createstream_129117(&(*p).Outstream, &(*p).Outhandle, ((NU8) 0));
	}
	LA3: ;
...
N_NIMCALL(tstream123629*, nosperrorStream)(tprocess126203* p) {
	...
	nimln(902, "osproc.nim");
	{
		...
		createstream_129117(&(*p).Errstream, &(*p).Errhandle, ((NU8) 0));
	}
	LA3: ;
...
N_NIMCALL(void, createfdset_129402)(fd_set* fd, TY127203* s, NI* m) {
	...
	while (1) {
		nimln(2797, "system.nim");
		if (!(i_129629 < l_129631)) goto LA1;
		nimln(2798, "system.nim");
		if ((NU)(i_129629) >= (NU)(s->Sup.len)) raiseIndexError();
		i_129614 = s->data[i_129629];
		nimln(917, "osproc.nim");
		nimln(917, "osproc.nim");
		(*m) = (((*m) >= ((NI) ((*i_129614).Outhandle))) ? (*m) : ((NI) ((*i_129614).Outhandle)));
		nimln(918, "osproc.nim");
		FD_SET((*i_129614).Outhandle, fd);
		nimln(2799, "system.nim");
		i_129629 = addInt(i_129629, 1);
		nimln(2800, "system.nim");
		{
			nimln(2800, "system.nim");
			nimln(2800, "system.nim");
			nimln(2800, "system.nim");
			if (!!((s->Sup.len == l_129631))) goto LA4;
			nimln(2800, "system.nim");
			failedassertimpl_79821(((NimStringDesc*) &TMP388));
		}
		LA4: ;
	} LA1: ;
	popFrame();
...
N_NIMCALL(void, pruneprocessset_129634)(TY127203** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(924, "osproc.nim");
		{
			...
			nimln(925, "osproc.nim");
			TMP389 = subInt(l, 1);
			if ((NU)((NI64)(TMP389)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRef((void**) &(*s)->data[i], (*s)->data[(NI64)(TMP389)]);
	...
	(*s) = (TY127203*) setLengthSeq(&((*s))->Sup, sizeof(tprocess126203*), l);
	popFrame();
}
...
N_NIMCALL(NI, select_127521)(TY127203** readfds, NI timeout) {
	...
	nimln(934, "osproc.nim");
	TMP390 = mulInt(timeout, 1000);
	tv.tv_usec = (NI64)(TMP390);
	memset((void*)&rd, 0, sizeof(rd));
	nimln(937, "osproc.nim");
	m = 0;
	nimln(938, "osproc.nim");
	createfdset_129402(&rd, (*readfds), &m);
	nimln(940, "osproc.nim");
	{
		...
		TMP391 = addInt(m, 1);
		LOC5 = 0;
		LOC5 = select(((int)chckRange((NI64)(TMP391), ((int) (-2147483647 -1)), ((int) 2147483647))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		TMP392 = addInt(m, 1);
		LOC7 = 0;
		LOC7 = select(((int)chckRange((NI64)(TMP392), ((int) (-2147483647 -1)), ((int) 2147483647))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
	nimln(945, "osproc.nim");
	pruneprocessset_129634(readfds, &rd);
	popFrame();
	return result;
}
...
N_NIMCALL(void, execcmdex_129802)(NimStringDesc* command, NU8 options, TY129808* Result) {
	...
	p = startcmd_126434(command, options);
	nimln(955, "osproc.nim");
	outp = nospoutputStream(p);
	nimln(956, "osproc.nim");
	unsureAsgnRef((void**) &(*Result).Field0, copyString(TMP393.Field0));
	(*Result).Field1 = TMP393.Field1;
...
appendString((*Result).Field0, ((NimStringDesc*) &TMP363));
		}
		goto LA2;
		LA5: ;
		{
			nimln(963, "osproc.nim");
			(*Result).Field1 = peekexitcode_126496(p);
...
static TNimNode* TMP351[8];
static TNimNode TMP313[9];
NTI126203.size = sizeof(tprocess126203);
NTI126203.kind = 17;
NTI126203.base = (&NTI2409);
TMP351[0] = &TMP313[1];
TMP313[1].kind = 1;
TMP313[1].offset = offsetof(tprocess126203, Inhandle);
TMP313[1].typ = (&NTI10008);
TMP313[1].name = "inHandle";
TMP351[1] = &TMP313[2];
TMP313[2].kind = 1;
TMP313[2].offset = offsetof(tprocess126203, Outhandle);
TMP313[2].typ = (&NTI10008);
TMP313[2].name = "outHandle";
TMP351[2] = &TMP313[3];
TMP313[3].kind = 1;
TMP313[3].offset = offsetof(tprocess126203, Errhandle);
TMP313[3].typ = (&NTI10008);
TMP313[3].name = "errHandle";
TMP351[3] = &TMP313[4];
TMP313[4].kind = 1;
TMP313[4].offset = offsetof(tprocess126203, Instream);
TMP313[4].typ = (&NTI123627);
TMP313[4].name = "inStream";
TMP351[4] = &TMP313[5];
TMP313[5].kind = 1;
TMP313[5].offset = offsetof(tprocess126203, Outstream);
TMP313[5].typ = (&NTI123627);
TMP313[5].name = "outStream";
TMP351[5] = &TMP313[6];
TMP313[6].kind = 1;
TMP313[6].offset = offsetof(tprocess126203, Errstream);
TMP313[6].typ = (&NTI123627);
TMP313[6].name = "errStream";
TMP351[6] = &TMP313[7];
TMP313[7].kind = 1;
TMP313[7].offset = offsetof(tprocess126203, Id);
TMP313[7].typ = (&NTI97457);
TMP313[7].name = "id";
TMP351[7] = &TMP313[8];
TMP313[8].kind = 1;
TMP313[8].offset = offsetof(tprocess126203, Exitcode);
TMP313[8].typ = (&NTI4409);
TMP313[8].name = "exitCode";
TMP313[0].len = 8; TMP313[0].kind = 2; TMP313[0].sons = &TMP351[0];
NTI126203.node = &TMP313[0];
NTI126205.size = sizeof(tprocess126203*);
NTI126205.kind = 22;
NTI126205.base = (&NTI126203);
NTI126205.marker = TMP353;
NTI127203.size = sizeof(TY127203*);
NTI127203.kind = 24;
NTI127203.base = (&NTI126205);
NTI127203.marker = TMP354;
}
