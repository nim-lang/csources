...
static NIM_CONST TY171865 TMP5589 = {
...
static N_INLINE(ttype171693*, lastson_172034)(ttype171693* n) {
	...
	if ((NU)((NI64)(TMP5595)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP5595)];
	popFrame();
	return result;
}
N_NIMCALL(ttype171693*, getuniquetype_366401)(ttype171693* key) {
	...
	case ((NU8) 55):
	{
		...
		internalerror_138383(((NimStringDesc*) &TMP5593));	}	break;
	case ((NU8) 12):
	{
		nimln(92, "ccgutils.nim");
		internalerror_138383(((NimStringDesc*) &TMP5594));	}	break;
	case ((NU8) 11):
	case ((NU8) 13):
	case ((NU8) 15):
	case ((NU8) 47):
...
N_NIMCALL(trope121007*, makellvmstring_366621)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(170, "ccgutils.nim");
		{
			...
			nimln(170, "ccgutils.nim");
			nimln(170, "ccgutils.nim");
			TMP5599 = addInt(i_366636, 1);
			TMP5600 = modInt((NI64)(TMP5599), 64);
			if (!(((NI) ((NI64)(TMP5600))) == 0)) goto LA4;
