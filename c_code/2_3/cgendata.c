...
static N_INLINE(trope149007**, s_471173)(tcproc471026* p, NU8 s) {
	...
	if ((NU)((NI64)(TMP6225)) >= (NU)((*p).Blocks->Sup.len)) raiseIndexError();
	result = &(*p).Blocks->data[(NI64)(TMP6225)].Sections[(s)- 0];
	popFrame();
	return result;
}
