...
N_NIMCALL(void, fillbuffer_214097)(tbaselexer214024* l) {
	...
	LA3: ;
	LOC5 = 0;
	LOC5 = llstreamread_212256((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI64)((NI64)((*l).Sentinel + 1) * 1));
		...
		s -= 1;
		{
			while (1) {
				...
				LA19: ;
				{
					...
					LOC23 = 0;
					LOC23 = llstreamread_212256((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(oldbuflen * 1));
...
N_NIMCALL(NI, handlecr_214066)(tbaselexer214024* l, NI pos) {
	...
	result = 0;
	(*l).Linenumber += 1;
	result = fillbaselexer_214828(l, pos);
	{
		if (!((NU8)((*l).Buf[result]) == (NU8)(10))) goto LA3;
		result = fillbaselexer_214828(l, result);
	}
	LA3: ;
	return result;
}
...
N_NIMCALL(void, closebaselexer_214045)(tbaselexer214024* l) {
	...
	llstreamclose_212250((*l).Stream);
}
NIM_EXTERNC N_NOINLINE(void, HEX00_nimlexbaseInit)(void) {
}

NIM_EXTERNC N_NOINLINE(void, HEX00_nimlexbaseDatInit)(void) {
static TNimNode* TMP1005[7];
static TNimNode TMP709[8];
NTI214024.size = sizeof(tbaselexer214024);
NTI214024.kind = 17;
NTI214024.base = (&NTI3211);
TMP1005[0] = &TMP709[1];
TMP709[1].kind = 1;
TMP709[1].offset = offsetof(tbaselexer214024, Bufpos);
TMP709[1].typ = (&NTI108);
TMP709[1].name = "bufpos";
TMP1005[1] = &TMP709[2];
TMP709[2].kind = 1;
TMP709[2].offset = offsetof(tbaselexer214024, Buf);
TMP709[2].typ = (&NTI151);
TMP709[2].name = "buf";
TMP1005[2] = &TMP709[3];
TMP709[3].kind = 1;
TMP709[3].offset = offsetof(tbaselexer214024, Buflen);
TMP709[3].typ = (&NTI108);
TMP709[3].name = "bufLen";
TMP1005[3] = &TMP709[4];
TMP709[4].kind = 1;
TMP709[4].offset = offsetof(tbaselexer214024, Stream);
TMP709[4].typ = (&NTI212206);
TMP709[4].name = "stream";
TMP1005[4] = &TMP709[5];
TMP709[5].kind = 1;
TMP709[5].offset = offsetof(tbaselexer214024, Linenumber);
TMP709[5].typ = (&NTI108);
TMP709[5].name = "lineNumber";
TMP1005[5] = &TMP709[6];
TMP709[6].kind = 1;
TMP709[6].offset = offsetof(tbaselexer214024, Sentinel);
TMP709[6].typ = (&NTI108);
TMP709[6].name = "sentinel";
TMP1005[6] = &TMP709[7];
TMP709[7].kind = 1;
TMP709[7].offset = offsetof(tbaselexer214024, Linestart);
TMP709[7].typ = (&NTI108);
TMP709[7].name = "lineStart";
TMP709[0].len = 7; TMP709[0].kind = 2; TMP709[0].sons = &TMP1005[0];
NTI214024.node = &TMP709[0];
}
