...
N_NIMCALL(void, fillbuffer_182072)(tbaselexer182018* l) {
	...
	nimln(82, "nimlexbase.nim");
	{
		...
		nimln(82, "nimlexbase.nim");
		failedassertimpl_80421(((NimStringDesc*) &TMP1656));
	}
	LA3: ;
	...
	nimln(84, "nimlexbase.nim");
	{
		...
		nimln(84, "nimlexbase.nim");
		failedassertimpl_80421(((NimStringDesc*) &TMP1659));
	}
	LA7: ;
	nimln(85, "nimlexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP1660)])), (NI64)(TMP1661));
	}
	LA11: ;
	...
	TMP1663 = mulInt((NI64)(TMP1662), 1);
	LOC13 = 0;
	LOC13 = llstreamread_180242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP1663));
	...
	nimln(91, "nimlexbase.nim");
	{
		...
		if (!(charsread < (NI64)(TMP1666))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI64)(TMP1668);
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				TMP1669 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4631(((void*) ((*l).Buf)), (NI64)(TMP1669));
				...
				nimln(110, "nimlexbase.nim");
				{
					...
					if (!!(((NI64)(TMP1670) == oldbuflen))) goto LA35;
					nimln(110, "nimlexbase.nim");
					failedassertimpl_80421(((NimStringDesc*) &TMP1671));
				}
				LA35: ;
				...
				LOC37 = 0;
				LOC37 = llstreamread_180242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP1672));
				TMP1673 = divInt(LOC37, 1);
				charsread = (NI64)(TMP1673);
...
N_NIMCALL(NI, handlelf_182056)(tbaselexer182018* l, NI pos) {
	...
	nimln(137, "nimlexbase.nim");
	{
		...
		nimln(137, "nimlexbase.nim");
		failedassertimpl_80421(((NimStringDesc*) &TMP1680));
	}
	LA3: ;
...
N_NIMCALL(void, openbaselexer_182027)(tbaselexer182018* l, tllstream180204* inputstream, NI buflen) {
	...
	nimln(147, "nimlexbase.nim");
	{
		...
		nimln(147, "nimlexbase.nim");
		failedassertimpl_80421(((NimStringDesc*) &TMP1681));
	}
	LA3: ;
	...
	LOC5 = 0;
	LOC5 = alloc_4601((NI64)(TMP1682));
	(*l).Buf = ((NCSTRING) (LOC5));
	nimln(151, "nimlexbase.nim");
	nimln(151, "nimlexbase.nim");
	TMP1683 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP1683);
...
N_NIMCALL(NI, getcolnumber_182045)(tbaselexer182018* l, NI pos) {
	...
	if ((NI64)(TMP1684) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP1684));
	popFrame();
	return result;
}
