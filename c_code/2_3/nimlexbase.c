...
N_NIMCALL(void, fillbuffer_176072)(tbaselexer176018* l) {
	...
	nimln(85, "nimlexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP1653)])), (NI64)(TMP1654));
	}
	LA11: ;
	...
	TMP1656 = mulInt((NI64)(TMP1655), 1);
	LOC13 = 0;
	LOC13 = llstreamread_174242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP1656));
	TMP1657 = divInt(LOC13, 1);
	charsread = (NI64)(TMP1657);
	...
	nimln(91, "nimlexbase.nim");
	{
		...
		if (!(charsread < (NI64)(TMP1659))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI64)(TMP1661);
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				TMP1662 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4631(((void*) ((*l).Buf)), (NI64)(TMP1662));
				...
				nimln(110, "nimlexbase.nim");
				{
					...
					if (!!(((NI64)(TMP1663) == oldbuflen))) goto LA35;
					nimln(110, "nimlexbase.nim");
				...
				LOC37 = 0;
				LOC37 = llstreamread_174242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP1665));
				TMP1666 = divInt(LOC37, 1);
				charsread = (NI64)(TMP1666);
...
N_NIMCALL(void, openbaselexer_176027)(tbaselexer176018* l, tllstream174204* inputstream, NI buflen) {
	...
	LOC5 = 0;
	LOC5 = alloc_4601((NI64)(TMP1675));
	(*l).Buf = ((NCSTRING) (LOC5));
	nimln(151, "nimlexbase.nim");
	nimln(151, "nimlexbase.nim");
	TMP1676 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP1676);
...
N_NIMCALL(NI, getcolnumber_176045)(tbaselexer176018* l, NI pos) {
	...
	if ((NI64)(TMP1677) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP1677));
	popFrame();
	return result;
}
