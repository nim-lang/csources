...
STRING_LITERAL(TMP7231, "./", 2);
STRING_LITERAL(TMP7232, "", 0);
STRING_LITERAL(TMP7234, "nimrod.cfg", 10);
STRING_LITERAL(TMP7235, "js", 2);
STRING_LITERAL(TMP7236, "node ", 5);
...
appendString(LOC7, ((NimStringDesc*) &TMP7231));
appendString(LOC7, f);
		result = LOC7;
	}	LA1: ;
	popFrame();
...
N_NIMCALL(void, handlecmdline_423603)(void) {
	...
	{
		nimln(39, "nimrod.nim");
		processcmdline_418207(((NU8) 0), ((NimStringDesc*) &TMP7232));		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP7233;
			TY102259 p;
			NimStringDesc* LOC15;
			...
			nimln(41, "nimrod.nim");
			pushSafePoint(&TMP7233);
			TMP7233.status = setjmp(TMP7233.context);
			if (TMP7233.status == 0) {
				nimln(42, "nimrod.nim");
				...
				if (isObj(getCurrentException()->Sup.m_type, (&NTI1035))) {
					...
					popCurrentException();
				}			}			if (TMP7233.status != 0) reraiseException();
			nimln(45, "nimrod.nim");
			chckNil((void*)&p);
		...
		nimln(50, "nimrod.nim");
		loadconfigs_167607(((NimStringDesc*) &TMP7234));		nimln(53, "nimrod.nim");
		initvars_147647();		nimln(54, "nimrod.nim");
		processcmdline_418207(((NU8) 1), ((NimStringDesc*) &TMP7232));		nimln(55, "nimrod.nim");
		...
		{
			nimln(58, "nimrod.nim");
			if (!(gerrorcounter_137071 == 0)) goto LA25;
			nimln(62, "nimrod.nim");
			{
				...
				nimln(63, "nimrod.nim");
				{
					...
					nimln(65, "nimrod.nim");
					LOC35 = 0;
					LOC35 = nosChangeFileExt(gprojectfull_114199, ((NimStringDesc*) &TMP7235));
					LOC36 = 0;
...
appendString(LOC38, ((NimStringDesc*) &TMP7236));
...
appendString(LOC38, arguments_418205);
				...
				LA33: ;
				{
					...
					LA42: ;
					{
						...
						nimln(74, "nimrod.nim");
						LOC45 = 0;
						LOC45 = nosChangeFileExt(gprojectfull_114199, ((NimStringDesc*) &TMP7232));
...
N_NOINLINE(void, nimrodInit)(void) {
	...
	nimln(706, "system.nim");
	exit(((NI) (((NI8) ((0 < gerrorcounter_137071))))));	popFrame();
}
