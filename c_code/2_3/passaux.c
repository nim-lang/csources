...
NIM_CONST tpass251015 verbosepass_525054 = {verboseopen_525007,
NIM_NIL,
...
NIM_CONST tpass251015 cleanuppass_525204 = {NIM_NIL,
NIM_NIL,
cleanup_525056,
cleanup_525056}
;
...
N_NIMCALL(tnode192813*, verboseprocess_525014)(tpasscontext251003* context, tnode192813* n) {
	...
	nimln(23, "passaux.nim");
	{
		...
		gnotes_168178 |=((NI64)(1)<<(((((NU16) 265)- 230))%(sizeof(NI64)*8)));
...
N_NIMCALL(tnode192813*, cleanup_525056)(tpasscontext251003* c, tnode192813* n) {
	...
	case ((NU8) 114):
	{
		...
		while (1) {
			tnode192813* LOC10;
			nimln(1452, "system.nim");
			if (!(res_525199 <= HEX3Atmp_525197)) goto LA9;
			nimln(1451, "system.nim");
			i_525103 = res_525199;
			nimln(37, "passaux.nim");
			nimln(37, "passaux.nim");
			if (((TMP7606[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7607));
			if ((NU)(i_525103) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC10 = 0;
			LOC10 = cleanup_525056(c, (*n).kindU.S6.Sons->data[i_525103]);
			nimln(1454, "system.nim");
			res_525199 = addInt(res_525199, 1);
		} LA9: ;
	}
	break;
	case ((NU8) 79):
