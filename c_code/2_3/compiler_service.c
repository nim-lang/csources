	...
	while (1) {
		...
		case ((NU8) 3):
		{
			...
			nimln(43, "service.nim");
			{
				...
				key = copyStrLast(p.Key, 0, (NI64)(TMP7041));
				...
				LOC9 = 0;
				LOC9 = copyStr(p.Key, (NI64)(TMP7042));
...
N_NIMCALL(void, serve_418277)(TY418279 action) {
	...
	LA2: ;
	{
		...
		while (1) {
			...
			send_134204(stdoutsocket_137081, ((NimStringDesc*) &TMP7077));			nimln(98, "service.nim");
	...
	LOC1 = 0;
	LOC1 = curcaascmd_418203; curcaascmd_418203 = copyStringRC1(((NimStringDesc*) &TMP7036));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(25, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_418204; lastcaascmd_418204 = copyStringRC1(((NimStringDesc*) &TMP7036));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(28, "service.nim");
	LOC3 = 0;
	LOC3 = arguments_418205; arguments_418205 = copyStringRC1(((NimStringDesc*) &TMP7036));
