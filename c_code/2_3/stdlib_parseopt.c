...
N_NIMCALL(NI, parseword_529002)(NimStringDesc* s, NI i, NimStringDesc** w, TY123387 delim);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(NimStringDesc*, addChar)(NimStringDesc* s, NIM_CHAR c);
N_NIMCALL(void, handleshortoption_529106)(toptparser528807* p);
...
static NIM_CONST TY123387 TMP7636 = {
0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY123387 TMP7637 = {
...
N_NIMCALL(void, initoptparser_528819)(NimStringDesc* cmdline, toptparser528807* Result) {
	...
	LA3: ;
	{
		...
		unsureAsgnRef((void**) &(*Result).Cmd, copyString(((NimStringDesc*) &TMP7632)));
		i_528835 = 0;
		HEX3Atmp_528837 = 0;
		nimln(53, "parseopt.nim");
		HEX3Atmp_528837 = paramcount_115233();
		...
		while (1) {
			...
			NimStringDesc* LOC9;
			nimln(1452, "system.nim");
			if (!(res_528839 <= HEX3Atmp_528837)) goto LA6;
			nimln(1451, "system.nim");
			i_528835 = res_528839;
...
appendChar(LOC7, 32);
			...
			res_528839 = addInt(res_528839, 1);
		} LA6: ;
	}
	LA1: ;
...
N_NIMCALL(void, handleshortoption_529106)(toptparser528807* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_529002((*p).Cmd, i, &(*p).Val, TMP7636);
	}
	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser528807* p) {
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_529002((*p).Cmd, i, &(*p).Key, TMP7637);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_529002((*p).Cmd, i, &(*p).Val, TMP7636);
			}
			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_529002((*p).Cmd, i, &(*p).Key, TMP7636);
	}
	break;
	}
	BeforeRet: ;
...
"cmdLongoption", 
"cmdShortOption"};
static TNimNode TMP7630[12];
NTI528807.size = sizeof(toptparser528807);
NTI528807.kind = 17;
NTI528807.base = (&NTI2409);
TMP7640[0] = &TMP7630[1];
TMP7630[1].kind = 1;
TMP7630[1].offset = offsetof(toptparser528807, Cmd);
TMP7630[1].typ = (&NTI143);
TMP7630[1].name = "cmd";
TMP7640[1] = &TMP7630[2];
TMP7630[2].kind = 1;
TMP7630[2].offset = offsetof(toptparser528807, Pos);
TMP7630[2].typ = (&NTI106);
TMP7630[2].name = "pos";
TMP7640[2] = &TMP7630[3];
TMP7630[3].kind = 1;
TMP7630[3].offset = offsetof(toptparser528807, Inshortstate);
TMP7630[3].typ = (&NTI134);
TMP7630[3].name = "inShortState";
TMP7640[3] = &TMP7630[4];
NTI528805.size = sizeof(NU8);
NTI528805.kind = 14;
NTI528805.base = 0;
NTI528805.flags = 3;
for (TMP7643 = 0; TMP7643 < 4; TMP7643++) {
TMP7630[TMP7643+5].kind = 1;
TMP7630[TMP7643+5].offset = TMP7643;
TMP7630[TMP7643+5].name = TMP7642[TMP7643];
TMP7641[TMP7643] = &TMP7630[TMP7643+5];
}
TMP7630[9].len = 4; TMP7630[9].kind = 2; TMP7630[9].sons = &TMP7641[0];
NTI528805.node = &TMP7630[9];
TMP7630[4].kind = 1;
TMP7630[4].offset = offsetof(toptparser528807, Kind);
TMP7630[4].typ = (&NTI528805);
TMP7630[4].name = "kind";
TMP7640[4] = &TMP7630[10];
TMP7630[10].kind = 1;
TMP7630[10].offset = offsetof(toptparser528807, Key);
TMP7630[10].typ = (&NTI143);
TMP7630[10].name = "key";
TMP7640[5] = &TMP7630[11];
TMP7630[11].kind = 1;
TMP7630[11].offset = offsetof(toptparser528807, Val);
TMP7630[11].typ = (&NTI143);
TMP7630[11].name = "val";
TMP7630[0].len = 6; TMP7630[0].kind = 2; TMP7630[0].sons = &TMP7640[0];
NTI528807.node = &TMP7630[0];
}
