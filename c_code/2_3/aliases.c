...
static N_INLINE(tnode192813*, lastson_193199)(tnode192813* n) {
	...
	result = (*n).kindU.S6.Sons->data[(NI64)(TMP5626)];
	popFrame();
	return result;
}
...
N_NIMCALL(NU8, ispartofaux_417020)(tnode192813* n, ttype192847* b, tintset189047* marker) {
	...
	case ((NU8) 137):
	{
		...
		nimln(29, "aliases.nim");
		{
			...
			nimln(29, "aliases.nim");
			failedassertimpl_80421(((NimStringDesc*) &TMP5624));
		}
		LA11: ;
...
static N_INLINE(ttype192847*, lastson_193203)(ttype192847* n) {
	...
	if ((NU)((NI64)(TMP5631)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP5631)];
	popFrame();
	return result;
}
