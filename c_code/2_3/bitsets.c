...
N_NIMCALL(NIM_BOOL, bitsetin_242059)(tbitset242012* x, NI64 e) {
	...
	result = !(((NI8)(x->data[(NI64)(TMP3145)] & ((NI8)(NU8)(NU)((NI)((NU64)(1) << (NU64)(((NI) ((NI64)(TMP3146)))))))) == ((NI8) 0)));
	popFrame();
	return result;
}
...
N_NIMCALL(void, bitsetincl_242047)(tbitset242012** x, NI64 elem) {
	...
	(*x)->data[(NI64)(TMP3148)] = (NI8)((*x)->data[(NI64)(TMP3149)] | ((NI8)(NU8)(NU)((NI)((NU64)(1) << (NU64)(((NI) ((NI64)(TMP3150))))))));
	popFrame();
}
...
N_NIMCALL(void, bitsetexcl_242053)(tbitset242012** x, NI64 elem) {
	...
	(*x)->data[(NI64)(TMP3151)] = (NI8)((*x)->data[(NI64)(TMP3152)] & (NI8)((NU8) ~(((NI8)(NU8)(NU)((NI)((NU64)(1) << (NU64)(((NI) ((NI64)(TMP3153))))))))));
	popFrame();
}
N_NIMCALL(void, TMP3154)(void* p, NI op) {
	tbitset242012* a;
