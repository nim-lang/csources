...
{	result = (PrefixMatch_Dkww2nY9cxJVLF9cfoQS5U6Q)0;
			...
			LA9_: ;
			{
				...
				} LA17: ;
				{
					if (!((p ? p->Sup.len : 0) <= jj)) goto LA37_;
					{
						...
						result = ((PrefixMatch_Dkww2nY9cxJVLF9cfoQS5U6Q) 3);
						goto BeforeRet_;
					}
					goto LA39_;
					LA41_: ;
					{
						result = ((PrefixMatch_Dkww2nY9cxJVLF9cfoQS5U6Q) 2);
						goto BeforeRet_;
					}
					LA39_: ;
				}
	...
	}
	{
		...
		}
		{
			...
			result = ((PrefixMatch_Dkww2nY9cxJVLF9cfoQS5U6Q) 1);
			goto BeforeRet_;
		}
		goto LA82_;
		LA84_: ;
...
NTI_Dkww2nY9cxJVLF9cfoQS5U6Q_.size = sizeof(PrefixMatch_Dkww2nY9cxJVLF9cfoQS5U6Q);
