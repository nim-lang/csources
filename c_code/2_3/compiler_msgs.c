...
N_NOINLINE(void, raiserecoverableerror_181969)(NimStringDesc* msg);
...
tlineinfo181338 gcmdlineinfo_181924;
tlineinfo181338 gcodegenlineinfo_181962;
NU64 gnotes_182014;
NI gerrorcounter_182015;
NI ghintcounter_182016;
NI gwarncounter_182017;
NI gerrormax_182018;
TY182036* msgcontext_182055;
TNimType NTI181338; /* TLineInfo */
extern TNimType NTI112; /* int16 */
extern TNimType NTI114; /* int32 */
TNimType NTI182036; /* seq[TLineInfo] */
tlineinfo181338 lasterror_182056;
TY120008* bufferedmsgs_182058;
NU8 erroroutputs_182060;
TY182061 writelnhook_182064;
...
TNimType NTI181975; /* ref ERecoverableError */
...
TNimType NTI182297; /* ref ESuggestDone */
N_NIMCALL(void, TMP136)(void* p, NI op) {
	TY181351* a;
	NI LOC1;
	a = (TY181351*)p;
...
N_NIMCALL(trope178009*, makecstring_181451)(NimStringDesc* s) {
	...
	res = copyString(((NimStringDesc*) &TMP140));
	{
		...
		i_181469 = 0;
		HEX3Atmp_181474 = 0;
		HEX3Atmp_181474 = (NI64)(s->Sup.len - ((NI) 1));
		res_181477 = ((NI) 0);
		{
			while (1) {
				NimStringDesc* LOC9;
				...
				{
					trope178009* LOC8;
					if (!(((NI) ((NI64)((NI64)(i_181469 + ((NI) 1)) % ((NI) 64)))) == ((NI) 0))) goto LA6;
					res = addChar(res, 34);
...
N_NIMCALL(void, msgwriteln_182738)(NimStringDesc* s) {
	{
		if (!!(writelnhook_182064.ClPrc == 0)) goto LA3;
		writelnhook_182064.ClEnv? writelnhook_182064.ClPrc(s, writelnhook_182064.ClEnv):((TMP145)(writelnhook_182064.ClPrc))(s);
	}
	goto LA1;
	LA3: ;
	{
		...
		{
			TY182780 LOC12;
			if (!((erroroutputs_182060 &(1<<((((NU8) 1))&7)))!=0)) goto LA10;
	...
	LA6: ;
	{
		{
			TY182780 LOC18;
			if (!((erroroutputs_182060 &(1<<((((NU8) 0))&7)))!=0)) goto LA16;
	...
	LA1: ;
	{
		if (!((erroroutputs_182060 &(1<<((((NU8) 2))&7)))!=0)) goto LA21;
		safeadd_182127((&bufferedmsgs_182058), s);
	}
	LA21: ;
}
...
N_NIMCALL(void, writecontext_183029)(tlineinfo181338 lastinfo) {
	...
	info = lastinfo;
	{
		...
		i_183053 = 0;
		HEX3Atmp_183059 = 0;
		HEX3Atmp_183059 = (NI64)(msgcontext_182055->Sup.len - ((NI) 1));
		res_183062 = ((NI) 0);
		{
			while (1) {
				...
				i_183053 = res_183062;
				{
					...
					LOC6 = 0;
					LOC7 = 0;
					LOC7 = HEX3DHEX3D_183018(msgcontext_182055->data[i_183053], lastinfo);
					LOC6 = !(LOC7);
					if (!(LOC6)) goto LA8;
					LOC9 = 0;
					LOC9 = HEX3DHEX3D_183018(msgcontext_182055->data[i_183053], info);
					LOC6 = !(LOC9);
					LA8: ;
					if (!LOC6) goto LA10;
					memset((void*)LOC12, 0, sizeof(LOC12));
					LOC12[0] = tomsgfilename_182629(msgcontext_182055->data[i_183053]);
					LOC12[1] = coordtostr_182833(((NI) (msgcontext_182055->data[i_183053].Line)));
					LOC12[2] = coordtostr_182833(((NI) (msgcontext_182055->data[i_183053].Col)));
				...
				LA10: ;
				info = msgcontext_182055->data[i_183053];
				res_183062 += ((NI) 1);
			} LA3: ;
		}
	}
...
N_NOINLINE(void, raiserecoverableerror_181969)(NimStringDesc* msg) {
	erecoverableerror181344* e_181974;
	NimStringDesc* LOC1;
	e_181974 = 0;
	e_181974 = (erecoverableerror181344*) newObj((&NTI181975), sizeof(erecoverableerror181344));
	(*e_181974).Sup.Sup.Sup.m_type = (&NTI181344);
	LOC1 = 0;
	LOC1 = (*e_181974).Sup.Sup.message; (*e_181974).Sup.Sup.message = copyStringRC1(msg);
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_181974, "ERecoverableError");
}
...
N_NIMCALL(void, handleerror_182876)(NU16 msg, NU8 eh, NimStringDesc* s) {
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			if (!LOC9) goto LA13;
			{
				...
				if (!(LOC17)) goto LA18;
				LOC17 = writelnhook_182064.ClPrc == 0;
				LA18: ;
				if (!LOC17) goto LA19;
...
appendString(LOC22, ((NimStringDesc*) &TMP431));
	...
	LA5: ;
	{
		...
		LA26: ;
		if (!LOC25) goto LA27;
		gerrorcounter_182015 += ((NI) 1);
		gexitcode_170129 = ((NI8) 1);
		{
			if (!(gerrormax_182018 <= gerrorcounter_182015)) goto LA31;
			{
				NIM_BOOL LOC35;
				NIM_BOOL LOC36;
				LOC35 = 0;
				...
				if (!LOC35) goto LA39;
				{
					...
					if (!(LOC43)) goto LA44;
					LOC43 = writelnhook_182064.ClPrc == 0;
					LA44: ;
					if (!LOC43) goto LA45;
					writestacktrace_16207();
				}
		...
		LA31: ;
		{
			...
			if (!LOC50) goto LA52;
			{
				...
				if (!LOC56) goto LA60;
				{
					...
					if (!(LOC64)) goto LA65;
					LOC64 = writelnhook_182064.ClPrc == 0;
					LA65: ;
					if (!LOC64) goto LA66;
					writestacktrace_16207();
				}
...
appendString(LOC69, ((NimStringDesc*) &TMP431));
		...
		LA52: ;
		{
			...
			raiserecoverableerror_181969(s);
		}
		goto LA29;
		LA71: ;
		LA29: ;
...
{	frmt = 0;
	...
	case ((NU16) 230) ... ((NU16) 260):
	{
		...
		LA6: ;
		{
			if (!!(((gnotes_182014 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0))) goto LA10;
			goto BeforeRet;
		}
		LA10: ;
	...
	case ((NU16) 261) ... ((NU16) 277):
	{
		...
		LA16: ;
		{
			if (!!(((gnotes_182014 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0))) goto LA20;
			goto BeforeRet;
		}
		LA20: ;
		frmt = copyString(((NimStringDesc*) &TMP429));
		ghintcounter_182016 += ((NI) 1);
	}
	break;
	}
	LOC22 = 0;
		...
		if (TMP1042.status == 0) {
			{
				...
				line_183521 = 0;
				HEX3Atmp_183557 = 0;
				HEX3Atmp_183557 = tofullpath_182443(i.Fileindex);
...
N_NIMCALL(void, limessage_183232)(tlineinfo181338 info, NU16 msg, NimStringDesc* arg, NU8 eh) {
	...
	case ((NU16) 230) ... ((NU16) 260):
	{
		...
		if (LOC3) goto LA4;
		LOC3 = !(((gnotes_182014 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0));
		LA4: ;
		ignoremsg = LOC3;
		{
	...
	case ((NU16) 261) ... ((NU16) 277):
	{
		...
		if (LOC10) goto LA11;
		LOC10 = !(((gnotes_182014 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0));
		LA11: ;
		ignoremsg = LOC10;
...
N_NIMCALL(void, suggestwriteln_182082)(NimStringDesc* s) {
	{
		if (!((erroroutputs_182060 &(1<<((((NU8) 0))&7)))!=0)) goto LA3;
		{
			TY182780 LOC9;
			if (!writelnhook_182064.ClPrc == 0) goto LA7;
		...
		LA7: ;
		{
			writelnhook_182064.ClEnv? writelnhook_182064.ClPrc(s, writelnhook_182064.ClEnv):((TMP2009)(writelnhook_182064.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
	{
		if (!((erroroutputs_182060 &(1<<((((NU8) 2))&7)))!=0)) goto LA13;
		safeadd_182127((&bufferedmsgs_182058), s);
	}
	LA13: ;
}
...
N_NIMCALL(void, pushinfocontext_182359)(tlineinfo181338 info) {
	msgcontext_182055 = (TY182036*) incrSeq(&(msgcontext_182055)->Sup, sizeof(tlineinfo181338));
	msgcontext_182055->data[msgcontext_182055->Sup.len-1] = info;
}

N_NIMCALL(void, popinfocontext_182378)(void) {
	msgcontext_182055 = (TY182036*) setLengthSeq(&(msgcontext_182055)->Sup, sizeof(tlineinfo181338), (NI64)(msgcontext_182055->Sup.len - ((NI) 1)));
}

N_NIMCALL(void, clearbufferedmsgs_182074)(void) {
	genericSeqAssign((&bufferedmsgs_182058), NIM_NIL, (&NTI120008));
}
N_NIMCALL(void, TMP2729)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_182292)(void) {
	esuggestdone181346* e_182296;
	NimStringDesc* LOC1;
	e_182296 = 0;
	e_182296 = (esuggestdone181346*) newObj((&NTI182297), sizeof(esuggestdone181346));
	(*e_182296).Sup.Sup.m_type = (&NTI181346);
	LOC1 = 0;
	LOC1 = (*e_182296).Sup.message; (*e_182296).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2730));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_182296, "ESuggestDone");
}
...
N_NIMCALL(tlineinfo181338, getinfocontext_182404)(NI index) {
	...
	LA1: ;
	{
		...
		result = unknownlineinfo_182027();
	}
	goto LA6;
	LA8: ;
	{
		result = msgcontext_182055->data[i];
	}
	LA6: ;
	return result;
}
...
N_NIMCALL(NI, getinfocontextlen_182323)(void) {
	NI result;
{	result = 0;
	result = msgcontext_182055->Sup.len;
	goto BeforeRet;
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, setinfocontextlen_182340)(NI l) {
	msgcontext_182055 = (TY182036*) setLengthSeq(&(msgcontext_182055)->Sup, sizeof(tlineinfo181338), l);
}
...
NIM_EXTERNC N_NOINLINE(void, compiler_msgsInit)(void) {
	...
	gcmdlineinfo_181924 = newlineinfo_181869(((NI32) 0), ((NI) 1), ((NI) 1));
	memset((void*)(&LOC2), 0, sizeof(LOC2));
	...
	gcodegenlineinfo_181962 = newlineinfo_181869(((NI32) 1), ((NI) 1), ((NI) 1));
	gnotes_182014 = IL64(281474927951871);
	gerrorcounter_182015 = ((NI) 0);
	ghintcounter_182016 = ((NI) 0);
	gwarncounter_182017 = ((NI) 0);
	gerrormax_182018 = ((NI) 1);
	if (msgcontext_182055) nimGCunrefNoCycle(msgcontext_182055);
	msgcontext_182055 = (TY182036*) newSeqRC1((&NTI182036), 0);
	lasterror_182056 = unknownlineinfo_182027();
	erroroutputs_182060 = 3;
...
NTI182036.size = sizeof(TY182036*);
NTI182036.kind = 24;
NTI182036.base = (&NTI181338);
NTI182036.flags = 2;
NTI182036.marker = TMP144;
NTI181344.size = sizeof(erecoverableerror181344);
NTI181344.kind = 17;
NTI181344.base = (&NTI3449);
TMP19[11].len = 0; TMP19[11].kind = 2;
NTI181344.node = &TMP19[11];
NTI181975.size = sizeof(erecoverableerror181344*);
NTI181975.kind = 22;
NTI181975.base = (&NTI181344);
NTI181975.marker = TMP432;
...
NTI182297.size = sizeof(esuggestdone181346*);
NTI182297.kind = 22;
NTI182297.base = (&NTI181346);
NTI182297.marker = TMP2729;
}
