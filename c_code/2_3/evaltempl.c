	...
	case ((NU8) 3):
	{
		...
		s = (*templ).kindU.S4.Sym;
		{
			...
			LA8: ;
			{
				...
				LA33: ;
				LOC38 = 0;
				LOC38 = newsymnode_227754(x, LOC32);
...
N_NIMCALL(tnode225819*, evaltemplate_452334)(tnode225819* n, tsym225849* tmpl, tsym225849* gensymowner) {
	...
	body = getbody_279269(tmpl);
	{
		NIM_BOOL LOC7;
		LOC7 = 0;
		LOC7 = isatom_232963(body);
		if (!LOC7) goto LA8;
