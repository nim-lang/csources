...
N_NIMCALL(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*, getArg_4LRC3jIE5TPe1ACm9aPVpBQ)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n, NimStringDesc* name, NI pos);
N_NIMCALL(NI, sonsLen_qPWPHw7WgJeEVYUdcaRIig)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n);
N_NIMCALL(void, invalidPragma_54ZurtFnCR0LbrbLzC8vrw)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n);
...
N_NIMCALL(NIM_BOOL, boolArg_J1A66BRI6GgqzqhU0EZntw)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n, NimStringDesc* name, NI pos, NIM_BOOL default_0);
