...
TMP1045[0] = &TMP1043[1];
TMP1043[1].kind = 1;
TMP1043[1].offset = offsetof(Tcgen456038, module);
TMP1043[1].typ = (&NTI191811);
TMP1043[1].name = "module";
TMP1045[1] = &TMP1043[2];
TMP1043[2].kind = 1;
TMP1043[2].offset = offsetof(Tcgen456038, filename);
...
NTI456022.flags = 2;
TMP1043[3].kind = 1;
TMP1043[3].offset = offsetof(Tcgen456038, s);
TMP1043[3].typ = (&NTI456022);
TMP1043[3].name = "s";
TMP1045[3] = &TMP1043[4];
TMP1043[4].kind = 1;
TMP1043[4].offset = offsetof(Tcgen456038, preventstacktrace);
TMP1043[4].typ = (&NTI138);
TMP1043[4].name = "preventStackTrace";
TMP1045[4] = &TMP1043[5];
TMP1043[5].kind = 1;
TMP1043[5].offset = offsetof(Tcgen456038, usesthreadvars);
TMP1043[5].typ = (&NTI138);
TMP1043[5].name = "usesThreadVars";
TMP1045[5] = &TMP1043[6];
TMP1043[6].kind = 1;
TMP1043[6].offset = offsetof(Tcgen456038, framedeclared);
TMP1043[6].typ = (&NTI138);
TMP1043[6].name = "frameDeclared";
TMP1045[6] = &TMP1043[7];
TMP1043[7].kind = 1;
TMP1043[7].offset = offsetof(Tcgen456038, isheaderfile);
TMP1043[7].typ = (&NTI138);
TMP1043[7].name = "isHeaderFile";
TMP1045[7] = &TMP1043[8];
TMP1043[8].kind = 1;
TMP1043[8].offset = offsetof(Tcgen456038, includesstringh);
TMP1043[8].typ = (&NTI138);
TMP1043[8].name = "includesStringh";
TMP1045[8] = &TMP1043[9];
TMP1043[9].kind = 1;
TMP1043[9].offset = offsetof(Tcgen456038, objhaskidsvalid);
TMP1043[9].typ = (&NTI138);
TMP1043[9].name = "objHasKidsValid";
TMP1045[9] = &TMP1043[10];
TMP1043[10].kind = 1;
TMP1043[10].offset = offsetof(Tcgen456038, cfilename);
TMP1043[10].typ = (&NTI149);
TMP1043[10].name = "cfilename";
TMP1045[10] = &TMP1043[11];
TMP1043[11].kind = 1;
TMP1043[11].offset = offsetof(Tcgen456038, typecache);
TMP1043[11].typ = (&NTI191861);
TMP1043[11].name = "typeCache";
TMP1045[11] = &TMP1043[12];
TMP1043[12].kind = 1;
TMP1043[12].offset = offsetof(Tcgen456038, forwtypecache);
TMP1043[12].typ = (&NTI191861);
TMP1043[12].name = "forwTypeCache";
TMP1045[12] = &TMP1043[13];
TMP1043[13].kind = 1;
TMP1043[13].offset = offsetof(Tcgen456038, declaredthings);
TMP1043[13].typ = (&NTI188056);
TMP1043[13].name = "declaredThings";
TMP1045[13] = &TMP1043[14];
TMP1043[14].kind = 1;
TMP1043[14].offset = offsetof(Tcgen456038, declaredprotos);
TMP1043[14].typ = (&NTI188056);
TMP1043[14].name = "declaredProtos";
TMP1045[14] = &TMP1043[15];
TMP1043[15].kind = 1;
TMP1043[15].offset = offsetof(Tcgen456038, headerfiles);
TMP1043[15].typ = (&NTI129028);
TMP1043[15].name = "headerFiles";
TMP1045[15] = &TMP1043[16];
TMP1043[16].kind = 1;
TMP1043[16].offset = offsetof(Tcgen456038, typeinfomarker);
...
TMP1043[19].kind = 1;
TMP1043[19].offset = offsetof(Tcproc456034, prc);
TMP1043[19].typ = (&NTI191811);
TMP1043[19].name = "prc";
TMP1051[1] = &TMP1043[20];
TMP1043[20].kind = 1;
TMP1043[20].offset = offsetof(Tcproc456034, beforeretneeded);
TMP1043[20].typ = (&NTI138);
TMP1043[20].name = "beforeRetNeeded";
TMP1051[2] = &TMP1043[21];
TMP1043[21].kind = 1;
TMP1043[21].offset = offsetof(Tcproc456034, threadvaraccessed);
TMP1043[21].typ = (&NTI138);
TMP1043[21].name = "threadVarAccessed";
TMP1051[3] = &TMP1043[22];
TMP1043[22].kind = 1;
TMP1043[22].offset = offsetof(Tcproc456034, lastlineinfo);
TMP1043[22].typ = (&NTI163338);
TMP1043[22].name = "lastLineInfo";
TMP1051[4] = &TMP1043[23];
TMP1043[23].kind = 1;
TMP1043[23].offset = offsetof(Tcproc456034, nestedtrystmts);
TMP1043[23].typ = (&NTI191807);
TMP1043[23].name = "nestedTryStmts";
TMP1051[5] = &TMP1043[24];
TMP1043[24].kind = 1;
TMP1043[24].offset = offsetof(Tcproc456034, inexceptblock);
TMP1043[24].typ = (&NTI108);
TMP1043[24].name = "inExceptBlock";
TMP1051[6] = &TMP1043[25];
TMP1043[25].kind = 1;
TMP1043[25].offset = offsetof(Tcproc456034, finallysafepoints);
TMP1043[25].typ = (&NTI163351);
TMP1043[25].name = "finallySafePoints";
TMP1051[7] = &TMP1043[26];
TMP1043[26].kind = 1;
TMP1043[26].offset = offsetof(Tcproc456034, labels);
...
TMP1043[29].kind = 1;
TMP1043[29].offset = offsetof(Tblock456032, id);
TMP1043[29].typ = (&NTI108);
TMP1043[29].name = "id";
TMP1052[1] = &TMP1043[30];
TMP1043[30].kind = 1;
TMP1043[30].offset = offsetof(Tblock456032, label);
TMP1043[30].typ = (&NTI161007);
