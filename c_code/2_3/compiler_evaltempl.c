	...
	case ((NU8) 3):
	{
		...
		s = (*templ).kindU.S4.Sym;
		{
			...
			LA10: ;
			{
				...
				LA38: ;
				LOC43 = 0;
				LOC43 = newsymnode_212691(x, LOC37);
...
N_NIMCALL(tnode210818*, evaltemplate_415286)(tnode210818* n, tsym210848* tmpl, tsym210848* gensymowner) {
	...
	body = getbody_259281(tmpl);
	{
		NIM_BOOL LOC7;
		LOC7 = 0;
		LOC7 = isatom_216972(body);
		if (!LOC7) goto LA8;
