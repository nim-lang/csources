...
static N_INLINE(NIM_BOOL, mustrehash_168054)(NI length, NI counter) {
	...
	LOC5 = ((NI64)(TMP1911) < (NI64)(TMP1912));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
...
static N_INLINE(NI, nexttry_168205)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1914 = mulInt(5, h);
	TMP1915 = addInt((NI64)(TMP1914), 1);
	result = (NI)((NI64)(TMP1915) & maxhash);
	popFrame();
	return result;
}
N_NIMCALL(ttrunk168039*, intsetget_168212)(tintset168043* t, NI key) {
...
N_NIMCALL(void, intsetenlarge_168604)(tintset168043* t) {
	...
	TMP1919 = mulInt((NI64)(TMP1918), 2);
	TMP1920 = subInt((NI64)(TMP1919), 1);
	(*t).Max = (NI64)(TMP1920);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1921 = addInt((*t).Max, 1);
	n = (ttrunkseq168041*) newSeq((&NTI168041), (NI64)(TMP1921));
	i_168629 = 0;
...
N_NIMCALL(ttrunk168039*, intsetput_168661)(tintset168043* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_168054((NI64)(TMP1925), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
...
TMP1922[0] = &TMP1908[1];
TMP1908[1].kind = 1;
TMP1908[1].offset = offsetof(ttrunk168039, Next);
TMP1908[1].typ = (&NTI168037);
TMP1908[1].name = "next";
TMP1922[1] = &TMP1908[2];
TMP1908[2].kind = 1;
TMP1908[2].offset = offsetof(ttrunk168039, Key);
TMP1908[2].typ = (&NTI105);
TMP1908[2].name = "key";
TMP1922[2] = &TMP1908[3];
TMP1908[3].kind = 1;
TMP1908[3].offset = offsetof(ttrunk168039, Bits);
TMP1908[3].typ = (&NTI21418);
TMP1908[3].name = "bits";
TMP1908[0].len = 3; TMP1908[0].kind = 2; TMP1908[0].sons = &TMP1922[0];
NTI168039.node = &TMP1908[0];
NTI168037.size = sizeof(ttrunk168039*);
NTI168037.kind = 22;
NTI168037.base = (&NTI168039);
NTI168037.marker = TMP1923;
NTI168041.size = sizeof(ttrunkseq168041*);
NTI168041.kind = 24;
NTI168041.base = (&NTI168037);
NTI168041.flags = 2;
NTI168041.marker = TMP1924;
...
TMP3348[0] = &TMP1908[5];
TMP1908[5].kind = 1;
TMP1908[5].offset = offsetof(tintset168043, Counter);
TMP1908[5].typ = (&NTI105);
TMP1908[5].name = "counter";
TMP3348[1] = &TMP1908[6];
TMP1908[6].kind = 1;
TMP1908[6].offset = offsetof(tintset168043, Max);
TMP1908[6].typ = (&NTI105);
TMP1908[6].name = "max";
TMP3348[2] = &TMP1908[7];
TMP1908[7].kind = 1;
TMP1908[7].offset = offsetof(tintset168043, Head);
TMP1908[7].typ = (&NTI168037);
TMP1908[7].name = "head";
TMP3348[3] = &TMP1908[8];
TMP1908[8].kind = 1;
TMP1908[8].offset = offsetof(tintset168043, Data);
TMP1908[8].typ = (&NTI168041);
TMP1908[8].name = "data";
TMP1908[4].len = 4; TMP1908[4].kind = 2; TMP1908[4].sons = &TMP3348[0];
NTI168043.node = &TMP1908[4];
}
