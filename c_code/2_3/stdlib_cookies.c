...
N_NIMCALL(NimStringDesc*, setcookie_334106)(NimStringDesc* key, NimStringDesc* value, NimStringDesc* domain, NimStringDesc* path, NimStringDesc* expires, NIM_BOOL noname);
N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src);
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src);
N_NIMCALL(NimStringDesc*, resizeString)(NimStringDesc* dest, NI addlen);
N_NIMCALL(NimStringDesc*, rawNewString)(NI space);
N_NIMCALL(NimStringDesc*, setcookie_334117)(NimStringDesc* key, NimStringDesc* value, ttimeinfo94003* expires, NimStringDesc* domain, NimStringDesc* path, NIM_BOOL noname);
N_NIMCALL(NimStringDesc*, format_95999)(ttimeinfo94003* info, NimStringDesc* f);
STRING_LITERAL(TMP4687, "", 0);
STRING_LITERAL(TMP4688, "Set-Cookie: ", 12);
STRING_LITERAL(TMP4689, "=", 1);
STRING_LITERAL(TMP4690, "; Domain=", 9);
STRING_LITERAL(TMP4691, "; Path=", 7);
STRING_LITERAL(TMP4692, "; Expires=", 10);
STRING_LITERAL(TMP4693, "ddd\',\' dd MMM yyyy HH:mm:ss \'UTC\'", 33);
...
N_NIMCALL(tstringtable120810*, parsecookies_334012)(NimStringDesc* s) {
	...
	while (1) {
		...
		TMP4686 = subInt(i, 1);
		LOC16 = 0;
		LOC16 = copyStrLast(s, valstart, (NI64)(TMP4686));
...
N_NIMCALL(NimStringDesc*, setcookie_334106)(NimStringDesc* key, NimStringDesc* value, NimStringDesc* domain, NimStringDesc* path, NimStringDesc* expires, NIM_BOOL noname) {
	...
	result = copyString(((NimStringDesc*) &TMP4687));
...
appendString(LOC5, ((NimStringDesc*) &TMP4689));
...
appendString(LOC10, ((NimStringDesc*) &TMP4690));
...
appendString(LOC15, ((NimStringDesc*) &TMP4691));
...
appendString(LOC20, ((NimStringDesc*) &TMP4692));
...
N_NIMCALL(NimStringDesc*, setcookie_334117)(NimStringDesc* key, NimStringDesc* value, ttimeinfo94003* expires, NimStringDesc* domain, NimStringDesc* path, NIM_BOOL noname) {
	...
	LOC1 = 0;
	LOC1 = format_95999(expires, ((NimStringDesc*) &TMP4693));
	result = setcookie_334106(key, value, domain, path, LOC1, noname);
	goto BeforeRet;
	BeforeRet: ;
	popFrame();
	return result;
