...
static NIM_CONST TY113118 TMP931 = {
...
static NIM_CONST TY113118 TMP936 = {
0x00, 0x00, 0x00, 0x00, 0x20, 0xE8, 0xFF, 0x27,
0xFF, 0xFF, 0xFF, 0x87, 0xFE, 0xFF, 0xFF, 0x07,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
...
STRING_LITERAL(TMP941, "\'\"\'\"\'", 5);
STRING_LITERAL(TMP945, "0 < n ", 6);
STRING_LITERAL(TMP957, "", 0);
STRING_LITERAL(TMP958, "\012", 1);
STRING_LITERAL(TMP959, " ", 1);
STRING_LITERAL(TMP971, "=", 1);
STRING_LITERAL(TMP983, "sh", 2);
STRING_LITERAL(TMP984, "-c", 2);
NIM_CONST TY114486 TMP982 = {((NimStringDesc*) &TMP983),
((NimStringDesc*) &TMP984)}
;
NIM_CONST TY75888 TMP991 = {((NimStringDesc*) &TMP957),
-1}
;
...
N_NIMCALL(NimStringDesc*, nospquoteShellWindows)(NimStringDesc* s) {
	...
	nimln(51, "osproc.nim");
	backslashbuff = copyString(((NimStringDesc*) &TMP932));
	nimln(52, "osproc.nim");
	{
...
N_NIMCALL(NimStringDesc*, nospquoteShellPosix)(NimStringDesc* s) {
	...
	nimln(77, "osproc.nim");
	{
		...
		nimln(78, "osproc.nim");
		nimln(78, "osproc.nim");
		result = copyString(((NimStringDesc*) &TMP935));
		goto BeforeRet;
	}	LA3: ;
	nimln(80, "osproc.nim");
	safe = allcharsinset_84306(s, TMP936);
	nimln(82, "osproc.nim");
	{
		if (!safe) goto LA7;
		nimln(83, "osproc.nim");
	...
	LA7: ;
	{
		...
		nimln(85, "osproc.nim");
		LOC11 = 0;
		LOC11 = nsuReplaceStr(s, ((NimStringDesc*) &TMP937), ((NimStringDesc*) &TMP941));
		LOC10 = rawNewString(LOC11->Sup.len + 2);
appendString(LOC10, ((NimStringDesc*) &TMP937));
...
N_NIMCALL(tprocess144203*, startcmd_144428)(NimStringDesc* command, NU8 options) {
	...
	nimln(137, "osproc.nim");
	nimln(137, "osproc.nim");
	TMP942 = subInt(c->Sup.len, 1);
	a = (TY9552*) newSeq((&NTI9552), (NI64)(TMP942));
	i_144473 = 0;
	HEX3Atmp_144475 = 0;
	...
	while (1) {
		...
		nimln(138, "osproc.nim");
		nimln(138, "osproc.nim");
		TMP944 = subInt(i_144473, 1);
		if ((NU)((NI64)(TMP944)) >= (NU)(a->Sup.len)) raiseIndexError();
		if ((NU)(i_144473) >= (NU)(c->Sup.len)) raiseIndexError();
		LOC2 = 0;
		LOC2 = a->data[(NI64)(TMP944)]; a->data[(NI64)(TMP944)] = copyStringRC1(c->data[i_144473]);
	...
	result = nospstartProcess(c->data[0], ((NimStringDesc*) &TMP932), a->data, a->Sup.len, NIM_NIL, options);
	popFrame();
	return result;
}
N_NIMCALL(NI, nospprocessID)(tprocess144203* p) {
...
N_NIMCALL(NI, nospexecProcesses)(NimStringDesc** cmds, NI cmdsLen0, NU8 options_144808, NI n) {
	...
	nimln(257, "osproc.nim");
	{
		...
		if (!!((0 < n))) goto LA3;
		nimln(257, "osproc.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP945));	}	LA3: ;
...
N_NIMCALL(NimStringDesc*, nospexecProcess)(NimStringDesc* command, NU8 options) {
	...
	result = copyString(((NimStringDesc*) &TMP957));
...
N_NIMCALL(NCSTRING*, tocstringarray_145626)(NimStringDesc** b, NI bLen0, NimStringDesc** a, NI aLen0) {
	...
	nimln(571, "osproc.nim");
	nimln(571, "osproc.nim");
	TMP960 = addInt(aLen0, bLen0);
	TMP961 = addInt((NI64)(TMP960), 1);
	TMP962 = mulInt((NI64)(TMP961), 8);
	LOC1 = 0;
	LOC1 = alloc0_4004((NI64)(TMP962));
	...
	while (1) {
		...
		TMP963 = addInt(b[i_145654]->Sup.len, 1);
		LOC3 = 0;
		LOC3 = alloc_4001((NI64)(TMP963));
		...
		memcpy(((void*) (result[(i_145654)- 0])), ((void*) (b[i_145654]->data)), (NI64)(TMP964));		nimln(1311, "system.nim");
	...
	while (1) {
		...
		nimln(576, "osproc.nim");
		nimln(576, "osproc.nim");
		TMP965 = addInt(i_145664, bLen0);
		if ((NU)((NI64)(TMP965)) > (NU)(50000)) raiseIndexError();
		nimln(576, "osproc.nim");
		nimln(576, "osproc.nim");
		nimln(576, "osproc.nim");
		if ((NU)(i_145664) >= (NU)(aLen0)) raiseIndexError();
		TMP966 = addInt(a[i_145664]->Sup.len, 1);
		LOC5 = 0;
		LOC5 = alloc_4001((NI64)(TMP966));
		result[((NI64)(TMP965))- 0] = ((NCSTRING) (LOC5));
		nimln(577, "osproc.nim");
		nimln(577, "osproc.nim");
		nimln(577, "osproc.nim");
		TMP967 = addInt(i_145664, bLen0);
		if ((NU)((NI64)(TMP967)) > (NU)(50000)) raiseIndexError();
		if ((NU)(i_145664) >= (NU)(aLen0)) raiseIndexError();
		nimln(577, "osproc.nim");
		nimln(577, "osproc.nim");
		if ((NU)(i_145664) >= (NU)(aLen0)) raiseIndexError();
		TMP968 = addInt(a[i_145664]->Sup.len, 1);
		memcpy(((void*) (result[((NI64)(TMP967))- 0])), ((void*) (a[i_145664]->data)), (NI64)(TMP968));		nimln(1311, "system.nim");
...
N_NIMCALL(NCSTRING*, tocstringarray_145692)(tstringtable112610* t) {
	...
	LOC1 = 0;
	LOC1 = nstlen(t);
	TMP969 = addInt(LOC1, 1);
	TMP970 = mulInt((NI64)(TMP969), 8);
	LOC2 = 0;
	LOC2 = alloc0_4004((NI64)(TMP970));
...
appendString(LOC8, ((NimStringDesc*) &TMP971));
appendString(LOC8, val_145699);
			...
			nimln(584, "osproc.nim");
			nimln(584, "osproc.nim");
			TMP972 = addInt(x->Sup.len, 1);
			LOC9 = 0;
			LOC9 = alloc_4001((NI64)(TMP972));
			...
			memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI64)(TMP973));			nimln(586, "osproc.nim");
			i = addInt(i, 1);
		}		LA6: ;
		nimln(1311, "system.nim");
...
N_NIMCALL(NCSTRING*, envtocstringarray_145723)(void) {
	...
	while (1) {
		...
		if ((NU)(i_145756) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1151, "os.nim");
		TMP974 = subInt(p_145762, 1);
		key_145727 = copyStrLast(environment_104029->data[i_145756], 0, (NI64)(TMP974));
		nimln(1152, "os.nim");
		nimln(1152, "os.nim");
		if ((NU)(i_145756) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1152, "os.nim");
		TMP975 = addInt(p_145762, 1);
		val_145728 = copyStr(environment_104029->data[i_145756], (NI64)(TMP975));
	...
	nimln(591, "osproc.nim");
	nimln(591, "osproc.nim");
	TMP976 = addInt(counter, 1);
	TMP977 = mulInt((NI64)(TMP976), 8);
	LOC2 = 0;
	LOC2 = alloc0_4004((NI64)(TMP977));
	result = ((NCSTRING*) (LOC2));
	...
	while (1) {
		...
		if ((NU)(i_145772) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1151, "os.nim");
		TMP978 = subInt(p_145778, 1);
		key_145741 = copyStrLast(environment_104029->data[i_145772], 0, (NI64)(TMP978));
		nimln(1152, "os.nim");
		nimln(1152, "os.nim");
		if ((NU)(i_145772) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1152, "os.nim");
		TMP979 = addInt(p_145778, 1);
		val_145742 = copyStr(environment_104029->data[i_145772], (NI64)(TMP979));
...
appendString(LOC4, val_145742);
		...
		nimln(595, "osproc.nim");
		nimln(595, "osproc.nim");
		TMP980 = addInt(x->Sup.len, 1);
		LOC5 = 0;
		LOC5 = alloc_4001((NI64)(TMP980));
		...
		memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI64)(TMP981));		nimln(597, "osproc.nim");
		i = addInt(i, 1);
		nimln(1311, "system.nim");
...
N_NIMCALL(tprocess144203*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, tstringtable112610* env, NU8 options) {
	...
	LA115: ;
	{
		...
		a = tocstringarray_145626(TMP982, 2, LOC119, 1);
	...
	nimln(699, "osproc.nim");
	{
		...
		nimln(700, "osproc.nim");
		LOC131 = 0;
		LOC131 = nsuJoinSep(args, argsLen0, ((NimStringDesc*) &TMP959));
		printf("%s%s%s\012", (command)->data, (((NimStringDesc*) &TMP959))->data, (LOC131)->data);
	}	LA129: ;
...
N_NIMCALL(void, pruneprocessset_146391)(TY145202** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(803, "osproc.nim");
		{
			...
			nimln(804, "osproc.nim");
			TMP987 = subInt(l, 1);
			if ((NU)((NI64)(TMP987)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRefNoCycle((void**) &(*s)->data[i], (*s)->data[(NI64)(TMP987)]);
...
N_NIMCALL(NI, select_145502)(TY145202** readfds, NI timeout) {
	...
	nimln(813, "osproc.nim");
	TMP988 = mulInt(timeout, 1000);
	tv.tv_usec = (NI64)(TMP988);
	...
	createfdset_146336(&rd, (*readfds), &m);	nimln(819, "osproc.nim");
	{
		...
		TMP989 = addInt(m, 1);
		LOC5 = 0;
		LOC5 = select(((int)chckRange((NI64)(TMP989), ((int) (-2147483647 -1)), ((int) 2147483647))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}	goto LA1;
	LA3: ;
	{
		...
		TMP990 = addInt(m, 1);
		LOC7 = 0;
		LOC7 = select(((int)chckRange((NI64)(TMP990), ((int) (-2147483647 -1)), ((int) 2147483647))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}	LA1: ;
...
N_NIMCALL(void, execcmdex_146602)(NimStringDesc* command, NU8 options, TY75888* Result) {
	...
	unsureAsgnRef((void**) &(*Result).Field0, copyString(TMP991.Field0));
	(*Result).Field1 = TMP991.Field1;
...
appendString((*Result).Field0, ((NimStringDesc*) &TMP958));
		}		goto LA2;
		LA5: ;
		{
...
static TNimNode* TMP946[8];
static TNimNode TMP917[9];
...
TMP946[0] = &TMP917[1];
TMP917[1].kind = 1;
TMP917[1].offset = offsetof(tprocess144203, Inhandle);
TMP917[1].typ = (&NTI9008);
TMP917[1].name = "inHandle";
TMP946[1] = &TMP917[2];
TMP917[2].kind = 1;
TMP917[2].offset = offsetof(tprocess144203, Outhandle);
TMP917[2].typ = (&NTI9008);
TMP917[2].name = "outHandle";
TMP946[2] = &TMP917[3];
TMP917[3].kind = 1;
TMP917[3].offset = offsetof(tprocess144203, Errhandle);
TMP917[3].typ = (&NTI9008);
TMP917[3].name = "errHandle";
TMP946[3] = &TMP917[4];
TMP917[4].kind = 1;
TMP917[4].offset = offsetof(tprocess144203, Instream);
TMP917[4].typ = (&NTI142627);
TMP917[4].name = "inStream";
TMP946[4] = &TMP917[5];
TMP917[5].kind = 1;
TMP917[5].offset = offsetof(tprocess144203, Outstream);
TMP917[5].typ = (&NTI142627);
TMP917[5].name = "outStream";
TMP946[5] = &TMP917[6];
TMP917[6].kind = 1;
TMP917[6].offset = offsetof(tprocess144203, Errstream);
TMP917[6].typ = (&NTI142627);
TMP917[6].name = "errStream";
TMP946[6] = &TMP917[7];
TMP917[7].kind = 1;
TMP917[7].offset = offsetof(tprocess144203, Id);
TMP917[7].typ = (&NTI91457);
TMP917[7].name = "id";
TMP946[7] = &TMP917[8];
TMP917[8].kind = 1;
TMP917[8].offset = offsetof(tprocess144203, Exitcode);
TMP917[8].typ = (&NTI3809);
TMP917[8].name = "exitCode";
TMP917[0].len = 8; TMP917[0].kind = 2; TMP917[0].sons = &TMP946[0];
NTI144203.node = &TMP917[0];
NTI144205.size = sizeof(tprocess144203*);
NTI144205.kind = 22;
NTI144205.base = (&NTI144203);
NTI144205.flags = 2;
NTI144205.marker = TMP948;
NTI145202.size = sizeof(TY145202*);
NTI145202.kind = 24;
NTI145202.base = (&NTI144205);
NTI145202.flags = 2;
NTI145202.marker = TMP949;
}
