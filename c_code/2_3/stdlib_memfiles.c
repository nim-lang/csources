...
N_NIMCALL(void*, mapmem_239210)(tmemfile239204* m, NU8 mode, NI mappedsize, NI offset);
...
N_NIMCALL(void, unmapmem_239605)(tmemfile239204* f, void* p, NI size);
...
STRING_LITERAL(TMP2966, "mappedSize > 0 ", 15);
STRING_LITERAL(TMP2967, "newFileSize == - 1 or mode != fmRead ", 37);
extern TFrame* frameptr_13238;
TNimType NTI239204; /* TMemFile */
...
N_NIMCALL(void*, mapmem_239210)(tmemfile239204* m, NU8 mode, NI mappedsize, NI offset) {
	...
	nimln(52, "memfiles.nim");
	{
		...
		nimln(52, "memfiles.nim");
		failedassertimpl_80421(((NimStringDesc*) &TMP2966));
	}
	LA3: ;
...
N_NIMCALL(tmemfile239204, open_239803)(NimStringDesc* filename, NU8 mode, NI mappedsize, NI offset, NI newfilesize) {
	...
	nimln(95, "memfiles.nim");
	{
		...
		if (!!(LOC3)) goto LA5;
		nimln(95, "memfiles.nim");
		failedassertimpl_80421(((NimStringDesc*) &TMP2967));
	}
	LA5: ;
...
static TNimNode* TMP3048[3];
static TNimNode TMP2964[4];
NTI239204.size = sizeof(tmemfile239204);
NTI239204.kind = 18;
NTI239204.base = 0;
NTI239204.flags = 3;
TMP3048[0] = &TMP2964[1];
TMP2964[1].kind = 1;
TMP2964[1].offset = offsetof(tmemfile239204, Mem);
TMP2964[1].typ = (&NTI147);
TMP2964[1].name = "mem";
TMP3048[1] = &TMP2964[2];
TMP2964[2].kind = 1;
TMP2964[2].offset = offsetof(tmemfile239204, Size);
TMP2964[2].typ = (&NTI106);
TMP2964[2].name = "size";
TMP3048[2] = &TMP2964[3];
TMP2964[3].kind = 1;
TMP2964[3].offset = offsetof(tmemfile239204, Handle);
TMP2964[3].typ = (&NTI4409);
TMP2964[3].name = "handle";
TMP2964[0].len = 3; TMP2964[0].kind = 2; TMP2964[0].sons = &TMP3048[0];
NTI239204.node = &TMP2964[0];
}
