...
typedef struct tgen527008 tgen527008;
...
NIM_CONST tpass251015 docgen2pass_527082 = {myopen_527057,
NIM_NIL,
processnode_527049,
close_527014}
;
extern TNimType NTI251003; /* TPassContext */
TNimType NTI527008; /* TGen */
...
N_NIMCALL(tnode192813*, processnode_527049)(tpasscontext251003* c, tnode192813* n) {
	...
	if (c) chckObj((*c).Sup.m_type, (&NTI527008));
	g = ((tgen527008*) (c));
...
NTI527008.size = sizeof(tgen527008);
NTI527008.kind = 17;
NTI527008.base = (&NTI251003);
TMP7624[0] = &TMP7622[1];
TMP7622[1].kind = 1;
TMP7622[1].offset = offsetof(tgen527008, Doc);
TMP7622[1].typ = (&NTI346007);
TMP7622[1].name = "doc";
TMP7624[1] = &TMP7622[2];
TMP7622[2].kind = 1;
TMP7622[2].offset = offsetof(tgen527008, Module);
TMP7622[2].typ = (&NTI192811);
TMP7622[2].name = "module";
TMP7622[0].len = 2; TMP7622[0].kind = 2; TMP7622[0].sons = &TMP7624[0];
NTI527008.node = &TMP7622[0];
NTI527010.size = sizeof(tgen527008*);
NTI527010.kind = 22;
NTI527010.base = (&NTI527008);
NTI527010.marker = TMP7627;
}
