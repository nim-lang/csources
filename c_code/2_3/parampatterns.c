...
N_NIMCALL(NIM_BOOL, matchnodekinds_276321)(tnode186813* p, tnode186813* n) {
	...
	while (1) {
		...
		case ((NU8) 2):
		{
			...
			LOC4 = stack[((NI64)(TMP3601))- 0];
			LA5: ;
			stack[((NI64)(TMP3599))- 0] = LOC4;
		...
		case ((NU8) 3):
		{
			...
			LOC7 = stack[((NI64)(TMP3604))- 0];
			LA8: ;
			stack[((NI64)(TMP3602))- 0] = LOC7;
		...
		case ((NU8) 4):
		{
			...
			stack[((NI64)(TMP3605))- 0] = !(stack[((NI64)(TMP3606))- 0]);
		}
		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3607)])), ((NU8) 0), ((NU8) 24)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			nimln(255, "parampatterns.nim");
			TMP3608 = addInt(pc, 1);
			if ((NU)((NI64)(TMP3608)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3608)])), ((NU8) 0), ((NU8) 156)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
