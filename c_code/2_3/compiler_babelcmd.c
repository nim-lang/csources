...
N_NIMCALL(void, addpackage_150103)(tstringtable112610* packages, NimStringDesc* p) {
	...
	nimln(48, "babelcmd.nim");
	TMP1398 = subInt(x, 1);
	name = copyStrLast(p, 0, (NI64)(TMP1398));
	nimln(49, "babelcmd.nim");
	{
		...
		nimln(50, "babelcmd.nim");
		TMP1399 = addInt(x, 1);
		version = copyStr(p, (NI64)(TMP1399));
	...
	nimln(1228, "os.nim");
	{
		...
		while (1) {
			...
			nimln(1233, "os.nim");
			{
				...
				nimln(698, "system.nim");
				nimln(698, "system.nim");
				LOC12 = !(eqStrings(y_150158, ((NimStringDesc*) &TMP1400)));
				if (!(LOC12)) goto LA13;
				nimln(698, "system.nim");
				nimln(698, "system.nim");
				...
				nimln(69, "babelcmd.nim");
				{
					...
					if (!(LOC33)) goto LA34;
					nimln(69, "babelcmd.nim");
					LOC33 = nsuEndsWith(path_150144, ((NimStringDesc*) &TMP1405));
					LA34: ;
					if (!LOC33) goto LA35;
		...
		nimln(1228, "os.nim");
		{
			...
			while (1) {
				...
				nimln(1233, "os.nim");
				{
					...
					nimln(698, "system.nim");
					nimln(698, "system.nim");
					LOC18 = !(eqStrings(y_150172, ((NimStringDesc*) &TMP1400)));
					if (!(LOC18)) goto LA19;
					nimln(698, "system.nim");
					nimln(698, "system.nim");
