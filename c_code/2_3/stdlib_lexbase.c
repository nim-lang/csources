...
N_NIMCALL(void, fillbuffer_283084)(tbaselexer283029* l) {
	...
	nimln(77, "lexbase.nim");
	{
		...
		nimln(77, "lexbase.nim");
		failedassertimpl_80421(((NimStringDesc*) &TMP3625));
	}
	LA3: ;
	...
	nimln(79, "lexbase.nim");
	{
		...
		nimln(79, "lexbase.nim");
		failedassertimpl_80421(((NimStringDesc*) &TMP3628));
	}
	LA7: ;
	nimln(80, "lexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP3629)])), (NI64)(TMP3630));
	}
	LA11: ;
	...
	TMP3632 = mulInt((NI64)(TMP3631), 1);
	LOC13 = 0;
	LOC13 = readdata_125733((*l).Input, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP3632));
	TMP3633 = divInt(LOC13, 1);
	charsread = (NI64)(TMP3633);
	...
	nimln(86, "lexbase.nim");
	{
		...
		if (!(charsread < (NI64)(TMP3635))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI64)(TMP3637);
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				TMP3638 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4631(((void*) ((*l).Buf)), (NI64)(TMP3638));
				...
				nimln(105, "lexbase.nim");
				{
					...
					if (!!(((NI64)(TMP3639) == oldbuflen))) goto LA35;
					nimln(105, "lexbase.nim");
					failedassertimpl_80421(((NimStringDesc*) &TMP3640));
				}
				LA35: ;
				...
				LOC37 = 0;
				LOC37 = readdata_125733((*l).Input, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP3641));
				TMP3642 = divInt(LOC37, 1);
				charsread = (NI64)(TMP3642);
...
N_NIMCALL(void, open_283039)(tbaselexer283029* l, tstream125629* input, NI buflen) {
	...
	nimln(142, "lexbase.nim");
	{
		...
		nimln(142, "lexbase.nim");
		failedassertimpl_80421(((NimStringDesc*) &TMP3650));
	}
	LA3: ;
	nimln(143, "lexbase.nim");
	{
		...
		nimln(143, "lexbase.nim");
		failedassertimpl_80421(((NimStringDesc*) &TMP3651));
	}
	LA7: ;
	...
	LOC9 = 0;
	LOC9 = alloc_4601((NI64)(TMP3652));
	(*l).Buf = ((NCSTRING) (LOC9));
	nimln(148, "lexbase.nim");
	nimln(148, "lexbase.nim");
	TMP3653 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP3653);
...
N_NIMCALL(NI, getcolnumber_283057)(tbaselexer283029* l, NI pos) {
	...
	if ((NI64)(TMP3654) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP3654));
	popFrame();
	return result;
}
