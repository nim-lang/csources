...
N_NIMCALL(void, fillbuffer_277084)(tbaselexer277029* l) {
	...
	nimln(80, "lexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP3622)])), (NI64)(TMP3623));
	}
	LA11: ;
	...
	TMP3625 = mulInt((NI64)(TMP3624), 1);
	LOC13 = 0;
	LOC13 = readdata_123733((*l).Input, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP3625));
	TMP3626 = divInt(LOC13, 1);
	charsread = (NI64)(TMP3626);
	...
	nimln(86, "lexbase.nim");
	{
		...
		if (!(charsread < (NI64)(TMP3628))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI64)(TMP3630);
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				TMP3631 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4631(((void*) ((*l).Buf)), (NI64)(TMP3631));
				...
				nimln(105, "lexbase.nim");
				{
					...
					if (!!(((NI64)(TMP3632) == oldbuflen))) goto LA35;
					nimln(105, "lexbase.nim");
				...
				LOC37 = 0;
				LOC37 = readdata_123733((*l).Input, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP3634));
				TMP3635 = divInt(LOC37, 1);
				charsread = (NI64)(TMP3635);
...
N_NIMCALL(void, open_277039)(tbaselexer277029* l, tstream123629* input, NI buflen) {
	...
	LOC9 = 0;
	LOC9 = alloc_4601((NI64)(TMP3645));
	(*l).Buf = ((NCSTRING) (LOC9));
	nimln(148, "lexbase.nim");
	nimln(148, "lexbase.nim");
	TMP3646 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP3646);
...
N_NIMCALL(NI, getcolnumber_277057)(tbaselexer277029* l, NI pos) {
	...
	if ((NI64)(TMP3647) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP3647));
	popFrame();
	return result;
}
