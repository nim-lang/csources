...
N_NIMCALL(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*, semLocals_xRvvbI9bSWX9aGV1K2WmJX9bQ)(tyObject_TContext_5TfOJKwTttj3W1t1tMzWUQ* c, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n);
					...
					s = initTabIter_4ygtuv45J5xOJG1H4GUF9bA((&it_2), colontmp__2);
					{
						while (1) {
							...
							it = s;
							{
								...
								T13_ = (NIM_BOOL)0;
								T13_ = ((1051400 &(1U<<((NU)((*it).kind)&31U)))!=0);
								if (!(T13_)) goto LA14_;
								...
								field = newSym_2uJTpCZGZAi7a4eAm1ds8Q(((tyEnum_TSymKind_cNCW9acsSznmEccl1fgQwkw) 18), (*it).name, T18_, (*n).info);
...
NIM_EXTERNC N_NOINLINE(void, compiler_localsInit000)(void) {
	registerPlugin_TWpFbOEPiFRbOW9baL7NPrA(((NimStringDesc*) &TM_tdBuY2ZF9bI7pxZ6PYkeTmw_2), ((NimStringDesc*) &TM_tdBuY2ZF9bI7pxZ6PYkeTmw_3), ((NimStringDesc*) &TM_tdBuY2ZF9bI7pxZ6PYkeTmw_4), semLocals_xRvvbI9bSWX9aGV1K2WmJX9bQ);
}
