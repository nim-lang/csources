...
NIM_CONST TY86145 TMP3127 = {((NimStringDesc*) &TMP3128),
((NI) 100)}
;
NIM_CONST TY86145 TMP3129 = {((NimStringDesc*) &TMP3128),
((NI) 107)}
;
...
N_NIMCALL(Tnode191813*, semnodekindconstraints_268679)(Tnode191813* p) {
	...
	(*result).kindU.S3.strval = addChar((*result).kindU.S3.strval, 1);
	{
		...
		}
		{
			...
			internalerror_165215((*p).info, ((NimStringDesc*) &TMP3130));
		}
		LA12: ;
	}
	goto LA1;
