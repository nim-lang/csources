...
N_NIMCALL(NI, counttriples_180676)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1644 = addInt(i, 1);
			if ((NU)((NI64)(TMP1644)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI64)(TMP1644)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1645 = addInt(i, 2);
			if ((NU)((NI64)(TMP1645)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI64)(TMP1645)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
appendString((*s).S, ((NimStringDesc*) &TMP1648));
	...
	result = ((buflen <= (NI64)(TMP1649)) ? buflen : (NI64)(TMP1649));
...
N_NIMCALL(NI, llstreamread_180242)(tllstream180204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		result = ((buflen <= (NI64)(TMP1650)) ? buflen : (NI64)(TMP1650));
		nimln(136, "llstream.nim");
		{
			...
			if ((NU)((NI64)(TMP1651)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI64)(TMP1651)])), result);
...
N_NIMCALL(void, llstreamwrite_180268)(tllstream180204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			(*s).S = setLengthStr((*s).S, (NI64)(TMP1652));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1653 = addInt(0, (*s).Wr);
			if ((NU)((NI64)(TMP1653)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI64)(TMP1653)])), buf, buflen);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_180254)(tllstream180204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI64)(TMP1654));
			nimln(222, "llstream.nim");
			nimln(222, "llstream.nim");
			TMP1655 = addInt(i, 0);
			if ((NU)((NI64)(TMP1655)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_10827((*s).F, ((void*) (&result->data[(NI64)(TMP1655)])), 2048);
