...
N_NIMCALL(NI, counttriples_174676)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1637 = addInt(i, 1);
			if ((NU)((NI64)(TMP1637)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI64)(TMP1637)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1638 = addInt(i, 2);
			if ((NU)((NI64)(TMP1638)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI64)(TMP1638)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
appendString((*s).S, ((NimStringDesc*) &TMP1641));
	...
	result = ((buflen <= (NI64)(TMP1642)) ? buflen : (NI64)(TMP1642));
...
N_NIMCALL(NI, llstreamread_174242)(tllstream174204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		result = ((buflen <= (NI64)(TMP1643)) ? buflen : (NI64)(TMP1643));
		nimln(136, "llstream.nim");
		{
			...
			memcpy(buf, ((void*) (&(*s).S->data[(NI64)(TMP1644)])), result);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_174254)(tllstream174204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI64)(TMP1647));
			nimln(222, "llstream.nim");
			nimln(222, "llstream.nim");
			TMP1648 = addInt(i, 0);
			if ((NU)((NI64)(TMP1648)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_10627((*s).F, ((void*) (&result->data[(NI64)(TMP1648)])), 2048);
