...
N_NIMCALL(void, merge_357843)(tsym186843** a_357851, NI a_357851Len0, tsym186843** b_357859, NI b_357859Len0, NI lo_357863, NI m_357865, NI hi_357867, TY357801 cmp_357875, NU8 order_357878) {
	...
	nimln(101, "algorithm.nim");
	{
		...
		if ((NU)((NI64)(TMP5099)) >= (NU)(a_357851Len0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp_357875.ClEnv? cmp_357875.ClPrc(a_357851[m_357865], a_357851[(NI64)(TMP5099)], cmp_357875.ClEnv):((TMP5100)(cmp_357875.ClPrc))(a_357851[m_357865], a_357851[(NI64)(TMP5099)]);
		LOC4 = 0;
...
N_NIMCALL(void, sort_357782)(tsym186843** a_357790, NI a_357790Len0, TY357801 cmp_357800, NU8 order_357803) {
	...
	nimln(155, "algorithm.nim");
	TMP5096 = divInt(n, 2);
	b = (tsymseq186815*) newSeq((&NTI186815), (NI64)(TMP5096));
	...
	while (1) {
		...
		while (1) {
			...
			nimln(160, "algorithm.nim");
			TMP5105 = addInt(m, s);
			merge_357843(a_357790, a_357790Len0, b->data, b->Sup.len, (((NI64)(TMP5104) >= 0) ? (NI64)(TMP5104) : 0), m, (NI64)(TMP5105), cmp_357800, order_357803);
			nimln(161, "algorithm.nim");
			nimln(161, "algorithm.nim");
			TMP5106 = mulInt(s, 2);
			m = subInt(m, (NI64)(TMP5106));
		} LA2: ;
...
N_NIMCALL(void, merge_361227)(tentry360566* a_361235, NI a_361235Len0, tentry360566* b_361243, NI b_361243Len0, NI lo_361247, NI m_361249, NI hi_361251, TY361185 cmp_361259, NU8 order_361262) {
	...
	nimln(101, "algorithm.nim");
	{
		...
		if ((NU)((NI64)(TMP5118)) >= (NU)(a_361235Len0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp_361259.ClEnv? cmp_361259.ClPrc(a_361235[m_361249], a_361235[(NI64)(TMP5118)], cmp_361259.ClEnv):((TMP5119)(cmp_361259.ClPrc))(a_361235[m_361249], a_361235[(NI64)(TMP5118)]);
		LOC4 = 0;
...
N_NIMCALL(void, sort_361166)(tentry360566* a_361174, NI a_361174Len0, TY361185 cmp_361184, NU8 order_361187) {
	...
	nimln(155, "algorithm.nim");
	TMP5115 = divInt(n, 2);
	b = (TY360573*) newSeq((&NTI360573), (NI64)(TMP5115));
	nimln(156, "algorithm.nim");
	s = 1;
	nimln(157, "algorithm.nim");
	while (1) {
		...
		while (1) {
			...
			nimln(160, "algorithm.nim");
			TMP5121 = subInt(m, s);
			TMP5122 = addInt((NI64)(TMP5121), 1);
			nimln(160, "algorithm.nim");
			TMP5123 = addInt(m, s);
			merge_361227(a_361174, a_361174Len0, b->data, b->Sup.len, (((NI64)(TMP5122) >= 0) ? (NI64)(TMP5122) : 0), m, (NI64)(TMP5123), cmp_361184, order_361187);
			nimln(161, "algorithm.nim");
			nimln(161, "algorithm.nim");
			TMP5124 = mulInt(s, 2);
			m = subInt(m, (NI64)(TMP5124));
		} LA2: ;
		nimln(162, "algorithm.nim");
		nimln(162, "algorithm.nim");
		TMP5125 = mulInt(s, 2);
