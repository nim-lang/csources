...
N_NIMCALL(void, settarget_175634)(NU8 o, NU8 c) {
	...
	targetcpu_175600 = c;
	targetos_175602 = o;
	intsize_175623 = (NI64)(cpu_175496[(c)- 1].Field1 / ((NI) 8));
	floatsize_175624 = (NI64)(cpu_175496[(c)- 1].Field3 / ((NI) 8));
	ptrsize_175625 = (NI64)(cpu_175496[(c)- 1].Field4 / ((NI) 8));
	LOC1 = 0;
...
NIM_EXTERNC N_NOINLINE(void, compiler_platformInit)(void) {
	hostcpu_175601 = nametocpu_175617(((NimStringDesc*) &TMP65));
