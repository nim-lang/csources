...
STRING_LITERAL(TMP887, "id == 0 or id == result.id ", 27);
STRING_LITERAL(TMP891, ":anonymous", 10);
STRING_LITERAL(TMP892, ":delegator", 10);
...
N_NIMCALL(NI, cmpignorestyle_140034)(NCSTRING a, NCSTRING b, NI blen) {
	...
	while (1) {
		...
		nimln(43, "idents.nim");
		{
			...
			nimln(43, "idents.nim");
			nimln(43, "idents.nim");
			TMP883 = addInt(((NI) (((NU8)(aa)))), 32);
			aa = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP883), 0, 255))));
		}		LA16: ;
		nimln(44, "idents.nim");
		{
			NIM_BOOL LOC20;
			...
			nimln(44, "idents.nim");
			nimln(44, "idents.nim");
			TMP884 = addInt(((NI) (((NU8)(bb)))), 32);
			bb = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP884), 0, 255))));
		}		LA22: ;
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
		TMP885 = subInt(((NI) (((NU8)(aa)))), ((NI) (((NU8)(bb)))));
		result = (NI64)(TMP885);
		nimln(46, "idents.nim");
		{
			NIM_BOOL LOC26;
...
N_NOINLINE(void, compileridentsInit)(void) {
	...
	asgnRefNoCycle((void**) &idanon_140463, getident_140443(((NimStringDesc*) &TMP891)));
	nimln(109, "idents.nim");
	asgnRefNoCycle((void**) &iddelegator_140465, getident_140443(((NimStringDesc*) &TMP892)));
	popFrame();
}
...
NTI140011.flags = 3;
TMP881[0].kind = 1;
TMP881[0].offset = offsetof(tidobj140011, Id);
TMP881[0].typ = (&NTI105);
TMP881[0].name = "id";
NTI140011.node = &TMP881[0];
...
TMP888[0] = &TMP881[2];
TMP881[2].kind = 1;
TMP881[2].offset = offsetof(tident140017, S);
TMP881[2].typ = (&NTI142);
TMP881[2].name = "s";
TMP888[1] = &TMP881[3];
TMP881[3].kind = 1;
TMP881[3].offset = offsetof(tident140017, Next);
TMP881[3].typ = (&NTI140015);
TMP881[3].name = "next";
TMP888[2] = &TMP881[4];
TMP881[4].kind = 1;
TMP881[4].offset = offsetof(tident140017, H);
TMP881[4].typ = (&NTI110011);
TMP881[4].name = "h";
TMP881[1].len = 3; TMP881[1].kind = 2; TMP881[1].sons = &TMP888[0];
NTI140017.node = &TMP881[1];
NTI140015.size = sizeof(tident140017*);
NTI140015.kind = 22;
NTI140015.base = (&NTI140017);
NTI140015.flags = 2;
NTI140015.marker = TMP889;
NTI140013.size = sizeof(tidobj140011*);
NTI140013.kind = 22;
NTI140013.base = (&NTI140011);
NTI140013.flags = 2;
NTI140013.marker = TMP2016;
}
