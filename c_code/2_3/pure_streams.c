...
STRING_LITERAL(TMP921, "\012", 1);
STRING_LITERAL(TMP922, "cannot read from stream", 23);
STRING_LITERAL(TMP923, "", 0);
STRING_LITERAL(TMP929, "cannot write to stream", 22);
...
N_NIMCALL(void, writeln_142778)(tstream142629* s, NimStringDesc** args, NI argsLen0) {
	...
	write_142772(s, ((NimStringDesc*) &TMP921));	popFrame();
}
N_NIMCALL(NIM_CHAR, readchar_142808)(tstream142629* s) {
	NIM_CHAR result;
...
N_NIMCALL(void, read_142821)(tstream142629* s, NIM_BOOL* result) {
	...
	nimln(117, "streams.nim");
	{
		...
		LOC6 = 0;
		LOC6 = neweio_142607(((NimStringDesc*) &TMP922));
		nimln(118, "streams.nim");
...
N_NIMCALL(NI, ssreaddata_143038)(tstream142629* s_143040, void* buffer, NI buflen) {
	...
	nimln(214, "streams.nim");
	nimln(214, "streams.nim");
	TMP926 = subInt((*s).Data->Sup.len, (*s).Pos);
	result = ((buflen <= (NI64)(TMP926)) ? buflen : (NI64)(TMP926));
...
N_NIMCALL(void, sswritedata_143062)(tstream142629* s_143064, void* buffer, NI buflen) {
	...
	nimln(221, "streams.nim");
	{
		...
		nimln(222, "streams.nim");
		nimln(222, "streams.nim");
		TMP927 = addInt((*s).Data->Sup.len, buflen);
		(*s).Data = setLengthStr((*s).Data, (NI64)(TMP927));
...
N_NIMCALL(void, fswritedata_143161)(tstream142629* s, void* buffer, NI buflen) {
	...
	nimln(260, "streams.nim");
	{
		...
		LOC6 = 0;
		LOC6 = neweio_142607(((NimStringDesc*) &TMP929));
		nimln(261, "streams.nim");
		raiseException((E_Base*)LOC6, "EIO");
	}	LA4: ;
	popFrame();
...
static TNimNode* TMP924[7];
static TNimNode* TMP925[2];
static TNimNode TMP919[12];
...
NTI142630.flags = 3;
TMP919[1].kind = 1;
TMP919[1].offset = offsetof(tstream142629, Closeimpl);
TMP919[1].typ = (&NTI142630);
TMP919[1].name = "closeImpl";
TMP924[1] = &TMP919[2];
...
NTI142634.flags = 3;
TMP919[2].kind = 1;
TMP919[2].offset = offsetof(tstream142629, Atendimpl);
TMP919[2].typ = (&NTI142634);
TMP919[2].name = "atEndImpl";
TMP924[2] = &TMP919[3];
...
NTI142638.flags = 3;
TMP919[3].kind = 1;
TMP919[3].offset = offsetof(tstream142629, Setpositionimpl);
TMP919[3].typ = (&NTI142638);
TMP919[3].name = "setPositionImpl";
TMP924[3] = &TMP919[4];
...
NTI142643.flags = 3;
TMP919[4].kind = 1;
TMP919[4].offset = offsetof(tstream142629, Getpositionimpl);
TMP919[4].typ = (&NTI142643);
TMP919[4].name = "getPositionImpl";
TMP924[4] = &TMP919[5];
...
NTI142647.flags = 3;
TMP919[5].kind = 1;
TMP919[5].offset = offsetof(tstream142629, Readdataimpl);
TMP919[5].typ = (&NTI142647);
TMP919[5].name = "readDataImpl";
TMP924[5] = &TMP919[6];
...
NTI142653.flags = 3;
TMP919[6].kind = 1;
TMP919[6].offset = offsetof(tstream142629, Writedataimpl);
TMP919[6].typ = (&NTI142653);
TMP919[6].name = "writeDataImpl";
TMP924[6] = &TMP919[7];
...
NTI142659.flags = 3;
TMP919[7].kind = 1;
TMP919[7].offset = offsetof(tstream142629, Flushimpl);
TMP919[7].typ = (&NTI142659);
TMP919[7].name = "flushImpl";
TMP919[0].len = 7; TMP919[0].kind = 2; TMP919[0].sons = &TMP924[0];
NTI142629.node = &TMP919[0];
...
TMP925[0] = &TMP919[9];
TMP919[9].kind = 1;
TMP919[9].offset = offsetof(tstringstream142999, Data);
TMP919[9].typ = (&NTI142);
TMP919[9].name = "data";
TMP925[1] = &TMP919[10];
TMP919[10].kind = 1;
TMP919[10].offset = offsetof(tstringstream142999, Pos);
TMP919[10].typ = (&NTI105);
TMP919[10].name = "pos";
TMP919[8].len = 2; TMP919[8].kind = 2; TMP919[8].sons = &TMP925[0];
NTI142999.node = &TMP919[8];
NTI142997.size = sizeof(tstringstream142999*);
NTI142997.kind = 22;
NTI142997.base = (&NTI142999);
NTI142997.flags = 2;
NTI142997.marker = TMP928;
NTI143109.size = sizeof(tfilestream143109);
NTI143109.kind = 17;
NTI143109.base = (&NTI142629);
NTI143109.flags = 3;
TMP919[11].kind = 1;
TMP919[11].offset = offsetof(tfilestream143109, F);
TMP919[11].typ = (&NTI9004);
TMP919[11].name = "f";
NTI143109.node = &TMP919[11];
NTI143107.size = sizeof(tfilestream143109*);
NTI143107.kind = 22;
NTI143107.base = (&NTI143109);
NTI143107.flags = 2;
NTI143107.marker = TMP930;
NTI142627.size = sizeof(tstream142629*);
NTI142627.kind = 22;
NTI142627.base = (&NTI142629);
NTI142627.flags = 2;
NTI142627.marker = TMP947;
}
