...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, equalsFile_fwrfAbSwc4yqu9c03oYMrZQ)(tyObject_RopeObj_OFzf0kSiPTcNreUIeJgWVA* r, FILE* f);
		...
		s = (NimStringDesc*)0;
		{
			...
			asgnRef((void**) (&stack->data[0]), r);
			{
				while (1) {
					...
					s = (*it).data;
					write_K9cOfFd4JHcDlmXKlD5CfyQ(f, s);
				} LA7: ;
			}
		}
		LA4_: ;
...
{	result = (NIM_BOOL)0;
					...
					rtotal += slen;
					{
						while (1) {
							...
							if (!(spos < slen)) goto LA13;
							{
								...
								bpos = ((NI) 0);
								blen = readBuffer_liBuPp3JMg9aDo4H9c6aGYGw_2(f, ((void*) ((&buf[(((NI) 0))- 0]))), ((NI) 1024));
								btotal += blen;
								{
							...
							n = (((NI)(blen - bpos) <= (NI)(slen - spos)) ? (NI)(blen - bpos) : (NI)(slen - spos));
							{
								NIM_BOOL T24_;
								T24_ = (NIM_BOOL)0;
								T24_ = equalMem_fmeFeLBvgmAHG9bC8ETS9bYQropes(((void*) ((&buf[(bpos)- 0]))), ((void*) ((NI)(((NI) (nimToCStringConv(s))) + spos))), ((NI) (n)));
								if (!!(T24_)) goto LA25_;
								result = NIM_FALSE;
								goto BeforeRet_;
							}
	...
	T27_ = (NIM_BOOL)0;
	T28_ = (NI)0;
	T28_ = readBuffer_liBuPp3JMg9aDo4H9c6aGYGw_2(f, ((void*) ((&buf[(((NI) 0))- 0]))), ((NI) 1));
	T27_ = (T28_ == ((NI) 0));
	if (!(T27_)) goto LA29_;
	T27_ = (btotal == rtotal);
	LA29_: ;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, equalsFile_EnPyko9cdia3BJbBC9ao9a60A)(tyObject_RopeObj_OFzf0kSiPTcNreUIeJgWVA* r, NimStringDesc* filename) {
	...
	result = (NIM_BOOL)0;
	f = (FILE*)0;
	result = open_9bJmir28gOIZeFueZNVXx8A(&f, filename, ((tyEnum_FileMode_ZJfK20XeZ9bv2j1pZjw9aswg) 0), ((NI) -1));
	{
		if (!result) goto LA3_;
		result = equalsFile_fwrfAbSwc4yqu9c03oYMrZQ(r, f);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, writeRope_xVzCd39bh3ndCAWl6XETYRg)(tyObject_RopeObj_OFzf0kSiPTcNreUIeJgWVA* head, NimStringDesc* filename) {
	...
	f = (FILE*)0;
	{
		...
		if (!T3_) goto LA4_;
		{
			...
			writeRope_sYD0VcTiwZXsyhXMaWra2Q(f, head);
		}
		LA8_: ;
		close_Yruu81izRSfgSs1G6fzRxA_2(f);
		result = NIM_TRUE;
