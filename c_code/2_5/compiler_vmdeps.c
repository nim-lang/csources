		...
		res_381139 = ((NI) 0);
		{
			while (1) {
				...
				i_381119 = res_381139;
				{
					...
					void_381132 = atomictypex_381072(((NimStringDesc*) &TMP2842), t, info);
...
N_NIMCALL(Tnode192813*, maptypetoast_381086)(Ttype192849* t, Tlineinfo164338 info, NIM_BOOL allowrecursion) {
	...
	case ((NU8) 0):
	{
		result = atomictypex_381072(((NimStringDesc*) &TMP2832), t, info);
	}
	break;
	case ((NU8) 1):
	{
		result = atomictypex_381072(((NimStringDesc*) &TMP2833), t, info);
	}
	break;
	case ((NU8) 2):
	{
	...
	case ((NU8) 16):
	{
		...
		result = newnodeit_194807(((NU8) 42), info, t);
		LOC9 = 0;
		LOC9 = atomictypex_381072(((NimStringDesc*) &TMP2839), t, info);
	...
	{
		{
			...
			result = newnodeit_194807(((NU8) 42), info, t);
			LOC18 = 0;
			LOC18 = atomictypex_381072(((NimStringDesc*) &TMP2840), t, info);
		...
		LA16: ;
		{
			result = atomictypex_381072(((NimStringDesc*) &TMP2841), t, info);
		}
		LA13: ;
	}
	break;
	...
	{
		{
			...
			result = maptypetobracket_381094(((NimStringDesc*) &TMP2843), t, info);
		}
		goto LA31;
		LA33: ;
		{
	...
	case ((NU8) 18):
	{
		result = maptypetobracket_381094(((NimStringDesc*) &TMP2844), t, info);
	}
	break;
	case ((NU8) 19):
	{
	...
	case ((NU8) 20):
	{
		...
		result = newnodeit_194807(((NU8) 42), info, t);
		LOC61 = 0;
		LOC61 = atomictypex_381072(((NimStringDesc*) &TMP2852), t, info);
	...
	case ((NU8) 26):
	{
		result = atomictypex_381072(((NimStringDesc*) &TMP2853), t, info);
	}
	break;
	case ((NU8) 28):
	{
		result = atomictypex_381072(((NimStringDesc*) &TMP2854), t, info);
	}
	break;
	case ((NU8) 29):
	{
	...
	case ((NU8) 46):
	{
		result = maptypetobracket_381094(((NimStringDesc*) &TMP2871), t, info);
	}
	break;
	case ((NU8) 47):
	{
		result = maptypetobracket_381094(((NimStringDesc*) &TMP2872), t, info);
	}
	break;
	case ((NU8) 48):
	{
	...
	case ((NU8) 50):
	{
		result = atomictypex_381072(((NimStringDesc*) &TMP2875), t, info);
	}
	break;
	case ((NU8) 51):
	{
	...
	{
		Tnode192813* LOC89;
		result = maptypetobracket_381094(((NimStringDesc*) &TMP2877), t, info);
		LOC89 = 0;
	...
	case ((NU8) 58):
	{
		result = atomictypex_381072(((NimStringDesc*) &TMP2882), t, info);
	}
	break;
	case ((NU8) 59):
	case ((NU8) 60):
	case ((NU8) 61):
	{
		...
		result = newnodeit_194807(((NU8) 42), info, t);
		LOC96 = 0;
		LOC96 = atomictypex_381072(((NimStringDesc*) &TMP2883), t, info);
