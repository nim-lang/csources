...
N_NIMCALL(void, TMP2692)(void* p, NI op);
...
STRING_LITERAL(TMP2695, "cannot write to stream", 22);
...
N_NIMCALL(void, fswritedata_135805)(streamobj135035* s, void* buffer, NI buflen) {
	{
		...
		LOC6 = 0;
		LOC6 = neweio_135005(((NimStringDesc*) &TMP2695));
