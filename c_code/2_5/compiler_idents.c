...
N_NIMCALL(NI, cmpignorestyle_141034)(NCSTRING a, NCSTRING b, NI blen) {
	...
	while (1) {
		...
		nimln(43, "idents.nim");
		{
			...
			aa = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP883), 0, 255))));
		}		LA16: ;
		nimln(44, "idents.nim");
		{
			NIM_BOOL LOC20;
			...
			bb = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP884), 0, 255))));
		}		LA22: ;
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
	...
	while (1) {
		...
		LA5: ;
		{
			...
			nimln(82, "idents.nim");
			{
				...
				if (!!(LOC17)) goto LA19;
				nimln(82, "idents.nim");
				hiddenraiseassert_76217(((NimStringDesc*) &TMP887));			}			LA19: ;
			nimln(83, "idents.nim");
			id = (*result).Sup.Id;
		}		goto LA2;
		LA13: ;
...
N_NOINLINE(void, compileridentsInit)(void) {
	...
	asgnRefNoCycle((void**) &idanon_141463, getident_141443(((NimStringDesc*) &TMP891)));
	nimln(109, "idents.nim");
	asgnRefNoCycle((void**) &iddelegator_141465, getident_141443(((NimStringDesc*) &TMP892)));
	popFrame();
}
...
NTI141011.flags = 3;
TMP881[0].kind = 1;
TMP881[0].offset = offsetof(tidobj141011, Id);
TMP881[0].typ = (&NTI105);
TMP881[0].name = "id";
NTI141011.node = &TMP881[0];
...
TMP888[0] = &TMP881[2];
TMP881[2].kind = 1;
TMP881[2].offset = offsetof(tident141017, S);
TMP881[2].typ = (&NTI142);
TMP881[2].name = "s";
TMP888[1] = &TMP881[3];
TMP881[3].kind = 1;
TMP881[3].offset = offsetof(tident141017, Next);
TMP881[3].typ = (&NTI141015);
TMP881[3].name = "next";
TMP888[2] = &TMP881[4];
TMP881[4].kind = 1;
TMP881[4].offset = offsetof(tident141017, H);
TMP881[4].typ = (&NTI110011);
TMP881[4].name = "h";
TMP881[1].len = 3; TMP881[1].kind = 2; TMP881[1].sons = &TMP888[0];
NTI141017.node = &TMP881[1];
NTI141015.size = sizeof(tident141017*);
NTI141015.kind = 22;
NTI141015.base = (&NTI141017);
NTI141015.flags = 2;
NTI141015.marker = TMP889;
NTI141013.size = sizeof(tidobj141011*);
NTI141013.kind = 22;
NTI141013.base = (&NTI141011);
NTI141013.flags = 2;
NTI141013.marker = TMP2016;
}
