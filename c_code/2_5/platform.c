...
NIM_CONST TY142064 os_142063 = {{((NimStringDesc*) &TMP463),
...
NIM_CONST TY142463 endiantostr_142462 = {((NimStringDesc*) &TMP511),
...
NIM_CONST TY142469 cpu_142468 = {{((NimStringDesc*) &TMP513),
32,
((NU8) 0),
64,
32}
...
N_NIMCALL(void, settarget_142599)(NU8 o, NU8 c) {
	...
	nimln(198, "platform.nim");
	{
		...
		if (!!(!((c == ((NU8) 0))))) goto LA3;
		nimln(198, "platform.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP527));
	}
	LA3: ;
	nimln(199, "platform.nim");
	{
		...
		if (!!(!((o == ((NU8) 0))))) goto LA7;
		nimln(199, "platform.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP528));
	}
	LA7: ;
	...
	TMP529 = divInt(cpu_142468[(c)- 1].Field1, 8);
	intsize_142590 = (NI32)(TMP529);
	nimln(204, "platform.nim");
	nimln(204, "platform.nim");
	if (c < 1 || c > 14) raiseIndexError();
	TMP530 = divInt(cpu_142468[(c)- 1].Field3, 8);
	floatsize_142591 = (NI32)(TMP530);
	nimln(205, "platform.nim");
	nimln(205, "platform.nim");
	if (c < 1 || c > 14) raiseIndexError();
	TMP531 = divInt(cpu_142468[(c)- 1].Field4, 8);
	ptrsize_142592 = (NI32)(TMP531);
...
N_NOINLINE(void, platformInit)(void) {
	...
	hostcpu_142574 = nametocpu_142586(((NimStringDesc*) &TMP518));
	nimln(221, "platform.nim");
	hostos_142576 = nametoos_142582(((NimStringDesc*) &TMP532));
