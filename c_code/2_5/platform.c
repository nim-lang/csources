...
N_NIMCALL(void, settarget_146599)(NU8 o, NU8 c) {
	...
	nimln(198, "platform.nim");
	{
		...
		if (!!(!((c == ((NU8) 0))))) goto LA3;
		nimln(198, "platform.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP533));
	}
	LA3: ;
	nimln(199, "platform.nim");
	{
		...
		if (!!(!((o == ((NU8) 0))))) goto LA7;
		nimln(199, "platform.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP534));
	}
	LA7: ;
...
N_NOINLINE(void, platformInit)(void) {
	...
	hostcpu_146574 = nametocpu_146586(((NimStringDesc*) &TMP524));
