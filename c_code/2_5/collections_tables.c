...
static N_INLINE(NIM_BOOL, mustrehash_117295)(NI length, NI counter) {
	...
	nimln(66, "tables.nim");
	{
		...
		nimln(66, "tables.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP373));	}	LA3: ;
	nimln(67, "tables.nim");
	nimln(67, "tables.nim");
	LOC5 = 0;
	nimln(67, "tables.nim");
...
static N_INLINE(NI, nexttry_117405)(NI h, NI maxhash) {
	...
	nimln(70, "tables.nim");
	TMP377 = mulInt(5, h);
	TMP378 = addInt((NI32)(TMP377), 1);
	result = (NI)((NI32)(TMP378) & maxhash);
	popFrame();
	return result;
}N_NIMCALL(void, TMP796)(void* p, NI op) {
...
N_NIMCALL(void, inittable_137534)(NI initialsize, ttable137540* Result) {
	...
	nimln(167, "tables.nim");
	{
		...
		if (!!(LOC3)) goto LA4;
		nimln(167, "tables.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP791));	}	LA4: ;
...
N_NIMCALL(void, enlarge_137840)(ttable137540* t) {
	...
	n = (tkeyvaluepairseq137543*) newSeq((&NTI137543), (NI32)(TMP809));
	i_137879 = 0;
	HEX3Atmp_137934 = 0;
...
N_NIMCALL(void, enlarge_220767)(ttable220029* t) {
	...
	n = (tkeyvaluepairseq220032*) newSeq((&NTI220032), (NI32)(TMP3095));
	i_220806 = 0;
	HEX3Atmp_220861 = 0;
	nimln(117, "tables.nim");
	nimln(117, "tables.nim");
...
N_NIMCALL(void, enlarge_221197)(ttable220059* t) {
	...
	n = (tkeyvaluepairseq220062*) newSeq((&NTI220062), (NI32)(TMP3104));
	i_221236 = 0;
	HEX3Atmp_221291 = 0;
	nimln(117, "tables.nim");
	nimln(117, "tables.nim");
...
TMP797[0] = &TMP369[9];
TMP369[9].kind = 1;
TMP369[9].offset = offsetof(ttable137540, Data);
TMP369[9].typ = (&NTI137543);
TMP369[9].name = "data";
TMP797[1] = &TMP369[10];
TMP369[10].kind = 1;
TMP369[10].offset = offsetof(ttable137540, Counter);
TMP369[10].typ = (&NTI105);
TMP369[10].name = "counter";
TMP369[8].len = 2; TMP369[8].kind = 2; TMP369[8].sons = &TMP797[0];
NTI137540.node = &TMP369[8];
...
TMP3080[0] = &TMP369[12];
TMP369[12].kind = 1;
TMP369[12].offset = offsetof(tkeyvaluepair220065, Field0);
TMP369[12].typ = (&NTI117005);
TMP369[12].name = "Field0";
TMP3080[1] = &TMP369[13];
TMP369[13].kind = 1;
TMP369[13].offset = offsetof(tkeyvaluepair220065, Field1);
TMP369[13].typ = (&NTI220009);
TMP369[13].name = "Field1";
TMP3080[2] = &TMP369[14];
TMP369[14].kind = 1;
TMP369[14].offset = offsetof(tkeyvaluepair220065, Field2);
TMP369[14].typ = (&NTI220007);
TMP369[14].name = "Field2";
TMP369[11].len = 3; TMP369[11].kind = 2; TMP369[11].sons = &TMP3080[0];
NTI220065.node = &TMP369[11];
NTI220062.size = sizeof(tkeyvaluepairseq220062*);
NTI220062.kind = 24;
NTI220062.base = (&NTI220065);
NTI220062.flags = 2;
NTI220062.marker = TMP3086;
...
TMP3087[0] = &TMP369[16];
TMP369[16].kind = 1;
TMP369[16].offset = offsetof(ttable220059, Data);
TMP369[16].typ = (&NTI220062);
TMP369[16].name = "data";
TMP3087[1] = &TMP369[17];
TMP369[17].kind = 1;
TMP369[17].offset = offsetof(ttable220059, Counter);
TMP369[17].typ = (&NTI105);
TMP369[17].name = "counter";
TMP369[15].len = 2; TMP369[15].kind = 2; TMP369[15].sons = &TMP3087[0];
NTI220059.node = &TMP369[15];
...
TMP3093[0] = &TMP369[23];
TMP369[23].kind = 1;
TMP369[23].offset = offsetof(ttable220029, Data);
TMP369[23].typ = (&NTI220032);
TMP369[23].name = "data";
TMP3093[1] = &TMP369[24];
TMP369[24].kind = 1;
TMP369[24].offset = offsetof(ttable220029, Counter);
TMP369[24].typ = (&NTI105);
TMP369[24].name = "counter";
TMP369[22].len = 2; TMP369[22].kind = 2; TMP369[22].sons = &TMP3093[0];
NTI220029.node = &TMP369[22];
}
