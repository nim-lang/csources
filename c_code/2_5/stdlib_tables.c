...
static N_INLINE(NIM_BOOL, mustrehash_139414)(NI length, NI counter) {
	...
	nimln(66, "tables.nim");
	{
		...
		nimln(66, "tables.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP453));
	}
	LA3: ;
	nimln(67, "tables.nim");
	nimln(67, "tables.nim");
...
N_NIMCALL(void, inittable_163552)(NI initialsize_163557, ttable163560* Result) {
	...
	nimln(167, "tables.nim");
	{
		...
		if (!!(LOC3)) goto LA4;
		nimln(167, "tables.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP885));
	}
	LA4: ;
...
N_NIMCALL(void, enlarge_163886)(ttable163560* t_163895) {
	...
	nimln(116, "tables.nim");
	nimln(116, "tables.nim");
	TMP903 = mulInt((*t_163895).Data->Sup.len, 2);
	n = (tkeyvaluepairseq163563*) newSeq((&NTI163563), (NI32)(TMP903));
	i_163941 = 0;
	HEX3Atmp_164011 = 0;
...
NTI139010.node = &TMP451[5];
TMP451[1].kind = 1;
TMP451[1].offset = offsetof(tkeyvaluepair163566, Field0);
TMP451[1].typ = (&NTI139010);
TMP451[1].name = "Field0";
TMP886[1] = &TMP451[6];
TMP451[6].kind = 1;
TMP451[6].offset = offsetof(tkeyvaluepair163566, Field1);
TMP451[6].typ = (&NTI143);
TMP451[6].name = "Field1";
TMP886[2] = &TMP451[7];
TMP451[7].kind = 1;
TMP451[7].offset = offsetof(tkeyvaluepair163566, Field2);
TMP451[7].typ = (&NTI112);
TMP451[7].name = "Field2";
TMP451[0].len = 3; TMP451[0].kind = 2; TMP451[0].sons = &TMP886[0];
NTI163566.node = &TMP451[0];
NTI163563.size = sizeof(tkeyvaluepairseq163563*);
NTI163563.kind = 24;
NTI163563.base = (&NTI163566);
NTI163563.flags = 2;
NTI163563.marker = TMP890;
...
TMP891[0] = &TMP451[9];
TMP451[9].kind = 1;
TMP451[9].offset = offsetof(ttable163560, Data);
TMP451[9].typ = (&NTI163563);
TMP451[9].name = "data";
TMP891[1] = &TMP451[10];
TMP451[10].kind = 1;
TMP451[10].offset = offsetof(ttable163560, Counter);
TMP451[10].typ = (&NTI106);
TMP451[10].name = "counter";
TMP451[8].len = 2; TMP451[8].kind = 2; TMP451[8].sons = &TMP891[0];
NTI163560.node = &TMP451[8];
}
