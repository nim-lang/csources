...
static NIM_CONST TY122387 TMP443 = {
...
N_NIMCALL(NimStringDesc*, getgeneratedpath_137417)(void) {
	...
	LA3: ;
	{
		...
		result = HEX2F_109477(LOC6, ((NimStringDesc*) &TMP421));
	}
	LA1: ;
	popFrame();
	return result;
...
N_NIMCALL(NimStringDesc*, getpackagename_137811)(NimStringDesc* path) {
	...
	parents = 0;
	{
		...
		while (1) {
			...
			HEX3Atmp_137852 = HEX2F_109477(d_137817, ((NimStringDesc*) &TMP425));
			...
			nimln(1212, "os.nim");
			{
				...
				nimln(1213, "os.nim");
				nimln(1213, "os.nim");
				TMP426 = subInt(f_137854.gl_pathc, 1);
				HEX3Atmp_137860 = (NI32)(TMP426);
				...
				while (1) {
					...
					nimln(1214, "os.nim");
					{
						...
						nimln(1214, "os.nim");
						failedassertimpl_80021(((NimStringDesc*) &TMP427));
					}
					LA20: ;
					nimln(1215, "os.nim");
					nimln(1215, "os.nim");
...
static N_INLINE(void, writeln_138205)(FILE* f_138209, NimStringDesc** x_138213, NI x_138213Len0) {
	...
	nimln(172, "sysio.nim");
	write_10463(f_138209, ((NimStringDesc*) &TMP428));
	popFrame();
}
...
N_NIMCALL(void, libcandidates_138321)(NimStringDesc* s, TY10665** dest) {
	...
	nimln(347, "options.nim");
	{
		...
		nimln(350, "options.nim");
		TMP439 = subInt(ri, 1);
		HEX3Atmp_138351 = copyStrLast(s, (NI32)(TMP438), (NI32)(TMP439));
		...
		nimln(258, "strutils.nim");
		{
			...
			nimln(258, "strutils.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP440));
		}
		LA9: ;
		nimln(259, "strutils.nim");
		{
			...
			while (1) {
				...
				nimln(264, "strutils.nim");
				nimln(264, "strutils.nim");
				TMP441 = subInt(last_138353, 1);
				middle_138332 = copyStrLast(HEX3Atmp_138351, first_138355, (NI32)(TMP441));
...
N_NIMCALL(void, incldynliboverride_138369)(NimStringDesc* lib) {
	...
	nstPut(gdlloverrides_137204, LOC1, ((NimStringDesc*) &TMP445));
	popFrame();
}
...
N_NOINLINE(void, optionsInit)(void) {
	...
	LOC1 = 0;
	LOC1 = outfile_137117; outfile_137117 = copyStringRC1(((NimStringDesc*) &TMP404));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(104, "options.nim");
	LOC2 = 0;
	LOC2 = docseesrcurl_137118; docseesrcurl_137118 = copyStringRC1(((NimStringDesc*) &TMP404));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(106, "options.nim");
	LOC3 = 0;
	LOC3 = headerfile_137119; headerfile_137119 = copyStringRC1(((NimStringDesc*) &TMP404));
	if (LOC3) nimGCunrefNoCycle(LOC3);
	nimln(107, "options.nim");
	gverbosity_137120 = 1;
	nimln(110, "options.nim");
	LOC4 = 0;
	LOC4 = gevalexpr_137123; gevalexpr_137123 = copyStringRC1(((NimStringDesc*) &TMP404));
	...
	LOC5 = 0;
	LOC5 = libpath_137205; libpath_137205 = copyStringRC1(((NimStringDesc*) &TMP404));
	if (LOC5) nimGCunrefNoCycle(LOC5);
	nimln(151, "options.nim");
	LOC6 = 0;
	LOC6 = gprojectname_137206; gprojectname_137206 = copyStringRC1(((NimStringDesc*) &TMP404));
	if (LOC6) nimGCunrefNoCycle(LOC6);
	nimln(152, "options.nim");
	LOC7 = 0;
	LOC7 = gprojectpath_137207; gprojectpath_137207 = copyStringRC1(((NimStringDesc*) &TMP404));
	if (LOC7) nimGCunrefNoCycle(LOC7);
	nimln(153, "options.nim");
	LOC8 = 0;
	LOC8 = gprojectfull_137208; gprojectfull_137208 = copyStringRC1(((NimStringDesc*) &TMP404));
	if (LOC8) nimGCunrefNoCycle(LOC8);
	nimln(155, "options.nim");
	LOC9 = 0;
	LOC9 = optmainmodule_137210; optmainmodule_137210 = copyStringRC1(((NimStringDesc*) &TMP404));
	if (LOC9) nimGCunrefNoCycle(LOC9);
	nimln(156, "options.nim");
	LOC10 = 0;
	LOC10 = nimcachedir_137211; nimcachedir_137211 = copyStringRC1(((NimStringDesc*) &TMP404));
	if (LOC10) nimGCunrefNoCycle(LOC10);
	nimln(157, "options.nim");
	LOC11 = 0;
	LOC11 = command_137212; command_137212 = copyStringRC1(((NimStringDesc*) &TMP404));
