	...
	{
		{
			...
			internalerror_166215((*n).info, ((NimStringDesc*) &TMP3286));
		}
		LA13: ;
		...
		LA17: ;
		{
			...
			res_403106 = ((NI) 1);
			{
				while (1) {
					...
					default:
					{
						internalerror_166215((*n).info, ((NimStringDesc*) &TMP3287));
					}
					break;
					}
					res_403106 += ((NI) 1);
...
appendString(LOC29, LOC30);
	...
	case ((NU8) 20) ... ((NU8) 22):
	{
		...
		LA77: ;
		{
			globalerror_166161((*n).info, ((NimStringDesc*) &TMP3294));
		}
		LA75: ;
	}
	break;
	case ((NU8) 23):
	{
		...
		LA83: ;
		{
			globalerror_166161((*n).info, ((NimStringDesc*) &TMP3295));
		}
		LA81: ;
	}
	break;
