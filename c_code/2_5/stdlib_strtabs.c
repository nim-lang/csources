...
N_NIMCALL(void, TMP299)(void* p, NI op);
...
STRING_LITERAL(TMP279, "length > counter ", 17);
STRING_LITERAL(TMP285, "", 0);
STRING_LITERAL(TMP287, "key does not exist: ", 20);
STRING_LITERAL(TMP291, "format string: key not found: ", 30);
...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP309, "{:}", 3);
STRING_LITERAL(TMP310, "{", 1);
STRING_LITERAL(TMP311, ", ", 2);
STRING_LITERAL(TMP312, ": ", 2);
STRING_LITERAL(TMP313, "}", 1);
...
N_NIMCALL(NIM_BOOL, mustrehash_122923)(NI length, NI counter) {
	...
	nimln(85, "strtabs.nim");
	{
		...
		nimln(85, "strtabs.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP279));
	}
	LA3: ;
...
static N_INLINE(NI, nexttry_123006)(NI h, NI maxhash) {
	...
	nimln(89, "strtabs.nim");
	TMP283 = mulInt(5, h);
	TMP284 = addInt((NI32)(TMP283), 1);
	result = (NI)((NI32)(TMP284) & maxhash);
	popFrame();
	return result;
}
...
appendString(LOC6, ((NimStringDesc*) &TMP287));
...
N_NIMCALL(void, enlarge_123081)(tstringtable122810* t) {
	...
	nimln(128, "strtabs.nim");
	nimln(128, "strtabs.nim");
	TMP288 = mulInt((*t).Data->Sup.len, 2);
	n = (tkeyvaluepairseq122808*) newSeq((&NTI122808), (NI32)(TMP288));
	i_123124 = 0;
	HEX3Atmp_123142 = 0;
...
appendString(LOC1, ((NimStringDesc*) &TMP291));
appendString(LOC1, s);
...
N_NIMCALL(tstringtable122810*, nstnewStringTableWithPairs)(NimStringDesc** keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	...
	while (1) {
		...
		nimln(176, "strtabs.nim");
		TMP300 = addInt(i, 1);
		if ((NU)((NI32)(TMP300)) >= (NU)(keyvaluepairsLen0)) raiseIndexError();
		nstPut(result, keyvaluepairs[i], keyvaluepairs[(NI32)(TMP300)]);
...
N_NIMCALL(NimStringDesc*, nstFormat)(NimStringDesc* f, tstringtable122810* t, NU8 flags) {
	...
	while (1) {
		...
		nimln(197, "strtabs.nim");
		{
			...
			nimln(198, "strtabs.nim");
			TMP301 = addInt(i, 1);
			if ((NU)((NI32)(TMP301)) > (NU)(f->Sup.len)) raiseIndexError();
			switch (((NU8)(f->data[(NI32)(TMP301)]))) {
			case 36:
			{
			...
			case 123:
			{
				...
				TMP304 = subInt(j, 1);
				LOC11 = 0;
				LOC11 = copyStrLast(f, (NI32)(TMP303), (NI32)(TMP304));
				LOC12 = 0;
...
appendString(result, LOC12);
			...
			case 95:
			{
				...
				TMP308 = subInt(j, 1);
				LOC17 = 0;
				LOC17 = copyStrLast(f, (NI32)(TMP307), (NI32)(TMP308));
				LOC18 = 0;
...
N_NIMCALL(NimStringDesc*, nstDollar)(tstringtable122810* t) {
	...
	LA4: ;
	{
		...
		result = copyString(((NimStringDesc*) &TMP310));
		key_123496 = 0;
		val_123497 = 0;
		h_123500 = 0;
		HEX3Atmp_123502 = 0;
...
appendString(result, ((NimStringDesc*) &TMP313));
	}
	LA1: ;
	popFrame();
	return result;
...
static TNimNode* TMP296[3];
NI TMP298;
static char* NIM_CONST TMP297[3] = {
"modeCaseSensitive", 
"modeCaseInsensitive", 
"modeStyleInsensitive"};
static TNimNode TMP267[8];
NTI122808.size = sizeof(tkeyvaluepairseq122808*);
NTI122808.kind = 24;
NTI122808.base = (&NTI95105);
NTI122808.flags = 2;
NTI122808.marker = TMP290;
NTI122810.size = sizeof(tstringtable122810);
NTI122810.kind = 17;
NTI122810.base = (&NTI2409);
TMP295[0] = &TMP267[1];
TMP267[1].kind = 1;
TMP267[1].offset = offsetof(tstringtable122810, Counter);
TMP267[1].typ = (&NTI106);
TMP267[1].name = "counter";
TMP295[1] = &TMP267[2];
TMP267[2].kind = 1;
TMP267[2].offset = offsetof(tstringtable122810, Data);
TMP267[2].typ = (&NTI122808);
TMP267[2].name = "data";
TMP295[2] = &TMP267[3];
...
NTI122804.base = 0;
NTI122804.flags = 3;
for (TMP298 = 0; TMP298 < 3; TMP298++) {
TMP267[TMP298+4].kind = 1;
TMP267[TMP298+4].offset = TMP298;
TMP267[TMP298+4].name = TMP297[TMP298];
TMP296[TMP298] = &TMP267[TMP298+4];
}
TMP267[7].len = 3; TMP267[7].kind = 2; TMP267[7].sons = &TMP296[0];
NTI122804.node = &TMP267[7];
TMP267[3].kind = 1;
TMP267[3].offset = offsetof(tstringtable122810, Mode);
TMP267[3].typ = (&NTI122804);
TMP267[3].name = "mode";
TMP267[0].len = 3; TMP267[0].kind = 2; TMP267[0].sons = &TMP295[0];
NTI122810.node = &TMP267[0];
NTI122812.size = sizeof(tstringtable122810*);
NTI122812.kind = 22;
NTI122812.base = (&NTI122810);
NTI122812.marker = TMP299;
}
