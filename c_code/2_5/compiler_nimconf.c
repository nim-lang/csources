...
N_NIMCALL(void, loadconfigs_187811)(NimStringDesc* cfg) {
	...
	LA3: ;
	{
		...
		LOC19 = 0;
		LOC19 = getsystemconfigpath_187592(cfg);
		readconfigfile_187522(LOC19);
	}
	LA17: ;
	{
		NimStringDesc* LOC24;
		...
		LOC24 = 0;
		LOC24 = getuserconfigpath_187580(cfg);
		readconfigfile_187522(LOC24);
	}
	LA22: ;
	{
					...
					res_188057 = ((NI) 0);
					{
						while (1) {
							...
							i_188053 = res_188057;
							{
								...
								LOC60 = (i_188053 == ((NI) 0));
								if (LOC60) goto LA61;
								LOC60 = !((((NU8)(pd->data[(NI)(i_188053 - ((NI) 1))])) == ((NU8)(47)) || ((NU8)(pd->data[(NI)(i_188053 - ((NI) 1))])) == ((NU8)(47))));
								LA61: ;
								LOC58 = LOC60;
								LA59: ;
								if (!LOC58) goto LA62;
