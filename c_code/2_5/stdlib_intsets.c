...
static N_INLINE(NIM_BOOL, mustrehash_184058)(NI length, NI counter) {
	...
	LOC5 = ((NI32)(TMP1939) < (NI32)(TMP1940));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
...
static N_INLINE(NI, nexttry_184206)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1942 = mulInt(5, h);
	TMP1943 = addInt((NI32)(TMP1942), 1);
	result = (NI)((NI32)(TMP1943) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, intsetrawinsert_184239)(tintset184047 t, ttrunkseq184045** data, ttrunk184043* desc) {
	...
	nimln(66, "intsets.nim");
	{
		...
		nimln(66, "intsets.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP1945));
	}
	LA8: ;
...
N_NIMCALL(void, intsetenlarge_184621)(tintset184047* t) {
	...
	TMP1947 = mulInt((NI32)(TMP1946), 2);
	TMP1948 = subInt((NI32)(TMP1947), 1);
	(*t).Max = (NI32)(TMP1948);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1949 = addInt((*t).Max, 1);
	n = (ttrunkseq184045*) newSeq((&NTI184045), (NI32)(TMP1949));
	i_184655 = 0;
...
N_NIMCALL(ttrunk184043*, intsetput_184696)(tintset184047* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_184058((NI32)(TMP1953), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
...
N_NIMCALL(NIM_BOOL, contains_184838)(tintset184047 s, NI key) {
	...
	nimln(97, "intsets.nim");
	t = intsetget_184213(s, (NI)((NU32)(key) >> (NU32)(9)));
...
N_NIMCALL(void, incl_184866)(tintset184047* s, NI key) {
	...
	nimln(106, "intsets.nim");
	t = intsetput_184696(s, (NI)((NU32)(key) >> (NU32)(9)));
...
N_NIMCALL(void, assign_184956)(tintset184047* dest, tintset184047 src) {
	...
	while (1) {
		...
		nimln(152, "intsets.nim");
		{
			...
			nimln(152, "intsets.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP1955));
		}
		LA5: ;
		n = 0;
...
N_NIMCALL(NimStringDesc*, HEX24_185322)(tintset184047 s) {
	...
	while (1) {
		...
		while (1) {
			...
			NI j_185336;
			nimln(169, "intsets.nim");
			if (!(i_185332 <= 15)) goto LA2;
			nimln(170, "intsets.nim");
			if ((NU)(i_185332) > (NU)(15)) raiseIndexError();
			...
			while (1) {
				...
				nimln(175, "intsets.nim");
				{
					...
					nimln(176, "intsets.nim");
					nimln(176, "intsets.nim");
					key_185327 = (NI)((NI)((NU32)((*r_185330).Key) << (NU32)(9)) | (NI)((NU32)((NI)((NU32)(i_185332) << (NU32)(5))) + (NU32)(j_185336)));
...
appendString(result, LOC12);
				...
				nimln(178, "intsets.nim");
				w_185334 = (NI)((NU32)(w_185334) >> (NU32)(1));
			} LA3: ;
...
TMP1950[0] = &TMP1936[1];
TMP1936[1].kind = 1;
TMP1936[1].offset = offsetof(ttrunk184043, Next);
TMP1936[1].typ = (&NTI184041);
TMP1936[1].name = "next";
TMP1950[1] = &TMP1936[2];
TMP1936[2].kind = 1;
TMP1936[2].offset = offsetof(ttrunk184043, Key);
TMP1936[2].typ = (&NTI106);
TMP1936[2].name = "key";
TMP1950[2] = &TMP1936[3];
TMP1936[3].kind = 1;
TMP1936[3].offset = offsetof(ttrunk184043, Bits);
TMP1936[3].typ = (&NTI22818);
TMP1936[3].name = "bits";
TMP1936[0].len = 3; TMP1936[0].kind = 2; TMP1936[0].sons = &TMP1950[0];
NTI184043.node = &TMP1936[0];
NTI184041.size = sizeof(ttrunk184043*);
NTI184041.kind = 22;
NTI184041.base = (&NTI184043);
NTI184041.marker = TMP1951;
NTI184045.size = sizeof(ttrunkseq184045*);
NTI184045.kind = 24;
NTI184045.base = (&NTI184041);
NTI184045.flags = 2;
NTI184045.marker = TMP1952;
...
TMP3244[0] = &TMP1936[5];
TMP1936[5].kind = 1;
TMP1936[5].offset = offsetof(tintset184047, Counter);
TMP1936[5].typ = (&NTI106);
TMP1936[5].name = "counter";
TMP3244[1] = &TMP1936[6];
TMP1936[6].kind = 1;
TMP1936[6].offset = offsetof(tintset184047, Max);
TMP1936[6].typ = (&NTI106);
TMP1936[6].name = "max";
TMP3244[2] = &TMP1936[7];
TMP1936[7].kind = 1;
TMP1936[7].offset = offsetof(tintset184047, Head);
TMP1936[7].typ = (&NTI184041);
TMP1936[7].name = "head";
TMP3244[3] = &TMP1936[8];
TMP1936[8].kind = 1;
TMP1936[8].offset = offsetof(tintset184047, Data);
TMP1936[8].typ = (&NTI184045);
TMP1936[8].name = "data";
TMP1936[4].len = 4; TMP1936[4].kind = 2; TMP1936[4].sons = &TMP3244[0];
NTI184047.node = &TMP1936[4];
}
