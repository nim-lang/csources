...
N_NIMCALL(void, execcmdex_147602)(NimStringDesc* command, NU8 options, TY76088* Result);
...
;
NIM_CONST TY76088 TMP991 = {((NimStringDesc*) &TMP957),
-1}
;
...
N_NIMCALL(tprocess145203*, startcmd_145428)(NimStringDesc* command, NU8 options) {
	...
	a = (TY9552*) newSeq((&NTI9552), (NI32)(TMP942));
	i_145473 = 0;
	HEX3Atmp_145475 = 0;
	...
	while (1) {
		...
		nimln(138, "osproc.nim");
		nimln(138, "osproc.nim");
		TMP944 = subInt(i_145473, 1);
		if ((NU)((NI32)(TMP944)) >= (NU)(a->Sup.len)) raiseIndexError();
		if ((NU)(i_145473) >= (NU)(c->Sup.len)) raiseIndexError();
		LOC2 = 0;
		LOC2 = a->data[(NI32)(TMP944)]; a->data[(NI32)(TMP944)] = copyStringRC1(c->data[i_145473]);
...
N_NIMCALL(NI, nospexecProcesses)(NimStringDesc** cmds, NI cmdsLen0, NU8 options_145808, NI n) {
	...
	nimln(257, "osproc.nim");
	{
		...
		if (!!((0 < n))) goto LA3;
		nimln(257, "osproc.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP945));	}	LA3: ;
...
N_NIMCALL(NCSTRING*, tocstringarray_146626)(NimStringDesc** b, NI bLen0, NimStringDesc** a, NI aLen0) {
	...
	TMP961 = addInt((NI32)(TMP960), 1);
	TMP962 = mulInt((NI32)(TMP961), 4);
	LOC1 = 0;
	LOC1 = alloc0_4004((NI32)(TMP962));
	...
	while (1) {
		...
		TMP963 = addInt(b[i_146654]->Sup.len, 1);
		LOC3 = 0;
		LOC3 = alloc_4001((NI32)(TMP963));
		...
		memcpy(((void*) (result[(i_146654)- 0])), ((void*) (b[i_146654]->data)), (NI32)(TMP964));		nimln(1311, "system.nim");
	...
	while (1) {
		...
		nimln(576, "osproc.nim");
		nimln(576, "osproc.nim");
		TMP965 = addInt(i_146664, bLen0);
		if ((NU)((NI32)(TMP965)) > (NU)(50000)) raiseIndexError();
		nimln(576, "osproc.nim");
		nimln(576, "osproc.nim");
		nimln(576, "osproc.nim");
		if ((NU)(i_146664) >= (NU)(aLen0)) raiseIndexError();
		TMP966 = addInt(a[i_146664]->Sup.len, 1);
		LOC5 = 0;
		LOC5 = alloc_4001((NI32)(TMP966));
		result[((NI32)(TMP965))- 0] = ((NCSTRING) (LOC5));
		nimln(577, "osproc.nim");
		nimln(577, "osproc.nim");
		nimln(577, "osproc.nim");
		TMP967 = addInt(i_146664, bLen0);
		if ((NU)((NI32)(TMP967)) > (NU)(50000)) raiseIndexError();
		if ((NU)(i_146664) >= (NU)(aLen0)) raiseIndexError();
		nimln(577, "osproc.nim");
		nimln(577, "osproc.nim");
		if ((NU)(i_146664) >= (NU)(aLen0)) raiseIndexError();
		TMP968 = addInt(a[i_146664]->Sup.len, 1);
		memcpy(((void*) (result[((NI32)(TMP967))- 0])), ((void*) (a[i_146664]->data)), (NI32)(TMP968));		nimln(1311, "system.nim");
...
N_NIMCALL(NCSTRING*, tocstringarray_146692)(tstringtable112610* t) {
	...
	TMP970 = mulInt((NI32)(TMP969), 4);
	LOC2 = 0;
	LOC2 = alloc0_4004((NI32)(TMP970));
...
appendString(LOC8, val_146699);
			...
			memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI32)(TMP973));			nimln(586, "osproc.nim");
			i = addInt(i, 1);
		}		LA6: ;
		nimln(1311, "system.nim");
...
N_NIMCALL(NCSTRING*, envtocstringarray_146723)(void) {
	...
	while (1) {
		...
		if ((NU)(i_146756) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1151, "os.nim");
		TMP974 = subInt(p_146762, 1);
		key_146727 = copyStrLast(environment_104029->data[i_146756], 0, (NI32)(TMP974));
		nimln(1152, "os.nim");
		nimln(1152, "os.nim");
		if ((NU)(i_146756) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1152, "os.nim");
		TMP975 = addInt(p_146762, 1);
		val_146728 = copyStr(environment_104029->data[i_146756], (NI32)(TMP975));
	...
	TMP977 = mulInt((NI32)(TMP976), 4);
	LOC2 = 0;
	LOC2 = alloc0_4004((NI32)(TMP977));
	result = ((NCSTRING*) (LOC2));
	...
	while (1) {
		...
		if ((NU)(i_146772) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1151, "os.nim");
		TMP978 = subInt(p_146778, 1);
		key_146741 = copyStrLast(environment_104029->data[i_146772], 0, (NI32)(TMP978));
		nimln(1152, "os.nim");
		nimln(1152, "os.nim");
		if ((NU)(i_146772) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1152, "os.nim");
		TMP979 = addInt(p_146778, 1);
		val_146742 = copyStr(environment_104029->data[i_146772], (NI32)(TMP979));
...
appendString(LOC4, val_146742);
		...
		memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI32)(TMP981));		nimln(597, "osproc.nim");
		i = addInt(i, 1);
		nimln(1311, "system.nim");
...
N_NIMCALL(tprocess145203*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, tstringtable112610* env, NU8 options) {
	...
	LA115: ;
	{
		...
		a = tocstringarray_146626(TMP982, 2, LOC119, 1);
...
N_NIMCALL(void, pruneprocessset_147391)(TY146202** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(803, "osproc.nim");
		{
			...
			nimln(804, "osproc.nim");
			TMP987 = subInt(l, 1);
			if ((NU)((NI32)(TMP987)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRefNoCycle((void**) &(*s)->data[i], (*s)->data[(NI32)(TMP987)]);
...
N_NIMCALL(NI, select_146502)(TY146202** readfds, NI timeout) {
	...
	createfdset_147336(&rd, (*readfds), &m);	nimln(819, "osproc.nim");
	{
		...
		TMP989 = addInt(m, 1);
		LOC5 = 0;
		LOC5 = select(((int) ((NI32)(TMP989))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}	goto LA1;
	LA3: ;
	{
		...
		TMP990 = addInt(m, 1);
		LOC7 = 0;
		LOC7 = select(((int) ((NI32)(TMP990))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}	LA1: ;
...
TMP946[0] = &TMP917[1];
TMP917[1].kind = 1;
TMP917[1].offset = offsetof(tprocess145203, Inhandle);
TMP917[1].typ = (&NTI9008);
TMP917[1].name = "inHandle";
TMP946[1] = &TMP917[2];
TMP917[2].kind = 1;
TMP917[2].offset = offsetof(tprocess145203, Outhandle);
TMP917[2].typ = (&NTI9008);
TMP917[2].name = "outHandle";
TMP946[2] = &TMP917[3];
TMP917[3].kind = 1;
TMP917[3].offset = offsetof(tprocess145203, Errhandle);
TMP917[3].typ = (&NTI9008);
TMP917[3].name = "errHandle";
TMP946[3] = &TMP917[4];
TMP917[4].kind = 1;
TMP917[4].offset = offsetof(tprocess145203, Instream);
TMP917[4].typ = (&NTI143627);
TMP917[4].name = "inStream";
TMP946[4] = &TMP917[5];
TMP917[5].kind = 1;
TMP917[5].offset = offsetof(tprocess145203, Outstream);
TMP917[5].typ = (&NTI143627);
TMP917[5].name = "outStream";
TMP946[5] = &TMP917[6];
TMP917[6].kind = 1;
TMP917[6].offset = offsetof(tprocess145203, Errstream);
TMP917[6].typ = (&NTI143627);
TMP917[6].name = "errStream";
TMP946[6] = &TMP917[7];
TMP917[7].kind = 1;
TMP917[7].offset = offsetof(tprocess145203, Id);
TMP917[7].typ = (&NTI91457);
TMP917[7].name = "id";
TMP946[7] = &TMP917[8];
TMP917[8].kind = 1;
TMP917[8].offset = offsetof(tprocess145203, Exitcode);
TMP917[8].typ = (&NTI3809);
TMP917[8].name = "exitCode";
TMP917[0].len = 8; TMP917[0].kind = 2; TMP917[0].sons = &TMP946[0];
NTI145203.node = &TMP917[0];
NTI145205.size = sizeof(tprocess145203*);
NTI145205.kind = 22;
NTI145205.base = (&NTI145203);
NTI145205.flags = 2;
NTI145205.marker = TMP948;
NTI146202.size = sizeof(TY146202*);
NTI146202.kind = 24;
NTI146202.base = (&NTI145205);
NTI146202.flags = 2;
NTI146202.marker = TMP949;
}
