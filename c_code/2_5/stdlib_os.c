...
STRING_LITERAL(TMP1143, "unknown OS error", 16);
STRING_LITERAL(TMP1144, "/proc/self/exe", 14);
STRING_LITERAL(TMP1146, "invalid index", 13);
STRING_LITERAL(TMP1147, "PATH", 4);
STRING_LITERAL(TMP1656, "HOME", 4);
STRING_LITERAL(TMP1657, "/", 1);
STRING_LITERAL(TMP1896, "/.config/", 9);
...
N_NIMCALL(void, raiseoserror_116809)(NI32 errorcode) {
	...
	asgnRefNoCycle((void**) (&(*e).Sup.Sup.message), oserrormsg_116620(errorcode));
	{
		...
		LOC5 = 0;
		LOC5 = (*e).Sup.Sup.message; (*e).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1143));
...
{	result = 0;
	...
	LOC7 = 0;
	LOC7 = (*e_125815).Sup.message; (*e_125815).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1146));
...
{	result = 0;
	result = paramstr_125809(((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			p_126602 = 0;
			HEX3Atmp_126609 = 0;
			HEX3Atmp_126609 = getenv_122644(((NimStringDesc*) &TMP1147));
			last_126614 = ((NI) 0);
			{
				while (1) {
					NI first_126616;
...
N_NIMCALL(NimStringDesc*, nosgetAppFilename)(void) {
	NimStringDesc* result;
	result = 0;
	result = getapplaux_126204(((NimStringDesc*) &TMP1144));
	{
...
{	result = 0;
	LOC1 = 0;
	LOC2 = 0;
	LOC2 = getenv_122644(((NimStringDesc*) &TMP1656));
	LOC1 = rawNewString(LOC2->Sup.len + 1);
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP1657));
	result = LOC1;
	goto BeforeRet;
	}BeforeRet: ;
	return result;
...
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP1896));
	result = LOC1;
	goto BeforeRet;
	}BeforeRet: ;
	return result;
...
N_NOINLINE(void, nosraiseOSError)(NimStringDesc* msg) {
	{
		...
		LA7: ;
		{
			NimStringDesc* LOC11;
			LOC11 = 0;
			LOC11 = (*e_116416).Sup.Sup.message; (*e_116416).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1143));
...
N_NIMCALL(NimStringDesc*, expandtilde_127610)(NimStringDesc* path) {
	...
	result = 0;
	{
		...
		LOC13 = 0;
		LOC13 = HEX5BHEX5D_85771(path, LOC12);
...
{	result = 0;
	...
	LA4: ;
	path = getenv_122644(((NimStringDesc*) &TMP1147));
	{
