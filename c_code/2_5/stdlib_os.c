...
STRING_LITERAL(TMP1079, "unknown OS error", 16);
STRING_LITERAL(TMP1080, "/proc/self/exe", 14);
STRING_LITERAL(TMP1082, "invalid index", 13);
STRING_LITERAL(TMP1083, "PATH", 4);
STRING_LITERAL(TMP1690, "HOME", 4);
...
N_NIMCALL(void, raiseoserror_115809)(NI32 errorcode) {
	...
	asgnRefNoCycle((void**) (&(*e).Sup.Sup.message), oserrormsg_115620(errorcode));
	{
		...
		LOC5 = 0;
		LOC5 = (*e).Sup.Sup.message; (*e).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1079));
...
{	result = 0;
	...
	LOC7 = 0;
	LOC7 = (*e_124616).Sup.message; (*e_124616).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1082));
...
{	result = 0;
	result = paramstr_124609(0);
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			p_125403 = 0;
			HEX3Atmp_125410 = 0;
			HEX3Atmp_125410 = getenv_121442(((NimStringDesc*) &TMP1083));
			last_125415 = 0;
			{
				while (1) {
					NI first_125417;
...
N_NIMCALL(NimStringDesc*, nosgetAppFilename)(void) {
	NimStringDesc* result;
	result = 0;
	result = getapplaux_125004(((NimStringDesc*) &TMP1080));
	{
...
{	result = 0;
	LOC1 = 0;
	LOC2 = 0;
	LOC2 = getenv_121442(((NimStringDesc*) &TMP1690));
	LOC1 = rawNewString(LOC2->Sup.len + 1);
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP1691));
	result = LOC1;
	goto BeforeRet;
	}BeforeRet: ;
	return result;
...
N_NOINLINE(void, nosraiseOSError)(NimStringDesc* msg) {
	{
		...
		LA7: ;
		{
			NimStringDesc* LOC11;
			LOC11 = 0;
			LOC11 = (*e_115417).Sup.Sup.message; (*e_115417).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1079));
...
N_NIMCALL(NimStringDesc*, expandtilde_126446)(NimStringDesc* path) {
	...
	result = 0;
	{
		...
		LOC13 = 0;
		LOC13 = HEX5BHEX5D_85171(path, LOC12);
...
N_NIMCALL(NimStringDesc*, findexe_126410)(NimStringDesc* exe) {
	...
	NimStringDesc* path;
{	result = 0;
	result = nosaddFileExt(exe, ((NimStringDesc*) &TMP141));
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
	...
	LA4: ;
	path = getenv_121442(((NimStringDesc*) &TMP1083));
	{
