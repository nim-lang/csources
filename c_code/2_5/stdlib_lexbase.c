...
NIM_CONST TY122387 newlines_278024 = {
...
N_NIMCALL(NI, fillbaselexer_278812)(tbaselexer278029* l, NI pos) {
	...
	nimln(115, "lexbase.nim");
	{
		...
		nimln(115, "lexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP3639));
	}
	LA3: ;
...
N_NIMCALL(NI, handlecr_278062)(tbaselexer278029* l, NI pos) {
	...
	nimln(125, "lexbase.nim");
	{
		...
		nimln(125, "lexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP3641));
	}
	LA3: ;
...
N_NIMCALL(NI, handlelf_278068)(tbaselexer278029* l, NI pos) {
	...
	nimln(132, "lexbase.nim");
	{
		...
		nimln(132, "lexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP3642));
	}
	LA3: ;
...
N_NIMCALL(void, open_278039)(tbaselexer278029* l, tstream124629* input, NI buflen) {
	...
	nimln(142, "lexbase.nim");
	{
		...
		nimln(142, "lexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP3643));
	}
	LA3: ;
	nimln(143, "lexbase.nim");
	{
		...
		nimln(143, "lexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP3644));
	}
	LA7: ;
...
TMP3758[0] = &TMP3616[1];
TMP3616[1].kind = 1;
TMP3616[1].offset = offsetof(tbaselexer278029, Bufpos);
TMP3616[1].typ = (&NTI106);
TMP3616[1].name = "bufpos";
TMP3758[1] = &TMP3616[2];
TMP3616[2].kind = 1;
TMP3616[2].offset = offsetof(tbaselexer278029, Buf);
TMP3616[2].typ = (&NTI145);
TMP3616[2].name = "buf";
TMP3758[2] = &TMP3616[3];
TMP3616[3].kind = 1;
TMP3616[3].offset = offsetof(tbaselexer278029, Buflen);
TMP3616[3].typ = (&NTI106);
TMP3616[3].name = "bufLen";
TMP3758[3] = &TMP3616[4];
TMP3616[4].kind = 1;
TMP3616[4].offset = offsetof(tbaselexer278029, Input);
TMP3616[4].typ = (&NTI124627);
TMP3616[4].name = "input";
TMP3758[4] = &TMP3616[5];
TMP3616[5].kind = 1;
TMP3616[5].offset = offsetof(tbaselexer278029, Linenumber);
TMP3616[5].typ = (&NTI106);
TMP3616[5].name = "lineNumber";
TMP3758[5] = &TMP3616[6];
TMP3616[6].kind = 1;
TMP3616[6].offset = offsetof(tbaselexer278029, Sentinel);
TMP3616[6].typ = (&NTI106);
TMP3616[6].name = "sentinel";
TMP3758[6] = &TMP3616[7];
TMP3616[7].kind = 1;
TMP3616[7].offset = offsetof(tbaselexer278029, Linestart);
TMP3616[7].typ = (&NTI106);
TMP3616[7].name = "lineStart";
TMP3758[7] = &TMP3616[8];
TMP3616[8].kind = 1;
TMP3616[8].offset = offsetof(tbaselexer278029, Fileopened);
TMP3616[8].typ = (&NTI134);
TMP3616[8].name = "fileOpened";
TMP3616[0].len = 8; TMP3616[0].kind = 2; TMP3616[0].sons = &TMP3758[0];
NTI278029.node = &TMP3616[0];
}
