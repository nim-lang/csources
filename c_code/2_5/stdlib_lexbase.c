...
N_NIMCALL(void, fillbuffer_283084)(tbaselexer283029* l);
...
N_NIMCALL(NI, fillbaselexer_283812)(tbaselexer283029* l, NI pos);
N_NIMCALL(NI, handlecr_283062)(tbaselexer283029* l, NI pos);
N_NIMCALL(NI, handlelf_283068)(tbaselexer283029* l, NI pos);
N_NIMCALL(void, skiputf8bom_284419)(tbaselexer283029* l);
...
N_NIMCALL(NimStringDesc*, getcurrentline_283052)(tbaselexer283029* l, NIM_BOOL marker);
...
NIM_CONST TY123387 newlines_283024 = {
0x00, 0x24, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3625, "L.sentinel < L.bufLen ", 22);
STRING_LITERAL(TMP3628, "toCopy >= 0 ", 12);
STRING_LITERAL(TMP3636, "s < L.bufLen ", 13);
STRING_LITERAL(TMP3640, "L.bufLen - oldBufLen == oldBufLen ", 34);
STRING_LITERAL(TMP3646, "pos <= L.sentinel ", 18);
STRING_LITERAL(TMP3648, "L.buf[pos] == \'\\x0D\' ", 21);
STRING_LITERAL(TMP3649, "L.buf[pos] == \'\\x0A\' ", 21);
STRING_LITERAL(TMP3650, "bufLen > 0 ", 11);
STRING_LITERAL(TMP3651, "input != nil ", 13);
STRING_LITERAL(TMP3655, "", 0);
STRING_LITERAL(TMP3656, "\012", 1);
STRING_LITERAL(TMP3657, "^\012", 2);
extern TFrame* frameptr_13238;
extern TNimType NTI2409; /* TObject */
TNimType NTI283029; /* TBaseLexer */
...
N_NIMCALL(void, fillbuffer_283084)(tbaselexer283029* l) {
	...
	nimln(78, "lexbase.nim");
	nimln(78, "lexbase.nim");
	TMP3626 = subInt((*l).Buflen, (*l).Sentinel);
	TMP3627 = subInt((NI32)(TMP3626), 1);
	tocopy = (NI32)(TMP3627);
	nimln(79, "lexbase.nim");
	{
		...
		nimln(79, "lexbase.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP3628));
	}
	LA7: ;
	nimln(80, "lexbase.nim");
	{
		...
		nimln(81, "lexbase.nim");
		TMP3630 = mulInt(tocopy, 1);
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI32)(TMP3629)])), (NI32)(TMP3630));
	}
	LA11: ;
	...
	TMP3632 = mulInt((NI32)(TMP3631), 1);
	LOC13 = 0;
	LOC13 = readdata_125733((*l).Input, ((void*) (&(*l).Buf[tocopy])), (NI32)(TMP3632));
	TMP3633 = divInt(LOC13, 1);
	charsread = (NI32)(TMP3633);
	nimln(85, "lexbase.nim");
	nimln(85, "lexbase.nim");
	TMP3634 = addInt(tocopy, charsread);
	s = (NI32)(TMP3634);
	nimln(86, "lexbase.nim");
	{
		...
		nimln(86, "lexbase.nim");
		nimln(86, "lexbase.nim");
		TMP3635 = addInt((*l).Sentinel, 1);
		if (!(charsread < (NI32)(TMP3635))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			nimln(93, "lexbase.nim");
			{
				...
				nimln(93, "lexbase.nim");
				failedassertimpl_80621(((NimStringDesc*) &TMP3636));
			}
			LA22: ;
			...
			LA29: ;
			{
				...
				nimln(103, "lexbase.nim");
				TMP3637 = mulInt((*l).Buflen, 2);
				(*l).Buflen = (NI32)(TMP3637);
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				TMP3638 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4631(((void*) ((*l).Buf)), (NI32)(TMP3638));
				...
				nimln(105, "lexbase.nim");
				{
					...
					nimln(105, "lexbase.nim");
					nimln(105, "lexbase.nim");
					TMP3639 = subInt((*l).Buflen, oldbuflen);
					if (!!(((NI32)(TMP3639) == oldbuflen))) goto LA35;
					nimln(105, "lexbase.nim");
				...
				nimln(106, "lexbase.nim");
				nimln(107, "lexbase.nim");
				TMP3641 = mulInt(oldbuflen, 1);
				LOC37 = 0;
				LOC37 = readdata_125733((*l).Input, ((void*) (&(*l).Buf[oldbuflen])), (NI32)(TMP3641));
				TMP3642 = divInt(LOC37, 1);
				charsread = (NI32)(TMP3642);
				nimln(108, "lexbase.nim");
				{
					...
					nimln(109, "lexbase.nim");
					TMP3643 = addInt(oldbuflen, charsread);
					(*l).Buf[(NI32)(TMP3643)] = 0;
					nimln(110, "lexbase.nim");
					nimln(110, "lexbase.nim");
					TMP3644 = addInt(oldbuflen, charsread);
					(*l).Sentinel = (NI32)(TMP3644);
...
N_NIMCALL(NI, fillbaselexer_283812)(tbaselexer283029* l, NI pos) {
	...
	nimln(115, "lexbase.nim");
	{
		...
		nimln(115, "lexbase.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP3646));
	}
	LA3: ;
...
N_NIMCALL(NI, handlelf_283068)(tbaselexer283029* l, NI pos) {
	...
	nimln(132, "lexbase.nim");
	{
		...
		nimln(132, "lexbase.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP3649));
	}
	LA3: ;
...
N_NIMCALL(void, open_283039)(tbaselexer283029* l, tstream125629* input, NI buflen) {
	...
	nimln(142, "lexbase.nim");
	{
		...
		nimln(142, "lexbase.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP3650));
	}
	LA3: ;
	nimln(143, "lexbase.nim");
	{
		...
		nimln(143, "lexbase.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP3651));
	}
	LA7: ;
	...
	nimln(147, "lexbase.nim");
	nimln(147, "lexbase.nim");
	TMP3652 = mulInt(buflen, 1);
	LOC9 = 0;
	LOC9 = alloc_4601((NI32)(TMP3652));
	(*l).Buf = ((NCSTRING) (LOC9));
	nimln(148, "lexbase.nim");
	nimln(148, "lexbase.nim");
	TMP3653 = subInt(buflen, 1);
	(*l).Sentinel = (NI32)(TMP3653);
...
N_NIMCALL(NI, getcolnumber_283057)(tbaselexer283029* l, NI pos) {
	...
	nimln(155, "lexbase.nim");
	nimln(155, "lexbase.nim");
	TMP3654 = subInt(pos, (*l).Linestart);
	if ((NI32)(TMP3654) == (-2147483647 -1)) raiseOverflow();
	result = (NI32)abs((NI32)(TMP3654));
	popFrame();
	return result;
}
...
static TNimNode* TMP3765[8];
static TNimNode TMP3623[9];
NTI283029.size = sizeof(tbaselexer283029);
NTI283029.kind = 17;
NTI283029.base = (&NTI2409);
TMP3765[0] = &TMP3623[1];
TMP3623[1].kind = 1;
TMP3623[1].offset = offsetof(tbaselexer283029, Bufpos);
TMP3623[1].typ = (&NTI106);
TMP3623[1].name = "bufpos";
TMP3765[1] = &TMP3623[2];
TMP3623[2].kind = 1;
TMP3623[2].offset = offsetof(tbaselexer283029, Buf);
TMP3623[2].typ = (&NTI145);
TMP3623[2].name = "buf";
TMP3765[2] = &TMP3623[3];
TMP3623[3].kind = 1;
TMP3623[3].offset = offsetof(tbaselexer283029, Buflen);
TMP3623[3].typ = (&NTI106);
TMP3623[3].name = "bufLen";
TMP3765[3] = &TMP3623[4];
TMP3623[4].kind = 1;
TMP3623[4].offset = offsetof(tbaselexer283029, Input);
TMP3623[4].typ = (&NTI125627);
TMP3623[4].name = "input";
TMP3765[4] = &TMP3623[5];
TMP3623[5].kind = 1;
TMP3623[5].offset = offsetof(tbaselexer283029, Linenumber);
TMP3623[5].typ = (&NTI106);
TMP3623[5].name = "lineNumber";
TMP3765[5] = &TMP3623[6];
TMP3623[6].kind = 1;
TMP3623[6].offset = offsetof(tbaselexer283029, Sentinel);
TMP3623[6].typ = (&NTI106);
TMP3623[6].name = "sentinel";
TMP3765[6] = &TMP3623[7];
TMP3623[7].kind = 1;
TMP3623[7].offset = offsetof(tbaselexer283029, Linestart);
TMP3623[7].typ = (&NTI106);
TMP3623[7].name = "lineStart";
TMP3765[7] = &TMP3623[8];
TMP3623[8].kind = 1;
TMP3623[8].offset = offsetof(tbaselexer283029, Fileopened);
TMP3623[8].typ = (&NTI134);
TMP3623[8].name = "fileOpened";
TMP3623[0].len = 8; TMP3623[0].kind = 2; TMP3623[0].sons = &TMP3765[0];
NTI283029.node = &TMP3623[0];
}
