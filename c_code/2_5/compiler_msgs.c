...
typedef N_CLOSURE_PTR(void, TMP1965) (NimStringDesc* output);
...
STRING_LITERAL(TMP427, "No stack traceback available\012To create a stacktrace, rerun comp"
...
STRING_LITERAL(TMP988, "compiler/msgs.nim", 17);
NIM_CONST TY86345 TMP987 = {((NimStringDesc*) &TMP988),
((NI) 868)}
;
STRING_LITERAL(TMP2665, "suggest done", 12);
STRING_LITERAL(TMP3151, "(", 1);
STRING_LITERAL(TMP3152, ",", 1);
STRING_LITERAL(TMP3153, ")", 1);
NIM_CONST TY86345 TMP3748 = {((NimStringDesc*) &TMP988),
((NI) 875)}
;
...
N_NIMCALL(void, handleerror_165655)(NU16 msg, NU8 eh, NimStringDesc* s) {
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			LA19: ;
			{
				NimStringDesc* LOC22;
				LOC22 = 0;
				LOC22 = rawNewString(command_155239->Sup.len + 95);
		...
		gexitcode_155129 = ((NI8) 1);
		{
			if (!(gerrormax_165022 <= gerrorcounter_165019)) goto LA31;
			{
				...
				LA45: ;
				{
					NimStringDesc* LOC48;
					LOC48 = 0;
					LOC48 = rawNewString(command_155239->Sup.len + 95);
		...
		LA31: ;
		{
			...
			if (!LOC50) goto LA52;
			{
				...
				LA66: ;
				{
					NimStringDesc* LOC69;
					LOC69 = 0;
					LOC69 = rawNewString(command_155239->Sup.len + 95);
...
N_NIMCALL(NI32, fileinfoidx_164537)(NimStringDesc* filename, NIM_BOOL* isknownfile) {
	...
	pushSafePoint(&TMP1141);
	TMP1141.status = setjmp(TMP1141.context);
	if (TMP1141.status == 0) {
	...
	if (TMP1141.status != 0) reraiseException();
	{
		NIM_BOOL LOC6;
		LOC6 = 0;
...
N_NIMCALL(void, suggestwriteln_165075)(NimStringDesc* s) {
	{
		...
		LA7: ;
		{
			writelnhook_165066.ClEnv? writelnhook_165066.ClPrc(s, writelnhook_165066.ClEnv):((TMP1965)(writelnhook_165066.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, suggestquit_165133)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_165137).Sup.message; (*e_165137).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2665));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
appendString(LOC1, ((NimStringDesc*) &TMP3153));
	result = LOC1;
	return result;
}
...
static TNimNode* TMP1959[278];
NI TMP1961;
static char* NIM_CONST TMP1960[278] = {
"errUnknown", 
"errIllFormedAstX", 
"errInternal", 
"errCannotOpenFile", 
...
TMP133[0] = &TMP19[1];
TMP19[1].kind = 1;
TMP19[1].offset = offsetof(Tfileinfo164336, fullpath);
TMP19[1].typ = (&NTI149);
TMP19[1].name = "fullPath";
TMP133[1] = &TMP19[2];
TMP19[2].kind = 1;
TMP19[2].offset = offsetof(Tfileinfo164336, projpath);
TMP19[2].typ = (&NTI149);
TMP19[2].name = "projPath";
TMP133[2] = &TMP19[3];
TMP19[3].kind = 1;
TMP19[3].offset = offsetof(Tfileinfo164336, shortname);
TMP19[3].typ = (&NTI149);
TMP19[3].name = "shortName";
TMP133[3] = &TMP19[4];
TMP19[4].kind = 1;
TMP19[4].offset = offsetof(Tfileinfo164336, quotedname);
TMP19[4].typ = (&NTI162007);
...
TMP19[5].kind = 1;
TMP19[5].offset = offsetof(Tfileinfo164336, lines);
TMP19[5].typ = (&NTI164351);
TMP19[5].name = "lines";
TMP133[5] = &TMP19[6];
TMP19[6].kind = 1;
TMP19[6].offset = offsetof(Tfileinfo164336, dirtyfile);
TMP19[6].typ = (&NTI149);
TMP19[6].name = "dirtyfile";
TMP19[0].len = 6; TMP19[0].kind = 2; TMP19[0].sons = &TMP133[0];
NTI164336.node = &TMP19[0];
...
TMP141[0] = &TMP19[8];
TMP19[8].kind = 1;
TMP19[8].offset = offsetof(Tlineinfo164338, line);
TMP19[8].typ = (&NTI112);
TMP19[8].name = "line";
TMP141[1] = &TMP19[9];
TMP19[9].kind = 1;
TMP19[9].offset = offsetof(Tlineinfo164338, col);
TMP19[9].typ = (&NTI112);
TMP19[9].name = "col";
TMP141[2] = &TMP19[10];
TMP19[10].kind = 1;
TMP19[10].offset = offsetof(Tlineinfo164338, fileindex);
TMP19[10].typ = (&NTI114);
TMP19[10].name = "fileIndex";
TMP19[7].len = 3; TMP19[7].kind = 2; TMP19[7].sons = &TMP141[0];
NTI164338.node = &TMP19[7];
...
NTI164005.base = 0;
NTI164005.flags = 3;
for (TMP1961 = 0; TMP1961 < 278; TMP1961++) {
TMP19[TMP1961+12].kind = 1;
TMP19[TMP1961+12].offset = TMP1961;
TMP19[TMP1961+12].name = TMP1960[TMP1961];
TMP1959[TMP1961] = &TMP19[TMP1961+12];
}
TMP19[290].len = 278; TMP19[290].kind = 2; TMP19[290].sons = &TMP1959[0];
NTI164005.node = &TMP19[290];
