		...
		getenvvarsc_119602();
		{
			...
			res_142899 = 0;
			{
				while (1) {
					...
					key_142859 = copyStrLast(environment_119409->data[i_142895], 0, (NI32)(p_142901 - 1));
					val_142860 = copyStr(environment_119409->data[i_142895], (NI32)(p_142901 + 1));
					counter += 1;
					res_142899 += 1;
				} LA4: ;
			}
		...
		getenvvarsc_119602();
		{
			...
			res_142918 = 0;
			{
				while (1) {
					...
					key_142875 = copyStrLast(environment_119409->data[i_142914], 0, (NI32)(p_142920 - 1));
					val_142876 = copyStr(environment_119409->data[i_142914], (NI32)(p_142920 + 1));
					LOC10 = 0;
