		...
		getenvvarsc_121002();
		{
			...
			res_143899 = 0;
			{
				while (1) {
					...
					key_143859 = copyStrLast(environment_120809->data[i_143895], 0, (NI32)(p_143901 - 1));
					val_143860 = copyStr(environment_120809->data[i_143895], (NI32)(p_143901 + 1));
					counter += 1;
					res_143899 += 1;
				} LA4: ;
			}
		...
		getenvvarsc_121002();
		{
			...
			res_143918 = 0;
			{
				while (1) {
					...
					key_143875 = copyStrLast(environment_120809->data[i_143914], 0, (NI32)(p_143920 - 1));
					val_143876 = copyStr(environment_120809->data[i_143914], (NI32)(p_143920 + 1));
					LOC10 = 0;
