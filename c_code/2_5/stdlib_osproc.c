...
appendString(result, backslashbuff);
		...
		nimln(2807, "system.nim");
		{
			...
			nimln(2807, "system.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP335));
		}
		LA22: ;
	} LA7: ;
	nimln(78, "osproc.nim");
...
N_NIMCALL(NI, nospexecProcesses)(NimStringDesc** cmds, NI cmdsLen0, NU8 options_128808, NI n) {
	...
	nimln(276, "osproc.nim");
	{
		...
		if (!!((0 < n))) goto LA3;
		nimln(276, "osproc.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP351));
	}
	LA3: ;
...
N_NIMCALL(tprocess128203*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, tstringtable122810* env, NU8 options) {
	...
	nimln(643, "osproc.nim");
	{
		...
		nimln(646, "osproc.nim");
		{
			...
			nimln(646, "osproc.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP383));
		}
		LA27: ;
	}
	goto LA17;
...
N_NIMCALL(void, createfdset_131402)(fd_set* fd, TY129203* s, NI* m) {
	...
	while (1) {
		...
		nimln(2798, "system.nim");
		{
			...
			nimln(2798, "system.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP389));
		}
		LA4: ;
	} LA1: ;
	popFrame();
