...
N_NIMCALL(tnode192813*, semnodekindconstraints_281472)(tnode192813* p) {
	...
	nimln(120, "parampatterns.nim");
	{
		...
		nimln(120, "parampatterns.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP3602));
	}
	LA3: ;
...
N_NIMCALL(NU8, checkforsideeffects_281740)(tnode192813* n) {
	...
	case ((NU8) 32):
	{
		...
		nimln(143, "parampatterns.nim");
		{
			...
			LOC4 = isroutine_199040((*op).kindU.S4.Sym);
			LA5: ;
			if (!LOC4) goto LA6;
...
N_NIMCALL(NIM_BOOL, matchnodekinds_282344)(tnode192813* p, tnode192813* n) {
	...
	while (1) {
		...
		case ((NU8) 2):
		{
			...
			nimln(242, "parampatterns.nim");
			TMP3607 = subInt(sp, 1);
			if ((NU)((NI32)(TMP3607)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI32)(TMP3607))- 0];
			if (LOC4) goto LA5;
			nimln(242, "parampatterns.nim");
			TMP3608 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3608)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI32)(TMP3608))- 0];
			LA5: ;
			stack[((NI32)(TMP3606))- 0] = LOC4;
		...
		case ((NU8) 3):
		{
			...
			nimln(245, "parampatterns.nim");
			TMP3610 = subInt(sp, 1);
			if ((NU)((NI32)(TMP3610)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI32)(TMP3610))- 0];
			if (!(LOC7)) goto LA8;
			nimln(245, "parampatterns.nim");
			TMP3611 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3611)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI32)(TMP3611))- 0];
			LA8: ;
			stack[((NI32)(TMP3609))- 0] = LOC7;
		...
		case ((NU8) 4):
		{
			...
			nimln(247, "parampatterns.nim");
			TMP3612 = subInt(sp, 1);
			if ((NU)((NI32)(TMP3612)) > (NU)(64)) raiseIndexError();
			nimln(247, "parampatterns.nim");
			nimln(247, "parampatterns.nim");
			TMP3613 = subInt(sp, 1);
			if ((NU)((NI32)(TMP3613)) > (NU)(64)) raiseIndexError();
			stack[((NI32)(TMP3612))- 0] = !(stack[((NI32)(TMP3613))- 0]);
		}
		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(254, "parampatterns.nim");
			TMP3614 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3614)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3614)])), ((NU8) 0), ((NU8) 24)));
			nimln(233, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			nimln(258, "parampatterns.nim");
			TMP3615 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3615)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3615)])), ((NU8) 0), ((NU8) 156)));
			nimln(233, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
	...
	nimln(266, "parampatterns.nim");
	TMP3616 = subInt(sp, 1);
	if ((NU)((NI32)(TMP3616)) > (NU)(64)) raiseIndexError();
	result = stack[((NI32)(TMP3616))- 0];
	popFrame();
	return result;
}
