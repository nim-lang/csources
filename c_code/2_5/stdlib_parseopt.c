...
static NIM_CONST TY179407 TMP1540 = {
0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY179407 TMP1541 = {
...
N_NIMCALL(void, initoptparser_176030)(NimStringDesc* cmdline, Optparser176011* Result) {
	...
	LA3: ;
	{
		unsureAsgnRef((void**) (&(*Result).cmd), copyString(((NimStringDesc*) &TMP1537)));
		{
			...
			i_176046 = 0;
			HEX3Atmp_176049 = 0;
			HEX3Atmp_176049 = paramcount_125830();
			res_176052 = ((NI) 1);
			{
				while (1) {
					NimStringDesc* LOC9;
					...
					LOC9 = 0;
					LOC10 = 0;
					LOC10 = paramstr_125809(i_176046);
					LOC11 = 0;
...
N_NIMCALL(void, handleshortoption_176291)(Optparser176011* p) {
	...
	}
	{
		...
		i = parseword_176204((*p).cmd, i, (&(*p).val), TMP1540);
	}
	LA5: ;
	{
...
{	i = (*p).pos;
	...
	case 45:
	{
		i += ((NI) 1);
		{
			...
			(*p).kind = ((NU8) 2);
			i += ((NI) 1);
			i = parseword_176204((*p).cmd, i, (&(*p).key), TMP1541);
			{
				while (1) {
			...
			}
			{
				...
				(*p).pos = parseword_176204((*p).cmd, i, (&(*p).val), TMP1540);
			}
			goto LA15;
			LA17: ;
			{
	...
	{
		(*p).kind = ((NU8) 1);
		(*p).pos = parseword_176204((*p).cmd, i, (&(*p).key), TMP1540);
	}
	break;
	}
	}BeforeRet: ;
