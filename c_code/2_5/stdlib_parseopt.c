...
N_NIMCALL(NI, parseword_524002)(NimStringDesc* s, NI i, NimStringDesc** w, TY122387 delim);
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY122387 TMP7637 = {
...
N_NIMCALL(void, initoptparser_523819)(NimStringDesc* cmdline, toptparser523807* Result) {
	...
	LA3: ;
	{
		...
		HEX3Atmp_523837 = paramcount_115233();
...
TMP7640[0] = &TMP7629[1];
TMP7629[1].kind = 1;
TMP7629[1].offset = offsetof(toptparser523807, Cmd);
TMP7629[1].typ = (&NTI143);
TMP7629[1].name = "cmd";
TMP7640[1] = &TMP7629[2];
TMP7629[2].kind = 1;
TMP7629[2].offset = offsetof(toptparser523807, Pos);
TMP7629[2].typ = (&NTI106);
TMP7629[2].name = "pos";
TMP7640[2] = &TMP7629[3];
TMP7629[3].kind = 1;
TMP7629[3].offset = offsetof(toptparser523807, Inshortstate);
...
NTI523805.node = &TMP7629[9];
TMP7629[4].kind = 1;
TMP7629[4].offset = offsetof(toptparser523807, Kind);
TMP7629[4].typ = (&NTI523805);
TMP7629[4].name = "kind";
TMP7640[4] = &TMP7629[10];
TMP7629[10].kind = 1;
TMP7629[10].offset = offsetof(toptparser523807, Key);
TMP7629[10].typ = (&NTI143);
TMP7629[10].name = "key";
TMP7640[5] = &TMP7629[11];
TMP7629[11].kind = 1;
TMP7629[11].offset = offsetof(toptparser523807, Val);
TMP7629[11].typ = (&NTI143);
TMP7629[11].name = "val";
TMP7629[0].len = 6; TMP7629[0].kind = 2; TMP7629[0].sons = &TMP7640[0];
NTI523807.node = &TMP7629[0];
}
