...
N_NIMCALL(void, writerope_163105)(Ropeobj162009* head, NimStringDesc* filename, NIM_BOOL usewarning) {
	...
	LA4: ;
	{
		errorhandler_162028.ClEnv? errorhandler_162028.ClPrc(((NU8) 0), filename, usewarning, errorhandler_162028.ClEnv):((TMP4320)(errorhandler_162028.ClPrc))(((NU8) 0), filename, usewarning);
	}
	LA1: ;
}
