			...
			res_169233 = ((NI) 0);
			{
				while (1) {
					...
					h_169229 = res_169233;
					{
						...
						{
							if (!!(eqStrings(val_169215, ((NimStringDesc*) &TMP1467)))) goto LA11;
							result += ((NI) 1);
						}
						LA11: ;
					}
...
N_NIMCALL(void, definesymbol_169013)(NimStringDesc* symbol) {
	nstPut(gsymbols_169004, symbol, ((NimStringDesc*) &TMP1515));
}

N_NIMCALL(void, initdefines_169254)(void) {
	asgnRef((void**) (&gsymbols_169004), nstnewStringTable(((NU8) 2)));
	definesymbol_169013(((NimStringDesc*) &TMP1516));
	definesymbol_169013(((NimStringDesc*) &TMP1517));
	definesymbol_169013(((NimStringDesc*) &TMP1518));
	definesymbol_169013(((NimStringDesc*) &TMP1519));
	definesymbol_169013(((NimStringDesc*) &TMP1520));
	definesymbol_169013(((NimStringDesc*) &TMP1521));
...
N_NIMCALL(void, undefsymbol_169022)(NimStringDesc* symbol) {
	nstPut(gsymbols_169004, symbol, ((NimStringDesc*) &TMP1467));
}
