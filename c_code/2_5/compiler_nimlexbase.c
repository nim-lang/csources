...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP1618, "L.sentinel < L.bufLen ", 22);
STRING_LITERAL(TMP1621, "0 <= toCopy ", 12);
STRING_LITERAL(TMP1629, "s < L.bufLen ", 13);
STRING_LITERAL(TMP1633, "L.bufLen - oldBufLen == oldBufLen ", 34);
STRING_LITERAL(TMP1639, "pos <= L.sentinel ", 18);
STRING_LITERAL(TMP1641, "L.buf[pos] == \'\\x0D\' ", 21);
STRING_LITERAL(TMP1642, "L.buf[pos] == \'\\x0A\' ", 21);
STRING_LITERAL(TMP1643, "0 < bufLen ", 11);
STRING_LITERAL(TMP1647, "", 0);
STRING_LITERAL(TMP1648, "\012", 1);
STRING_LITERAL(TMP1649, "^\012", 2);
...
N_NIMCALL(void, fillbuffer_163072)(tbaselexer163018* l) {
	...
	nimln(82, "nimlexbase.nim");
	{
		...
		nimln(82, "nimlexbase.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP1618));	}	LA3: ;
	nimln(83, "nimlexbase.nim");
	nimln(83, "nimlexbase.nim");
	nimln(83, "nimlexbase.nim");
	TMP1619 = subInt((*l).Buflen, (*l).Sentinel);
	TMP1620 = subInt((NI32)(TMP1619), 1);
	tocopy = (NI32)(TMP1620);
	nimln(84, "nimlexbase.nim");
	{
		...
		nimln(84, "nimlexbase.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP1621));	}	LA7: ;
	nimln(85, "nimlexbase.nim");
	{
		...
		nimln(86, "nimlexbase.nim");
		TMP1623 = mulInt(tocopy, 1);
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI32)(TMP1622)])), (NI32)(TMP1623));	}	LA11: ;
	...
	TMP1625 = mulInt((NI32)(TMP1624), 1);
	LOC13 = 0;
	LOC13 = llstreamread_162242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI32)(TMP1625));
	TMP1626 = divInt(LOC13, 1);
	charsread = (NI32)(TMP1626);
	nimln(90, "nimlexbase.nim");
	nimln(90, "nimlexbase.nim");
	TMP1627 = addInt(tocopy, charsread);
	s = (NI32)(TMP1627);
	nimln(91, "nimlexbase.nim");
	{
		...
		if (!(charsread < (NI32)(TMP1628))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			nimln(98, "nimlexbase.nim");
			{
				...
				nimln(98, "nimlexbase.nim");
				hiddenraiseassert_76217(((NimStringDesc*) &TMP1629));			}			LA22: ;
			...
			LA29: ;
			{
				...
				nimln(108, "nimlexbase.nim");
				TMP1630 = mulInt((*l).Buflen, 2);
				(*l).Buflen = (NI32)(TMP1630);
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				TMP1631 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4007(((void*) ((*l).Buf)), (NI32)(TMP1631));
				...
				nimln(110, "nimlexbase.nim");
				{
					...
					nimln(110, "nimlexbase.nim");
					nimln(110, "nimlexbase.nim");
					TMP1632 = subInt((*l).Buflen, oldbuflen);
					if (!!(((NI32)(TMP1632) == oldbuflen))) goto LA35;
					nimln(110, "nimlexbase.nim");
					hiddenraiseassert_76217(((NimStringDesc*) &TMP1633));				}				LA35: ;
				nimln(111, "nimlexbase.nim");
				nimln(112, "nimlexbase.nim");
				nimln(111, "nimlexbase.nim");
				nimln(112, "nimlexbase.nim");
				TMP1634 = mulInt(oldbuflen, 1);
				LOC37 = 0;
				LOC37 = llstreamread_162242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI32)(TMP1634));
				TMP1635 = divInt(LOC37, 1);
				charsread = (NI32)(TMP1635);
...
N_NIMCALL(NI, fillbaselexer_163812)(tbaselexer163018* l, NI pos) {
	...
	nimln(120, "nimlexbase.nim");
	{
		...
		nimln(120, "nimlexbase.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP1639));	}	LA3: ;
...
N_NIMCALL(NI, handlecr_163050)(tbaselexer163018* l, NI pos) {
	...
	nimln(130, "nimlexbase.nim");
	{
		...
		nimln(130, "nimlexbase.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP1641));	}	LA3: ;
...
N_NIMCALL(NI, handlelf_163056)(tbaselexer163018* l, NI pos) {
	...
	nimln(137, "nimlexbase.nim");
	{
		...
		nimln(137, "nimlexbase.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP1642));	}	LA3: ;
...
N_NIMCALL(void, openbaselexer_163027)(tbaselexer163018* l, tllstream162204* inputstream, NI buflen) {
	...
	nimln(147, "nimlexbase.nim");
	{
		...
		nimln(147, "nimlexbase.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP1643));	}	LA3: ;
	...
	nimln(150, "nimlexbase.nim");
	nimln(150, "nimlexbase.nim");
	TMP1644 = mulInt(buflen, 1);
	LOC5 = 0;
	LOC5 = alloc_4001((NI32)(TMP1644));
	(*l).Buf = ((NCSTRING) (LOC5));
	nimln(151, "nimlexbase.nim");
	nimln(151, "nimlexbase.nim");
	TMP1645 = subInt(buflen, 1);
	(*l).Sentinel = (NI32)(TMP1645);
...
N_NIMCALL(NI, getcolnumber_163045)(tbaselexer163018* l, NI pos) {
	...
	nimln(159, "nimlexbase.nim");
	nimln(159, "nimlexbase.nim");
	TMP1646 = subInt(pos, (*l).Linestart);
	if ((NI32)(TMP1646) == (-2147483647 -1)) raiseOverflow();
	result = (NI32)abs((NI32)(TMP1646));
	popFrame();
	return result;
}
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src) {
...
N_NIMCALL(NimStringDesc*, getcurrentline_163040)(tbaselexer163018* l, NIM_BOOL marker) {
	...
	result = copyString(((NimStringDesc*) &TMP1647));
...
appendString(result, ((NimStringDesc*) &TMP1648));
...
appendString(LOC6, ((NimStringDesc*) &TMP1649));
...
static TNimNode* TMP1887[7];
static TNimNode TMP1593[8];
...
TMP1887[0] = &TMP1593[1];
TMP1593[1].kind = 1;
TMP1593[1].offset = offsetof(tbaselexer163018, Bufpos);
TMP1593[1].typ = (&NTI105);
TMP1593[1].name = "bufpos";
TMP1887[1] = &TMP1593[2];
TMP1593[2].kind = 1;
TMP1593[2].offset = offsetof(tbaselexer163018, Buf);
TMP1593[2].typ = (&NTI144);
TMP1593[2].name = "buf";
TMP1887[2] = &TMP1593[3];
TMP1593[3].kind = 1;
TMP1593[3].offset = offsetof(tbaselexer163018, Buflen);
TMP1593[3].typ = (&NTI105);
TMP1593[3].name = "bufLen";
TMP1887[3] = &TMP1593[4];
TMP1593[4].kind = 1;
TMP1593[4].offset = offsetof(tbaselexer163018, Stream);
TMP1593[4].typ = (&NTI162206);
TMP1593[4].name = "stream";
TMP1887[4] = &TMP1593[5];
TMP1593[5].kind = 1;
TMP1593[5].offset = offsetof(tbaselexer163018, Linenumber);
TMP1593[5].typ = (&NTI105);
TMP1593[5].name = "LineNumber";
TMP1887[5] = &TMP1593[6];
TMP1593[6].kind = 1;
TMP1593[6].offset = offsetof(tbaselexer163018, Sentinel);
TMP1593[6].typ = (&NTI105);
TMP1593[6].name = "sentinel";
TMP1887[6] = &TMP1593[7];
TMP1593[7].kind = 1;
TMP1593[7].offset = offsetof(tbaselexer163018, Linestart);
TMP1593[7].typ = (&NTI105);
TMP1593[7].name = "lineStart";
TMP1593[0].len = 7; TMP1593[0].kind = 2; TMP1593[0].sons = &TMP1887[0];
NTI163018.node = &TMP1593[0];
}
