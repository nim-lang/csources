...
NIM_CONST TY220016 parsernames_220015 = {((NimStringDesc*) &TMP2689),
...
N_NIMCALL(tnode187813*, parseall_220049)(tparsers220029* p) {
	...
	case ((NU8) 3):
	{
		...
		internalerror_165606(((NimStringDesc*) &TMP2701));
...
N_NIMCALL(tllstream175204*, evalpipe_220461)(tparsers220029* p, tnode187813* n, NimStringDesc* filename, tllstream175204* start) {
	...
	nimln(151, "syntaxes.nim");
	{
		...
		if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP2707[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2708));
		LOC7 = identeq_167469((*(*n).kindU.S6.Sons->data[0]).kindU.S5.Ident, ((NimStringDesc*) &TMP2709));
		LA10: ;
		if (!LOC7) goto LA11;
		i_220550 = 0;
		nimln(1450, "system.nim");
...
NTI220005.node = &TMP2282[6];
TMP2282[1].kind = 1;
TMP2282[1].offset = offsetof(tparsers220029, Skin);
TMP2282[1].typ = (&NTI220005);
TMP2282[1].name = "skin";
TMP2697[1] = &TMP2282[7];
TMP2282[7].kind = 1;
TMP2282[7].offset = offsetof(tparsers220029, Parser);
TMP2282[7].typ = (&NTI205203);
TMP2282[7].name = "parser";
TMP2282[0].len = 2; TMP2282[0].kind = 2; TMP2282[0].sons = &TMP2697[0];
NTI220029.node = &TMP2282[0];
}
