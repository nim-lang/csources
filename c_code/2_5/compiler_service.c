...
extern TY165063 writelnhook_165066;
...
appendString(LOC1, ((NimStringDesc*) &TMP4999));
	send_520208((*HEX3Aenvp_523440).stdoutsocket523408, LOC1, 2);
}
...
N_NIMCALL(void, serve_523257)(TY523259 action) {
	...
	typ = getconfigvar_155340(((NimStringDesc*) &TMP4990));
	...
	LA2: ;
	{
		...
		p = getconfigvar_155340(((NimStringDesc*) &TMP4995));
		{
			NI LOC18;
		...
		LA14: ;
		LOC20 = 0;
		LOC20 = getconfigvar_155340(((NimStringDesc*) &TMP4996));
		bindaddr_516620(server, port, LOC20);
		inp = copyString(((NimStringDesc*) &TMP1077));
		listen_516610(server, SOMAXCONN);
		...
		asgnRef((void**) (&writelnhook_165066.ClEnv), LOC21.ClEnv);
		writelnhook_165066.ClPrc = LOC21.ClPrc;
		{
			while (1) {
				NimStringDesc* LOC24;
				...
				action();
				gerrorcounter_165019 = ((NI) 0);
				send_520208((*HEX3Aenv_523449).stdoutsocket523408, ((NimStringDesc*) &TMP4999), 2);
...
NIM_EXTERNC N_NOINLINE(void, compiler_serviceInit)(void) {
	...
	NimStringDesc* LOC2;
	LOC1 = 0;
	LOC1 = curcaascmd_523204; curcaascmd_523204 = copyStringRC1(((NimStringDesc*) &TMP1077));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	LOC2 = 0;
	LOC2 = lastcaascmd_523205; lastcaascmd_523205 = copyStringRC1(((NimStringDesc*) &TMP1077));
...
TMP4985[0] = &TMP1071[1];
TMP1071[1].kind = 1;
TMP1071[1].offset = offsetof(TY523428, HEX3Astate);
TMP1071[1].typ = (&NTI311033);
TMP1071[1].name = ":state";
TMP4985[1] = &TMP1071[2];
TMP1071[2].kind = 1;
TMP1071[2].offset = offsetof(TY523428, stdoutsocket523408);
TMP1071[2].typ = (&NTI515409);
TMP1071[2].name = "stdoutSocket523408";
TMP1071[0].len = 2; TMP1071[0].kind = 2; TMP1071[0].sons = &TMP4985[0];
NTI523428.node = &TMP1071[0];
NTI523450.size = sizeof(TY523428*);
NTI523450.kind = 22;
NTI523450.base = (&NTI523428);
NTI523450.flags = 2;
NTI523450.marker = TMP4989;
}
