...
N_NIMCALL(NimStringDesc*, setcookie_335117)(NimStringDesc* key, NimStringDesc* value, ttimeinfo95003* expires, NimStringDesc* domain, NimStringDesc* path, NIM_BOOL noname);
...
N_NIMCALL(NimStringDesc*, setcookie_335117)(NimStringDesc* key, NimStringDesc* value, ttimeinfo95003* expires, NimStringDesc* domain, NimStringDesc* path, NIM_BOOL noname) {
	...
	LOC1 = 0;
	LOC1 = format_96999(expires, ((NimStringDesc*) &TMP4693));
