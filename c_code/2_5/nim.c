...
N_NIMCALL(void, handlecmdline_612607)(void);
...
N_NIMCALL(NimStringDesc*, prependcurdir_612401)(NimStringDesc* f);
...
STRING_LITERAL(TMP1905, "nim.cfg", 7);
STRING_LITERAL(TMP4863, "./", 2);
STRING_LITERAL(TMP4864, "js", 2);
STRING_LITERAL(TMP4865, "node ", 5);
...
appendString(LOC7, ((NimStringDesc*) &TMP4863));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
N_NIMCALL(void, handlecmdline_612607)(void) {
	...
	LA4: ;
	{
		processcmdline_606209(((NU8) 0), ((NimStringDesc*) &TMP1879));
		{
			TSafePoint TMP1880;
			TY117204 p;
			NimStringDesc* LOC15;
			NimStringDesc* LOC16;
			if (!!(((gprojectname_170232) && (gprojectname_170232)->Sup.len == 0))) goto LA9;
			pushSafePoint(&TMP1880);
			TMP1880.status = setjmp(TMP1880.context);
			if (TMP1880.status == 0) {
				asgnRefNoCycle((void**) &gprojectfull_170234, canonicalizepath_170388(gprojectname_170232));
				popSafePoint();
			}
			else {
				popSafePoint();
				if (isObj(getCurrentException()->Sup.m_type, (&NTI3233))) {
					...
					TMP1880.status = 0;
					LOC14 = 0;
					LOC14 = gprojectfull_170234; gprojectfull_170234 = copyStringRC1(gprojectname_170232);
			...
			chckNil((void*)&p);
			memset((void*)&p, 0, sizeof(p));
			nossplitFile(gprojectfull_170234, &p);
			LOC15 = 0;
			LOC15 = gprojectpath_170233; gprojectpath_170233 = copyStringRC1(p.Field0);
			if (LOC15) nimGCunrefNoCycle(LOC15);
			LOC16 = 0;
			LOC16 = gprojectname_170232; gprojectname_170232 = copyStringRC1(p.Field1);
			if (LOC16) nimGCunrefNoCycle(LOC16);
		}
		goto LA7;
		LA9: ;
		{
			asgnRefNoCycle((void**) &gprojectpath_170233, nosgetCurrentDir());
		}
		LA7: ;
		loadconfigs_221811(((NimStringDesc*) &TMP1905));
		initvars_203820();
		processcmdline_606209(((NU8) 1), ((NimStringDesc*) &TMP1879));
		maincommand_610027();
		{
			NimStringDesc* LOC22;
		...
		LA20: ;
		{
			if (!(gerrorcounter_197306 == 0)) goto LA25;
			{
				if (!((gglobaloptions_170118 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				{
					...
					ex = 0;
					{
						...
						LOC39 = 0;
						LOC39 = prependcurdir_612401(outfile_170124);
					...
					LA37: ;
					{
						...
						NimStringDesc* LOC43;
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_170234, ((NimStringDesc*) &TMP4864));
						LOC42 = 0;
						LOC42 = prependcurdir_612401(LOC41);
						LOC43 = 0;
...
appendString(LOC44, ((NimStringDesc*) &TMP4865));
appendString(LOC44, ex);
appendChar(LOC44, 32);
appendString(LOC44, arguments_211144);
					execexternalprogram_203907(LOC44, ((NimStringDesc*) &TMP1879));
				}
				goto LA31;
				LA33: ;
				{
					...
					binpath = 0;
					{
						...
						binpath = prependcurdir_612401(outfile_170124);
					}
					goto LA46;
					LA48: ;
					{
						NimStringDesc* LOC51;
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_170234, ((NimStringDesc*) &TMP1879));
						binpath = prependcurdir_612401(LOC51);
					}
					LA46: ;
...
appendString(LOC52, arguments_211144);
					execexternalprogram_203907(LOC52, ((NimStringDesc*) &TMP1879));
				}
				LA31: ;
			}
			LA29: ;
...
NIM_EXTERNC N_NOINLINE(void, nimInit)(void) {
	...
	initdefines_202146();
	handlecmdline_612607();
	exit(((NI) (((NI8) ((0 < gerrorcounter_197306))))));
}
