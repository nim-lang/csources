...
N_NIMCALL(NIM_BOOL, endswithopr_162437)(NimStringDesc* x) {
	...
	result = endswith_162402(x, TMP1604);
	popFrame();
	return result;
}
static N_INLINE(NIM_BOOL, continueline_162443)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_162402(line, TMP1605);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(NI, counttriples_162462)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1606 = addInt(i, 1);
			if ((NU)((NI32)(TMP1606)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI32)(TMP1606)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			...
			LOC4 = ((NU8)(s->data[(NI32)(TMP1607)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
N_NIMCALL(NI, llstreamread_162242)(tllstream162204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		nimln(136, "llstream.nim");
		{
			...
			memcpy(buf, ((void*) (&(*s).S->data[(NI32)(TMP1613)])), result);			nimln(138, "llstream.nim");
			(*s).Rd = addInt((*s).Rd, result);
		}		LA5: ;
	}	break;
	case ((NU8) 2):
...
N_NIMCALL(void, llstreamwriteln_162274)(tllstream162204* s, NimStringDesc* data) {
	...
	llstreamwrite_162258(s, ((NimStringDesc*) &TMP1610));	popFrame();
}
N_NIMCALL(void, llstreamwrite_162263)(tllstream162204* s, NIM_CHAR data) {
	NIM_CHAR c;
	nimfr("LLStreamWrite", "llstream.nim")
...
N_NIMCALL(void, llstreamwrite_162268)(tllstream162204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			(*s).S = setLengthStr((*s).S, (NI32)(TMP1614));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1615 = addInt(0, (*s).Wr);
			if ((NU)((NI32)(TMP1615)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI32)(TMP1615)])), buf, buflen);			nimln(202, "llstream.nim");
...
NTI162202.node = &TMP1595[6];
TMP1595[1].kind = 1;
TMP1595[1].offset = offsetof(tllstream162204, Kind);
TMP1595[1].typ = (&NTI162202);
TMP1595[1].name = "kind";
TMP1597[1] = &TMP1595[7];
TMP1595[7].kind = 1;
TMP1595[7].offset = offsetof(tllstream162204, F);
TMP1595[7].typ = (&NTI9004);
TMP1595[7].name = "f";
TMP1597[2] = &TMP1595[8];
TMP1595[8].kind = 1;
TMP1595[8].offset = offsetof(tllstream162204, S);
TMP1595[8].typ = (&NTI142);
TMP1595[8].name = "s";
TMP1597[3] = &TMP1595[9];
TMP1595[9].kind = 1;
TMP1595[9].offset = offsetof(tllstream162204, Rd);
TMP1595[9].typ = (&NTI105);
TMP1595[9].name = "rd";
TMP1597[4] = &TMP1595[10];
TMP1595[10].kind = 1;
TMP1595[10].offset = offsetof(tllstream162204, Wr);
TMP1595[10].typ = (&NTI105);
TMP1595[10].name = "wr";
TMP1597[5] = &TMP1595[11];
TMP1595[11].kind = 1;
TMP1595[11].offset = offsetof(tllstream162204, Lineoffset);
TMP1595[11].typ = (&NTI105);
TMP1595[11].name = "lineOffset";
TMP1595[0].len = 6; TMP1595[0].kind = 2; TMP1595[0].sons = &TMP1597[0];
NTI162204.node = &TMP1595[0];
NTI162206.size = sizeof(tllstream162204*);
NTI162206.kind = 22;
NTI162206.base = (&NTI162204);
NTI162206.flags = 2;
NTI162206.marker = TMP1601;
}
