...
NimStringDesc* curcaascmd_529203;
extern TFrame* frameptr_13238;
extern tgcheap43816 gch_43844;
NimStringDesc* lastcaascmd_529204;
NimStringDesc* arguments_529205;
extern TNimType NTI527807; /* TOptParser */
...
extern tsocketimpl154605* stdoutsocket_168192;
...
N_NIMCALL(void, processcmdline_529207)(NU8 pass, NimStringDesc* cmd) {
	...
	p.Sup.m_type = (&NTI527807);
	initoptparser_527819(cmd, &p);
...
appendString(LOC8, p.Val);
				...
				processswitch_177016(key, val, pass, gcmdlineinfo_168104);
			}
			goto LA4;
			LA6: ;
			{
				nimln(48, "service.nim");
				processswitch_177016(p.Key, p.Val, pass, gcmdlineinfo_168104);
			}
			LA4: ;
		}
		break;
		case ((NU8) 1):
		{
			...
			LA14: ;
			{
				...
				nimln(54, "service.nim");
				{
					...
					asgnRefNoCycle((void**) &arguments_529205, npocmdLineRest(&p));
	...
	nimln(61, "service.nim");
	{
		...
		nimln(62, "service.nim");
		{
			...
			nimln(62, "service.nim");
			nimln(62, "service.nim");
			LOC33 = !(((arguments_529205) && (arguments_529205)->Sup.len == 0));
			LA34: ;
			if (!LOC33) goto LA35;
...
N_NIMCALL(void, serve_529292)(TY529294 action) {
	...
	LA1: ;
	{
		...
		while (1) {
			...
			LOC11 = 0;
			LOC11 = curcaascmd_529203; curcaascmd_529203 = copyStringRC1(line);
			if (LOC11) nimGCunrefNoCycle(LOC11);
			nimln(68, "service.nim");
			processcmdline_529207(((NU8) 1), line);
	...
	LA2: ;
	{
		...
		if (stdoutsocket_168192) nimGCunrefNoCycle(stdoutsocket_168192);
		stdoutsocket_168192 = (tsocketimpl154605*) newObjRC1((&NTI154607), sizeof(tsocketimpl154605));
		nimln(94, "service.nim");
		while (1) {
			NimStringDesc* LOC26;
			nimln(95, "service.nim");
			accept_158201(server, &stdoutsocket_168192);
			nimln(96, "service.nim");
			readline_163033(stdoutsocket_168192, &inp, -1);
			nimln(67, "service.nim");
			LOC26 = 0;
			LOC26 = curcaascmd_529203; curcaascmd_529203 = copyStringRC1(inp);
			if (LOC26) nimGCunrefNoCycle(LOC26);
			nimln(68, "service.nim");
			processcmdline_529207(((NU8) 1), inp);
			nimln(69, "service.nim");
			action();
			nimln(70, "service.nim");
			gdirtybufferidx_139127 = ((NI32) 0);
			...
			send_164604(stdoutsocket_168192, ((NimStringDesc*) &TMP7681));
			nimln(99, "service.nim");
			close_158266(stdoutsocket_168192);
		}
	}
	goto LA4;
	LA3: ;
...
N_NOINLINE(void, serviceInit)(void) {
	...
	LOC1 = 0;
	LOC1 = curcaascmd_529203; curcaascmd_529203 = copyStringRC1(((NimStringDesc*) &TMP7639));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(25, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_529204; lastcaascmd_529204 = copyStringRC1(((NimStringDesc*) &TMP7639));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(28, "service.nim");
	LOC3 = 0;
	LOC3 = arguments_529205; arguments_529205 = copyStringRC1(((NimStringDesc*) &TMP7639));
