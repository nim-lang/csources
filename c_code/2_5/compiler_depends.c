...
N_NIMCALL(void, adddependencyaux_508028)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	addf_163635(&gdotgraph_508023, ((NimStringDesc*) &TMP4958), LOC1, 2);
}
...
N_NIMCALL(void, generatedot_508009)(NimStringDesc* project) {
	...
	LOC4 = 0;
	LOC4 = HEX25_163235(((NimStringDesc*) &TMP4959), LOC1, 2);
	LOC5 = 0;
...
TMP1067[0].kind = 1;
TMP1067[0].offset = offsetof(Tgen508016, module);
TMP1067[0].typ = (&NTI192811);
TMP1067[0].name = "module";
NTI508016.node = &TMP1067[0];
NTI508018.size = sizeof(Tgen508016*);
NTI508018.kind = 22;
NTI508018.base = (&NTI508016);
NTI508018.marker = TMP4957;
}
