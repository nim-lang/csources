...
static NIM_CONST TY188025 TMP5614 = {
...
static NIM_CONST TY188025 TMP5621 = {
...
N_NIMCALL(NU8, ispartofaux_412020)(tnode187813* n, ttype187847* b, tintset184047* marker) {
	...
	case ((NU8) 137):
	{
		...
		nimln(29, "aliases.nim");
		{
			...
			nimln(29, "aliases.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP5617));
		}
		LA11: ;
		...
		while (1) {
			...
			default:
			{
				...
				internalerror_165606(((NimStringDesc*) &TMP5620));
			}
			break;
			}
			nimln(1453, "system.nim");
	...
	default:
	{
		...
		internalerror_165591((*n).Info, ((NimStringDesc*) &TMP5623));
	}
	break;
	}
	BeforeRet: ;
