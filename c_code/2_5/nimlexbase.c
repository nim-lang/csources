...
NIM_CONST TY122387 newlines_177014 = {
...
N_NIMCALL(NI, fillbaselexer_177812)(tbaselexer177018* l, NI pos) {
	...
	nimln(120, "nimlexbase.nim");
	{
		...
		nimln(120, "nimlexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP1670));
	}
	LA3: ;
...
N_NIMCALL(void, openbaselexer_177027)(tbaselexer177018* l, tllstream175204* inputstream, NI buflen) {
	...
	nimln(147, "nimlexbase.nim");
	{
		...
		nimln(147, "nimlexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP1674));
	}
	LA3: ;
...
TMP1918[0] = &TMP1624[1];
TMP1624[1].kind = 1;
TMP1624[1].offset = offsetof(tbaselexer177018, Bufpos);
TMP1624[1].typ = (&NTI106);
TMP1624[1].name = "bufpos";
TMP1918[1] = &TMP1624[2];
TMP1624[2].kind = 1;
TMP1624[2].offset = offsetof(tbaselexer177018, Buf);
TMP1624[2].typ = (&NTI145);
TMP1624[2].name = "buf";
TMP1918[2] = &TMP1624[3];
TMP1624[3].kind = 1;
TMP1624[3].offset = offsetof(tbaselexer177018, Buflen);
TMP1624[3].typ = (&NTI106);
TMP1624[3].name = "bufLen";
TMP1918[3] = &TMP1624[4];
TMP1624[4].kind = 1;
TMP1624[4].offset = offsetof(tbaselexer177018, Stream);
TMP1624[4].typ = (&NTI175206);
TMP1624[4].name = "stream";
TMP1918[4] = &TMP1624[5];
TMP1624[5].kind = 1;
TMP1624[5].offset = offsetof(tbaselexer177018, Linenumber);
TMP1624[5].typ = (&NTI106);
TMP1624[5].name = "lineNumber";
TMP1918[5] = &TMP1624[6];
TMP1624[6].kind = 1;
TMP1624[6].offset = offsetof(tbaselexer177018, Sentinel);
TMP1624[6].typ = (&NTI106);
TMP1624[6].name = "sentinel";
TMP1918[6] = &TMP1624[7];
TMP1624[7].kind = 1;
TMP1624[7].offset = offsetof(tbaselexer177018, Linestart);
TMP1624[7].typ = (&NTI106);
TMP1624[7].name = "lineStart";
TMP1624[0].len = 7; TMP1624[0].kind = 2; TMP1624[0].sons = &TMP1918[0];
NTI177018.node = &TMP1624[0];
}
