...
appendString((*result), ind);
		...
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI32)(TMP3782), lvltochar_297257[((*n).Level)- 0]);
...
N_NIMCALL(tjsonnode292114*, renderrsttojsonnode_297567)(trstnode297009* node) {
	...
	nimln(295, "rstast.nim");
	{
		...
		add_293844(result, ((NimStringDesc*) &TMP3812), LOC6);
	}
	LA4: ;
	nimln(297, "rstast.nim");
	{
		...
		add_293844(result, ((NimStringDesc*) &TMP3813), LOC15);
	}
	LA12: ;
	popFrame();
	return result;
...
NTI297003.node = &TMP3612[67];
TMP3612[1].kind = 1;
TMP3612[1].offset = offsetof(trstnode297009, Kind);
TMP3612[1].typ = (&NTI297003);
TMP3612[1].name = "kind";
TMP3771[1] = &TMP3612[68];
TMP3612[68].kind = 1;
TMP3612[68].offset = offsetof(trstnode297009, Text);
TMP3612[68].typ = (&NTI143);
TMP3612[68].name = "text";
TMP3771[2] = &TMP3612[69];
TMP3612[69].kind = 1;
TMP3612[69].offset = offsetof(trstnode297009, Level);
TMP3612[69].typ = (&NTI106);
TMP3612[69].name = "level";
TMP3771[3] = &TMP3612[70];
TMP3612[70].kind = 1;
TMP3612[70].offset = offsetof(trstnode297009, Sons);
TMP3612[70].typ = (&NTI297084);
TMP3612[70].name = "sons";
TMP3612[0].len = 4; TMP3612[0].kind = 2; TMP3612[0].sons = &TMP3771[0];
NTI297009.node = &TMP3612[0];
NTI297005.size = sizeof(trstnode297009*);
NTI297005.kind = 22;
NTI297005.base = (&NTI297009);
NTI297005.flags = 2;
NTI297005.marker = TMP3776;
}
