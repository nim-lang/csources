...
static NIM_CONST TY172865 TMP3601 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3602, "strVal", 6);
static NIM_CONST TY172865 TMP3603 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3604, "ident", 5);
static NIM_CONST TY172865 TMP3605 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3606, "sym", 3);
static NIM_CONST TY172865 TMP3607 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3608, "sons", 4);
STRING_LITERAL(TMP3609, "as", 2);
STRING_LITERAL(TMP3610, " ", 1);
STRING_LITERAL(TMP3611, "", 0);
STRING_LITERAL(TMP3612, ".", 1);
STRING_LITERAL(TMP3613, "/", 1);
STRING_LITERAL(TMP3614, "invalid module name: \'$1\'", 25);
STRING_LITERAL(TMP3616, "rawImportSymbol", 15);
STRING_LITERAL(TMP3617, "tab", 3);
STRING_LITERAL(TMP3618, "importSymbol: 2", 15);
STRING_LITERAL(TMP3619, "importSymbol: 3", 15);
STRING_LITERAL(TMP3620, "importAllSymbols: ", 18);
STRING_LITERAL(TMP3621, "a.Kind == nkSym ", 16);
STRING_LITERAL(TMP3622, "\'export except\' not implemented", 31);
STRING_LITERAL(TMP3624, "module alias must be an identifier", 34);
...
N_NIMCALL(NimStringDesc*, getmodulename_266012)(tnode172659* n) {
	...
	case ((NU8) 3):
	{
		...
		if (!(((TMP3605[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3606));
	...
	case ((NU8) 29):
	{
		...
		nimln(31, "importer.nim");
		{
			...
			if (((TMP3607[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3608));
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!(((TMP3603[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3604));
			nimln(31, "importer.nim");
			LOC9 = 0;
			LOC9 = getident_141443(((NimStringDesc*) &TMP3609));
		...
		result = nsuReplaceStr(LOC13, ((NimStringDesc*) &TMP3610), ((NimStringDesc*) &TMP3611));
	}	break;
	case ((NU8) 45):
	{
		NimStringDesc* LOC15;
		...
		result = nsuReplaceStr(LOC15, ((NimStringDesc*) &TMP3612), ((NimStringDesc*) &TMP3613));
	}	break;
	case ((NU8) 78):
	{
	...
	default:
	{
		...
		LOC19 = 0;
		LOC19 = nsuFormatSingleElem(((NimStringDesc*) &TMP3614), LOC18);
...
static N_INLINE(NIM_BOOL, haspattern_177877)(tsym172689* s) {
	...
	nimln(698, "system.nim");
	nimln(698, "system.nim");
	if (((TMP3607[(*(*s).Ast).Kind/8] &(1<<((*(*s).Ast).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3608));
...
N_NIMCALL(void, rawimportsymbol_266189)(tcontext263019* c, tsym172689* s) {
	...
	strtableadd_179078(&(*(*c).Importtable).Symbols, s);	nimln(71, "importer.nim");
	{
		...
		nimln(73, "importer.nim");
		{
			...
			TMP3615 = subInt(LOC21, 1);
			HEX3Atmp_266326 = (NI32)(TMP3615);
			...
			while (1) {
				...
				if (((TMP3607[(*(*etyp).N).Kind/8] &(1<<((*(*etyp).N).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3608));
				if ((NU)(j_266258) >= (NU)((*(*etyp).N).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (!(((TMP3605[(*(*(*etyp).N).kindU.S6.Sons->data[j_266258]).Kind/8] &(1<<((*(*(*etyp).N).kindU.S6.Sons->data[j_266258]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3606));
				...
				nimln(76, "importer.nim");
				{
					...
					internalerror_139369((*s).Info, ((NimStringDesc*) &TMP3616));				}				LA25: ;
...
N_NIMCALL(void, importsymbol_266334)(tcontext263019* c, tnode172659* n, tsym172689* frommod) {
	...
	if (!(((64 &(1<<(((*frommod).Kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3617));
	...
	LA3: ;
	{
		...
		nimln(102, "importer.nim");
		{
			...
			internalerror_139369((*n).Info, ((NimStringDesc*) &TMP3618));		}		LA12: ;
		...
		case ((NU8) 15):
		{
			...
			while (1) {
				...
				nimln(111, "importer.nim");
				{
					...
					nimln(111, "importer.nim");
					internalerror_139369((*n).Info, ((NimStringDesc*) &TMP3619));				}				LA18: ;
...
appendString(LOC14, ((NimStringDesc*) &TMP3620));
...
N_NIMCALL(void, importforwarded_266511)(tcontext263019* c, tnode172659* n, tintset169043 exceptset) {
	...
	case ((NU8) 117):
	{
		...
		while (1) {
			...
			nimln(137, "importer.nim");
			{
				...
				nimln(137, "importer.nim");
				hiddenraiseassert_76217(((NimStringDesc*) &TMP3621));			}			LA10: ;
			nimln(138, "importer.nim");
			if (!(((TMP3605[(*a_266524).Kind/8] &(1<<((*a_266524).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3606));
	...
	case ((NU8) 118):
	{
		...
		localerror_139349((*n).Info, ((NU16) 4), ((NimStringDesc*) &TMP3622));	}	break;
	default:
	{
		NI i_266630;
		NI HEX3Atmp_266648;
		...
		TMP3623 = subInt(LOC24, 1);
		HEX3Atmp_266648 = (NI32)(TMP3623);
		nimln(1308, "system.nim");
		res_266650 = 0;
		nimln(1309, "system.nim");
		while (1) {
...
N_NIMCALL(tsym172689*, importmoduleas_266656)(tnode172659* n, tsym172689* realmodule) {
	...
	LA3: ;
	{
		...
		localerror_139349((*n).Info, ((NU16) 4), ((NimStringDesc*) &TMP3624));	}	goto LA1;
	LA9: ;
	{
		nimln(698, "system.nim");
		nimln(698, "system.nim");
		if (((TMP3607[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3608));
		if ((NU)(1) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3603[(*(*n).kindU.S6.Sons->data[1]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[1]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3604));
...
N_NIMCALL(tnode172659*, evalimport_266002)(tcontext263019* c, tnode172659* n) {
	...
	TMP3625 = subInt(LOC1, 1);
	HEX3Atmp_266804 = (NI32)(TMP3625);
	nimln(1301, "system.nim");
	res_266806 = 0;
	nimln(1302, "system.nim");
	while (1) {
...
N_NIMCALL(tnode172659*, evalfrom_266007)(tcontext263019* c, tnode172659* n) {
	...
	nimln(180, "importer.nim");
	{
		...
		TMP3626 = subInt(LOC5, 1);
		HEX3Atmp_266891 = (NI32)(TMP3626);
		nimln(1301, "system.nim");
		res_266893 = 1;
		nimln(1302, "system.nim");
		while (1) {
