...
N_NIMCALL(NIM_BOOL, endswith_175602)(NimStringDesc* x, TY122387 s);
...
NIM_CONST TY122387 linecontinuationoprs_175641 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
NIM_CONST TY122387 additionallinecontinuationoprs_175643 = {
0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x24,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY122387 TMP1635 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY122387 TMP1636 = {
...
N_NIMCALL(NIM_BOOL, endswithopr_175646)(NimStringDesc* x) {
	...
	result = endswith_175602(x, TMP1635);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_175652)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_175602(line, TMP1636);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(void, llstreamwriteln_175274)(tllstream175204* s, NimStringDesc* data) {
	...
	llstreamwrite_175258(s, ((NimStringDesc*) &TMP1641));
	popFrame();
}
...
NTI175202.node = &TMP1626[6];
TMP1626[1].kind = 1;
TMP1626[1].offset = offsetof(tllstream175204, Kind);
TMP1626[1].typ = (&NTI175202);
TMP1626[1].name = "kind";
TMP1628[1] = &TMP1626[7];
TMP1626[7].kind = 1;
TMP1626[7].offset = offsetof(tllstream175204, F);
TMP1626[7].typ = (&NTI10004);
TMP1626[7].name = "f";
TMP1628[2] = &TMP1626[8];
TMP1626[8].kind = 1;
TMP1626[8].offset = offsetof(tllstream175204, S);
TMP1626[8].typ = (&NTI143);
TMP1626[8].name = "s";
TMP1628[3] = &TMP1626[9];
TMP1626[9].kind = 1;
TMP1626[9].offset = offsetof(tllstream175204, Rd);
TMP1626[9].typ = (&NTI106);
TMP1626[9].name = "rd";
TMP1628[4] = &TMP1626[10];
TMP1626[10].kind = 1;
TMP1626[10].offset = offsetof(tllstream175204, Wr);
TMP1626[10].typ = (&NTI106);
TMP1626[10].name = "wr";
TMP1628[5] = &TMP1626[11];
TMP1626[11].kind = 1;
TMP1626[11].offset = offsetof(tllstream175204, Lineoffset);
TMP1626[11].typ = (&NTI106);
TMP1626[11].name = "lineOffset";
TMP1626[0].len = 6; TMP1626[0].kind = 2; TMP1626[0].sons = &TMP1628[0];
NTI175204.node = &TMP1626[0];
NTI175206.size = sizeof(tllstream175204*);
NTI175206.kind = 22;
NTI175206.base = (&NTI175204);
NTI175206.marker = TMP1632;
}
