...
N_NIMCALL(void, TMP1639)(void* p, NI op);
...
N_NIMCALL(tllstream180204*, llstreamopen_180232)(void);
N_NIMCALL(tllstream180204*, llstreamopenstdin_180235)(void);
N_NIMCALL(void, llstreamclose_180238)(tllstream180204* s);
N_NIMCALL(NIM_BOOL, readlinefromstdin_180396)(NimStringDesc* prompt, NimStringDesc** line);
N_NIMCALL(void, write_10663)(FILE* f, NimStringDesc* s);
N_NIMCALL(NIM_BOOL, readline_10687)(FILE* f, NimStringDesc** line);
N_NIMCALL(NIM_BOOL, endswith_180602)(NimStringDesc* x, TY123387 s);
static N_INLINE(NI, subInt)(NI a, NI b);
N_NOINLINE(void, raiseOverflow)(void);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(NIM_BOOL, endswithopr_180646)(NimStringDesc* x);
static N_INLINE(NIM_BOOL, continueline_180652)(NimStringDesc* line, NIM_BOOL intriplestring);
N_NIMCALL(NI, counttriples_180676)(NimStringDesc* s);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NIMCALL(NI, llreadfromstdin_180733)(tllstream180204* s, void* buf, NI buflen);
...
N_NIMCALL(void, llstreamwrite_180268)(tllstream180204* s, void* buf, NI buflen);
N_NIMCALL(NimStringDesc*, llstreamreadall_180254)(tllstream180204* s);
N_NIMCALL(NimStringDesc*, copyStr)(NimStringDesc* s, NI start);
N_NIMCALL(NimStringDesc*, copyStr)(NimStringDesc* s, NI first);
N_NIMCALL(NimStringDesc*, mnewString)(NI len);
N_NIMCALL(NimStringDesc*, mnewString)(NI len);
STRING_LITERAL(TMP1640, "", 0);
NIM_CONST TY123387 linecontinuationoprs_180641 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
NIM_CONST TY123387 additionallinecontinuationoprs_180643 = {
0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x24,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY123387 TMP1642 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY123387 TMP1643 = {
0x00, 0x00, 0x00, 0x00, 0x7A, 0xBC, 0x00, 0xF4,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP1646, ">>> ", 4);
STRING_LITERAL(TMP1647, "... ", 4);
STRING_LITERAL(TMP1648, "\012", 1);
extern TNimType NTI2409; /* TObject */
TNimType NTI180204; /* TLLStream */
TNimType NTI180202; /* TLLStreamKind */
extern TNimType NTI10204; /* TFile */
extern TNimType NTI143; /* string */
extern TNimType NTI106; /* int */
TNimType NTI180206; /* PLLStream */
...
N_NIMCALL(tllstream180204*, llstreamopen_180218)(NimStringDesc* data) {
	...
	result = (tllstream180204*) newObj((&NTI180206), sizeof(tllstream180204));
	(*result).Sup.m_type = (&NTI180204);
...
N_NIMCALL(tllstream180204*, llstreamopenstdin_180235)(void) {
	...
	LOC1 = 0;
	LOC1 = (*result).S; (*result).S = copyStringRC1(((NimStringDesc*) &TMP1640));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
N_NIMCALL(NIM_BOOL, endswithopr_180646)(NimStringDesc* x) {
	...
	result = endswith_180602(x, TMP1642);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_180652)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_180602(line, TMP1643);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(NI, counttriples_180676)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1644 = addInt(i, 1);
			if ((NU)((NI32)(TMP1644)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI32)(TMP1644)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1645 = addInt(i, 2);
			if ((NU)((NI32)(TMP1645)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI32)(TMP1645)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
N_NIMCALL(NI, llreadfromstdin_180733)(tllstream180204* s, void* buf, NI buflen) {
	...
	LOC1 = 0;
	LOC1 = (*s).S; (*s).S = copyStringRC1(((NimStringDesc*) &TMP1640));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	...
	while (1) {
		...
		nimln(119, "llstream.nim");
		{
			...
			LOC3 = copyString(((NimStringDesc*) &TMP1646));
		}
		goto LA4;
		LA6: ;
		{
			LOC3 = copyString(((NimStringDesc*) &TMP1647));
		}
		LA4: ;
		LOC9 = 0;
		LOC9 = readlinefromstdin_180396(LOC3, &line);
		if (!LOC9) goto LA2;
...
appendString((*s).S, ((NimStringDesc*) &TMP1648));
		nimln(122, "llstream.nim");
		nimln(122, "llstream.nim");
		LOC10 = 0;
		LOC10 = counttriples_180676(line);
		...
		nimln(123, "llstream.nim");
		{
			...
			nimln(123, "llstream.nim");
			LOC13 = 0;
			LOC13 = continueline_180652(line, (((NI) ((NI)(triples & 1))) == 1));
			if (!!(LOC13)) goto LA14;
			nimln(123, "llstream.nim");
			goto LA2;
		}
	...
	nimln(125, "llstream.nim");
	nimln(125, "llstream.nim");
	TMP1649 = subInt((*s).S->Sup.len, (*s).Rd);
	result = ((buflen <= (NI32)(TMP1649)) ? buflen : (NI32)(TMP1649));
...
N_NIMCALL(NI, llstreamread_180242)(tllstream180204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		nimln(135, "llstream.nim");
		nimln(135, "llstream.nim");
		TMP1650 = subInt((*s).S->Sup.len, (*s).Rd);
		result = ((buflen <= (NI32)(TMP1650)) ? buflen : (NI32)(TMP1650));
		nimln(136, "llstream.nim");
		{
			...
			nimln(137, "llstream.nim");
			TMP1651 = addInt(0, (*s).Rd);
			if ((NU)((NI32)(TMP1651)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI32)(TMP1651)])), result);
	...
	case ((NU8) 3):
	{
		...
		result = llreadfromstdin_180733(s, buf, buflen);
	}
	break;
	}
	popFrame();
...
N_NIMCALL(void, llstreamwriteln_180274)(tllstream180204* s, NimStringDesc* data) {
	...
	llstreamwrite_180258(s, data);
	nimln(180, "llstream.nim");
	llstreamwrite_180258(s, ((NimStringDesc*) &TMP1648));
	popFrame();
}
...
N_NIMCALL(void, llstreamwrite_180268)(tllstream180204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			nimln(200, "llstream.nim");
			nimln(200, "llstream.nim");
			TMP1652 = addInt((*s).S->Sup.len, buflen);
			(*s).S = setLengthStr((*s).S, (NI32)(TMP1652));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1653 = addInt(0, (*s).Wr);
			if ((NU)((NI32)(TMP1653)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI32)(TMP1653)])), buf, buflen);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_180254)(tllstream180204* s) {
	...
	case ((NU8) 3):
	{
		...
		result = copyString(((NimStringDesc*) &TMP1640));
	}
	break;
	case ((NU8) 1):
	{
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			nimln(221, "llstream.nim");
			TMP1654 = addInt(i, 2048);
			result = setLengthStr(result, (NI32)(TMP1654));
			nimln(222, "llstream.nim");
			nimln(222, "llstream.nim");
			TMP1655 = addInt(i, 0);
			if ((NU)((NI32)(TMP1655)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_10827((*s).F, ((void*) (&result->data[(NI32)(TMP1655)])), 2048);
...
static TNimNode* TMP1635[6];
static TNimNode* TMP1636[4];
NI TMP1638;
static char* NIM_CONST TMP1637[4] = {
"llsNone", 
"llsString", 
"llsFile", 
"llsStdIn"};
static TNimNode TMP1633[12];
NTI180204.size = sizeof(tllstream180204);
NTI180204.kind = 17;
NTI180204.base = (&NTI2409);
TMP1635[0] = &TMP1633[1];
NTI180202.size = sizeof(NU8);
NTI180202.kind = 14;
NTI180202.base = 0;
NTI180202.flags = 3;
for (TMP1638 = 0; TMP1638 < 4; TMP1638++) {
TMP1633[TMP1638+2].kind = 1;
TMP1633[TMP1638+2].offset = TMP1638;
TMP1633[TMP1638+2].name = TMP1637[TMP1638];
TMP1636[TMP1638] = &TMP1633[TMP1638+2];
}
TMP1633[6].len = 4; TMP1633[6].kind = 2; TMP1633[6].sons = &TMP1636[0];
NTI180202.node = &TMP1633[6];
TMP1633[1].kind = 1;
TMP1633[1].offset = offsetof(tllstream180204, Kind);
TMP1633[1].typ = (&NTI180202);
TMP1633[1].name = "kind";
TMP1635[1] = &TMP1633[7];
TMP1633[7].kind = 1;
TMP1633[7].offset = offsetof(tllstream180204, F);
TMP1633[7].typ = (&NTI10204);
TMP1633[7].name = "f";
TMP1635[2] = &TMP1633[8];
TMP1633[8].kind = 1;
TMP1633[8].offset = offsetof(tllstream180204, S);
TMP1633[8].typ = (&NTI143);
TMP1633[8].name = "s";
TMP1635[3] = &TMP1633[9];
TMP1633[9].kind = 1;
TMP1633[9].offset = offsetof(tllstream180204, Rd);
TMP1633[9].typ = (&NTI106);
TMP1633[9].name = "rd";
TMP1635[4] = &TMP1633[10];
TMP1633[10].kind = 1;
TMP1633[10].offset = offsetof(tllstream180204, Wr);
TMP1633[10].typ = (&NTI106);
TMP1633[10].name = "wr";
TMP1635[5] = &TMP1633[11];
TMP1633[11].kind = 1;
TMP1633[11].offset = offsetof(tllstream180204, Lineoffset);
TMP1633[11].typ = (&NTI106);
TMP1633[11].name = "lineOffset";
TMP1633[0].len = 6; TMP1633[0].kind = 2; TMP1633[0].sons = &TMP1635[0];
NTI180204.node = &TMP1633[0];
NTI180206.size = sizeof(tllstream180204*);
NTI180206.kind = 22;
NTI180206.base = (&NTI180204);
NTI180206.marker = TMP1639;
}
