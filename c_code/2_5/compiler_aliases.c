...
STRING_LITERAL(TMP3188, "isPartOfAux(record case branch)", 31);
STRING_LITERAL(TMP3189, "isPartOfAux()", 13);
...
{	result = 0;
		...
		LA13: ;
		{
			...
			res_400249 = ((NI) 1);
			{
				while (1) {
					...
					default:
					{
						internalerror_166234(((NimStringDesc*) &TMP3188));
					}
					break;
					}
					res_400249 += ((NI) 1);
	...
	default:
	{
		internalerror_166215((*n).info, ((NimStringDesc*) &TMP3189));
	}
	break;
	}
	}BeforeRet: ;
