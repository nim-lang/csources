...
STRING_LITERAL(TMP1938, "nimrod.gid", 10);
STRING_LITERAL(TMP1939, "\012", 1);
...
static N_INLINE(void, setid_171432)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP1933 = addInt(id, 1);
	gfrontendid_171006 = ((gfrontendid_171006 >= (NI32)(TMP1933)) ? gfrontendid_171006 : (NI32)(TMP1933));
	popFrame();
}
static N_INLINE(NI, divInt)(NI a, NI b) {
	NI result;
...
N_NIMCALL(void, idsynchronizationpoint_171440)(NI idrange) {
	...
	nimln(41, "idgen.nim");
	nimln(41, "idgen.nim");
	TMP1934 = divInt(gfrontendid_171006, idrange);
	TMP1935 = addInt((NI32)(TMP1934), 1);
	TMP1936 = mulInt((NI32)(TMP1935), idrange);
	TMP1937 = addInt((NI32)(TMP1936), 1);
	gfrontendid_171006 = (NI32)(TMP1937);
	popFrame();
}
N_NIMCALL(NimStringDesc*, togid_171445)(NimStringDesc* f) {
	...
	result = 0;
	nimln(47, "idgen.nim");
	result = completegeneratedfilepath_114490(((NimStringDesc*) &TMP1938), NIM_TRUE);
	popFrame();
	return result;
}
static N_INLINE(void, writeln_114502)(FILE* f, NimStringDesc** x, NI xLen0) {
	...
	nimln(160, "sysio.nim");
	write_9459(f, ((NimStringDesc*) &TMP1939));	popFrame();
}
N_NIMCALL(void, savemaxids_171451)(NimStringDesc* project) {
	FILE* f;
	NimStringDesc* LOC1;
