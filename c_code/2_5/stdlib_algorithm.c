...
typedef N_CLOSURE_PTR(NI, TMP5100) (tsym187843* x_358870, tsym187843* y_358872);
struct  NimStringDesc  {
  TGenericSeq Sup;
NIM_CHAR data[SEQ_DECL_SIZE];
};
typedef N_CLOSURE_PTR(NI, TMP5102) (tsym187843* x_358870, tsym187843* y_358872);
struct  tentry361566  {
NI Pos;
tsym187843* Sym;
};
...
typedef N_CLOSURE_PTR(NI, TMP5119) (tentry361566 x_362254, tentry361566 y_362256);
typedef N_CLOSURE_PTR(NI, TMP5120) (tentry361566 x_362254, tentry361566 y_362256);
struct  TNimObject  {
TNimType* m_type;
};
struct  tidobj167013  {
...
N_NIMCALL(void, merge_358843)(tsym187843** a_358851, NI a_358851Len0, tsym187843** b_358859, NI b_358859Len0, NI lo_358863, NI m_358865, NI hi_358867, TY358801 cmp_358875, NU8 order_358878) {
	...
	nimln(101, "algorithm.nim");
	{
		...
		nimln(101, "algorithm.nim");
		TMP5099 = addInt(m_358865, 1);
		if ((NU)((NI32)(TMP5099)) >= (NU)(a_358851Len0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp_358875.ClEnv? cmp_358875.ClPrc(a_358851[m_358865], a_358851[(NI32)(TMP5099)], cmp_358875.ClEnv):((TMP5100)(cmp_358875.ClPrc))(a_358851[m_358865], a_358851[(NI32)(TMP5099)]);
		LOC4 = 0;
	...
	nimln(104, "algorithm.nim");
	{
		...
		nimln(104, "algorithm.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP5101));
	}
	LA9: ;
	...
	while (1) {
		...
		nimln(118, "algorithm.nim");
		{
			...
			if ((NU)(j) >= (NU)(a_358851Len0)) raiseIndexError();
			LOC17 = 0;
			LOC17 = cmp_358875.ClEnv? cmp_358875.ClPrc(b_358859[i], a_358851[j], cmp_358875.ClEnv):((TMP5102)(cmp_358875.ClPrc))(b_358859[i], a_358851[j]);
			LOC18 = 0;
...
N_NIMCALL(void, sort_358782)(tsym187843** a_358790, NI a_358790Len0, TY358801 cmp_358800, NU8 order_358803) {
	...
	nimln(155, "algorithm.nim");
	TMP5096 = divInt(n, 2);
	b = (tsymseq187815*) newSeq((&NTI187815), (NI32)(TMP5096));
	...
	while (1) {
		...
		while (1) {
			...
			nimln(160, "algorithm.nim");
			TMP5105 = addInt(m, s);
			merge_358843(a_358790, a_358790Len0, b->data, b->Sup.len, (((NI32)(TMP5104) >= 0) ? (NI32)(TMP5104) : 0), m, (NI32)(TMP5105), cmp_358800, order_358803);
...
N_NIMCALL(void, merge_362227)(tentry361566* a_362235, NI a_362235Len0, tentry361566* b_362243, NI b_362243Len0, NI lo_362247, NI m_362249, NI hi_362251, TY362185 cmp_362259, NU8 order_362262) {
	...
	nimln(101, "algorithm.nim");
	{
		...
		nimln(101, "algorithm.nim");
		TMP5118 = addInt(m_362249, 1);
		if ((NU)((NI32)(TMP5118)) >= (NU)(a_362235Len0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp_362259.ClEnv? cmp_362259.ClPrc(a_362235[m_362249], a_362235[(NI32)(TMP5118)], cmp_362259.ClEnv):((TMP5119)(cmp_362259.ClPrc))(a_362235[m_362249], a_362235[(NI32)(TMP5118)]);
		LOC4 = 0;
	...
	while (1) {
		...
		nimln(118, "algorithm.nim");
		{
			...
			if ((NU)(j) >= (NU)(a_362235Len0)) raiseIndexError();
			LOC17 = 0;
			LOC17 = cmp_362259.ClEnv? cmp_362259.ClPrc(b_362243[i], a_362235[j], cmp_362259.ClEnv):((TMP5120)(cmp_362259.ClPrc))(b_362243[i], a_362235[j]);
			LOC18 = 0;
...
N_NIMCALL(void, sort_362166)(tentry361566* a_362174, NI a_362174Len0, TY362185 cmp_362184, NU8 order_362187) {
	...
	nimln(155, "algorithm.nim");
	TMP5115 = divInt(n, 2);
	b = (TY361573*) newSeq((&NTI361573), (NI32)(TMP5115));
	nimln(156, "algorithm.nim");
	s = 1;
	nimln(157, "algorithm.nim");
	while (1) {
		...
		while (1) {
			...
			nimln(160, "algorithm.nim");
			TMP5123 = addInt(m, s);
			merge_362227(a_362174, a_362174Len0, b->data, b->Sup.len, (((NI32)(TMP5122) >= 0) ? (NI32)(TMP5122) : 0), m, (NI32)(TMP5123), cmp_362184, order_362187);
			nimln(161, "algorithm.nim");
			nimln(161, "algorithm.nim");
			TMP5124 = mulInt(s, 2);
