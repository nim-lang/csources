...
N_NIMCALL(void, handlecmdline_529607)(void);
...
N_NIMCALL(NimStringDesc*, prependcurdir_529401)(NimStringDesc* f);
...
N_NIMCALL(NimStringDesc*, findnodejs_528009)(void);
...
STRING_LITERAL(TMP1871, "", 0);
STRING_LITERAL(TMP1900, "nim.cfg", 7);
STRING_LITERAL(TMP5026, "-", 1);
STRING_LITERAL(TMP5027, "stdinfile", 9);
...
appendString(LOC7, ((NimStringDesc*) &TMP5028));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
N_NIMCALL(void, handlecmdline_529607)(void) {
	...
	LA4: ;
	{
		processcmdline_523209(((NU8) 0), ((NimStringDesc*) &TMP1871));
		{
			TSafePoint TMP1872;
			TY119589 p;
			NimStringDesc* LOC15;
			...
			pushSafePoint(&TMP1872);
			TMP1872.status = setjmp(TMP1872.context);
			if (TMP1872.status == 0) {
				asgnRefNoCycle((void**) (&gprojectfull_155236), canonicalizepath_155380(gprojectname_155234));
				popSafePoint();
			}
			else {
				popSafePoint();
			...
			if (TMP1872.status != 0) reraiseException();
		...
		LA7: ;
		loadconfigs_187811(((NimStringDesc*) &TMP1900));
		initvars_171876();
		processcmdline_523209(((NU8) 1), ((NimStringDesc*) &TMP1871));
		maincommand_526628();
		{
			NimStringDesc* LOC22;
		...
		LA20: ;
		{
			if (!(gerrorcounter_165019 == ((NI) 0))) goto LA25;
			{
				if (!((gglobaloptions_155128 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				{
					NimStringDesc* LOC35;
					if (!eqStrings(gprojectname_155234, ((NimStringDesc*) &TMP5026))) goto LA33;
					LOC35 = 0;
					LOC35 = gprojectfull_155236; gprojectfull_155236 = copyStringRC1(((NimStringDesc*) &TMP5027));
				...
				LA33: ;
				{
					...
					ex = 0;
					{
						...
						LOC44 = 0;
						LOC44 = prependcurdir_529401(outfile_155134);
					...
					LA42: ;
					{
						...
						NimStringDesc* LOC48;
						LOC46 = 0;
						LOC46 = noschangeFileExt(gprojectfull_155236, ((NimStringDesc*) &TMP5029));
						LOC47 = 0;
						LOC47 = prependcurdir_529401(LOC46);
						LOC48 = 0;
					...
					LOC49 = 0;
					LOC50 = 0;
					LOC50 = findnodejs_528009();
					LOC49 = rawNewString(LOC50->Sup.len + ex->Sup.len + arguments_178723->Sup.len + 2);
appendString(LOC49, LOC50);
appendString(LOC49, ((NimStringDesc*) &TMP5032));
appendString(LOC49, ex);
appendChar(LOC49, 32);
appendString(LOC49, arguments_178723);
					execexternalprogram_171985(LOC49, ((NimStringDesc*) &TMP1871));
				}
				goto LA36;
				LA38: ;
				{
					...
					binpath = 0;
					{
						...
						binpath = prependcurdir_529401(outfile_155134);
					}
					goto LA52;
					LA54: ;
					{
						NimStringDesc* LOC57;
						LOC57 = 0;
						LOC57 = noschangeFileExt(gprojectfull_155236, ((NimStringDesc*) &TMP1871));
						binpath = prependcurdir_529401(LOC57);
					}
					LA52: ;
					ex = nospquoteShell(binpath);
					LOC58 = 0;
					LOC58 = rawNewString(ex->Sup.len + arguments_178723->Sup.len + 1);
appendString(LOC58, ex);
appendChar(LOC58, 32);
appendString(LOC58, arguments_178723);
					execexternalprogram_171985(LOC58, ((NimStringDesc*) &TMP1871));
				}
				LA36: ;
			}
			LA29: ;
...
NIM_EXTERNC N_NOINLINE(void, nimInit)(void) {
	...
	initdefines_169254();
	handlecmdline_529607();
	msgquit_165115(((NI8) ((((NI) 0) < gerrorcounter_165019))));
}
