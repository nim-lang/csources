...
typedef NIM_CHAR TY100669[6];
typedef NIM_CHAR TY100672[2501];
typedef NIM_CHAR TY100664[3];
...
static NIM_CONST TY179407 TMP1538 = {
...
NIM_CONST TY100664 floatformattochar_100663 = {103,
102,
101}
;
...
N_NOINLINE(void, invalidformatstring_100760)(void) {
	...
	NimStringDesc* LOC1;
	e_100764 = 0;
	e_100764 = (Valueerror3449*) newObj((&NTI22201), sizeof(Valueerror3449));
	(*e_100764).Sup.Sup.m_type = (&NTI3449);
	LOC1 = 0;
	LOC1 = (*e_100764).Sup.message; (*e_100764).Sup.message = copyStringRC1(((NimStringDesc*) &TMP147));
...
N_NIMCALL(NF, nsuParseFloat)(NimStringDesc* s) {
	...
	L = npuParseFloat(s, (&result), ((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		e_97544 = 0;
		e_97544 = (Valueerror3449*) newObj((&NTI22201), sizeof(Valueerror3449));
...
N_NIMCALL(NI64, nsuParseBiggestInt)(NimStringDesc* s) {
	...
	L = npuParseBiggestInt(s, (&result), ((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		e_97519 = 0;
		e_97519 = (Valueerror3449*) newObj((&NTI22201), sizeof(Valueerror3449));
	...
	result = mnewString(((NI) (len)));
	{
		...
		res_97429 = ((NI) (HEX3Atmp_97426));
		{
			while (1) {
				...
				result->data[j_97423] = ((NimStringDesc*) &TMP1292)->data[(NI64)(n & IL64(15))];
...
N_NIMCALL(NimStringDesc*, nsuToBin)(NI64 x, NI len) {
	...
	result = mnewString(((NI) (len)));
	{
		...
		j_100013 = 0;
		HEX3Atmp_100025 = 0;
		HEX3Atmp_100025 = (NI)(((NI) (len)) - ((NI) 1));
		res_100028 = ((NI) (HEX3Atmp_100025));
		{
			while (1) {
				if (!(((NI) 0) <= res_100028)) goto LA3;
				j_100013 = ((NI) (res_100028));
...
N_NIMCALL(NimStringDesc*, nsuToOct)(NI64 x, NI len) {
	...
	result = mnewString(((NI) (len)));
	{
		...
		j_99813 = 0;
		HEX3Atmp_99825 = 0;
		HEX3Atmp_99825 = (NI)(((NI) (len)) - ((NI) 1));
		res_99828 = ((NI) (HEX3Atmp_99825));
		{
			while (1) {
				if (!(((NI) 0) <= res_99828)) goto LA3;
				j_99813 = ((NI) (res_99828));
...
N_NIMCALL(NI, nsuParseInt)(NimStringDesc* s) {
	...
	L = npuParseInt(s, (&result), ((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		e_97494 = 0;
		e_97494 = (Valueerror3449*) newObj((&NTI22201), sizeof(Valueerror3449));
...
appendString(result, prefix);
	{
		...
		c_100131 = 0;
		i_100143 = ((NI) 0);
		L_100145 = (s ? s->Sup.len : 0);
		{
			while (1) {
				if (!(i_100143 < L_100145)) goto LA3;
				c_100131 = s->data[i_100143];
				switch (((NU8)(c_100131))) {
				case 0 ... 31:
				case 128 ... 255:
				{
...
appendString(result, ((NimStringDesc*) &TMP2089));
					LOC5 = 0;
					LOC5 = nsuToHex(((NI64) (((NU8)(c_100131)))), ((NI) 2));
...
appendString(result, ((NimStringDesc*) &TMP2092));
				...
				default:
				{
					result = addChar(result, c_100131);
				}
				break;
				}
				i_100143 += ((NI) 1);
...
N_NIMCALL(NimStringDesc*, nsuformatBiggestFloat)(NF f, NU8 format, NI precision) {
	...
	frmtstr[(((NI) 0))- 0] = 37;
	{
		...
		frmtstr[(((NI) 2))- 0] = 46;
		frmtstr[(((NI) 3))- 0] = 42;
		frmtstr[(((NI) 4))- 0] = floatformattochar_100663[(format)- 0];
		frmtstr[(((NI) 5))- 0] = 0;
	...
	LA3: ;
	{
		frmtstr[(((NI) 1))- 0] = floatformattochar_100663[(format)- 0];
		frmtstr[(((NI) 2))- 0] = 0;
...
N_NIMCALL(NimStringDesc*, nsuInsertSep)(NimStringDesc* s, NIM_CHAR sep, NI digits) {
	...
	L -= ((NI) 1);
	{
		...
		i_100074 = 0;
		HEX3Atmp_100103 = 0;
		HEX3Atmp_100103 = (NI)((s ? s->Sup.len : 0) - ((NI) 1));
		res_100106 = HEX3Atmp_100103;
		{
			while (1) {
				if (!(((NI) 0) <= res_100106)) goto LA3;
				i_100074 = res_100106;
				{
...
N_NIMCALL(NimStringDesc*, formatsize_100697)(NI64 bytes, NIM_CHAR decimalsep) {
	...
	{
		NimStringDesc* bs_100720;
		NimStringDesc* LOC5;
		NimStringDesc* LOC6;
		NimStringDesc* LOC7;
		NimStringDesc* LOC8;
		if (!!((gigabytes == IL64(0)))) goto LA3;
		bs_100720 = nimInt64ToStr(megabytes);
		LOC5 = 0;
		LOC6 = 0;
		...
		LOC8 = 0;
		LOC8 = copyStrLast(bs_100720, ((NI) 0), ((NI) 2));
...
appendString(LOC5, ((NimStringDesc*) &TMP5009));
	...
	LA3: ;
	{
		NimStringDesc* bs_100722;
		NimStringDesc* LOC12;
		NimStringDesc* LOC13;
		NimStringDesc* LOC14;
		NimStringDesc* LOC15;
		if (!!((megabytes == IL64(0)))) goto LA10;
		bs_100722 = nimInt64ToStr(kilobytes);
		LOC12 = 0;
		LOC13 = 0;
		...
		LOC15 = 0;
		LOC15 = copyStrLast(bs_100722, ((NI) 0), ((NI) 2));
...
appendString(LOC12, ((NimStringDesc*) &TMP5010));
	...
	LA10: ;
	{
		NimStringDesc* bs_100724;
		NimStringDesc* LOC19;
		NimStringDesc* LOC20;
		NimStringDesc* LOC21;
		NimStringDesc* LOC22;
		if (!!((kilobytes == IL64(0)))) goto LA17;
		bs_100724 = nimInt64ToStr(bytes);
		LOC19 = 0;
		LOC20 = 0;
		...
		LOC22 = 0;
		LOC22 = copyStrLast(bs_100724, ((NI) 0), ((NI) 2));
