...
N_NIMCALL(tnode187813*, close_522014)(tpasscontext246003* p, tnode187813* n) {
	...
	nimln(25, "docgen2.nim");
	{
		...
		writeoutput_344719((*g).Doc, LOC7, ((NimStringDesc*) &TMP7624), usewarning);
...
TMP7623[0] = &TMP7621[1];
TMP7621[1].kind = 1;
TMP7621[1].offset = offsetof(tgen522008, Doc);
TMP7621[1].typ = (&NTI341007);
TMP7621[1].name = "doc";
TMP7623[1] = &TMP7621[2];
TMP7621[2].kind = 1;
TMP7621[2].offset = offsetof(tgen522008, Module);
TMP7621[2].typ = (&NTI187811);
TMP7621[2].name = "module";
TMP7621[0].len = 2; TMP7621[0].kind = 2; TMP7621[0].sons = &TMP7623[0];
NTI522008.node = &TMP7621[0];
NTI522010.size = sizeof(tgen522008*);
NTI522010.kind = 22;
NTI522010.base = (&NTI522008);
NTI522010.marker = TMP7626;
}
