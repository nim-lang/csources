...
STRING_LITERAL(TMP261, "list.tail.next == nil ", 22);
STRING_LITERAL(TMP265, "list.head.prev == nil ", 22);
STRING_LITERAL(TMP266, "pos != nil ", 11);
...
N_NIMCALL(void, append_119042)(tlinkedlist119023* list, tlistentry119017* entry) {
	...
	nimln(36, "lists.nim");
	{
		...
		nimln(37, "lists.nim");
		{
			...
			nimln(37, "lists.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP261));
		}
		LA7: ;
		nimln(38, "lists.nim");
...
N_NIMCALL(void, prepend_119300)(tlinkedlist119023* list, tlistentry119017* entry) {
	...
	nimln(64, "lists.nim");
	{
		...
		nimln(65, "lists.nim");
		{
			...
			nimln(65, "lists.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP265));
		}
		LA7: ;
		nimln(66, "lists.nim");
...
N_NIMCALL(void, insertbefore_119444)(tlinkedlist119023* list, tlistentry119017* pos, tlistentry119017* entry) {
	...
	nimln(74, "lists.nim");
	{
		...
		nimln(74, "lists.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP266));
	}
	LA3: ;
	nimln(75, "lists.nim");
	{
...
static TNimNode* TMP262[2];
static TNimNode* TMP3252[3];
...
NTI119015.marker = TMP263;
TMP259[1].kind = 1;
TMP259[1].offset = offsetof(tlistentry119017, Prev);
TMP259[1].typ = (&NTI119015);
TMP259[1].name = "prev";
TMP262[1] = &TMP259[2];
TMP259[2].kind = 1;
TMP259[2].offset = offsetof(tlistentry119017, Next);
TMP259[2].typ = (&NTI119015);
TMP259[2].name = "next";
TMP259[0].len = 2; TMP259[0].kind = 2; TMP259[0].sons = &TMP262[0];
NTI119017.node = &TMP259[0];
NTI119019.size = sizeof(tstrentry119019);
NTI119019.kind = 17;
NTI119019.base = (&NTI119017);
TMP259[3].kind = 1;
TMP259[3].offset = offsetof(tstrentry119019, Data);
TMP259[3].typ = (&NTI143);
TMP259[3].name = "data";
NTI119019.node = &TMP259[3];
NTI119021.size = sizeof(tstrentry119019*);
NTI119021.kind = 22;
NTI119021.base = (&NTI119019);
NTI119021.marker = TMP264;
NTI119023.size = sizeof(tlinkedlist119023);
NTI119023.kind = 18;
NTI119023.base = 0;
TMP3252[0] = &TMP259[5];
TMP259[5].kind = 1;
TMP259[5].offset = offsetof(tlinkedlist119023, Head);
TMP259[5].typ = (&NTI119015);
TMP259[5].name = "head";
TMP3252[1] = &TMP259[6];
TMP259[6].kind = 1;
TMP259[6].offset = offsetof(tlinkedlist119023, Tail);
TMP259[6].typ = (&NTI119015);
TMP259[6].name = "tail";
TMP3252[2] = &TMP259[7];
TMP259[7].kind = 1;
TMP259[7].offset = offsetof(tlinkedlist119023, Counter);
TMP259[7].typ = (&NTI106);
TMP259[7].name = "counter";
TMP259[4].len = 3; TMP259[4].kind = 2; TMP259[4].sons = &TMP3252[0];
NTI119023.node = &TMP259[4];
}
