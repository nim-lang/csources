...
N_NIMCALL(void, prepend_118300)(tlinkedlist118023* list, tlistentry118017* entry) {
	...
	nimln(64, "lists.nim");
	{
		...
		nimln(65, "lists.nim");
		{
			...
			nimln(65, "lists.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP264));
		}
		LA7: ;
		nimln(66, "lists.nim");
...
N_NIMCALL(void, insertbefore_118444)(tlinkedlist118023* list, tlistentry118017* pos, tlistentry118017* entry) {
	...
	nimln(74, "lists.nim");
	{
		...
		nimln(74, "lists.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP265));
	}
	LA3: ;
	nimln(75, "lists.nim");
	{
...
NTI118015.marker = TMP262;
TMP258[1].kind = 1;
TMP258[1].offset = offsetof(tlistentry118017, Prev);
TMP258[1].typ = (&NTI118015);
TMP258[1].name = "prev";
TMP261[1] = &TMP258[2];
TMP258[2].kind = 1;
TMP258[2].offset = offsetof(tlistentry118017, Next);
TMP258[2].typ = (&NTI118015);
TMP258[2].name = "next";
TMP258[0].len = 2; TMP258[0].kind = 2; TMP258[0].sons = &TMP261[0];
NTI118017.node = &TMP258[0];
NTI118019.size = sizeof(tstrentry118019);
NTI118019.kind = 17;
NTI118019.base = (&NTI118017);
TMP258[3].kind = 1;
TMP258[3].offset = offsetof(tstrentry118019, Data);
TMP258[3].typ = (&NTI143);
TMP258[3].name = "data";
NTI118019.node = &TMP258[3];
NTI118021.size = sizeof(tstrentry118019*);
NTI118021.kind = 22;
NTI118021.base = (&NTI118019);
NTI118021.marker = TMP263;
NTI118023.size = sizeof(tlinkedlist118023);
NTI118023.kind = 18;
NTI118023.base = 0;
TMP3245[0] = &TMP258[5];
TMP258[5].kind = 1;
TMP258[5].offset = offsetof(tlinkedlist118023, Head);
TMP258[5].typ = (&NTI118015);
TMP258[5].name = "head";
TMP3245[1] = &TMP258[6];
TMP258[6].kind = 1;
TMP258[6].offset = offsetof(tlinkedlist118023, Tail);
TMP258[6].typ = (&NTI118015);
TMP258[6].name = "tail";
TMP3245[2] = &TMP258[7];
TMP258[7].kind = 1;
TMP258[7].offset = offsetof(tlinkedlist118023, Counter);
TMP258[7].typ = (&NTI106);
TMP258[7].name = "counter";
TMP258[4].len = 3; TMP258[4].kind = 2; TMP258[4].sons = &TMP3245[0];
NTI118023.node = &TMP258[4];
}
