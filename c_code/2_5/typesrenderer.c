...
N_NIMCALL(NimStringDesc*, rendertype_343208)(tnode192813* n) {
	...
	case ((NU8) 141):
	{
		...
		nimln(37, "typesrenderer.nim");
		{
			...
			if (!!((LOC6 == 1))) goto LA7;
			nimln(37, "typesrenderer.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP4783));
		}
		LA7: ;
...
appendString(LOC25, LOC27);
	...
	case ((NU8) 145):
	{
		...
		nimln(48, "typesrenderer.nim");
		{
			...
			nimln(48, "typesrenderer.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP4787));
		}
		LA36: ;
	...
	case ((NU8) 35):
	{
		...
		while (1) {
			...
			nimln(59, "typesrenderer.nim");
			{
				...
				nimln(59, "typesrenderer.nim");
				failedassertimpl_80621(((NimStringDesc*) &TMP4792));
			}
			LA60: ;
...
N_NIMCALL(void, renderparamtypes_345423)(TY10865** found, tnode192813* n) {
	...
	case ((NU8) 35):
	{
		...
		nimln(87, "typesrenderer.nim");
		{
			...
			nimln(87, "typesrenderer.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP4797));
		}
		LA9: ;
