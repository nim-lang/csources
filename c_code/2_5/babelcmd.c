...
N_NIMCALL(NI, versionsplitpos_176014)(NimStringDesc* s);
static N_INLINE(NI, subInt)(NI a, NI b);
N_NOINLINE(void, raiseOverflow)(void);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(NIM_BOOL, HEX3CHEX2E_176054)(NimStringDesc* a, NimStringDesc* b);
static N_INLINE(NIM_BOOL, eqStrings)(NimStringDesc* a, NimStringDesc* b);
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NIMCALL(void, addpackage_176137)(tstringtable122810* packages, NimStringDesc* p);
...
N_NIMCALL(void, addbabelpath_176163)(NimStringDesc* p, tlineinfo167527 info);
...
STRING_LITERAL(TMP1430, "head", 4);
STRING_LITERAL(TMP1433, ".", 1);
STRING_LITERAL(TMP1434, "..", 2);
STRING_LITERAL(TMP1438, ".nim", 4);
...
N_NIMCALL(void, addpath_176007)(NimStringDesc* path, tlineinfo167527 info) {
	...
	nimln(15, "babelcmd.nim");
	{
		...
		nimln(15, "babelcmd.nim");
		LOC3 = 0;
		LOC3 = contains_119237(searchpaths_139115, path);
		if (!!(LOC3)) goto LA4;
		nimln(16, "babelcmd.nim");
		prependstr_119437(&searchpaths_139115, path);
	}
	LA4: ;
	popFrame();
}
...
N_NIMCALL(NIM_BOOL, HEX3CHEX2E_176054)(NimStringDesc* a, NimStringDesc* b) {
	...
	{
		nimln(28, "babelcmd.nim");
		if (!eqStrings(a, ((NimStringDesc*) &TMP1430))) goto LA3;
		nimln(28, "babelcmd.nim");
		nimln(28, "babelcmd.nim");
		result = NIM_FALSE;
		goto BeforeRet;
...
N_NIMCALL(void, addpackage_176137)(tstringtable122810* packages, NimStringDesc* p) {
	...
	x = versionsplitpos_176014(p);
	nimln(48, "babelcmd.nim");
	nimln(48, "babelcmd.nim");
	nimln(48, "babelcmd.nim");
	TMP1431 = subInt(x, 1);
	name = copyStrLast(p, 0, (NI32)(TMP1431));
	nimln(49, "babelcmd.nim");
	{
		...
		nimln(50, "babelcmd.nim");
		TMP1432 = addInt(x, 1);
		version = copyStr(p, (NI32)(TMP1432));
		nimln(51, "babelcmd.nim");
		{
			...
			LOC8 = 0;
			LOC8 = HEX3CHEX2E_176054(LOC7, version);
			if (!LOC8) goto LA9;
	...
	LA3: ;
	{
		...
		nstPut(packages, name, ((NimStringDesc*) &TMP1430));
	}
	LA1: ;
	popFrame();
}
...
N_NIMCALL(void, addbabelpath_176163)(NimStringDesc* p, tlineinfo167527 info) {
	...
	nimln(62, "babelcmd.nim");
	{
		...
		nimln(62, "babelcmd.nim");
		LOC3 = 0;
		LOC3 = contains_119237(searchpaths_139115, p);
		if (!!(LOC3)) goto LA4;
		nimln(63, "babelcmd.nim");
		{
			nimln(63, "babelcmd.nim");
			if (!(1 <= gverbosity_139120)) goto LA8;
			nimln(63, "babelcmd.nim");
			message_169584(info, ((NU16) 269), p);
		}
		LA8: ;
		nimln(64, "babelcmd.nim");
		prependstr_119437(&lazypaths_139116, p);
	}
	LA4: ;
	popFrame();
}
...
N_NIMCALL(void, babelpath_176290)(NimStringDesc* path, tlineinfo167527 info) {
	...
	addpathrec_176216(path, info);
	nimln(90, "babelcmd.nim");
	addbabelpath_176163(path, info);
	popFrame();
}
