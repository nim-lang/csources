...
N_NIMCALL(void, registerPlugin_TWpFbOEPiFRbOW9baL7NPrA)(NimStringDesc* package, NimStringDesc* module, NimStringDesc* fn, tyProc_AKW0Vo9cFIVu0NCvmOexsSA t);
N_NIMCALL(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*, iterToProcImpl_8Ju1JTLo6ouAMsxkpHAWIQ)(tyObject_TContext_5TfOJKwTttj3W1t1tMzWUQ* c, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n);
...
{	result = (tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*)0;
	...
	iter = (*n).kindU.S6.sons->data[((NI) 1)];
	{
		...
		if (T3_) goto LA4_;
		T3_ = !(((*(*iter).kindU.S4.sym).kind == ((tyEnum_TSymKind_cNCW9acsSznmEccl1fgQwkw) 14)));
		LA4_: ;
		if (!T3_) goto LA5_;
