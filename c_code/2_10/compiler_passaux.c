...
N_NIMCALL(tyObject_TPassContext_qNsm39cWb35W2r5AAd9ch87g*, verboseOpen_9cFiRqzMjYM822Jl0iQa30Q)(tyObject_ModuleGraphcolonObjectType__RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TSym_AXG7xcvKqaxY6koRX1xkCw* s, tyObject_IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw* cache) {
	...
	result = NIM_NIL;
	rawMessage_tBJ8mvo7MzzirsGkrHVc9cw(((tyEnum_TMsgKind_IGAWgv9aR2KqPKJfPZPEWaw) 279), (*(*s).name).s);
	return result;
}
...
N_NIMCALL(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*, verboseProcess_6fhNRoymw43U9bx1kqA2xCw)(tyObject_TPassContext_qNsm39cWb35W2r5AAd9ch87g* context, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	LA3_: ;
	{
		...
		gNotes_ra0BBMaJz6cOxn1JA3c6Bg |= ((NU64)1)<<(((((tyEnum_TMsgKind_P7z69ae9cO2FQBJme8oWEJoA) 279)- 240))%(sizeof(NU64)*8));
		T9_ = (NimStringDesc*)0;
		T9_ = nimIntToStr(gFrontEndId_gyRrMPnY7JyC6tAu9bCfGng);
		message_VpilfPWbplGz6ny7O9cfr2g_2((*n).info, ((tyEnum_TMsgKind_IGAWgv9aR2KqPKJfPZPEWaw) 279), T9_);
	}
	LA7_: ;
	return result;
}
