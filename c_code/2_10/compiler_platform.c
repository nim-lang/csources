...
;
STRING_LITERAL(T_LEa0rTUoGHqcCT74IoUuTg_72, "linux", 5);
static N_NIMCALL(void, T_LEa0rTUoGHqcCT74IoUuTg_2)(void) {
...
nimRegisterGlobalMarker(T_LEa0rTUoGHqcCT74IoUuTg_2);
	hostcpu_NC5ykU0V2OtuVwnPAFnkrg = nametocpu_JQ5BAe9a4dm5IfbYpemguNA(((NimStringDesc*) &T_LEa0rTUoGHqcCT74IoUuTg_16));
