...
N_NIMCALL(NimStringDesc*, togid_293423_644355110)(NimStringDesc* f0);
...
NI gfrontendid_293004_644355110;
...
N_NIMCALL(NimStringDesc*, togid_293423_644355110)(NimStringDesc* f0) {
	...
	result0 = completegeneratedfilepath_172201_2607990831(((NimStringDesc*) &T644355110_2), NIM_TRUE);
	return result0;
}
...
N_NIMCALL(void, idsynchronizationpoint_293420_644355110)(NI idrange0) {
	gfrontendid_293004_644355110 = (NI)((NI)((NI)((NI)(gfrontendid_293004_644355110 / idrange0) + ((NI) 1)) * idrange0) + ((NI) 1));
}
