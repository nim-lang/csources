...
N_LIB_PRIVATE N_NIMCALL(void, newLine_Seop6SJMf7a68kj2jl0nsQ_2)(tyObject_TTmplParser_hVXV9cC75rOvsaODz9bp1zeg* p);
...
N_LIB_PRIVATE N_NIMCALL(void, scanPar_LxubVMiL9c9aXekwPUmMO8iA)(tyObject_TTmplParser_hVXV9cC75rOvsaODz9bp1zeg* p, NI d);
static N_INLINE(NI, subInt)(NI a, NI b);
static N_INLINE(NIM_BOOL, withInExpr_0z6MLNAfAxEgGF4TC7H4Gwfilter_tmpl)(tyObject_TTmplParser_hVXV9cC75rOvsaODz9bp1zeg* p);
...
static NIM_CONST tySet_tyChar_nmiMWKVIe46vacnhAFrQvw TM_paI0W78l0CRDBLjAHJxn6w_22 = {
0x00, 0x00, 0x00, 0x00, 0x70, 0xBC, 0x00, 0x50,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_23, "end", 3);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_24, "if", 2);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_25, "when", 4);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_26, "try", 3);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_27, "while", 5);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_28, "for", 3);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_29, "block", 5);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_30, "case", 4);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_31, "proc", 4);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_32, "iterator", 8);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_33, "converter", 9);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_34, "macro", 5);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_35, "template", 8);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_36, "method", 6);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_37, "func", 4);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_38, "elif", 4);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_39, "of", 2);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_40, "else", 4);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_41, "except", 6);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_42, "finally", 7);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_43, "let", 3);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_44, "var", 3);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_45, "const", 5);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_46, "type", 4);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_48, "\'end\' does not close a control flow construct", 45);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_49, "#end", 4);
static NIM_CONST tySet_tyChar_nmiMWKVIe46vacnhAFrQvw TM_paI0W78l0CRDBLjAHJxn6w_52 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x24,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_55, "\"", 1);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_56, "(\"", 2);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_58, "\\x", 2);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_60, "\\\\", 2);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_62, "\\\'", 2);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_64, "\\\"", 2);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_73, "expected closing \'}\'", 20);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_76, "invalid expression", 18);
STRING_LITERAL(TM_paI0W78l0CRDBLjAHJxn6w_78, "\\n\"", 3);
...
N_LIB_PRIVATE N_NIMCALL(void, newLine_Seop6SJMf7a68kj2jl0nsQ_2)(tyObject_TTmplParser_hVXV9cC75rOvsaODz9bp1zeg* p) {
	NimStringDesc* T1_;
	T1_ = (NimStringDesc*)0;
	T1_ = nsuRepeatChar(41, ((NI)chckRange((*p).emitPar, ((NI) 0), ((NI) 2147483647))));
	llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, T1_);
	(*p).emitPar = ((NI) 0);
	{
		if (!((NU16)(((NU16) 1)) < (NU16)((*p).info.line))) goto LA4_;
		llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_11));
	}
	LA4_: ;
	{
		NimStringDesc* T10_;
		...
		T10_ = spaces_zuWfkBFTPm31FNfSpe2HQQstrutils(((NI) 2));
		llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, T10_);
...
N_LIB_PRIVATE N_NIMCALL(void, scanPar_LxubVMiL9c9aXekwPUmMO8iA)(tyObject_TTmplParser_hVXV9cC75rOvsaODz9bp1zeg* p, NI d) {
	...
	{
		while (1) {
			NI TM_paI0W78l0CRDBLjAHJxn6w_21;
			if (!(i < ((*p).x ? (*p).x->Sup.len : 0))) goto LA2;
			if ((NU)(i) >= (NU)((*p).x ? (*p).x->Sup.len : 0)) raiseIndexError2(i,((*p).x ? (*p).x->Sup.len : 0)-1);
			switch (((NU8)((*p).x->data[i]))) {
			case 40:
			{
				NI TM_paI0W78l0CRDBLjAHJxn6w_15;
				TM_paI0W78l0CRDBLjAHJxn6w_15 = addInt((*p).par, ((NI) 1));
				(*p).par = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_15);
			}
			break;
			case 41:
			{
				NI TM_paI0W78l0CRDBLjAHJxn6w_16;
				TM_paI0W78l0CRDBLjAHJxn6w_16 = subInt((*p).par, ((NI) 1));
				(*p).par = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_16);
			}
			break;
			case 91:
			{
				NI TM_paI0W78l0CRDBLjAHJxn6w_17;
				TM_paI0W78l0CRDBLjAHJxn6w_17 = addInt((*p).bracket, ((NI) 1));
				(*p).bracket = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_17);
			}
			break;
			case 93:
			{
				NI TM_paI0W78l0CRDBLjAHJxn6w_18;
				TM_paI0W78l0CRDBLjAHJxn6w_18 = subInt((*p).bracket, ((NI) 1));
				(*p).bracket = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_18);
			}
			break;
			case 123:
			{
				NI TM_paI0W78l0CRDBLjAHJxn6w_19;
				TM_paI0W78l0CRDBLjAHJxn6w_19 = addInt((*p).curly, ((NI) 1));
				(*p).curly = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_19);
			}
			break;
			case 125:
			{
				NI TM_paI0W78l0CRDBLjAHJxn6w_20;
				TM_paI0W78l0CRDBLjAHJxn6w_20 = subInt((*p).curly, ((NI) 1));
				(*p).curly = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_20);
			}
			break;
			default:
			{
			...
			TM_paI0W78l0CRDBLjAHJxn6w_21 = addInt(i, ((NI) 1));
			i = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_21);
		} LA2: ;
	}
}
...
N_LIB_PRIVATE N_NIMCALL(void, parseLine_Seop6SJMf7a68kj2jl0nsQ)(tyObject_TTmplParser_hVXV9cC75rOvsaODz9bp1zeg* p) {
	...
	len = ((*p).x ? (*p).x->Sup.len : 0);
	{
		while (1) {
			NIM_BOOL T3_;
			NI TM_paI0W78l0CRDBLjAHJxn6w_10;
			T3_ = (NIM_BOOL)0;
			T3_ = (j < len);
			if (!(T3_)) goto LA4_;
			if ((NU)(j) >= (NU)((*p).x ? (*p).x->Sup.len : 0)) raiseIndexError2(j,((*p).x ? (*p).x->Sup.len : 0)-1);
			T3_ = ((NU8)((*p).x->data[j]) == (NU8)(32));
			LA4_: ;
			if (!T3_) goto LA2;
			TM_paI0W78l0CRDBLjAHJxn6w_10 = addInt(j, ((NI) 1));
			j = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_10);
		} LA2: ;
	}
	{
		NIM_BOOL T7_;
		...
		T8_ = (((NI) 2) <= len);
		if (!(T8_)) goto LA9_;
		if ((NU)(((NI) 0)) >= (NU)((*p).x ? (*p).x->Sup.len : 0)) raiseIndexError2(((NI) 0),((*p).x ? (*p).x->Sup.len : 0)-1);
		T8_ = ((NU8)((*p).x->data[((NI) 0)]) == (NU8)((*p).nimDirective));
		LA9_: ;
		T7_ = T8_;
		if (!(T7_)) goto LA10_;
		if ((NU)(((NI) 1)) >= (NU)((*p).x ? (*p).x->Sup.len : 0)) raiseIndexError2(((NI) 1),((*p).x ? (*p).x->Sup.len : 0)-1);
		T7_ = ((NU8)((*p).x->data[((NI) 1)]) == (NU8)(63));
		LA10_: ;
		if (!T7_) goto LA11_;
		newLine_Seop6SJMf7a68kj2jl0nsQ_2(p);
	}
	goto LA5_;
	LA11_: ;
	{
		NIM_BOOL T14_;
		NI TM_paI0W78l0CRDBLjAHJxn6w_12;
		NI d;
		NimStringDesc* keyw;
		NIM_BOOL T26_;
		T14_ = (NIM_BOOL)0;
		...
		if (!T14_) goto LA16_;
		newLine_Seop6SJMf7a68kj2jl0nsQ_2(p);
		TM_paI0W78l0CRDBLjAHJxn6w_12 = addInt(j, ((NI) 1));
		j = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_12);
		{
			while (1) {
				NIM_BOOL T20_;
				NI TM_paI0W78l0CRDBLjAHJxn6w_13;
				T20_ = (NIM_BOOL)0;
				T20_ = (j < len);
				if (!(T20_)) goto LA21_;
				if ((NU)(j) >= (NU)((*p).x ? (*p).x->Sup.len : 0)) raiseIndexError2(j,((*p).x ? (*p).x->Sup.len : 0)-1);
				...
				LA21_: ;
				if (!T20_) goto LA19;
				TM_paI0W78l0CRDBLjAHJxn6w_13 = addInt(j, ((NI) 1));
				j = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_13);
			} LA19: ;
		}
		d = j;
		keyw = ((NimStringDesc*) NIM_NIL);
		{
			while (1) {
				NIM_BOOL T24_;
				NI TM_paI0W78l0CRDBLjAHJxn6w_14;
				T24_ = (NIM_BOOL)0;
				T24_ = (j < len);
				if (!(T24_)) goto LA25_;
				if ((NU)(j) >= (NU)((*p).x ? (*p).x->Sup.len : 0)) raiseIndexError2(j,((*p).x ? (*p).x->Sup.len : 0)-1);
				...
				TM_paI0W78l0CRDBLjAHJxn6w_14 = addInt(j, ((NI) 1));
				j = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_14);
			} LA23: ;
		}
		scanPar_LxubVMiL9c9aXekwPUmMO8iA(p, j);
		T26_ = (NIM_BOOL)0;
		T26_ = withInExpr_0z6MLNAfAxEgGF4TC7H4Gwfilter_tmpl((&(*p)));
		if (T26_) goto LA27_;
		T26_ = endsWith_sberXLoaiFnBA9azzLZ5m2Q((*p).x, TM_paI0W78l0CRDBLjAHJxn6w_22);
		LA27_: ;
		(*p).pendingExprLine = T26_;
		switch (hashString(keyw) & 31) {
		case 3: 
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_39))) goto LA30_;
break;
		case 6: 
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_30))) goto LA29_;
break;
		case 7: 
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_24))) goto LA29_;
break;
		case 10: 
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_31))) goto LA29_;
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_43))) goto LA31_;
break;
		case 12: 
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_32))) goto LA29_;
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_44))) goto LA31_;
break;
		case 13: 
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_36))) goto LA29_;
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_41))) goto LA30_;
break;
		case 16: 
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_25))) goto LA29_;
break;
		case 17: 
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_38))) goto LA30_;
break;
		case 18: 
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_35))) goto LA29_;
break;
		case 19: 
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_28))) goto LA29_;
break;
		case 21: 
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_40))) goto LA30_;
break;
		case 23: 
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_23))) goto LA28_;
break;
		case 24: 
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_42))) goto LA30_;
break;
		case 25: 
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_27))) goto LA29_;
break;
		case 26: 
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_45))) goto LA31_;
break;
		case 27: 
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_26))) goto LA29_;
break;
		case 29: 
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_29))) goto LA29_;
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_37))) goto LA29_;
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_46))) goto LA31_;
break;
		case 30: 
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_33))) goto LA29_;
if (eqStrings(keyw, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_34))) goto LA29_;
break;
		}
		goto LA32_;
		LA28_: ;
		{
			NimStringDesc* T40_;
			{
				NI TM_paI0W78l0CRDBLjAHJxn6w_47;
				if (!(((NI) 2) <= (*p).indent)) goto LA37_;
				TM_paI0W78l0CRDBLjAHJxn6w_47 = subInt((*p).indent, ((NI) 2));
				(*p).indent = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_47);
			}
			goto LA35_;
			LA37_: ;
			{
				(*p).info.col = ((NI16)chckRange(j, ((NI16) -32768), ((NI16) 32767)));
				localError_NF6kBGchnhQYPbCedyefVA((*p).config, (*p).info, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_48));
			}
			LA35_: ;
			T40_ = (NimStringDesc*)0;
			T40_ = spaces_zuWfkBFTPm31FNfSpe2HQQstrutils(((NI)chckRange((*p).indent, ((NI) 0), ((NI) 2147483647))));
			llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, T40_);
			llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_49));
		}
		goto LA33_;
		LA29_: ;
		{
			NimStringDesc* T42_;
			NimStringDesc* T43_;
			NI TM_paI0W78l0CRDBLjAHJxn6w_50;
			T42_ = (NimStringDesc*)0;
			T42_ = spaces_zuWfkBFTPm31FNfSpe2HQQstrutils(((NI)chckRange((*p).indent, ((NI) 0), ((NI) 2147483647))));
			llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, T42_);
			T43_ = (NimStringDesc*)0;
			T43_ = substr_iGg0RIKceRvsmvq8FUHOEw((*p).x, d);
			llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, T43_);
			TM_paI0W78l0CRDBLjAHJxn6w_50 = addInt((*p).indent, ((NI) 2));
			(*p).indent = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_50);
		}
		goto LA33_;
		LA30_: ;
		{
			NI TM_paI0W78l0CRDBLjAHJxn6w_51;
			NimStringDesc* T45_;
			NimStringDesc* T46_;
			TM_paI0W78l0CRDBLjAHJxn6w_51 = subInt((*p).indent, ((NI) 2));
			T45_ = (NimStringDesc*)0;
			T45_ = spaces_zuWfkBFTPm31FNfSpe2HQQstrutils(((NI)chckRange((NI)(TM_paI0W78l0CRDBLjAHJxn6w_51), ((NI) 0), ((NI) 2147483647))));
			llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, T45_);
			T46_ = (NimStringDesc*)0;
			T46_ = substr_iGg0RIKceRvsmvq8FUHOEw((*p).x, d);
			llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, T46_);
		}
		goto LA33_;
		LA31_: ;
		{
			...
			T48_ = spaces_zuWfkBFTPm31FNfSpe2HQQstrutils(((NI)chckRange((*p).indent, ((NI) 0), ((NI) 2147483647))));
			llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, T48_);
			T49_ = (NimStringDesc*)0;
			T49_ = substr_iGg0RIKceRvsmvq8FUHOEw((*p).x, d);
			llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, T49_);
			{
				NIM_BOOL T52_;
				NI TM_paI0W78l0CRDBLjAHJxn6w_53;
				T52_ = (NIM_BOOL)0;
				T52_ = contains_wAzSnEu9cCHHjvPQlWBZUeQ((*p).x, TM_paI0W78l0CRDBLjAHJxn6w_52);
				if (!!(T52_)) goto LA53_;
				TM_paI0W78l0CRDBLjAHJxn6w_53 = addInt((*p).indent, ((NI) 2));
				(*p).indent = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_53);
			}
			LA53_: ;
		}
		goto LA33_;
		LA32_: ;
		{
			...
			T56_ = spaces_zuWfkBFTPm31FNfSpe2HQQstrutils(((NI)chckRange((*p).indent, ((NI) 0), ((NI) 2147483647))));
			llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, T56_);
			T57_ = (NimStringDesc*)0;
			T57_ = substr_iGg0RIKceRvsmvq8FUHOEw((*p).x, d);
			llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, T57_);
		}
		LA33_: ;
	...
	LA16_: ;
	{
		...
		{
			NI TM_paI0W78l0CRDBLjAHJxn6w_54;
			NimStringDesc* T60_;
			llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, (*p).conc);
			llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_11));
			TM_paI0W78l0CRDBLjAHJxn6w_54 = addInt((*p).indent, ((NI) 2));
			T60_ = (NimStringDesc*)0;
			T60_ = spaces_zuWfkBFTPm31FNfSpe2HQQstrutils(((NI)chckRange((NI)(TM_paI0W78l0CRDBLjAHJxn6w_54), ((NI) 0), ((NI) 2147483647))));
			llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, T60_);
			llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_55));
		}
		break;
		case ((tyEnum_TParseState_TMyoReN7VAtsUpVF9bL9cXRQ) 0):
		{
			NimStringDesc* T62_;
			NI TM_paI0W78l0CRDBLjAHJxn6w_57;
			newLine_Seop6SJMf7a68kj2jl0nsQ_2(p);
			T62_ = (NimStringDesc*)0;
			T62_ = spaces_zuWfkBFTPm31FNfSpe2HQQstrutils(((NI)chckRange((*p).indent, ((NI) 0), ((NI) 2147483647))));
			llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, T62_);
			llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, (*p).emit);
			llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_56));
			TM_paI0W78l0CRDBLjAHJxn6w_57 = addInt((*p).emitPar, ((NI) 1));
			(*p).emitPar = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_57);
		}
		break;
		}
		(*p).state = ((tyEnum_TParseState_TMyoReN7VAtsUpVF9bL9cXRQ) 1);
		{
			while (1) {
				...
				{
					NimStringDesc* T66_;
					NI TM_paI0W78l0CRDBLjAHJxn6w_59;
					llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_58));
					if ((NU)(j) >= (NU)((*p).x ? (*p).x->Sup.len : 0)) raiseIndexError2(j,((*p).x ? (*p).x->Sup.len : 0)-1);
					T66_ = (NimStringDesc*)0;
					T66_ = nsuToHex(((NI64) (((NU8)((*p).x->data[j])))), ((NI) 2));
					llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, T66_);
					TM_paI0W78l0CRDBLjAHJxn6w_59 = addInt(j, ((NI) 1));
					j = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_59);
				}
				break;
				case 92:
				{
					NI TM_paI0W78l0CRDBLjAHJxn6w_61;
					llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_60));
					TM_paI0W78l0CRDBLjAHJxn6w_61 = addInt(j, ((NI) 1));
					j = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_61);
				}
				break;
				case 39:
				{
					NI TM_paI0W78l0CRDBLjAHJxn6w_63;
					llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_62));
					TM_paI0W78l0CRDBLjAHJxn6w_63 = addInt(j, ((NI) 1));
					j = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_63);
				}
				break;
				case 34:
				{
					NI TM_paI0W78l0CRDBLjAHJxn6w_65;
					llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_64));
					TM_paI0W78l0CRDBLjAHJxn6w_65 = addInt(j, ((NI) 1));
					j = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_65);
				}
				break;
				default:
				{
					{
						NI TM_paI0W78l0CRDBLjAHJxn6w_66;
						if ((NU)(j) >= (NU)((*p).x ? (*p).x->Sup.len : 0)) raiseIndexError2(j,((*p).x ? (*p).x->Sup.len : 0)-1);
						if (!((NU8)((*p).x->data[j]) == (NU8)((*p).subsChar))) goto LA73_;
						TM_paI0W78l0CRDBLjAHJxn6w_66 = addInt(j, ((NI) 1));
						j = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_66);
						if ((NU)(j) >= (NU)((*p).x ? (*p).x->Sup.len : 0)) raiseIndexError2(j,((*p).x ? (*p).x->Sup.len : 0)-1);
						switch (((NU8)((*p).x->data[j]))) {
						case 123:
						{
							NI TM_paI0W78l0CRDBLjAHJxn6w_67;
							NI curly;
							(*p).info.col = ((NI16)chckRange(j, ((NI16) -32768), ((NI16) 32767)));
							llStreamWrite_eHN6oO0rdFcz7KOdSd4bXw((*p).outp, 34);
							llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, (*p).conc);
							llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, (*p).toStr);
							llStreamWrite_eHN6oO0rdFcz7KOdSd4bXw((*p).outp, 40);
							TM_paI0W78l0CRDBLjAHJxn6w_67 = addInt(j, ((NI) 1));
							j = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_67);
							curly = ((NI) 0);
							{
								while (1) {
									if (!(j < len)) goto LA77;
									...
									case 123:
									{
										NI TM_paI0W78l0CRDBLjAHJxn6w_68;
										NI TM_paI0W78l0CRDBLjAHJxn6w_69;
										TM_paI0W78l0CRDBLjAHJxn6w_68 = addInt(j, ((NI) 1));
										j = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_68);
										TM_paI0W78l0CRDBLjAHJxn6w_69 = addInt(curly, ((NI) 1));
										curly = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_69);
										llStreamWrite_eHN6oO0rdFcz7KOdSd4bXw((*p).outp, 123);
									}
									break;
									case 125:
									{
										NI TM_paI0W78l0CRDBLjAHJxn6w_70;
										TM_paI0W78l0CRDBLjAHJxn6w_70 = addInt(j, ((NI) 1));
										j = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_70);
										{
										...
										LA82_: ;
										{
											NI TM_paI0W78l0CRDBLjAHJxn6w_71;
											if (!(((NI) 0) < curly)) goto LA86_;
											TM_paI0W78l0CRDBLjAHJxn6w_71 = subInt(curly, ((NI) 1));
											curly = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_71);
										}
										LA86_: ;
										llStreamWrite_eHN6oO0rdFcz7KOdSd4bXw((*p).outp, 125);
									}
									break;
									default:
									{
										NI TM_paI0W78l0CRDBLjAHJxn6w_72;
										if ((NU)(j) >= (NU)((*p).x ? (*p).x->Sup.len : 0)) raiseIndexError2(j,((*p).x ? (*p).x->Sup.len : 0)-1);
										llStreamWrite_eHN6oO0rdFcz7KOdSd4bXw((*p).outp, (*p).x->data[j]);
										TM_paI0W78l0CRDBLjAHJxn6w_72 = addInt(j, ((NI) 1));
										j = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_72);
									}
									break;
									}
								} LA77: ;
							} LA76: ;
							{
								...
								localError_NF6kBGchnhQYPbCedyefVA((*p).config, (*p).info, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_73));
								goto LA63;
							}
							LA91_: ;
							llStreamWrite_eHN6oO0rdFcz7KOdSd4bXw((*p).outp, 41);
							llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, (*p).conc);
							llStreamWrite_eHN6oO0rdFcz7KOdSd4bXw((*p).outp, 34);
						}
						break;
						...
						case 128 ... 255:
						{
							...
							llStreamWrite_eHN6oO0rdFcz7KOdSd4bXw((*p).outp, 40);
							{
								while (1) {
									NIM_BOOL T96_;
									NI TM_paI0W78l0CRDBLjAHJxn6w_74;
									T96_ = (NIM_BOOL)0;
									T96_ = (j < len);
									if (!(T96_)) goto LA97_;
									if ((NU)(j) >= (NU)((*p).x ? (*p).x->Sup.len : 0)) raiseIndexError2(j,((*p).x ? (*p).x->Sup.len : 0)-1);
									...
									if ((NU)(j) >= (NU)((*p).x ? (*p).x->Sup.len : 0)) raiseIndexError2(j,((*p).x ? (*p).x->Sup.len : 0)-1);
									llStreamWrite_eHN6oO0rdFcz7KOdSd4bXw((*p).outp, (*p).x->data[j]);
									TM_paI0W78l0CRDBLjAHJxn6w_74 = addInt(j, ((NI) 1));
									j = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_74);
								} LA95: ;
							}
							llStreamWrite_eHN6oO0rdFcz7KOdSd4bXw((*p).outp, 41);
							llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, (*p).conc);
						...
						{
							{
								NI TM_paI0W78l0CRDBLjAHJxn6w_75;
								if ((NU)(j) >= (NU)((*p).x ? (*p).x->Sup.len : 0)) raiseIndexError2(j,((*p).x ? (*p).x->Sup.len : 0)-1);
								if (!((NU8)((*p).x->data[j]) == (NU8)((*p).subsChar))) goto LA101_;
								llStreamWrite_eHN6oO0rdFcz7KOdSd4bXw((*p).outp, (*p).subsChar);
								TM_paI0W78l0CRDBLjAHJxn6w_75 = addInt(j, ((NI) 1));
								j = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_75);
							}
							goto LA99_;
							LA101_: ;
							{
								(*p).info.col = ((NI16)chckRange(j, ((NI16) -32768), ((NI16) 32767)));
								localError_NF6kBGchnhQYPbCedyefVA((*p).config, (*p).info, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_76));
							}
							LA99_: ;
						}
						break;
					...
					LA73_: ;
					{
						NI TM_paI0W78l0CRDBLjAHJxn6w_77;
						if ((NU)(j) >= (NU)((*p).x ? (*p).x->Sup.len : 0)) raiseIndexError2(j,((*p).x ? (*p).x->Sup.len : 0)-1);
						llStreamWrite_eHN6oO0rdFcz7KOdSd4bXw((*p).outp, (*p).x->data[j]);
						TM_paI0W78l0CRDBLjAHJxn6w_77 = addInt(j, ((NI) 1));
						j = (NI)(TM_paI0W78l0CRDBLjAHJxn6w_77);
					}
					LA71_: ;
				}
				break;
		...
		llStreamWrite_qdgWNgp9caij5krvzhfMCdQ((*p).outp, ((NimStringDesc*) &TM_paI0W78l0CRDBLjAHJxn6w_78));
	}
	LA5_: ;
}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TLLStream_a5oZYQ9aTktYME2449ayEi6g*, filterTmpl_ktXx03A4I583g1JBDSVOmw)(tyObject_TLLStream_a5oZYQ9aTktYME2449ayEi6g* stdin_0, NimStringDesc* filename, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* call, tyObject_ConfigRefcolonObjectType__LaK09ayL9alwKUad7rts0rTw* conf) {
	...
	p.config = conf;
	p.info = newLineInfo_q6yS31W9c9bTxOv5YvOB1n7gmsgs(conf, filename, ((NI) 0), ((NI) 0));
	p.outp = llStreamOpen_jzv9bBGhVSDMwEPDegAAa2w(((NimStringDesc*) NIM_NIL));
	p.inp = stdin_0;
	...
	p.x = rawNewString(((NI) 120));
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = llStreamReadLine_7RtV9aJubfIMSghb2POqd9ag(p.inp, (&p.x));
		if (!T3_) goto LA4_;
	...
	LA4_: ;
	{
		while (1) {
			NIM_BOOL T8_;
			T8_ = (NIM_BOOL)0;
			T8_ = llStreamReadLine_7RtV9aJubfIMSghb2POqd9ag(p.inp, (&p.x));
			if (!T8_) goto LA7;
			p.info.line = (NU16)((NU16)(p.info.line) + (NU16)(((NU16) 1)));
	...
	newLine_Seop6SJMf7a68kj2jl0nsQ_2((&p));
	result = p.outp;
	llStreamClose_pzACjlxXGrH2rRQU5WrSmg(p.inp);
	return result;
}
