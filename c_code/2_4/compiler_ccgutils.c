...
static NIM_CONST TY172865 TMP5589 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5590, "sons", 4);
extern NIM_CONST TY119461 cpu_119460;
STRING_LITERAL(TMP5593, "value expected, but got a type", 30);
STRING_LITERAL(TMP5594, "GetUniqueType", 13);
STRING_LITERAL(TMP5596, "\"", 1);
STRING_LITERAL(TMP5597, "c\"", 2);
STRING_LITERAL(TMP5601, "\\00\"", 4);
...
static N_INLINE(NI, len_173102)(tnode172659* n) {
	...
	{
		nimln(873, "ast.nim");
		if (((TMP5589[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP5590));
...
N_NIMCALL(NI64, hashstring_367102)(NimStringDesc* s) {
	...
	nimln(32, "ccgutils.nim");
	{
		...
		nimln(36, "ccgutils.nim");
		nimln(36, "ccgutils.nim");
		TMP5591 = subInt(s->Sup.len, 1);
		HEX3Atmp_367175 = (NI32)(TMP5591);
...
static N_INLINE(ttype172693*, lastson_173034)(ttype172693* n) {
	...
	TMP5595 = subInt(LOC1, 1);
	if ((NU)((NI32)(TMP5595)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP5595)];
	popFrame();
	return result;
}
N_NIMCALL(ttype172693*, getuniquetype_367401)(ttype172693* key) {
	...
	case ((NU8) 55):
	{
		...
		internalerror_139383(((NimStringDesc*) &TMP5593));	}	break;
	case ((NU8) 12):
	{
...
N_NIMCALL(NimStringDesc*, makesinglelinecstring_367611)(NimStringDesc* s) {
	...
	result = copyString(((NimStringDesc*) &TMP5596));
	c_367615 = 0;
...
N_NIMCALL(trope121007*, makellvmstring_367621)(NimStringDesc* s) {
	...
	res = copyString(((NimStringDesc*) &TMP5597));
	i_367636 = 0;
	HEX3Atmp_367647 = 0;
	...
	while (1) {
		...
		nimln(170, "ccgutils.nim");
		{
			...
			nimln(170, "ccgutils.nim");
			nimln(170, "ccgutils.nim");
			TMP5599 = addInt(i_367636, 1);
			TMP5600 = modInt((NI32)(TMP5599), 64);
			if (!(((NI) ((NI32)(TMP5600))) == 0)) goto LA4;
...
appendString(res, ((NimStringDesc*) &TMP5601));
