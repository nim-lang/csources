...
static N_INLINE(tnode186813*, lastson_187199)(tnode186813* n) {
	...
	if ((NU)((NI32)(TMP5619)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI32)(TMP5619)];
	popFrame();
	return result;
}
...
static N_INLINE(ttype186847*, lastson_187203)(ttype186847* n) {
	...
	if ((NU)((NI32)(TMP5624)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP5624)];
	popFrame();
	return result;
}
