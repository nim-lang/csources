...
NIM_CONST TY198015 parsernames_198014 = {((NimStringDesc*) &TMP2615),
...
N_NIMCALL(tnode172659*, parseall_198046)(tparsers198026* p) {
	...
	case ((NU8) 2):
	{
		...
		internalerror_139383(((NimStringDesc*) &TMP2626));		nimln(63, "syntaxes.nim");
...
N_NIMCALL(tnode172659*, parsetoplevelstmt_198051)(tparsers198026* p) {
	...
	case ((NU8) 2):
	{
		...
		internalerror_139383(((NimStringDesc*) &TMP2626));		nimln(74, "syntaxes.nim");
		result = emptynode_173505;
	}	break;
	}
	popFrame();
...
N_NIMCALL(NIM_BOOL, containsshebang_198097)(NimStringDesc* s, NI i) {
	...
	nimln(84, "syntaxes.nim");
	{
		...
		nimln(84, "syntaxes.nim");
		TMP2627 = addInt(i, 1);
		if ((NU)((NI32)(TMP2627)) > (NU)(s->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(s->data[(NI32)(TMP2627)]) == (NU8)(33));
		LA4: ;
		if (!LOC3) goto LA5;
...
N_NIMCALL(tnode172659*, parsepipe_198126)(NimStringDesc* filename, tllstream162204* inputstream) {
	...
	nimln(92, "syntaxes.nim");
	{
		...
		nimln(99, "syntaxes.nim");
		{
			...
			nimln(99, "syntaxes.nim");
			TMP2629 = addInt(i, 1);
			if ((NU)((NI32)(TMP2629)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC14 = ((NU8)(line->data[(NI32)(TMP2629)]) == (NU8)(33));
			LA15: ;
			if (!LOC14) goto LA16;
...
N_NIMCALL(tllstream162204*, evalpipe_198391)(tparsers198026* p, tnode172659* n, NimStringDesc* filename, tllstream162204* start) {
	...
	nimln(152, "syntaxes.nim");
	{
		...
		if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP2632[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2633));
		LOC7 = identeq_141456((*(*n).kindU.S6.Sons->data[0]).kindU.S5.Ident, ((NimStringDesc*) &TMP2634));
		LA10: ;
		if (!LOC7) goto LA11;
		i_198465 = 0;
		nimln(1301, "system.nim");
...
NTI198005.node = &TMP2251[5];
TMP2251[1].kind = 1;
TMP2251[1].offset = offsetof(tparsers198026, Skin);
TMP2251[1].typ = (&NTI198005);
TMP2251[1].name = "skin";
TMP2622[1] = &TMP2251[6];
TMP2251[6].kind = 1;
TMP2251[6].offset = offsetof(tparsers198026, Parser);
TMP2251[6].typ = (&NTI186203);
TMP2251[6].name = "parser";
TMP2251[0].len = 2; TMP2251[0].kind = 2; TMP2251[0].sons = &TMP2622[0];
NTI198026.node = &TMP2251[0];
}
