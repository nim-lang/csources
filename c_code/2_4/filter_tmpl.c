...
#include <stdio.h>
typedef struct ttmplparser218017 ttmplparser218017;
...
N_NIMCALL(void, newline_218040)(ttmplparser218017* p);
...
static N_INLINE(NIM_BOOL, withinexpr_218168)(ttmplparser218017* p);
...
NIM_CONST TY121387 patternchars_218037 = {
...
static NIM_CONST TY121387 TMP2670 = {
...
N_NIMCALL(void, newline_218040)(ttmplparser218017* p) {
	...
	llstreamwrite_174258((*p).Outp, LOC1);
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		nimln(42, "filter_tmpl.nim");
		llstreamwrite_174258((*p).Outp, ((NimStringDesc*) &TMP2665));
	}
	LA4: ;
	nimln(43, "filter_tmpl.nim");
	{
		...
		llstreamwrite_174258((*p).Outp, LOC10);
...
N_NIMCALL(void, parseline_218177)(ttmplparser218017* p) {
	...
	LA6: ;
	{
		...
		case ((NU8) 20):
		{
			...
			LA19: ;
			{
				...
				localerror_164571((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP2667));
			}
			LA17: ;
		...
		case ((NU8) 60):
		{
			...
			nimln(104, "filter_tmpl.nim");
			{
				...
				nimln(104, "filter_tmpl.nim");
				LOC34 = 0;
				LOC34 = contains_90258((*p).X, TMP2670);
				if (!!(LOC34)) goto LA35;
	...
	LA9: ;
	{
		...
		case ((NU8) 1):
		{
			...
			llstreamwrite_174258((*p).Outp, ((NimStringDesc*) &TMP2672));
		}
		break;
		case ((NU8) 0):
		{
			...
			llstreamwrite_174258((*p).Outp, ((NimStringDesc*) &TMP2673));
		...
		while (1) {
			...
			case 92:
			{
				...
				llstreamwrite_174258((*p).Outp, ((NimStringDesc*) &TMP2675));
			...
			case 39:
			{
				...
				llstreamwrite_174258((*p).Outp, ((NimStringDesc*) &TMP2676));
			...
			case 34:
			{
				...
				llstreamwrite_174258((*p).Outp, ((NimStringDesc*) &TMP2677));
				...
				nimln(150, "filter_tmpl.nim");
				{
					...
					case 123:
					{
						...
						while (1) {
							...
							case 0:
							{
								...
								localerror_164571((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP2678));
					...
					default:
					{
						...
						LA76: ;
						{
							...
							localerror_164571((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP2679));
						}
						LA74: ;
					}
					break;
		...
		llstreamwrite_174258((*p).Outp, ((NimStringDesc*) &TMP2680));
	}
	LA2: ;
	popFrame();
}
...
N_NIMCALL(tllstream174204*, filtertmpl_218007)(tllstream174204* stdin_218009, NimStringDesc* filename, tnode186813* call) {
	...
	p.Info = newlineinfo_163077(filename, 0, 0);
	nimln(208, "filter_tmpl.nim");
	p.Outp = llstreamopen_174218(((NimStringDesc*) &TMP2666));
	nimln(209, "filter_tmpl.nim");
	p.Inp = stdin_218009;
	nimln(210, "filter_tmpl.nim");
	p.Subschar = chararg_217014(call, ((NimStringDesc*) &TMP2681), 1, 36);
	nimln(211, "filter_tmpl.nim");
	p.Nimdirective = chararg_217014(call, ((NimStringDesc*) &TMP2682), 2, 35);
	nimln(212, "filter_tmpl.nim");
	p.Emit = strarg_217021(call, ((NimStringDesc*) &TMP2683), 3, ((NimStringDesc*) &TMP2684));
	nimln(213, "filter_tmpl.nim");
	p.Conc = strarg_217021(call, ((NimStringDesc*) &TMP2685), 4, ((NimStringDesc*) &TMP2686));
	nimln(214, "filter_tmpl.nim");
	p.Tostr = strarg_217021(call, ((NimStringDesc*) &TMP2687), 5, ((NimStringDesc*) &TMP2679));
	...
	while (1) {
		...
		nimln(216, "filter_tmpl.nim");
		LOC2 = 0;
		LOC2 = llstreamreadline_174248(p.Inp, &p.X);
		if (!LOC2) goto LA1;
