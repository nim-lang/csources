...
N_NIMCALL(NI, fsreaddata_158912_1780494535)(Streamobj157818* s0, void* buffer0, NI buflen0);
...
N_NIMCALL(Filestreamobj158877*, newfilestream_158930_1780494535)(FILE* f0) {
	...
	(*result0).Sup.readdataimpl = fsreaddata_158912_1780494535;
	(*result0).Sup.peekdataimpl = fspeekdata_158918_1780494535;
	(*result0).Sup.writedataimpl = fswritedata_158925_1780494535;
...
N_NIMCALL(Filestreamobj158877*, newfilestream_158942_1780494535)(NimStringDesc* filename0, Filemode13009 mode0) {
	...
	f0 = (FILE*)0;
	{
		...
		if (!LOC3) goto LA4;
		result0 = newfilestream_158930_1780494535(f0);
	}
	LA4: ;
	return result0;
}
