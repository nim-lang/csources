...
N_NIMCALL(void, writeln_143778)(tstream143629* s, NimStringDesc** args, NI argsLen0) {
	...
	write_143772(s, ((NimStringDesc*) &TMP921));	popFrame();
}
N_NIMCALL(NIM_CHAR, readchar_143808)(tstream143629* s) {
	NIM_CHAR result;
...
N_NIMCALL(void, read_143821)(tstream143629* s, NIM_BOOL* result) {
	...
	nimln(117, "streams.nim");
	{
		...
		LOC6 = 0;
		LOC6 = neweio_143607(((NimStringDesc*) &TMP922));
		nimln(118, "streams.nim");
...
N_NIMCALL(NI, ssreaddata_144038)(tstream143629* s_144040, void* buffer, NI buflen) {
	...
	result = ((buflen <= (NI32)(TMP926)) ? buflen : (NI32)(TMP926));
...
N_NIMCALL(void, sswritedata_144062)(tstream143629* s_144064, void* buffer, NI buflen) {
	...
	nimln(221, "streams.nim");
	{
		...
		(*s).Data = setLengthStr((*s).Data, (NI32)(TMP927));
...
N_NIMCALL(void, fswritedata_144160)(tstream143629* s, void* buffer, NI buflen) {
	...
	nimln(260, "streams.nim");
	{
		...
		LOC6 = 0;
		LOC6 = neweio_143607(((NimStringDesc*) &TMP929));
		nimln(261, "streams.nim");
		raiseException((E_Base*)LOC6, "EIO");
	}	LA4: ;
	popFrame();
...
NTI143630.flags = 3;
TMP919[1].kind = 1;
TMP919[1].offset = offsetof(tstream143629, Closeimpl);
TMP919[1].typ = (&NTI143630);
...
NTI143634.flags = 3;
TMP919[2].kind = 1;
TMP919[2].offset = offsetof(tstream143629, Atendimpl);
TMP919[2].typ = (&NTI143634);
...
NTI143638.flags = 3;
TMP919[3].kind = 1;
TMP919[3].offset = offsetof(tstream143629, Setpositionimpl);
TMP919[3].typ = (&NTI143638);
...
NTI143643.flags = 3;
TMP919[4].kind = 1;
TMP919[4].offset = offsetof(tstream143629, Getpositionimpl);
TMP919[4].typ = (&NTI143643);
...
NTI143647.flags = 3;
TMP919[5].kind = 1;
TMP919[5].offset = offsetof(tstream143629, Readdataimpl);
TMP919[5].typ = (&NTI143647);
...
NTI143653.flags = 3;
TMP919[6].kind = 1;
TMP919[6].offset = offsetof(tstream143629, Writedataimpl);
TMP919[6].typ = (&NTI143653);
...
NTI143659.flags = 3;
TMP919[7].kind = 1;
TMP919[7].offset = offsetof(tstream143629, Flushimpl);
TMP919[7].typ = (&NTI143659);
TMP919[7].name = "flushImpl";
TMP919[0].len = 7; TMP919[0].kind = 2; TMP919[0].sons = &TMP924[0];
NTI143629.node = &TMP919[0];
