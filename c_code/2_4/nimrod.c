...
N_NIMCALL(void, loadconfigs_217811)(NimStringDesc* cfg);
...
N_NOINLINE(void, stdlib_linuxInit)(void);
N_NOINLINE(void, stdlib_linuxDatInit)(void);
...
STRING_LITERAL(TMP1481, "", 0);
STRING_LITERAL(TMP1648, "nimrod.cfg", 10);
STRING_LITERAL(TMP4786, "./", 2);
STRING_LITERAL(TMP4787, "js", 2);
STRING_LITERAL(TMP4788, "node ", 5);
...
appendString(LOC7, ((NimStringDesc*) &TMP4786));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
N_NIMCALL(void, handlecmdline_599607)(void) {
	...
	LA4: ;
	{
		processcmdline_593213(((NU8) 0), ((NimStringDesc*) &TMP1481));
		{
			TSafePoint TMP1482;
			TY114804 p;
			NimStringDesc* LOC15;
			...
			pushSafePoint(&TMP1482);
			TMP1482.status = setjmp(TMP1482.context);
			if (TMP1482.status == 0) {
			...
			if (TMP1482.status != 0) reraiseException();
		...
		LA7: ;
		loadconfigs_217811(((NimStringDesc*) &TMP1648));
		initvars_202812();
		processcmdline_593213(((NU8) 1), ((NimStringDesc*) &TMP1481));
		maincommand_597027();
		{
			NimStringDesc* LOC22;
			...
			if (!(gerrorcounter_196306 == 0)) goto LA25;
			{
				if (!((gglobaloptions_166118 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				{
					...
					LA37: ;
					{
						...
						NimStringDesc* LOC43;
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_166237, ((NimStringDesc*) &TMP4787));
						LOC42 = 0;
...
appendString(LOC44, ((NimStringDesc*) &TMP4788));
...
appendString(LOC44, arguments_593209);
				...
				LA33: ;
				{
					...
					LA48: ;
					{
						NimStringDesc* LOC51;
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_166237, ((NimStringDesc*) &TMP1481));
