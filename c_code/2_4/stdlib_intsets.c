...
N_NIMCALL(void, intsetenlarge_222614)(intset222056* t) {
	...
	n = (ttrunkseq222054*) newSeq((&NTI222054), (NI32)((*t).Max + 1));
	{
		NI i_222648;
		NI res_222686;
		i_222648 = 0;
...
N_NIMCALL(ttrunk222052*, intsetput_222703)(intset222056* t, NI key) {
	...
	}
	{
		NIM_BOOL LOC9;
		LOC9 = 0;
		LOC9 = mustrehash_222073((NI32)((*t).Max + 1), (*t).Counter);
		if (!LOC9) goto LA10;
...
N_NIMCALL(void, incl_222869)(intset222056* s, NI key) {
	ttrunk222052* t;
	NI u;
	t = intsetput_222703(s, (NI)((NU32)(key) >> (NU32)(9)));
	u = (NI)(key & 511);
...
N_NIMCALL(NIM_BOOL, containsorincl_222916)(intset222056* s, NI key) {
	...
	ttrunk222052* t;
	result = 0;
	t = intsetget_222220((*s), (NI)((NU32)(key) >> (NU32)(9)));
	{
		NI u;
