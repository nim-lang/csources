...
extern TY193104 writelnhook_193107_155036129;
N_NIMCALL(void, T3526807654_2)(void) {
...
appendString(LOC1, ((NimStringDesc*) &T3526807654_16));
	send_589801_170061329((*HEX3Aenvp_593424_3526807654).stdoutsocket593408, LOC1, 2);
}
	...
	LA2: ;
	{
		...
		writelnhook_193107_155036129.ClPrc = LOC21.ClPrc;
		{
			while (1) {
				...
				action0();
				gerrorcounter_193069_155036129 = ((NI) 0);
				send_589801_170061329((*HEX3Aenv_593426_3526807654).stdoutsocket593408, ((NimStringDesc*) &T3526807654_16), 2);
