...
STRING_LITERAL(TMP4143, "ccgmerge: \':\' expected", 22);
STRING_LITERAL(TMP4144, "NIM_merge_INFO", 14);
STRING_LITERAL(TMP4145, "typeCache", 9);
STRING_LITERAL(TMP4146, "declared", 8);
STRING_LITERAL(TMP4147, "typeInfo", 8);
STRING_LITERAL(TMP4148, "labels", 6);
STRING_LITERAL(TMP4149, "hasframe", 8);
STRING_LITERAL(TMP4150, "ccgmerge: \'{\' expected", 22);
STRING_LITERAL(TMP4151, "ccgmerge: unknown key: ", 23);
STRING_LITERAL(TMP4220, "ccgmerge: expected: /*\011NIM_merge_END:*/", 39);
STRING_LITERAL(TMP4221, "/*\011NIM_merge_END:*/", 19);
STRING_LITERAL(TMP4222, "", 0);
STRING_LITERAL(TMP4223, "NIM_merge_HEADERS", 17);
STRING_LITERAL(TMP4224, "NIM_merge_FORWARD_TYPES", 23);
STRING_LITERAL(TMP4225, "NIM_merge_TYPES", 15);
STRING_LITERAL(TMP4226, "NIM_merge_SEQ_TYPES", 19);
STRING_LITERAL(TMP4227, "NIM_merge_FIELD_INFO", 20);
STRING_LITERAL(TMP4228, "NIM_merge_TYPE_INFO", 19);
STRING_LITERAL(TMP4229, "NIM_merge_PROC_HEADERS", 22);
STRING_LITERAL(TMP4230, "NIM_merge_DATA", 14);
STRING_LITERAL(TMP4231, "NIM_merge_VARS", 14);
STRING_LITERAL(TMP4232, "NIM_merge_PROCS", 15);
STRING_LITERAL(TMP4233, "NIM_merge_INIT_PROC", 19);
STRING_LITERAL(TMP4234, "NIM_merge_TYPE_INIT1", 20);
STRING_LITERAL(TMP4235, "NIM_merge_TYPE_INIT2", 20);
STRING_LITERAL(TMP4236, "NIM_merge_TYPE_INIT3", 20);
STRING_LITERAL(TMP4237, "NIM_merge_DEBUG_INIT", 20);
STRING_LITERAL(TMP4238, "NIM_merge_DYNLIB_INIT", 21);
STRING_LITERAL(TMP4239, "NIM_merge_DYNLIB_DEINIT", 23);
NIM_CONST TY464013 cfilesectionnames_464012 = {((NimStringDesc*) &TMP4222),
...
;
STRING_LITERAL(TMP4240, "NIM_merge_PROC_LOCALS", 21);
STRING_LITERAL(TMP4241, "NIM_merge_PROC_INIT", 19);
STRING_LITERAL(TMP4242, "NIM_merge_PROC_BODY", 19);
NIM_CONST TY464019 cprocsectionnames_464018 = {((NimStringDesc*) &TMP4240),
((NimStringDesc*) &TMP4241),
((NimStringDesc*) &TMP4242)}
;
STRING_LITERAL(TMP4243, "ccgmerge: unknown section: ", 27);
STRING_LITERAL(TMP4244, "ccgmerge: \'*/\' expected", 23);
STRING_LITERAL(TMP4248, "/*\011", 3);
STRING_LITERAL(TMP4249, ":*/", 3);
STRING_LITERAL(TMP4257, "/*\011NIM_merge_INFO:", 18);
STRING_LITERAL(TMP4258, "typeCache:{", 11);
STRING_LITERAL(TMP4259, "declared:{", 10);
STRING_LITERAL(TMP4260, "typeInfo:{", 10);
STRING_LITERAL(TMP4261, "labels:", 7);
STRING_LITERAL(TMP4262, " hasframe:", 10);
...
N_NIMCALL(void, readkey_464466)(tbaselexer195024* l, NimStringDesc** result) {
	...
	}
	{
		...
		internalerror_182443(((NimStringDesc*) &TMP4143));
	}
	LA5: ;
...
N_NIMCALL(void, readtypecache_464524)(tbaselexer195024* l, tidtable207861* result) {
	{
		...
		internalerror_182443(((NimStringDesc*) &TMP4150));
	}
	LA3: ;
	(*l).Bufpos += ((NI) 1);
	{
...
N_NIMCALL(void, processmergeinfo_464613)(tbaselexer195024* l, tcgen463035* m) {
	...
	k = rawNewString(((NI) 9));
	{
		while (1) {
			...
			LA7: ;
			readkey_464466(l, (&k));
			if (eqStrings(k, ((NimStringDesc*) &TMP4145))) goto LA9;
			if (eqStrings(k, ((NimStringDesc*) &TMP4146))) goto LA10;
			if (eqStrings(k, ((NimStringDesc*) &TMP4147))) goto LA11;
			if (eqStrings(k, ((NimStringDesc*) &TMP4148))) goto LA12;
...
appendString(LOC24, ((NimStringDesc*) &TMP4151));
...
{	s_464820 = llstreamopen_194256(cfilename, ((NU8) 0));
	...
	k = rawNewString(((NI) 23));
	{
		while (1) {
			...
			readkey_464466((&l), (&k));
			{
				if (!eqStrings(k, ((NimStringDesc*) &TMP4144))) goto LA13;
...
N_NIMCALL(NIM_BOOL, atendmark_464397)(NCSTRING buf, NI pos) {
	...
	s = ((NI) 0);
	{
		while (1) {
			...
			LOC3 = (s < ((NI) 19));
			if (!(LOC3)) goto LA4;
			LOC3 = ((NU8)(buf[(NI64)(pos + s)]) == (NU8)(((NimStringDesc*) &TMP4221)->data[s]));
			LA4: ;
			if (!LOC3) goto LA2;
			s += ((NI) 1);
		} LA2: ;
...
appendString(r, tnl_174626);
			...
			case 0:
			{
				internalerror_182443(((NimStringDesc*) &TMP4220));
				goto LA1;
			}
			break;
			default:
...
appendString(LOC34, ((NimStringDesc*) &TMP4243));
appendString(LOC34, k);
			...
			LA18: ;
			{
				internalerror_182443(((NimStringDesc*) &TMP4244));
			}
			LA11: ;
		}
	} LA5: ;
...
N_NIMCALL(trope177009*, gensectionstart_464106)(NU8 ps) {
	...
	result = 0;
	{
		...
		app_177060(&result, ((NimStringDesc*) &TMP4248));
		app_177060(&result, cprocsectionnames_464018[(ps)- 0]);
		app_177060(&result, ((NimStringDesc*) &TMP4249));
...
appendString(LOC5, ((NimStringDesc*) &TMP4221));
						...
						j_464257 = ((NI) 0);
						{
							while (1) {
								if (!!((w_464255 == ((NI) 0)))) goto LA7;
								{
									...
									x_464236 = (NI)((NI)((NU64)((*r_464251).Key) << (NU64)(((NI) 9))) | (NI)((NU64)((NI)((NU64)(i_464253) << (NU64)(((NI) 6)))) + (NU64)(j_464257)));
									{
...
appendString((*s), tnl_174626);
								...
								LA10: ;
								j_464257 += ((NI) 1);
								w_464255 = (NI)((NU64)(w_464255) >> (NU64)(((NI) 1)));
							} LA7: ;
						}
						i_464253 += ((NI) 1);
					} LA5: ;
...
{	result = 0;
	...
	LA3: ;
	s = copyString(((NimStringDesc*) &TMP4257));
	s = resizeString(s, tnl_174626->Sup.len + 0);
appendString(s, tnl_174626);
	s = resizeString(s, 11);
appendString(s, ((NimStringDesc*) &TMP4258));
	writetypecache_464184((*m).Typecache, (&s));
	s = resizeString(s, 10);
appendString(s, ((NimStringDesc*) &TMP4259));
	writeintset_464230((&(*m).Declaredthings), (&s));
	s = resizeString(s, 10);
appendString(s, ((NimStringDesc*) &TMP4260));
