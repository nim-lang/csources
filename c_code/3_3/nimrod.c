...
typedef struct tcell44133 tcell44133;
typedef struct tcellseq44149 tcellseq44149;
typedef struct tgcheap46216 tgcheap46216;
typedef struct tcellset44145 tcellset44145;
typedef struct tpagedesc44141 tpagedesc44141;
...
struct  tcellseq44149  {
NI Len;
NI Cap;
tcell44133** D;
};
struct  tcellset44145  {
NI Counter;
NI Max;
tpagedesc44141* Head;
tpagedesc44141** Data;
...
NI Cyclethreshold;
tcellseq44149 Zct;
tcellseq44149 Decstack;
tcellset44145 Cycleroots;
tcellseq44149 Tempstack;
NI Recgclock;
...
N_NIMCALL(NI, paramcount_121039)(void);
...
static N_INLINE(tcell44133*, usrtocell_47846)(void* usr);
static N_INLINE(void, rtladdzct_49404)(tcell44133* c);
N_NOINLINE(void, addzct_47817)(tcellseq44149* s, tcell44133* c);
...
static N_INLINE(void, incref_50225)(tcell44133* c);
static N_INLINE(NIM_BOOL, canbecycleroot_47867)(tcell44133* c);
static N_INLINE(void, rtladdcycleroot_48629)(tcell44133* c);
N_NOINLINE(void, incl_44871)(tcellset44145* s, tcell44133* cell);
static N_INLINE(void, decref_49804)(tcell44133* c);
N_NIMCALL(void, reraiseException)(void);
N_NIMCALL(void, nossplitFile)(NimStringDesc* path, TY115004* Result);
...
STRING_LITERAL(TMP1477, "", 0);
STRING_LITERAL(TMP1644, "nimrod.cfg", 10);
STRING_LITERAL(TMP4781, "./", 2);
STRING_LITERAL(TMP4782, "js", 2);
STRING_LITERAL(TMP4783, "node ", 5);
...
extern Exception* currexception_15445;
...
static N_INLINE(tcell44133*, usrtocell_47846)(void* usr) {
	tcell44133* result;
	result = 0;
	result = ((tcell44133*) ((NI)((NU64)(((NI) (usr))) - (NU64)(((NI)sizeof(tcell44133))))));
	return result;
}
...
appendString(LOC7, ((NimStringDesc*) &TMP4781));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
N_NIMCALL(void, handlecmdline_598607)(void) {
	...
	LA4: ;
	{
		processcmdline_592213(((NU8) 0), ((NimStringDesc*) &TMP1477));
		{
			TSafePoint TMP1478;
			TY115004 p;
			NimStringDesc* LOC15;
			...
			pushSafePoint(&TMP1478);
			TMP1478.status = setjmp(TMP1478.context);
			if (TMP1478.status == 0) {
			...
			if (TMP1478.status != 0) reraiseException();
		...
		LA7: ;
		loadconfigs_216811(((NimStringDesc*) &TMP1644));
		initvars_201812();
		processcmdline_592213(((NU8) 1), ((NimStringDesc*) &TMP1477));
		maincommand_596027();
		{
			NimStringDesc* LOC22;
		...
		LA20: ;
		{
			if (!(gerrorcounter_195303 == 0)) goto LA25;
			{
				if (!((gglobaloptions_165118 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				{
					...
					LA37: ;
					{
						...
						NimStringDesc* LOC43;
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_165237, ((NimStringDesc*) &TMP4782));
						LOC42 = 0;
...
appendString(LOC44, ((NimStringDesc*) &TMP4783));
...
appendString(LOC44, arguments_592209);
				...
				LA33: ;
				{
					...
					LA48: ;
					{
						NimStringDesc* LOC51;
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_165237, ((NimStringDesc*) &TMP1477));
...
N_NOINLINE(void, nimrodInit)(void) {
	...
	exit(((NI) (((NI8) ((0 < gerrorcounter_195303))))));
}
