...
N_NIMCALL(NI, send_589492_170061329)(Socketimpl584404* socket0, void* data0, NI size0);
...
N_NIMCALL(NI, waitfor_588606_170061329)(Socketimpl584404* socket0, NF* waited0, NI timeout0, NI size0, NimStringDesc* funcname0);
...
N_NIMCALL(Socketimpl584404*, newsocket_584674_170061329)(int fd0, Domain578604 domain0, Socktype578606 socktype0, Protocol578608 protocol0, NIM_BOOL buffered0) {
	...
	LA3: ;
	setsockoptint_582831_466562973(fd0, ((NI) (SOL_SOCKET)), ((NI) (SO_NOSIGPIPE)), ((NI) 1));
	return result0;
}
...
N_NIMCALL(void, bindaddr_585808_170061329)(Socketimpl584404* socket0, NU16 port0, NimStringDesc* address0) {
	{
		...
		name0.sin_port = ntohs_580007_466562973(port0);
...
N_NIMCALL(void, send_589801_170061329)(Socketimpl584404* socket0, NimStringDesc* data0, Socketflag584414Set flags0) {
	NI sent0;
{	sent0 = send_589492_170061329(socket0, ((void*) (data0->data)), (data0 ? data0->Sup.len : 0));
	{
		NI32 lasterror0;
