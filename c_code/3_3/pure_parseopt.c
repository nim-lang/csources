...
static NIM_CONST TY113118 TMP7029 = {
...
appendChar(LOC7, 32);
	...
	unsureAsgnRef((void**) &(*Result).Key, copyString(((NimStringDesc*) &TMP7028)));
	nimln(57, "parseopt.nim");
	unsureAsgnRef((void**) &(*Result).Val, copyString(((NimStringDesc*) &TMP7028)));
	popFrame();
}
N_NIMCALL(NI, parseword_416802)(NimStringDesc* s, NI i, NimStringDesc** w, TY113118 delim) {
	NI result;
...
N_NIMCALL(void, handleshortoption_416876)(toptparser416607* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_416802((*p).Cmd, i, &(*p).Val, TMP7029);
	}	LA4: ;
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser416607* p) {
	...
	LOC1 = 0;
	LOC1 = copyStrLast((*p).Cmd, (*p).Pos, (NI64)(TMP7031));
...
static TNimNode* TMP7033[6];
static TNimNode* TMP7034[4];
NI TMP7036;
static char* NIM_CONST TMP7035[4] = {
"cmdEnd", 
"cmdArgument", 
"cmdLongoption", 
"cmdShortOption"};
...
TMP7033[0] = &TMP7022[1];
TMP7022[1].kind = 1;
TMP7022[1].offset = offsetof(toptparser416607, Cmd);
TMP7022[1].typ = (&NTI142);
TMP7022[1].name = "cmd";
TMP7033[1] = &TMP7022[2];
TMP7022[2].kind = 1;
TMP7022[2].offset = offsetof(toptparser416607, Pos);
TMP7022[2].typ = (&NTI105);
TMP7022[2].name = "pos";
TMP7033[2] = &TMP7022[3];
TMP7022[3].kind = 1;
TMP7022[3].offset = offsetof(toptparser416607, Inshortstate);
...
NTI416605.base = 0;
NTI416605.flags = 3;
for (TMP7036 = 0; TMP7036 < 4; TMP7036++) {
TMP7022[TMP7036+5].kind = 1;
TMP7022[TMP7036+5].offset = TMP7036;
TMP7022[TMP7036+5].name = TMP7035[TMP7036];
TMP7034[TMP7036] = &TMP7022[TMP7036+5];
}
TMP7022[9].len = 4; TMP7022[9].kind = 2; TMP7022[9].sons = &TMP7034[0];
NTI416605.node = &TMP7022[9];
TMP7022[4].kind = 1;
TMP7022[4].offset = offsetof(toptparser416607, Kind);
TMP7022[4].typ = (&NTI416605);
TMP7022[4].name = "kind";
TMP7033[4] = &TMP7022[10];
TMP7022[10].kind = 1;
TMP7022[10].offset = offsetof(toptparser416607, Key);
TMP7022[10].typ = (&NTI142);
TMP7022[10].name = "key";
TMP7033[5] = &TMP7022[11];
TMP7022[11].kind = 1;
TMP7022[11].offset = offsetof(toptparser416607, Val);
TMP7022[11].typ = (&NTI142);
TMP7022[11].name = "val";
TMP7022[0].len = 6; TMP7022[0].kind = 2; TMP7022[0].sons = &TMP7033[0];
NTI416607.node = &TMP7022[0];
}
