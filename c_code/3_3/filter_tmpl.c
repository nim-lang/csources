...
STRING_LITERAL(TMP1313, "", 0);
STRING_LITERAL(TMP1314, "subschar", 8);
STRING_LITERAL(TMP1315, "metachar", 8);
STRING_LITERAL(TMP1316, "emit", 4);
STRING_LITERAL(TMP1317, "result.add", 10);
STRING_LITERAL(TMP1318, "conc", 4);
STRING_LITERAL(TMP1319, " & ", 3);
STRING_LITERAL(TMP1320, "tostring", 8);
STRING_LITERAL(TMP1321, "$", 1);
STRING_LITERAL(TMP1322, "\012", 1);
STRING_LITERAL(TMP1324, "end", 3);
STRING_LITERAL(TMP1325, "#end", 4);
static NIM_CONST TY211607 TMP1326 = {
...
N_NIMCALL(void, newline_257047)(ttmplparser257020* p) {
	...
	(*p).Emitpar = 0;
	{
		...
		llstreamwrite_211278((*p).Outp, ((NimStringDesc*) &TMP1322));
	}
	LA4: ;
	{
		NimStringDesc* LOC10;
...
N_NIMCALL(void, parseline_257174)(ttmplparser257020* p) {
	...
	LA7: ;
	{
		...
		d = j;
		keyw = copyString(((NimStringDesc*) &TMP1313));
		{
			while (1) {
		...
		case ((NU8) 20):
		{
			...
			{
				(*p).Info.Col = ((NI16) (j));
				localerror_197938((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP1324));
			}
			LA20: ;
			LOC25 = 0;
			LOC25 = nsuRepeatChar((*p).Indent, 32);
			llstreamwrite_211278((*p).Outp, LOC25);
			llstreamwrite_211278((*p).Outp, ((NimStringDesc*) &TMP1325));
		}
		break;
		case ((NU8) 28):
		case ((NU8) 62):
		...
		case ((NU8) 59):
		{
			...
			llstreamwrite_211278((*p).Outp, LOC34);
			{
				NIM_BOOL LOC37;
				LOC37 = 0;
				LOC37 = contains_97229((*p).X, TMP1326);
				if (!!(LOC37)) goto LA38;
				(*p).Indent += 2;
			}
			LA38: ;
	...
	LA10: ;
	{
		...
		case ((NU8) 1):
		{
			...
			llstreamwrite_211278((*p).Outp, ((NimStringDesc*) &TMP1327));
		}
		break;
		case ((NU8) 0):
		{
			...
			llstreamwrite_211278((*p).Outp, ((NimStringDesc*) &TMP1328));
			(*p).Emitpar += 1;
		}
		break;
		}
		(*p).State = ((NU8) 1);
		{
			while (1) {
				...
				case 92:
				{
					llstreamwrite_211278((*p).Outp, ((NimStringDesc*) &TMP1330));
					j += 1;
				}
				break;
				case 39:
				...
				{
					{
						...
						case 123:
						{
							...
							curly = 0;
							{
								while (1) {
									...
									case 0:
									{
										localerror_197938((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP1333));
										goto LA62;
									}
									break;
									case 123:
						...
						default:
						{
							...
							{
								(*p).Info.Col = ((NI16) (j));
								localerror_197938((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP1321));
							}
							LA80: ;
						}
						break;
...
N_NIMCALL(tllstream211204*, filtertmpl_257009)(tllstream211204* stdin_257011, NimStringDesc* filename, tnode224819* call) {
	...
	p.Outp = llstreamopen_211220(((NimStringDesc*) &TMP1313));
	p.Inp = stdin_257011;
	p.Subschar = chararg_256020(call, ((NimStringDesc*) &TMP1314), 1, 36);
	p.Nimdirective = chararg_256020(call, ((NimStringDesc*) &TMP1315), 2, 35);
	p.Emit = strarg_256029(call, ((NimStringDesc*) &TMP1316), 3, ((NimStringDesc*) &TMP1317));
	p.Conc = strarg_256029(call, ((NimStringDesc*) &TMP1318), 4, ((NimStringDesc*) &TMP1319));
	p.Tostr = strarg_256029(call, ((NimStringDesc*) &TMP1320), 5, ((NimStringDesc*) &TMP1321));
