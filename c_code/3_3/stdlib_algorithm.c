...
typedef N_CLOSURE_PTR(NI, TMP5094) (tsym186843* x_357870, tsym186843* y_357872);
struct  NimStringDesc  {
  TGenericSeq Sup;
NIM_CHAR data[SEQ_DECL_SIZE];
};
typedef N_CLOSURE_PTR(NI, TMP5096) (tsym186843* x_357870, tsym186843* y_357872);
struct  tentry360566  {
NI Pos;
tsym186843* Sym;
};
...
typedef N_CLOSURE_PTR(NI, TMP5113) (tentry360566 x_361254, tentry360566 y_361256);
typedef N_CLOSURE_PTR(NI, TMP5114) (tentry360566 x_361254, tentry360566 y_361256);
struct  TNimObject  {
TNimType* m_type;
};
struct  tidobj166013  {
...
STRING_LITERAL(TMP5095, "j (<=|<=|<=|<=|<=|<=|<=|<=|<=|<=|<=|<=|<=|<=|<=)\015\012    m ", 56);
...
static N_INLINE(NI, HEX2A_352919)(NI x, NU8 order) {
	...
	nimln(21, "algorithm.nim");
	nimln(21, "algorithm.nim");
	TMP5012 = subInt(((NI) (order)), 1);
	y = (NI64)(TMP5012);
	nimln(22, "algorithm.nim");
	nimln(22, "algorithm.nim");
	nimln(22, "algorithm.nim");
	TMP5013 = subInt((NI)(x ^ ((NI) (y))), ((NI) (y)));
	result = (NI64)(TMP5013);
	popFrame();
	return result;
}
...
N_NIMCALL(void, merge_357843)(tsym186843** a_357851, NI a_357851Len0, tsym186843** b_357859, NI b_357859Len0, NI lo_357863, NI m_357865, NI hi_357867, TY357801 cmp_357875, NU8 order_357878) {
	...
	nimln(101, "algorithm.nim");
	{
		...
		nimln(101, "algorithm.nim");
		TMP5093 = addInt(m_357865, 1);
		if ((NU)((NI64)(TMP5093)) >= (NU)(a_357851Len0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp_357875.ClEnv? cmp_357875.ClPrc(a_357851[m_357865], a_357851[(NI64)(TMP5093)], cmp_357875.ClEnv):((TMP5094)(cmp_357875.ClPrc))(a_357851[m_357865], a_357851[(NI64)(TMP5093)]);
		LOC4 = 0;
	...
	nimln(104, "algorithm.nim");
	{
		...
		nimln(104, "algorithm.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP5095));
	}
	LA9: ;
	...
	while (1) {
		...
		nimln(118, "algorithm.nim");
		{
			...
			if ((NU)(j) >= (NU)(a_357851Len0)) raiseIndexError();
			LOC17 = 0;
			LOC17 = cmp_357875.ClEnv? cmp_357875.ClPrc(b_357859[i], a_357851[j], cmp_357875.ClEnv):((TMP5096)(cmp_357875.ClPrc))(b_357859[i], a_357851[j]);
			LOC18 = 0;
...
N_NIMCALL(void, sort_357782)(tsym186843** a_357790, NI a_357790Len0, TY357801 cmp_357800, NU8 order_357803) {
	...
	nimln(155, "algorithm.nim");
	TMP5090 = divInt(n, 2);
	b = (tsymseq186815*) newSeq((&NTI186815), (NI64)(TMP5090));
	...
	while (1) {
		...
		while (1) {
			...
			nimln(160, "algorithm.nim");
			TMP5099 = addInt(m, s);
			merge_357843(a_357790, a_357790Len0, b->data, b->Sup.len, (((NI64)(TMP5098) >= 0) ? (NI64)(TMP5098) : 0), m, (NI64)(TMP5099), cmp_357800, order_357803);
			nimln(161, "algorithm.nim");
			nimln(161, "algorithm.nim");
			TMP5100 = mulInt(s, 2);
			m = subInt(m, (NI64)(TMP5100));
		} LA2: ;
...
N_NIMCALL(void, merge_361227)(tentry360566* a_361235, NI a_361235Len0, tentry360566* b_361243, NI b_361243Len0, NI lo_361247, NI m_361249, NI hi_361251, TY361185 cmp_361259, NU8 order_361262) {
	...
	nimln(101, "algorithm.nim");
	{
		...
		nimln(101, "algorithm.nim");
		TMP5112 = addInt(m_361249, 1);
		if ((NU)((NI64)(TMP5112)) >= (NU)(a_361235Len0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp_361259.ClEnv? cmp_361259.ClPrc(a_361235[m_361249], a_361235[(NI64)(TMP5112)], cmp_361259.ClEnv):((TMP5113)(cmp_361259.ClPrc))(a_361235[m_361249], a_361235[(NI64)(TMP5112)]);
		LOC4 = 0;
	...
	while (1) {
		...
		nimln(118, "algorithm.nim");
		{
			...
			if ((NU)(j) >= (NU)(a_361235Len0)) raiseIndexError();
			LOC17 = 0;
			LOC17 = cmp_361259.ClEnv? cmp_361259.ClPrc(b_361243[i], a_361235[j], cmp_361259.ClEnv):((TMP5114)(cmp_361259.ClPrc))(b_361243[i], a_361235[j]);
			LOC18 = 0;
...
N_NIMCALL(void, sort_361166)(tentry360566* a_361174, NI a_361174Len0, TY361185 cmp_361184, NU8 order_361187) {
	...
	nimln(155, "algorithm.nim");
	TMP5109 = divInt(n, 2);
	b = (TY360573*) newSeq((&NTI360573), (NI64)(TMP5109));
	nimln(156, "algorithm.nim");
	s = 1;
	nimln(157, "algorithm.nim");
	while (1) {
		...
		while (1) {
			...
			nimln(160, "algorithm.nim");
			TMP5115 = subInt(m, s);
			TMP5116 = addInt((NI64)(TMP5115), 1);
			nimln(160, "algorithm.nim");
			TMP5117 = addInt(m, s);
			merge_361227(a_361174, a_361174Len0, b->data, b->Sup.len, (((NI64)(TMP5116) >= 0) ? (NI64)(TMP5116) : 0), m, (NI64)(TMP5117), cmp_361184, order_361187);
			nimln(161, "algorithm.nim");
			nimln(161, "algorithm.nim");
			TMP5118 = mulInt(s, 2);
			m = subInt(m, (NI64)(TMP5118));
		} LA2: ;
		nimln(162, "algorithm.nim");
		nimln(162, "algorithm.nim");
		TMP5119 = mulInt(s, 2);
