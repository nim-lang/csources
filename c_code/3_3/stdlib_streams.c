...
N_NIMCALL(void, TMP2687)(void* p, NI op);
...
N_NIMCALL(void, TMP2688)(void* p, NI op);
...
STRING_LITERAL(TMP2691, "cannot write to stream", 22);
STRING_LITERAL(TMP2837, "", 0);
...
N_NIMCALL(void, fswritedata_135806)(streamobj135035* s, void* buffer, NI buflen) {
	{
		...
		LOC6 = 0;
		LOC6 = neweio_135005(((NimStringDesc*) &TMP2691));
