...
N_NIMCALL(void, processimplicits_245510)(TY10865* implicits, NU8 nodekind, tpasscontext245003** a);
...
static NIM_CONST TY187025 TMP3169 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3170, "sons", 4);
STRING_LITERAL(TMP3177, "(len|len|len|len|len)(a) (==|==|==|==|==|==|==|==|==|==|==|==|="
...
N_NIMCALL(void, openpasses_245277)(tpasscontext245003** a, tsym186843* module) {
	...
	nimln(112, "passes.nim");
	TMP3171 = subInt(gpasseslen_245179, 1);
	HEX3Atmp_245302 = (NI64)(TMP3171);
...
N_NIMCALL(void, openpassescached_245309)(tpasscontext245003** a, tsym186843* module, trodreader235024* rd) {
	...
	nimln(118, "passes.nim");
	TMP3172 = subInt(gpasseslen_245179, 1);
	HEX3Atmp_245352 = (NI64)(TMP3172);
	nimln(1450, "system.nim");
	res_245354 = 0;
	nimln(1451, "system.nim");
	while (1) {
...
N_NIMCALL(void, closepasses_245359)(tpasscontext245003** a) {
	...
	nimln(128, "passes.nim");
	TMP3173 = subInt(gpasseslen_245179, 1);
	HEX3Atmp_245385 = (NI64)(TMP3173);
	nimln(1450, "system.nim");
	res_245387 = 0;
	nimln(1451, "system.nim");
	while (1) {
...
N_NIMCALL(NIM_BOOL, processtoplevelstmt_245392)(tnode186813* n, tpasscontext245003** a) {
	...
	nimln(135, "passes.nim");
	TMP3174 = subInt(gpasseslen_245179, 1);
	HEX3Atmp_245430 = (NI64)(TMP3174);
	nimln(1450, "system.nim");
	res_245432 = 0;
	nimln(1451, "system.nim");
	while (1) {
...
N_NIMCALL(void, processtoplevelstmtcached_245437)(tnode186813* n, tpasscontext245003** a) {
	...
	nimln(144, "passes.nim");
	TMP3175 = subInt(gpasseslen_245179, 1);
	HEX3Atmp_245463 = (NI64)(TMP3175);
	nimln(1450, "system.nim");
	res_245465 = 0;
	nimln(1451, "system.nim");
	while (1) {
...
N_NIMCALL(void, closepassescached_245470)(tpasscontext245003** a) {
	...
	nimln(149, "passes.nim");
	TMP3176 = subInt(gpasseslen_245179, 1);
	HEX3Atmp_245503 = (NI64)(TMP3176);
	nimln(1450, "system.nim");
	res_245505 = 0;
	nimln(1451, "system.nim");
	while (1) {
...
N_NIMCALL(void, processimplicits_245510)(TY10865* implicits, NU8 nodekind, tpasscontext245003** a) {
	...
	while (1) {
		...
		importstmt = newnodei_187109(nodekind, gcmdlineinfo_163103);
		nimln(158, "passes.nim");
		str = newstrnode_187095(((NU8) 20), module_245529);
		nimln(159, "passes.nim");
		(*str).Info = gcmdlineinfo_163103;
		...
		nimln(2800, "system.nim");
		{
			...
			nimln(2800, "system.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP3177));
		}
		LA9: ;
	} LA1: ;
	popFrame();
...
N_NIMCALL(void, processmodule_245049)(tsym186843* module, tllstream174204* stream, trodreader235024* rd) {
	...
	LA3: ;
	{
		...
		HEX3Atmp_245675 = (NI64)(TMP3178);
		nimln(1450, "system.nim");
		res_245677 = 0;
		nimln(1451, "system.nim");
		while (1) {
			nimln(1451, "system.nim");
			if (!(res_245677 <= HEX3Atmp_245675)) goto LA35;
			nimln(1450, "system.nim");
			i_245655 = res_245677;
			nimln(203, "passes.nim");
			if (((TMP3169[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3170));
			...
			nimln(1453, "system.nim");
			res_245677 = addInt(res_245677, 1);
		} LA35: ;
...
NTI245003.flags = 1;
TMP3104[0].kind = 1;
TMP3104[0].offset = offsetof(tpasscontext245003, Fromcache);
TMP3104[0].typ = (&NTI134);
TMP3104[0].name = "fromCache";
NTI245003.node = &TMP3104[0];
}
