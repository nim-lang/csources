...
STRING_LITERAL(TMP2828, "none", 4);
STRING_LITERAL(TMP2829, "bool", 4);
STRING_LITERAL(TMP2830, "char", 4);
STRING_LITERAL(TMP2831, "nil", 3);
STRING_LITERAL(TMP2832, "expr", 4);
STRING_LITERAL(TMP2833, "stmt", 4);
STRING_LITERAL(TMP2834, "void", 4);
STRING_LITERAL(TMP2835, "array", 5);
STRING_LITERAL(TMP2836, "typeDesc", 8);
STRING_LITERAL(TMP2837, "typeDesc", 8);
STRING_LITERAL(TMP2838, "void", 4);
STRING_LITERAL(TMP2839, "distinct", 8);
STRING_LITERAL(TMP2840, "tuple", 5);
STRING_LITERAL(TMP2841, "set", 3);
STRING_LITERAL(TMP2842, "ptr", 3);
STRING_LITERAL(TMP2843, "ref", 3);
STRING_LITERAL(TMP2844, "var", 3);
STRING_LITERAL(TMP2845, "seq", 3);
STRING_LITERAL(TMP2846, "proc", 4);
STRING_LITERAL(TMP2847, "openArray", 9);
STRING_LITERAL(TMP2848, "range", 5);
STRING_LITERAL(TMP2849, "pointer", 7);
STRING_LITERAL(TMP2850, "string", 6);
STRING_LITERAL(TMP2851, "cstring", 7);
STRING_LITERAL(TMP2852, "int", 3);
STRING_LITERAL(TMP2853, "int8", 4);
STRING_LITERAL(TMP2854, "int16", 5);
STRING_LITERAL(TMP2855, "int32", 5);
STRING_LITERAL(TMP2856, "int64", 5);
STRING_LITERAL(TMP2857, "float", 5);
STRING_LITERAL(TMP2858, "float32", 7);
STRING_LITERAL(TMP2859, "float64", 7);
STRING_LITERAL(TMP2860, "float128", 8);
STRING_LITERAL(TMP2861, "uint", 4);
STRING_LITERAL(TMP2862, "uint8", 5);
STRING_LITERAL(TMP2863, "uint16", 6);
STRING_LITERAL(TMP2864, "uint32", 6);
STRING_LITERAL(TMP2865, "uint64", 6);
STRING_LITERAL(TMP2866, "bignum", 6);
STRING_LITERAL(TMP2867, "const", 5);
STRING_LITERAL(TMP2868, "mutable", 7);
STRING_LITERAL(TMP2869, "varargs", 7);
STRING_LITERAL(TMP2870, "iter", 4);
STRING_LITERAL(TMP2871, "error", 5);
STRING_LITERAL(TMP2872, "builtinTypeClass", 16);
STRING_LITERAL(TMP2873, "concept", 7);
STRING_LITERAL(TMP2874, "compositeTypeClass", 18);
STRING_LITERAL(TMP2875, "and", 3);
STRING_LITERAL(TMP2876, "or", 2);
STRING_LITERAL(TMP2877, "not", 3);
STRING_LITERAL(TMP2878, "anything", 8);
STRING_LITERAL(TMP2879, "static", 6);
STRING_LITERAL(TMP2883, "", 0);
STRING_LITERAL(TMP2894, "\012", 1);
		...
		res_380139 = ((NI) 0);
		{
			while (1) {
				...
				i_380119 = res_380139;
				{
					...
					void_380132 = atomictypex_380072(((NimStringDesc*) &TMP2838), t, info);
...
N_NIMCALL(Tnode191813*, maptypetoast_380086)(Ttype191849* t, Tlineinfo163338 info, NIM_BOOL allowrecursion) {
	...
	case ((NU8) 0):
	{
		result = atomictypex_380072(((NimStringDesc*) &TMP2828), t, info);
	}
	break;
	case ((NU8) 1):
	{
		result = atomictypex_380072(((NimStringDesc*) &TMP2829), t, info);
	}
	break;
	case ((NU8) 2):
	{
		result = atomictypex_380072(((NimStringDesc*) &TMP2830), t, info);
	}
	break;
	case ((NU8) 5):
	{
		result = atomictypex_380072(((NimStringDesc*) &TMP2831), t, info);
	}
	break;
	case ((NU8) 6):
	{
	...
	case ((NU8) 16):
	{
		...
		result = newnodeit_193807(((NU8) 42), info, t);
		LOC9 = 0;
		LOC9 = atomictypex_380072(((NimStringDesc*) &TMP2835), t, info);
	...
	{
		{
			...
			result = newnodeit_193807(((NU8) 42), info, t);
			LOC18 = 0;
			LOC18 = atomictypex_380072(((NimStringDesc*) &TMP2836), t, info);
	...
	{
		{
			...
			result = maptypetobracket_380094(((NimStringDesc*) &TMP2839), t, info);
		}
		goto LA31;
		LA33: ;
		{
	...
	case ((NU8) 18):
	{
		result = maptypetobracket_380094(((NimStringDesc*) &TMP2840), t, info);
	}
	break;
	case ((NU8) 19):
	{
		result = maptypetobracket_380094(((NimStringDesc*) &TMP2841), t, info);
	}
	break;
	case ((NU8) 21):
	{
		result = maptypetobracket_380094(((NimStringDesc*) &TMP2842), t, info);
	}
	break;
	case ((NU8) 22):
	{
	...
	case ((NU8) 20):
	{
		...
		result = newnodeit_193807(((NU8) 42), info, t);
		LOC61 = 0;
		LOC61 = atomictypex_380072(((NimStringDesc*) &TMP2848), t, info);
	...
	case ((NU8) 26):
	{
		result = atomictypex_380072(((NimStringDesc*) &TMP2849), t, info);
	}
	break;
	case ((NU8) 28):
	{
		result = atomictypex_380072(((NimStringDesc*) &TMP2850), t, info);
	}
	break;
	case ((NU8) 29):
	{
		result = atomictypex_380072(((NimStringDesc*) &TMP2851), t, info);
	}
	break;
	case ((NU8) 31):
	{
		result = atomictypex_380072(((NimStringDesc*) &TMP2852), t, info);
	}
	break;
	case ((NU8) 32):
	{
	...
	case ((NU8) 46):
	{
		result = maptypetobracket_380094(((NimStringDesc*) &TMP2867), t, info);
	}
	break;
	case ((NU8) 47):
	{
		result = maptypetobracket_380094(((NimStringDesc*) &TMP2868), t, info);
	}
	break;
	case ((NU8) 48):
	{
		result = maptypetobracket_380094(((NimStringDesc*) &TMP2869), t, info);
	}
	break;
	case ((NU8) 49):
	{
		result = maptypetobracket_380094(((NimStringDesc*) &TMP2870), t, info);
	}
	break;
	case ((NU8) 50):
	{
		result = atomictypex_380072(((NimStringDesc*) &TMP2871), t, info);
	}
	break;
	case ((NU8) 51):
	{
	...
	case ((NU8) 55):
	{
		result = maptypetobracket_380094(((NimStringDesc*) &TMP2875), t, info);
	}
	break;
	case ((NU8) 56):
	{
	...
	case ((NU8) 58):
	{
		result = atomictypex_380072(((NimStringDesc*) &TMP2878), t, info);
	}
	break;
	case ((NU8) 59):
	case ((NU8) 60):
	case ((NU8) 61):
	{
		...
		result = newnodeit_193807(((NU8) 42), info, t);
		LOC96 = 0;
		LOC96 = atomictypex_380072(((NimStringDesc*) &TMP2879), t, info);
...
N_NIMCALL(NimStringDesc*, opslurp_380044)(NimStringDesc* file, Tlineinfo163338 info, Tsym191843* module) {
	...
	TMP2882.status = _setjmp(TMP2882.context);
	if (TMP2882.status == 0) {
		...
		result = readfile_13634(filename);
		LOC2 = 0;
...
N_NIMCALL(NimStringDesc*, opgorge_380027)(NimStringDesc* cmd, NimStringDesc* input) {
	...
	if (TMP2884.status == 0) {
		...
		p = nospstartProcess(cmd, ((NimStringDesc*) &TMP2883), LOC2, 0, NIM_NIL, 4);
		{
