...
#include <setjmp.h>
#include <stdio.h>
typedef struct TY346011 TY346011;
typedef struct Tsourcefile346003 Tsourcefile346003;
...
struct TY346011 {
  TGenericSeq Sup;
  Tsourcefile346003 data[SEQ_DECL_SIZE];
};
struct TY135002 {
  TGenericSeq Sup;
...
N_NIMCALL(void, replacedeprecated_346155_3901077974)(Tlineinfo192336 info0, Tident200010* oldsym0, Tident200010* newsym0);
N_NIMCALL(void, loadfile_346030_3901077974)(Tlineinfo192336 info0);
...
N_NIMCALL(NI, identlen_346112_3901077974)(NimStringDesc* line0, NI start0);
...
TY346011* gsourcefiles_346028_3901077974;
TNimType NTI346003; /* TSourceFile */
extern TNimType NTI135002; /* seq[string] */
extern TNimType NTI130; /* bool */
extern TNimType NTI138; /* string */
extern TNimType NTI110; /* int32 */
TNimType NTI346011; /* seq[TSourceFile] */
...
N_NIMCALL(void, T3901077974_4)(void) {
	nimGCvisit((void*)gsourcefiles_346028_3901077974, 0);
}
...
N_NIMCALL(void, loadfile_346030_3901077974)(Tlineinfo192336 info0) {
	...
	i0 = info0.fileindex;
	{
		if (!((gsourcefiles_346028_3901077974 ? gsourcefiles_346028_3901077974->Sup.len : 0) <= ((NI) (i0)))) goto LA3;
		gsourcefiles_346028_3901077974 = (TY346011*) setLengthSeq(&(gsourcefiles_346028_3901077974)->Sup, sizeof(Tsourcefile346003), ((NI) ((NI32)(i0 + ((NI32) 1)))));
	}
	LA3: ;
	{
		NimStringDesc* path0;
		NimStringDesc* LOC9;
		TY128506 LOC10;
		Baselexer219007 lex0;
		Filestreamobj157877* LOC19;
		Streamobj156818* LOC20;
		NI pos0;
		if (!gsourcefiles_346028_3901077974->data[i0].lines == 0) goto LA7;
		gsourcefiles_346028_3901077974->data[i0].fileidx = info0.fileindex;
		if (gsourcefiles_346028_3901077974->data[i0].lines) nimGCunrefNoCycle(gsourcefiles_346028_3901077974->data[i0].lines);
		gsourcefiles_346028_3901077974->data[i0].lines = (TY135002*) newSeqRC1((&NTI135002), 0);
		path0 = tofullpath_193261_155036129(info0.fileindex);
		LOC9 = (NimStringDesc*)0;
		LOC9 = gsourcefiles_346028_3901077974->data[i0].fullpath; gsourcefiles_346028_3901077974->data[i0].fullpath = copyStringRC1(path0);
		if (LOC9) nimGCunrefNoCycle(LOC9);
		memset((void*)(&LOC10), 0, sizeof(LOC10));
		nossplitFile(path0, (&LOC10));
		gsourcefiles_346028_3901077974->data[i0].isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &T3901077974_5));
		{
			NimStringDesc* line_346077_3901077974;
			FILE* f_346104_3901077974;
			TSafePoint T3901077974_6;
			line_346077_3901077974 = (NimStringDesc*)0;
			f_346104_3901077974 = open_14817_1689653243(path0, ((Filemode13009) 0), ((NI) 8000));
			pushSafePoint(&T3901077974_6);
			T3901077974_6.status = _setjmp(T3901077974_6.context);
			if (T3901077974_6.status == 0) {
				NimStringDesc* res_346106_3901077974;
				res_346106_3901077974 = rawNewString(((NI) 80));
				{
					while (1) {
						NIM_BOOL LOC15;
						NimStringDesc* LOC16;
						LOC15 = (NIM_BOOL)0;
						LOC15 = readline_14915_1689653243(f_346104_3901077974, (&res_346106_3901077974));
						if (!LOC15) goto LA14;
						line_346077_3901077974 = res_346106_3901077974;
						gsourcefiles_346028_3901077974->data[i0].lines = (TY135002*) incrSeqV2(&(gsourcefiles_346028_3901077974->data[i0].lines)->Sup, sizeof(NimStringDesc*));
						LOC16 = (NimStringDesc*)0;
						LOC16 = gsourcefiles_346028_3901077974->data[i0].lines->data[gsourcefiles_346028_3901077974->data[i0].lines->Sup.len]; gsourcefiles_346028_3901077974->data[i0].lines->data[gsourcefiles_346028_3901077974->data[i0].lines->Sup.len] = copyStringRC1(line_346077_3901077974);
						if (LOC16) nimGCunrefNoCycle(LOC16);
						++gsourcefiles_346028_3901077974->data[i0].lines->Sup.len;
					} LA14: ;
				}
				popSafePoint();
			}
		...
		pos0 = lex0.bufpos;
		{
			while (1) {
				...
				case 13:
				{
					...
					LOC24 = gsourcefiles_346028_3901077974->data[i0].newline; gsourcefiles_346028_3901077974->data[i0].newline = copyStringRC1(((NimStringDesc*) &T3901077974_8));
				...
				case 0:
				{
					...
					LOC26 = gsourcefiles_346028_3901077974->data[i0].newline; gsourcefiles_346028_3901077974->data[i0].newline = copyStringRC1(((NimStringDesc*) &T3901077974_9));
...
N_NIMCALL(void, replacedeprecated_346155_3901077974)(Tlineinfo192336 info0, Tident200010* oldsym0, Tident200010* newsym0) {
	...
	NI last0;
	NI LOC17;
{	loadfile_346030_3901077974(info0);
	line0 = gsourcefiles_346028_3901077974->data[info0.fileindex].lines->data[(NI16)(info0.line - ((NI16) 1))];
	...
	LA15: ;
	LOC17 = (NI)0;
	LOC17 = identlen_346112_3901077974(line0, first0);
...
appendString(LOC25, LOC27);
		x0 = LOC25;
		asgnRefNoCycle((void**) (&gsourcefiles_346028_3901077974->data[info0.fileindex].lines->data[(NI16)(info0.line - ((NI16) 1))]), x0);
		gsourcefiles_346028_3901077974->data[info0.fileindex].dirty = NIM_TRUE;
	}
	LA23: ;
	}BeforeRet: ;
}
...
N_NIMCALL(void, replacedeprecated_346208_3901077974)(Tlineinfo192336 info0, Tsym293834* oldsym0, Tsym293834* newsym0) {
	replacedeprecated_346155_3901077974(info0, (*oldsym0).name, (*newsym0).name);
}
NIM_EXTERNC N_NOINLINE(void, compiler_prettybaseInit000)(void) {
nimRegisterGlobalMarker(T3901077974_4);
	if (gsourcefiles_346028_3901077974) nimGCunrefNoCycle(gsourcefiles_346028_3901077974);
	gsourcefiles_346028_3901077974 = (TY346011*) newSeqRC1((&NTI346011), 0);
}
...
NTI346003.node = &T3901077974_0[0];
NTI346011.size = sizeof(TY346011*);
NTI346011.kind = 24;
NTI346011.base = (&NTI346003);
NTI346011.flags = 2;
NTI346011.marker = T3901077974_3;
}
