...
{	result = 0;
	{
		...
		res_199872 = start;
		{
			while (1) {
				...
				LA7: ;
				{
					internalerror_165215((*list).info, ((NimStringDesc*) &TMP2673));
				}
				LA5: ;
				res_199872 += ((NI) 1);
			} LA4: ;
...
{	result = 0;
	...
	{
		{
			...
			internalerror_165215((*n).info, ((NimStringDesc*) &TMP2954));
		}
		LA13: ;
		...
		LA17: ;
		{
			...
			res_199551 = ((NI) 1);
			{
				while (1) {
					...
					default:
					{
						internalerror_165215((*n).info, ((NimStringDesc*) &TMP2955));
					}
					break;
					}
					res_199551 += ((NI) 1);
	...
	default:
	{
		internalerror_165215((*n).info, ((NimStringDesc*) &TMP2956));
	}
	break;
	}
	}BeforeRet: ;
