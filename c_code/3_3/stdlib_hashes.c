...
N_NIMCALL(NI, hashdata_119064)(void* data, NI size);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NOINLINE(void, raiseOverflow)(void);
static N_INLINE(NI, subInt)(NI a, NI b);
static N_INLINE(NI, hash_119401)(void* x);
static N_INLINE(NI, hash_119801)(NI x);
static N_INLINE(NI, hash_119807)(NI64 x);
static N_INLINE(NI, hash_119813)(NIM_CHAR x);
...
static N_INLINE(NI, hash_120021)(NF x);
extern TFrame* frameptr_13238;
TNimType NTI119013; /* THash */
...
N_NIMCALL(NI, hashdata_119064)(void* data, NI size) {
	...
	while (1) {
		...
		nimln(46, "hashes.nim");
		nimln(46, "hashes.nim");
		h = HEX21HEX26_119015(h, ((NI) (((NU8)(p[i])))));
		nimln(47, "hashes.nim");
		i = addInt(i, 1);
		nimln(48, "hashes.nim");
		s = subInt(s, 1);
...
N_NIMCALL(NI, hash_119827)(NimStringDesc* x) {
	...
	HEX3Atmp_119852 = (NI64)(TMP268);
	nimln(1457, "system.nim");
	res_119854 = 0;
	nimln(1458, "system.nim");
	while (1) {
		nimln(1458, "system.nim");
		if (!(res_119854 <= HEX3Atmp_119852)) goto LA1;
		nimln(1457, "system.nim");
		i_119842 = res_119854;
		nimln(94, "hashes.nim");
		nimln(94, "hashes.nim");
		if ((NU)(i_119842) > (NU)(x->Sup.len)) raiseIndexError();
		h = HEX21HEX26_119015(h, ((NI) (((NU8)(x->data[i_119842])))));
		nimln(1460, "system.nim");
		res_119854 = addInt(res_119854, 1);
	} LA1: ;
	nimln(95, "hashes.nim");
	result = HEX21HEX24_119040(h);
	popFrame();
...
N_NIMCALL(NI, hashignorecase_119935)(NimStringDesc* x) {
	...
	while (1) {
		NIM_CHAR c;
		nimln(1458, "system.nim");
		if (!(res_120004 <= HEX3Atmp_120002)) goto LA1;
		nimln(1457, "system.nim");
		i_119950 = res_120004;
		nimln(113, "hashes.nim");
		if ((NU)(i_119950) > (NU)(x->Sup.len)) raiseIndexError();
		c = x->data[i_119950];
		...
		h = HEX21HEX26_119015(h, ((NI) (((NU8)(c)))));
		nimln(1460, "system.nim");
		res_120004 = addInt(res_120004, 1);
	} LA1: ;
