...
N_NIMCALL(tfilestream125156*, newfilestream_125212)(FILE* f);
...
N_NIMCALL(void, execcmdex_130003)(NimStringDesc* command, NU8 options, TY130009* Result);
static NIM_CONST TY122387 TMP326 = {
...
STRING_LITERAL(TMP330, "len(a) == L string modified while iterating over it", 51);
...
static NIM_CONST TY122387 TMP333 = {
0x00, 0x00, 0x00, 0x00, 0x20, 0xE8, 0xFF, 0x27,
0xFF, 0xFF, 0xFF, 0x87, 0xFE, 0xFF, 0xFF, 0x07,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
...
STRING_LITERAL(TMP345, "\'\"\'\"\'", 5);
STRING_LITERAL(TMP346, "n > 0 ", 6);
STRING_LITERAL(TMP358, "", 0);
STRING_LITERAL(TMP359, "\012", 1);
STRING_LITERAL(TMP362, "=", 1);
STRING_LITERAL(TMP376, "/bin/sh", 7);
STRING_LITERAL(TMP377, "-c", 2);
STRING_LITERAL(TMP378, "args.len == 0 `args` has to be empty when using poEvalCommand.", 62);
STRING_LITERAL(TMP381, " ", 1);
STRING_LITERAL(TMP384, "(len|len|len|len|len)(a) (==|==|==|==|==|==|==|==|==|==|==|==|="
"=|==|==|==|==|==|==|==)\015\012    L seq modified while iterating over"
" it", 130);
NIM_CONST TY130009 TMP389 = {((NimStringDesc*) &TMP358),
-1}
;
...
extern TY10865* environment_112006;
...
N_NIMCALL(NimStringDesc*, nospquoteShellWindows)(NimStringDesc* s) {
	...
	nimln(60, "osproc.nim");
	backslashbuff = copyString(((NimStringDesc*) &TMP327));
	nimln(61, "osproc.nim");
	{
...
appendString(result, backslashbuff);
		...
		nimln(2809, "system.nim");
		{
			...
			nimln(2809, "system.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP330));
		}
		LA22: ;
	} LA7: ;
	nimln(78, "osproc.nim");
...
N_NIMCALL(NimStringDesc*, nospquoteShellPosix)(NimStringDesc* s) {
	...
	LA3: ;
	nimln(89, "osproc.nim");
	safe = allcharsinset_90836(s, TMP333);
	nimln(91, "osproc.nim");
	{
		if (!safe) goto LA7;
		nimln(92, "osproc.nim");
	...
	LA7: ;
	{
		...
		nimln(94, "osproc.nim");
		LOC11 = 0;
		LOC11 = nsuReplaceStr(s, ((NimStringDesc*) &TMP334), ((NimStringDesc*) &TMP345));
		LOC10 = rawNewString(LOC11->Sup.len + 2);
appendString(LOC10, ((NimStringDesc*) &TMP334));
...
N_NIMCALL(tprocess126402*, startcmd_126634)(NimStringDesc* command, NU8 options) {
	...
	nimln(155, "osproc.nim");
	result = nospstartProcess(command, ((NimStringDesc*) &TMP327), LOC1, 0, NIM_NIL, (options | 4));
	popFrame();
	return result;
}
...
N_NIMCALL(NI, nospexecProcesses)(NimStringDesc** cmds, NI cmdsLen0, NU8 options_127023, NI n) {
	...
	nimln(276, "osproc.nim");
	{
		...
		if (!!((0 < n))) goto LA3;
		nimln(276, "osproc.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP346));
	}
	LA3: ;
...
N_NIMCALL(NimStringDesc*, nospexecProcess)(NimStringDesc* command, NimStringDesc** args, NI argsLen0, tstringtable121810* env, NU8 options) {
	...
	p = nospstartProcess(command, ((NimStringDesc*) &TMP327), args, argsLen0, env, options);
	nimln(335, "osproc.nim");
	outp = nospoutputStream(p);
	nimln(336, "osproc.nim");
	result = copyString(((NimStringDesc*) &TMP358));
...
appendString(result, line);
			...
			result = resizeString(result, 1);
appendString(result, ((NimStringDesc*) &TMP359));
		}
		goto LA2;
		LA5: ;
		{
...
N_NIMCALL(NCSTRING*, envtocstringarray_127804)(tstringtable121810* t) {
	...
	LOC1 = 0;
	LOC1 = nstlen(t);
	TMP360 = addInt(LOC1, 1);
	TMP361 = mulInt((NI64)(TMP360), 8);
	LOC2 = 0;
	LOC2 = alloc0_4616((NI64)(TMP361));
...
appendString(LOC8, ((NimStringDesc*) &TMP362));
appendString(LOC8, val_127811);
			...
			nimln(592, "osproc.nim");
			nimln(592, "osproc.nim");
			TMP363 = addInt(x->Sup.len, 1);
			LOC9 = 0;
			LOC9 = alloc_4601((NI64)(TMP363));
			...
			memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI64)(TMP364));
...
N_NIMCALL(NCSTRING*, envtocstringarray_127841)(void) {
	...
	nimln(1181, "os.nim");
	nimln(1181, "os.nim");
	HEX3Atmp_127888 = (environment_112006->Sup.len-1);
	nimln(1457, "system.nim");
	res_127890 = 0;
	nimln(1458, "system.nim");
	while (1) {
		...
		i_127886 = res_127890;
		nimln(1182, "os.nim");
		if ((NU)(i_127886) >= (NU)(environment_112006->Sup.len)) raiseIndexError();
		p_127892 = nsuFindChar(environment_112006->data[i_127886], 61, 0);
		nimln(1183, "os.nim");
		nimln(1183, "os.nim");
		if ((NU)(i_127886) >= (NU)(environment_112006->Sup.len)) raiseIndexError();
		nimln(1183, "os.nim");
		TMP365 = subInt(p_127892, 1);
		key_127845 = copyStrLast(environment_112006->data[i_127886], 0, (NI64)(TMP365));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_127886) >= (NU)(environment_112006->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP366 = addInt(p_127892, 1);
		val_127846 = copyStr(environment_112006->data[i_127886], (NI64)(TMP366));
	...
	nimln(599, "osproc.nim");
	nimln(599, "osproc.nim");
	TMP367 = addInt(counter, 1);
	TMP368 = mulInt((NI64)(TMP367), 8);
	LOC2 = 0;
	LOC2 = alloc0_4616((NI64)(TMP368));
	result = ((NCSTRING*) (LOC2));
	...
	nimln(1181, "os.nim");
	nimln(1181, "os.nim");
	HEX3Atmp_127904 = (environment_112006->Sup.len-1);
	nimln(1457, "system.nim");
	res_127906 = 0;
	nimln(1458, "system.nim");
	while (1) {
		...
		i_127902 = res_127906;
		nimln(1182, "os.nim");
		if ((NU)(i_127902) >= (NU)(environment_112006->Sup.len)) raiseIndexError();
		p_127908 = nsuFindChar(environment_112006->data[i_127902], 61, 0);
		nimln(1183, "os.nim");
		nimln(1183, "os.nim");
		if ((NU)(i_127902) >= (NU)(environment_112006->Sup.len)) raiseIndexError();
		nimln(1183, "os.nim");
		TMP369 = subInt(p_127908, 1);
		key_127865 = copyStrLast(environment_112006->data[i_127902], 0, (NI64)(TMP369));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_127902) >= (NU)(environment_112006->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP370 = addInt(p_127908, 1);
		val_127866 = copyStr(environment_112006->data[i_127902], (NI64)(TMP370));
		nimln(602, "osproc.nim");
		nimln(602, "osproc.nim");
		LOC4 = 0;
		LOC4 = rawNewString(key_127865->Sup.len + val_127866->Sup.len + 1);
appendString(LOC4, key_127865);
appendString(LOC4, ((NimStringDesc*) &TMP362));
appendString(LOC4, val_127866);
		...
		nimln(603, "osproc.nim");
		nimln(603, "osproc.nim");
		TMP371 = addInt(x->Sup.len, 1);
		LOC5 = 0;
		LOC5 = alloc_4601((NI64)(TMP371));
		...
		memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI64)(TMP372));
...
N_NIMCALL(pid_t, startprocessauxfork_128004)(tstartprocessdata127915* data) {
	...
	pushSafePoint(&TMP375);
	TMP375.status = setjmp(TMP375.context);
	if (TMP375.status == 0) {
		pid_t volatile pid;
	...
	if (TMP375.status != 0) reraiseException();
	BeforeRet: ;
	popFrame();
	return result;
}
...
N_NIMCALL(tprocess126402*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, tstringtable121810* env, NU8 options) {
	...
	nimln(643, "osproc.nim");
	{
		...
		nimln(646, "osproc.nim");
		{
			...
			nimln(646, "osproc.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP378));
		}
		LA27: ;
	}
	goto LA17;
	...
	if (TMP379.status == 0) {
		...
		if (TMP380.status == 0) {
			...
			nimln(685, "osproc.nim");
			{
				...
				nimln(686, "osproc.nim");
				LOC45 = 0;
				LOC45 = nsuJoinSep(args, argsLen0, ((NimStringDesc*) &TMP381));
				printf("%s%s%s\012", (command)->data, (((NimStringDesc*) &TMP381))->data, (LOC45)->data);
			}
			LA43: ;
...
N_NIMCALL(void, createfdset_129602)(fd_set* fd, TY127403* s, NI* m) {
	...
	while (1) {
		...
		nimln(2800, "system.nim");
		{
			...
			nimln(2800, "system.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP384));
		}
		LA4: ;
	} LA1: ;
	popFrame();
...
N_NIMCALL(void, pruneprocessset_129834)(TY127403** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(924, "osproc.nim");
		{
			...
			nimln(925, "osproc.nim");
			TMP385 = subInt(l, 1);
			if ((NU)((NI64)(TMP385)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRef((void**) &(*s)->data[i], (*s)->data[(NI64)(TMP385)]);
...
N_NIMCALL(NI, select_127721)(TY127403** readfds, NI timeout) {
	...
	nimln(934, "osproc.nim");
	TMP386 = mulInt(timeout, 1000);
	tv.tv_usec = (NI64)(TMP386);
	...
	nimln(940, "osproc.nim");
	{
		...
		TMP387 = addInt(m, 1);
		LOC5 = 0;
		LOC5 = select(((int)chckRange((NI64)(TMP387), ((int) (-2147483647 -1)), ((int) 2147483647))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		TMP388 = addInt(m, 1);
		LOC7 = 0;
		LOC7 = select(((int)chckRange((NI64)(TMP388), ((int) (-2147483647 -1)), ((int) 2147483647))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
...
N_NIMCALL(void, execcmdex_130003)(NimStringDesc* command, NU8 options, TY130009* Result) {
	...
	unsureAsgnRef((void**) &(*Result).Field0, copyString(TMP389.Field0));
	(*Result).Field1 = TMP389.Field1;
...
appendString((*Result).Field0, ((NimStringDesc*) &TMP359));
		}
		goto LA2;
		LA5: ;
		{
...
static TNimNode* TMP347[8];
static TNimNode TMP311[9];
NTI126402.size = sizeof(tprocess126402);
NTI126402.kind = 17;
NTI126402.base = (&NTI2409);
TMP347[0] = &TMP311[1];
TMP311[1].kind = 1;
TMP311[1].offset = offsetof(tprocess126402, Inhandle);
TMP311[1].typ = (&NTI10208);
TMP311[1].name = "inHandle";
TMP347[1] = &TMP311[2];
TMP311[2].kind = 1;
TMP311[2].offset = offsetof(tprocess126402, Outhandle);
TMP311[2].typ = (&NTI10208);
TMP311[2].name = "outHandle";
TMP347[2] = &TMP311[3];
TMP311[3].kind = 1;
TMP311[3].offset = offsetof(tprocess126402, Errhandle);
TMP311[3].typ = (&NTI10208);
TMP311[3].name = "errHandle";
TMP347[3] = &TMP311[4];
TMP311[4].kind = 1;
TMP311[4].offset = offsetof(tprocess126402, Instream);
TMP311[4].typ = (&NTI124627);
TMP311[4].name = "inStream";
TMP347[4] = &TMP311[5];
TMP311[5].kind = 1;
TMP311[5].offset = offsetof(tprocess126402, Outstream);
TMP311[5].typ = (&NTI124627);
TMP311[5].name = "outStream";
TMP347[5] = &TMP311[6];
TMP311[6].kind = 1;
TMP311[6].offset = offsetof(tprocess126402, Errstream);
TMP311[6].typ = (&NTI124627);
TMP311[6].name = "errStream";
TMP347[6] = &TMP311[7];
TMP311[7].kind = 1;
TMP311[7].offset = offsetof(tprocess126402, Id);
TMP311[7].typ = (&NTI98457);
TMP311[7].name = "id";
TMP347[7] = &TMP311[8];
TMP311[8].kind = 1;
TMP311[8].offset = offsetof(tprocess126402, Exitcode);
TMP311[8].typ = (&NTI4409);
TMP311[8].name = "exitCode";
TMP311[0].len = 8; TMP311[0].kind = 2; TMP311[0].sons = &TMP347[0];
NTI126402.node = &TMP311[0];
NTI126404.size = sizeof(tprocess126402*);
NTI126404.kind = 22;
NTI126404.base = (&NTI126402);
NTI126404.marker = TMP349;
NTI127403.size = sizeof(TY127403*);
NTI127403.kind = 24;
NTI127403.base = (&NTI126404);
NTI127403.marker = TMP350;
}
