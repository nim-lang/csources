...
N_NIMCALL(void, processimplicits_241621)(TY122208* implicits, NU8 nodekind, Tpasscontext241005** a);
...
STRING_LITERAL(TMP1503, "stdinfile", 9);
...
{	memset((void*)(&p), 0, sizeof(p));
	...
	fileidx = ((NI32) ((*module).position));
	{
		...
		openpasses_241293(a, module);
		{
			...
			{
				NimStringDesc* LOC13;
				if (!eqStrings((*(*module).name).s, ((NimStringDesc*) &TMP1502))) goto LA11;
				LOC13 = 0;
				LOC13 = (*(*module).name).s; (*(*module).name).s = copyStringRC1(((NimStringDesc*) &TMP1503));
