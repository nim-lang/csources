...
Stringtableobj140209* gcookies_354700;
...
N_NIMCALL(NimStringDesc*, encodeurl_354001)(NimStringDesc* s) {
	...
	result = rawNewString(((NI) ((NI)((s ? s->Sup.len : 0) + (NI)((NU64)((s ? s->Sup.len : 0)) >> (NU64)(((NI) 2)))))));
	{
		...
		i_354014 = 0;
		HEX3Atmp_354024 = 0;
		HEX3Atmp_354024 = (NI)((s ? s->Sup.len : 0) - ((NI) 1));
		res_354027 = ((NI) 0);
		{
			while (1) {
				if (!(res_354027 <= HEX3Atmp_354024)) goto LA3;
				i_354014 = res_354027;
				switch (((NU8)(s->data[i_354014]))) {
				case 97 ... 122:
				case 65 ... 90:
				case 48 ... 57:
				case 95:
				{
					result = addChar(result, s->data[i_354014]);
				}
				break;
				case 32:
				{
				...
				default:
				{
					...
					LOC7 = 0;
					LOC7 = nsuToHex(((NI64) (((NU8)(s->data[i_354014])))), ((NI) 2));
