...
N_NIMCALL(void, gettzname_101350)(keyvaluepair131008* Result);
...
N_NIMCALL(void, tmtotimeinfo_101848)(struct tm* tm, NIM_BOOL local, timeinfo101205* Result) {
	...
	LA4: ;
	{
		LOC1.Tzname = copyString(((NimStringDesc*) &TMP3065));
	}
	LA2: ;
	{
		if (!local) goto LA16;
...
static TNimNode* TMP3058[11];
static TNimNode* TMP3059[12];
NI TMP3061;
static char* NIM_CONST TMP3060[12] = {
"mJan", 
"mFeb", 
"mMar", 
"mApr", 
...
"mNov", 
"mDec"};
static TNimNode* TMP3062[7];
NI TMP3064;
static char* NIM_CONST TMP3063[7] = {
"dMon", 
"dTue", 
"dWed", 
"dThu", 
...
NTI101006.base = 0;
NTI101006.flags = 3;
for (TMP3061 = 0; TMP3061 < 12; TMP3061++) {
TMP15[TMP3061+6].kind = 1;
TMP15[TMP3061+6].offset = TMP3061;
TMP15[TMP3061+6].name = TMP3060[TMP3061];
TMP3059[TMP3061] = &TMP15[TMP3061+6];
}
TMP15[18].len = 12; TMP15[18].kind = 2; TMP15[18].sons = &TMP3059[0];
...
NTI101008.base = 0;
NTI101008.flags = 3;
for (TMP3064 = 0; TMP3064 < 7; TMP3064++) {
TMP15[TMP3064+21].kind = 1;
TMP15[TMP3064+21].offset = TMP3064;
TMP15[TMP3064+21].name = TMP3063[TMP3064];
TMP3062[TMP3064] = &TMP15[TMP3064+21];
}
TMP15[28].len = 7; TMP15[28].kind = 2; TMP15[28].sons = &TMP3062[0];
...
TMP15[0].len = 11; TMP15[0].kind = 2; TMP15[0].sons = &TMP3058[0];
