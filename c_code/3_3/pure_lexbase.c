...
N_NIMCALL(void, fillbuffer_290071)(tbaselexer290016* l) {
	...
	nimln(80, "lexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP4630)])), (NI64)(TMP4631));	}	LA11: ;
	...
	TMP4633 = mulInt((NI64)(TMP4632), 1);
	LOC13 = 0;
	LOC13 = readdata_142731((*l).Input, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP4633));
	TMP4634 = divInt(LOC13, 1);
	charsread = (NI64)(TMP4634);
	...
	nimln(86, "lexbase.nim");
	{
		...
		if (!(charsread < (NI64)(TMP4636))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI64)(TMP4638);
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				TMP4639 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4007(((void*) ((*l).Buf)), (NI64)(TMP4639));
				...
				nimln(105, "lexbase.nim");
				{
					...
					if (!!(((NI64)(TMP4640) == oldbuflen))) goto LA35;
					nimln(105, "lexbase.nim");
				...
				LOC37 = 0;
				LOC37 = readdata_142731((*l).Input, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP4642));
				TMP4643 = divInt(LOC37, 1);
				charsread = (NI64)(TMP4643);
...
N_NIMCALL(void, open_290026)(tbaselexer290016* l, tstream142629* input, NI buflen) {
	...
	LOC9 = 0;
	LOC9 = alloc_4001((NI64)(TMP4653));
	(*l).Buf = ((NCSTRING) (LOC9));
	nimln(148, "lexbase.nim");
	nimln(148, "lexbase.nim");
	TMP4654 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP4654);
...
N_NIMCALL(NI, getcolnumber_290044)(tbaselexer290016* l, NI pos) {
	...
	if ((NI64)(TMP4655) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP4655));
	popFrame();
	return result;
}
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src) {
