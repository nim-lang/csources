...
STRING_LITERAL(TMP1960, "nimrod.gid", 10);
STRING_LITERAL(TMP1961, "\012", 1);
...
static N_INLINE(void, setid_185444)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP1955 = addInt(id, 1);
	gfrontendid_185007 = ((gfrontendid_185007 >= (NI64)(TMP1955)) ? gfrontendid_185007 : (NI64)(TMP1955));
	popFrame();
}
...
N_NIMCALL(void, idsynchronizationpoint_185452)(NI idrange) {
	...
	TMP1957 = addInt((NI64)(TMP1956), 1);
	TMP1958 = mulInt((NI64)(TMP1957), idrange);
	TMP1959 = addInt((NI64)(TMP1958), 1);
	gfrontendid_185007 = (NI64)(TMP1959);
	popFrame();
}
...
N_NIMCALL(NimStringDesc*, togid_185457)(NimStringDesc* f) {
	...
	result = 0;
	nimln(47, "idgen.nim");
	result = completegeneratedfilepath_137001(((NimStringDesc*) &TMP1960), NIM_TRUE);
	popFrame();
	return result;
}
...
static N_INLINE(void, writeln_137205)(FILE* f_137209, NimStringDesc** x_137213, NI x_137213Len0) {
	...
	nimln(172, "sysio.nim");
	write_10663(f_137209, ((NimStringDesc*) &TMP1961));
	popFrame();
}
