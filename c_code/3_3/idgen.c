...
STRING_LITERAL(TMP1351, "nimrod.gid", 10);
STRING_LITERAL(TMP4101, "\012", 1);
...
N_NIMCALL(NimStringDesc*, togid_223467)(NimStringDesc* f) {
	...
	result = 0;
	result = completegeneratedfilepath_170001(((NimStringDesc*) &TMP1351), NIM_TRUE);
	return result;
}
...
N_NIMCALL(void, idsynchronizationpoint_223458)(NI idrange) {
	gfrontendid_223012 = (NI64)((NI64)((NI64)((NI64)(gfrontendid_223012 / idrange) + 1) * idrange) + 1);
}
...
static N_INLINE(void, writeln_170205)(FILE* f_170209, NimStringDesc** x_170213, NI x_170213Len0) {
	...
	write_12865(f_170209, ((NimStringDesc*) &TMP4101));
}
