...
#include <string.h>
#include <stdio.h>
typedef struct TY291111 TY291111;
...
N_NIMCALL(void, readconfigfile_291381_930198375)(NimStringDesc* filename0);
...
N_NIMCALL(void, ppgettok_291002_930198375)(Tlexer286174* L0, Ttoken286170* tok0);
...
N_NIMCALL(NIM_BOOL, evalppif_291095_930198375)(Tlexer286174* L0, Ttoken286170* tok0);
N_NIMCALL(NIM_BOOL, parseexpr_291020_930198375)(Tlexer286174* L0, Ttoken286170* tok0);
N_NIMCALL(NIM_BOOL, parseandexpr_291060_930198375)(Tlexer286174* L0, Ttoken286170* tok0);
N_NIMCALL(NIM_BOOL, parseatom_291026_930198375)(Tlexer286174* L0, Ttoken286170* tok0);
...
N_NIMCALL(void, jumptodirective_291150_930198375)(Tlexer286174* L0, Ttoken286170* tok0, Tjumpdest291147 dest0);
N_NIMCALL(void, doelse_291157_930198375)(Tlexer286174* L0, Ttoken286170* tok0);
N_NIMCALL(void, doelif_291172_930198375)(Tlexer286174* L0, Ttoken286170* tok0);
...
N_NIMCALL(void, parseassignment_291318_930198375)(Tlexer286174* L0, Ttoken286170* tok0);
...
N_NIMCALL(void, checksymbol_291293_930198375)(Tlexer286174* L0, Ttoken286170* tok0);
...
TY291111* condstack_291128_930198375;
extern TNimType NTI130; /* bool */
TNimType NTI291111; /* seq[bool] */
...
N_NIMCALL(void, T930198375_3)(void) {
	nimGCvisit((void*)condstack_291128_930198375, 0);
}
...
N_NIMCALL(void, ppgettok_291002_930198375)(Tlexer286174* L0, Ttoken286170* tok0) {
	...
	{
		while (1) {
			if (!((*tok0).toktype == ((Ttoktype286016) 113))) goto LA2;
			rawgettok_289824_689113469(L0, tok0);
		} LA2: ;
	}
}
...
N_NIMCALL(NIM_BOOL, parseatom_291026_930198375)(Tlexer286174* L0, Ttoken286170* tok0) {
	...
	result0 = (NIM_BOOL)0;
	{
		if (!((*tok0).toktype == ((Ttoktype286016) 93))) goto LA3;
		ppgettok_291002_930198375(L0, tok0);
		result0 = parseexpr_291020_930198375(L0, tok0);
		{
			if (!((*tok0).toktype == ((Ttoktype286016) 94))) goto LA7;
			ppgettok_291002_930198375(L0, tok0);
		}
		goto LA5;
		LA7: ;
		{
			lexmessage_286378_689113469((&(*L0)), ((Tmsgkind192002) 24), ((NimStringDesc*) &T930198375_5));
		}
		LA5: ;
	}
	goto LA1;
	LA3: ;
	{
		...
		ppgettok_291002_930198375(L0, tok0);
		LOC13 = (NIM_BOOL)0;
		LOC13 = parseatom_291026_930198375(L0, tok0);
		result0 = !(LOC13);
	}
	goto LA1;
	LA11: ;
	{
		result0 = isdefined_201141_1967573533((*tok0).ident);
		ppgettok_291002_930198375(L0, tok0);
	}
	LA1: ;
	return result0;
...
N_NIMCALL(NIM_BOOL, parseandexpr_291060_930198375)(Tlexer286174* L0, Ttoken286170* tok0) {
	NIM_BOOL result0;
	result0 = (NIM_BOOL)0;
	result0 = parseatom_291026_930198375(L0, tok0);
	{
		while (1) {
			NIM_BOOL b0;
			NIM_BOOL LOC3;
			...
			ppgettok_291002_930198375(L0, tok0);
			b0 = parseatom_291026_930198375(L0, tok0);
			LOC3 = (NIM_BOOL)0;
			LOC3 = result0;
			if (!(LOC3)) goto LA4;
			LOC3 = b0;
...
N_NIMCALL(NIM_BOOL, parseexpr_291020_930198375)(Tlexer286174* L0, Ttoken286170* tok0) {
	NIM_BOOL result0;
	result0 = (NIM_BOOL)0;
	result0 = parseandexpr_291060_930198375(L0, tok0);
	{
		while (1) {
			NIM_BOOL b0;
			NIM_BOOL LOC3;
			...
			ppgettok_291002_930198375(L0, tok0);
			b0 = parseandexpr_291060_930198375(L0, tok0);
			LOC3 = (NIM_BOOL)0;
			LOC3 = result0;
			if (LOC3) goto LA4;
			LOC3 = b0;
...
N_NIMCALL(NIM_BOOL, evalppif_291095_930198375)(Tlexer286174* L0, Ttoken286170* tok0) {
	...
	result0 = parseexpr_291020_930198375(L0, tok0);
	{
		if (!((*tok0).toktype == ((Ttoktype286016) 107))) goto LA3;
		ppgettok_291002_930198375(L0, tok0);
	}
	goto LA1;
	LA3: ;
	{
		lexmessage_286378_689113469((&(*L0)), ((Tmsgkind192002) 24), ((NimStringDesc*) &T930198375_6));
	}
	LA1: ;
	return result0;
}
...
N_NIMCALL(void, doelse_291157_930198375)(Tlexer286174* L0, Ttoken286170* tok0) {
	...
	ppgettok_291002_930198375(L0, tok0);
	{
		if (!((*tok0).toktype == ((Ttoktype286016) 107))) goto LA7;
		ppgettok_291002_930198375(L0, tok0);
	}
	LA7: ;
	{
		if (!condstack_291128_930198375->data[(condstack_291128_930198375 ? (condstack_291128_930198375->Sup.len-1) : -1)]) goto LA11;
		jumptodirective_291150_930198375(L0, tok0, ((Tjumpdest291147) 0));
	}
	LA11: ;
}
...
N_NIMCALL(void, doelif_291172_930198375)(Tlexer286174* L0, Ttoken286170* tok0) {
	...
	res0 = evalppif_291095_930198375(L0, tok0);
	{
		NIM_BOOL LOC7;
		LOC7 = (NIM_BOOL)0;
		LOC7 = condstack_291128_930198375->data[(condstack_291128_930198375 ? (condstack_291128_930198375->Sup.len-1) : -1)];
		if (LOC7) goto LA8;
		LOC7 = !(res0);
		LA8: ;
		if (!LOC7) goto LA9;
	...
	LA9: ;
	{
		condstack_291128_930198375->data[(condstack_291128_930198375 ? (condstack_291128_930198375->Sup.len-1) : -1)] = NIM_TRUE;
	}
	LA5: ;
}
		...
		while (1) {
			{
				...
				LOC9 = whichkeyword_276365_1391470768((*tok0).ident);
				switch (LOC9) {
			...
			LA7: ;
			{
				if (!((*tok0).toktype == ((Ttoktype286016) 1))) goto LA36;
				lexmessage_286378_689113469((&(*L0)), ((Tmsgkind192002) 24), ((NimStringDesc*) &T930198375_8));
			}
			goto LA3;
			LA36: ;
			{
...
N_NIMCALL(void, parsedirective_291245_930198375)(Tlexer286174* L0, Ttoken286170* tok0) {
	...
	default:
	{
		...
		LA15: ;
		{
			...
			putenv_135637_2125978480(key0, LOC21);
			ppgettok_291002_930198375(L0, tok0);
		}
		goto LA19;
		LA16: ;
...
appendString(LOC23, LOC25);
		...
		LA17: ;
		{
			...
			LOC28 = getenv_135624_2125978480(key0);
...
appendString(LOC27, LOC29);
			putenv_135637_2125978480(key0, LOC27);
			ppgettok_291002_930198375(L0, tok0);
		}
		goto LA19;
		LA18: ;
...
N_NIMCALL(void, checksymbol_291293_930198375)(Tlexer286174* L0, Ttoken286170* tok0) {
	{
		NimStringDesc* LOC5;
		if (!!(((*tok0).toktype >= ((Ttoktype286016) 2) && (*tok0).toktype <= ((Ttoktype286016) 72) || (*tok0).toktype >= ((Ttoktype286016) 87) && (*tok0).toktype <= ((Ttoktype286016) 89)))) goto LA3;
		LOC5 = (NimStringDesc*)0;
		LOC5 = toktostr_286293_689113469(tok0);
		lexmessage_286378_689113469(L0, ((Tmsgkind192002) 20), LOC5);
	}
	LA3: ;
}
...
N_NIMCALL(void, parseassignment_291318_930198375)(Tlexer286174* L0, Ttoken286170* tok0) {
	...
	Tident200010* LOC22;
	{
		...
		LOC3 = (NIM_BOOL)0;
		LOC4 = (Tident200010*)0;
		LOC4 = getident_200441_791273810(((NimStringDesc*) &T930198375_12));
		LOC3 = ((*(*tok0).ident).Sup.id == (*LOC4).Sup.id);
		if (LOC3) goto LA5;
		LOC6 = (Tident200010*)0;
		LOC6 = getident_200441_791273810(((NimStringDesc*) &T930198375_13));
		LOC3 = ((*(*tok0).ident).Sup.id == (*LOC6).Sup.id);
		LA5: ;
		if (!LOC3) goto LA7;
		conftok_291274_930198375(L0, tok0);
	}
	LA7: ;
	info0 = getlineinfo_286206_689113469((&(*L0)), (&(*tok0)));
	checksymbol_291293_930198375((&(*L0)), (&(*tok0)));
	s0 = toktostr_286293_689113469((&(*tok0)));
	conftok_291274_930198375(L0, tok0);
	val0 = copyString(((NimStringDesc*) &T930198375_14));
	{
		while (1) {
			NimStringDesc* LOC11;
			if (!((*tok0).toktype == ((Ttoktype286016) 110))) goto LA10;
			s0 = addChar(s0, 46);
			conftok_291274_930198375(L0, tok0);
			checksymbol_291293_930198375((&(*L0)), (&(*tok0)));
			LOC11 = (NimStringDesc*)0;
...
appendString(s0, LOC11);
	...
	{
		NimStringDesc* LOC16;
		if (!((*tok0).toktype == ((Ttoktype286016) 95))) goto LA14;
		conftok_291274_930198375(L0, tok0);
		checksymbol_291293_930198375((&(*L0)), (&(*tok0)));
		LOC16 = (NimStringDesc*)0;
		LOC16 = toktostr_286293_689113469((&(*tok0)));
		val0 = resizeString(val0, LOC16->Sup.len + 0);
appendString(val0, LOC16);
		conftok_291274_930198375(L0, tok0);
		{
			if (!((*tok0).toktype == ((Ttoktype286016) 96))) goto LA19;
			conftok_291274_930198375(L0, tok0);
		}
		goto LA17;
		LA19: ;
		{
			lexmessage_286378_689113469((&(*L0)), ((Tmsgkind192002) 24), ((NimStringDesc*) &T930198375_15));
		}
		LA17: ;
		val0 = addChar(val0, 93);
	}
	LA14: ;
	LOC22 = (Tident200010*)0;
	LOC22 = getident_200441_791273810(((NimStringDesc*) &T930198375_16));
	percent0 = ((*(*tok0).ident).Sup.id == (*LOC22).Sup.id);
	{
		NIM_BOOL LOC25;
		NimStringDesc* LOC33;
		LOC25 = (NIM_BOOL)0;
		LOC25 = ((*tok0).toktype == ((Ttoktype286016) 107) || (*tok0).toktype == ((Ttoktype286016) 109));
		if (LOC25) goto LA26;
		LOC25 = percent0;
		LA26: ;
		if (!LOC25) goto LA27;
		...
		LOC33 = toktostr_286293_689113469((&(*tok0)));
...
appendString(val0, LOC33);
		conftok_291274_930198375(L0, tok0);
		{
			while (1) {
				...
				LOC38 = getident_200441_791273810(((NimStringDesc*) &T930198375_17));
				...
				LOC39 = toktostr_286293_689113469((&(*tok0)));
...
appendString(val0, LOC39);
	...
	LA27: ;
	{
		...
		LOC44 = nstFormat(val0, gconfigvars_170204_2607990831, 3);
		processswitch_281016_2004575671(s0, LOC44, ((Tcmdlinepass281008) 2), info0);
	}
	goto LA40;
	LA42: ;
	{
		processswitch_281016_2004575671(s0, val0, ((Tcmdlinepass281008) 2), info0);
	}
	LA40: ;
}
...
N_NIMCALL(void, readconfigfile_291381_930198375)(NimStringDesc* filename0) {
	...
	stream0 = (Tllstream283204*)0;
	stream0 = llstreamopen_283242_597494479(filename0, ((Filemode13009) 0));
	{
		if (!!((stream0 == NIM_NIL))) goto LA3;
		inittoken_286318_689113469((&tok0));
		openlexer_286341_689113469((&L0), filename0, stream0);
		tok0.toktype = ((Ttoktype286016) 1);
		conftok_291274_930198375((&L0), (&tok0));
		{
			while (1) {
				if (!!((tok0.toktype == ((Ttoktype286016) 1)))) goto LA6;
				parseassignment_291318_930198375((&L0), (&tok0));
			} LA6: ;
		}
		{
			if (!(((NI) 0) < (condstack_291128_930198375 ? condstack_291128_930198375->Sup.len : 0))) goto LA9;
			lexmessage_286378_689113469((&L0), ((Tmsgkind192002) 24), ((NimStringDesc*) &T930198375_8));
		}
		LA9: ;
		closelexer_286347_689113469((&L0));
		rawmessage_195612_155036129(((Tmsgkind192002) 279), filename0);
	}
	LA3: ;
}
...
nimRegisterGlobalMarker(T930198375_3);
	if (condstack_291128_930198375) nimGCunrefNoCycle(condstack_291128_930198375);
	condstack_291128_930198375 = (TY291111*) newSeqRC1((&NTI291111), 0);
}

NIM_EXTERNC N_NOINLINE(void, compiler_nimconfDatInit000)(void) {
NTI291111.size = sizeof(TY291111*);
NTI291111.kind = 24;
NTI291111.base = (&NTI130);
NTI291111.flags = 2;
NTI291111.marker = T930198375_2;
}
