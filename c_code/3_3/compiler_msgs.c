...
typedef N_CLOSURE_PTR(void, TMP1987) (NimStringDesc* output);
...
N_NOINLINE(void, raiserecoverableerror_182059)(NimStringDesc* msg);
...
static N_INLINE(void, shallow_86624)(NimStringDesc** s_86627);
...
NIM_CONST TY85745 TMP1049 = {((NimStringDesc*) &TMP1050),
868}
;
STRING_LITERAL(TMP2705, "suggest done", 12);
STRING_LITERAL(TMP3052, "(", 1);
STRING_LITERAL(TMP3053, ",", 1);
STRING_LITERAL(TMP3054, ")", 1);
NIM_CONST TY85745 TMP3621 = {((NimStringDesc*) &TMP1050),
875}
;
...
tlineinfo181340 gcmdlineinfo_182006;
tlineinfo181340 gcodegenlineinfo_182052;
NU64 gnotes_182117;
NI gerrorcounter_182118;
NI ghintcounter_182119;
NI gwarncounter_182120;
NI gerrormax_182121;
TY182139* msgcontext_182160;
TNimType NTI181340; /* TLineInfo */
extern TNimType NTI112; /* int16 */
extern TNimType NTI114; /* int32 */
TNimType NTI182139; /* seq[TLineInfo] */
tlineinfo181340 lasterror_182161;
TY121008* bufferedmsgs_182163;
NU8 erroroutputs_182165;
TY182166 writelnhook_182169;
...
TNimType NTI182065; /* ref ERecoverableError */
...
TNimType NTI182451; /* ref ESuggestDone */
N_NIMCALL(void, TMP137)(void* p, NI op) {
	TY181353* a;
	NI LOC1;
	a = (TY181353*)p;
...
N_NIMCALL(trope178009*, makecstring_181459)(NimStringDesc* s) {
	...
	res = copyString(((NimStringDesc*) &TMP141));
	{
		...
		i_181477 = 0;
		HEX3Atmp_181482 = 0;
		HEX3Atmp_181482 = (NI64)(s->Sup.len - 1);
		res_181485 = 0;
		{
			while (1) {
				NimStringDesc* LOC9;
				...
				{
					trope178009* LOC8;
					if (!(((NI) ((NI64)((NI64)(i_181477 + 1) % 64))) == 0)) goto LA6;
					res = addChar(res, 34);
...
static N_INLINE(void, writeln_171205)(FILE* f_171209, NimStringDesc** x_171213, NI x_171213Len0) {
	...
	write_13465(f_171209, ((NimStringDesc*) &TMP148));
}
...
N_NIMCALL(void, msgwriteln_182947)(NimStringDesc* s) {
	{
		...
		{
			TY182990 LOC9;
			if (!((erroroutputs_182165 &(1<<((((NU8) 1))&7)))!=0)) goto LA7;
	...
	LA3: ;
	{
		{
			TY182990 LOC15;
			if (!((erroroutputs_182165 &(1<<((((NU8) 0))&7)))!=0)) goto LA13;
	...
	LA1: ;
	{
		if (!((erroroutputs_182165 &(1<<((((NU8) 2))&7)))!=0)) goto LA18;
		safeadd_182242((&bufferedmsgs_182163), s);
	}
	LA18: ;
}
...
N_NIMCALL(void, writecontext_183231)(tlineinfo181340 lastinfo) {
	...
	info = lastinfo;
	{
		...
		i_183258 = 0;
		HEX3Atmp_183264 = 0;
		HEX3Atmp_183264 = (NI64)(msgcontext_182160->Sup.len - 1);
		res_183267 = 0;
		{
			while (1) {
				...
				i_183258 = res_183267;
				{
					...
					LOC6 = 0;
					LOC7 = 0;
					LOC7 = HEX3DHEX3D_183220(msgcontext_182160->data[i_183258], lastinfo);
					LOC6 = !(LOC7);
					if (!(LOC6)) goto LA8;
					LOC9 = 0;
					LOC9 = HEX3DHEX3D_183220(msgcontext_182160->data[i_183258], info);
					LOC6 = !(LOC9);
					LA8: ;
					if (!LOC6) goto LA10;
					memset((void*)LOC12, 0, sizeof(LOC12));
					LOC12[0] = tomsgfilename_182831(msgcontext_182160->data[i_183258]);
					LOC12[1] = coordtostr_183057(((NI) (msgcontext_182160->data[i_183258].Line)));
					LOC12[2] = coordtostr_183057(((NI) (msgcontext_182160->data[i_183258].Col)));
				...
				LA10: ;
				info = msgcontext_182160->data[i_183258];
				res_183267 += 1;
			} LA3: ;
		}
	}
...
N_NOINLINE(void, raiserecoverableerror_182059)(NimStringDesc* msg) {
	erecoverableerror181346* e_182064;
	NimStringDesc* LOC1;
	e_182064 = 0;
	e_182064 = (erecoverableerror181346*) newObj((&NTI182065), sizeof(erecoverableerror181346));
	(*e_182064).Sup.Sup.Sup.m_type = (&NTI181346);
	LOC1 = 0;
	LOC1 = (*e_182064).Sup.Sup.message; (*e_182064).Sup.Sup.message = copyStringRC1(msg);
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_182064, "ERecoverableError");
}
...
N_NIMCALL(void, handleerror_183100)(NU16 msg, NU8 eh, NimStringDesc* s) {
	...
	LA5: ;
	{
		...
		LA18: ;
		if (!LOC17) goto LA19;
		gerrorcounter_182118 += 1;
		gexitcode_170129 = ((NI8) 1);
		{
			if (!(gerrormax_182121 <= gerrorcounter_182118)) goto LA23;
			{
				NIM_BOOL LOC27;
				NIM_BOOL LOC28;
				LOC27 = 0;
		...
		LA36: ;
		{
			...
			raiserecoverableerror_182059(s);
		}
		goto LA21;
		LA47: ;
		LA21: ;
...
{	frmt = 0;
	...
	case ((NU16) 230) ... ((NU16) 259):
	{
		...
		LA6: ;
		{
			if (!!(((gnotes_182117 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0))) goto LA10;
			goto BeforeRet;
		}
		LA10: ;
	...
	case ((NU16) 260) ... ((NU16) 276):
	{
		...
		LA16: ;
		{
			if (!!(((gnotes_182117 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0))) goto LA20;
			goto BeforeRet;
		}
		LA20: ;
		frmt = copyString(((NimStringDesc*) &TMP428));
		ghintcounter_182119 += 1;
	}
	break;
	}
	LOC22 = 0;
		...
		if (TMP1039.status == 0) {
			{
				...
				line_183782 = 0;
				HEX3Atmp_183838 = 0;
				HEX3Atmp_183838 = tofullpath_182637(i.Fileindex);
				f_183841 = open_13217(HEX3Atmp_183838, ((NU8) 0), 8000);
				res_183843 = rawNewString(80);
				{
					while (1) {
						NIM_BOOL LOC15;
						LOC15 = 0;
						LOC15 = readline_13489(f_183841, (&res_183843));
						if (!LOC15) goto LA14;
...
N_NIMCALL(void, limessage_183456)(tlineinfo181340 info, NU16 msg, NimStringDesc* arg, NU8 eh) {
	...
	case ((NU16) 230) ... ((NU16) 259):
	{
		...
		if (LOC3) goto LA4;
		LOC3 = !(((gnotes_182117 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0));
		LA4: ;
		ignoremsg = LOC3;
		{
	...
	case ((NU16) 260) ... ((NU16) 276):
	{
		...
		if (LOC10) goto LA11;
		LOC10 = !(((gnotes_182117 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0));
		LA11: ;
		ignoremsg = LOC10;
...
N_NIMCALL(void, suggestwriteln_182187)(NimStringDesc* s) {
	{
		if (!((erroroutputs_182165 &(1<<((((NU8) 0))&7)))!=0)) goto LA3;
		{
			TY182990 LOC9;
			if (!writelnhook_182169.ClPrc == 0) goto LA7;
			memset((void*)LOC9, 0, sizeof(LOC9));
			LOC9[0] = copyString(s);
		...
		LA7: ;
		{
			writelnhook_182169.ClEnv? writelnhook_182169.ClPrc(s, writelnhook_182169.ClEnv):((TMP1987)(writelnhook_182169.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
	{
		if (!((erroroutputs_182165 &(1<<((((NU8) 2))&7)))!=0)) goto LA13;
		safeadd_182242((&bufferedmsgs_182163), s);
	}
	LA13: ;
}
...
N_NIMCALL(void, pushinfocontext_182530)(tlineinfo181340 info) {
	msgcontext_182160 = (TY182139*) incrSeq(&(msgcontext_182160)->Sup, sizeof(tlineinfo181340));
	msgcontext_182160->data[msgcontext_182160->Sup.len-1] = info;
}

N_NIMCALL(void, popinfocontext_182557)(void) {
	msgcontext_182160 = (TY182139*) setLengthSeq(&(msgcontext_182160)->Sup, sizeof(tlineinfo181340), (NI64)(msgcontext_182160->Sup.len - 1));
}

N_NIMCALL(void, clearbufferedmsgs_182179)(void) {
	genericSeqAssign((&bufferedmsgs_182163), NIM_NIL, (&NTI121008));
}
N_NIMCALL(void, TMP2704)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_182446)(void) {
	esuggestdone181348* e_182450;
	NimStringDesc* LOC1;
	e_182450 = 0;
	e_182450 = (esuggestdone181348*) newObj((&NTI182451), sizeof(esuggestdone181348));
	(*e_182450).Sup.Sup.m_type = (&NTI181348);
	LOC1 = 0;
	LOC1 = (*e_182450).Sup.message; (*e_182450).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2705));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_182450, "ESuggestDone");
}
...
N_NIMCALL(tlineinfo181340, getinfocontext_182592)(NI index) {
	...
	LA1: ;
	{
		...
		result = unknownlineinfo_182130();
	}
	goto LA6;
	LA8: ;
	{
		result = msgcontext_182160->data[i];
	}
	LA6: ;
	return result;
}
...
appendString(LOC1, ((NimStringDesc*) &TMP3052));
appendString(LOC1, LOC3);
appendString(LOC1, ((NimStringDesc*) &TMP3053));
...
N_NIMCALL(NI, getinfocontextlen_182485)(void) {
	NI result;
{	result = 0;
	result = msgcontext_182160->Sup.len;
	goto BeforeRet;
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, setinfocontextlen_182505)(NI l) {
	msgcontext_182160 = (TY182139*) setLengthSeq(&(msgcontext_182160)->Sup, sizeof(tlineinfo181340), l);
}
...
NIM_EXTERNC N_NOINLINE(void, compiler_msgsInit)(void) {
	...
	gcmdlineinfo_182006 = newlineinfo_181943(((NI32) 0), 1, 1);
	memset((void*)(&LOC2), 0, sizeof(LOC2));
	...
	gcodegenlineinfo_182052 = newlineinfo_181943(((NI32) 1), 1, 1);
	gnotes_182117 = IL64(140737439596543);
	gerrorcounter_182118 = 0;
	ghintcounter_182119 = 0;
	gwarncounter_182120 = 0;
	gerrormax_182121 = 1;
	if (msgcontext_182160) nimGCunrefNoCycle(msgcontext_182160);
	msgcontext_182160 = (TY182139*) newSeqRC1((&NTI182139), 0);
	lasterror_182161 = unknownlineinfo_182130();
	erroroutputs_182165 = 3;
...
static TNimNode* TMP1981[277];
NI TMP1983;
static char* NIM_CONST TMP1982[277] = {
"errUnknown", 
"errIllFormedAstX", 
"errInternal", 
"errCannotOpenFile", 
...
NTI182139.size = sizeof(TY182139*);
NTI182139.kind = 24;
NTI182139.base = (&NTI181340);
NTI182139.flags = 2;
NTI182139.marker = TMP145;
NTI181346.size = sizeof(erecoverableerror181346);
NTI181346.kind = 17;
NTI181346.base = (&NTI3449);
TMP19[11].len = 0; TMP19[11].kind = 2;
NTI181346.node = &TMP19[11];
NTI182065.size = sizeof(erecoverableerror181346*);
NTI182065.kind = 22;
NTI182065.base = (&NTI181346);
NTI182065.marker = TMP429;
NTI181005.size = sizeof(NU16);
NTI181005.kind = 14;
NTI181005.base = 0;
NTI181005.flags = 3;
for (TMP1983 = 0; TMP1983 < 277; TMP1983++) {
TMP19[TMP1983+12].kind = 1;
TMP19[TMP1983+12].offset = TMP1983;
TMP19[TMP1983+12].name = TMP1982[TMP1983];
TMP1981[TMP1983] = &TMP19[TMP1983+12];
}
TMP19[289].len = 277; TMP19[289].kind = 2; TMP19[289].sons = &TMP1981[0];
...
NTI182451.size = sizeof(esuggestdone181348*);
NTI182451.kind = 22;
NTI182451.base = (&NTI181348);
NTI182451.marker = TMP2704;
}
