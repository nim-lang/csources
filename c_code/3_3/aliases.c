...
static N_INLINE(tnode186813*, lastson_187199)(tnode186813* n) {
	...
	if ((NU)((NI64)(TMP5613)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI64)(TMP5613)];
	popFrame();
	return result;
}
...
static N_INLINE(ttype186847*, lastson_187203)(ttype186847* n) {
	...
	if ((NU)((NI64)(TMP5618)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP5618)];
	popFrame();
	return result;
}
