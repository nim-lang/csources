...
N_NIMCALL(tmemfile209204, open_209210)(NimStringDesc* filename, NU8 mode, NI mappedsize, NI offset, NI newfilesize) {
	...
	nimln(45, "memfiles.nim");
	{
		...
		if (!!(LOC3)) goto LA5;
		nimln(45, "memfiles.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP2859));	}	LA5: ;
...
static TNimNode* TMP2940[3];
static TNimNode TMP2857[4];
...
TMP2940[0] = &TMP2857[1];
TMP2857[1].kind = 1;
TMP2857[1].offset = offsetof(tmemfile209204, Mem);
TMP2857[1].typ = (&NTI146);
TMP2857[1].name = "mem";
TMP2940[1] = &TMP2857[2];
TMP2857[2].kind = 1;
TMP2857[2].offset = offsetof(tmemfile209204, Size);
TMP2857[2].typ = (&NTI105);
TMP2857[2].name = "size";
TMP2940[2] = &TMP2857[3];
TMP2857[3].kind = 1;
TMP2857[3].offset = offsetof(tmemfile209204, Handle);
TMP2857[3].typ = (&NTI3809);
TMP2857[3].name = "handle";
TMP2857[0].len = 3; TMP2857[0].kind = 2; TMP2857[0].sons = &TMP2940[0];
NTI209204.node = &TMP2857[0];
}
