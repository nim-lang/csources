...
STRING_LITERAL(TMP968, "(id == 0) or (id == result.id) ", 31);
STRING_LITERAL(TMP972, ":anonymous", 10);
STRING_LITERAL(TMP973, ":delegator", 10);
...
N_NIMCALL(NI, cmpignorestyle_166036)(NCSTRING a, NCSTRING b, NI blen) {
	...
	while (1) {
		...
		nimln(43, "idents.nim");
		{
			...
			nimln(43, "idents.nim");
			nimln(43, "idents.nim");
			TMP964 = addInt(((NI) (((NU8)(aa)))), 32);
			aa = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP964), 0, 255))));
		}
		LA16: ;
		nimln(44, "idents.nim");
		{
			...
			nimln(44, "idents.nim");
			nimln(44, "idents.nim");
			TMP965 = addInt(((NI) (((NU8)(bb)))), 32);
			bb = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP965), 0, 255))));
		}
		LA22: ;
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
		TMP966 = subInt(((NI) (((NU8)(aa)))), ((NI) (((NU8)(bb)))));
		result = (NI64)(TMP966);
		nimln(46, "idents.nim");
		{
			NIM_BOOL LOC26;
...
N_NIMCALL(tident166019*, getident_166250)(NCSTRING identifier, NI length, NI h) {
	...
	while (1) {
		...
		LA5: ;
		{
			...
			nimln(82, "idents.nim");
			{
				...
				if (!!(LOC17)) goto LA19;
				nimln(82, "idents.nim");
				failedassertimpl_80021(((NimStringDesc*) &TMP968));
			}
			LA19: ;
			nimln(83, "idents.nim");
			id = (*result).Sup.Id;
	...
	nimln(89, "idents.nim");
	nimln(89, "idents.nim");
	TMP971 = subInt(length, 1);
	HEX3Atmp_166448 = (NI64)(TMP971);
	...
	nimln(92, "idents.nim");
	{
		...
		nimln(94, "idents.nim");
		nimln(94, "idents.nim");
		if (wordcounter_166248 == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
		(*result).Sup.Id = ((NI64)-(wordcounter_166248));
	}
	goto LA22;
	LA24: ;
	{
...
N_NOINLINE(void, identsInit)(void) {
	...
	asgnRefNoCycle((void**) &idanon_166476, getident_166456(((NimStringDesc*) &TMP972)));
	nimln(109, "idents.nim");
	asgnRefNoCycle((void**) &iddelegator_166478, getident_166456(((NimStringDesc*) &TMP973)));
	popFrame();
}

N_NOINLINE(void, identsDatInit)(void) {
static TNimNode* TMP969[3];
static TNimNode TMP962[5];
NTI166013.size = sizeof(tidobj166013);
NTI166013.kind = 17;
NTI166013.base = (&NTI2409);
NTI166013.flags = 1;
TMP962[0].kind = 1;
TMP962[0].offset = offsetof(tidobj166013, Id);
TMP962[0].typ = (&NTI106);
TMP962[0].name = "id";
NTI166013.node = &TMP962[0];
...
TMP969[0] = &TMP962[2];
TMP962[2].kind = 1;
TMP962[2].offset = offsetof(tident166019, S);
TMP962[2].typ = (&NTI143);
TMP962[2].name = "s";
TMP969[1] = &TMP962[3];
TMP962[3].kind = 1;
TMP962[3].offset = offsetof(tident166019, Next);
TMP962[3].typ = (&NTI166017);
TMP962[3].name = "next";
TMP969[2] = &TMP962[4];
TMP962[4].kind = 1;
TMP962[4].offset = offsetof(tident166019, H);
TMP962[4].typ = (&NTI119013);
TMP962[4].name = "h";
TMP962[1].len = 3; TMP962[1].kind = 2; TMP962[1].sons = &TMP969[0];
NTI166019.node = &TMP962[1];
NTI166017.size = sizeof(tident166019*);
NTI166017.kind = 22;
NTI166017.base = (&NTI166019);
NTI166017.flags = 2;
NTI166017.marker = TMP970;
NTI166015.size = sizeof(tidobj166013*);
NTI166015.kind = 22;
NTI166015.base = (&NTI166013);
NTI166015.marker = TMP2039;
}
