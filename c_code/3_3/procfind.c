...
static NIM_CONST TY192025 TMP3434 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3435, "sons", 4);
STRING_LITERAL(TMP3437, "equalGenericParams", 18);
static NIM_CONST TY192025 TMP3438 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3439, "sym", 3);
...
N_NIMCALL(NIM_BOOL, equalgenericparams_270007)(tnode191813* proca, tnode191813* procb) {
	...
	TMP3436 = subInt(LOC7, 1);
	HEX3Atmp_270164 = (NI64)(TMP3436);
	...
	while (1) {
		...
		nimln(19, "procfind.nim");
		{
			nimln(19, "procfind.nim");
			nimln(19, "procfind.nim");
			if (((TMP3434[(*proca).Kind/8] &(1<<((*proca).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3435));
			...
			internalerror_168591((*proca).Info, ((NimStringDesc*) &TMP3437));
		...
		nimln(22, "procfind.nim");
		{
			nimln(22, "procfind.nim");
			nimln(22, "procfind.nim");
			if (((TMP3434[(*procb).Kind/8] &(1<<((*procb).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3435));
			...
			internalerror_168591((*procb).Info, ((NimStringDesc*) &TMP3437));
		...
		if (((TMP3434[(*proca).Kind/8] &(1<<((*proca).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3435));
		if ((NU)(i_270024) >= (NU)((*proca).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3438[(*(*proca).kindU.S6.Sons->data[i_270024]).Kind/8] &(1<<((*(*proca).kindU.S6.Sons->data[i_270024]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3439));
		a = (*(*proca).kindU.S6.Sons->data[i_270024]).kindU.S4.Sym;
		nimln(26, "procfind.nim");
		if (((TMP3434[(*procb).Kind/8] &(1<<((*procb).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3435));
		if ((NU)(i_270024) >= (NU)((*procb).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3438[(*(*procb).kindU.S6.Sons->data[i_270024]).Kind/8] &(1<<((*(*procb).kindU.S6.Sons->data[i_270024]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3439));
	...
	nimln(39, "procfind.nim");
	{
		...
		while (1) {
			...
			nimln(44, "procfind.nim");
			{
				...
				if (((TMP3434[(*(*result).Ast).Kind/8] &(1<<((*(*result).Ast).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3435));
				if ((NU)(2) >= (NU)((*(*result).Ast).kindU.S6.Sons->Sup.len)) raiseIndexError();
				genr = (*(*result).Ast).kindU.S6.Sons->data[2];
				nimln(46, "procfind.nim");
				if (((TMP3434[(*(*fn).Ast).Kind/8] &(1<<((*(*fn).Ast).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3435));
