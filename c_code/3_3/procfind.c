...
static NIM_CONST TY187025 TMP3432 = {
...
static NIM_CONST TY187025 TMP3436 = {
...
N_NIMCALL(NIM_BOOL, equalgenericparams_265007)(tnode186813* proca, tnode186813* procb) {
	...
	while (1) {
		...
		nimln(19, "procfind.nim");
		{
			...
			internalerror_164591((*proca).Info, ((NimStringDesc*) &TMP3435));
		...
		nimln(22, "procfind.nim");
		{
			...
			internalerror_164591((*procb).Info, ((NimStringDesc*) &TMP3435));
		...
		if (((TMP3432[(*proca).Kind/8] &(1<<((*proca).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3433));
		if ((NU)(i_265024) >= (NU)((*proca).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3436[(*(*proca).kindU.S6.Sons->data[i_265024]).Kind/8] &(1<<((*(*proca).kindU.S6.Sons->data[i_265024]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3437));
		a = (*(*proca).kindU.S6.Sons->data[i_265024]).kindU.S4.Sym;
		nimln(26, "procfind.nim");
		if (((TMP3432[(*procb).Kind/8] &(1<<((*procb).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3433));
		if ((NU)(i_265024) >= (NU)((*procb).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3436[(*(*procb).kindU.S6.Sons->data[i_265024]).Kind/8] &(1<<((*(*procb).kindU.S6.Sons->data[i_265024]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3437));
