...
N_NIMCALL(NI, rawparseint_80973)(NimStringDesc* s, NI64* b, NI start) {
	...
	nimln(200, "parseutils.nim");
	{
		...
		while (1) {
			...
			TMP1106 = subInt64((NI64)(TMP1104), ((NI64) ((NI64)(TMP1105))));
			(*b) = (NI64)(TMP1106);
...
N_NIMCALL(NI, npuParseBiggestFloat)(NimStringDesc* s, NF* number, NI start) {
	...
	nimln(261, "parseutils.nim");
	{
		...
		nimln(262, "parseutils.nim");
		{
			...
			nimln(262, "parseutils.nim");
			TMP1806 = addInt(i, 1);
			if ((NU)((NI64)(TMP1806)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC16 = ((NU8)(s->data[(NI64)(TMP1806)]) == (NU8)(65));
			if (LOC16) goto LA17;
			nimln(262, "parseutils.nim");
			nimln(262, "parseutils.nim");
			TMP1807 = addInt(i, 1);
			if ((NU)((NI64)(TMP1807)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC16 = ((NU8)(s->data[(NI64)(TMP1807)]) == (NU8)(97));
			LA17: ;
			if (!LOC16) goto LA18;
			nimln(263, "parseutils.nim");
			{
				...
				LOC22 = ((NU8)(s->data[(NI64)(TMP1808)]) == (NU8)(78));
				if (LOC22) goto LA23;
				nimln(263, "parseutils.nim");
				nimln(263, "parseutils.nim");
				TMP1809 = addInt(i, 2);
				if ((NU)((NI64)(TMP1809)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC22 = ((NU8)(s->data[(NI64)(TMP1809)]) == (NU8)(110));
				LA23: ;
				if (!LOC22) goto LA24;
				nimln(264, "parseutils.nim");
				{
					...
					if (!!((((NU8)(s->data[(NI64)(TMP1810)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI64)(TMP1810)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI64)(TMP1810)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI64)(TMP1810)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI64)(TMP1810)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI64)(TMP1810)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI64)(TMP1810)])) == ((NU8)(95))))) goto LA28;
					...
					nimln(266, "parseutils.nim");
					TMP1811 = addInt(i, 3);
					TMP1812 = subInt((NI64)(TMP1811), start);
					result = (NI64)(TMP1812);
					goto BeforeRet;
				}				LA28: ;
			}			LA24: ;
	...
	nimln(268, "parseutils.nim");
	{
		...
		nimln(269, "parseutils.nim");
		{
			...
			LOC38 = ((NU8)(s->data[(NI64)(TMP1813)]) == (NU8)(78));
			if (LOC38) goto LA39;
			nimln(269, "parseutils.nim");
			nimln(269, "parseutils.nim");
			TMP1814 = addInt(i, 1);
			if ((NU)((NI64)(TMP1814)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC38 = ((NU8)(s->data[(NI64)(TMP1814)]) == (NU8)(110));
			LA39: ;
			if (!LOC38) goto LA40;
			nimln(270, "parseutils.nim");
			{
				...
				LOC44 = ((NU8)(s->data[(NI64)(TMP1815)]) == (NU8)(70));
				if (LOC44) goto LA45;
				nimln(270, "parseutils.nim");
				nimln(270, "parseutils.nim");
				TMP1816 = addInt(i, 2);
				if ((NU)((NI64)(TMP1816)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC44 = ((NU8)(s->data[(NI64)(TMP1816)]) == (NU8)(102));
				LA45: ;
				if (!LOC44) goto LA46;
				nimln(271, "parseutils.nim");
				{
					...
					if (!!((((NU8)(s->data[(NI64)(TMP1817)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI64)(TMP1817)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI64)(TMP1817)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI64)(TMP1817)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI64)(TMP1817)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI64)(TMP1817)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI64)(TMP1817)])) == ((NU8)(95))))) goto LA50;
	...
	while (1) {
		...
		(*number) = ((NF)(((NF)((*number)) * (NF)(1.0000000000000000e+01))) + (NF)(((double) (((NI) ((NI64)(TMP1820)))))));
	...
	nimln(282, "parseutils.nim");
	{
		...
		while (1) {
			...
			(*number) = ((NF)(((NF)((*number)) * (NF)(1.0000000000000000e+01))) + (NF)(((double) (((NI) ((NI64)(TMP1821)))))));
	...
	nimln(296, "parseutils.nim");
	{
		...
		while (1) {
			...
			nimln(306, "parseutils.nim");
			if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
			TMP1823 = addInt((NI64)(TMP1822), ((NI) (((NU8)(s->data[i])))));
			TMP1824 = subInt((NI64)(TMP1823), 48);
			exponent = (NI64)(TMP1824);
