	...
	p = ((NI8*) (buf));
	{
		while (1) {
			...
			readbytes = readbuffer_13715(bin, buf, ((NI) 8000));
			{
				...
				i_176647 = 0;
				HEX3Atmp_176652 = 0;
				HEX3Atmp_176652 = (NI64)(readbytes - ((NI) 1));
				res_176655 = ((NI) 0);
				{
					while (1) {
						if (!(res_176655 <= HEX3Atmp_176652)) goto LA10;
						i_176647 = res_176655;
						result = updatecrc32_176019(p[(i_176647)- 0], result);
						res_176655 += ((NI) 1);
					} LA10: ;
				}
			}
...
N_NIMCALL(NI32, HEX3EHEX3C_176533)(NI32 c, NimStringDesc* s) {
	...
	result = c;
	{
		...
		i_176548 = 0;
		HEX3Atmp_176550 = 0;
		HEX3Atmp_176550 = (NI64)(s->Sup.len - ((NI) 1));
		res_176553 = ((NI) 0);
		{
			while (1) {
				if (!(res_176553 <= HEX3Atmp_176550)) goto LA3;
				i_176548 = res_176553;
				result = updatecrc32_176026(s->data[i_176548], result);
				res_176553 += ((NI) 1);
			} LA3: ;
		}
	}
