...
N_NIMCALL(void, handlecmdline_611607)(void) {
	...
	LA4: ;
	{
		processcmdline_605209(((NU8) 0), ((NimStringDesc*) &TMP1877));
		{
			TSafePoint TMP1878;
			TY117204 p;
			NimStringDesc* LOC15;
		...
		LA7: ;
		loadconfigs_220811(((NimStringDesc*) &TMP1903));
		initvars_202820();
		processcmdline_605209(((NU8) 1), ((NimStringDesc*) &TMP1877));
		maincommand_609027();
		{
			NimStringDesc* LOC22;
...
appendString(LOC44, arguments_210144);
					execexternalprogram_202907(LOC44, ((NimStringDesc*) &TMP1877));
				}
				goto LA31;
				LA33: ;
				{
					...
					LA48: ;
					{
						NimStringDesc* LOC51;
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_169234, ((NimStringDesc*) &TMP1877));
...
appendString(LOC52, arguments_210144);
					execexternalprogram_202907(LOC52, ((NimStringDesc*) &TMP1877));
				}
				LA31: ;
			}
			LA29: ;
