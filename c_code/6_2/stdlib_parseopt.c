...
static NIM_CONST TY211607 TMP1559 = {
...
N_NIMCALL(void, handleshortoption_207309)(optparser207011* p) {
	...
	}
	{
		...
		i = parseword_207204((*p).Cmd, i, &(*p).Val, TMP1559);
	}
	LA5: ;
	{
...
N_NIMCALL(void, nponext)(optparser207011* p) {
	...
	case 45:
	{
		i += 1;
		{
			...
			(*p).Kind = ((NU8) 2);
			i += 1;
			i = parseword_207204((*p).Cmd, i, &(*p).Key, TMP1560);
			{
				while (1) {
			...
			}
			{
				...
				(*p).Pos = parseword_207204((*p).Cmd, i, &(*p).Val, TMP1559);
			}
			goto LA15;
			LA17: ;
			{
	...
	{
		(*p).Kind = ((NU8) 1);
		(*p).Pos = parseword_207204((*p).Cmd, i, &(*p).Key, TMP1559);
	}
	break;
	}
	BeforeRet: ;
