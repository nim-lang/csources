...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY123387 TMP7633 = {
...
N_NIMCALL(void, initoptparser_527819)(NimStringDesc* cmdline, toptparser527807* Result) {
	...
	LA3: ;
	{
		...
		HEX3Atmp_527837 = paramcount_115233();
...
N_NIMCALL(void, handleshortoption_528106)(toptparser527807* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_528002((*p).Cmd, i, &(*p).Val, TMP7632);
	}
	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser527807* p) {
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_528002((*p).Cmd, i, &(*p).Key, TMP7633);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_528002((*p).Cmd, i, &(*p).Val, TMP7632);
			}
			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_528002((*p).Cmd, i, &(*p).Key, TMP7632);
	}
	break;
	}
	BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser527807* p) {
	...
	LOC1 = 0;
	LOC1 = copyStrLast((*p).Cmd, (*p).Pos, (NI64)(TMP7634));
...
TMP7636[0] = &TMP7626[1];
TMP7626[1].kind = 1;
TMP7626[1].offset = offsetof(toptparser527807, Cmd);
TMP7626[1].typ = (&NTI143);
TMP7626[1].name = "cmd";
TMP7636[1] = &TMP7626[2];
TMP7626[2].kind = 1;
TMP7626[2].offset = offsetof(toptparser527807, Pos);
TMP7626[2].typ = (&NTI106);
TMP7626[2].name = "pos";
TMP7636[2] = &TMP7626[3];
TMP7626[3].kind = 1;
TMP7626[3].offset = offsetof(toptparser527807, Inshortstate);
...
NTI527805.node = &TMP7626[9];
TMP7626[4].kind = 1;
TMP7626[4].offset = offsetof(toptparser527807, Kind);
TMP7626[4].typ = (&NTI527805);
TMP7626[4].name = "kind";
TMP7636[4] = &TMP7626[10];
TMP7626[10].kind = 1;
TMP7626[10].offset = offsetof(toptparser527807, Key);
TMP7626[10].typ = (&NTI143);
TMP7626[10].name = "key";
TMP7636[5] = &TMP7626[11];
TMP7626[11].kind = 1;
TMP7626[11].offset = offsetof(toptparser527807, Val);
TMP7626[11].typ = (&NTI143);
TMP7626[11].name = "val";
TMP7626[0].len = 6; TMP7626[0].kind = 2; TMP7626[0].sons = &TMP7636[0];
NTI527807.node = &TMP7626[0];
}
