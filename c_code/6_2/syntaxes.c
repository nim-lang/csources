...
NIM_CONST TY258026 filternames_258025 = {((NimStringDesc*) &TMP1309),
...
NIM_CONST TY258020 parsernames_258019 = {((NimStringDesc*) &TMP1313),
...
N_NIMCALL(tllstream211204*, evalpipe_258546)(tparsers258035* p, tnode224819* n, NimStringDesc* filename, tllstream211204* start) {
	...
	LA3: ;
	{
		...
		LOC7 = LOC8;
		if (!(LOC7)) goto LA10;
		LOC7 = identeq_200493((*(*n).kindU.S6.Sons->data[0]).kindU.S5.Ident, ((NimStringDesc*) &TMP1200));
		LA10: ;
		if (!LOC7) goto LA11;
		{
			NI i_258635;
...
N_NIMCALL(tnode224819*, parseall_258063)(tparsers258035* p) {
	...
	case ((NU8) 3):
	{
		internalerror_197989(((NimStringDesc*) &TMP1347));
		result = emptynode_225738;
	}
	break;
	}
