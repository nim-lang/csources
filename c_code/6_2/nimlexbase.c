...
N_NIMCALL(void, fillbuffer_181072)(tbaselexer181018* l) {
	...
	LOC13 = 0;
	LOC13 = llstreamread_179242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP1659));
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				LOC37 = 0;
				LOC37 = llstreamread_179242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP1668));
...
N_NIMCALL(NI, getcolnumber_181045)(tbaselexer181018* l, NI pos) {
	...
	if ((NI64)(TMP1680) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP1680));
	popFrame();
	return result;
}
