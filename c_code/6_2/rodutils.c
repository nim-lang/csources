...
N_NIMCALL(NimStringDesc*, decodestr_199126)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 92:
		{
			...
			nimln(49, "rodutils.nim");
			TMP2106 = subInt(i, 2);
			hexchar_199064(s[(NI64)(TMP2106)], &xi);
			nimln(50, "rodutils.nim");
			nimln(50, "rodutils.nim");
			TMP2107 = subInt(i, 1);
			hexchar_199064(s[(NI64)(TMP2107)], &xi);
...
N_NIMCALL(void, encodevbiggestintaux_199198)(NI64 x, NimStringDesc** result) {
	...
	nimln(70, "rodutils.nim");
	TMP2108 = modInt64(v_199206, 190);
	rem_199208 = (NI64)(TMP2108);
	...
	LA3: ;
	{
		...
		nimln(76, "rodutils.nim");
		TMP2110 = divInt64(v_199206, 190);
		v_199206 = (NI64)(TMP2110);
	}
	LA1: ;
	...
	nimln(78, "rodutils.nim");
	{
		...
		nimln(78, "rodutils.nim");
		if ((NU)(idx_199210) > (NU)(((NimStringDesc*) &TMP2111)->Sup.len)) raiseIndexError();
		d_199204 = ((NimStringDesc*) &TMP2111)->data[idx_199210];
	}
	goto LA6;
	LA8: ;
	{
		...
		nimln(79, "rodutils.nim");
		nimln(79, "rodutils.nim");
		TMP2112 = subInt(idx_199210, 62);
		TMP2113 = addInt((NI64)(TMP2112), 128);
		d_199204 = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP2113), 0, 255))));
	}
	LA6: ;
...
N_NIMCALL(void, encodevintaux_199231)(NI x, NimStringDesc** result) {
	...
	nimln(70, "rodutils.nim");
	nimln(70, "rodutils.nim");
	TMP2114 = modInt(v_199239, 190);
	rem_199241 = (NI64)(TMP2114);
	nimln(71, "rodutils.nim");
	{
		NI TMP2115;
		nimln(71, "rodutils.nim");
	...
	LA3: ;
	{
		...
		nimln(76, "rodutils.nim");
		nimln(76, "rodutils.nim");
		TMP2116 = divInt(v_199239, 190);
		v_199239 = (NI64)(TMP2116);
	}
	LA1: ;
	nimln(77, "rodutils.nim");
	...
	nimln(78, "rodutils.nim");
	{
		...
		nimln(78, "rodutils.nim");
		if ((NU)(idx_199243) > (NU)(((NimStringDesc*) &TMP2111)->Sup.len)) raiseIndexError();
		d_199237 = ((NimStringDesc*) &TMP2111)->data[idx_199243];
	}
	goto LA6;
	LA8: ;
	{
		...
		nimln(79, "rodutils.nim");
		nimln(79, "rodutils.nim");
		TMP2117 = subInt(idx_199243, 62);
		TMP2118 = addInt((NI64)(TMP2117), 128);
		d_199237 = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP2118), 0, 255))));
	}
	LA6: ;
	nimln(80, "rodutils.nim");
	{
...
N_NIMCALL(NI, decodevint_199305)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 48 ... 57:
		{
			...
			nimln(110, "rodutils.nim");
			nimln(110, "rodutils.nim");
			TMP2121 = subInt(((NI) (((NU8)(s[i_199312])))), 48);
		...
		case 97 ... 122:
		{
			...
			nimln(111, "rodutils.nim");
			nimln(111, "rodutils.nim");
			TMP2124 = subInt(((NI) (((NU8)(s[i_199312])))), 97);
		...
		case 65 ... 90:
		{
			...
			nimln(112, "rodutils.nim");
			nimln(112, "rodutils.nim");
			TMP2128 = subInt(((NI) (((NU8)(s[i_199312])))), 65);
		...
		case 128 ... 255:
		{
			...
			nimln(113, "rodutils.nim");
			nimln(113, "rodutils.nim");
			TMP2132 = subInt(((NI) (((NU8)(s[i_199312])))), 128);
	...
	nimln(116, "rodutils.nim");
	nimln(116, "rodutils.nim");
	TMP2135 = mulInt(result, sign_199314);
...
N_NIMCALL(NI64, decodevbiggestint_199530)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 48 ... 57:
		{
			...
			nimln(110, "rodutils.nim");
			nimln(110, "rodutils.nim");
			TMP2137 = subInt(((NI) (((NU8)(s[i_199537])))), 48);
		...
		case 97 ... 122:
		{
			...
			nimln(111, "rodutils.nim");
			nimln(111, "rodutils.nim");
			TMP2140 = subInt(((NI) (((NU8)(s[i_199537])))), 97);
		...
		case 65 ... 90:
		{
			...
			nimln(112, "rodutils.nim");
			nimln(112, "rodutils.nim");
			TMP2144 = subInt(((NI) (((NU8)(s[i_199537])))), 65);
		...
		case 128 ... 255:
		{
			...
			nimln(113, "rodutils.nim");
			nimln(113, "rodutils.nim");
			TMP2148 = subInt(((NI) (((NU8)(s[i_199537])))), 128);
	...
	nimln(116, "rodutils.nim");
	nimln(116, "rodutils.nim");
	TMP2151 = mulInt64(result, ((NI64) (sign_199539)));
