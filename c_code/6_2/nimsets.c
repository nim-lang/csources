...
N_NIMCALL(tnode224819*, totreeset_283754)(tbitset282012* s, ttype224855* settype, tlineinfo195539 info);
...
N_NIMCALL(NIM_BOOL, inset_283019)(tnode224819* s, tnode224819* elem) {
	...
	result = 0;
	{
		...
		internalerror_197970((*s).Info, ((NimStringDesc*) &TMP2801));
		result = NIM_FALSE;
		goto BeforeRet;
	}
	LA3: ;
		...
		res_284119 = 0;
		{
			while (1) {
				...
				i_284023 = res_284119;
				{
					...
					LOC9 = 0;
					LOC9 = getordvalue_261187((*(*s).kindU.S6.Sons->data[i_284023]).kindU.S6.Sons->data[1]);
					LOC10 = 0;
					LOC10 = getordvalue_261187((*(*s).kindU.S6.Sons->data[i_284023]).kindU.S6.Sons->data[0]);
