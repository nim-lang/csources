...
static NIM_CONST TY192025 TMP5466 = {
...
NIM_CONST TY131008 TMP5470 = {((NimStringDesc*) &TMP5471),
39}
;
...
N_NIMCALL(tnode191813*, evaltemplateargs_395174)(tnode191813* n, tsym191843* s) {
	...
	nimln(65, "evaltempl.nim");
	{
		...
		if (!(f < a)) goto LA5;
		nimln(65, "evaltempl.nim");
		globalerror_168558((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP5473));
	}
	LA5: ;
	...
	while (1) {
		...
		LA10: ;
		{
			...
			if (!(((TMP5466[(*(*(*(*s).Typ).N).kindU.S6.Sons->data[i_395194]).Kind/8] &(1<<((*(*(*(*s).Typ).N).kindU.S6.Sons->data[i_395194]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5467));
		...
		nimln(70, "evaltempl.nim");
		{
			...
			localerror_168571((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP5473));
		}
		LA17: ;
...
N_NIMCALL(tnode191813*, evaltemplate_395275)(tnode191813* n, tsym191843* tmpl, tsym191843* gensymowner) {
	...
	nimln(79, "evaltempl.nim");
	{
		...
		globalerror_168558((*n).Info, ((NU16) 183), ((NimStringDesc*) &TMP5473));
