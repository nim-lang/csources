...
N_NIMCALL(NimStringDesc*, paramstr_123209)(NI i) {
	...
	LOC7 = 0;
	LOC7 = (*e_123216).Sup.message; (*e_123216).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1070));
...
N_NIMCALL(NimStringDesc*, getapplheuristic_123804)(void) {
	...
	result = paramstr_123209(0);
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			p_124003 = 0;
			HEX3Atmp_124010 = 0;
			HEX3Atmp_124010 = getenv_120042(((NimStringDesc*) &TMP1071));
			last_124015 = 0;
			{
				while (1) {
					NI first_124017;
...
N_NIMCALL(NimStringDesc*, nosgetAppFilename)(void) {
	NimStringDesc* result;
	result = 0;
	result = getenv_120042(((NimStringDesc*) &TMP1068));
	{
...
N_NIMCALL(NimStringDesc*, nosgetHomeDir)(void) {
	...
	LOC1 = 0;
	LOC2 = 0;
	LOC2 = getenv_120042(((NimStringDesc*) &TMP1672));
...
N_NOINLINE(void, nosraiseOSError)(NimStringDesc* msg) {
	{
		...
		LA7: ;
		{
			NimStringDesc* LOC11;
			LOC11 = 0;
			LOC11 = (*e_114217).Sup.Sup.message; (*e_114217).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1067));
