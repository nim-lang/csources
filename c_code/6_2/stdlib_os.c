...
{	result = 0;
	...
	LOC7 = 0;
	LOC7 = (*e_124616).Sup.message; (*e_124616).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1080));
...
{	result = 0;
	result = paramstr_124609(0);
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			p_125403 = 0;
			HEX3Atmp_125410 = 0;
			HEX3Atmp_125410 = getenv_121442(((NimStringDesc*) &TMP1081));
			last_125415 = 0;
			{
				while (1) {
					NI first_125417;
...
N_NIMCALL(NimStringDesc*, nosgetAppFilename)(void) {
	NimStringDesc* result;
	result = 0;
	result = getenv_121442(((NimStringDesc*) &TMP1078));
	{
...
{	result = 0;
	LOC1 = 0;
	LOC2 = 0;
	LOC2 = getenv_121442(((NimStringDesc*) &TMP1688));
...
{	result = 0;
	...
	LA4: ;
	path = getenv_121442(((NimStringDesc*) &TMP1081));
	{
