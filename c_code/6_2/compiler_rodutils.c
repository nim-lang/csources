...
N_NIMCALL(NimStringDesc*, decodestr_177114)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 92:
		{
			...
			nimln(49, "rodutils.nim");
			TMP2080 = subInt(i, 2);
			hexchar_177058(s[(NI64)(TMP2080)], &xi);			nimln(50, "rodutils.nim");
			nimln(50, "rodutils.nim");
			TMP2081 = subInt(i, 1);
			hexchar_177058(s[(NI64)(TMP2081)], &xi);			nimln(51, "rodutils.nim");
...
N_NIMCALL(void, encodevbiggestintaux_177161)(NI64 x, NimStringDesc** result) {
	...
	nimln(70, "rodutils.nim");
	TMP2082 = modInt64(v_177169, 190);
	rem_177171 = (NI64)(TMP2082);
	...
	LA3: ;
	{
		...
		nimln(76, "rodutils.nim");
		TMP2084 = divInt64(v_177169, 190);
		v_177169 = (NI64)(TMP2084);
	}	LA1: ;
	...
	nimln(78, "rodutils.nim");
	{
		...
		nimln(78, "rodutils.nim");
		if ((NU)(idx_177173) > (NU)(((NimStringDesc*) &TMP2085)->Sup.len)) raiseIndexError();
		d_177167 = ((NimStringDesc*) &TMP2085)->data[idx_177173];
	}	goto LA6;
	LA8: ;
	{
		NI TMP2086;
		...
		nimln(79, "rodutils.nim");
		nimln(79, "rodutils.nim");
		TMP2086 = subInt(idx_177173, 62);
		TMP2087 = addInt((NI64)(TMP2086), 128);
		d_177167 = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP2087), 0, 255))));
	}	LA6: ;
...
N_NIMCALL(void, encodevintaux_177193)(NI x, NimStringDesc** result) {
	...
	nimln(70, "rodutils.nim");
	nimln(70, "rodutils.nim");
	TMP2088 = modInt(v_177201, 190);
	rem_177203 = (NI64)(TMP2088);
	nimln(71, "rodutils.nim");
	{
		NI TMP2089;
		nimln(71, "rodutils.nim");
	...
	LA3: ;
	{
		...
		nimln(76, "rodutils.nim");
		nimln(76, "rodutils.nim");
		TMP2090 = divInt(v_177201, 190);
		v_177201 = (NI64)(TMP2090);
	}	LA1: ;
	nimln(77, "rodutils.nim");
	...
	nimln(78, "rodutils.nim");
	{
		...
		nimln(78, "rodutils.nim");
		if ((NU)(idx_177205) > (NU)(((NimStringDesc*) &TMP2085)->Sup.len)) raiseIndexError();
		d_177199 = ((NimStringDesc*) &TMP2085)->data[idx_177205];
	}	goto LA6;
	LA8: ;
	{
		NI TMP2091;
		...
		nimln(79, "rodutils.nim");
		nimln(79, "rodutils.nim");
		TMP2091 = subInt(idx_177205, 62);
		TMP2092 = addInt((NI64)(TMP2091), 128);
		d_177199 = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP2092), 0, 255))));
	}	LA6: ;
	nimln(80, "rodutils.nim");
	{
		nimln(698, "system.nim");
...
N_NIMCALL(NI, decodevint_177239)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 48 ... 57:
		{
			...
			nimln(110, "rodutils.nim");
			nimln(110, "rodutils.nim");
			TMP2095 = subInt(((NI) (((NU8)(s[i_177246])))), 48);
		...
		case 97 ... 122:
		{
			...
			nimln(111, "rodutils.nim");
			nimln(111, "rodutils.nim");
			TMP2098 = subInt(((NI) (((NU8)(s[i_177246])))), 97);
		...
		case 65 ... 90:
		{
			...
			nimln(112, "rodutils.nim");
			nimln(112, "rodutils.nim");
			TMP2102 = subInt(((NI) (((NU8)(s[i_177246])))), 65);
		...
		case 128 ... 255:
		{
			...
			nimln(113, "rodutils.nim");
			nimln(113, "rodutils.nim");
			TMP2106 = subInt(((NI) (((NU8)(s[i_177246])))), 128);
	...
	nimln(116, "rodutils.nim");
	nimln(116, "rodutils.nim");
	TMP2109 = mulInt(result, sign_177248);
...
N_NIMCALL(NI64, decodevbiggestint_177495)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 48 ... 57:
		{
			...
			nimln(110, "rodutils.nim");
			nimln(110, "rodutils.nim");
			TMP2111 = subInt(((NI) (((NU8)(s[i_177502])))), 48);
		...
		case 97 ... 122:
		{
			...
			nimln(111, "rodutils.nim");
			nimln(111, "rodutils.nim");
			TMP2114 = subInt(((NI) (((NU8)(s[i_177502])))), 97);
		...
		case 65 ... 90:
		{
			...
			nimln(112, "rodutils.nim");
			nimln(112, "rodutils.nim");
			TMP2118 = subInt(((NI) (((NU8)(s[i_177502])))), 65);
		...
		case 128 ... 255:
		{
			...
			nimln(113, "rodutils.nim");
			nimln(113, "rodutils.nim");
			TMP2122 = subInt(((NI) (((NU8)(s[i_177502])))), 128);
	...
	nimln(116, "rodutils.nim");
	nimln(116, "rodutils.nim");
	TMP2125 = mulInt64(result, ((NI64) (sign_177504)));
