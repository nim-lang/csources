...
N_NIMCALL(void, handlecmdline_558607)(void) {
	...
	LA4: ;
	{
		processcmdline_552209(((NU8) 0), ((NimStringDesc*) &TMP1895));
		{
			TSafePoint TMP1896;
			TY118604 p;
			NimStringDesc* LOC15;
			...
			TMP1896.status = _setjmp(TMP1896.context);
			if (TMP1896.status == 0) {
		...
		LA7: ;
		loadconfigs_204811(((NimStringDesc*) &TMP1924));
		initvars_187817();
		processcmdline_552209(((NU8) 1), ((NimStringDesc*) &TMP1895));
		maincommand_555627();
		{
			NimStringDesc* LOC22;
			...
			if (!(gerrorcounter_182118 == 0)) goto LA25;
			{
				if (!((gglobaloptions_170128 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				{
					...
					LA37: ;
					{
						...
						NimStringDesc* LOC43;
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_170239, ((NimStringDesc*) &TMP4896));
						LOC42 = 0;
...
appendString(LOC44, arguments_195081);
					execexternalprogram_187929(LOC44, ((NimStringDesc*) &TMP1895));
				}
				goto LA31;
				LA33: ;
				{
					...
					LA49: ;
					{
						NimStringDesc* LOC52;
						LOC52 = 0;
						LOC52 = noschangeFileExt(gprojectfull_170239, ((NimStringDesc*) &TMP1895));
...
appendString(LOC53, arguments_195081);
					execexternalprogram_187929(LOC53, ((NimStringDesc*) &TMP1895));
				}
				LA31: ;
			}
			LA29: ;
