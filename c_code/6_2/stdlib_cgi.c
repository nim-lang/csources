...
Stringtableobj152608* gcookies_412702_79315961;
extern TNimType NTI152610; /* StringTableRef */
N_NIMCALL(void, T79315961_2)(void) {
	nimGCvisit((void*)gcookies_412702_79315961, 0);
}
...
N_NIMCALL(NimStringDesc*, encodeurl_412001_79315961)(NimStringDesc* s0) {
	...
	{
		NI i_412014_79315961;
		NI HEX3Atmp_412024_79315961;
		NI res_412027_79315961;
		i_412014_79315961 = (NI)0;
		HEX3Atmp_412024_79315961 = (NI)0;
		HEX3Atmp_412024_79315961 = (NI)((s0 ? s0->Sup.len : 0) - ((NI) 1));
		res_412027_79315961 = ((NI) 0);
		{
			while (1) {
				if (!(res_412027_79315961 <= HEX3Atmp_412024_79315961)) goto LA3;
				i_412014_79315961 = res_412027_79315961;
				switch (((NU8)(s0->data[i_412014_79315961]))) {
				case 97 ... 122:
				case 65 ... 90:
				case 48 ... 57:
				case 95:
				{
					result0 = addChar(result0, s0->data[i_412014_79315961]);
				}
				break;
				case 32:
				{
				...
				default:
				{
					...
					LOC7 = nsuToHex(((NI64) (((NU8)(s0->data[i_412014_79315961])))), ((NI) 2));
					result0 = resizeString(result0, LOC7->Sup.len + 0);
appendString(result0, LOC7);
				}
				break;
				}
				res_412027_79315961 += ((NI) 1);
			} LA3: ;
		}
	}
	return result0;
