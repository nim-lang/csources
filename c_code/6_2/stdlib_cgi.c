...
Stringtableobj140209* gcookies_355700;
...
N_NIMCALL(NimStringDesc*, encodeurl_355001)(NimStringDesc* s) {
	...
	result = rawNewString(((NI) ((NI)((s ? s->Sup.len : 0) + (NI)((NU64)((s ? s->Sup.len : 0)) >> (NU64)(((NI) 2)))))));
	{
		...
		i_355014 = 0;
		HEX3Atmp_355024 = 0;
		HEX3Atmp_355024 = (NI)((s ? s->Sup.len : 0) - ((NI) 1));
		res_355027 = ((NI) 0);
		{
			while (1) {
				if (!(res_355027 <= HEX3Atmp_355024)) goto LA3;
				i_355014 = res_355027;
				switch (((NU8)(s->data[i_355014]))) {
				case 97 ... 122:
				case 65 ... 90:
				case 48 ... 57:
				case 95:
				{
					result = addChar(result, s->data[i_355014]);
				}
				break;
				case 32:
				{
				...
				default:
				{
					...
					LOC7 = 0;
					LOC7 = nsuToHex(((NI64) (((NU8)(s->data[i_355014])))), ((NI) 2));
