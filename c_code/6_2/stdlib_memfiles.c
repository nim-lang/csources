...
N_NIMCALL(Memfile250202, open_250801)(NimStringDesc* filename, NU8 mode, NI mappedsize, NI offset, NI newfilesize) {
	...
	LA6: ;
	{
		...
		raiseoserror_120803(LOC20, ((NimStringDesc*) &TMP1568));
	}
	LA13: ;
	{
		if (!!((newfilesize == ((NI) -1)))) goto LA23;
		{
			...
			raiseoserror_120803(LOC35, ((NimStringDesc*) &TMP1568));
		}
		LA28: ;
	}
	LA23: ;
	...
	LA38: ;
	{
		...
		LA44: ;
		{
			...
			raiseoserror_120803(LOC52, ((NimStringDesc*) &TMP1568));
		}
		LA41: ;
	}
	LA36: ;
	...
	result.mem = mmap(NIM_NIL, result.size, LOC53, LOC59, result.handle, ((off_t) (offset)));
	{
		...
		raiseoserror_120803(LOC74, ((NimStringDesc*) &TMP1568));
	}
	LA67: ;
	return result;
}
...
N_NIMCALL(void, close_251243)(Memfile250202* f) {
	...
	{
		if (!error) goto LA11;
		raiseoserror_120803(lasterr, ((NimStringDesc*) &TMP1568));
	}
	LA11: ;
}
