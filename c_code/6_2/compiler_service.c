...
STRING_LITERAL(TMP2025, "run", 3);
STRING_LITERAL(TMP5273, "server.type", 11);
STRING_LITERAL(TMP5274, "stdin", 5);
STRING_LITERAL(TMP5275, "tcp", 3);
STRING_LITERAL(TMP5276, "quit", 4);
STRING_LITERAL(TMP5278, "server.port", 11);
STRING_LITERAL(TMP5279, "server.address", 14);
STRING_LITERAL(TMP5282, "\015\012", 2);
STRING_LITERAL(TMP5290, "Invalid server.type:", 20);
...
N_NIMCALL(void, processcmdline_530203)(NU8 pass, NimStringDesc* cmd) {
	...
	argscount = ((NI) 0);
	{
		while (1) {
			...
			{
				{
					if (!eqStrings(p.key, ((NimStringDesc*) &TMP1669))) goto LA7;
					p.key = copyString(((NimStringDesc*) &TMP1670));
					{
						NIM_BOOL LOC11;
						LOC11 = 0;
	...
	} LA1: ;
	{
		if (!(pass == ((NU8) 1))) goto LA23;
		{
			...
			LOC27 = !(eqStrings(LOC31, ((NimStringDesc*) &TMP2025)));
			LA30: ;
			if (!LOC27) goto LA32;
...
TMP1187[0].len = 2; TMP1187[0].kind = 2; TMP1187[0].sons = &TMP5259[0];
NTI530421.node = &TMP1187[0];
NTI530420.size = sizeof(TY530421*);
NTI530420.kind = 22;
NTI530420.base = (&NTI530421);
NTI530420.flags = 2;
NTI530420.marker = TMP5272;
}
