...
N_NIMCALL(void, intsetenlarge_182621)(tintset182047* t) {
	...
	n = (ttrunkseq182045*) newSeq((&NTI182045), (NI64)(TMP1951));
	i_182655 = 0;
...
N_NIMCALL(ttrunk182043*, intsetput_182696)(tintset182047* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_182058((NI64)(TMP1955), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
...
N_NIMCALL(NIM_BOOL, contains_182838)(tintset182047* s, NI key) {
	...
	nimln(97, "intsets.nim");
	t = intsetget_182213(s, (NI)((NU64)(key) >> (NU64)(9)));
...
N_NIMCALL(void, incl_182866)(tintset182047* s, NI key) {
	...
	nimln(106, "intsets.nim");
	t = intsetput_182696(s, (NI)((NU64)(key) >> (NU64)(9)));
...
N_NIMCALL(NimStringDesc*, HEX24_183322)(tintset182047* s) {
	...
	while (1) {
		...
		while (1) {
			...
			NI j_183336;
			nimln(169, "intsets.nim");
			if (!(i_183332 <= 7)) goto LA2;
			nimln(170, "intsets.nim");
			if ((NU)(i_183332) > (NU)(7)) raiseIndexError();
			...
			while (1) {
				...
				nimln(175, "intsets.nim");
				{
					...
					nimln(176, "intsets.nim");
					nimln(176, "intsets.nim");
					key_183327 = (NI)((NI)((NU64)((*r_183330).Key) << (NU64)(9)) | (NI)((NU64)((NI)((NU64)(i_183332) << (NU64)(6))) + (NU64)(j_183336)));
...
appendString(result, LOC12);
				...
				nimln(178, "intsets.nim");
				w_183334 = (NI)((NU64)(w_183334) >> (NU64)(1));
			} LA3: ;
