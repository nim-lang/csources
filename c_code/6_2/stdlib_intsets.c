...
N_NIMCALL(void, intsetenlarge_188621)(tintset188047* t) {
	...
	n = (ttrunkseq188045*) newSeq((&NTI188045), (NI64)(TMP1952));
	i_188655 = 0;
...
N_NIMCALL(ttrunk188043*, intsetput_188696)(tintset188047* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_188058((NI64)(TMP1956), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
...
TMP1953[0] = &TMP1939[1];
TMP1939[1].kind = 1;
TMP1939[1].offset = offsetof(ttrunk188043, Next);
TMP1939[1].typ = (&NTI188041);
TMP1939[1].name = "next";
TMP1953[1] = &TMP1939[2];
TMP1939[2].kind = 1;
TMP1939[2].offset = offsetof(ttrunk188043, Key);
TMP1939[2].typ = (&NTI106);
TMP1939[2].name = "key";
TMP1953[2] = &TMP1939[3];
TMP1939[3].kind = 1;
TMP1939[3].offset = offsetof(ttrunk188043, Bits);
TMP1939[3].typ = (&NTI23418);
TMP1939[3].name = "bits";
TMP1939[0].len = 3; TMP1939[0].kind = 2; TMP1939[0].sons = &TMP1953[0];
NTI188043.node = &TMP1939[0];
NTI188041.size = sizeof(ttrunk188043*);
NTI188041.kind = 22;
NTI188041.base = (&NTI188043);
NTI188041.marker = TMP1954;
NTI188045.size = sizeof(ttrunkseq188045*);
NTI188045.kind = 24;
NTI188045.base = (&NTI188041);
NTI188045.flags = 2;
NTI188045.marker = TMP1955;
...
TMP3247[0] = &TMP1939[5];
TMP1939[5].kind = 1;
TMP1939[5].offset = offsetof(tintset188047, Counter);
TMP1939[5].typ = (&NTI106);
TMP1939[5].name = "counter";
TMP3247[1] = &TMP1939[6];
TMP1939[6].kind = 1;
TMP1939[6].offset = offsetof(tintset188047, Max);
TMP1939[6].typ = (&NTI106);
TMP1939[6].name = "max";
TMP3247[2] = &TMP1939[7];
TMP1939[7].kind = 1;
TMP1939[7].offset = offsetof(tintset188047, Head);
TMP1939[7].typ = (&NTI188041);
TMP1939[7].name = "head";
TMP3247[3] = &TMP1939[8];
TMP1939[8].kind = 1;
TMP1939[8].offset = offsetof(tintset188047, Data);
TMP1939[8].typ = (&NTI188045);
TMP1939[8].name = "data";
TMP1939[4].len = 4; TMP1939[4].kind = 2; TMP1939[4].sons = &TMP3247[0];
NTI188047.node = &TMP1939[4];
}
