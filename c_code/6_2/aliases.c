...
N_NIMCALL(NU8, ispartofaux_416020)(tnode191813* n, ttype191847* b, tintset188047* marker) {
	...
	case ((NU8) 137):
	{
		...
		while (1) {
			...
			default:
			{
				...
				internalerror_168606(((NimStringDesc*) &TMP5623));
			}
			break;
			}
			nimln(1454, "system.nim");
	...
	default:
	{
		...
		internalerror_168591((*n).Info, ((NimStringDesc*) &TMP5626));
	}
	break;
	}
	BeforeRet: ;
