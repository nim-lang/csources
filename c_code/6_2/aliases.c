...
static NIM_CONST TY186025 TMP5616 = {
...
static NIM_CONST TY186025 TMP5623 = {
...
N_NIMCALL(NU8, ispartofaux_410020)(tnode185813* n, ttype185847* b, tintset182047* marker) {
	...
	case ((NU8) 137):
	{
		...
		while (1) {
			...
			default:
			{
				...
				internalerror_163606(((NimStringDesc*) &TMP5622));
			}
			break;
			}
			nimln(1453, "system.nim");
	...
	default:
	{
		...
		internalerror_163591((*n).Info, ((NimStringDesc*) &TMP5625));
	}
	break;
	}
	BeforeRet: ;
