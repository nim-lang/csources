...
static NIM_CONST TY192025 TMP3141 = {
...
N_NIMCALL(tsym191843*, getsyssym_246040)(NimStringDesc* name) {
	...
	if (!(((64 &(1<<(((*systemmodule_246017).Kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3117));
	nimln(39, "magicsys.nim");
	LOC1 = 0;
...
N_NIMCALL(void, setintlittype_246519)(tnode191813* result) {
	...
	default:
	{
		...
		internalerror_168591((*result).Info, ((NimStringDesc*) &TMP3143));
	}
	break;
	}
	popFrame();
