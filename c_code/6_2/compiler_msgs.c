...
N_NIMCALL(void, suggestwriteln_182187)(NimStringDesc* s) {
	{
		...
		LA7: ;
		{
			writelnhook_182169.ClEnv? writelnhook_182169.ClPrc(s, writelnhook_182169.ClEnv):((TMP1989)(writelnhook_182169.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, suggestquit_182446)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_182450).Sup.message; (*e_182450).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2707));
	if (LOC1) nimGCunrefNoCycle(LOC1);
