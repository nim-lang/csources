...
N_NIMCALL(void, loadfile_271045)(tlineinfo181340 info) {
	...
	LA3: ;
	{
		...
		gsourcefiles_271040->data[i].Isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP2720));
		{
		...
		pos = lex.Bufpos;
		{
			while (1) {
				...
				case 13:
				{
					NimStringDesc* LOC21;
					LOC21 = 0;
					LOC21 = gsourcefiles_271040->data[i].Newline; gsourcefiles_271040->data[i].Newline = copyStringRC1(((NimStringDesc*) &TMP2728));
				...
				case 0:
				{
					NimStringDesc* LOC23;
					LOC23 = 0;
					LOC23 = gsourcefiles_271040->data[i].Newline; gsourcefiles_271040->data[i].Newline = copyStringRC1(((NimStringDesc*) &TMP2729));
