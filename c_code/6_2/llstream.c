...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY121387 TMP1637 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY121387 TMP1638 = {
...
N_NIMCALL(NIM_BOOL, endswithopr_173646)(NimStringDesc* x) {
	...
	result = endswith_173602(x, TMP1637);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_173652)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_173602(line, TMP1638);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(void, llstreamwriteln_173274)(tllstream173204* s, NimStringDesc* data) {
	...
	llstreamwrite_173258(s, ((NimStringDesc*) &TMP1643));
	popFrame();
}
...
NTI173202.node = &TMP1628[6];
TMP1628[1].kind = 1;
TMP1628[1].offset = offsetof(tllstream173204, Kind);
TMP1628[1].typ = (&NTI173202);
TMP1628[1].name = "kind";
TMP1630[1] = &TMP1628[7];
TMP1628[7].kind = 1;
TMP1628[7].offset = offsetof(tllstream173204, F);
TMP1628[7].typ = (&NTI10004);
TMP1628[7].name = "f";
TMP1630[2] = &TMP1628[8];
TMP1628[8].kind = 1;
TMP1628[8].offset = offsetof(tllstream173204, S);
TMP1628[8].typ = (&NTI143);
TMP1628[8].name = "s";
TMP1630[3] = &TMP1628[9];
TMP1628[9].kind = 1;
TMP1628[9].offset = offsetof(tllstream173204, Rd);
TMP1628[9].typ = (&NTI106);
TMP1628[9].name = "rd";
TMP1630[4] = &TMP1628[10];
TMP1628[10].kind = 1;
TMP1628[10].offset = offsetof(tllstream173204, Wr);
TMP1628[10].typ = (&NTI106);
TMP1628[10].name = "wr";
TMP1630[5] = &TMP1628[11];
TMP1628[11].kind = 1;
TMP1628[11].offset = offsetof(tllstream173204, Lineoffset);
TMP1628[11].typ = (&NTI106);
TMP1628[11].name = "lineOffset";
TMP1628[0].len = 6; TMP1628[0].kind = 2; TMP1628[0].sons = &TMP1630[0];
NTI173204.node = &TMP1628[0];
NTI173206.size = sizeof(tllstream173204*);
NTI173206.kind = 22;
NTI173206.base = (&NTI173204);
NTI173206.marker = TMP1634;
}
