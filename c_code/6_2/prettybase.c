...
N_NIMCALL(void, loadfile_293045)(tlineinfo195539 info) {
	...
	LA3: ;
	{
		...
		gsourcefiles_293040->data[i].Isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP2686));
		{
		...
		pos = lex.Bufpos;
		{
			while (1) {
				...
				case 13:
				{
					NimStringDesc* LOC20;
					LOC20 = 0;
					LOC20 = gsourcefiles_293040->data[i].Newline; gsourcefiles_293040->data[i].Newline = copyStringRC1(((NimStringDesc*) &TMP2694));
				...
				case 0:
				{
					NimStringDesc* LOC22;
					LOC22 = 0;
					LOC22 = gsourcefiles_293040->data[i].Newline; gsourcefiles_293040->data[i].Newline = copyStringRC1(((NimStringDesc*) &TMP2695));
