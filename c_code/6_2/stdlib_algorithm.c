...
typedef N_CLOSURE_PTR(NI, TMP5103) (tsym191843* x_362870, tsym191843* y_362872);
...
typedef N_CLOSURE_PTR(NI, TMP5122) (tentry365566 x_366254, tentry365566 y_366256);
typedef N_CLOSURE_PTR(NI, TMP5123) (tentry365566 x_366254, tentry365566 y_366256);
struct  TNimObject  {
TNimType* m_type;
};
struct  tidobj170013  {
...
N_NIMCALL(void, merge_362843)(tsym191843** a_362851, NI a_362851Len0, tsym191843** b_362859, NI b_362859Len0, NI lo_362863, NI m_362865, NI hi_362867, TY362801 cmp_362875, NU8 order_362878) {
	...
	nimln(101, "algorithm.nim");
	{
		...
		nimln(101, "algorithm.nim");
		TMP5102 = addInt(m_362865, 1);
		if ((NU)((NI64)(TMP5102)) >= (NU)(a_362851Len0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp_362875.ClEnv? cmp_362875.ClPrc(a_362851[m_362865], a_362851[(NI64)(TMP5102)], cmp_362875.ClEnv):((TMP5103)(cmp_362875.ClPrc))(a_362851[m_362865], a_362851[(NI64)(TMP5102)]);
		LOC4 = 0;
	...
	while (1) {
		...
		nimln(118, "algorithm.nim");
		{
			...
			if ((NU)(j) >= (NU)(a_362851Len0)) raiseIndexError();
			LOC17 = 0;
			LOC17 = cmp_362875.ClEnv? cmp_362875.ClPrc(b_362859[i], a_362851[j], cmp_362875.ClEnv):((TMP5105)(cmp_362875.ClPrc))(b_362859[i], a_362851[j]);
			LOC18 = 0;
...
N_NIMCALL(void, sort_362782)(tsym191843** a_362790, NI a_362790Len0, TY362801 cmp_362800, NU8 order_362803) {
	...
	nimln(155, "algorithm.nim");
	TMP5099 = divInt(n, 2);
	b = (tsymseq191815*) newSeq((&NTI191815), (NI64)(TMP5099));
	...
	while (1) {
		...
		while (1) {
			...
			nimln(160, "algorithm.nim");
			TMP5108 = addInt(m, s);
			merge_362843(a_362790, a_362790Len0, b->data, b->Sup.len, (((NI64)(TMP5107) >= 0) ? (NI64)(TMP5107) : 0), m, (NI64)(TMP5108), cmp_362800, order_362803);
...
N_NIMCALL(void, merge_366227)(tentry365566* a_366235, NI a_366235Len0, tentry365566* b_366243, NI b_366243Len0, NI lo_366247, NI m_366249, NI hi_366251, TY366185 cmp_366259, NU8 order_366262) {
	...
	nimln(101, "algorithm.nim");
	{
		...
		nimln(101, "algorithm.nim");
		TMP5121 = addInt(m_366249, 1);
		if ((NU)((NI64)(TMP5121)) >= (NU)(a_366235Len0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp_366259.ClEnv? cmp_366259.ClPrc(a_366235[m_366249], a_366235[(NI64)(TMP5121)], cmp_366259.ClEnv):((TMP5122)(cmp_366259.ClPrc))(a_366235[m_366249], a_366235[(NI64)(TMP5121)]);
		LOC4 = 0;
	...
	while (1) {
		...
		nimln(118, "algorithm.nim");
		{
			...
			if ((NU)(j) >= (NU)(a_366235Len0)) raiseIndexError();
			LOC17 = 0;
			LOC17 = cmp_366259.ClEnv? cmp_366259.ClPrc(b_366243[i], a_366235[j], cmp_366259.ClEnv):((TMP5123)(cmp_366259.ClPrc))(b_366243[i], a_366235[j]);
			LOC18 = 0;
...
N_NIMCALL(void, sort_366166)(tentry365566* a_366174, NI a_366174Len0, TY366185 cmp_366184, NU8 order_366187) {
	...
	nimln(155, "algorithm.nim");
	TMP5118 = divInt(n, 2);
	b = (TY365573*) newSeq((&NTI365573), (NI64)(TMP5118));
	nimln(156, "algorithm.nim");
	s = 1;
	nimln(157, "algorithm.nim");
	while (1) {
		...
		while (1) {
			...
			nimln(160, "algorithm.nim");
			TMP5126 = addInt(m, s);
			merge_366227(a_366174, a_366174Len0, b->data, b->Sup.len, (((NI64)(TMP5125) >= 0) ? (NI64)(TMP5125) : 0), m, (NI64)(TMP5126), cmp_366184, order_366187);
			nimln(161, "algorithm.nim");
			nimln(161, "algorithm.nim");
			TMP5127 = mulInt(s, 2);
