...
extern tsocketimpl152605* stdoutsocket_166189;
	...
	while (1) {
		...
		case ((NU8) 3):
		{
			...
			nimln(43, "service.nim");
			{
				...
				key = copyStrLast(p.Key, 0, (NI64)(TMP7640));
				...
				LOC9 = 0;
				LOC9 = copyStr(p.Key, (NI64)(TMP7641));
...
appendString(LOC8, p.Val);
				...
				processswitch_175016(key, val, pass, gcmdlineinfo_166103);
			}
			goto LA4;
			LA6: ;
			{
				nimln(48, "service.nim");
				processswitch_175016(p.Key, p.Val, pass, gcmdlineinfo_166103);
			}
			LA4: ;
		}
		break;
...
N_NIMCALL(void, serve_528292)(TY528294 action) {
	...
	LA2: ;
	{
		...
		if (stdoutsocket_166189) nimGCunrefNoCycle(stdoutsocket_166189);
		stdoutsocket_166189 = (tsocketimpl152605*) newObjRC1((&NTI152607), sizeof(tsocketimpl152605));
		nimln(94, "service.nim");
		while (1) {
			NimStringDesc* LOC26;
			nimln(95, "service.nim");
			accept_156201(server, &stdoutsocket_166189);
			nimln(96, "service.nim");
			readline_161033(stdoutsocket_166189, &inp, -1);
			nimln(67, "service.nim");
			LOC26 = 0;
			...
			send_162604(stdoutsocket_166189, ((NimStringDesc*) &TMP7677));
			nimln(99, "service.nim");
			close_156266(stdoutsocket_166189);
		}
	}
	goto LA4;
	LA3: ;
