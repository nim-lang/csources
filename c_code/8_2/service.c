...
extern tsocketimpl147605* stdoutsocket_161189;
...
appendString(LOC8, p.Val);
				...
				processswitch_170016(key, val, pass, gcmdlineinfo_161103);
			}
			goto LA4;
			LA6: ;
			{
				nimln(48, "service.nim");
				processswitch_170016(p.Key, p.Val, pass, gcmdlineinfo_161103);
			}
			LA4: ;
		}
		break;
...
N_NIMCALL(void, serve_522292)(TY522294 action) {
	...
	LA2: ;
	{
		...
		if (stdoutsocket_161189) nimGCunrefNoCycle(stdoutsocket_161189);
		stdoutsocket_161189 = (tsocketimpl147605*) newObjRC1((&NTI147607), sizeof(tsocketimpl147605));
		nimln(94, "service.nim");
		while (1) {
			NimStringDesc* LOC26;
			nimln(95, "service.nim");
			accept_151201(server, &stdoutsocket_161189);
			nimln(96, "service.nim");
			readline_156033(stdoutsocket_161189, &inp, -1);
			nimln(67, "service.nim");
			LOC26 = 0;
			...
			send_157604(stdoutsocket_161189, ((NimStringDesc*) &TMP7682));
			nimln(99, "service.nim");
			close_151266(stdoutsocket_161189);
		}
	}
	goto LA4;
	LA3: ;
