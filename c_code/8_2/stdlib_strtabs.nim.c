...
N_LIB_PRIVATE N_NIMCALL(void, enlarge_cvA7ksxbnJWGPZwLRu9c1YQ)(tyObject_StringTableObj_V5PVrt9bIxZEeV7lfvqqtNg* t) {
	...
	n = (tySequence_xv3aaFd3JCw8NbmALHiezQ*) newSeq((&NTI_xv3aaFd3JCw8NbmALHiezQ_), ((NI)chckRange((NI)(TM_ZT9crccxweoChVXn9cHcxIXQ_12), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		NI i;
		NI colontmp_;
		NI T3_;
