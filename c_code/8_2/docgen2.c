...
NIM_CONST tpass243015 docgen2pass_519082 = {myopen_519057,
NIM_NIL,
processnode_519049,
close_519014}
;
...
N_NIMCALL(tnode184813*, close_519014)(tpasscontext243003* p, tnode184813* n) {
	...
	nimln(25, "docgen2.nim");
	{
		...
		nimln(26, "docgen2.nim");
		LOC7 = 0;
		LOC7 = tofilename_161780(((NI32)chckRange((*(*g).Module).Position, ((NI32) (-2147483647 -1)), ((NI32) 2147483647))));
...
N_NIMCALL(tpasscontext243003*, myopen_519057)(tsym184843* module) {
	...
	nimln(41, "docgen2.nim");
	LOC1 = 0;
	LOC1 = tofilename_161780(((NI32)chckRange((*module).Position, ((NI32) (-2147483647 -1)), ((NI32) 2147483647))));
