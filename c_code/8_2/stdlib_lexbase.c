...
N_NIMCALL(void, fillbuffer_281084)(tbaselexer281029* l);
...
N_NIMCALL(NI, fillbaselexer_281812)(tbaselexer281029* l, NI pos);
N_NIMCALL(NI, handlecr_281062)(tbaselexer281029* l, NI pos);
N_NIMCALL(NI, handlelf_281068)(tbaselexer281029* l, NI pos);
N_NIMCALL(void, skiputf8bom_282419)(tbaselexer281029* l);
...
N_NIMCALL(NimStringDesc*, getcurrentline_281052)(tbaselexer281029* l, NIM_BOOL marker);
...
NIM_CONST TY122387 newlines_281024 = {
...
N_NIMCALL(void, fillbuffer_281084)(tbaselexer281029* l) {
	...
	nimln(80, "lexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP3625)])), (NI64)(TMP3626));
	}
	LA11: ;
	...
	TMP3628 = mulInt((NI64)(TMP3627), 1);
	LOC13 = 0;
	LOC13 = readdata_124733((*l).Input, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP3628));
	...
	nimln(86, "lexbase.nim");
	{
		...
		if (!(charsread < (NI64)(TMP3631))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI64)(TMP3633);
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				TMP3634 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4631(((void*) ((*l).Buf)), (NI64)(TMP3634));
				...
				nimln(105, "lexbase.nim");
				{
					...
					if (!!(((NI64)(TMP3635) == oldbuflen))) goto LA35;
					nimln(105, "lexbase.nim");
				...
				LOC37 = 0;
				LOC37 = readdata_124733((*l).Input, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP3637));
				TMP3638 = divInt(LOC37, 1);
				charsread = (NI64)(TMP3638);
...
N_NIMCALL(void, open_281039)(tbaselexer281029* l, tstream124629* input, NI buflen) {
	...
	LOC9 = 0;
	LOC9 = alloc_4601((NI64)(TMP3648));
	(*l).Buf = ((NCSTRING) (LOC9));
	nimln(148, "lexbase.nim");
	nimln(148, "lexbase.nim");
	TMP3649 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP3649);
...
N_NIMCALL(NI, getcolnumber_281057)(tbaselexer281029* l, NI pos) {
	...
	if ((NI64)(TMP3650) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP3650));
	popFrame();
	return result;
}
...
appendString(result, ((NimStringDesc*) &TMP3652));
	nimln(165, "lexbase.nim");
	{
		...
		nimln(166, "lexbase.nim");
		LOC7 = 0;
		LOC7 = getcolnumber_281057(l, (*l).Bufpos);
		LOC8 = 0;
...
NTI281029.size = sizeof(tbaselexer281029);
NTI281029.kind = 17;
NTI281029.base = (&NTI2409);
TMP3761[0] = &TMP3619[1];
TMP3619[1].kind = 1;
TMP3619[1].offset = offsetof(tbaselexer281029, Bufpos);
TMP3619[1].typ = (&NTI106);
TMP3619[1].name = "bufpos";
TMP3761[1] = &TMP3619[2];
TMP3619[2].kind = 1;
TMP3619[2].offset = offsetof(tbaselexer281029, Buf);
TMP3619[2].typ = (&NTI145);
TMP3619[2].name = "buf";
TMP3761[2] = &TMP3619[3];
TMP3619[3].kind = 1;
TMP3619[3].offset = offsetof(tbaselexer281029, Buflen);
TMP3619[3].typ = (&NTI106);
TMP3619[3].name = "bufLen";
TMP3761[3] = &TMP3619[4];
TMP3619[4].kind = 1;
TMP3619[4].offset = offsetof(tbaselexer281029, Input);
TMP3619[4].typ = (&NTI124627);
TMP3619[4].name = "input";
TMP3761[4] = &TMP3619[5];
TMP3619[5].kind = 1;
TMP3619[5].offset = offsetof(tbaselexer281029, Linenumber);
TMP3619[5].typ = (&NTI106);
TMP3619[5].name = "lineNumber";
TMP3761[5] = &TMP3619[6];
TMP3619[6].kind = 1;
TMP3619[6].offset = offsetof(tbaselexer281029, Sentinel);
TMP3619[6].typ = (&NTI106);
TMP3619[6].name = "sentinel";
TMP3761[6] = &TMP3619[7];
TMP3619[7].kind = 1;
TMP3619[7].offset = offsetof(tbaselexer281029, Linestart);
TMP3619[7].typ = (&NTI106);
TMP3619[7].name = "lineStart";
TMP3761[7] = &TMP3619[8];
TMP3619[8].kind = 1;
TMP3619[8].offset = offsetof(tbaselexer281029, Fileopened);
TMP3619[8].typ = (&NTI134);
TMP3619[8].name = "fileOpened";
TMP3619[0].len = 8; TMP3619[0].kind = 2; TMP3619[0].sons = &TMP3761[0];
NTI281029.node = &TMP3619[0];
}
