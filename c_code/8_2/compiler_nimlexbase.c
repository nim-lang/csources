...
N_NIMCALL(void, fillbuffer_161072)(tbaselexer161018* l);
...
N_NIMCALL(NI, fillbaselexer_161812)(tbaselexer161018* l, NI pos);
N_NIMCALL(NI, handlecr_161050)(tbaselexer161018* l, NI pos);
N_NIMCALL(NI, handlelf_161056)(tbaselexer161018* l, NI pos);
N_NIMCALL(void, skiputf8bom_162413)(tbaselexer161018* l);
...
N_NIMCALL(NimStringDesc*, getcurrentline_161040)(tbaselexer161018* l, NIM_BOOL marker);
...
NIM_CONST TY112118 newlines_161014 = {
0x00, 0x24, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP1624, "L.sentinel < L.bufLen ", 22);
STRING_LITERAL(TMP1627, "0 <= toCopy ", 12);
STRING_LITERAL(TMP1635, "s < L.bufLen ", 13);
STRING_LITERAL(TMP1639, "L.bufLen - oldBufLen == oldBufLen ", 34);
STRING_LITERAL(TMP1645, "pos <= L.sentinel ", 18);
STRING_LITERAL(TMP1647, "L.buf[pos] == \'\\x0D\' ", 21);
STRING_LITERAL(TMP1648, "L.buf[pos] == \'\\x0A\' ", 21);
STRING_LITERAL(TMP1649, "0 < bufLen ", 11);
STRING_LITERAL(TMP1653, "", 0);
STRING_LITERAL(TMP1654, "\012", 1);
STRING_LITERAL(TMP1655, "^\012", 2);
extern TFrame* frameptr_12037;
extern TNimType NTI1009; /* TObject */
TNimType NTI161018; /* TBaseLexer */
extern TNimType NTI105; /* int */
extern TNimType NTI144; /* cstring */
extern TNimType NTI160206; /* PLLStream */
...
N_NIMCALL(void, closebaselexer_161035)(tbaselexer161018* l) {
	...
	llstreamclose_160238((*l).Stream);	popFrame();
}
static N_INLINE(NI, subInt)(NI a, NI b) {
	NI result;
	result = 0;
...
N_NIMCALL(void, fillbuffer_161072)(tbaselexer161018* l) {
	...
	nimln(85, "nimlexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP1628)])), (NI64)(TMP1629));	}	LA11: ;
	...
	TMP1631 = mulInt((NI64)(TMP1630), 1);
	LOC13 = 0;
	LOC13 = llstreamread_160242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP1631));
	TMP1632 = divInt(LOC13, 1);
	charsread = (NI64)(TMP1632);
	...
	nimln(91, "nimlexbase.nim");
	{
		...
		if (!(charsread < (NI64)(TMP1634))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI64)(TMP1636);
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				TMP1637 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4007(((void*) ((*l).Buf)), (NI64)(TMP1637));
				...
				nimln(110, "nimlexbase.nim");
				{
					...
					if (!!(((NI64)(TMP1638) == oldbuflen))) goto LA35;
					nimln(110, "nimlexbase.nim");
				...
				LOC37 = 0;
				LOC37 = llstreamread_160242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP1640));
				TMP1641 = divInt(LOC37, 1);
				charsread = (NI64)(TMP1641);
...
N_NIMCALL(NI, fillbaselexer_161812)(tbaselexer161018* l, NI pos) {
	...
	nimln(121, "nimlexbase.nim");
	{
		...
		nimln(122, "nimlexbase.nim");
		TMP1646 = addInt(pos, 1);
		result = (NI64)(TMP1646);
	}	goto LA5;
	LA7: ;
	{
		nimln(124, "nimlexbase.nim");
		fillbuffer_161072(l);		nimln(125, "nimlexbase.nim");
		(*l).Bufpos = 0;
...
N_NIMCALL(NI, handlelf_161056)(tbaselexer161018* l, NI pos) {
	...
	nimln(137, "nimlexbase.nim");
	{
		...
		nimln(137, "nimlexbase.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP1648));	}	LA3: ;
...
N_NIMCALL(void, openbaselexer_161027)(tbaselexer161018* l, tllstream160204* inputstream, NI buflen) {
	...
	nimln(147, "nimlexbase.nim");
	{
		...
		nimln(147, "nimlexbase.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP1649));	}	LA3: ;
	...
	nimln(150, "nimlexbase.nim");
	nimln(150, "nimlexbase.nim");
	TMP1650 = mulInt(buflen, 1);
	LOC5 = 0;
	LOC5 = alloc_4001((NI64)(TMP1650));
	(*l).Buf = ((NCSTRING) (LOC5));
	nimln(151, "nimlexbase.nim");
	nimln(151, "nimlexbase.nim");
	TMP1651 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP1651);
	...
	fillbuffer_161072(l);	nimln(156, "nimlexbase.nim");
	skiputf8bom_162413(l);	popFrame();
}
N_NIMCALL(NI, getcolnumber_161045)(tbaselexer161018* l, NI pos) {
	NI result;
	NI TMP1652;
	...
	nimln(159, "nimlexbase.nim");
	nimln(159, "nimlexbase.nim");
	TMP1652 = subInt(pos, (*l).Linestart);
	if ((NI64)(TMP1652) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP1652));
	popFrame();
	return result;
}
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src) {
...
appendString(result, ((NimStringDesc*) &TMP1654));
	nimln(168, "nimlexbase.nim");
	{
		...
		nimln(169, "nimlexbase.nim");
		LOC7 = 0;
		LOC7 = getcolnumber_161045(l, (*l).Bufpos);
		LOC8 = 0;
...
static TNimNode* TMP1893[7];
static TNimNode TMP1599[8];
NTI161018.size = sizeof(tbaselexer161018);
NTI161018.kind = 17;
NTI161018.base = (&NTI1009);
NTI161018.flags = 2;
TMP1893[0] = &TMP1599[1];
TMP1599[1].kind = 1;
TMP1599[1].offset = offsetof(tbaselexer161018, Bufpos);
TMP1599[1].typ = (&NTI105);
TMP1599[1].name = "bufpos";
TMP1893[1] = &TMP1599[2];
TMP1599[2].kind = 1;
TMP1599[2].offset = offsetof(tbaselexer161018, Buf);
TMP1599[2].typ = (&NTI144);
TMP1599[2].name = "buf";
TMP1893[2] = &TMP1599[3];
TMP1599[3].kind = 1;
TMP1599[3].offset = offsetof(tbaselexer161018, Buflen);
TMP1599[3].typ = (&NTI105);
TMP1599[3].name = "bufLen";
TMP1893[3] = &TMP1599[4];
TMP1599[4].kind = 1;
TMP1599[4].offset = offsetof(tbaselexer161018, Stream);
TMP1599[4].typ = (&NTI160206);
TMP1599[4].name = "stream";
TMP1893[4] = &TMP1599[5];
TMP1599[5].kind = 1;
TMP1599[5].offset = offsetof(tbaselexer161018, Linenumber);
TMP1599[5].typ = (&NTI105);
TMP1599[5].name = "LineNumber";
TMP1893[5] = &TMP1599[6];
TMP1599[6].kind = 1;
TMP1599[6].offset = offsetof(tbaselexer161018, Sentinel);
TMP1599[6].typ = (&NTI105);
TMP1599[6].name = "sentinel";
TMP1893[6] = &TMP1599[7];
TMP1599[7].kind = 1;
TMP1599[7].offset = offsetof(tbaselexer161018, Linestart);
TMP1599[7].typ = (&NTI105);
TMP1599[7].name = "lineStart";
TMP1599[0].len = 7; TMP1599[0].kind = 2; TMP1599[0].sons = &TMP1893[0];
NTI161018.node = &TMP1599[0];
}
