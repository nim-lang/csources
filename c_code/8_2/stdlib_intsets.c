...
N_NIMCALL(void, intsetenlarge_220614)(intset220056* t) {
	...
	n = (ttrunkseq220054*) newSeq((&NTI220054), (NI64)((*t).Max + 1));
	{
		NI i_220648;
		NI res_220686;
		i_220648 = 0;
...
N_NIMCALL(ttrunk220052*, intsetput_220703)(intset220056* t, NI key) {
	...
	}
	{
		NIM_BOOL LOC9;
		LOC9 = 0;
		LOC9 = mustrehash_220073((NI64)((*t).Max + 1), (*t).Counter);
		if (!LOC9) goto LA10;
...
N_NIMCALL(void, incl_220869)(intset220056* s, NI key) {
	ttrunk220052* t;
	NI u;
	t = intsetput_220703(s, (NI)((NU64)(key) >> (NU64)(9)));
	u = (NI)(key & 511);
...
N_NIMCALL(NIM_BOOL, containsorincl_220916)(intset220056* s, NI key) {
	...
	ttrunk220052* t;
	result = 0;
	t = intsetget_220220(&(*s), (NI)((NU64)(key) >> (NU64)(9)));
	{
		NI u;
