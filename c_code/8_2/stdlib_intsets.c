...
static N_INLINE(NIM_BOOL, mustrehash_181058)(NI length, NI counter) {
	...
	LOC5 = ((NI64)(TMP1941) < (NI64)(TMP1942));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
...
static N_INLINE(NI, nexttry_181206)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1944 = mulInt(5, h);
	TMP1945 = addInt((NI64)(TMP1944), 1);
	result = (NI)((NI64)(TMP1945) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, intsetenlarge_181621)(tintset181047* t) {
	...
	TMP1949 = mulInt((NI64)(TMP1948), 2);
	TMP1950 = subInt((NI64)(TMP1949), 1);
	(*t).Max = (NI64)(TMP1950);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1951 = addInt((*t).Max, 1);
	n = (ttrunkseq181045*) newSeq((&NTI181045), (NI64)(TMP1951));
	i_181655 = 0;
...
N_NIMCALL(ttrunk181043*, intsetput_181696)(tintset181047* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_181058((NI64)(TMP1955), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
...
N_NIMCALL(NIM_BOOL, contains_181838)(tintset181047* s, NI key) {
	...
	nimln(97, "intsets.nim");
	t = intsetget_181213(s, (NI)((NU64)(key) >> (NU64)(9)));
...
N_NIMCALL(void, incl_181866)(tintset181047* s, NI key) {
	...
	nimln(106, "intsets.nim");
	t = intsetput_181696(s, (NI)((NU64)(key) >> (NU64)(9)));
...
N_NIMCALL(NimStringDesc*, HEX24_182322)(tintset181047* s) {
	...
	while (1) {
		...
		while (1) {
			...
			NI j_182336;
			nimln(169, "intsets.nim");
			if (!(i_182332 <= 7)) goto LA2;
			nimln(170, "intsets.nim");
			if ((NU)(i_182332) > (NU)(7)) raiseIndexError();
			...
			while (1) {
				...
				nimln(175, "intsets.nim");
				{
					...
					nimln(176, "intsets.nim");
					nimln(176, "intsets.nim");
					key_182327 = (NI)((NI)((NU64)((*r_182330).Key) << (NU64)(9)) | (NI)((NU64)((NI)((NU64)(i_182332) << (NU64)(6))) + (NU64)(j_182336)));
...
appendString(result, LOC12);
				...
				nimln(178, "intsets.nim");
				w_182334 = (NI)((NU64)(w_182334) >> (NU64)(1));
			} LA3: ;
