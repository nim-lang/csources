...
N_NIMCALL(void, handlecmdline_534603)(void) {
	...
	{
		nimln(39, "nimrod.nim");
		processcmdline_528207(((NU8) 0), ((NimStringDesc*) &TMP7782));
		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP7783;
			TY108700 p;
		...
		initvars_171714();
		nimln(54, "nimrod.nim");
		processcmdline_528207(((NU8) 1), ((NimStringDesc*) &TMP7782));
		nimln(55, "nimrod.nim");
		maincommand_532011();
		nimln(56, "nimrod.nim");
		{
		...
		{
			nimln(58, "nimrod.nim");
			if (!(gerrorcounter_166179 == 0)) goto LA25;
			nimln(62, "nimrod.nim");
			{
				nimln(62, "nimrod.nim");
				...
				nimln(63, "nimrod.nim");
				{
					...
					nimln(65, "nimrod.nim");
					{
						...
						nimln(66, "nimrod.nim");
						LOC39 = 0;
						LOC39 = prependcurdir_534401(outfile_137117);
...
appendString(LOC44, arguments_528205);
				...
				LA33: ;
				{
					...
					nimln(73, "nimrod.nim");
					{
						...
						nimln(75, "nimrod.nim");
						binpath = prependcurdir_534401(outfile_137117);
					}
					goto LA46;
					LA48: ;
					{
...
N_NOINLINE(void, nimrodInit)(void) {
	...
	nimln(92, "nimrod.nim");
	nimln(92, "nimrod.nim");
	exit(((NI) (((NI8) ((0 < gerrorcounter_166179))))));
	popFrame();
}
