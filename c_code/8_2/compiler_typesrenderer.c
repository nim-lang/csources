...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, renderPlainSymbolName_g8MdfB9aQ9cSB3KYEfnCiLug)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 53):
	{
		...
		result = renderPlainSymbolName_g8MdfB9aQ9cSB3KYEfnCiLug((*n)._Ukind.S6.sons->data[(NI)(T2_ - ((NI) 1))]);
	}
	break;
	...
	{
		result = renderDefinitionName_N2R2wpSvkL9a4PMNBxn4NDg((*n)._Ukind.S4.sym, NIM_TRUE);
	}
	break;
	case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 43):
	{
		result = renderPlainSymbolName_g8MdfB9aQ9cSB3KYEfnCiLug((*n)._Ukind.S6.sons->data[((NI) 0)]);
	}
	break;
	default:
	{
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, renderType_0mm4u02iK86TVZPOApjzQA)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 3):
	{
		result = typeToString_QlvraUan7WbHowhAbvDvdA((*(*n)._Ukind.S4.sym).typ, ((tyEnum_TPreferedDesc_tnd4qt9c4xddV8oKV5zyusw) 0));
	}
	break;
	...
	{
		{
			...
			result = renderType_0mm4u02iK86TVZPOApjzQA((*n)._Ukind.S6.sons->data[((NI) 0)]);
		}
		goto LA4_;
		LA7_: ;
		{
	...
	{
		{
			...
			T17_ = renderType_0mm4u02iK86TVZPOApjzQA((*n)._Ukind.S6.sons->data[((NI) 0)]);
	...
	{
		{
			...
			T26_ = renderType_0mm4u02iK86TVZPOApjzQA((*n)._Ukind.S6.sons->data[((NI) 0)]);
	...
	{
		{
			...
			params = (*n)._Ukind.S6.sons->data[((NI) 0)];
			result = copyString(((NimStringDesc*) &TM_SgHDIVcSir4dkKoe0Xsi0A_7));
			{
				...
				i_2 = ((NI) 1);
				{
					while (1) {
						...
						T38_ = renderType_0mm4u02iK86TVZPOApjzQA((*params)._Ukind.S6.sons->data[i]);
...
appendString(result, T37_);
	...
	case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 35):
	{
		...
		T41_ = (NI)0;
		T41_ = len_CdME9baJhvveuPEDZE9bXoxAsigmatch(n);
		typePos = (NI)(T41_ - ((NI) 2));
		typeStr = renderType_0mm4u02iK86TVZPOApjzQA((*n)._Ukind.S6.sons->data[typePos]);
		...
		result = copyString(((NimStringDesc*) &TM_SgHDIVcSir4dkKoe0Xsi0A_9));
		{
			...
			i_6 = ((NI) 0);
			{
				while (1) {
					...
					T51_ = renderType_0mm4u02iK86TVZPOApjzQA((*n)._Ukind.S6.sons->data[i_5]);
...
appendString(result, T50_);
	...
	case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 42):
	{
		...
		T54_ = renderType_0mm4u02iK86TVZPOApjzQA((*n)._Ukind.S6.sons->data[((NI) 0)]);
		...
		result = T53_;
		{
			...
			i_8 = ((NI) 1);
			{
				while (1) {
					...
					T59_ = renderType_0mm4u02iK86TVZPOApjzQA((*n)._Ukind.S6.sons->data[i_7]);
...
{	switch ((*n).kind) {
	...
	{
		{
			...
			i_2 = ((NI) 1);
			{
				while (1) {
					...
					i = i_2;
					renderParamTypes_nsr8uxcmlhx5QS6xeTtlLA(found, (*n)._Ukind.S6.sons->data[i]);
					i_2 += ((NI) 1);
				} LA4: ;
			}
		}
	...
	case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 35):
	{
		...
		typeStr = renderType_0mm4u02iK86TVZPOApjzQA((*n)._Ukind.S6.sons->data[typePos]);
		{
			...
			if (!(T9_)) goto LA10_;
			T9_ = !(((*(*n)._Ukind.S6.sons->data[(NI)(typePos + ((NI) 1))]).kind == ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 1)));
			LA10_: ;
			if (!T9_) goto LA11_;
			typ = (*(*n)._Ukind.S6.sons->data[(NI)(typePos + ((NI) 1))]).typ;
			{
				if (!!((typ == 0))) goto LA15_;
		...
		LA11_: ;
		{
			...
			i_4 = ((NI) 0);
			{
				while (1) {
					...
					i_3 = i_4;
					unsureAsgnRef((void**) (&(*found)), (tySequence_sM4lkSb7zS6F7OVMvW9cffQ*) incrSeqV3(&((*found))->Sup, (&NTI_sM4lkSb7zS6F7OVMvW9cffQ_)));
					T24_ = (*found)->Sup.len++;
					T25_ = (NimStringDesc*)0;
