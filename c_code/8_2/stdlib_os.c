...
N_NIMCALL(NimStringDesc*, getapplheuristic_124201)(void);
...
N_NIMCALL(void, nossplitPath)(NimStringDesc* path, keyvaluepair131008* Result) {
	...
	seppos = -1;
	{
		...
		i_117331 = 0;
		HEX3Atmp_117347 = 0;
		HEX3Atmp_117347 = (NI64)(path->Sup.len - 1);
...
N_NIMCALL(NI, searchextpos_117551)(NimStringDesc* s) {
	...
	result = -1;
	{
		...
		i_117566 = 0;
		HEX3Atmp_117582 = 0;
		HEX3Atmp_117582 = (NI64)(s->Sup.len - 1);
...
N_NIMCALL(void, nossplitFile)(NimStringDesc* path, TY117604* Result) {
	...
	LA5: ;
	{
		...
		dotpos = path->Sup.len;
		{
			...
			i_117637 = 0;
			HEX3Atmp_117668 = 0;
			HEX3Atmp_117668 = (NI64)(path->Sup.len - 1);
				...
				while (1) {
					...
					i_117637 = res_117671;
					{
						if (!((NU8)(path->data[i_117637]) == (NU8)(46))) goto LA13;
						{
							...
							LOC17 = LOC18;
							if (!(LOC17)) goto LA20;
							LOC17 = !((((NU8)(path->data[(NI64)(i_117637 - 1)])) == ((NU8)(47)) || ((NU8)(path->data[(NI64)(i_117637 - 1)])) == ((NU8)(47))));
							LA20: ;
							if (!LOC17) goto LA21;
							dotpos = i_117637;
						}
...
{	result = 0;
	i = findenvvar_120405(key);
	{
		...
		result = copyStr(environment_119809->data[i], (NI64)(LOC5 + 1));
		goto BeforeRet;
	}
	goto LA1;
	LA3: ;
		...
		if (!LOC3) goto LA5;
		{
			...
			last_124415 = 0;
			{
				while (1) {
					...
					{
						NimStringDesc* x;
						if (!(first_124417 <= (NI64)(last_124415 - 1))) goto LA18;
						p_124403 = copyStrLast(HEX3Atmp_124410, first_124417, (NI64)(last_124415 - 1));
...
N_NIMCALL(NimStringDesc*, nosgetAppFilename)(void) {
	...
	result = getenv_120442(((NimStringDesc*) &TMP1078));
	{
		...
		result = getapplheuristic_124201();
	}
	LA3: ;
	return result;
}
...
{	result = 0;
	...
	LA5: ;
	{
		...
		i_117396 = 0;
		HEX3Atmp_117412 = 0;
		HEX3Atmp_117412 = (NI64)(path->Sup.len - q);
...
N_NIMCALL(void, noscreateDir)(NimStringDesc* dir) {
	...
	omitnext = NIM_FALSE;
	{
		...
		i_122011 = 0;
		HEX3Atmp_122027 = 0;
		HEX3Atmp_122027 = (NI64)(dir->Sup.len - 1);
		res_122030 = 1;
		{
			while (1) {
				...
				i_122011 = res_122030;
				{
					...
					LA10: ;
					{
						NimStringDesc* LOC13;
						LOC13 = 0;
						LOC13 = copyStrLast(dir, 0, (NI64)(i_122011 - 1));
...
N_NIMCALL(NimStringDesc*, expandtilde_125446)(NimStringDesc* path) {
	...
	result = 0;
	{
		...
		LOC13 = 0;
		LOC13 = HEX5BHEX5D_84970(path, LOC12);
		...
		last_125422 = 0;
		{
			if (!(0 < path->Sup.len)) goto LA9;
			{
				while (1) {
					...
					candidate_125415 = copyStrLast(path, first_125424, (NI64)(last_125422 - 1));
