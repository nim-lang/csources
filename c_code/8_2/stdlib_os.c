...
N_NIMCALL(void, nossplitPath)(NimStringDesc* path, keyvaluepair130008* Result) {
	...
	seppos = -1;
	{
		...
		i_115931 = 0;
		HEX3Atmp_115947 = 0;
		HEX3Atmp_115947 = (NI64)(path->Sup.len - 1);
...
N_NIMCALL(NI, searchextpos_116151)(NimStringDesc* s) {
	...
	result = -1;
	{
		...
		i_116166 = 0;
		HEX3Atmp_116182 = 0;
		HEX3Atmp_116182 = (NI64)(s->Sup.len - 1);
...
N_NIMCALL(void, nossplitFile)(NimStringDesc* path, TY116204* Result) {
	...
	LA5: ;
	{
		...
		dotpos = path->Sup.len;
		{
			...
			i_116237 = 0;
			HEX3Atmp_116268 = 0;
			HEX3Atmp_116268 = (NI64)(path->Sup.len - 1);
				...
				while (1) {
					...
					i_116237 = res_116271;
					{
						if (!((NU8)(path->data[i_116237]) == (NU8)(46))) goto LA13;
						{
							...
							LOC17 = LOC18;
							if (!(LOC17)) goto LA20;
							LOC17 = !((((NU8)(path->data[(NI64)(i_116237 - 1)])) == ((NU8)(47)) || ((NU8)(path->data[(NI64)(i_116237 - 1)])) == ((NU8)(47))));
							LA20: ;
							if (!LOC17) goto LA21;
							dotpos = i_116237;
						}
...
N_NIMCALL(NimStringDesc*, getenv_119042)(NimStringDesc* key) {
	...
	i = findenvvar_119005(key);
	{
		...
		result = copyStr(environment_118409->data[i], (NI64)(LOC5 + 1));
		goto BeforeRet;
	}
	goto LA1;
	LA3: ;
		...
		if (!LOC3) goto LA5;
		{
			...
			last_123015 = 0;
			{
				while (1) {
					...
					{
						NimStringDesc* x;
						if (!(first_123017 <= (NI64)(last_123015 - 1))) goto LA18;
						p_123003 = copyStrLast(HEX3Atmp_123010, first_123017, (NI64)(last_123015 - 1));
...
N_NIMCALL(NI, parentdirpos_115966)(NimStringDesc* path) {
	...
	LA3: ;
	{
		...
		i_115996 = 0;
		HEX3Atmp_116012 = 0;
		HEX3Atmp_116012 = (NI64)(path->Sup.len - q);
...
N_NIMCALL(void, noscreateDir)(NimStringDesc* dir) {
	...
	omitnext = NIM_FALSE;
	{
		...
		i_120611 = 0;
		HEX3Atmp_120627 = 0;
		HEX3Atmp_120627 = (NI64)(dir->Sup.len - 1);
		res_120630 = 1;
		{
			while (1) {
				...
				i_120611 = res_120630;
				{
					...
					LA10: ;
					{
						NimStringDesc* LOC13;
						LOC13 = 0;
						LOC13 = copyStrLast(dir, 0, (NI64)(i_120611 - 1));
