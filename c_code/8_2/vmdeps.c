...
N_NIMCALL(NimStringDesc*, readoutput_393006)(tprocess126402* p);
...
N_NIMCALL(NimStringDesc*, opslurp_393022)(NimStringDesc* file, tlineinfo165527 info, tsym190843* module) {
	...
	if (TMP5463.status == 0) {
		...
		nimln(33, "vmdeps.nim");
		LOC3[0] = newstrnode_191095(((NU8) 20), filename);
		asgnRefNoCycle((void**) &LOC2->data[0], LOC3[0]);
		LOC4 = 0;
		LOC4 = newnode_193003(((NU8) 120), info, LOC2, NIM_NIL);
		appendtomodule_191832(module, LOC4);
		popSafePoint();
	}
	else {
		popSafePoint();
		...
		if (isObj(getCurrentException()->Sup.m_type, (&NTI2433))) {
			TMP5463.status = 0;
			nimln(35, "vmdeps.nim");
			localerror_167571(info, ((NU16) 3), file);
			nimln(36, "vmdeps.nim");
			result = copyString(((NimStringDesc*) &TMP5462));
			popCurrentException();
		}
