...
N_NIMCALL(NI, nodetablerawget_262160)(Tnodetable214852 t, NI k, Tnode214790* key);
N_NIMCALL(NIM_BOOL, treesequivalent_262077)(Tnode214790* a, Tnode214790* b);
...
N_NIMCALL(void, nodetablerawinsert_262190)(Tnodepairseq214850** data, NI k, Tnode214790* key, NI val);
	...
	{
		{
			...
			HEX3Atmp_262070 = (NI)(LOC30 - ((NI) 1));
			res_262073 = ((NI) 0);
			{
				while (1) {
					NI LOC33;
					if (!(res_262073 <= HEX3Atmp_262070)) goto LA32;
					i_262062 = res_262073;
					LOC33 = 0;
		...
		{
			{
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					HEX3Atmp_262153 = (NI)(LOC26 - ((NI) 1));
					res_262156 = ((NI) 0);
					{
						while (1) {
							if (!(res_262156 <= HEX3Atmp_262153)) goto LA28;
							i_262149 = res_262156;
							{
								NIM_BOOL LOC31;
								LOC31 = 0;
								LOC31 = treesequivalent_262077((*a).kindU.S6.sons->data[i_262149], (*b).kindU.S6.sons->data[i_262149]);
								if (!!(LOC31)) goto LA32;
								goto BeforeRet;
							}
							LA32: ;
	...
	h = (NI)(k & (t.data ? (t.data->Sup.len-1) : -1));
	{
		while (1) {
			if (!!((t.data->data[h].key == NIM_NIL))) goto LA2;
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = treesequivalent_262077(t.data->data[h].key, key);
				LA6: ;
				if (!LOC5) goto LA7;
				result = h;
				goto BeforeRet;
...
N_NIMCALL(NI, nodetabletestorset_262682)(Tnodetable214852* t, Tnode214790* key, NI val) {
	...
	index = nodetablerawget_262160((*t), k, key);
	{
	...
	LA3: ;
	{
				...
				res_262878 = ((NI) 0);
				{
					while (1) {
						...
						i_262838 = res_262878;
						{
							...
							nodetablerawinsert_262190((&n), (*t).data->data[i_262838].h, (*t).data->data[i_262838].key, (*t).data->data[i_262838].val);
						}
						LA16: ;
						res_262878 += ((NI) 1);
					} LA13: ;
		...
		LA9: ;
		nodetablerawinsert_262190((&(*t).data), k, key, val);
		result = val;
		(*t).counter += ((NI) 1);
	}
	LA1: ;
