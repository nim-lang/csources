...
N_NIMCALL(NI, nodetablerawget_264227)(tnodetable208878 t, NI k, tnode208818* key);
N_NIMCALL(NIM_BOOL, treesequivalent_264115)(tnode208818* a, tnode208818* b);
...
N_NIMCALL(void, nodetablerawinsert_264280)(tnodepairseq208876** data, NI k, tnode208818* key, NI val);
	...
	{
		{
			...
			HEX3Atmp_264095 = (NI64)(LOC30 - 1);
			res_264098 = 0;
			{
				while (1) {
					NI LOC33;
					if (!(res_264098 <= HEX3Atmp_264095)) goto LA32;
					i_264087 = res_264098;
					LOC33 = 0;
		...
		{
			{
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					HEX3Atmp_264207 = (NI64)(LOC26 - 1);
					res_264210 = 0;
					{
						while (1) {
							if (!(res_264210 <= HEX3Atmp_264207)) goto LA28;
							i_264203 = res_264210;
							{
								NIM_BOOL LOC31;
								LOC31 = 0;
								LOC31 = treesequivalent_264115((*a).kindU.S6.Sons->data[i_264203], (*b).kindU.S6.Sons->data[i_264203]);
								if (!!(LOC31)) goto LA32;
								goto BeforeRet;
							}
							LA32: ;
	...
	h = (NI)(k & (t.Data->Sup.len-1));
	{
		while (1) {
			if (!!((t.Data->data[h].Key == NIM_NIL))) goto LA2;
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = treesequivalent_264115(t.Data->data[h].Key, key);
				LA6: ;
				if (!LOC5) goto LA7;
				result = h;
				goto BeforeRet;
...
N_NIMCALL(NI, nodetabletestorset_264721)(tnodetable208878* t, tnode208818* key, NI val) {
	...
	index = nodetablerawget_264227((*t), k, key);
	{
		if (!(0 <= index)) goto LA3;
	...
	{
		{
			...
			if (!LOC8) goto LA9;
			n = (tnodepairseq208876*) newSeq((&NTI208876), (NI64)((*t).Data->Sup.len * 2));
			{
				NI i_264851;
				NI HEX3Atmp_264901;
				NI res_264904;
				...
				res_264904 = 0;
				{
					while (1) {
						...
						i_264851 = res_264904;
						{
							...
							nodetablerawinsert_264280((&n), (*t).Data->data[i_264851].H, (*t).Data->data[i_264851].Key, (*t).Data->data[i_264851].Val);
						}
						LA16: ;
						res_264904 += 1;
					} LA13: ;
		...
		LA9: ;
		nodetablerawinsert_264280((&(*t).Data), k, key, val);
		result = val;
		(*t).Counter += 1;
	}
	LA1: ;
