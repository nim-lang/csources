...
N_NIMCALL(void, setintlittype_245519)(tnode190813* result);
...
N_NIMCALL(ttype190847*, getintlittype_245378)(tnode190813* literal) {
	...
	nimln(106, "magicsys.nim");
	{
		...
		result = inttypecache_245289[(((NI) (value)))- -5];
		nimln(108, "magicsys.nim");
		{
			...
			if (((NI) (value)) < -5 || ((NI) (value)) > 64) raiseIndexError();
			asgnRefNoCycle((void**) &inttypecache_245289[(((NI) (value)))- -5], result);
		}
		LA9: ;
	}
	goto LA1;
