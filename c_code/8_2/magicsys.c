...
N_NIMCALL(void, setintlittype_239519)(tnode184813* result);
...
N_NIMCALL(ttype184847*, getintlittype_239378)(tnode184813* literal) {
	...
	nimln(106, "magicsys.nim");
	{
		...
		result = inttypecache_239289[(((NI) (value)))- -5];
		nimln(108, "magicsys.nim");
		{
			...
			if (((NI) (value)) < -5 || ((NI) (value)) > 64) raiseIndexError();
			asgnRefNoCycle((void**) &inttypecache_239289[(((NI) (value)))- -5], result);
		}
		LA9: ;
	}
	goto LA1;
