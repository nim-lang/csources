...
N_NIMCALL(NI, cmpexact_184200)(NCSTRING a, NCSTRING b, NI blen);
...
NI wordcounter_184264;
tident184021* idanon_184504;
...
tident184021* iddelegator_184559;
...
{	result = 0;
	...
	id = 0;
	{
		while (1) {
			if (!!((result == NIM_NIL))) goto LA2;
			{
				NI LOC5;
				LOC5 = 0;
				LOC5 = cmpexact_184200((*result).S->data, identifier, length);
				if (!(LOC5 == 0)) goto LA6;
				{
	...
	asgnRefNoCycle((void**) (&(*result).S), mnewString(length));
	{
		...
		i_184429 = 0;
		HEX3Atmp_184446 = 0;
		HEX3Atmp_184446 = (NI64)(length - 1);
		res_184449 = 0;
		{
			while (1) {
				if (!(res_184449 <= HEX3Atmp_184446)) goto LA18;
				i_184429 = res_184449;
				(*result).S->data[i_184429] = identifier[i_184429];
				res_184449 += 1;
			} LA18: ;
		}
	}
	...
	{
		if (!(id == 0)) goto LA21;
		wordcounter_184264 += 1;
		(*result).Sup.Id = ((NI64)-(wordcounter_184264));
	}
	goto LA19;
	LA21: ;
	{
...
N_NIMCALL(tident184021*, getident_184472)(NimStringDesc* identifier) {
	...
	result = getident_184268(identifier->data, identifier->Sup.len, LOC1);
	return result;
}
...
N_NIMCALL(tident184021*, getident_184482)(NimStringDesc* identifier, NI h) {
	tident184021* result;
	result = 0;
	result = getident_184268(identifier->data, identifier->Sup.len, h);
	return result;
}
N_NIMCALL(void, TMP827)(void* p, NI op) {
	tidobj184015* a;
...
NIM_EXTERNC N_NOINLINE(void, compiler_identsInit)(void) {
	...
	wordcounter_184264 = 1;
	asgnRefNoCycle((void**) (&idanon_184504), getident_184472(((NimStringDesc*) &TMP441)));
	asgnRefNoCycle((void**) (&iddelegator_184559), getident_184472(((NimStringDesc*) &TMP442)));
}
...
NTI184015.flags = 1;
TMP437[0].kind = 1;
TMP437[0].offset = offsetof(tidobj184015, Id);
TMP437[0].typ = (&NTI108);
TMP437[0].name = "id";
NTI184015.node = &TMP437[0];
...
TMP439[0] = &TMP437[2];
TMP437[2].kind = 1;
TMP437[2].offset = offsetof(tident184021, S);
TMP437[2].typ = (&NTI149);
TMP437[2].name = "s";
TMP439[1] = &TMP437[3];
TMP437[3].kind = 1;
TMP437[3].offset = offsetof(tident184021, Next);
TMP437[3].typ = (&NTI184019);
TMP437[3].name = "next";
TMP439[2] = &TMP437[4];
TMP437[4].kind = 1;
TMP437[4].offset = offsetof(tident184021, H);
TMP437[4].typ = (&NTI128021);
TMP437[4].name = "h";
TMP437[1].len = 3; TMP437[1].kind = 2; TMP437[1].sons = &TMP439[0];
NTI184021.node = &TMP437[1];
NTI184019.size = sizeof(tident184021*);
NTI184019.kind = 22;
NTI184019.base = (&NTI184021);
NTI184019.flags = 2;
NTI184019.marker = TMP440;
NTI184017.size = sizeof(tidobj184015*);
NTI184017.kind = 22;
NTI184017.base = (&NTI184015);
NTI184017.marker = TMP827;
}
