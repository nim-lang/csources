...
N_NIMCALL(void, fillbuffer_174072)(tbaselexer174018* l);
...
N_NIMCALL(NI, fillbaselexer_174812)(tbaselexer174018* l, NI pos);
N_NIMCALL(NI, handlecr_174050)(tbaselexer174018* l, NI pos);
N_NIMCALL(NI, handlelf_174056)(tbaselexer174018* l, NI pos);
N_NIMCALL(void, skiputf8bom_175419)(tbaselexer174018* l);
...
N_NIMCALL(NimStringDesc*, getcurrentline_174040)(tbaselexer174018* l, NIM_BOOL marker);
...
NIM_CONST TY120387 newlines_174014 = {
...
TNimType NTI174018; /* TBaseLexer */
extern TNimType NTI106; /* int */
extern TNimType NTI145; /* cstring */
extern TNimType NTI172206; /* PLLStream */
...
N_NIMCALL(void, fillbuffer_174072)(tbaselexer174018* l) {
	...
	nimln(85, "nimlexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP1655)])), (NI64)(TMP1656));
	}
	LA11: ;
	...
	TMP1658 = mulInt((NI64)(TMP1657), 1);
	LOC13 = 0;
	LOC13 = llstreamread_172242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP1658));
	TMP1659 = divInt(LOC13, 1);
	charsread = (NI64)(TMP1659);
	...
	nimln(91, "nimlexbase.nim");
	{
		...
		if (!(charsread < (NI64)(TMP1661))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI64)(TMP1663);
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				TMP1664 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4631(((void*) ((*l).Buf)), (NI64)(TMP1664));
				...
				nimln(110, "nimlexbase.nim");
				{
					...
					if (!!(((NI64)(TMP1665) == oldbuflen))) goto LA35;
					nimln(110, "nimlexbase.nim");
				...
				LOC37 = 0;
				LOC37 = llstreamread_172242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP1667));
				TMP1668 = divInt(LOC37, 1);
				charsread = (NI64)(TMP1668);
...
N_NIMCALL(void, openbaselexer_174027)(tbaselexer174018* l, tllstream172204* inputstream, NI buflen) {
	...
	LOC5 = 0;
	LOC5 = alloc_4601((NI64)(TMP1677));
	(*l).Buf = ((NCSTRING) (LOC5));
	nimln(151, "nimlexbase.nim");
	nimln(151, "nimlexbase.nim");
	TMP1678 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP1678);
...
N_NIMCALL(NI, getcolnumber_174045)(tbaselexer174018* l, NI pos) {
	...
	if ((NI64)(TMP1679) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP1679));
	popFrame();
	return result;
}
...
appendString(result, ((NimStringDesc*) &TMP1681));
	nimln(168, "nimlexbase.nim");
	{
		...
		nimln(169, "nimlexbase.nim");
		LOC7 = 0;
		LOC7 = getcolnumber_174045(l, (*l).Bufpos);
		LOC8 = 0;
...
NTI174018.size = sizeof(tbaselexer174018);
NTI174018.kind = 17;
NTI174018.base = (&NTI2409);
TMP1920[0] = &TMP1626[1];
TMP1626[1].kind = 1;
TMP1626[1].offset = offsetof(tbaselexer174018, Bufpos);
TMP1626[1].typ = (&NTI106);
TMP1626[1].name = "bufpos";
TMP1920[1] = &TMP1626[2];
TMP1626[2].kind = 1;
TMP1626[2].offset = offsetof(tbaselexer174018, Buf);
TMP1626[2].typ = (&NTI145);
TMP1626[2].name = "buf";
TMP1920[2] = &TMP1626[3];
TMP1626[3].kind = 1;
TMP1626[3].offset = offsetof(tbaselexer174018, Buflen);
TMP1626[3].typ = (&NTI106);
TMP1626[3].name = "bufLen";
TMP1920[3] = &TMP1626[4];
TMP1626[4].kind = 1;
TMP1626[4].offset = offsetof(tbaselexer174018, Stream);
TMP1626[4].typ = (&NTI172206);
TMP1626[4].name = "stream";
TMP1920[4] = &TMP1626[5];
TMP1626[5].kind = 1;
TMP1626[5].offset = offsetof(tbaselexer174018, Linenumber);
TMP1626[5].typ = (&NTI106);
TMP1626[5].name = "lineNumber";
TMP1920[5] = &TMP1626[6];
TMP1626[6].kind = 1;
TMP1626[6].offset = offsetof(tbaselexer174018, Sentinel);
TMP1626[6].typ = (&NTI106);
TMP1626[6].name = "sentinel";
TMP1920[6] = &TMP1626[7];
TMP1626[7].kind = 1;
TMP1626[7].offset = offsetof(tbaselexer174018, Linestart);
TMP1626[7].typ = (&NTI106);
TMP1626[7].name = "lineStart";
TMP1626[0].len = 7; TMP1626[0].kind = 2; TMP1626[0].sons = &TMP1920[0];
NTI174018.node = &TMP1626[0];
}
