...
STRING_LITERAL(TMP3627, "", 0);
STRING_LITERAL(TMP3628, "as", 2);
STRING_LITERAL(TMP3629, " ", 1);
STRING_LITERAL(TMP3630, ".", 1);
STRING_LITERAL(TMP3631, "/", 1);
STRING_LITERAL(TMP3632, "invalid module name: \'$1\'", 25);
STRING_LITERAL(TMP3633, "module alias must be an identifier", 34);
STRING_LITERAL(TMP3634, "A module cannot import itself", 29);
STRING_LITERAL(TMP3635, "importAllSymbols: ", 18);
STRING_LITERAL(TMP3636, "rawImportSymbol", 15);
STRING_LITERAL(TMP3638, "importSymbol: 2", 15);
STRING_LITERAL(TMP3639, "importSymbol: 3", 15);
...
{	result = 0;
	...
	case ((NU8) 22):
	{
		result = nosunixToNativePath((*n).kindU.S3.strval, ((NimStringDesc*) &TMP3627));
	}
	break;
	case ((NU8) 2):
	{
	...
	case ((NU8) 30):
	{
		NimStringDesc* LOC12;
		{
			...
			if (!(LOC7)) goto LA8;
			LOC9 = 0;
			LOC9 = getident_189441(((NimStringDesc*) &TMP3628));
		...
		result = nsuReplaceStr(LOC12, ((NimStringDesc*) &TMP3629), ((NimStringDesc*) &TMP3627));
	}
	break;
	case ((NU8) 45):
	{
		...
		result = nsuReplaceStr(LOC14, ((NimStringDesc*) &TMP3630), ((NimStringDesc*) &TMP3631));
	}
	break;
	case ((NU8) 78):
	{
	...
	default:
	{
		...
		LOC18 = 0;
		LOC18 = nsuFormatSingleElem(((NimStringDesc*) &TMP3632), LOC17);
...
N_NIMCALL(Tsym214822*, myimportmodule_271474)(Tcontext264020* c, Tnode214790* n) {
	...
	f = checkmodulename_271049(n);
	{
		...
		result = importmoduleas_271443(n, LOC5);
		{
			...
			localerror_187080((*n).info, ((NU16) 4), ((NimStringDesc*) &TMP3634));
		}
		LA8: ;
		{
				...
				res_271194 = ((NI) 0);
				{
					while (1) {
						...
						e = (*(*(*etyp).n).kindU.S6.sons->data[j_271135]).kindU.S4.sym;
						{
							...
							internalerror_187100((*s).info, ((NimStringDesc*) &TMP3636));
						}
						LA27: ;
...
appendString(LOC15, ((NimStringDesc*) &TMP3635));
			...
			e = initidentiter_221087((&it), (*frommod).kindU.S3.tab, (*s).name);
			{
				while (1) {
					if (!!((e == NIM_NIL))) goto LA16;
					{
						...
						internalerror_187100((*n).info, ((NimStringDesc*) &TMP3639));
					}
					LA19: ;
					rawimportsymbol_271056(c, e);
