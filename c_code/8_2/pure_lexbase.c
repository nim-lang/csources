...
N_NIMCALL(void, fillbuffer_289071)(tbaselexer289016* l);
...
N_NIMCALL(NI, fillbaselexer_289812)(tbaselexer289016* l, NI pos);
N_NIMCALL(NI, handlecr_289049)(tbaselexer289016* l, NI pos);
N_NIMCALL(NI, handlelf_289055)(tbaselexer289016* l, NI pos);
N_NIMCALL(void, skiputf8bom_290413)(tbaselexer289016* l);
...
N_NIMCALL(NimStringDesc*, getcurrentline_289039)(tbaselexer289016* l, NIM_BOOL marker);
...
NIM_CONST TY112118 newlines_289011 = {
...
N_NIMCALL(void, fillbuffer_289071)(tbaselexer289016* l) {
	...
	LOC13 = 0;
	LOC13 = readdata_141731((*l).Input, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP4643));
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				LOC37 = 0;
				LOC37 = readdata_141731((*l).Input, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP4652));
...
N_NIMCALL(NI, fillbaselexer_289812)(tbaselexer289016* l, NI pos) {
	...
	LA7: ;
	{
		...
		fillbuffer_289071(l);		nimln(120, "lexbase.nim");
		(*l).Bufpos = 0;
...
N_NIMCALL(void, open_289026)(tbaselexer289016* l, tstream141629* input, NI buflen) {
	...
	fillbuffer_289071(l);	nimln(152, "lexbase.nim");
	skiputf8bom_290413(l);	popFrame();
}
N_NIMCALL(NI, getcolnumber_289044)(tbaselexer289016* l, NI pos) {
	NI result;
	NI TMP4665;
...
appendString(result, ((NimStringDesc*) &TMP4667));
	nimln(165, "lexbase.nim");
	{
		...
		nimln(166, "lexbase.nim");
		LOC7 = 0;
		LOC7 = getcolnumber_289044(l, (*l).Bufpos);
		LOC8 = 0;
...
NTI289016.size = sizeof(tbaselexer289016);
NTI289016.kind = 17;
NTI289016.base = (&NTI1009);
NTI289016.flags = 2;
TMP4775[0] = &TMP4634[1];
TMP4634[1].kind = 1;
TMP4634[1].offset = offsetof(tbaselexer289016, Bufpos);
TMP4634[1].typ = (&NTI105);
TMP4634[1].name = "bufpos";
TMP4775[1] = &TMP4634[2];
TMP4634[2].kind = 1;
TMP4634[2].offset = offsetof(tbaselexer289016, Buf);
TMP4634[2].typ = (&NTI144);
TMP4634[2].name = "buf";
TMP4775[2] = &TMP4634[3];
TMP4634[3].kind = 1;
TMP4634[3].offset = offsetof(tbaselexer289016, Buflen);
TMP4634[3].typ = (&NTI105);
TMP4634[3].name = "bufLen";
TMP4775[3] = &TMP4634[4];
TMP4634[4].kind = 1;
TMP4634[4].offset = offsetof(tbaselexer289016, Input);
TMP4634[4].typ = (&NTI141627);
TMP4634[4].name = "input";
TMP4775[4] = &TMP4634[5];
TMP4634[5].kind = 1;
TMP4634[5].offset = offsetof(tbaselexer289016, Linenumber);
TMP4634[5].typ = (&NTI105);
TMP4634[5].name = "LineNumber";
TMP4775[5] = &TMP4634[6];
TMP4634[6].kind = 1;
TMP4634[6].offset = offsetof(tbaselexer289016, Sentinel);
TMP4634[6].typ = (&NTI105);
TMP4634[6].name = "sentinel";
TMP4775[6] = &TMP4634[7];
TMP4634[7].kind = 1;
TMP4634[7].offset = offsetof(tbaselexer289016, Linestart);
TMP4634[7].typ = (&NTI105);
TMP4634[7].name = "lineStart";
TMP4775[7] = &TMP4634[8];
TMP4634[8].kind = 1;
TMP4634[8].offset = offsetof(tbaselexer289016, Fileopened);
TMP4634[8].typ = (&NTI133);
TMP4634[8].name = "fileOpened";
TMP4634[0].len = 8; TMP4634[0].kind = 2; TMP4634[0].sons = &TMP4775[0];
NTI289016.node = &TMP4634[0];
}
