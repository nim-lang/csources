...
typedef struct tgen524012 tgen524012;
...
N_NIMCALL(void, adddependencyaux_524020)(NimStringDesc* importing, NimStringDesc* imported);
...
NIM_CONST tpass249015 gendependpass_524152 = {myopen_524128,
NIM_NIL,
adddotdependency_524031,
NIM_NIL}
;
trope147007* gdotgraph_524017;
extern TFrame* frameptr_13238;
extern TNimType NTI249003; /* TPassContext */
TNimType NTI524012; /* TGen */
extern TNimType NTI190811; /* PSym */
TNimType NTI524014; /* PGen */
...
N_NIMCALL(void, adddependencyaux_524020)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	appf_147085(&gdotgraph_524017, ((NimStringDesc*) &TMP7609), LOC1, 2);
	popFrame();
}
...
N_NIMCALL(tnode190813*, adddotdependency_524031)(tpasscontext249003* c, tnode190813* n) {
	...
	if (c) chckObj((*c).Sup.m_type, (&NTI524012));
	g = ((tgen524012*) (c));
	...
	case ((NU8) 115):
	{
		...
		while (1) {
			...
			nimln(1452, "system.nim");
			if (!(res_524109 <= HEX3Atmp_524107)) goto LA3;
			nimln(1451, "system.nim");
			i_524049 = res_524109;
			nimln(34, "depends.nim");
			if (((TMP7610[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7611));
			if ((NU)(i_524049) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			imported = getmodulename_258012((*n).kindU.S6.Sons->data[i_524049]);
			nimln(35, "depends.nim");
			adddependencyaux_524020((*(*(*g).Module).Name).S, imported);
			nimln(1454, "system.nim");
			res_524109 = addInt(res_524109, 1);
		} LA3: ;
	}
	break;
	case ((NU8) 119):
	...
	case ((NU8) 126):
	{
		...
		while (1) {
			tnode190813* LOC8;
			nimln(1452, "system.nim");
			if (!(res_524113 <= HEX3Atmp_524111)) goto LA7;
			nimln(1451, "system.nim");
			i_524092 = res_524113;
			nimln(40, "depends.nim");
			nimln(40, "depends.nim");
			if (((TMP7610[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7611));
			if ((NU)(i_524092) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC8 = 0;
			LOC8 = adddotdependency_524031(c, (*n).kindU.S6.Sons->data[i_524092]);
			nimln(1454, "system.nim");
			res_524113 = addInt(res_524113, 1);
		} LA7: ;
	}
	break;
	default:
...
N_NIMCALL(tpasscontext249003*, myopen_524128)(tsym190843* module) {
	...
	g = (tgen524012*) newObj((&NTI524014), sizeof(tgen524012));
	(*g).Sup.Sup.m_type = (&NTI524012);
...
NTI524012.size = sizeof(tgen524012);
NTI524012.kind = 17;
NTI524012.base = (&NTI249003);
TMP7607[0].kind = 1;
TMP7607[0].offset = offsetof(tgen524012, Module);
TMP7607[0].typ = (&NTI190811);
TMP7607[0].name = "module";
NTI524012.node = &TMP7607[0];
NTI524014.size = sizeof(tgen524012*);
NTI524014.kind = 22;
NTI524014.base = (&NTI524012);
NTI524014.marker = TMP7617;
}
