...
N_NIMCALL(void, patternerror_275038)(tnode170659* n);
...
static N_INLINE(void, add_275044)(NimStringDesc** code, NU8 op);
...
N_NIMCALL(void, compileconstraints_275094)(tnode170659* p, NimStringDesc** result);
...
N_NIMCALL(tnode170659*, semnodekindconstraints_275393)(tnode170659* p);
...
N_NIMCALL(NU8, checkforsideeffects_275708)(tnode170659* n);
static N_INLINE(NIM_BOOL, isroutine_175861)(tsym170689* s);
N_NIMCALL(NU8, isassignable_275902)(tsym170689* owner, tnode170659* n);
...
static NIM_CONST TY170865 TMP3824 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3825, "strVal", 6);
static NIM_CONST TY170865 TMP3826 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3827, "sons", 4);
static NIM_CONST TY170865 TMP3828 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3829, "ident", 5);
STRING_LITERAL(TMP3830, "|", 1);
STRING_LITERAL(TMP3831, "&", 1);
STRING_LITERAL(TMP3832, "~", 1);
STRING_LITERAL(TMP3833, "atom", 4);
STRING_LITERAL(TMP3834, "lit", 3);
STRING_LITERAL(TMP3835, "sym", 3);
STRING_LITERAL(TMP3836, "ident", 5);
STRING_LITERAL(TMP3837, "call", 4);
STRING_LITERAL(TMP3838, "alias", 5);
STRING_LITERAL(TMP3839, "noalias", 7);
STRING_LITERAL(TMP3840, "lvalue", 6);
STRING_LITERAL(TMP3841, "local", 5);
STRING_LITERAL(TMP3842, "sideeffect", 10);
STRING_LITERAL(TMP3843, "nosideeffect", 12);
STRING_LITERAL(TMP3845, "compiler/parampatterns.nim", 26);
NIM_CONST TY75888 TMP3844 = {((NimStringDesc*) &TMP3845),
100}
;
NIM_CONST TY75888 TMP3846 = {((NimStringDesc*) &TMP3845),
107}
;
STRING_LITERAL(TMP3847, "p.Kind == nkCurlyExpr ", 22);
STRING_LITERAL(TMP3848, "parameter pattern too complex", 29);
static NIM_CONST TY170865 TMP3849 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3850, "sym", 3);
...
N_NIMCALL(void, patternerror_275038)(tnode170659* n) {
	...
	localerror_137349((*n).Info, ((NU16) 1), LOC1);	popFrame();
}
static N_INLINE(void, add_275044)(NimStringDesc** code, NU8 op) {
...
N_NIMCALL(NU8, whichalias_275058)(tsym170689* p) {
	...
	nimln(51, "parampatterns.nim");
	{
		...
		nimln(52, "parampatterns.nim");
		if (!(((TMP3824[(*(*p).Constraint).Kind/8] &(1<<((*(*p).Constraint).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3825));
...
static N_INLINE(NI, len_171102)(tnode170659* n) {
	...
	{
		nimln(873, "ast.nim");
		if (((TMP3826[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3827));
...
N_NIMCALL(void, compileconstraints_275094)(tnode170659* p, NimStringDesc** result) {
	...
	case ((NU8) 32):
	{
		...
		nimln(59, "parampatterns.nim");
		{
			nimln(698, "system.nim");
			nimln(698, "system.nim");
			if (((TMP3826[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3827));
			...
			if (((TMP3826[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3827));
			if ((NU)(0) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
			patternerror_275038((*p).kindU.S6.Sons->data[0]);			nimln(61, "parampatterns.nim");
			goto BeforeRet;
		}		LA4: ;
		nimln(62, "parampatterns.nim");
		if (((TMP3826[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3827));
		if ((NU)(0) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3828[(*(*p).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*p).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3829));
		...
		nimln(63, "parampatterns.nim");
		{
			...
			nimln(64, "parampatterns.nim");
			{
				...
				LOC13 = 0;
				nimln(64, "parampatterns.nim");
				LOC13 = eqStrings((*op).S, ((NimStringDesc*) &TMP3830));
				if (LOC13) goto LA14;
				nimln(64, "parampatterns.nim");
				LOC13 = ((*op).Sup.Id == 48);
				LA14: ;
				...
				compileconstraints_275094((*p).kindU.S6.Sons->data[1], result);				nimln(66, "parampatterns.nim");
				if (((TMP3826[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3827));
				if ((NU)(2) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
				compileconstraints_275094((*p).kindU.S6.Sons->data[2], result);				nimln(67, "parampatterns.nim");
				add_275044(result, ((NU8) 2));			}			goto LA11;
			LA15: ;
			{
				NIM_BOOL LOC18;
				...
				LOC18 = 0;
				nimln(68, "parampatterns.nim");
				LOC18 = eqStrings((*op).S, ((NimStringDesc*) &TMP3831));
				if (LOC18) goto LA19;
				nimln(68, "parampatterns.nim");
				LOC18 = ((*op).Sup.Id == 2);
				LA19: ;
				...
				if (((TMP3826[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3827));
				if ((NU)(1) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
				compileconstraints_275094((*p).kindU.S6.Sons->data[1], result);				nimln(70, "parampatterns.nim");
				if (((TMP3826[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3827));
				if ((NU)(2) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
				compileconstraints_275094((*p).kindU.S6.Sons->data[2], result);				nimln(71, "parampatterns.nim");
				add_275044(result, ((NU8) 3));			}			goto LA11;
			LA20: ;
			{
				nimln(73, "parampatterns.nim");
				patternerror_275038(p);			}			LA11: ;
		}		goto LA6;
		LA9: ;
		{
			NIM_BOOL LOC24;
			...
			LOC27 = 0;
			nimln(74, "parampatterns.nim");
			LOC27 = eqStrings((*op).S, ((NimStringDesc*) &TMP3832));
			if (LOC27) goto LA28;
			nimln(74, "parampatterns.nim");
			LOC27 = ((*op).Sup.Id == 44);
			LA28: ;
			...
			if (((TMP3826[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3827));
			if ((NU)(1) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
			compileconstraints_275094((*p).kindU.S6.Sons->data[1], result);			nimln(76, "parampatterns.nim");
			add_275044(result, ((NU8) 4));		}		goto LA6;
		LA29: ;
		{
			nimln(78, "parampatterns.nim");
			patternerror_275038(p);		}		LA6: ;
	}	break;
	case ((NU8) 53):
	case ((NU8) 37):
	{
		nimln(80, "parampatterns.nim");
		{
			...
			if (((TMP3826[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3827));
			if ((NU)(0) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
			compileconstraints_275094((*p).kindU.S6.Sons->data[0], result);		}		goto LA33;
		LA36: ;
		{
			nimln(83, "parampatterns.nim");
			patternerror_275038(p);		}		LA33: ;
	}	break;
	case ((NU8) 2):
	{
		NimStringDesc* spec;
		nimln(85, "parampatterns.nim");
		if (!(((TMP3828[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3829));
		spec = nsuNormalize((*(*p).kindU.S5.Ident).S);
		nimln(86, "parampatterns.nim");
		switch (hashString(spec) & 15) {
		case 2: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3843))) goto LA50;
break;
		case 4: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3835))) goto LA42;
if (eqStrings(spec, ((NimStringDesc*) &TMP3840))) goto LA47;
if (eqStrings(spec, ((NimStringDesc*) &TMP3842))) goto LA49;
break;
		case 6: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3836))) goto LA43;
break;
		case 10: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3839))) goto LA46;
break;
		case 11: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3833))) goto LA40;
break;
		case 12: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3834))) goto LA41;
break;
		case 13: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3837))) goto LA44;
break;
		case 14: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3838))) goto LA45;
if (eqStrings(spec, ((NimStringDesc*) &TMP3841))) goto LA48;
break;
		}
		goto LA51;
		LA40: ;
		{
			...
			add_275044(result, ((NU8) 6));		}		goto LA52;
		LA41: ;
		{
			nimln(88, "parampatterns.nim");
			add_275044(result, ((NU8) 7));		}		goto LA52;
		LA42: ;
		{
			nimln(89, "parampatterns.nim");
			add_275044(result, ((NU8) 5));		}		goto LA52;
		LA43: ;
		{
			nimln(90, "parampatterns.nim");
			add_275044(result, ((NU8) 8));		}		goto LA52;
		LA44: ;
		{
			nimln(91, "parampatterns.nim");
			add_275044(result, ((NU8) 9));		}		goto LA52;
		LA45: ;
		{
		...
		LA47: ;
		{
			...
			add_275044(result, ((NU8) 12));		}		goto LA52;
		LA48: ;
		{
			nimln(95, "parampatterns.nim");
			add_275044(result, ((NU8) 13));		}		goto LA52;
		LA49: ;
		{
			nimln(96, "parampatterns.nim");
			add_275044(result, ((NU8) 14));		}		goto LA52;
		LA50: ;
		{
			nimln(97, "parampatterns.nim");
			add_275044(result, ((NU8) 15));		}		goto LA52;
		LA51: ;
		{
			NU8 i_275308;
			NU8 res_275382;
			...
			nimln(826, "msgs.nim");
			{
				...
				nimln(826, "msgs.nim");
				LOC69 = 0;
				LOC69 = HEX24_137459(TMP3844);
				internalerror_137383(LOC69);			}			LA67: ;
			i_275308 = 0;
			...
			while (1) {
				nimln(1309, "system.nim");
				if (!(res_275382 <= ((NU8) 22))) goto LA70;
				nimln(1308, "system.nim");
				i_275308 = res_275382;
				nimln(102, "parampatterns.nim");
				{
					...
					nimln(102, "parampatterns.nim");
					LOC73 = 0;
					LOC73 = copyStr(reprEnum(i_275308, (&NTI170313)), 2);
					LOC74 = 0;
					LOC74 = nsuCmpIgnoreStyle(LOC73, spec);
					if (!(LOC74 == 0)) goto LA75;
					nimln(103, "parampatterns.nim");
					add_275044(result, ((NU8) 10));					nimln(104, "parampatterns.nim");
					nimln(104, "parampatterns.nim");
					nimln(104, "parampatterns.nim");
					(*result) = addChar((*result), ((NIM_CHAR) (((NI) (i_275308)))));
					nimln(105, "parampatterns.nim");
					goto BeforeRet;
				}				LA75: ;
				nimln(1311, "system.nim");
				res_275382 = addInt(res_275382, 1);
			} LA70: ;
			nimln(826, "msgs.nim");
			{
				NimStringDesc* LOC81;
				...
				nimln(826, "msgs.nim");
				LOC81 = 0;
				LOC81 = HEX24_137459(TMP3846);
				internalerror_137383(LOC81);			}			LA79: ;
			i_275365 = 0;
			nimln(1308, "system.nim");
			res_275387 = ((NU8) 0);
			nimln(1309, "system.nim");
			while (1) {
				nimln(1309, "system.nim");
				if (!(res_275387 <= ((NU8) 153))) goto LA82;
				nimln(1308, "system.nim");
				i_275365 = res_275387;
				nimln(109, "parampatterns.nim");
				{
					...
					nimln(109, "parampatterns.nim");
					LOC85 = 0;
					LOC85 = nsuCmpIgnoreStyle(reprEnum(i_275365, (&NTI170022)), spec);
					if (!(LOC85 == 0)) goto LA86;
					nimln(110, "parampatterns.nim");
					add_275044(result, ((NU8) 11));					nimln(111, "parampatterns.nim");
					nimln(111, "parampatterns.nim");
					nimln(111, "parampatterns.nim");
					(*result) = addChar((*result), ((NIM_CHAR) (((NI) (i_275365)))));
					nimln(112, "parampatterns.nim");
					goto BeforeRet;
				}				LA86: ;
				nimln(1311, "system.nim");
				res_275387 = addInt(res_275387, 1);
			} LA82: ;
			nimln(113, "parampatterns.nim");
			patternerror_275038(p);		}		LA52: ;
	}	break;
	default:
	{
		nimln(115, "parampatterns.nim");
		patternerror_275038(p);	}	break;
	}
	BeforeRet: ;	popFrame();
}
static N_INLINE(tcell38848*, usrtocell_42239)(void* usr) {
...
N_NIMCALL(tnode170659*, semnodekindconstraints_275393)(tnode170659* p) {
	...
	nimln(120, "parampatterns.nim");
	{
		...
		nimln(120, "parampatterns.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP3847));	}	LA3: ;
	nimln(121, "parampatterns.nim");
	result = newnodei_170940(((NU8) 20), (*p).Info);
	nimln(122, "parampatterns.nim");
	if (!(((TMP3824[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3825));
	nimln(122, "parampatterns.nim");
	...
	nimln(124, "parampatterns.nim");
	{
		...
		LOC10 = 0;
		LOC10 = len_171102(p);
		HEX3Atmp_275695 = subInt(LOC10, 1);
		nimln(1308, "system.nim");
		res_275697 = 1;
		nimln(1309, "system.nim");
		while (1) {
			nimln(1309, "system.nim");
			if (!(res_275697 <= HEX3Atmp_275695)) goto LA11;
			nimln(1308, "system.nim");
			i_275647 = res_275697;
			nimln(126, "parampatterns.nim");
			if (((TMP3826[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3827));
			if ((NU)(i_275647) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!(((TMP3824[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3825));
			compileconstraints_275094((*p).kindU.S6.Sons->data[i_275647], &(*result).kindU.S3.Strval);			nimln(1311, "system.nim");
			res_275697 = addInt(res_275697, 1);
		} LA11: ;
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_137369((*p).Info, ((NimStringDesc*) &TMP3848));		}		LA14: ;
	}	goto LA5;
	LA8: ;
	{
		nimln(130, "parampatterns.nim");
		patternerror_275038(p);	}	LA5: ;
	nimln(131, "parampatterns.nim");
	if (!(((TMP3824[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3825));
	add_275044(&(*result).kindU.S3.Strval, ((NU8) 1));	popFrame();
	return result;
}
static N_INLINE(NIM_BOOL, isroutine_175861)(tsym170689* s) {
	NIM_BOOL result;
...
N_NIMCALL(NU8, checkforsideeffects_275708)(tnode170659* n) {
	...
	case ((NU8) 32):
	{
		...
		nimln(143, "parampatterns.nim");
		{
			...
			if (!(LOC4)) goto LA5;
			nimln(143, "parampatterns.nim");
			if (!(((TMP3849[(*op).Kind/8] &(1<<((*op).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3850));
			LOC4 = isroutine_175861((*op).kindU.S4.Sym);
			LA5: ;
			if (!LOC4) goto LA6;
		...
		LOC16 = 0;
		LOC16 = len_171102(n);
		HEX3Atmp_275883 = subInt(LOC16, 1);
		nimln(1308, "system.nim");
		res_275885 = 0;
		nimln(1309, "system.nim");
		while (1) {
			NU8 ret;
			nimln(1309, "system.nim");
			if (!(res_275885 <= HEX3Atmp_275883)) goto LA17;
			nimln(1308, "system.nim");
			i_275792 = res_275885;
			nimln(157, "parampatterns.nim");
			if (((TMP3826[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3827));
			if ((NU)(i_275792) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			ret = checkforsideeffects_275708((*n).kindU.S6.Sons->data[i_275792]);
			...
			LA18: ;
			nimln(1311, "system.nim");
			res_275885 = addInt(res_275885, 1);
		} LA17: ;
	}	break;
	case ((NU8) 0) ... ((NU8) 23):
	{
	...
	default:
	{
		...
		LOC29 = 0;
		LOC29 = len_171102(n);
		HEX3Atmp_275887 = subInt(LOC29, 1);
		nimln(1308, "system.nim");
		res_275889 = 0;
		nimln(1309, "system.nim");
		while (1) {
			NU8 ret;
			nimln(1309, "system.nim");
			if (!(res_275889 <= HEX3Atmp_275887)) goto LA30;
			nimln(1308, "system.nim");
			i_275846 = res_275889;
			nimln(166, "parampatterns.nim");
			if (((TMP3826[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3827));
			if ((NU)(i_275846) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			ret = checkforsideeffects_275708((*n).kindU.S6.Sons->data[i_275846]);
			...
			LA31: ;
			nimln(1311, "system.nim");
			res_275889 = addInt(res_275889, 1);
		} LA30: ;
	}	break;
	}
	BeforeRet: ;	popFrame();
...
N_NIMCALL(NU8, isassignable_275902)(tsym170689* owner, tnode170659* n) {
	...
	case ((NU8) 3):
	{
		...
		{
			nimln(730, "system.nim");
			if (!(((TMP3849[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3850));
	...
	case ((NU8) 45):
	{
		nimln(192, "parampatterns.nim");
		{
			...
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC18 = 0;
			LOC18 = skiptypes_199120((*(*n).kindU.S6.Sons->data[0]).Typ, IL64(211106232576000));
		...
		LA19: ;
		{
			...
			if (((TMP3826[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3827));
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			result = isassignable_275902(owner, (*n).kindU.S6.Sons->data[0]);
		}		LA16: ;
		nimln(197, "parampatterns.nim");
		{
			...
			if (!(((TMP3849[(*(*n).kindU.S6.Sons->data[1]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[1]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3850));
	...
	case ((NU8) 42):
	{
		nimln(200, "parampatterns.nim");
		{
			...
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC31 = 0;
			LOC31 = skiptypes_199120((*(*n).kindU.S6.Sons->data[0]).Typ, IL64(211106232576000));
	...
	case ((NU8) 60):
	{
		nimln(208, "parampatterns.nim");
		{
			...
			nimln(208, "parampatterns.nim");
			LOC38 = 0;
			LOC38 = skiptypes_199120((*n).Typ, IL64(211106247256064));
			if (!((134610944 &(IL64(1)<<(((*LOC38).Kind)&IL64(63))))!=0)) goto LA39;
			nimln(210, "parampatterns.nim");
			if (((TMP3826[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3827));
			if ((NU)(1) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			result = isassignable_275902(owner, (*n).kindU.S6.Sons->data[1]);
		}		goto LA36;
		LA39: ;
		{
			NIM_BOOL LOC42;
			...
			if ((NU)(1) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC42 = 0;
			LOC42 = comparetypes_205524((*n).Typ, (*(*n).kindU.S6.Sons->data[1]).Typ, ((NU8) 1), 0);
			if (!LOC42) goto LA43;
...
N_NIMCALL(NIM_BOOL, matchnodekinds_276175)(tnode170659* p, tnode170659* n) {
	...
	if (!(((TMP3824[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3825));
	...
	while (1) {
		...
		case ((NU8) 2):
		{
			...
			nimln(239, "parampatterns.nim");
			TMP3852 = subInt(sp, 1);
			if ((NU)((NI64)(TMP3852)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI64)(TMP3852))- 0];
			if (LOC4) goto LA5;
			nimln(239, "parampatterns.nim");
			TMP3853 = subInt(sp, 2);
			if ((NU)((NI64)(TMP3853)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI64)(TMP3853))- 0];
			LA5: ;
			stack[((NI64)(TMP3851))- 0] = LOC4;
		...
		case ((NU8) 3):
		{
			...
			nimln(242, "parampatterns.nim");
			TMP3854 = subInt(sp, 2);
			if ((NU)((NI64)(TMP3854)) > (NU)(64)) raiseIndexError();
			nimln(242, "parampatterns.nim");
			LOC7 = 0;
			nimln(242, "parampatterns.nim");
			TMP3855 = subInt(sp, 1);
			if ((NU)((NI64)(TMP3855)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI64)(TMP3855))- 0];
			if (!(LOC7)) goto LA8;
			nimln(242, "parampatterns.nim");
			TMP3856 = subInt(sp, 2);
			if ((NU)((NI64)(TMP3856)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI64)(TMP3856))- 0];
			LA8: ;
			stack[((NI64)(TMP3854))- 0] = LOC7;
		...
		case ((NU8) 4):
		{
			...
			nimln(244, "parampatterns.nim");
			TMP3857 = subInt(sp, 1);
			if ((NU)((NI64)(TMP3857)) > (NU)(64)) raiseIndexError();
			nimln(244, "parampatterns.nim");
			nimln(244, "parampatterns.nim");
			TMP3858 = subInt(sp, 1);
			if ((NU)((NI64)(TMP3858)) > (NU)(64)) raiseIndexError();
			stack[((NI64)(TMP3857))- 0] = !(stack[((NI64)(TMP3858))- 0]);
		}		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(251, "parampatterns.nim");
			TMP3859 = addInt(pc, 1);
			if ((NU)((NI64)(TMP3859)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3859)])), ((NU8) 0), ((NU8) 22)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			nimln(255, "parampatterns.nim");
			TMP3860 = addInt(pc, 1);
			if ((NU)((NI64)(TMP3860)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3860)])), ((NU8) 0), ((NU8) 153)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 12):
		{
			...
			LOC20 = 0;
			LOC20 = isassignable_275902(NIM_NIL, n);
		...
		case ((NU8) 13):
		{
			...
			nimln(259, "parampatterns.nim");
			LOC22 = 0;
			LOC22 = isassignable_275902(NIM_NIL, n);
		...
		case ((NU8) 14):
		{
			...
			nimln(260, "parampatterns.nim");
			LOC24 = 0;
			LOC24 = checkforsideeffects_275708(n);
		...
		case ((NU8) 15):
		{
			...
			LOC26 = 0;
			LOC26 = checkforsideeffects_275708(n);
	...
	nimln(263, "parampatterns.nim");
	TMP3861 = subInt(sp, 1);
	if ((NU)((NI64)(TMP3861)) > (NU)(64)) raiseIndexError();
	result = stack[((NI64)(TMP3861))- 0];
	popFrame();
	return result;
