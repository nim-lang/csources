...
N_NIMCALL(NIM_BOOL, treesequivalent_244224)(tnode184813* a, tnode184813* b);
static N_INLINE(NIM_BOOL, eqStrings)(NimStringDesc* a, NimStringDesc* b);
N_NIMCALL(NIM_BOOL, sametypeornil_225151)(ttype184847* a, ttype184847* b, NU8 flags);
N_NIMCALL(NI, nodetablerawget_244476)(tnodetable184871 t, NI k, tnode184813* key);
static N_INLINE(NI, nexttry_193192)(NI h, NI maxhash);
N_NIMCALL(NI, mulInt)(NI a, NI b);
N_NIMCALL(NI, nodetableget_244504)(tnodetable184871 t, tnode184813* key);
N_NIMCALL(void, nodetablerawinsert_244515)(tnodepairseq184869** data, NI k, tnode184813* key, NI val);
...
N_NIMCALL(NI, hashtree_244022)(tnode184813* n) {
	...
	case ((NU8) 5) ... ((NU8) 15):
	{
		nimln(26, "treetab.nim");
		{
			...
			if (!(((TMP3199[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3200));
			result = HEX21HEX26_117015(result, ((NI) ((*n).kindU.S1.Intval)));
		}
		LA13: ;
	}
	break;
	...
	default:
	{
		...
		while (1) {
			NI LOC27;
			nimln(1451, "system.nim");
			if (!(res_244219 <= HEX3Atmp_244217)) goto LA26;
			nimln(1450, "system.nim");
			i_244197 = res_244219;
			...
			res_244219 = addInt(res_244219, 1);
		} LA26: ;
	}
	break;
	}
	...
	LA3: ;
	{
		...
		default:
		{
			nimln(49, "treetab.nim");
			{
				...
				HEX3Atmp_244469 = (NI64)(TMP3208);
				nimln(1450, "system.nim");
				res_244471 = 0;
				nimln(1451, "system.nim");
				while (1) {
					nimln(1451, "system.nim");
					if (!(res_244471 <= HEX3Atmp_244469)) goto LA26;
					nimln(1450, "system.nim");
					i_244440 = res_244471;
					nimln(51, "treetab.nim");
					{
						...
						if ((NU)(i_244440) >= (NU)((*a).kindU.S6.Sons->Sup.len)) raiseIndexError();
						if (((TMP3205[(*b).Kind/8] &(1<<((*b).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3206));
						if ((NU)(i_244440) >= (NU)((*b).kindU.S6.Sons->Sup.len)) raiseIndexError();
						LOC29 = 0;
						LOC29 = treesequivalent_244224((*a).kindU.S6.Sons->data[i_244440], (*b).kindU.S6.Sons->data[i_244440]);
						if (!!(LOC29)) goto LA30;
						nimln(51, "treetab.nim");
						goto BeforeRet;
					}
					LA30: ;
					nimln(1453, "system.nim");
					res_244471 = addInt(res_244471, 1);
				} LA26: ;
...
static N_INLINE(NI, nexttry_193192)(NI h, NI maxhash) {
	...
	nimln(465, "astalgo.nim");
	TMP3209 = mulInt(5, h);
	TMP3210 = addInt((NI64)(TMP3209), 1);
	result = (NI)((NI64)(TMP3210) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(NI, nodetablerawget_244476)(tnodetable184871 t, NI k, tnode184813* key) {
	...
	while (1) {
		...
		nimln(58, "treetab.nim");
		{
			...
			nimln(58, "treetab.nim");
			if ((NU)(h) >= (NU)(t.Data->Sup.len)) raiseIndexError();
			LOC4 = treesequivalent_244224(t.Data->data[h].Key, key);
			LA5: ;
			if (!LOC4) goto LA6;
...
N_NIMCALL(NI, nodetableget_244504)(tnodetable184871 t, tnode184813* key) {
	...
	index = nodetablerawget_244476(t, LOC1, key);
...
N_NIMCALL(void, nodetableput_244622)(tnodetable184871* t, tnode184813* key, NI val) {
	...
	index = nodetablerawget_244476((*t), k, key);
	...
	LA3: ;
	{
		nimln(85, "treetab.nim");
		{
			...
			n = (tnodepairseq184869*) newSeq((&NTI184869), (NI64)(TMP3213));
			i_244868 = 0;
			HEX3Atmp_244921 = 0;
			...
			while (1) {
				...
				nimln(88, "treetab.nim");
				{
					...
					if ((NU)(i_244868) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
					if ((NU)(i_244868) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
					nodetablerawinsert_244515(&n, (*t).Data->data[i_244868].H, (*t).Data->data[i_244868].Key, (*t).Data->data[i_244868].Val);
				}
				LA18: ;
				nimln(1453, "system.nim");
		...
		nodetablerawinsert_244515(&(*t).Data, k, key, val);
...
N_NIMCALL(NI, nodetabletestorset_244928)(tnodetable184871* t, tnode184813* key, NI val) {
	...
	LA3: ;
	{
		nimln(102, "treetab.nim");
		{
			...
			n = (tnodepairseq184869*) newSeq((&NTI184869), (NI64)(TMP3214));
			i_245068 = 0;
			HEX3Atmp_245121 = 0;
			...
			while (1) {
				...
				nimln(105, "treetab.nim");
				{
					...
					if ((NU)(i_245068) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
					if ((NU)(i_245068) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
					nodetablerawinsert_244515(&n, (*t).Data->data[i_245068].H, (*t).Data->data[i_245068].Key, (*t).Data->data[i_245068].Val);
				}
				LA18: ;
				nimln(1453, "system.nim");
