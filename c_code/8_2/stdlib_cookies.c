...
N_NIMCALL(NimStringDesc*, setcookie_332106)(NimStringDesc* key, NimStringDesc* value, NimStringDesc* domain, NimStringDesc* path, NimStringDesc* expires, NIM_BOOL noname);
N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src);
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src);
N_NIMCALL(NimStringDesc*, resizeString)(NimStringDesc* dest, NI addlen);
N_NIMCALL(NimStringDesc*, rawNewString)(NI space);
N_NIMCALL(NimStringDesc*, setcookie_332117)(NimStringDesc* key, NimStringDesc* value, ttimeinfo94003* expires, NimStringDesc* domain, NimStringDesc* path, NIM_BOOL noname);
N_NIMCALL(NimStringDesc*, format_95999)(ttimeinfo94003* info, NimStringDesc* f);
STRING_LITERAL(TMP4689, "", 0);
STRING_LITERAL(TMP4690, "Set-Cookie: ", 12);
STRING_LITERAL(TMP4691, "=", 1);
STRING_LITERAL(TMP4692, "; Domain=", 9);
STRING_LITERAL(TMP4693, "; Path=", 7);
STRING_LITERAL(TMP4694, "; Expires=", 10);
STRING_LITERAL(TMP4695, "ddd\',\' dd MMM yyyy HH:mm:ss \'UTC\'", 33);
...
N_NIMCALL(tstringtable119810*, parsecookies_332012)(NimStringDesc* s) {
	...
	while (1) {
		...
		TMP4688 = subInt(i, 1);
		LOC16 = 0;
		LOC16 = copyStrLast(s, valstart, (NI64)(TMP4688));
...
N_NIMCALL(NimStringDesc*, setcookie_332117)(NimStringDesc* key, NimStringDesc* value, ttimeinfo94003* expires, NimStringDesc* domain, NimStringDesc* path, NIM_BOOL noname) {
	...
	LOC1 = 0;
	LOC1 = format_95999(expires, ((NimStringDesc*) &TMP4695));
	result = setcookie_332106(key, value, domain, path, LOC1, noname);
	goto BeforeRet;
	BeforeRet: ;
	popFrame();
	return result;
