...
N_NIMCALL(NimStringDesc*, prependcurdir_422401)(NimStringDesc* f);
...
N_NIMCALL(void, handlecmdline_422603)(void);
...
STRING_LITERAL(TMP7236, "./", 2);
STRING_LITERAL(TMP7237, "", 0);
STRING_LITERAL(TMP7239, "nimrod.cfg", 10);
STRING_LITERAL(TMP7240, "js", 2);
STRING_LITERAL(TMP7241, "node ", 5);
...
extern NimStringDesc* arguments_417205;
...
appendString(LOC7, ((NimStringDesc*) &TMP7236));
appendString(LOC7, f);
		result = LOC7;
	}	LA1: ;
	popFrame();
...
N_NIMCALL(void, handlecmdline_422603)(void) {
	...
	nimln(35, "nimrod.nim");
	{
		...
		nimln(35, "nimrod.nim");
		LOC3 = 0;
		LOC3 = paramcount_106029();
		if (!(LOC3 == 0)) goto LA4;
		nimln(36, "nimrod.nim");
		writecommandlineusage_150002();	}	goto LA1;
	LA4: ;
	{
		nimln(39, "nimrod.nim");
		processcmdline_417207(((NU8) 0), ((NimStringDesc*) &TMP7237));		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP7238;
			TY101259 p;
			NimStringDesc* LOC15;
			...
			nimln(698, "system.nim");
			nimln(698, "system.nim");
			if (!!(((gprojectname_113197) && (gprojectname_113197)->Sup.len == 0))) goto LA9;
			nimln(41, "nimrod.nim");
			pushSafePoint(&TMP7238);
			TMP7238.status = setjmp(TMP7238.context);
			if (TMP7238.status == 0) {
				nimln(42, "nimrod.nim");
				asgnRefNoCycle((void**) &gprojectfull_113199, canonicalizepath_113316(gprojectname_113197));
				popSafePoint();
			}			else {
				popSafePoint();
				setFrame((TFrame*)&F);
				if (isObj(getCurrentException()->Sup.m_type, (&NTI1035))) {
					...
					nimln(44, "nimrod.nim");
					LOC14 = 0;
					LOC14 = gprojectfull_113199; gprojectfull_113199 = copyStringRC1(gprojectname_113197);
					if (LOC14) nimGCunrefNoCycle(LOC14);
					popCurrentException();
				}			}			if (TMP7238.status != 0) reraiseException();
			nimln(45, "nimrod.nim");
			chckNil((void*)&p);
			memset((void*)&p, 0, sizeof(p));
			nossplitFile(gprojectfull_113199, &p);			nimln(46, "nimrod.nim");
			LOC15 = 0;
			LOC15 = gprojectpath_113198; gprojectpath_113198 = copyStringRC1(p.Field0);
			if (LOC15) nimGCunrefNoCycle(LOC15);
			nimln(47, "nimrod.nim");
			LOC16 = 0;
			LOC16 = gprojectname_113197; gprojectname_113197 = copyStringRC1(p.Field1);
			if (LOC16) nimGCunrefNoCycle(LOC16);
		}		goto LA7;
		LA9: ;
		{
			nimln(49, "nimrod.nim");
			asgnRefNoCycle((void**) &gprojectpath_113198, nosgetCurrentDir());
		}		LA7: ;
		nimln(50, "nimrod.nim");
		loadconfigs_166607(((NimStringDesc*) &TMP7239));		nimln(53, "nimrod.nim");
		initvars_146647();		nimln(54, "nimrod.nim");
		processcmdline_417207(((NU8) 1), ((NimStringDesc*) &TMP7237));		nimln(55, "nimrod.nim");
		maincommand_420811();		nimln(56, "nimrod.nim");
		{
			NimStringDesc* LOC22;
		...
		{
			nimln(58, "nimrod.nim");
			if (!(gerrorcounter_136071 == 0)) goto LA25;
			nimln(62, "nimrod.nim");
			{
				nimln(730, "system.nim");
				if (!((gglobaloptions_113109 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				nimln(63, "nimrod.nim");
				{
					NimStringDesc* ex;
					NimStringDesc* LOC35;
					...
					NimStringDesc* LOC38;
					nimln(63, "nimrod.nim");
					if (!(gcmd_113111 == ((NU8) 4))) goto LA33;
					nimln(64, "nimrod.nim");
					nimln(65, "nimrod.nim");
					nimln(65, "nimrod.nim");
					nimln(65, "nimrod.nim");
					LOC35 = 0;
					LOC35 = nosChangeFileExt(gprojectfull_113199, ((NimStringDesc*) &TMP7240));
					LOC36 = 0;
					LOC36 = prependcurdir_422401(LOC35);
					LOC37 = 0;
					LOC37 = completecfilepath_146681(LOC36, NIM_TRUE);
					ex = nospquoteShell(LOC37);
					nimln(66, "nimrod.nim");
					nimln(66, "nimrod.nim");
					LOC38 = 0;
					LOC38 = rawNewString(ex->Sup.len + arguments_417205->Sup.len + 6);
appendString(LOC38, ((NimStringDesc*) &TMP7241));
appendString(LOC38, ex);
appendChar(LOC38, 32);
appendString(LOC38, arguments_417205);
					execexternalprogram_146713(LOC38);				}				goto LA31;
				LA33: ;
				{
					...
					nimln(69, "nimrod.nim");
					{
						...
						nimln(69, "nimrod.nim");
						if (!(0 < outfile_113115->Sup.len)) goto LA42;
						nimln(71, "nimrod.nim");
						binpath = prependcurdir_422401(outfile_113115);
					}					goto LA40;
					LA42: ;
					{
						NimStringDesc* LOC45;
						...
						nimln(74, "nimrod.nim");
						LOC45 = 0;
						LOC45 = nosChangeFileExt(gprojectfull_113199, ((NimStringDesc*) &TMP7237));
						binpath = prependcurdir_422401(LOC45);
					}					LA40: ;
					nimln(75, "nimrod.nim");
					...
					nimln(76, "nimrod.nim");
					LOC46 = 0;
					LOC46 = rawNewString(ex->Sup.len + arguments_417205->Sup.len + 1);
appendString(LOC46, ex);
appendChar(LOC46, 32);
appendString(LOC46, arguments_417205);
					execexternalprogram_146713(LOC46);				}				LA31: ;
			}			LA29: ;
		}		LA25: ;
	}	LA1: ;
	popFrame();
...
N_NOINLINE(void, nimrodInit)(void) {
	...
	initdefines_140065();	nimln(87, "nimrod.nim");
	handlecmdline_422603();	nimln(88, "nimrod.nim");
	nimln(706, "system.nim");
	exit(((NI) (((NI8) ((0 < gerrorcounter_136071))))));	popFrame();
}
