...
N_NIMCALL(Tnode214790*, semlocals_422005)(Tcontext264020* c, Tnode214790* n) {
	...
	result = 0;
	counter = ((NI) 0);
	tupletype = newtypes_264184(((NU8) 18), c);
					...
					s_422084 = inittabiter_221073((&it_422082), HEX3Atmp_422079);
					{
						while (1) {
							...
							it_422024 = s_422084;
							{
								...
								if (!LOC13) goto LA16;
								LOC18 = 0;
								LOC18 = getcurrowner_264209();
								field = newsym_215683(((NU8) 18), (*it_422024).name, LOC18, (*n).info);
								...
								addsonskipintlit_258680(tupletype, (*field).typ);
