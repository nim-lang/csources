...
static N_INLINE(ttype190847*, lastson_191203)(ttype190847* n) {
	...
	if ((NU)((NI64)(TMP6199)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP6199)];
	popFrame();
	return result;
}
...
N_NIMCALL(trope147007*, makellvmstring_468723)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(190, "ccgutils.nim");
		{
			...
			TMP6209 = modInt((NI64)(TMP6208), 64);
			if (!(((NI) ((NI64)(TMP6209))) == 0)) goto LA4;
