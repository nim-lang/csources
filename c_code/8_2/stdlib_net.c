...
{	sent = send_524715(socket, ((void*) (data->data)), data->Sup.len);
	...
	LA3: ;
	{
		...
		LOC14 = 0;
		LOC14 = (*e_525219).Sup.Sup.message; (*e_525219).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP4953));
...
{	waited = 0.0;
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_523818(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP4960));
			...
			LA4: ;
			{
				...
				LOC20 = 0;
				LOC20 = waitfor_523818(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP4960));
...
N_NIMCALL(void, close_522417)(socketimpl520407* socket) {
	...
	TMP4962.status = setjmp(TMP4962.context);
	if (TMP4962.status == 0) {
		popSafePoint();
	}
	else {
