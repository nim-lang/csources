...
N_NIMCALL(void, handlecmdline_534607)(void) {
	...
	LA4: ;
	{
		processcmdline_528209(((NU8) 0), ((NimStringDesc*) &TMP1913));
		{
			TSafePoint TMP1914;
			TY117589 p;
			NimStringDesc* LOC15;
			...
			TMP1914.status = setjmp(TMP1914.context);
			if (TMP1914.status == 0) {
		...
		LA7: ;
		loadconfigs_202811(((NimStringDesc*) &TMP1942));
		initvars_186884();
		processcmdline_528209(((NU8) 1), ((NimStringDesc*) &TMP1913));
		maincommand_531628();
		{
			NimStringDesc* LOC22;
...
appendString(LOC49, arguments_193669);
					execexternalprogram_186992(LOC49, ((NimStringDesc*) &TMP1913));
				}
				goto LA36;
				LA38: ;
				{
					...
					LA54: ;
					{
						NimStringDesc* LOC57;
						LOC57 = 0;
						LOC57 = noschangeFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP1913));
...
appendString(LOC58, arguments_193669);
					execexternalprogram_186992(LOC58, ((NimStringDesc*) &TMP1913));
				}
				LA36: ;
			}
			LA29: ;
