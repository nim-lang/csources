...
N_NIMCALL(void, initspecials_188403)(void);
...
NIM_CONST TY188333 specialwords_188332 = {((NimStringDesc*) &TMP448),
...
N_NIMCALL(void, initspecials_188403)(void) {
	{
		...
		res_188476 = ((NU8) 1);
		{
			while (1) {
				NI LOC4;
				tident184021* LOC5;
				if (!(res_188476 <= ((NU8) 254))) goto LA3;
				s_188464 = res_188476;
				LOC4 = 0;
				LOC4 = hashignorestyle_128885(specialwords_188332[(s_188464)- 0]);
				LOC5 = 0;
				LOC5 = getident_184482(specialwords_188332[(s_188464)- 0], LOC4);
				(*LOC5).Sup.Id = ((NI) (s_188464));
				res_188476 += 1;
			} LA3: ;
		}
	}
...
N_NIMCALL(NU8, whichkeyword_188393)(NimStringDesc* id) {
	...
	result = 0;
	LOC1 = 0;
	LOC1 = getident_184472(id);
	result = whichkeyword_188382(LOC1);
	return result;
}
