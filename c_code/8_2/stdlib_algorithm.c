...
typedef N_CLOSURE_PTR(NI, TMP2619) (Tsym190843* x_350584, Tsym190843* y_350586);
...
{	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI)(m + ((NI) 1))], cmp.ClEnv):((TMP2619)(cmp.ClPrc))(a[m], a[(NI)(m + ((NI) 1))]);
		LOC4 = 0;
	...
	k = lo;
	{
		while (1) {
			...
			if (!LOC11) goto LA10;
			{
				...
				NI LOC16;
				LOC15 = 0;
				LOC15 = cmp.ClEnv? cmp.ClPrc(b[i], a[j], cmp.ClEnv):((TMP2620)(cmp.ClPrc))(b[i], a[j]);
				LOC16 = 0;
