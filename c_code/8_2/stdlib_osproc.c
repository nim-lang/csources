...
N_NIMCALL(pid_t, startprocessauxfork_128001)(tstartprocessdata127915* data);
N_NIMCALL(void, oserror_106205)(NI32 errorcode);
N_NIMCALL(NI32, oslasterror_106231)(void);
static N_INLINE(void, pushSafePoint)(TSafePoint* s);
N_CDECL(void, startprocessafterfork_128004)(tstartprocessdata127915* data);
...
extern TY10865* environment_110806;
...
N_NIMCALL(NCSTRING*, envtocstringarray_127841)(void) {
	...
	nimln(1181, "os.nim");
	nimln(1181, "os.nim");
	HEX3Atmp_127888 = (environment_110806->Sup.len-1);
	nimln(1458, "system.nim");
	res_127890 = 0;
	nimln(1459, "system.nim");
	while (1) {
		...
		i_127886 = res_127890;
		nimln(1182, "os.nim");
		if ((NU)(i_127886) >= (NU)(environment_110806->Sup.len)) raiseIndexError();
		p_127892 = nsuFindChar(environment_110806->data[i_127886], 61, 0);
		nimln(1183, "os.nim");
		nimln(1183, "os.nim");
		if ((NU)(i_127886) >= (NU)(environment_110806->Sup.len)) raiseIndexError();
		nimln(1183, "os.nim");
		TMP367 = subInt(p_127892, 1);
		key_127845 = copyStrLast(environment_110806->data[i_127886], 0, (NI64)(TMP367));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_127886) >= (NU)(environment_110806->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP368 = addInt(p_127892, 1);
		val_127846 = copyStr(environment_110806->data[i_127886], (NI64)(TMP368));
	...
	nimln(1181, "os.nim");
	nimln(1181, "os.nim");
	HEX3Atmp_127904 = (environment_110806->Sup.len-1);
	nimln(1458, "system.nim");
	res_127906 = 0;
	nimln(1459, "system.nim");
	while (1) {
		...
		i_127902 = res_127906;
		nimln(1182, "os.nim");
		if ((NU)(i_127902) >= (NU)(environment_110806->Sup.len)) raiseIndexError();
		p_127908 = nsuFindChar(environment_110806->data[i_127902], 61, 0);
		nimln(1183, "os.nim");
		nimln(1183, "os.nim");
		if ((NU)(i_127902) >= (NU)(environment_110806->Sup.len)) raiseIndexError();
		nimln(1183, "os.nim");
		TMP371 = subInt(p_127908, 1);
		key_127865 = copyStrLast(environment_110806->data[i_127902], 0, (NI64)(TMP371));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_127902) >= (NU)(environment_110806->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP372 = addInt(p_127908, 1);
		val_127866 = copyStr(environment_110806->data[i_127902], (NI64)(TMP372));
...
N_NIMCALL(pid_t, startprocessauxfork_128001)(tstartprocessdata127915* data) {
	...
	if (TMP377.status == 0) {
		...
		nimln(778, "osproc.nim");
		{
			...
			startprocessafterfork_128004(&datacopy);
...
N_NIMCALL(tprocess126402*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, tstringtable121810* env, NU8 options) {
	...
	if (TMP381.status == 0) {
		...
		if (TMP382.status == 0) {
			...
			pid = startprocessauxfork_128001(&data);
