...
STRING_LITERAL(TMP1208, "0123456789ABCDEF", 16);
STRING_LITERAL(TMP1210, "", 0);
static NIM_CONST TY210607 TMP1557 = {
0x00, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2097, "\\x", 2);
...
101}
;
STRING_LITERAL(TMP4847, "GB", 2);
STRING_LITERAL(TMP4848, "MB", 2);
STRING_LITERAL(TMP4849, "KB", 2);
STRING_LITERAL(TMP4850, "B", 1);
	...
	result = mnewString(len);
	{
		...
		res_95595 = HEX3Atmp_95592;
		{
			while (1) {
				...
				j_95588 = res_95595;
				result->data[j_95588] = ((NimStringDesc*) &TMP1208)->data[(NI32)(((NI32)(NU32)(NU64)((NI64)((NU64)(x) >> (NU64)(shift)))) & ((NI32) 15))];
				shift = (NI64)(shift + 4);
				res_95595 -= 1;
			} LA3: ;
		}
...
N_NIMCALL(NimStringDesc*, quoteifcontainswhite_97196)(NimStringDesc* s) {
	...
	result = 0;
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = nsuFindCharSet(s, TMP1557, 0);
		LOC3 = (0 <= LOC4);
		if (!(LOC3)) goto LA5;
...
N_NIMCALL(TY118408*, nsuSplitChar)(NimStringDesc* s, NIM_CHAR sep) {
	TY118408* result;
	result = 0;
	result = (TY118408*) newSeq((&NTI118408), 0);
	{
		...
		last_95472 = 0;
		{
			if (!(0 < s->Sup.len)) goto LA4;
			{
				while (1) {
					...
					result = (TY118408*) incrSeq(&(result)->Sup, sizeof(NimStringDesc*));
					LOC12 = 0;
...
appendString(LOC12, ((NimStringDesc*) &TMP4848));
		result = LOC12;
	}
	goto LA1;
	LA10: ;
...
appendString(LOC19, ((NimStringDesc*) &TMP4849));
		result = LOC19;
	}
	goto LA1;
	LA17: ;
...
appendString(LOC24, ((NimStringDesc*) &TMP4850));
		result = LOC24;
	}
	LA1: ;
	return result;
