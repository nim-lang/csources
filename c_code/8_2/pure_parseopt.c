...
N_NIMCALL(NI, parseword_415802)(NimStringDesc* s, NI i, NimStringDesc** w, TY112118 delim);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(NimStringDesc*, addChar)(NimStringDesc* s, NIM_CHAR c);
N_NIMCALL(void, handleshortoption_415876)(toptparser415607* p);
...
STRING_LITERAL(TMP7034, "", 0);
STRING_LITERAL(TMP7037, "", 0);
static NIM_CONST TY112118 TMP7038 = {
0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY112118 TMP7039 = {
...
N_NIMCALL(void, initoptparser_415619)(NimStringDesc* cmdline, toptparser415607* Result) {
	...
	LA3: ;
	{
		...
		unsureAsgnRef((void**) &(*Result).Cmd, copyString(((NimStringDesc*) &TMP7034)));
		i_415632 = 0;
		HEX3Atmp_415634 = 0;
		nimln(53, "parseopt.nim");
		HEX3Atmp_415634 = paramcount_106029();
		...
		while (1) {
			...
			NimStringDesc* LOC9;
			nimln(1302, "system.nim");
			if (!(res_415636 <= HEX3Atmp_415634)) goto LA6;
			nimln(1301, "system.nim");
			i_415632 = res_415636;
...
appendChar(LOC7, 32);
			...
			res_415636 = addInt(res_415636, 1);
		} LA6: ;
	}	LA1: ;
	nimln(55, "parseopt.nim");
	(*Result).Kind = ((NU8) 0);
	nimln(56, "parseopt.nim");
	unsureAsgnRef((void**) &(*Result).Key, copyString(((NimStringDesc*) &TMP7037)));
	nimln(57, "parseopt.nim");
	unsureAsgnRef((void**) &(*Result).Val, copyString(((NimStringDesc*) &TMP7037)));
	popFrame();
}
N_NIMCALL(NI, parseword_415802)(NimStringDesc* s, NI i, NimStringDesc** w, TY112118 delim) {
	NI result;
...
N_NIMCALL(void, handleshortoption_415876)(toptparser415607* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_415802((*p).Cmd, i, &(*p).Val, TMP7038);
	}	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser415607* p) {
	...
	nimln(99, "parseopt.nim");
	{
		...
		handleshortoption_415876(p);		nimln(101, "parseopt.nim");
		goto BeforeRet;
	}	LA4: ;
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_415802((*p).Cmd, i, &(*p).Key, TMP7039);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_415802((*p).Cmd, i, &(*p).Val, TMP7038);
			}			goto LA13;
			LA15: ;
			{
		...
		LA10: ;
		{
			...
			handleshortoption_415876(p);		}		LA8: ;
	}	break;
	default:
	{
		...
		(*p).Pos = parseword_415802((*p).Cmd, i, &(*p).Key, TMP7038);
	}	break;
	}
	BeforeRet: ;	popFrame();
}
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser415607* p) {
	...
	nimln(128, "parseopt.nim");
	nimln(128, "parseopt.nim");
	TMP7040 = subInt((*p).Cmd->Sup.len, 1);
	LOC1 = 0;
	LOC1 = copyStrLast((*p).Cmd, (*p).Pos, (NI64)(TMP7040));
...
static TNimNode* TMP7042[6];
static TNimNode* TMP7043[4];
NI TMP7045;
static char* NIM_CONST TMP7044[4] = {
"cmdEnd", 
"cmdArgument", 
"cmdLongoption", 
"cmdShortOption"};
static TNimNode TMP7032[12];
NTI415607.size = sizeof(toptparser415607);
NTI415607.kind = 17;
NTI415607.base = (&NTI1009);
NTI415607.flags = 2;
TMP7042[0] = &TMP7032[1];
TMP7032[1].kind = 1;
TMP7032[1].offset = offsetof(toptparser415607, Cmd);
TMP7032[1].typ = (&NTI142);
TMP7032[1].name = "cmd";
TMP7042[1] = &TMP7032[2];
TMP7032[2].kind = 1;
TMP7032[2].offset = offsetof(toptparser415607, Pos);
TMP7032[2].typ = (&NTI105);
TMP7032[2].name = "pos";
TMP7042[2] = &TMP7032[3];
TMP7032[3].kind = 1;
TMP7032[3].offset = offsetof(toptparser415607, Inshortstate);
TMP7032[3].typ = (&NTI133);
TMP7032[3].name = "inShortState";
TMP7042[3] = &TMP7032[4];
NTI415605.size = sizeof(NU8);
NTI415605.kind = 14;
NTI415605.base = 0;
NTI415605.flags = 3;
for (TMP7045 = 0; TMP7045 < 4; TMP7045++) {
TMP7032[TMP7045+5].kind = 1;
TMP7032[TMP7045+5].offset = TMP7045;
TMP7032[TMP7045+5].name = TMP7044[TMP7045];
TMP7043[TMP7045] = &TMP7032[TMP7045+5];
}
TMP7032[9].len = 4; TMP7032[9].kind = 2; TMP7032[9].sons = &TMP7043[0];
NTI415605.node = &TMP7032[9];
TMP7032[4].kind = 1;
TMP7032[4].offset = offsetof(toptparser415607, Kind);
TMP7032[4].typ = (&NTI415605);
TMP7032[4].name = "kind";
TMP7042[4] = &TMP7032[10];
TMP7032[10].kind = 1;
TMP7032[10].offset = offsetof(toptparser415607, Key);
TMP7032[10].typ = (&NTI142);
TMP7032[10].name = "key";
TMP7042[5] = &TMP7032[11];
TMP7032[11].kind = 1;
TMP7032[11].offset = offsetof(toptparser415607, Val);
TMP7032[11].typ = (&NTI142);
TMP7032[11].name = "val";
TMP7032[0].len = 6; TMP7032[0].kind = 2; TMP7032[0].sons = &TMP7042[0];
NTI415607.node = &TMP7032[0];
}
