...
N_NIMCALL(void, prepend_126309)(tlinkedlist126028* list, tlistentry126022* entry);
static N_INLINE(NIM_BOOL, eqStrings)(NimStringDesc* a, NimStringDesc* b);
N_NIMCALL(tstrentry126024*, newstrentry_126260)(NimStringDesc* data);
N_NIMCALL(void, TMP1668)(void* p, NI op);
...
TNimType NTI126022; /* TListEntry */
TNimType NTI126020; /* PListEntry */
TNimType NTI126028; /* TLinkedList */
extern TNimType NTI108; /* int */
extern tgcheap46816 gch_46844;
TNimType NTI126024; /* TStrEntry */
extern TNimType NTI149; /* string */
TNimType NTI126026; /* PStrEntry */
N_NIMCALL(void, TMP772)(void* p, NI op) {
	tlistentry126022* a;
	a = (tlistentry126022*)p;
...
N_NIMCALL(void, bringtofront_126741)(tlinkedlist126028* list, tlistentry126022* entry) {
	remove_126652(list, entry);
	prepend_126309(list, entry);
}
...
N_NIMCALL(NIM_BOOL, contains_126224)(tlinkedlist126028* list, NimStringDesc* data) {
	...
	it = (*list).Head;
	{
		while (1) {
			...
			{
				if (!eqStrings((*((tstrentry126024*) (it))).Data, data)) goto LA5;
				result = NIM_TRUE;
				goto BeforeRet;
			}
			LA5: ;
...
N_NIMCALL(tstrentry126024*, newstrentry_126260)(NimStringDesc* data) {
	tstrentry126024* result;
	NimStringDesc* LOC1;
	result = 0;
	result = (tstrentry126024*) newObj((&NTI126026), sizeof(tstrentry126024));
	(*result).Sup.Sup.m_type = (&NTI126024);
	LOC1 = 0;
...
N_NIMCALL(void, prependstr_126424)(tlinkedlist126028* list, NimStringDesc* data) {
	tstrentry126024* LOC1;
	LOC1 = 0;
	LOC1 = newstrentry_126260(data);
	prepend_126309(list, &LOC1->Sup);
}
...
N_NIMCALL(void, excludepath_126807)(tlinkedlist126028* list, NimStringDesc* data) {
	...
	{
		while (1) {
			tlistentry126022* nxt;
			if (!!((it == NIM_NIL))) goto LA2;
			nxt = (*it).Next;
			{
				NI LOC5;
				LOC5 = 0;
				LOC5 = noscmpPaths((*((tstrentry126024*) (it))).Data, data);
				if (!(LOC5 == 0)) goto LA6;
				remove_126652(list, it);
			}
			LA6: ;
			it = nxt;
		} LA2: ;
...
N_NIMCALL(NIM_BOOL, includestr_126297)(tlinkedlist126028* list, NimStringDesc* data) {
	...
	result = 0;
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = contains_126224(&(*list), data);
		if (!LOC3) goto LA4;
		result = NIM_TRUE;
		goto BeforeRet;
	}
	LA4: ;
	appendstr_126286(list, data);
	BeforeRet: ;
	return result;
}
...
NTI126022.size = sizeof(tlistentry126022);
NTI126022.kind = 17;
NTI126022.base = (&NTI3211);
TMP771[0] = &TMP23[1];
NTI126020.size = sizeof(tlistentry126022*);
NTI126020.kind = 22;
NTI126020.base = (&NTI126022);
NTI126020.marker = TMP772;
TMP23[1].kind = 1;
TMP23[1].offset = offsetof(tlistentry126022, Prev);
TMP23[1].typ = (&NTI126020);
TMP23[1].name = "prev";
TMP771[1] = &TMP23[2];
TMP23[2].kind = 1;
TMP23[2].offset = offsetof(tlistentry126022, Next);
TMP23[2].typ = (&NTI126020);
TMP23[2].name = "next";
TMP23[0].len = 2; TMP23[0].kind = 2; TMP23[0].sons = &TMP771[0];
NTI126022.node = &TMP23[0];
NTI126028.size = sizeof(tlinkedlist126028);
NTI126028.kind = 18;
NTI126028.base = 0;
TMP964[0] = &TMP23[4];
TMP23[4].kind = 1;
TMP23[4].offset = offsetof(tlinkedlist126028, Head);
TMP23[4].typ = (&NTI126020);
TMP23[4].name = "head";
TMP964[1] = &TMP23[5];
TMP23[5].kind = 1;
TMP23[5].offset = offsetof(tlinkedlist126028, Tail);
TMP23[5].typ = (&NTI126020);
TMP23[5].name = "tail";
TMP964[2] = &TMP23[6];
TMP23[6].kind = 1;
TMP23[6].offset = offsetof(tlinkedlist126028, Counter);
TMP23[6].typ = (&NTI108);
TMP23[6].name = "counter";
TMP23[3].len = 3; TMP23[3].kind = 2; TMP23[3].sons = &TMP964[0];
NTI126028.node = &TMP23[3];
NTI126024.size = sizeof(tstrentry126024);
NTI126024.kind = 17;
NTI126024.base = (&NTI126022);
TMP23[7].kind = 1;
TMP23[7].offset = offsetof(tstrentry126024, Data);
TMP23[7].typ = (&NTI149);
TMP23[7].name = "data";
NTI126024.node = &TMP23[7];
NTI126026.size = sizeof(tstrentry126024*);
NTI126026.kind = 22;
NTI126026.base = (&NTI126024);
NTI126026.marker = TMP1668;
}
