...
typedef N_NIMCALL_PTR(NIM_BOOL, tcompareproc116025) (tlistentry116017* entry, void* closure);
...
N_NIMCALL(tstrentry116019*, newstrentry_116263)(NimStringDesc* data);
...
N_NIMCALL(void, prepend_116300)(tlinkedlist116023* list, tlistentry116017* entry);
N_NIMCALL(void, prependstr_116437)(tlinkedlist116023* list, NimStringDesc* data);
N_NIMCALL(void, insertbefore_116444)(tlinkedlist116023* list, tlistentry116017* pos, tlistentry116017* entry);
...
N_NIMCALL(tlistentry116017*, find_116830)(tlinkedlist116023* list, tcompareproc116025 fn, void* closure);
...
TNimType NTI116017; /* TListEntry */
TNimType NTI116015; /* PListEntry */
TNimType NTI116019; /* TStrEntry */
extern TNimType NTI143; /* string */
TNimType NTI116021; /* PStrEntry */
TNimType NTI116023; /* TLinkedList */
...
N_NIMCALL(NIM_BOOL, contains_116237)(tlinkedlist116023* list, NimStringDesc* data) {
	...
	while (1) {
		...
		{
			nimln(45, "lists.nim");
			if (it) chckObj((*it).Sup.m_type, (&NTI116019));
			if (!eqStrings((*((tstrentry116019*) (it))).Data, data)) goto LA4;
			nimln(46, "lists.nim");
			nimln(46, "lists.nim");
			result = NIM_TRUE;
			goto BeforeRet;
...
N_NIMCALL(tstrentry116019*, newstrentry_116263)(NimStringDesc* data) {
	tstrentry116019* result;
	NimStringDesc* LOC1;
	nimfr("newStrEntry", "lists.nim")
	result = 0;
	nimln(50, "lists.nim");
	result = (tstrentry116019*) newObj((&NTI116021), sizeof(tstrentry116019));
	(*result).Sup.Sup.m_type = (&NTI116019);
	nimln(51, "lists.nim");
	LOC1 = 0;
...
N_NIMCALL(void, appendstr_116285)(tlinkedlist116023* list, NimStringDesc* data) {
	tstrentry116019* LOC1;
	nimfr("appendStr", "lists.nim")
	nimln(54, "lists.nim");
	nimln(54, "lists.nim");
	LOC1 = 0;
	LOC1 = newstrentry_116263(data);
	append_116042(list, &LOC1->Sup);
	popFrame();
}
...
N_NIMCALL(NIM_BOOL, includestr_116292)(tlinkedlist116023* list, NimStringDesc* data) {
	...
	nimln(57, "lists.nim");
	{
		...
		nimln(57, "lists.nim");
		LOC3 = 0;
		LOC3 = contains_116237(&(*list), data);
		if (!LOC3) goto LA4;
		nimln(57, "lists.nim");
		nimln(57, "lists.nim");
		result = NIM_TRUE;
...
NTI116017.size = sizeof(tlistentry116017);
NTI116017.kind = 17;
NTI116017.base = (&NTI2409);
TMP261[0] = &TMP258[1];
NTI116015.size = sizeof(tlistentry116017*);
NTI116015.kind = 22;
NTI116015.base = (&NTI116017);
NTI116015.marker = TMP262;
TMP258[1].kind = 1;
TMP258[1].offset = offsetof(tlistentry116017, Prev);
TMP258[1].typ = (&NTI116015);
TMP258[1].name = "prev";
TMP261[1] = &TMP258[2];
TMP258[2].kind = 1;
TMP258[2].offset = offsetof(tlistentry116017, Next);
TMP258[2].typ = (&NTI116015);
TMP258[2].name = "next";
TMP258[0].len = 2; TMP258[0].kind = 2; TMP258[0].sons = &TMP261[0];
NTI116017.node = &TMP258[0];
NTI116019.size = sizeof(tstrentry116019);
NTI116019.kind = 17;
NTI116019.base = (&NTI116017);
TMP258[3].kind = 1;
TMP258[3].offset = offsetof(tstrentry116019, Data);
TMP258[3].typ = (&NTI143);
TMP258[3].name = "data";
NTI116019.node = &TMP258[3];
NTI116021.size = sizeof(tstrentry116019*);
NTI116021.kind = 22;
NTI116021.base = (&NTI116019);
NTI116021.marker = TMP263;
NTI116023.size = sizeof(tlinkedlist116023);
NTI116023.kind = 18;
NTI116023.base = 0;
TMP3247[0] = &TMP258[5];
TMP258[5].kind = 1;
TMP258[5].offset = offsetof(tlinkedlist116023, Head);
TMP258[5].typ = (&NTI116015);
TMP258[5].name = "head";
TMP3247[1] = &TMP258[6];
TMP258[6].kind = 1;
TMP258[6].offset = offsetof(tlinkedlist116023, Tail);
TMP258[6].typ = (&NTI116015);
TMP258[6].name = "tail";
TMP3247[2] = &TMP258[7];
TMP258[7].kind = 1;
TMP258[7].offset = offsetof(tlinkedlist116023, Counter);
TMP258[7].typ = (&NTI106);
TMP258[7].name = "counter";
TMP258[4].len = 3; TMP258[4].kind = 2; TMP258[4].sons = &TMP3247[0];
NTI116023.node = &TMP258[4];
}
