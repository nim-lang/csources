...
N_NIMCALL(tnode223819*, totreeset_282754)(tbitset281012* s, ttype223855* settype, tlineinfo194539 info);
...
N_NIMCALL(void, tobitset_282004)(tnode223819* s, tbitset281012** b) {
	...
	bitsetinit_281021(b, ((NI) (LOC1)));
	{
		...
		HEX3Atmp_282728 = (NI64)(LOC3 - 1);
		res_282731 = 0;
		{
			while (1) {
				if (!(res_282731 <= HEX3Atmp_282728)) goto LA5;
				i_282617 = res_282731;
				{
...
N_NIMCALL(tnode223819*, diffsets_282054)(tnode223819* a, tnode223819* b) {
	...
	result = totreeset_282754(x, (*a).Typ, (*a).Info);
	return result;
}
...
N_NIMCALL(NI64, cardset_282089)(tnode223819* s) {
	...
	result = 0;
	{
		...
		HEX3Atmp_283116 = (NI64)(LOC2 - 1);
		res_283119 = 0;
		{
			while (1) {
				if (!(res_283119 <= HEX3Atmp_283116)) goto LA4;
				i_283023 = res_283119;
				{
					NI64 LOC9;
					NI64 LOC10;
					if (!((*(*s).kindU.S6.Sons->data[i_283023]).Kind == ((NU8) 44))) goto LA7;
					LOC9 = 0;
					LOC9 = getordvalue_260187((*(*s).kindU.S6.Sons->data[i_283023]).kindU.S6.Sons->data[1]);
					LOC10 = 0;
					LOC10 = getordvalue_260187((*(*s).kindU.S6.Sons->data[i_283023]).kindU.S6.Sons->data[0]);
...
N_NIMCALL(tnode223819*, complement_282966)(tnode223819* a) {
	...
	tobitset_282004(a, &x);
	{
		...
		i_282984 = 0;
		HEX3Atmp_282987 = 0;
		HEX3Atmp_282987 = (x->Sup.len-1);
		res_282990 = 0;
		{
			while (1) {
				if (!(res_282990 <= HEX3Atmp_282987)) goto LA3;
				i_282984 = res_282990;
				x->data[i_282984] = (NI8)((NU8) ~(x->data[i_282984]));
				res_282990 += 1;
			} LA3: ;
		}
	}
