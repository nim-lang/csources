...
N_NIMCALL(tnode190813*, totreeset_247679)(tbitset246012* s, ttype190847* settype, tlineinfo165527 info);
...
N_NIMCALL(void, tobitset_247002)(tnode190813* s, tbitset246012** b) {
	...
	HEX3Atmp_247671 = (NI64)(TMP3164);
	nimln(1451, "system.nim");
	res_247673 = 0;
	nimln(1452, "system.nim");
	while (1) {
		nimln(1452, "system.nim");
		if (!(res_247673 <= HEX3Atmp_247671)) goto LA3;
		nimln(1451, "system.nim");
		i_247558 = res_247673;
		...
		LA4: ;
		nimln(1454, "system.nim");
		res_247673 = addInt(res_247673, 1);
	} LA3: ;
	popFrame();
}
...
N_NIMCALL(tnode190813*, unionsets_247033)(tnode190813* a, tnode190813* b) {
	...
	result = totreeset_247679(x, (*a).Typ, (*a).Info);
	popFrame();
	return result;
}
...
N_NIMCALL(tnode190813*, complement_247861)(tnode190813* a) {
	...
	nimln(147, "nimsets.nim");
	HEX3Atmp_247881 = (x->Sup.len-1);
	nimln(1451, "system.nim");
	res_247883 = 0;
	nimln(1452, "system.nim");
	while (1) {
		nimln(1452, "system.nim");
		if (!(res_247883 <= HEX3Atmp_247881)) goto LA1;
		nimln(1451, "system.nim");
		i_247879 = res_247883;
		nimln(147, "nimsets.nim");
		if ((NU)(i_247879) >= (NU)(x->Sup.len)) raiseIndexError();
		nimln(147, "nimsets.nim");
		if ((NU)(i_247879) >= (NU)(x->Sup.len)) raiseIndexError();
		x->data[i_247879] = (NI8)((NU8) ~(x->data[i_247879]));
		nimln(1454, "system.nim");
		res_247883 = addInt(res_247883, 1);
	} LA1: ;
...
N_NIMCALL(NI64, cardset_247063)(tnode190813* s) {
	...
	HEX3Atmp_248000 = (NI64)(TMP3172);
	nimln(1451, "system.nim");
	res_248002 = 0;
	nimln(1452, "system.nim");
	while (1) {
		nimln(1452, "system.nim");
		if (!(res_248002 <= HEX3Atmp_248000)) goto LA2;
		nimln(1451, "system.nim");
		i_247904 = res_248002;
		nimln(155, "nimsets.nim");
		{
			...
			nimln(155, "nimsets.nim");
			if (((TMP3159[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3160));
			if ((NU)(i_247904) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!((*(*s).kindU.S6.Sons->data[i_247904]).Kind == ((NU8) 44))) goto LA5;
			...
			if (((TMP3159[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3160));
			if ((NU)(i_247904) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (((TMP3159[(*(*s).kindU.S6.Sons->data[i_247904]).Kind/8] &(1<<((*(*s).kindU.S6.Sons->data[i_247904]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3160));
			if ((NU)(1) >= (NU)((*(*s).kindU.S6.Sons->data[i_247904]).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC7 = 0;
			LOC7 = getordvalue_226150((*(*s).kindU.S6.Sons->data[i_247904]).kindU.S6.Sons->data[1]);
			TMP3173 = addInt64(result, LOC7);
			nimln(157, "nimsets.nim");
			if (((TMP3159[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3160));
			if ((NU)(i_247904) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (((TMP3159[(*(*s).kindU.S6.Sons->data[i_247904]).Kind/8] &(1<<((*(*s).kindU.S6.Sons->data[i_247904]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3160));
			if ((NU)(0) >= (NU)((*(*s).kindU.S6.Sons->data[i_247904]).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC8 = 0;
			LOC8 = getordvalue_226150((*(*s).kindU.S6.Sons->data[i_247904]).kindU.S6.Sons->data[0]);
		...
		LA3: ;
		nimln(1454, "system.nim");
		res_248002 = addInt(res_248002, 1);
	} LA2: ;
	popFrame();
	return result;
}
...
N_NIMCALL(NIM_BOOL, sethasrange_247029)(tnode190813* s) {
	...
	HEX3Atmp_248056 = (NI64)(TMP3177);
	nimln(1451, "system.nim");
	res_248058 = 0;
	nimln(1452, "system.nim");
	while (1) {
		nimln(1452, "system.nim");
		if (!(res_248058 <= HEX3Atmp_248056)) goto LA6;
		nimln(1451, "system.nim");
		i_248032 = res_248058;
		nimln(166, "nimsets.nim");
		{
			nimln(166, "nimsets.nim");
			if (((TMP3159[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3160));
			if ((NU)(i_248032) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!((*(*s).kindU.S6.Sons->data[i_248032]).Kind == ((NU8) 44))) goto LA9;
		...
		LA9: ;
		nimln(1454, "system.nim");
		res_248058 = addInt(res_248058, 1);
	} LA6: ;
