...
static N_INLINE(NIM_BOOL, mustrehash_167054)(NI length, NI counter);
...
static N_INLINE(NI, nexttry_167205)(NI h, NI maxhash);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NIMCALL(ttrunk167039*, intsetget_167212)(tintset167043* t, NI key);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(void, intsetrawinsert_167233)(tintset167043* t, ttrunkseq167041** data, ttrunk167039* desc);
...
N_NIMCALL(void, intsetenlarge_167604)(tintset167043* t);
N_NIMCALL(void, nimGCvisit)(void* d, NI op);
N_NIMCALL(void, TMP1929)(void* p, NI op);
N_NIMCALL(void, TMP1930)(void* p, NI op);
N_NIMCALL(void*, newSeq)(TNimType* typ, NI len);
N_NIMCALL(void, unsureAsgnRef)(void** dest, void* src);
N_NIMCALL(ttrunk167039*, intsetput_167661)(tintset167043* t, NI key);
...
N_NIMCALL(void, assign_167914)(tintset167043* dest, tintset167043* src);
N_NIMCALL(NimStringDesc*, HEX24_168076)(tintset167043* s);
...
TNimType NTI167039; /* TTrunk */
extern TNimType NTI105; /* int */
extern TNimType NTI21418; /* array[0..7, int] */
TNimType NTI167037; /* PTrunk */
TNimType NTI167041; /* TTrunkSeq */
TNimType NTI167043; /* TIntSet */
...
N_NIMCALL(void, intsetenlarge_167604)(tintset167043* t) {
	...
	n = (ttrunkseq167041*) newSeq((&NTI167041), (NI64)(TMP1927));
	i_167629 = 0;
	...
	while (1) {
		...
		nimln(75, "intsets.nim");
		{
			nimln(698, "system.nim");
			nimln(698, "system.nim");
			if ((NU)(i_167629) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			if (!!(((*t).Data->data[i_167629] == NIM_NIL))) goto LA4;
			nimln(75, "intsets.nim");
			if ((NU)(i_167629) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			intsetrawinsert_167233(&(*t), &n, (*t).Data->data[i_167629]);		}		LA4: ;
		nimln(1304, "system.nim");
		res_167656 = addInt(res_167656, 1);
	} LA1: ;
...
N_NIMCALL(ttrunk167039*, intsetput_167661)(tintset167043* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_167054((NI64)(TMP1931), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
		intsetenlarge_167604(t);	}	LA9: ;
	...
	result = (ttrunk167039*) newObj((&NTI167037), sizeof(ttrunk167039));
...
N_NIMCALL(NIM_BOOL, contains_167817)(tintset167043* s, NI key) {
	...
	nimln(97, "intsets.nim");
	t = intsetget_167212(s, (NI)((NU64)(key) >> (NU64)(9)));
...
N_NIMCALL(void, incl_167840)(tintset167043* s, NI key) {
	...
	nimln(106, "intsets.nim");
	t = intsetput_167661(s, (NI)((NU64)(key) >> (NU64)(9)));
...
N_NIMCALL(NIM_BOOL, containsorincl_167874)(tintset167043* s, NI key) {
	...
	LA3: ;
	{
		...
		incl_167840(s, key);		nimln(131, "intsets.nim");
		result = NIM_FALSE;
	}	LA1: ;
	popFrame();
	return result;
...
N_NIMCALL(void, initintset_167899)(tintset167043* Result) {
	...
	unsureAsgnRef((void**) &(*Result).Data, (ttrunkseq167041*) newSeq((&NTI167041), 8));
...
N_NIMCALL(void, assign_167914)(tintset167043* dest, tintset167043* src) {
	...
	nimln(145, "intsets.nim");
	unsureAsgnRef((void**) &(*dest).Data, (ttrunkseq167041*) newSeq((&NTI167041), (*src).Data->Sup.len));
	...
	while (1) {
		...
		n = (ttrunk167039*) newObj((&NTI167037), sizeof(ttrunk167039));
...
N_NIMCALL(NimStringDesc*, HEX24_168076)(tintset167043* s) {
	...
	while (1) {
		...
		while (1) {
			...
			NI j_168090;
			nimln(169, "intsets.nim");
			if (!(i_168086 <= 7)) goto LA2;
			nimln(170, "intsets.nim");
			if ((NU)(i_168086) > (NU)(7)) raiseIndexError();
			w_168088 = (*r_168084).Bits[(i_168086)- 0];
			...
			while (1) {
				...
				nimln(175, "intsets.nim");
				{
					...
					nimln(698, "system.nim");
					nimln(175, "intsets.nim");
					if (!!((((NI) ((NI)(w_168088 & 1))) == 0))) goto LA6;
					nimln(176, "intsets.nim");
					nimln(176, "intsets.nim");
					nimln(176, "intsets.nim");
					nimln(176, "intsets.nim");
					nimln(176, "intsets.nim");
					key_168081 = (NI)((NI)((NU64)((*r_168084).Key) << (NU64)(9)) | (NI)((NU64)((NI)((NU64)(i_168086) << (NU64)(6))) + (NU64)(j_168090)));
...
NTI167039.size = sizeof(ttrunk167039);
NTI167039.kind = 18;
NTI167039.base = 0;
TMP1928[0] = &TMP1914[1];
TMP1914[1].kind = 1;
TMP1914[1].offset = offsetof(ttrunk167039, Next);
TMP1914[1].typ = (&NTI167037);
TMP1914[1].name = "next";
TMP1928[1] = &TMP1914[2];
TMP1914[2].kind = 1;
TMP1914[2].offset = offsetof(ttrunk167039, Key);
TMP1914[2].typ = (&NTI105);
TMP1914[2].name = "key";
TMP1928[2] = &TMP1914[3];
TMP1914[3].kind = 1;
TMP1914[3].offset = offsetof(ttrunk167039, Bits);
TMP1914[3].typ = (&NTI21418);
TMP1914[3].name = "bits";
TMP1914[0].len = 3; TMP1914[0].kind = 2; TMP1914[0].sons = &TMP1928[0];
NTI167039.node = &TMP1914[0];
NTI167037.size = sizeof(ttrunk167039*);
NTI167037.kind = 22;
NTI167037.base = (&NTI167039);
NTI167037.marker = TMP1929;
NTI167041.size = sizeof(ttrunkseq167041*);
NTI167041.kind = 24;
NTI167041.base = (&NTI167037);
NTI167041.flags = 2;
NTI167041.marker = TMP1930;
NTI167043.size = sizeof(tintset167043);
NTI167043.kind = 18;
NTI167043.base = 0;
NTI167043.flags = 2;
TMP3354[0] = &TMP1914[5];
TMP1914[5].kind = 1;
TMP1914[5].offset = offsetof(tintset167043, Counter);
TMP1914[5].typ = (&NTI105);
TMP1914[5].name = "counter";
TMP3354[1] = &TMP1914[6];
TMP1914[6].kind = 1;
TMP1914[6].offset = offsetof(tintset167043, Max);
TMP1914[6].typ = (&NTI105);
TMP1914[6].name = "max";
TMP3354[2] = &TMP1914[7];
TMP1914[7].kind = 1;
TMP1914[7].offset = offsetof(tintset167043, Head);
TMP1914[7].typ = (&NTI167037);
TMP1914[7].name = "head";
TMP3354[3] = &TMP1914[8];
TMP1914[8].kind = 1;
TMP1914[8].offset = offsetof(tintset167043, Data);
TMP1914[8].typ = (&NTI167041);
TMP1914[8].name = "data";
TMP1914[4].len = 4; TMP1914[4].kind = 2; TMP1914[4].sons = &TMP3354[0];
NTI167043.node = &TMP1914[4];
}
