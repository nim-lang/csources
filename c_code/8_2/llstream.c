...
N_NIMCALL(NI, llreadfromstdin_210749)(tllstream210204* s, void* buf, NI buflen);
...
N_NIMCALL(NIM_BOOL, readlinefromstdin_210447)(NimStringDesc* prompt, NimStringDesc** line);
N_NIMCALL(void, write_12665)(FILE* f, NimStringDesc* s);
N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src);
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src);
N_NIMCALL(NimStringDesc*, resizeString)(NimStringDesc* dest, NI addlen);
N_NIMCALL(NI, counttriples_210694)(NimStringDesc* s);
static N_INLINE(NIM_BOOL, continueline_210666)(NimStringDesc* line, NIM_BOOL intriplestring);
N_NIMCALL(NIM_BOOL, endswith_210604)(NimStringDesc* x, TY210607 s);
...
TNimType NTI210204; /* TLLStream */
TNimType NTI210202; /* TLLStreamKind */
extern TNimType NTI12204; /* File */
extern TNimType NTI149; /* string */
extern TNimType NTI108; /* int */
TNimType NTI210206; /* PLLStream */
...
N_NIMCALL(tllstream210204*, llstreamopen_210233)(NimStringDesc* filename, NU8 mode) {
	...
	result = 0;
	result = (tllstream210204*) newObj((&NTI210206), sizeof(tllstream210204));
	(*result).Sup.m_type = (&NTI210204);
	(*result).Kind = ((NU8) 2);
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
...
static N_INLINE(NIM_BOOL, continueline_210666)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = LOC2;
	if (LOC1) goto LA4;
	LOC1 = endswith_210604(line, TMP1026);
	LA4: ;
	result = LOC1;
	return result;
}
...
N_NIMCALL(NI, llreadfromstdin_210749)(tllstream210204* s, void* buf, NI buflen) {
	...
	triples = 0;
	{
		while (1) {
			...
			LA5: ;
			LOC10 = 0;
			LOC10 = readlinefromstdin_210447(LOC4, &line);
			if (!LOC10) goto LA3;
...
appendString((*s).S, ((NimStringDesc*) &TMP1023));
			LOC11 = 0;
			LOC11 = counttriples_210694(line);
			triples += LOC11;
			{
				NIM_BOOL LOC14;
				LOC14 = 0;
				LOC14 = continueline_210666(line, (((NI) ((NI)(triples & 1))) == 1));
				if (!!(LOC14)) goto LA15;
				goto LA2;
			}
			LA15: ;
...
N_NIMCALL(NI, llstreamread_210256)(tllstream210204* s, void* buf, NI buflen) {
	...
	case ((NU8) 3):
	{
		result = llreadfromstdin_210749(s, buf, buflen);
	}
	break;
	}
	return result;
...
N_NIMCALL(NIM_BOOL, endswithopr_210656)(NimStringDesc* x) {
	NIM_BOOL result;
	result = 0;
	result = endswith_210604(x, TMP1327);
	return result;
}
...
N_NIMCALL(void, llstreamwriteln_210300)(tllstream210204* s, NimStringDesc* data) {
	llstreamwrite_210278(s, data);
	llstreamwrite_210278(s, ((NimStringDesc*) &TMP1023));
}
...
NTI210204.size = sizeof(tllstream210204);
NTI210204.kind = 17;
NTI210204.base = (&NTI3211);
TMP1004[0] = &TMP709[1];
NTI210202.size = sizeof(NU8);
NTI210202.kind = 14;
NTI210202.base = 0;
NTI210202.flags = 3;
...
NTI210202.node = &TMP709[6];
TMP709[1].kind = 1;
TMP709[1].offset = offsetof(tllstream210204, Kind);
TMP709[1].typ = (&NTI210202);
TMP709[1].name = "kind";
TMP1004[1] = &TMP709[7];
TMP709[7].kind = 1;
TMP709[7].offset = offsetof(tllstream210204, F);
TMP709[7].typ = (&NTI12204);
TMP709[7].name = "f";
TMP1004[2] = &TMP709[8];
TMP709[8].kind = 1;
TMP709[8].offset = offsetof(tllstream210204, S);
TMP709[8].typ = (&NTI149);
TMP709[8].name = "s";
TMP1004[3] = &TMP709[9];
TMP709[9].kind = 1;
TMP709[9].offset = offsetof(tllstream210204, Rd);
TMP709[9].typ = (&NTI108);
TMP709[9].name = "rd";
TMP1004[4] = &TMP709[10];
TMP709[10].kind = 1;
TMP709[10].offset = offsetof(tllstream210204, Wr);
TMP709[10].typ = (&NTI108);
TMP709[10].name = "wr";
TMP1004[5] = &TMP709[11];
TMP709[11].kind = 1;
TMP709[11].offset = offsetof(tllstream210204, Lineoffset);
TMP709[11].typ = (&NTI108);
TMP709[11].name = "lineOffset";
TMP709[0].len = 6; TMP709[0].kind = 2; TMP709[0].sons = &TMP1004[0];
NTI210204.node = &TMP709[0];
NTI210206.size = sizeof(tllstream210204*);
NTI210206.kind = 22;
NTI210206.base = (&NTI210204);
NTI210206.marker = TMP1008;
}
