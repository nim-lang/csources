...
N_NIMCALL(NI, counttriples_178676)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1640 = addInt(i, 1);
			if ((NU)((NI64)(TMP1640)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI64)(TMP1640)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1641 = addInt(i, 2);
			if ((NU)((NI64)(TMP1641)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI64)(TMP1641)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
appendString((*s).S, ((NimStringDesc*) &TMP1644));
	...
	result = ((buflen <= (NI64)(TMP1645)) ? buflen : (NI64)(TMP1645));
...
N_NIMCALL(NI, llstreamread_178242)(tllstream178204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		result = ((buflen <= (NI64)(TMP1646)) ? buflen : (NI64)(TMP1646));
		nimln(136, "llstream.nim");
		{
			...
			if ((NU)((NI64)(TMP1647)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI64)(TMP1647)])), result);
...
N_NIMCALL(void, llstreamwrite_178268)(tllstream178204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			(*s).S = setLengthStr((*s).S, (NI64)(TMP1648));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1649 = addInt(0, (*s).Wr);
			if ((NU)((NI64)(TMP1649)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI64)(TMP1649)])), buf, buflen);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_178254)(tllstream178204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI64)(TMP1650));
			nimln(222, "llstream.nim");
			nimln(222, "llstream.nim");
			TMP1651 = addInt(i, 0);
			if ((NU)((NI64)(TMP1651)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_10827((*s).F, ((void*) (&result->data[(NI64)(TMP1651)])), 2048);
