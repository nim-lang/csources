...
N_NIMCALL(void, TMP1634)(void* p, NI op);
...
N_NIMCALL(tllstream172204*, llstreamopen_172232)(void);
N_NIMCALL(tllstream172204*, llstreamopenstdin_172235)(void);
N_NIMCALL(void, llstreamclose_172238)(tllstream172204* s);
N_NIMCALL(NIM_BOOL, readlinefromstdin_172396)(NimStringDesc* prompt, NimStringDesc** line);
N_NIMCALL(void, write_10463)(FILE* f, NimStringDesc* s);
N_NIMCALL(NIM_BOOL, readline_10487)(FILE* f, NimStringDesc** line);
N_NIMCALL(NIM_BOOL, endswith_172602)(NimStringDesc* x, TY120387 s);
static N_INLINE(NI, subInt)(NI a, NI b);
N_NOINLINE(void, raiseOverflow)(void);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(NIM_BOOL, endswithopr_172646)(NimStringDesc* x);
static N_INLINE(NIM_BOOL, continueline_172652)(NimStringDesc* line, NIM_BOOL intriplestring);
N_NIMCALL(NI, counttriples_172676)(NimStringDesc* s);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NIMCALL(NI, llreadfromstdin_172733)(tllstream172204* s, void* buf, NI buflen);
N_NIMCALL(NimStringDesc*, rawNewString)(NI space);
N_NIMCALL(NimStringDesc*, rawNewString)(NI cap);
N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src);
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src);
N_NIMCALL(NimStringDesc*, resizeString)(NimStringDesc* dest, NI addlen);
N_NIMCALL(NI, llstreamread_172242)(tllstream172204* s, void* buf, NI buflen);
...
N_NIMCALL(void, llstreamwrite_172268)(tllstream172204* s, void* buf, NI buflen);
N_NIMCALL(NimStringDesc*, llstreamreadall_172254)(tllstream172204* s);
N_NIMCALL(NimStringDesc*, copyStr)(NimStringDesc* s, NI start);
N_NIMCALL(NimStringDesc*, copyStr)(NimStringDesc* s, NI first);
N_NIMCALL(NimStringDesc*, mnewString)(NI len);
N_NIMCALL(NimStringDesc*, mnewString)(NI len);
STRING_LITERAL(TMP1635, "", 0);
NIM_CONST TY120387 linecontinuationoprs_172641 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
NIM_CONST TY120387 additionallinecontinuationoprs_172643 = {
0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x24,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY120387 TMP1637 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY120387 TMP1638 = {
0x00, 0x00, 0x00, 0x00, 0x7A, 0xBC, 0x00, 0xF4,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP1641, ">>> ", 4);
STRING_LITERAL(TMP1642, "... ", 4);
STRING_LITERAL(TMP1643, "\012", 1);
extern TNimType NTI2409; /* TObject */
TNimType NTI172204; /* TLLStream */
TNimType NTI172202; /* TLLStreamKind */
extern TNimType NTI10004; /* TFile */
extern TNimType NTI143; /* string */
extern TNimType NTI106; /* int */
TNimType NTI172206; /* PLLStream */
...
N_NIMCALL(tllstream172204*, llstreamopen_172218)(NimStringDesc* data) {
	...
	result = (tllstream172204*) newObj((&NTI172206), sizeof(tllstream172204));
	(*result).Sup.m_type = (&NTI172204);
...
N_NIMCALL(tllstream172204*, llstreamopenstdin_172235)(void) {
	...
	LOC1 = 0;
	LOC1 = (*result).S; (*result).S = copyStringRC1(((NimStringDesc*) &TMP1635));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
N_NIMCALL(NIM_BOOL, endswithopr_172646)(NimStringDesc* x) {
	...
	result = endswith_172602(x, TMP1637);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_172652)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_172602(line, TMP1638);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(NI, counttriples_172676)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1639 = addInt(i, 1);
			if ((NU)((NI64)(TMP1639)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI64)(TMP1639)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			...
			LOC4 = ((NU8)(s->data[(NI64)(TMP1640)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
N_NIMCALL(NI, llreadfromstdin_172733)(tllstream172204* s, void* buf, NI buflen) {
	...
	LOC1 = 0;
	LOC1 = (*s).S; (*s).S = copyStringRC1(((NimStringDesc*) &TMP1635));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	...
	while (1) {
		...
		nimln(119, "llstream.nim");
		{
			...
			LOC3 = copyString(((NimStringDesc*) &TMP1641));
		}
		goto LA4;
		LA6: ;
		{
		...
		LA4: ;
		LOC9 = 0;
		LOC9 = readlinefromstdin_172396(LOC3, &line);
		if (!LOC9) goto LA2;
...
appendString((*s).S, ((NimStringDesc*) &TMP1643));
		nimln(122, "llstream.nim");
		nimln(122, "llstream.nim");
		LOC10 = 0;
		LOC10 = counttriples_172676(line);
		...
		nimln(123, "llstream.nim");
		{
			...
			nimln(123, "llstream.nim");
			LOC13 = 0;
			LOC13 = continueline_172652(line, (((NI) ((NI)(triples & 1))) == 1));
			if (!!(LOC13)) goto LA14;
			nimln(123, "llstream.nim");
			goto LA2;
		}
	...
	nimln(125, "llstream.nim");
	nimln(125, "llstream.nim");
	TMP1644 = subInt((*s).S->Sup.len, (*s).Rd);
	result = ((buflen <= (NI64)(TMP1644)) ? buflen : (NI64)(TMP1644));
...
N_NIMCALL(NI, llstreamread_172242)(tllstream172204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		nimln(136, "llstream.nim");
		{
			...
			nimln(137, "llstream.nim");
			TMP1646 = addInt(0, (*s).Rd);
			if ((NU)((NI64)(TMP1646)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI64)(TMP1646)])), result);
	...
	case ((NU8) 3):
	{
		...
		result = llreadfromstdin_172733(s, buf, buflen);
	}
	break;
	}
	popFrame();
...
N_NIMCALL(void, llstreamwriteln_172274)(tllstream172204* s, NimStringDesc* data) {
	...
	llstreamwrite_172258(s, data);
	nimln(180, "llstream.nim");
	llstreamwrite_172258(s, ((NimStringDesc*) &TMP1643));
	popFrame();
}
...
N_NIMCALL(void, llstreamwrite_172268)(tllstream172204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			nimln(200, "llstream.nim");
			nimln(200, "llstream.nim");
			TMP1647 = addInt((*s).S->Sup.len, buflen);
			(*s).S = setLengthStr((*s).S, (NI64)(TMP1647));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1648 = addInt(0, (*s).Wr);
			if ((NU)((NI64)(TMP1648)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI64)(TMP1648)])), buf, buflen);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_172254)(tllstream172204* s) {
	...
	case ((NU8) 3):
	{
		...
		result = copyString(((NimStringDesc*) &TMP1635));
	}
	break;
	case ((NU8) 1):
	{
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			nimln(221, "llstream.nim");
			TMP1649 = addInt(i, 2048);
			result = setLengthStr(result, (NI64)(TMP1649));
			nimln(222, "llstream.nim");
			nimln(222, "llstream.nim");
			TMP1650 = addInt(i, 0);
			if ((NU)((NI64)(TMP1650)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_10627((*s).F, ((void*) (&result->data[(NI64)(TMP1650)])), 2048);
...
static TNimNode* TMP1630[6];
static TNimNode* TMP1631[4];
NI TMP1633;
static char* NIM_CONST TMP1632[4] = {
"llsNone", 
"llsString", 
"llsFile", 
"llsStdIn"};
static TNimNode TMP1628[12];
NTI172204.size = sizeof(tllstream172204);
NTI172204.kind = 17;
NTI172204.base = (&NTI2409);
TMP1630[0] = &TMP1628[1];
NTI172202.size = sizeof(NU8);
NTI172202.kind = 14;
NTI172202.base = 0;
NTI172202.flags = 3;
for (TMP1633 = 0; TMP1633 < 4; TMP1633++) {
TMP1628[TMP1633+2].kind = 1;
TMP1628[TMP1633+2].offset = TMP1633;
TMP1628[TMP1633+2].name = TMP1632[TMP1633];
TMP1631[TMP1633] = &TMP1628[TMP1633+2];
}
TMP1628[6].len = 4; TMP1628[6].kind = 2; TMP1628[6].sons = &TMP1631[0];
NTI172202.node = &TMP1628[6];
TMP1628[1].kind = 1;
TMP1628[1].offset = offsetof(tllstream172204, Kind);
TMP1628[1].typ = (&NTI172202);
TMP1628[1].name = "kind";
TMP1630[1] = &TMP1628[7];
TMP1628[7].kind = 1;
TMP1628[7].offset = offsetof(tllstream172204, F);
TMP1628[7].typ = (&NTI10004);
TMP1628[7].name = "f";
TMP1630[2] = &TMP1628[8];
TMP1628[8].kind = 1;
TMP1628[8].offset = offsetof(tllstream172204, S);
TMP1628[8].typ = (&NTI143);
TMP1628[8].name = "s";
TMP1630[3] = &TMP1628[9];
TMP1628[9].kind = 1;
TMP1628[9].offset = offsetof(tllstream172204, Rd);
TMP1628[9].typ = (&NTI106);
TMP1628[9].name = "rd";
TMP1630[4] = &TMP1628[10];
TMP1628[10].kind = 1;
TMP1628[10].offset = offsetof(tllstream172204, Wr);
TMP1628[10].typ = (&NTI106);
TMP1628[10].name = "wr";
TMP1630[5] = &TMP1628[11];
TMP1628[11].kind = 1;
TMP1628[11].offset = offsetof(tllstream172204, Lineoffset);
TMP1628[11].typ = (&NTI106);
TMP1628[11].name = "lineOffset";
TMP1628[0].len = 6; TMP1628[0].kind = 2; TMP1628[0].sons = &TMP1630[0];
NTI172204.node = &TMP1628[0];
NTI172206.size = sizeof(tllstream172204*);
NTI172206.kind = 22;
NTI172206.base = (&NTI172204);
NTI172206.marker = TMP1634;
}
