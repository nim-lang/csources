...
static N_INLINE(trope147007**, s_469173)(tcproc469026* p, NU8 s) {
	...
	if ((NU)((NI64)(TMP6221)) >= (NU)((*p).Blocks->Sup.len)) raiseIndexError();
	result = &(*p).Blocks->data[(NI64)(TMP6221)].Sections[(s)- 0];
	popFrame();
	return result;
}
