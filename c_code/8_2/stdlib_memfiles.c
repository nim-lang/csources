...
N_NIMCALL(void*, mapmem_231210)(tmemfile231204* m, NU8 mode, NI mappedsize, NI offset);
...
N_NIMCALL(void, unmapmem_231605)(tmemfile231204* f, void* p, NI size);
...
N_NIMCALL(void*, mapmem_231210)(tmemfile231204* m, NU8 mode, NI mappedsize, NI offset) {
	...
	nimln(59, "memfiles.nim");
	{
		...
		nimln(60, "memfiles.nim");
		LOC21 = 0;
		LOC21 = oslasterror_105231();
		oserror_105205(LOC21);
	}
	LA19: ;
	popFrame();
	return result;
...
N_NIMCALL(tmemfile231204, open_231803)(NimStringDesc* filename, NU8 mode, NI mappedsize, NI offset, NI newfilesize) {
	...
	nimln(170, "memfiles.nim");
	{
		...
		LOC25 = 0;
		LOC25 = oslasterror_105231();
		oserror_105205(LOC25);
	}
	LA18: ;
	nimln(175, "memfiles.nim");
	{
		...
		nimln(176, "memfiles.nim");
		{
			...
			LOC40 = 0;
			LOC40 = oslasterror_105231();
			oserror_105205(LOC40);
		}
		LA33: ;
	}
	LA28: ;
	...
	LA43: ;
	{
		...
		LA49: ;
		{
			...
			LOC57 = 0;
			LOC57 = oslasterror_105231();
			oserror_105205(LOC57);
		}
		LA46: ;
	}
	LA41: ;
	...
	nimln(198, "memfiles.nim");
	{
		...
		LOC79 = 0;
		LOC79 = oslasterror_105231();
		oserror_105205(LOC79);
	}
	LA72: ;
	popFrame();
	return result;
...
NTI231204.size = sizeof(tmemfile231204);
NTI231204.kind = 18;
NTI231204.base = 0;
NTI231204.flags = 3;
TMP3043[0] = &TMP2959[1];
TMP2959[1].kind = 1;
TMP2959[1].offset = offsetof(tmemfile231204, Mem);
TMP2959[1].typ = (&NTI147);
TMP2959[1].name = "mem";
TMP3043[1] = &TMP2959[2];
TMP2959[2].kind = 1;
TMP2959[2].offset = offsetof(tmemfile231204, Size);
TMP2959[2].typ = (&NTI106);
TMP2959[2].name = "size";
TMP3043[2] = &TMP2959[3];
TMP2959[3].kind = 1;
TMP2959[3].offset = offsetof(tmemfile231204, Handle);
TMP2959[3].typ = (&NTI4409);
TMP2959[3].name = "handle";
TMP2959[0].len = 3; TMP2959[0].kind = 2; TMP2959[0].sons = &TMP3043[0];
NTI231204.node = &TMP2959[0];
}
