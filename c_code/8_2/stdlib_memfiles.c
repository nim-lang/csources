...
N_NIMCALL(memfile272208, open_272807)(NimStringDesc* filename, NU8 mode, NI mappedsize, NI offset, NI newfilesize) {
	...
	LA6: ;
	{
		...
		LA17: ;
		LOC20 = 0;
		LOC20 = oslasterror_113641();
		raiseoserror_113609(LOC20);
	}
	LA13: ;
	{
		if (!!((newfilesize == -1))) goto LA23;
		{
			...
			LA32: ;
			LOC35 = 0;
			LOC35 = oslasterror_113641();
			raiseoserror_113609(LOC35);
		}
		LA28: ;
	}
	LA23: ;
	...
	LA38: ;
	{
		...
		LA44: ;
		{
			...
			LA49: ;
			LOC52 = 0;
			LOC52 = oslasterror_113641();
			raiseoserror_113609(LOC52);
		}
		LA41: ;
	}
	LA36: ;
	...
	result.Mem = mmap(NIM_NIL, result.Size, LOC53, LOC59, result.Handle, ((off_t) (offset)));
	{
		...
		LA71: ;
		LOC74 = 0;
		LOC74 = oslasterror_113641();
		raiseoserror_113609(LOC74);
	}
	LA67: ;
	return result;
}
...
NTI272208.size = sizeof(memfile272208);
NTI272208.kind = 18;
NTI272208.base = 0;
NTI272208.flags = 3;
TMP825[0] = &TMP809[1];
TMP809[1].kind = 1;
TMP809[1].offset = offsetof(memfile272208, Mem);
TMP809[1].typ = (&NTI153);
TMP809[1].name = "mem";
TMP825[1] = &TMP809[2];
TMP809[2].kind = 1;
TMP809[2].offset = offsetof(memfile272208, Size);
TMP809[2].typ = (&NTI108);
TMP809[2].name = "size";
TMP825[2] = &TMP809[3];
TMP809[3].kind = 1;
TMP809[3].offset = offsetof(memfile272208, Handle);
TMP809[3].typ = (&NTI5611);
TMP809[3].name = "handle";
TMP809[0].len = 3; TMP809[0].kind = 2; TMP809[0].sons = &TMP825[0];
NTI272208.node = &TMP809[0];
}
