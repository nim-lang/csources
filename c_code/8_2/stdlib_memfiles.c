...
STRING_LITERAL(TMP2962, "mappedSize > 0 ", 15);
STRING_LITERAL(TMP2963, "newFileSize == - 1 or mode != fmRead ", 37);
extern TFrame* frameptr_13238;
TNimType NTI237204; /* TMemFile */
...
static TNimNode* TMP3044[3];
static TNimNode TMP2960[4];
NTI237204.size = sizeof(tmemfile237204);
NTI237204.kind = 18;
NTI237204.base = 0;
NTI237204.flags = 3;
TMP3044[0] = &TMP2960[1];
TMP2960[1].kind = 1;
TMP2960[1].offset = offsetof(tmemfile237204, Mem);
TMP2960[1].typ = (&NTI147);
TMP2960[1].name = "mem";
TMP3044[1] = &TMP2960[2];
TMP2960[2].kind = 1;
TMP2960[2].offset = offsetof(tmemfile237204, Size);
TMP2960[2].typ = (&NTI106);
TMP2960[2].name = "size";
TMP3044[2] = &TMP2960[3];
TMP2960[3].kind = 1;
TMP2960[3].offset = offsetof(tmemfile237204, Handle);
TMP2960[3].typ = (&NTI4409);
TMP2960[3].name = "handle";
TMP2960[0].len = 3; TMP2960[0].kind = 2; TMP2960[0].sons = &TMP3044[0];
NTI237204.node = &TMP2960[0];
}
