...
N_NIMCALL(NIM_BOOL, mustrehash_121923)(NI length, NI counter) {
	...
	nimln(85, "strtabs.nim");
	{
		...
		nimln(85, "strtabs.nim");
		failedassertimpl_80421(((NimStringDesc*) &TMP278));
	}
	LA3: ;
...
N_NIMCALL(void, enlarge_122081)(tstringtable121810* t) {
	...
	n = (tkeyvaluepairseq121808*) newSeq((&NTI121808), (NI64)(TMP287));
	i_122124 = 0;
	HEX3Atmp_122142 = 0;
...
NTI121808.flags = 2;
NTI121808.marker = TMP289;
NTI121810.size = sizeof(tstringtable121810);
NTI121810.kind = 17;
NTI121810.base = (&NTI2409);
TMP294[0] = &TMP266[1];
TMP266[1].kind = 1;
TMP266[1].offset = offsetof(tstringtable121810, Counter);
TMP266[1].typ = (&NTI106);
TMP266[1].name = "counter";
TMP294[1] = &TMP266[2];
TMP266[2].kind = 1;
TMP266[2].offset = offsetof(tstringtable121810, Data);
TMP266[2].typ = (&NTI121808);
TMP266[2].name = "data";
TMP294[2] = &TMP266[3];
...
NTI121804.node = &TMP266[7];
TMP266[3].kind = 1;
TMP266[3].offset = offsetof(tstringtable121810, Mode);
TMP266[3].typ = (&NTI121804);
TMP266[3].name = "mode";
TMP266[0].len = 3; TMP266[0].kind = 2; TMP266[0].sons = &TMP294[0];
NTI121810.node = &TMP266[0];
NTI121812.size = sizeof(tstringtable121810*);
NTI121812.kind = 22;
NTI121812.base = (&NTI121810);
NTI121812.marker = TMP298;
}
