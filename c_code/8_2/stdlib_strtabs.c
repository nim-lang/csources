...
N_NIMCALL(NI, myhash_119908)(tstringtable119810* t, NimStringDesc* key);
...
N_NIMCALL(NIM_BOOL, mycmp_119915)(tstringtable119810* t, NimStringDesc* a, NimStringDesc* b);
...
N_NIMCALL(NIM_BOOL, mustrehash_119923)(NI length, NI counter);
N_NIMCALL(void, failedassertimpl_79821)(NimStringDesc* msg);
N_NIMCALL(NI, mulInt)(NI a, NI b);
static N_INLINE(NI, subInt)(NI a, NI b);
N_NOINLINE(void, raiseOverflow)(void);
static N_INLINE(NI, nexttry_120006)(NI h, NI maxhash);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NIMCALL(NI, rawget_120013)(tstringtable119810* t, NimStringDesc* key);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(NimStringDesc*, nstGet)(tstringtable119810* t, NimStringDesc* key);
N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src);
N_NIMCALL(NimStringDesc**, nstTake)(tstringtable119810* t, NimStringDesc* key);
...
N_NIMCALL(void, rawinsert_120069)(tstringtable119810* t, tkeyvaluepairseq119808** data, NimStringDesc* key, NimStringDesc* val);
N_NIMCALL(NimStringDesc*, copyStringRC1)(NimStringDesc* src);
static N_INLINE(void, nimGCunrefNoCycle)(void* p);
N_NIMCALL(void, enlarge_120081)(tstringtable119810* t);
...
N_NIMCALL(void, raiseformatexception_120185)(NimStringDesc* s);
N_NIMCALL(NimStringDesc*, getvalue_120209)(tstringtable119810* t, NU8 flags, NimStringDesc* key);
...
N_NIMCALL(tstringtable119810*, nstnewStringTableWithPairs)(NimStringDesc** keyvaluepairs, NI keyvaluepairsLen0, NU8 mode);
N_NIMCALL(tstringtable119810*, nstnewStringTableWithTableConstr)(TY94106* keyvaluepairs, NI keyvaluepairsLen0, NU8 mode);
N_NIMCALL(NimStringDesc*, nstFormat)(NimStringDesc* f, tstringtable119810* t, NU8 flags);
N_NIMCALL(NimStringDesc*, addChar)(NimStringDesc* s, NIM_CHAR c);
N_NIMCALL(NimStringDesc*, copyStrLast)(NimStringDesc* s, NI start_70824, NI last);
N_NIMCALL(NimStringDesc*, copyStrLast)(NimStringDesc* s, NI first, NI last);
N_NIMCALL(NimStringDesc*, resizeString)(NimStringDesc* dest, NI addlen);
N_NIMCALL(NimStringDesc*, nstDollar)(tstringtable119810* t);
...
NIM_CONST TY120387 patternchars_120386 = {
...
N_NIMCALL(NI, myhash_119908)(tstringtable119810* t, NimStringDesc* key) {
	...
	case ((NU8) 0):
	{
		...
		result = hash_117827(key);
	}
	break;
	case ((NU8) 1):
	{
		nimln(75, "strtabs.nim");
		result = hashignorecase_117935(key);
	}
	break;
	case ((NU8) 2):
	{
		nimln(76, "strtabs.nim");
		result = hashignorestyle_117859(key);
	}
	break;
	}
	popFrame();
...
N_NIMCALL(NI, rawget_120013)(tstringtable119810* t, NimStringDesc* key) {
	...
	while (1) {
		...
		nimln(94, "strtabs.nim");
		{
			...
			if ((NU)(h) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			LOC5 = 0;
			LOC5 = mycmp_119915(t, (*t).Data->data[h].Field0, key);
			if (!LOC5) goto LA6;
		...
		nimln(96, "strtabs.nim");
		h = nexttry_120006(h, ((*t).Data->Sup.len-1));
	} LA2: ;
...
N_NIMCALL(NimStringDesc**, nstTake)(tstringtable119810* t, NimStringDesc* key) {
	...
	LA3: ;
	{
		einvalidkey2455* e_120041;
		NimStringDesc* LOC6;
		e_120041 = 0;
		nimln(1991, "system.nim");
		e_120041 = (einvalidkey2455*) newObj((&NTI120042), sizeof(einvalidkey2455));
		(*e_120041).Sup.Sup.Sup.Sup.m_type = (&NTI2455);
...
appendString(LOC6, key);
		asgnRefNoCycle((void**) &(*e_120041).Sup.Sup.Sup.message, LOC6);
		nimln(113, "strtabs.nim");
		raiseException((E_Base*)e_120041, "EInvalidKey");
	}
	LA1: ;
	popFrame();
	return result;
...
N_NIMCALL(void, rawinsert_120069)(tstringtable119810* t, tkeyvaluepairseq119808** data, NimStringDesc* key, NimStringDesc* val) {
	...
	while (1) {
		...
		nimln(122, "strtabs.nim");
		h = nexttry_120006(h, ((*data)->Sup.len-1));
	} LA2: ;
...
N_NIMCALL(void, TMP289)(void* p, NI op) {
	tkeyvaluepairseq119808* a;
	NI LOC1;
	a = (tkeyvaluepairseq119808*)p;
	LOC1 = 0;
...
N_NIMCALL(void, enlarge_120081)(tstringtable119810* t) {
	tkeyvaluepairseq119808* n;
	NI TMP287;
	NI i_120124;
	NI HEX3Atmp_120142;
	NI res_120144;
	tkeyvaluepairseq119808* LOC6;
	...
	n = (tkeyvaluepairseq119808*) newSeq((&NTI119808), (NI64)(TMP287));
	i_120124 = 0;
	HEX3Atmp_120142 = 0;
	nimln(129, "strtabs.nim");
	nimln(129, "strtabs.nim");
	HEX3Atmp_120142 = ((*t).Data->Sup.len-1);
	nimln(1450, "system.nim");
	res_120144 = 0;
	nimln(1451, "system.nim");
	while (1) {
		nimln(1451, "system.nim");
		if (!(res_120144 <= HEX3Atmp_120142)) goto LA1;
		nimln(1450, "system.nim");
		i_120124 = res_120144;
		nimln(130, "strtabs.nim");
		{
			nimln(130, "strtabs.nim");
			nimln(130, "strtabs.nim");
			if ((NU)(i_120124) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			if (!!((*t).Data->data[i_120124].Field0 == 0)) goto LA4;
			nimln(130, "strtabs.nim");
			if ((NU)(i_120124) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			if ((NU)(i_120124) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			rawinsert_120069(t, &n, (*t).Data->data[i_120124].Field0, (*t).Data->data[i_120124].Field1);
		}
		LA4: ;
		nimln(1453, "system.nim");
		res_120144 = addInt(res_120144, 1);
	} LA1: ;
...
N_NIMCALL(void, nstPut)(tstringtable119810* t, NimStringDesc* key, NimStringDesc* val) {
	...
	LA3: ;
	{
		nimln(139, "strtabs.nim");
		{
			...
			nimln(139, "strtabs.nim");
			LOC9 = 0;
			LOC9 = mustrehash_119923((*t).Data->Sup.len, (*t).Counter);
			if (!LOC9) goto LA10;
			nimln(139, "strtabs.nim");
			enlarge_120081(t);
		}
		...
		rawinsert_120069(t, &(*t).Data, key, val);
...
appendString(LOC19, key);
		...
		LA17: ;
		{
			...
			nimln(156, "strtabs.nim");
			raiseformatexception_120185(key);
		}
		goto LA15;
		LA21: ;
		LA15: ;
...
N_NIMCALL(void, TMP298)(void* p, NI op) {
	tstringtable119810* a;
	a = (tstringtable119810*)p;
...
N_NIMCALL(tstringtable119810*, nstnewStringTable)(NU8 mode) {
	...
	result = (tstringtable119810*) newObj((&NTI119812), sizeof(tstringtable119810));
	(*result).Sup.m_type = (&NTI119810);
	...
	(*result).Data = (tkeyvaluepairseq119808*) newSeqRC1((&NTI119808), 64);
	popFrame();
	return result;
}
...
N_NIMCALL(tstringtable119810*, nstnewStringTableWithTableConstr)(TY94106* keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	tstringtable119810* result;
	NimStringDesc* key_120370;
	NimStringDesc* val_120371;
	NI i_120373;
	nimfr("newStringTable", "strtabs.nim")
	result = 0;
	...
	while (1) {
		nimln(1531, "system.nim");
		nimln(1531, "system.nim");
		if (!(i_120373 < keyvaluepairsLen0)) goto LA1;
		nimln(1532, "system.nim");
		if ((NU)(i_120373) >= (NU)(keyvaluepairsLen0)) raiseIndexError();
		key_120370 = keyvaluepairs[i_120373].Field0;
		nimln(1532, "system.nim");
		if ((NU)(i_120373) >= (NU)(keyvaluepairsLen0)) raiseIndexError();
		val_120371 = keyvaluepairs[i_120373].Field1;
		nimln(187, "strtabs.nim");
		nstPut(result, key_120370, val_120371);
		nimln(1533, "system.nim");
		i_120373 = addInt(i_120373, 1);
	} LA1: ;
	popFrame();
	return result;
}
	...
	while (1) {
		...
		nimln(197, "strtabs.nim");
		{
			...
			case 123:
			{
				...
				LOC12 = 0;
				LOC12 = getvalue_120209(t, flags, LOC11);
...
appendString(result, LOC12);
			...
			case 95:
			{
				...
				LOC18 = 0;
				LOC18 = getvalue_120209(t, flags, LOC17);
...
N_NIMCALL(NimStringDesc*, nstDollar)(tstringtable119810* t) {
	...
	LA4: ;
	{
		NimStringDesc* key_120496;
		NimStringDesc* val_120497;
		NI h_120500;
		NI HEX3Atmp_120502;
		NI res_120504;
		...
		nimln(40, "strtabs.nim");
		HEX3Atmp_120502 = ((*t).Data->Sup.len-1);
		nimln(1457, "system.nim");
		res_120504 = 0;
		nimln(1458, "system.nim");
		while (1) {
			nimln(1458, "system.nim");
			if (!(res_120504 <= HEX3Atmp_120502)) goto LA7;
			nimln(1457, "system.nim");
			h_120500 = res_120504;
			nimln(41, "strtabs.nim");
			{
				nimln(41, "strtabs.nim");
				nimln(41, "strtabs.nim");
				if ((NU)(h_120500) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
				if (!!((*t).Data->data[h_120500].Field0 == 0)) goto LA10;
				nimln(42, "strtabs.nim");
				if ((NU)(h_120500) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
				key_120496 = (*t).Data->data[h_120500].Field0;
				nimln(42, "strtabs.nim");
				if ((NU)(h_120500) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
				val_120497 = (*t).Data->data[h_120500].Field1;
...
appendString(result, ((NimStringDesc*) &TMP310));
				...
				result = resizeString(result, key_120496->Sup.len + 0);
appendString(result, key_120496);
				nimln(228, "strtabs.nim");
				result = resizeString(result, 2);
appendString(result, ((NimStringDesc*) &TMP311));
				nimln(229, "strtabs.nim");
				result = resizeString(result, val_120497->Sup.len + 0);
appendString(result, val_120497);
			}
			LA10: ;
			nimln(1460, "system.nim");
			res_120504 = addInt(res_120504, 1);
		} LA7: ;
...
NTI119808.size = sizeof(tkeyvaluepairseq119808*);
NTI119808.kind = 24;
NTI119808.base = (&NTI94106);
NTI119808.flags = 2;
NTI119808.marker = TMP289;
NTI119810.size = sizeof(tstringtable119810);
NTI119810.kind = 17;
NTI119810.base = (&NTI2409);
TMP294[0] = &TMP266[1];
TMP266[1].kind = 1;
TMP266[1].offset = offsetof(tstringtable119810, Counter);
TMP266[1].typ = (&NTI106);
TMP266[1].name = "counter";
TMP294[1] = &TMP266[2];
TMP266[2].kind = 1;
TMP266[2].offset = offsetof(tstringtable119810, Data);
TMP266[2].typ = (&NTI119808);
TMP266[2].name = "data";
TMP294[2] = &TMP266[3];
NTI119804.size = sizeof(NU8);
NTI119804.kind = 14;
NTI119804.base = 0;
NTI119804.flags = 3;
...
NTI119804.node = &TMP266[7];
TMP266[3].kind = 1;
TMP266[3].offset = offsetof(tstringtable119810, Mode);
TMP266[3].typ = (&NTI119804);
TMP266[3].name = "mode";
TMP266[0].len = 3; TMP266[0].kind = 2; TMP266[0].sons = &TMP294[0];
NTI119810.node = &TMP266[0];
NTI119812.size = sizeof(tstringtable119810*);
NTI119812.kind = 22;
NTI119812.base = (&NTI119810);
NTI119812.marker = TMP298;
}
