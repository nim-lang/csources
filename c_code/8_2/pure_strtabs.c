...
N_NIMCALL(NI, myhash_111702)(tstringtable111610* t, NimStringDesc* key);
N_NIMCALL(NI, hash_109826)(NimStringDesc* x);
N_NIMCALL(NI, hashignorecase_109924)(NimStringDesc* x);
N_NIMCALL(NI, hashignorestyle_109856)(NimStringDesc* x);
N_NIMCALL(NIM_BOOL, mycmp_111709)(tstringtable111610* t, NimStringDesc* a, NimStringDesc* b);
...
N_NIMCALL(NIM_BOOL, mustrehash_111717)(NI length, NI counter);
N_NIMCALL(void, hiddenraiseassert_76017)(NimStringDesc* msg);
N_NIMCALL(NI, mulInt)(NI a, NI b);
static N_INLINE(NI, subInt)(NI a, NI b);
N_NOINLINE(void, raiseOverflow)(void);
static N_INLINE(NI, nexttry_111805)(NI h, NI maxhash);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NIMCALL(NI, rawget_111812)(tstringtable111610* t, NimStringDesc* key);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(NimStringDesc*, nstGet)(tstringtable111610* t, NimStringDesc* key);
N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src);
N_NIMCALL(NimStringDesc**, nstTake)(tstringtable111610* t, NimStringDesc* key);
...
N_NIMCALL(void, rawinsert_111864)(tstringtable111610* t, tkeyvaluepairseq111608** data, NimStringDesc* key, NimStringDesc* val);
N_NIMCALL(NimStringDesc*, copyStringRC1)(NimStringDesc* src);
static N_INLINE(void, nimGCunrefNoCycle)(void* p);
N_NIMCALL(void, enlarge_111876)(tstringtable111610* t);
...
N_NIMCALL(void, raiseformatexception_111955)(NimStringDesc* s);
N_NIMCALL(NimStringDesc*, getvalue_111975)(tstringtable111610* t, NU8 flags, NimStringDesc* key);
...
N_NIMCALL(tstringtable111610*, nstnewStringTableWithPairs)(NimStringDesc** keyvaluepairs, NI keyvaluepairsLen0, NU8 mode);
N_NIMCALL(tstringtable111610*, nstnewStringTableWithTableConstr)(TY87906* keyvaluepairs, NI keyvaluepairsLen0, NU8 mode);
...
N_NIMCALL(NI, myhash_111702)(tstringtable111610* t, NimStringDesc* key) {
	...
	case ((NU8) 0):
	{
		...
		result = hash_109826(key);
	}	break;
	case ((NU8) 1):
	{
		nimln(75, "strtabs.nim");
		result = hashignorecase_109924(key);
	}	break;
	case ((NU8) 2):
	{
		nimln(76, "strtabs.nim");
		result = hashignorestyle_109856(key);
	}	break;
	}
	popFrame();
	return result;
...
N_NIMCALL(NI, rawget_111812)(tstringtable111610* t, NimStringDesc* key) {
	...
	while (1) {
		...
		nimln(94, "strtabs.nim");
		{
			...
			if ((NU)(h) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			LOC5 = 0;
			LOC5 = mycmp_111709(t, (*t).Data->data[h].Field0, key);
			if (!LOC5) goto LA6;
		...
		nimln(96, "strtabs.nim");
		h = nexttry_111805(h, ((*t).Data->Sup.len-1));
	} LA2: ;
...
N_NIMCALL(NimStringDesc**, nstTake)(tstringtable111610* t, NimStringDesc* key) {
	...
	LA3: ;
	{
		einvalidkey1055* e_111840;
		NimStringDesc* LOC6;
		e_111840 = 0;
		nimln(1829, "system.nim");
		e_111840 = (einvalidkey1055*) newObj((&NTI111841), sizeof(einvalidkey1055));
		(*e_111840).Sup.Sup.Sup.Sup.m_type = (&NTI1055);
...
appendString(LOC6, key);
		asgnRefNoCycle((void**) &(*e_111840).Sup.Sup.Sup.message, LOC6);
		nimln(113, "strtabs.nim");
		raiseException((E_Base*)e_111840, "EInvalidKey");
	}	LA1: ;
	popFrame();
	return result;
}
...
N_NIMCALL(void, rawinsert_111864)(tstringtable111610* t, tkeyvaluepairseq111608** data, NimStringDesc* key, NimStringDesc* val) {
	...
	while (1) {
		...
		nimln(122, "strtabs.nim");
		h = nexttry_111805(h, ((*data)->Sup.len-1));
	} LA2: ;
	...
	tkeyvaluepairseq111608* a;
	NI LOC1;
	a = (tkeyvaluepairseq111608*)p;
	LOC1 = 0;
...
N_NIMCALL(void, enlarge_111876)(tstringtable111610* t) {
	tkeyvaluepairseq111608* n;
	NI TMP287;
	NI i_111907;
	NI HEX3Atmp_111921;
	NI res_111923;
	tkeyvaluepairseq111608* LOC6;
	...
	n = (tkeyvaluepairseq111608*) newSeq((&NTI111608), (NI64)(TMP287));
	i_111907 = 0;
	HEX3Atmp_111921 = 0;
	nimln(129, "strtabs.nim");
	nimln(129, "strtabs.nim");
	HEX3Atmp_111921 = ((*t).Data->Sup.len-1);
	nimln(1301, "system.nim");
	res_111923 = 0;
	nimln(1302, "system.nim");
	while (1) {
		nimln(1302, "system.nim");
		if (!(res_111923 <= HEX3Atmp_111921)) goto LA1;
		nimln(1301, "system.nim");
		i_111907 = res_111923;
		nimln(130, "strtabs.nim");
		{
			nimln(130, "strtabs.nim");
			nimln(130, "strtabs.nim");
			if ((NU)(i_111907) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			if (!!((*t).Data->data[i_111907].Field0 == 0)) goto LA4;
			nimln(130, "strtabs.nim");
			if ((NU)(i_111907) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			if ((NU)(i_111907) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			rawinsert_111864(t, &n, (*t).Data->data[i_111907].Field0, (*t).Data->data[i_111907].Field1);		}		LA4: ;
		nimln(1304, "system.nim");
		res_111923 = addInt(res_111923, 1);
	} LA1: ;
...
appendString(LOC19, key);
		...
		LA17: ;
		{
			...
			nimln(156, "strtabs.nim");
			raiseformatexception_111955(key);		}		goto LA15;
		LA21: ;
		LA15: ;
	}	LA13: ;
	BeforeRet: ;	popFrame();
	...
	tstringtable111610* a;
	a = (tstringtable111610*)p;
...
N_NIMCALL(tstringtable111610*, nstnewStringTable)(NU8 mode) {
	...
	result = (tstringtable111610*) newObj((&NTI111612), sizeof(tstringtable111610));
	(*result).Sup.m_type = (&NTI111610);
	...
	(*result).Data = (tkeyvaluepairseq111608*) newSeqRC1((&NTI111608), 64);
	popFrame();
	return result;
}
N_NIMCALL(tstringtable111610*, nstnewStringTableWithPairs)(NimStringDesc** keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	...
	while (1) {
		...
		nstPut(result, keyvaluepairs[i], keyvaluepairs[(NI64)(TMP299)]);		nimln(177, "strtabs.nim");
		i = addInt(i, 2);
	} LA1: ;
	popFrame();
	return result;
...
N_NIMCALL(tstringtable111610*, nstnewStringTableWithTableConstr)(TY87906* keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	tstringtable111610* result;
	NimStringDesc* key_112101;
	NimStringDesc* val_112102;
	NI i_112104;
	nimfr("newStringTable", "strtabs.nim")
	result = 0;
	...
	while (1) {
		nimln(1378, "system.nim");
		nimln(1378, "system.nim");
		if (!(i_112104 < keyvaluepairsLen0)) goto LA1;
		nimln(1379, "system.nim");
		if ((NU)(i_112104) >= (NU)(keyvaluepairsLen0)) raiseIndexError();
		key_112101 = keyvaluepairs[i_112104].Field0;
		nimln(1379, "system.nim");
		if ((NU)(i_112104) >= (NU)(keyvaluepairsLen0)) raiseIndexError();
		val_112102 = keyvaluepairs[i_112104].Field1;
		nimln(187, "strtabs.nim");
		nstPut(result, key_112101, val_112102);		nimln(1380, "system.nim");
		i_112104 = addInt(i_112104, 1);
	} LA1: ;
	popFrame();
	return result;
}
...
NTI111608.size = sizeof(tkeyvaluepairseq111608*);
NTI111608.kind = 24;
NTI111608.base = (&NTI87906);
NTI111608.flags = 2;
NTI111608.marker = TMP289;
NTI111610.size = sizeof(tstringtable111610);
NTI111610.kind = 17;
NTI111610.base = (&NTI1009);
NTI111610.flags = 2;
TMP294[0] = &TMP266[1];
TMP266[1].kind = 1;
TMP266[1].offset = offsetof(tstringtable111610, Counter);
TMP266[1].typ = (&NTI105);
TMP266[1].name = "counter";
TMP294[1] = &TMP266[2];
TMP266[2].kind = 1;
TMP266[2].offset = offsetof(tstringtable111610, Data);
TMP266[2].typ = (&NTI111608);
TMP266[2].name = "data";
TMP294[2] = &TMP266[3];
NTI111604.size = sizeof(NU8);
NTI111604.kind = 14;
NTI111604.base = 0;
NTI111604.flags = 3;
...
NTI111604.node = &TMP266[7];
TMP266[3].kind = 1;
TMP266[3].offset = offsetof(tstringtable111610, Mode);
TMP266[3].typ = (&NTI111604);
TMP266[3].name = "mode";
TMP266[0].len = 3; TMP266[0].kind = 2; TMP266[0].sons = &TMP294[0];
NTI111610.node = &TMP266[0];
NTI111612.size = sizeof(tstringtable111610*);
NTI111612.kind = 22;
NTI111612.base = (&NTI111610);
NTI111612.flags = 2;
NTI111612.marker = TMP298;
}
