...
N_NIMCALL(NI, decodevint_232359)(NCSTRING s, NI* pos) {
	...
	result = 0;
	{
		while (1) {
			...
			case 48 ... 57:
			{
				result = (NI64)((NI64)(result * 190) - ((NI) ((NI64)(((NI) (((NU8)(s[i_232366])))) - 48))));
			}
			break;
			case 97 ... 122:
			{
				result = (NI64)((NI64)(result * 190) - ((NI) ((NI64)(((NI) ((NI64)(((NI) (((NU8)(s[i_232366])))) - 97))) + 10))));
			}
			break;
			case 65 ... 90:
			{
				result = (NI64)((NI64)(result * 190) - ((NI) ((NI64)(((NI) ((NI64)(((NI) (((NU8)(s[i_232366])))) - 65))) + 36))));
			}
			break;
			case 128 ... 255:
			{
				result = (NI64)((NI64)(result * 190) - ((NI) ((NI64)(((NI) ((NI64)(((NI) (((NU8)(s[i_232366])))) - 128))) + 62))));
			}
			break;
			default:
			{
	...
	result = (NI)((NU64)((NI64)(result * sign_232368)) - (NU64)(5));
	(*pos) = i_232366;
	return result;
}
	...
	result = copyString(((NimStringDesc*) &TMP1382));
	{
		while (1) {
			...
			case 92:
			{
				...
				i += 3;
				xi = 0;
				hexchar_232089(s[(NI64)(i - 2)], &xi);
				hexchar_232089(s[(NI64)(i - 1)], &xi);
...
N_NIMCALL(void, encodevintaux_232275)(NI x, NimStringDesc** result) {
	...
	d_232281 = 0;
	v_232283 = x;
	rem_232285 = (NI64)(v_232283 % 190);
	{
		if (!(((NI) (rem_232285)) < 0)) goto LA3;
		(*result) = addChar((*result), 45);
		v_232283 = ((NI64)-((NI64)(v_232283 / 190)));
		rem_232285 = ((NI64)-(((NI) (rem_232285))));
	}
	goto LA1;
	LA3: ;
	{
		v_232283 = (NI64)(v_232283 / 190);
	}
	LA1: ;
	...
	LA8: ;
	{
		d_232281 = ((NIM_CHAR) (((NI) ((NI64)((NI64)(idx_232287 - 62) + 128)))));
	}
	LA6: ;
	{
...
N_NIMCALL(void, encodevint_232304)(NI x, NimStringDesc** result) {
	encodevintaux_232275((NI)((NU64)(x) + (NU64)(5)), result);
}
...
N_NIMCALL(NI64, decodevbiggestint_232518)(NCSTRING s, NI* pos) {
	...
	result = 0;
	{
		while (1) {
			...
			case 48 ... 57:
			{
				result = (NI64)((NI64)(result * 190) - ((NI64) ((NI64)(((NI) (((NU8)(s[i_232525])))) - 48))));
			}
			break;
			case 97 ... 122:
			{
				result = (NI64)((NI64)(result * 190) - ((NI64) ((NI64)(((NI) ((NI64)(((NI) (((NU8)(s[i_232525])))) - 97))) + 10))));
			}
			break;
			case 65 ... 90:
			{
				result = (NI64)((NI64)(result * 190) - ((NI64) ((NI64)(((NI) ((NI64)(((NI) (((NU8)(s[i_232525])))) - 65))) + 36))));
			}
			break;
			case 128 ... 255:
			{
				result = (NI64)((NI64)(result * 190) - ((NI64) ((NI64)(((NI) ((NI64)(((NI) (((NU8)(s[i_232525])))) - 128))) + 62))));
			}
			break;
			default:
			{
...
N_NIMCALL(void, encodestr_232042)(NimStringDesc* s, NimStringDesc** result) {
	{
		...
		i_232059 = 0;
		HEX3Atmp_232069 = 0;
		HEX3Atmp_232069 = (NI64)(s->Sup.len - 1);
		res_232072 = 0;
		{
			while (1) {
...
N_NIMCALL(void, encodevbiggestintaux_232234)(NI64 x, NimStringDesc** result) {
	...
	LA8: ;
	{
		d_232240 = ((NIM_CHAR) (((NI) ((NI64)((NI64)(idx_232246 - 62) + 128)))));
	}
	LA6: ;
	{
