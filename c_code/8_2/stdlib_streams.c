...
N_NIMCALL(void, TMP2681)(void* p, NI op);
...
STRING_LITERAL(TMP2685, "cannot write to stream", 22);
...
N_NIMCALL(Filestreamobj137692*, newfilestream_137759)(FILE* f) {
	...
	(*result).Sup.readdataimpl = fsreaddata_137742;
	(*result).Sup.writedataimpl = fswritedata_137751;
