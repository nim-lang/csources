...
extern TNimType NTI81472; /* ref IOError */
...
N_NIMCALL(void, fsclose_157882_1780494535)(Streamobj156818* s0) {
	{
		...
		close_15253_1689653243((*((Filestreamobj157877*) (s0))).f);
...
N_NIMCALL(NIM_BOOL, fsatend_157900_1780494535)(Streamobj156818* s0) {
	NIM_BOOL result0;
{	result0 = (NIM_BOOL)0;
	result0 = endoffile_15256_1689653243((*((Filestreamobj157877*) (s0))).f);
	goto BeforeRet;
	}BeforeRet: ;
	return result0;
}
...
N_NIMCALL(void, fssetposition_157904_1780494535)(Streamobj156818* s0, NI pos0) {
	setfilepos_15383_1689653243((*((Filestreamobj157877*) (s0))).f, ((NI64) (pos0)));
}
...
{	result0 = (NI)0;
	LOC1 = (NI64)0;
	LOC1 = getfilepos_15387_1689653243((*((Filestreamobj157877*) (s0))).f);
	result0 = ((NI) (LOC1));
	goto BeforeRet;
	}BeforeRet: ;
	return result0;
...
N_NIMCALL(NI, fsreaddata_157913_1780494535)(Streamobj156818* s0, void* buffer0, NI buflen0) {
	NI result0;
	result0 = (NI)0;
	result0 = readbuffer_15356_1689653243((*((Filestreamobj157877*) (s0))).f, buffer0, ((NI) (buflen0)));
	return result0;
}
...
N_NIMCALL(Ioerror3628*, neweio_156802_1780494535)(NimStringDesc* msg0) {
	...
	result0 = (Ioerror3628*) newObj((&NTI81472), sizeof(Ioerror3628));
...
N_NIMCALL(void, fswritedata_157926_1780494535)(Streamobj156818* s0, void* buffer0, NI buflen0) {
	{
		...
		Ioerror3628* LOC6;
		LOC3 = (NI)0;
		LOC3 = writebuffer_15378_1689653243((*((Filestreamobj157877*) (s0))).f, buffer0, ((NI) (buflen0)));
...
N_NIMCALL(void, fsflush_157897_1780494535)(Streamobj156818* s0) {
	flushfile_15262_1689653243((*((Filestreamobj157877*) (s0))).f);
}
...
N_NIMCALL(Filestreamobj157877*, newfilestream_157943_1780494535)(NimStringDesc* filename0, Filemode13009 mode0) {
	...
	f0 = (FILE*)0;
	{
		NIM_BOOL LOC3;
		LOC3 = (NIM_BOOL)0;
		LOC3 = open_15203_1689653243(&f0, filename0, mode0, ((NI) -1));
		if (!LOC3) goto LA4;
