...
N_NIMCALL(tsym184843*, ithfield_413007)(tnode184813* n, NI field) {
	...
	case ((NU8) 136):
	{
		...
		while (1) {
			...
			result = ithfield_413007((*n).kindU.S6.Sons->data[i_413024], (NI64)(TMP5679));
	...
	case ((NU8) 137):
	{
		...
		result = ithfield_413007((*n).kindU.S6.Sons->data[0], (NI64)(TMP5681));
		...
		while (1) {
			...
			case ((NU8) 88):
			{
				...
				result = ithfield_413007(LOC20, (NI64)(TMP5684));
