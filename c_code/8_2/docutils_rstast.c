...
N_NIMCALL(trstnode300009*, lastson_300146)(trstnode300009* n) {
	...
	if ((NU)((NI64)(TMP3780)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP3780)];
	popFrame();
	return result;
}
...
appendString((*result), ind);
		...
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI64)(TMP3785), lvltochar_300257[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI64)(TMP3787), 45);
...
appendString((*result), ((NimStringDesc*) &TMP3790));
	...
	case ((NU8) 14):
	{
		...
		l = (((NI64)(TMP3791) >= 30) ? (NI64)(TMP3791) : 30);
...
appendString((*result), tmp);
		...
		TMP3793 = subInt((NI64)(TMP3792), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI64)(TMP3793), 32);
