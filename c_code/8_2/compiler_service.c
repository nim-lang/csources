...
extern TY192104 writelnhook_192107_155036129;
N_NIMCALL(void, T3526807654_2)(void) {
...
N_NIMCALL(void, serve_592236_3526807654)(TY592238 action0) {
	...
	LA2: ;
	{
		...
		asgnRef((void**) (&writelnhook_192107_155036129.ClEnv), LOC21.ClEnv);
		writelnhook_192107_155036129.ClPrc = LOC21.ClPrc;
		{
			while (1) {
				NimStringDesc* LOC24;
	...
	LA3: ;
	{
		...
		fflush(stdout);
		msgquit_192146_155036129(((NI8) 1));
	}
	LA4: ;
}
