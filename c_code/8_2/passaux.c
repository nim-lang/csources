...
NIM_CONST tpass249015 verbosepass_523054 = {verboseopen_523007,
NIM_NIL,
...
NIM_CONST tpass249015 cleanuppass_523204 = {NIM_NIL,
NIM_NIL,
cleanup_523056,
cleanup_523056}
;
...
N_NIMCALL(tnode190813*, verboseprocess_523014)(tpasscontext249003* context, tnode190813* n) {
	...
	nimln(23, "passaux.nim");
	{
		...
		gnotes_166178 |=((NI64)(1)<<(((((NU16) 265)- 230))%(sizeof(NI64)*8)));
