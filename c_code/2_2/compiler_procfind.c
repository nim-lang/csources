...
N_NIMCALL(NIM_BOOL, equalgenericparams_269010)(tnode171659* proca, tnode171659* procb) {
	...
	while (1) {
		...
		nimln(19, "procfind.nim");
		{
			...
			internalerror_138369((*proca).Info, ((NimStringDesc*) &TMP3699));			nimln(21, "procfind.nim");
			goto BeforeRet;
		}		LA11: ;
		nimln(22, "procfind.nim");
		{
			...
			internalerror_138369((*procb).Info, ((NimStringDesc*) &TMP3699));			nimln(24, "procfind.nim");
			goto BeforeRet;
		}		LA15: ;
		nimln(25, "procfind.nim");
		if (((TMP3696[(*proca).Kind/8] &(1<<((*proca).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3697));
		if ((NU)(i_269024) >= (NU)((*proca).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3700[(*(*proca).kindU.S6.Sons->data[i_269024]).Kind/8] &(1<<((*(*proca).kindU.S6.Sons->data[i_269024]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3701));
		a = (*(*proca).kindU.S6.Sons->data[i_269024]).kindU.S4.Sym;
		nimln(26, "procfind.nim");
		if (((TMP3696[(*procb).Kind/8] &(1<<((*procb).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3697));
		if ((NU)(i_269024) >= (NU)((*procb).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3700[(*(*procb).kindU.S6.Sons->data[i_269024]).Kind/8] &(1<<((*(*procb).kindU.S6.Sons->data[i_269024]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3701));
