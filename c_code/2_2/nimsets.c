...
N_NIMCALL(tnode225819*, totreeset_284754)(tbitset283012* s, ttype225855* settype, tlineinfo196539 info);
		...
		res_285119 = 0;
		{
			while (1) {
				...
				i_285023 = res_285119;
				{
					...
					LOC9 = 0;
					LOC9 = getordvalue_262187((*(*s).kindU.S6.Sons->data[i_285023]).kindU.S6.Sons->data[1]);
					LOC10 = 0;
					LOC10 = getordvalue_262187((*(*s).kindU.S6.Sons->data[i_285023]).kindU.S6.Sons->data[0]);
