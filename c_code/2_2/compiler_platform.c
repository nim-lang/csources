...
N_NIMCALL(void, settarget_176637)(NU8 o, NU8 c) {
	...
	targetcpu_176603 = c;
	targetos_176605 = o;
	intsize_176626 = (NI64)(cpu_176496[(c)- 1].Field1 / 8);
	floatsize_176627 = (NI64)(cpu_176496[(c)- 1].Field3 / 8);
	ptrsize_176628 = (NI64)(cpu_176496[(c)- 1].Field4 / 8);
	LOC1 = 0;
...
NIM_EXTERNC N_NOINLINE(void, compiler_platformInit)(void) {
	hostcpu_176604 = nametocpu_176620(((NimStringDesc*) &TMP69));
