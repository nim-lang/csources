...
N_NIMCALL(void, replaceDeprecated_MCFlYIPYCGdqUBK0MS9a8dQ)(tyObject_TLineInfo_T9c3PM9bs7WZ4LIQfEici9cZw info, tyObject_TIdent_4umxGerWTHGPwUms7Yqu3g* oldSym, tyObject_TIdent_4umxGerWTHGPwUms7Yqu3g* newSym);
N_NIMCALL(void, loadFile_e0l2N9bShT7NbC9c3sH4FHTg)(tyObject_TLineInfo_T9c3PM9bs7WZ4LIQfEici9cZw info);
...
{	loadFile_e0l2N9bShT7NbC9c3sH4FHTg(info);
	...
	last = (NI)((NI)(first + T17_) - ((NI) 1));
	{
		...
		NimStringDesc* T26_;
		NimStringDesc* T27_;
		T20_ = dotdot__18yoMoUbfoITYgEZSwZDYAnimblecmd(first, last);
		T21_ = (NimStringDesc*)0;
		T21_ = X5BX5D__Sq9b57KCLKZryBwyHy49aBswnimblecmd(line, T20_);
		T22_ = (NI)0;
