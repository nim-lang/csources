...
static N_INLINE(ttype192847*, lastson_193203)(ttype192847* n) {
	...
	if ((NU)((NI64)(TMP6203)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP6203)];
	popFrame();
	return result;
}
...
appendString(result, LOC2);
		...
		nimln(2807, "system.nim");
		{
			...
			nimln(2807, "system.nim");
			failedassertimpl_80421(((NimStringDesc*) &TMP6205));
		}
		LA5: ;
	} LA1: ;
...
N_NIMCALL(trope149007*, makellvmstring_470723)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(190, "ccgutils.nim");
		{
			...
			TMP6213 = modInt((NI64)(TMP6212), 64);
			if (!(((NI) ((NI64)(TMP6213))) == 0)) goto LA4;
