...
N_NIMCALL(trstnode302009*, lastson_302146)(trstnode302009* n) {
	...
	if ((NU)((NI64)(TMP3784)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP3784)];
	popFrame();
	return result;
}
...
appendString((*result), ind);
		...
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI64)(TMP3789), lvltochar_302257[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI64)(TMP3791), 45);
...
appendString((*result), ((NimStringDesc*) &TMP3794));
	...
	case ((NU8) 14):
	{
		...
		l = (((NI64)(TMP3795) >= 30) ? (NI64)(TMP3795) : 30);
...
appendString((*result), tmp);
		...
		TMP3797 = subInt((NI64)(TMP3796), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI64)(TMP3797), 32);
