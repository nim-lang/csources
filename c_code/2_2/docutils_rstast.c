...
N_NIMCALL(trstnode296009*, lastson_296146)(trstnode296009* n) {
	...
	if ((NU)((NI64)(TMP3777)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP3777)];
	popFrame();
	return result;
}
...
appendString((*result), ind);
		...
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI64)(TMP3782), lvltochar_296257[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI64)(TMP3784), 45);
...
appendString((*result), ((NimStringDesc*) &TMP3787));
	...
	case ((NU8) 14):
	{
		...
		l = (((NI64)(TMP3788) >= 30) ? (NI64)(TMP3788) : 30);
...
appendString((*result), tmp);
		...
		TMP3790 = subInt((NI64)(TMP3789), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI64)(TMP3790), 32);
