...
static TNimNode* TMP827[3];
static TNimNode TMP811[4];
...
TMP827[0] = &TMP811[1];
TMP811[1].kind = 1;
TMP811[1].offset = offsetof(memfile274208, Mem);
TMP811[1].typ = (&NTI153);
TMP811[1].name = "mem";
TMP827[1] = &TMP811[2];
TMP811[2].kind = 1;
TMP811[2].offset = offsetof(memfile274208, Size);
TMP811[2].typ = (&NTI108);
TMP811[2].name = "size";
TMP827[2] = &TMP811[3];
TMP811[3].kind = 1;
TMP811[3].offset = offsetof(memfile274208, Handle);
TMP811[3].typ = (&NTI5611);
TMP811[3].name = "handle";
TMP811[0].len = 3; TMP811[0].kind = 2; TMP811[0].sons = &TMP827[0];
NTI274208.node = &TMP811[0];
}
