...
N_NIMCALL(tyObject_MemFile_j4SnXNrJDFBxAz4BlbM9aIQ, open_Dp9bdJQfA43suzyZzRfL9bow)(NimStringDesc* filename, tyEnum_FileMode_fVUBHvW79bXUw1j55Oo9avSQ mode, NI mappedSize, NI offset, NI newFileSize, NIM_BOOL allowRemap) {
	...
	LA1_: ;
	{
		...
		flags = (NI32)((NI32)(flags | ((int) 64)) | ((int) 512));
		permissions_mode = ((NI32) 384);
	...
	LA6_: ;
	{
		...
		raiseOSError_bEwAamo1N7TKcaU9akpiyIg(T20_, ((NimStringDesc*) &TM_mFfhe8Jm7Jqn2Znr3841fw_3));
	}
	LA13_: ;
	{
		if (!!((newFileSize == ((NI) -1)))) goto LA23_;
		{
			...
			NI32 T35_;
			T27_ = (int)0;
			T27_ = ftruncate(result.handle, newFileSize);
			...
			raiseOSError_bEwAamo1N7TKcaU9akpiyIg(T35_, ((NimStringDesc*) &TM_mFfhe8Jm7Jqn2Znr3841fw_3));
		}
		LA28_: ;
	}
	LA23_: ;
	...
	LA38_: ;
	{
		...
		LA44_: ;
		{
			...
			raiseOSError_bEwAamo1N7TKcaU9akpiyIg(T52_, ((NimStringDesc*) &TM_mFfhe8Jm7Jqn2Znr3841fw_3));
		}
		LA41_: ;
	}
	LA36_: ;
	...
	LA60_: ;
	result.mem = mmap(NIM_NIL, result.size, T53_, T59_, result.handle, offset);
	{
		NI32 T74_;
		if (!(result.mem == ((void*) -1))) goto LA67_;
		result.mem = NIM_NIL;
		result.size = ((NI) 0);
		{
			int T73_;
		...
		LA71_: ;
		T74_ = (NI32)0;
		T74_ = osLastError_tNPXXFl9cb3BG0pJKzUn9bew();
		raiseOSError_bEwAamo1N7TKcaU9akpiyIg(T74_, ((NimStringDesc*) &TM_mFfhe8Jm7Jqn2Znr3841fw_3));
	}
	LA67_: ;
	{
		NIM_BOOL T77_;
...
N_NIMCALL(void, close_pdDAO8UZUr4A4NczjpWmdA)(tyObject_MemFile_j4SnXNrJDFBxAz4BlbM9aIQ* f) {
	...
	error = !((T1_ == ((NI32) 0)));
	lastErr = osLastError_tNPXXFl9cb3BG0pJKzUn9bew();
	{
		NIM_BOOL T6_;
		int T7_;
