...
STRING_LITERAL(TMP2719, "getSymFromList", 14);
STRING_LITERAL(TMP3204, "lookupInRecord", 14);
STRING_LITERAL(TMP3205, "lookupInRecord(record case branch)", 34);
STRING_LITERAL(TMP3206, "lookupInRecord()", 16);
...
N_NIMCALL(void, strtableenlarge_224228)(tstrtable210822* t) {
	...
	tsymseq210820* LOC8;
	n = 0;
	n = (tsymseq210820*) newSeq((&NTI210820), (NI64)((*t).Data->Sup.len * 2));
	{
		NI i_224272;
		NI HEX3Atmp_224308;
		NI res_224311;
	...
	unsureAsgnRef((void**) (&(*x).Data), (tiipairseq219272*) newSeq((&NTI219272), 8));
	{
		...
		res_226831 = 0;
		{
			while (1) {
				...
				i_226827 = res_226831;
				(*x).Data->data[i_226827].Key = (IL64(-9223372036854775807) - IL64(1));
				res_226831 += 1;
			} LA3: ;
		}
	}
	...
	{
		{
			...
			if (!LOC8) goto LA9;
			n = 0;
			n = (tiipairseq219272*) newSeq((&NTI219272), (NI64)((*t).Data->Sup.len * 2));
			{
				NI i_227452;
				NI HEX3Atmp_227497;
				NI res_227500;
				...
				res_227500 = 0;
				{
					while (1) {
						...
						i_227452 = res_227500;
						n->data[i_227452].Key = (IL64(-9223372036854775807) - IL64(1));
						res_227500 += 1;
					} LA13: ;
				}
			}
			{
				...
				res_227506 = 0;
				{
					while (1) {
						...
						i_227465 = res_227506;
						{
							if (!!(((*t).Data->data[i_227465].Key == (IL64(-9223372036854775807) - IL64(1))))) goto LA19;
	...
	{
		{
			...
			LOC8 = mustrehash_219249((*t).Data->Sup.len, (*t).Counter);
			if (!LOC8) goto LA9;
			n = (tidpairseq210864*) newSeq((&NTI210864), (NI64)((*t).Data->Sup.len * 2));
			{
				NI i_225851;
				NI HEX3Atmp_226032;
				NI res_226035;
...
{	result = 0;
	{
		...
		res_219877 = start;
		{
			while (1) {
				...
				LA7: ;
				{
					internalerror_184669((*list).Info, ((NimStringDesc*) &TMP2719));
				}
				LA5: ;
				res_219877 += 1;
			} LA4: ;
	...
	{
		{
			...
			if (!LOC8) goto LA9;
			n = 0;
			n = (tidnodepairseq210870*) newSeq((&NTI210870), (NI64)((*t).Data->Sup.len * 2));
			{
				NI i_226652;
				NI HEX3Atmp_226701;
				NI res_226704;
...
{	result = 0;
	...
	{
		{
			...
			internalerror_184669((*n).Info, ((NimStringDesc*) &TMP3204));
		}
		LA13: ;
		...
		LA17: ;
		{
			...
			res_219588 = 1;
			{
				while (1) {
					...
					default:
					{
						internalerror_184669((*n).Info, ((NimStringDesc*) &TMP3205));
					}
					break;
					}
					res_219588 += 1;
	...
	default:
	{
		internalerror_184669((*n).Info, ((NimStringDesc*) &TMP3206));
	}
	break;
	}
	}BeforeRet: ;
