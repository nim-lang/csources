...
#include <stdio.h>
typedef struct ttmplparser224017 ttmplparser224017;
...
N_NIMCALL(void, newline_224040)(ttmplparser224017* p);
N_NIMCALL(void, llstreamwrite_180258)(tllstream180204* s, NimStringDesc* data);
N_NIMCALL(NimStringDesc*, nsuRepeatChar)(NI count, NIM_CHAR c);
static N_INLINE(void, nimFrame)(TFrame* s);
static N_INLINE(void, popFrame)(void);
N_NIMCALL(void, scanpar_224047)(ttmplparser224017* p, NI d);
N_NOINLINE(void, raiseIndexError)(void);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NOINLINE(void, raiseOverflow)(void);
static N_INLINE(NI, subInt)(NI a, NI b);
static N_INLINE(NIM_BOOL, withinexpr_224168)(ttmplparser224017* p);
N_NIMCALL(void, parseline_224177)(ttmplparser224017* p);
N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src);
N_NIMCALL(NimStringDesc*, addChar)(NimStringDesc* s, NIM_CHAR c);
N_NIMCALL(NIM_BOOL, endswithopr_180646)(NimStringDesc* x);
...
N_NIMCALL(void, llstreamwrite_180263)(tllstream180204* s, NIM_CHAR data);
...
NIM_CONST TY123387 patternchars_224037 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0xFF, 0x03,
0xFE, 0xFF, 0xFF, 0x87, 0xFE, 0xFF, 0xFF, 0x07,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP2672, "\012", 1);
STRING_LITERAL(TMP2673, "", 0);
STRING_LITERAL(TMP2674, "end", 3);
STRING_LITERAL(TMP2675, "#end", 4);
static NIM_CONST TY123387 TMP2677 = {
...
STRING_LITERAL(TMP2681, "\\x", 2);
STRING_LITERAL(TMP2682, "\\\\", 2);
STRING_LITERAL(TMP2683, "\\\'", 2);
STRING_LITERAL(TMP2684, "\\\"", 2);
STRING_LITERAL(TMP2685, "}", 1);
STRING_LITERAL(TMP2686, "$", 1);
STRING_LITERAL(TMP2687, "\\n\"", 3);
STRING_LITERAL(TMP2688, "subschar", 8);
STRING_LITERAL(TMP2689, "metachar", 8);
STRING_LITERAL(TMP2690, "emit", 4);
STRING_LITERAL(TMP2691, "result.add", 10);
STRING_LITERAL(TMP2692, "conc", 4);
STRING_LITERAL(TMP2693, " & ", 3);
STRING_LITERAL(TMP2694, "tostring", 8);
...
N_NIMCALL(void, newline_224040)(ttmplparser224017* p) {
	...
	llstreamwrite_180258((*p).Outp, LOC1);
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		nimln(42, "filter_tmpl.nim");
		llstreamwrite_180258((*p).Outp, ((NimStringDesc*) &TMP2672));
	}
	LA4: ;
	nimln(43, "filter_tmpl.nim");
	{
		...
		llstreamwrite_180258((*p).Outp, LOC10);
...
N_NIMCALL(void, parseline_224177)(ttmplparser224017* p) {
	...
	LA6: ;
	{
		...
		keyw = copyString(((NimStringDesc*) &TMP2673));
		...
		LOC13 = 0;
		nimln(83, "filter_tmpl.nim");
		LOC13 = withinexpr_224168(&(*p));
		if (LOC13) goto LA14;
		nimln(83, "filter_tmpl.nim");
		LOC13 = endswithopr_180646((*p).X);
		LA14: ;
		(*p).Pendingexprline = LOC13;
		nimln(84, "filter_tmpl.nim");
		nimln(84, "filter_tmpl.nim");
		LOC15 = 0;
		LOC15 = whichkeyword_175367(keyw);
		switch (LOC15) {
		case ((NU8) 20):
		{
			NimStringDesc* LOC22;
			...
			LA19: ;
			{
				...
				localerror_169571((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP2674));
			}
			LA17: ;
			...
			llstreamwrite_180258((*p).Outp, LOC22);
			nimln(92, "filter_tmpl.nim");
			llstreamwrite_180258((*p).Outp, ((NimStringDesc*) &TMP2675));
		}
		break;
		case ((NU8) 28):
		case ((NU8) 63):
		...
		case ((NU8) 39):
		{
			...
			llstreamwrite_180258((*p).Outp, LOC24);
			nimln(96, "filter_tmpl.nim");
			nimln(96, "filter_tmpl.nim");
			LOC25 = 0;
			LOC25 = copyStr((*p).X, d);
			llstreamwrite_180258((*p).Outp, LOC25);
		...
		case ((NU8) 24):
		{
			...
			nimln(99, "filter_tmpl.nim");
			nimln(99, "filter_tmpl.nim");
			TMP2676 = subInt((*p).Indent, 2);
			LOC27 = 0;
			LOC27 = nsuRepeatChar((NI64)(TMP2676), 32);
			llstreamwrite_180258((*p).Outp, LOC27);
			nimln(100, "filter_tmpl.nim");
			nimln(100, "filter_tmpl.nim");
			LOC28 = 0;
			LOC28 = copyStr((*p).X, d);
			llstreamwrite_180258((*p).Outp, LOC28);
		}
		break;
		case ((NU8) 37):
		case ((NU8) 62):
		...
		case ((NU8) 60):
		{
			...
			llstreamwrite_180258((*p).Outp, LOC30);
			nimln(103, "filter_tmpl.nim");
			nimln(103, "filter_tmpl.nim");
			LOC31 = 0;
			LOC31 = copyStr((*p).X, d);
			llstreamwrite_180258((*p).Outp, LOC31);
			nimln(104, "filter_tmpl.nim");
			{
				...
				nimln(104, "filter_tmpl.nim");
				LOC34 = 0;
				LOC34 = contains_91258((*p).X, TMP2677);
				if (!!(LOC34)) goto LA35;
		...
		default:
		{
			...
			llstreamwrite_180258((*p).Outp, LOC38);
			nimln(109, "filter_tmpl.nim");
			nimln(109, "filter_tmpl.nim");
			LOC39 = 0;
			LOC39 = copyStr((*p).X, d);
			llstreamwrite_180258((*p).Outp, LOC39);
		}
		break;
		}
	...
	LA9: ;
	{
		...
		case ((NU8) 1):
		{
			...
			llstreamwrite_180258((*p).Outp, (*p).Conc);
			nimln(122, "filter_tmpl.nim");
			llstreamwrite_180258((*p).Outp, ((NimStringDesc*) &TMP2672));
			nimln(123, "filter_tmpl.nim");
			nimln(123, "filter_tmpl.nim");
			nimln(123, "filter_tmpl.nim");
			TMP2678 = addInt((*p).Indent, 2);
			LOC42 = 0;
			LOC42 = nsuRepeatChar((NI64)(TMP2678), 32);
			llstreamwrite_180258((*p).Outp, LOC42);
			nimln(124, "filter_tmpl.nim");
			llstreamwrite_180258((*p).Outp, ((NimStringDesc*) &TMP2679));
		}
		break;
		case ((NU8) 0):
		{
			...
			llstreamwrite_180258((*p).Outp, LOC44);
			nimln(128, "filter_tmpl.nim");
			llstreamwrite_180258((*p).Outp, (*p).Emit);
			nimln(129, "filter_tmpl.nim");
			llstreamwrite_180258((*p).Outp, ((NimStringDesc*) &TMP2680));
		...
		while (1) {
			...
			case 128 ... 255:
			{
				...
				llstreamwrite_180258((*p).Outp, ((NimStringDesc*) &TMP2681));
				...
				llstreamwrite_180258((*p).Outp, LOC48);
			...
			case 92:
			{
				...
				llstreamwrite_180258((*p).Outp, ((NimStringDesc*) &TMP2682));
			...
			case 39:
			{
				...
				llstreamwrite_180258((*p).Outp, ((NimStringDesc*) &TMP2683));
			...
			case 34:
			{
				...
				llstreamwrite_180258((*p).Outp, ((NimStringDesc*) &TMP2684));
			...
			default:
			{
				nimln(150, "filter_tmpl.nim");
				{
					...
					case 123:
					{
						...
						llstreamwrite_180263((*p).Outp, 34);
						nimln(157, "filter_tmpl.nim");
						llstreamwrite_180258((*p).Outp, (*p).Conc);
						nimln(158, "filter_tmpl.nim");
						llstreamwrite_180258((*p).Outp, (*p).Tostr);
						nimln(159, "filter_tmpl.nim");
						llstreamwrite_180263((*p).Outp, 40);
						...
						while (1) {
							...
							case 0:
							{
								...
								localerror_169571((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP2685));
							...
							case 123:
							{
								...
								llstreamwrite_180263((*p).Outp, 123);
							}
							break;
							case 125:
							{
								...
								llstreamwrite_180263((*p).Outp, 125);
							}
							break;
							default:
							{
								...
								if ((NU)(j) > (NU)((*p).X->Sup.len)) raiseIndexError();
								llstreamwrite_180263((*p).Outp, (*p).X->data[j]);
						...
						llstreamwrite_180263((*p).Outp, 41);
					...
					default:
					{
						nimln(194, "filter_tmpl.nim");
						{
							...
							llstreamwrite_180263((*p).Outp, (*p).Subschar);
						...
						LA76: ;
						{
							...
							localerror_169571((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP2686));
						}
						LA74: ;
					}
					break;
		...
		llstreamwrite_180258((*p).Outp, ((NimStringDesc*) &TMP2687));
	}
	LA2: ;
	popFrame();
}
...
N_NIMCALL(tllstream180204*, filtertmpl_224007)(tllstream180204* stdin_224009, NimStringDesc* filename, tnode192813* call) {
	...
	p.Info = newlineinfo_168076(filename, 0, 0);
	nimln(208, "filter_tmpl.nim");
	p.Outp = llstreamopen_180218(((NimStringDesc*) &TMP2673));
	nimln(209, "filter_tmpl.nim");
	p.Inp = stdin_224009;
	nimln(210, "filter_tmpl.nim");
	p.Subschar = chararg_223014(call, ((NimStringDesc*) &TMP2688), 1, 36);
	nimln(211, "filter_tmpl.nim");
	p.Nimdirective = chararg_223014(call, ((NimStringDesc*) &TMP2689), 2, 35);
	nimln(212, "filter_tmpl.nim");
	p.Emit = strarg_223021(call, ((NimStringDesc*) &TMP2690), 3, ((NimStringDesc*) &TMP2691));
	nimln(213, "filter_tmpl.nim");
	p.Conc = strarg_223021(call, ((NimStringDesc*) &TMP2692), 4, ((NimStringDesc*) &TMP2693));
	nimln(214, "filter_tmpl.nim");
	p.Tostr = strarg_223021(call, ((NimStringDesc*) &TMP2694), 5, ((NimStringDesc*) &TMP2686));
	...
	while (1) {
		...
		nimln(216, "filter_tmpl.nim");
		LOC2 = 0;
		LOC2 = llstreamreadline_180248(p.Inp, &p.X);
		if (!LOC2) goto LA1;
		nimln(217, "filter_tmpl.nim");
		nimln(217, "filter_tmpl.nim");
		TMP2695 = addInt(p.Info.Line, ((NI16) 1));
		if (TMP2695 < -32768 || TMP2695 > 32767) raiseOverflow();
		p.Info.Line = (NI16)(TMP2695);
