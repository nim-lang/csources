...
N_NIMCALL(void, parsedirective_205369)(tlexer200190* l, ttoken200186* tok) {
	...
	{
		NIM_BOOL res;
		condstack_205192 = (TY205171*) setLengthSeq(&(condstack_205192)->Sup, sizeof(NIM_BOOL), (NI64)(condstack_205192->Sup.len + 1));
		res = evalppif_205149(l, tok);
			...
			{
				{
					...
					i_206066 = 0;
					HEX3Atmp_206068 = 0;
					HEX3Atmp_206068 = (NI64)(pd->Sup.len - 2);
					res_206070 = 0;
					{
						while (1) {
							...
							i_206066 = res_206070;
							{
								...
								LOC60 = (i_206066 == 0);
								if (LOC60) goto LA61;
								LOC60 = !((((NU8)(pd->data[(NI64)(i_206066 - 1)])) == ((NU8)(47)) || ((NU8)(pd->data[(NI64)(i_206066 - 1)])) == ((NU8)(47))));
								LA61: ;
								LOC58 = LOC60;
								LA59: ;
								if (!LOC58) goto LA62;
