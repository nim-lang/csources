...
N_NIMCALL(void, parsedirective_203343)(tlexer198184* l, ttoken198180* tok) {
	...
	{
		NIM_BOOL res;
		condstack_203187 = (TY203168*) setLengthSeq(&(condstack_203187)->Sup, sizeof(NIM_BOOL), (NI64)(condstack_203187->Sup.len + ((NI) 1)));
		res = evalppif_203146(l, tok);
			...
			{
				{
					...
					i_204053 = 0;
					HEX3Atmp_204055 = 0;
					HEX3Atmp_204055 = (NI64)(pd->Sup.len - ((NI) 2));
					res_204057 = ((NI) 0);
					{
						while (1) {
							...
							i_204053 = res_204057;
							{
								...
								LOC60 = (i_204053 == ((NI) 0));
								if (LOC60) goto LA61;
								LOC60 = !((((NU8)(pd->data[(NI64)(i_204053 - ((NI) 1))])) == ((NU8)(47)) || ((NU8)(pd->data[(NI64)(i_204053 - ((NI) 1))])) == ((NU8)(47))));
								LA61: ;
								LOC58 = LOC60;
								LA59: ;
								if (!LOC58) goto LA62;
