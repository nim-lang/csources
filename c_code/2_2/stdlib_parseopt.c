...
N_NIMCALL(void, handleshortoption_192291)(optparser192011* p);
N_NIMCALL(NimStringDesc*, addChar)(NimStringDesc* s, NIM_CHAR c);
N_NIMCALL(NI, parseword_192204)(NimStringDesc* s, NI i, NimStringDesc** w, TY195407 delim);
...
STRING_LITERAL(TMP1583, "", 0);
static NIM_CONST TY195407 TMP1584 = {
0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY195407 TMP1585 = {
...
N_NIMCALL(void, initoptparser_192030)(NimStringDesc* cmdline, optparser192011* Result) {
	...
	LA3: ;
	{
		unsureAsgnRef((void**) (&(*Result).Cmd), copyString(((NimStringDesc*) &TMP1581)));
		{
			NI i_192046;
			NI HEX3Atmp_192049;
			NI res_192052;
			i_192046 = 0;
			HEX3Atmp_192049 = 0;
			HEX3Atmp_192049 = paramcount_123830();
			res_192052 = ((NI) 1);
			{
				while (1) {
					NimStringDesc* LOC9;
					...
					LOC9 = 0;
					LOC10 = 0;
					LOC10 = paramstr_123809(i_192046);
					LOC11 = 0;
...
appendChar(LOC9, 32);
	...
	LA1: ;
	(*Result).Kind = ((NU8) 0);
	unsureAsgnRef((void**) (&(*Result).Key), copyString(((NimStringDesc*) &TMP1583)));
	unsureAsgnRef((void**) (&(*Result).Val), copyString(((NimStringDesc*) &TMP1583)));
}
...
N_NIMCALL(void, handleshortoption_192291)(optparser192011* p) {
	...
	}
	{
		...
		i = parseword_192204((*p).Cmd, i, (&(*p).Val), TMP1584);
	}
	LA5: ;
	{
...
{	i = (*p).Pos;
	...
	case 45:
	{
		i += ((NI) 1);
		{
			...
			(*p).Kind = ((NU8) 2);
			i += ((NI) 1);
			i = parseword_192204((*p).Cmd, i, (&(*p).Key), TMP1585);
			{
				while (1) {
			...
			}
			{
				...
				(*p).Pos = parseword_192204((*p).Cmd, i, (&(*p).Val), TMP1584);
			}
			goto LA15;
			LA17: ;
			{
	...
	{
		(*p).Kind = ((NU8) 1);
		(*p).Pos = parseword_192204((*p).Cmd, i, (&(*p).Key), TMP1584);
	}
	break;
	}
	}BeforeRet: ;
...
static TNimNode* TMP1577[6];
static TNimNode* TMP1578[4];
NI TMP1580;
static char* NIM_CONST TMP1579[4] = {
"cmdEnd", 
"cmdArgument", 
"cmdLongOption", 
"cmdShortOption"};
...
TMP1577[0] = &TMP708[1];
TMP708[1].kind = 1;
TMP708[1].offset = offsetof(optparser192011, Cmd);
TMP708[1].typ = (&NTI149);
TMP708[1].name = "cmd";
TMP1577[1] = &TMP708[2];
TMP708[2].kind = 1;
TMP708[2].offset = offsetof(optparser192011, Pos);
TMP708[2].typ = (&NTI108);
TMP708[2].name = "pos";
TMP1577[2] = &TMP708[3];
TMP708[3].kind = 1;
TMP708[3].offset = offsetof(optparser192011, Inshortstate);
TMP708[3].typ = (&NTI138);
...
NTI192009.base = 0;
NTI192009.flags = 3;
for (TMP1580 = 0; TMP1580 < 4; TMP1580++) {
TMP708[TMP1580+5].kind = 1;
TMP708[TMP1580+5].offset = TMP1580;
TMP708[TMP1580+5].name = TMP1579[TMP1580];
TMP1578[TMP1580] = &TMP708[TMP1580+5];
}
TMP708[9].len = 4; TMP708[9].kind = 2; TMP708[9].sons = &TMP1578[0];
NTI192009.node = &TMP708[9];
TMP708[4].kind = 1;
TMP708[4].offset = offsetof(optparser192011, Kind);
TMP708[4].typ = (&NTI192009);
TMP708[4].name = "kind";
TMP1577[4] = &TMP708[10];
TMP708[10].kind = 1;
TMP708[10].offset = offsetof(optparser192011, Key);
TMP708[10].typ = (&NTI149);
TMP708[10].name = "key";
TMP1577[5] = &TMP708[11];
TMP708[11].kind = 1;
TMP708[11].offset = offsetof(optparser192011, Val);
TMP708[11].typ = (&NTI149);
TMP708[11].name = "val";
TMP708[0].len = 6; TMP708[0].kind = 2; TMP708[0].sons = &TMP1577[0];
NTI192011.node = &TMP708[0];
}
