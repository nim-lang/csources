...
N_NIMCALL(void, intsetenlarge_205614)(intset205056* t) {
	...
	n = (ttrunkseq205054*) newSeq((&NTI205054), (NI64)((*t).Max + ((NI) 1)));
	{
		NI i_205642;
		NI res_205670;
		i_205642 = 0;
...
{	result = 0;
	...
	}
	{
		NIM_BOOL LOC9;
		LOC9 = 0;
		LOC9 = mustrehash_205073((NI64)((*t).Max + ((NI) 1)), (*t).Counter);
		if (!LOC9) goto LA10;
...
N_NIMCALL(void, incl_205856)(intset205056* s, NI key) {
	ttrunk205052* t;
	NI u;
	t = intsetput_205689(s, (NI)((NU64)(key) >> (NU64)(((NI) 9))));
	u = (NI)(key & ((NI) 511));
...
N_NIMCALL(NIM_BOOL, containsorincl_205898)(intset205056* s, NI key) {
	...
	ttrunk205052* t;
	result = 0;
	t = intsetget_205218((&(*s)), (NI)((NU64)(key) >> (NU64)(((NI) 9))));
	{
		NI u;
