...
static NIM_CONST TY187025 TMP7613 = {
...
N_NIMCALL(void, adddependencyaux_520020)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	appf_144085(&gdotgraph_520017, ((NimStringDesc*) &TMP7612), LOC1, 2);
	popFrame();
}
...
N_NIMCALL(void, generatedot_520007)(NimStringDesc* project) {
	...
	LOC4 = 0;
	LOC4 = ropef_144079(((NimStringDesc*) &TMP7617), LOC1, 2);
...
TMP7610[0].kind = 1;
TMP7610[0].offset = offsetof(tgen520012, Module);
TMP7610[0].typ = (&NTI186811);
TMP7610[0].name = "module";
NTI520012.node = &TMP7610[0];
NTI520014.size = sizeof(tgen520012*);
NTI520014.kind = 22;
NTI520014.base = (&NTI520012);
NTI520014.marker = TMP7620;
}
