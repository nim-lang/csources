...
typedef struct tgen526012 tgen526012;
...
N_NIMCALL(void, adddependencyaux_526020)(NimStringDesc* importing, NimStringDesc* imported);
...
NIM_CONST tpass251015 gendependpass_526152 = {myopen_526128,
NIM_NIL,
adddotdependency_526031,
NIM_NIL}
;
trope149007* gdotgraph_526017;
extern TFrame* frameptr_13238;
extern TNimType NTI251003; /* TPassContext */
TNimType NTI526012; /* TGen */
extern TNimType NTI192811; /* PSym */
TNimType NTI526014; /* PGen */
...
N_NIMCALL(void, adddependencyaux_526020)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	appf_149085(&gdotgraph_526017, ((NimStringDesc*) &TMP7613), LOC1, 2);
	popFrame();
}
...
N_NIMCALL(tnode192813*, adddotdependency_526031)(tpasscontext251003* c, tnode192813* n) {
	...
	if (c) chckObj((*c).Sup.m_type, (&NTI526012));
	g = ((tgen526012*) (c));
	...
	case ((NU8) 115):
	{
		...
		while (1) {
			...
			nimln(1452, "system.nim");
			if (!(res_526109 <= HEX3Atmp_526107)) goto LA3;
			nimln(1451, "system.nim");
			i_526049 = res_526109;
			nimln(34, "depends.nim");
			if (((TMP7614[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7615));
			if ((NU)(i_526049) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			imported = getmodulename_260012((*n).kindU.S6.Sons->data[i_526049]);
			nimln(35, "depends.nim");
			adddependencyaux_526020((*(*(*g).Module).Name).S, imported);
			nimln(1454, "system.nim");
			res_526109 = addInt(res_526109, 1);
		} LA3: ;
	}
	break;
	case ((NU8) 119):
	...
	case ((NU8) 126):
	{
		...
		while (1) {
			tnode192813* LOC8;
			nimln(1452, "system.nim");
			if (!(res_526113 <= HEX3Atmp_526111)) goto LA7;
			nimln(1451, "system.nim");
			i_526092 = res_526113;
			nimln(40, "depends.nim");
			nimln(40, "depends.nim");
			if (((TMP7614[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7615));
			if ((NU)(i_526092) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC8 = 0;
			LOC8 = adddotdependency_526031(c, (*n).kindU.S6.Sons->data[i_526092]);
			nimln(1454, "system.nim");
			res_526113 = addInt(res_526113, 1);
		} LA7: ;
	}
	break;
	default:
...
N_NIMCALL(tpasscontext251003*, myopen_526128)(tsym192843* module) {
	...
	g = (tgen526012*) newObj((&NTI526014), sizeof(tgen526012));
	(*g).Sup.Sup.m_type = (&NTI526012);
...
NTI526012.size = sizeof(tgen526012);
NTI526012.kind = 17;
NTI526012.base = (&NTI251003);
TMP7611[0].kind = 1;
TMP7611[0].offset = offsetof(tgen526012, Module);
TMP7611[0].typ = (&NTI192811);
TMP7611[0].name = "module";
NTI526012.node = &TMP7611[0];
NTI526014.size = sizeof(tgen526012*);
NTI526014.kind = 22;
NTI526014.base = (&NTI526012);
NTI526014.marker = TMP7621;
}
