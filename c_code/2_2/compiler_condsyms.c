...
STRING_LITERAL(TMP893, "true", 4);
STRING_LITERAL(TMP894, "false", 5);
STRING_LITERAL(TMP895, "nimrod", 6);
STRING_LITERAL(TMP896, "nimhygiene", 10);
STRING_LITERAL(TMP897, "niminheritable", 14);
STRING_LITERAL(TMP898, "nimmixin", 8);
STRING_LITERAL(TMP899, "nimeffects", 10);
STRING_LITERAL(TMP900, "nimbabel", 8);
STRING_LITERAL(TMP901, "nimcomputedgoto", 15);
STRING_LITERAL(TMP902, "x86", 3);
STRING_LITERAL(TMP903, "itanium", 7);
STRING_LITERAL(TMP904, "x8664", 5);
STRING_LITERAL(TMP905, "msdos", 5);
STRING_LITERAL(TMP906, "mswindows", 9);
STRING_LITERAL(TMP907, "win32", 5);
STRING_LITERAL(TMP908, "unix", 4);
STRING_LITERAL(TMP909, "posix", 5);
STRING_LITERAL(TMP910, "sunos", 5);
STRING_LITERAL(TMP911, "bsd", 3);
STRING_LITERAL(TMP912, "macintosh", 9);
STRING_LITERAL(TMP913, "cpu", 3);
extern NIM_CONST TY119461 cpu_119460;
extern NIM_CONST TY119456 endiantostr_119455;
extern NIM_CONST TY119062 os_119061;
STRING_LITERAL(TMP914, "emulatedthreadvars", 18);
...
N_NIMCALL(void, definesymbol_141006)(NimStringDesc* symbol) {
	...
	nstPut(gsymbols_141003, symbol, ((NimStringDesc*) &TMP893));	popFrame();
}
N_NIMCALL(void, undefsymbol_141011)(NimStringDesc* symbol) {
	nimfr("UndefSymbol", "condsyms.nim")
	nimln(23, "condsyms.nim");
	nstPut(gsymbols_141003, symbol, ((NimStringDesc*) &TMP894));	popFrame();
}
static N_INLINE(NIM_BOOL, eqStrings)(NimStringDesc* a, NimStringDesc* b) {
	NIM_BOOL result;
	NIM_BOOL LOC11;
...
N_NIMCALL(NIM_BOOL, isdefined_141016)(NimStringDesc* symbol) {
	...
	nimln(26, "condsyms.nim");
	{
		...
		result = eqStrings(LOC6, ((NimStringDesc*) &TMP893));
	}	LA4: ;
	popFrame();
	return result;
}
...
N_NIMCALL(NI, countdefinedsymbols_141041)(void) {
	...
	while (1) {
		...
		nimln(41, "strtabs.nim");
		{
			...
			{
				nimln(38, "condsyms.nim");
				if (!eqStrings(val_141045, ((NimStringDesc*) &TMP893))) goto LA8;
				nimln(38, "condsyms.nim");
...
N_NIMCALL(void, initdefines_141065)(void) {
	...
	definesymbol_141006(((NimStringDesc*) &TMP895));	nimln(44, "condsyms.nim");
	definesymbol_141006(((NimStringDesc*) &TMP896));	nimln(45, "condsyms.nim");
	definesymbol_141006(((NimStringDesc*) &TMP897));	nimln(46, "condsyms.nim");
	definesymbol_141006(((NimStringDesc*) &TMP898));	nimln(47, "condsyms.nim");
	definesymbol_141006(((NimStringDesc*) &TMP899));	nimln(48, "condsyms.nim");
	definesymbol_141006(((NimStringDesc*) &TMP900));	nimln(49, "condsyms.nim");
	definesymbol_141006(((NimStringDesc*) &TMP901));	nimln(52, "condsyms.nim");
	switch (targetcpu_119560) {
	case ((NU8) 1):
	{
		nimln(53, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP902));	}	break;
	case ((NU8) 8):
	{
	...
	case ((NU8) 9):
	{
		...
		definesymbol_141006(((NimStringDesc*) &TMP904));	}	break;
	default:
	{
	}	break;
	}
	...
	case ((NU8) 2):
	{
		...
		definesymbol_141006(((NimStringDesc*) &TMP906));		nimln(62, "condsyms.nim");
	...
	case ((NU8) 20):
	{
		...
		definesymbol_141006(((NimStringDesc*) &TMP908));		nimln(67, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP909));	}	break;
	case ((NU8) 7):
	{
		nimln(69, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP910));		nimln(70, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP908));		nimln(71, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP909));	}	break;
	case ((NU8) 9):
	case ((NU8) 10):
	case ((NU8) 11):
	{
		...
		definesymbol_141006(((NimStringDesc*) &TMP908));		nimln(74, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP911));		nimln(75, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP909));	}	break;
	case ((NU8) 18):
	{
		nimln(77, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP912));	}	break;
	case ((NU8) 19):
	{
		nimln(79, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP912));		nimln(80, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP908));		nimln(81, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP909));	}	break;
	default:
	{
	}	break;
...
appendString(LOC13, ((NimStringDesc*) &TMP913));
appendString(LOC13, LOC14);
	...
	definesymbol_141006(os_119061[(targetos_119562)- 1].Field0);	nimln(87, "condsyms.nim");
	{
		...
		definesymbol_141006(((NimStringDesc*) &TMP914));	}	LA18: ;
	popFrame();
