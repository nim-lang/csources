...
N_NIMCALL(NIM_BOOL, readlinefromstdin_284281_597494479)(NimStringDesc* prompt0, NimStringDesc** line0);
...
N_NIMCALL(NI, counttriples_284453_597494479)(NimStringDesc* s0);
static N_INLINE(NIM_BOOL, continueline_284436_597494479)(NimStringDesc* line0, NIM_BOOL intriplestring0);
N_NIMCALL(NIM_BOOL, endswith_284401_597494479)(NimStringDesc* x0, char136Set s0);
...
TNimType NTI284204; /* TLLStream */
TNimType NTI284202; /* TLLStreamKind */
extern TNimType NTI13007; /* File */
extern TNimType NTI138; /* string */
extern TNimType NTI104; /* int */
TNimType NTI284206; /* PLLStream */
extern Gcheap49818 gch_49858_1689653243;
extern TNimType NTI136; /* char */
TNimType NTI284404; /* set[char] */
N_NIMCALL(void, T597494479_6)(void* p, NI op) {
	Tllstream284204* a;
	a = (Tllstream284204*)p;
...
N_NIMCALL(Tllstream284204*, llstreamopen_284242_597494479)(NimStringDesc* filename0, Filemode13009 mode0) {
	...
	result0 = (Tllstream284204*) newObj((&NTI284206), sizeof(Tllstream284204));
	(*result0).Sup.m_type = (&NTI284204);
	(*result0).kind = ((Tllstreamkind284202) 2);
	{
		NIM_BOOL LOC3;
		LOC3 = (NIM_BOOL)0;
...
static N_INLINE(NIM_BOOL, continueline_284436_597494479)(NimStringDesc* line0, NIM_BOOL intriplestring0) {
	...
	LOC1 = LOC2;
	if (LOC1) goto LA4;
	LOC1 = endswith_284401_597494479(line0, T597494479_11);
	LA4: ;
	result0 = LOC1;
	return result0;
}
...
N_NIMCALL(NI, llstreamread_284530_597494479)(Tllstream284204* s0, void* buf0, NI buflen0) {
	...
	case ((Tllstreamkind284202) 3):
	{
		result0 = llreadfromstdin_284486_597494479(s0, buf0, buflen0);
	}
	break;
	}
	return result0;
...
N_NIMCALL(Tllstream284204*, llstreamopen_284218_597494479)(NimStringDesc* data0) {
	...
	if (LOC1) nimGCunrefNoCycle(LOC1);
	(*result0).kind = ((Tllstreamkind284202) 1);
	return result0;
}
...
N_NIMCALL(NIM_BOOL, endswithopr_284432_597494479)(NimStringDesc* x0) {
	NIM_BOOL result0;
	result0 = (NIM_BOOL)0;
	result0 = endswith_284401_597494479(x0, T597494479_12);
	return result0;
}
...
N_NIMCALL(void, llstreamwriteln_284608_597494479)(Tllstream284204* s0, NimStringDesc* data0) {
	llstreamwrite_284593_597494479(s0, data0);
	llstreamwrite_284593_597494479(s0, ((NimStringDesc*) &T597494479_8));
}
...
N_NIMCALL(Tllstream284204*, llstreamopenstdin_284267_597494479)(void) {
	...
	result0 = (Tllstream284204*) newObj((&NTI284206), sizeof(Tllstream284204));
	(*result0).Sup.m_type = (&NTI284204);
	(*result0).kind = ((Tllstreamkind284202) 3);
	LOC1 = (NimStringDesc*)0;
...
NTI284204.size = sizeof(Tllstream284204);
NTI284204.kind = 17;
NTI284204.base = (&NTI3608);
T597494479_2[0] = &T597494479_0[1];
NTI284202.size = sizeof(Tllstreamkind284202);
NTI284202.kind = 14;
NTI284202.base = 0;
NTI284202.flags = 3;
...
NTI284204.node = &T597494479_0[0];
NTI284206.size = sizeof(Tllstream284204*);
NTI284206.kind = 22;
NTI284206.base = (&NTI284204);
NTI284206.marker = T597494479_6;
NTI284404.size = sizeof(char136Set);
NTI284404.kind = 19;
NTI284404.base = (&NTI136);
NTI284404.flags = 3;
T597494479_0[12].len = 0; T597494479_0[12].kind = 0;
NTI284404.node = &T597494479_0[12];
}
