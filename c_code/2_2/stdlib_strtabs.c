...
STRING_LITERAL(TMP1369, "", 0);
STRING_LITERAL(TMP1927, "format string: key not found: ", 30);
...
N_NIMCALL(NimStringDesc*, nstGet)(stringtableobj131012* t, NimStringDesc* key) {
	...
	LA3: ;
	{
		result = copyString(((NimStringDesc*) &TMP1369));
	}
	LA1: ;
	return result;
}
