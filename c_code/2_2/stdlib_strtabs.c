...
static N_INLINE(NI, nexttry_123006)(NI h, NI maxhash) {
	...
	nimln(89, "strtabs.nim");
	TMP283 = mulInt(5, h);
	TMP284 = addInt((NI64)(TMP283), 1);
	result = (NI)((NI64)(TMP284) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, enlarge_123081)(tstringtable122810* t) {
	...
	n = (tkeyvaluepairseq122808*) newSeq((&NTI122808), (NI64)(TMP288));
	i_123124 = 0;
	HEX3Atmp_123142 = 0;
...
N_NIMCALL(tstringtable122810*, nstnewStringTableWithPairs)(NimStringDesc** keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	...
	while (1) {
		...
		nimln(176, "strtabs.nim");
		TMP300 = addInt(i, 1);
		if ((NU)((NI64)(TMP300)) >= (NU)(keyvaluepairsLen0)) raiseIndexError();
		nstPut(result, keyvaluepairs[i], keyvaluepairs[(NI64)(TMP300)]);
