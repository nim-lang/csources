...
typedef struct toptparser528807 toptparser528807;
...
N_NIMCALL(void, processcmdline_530207)(NU8 pass, NimStringDesc* cmd);
N_NIMCALL(void, initoptparser_528819)(NimStringDesc* cmdline, toptparser528807* Result);
N_NOINLINE(void, chckNil)(void* p);
N_NIMCALL(void, nponext)(toptparser528807* p);
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser528807* p);
...
NimStringDesc* curcaascmd_530203;
extern TFrame* frameptr_13238;
extern tgcheap43816 gch_43844;
NimStringDesc* lastcaascmd_530204;
NimStringDesc* arguments_530205;
extern TNimType NTI528807; /* TOptParser */
...
extern tsocketimpl154605* invalidsocket_154678;
extern tsocketimpl154605* stdoutsocket_168189;
...
N_NIMCALL(void, processcmdline_530207)(NU8 pass, NimStringDesc* cmd) {
	...
	p.Sup.m_type = (&NTI528807);
	initoptparser_528819(cmd, &p);
...
appendString(LOC8, p.Val);
				...
				processswitch_177016(key, val, pass, gcmdlineinfo_168103);
			}
			goto LA4;
			LA6: ;
			{
				nimln(48, "service.nim");
				processswitch_177016(p.Key, p.Val, pass, gcmdlineinfo_168103);
			}
			LA4: ;
		}
		break;
		case ((NU8) 1):
		{
			nimln(50, "service.nim");
			{
				...
				LOC16 = 0;
				LOC16 = command_139212; command_139212 = copyStringRC1(p.Key);
			...
			LA14: ;
			{
				nimln(53, "service.nim");
				{
					...
					nimln(53, "service.nim");
					commandargs_139234 = (TY10865*) incrSeq(&(commandargs_139234)->Sup, sizeof(NimStringDesc*));
					LOC22 = 0;
					LOC22 = commandargs_139234->data[commandargs_139234->Sup.len-1]; commandargs_139234->data[commandargs_139234->Sup.len-1] = copyStringRC1(p.Key);
				...
				nimln(54, "service.nim");
				{
					...
					asgnRefNoCycle((void**) &gprojectname_139206, nosunixToNativePath(p.Key, ((NimStringDesc*) &TMP7639)));
					nimln(57, "service.nim");
					asgnRefNoCycle((void**) &arguments_530205, npocmdLineRest(&p));
	...
	nimln(61, "service.nim");
	{
		...
		nimln(62, "service.nim");
		{
			...
			nimln(62, "service.nim");
			nimln(62, "service.nim");
			LOC33 = !(((gglobaloptions_139111 &(1<<((((NU8) 13))&31)))!=0));
			if (!(LOC33)) goto LA34;
			nimln(62, "service.nim");
			nimln(62, "service.nim");
			LOC33 = !(((arguments_530205) && (arguments_530205)->Sup.len == 0));
			LA34: ;
			if (!LOC33) goto LA35;
			nimln(63, "service.nim");
			memset((void*)LOC37, 0, sizeof(LOC37));
			rawmessage_169292(((NU16) 57), LOC37, 0);
		}
		LA35: ;
	}
	LA29: ;
...
N_NIMCALL(void, serve_530292)(TY530294 action) {
	...
	typ = getconfigvar_139311(((NimStringDesc*) &TMP7646));
	...
	LA1: ;
	{
		...
		while (1) {
			...
			LOC11 = 0;
			LOC11 = curcaascmd_530203; curcaascmd_530203 = copyStringRC1(line);
			if (LOC11) nimGCunrefNoCycle(LOC11);
			nimln(68, "service.nim");
			processcmdline_530207(((NU8) 1), line);
	...
	LA2: ;
	{
		tsocketimpl154605* server;
		NimStringDesc* p;
		NU16 port;
		NimStringDesc* LOC24;
		NimStringDesc* inp;
		nimln(86, "service.nim");
		server = socket_155402(((NU8) 2), ((NU8) 1), ((NU8) 6), NIM_TRUE);
		nimln(87, "service.nim");
		{
			NI32 LOC17;
			nimln(87, "service.nim");
			if (!(server == invalidsocket_154678)) goto LA15;
			nimln(87, "service.nim");
			nimln(87, "service.nim");
			LOC17 = 0;
		...
		p = getconfigvar_139311(((NimStringDesc*) &TMP7654));
		...
		nimln(90, "service.nim");
		LOC24 = 0;
		LOC24 = getconfigvar_139311(((NimStringDesc*) &TMP7655));
		bindaddr_156584(server, port, LOC24);
		nimln(91, "service.nim");
		inp = copyString(((NimStringDesc*) &TMP7639));
		nimln(92, "service.nim");
		listen_156405(server, SOMAXCONN);
		nimln(93, "service.nim");
		if (stdoutsocket_168189) nimGCunrefNoCycle(stdoutsocket_168189);
		stdoutsocket_168189 = (tsocketimpl154605*) newObjRC1((&NTI154607), sizeof(tsocketimpl154605));
		nimln(94, "service.nim");
		while (1) {
			NimStringDesc* LOC26;
			nimln(95, "service.nim");
			accept_158201(server, &stdoutsocket_168189);
			nimln(96, "service.nim");
			readline_163033(stdoutsocket_168189, &inp, -1);
			nimln(67, "service.nim");
			LOC26 = 0;
			LOC26 = curcaascmd_530203; curcaascmd_530203 = copyStringRC1(inp);
			if (LOC26) nimGCunrefNoCycle(LOC26);
			nimln(68, "service.nim");
			processcmdline_530207(((NU8) 1), inp);
			nimln(69, "service.nim");
			action();
			nimln(70, "service.nim");
			gdirtybufferidx_139127 = ((NI32) 0);
			...
			send_164604(stdoutsocket_168189, ((NimStringDesc*) &TMP7681));
			nimln(99, "service.nim");
			close_158266(stdoutsocket_168189);
		}
	}
	goto LA4;
	LA3: ;
...
N_NOINLINE(void, serviceInit)(void) {
	...
	LOC1 = 0;
	LOC1 = curcaascmd_530203; curcaascmd_530203 = copyStringRC1(((NimStringDesc*) &TMP7639));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(25, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_530204; lastcaascmd_530204 = copyStringRC1(((NimStringDesc*) &TMP7639));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(28, "service.nim");
	LOC3 = 0;
	LOC3 = arguments_530205; arguments_530205 = copyStringRC1(((NimStringDesc*) &TMP7639));
