...
extern tsocketimpl183607* stdoutsocket_197315;
...
N_NIMCALL(void, serve_606259)(TY606261 action) {
	...
	LA2: ;
	{
		...
		if (stdoutsocket_197315) nimGCunrefNoCycle(stdoutsocket_197315);
		stdoutsocket_197315 = (tsocketimpl183607*) newObjRC1((&NTI183609), sizeof(tsocketimpl183607));
		{
			while (1) {
				NimStringDesc* LOC28;
				accept_187401(server, &stdoutsocket_197315);
				readline_192447(stdoutsocket_197315, &inp, -1);
				LOC28 = 0;
				...
				gdirtyoriginalidx_170135 = ((NI32) 0);
				gerrorcounter_197303 = 0;
				send_194008(stdoutsocket_197315, ((NimStringDesc*) &TMP4847));
				close_187478(stdoutsocket_197315);
			}
		}
	}
	goto LA4;
