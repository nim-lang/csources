					...
					while (1) {
						...
						j = i_420189;
						{
							while (1) {
								NI LOC14;
								LOC14 = 0;
								LOC14 = cmpsignatures_420111((*a)->data[(NI64)(j - h)], v, relevantcols);
		...
		res_420473 = 0;
		{
			while (1) {
				...
				cond = NIM_NIL;
				{
					...
					col_420286 = 0;
					HEX3Atmp_420458 = 0;
					HEX3Atmp_420458 = (NI64)(paramlen - 1);
					res_420461 = 1;
					{
						while (1) {
				...
				addson_226290(call, LOC24);
				{
					...
					col_420347 = 0;
					HEX3Atmp_420464 = 0;
					HEX3Atmp_420464 = (NI64)(paramlen - 1);
					res_420467 = 1;
					{
						while (1) {
							tnode225819* LOC28;
...
N_NIMCALL(tnode225819*, generatemethoddispatchers_420508)(void) {
	...
	result = newnode_226093(((NU8) 114));
	{
		...
		bucket_420534 = 0;
		HEX3Atmp_420558 = 0;
		HEX3Atmp_420558 = (NI64)(gmethods_419315->Sup.len - 1);
		res_420561 = 0;
		{
			while (1) {
