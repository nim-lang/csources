...
N_NIMCALL(NI, getcolnumber_290044)(tbaselexer290016* l, NI pos) {
	...
	if ((NI64)(TMP4659) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP4659));
	popFrame();
	return result;
}
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src) {
...
TMP4769[0] = &TMP4628[1];
TMP4628[1].kind = 1;
TMP4628[1].offset = offsetof(tbaselexer290016, Bufpos);
TMP4628[1].typ = (&NTI105);
TMP4628[1].name = "bufpos";
TMP4769[1] = &TMP4628[2];
TMP4628[2].kind = 1;
TMP4628[2].offset = offsetof(tbaselexer290016, Buf);
TMP4628[2].typ = (&NTI144);
TMP4628[2].name = "buf";
TMP4769[2] = &TMP4628[3];
TMP4628[3].kind = 1;
TMP4628[3].offset = offsetof(tbaselexer290016, Buflen);
TMP4628[3].typ = (&NTI105);
TMP4628[3].name = "bufLen";
TMP4769[3] = &TMP4628[4];
TMP4628[4].kind = 1;
TMP4628[4].offset = offsetof(tbaselexer290016, Input);
TMP4628[4].typ = (&NTI142627);
TMP4628[4].name = "input";
TMP4769[4] = &TMP4628[5];
TMP4628[5].kind = 1;
TMP4628[5].offset = offsetof(tbaselexer290016, Linenumber);
TMP4628[5].typ = (&NTI105);
TMP4628[5].name = "LineNumber";
TMP4769[5] = &TMP4628[6];
TMP4628[6].kind = 1;
TMP4628[6].offset = offsetof(tbaselexer290016, Sentinel);
TMP4628[6].typ = (&NTI105);
TMP4628[6].name = "sentinel";
TMP4769[6] = &TMP4628[7];
TMP4628[7].kind = 1;
TMP4628[7].offset = offsetof(tbaselexer290016, Linestart);
TMP4628[7].typ = (&NTI105);
TMP4628[7].name = "lineStart";
TMP4769[7] = &TMP4628[8];
TMP4628[8].kind = 1;
TMP4628[8].offset = offsetof(tbaselexer290016, Fileopened);
TMP4628[8].typ = (&NTI133);
TMP4628[8].name = "fileOpened";
TMP4628[0].len = 8; TMP4628[0].kind = 2; TMP4628[0].sons = &TMP4769[0];
NTI290016.node = &TMP4628[0];
}
