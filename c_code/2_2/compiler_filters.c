...
static NIM_CONST TY171865 TMP2571 = {
	...
	while (1) {
		...
		nimln(31, "filters.nim");
		{
			...
			nimln(32, "filters.nim");
			{
				...
				if (((TMP2571[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2572));
				if ((NU)(i_195068) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP2571[(*(*n).kindU.S6.Sons->data[i_195068]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_195068]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2572));
			...
			nimln(33, "filters.nim");
			{
				...
				if (((TMP2571[(*(*n).kindU.S6.Sons->data[i_195068]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_195068]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2572));
				if ((NU)(0) >= (NU)((*(*n).kindU.S6.Sons->data[i_195068]).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (!(((TMP2574[(*(*(*n).kindU.S6.Sons->data[i_195068]).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*(*n).kindU.S6.Sons->data[i_195068]).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2575));
				LOC17 = 0;
...
N_NIMCALL(NIM_BOOL, boolarg_195028)(tnode171659* n, NimStringDesc* name, NI pos, NIM_BOOL default_195033) {
	...
	LA3: ;
	{
		...
		LOC6 = identeq_140456((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2580));
		LA7: ;
		if (!LOC6) goto LA8;
		nimln(53, "filters.nim");
		result = NIM_TRUE;
	...
	LA8: ;
	{
		...
		nimln(54, "filters.nim");
		if (!(((TMP2574[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2575));
		LOC11 = identeq_140456((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2581));
		LA12: ;
		if (!LOC11) goto LA13;
		nimln(54, "filters.nim");
		result = NIM_FALSE;
...
N_NIMCALL(tllstream161204*, filterstrip_195008)(tllstream161204* stdin_195010, NimStringDesc* filename, tnode171659* call) {
	...
	pattern = strarg_195021(call, ((NimStringDesc*) &TMP2582), 1, ((NimStringDesc*) &TMP2583));
	nimln(59, "filters.nim");
	leading = boolarg_195028(call, ((NimStringDesc*) &TMP2584), 2, NIM_TRUE);
	nimln(60, "filters.nim");
	trailing = boolarg_195028(call, ((NimStringDesc*) &TMP2585), 3, NIM_TRUE);
	nimln(61, "filters.nim");
	result = llstreamopen_161218(((NimStringDesc*) &TMP2583));
...
N_NIMCALL(tllstream161204*, filterreplace_195002)(tllstream161204* stdin_195004, NimStringDesc* filename, tnode171659* call) {
	...
	sub = strarg_195021(call, ((NimStringDesc*) &TMP2587), 1, ((NimStringDesc*) &TMP2583));
	...
	by = strarg_195021(call, ((NimStringDesc*) &TMP2588), 2, ((NimStringDesc*) &TMP2583));
