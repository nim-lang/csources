...
STRING_LITERAL(TMP1377, "overflow", 8);
	...
	LA1: ;
	{
		...
		(*b) = IL64(0);
		{
			while (1) {
				...
				TMP1071 = mulInt64((*b), IL64(10));
				TMP1072 = subInt(((NI) (((NU8)(s->data[i])))), ((NI) 48));
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	result = npuParseBiggestInt(s, (&res), start);
	{
		...
		LOC9 = 0;
		LOC9 = (*e_93055).Sup.Sup.message; (*e_93055).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1377));
