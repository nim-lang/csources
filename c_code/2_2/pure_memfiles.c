...
STRING_LITERAL(TMP2863, "newFileSize == -1 or not (mode == fmRead) ", 42);
...
static TNimNode* TMP2944[3];
static TNimNode TMP2861[4];
...
TMP2944[0] = &TMP2861[1];
TMP2861[1].kind = 1;
TMP2861[1].offset = offsetof(tmemfile209204, Mem);
TMP2861[1].typ = (&NTI146);
TMP2861[1].name = "mem";
TMP2944[1] = &TMP2861[2];
TMP2861[2].kind = 1;
TMP2861[2].offset = offsetof(tmemfile209204, Size);
TMP2861[2].typ = (&NTI105);
TMP2861[2].name = "size";
TMP2944[2] = &TMP2861[3];
TMP2861[3].kind = 1;
TMP2861[3].offset = offsetof(tmemfile209204, Handle);
TMP2861[3].typ = (&NTI3809);
TMP2861[3].name = "handle";
TMP2861[0].len = 3; TMP2861[0].kind = 2; TMP2861[0].sons = &TMP2944[0];
NTI209204.node = &TMP2861[0];
}
