...
typedef N_CLOSURE_PTR(NI, TMP4977) (tsym171689* x, tsym171689* y);
typedef NIM_CHAR TY611[100000001];
struct NimStringDesc {
  TGenericSeq Sup;
TY611 data;
};
typedef N_CLOSURE_PTR(NI, TMP4979) (tsym171689* x, tsym171689* y);
struct tentry321943 {
NI Pos;
tsym171689* Sym;
};
...
typedef N_CLOSURE_PTR(NI, TMP4996) (tentry321943 x, tentry321943 y);
...
N_NIMCALL(void, merge_319761)(tsym171689** a, NI aLen0, tsym171689** b, NI bLen0, NI lo, NI m, NI hi, TY319724 cmp, NU8 order) {
	...
	nimln(71, "algorithm.nim");
	{
		...
		nimln(71, "algorithm.nim");
		TMP4976 = addInt(m, 1);
		if ((NU)((NI64)(TMP4976)) >= (NU)(aLen0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI64)(TMP4976)], cmp.ClEnv) : ((TMP4977)(cmp.ClPrc))(a[m], a[(NI64)(TMP4976)]);
		LOC4 = 0;
...
N_NIMCALL(void, sort_319717)(tsym171689** a, NI aLen0, TY319724 cmp, NU8 order) {
	...
	nimln(125, "algorithm.nim");
	TMP4973 = divInt(n, 2);
	b = (tsymseq171661*) newSeq((&NTI171661), (NI64)(TMP4973));
	...
	while (1) {
		...
		while (1) {
			...
			nimln(130, "algorithm.nim");
			TMP4980 = subInt(m, s);
			TMP4981 = addInt((NI64)(TMP4980), 1);
			nimln(130, "algorithm.nim");
			TMP4982 = addInt(m, s);
			merge_319761(a, aLen0, b->data, b->Sup.len, (((NI64)(TMP4981) >= 0) ? (NI64)(TMP4981) : 0), m, (NI64)(TMP4982), cmp, order);			nimln(131, "algorithm.nim");
			nimln(131, "algorithm.nim");
			TMP4983 = mulInt(s, 2);
			m = subInt(m, (NI64)(TMP4983));
		} LA2: ;
...
N_NIMCALL(void, merge_322468)(tentry321943* a, NI aLen0, tentry321943* b, NI bLen0, NI lo, NI m, NI hi, TY322431 cmp, NU8 order) {
	...
	nimln(71, "algorithm.nim");
	{
		...
		nimln(71, "algorithm.nim");
		TMP4995 = addInt(m, 1);
		if ((NU)((NI64)(TMP4995)) >= (NU)(aLen0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI64)(TMP4995)], cmp.ClEnv) : ((TMP4996)(cmp.ClPrc))(a[m], a[(NI64)(TMP4995)]);
		LOC4 = 0;
		LOC4 = HEX2A_317040(LOC3, order);
		if (!(LOC4 <= 0)) goto LA5;
		nimln(71, "algorithm.nim");
...
N_NIMCALL(void, sort_322424)(tentry321943* a, NI aLen0, TY322431 cmp, NU8 order) {
	...
	nimln(125, "algorithm.nim");
	TMP4992 = divInt(n, 2);
	b = (TY321950*) newSeq((&NTI321950), (NI64)(TMP4992));
	nimln(126, "algorithm.nim");
	s = 1;
	nimln(127, "algorithm.nim");
	while (1) {
		...
		while (1) {
			...
			nimln(130, "algorithm.nim");
			TMP4998 = subInt(m, s);
			TMP4999 = addInt((NI64)(TMP4998), 1);
			nimln(130, "algorithm.nim");
			TMP5000 = addInt(m, s);
			merge_322468(a, aLen0, b->data, b->Sup.len, (((NI64)(TMP4999) >= 0) ? (NI64)(TMP4999) : 0), m, (NI64)(TMP5000), cmp, order);			nimln(131, "algorithm.nim");
			nimln(131, "algorithm.nim");
			TMP5001 = mulInt(s, 2);
			m = subInt(m, (NI64)(TMP5001));
		} LA2: ;
		nimln(132, "algorithm.nim");
		nimln(132, "algorithm.nim");
		TMP5002 = mulInt(s, 2);
