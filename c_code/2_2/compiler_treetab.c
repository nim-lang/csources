...
static NIM_CONST TY171865 TMP3142 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3143, "ident", 5);
static NIM_CONST TY171865 TMP3144 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3145, "sym", 3);
static NIM_CONST TY171865 TMP3146 = {
0xE0, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3147, "intVal", 6);
static NIM_CONST TY171865 TMP3148 = {
0x00, 0x00, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3149, "floatVal", 8);
static NIM_CONST TY171865 TMP3150 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3151, "strVal", 6);
...
STRING_LITERAL(TMP3158, "data[h].key == nil ", 19);
STRING_LITERAL(TMP3159, "not (t.data[index].key == nil) ", 31);
...
static N_INLINE(NI, nexttry_178196)(NI h, NI maxhash) {
	...
	nimln(452, "astalgo.nim");
	TMP3156 = mulInt(5, h);
	TMP3157 = addInt((NI64)(TMP3156), 1);
	result = (NI)((NI64)(TMP3157) & maxhash);
	popFrame();
	return result;
}
N_NIMCALL(NI, nodetablerawget_223378)(tnodetable171717 t, NI k, tnode171659* key) {
...
N_NIMCALL(void, nodetablerawinsert_223412)(tnodepairseq171715** data, NI k, tnode171659* key, NI val) {
	...
	nimln(72, "treetab.nim");
	{
		...
		nimln(72, "treetab.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP3158));	}	LA4: ;
...
N_NIMCALL(void, nodetableput_223605)(tnodetable171717* t, tnode171659* key, NI val) {
	...
	nimln(81, "treetab.nim");
	{
		...
		nimln(82, "treetab.nim");
		{
			...
			nimln(82, "treetab.nim");
			hiddenraiseassert_76017(((NimStringDesc*) &TMP3159));		}		LA7: ;
	...
	LA3: ;
	{
		nimln(85, "treetab.nim");
		{
			...
			n = (tnodepairseq171715*) newSeq((&NTI171715), (NI64)(TMP3160));
			i_223836 = 0;
			HEX3Atmp_223874 = 0;
...
N_NIMCALL(NI, nodetabletestorset_223881)(tnodetable171717* t, tnode171659* key, NI val) {
	...
	LA3: ;
	{
		nimln(102, "treetab.nim");
		{
			...
			n = (tnodepairseq171715*) newSeq((&NTI171715), (NI64)(TMP3161));
			i_224036 = 0;
			HEX3Atmp_224074 = 0;
