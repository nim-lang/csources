...
N_NIMCALL(NI, nodetablerawget_266227)(tnodetable210878 t, NI k, tnode210818* key);
N_NIMCALL(NIM_BOOL, treesequivalent_266115)(tnode210818* a, tnode210818* b);
...
N_NIMCALL(void, nodetablerawinsert_266280)(tnodepairseq210876** data, NI k, tnode210818* key, NI val);
	...
	{
		{
			...
			HEX3Atmp_266095 = (NI64)(LOC30 - 1);
			res_266098 = 0;
			{
				while (1) {
					NI LOC33;
					if (!(res_266098 <= HEX3Atmp_266095)) goto LA32;
					i_266087 = res_266098;
					LOC33 = 0;
		...
		{
			{
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					HEX3Atmp_266207 = (NI64)(LOC26 - 1);
					res_266210 = 0;
					{
						while (1) {
							if (!(res_266210 <= HEX3Atmp_266207)) goto LA28;
							i_266203 = res_266210;
							{
								NIM_BOOL LOC31;
								LOC31 = 0;
								LOC31 = treesequivalent_266115((*a).kindU.S6.Sons->data[i_266203], (*b).kindU.S6.Sons->data[i_266203]);
								if (!!(LOC31)) goto LA32;
								goto BeforeRet;
							}
							LA32: ;
	...
	h = (NI)(k & (t.Data->Sup.len-1));
	{
		while (1) {
			if (!!((t.Data->data[h].Key == NIM_NIL))) goto LA2;
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = treesequivalent_266115(t.Data->data[h].Key, key);
				LA6: ;
				if (!LOC5) goto LA7;
				result = h;
				goto BeforeRet;
...
N_NIMCALL(NI, nodetabletestorset_266721)(tnodetable210878* t, tnode210818* key, NI val) {
	...
	index = nodetablerawget_266227((*t), k, key);
	{
		if (!(0 <= index)) goto LA3;
	...
	{
		{
			...
			if (!LOC8) goto LA9;
			n = (tnodepairseq210876*) newSeq((&NTI210876), (NI64)((*t).Data->Sup.len * 2));
			{
				NI i_266851;
				NI HEX3Atmp_266901;
				NI res_266904;
				...
				res_266904 = 0;
				{
					while (1) {
						...
						i_266851 = res_266904;
						{
							...
							nodetablerawinsert_266280((&n), (*t).Data->data[i_266851].H, (*t).Data->data[i_266851].Key, (*t).Data->data[i_266851].Val);
						}
						LA16: ;
						res_266904 += 1;
					} LA13: ;
		...
		LA9: ;
		nodetablerawinsert_266280((&(*t).Data), k, key, val);
		result = val;
		(*t).Counter += 1;
	}
	LA1: ;
