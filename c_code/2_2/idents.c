...
N_NIMCALL(NI, cmpignorestyle_171036)(NCSTRING a, NCSTRING b, NI blen) {
	...
	while (1) {
		...
		nimln(43, "idents.nim");
		{
			...
			aa = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP976), 0, 255))));
		}
		LA16: ;
		nimln(44, "idents.nim");
		{
			...
			bb = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP977), 0, 255))));
		}
		LA22: ;
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
...
N_NIMCALL(tident171019*, getident_171250)(NCSTRING identifier, NI length, NI h) {
	...
	nimln(92, "idents.nim");
	{
		...
		nimln(94, "idents.nim");
		nimln(94, "idents.nim");
		if (wordcounter_171248 == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
		(*result).Sup.Id = ((NI64)-(wordcounter_171248));
	}
	goto LA22;
	LA24: ;
	{
