...
N_NIMCALL(void, handlecmdline_536603)(void);
...
extern NimStringDesc* arguments_530205;
...
N_NIMCALL(void, handlecmdline_536603)(void) {
	...
	nimln(35, "nimrod.nim");
	{
		...
		if (!(LOC3 == 0)) goto LA4;
		nimln(36, "nimrod.nim");
		writecommandlineusage_177002();
	}
	goto LA1;
	LA4: ;
	{
		nimln(39, "nimrod.nim");
		processcmdline_530207(((NU8) 0), ((NimStringDesc*) &TMP7786));
		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP7787;
			TY109700 p;
			...
			nimln(40, "nimrod.nim");
			nimln(40, "nimrod.nim");
			if (!!(((gprojectname_139206) && (gprojectname_139206)->Sup.len == 0))) goto LA9;
			nimln(41, "nimrod.nim");
			pushSafePoint(&TMP7787);
			TMP7787.status = setjmp(TMP7787.context);
			if (TMP7787.status == 0) {
				nimln(42, "nimrod.nim");
				asgnRefNoCycle((void**) &gprojectfull_139208, canonicalizepath_139335(gprojectname_139206));
				popSafePoint();
			}
			else {
				popSafePoint();
				...
				if (isObj(getCurrentException()->Sup.m_type, (&NTI2435))) {
					...
					nimln(44, "nimrod.nim");
					LOC14 = 0;
					LOC14 = gprojectfull_139208; gprojectfull_139208 = copyStringRC1(gprojectname_139206);
			...
			nossplitFile(gprojectfull_139208, &p);
			nimln(46, "nimrod.nim");
			LOC15 = 0;
			LOC15 = gprojectpath_139207; gprojectpath_139207 = copyStringRC1(p.Field0);
			if (LOC15) nimGCunrefNoCycle(LOC15);
			nimln(47, "nimrod.nim");
			LOC16 = 0;
			LOC16 = gprojectname_139206; gprojectname_139206 = copyStringRC1(p.Field1);
		...
		{
			nimln(49, "nimrod.nim");
			asgnRefNoCycle((void**) &gprojectpath_139207, nosgetCurrentDir());
		}
		LA7: ;
		nimln(50, "nimrod.nim");
		loadconfigs_188607(((NimStringDesc*) &TMP7788));
		nimln(53, "nimrod.nim");
		initvars_173714();
		nimln(54, "nimrod.nim");
		processcmdline_530207(((NU8) 1), ((NimStringDesc*) &TMP7786));
		nimln(55, "nimrod.nim");
		maincommand_534011();
		nimln(56, "nimrod.nim");
		{
		...
		{
			nimln(58, "nimrod.nim");
			if (!(gerrorcounter_168179 == 0)) goto LA25;
			nimln(62, "nimrod.nim");
			{
				nimln(62, "nimrod.nim");
				if (!((gglobaloptions_139111 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				nimln(63, "nimrod.nim");
				{
					NimStringDesc* ex;
					NimStringDesc* LOC44;
					nimln(63, "nimrod.nim");
					if (!(gcmd_139113 == ((NU8) 4))) goto LA33;
					ex = 0;
					nimln(65, "nimrod.nim");
					{
						NimStringDesc* LOC39;
						nimln(65, "nimrod.nim");
						nimln(65, "nimrod.nim");
						if (!(0 < outfile_139117->Sup.len)) goto LA37;
						nimln(66, "nimrod.nim");
						nimln(66, "nimrod.nim");
						LOC39 = 0;
						LOC39 = prependcurdir_536401(outfile_139117);
					...
					LA37: ;
					{
						...
						nimln(69, "nimrod.nim");
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_139208, ((NimStringDesc*) &TMP7789));
						LOC42 = 0;
						LOC42 = prependcurdir_536401(LOC41);
						LOC43 = 0;
						LOC43 = completecfilepath_173753(LOC42, NIM_TRUE);
					...
					nimln(70, "nimrod.nim");
					LOC44 = 0;
					LOC44 = rawNewString(ex->Sup.len + arguments_530205->Sup.len + 6);
appendString(LOC44, ((NimStringDesc*) &TMP7790));
appendString(LOC44, ex);
appendChar(LOC44, 32);
appendString(LOC44, arguments_530205);
					execexternalprogram_173785(LOC44);
				}
				goto LA31;
				LA33: ;
				{
					...
					nimln(73, "nimrod.nim");
					{
						nimln(73, "nimrod.nim");
						nimln(73, "nimrod.nim");
						if (!(0 < outfile_139117->Sup.len)) goto LA48;
						nimln(75, "nimrod.nim");
						binpath = prependcurdir_536401(outfile_139117);
					}
					goto LA46;
					LA48: ;
					{
						...
						nimln(78, "nimrod.nim");
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_139208, ((NimStringDesc*) &TMP7786));
						binpath = prependcurdir_536401(LOC51);
					}
					LA46: ;
					nimln(79, "nimrod.nim");
					...
					nimln(80, "nimrod.nim");
					LOC52 = 0;
					LOC52 = rawNewString(ex->Sup.len + arguments_530205->Sup.len + 1);
appendString(LOC52, ex);
appendChar(LOC52, 32);
appendString(LOC52, arguments_530205);
					execexternalprogram_173785(LOC52);
				}
				LA31: ;
			}
			LA29: ;
...
N_NOINLINE(void, nimrodInit)(void) {
	...
	initdefines_172072();
	nimln(91, "nimrod.nim");
	handlecmdline_536603();
	nimln(92, "nimrod.nim");
	nimln(92, "nimrod.nim");
	exit(((NI) (((NI8) ((0 < gerrorcounter_168179))))));
	popFrame();
}
