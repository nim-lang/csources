...
STRING_LITERAL(TMP1059, "invalid float: ", 15);
STRING_LITERAL(TMP1065, "invalid integer: ", 17);
STRING_LITERAL(TMP1210, "0123456789ABCDEF", 16);
STRING_LITERAL(TMP1212, "", 0);
static NIM_CONST TY212607 TMP1559 = {
0x00, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2099, "\\x", 2);
...
N_NOINLINE(void, invalidformatstring_98672)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_98676).Sup.message; (*e_98676).Sup.message = copyStringRC1(((NimStringDesc*) &TMP153));
...
appendString(LOC7, ((NimStringDesc*) &TMP1059));
appendString(LOC7, s);
...
appendString(LOC7, ((NimStringDesc*) &TMP1065));
appendString(LOC7, s);
	...
	result = mnewString(len);
	{
		...
		res_95595 = HEX3Atmp_95592;
		{
			while (1) {
				...
				j_95588 = res_95595;
				result->data[j_95588] = ((NimStringDesc*) &TMP1210)->data[(NI32)(((NI32)(NU32)(NU64)((NI64)((NU64)(x) >> (NU64)(shift)))) & ((NI32) 15))];
				shift = (NI64)(shift + 4);
				res_95595 -= 1;
			} LA3: ;
		}
...
N_NIMCALL(NimStringDesc*, quoteifcontainswhite_97196)(NimStringDesc* s) {
	...
	result = 0;
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = nsuFindCharSet(s, TMP1559, 0);
		LOC3 = (0 <= LOC4);
		if (!(LOC3)) goto LA5;
...
appendString(result, ((NimStringDesc*) &TMP2101));
				...
				{
					result = resizeString(result, 2);
appendString(result, ((NimStringDesc*) &TMP2102));
				}
				break;
				default:
				{
