...
N_NIMCALL(void, msgwriteln_164538)(NimStringDesc* s) {
	{
		...
		writelnhook_164063.ClEnv? writelnhook_164063.ClPrc(s, writelnhook_164063.ClEnv):((TMP143)(writelnhook_164063.ClPrc))(s);
	}
	goto LA1;
	LA3: ;
	{
...
N_NIMCALL(void, suggestwriteln_164072)(NimStringDesc* s) {
	{
		...
		LA7: ;
		{
			writelnhook_164063.ClEnv? writelnhook_164063.ClPrc(s, writelnhook_164063.ClEnv):((TMP1965)(writelnhook_164063.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, suggestquit_164130)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_164134).Sup.message; (*e_164134).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2665));
	if (LOC1) nimGCunrefNoCycle(LOC1);
