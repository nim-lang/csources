...
N_NIMCALL(NIM_BOOL, parseatom_182038)(tlexer178176* l, ttoken178174* tok) {
	...
	nimln(26, "nimconf.nim");
	{
		...
		LA7: ;
		{
			...
			lexmessage_178246(&(*l), ((NU16) 23), ((NimStringDesc*) &TMP1903));
		}
		LA5: ;
	}
	goto LA1;
...
N_NIMCALL(NIM_BOOL, evalppif_182113)(tlexer178176* l, ttoken178174* tok) {
	...
	LA3: ;
	{
		...
		lexmessage_178246(&(*l), ((NU16) 23), ((NimStringDesc*) &TMP1904));
	}
	LA1: ;
	popFrame();
	return result;
...
N_NIMCALL(void, doend_182155)(tlexer178176* l, ttoken178174* tok) {
	...
	nimln(61, "nimconf.nim");
	{
		...
		nimln(61, "nimconf.nim");
		lexmessage_178246(&(*l), ((NU16) 23), ((NimStringDesc*) &TMP1906));
	}
	LA3: ;
...
N_NIMCALL(void, jumptodirective_182185)(tlexer178176* l, ttoken178174* tok, NU8 dest) {
	...
	while (1) {
		...
		LA6: ;
		{
			...
			lexmessage_178246(&(*l), ((NU16) 23), ((NimStringDesc*) &TMP1908));
		}
		goto LA2;
		LA35: ;
		{
...
N_NIMCALL(void, parsedirective_182309)(tlexer178176* l, ttoken178174* tok) {
	...
	case ((NU8) 28):
	{
		...
		nimln(115, "nimconf.nim");
		nimln(115, "nimconf.nim");
		TMP1909 = addInt(condstack_182152->Sup.len, 1);
		condstack_182152 = (TY182131*) setLengthSeq(&(condstack_182152)->Sup, sizeof(NIM_BOOL), (NI64)(TMP1909));
...
N_NIMCALL(void, parseassignment_182407)(tlexer178176* l, ttoken178174* tok) {
	...
	nimln(158, "nimconf.nim");
	{
		...
		nimln(158, "nimconf.nim");
		LOC4 = 0;
		LOC4 = getident_166456(((NimStringDesc*) &TMP1913));
		LOC3 = ((*(*tok).Ident).Sup.Id == (*LOC4).Sup.Id);
		if (LOC3) goto LA5;
		nimln(158, "nimconf.nim");
		nimln(158, "nimconf.nim");
		LOC6 = 0;
		LOC6 = getident_166456(((NimStringDesc*) &TMP1914));
...
appendString(val, LOC15);
		...
		LA18: ;
		{
			...
			lexmessage_178246(&(*l), ((NU16) 23), ((NimStringDesc*) &TMP1916));
		}
		LA16: ;
...
appendString(val, LOC29);
		...
		while (1) {
			...
			nimln(187, "nimconf.nim");
			LOC33 = 0;
			LOC33 = getident_166456(((NimStringDesc*) &TMP1917));
...
N_NIMCALL(void, loadconfigs_182607)(NimStringDesc* cfg) {
	...
	nimln(224, "nimconf.nim");
	{
		...
		nimln(227, "nimconf.nim");
		{
			...
			nimln(227, "nimconf.nim");
			LOC9 = 0;
			LOC9 = libpath_136205; libpath_136205 = copyStringRC1(((NimStringDesc*) &TMP1925));
		...
		LA7: ;
		{
			...
			nimln(228, "nimconf.nim");
			LOC13 = 0;
			LOC13 = libpath_136205; libpath_136205 = copyStringRC1(((NimStringDesc*) &TMP1927));
		...
		LA11: ;
		{
			...
			asgnRefNoCycle((void**) &libpath_136205, nosjoinPath(prefix, ((NimStringDesc*) &TMP1928)));
		}
		LA5: ;
	}
	LA3: ;
	...
	nimln(238, "nimconf.nim");
	{
		...
		nimln(621, "os.nim");
		{
			...
			nimln(623, "os.nim");
			{
				...
				nimln(240, "nimconf.nim");
				LOC42 = 0;
				LOC42 = HEX2F_108477(dir_182654, cfg);
			...
			while (1) {
				...
				nimln(240, "nimconf.nim");
				LOC49 = 0;
				LOC49 = HEX2F_108477(dir_182654, cfg);
		...
		LA36: ;
		{
			...
			while (1) {
				...
				nimln(631, "os.nim");
				{
					...
					nimln(632, "os.nim");
					nimln(632, "os.nim");
					TMP1930 = subInt(i_182671, 1);
					if ((NU)((NI64)(TMP1930)) > (NU)(pd->Sup.len)) raiseIndexError();
					LOC56 = !((((NU8)(pd->data[(NI64)(TMP1930)])) == ((NU8)(47)) || ((NU8)(pd->data[(NI64)(TMP1930)])) == ((NU8)(47))));
					LA57: ;
					LOC54 = LOC56;
					LA55: ;
					if (!LOC54) goto LA58;
					...
					nimln(240, "nimconf.nim");
					LOC60 = 0;
					LOC60 = HEX2F_108477(dir_182654, cfg);
			...
			nimln(635, "os.nim");
			{
				...
				nimln(240, "nimconf.nim");
				LOC65 = 0;
				LOC65 = HEX2F_108477(dir_182654, cfg);
	...
	nimln(242, "nimconf.nim");
	{
		...
		nimln(245, "nimconf.nim");
		{
			...
			nimln(247, "nimconf.nim");
			LOC75 = 0;
			LOC75 = noschangeFileExt(gprojectfull_136208, ((NimStringDesc*) &TMP1931));
