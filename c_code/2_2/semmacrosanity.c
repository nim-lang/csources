...
static N_INLINE(tnode186813*, lastson_187199)(tnode186813* n) {
	...
	if ((NU)((NI64)(TMP5681)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI64)(TMP5681)];
	popFrame();
	return result;
}
...
N_NIMCALL(tsym186843*, ithfield_415007)(tnode186813* n, NI field) {
	...
	case ((NU8) 136):
	{
		...
		while (1) {
			...
			result = ithfield_415007((*n).kindU.S6.Sons->data[i_415024], (NI64)(TMP5677));
	...
	case ((NU8) 137):
	{
		...
		result = ithfield_415007((*n).kindU.S6.Sons->data[0], (NI64)(TMP5679));
		...
		while (1) {
			...
			case ((NU8) 88):
			{
				...
				result = ithfield_415007(LOC20, (NI64)(TMP5682));
