...
TMP961[0] = &TMP955[1];
TMP955[1].kind = 1;
TMP955[1].offset = offsetof(PluginHEX3Aobjecttype406019, fn);
TMP955[1].typ = (&NTI167019);
TMP955[1].name = "fn";
TMP961[1] = &TMP955[2];
TMP955[2].kind = 1;
TMP955[2].offset = offsetof(PluginHEX3Aobjecttype406019, module);
TMP955[2].typ = (&NTI167019);
TMP955[2].name = "module";
TMP961[2] = &TMP955[3];
TMP955[3].kind = 1;
TMP955[3].offset = offsetof(PluginHEX3Aobjecttype406019, package);
TMP955[3].typ = (&NTI167019);
...
NTI406013.flags = 3;
TMP955[4].kind = 1;
TMP955[4].offset = offsetof(PluginHEX3Aobjecttype406019, t);
TMP955[4].typ = (&NTI406013);
TMP955[4].name = "t";
TMP961[4] = &TMP955[5];
TMP955[5].kind = 1;
TMP955[5].offset = offsetof(PluginHEX3Aobjecttype406019, next);
TMP955[5].typ = (&NTI406015);
TMP955[5].name = "next";
TMP955[0].len = 5; TMP955[0].kind = 2; TMP955[0].sons = &TMP961[0];
NTI406019.node = &TMP955[0];
NTI406015.size = sizeof(PluginHEX3Aobjecttype406019*);
NTI406015.kind = 22;
NTI406015.base = (&NTI406019);
NTI406015.marker = TMP962;
}
