...
STRING_LITERAL(TMP332, "nimcache", 8);
STRING_LITERAL(TMP339, "lib", 3);
STRING_LITERAL(TMP340, "src", 3);
STRING_LITERAL(TMP341, "source", 6);
STRING_LITERAL(TMP342, "package", 7);
STRING_LITERAL(TMP343, "pckg", 4);
STRING_LITERAL(TMP344, "library", 7);
STRING_LITERAL(TMP345, "private", 7);
STRING_LITERAL(TMP346, "\012", 1);
STRING_LITERAL(TMP350, "cannot create directory: ", 25);
STRING_LITERAL(TMP352, "nim", 3);
STRING_LITERAL(TMP358, "not (\'\\0\' == sep) ", 18);
static NIM_CONST TY113118 TMP361 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x43, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP363, "true", 4);
...
N_NIMCALL(NimStringDesc*, removetrailingdirsep_114410)(NimStringDesc* path) {
	...
	nimln(205, "options.nim");
	{
		...
		LOC3 = ((NU8)(path->data[(NI64)(TMP329)]) == (NU8)(47));
		LA4: ;
		if (!LOC3) goto LA5;
		...
		nimln(206, "options.nim");
		nimln(206, "options.nim");
		TMP330 = subInt(path->Sup.len, 2);
		result = copyStrLast(path, 0, (NI64)(TMP330));
	}	goto LA1;
	LA5: ;
	{
...
N_NIMCALL(NimStringDesc*, getgeneratedpath_114417)(void) {
	...
	LA3: ;
	{
		...
		result = HEX2F_102067(LOC6, ((NimStringDesc*) &TMP332));
	}	LA1: ;
	popFrame();
	return result;
}
...
N_NIMCALL(NimStringDesc*, getpackagename_114423)(NimStringDesc* path) {
	...
	nimln(217, "options.nim");
	{
		...
		if (!(((NU8)(path->data[(NI64)(TMP333)])) == ((NU8)(47)) || ((NU8)(path->data[(NI64)(TMP333)])) == ((NU8)(47)))) goto LA3;
		nimln(217, "options.nim");
		q = 2;
	}	LA3: ;
	i_114448 = 0;
	...
	while (1) {
		...
		nimln(219, "options.nim");
		{
			...
			LA12: ;
			{
				...
				nimln(222, "options.nim");
				TMP336 = subInt(b, 1);
				x = copyStrLast(path, (NI64)(TMP335), (NI64)(TMP336));
...
static N_INLINE(void, writeln_114502)(FILE* f, NimStringDesc** x, NI xLen0) {
	...
	nimln(160, "sysio.nim");
	write_9459(f, ((NimStringDesc*) &TMP346));	popFrame();
}
static N_INLINE(void, pushSafePoint)(TSafePoint* s) {
...
N_NIMCALL(void, libcandidates_114600)(NimStringDesc* s, TY9552** dest) {
	...
	nimln(300, "options.nim");
	TMP353 = addInt(le, 1);
	ri = nsuFindChar(s, 41, (NI64)(TMP353));
	nimln(301, "options.nim");
	{
		...
		nimln(302, "options.nim");
		TMP354 = subInt(le, 1);
		prefix = copyStrLast(s, 0, (NI64)(TMP354));
		nimln(303, "options.nim");
		nimln(303, "options.nim");
		nimln(303, "options.nim");
		TMP355 = addInt(ri, 1);
		suffix = copyStr(s, (NI64)(TMP355));
		middle_114611 = 0;
		HEX3Atmp_114626 = 0;
		...
		nimln(304, "options.nim");
		TMP357 = subInt(ri, 1);
		HEX3Atmp_114626 = copyStrLast(s, (NI64)(TMP356), (NI64)(TMP357));
		...
		nimln(249, "strutils.nim");
		{
			...
			while (1) {
				...
				middle_114611 = copyStrLast(HEX3Atmp_114626, first_114630, (NI64)(TMP359));
...
N_NIMCALL(NimStringDesc*, canondynlibname_114635)(NimStringDesc* s) {
	...
	nimln(312, "options.nim");
	{
		...
		result = copyStrLast(s, start, (NI64)(TMP362));
	}	goto LA7;
	LA9: ;
	{
...
static TNimNode* TMP1986[22];
NI TMP1988;
static char* NIM_CONST TMP1987[22] = {
"optNone", 
"optObjCheck", 
"optFieldCheck", 
"optRangeCheck", 
...
"optImplicitStatic", 
"optPatterns"};
static TNimNode* TMP2987[32];
NI TMP2989;
static char* NIM_CONST TMP2988[32] = {
"gloptNone", 
"optForceFullMake", 
"optDeadCodeElim", 
"optListCmd", 
...
"optGenIndex", 
"optEmbedOrigSrc"};
static TNimNode* TMP2998[20];
NI TMP3000;
static char* NIM_CONST TMP2999[20] = {
"cmdNone", 
"cmdCompileToC", 
"cmdCompileToCpp", 
"cmdCompileToOC", 
...
NTI114009.base = 0;
NTI114009.flags = 3;
for (TMP1988 = 0; TMP1988 < 22; TMP1988++) {
TMP256[TMP1988+0].kind = 1;
TMP256[TMP1988+0].offset = TMP1988;
TMP256[TMP1988+0].name = TMP1987[TMP1988];
TMP1986[TMP1988] = &TMP256[TMP1988+0];
}
TMP256[22].len = 22; TMP256[22].kind = 2; TMP256[22].sons = &TMP1986[0];
...
NTI114013.base = 0;
NTI114013.flags = 3;
for (TMP2989 = 0; TMP2989 < 32; TMP2989++) {
TMP256[TMP2989+24].kind = 1;
TMP256[TMP2989+24].offset = TMP2989;
TMP256[TMP2989+24].name = TMP2988[TMP2989];
TMP2987[TMP2989] = &TMP256[TMP2989+24];
}
TMP256[56].len = 32; TMP256[56].kind = 2; TMP256[56].sons = &TMP2987[0];
NTI114013.node = &TMP256[56];
NTI114017.size = sizeof(NU8);
NTI114017.kind = 14;
NTI114017.base = 0;
NTI114017.flags = 3;
for (TMP3000 = 0; TMP3000 < 20; TMP3000++) {
TMP256[TMP3000+57].kind = 1;
TMP256[TMP3000+57].offset = TMP3000;
TMP256[TMP3000+57].name = TMP2999[TMP3000];
TMP2998[TMP3000] = &TMP256[TMP3000+57];
}
TMP256[77].len = 20; TMP256[77].kind = 2; TMP256[77].sons = &TMP2998[0];
