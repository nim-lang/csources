...
N_NIMCALL(NIM_BOOL, cyclicTreeAux_fJtdv7gqXOKIakDjzod6NA)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n, tySequence_ehmV9bTklH2Gt9cXHV9c0HLeQ** visited);
...
N_NIMCALL(void, unnestStmts_9c5lwXyiq4AUtthHD0LdCvQ)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* result);
...
N_NIMCALL(NIM_BOOL, isCaseObj_FTbvAnf1y9b9c3Krp9bsHDTiw_3)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n);
...
N_NIMCALL(void, unnestStmts_9c5lwXyiq4AUtthHD0LdCvQ)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* result) {
	...
	LA3_: ;
	{
		if (!!(((*n).kind == ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 125) || (*n).kind == ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 23)))) goto LA11_;
...
N_NIMCALL(tyEnum_TSpecialWord_ycbpMCRV6Cd2eBh3X9biEiw, whichPragma_tadMdqrtQd2cek9aFwyE1XQ)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	LA1_: ;
	{
		if (!((*key).kind == ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 2))) goto LA8_;
...
{	result = (NIM_BOOL)0;
	...
	case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 44):
	{
		...
		LA15_: ;
		{
			...
			{
				if (!((*t).kind == ((tyEnum_TTypeKind_9a3YiReNVD0IJHWFKgXRe9ag) 22) || (*t).kind == ((tyEnum_TTypeKind_9a3YiReNVD0IJHWFKgXRe9ag) 21))) goto LA20_;
				result = NIM_FALSE;
				goto BeforeRet_;
			}
			LA20_: ;
			{
				...
				NIM_BOOL T26_;
				T24_ = (NIM_BOOL)0;
				T24_ = !(((*t).kind == ((tyEnum_TTypeKind_9a3YiReNVD0IJHWFKgXRe9ag) 17)));
				if (T24_) goto LA25_;
				T26_ = (NIM_BOOL)0;
