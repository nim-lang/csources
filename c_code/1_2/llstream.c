...
N_NIMCALL(void, TMP1630)(void* p, NI op);
...
N_NIMCALL(NIM_BOOL, endswith_179602)(NimStringDesc* x, TY124387 s);
...
NIM_CONST TY124387 linecontinuationoprs_179641 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
NIM_CONST TY124387 additionallinecontinuationoprs_179643 = {
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY124387 TMP1634 = {
...
STRING_LITERAL(TMP1639, "\015\012", 2);
...
N_NIMCALL(tllstream179204*, llstreamopenstdin_179235)(void) {
	...
	LOC1 = 0;
	LOC1 = (*result).S; (*result).S = copyStringRC1(((NimStringDesc*) &TMP1631));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
N_NIMCALL(NIM_BOOL, endswithopr_179646)(NimStringDesc* x) {
	...
	result = endswith_179602(x, TMP1633);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_179652)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_179602(line, TMP1634);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(NI, counttriples_179676)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			LOC5 = ((NU8)(s->data[(NI64)(TMP1635)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1636 = addInt(i, 2);
			if ((NU)((NI64)(TMP1636)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI64)(TMP1636)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
N_NIMCALL(NI, llstreamread_179242)(tllstream179204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		result = ((buflen <= (NI64)(TMP1641)) ? buflen : (NI64)(TMP1641));
		nimln(136, "llstream.nim");
		{
			...
			nimln(137, "llstream.nim");
			TMP1642 = addInt(0, (*s).Rd);
			if ((NU)((NI64)(TMP1642)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI64)(TMP1642)])), result);
...
N_NIMCALL(void, llstreamwriteln_179274)(tllstream179204* s, NimStringDesc* data) {
	...
	llstreamwrite_179258(s, ((NimStringDesc*) &TMP1639));
	popFrame();
}
...
N_NIMCALL(void, llstreamwrite_179268)(tllstream179204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			nimln(200, "llstream.nim");
			nimln(200, "llstream.nim");
			TMP1643 = addInt((*s).S->Sup.len, buflen);
			(*s).S = setLengthStr((*s).S, (NI64)(TMP1643));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1644 = addInt(0, (*s).Wr);
			if ((NU)((NI64)(TMP1644)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI64)(TMP1644)])), buf, buflen);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_179254)(tllstream179204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI64)(TMP1645));
			nimln(222, "llstream.nim");
			nimln(222, "llstream.nim");
			TMP1646 = addInt(i, 0);
			if ((NU)((NI64)(TMP1646)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_10827((*s).F, ((void*) (&result->data[(NI64)(TMP1646)])), 2048);
...
static TNimNode* TMP1626[6];
static TNimNode* TMP1627[4];
NI TMP1629;
static char* NIM_CONST TMP1628[4] = {
"llsNone", 
"llsString", 
"llsFile", 
"llsStdIn"};
static TNimNode TMP1624[12];
...
NTI179202.base = 0;
NTI179202.flags = 3;
for (TMP1629 = 0; TMP1629 < 4; TMP1629++) {
TMP1624[TMP1629+2].kind = 1;
TMP1624[TMP1629+2].offset = TMP1629;
TMP1624[TMP1629+2].name = TMP1628[TMP1629];
TMP1627[TMP1629] = &TMP1624[TMP1629+2];
}
TMP1624[6].len = 4; TMP1624[6].kind = 2; TMP1624[6].sons = &TMP1627[0];
NTI179202.node = &TMP1624[6];
TMP1624[1].kind = 1;
TMP1624[1].offset = offsetof(tllstream179204, Kind);
TMP1624[1].typ = (&NTI179202);
TMP1624[1].name = "kind";
TMP1626[1] = &TMP1624[7];
TMP1624[7].kind = 1;
TMP1624[7].offset = offsetof(tllstream179204, F);
TMP1624[7].typ = (&NTI10204);
TMP1624[7].name = "f";
TMP1626[2] = &TMP1624[8];
TMP1624[8].kind = 1;
TMP1624[8].offset = offsetof(tllstream179204, S);
TMP1624[8].typ = (&NTI143);
TMP1624[8].name = "s";
TMP1626[3] = &TMP1624[9];
TMP1624[9].kind = 1;
TMP1624[9].offset = offsetof(tllstream179204, Rd);
TMP1624[9].typ = (&NTI106);
TMP1624[9].name = "rd";
TMP1626[4] = &TMP1624[10];
TMP1624[10].kind = 1;
TMP1624[10].offset = offsetof(tllstream179204, Wr);
TMP1624[10].typ = (&NTI106);
TMP1624[10].name = "wr";
TMP1626[5] = &TMP1624[11];
TMP1624[11].kind = 1;
TMP1624[11].offset = offsetof(tllstream179204, Lineoffset);
TMP1624[11].typ = (&NTI106);
TMP1624[11].name = "lineOffset";
TMP1624[0].len = 6; TMP1624[0].kind = 2; TMP1624[0].sons = &TMP1626[0];
NTI179204.node = &TMP1624[0];
NTI179206.size = sizeof(tllstream179204*);
NTI179206.kind = 22;
NTI179206.base = (&NTI179204);
NTI179206.marker = TMP1630;
}
