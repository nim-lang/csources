...
N_NIMCALL(NI, counttriples_175676)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			LOC5 = ((NU8)(s->data[(NI64)(TMP1634)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1635 = addInt(i, 2);
			if ((NU)((NI64)(TMP1635)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI64)(TMP1635)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
N_NIMCALL(NI, llstreamread_175242)(tllstream175204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		result = ((buflen <= (NI64)(TMP1640)) ? buflen : (NI64)(TMP1640));
		nimln(136, "llstream.nim");
		{
			...
			if ((NU)((NI64)(TMP1641)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI64)(TMP1641)])), result);
...
N_NIMCALL(void, llstreamwrite_175268)(tllstream175204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			(*s).S = setLengthStr((*s).S, (NI64)(TMP1642));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1643 = addInt(0, (*s).Wr);
			if ((NU)((NI64)(TMP1643)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI64)(TMP1643)])), buf, buflen);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_175254)(tllstream175204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI64)(TMP1644));
			nimln(222, "llstream.nim");
			nimln(222, "llstream.nim");
			TMP1645 = addInt(i, 0);
			if ((NU)((NI64)(TMP1645)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_10627((*s).F, ((void*) (&result->data[(NI64)(TMP1645)])), 2048);
