...
static NIM_CONST TY192025 TMP3433 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3434, "sons", 4);
STRING_LITERAL(TMP3436, "equalGenericParams", 18);
static NIM_CONST TY192025 TMP3437 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3438, "sym", 3);
...
static N_INLINE(NI, sonslen_192191)(tnode191813* n) {
	...
	{
		nimln(1300, "ast.nim");
		if (((TMP3433[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3434));
...
N_NIMCALL(NIM_BOOL, equalgenericparams_270007)(tnode191813* proca, tnode191813* procb) {
	...
	TMP3435 = subInt(LOC7, 1);
	HEX3Atmp_270164 = (NI64)(TMP3435);
	...
	while (1) {
		...
		nimln(19, "procfind.nim");
		{
			nimln(19, "procfind.nim");
			nimln(19, "procfind.nim");
			if (((TMP3433[(*proca).Kind/8] &(1<<((*proca).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3434));
			...
			internalerror_168591((*proca).Info, ((NimStringDesc*) &TMP3436));
		...
		nimln(22, "procfind.nim");
		{
			nimln(22, "procfind.nim");
			nimln(22, "procfind.nim");
			if (((TMP3433[(*procb).Kind/8] &(1<<((*procb).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3434));
			...
			internalerror_168591((*procb).Info, ((NimStringDesc*) &TMP3436));
		...
		if (((TMP3433[(*proca).Kind/8] &(1<<((*proca).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3434));
		if ((NU)(i_270024) >= (NU)((*proca).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3437[(*(*proca).kindU.S6.Sons->data[i_270024]).Kind/8] &(1<<((*(*proca).kindU.S6.Sons->data[i_270024]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3438));
		a = (*(*proca).kindU.S6.Sons->data[i_270024]).kindU.S4.Sym;
		nimln(26, "procfind.nim");
		if (((TMP3433[(*procb).Kind/8] &(1<<((*procb).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3434));
		if ((NU)(i_270024) >= (NU)((*procb).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3437[(*(*procb).kindU.S6.Sons->data[i_270024]).Kind/8] &(1<<((*(*procb).kindU.S6.Sons->data[i_270024]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3438));
	...
	nimln(39, "procfind.nim");
	{
		...
		while (1) {
			...
			nimln(44, "procfind.nim");
			{
				...
				if (((TMP3433[(*(*result).Ast).Kind/8] &(1<<((*(*result).Ast).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3434));
				if ((NU)(2) >= (NU)((*(*result).Ast).kindU.S6.Sons->Sup.len)) raiseIndexError();
				genr = (*(*result).Ast).kindU.S6.Sons->data[2];
				nimln(46, "procfind.nim");
				if (((TMP3433[(*(*fn).Ast).Kind/8] &(1<<((*(*fn).Ast).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3434));
