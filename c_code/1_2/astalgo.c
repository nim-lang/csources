...
STRING_LITERAL(TMP2690, "getSymFromList", 14);
	...
	result = 0;
	{
		...
		res_235114 = start;
		{
			while (1) {
				...
				LA7: ;
				{
					internalerror_197970((*list).Info, ((NimStringDesc*) &TMP2690));
				}
				LA5: ;
				res_235114 += 1;
			} LA4: ;
...
N_NIMCALL(tsym224849*, lookupinrecord_234236)(tnode224819* n, tident200021* field) {
	...
	default:
	{
		internalerror_197970((*n).Info, ((NimStringDesc*) &TMP3162));
	}
	break;
	}
	BeforeRet: ;
...
TMP830[0] = &TMP800[1];
TMP800[1].kind = 1;
TMP800[1].offset = offsetof(tiitable234274, Counter);
TMP800[1].typ = (&NTI108);
TMP800[1].name = "counter";
TMP830[1] = &TMP800[2];
...
TMP831[0] = &TMP800[4];
TMP800[4].kind = 1;
TMP800[4].offset = offsetof(tiipair234270, Key);
TMP800[4].typ = (&NTI108);
TMP800[4].name = "key";
TMP831[1] = &TMP800[5];
TMP800[5].kind = 1;
TMP800[5].offset = offsetof(tiipair234270, Val);
TMP800[5].typ = (&NTI108);
TMP800[5].name = "val";
TMP800[3].len = 2; TMP800[3].kind = 2; TMP800[3].sons = &TMP831[0];
NTI234270.node = &TMP800[3];
NTI234272.size = sizeof(tiipairseq234272*);
NTI234272.kind = 24;
NTI234272.base = (&NTI234270);
NTI234272.flags = 2;
NTI234272.marker = TMP832;
TMP800[2].kind = 1;
TMP800[2].offset = offsetof(tiitable234274, Data);
TMP800[2].typ = (&NTI234272);
TMP800[2].name = "data";
TMP800[0].len = 2; TMP800[0].kind = 2; TMP800[0].sons = &TMP830[0];
NTI234274.node = &TMP800[0];
}
