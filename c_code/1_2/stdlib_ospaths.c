...
extern tyProc_9cu0cWy2jNXKVhds9cs4T9a9cA Dl_134432_;
extern tyProc_hayl9b1HhJokJ1Zo9ctoglPg Dl_134434_;
extern TNimType NTI_Qx9aKy4vZ9bVz9bnG9brQcRHGA_;
extern TNimType NTI_3XwRQvmzCEOC4QnT706q1g_;
extern tyProc_aO673xGTLLxou7P7GxoCXA Dl_133635_;
extern tyProc_im9buRnIvptJfzdASYMEbBA Dl_133801_;
extern tyProc_9bXer9a4ps9aSGctILcxWReVw Dl_133630_;
TNimType NTI_7q7q3E6Oj24ZNVJb9aonhAg_;
extern tyProc_IwsYs9blTXXmAlfsBWq604w Dl_133818_;
...
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_10, ".", 1);
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_11, "..\\", 3);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, osErrorMsg_yWvWz5V6Ib7QshcAbOiDeQ)(NI32 errorCode) {
	...
	result = copyString(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_3));
	{
		...
		msgbuf = (NI16*)0;
		{
			NI32 T7_;
			T7_ = (NI32)0;
			T7_ = Dl_133635_(((NI32) 4864), NIM_NIL, errorCode, ((NI32) 0), ((void*) (&msgbuf)), ((NI32) 0), NIM_NIL);
			if (!!((T7_ == ((NI32) 0)))) goto LA8_;
			result = dollar__D2o4ABrO3iHTudww2CqX4w(msgbuf);
			{
				if (!!((msgbuf == NIM_NIL))) goto LA12_;
				Dl_133801_(((void*) (msgbuf)));
			}
			LA12_: ;
		}
		LA8_: ;
...
appendString(T9_, ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_9));
			result = T9_;
		}
		goto LA5_;
		LA7_: ;
	...
	LA3_: ;
	{
		...
		LA13_: ;
		if (!T12_) goto LA14_;
		result = copyString(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_10));
		start = ((NI) 2);
	}
	goto LA1_;
	LA14_: ;
...
appendString(result, ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_11));
				i += ((NI) 3);
			}
			goto LA19_;
			LA25_: ;
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nospquoteShellWindows)(NimStringDesc* s) {
	...
	needQuote = T1_;
	result = copyString(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_3));
	backslashBuff = copyString(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_3));
	{
...
{	result = (NimStringDesc*)0;
	T1_ = (NimStringDesc*)0;
	T2_ = (NimStringDesc*)0;
	T2_ = getEnv_9b1nh9cAHhSLlHOPz8lCk5FA(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_15), ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_3));
	T1_ = rawNewString(T2_->Sup.len + 1);
appendString(T1_, T2_);
appendString(T1_, ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_5));
	result = T1_;
