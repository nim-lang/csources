...
43}
;
STRING_LITERAL(TMP3775, "\015\012", 2);
STRING_LITERAL(TMP3777, "", 0);
STRING_LITERAL(TMP3779, "\015\012\015\012", 4);
...
STRING_LITERAL(TMP3802, ".. index::\015\012", 12);
...
N_NIMCALL(trstnode301009*, lastson_301146)(trstnode301009* n) {
	...
	if ((NU)((NI64)(TMP3773)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP3773)];
	popFrame();
	return result;
}
...
appendString((*result), ind);
		...
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI64)(TMP3778), lvltochar_301257[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI64)(TMP3780), 45);
...
appendString((*result), ((NimStringDesc*) &TMP3783));
	...
	case ((NU8) 14):
	{
		...
		l = (((NI64)(TMP3784) >= 30) ? (NI64)(TMP3784) : 30);
...
appendString((*result), tmp);
		...
		TMP3786 = subInt((NI64)(TMP3785), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI64)(TMP3786), 32);
...
TMP3607[TMP3770+2].kind = 1;
TMP3607[TMP3770+2].offset = TMP3770;
TMP3607[TMP3770+2].name = TMP3769[TMP3770];
TMP3768[TMP3770] = &TMP3607[TMP3770+2];
}
TMP3607[67].len = 65; TMP3607[67].kind = 2; TMP3607[67].sons = &TMP3768[0];
NTI301003.node = &TMP3607[67];
TMP3607[1].kind = 1;
TMP3607[1].offset = offsetof(trstnode301009, Kind);
TMP3607[1].typ = (&NTI301003);
TMP3607[1].name = "kind";
TMP3767[1] = &TMP3607[68];
TMP3607[68].kind = 1;
TMP3607[68].offset = offsetof(trstnode301009, Text);
TMP3607[68].typ = (&NTI143);
TMP3607[68].name = "text";
TMP3767[2] = &TMP3607[69];
TMP3607[69].kind = 1;
TMP3607[69].offset = offsetof(trstnode301009, Level);
TMP3607[69].typ = (&NTI106);
TMP3607[69].name = "level";
TMP3767[3] = &TMP3607[70];
TMP3607[70].kind = 1;
TMP3607[70].offset = offsetof(trstnode301009, Sons);
TMP3607[70].typ = (&NTI301084);
TMP3607[70].name = "sons";
TMP3607[0].len = 4; TMP3607[0].kind = 2; TMP3607[0].sons = &TMP3767[0];
NTI301009.node = &TMP3607[0];
