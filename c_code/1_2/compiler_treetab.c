...
N_NIMCALL(NI, nodetablerawget_264160)(Tnodetable216852 t, NI k, Tnode216790* key);
N_NIMCALL(NIM_BOOL, treesequivalent_264077)(Tnode216790* a, Tnode216790* b);
...
N_NIMCALL(void, nodetablerawinsert_264190)(Tnodepairseq216850** data, NI k, Tnode216790* key, NI val);
		...
		{
			{
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					HEX3Atmp_264153 = (NI)(LOC26 - ((NI) 1));
					res_264156 = ((NI) 0);
					{
						while (1) {
							if (!(res_264156 <= HEX3Atmp_264153)) goto LA28;
							i_264149 = res_264156;
							{
								NIM_BOOL LOC31;
								LOC31 = 0;
								LOC31 = treesequivalent_264077((*a).kindU.S6.sons->data[i_264149], (*b).kindU.S6.sons->data[i_264149]);
								if (!!(LOC31)) goto LA32;
								goto BeforeRet;
							}
							LA32: ;
	...
	h = (NI)(k & (t.data ? (t.data->Sup.len-1) : -1));
	{
		while (1) {
			if (!!((t.data->data[h].key == NIM_NIL))) goto LA2;
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = treesequivalent_264077(t.data->data[h].key, key);
				LA6: ;
				if (!LOC5) goto LA7;
				result = h;
				goto BeforeRet;
...
N_NIMCALL(NI, nodetabletestorset_264682)(Tnodetable216852* t, Tnode216790* key, NI val) {
	...
	index = nodetablerawget_264160((*t), k, key);
	{
	...
	LA3: ;
	{
				...
				res_264878 = ((NI) 0);
				{
					while (1) {
						...
						i_264838 = res_264878;
						{
							...
							nodetablerawinsert_264190((&n), (*t).data->data[i_264838].h, (*t).data->data[i_264838].key, (*t).data->data[i_264838].val);
						}
						LA16: ;
						res_264878 += ((NI) 1);
					} LA13: ;
		...
		LA9: ;
		nodetablerawinsert_264190((&(*t).data), k, key, val);
		result = val;
		(*t).counter += ((NI) 1);
	}
	LA1: ;
