...
STRING_LITERAL(TMP1961, "nimrod.gid", 10);
STRING_LITERAL(TMP1962, "\015\012", 2);
...
static N_INLINE(void, setid_186444)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP1956 = addInt(id, 1);
	gfrontendid_186007 = ((gfrontendid_186007 >= (NI64)(TMP1956)) ? gfrontendid_186007 : (NI64)(TMP1956));
	popFrame();
}
...
N_NIMCALL(void, idsynchronizationpoint_186452)(NI idrange) {
	...
	nimln(41, "idgen.nim");
	nimln(41, "idgen.nim");
	TMP1957 = divInt(gfrontendid_186007, idrange);
	TMP1958 = addInt((NI64)(TMP1957), 1);
	TMP1959 = mulInt((NI64)(TMP1958), idrange);
	TMP1960 = addInt((NI64)(TMP1959), 1);
	gfrontendid_186007 = (NI64)(TMP1960);
	popFrame();
}
...
N_NIMCALL(NimStringDesc*, togid_186457)(NimStringDesc* f) {
	...
	result = 0;
	nimln(47, "idgen.nim");
	result = completegeneratedfilepath_138001(((NimStringDesc*) &TMP1961), NIM_TRUE);
	popFrame();
	return result;
}
...
static N_INLINE(void, writeln_138205)(FILE* f_138209, NimStringDesc** x_138213, NI x_138213Len0) {
	...
	nimln(172, "sysio.nim");
	write_10463(f_138209, ((NimStringDesc*) &TMP1962));
	popFrame();
}
