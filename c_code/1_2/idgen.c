...
STRING_LITERAL(TMP1363, "nimrod.gid", 10);
STRING_LITERAL(TMP4106, "\015\012", 2);
...
N_NIMCALL(NimStringDesc*, togid_223467)(NimStringDesc* f) {
	...
	result = 0;
	result = completegeneratedfilepath_170001(((NimStringDesc*) &TMP1363), NIM_TRUE);
	return result;
}
...
static N_INLINE(void, writeln_170205)(FILE* f_170209, NimStringDesc** x_170213, NI x_170213Len0) {
	...
	write_12665(f_170209, ((NimStringDesc*) &TMP4106));
}
