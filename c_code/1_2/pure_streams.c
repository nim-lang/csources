...
N_NIMCALL(NI, fsreaddata_144153)(tstream143629* s, void* buffer, NI buflen);
N_NIMCALL(NI, readbuffer_9514)(FILE* f, void* buffer, NI len);
N_NIMCALL(void, fswritedata_144161)(tstream143629* s, void* buffer, NI buflen);
N_NIMCALL(NI, writebuffer_9533)(FILE* f, void* buffer, NI len);
N_NIMCALL(tfilestream144109*, newfilestream_144168)(FILE* f);
...
STRING_LITERAL(TMP932, "\015\012", 2);
STRING_LITERAL(TMP933, "cannot read from stream", 23);
STRING_LITERAL(TMP934, "", 0);
STRING_LITERAL(TMP940, "cannot write to stream", 22);
...
N_NIMCALL(void, writeln_143778)(tstream143629* s, NimStringDesc** args, NI argsLen0) {
	...
	write_143772(s, ((NimStringDesc*) &TMP932));	popFrame();
}
N_NIMCALL(NIM_CHAR, readchar_143808)(tstream143629* s) {
	NIM_CHAR result;
...
N_NIMCALL(NI, ssreaddata_144038)(tstream143629* s_144040, void* buffer, NI buflen) {
	...
	nimln(214, "streams.nim");
	nimln(214, "streams.nim");
	TMP937 = subInt((*s).Data->Sup.len, (*s).Pos);
	result = ((buflen <= (NI64)(TMP937)) ? buflen : (NI64)(TMP937));
...
N_NIMCALL(void, sswritedata_144062)(tstream143629* s_144064, void* buffer, NI buflen) {
	...
	nimln(221, "streams.nim");
	{
		...
		nimln(222, "streams.nim");
		nimln(222, "streams.nim");
		TMP938 = addInt((*s).Data->Sup.len, buflen);
		(*s).Data = setLengthStr((*s).Data, (NI64)(TMP938));
...
N_NIMCALL(void, fswritedata_144161)(tstream143629* s, void* buffer, NI buflen) {
	...
	nimln(260, "streams.nim");
	{
		...
		LOC6 = 0;
		LOC6 = neweio_143607(((NimStringDesc*) &TMP940));
		nimln(261, "streams.nim");
		raiseException((E_Base*)LOC6, "EIO");
	}	LA4: ;
	popFrame();
...
N_NIMCALL(tfilestream144109*, newfilestream_144168)(FILE* f) {
	...
	(*result).Sup.Readdataimpl = fsreaddata_144153;
	nimln(272, "streams.nim");
	(*result).Sup.Writedataimpl = fswritedata_144161;
...
NTI143630.flags = 3;
TMP930[1].kind = 1;
TMP930[1].offset = offsetof(tstream143629, Closeimpl);
TMP930[1].typ = (&NTI143630);
TMP930[1].name = "closeImpl";
TMP935[1] = &TMP930[2];
...
NTI143634.flags = 3;
TMP930[2].kind = 1;
TMP930[2].offset = offsetof(tstream143629, Atendimpl);
TMP930[2].typ = (&NTI143634);
TMP930[2].name = "atEndImpl";
TMP935[2] = &TMP930[3];
...
NTI143638.flags = 3;
TMP930[3].kind = 1;
TMP930[3].offset = offsetof(tstream143629, Setpositionimpl);
TMP930[3].typ = (&NTI143638);
TMP930[3].name = "setPositionImpl";
TMP935[3] = &TMP930[4];
...
NTI143643.flags = 3;
TMP930[4].kind = 1;
TMP930[4].offset = offsetof(tstream143629, Getpositionimpl);
TMP930[4].typ = (&NTI143643);
TMP930[4].name = "getPositionImpl";
TMP935[4] = &TMP930[5];
...
NTI143647.flags = 3;
TMP930[5].kind = 1;
TMP930[5].offset = offsetof(tstream143629, Readdataimpl);
TMP930[5].typ = (&NTI143647);
TMP930[5].name = "readDataImpl";
TMP935[5] = &TMP930[6];
...
NTI143653.flags = 3;
TMP930[6].kind = 1;
TMP930[6].offset = offsetof(tstream143629, Writedataimpl);
TMP930[6].typ = (&NTI143653);
TMP930[6].name = "writeDataImpl";
TMP935[6] = &TMP930[7];
...
NTI143659.flags = 3;
TMP930[7].kind = 1;
TMP930[7].offset = offsetof(tstream143629, Flushimpl);
TMP930[7].typ = (&NTI143659);
TMP930[7].name = "flushImpl";
TMP930[0].len = 7; TMP930[0].kind = 2; TMP930[0].sons = &TMP935[0];
NTI143629.node = &TMP930[0];
...
TMP936[0] = &TMP930[9];
TMP930[9].kind = 1;
TMP930[9].offset = offsetof(tstringstream143999, Data);
TMP930[9].typ = (&NTI142);
TMP930[9].name = "data";
TMP936[1] = &TMP930[10];
TMP930[10].kind = 1;
TMP930[10].offset = offsetof(tstringstream143999, Pos);
TMP930[10].typ = (&NTI105);
TMP930[10].name = "pos";
TMP930[8].len = 2; TMP930[8].kind = 2; TMP930[8].sons = &TMP936[0];
NTI143999.node = &TMP930[8];
NTI143997.size = sizeof(tstringstream143999*);
NTI143997.kind = 22;
NTI143997.base = (&NTI143999);
NTI143997.flags = 2;
NTI143997.marker = TMP939;
NTI144109.size = sizeof(tfilestream144109);
NTI144109.kind = 17;
NTI144109.base = (&NTI143629);
NTI144109.flags = 3;
TMP930[11].kind = 1;
TMP930[11].offset = offsetof(tfilestream144109, F);
TMP930[11].typ = (&NTI9004);
TMP930[11].name = "f";
NTI144109.node = &TMP930[11];
NTI144107.size = sizeof(tfilestream144109*);
NTI144107.kind = 22;
NTI144107.base = (&NTI144109);
NTI144107.flags = 2;
NTI144107.marker = TMP941;
NTI143627.size = sizeof(tstream143629*);
NTI143627.kind = 22;
NTI143627.base = (&NTI143629);
NTI143627.flags = 2;
NTI143627.marker = TMP4765;
}
