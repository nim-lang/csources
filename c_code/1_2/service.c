...
STRING_LITERAL(TMP7641, "server.type", 11);
STRING_LITERAL(TMP7642, "stdin", 5);
STRING_LITERAL(TMP7643, "tcp", 3);
STRING_LITERAL(TMP7644, "quit", 4);
STRING_LITERAL(TMP7649, "server.port", 11);
STRING_LITERAL(TMP7650, "server.address", 14);
STRING_LITERAL(TMP7676, "\015\012", 2);
STRING_LITERAL(TMP7677, "Invalid server.type:", 20);
...
extern tsocketimpl153605* stdoutsocket_167189;
	...
	while (1) {
		...
		case ((NU8) 3):
		{
			...
			nimln(43, "service.nim");
			{
				...
				nimln(44, "service.nim");
				nimln(44, "service.nim");
				TMP7639 = subInt(bracketle, 1);
				key = copyStrLast(p.Key, 0, (NI64)(TMP7639));
				nimln(45, "service.nim");
				nimln(45, "service.nim");
				LOC8 = 0;
				nimln(45, "service.nim");
				nimln(45, "service.nim");
				TMP7640 = addInt(bracketle, 1);
				LOC9 = 0;
				LOC9 = copyStr(p.Key, (NI64)(TMP7640));
...
appendString(LOC8, p.Val);
				...
				processswitch_176016(key, val, pass, gcmdlineinfo_167103);
			}
			goto LA4;
			LA6: ;
			{
				nimln(48, "service.nim");
				processswitch_176016(p.Key, p.Val, pass, gcmdlineinfo_167103);
			}
			LA4: ;
		}
		break;
		case ((NU8) 1):
		{
			...
			LA14: ;
			{
				...
				nimln(54, "service.nim");
				{
					...
					asgnRefNoCycle((void**) &gprojectname_138206, nosunixToNativePath(p.Key, ((NimStringDesc*) &TMP7634)));
...
N_NIMCALL(void, serve_529292)(TY529294 action) {
	...
	typ = getconfigvar_138311(((NimStringDesc*) &TMP7641));
	nimln(75, "service.nim");
	if (eqStrings(typ, ((NimStringDesc*) &TMP7642))) goto LA1;
	if (eqStrings(typ, ((NimStringDesc*) &TMP7643))) goto LA2;
	if (eqStrings(typ, ((NimStringDesc*) &TMP7634))) goto LA2;
	goto LA3;
	LA1: ;
	{
		...
		while (1) {
			...
			{
				nimln(79, "service.nim");
				if (!eqStrings(line, ((NimStringDesc*) &TMP7644))) goto LA9;
				nimln(79, "service.nim");
				exit(0);
			}
			LA9: ;
			...
			printf("%s\015\012", (((NimStringDesc*) &TMP7634))->data);
	...
	LA2: ;
	{
		...
		p = getconfigvar_138311(((NimStringDesc*) &TMP7649));
		...
		nimln(90, "service.nim");
		LOC24 = 0;
		LOC24 = getconfigvar_138311(((NimStringDesc*) &TMP7650));
		bindaddr_155583(server, port, LOC24);
		nimln(91, "service.nim");
		inp = copyString(((NimStringDesc*) &TMP7634));
		nimln(92, "service.nim");
		listen_155404(server, SOMAXCONN);
		nimln(93, "service.nim");
		if (stdoutsocket_167189) nimGCunrefNoCycle(stdoutsocket_167189);
		stdoutsocket_167189 = (tsocketimpl153605*) newObjRC1((&NTI153607), sizeof(tsocketimpl153605));
		nimln(94, "service.nim");
		while (1) {
			NimStringDesc* LOC26;
			nimln(95, "service.nim");
			accept_157201(server, &stdoutsocket_167189);
			nimln(96, "service.nim");
			readline_162033(stdoutsocket_167189, &inp, -1);
			nimln(67, "service.nim");
			LOC26 = 0;
			...
			send_163403(stdoutsocket_167189, ((NimStringDesc*) &TMP7676));
			nimln(99, "service.nim");
			close_157266(stdoutsocket_167189);
		}
	}
	goto LA4;
	LA3: ;
	{
		...
		printf("%s%s\015\012", (((NimStringDesc*) &TMP7677))->data, (typ)->data);
...
N_NOINLINE(void, serviceInit)(void) {
	...
	LOC1 = 0;
	LOC1 = curcaascmd_529203; curcaascmd_529203 = copyStringRC1(((NimStringDesc*) &TMP7634));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(25, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_529204; lastcaascmd_529204 = copyStringRC1(((NimStringDesc*) &TMP7634));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(28, "service.nim");
	LOC3 = 0;
	LOC3 = arguments_529205; arguments_529205 = copyStringRC1(((NimStringDesc*) &TMP7634));
