...
N_NIMCALL(Tnode_bROa11lyF5vxEN9aYNbHmhw*, closejson_u9cSAp7a1p5L9ciLEY2aRu3Q)(Tpasscontext_qNsm39cWb35W2r5AAd9ch87g* p0, Tnode_bROa11lyF5vxEN9aYNbHmhw* n0) {
	...
	usewarning0 = !((((*(*g0).module).flags &(1U<<((NU)(((Tsymflag_K9ay6LWMat9bUiT9bIbMxpDHw) 12))&31U)))!=0));
	{
		...
		T_87tQLGE73DKq5cz9cph1IqQ_5.status = setjmp(T_87tQLGE73DKq5cz9cph1IqQ_5.context);
...
N_NIMCALL(Tnode_bROa11lyF5vxEN9aYNbHmhw*, close_u9cSAp7a1p5L9ciLEY2aRu3Q_2)(Tpasscontext_qNsm39cWb35W2r5AAd9ch87g* p0, Tnode_bROa11lyF5vxEN9aYNbHmhw* n0) {
	...
	usewarning0 = !((((*(*g0).module).flags &(1U<<((NU)(((Tsymflag_K9ay6LWMat9bUiT9bIbMxpDHw) 12))&31U)))!=0));
	{
		...
		T_87tQLGE73DKq5cz9cph1IqQ_7.status = setjmp(T_87tQLGE73DKq5cz9cph1IqQ_7.context);
