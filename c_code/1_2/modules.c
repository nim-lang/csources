...
N_NIMCALL(NU8, checkdepmem_606462)(NI32 fileidx);
		...
		gmemcachedata_606079->data[fileidx].Needsrecompile = ((NU8) 3);
		{
			...
			l_606633 = HEX3Atmp_606628->Sup.len;
			{
				while (1) {
					...
					d = checkdepmem_606462(dep_606611);
					{
	...
	{
		{
			NU8 LOC25;
			LOC25 = 0;
			LOC25 = checkdepmem_606462(fileidx);
...
N_NIMCALL(void, wantmainmodule_607014)(void) {
	NimStringDesc* LOC5;
	{
		...
		fatal_197906(gcmdlineinfo_196191, ((NU16) 186), ((NimStringDesc*) &TMP4107));
	}
	LA3: ;
	LOC5 = 0;
...
N_NIMCALL(void, resetallmodules_606411)(void) {
	{
		...
		i_606423 = 0;
		HEX3Atmp_606442 = 0;
		HEX3Atmp_606442 = (gcompiledmodules_606057->Sup.len-1);
		res_606445 = 0;
		{
			while (1) {
				if (!(res_606445 <= HEX3Atmp_606442)) goto LA3;
				i_606423 = res_606445;
				{
