...
N_NIMCALL(void, settarget_176634)(NU8 o, NU8 c) {
	...
	targetcpu_176600 = c;
	targetos_176602 = o;
	intsize_176623 = (NI64)(cpu_176496[(c)- 1].Field1 / ((NI) 8));
	floatsize_176624 = (NI64)(cpu_176496[(c)- 1].Field3 / ((NI) 8));
	ptrsize_176625 = (NI64)(cpu_176496[(c)- 1].Field4 / ((NI) 8));
	LOC1 = 0;
...
NIM_EXTERNC N_NOINLINE(void, compiler_platformInit)(void) {
	hostcpu_176601 = nametocpu_176617(((NimStringDesc*) &TMP69));
