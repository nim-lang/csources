...
N_NOINLINE(void, identsInit)(void) {
	...
	asgnRefNoCycle((void**) &idanon_170476, getident_170456(((NimStringDesc*) &TMP978)));
	nimln(109, "idents.nim");
	asgnRefNoCycle((void**) &iddelegator_170478, getident_170456(((NimStringDesc*) &TMP979)));
	popFrame();
}
...
NTI170013.flags = 1;
TMP968[0].kind = 1;
TMP968[0].offset = offsetof(tidobj170013, Id);
TMP968[0].typ = (&NTI106);
TMP968[0].name = "id";
NTI170013.node = &TMP968[0];
...
TMP975[0] = &TMP968[2];
TMP968[2].kind = 1;
TMP968[2].offset = offsetof(tident170019, S);
TMP968[2].typ = (&NTI143);
TMP968[2].name = "s";
TMP975[1] = &TMP968[3];
TMP968[3].kind = 1;
TMP968[3].offset = offsetof(tident170019, Next);
TMP968[3].typ = (&NTI170017);
TMP968[3].name = "next";
TMP975[2] = &TMP968[4];
TMP968[4].kind = 1;
TMP968[4].offset = offsetof(tident170019, H);
TMP968[4].typ = (&NTI121013);
TMP968[4].name = "h";
TMP968[1].len = 3; TMP968[1].kind = 2; TMP968[1].sons = &TMP975[0];
NTI170019.node = &TMP968[1];
NTI170017.size = sizeof(tident170019*);
NTI170017.kind = 22;
NTI170017.base = (&NTI170019);
NTI170017.flags = 2;
NTI170017.marker = TMP976;
