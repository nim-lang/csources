...
N_NIMCALL(NI32, checkmodulename_275070)(tnode210818* n) {
	...
	LOC1 = 0;
	LOC1 = tofullpath_183637((*n).Info.Fileindex);
	...
	LA4: ;
	{
		result = fileinfoidx_182930(fullpath);
	}
	LA2: ;
	return result;
}
...
N_NIMCALL(void, rawimportsymbol_275083)(tcontext268021* c, tsym210848* s) {
	...
	LA13: ;
	{
		...
		LA42: ;
		{
			NIM_BOOL LOC46;
			LOC46 = 0;
			LOC46 = haspattern_216849(s);
			if (!LOC46) goto LA47;
			addpattern_268651(c, s);
		}
		LA47: ;
	}
	LA11: ;
