...
N_NIMCALL(void, patternerror_276040)(tnode187813* n);
...
static N_INLINE(void, add_276046)(NimStringDesc** code, NU8 op);
...
N_NIMCALL(void, compileconstraints_276106)(tnode187813* p, NimStringDesc** result);
...
N_NIMCALL(tnode187813*, semnodekindconstraints_276472)(tnode187813* p);
...
N_NIMCALL(NU8, checkforsideeffects_276740)(tnode187813* n);
static N_INLINE(NIM_BOOL, isroutine_194041)(tsym187843* s);
N_NIMCALL(NU8, isassignable_276970)(tsym187843* owner, tnode187813* n);
...
static NIM_CONST TY188025 TMP3566 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3567, "strVal", 6);
static NIM_CONST TY188025 TMP3568 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3569, "sons", 4);
static NIM_CONST TY188025 TMP3570 = {
...
NIM_CONST TY131208 TMP3586 = {((NimStringDesc*) &TMP3587),
100}
;
NIM_CONST TY131208 TMP3588 = {((NimStringDesc*) &TMP3587),
107}
;
STRING_LITERAL(TMP3589, "p.kind == nkCurlyExpr ", 22);
STRING_LITERAL(TMP3590, "parameter pattern too complex", 29);
static NIM_CONST TY188025 TMP3591 = {
...
N_NIMCALL(void, patternerror_276040)(tnode187813* n) {
	...
	localerror_165571((*n).Info, ((NU16) 1), LOC1);
	popFrame();
}
...
N_NIMCALL(void, compileconstraints_276106)(tnode187813* p, NimStringDesc** result) {
	...
	case ((NU8) 32):
	{
		...
		nimln(59, "parampatterns.nim");
		{
			...
			if (((TMP3568[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3569));
			if ((NU)(0) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
			patternerror_276040((*p).kindU.S6.Sons->data[0]);
		...
		nimln(63, "parampatterns.nim");
		{
			...
			nimln(64, "parampatterns.nim");
			{
				...
				compileconstraints_276106((*p).kindU.S6.Sons->data[1], result);
				nimln(66, "parampatterns.nim");
				if (((TMP3568[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3569));
				if ((NU)(2) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
				compileconstraints_276106((*p).kindU.S6.Sons->data[2], result);
				nimln(67, "parampatterns.nim");
				add_276046(result, ((NU8) 2));
			}
			goto LA11;
			LA15: ;
			{
				...
				add_276046(result, ((NU8) 3));
			}
			goto LA11;
			LA20: ;
			{
				nimln(73, "parampatterns.nim");
				patternerror_276040(p);
			}
			LA11: ;
		}
		goto LA6;
	...
	case ((NU8) 37):
	{
		nimln(80, "parampatterns.nim");
		{
			...
			if (((TMP3568[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3569));
			if ((NU)(0) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
			compileconstraints_276106((*p).kindU.S6.Sons->data[0], result);
		}
		goto LA33;
		LA36: ;
		{
...
break;
		...
		LA40: ;
		{
			...
			add_276046(result, ((NU8) 6));
		}
		goto LA52;
		LA41: ;
		{
			nimln(88, "parampatterns.nim");
			add_276046(result, ((NU8) 7));
		}
		goto LA52;
		LA42: ;
		{
			nimln(89, "parampatterns.nim");
			add_276046(result, ((NU8) 5));
		}
		goto LA52;
		LA43: ;
		{
			nimln(90, "parampatterns.nim");
			add_276046(result, ((NU8) 8));
		}
		goto LA52;
		LA44: ;
		{
			nimln(91, "parampatterns.nim");
			add_276046(result, ((NU8) 9));
		}
		goto LA52;
		LA45: ;
		{
		...
		LA47: ;
		{
			...
			add_276046(result, ((NU8) 12));
		}
		goto LA52;
		LA48: ;
		{
			nimln(95, "parampatterns.nim");
			add_276046(result, ((NU8) 13));
		}
		goto LA52;
		LA49: ;
		{
			nimln(96, "parampatterns.nim");
			add_276046(result, ((NU8) 14));
		}
		goto LA52;
		LA50: ;
		{
			nimln(97, "parampatterns.nim");
			add_276046(result, ((NU8) 15));
		}
		goto LA52;
		LA51: ;
		{
			...
			nimln(849, "msgs.nim");
			{
				...
				nimln(849, "msgs.nim");
				LOC69 = 0;
				LOC69 = HEX24_165714(TMP3586);
				internalerror_165606(LOC69);
			}
			LA67: ;
			i_276371 = 0;
			...
			while (1) {
				nimln(1458, "system.nim");
				if (!(res_276461 <= ((NU8) 24))) goto LA70;
				nimln(1457, "system.nim");
				i_276371 = res_276461;
			...
			nimln(849, "msgs.nim");
			{
				...
				nimln(849, "msgs.nim");
				LOC81 = 0;
				LOC81 = HEX24_165714(TMP3588);
				internalerror_165606(LOC81);
			}
			LA79: ;
			i_276442 = 0;
			nimln(1457, "system.nim");
			...
			while (1) {
				nimln(1458, "system.nim");
				if (!(res_276466 <= ((NU8) 156))) goto LA82;
				nimln(1457, "system.nim");
				i_276442 = res_276466;
				nimln(109, "parampatterns.nim");
				{
					...
					nimln(109, "parampatterns.nim");
					LOC85 = 0;
					LOC85 = nsuCmpIgnoreStyle(reprEnum(i_276442, (&NTI187023)), spec);
					if (!(LOC85 == 0)) goto LA86;
					nimln(110, "parampatterns.nim");
					add_276046(result, ((NU8) 11));
					nimln(111, "parampatterns.nim");
					nimln(111, "parampatterns.nim");
					nimln(111, "parampatterns.nim");
					(*result) = addChar((*result), ((NIM_CHAR) (((NI) (i_276442)))));
					nimln(112, "parampatterns.nim");
					goto BeforeRet;
				}
				LA86: ;
				nimln(1460, "system.nim");
				res_276466 = addInt(res_276466, 1);
			} LA82: ;
...
N_NIMCALL(tnode187813*, semnodekindconstraints_276472)(tnode187813* p) {
	...
	nimln(120, "parampatterns.nim");
	{
		...
		nimln(120, "parampatterns.nim");
		failedassertimpl_81021(((NimStringDesc*) &TMP3589));
	}
	LA3: ;
	nimln(121, "parampatterns.nim");
	result = newnodei_188109(((NU8) 20), (*p).Info);
	...
	nimln(124, "parampatterns.nim");
	{
		...
		LOC10 = 0;
		LOC10 = len_188274(p);
		HEX3Atmp_276727 = subInt(LOC10, 1);
		nimln(1457, "system.nim");
		res_276729 = 1;
		nimln(1458, "system.nim");
		while (1) {
			nimln(1458, "system.nim");
			if (!(res_276729 <= HEX3Atmp_276727)) goto LA11;
			nimln(1457, "system.nim");
			i_276667 = res_276729;
			nimln(126, "parampatterns.nim");
			if (((TMP3568[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3569));
			if ((NU)(i_276667) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!(((TMP3566[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3567));
			compileconstraints_276106((*p).kindU.S6.Sons->data[i_276667], &(*result).kindU.S3.Strval);
			nimln(1460, "system.nim");
			res_276729 = addInt(res_276729, 1);
		} LA11: ;
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_165591((*p).Info, ((NimStringDesc*) &TMP3590));
		}
		LA14: ;
	}
	goto LA5;
	...
	if (!(((TMP3566[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3567));
	add_276046(&(*result).kindU.S3.Strval, ((NU8) 1));
	popFrame();
	return result;
}
...
N_NIMCALL(NU8, checkforsideeffects_276740)(tnode187813* n) {
	...
	case ((NU8) 32):
	{
		...
		nimln(143, "parampatterns.nim");
		{
			...
			LOC4 = isroutine_194041((*op).kindU.S4.Sym);
			LA5: ;
			if (!LOC4) goto LA6;
		...
		LOC16 = 0;
		LOC16 = len_188274(n);
		HEX3Atmp_276951 = subInt(LOC16, 1);
		nimln(1457, "system.nim");
		res_276953 = 0;
		nimln(1458, "system.nim");
		while (1) {
			NU8 ret;
			nimln(1458, "system.nim");
			if (!(res_276953 <= HEX3Atmp_276951)) goto LA17;
			nimln(1457, "system.nim");
			i_276844 = res_276953;
			nimln(157, "parampatterns.nim");
			if (((TMP3568[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3569));
			if ((NU)(i_276844) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			ret = checkforsideeffects_276740((*n).kindU.S6.Sons->data[i_276844]);
			...
			LA18: ;
			nimln(1460, "system.nim");
			res_276953 = addInt(res_276953, 1);
		} LA17: ;
	}
	break;
	case ((NU8) 0) ... ((NU8) 23):
	...
	default:
	{
		...
		LOC29 = 0;
		LOC29 = len_188274(n);
		HEX3Atmp_276955 = subInt(LOC29, 1);
		nimln(1457, "system.nim");
		res_276957 = 0;
		nimln(1458, "system.nim");
		while (1) {
			NU8 ret;
			nimln(1458, "system.nim");
			if (!(res_276957 <= HEX3Atmp_276955)) goto LA30;
			nimln(1457, "system.nim");
			i_276908 = res_276957;
			nimln(166, "parampatterns.nim");
			if (((TMP3568[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3569));
			if ((NU)(i_276908) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			ret = checkforsideeffects_276740((*n).kindU.S6.Sons->data[i_276908]);
			...
			LA31: ;
			nimln(1460, "system.nim");
			res_276957 = addInt(res_276957, 1);
		} LA30: ;
	}
	break;
	}
...
N_NIMCALL(NU8, isassignable_276970)(tsym187843* owner, tnode187813* n) {
	...
	case ((NU8) 45):
	{
		nimln(192, "parampatterns.nim");
		{
			...
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC18 = 0;
			LOC18 = skiptypes_191793((*(*n).kindU.S6.Sons->data[0]).Typ, IL64(211106232576000));
		...
		LA19: ;
		{
			...
			if (((TMP3568[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3569));
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			result = isassignable_276970(owner, (*n).kindU.S6.Sons->data[0]);
		}
		LA16: ;
	...
	case ((NU8) 42):
	{
		nimln(200, "parampatterns.nim");
		{
			...
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC31 = 0;
			LOC31 = skiptypes_191793((*(*n).kindU.S6.Sons->data[0]).Typ, IL64(211106232576000));
	...
	case ((NU8) 60):
	{
		nimln(208, "parampatterns.nim");
		{
			...
			nimln(208, "parampatterns.nim");
			LOC38 = 0;
			LOC38 = skiptypes_191793((*n).Typ, IL64(211106247256064));
			if (!((134610944 &(IL64(1)<<(((*LOC38).Kind)&IL64(63))))!=0)) goto LA39;
			nimln(210, "parampatterns.nim");
			if (((TMP3568[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3569));
			if ((NU)(1) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			result = isassignable_276970(owner, (*n).kindU.S6.Sons->data[1]);
		}
		goto LA36;
		LA39: ;
		{
			...
			if ((NU)(1) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC42 = 0;
			LOC42 = comparetypes_230564((*n).Typ, (*(*n).kindU.S6.Sons->data[1]).Typ, ((NU8) 1), 0);
			if (!LOC42) goto LA43;
...
N_NIMCALL(NIM_BOOL, matchnodekinds_277321)(tnode187813* p, tnode187813* n) {
	...
	while (1) {
		...
		case ((NU8) 12):
		{
			...
			nimln(258, "parampatterns.nim");
			LOC20 = 0;
			LOC20 = isassignable_276970(NIM_NIL, n);
		...
		case ((NU8) 13):
		{
			...
			nimln(259, "parampatterns.nim");
			LOC22 = 0;
			LOC22 = isassignable_276970(NIM_NIL, n);
		...
		case ((NU8) 14):
		{
			...
			nimln(260, "parampatterns.nim");
			LOC24 = 0;
			LOC24 = checkforsideeffects_276740(n);
		...
		case ((NU8) 15):
		{
			...
			nimln(261, "parampatterns.nim");
			LOC26 = 0;
			LOC26 = checkforsideeffects_276740(n);
