...
STRING_LITERAL(TMP1317, "none", 4);
STRING_LITERAL(TMP1318, "stdtmpl", 7);
STRING_LITERAL(TMP1319, "replace", 7);
STRING_LITERAL(TMP1320, "strip", 5);
NIM_CONST TY258026 filternames_258025 = {((NimStringDesc*) &TMP1317),
((NimStringDesc*) &TMP1318),
((NimStringDesc*) &TMP1319),
((NimStringDesc*) &TMP1320)}
;
STRING_LITERAL(TMP1321, "standard", 8);
STRING_LITERAL(TMP1322, "strongspaces", 12);
STRING_LITERAL(TMP1323, "braces", 6);
STRING_LITERAL(TMP1324, "endx", 4);
NIM_CONST TY258020 parsernames_258019 = {((NimStringDesc*) &TMP1321),
((NimStringDesc*) &TMP1322),
((NimStringDesc*) &TMP1323),
((NimStringDesc*) &TMP1324)}
;
STRING_LITERAL(TMP1355, "parser to implement", 19);
...
N_NIMCALL(tllstream211204*, evalpipe_258546)(tparsers258035* p, tnode224819* n, NimStringDesc* filename, tllstream211204* start) {
	...
	LA3: ;
	{
		...
		LOC7 = LOC8;
		if (!(LOC7)) goto LA10;
		LOC7 = identeq_200493((*(*n).kindU.S6.Sons->data[0]).kindU.S5.Ident, ((NimStringDesc*) &TMP1208));
		LA10: ;
		if (!LOC7) goto LA11;
		{
			NI i_258635;
...
N_NIMCALL(tnode224819*, parseall_258063)(tparsers258035* p) {
	...
	case ((NU8) 3):
	{
		internalerror_197989(((NimStringDesc*) &TMP1355));
		result = emptynode_225738;
	}
	break;
	}
...
TMP804[TMP1014+2].kind = 1;
TMP804[TMP1014+2].offset = TMP1014;
TMP804[TMP1014+2].name = TMP1013[TMP1014];
TMP1012[TMP1014] = &TMP804[TMP1014+2];
}
TMP804[6].len = 4; TMP804[6].kind = 2; TMP804[6].sons = &TMP1012[0];
NTI258007.node = &TMP804[6];
TMP804[1].kind = 1;
TMP804[1].offset = offsetof(tparsers258035, Skin);
TMP804[1].typ = (&NTI258007);
TMP804[1].name = "skin";
TMP1011[1] = &TMP804[7];
TMP804[7].kind = 1;
TMP804[7].offset = offsetof(tparsers258035, Parser);
TMP804[7].typ = (&NTI243205);
TMP804[7].name = "parser";
TMP804[0].len = 2; TMP804[0].kind = 2; TMP804[0].sons = &TMP1011[0];
NTI258035.node = &TMP804[0];
}
