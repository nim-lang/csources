...
N_NIMCALL(NIM_BOOL, containsshebang_220100)(NimStringDesc* s, NI i) {
	...
	nimln(83, "syntaxes.nim");
	{
		...
		nimln(83, "syntaxes.nim");
		TMP2697 = addInt(i, 1);
		if ((NU)((NI64)(TMP2697)) > (NU)(s->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(s->data[(NI64)(TMP2697)]) == (NU8)(33));
		LA4: ;
		if (!LOC3) goto LA5;
...
N_NIMCALL(tnode187813*, parsepipe_220138)(NimStringDesc* filename, tllstream175204* inputstream) {
	...
	nimln(91, "syntaxes.nim");
	{
		...
		nimln(98, "syntaxes.nim");
		{
			...
			nimln(98, "syntaxes.nim");
			TMP2699 = addInt(i, 1);
			if ((NU)((NI64)(TMP2699)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC14 = ((NU8)(line->data[(NI64)(TMP2699)]) == (NU8)(33));
			LA15: ;
			if (!LOC14) goto LA16;
