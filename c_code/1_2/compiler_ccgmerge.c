...
N_NIMCALL(NIM_BOOL, atendmark_466397)(NCSTRING buf, NI pos) {
	...
	s = ((NI) 0);
	{
		while (1) {
			...
			LOC3 = (s < ((NI) 19));
			if (!(LOC3)) goto LA4;
			LOC3 = ((NU8)(buf[(NI64)(pos + s)]) == (NU8)(((NimStringDesc*) &TMP4224)->data[s]));
			LA4: ;
			if (!LOC3) goto LA2;
			s += ((NI) 1);
		} LA2: ;
						...
						j_466257 = ((NI) 0);
						{
							while (1) {
								if (!!((w_466255 == ((NI) 0)))) goto LA7;
								{
									...
									x_466236 = (NI)((NI)((NU64)((*r_466251).Key) << (NU64)(((NI) 9))) | (NI)((NU64)((NI)((NU64)(i_466253) << (NU64)(((NI) 6)))) + (NU64)(j_466257)));
									{
...
appendString((*s), tnl_176626);
								...
								LA10: ;
								j_466257 += ((NI) 1);
								w_466255 = (NI)((NU64)(w_466255) >> (NU64)(((NI) 1)));
							} LA7: ;
						}
						i_466253 += ((NI) 1);
					} LA5: ;
