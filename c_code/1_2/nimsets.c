...
N_NIMCALL(tnode187813*, totreeset_244679)(tbitset243012* s, ttype187847* settype, tlineinfo163527 info);
...
N_NIMCALL(void, tobitset_244002)(tnode187813* s, tbitset243012** b) {
	...
	HEX3Atmp_244671 = (NI64)(TMP3155);
	nimln(1450, "system.nim");
	res_244673 = 0;
	nimln(1451, "system.nim");
	while (1) {
		nimln(1451, "system.nim");
		if (!(res_244673 <= HEX3Atmp_244671)) goto LA3;
		nimln(1450, "system.nim");
		i_244558 = res_244673;
		...
		LA4: ;
		nimln(1453, "system.nim");
		res_244673 = addInt(res_244673, 1);
	} LA3: ;
	popFrame();
}
...
N_NIMCALL(tnode187813*, unionsets_244033)(tnode187813* a, tnode187813* b) {
	...
	result = totreeset_244679(x, (*a).Typ, (*a).Info);
	popFrame();
	return result;
}
...
N_NIMCALL(tnode187813*, complement_244861)(tnode187813* a) {
	...
	nimln(147, "nimsets.nim");
	HEX3Atmp_244881 = (x->Sup.len-1);
	nimln(1450, "system.nim");
	res_244883 = 0;
	nimln(1451, "system.nim");
	while (1) {
		nimln(1451, "system.nim");
		if (!(res_244883 <= HEX3Atmp_244881)) goto LA1;
		nimln(1450, "system.nim");
		i_244879 = res_244883;
		nimln(147, "nimsets.nim");
		if ((NU)(i_244879) >= (NU)(x->Sup.len)) raiseIndexError();
		nimln(147, "nimsets.nim");
		if ((NU)(i_244879) >= (NU)(x->Sup.len)) raiseIndexError();
		x->data[i_244879] = (NI8)((NU8) ~(x->data[i_244879]));
		nimln(1453, "system.nim");
		res_244883 = addInt(res_244883, 1);
	} LA1: ;
...
N_NIMCALL(NI64, cardset_244063)(tnode187813* s) {
	...
	HEX3Atmp_245000 = (NI64)(TMP3163);
	nimln(1450, "system.nim");
	res_245002 = 0;
	nimln(1451, "system.nim");
	while (1) {
		nimln(1451, "system.nim");
		if (!(res_245002 <= HEX3Atmp_245000)) goto LA2;
		nimln(1450, "system.nim");
		i_244904 = res_245002;
		nimln(155, "nimsets.nim");
		{
			...
			nimln(155, "nimsets.nim");
			if (((TMP3150[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3151));
			if ((NU)(i_244904) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!((*(*s).kindU.S6.Sons->data[i_244904]).Kind == ((NU8) 44))) goto LA5;
			...
			if (((TMP3150[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3151));
			if ((NU)(i_244904) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (((TMP3150[(*(*s).kindU.S6.Sons->data[i_244904]).Kind/8] &(1<<((*(*s).kindU.S6.Sons->data[i_244904]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3151));
			if ((NU)(1) >= (NU)((*(*s).kindU.S6.Sons->data[i_244904]).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC7 = 0;
			LOC7 = getordvalue_223150((*(*s).kindU.S6.Sons->data[i_244904]).kindU.S6.Sons->data[1]);
			TMP3164 = addInt64(result, LOC7);
			nimln(157, "nimsets.nim");
			if (((TMP3150[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3151));
			if ((NU)(i_244904) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (((TMP3150[(*(*s).kindU.S6.Sons->data[i_244904]).Kind/8] &(1<<((*(*s).kindU.S6.Sons->data[i_244904]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3151));
			if ((NU)(0) >= (NU)((*(*s).kindU.S6.Sons->data[i_244904]).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC8 = 0;
			LOC8 = getordvalue_223150((*(*s).kindU.S6.Sons->data[i_244904]).kindU.S6.Sons->data[0]);
		...
		LA3: ;
		nimln(1453, "system.nim");
		res_245002 = addInt(res_245002, 1);
	} LA2: ;
	popFrame();
	return result;
}
...
N_NIMCALL(NIM_BOOL, sethasrange_244029)(tnode187813* s) {
	...
	HEX3Atmp_245056 = (NI64)(TMP3168);
	nimln(1450, "system.nim");
	res_245058 = 0;
	nimln(1451, "system.nim");
	while (1) {
		nimln(1451, "system.nim");
		if (!(res_245058 <= HEX3Atmp_245056)) goto LA6;
		nimln(1450, "system.nim");
		i_245032 = res_245058;
		nimln(166, "nimsets.nim");
		{
			nimln(166, "nimsets.nim");
			if (((TMP3150[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3151));
			if ((NU)(i_245032) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!((*(*s).kindU.S6.Sons->data[i_245032]).Kind == ((NU8) 44))) goto LA9;
		...
		LA9: ;
		nimln(1453, "system.nim");
		res_245058 = addInt(res_245058, 1);
	} LA6: ;
