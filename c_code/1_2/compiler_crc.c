	...
	p = ((NI8*) (buf));
	{
		while (1) {
			...
			readbytes = readbuffer_13515(bin, buf, ((NI) 8000));
			{
				...
				i_178647 = 0;
				HEX3Atmp_178652 = 0;
				HEX3Atmp_178652 = (NI64)(readbytes - ((NI) 1));
				res_178655 = ((NI) 0);
				{
					while (1) {
						if (!(res_178655 <= HEX3Atmp_178652)) goto LA10;
						i_178647 = res_178655;
						result = updatecrc32_178019(p[(i_178647)- 0], result);
						res_178655 += ((NI) 1);
					} LA10: ;
				}
			}
...
N_NIMCALL(NI32, HEX3EHEX3C_178533)(NI32 c, NimStringDesc* s) {
	...
	result = c;
	{
		...
		i_178548 = 0;
		HEX3Atmp_178550 = 0;
		HEX3Atmp_178550 = (NI64)(s->Sup.len - ((NI) 1));
		res_178553 = ((NI) 0);
		{
			while (1) {
