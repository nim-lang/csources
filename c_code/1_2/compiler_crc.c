	...
	p = ((NI8*) (buf));
	{
		while (1) {
			...
			readbytes = readbuffer_13427(bin, buf, 8000);
			{
				...
				i_178641 = 0;
				HEX3Atmp_178646 = 0;
				HEX3Atmp_178646 = (NI64)(readbytes - 1);
				res_178649 = 0;
				{
					while (1) {
						if (!(res_178649 <= HEX3Atmp_178646)) goto LA10;
						i_178641 = res_178649;
						result = updatecrc32_178019(p[(i_178641)- 0], result);
						res_178649 += 1;
					} LA10: ;
				}
			}
...
N_NIMCALL(NI32, HEX3EHEX3C_178531)(NI32 c, NimStringDesc* s) {
	...
	result = c;
	{
		...
		i_178546 = 0;
		HEX3Atmp_178548 = 0;
		HEX3Atmp_178548 = (NI64)(s->Sup.len - 1);
		res_178551 = 0;
		{
			while (1) {
				if (!(res_178551 <= HEX3Atmp_178548)) goto LA3;
				i_178546 = res_178551;
				result = updatecrc32_178026(s->data[i_178546], result);
				res_178551 += 1;
			} LA3: ;
		}
	}
