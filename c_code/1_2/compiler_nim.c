...
{	{
	...
	LA4_: ;
	{
		...
		mainCommand_9ckTkd2AM27sYCvHGluAXLg(T48_, cache);
		{
			...
			printf("%s\015\012", T55_? (T55_)->data:"nil");
			fflush(stdout);
		}
		LA53_: ;
		{
			if (!(gErrorCounter_BdMIKofstJQD5Y2GBaRdzQ == ((NI) 0))) goto LA58_;
			{
				if (!((gGlobalOptions_j042VVDC9cT5ENYoXnmhhVg &(1U<<((NU)(((tyEnum_TGlobalOption_RAfAEZqjnKMDumgyKKc1qw) 12))&31U)))!=0)) goto LA62_;
				{
					...
					LA70_: ;
					{
						...
						T76_ = completeCFilePath_XziFVTv1mJIlNEw2aMU1Ig(T75_, NIM_TRUE);
...
appendString(T77_, arguments_J4sVmqKDJ3MkfxziRX9cODA);
				...
				LA66_: ;
				{
					...
					LA84_: ;
					{
						...
						T90_ = completeCFilePath_XziFVTv1mJIlNEw2aMU1Ig(T89_, NIM_TRUE);
