...
STRING_LITERAL(TMP1928, "nim.cfg", 7);
STRING_LITERAL(TMP4894, "js", 2);
STRING_LITERAL(TMP4899, " ", 1);
STRING_LITERAL(TMP4900, "exe", 3);
...
N_NIMCALL(void, handlecmdline_559607)(void) {
	...
	LA4: ;
	{
		processcmdline_553209(((NU8) 0), ((NimStringDesc*) &TMP1905));
		{
			TSafePoint TMP1906;
			TY117804 p;
			NimStringDesc* LOC15;
			...
			pushSafePoint(&TMP1906);
			TMP1906.status = setjmp(TMP1906.context);
			if (TMP1906.status == 0) {
			...
			if (TMP1906.status != 0) reraiseException();
		...
		LA7: ;
		loadconfigs_205807(((NimStringDesc*) &TMP1928));
		initvars_188817();
		processcmdline_553209(((NU8) 1), ((NimStringDesc*) &TMP1905));
		maincommand_556627();
		{
			NimStringDesc* LOC22;
			...
			if (!(gerrorcounter_183118 == 0)) goto LA25;
			{
				if (!((gglobaloptions_171128 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				{
					...
					LA37: ;
					{
						...
						NimStringDesc* LOC43;
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_171239, ((NimStringDesc*) &TMP4894));
						LOC42 = 0;
...
appendString(LOC44, arguments_196081);
					execexternalprogram_188929(LOC44, ((NimStringDesc*) &TMP1905));
				}
				goto LA31;
				LA33: ;
				{
					...
					LA49: ;
					{
						NimStringDesc* LOC52;
						LOC52 = 0;
						LOC52 = noschangeFileExt(gprojectfull_171239, ((NimStringDesc*) &TMP4900));
...
appendString(LOC53, arguments_196081);
					execexternalprogram_188929(LOC53, ((NimStringDesc*) &TMP1905));
				}
				LA31: ;
			}
			LA29: ;
