...
N_NIMCALL(void, handlecmdline_595601_957294627)(void);
...
N_NIMCALL(NimStringDesc*, prependcurdir_595401_957294627)(NimStringDesc* f0);
...
STRING_LITERAL(T957294627_9, "js", 2);
STRING_LITERAL(T957294627_10, " ", 1);
STRING_LITERAL(T957294627_11, "php", 3);
STRING_LITERAL(T957294627_12, "php ", 4);
STRING_LITERAL(T957294627_13, "exe", 3);
...
{	{
		...
		writecommandlineusage_278005_2004575671();
	}
	goto LA1;
	LA4: ;
	{
		NimStringDesc* scriptfile0;
		processcmdline_589203_3526807654(((Tcmdlinepass278008) 0), ((NimStringDesc*) &T957294627_2));
		{
			NimStringDesc* LOC11;
			NimStringDesc* LOC12;
			if (!eqStrings(gprojectname_168209_2607990831, ((NimStringDesc*) &T957294627_3))) goto LA9;
			LOC11 = (NimStringDesc*)0;
			LOC11 = gprojectname_168209_2607990831; gprojectname_168209_2607990831 = copyStringRC1(((NimStringDesc*) &T957294627_4));
			if (LOC11) nimGCunrefNoCycle(LOC11);
			LOC12 = (NimStringDesc*)0;
			LOC12 = gprojectfull_168211_2607990831; gprojectfull_168211_2607990831 = copyStringRC1(((NimStringDesc*) &T957294627_4));
			if (LOC12) nimGCunrefNoCycle(LOC12);
			asgnRefNoCycle((void**) (&gprojectpath_168210_2607990831), nosgetCurrentDir());
			gprojectisstdin_168212_2607990831 = NIM_TRUE;
		}
		goto LA7;
		LA9: ;
		{
			...
			NimStringDesc* LOC20;
			NimStringDesc* LOC21;
			if (!!(((gprojectname_168209_2607990831) && (gprojectname_168209_2607990831)->Sup.len == 0))) goto LA14;
			pushSafePoint(&T957294627_5);
			T957294627_5.status = setjmp(T957294627_5.context);
			if (T957294627_5.status == 0) {
				asgnRefNoCycle((void**) (&gprojectfull_168211_2607990831), canonicalizepath_168405_2607990831(gprojectname_168209_2607990831));
				popSafePoint();
			}
			else {
				popSafePoint();
				if (isObj(getCurrentException()->Sup.m_type, (&NTI3630))) {
					...
					LOC19 = gprojectfull_168211_2607990831; gprojectfull_168211_2607990831 = copyStringRC1(gprojectname_168209_2607990831);
			...
			chckNil((void*)(&p0));
			memset((void*)(&p0), 0, sizeof(p0));
			nossplitFile(gprojectfull_168211_2607990831, (&p0));
			LOC20 = (NimStringDesc*)0;
			LOC20 = gprojectpath_168210_2607990831; gprojectpath_168210_2607990831 = copyStringRC1(p0.Field0);
			if (LOC20) nimGCunrefNoCycle(LOC20);
			LOC21 = (NimStringDesc*)0;
			LOC21 = gprojectname_168209_2607990831; gprojectname_168209_2607990831 = copyStringRC1(p0.Field1);
		...
		LA7: ;
		loadconfigs_288601_930198375(((NimStringDesc*) &T957294627_6));
		scriptfile0 = noschangeFileExt(gprojectfull_168211_2607990831, ((NimStringDesc*) &T957294627_7));
		{
			NIM_BOOL LOC25;
			LOC25 = (NIM_BOOL)0;
			LOC25 = fileexists_129002_2125978480(scriptfile0);
			if (!LOC25) goto LA26;
			runnimscript_594218_3062286716(scriptfile0, NIM_FALSE);
			{
				if (!eqStrings(scriptfile0, gprojectfull_168211_2607990831)) goto LA30;
				goto BeforeRet;
			}
			LA30: ;
		}
		...
		LA26: ;
		{
			...
			LOC33 = HEX2F_124074_2125978480(gprojectpath_168210_2607990831, ((NimStringDesc*) &T957294627_8));
			LOC34 = (NIM_BOOL)0;
			LOC34 = fileexists_129002_2125978480(LOC33);
			if (!LOC34) goto LA35;
			LOC37 = (NimStringDesc*)0;
			LOC37 = HEX2F_124074_2125978480(gprojectpath_168210_2607990831, ((NimStringDesc*) &T957294627_8));
			runnimscript_594218_3062286716(LOC37, NIM_FALSE);
		}
		goto LA23;
		LA35: ;
		LA23: ;
		initvars_271834_2528170400();
		processcmdline_589203_3526807654(((Tcmdlinepass278008) 1), ((NimStringDesc*) &T957294627_2));
		{
			if (!((command_168215_2607990831) && (command_168215_2607990831)->Sup.len == 0)) goto LA40;
			rawmessage_192612_155036129(((Tmsgkind189002) 184), command_168215_2607990831);
		}
		LA40: ;
		maincommand_591610_6460232();
		{
			NIM_BOOL LOC44;
			NimStringDesc* LOC48;
			LOC44 = (NIM_BOOL)0;
			LOC44 = ((goptions_168128_2607990831 &(1U<<((NU)(((Toption168009) 12))&31U)))!=0);
			if (!(LOC44)) goto LA45;
			LOC44 = ((gnotes_190068_155036129 &((NU64)1<<((NU)((((Tmsgkind189002) 289)- 237))&63U)))!=0);
			LA45: ;
			if (!LOC44) goto LA46;
		...
		LA46: ;
		{
			if (!(gerrorcounter_190069_155036129 == ((NI) 0))) goto LA51;
			{
				if (!((gglobaloptions_168130_2607990831 &((NU64)1<<((NU)(((Tglobaloption168013) 13))&63U)))!=0)) goto LA55;
				{
					NimStringDesc* ex0;
					NimStringDesc* LOC70;
					NimStringDesc* LOC71;
					if (!(gcmd_168132_2607990831 == ((Tcommands168076) 4))) goto LA59;
					ex0 = (NimStringDesc*)0;
					{
						NimStringDesc* LOC65;
						if (!(((NI) 0) < (outfile_168136_2607990831 ? outfile_168136_2607990831->Sup.len : 0))) goto LA63;
						LOC65 = (NimStringDesc*)0;
						LOC65 = prependcurdir_595401_957294627(outfile_168136_2607990831);
					...
					LA63: ;
					{
						...
						LOC67 = noschangeFileExt(gprojectfull_168211_2607990831, ((NimStringDesc*) &T957294627_9));
						LOC68 = (NimStringDesc*)0;
						LOC68 = prependcurdir_595401_957294627(LOC67);
						LOC69 = (NimStringDesc*)0;
						LOC69 = completecfilepath_271854_2528170400(LOC68, NIM_TRUE);
						ex0 = nospquoteShell(LOC69);
					}
					LA61: ;
					LOC70 = (NimStringDesc*)0;
					LOC71 = (NimStringDesc*)0;
					LOC71 = findnodejs_593002_1446018522();
					LOC70 = rawNewString(LOC71->Sup.len + ex0->Sup.len + arguments_279811_2004575671->Sup.len + 2);
appendString(LOC70, LOC71);
appendString(LOC70, ((NimStringDesc*) &T957294627_10));
appendString(LOC70, ex0);
appendChar(LOC70, 32);
appendString(LOC70, arguments_279811_2004575671);
					execexternalprogram_271881_2528170400(LOC70, ((Tmsgkind189002) 284));
				}
				goto LA57;
				LA59: ;
				{
					NimStringDesc* ex0;
					NimStringDesc* LOC84;
					if (!(gcmd_168132_2607990831 == ((Tcommands168076) 5))) goto LA73;
					ex0 = (NimStringDesc*)0;
					{
						NimStringDesc* LOC79;
						if (!(((NI) 0) < (outfile_168136_2607990831 ? outfile_168136_2607990831->Sup.len : 0))) goto LA77;
						LOC79 = (NimStringDesc*)0;
						LOC79 = prependcurdir_595401_957294627(outfile_168136_2607990831);
					...
					LA77: ;
					{
						...
						LOC81 = noschangeFileExt(gprojectfull_168211_2607990831, ((NimStringDesc*) &T957294627_11));
						LOC82 = (NimStringDesc*)0;
						LOC82 = prependcurdir_595401_957294627(LOC81);
						LOC83 = (NimStringDesc*)0;
						LOC83 = completecfilepath_271854_2528170400(LOC82, NIM_TRUE);
						ex0 = nospquoteShell(LOC83);
					}
					LA75: ;
					LOC84 = (NimStringDesc*)0;
					LOC84 = rawNewString(ex0->Sup.len + arguments_279811_2004575671->Sup.len + 5);
appendString(LOC84, ((NimStringDesc*) &T957294627_12));
appendString(LOC84, ex0);
appendChar(LOC84, 32);
appendString(LOC84, arguments_279811_2004575671);
					execexternalprogram_271881_2528170400(LOC84, ((Tmsgkind189002) 284));
				}
				goto LA57;
				LA73: ;
				{
					...
					{
						if (!(((NI) 0) < (outfile_168136_2607990831 ? outfile_168136_2607990831->Sup.len : 0))) goto LA88;
						binpath0 = prependcurdir_595401_957294627(outfile_168136_2607990831);
					}
					goto LA86;
					LA88: ;
					{
						...
						LOC91 = noschangeFileExt(gprojectfull_168211_2607990831, ((NimStringDesc*) &T957294627_13));
						binpath0 = prependcurdir_595401_957294627(LOC91);
					}
					LA86: ;
					ex0 = nospquoteShell(binpath0);
					LOC92 = (NimStringDesc*)0;
					LOC92 = rawNewString(ex0->Sup.len + arguments_279811_2004575671->Sup.len + 1);
appendString(LOC92, ex0);
appendChar(LOC92, 32);
appendString(LOC92, arguments_279811_2004575671);
					execexternalprogram_271881_2528170400(LOC92, ((Tmsgkind189002) 284));
				}
				LA57: ;
			}
			LA55: ;
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	...
	handlecmdline_595601_957294627();
	msgquit_190146_155036129(((NI8) ((((NI) 0) < gerrorcounter_190069_155036129))));
}
