...
STRING_LITERAL(TMP1325, "", 0);
STRING_LITERAL(TMP1326, "subschar", 8);
STRING_LITERAL(TMP1327, "metachar", 8);
STRING_LITERAL(TMP1328, "emit", 4);
STRING_LITERAL(TMP1329, "result.add", 10);
STRING_LITERAL(TMP1330, "conc", 4);
STRING_LITERAL(TMP1331, " & ", 3);
STRING_LITERAL(TMP1332, "tostring", 8);
STRING_LITERAL(TMP1333, "$", 1);
STRING_LITERAL(TMP1334, "\015\012", 2);
STRING_LITERAL(TMP1336, "end", 3);
STRING_LITERAL(TMP1337, "#end", 4);
static NIM_CONST TY211607 TMP1338 = {
...
N_NIMCALL(void, parseline_257174)(ttmplparser257020* p) {
	...
	LA7: ;
	{
		...
		d = j;
		keyw = copyString(((NimStringDesc*) &TMP1325));
		{
			while (1) {
		...
		case ((NU8) 20):
		{
			...
			{
				(*p).Info.Col = ((NI16) (j));
				localerror_197938((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP1336));
			}
			LA20: ;
			LOC25 = 0;
		...
		case ((NU8) 59):
		{
			...
			llstreamwrite_211278((*p).Outp, LOC34);
			{
				NIM_BOOL LOC37;
				LOC37 = 0;
				LOC37 = contains_99229((*p).X, TMP1338);
				if (!!(LOC37)) goto LA38;
				(*p).Indent += 2;
			}
			LA38: ;
				...
				{
					{
						...
						case 123:
						{
							...
							curly = 0;
							{
								while (1) {
									...
									case 0:
									{
										localerror_197938((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP1345));
										goto LA62;
									}
									break;
									case 123:
						...
						default:
						{
							...
							{
								(*p).Info.Col = ((NI16) (j));
								localerror_197938((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP1333));
							}
							LA80: ;
						}
						break;
...
N_NIMCALL(tllstream211204*, filtertmpl_257009)(tllstream211204* stdin_257011, NimStringDesc* filename, tnode224819* call) {
	...
	p.Outp = llstreamopen_211220(((NimStringDesc*) &TMP1325));
	p.Inp = stdin_257011;
	p.Subschar = chararg_256020(call, ((NimStringDesc*) &TMP1326), 1, 36);
	p.Nimdirective = chararg_256020(call, ((NimStringDesc*) &TMP1327), 2, 35);
	p.Emit = strarg_256029(call, ((NimStringDesc*) &TMP1328), 3, ((NimStringDesc*) &TMP1329));
	p.Conc = strarg_256029(call, ((NimStringDesc*) &TMP1330), 4, ((NimStringDesc*) &TMP1331));
	p.Tostr = strarg_256029(call, ((NimStringDesc*) &TMP1332), 5, ((NimStringDesc*) &TMP1333));
