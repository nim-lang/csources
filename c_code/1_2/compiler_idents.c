...
N_NIMCALL(NI, cmpignorestyle_141034)(NCSTRING a, NCSTRING b, NI blen) {
	...
	while (1) {
		...
		nimln(43, "idents.nim");
		{
			...
			aa = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP894), 0, 255))));
		}		LA16: ;
		nimln(44, "idents.nim");
		{
			NIM_BOOL LOC20;
			...
			bb = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP895), 0, 255))));
		}		LA22: ;
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
...
N_NIMCALL(tident141017*, getident_141202)(NCSTRING identifier, NI length, NI h) {
	...
	nimln(92, "idents.nim");
	{
		...
		nimln(94, "idents.nim");
		nimln(94, "idents.nim");
		if (wordcounter_141200 == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
		(*result).Sup.Id = ((NI64)-(wordcounter_141200));
	}	goto LA22;
	LA24: ;
	{
		nimln(96, "idents.nim");
