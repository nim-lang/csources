...
N_NIMCALL(void, renderparamtypes_395467)(TY120208** found, tnode224819* n);
...
STRING_LITERAL(TMP4634, "", 0);
STRING_LITERAL(TMP4635, "*", 1);
STRING_LITERAL(TMP4636, "renderPlainSymbolName() with ", 29);
STRING_LITERAL(TMP4643, "ref.", 4);
STRING_LITERAL(TMP4644, "ptr.", 4);
STRING_LITERAL(TMP4645, "proc(", 5);
STRING_LITERAL(TMP4646, "tuple[", 6);
STRING_LITERAL(TMP4647, "renderParamTypes(found,n) with ", 31);
...
N_NIMCALL(NimStringDesc*, renderplainsymbolname_393013)(tnode224819* n) {
	...
	result = 0;
	result = copyString(((NimStringDesc*) &TMP4634));
	switch ((*n).Kind) {
	case ((NU8) 31):
	{
		{
	...
	{
		{
			if (!!(eqStrings((*(*n).kindU.S5.Ident).S, ((NimStringDesc*) &TMP4635)))) goto LA15;
...
appendString(LOC24, ((NimStringDesc*) &TMP4636));
...
appendString(LOC6, ((NimStringDesc*) &TMP4643));
...
appendString(LOC10, ((NimStringDesc*) &TMP4644));
...
N_NIMCALL(void, renderparamtypes_395467)(TY120208** found, tnode224819* n) {
	...
	case ((NU8) 35):
	{
		...
		typestr = rendertype_393222(LOC9);
		{
			...
			if (!(LOC12)) goto LA13;
			LOC14 = 0;
			LOC14 = HEX5BHEX5D_225698(n, (NI64)(typepos + 1));
			LOC12 = !(((*LOC14).Kind == ((NU8) 1)));
			LA13: ;
			if (!LOC12) goto LA15;
			LOC17 = 0;
			LOC17 = HEX5BHEX5D_225698(n, (NI64)(typepos + 1));
			typ = (*LOC17).Typ;
			{
				if (!!(typ == 0)) goto LA20;
...
appendString(LOC31, ((NimStringDesc*) &TMP4647));
