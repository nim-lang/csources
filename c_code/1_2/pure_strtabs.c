...
N_NIMCALL(NimStringDesc**, nstTake)(tstringtable113610* t, NimStringDesc* key);
...
N_NIMCALL(void, rawinsert_113864)(tstringtable113610* t, tkeyvaluepairseq113608** data, NimStringDesc* key, NimStringDesc* val);
N_NIMCALL(NimStringDesc*, copyStringRC1)(NimStringDesc* src);
static N_INLINE(void, nimGCunrefNoCycle)(void* p);
N_NIMCALL(void, enlarge_113876)(tstringtable113610* t);
N_NIMCALL(void, nimGCvisit)(void* d, NI op);
N_NIMCALL(void, TMP302)(void* p, NI op);
N_NIMCALL(void*, newSeq)(TNimType* typ, NI len);
N_NIMCALL(void, nstPut)(tstringtable113610* t, NimStringDesc* key, NimStringDesc* val);
N_NIMCALL(void, raiseformatexception_113955)(NimStringDesc* s);
...
STRING_LITERAL(TMP291, "counter < length ", 17);
STRING_LITERAL(TMP297, "", 0);
STRING_LITERAL(TMP299, "key does not exist: ", 20);
STRING_LITERAL(TMP303, "format string: key not found: ", 30);
NIM_CONST TY114118 patternchars_114117 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x03,
0xFE, 0xFF, 0xFF, 0x87, 0xFE, 0xFF, 0xFF, 0x07,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP322, "{:}", 3);
STRING_LITERAL(TMP323, "{", 1);
STRING_LITERAL(TMP324, ", ", 2);
STRING_LITERAL(TMP325, ": ", 2);
STRING_LITERAL(TMP326, "}", 1);
extern TFrame* frameptr_12037;
extern TNimType NTI113841; /* ref EInvalidKey */
extern TNimType NTI1055; /* EInvalidKey */
extern tgcheap40616 gch_40644;
extern TNimType NTI92504; /* tuple[nonDST: string, DST: string] */
...
N_NIMCALL(NI, myhash_113702)(tstringtable113610* t, NimStringDesc* key) {
	...
	case ((NU8) 0):
	{
		...
		result = hash_111826(key);
	}	break;
	case ((NU8) 1):
	{
		nimln(75, "strtabs.nim");
		result = hashignorecase_111924(key);
	}	break;
	case ((NU8) 2):
	{
		nimln(76, "strtabs.nim");
		result = hashignorestyle_111856(key);
	}	break;
	}
	popFrame();
	return result;
...
N_NIMCALL(NIM_BOOL, mustrehash_113717)(NI length, NI counter) {
	...
	nimln(85, "strtabs.nim");
	{
		...
		nimln(85, "strtabs.nim");
		hiddenraiseassert_77217(((NimStringDesc*) &TMP291));	}	LA3: ;
	nimln(86, "strtabs.nim");
	nimln(86, "strtabs.nim");
	LOC5 = 0;
	nimln(86, "strtabs.nim");
	nimln(86, "strtabs.nim");
	TMP292 = mulInt(length, 2);
	nimln(86, "strtabs.nim");
	TMP293 = mulInt(counter, 3);
	LOC5 = ((NI64)(TMP292) < (NI64)(TMP293));
	if (LOC5) goto LA6;
	nimln(86, "strtabs.nim");
	nimln(86, "strtabs.nim");
	TMP294 = subInt(length, counter);
	LOC5 = ((NI64)(TMP294) < 4);
	LA6: ;
	result = LOC5;
	popFrame();
...
N_NIMCALL(NimStringDesc**, nstTake)(tstringtable113610* t, NimStringDesc* key) {
	...
	LA3: ;
	{
		einvalidkey1055* e_113840;
		NimStringDesc* LOC6;
		e_113840 = 0;
		nimln(1829, "system.nim");
		e_113840 = (einvalidkey1055*) newObj((&NTI113841), sizeof(einvalidkey1055));
		(*e_113840).Sup.Sup.Sup.Sup.m_type = (&NTI1055);
		nimln(1830, "system.nim");
		nimln(113, "strtabs.nim");
		LOC6 = 0;
		LOC6 = rawNewString(key->Sup.len + 20);
appendString(LOC6, ((NimStringDesc*) &TMP299));
appendString(LOC6, key);
		asgnRefNoCycle((void**) &(*e_113840).Sup.Sup.Sup.message, LOC6);
		nimln(113, "strtabs.nim");
		raiseException((E_Base*)e_113840, "EInvalidKey");
	}	LA1: ;
	popFrame();
	return result;
}
...
N_NIMCALL(void, enlarge_113876)(tstringtable113610* t) {
	...
	nimln(128, "strtabs.nim");
	nimln(128, "strtabs.nim");
	TMP300 = mulInt((*t).Data->Sup.len, 2);
	n = (tkeyvaluepairseq113608*) newSeq((&NTI113608), (NI64)(TMP300));
	i_113907 = 0;
	HEX3Atmp_113921 = 0;
	nimln(129, "strtabs.nim");
	nimln(129, "strtabs.nim");
	HEX3Atmp_113921 = ((*t).Data->Sup.len-1);
	nimln(1301, "system.nim");
	res_113923 = 0;
	nimln(1302, "system.nim");
	while (1) {
		nimln(1302, "system.nim");
		if (!(res_113923 <= HEX3Atmp_113921)) goto LA1;
		nimln(1301, "system.nim");
		i_113907 = res_113923;
		nimln(130, "strtabs.nim");
		{
			nimln(130, "strtabs.nim");
			nimln(130, "strtabs.nim");
			if ((NU)(i_113907) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			if (!!((*t).Data->data[i_113907].Field0 == 0)) goto LA4;
			nimln(130, "strtabs.nim");
			if ((NU)(i_113907) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			if ((NU)(i_113907) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			rawinsert_113864(t, &n, (*t).Data->data[i_113907].Field0, (*t).Data->data[i_113907].Field1);		}		LA4: ;
		nimln(1304, "system.nim");
		res_113923 = addInt(res_113923, 1);
	} LA1: ;
...
N_NIMCALL(void, nstPut)(tstringtable113610* t, NimStringDesc* key, NimStringDesc* val) {
	...
	LA3: ;
	{
		nimln(139, "strtabs.nim");
		{
			...
			if (!LOC9) goto LA10;
			nimln(139, "strtabs.nim");
			enlarge_113876(t);		}		LA10: ;
		nimln(140, "strtabs.nim");
		rawinsert_113864(t, &(*t).Data, key, val);		nimln(141, "strtabs.nim");
...
appendString(LOC1, ((NimStringDesc*) &TMP303));
appendString(LOC1, s);
...
appendString(LOC19, key);
		...
		LA17: ;
		{
			...
			nimln(156, "strtabs.nim");
			raiseformatexception_113955(key);		}		goto LA15;
		LA21: ;
		LA15: ;
	}	LA13: ;
	BeforeRet: ;	popFrame();
...
N_NIMCALL(tstringtable113610*, nstnewStringTableWithPairs)(NimStringDesc** keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	...
	while (1) {
		...
		nimln(176, "strtabs.nim");
		TMP313 = addInt(i, 1);
		if ((NU)((NI64)(TMP313)) >= (NU)(keyvaluepairsLen0)) raiseIndexError();
		nstPut(result, keyvaluepairs[i], keyvaluepairs[(NI64)(TMP313)]);		nimln(177, "strtabs.nim");
		i = addInt(i, 2);
	} LA1: ;
	popFrame();
	return result;
...
N_NIMCALL(tstringtable113610*, nstnewStringTableWithTableConstr)(TY92504* keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	...
	while (1) {
		...
		nstPut(result, key_114101, val_114102);		nimln(1380, "system.nim");
...
N_NIMCALL(NimStringDesc*, nstFormat)(NimStringDesc* f, tstringtable113610* t, NU8 flags) {
	...
	while (1) {
		...
		nimln(197, "strtabs.nim");
		{
			...
			nimln(198, "strtabs.nim");
			TMP314 = addInt(i, 1);
			if ((NU)((NI64)(TMP314)) > (NU)(f->Sup.len)) raiseIndexError();
			switch (((NU8)(f->data[(NI64)(TMP314)]))) {
			case 36:
			{
			...
			case 123:
			{
				...
				TMP317 = subInt(j, 1);
				LOC11 = 0;
				LOC11 = copyStrLast(f, (NI64)(TMP316), (NI64)(TMP317));
				LOC12 = 0;
...
appendString(result, LOC12);
			...
			case 95:
			{
				...
				TMP321 = subInt(j, 1);
				LOC17 = 0;
				LOC17 = copyStrLast(f, (NI64)(TMP320), (NI64)(TMP321));
				LOC18 = 0;
...
static TNimNode* TMP309[3];
NI TMP311;
static char* NIM_CONST TMP310[3] = {
"modeCaseSensitive", 
"modeCaseInsensitive", 
"modeStyleInsensitive"};
static TNimNode TMP279[8];
NTI113608.size = sizeof(tkeyvaluepairseq113608*);
NTI113608.kind = 24;
NTI113608.base = (&NTI92504);
NTI113608.flags = 2;
NTI113608.marker = TMP302;
NTI113610.size = sizeof(tstringtable113610);
NTI113610.kind = 17;
NTI113610.base = (&NTI1009);
NTI113610.flags = 2;
TMP308[0] = &TMP279[1];
TMP279[1].kind = 1;
TMP279[1].offset = offsetof(tstringtable113610, Counter);
TMP279[1].typ = (&NTI105);
TMP279[1].name = "counter";
TMP308[1] = &TMP279[2];
TMP279[2].kind = 1;
TMP279[2].offset = offsetof(tstringtable113610, Data);
TMP279[2].typ = (&NTI113608);
TMP279[2].name = "data";
TMP308[2] = &TMP279[3];
...
NTI113604.base = 0;
NTI113604.flags = 3;
for (TMP311 = 0; TMP311 < 3; TMP311++) {
TMP279[TMP311+4].kind = 1;
TMP279[TMP311+4].offset = TMP311;
TMP279[TMP311+4].name = TMP310[TMP311];
TMP309[TMP311] = &TMP279[TMP311+4];
}
TMP279[7].len = 3; TMP279[7].kind = 2; TMP279[7].sons = &TMP309[0];
NTI113604.node = &TMP279[7];
TMP279[3].kind = 1;
TMP279[3].offset = offsetof(tstringtable113610, Mode);
TMP279[3].typ = (&NTI113604);
TMP279[3].name = "mode";
TMP279[0].len = 3; TMP279[0].kind = 2; TMP279[0].sons = &TMP308[0];
NTI113610.node = &TMP279[0];
NTI113612.size = sizeof(tstringtable113610*);
NTI113612.kind = 22;
NTI113612.base = (&NTI113610);
NTI113612.flags = 2;
NTI113612.marker = TMP312;
}
