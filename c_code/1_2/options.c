...
tlinkedlist120023 searchpaths_138115;
tlinkedlist120023 lazypaths_138116;
...
tstringtable123810* gconfigvars_138203;
tstringtable123810* gdlloverrides_138204;
...
tstringtable123810* packagecache_138601;
...
N_NIMCALL(NimStringDesc*, getgeneratedpath_138417)(void) {
	...
	LA3: ;
	{
		...
		result = HEX2F_108677(LOC6, ((NimStringDesc*) &TMP425));
	}
	LA1: ;
	popFrame();
	return result;
...
N_NIMCALL(void, resetpackagecache_138603)(void) {
	...
	asgnRef((void**) &packagecache_138601, nstnewStringTable(((NU8) 0)));
	popFrame();
}
...
N_NIMCALL(NimStringDesc*, getpackagename_138811)(NimStringDesc* path) {
	...
	parents = 0;
	{
		...
		NimStringDesc* current_138859;
		d_138817 = 0;
		nimln(227, "options.nim");
		current_138859 = copyString(path);
		nimln(228, "options.nim");
		while (1) {
			NimStringDesc* file_138834;
			NimStringDesc* HEX3Atmp_138852;
			twin32finddata96815 f_138854;
			NI res_138856;
			nimln(229, "options.nim");
			current_138859 = nosparentDir(current_138859);
			nimln(230, "options.nim");
			{
				nimln(230, "options.nim");
				nimln(230, "options.nim");
				if (!(current_138859->Sup.len == 0)) goto LA5;
				nimln(230, "options.nim");
				goto LA2;
			}
			LA5: ;
			nimln(227, "options.nim");
			d_138817 = current_138859;
			...
			HEX3Atmp_138852 = HEX2F_108677(d_138817, ((NimStringDesc*) &TMP429));
			memset((void*)&f_138854, 0, sizeof(f_138854));
			res_138856 = 0;
			nimln(1196, "os.nim");
			res_138856 = findfirstfile_105816(HEX3Atmp_138852, &f_138854);
			nimln(1197, "os.nim");
			{
				nimln(1197, "os.nim");
				nimln(1197, "os.nim");
				if (!!((res_138856 == -1))) goto LA14;
				nimln(1198, "os.nim");
				while (1) {
					nimln(1199, "os.nim");
					{
						...
						nimln(1199, "os.nim");
						LOC20 = 0;
						LOC20 = skipfinddata_105834(&f_138854);
						LOC19 = !(LOC20);
						if (!(LOC19)) goto LA21;
						nimln(1200, "os.nim");
						nimln(1200, "os.nim");
						LOC19 = ((NI32)(f_138854.Dwfileattributes & ((NI32) 16)) == ((NI32) 0));
						LA21: ;
						if (!LOC19) goto LA22;
						nimln(1201, "os.nim");
						nimln(1201, "os.nim");
						memset((void*)&LOC24, 0, sizeof(LOC24));
						nossplitFile(HEX3Atmp_138852, &LOC24);
						nimln(1201, "os.nim");
						nimln(1201, "os.nim");
						LOC25 = 0;
						LOC25 = HEX24_74991(((NI16*) (&f_138854.Cfilename[(0)- 0])));
						LOC26 = 0;
						LOC26 = nosextractFilename(LOC25);
						file_138834 = HEX2F_108677(LOC24.Field0, LOC26);
						nimln(242, "options.nim");
						nimln(242, "options.nim");
						memset((void*)&LOC27, 0, sizeof(LOC27));
						nossplitFile(file_138834, &LOC27);
					...
					nimln(1202, "os.nim");
					{
						...
						nimln(1202, "os.nim");
						LOC30 = 0;
						LOC30 = Dl_96838(res_138856, &f_138854);
	...
	d_138835 = 0;
	nimln(227, "options.nim");
	current_138861 = copyString(path);
	nimln(228, "options.nim");
	while (1) {
		nimln(229, "options.nim");
		current_138861 = nosparentDir(current_138861);
		nimln(230, "options.nim");
		{
			nimln(230, "options.nim");
			nimln(230, "options.nim");
			if (!(current_138861->Sup.len == 0)) goto LA40;
			nimln(230, "options.nim");
			goto LA37;
		}
		LA40: ;
		nimln(227, "options.nim");
		d_138835 = current_138861;
...
static N_INLINE(void, writeln_139205)(FILE* f_139209, NimStringDesc** x_139213, NI x_139213Len0) {
	...
	nimln(172, "sysio.nim");
	write_10663(f_139209, ((NimStringDesc*) &TMP431));
	popFrame();
}
...
N_NIMCALL(NimStringDesc*, rawfindfile_139266)(NimStringDesc* f) {
	...
	it_139274 = ((tstrentry120019*) (searchpaths_138115.Head));
	...
	while (1) {
		...
		if ((*it_139274).Sup.Next) chckObj((*(*it_139274).Sup.Next).Sup.m_type, (&NTI120019));
		it_139274 = ((tstrentry120019*) ((*it_139274).Sup.Next));
	} LA1: ;
...
N_NIMCALL(NimStringDesc*, rawfindfile2_139278)(NimStringDesc* f) {
	...
	if (lazypaths_138116.Head) chckObj((*lazypaths_138116.Head).Sup.m_type, (&NTI120019));
	it = ((tstrentry120019*) (lazypaths_138116.Head));
	...
	while (1) {
		...
		nimln(321, "options.nim");
		{
			...
			bringtofront_120758(&lazypaths_138116, &it->Sup);
...
N_NIMCALL(NimStringDesc*, findmodule_139312)(NimStringDesc* modulename, NimStringDesc* currentmodule) {
	...
	result = HEX2F_108677(currentpath, m);
...
N_NIMCALL(void, libcandidates_139321)(NimStringDesc* s, TY10865** dest) {
	...
	nimln(347, "options.nim");
	{
		...
		nimln(350, "options.nim");
		TMP441 = subInt(ri, 1);
		HEX3Atmp_139351 = copyStrLast(s, (NI64)(TMP440), (NI64)(TMP441));
		...
		nimln(258, "strutils.nim");
		{
			...
			nimln(258, "strutils.nim");
			failedassertimpl_81621(((NimStringDesc*) &TMP442));
		}
		LA9: ;
		nimln(259, "strutils.nim");
		{
			...
			while (1) {
				...
				nimln(264, "strutils.nim");
				nimln(264, "strutils.nim");
				TMP443 = subInt(last_139353, 1);
				middle_139332 = copyStrLast(HEX3Atmp_139351, first_139355, (NI64)(TMP443));
...
N_NIMCALL(void, incldynliboverride_139369)(NimStringDesc* lib) {
	...
	nstPut(gdlloverrides_138204, LOC1, ((NimStringDesc*) &TMP447));
	popFrame();
}
...
N_NOINLINE(void, optionsInit)(void) {
	...
	LOC1 = 0;
	LOC1 = outfile_138117; outfile_138117 = copyStringRC1(((NimStringDesc*) &TMP409));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(104, "options.nim");
	LOC2 = 0;
	LOC2 = docseesrcurl_138118; docseesrcurl_138118 = copyStringRC1(((NimStringDesc*) &TMP409));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(106, "options.nim");
	LOC3 = 0;
	LOC3 = headerfile_138119; headerfile_138119 = copyStringRC1(((NimStringDesc*) &TMP409));
	if (LOC3) nimGCunrefNoCycle(LOC3);
	nimln(107, "options.nim");
	gverbosity_138120 = 1;
	nimln(110, "options.nim");
	LOC4 = 0;
	LOC4 = gevalexpr_138123; gevalexpr_138123 = copyStringRC1(((NimStringDesc*) &TMP409));
	...
	LOC5 = 0;
	LOC5 = libpath_138205; libpath_138205 = copyStringRC1(((NimStringDesc*) &TMP409));
	if (LOC5) nimGCunrefNoCycle(LOC5);
	nimln(151, "options.nim");
	LOC6 = 0;
	LOC6 = gprojectname_138206; gprojectname_138206 = copyStringRC1(((NimStringDesc*) &TMP409));
	if (LOC6) nimGCunrefNoCycle(LOC6);
	nimln(152, "options.nim");
	LOC7 = 0;
	LOC7 = gprojectpath_138207; gprojectpath_138207 = copyStringRC1(((NimStringDesc*) &TMP409));
	if (LOC7) nimGCunrefNoCycle(LOC7);
	nimln(153, "options.nim");
	LOC8 = 0;
	LOC8 = gprojectfull_138208; gprojectfull_138208 = copyStringRC1(((NimStringDesc*) &TMP409));
	if (LOC8) nimGCunrefNoCycle(LOC8);
	nimln(155, "options.nim");
	LOC9 = 0;
	LOC9 = optmainmodule_138210; optmainmodule_138210 = copyStringRC1(((NimStringDesc*) &TMP409));
	if (LOC9) nimGCunrefNoCycle(LOC9);
	nimln(156, "options.nim");
	LOC10 = 0;
	LOC10 = nimcachedir_138211; nimcachedir_138211 = copyStringRC1(((NimStringDesc*) &TMP409));
	if (LOC10) nimGCunrefNoCycle(LOC10);
	nimln(157, "options.nim");
	LOC11 = 0;
	LOC11 = command_138212; command_138212 = copyStringRC1(((NimStringDesc*) &TMP409));
...
static TNimNode* TMP2010[22];
NI TMP2012;
static char* NIM_CONST TMP2011[22] = {
"optNone", 
"optObjCheck", 
"optFieldCheck", 
"optRangeCheck", 
...
"optImplicitStatic", 
"optPatterns"};
static TNimNode* TMP3079[32];
NI TMP3081;
static char* NIM_CONST TMP3080[32] = {
"gloptNone", 
"optForceFullMake", 
"optDeadCodeElim", 
"optListCmd", 
...
"optGenIndex", 
"optEmbedOrigSrc"};
static TNimNode* TMP3090[20];
NI TMP3092;
static char* NIM_CONST TMP3091[20] = {
"cmdNone", 
"cmdCompileToC", 
"cmdCompileToCpp", 
"cmdCompileToOC", 
...
NTI138010.base = 0;
NTI138010.flags = 3;
for (TMP2012 = 0; TMP2012 < 22; TMP2012++) {
TMP271[TMP2012+0].kind = 1;
TMP271[TMP2012+0].offset = TMP2012;
TMP271[TMP2012+0].name = TMP2011[TMP2012];
TMP2010[TMP2012] = &TMP271[TMP2012+0];
}
TMP271[22].len = 22; TMP271[22].kind = 2; TMP271[22].sons = &TMP2010[0];
NTI138010.node = &TMP271[22];
NTI138105.size = sizeof(NU32);
NTI138105.kind = 19;
NTI138105.base = (&NTI138010);
NTI138105.flags = 3;
TMP271[23].len = 0; TMP271[23].kind = 0;
NTI138105.node = &TMP271[23];
NTI138014.size = sizeof(NU8);
NTI138014.kind = 14;
NTI138014.base = 0;
NTI138014.flags = 3;
for (TMP3081 = 0; TMP3081 < 32; TMP3081++) {
TMP271[TMP3081+24].kind = 1;
TMP271[TMP3081+24].offset = TMP3081;
TMP271[TMP3081+24].name = TMP3080[TMP3081];
TMP3079[TMP3081] = &TMP271[TMP3081+24];
}
TMP271[56].len = 32; TMP271[56].kind = 2; TMP271[56].sons = &TMP3079[0];
NTI138014.node = &TMP271[56];
NTI138018.size = sizeof(NU8);
NTI138018.kind = 14;
NTI138018.base = 0;
NTI138018.flags = 3;
for (TMP3092 = 0; TMP3092 < 20; TMP3092++) {
TMP271[TMP3092+57].kind = 1;
TMP271[TMP3092+57].offset = TMP3092;
TMP271[TMP3092+57].name = TMP3091[TMP3092];
TMP3090[TMP3092] = &TMP271[TMP3092+57];
}
TMP271[77].len = 20; TMP271[77].kind = 2; TMP271[77].sons = &TMP3090[0];
NTI138018.node = &TMP271[77];
}
