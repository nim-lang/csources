...
N_NOINLINE(void, raiserecoverableerror_182969)(NimStringDesc* msg);
...
tlineinfo182338 gcmdlineinfo_182924;
tlineinfo182338 gcodegenlineinfo_182962;
NU64 gnotes_183014;
NI gerrorcounter_183015;
NI ghintcounter_183016;
NI gwarncounter_183017;
NI gerrormax_183018;
TY183036* msgcontext_183055;
TNimType NTI182338; /* TLineInfo */
extern TNimType NTI112; /* int16 */
extern TNimType NTI114; /* int32 */
TNimType NTI183036; /* seq[TLineInfo] */
tlineinfo182338 lasterror_183056;
TY122008* bufferedmsgs_183058;
NU8 erroroutputs_183060;
TY183061 writelnhook_183064;
...
TNimType NTI182975; /* ref ERecoverableError */
...
TNimType NTI183297; /* ref ESuggestDone */
N_NIMCALL(void, TMP136)(void* p, NI op) {
	TY182351* a;
	NI LOC1;
	a = (TY182351*)p;
...
N_NIMCALL(trope179009*, makecstring_182451)(NimStringDesc* s) {
	...
	res = copyString(((NimStringDesc*) &TMP140));
	{
		...
		i_182469 = 0;
		HEX3Atmp_182474 = 0;
		HEX3Atmp_182474 = (NI64)(s->Sup.len - ((NI) 1));
		res_182477 = ((NI) 0);
		{
			while (1) {
				NimStringDesc* LOC9;
				...
				{
					trope179009* LOC8;
					if (!(((NI) ((NI64)((NI64)(i_182469 + ((NI) 1)) % ((NI) 64)))) == ((NI) 0))) goto LA6;
					res = addChar(res, 34);
...
N_NIMCALL(void, msgwriteln_183738)(NimStringDesc* s) {
	{
		if (!!(writelnhook_183064.ClPrc == 0)) goto LA3;
		writelnhook_183064.ClEnv? writelnhook_183064.ClPrc(s, writelnhook_183064.ClEnv):((TMP145)(writelnhook_183064.ClPrc))(s);
	}
	goto LA1;
	LA3: ;
	{
		...
		{
			TY183780 LOC12;
			if (!((erroroutputs_183060 &(1<<((((NU8) 1))&7)))!=0)) goto LA10;
	...
	LA6: ;
	{
		{
			TY183780 LOC18;
			if (!((erroroutputs_183060 &(1<<((((NU8) 0))&7)))!=0)) goto LA16;
	...
	LA1: ;
	{
		if (!((erroroutputs_183060 &(1<<((((NU8) 2))&7)))!=0)) goto LA21;
		safeadd_183127((&bufferedmsgs_183058), s);
	}
	LA21: ;
}
...
N_NIMCALL(void, writecontext_184029)(tlineinfo182338 lastinfo) {
	...
	info = lastinfo;
	{
		...
		i_184053 = 0;
		HEX3Atmp_184059 = 0;
		HEX3Atmp_184059 = (NI64)(msgcontext_183055->Sup.len - ((NI) 1));
		res_184062 = ((NI) 0);
		{
			while (1) {
				...
				i_184053 = res_184062;
				{
					...
					LOC6 = 0;
					LOC7 = 0;
					LOC7 = HEX3DHEX3D_184018(msgcontext_183055->data[i_184053], lastinfo);
					LOC6 = !(LOC7);
					if (!(LOC6)) goto LA8;
					LOC9 = 0;
					LOC9 = HEX3DHEX3D_184018(msgcontext_183055->data[i_184053], info);
					LOC6 = !(LOC9);
					LA8: ;
					if (!LOC6) goto LA10;
					memset((void*)LOC12, 0, sizeof(LOC12));
					LOC12[0] = tomsgfilename_183629(msgcontext_183055->data[i_184053]);
					LOC12[1] = coordtostr_183833(((NI) (msgcontext_183055->data[i_184053].Line)));
					LOC12[2] = coordtostr_183833(((NI) (msgcontext_183055->data[i_184053].Col)));
				...
				LA10: ;
				info = msgcontext_183055->data[i_184053];
				res_184062 += ((NI) 1);
			} LA3: ;
		}
	}
...
N_NOINLINE(void, raiserecoverableerror_182969)(NimStringDesc* msg) {
	erecoverableerror182344* e_182974;
	NimStringDesc* LOC1;
	e_182974 = 0;
	e_182974 = (erecoverableerror182344*) newObj((&NTI182975), sizeof(erecoverableerror182344));
	(*e_182974).Sup.Sup.Sup.m_type = (&NTI182344);
	LOC1 = 0;
	LOC1 = (*e_182974).Sup.Sup.message; (*e_182974).Sup.Sup.message = copyStringRC1(msg);
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_182974, "ERecoverableError");
}
...
N_NIMCALL(void, handleerror_183876)(NU16 msg, NU8 eh, NimStringDesc* s) {
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			if (!LOC9) goto LA13;
			{
				...
				if (!(LOC17)) goto LA18;
				LOC17 = writelnhook_183064.ClPrc == 0;
				LA18: ;
				if (!LOC17) goto LA19;
...
appendString(LOC22, ((NimStringDesc*) &TMP431));
	...
	LA5: ;
	{
		...
		LA26: ;
		if (!LOC25) goto LA27;
		gerrorcounter_183015 += ((NI) 1);
		gexitcode_171129 = ((NI8) 1);
		{
			if (!(gerrormax_183018 <= gerrorcounter_183015)) goto LA31;
			{
				NIM_BOOL LOC35;
				NIM_BOOL LOC36;
				LOC35 = 0;
				...
				if (!LOC35) goto LA39;
				{
					...
					if (!(LOC43)) goto LA44;
					LOC43 = writelnhook_183064.ClPrc == 0;
					LA44: ;
					if (!LOC43) goto LA45;
					writestacktrace_16207();
				}
		...
		LA31: ;
		{
			...
			if (!LOC50) goto LA52;
			{
				...
				if (!LOC56) goto LA60;
				{
					...
					if (!(LOC64)) goto LA65;
					LOC64 = writelnhook_183064.ClPrc == 0;
					LA65: ;
					if (!LOC64) goto LA66;
					writestacktrace_16207();
				}
...
appendString(LOC69, ((NimStringDesc*) &TMP431));
		...
		LA52: ;
		{
			...
			raiserecoverableerror_182969(s);
		}
		goto LA29;
		LA71: ;
		LA29: ;
...
{	frmt = 0;
	...
	case ((NU16) 230) ... ((NU16) 260):
	{
		...
		LA6: ;
		{
			if (!!(((gnotes_183014 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0))) goto LA10;
			goto BeforeRet;
		}
		LA10: ;
	...
	case ((NU16) 261) ... ((NU16) 277):
	{
		...
		LA16: ;
		{
			if (!!(((gnotes_183014 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0))) goto LA20;
			goto BeforeRet;
		}
		LA20: ;
		frmt = copyString(((NimStringDesc*) &TMP429));
		ghintcounter_183016 += ((NI) 1);
	}
	break;
	}
	LOC22 = 0;
		...
		if (TMP1054.status == 0) {
			{
				...
				line_184521 = 0;
				HEX3Atmp_184557 = 0;
				HEX3Atmp_184557 = tofullpath_183443(i.Fileindex);
...
N_NIMCALL(void, limessage_184232)(tlineinfo182338 info, NU16 msg, NimStringDesc* arg, NU8 eh) {
	...
	case ((NU16) 230) ... ((NU16) 260):
	{
		...
		if (LOC3) goto LA4;
		LOC3 = !(((gnotes_183014 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0));
		LA4: ;
		ignoremsg = LOC3;
		{
	...
	case ((NU16) 261) ... ((NU16) 277):
	{
		...
		if (LOC10) goto LA11;
		LOC10 = !(((gnotes_183014 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0));
		LA11: ;
		ignoremsg = LOC10;
...
N_NIMCALL(void, suggestwriteln_183082)(NimStringDesc* s) {
	{
		if (!((erroroutputs_183060 &(1<<((((NU8) 0))&7)))!=0)) goto LA3;
		{
			TY183780 LOC9;
			if (!writelnhook_183064.ClPrc == 0) goto LA7;
		...
		LA7: ;
		{
			writelnhook_183064.ClEnv? writelnhook_183064.ClPrc(s, writelnhook_183064.ClEnv):((TMP2011)(writelnhook_183064.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
	{
		if (!((erroroutputs_183060 &(1<<((((NU8) 2))&7)))!=0)) goto LA13;
		safeadd_183127((&bufferedmsgs_183058), s);
	}
	LA13: ;
}
...
N_NIMCALL(void, pushinfocontext_183359)(tlineinfo182338 info) {
	msgcontext_183055 = (TY183036*) incrSeq(&(msgcontext_183055)->Sup, sizeof(tlineinfo182338));
	msgcontext_183055->data[msgcontext_183055->Sup.len-1] = info;
}

N_NIMCALL(void, popinfocontext_183378)(void) {
	msgcontext_183055 = (TY183036*) setLengthSeq(&(msgcontext_183055)->Sup, sizeof(tlineinfo182338), (NI64)(msgcontext_183055->Sup.len - ((NI) 1)));
}

N_NIMCALL(void, clearbufferedmsgs_183074)(void) {
	genericSeqAssign((&bufferedmsgs_183058), NIM_NIL, (&NTI122008));
}
N_NIMCALL(void, TMP2731)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_183292)(void) {
	esuggestdone182346* e_183296;
	NimStringDesc* LOC1;
	e_183296 = 0;
	e_183296 = (esuggestdone182346*) newObj((&NTI183297), sizeof(esuggestdone182346));
	(*e_183296).Sup.Sup.m_type = (&NTI182346);
	LOC1 = 0;
	LOC1 = (*e_183296).Sup.message; (*e_183296).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2732));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_183296, "ESuggestDone");
}
...
N_NIMCALL(tlineinfo182338, getinfocontext_183404)(NI index) {
	...
	LA1: ;
	{
		...
		result = unknownlineinfo_183027();
	}
	goto LA6;
	LA8: ;
	{
		result = msgcontext_183055->data[i];
	}
	LA6: ;
	return result;
}
...
N_NIMCALL(NI, getinfocontextlen_183323)(void) {
	NI result;
{	result = 0;
	result = msgcontext_183055->Sup.len;
	goto BeforeRet;
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, setinfocontextlen_183340)(NI l) {
	msgcontext_183055 = (TY183036*) setLengthSeq(&(msgcontext_183055)->Sup, sizeof(tlineinfo182338), l);
}
...
NIM_EXTERNC N_NOINLINE(void, compiler_msgsInit)(void) {
	...
	gcmdlineinfo_182924 = newlineinfo_182869(((NI32) 0), ((NI) 1), ((NI) 1));
	memset((void*)(&LOC2), 0, sizeof(LOC2));
	...
	gcodegenlineinfo_182962 = newlineinfo_182869(((NI32) 1), ((NI) 1), ((NI) 1));
	gnotes_183014 = IL64(281474927951871);
	gerrorcounter_183015 = ((NI) 0);
	ghintcounter_183016 = ((NI) 0);
	gwarncounter_183017 = ((NI) 0);
	gerrormax_183018 = ((NI) 1);
	if (msgcontext_183055) nimGCunrefNoCycle(msgcontext_183055);
	msgcontext_183055 = (TY183036*) newSeqRC1((&NTI183036), 0);
	lasterror_183056 = unknownlineinfo_183027();
	erroroutputs_183060 = 3;
...
NTI183036.size = sizeof(TY183036*);
NTI183036.kind = 24;
NTI183036.base = (&NTI182338);
NTI183036.flags = 2;
NTI183036.marker = TMP144;
NTI182344.size = sizeof(erecoverableerror182344);
NTI182344.kind = 17;
NTI182344.base = (&NTI3449);
TMP21[11].len = 0; TMP21[11].kind = 2;
NTI182344.node = &TMP21[11];
NTI182975.size = sizeof(erecoverableerror182344*);
NTI182975.kind = 22;
NTI182975.base = (&NTI182344);
NTI182975.marker = TMP432;
...
NTI183297.size = sizeof(esuggestdone182346*);
NTI183297.kind = 22;
NTI183297.base = (&NTI182346);
NTI183297.marker = TMP2731;
}
