...
N_NIMCALL(void, suggestwriteln_183187)(NimStringDesc* s) {
	{
		...
		LA7: ;
		{
			writelnhook_183169.ClEnv? writelnhook_183169.ClPrc(s, writelnhook_183169.ClEnv):((TMP1993)(writelnhook_183169.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, clearbufferedmsgs_183179)(void) {
	genericSeqAssign((&bufferedmsgs_183163), NIM_NIL, (&NTI121608));
}
N_NIMCALL(void, TMP2710)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_183446)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_183450).Sup.message; (*e_183450).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2711));
	if (LOC1) nimGCunrefNoCycle(LOC1);
