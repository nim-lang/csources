...
N_NIMCALL(void, processimplicits_246510)(TY10665* implicits, NU8 nodekind, tpasscontext246003** a) {
	...
	while (1) {
		...
		importstmt = newnodei_188109(nodekind, gcmdlineinfo_164103);
		nimln(158, "passes.nim");
		str = newstrnode_188095(((NU8) 20), module_246529);
		nimln(159, "passes.nim");
		(*str).Info = gcmdlineinfo_164103;
...
N_NIMCALL(void, processmodule_246049)(tsym187843* module, tllstream175204* stream, trodreader236024* rd) {
	...
	LA3: ;
	{
		...
		HEX3Atmp_246675 = (NI64)(TMP3178);
		nimln(1450, "system.nim");
		res_246677 = 0;
		nimln(1451, "system.nim");
		while (1) {
			nimln(1451, "system.nim");
			if (!(res_246677 <= HEX3Atmp_246675)) goto LA35;
			nimln(1450, "system.nim");
			i_246655 = res_246677;
			nimln(203, "passes.nim");
			if (((TMP3169[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3170));
			...
			nimln(1453, "system.nim");
			res_246677 = addInt(res_246677, 1);
		} LA35: ;
