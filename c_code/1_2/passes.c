...
static NIM_CONST TY192025 TMP3170 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3171, "sons", 4);
STRING_LITERAL(TMP3178, "(len|len|len|len|len|len)(a) (==|==|==|==|==|==|==|==|==|==|==|"
...
N_NIMCALL(NIM_BOOL, astneeded_250081)(tsym191843* s) {
	...
	nimln(73, "passes.nim");
	{
		...
		if (!(LOC3)) goto LA8;
		nimln(76, "passes.nim");
		if (((TMP3170[(*(*s).Ast).Kind/8] &(1<<((*(*s).Ast).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3171));
...
N_NIMCALL(void, openpasses_250277)(tpasscontext250003** a, tsym191843* module) {
	...
	nimln(112, "passes.nim");
	TMP3172 = subInt(gpasseslen_250179, 1);
	HEX3Atmp_250302 = (NI64)(TMP3172);
...
N_NIMCALL(void, processimplicits_250510)(TY10865* implicits, NU8 nodekind, tpasscontext250003** a) {
	...
	while (1) {
		...
		nimln(2798, "system.nim");
		{
			...
			nimln(2798, "system.nim");
			failedassertimpl_81621(((NimStringDesc*) &TMP3178));
		}
		LA9: ;
	} LA1: ;
	popFrame();
...
N_NIMCALL(void, processmodule_250049)(tsym191843* module, tllstream179204* stream, trodreader240024* rd) {
	...
	LA3: ;
	{
		...
		TMP3179 = subInt(LOC34, 1);
		HEX3Atmp_250675 = (NI64)(TMP3179);
		nimln(1451, "system.nim");
		res_250677 = 0;
		nimln(1452, "system.nim");
		while (1) {
...
static TNimNode TMP3105[1];
NTI250003.size = sizeof(tpasscontext250003);
NTI250003.kind = 17;
NTI250003.base = (&NTI2409);
NTI250003.flags = 1;
TMP3105[0].kind = 1;
TMP3105[0].offset = offsetof(tpasscontext250003, Fromcache);
TMP3105[0].typ = (&NTI134);
TMP3105[0].name = "fromCache";
NTI250003.node = &TMP3105[0];
}
