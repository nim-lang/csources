		...
		{
			{
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					HEX3Atmp_237226 = (NI64)(LOC26 - ((NI) 1));
					res_237229 = ((NI) 0);
					{
						while (1) {
...
{	result = 0;
	{
		...
		HEX3Atmp_237050 = (NI64)(LOC2 - ((NI) 1));
		res_237053 = ((NI) 0);
		{
			while (1) {
...
{	result = 0;
	...
	addson_211819(s, n);
	{
		if (!!(((*n).Kind >= ((NU8) 1) && (*n).Kind <= ((NU8) 23)))) goto LA12;
		{
			...
			HEX3Atmp_237116 = (NI64)(LOC15 - ((NI) 1));
			res_237119 = ((NI) 0);
			{
				while (1) {
...
N_NIMCALL(tnode209813*, extractrange_237770)(NU8 k, tnode209813* n, NI a, NI b) {
	tnode209813* result;
	result = 0;
	result = newnodei_211407(k, (*n).Info, (NI64)((NI64)(b - a) + ((NI) 1)));
	{
		NI i_237787;
		NI HEX3Atmp_237791;
		NI res_237794;
		i_237787 = 0;
		HEX3Atmp_237791 = 0;
		HEX3Atmp_237791 = (NI64)(b - a);
		res_237794 = ((NI) 0);
		{
			while (1) {
				if (!(res_237794 <= HEX3Atmp_237791)) goto LA3;
				i_237787 = res_237794;
				asgnRefNoCycle((void**) (&(*result).kindU.S6.Sons->data[i_237787]), (*n).kindU.S6.Sons->data[(NI64)(i_237787 + a)]);
				res_237794 += ((NI) 1);
			} LA3: ;
		}
	}
