...
N_NIMCALL(NimStringDesc*, nosextractFilename)(NimStringDesc* path) {
	...
	result = 0;
	{
		...
		if (LOC3) goto LA4;
		LOC3 = (((NU8)(path->data[(NI64)(path->Sup.len - ((NI) 1))])) == ((NU8)(92)) || ((NU8)(path->data[(NI64)(path->Sup.len - ((NI) 1))])) == ((NU8)(47)));
		LA4: ;
		if (!LOC3) goto LA5;
				...
				while (1) {
					...
					i_117819 = res_117846;
					{
						if (!((NU8)(path->data[i_117819]) == (NU8)(46))) goto LA13;
						{
							...
							LOC17 = LOC18;
							if (!(LOC17)) goto LA20;
							LOC17 = !((((NU8)(path->data[(NI64)(i_117819 - ((NI) 1))])) == ((NU8)(92)) || ((NU8)(path->data[(NI64)(i_117819 - ((NI) 1))])) == ((NU8)(47))));
							LA20: ;
							if (!LOC17) goto LA21;
							dotpos = i_117819;
						}
...
N_NIMCALL(NimStringDesc*, nosjoinPath)(NimStringDesc* head, NimStringDesc* tail) {
	...
	LA3: ;
	{
		if (!(((NU8)(head->data[(NI64)(head->Sup.len - ((NI) 1))])) == ((NU8)(92)) || ((NU8)(head->data[(NI64)(head->Sup.len - ((NI) 1))])) == ((NU8)(47)))) goto LA6;
		{
			NimStringDesc* LOC12;
			NimStringDesc* LOC13;
...
N_NIMCALL(void, noscreateDir)(NimStringDesc* dir) {
	...
	omitnext = nosisAbsolute(dir);
	{
		...
		i_124611 = 0;
		HEX3Atmp_124624 = 0;
		HEX3Atmp_124624 = (NI64)(dir->Sup.len - ((NI) 1));
		res_124627 = ((NI) 1);
		{
			while (1) {
				...
				i_124611 = res_124627;
				{
					...
					LA10: ;
					{
						NimStringDesc* LOC13;
						LOC13 = 0;
						LOC13 = copyStrLast(dir, ((NI) 0), (NI64)(i_124611 - ((NI) 1)));
					...
					case 92:
					{
						...
						}
						{
							if (!((NU8)(c->data[j]) == (NU8)(34))) goto LA23;
							{
								...
								k_125622 = 0;
								HEX3Atmp_125684 = 0;
								HEX3Atmp_125684 = (NI64)((NI64)(j - i) / ((NI) 2));
								res_125687 = ((NI) 1);
								{
									while (1) {
							...
							{
								if (!(((NI) ((NI64)((NI64)(j - i) % ((NI) 2)))) == ((NI) 0))) goto LA30;
								i = j;
							}
							goto LA28;
							LA30: ;
...
N_NIMCALL(NI, nosparamCount)(void) {
	...
	LA3: ;
	result = (NI64)(ownargv_126609->Sup.len - ((NI) 1));
	return result;
}
	...
	i = start;
	{
		while (1) {
			if (!(i < path->Sup.len)) goto LA18;
			{
				...
				if (!(LOC22)) goto LA23;
				LOC22 = ((NU8)(path->data[(NI64)(i + ((NI) 1))]) == (NU8)(46));
				LA23: ;
				LOC21 = LOC22;
				if (!(LOC21)) goto LA24;
				LOC21 = ((NU8)(path->data[(NI64)(i + ((NI) 2))]) == (NU8)(47));
				LA24: ;
				if (!LOC21) goto LA25;
...
{	result = 0;
	i = findenvvar_122804(key);
	{
		...
		result = copyStr(environment_122009->data[i], (NI64)(LOC5 + ((NI) 1)));
		goto BeforeRet;
	}
	goto LA1;
	LA3: ;
...
N_NIMCALL(NimStringDesc*, expandtilde_128447)(NimStringDesc* path) {
	...
	result = 0;
	{
		...
		LOC11 = 0;
		LOC11 = nosgetHomeDir();
		LOC12 = HEX2EHEX2E_108273(((NI) 2), (NI64)(path->Sup.len - ((NI) 1)));
		LOC13 = 0;
		...
		last_128423 = ((NI) 0);
		{
			if (!(((NI) 0) < path->Sup.len)) goto LA9;
			{
				while (1) {
					...
					candidate_128416 = copyStrLast(path, first_128425, (NI64)(last_128423 - ((NI) 1)));
