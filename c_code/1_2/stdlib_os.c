...
N_NIMCALL(void, nossplitPath)(NimStringDesc* path, keyvaluepair134008* Result) {
	...
	seppos = -1;
	{
		...
		i_117531 = 0;
		HEX3Atmp_117547 = 0;
		HEX3Atmp_117547 = (NI64)(path->Sup.len - 1);
...
N_NIMCALL(NI, searchextpos_117751)(NimStringDesc* s) {
	...
	result = -1;
	{
		...
		i_117766 = 0;
		HEX3Atmp_117782 = 0;
		HEX3Atmp_117782 = (NI64)(s->Sup.len - 1);
...
N_NIMCALL(void, nossplitFile)(NimStringDesc* path, TY117804* Result) {
	...
	LA5: ;
	{
		...
		dotpos = path->Sup.len;
		{
			...
			i_117837 = 0;
			HEX3Atmp_117868 = 0;
			HEX3Atmp_117868 = (NI64)(path->Sup.len - 1);
				...
				while (1) {
					...
					i_117837 = res_117871;
					{
						if (!((NU8)(path->data[i_117837]) == (NU8)(46))) goto LA13;
						{
							...
							LOC17 = LOC18;
							if (!(LOC17)) goto LA20;
							LOC17 = !((((NU8)(path->data[(NI64)(i_117837 - 1)])) == ((NU8)(92)) || ((NU8)(path->data[(NI64)(i_117837 - 1)])) == ((NU8)(47))));
							LA20: ;
							if (!LOC17) goto LA21;
							dotpos = i_117837;
						}
...
{	result = 0;
	...
	LA5: ;
	{
		...
		i_117596 = 0;
		HEX3Atmp_117612 = 0;
		HEX3Atmp_117612 = (NI64)(path->Sup.len - q);
...
N_NIMCALL(void, noscreateDir)(NimStringDesc* dir) {
	...
	omitnext = nosisAbsolute(dir);
	{
		...
		i_124211 = 0;
		HEX3Atmp_124227 = 0;
		HEX3Atmp_124227 = (NI64)(dir->Sup.len - 1);
		res_124230 = 1;
		{
			while (1) {
				...
				i_124211 = res_124230;
				{
					...
					LA10: ;
					{
						NimStringDesc* LOC13;
						LOC13 = 0;
						LOC13 = copyStrLast(dir, 0, (NI64)(i_124211 - 1));
					...
					case 92:
					{
						...
						}
						{
							if (!((NU8)(c->data[j]) == (NU8)(34))) goto LA23;
							{
								...
								k_125225 = 0;
								HEX3Atmp_125310 = 0;
								HEX3Atmp_125310 = (NI64)((NI64)(j - i) / 2);
								res_125313 = 1;
								{
									while (1) {
...
N_NIMCALL(NI, nosparamCount)(void) {
	...
	LA3: ;
	result = (NI64)(ownargv_126209->Sup.len - 1);
	return result;
}
...
{	result = 0;
	i = findenvvar_122404(key);
	{
		...
		result = copyStr(environment_121609->data[i], (NI64)(LOC5 + 1));
		goto BeforeRet;
	}
	goto LA1;
	LA3: ;
...
N_NIMCALL(NimStringDesc*, expandtilde_128047)(NimStringDesc* path) {
	...
	result = 0;
	{
		...
		LOC11 = 0;
		LOC11 = nosgetHomeDir();
		LOC12 = HEX2EHEX2E_109274(2, (NI64)(path->Sup.len - 1));
		LOC13 = 0;
		...
		last_128023 = 0;
		{
			if (!(0 < path->Sup.len)) goto LA9;
			{
				while (1) {
					...
					candidate_128016 = copyStrLast(path, first_128025, (NI64)(last_128023 - 1));
