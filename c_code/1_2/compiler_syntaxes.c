...
STRING_LITERAL(TMP1331, "none", 4);
STRING_LITERAL(TMP1332, "stdtmpl", 7);
STRING_LITERAL(TMP1333, "replace", 7);
STRING_LITERAL(TMP1334, "strip", 5);
NIM_CONST TY241026 filternames_241025 = {((NimStringDesc*) &TMP1331),
((NimStringDesc*) &TMP1332),
((NimStringDesc*) &TMP1333),
((NimStringDesc*) &TMP1334)}
;
STRING_LITERAL(TMP1335, "standard", 8);
STRING_LITERAL(TMP1336, "strongspaces", 12);
STRING_LITERAL(TMP1337, "braces", 6);
STRING_LITERAL(TMP1338, "endx", 4);
NIM_CONST TY241020 parsernames_241019 = {((NimStringDesc*) &TMP1335),
((NimStringDesc*) &TMP1336),
((NimStringDesc*) &TMP1337),
((NimStringDesc*) &TMP1338)}
;
STRING_LITERAL(TMP1369, "parser to implement", 19);
...
{	result = 0;
	...
	LA3: ;
	{
		...
		LOC7 = LOC8;
		if (!(LOC7)) goto LA10;
		LOC7 = identeq_186493((*(*n).kindU.S6.Sons->data[0]).kindU.S5.Ident, ((NimStringDesc*) &TMP1221));
		LA10: ;
		if (!LOC7) goto LA11;
		{
			NI i_241544;
...
N_NIMCALL(tnode210818*, parseall_241063)(tparsers241035* p) {
	...
	case ((NU8) 3):
	{
		internalerror_184688(((NimStringDesc*) &TMP1369));
		result = emptynode_211686;
	}
	break;
	}
...
static TNimNode* TMP1017[4];
NI TMP1019;
static char* NIM_CONST TMP1018[4] = {
"skinStandard", 
"skinStrongSpaces", 
"skinBraces", 
"skinEndX"};
...
NTI241007.base = 0;
NTI241007.flags = 3;
for (TMP1019 = 0; TMP1019 < 4; TMP1019++) {
TMP798[TMP1019+2].kind = 1;
TMP798[TMP1019+2].offset = TMP1019;
TMP798[TMP1019+2].name = TMP1018[TMP1019];
TMP1017[TMP1019] = &TMP798[TMP1019+2];
}
TMP798[6].len = 4; TMP798[6].kind = 2; TMP798[6].sons = &TMP1017[0];
...
TMP798[0].len = 2; TMP798[0].kind = 2; TMP798[0].sons = &TMP1016[0];
