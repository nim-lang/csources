...
N_NIMCALL(void, enlarge_182675)(table182376* t) {
	...
	n = 0;
	n = (keyvaluepairseq182379*) newSeq((&NTI182379), (NI64)((*t).Data->Sup.len * ((NI) 2)));
	LOC1 = 0;
	LOC1 = (*t).Data;
...
N_NIMCALL(void, enlarge_329185)(table328052* t) {
	...
	n = 0;
	n = (keyvaluepairseq328055*) newSeq((&NTI328055), (NI64)((*t).Data->Sup.len * ((NI) 2)));
	LOC1 = 0;
	LOC1 = (*t).Data;
	unsureAsgnRef((void**) (&(*t).Data), n);
	n = LOC1;
...
N_NIMCALL(void, enlarge_332109)(table329411* t) {
	...
	n = 0;
	n = (keyvaluepairseq329414*) newSeq((&NTI329414), (NI64)((*t).Data->Sup.len * ((NI) 2)));
	LOC1 = 0;
	LOC1 = (*t).Data;
	unsureAsgnRef((void**) (&(*t).Data), n);
	n = LOC1;
