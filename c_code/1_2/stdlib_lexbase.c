...
N_NIMCALL(void, fillbuffer_282084)(tbaselexer282029* l) {
	...
	nimln(80, "lexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP3617)])), (NI64)(TMP3618));
	}
	LA11: ;
	...
	TMP3620 = mulInt((NI64)(TMP3619), 1);
	LOC13 = 0;
	LOC13 = readdata_126733((*l).Input, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP3620));
	TMP3621 = divInt(LOC13, 1);
	charsread = (NI64)(TMP3621);
	...
	nimln(86, "lexbase.nim");
	{
		...
		if (!(charsread < (NI64)(TMP3623))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI64)(TMP3625);
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				TMP3626 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4631(((void*) ((*l).Buf)), (NI64)(TMP3626));
				...
				nimln(105, "lexbase.nim");
				{
					...
					if (!!(((NI64)(TMP3627) == oldbuflen))) goto LA35;
					nimln(105, "lexbase.nim");
				...
				LOC37 = 0;
				LOC37 = readdata_126733((*l).Input, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP3629));
				TMP3630 = divInt(LOC37, 1);
				charsread = (NI64)(TMP3630);
...
N_NIMCALL(void, open_282039)(tbaselexer282029* l, tstream126629* input, NI buflen) {
	...
	LOC9 = 0;
	LOC9 = alloc_4601((NI64)(TMP3640));
	(*l).Buf = ((NCSTRING) (LOC9));
	nimln(148, "lexbase.nim");
	nimln(148, "lexbase.nim");
	TMP3641 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP3641);
...
N_NIMCALL(NI, getcolnumber_282057)(tbaselexer282029* l, NI pos) {
	...
	if ((NI64)(TMP3642) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP3642));
	popFrame();
	return result;
}
