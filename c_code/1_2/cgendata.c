...
static N_INLINE(trope148007**, s_470173)(tcproc470026* p, NU8 s) {
	...
	if ((NU)((NI64)(TMP6215)) >= (NU)((*p).Blocks->Sup.len)) raiseIndexError();
	result = &(*p).Blocks->data[(NI64)(TMP6215)].Sections[(s)- 0];
	popFrame();
	return result;
}
