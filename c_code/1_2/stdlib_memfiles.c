...
extern tyProc_rQv4HdT3JZB1EnhSb4r4Gg Dl_129624_;
extern tyProc_N3uS69bw8S7evCEnH5Rc6Mg Dl_129616_;
extern tyProc_I8CYTKrqz0DV8EyysIRhJw Dl_129611_;
extern tyProc_ah5wcFv3UG20t2vgXBy0Fg Dl_129801_;
...
N_NIMCALL(tyObject_MemFile_j4SnXNrJDFBxAz4BlbM9aIQ, open_39cFdhV3oLaZ6GpD2Bd26ew)(NimStringDesc* filename, tyEnum_FileMode_fVUBHvW79bXUw1j55Oo9avSQ mode, NI mappedSize, NI offset, NI newFileSize, NIM_BOOL allowRemap) {
	tyObject_MemFile_j4SnXNrJDFBxAz4BlbM9aIQ result;
	NIM_BOOL readonly;
	NI16* T1_;
	NI32 T2_;
	NI32 T8_;
	...
	readonly = (mode == ((tyEnum_FileMode_fVUBHvW79bXUw1j55Oo9avSQ) 0));
	T1_ = (NI16*)0;
	...
	result.fHandle = Dl_129423_(T1_, T2_, ((NI32) 1), NIM_NIL, T8_, T14_, ((NI) 0));
	{
		...
		LA31_: ;
		T34_ = (NI32)0;
		T34_ = osLastError_9bdZBDTfBOjOcVVodbA2otw();
		raiseOSError_bEwAamo1N7TKcaU9akpiyIg(T34_, ((NimStringDesc*) &TM_mFfhe8Jm7Jqn2Znr3841fw_3));
	}
	LA22_: ;
	{
		NI32 sizeHigh;
		...
		lastErr = osLastError_9bdZBDTfBOjOcVVodbA2otw();
		{
			...
			LA55_: ;
			raiseOSError_bEwAamo1N7TKcaU9akpiyIg(lastErr, ((NimStringDesc*) &TM_mFfhe8Jm7Jqn2Znr3841fw_3));
		}
		LA46_: ;
	}
	LA37_: ;
	...
	result.mapHandle = Dl_129624_(result.fHandle, NIM_NIL, T58_, ((NI32) 0), ((NI32) 0), NIM_NIL);
	{
		...
		LA75_: ;
		T78_ = (NI32)0;
		T78_ = osLastError_9bdZBDTfBOjOcVVodbA2otw();
		raiseOSError_bEwAamo1N7TKcaU9akpiyIg(T78_, ((NimStringDesc*) &TM_mFfhe8Jm7Jqn2Znr3841fw_3));
	}
	LA66_: ;
	T79_ = (NI32)0;
	{
	...
	LA86_: ;
	result.mem = Dl_129616_(result.mapHandle, T79_, ((NI32) ((NI)((NU64)(offset) >> (NU64)(((NI) 32))))), ((NI32) ((NI64)(((NI64) (offset)) & IL64(4294967295)))), ((NI32) (T85_)), NIM_NIL);
	{
		NI32 T105_;
		...
		LA102_: ;
		T105_ = (NI32)0;
		T105_ = osLastError_9bdZBDTfBOjOcVVodbA2otw();
		raiseOSError_bEwAamo1N7TKcaU9akpiyIg(T105_, ((NimStringDesc*) &TM_mFfhe8Jm7Jqn2Znr3841fw_3));
	}
	LA93_: ;
	hi = (NI32)0;
	low = (NI32)0;
	low = Dl_129611_(result.fHandle, (&hi));
	{
		...
		LA117_: ;
		T120_ = (NI32)0;
		T120_ = osLastError_9bdZBDTfBOjOcVVodbA2otw();
		raiseOSError_bEwAamo1N7TKcaU9akpiyIg(T120_, ((NimStringDesc*) &TM_mFfhe8Jm7Jqn2Znr3841fw_3));
	}
	goto LA106_;
	LA108_: ;
	{
