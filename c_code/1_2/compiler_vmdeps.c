...
N_NIMCALL(NimStringDesc*, readoutput_414009)(processobj143402* p);
...
STRING_LITERAL(TMP2874, "", 0);
STRING_LITERAL(TMP2881, "\015\012", 2);
...
N_NIMCALL(NimStringDesc*, readoutput_414009)(processobj143402* p) {
	...
	output = nospoutputStream(p);
	{
		while (1) {
			...
			NimStringDesc* LOC4;
			LOC3 = 0;
			LOC3 = atend_138119(output);
			if (!!(LOC3)) goto LA2;
			LOC4 = 0;
			LOC4 = readline_138564(output);
...
N_NIMCALL(NimStringDesc*, opgorge_414027)(NimStringDesc* cmd, NimStringDesc* input) {
	...
	processobj143402* p;
	result = 0;
	p = startcmd_143644(cmd, 10);
	{
		streamobj138035* LOC5;
		streamobj138035* LOC6;
		if (!!((input->Sup.len == 0))) goto LA3;
		LOC5 = 0;
		LOC5 = nospinputStream(p);
		write_138241(LOC5, input);
		LOC6 = 0;
