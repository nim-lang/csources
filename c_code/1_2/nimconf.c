...
N_NIMCALL(void, parsedirective_220368)(tlexer215186* l, ttoken215184* tok) {
	...
	{
		NIM_BOOL res;
		condstack_220191 = (TY220170*) setLengthSeq(&(condstack_220191)->Sup, sizeof(NIM_BOOL), (NI64)(condstack_220191->Sup.len + 1));
		res = evalppif_220148(l, tok);
			...
			{
				{
					...
					i_220876 = 0;
					HEX3Atmp_220878 = 0;
					HEX3Atmp_220878 = (NI64)(pd->Sup.len - 2);
					res_220880 = 0;
					{
						while (1) {
							...
							i_220876 = res_220880;
							{
								...
								LOC60 = (i_220876 == 0);
								if (LOC60) goto LA61;
								LOC60 = !((((NU8)(pd->data[(NI64)(i_220876 - 1)])) == ((NU8)(92)) || ((NU8)(pd->data[(NI64)(i_220876 - 1)])) == ((NU8)(47))));
								LA61: ;
								LOC58 = LOC60;
								LA59: ;
								if (!LOC58) goto LA62;
