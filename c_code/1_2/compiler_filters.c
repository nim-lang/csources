...
N_NIMCALL(void, invalidpragma_197036)(tnode173659* n);
...
N_NIMCALL(tnode173659*, getarg_197042)(tnode173659* n, NimStringDesc* name, NI pos);
...
N_NIMCALL(NIM_BOOL, boolarg_197028)(tnode173659* n, NimStringDesc* name, NI pos, NIM_BOOL default_197033);
...
N_NIMCALL(tnode173659*, getarg_197042)(tnode173659* n, NimStringDesc* name, NI pos) {
	...
	HEX3Atmp_197184 = (NI64)(TMP2569);
	nimln(1301, "system.nim");
	res_197186 = 1;
	nimln(1302, "system.nim");
	while (1) {
		nimln(1302, "system.nim");
		if (!(res_197186 <= HEX3Atmp_197184)) goto LA6;
		nimln(1301, "system.nim");
		i_197068 = res_197186;
		nimln(31, "filters.nim");
		{
			nimln(31, "filters.nim");
			if (((TMP2567[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2568));
			if ((NU)(i_197068) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!((*(*n).kindU.S6.Sons->data[i_197068]).Kind == ((NU8) 33))) goto LA9;
			nimln(32, "filters.nim");
			{
				...
				if (((TMP2567[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2568));
				if ((NU)(i_197068) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP2567[(*(*n).kindU.S6.Sons->data[i_197068]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_197068]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2568));
				if ((NU)(0) >= (NU)((*(*n).kindU.S6.Sons->data[i_197068]).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (!!(((*(*(*n).kindU.S6.Sons->data[i_197068]).kindU.S6.Sons->data[0]).Kind == ((NU8) 2)))) goto LA13;
				nimln(32, "filters.nim");
				invalidpragma_197036(n);			}			LA13: ;
			nimln(33, "filters.nim");
			{
				...
				if (((TMP2567[(*(*n).kindU.S6.Sons->data[i_197068]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_197068]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2568));
				if ((NU)(0) >= (NU)((*(*n).kindU.S6.Sons->data[i_197068]).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (!(((TMP2570[(*(*(*n).kindU.S6.Sons->data[i_197068]).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*(*n).kindU.S6.Sons->data[i_197068]).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2571));
				LOC17 = 0;
				LOC17 = identeq_141456((*(*(*n).kindU.S6.Sons->data[i_197068]).kindU.S6.Sons->data[0]).kindU.S5.Ident, name);
				if (!LOC17) goto LA18;
				...
				if ((NU)(i_197068) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP2567[(*(*n).kindU.S6.Sons->data[i_197068]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_197068]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2568));
				if ((NU)(1) >= (NU)((*(*n).kindU.S6.Sons->data[i_197068]).kindU.S6.Sons->Sup.len)) raiseIndexError();
				result = (*(*n).kindU.S6.Sons->data[i_197068]).kindU.S6.Sons->data[1];
				goto BeforeRet;
			}			LA18: ;
		}		goto LA7;
		LA9: ;
		{
			...
			if (!(i_197068 == pos)) goto LA21;
			nimln(36, "filters.nim");
			nimln(36, "filters.nim");
			if (((TMP2567[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2568));
			if ((NU)(i_197068) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			result = (*n).kindU.S6.Sons->data[i_197068];
			goto BeforeRet;
		}		goto LA7;
		LA21: ;
		LA7: ;
		nimln(1304, "system.nim");
		res_197186 = addInt(res_197186, 1);
	} LA6: ;
	BeforeRet: ;	popFrame();
	return result;
}
...
N_NIMCALL(NIM_CHAR, chararg_197014)(tnode173659* n, NimStringDesc* name, NI pos, NIM_CHAR default_197019) {
	...
	x = getarg_197042(n, name, pos);
	nimln(40, "filters.nim");
	{
		nimln(40, "filters.nim");
		if (!(x == NIM_NIL)) goto LA3;
		nimln(40, "filters.nim");
		result = default_197019;
	}	goto LA1;
	LA3: ;
	{
...
N_NIMCALL(NimStringDesc*, strarg_197021)(tnode173659* n, NimStringDesc* name, NI pos, NimStringDesc* default_197026) {
	...
	nimln(46, "filters.nim");
	{
		...
		if (!(x == NIM_NIL)) goto LA3;
		nimln(46, "filters.nim");
		result = copyString(default_197026);
	}	goto LA1;
	LA3: ;
	{
		nimln(730, "system.nim");
...
N_NIMCALL(NIM_BOOL, boolarg_197028)(tnode173659* n, NimStringDesc* name, NI pos, NIM_BOOL default_197033) {
	...
	LA3: ;
	{
		...
		LOC6 = identeq_141456((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2576));
		LA7: ;
		if (!LOC6) goto LA8;
		nimln(53, "filters.nim");
		result = NIM_TRUE;
	...
	LA8: ;
	{
		...
		nimln(54, "filters.nim");
		if (!(((TMP2570[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2571));
		LOC11 = identeq_141456((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2577));
		LA12: ;
		if (!LOC11) goto LA13;
		nimln(54, "filters.nim");
		result = NIM_FALSE;
...
N_NIMCALL(tllstream163204*, filterstrip_197008)(tllstream163204* stdin_197010, NimStringDesc* filename, tnode173659* call) {
	...
	pattern = strarg_197021(call, ((NimStringDesc*) &TMP2578), 1, ((NimStringDesc*) &TMP2579));
	nimln(59, "filters.nim");
	leading = boolarg_197028(call, ((NimStringDesc*) &TMP2580), 2, NIM_TRUE);
	nimln(60, "filters.nim");
	trailing = boolarg_197028(call, ((NimStringDesc*) &TMP2581), 3, NIM_TRUE);
	nimln(61, "filters.nim");
	result = llstreamopen_163218(((NimStringDesc*) &TMP2579));
	...
	while (1) {
		...
		nimln(63, "filters.nim");
		LOC2 = 0;
		LOC2 = llstreamreadline_163248(stdin_197010, &line);
		if (!LOC2) goto LA1;
		...
		nimln(65, "filters.nim");
		{
			...
			llstreamwriteln_163274(result, stripped);		}		goto LA3;
		LA7: ;
		{
			nimln(68, "filters.nim");
			llstreamwriteln_163274(result, line);		}		LA3: ;
	} LA1: ;
	nimln(69, "filters.nim");
	llstreamclose_163238(stdin_197010);	popFrame();
	return result;
}
N_NIMCALL(tllstream163204*, filterreplace_197002)(tllstream163204* stdin_197004, NimStringDesc* filename, tnode173659* call) {
	tllstream163204* result;
	...
	sub = strarg_197021(call, ((NimStringDesc*) &TMP2583), 1, ((NimStringDesc*) &TMP2579));
	nimln(73, "filters.nim");
	{
		...
		nimln(73, "filters.nim");
		invalidpragma_197036(call);	}	LA3: ;
	nimln(74, "filters.nim");
	by = strarg_197021(call, ((NimStringDesc*) &TMP2584), 2, ((NimStringDesc*) &TMP2579));
	...
	while (1) {
		...
		nimln(77, "filters.nim");
		LOC6 = 0;
		LOC6 = llstreamreadline_163248(stdin_197004, &line);
		if (!LOC6) goto LA5;
		nimln(78, "filters.nim");
		nimln(78, "filters.nim");
		LOC7 = 0;
		LOC7 = nsuReplaceStr(line, sub, by);
		llstreamwriteln_163274(result, LOC7);	} LA5: ;
	nimln(79, "filters.nim");
	llstreamclose_163238(stdin_197004);	popFrame();
	return result;
