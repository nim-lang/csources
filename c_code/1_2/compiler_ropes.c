...
N_NIMCALL(tyObject_RopeObj_HF4qJnb6xiOddgPmsxodtQ*, newRope_FFvNE9bTZHQQSLFPakYFt8w)(NimStringDesc* data);
...
N_NIMCALL(tyObject_RopeObj_HF4qJnb6xiOddgPmsxodtQ*, insertInCache_53CHEX05HP0HacydnwoUYg_2)(NimStringDesc* s);
...
N_NIMCALL(NIM_BOOL, equalsFile_J1CvHJJz3W7oEXSmrd5b9aA)(tyObject_RopeObj_HF4qJnb6xiOddgPmsxodtQ* r, FILE* f);
