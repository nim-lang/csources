...
N_NIMCALL(NI, parseword_528002)(NimStringDesc* s, NI i, NimStringDesc** w, TY124387 delim);
...
STRING_LITERAL(TMP7622, "", 0);
STRING_LITERAL(TMP7630, "", 0);
static NIM_CONST TY124387 TMP7631 = {
0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY124387 TMP7632 = {
...
N_NIMCALL(void, initoptparser_527819)(NimStringDesc* cmdline, toptparser527807* Result) {
	...
	LA3: ;
	{
		...
		unsureAsgnRef((void**) &(*Result).Cmd, copyString(((NimStringDesc*) &TMP7622)));
		i_527835 = 0;
		HEX3Atmp_527837 = 0;
		nimln(53, "parseopt.nim");
		HEX3Atmp_527837 = nosparamCount();
		...
		while (1) {
			...
			nimln(54, "parseopt.nim");
			LOC8 = 0;
			LOC8 = nosparamStr(i_527835);
			LOC9 = 0;
			LOC9 = quoteifcontainswhite_92237(LOC8);
...
appendChar(LOC7, 32);
	...
	unsureAsgnRef((void**) &(*Result).Key, copyString(((NimStringDesc*) &TMP7630)));
	nimln(57, "parseopt.nim");
	unsureAsgnRef((void**) &(*Result).Val, copyString(((NimStringDesc*) &TMP7630)));
	popFrame();
}
...
N_NIMCALL(void, handleshortoption_528106)(toptparser527807* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_528002((*p).Cmd, i, &(*p).Val, TMP7631);
	}
	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser527807* p) {
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_528002((*p).Cmd, i, &(*p).Key, TMP7632);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_528002((*p).Cmd, i, &(*p).Val, TMP7631);
			}
			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_528002((*p).Cmd, i, &(*p).Key, TMP7631);
	}
	break;
	}
	BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser527807* p) {
	...
	nimln(128, "parseopt.nim");
	nimln(128, "parseopt.nim");
	TMP7633 = subInt((*p).Cmd->Sup.len, 1);
	LOC1 = 0;
	LOC1 = copyStrLast((*p).Cmd, (*p).Pos, (NI64)(TMP7633));
...
static TNimNode* TMP7635[6];
static TNimNode* TMP7636[4];
NI TMP7638;
static char* NIM_CONST TMP7637[4] = {
"cmdEnd", 
"cmdArgument", 
"cmdLongoption", 
"cmdShortOption"};
static TNimNode TMP7620[12];
NTI527807.size = sizeof(toptparser527807);
NTI527807.kind = 17;
NTI527807.base = (&NTI2409);
TMP7635[0] = &TMP7620[1];
TMP7620[1].kind = 1;
TMP7620[1].offset = offsetof(toptparser527807, Cmd);
TMP7620[1].typ = (&NTI143);
TMP7620[1].name = "cmd";
TMP7635[1] = &TMP7620[2];
TMP7620[2].kind = 1;
TMP7620[2].offset = offsetof(toptparser527807, Pos);
TMP7620[2].typ = (&NTI106);
TMP7620[2].name = "pos";
TMP7635[2] = &TMP7620[3];
TMP7620[3].kind = 1;
TMP7620[3].offset = offsetof(toptparser527807, Inshortstate);
TMP7620[3].typ = (&NTI134);
TMP7620[3].name = "inShortState";
TMP7635[3] = &TMP7620[4];
NTI527805.size = sizeof(NU8);
NTI527805.kind = 14;
NTI527805.base = 0;
NTI527805.flags = 3;
for (TMP7638 = 0; TMP7638 < 4; TMP7638++) {
TMP7620[TMP7638+5].kind = 1;
TMP7620[TMP7638+5].offset = TMP7638;
TMP7620[TMP7638+5].name = TMP7637[TMP7638];
TMP7636[TMP7638] = &TMP7620[TMP7638+5];
}
TMP7620[9].len = 4; TMP7620[9].kind = 2; TMP7620[9].sons = &TMP7636[0];
NTI527805.node = &TMP7620[9];
TMP7620[4].kind = 1;
TMP7620[4].offset = offsetof(toptparser527807, Kind);
TMP7620[4].typ = (&NTI527805);
TMP7620[4].name = "kind";
TMP7635[4] = &TMP7620[10];
TMP7620[10].kind = 1;
TMP7620[10].offset = offsetof(toptparser527807, Key);
TMP7620[10].typ = (&NTI143);
TMP7620[10].name = "key";
TMP7635[5] = &TMP7620[11];
TMP7620[11].kind = 1;
TMP7620[11].offset = offsetof(toptparser527807, Val);
TMP7620[11].typ = (&NTI143);
TMP7620[11].name = "val";
TMP7620[0].len = 6; TMP7620[0].kind = 2; TMP7620[0].sons = &TMP7635[0];
NTI527807.node = &TMP7620[0];
}
