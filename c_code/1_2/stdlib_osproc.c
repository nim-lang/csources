...
N_NIMCALL(void, hswritedata_129830)(tstream126629* s_129832, void* buffer, NI buflen);
N_NIMCALL(tfilehandlestream129805*, newfilehandlestream_129841)(NI handle);
N_NIMCALL(void, TMP386)(void* p, NI op);
N_NIMCALL(void*, newObj)(TNimType* typ, NI size);
N_NIMCALL(NCSTRING, buildcommandline_129862)(NimStringDesc* a, NimStringDesc** args, NI argsLen0);
N_NOCONV(void*, alloc0_4616)(NI size);
N_NIMCALL(NCSTRING, buildenv_129887)(tstringtable123810* env);
N_NIMCALL(void, createpipehandles_129946)(NI* rdhandle, NI* wrhandle);
static N_INLINE(void, fileclose_129959)(NI h);
...
N_NIMCALL(NI, hsreaddata_129817)(tstream126629* s_129819, void* buffer, NI buflen) {
	...
	a = Dl_96024((*s).Handle, buffer, ((int)chckRange(buflen, ((int) (-2147483647 -1)), ((int) 2147483647))), &br, NIM_NIL);
...
N_NIMCALL(void, hswritedata_129830)(tstream126629* s_129832, void* buffer, NI buflen) {
	...
	if (s_129832) chckObj((*s_129832).Sup.m_type, (&NTI129805));
	s = ((tfilehandlestream129805*) (s_129832));
	byteswritten = 0;
	nimln(373, "osproc.nim");
	a = Dl_96033((*s).Handle, buffer, ((int)chckRange(buflen, ((int) (-2147483647 -1)), ((int) 2147483647))), &byteswritten, NIM_NIL);
...
N_NIMCALL(tfilehandlestream129805*, newfilehandlestream_129841)(NI handle) {
	...
	(*result).Sup.Writedataimpl = hswritedata_129830;
	popFrame();
	return result;
}
...
N_NIMCALL(NCSTRING, buildcommandline_129862)(NimStringDesc* a, NimStringDesc** args, NI argsLen0) {
	...
	while (1) {
		NimStringDesc* LOC2;
		nimln(1458, "system.nim");
		if (!(res_129882 <= HEX3Atmp_129880)) goto LA1;
		nimln(1457, "system.nim");
		i_129879 = res_129882;
		...
		nimln(388, "osproc.nim");
		if ((NU)(i_129879) >= (NU)(argsLen0)) raiseIndexError();
		LOC2 = 0;
		LOC2 = nospquoteShell(args[i_129879]);
		res = resizeString(res, LOC2->Sup.len + 0);
appendString(res, LOC2);
		nimln(1460, "system.nim");
		res_129882 = addInt(res_129882, 1);
	} LA1: ;
...
N_NIMCALL(NCSTRING, buildenv_129887)(tstringtable123810* env) {
	NCSTRING result;
	NI l;
	NimStringDesc* key_129892;
	NimStringDesc* val_129893;
	NI h_129931;
	NI HEX3Atmp_129933;
	NI res_129935;
	NI TMP390;
	void* LOC6;
	NimStringDesc* key_129910;
	NimStringDesc* val_129911;
	NI h_129938;
	NI HEX3Atmp_129940;
	NI res_129942;
	...
	nimln(40, "strtabs.nim");
	HEX3Atmp_129933 = ((*env).Data->Sup.len-1);
	nimln(1457, "system.nim");
	res_129935 = 0;
	nimln(1458, "system.nim");
	while (1) {
		nimln(1458, "system.nim");
		if (!(res_129935 <= HEX3Atmp_129933)) goto LA1;
		nimln(1457, "system.nim");
		h_129931 = res_129935;
		nimln(41, "strtabs.nim");
		{
			...
			nimln(41, "strtabs.nim");
			nimln(41, "strtabs.nim");
			if ((NU)(h_129931) >= (NU)((*env).Data->Sup.len)) raiseIndexError();
			if (!!((*env).Data->data[h_129931].Field0 == 0)) goto LA4;
			nimln(42, "strtabs.nim");
			if ((NU)(h_129931) >= (NU)((*env).Data->Sup.len)) raiseIndexError();
			key_129892 = (*env).Data->data[h_129931].Field0;
			nimln(42, "strtabs.nim");
			if ((NU)(h_129931) >= (NU)((*env).Data->Sup.len)) raiseIndexError();
			val_129893 = (*env).Data->data[h_129931].Field1;
			nimln(394, "osproc.nim");
			nimln(394, "osproc.nim");
			nimln(394, "osproc.nim");
			nimln(394, "osproc.nim");
			nimln(394, "osproc.nim");
			TMP388 = addInt(key_129892->Sup.len, val_129893->Sup.len);
			TMP389 = addInt((NI64)(TMP388), 2);
			l = addInt(l, (NI64)(TMP389));
		}
		LA4: ;
		nimln(1460, "system.nim");
		res_129935 = addInt(res_129935, 1);
	} LA1: ;
	...
	nimln(40, "strtabs.nim");
	nimln(40, "strtabs.nim");
	HEX3Atmp_129940 = ((*env).Data->Sup.len-1);
	nimln(1457, "system.nim");
	res_129942 = 0;
	nimln(1458, "system.nim");
	while (1) {
		nimln(1458, "system.nim");
		if (!(res_129942 <= HEX3Atmp_129940)) goto LA7;
		nimln(1457, "system.nim");
		h_129938 = res_129942;
		nimln(41, "strtabs.nim");
		{
			...
			nimln(41, "strtabs.nim");
			nimln(41, "strtabs.nim");
			if ((NU)(h_129938) >= (NU)((*env).Data->Sup.len)) raiseIndexError();
			if (!!((*env).Data->data[h_129938].Field0 == 0)) goto LA10;
			nimln(42, "strtabs.nim");
			if ((NU)(h_129938) >= (NU)((*env).Data->Sup.len)) raiseIndexError();
			key_129910 = (*env).Data->data[h_129938].Field0;
			nimln(42, "strtabs.nim");
			if ((NU)(h_129938) >= (NU)((*env).Data->Sup.len)) raiseIndexError();
			val_129911 = (*env).Data->data[h_129938].Field1;
			nimln(398, "osproc.nim");
			nimln(398, "osproc.nim");
			LOC12 = 0;
			LOC12 = rawNewString(key_129910->Sup.len + val_129911->Sup.len + 1);
appendString(LOC12, key_129910);
appendString(LOC12, ((NimStringDesc*) &TMP391));
appendString(LOC12, val_129911);
			x = LOC12;
			nimln(399, "osproc.nim");
			nimln(399, "osproc.nim");
			nimln(399, "osproc.nim");
			TMP392 = addInt(x->Sup.len, 1);
			memcpy(((void*) (&result[l])), ((void*) (x->data)), (NI64)(TMP392));
			nimln(400, "osproc.nim");
			nimln(400, "osproc.nim");
			nimln(400, "osproc.nim");
			TMP393 = addInt(x->Sup.len, 1);
			l = addInt(l, (NI64)(TMP393));
		}
		LA10: ;
		nimln(1460, "system.nim");
		res_129942 = addInt(res_129942, 1);
	} LA7: ;
	popFrame();
	return result;
}
...
N_NIMCALL(void, createpipehandles_129946)(NI* rdhandle, NI* wrhandle) {
	...
	nimln(411, "osproc.nim");
	piinheritablepipe.Nlength = ((int)chckRange(((NI)sizeof(tsecurityattributes95862)), ((int) (-2147483647 -1)), ((int) 2147483647)));
...
N_NIMCALL(tprocess128402*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, tstringtable123810* env, NU8 options) {
	...
	nimln(431, "osproc.nim");
	si.Cb = ((int)chckRange(((NI)sizeof(tstartupinfo95864)), ((int) (-2147483647 -1)), ((int) 2147483647)));
	nimln(432, "osproc.nim");
	{
		...
		createpipehandles_129946(&si.Hstdinput, &hi);
		nimln(435, "osproc.nim");
		createpipehandles_129946(&ho, &si.Hstdoutput);
		...
		LA7: ;
		{
			...
			createpipehandles_129946(&he, &si.Hstderror);
		}
		LA5: ;
	...
	LA13: ;
	{
		...
		cmdl = buildcommandline_129862(command, args, argsLen0);
	}
	LA11: ;
	...
	nimln(475, "osproc.nim");
	{
		...
		fileclose_129959(si.Hstdinput);
		nimln(477, "osproc.nim");
		fileclose_129959(si.Hstdoutput);
...
N_NIMCALL(NI, nospwaitForExit)(tprocess128402* p, NI timeout) {
	...
	nimln(511, "osproc.nim");
	LOC1 = 0;
	LOC1 = Dl_96210((*p).Fprocesshandle, ((NI32)chckRange(timeout, ((NI32) (-2147483647 -1)), ((NI32) 2147483647))));
	res = 0;
...
N_NIMCALL(tstream126629*, nospinputStream)(tprocess128402* p) {
	...
	nimln(527, "osproc.nim");
	LOC1 = 0;
	LOC1 = newfilehandlestream_129841(((NI) ((*p).Inhandle)));
	result = &LOC1->Sup;
	popFrame();
	return result;
}
...
N_NIMCALL(tstream126629*, nospoutputStream)(tprocess128402* p) {
	...
	nimln(530, "osproc.nim");
	LOC1 = 0;
	LOC1 = newfilehandlestream_129841(((NI) ((*p).Outhandle)));
	result = &LOC1->Sup;
	popFrame();
	return result;
}
...
N_NIMCALL(tstream126629*, nosperrorStream)(tprocess128402* p) {
	...
	nimln(533, "osproc.nim");
	LOC1 = 0;
	LOC1 = newfilehandlestream_129841(((NI) ((*p).Errhandle)));
	result = &LOC1->Sup;
	popFrame();
	return result;
}
...
N_NIMCALL(NI, select_129721)(TY129403** readfds, NI timeout) {
	...
	nimln(570, "osproc.nim");
	ret = Dl_97786(((NI32)chckRange((*readfds)->Sup.len, ((NI32) (-2147483647 -1)), ((NI32) 2147483647))), rfds, ((NI32) 0), ((NI32)chckRange(timeout, ((NI32) (-2147483647 -1)), ((NI32) 2147483647))));
	...
	default:
	{
		...
		if (TMP397 < (-2147483647 -1) || TMP397 > 2147483647) raiseOverflow();
		i = (NI32)(TMP397);
