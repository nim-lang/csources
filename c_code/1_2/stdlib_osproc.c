...
N_NIMCALL(void, createpipehandles_146983)(NI* rdhandle, NI* wrhandle);
N_NIMCALL(void, raiseoserror_114430)(NI32 errorcode);
N_NIMCALL(NI32, oslasterror_114454)(void);
N_NIMCALL(NCSTRING, buildcommandline_146865)(NimStringDesc* a, NimStringDesc** args, NI argsLen0);
N_NIMCALL(NimStringDesc*, nospquoteShell)(NimStringDesc* s);
N_NOCONV(void*, alloc0_6017)(NI size);
N_NIMCALL(NCSTRING, buildenv_146904)(Stringtableobj136012* env);
N_NIMCALL(NimStringDesc*, rawNewString)(NI space);
N_NIMCALL(NimStringDesc*, cstrToNimstr)(NCSTRING str);
N_NIMCALL(NI16*, newwidecstring_80544)(NCSTRING s);
static N_INLINE(void, fileclose_146998)(NI h);
N_NOCONV(void, dealloc_6048)(void* p);
N_NIMCALL(Tfilehandlestream146807*, newfilehandlestream_146850)(NI handle);
...
N_NIMCALL(void, hswritedata_146837)(Streamobj140027* s_146839, void* buffer, NI buflen);
...
N_NIMCALL(NCSTRING, buildcommandline_146865)(NimStringDesc* a, NimStringDesc** args, NI argsLen0) {
	...
	res = nospquoteShell(a);
	{
		...
		i_146882 = 0;
		HEX3Atmp_146884 = 0;
		HEX3Atmp_146884 = (argsLen0-1);
		res_146887 = ((NI) 0);
		{
			while (1) {
				NimStringDesc* LOC4;
				if (!(res_146887 <= HEX3Atmp_146884)) goto LA3;
				i_146882 = res_146887;
				res = addChar(res, 32);
				LOC4 = 0;
				LOC4 = nospquoteShell(args[i_146882]);
...
N_NIMCALL(NCSTRING, buildenv_146904)(Stringtableobj136012* env) {
	...
	L = ((NI) 0);
	{
		NimStringDesc* key_146909;
		NimStringDesc* val_146910;
		key_146909 = 0;
		val_146910 = 0;
		{
			NI h_146937;
			...
			h_146937 = 0;
			HEX3Atmp_146939 = 0;
			HEX3Atmp_146939 = ((*env).data ? ((*env).data->Sup.len-1) : -1);
			res_146941 = ((NI) 0);
			{
				while (1) {
					if (!(res_146941 <= HEX3Atmp_146939)) goto LA4;
					h_146937 = res_146941;
					{
						if (!!((*env).data->data[h_146937].Field0 == 0)) goto LA7;
						key_146909 = (*env).data->data[h_146937].Field0;
						val_146910 = (*env).data->data[h_146937].Field1;
						L += (NI)((NI)((key_146909 ? key_146909->Sup.len : 0) + (val_146910 ? val_146910->Sup.len : 0)) + ((NI) 2));
					}
					LA7: ;
					res_146941 += ((NI) 1);
				} LA4: ;
	...
	L = ((NI) 0);
	{
		NimStringDesc* key_146920;
		NimStringDesc* val_146921;
		key_146920 = 0;
		val_146921 = 0;
		{
			NI h_146949;
			...
			h_146949 = 0;
			HEX3Atmp_146951 = 0;
			HEX3Atmp_146951 = ((*env).data ? ((*env).data->Sup.len-1) : -1);
			res_146953 = ((NI) 0);
			{
				while (1) {
					if (!(res_146953 <= HEX3Atmp_146951)) goto LA13;
					h_146949 = res_146953;
					{
						NimStringDesc* x;
						NimStringDesc* LOC18;
						if (!!((*env).data->data[h_146949].Field0 == 0)) goto LA16;
						key_146920 = (*env).data->data[h_146949].Field0;
						val_146921 = (*env).data->data[h_146949].Field1;
						LOC18 = 0;
						LOC18 = rawNewString(key_146920->Sup.len + val_146921->Sup.len + 1);
appendString(LOC18, key_146920);
appendString(LOC18, ((NimStringDesc*) &TMP2893));
appendString(LOC18, val_146921);
						x = LOC18;
...
N_NIMCALL(Processobj145402*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, Stringtableobj136012* env, NU8 options) {
	...
	si.cb = ((int) (((NI)sizeof(Tstartupinfo104241))));
	{
		...
		si.dwflags = ((NI32) 256);
		createpipehandles_146983((&si.hstdinput), (&hi));
		createpipehandles_146983((&ho), (&si.hstdoutput));
		{
		...
		LA7: ;
		{
			createpipehandles_146983((&he), (&si.hstderror));
		}
		LA5: ;
	...
	LA13: ;
	{
		cmdl = buildcommandline_146865(command, args, argsLen0);
	}
	LA11: ;
	wd = NIM_NIL;
	e = NIM_NIL;
	...
	lasterror = oslasterror_114454();
	{
		...
		fileclose_146998(si.hstdinput);
		fileclose_146998(si.hstdoutput);
		{
			if (!!(((options &(1<<((((NU8) 3))&7)))!=0))) goto LA36;
			fileclose_146998(si.hstderror);
		}
		LA36: ;
	}
	LA32: ;
...
N_NIMCALL(void, hswritedata_146837)(Streamobj140027* s_146839, void* buffer, NI buflen) {
	...
	NI32 byteswritten;
	NI32 a;
	s = ((Tfilehandlestream146807*) (s_146839));
	byteswritten = 0;
...
N_NIMCALL(Tfilehandlestream146807*, newfilehandlestream_146850)(NI handle) {
	...
	(*result).Sup.writedataimpl = hswritedata_146837;
	return result;
}
...
N_NIMCALL(Streamobj140027*, nospinputStream)(Processobj145402* p) {
	...
	result = 0;
	LOC1 = 0;
	LOC1 = newfilehandlestream_146850(((NI) ((*p).inhandle)));
	result = &LOC1->Sup;
	return result;
}
...
N_NIMCALL(Streamobj140027*, nospoutputStream)(Processobj145402* p) {
	...
	result = 0;
	LOC1 = 0;
	LOC1 = newfilehandlestream_146850(((NI) ((*p).outhandle)));
	result = &LOC1->Sup;
	return result;
}
