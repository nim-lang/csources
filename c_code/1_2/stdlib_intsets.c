...
extern TNimType NTI29019; /* array[0..7, int] */
...
N_NIMCALL(void, incl_266832_2627731572)(Intset266030* s0, NI key0) {
	Trunk266026* t0;
	NI u0;
	t0 = intsetput_266661_2627731572(s0, (NI)((NU64)(key0) >> (NU64)(((NI) 9))));
	u0 = (NI)(key0 & ((NI) 511));
...
N_NIMCALL(NIM_BOOL, containsorincl_266862_2627731572)(Intset266030* s0, NI key0) {
	...
	Trunk266026* t0;
	result0 = (NIM_BOOL)0;
	t0 = intsetget_266206_2627731572((&(*s0)), (NI)((NU64)(key0) >> (NU64)(((NI) 9))));
	{
		NI u0;
...
N_NIMCALL(void, assign_266941_2627731572)(Intset266030* dest0, Intset266030* src0) {
	...
	it0 = (*src0).head;
	{
		while (1) {
			...
			(*n0).key = (*it0).key;
			memcpy((void*)(*n0).bits, (NIM_CONST void*)(*it0).bits, sizeof(TY29019));
