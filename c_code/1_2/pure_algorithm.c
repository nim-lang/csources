...
N_NIMCALL(void, merge_321761)(tsym173689** a, NI aLen0, tsym173689** b, NI bLen0, NI lo, NI m, NI hi, TY321724 cmp, NU8 order) {
	...
	nimln(71, "algorithm.nim");
	{
		...
		nimln(71, "algorithm.nim");
		TMP4972 = addInt(m, 1);
		if ((NU)((NI64)(TMP4972)) >= (NU)(aLen0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI64)(TMP4972)], cmp.ClEnv) : ((TMP4973)(cmp.ClPrc))(a[m], a[(NI64)(TMP4972)]);
		LOC4 = 0;
...
N_NIMCALL(void, sort_321717)(tsym173689** a, NI aLen0, TY321724 cmp, NU8 order) {
	...
	nimln(125, "algorithm.nim");
	TMP4969 = divInt(n, 2);
	b = (tsymseq173661*) newSeq((&NTI173661), (NI64)(TMP4969));
	...
	while (1) {
		...
		while (1) {
			...
			nimln(130, "algorithm.nim");
			TMP4976 = subInt(m, s);
			TMP4977 = addInt((NI64)(TMP4976), 1);
			nimln(130, "algorithm.nim");
			TMP4978 = addInt(m, s);
			merge_321761(a, aLen0, b->data, b->Sup.len, (((NI64)(TMP4977) >= 0) ? (NI64)(TMP4977) : 0), m, (NI64)(TMP4978), cmp, order);			nimln(131, "algorithm.nim");
			nimln(131, "algorithm.nim");
			TMP4979 = mulInt(s, 2);
			m = subInt(m, (NI64)(TMP4979));
		} LA2: ;
...
N_NIMCALL(void, merge_324468)(tentry323943* a, NI aLen0, tentry323943* b, NI bLen0, NI lo, NI m, NI hi, TY324431 cmp, NU8 order) {
	...
	nimln(71, "algorithm.nim");
	{
		...
		nimln(71, "algorithm.nim");
		TMP4991 = addInt(m, 1);
		if ((NU)((NI64)(TMP4991)) >= (NU)(aLen0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI64)(TMP4991)], cmp.ClEnv) : ((TMP4992)(cmp.ClPrc))(a[m], a[(NI64)(TMP4991)]);
		LOC4 = 0;
		LOC4 = HEX2A_319040(LOC3, order);
		if (!(LOC4 <= 0)) goto LA5;
		nimln(71, "algorithm.nim");
...
N_NIMCALL(void, sort_324424)(tentry323943* a, NI aLen0, TY324431 cmp, NU8 order) {
	...
	nimln(125, "algorithm.nim");
	TMP4988 = divInt(n, 2);
	b = (TY323950*) newSeq((&NTI323950), (NI64)(TMP4988));
	nimln(126, "algorithm.nim");
	s = 1;
	nimln(127, "algorithm.nim");
	while (1) {
		...
		while (1) {
			...
			nimln(130, "algorithm.nim");
			TMP4994 = subInt(m, s);
			TMP4995 = addInt((NI64)(TMP4994), 1);
			nimln(130, "algorithm.nim");
			TMP4996 = addInt(m, s);
			merge_324468(a, aLen0, b->data, b->Sup.len, (((NI64)(TMP4995) >= 0) ? (NI64)(TMP4995) : 0), m, (NI64)(TMP4996), cmp, order);			nimln(131, "algorithm.nim");
			nimln(131, "algorithm.nim");
			TMP4997 = mulInt(s, 2);
			m = subInt(m, (NI64)(TMP4997));
		} LA2: ;
		nimln(132, "algorithm.nim");
		nimln(132, "algorithm.nim");
		TMP4998 = mulInt(s, 2);
