...
N_NIMCALL(Tnode216790*, totreeset_262252)(Tbitset261006* s, Ttype216828* settype, Tlineinfo184337 info);
...
N_NIMCALL(void, tobitset_262001)(Tnode216790* s, Tbitset261006** b) {
	...
	bitsetinit_261009(b, ((NI) (LOC1)));
	{
		...
		HEX3Atmp_262245 = (NI)(LOC3 - ((NI) 1));
		res_262248 = ((NI) 0);
		{
			while (1) {
				if (!(res_262248 <= HEX3Atmp_262245)) goto LA5;
				i_262215 = res_262248;
				{
	...
	e = IL64(0);
	{
		while (1) {
			if (!(e < ((NI64) ((NI)((s ? s->Sup.len : 0) * ((NI) 8)))))) goto LA2;
			{
				...
				b -= ((NI) 1);
				aa = newinttypenode_217665(((NU8) 6), (NI64)(a + first), elemtype);
				(*aa).info = info;
				{
					if (!(a == b)) goto LA19;
				...
				LA19: ;
				{
					...
					addson_218807(n, aa);
					bb = newinttypenode_217665(((NU8) 6), (NI64)(b + first), elemtype);
					(*bb).info = info;
					addson_218807(n, bb);
...
N_NIMCALL(Tnode216790*, diffsets_262030)(Tnode216790* a, Tnode216790* b) {
	...
	result = totreeset_262252(x, (*a).typ, (*a).info);
	return result;
}
...
N_NIMCALL(NI64, cardset_262050)(Tnode216790* s) {
	...
	result = IL64(0);
	{
		...
		HEX3Atmp_262460 = (NI)(LOC2 - ((NI) 1));
		res_262463 = ((NI) 0);
		{
			while (1) {
				if (!(res_262463 <= HEX3Atmp_262460)) goto LA4;
				i_262435 = res_262463;
				{
					NI64 LOC9;
					NI64 LOC10;
					if (!((*(*s).kindU.S6.sons->data[i_262435]).kind == ((NU8) 44))) goto LA7;
					LOC9 = 0;
					LOC9 = getordvalue_242118((*(*s).kindU.S6.sons->data[i_262435]).kindU.S6.sons->data[((NI) 1)]);
					LOC10 = 0;
					LOC10 = getordvalue_242118((*(*s).kindU.S6.sons->data[i_262435]).kindU.S6.sons->data[((NI) 0)]);
...
N_NIMCALL(Tnode216790*, complement_262393)(Tnode216790* a) {
	...
	tobitset_262001(a, (&x));
	{
		...
		i_262410 = 0;
		HEX3Atmp_262413 = 0;
		HEX3Atmp_262413 = (x ? (x->Sup.len-1) : -1);
		res_262416 = ((NI) 0);
		{
			while (1) {
				if (!(res_262416 <= HEX3Atmp_262413)) goto LA3;
				i_262410 = res_262416;
				x->data[i_262410] = (NI8)((NU8) ~(x->data[i_262410]));
				res_262416 += ((NI) 1);
			} LA3: ;
		}
	}
