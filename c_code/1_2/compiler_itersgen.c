...
{	result0 = (Tnode290802*)0;
	...
	LA25: ;
	LOC28 = (Tnode290802*)0;
	LOC28 = getbody_333226_1724185294((*iter0).kindU.S4.sym);
	body0 = liftitertoproc_438395_2538784801((*iter0).kindU.S4.sym, LOC28, t0);
	LOC29 = (Tnode290802*)0;
	LOC29 = HEX5BHEX5D_291238_850551059(n0, ((NI) 3));
	prc0 = newsym_291683_850551059(((Tsymkind290435) 12), (*LOC29).kindU.S5.ident, (*(*iter0).kindU.S4.sym).owner, (*(*iter0).kindU.S4.sym).info);
