...
N_NIMCALL(void, setintlittype_242519)(tnode187813* result);
...
N_NIMCALL(ttype187847*, getintlittype_242378)(tnode187813* literal) {
	...
	nimln(106, "magicsys.nim");
	{
		...
		result = inttypecache_242289[(((NI) (value)))- -5];
		nimln(108, "magicsys.nim");
		{
			...
			if (((NI) (value)) < -5 || ((NI) (value)) > 64) raiseIndexError();
			asgnRefNoCycle((void**) &inttypecache_242289[(((NI) (value)))- -5], result);
		}
		LA9: ;
	}
	goto LA1;
