...
STRING_LITERAL(TMP3109, "tab", 3);
STRING_LITERAL(TMP3110, "int", 3);
STRING_LITERAL(TMP3111, "int8", 4);
STRING_LITERAL(TMP3112, "int16", 5);
STRING_LITERAL(TMP3113, "int32", 5);
STRING_LITERAL(TMP3114, "int64", 5);
STRING_LITERAL(TMP3115, "uint", 4);
STRING_LITERAL(TMP3116, "uint8", 5);
STRING_LITERAL(TMP3117, "uint16", 6);
STRING_LITERAL(TMP3118, "uint32", 6);
STRING_LITERAL(TMP3119, "uint64", 6);
STRING_LITERAL(TMP3120, "float", 5);
STRING_LITERAL(TMP3121, "float32", 7);
STRING_LITERAL(TMP3122, "float64", 7);
STRING_LITERAL(TMP3123, "float128", 8);
STRING_LITERAL(TMP3124, "bool", 4);
STRING_LITERAL(TMP3125, "char", 4);
STRING_LITERAL(TMP3126, "string", 6);
STRING_LITERAL(TMP3127, "cstring", 7);
STRING_LITERAL(TMP3128, "pointer", 7);
STRING_LITERAL(TMP3129, "request for typekind: ", 22);
STRING_LITERAL(TMP3130, "wanted: ", 8);
STRING_LITERAL(TMP3131, " got: ", 6);
STRING_LITERAL(TMP3132, "type not found: ", 16);
static NIM_CONST TY192025 TMP3133 = {
0xE0, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3134, "intVal", 6);
STRING_LITERAL(TMP3135, "invalid int size", 16);
...
N_NIMCALL(tsym191843*, getsyssym_246040)(NimStringDesc* name) {
	...
	if (!(((64 &(1<<(((*systemmodule_246017).Kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3109));
	nimln(39, "magicsys.nim");
	LOC1 = 0;
...
N_NIMCALL(ttype191847*, getsystype_246024)(NU8 kind) {
	...
	nimln(63, "magicsys.nim");
	{
		...
		case ((NU8) 31):
		{
			...
			result = systypefromname_246204(((NimStringDesc*) &TMP3110));
		}
		break;
		case ((NU8) 32):
		{
...
appendString(LOC26, ((NimStringDesc*) &TMP3129));
...
appendString(LOC36, ((NimStringDesc*) &TMP3132));
...
N_NIMCALL(ttype191847*, getintlittype_246378)(tnode191813* literal) {
	...
	if (!(((TMP3133[(*literal).Kind/8] &(1<<((*literal).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3134));
