...
static NIM_CONST TY188025 TMP2640 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2641, "sons", 4);
static NIM_CONST TY188025 TMP2643 = {
...
static NIM_CONST TY188025 TMP2647 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2648, "strVal", 6);
STRING_LITERAL(TMP2649, "true", 4);
STRING_LITERAL(TMP2650, "false", 5);
STRING_LITERAL(TMP2651, "startswith", 10);
STRING_LITERAL(TMP2652, "", 0);
STRING_LITERAL(TMP2653, "leading", 7);
STRING_LITERAL(TMP2654, "trailing", 8);
STRING_LITERAL(TMP2656, "sub", 3);
STRING_LITERAL(TMP2657, "by", 2);
...
static N_INLINE(NI, sonslen_188191)(tnode187813* n) {
	...
	{
		nimln(1301, "ast.nim");
		if (((TMP2640[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2641));
...
N_NIMCALL(tnode187813*, getarg_218042)(tnode187813* n, NimStringDesc* name, NI pos) {
	...
	TMP2642 = subInt(LOC5, 1);
	HEX3Atmp_218219 = (NI64)(TMP2642);
	...
	while (1) {
		...
		nimln(31, "filters.nim");
		{
			...
			nimln(32, "filters.nim");
			{
				...
				if (((TMP2640[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2641));
				if ((NU)(i_218074) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP2640[(*(*n).kindU.S6.Sons->data[i_218074]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_218074]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2641));
			...
			nimln(33, "filters.nim");
			{
				...
				if (((TMP2640[(*(*n).kindU.S6.Sons->data[i_218074]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_218074]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2641));
				if ((NU)(0) >= (NU)((*(*n).kindU.S6.Sons->data[i_218074]).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (!(((TMP2643[(*(*(*n).kindU.S6.Sons->data[i_218074]).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*(*n).kindU.S6.Sons->data[i_218074]).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2644));
				LOC17 = 0;
...
N_NIMCALL(NIM_CHAR, chararg_218014)(tnode187813* n, NimStringDesc* name, NI pos, NIM_CHAR default_218019) {
	...
	LA3: ;
	{
		...
		nimln(41, "filters.nim");
		nimln(41, "filters.nim");
		if (!(((TMP2645[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2646));
...
N_NIMCALL(NIM_BOOL, boolarg_218028)(tnode187813* n, NimStringDesc* name, NI pos, NIM_BOOL default_218033) {
	...
	LA3: ;
	{
		...
		if (!(LOC6)) goto LA7;
		nimln(53, "filters.nim");
		if (!(((TMP2643[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2644));
		LOC6 = identeq_167469((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2649));
		LA7: ;
		if (!LOC6) goto LA8;
		nimln(53, "filters.nim");
		result = NIM_TRUE;
	...
	LA8: ;
	{
		...
		nimln(54, "filters.nim");
		if (!(((TMP2643[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2644));
		LOC11 = identeq_167469((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2650));
		LA12: ;
		if (!LOC11) goto LA13;
		nimln(54, "filters.nim");
		result = NIM_FALSE;
...
N_NIMCALL(tllstream175204*, filterstrip_218008)(tllstream175204* stdin_218010, NimStringDesc* filename, tnode187813* call) {
	...
	pattern = strarg_218021(call, ((NimStringDesc*) &TMP2651), 1, ((NimStringDesc*) &TMP2652));
	nimln(59, "filters.nim");
	leading = boolarg_218028(call, ((NimStringDesc*) &TMP2653), 2, NIM_TRUE);
	nimln(60, "filters.nim");
	trailing = boolarg_218028(call, ((NimStringDesc*) &TMP2654), 3, NIM_TRUE);
	nimln(61, "filters.nim");
	result = llstreamopen_175218(((NimStringDesc*) &TMP2652));
...
N_NIMCALL(tllstream175204*, filterreplace_218002)(tllstream175204* stdin_218004, NimStringDesc* filename, tnode187813* call) {
	...
	sub = strarg_218021(call, ((NimStringDesc*) &TMP2656), 1, ((NimStringDesc*) &TMP2652));
	...
	by = strarg_218021(call, ((NimStringDesc*) &TMP2657), 2, ((NimStringDesc*) &TMP2652));
