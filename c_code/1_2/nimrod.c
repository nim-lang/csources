...
N_NIMCALL(void, handlecmdline_531603)(void) {
	...
	{
		nimln(39, "nimrod.nim");
		processcmdline_525207(((NU8) 0), ((NimStringDesc*) &TMP7785));
		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP7786;
			TY108700 p;
		...
		LA7: ;
		nimln(50, "nimrod.nim");
		loadconfigs_183603(((NimStringDesc*) &TMP7787));
		nimln(53, "nimrod.nim");
		initvars_169714();
		nimln(54, "nimrod.nim");
		processcmdline_525207(((NU8) 1), ((NimStringDesc*) &TMP7785));
		nimln(55, "nimrod.nim");
		maincommand_529011();
		nimln(56, "nimrod.nim");
		{
		...
		{
			nimln(58, "nimrod.nim");
			if (!(gerrorcounter_164179 == 0)) goto LA25;
			nimln(62, "nimrod.nim");
			{
				nimln(62, "nimrod.nim");
				...
				nimln(63, "nimrod.nim");
				{
					...
					LA37: ;
					{
						...
						nimln(69, "nimrod.nim");
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_137208, ((NimStringDesc*) &TMP7788));
						LOC42 = 0;
...
appendString(LOC44, arguments_525205);
				...
				LA33: ;
				{
					...
					LA48: ;
					{
						...
						nimln(78, "nimrod.nim");
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_137208, ((NimStringDesc*) &TMP7790));
...
N_NOINLINE(void, nimrodInit)(void) {
	...
	nimln(92, "nimrod.nim");
	nimln(92, "nimrod.nim");
	exit(((NI) (((NI8) ((0 < gerrorcounter_164179))))));
	popFrame();
}
