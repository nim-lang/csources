...
NIM_CONST tpass246015 docgen2pass_522082 = {myopen_522057,
NIM_NIL,
processnode_522049,
close_522014}
;
...
N_NIMCALL(tnode187813*, close_522014)(tpasscontext246003* p, tnode187813* n) {
	...
	nimln(25, "docgen2.nim");
	{
		...
		nimln(26, "docgen2.nim");
		LOC7 = 0;
		LOC7 = tofilename_164780(((NI32)chckRange((*(*g).Module).Position, ((NI32) (-2147483647 -1)), ((NI32) 2147483647))));
...
N_NIMCALL(tpasscontext246003*, myopen_522057)(tsym187843* module) {
	...
	nimln(41, "docgen2.nim");
	LOC1 = 0;
	LOC1 = tofilename_164780(((NI32)chckRange((*module).Position, ((NI32) (-2147483647 -1)), ((NI32) 2147483647))));
