...
N_NIMCALL(NU8, ispartofaux_327019)(tnode173659* n, ttype173693* b, tintset170043* marker);
...
N_NIMCALL(NU8, ispartofaux_327012)(ttype173693* a, ttype173693* b, tintset170043* marker);
...
N_NIMCALL(NU8, ispartof_327347)(ttype173693* a, ttype173693* b);
...
static NIM_CONST TY173865 TMP5020 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5021, "sons", 4);
STRING_LITERAL(TMP5023, "n.sons[0].Kind == nkSym ", 24);
STRING_LITERAL(TMP5026, "isPartOfAux(record case branch)", 31);
static NIM_CONST TY173865 TMP5027 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5028, "sym", 3);
STRING_LITERAL(TMP5029, "isPartOfAux()", 13);
NIM_CONST NU32 varkinds_327369 = 4384;
NIM_CONST TY173865 ix0kinds_327555 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 0x00, 0x00,
0x0C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
NIM_CONST TY173865 ix1kinds_327557 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1C,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
NIM_CONST TY173865 derefkinds_327559 = {
...
static N_INLINE(tnode173659*, lastson_174030)(tnode173659* n) {
	...
	TMP5025 = subInt(LOC1, 1);
	if ((NU)((NI64)(TMP5025)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI64)(TMP5025)];
	popFrame();
	return result;
}
N_NIMCALL(NU8, ispartofaux_327019)(tnode173659* n, ttype173693* b, tintset170043* marker) {
	...
	case ((NU8) 133):
	{
		...
		HEX3Atmp_327271 = (NI64)(TMP5022);
		nimln(1301, "system.nim");
		res_327273 = 0;
		nimln(1302, "system.nim");
		while (1) {
			nimln(1302, "system.nim");
			if (!(res_327273 <= HEX3Atmp_327271)) goto LA3;
			nimln(1301, "system.nim");
			i_327035 = res_327273;
			nimln(26, "aliases.nim");
			if (((TMP5020[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP5021));
			if ((NU)(i_327035) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			result = ispartofaux_327019((*n).kindU.S6.Sons->data[i_327035], b, marker);
			...
			res_327273 = addInt(res_327273, 1);
		} LA3: ;
	}	break;
	case ((NU8) 134):
	{
		...
		nimln(29, "aliases.nim");
		{
			...
			nimln(29, "aliases.nim");
			hiddenraiseassert_77217(((NimStringDesc*) &TMP5023));		}		LA11: ;
		nimln(30, "aliases.nim");
		if (((TMP5020[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP5021));
		if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
		result = ispartofaux_327019((*n).kindU.S6.Sons->data[0], b, marker);
		...
		HEX3Atmp_327275 = (NI64)(TMP5024);
		nimln(1301, "system.nim");
		res_327277 = 1;
		nimln(1302, "system.nim");
		while (1) {
			nimln(1302, "system.nim");
			if (!(res_327277 <= HEX3Atmp_327275)) goto LA18;
			nimln(1301, "system.nim");
			i_327229 = res_327277;
			nimln(33, "aliases.nim");
			if (((TMP5020[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP5021));
			if ((NU)(i_327229) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			switch ((*(*n).kindU.S6.Sons->data[i_327229]).Kind) {
			case ((NU8) 85):
			case ((NU8) 88):
			{
				tnode173659* LOC20;
				...
				if ((NU)(i_327229) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
				LOC20 = 0;
				LOC20 = lastson_174030((*n).kindU.S6.Sons->data[i_327229]);
				result = ispartofaux_327019(LOC20, b, marker);
			...
			default:
			{
				...
				internalerror_139383(((NimStringDesc*) &TMP5026));			}			break;
			}
			nimln(1304, "system.nim");
			res_327277 = addInt(res_327277, 1);
		} LA18: ;
	}	break;
	case ((NU8) 3):
	{
		...
		result = ispartofaux_327012((*(*n).kindU.S4.Sym).Typ, b, marker);
	}	break;
	default:
	{
		nimln(40, "aliases.nim");
		internalerror_139369((*n).Info, ((NimStringDesc*) &TMP5029));	}	break;
	}
	BeforeRet: ;	popFrame();
	return result;
}
...
static N_INLINE(ttype173693*, lastson_174034)(ttype173693* n) {
	...
	if ((NU)((NI64)(TMP5030)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP5030)];
	popFrame();
	return result;
}
N_NIMCALL(NU8, ispartofaux_327012)(ttype173693* a, ttype173693* b, tintset170043* marker) {
	...
	nimln(45, "aliases.nim");
	{
		...
		nimln(45, "aliases.nim");
		LOC9 = 0;
		LOC9 = containsorincl_170874(marker, (*a).Sup.Id);
		if (!LOC9) goto LA10;
		nimln(45, "aliases.nim");
		goto BeforeRet;
	}	LA10: ;
	nimln(46, "aliases.nim");
	{
		...
		nimln(46, "aliases.nim");
		LOC14 = 0;
		LOC14 = comparetypes_208524(a, b, ((NU8) 1), 0);
		if (!LOC14) goto LA15;
		nimln(46, "aliases.nim");
		nimln(46, "aliases.nim");
		result = ((NU8) 2);
	...
	case ((NU8) 17):
	{
		...
		result = ispartofaux_327012((*a).Sons->data[0], b, marker);
		nimln(50, "aliases.nim");
		{
			nimln(50, "aliases.nim");
			if (!(result == ((NU8) 0))) goto LA20;
			nimln(50, "aliases.nim");
			result = ispartofaux_327019((*a).N, b, marker);
		}		LA20: ;
	}	break;
	case ((NU8) 11):
	case ((NU8) 13):
	{
		...
		nimln(52, "aliases.nim");
		LOC23 = 0;
		LOC23 = lastson_174034(a);
		result = ispartofaux_327012(LOC23, b, marker);
	}	break;
	case ((NU8) 16):
	case ((NU8) 4):
	case ((NU8) 19):
	case ((NU8) 18):
	{
		...
		nimln(54, "aliases.nim");
		LOC25 = 0;
		LOC25 = sonslen_174026(a);
		TMP5031 = subInt(LOC25, 1);
		HEX3Atmp_327340 = (NI64)(TMP5031);
		nimln(1301, "system.nim");
		res_327342 = 0;
		nimln(1302, "system.nim");
		while (1) {
			nimln(1302, "system.nim");
			if (!(res_327342 <= HEX3Atmp_327340)) goto LA26;
			nimln(1301, "system.nim");
			i_327331 = res_327342;
			nimln(55, "aliases.nim");
			if ((NU)(i_327331) >= (NU)((*a).Sons->Sup.len)) raiseIndexError();
			result = ispartofaux_327012((*a).Sons->data[i_327331], b, marker);
			...
			nimln(1304, "system.nim");
			res_327342 = addInt(res_327342, 1);
		} LA26: ;
	}	break;
	default:
	{
...
N_NIMCALL(NU8, ispartof_327347)(ttype173693* a, ttype173693* b) {
	...
	initintset_170899(&marker);	nimln(63, "aliases.nim");
	result = ispartofaux_327012(b, a, &marker);
	popFrame();
	return result;
}
static N_INLINE(tnode173659*, HEX5BHEX5D_174475)(tnode173659* n, NI i) {
...
N_NIMCALL(NU8, ispartof_327356)(tnode173659* a, tnode173659* b) {
	...
	nimln(94, "aliases.nim");
	{
		...
		case ((NU8) 3):
		{
			...
			{
				nimln(99, "aliases.nim");
				if (!(((TMP5027[(*a).Kind/8] &(1<<((*a).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5028));
				if (!(((TMP5027[(*b).Kind/8] &(1<<((*b).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5028));
			...
			LA13: ;
			{
				nimln(106, "aliases.nim");
				{
					...
					if (!(((TMP5027[(*b).Kind/8] &(1<<((*b).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5028));
					LOC18 = 0;
					LOC18 = ispartof_327347((*(*a).kindU.S4.Sym).Typ, (*(*b).kindU.S4.Sym).Typ);
		...
		case ((NU8) 42):
		{
			...
			nimln(109, "aliases.nim");
			LOC22 = 0;
			LOC22 = HEX5BHEX5D_174475(a, 0);
			nimln(109, "aliases.nim");
			LOC23 = 0;
			LOC23 = HEX5BHEX5D_174475(b, 0);
			result = ispartof_327356(LOC22, LOC23);
			nimln(110, "aliases.nim");
			{
				...
				nimln(112, "aliases.nim");
				{
					...
					nimln(112, "aliases.nim");
					LOC37 = 0;
					LOC37 = HEX5BHEX5D_174475(a, 1);
					LOC35 = isdeepconstexpr_200696(LOC37);
					LA36: ;
					LOC34 = LOC35;
					if (!(LOC34)) goto LA38;
					nimln(112, "aliases.nim");
					nimln(112, "aliases.nim");
					LOC39 = 0;
					LOC39 = HEX5BHEX5D_174475(b, 1);
					LOC34 = isdeepconstexpr_200696(LOC39);
					LA38: ;
					if (!LOC34) goto LA40;
					...
					nimln(115, "aliases.nim");
					{
						...
						nimln(115, "aliases.nim");
						LOC44 = 0;
						LOC44 = HEX5BHEX5D_174475(a, 1);
						if (!((*LOC44).Kind == ((NU8) 58))) goto LA45;
						nimln(115, "aliases.nim");
						nimln(115, "aliases.nim");
						LOC47 = 0;
						LOC47 = HEX5BHEX5D_174475(a, 1);
						x = HEX5BHEX5D_174475(LOC47, 1);
					}					goto LA42;
					LA45: ;
					{
						nimln(115, "aliases.nim");
						x = HEX5BHEX5D_174475(a, 1);
					}					LA42: ;
					...
					nimln(116, "aliases.nim");
					{
						...
						nimln(116, "aliases.nim");
						LOC51 = 0;
						LOC51 = HEX5BHEX5D_174475(b, 1);
						if (!((*LOC51).Kind == ((NU8) 58))) goto LA52;
						nimln(116, "aliases.nim");
						nimln(116, "aliases.nim");
						LOC54 = 0;
						LOC54 = HEX5BHEX5D_174475(b, 1);
						y = HEX5BHEX5D_174475(LOC54, 1);
					}					goto LA49;
					LA52: ;
					{
						nimln(116, "aliases.nim");
						y = HEX5BHEX5D_174475(b, 1);
					}					LA49: ;
			...
			LA30: ;
			{
				nimln(123, "aliases.nim");
				{
					...
					nimln(124, "aliases.nim");
					{
						...
						nimln(124, "aliases.nim");
						LOC69 = 0;
						LOC69 = ispartof_327347((*a).Typ, (*b).Typ);
		...
		case ((NU8) 45):
		{
			...
			nimln(127, "aliases.nim");
			LOC73 = 0;
			LOC73 = HEX5BHEX5D_174475(a, 0);
			nimln(127, "aliases.nim");
			LOC74 = 0;
			LOC74 = HEX5BHEX5D_174475(b, 0);
			result = ispartof_327356(LOC73, LOC74);
			nimln(128, "aliases.nim");
			{
				...
				nimln(130, "aliases.nim");
				{
					...
					nimln(130, "aliases.nim");
					LOC81 = 0;
					LOC81 = HEX5BHEX5D_174475(a, 1);
					if (!(((TMP5027[(*LOC81).Kind/8] &(1<<((*LOC81).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5028));
					nimln(130, "aliases.nim");
					LOC82 = 0;
					LOC82 = HEX5BHEX5D_174475(b, 1);
					if (!(((TMP5027[(*LOC82).Kind/8] &(1<<((*LOC82).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5028));
		...
		case ((NU8) 47):
		{
			...
			nimln(134, "aliases.nim");
			LOC86 = 0;
			LOC86 = HEX5BHEX5D_174475(a, 0);
			nimln(134, "aliases.nim");
			LOC87 = 0;
			LOC87 = HEX5BHEX5D_174475(b, 0);
			result = ispartof_327356(LOC86, LOC87);
			nimln(136, "aliases.nim");
			{
				...
				nimln(137, "aliases.nim");
				{
					...
					nimln(137, "aliases.nim");
					LOC94 = 0;
					LOC94 = ispartof_327347((*a).Typ, (*b).Typ);
		...
		case ((NU8) 60):
		{
			...
			nimln(140, "aliases.nim");
			LOC98 = 0;
			LOC98 = HEX5BHEX5D_174475(a, 1);
			nimln(140, "aliases.nim");
			LOC99 = 0;
			LOC99 = HEX5BHEX5D_174475(b, 1);
			result = ispartof_327356(LOC98, LOC99);
		}		break;
		case ((NU8) 67):
		case ((NU8) 66):
		case ((NU8) 46):
		{
			...
			nimln(142, "aliases.nim");
			LOC101 = 0;
			LOC101 = HEX5BHEX5D_174475(a, 0);
			nimln(142, "aliases.nim");
			LOC102 = 0;
			LOC102 = HEX5BHEX5D_174475(b, 0);
			result = ispartof_327356(LOC101, LOC102);
		}		break;
		default:
		{
		}		break;
	...
	LA3: ;
	{
		...
		case ((NU8) 46):
		{
			...
			nimln(155, "aliases.nim");
			LOC106 = 0;
			LOC106 = HEX5BHEX5D_174475(b, 0);
			result = ispartof_327356(a, LOC106);
		}		break;
		case ((NU8) 65):
		case ((NU8) 47):
		{
			nimln(159, "aliases.nim");
			{
				...
				nimln(159, "aliases.nim");
				LOC110 = 0;
				LOC110 = ispartof_327347((*a).Typ, (*b).Typ);
				if (!!((LOC110 == ((NU8) 0)))) goto LA111;
				nimln(160, "aliases.nim");
				nimln(160, "aliases.nim");
				LOC113 = 0;
				LOC113 = HEX5BHEX5D_174475(b, 0);
				result = ispartof_327356(a, LOC113);
		...
		case ((NU8) 60):
		{
			...
			nimln(165, "aliases.nim");
			LOC119 = 0;
			LOC119 = HEX5BHEX5D_174475(b, 1);
			result = ispartof_327356(a, LOC119);
		}		break;
		case ((NU8) 3):
		{
			...
			case ((NU8) 46):
			{
				...
				nimln(172, "aliases.nim");
				LOC122 = 0;
				LOC122 = HEX5BHEX5D_174475(a, 0);
				result = ispartof_327356(LOC122, b);
			}			break;
			case ((NU8) 58):
			case ((NU8) 59):
			case ((NU8) 60):
			{
				...
				nimln(174, "aliases.nim");
				LOC124 = 0;
				LOC124 = HEX5BHEX5D_174475(a, 1);
				result = ispartof_327356(LOC124, b);
			}			break;
			case ((NU8) 65):
			case ((NU8) 47):
			{
				nimln(177, "aliases.nim");
				{
					...
					nimln(177, "aliases.nim");
					LOC128 = 0;
					LOC128 = ispartof_327347((*a).Typ, (*b).Typ);
					if (!!((LOC128 == ((NU8) 0)))) goto LA129;
					nimln(178, "aliases.nim");
					nimln(178, "aliases.nim");
					LOC131 = 0;
					LOC131 = HEX5BHEX5D_174475(a, 0);
					result = ispartof_327356(LOC131, b);
