...
#include <stdio.h>
typedef struct ttmplparser198016 ttmplparser198016;
...
N_NIMCALL(void, newline_198039)(ttmplparser198016* p);
...
N_NIMCALL(void, scanpar_198046)(ttmplparser198016* p, NI d);
N_NOINLINE(void, raiseIndexError)(void);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NOINLINE(void, raiseOverflow)(void);
static N_INLINE(NI, subInt)(NI a, NI b);
static N_INLINE(NIM_BOOL, withinexpr_198125)(ttmplparser198016* p);
N_NIMCALL(void, parseline_198134)(ttmplparser198016* p);
...
N_NIMCALL(NIM_CHAR, chararg_197014)(tnode173659* n, NimStringDesc* name, NI pos, NIM_CHAR default_197019);
N_NIMCALL(NimStringDesc*, strarg_197021)(tnode173659* n, NimStringDesc* name, NI pos, NimStringDesc* default_197026);
...
N_NIMCALL(void, newline_198039)(ttmplparser198016* p) {
	...
	llstreamwrite_163258((*p).Outp, LOC1);	nimln(41, "filter_tmpl.nim");
	(*p).Emitpar = 0;
	nimln(42, "filter_tmpl.nim");
	{
		...
		nimln(42, "filter_tmpl.nim");
		llstreamwrite_163258((*p).Outp, ((NimStringDesc*) &TMP2587));	}	LA4: ;
	nimln(43, "filter_tmpl.nim");
	{
		...
		llstreamwrite_163258((*p).Outp, LOC10);		nimln(45, "filter_tmpl.nim");
...
N_NIMCALL(void, parseline_198134)(ttmplparser198016* p) {
	...
	LA6: ;
	{
		...
		newline_198039(p);		nimln(74, "filter_tmpl.nim");
		j = addInt(j, 1);
		...
		scanpar_198046(p, j);		nimln(83, "filter_tmpl.nim");
		nimln(83, "filter_tmpl.nim");
		LOC13 = 0;
		nimln(83, "filter_tmpl.nim");
		LOC13 = withinexpr_198125(&(*p));
		if (LOC13) goto LA14;
		nimln(83, "filter_tmpl.nim");
		LOC13 = endswithopr_163437((*p).X);
		LA14: ;
		(*p).Pendingexprline = LOC13;
		nimln(84, "filter_tmpl.nim");
		nimln(84, "filter_tmpl.nim");
		LOC15 = 0;
		LOC15 = whichkeyword_151353(keyw);
		switch (LOC15) {
		case ((NU8) 20):
		{
			NimStringDesc* LOC22;
			...
			LA19: ;
			{
				...
				localerror_139349((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP2589));			}			LA17: ;
			nimln(91, "filter_tmpl.nim");
			nimln(91, "filter_tmpl.nim");
			LOC22 = 0;
			LOC22 = nsuRepeatChar((*p).Indent, 32);
			llstreamwrite_163258((*p).Outp, LOC22);			nimln(92, "filter_tmpl.nim");
			llstreamwrite_163258((*p).Outp, ((NimStringDesc*) &TMP2590));		}		break;
		case ((NU8) 28):
		case ((NU8) 64):
		case ((NU8) 60):
		case ((NU8) 65):
		...
		case ((NU8) 39):
		{
			...
			llstreamwrite_163258((*p).Outp, LOC24);			nimln(96, "filter_tmpl.nim");
			nimln(96, "filter_tmpl.nim");
			LOC25 = 0;
			LOC25 = copyStr((*p).X, d);
			llstreamwrite_163258((*p).Outp, LOC25);			nimln(97, "filter_tmpl.nim");
		...
		case ((NU8) 24):
		{
			...
			LOC27 = 0;
			LOC27 = nsuRepeatChar((NI64)(TMP2591), 32);
			llstreamwrite_163258((*p).Outp, LOC27);			nimln(100, "filter_tmpl.nim");
			nimln(100, "filter_tmpl.nim");
			LOC28 = 0;
			LOC28 = copyStr((*p).X, d);
			llstreamwrite_163258((*p).Outp, LOC28);		}		break;
		case ((NU8) 37):
		case ((NU8) 63):
		case ((NU8) 11):
		case ((NU8) 62):
		{
			...
			llstreamwrite_163258((*p).Outp, LOC30);			nimln(103, "filter_tmpl.nim");
			nimln(103, "filter_tmpl.nim");
			LOC31 = 0;
			LOC31 = copyStr((*p).X, d);
			llstreamwrite_163258((*p).Outp, LOC31);			nimln(104, "filter_tmpl.nim");
			{
				NIM_BOOL LOC34;
				nimln(104, "filter_tmpl.nim");
				nimln(104, "filter_tmpl.nim");
				LOC34 = 0;
				LOC34 = contains_86683((*p).X, TMP2592);
				if (!!(LOC34)) goto LA35;
		...
		default:
		{
			...
			llstreamwrite_163258((*p).Outp, LOC38);			nimln(109, "filter_tmpl.nim");
			nimln(109, "filter_tmpl.nim");
			LOC39 = 0;
			LOC39 = copyStr((*p).X, d);
			llstreamwrite_163258((*p).Outp, LOC39);		}		break;
		}
	...
	LA9: ;
	{
		...
		case ((NU8) 1):
		{
			...
			llstreamwrite_163258((*p).Outp, (*p).Conc);			nimln(122, "filter_tmpl.nim");
			llstreamwrite_163258((*p).Outp, ((NimStringDesc*) &TMP2587));			nimln(123, "filter_tmpl.nim");
			nimln(123, "filter_tmpl.nim");
			nimln(123, "filter_tmpl.nim");
			TMP2593 = addInt((*p).Indent, 2);
			LOC42 = 0;
			LOC42 = nsuRepeatChar((NI64)(TMP2593), 32);
			llstreamwrite_163258((*p).Outp, LOC42);			nimln(124, "filter_tmpl.nim");
			llstreamwrite_163258((*p).Outp, ((NimStringDesc*) &TMP2594));		}		break;
		case ((NU8) 0):
		{
			NimStringDesc* LOC44;
			nimln(126, "filter_tmpl.nim");
			newline_198039(p);			nimln(127, "filter_tmpl.nim");
			nimln(127, "filter_tmpl.nim");
			LOC44 = 0;
			LOC44 = nsuRepeatChar((*p).Indent, 32);
			llstreamwrite_163258((*p).Outp, LOC44);			nimln(128, "filter_tmpl.nim");
			llstreamwrite_163258((*p).Outp, (*p).Emit);			nimln(129, "filter_tmpl.nim");
			llstreamwrite_163258((*p).Outp, ((NimStringDesc*) &TMP2595));			nimln(130, "filter_tmpl.nim");
		...
		while (1) {
			...
			case 128 ... 255:
			{
				...
				llstreamwrite_163258((*p).Outp, ((NimStringDesc*) &TMP2596));				nimln(138, "filter_tmpl.nim");
				nimln(138, "filter_tmpl.nim");
				nimln(138, "filter_tmpl.nim");
				if ((NU)(j) > (NU)((*p).X->Sup.len)) raiseIndexError();
				LOC48 = 0;
				LOC48 = nsuToHex(((NI64) (((NU8)((*p).X->data[j])))), 2);
				llstreamwrite_163258((*p).Outp, LOC48);				nimln(139, "filter_tmpl.nim");
				j = addInt(j, 1);
			}			break;
			case 92:
			{
				nimln(141, "filter_tmpl.nim");
				llstreamwrite_163258((*p).Outp, ((NimStringDesc*) &TMP2597));				nimln(142, "filter_tmpl.nim");
				j = addInt(j, 1);
			}			break;
			case 39:
			{
				nimln(144, "filter_tmpl.nim");
				llstreamwrite_163258((*p).Outp, ((NimStringDesc*) &TMP2598));				nimln(145, "filter_tmpl.nim");
				j = addInt(j, 1);
			}			break;
			case 34:
			{
				nimln(147, "filter_tmpl.nim");
				llstreamwrite_163258((*p).Outp, ((NimStringDesc*) &TMP2599));				nimln(148, "filter_tmpl.nim");
				j = addInt(j, 1);
			}			break;
			default:
			{
				nimln(150, "filter_tmpl.nim");
				{
					...
					case 123:
					{
						...
						llstreamwrite_163263((*p).Outp, 34);						nimln(157, "filter_tmpl.nim");
						llstreamwrite_163258((*p).Outp, (*p).Conc);						nimln(158, "filter_tmpl.nim");
						llstreamwrite_163258((*p).Outp, (*p).Tostr);						nimln(159, "filter_tmpl.nim");
						llstreamwrite_163263((*p).Outp, 40);						nimln(160, "filter_tmpl.nim");
						j = addInt(j, 1);
						...
						while (1) {
							...
							case 0:
							{
								...
								localerror_139349((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP2600));								nimln(166, "filter_tmpl.nim");
								goto LA58;
							}							break;
							case 123:
							{
								...
								llstreamwrite_163263((*p).Outp, 123);							}							break;
							case 125:
							{
								...
								llstreamwrite_163263((*p).Outp, 125);							}							break;
							default:
							{
								nimln(177, "filter_tmpl.nim");
								if ((NU)(j) > (NU)((*p).X->Sup.len)) raiseIndexError();
								llstreamwrite_163263((*p).Outp, (*p).X->data[j]);								nimln(178, "filter_tmpl.nim");
								j = addInt(j, 1);
							}							break;
							}
						} LA58: ;
						nimln(179, "filter_tmpl.nim");
						llstreamwrite_163263((*p).Outp, 41);						nimln(180, "filter_tmpl.nim");
						llstreamwrite_163258((*p).Outp, (*p).Conc);						nimln(181, "filter_tmpl.nim");
						llstreamwrite_163263((*p).Outp, 34);					}					break;
					case 97 ... 122:
					case 65 ... 90:
					case 128 ... 255:
					{
						nimln(183, "filter_tmpl.nim");
						llstreamwrite_163263((*p).Outp, 34);						nimln(184, "filter_tmpl.nim");
						llstreamwrite_163258((*p).Outp, (*p).Conc);						nimln(185, "filter_tmpl.nim");
						llstreamwrite_163258((*p).Outp, (*p).Tostr);						nimln(186, "filter_tmpl.nim");
						llstreamwrite_163263((*p).Outp, 40);						nimln(187, "filter_tmpl.nim");
						while (1) {
							nimln(730, "system.nim");
							if ((NU)(j) > (NU)((*p).X->Sup.len)) raiseIndexError();
							...
							if ((NU)(j) > (NU)((*p).X->Sup.len)) raiseIndexError();
							llstreamwrite_163263((*p).Outp, (*p).X->data[j]);							nimln(189, "filter_tmpl.nim");
							j = addInt(j, 1);
						} LA72: ;
						nimln(190, "filter_tmpl.nim");
						llstreamwrite_163263((*p).Outp, 41);						nimln(191, "filter_tmpl.nim");
						llstreamwrite_163258((*p).Outp, (*p).Conc);						nimln(192, "filter_tmpl.nim");
						llstreamwrite_163263((*p).Outp, 34);					}					break;
					default:
					{
						nimln(194, "filter_tmpl.nim");
						{
							...
							llstreamwrite_163263((*p).Outp, (*p).Subschar);							nimln(196, "filter_tmpl.nim");
							j = addInt(j, 1);
						}						goto LA74;
						LA76: ;
						{
							...
							localerror_139349((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP2601));						}						LA74: ;
					}					break;
					}
				}				goto LA53;
				LA55: ;
				{
					...
					if ((NU)(j) > (NU)((*p).X->Sup.len)) raiseIndexError();
					llstreamwrite_163263((*p).Outp, (*p).X->data[j]);					nimln(202, "filter_tmpl.nim");
					j = addInt(j, 1);
				}				LA53: ;
			}			break;
			}
		...
		llstreamwrite_163258((*p).Outp, ((NimStringDesc*) &TMP2602));	}	LA2: ;
	popFrame();
}
static N_INLINE(tlineinfo137509, newlineinfo_137985)(NimStringDesc* filename, NI line, NI col) {
...
N_NIMCALL(tllstream163204*, filtertmpl_198006)(tllstream163204* stdin_198008, NimStringDesc* filename, tnode173659* call) {
	...
	p.Info = newlineinfo_137985(filename, 0, 0);
	nimln(208, "filter_tmpl.nim");
	p.Outp = llstreamopen_163218(((NimStringDesc*) &TMP2588));
	nimln(209, "filter_tmpl.nim");
	p.Inp = stdin_198008;
	nimln(210, "filter_tmpl.nim");
	p.Subschar = chararg_197014(call, ((NimStringDesc*) &TMP2603), 1, 36);
	nimln(211, "filter_tmpl.nim");
	p.Nimdirective = chararg_197014(call, ((NimStringDesc*) &TMP2604), 2, 35);
	nimln(212, "filter_tmpl.nim");
	p.Emit = strarg_197021(call, ((NimStringDesc*) &TMP2605), 3, ((NimStringDesc*) &TMP2606));
	nimln(213, "filter_tmpl.nim");
	p.Conc = strarg_197021(call, ((NimStringDesc*) &TMP2607), 4, ((NimStringDesc*) &TMP2608));
	nimln(214, "filter_tmpl.nim");
	p.Tostr = strarg_197021(call, ((NimStringDesc*) &TMP2609), 5, ((NimStringDesc*) &TMP2601));
	...
	while (1) {
		...
		parseline_198134(&p);	} LA1: ;
	nimln(219, "filter_tmpl.nim");
	newline_198039(&p);	nimln(220, "filter_tmpl.nim");
	result = p.Outp;
	nimln(221, "filter_tmpl.nim");
	llstreamclose_163238(p.Inp);	popFrame();
	return result;
