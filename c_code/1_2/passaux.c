...
STRING_LITERAL(TMP7600, "logpass: context is not nil", 27);
NIM_CONST tpass246015 verbosepass_520054 = {verboseopen_520007,
NIM_NIL,
verboseprocess_520014,
NIM_NIL}
;
static NIM_CONST TY188025 TMP7601 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7602, "sons", 4);
static NIM_CONST TY188025 TMP7604 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7605, "sym", 3);
...
N_NIMCALL(tnode187813*, verboseprocess_520014)(tpasscontext246003* context, tnode187813* n) {
	...
	nimln(22, "passaux.nim");
	{
		...
		nimln(22, "passaux.nim");
		internalerror_165606(((NimStringDesc*) &TMP7600));
	}
	LA3: ;
	nimln(23, "passaux.nim");
	{
		...
		gnotes_164178 |=((NI64)(1)<<(((((NU16) 265)- 230))%(sizeof(NI64)*8)));
...
static N_INLINE(NI, sonslen_188191)(tnode187813* n) {
	...
	{
		nimln(1301, "ast.nim");
		if (((TMP7601[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7602));
...
N_NIMCALL(tnode187813*, cleanup_520056)(tpasscontext246003* c, tnode187813* n) {
	...
	case ((NU8) 114):
	{
		...
		TMP7603 = subInt(LOC8, 1);
		HEX3Atmp_520197 = (NI64)(TMP7603);
	...
	case ((NU8) 80):
	{
		nimln(39, "passaux.nim");
		{
			...
			if (((TMP7601[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7602));
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!(((TMP7604[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7605));
			...
			nimln(41, "passaux.nim");
			{
				...
				if (((TMP7601[(*(*s).Ast).Kind/8] &(1<<((*(*s).Ast).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7602));
