...
N_NIMCALL(NI, llReadFromStdin_rgyTKC8s50wthTlyUpoMQg_2)(tyObject_TLLStream_IHsOGFu33dIY69a9bLlFHlHw* s, void* buf, NI bufLen);
...
N_NIMCALL(NIM_BOOL, endsWith_RTbJaR5kDAZUyj9bXErnbyg)(NimStringDesc* x, tySet_tyChar_nmiMWKVIe46vacnhAFrQvw s);
...
N_NIMCALL(void, llStreamWrite_p1fwzwO1YKdwAKg6V27RTw)(tyObject_TLLStream_IHsOGFu33dIY69a9bLlFHlHw* s, NimStringDesc* data);
...
STRING_LITERAL(TM_ml9aueblxGz9aYsRLKvPmpow_7, "\015\012", 2);
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST tySet_tyChar_nmiMWKVIe46vacnhAFrQvw TM_ml9aueblxGz9aYsRLKvPmpow_11 = {
...
N_NIMCALL(NIM_BOOL, readLineFromStdin_uSz3afZdESO5uHQzkWghlQ)(NimStringDesc* prompt, NimStringDesc** line) {
	...
	{
		if (!!(result)) goto LA3_;
		write_c4mGyJBvK73pdM22jiweKQ_2(stdout, ((NimStringDesc*) &TM_ml9aueblxGz9aYsRLKvPmpow_7));
		exit(((NI) 0));
	}
	LA3_: ;
	return result;
...
N_NIMCALL(NI, llStreamRead_rgyTKC8s50wthTlyUpoMQg)(tyObject_TLLStream_IHsOGFu33dIY69a9bLlFHlHw* s, void* buf, NI bufLen) {
	NI result;
	result = (NI)0;
	switch ((*s).kind) {
	case ((tyEnum_TLLStreamKind_jVcKY16LbOamXE9bxXUD6pQ) 0):
...
N_NIMCALL(void, llStreamWrite_qahxCxkD1WgPXDAm4CZKqw)(tyObject_TLLStream_IHsOGFu33dIY69a9bLlFHlHw* s, NIM_CHAR data) {
	NIM_CHAR c;
	c = (NIM_CHAR)0;
	switch ((*s).kind) {
	case ((tyEnum_TLLStreamKind_jVcKY16LbOamXE9bxXUD6pQ) 0):
...
N_NIMCALL(void, llStreamWriteln_p1fwzwO1YKdwAKg6V27RTw_2)(tyObject_TLLStream_IHsOGFu33dIY69a9bLlFHlHw* s, NimStringDesc* data) {
