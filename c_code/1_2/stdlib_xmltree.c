...
N_NIMCALL(void, addescaped_349039)(NimStringDesc** result, NimStringDesc* s);
...
N_NIMCALL(void, addescaped_349039)(NimStringDesc** result, NimStringDesc* s) {
	{
		...
		{
			while (1) {
				if (!(i_349048 < l_349050)) goto LA3;
				c_349044 = s->data[i_349048];
				switch (((NU8)(c_349044))) {
				case 60:
				{
...
appendString((*result), ((NimStringDesc*) &TMP4747));
				...
				default:
				{
					(*result) = addChar((*result), c_349044);
				}
				break;
				}
				i_349048 += ((NI) 1);
