...
N_NIMCALL(void, createfdset_579821_466562973)(Tfdset116049* fd0, TY584619* s0, NI* m0);
...
N_NIMCALL(NI, select_580060_466562973)(TY584619** readfds0, NI timeout0) {
	...
	m0 = ((NI) 0);
	createfdset_579821_466562973((&rd0), (*readfds0), (&m0));
	{
		int LOC5;
		if (!!((timeout0 == ((NI) -1)))) goto LA3;
		LOC5 = (int)0;
...
NIM_EXTERNC N_NOINLINE(void, stdlib_nativesocketsInit000)(void) {
	osinvalidsocket_575650_466562973 = INVALID_SOCKET;
	{
		...
		NI32 LOC6;
		LOC3 = (int)0;
		LOC3 = Dl_116346(((NI16) 257), (&wsa_580102_466562973));
