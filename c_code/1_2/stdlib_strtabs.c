...
static N_INLINE(NI, nexttry_124006)(NI h, NI maxhash) {
	...
	nimln(89, "strtabs.nim");
	TMP297 = mulInt(5, h);
	TMP298 = addInt((NI64)(TMP297), 1);
	result = (NI)((NI64)(TMP298) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, enlarge_124081)(tstringtable123810* t) {
	...
	n = (tkeyvaluepairseq123808*) newSeq((&NTI123808), (NI64)(TMP302));
	i_124124 = 0;
	HEX3Atmp_124142 = 0;
...
N_NIMCALL(tstringtable123810*, nstnewStringTableWithPairs)(NimStringDesc** keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	...
	while (1) {
		...
		nimln(176, "strtabs.nim");
		TMP315 = addInt(i, 1);
		if ((NU)((NI64)(TMP315)) >= (NU)(keyvaluepairsLen0)) raiseIndexError();
		nstPut(result, keyvaluepairs[i], keyvaluepairs[(NI64)(TMP315)]);
...
N_NIMCALL(NimStringDesc*, nstFormat)(NimStringDesc* f, tstringtable123810* t, NU8 flags) {
	...
	while (1) {
		...
		nimln(197, "strtabs.nim");
		{
			...
			nimln(198, "strtabs.nim");
			TMP316 = addInt(i, 1);
			if ((NU)((NI64)(TMP316)) > (NU)(f->Sup.len)) raiseIndexError();
			switch (((NU8)(f->data[(NI64)(TMP316)]))) {
			case 36:
			{
			...
			case 123:
			{
				...
				TMP319 = subInt(j, 1);
				LOC11 = 0;
				LOC11 = copyStrLast(f, (NI64)(TMP318), (NI64)(TMP319));
				LOC12 = 0;
...
appendString(result, LOC12);
			...
			case 95:
			{
				...
				TMP323 = subInt(j, 1);
				LOC17 = 0;
				LOC17 = copyStrLast(f, (NI64)(TMP322), (NI64)(TMP323));
				LOC18 = 0;
