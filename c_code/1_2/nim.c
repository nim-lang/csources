...
STRING_LITERAL(TMP1911, "nim.cfg", 7);
STRING_LITERAL(TMP4863, "js", 2);
STRING_LITERAL(TMP4864, "node ", 5);
STRING_LITERAL(TMP4865, "exe", 3);
...
N_NIMCALL(void, handlecmdline_611607)(void) {
	...
	LA4: ;
	{
		processcmdline_605209(((NU8) 0), ((NimStringDesc*) &TMP1887));
		{
			TSafePoint TMP1888;
			TY116404 p;
			NimStringDesc* LOC15;
			...
			pushSafePoint(&TMP1888);
			TMP1888.status = setjmp(TMP1888.context);
			if (TMP1888.status == 0) {
			...
			if (TMP1888.status != 0) reraiseException();
		...
		LA7: ;
		loadconfigs_220807(((NimStringDesc*) &TMP1911));
		initvars_202820();
		processcmdline_605209(((NU8) 1), ((NimStringDesc*) &TMP1887));
		maincommand_609027();
		{
			NimStringDesc* LOC22;
...
appendString(LOC44, arguments_210144);
					execexternalprogram_202907(LOC44, ((NimStringDesc*) &TMP1887));
				}
				goto LA31;
				LA33: ;
				{
					...
					LA48: ;
					{
						NimStringDesc* LOC51;
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_169234, ((NimStringDesc*) &TMP4865));
...
appendString(LOC52, arguments_210144);
					execexternalprogram_202907(LOC52, ((NimStringDesc*) &TMP1887));
				}
				LA31: ;
			}
			LA29: ;
