...
NIM_CONST TY124387 newlines_181014 = {
0x00, 0x24, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP1647, "L.sentinel < L.bufLen ", 22);
STRING_LITERAL(TMP1650, "toCopy >= 0 ", 12);
STRING_LITERAL(TMP1658, "s < L.bufLen ", 13);
STRING_LITERAL(TMP1662, "L.bufLen - oldBufLen == oldBufLen ", 34);
STRING_LITERAL(TMP1668, "pos <= L.sentinel ", 18);
STRING_LITERAL(TMP1670, "L.buf[pos] == CR ", 17);
STRING_LITERAL(TMP1671, "L.buf[pos] == LF ", 17);
STRING_LITERAL(TMP1672, "bufLen > 0 ", 11);
STRING_LITERAL(TMP1676, "", 0);
STRING_LITERAL(TMP1677, "\015\012", 2);
STRING_LITERAL(TMP1678, "^\015\012", 3);
...
N_NIMCALL(void, fillbuffer_181072)(tbaselexer181018* l) {
	...
	nimln(82, "nimlexbase.nim");
	{
		...
		nimln(82, "nimlexbase.nim");
		failedassertimpl_81621(((NimStringDesc*) &TMP1647));
	}
	LA3: ;
	nimln(83, "nimlexbase.nim");
	nimln(83, "nimlexbase.nim");
	nimln(83, "nimlexbase.nim");
	TMP1648 = subInt((*l).Buflen, (*l).Sentinel);
	TMP1649 = subInt((NI64)(TMP1648), 1);
	tocopy = (NI64)(TMP1649);
	nimln(84, "nimlexbase.nim");
	{
		...
		nimln(84, "nimlexbase.nim");
		failedassertimpl_81621(((NimStringDesc*) &TMP1650));
	}
	LA7: ;
	nimln(85, "nimlexbase.nim");
	{
		...
		nimln(86, "nimlexbase.nim");
		TMP1652 = mulInt(tocopy, 1);
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP1651)])), (NI64)(TMP1652));
	}
	LA11: ;
	...
	TMP1654 = mulInt((NI64)(TMP1653), 1);
	LOC13 = 0;
	LOC13 = llstreamread_179242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP1654));
	TMP1655 = divInt(LOC13, 1);
	charsread = (NI64)(TMP1655);
	nimln(90, "nimlexbase.nim");
	nimln(90, "nimlexbase.nim");
	TMP1656 = addInt(tocopy, charsread);
	s = (NI64)(TMP1656);
	nimln(91, "nimlexbase.nim");
	{
		...
		if (!(charsread < (NI64)(TMP1657))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			nimln(98, "nimlexbase.nim");
			{
				...
				nimln(98, "nimlexbase.nim");
				failedassertimpl_81621(((NimStringDesc*) &TMP1658));
			}
			LA22: ;
			...
			LA29: ;
			{
				...
				nimln(108, "nimlexbase.nim");
				TMP1659 = mulInt((*l).Buflen, 2);
				(*l).Buflen = (NI64)(TMP1659);
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				TMP1660 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4631(((void*) ((*l).Buf)), (NI64)(TMP1660));
				...
				nimln(110, "nimlexbase.nim");
				{
					...
					nimln(110, "nimlexbase.nim");
					nimln(110, "nimlexbase.nim");
					TMP1661 = subInt((*l).Buflen, oldbuflen);
					if (!!(((NI64)(TMP1661) == oldbuflen))) goto LA35;
					nimln(110, "nimlexbase.nim");
					failedassertimpl_81621(((NimStringDesc*) &TMP1662));
				}
				LA35: ;
				...
				nimln(111, "nimlexbase.nim");
				nimln(112, "nimlexbase.nim");
				TMP1663 = mulInt(oldbuflen, 1);
				LOC37 = 0;
				LOC37 = llstreamread_179242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP1663));
				TMP1664 = divInt(LOC37, 1);
				charsread = (NI64)(TMP1664);
...
N_NIMCALL(NI, fillbaselexer_181812)(tbaselexer181018* l, NI pos) {
	...
	nimln(120, "nimlexbase.nim");
	{
		...
		nimln(120, "nimlexbase.nim");
		failedassertimpl_81621(((NimStringDesc*) &TMP1668));
	}
	LA3: ;
...
N_NIMCALL(NI, handlecr_181050)(tbaselexer181018* l, NI pos) {
	...
	nimln(130, "nimlexbase.nim");
	{
		...
		nimln(130, "nimlexbase.nim");
		failedassertimpl_81621(((NimStringDesc*) &TMP1670));
	}
	LA3: ;
...
N_NIMCALL(NI, handlelf_181056)(tbaselexer181018* l, NI pos) {
	...
	nimln(137, "nimlexbase.nim");
	{
		...
		nimln(137, "nimlexbase.nim");
		failedassertimpl_81621(((NimStringDesc*) &TMP1671));
	}
	LA3: ;
...
N_NIMCALL(void, openbaselexer_181027)(tbaselexer181018* l, tllstream179204* inputstream, NI buflen) {
	...
	nimln(147, "nimlexbase.nim");
	{
		...
		nimln(147, "nimlexbase.nim");
		failedassertimpl_81621(((NimStringDesc*) &TMP1672));
	}
	LA3: ;
	...
	nimln(150, "nimlexbase.nim");
	nimln(150, "nimlexbase.nim");
	TMP1673 = mulInt(buflen, 1);
	LOC5 = 0;
	LOC5 = alloc_4601((NI64)(TMP1673));
	(*l).Buf = ((NCSTRING) (LOC5));
	nimln(151, "nimlexbase.nim");
	nimln(151, "nimlexbase.nim");
	TMP1674 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP1674);
...
N_NIMCALL(NI, getcolnumber_181045)(tbaselexer181018* l, NI pos) {
	...
	nimln(159, "nimlexbase.nim");
	nimln(159, "nimlexbase.nim");
	TMP1675 = subInt(pos, (*l).Linestart);
	if ((NI64)(TMP1675) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP1675));
	popFrame();
	return result;
}
...
N_NIMCALL(NimStringDesc*, getcurrentline_181040)(tbaselexer181018* l, NIM_BOOL marker) {
	...
	result = copyString(((NimStringDesc*) &TMP1676));
...
appendString(result, ((NimStringDesc*) &TMP1677));
...
appendString(LOC6, ((NimStringDesc*) &TMP1678));
...
static TNimNode* TMP1916[7];
static TNimNode TMP1622[8];
NTI181018.size = sizeof(tbaselexer181018);
NTI181018.kind = 17;
NTI181018.base = (&NTI2409);
TMP1916[0] = &TMP1622[1];
TMP1622[1].kind = 1;
TMP1622[1].offset = offsetof(tbaselexer181018, Bufpos);
TMP1622[1].typ = (&NTI106);
TMP1622[1].name = "bufpos";
TMP1916[1] = &TMP1622[2];
TMP1622[2].kind = 1;
TMP1622[2].offset = offsetof(tbaselexer181018, Buf);
TMP1622[2].typ = (&NTI145);
TMP1622[2].name = "buf";
TMP1916[2] = &TMP1622[3];
TMP1622[3].kind = 1;
TMP1622[3].offset = offsetof(tbaselexer181018, Buflen);
TMP1622[3].typ = (&NTI106);
TMP1622[3].name = "bufLen";
TMP1916[3] = &TMP1622[4];
TMP1622[4].kind = 1;
TMP1622[4].offset = offsetof(tbaselexer181018, Stream);
TMP1622[4].typ = (&NTI179206);
TMP1622[4].name = "stream";
TMP1916[4] = &TMP1622[5];
TMP1622[5].kind = 1;
TMP1622[5].offset = offsetof(tbaselexer181018, Linenumber);
TMP1622[5].typ = (&NTI106);
TMP1622[5].name = "lineNumber";
TMP1916[5] = &TMP1622[6];
TMP1622[6].kind = 1;
TMP1622[6].offset = offsetof(tbaselexer181018, Sentinel);
TMP1622[6].typ = (&NTI106);
TMP1622[6].name = "sentinel";
TMP1916[6] = &TMP1622[7];
TMP1622[7].kind = 1;
TMP1622[7].offset = offsetof(tbaselexer181018, Linestart);
TMP1622[7].typ = (&NTI106);
TMP1622[7].name = "lineStart";
TMP1622[0].len = 7; TMP1622[0].kind = 2; TMP1622[0].sons = &TMP1916[0];
NTI181018.node = &TMP1622[0];
}
