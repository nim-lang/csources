...
N_NIMCALL(NI, send_528677)(Socketimpl524404* socket, void* data, NI size);
...
N_NIMCALL(void, send_529001)(Socketimpl524404* socket, NimStringDesc* data, NU8 flags) {
	NI sent;
{	sent = send_528677(socket, ((void*) (data->data)), (data ? data->Sup.len : 0));
	{
		NI32 lasterror;
...
{	waited = 0.0;
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_527806(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5290));
			...
			LA4: ;
			{
				...
				LOC20 = 0;
				LOC20 = waitfor_527806(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5290));
