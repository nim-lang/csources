...
N_NIMCALL(void, md5Update_2rxQixjUkbT0w5WdNOCwMw)(MD5Context_oMciKUdSdCaIeMtcxbiPOw* c, NCSTRING input, NI len) {
	...
	NI PartLen;
	input_2 = input;
	Index = ((NI) ((NU32)((NU32)((NU64)((*c).count[(((NI) 0))- 0]) >> (NU64)(((NI) 3))) & ((NI) 63))));
	...
	LA3_: ;
	(*c).count[(((NI) 1))- 0] = (NU32)((NU32)((*c).count[(((NI) 1))- 0]) + (NU32)((NU32)((NU64)(((NU32) (len))) >> (NU64)(((NI) 29)))));
	...
	i = ((NI) 0);
	{
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				dest[(NI)(i + ((NI) 1))] = ((NU8) ((NU32)((NU32)((NU64)(src[j]) >> (NU64)(((NI) 8))) & ((NU32) 255))));
				dest[(NI)(i + ((NI) 2))] = ((NU8) ((NU32)((NU32)((NU64)(src[j]) >> (NU64)(((NI) 16))) & ((NU32) 255))));
				dest[(NI)(i + ((NI) 3))] = ((NU8) ((NU32)((NU32)((NU64)(src[j]) >> (NU64)(((NI) 24))) & ((NU32) 255))));
				i += ((NI) 4);
				res += ((NI) 1);
			} LA3: ;
		}
