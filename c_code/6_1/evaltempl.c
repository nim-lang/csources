...
N_NIMCALL(tnode224819*, evaltemplateargs_451217)(tnode224819* n, tsym224849* s) {
	...
	{
		if (!(f < a)) goto LA5;
		globalerror_197917((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP2812));
	}
	LA5: ;
		...
		res_451313 = 1;
		{
			while (1) {
				...
				LA10: ;
				{
					...
					LA18: ;
					if (!LOC17) goto LA19;
					localerror_197938((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP2812));
				}
				LA19: ;
...
N_NIMCALL(tnode224819*, evaltemplate_451334)(tnode224819* n, tsym224849* tmpl, tsym224849* gensymowner) {
	...
	evaltemplatecounter_451330 += 1;
	{
		...
		globalerror_197917((*n).Info, ((NU16) 183), ((NimStringDesc*) &TMP2812));
		result = n;
	}
	LA3: ;
