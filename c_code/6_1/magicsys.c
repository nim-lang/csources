...
static NIM_CONST TY186025 TMP3140 = {
...
N_NIMCALL(tsym185843*, getsyssym_240040)(NimStringDesc* name) {
	...
	if (!(((64 &(1<<(((*systemmodule_240017).Kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3116));
	nimln(39, "magicsys.nim");
	LOC1 = 0;
...
N_NIMCALL(ttype185847*, getsystype_240024)(NU8 kind) {
	...
	nimln(63, "magicsys.nim");
	{
		...
		case ((NU8) 28):
		{
			...
			result = systypefromname_240204(((NimStringDesc*) &TMP3133));
		}
		break;
		case ((NU8) 29):
		{
			nimln(82, "magicsys.nim");
			result = systypefromname_240204(((NimStringDesc*) &TMP3134));
		}
		break;
		case ((NU8) 26):
		{
			nimln(83, "magicsys.nim");
			result = systypefromname_240204(((NimStringDesc*) &TMP3135));
		}
		break;
		case ((NU8) 5):
		{
...
N_NIMCALL(void, setintlittype_240517)(tnode185813* result) {
	...
	default:
	{
		...
		internalerror_163591((*result).Info, ((NimStringDesc*) &TMP3142));
	}
	break;
	}
	popFrame();
