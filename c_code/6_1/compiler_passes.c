...
static NIM_CONST TY172865 TMP3131 = {
...
N_NIMCALL(NIM_BOOL, processtoplevelstmt_223341)(tnode172659* n, tpasscontext223003** a) {
	...
	nimln(134, "passes.nim");
	TMP3136 = subInt(gpasseslen_223161, 1);
	HEX3Atmp_223372 = (NI32)(TMP3136);
	nimln(1301, "system.nim");
	res_223374 = 0;
	nimln(1302, "system.nim");
	while (1) {
...
N_NIMCALL(void, processtoplevelstmtcached_223379)(tnode172659* n, tpasscontext223003** a) {
	...
	nimln(143, "passes.nim");
	TMP3137 = subInt(gpasseslen_223161, 1);
	HEX3Atmp_223401 = (NI32)(TMP3137);
	nimln(1301, "system.nim");
	res_223403 = 0;
	nimln(1302, "system.nim");
	while (1) {
...
N_NIMCALL(void, closepassescached_223408)(tpasscontext223003** a) {
	...
	nimln(148, "passes.nim");
	TMP3138 = subInt(gpasseslen_223161, 1);
	HEX3Atmp_223436 = (NI32)(TMP3138);
	nimln(1301, "system.nim");
	res_223438 = 0;
	nimln(1302, "system.nim");
	while (1) {
...
NTI223003.flags = 3;
TMP3019[0].kind = 1;
TMP3019[0].offset = offsetof(tpasscontext223003, Fromcache);
TMP3019[0].typ = (&NTI133);
TMP3019[0].name = "fromCache";
NTI223003.node = &TMP3019[0];
}
