...
static NIM_CONST TY211607 TMP1872 = {
			...
			current_169890 = copyString(path);
			{
				while (1) {
					...
					parents += 1;
					{
						...
						file_169844 = 0;
						HEX3Atmp_169861 = 0;
						HEX3Atmp_169861 = HEX2F_116899(d_169831, ((NimStringDesc*) &TMP1349));
					...
					}
					{
						...
						file_169845 = 0;
						HEX3Atmp_169875 = 0;
						HEX3Atmp_169875 = HEX2F_116899(d_169831, ((NimStringDesc*) &TMP1350));
...
N_NIMCALL(NimStringDesc*, getgeneratedpath_169429)(void) {
	...
	LA3: ;
	{
		...
		result = HEX2F_116899(LOC6, ((NimStringDesc*) &TMP1351));
	}
	LA1: ;
	return result;
}
...
static N_INLINE(void, writeln_170205)(FILE* f_170209, NimStringDesc** x_170213, NI x_170213Len0) {
	...
	write_12665(f_170209, ((NimStringDesc*) &TMP1353));
}
...
N_NIMCALL(void, incldynliboverride_170481)(NimStringDesc* lib) {
	...
	nstPut(gdlloverrides_169230, LOC1, ((NimStringDesc*) &TMP1873));
}
