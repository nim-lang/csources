...
N_NIMCALL(NIM_BOOL, boolarg_238038)(tnode209818* n, NimStringDesc* name, NI pos, NIM_BOOL default_238043) {
	...
	LA3: ;
	{
		...
		LOC6 = ((*x).Kind == ((NU8) 2));
		if (!(LOC6)) goto LA7;
		LOC6 = identeq_185493((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP1355));
		LA7: ;
		if (!LOC6) goto LA8;
		result = NIM_TRUE;
	}
	...
	LA8: ;
	{
		...
		LOC11 = ((*x).Kind == ((NU8) 2));
		if (!(LOC11)) goto LA12;
		LOC11 = identeq_185493((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP1356));
		LA12: ;
		if (!LOC11) goto LA13;
		result = NIM_FALSE;
	}
...
N_NIMCALL(tllstream196204*, filterstrip_238012)(tllstream196204* stdin_238014, NimStringDesc* filename, tnode209818* call) {
	...
	NimStringDesc* line;
	result = 0;
	pattern = strarg_238029(call, ((NimStringDesc*) &TMP1353), 1, ((NimStringDesc*) &TMP1354));
	leading = boolarg_238038(call, ((NimStringDesc*) &TMP1357), 2, NIM_TRUE);
	trailing = boolarg_238038(call, ((NimStringDesc*) &TMP1358), 3, NIM_TRUE);
	result = llstreamopen_196220(((NimStringDesc*) &TMP1354));
...
N_NIMCALL(tllstream196204*, filterreplace_238004)(tllstream196204* stdin_238006, NimStringDesc* filename, tnode209818* call) {
	...
	NimStringDesc* line;
	result = 0;
	sub = strarg_238029(call, ((NimStringDesc*) &TMP1359), 1, ((NimStringDesc*) &TMP1354));
	{
		if (!(sub->Sup.len == 0)) goto LA3;
		invalidpragma_238047(call);
	}
	LA3: ;
	by = strarg_238029(call, ((NimStringDesc*) &TMP1360), 2, ((NimStringDesc*) &TMP1354));
	result = llstreamopen_196220(((NimStringDesc*) &TMP1354));
	line = rawNewString(80);
	{
		while (1) {
