...
N_NIMCALL(void, fillbuffer_181072)(tbaselexer181018* l) {
	...
	LOC13 = 0;
	LOC13 = llstreamread_179242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI32)(TMP1659));
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				LOC37 = 0;
				LOC37 = llstreamread_179242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI32)(TMP1668));
...
TMP1921[0] = &TMP1627[1];
TMP1627[1].kind = 1;
TMP1627[1].offset = offsetof(tbaselexer181018, Bufpos);
TMP1627[1].typ = (&NTI106);
TMP1627[1].name = "bufpos";
TMP1921[1] = &TMP1627[2];
TMP1627[2].kind = 1;
TMP1627[2].offset = offsetof(tbaselexer181018, Buf);
TMP1627[2].typ = (&NTI145);
TMP1627[2].name = "buf";
TMP1921[2] = &TMP1627[3];
TMP1627[3].kind = 1;
TMP1627[3].offset = offsetof(tbaselexer181018, Buflen);
TMP1627[3].typ = (&NTI106);
TMP1627[3].name = "bufLen";
TMP1921[3] = &TMP1627[4];
TMP1627[4].kind = 1;
TMP1627[4].offset = offsetof(tbaselexer181018, Stream);
TMP1627[4].typ = (&NTI179206);
TMP1627[4].name = "stream";
TMP1921[4] = &TMP1627[5];
TMP1627[5].kind = 1;
TMP1627[5].offset = offsetof(tbaselexer181018, Linenumber);
TMP1627[5].typ = (&NTI106);
TMP1627[5].name = "lineNumber";
TMP1921[5] = &TMP1627[6];
TMP1627[6].kind = 1;
TMP1627[6].offset = offsetof(tbaselexer181018, Sentinel);
TMP1627[6].typ = (&NTI106);
TMP1627[6].name = "sentinel";
TMP1921[6] = &TMP1627[7];
TMP1627[7].kind = 1;
TMP1627[7].offset = offsetof(tbaselexer181018, Linestart);
TMP1627[7].typ = (&NTI106);
TMP1627[7].name = "lineStart";
TMP1627[0].len = 7; TMP1627[0].kind = 2; TMP1627[0].sons = &TMP1921[0];
NTI181018.node = &TMP1627[0];
}
