...
N_NIMCALL(NimStringDesc*, mnewString)(NI len);
STRING_LITERAL(TMP2832, "cannot write to stream", 22);
STRING_LITERAL(TMP3059, "", 0);
...
N_NIMCALL(NI, fspeekdata_145288)(Streamobj144418* s, void* buffer, NI buflen) {
	...
	pushSafePoint(&TMP2831);
	TMP2831.status = _setjmp(TMP2831.context);
	if (TMP2831.status == 0) {
		result = readbuffer_15554((*((Filestreamobj145248*) (s))).f, buffer, ((NI) (buflen)));
		popSafePoint();
	}
	...
	if (TMP2831.status != 0) reraiseException();
	return result;
}
...
N_NIMCALL(void, fswritedata_145295)(Streamobj144418* s, void* buffer, NI buflen) {
	{
		...
		LOC6 = 0;
		LOC6 = neweio_144402(((NimStringDesc*) &TMP2832));
...
N_NIMCALL(NimStringDesc*, readline_145133)(Streamobj144418* s) {
	...
	result = 0;
	result = copyString(((NimStringDesc*) &TMP3059));
	{
		while (1) {
			NIM_CHAR c;
			c = readchar_144626(s);
