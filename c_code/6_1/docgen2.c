...
N_NIMCALL(tnode185813*, close_520014)(tpasscontext244003* p, tnode185813* n) {
	...
	nimln(25, "docgen2.nim");
	{
		...
		writeoutput_342719((*g).Doc, LOC7, ((NimStringDesc*) &TMP7626), usewarning);
...
TMP7625[0] = &TMP7623[1];
TMP7623[1].kind = 1;
TMP7623[1].offset = offsetof(tgen520008, Doc);
TMP7623[1].typ = (&NTI339007);
TMP7623[1].name = "doc";
TMP7625[1] = &TMP7623[2];
TMP7623[2].kind = 1;
TMP7623[2].offset = offsetof(tgen520008, Module);
TMP7623[2].typ = (&NTI185811);
TMP7623[2].name = "module";
TMP7623[0].len = 2; TMP7623[0].kind = 2; TMP7623[0].sons = &TMP7625[0];
NTI520008.node = &TMP7623[0];
NTI520010.size = sizeof(tgen520008*);
NTI520010.kind = 22;
NTI520010.base = (&NTI520008);
NTI520010.marker = TMP7628;
}
