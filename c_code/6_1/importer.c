...
static NIM_CONST TY192025 TMP3280 = {
...
N_NIMCALL(NimStringDesc*, getmodulename_259012)(tnode191813* n) {
	...
	case ((NU8) 29):
	{
		...
		nimln(31, "importer.nim");
		{
			...
			nimln(31, "importer.nim");
			LOC9 = 0;
			LOC9 = getident_170456(((NimStringDesc*) &TMP3286));
	...
	nimln(71, "importer.nim");
	{
		...
		nimln(73, "importer.nim");
		{
			...
			while (1) {
				...
				if (!(((TMP3282[(*(*(*etyp).N).kindU.S6.Sons->data[j_259322]).Kind/8] &(1<<((*(*(*etyp).N).kindU.S6.Sons->data[j_259322]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3283));
				...
				nimln(76, "importer.nim");
				{
					...
					internalerror_168591((*s).Info, ((NimStringDesc*) &TMP3292));
				}
				LA25: ;
...
N_NIMCALL(void, importsymbol_259416)(tcontext254019* c, tnode191813* n, tsym191843* frommod) {
	...
	LA3: ;
	{
		...
		nimln(102, "importer.nim");
		{
			...
			internalerror_168591((*n).Info, ((NimStringDesc*) &TMP3294));
		}
		LA12: ;
		...
		case ((NU8) 16):
		{
			...
			while (1) {
				...
				nimln(111, "importer.nim");
				{
					...
					nimln(111, "importer.nim");
					internalerror_168591((*n).Info, ((NimStringDesc*) &TMP3295));
				}
				LA18: ;
...
N_NIMCALL(void, importforwarded_259633)(tcontext254019* c, tnode191813* n, tintset188047 exceptset) {
	...
	case ((NU8) 117):
	{
		...
		while (1) {
			...
			if (!(((TMP3282[(*a_259649).Kind/8] &(1<<((*a_259649).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3283));
	...
	case ((NU8) 118):
	{
		...
		localerror_168571((*n).Info, ((NU16) 4), ((NimStringDesc*) &TMP3298));
	}
	break;
	default:
	{
