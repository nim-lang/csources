...
static NIM_CONST TY172865 TMP5595 = {
...
static N_INLINE(ttype172693*, lastson_173034)(ttype172693* n) {
	...
	if ((NU)((NI32)(TMP5601)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP5601)];
	popFrame();
	return result;
}
N_NIMCALL(ttype172693*, getuniquetype_367401)(ttype172693* key) {
	...
	case ((NU8) 55):
	{
		...
		internalerror_139383(((NimStringDesc*) &TMP5599));	}	break;
	case ((NU8) 12):
	{
		nimln(92, "ccgutils.nim");
		internalerror_139383(((NimStringDesc*) &TMP5600));	}	break;
	case ((NU8) 11):
	case ((NU8) 13):
	case ((NU8) 15):
	case ((NU8) 47):
...
N_NIMCALL(trope121007*, makellvmstring_367621)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(170, "ccgutils.nim");
		{
			...
			nimln(170, "ccgutils.nim");
			nimln(170, "ccgutils.nim");
			TMP5605 = addInt(i_367636, 1);
			TMP5606 = modInt((NI32)(TMP5605), 64);
			if (!(((NI) ((NI32)(TMP5606))) == 0)) goto LA4;
