...
STRING_LITERAL(TMP1871, "/usr", 4);
STRING_LITERAL(TMP1872, "/usr/lib/nim", 12);
STRING_LITERAL(TMP1873, "/usr/local", 10);
STRING_LITERAL(TMP1874, "/usr/local/lib/nim", 18);
STRING_LITERAL(TMP1875, "lib", 3);
STRING_LITERAL(TMP1876, "@", 1);
STRING_LITERAL(TMP1877, "\')\'", 3);
STRING_LITERAL(TMP1878, "\':\'", 3);
STRING_LITERAL(TMP1879, "@if", 3);
...
STRING_LITERAL(TMP1895, "nimcfg", 6);
STRING_LITERAL(TMP1896, "nim.cfg", 7);
STRING_LITERAL(TMP1897, "nimrod.cfg", 10);
...
N_NIMCALL(NIM_BOOL, parseatom_185048)(Tlexer180185* L, Ttoken180181* tok) {
	...
	result = 0;
	{
		...
		LA7: ;
		{
			lexmessage_180483((&(*L)), ((NU16) 23), ((NimStringDesc*) &TMP1877));
		}
		LA5: ;
	}
	goto LA1;
		...
		while (1) {
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = eqStrings((*(*tok).ident).s, ((NimStringDesc*) &TMP1876));
				LA6: ;
				if (!LOC5) goto LA7;
				ppgettok_185009(L, tok);
				LOC9 = 0;
...
N_NIMCALL(void, parsedirective_185344)(Tlexer180185* L, Ttoken180181* tok) {
	...
	default:
	{
		...
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP1882))) goto LA15;
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP1883))) goto LA16;
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP1884))) goto LA17;
		goto LA18;
		LA15: ;
		{
			NimStringDesc* key;
...
N_NIMCALL(void, conftok_185379)(Tlexer180185* L, Ttoken180181* tok) {
	ppgettok_185009(L, tok);
	{
		while (1) {
			...
			if (!(LOC3)) goto LA4;
			LOC3 = eqStrings((*(*tok).ident).s, ((NimStringDesc*) &TMP1876));
			LA4: ;
			if (!LOC3) goto LA2;
...
N_NIMCALL(void, parseassignment_185441)(Tlexer180185* L, Ttoken180181* tok) {
	...
	Tident166021* LOC22;
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = getident_166463(((NimStringDesc*) &TMP1885));
		LOC3 = ((*(*tok).ident).Sup.id == (*LOC4).Sup.id);
		if (LOC3) goto LA5;
		LOC6 = 0;
		LOC6 = getident_166463(((NimStringDesc*) &TMP1886));
...
appendString(val, LOC16);
		...
		LA19: ;
		{
			lexmessage_180483((&(*L)), ((NU16) 23), ((NimStringDesc*) &TMP1888));
		}
		LA17: ;
		val = addChar(val, 93);
	}
	LA14: ;
	LOC22 = 0;
	LOC22 = getident_166463(((NimStringDesc*) &TMP1889));
...
appendString(val, LOC33);
		conftok_185379(L, tok);
		{
			while (1) {
				...
				if (!(LOC36)) goto LA37;
				LOC38 = 0;
				LOC38 = getident_166463(((NimStringDesc*) &TMP1890));
...
N_NIMCALL(void, loadconfigs_185811)(NimStringDesc* cfg) {
	NimStringDesc* pd;
	{
		...
		{
			NimStringDesc* LOC9;
			if (!eqStrings(prefix, ((NimStringDesc*) &TMP1871))) goto LA7;
			LOC9 = 0;
			LOC9 = libpath_153233; libpath_153233 = copyStringRC1(((NimStringDesc*) &TMP1872));
		...
		{
			NimStringDesc* LOC13;
			if (!eqStrings(prefix, ((NimStringDesc*) &TMP1873))) goto LA11;
			LOC13 = 0;
			LOC13 = libpath_153233; libpath_153233 = copyStringRC1(((NimStringDesc*) &TMP1874));
			if (LOC13) nimGCunrefNoCycle(LOC13);
		}
		goto LA5;
		LA11: ;
		{
			asgnRefNoCycle((void**) (&libpath_153233), nosjoinPath(prefix, ((NimStringDesc*) &TMP1875)));
		}
		LA5: ;
	}
	LA3: ;
	...
	LA32: ;
	{
		...
		readconfigfile_185522(LOC74);
		{
			...
			projectconfig = noschangeFileExt(gprojectfull_153236, ((NimStringDesc*) &TMP1895));
			{
				NIM_BOOL LOC81;
				LOC81 = 0;
