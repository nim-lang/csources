...
static N_INLINE(void, setid_171432)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP1939 = addInt(id, 1);
	gfrontendid_171006 = ((gfrontendid_171006 >= (NI32)(TMP1939)) ? gfrontendid_171006 : (NI32)(TMP1939));
	popFrame();
}
static N_INLINE(NI, divInt)(NI a, NI b) {
	NI result;
...
N_NIMCALL(void, idsynchronizationpoint_171440)(NI idrange) {
	...
	nimln(41, "idgen.nim");
	nimln(41, "idgen.nim");
	TMP1940 = divInt(gfrontendid_171006, idrange);
	TMP1941 = addInt((NI32)(TMP1940), 1);
	TMP1942 = mulInt((NI32)(TMP1941), idrange);
	TMP1943 = addInt((NI32)(TMP1942), 1);
	gfrontendid_171006 = (NI32)(TMP1943);
	popFrame();
}
N_NIMCALL(NimStringDesc*, togid_171445)(NimStringDesc* f) {
	...
	result = 0;
	nimln(47, "idgen.nim");
	result = completegeneratedfilepath_114490(((NimStringDesc*) &TMP1944), NIM_TRUE);
	popFrame();
	return result;
}
static N_INLINE(void, writeln_114502)(FILE* f, NimStringDesc** x, NI xLen0) {
