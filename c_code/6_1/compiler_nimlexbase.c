...
N_NIMCALL(void, fillbuffer_163072)(tbaselexer163018* l) {
	...
	LOC13 = 0;
	LOC13 = llstreamread_162242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI32)(TMP1631));
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				LOC37 = 0;
				LOC37 = llstreamread_162242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI32)(TMP1640));
...
N_NIMCALL(void, openbaselexer_163027)(tbaselexer163018* l, tllstream162204* inputstream, NI buflen) {
	...
	LOC5 = 0;
	LOC5 = alloc_4001((NI32)(TMP1650));
	(*l).Buf = ((NCSTRING) (LOC5));
	nimln(151, "nimlexbase.nim");
	nimln(151, "nimlexbase.nim");
	TMP1651 = subInt(buflen, 1);
	(*l).Sentinel = (NI32)(TMP1651);
...
N_NIMCALL(NI, getcolnumber_163045)(tbaselexer163018* l, NI pos) {
	...
	if ((NI32)(TMP1652) == (-2147483647 -1)) raiseOverflow();
	result = (NI32)abs((NI32)(TMP1652));
	popFrame();
	return result;
}
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src) {
...
TMP1893[0] = &TMP1599[1];
TMP1599[1].kind = 1;
TMP1599[1].offset = offsetof(tbaselexer163018, Bufpos);
TMP1599[1].typ = (&NTI105);
TMP1599[1].name = "bufpos";
TMP1893[1] = &TMP1599[2];
TMP1599[2].kind = 1;
TMP1599[2].offset = offsetof(tbaselexer163018, Buf);
TMP1599[2].typ = (&NTI144);
TMP1599[2].name = "buf";
TMP1893[2] = &TMP1599[3];
TMP1599[3].kind = 1;
TMP1599[3].offset = offsetof(tbaselexer163018, Buflen);
TMP1599[3].typ = (&NTI105);
TMP1599[3].name = "bufLen";
TMP1893[3] = &TMP1599[4];
TMP1599[4].kind = 1;
TMP1599[4].offset = offsetof(tbaselexer163018, Stream);
TMP1599[4].typ = (&NTI162206);
TMP1599[4].name = "stream";
TMP1893[4] = &TMP1599[5];
TMP1599[5].kind = 1;
TMP1599[5].offset = offsetof(tbaselexer163018, Linenumber);
TMP1599[5].typ = (&NTI105);
TMP1599[5].name = "LineNumber";
TMP1893[5] = &TMP1599[6];
TMP1599[6].kind = 1;
TMP1599[6].offset = offsetof(tbaselexer163018, Sentinel);
TMP1599[6].typ = (&NTI105);
TMP1599[6].name = "sentinel";
TMP1893[6] = &TMP1599[7];
TMP1599[7].kind = 1;
TMP1599[7].offset = offsetof(tbaselexer163018, Linestart);
TMP1599[7].typ = (&NTI105);
TMP1599[7].name = "lineStart";
TMP1599[0].len = 7; TMP1599[0].kind = 2; TMP1599[0].sons = &TMP1893[0];
NTI163018.node = &TMP1599[0];
}
