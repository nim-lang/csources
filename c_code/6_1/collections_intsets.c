...
static N_INLINE(NIM_BOOL, mustrehash_169054)(NI length, NI counter) {
	...
	LOC5 = ((NI32)(TMP1917) < (NI32)(TMP1918));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
...
static N_INLINE(NI, nexttry_169205)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1920 = mulInt(5, h);
	TMP1921 = addInt((NI32)(TMP1920), 1);
	result = (NI)((NI32)(TMP1921) & maxhash);
	popFrame();
	return result;
}
N_NIMCALL(ttrunk169039*, intsetget_169212)(tintset169043 t, NI key) {
...
N_NIMCALL(void, intsetenlarge_169604)(tintset169043* t) {
	...
	TMP1925 = mulInt((NI32)(TMP1924), 2);
	TMP1926 = subInt((NI32)(TMP1925), 1);
	(*t).Max = (NI32)(TMP1926);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1927 = addInt((*t).Max, 1);
	n = (ttrunkseq169041*) newSeq((&NTI169041), (NI32)(TMP1927));
	i_169629 = 0;
...
N_NIMCALL(ttrunk169039*, intsetput_169661)(tintset169043* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_169054((NI32)(TMP1931), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
...
TMP1928[0] = &TMP1914[1];
TMP1914[1].kind = 1;
TMP1914[1].offset = offsetof(ttrunk169039, Next);
TMP1914[1].typ = (&NTI169037);
TMP1914[1].name = "next";
TMP1928[1] = &TMP1914[2];
TMP1914[2].kind = 1;
TMP1914[2].offset = offsetof(ttrunk169039, Key);
TMP1914[2].typ = (&NTI105);
TMP1914[2].name = "key";
TMP1928[2] = &TMP1914[3];
TMP1914[3].kind = 1;
TMP1914[3].offset = offsetof(ttrunk169039, Bits);
TMP1914[3].typ = (&NTI21418);
TMP1914[3].name = "bits";
TMP1914[0].len = 3; TMP1914[0].kind = 2; TMP1914[0].sons = &TMP1928[0];
NTI169039.node = &TMP1914[0];
NTI169037.size = sizeof(ttrunk169039*);
NTI169037.kind = 22;
NTI169037.base = (&NTI169039);
NTI169037.marker = TMP1929;
NTI169041.size = sizeof(ttrunkseq169041*);
NTI169041.kind = 24;
NTI169041.base = (&NTI169037);
NTI169041.flags = 2;
NTI169041.marker = TMP1930;
...
TMP3354[0] = &TMP1914[5];
TMP1914[5].kind = 1;
TMP1914[5].offset = offsetof(tintset169043, Counter);
TMP1914[5].typ = (&NTI105);
TMP1914[5].name = "counter";
TMP3354[1] = &TMP1914[6];
TMP1914[6].kind = 1;
TMP1914[6].offset = offsetof(tintset169043, Max);
TMP1914[6].typ = (&NTI105);
TMP1914[6].name = "max";
TMP3354[2] = &TMP1914[7];
TMP1914[7].kind = 1;
TMP1914[7].offset = offsetof(tintset169043, Head);
TMP1914[7].typ = (&NTI169037);
TMP1914[7].name = "head";
TMP3354[3] = &TMP1914[8];
TMP1914[8].kind = 1;
TMP1914[8].offset = offsetof(tintset169043, Data);
TMP1914[8].typ = (&NTI169041);
TMP1914[8].name = "data";
TMP1914[4].len = 4; TMP1914[4].kind = 2; TMP1914[4].sons = &TMP3354[0];
NTI169043.node = &TMP1914[4];
}
