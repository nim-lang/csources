...
static NIM_CONST TY177407 TMP1538 = {
...
N_NIMCALL(void, initoptparser_174030)(NimStringDesc* cmdline, Optparser174011* Result) {
	...
	LA3: ;
	{
		unsureAsgnRef((void**) (&(*Result).cmd), copyString(((NimStringDesc*) &TMP1535)));
		{
			NI i_174046;
			NI HEX3Atmp_174049;
			NI res_174052;
...
appendChar(LOC9, 32);
	...
	LA1: ;
	(*Result).kind = ((NU8) 0);
	unsureAsgnRef((void**) (&(*Result).key), copyString(((NimStringDesc*) &TMP1537)));
	unsureAsgnRef((void**) (&(*Result).val), copyString(((NimStringDesc*) &TMP1537)));
}
...
N_NIMCALL(void, handleshortoption_174291)(Optparser174011* p) {
	...
	}
	{
		...
		i = parseword_174204((*p).cmd, i, (&(*p).val), TMP1538);
	}
	LA5: ;
	{
...
{	i = (*p).pos;
	...
	case 45:
	{
		i += ((NI) 1);
		{
			...
			(*p).kind = ((NU8) 2);
			i += ((NI) 1);
			i = parseword_174204((*p).cmd, i, (&(*p).key), TMP1539);
			{
				while (1) {
			...
			}
			{
				...
				(*p).pos = parseword_174204((*p).cmd, i, (&(*p).val), TMP1538);
			}
			goto LA15;
			LA17: ;
			{
	...
	{
		(*p).kind = ((NU8) 1);
		(*p).pos = parseword_174204((*p).cmd, i, (&(*p).key), TMP1538);
	}
	break;
	}
	}BeforeRet: ;
...
static TNimNode* TMP1531[6];
static TNimNode* TMP1532[4];
NI TMP1534;
static char* NIM_CONST TMP1533[4] = {
"cmdEnd", 
"cmdArgument", 
"cmdLongOption", 
"cmdShortOption"};
...
NTI174009.base = 0;
NTI174009.flags = 3;
for (TMP1534 = 0; TMP1534 < 4; TMP1534++) {
TMP706[TMP1534+5].kind = 1;
TMP706[TMP1534+5].offset = TMP1534;
TMP706[TMP1534+5].name = TMP1533[TMP1534];
TMP1532[TMP1534] = &TMP706[TMP1534+5];
}
TMP706[9].len = 4; TMP706[9].kind = 2; TMP706[9].sons = &TMP1532[0];
...
TMP706[11].name = "val";
TMP706[0].len = 6; TMP706[0].kind = 2; TMP706[0].sons = &TMP1531[0];
