...
typedef N_CLOSURE_PTR(NI, TMP4764) (NimStringDesc* x_360547, NimStringDesc* y_360549, void* ClEnv);
typedef struct {
N_NIMCALL_PTR(NI, ClPrc) (tindexentry357264 x_358566, tindexentry357264 y_358568, void* ClEnv);
void* ClEnv;
} TY358572;
typedef N_CLOSURE_PTR(NI, TMP4768) (tindexentry357264 x_359592, tindexentry357264 y_359594, void* ClEnv);
typedef N_CLOSURE_PTR(NI, TMP4778) (tindexentry357264 x_358549, tindexentry357264 y_358551, void* ClEnv);
struct TY357880 {
NI Field0;
NimStringDesc* Field1;
};
...
N_NIMCALL(NimStringDesc*, generatemodulejumps_359718)(TY119408* modules);
...
N_NIMCALL(void, renderheadline_362281)(trstgenerator356016* d, trstnode341011* n, NimStringDesc** result) {
	...
	refname = rstnodetorefname_342060(n);
	{
		...
		dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2105), ((NimStringDesc*) &TMP2106), LOC11, 4);
	}
	goto LA5;
	LA7: ;
	{
		...
		dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2107), ((NimStringDesc*) &TMP2106), LOC13, 4);
	}
	LA5: ;
	LOC14 = 0;
...
appendString(LOC15, tmp);
	setindexterm_356710(d, refname, LOC14, LOC15, ((NimStringDesc*) &TMP2103));
}
...
N_NIMCALL(void, renderoverline_362425)(trstgenerator356016* d, trstnode341011* n, NimStringDesc** result) {
	...
	LA10: ;
	{
		...
		dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2115), ((NimStringDesc*) &TMP2116), LOC21, 4);
	}
	LA1: ;
}
		...
		j = 0;
		{
			while (1) {
				...
				k = nextsplitpoint_356349(s, j);
				{
					NIM_BOOL LOC9;
					LOC9 = 0;
					LOC9 = !(eqStrings(splitter_356332, ((NimStringDesc*) &TMP2134)));
					if (LOC9) goto LA10;
...
N_NIMCALL(void, renderimage_362598)(trstgenerator356016* d, trstnode341011* n, NimStringDesc** result) {
	...
	s = getfieldvalue_342072(n, ((NimStringDesc*) &TMP2193));
	{
		TY197301 LOC5;
		if (!!(((s) && (s)->Sup.len == 0))) goto LA3;
		memset((void*)LOC5, 0, sizeof(LOC5));
		LOC5[0] = nsuStrip(s, NIM_TRUE, NIM_TRUE);
		dispa_356544((*d).Target, &options, ((NimStringDesc*) &TMP2194), ((NimStringDesc*) &TMP2195), LOC5, 1);
	}
	LA3: ;
	s = getfieldvalue_342072(n, ((NimStringDesc*) &TMP2196));
	{
		TY197301 LOC10;
		if (!!(((s) && (s)->Sup.len == 0))) goto LA8;
		memset((void*)LOC10, 0, sizeof(LOC10));
		LOC10[0] = nsuStrip(s, NIM_TRUE, NIM_TRUE);
		dispa_356544((*d).Target, &options, ((NimStringDesc*) &TMP2197), ((NimStringDesc*) &TMP2198), LOC10, 1);
	}
	LA8: ;
	s = getfieldvalue_342072(n, ((NimStringDesc*) &TMP2199));
	{
		TY197301 LOC15;
		if (!!(((s) && (s)->Sup.len == 0))) goto LA13;
		memset((void*)LOC15, 0, sizeof(LOC15));
		LOC15[0] = nsuStrip(s, NIM_TRUE, NIM_TRUE);
		dispa_356544((*d).Target, &options, ((NimStringDesc*) &TMP2200), ((NimStringDesc*) &TMP2201), LOC15, 1);
	}
	LA13: ;
	s = getfieldvalue_342072(n, ((NimStringDesc*) &TMP2202));
	{
		...
		dispa_356544((*d).Target, &options, ((NimStringDesc*) &TMP2203), ((NimStringDesc*) &TMP2103), LOC20, 1);
	}
	LA18: ;
	s = getfieldvalue_342072(n, ((NimStringDesc*) &TMP2204));
	{
		TY197301 LOC25;
		if (!!(((s) && (s)->Sup.len == 0))) goto LA23;
		memset((void*)LOC25, 0, sizeof(LOC25));
		LOC25[0] = nsuStrip(s, NIM_TRUE, NIM_TRUE);
		dispa_356544((*d).Target, &options, ((NimStringDesc*) &TMP2205), ((NimStringDesc*) &TMP2103), LOC25, 1);
	}
	LA23: ;
	{
		TY197301 LOC30;
		...
		options = dispf_356521((*d).Target, ((NimStringDesc*) &TMP2157), ((NimStringDesc*) &TMP2206), LOC30, 1);
	}
	LA28: ;
	memset((void*)LOC31, 0, sizeof(LOC31));
	LOC31[0] = getargument_342079(n);
	LOC31[1] = copyString(options);
	dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2207), ((NimStringDesc*) &TMP2208), LOC31, 2);
	{
		NI LOC34;
		LOC34 = 0;
		LOC34 = len_341084(n);
...
N_NIMCALL(void, rendercodeblock_362662)(trstgenerator356016* d, trstnode341011* n, NimStringDesc** result) {
	...
	LA6: ;
	memset((void*)LOC11, 0, sizeof(LOC11));
	dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2216), ((NimStringDesc*) &TMP2217), LOC11, 0);
	{
...
appendString((*result), LOC24);
				...
				default:
				{
					...
					dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2376), ((NimStringDesc*) &TMP2377), LOC26, 2);
				}
				break;
				}
			}
	...
	dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2411), ((NimStringDesc*) &TMP2412), LOC28, 0);
	BeforeRet: ;
}
...
N_NIMCALL(void, rendercontainer_362866)(trstgenerator356016* d, trstnode341011* n, NimStringDesc** result) {
	...
	arg = nsuStrip(LOC1, NIM_TRUE, NIM_TRUE);
	{
		...
		dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2413), ((NimStringDesc*) &TMP2157), LOC6, 1);
	}
	goto LA2;
	LA4: ;
	{
		...
		dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2414), ((NimStringDesc*) &TMP2415), LOC8, 2);
	}
	LA2: ;
}
...
appendString(LOC8, LOC10);
	...
	setindexterm_356710(d, id, term, (*d).Currentsection, ((NimStringDesc*) &TMP2103));
	memset((void*)LOC11, 0, sizeof(LOC11));
	LOC11[0] = copyString(id);
	LOC11[1] = copyString(term);
	dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2429), ((NimStringDesc*) &TMP2430), LOC11, 2);
}
...
N_NIMCALL(void, rendersmiley_362646)(trstgenerator356016* d, trstnode341011* n, NimStringDesc** result) {
	...
	dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2433), ((NimStringDesc*) &TMP2434), LOC1, 1);
}
...
N_NIMCALL(void, renderrsttoout_356579)(trstgenerator356016* d, trstnode341011* n, NimStringDesc** result) {
	...
	case ((NU8) 12):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2131), ((NimStringDesc*) &TMP2132), result);
	}
	break;
	case ((NU8) 13):
	{
		...
		}
		{
			...
			dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2133), ((NimStringDesc*) &TMP2128), LOC26, 1);
		}
		LA24: ;
	}
	break;
	...
	case ((NU8) 19):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2164), ((NimStringDesc*) &TMP2165), result);
	}
	break;
	case ((NU8) 23):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2166), ((NimStringDesc*) &TMP2161), result);
	}
	break;
	case ((NU8) 20):
	case ((NU8) 21):
	...
	case ((NU8) 26):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2171), ((NimStringDesc*) &TMP2120), result);
	}
	break;
	case ((NU8) 27):
	{
	...
	case ((NU8) 28):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2174), ((NimStringDesc*) &TMP2175), result);
	}
	break;
	case ((NU8) 29):
	case ((NU8) 30):
...
appendString(LOC50, ((NimStringDesc*) &TMP2179));
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2176), LOC50, result);
	}
	break;
	case ((NU8) 31):
	{
...
appendString((*result), ((NimStringDesc*) &TMP2183));
	...
	case ((NU8) 33):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2160), ((NimStringDesc*) &TMP2157), result);
	}
	break;
	case ((NU8) 32):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2184), ((NimStringDesc*) &TMP2185), result);
	}
	break;
	case ((NU8) 34):
	{
	...
	case ((NU8) 39):
	{
		...
		dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2186), ((NimStringDesc*) &TMP2187), LOC85, 2);
	}
	break;
	case ((NU8) 37):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2188), ((NimStringDesc*) &TMP2189), result);
	}
	break;
	case ((NU8) 38):
	{
		...
		dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2190), ((NimStringDesc*) &TMP2191), LOC88, 2);
	}
	break;
	case ((NU8) 41):
	case ((NU8) 42):
...
appendString((*result), LOC103);
	...
	case ((NU8) 52):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2416), ((NimStringDesc*) &TMP2416), result);
	}
	break;
	case ((NU8) 40):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2103), ((NimStringDesc*) &TMP2103), result);
	}
	break;
	case ((NU8) 53):
	{
		...
		dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2376), ((NimStringDesc*) &TMP2377), LOC110, 2);
	}
	break;
	case ((NU8) 54):
	{
	...
	case ((NU8) 57):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2421), ((NimStringDesc*) &TMP2422), result);
	}
	break;
	case ((NU8) 58):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2423), ((NimStringDesc*) &TMP2185), result);
	}
	break;
	case ((NU8) 59):
	{
	...
	case ((NU8) 60):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2426), ((NimStringDesc*) &TMP2422), result);
	}
	break;
	case ((NU8) 56):
	{
	...
	LA8: ;
	{
		...
		res_356270 = ((NU8) 0);
		{
			while (1) {
				...
				i_356266 = res_356270;
				unsureAsgnRef((void**) &(*g).Meta[(i_356266)- 0], copyString(((NimStringDesc*) &TMP2103)));
				res_356270 += 1;
			} LA12: ;
		}
	}
...
N_NIMCALL(void, rendertocentry_362538)(trstgenerator356016* d, ttocentry356012 e, NimStringDesc** result) {
	...
	dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP4676), ((NimStringDesc*) &TMP4677), LOC1, 2);
}
...
N_NIMCALL(void, rendertocentries_362554)(trstgenerator356016* d, NI* j, NI lvl, NimStringDesc** result) {
	...
	} LA1: ;
	{
		...
		dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP4678), ((NimStringDesc*) &TMP4679), LOC15, 1);
	}
	goto LA11;
	LA13: ;
	{
...
N_NIMCALL(NI, hash_357309)(tindexentry357264 x) {
	...
	LOC3 = 0;
	LOC3 = or_356568(x.Linktitle, ((NimStringDesc*) &TMP2103));
	LOC4 = 0;
	LOC4 = hash_128839(LOC3);
	result = HEX21HEX26_128025(result, LOC4);
	LOC5 = 0;
	LOC5 = or_356568(x.Linkdesc, ((NimStringDesc*) &TMP2103));
	LOC6 = 0;
			...
			if (!!((d_362101 == NIM_NIL))) goto LA4;
			{
				while (1) {
					...
					y_362105 = cstrToNimstr(((NCSTRING) ((*x_362103).d_name)));
					{
						...
						NU8 k_362109;
						LOC14 = 0;
						LOC14 = !(eqStrings(y_362105, ((NimStringDesc*) &TMP4758)));
						if (!(LOC14)) goto LA15;
						LOC14 = !(eqStrings(y_362105, ((NimStringDesc*) &TMP4759)));
						LA15: ;
						if (!LOC14) goto LA16;
						memset((void*)&s_362107, 0, sizeof(s_362107));
						y_362105 = HEX2F_116899(dir, y_362105);
						{
							int LOC20;
							LOC20 = 0;
						...
						path_360056 = y_362105;
						{
							...
							if (!(LOC35)) goto LA36;
							LOC35 = nsuEndsWith(path_360056, ((NimStringDesc*) &TMP4760));
							LA36: ;
							if (!LOC35) goto LA37;
							fileentries = 0;
							...
							fileentries = (TY359804*) setLengthSeq(&(fileentries)->Sup, sizeof(tindexentry357264), 0);
							{
								...
								res_362090 = rawNewString(80);
								{
									while (1) {
										NIM_BOOL LOC42;
										LOC42 = 0;
										LOC42 = readline_12689(f_362088, &res_362090);
										if (!LOC42) goto LA41;
...
N_NIMCALL(NimStringDesc*, generatedocumentationjumps_359423)(table357277 docs) {
	...
	NimStringDesc* LOC20;
	result_359426 = 0;
	result_359426 = copyString(((NimStringDesc*) &TMP4765));
	...
	memset((void*)&LOC13, 0, sizeof(LOC13));
	LOC13.ClPrc = ((TMP4768) (cmp_357298)); LOC13.ClEnv = NIM_NIL;
...
N_NIMCALL(NimStringDesc*, generatedocumentationindex_358231)(table357277 docs) {
	...
	TY358572 LOC13;
	result_358234 = 0;
	result_358234 = copyString(((NimStringDesc*) &TMP2103));
	...
	memset((void*)&LOC13, 0, sizeof(LOC13));
	LOC13.ClPrc = ((TMP4778) (cmp_357298)); LOC13.ClEnv = NIM_NIL;
	sort_358553(titles->data, titles->Sup.len, LOC13, ((NU8) 1));
	{
