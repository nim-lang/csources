...
static N_INLINE(NIM_BOOL, mustrehash_188058)(NI length, NI counter) {
	...
	LOC5 = ((NI32)(TMP1942) < (NI32)(TMP1943));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
...
static N_INLINE(NI, nexttry_188206)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1945 = mulInt(5, h);
	TMP1946 = addInt((NI32)(TMP1945), 1);
	result = (NI)((NI32)(TMP1946) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, intsetenlarge_188621)(tintset188047* t) {
	...
	TMP1950 = mulInt((NI32)(TMP1949), 2);
	TMP1951 = subInt((NI32)(TMP1950), 1);
	(*t).Max = (NI32)(TMP1951);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1952 = addInt((*t).Max, 1);
	n = (ttrunkseq188045*) newSeq((&NTI188045), (NI32)(TMP1952));
	i_188655 = 0;
...
N_NIMCALL(ttrunk188043*, intsetput_188696)(tintset188047* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_188058((NI32)(TMP1956), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
