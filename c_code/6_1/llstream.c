...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY123387 TMP1638 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY123387 TMP1639 = {
...
N_NIMCALL(NIM_BOOL, endswithopr_179646)(NimStringDesc* x) {
	...
	result = endswith_179602(x, TMP1638);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_179652)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_179602(line, TMP1639);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(void, llstreamwriteln_179274)(tllstream179204* s, NimStringDesc* data) {
	...
	llstreamwrite_179258(s, ((NimStringDesc*) &TMP1644));
	popFrame();
}
...
NTI179202.node = &TMP1629[6];
TMP1629[1].kind = 1;
TMP1629[1].offset = offsetof(tllstream179204, Kind);
TMP1629[1].typ = (&NTI179202);
TMP1629[1].name = "kind";
TMP1631[1] = &TMP1629[7];
TMP1629[7].kind = 1;
TMP1629[7].offset = offsetof(tllstream179204, F);
TMP1629[7].typ = (&NTI10204);
TMP1629[7].name = "f";
TMP1631[2] = &TMP1629[8];
TMP1629[8].kind = 1;
TMP1629[8].offset = offsetof(tllstream179204, S);
TMP1629[8].typ = (&NTI143);
TMP1629[8].name = "s";
TMP1631[3] = &TMP1629[9];
TMP1629[9].kind = 1;
TMP1629[9].offset = offsetof(tllstream179204, Rd);
TMP1629[9].typ = (&NTI106);
TMP1629[9].name = "rd";
TMP1631[4] = &TMP1629[10];
TMP1629[10].kind = 1;
TMP1629[10].offset = offsetof(tllstream179204, Wr);
TMP1629[10].typ = (&NTI106);
TMP1629[10].name = "wr";
TMP1631[5] = &TMP1629[11];
TMP1629[11].kind = 1;
TMP1629[11].offset = offsetof(tllstream179204, Lineoffset);
TMP1629[11].typ = (&NTI106);
TMP1629[11].name = "lineOffset";
TMP1629[0].len = 6; TMP1629[0].kind = 2; TMP1629[0].sons = &TMP1631[0];
NTI179204.node = &TMP1629[0];
NTI179206.size = sizeof(tllstream179204*);
NTI179206.kind = 22;
NTI179206.base = (&NTI179204);
NTI179206.marker = TMP1635;
}
