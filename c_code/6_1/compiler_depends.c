...
STRING_LITERAL(TMP5231, "$1 -> $2;$n", 11);
STRING_LITERAL(TMP5232, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP5233, "", 0);
...
N_NIMCALL(void, adddependencyaux_514013)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	addf_170205(&gdotgraph_514011, ((NimStringDesc*) &TMP5231), LOC1, 2);
}
...
N_NIMCALL(void, generatedot_514003)(NimStringDesc* project) {
	...
	LOC3 = 0;
	LOC3 = noschangeFileExt(LOC2, ((NimStringDesc*) &TMP5233));
	LOC1[0] = rope_169277(LOC3);
	LOC1[1] = gdotgraph_514011;
	LOC4 = 0;
	LOC4 = HEX25_169905(((NimStringDesc*) &TMP5232), LOC1, 2);
	LOC5 = 0;
	LOC5 = noschangeFileExt(project, ((NimStringDesc*) &TMP5234));
