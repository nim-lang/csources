...
STRING_LITERAL(TMP1409, "0123456789ABCDEF", 16);
STRING_LITERAL(TMP1411, "", 0);
STRING_LITERAL(TMP2112, "\\x", 2);
...
101}
;
STRING_LITERAL(TMP5291, "GB", 2);
STRING_LITERAL(TMP5292, "MB", 2);
STRING_LITERAL(TMP5293, "KB", 2);
STRING_LITERAL(TMP5294, "B", 1);
...
appendString(LOC7, ((NimStringDesc*) &TMP1266));
appendString(LOC7, s);
	...
	result = mnewString(((NI) (len)));
	{
		...
		res_99620 = ((NI) (HEX3Atmp_99617));
		{
			while (1) {
				...
				result->data[j_99614] = ((NimStringDesc*) &TMP1409)->data[(NI64)(n & IL64(15))];
...
N_NIMCALL(NimStringDesc*, nsuReplaceStr)(NimStringDesc* s, NimStringDesc* sub, NimStringDesc* by) {
	...
	NimStringDesc* LOC8;
	result = 0;
	result = copyString(((NimStringDesc*) &TMP1411));
...
appendString(LOC20, ((NimStringDesc*) &TMP1266));
...
appendString(LOC5, ((NimStringDesc*) &TMP5291));
		result = LOC5;
	}
	goto LA1;
	LA3: ;
...
appendString(LOC19, ((NimStringDesc*) &TMP5293));
		result = LOC19;
	}
	goto LA1;
	LA17: ;
...
appendString(LOC24, ((NimStringDesc*) &TMP5294));
		result = LOC24;
	}
	LA1: ;
	return result;
