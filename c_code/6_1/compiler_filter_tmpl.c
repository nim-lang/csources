...
static NIM_CONST TY196407 TMP1344 = {
...
N_NIMCALL(void, newline_239047)(ttmplparser239020* p) {
	...
	(*p).Emitpar = 0;
	{
		...
		llstreamwrite_196713((*p).Outp, ((NimStringDesc*) &TMP1340));
	}
	LA4: ;
	{
		NimStringDesc* LOC10;
...
N_NIMCALL(void, parseline_239174)(ttmplparser239020* p) {
	...
	LA7: ;
	{
		...
		case ((NU8) 21):
		{
			...
			{
				(*p).Info.Col = ((NI16) (j));
				localerror_183637((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP1342));
			}
			LA20: ;
			LOC25 = 0;
	...
	LA10: ;
	{
				...
				{
					{
						...
						case 123:
						{
							...
							curly = 0;
							{
								while (1) {
									...
									case 0:
									{
										localerror_183637((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP1351));
										goto LA62;
									}
									break;
									case 123:
						...
						default:
						{
							...
							{
								(*p).Info.Col = ((NI16) (j));
								localerror_183637((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP1339));
							}
							LA80: ;
						}
						break;
		...
		llstreamwrite_196713((*p).Outp, ((NimStringDesc*) &TMP1352));
	}
	LA3: ;
}
...
N_NIMCALL(tllstream196204*, filtertmpl_239009)(tllstream196204* stdin_239011, NimStringDesc* filename, tnode209818* call) {
	...
	p.Outp = llstreamopen_196220(((NimStringDesc*) &TMP1331));
	p.Inp = stdin_239011;
	p.Subschar = chararg_238020(call, ((NimStringDesc*) &TMP1332), 1, 36);
	p.Nimdirective = chararg_238020(call, ((NimStringDesc*) &TMP1333), 2, 35);
	p.Emit = strarg_238029(call, ((NimStringDesc*) &TMP1334), 3, ((NimStringDesc*) &TMP1335));
	p.Conc = strarg_238029(call, ((NimStringDesc*) &TMP1336), 4, ((NimStringDesc*) &TMP1337));
	p.Tostr = strarg_238029(call, ((NimStringDesc*) &TMP1338), 5, ((NimStringDesc*) &TMP1339));
