...
NIM_CONST TY119408* additionalsymbols_201142 = ((TY119408*)&CNSTSEQ1548);
			...
			res_201123 = 0;
			{
				while (1) {
					...
					h_201119 = res_201123;
					{
						...
						{
							if (!eqStrings(val_201102, ((NimStringDesc*) &TMP1383))) goto LA11;
							result += 1;
						}
						LA11: ;
					}
...
N_NIMCALL(void, definesymbol_201009)(NimStringDesc* symbol) {
	nstPut(gsymbols_201004, symbol, ((NimStringDesc*) &TMP1383));
}

N_NIMCALL(void, declaresymbol_201018)(NimStringDesc* symbol) {
	nstPut(gsymbols_201004, symbol, ((NimStringDesc*) &TMP1442));
}
...
appendString(LOC25, LOC26);
	...
	declaresymbol_201018(((NimStringDesc*) &TMP1548));
	{
		if (!((os_174069[(targetos_174589)- 1].Field12 &(1<<((((NU8) 3))&7)))!=0)) goto LA30;
		definesymbol_201009(((NimStringDesc*) &TMP1548));
	}
	LA30: ;
	switch (targetos_174589) {
	case ((NU8) 7):
	...
	case ((NU8) 19):
	{
		definesymbol_201009(((NimStringDesc*) &TMP1545));
	}
	break;
	default:
	{
...
N_NIMCALL(void, undefsymbol_201027)(NimStringDesc* symbol) {
	nstPut(gsymbols_201004, symbol, ((NimStringDesc*) &TMP1679));
}
