...
static NIM_CONST TY113118 TMP365 = {
...
N_NIMCALL(NimStringDesc*, getgeneratedpath_114417)(void) {
	...
	LA3: ;
	{
		...
		result = HEX2F_102067(LOC6, ((NimStringDesc*) &TMP336));
	}	LA1: ;
	popFrame();
	return result;
}
...
N_NIMCALL(void, libcandidates_114600)(NimStringDesc* s, TY9552** dest) {
	...
	nimln(301, "options.nim");
	{
		...
		nimln(304, "options.nim");
		TMP361 = subInt(ri, 1);
		HEX3Atmp_114626 = copyStrLast(s, (NI32)(TMP360), (NI32)(TMP361));
		...
		nimln(249, "strutils.nim");
		{
			...
			while (1) {
				...
				nimln(254, "strutils.nim");
				nimln(254, "strutils.nim");
				TMP363 = subInt(last_114628, 1);
				middle_114611 = copyStrLast(HEX3Atmp_114626, first_114630, (NI32)(TMP363));
...
N_NIMCALL(void, incldynliboverride_114644)(NimStringDesc* lib) {
	...
	nstPut(gdlloverrides_114195, LOC1, ((NimStringDesc*) &TMP367));	popFrame();
}
N_NIMCALL(NIM_BOOL, isdynliboverride_114649)(NimStringDesc* lib) {
	NIM_BOOL result;
	NimStringDesc* LOC1;
