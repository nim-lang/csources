...
static NIM_CONST TY196407 TMP1890 = {
			...
			current_170890 = copyString(path);
			{
				while (1) {
					...
					parents += 1;
					{
						...
						file_170844 = 0;
						HEX3Atmp_170861 = 0;
						HEX3Atmp_170861 = HEX2F_118299(d_170831, ((NimStringDesc*) &TMP1363));
					...
					}
					{
						...
						file_170845 = 0;
						HEX3Atmp_170875 = 0;
						HEX3Atmp_170875 = HEX2F_118299(d_170831, ((NimStringDesc*) &TMP1364));
...
N_NIMCALL(NimStringDesc*, getgeneratedpath_170429)(void) {
	...
	LA3: ;
	{
		...
		result = HEX2F_118299(LOC6, ((NimStringDesc*) &TMP1365));
	}
	LA1: ;
	return result;
}
...
static N_INLINE(void, writeln_171205)(FILE* f_171209, NimStringDesc** x_171213, NI x_171213Len0) {
	...
	write_13265(f_171209, ((NimStringDesc*) &TMP1367));
}
...
N_NIMCALL(void, incldynliboverride_171481)(NimStringDesc* lib) {
	...
	nstPut(gdlloverrides_170235, LOC1, ((NimStringDesc*) &TMP1891));
}
