	...
	case ((NU8) 3):
	{
		...
		s = (*templ).kindU.S4.Sym;
		{
			...
			LA10: ;
			{
				...
				LA38: ;
				LOC43 = 0;
				LOC43 = newsymnode_211692(x, LOC37);
...
N_NIMCALL(tnode209818*, evaltemplate_414286)(tnode209818* n, tsym209848* tmpl, tsym209848* gensymowner) {
	...
	body = getbody_258282(tmpl);
	{
		NIM_BOOL LOC7;
		LOC7 = 0;
		LOC7 = isatom_215971(body);
		if (!LOC7) goto LA8;
