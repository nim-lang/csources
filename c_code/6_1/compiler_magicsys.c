...
static NIM_CONST TY172865 TMP3047 = {
...
N_NIMCALL(tsym172689*, getsyssym_217037)(NimStringDesc* name) {
	...
	if (!(((64 &(1<<(((*systemmodule_217014).Kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3023));
	nimln(39, "magicsys.nim");
	LOC1 = 0;
...
N_NIMCALL(ttype172693*, getsystype_217021)(NU8 kind) {
	...
	nimln(63, "magicsys.nim");
	{
		...
		case ((NU8) 1):
		{
			...
			result = systypefromname_217173(((NimStringDesc*) &TMP3038));
		}		break;
		case ((NU8) 2):
		{
			nimln(80, "magicsys.nim");
			result = systypefromname_217173(((NimStringDesc*) &TMP3039));
		}		break;
		case ((NU8) 28):
		{
			nimln(81, "magicsys.nim");
			result = systypefromname_217173(((NimStringDesc*) &TMP3040));
		}		break;
		case ((NU8) 29):
		{
			nimln(82, "magicsys.nim");
			result = systypefromname_217173(((NimStringDesc*) &TMP3041));
		}		break;
		case ((NU8) 26):
		{
			nimln(83, "magicsys.nim");
			result = systypefromname_217173(((NimStringDesc*) &TMP3042));
		}		break;
		case ((NU8) 5):
		{
...
N_NIMCALL(void, setintlittype_217430)(tnode172659* result) {
	...
	default:
	{
		...
		internalerror_139369((*result).Info, ((NimStringDesc*) &TMP3049));	}	break;
	}
	popFrame();
}
N_NIMCALL(tsym172689*, getcompilerproc_217025)(NimStringDesc* name) {
