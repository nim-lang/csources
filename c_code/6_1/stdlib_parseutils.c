...
STRING_LITERAL(TMP1563, "overflow", 8);
	...
	LA1: ;
	{
		...
		(*b) = IL64(0);
		{
			while (1) {
				...
				TMP1259 = mulInt64((*b), IL64(10));
				TMP1260 = subInt(((NI) (((NU8)(s->data[i])))), ((NI) 48));
				TMP1261 = subInt64((NI64)(TMP1259), ((NI64) ((NI)(TMP1260))));
				(*b) = (NI64)(TMP1261);
		...
		TMP1264 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP1264);
		TMP1265 = subInt(i, start);
		result = (NI)(TMP1265);
	}
	LA10: ;
	return result;
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	result = npuParseBiggestInt(s, (&res), start);
	{
		...
		LOC9 = 0;
		LOC9 = (*e_96241).Sup.Sup.message; (*e_96241).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1563));
