...
N_NIMCALL(tsym191843*, ithfield_420007)(tnode191813* n, NI field) {
	...
	case ((NU8) 136):
	{
		...
		while (1) {
			...
			result = ithfield_420007((*n).kindU.S6.Sons->data[i_420024], (NI32)(TMP5680));
	...
	case ((NU8) 137):
	{
		...
		result = ithfield_420007((*n).kindU.S6.Sons->data[0], (NI32)(TMP5682));
		...
		while (1) {
			...
			case ((NU8) 88):
			{
				...
				result = ithfield_420007(LOC20, (NI32)(TMP5685));
