...
{	{
	...
	LA4: ;
	{
		...
		scriptfile0 = noschangeFileExt(gprojectfull_170211_2607990831, ((NimStringDesc*) &T957294627_7));
		{
			...
			if (!LOC25) goto LA26;
			runnimscript_598218_3062286716(scriptfile0, NIM_FALSE);
			{
		...
		LA26: ;
		{
			...
			runnimscript_598218_3062286716(LOC37, NIM_FALSE);
		}
		goto LA23;
		LA35: ;
		LA23: ;
		...
		maincommand_595610_6460232();
		{
			...
			if (!(LOC44)) goto LA45;
			LOC44 = ((gnotes_193071_155036129 &((NU64)1<<((NU)((((Tmsgkind192002) 289)- 237))&63U)))!=0);
			LA45: ;
			if (!LOC44) goto LA46;
		...
		LA46: ;
		{
			if (!(gerrorcounter_193072_155036129 == ((NI) 0))) goto LA51;
			{
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	...
	msgquit_193149_155036129(((NI8) ((((NI) 0) < gerrorcounter_193072_155036129))));
}
