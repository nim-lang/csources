...
TMP2950[0] = &TMP2867[1];
TMP2867[1].kind = 1;
TMP2867[1].offset = offsetof(tmemfile210204, Mem);
TMP2867[1].typ = (&NTI146);
TMP2867[1].name = "mem";
TMP2950[1] = &TMP2867[2];
TMP2867[2].kind = 1;
TMP2867[2].offset = offsetof(tmemfile210204, Size);
TMP2867[2].typ = (&NTI105);
TMP2867[2].name = "size";
TMP2950[2] = &TMP2867[3];
TMP2867[3].kind = 1;
TMP2867[3].offset = offsetof(tmemfile210204, Handle);
TMP2867[3].typ = (&NTI3809);
TMP2867[3].name = "handle";
TMP2867[0].len = 3; TMP2867[0].kind = 2; TMP2867[0].sons = &TMP2950[0];
NTI210204.node = &TMP2867[0];
}
