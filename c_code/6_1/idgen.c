...
static N_INLINE(void, setid_190444)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP1964 = addInt(id, 1);
	gfrontendid_190007 = ((gfrontendid_190007 >= (NI32)(TMP1964)) ? gfrontendid_190007 : (NI32)(TMP1964));
	popFrame();
}
...
N_NIMCALL(NimStringDesc*, togid_190457)(NimStringDesc* f) {
	...
	result = 0;
	nimln(47, "idgen.nim");
	result = completegeneratedfilepath_139001(((NimStringDesc*) &TMP1969), NIM_TRUE);
	popFrame();
	return result;
}
...
static N_INLINE(void, writeln_139205)(FILE* f_139209, NimStringDesc** x_139213, NI x_139213Len0) {
	...
	nimln(172, "sysio.nim");
	write_10663(f_139209, ((NimStringDesc*) &TMP1970));
	popFrame();
}
