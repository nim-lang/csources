...
N_NOINLINE(void, identsInit)(void) {
	...
	asgnRefNoCycle((void**) &idanon_165476, getident_165456(((NimStringDesc*) &TMP980)));
	nimln(109, "idents.nim");
	asgnRefNoCycle((void**) &iddelegator_165478, getident_165456(((NimStringDesc*) &TMP981)));
	popFrame();
}
...
NTI165013.flags = 1;
TMP970[0].kind = 1;
TMP970[0].offset = offsetof(tidobj165013, Id);
TMP970[0].typ = (&NTI106);
TMP970[0].name = "id";
NTI165013.node = &TMP970[0];
...
TMP977[0] = &TMP970[2];
TMP970[2].kind = 1;
TMP970[2].offset = offsetof(tident165019, S);
TMP970[2].typ = (&NTI143);
TMP970[2].name = "s";
TMP977[1] = &TMP970[3];
TMP970[3].kind = 1;
TMP970[3].offset = offsetof(tident165019, Next);
TMP970[3].typ = (&NTI165017);
TMP970[3].name = "next";
TMP977[2] = &TMP970[4];
TMP970[4].kind = 1;
TMP970[4].offset = offsetof(tident165019, H);
TMP970[4].typ = (&NTI118013);
TMP970[4].name = "h";
TMP970[1].len = 3; TMP970[1].kind = 2; TMP970[1].sons = &TMP977[0];
NTI165019.node = &TMP970[1];
NTI165017.size = sizeof(tident165019*);
NTI165017.kind = 22;
NTI165017.base = (&NTI165019);
NTI165017.flags = 2;
NTI165017.marker = TMP978;
NTI165015.size = sizeof(tidobj165013*);
NTI165015.kind = 22;
NTI165015.base = (&NTI165013);
NTI165015.marker = TMP2047;
}
