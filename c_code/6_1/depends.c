...
static NIM_CONST TY186025 TMP7615 = {
...
N_NIMCALL(void, adddependencyaux_519020)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	appf_143085(&gdotgraph_519017, ((NimStringDesc*) &TMP7614), LOC1, 2);
	popFrame();
}
...
N_NIMCALL(void, generatedot_519007)(NimStringDesc* project) {
	...
	LOC4 = 0;
	LOC4 = ropef_143079(((NimStringDesc*) &TMP7619), LOC1, 2);
...
TMP7612[0].kind = 1;
TMP7612[0].offset = offsetof(tgen519012, Module);
TMP7612[0].typ = (&NTI185811);
TMP7612[0].name = "module";
NTI519012.node = &TMP7612[0];
NTI519014.size = sizeof(tgen519012*);
NTI519014.kind = 22;
NTI519014.base = (&NTI519012);
NTI519014.marker = TMP7622;
}
