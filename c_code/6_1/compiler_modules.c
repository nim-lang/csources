...
STRING_LITERAL(TMP1444, "handleSymbolFile should have set the module\'s ID", 48);
STRING_LITERAL(TMP1449, "compiler/modules.nim", 20);
NIM_CONST TY85545 TMP1448 = {((NimStringDesc*) &TMP1449),
((NI) 41)}
;
...
N_NIMCALL(tsym207843*, newmodule_529646)(NI32 fileidx) {
	...
	asgnRefNoCycle((void**) (&(*result).Name), getident_184463(LOC1.Field1));
	{
		...
		NIM_BOOL LOC6;
		LOC4 = 0;
		LOC4 = !(eqStrings((*(*result).Name).S, ((NimStringDesc*) &TMP1366)));
		if (!(LOC4)) goto LA5;
		LOC6 = 0;
...
N_NIMCALL(void, wantmainmodule_529922)(void) {
	NimStringDesc* LOC5;
	{
		...
		fatal_182360(gcmdlineinfo_180925, ((NU16) 186), ((NimStringDesc*) &TMP4219));
	}
	LA3: ;
	LOC5 = 0;
...
N_NIMCALL(tsym207843*, makestdinmodule_530003)(void) {
	...
	result = 0;
	{
		...
		LOC5 = 0;
		LOC5 = fileinfoidx_180857(((NimStringDesc*) &TMP4936));
