...
STRING_LITERAL(TMP1231, "_", 1);
STRING_LITERAL(TMP1233, "invalid index", 13);
STRING_LITERAL(TMP1234, "PATH", 4);
STRING_LITERAL(TMP1789, "HOME", 4);
STRING_LITERAL(TMP1790, "/", 1);
STRING_LITERAL(TMP2053, "/.config/", 9);
STRING_LITERAL(TMP3668, ".", 1);
STRING_LITERAL(TMP3669, "..", 2);
...
{	result = 0;
	...
	LOC7 = 0;
	LOC7 = (*e_131414).Sup.message; (*e_131414).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1233));
...
{	result = 0;
	result = paramstr_131407(((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			p_132202 = 0;
			HEX3Atmp_132209 = 0;
			HEX3Atmp_132209 = getenv_125825(((NimStringDesc*) &TMP1234));
			last_132214 = ((NI) 0);
			{
				while (1) {
					NI first_132216;
...
N_NIMCALL(NimStringDesc*, nosgetAppFilename)(void) {
	NimStringDesc* result;
	result = 0;
	result = getenv_125825(((NimStringDesc*) &TMP1231));
	{
...
{	result = 0;
	LOC1 = 0;
	LOC2 = 0;
	LOC2 = getenv_125825(((NimStringDesc*) &TMP1789));
	LOC1 = rawNewString(LOC2->Sup.len + 1);
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP1790));
	result = LOC1;
	goto BeforeRet;
	}BeforeRet: ;
	return result;
...
{	result = 0;
	...
	LA4: ;
	path = getenv_125825(((NimStringDesc*) &TMP1234));
	{
				...
				while (1) {
					{
						...
						y_127626 = cstrToNimstr(((NCSTRING) ((*x_127624).d_name)));
						{
							...
							NU8 k_127630;
							LOC15 = 0;
							LOC15 = !(eqStrings(y_127626, ((NimStringDesc*) &TMP3668)));
							if (!(LOC15)) goto LA16;
