...
N_NIMCALL(void, serve_419277)(TY419279 action) {
	...
	typ = getconfigvar_114292(((NimStringDesc*) &TMP7048));
	...
	LA2: ;
	{
		...
		p = getconfigvar_114292(((NimStringDesc*) &TMP7056));
		...
		nimln(89, "service.nim");
		LOC19 = 0;
		LOC19 = getconfigvar_114292(((NimStringDesc*) &TMP7057));
		...
		while (1) {
			...
			send_134404(stdoutsocket_138084, ((NimStringDesc*) &TMP7082));			nimln(98, "service.nim");
	...
	LOC1 = 0;
	LOC1 = curcaascmd_419203; curcaascmd_419203 = copyStringRC1(((NimStringDesc*) &TMP7041));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(25, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_419204; lastcaascmd_419204 = copyStringRC1(((NimStringDesc*) &TMP7041));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(28, "service.nim");
	LOC3 = 0;
	LOC3 = arguments_419205; arguments_419205 = copyStringRC1(((NimStringDesc*) &TMP7041));
