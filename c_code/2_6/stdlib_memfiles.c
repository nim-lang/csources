...
N_NIMCALL(tmemfile233204, open_233803)(NimStringDesc* filename, NU8 mode, NI mappedsize, NI offset, NI newfilesize) {
	...
	nimln(82, "memfiles.nim");
	{
		...
		if (!!(LOC3)) goto LA5;
		nimln(82, "memfiles.nim");
		failedassertimpl_79821(((NimStringDesc*) &TMP2960));
	}
	LA5: ;
...
TMP3041[0] = &TMP2957[1];
TMP2957[1].kind = 1;
TMP2957[1].offset = offsetof(tmemfile233204, Mem);
TMP2957[1].typ = (&NTI147);
TMP2957[1].name = "mem";
TMP3041[1] = &TMP2957[2];
TMP2957[2].kind = 1;
TMP2957[2].offset = offsetof(tmemfile233204, Size);
TMP2957[2].typ = (&NTI106);
TMP2957[2].name = "size";
TMP3041[2] = &TMP2957[3];
TMP2957[3].kind = 1;
TMP2957[3].offset = offsetof(tmemfile233204, Handle);
TMP2957[3].typ = (&NTI4409);
TMP2957[3].name = "handle";
TMP2957[0].len = 3; TMP2957[0].kind = 2; TMP2957[0].sons = &TMP3041[0];
NTI233204.node = &TMP2957[0];
}
