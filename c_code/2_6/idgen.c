...
static N_INLINE(void, setid_185444)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP1961 = addInt(id, 1);
	gfrontendid_185007 = ((gfrontendid_185007 >= (NI32)(TMP1961)) ? gfrontendid_185007 : (NI32)(TMP1961));
	popFrame();
}
...
N_NIMCALL(void, idsynchronizationpoint_185452)(NI idrange) {
	...
	gfrontendid_185007 = (NI32)(TMP1965);
	popFrame();
}
...
N_NIMCALL(NimStringDesc*, togid_185457)(NimStringDesc* f) {
	...
	result = 0;
	nimln(47, "idgen.nim");
	result = completegeneratedfilepath_137001(((NimStringDesc*) &TMP1966), NIM_TRUE);
	popFrame();
	return result;
}
...
static N_INLINE(void, writeln_137205)(FILE* f_137209, NimStringDesc** x_137213, NI x_137213Len0) {
	...
	nimln(172, "sysio.nim");
	write_10463(f_137209, ((NimStringDesc*) &TMP1967));
	popFrame();
}
