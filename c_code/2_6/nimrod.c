...
N_NIMCALL(void, handlecmdline_530603)(void) {
	...
	{
		nimln(39, "nimrod.nim");
		processcmdline_524207(((NU8) 0), ((NimStringDesc*) &TMP7786));
		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP7787;
			TY108700 p;
		...
		LA7: ;
		nimln(50, "nimrod.nim");
		loadconfigs_182607(((NimStringDesc*) &TMP7788));
		nimln(53, "nimrod.nim");
		initvars_168714();
		nimln(54, "nimrod.nim");
		processcmdline_524207(((NU8) 1), ((NimStringDesc*) &TMP7786));
		nimln(55, "nimrod.nim");
		maincommand_528011();
		nimln(56, "nimrod.nim");
		{
			...
			nimln(62, "nimrod.nim");
			{
				...
				nimln(63, "nimrod.nim");
				{
					...
					LA37: ;
					{
						...
						nimln(69, "nimrod.nim");
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_136208, ((NimStringDesc*) &TMP7789));
						LOC42 = 0;
...
appendString(LOC44, arguments_524205);
				...
				LA33: ;
				{
					...
					LA48: ;
					{
						...
						nimln(78, "nimrod.nim");
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_136208, ((NimStringDesc*) &TMP7786));
