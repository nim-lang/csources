...
static N_INLINE(NIM_BOOL, isPatternParam_gPET1IUN01z2uU7gQJbgXwpatterns)(tyObject_TPatternContext_ArP5wLemitHqyeu50ovXug* c, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* p) {
	...
	if (!(T2_)) goto LA3_;
	T2_ = ((*(*p)._Ukind.S4.sym).kind == ((tyEnum_TSymKind_cNCW9acsSznmEccl1fgQwkw) 3));
	LA3_: ;
	T1_ = T2_;
	if (!(T1_)) goto LA4_;
	T1_ = ((*(*p)._Ukind.S4.sym).owner == (*c).owner);
	LA4_: ;
	result = T1_;
	return result;
}
					...
					res = ((NI) 0);
					{
						while (1) {
							...
							i = res;
							{
								NIM_BOOL T26_;
								T26_ = (NIM_BOOL)0;
								T26_ = sameTrees_5GE9abCZqpois6anfudFhKw((*a)._Ukind.S6.sons->data[i], (*b)._Ukind.S6.sons->data[i]);
								if (!!(T26_)) goto LA27_;
								goto BeforeRet_;
							}
							LA27_: ;
...
{	result = (NIM_BOOL)0;
	...
	LA11_: ;
	{
		result = argtypeMatches_Hty9bG59aIFdjFb0sE4OUR3w((*c).c, (*p).typ, (*n).typ, NIM_TRUE);
	}
	LA9_: ;
	}BeforeRet_: ;
	return result;
...
{	result = (NIM_BOOL)0;
	{
		if (!((*sc).kind == ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 56))) goto LA3_;
		{
			...
			i = (NI)0;
			colontmp_ = (NI)0;
			colontmp_ = len_CdME9baJhvveuPEDZE9bXoxAsigmatch(sc);
			i_2 = ((NI) 0);
			{
				while (1) {
					...
					i = i_2;
					{
						if (!((*(*sc)._Ukind.S6.sons->data[i])._Ukind.S4.sym == (*x)._Ukind.S4.sym)) goto LA10_;
						result = NIM_TRUE;
						goto BeforeRet_;
					}
					LA10_: ;
	...
	LA3_: ;
	{
		...
		result = ((*(*(*(*sc)._Ukind.S6.sons->data[((NI) 0)])._Ukind.S4.sym).name).Sup.id == (*(*(*x)._Ukind.S4.sym).name).Sup.id);
	}
	goto LA1_;
	LA13_: ;
	LA1_: ;
...
{	result = (NIM_BOOL)0;
	{
		...
		i = (NI)0;
		colontmp_ = (NI)0;
		colontmp_ = len_CdME9baJhvveuPEDZE9bXoxAsigmatch(p);
		i_2 = ((NI) 1);
		{
			while (1) {
				...
				i = i_2;
				{
					NIM_BOOL T6_;
					T6_ = (NIM_BOOL)0;
					T6_ = matches_VCMdmeXpaOrMqkuJKekVZA(c, (*p)._Ukind.S6.sons->data[i], n);
					if (!T6_) goto LA7_;
					result = NIM_TRUE;
					goto BeforeRet_;
				}
...
{	result = (NIM_BOOL)0;
	...
	result = NIM_TRUE;
	{
		...
		if (!(T3_)) goto LA4_;
		T3_ = matches_VCMdmeXpaOrMqkuJKekVZA(c, (*op)._Ukind.S6.sons->data[((NI) 1)], (*n)._Ukind.S6.sons->data[((NI) 0)]);
		LA4_: ;
		if (!T3_) goto LA5_;
		{
			NI i;
			...
			res = ((NI) 1);
			{
				while (1) {
					...
					i = res;
					{
						...
						T14_ = (NIM_BOOL)0;
						T14_ = T13_.ClE_0? T13_.ClP_0(c, op, (*n)._Ukind.S6.sons->data[i], arglist, rpn, T13_.ClE_0):((TM_1E9cVLQUjhbw81lEou89bC9bw_7)(T13_.ClP_0))(c, op, (*n)._Ukind.S6.sons->data[i], arglist, rpn);
						if (!!(T14_)) goto LA15_;
						result = NIM_FALSE;
						goto BeforeRet_;
					}
		...
		{
			if (!rpn) goto LA19_;
			add_gCCf68XrWL79bKes6htzFjQ(arglist, (*n)._Ukind.S6.sons->data[((NI) 0)]);
		}
		LA19_: ;
	}
	goto LA1_;
	LA5_: ;
	{
		...
		if (!(T22_)) goto LA23_;
		T22_ = ((*(*n)._Ukind.S6.sons->data[((NI) 1)]).kind == ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 41));
		LA23_: ;
		if (!T22_) goto LA24_;
		n_2 = (*n)._Ukind.S6.sons->data[((NI) 1)];
		{
			NI i_2;
			NI colontmp__2;
			NI i_3;
			i_2 = (NI)0;
			colontmp__2 = (NI)0;
			colontmp__2 = len_CdME9baJhvveuPEDZE9bXoxAsigmatch(n_2);
			i_3 = ((NI) 0);
			{
				while (1) {
					...
					i_2 = i_3;
					{
						...
						T32_ = (NIM_BOOL)0;
						T32_ = T31_.ClE_0? T31_.ClP_0(c, op, (*n_2)._Ukind.S6.sons->data[i_2], arglist, rpn, T31_.ClE_0):((TM_1E9cVLQUjhbw81lEou89bC9bw_8)(T31_.ClP_0))(c, op, (*n_2)._Ukind.S6.sons->data[i_2], arglist, rpn);
						if (!!(T32_)) goto LA33_;
						result = NIM_FALSE;
						goto BeforeRet_;
					}
	...
	LA24_: ;
	{
		NIM_BOOL T36_;
		T36_ = (NIM_BOOL)0;
		T36_ = checkTypes_5sOMssutW0quSDlXGaSK9cg(c, (*(*(*colonenvP_).p1)._Ukind.S6.sons->data[((NI) 2)])._Ukind.S4.sym, n);
		if (!T36_) goto LA37_;
...
{	result = (NIM_BOOL)0;
	...
	LA3_: ;
	{
		...
		T7_ = (NIM_BOOL)0;
		T7_ = matches_VCMdmeXpaOrMqkuJKekVZA(c, (*(*colonenv_).p1)._Ukind.S6.sons->data[((NI) 1)], (*n)._Ukind.S6.sons->data[((NI) 0)]);
		if (!T7_) goto LA8_;
		arglist = newNodeI_I7fH85CUcZMasoPRKxPsPg(((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 152), (*n).info);
		{
			...
			if (!T13_) goto LA14_;
			result = bindOrCheck_EggZoRCGflksdwwfiYwe9bA(c, (*(*(*colonenv_).p1)._Ukind.S6.sons->data[((NI) 2)])._Ukind.S4.sym, arglist);
		}
		LA14_: ;
	}
	LA8_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, gather_hIzXa8r9c4bMqC9bQDGZhp0A)(tyObject_TPatternContext_ArP5wLemitHqyeu50ovXug* c, tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w* param, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	LA5_: ;
	{
		...
		asgnRefNoCycle((void**) (&(*pp)._Ukind.S6.sons->data[((NI) 0)]), n);
...
{	result = (NIM_BOOL)0;
	...
	LA3_: ;
	{
		...
		if (!T6_) goto LA7_;
		result = bindOrCheck_EggZoRCGflksdwwfiYwe9bA(c, (*p)._Ukind.S4.sym, n_2);
	}
	goto LA1_;
	LA7_: ;
	{
		...
		LA11_: ;
		if (!T10_) goto LA12_;
		result = ((*(*p)._Ukind.S5.ident).Sup.id == (*(*(*n_2)._Ukind.S4.sym).name).Sup.id);
	}
	goto LA1_;
	LA12_: ;
	{
	...
	LA17_: ;
	{
		...
		if (!(T20_)) goto LA21_;
		T20_ = ((*(*n_2)._Ukind.S4.sym).kind == ((tyEnum_TSymKind_cNCW9acsSznmEccl1fgQwkw) 10));
		LA21_: ;
		if (!T20_) goto LA22_;
		{
			if (!((*p).kind == ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 3))) goto LA26_;
			result = ((*p)._Ukind.S4.sym == (*n_2)._Ukind.S4.sym);
		}
		goto LA24_;
		LA26_: ;
		{
			NIM_BOOL T29_;
			T29_ = (NIM_BOOL)0;
			T29_ = matches_VCMdmeXpaOrMqkuJKekVZA(c, p, (*(*n_2)._Ukind.S4.sym).ast);
			if (!T29_) goto LA30_;
			result = NIM_TRUE;
		}
		goto LA24_;
	...
	LA22_: ;
	{
		...
		opr = (*(*(*p)._Ukind.S6.sons->data[((NI) 0)])._Ukind.S5.ident).s;
		...
		LA38_: ;
		{
			NIM_BOOL T45_;
			T45_ = (NIM_BOOL)0;
			T45_ = matches_VCMdmeXpaOrMqkuJKekVZA(c, (*p)._Ukind.S6.sons->data[((NI) 1)], n_2);
			result = !(T45_);
		}
		goto LA40_;
		LA39_: ;
	...
	LA33_: ;
	{
		...
		{
			if (!((*(*p)._Ukind.S6.sons->data[((NI) 1)]).kind == ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 30))) goto LA56_;
			{
				NIM_BOOL T60_;
				T60_ = (NIM_BOOL)0;
				T60_ = matches_VCMdmeXpaOrMqkuJKekVZA(c, (*p)._Ukind.S6.sons->data[((NI) 0)], n_2);
				if (!T60_) goto LA61_;
				gather_hIzXa8r9c4bMqC9bQDGZhp0A(c, (*(*(*p)._Ukind.S6.sons->data[((NI) 1)])._Ukind.S6.sons->data[((NI) 1)])._Ukind.S4.sym, n_2);
				result = NIM_TRUE;
			}
			LA61_: ;
		}
		...
		{
			{
				NIM_BOOL T66_;
				T66_ = (NIM_BOOL)0;
				T66_ = matches_VCMdmeXpaOrMqkuJKekVZA(c, (*p)._Ukind.S6.sons->data[((NI) 0)], n_2);
				if (!T66_) goto LA67_;
				result = bindOrCheck_EggZoRCGflksdwwfiYwe9bA(c, (*(*p)._Ukind.S6.sons->data[((NI) 1)])._Ukind.S4.sym, n_2);
			}
			LA67_: ;
		}
		LA54_: ;
	...
	LA52_: ;
	{
		...
		case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 2):
		{
			result = ((*(*p)._Ukind.S5.ident).Sup.id == (*(*n_2)._Ukind.S5.ident).Sup.id);
		}
		break;
		case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 5) ... ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 10):
		{
			result = ((*p)._Ukind.S1.intVal == (*n_2)._Ukind.S1.intVal);
		}
		break;
		case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 16) ... ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 18):
		{
			result = ((*p)._Ukind.S2.floatVal == (*n_2)._Ukind.S2.floatVal);
		}
		break;
		case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 20) ... ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 22):
		{
			result = eqStrings((*p)._Ukind.S3.strVal, (*n_2)._Ukind.S3.strVal);
		}
		break;
		case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 1):
		case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 23):
		...
		default:
		{
			...
			v = lastSon_esDJA7239bJDiq4UrX9aHCjg(p);
			{
				...
				if (!(T82_)) goto LA83_;
				T82_ = ((*(*(*v)._Ukind.S4.sym).typ).kind == ((tyEnum_TTypeKind_9a3YiReNVD0IJHWFKgXRe9ag) 48));
				LA83_: ;
				if (!T82_) goto LA84_;
				arglist = (tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*)0;
				{
						...
						res = ((NI) 0);
						{
							while (1) {
								...
								i = res;
								{
									NIM_BOOL T96_;
									T96_ = (NIM_BOOL)0;
									T96_ = matches_VCMdmeXpaOrMqkuJKekVZA(c, (*p)._Ukind.S6.sons->data[i], (*n_2)._Ukind.S6.sons->data[i]);
									if (!!(T96_)) goto LA97_;
									goto BeforeRet_;
								}
								LA97_: ;
					...
					}
					{
						...
						T101_ = ((*(*T107_)._Ukind.S6.sons->data[((NI) 1)]).kind == ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 41));
						LA106_: ;
						if (!T101_) goto LA108_;
						T110_ = (tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*)0;
						T110_ = lastSon_esDJA7239bJDiq4UrX9aHCjg(n_2);
						n_3 = (*T110_)._Ukind.S6.sons->data[((NI) 1)];
						T111_ = (NI)0;
						T111_ = len_CdME9baJhvveuPEDZE9bXoxAsigmatch(n_3);
						arglist = newNodeI_lJ75Ni9cLabI0ssrSNczTxg(((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 152), (*n_3).info, T111_);
						{
							...
							i_2 = (NI)0;
							colontmp__2 = (NI)0;
							colontmp__2 = len_CdME9baJhvveuPEDZE9bXoxAsigmatch(n_3);
							i_3 = ((NI) 0);
							{
								while (1) {
									if (!(i_3 < colontmp__2)) goto LA114;
									i_2 = i_3;
									asgnRefNoCycle((void**) (&(*arglist)._Ukind.S6.sons->data[i_2]), (*n_3)._Ukind.S6.sons->data[i_2]);
									i_3 += ((NI) 1);
								} LA114: ;
							}
						}
						...
						arglist = newNodeI_lJ75Ni9cLabI0ssrSNczTxg(((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 152), (*n_2).info, (NI)((NI)(T116_ - plen) + ((NI) 1)));
						{
							...
							res_2 = ((NI) 0);
							{
								while (1) {
									...
									i_4 = res_2;
									asgnRefNoCycle((void**) (&(*arglist)._Ukind.S6.sons->data[i_4]), (*n_2)._Ukind.S6.sons->data[(NI)((NI)(i_4 + plen) - ((NI) 1))]);
									res_2 += ((NI) 1);
								} LA120: ;
							}
						}
					...
					LA99_: ;
					result = bindOrCheck_EggZoRCGflksdwwfiYwe9bA(c, (*v)._Ukind.S4.sym, arglist);
					goto BeforeRet_;
				}
				goto LA86_;
				LA89_: ;
						...
						res_3 = ((NI) 0);
						{
							while (1) {
								...
								i_5 = res_3;
								{
									NIM_BOOL T130_;
									T130_ = (NIM_BOOL)0;
									T130_ = matches_VCMdmeXpaOrMqkuJKekVZA(c, (*p)._Ukind.S6.sons->data[i_5], (*n_2)._Ukind.S6.sons->data[i_5]);
					...
					res_4 = ((NI) 0);
					{
						while (1) {
							...
							i_6 = res_4;
							{
								NIM_BOOL T144_;
								T144_ = (NIM_BOOL)0;
								T144_ = matches_VCMdmeXpaOrMqkuJKekVZA(c, (*p)._Ukind.S6.sons->data[i_6], (*n_2)._Ukind.S6.sons->data[i_6]);
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				j = i_2;
				{
					NIM_BOOL T6_;
					T6_ = (NIM_BOOL)0;
					T6_ = matches_VCMdmeXpaOrMqkuJKekVZA(c, (*p)._Ukind.S6.sons->data[j], (*n)._Ukind.S6.sons->data[(NI)(i + j)]);
					if (!!(T6_)) goto LA7_;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*, matchStmtList_llKO9cuhE9atweXgNJPGkR9aA)(tyObject_TPatternContext_ArP5wLemitHqyeu50ovXug* c, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* p, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	result = (tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*)0;
	{
		...
		if (!(T3_)) goto LA6_;
		T7_ = (NI)0;
		T7_ = len_CdME9baJhvveuPEDZE9bXoxAsigmatch(p);
		T8_ = (NI)0;
		...
		n_2 = flattenStmts_kDuk7Mp6Hb4CD2EwZbGQ3g(n);
		{
			...
			colontmp_ = (NI)0;
			T12_ = (NI)0;
			T12_ = len_CdME9baJhvveuPEDZE9bXoxAsigmatch(n_2);
			T13_ = (NI)0;
			...
			res = ((NI) 0);
			{
				while (1) {
					...
					i = res;
					{
						...
						asgnRefNoCycle((void**) (&(*result)._Ukind.S6.sons->data[((NI) 0)]), extractRange_hXdHXhYIaWyizlIOoxd1YA(((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 115), n_2, ((NI) 0), (NI)(i - ((NI) 1))));
						T21_ = (NI)0;
						T21_ = len_CdME9baJhvveuPEDZE9bXoxAsigmatch(p);
						asgnRefNoCycle((void**) (&(*result)._Ukind.S6.sons->data[((NI) 1)]), extractRange_hXdHXhYIaWyizlIOoxd1YA(((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 115), n_2, i, (NI)((NI)(i + T21_) - ((NI) 1))));
						T22_ = (NI)0;
						T22_ = len_CdME9baJhvveuPEDZE9bXoxAsigmatch(p);
						T23_ = (NI)0;
						T23_ = len_CdME9baJhvveuPEDZE9bXoxAsigmatch(n_2);
						asgnRefNoCycle((void**) (&(*result)._Ukind.S6.sons->data[((NI) 2)]), extractRange_hXdHXhYIaWyizlIOoxd1YA(((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 115), n_2, (NI)(i + T22_), (NI)(T23_ - ((NI) 1))));
						goto LA11;
					}
					LA19_: ;
					res += ((NI) 1);
		...
		if (!(((NI) 2) <= T3_)) goto LA4_;
		{
			...
			i_2 = ((NI) 1);
			{
				while (1) {
					...
					i = i_2;
					param = (*(*params)._Ukind.S6.sons->data[i])._Ukind.S4.sym;
					{
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*, applyRule_CznRIfbV1P9bsQhIYnRp0Qg)(tyObject_TContext_vTgAc1OsYaFyeD40uCdaWA* c, tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w* s, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n) {
	tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* result;
...
{	result = (tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*)0;
	...
	m = matchStmtList_llKO9cuhE9atweXgNJPGkR9aA((&ctx), (*(*s).ast)._Ukind.S6.sons->data[((NI) 1)], n);
	{
		if (!(m == 0)) goto LA4_;
		result = NIM_NIL;
		goto BeforeRet_;
		...
		if (!requiresAA) goto LA24_;
		{
			...
			i_4 = ((NI) 1);
			{
				while (1) {
					...
					i_3 = i_4;
					rs = (*result)._Ukind.S6.sons->data[i_3];
					param_2 = (*(*params)._Ukind.S6.sons->data[i_3])._Ukind.S4.sym;
							...
							arg = (tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*)0;
							{
								...
								i_6 = ((NI) 0);
								{
									while (1) {
										...
										i_5 = i_6;
										arg = (*args)._Ukind.S6.sons->data[i_5];
										{
											NIM_BOOL T38_;
							...
							arg_2 = (tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*)0;
							{
								...
								i_8 = ((NI) 0);
								{
									while (1) {
										...
										i_7 = i_8;
										arg_2 = (*args)._Ukind.S6.sons->data[i_7];
										{
											NIM_BOOL T54_;
	...
	markUsed_6hg0JhEmQNoQRUGJJom2vw((*(*c).graph).config, (*n).info, s, &(*(*c).graph).usageSym);
	{
		...
		asgnRefNoCycle((void**) (&(*m)._Ukind.S6.sons->data[((NI) 1)]), result);
		result = m;
	}
	LA65_: ;
	}BeforeRet_: ;
