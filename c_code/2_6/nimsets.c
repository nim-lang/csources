...
N_NIMCALL(NI64, cardset_243063)(tnode186813* s) {
	...
	while (1) {
		...
		nimln(155, "nimsets.nim");
		{
			...
			if (((TMP3156[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3157));
			if ((NU)(i_243903) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (((TMP3156[(*(*s).kindU.S6.Sons->data[i_243903]).Kind/8] &(1<<((*(*s).kindU.S6.Sons->data[i_243903]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3157));
