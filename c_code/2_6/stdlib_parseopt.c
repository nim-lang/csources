...
N_NIMCALL(void, handleshortoption_528106)(toptparser527807* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_528002((*p).Cmd, i, &(*p).Val, TMP7636);
	}
	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser527807* p) {
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_528002((*p).Cmd, i, &(*p).Key, TMP7637);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_528002((*p).Cmd, i, &(*p).Val, TMP7636);
			}
			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_528002((*p).Cmd, i, &(*p).Key, TMP7636);
	}
	break;
	}
	BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser527807* p) {
	...
	LOC1 = 0;
	LOC1 = copyStrLast((*p).Cmd, (*p).Pos, (NI32)(TMP7638));
...
TMP7640[0] = &TMP7630[1];
TMP7630[1].kind = 1;
TMP7630[1].offset = offsetof(toptparser527807, Cmd);
TMP7630[1].typ = (&NTI143);
TMP7630[1].name = "cmd";
TMP7640[1] = &TMP7630[2];
TMP7630[2].kind = 1;
TMP7630[2].offset = offsetof(toptparser527807, Pos);
TMP7630[2].typ = (&NTI106);
TMP7630[2].name = "pos";
TMP7640[2] = &TMP7630[3];
TMP7630[3].kind = 1;
TMP7630[3].offset = offsetof(toptparser527807, Inshortstate);
...
NTI527805.node = &TMP7630[9];
TMP7630[4].kind = 1;
TMP7630[4].offset = offsetof(toptparser527807, Kind);
TMP7630[4].typ = (&NTI527805);
TMP7630[4].name = "kind";
TMP7640[4] = &TMP7630[10];
TMP7630[10].kind = 1;
TMP7630[10].offset = offsetof(toptparser527807, Key);
TMP7630[10].typ = (&NTI143);
TMP7630[10].name = "key";
TMP7640[5] = &TMP7630[11];
TMP7630[11].kind = 1;
TMP7630[11].offset = offsetof(toptparser527807, Val);
TMP7630[11].typ = (&NTI143);
TMP7630[11].name = "val";
TMP7630[0].len = 6; TMP7630[0].kind = 2; TMP7630[0].sons = &TMP7640[0];
NTI527807.node = &TMP7630[0];
}
