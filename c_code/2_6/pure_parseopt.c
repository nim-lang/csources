...
STRING_LITERAL(TMP7028, "", 0);
STRING_LITERAL(TMP7032, "", 0);
...
N_NIMCALL(void, handleshortoption_417876)(toptparser417607* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_417802((*p).Cmd, i, &(*p).Val, TMP7033);
	}	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser417607* p) {
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_417802((*p).Cmd, i, &(*p).Key, TMP7034);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_417802((*p).Cmd, i, &(*p).Val, TMP7033);
			}			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_417802((*p).Cmd, i, &(*p).Key, TMP7033);
	}	break;
	}
	BeforeRet: ;	popFrame();
}
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser417607* p) {
	...
	nimln(128, "parseopt.nim");
	nimln(128, "parseopt.nim");
	TMP7035 = subInt((*p).Cmd->Sup.len, 1);
	LOC1 = 0;
	LOC1 = copyStrLast((*p).Cmd, (*p).Pos, (NI32)(TMP7035));
...
static TNimNode* TMP7037[6];
static TNimNode* TMP7038[4];
NI TMP7040;
static char* NIM_CONST TMP7039[4] = {
"cmdEnd", 
"cmdArgument", 
"cmdLongoption", 
"cmdShortOption"};
static TNimNode TMP7026[12];
...
TMP7037[0] = &TMP7026[1];
TMP7026[1].kind = 1;
TMP7026[1].offset = offsetof(toptparser417607, Cmd);
TMP7026[1].typ = (&NTI142);
TMP7026[1].name = "cmd";
TMP7037[1] = &TMP7026[2];
TMP7026[2].kind = 1;
TMP7026[2].offset = offsetof(toptparser417607, Pos);
TMP7026[2].typ = (&NTI105);
TMP7026[2].name = "pos";
TMP7037[2] = &TMP7026[3];
TMP7026[3].kind = 1;
TMP7026[3].offset = offsetof(toptparser417607, Inshortstate);
TMP7026[3].typ = (&NTI133);
TMP7026[3].name = "inShortState";
TMP7037[3] = &TMP7026[4];
NTI417605.size = sizeof(NU8);
NTI417605.kind = 14;
NTI417605.base = 0;
NTI417605.flags = 3;
for (TMP7040 = 0; TMP7040 < 4; TMP7040++) {
TMP7026[TMP7040+5].kind = 1;
TMP7026[TMP7040+5].offset = TMP7040;
TMP7026[TMP7040+5].name = TMP7039[TMP7040];
TMP7038[TMP7040] = &TMP7026[TMP7040+5];
}
TMP7026[9].len = 4; TMP7026[9].kind = 2; TMP7026[9].sons = &TMP7038[0];
NTI417605.node = &TMP7026[9];
TMP7026[4].kind = 1;
TMP7026[4].offset = offsetof(toptparser417607, Kind);
TMP7026[4].typ = (&NTI417605);
TMP7026[4].name = "kind";
TMP7037[4] = &TMP7026[10];
TMP7026[10].kind = 1;
TMP7026[10].offset = offsetof(toptparser417607, Key);
TMP7026[10].typ = (&NTI142);
TMP7026[10].name = "key";
TMP7037[5] = &TMP7026[11];
TMP7026[11].kind = 1;
TMP7026[11].offset = offsetof(toptparser417607, Val);
TMP7026[11].typ = (&NTI142);
TMP7026[11].name = "val";
TMP7026[0].len = 6; TMP7026[0].kind = 2; TMP7026[0].sons = &TMP7037[0];
NTI417607.node = &TMP7026[0];
}
