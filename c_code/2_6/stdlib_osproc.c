...
N_NIMCALL(NCSTRING*, envtocstringarray_127604)(tstringtable120810* t) {
	...
	TMP365 = mulInt((NI32)(TMP364), 4);
	LOC2 = 0;
	LOC2 = alloc0_4616((NI32)(TMP365));
...
appendString(LOC8, val_127611);
			...
			memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI32)(TMP368));
...
N_NIMCALL(NCSTRING*, envtocstringarray_127641)(void) {
	...
	while (1) {
		...
		key_127645 = copyStrLast(environment_110806->data[i_127686], 0, (NI32)(TMP369));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_127686) >= (NU)(environment_110806->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP370 = addInt(p_127692, 1);
		val_127646 = copyStr(environment_110806->data[i_127686], (NI32)(TMP370));
	...
	TMP372 = mulInt((NI32)(TMP371), 4);
	LOC2 = 0;
	LOC2 = alloc0_4616((NI32)(TMP372));
	result = ((NCSTRING*) (LOC2));
	...
	while (1) {
		...
		key_127665 = copyStrLast(environment_110806->data[i_127702], 0, (NI32)(TMP373));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_127702) >= (NU)(environment_110806->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP374 = addInt(p_127708, 1);
		val_127666 = copyStr(environment_110806->data[i_127702], (NI32)(TMP374));
...
appendString(LOC4, val_127666);
		...
		memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI32)(TMP376));
...
N_NIMCALL(void, pruneprocessset_129634)(TY127203** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(924, "osproc.nim");
		{
			...
			nimln(925, "osproc.nim");
			TMP389 = subInt(l, 1);
			if ((NU)((NI32)(TMP389)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRef((void**) &(*s)->data[i], (*s)->data[(NI32)(TMP389)]);
...
N_NIMCALL(NI, select_127521)(TY127203** readfds, NI timeout) {
	...
	nimln(940, "osproc.nim");
	{
		...
		TMP391 = addInt(m, 1);
		LOC5 = 0;
		LOC5 = select(((int) ((NI32)(TMP391))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		TMP392 = addInt(m, 1);
		LOC7 = 0;
		LOC7 = select(((int) ((NI32)(TMP392))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
