...
TNimType NTI_9agrCtWKhCnWWMJpKKugJag;
...
N_NIMCALL(void, incl_iUpE9bYmIR0fROyJskQwN8g)(Intset_PQrmFm4BXFkFSVOUl1ojSg* s0, NI key0) {
	...
	NI u0;
	t0 = intsetput_0ZDJhLLWVElSxfwD0RRxbQ(s0, (NI)((NU32)(key0) >> (NU32)(((NI) 9))));
	u0 = (NI)(key0 & ((NI) 511));
...
N_NIMCALL(NIM_BOOL, containsorincl_B0EhVMrh5BBBZOOtYjAvVg)(Intset_PQrmFm4BXFkFSVOUl1ojSg* s0, NI key0) {
	...
	Trunk_ul49aWfv9aes8cutmeltT3gQ* t0;
	result0 = (NIM_BOOL)0;
	t0 = intsetget_IcxbJfpUmsxePO8Fvv2aCg((*s0), (NI)((NU32)(key0) >> (NU32)(((NI) 9))));
	{
		NI u0;
...
N_NIMCALL(void, assign_a2uuNOWD29cFDODAp4nip0A)(Intset_PQrmFm4BXFkFSVOUl1ojSg* dest0, Intset_PQrmFm4BXFkFSVOUl1ojSg src0) {
	...
	it0 = src0.head;
	{
		while (1) {
			...
			(*n0).key = (*it0).key;
			memcpy((void*)(*n0).bits, (NIM_CONST void*)(*it0).bits, sizeof(TY_9agrCtWKhCnWWMJpKKugJag));
...
NTI_9agrCtWKhCnWWMJpKKugJag.size = sizeof(TY_9agrCtWKhCnWWMJpKKugJag);
NTI_9agrCtWKhCnWWMJpKKugJag.kind = 16;
NTI_9agrCtWKhCnWWMJpKKugJag.base = (&NTI_rR5Bzr1D5krxoo1NcNyeMA);
NTI_9agrCtWKhCnWWMJpKKugJag.flags = 3;
T_ulJ2WYumkJwZ9b5Ewe7sCpg_0[3].kind = 1;
T_ulJ2WYumkJwZ9b5Ewe7sCpg_0[3].offset = offsetof(Trunk_ul49aWfv9aes8cutmeltT3gQ, bits);
T_ulJ2WYumkJwZ9b5Ewe7sCpg_0[3].typ = (&NTI_9agrCtWKhCnWWMJpKKugJag);
