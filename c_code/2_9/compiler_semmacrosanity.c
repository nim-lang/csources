...
appendString(LOC32, LOC33);
	...
	{
		{
			if (!((151060496 &((NU64)1<<((NU)((*x_478125_658252590).kind)&63U)))!=0)) goto LA44;
			asgnRefNoCycle((void**) (&(*n0).typ), t0);
			{
	...
	{
		{
			if (!((524288 &((NU64)1<<((NU)((*x_478125_658252590).kind)&63U)))!=0)) goto LA56;
			asgnRefNoCycle((void**) (&(*n0).typ), t0);
			{
	...
	{
		{
			if (!((IL64(1030792151040) &((NU64)1<<((NU)((*x_478125_658252590).kind)&63U)))!=0)) goto LA68;
			asgnRefNoCycle((void**) (&(*n0).typ), t0);
		}
		goto LA66;
		LA68: ;
	...
	{
		{
			if (!((IL64(35182224621574) &((NU64)1<<((NU)((*x_478125_658252590).kind)&63U)))!=0)) goto LA74;
			asgnRefNoCycle((void**) (&(*n0).typ), t0);
		}
		goto LA72;
		LA74: ;
	...
	{
		{
			if (!((805306368 &((NU64)1<<((NU)((*x_478125_658252590).kind)&63U)))!=0)) goto LA80;
			asgnRefNoCycle((void**) (&(*n0).typ), t0);
		}
		goto LA78;
		LA80: ;
	...
	{
		{
			if (!((IL64(1125900835880960) &((NU64)1<<((NU)((*x_478125_658252590).kind)&63U)))!=0)) goto LA86;
			asgnRefNoCycle((void**) (&(*n0).typ), t0);
		}
		goto LA84;
		LA86: ;
