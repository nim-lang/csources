...
N_LIB_PRIVATE N_NIMCALL(tyObject_RstNode_CjRS2xrmuD58kdGedE3yyg*, lastSon_0dL43t7uo9b9ast8lG3CHj1A)(tyObject_RstNode_CjRS2xrmuD58kdGedE3yyg* n) {
	...
	NI T1_;
	NI TM_MI3pYf9cgAsIrjZXIlQqHnQ_6;
	result = (tyObject_RstNode_CjRS2xrmuD58kdGedE3yyg*)0;
	T1_ = ((*n).sons ? (*n).sons->Sup.len : 0);
	TM_MI3pYf9cgAsIrjZXIlQqHnQ_6 = subInt(T1_, ((NI) 1));
	if ((NU)((NI)(TM_MI3pYf9cgAsIrjZXIlQqHnQ_6)) >= (NU)((*n).sons ? (*n).sons->Sup.len : 0)) raiseIndexError2((NI)(TM_MI3pYf9cgAsIrjZXIlQqHnQ_6),((*n).sons ? (*n).sons->Sup.len : 0)-1);
	result = (*n).sons->data[(NI)(TM_MI3pYf9cgAsIrjZXIlQqHnQ_6)];
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_RstNode_CjRS2xrmuD58kdGedE3yyg*, newRstNode_1jaf6GW9cTGFKmVxMM1pg9aA)(tyEnum_RstNodeKind_Q1jM9a8f0MKlvbLZpipB3qg kind, NimStringDesc* s) {
	...
	NimStringDesc* T1_;
	result = (tyObject_RstNode_CjRS2xrmuD58kdGedE3yyg*)0;
	result = newRstNode_9bXoUUqG5jV9cUn3dHohLAXA(kind);
	T1_ = (NimStringDesc*)0;
...
N_LIB_PRIVATE N_NIMCALL(void, add_6h6IpXf2O9aeD4hz9aJicc2A)(tyObject_RstNode_CjRS2xrmuD58kdGedE3yyg* father, tyObject_RstNode_CjRS2xrmuD58kdGedE3yyg* son) {
	NI T1_;
	asgnRef((void**) (&(*father).sons), (tySequence_sawZST1Esj3o7EY9ayWwGPw*) incrSeqV3((TGenericSeq*)((*father).sons), (&NTI_sawZST1Esj3o7EY9ayWwGPw_)));
...
N_LIB_PRIVATE N_NIMCALL(void, add_LfzNpI2Kb4J8icovXV69apg)(tyObject_RstNode_CjRS2xrmuD58kdGedE3yyg* father, NimStringDesc* s) {
	tyObject_RstNode_CjRS2xrmuD58kdGedE3yyg* T1_;
	NI T2_;
	T1_ = (tyObject_RstNode_CjRS2xrmuD58kdGedE3yyg*)0;
	T1_ = newRstNode_1jaf6GW9cTGFKmVxMM1pg9aA(((tyEnum_RstNodeKind_Q1jM9a8f0MKlvbLZpipB3qg) 64), s);
	asgnRef((void**) (&(*father).sons), (tySequence_sawZST1Esj3o7EY9ayWwGPw*) incrSeqV3((TGenericSeq*)((*father).sons), (&NTI_sawZST1Esj3o7EY9ayWwGPw_)));
...
N_LIB_PRIVATE N_NIMCALL(void, addIfNotNil_6h6IpXf2O9aeD4hz9aJicc2A_2)(tyObject_RstNode_CjRS2xrmuD58kdGedE3yyg* father, tyObject_RstNode_CjRS2xrmuD58kdGedE3yyg* son) {
	{
		...
		add_6h6IpXf2O9aeD4hz9aJicc2A(father, son);
	}
	LA3_: ;
}
N_LIB_PRIVATE N_NIMCALL(void, docutils_rstastDatInit000)(void) {
static TNimNode* TM_MI3pYf9cgAsIrjZXIlQqHnQ_2_4[4];
static TNimNode* TM_MI3pYf9cgAsIrjZXIlQqHnQ_3_65[65];
...
TM_MI3pYf9cgAsIrjZXIlQqHnQ_2_4[0] = &TM_MI3pYf9cgAsIrjZXIlQqHnQ_0[1];
...
TM_MI3pYf9cgAsIrjZXIlQqHnQ_3_65[TM_MI3pYf9cgAsIrjZXIlQqHnQ_5] = &TM_MI3pYf9cgAsIrjZXIlQqHnQ_0[TM_MI3pYf9cgAsIrjZXIlQqHnQ_5+2];
}
TM_MI3pYf9cgAsIrjZXIlQqHnQ_0[67].len = 65; TM_MI3pYf9cgAsIrjZXIlQqHnQ_0[67].kind = 2; TM_MI3pYf9cgAsIrjZXIlQqHnQ_0[67].sons = &TM_MI3pYf9cgAsIrjZXIlQqHnQ_3_65[0];
...
TM_MI3pYf9cgAsIrjZXIlQqHnQ_2_4[1] = &TM_MI3pYf9cgAsIrjZXIlQqHnQ_0[68];
...
TM_MI3pYf9cgAsIrjZXIlQqHnQ_2_4[2] = &TM_MI3pYf9cgAsIrjZXIlQqHnQ_0[69];
...
TM_MI3pYf9cgAsIrjZXIlQqHnQ_2_4[3] = &TM_MI3pYf9cgAsIrjZXIlQqHnQ_0[70];
...
TM_MI3pYf9cgAsIrjZXIlQqHnQ_0[0].len = 4; TM_MI3pYf9cgAsIrjZXIlQqHnQ_0[0].kind = 2; TM_MI3pYf9cgAsIrjZXIlQqHnQ_0[0].sons = &TM_MI3pYf9cgAsIrjZXIlQqHnQ_2_4[0];
