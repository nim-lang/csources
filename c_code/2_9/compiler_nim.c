...
{	{
	...
	LA4: ;
	{
		...
		scriptfile = noschangeFileExt(gprojectfull_161201, ((NimStringDesc*) &TMP2060));
		{
			...
			if (!LOC25) goto LA26;
			runnimscript_536203(scriptfile);
			{
		...
		maincommand_533610();
		{
			...
			if (!(LOC44)) goto LA45;
			LOC44 = ((gnotes_184077 &((NU64)1<<((NU)((((NU16) 289)- 237))&63U)))!=0);
			LA45: ;
			if (!LOC44) goto LA46;
			LOC48 = 0;
		...
		LA46: ;
		{
			if (!(gerrorcounter_184078 == ((NI) 0))) goto LA51;
			{
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	...
	msgquit_184149(((NI8) ((((NI) 0) < gerrorcounter_184078))));
}
