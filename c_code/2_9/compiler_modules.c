...
N_NIMCALL(NU8, checkdepmem_532372)(NI32 fileidx);
...
N_NIMCALL(void, dohash_532102)(NI32 fileidx) {
	{
		...
		LOC5 = 0;
		LOC5 = tofullpath_184266(fileidx);
...
N_NIMCALL(Tsym215822*, newmodule_532622)(NI32 fileidx) {
	...
	(*result).Sup.id = ((NI) -1);
	(*result).kind = ((NU8) 6);
	filename = tofullpath_184266(fileidx);
	...
	LA5: ;
	(*result).info = newlineinfo_184023(fileidx, ((NI) 1), ((NI) 1));
	LOC7 = 0;
	LOC7 = getpackagename_162006(filename);
	LOC8 = 0;
	LOC8 = getident_190441(LOC7);
	asgnRefNoCycle((void**) (&(*result).owner), newsym_216683(((NU8) 23), LOC8, NIM_NIL, (*result).info));
...
N_NIMCALL(NIM_BOOL, hashchanged_532078)(NI32 fileidx) {
	...
	case ((NU8) 1):
	{
		...
		LOC11 = 0;
		LOC11 = tofullpath_184266(fileidx);
	...
	case ((NU8) 0):
	{
		NimStringDesc* LOC19;
		LOC19 = 0;
		LOC19 = tofullpath_184266(fileidx);
		...
		gmemcachedata_532059->data[fileidx].needsrecompile = ((NU8) 3);
		{
			...
			L_532621 = (HEX3Atmp_532616 ? HEX3Atmp_532616->Sup.len : 0);
			{
				while (1) {
					...
					d = checkdepmem_532372(dep_532602);
					{
	...
	{
		{
			NU8 LOC33;
			LOC33 = 0;
			LOC33 = checkdepmem_532372(fileidx);
...
N_NIMCALL(void, compilesystemmodule_532856)(void) {
	{
		...
		systemfileidx_183630 = fileinfoidx_184016(LOC5);
		LOC6 = 0;
...
N_NIMCALL(void, wantmainmodule_532871)(void) {
	NimStringDesc* LOC5;
	{
		...
		fatal_188066(gcmdlineinfo_184045, ((NU16) 191), ((NimStringDesc*) &TMP4539));
	}
	LA3: ;
	LOC5 = 0;
	LOC5 = nosaddFileExt(gprojectfull_161201, ((NimStringDesc*) &TMP4540));
	gprojectmainidx_161203 = fileinfoidx_184016(LOC5);
}
...
N_NIMCALL(void, compileproject_532877)(NI32 projectfileidx) {
	...
	systemfileidx = fileinfoidx_184016(LOC1);
	{
...
N_NIMCALL(void, resetallmodules_532318)(void) {
	{
		...
		i_532329 = 0;
		HEX3Atmp_532343 = 0;
		HEX3Atmp_532343 = (gcompiledmodules_532041 ? (gcompiledmodules_532041->Sup.len-1) : -1);
		res_532346 = ((NI) 0);
		{
			while (1) {
				if (!(res_532346 <= HEX3Atmp_532343)) goto LA3;
				i_532329 = res_532346;
				{
					if (!!((gcompiledmodules_532041->data[i_532329] == NIM_NIL))) goto LA6;
					resetmodule_532258(((NI32) (i_532329)));
				}
				LA6: ;
				res_532346 += ((NI) 1);
			} LA3: ;
