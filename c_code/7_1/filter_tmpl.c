...
#include <stdio.h>
typedef struct ttmplparser217017 ttmplparser217017;
...
N_NIMCALL(void, newline_217040)(ttmplparser217017* p);
...
N_NIMCALL(void, scanpar_217047)(ttmplparser217017* p, NI d);
N_NOINLINE(void, raiseIndexError)(void);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NOINLINE(void, raiseOverflow)(void);
static N_INLINE(NI, subInt)(NI a, NI b);
static N_INLINE(NIM_BOOL, withinexpr_217168)(ttmplparser217017* p);
N_NIMCALL(void, parseline_217177)(ttmplparser217017* p);
...
NIM_CONST TY121387 patternchars_217037 = {
...
static NIM_CONST TY121387 TMP2672 = {
...
N_NIMCALL(void, newline_217040)(ttmplparser217017* p) {
	...
	llstreamwrite_173258((*p).Outp, LOC1);
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		nimln(42, "filter_tmpl.nim");
		llstreamwrite_173258((*p).Outp, ((NimStringDesc*) &TMP2667));
	}
	LA4: ;
	nimln(43, "filter_tmpl.nim");
	{
		...
		llstreamwrite_173258((*p).Outp, LOC10);
...
N_NIMCALL(void, parseline_217177)(ttmplparser217017* p) {
	...
	LA6: ;
	{
		...
		LOC13 = 0;
		nimln(83, "filter_tmpl.nim");
		LOC13 = withinexpr_217168(&(*p));
		if (LOC13) goto LA14;
		nimln(83, "filter_tmpl.nim");
		LOC13 = endswithopr_173646((*p).X);
		LA14: ;
		(*p).Pendingexprline = LOC13;
		nimln(84, "filter_tmpl.nim");
		nimln(84, "filter_tmpl.nim");
		LOC15 = 0;
		LOC15 = whichkeyword_169367(keyw);
		switch (LOC15) {
		case ((NU8) 20):
		{
			NimStringDesc* LOC22;
			...
			LA19: ;
			{
				...
				localerror_163571((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP2669));
			}
			LA17: ;
			...
			llstreamwrite_173258((*p).Outp, LOC22);
			nimln(92, "filter_tmpl.nim");
			llstreamwrite_173258((*p).Outp, ((NimStringDesc*) &TMP2670));
		}
		break;
		case ((NU8) 28):
		case ((NU8) 63):
		...
		case ((NU8) 39):
		{
			...
			llstreamwrite_173258((*p).Outp, LOC24);
			nimln(96, "filter_tmpl.nim");
			nimln(96, "filter_tmpl.nim");
			LOC25 = 0;
			LOC25 = copyStr((*p).X, d);
			llstreamwrite_173258((*p).Outp, LOC25);
		...
		case ((NU8) 24):
		{
			...
			llstreamwrite_173258((*p).Outp, LOC27);
			nimln(100, "filter_tmpl.nim");
			nimln(100, "filter_tmpl.nim");
			LOC28 = 0;
			LOC28 = copyStr((*p).X, d);
			llstreamwrite_173258((*p).Outp, LOC28);
		}
		break;
		case ((NU8) 37):
		case ((NU8) 62):
		...
		case ((NU8) 60):
		{
			...
			llstreamwrite_173258((*p).Outp, LOC30);
			nimln(103, "filter_tmpl.nim");
			nimln(103, "filter_tmpl.nim");
			LOC31 = 0;
			LOC31 = copyStr((*p).X, d);
			llstreamwrite_173258((*p).Outp, LOC31);
		...
		default:
		{
			...
			llstreamwrite_173258((*p).Outp, LOC38);
			nimln(109, "filter_tmpl.nim");
			nimln(109, "filter_tmpl.nim");
			LOC39 = 0;
			LOC39 = copyStr((*p).X, d);
			llstreamwrite_173258((*p).Outp, LOC39);
		}
		break;
		}
	...
	LA9: ;
	{
		...
		case ((NU8) 1):
		{
			...
			llstreamwrite_173258((*p).Outp, (*p).Conc);
			...
			llstreamwrite_173258((*p).Outp, LOC42);
			nimln(124, "filter_tmpl.nim");
			llstreamwrite_173258((*p).Outp, ((NimStringDesc*) &TMP2674));
		}
		break;
		case ((NU8) 0):
		{
			...
			llstreamwrite_173258((*p).Outp, LOC44);
			nimln(128, "filter_tmpl.nim");
			llstreamwrite_173258((*p).Outp, (*p).Emit);
			nimln(129, "filter_tmpl.nim");
			llstreamwrite_173258((*p).Outp, ((NimStringDesc*) &TMP2675));
		...
		while (1) {
			...
			case 128 ... 255:
			{
				...
				llstreamwrite_173258((*p).Outp, ((NimStringDesc*) &TMP2676));
				...
				llstreamwrite_173258((*p).Outp, LOC48);
			...
			case 92:
			{
				...
				llstreamwrite_173258((*p).Outp, ((NimStringDesc*) &TMP2677));
			...
			case 39:
			{
				...
				llstreamwrite_173258((*p).Outp, ((NimStringDesc*) &TMP2678));
			...
			case 34:
			{
				...
				llstreamwrite_173258((*p).Outp, ((NimStringDesc*) &TMP2679));
			...
			default:
			{
				nimln(150, "filter_tmpl.nim");
				{
					...
					case 123:
					{
						...
						llstreamwrite_173263((*p).Outp, 34);
						nimln(157, "filter_tmpl.nim");
						llstreamwrite_173258((*p).Outp, (*p).Conc);
						nimln(158, "filter_tmpl.nim");
						llstreamwrite_173258((*p).Outp, (*p).Tostr);
						nimln(159, "filter_tmpl.nim");
						llstreamwrite_173263((*p).Outp, 40);
						...
						while (1) {
							...
							case 0:
							{
								...
								localerror_163571((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP2680));
							...
							case 123:
							{
								...
								llstreamwrite_173263((*p).Outp, 123);
							}
							break;
							case 125:
							{
								...
								llstreamwrite_173263((*p).Outp, 125);
							}
							break;
							default:
							{
								...
								if ((NU)(j) > (NU)((*p).X->Sup.len)) raiseIndexError();
								llstreamwrite_173263((*p).Outp, (*p).X->data[j]);
						...
						llstreamwrite_173263((*p).Outp, 41);
					...
					default:
					{
						nimln(194, "filter_tmpl.nim");
						{
							...
							llstreamwrite_173263((*p).Outp, (*p).Subschar);
						...
						LA76: ;
						{
							...
							localerror_163571((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP2681));
						}
						LA74: ;
					}
					break;
		...
		llstreamwrite_173258((*p).Outp, ((NimStringDesc*) &TMP2682));
	}
	LA2: ;
	popFrame();
}
...
N_NIMCALL(tllstream173204*, filtertmpl_217007)(tllstream173204* stdin_217009, NimStringDesc* filename, tnode185813* call) {
	...
	p.Info = newlineinfo_162077(filename, 0, 0);
	nimln(208, "filter_tmpl.nim");
	p.Outp = llstreamopen_173218(((NimStringDesc*) &TMP2668));
	nimln(209, "filter_tmpl.nim");
	p.Inp = stdin_217009;
	nimln(210, "filter_tmpl.nim");
	p.Subschar = chararg_216014(call, ((NimStringDesc*) &TMP2683), 1, 36);
	nimln(211, "filter_tmpl.nim");
	p.Nimdirective = chararg_216014(call, ((NimStringDesc*) &TMP2684), 2, 35);
	nimln(212, "filter_tmpl.nim");
	p.Emit = strarg_216021(call, ((NimStringDesc*) &TMP2685), 3, ((NimStringDesc*) &TMP2686));
	nimln(213, "filter_tmpl.nim");
	p.Conc = strarg_216021(call, ((NimStringDesc*) &TMP2687), 4, ((NimStringDesc*) &TMP2688));
	nimln(214, "filter_tmpl.nim");
	p.Tostr = strarg_216021(call, ((NimStringDesc*) &TMP2689), 5, ((NimStringDesc*) &TMP2681));
	...
	while (1) {
		...
		nimln(216, "filter_tmpl.nim");
		LOC2 = 0;
		LOC2 = llstreamreadline_173248(p.Inp, &p.X);
		if (!LOC2) goto LA1;
