...
N_NIMCALL(tnode223819*, extractrange_259419)(NU8 k, tnode223819* n, NI a, NI b) {
	tnode223819* result;
	result = 0;
	result = newnodei_226007(k, (*n).Info, (NI32)((NI32)(b - a) + 1));
	{
		NI i_259436;
		NI HEX3Atmp_259466;
		NI res_259469;
		i_259436 = 0;
		HEX3Atmp_259466 = 0;
		HEX3Atmp_259466 = (NI32)(b - a);
		res_259469 = 0;
		{
			while (1) {
				if (!(res_259469 <= HEX3Atmp_259466)) goto LA3;
				i_259436 = res_259469;
				asgnRefNoCycle((void**) &(*result).kindU.S6.Sons->data[i_259436], (*n).kindU.S6.Sons->data[(NI32)(i_259436 + a)]);
				res_259469 += 1;
			} LA3: ;
		}
	}
