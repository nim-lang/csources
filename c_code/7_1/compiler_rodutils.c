...
N_NIMCALL(void, hexchar_178058)(NIM_CHAR c, NI* xi) {
	...
	case 48 ... 57:
	{
		...
		(*xi) = (NI)((NI)((NU32)((*xi)) << (NU32)(4)) | ((NI) ((NI32)(TMP2074))));
	}	break;
	case 97 ... 102:
	{
		NI TMP2075;
		...
		TMP2076 = addInt(((NI) ((NI32)(TMP2075))), 10);
		(*xi) = (NI)((NI)((NU32)((*xi)) << (NU32)(4)) | ((NI) ((NI32)(TMP2076))));
	}	break;
	case 65 ... 70:
	{
		NI TMP2077;
		...
		TMP2078 = addInt(((NI) ((NI32)(TMP2077))), 10);
		(*xi) = (NI)((NI)((NU32)((*xi)) << (NU32)(4)) | ((NI) ((NI32)(TMP2078))));
	}	break;
	default:
	{
	}	break;
...
N_NIMCALL(NimStringDesc*, decodestr_178114)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 92:
		{
			...
			nimln(49, "rodutils.nim");
			TMP2080 = subInt(i, 2);
			hexchar_178058(s[(NI32)(TMP2080)], &xi);			nimln(50, "rodutils.nim");
			nimln(50, "rodutils.nim");
			TMP2081 = subInt(i, 1);
			hexchar_178058(s[(NI32)(TMP2081)], &xi);			nimln(51, "rodutils.nim");
...
N_NIMCALL(void, encodevbiggestintaux_178161)(NI64 x, NimStringDesc** result) {
	...
	nimln(70, "rodutils.nim");
	TMP2082 = modInt64(v_178169, 190);
	rem_178171 = (NI64)(TMP2082);
	...
	LA3: ;
	{
		...
		nimln(76, "rodutils.nim");
		TMP2084 = divInt64(v_178169, 190);
		v_178169 = (NI64)(TMP2084);
	}	LA1: ;
	...
	nimln(78, "rodutils.nim");
	{
		...
		nimln(78, "rodutils.nim");
		if ((NU)(idx_178173) > (NU)(((NimStringDesc*) &TMP2085)->Sup.len)) raiseIndexError();
		d_178167 = ((NimStringDesc*) &TMP2085)->data[idx_178173];
	}	goto LA6;
	LA8: ;
	{
		NI TMP2086;
		...
		nimln(79, "rodutils.nim");
		nimln(79, "rodutils.nim");
		TMP2086 = subInt(idx_178173, 62);
		TMP2087 = addInt((NI32)(TMP2086), 128);
		d_178167 = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP2087), 0, 255))));
	}	LA6: ;
...
N_NIMCALL(void, encodevintaux_178193)(NI x, NimStringDesc** result) {
	...
	nimln(70, "rodutils.nim");
	nimln(70, "rodutils.nim");
	TMP2088 = modInt(v_178201, 190);
	rem_178203 = (NI32)(TMP2088);
	nimln(71, "rodutils.nim");
	{
		NI TMP2089;
		nimln(71, "rodutils.nim");
		...
		nimln(73, "rodutils.nim");
		nimln(73, "rodutils.nim");
		TMP2089 = divInt(v_178201, 190);
		if ((NI32)(TMP2089) == (-2147483647 -1)) raiseOverflow();
		v_178201 = ((NI32)-((NI32)(TMP2089)));
		nimln(74, "rodutils.nim");
		nimln(74, "rodutils.nim");
	...
	LA3: ;
	{
		...
		nimln(76, "rodutils.nim");
		nimln(76, "rodutils.nim");
		TMP2090 = divInt(v_178201, 190);
		v_178201 = (NI32)(TMP2090);
	}	LA1: ;
	nimln(77, "rodutils.nim");
	...
	nimln(78, "rodutils.nim");
	{
		...
		nimln(78, "rodutils.nim");
		if ((NU)(idx_178205) > (NU)(((NimStringDesc*) &TMP2085)->Sup.len)) raiseIndexError();
		d_178199 = ((NimStringDesc*) &TMP2085)->data[idx_178205];
	}	goto LA6;
	LA8: ;
	{
		NI TMP2091;
		...
		nimln(79, "rodutils.nim");
		nimln(79, "rodutils.nim");
		TMP2091 = subInt(idx_178205, 62);
		TMP2092 = addInt((NI32)(TMP2091), 128);
		d_178199 = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP2092), 0, 255))));
	}	LA6: ;
	nimln(80, "rodutils.nim");
	{
		nimln(698, "system.nim");
...
N_NIMCALL(NI, decodevint_178239)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 48 ... 57:
		{
			...
			nimln(110, "rodutils.nim");
			nimln(110, "rodutils.nim");
			TMP2095 = subInt(((NI) (((NU8)(s[i_178246])))), 48);
			TMP2096 = subInt((NI32)(TMP2094), ((NI) ((NI32)(TMP2095))));
			result = (NI32)(TMP2096);
		}		break;
		case 97 ... 122:
		{
			...
			nimln(111, "rodutils.nim");
			nimln(111, "rodutils.nim");
			TMP2098 = subInt(((NI) (((NU8)(s[i_178246])))), 97);
			TMP2099 = addInt(((NI) ((NI32)(TMP2098))), 10);
			TMP2100 = subInt((NI32)(TMP2097), ((NI) ((NI32)(TMP2099))));
			result = (NI32)(TMP2100);
		}		break;
		case 65 ... 90:
		{
			...
			nimln(112, "rodutils.nim");
			nimln(112, "rodutils.nim");
			TMP2102 = subInt(((NI) (((NU8)(s[i_178246])))), 65);
			TMP2103 = addInt(((NI) ((NI32)(TMP2102))), 36);
			TMP2104 = subInt((NI32)(TMP2101), ((NI) ((NI32)(TMP2103))));
			result = (NI32)(TMP2104);
		}		break;
		case 128 ... 255:
		{
			...
			nimln(113, "rodutils.nim");
			nimln(113, "rodutils.nim");
			TMP2106 = subInt(((NI) (((NU8)(s[i_178246])))), 128);
			TMP2107 = addInt(((NI) ((NI32)(TMP2106))), 62);
			TMP2108 = subInt((NI32)(TMP2105), ((NI) ((NI32)(TMP2107))));
			result = (NI32)(TMP2108);
		}		break;
		default:
		{
	...
	nimln(116, "rodutils.nim");
	nimln(116, "rodutils.nim");
	TMP2109 = mulInt(result, sign_178248);
	result = (NI)((NU32)((NI32)(TMP2109)) - (NU32)(5));
...
N_NIMCALL(NI64, decodevbiggestint_178495)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 48 ... 57:
		{
			...
			nimln(110, "rodutils.nim");
			nimln(110, "rodutils.nim");
			TMP2111 = subInt(((NI) (((NU8)(s[i_178502])))), 48);
			TMP2112 = subInt64((NI64)(TMP2110), ((NI64) ((NI32)(TMP2111))));
			result = (NI64)(TMP2112);
		}		break;
		case 97 ... 122:
		{
			...
			nimln(111, "rodutils.nim");
			nimln(111, "rodutils.nim");
			TMP2114 = subInt(((NI) (((NU8)(s[i_178502])))), 97);
			TMP2115 = addInt(((NI) ((NI32)(TMP2114))), 10);
			TMP2116 = subInt64((NI64)(TMP2113), ((NI64) ((NI32)(TMP2115))));
			result = (NI64)(TMP2116);
		}		break;
		case 65 ... 90:
		{
			...
			nimln(112, "rodutils.nim");
			nimln(112, "rodutils.nim");
			TMP2118 = subInt(((NI) (((NU8)(s[i_178502])))), 65);
			TMP2119 = addInt(((NI) ((NI32)(TMP2118))), 36);
			TMP2120 = subInt64((NI64)(TMP2117), ((NI64) ((NI32)(TMP2119))));
			result = (NI64)(TMP2120);
		}		break;
		case 128 ... 255:
		{
			...
			nimln(113, "rodutils.nim");
			nimln(113, "rodutils.nim");
			TMP2122 = subInt(((NI) (((NU8)(s[i_178502])))), 128);
			TMP2123 = addInt(((NI) ((NI32)(TMP2122))), 62);
			TMP2124 = subInt64((NI64)(TMP2121), ((NI64) ((NI32)(TMP2123))));
			result = (NI64)(TMP2124);
		}		break;
		default:
		{
	...
	nimln(116, "rodutils.nim");
	nimln(116, "rodutils.nim");
	TMP2125 = mulInt64(result, ((NI64) (sign_178504)));
