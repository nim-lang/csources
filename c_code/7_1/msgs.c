...
N_NOINLINE(void, raiserecoverableerror_195247)(NimStringDesc* msg);
...
tlineinfo194539 gcmdlineinfo_195192;
tlineinfo194539 gcodegenlineinfo_195239;
NU64 gnotes_195305;
NI gerrorcounter_195306;
NI ghintcounter_195307;
NI gwarncounter_195308;
NI gerrormax_195309;
tsocketimpl181607* stdoutsocket_195318;
...
TNimType NTI195253; /* ref ERecoverableError */
...
N_NIMCALL(trope176009*, makecstring_194659)(NimStringDesc* s) {
	...
	res = copyString(((NimStringDesc*) &TMP143));
	{
		...
		i_194677 = 0;
		HEX3Atmp_194682 = 0;
		HEX3Atmp_194682 = (NI32)(s->Sup.len - 1);
		res_194685 = 0;
		{
			while (1) {
				NimStringDesc* LOC9;
				...
				{
					trope176009* LOC8;
					if (!(((NI) ((NI32)((NI32)(i_194677 + 1) % 64))) == 0)) goto LA6;
					res = addChar(res, 34);
...
N_NIMCALL(void, writecontext_196590)(tlineinfo194539 lastinfo) {
	...
	info = lastinfo;
	{
		...
		i_196617 = 0;
		HEX3Atmp_196623 = 0;
		HEX3Atmp_196623 = (NI32)(msgcontext_195435->Sup.len - 1);
		res_196626 = 0;
		{
			while (1) {
...
N_NOINLINE(void, raiserecoverableerror_195247)(NimStringDesc* msg) {
	erecoverableerror194545* e_195252;
	NimStringDesc* LOC1;
	e_195252 = 0;
	e_195252 = (erecoverableerror194545*) newObj((&NTI195253), sizeof(erecoverableerror194545));
	(*e_195252).Sup.Sup.Sup.m_type = (&NTI194545);
	LOC1 = 0;
	LOC1 = (*e_195252).Sup.Sup.message; (*e_195252).Sup.Sup.message = copyStringRC1(msg);
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_195252, "ERecoverableError");
}
...
N_NIMCALL(void, handleerror_196459)(NU16 msg, NU8 eh, NimStringDesc* s) {
	...
	LA5: ;
	{
		...
		LA18: ;
		if (!LOC17) goto LA19;
		gerrorcounter_195306 += 1;
		gexitcode_168119 = ((NI8) 1);
		{
			if (!(gerrormax_195309 <= gerrorcounter_195306)) goto LA23;
			{
				NIM_BOOL LOC27;
				NIM_BOOL LOC28;
				LOC27 = 0;
		...
		LA36: ;
		{
			...
			raiserecoverableerror_195247(s);
		}
		goto LA21;
		LA47: ;
		LA21: ;
...
N_NIMCALL(void, rawmessage_196643)(NU16 msg, NimStringDesc** args, NI argsLen0) {
	...
	case ((NU16) 230) ... ((NU16) 257):
	{
		...
		LA6: ;
		{
			if (!!(((gnotes_195305 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0))) goto LA10;
			goto BeforeRet;
		}
		LA10: ;
	...
	case ((NU16) 258) ... ((NU16) 274):
	{
		...
		LA16: ;
		{
			if (!!(((gnotes_195305 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0))) goto LA20;
			goto BeforeRet;
		}
		LA20: ;
		frmt = copyString(((NimStringDesc*) &TMP428));
		ghintcounter_195307 += 1;
	}
	break;
	}
	LOC22 = 0;
...
N_NIMCALL(void, limessage_196757)(tlineinfo194539 info, NU16 msg, NimStringDesc* arg, NU8 eh) {
	...
	case ((NU16) 230) ... ((NU16) 257):
	{
		...
		if (LOC3) goto LA4;
		LOC3 = !(((gnotes_195305 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0));
		LA4: ;
		ignoremsg = LOC3;
		{
	...
	case ((NU16) 258) ... ((NU16) 274):
	{
		...
		if (LOC10) goto LA11;
		LOC10 = !(((gnotes_195305 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0));
		LA11: ;
		ignoremsg = LOC10;
...
N_NIMCALL(void, suggestwriteln_195457)(NimStringDesc* s) {
	{
		...
		{
			TY196301 LOC9;
			if (!stdoutsocket_195318 == 0) goto LA7;
...
appendString(LOC12, ((NimStringDesc*) &TMP1974));
			send_192008(stdoutsocket_195318, LOC12);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, popinfocontext_195957)(void) {
	msgcontext_195435 = (TY195414*) setLengthSeq(&(msgcontext_195435)->Sup, sizeof(tlineinfo194539), (NI32)(msgcontext_195435->Sup.len - 1));
}
...
NIM_EXTERNC N_NOINLINE(void, HEX00_msgsInit)(void) {
	...
	gcmdlineinfo_195192 = newlineinfo_195129(((NI32) 0), 1, 1);
	memset((void*)&LOC2, 0, sizeof(LOC2));
	...
	gcodegenlineinfo_195239 = newlineinfo_195129(((NI32) 1), 1, 1);
	gnotes_195305 = IL64(35184347709439);
	gerrorcounter_195306 = 0;
	ghintcounter_195307 = 0;
	gwarncounter_195308 = 0;
	gerrormax_195309 = 1;
...
NTI195253.size = sizeof(erecoverableerror194545*);
NTI195253.kind = 22;
NTI195253.base = (&NTI194545);
NTI195253.marker = TMP429;
