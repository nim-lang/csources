...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY113118 TMP1610 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY113118 TMP1611 = {
...
N_NIMCALL(NIM_BOOL, endswithopr_162437)(NimStringDesc* x) {
	...
	result = endswith_162402(x, TMP1610);
	popFrame();
	return result;
}
static N_INLINE(NIM_BOOL, continueline_162443)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_162402(line, TMP1611);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(NI, counttriples_162462)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1612 = addInt(i, 1);
			if ((NU)((NI32)(TMP1612)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI32)(TMP1612)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1613 = addInt(i, 2);
			if ((NU)((NI32)(TMP1613)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI32)(TMP1613)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
appendString((*s).S, ((NimStringDesc*) &TMP1616));
	...
	result = ((buflen <= (NI32)(TMP1617)) ? buflen : (NI32)(TMP1617));
...
N_NIMCALL(NI, llstreamread_162242)(tllstream162204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		result = ((buflen <= (NI32)(TMP1618)) ? buflen : (NI32)(TMP1618));
		nimln(136, "llstream.nim");
		{
			...
			if ((NU)((NI32)(TMP1619)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI32)(TMP1619)])), result);			nimln(138, "llstream.nim");
			(*s).Rd = addInt((*s).Rd, result);
		}		LA5: ;
	}	break;
	case ((NU8) 2):
...
N_NIMCALL(void, llstreamwriteln_162274)(tllstream162204* s, NimStringDesc* data) {
	...
	llstreamwrite_162258(s, ((NimStringDesc*) &TMP1616));	popFrame();
}
N_NIMCALL(void, llstreamwrite_162263)(tllstream162204* s, NIM_CHAR data) {
	NIM_CHAR c;
	nimfr("LLStreamWrite", "llstream.nim")
...
N_NIMCALL(void, llstreamwrite_162268)(tllstream162204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			(*s).S = setLengthStr((*s).S, (NI32)(TMP1620));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1621 = addInt(0, (*s).Wr);
			if ((NU)((NI32)(TMP1621)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI32)(TMP1621)])), buf, buflen);			nimln(202, "llstream.nim");
...
N_NIMCALL(NimStringDesc*, llstreamreadall_162254)(tllstream162204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI32)(TMP1622));
			nimln(223, "llstream.nim");
			nimln(223, "llstream.nim");
			TMP1623 = addInt(i, 0);
			if ((NU)((NI32)(TMP1623)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_9514((*s).F, ((void*) (&result->data[(NI32)(TMP1623)])), 2048);
...
NTI162202.node = &TMP1601[6];
TMP1601[1].kind = 1;
TMP1601[1].offset = offsetof(tllstream162204, Kind);
TMP1601[1].typ = (&NTI162202);
TMP1601[1].name = "kind";
TMP1603[1] = &TMP1601[7];
TMP1601[7].kind = 1;
TMP1601[7].offset = offsetof(tllstream162204, F);
TMP1601[7].typ = (&NTI9004);
TMP1601[7].name = "f";
TMP1603[2] = &TMP1601[8];
TMP1601[8].kind = 1;
TMP1601[8].offset = offsetof(tllstream162204, S);
TMP1601[8].typ = (&NTI142);
TMP1601[8].name = "s";
TMP1603[3] = &TMP1601[9];
TMP1601[9].kind = 1;
TMP1601[9].offset = offsetof(tllstream162204, Rd);
TMP1601[9].typ = (&NTI105);
TMP1601[9].name = "rd";
TMP1603[4] = &TMP1601[10];
TMP1601[10].kind = 1;
TMP1601[10].offset = offsetof(tllstream162204, Wr);
TMP1601[10].typ = (&NTI105);
TMP1601[10].name = "wr";
TMP1603[5] = &TMP1601[11];
TMP1601[11].kind = 1;
TMP1601[11].offset = offsetof(tllstream162204, Lineoffset);
TMP1601[11].typ = (&NTI105);
TMP1601[11].name = "lineOffset";
TMP1601[0].len = 6; TMP1601[0].kind = 2; TMP1601[0].sons = &TMP1603[0];
NTI162204.node = &TMP1601[0];
NTI162206.size = sizeof(tllstream162204*);
NTI162206.kind = 22;
NTI162206.base = (&NTI162204);
NTI162206.flags = 2;
NTI162206.marker = TMP1607;
}
