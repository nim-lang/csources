	...
	while (1) {
		...
		nimln(31, "filters.nim");
		{
			...
			nimln(32, "filters.nim");
			{
				...
				if (((TMP2647[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2648));
				if ((NU)(i_216074) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP2647[(*(*n).kindU.S6.Sons->data[i_216074]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_216074]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2648));
			...
			nimln(33, "filters.nim");
			{
				...
				if (((TMP2647[(*(*n).kindU.S6.Sons->data[i_216074]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_216074]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2648));
				if ((NU)(0) >= (NU)((*(*n).kindU.S6.Sons->data[i_216074]).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (!(((TMP2650[(*(*(*n).kindU.S6.Sons->data[i_216074]).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*(*n).kindU.S6.Sons->data[i_216074]).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2651));
				LOC17 = 0;
...
N_NIMCALL(NIM_BOOL, boolarg_216028)(tnode185813* n, NimStringDesc* name, NI pos, NIM_BOOL default_216033) {
	...
	LA3: ;
	{
		...
		LOC6 = identeq_165469((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2656));
		LA7: ;
		if (!LOC6) goto LA8;
		nimln(53, "filters.nim");
		result = NIM_TRUE;
	...
	LA8: ;
	{
		...
		nimln(54, "filters.nim");
		if (!(((TMP2650[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2651));
		LOC11 = identeq_165469((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2657));
		LA12: ;
		if (!LOC11) goto LA13;
		nimln(54, "filters.nim");
		result = NIM_FALSE;
...
N_NIMCALL(tllstream173204*, filterstrip_216008)(tllstream173204* stdin_216010, NimStringDesc* filename, tnode185813* call) {
	...
	pattern = strarg_216021(call, ((NimStringDesc*) &TMP2658), 1, ((NimStringDesc*) &TMP2659));
	nimln(59, "filters.nim");
	leading = boolarg_216028(call, ((NimStringDesc*) &TMP2660), 2, NIM_TRUE);
	nimln(60, "filters.nim");
	trailing = boolarg_216028(call, ((NimStringDesc*) &TMP2661), 3, NIM_TRUE);
