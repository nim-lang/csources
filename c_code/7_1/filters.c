	...
	while (1) {
		...
		nimln(31, "filters.nim");
		{
			...
			nimln(32, "filters.nim");
			{
				...
				if (((TMP2648[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2649));
				if ((NU)(i_222074) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP2648[(*(*n).kindU.S6.Sons->data[i_222074]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_222074]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2649));
			...
			nimln(33, "filters.nim");
			{
				...
				if (((TMP2648[(*(*n).kindU.S6.Sons->data[i_222074]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_222074]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2649));
				if ((NU)(0) >= (NU)((*(*n).kindU.S6.Sons->data[i_222074]).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (!(((TMP2651[(*(*(*n).kindU.S6.Sons->data[i_222074]).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*(*n).kindU.S6.Sons->data[i_222074]).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2652));
				LOC17 = 0;
...
N_NIMCALL(NIM_BOOL, boolarg_222028)(tnode191813* n, NimStringDesc* name, NI pos, NIM_BOOL default_222033) {
	...
	LA3: ;
	{
		...
		LOC6 = identeq_170469((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2657));
		LA7: ;
		if (!LOC6) goto LA8;
		nimln(53, "filters.nim");
		result = NIM_TRUE;
	...
	LA8: ;
	{
		...
		nimln(54, "filters.nim");
		if (!(((TMP2651[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2652));
		LOC11 = identeq_170469((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2658));
		LA12: ;
		if (!LOC11) goto LA13;
		nimln(54, "filters.nim");
		result = NIM_FALSE;
...
N_NIMCALL(tllstream179204*, filterstrip_222008)(tllstream179204* stdin_222010, NimStringDesc* filename, tnode191813* call) {
	...
	pattern = strarg_222021(call, ((NimStringDesc*) &TMP2659), 1, ((NimStringDesc*) &TMP2660));
	nimln(59, "filters.nim");
	leading = boolarg_222028(call, ((NimStringDesc*) &TMP2661), 2, NIM_TRUE);
	nimln(60, "filters.nim");
	trailing = boolarg_222028(call, ((NimStringDesc*) &TMP2662), 3, NIM_TRUE);
	nimln(61, "filters.nim");
	result = llstreamopen_179218(((NimStringDesc*) &TMP2660));
...
N_NIMCALL(tllstream179204*, filterreplace_222002)(tllstream179204* stdin_222004, NimStringDesc* filename, tnode191813* call) {
	...
	sub = strarg_222021(call, ((NimStringDesc*) &TMP2664), 1, ((NimStringDesc*) &TMP2660));
	...
	by = strarg_222021(call, ((NimStringDesc*) &TMP2665), 2, ((NimStringDesc*) &TMP2660));
