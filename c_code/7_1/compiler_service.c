...
N_NIMCALL(void, processcmdline_521209)(NU8 pass, NimStringDesc* cmd) {
	...
	argscount = ((NI) 0);
	{
		while (1) {
			...
			{
				{
					if (!eqStrings(p.key, ((NimStringDesc*) &TMP1540))) goto LA7;
					p.key = copyString(((NimStringDesc*) &TMP1541));
					{
						NIM_BOOL LOC11;
						LOC11 = 0;
	...
	} LA1: ;
	{
		if (!(pass == ((NU8) 1))) goto LA23;
		{
			...
			LOC27 = !(eqStrings(LOC31, ((NimStringDesc*) &TMP1868)));
			LA30: ;
			if (!LOC27) goto LA32;
