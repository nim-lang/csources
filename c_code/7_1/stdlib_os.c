...
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_6, "\012  0 <= bufsize ", 16);
...
{	result = (NimStringDesc*)0;
	...
	T7_ = (NimStringDesc*)0;
	T7_ = (*e).Sup.message; (*e).Sup.message = copyStringRC1(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_3));
...
{	result = (NimStringDesc*)0;
	result = paramStr_eYicl3uwirn1ppNz7OCowg(((NI) 0));
	{
		...
		if (!T3_) goto LA5_;
		{
			...
			colontmp_ = getEnv_rVXof6qIUKJ3J9cw79conT2g(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_4));
			last = ((NI) 0);
			splits = ((NI) -1);
			{
			...
			LA7_: ;
			{
				...
				err = osLastError_tNPXXFl9cb3BG0pJKzUn9bew();
				{
					...
					bufsize = (NI)((NU32)(bufsize) << (NU32)(((NI) 1)));
					{
						...
						raiseAssert_PpfSiTIeNpMAb9a5o6SglJw_2(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_6));
					}
					LA17_: ;
					result = mnewString(((NI) (bufsize)));
				}
...
{	result = (NimStringDesc*)0;
	...
	path = getEnv_rVXof6qIUKJ3J9cw79conT2g(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_4));
	{
