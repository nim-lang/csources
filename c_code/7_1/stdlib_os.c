...
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_8, "invalid index", 13);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_9, "PATH", 4);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_10, "Failed to create the directory", 30);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_11, "\012  0 <= bufsize ", 16);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_12, "/.config/", 9);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_14, ".", 1);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_15, "..", 2);
static N_NIMCALL(void, Marker_TY_sM4lkSb7zS6F7OVMvW9cffQ)(void* p, NI op) {
...
{	result = (NimStringDesc*)0;
	...
	T7_ = (NimStringDesc*)0;
	T7_ = (*e).Sup.message; (*e).Sup.message = copyStringRC1(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_8));
...
{	result = (NimStringDesc*)0;
	result = paramStr_eYicl3uwirn1ppNz7OCowg(((NI) 0));
	{
		...
		if (!T3_) goto LA5_;
		{
			...
			colontmp_ = getEnv_8zNgT9bxx7m9cTt2TeVdTdIw(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_9));
			last = ((NI) 0);
			splits = ((NI) -1);
			{
...
N_NIMCALL(NIM_BOOL, existsOrCreateDir_V86QyZrcGMPX0W9bv1Q53ww)(NimStringDesc* dir) {
	...
	result = !(T1_);
	{
		if (!result) goto LA4_;
		{
			...
			T11_ = (*e).Sup.Sup.message; (*e).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_10));
			...
			LA7_: ;
			{
				...
				err = osLastError_YyC2FKP9bqQiUDq2XVqW9acA();
				{
					...
					bufsize = (NI)((NU32)(bufsize) << (NU32)(((NI) 1)));
					{
						...
						raiseAssert_PpfSiTIeNpMAb9a5o6SglJw_2(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_11));
					}
					LA17_: ;
					result = mnewString(((NI) (bufsize)));
				}
...
{	result = (NimStringDesc*)0;
	...
	path = getEnv_8zNgT9bxx7m9cTt2TeVdTdIw(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_9));
	{
...
appendString(T1_, T2_);
appendString(T1_, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_12));
	result = T1_;
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
					...
					while (1) {
						{
							...
							y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
							{
								...
								T16_ = (NIM_BOOL)0;
								T16_ = !(eqStrings(y, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_14)));
								if (!(T16_)) goto LA17_;
...
N_NIMCALL(void, nosmoveFile)(NimStringDesc* source, NimStringDesc* dest) {
	{
		...
		err = osLastError_YyC2FKP9bqQiUDq2XVqW9acA();
		{
			TSafePoint TM_yu6cxgKBBXbNsTkT9cyMd4g_16;
			if (!(err == EXDEV)) goto LA8_;
			noscopyFile(source, dest);
			pushSafePoint(&TM_yu6cxgKBBXbNsTkT9cyMd4g_16);
			TM_yu6cxgKBBXbNsTkT9cyMd4g_16.status = _setjmp(TM_yu6cxgKBBXbNsTkT9cyMd4g_16.context);
			if (TM_yu6cxgKBBXbNsTkT9cyMd4g_16.status == 0) {
				...
				{
					NIM_BOOL T13_;
					TM_yu6cxgKBBXbNsTkT9cyMd4g_16.status = 0;
					T13_ = (NIM_BOOL)0;
			...
			if (TM_yu6cxgKBBXbNsTkT9cyMd4g_16.status != 0) reraiseException();
		}
		goto LA6_;
		LA8_: ;
		{
