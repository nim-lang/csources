...
N_NIMCALL(void, nosremoveDir)(NimStringDesc* dir0) {
	{
		...
		d_Snew50d2sxhgjxplaladWA = opendir(dir0->data);
		{
			...
			T_yu6cxgKBBXbNsTkT9cyMd4g_13.status = _setjmp(T_yu6cxgKBBXbNsTkT9cyMd4g_13.context);
					...
					while (1) {
						{
							...
							y_nqt04gTLPSvk7lCmOg2cqg = cstrToNimstr(((NCSTRING) ((*x_aQYTEBuHrMi9cGfwwrddjfg).d_name)));
							{
								...
								LOC16 = (NIM_BOOL)0;
								LOC16 = !(eqStrings(y_nqt04gTLPSvk7lCmOg2cqg, ((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_14)));
								if (!(LOC16)) goto LA17;
