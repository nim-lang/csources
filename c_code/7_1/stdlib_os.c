...
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_4, "/Users/andreasrumpf-mac/projects/nim/lib/pure/os.nim(282, 19) `"
"\0120 <= bufsize` ", 78);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_5, "Failed to create \'", 18);
...
{	result = (NimStringDesc*)0;
	result = paramStr_eYicl3uwirn1ppNz7OCowg(((NI) 0));
	{
		...
		if (!T3_) goto LA5_;
		{
			...
			colontmp_ = getEnv_9b1nh9cAHhSLlHOPz8lCk5FA(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_3), ((NimStringDesc*) NIM_NIL));
			last = ((NI) 0);
			splits = ((NI) -1);
			{
				while (1) {
...
{	result = (NimStringDesc*)0;
	...
	LA8_: ;
	path = getEnv_9b1nh9cAHhSLlHOPz8lCk5FA(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_3), ((NimStringDesc*) NIM_NIL));
	{
