...
STRING_LITERAL(TMP1933, "logpass: context is not nil", 27);
...
N_NIMCALL(tpasscontext284005*, verboseopen_601012)(tsym223849* s) {
	...
	result = NIM_NIL;
	{
		...
		rawmessage_196733(((NU16) 266), (*(*s).Name).S);
	}
	LA3: ;
	return result;
}
...
N_NIMCALL(tnode223819*, verboseprocess_601023)(tpasscontext284005* context, tnode223819* n) {
	...
	result = n;
	{
		...
		internalerror_196989(((NimStringDesc*) &TMP1933));
	}
	LA3: ;
	{
		NimStringDesc* LOC9;
		if (!(gverbosity_168127 == 3)) goto LA7;
		gnotes_195305 |= ((NI64)1)<<(((((NU16) 266)- 230))%(sizeof(NI64)*8));
		LOC9 = 0;
		LOC9 = nimIntToStr(gbackendid_222013);
		message_196959((*n).Info, ((NU16) 266), LOC9);
	}
	LA7: ;
	return result;
}
	...
	{
		{
			...
			HEX3Atmp_601219 = (NI32)(LOC9 - 1);
			res_601222 = 0;
			{
				while (1) {
					tnode223819* LOC12;
					if (!(res_601222 <= HEX3Atmp_601219)) goto LA11;
					i_601124 = res_601222;
					LOC12 = 0;
					LOC12 = cleanup_601077(c, (*n).kindU.S6.Sons->data[i_601124]);
					res_601222 += 1;
				} LA11: ;
			}
		}
	...
	{
		{
			...
			s = (*(*n).kindU.S6.Sons->data[0]).kindU.S4.Sym;
			{
				...
				if (!(LOC20)) goto LA22;
				LOC23 = 0;
				LOC23 = astneeded_284094(s);
				LOC20 = !(LOC23);
				LA22: ;
				if (!LOC20) goto LA24;
				asgnRefNoCycle((void**) &(*(*s).Ast).kindU.S6.Sons->data[6], emptynode_224738);
			}
			LA24: ;
		}
		LA16: ;
