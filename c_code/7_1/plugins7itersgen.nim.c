...
static NIM_CONST tySet_tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw TM_fVT8Frbe1eY8sI6VOwxZZg_2 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TM_fVT8Frbe1eY8sI6VOwxZZg_3, "sons", 4);
static NIM_CONST tySet_tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw TM_fVT8Frbe1eY8sI6VOwxZZg_4 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TM_fVT8Frbe1eY8sI6VOwxZZg_5, "sym", 3);
STRING_LITERAL(TM_fVT8Frbe1eY8sI6VOwxZZg_6, "first argument needs to be an iterator", 38);
STRING_LITERAL(TM_fVT8Frbe1eY8sI6VOwxZZg_7, "second argument needs to be a type", 34);
STRING_LITERAL(TM_fVT8Frbe1eY8sI6VOwxZZg_8, "third argument needs to be an identifier", 40);
STRING_LITERAL(TM_fVT8Frbe1eY8sI6VOwxZZg_9, "type must be a non-generic ref|ptr to object with state field", 61);
static NIM_CONST tySet_tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw TM_fVT8Frbe1eY8sI6VOwxZZg_10 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TM_fVT8Frbe1eY8sI6VOwxZZg_11, "ident", 5);
...
{	result = (tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*)0;
	...
	if (((TM_fVT8Frbe1eY8sI6VOwxZZg_2[(NU)((*n).kind)>>3] &(1U<<((NU)((*n).kind)&7U)))!=0)) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_3));
	...
	iter = (*n).sons->data[((NI) 1)];
	{
		...
		if (T3_) goto LA4_;
		if (!(((TM_fVT8Frbe1eY8sI6VOwxZZg_4[(NU)((*iter).kind)>>3] &(1U<<((NU)((*iter).kind)&7U)))!=0))) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_5));
		T3_ = !(((*(*iter).sym).kind == ((tyEnum_TSymKind_cNCW9acsSznmEccl1fgQwkw) 15)));
		LA4_: ;
		if (!T3_) goto LA5_;
		localError_NF6kBGchnhQYPbCedyefVA((*(*c).graph).config, (*iter).info, ((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_6));
		goto BeforeRet_;
	}
	LA5_: ;
	{
		...
		if (((TM_fVT8Frbe1eY8sI6VOwxZZg_2[(NU)((*n).kind)>>3] &(1U<<((NU)((*n).kind)&7U)))!=0)) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_3));
		if ((NU)(((NI) 2)) >= (NU)((*n).sons ? (*n).sons->Sup.len : 0)) raiseIndexError2(((NI) 2),((*n).sons ? (*n).sons->Sup.len : 0)-1);
		localError_NF6kBGchnhQYPbCedyefVA((*(*c).graph).config, (*(*n).sons->data[((NI) 2)]).info, ((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_7));
		goto BeforeRet_;
	}
	LA9_: ;
	{
		...
		if (!!(((*(*n).sons->data[((NI) 3)]).kind == ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 2)))) goto LA13_;
		if (((TM_fVT8Frbe1eY8sI6VOwxZZg_2[(NU)((*n).kind)>>3] &(1U<<((NU)((*n).kind)&7U)))!=0)) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_3));
		if ((NU)(((NI) 3)) >= (NU)((*n).sons ? (*n).sons->Sup.len : 0)) raiseIndexError2(((NI) 3),((*n).sons ? (*n).sons->Sup.len : 0)-1);
		localError_NF6kBGchnhQYPbCedyefVA((*(*c).graph).config, (*(*n).sons->data[((NI) 3)]).info, ((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_8));
		goto BeforeRet_;
	}
	LA13_: ;
	if (((TM_fVT8Frbe1eY8sI6VOwxZZg_2[(NU)((*n).kind)>>3] &(1U<<((NU)((*n).kind)&7U)))!=0)) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_3));
	if ((NU)(((NI) 2)) >= (NU)((*n).sons ? (*n).sons->Sup.len : 0)) raiseIndexError2(((NI) 2),((*n).sons ? (*n).sons->Sup.len : 0)-1);
	t = skipTypes_zsqmUNR5OZrTUna0Y9bdu9bg((*(*n).sons->data[((NI) 2)]).typ, 2304);
	{
		NIM_BOOL T17_;
		...
		T19_ = lastSon_Bdq9aiV9buvJtPvmOc0OR5JQ(t);
		T17_ = !(((*T19_).kind == ((tyEnum_TTypeKind_9a3YiReNVD0IJHWFKgXRe9ag) 17)));
		LA18_: ;
		if (!T17_) goto LA20_;
		if (((TM_fVT8Frbe1eY8sI6VOwxZZg_2[(NU)((*n).kind)>>3] &(1U<<((NU)((*n).kind)&7U)))!=0)) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_3));
		if ((NU)(((NI) 2)) >= (NU)((*n).sons ? (*n).sons->Sup.len : 0)) raiseIndexError2(((NI) 2),((*n).sons ? (*n).sons->Sup.len : 0)-1);
		localError_NF6kBGchnhQYPbCedyefVA((*(*c).graph).config, (*(*n).sons->data[((NI) 2)]).info, ((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_9));
		goto BeforeRet_;
	}
	LA20_: ;
	if (!(((TM_fVT8Frbe1eY8sI6VOwxZZg_4[(NU)((*iter).kind)>>3] &(1U<<((NU)((*iter).kind)&7U)))!=0))) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_5));
	if (!(((TM_fVT8Frbe1eY8sI6VOwxZZg_4[(NU)((*iter).kind)>>3] &(1U<<((NU)((*iter).kind)&7U)))!=0))) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_5));
	if (((TM_fVT8Frbe1eY8sI6VOwxZZg_2[(NU)((*(*(*iter).sym).ast).kind)>>3] &(1U<<((NU)((*(*(*iter).sym).ast).kind)&7U)))!=0)) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_3));
	if ((NU)(((NI) 6)) >= (NU)((*(*(*iter).sym).ast).sons ? (*(*(*iter).sym).ast).sons->Sup.len : 0)) raiseIndexError2(((NI) 6),((*(*(*iter).sym).ast).sons ? (*(*(*iter).sym).ast).sons->Sup.len : 0)-1);
	body = liftIterToProc_t1WUr4lePynddtLnmYOFEQ((*c).graph, (*iter).sym, (*(*(*iter).sym).ast).sons->data[((NI) 6)], t);
	if (((TM_fVT8Frbe1eY8sI6VOwxZZg_2[(NU)((*n).kind)>>3] &(1U<<((NU)((*n).kind)&7U)))!=0)) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_3));
	if ((NU)(((NI) 3)) >= (NU)((*n).sons ? (*n).sons->Sup.len : 0)) raiseIndexError2(((NI) 3),((*n).sons ? (*n).sons->Sup.len : 0)-1);
	if (!(((TM_fVT8Frbe1eY8sI6VOwxZZg_10[(NU)((*(*n).sons->data[((NI) 3)]).kind)>>3] &(1U<<((NU)((*(*n).sons->data[((NI) 3)]).kind)&7U)))!=0))) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_11));
	if (!(((TM_fVT8Frbe1eY8sI6VOwxZZg_4[(NU)((*iter).kind)>>3] &(1U<<((NU)((*iter).kind)&7U)))!=0))) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_5));
	if (!(((TM_fVT8Frbe1eY8sI6VOwxZZg_4[(NU)((*iter).kind)>>3] &(1U<<((NU)((*iter).kind)&7U)))!=0))) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_5));
	prc = newSym_IXbidcxhXTQGZY9abN63Cxg(((tyEnum_TSymKind_cNCW9acsSznmEccl1fgQwkw) 12), (*(*n).sons->data[((NI) 3)]).ident, (*(*iter).sym).owner, (*(*iter).sym).info, 0);
	if (!(((TM_fVT8Frbe1eY8sI6VOwxZZg_4[(NU)((*iter).kind)>>3] &(1U<<((NU)((*iter).kind)&7U)))!=0))) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_5));
	asgnRef((void**) (&(*prc).typ), copyType_4O4aYoscFPo2FRSh4rP9ayg((*(*iter).sym).typ, prc, NIM_FALSE));
	(*(*prc).typ).flags &= ~(((NU64)1) << ((((tyEnum_TTypeFlag_x2m5g1NpbmDig4wLT3Ylhw) 12)) & 63));
	if (!(((TM_fVT8Frbe1eY8sI6VOwxZZg_4[(NU)((*iter).kind)>>3] &(1U<<((NU)((*iter).kind)&7U)))!=0))) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_5));
	T22_ = (tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w*)0;
	T22_ = getEnvParam_0hs55xLsSn1sbFSXWwel1A((*iter).sym);
	T23_ = (tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*)0;
	T23_ = newSymNode_I2DV2TmmOysY1ZEGW19b9bRg(T22_);
	add_P8dDSotTW25BkfbyspojGg((*(*prc).typ).n, T23_);
	rawAddSon_9a8CdZqChTyqzq5bpSL3TzA((*prc).typ, t);
	if (!(((TM_fVT8Frbe1eY8sI6VOwxZZg_4[(NU)((*iter).kind)>>3] &(1U<<((NU)((*iter).kind)&7U)))!=0))) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_5));
	orig = (*(*iter).sym).ast;
	if (((TM_fVT8Frbe1eY8sI6VOwxZZg_2[(NU)((*orig).kind)>>3] &(1U<<((NU)((*orig).kind)&7U)))!=0)) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_3));
	if ((NU)(((NI) 3)) >= (NU)((*orig).sons ? (*orig).sons->Sup.len : 0)) raiseIndexError2(((NI) 3),((*orig).sons ? (*orig).sons->Sup.len : 0)-1);
	T24_ = (tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*)0;
	T24_ = newSymNode_I2DV2TmmOysY1ZEGW19b9bRg(prc);
	if (((TM_fVT8Frbe1eY8sI6VOwxZZg_2[(NU)((*orig).kind)>>3] &(1U<<((NU)((*orig).kind)&7U)))!=0)) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_3));
	if ((NU)(((NI) 4)) >= (NU)((*orig).sons ? (*orig).sons->Sup.len : 0)) raiseIndexError2(((NI) 4),((*orig).sons ? (*orig).sons->Sup.len : 0)-1);
	asgnRef((void**) (&(*prc).ast), newProcNode_g5PEkYP0A0RT03uHbJ6wKQ(((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 79), (*n).info, body, (*orig).sons->data[((NI) 3)], T24_, (*(*c).graph).emptyNode, (*(*c).graph).emptyNode, (*orig).sons->data[((NI) 4)], (*(*c).graph).emptyNode));
	if (!(((TM_fVT8Frbe1eY8sI6VOwxZZg_4[(NU)((*iter).kind)>>3] &(1U<<((NU)((*iter).kind)&7U)))!=0))) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_5));
	if (((TM_fVT8Frbe1eY8sI6VOwxZZg_2[(NU)((*(*(*iter).sym).ast).kind)>>3] &(1U<<((NU)((*(*(*iter).sym).ast).kind)&7U)))!=0)) raiseFieldError(((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_3));
	if ((NU)(((NI) 7)) >= (NU)((*(*(*iter).sym).ast).sons ? (*(*(*iter).sym).ast).sons->Sup.len : 0)) raiseIndexError2(((NI) 7),((*(*(*iter).sym).ast).sons ? (*(*(*iter).sym).ast).sons->Sup.len : 0)-1);
	add_P8dDSotTW25BkfbyspojGg((*prc).ast, (*(*(*iter).sym).ast).sons->data[((NI) 7)]);
	addInterfaceDecl_aPXKqZJT9c7r7gT8X3uZAHw_2(c, prc);
	}BeforeRet_: ;
	return result;
}
