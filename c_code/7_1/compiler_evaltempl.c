...
static NIM_CONST TY172865 TMP3449 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3450, "sym", 3);
static NIM_CONST TY172865 TMP3451 = {
...
N_NIMCALL(tnode172659*, evaltemplateargs_252201)(tnode172659* n, tsym172689* s) {
	...
	nimln(86, "evaltempl.nim");
	{
		...
		if (!(f < a)) goto LA5;
		nimln(86, "evaltempl.nim");
		globalerror_139336((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP3456));	}	LA5: ;
	...
	while (1) {
		...
		LA10: ;
		{
			...
			if (!(((TMP3449[(*(*(*(*s).Typ).N).kindU.S6.Sons->data[i_252218]).Kind/8] &(1<<((*(*(*(*s).Typ).N).kindU.S6.Sons->data[i_252218]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3450));
		...
		nimln(91, "evaltempl.nim");
		{
			...
			localerror_139349((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP3456));		}		LA17: ;
...
N_NIMCALL(tnode172659*, evaltemplate_252285)(tnode172659* n, tsym172689* tmpl, tsym172689* gensymowner) {
	...
	nimln(100, "evaltempl.nim");
	{
		...
		globalerror_139336((*n).Info, ((NU16) 183), ((NimStringDesc*) &TMP3456));		nimln(102, "evaltempl.nim");
		result = n;
	}	LA3: ;
