...
N_NIMCALL(void, handlecmdline_598607)(void) {
	...
	LA4: ;
	{
		processcmdline_592213(((NU8) 0), ((NimStringDesc*) &TMP1479));
		{
			TSafePoint TMP1480;
			TY114804 p;
			NimStringDesc* LOC15;
		...
		LA7: ;
		loadconfigs_216811(((NimStringDesc*) &TMP1646));
		initvars_201812();
		processcmdline_592213(((NU8) 1), ((NimStringDesc*) &TMP1479));
		maincommand_596027();
		{
			NimStringDesc* LOC22;
...
appendString(LOC44, arguments_592209);
				...
				LA33: ;
				{
					...
					LA48: ;
					{
						NimStringDesc* LOC51;
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_165237, ((NimStringDesc*) &TMP1479));
