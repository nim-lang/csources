...
static NIM_CONST TY113118 TMP2602 = {
...
N_NIMCALL(tllstream162204*, filtertmpl_197006)(tllstream162204* stdin_197008, NimStringDesc* filename, tnode172659* call) {
	...
	p.Outp = llstreamopen_162218(((NimStringDesc*) &TMP2598));
	nimln(209, "filter_tmpl.nim");
	p.Inp = stdin_197008;
	nimln(210, "filter_tmpl.nim");
	p.Subschar = chararg_196014(call, ((NimStringDesc*) &TMP2613), 1, 36);
	nimln(211, "filter_tmpl.nim");
	p.Nimdirective = chararg_196014(call, ((NimStringDesc*) &TMP2614), 2, 35);
	nimln(212, "filter_tmpl.nim");
	p.Emit = strarg_196021(call, ((NimStringDesc*) &TMP2615), 3, ((NimStringDesc*) &TMP2616));
	nimln(213, "filter_tmpl.nim");
	p.Conc = strarg_196021(call, ((NimStringDesc*) &TMP2617), 4, ((NimStringDesc*) &TMP2618));
	nimln(214, "filter_tmpl.nim");
	p.Tostr = strarg_196021(call, ((NimStringDesc*) &TMP2619), 5, ((NimStringDesc*) &TMP2611));
