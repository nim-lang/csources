...
NIM_CONST TY119062 os_119061 = {{((NimStringDesc*) &TMP387),
...
NIM_CONST TY119456 endiantostr_119455 = {((NimStringDesc*) &TMP435),
...
NIM_CONST TY119461 cpu_119460 = {{((NimStringDesc*) &TMP437),
32,
((NU8) 0),
64,
32}
...
STRING_LITERAL(TMP456, "openbsd", 7);
...
N_NIMCALL(void, settarget_119586)(NU8 o, NU8 c) {
	...
	TMP453 = divInt(cpu_119460[(c)- 1].Field1, 8);
	intsize_119577 = (NI32)(TMP453);
	nimln(204, "platform.nim");
	nimln(204, "platform.nim");
	if (c < 1 || c > 14) raiseIndexError();
	TMP454 = divInt(cpu_119460[(c)- 1].Field3, 8);
	floatsize_119578 = (NI32)(TMP454);
	nimln(205, "platform.nim");
	nimln(205, "platform.nim");
	if (c < 1 || c > 14) raiseIndexError();
	TMP455 = divInt(cpu_119460[(c)- 1].Field4, 8);
	ptrsize_119579 = (NI32)(TMP455);
...
N_NIMCALL(NU8, nametocpu_119573)(NimStringDesc* name) {
	...
	hostos_119563 = nametoos_119569(((NimStringDesc*) &TMP456));
