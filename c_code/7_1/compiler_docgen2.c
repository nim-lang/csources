...
N_NIMCALL(tnode172659*, close_416013)(tpasscontext223003* p, tnode172659* n) {
	...
	nimln(25, "docgen2.nim");
	{
		...
		writeoutput_311043((*g).Doc, LOC7, ((NimStringDesc*) &TMP7027), usewarning);		nimln(27, "docgen2.nim");
...
TMP7026[0] = &TMP7024[1];
TMP7024[1].kind = 1;
TMP7024[1].offset = offsetof(tgen416007, Doc);
TMP7024[1].typ = (&NTI308007);
TMP7024[1].name = "doc";
TMP7026[1] = &TMP7024[2];
TMP7024[2].kind = 1;
TMP7024[2].offset = offsetof(tgen416007, Module);
TMP7024[2].typ = (&NTI172657);
TMP7024[2].name = "module";
TMP7024[0].len = 2; TMP7024[0].kind = 2; TMP7024[0].sons = &TMP7026[0];
NTI416007.node = &TMP7024[0];
NTI416009.size = sizeof(tgen416007*);
NTI416009.kind = 22;
NTI416009.base = (&NTI416007);
NTI416009.flags = 2;
NTI416009.marker = TMP7029;
}
