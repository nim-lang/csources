...
typedef N_CLOSURE_PTR(NI, TMP5102) (tsym185843* x_356870, tsym185843* y_356872);
struct  NimStringDesc  {
  TGenericSeq Sup;
NIM_CHAR data[SEQ_DECL_SIZE];
};
typedef N_CLOSURE_PTR(NI, TMP5104) (tsym185843* x_356870, tsym185843* y_356872);
struct  tentry359566  {
NI Pos;
tsym185843* Sym;
};
...
typedef N_CLOSURE_PTR(NI, TMP5121) (tentry359566 x_360254, tentry359566 y_360256);
typedef N_CLOSURE_PTR(NI, TMP5122) (tentry359566 x_360254, tentry359566 y_360256);
struct  TNimObject  {
TNimType* m_type;
};
struct  tidobj165013  {
...
N_NIMCALL(void, merge_356843)(tsym185843** a_356851, NI a_356851Len0, tsym185843** b_356859, NI b_356859Len0, NI lo_356863, NI m_356865, NI hi_356867, TY356801 cmp_356875, NU8 order_356878) {
	...
	nimln(101, "algorithm.nim");
	{
		...
		nimln(101, "algorithm.nim");
		TMP5101 = addInt(m_356865, 1);
		if ((NU)((NI32)(TMP5101)) >= (NU)(a_356851Len0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp_356875.ClEnv? cmp_356875.ClPrc(a_356851[m_356865], a_356851[(NI32)(TMP5101)], cmp_356875.ClEnv):((TMP5102)(cmp_356875.ClPrc))(a_356851[m_356865], a_356851[(NI32)(TMP5101)]);
		LOC4 = 0;
	...
	while (1) {
		...
		nimln(118, "algorithm.nim");
		{
			...
			if ((NU)(j) >= (NU)(a_356851Len0)) raiseIndexError();
			LOC17 = 0;
			LOC17 = cmp_356875.ClEnv? cmp_356875.ClPrc(b_356859[i], a_356851[j], cmp_356875.ClEnv):((TMP5104)(cmp_356875.ClPrc))(b_356859[i], a_356851[j]);
			LOC18 = 0;
...
N_NIMCALL(void, sort_356782)(tsym185843** a_356790, NI a_356790Len0, TY356801 cmp_356800, NU8 order_356803) {
	...
	nimln(155, "algorithm.nim");
	TMP5098 = divInt(n, 2);
	b = (tsymseq185815*) newSeq((&NTI185815), (NI32)(TMP5098));
	...
	while (1) {
		...
		while (1) {
			...
			nimln(160, "algorithm.nim");
			TMP5107 = addInt(m, s);
			merge_356843(a_356790, a_356790Len0, b->data, b->Sup.len, (((NI32)(TMP5106) >= 0) ? (NI32)(TMP5106) : 0), m, (NI32)(TMP5107), cmp_356800, order_356803);
...
N_NIMCALL(void, merge_360227)(tentry359566* a_360235, NI a_360235Len0, tentry359566* b_360243, NI b_360243Len0, NI lo_360247, NI m_360249, NI hi_360251, TY360185 cmp_360259, NU8 order_360262) {
	...
	nimln(101, "algorithm.nim");
	{
		...
		nimln(101, "algorithm.nim");
		TMP5120 = addInt(m_360249, 1);
		if ((NU)((NI32)(TMP5120)) >= (NU)(a_360235Len0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp_360259.ClEnv? cmp_360259.ClPrc(a_360235[m_360249], a_360235[(NI32)(TMP5120)], cmp_360259.ClEnv):((TMP5121)(cmp_360259.ClPrc))(a_360235[m_360249], a_360235[(NI32)(TMP5120)]);
		LOC4 = 0;
	...
	while (1) {
		...
		nimln(118, "algorithm.nim");
		{
			...
			if ((NU)(j) >= (NU)(a_360235Len0)) raiseIndexError();
			LOC17 = 0;
			LOC17 = cmp_360259.ClEnv? cmp_360259.ClPrc(b_360243[i], a_360235[j], cmp_360259.ClEnv):((TMP5122)(cmp_360259.ClPrc))(b_360243[i], a_360235[j]);
			LOC18 = 0;
...
N_NIMCALL(void, sort_360166)(tentry359566* a_360174, NI a_360174Len0, TY360185 cmp_360184, NU8 order_360187) {
	...
	nimln(155, "algorithm.nim");
	TMP5117 = divInt(n, 2);
	b = (TY359573*) newSeq((&NTI359573), (NI32)(TMP5117));
	nimln(156, "algorithm.nim");
	s = 1;
	nimln(157, "algorithm.nim");
	while (1) {
		...
		while (1) {
			...
			nimln(160, "algorithm.nim");
			TMP5125 = addInt(m, s);
			merge_360227(a_360174, a_360174Len0, b->data, b->Sup.len, (((NI32)(TMP5124) >= 0) ? (NI32)(TMP5124) : 0), m, (NI32)(TMP5125), cmp_360184, order_360187);
			nimln(161, "algorithm.nim");
			nimln(161, "algorithm.nim");
			TMP5126 = mulInt(s, 2);
