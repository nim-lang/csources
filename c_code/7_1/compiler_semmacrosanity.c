...
{	result = 0;
	...
	{
		{
			...
			HEX3Atmp_431110 = (NI32)(LOC3 - 1);
			res_431113 = 0;
			{
				while (1) {
					if (!(res_431113 <= HEX3Atmp_431110)) goto LA5;
					i_431029 = res_431113;
					result = ithfield_431012((*n).kindU.S6.Sons->data[i_431029], (NI32)(field - i_431029));
					{
	...
	case ((NU8) 138):
	{
		...
		LA13: ;
		result = ithfield_431012((*n).kindU.S6.Sons->data[0], (NI32)(field - 1));
		{
			...
			res_431119 = 1;
			{
				while (1) {
					...
					case ((NU8) 88):
					{
						...
						result = ithfield_431012(LOC24, (NI32)(field - 1));
						{
