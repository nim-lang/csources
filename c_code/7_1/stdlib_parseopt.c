...
N_NIMCALL(NI, parseword_527002)(NimStringDesc* s, NI i, NimStringDesc** w, TY123387 delim);
...
N_NIMCALL(void, initoptparser_526819)(NimStringDesc* cmdline, toptparser526807* Result) {
	...
	LA3: ;
	{
		...
		HEX3Atmp_526837 = paramcount_115233();
...
N_NIMCALL(void, handleshortoption_527106)(toptparser526807* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_527002((*p).Cmd, i, &(*p).Val, TMP7632);
	}
	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser526807* p) {
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_527002((*p).Cmd, i, &(*p).Key, TMP7633);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_527002((*p).Cmd, i, &(*p).Val, TMP7632);
			}
			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_527002((*p).Cmd, i, &(*p).Key, TMP7632);
	}
	break;
	}
	BeforeRet: ;
...
TMP7636[0] = &TMP7626[1];
TMP7626[1].kind = 1;
TMP7626[1].offset = offsetof(toptparser526807, Cmd);
TMP7626[1].typ = (&NTI143);
TMP7626[1].name = "cmd";
TMP7636[1] = &TMP7626[2];
TMP7626[2].kind = 1;
TMP7626[2].offset = offsetof(toptparser526807, Pos);
TMP7626[2].typ = (&NTI106);
TMP7626[2].name = "pos";
TMP7636[2] = &TMP7626[3];
TMP7626[3].kind = 1;
TMP7626[3].offset = offsetof(toptparser526807, Inshortstate);
...
NTI526805.node = &TMP7626[9];
TMP7626[4].kind = 1;
TMP7626[4].offset = offsetof(toptparser526807, Kind);
TMP7626[4].typ = (&NTI526805);
TMP7626[4].name = "kind";
TMP7636[4] = &TMP7626[10];
TMP7626[10].kind = 1;
TMP7626[10].offset = offsetof(toptparser526807, Key);
TMP7626[10].typ = (&NTI143);
TMP7626[10].name = "key";
TMP7636[5] = &TMP7626[11];
TMP7626[11].kind = 1;
TMP7626[11].offset = offsetof(toptparser526807, Val);
TMP7626[11].typ = (&NTI143);
TMP7626[11].name = "val";
TMP7626[0].len = 6; TMP7626[0].kind = 2; TMP7626[0].sons = &TMP7636[0];
NTI526807.node = &TMP7626[0];
}
