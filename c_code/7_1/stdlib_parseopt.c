...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY121387 TMP7638 = {
...
N_NIMCALL(void, handleshortoption_522106)(toptparser521807* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_522002((*p).Cmd, i, &(*p).Val, TMP7637);
	}
	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser521807* p) {
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_522002((*p).Cmd, i, &(*p).Key, TMP7638);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_522002((*p).Cmd, i, &(*p).Val, TMP7637);
			}
			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_522002((*p).Cmd, i, &(*p).Key, TMP7637);
	}
	break;
	}
	BeforeRet: ;
...
TMP7641[0] = &TMP7631[1];
TMP7631[1].kind = 1;
TMP7631[1].offset = offsetof(toptparser521807, Cmd);
TMP7631[1].typ = (&NTI143);
TMP7631[1].name = "cmd";
TMP7641[1] = &TMP7631[2];
TMP7631[2].kind = 1;
TMP7631[2].offset = offsetof(toptparser521807, Pos);
TMP7631[2].typ = (&NTI106);
TMP7631[2].name = "pos";
TMP7641[2] = &TMP7631[3];
TMP7631[3].kind = 1;
TMP7631[3].offset = offsetof(toptparser521807, Inshortstate);
...
NTI521805.node = &TMP7631[9];
TMP7631[4].kind = 1;
TMP7631[4].offset = offsetof(toptparser521807, Kind);
TMP7631[4].typ = (&NTI521805);
TMP7631[4].name = "kind";
TMP7641[4] = &TMP7631[10];
TMP7631[10].kind = 1;
TMP7631[10].offset = offsetof(toptparser521807, Key);
TMP7631[10].typ = (&NTI143);
TMP7631[10].name = "key";
TMP7641[5] = &TMP7631[11];
TMP7631[11].kind = 1;
TMP7631[11].offset = offsetof(toptparser521807, Val);
TMP7631[11].typ = (&NTI143);
TMP7631[11].name = "val";
TMP7631[0].len = 6; TMP7631[0].kind = 2; TMP7631[0].sons = &TMP7641[0];
NTI521807.node = &TMP7631[0];
}
