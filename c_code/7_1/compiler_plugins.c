...
N_NIMCALL(NIM_BOOL, pluginmatches_405029)(PluginHEX3Aobjecttype405019* p, Tsym190843* s);
...
TMP959[0] = &TMP953[1];
TMP953[1].kind = 1;
TMP953[1].offset = offsetof(PluginHEX3Aobjecttype405019, fn);
TMP953[1].typ = (&NTI166019);
TMP953[1].name = "fn";
TMP959[1] = &TMP953[2];
TMP953[2].kind = 1;
TMP953[2].offset = offsetof(PluginHEX3Aobjecttype405019, module);
TMP953[2].typ = (&NTI166019);
TMP953[2].name = "module";
TMP959[2] = &TMP953[3];
TMP953[3].kind = 1;
TMP953[3].offset = offsetof(PluginHEX3Aobjecttype405019, package);
TMP953[3].typ = (&NTI166019);
...
NTI405013.flags = 3;
TMP953[4].kind = 1;
TMP953[4].offset = offsetof(PluginHEX3Aobjecttype405019, t);
TMP953[4].typ = (&NTI405013);
TMP953[4].name = "t";
TMP959[4] = &TMP953[5];
TMP953[5].kind = 1;
TMP953[5].offset = offsetof(PluginHEX3Aobjecttype405019, next);
TMP953[5].typ = (&NTI405015);
TMP953[5].name = "next";
TMP953[0].len = 5; TMP953[0].kind = 2; TMP953[0].sons = &TMP959[0];
NTI405019.node = &TMP953[0];
NTI405015.size = sizeof(PluginHEX3Aobjecttype405019*);
NTI405015.kind = 22;
NTI405015.base = (&NTI405019);
NTI405015.marker = TMP960;
}
