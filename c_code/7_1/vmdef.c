...
NTI253229.flags = 2;
NTI253229.marker = TMP3219;
TMP3216[1].kind = 1;
TMP3216[1].offset = offsetof(tctx253037, Code);
TMP3216[1].typ = (&NTI253229);
TMP3216[1].name = "code";
TMP3218[1] = &TMP3216[2];
TMP3216[2].kind = 1;
TMP3216[2].offset = offsetof(tctx253037, Debug);
TMP3216[2].typ = (&NTI167208);
TMP3216[2].name = "debug";
TMP3218[2] = &TMP3216[3];
TMP3216[3].kind = 1;
TMP3216[3].offset = offsetof(tctx253037, Globals);
TMP3216[3].typ = (&NTI191805);
TMP3216[3].name = "globals";
TMP3218[3] = &TMP3216[4];
TMP3216[4].kind = 1;
TMP3216[4].offset = offsetof(tctx253037, Constants);
TMP3216[4].typ = (&NTI191805);
TMP3216[4].name = "constants";
TMP3218[4] = &TMP3216[5];
TMP3216[5].kind = 1;
TMP3216[5].offset = offsetof(tctx253037, Types);
TMP3216[5].typ = (&NTI191845);
TMP3216[5].name = "types";
TMP3218[5] = &TMP3216[6];
TMP3216[6].kind = 1;
TMP3216[6].offset = offsetof(tctx253037, Currentexceptiona);
TMP3216[6].typ = (&NTI191805);
TMP3216[6].name = "currentExceptionA";
TMP3218[6] = &TMP3216[7];
TMP3216[7].kind = 1;
TMP3216[7].offset = offsetof(tctx253037, Currentexceptionb);
TMP3216[7].typ = (&NTI191805);
TMP3216[7].name = "currentExceptionB";
TMP3218[7] = &TMP3216[8];
TMP3216[8].kind = 1;
TMP3216[8].offset = offsetof(tctx253037, Exceptioninstr);
...
TMP3216[13].kind = 1;
TMP3216[13].offset = offsetof(tblock253023, Label);
TMP3216[13].typ = (&NTI191811);
...
NTI253198.flags = 2;
NTI253198.marker = TMP3222;
TMP3216[14].kind = 1;
TMP3216[14].offset = offsetof(tblock253023, Fixups);
TMP3216[14].typ = (&NTI253198);
TMP3216[14].name = "fixups";
TMP3216[12].len = 2; TMP3216[12].kind = 2; TMP3216[12].sons = &TMP3221[0];
NTI253023.node = &TMP3216[12];
NTI253217.size = sizeof(TY253217*);
NTI253217.kind = 24;
NTI253217.base = (&NTI253023);
NTI253217.flags = 2;
NTI253217.marker = TMP3223;
TMP3216[11].kind = 1;
TMP3216[11].offset = offsetof(pprocHEX3Aobjecttype253216, Blocks);
TMP3216[11].typ = (&NTI253217);
TMP3216[11].name = "blocks";
TMP3220[1] = &TMP3216[15];
TMP3216[15].kind = 1;
TMP3216[15].offset = offsetof(pprocHEX3Aobjecttype253216, Sym);
TMP3216[15].typ = (&NTI191811);
TMP3216[15].name = "sym";
...
TMP3216[18].kind = 1;
TMP3216[18].offset = offsetof(TY253223, Field0);
...
NTI253031.node = &TMP3216[28];
TMP3216[19].kind = 1;
TMP3216[19].offset = offsetof(TY253223, Field1);
TMP3216[19].typ = (&NTI253031);
TMP3216[19].name = "Field1";
TMP3216[17].len = 2; TMP3216[17].kind = 2; TMP3216[17].sons = &TMP3224[0];
NTI253223.node = &TMP3216[17];
NTI253220.size = sizeof(TY253220);
NTI253220.kind = 16;
NTI253220.base = (&NTI253223);
NTI253220.flags = 3;
TMP3216[16].kind = 1;
TMP3216[16].offset = offsetof(pprocHEX3Aobjecttype253216, Slots);
TMP3216[16].typ = (&NTI253220);
TMP3216[16].name = "slots";
TMP3220[3] = &TMP3216[29];
TMP3216[29].kind = 1;
TMP3216[29].offset = offsetof(pprocHEX3Aobjecttype253216, Maxslots);
TMP3216[29].typ = (&NTI106);
TMP3216[29].name = "maxSlots";
TMP3216[10].len = 4; TMP3216[10].kind = 2; TMP3216[10].sons = &TMP3220[0];
NTI253216.node = &TMP3216[10];
NTI253033.size = sizeof(pprocHEX3Aobjecttype253216*);
NTI253033.kind = 22;
NTI253033.base = (&NTI253216);
NTI253033.flags = 2;
NTI253033.marker = TMP3228;
TMP3216[9].kind = 1;
TMP3216[9].offset = offsetof(tctx253037, Prc);
TMP3216[9].typ = (&NTI253033);
TMP3216[9].name = "prc";
TMP3218[9] = &TMP3216[30];
TMP3216[30].kind = 1;
TMP3216[30].offset = offsetof(tctx253037, Module);
TMP3216[30].typ = (&NTI191811);
TMP3216[30].name = "module";
TMP3218[10] = &TMP3216[31];
TMP3216[31].kind = 1;
TMP3216[31].offset = offsetof(tctx253037, Callsite);
TMP3216[31].typ = (&NTI191805);
...
NTI253025.node = &TMP3216[38];
TMP3216[32].kind = 1;
TMP3216[32].offset = offsetof(tctx253037, Mode);
TMP3216[32].typ = (&NTI253025);
