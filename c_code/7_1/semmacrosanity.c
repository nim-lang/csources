...
N_NIMCALL(tsym185843*, ithfield_414007)(tnode185813* n, NI field) {
	...
	case ((NU8) 136):
	{
		...
		while (1) {
			...
			result = ithfield_414007((*n).kindU.S6.Sons->data[i_414024], (NI32)(TMP5679));
	...
	case ((NU8) 137):
	{
		...
		result = ithfield_414007((*n).kindU.S6.Sons->data[0], (NI32)(TMP5681));
		...
		while (1) {
			...
			case ((NU8) 88):
			{
				...
				result = ithfield_414007(LOC20, (NI32)(TMP5684));
