...
N_NOINLINE(void, identsInit)(void) {
	...
	asgnRefNoCycle((void**) &idanon_170476, getident_170456(((NimStringDesc*) &TMP980)));
	nimln(109, "idents.nim");
	asgnRefNoCycle((void**) &iddelegator_170478, getident_170456(((NimStringDesc*) &TMP981)));
	popFrame();
}
...
NTI170013.flags = 1;
TMP970[0].kind = 1;
TMP970[0].offset = offsetof(tidobj170013, Id);
TMP970[0].typ = (&NTI106);
TMP970[0].name = "id";
NTI170013.node = &TMP970[0];
...
TMP977[0] = &TMP970[2];
TMP970[2].kind = 1;
TMP970[2].offset = offsetof(tident170019, S);
TMP970[2].typ = (&NTI143);
TMP970[2].name = "s";
TMP977[1] = &TMP970[3];
TMP970[3].kind = 1;
TMP970[3].offset = offsetof(tident170019, Next);
TMP970[3].typ = (&NTI170017);
TMP970[3].name = "next";
TMP977[2] = &TMP970[4];
TMP970[4].kind = 1;
TMP970[4].offset = offsetof(tident170019, H);
TMP970[4].typ = (&NTI120013);
TMP970[4].name = "h";
TMP970[1].len = 3; TMP970[1].kind = 2; TMP970[1].sons = &TMP977[0];
NTI170019.node = &TMP970[1];
NTI170017.size = sizeof(tident170019*);
NTI170017.kind = 22;
NTI170017.base = (&NTI170019);
NTI170017.flags = 2;
NTI170017.marker = TMP978;
NTI170015.size = sizeof(tidobj170013*);
NTI170015.kind = 22;
NTI170015.base = (&NTI170013);
NTI170015.marker = TMP2048;
}
