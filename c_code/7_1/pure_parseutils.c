...
N_NIMCALL(NI, rawparseint_80973)(NimStringDesc* s, NI64* b, NI start) {
	...
	nimln(200, "parseutils.nim");
	{
		...
		while (1) {
			...
			TMP1116 = subInt64((NI64)(TMP1114), ((NI64) ((NI32)(TMP1115))));
			(*b) = (NI64)(TMP1116);
...
N_NIMCALL(NI, npuParseBiggestFloat)(NimStringDesc* s, NF* number, NI start) {
	...
	nimln(261, "parseutils.nim");
	{
		...
		nimln(262, "parseutils.nim");
		{
			...
			LOC16 = ((NU8)(s->data[(NI32)(TMP1816)]) == (NU8)(65));
			if (LOC16) goto LA17;
			nimln(262, "parseutils.nim");
			nimln(262, "parseutils.nim");
			TMP1817 = addInt(i, 1);
			if ((NU)((NI32)(TMP1817)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC16 = ((NU8)(s->data[(NI32)(TMP1817)]) == (NU8)(97));
			LA17: ;
			if (!LOC16) goto LA18;
			nimln(263, "parseutils.nim");
			{
				...
				LOC22 = ((NU8)(s->data[(NI32)(TMP1818)]) == (NU8)(78));
				if (LOC22) goto LA23;
				nimln(263, "parseutils.nim");
				nimln(263, "parseutils.nim");
				TMP1819 = addInt(i, 2);
				if ((NU)((NI32)(TMP1819)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC22 = ((NU8)(s->data[(NI32)(TMP1819)]) == (NU8)(110));
				LA23: ;
				if (!LOC22) goto LA24;
				nimln(264, "parseutils.nim");
				{
					...
					if (!!((((NU8)(s->data[(NI32)(TMP1820)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI32)(TMP1820)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI32)(TMP1820)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI32)(TMP1820)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI32)(TMP1820)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI32)(TMP1820)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI32)(TMP1820)])) == ((NU8)(95))))) goto LA28;
					...
					nimln(266, "parseutils.nim");
					TMP1821 = addInt(i, 3);
					TMP1822 = subInt((NI32)(TMP1821), start);
					result = (NI32)(TMP1822);
					goto BeforeRet;
				}				LA28: ;
			}			LA24: ;
	...
	nimln(268, "parseutils.nim");
	{
		...
		nimln(269, "parseutils.nim");
		{
			...
			nimln(269, "parseutils.nim");
			TMP1823 = addInt(i, 1);
			if ((NU)((NI32)(TMP1823)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC38 = ((NU8)(s->data[(NI32)(TMP1823)]) == (NU8)(78));
			if (LOC38) goto LA39;
			nimln(269, "parseutils.nim");
			nimln(269, "parseutils.nim");
			TMP1824 = addInt(i, 1);
			if ((NU)((NI32)(TMP1824)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC38 = ((NU8)(s->data[(NI32)(TMP1824)]) == (NU8)(110));
			LA39: ;
			if (!LOC38) goto LA40;
			nimln(270, "parseutils.nim");
			{
				...
				nimln(270, "parseutils.nim");
				TMP1825 = addInt(i, 2);
				if ((NU)((NI32)(TMP1825)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC44 = ((NU8)(s->data[(NI32)(TMP1825)]) == (NU8)(70));
				if (LOC44) goto LA45;
				nimln(270, "parseutils.nim");
				nimln(270, "parseutils.nim");
				TMP1826 = addInt(i, 2);
				if ((NU)((NI32)(TMP1826)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC44 = ((NU8)(s->data[(NI32)(TMP1826)]) == (NU8)(102));
				LA45: ;
				if (!LOC44) goto LA46;
				nimln(271, "parseutils.nim");
				{
					...
					nimln(271, "parseutils.nim");
					TMP1827 = addInt(i, 3);
					if ((NU)((NI32)(TMP1827)) > (NU)(s->Sup.len)) raiseIndexError();
					if (!!((((NU8)(s->data[(NI32)(TMP1827)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI32)(TMP1827)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI32)(TMP1827)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI32)(TMP1827)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI32)(TMP1827)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI32)(TMP1827)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI32)(TMP1827)])) == ((NU8)(95))))) goto LA50;
					...
					nimln(273, "parseutils.nim");
					TMP1828 = addInt(i, 3);
					TMP1829 = subInt((NI32)(TMP1828), start);
					result = (NI32)(TMP1829);
					goto BeforeRet;
				}				LA50: ;
			}			LA46: ;
	...
	while (1) {
		...
		(*number) = ((NF)(((NF)((*number)) * (NF)(1.0000000000000000e+01))) + (NF)(((double) (((NI) ((NI32)(TMP1830)))))));
	...
	nimln(282, "parseutils.nim");
	{
		...
		while (1) {
			...
			(*number) = ((NF)(((NF)((*number)) * (NF)(1.0000000000000000e+01))) + (NF)(((double) (((NI) ((NI32)(TMP1831)))))));
	...
	nimln(296, "parseutils.nim");
	{
		...
		while (1) {
			...
			nimln(306, "parseutils.nim");
			if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
			TMP1833 = addInt((NI32)(TMP1832), ((NI) (((NU8)(s->data[i])))));
			TMP1834 = subInt((NI32)(TMP1833), 48);
			exponent = (NI32)(TMP1834);
