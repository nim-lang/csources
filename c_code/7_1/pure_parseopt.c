...
static NIM_CONST TY113118 TMP7038 = {
0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY113118 TMP7039 = {
...
N_NIMCALL(void, handleshortoption_417876)(toptparser417607* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_417802((*p).Cmd, i, &(*p).Val, TMP7038);
	}	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser417607* p) {
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_417802((*p).Cmd, i, &(*p).Key, TMP7039);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_417802((*p).Cmd, i, &(*p).Val, TMP7038);
			}			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_417802((*p).Cmd, i, &(*p).Key, TMP7038);
	}	break;
	}
	BeforeRet: ;	popFrame();
}
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser417607* p) {
	...
	LOC1 = 0;
	LOC1 = copyStrLast((*p).Cmd, (*p).Pos, (NI32)(TMP7040));
...
TMP7042[0] = &TMP7032[1];
TMP7032[1].kind = 1;
TMP7032[1].offset = offsetof(toptparser417607, Cmd);
TMP7032[1].typ = (&NTI142);
TMP7032[1].name = "cmd";
TMP7042[1] = &TMP7032[2];
TMP7032[2].kind = 1;
TMP7032[2].offset = offsetof(toptparser417607, Pos);
TMP7032[2].typ = (&NTI105);
TMP7032[2].name = "pos";
TMP7042[2] = &TMP7032[3];
TMP7032[3].kind = 1;
TMP7032[3].offset = offsetof(toptparser417607, Inshortstate);
...
NTI417605.node = &TMP7032[9];
TMP7032[4].kind = 1;
TMP7032[4].offset = offsetof(toptparser417607, Kind);
TMP7032[4].typ = (&NTI417605);
TMP7032[4].name = "kind";
TMP7042[4] = &TMP7032[10];
TMP7032[10].kind = 1;
TMP7032[10].offset = offsetof(toptparser417607, Key);
TMP7032[10].typ = (&NTI142);
TMP7032[10].name = "key";
TMP7042[5] = &TMP7032[11];
TMP7032[11].kind = 1;
TMP7032[11].offset = offsetof(toptparser417607, Val);
TMP7032[11].typ = (&NTI142);
TMP7032[11].name = "val";
TMP7032[0].len = 6; TMP7032[0].kind = 2; TMP7032[0].sons = &TMP7042[0];
NTI417607.node = &TMP7032[0];
}
