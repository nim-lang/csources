...
static NIM_CONST TY172865 TMP3702 = {
...
static NIM_CONST TY172865 TMP3706 = {
...
N_NIMCALL(NIM_BOOL, equalgenericparams_270010)(tnode172659* proca, tnode172659* procb) {
	...
	while (1) {
		...
		nimln(19, "procfind.nim");
		{
			...
			internalerror_139369((*proca).Info, ((NimStringDesc*) &TMP3705));			nimln(21, "procfind.nim");
			goto BeforeRet;
		}		LA11: ;
		nimln(22, "procfind.nim");
		{
			...
			internalerror_139369((*procb).Info, ((NimStringDesc*) &TMP3705));			nimln(24, "procfind.nim");
			goto BeforeRet;
		}		LA15: ;
		nimln(25, "procfind.nim");
		if (((TMP3702[(*proca).Kind/8] &(1<<((*proca).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3703));
		if ((NU)(i_270024) >= (NU)((*proca).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3706[(*(*proca).kindU.S6.Sons->data[i_270024]).Kind/8] &(1<<((*(*proca).kindU.S6.Sons->data[i_270024]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3707));
		a = (*(*proca).kindU.S6.Sons->data[i_270024]).kindU.S4.Sym;
		nimln(26, "procfind.nim");
		if (((TMP3702[(*procb).Kind/8] &(1<<((*procb).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3703));
		if ((NU)(i_270024) >= (NU)((*procb).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3706[(*(*procb).kindU.S6.Sons->data[i_270024]).Kind/8] &(1<<((*(*procb).kindU.S6.Sons->data[i_270024]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3707));
