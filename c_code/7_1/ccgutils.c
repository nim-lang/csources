...
static NIM_CONST TY186025 TMP6193 = {
...
N_NIMCALL(ttype185847*, getuniquetype_463401)(ttype185847* key) {
	...
	case ((NU8) 58):
	{
		...
		internalerror_163606(((NimStringDesc*) &TMP6197));
	}
	break;
	case ((NU8) 11):
	case ((NU8) 13):
