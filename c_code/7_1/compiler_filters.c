	...
	while (1) {
		...
		nimln(31, "filters.nim");
		{
			...
			nimln(32, "filters.nim");
			{
				...
				if (((TMP2577[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2578));
				if ((NU)(i_196068) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP2577[(*(*n).kindU.S6.Sons->data[i_196068]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_196068]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2578));
			...
			nimln(33, "filters.nim");
			{
				...
				if (((TMP2577[(*(*n).kindU.S6.Sons->data[i_196068]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_196068]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2578));
				if ((NU)(0) >= (NU)((*(*n).kindU.S6.Sons->data[i_196068]).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (!(((TMP2580[(*(*(*n).kindU.S6.Sons->data[i_196068]).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*(*n).kindU.S6.Sons->data[i_196068]).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2581));
				LOC17 = 0;
...
N_NIMCALL(NIM_BOOL, boolarg_196028)(tnode172659* n, NimStringDesc* name, NI pos, NIM_BOOL default_196033) {
	...
	LA3: ;
	{
		...
		LOC6 = identeq_141456((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2586));
		LA7: ;
		if (!LOC6) goto LA8;
		nimln(53, "filters.nim");
		result = NIM_TRUE;
	...
	LA8: ;
	{
		...
		nimln(54, "filters.nim");
		if (!(((TMP2580[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2581));
		LOC11 = identeq_141456((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2587));
		LA12: ;
		if (!LOC11) goto LA13;
		nimln(54, "filters.nim");
		result = NIM_FALSE;
...
N_NIMCALL(tllstream162204*, filterstrip_196008)(tllstream162204* stdin_196010, NimStringDesc* filename, tnode172659* call) {
	...
	pattern = strarg_196021(call, ((NimStringDesc*) &TMP2588), 1, ((NimStringDesc*) &TMP2589));
	nimln(59, "filters.nim");
	leading = boolarg_196028(call, ((NimStringDesc*) &TMP2590), 2, NIM_TRUE);
	nimln(60, "filters.nim");
	trailing = boolarg_196028(call, ((NimStringDesc*) &TMP2591), 3, NIM_TRUE);
	nimln(61, "filters.nim");
	result = llstreamopen_162218(((NimStringDesc*) &TMP2589));
...
N_NIMCALL(tllstream162204*, filterreplace_196002)(tllstream162204* stdin_196004, NimStringDesc* filename, tnode172659* call) {
	...
	sub = strarg_196021(call, ((NimStringDesc*) &TMP2593), 1, ((NimStringDesc*) &TMP2589));
	...
	by = strarg_196021(call, ((NimStringDesc*) &TMP2594), 2, ((NimStringDesc*) &TMP2589));
