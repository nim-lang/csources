...
TMP3044[0] = &TMP2960[1];
TMP2960[1].kind = 1;
TMP2960[1].offset = offsetof(tmemfile238204, Mem);
TMP2960[1].typ = (&NTI147);
TMP2960[1].name = "mem";
TMP3044[1] = &TMP2960[2];
TMP2960[2].kind = 1;
TMP2960[2].offset = offsetof(tmemfile238204, Size);
TMP2960[2].typ = (&NTI106);
TMP2960[2].name = "size";
TMP3044[2] = &TMP2960[3];
TMP2960[3].kind = 1;
TMP2960[3].offset = offsetof(tmemfile238204, Handle);
TMP2960[3].typ = (&NTI4409);
TMP2960[3].name = "handle";
TMP2960[0].len = 3; TMP2960[0].kind = 2; TMP2960[0].sons = &TMP3044[0];
NTI238204.node = &TMP2960[0];
}
