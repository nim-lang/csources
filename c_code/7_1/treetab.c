...
N_NIMCALL(NI, nodetablerawget_285508)(tnodetable223879 t, NI k, tnode223819* key);
N_NIMCALL(NIM_BOOL, treesequivalent_285242)(tnode223819* a, tnode223819* b);
...
N_NIMCALL(void, nodetablerawinsert_285561)(tnodepairseq223877** data, NI k, tnode223819* key, NI val);
	...
	{
		{
			...
			HEX3Atmp_285222 = (NI32)(LOC26 - 1);
			res_285225 = 0;
			{
				while (1) {
					NI LOC29;
					if (!(res_285225 <= HEX3Atmp_285222)) goto LA28;
					i_285202 = res_285225;
					LOC29 = 0;
		...
		{
			{
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					HEX3Atmp_285488 = (NI32)(LOC26 - 1);
					res_285491 = 0;
					{
						while (1) {
							if (!(res_285491 <= HEX3Atmp_285488)) goto LA28;
							i_285458 = res_285491;
							{
								NIM_BOOL LOC31;
								LOC31 = 0;
								LOC31 = treesequivalent_285242((*a).kindU.S6.Sons->data[i_285458], (*b).kindU.S6.Sons->data[i_285458]);
								if (!!(LOC31)) goto LA32;
								goto BeforeRet;
							}
							LA32: ;
	...
	h = (NI)(k & (t.Data->Sup.len-1));
	{
		while (1) {
			if (!!((t.Data->data[h].Key == NIM_NIL))) goto LA2;
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = treesequivalent_285242(t.Data->data[h].Key, key);
				LA6: ;
				if (!LOC5) goto LA7;
				result = h;
				goto BeforeRet;
...
N_NIMCALL(NI, nodetabletestorset_286121)(tnodetable223879* t, tnode223819* key, NI val) {
	...
	index = nodetablerawget_285508((*t), k, key);
	{
		if (!(0 <= index)) goto LA3;
	...
	{
		{
			...
			if (!LOC8) goto LA9;
			n = (tnodepairseq223877*) newSeq((&NTI223877), (NI32)((*t).Data->Sup.len * 2));
			{
				NI i_286251;
				NI HEX3Atmp_286301;
				NI res_286304;
				...
				res_286304 = 0;
				{
					while (1) {
						...
						i_286251 = res_286304;
						{
							...
							nodetablerawinsert_285561(&n, (*t).Data->data[i_286251].H, (*t).Data->data[i_286251].Key, (*t).Data->data[i_286251].Val);
						}
						LA16: ;
						res_286304 += 1;
					} LA13: ;
		...
		LA9: ;
		nodetablerawinsert_285561(&(*t).Data, k, key, val);
		result = val;
		(*t).Counter += 1;
	}
	LA1: ;
