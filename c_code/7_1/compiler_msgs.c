...
N_NOINLINE(void, raiserecoverableerror_181062)(NimStringDesc* msg);
...
tlineinfo180340 gcmdlineinfo_181007;
tlineinfo180340 gcodegenlineinfo_181054;
NU64 gnotes_181120;
NI gerrorcounter_181121;
NI ghintcounter_181122;
NI gwarncounter_181123;
NI gerrormax_181124;
TY181142* msgcontext_181163;
TNimType NTI180340; /* TLineInfo */
extern TNimType NTI112; /* int16 */
extern TNimType NTI114; /* int32 */
TNimType NTI181142; /* seq[TLineInfo] */
tlineinfo180340 lasterror_181164;
TY119808* bufferedmsgs_181166;
NU8 erroroutputs_181168;
TY181169 writelnhook_181172;
...
TNimType NTI181068; /* ref ERecoverableError */
...
TNimType NTI181454; /* ref ESuggestDone */
N_NIMCALL(void, TMP137)(void* p, NI op) {
	TY180353* a;
	NI LOC1;
	a = (TY180353*)p;
...
N_NIMCALL(trope177009*, makecstring_180459)(NimStringDesc* s) {
	...
	res = copyString(((NimStringDesc*) &TMP141));
	{
		...
		i_180477 = 0;
		HEX3Atmp_180482 = 0;
		HEX3Atmp_180482 = (NI32)(s->Sup.len - 1);
		res_180485 = 0;
		{
			while (1) {
				NimStringDesc* LOC9;
				...
				{
					trope177009* LOC8;
					if (!(((NI) ((NI32)((NI32)(i_180477 + 1) % 64))) == 0)) goto LA6;
					res = addChar(res, 34);
...
N_NIMCALL(void, msgwriteln_181947)(NimStringDesc* s) {
	{
		...
		{
			TY181990 LOC9;
			if (!((erroroutputs_181168 &(1<<((((NU8) 1))&7)))!=0)) goto LA7;
	...
	LA3: ;
	{
		{
			TY181990 LOC15;
			if (!((erroroutputs_181168 &(1<<((((NU8) 0))&7)))!=0)) goto LA13;
	...
	LA1: ;
	{
		if (!((erroroutputs_181168 &(1<<((((NU8) 2))&7)))!=0)) goto LA18;
		safeadd_181245((&bufferedmsgs_181166), s);
	}
	LA18: ;
}
...
N_NIMCALL(void, writecontext_182231)(tlineinfo180340 lastinfo) {
	...
	info = lastinfo;
	{
		...
		i_182258 = 0;
		HEX3Atmp_182264 = 0;
		HEX3Atmp_182264 = (NI32)(msgcontext_181163->Sup.len - 1);
		res_182267 = 0;
		{
			while (1) {
				...
				i_182258 = res_182267;
				{
					...
					LOC6 = 0;
					LOC7 = 0;
					LOC7 = HEX3DHEX3D_182220(msgcontext_181163->data[i_182258], lastinfo);
					LOC6 = !(LOC7);
					if (!(LOC6)) goto LA8;
					LOC9 = 0;
					LOC9 = HEX3DHEX3D_182220(msgcontext_181163->data[i_182258], info);
					LOC6 = !(LOC9);
					LA8: ;
					if (!LOC6) goto LA10;
					memset((void*)LOC12, 0, sizeof(LOC12));
					LOC12[0] = tomsgfilename_181831(msgcontext_181163->data[i_182258]);
					LOC12[1] = coordtostr_182057(((NI) (msgcontext_181163->data[i_182258].Line)));
					LOC12[2] = coordtostr_182057(((NI) (msgcontext_181163->data[i_182258].Col)));
				...
				LA10: ;
				info = msgcontext_181163->data[i_182258];
				res_182267 += 1;
			} LA3: ;
		}
	}
...
N_NOINLINE(void, raiserecoverableerror_181062)(NimStringDesc* msg) {
	erecoverableerror180346* e_181067;
	NimStringDesc* LOC1;
	e_181067 = 0;
	e_181067 = (erecoverableerror180346*) newObj((&NTI181068), sizeof(erecoverableerror180346));
	(*e_181067).Sup.Sup.Sup.m_type = (&NTI180346);
	LOC1 = 0;
	LOC1 = (*e_181067).Sup.Sup.message; (*e_181067).Sup.Sup.message = copyStringRC1(msg);
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_181067, "ERecoverableError");
}
...
N_NIMCALL(void, handleerror_182100)(NU16 msg, NU8 eh, NimStringDesc* s) {
	...
	LA5: ;
	{
		...
		LA18: ;
		if (!LOC17) goto LA19;
		gerrorcounter_181121 += 1;
		gexitcode_169129 = ((NI8) 1);
		{
			if (!(gerrormax_181124 <= gerrorcounter_181121)) goto LA23;
			{
				NIM_BOOL LOC27;
				NIM_BOOL LOC28;
				LOC27 = 0;
		...
		LA36: ;
		{
			...
			raiserecoverableerror_181062(s);
		}
		goto LA21;
		LA47: ;
		LA21: ;
...
{	frmt = 0;
	...
	case ((NU16) 230) ... ((NU16) 259):
	{
		...
		LA6: ;
		{
			if (!!(((gnotes_181120 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0))) goto LA10;
			goto BeforeRet;
		}
		LA10: ;
	...
	case ((NU16) 260) ... ((NU16) 276):
	{
		...
		LA16: ;
		{
			if (!!(((gnotes_181120 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0))) goto LA20;
			goto BeforeRet;
		}
		LA20: ;
		frmt = copyString(((NimStringDesc*) &TMP428));
		ghintcounter_181122 += 1;
	}
	break;
	}
	LOC22 = 0;
		...
		if (TMP1039.status == 0) {
			{
				...
				line_182782 = 0;
				HEX3Atmp_182838 = 0;
				HEX3Atmp_182838 = tofullpath_181640(i.Fileindex);
...
N_NIMCALL(void, limessage_182456)(tlineinfo180340 info, NU16 msg, NimStringDesc* arg, NU8 eh) {
	...
	case ((NU16) 230) ... ((NU16) 259):
	{
		...
		if (LOC3) goto LA4;
		LOC3 = !(((gnotes_181120 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0));
		LA4: ;
		ignoremsg = LOC3;
		{
	...
	case ((NU16) 260) ... ((NU16) 276):
	{
		...
		if (LOC10) goto LA11;
		LOC10 = !(((gnotes_181120 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0));
		LA11: ;
		ignoremsg = LOC10;
...
N_NIMCALL(void, suggestwriteln_181190)(NimStringDesc* s) {
	{
		if (!((erroroutputs_181168 &(1<<((((NU8) 0))&7)))!=0)) goto LA3;
		{
			TY181990 LOC9;
			if (!writelnhook_181172.ClPrc == 0) goto LA7;
			memset((void*)LOC9, 0, sizeof(LOC9));
			LOC9[0] = copyString(s);
		...
		LA7: ;
		{
			writelnhook_181172.ClEnv? writelnhook_181172.ClPrc(s, writelnhook_181172.ClEnv):((TMP1989)(writelnhook_181172.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
	{
		if (!((erroroutputs_181168 &(1<<((((NU8) 2))&7)))!=0)) goto LA13;
		safeadd_181245((&bufferedmsgs_181166), s);
	}
	LA13: ;
}
...
N_NIMCALL(void, pushinfocontext_181533)(tlineinfo180340 info) {
	msgcontext_181163 = (TY181142*) incrSeq(&(msgcontext_181163)->Sup, sizeof(tlineinfo180340));
	msgcontext_181163->data[msgcontext_181163->Sup.len-1] = info;
}

N_NIMCALL(void, popinfocontext_181560)(void) {
	msgcontext_181163 = (TY181142*) setLengthSeq(&(msgcontext_181163)->Sup, sizeof(tlineinfo180340), (NI32)(msgcontext_181163->Sup.len - 1));
}

N_NIMCALL(void, clearbufferedmsgs_181182)(void) {
	genericSeqAssign((&bufferedmsgs_181166), NIM_NIL, (&NTI119808));
}
N_NIMCALL(void, TMP2706)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_181449)(void) {
	esuggestdone180348* e_181453;
	NimStringDesc* LOC1;
	e_181453 = 0;
	e_181453 = (esuggestdone180348*) newObj((&NTI181454), sizeof(esuggestdone180348));
	(*e_181453).Sup.Sup.m_type = (&NTI180348);
	LOC1 = 0;
	LOC1 = (*e_181453).Sup.message; (*e_181453).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2707));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_181453, "ESuggestDone");
}
...
N_NIMCALL(tlineinfo180340, getinfocontext_181595)(NI index) {
	...
	LA1: ;
	{
		...
		result = unknownlineinfo_181133();
	}
	goto LA6;
	LA8: ;
	{
		result = msgcontext_181163->data[i];
	}
	LA6: ;
	return result;
}
...
N_NIMCALL(NI, getinfocontextlen_181488)(void) {
	NI result;
{	result = 0;
	result = msgcontext_181163->Sup.len;
	goto BeforeRet;
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, setinfocontextlen_181508)(NI l) {
	msgcontext_181163 = (TY181142*) setLengthSeq(&(msgcontext_181163)->Sup, sizeof(tlineinfo180340), l);
}
...
NIM_EXTERNC N_NOINLINE(void, compiler_msgsInit)(void) {
	...
	gcmdlineinfo_181007 = newlineinfo_180944(((NI32) 0), 1, 1);
	memset((void*)(&LOC2), 0, sizeof(LOC2));
	...
	gcodegenlineinfo_181054 = newlineinfo_180944(((NI32) 1), 1, 1);
	gnotes_181120 = IL64(140737439596543);
	gerrorcounter_181121 = 0;
	ghintcounter_181122 = 0;
	gwarncounter_181123 = 0;
	gerrormax_181124 = 1;
	if (msgcontext_181163) nimGCunrefNoCycle(msgcontext_181163);
	msgcontext_181163 = (TY181142*) newSeqRC1((&NTI181142), 0);
	lasterror_181164 = unknownlineinfo_181133();
	erroroutputs_181168 = 3;
...
NTI181142.size = sizeof(TY181142*);
NTI181142.kind = 24;
NTI181142.base = (&NTI180340);
NTI181142.flags = 2;
NTI181142.marker = TMP145;
NTI180346.size = sizeof(erecoverableerror180346);
NTI180346.kind = 17;
NTI180346.base = (&NTI3449);
TMP19[11].len = 0; TMP19[11].kind = 2;
NTI180346.node = &TMP19[11];
NTI181068.size = sizeof(erecoverableerror180346*);
NTI181068.kind = 22;
NTI181068.base = (&NTI180346);
NTI181068.marker = TMP429;
...
NTI181454.size = sizeof(esuggestdone180348*);
NTI181454.kind = 22;
NTI181454.base = (&NTI180348);
NTI181454.marker = TMP2706;
}
