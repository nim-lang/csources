...
N_NIMCALL(void, createstream_147264)(tstream143629** stream, NI32* handle, NU8 filemode);
...
N_NIMCALL(void, createfdset_147340)(fd_set* fd, TY146202* s, NI* m);
N_NIMCALL(void, pruneprocessset_147395)(TY146202** s, fd_set* fd);
...
N_NIMCALL(tprocess145203*, startcmd_145428)(NimStringDesc* command, NU8 options) {
	...
	while (1) {
		...
		nimln(138, "osproc.nim");
		nimln(138, "osproc.nim");
		TMP948 = subInt(i_145473, 1);
		if ((NU)((NI32)(TMP948)) >= (NU)(a->Sup.len)) raiseIndexError();
		if ((NU)(i_145473) >= (NU)(c->Sup.len)) raiseIndexError();
		LOC2 = 0;
		LOC2 = a->data[(NI32)(TMP948)]; a->data[(NI32)(TMP948)] = copyStringRC1(c->data[i_145473]);
...
N_NIMCALL(NCSTRING*, tocstringarray_146626)(NimStringDesc** b, NI bLen0, NimStringDesc** a, NI aLen0) {
	...
	while (1) {
		...
		TMP967 = addInt(b[i_146654]->Sup.len, 1);
		LOC3 = 0;
		...
		nimln(574, "osproc.nim");
		if ((NU)(i_146654) >= (NU)(bLen0)) raiseIndexError();
		TMP968 = addInt(b[i_146654]->Sup.len, 1);
		memcpy(((void*) (result[(i_146654)- 0])), ((void*) (b[i_146654]->data)), (NI32)(TMP968));		nimln(1311, "system.nim");
	...
	while (1) {
		...
		nimln(577, "osproc.nim");
		nimln(577, "osproc.nim");
		TMP971 = addInt(i_146664, bLen0);
		if ((NU)((NI32)(TMP971)) > (NU)(50000)) raiseIndexError();
		if ((NU)(i_146664) >= (NU)(aLen0)) raiseIndexError();
		nimln(577, "osproc.nim");
		nimln(577, "osproc.nim");
		if ((NU)(i_146664) >= (NU)(aLen0)) raiseIndexError();
		TMP972 = addInt(a[i_146664]->Sup.len, 1);
		memcpy(((void*) (result[((NI32)(TMP971))- 0])), ((void*) (a[i_146664]->data)), (NI32)(TMP972));		nimln(1311, "system.nim");
...
N_NIMCALL(NCSTRING*, envtocstringarray_146723)(void) {
	...
	while (1) {
		...
		if ((NU)(i_146756) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1151, "os.nim");
		TMP978 = subInt(p_146762, 1);
		key_146727 = copyStrLast(environment_104029->data[i_146756], 0, (NI32)(TMP978));
		nimln(1152, "os.nim");
		nimln(1152, "os.nim");
		if ((NU)(i_146756) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1152, "os.nim");
		TMP979 = addInt(p_146762, 1);
		val_146728 = copyStr(environment_104029->data[i_146756], (NI32)(TMP979));
	...
	while (1) {
		...
		if ((NU)(i_146772) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1151, "os.nim");
		TMP982 = subInt(p_146778, 1);
		key_146741 = copyStrLast(environment_104029->data[i_146772], 0, (NI32)(TMP982));
		nimln(1152, "os.nim");
		nimln(1152, "os.nim");
		if ((NU)(i_146772) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1152, "os.nim");
		TMP983 = addInt(p_146778, 1);
		val_146742 = copyStr(environment_104029->data[i_146772], (NI32)(TMP983));
...
appendString(LOC67, LOC69);
		...
		nimln(683, "osproc.nim");
		{
			...
			a = tocstringarray_146626(LOC78, 1, args, argsLen0);
			...
			LA81: ;
			{
				...
				nimln(688, "osproc.nim");
				LOC85 = 0;
				LOC85 = tocstringarray_146692(env);
				LOC86 = 0;
		...
		LA76: ;
		{
			...
			a = tocstringarray_146626(TMP987, 2, LOC88, 1);
			...
			LA91: ;
			{
				...
				nimln(695, "osproc.nim");
				LOC95 = 0;
				LOC95 = tocstringarray_146692(env);
				LOC96 = 0;
...
N_NIMCALL(tstream143629*, nospinputStream)(tprocess145203* p) {
	...
	nimln(774, "osproc.nim");
	{
		...
		createstream_147264(&(*p).Instream, &(*p).Inhandle, ((NU8) 1));	}	LA3: ;
...
N_NIMCALL(tstream143629*, nospoutputStream)(tprocess145203* p) {
	...
	nimln(779, "osproc.nim");
	{
		...
		createstream_147264(&(*p).Outstream, &(*p).Outhandle, ((NU8) 0));	}	LA3: ;
...
N_NIMCALL(tstream143629*, nosperrorStream)(tprocess145203* p) {
	...
	nimln(784, "osproc.nim");
	{
		...
		createstream_147264(&(*p).Errstream, &(*p).Errhandle, ((NU8) 0));	}	LA3: ;
...
N_NIMCALL(void, createfdset_147340)(fd_set* fd, TY146202* s, NI* m) {
	...
	while (1) {
		nimln(1394, "system.nim");
		nimln(1394, "system.nim");
		if (!(i_147392 < s->Sup.len)) goto LA1;
		nimln(1395, "system.nim");
		if ((NU)(i_147392) >= (NU)(s->Sup.len)) raiseIndexError();
		i_147379 = s->data[i_147392];
		nimln(796, "osproc.nim");
		nimln(796, "osproc.nim");
		(*m) = (((*m) >= ((NI) ((*i_147379).Outhandle))) ? (*m) : ((NI) ((*i_147379).Outhandle)));
		nimln(797, "osproc.nim");
		FD_SET((*i_147379).Outhandle, fd);		nimln(1396, "system.nim");
		i_147392 = addInt(i_147392, 1);
	} LA1: ;
	popFrame();
}
N_NIMCALL(void, pruneprocessset_147395)(TY146202** s, fd_set* fd) {
...
N_NIMCALL(NI, select_146502)(TY146202** readfds, NI timeout) {
	...
	createfdset_147340(&rd, (*readfds), &m);	nimln(819, "osproc.nim");
	{
		NI TMP995;
		int LOC5;
		nimln(698, "system.nim");
	...
	pruneprocessset_147395(readfds, &rd);	popFrame();
	return result;
}
N_NIMCALL(void, execcmdex_147602)(NimStringDesc* command, NU8 options, TY75888* Result) {
	tprocess145203* p;
...
TMP950[0] = &TMP921[1];
TMP921[1].kind = 1;
TMP921[1].offset = offsetof(tprocess145203, Inhandle);
TMP921[1].typ = (&NTI9008);
TMP921[1].name = "inHandle";
TMP950[1] = &TMP921[2];
TMP921[2].kind = 1;
TMP921[2].offset = offsetof(tprocess145203, Outhandle);
TMP921[2].typ = (&NTI9008);
TMP921[2].name = "outHandle";
TMP950[2] = &TMP921[3];
TMP921[3].kind = 1;
TMP921[3].offset = offsetof(tprocess145203, Errhandle);
TMP921[3].typ = (&NTI9008);
TMP921[3].name = "errHandle";
TMP950[3] = &TMP921[4];
TMP921[4].kind = 1;
TMP921[4].offset = offsetof(tprocess145203, Instream);
TMP921[4].typ = (&NTI143627);
TMP921[4].name = "inStream";
TMP950[4] = &TMP921[5];
TMP921[5].kind = 1;
TMP921[5].offset = offsetof(tprocess145203, Outstream);
TMP921[5].typ = (&NTI143627);
TMP921[5].name = "outStream";
TMP950[5] = &TMP921[6];
TMP921[6].kind = 1;
TMP921[6].offset = offsetof(tprocess145203, Errstream);
TMP921[6].typ = (&NTI143627);
TMP921[6].name = "errStream";
TMP950[6] = &TMP921[7];
TMP921[7].kind = 1;
TMP921[7].offset = offsetof(tprocess145203, Id);
TMP921[7].typ = (&NTI91457);
TMP921[7].name = "id";
TMP950[7] = &TMP921[8];
TMP921[8].kind = 1;
TMP921[8].offset = offsetof(tprocess145203, Exitcode);
TMP921[8].typ = (&NTI3809);
TMP921[8].name = "exitCode";
TMP921[0].len = 8; TMP921[0].kind = 2; TMP921[0].sons = &TMP950[0];
NTI145203.node = &TMP921[0];
NTI145205.size = sizeof(tprocess145203*);
NTI145205.kind = 22;
NTI145205.base = (&NTI145203);
NTI145205.flags = 2;
NTI145205.marker = TMP952;
NTI146202.size = sizeof(TY146202*);
NTI146202.kind = 24;
NTI146202.base = (&NTI145205);
NTI146202.flags = 2;
NTI146202.marker = TMP953;
}
