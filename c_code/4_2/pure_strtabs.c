...
N_NIMCALL(void, enlarge_112876)(tstringtable112610* t) {
	...
	n = (tkeyvaluepairseq112608*) newSeq((&NTI112608), (NI64)(TMP287));
	i_112907 = 0;
	HEX3Atmp_112921 = 0;
...
TMP294[0] = &TMP266[1];
TMP266[1].kind = 1;
TMP266[1].offset = offsetof(tstringtable112610, Counter);
TMP266[1].typ = (&NTI105);
TMP266[1].name = "counter";
TMP294[1] = &TMP266[2];
TMP266[2].kind = 1;
TMP266[2].offset = offsetof(tstringtable112610, Data);
TMP266[2].typ = (&NTI112608);
TMP266[2].name = "data";
TMP294[2] = &TMP266[3];
...
NTI112604.node = &TMP266[7];
TMP266[3].kind = 1;
TMP266[3].offset = offsetof(tstringtable112610, Mode);
TMP266[3].typ = (&NTI112604);
TMP266[3].name = "mode";
TMP266[0].len = 3; TMP266[0].kind = 2; TMP266[0].sons = &TMP294[0];
NTI112610.node = &TMP266[0];
NTI112612.size = sizeof(tstringtable112610*);
NTI112612.kind = 22;
NTI112612.base = (&NTI112610);
NTI112612.flags = 2;
NTI112612.marker = TMP298;
}
