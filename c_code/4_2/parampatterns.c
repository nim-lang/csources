...
N_NIMCALL(void, patternerror_274040)(tnode185813* n);
...
static N_INLINE(void, add_274046)(NimStringDesc** code, NU8 op);
...
N_NIMCALL(void, compileconstraints_274106)(tnode185813* p, NimStringDesc** result);
...
N_NIMCALL(tnode185813*, semnodekindconstraints_274472)(tnode185813* p);
...
N_NIMCALL(NU8, checkforsideeffects_274740)(tnode185813* n);
static N_INLINE(NIM_BOOL, isroutine_192041)(tsym185843* s);
N_NIMCALL(NU8, isassignable_274970)(tsym185843* owner, tnode185813* n);
...
static NIM_CONST TY186025 TMP3571 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3572, "strVal", 6);
static NIM_CONST TY186025 TMP3573 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3574, "sons", 4);
static NIM_CONST TY186025 TMP3575 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3576, "ident", 5);
STRING_LITERAL(TMP3577, "|", 1);
STRING_LITERAL(TMP3578, "&", 1);
STRING_LITERAL(TMP3579, "~", 1);
STRING_LITERAL(TMP3580, "atom", 4);
STRING_LITERAL(TMP3581, "lit", 3);
STRING_LITERAL(TMP3582, "sym", 3);
STRING_LITERAL(TMP3583, "ident", 5);
STRING_LITERAL(TMP3584, "call", 4);
STRING_LITERAL(TMP3585, "alias", 5);
STRING_LITERAL(TMP3586, "noalias", 7);
STRING_LITERAL(TMP3587, "lvalue", 6);
STRING_LITERAL(TMP3588, "local", 5);
STRING_LITERAL(TMP3589, "sideeffect", 10);
STRING_LITERAL(TMP3590, "nosideeffect", 12);
STRING_LITERAL(TMP3592, "parampatterns.nim", 17);
NIM_CONST TY129008 TMP3591 = {((NimStringDesc*) &TMP3592),
100}
;
NIM_CONST TY129008 TMP3593 = {((NimStringDesc*) &TMP3592),
107}
;
STRING_LITERAL(TMP3594, "p.kind == nkCurlyExpr ", 22);
STRING_LITERAL(TMP3595, "parameter pattern too complex", 29);
static NIM_CONST TY186025 TMP3596 = {
...
N_NIMCALL(void, patternerror_274040)(tnode185813* n) {
	...
	localerror_163571((*n).Info, ((NU16) 1), LOC1);
	popFrame();
}
...
N_NIMCALL(NU8, whichalias_274061)(tsym185843* p) {
	...
	nimln(51, "parampatterns.nim");
	{
		...
		nimln(52, "parampatterns.nim");
		if (!(((TMP3571[(*(*p).Constraint).Kind/8] &(1<<((*(*p).Constraint).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3572));
...
static N_INLINE(NI, len_186274)(tnode185813* n) {
	...
	{
		nimln(958, "ast.nim");
		if (((TMP3573[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3574));
...
N_NIMCALL(void, compileconstraints_274106)(tnode185813* p, NimStringDesc** result) {
	...
	case ((NU8) 32):
	{
		...
		nimln(59, "parampatterns.nim");
		{
			nimln(59, "parampatterns.nim");
			nimln(59, "parampatterns.nim");
			if (((TMP3573[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3574));
			...
			if (((TMP3573[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3574));
			if ((NU)(0) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
			patternerror_274040((*p).kindU.S6.Sons->data[0]);
		...
		if (((TMP3573[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3574));
		if ((NU)(0) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3575[(*(*p).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*p).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3576));
		...
		nimln(63, "parampatterns.nim");
		{
			...
			nimln(64, "parampatterns.nim");
			{
				...
				LOC13 = 0;
				nimln(64, "parampatterns.nim");
				LOC13 = eqStrings((*op).S, ((NimStringDesc*) &TMP3577));
				if (LOC13) goto LA14;
				nimln(64, "parampatterns.nim");
				LOC13 = ((*op).Sup.Id == 47);
				LA14: ;
				...
				compileconstraints_274106((*p).kindU.S6.Sons->data[1], result);
				nimln(66, "parampatterns.nim");
				if (((TMP3573[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3574));
				if ((NU)(2) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
				compileconstraints_274106((*p).kindU.S6.Sons->data[2], result);
				nimln(67, "parampatterns.nim");
				add_274046(result, ((NU8) 2));
			}
			goto LA11;
			LA15: ;
			{
				...
				LOC18 = 0;
				nimln(68, "parampatterns.nim");
				LOC18 = eqStrings((*op).S, ((NimStringDesc*) &TMP3578));
				if (LOC18) goto LA19;
				nimln(68, "parampatterns.nim");
				LOC18 = ((*op).Sup.Id == 2);
				LA19: ;
				...
				add_274046(result, ((NU8) 3));
			}
			goto LA11;
			LA20: ;
			{
				nimln(73, "parampatterns.nim");
				patternerror_274040(p);
			}
			LA11: ;
		}
		goto LA6;
		LA9: ;
		{
			...
			LOC27 = 0;
			nimln(74, "parampatterns.nim");
			LOC27 = eqStrings((*op).S, ((NimStringDesc*) &TMP3579));
			if (LOC27) goto LA28;
			nimln(74, "parampatterns.nim");
			LOC27 = ((*op).Sup.Id == 43);
			LA28: ;
	...
	case ((NU8) 37):
	{
		nimln(80, "parampatterns.nim");
		{
			...
			if (((TMP3573[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3574));
			if ((NU)(0) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
			compileconstraints_274106((*p).kindU.S6.Sons->data[0], result);
		}
		goto LA33;
		LA36: ;
		{
	...
	case ((NU8) 2):
	{
		...
		case 2: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3590))) goto LA50;
break;
		case 4: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3582))) goto LA42;
if (eqStrings(spec, ((NimStringDesc*) &TMP3587))) goto LA47;
if (eqStrings(spec, ((NimStringDesc*) &TMP3589))) goto LA49;
break;
		case 6: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3583))) goto LA43;
break;
		case 10: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3586))) goto LA46;
break;
		case 11: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3580))) goto LA40;
break;
		case 12: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3581))) goto LA41;
break;
		case 13: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3584))) goto LA44;
break;
		case 14: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3585))) goto LA45;
if (eqStrings(spec, ((NimStringDesc*) &TMP3588))) goto LA48;
break;
		}
		goto LA51;
		LA40: ;
		{
			...
			add_274046(result, ((NU8) 6));
		}
		goto LA52;
		LA41: ;
		{
			nimln(88, "parampatterns.nim");
			add_274046(result, ((NU8) 7));
		}
		goto LA52;
		LA42: ;
		{
			nimln(89, "parampatterns.nim");
			add_274046(result, ((NU8) 5));
		}
		goto LA52;
		LA43: ;
		{
			nimln(90, "parampatterns.nim");
			add_274046(result, ((NU8) 8));
		}
		goto LA52;
		LA44: ;
		{
			nimln(91, "parampatterns.nim");
			add_274046(result, ((NU8) 9));
		}
		goto LA52;
		LA45: ;
		{
		...
		LA47: ;
		{
			...
			add_274046(result, ((NU8) 12));
		}
		goto LA52;
		LA48: ;
		{
			nimln(95, "parampatterns.nim");
			add_274046(result, ((NU8) 13));
		}
		goto LA52;
		LA49: ;
		{
			nimln(96, "parampatterns.nim");
			add_274046(result, ((NU8) 14));
		}
		goto LA52;
		LA50: ;
		{
			nimln(97, "parampatterns.nim");
			add_274046(result, ((NU8) 15));
		}
		goto LA52;
		LA51: ;
		{
			...
			nimln(849, "msgs.nim");
			{
				...
				nimln(849, "msgs.nim");
				LOC69 = 0;
				LOC69 = HEX24_163714(TMP3591);
				internalerror_163606(LOC69);
			}
			LA67: ;
			i_274371 = 0;
			...
			while (1) {
				nimln(1458, "system.nim");
				if (!(res_274461 <= ((NU8) 24))) goto LA70;
				nimln(1457, "system.nim");
				i_274371 = res_274461;
			...
			nimln(849, "msgs.nim");
			{
				...
				nimln(849, "msgs.nim");
				LOC81 = 0;
				LOC81 = HEX24_163714(TMP3593);
				internalerror_163606(LOC81);
			}
			LA79: ;
			i_274442 = 0;
			nimln(1457, "system.nim");
			...
			while (1) {
				nimln(1458, "system.nim");
				if (!(res_274466 <= ((NU8) 156))) goto LA82;
				nimln(1457, "system.nim");
				i_274442 = res_274466;
				nimln(109, "parampatterns.nim");
				{
					...
					nimln(109, "parampatterns.nim");
					LOC85 = 0;
					LOC85 = nsuCmpIgnoreStyle(reprEnum(i_274442, (&NTI185023)), spec);
					if (!(LOC85 == 0)) goto LA86;
					nimln(110, "parampatterns.nim");
					add_274046(result, ((NU8) 11));
					nimln(111, "parampatterns.nim");
					nimln(111, "parampatterns.nim");
					nimln(111, "parampatterns.nim");
					(*result) = addChar((*result), ((NIM_CHAR) (((NI) (i_274442)))));
					nimln(112, "parampatterns.nim");
					goto BeforeRet;
				}
				LA86: ;
				nimln(1460, "system.nim");
				res_274466 = addInt(res_274466, 1);
			} LA82: ;
...
N_NIMCALL(tnode185813*, semnodekindconstraints_274472)(tnode185813* p) {
	...
	nimln(120, "parampatterns.nim");
	{
		...
		nimln(120, "parampatterns.nim");
		failedassertimpl_79821(((NimStringDesc*) &TMP3594));
	}
	LA3: ;
	nimln(121, "parampatterns.nim");
	result = newnodei_186109(((NU8) 20), (*p).Info);
	nimln(122, "parampatterns.nim");
	if (!(((TMP3571[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3572));
	nimln(122, "parampatterns.nim");
	...
	nimln(124, "parampatterns.nim");
	{
		...
		LOC10 = 0;
		LOC10 = len_186274(p);
		HEX3Atmp_274727 = subInt(LOC10, 1);
		nimln(1457, "system.nim");
		res_274729 = 1;
		nimln(1458, "system.nim");
		while (1) {
			nimln(1458, "system.nim");
			if (!(res_274729 <= HEX3Atmp_274727)) goto LA11;
			nimln(1457, "system.nim");
			i_274667 = res_274729;
			nimln(126, "parampatterns.nim");
			if (((TMP3573[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3574));
			if ((NU)(i_274667) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!(((TMP3571[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3572));
			compileconstraints_274106((*p).kindU.S6.Sons->data[i_274667], &(*result).kindU.S3.Strval);
			nimln(1460, "system.nim");
			res_274729 = addInt(res_274729, 1);
		} LA11: ;
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_163591((*p).Info, ((NimStringDesc*) &TMP3595));
		}
		LA14: ;
	}
	goto LA5;
	...
	if (!(((TMP3571[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3572));
	add_274046(&(*result).kindU.S3.Strval, ((NU8) 1));
	popFrame();
	return result;
}
...
N_NIMCALL(NU8, checkforsideeffects_274740)(tnode185813* n) {
	...
	case ((NU8) 32):
	{
		...
		nimln(143, "parampatterns.nim");
		{
			...
			if (!(LOC4)) goto LA5;
			nimln(143, "parampatterns.nim");
			if (!(((TMP3596[(*op).Kind/8] &(1<<((*op).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3597));
			LOC4 = isroutine_192041((*op).kindU.S4.Sym);
			LA5: ;
			if (!LOC4) goto LA6;
		...
		LOC16 = 0;
		LOC16 = len_186274(n);
		HEX3Atmp_274951 = subInt(LOC16, 1);
		nimln(1457, "system.nim");
		res_274953 = 0;
		nimln(1458, "system.nim");
		while (1) {
			NU8 ret;
			nimln(1458, "system.nim");
			if (!(res_274953 <= HEX3Atmp_274951)) goto LA17;
			nimln(1457, "system.nim");
			i_274844 = res_274953;
			nimln(157, "parampatterns.nim");
			if (((TMP3573[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3574));
			if ((NU)(i_274844) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			ret = checkforsideeffects_274740((*n).kindU.S6.Sons->data[i_274844]);
			...
			LA18: ;
			nimln(1460, "system.nim");
			res_274953 = addInt(res_274953, 1);
		} LA17: ;
	}
	break;
	case ((NU8) 0) ... ((NU8) 23):
	...
	default:
	{
		...
		LOC29 = 0;
		LOC29 = len_186274(n);
		HEX3Atmp_274955 = subInt(LOC29, 1);
		nimln(1457, "system.nim");
		res_274957 = 0;
		nimln(1458, "system.nim");
		while (1) {
			NU8 ret;
			nimln(1458, "system.nim");
			if (!(res_274957 <= HEX3Atmp_274955)) goto LA30;
			nimln(1457, "system.nim");
			i_274908 = res_274957;
			nimln(166, "parampatterns.nim");
			if (((TMP3573[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3574));
			if ((NU)(i_274908) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			ret = checkforsideeffects_274740((*n).kindU.S6.Sons->data[i_274908]);
			...
			LA31: ;
			nimln(1460, "system.nim");
			res_274957 = addInt(res_274957, 1);
		} LA30: ;
	}
	break;
	}
...
N_NIMCALL(NU8, isassignable_274970)(tsym185843* owner, tnode185813* n) {
	...
	case ((NU8) 45):
	{
		nimln(192, "parampatterns.nim");
		{
			...
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC18 = 0;
			LOC18 = skiptypes_189793((*(*n).kindU.S6.Sons->data[0]).Typ, IL64(211106232576000));
		...
		LA19: ;
		{
			...
			if (((TMP3573[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3574));
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			result = isassignable_274970(owner, (*n).kindU.S6.Sons->data[0]);
		}
		LA16: ;
		nimln(197, "parampatterns.nim");
		{
			...
			if (!(((TMP3596[(*(*n).kindU.S6.Sons->data[1]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[1]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3597));
	...
	case ((NU8) 42):
	{
		nimln(200, "parampatterns.nim");
		{
			...
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC31 = 0;
			LOC31 = skiptypes_189793((*(*n).kindU.S6.Sons->data[0]).Typ, IL64(211106232576000));
	...
	case ((NU8) 60):
	{
		nimln(208, "parampatterns.nim");
		{
			...
			nimln(208, "parampatterns.nim");
			LOC38 = 0;
			LOC38 = skiptypes_189793((*n).Typ, IL64(211106247256064));
			if (!((134610944 &(IL64(1)<<(((*LOC38).Kind)&IL64(63))))!=0)) goto LA39;
			nimln(210, "parampatterns.nim");
			if (((TMP3573[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3574));
			if ((NU)(1) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			result = isassignable_274970(owner, (*n).kindU.S6.Sons->data[1]);
		}
		goto LA36;
		LA39: ;
		{
			...
			if ((NU)(1) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC42 = 0;
			LOC42 = comparetypes_228564((*n).Typ, (*(*n).kindU.S6.Sons->data[1]).Typ, ((NU8) 1), 0);
			if (!LOC42) goto LA43;
...
N_NIMCALL(NIM_BOOL, matchnodekinds_275321)(tnode185813* p, tnode185813* n) {
	...
	while (1) {
		...
		case ((NU8) 2):
		{
			...
			LOC4 = stack[((NI64)(TMP3599))- 0];
			if (LOC4) goto LA5;
			nimln(239, "parampatterns.nim");
			TMP3600 = subInt(sp, 2);
			if ((NU)((NI64)(TMP3600)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI64)(TMP3600))- 0];
			LA5: ;
			stack[((NI64)(TMP3598))- 0] = LOC4;
		...
		case ((NU8) 3):
		{
			...
			LOC7 = stack[((NI64)(TMP3602))- 0];
			if (!(LOC7)) goto LA8;
			nimln(242, "parampatterns.nim");
			TMP3603 = subInt(sp, 2);
			if ((NU)((NI64)(TMP3603)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI64)(TMP3603))- 0];
			LA8: ;
			stack[((NI64)(TMP3601))- 0] = LOC7;
		...
		case ((NU8) 4):
		{
			...
			stack[((NI64)(TMP3604))- 0] = !(stack[((NI64)(TMP3605))- 0]);
		}
		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(251, "parampatterns.nim");
			TMP3606 = addInt(pc, 1);
			if ((NU)((NI64)(TMP3606)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3606)])), ((NU8) 0), ((NU8) 24)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			nimln(255, "parampatterns.nim");
			TMP3607 = addInt(pc, 1);
			if ((NU)((NI64)(TMP3607)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3607)])), ((NU8) 0), ((NU8) 156)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 12):
		{
			...
			nimln(258, "parampatterns.nim");
			LOC20 = 0;
			LOC20 = isassignable_274970(NIM_NIL, n);
		...
		case ((NU8) 13):
		{
			...
			nimln(259, "parampatterns.nim");
			LOC22 = 0;
			LOC22 = isassignable_274970(NIM_NIL, n);
		...
		case ((NU8) 14):
		{
			...
			nimln(260, "parampatterns.nim");
			LOC24 = 0;
			LOC24 = checkforsideeffects_274740(n);
		...
		case ((NU8) 15):
		{
			...
			nimln(261, "parampatterns.nim");
			LOC26 = 0;
			LOC26 = checkforsideeffects_274740(n);
