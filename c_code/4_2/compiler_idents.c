...
N_NIMCALL(NI, cmpignorestyle_140034)(NCSTRING a, NCSTRING b, NI blen) {
	...
	while (1) {
		...
		nimln(43, "idents.nim");
		{
			...
			aa = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP884), 0, 255))));
		}		LA16: ;
		nimln(44, "idents.nim");
		{
			NIM_BOOL LOC20;
			...
			bb = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP885), 0, 255))));
		}		LA22: ;
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
...
N_NOINLINE(void, compileridentsInit)(void) {
	...
	asgnRefNoCycle((void**) &idanon_140463, getident_140443(((NimStringDesc*) &TMP892)));
	nimln(109, "idents.nim");
	asgnRefNoCycle((void**) &iddelegator_140465, getident_140443(((NimStringDesc*) &TMP893)));
	popFrame();
}
...
NTI140011.flags = 3;
TMP882[0].kind = 1;
TMP882[0].offset = offsetof(tidobj140011, Id);
TMP882[0].typ = (&NTI105);
TMP882[0].name = "id";
NTI140011.node = &TMP882[0];
...
TMP889[0] = &TMP882[2];
TMP882[2].kind = 1;
TMP882[2].offset = offsetof(tident140017, S);
TMP882[2].typ = (&NTI142);
TMP882[2].name = "s";
TMP889[1] = &TMP882[3];
TMP882[3].kind = 1;
TMP882[3].offset = offsetof(tident140017, Next);
TMP882[3].typ = (&NTI140015);
TMP882[3].name = "next";
TMP889[2] = &TMP882[4];
TMP882[4].kind = 1;
TMP882[4].offset = offsetof(tident140017, H);
TMP882[4].typ = (&NTI110011);
TMP882[4].name = "h";
TMP882[1].len = 3; TMP882[1].kind = 2; TMP882[1].sons = &TMP889[0];
NTI140017.node = &TMP882[1];
NTI140015.size = sizeof(tident140017*);
NTI140015.kind = 22;
NTI140015.base = (&NTI140017);
NTI140015.flags = 2;
NTI140015.marker = TMP890;
NTI140013.size = sizeof(tidobj140011*);
NTI140013.kind = 22;
NTI140013.base = (&NTI140011);
NTI140013.flags = 2;
NTI140013.marker = TMP2017;
}
