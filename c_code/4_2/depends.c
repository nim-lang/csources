...
typedef struct tgen519012 tgen519012;
...
N_NIMCALL(void, adddependencyaux_519020)(NimStringDesc* importing, NimStringDesc* imported);
...
N_NIMCALL(void, TMP7619)(void* p, NI op);
...
STRING_LITERAL(TMP7611, "$1 -> $2;$n", 11);
static NIM_CONST TY186025 TMP7612 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7613, "sons", 4);
STRING_LITERAL(TMP7616, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP7617, "", 0);
STRING_LITERAL(TMP7618, "dot", 3);
NIM_CONST tpass244015 gendependpass_519152 = {myopen_519128,
NIM_NIL,
adddotdependency_519031,
NIM_NIL}
;
trope143007* gdotgraph_519017;
extern TFrame* frameptr_13038;
extern TNimType NTI244003; /* TPassContext */
TNimType NTI519012; /* TGen */
extern TNimType NTI185811; /* PSym */
TNimType NTI519014; /* PGen */
...
N_NIMCALL(void, adddependencyaux_519020)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	nimln(25, "depends.nim");
	LOC1[0] = torope_143058(importing);
	nimln(25, "depends.nim");
	LOC1[1] = torope_143058(imported);
	appf_143085(&gdotgraph_519017, ((NimStringDesc*) &TMP7611), LOC1, 2);
	popFrame();
}
...
static N_INLINE(NI, sonslen_186191)(tnode185813* n) {
	...
	{
		nimln(1301, "ast.nim");
		if (((TMP7612[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7613));
...
N_NIMCALL(tnode185813*, adddotdependency_519031)(tpasscontext244003* c, tnode185813* n) {
	...
	if (c) chckObj((*c).Sup.m_type, (&NTI519012));
	g = ((tgen519012*) (c));
	...
	case ((NU8) 115):
	{
		...
		TMP7614 = subInt(LOC2, 1);
		HEX3Atmp_519107 = (NI64)(TMP7614);
		...
		while (1) {
			...
			nimln(1451, "system.nim");
			if (!(res_519109 <= HEX3Atmp_519107)) goto LA3;
			nimln(1450, "system.nim");
			i_519049 = res_519109;
			nimln(34, "depends.nim");
			if (((TMP7612[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7613));
			if ((NU)(i_519049) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			imported = getmodulename_253012((*n).kindU.S6.Sons->data[i_519049]);
			nimln(35, "depends.nim");
			adddependencyaux_519020((*(*(*g).Module).Name).S, imported);
			nimln(1453, "system.nim");
			res_519109 = addInt(res_519109, 1);
		} LA3: ;
	}
	break;
	case ((NU8) 119):
	case ((NU8) 116):
	{
		...
		imported = getmodulename_253012((*n).kindU.S6.Sons->data[0]);
	...
	case ((NU8) 126):
	{
		...
		TMP7615 = subInt(LOC6, 1);
		HEX3Atmp_519111 = (NI64)(TMP7615);
		nimln(1450, "system.nim");
		res_519113 = 0;
		nimln(1451, "system.nim");
		while (1) {
			tnode185813* LOC8;
			nimln(1451, "system.nim");
			if (!(res_519113 <= HEX3Atmp_519111)) goto LA7;
			nimln(1450, "system.nim");
			i_519092 = res_519113;
			nimln(40, "depends.nim");
			nimln(40, "depends.nim");
			if (((TMP7612[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7613));
			if ((NU)(i_519092) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC8 = 0;
			LOC8 = adddotdependency_519031(c, (*n).kindU.S6.Sons->data[i_519092]);
			nimln(1453, "system.nim");
			res_519113 = addInt(res_519113, 1);
		} LA7: ;
	}
	break;
	default:
...
N_NIMCALL(void, generatedot_519007)(NimStringDesc* project) {
	...
	LOC3 = 0;
	LOC3 = noschangeFileExt(LOC2, ((NimStringDesc*) &TMP7617));
	LOC1[0] = torope_143058(LOC3);
	LOC1[1] = gdotgraph_519017;
	LOC4 = 0;
	LOC4 = ropef_143079(((NimStringDesc*) &TMP7616), LOC1, 2);
	nimln(47, "depends.nim");
	LOC5 = 0;
	LOC5 = noschangeFileExt(project, ((NimStringDesc*) &TMP7618));
	writerope_144407(LOC4, LOC5, NIM_FALSE);
	popFrame();
}
N_NIMCALL(void, TMP7619)(void* p, NI op) {
	tgen519012* a;
...
N_NIMCALL(tpasscontext244003*, myopen_519128)(tsym185843* module) {
	...
	g = (tgen519012*) newObj((&NTI519014), sizeof(tgen519012));
	(*g).Sup.Sup.m_type = (&NTI519012);
...
static TNimNode TMP7609[1];
NTI519012.size = sizeof(tgen519012);
NTI519012.kind = 17;
NTI519012.base = (&NTI244003);
TMP7609[0].kind = 1;
TMP7609[0].offset = offsetof(tgen519012, Module);
TMP7609[0].typ = (&NTI185811);
TMP7609[0].name = "module";
NTI519012.node = &TMP7609[0];
NTI519014.size = sizeof(tgen519012*);
NTI519014.kind = 22;
NTI519014.base = (&NTI519012);
NTI519014.marker = TMP7619;
}
