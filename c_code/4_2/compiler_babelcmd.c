...
STRING_LITERAL(TMP1398, "head", 4);
STRING_LITERAL(TMP1401, ".", 1);
STRING_LITERAL(TMP1402, "..", 2);
STRING_LITERAL(TMP1406, ".nim", 4);
...
N_NIMCALL(NIM_BOOL, HEX3CHEX2E_150044)(NimStringDesc* a, NimStringDesc* b) {
	...
	{
		nimln(28, "babelcmd.nim");
		if (!eqStrings(a, ((NimStringDesc*) &TMP1398))) goto LA3;
		nimln(28, "babelcmd.nim");
		nimln(28, "babelcmd.nim");
		result = NIM_FALSE;
		goto BeforeRet;
...
N_NIMCALL(void, addpackage_150103)(tstringtable112610* packages, NimStringDesc* p) {
	...
	nimln(48, "babelcmd.nim");
	TMP1399 = subInt(x, 1);
	name = copyStrLast(p, 0, (NI64)(TMP1399));
	nimln(49, "babelcmd.nim");
	{
		...
		nimln(50, "babelcmd.nim");
		TMP1400 = addInt(x, 1);
		version = copyStr(p, (NI64)(TMP1400));
	...
	LA3: ;
	{
		...
		nstPut(packages, name, ((NimStringDesc*) &TMP1398));	}	LA1: ;
	popFrame();
}
N_NIMCALL(void, addbabelpath_150128)(NimStringDesc* p, tlineinfo136509 info) {
	...
	nimln(1228, "os.nim");
	{
		...
		while (1) {
			...
			nimln(1233, "os.nim");
			{
				...
				nimln(698, "system.nim");
				nimln(698, "system.nim");
				LOC12 = !(eqStrings(y_150158, ((NimStringDesc*) &TMP1401)));
				if (!(LOC12)) goto LA13;
				nimln(698, "system.nim");
				nimln(698, "system.nim");
				LOC12 = !(eqStrings(y_150158, ((NimStringDesc*) &TMP1402)));
				LA13: ;
				if (!LOC12) goto LA14;
				...
				nimln(69, "babelcmd.nim");
				{
					...
					if (!(LOC33)) goto LA34;
					nimln(69, "babelcmd.nim");
					LOC33 = nsuEndsWith(path_150144, ((NimStringDesc*) &TMP1406));
					LA34: ;
					if (!LOC33) goto LA35;
		...
		nimln(1228, "os.nim");
		{
			...
			while (1) {
				...
				nimln(1233, "os.nim");
				{
					...
					nimln(698, "system.nim");
					nimln(698, "system.nim");
					LOC18 = !(eqStrings(y_150172, ((NimStringDesc*) &TMP1401)));
					if (!(LOC18)) goto LA19;
					nimln(698, "system.nim");
					nimln(698, "system.nim");
					LOC18 = !(eqStrings(y_150172, ((NimStringDesc*) &TMP1402)));
					LA19: ;
					if (!LOC18) goto LA20;
...
N_NIMCALL(void, addpathrec_150180)(NimStringDesc* dir, tlineinfo136509 info) {
	...
	nimln(1228, "os.nim");
	{
		...
		while (1) {
			...
			nimln(1233, "os.nim");
			{
				...
				nimln(698, "system.nim");
				nimln(698, "system.nim");
				LOC16 = !(eqStrings(y_150223, ((NimStringDesc*) &TMP1402)));
				LA17: ;
				if (!LOC16) goto LA18;
	...
	while (1) {
		...
		nimln(41, "strtabs.nim");
		{
			...
			{
				nimln(58, "babelcmd.nim");
				if (!eqStrings(val_150231, ((NimStringDesc*) &TMP1398))) goto LA49;
