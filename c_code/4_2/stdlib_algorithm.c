...
typedef N_CLOSURE_PTR(NI, TMP5196) (NimStringDesc* x_330530, NimStringDesc* y_330532);
...
typedef N_CLOSURE_PTR(NI, TMP5200) (Indexentry327126* x_328630, Indexentry327126* y_328632);
...
{	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI)(m + ((NI) 1))], cmp.ClEnv):((TMP5196)(cmp.ClPrc))(a[m], a[(NI)(m + ((NI) 1))]);
		LOC4 = 0;
		LOC4 = HEX2A_325008(LOC3, order);
		if (!(LOC4 <= ((NI) 0))) goto LA5;
		goto BeforeRet;
	...
	k = lo;
	{
		while (1) {
			...
			if (!LOC11) goto LA10;
			{
				...
				NI LOC16;
				LOC15 = 0;
				LOC15 = cmp.ClEnv? cmp.ClPrc(b[i], a[j], cmp.ClEnv):((TMP5197)(cmp.ClPrc))(b[i], a[j]);
				LOC16 = 0;
				LOC16 = HEX2A_325008(LOC15, order);
				if (!(LOC16 <= ((NI) 0))) goto LA17;
				unsureAsgnRef((void**) (&a[k]), b[i]);
