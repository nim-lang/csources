...
N_NIMCALL(void, merge_362843)(tsym191843** a_362851, NI a_362851Len0, tsym191843** b_362859, NI b_362859Len0, NI lo_362863, NI m_362865, NI hi_362867, TY362801 cmp_362875, NU8 order_362878) {
	...
	nimln(101, "algorithm.nim");
	{
		...
		if ((NU)((NI64)(TMP5104)) >= (NU)(a_362851Len0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp_362875.ClEnv? cmp_362875.ClPrc(a_362851[m_362865], a_362851[(NI64)(TMP5104)], cmp_362875.ClEnv):((TMP5105)(cmp_362875.ClPrc))(a_362851[m_362865], a_362851[(NI64)(TMP5104)]);
		LOC4 = 0;
...
N_NIMCALL(void, sort_362782)(tsym191843** a_362790, NI a_362790Len0, TY362801 cmp_362800, NU8 order_362803) {
	...
	nimln(155, "algorithm.nim");
	TMP5101 = divInt(n, 2);
	b = (tsymseq191815*) newSeq((&NTI191815), (NI64)(TMP5101));
	...
	while (1) {
		...
		while (1) {
			...
			nimln(160, "algorithm.nim");
			TMP5108 = subInt(m, s);
			TMP5109 = addInt((NI64)(TMP5108), 1);
			nimln(160, "algorithm.nim");
			TMP5110 = addInt(m, s);
			merge_362843(a_362790, a_362790Len0, b->data, b->Sup.len, (((NI64)(TMP5109) >= 0) ? (NI64)(TMP5109) : 0), m, (NI64)(TMP5110), cmp_362800, order_362803);
			nimln(161, "algorithm.nim");
			nimln(161, "algorithm.nim");
			TMP5111 = mulInt(s, 2);
			m = subInt(m, (NI64)(TMP5111));
		} LA2: ;
...
N_NIMCALL(void, merge_366227)(tentry365566* a_366235, NI a_366235Len0, tentry365566* b_366243, NI b_366243Len0, NI lo_366247, NI m_366249, NI hi_366251, TY366185 cmp_366259, NU8 order_366262) {
	...
	nimln(101, "algorithm.nim");
	{
		...
		if ((NU)((NI64)(TMP5123)) >= (NU)(a_366235Len0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp_366259.ClEnv? cmp_366259.ClPrc(a_366235[m_366249], a_366235[(NI64)(TMP5123)], cmp_366259.ClEnv):((TMP5124)(cmp_366259.ClPrc))(a_366235[m_366249], a_366235[(NI64)(TMP5123)]);
		LOC4 = 0;
...
N_NIMCALL(void, sort_366166)(tentry365566* a_366174, NI a_366174Len0, TY366185 cmp_366184, NU8 order_366187) {
	...
	nimln(155, "algorithm.nim");
	TMP5120 = divInt(n, 2);
	b = (TY365573*) newSeq((&NTI365573), (NI64)(TMP5120));
	nimln(156, "algorithm.nim");
	s = 1;
	nimln(157, "algorithm.nim");
	while (1) {
		...
		while (1) {
			...
			nimln(160, "algorithm.nim");
			TMP5126 = subInt(m, s);
			TMP5127 = addInt((NI64)(TMP5126), 1);
			nimln(160, "algorithm.nim");
			TMP5128 = addInt(m, s);
			merge_366227(a_366174, a_366174Len0, b->data, b->Sup.len, (((NI64)(TMP5127) >= 0) ? (NI64)(TMP5127) : 0), m, (NI64)(TMP5128), cmp_366184, order_366187);
			nimln(161, "algorithm.nim");
			nimln(161, "algorithm.nim");
			TMP5129 = mulInt(s, 2);
			m = subInt(m, (NI64)(TMP5129));
		} LA2: ;
		nimln(162, "algorithm.nim");
		nimln(162, "algorithm.nim");
		TMP5130 = mulInt(s, 2);
