...
STRING_LITERAL(TMP1140, "overflow", 8);
...
N_NIMCALL(NI, rawparseint_86531)(NimStringDesc* s, NI64* b, NI start) {
	...
	nimln(200, "parseutils.nim");
	{
		...
		while (1) {
			...
			TMP1137 = subInt64((NI64)(TMP1135), ((NI64) ((NI64)(TMP1136))));
			(*b) = (NI64)(TMP1137);
...
N_NIMCALL(NI, npuParseBiggestFloat)(NimStringDesc* s, NF* number, NI start) {
	...
	nimln(261, "parseutils.nim");
	{
		...
		nimln(262, "parseutils.nim");
		{
			...
			LOC16 = ((NU8)(s->data[(NI64)(TMP1846)]) == (NU8)(65));
			if (LOC16) goto LA17;
			nimln(262, "parseutils.nim");
			nimln(262, "parseutils.nim");
			TMP1847 = addInt(i, 1);
			if ((NU)((NI64)(TMP1847)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC16 = ((NU8)(s->data[(NI64)(TMP1847)]) == (NU8)(97));
			LA17: ;
			if (!LOC16) goto LA18;
			nimln(263, "parseutils.nim");
			{
				...
				LOC22 = ((NU8)(s->data[(NI64)(TMP1848)]) == (NU8)(78));
				if (LOC22) goto LA23;
				nimln(263, "parseutils.nim");
				nimln(263, "parseutils.nim");
				TMP1849 = addInt(i, 2);
				if ((NU)((NI64)(TMP1849)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC22 = ((NU8)(s->data[(NI64)(TMP1849)]) == (NU8)(110));
				LA23: ;
				if (!LOC22) goto LA24;
				nimln(264, "parseutils.nim");
				{
					...
					if (!!((((NU8)(s->data[(NI64)(TMP1850)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI64)(TMP1850)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI64)(TMP1850)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI64)(TMP1850)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI64)(TMP1850)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI64)(TMP1850)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI64)(TMP1850)])) == ((NU8)(95))))) goto LA28;
	...
	nimln(268, "parseutils.nim");
	{
		...
		nimln(269, "parseutils.nim");
		{
			...
			LOC38 = ((NU8)(s->data[(NI64)(TMP1853)]) == (NU8)(78));
			if (LOC38) goto LA39;
			nimln(269, "parseutils.nim");
			nimln(269, "parseutils.nim");
			TMP1854 = addInt(i, 1);
			if ((NU)((NI64)(TMP1854)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC38 = ((NU8)(s->data[(NI64)(TMP1854)]) == (NU8)(110));
			LA39: ;
			if (!LOC38) goto LA40;
			nimln(270, "parseutils.nim");
			{
				...
				LOC44 = ((NU8)(s->data[(NI64)(TMP1855)]) == (NU8)(70));
				if (LOC44) goto LA45;
				nimln(270, "parseutils.nim");
				nimln(270, "parseutils.nim");
				TMP1856 = addInt(i, 2);
				if ((NU)((NI64)(TMP1856)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC44 = ((NU8)(s->data[(NI64)(TMP1856)]) == (NU8)(102));
				LA45: ;
				if (!LOC44) goto LA46;
				nimln(271, "parseutils.nim");
				{
					...
					if (!!((((NU8)(s->data[(NI64)(TMP1857)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI64)(TMP1857)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI64)(TMP1857)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI64)(TMP1857)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI64)(TMP1857)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI64)(TMP1857)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI64)(TMP1857)])) == ((NU8)(95))))) goto LA50;
					...
					nimln(273, "parseutils.nim");
					TMP1858 = addInt(i, 3);
					TMP1859 = subInt((NI64)(TMP1858), start);
					result = (NI64)(TMP1859);
					goto BeforeRet;
				}
				LA50: ;
	...
	while (1) {
		...
		(*number) = ((NF)(((NF)((*number)) * (NF)(1.0000000000000000e+001))) + (NF)(((double) (((NI) ((NI64)(TMP1860)))))));
	...
	nimln(282, "parseutils.nim");
	{
		...
		while (1) {
			...
			(*number) = ((NF)(((NF)((*number)) * (NF)(1.0000000000000000e+001))) + (NF)(((double) (((NI) ((NI64)(TMP1861)))))));
	...
	nimln(296, "parseutils.nim");
	{
		...
		while (1) {
			...
			nimln(306, "parseutils.nim");
			if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
			TMP1863 = addInt((NI64)(TMP1862), ((NI) (((NU8)(s->data[i])))));
			TMP1864 = subInt((NI64)(TMP1863), 48);
			exponent = (NI64)(TMP1864);
