...
STRING_LITERAL(TMP3441, "method has lock level $1, but another method has $2", 51);
STRING_LITERAL(TMP3449, "method is not a base", 20);
STRING_LITERAL(TMP3450, "no method dispatcher found", 26);
STRING_LITERAL(TMP3451, "invalid declaration order; cannot attach \'", 42);
STRING_LITERAL(TMP3452, "\' to method defined here: ", 26);
STRING_LITERAL(TMP3453, "", 0);
STRING_LITERAL(TMP3454, "cgmeth.genConv: no upcast allowed", 33);
STRING_LITERAL(TMP3455, "cgmeth.genConv: no downcast allowed", 35);
STRING_LITERAL(TMP4479, "and", 3);
STRING_LITERAL(TMP4480, "of", 2);
...
N_NIMCALL(void, fixupdispatcher_374466)(Tsym214822* meth, Tsym214822* disp) {
	...
	LA13: ;
	{
		...
		LOC21 = 0;
		LOC21 = nsuFormatOpenArray(((NimStringDesc*) &TMP3441), LOC20, 2);
...
{	L = (gmethods_374246 ? gmethods_374246->Sup.len : 0);
			...
			while (1) {
				...
				case ((NU8) 2):
				{
					...
					checkmethodeffects_346842(disp, s);
					{
						...
						LA10: ;
						if (!LOC9) goto LA11;
						localerror_187085((*s).info, ((NimStringDesc*) &TMP3449));
					}
					LA11: ;
					goto BeforeRet;
				}
	...
	++gmethods_374246->Sup.len;
	{
		...
		internalerror_187100((*s).info, ((NimStringDesc*) &TMP3450));
	}
	LA23: ;
	{
		NimStringDesc* LOC29;
...
appendString(LOC29, ((NimStringDesc*) &TMP3451));
...
appendString(LOC29, LOC30);
	...
	LA27: ;
	{
		...
		message_187095((*s).info, ((NU16) 252), ((NimStringDesc*) &TMP3453));
	}
	goto LA25;
	LA32: ;
	LA25: ;
	...
	source = skiptypes_218113((*n).typ, IL64(211106247256320));
	{
		...
		LA9: ;
		{
			...
			addson_216807(result, n);
			{
				...
				internalerror_187100((*n).info, ((NimStringDesc*) &TMP3454));
			}
			LA16: ;
		}
		goto LA7;
...
N_NIMCALL(Tsym214822*, gendispatcher_375010)(Tsymseq214792* methods, Intset211035* relevantcols) {
	...
	ands = getsyssym_258041(((NimStringDesc*) &TMP4479));
	iss = getsyssym_258041(((NimStringDesc*) &TMP4480));
	{
		NI meth_375035;
		NI HEX3Atmp_375144;
		NI res_375147;
