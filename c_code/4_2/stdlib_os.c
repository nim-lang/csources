...
STRING_LITERAL(TMP1232, "/path/a.out", 11);
...
N_NIMCALL(void, rawcreatedir_127630)(NimStringDesc* dir) {
	{
		...
		raiseoserror_120803(LOC10, ((NimStringDesc*) &TMP146));
	}
	LA8: ;
}
			...
			if (!!((d_127621 == NIM_NIL))) goto LA4;
			{
				while (1) {
					...
					y_127625 = cstrToNimstr(((NCSTRING) ((*x_127623).d_name)));
					{
						...
						NU8 k_127629;
						LOC14 = 0;
						LOC14 = !(eqStrings(y_127625, ((NimStringDesc*) &TMP3667)));
						if (!(LOC14)) goto LA15;
