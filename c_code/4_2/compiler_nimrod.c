...
N_NIMCALL(void, handlecmdline_423603)(void) {
	...
	{
		nimln(39, "nimrod.nim");
		processcmdline_418207(((NU8) 0), ((NimStringDesc*) &TMP7233));		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP7234;
			TY102259 p;
			NimStringDesc* LOC15;
		...
		nimln(50, "nimrod.nim");
		loadconfigs_167607(((NimStringDesc*) &TMP7235));		nimln(53, "nimrod.nim");
		initvars_147647();		nimln(54, "nimrod.nim");
		processcmdline_418207(((NU8) 1), ((NimStringDesc*) &TMP7233));		nimln(55, "nimrod.nim");
