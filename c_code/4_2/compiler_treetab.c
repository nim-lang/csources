...
N_NIMCALL(NI, nodetablerawget_342156_1142335848)(Tnodetable292862 t0, NI k0, Tnode292802* key0);
N_NIMCALL(NIM_BOOL, treesequivalent_342073_1142335848)(Tnode292802* a0, Tnode292802* b0);
...
N_NIMCALL(void, nodetablerawinsert_342186_1142335848)(Tnodepairseq292860** data0, NI k0, Tnode292802* key0, NI val0);
	...
	{
		{
			...
			NI HEX3Atmp_342066_1142335848;
			NI LOC30;
			NI res_342069_1142335848;
			i_342058_1142335848 = (NI)0;
			HEX3Atmp_342066_1142335848 = (NI)0;
			LOC30 = (NI)0;
			LOC30 = sonslen_295351_850551059(n0);
			HEX3Atmp_342066_1142335848 = (NI)(LOC30 - ((NI) 1));
			res_342069_1142335848 = ((NI) 0);
			{
				while (1) {
					NI LOC33;
					if (!(res_342069_1142335848 <= HEX3Atmp_342066_1142335848)) goto LA32;
					i_342058_1142335848 = res_342069_1142335848;
					LOC33 = (NI)0;
		...
		{
			{
				...
				{
					NI i_342145_1142335848;
					NI HEX3Atmp_342149_1142335848;
					NI LOC26;
					NI res_342152_1142335848;
					i_342145_1142335848 = (NI)0;
					HEX3Atmp_342149_1142335848 = (NI)0;
					LOC26 = (NI)0;
					LOC26 = sonslen_295351_850551059(a0);
					HEX3Atmp_342149_1142335848 = (NI)(LOC26 - ((NI) 1));
					res_342152_1142335848 = ((NI) 0);
					{
						while (1) {
							if (!(res_342152_1142335848 <= HEX3Atmp_342149_1142335848)) goto LA28;
							i_342145_1142335848 = res_342152_1142335848;
							{
								NIM_BOOL LOC31;
								LOC31 = (NIM_BOOL)0;
								LOC31 = treesequivalent_342073_1142335848((*a0).kindU.S6.sons->data[i_342145_1142335848], (*b0).kindU.S6.sons->data[i_342145_1142335848]);
								if (!!(LOC31)) goto LA32;
								goto BeforeRet;
							}
							LA32: ;
							res_342152_1142335848 += ((NI) 1);
						} LA28: ;
					}
				}
				result0 = NIM_TRUE;
	...
	h0 = (NI)(k0 & (t0.data ? (t0.data->Sup.len-1) : -1));
	{
		while (1) {
			if (!!((t0.data->data[h0].key == NIM_NIL))) goto LA2;
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = treesequivalent_342073_1142335848(t0.data->data[h0].key, key0);
				LA6: ;
				if (!LOC5) goto LA7;
				result0 = h0;
				goto BeforeRet;
...
N_NIMCALL(NI, nodetabletestorset_342682_1142335848)(Tnodetable292862* t0, Tnode292802* key0, NI val0) {
	...
	index0 = nodetablerawget_342156_1142335848((*t0), k0, key0);
	{
	...
	LA3: ;
	{
				...
				res_342878_1142335848 = ((NI) 0);
				{
					while (1) {
						...
						i_342838_1142335848 = res_342878_1142335848;
						{
							...
							nodetablerawinsert_342186_1142335848((&n0), (*t0).data->data[i_342838_1142335848].h, (*t0).data->data[i_342838_1142335848].key, (*t0).data->data[i_342838_1142335848].val);
						}
						LA16: ;
		...
		LA9: ;
		nodetablerawinsert_342186_1142335848((&(*t0).data), k0, key0, val0);
		result0 = val0;
		(*t0).counter += ((NI) 1);
	}
	LA1: ;
