...
static N_INLINE(NIM_BOOL, mustrehash_168054)(NI length, NI counter) {
	...
	LOC5 = ((NI64)(TMP1912) < (NI64)(TMP1913));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
...
static N_INLINE(NI, nexttry_168205)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1915 = mulInt(5, h);
	TMP1916 = addInt((NI64)(TMP1915), 1);
	result = (NI)((NI64)(TMP1916) & maxhash);
	popFrame();
	return result;
}
N_NIMCALL(ttrunk168039*, intsetget_168212)(tintset168043* t, NI key) {
...
N_NIMCALL(void, intsetenlarge_168604)(tintset168043* t) {
	...
	TMP1920 = mulInt((NI64)(TMP1919), 2);
	TMP1921 = subInt((NI64)(TMP1920), 1);
	(*t).Max = (NI64)(TMP1921);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1922 = addInt((*t).Max, 1);
	n = (ttrunkseq168041*) newSeq((&NTI168041), (NI64)(TMP1922));
	i_168629 = 0;
...
N_NIMCALL(ttrunk168039*, intsetput_168661)(tintset168043* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_168054((NI64)(TMP1926), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
...
TMP1923[0] = &TMP1909[1];
TMP1909[1].kind = 1;
TMP1909[1].offset = offsetof(ttrunk168039, Next);
TMP1909[1].typ = (&NTI168037);
TMP1909[1].name = "next";
TMP1923[1] = &TMP1909[2];
TMP1909[2].kind = 1;
TMP1909[2].offset = offsetof(ttrunk168039, Key);
TMP1909[2].typ = (&NTI105);
TMP1909[2].name = "key";
TMP1923[2] = &TMP1909[3];
TMP1909[3].kind = 1;
TMP1909[3].offset = offsetof(ttrunk168039, Bits);
TMP1909[3].typ = (&NTI21418);
TMP1909[3].name = "bits";
TMP1909[0].len = 3; TMP1909[0].kind = 2; TMP1909[0].sons = &TMP1923[0];
NTI168039.node = &TMP1909[0];
NTI168037.size = sizeof(ttrunk168039*);
NTI168037.kind = 22;
NTI168037.base = (&NTI168039);
NTI168037.marker = TMP1924;
NTI168041.size = sizeof(ttrunkseq168041*);
NTI168041.kind = 24;
NTI168041.base = (&NTI168037);
NTI168041.flags = 2;
NTI168041.marker = TMP1925;
...
TMP3349[0] = &TMP1909[5];
TMP1909[5].kind = 1;
TMP1909[5].offset = offsetof(tintset168043, Counter);
TMP1909[5].typ = (&NTI105);
TMP1909[5].name = "counter";
TMP3349[1] = &TMP1909[6];
TMP1909[6].kind = 1;
TMP1909[6].offset = offsetof(tintset168043, Max);
TMP1909[6].typ = (&NTI105);
TMP1909[6].name = "max";
TMP3349[2] = &TMP1909[7];
TMP1909[7].kind = 1;
TMP1909[7].offset = offsetof(tintset168043, Head);
TMP1909[7].typ = (&NTI168037);
TMP1909[7].name = "head";
TMP3349[3] = &TMP1909[8];
TMP1909[8].kind = 1;
TMP1909[8].offset = offsetof(tintset168043, Data);
TMP1909[8].typ = (&NTI168041);
TMP1909[8].name = "data";
TMP1909[4].len = 4; TMP1909[4].kind = 2; TMP1909[4].sons = &TMP3349[0];
NTI168043.node = &TMP1909[4];
}
