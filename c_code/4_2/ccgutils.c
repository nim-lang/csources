...
static N_INLINE(ttype191847*, lastson_192203)(ttype191847* n) {
	...
	if ((NU)((NI64)(TMP6201)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP6201)];
	popFrame();
	return result;
}
...
N_NIMCALL(trope148007*, makellvmstring_469723)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(190, "ccgutils.nim");
		{
			...
			TMP6211 = modInt((NI64)(TMP6210), 64);
			if (!(((NI) ((NI64)(TMP6211))) == 0)) goto LA4;
