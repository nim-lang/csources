...
static N_INLINE(ttype185847*, lastson_186203)(ttype185847* n) {
	...
	if ((NU)((NI64)(TMP6195)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP6195)];
	popFrame();
	return result;
}
...
N_NIMCALL(trope143007*, makellvmstring_463684)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(169, "ccgutils.nim");
		{
			...
			TMP6201 = modInt((NI64)(TMP6200), 64);
			if (!(((NI) ((NI64)(TMP6201))) == 0)) goto LA4;
