...
STRING_LITERAL(TMP2064, "NAN", 3);
STRING_LITERAL(TMP2065, "0.0", 3);
STRING_LITERAL(TMP2066, "INF", 3);
STRING_LITERAL(TMP2067, "-INF", 4);
STRING_LITERAL(TMP2074, "", 0);
STRING_LITERAL(TMP2080, "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", 62);
STRING_LITERAL(TMP2088, "contains({\'a\'..\'z\', \'A\'..\'Z\', \'0\'..\'9\', \'-\', \'\\x80\'..\'\\xFF\'}, s"
"[i]) ", 68);
...
N_NIMCALL(void, encodestr_177029)(NimStringDesc* s, NimStringDesc** result) {
	...
	nimln(29, "rodutils.nim");
	nimln(29, "rodutils.nim");
	TMP2068 = subInt(s->Sup.len, 1);
	HEX3Atmp_177051 = (NI64)(TMP2068);
...
N_NIMCALL(void, hexchar_177058)(NIM_CHAR c, NI* xi) {
	...
	case 48 ... 57:
	{
		...
		nimln(36, "rodutils.nim");
		nimln(36, "rodutils.nim");
		TMP2069 = subInt(((NI) (((NU8)(c)))), 48);
		(*xi) = (NI)((NI)((NU64)((*xi)) << (NU64)(4)) | ((NI) ((NI64)(TMP2069))));
	}	break;
	case 97 ... 102:
	{
		NI TMP2070;
		...
		nimln(37, "rodutils.nim");
		nimln(37, "rodutils.nim");
		TMP2070 = subInt(((NI) (((NU8)(c)))), 97);
		TMP2071 = addInt(((NI) ((NI64)(TMP2070))), 10);
...
N_NIMCALL(NimStringDesc*, decodestr_177114)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 92:
		{
			...
			nimln(49, "rodutils.nim");
			TMP2075 = subInt(i, 2);
			hexchar_177058(s[(NI64)(TMP2075)], &xi);			nimln(50, "rodutils.nim");
			nimln(50, "rodutils.nim");
			TMP2076 = subInt(i, 1);
			hexchar_177058(s[(NI64)(TMP2076)], &xi);			nimln(51, "rodutils.nim");
...
N_NIMCALL(void, encodevbiggestintaux_177161)(NI64 x, NimStringDesc** result) {
	...
	nimln(70, "rodutils.nim");
	TMP2077 = modInt64(v_177169, 190);
	rem_177171 = (NI64)(TMP2077);
	nimln(71, "rodutils.nim");
	{
		...
		if ((NI64)(TMP2078) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	...
	LA3: ;
	{
		...
		nimln(76, "rodutils.nim");
		TMP2079 = divInt64(v_177169, 190);
		v_177169 = (NI64)(TMP2079);
	}	LA1: ;
	...
	nimln(78, "rodutils.nim");
	{
		...
		nimln(78, "rodutils.nim");
		if ((NU)(idx_177173) > (NU)(((NimStringDesc*) &TMP2080)->Sup.len)) raiseIndexError();
		d_177167 = ((NimStringDesc*) &TMP2080)->data[idx_177173];
	}	goto LA6;
	LA8: ;
	{
		NI TMP2081;
		...
		nimln(79, "rodutils.nim");
		nimln(79, "rodutils.nim");
		TMP2081 = subInt(idx_177173, 62);
		TMP2082 = addInt((NI64)(TMP2081), 128);
		d_177167 = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP2082), 0, 255))));
	}	LA6: ;
...
N_NIMCALL(void, encodevintaux_177193)(NI x, NimStringDesc** result) {
	...
	nimln(70, "rodutils.nim");
	nimln(70, "rodutils.nim");
	TMP2083 = modInt(v_177201, 190);
	rem_177203 = (NI64)(TMP2083);
	nimln(71, "rodutils.nim");
	{
		NI TMP2084;
		nimln(71, "rodutils.nim");
		...
		if ((NI64)(TMP2084) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
		v_177201 = ((NI64)-((NI64)(TMP2084)));
		nimln(74, "rodutils.nim");
		nimln(74, "rodutils.nim");
	...
	LA3: ;
	{
		...
		nimln(76, "rodutils.nim");
		nimln(76, "rodutils.nim");
		TMP2085 = divInt(v_177201, 190);
		v_177201 = (NI64)(TMP2085);
	}	LA1: ;
	nimln(77, "rodutils.nim");
	...
	nimln(78, "rodutils.nim");
	{
		...
		nimln(78, "rodutils.nim");
		if ((NU)(idx_177205) > (NU)(((NimStringDesc*) &TMP2080)->Sup.len)) raiseIndexError();
		d_177199 = ((NimStringDesc*) &TMP2080)->data[idx_177205];
	}	goto LA6;
	LA8: ;
	{
		NI TMP2086;
		...
		nimln(79, "rodutils.nim");
		nimln(79, "rodutils.nim");
		TMP2086 = subInt(idx_177205, 62);
		TMP2087 = addInt((NI64)(TMP2086), 128);
		d_177199 = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP2087), 0, 255))));
	}	LA6: ;
	nimln(80, "rodutils.nim");
	{
		nimln(698, "system.nim");
...
N_NIMCALL(NI, decodevint_177239)(NCSTRING s, NI* pos) {
	...
	nimln(103, "rodutils.nim");
	{
		...
		nimln(103, "rodutils.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP2088));	}	LA3: ;
	...
	while (1) {
		...
		case 48 ... 57:
		{
			...
			nimln(110, "rodutils.nim");
			nimln(110, "rodutils.nim");
			TMP2089 = mulInt(result, 190);
			nimln(110, "rodutils.nim");
			nimln(110, "rodutils.nim");
			TMP2090 = subInt(((NI) (((NU8)(s[i_177246])))), 48);
			TMP2091 = subInt((NI64)(TMP2089), ((NI) ((NI64)(TMP2090))));
			result = (NI64)(TMP2091);
		}		break;
		case 97 ... 122:
		{
			...
			nimln(111, "rodutils.nim");
			nimln(111, "rodutils.nim");
			TMP2092 = mulInt(result, 190);
			nimln(111, "rodutils.nim");
			nimln(111, "rodutils.nim");
			nimln(111, "rodutils.nim");
			TMP2093 = subInt(((NI) (((NU8)(s[i_177246])))), 97);
			TMP2094 = addInt(((NI) ((NI64)(TMP2093))), 10);
			TMP2095 = subInt((NI64)(TMP2092), ((NI) ((NI64)(TMP2094))));
			result = (NI64)(TMP2095);
		}		break;
		case 65 ... 90:
		{
			...
			nimln(112, "rodutils.nim");
			nimln(112, "rodutils.nim");
			TMP2096 = mulInt(result, 190);
			nimln(112, "rodutils.nim");
			nimln(112, "rodutils.nim");
			nimln(112, "rodutils.nim");
			TMP2097 = subInt(((NI) (((NU8)(s[i_177246])))), 65);
			TMP2098 = addInt(((NI) ((NI64)(TMP2097))), 36);
			TMP2099 = subInt((NI64)(TMP2096), ((NI) ((NI64)(TMP2098))));
			result = (NI64)(TMP2099);
		}		break;
		case 128 ... 255:
		{
			...
			nimln(113, "rodutils.nim");
			nimln(113, "rodutils.nim");
			TMP2100 = mulInt(result, 190);
			nimln(113, "rodutils.nim");
			nimln(113, "rodutils.nim");
			nimln(113, "rodutils.nim");
			TMP2101 = subInt(((NI) (((NU8)(s[i_177246])))), 128);
			TMP2102 = addInt(((NI) ((NI64)(TMP2101))), 62);
			TMP2103 = subInt((NI64)(TMP2100), ((NI) ((NI64)(TMP2102))));
			result = (NI64)(TMP2103);
		}		break;
		default:
		{
	...
	nimln(116, "rodutils.nim");
	nimln(116, "rodutils.nim");
	TMP2104 = mulInt(result, sign_177248);
	result = (NI)((NU64)((NI64)(TMP2104)) - (NU64)(5));
...
N_NIMCALL(NI64, decodevbiggestint_177495)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 48 ... 57:
		{
			...
			nimln(110, "rodutils.nim");
			nimln(110, "rodutils.nim");
			TMP2105 = mulInt64(result, 190);
			nimln(110, "rodutils.nim");
			nimln(110, "rodutils.nim");
			TMP2106 = subInt(((NI) (((NU8)(s[i_177502])))), 48);
			TMP2107 = subInt64((NI64)(TMP2105), ((NI64) ((NI64)(TMP2106))));
			result = (NI64)(TMP2107);
		}		break;
		case 97 ... 122:
		{
			...
			nimln(111, "rodutils.nim");
			nimln(111, "rodutils.nim");
			TMP2108 = mulInt64(result, 190);
			nimln(111, "rodutils.nim");
			nimln(111, "rodutils.nim");
			nimln(111, "rodutils.nim");
			TMP2109 = subInt(((NI) (((NU8)(s[i_177502])))), 97);
			TMP2110 = addInt(((NI) ((NI64)(TMP2109))), 10);
			TMP2111 = subInt64((NI64)(TMP2108), ((NI64) ((NI64)(TMP2110))));
			result = (NI64)(TMP2111);
		}		break;
		case 65 ... 90:
		{
			...
			nimln(112, "rodutils.nim");
			nimln(112, "rodutils.nim");
			TMP2112 = mulInt64(result, 190);
			nimln(112, "rodutils.nim");
			nimln(112, "rodutils.nim");
			nimln(112, "rodutils.nim");
			TMP2113 = subInt(((NI) (((NU8)(s[i_177502])))), 65);
			TMP2114 = addInt(((NI) ((NI64)(TMP2113))), 36);
			TMP2115 = subInt64((NI64)(TMP2112), ((NI64) ((NI64)(TMP2114))));
			result = (NI64)(TMP2115);
		}		break;
		case 128 ... 255:
		{
			...
			nimln(113, "rodutils.nim");
			nimln(113, "rodutils.nim");
			TMP2116 = mulInt64(result, 190);
			nimln(113, "rodutils.nim");
			nimln(113, "rodutils.nim");
			nimln(113, "rodutils.nim");
			TMP2117 = subInt(((NI) (((NU8)(s[i_177502])))), 128);
			TMP2118 = addInt(((NI) ((NI64)(TMP2117))), 62);
			TMP2119 = subInt64((NI64)(TMP2116), ((NI64) ((NI64)(TMP2118))));
			result = (NI64)(TMP2119);
		}		break;
		default:
		{
	...
	nimln(116, "rodutils.nim");
	nimln(116, "rodutils.nim");
	TMP2120 = mulInt64(result, ((NI64) (sign_177504)));
	result = (NI64)((NU64)((NI64)(TMP2120)) - (NU64)(5));
	nimln(117, "rodutils.nim");
	(*pos) = i_177502;
	popFrame();
	return result;
