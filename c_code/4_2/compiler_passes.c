...
static NIM_CONST TY171865 TMP3126 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3127, "sons", 4);
...
N_NIMCALL(NIM_BOOL, astneeded_222081)(tsym171689* s) {
	...
	nimln(73, "passes.nim");
	{
		...
		if (!(LOC3)) goto LA8;
		nimln(76, "passes.nim");
		if (((TMP3126[(*(*s).Ast).Kind/8] &(1<<((*(*s).Ast).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3127));
...
static N_INLINE(NI, sonslen_172022)(tnode171659* n) {
	...
	{
		nimln(1209, "ast.nim");
		if (((TMP3126[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3127));
...
N_NIMCALL(void, processmodule_222049)(tsym171689* module, tllstream161204* stream, trodreader211023* rd) {
	...
	LA3: ;
	{
		...
		TMP3134 = subInt(LOC34, 1);
		HEX3Atmp_222577 = (NI64)(TMP3134);
		nimln(1301, "system.nim");
		res_222579 = 0;
		nimln(1302, "system.nim");
		while (1) {
...
static TNimNode TMP3014[1];
NTI222003.size = sizeof(tpasscontext222003);
NTI222003.kind = 17;
NTI222003.base = (&NTI1009);
NTI222003.flags = 3;
TMP3014[0].kind = 1;
TMP3014[0].offset = offsetof(tpasscontext222003, Fromcache);
TMP3014[0].typ = (&NTI133);
TMP3014[0].name = "fromCache";
NTI222003.node = &TMP3014[0];
}
