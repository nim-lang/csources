...
N_NIMCALL(void, fillbuffer_290071)(tbaselexer290016* l) {
	...
	nimln(77, "lexbase.nim");
	{
		...
		nimln(77, "lexbase.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP4631));	}	LA3: ;
	nimln(78, "lexbase.nim");
	nimln(78, "lexbase.nim");
	nimln(78, "lexbase.nim");
	TMP4632 = subInt((*l).Buflen, (*l).Sentinel);
	TMP4633 = subInt((NI64)(TMP4632), 1);
	tocopy = (NI64)(TMP4633);
	nimln(79, "lexbase.nim");
	{
		...
		nimln(79, "lexbase.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP4634));	}	LA7: ;
	nimln(80, "lexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP4635)])), (NI64)(TMP4636));	}	LA11: ;
	...
	TMP4638 = mulInt((NI64)(TMP4637), 1);
	LOC13 = 0;
	LOC13 = readdata_142731((*l).Input, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP4638));
	TMP4639 = divInt(LOC13, 1);
	charsread = (NI64)(TMP4639);
	...
	nimln(86, "lexbase.nim");
	{
		...
		if (!(charsread < (NI64)(TMP4641))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			nimln(93, "lexbase.nim");
			{
				...
				nimln(93, "lexbase.nim");
				hiddenraiseassert_76017(((NimStringDesc*) &TMP4642));			}			LA22: ;
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI64)(TMP4643);
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				TMP4644 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4007(((void*) ((*l).Buf)), (NI64)(TMP4644));
				...
				nimln(105, "lexbase.nim");
				{
					...
					if (!!(((NI64)(TMP4645) == oldbuflen))) goto LA35;
					nimln(105, "lexbase.nim");
					hiddenraiseassert_76017(((NimStringDesc*) &TMP4646));				}				LA35: ;
				...
				LOC37 = 0;
				LOC37 = readdata_142731((*l).Input, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP4647));
				TMP4648 = divInt(LOC37, 1);
				charsread = (NI64)(TMP4648);
...
N_NIMCALL(NI, fillbaselexer_290812)(tbaselexer290016* l, NI pos) {
	...
	nimln(115, "lexbase.nim");
	{
		...
		nimln(115, "lexbase.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP4652));	}	LA3: ;
...
N_NIMCALL(void, open_290026)(tbaselexer290016* l, tstream142629* input, NI buflen) {
	...
	nimln(143, "lexbase.nim");
	{
		...
		nimln(143, "lexbase.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP4657));	}	LA7: ;
	...
	LOC9 = 0;
	LOC9 = alloc_4001((NI64)(TMP4658));
	(*l).Buf = ((NCSTRING) (LOC9));
	nimln(148, "lexbase.nim");
	nimln(148, "lexbase.nim");
	TMP4659 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP4659);
...
N_NIMCALL(NI, getcolnumber_290044)(tbaselexer290016* l, NI pos) {
	...
	if ((NI64)(TMP4660) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP4660));
	popFrame();
	return result;
}
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src) {
...
TMP4770[0] = &TMP4629[1];
TMP4629[1].kind = 1;
TMP4629[1].offset = offsetof(tbaselexer290016, Bufpos);
TMP4629[1].typ = (&NTI105);
TMP4629[1].name = "bufpos";
TMP4770[1] = &TMP4629[2];
TMP4629[2].kind = 1;
TMP4629[2].offset = offsetof(tbaselexer290016, Buf);
TMP4629[2].typ = (&NTI144);
TMP4629[2].name = "buf";
TMP4770[2] = &TMP4629[3];
TMP4629[3].kind = 1;
TMP4629[3].offset = offsetof(tbaselexer290016, Buflen);
TMP4629[3].typ = (&NTI105);
TMP4629[3].name = "bufLen";
TMP4770[3] = &TMP4629[4];
TMP4629[4].kind = 1;
TMP4629[4].offset = offsetof(tbaselexer290016, Input);
TMP4629[4].typ = (&NTI142627);
TMP4629[4].name = "input";
TMP4770[4] = &TMP4629[5];
TMP4629[5].kind = 1;
TMP4629[5].offset = offsetof(tbaselexer290016, Linenumber);
TMP4629[5].typ = (&NTI105);
TMP4629[5].name = "LineNumber";
TMP4770[5] = &TMP4629[6];
TMP4629[6].kind = 1;
TMP4629[6].offset = offsetof(tbaselexer290016, Sentinel);
TMP4629[6].typ = (&NTI105);
TMP4629[6].name = "sentinel";
TMP4770[6] = &TMP4629[7];
TMP4629[7].kind = 1;
TMP4629[7].offset = offsetof(tbaselexer290016, Linestart);
TMP4629[7].typ = (&NTI105);
TMP4629[7].name = "lineStart";
TMP4770[7] = &TMP4629[8];
TMP4629[8].kind = 1;
TMP4629[8].offset = offsetof(tbaselexer290016, Fileopened);
TMP4629[8].typ = (&NTI133);
TMP4629[8].name = "fileOpened";
TMP4629[0].len = 8; TMP4629[0].kind = 2; TMP4629[0].sons = &TMP4770[0];
NTI290016.node = &TMP4629[0];
}
