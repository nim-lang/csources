...
N_NIMCALL(void, undefsymbol_141011)(NimStringDesc* symbol) {
	...
	nstPut(gsymbols_141003, symbol, ((NimStringDesc*) &TMP895));	popFrame();
}
static N_INLINE(NIM_BOOL, eqStrings)(NimStringDesc* a, NimStringDesc* b) {
	NIM_BOOL result;
	NIM_BOOL LOC11;
...
N_NIMCALL(NI, countdefinedsymbols_141041)(void) {
	...
	while (1) {
		...
		nimln(41, "strtabs.nim");
		{
			...
			{
				nimln(38, "condsyms.nim");
				if (!eqStrings(val_141045, ((NimStringDesc*) &TMP894))) goto LA8;
				nimln(38, "condsyms.nim");
...
N_NIMCALL(void, initdefines_141065)(void) {
	...
	definesymbol_141006(((NimStringDesc*) &TMP896));	nimln(44, "condsyms.nim");
	definesymbol_141006(((NimStringDesc*) &TMP897));	nimln(45, "condsyms.nim");
	definesymbol_141006(((NimStringDesc*) &TMP898));	nimln(46, "condsyms.nim");
	definesymbol_141006(((NimStringDesc*) &TMP899));	nimln(47, "condsyms.nim");
	definesymbol_141006(((NimStringDesc*) &TMP900));	nimln(48, "condsyms.nim");
	definesymbol_141006(((NimStringDesc*) &TMP901));	nimln(49, "condsyms.nim");
	definesymbol_141006(((NimStringDesc*) &TMP902));	nimln(52, "condsyms.nim");
	...
	case ((NU8) 2):
	{
		...
		definesymbol_141006(((NimStringDesc*) &TMP907));		nimln(62, "condsyms.nim");
	...
	case ((NU8) 20):
	{
		...
		definesymbol_141006(((NimStringDesc*) &TMP909));		nimln(67, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP910));	}	break;
	case ((NU8) 7):
	{
		nimln(69, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP911));		nimln(70, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP909));		nimln(71, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP910));	}	break;
	case ((NU8) 9):
	case ((NU8) 10):
	case ((NU8) 11):
	{
		...
		definesymbol_141006(((NimStringDesc*) &TMP909));		nimln(74, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP912));		nimln(75, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP910));	}	break;
	case ((NU8) 18):
	{
	...
	case ((NU8) 19):
	{
		...
		definesymbol_141006(((NimStringDesc*) &TMP913));		nimln(80, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP909));		nimln(81, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP910));	}	break;
	default:
	{
	}	break;
...
appendString(LOC13, LOC14);
	...
	definesymbol_141006(os_119061[(targetos_119562)- 1].Field0);	nimln(87, "condsyms.nim");
	{
		...
		definesymbol_141006(((NimStringDesc*) &TMP915));	}	LA18: ;
	popFrame();
