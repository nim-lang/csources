...
NIM_CONST TY197015 parsernames_197014 = {((NimStringDesc*) &TMP2616),
...
N_NIMCALL(tnode171659*, parseall_197046)(tparsers197026* p) {
	...
	case ((NU8) 2):
	{
		...
		internalerror_138383(((NimStringDesc*) &TMP2627));		nimln(63, "syntaxes.nim");
...
N_NIMCALL(tnode171659*, parsetoplevelstmt_197051)(tparsers197026* p) {
	...
	case ((NU8) 2):
	{
		...
		internalerror_138383(((NimStringDesc*) &TMP2627));		nimln(74, "syntaxes.nim");
		result = emptynode_172505;
	}	break;
	}
	popFrame();
...
N_NIMCALL(NIM_BOOL, containsshebang_197097)(NimStringDesc* s, NI i) {
	...
	nimln(84, "syntaxes.nim");
	{
		...
		nimln(84, "syntaxes.nim");
		TMP2628 = addInt(i, 1);
		if ((NU)((NI64)(TMP2628)) > (NU)(s->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(s->data[(NI64)(TMP2628)]) == (NU8)(33));
		LA4: ;
		if (!LOC3) goto LA5;
...
N_NIMCALL(tnode171659*, parsepipe_197126)(NimStringDesc* filename, tllstream161204* inputstream) {
	...
	nimln(92, "syntaxes.nim");
	{
		...
		nimln(99, "syntaxes.nim");
		{
			...
			nimln(99, "syntaxes.nim");
			TMP2630 = addInt(i, 1);
			if ((NU)((NI64)(TMP2630)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC14 = ((NU8)(line->data[(NI64)(TMP2630)]) == (NU8)(33));
			LA15: ;
			if (!LOC14) goto LA16;
...
N_NIMCALL(tllstream161204*, evalpipe_197391)(tparsers197026* p, tnode171659* n, NimStringDesc* filename, tllstream161204* start) {
	...
	nimln(152, "syntaxes.nim");
	{
		...
		if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP2633[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2634));
		LOC7 = identeq_140456((*(*n).kindU.S6.Sons->data[0]).kindU.S5.Ident, ((NimStringDesc*) &TMP2635));
		LA10: ;
		if (!LOC7) goto LA11;
		i_197465 = 0;
		nimln(1301, "system.nim");
...
NTI197005.node = &TMP2252[5];
TMP2252[1].kind = 1;
TMP2252[1].offset = offsetof(tparsers197026, Skin);
TMP2252[1].typ = (&NTI197005);
TMP2252[1].name = "skin";
TMP2623[1] = &TMP2252[6];
TMP2252[6].kind = 1;
TMP2252[6].offset = offsetof(tparsers197026, Parser);
TMP2252[6].typ = (&NTI185203);
TMP2252[6].name = "parser";
TMP2252[0].len = 2; TMP2252[0].kind = 2; TMP2252[0].sons = &TMP2623[0];
NTI197026.node = &TMP2252[0];
}
