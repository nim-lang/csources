...
N_NIMCALL(void, enlarge_123081)(tstringtable122810* t) {
	...
	n = (tkeyvaluepairseq122808*) newSeq((&NTI122808), (NI64)(TMP287));
	i_123124 = 0;
	HEX3Atmp_123142 = 0;
...
NTI122808.flags = 2;
NTI122808.marker = TMP289;
NTI122810.size = sizeof(tstringtable122810);
NTI122810.kind = 17;
NTI122810.base = (&NTI2409);
TMP294[0] = &TMP266[1];
TMP266[1].kind = 1;
TMP266[1].offset = offsetof(tstringtable122810, Counter);
TMP266[1].typ = (&NTI106);
TMP266[1].name = "counter";
TMP294[1] = &TMP266[2];
TMP266[2].kind = 1;
TMP266[2].offset = offsetof(tstringtable122810, Data);
TMP266[2].typ = (&NTI122808);
TMP266[2].name = "data";
TMP294[2] = &TMP266[3];
...
NTI122804.node = &TMP266[7];
TMP266[3].kind = 1;
TMP266[3].offset = offsetof(tstringtable122810, Mode);
TMP266[3].typ = (&NTI122804);
TMP266[3].name = "mode";
TMP266[0].len = 3; TMP266[0].kind = 2; TMP266[0].sons = &TMP294[0];
NTI122810.node = &TMP266[0];
NTI122812.size = sizeof(tstringtable122810*);
NTI122812.kind = 22;
NTI122812.base = (&NTI122810);
NTI122812.marker = TMP298;
}
