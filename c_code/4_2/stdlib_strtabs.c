...
STRING_LITERAL(TMP1882, "format string: key not found: ", 30);
...
N_NIMCALL(NimStringDesc*, nstGet)(Stringtableobj133012* t, NimStringDesc* key) {
	...
	LA3: ;
	{
		result = copyString(((NimStringDesc*) &TMP1433));
	}
	LA1: ;
	return result;
}
...
appendString(LOC1, ((NimStringDesc*) &TMP1882));
appendString(LOC1, s);
