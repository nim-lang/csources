...
static NIM_CONST TY171865 TMP5590 = {
...
static N_INLINE(ttype171693*, lastson_172034)(ttype171693* n) {
	...
	if ((NU)((NI64)(TMP5596)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP5596)];
	popFrame();
	return result;
}
N_NIMCALL(ttype171693*, getuniquetype_366401)(ttype171693* key) {
	...
	case ((NU8) 12):
	{
		...
		internalerror_138383(((NimStringDesc*) &TMP5595));	}	break;
	case ((NU8) 11):
	case ((NU8) 13):
	case ((NU8) 15):
	case ((NU8) 47):
...
N_NIMCALL(trope121007*, makellvmstring_366621)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(170, "ccgutils.nim");
		{
			...
			nimln(170, "ccgutils.nim");
			nimln(170, "ccgutils.nim");
			TMP5600 = addInt(i_366636, 1);
			TMP5601 = modInt((NI64)(TMP5600), 64);
			if (!(((NI) ((NI64)(TMP5601))) == 0)) goto LA4;
