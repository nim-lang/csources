...
N_NIMCALL(void, fillbuffer_162072)(tbaselexer162018* l) {
	...
	nimln(85, "nimlexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP1623)])), (NI64)(TMP1624));	}	LA11: ;
	...
	TMP1626 = mulInt((NI64)(TMP1625), 1);
	LOC13 = 0;
	LOC13 = llstreamread_161242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP1626));
	TMP1627 = divInt(LOC13, 1);
	charsread = (NI64)(TMP1627);
	...
	nimln(91, "nimlexbase.nim");
	{
		...
		if (!(charsread < (NI64)(TMP1629))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI64)(TMP1631);
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				TMP1632 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4007(((void*) ((*l).Buf)), (NI64)(TMP1632));
				...
				nimln(110, "nimlexbase.nim");
				{
					...
					if (!!(((NI64)(TMP1633) == oldbuflen))) goto LA35;
					nimln(110, "nimlexbase.nim");
				...
				LOC37 = 0;
				LOC37 = llstreamread_161242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP1635));
				TMP1636 = divInt(LOC37, 1);
				charsread = (NI64)(TMP1636);
...
N_NIMCALL(void, openbaselexer_162027)(tbaselexer162018* l, tllstream161204* inputstream, NI buflen) {
	...
	LOC5 = 0;
	LOC5 = alloc_4001((NI64)(TMP1645));
	(*l).Buf = ((NCSTRING) (LOC5));
	nimln(151, "nimlexbase.nim");
	nimln(151, "nimlexbase.nim");
	TMP1646 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP1646);
...
N_NIMCALL(NI, getcolnumber_162045)(tbaselexer162018* l, NI pos) {
	...
	if ((NI64)(TMP1647) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP1647));
	popFrame();
	return result;
}
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src) {
...
TMP1888[0] = &TMP1594[1];
TMP1594[1].kind = 1;
TMP1594[1].offset = offsetof(tbaselexer162018, Bufpos);
TMP1594[1].typ = (&NTI105);
TMP1594[1].name = "bufpos";
TMP1888[1] = &TMP1594[2];
TMP1594[2].kind = 1;
TMP1594[2].offset = offsetof(tbaselexer162018, Buf);
TMP1594[2].typ = (&NTI144);
TMP1594[2].name = "buf";
TMP1888[2] = &TMP1594[3];
TMP1594[3].kind = 1;
TMP1594[3].offset = offsetof(tbaselexer162018, Buflen);
TMP1594[3].typ = (&NTI105);
TMP1594[3].name = "bufLen";
TMP1888[3] = &TMP1594[4];
TMP1594[4].kind = 1;
TMP1594[4].offset = offsetof(tbaselexer162018, Stream);
TMP1594[4].typ = (&NTI161206);
TMP1594[4].name = "stream";
TMP1888[4] = &TMP1594[5];
TMP1594[5].kind = 1;
TMP1594[5].offset = offsetof(tbaselexer162018, Linenumber);
TMP1594[5].typ = (&NTI105);
TMP1594[5].name = "LineNumber";
TMP1888[5] = &TMP1594[6];
TMP1594[6].kind = 1;
TMP1594[6].offset = offsetof(tbaselexer162018, Sentinel);
TMP1594[6].typ = (&NTI105);
TMP1594[6].name = "sentinel";
TMP1888[6] = &TMP1594[7];
TMP1594[7].kind = 1;
TMP1594[7].offset = offsetof(tbaselexer162018, Linestart);
TMP1594[7].typ = (&NTI105);
TMP1594[7].name = "lineStart";
TMP1594[0].len = 7; TMP1594[0].kind = 2; TMP1594[0].sons = &TMP1888[0];
NTI162018.node = &TMP1594[0];
}
