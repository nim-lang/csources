...
N_NIMCALL(NI, send_526677)(Socketimpl522404* socket, void* data, NI size);
...
N_NIMCALL(NI, waitfor_525806)(Socketimpl522404* socket, NF* waited, NI timeout, NI size, NimStringDesc* funcname);
...
STRING_LITERAL(TMP5279, "No valid socket error code available", 36);
STRING_LITERAL(TMP5280, "Could not send all data.", 24);
STRING_LITERAL(TMP5283, "Call to \'", 9);
STRING_LITERAL(TMP5284, "\' timed out.", 12);
STRING_LITERAL(TMP5286, "readLine", 8);
STRING_LITERAL(TMP5287, "\015\012", 2);
...
N_NIMCALL(Socketimpl522404*, newsocket_522821)(NU8 domain, NU8 socktype, NU8 protocol, NIM_BOOL buffered) {
	...
	fd = newnativesocket_517001(domain, socktype, protocol);
	{
		...
		raiseoserror_120803(LOC5, ((NimStringDesc*) &TMP5276));
	}
	LA3: ;
...
N_NIMCALL(void, bindaddr_523608)(Socketimpl522404* socket, NU16 port, NimStringDesc* address) {
	{
		...
		name.sin_addr.s_addr = ntohl_517806(INADDR_ANY);
		{
			...
			raiseoserror_120803(LOC10, ((NimStringDesc*) &TMP5276));
		}
		LA8: ;
	}
	goto LA1;
	LA3: ;
	{
		...
		ailist = getaddrinfo_517402(address, port, (*socket).domain, ((NU8) 1), ((NU8) 6));
		{
			...
			raiseoserror_120803(LOC17, ((NimStringDesc*) &TMP5276));
		}
		LA15: ;
		dealloc_517802(ailist);
	}
...
N_NIMCALL(void, listen_523604)(Socketimpl522404* socket, int backlog) {
	{
		...
		raiseoserror_120803(LOC6, ((NimStringDesc*) &TMP5276));
	}
	LA4: ;
}
...
N_NIMCALL(NI32, getsocketerror_523001)(Socketimpl522404* socket) {
	...
	LA3: ;
	{
		...
		raiseoserror_120803(result, ((NimStringDesc*) &TMP5279));
	}
	LA7: ;
	return result;
}
...
{	{
		...
		LA7: ;
		{
			...
			LA20: ;
			{
				raiseoserror_120803(laste, ((NimStringDesc*) &TMP5276));
			}
			LA16: ;
		}
		goto LA12;
...
N_NIMCALL(void, send_527202)(Socketimpl522404* socket, NimStringDesc* data, NU8 flags) {
	NI sent;
{	sent = send_526677(socket, ((void*) (data->data)), (data ? data->Sup.len : 0));
	{
		NI32 lasterror;
	...
	LA3: ;
	{
		...
		raiseoserror_120803(LOC14, ((NimStringDesc*) &TMP5280));
	}
	LA12: ;
	}BeforeRet: ;
}
...
N_NIMCALL(void, acceptaddr_523808)(Socketimpl522404* server, Socketimpl522404** client, NimStringDesc** address, NU8 flags) {
	...
	sock = accept((*server).fd, ((struct sockaddr*) ((&sockaddress))), (&addrlen));
	{
		...
		LA8: ;
		raiseoserror_120803(err, ((NimStringDesc*) &TMP5276));
	}
	goto LA1;
	LA3: ;
	{
...
N_NIMCALL(void, accept_524401)(Socketimpl522404* server, Socketimpl522404** client, NU8 flags) {
	...
	addrdummy = copyString(((NimStringDesc*) &TMP5276));
...
appendString(LOC22, ((NimStringDesc*) &TMP5283));
...
appendString(LOC22, ((NimStringDesc*) &TMP5284));
		...
		selret = select_525201(socket, (NI)(timeout - ((NI) (((NF)((*waited)) * (NF)(1.0000000000000000e+03))))));
		{
			...
			raiseoserror_120803(LOC27, ((NimStringDesc*) &TMP5276));
		}
		LA25: ;
		{
...
appendString(LOC32, ((NimStringDesc*) &TMP5283));
...
{	waited = 0.0;
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_525806(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5286));
			...
			LA4: ;
			{
				...
				LOC20 = 0;
				LOC20 = waitfor_525806(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5286));
...
appendString((*line), ((NimStringDesc*) &TMP5287));
				}
				LA38: ;
				goto BeforeRet;
			}
...
N_NIMCALL(void, close_524411)(Socketimpl522404* socket) {
	TSafePoint TMP5288;
	pushSafePoint(&TMP5288);
	TMP5288.status = _setjmp(TMP5288.context);
	if (TMP5288.status == 0) {
		popSafePoint();
	}
	else {
...
TMP1189[3].len = 3; TMP1189[3].kind = 2; TMP1189[3].sons = &TMP5260[0];
