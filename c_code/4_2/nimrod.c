...
STRING_LITERAL(TMP7783, "./", 2);
STRING_LITERAL(TMP7784, "", 0);
STRING_LITERAL(TMP7786, "nimrod.cfg", 10);
STRING_LITERAL(TMP7787, "js", 2);
STRING_LITERAL(TMP7788, "node ", 5);
...
appendString(LOC7, ((NimStringDesc*) &TMP7783));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
N_NIMCALL(void, handlecmdline_535603)(void) {
	...
	{
		nimln(39, "nimrod.nim");
		processcmdline_529207(((NU8) 0), ((NimStringDesc*) &TMP7784));
		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP7785;
			TY109700 p;
			...
			nimln(41, "nimrod.nim");
			pushSafePoint(&TMP7785);
			TMP7785.status = setjmp(TMP7785.context);
			if (TMP7785.status == 0) {
				nimln(42, "nimrod.nim");
			...
			if (TMP7785.status != 0) reraiseException();
			nimln(45, "nimrod.nim");
			chckNil((void*)&p);
		...
		LA7: ;
		nimln(50, "nimrod.nim");
		loadconfigs_187607(((NimStringDesc*) &TMP7786));
		nimln(53, "nimrod.nim");
		initvars_172714();
		nimln(54, "nimrod.nim");
		processcmdline_529207(((NU8) 1), ((NimStringDesc*) &TMP7784));
		nimln(55, "nimrod.nim");
		maincommand_533011();
		nimln(56, "nimrod.nim");
		{
			...
			nimln(62, "nimrod.nim");
			{
				...
				nimln(63, "nimrod.nim");
				{
					...
					LA37: ;
					{
						...
						nimln(69, "nimrod.nim");
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_138208, ((NimStringDesc*) &TMP7787));
						LOC42 = 0;
...
appendString(LOC44, ((NimStringDesc*) &TMP7788));
...
appendString(LOC44, arguments_529205);
				...
				LA33: ;
				{
					...
					LA48: ;
					{
						...
						nimln(78, "nimrod.nim");
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_138208, ((NimStringDesc*) &TMP7784));
