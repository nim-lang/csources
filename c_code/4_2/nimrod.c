...
STRING_LITERAL(TMP7784, "./", 2);
STRING_LITERAL(TMP7785, "", 0);
STRING_LITERAL(TMP7787, "nimrod.cfg", 10);
STRING_LITERAL(TMP7788, "js", 2);
STRING_LITERAL(TMP7789, "node ", 5);
...
extern NimStringDesc* arguments_523205;
...
appendString(LOC7, ((NimStringDesc*) &TMP7784));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
N_NIMCALL(void, handlecmdline_529603)(void) {
	...
	{
		nimln(39, "nimrod.nim");
		processcmdline_523207(((NU8) 0), ((NimStringDesc*) &TMP7785));
		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP7786;
			TY108700 p;
			...
			nimln(41, "nimrod.nim");
			pushSafePoint(&TMP7786);
			TMP7786.status = setjmp(TMP7786.context);
			if (TMP7786.status == 0) {
				nimln(42, "nimrod.nim");
			...
			if (TMP7786.status != 0) reraiseException();
			nimln(45, "nimrod.nim");
			chckNil((void*)&p);
		...
		LA7: ;
		nimln(50, "nimrod.nim");
		loadconfigs_181607(((NimStringDesc*) &TMP7787));
		nimln(53, "nimrod.nim");
		initvars_167714();
		nimln(54, "nimrod.nim");
		processcmdline_523207(((NU8) 1), ((NimStringDesc*) &TMP7785));
		nimln(55, "nimrod.nim");
		maincommand_527011();
		nimln(56, "nimrod.nim");
		{
		...
		{
			nimln(58, "nimrod.nim");
			if (!(gerrorcounter_162179 == 0)) goto LA25;
			nimln(62, "nimrod.nim");
			{
				nimln(62, "nimrod.nim");
				...
				nimln(63, "nimrod.nim");
				{
					...
					LA37: ;
					{
						...
						nimln(69, "nimrod.nim");
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_135208, ((NimStringDesc*) &TMP7788));
						LOC42 = 0;
...
appendString(LOC44, ((NimStringDesc*) &TMP7789));
...
appendString(LOC44, arguments_523205);
				...
				LA33: ;
				{
					...
					LA48: ;
					{
						...
						nimln(78, "nimrod.nim");
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_135208, ((NimStringDesc*) &TMP7785));
...
N_NOINLINE(void, nimrodInit)(void) {
	...
	initdefines_166072();
	nimln(91, "nimrod.nim");
	handlecmdline_529603();
	nimln(92, "nimrod.nim");
	nimln(92, "nimrod.nim");
	exit(((NI) (((NI8) ((0 < gerrorcounter_162179))))));
	popFrame();
}
