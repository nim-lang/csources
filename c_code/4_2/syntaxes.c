...
STRING_LITERAL(TMP1310, "none", 4);
STRING_LITERAL(TMP1311, "stdtmpl", 7);
STRING_LITERAL(TMP1312, "replace", 7);
STRING_LITERAL(TMP1313, "strip", 5);
NIM_CONST TY258026 filternames_258025 = {((NimStringDesc*) &TMP1310),
((NimStringDesc*) &TMP1311),
((NimStringDesc*) &TMP1312),
((NimStringDesc*) &TMP1313)}
;
STRING_LITERAL(TMP1314, "standard", 8);
STRING_LITERAL(TMP1315, "strongspaces", 12);
STRING_LITERAL(TMP1316, "braces", 6);
STRING_LITERAL(TMP1317, "endx", 4);
NIM_CONST TY258020 parsernames_258019 = {((NimStringDesc*) &TMP1314),
((NimStringDesc*) &TMP1315),
((NimStringDesc*) &TMP1316),
((NimStringDesc*) &TMP1317)}
;
STRING_LITERAL(TMP1348, "parser to implement", 19);
...
N_NIMCALL(tllstream211204*, evalpipe_258546)(tparsers258035* p, tnode224819* n, NimStringDesc* filename, tllstream211204* start) {
	...
	LA3: ;
	{
		...
		LOC7 = LOC8;
		if (!(LOC7)) goto LA10;
		LOC7 = identeq_200493((*(*n).kindU.S6.Sons->data[0]).kindU.S5.Ident, ((NimStringDesc*) &TMP1201));
		LA10: ;
		if (!LOC7) goto LA11;
		{
			NI i_258635;
...
N_NIMCALL(tnode224819*, parseall_258063)(tparsers258035* p) {
	...
	case ((NU8) 3):
	{
		internalerror_197989(((NimStringDesc*) &TMP1348));
		result = emptynode_225738;
	}
	break;
	}
