...
N_NIMCALL(NIM_BOOL, containsshebang_224100)(NimStringDesc* s, NI i) {
	...
	nimln(83, "syntaxes.nim");
	{
		...
		nimln(83, "syntaxes.nim");
		TMP2707 = addInt(i, 1);
		if ((NU)((NI64)(TMP2707)) > (NU)(s->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(s->data[(NI64)(TMP2707)]) == (NU8)(33));
		LA4: ;
		if (!LOC3) goto LA5;
...
N_NIMCALL(tnode191813*, parsepipe_224138)(NimStringDesc* filename, tllstream179204* inputstream) {
	...
	nimln(91, "syntaxes.nim");
	{
		...
		nimln(98, "syntaxes.nim");
		{
			...
			nimln(98, "syntaxes.nim");
			TMP2709 = addInt(i, 1);
			if ((NU)((NI64)(TMP2709)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC14 = ((NU8)(line->data[(NI64)(TMP2709)]) == (NU8)(33));
			LA15: ;
			if (!LOC14) goto LA16;
