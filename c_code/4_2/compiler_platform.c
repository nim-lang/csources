...
STRING_LITERAL(TMP384, "DOS", 3);
STRING_LITERAL(TMP385, "..", 2);
STRING_LITERAL(TMP386, "$1.dll", 6);
STRING_LITERAL(TMP387, "/", 1);
STRING_LITERAL(TMP388, ".obj", 4);
STRING_LITERAL(TMP389, "\015\012", 2);
STRING_LITERAL(TMP390, ";", 1);
STRING_LITERAL(TMP391, "\\", 1);
STRING_LITERAL(TMP392, ".bat", 4);
STRING_LITERAL(TMP393, ".", 1);
STRING_LITERAL(TMP394, ".exe", 4);
STRING_LITERAL(TMP395, "Windows", 7);
STRING_LITERAL(TMP396, "OS2", 3);
STRING_LITERAL(TMP397, "Linux", 5);
STRING_LITERAL(TMP398, "lib$1.so", 8);
STRING_LITERAL(TMP399, ".o", 2);
STRING_LITERAL(TMP400, "\012", 1);
STRING_LITERAL(TMP401, ":", 1);
STRING_LITERAL(TMP402, ".sh", 3);
STRING_LITERAL(TMP403, "", 0);
STRING_LITERAL(TMP404, "MorphOS", 7);
STRING_LITERAL(TMP405, "SkyOS", 5);
STRING_LITERAL(TMP406, "Solaris", 7);
STRING_LITERAL(TMP407, "Irix", 4);
STRING_LITERAL(TMP408, "NetBSD", 6);
STRING_LITERAL(TMP409, "FreeBSD", 7);
STRING_LITERAL(TMP410, "OpenBSD", 7);
STRING_LITERAL(TMP411, "AIX", 3);
STRING_LITERAL(TMP412, "PalmOS", 6);
STRING_LITERAL(TMP413, "QNX", 3);
STRING_LITERAL(TMP414, "Amiga", 5);
STRING_LITERAL(TMP415, "$1.library", 10);
STRING_LITERAL(TMP416, "Atari", 5);
STRING_LITERAL(TMP417, ".tpp", 4);
STRING_LITERAL(TMP418, "Netware", 7);
STRING_LITERAL(TMP419, "$1.nlm", 6);
STRING_LITERAL(TMP420, ".nlm", 4);
STRING_LITERAL(TMP421, "MacOS", 5);
STRING_LITERAL(TMP422, "::", 2);
STRING_LITERAL(TMP423, "$1Lib", 5);
STRING_LITERAL(TMP424, "\015", 1);
STRING_LITERAL(TMP425, ",", 1);
STRING_LITERAL(TMP426, "MacOSX", 6);
STRING_LITERAL(TMP427, "lib$1.dylib", 11);
STRING_LITERAL(TMP428, "Haiku", 5);
STRING_LITERAL(TMP429, "JS", 2);
STRING_LITERAL(TMP430, "NimrodVM", 8);
STRING_LITERAL(TMP431, "Standalone", 10);
NIM_CONST TY119062 os_119061 = {{((NimStringDesc*) &TMP384),
...
;
STRING_LITERAL(TMP432, "littleEndian", 12);
STRING_LITERAL(TMP433, "bigEndian", 9);
NIM_CONST TY119456 endiantostr_119455 = {((NimStringDesc*) &TMP432),
((NimStringDesc*) &TMP433)}
;
STRING_LITERAL(TMP434, "i386", 4);
STRING_LITERAL(TMP435, "m68k", 4);
STRING_LITERAL(TMP436, "alpha", 5);
STRING_LITERAL(TMP437, "powerpc", 7);
STRING_LITERAL(TMP438, "powerpc64", 9);
STRING_LITERAL(TMP439, "sparc", 5);
STRING_LITERAL(TMP440, "vm", 2);
STRING_LITERAL(TMP441, "ia64", 4);
STRING_LITERAL(TMP442, "amd64", 5);
STRING_LITERAL(TMP443, "mips", 4);
STRING_LITERAL(TMP444, "arm", 3);
STRING_LITERAL(TMP445, "js", 2);
STRING_LITERAL(TMP446, "nimrodvm", 8);
STRING_LITERAL(TMP447, "avr", 3);
NIM_CONST TY119461 cpu_119460 = {{((NimStringDesc*) &TMP434),
32,
((NU8) 0),
64,
32}
...
;
STRING_LITERAL(TMP448, "not (c == cpuNone) ", 19);
STRING_LITERAL(TMP449, "not (o == osNone) ", 18);
STRING_LITERAL(TMP453, "solaris", 7);
...
N_NIMCALL(void, settarget_119586)(NU8 o, NU8 c) {
	...
	nimln(198, "platform.nim");
	{
		...
		if (!!(!((c == ((NU8) 0))))) goto LA3;
		nimln(198, "platform.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP448));	}	LA3: ;
	nimln(199, "platform.nim");
	{
		...
		if (!!(!((o == ((NU8) 0))))) goto LA7;
		nimln(199, "platform.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP449));	}	LA7: ;
	...
	TMP450 = divInt(cpu_119460[(c)- 1].Field1, 8);
	intsize_119577 = (NI64)(TMP450);
	nimln(204, "platform.nim");
	nimln(204, "platform.nim");
	if (c < 1 || c > 14) raiseIndexError();
	TMP451 = divInt(cpu_119460[(c)- 1].Field3, 8);
	floatsize_119578 = (NI64)(TMP451);
	nimln(205, "platform.nim");
	nimln(205, "platform.nim");
	if (c < 1 || c > 14) raiseIndexError();
	TMP452 = divInt(cpu_119460[(c)- 1].Field4, 8);
	ptrsize_119579 = (NI64)(TMP452);
...
N_NIMCALL(NU8, nametocpu_119573)(NimStringDesc* name) {
	...
	hostos_119563 = nametoos_119569(((NimStringDesc*) &TMP453));
