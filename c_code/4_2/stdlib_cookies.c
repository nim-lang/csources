...
N_NIMCALL(NimStringDesc*, setcookie_333117)(NimStringDesc* key, NimStringDesc* value, ttimeinfo94003* expires, NimStringDesc* domain, NimStringDesc* path, NIM_BOOL noname);
...
N_NIMCALL(tstringtable120810*, parsecookies_333012)(NimStringDesc* s) {
	...
	while (1) {
		...
		TMP4685 = subInt(i, 1);
		LOC16 = 0;
		LOC16 = copyStrLast(s, valstart, (NI64)(TMP4685));
...
N_NIMCALL(NimStringDesc*, setcookie_333117)(NimStringDesc* key, NimStringDesc* value, ttimeinfo94003* expires, NimStringDesc* domain, NimStringDesc* path, NIM_BOOL noname) {
	...
	LOC1 = 0;
	LOC1 = format_95999(expires, ((NimStringDesc*) &TMP4692));
	result = setcookie_333106(key, value, domain, path, LOC1, noname);
	goto BeforeRet;
	BeforeRet: ;
	popFrame();
	return result;
