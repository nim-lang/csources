...
typedef N_CLOSURE_PTR(NI, TMP4978) (tsym171689* x, tsym171689* y);
...
typedef N_CLOSURE_PTR(NI, TMP4997) (tentry321943 x, tentry321943 y);
typedef N_CLOSURE_PTR(NI, TMP4998) (tentry321943 x, tentry321943 y);
struct TNimObject {
TNimType* m_type;
};
struct tidobj140011 {
...
static N_INLINE(NI, HEX2A_317040)(NI x, NU8 order) {
	...
	nimln(21, "algorithm.nim");
	nimln(21, "algorithm.nim");
	TMP4970 = subInt(((NI) (order)), 1);
	y = (NI64)(TMP4970);
	nimln(22, "algorithm.nim");
	nimln(22, "algorithm.nim");
	nimln(22, "algorithm.nim");
	TMP4971 = subInt((NI)(x ^ ((NI) (y))), ((NI) (y)));
	result = (NI64)(TMP4971);
	popFrame();
	return result;
}
...
N_NIMCALL(void, merge_319761)(tsym171689** a, NI aLen0, tsym171689** b, NI bLen0, NI lo, NI m, NI hi, TY319724 cmp, NU8 order) {
	...
	nimln(71, "algorithm.nim");
	{
		...
		nimln(71, "algorithm.nim");
		TMP4977 = addInt(m, 1);
		if ((NU)((NI64)(TMP4977)) >= (NU)(aLen0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI64)(TMP4977)], cmp.ClEnv) : ((TMP4978)(cmp.ClPrc))(a[m], a[(NI64)(TMP4977)]);
		LOC4 = 0;
	...
	nimln(74, "algorithm.nim");
	{
		...
		if (!!((j <= m))) goto LA9;
		nimln(74, "algorithm.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP4979));	}	LA9: ;
	...
	while (1) {
		...
		nimln(88, "algorithm.nim");
		{
			...
			if ((NU)(j) >= (NU)(aLen0)) raiseIndexError();
			LOC17 = 0;
			LOC17 = cmp.ClEnv? cmp.ClPrc(b[i], a[j], cmp.ClEnv) : ((TMP4980)(cmp.ClPrc))(b[i], a[j]);
			LOC18 = 0;
...
N_NIMCALL(void, sort_319717)(tsym171689** a, NI aLen0, TY319724 cmp, NU8 order) {
	...
	nimln(125, "algorithm.nim");
	TMP4974 = divInt(n, 2);
	b = (tsymseq171661*) newSeq((&NTI171661), (NI64)(TMP4974));
	...
	while (1) {
		...
		while (1) {
			...
			nimln(130, "algorithm.nim");
			TMP4981 = subInt(m, s);
			TMP4982 = addInt((NI64)(TMP4981), 1);
			nimln(130, "algorithm.nim");
			TMP4983 = addInt(m, s);
			merge_319761(a, aLen0, b->data, b->Sup.len, (((NI64)(TMP4982) >= 0) ? (NI64)(TMP4982) : 0), m, (NI64)(TMP4983), cmp, order);			nimln(131, "algorithm.nim");
			nimln(131, "algorithm.nim");
			TMP4984 = mulInt(s, 2);
			m = subInt(m, (NI64)(TMP4984));
		} LA2: ;
...
N_NIMCALL(void, merge_322468)(tentry321943* a, NI aLen0, tentry321943* b, NI bLen0, NI lo, NI m, NI hi, TY322431 cmp, NU8 order) {
	...
	nimln(71, "algorithm.nim");
	{
		...
		nimln(71, "algorithm.nim");
		TMP4996 = addInt(m, 1);
		if ((NU)((NI64)(TMP4996)) >= (NU)(aLen0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI64)(TMP4996)], cmp.ClEnv) : ((TMP4997)(cmp.ClPrc))(a[m], a[(NI64)(TMP4996)]);
		LOC4 = 0;
		LOC4 = HEX2A_317040(LOC3, order);
		if (!(LOC4 <= 0)) goto LA5;
		nimln(71, "algorithm.nim");
	...
	while (1) {
		...
		nimln(88, "algorithm.nim");
		{
			...
			if ((NU)(j) >= (NU)(aLen0)) raiseIndexError();
			LOC17 = 0;
			LOC17 = cmp.ClEnv? cmp.ClPrc(b[i], a[j], cmp.ClEnv) : ((TMP4998)(cmp.ClPrc))(b[i], a[j]);
			LOC18 = 0;
			LOC18 = HEX2A_317040(LOC17, order);
			if (!(LOC18 <= 0)) goto LA19;
			nimln(64, "algorithm.nim");
...
N_NIMCALL(void, sort_322424)(tentry321943* a, NI aLen0, TY322431 cmp, NU8 order) {
	...
	nimln(125, "algorithm.nim");
	TMP4993 = divInt(n, 2);
	b = (TY321950*) newSeq((&NTI321950), (NI64)(TMP4993));
	nimln(126, "algorithm.nim");
	s = 1;
	nimln(127, "algorithm.nim");
	while (1) {
		...
		while (1) {
			...
			nimln(130, "algorithm.nim");
			TMP4999 = subInt(m, s);
			TMP5000 = addInt((NI64)(TMP4999), 1);
			nimln(130, "algorithm.nim");
			TMP5001 = addInt(m, s);
			merge_322468(a, aLen0, b->data, b->Sup.len, (((NI64)(TMP5000) >= 0) ? (NI64)(TMP5000) : 0), m, (NI64)(TMP5001), cmp, order);			nimln(131, "algorithm.nim");
			nimln(131, "algorithm.nim");
			TMP5002 = mulInt(s, 2);
			m = subInt(m, (NI64)(TMP5002));
		} LA2: ;
		nimln(132, "algorithm.nim");
		nimln(132, "algorithm.nim");
		TMP5003 = mulInt(s, 2);
