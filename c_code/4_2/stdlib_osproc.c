...
N_NIMCALL(void, execcmdex_131002)(NimStringDesc* command, NU8 options, TY131008* Result);
static NIM_CONST TY123387 TMP328 = {
...
static NIM_CONST TY123387 TMP335 = {
0x00, 0x00, 0x00, 0x00, 0x20, 0xE8, 0xFF, 0x27,
0xFF, 0xFF, 0xFF, 0x87, 0xFE, 0xFF, 0xFF, 0x07,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
...
" it", 130);
NIM_CONST TY131008 TMP391 = {((NimStringDesc*) &TMP360),
-1}
;
...
appendString(result, backslashbuff);
		...
		nimln(2807, "system.nim");
		{
			...
			nimln(2807, "system.nim");
			failedassertimpl_80421(((NimStringDesc*) &TMP332));
		}
		LA22: ;
	} LA7: ;
	nimln(78, "osproc.nim");
...
N_NIMCALL(NI, nospexecProcesses)(NimStringDesc** cmds, NI cmdsLen0, NU8 options_128008, NI n) {
	...
	nimln(276, "osproc.nim");
	{
		...
		if (!!((0 < n))) goto LA3;
		nimln(276, "osproc.nim");
		failedassertimpl_80421(((NimStringDesc*) &TMP348));
	}
	LA3: ;
...
N_NIMCALL(NCSTRING*, envtocstringarray_128841)(void) {
	...
	nimln(1181, "os.nim");
	nimln(1181, "os.nim");
	HEX3Atmp_128888 = (environment_111806->Sup.len-1);
	nimln(1458, "system.nim");
	res_128890 = 0;
	nimln(1459, "system.nim");
	while (1) {
		...
		i_128886 = res_128890;
		nimln(1182, "os.nim");
		if ((NU)(i_128886) >= (NU)(environment_111806->Sup.len)) raiseIndexError();
		p_128892 = nsuFindChar(environment_111806->data[i_128886], 61, 0);
		nimln(1183, "os.nim");
		nimln(1183, "os.nim");
		if ((NU)(i_128886) >= (NU)(environment_111806->Sup.len)) raiseIndexError();
		nimln(1183, "os.nim");
		TMP367 = subInt(p_128892, 1);
		key_128845 = copyStrLast(environment_111806->data[i_128886], 0, (NI64)(TMP367));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_128886) >= (NU)(environment_111806->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP368 = addInt(p_128892, 1);
		val_128846 = copyStr(environment_111806->data[i_128886], (NI64)(TMP368));
	...
	nimln(1181, "os.nim");
	nimln(1181, "os.nim");
	HEX3Atmp_128904 = (environment_111806->Sup.len-1);
	nimln(1458, "system.nim");
	res_128906 = 0;
	nimln(1459, "system.nim");
	while (1) {
		...
		i_128902 = res_128906;
		nimln(1182, "os.nim");
		if ((NU)(i_128902) >= (NU)(environment_111806->Sup.len)) raiseIndexError();
		p_128908 = nsuFindChar(environment_111806->data[i_128902], 61, 0);
		nimln(1183, "os.nim");
		nimln(1183, "os.nim");
		if ((NU)(i_128902) >= (NU)(environment_111806->Sup.len)) raiseIndexError();
		nimln(1183, "os.nim");
		TMP371 = subInt(p_128908, 1);
		key_128865 = copyStrLast(environment_111806->data[i_128902], 0, (NI64)(TMP371));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_128902) >= (NU)(environment_111806->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP372 = addInt(p_128908, 1);
		val_128866 = copyStr(environment_111806->data[i_128902], (NI64)(TMP372));
...
N_NIMCALL(tprocess127402*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, tstringtable122810* env, NU8 options) {
	...
	nimln(643, "osproc.nim");
	{
		...
		nimln(646, "osproc.nim");
		{
			...
			nimln(646, "osproc.nim");
			failedassertimpl_80421(((NimStringDesc*) &TMP380));
		}
		LA27: ;
	}
	goto LA17;
...
N_NIMCALL(void, createfdset_130602)(fd_set* fd, TY128403* s, NI* m) {
	...
	while (1) {
		...
		nimln(2798, "system.nim");
		{
			...
			nimln(2798, "system.nim");
			failedassertimpl_80421(((NimStringDesc*) &TMP386));
		}
		LA4: ;
	} LA1: ;
	popFrame();
...
TMP349[0] = &TMP313[1];
TMP313[1].kind = 1;
TMP313[1].offset = offsetof(tprocess127402, Inhandle);
TMP313[1].typ = (&NTI10208);
TMP313[1].name = "inHandle";
TMP349[1] = &TMP313[2];
TMP313[2].kind = 1;
TMP313[2].offset = offsetof(tprocess127402, Outhandle);
TMP313[2].typ = (&NTI10208);
TMP313[2].name = "outHandle";
TMP349[2] = &TMP313[3];
TMP313[3].kind = 1;
TMP313[3].offset = offsetof(tprocess127402, Errhandle);
TMP313[3].typ = (&NTI10208);
TMP313[3].name = "errHandle";
TMP349[3] = &TMP313[4];
TMP313[4].kind = 1;
TMP313[4].offset = offsetof(tprocess127402, Instream);
TMP313[4].typ = (&NTI125627);
TMP313[4].name = "inStream";
TMP349[4] = &TMP313[5];
TMP313[5].kind = 1;
TMP313[5].offset = offsetof(tprocess127402, Outstream);
TMP313[5].typ = (&NTI125627);
TMP313[5].name = "outStream";
TMP349[5] = &TMP313[6];
TMP313[6].kind = 1;
TMP313[6].offset = offsetof(tprocess127402, Errstream);
TMP313[6].typ = (&NTI125627);
TMP313[6].name = "errStream";
TMP349[6] = &TMP313[7];
TMP313[7].kind = 1;
TMP313[7].offset = offsetof(tprocess127402, Id);
TMP313[7].typ = (&NTI98457);
TMP313[7].name = "id";
TMP349[7] = &TMP313[8];
TMP313[8].kind = 1;
TMP313[8].offset = offsetof(tprocess127402, Exitcode);
TMP313[8].typ = (&NTI4409);
TMP313[8].name = "exitCode";
TMP313[0].len = 8; TMP313[0].kind = 2; TMP313[0].sons = &TMP349[0];
NTI127402.node = &TMP313[0];
NTI127404.size = sizeof(tprocess127402*);
NTI127404.kind = 22;
NTI127404.base = (&NTI127402);
NTI127404.marker = TMP351;
NTI128403.size = sizeof(TY128403*);
NTI128403.kind = 24;
NTI128403.base = (&NTI127404);
NTI128403.marker = TMP352;
}
