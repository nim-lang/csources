...
STRING_LITERAL(TMP333, "nimcache", 8);
STRING_LITERAL(TMP340, "lib", 3);
STRING_LITERAL(TMP341, "src", 3);
STRING_LITERAL(TMP342, "source", 6);
STRING_LITERAL(TMP343, "package", 7);
STRING_LITERAL(TMP344, "pckg", 4);
STRING_LITERAL(TMP345, "library", 7);
STRING_LITERAL(TMP346, "private", 7);
STRING_LITERAL(TMP347, "\012", 1);
STRING_LITERAL(TMP351, "cannot create directory: ", 25);
STRING_LITERAL(TMP353, "nim", 3);
STRING_LITERAL(TMP359, "not (\'\\0\' == sep) ", 18);
static NIM_CONST TY113118 TMP362 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x43, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP364, "true", 4);
...
N_NIMCALL(NimStringDesc*, removetrailingdirsep_114410)(NimStringDesc* path) {
	...
	nimln(205, "options.nim");
	{
		...
		if ((NU)((NI64)(TMP330)) > (NU)(path->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(path->data[(NI64)(TMP330)]) == (NU8)(47));
		LA4: ;
		if (!LOC3) goto LA5;
		...
		nimln(206, "options.nim");
		nimln(206, "options.nim");
		TMP331 = subInt(path->Sup.len, 2);
		result = copyStrLast(path, 0, (NI64)(TMP331));
	}	goto LA1;
	LA5: ;
	{
...
N_NIMCALL(NimStringDesc*, getgeneratedpath_114417)(void) {
	...
	LA3: ;
	{
		...
		result = HEX2F_102067(LOC6, ((NimStringDesc*) &TMP333));
	}	LA1: ;
	popFrame();
	return result;
}
...
N_NIMCALL(NimStringDesc*, getpackagename_114423)(NimStringDesc* path) {
	...
	nimln(217, "options.nim");
	{
		...
		if (!(((NU8)(path->data[(NI64)(TMP334)])) == ((NU8)(47)) || ((NU8)(path->data[(NI64)(TMP334)])) == ((NU8)(47)))) goto LA3;
		nimln(217, "options.nim");
		q = 2;
	}	LA3: ;
	i_114448 = 0;
	...
	nimln(218, "options.nim");
	nimln(218, "options.nim");
	TMP335 = subInt(path->Sup.len, q);
	HEX3Atmp_114461 = (NI64)(TMP335);
	...
	while (1) {
		...
		nimln(219, "options.nim");
		{
			...
			LA12: ;
			{
				...
				nimln(222, "options.nim");
				nimln(222, "options.nim");
				TMP336 = addInt(i_114448, 1);
				nimln(222, "options.nim");
				TMP337 = subInt(b, 1);
				x = copyStrLast(path, (NI64)(TMP336), (NI64)(TMP337));
...
static N_INLINE(void, writeln_114502)(FILE* f, NimStringDesc** x, NI xLen0) {
	...
	nimln(160, "sysio.nim");
	write_9459(f, ((NimStringDesc*) &TMP347));	popFrame();
}
static N_INLINE(void, pushSafePoint)(TSafePoint* s) {
...
N_NIMCALL(NimStringDesc*, completegeneratedfilepath_114490)(NimStringDesc* f, NIM_BOOL createsubdir) {
	...
	nimln(249, "options.nim");
	{
		...
		TMP348.status = setjmp(TMP348.context);
		if (TMP348.status == 0) {
...
appendString(LOC10, ((NimStringDesc*) &TMP351));
...
N_NIMCALL(NimStringDesc*, findmodule_114591)(NimStringDesc* modulename, NimStringDesc* currentmodule) {
	...
	m = nosaddFileExt(modulename, ((NimStringDesc*) &TMP353));
...
N_NIMCALL(void, libcandidates_114600)(NimStringDesc* s, TY9552** dest) {
	...
	nimln(300, "options.nim");
	TMP354 = addInt(le, 1);
	ri = nsuFindChar(s, 41, (NI64)(TMP354));
	nimln(301, "options.nim");
	{
		...
		nimln(302, "options.nim");
		TMP355 = subInt(le, 1);
		prefix = copyStrLast(s, 0, (NI64)(TMP355));
		nimln(303, "options.nim");
		nimln(303, "options.nim");
		nimln(303, "options.nim");
		TMP356 = addInt(ri, 1);
		suffix = copyStr(s, (NI64)(TMP356));
		middle_114611 = 0;
		HEX3Atmp_114626 = 0;
		...
		nimln(304, "options.nim");
		TMP358 = subInt(ri, 1);
		HEX3Atmp_114626 = copyStrLast(s, (NI64)(TMP357), (NI64)(TMP358));
		...
		nimln(248, "strutils.nim");
		{
			...
			nimln(248, "strutils.nim");
			hiddenraiseassert_76017(((NimStringDesc*) &TMP359));		}		LA9: ;
		nimln(249, "strutils.nim");
		{
			...
			while (1) {
				...
				nimln(254, "strutils.nim");
				nimln(254, "strutils.nim");
				TMP360 = subInt(last_114628, 1);
				middle_114611 = copyStrLast(HEX3Atmp_114626, first_114630, (NI64)(TMP360));
...
N_NIMCALL(NimStringDesc*, canondynlibname_114635)(NimStringDesc* s) {
	...
	nimln(310, "options.nim");
	{
		...
		nimln(310, "options.nim");
		LOC3 = 0;
		LOC3 = nsuStartsWith(s, ((NimStringDesc*) &TMP340));
		if (!LOC3) goto LA4;
		start = 3;
	}	goto LA1;
	LA4: ;
	...
	ende = nsuFindCharSet(s, TMP362, 0);
	nimln(312, "options.nim");
	{
		...
		nimln(313, "options.nim");
		nimln(313, "options.nim");
		TMP363 = subInt(ende, 1);
		result = copyStrLast(s, start, (NI64)(TMP363));
	}	goto LA7;
	LA9: ;
	{
...
N_NIMCALL(void, incldynliboverride_114644)(NimStringDesc* lib) {
	...
	nstPut(gdlloverrides_114195, LOC1, ((NimStringDesc*) &TMP364));	popFrame();
}
N_NIMCALL(NIM_BOOL, isdynliboverride_114649)(NimStringDesc* lib) {
	NIM_BOOL result;
	NimStringDesc* LOC1;
...
static TNimNode* TMP1987[22];
NI TMP1989;
static char* NIM_CONST TMP1988[22] = {
"optNone", 
"optObjCheck", 
"optFieldCheck", 
"optRangeCheck", 
...
"optImplicitStatic", 
"optPatterns"};
static TNimNode* TMP2988[32];
NI TMP2990;
static char* NIM_CONST TMP2989[32] = {
"gloptNone", 
"optForceFullMake", 
"optDeadCodeElim", 
"optListCmd", 
...
"optGenIndex", 
"optEmbedOrigSrc"};
static TNimNode* TMP2999[20];
NI TMP3001;
static char* NIM_CONST TMP3000[20] = {
"cmdNone", 
"cmdCompileToC", 
"cmdCompileToCpp", 
"cmdCompileToOC", 
...
NTI114009.base = 0;
NTI114009.flags = 3;
for (TMP1989 = 0; TMP1989 < 22; TMP1989++) {
TMP256[TMP1989+0].kind = 1;
TMP256[TMP1989+0].offset = TMP1989;
TMP256[TMP1989+0].name = TMP1988[TMP1989];
TMP1987[TMP1989] = &TMP256[TMP1989+0];
}
TMP256[22].len = 22; TMP256[22].kind = 2; TMP256[22].sons = &TMP1987[0];
...
NTI114013.base = 0;
NTI114013.flags = 3;
for (TMP2990 = 0; TMP2990 < 32; TMP2990++) {
TMP256[TMP2990+24].kind = 1;
TMP256[TMP2990+24].offset = TMP2990;
TMP256[TMP2990+24].name = TMP2989[TMP2990];
TMP2988[TMP2990] = &TMP256[TMP2990+24];
}
TMP256[56].len = 32; TMP256[56].kind = 2; TMP256[56].sons = &TMP2988[0];
NTI114013.node = &TMP256[56];
NTI114017.size = sizeof(NU8);
NTI114017.kind = 14;
NTI114017.base = 0;
NTI114017.flags = 3;
for (TMP3001 = 0; TMP3001 < 20; TMP3001++) {
TMP256[TMP3001+57].kind = 1;
TMP256[TMP3001+57].offset = TMP3001;
TMP256[TMP3001+57].name = TMP3000[TMP3001];
TMP2999[TMP3001] = &TMP256[TMP3001+57];
}
TMP256[77].len = 20; TMP256[77].kind = 2; TMP256[77].sons = &TMP2999[0];
