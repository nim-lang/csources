...
STRING_LITERAL(TMP1426, "handleSymbolFile should have set the module\'s ID", 48);
STRING_LITERAL(TMP1429, "modules.nim", 11);
NIM_CONST TY84535 TMP1428 = {((NimStringDesc*) &TMP1429),
44}
;
...
N_NIMCALL(void, wantmainmodule_607014)(void) {
	NimStringDesc* LOC5;
	{
		...
		fatal_197906(gcmdlineinfo_196191, ((NU16) 186), ((NimStringDesc*) &TMP4105));
	}
	LA3: ;
	LOC5 = 0;
