...
static N_INLINE(void, setid_170432)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP1934 = addInt(id, 1);
	gfrontendid_170006 = ((gfrontendid_170006 >= (NI64)(TMP1934)) ? gfrontendid_170006 : (NI64)(TMP1934));
	popFrame();
}
static N_INLINE(NI, divInt)(NI a, NI b) {
	NI result;
...
N_NIMCALL(void, idsynchronizationpoint_170440)(NI idrange) {
	...
	nimln(41, "idgen.nim");
	nimln(41, "idgen.nim");
	TMP1935 = divInt(gfrontendid_170006, idrange);
	TMP1936 = addInt((NI64)(TMP1935), 1);
	TMP1937 = mulInt((NI64)(TMP1936), idrange);
	TMP1938 = addInt((NI64)(TMP1937), 1);
	gfrontendid_170006 = (NI64)(TMP1938);
	popFrame();
}
N_NIMCALL(NimStringDesc*, togid_170445)(NimStringDesc* f) {
