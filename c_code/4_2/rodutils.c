...
STRING_LITERAL(TMP2097, "NAN", 3);
STRING_LITERAL(TMP2098, "0.0", 3);
STRING_LITERAL(TMP2099, "INF", 3);
STRING_LITERAL(TMP2100, "-INF", 4);
STRING_LITERAL(TMP2107, "", 0);
STRING_LITERAL(TMP2113, "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", 62);
STRING_LITERAL(TMP2121, "s[i] in\015\012    {\'a\' (..|..|..) \'z\', \'A\' (..|..|..) \'Z\', \'0\' (..|."
...
N_NIMCALL(NimStringDesc*, decodestr_199126)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 92:
		{
			...
			nimln(49, "rodutils.nim");
			TMP2108 = subInt(i, 2);
			hexchar_199064(s[(NI64)(TMP2108)], &xi);
			nimln(50, "rodutils.nim");
			nimln(50, "rodutils.nim");
			TMP2109 = subInt(i, 1);
			hexchar_199064(s[(NI64)(TMP2109)], &xi);
...
N_NIMCALL(void, encodevbiggestintaux_199198)(NI64 x, NimStringDesc** result) {
	...
	LA8: ;
	{
		...
		d_199204 = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP2115), 0, 255))));
	}
	LA6: ;
...
N_NIMCALL(void, encodevintaux_199231)(NI x, NimStringDesc** result) {
	...
	nimln(71, "rodutils.nim");
	{
		...
		if ((NI64)(TMP2117) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
		v_199239 = ((NI64)-((NI64)(TMP2117)));
		nimln(74, "rodutils.nim");
		nimln(74, "rodutils.nim");
	...
	LA8: ;
	{
		...
		TMP2120 = addInt((NI64)(TMP2119), 128);
		d_199237 = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP2120), 0, 255))));
	}
	LA6: ;
	nimln(80, "rodutils.nim");
	{
...
N_NIMCALL(NI, decodevint_199305)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 48 ... 57:
		{
			...
			TMP2124 = subInt((NI64)(TMP2122), ((NI) ((NI64)(TMP2123))));
			result = (NI64)(TMP2124);
		}
		break;
		case 97 ... 122:
		{
			...
			TMP2127 = addInt(((NI) ((NI64)(TMP2126))), 10);
			TMP2128 = subInt((NI64)(TMP2125), ((NI) ((NI64)(TMP2127))));
			result = (NI64)(TMP2128);
		}
		break;
		case 65 ... 90:
		{
			...
			TMP2131 = addInt(((NI) ((NI64)(TMP2130))), 36);
			TMP2132 = subInt((NI64)(TMP2129), ((NI) ((NI64)(TMP2131))));
			result = (NI64)(TMP2132);
		}
		break;
		case 128 ... 255:
		{
			...
			TMP2135 = addInt(((NI) ((NI64)(TMP2134))), 62);
			TMP2136 = subInt((NI64)(TMP2133), ((NI) ((NI64)(TMP2135))));
			result = (NI64)(TMP2136);
		}
		break;
		default:
	...
	result = (NI)((NU64)((NI64)(TMP2137)) - (NU64)(5));
...
N_NIMCALL(NI64, decodevbiggestint_199530)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 48 ... 57:
		{
			...
			TMP2140 = subInt64((NI64)(TMP2138), ((NI64) ((NI64)(TMP2139))));
			result = (NI64)(TMP2140);
		}
		break;
		case 97 ... 122:
		{
			...
			TMP2143 = addInt(((NI) ((NI64)(TMP2142))), 10);
			TMP2144 = subInt64((NI64)(TMP2141), ((NI64) ((NI64)(TMP2143))));
			result = (NI64)(TMP2144);
		}
		break;
		case 65 ... 90:
		{
			...
			TMP2147 = addInt(((NI) ((NI64)(TMP2146))), 36);
			TMP2148 = subInt64((NI64)(TMP2145), ((NI64) ((NI64)(TMP2147))));
			result = (NI64)(TMP2148);
		}
		break;
		case 128 ... 255:
		{
			...
			TMP2151 = addInt(((NI) ((NI64)(TMP2150))), 62);
			TMP2152 = subInt64((NI64)(TMP2149), ((NI64) ((NI64)(TMP2151))));
			result = (NI64)(TMP2152);
		}
		break;
		default:
