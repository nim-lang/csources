...
appendString(LOC22, reprEnum((*n).Kind, (&NTI191023)));
	...
	nimln(29, "typesrenderer.nim");
	{
		...
		nimln(29, "typesrenderer.nim");
		failedassertimpl_80421(((NimStringDesc*) &TMP4780));
	}
	LA25: ;
	BeforeRet: ;
	popFrame();
...
N_NIMCALL(NimStringDesc*, rendertype_342208)(tnode191813* n) {
	...
	case ((NU8) 141):
	{
		...
		nimln(37, "typesrenderer.nim");
		{
			...
			if (!!((LOC6 == 1))) goto LA7;
			nimln(37, "typesrenderer.nim");
			failedassertimpl_80421(((NimStringDesc*) &TMP4781));
		}
		LA7: ;
...
appendString(LOC25, LOC27);
	...
	case ((NU8) 145):
	{
		...
		nimln(48, "typesrenderer.nim");
		{
			...
			nimln(48, "typesrenderer.nim");
			failedassertimpl_80421(((NimStringDesc*) &TMP4785));
		}
		LA36: ;
...
N_NIMCALL(void, renderparamtypes_344423)(TY10865** found, tnode191813* n) {
	...
	case ((NU8) 35):
	{
		...
		nimln(89, "typesrenderer.nim");
		{
			...
			LOC16 = 0;
			LOC16 = HEX5BHEX5D_192711(n, (NI64)(TMP4796));
			...
			LOC19 = 0;
			LOC19 = HEX5BHEX5D_192711(n, (NI64)(TMP4797));
			typ = (*LOC19).Typ;
