...
N_NIMCALL(tmemfile209204, open_209210)(NimStringDesc* filename, NU8 mode, NI mappedsize, NI offset, NI newfilesize) {
	...
	nimln(45, "memfiles.nim");
	{
		...
		if (!!(LOC3)) goto LA5;
		nimln(45, "memfiles.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP2864));	}	LA5: ;
...
TMP2945[0] = &TMP2862[1];
TMP2862[1].kind = 1;
TMP2862[1].offset = offsetof(tmemfile209204, Mem);
TMP2862[1].typ = (&NTI146);
TMP2862[1].name = "mem";
TMP2945[1] = &TMP2862[2];
TMP2862[2].kind = 1;
TMP2862[2].offset = offsetof(tmemfile209204, Size);
TMP2862[2].typ = (&NTI105);
TMP2862[2].name = "size";
TMP2945[2] = &TMP2862[3];
TMP2862[3].kind = 1;
TMP2862[3].offset = offsetof(tmemfile209204, Handle);
TMP2862[3].typ = (&NTI3809);
TMP2862[3].name = "handle";
TMP2862[0].len = 3; TMP2862[0].kind = 2; TMP2862[0].sons = &TMP2945[0];
NTI209204.node = &TMP2862[0];
}
