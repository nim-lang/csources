...
N_NIMCALL(NI, counttriples_173676)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			LOC5 = ((NU8)(s->data[(NI64)(TMP1636)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			...
			LOC4 = ((NU8)(s->data[(NI64)(TMP1637)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
N_NIMCALL(NI, llstreamread_173242)(tllstream173204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		nimln(136, "llstream.nim");
		{
			...
			memcpy(buf, ((void*) (&(*s).S->data[(NI64)(TMP1643)])), result);
...
N_NIMCALL(void, llstreamwrite_173268)(tllstream173204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			(*s).S = setLengthStr((*s).S, (NI64)(TMP1644));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1645 = addInt(0, (*s).Wr);
			if ((NU)((NI64)(TMP1645)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI64)(TMP1645)])), buf, buflen);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_173254)(tllstream173204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI64)(TMP1646));
			nimln(222, "llstream.nim");
			nimln(222, "llstream.nim");
			TMP1647 = addInt(i, 0);
			if ((NU)((NI64)(TMP1647)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_10627((*s).F, ((void*) (&result->data[(NI64)(TMP1647)])), 2048);
