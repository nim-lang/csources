...
N_NIMCALL(void, TMP1637)(void* p, NI op);
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY123387 TMP1640 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY123387 TMP1641 = {
0x00, 0x00, 0x00, 0x00, 0x7A, 0xBC, 0x00, 0xF4,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP1644, ">>> ", 4);
STRING_LITERAL(TMP1645, "... ", 4);
STRING_LITERAL(TMP1646, "\012", 1);
...
N_NIMCALL(tllstream179204*, llstreamopenstdin_179235)(void) {
	...
	LOC1 = 0;
	LOC1 = (*result).S; (*result).S = copyStringRC1(((NimStringDesc*) &TMP1638));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
N_NIMCALL(NIM_BOOL, endswithopr_179646)(NimStringDesc* x) {
	...
	result = endswith_179602(x, TMP1640);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_179652)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_179602(line, TMP1641);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(NI, counttriples_179676)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1642 = addInt(i, 1);
			if ((NU)((NI64)(TMP1642)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI64)(TMP1642)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1643 = addInt(i, 2);
			if ((NU)((NI64)(TMP1643)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI64)(TMP1643)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
N_NIMCALL(NI, llreadfromstdin_179733)(tllstream179204* s, void* buf, NI buflen) {
	...
	LOC1 = 0;
	LOC1 = (*s).S; (*s).S = copyStringRC1(((NimStringDesc*) &TMP1638));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	...
	while (1) {
		...
		nimln(119, "llstream.nim");
		{
			...
			LOC3 = copyString(((NimStringDesc*) &TMP1644));
		}
		goto LA4;
		LA6: ;
		{
			LOC3 = copyString(((NimStringDesc*) &TMP1645));
		}
		LA4: ;
		LOC9 = 0;
...
appendString((*s).S, ((NimStringDesc*) &TMP1646));
	...
	nimln(125, "llstream.nim");
	nimln(125, "llstream.nim");
	TMP1647 = subInt((*s).S->Sup.len, (*s).Rd);
	result = ((buflen <= (NI64)(TMP1647)) ? buflen : (NI64)(TMP1647));
...
N_NIMCALL(NI, llstreamread_179242)(tllstream179204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		nimln(135, "llstream.nim");
		nimln(135, "llstream.nim");
		TMP1648 = subInt((*s).S->Sup.len, (*s).Rd);
		result = ((buflen <= (NI64)(TMP1648)) ? buflen : (NI64)(TMP1648));
		nimln(136, "llstream.nim");
		{
			...
			nimln(137, "llstream.nim");
			TMP1649 = addInt(0, (*s).Rd);
			if ((NU)((NI64)(TMP1649)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI64)(TMP1649)])), result);
...
N_NIMCALL(void, llstreamwriteln_179274)(tllstream179204* s, NimStringDesc* data) {
	...
	llstreamwrite_179258(s, ((NimStringDesc*) &TMP1646));
	popFrame();
}
...
N_NIMCALL(void, llstreamwrite_179268)(tllstream179204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			nimln(200, "llstream.nim");
			nimln(200, "llstream.nim");
			TMP1650 = addInt((*s).S->Sup.len, buflen);
			(*s).S = setLengthStr((*s).S, (NI64)(TMP1650));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1651 = addInt(0, (*s).Wr);
			if ((NU)((NI64)(TMP1651)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI64)(TMP1651)])), buf, buflen);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_179254)(tllstream179204* s) {
	...
	case ((NU8) 3):
	{
		...
		result = copyString(((NimStringDesc*) &TMP1638));
	}
	break;
	case ((NU8) 1):
	{
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			nimln(221, "llstream.nim");
			TMP1652 = addInt(i, 2048);
			result = setLengthStr(result, (NI64)(TMP1652));
			nimln(222, "llstream.nim");
			nimln(222, "llstream.nim");
			TMP1653 = addInt(i, 0);
			if ((NU)((NI64)(TMP1653)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_10827((*s).F, ((void*) (&result->data[(NI64)(TMP1653)])), 2048);
...
static TNimNode* TMP1633[6];
static TNimNode* TMP1634[4];
NI TMP1636;
static char* NIM_CONST TMP1635[4] = {
"llsNone", 
"llsString", 
"llsFile", 
"llsStdIn"};
static TNimNode TMP1631[12];
...
NTI179202.base = 0;
NTI179202.flags = 3;
for (TMP1636 = 0; TMP1636 < 4; TMP1636++) {
TMP1631[TMP1636+2].kind = 1;
TMP1631[TMP1636+2].offset = TMP1636;
TMP1631[TMP1636+2].name = TMP1635[TMP1636];
TMP1634[TMP1636] = &TMP1631[TMP1636+2];
}
TMP1631[6].len = 4; TMP1631[6].kind = 2; TMP1631[6].sons = &TMP1634[0];
NTI179202.node = &TMP1631[6];
TMP1631[1].kind = 1;
TMP1631[1].offset = offsetof(tllstream179204, Kind);
TMP1631[1].typ = (&NTI179202);
TMP1631[1].name = "kind";
TMP1633[1] = &TMP1631[7];
TMP1631[7].kind = 1;
TMP1631[7].offset = offsetof(tllstream179204, F);
TMP1631[7].typ = (&NTI10204);
TMP1631[7].name = "f";
TMP1633[2] = &TMP1631[8];
TMP1631[8].kind = 1;
TMP1631[8].offset = offsetof(tllstream179204, S);
TMP1631[8].typ = (&NTI143);
TMP1631[8].name = "s";
TMP1633[3] = &TMP1631[9];
TMP1631[9].kind = 1;
TMP1631[9].offset = offsetof(tllstream179204, Rd);
TMP1631[9].typ = (&NTI106);
TMP1631[9].name = "rd";
TMP1633[4] = &TMP1631[10];
TMP1631[10].kind = 1;
TMP1631[10].offset = offsetof(tllstream179204, Wr);
TMP1631[10].typ = (&NTI106);
TMP1631[10].name = "wr";
TMP1633[5] = &TMP1631[11];
TMP1631[11].kind = 1;
TMP1631[11].offset = offsetof(tllstream179204, Lineoffset);
TMP1631[11].typ = (&NTI106);
TMP1631[11].name = "lineOffset";
TMP1631[0].len = 6; TMP1631[0].kind = 2; TMP1631[0].sons = &TMP1633[0];
NTI179204.node = &TMP1631[0];
NTI179206.size = sizeof(tllstream179204*);
NTI179206.kind = 22;
NTI179206.base = (&NTI179204);
NTI179206.marker = TMP1637;
}
