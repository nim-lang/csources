...
N_NIMCALL(void, handleshortoption_416876)(toptparser416607* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_416802((*p).Cmd, i, &(*p).Val, TMP7034);
	}	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser416607* p) {
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_416802((*p).Cmd, i, &(*p).Key, TMP7035);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_416802((*p).Cmd, i, &(*p).Val, TMP7034);
			}			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_416802((*p).Cmd, i, &(*p).Key, TMP7034);
	}	break;
	}
	BeforeRet: ;	popFrame();
}
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser416607* p) {
	...
	LOC1 = 0;
	LOC1 = copyStrLast((*p).Cmd, (*p).Pos, (NI64)(TMP7036));
...
TMP7038[0] = &TMP7027[1];
TMP7027[1].kind = 1;
TMP7027[1].offset = offsetof(toptparser416607, Cmd);
TMP7027[1].typ = (&NTI142);
TMP7027[1].name = "cmd";
TMP7038[1] = &TMP7027[2];
TMP7027[2].kind = 1;
TMP7027[2].offset = offsetof(toptparser416607, Pos);
TMP7027[2].typ = (&NTI105);
TMP7027[2].name = "pos";
TMP7038[2] = &TMP7027[3];
TMP7027[3].kind = 1;
TMP7027[3].offset = offsetof(toptparser416607, Inshortstate);
...
NTI416605.node = &TMP7027[9];
TMP7027[4].kind = 1;
TMP7027[4].offset = offsetof(toptparser416607, Kind);
TMP7027[4].typ = (&NTI416605);
TMP7027[4].name = "kind";
TMP7038[4] = &TMP7027[10];
TMP7027[10].kind = 1;
TMP7027[10].offset = offsetof(toptparser416607, Key);
TMP7027[10].typ = (&NTI142);
TMP7027[10].name = "key";
TMP7038[5] = &TMP7027[11];
TMP7027[11].kind = 1;
TMP7027[11].offset = offsetof(toptparser416607, Val);
TMP7027[11].typ = (&NTI142);
TMP7027[11].name = "val";
TMP7027[0].len = 6; TMP7027[0].kind = 2; TMP7027[0].sons = &TMP7038[0];
NTI416607.node = &TMP7027[0];
}
