...
static NIM_CONST TY171865 TMP3602 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3603, "strVal", 6);
static NIM_CONST TY171865 TMP3604 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3605, "ident", 5);
static NIM_CONST TY171865 TMP3606 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3607, "sym", 3);
static NIM_CONST TY171865 TMP3608 = {
...
N_NIMCALL(NimStringDesc*, getmodulename_265012)(tnode171659* n) {
	...
	case ((NU8) 29):
	{
		...
		nimln(31, "importer.nim");
		{
			...
			nimln(31, "importer.nim");
			LOC9 = 0;
			LOC9 = getident_140443(((NimStringDesc*) &TMP3610));
...
N_NIMCALL(void, rawimportsymbol_265189)(tcontext262019* c, tsym171689* s) {
	...
	strtableadd_178078(&(*(*c).Importtable).Symbols, s);	nimln(71, "importer.nim");
	{
		...
		nimln(73, "importer.nim");
		{
			...
			while (1) {
				...
				if (!(((TMP3606[(*(*(*etyp).N).kindU.S6.Sons->data[j_265258]).Kind/8] &(1<<((*(*(*etyp).N).kindU.S6.Sons->data[j_265258]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3607));
				...
				nimln(76, "importer.nim");
				{
					...
					internalerror_138369((*s).Info, ((NimStringDesc*) &TMP3617));				}				LA25: ;
	...
	LA13: ;
	{
		nimln(92, "importer.nim");
		{
			...
			nimln(92, "importer.nim");
			addconverter_262459(c, s);		}		LA39: ;
		nimln(93, "importer.nim");
		{
			NIM_BOOL LOC43;
			nimln(93, "importer.nim");
			LOC43 = 0;
			LOC43 = haspattern_176878(s);
			if (!LOC43) goto LA44;
			nimln(93, "importer.nim");
			addpattern_262466(c, s);		}		LA44: ;
	}	LA11: ;
	popFrame();
}
N_NIMCALL(void, importsymbol_265334)(tcontext262019* c, tnode171659* n, tsym171689* frommod) {
	...
	LA3: ;
	{
		...
		nimln(102, "importer.nim");
		{
			...
			internalerror_138369((*n).Info, ((NimStringDesc*) &TMP3619));		}		LA12: ;
		...
		case ((NU8) 15):
		{
			...
			while (1) {
				...
				nimln(111, "importer.nim");
				{
					...
					nimln(111, "importer.nim");
					internalerror_138369((*n).Info, ((NimStringDesc*) &TMP3620));				}				LA18: ;
...
N_NIMCALL(void, importforwarded_265511)(tcontext262019* c, tnode171659* n, tintset168043* exceptset) {
	...
	case ((NU8) 117):
	{
		...
		while (1) {
			...
			if (!(((TMP3606[(*a_265524).Kind/8] &(1<<((*a_265524).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3607));
	...
	case ((NU8) 118):
	{
		...
		localerror_138349((*n).Info, ((NU16) 4), ((NimStringDesc*) &TMP3623));	}	break;
	default:
	{
		NI i_265630;
		NI HEX3Atmp_265648;
...
N_NIMCALL(tsym171689*, importmoduleas_265656)(tnode171659* n, tsym171689* realmodule) {
	...
	LA3: ;
	{
		...
		localerror_138349((*n).Info, ((NU16) 4), ((NimStringDesc*) &TMP3625));	}	goto LA1;
	LA9: ;
	{
		nimln(698, "system.nim");
		nimln(698, "system.nim");
...
N_NIMCALL(tnode171659*, evalfrom_265007)(tcontext262019* c, tnode171659* n) {
	...
	checkminsonslen_262670(n, 2);	nimln(179, "importer.nim");
	if (((TMP3608[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3609));
	if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
...
N_NIMCALL(tnode171659*, evalimportexcept_265898)(tcontext262019* c, tnode171659* n) {
	...
	checkminsonslen_262670(n, 2);	nimln(190, "importer.nim");
	if (((TMP3608[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3609));
	if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	m = myimportmodule_265745(c, (*n).kindU.S6.Sons->data[0]);
