...
static NIM_CONST TY171865 TMP3819 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3820, "strVal", 6);
static NIM_CONST TY171865 TMP3821 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3822, "sons", 4);
static NIM_CONST TY171865 TMP3823 = {
...
static NIM_CONST TY171865 TMP3844 = {
...
N_NIMCALL(tnode171659*, semnodekindconstraints_276393)(tnode171659* p) {
	...
	nimln(124, "parampatterns.nim");
	{
		...
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_138369((*p).Info, ((NimStringDesc*) &TMP3843));		}		LA14: ;
	}	goto LA5;
	LA8: ;
	{
...
N_NIMCALL(NIM_BOOL, matchnodekinds_277175)(tnode171659* p, tnode171659* n) {
	...
	while (1) {
		...
		case ((NU8) 2):
		{
			...
			LOC4 = stack[((NI64)(TMP3847))- 0];
			if (LOC4) goto LA5;
			nimln(239, "parampatterns.nim");
			TMP3848 = subInt(sp, 2);
			if ((NU)((NI64)(TMP3848)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI64)(TMP3848))- 0];
			LA5: ;
			stack[((NI64)(TMP3846))- 0] = LOC4;
		...
		case ((NU8) 3):
		{
			...
			nimln(242, "parampatterns.nim");
			TMP3849 = subInt(sp, 2);
			if ((NU)((NI64)(TMP3849)) > (NU)(64)) raiseIndexError();
			nimln(242, "parampatterns.nim");
			LOC7 = 0;
			nimln(242, "parampatterns.nim");
			TMP3850 = subInt(sp, 1);
			if ((NU)((NI64)(TMP3850)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI64)(TMP3850))- 0];
			if (!(LOC7)) goto LA8;
			nimln(242, "parampatterns.nim");
			TMP3851 = subInt(sp, 2);
			if ((NU)((NI64)(TMP3851)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI64)(TMP3851))- 0];
			LA8: ;
			stack[((NI64)(TMP3849))- 0] = LOC7;
		...
		case ((NU8) 4):
		{
			...
			stack[((NI64)(TMP3852))- 0] = !(stack[((NI64)(TMP3853))- 0]);
		}		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(251, "parampatterns.nim");
			TMP3854 = addInt(pc, 1);
			if ((NU)((NI64)(TMP3854)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3854)])), ((NU8) 0), ((NU8) 22)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			nimln(255, "parampatterns.nim");
			TMP3855 = addInt(pc, 1);
			if ((NU)((NI64)(TMP3855)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3855)])), ((NU8) 0), ((NU8) 153)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
