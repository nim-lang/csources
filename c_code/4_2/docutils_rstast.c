...
43}
;
STRING_LITERAL(TMP3778, "\012", 1);
STRING_LITERAL(TMP3780, "", 0);
STRING_LITERAL(TMP3782, "\012\012", 2);
STRING_LITERAL(TMP3784, "* ", 2);
STRING_LITERAL(TMP3785, "(#) ", 4);
STRING_LITERAL(TMP3786, "  ", 2);
STRING_LITERAL(TMP3790, "| ", 2);
STRING_LITERAL(TMP3791, "`", 1);
STRING_LITERAL(TMP3792, "`_", 2);
STRING_LITERAL(TMP3793, " <", 2);
STRING_LITERAL(TMP3794, ">`_", 3);
STRING_LITERAL(TMP3795, "`:", 2);
STRING_LITERAL(TMP3796, "`:sub:", 6);
STRING_LITERAL(TMP3797, "`:sup:", 6);
STRING_LITERAL(TMP3798, "`:idx:", 6);
...
STRING_LITERAL(TMP3805, ".. index::\012", 11);
STRING_LITERAL(TMP3806, ".. contents::", 13);
STRING_LITERAL(TMP3807, "Error: cannot render: ", 22);
STRING_LITERAL(TMP3809, "kind", 4);
STRING_LITERAL(TMP3810, "level", 5);
STRING_LITERAL(TMP3811, "text", 4);
STRING_LITERAL(TMP3812, "sons", 4);
...
N_NIMCALL(trstnode295009*, lastson_295146)(trstnode295009* n) {
	...
	nimln(87, "rstast.nim");
	nimln(87, "rstast.nim");
	TMP3776 = subInt((*n).Sons->Sup.len, 1);
	if ((NU)((NI64)(TMP3776)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP3776)];
	popFrame();
	return result;
}
...
N_NIMCALL(void, renderrstsons_295223)(trendercontext295211* d, trstnode295009* n, NimStringDesc** result) {
	...
	LOC1 = 0;
	LOC1 = len_295080(n);
	TMP3777 = subInt(LOC1, 1);
	HEX3Atmp_295243 = (NI64)(TMP3777);
...
appendString((*result), ind);
		...
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI64)(TMP3781), lvltochar_295257[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI64)(TMP3783), 45);
...
appendString((*result), ((NimStringDesc*) &TMP3786));
	...
	case ((NU8) 14):
	{
		...
		l = (((NI64)(TMP3787) >= 30) ? (NI64)(TMP3787) : 30);
...
appendString((*result), tmp);
		...
		TMP3789 = subInt((NI64)(TMP3788), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI64)(TMP3789), 32);
...
static TNimNode* TMP3770[4];
static TNimNode* TMP3771[65];
NI TMP3773;
static char* NIM_CONST TMP3772[65] = {
"rnInner", 
"rnHeadline", 
"rnOverline", 
"rnTransition", 
...
NTI295003.base = 0;
NTI295003.flags = 3;
for (TMP3773 = 0; TMP3773 < 65; TMP3773++) {
TMP3611[TMP3773+2].kind = 1;
TMP3611[TMP3773+2].offset = TMP3773;
TMP3611[TMP3773+2].name = TMP3772[TMP3773];
TMP3771[TMP3773] = &TMP3611[TMP3773+2];
}
TMP3611[67].len = 65; TMP3611[67].kind = 2; TMP3611[67].sons = &TMP3771[0];
NTI295003.node = &TMP3611[67];
TMP3611[1].kind = 1;
TMP3611[1].offset = offsetof(trstnode295009, Kind);
TMP3611[1].typ = (&NTI295003);
TMP3611[1].name = "kind";
TMP3770[1] = &TMP3611[68];
TMP3611[68].kind = 1;
TMP3611[68].offset = offsetof(trstnode295009, Text);
TMP3611[68].typ = (&NTI143);
TMP3611[68].name = "text";
TMP3770[2] = &TMP3611[69];
TMP3611[69].kind = 1;
TMP3611[69].offset = offsetof(trstnode295009, Level);
TMP3611[69].typ = (&NTI106);
TMP3611[69].name = "level";
TMP3770[3] = &TMP3611[70];
TMP3611[70].kind = 1;
TMP3611[70].offset = offsetof(trstnode295009, Sons);
TMP3611[70].typ = (&NTI295084);
TMP3611[70].name = "sons";
TMP3611[0].len = 4; TMP3611[0].kind = 2; TMP3611[0].sons = &TMP3770[0];
NTI295009.node = &TMP3611[0];
NTI295005.size = sizeof(trstnode295009*);
NTI295005.kind = 22;
NTI295005.base = (&NTI295009);
NTI295005.flags = 2;
NTI295005.marker = TMP3775;
}
