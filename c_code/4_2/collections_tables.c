...
N_NIMCALL(void, enlarge_219767)(ttable219029* t) {
	...
	n = (tkeyvaluepairseq219032*) newSeq((&NTI219032), (NI64)(TMP3096));
	i_219806 = 0;
	HEX3Atmp_219861 = 0;
	nimln(117, "tables.nim");
	nimln(117, "tables.nim");
...
N_NIMCALL(void, enlarge_220197)(ttable219059* t) {
	...
	n = (tkeyvaluepairseq219062*) newSeq((&NTI219062), (NI64)(TMP3105));
	i_220236 = 0;
	HEX3Atmp_220291 = 0;
	nimln(117, "tables.nim");
	nimln(117, "tables.nim");
