...
static NIM_CONST TY171865 TMP2575 = {
	...
	while (1) {
		...
		nimln(31, "filters.nim");
		{
			...
			nimln(32, "filters.nim");
			{
				...
				if (((TMP2572[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2573));
				if ((NU)(i_195068) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP2572[(*(*n).kindU.S6.Sons->data[i_195068]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_195068]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2573));
			...
			nimln(33, "filters.nim");
			{
				...
				if (((TMP2572[(*(*n).kindU.S6.Sons->data[i_195068]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_195068]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2573));
				if ((NU)(0) >= (NU)((*(*n).kindU.S6.Sons->data[i_195068]).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (!(((TMP2575[(*(*(*n).kindU.S6.Sons->data[i_195068]).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*(*n).kindU.S6.Sons->data[i_195068]).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2576));
				LOC17 = 0;
...
N_NIMCALL(NIM_BOOL, boolarg_195028)(tnode171659* n, NimStringDesc* name, NI pos, NIM_BOOL default_195033) {
	...
	LA3: ;
	{
		...
		LOC6 = identeq_140456((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2581));
		LA7: ;
		if (!LOC6) goto LA8;
		nimln(53, "filters.nim");
		result = NIM_TRUE;
	...
	LA8: ;
	{
		...
		nimln(54, "filters.nim");
		if (!(((TMP2575[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2576));
		LOC11 = identeq_140456((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2582));
		LA12: ;
		if (!LOC11) goto LA13;
		nimln(54, "filters.nim");
		result = NIM_FALSE;
...
N_NIMCALL(tllstream161204*, filterstrip_195008)(tllstream161204* stdin_195010, NimStringDesc* filename, tnode171659* call) {
	...
	pattern = strarg_195021(call, ((NimStringDesc*) &TMP2583), 1, ((NimStringDesc*) &TMP2584));
	nimln(59, "filters.nim");
	leading = boolarg_195028(call, ((NimStringDesc*) &TMP2585), 2, NIM_TRUE);
	nimln(60, "filters.nim");
	trailing = boolarg_195028(call, ((NimStringDesc*) &TMP2586), 3, NIM_TRUE);
	nimln(61, "filters.nim");
	result = llstreamopen_161218(((NimStringDesc*) &TMP2584));
...
N_NIMCALL(tllstream161204*, filterreplace_195002)(tllstream161204* stdin_195004, NimStringDesc* filename, tnode171659* call) {
	...
	sub = strarg_195021(call, ((NimStringDesc*) &TMP2588), 1, ((NimStringDesc*) &TMP2584));
	...
	by = strarg_195021(call, ((NimStringDesc*) &TMP2589), 2, ((NimStringDesc*) &TMP2584));
