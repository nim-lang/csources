...
static NIM_CONST TY192025 TMP5679 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5680, "sons", 4);
STRING_LITERAL(TMP5683, "ithField", 8);
STRING_LITERAL(TMP5688, "ithField(record case branch)", 28);
static NIM_CONST TY192025 TMP5689 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5690, "sym", 3);
STRING_LITERAL(TMP5691, "invalid field at index ", 23);
STRING_LITERAL(TMP5692, "() must have an object or tuple type", 36);
STRING_LITERAL(TMP5693, "[] must have some form of array type", 36);
STRING_LITERAL(TMP5694, "{} must have the set type", 25);
STRING_LITERAL(TMP5695, "float literal must have some float type", 39);
STRING_LITERAL(TMP5696, "integer literal must have some int type", 39);
STRING_LITERAL(TMP5697, "string literal must be of some string type", 42);
STRING_LITERAL(TMP5698, "nil literal must be of some pointer type", 40);
...
static N_INLINE(tnode191813*, lastson_192199)(tnode191813* n) {
	...
	if ((NU)((NI64)(TMP5686)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI64)(TMP5686)];
	popFrame();
	return result;
}
...
N_NIMCALL(tsym191843*, ithfield_420007)(tnode191813* n, NI field) {
	...
	case ((NU8) 136):
	{
		...
		while (1) {
			...
			result = ithfield_420007((*n).kindU.S6.Sons->data[i_420024], (NI64)(TMP5682));
	...
	case ((NU8) 137):
	{
		...
		result = ithfield_420007((*n).kindU.S6.Sons->data[0], (NI64)(TMP5684));
		...
		while (1) {
			...
			case ((NU8) 88):
			{
				...
				result = ithfield_420007(LOC20, (NI64)(TMP5687));
