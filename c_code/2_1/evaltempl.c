...
static NIM_CONST TY187025 TMP5463 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5464, "sym", 3);
static NIM_CONST TY187025 TMP5465 = {
...
NIM_CONST TY129808 TMP5467 = {((NimStringDesc*) &TMP5468),
39}
;
	...
	case ((NU8) 3):
	{
		...
		nimln(31, "evaltempl.nim");
		{
			...
			LA8: ;
			{
				...
				LA30: ;
				LOC35 = 0;
				LOC35 = newsymnode_188723(x, LOC29);
...
N_NIMCALL(tnode186813*, evaltemplateargs_390174)(tnode186813* n, tsym186843* s) {
	...
	nimln(65, "evaltempl.nim");
	{
		...
		if (!(f < a)) goto LA5;
		nimln(65, "evaltempl.nim");
		globalerror_164558((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP5470));
	}
	LA5: ;
	...
	while (1) {
		...
		LA10: ;
		{
			...
			if (!(((TMP5463[(*(*(*(*s).Typ).N).kindU.S6.Sons->data[i_390194]).Kind/8] &(1<<((*(*(*(*s).Typ).N).kindU.S6.Sons->data[i_390194]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5464));
		...
		nimln(70, "evaltempl.nim");
		{
			...
			localerror_164571((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP5470));
		}
		LA17: ;
...
N_NIMCALL(tnode186813*, evaltemplate_390275)(tnode186813* n, tsym186843* tmpl, tsym186843* gensymowner) {
	...
	nimln(79, "evaltempl.nim");
	{
		...
		globalerror_164558((*n).Info, ((NU16) 183), ((NimStringDesc*) &TMP5470));
	...
	body = getbody_238244(tmpl);
	nimln(91, "evaltempl.nim");
	{
		NIM_BOOL LOC7;
		nimln(91, "evaltempl.nim");
		LOC7 = 0;
		LOC7 = isatom_193186(body);
		if (!LOC7) goto LA8;
