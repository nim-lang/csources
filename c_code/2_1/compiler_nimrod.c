...
N_NIMCALL(void, handlecmdline_424603)(void) {
	...
	{
		nimln(39, "nimrod.nim");
		processcmdline_419207(((NU8) 0), ((NimStringDesc*) &TMP7232));		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP7233;
			TY102259 p;
			NimStringDesc* LOC15;
		...
		nimln(50, "nimrod.nim");
		loadconfigs_168607(((NimStringDesc*) &TMP7234));		nimln(53, "nimrod.nim");
		initvars_148647();		nimln(54, "nimrod.nim");
		processcmdline_419207(((NU8) 1), ((NimStringDesc*) &TMP7232));		nimln(55, "nimrod.nim");
