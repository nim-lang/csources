...
N_NIMCALL(void, strtableenlarge_240628)(tstrtable225823* t) {
	...
	tsymseq225821* LOC8;
	n = 0;
	n = (tsymseq225821*) newSeq((&NTI225821), (NI32)((*t).Data->Sup.len * 2));
	{
		NI i_240672;
		NI HEX3Atmp_240708;
		NI res_240711;
	...
	{
		{
			...
			LOC8 = mustrehash_235249((*t).Data->Sup.len, (*t).Counter);
			if (!LOC8) goto LA9;
			n = (tidpairseq225865*) newSeq((&NTI225865), (NI32)((*t).Data->Sup.len * 2));
			{
				NI i_242251;
				NI HEX3Atmp_242432;
				NI res_242435;
	...
	{
		{
			...
			if (!LOC8) goto LA9;
			n = 0;
			n = (tidnodepairseq225871*) newSeq((&NTI225871), (NI32)((*t).Data->Sup.len * 2));
			{
				NI i_243052;
				NI HEX3Atmp_243101;
				NI res_243104;
