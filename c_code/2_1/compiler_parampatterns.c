	...
	{
		{
			...
			if (!((*LOC42).kind == ((Ttypekind294244) 23) || (*LOC42).kind == ((Ttypekind294244) 21) || (*LOC42).kind == ((Ttypekind294244) 22))) goto LA43;
			result0 = ((Tassignableresult366802) 1);
		}
		goto LA40;
		LA43: ;
	...
	{
		{
			...
			if (!((*LOC55).kind == ((Ttypekind294244) 23) || (*LOC55).kind == ((Ttypekind294244) 21) || (*LOC55).kind == ((Ttypekind294244) 22))) goto LA56;
			result0 = ((Tassignableresult366802) 1);
		}
		goto LA53;
		LA56: ;
	...
	{
		{
			...
			if (!((*LOC62).kind == ((Ttypekind294244) 27) || (*LOC62).kind == ((Ttypekind294244) 18) || (*LOC62).kind == ((Ttypekind294244) 17))) goto LA63;
...
{	result0 = (Tsideeffectanalysis366646)0;
	...
	case ((Tnodekind294020) 32):
	{
		...
		op0 = (*n0).kindU.S6.sons->data[((NI) 0)];
		{
			...
			if (!(LOC4)) goto LA5;
			LOC4 = isroutine_299323_850551059((*op0).kindU.S4.sym);
			LA5: ;
			if (!LOC4) goto LA6;
			s0 = (*op0).kindU.S4.sym;
			{
...
N_NIMCALL(NIM_BOOL, matchnodekinds_367063_3566143041)(Tnode294802* p0, Tnode294802* n0) {
	...
	pc0 = ((NI) 1);
	{
		while (1) {
			...
			{
				stack0[(sp0)- 0] = isatom_299418_850551059(n0);
				sp0 += ((NI) 1);
			}
			break;
