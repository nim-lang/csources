...
N_NIMCALL(tnode186813*, extractrange_221271)(NU8 k, tnode186813* n, NI a, NI b) {
	...
	result = newnodei_188803(k, (*n).Info, (NI32)(TMP2735));
	i_221288 = 0;
	HEX3Atmp_221317 = 0;
	nimln(168, "trees.nim");
	nimln(168, "trees.nim");
	TMP2736 = subInt(b, a);
	HEX3Atmp_221317 = (NI32)(TMP2736);
	nimln(1457, "system.nim");
	res_221319 = 0;
	nimln(1458, "system.nim");
	while (1) {
		...
		asgnRefNoCycle((void**) &(*result).kindU.S6.Sons->data[i_221288], (*n).kindU.S6.Sons->data[(NI32)(TMP2737)]);
		nimln(1460, "system.nim");
