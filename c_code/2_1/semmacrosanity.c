...
N_NIMCALL(tsym225849*, ithfield_479012)(tnode225819* n, NI field) {
	...
	{
		{
			...
			HEX3Atmp_479188 = (NI32)(LOC3 - 1);
			res_479191 = 0;
			{
				while (1) {
					if (!(res_479191 <= HEX3Atmp_479188)) goto LA5;
					i_479029 = res_479191;
					result = ithfield_479012((*n).kindU.S6.Sons->data[i_479029], (NI32)(field - i_479029));
					{
	...
	case ((NU8) 137):
	{
		...
		LA13: ;
		result = ithfield_479012((*n).kindU.S6.Sons->data[0], (NI32)(field - 1));
		{
			...
			res_479197 = 1;
			{
				while (1) {
					...
					case ((NU8) 88):
					{
						...
						result = ithfield_479012(LOC24, (NI32)(field - 1));
						{
