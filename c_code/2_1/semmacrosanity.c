...
static N_INLINE(tnode192813*, lastson_193199)(tnode192813* n) {
	...
	if ((NU)((NI32)(TMP5688)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI32)(TMP5688)];
	popFrame();
	return result;
}
...
N_NIMCALL(tsym192843*, ithfield_421007)(tnode192813* n, NI field) {
	...
	case ((NU8) 136):
	{
		...
		while (1) {
			...
			result = ithfield_421007((*n).kindU.S6.Sons->data[i_421024], (NI32)(TMP5684));
	...
	case ((NU8) 137):
	{
		...
		result = ithfield_421007((*n).kindU.S6.Sons->data[0], (NI32)(TMP5686));
		...
		while (1) {
			...
			case ((NU8) 88):
			{
				...
				result = ithfield_421007(LOC20, (NI32)(TMP5689));
