...
typedef N_CLOSURE_PTR(void, T_HZdw8BhppcTQo8DIK46LSg_27) (NI idx0);
typedef N_CLOSURE_PTR(void, T_HZdw8BhppcTQo8DIK46LSg_28) (NI idx0, Processobj_NHqciQYh8G1aN2n273mmYw* p0);
...
STRING_LITERAL(T_HZdw8BhppcTQo8DIK46LSg_20, "System time was modified", 24);
static NIM_CONST TY_kElEuvYkhDcTHhB3d89aMYA T_HZdw8BhppcTQo8DIK46LSg_21 = {NIM_NIL,NIM_NIL};
static NIM_CONST TY_SfW5itioRNR8yop8fOJeNg T_HZdw8BhppcTQo8DIK46LSg_23 = {NIM_NIL,NIM_NIL};
...
{	result0 = (pid_t)0;
	...
	T_HZdw8BhppcTQo8DIK46LSg_16.status = setjmp(T_HZdw8BhppcTQo8DIK46LSg_16.context);
...
N_NIMCALL(Processobj_NHqciQYh8G1aN2n273mmYw*, nospstartProcess)(NimStringDesc* command0, NimStringDesc* workingdir0, NimStringDesc** args0, NI args0Len0, Stringtableobj_DKRIdH9c9cKI7YpQb9c0wKlEw* env0, Processoption_bnU6W8LhTMnT4JaSWtGlSA_Set options0) {
	...
	T_HZdw8BhppcTQo8DIK46LSg_13.status = setjmp(T_HZdw8BhppcTQo8DIK46LSg_13.context);
	if (T_HZdw8BhppcTQo8DIK46LSg_13.status == 0) {
		...
		T_HZdw8BhppcTQo8DIK46LSg_15.status = setjmp(T_HZdw8BhppcTQo8DIK46LSg_15.context);
							...
							{
								{
									...
									LOC71 = (*e_CnnTBizt4erFnIvznHIRgg).Sup.message; (*e_CnnTBizt4erFnIvznHIRgg).Sup.message = copyStringRC1(((NimStringDesc*) &T_HZdw8BhppcTQo8DIK46LSg_20));
							...
							{
								{
									...
									LOC103 = (*e_CnnTBizt4erFnIvznHIRgg_2).Sup.message; (*e_CnnTBizt4erFnIvznHIRgg_2).Sup.message = copyStringRC1(((NimStringDesc*) &T_HZdw8BhppcTQo8DIK46LSg_20));
...
N_NIMCALL(NI, nospexecCmd)(NimStringDesc* command0) {
	...
	result0 = ((NI) ((NI32)((NU32)(LOC1) >> (NU32)(((NI) 8)))));
	return result0;
}
		...
		m0 = ((n0 <= cmds0Len0) ? n0 : cmds0Len0);
		{
			...
			res_I72nYMiJcfiDqXF9cJLTlxQ = ((NI) 0);
			{
				while (1) {
					...
					{
						if (!!((beforerunevent0.ClPrc == T_HZdw8BhppcTQo8DIK46LSg_21.ClPrc && beforerunevent0.ClEnv == T_HZdw8BhppcTQo8DIK46LSg_21.ClEnv))) goto LA10;
						beforerunevent0.ClEnv? beforerunevent0.ClPrc(i_IXYJmgb9b21Zawh7ZZyHDAA, beforerunevent0.ClEnv):((T_HZdw8BhppcTQo8DIK46LSg_22)(beforerunevent0.ClPrc))(i_IXYJmgb9b21Zawh7ZZyHDAA);
					}
					LA10: ;
					...
					res_I72nYMiJcfiDqXF9cJLTlxQ_2 = ((NI) 0);
					{
						while (1) {
							...
							r_7CDX8QyPfnTM0rb4p9bm9blg = res_I72nYMiJcfiDqXF9cJLTlxQ_2;
							{
								...
								{
									if (!!((afterrunevent0.ClPrc == T_HZdw8BhppcTQo8DIK46LSg_23.ClPrc && afterrunevent0.ClEnv == T_HZdw8BhppcTQo8DIK46LSg_23.ClEnv))) goto LA26;
									afterrunevent0.ClEnv? afterrunevent0.ClPrc(r_7CDX8QyPfnTM0rb4p9bm9blg, q0->data[r_7CDX8QyPfnTM0rb4p9bm9blg], afterrunevent0.ClEnv):((T_HZdw8BhppcTQo8DIK46LSg_24)(afterrunevent0.ClPrc))(r_7CDX8QyPfnTM0rb4p9bm9blg, q0->data[r_7CDX8QyPfnTM0rb4p9bm9blg]);
								}
								LA26: ;
								{
								...
								LA30: ;
								{
									if (!!((beforerunevent0.ClPrc == T_HZdw8BhppcTQo8DIK46LSg_21.ClPrc && beforerunevent0.ClEnv == T_HZdw8BhppcTQo8DIK46LSg_21.ClEnv))) goto LA34;
									beforerunevent0.ClEnv? beforerunevent0.ClPrc(i0, beforerunevent0.ClEnv):((T_HZdw8BhppcTQo8DIK46LSg_25)(beforerunevent0.ClPrc))(i0);
								}
								LA34: ;
		...
		}
		{
			...
			res_I72nYMiJcfiDqXF9cJLTlxQ_3 = ((NI) 0);
			{
				while (1) {
					...
					{
						if (!!((afterrunevent0.ClPrc == T_HZdw8BhppcTQo8DIK46LSg_23.ClPrc && afterrunevent0.ClEnv == T_HZdw8BhppcTQo8DIK46LSg_23.ClEnv))) goto LA47;
						afterrunevent0.ClEnv? afterrunevent0.ClPrc(j_Qx3Y6Wjo6lf0L32X59altUg, q0->data[j_Qx3Y6Wjo6lf0L32X59altUg], afterrunevent0.ClEnv):((T_HZdw8BhppcTQo8DIK46LSg_26)(afterrunevent0.ClPrc))(j_Qx3Y6Wjo6lf0L32X59altUg, q0->data[j_Qx3Y6Wjo6lf0L32X59altUg]);
					}
					LA47: ;
					{
	...
	{
		{
			...
			res_I72nYMiJcfiDqXF9cJLTlxQ_4 = ((NI) 0);
			{
				while (1) {
					...
					{
						if (!!((beforerunevent0.ClPrc == T_HZdw8BhppcTQo8DIK46LSg_21.ClPrc && beforerunevent0.ClEnv == T_HZdw8BhppcTQo8DIK46LSg_21.ClEnv))) goto LA59;
						beforerunevent0.ClEnv? beforerunevent0.ClPrc(i_IXYJmgb9b21Zawh7ZZyHDAA_2, beforerunevent0.ClEnv):((T_HZdw8BhppcTQo8DIK46LSg_27)(beforerunevent0.ClPrc))(i_IXYJmgb9b21Zawh7ZZyHDAA_2);
					}
					LA59: ;
					...
					{
						if (!!((afterrunevent0.ClPrc == T_HZdw8BhppcTQo8DIK46LSg_23.ClPrc && afterrunevent0.ClEnv == T_HZdw8BhppcTQo8DIK46LSg_23.ClEnv))) goto LA65;
						afterrunevent0.ClEnv? afterrunevent0.ClPrc(i_IXYJmgb9b21Zawh7ZZyHDAA_2, p0, afterrunevent0.ClEnv):((T_HZdw8BhppcTQo8DIK46LSg_28)(afterrunevent0.ClPrc))(i_IXYJmgb9b21Zawh7ZZyHDAA_2, p0);
					}
					LA65: ;
					nospclose(p0);
