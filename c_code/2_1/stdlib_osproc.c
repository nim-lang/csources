...
N_NIMCALL(NCSTRING*, envtocstringarray_129604)(tstringtable122810* t) {
	...
	TMP366 = mulInt((NI32)(TMP365), 4);
	LOC2 = 0;
	LOC2 = alloc0_4616((NI32)(TMP366));
...
appendString(LOC8, val_129611);
			...
			memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI32)(TMP369));
...
N_NIMCALL(NCSTRING*, envtocstringarray_129641)(void) {
	...
	while (1) {
		...
		key_129645 = copyStrLast(environment_111806->data[i_129686], 0, (NI32)(TMP370));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_129686) >= (NU)(environment_111806->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP371 = addInt(p_129692, 1);
		val_129646 = copyStr(environment_111806->data[i_129686], (NI32)(TMP371));
	...
	TMP373 = mulInt((NI32)(TMP372), 4);
	LOC2 = 0;
	LOC2 = alloc0_4616((NI32)(TMP373));
	result = ((NCSTRING*) (LOC2));
	...
	while (1) {
		...
		key_129665 = copyStrLast(environment_111806->data[i_129702], 0, (NI32)(TMP374));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_129702) >= (NU)(environment_111806->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP375 = addInt(p_129708, 1);
		val_129666 = copyStr(environment_111806->data[i_129702], (NI32)(TMP375));
...
appendString(LOC4, val_129666);
		...
		memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI32)(TMP377));
...
N_NIMCALL(void, pruneprocessset_131634)(TY129203** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(924, "osproc.nim");
		{
			...
			nimln(925, "osproc.nim");
			TMP390 = subInt(l, 1);
			if ((NU)((NI32)(TMP390)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRef((void**) &(*s)->data[i], (*s)->data[(NI32)(TMP390)]);
...
N_NIMCALL(NI, select_129521)(TY129203** readfds, NI timeout) {
	...
	nimln(940, "osproc.nim");
	{
		...
		TMP392 = addInt(m, 1);
		LOC5 = 0;
		LOC5 = select(((int) ((NI32)(TMP392))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		TMP393 = addInt(m, 1);
		LOC7 = 0;
		LOC7 = select(((int) ((NI32)(TMP393))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
