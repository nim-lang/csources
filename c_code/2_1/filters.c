	...
	while (1) {
		...
		nimln(31, "filters.nim");
		{
			...
			nimln(32, "filters.nim");
			{
				...
				if (((TMP2645[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2646));
				if ((NU)(i_217074) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP2645[(*(*n).kindU.S6.Sons->data[i_217074]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_217074]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2646));
			...
			nimln(33, "filters.nim");
			{
				...
				if (((TMP2645[(*(*n).kindU.S6.Sons->data[i_217074]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_217074]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2646));
				if ((NU)(0) >= (NU)((*(*n).kindU.S6.Sons->data[i_217074]).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (!(((TMP2648[(*(*(*n).kindU.S6.Sons->data[i_217074]).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*(*n).kindU.S6.Sons->data[i_217074]).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2649));
				LOC17 = 0;
...
N_NIMCALL(NIM_BOOL, boolarg_217028)(tnode186813* n, NimStringDesc* name, NI pos, NIM_BOOL default_217033) {
	...
	LA3: ;
	{
		...
		LOC6 = identeq_166469((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2654));
		LA7: ;
		if (!LOC6) goto LA8;
		nimln(53, "filters.nim");
		result = NIM_TRUE;
	...
	LA8: ;
	{
		...
		nimln(54, "filters.nim");
		if (!(((TMP2648[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2649));
		LOC11 = identeq_166469((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2655));
		LA12: ;
		if (!LOC11) goto LA13;
		nimln(54, "filters.nim");
		result = NIM_FALSE;
...
N_NIMCALL(tllstream174204*, filterstrip_217008)(tllstream174204* stdin_217010, NimStringDesc* filename, tnode186813* call) {
	...
	pattern = strarg_217021(call, ((NimStringDesc*) &TMP2656), 1, ((NimStringDesc*) &TMP2657));
	nimln(59, "filters.nim");
	leading = boolarg_217028(call, ((NimStringDesc*) &TMP2658), 2, NIM_TRUE);
	nimln(60, "filters.nim");
	trailing = boolarg_217028(call, ((NimStringDesc*) &TMP2659), 3, NIM_TRUE);
	nimln(61, "filters.nim");
	result = llstreamopen_174218(((NimStringDesc*) &TMP2657));
...
N_NIMCALL(tllstream174204*, filterreplace_217002)(tllstream174204* stdin_217004, NimStringDesc* filename, tnode186813* call) {
	...
	sub = strarg_217021(call, ((NimStringDesc*) &TMP2661), 1, ((NimStringDesc*) &TMP2657));
	...
	by = strarg_217021(call, ((NimStringDesc*) &TMP2662), 2, ((NimStringDesc*) &TMP2657));
