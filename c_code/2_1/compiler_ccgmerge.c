...
NIM_CONST TY457013 Cfilesectionnames_457012 = {((NimStringDesc*) &TMP4274),
...
NIM_CONST TY457019 Cprocsectionnames_457018 = {((NimStringDesc*) &TMP4292),
...
N_NIMCALL(void, readkey_457466)(Tbaselexer179024* L, NimStringDesc** result) {
	...
	}
	{
		...
		internalerror_165234(((NimStringDesc*) &TMP4195));
	}
	LA5: ;
...
N_NIMCALL(void, readtypecache_457524)(Tbaselexer179024* L, Tidtable191861* result) {
	{
		...
		internalerror_165234(((NimStringDesc*) &TMP4202));
	}
	LA3: ;
	(*L).bufpos += ((NI) 1);
	{
...
appendString(r, tnl_159626);
			...
			case 0:
			{
				internalerror_165234(((NimStringDesc*) &TMP4272));
				goto LA1;
			}
			break;
			default:
...
appendString(LOC34, k);
			...
			LA18: ;
			{
				internalerror_165234(((NimStringDesc*) &TMP4296));
			}
			LA11: ;
		}
	} LA5: ;
...
N_NIMCALL(Ropeobj161009*, gensectionstart_457106)(NU8 ps) {
	...
	result = 0;
	{
		...
		add_161545(&result, ((NimStringDesc*) &TMP4300));
		add_161545(&result, Cprocsectionnames_457018[(ps)- 0]);
		add_161545(&result, ((NimStringDesc*) &TMP4301));
