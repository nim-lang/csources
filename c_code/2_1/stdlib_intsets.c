...
N_NIMCALL(void, incl_270832_2627731572)(Intset270030* s0, NI key0) {
	Trunk270026* t0;
	NI u0;
	t0 = intsetput_270661_2627731572(s0, (NI)((NU32)(key0) >> (NU32)(((NI) 9))));
	u0 = (NI)(key0 & ((NI) 511));
...
N_NIMCALL(NIM_BOOL, containsorincl_270862_2627731572)(Intset270030* s0, NI key0) {
	...
	Trunk270026* t0;
	result0 = (NIM_BOOL)0;
	t0 = intsetget_270206_2627731572((*s0), (NI)((NU32)(key0) >> (NU32)(((NI) 9))));
	{
		NI u0;
...
N_NIMCALL(void, assign_270941_2627731572)(Intset270030* dest0, Intset270030 src0) {
	...
	it0 = src0.head;
	{
		while (1) {
			...
			(*n0).key = (*it0).key;
			memcpy((void*)(*n0).bits, (NIM_CONST void*)(*it0).bits, sizeof(TY29418));
