...
static NIM_CONST TY172865 TMP3125 = {
...
N_NIMCALL(void, openpasses_223243)(tpasscontext223003** a, tsym172689* module) {
	...
	nimln(111, "passes.nim");
	TMP3127 = subInt(gpasseslen_223161, 1);
	HEX3Atmp_223264 = (NI32)(TMP3127);
...
N_NIMCALL(void, openpassescached_223271)(tpasscontext223003** a, tsym172689* module, trodreader212023* rd) {
	...
	nimln(117, "passes.nim");
	TMP3128 = subInt(gpasseslen_223161, 1);
	HEX3Atmp_223305 = (NI32)(TMP3128);
	nimln(1301, "system.nim");
	res_223307 = 0;
	nimln(1302, "system.nim");
	while (1) {
...
N_NIMCALL(void, closepasses_223312)(tpasscontext223003** a) {
	...
	nimln(127, "passes.nim");
	TMP3129 = subInt(gpasseslen_223161, 1);
	HEX3Atmp_223334 = (NI32)(TMP3129);
	nimln(1301, "system.nim");
	res_223336 = 0;
	nimln(1302, "system.nim");
	while (1) {
...
NTI223003.flags = 3;
TMP3013[0].kind = 1;
TMP3013[0].offset = offsetof(tpasscontext223003, Fromcache);
TMP3013[0].typ = (&NTI133);
TMP3013[0].name = "fromCache";
NTI223003.node = &TMP3013[0];
}
