...
typedef NIM_CHAR TY98575[6];
typedef NIM_CHAR TY98578[2501];
typedef NIM_CHAR TY98570[3];
...
NIM_CONST TY98570 floatformattochar_98569 = {103,
102,
101}
;
	...
	val = ((NU8)(c));
	{
		...
		res_94592 = 2;
		{
			while (1) {
				...
				i_94577 = res_94592;
				result->data[i_94577] = ((NIM_CHAR) (((NI) ((NI32)(((NI) ((NI32)(((NI) (val)) % 8))) + 48)))));
...
N_NOINLINE(void, invalidformatstring_98671)(void) {
	...
	NimStringDesc* LOC1;
	e_98675 = 0;
	e_98675 = (valueerror3249*) newObj((&NTI21201), sizeof(valueerror3249));
	(*e_98675).Sup.Sup.m_type = (&NTI3249);
	LOC1 = 0;
	LOC1 = (*e_98675).Sup.message; (*e_98675).Sup.message = copyStringRC1(((NimStringDesc*) &TMP153));
...
N_NIMCALL(NI, nsuFindChar)(NimStringDesc* s, NIM_CHAR sub, NI start) {
	...
	result = 0;
	{
		...
		i_96908 = 0;
		HEX3Atmp_96910 = 0;
		HEX3Atmp_96910 = (NI32)(s->Sup.len - 1);
		res_96913 = start;
		{
			while (1) {
...
N_NIMCALL(void, preprocesssub_96748)(NimStringDesc* sub, NI* a) {
	...
	m = sub->Sup.len;
	{
		...
		res_96780 = 0;
		{
			while (1) {
				...
				i_96765 = res_96780;
				a[(((NU8)(((NIM_CHAR) (((NI) (i_96765)))))))- 0] = (NI32)(m + 1);
				res_96780 += 1;
			} LA3: ;
		}
	}
	{
		...
		i_96776 = 0;
		HEX3Atmp_96783 = 0;
		HEX3Atmp_96783 = (NI32)(m - 1);
		res_96786 = 0;
		{
			while (1) {
				if (!(res_96786 <= HEX3Atmp_96783)) goto LA6;
				i_96776 = res_96786;
				a[(((NU8)(sub->data[i_96776])))- 0] = (NI32)(m - i_96776);
				res_96786 += 1;
			} LA6: ;
		}
	}
			...
			{
				{
					...
					res_96851 = 0;
					{
						while (1) {
							...
							k_96833 = res_96851;
							{
								if (!!(((NU8)(sub->data[k_96833]) == (NU8)(s->data[(NI32)(k_96833 + j)])))) goto LA9;
								goto LA3;
							}
							LA9: ;
							res_96851 += 1;
...
N_NIMCALL(NimStringDesc*, nsuToBin)(NI64 x, NI len) {
	...
	result = mnewString(len);
	{
		...
		j_97812 = 0;
		HEX3Atmp_97824 = 0;
		HEX3Atmp_97824 = (NI32)(len - 1);
		res_97827 = HEX3Atmp_97824;
		{
			while (1) {
				if (!(0 <= res_97827)) goto LA3;
				j_97812 = res_97827;
				result->data[j_97812] = ((NIM_CHAR) (((NI) ((NI32)(((NI) ((NI64)((NU64)((NI64)(x & mask)) >> (NU64)(shift)))) + 48)))));
				shift = (NI64)(shift + 1);
...
N_NIMCALL(NimStringDesc*, nsuToOct)(NI64 x, NI len) {
	...
	result = mnewString(len);
	{
		...
		j_97612 = 0;
		HEX3Atmp_97624 = 0;
		HEX3Atmp_97624 = (NI32)(len - 1);
		res_97627 = HEX3Atmp_97624;
		{
			while (1) {
				if (!(0 <= res_97627)) goto LA3;
				j_97612 = res_97627;
				result->data[j_97612] = ((NIM_CHAR) (((NI) ((NI32)(((NI) ((NI64)((NU64)((NI64)(x & mask)) >> (NU64)(shift)))) + 48)))));
				shift = (NI64)(shift + 3);
...
N_NIMCALL(NI, nsuFindCharSet)(NimStringDesc* s, TY212607 chars, NI start) {
	...
	result = 0;
	{
		...
		i_96947 = 0;
		HEX3Atmp_96962 = 0;
		HEX3Atmp_96962 = (NI32)(s->Sup.len - 1);
		res_96965 = start;
		{
			while (1) {
...
N_NIMCALL(NimStringDesc*, nsuToLowerStr)(NimStringDesc* s) {
	...
	result = mnewString(s->Sup.len);
	{
		...
		i_94094 = 0;
		HEX3Atmp_94096 = 0;
		HEX3Atmp_94096 = (NI32)(s->Sup.len - 1);
		res_94099 = 0;
		{
			while (1) {
...
N_NIMCALL(NimStringDesc*, nsuNormalize)(NimStringDesc* s) {
	...
	j = 0;
	{
		...
		i_94228 = 0;
		HEX3Atmp_94295 = 0;
		HEX3Atmp_94295 = (NI32)(s->Sup.len - 1);
		res_94298 = 0;
		{
			while (1) {
				...
				i_94228 = res_94298;
				{
					...
					result->data[j] = ((NIM_CHAR) (((NI) ((NI32)(((NI) (((NU8)(s->data[i_94228])))) + 32)))));
					j += 1;
				}
				goto LA4;
				LA6: ;
		...
		last_95472 = 0;
		{
			if (!(0 < s->Sup.len)) goto LA4;
			{
				while (1) {
					...
					x_95429 = copyStrLast(s, first_95474, (NI32)(last_95472 - 1));
...
appendString(result, prefix);
	{
		...
		{
			while (1) {
				if (!(i_97949 < l_97951)) goto LA3;
				c_97937 = s->data[i_97949];
				switch (((NU8)(c_97937))) {
				case 0 ... 31:
				case 128 ... 255:
				{
...
appendString(result, ((NimStringDesc*) &TMP2099));
					LOC5 = 0;
					LOC5 = nsuToHex(((NI64) (((NU8)(c_97937)))), 2);
...
N_NIMCALL(NimStringDesc*, nsuIntToStr)(NI x, NI minchars) {
	...
	result = nimIntToStr((x > 0? (x) : -(x)));
	{
		...
		i_95626 = 0;
		HEX3Atmp_95629 = 0;
		HEX3Atmp_95629 = (NI32)(minchars - result->Sup.len);
		res_95632 = 1;
		{
			while (1) {
				NimStringDesc* LOC4;
...
N_NIMCALL(NimStringDesc*, nsuformatBiggestFloat)(NF f, NU8 format, NI precision) {
	...
	frmtstr[(0)- 0] = 37;
	{
		...
		frmtstr[(2)- 0] = 46;
		frmtstr[(3)- 0] = 42;
		frmtstr[(4)- 0] = floatformattochar_98569[(format)- 0];
		frmtstr[(5)- 0] = 0;
	...
	LA3: ;
	{
		frmtstr[(1)- 0] = floatformattochar_98569[(format)- 0];
		frmtstr[(2)- 0] = 0;
...
N_NIMCALL(NimStringDesc*, nsuInsertSep)(NimStringDesc* s, NIM_CHAR sep, NI digits) {
	...
	l -= 1;
	{
		...
		i_97874 = 0;
		HEX3Atmp_97912 = 0;
		HEX3Atmp_97912 = (NI32)(s->Sup.len - 1);
		res_97915 = HEX3Atmp_97912;
		{
			while (1) {
				if (!(0 <= res_97915)) goto LA3;
				i_97874 = res_97915;
				{
...
N_NIMCALL(NimStringDesc*, formatsize_98604)(NI64 bytes, NIM_CHAR decimalsep) {
	...
	{
		NimStringDesc* bs_98627;
		NimStringDesc* LOC5;
		NimStringDesc* LOC6;
		NimStringDesc* LOC7;
		NimStringDesc* LOC8;
		if (!!((gigabytes == 0))) goto LA3;
		bs_98627 = nimInt64ToStr(megabytes);
		LOC5 = 0;
		LOC6 = 0;
...
appendString(LOC5, ((NimStringDesc*) &TMP4849));
	...
	LA3: ;
	{
		NimStringDesc* bs_98629;
		NimStringDesc* LOC12;
		NimStringDesc* LOC13;
		NimStringDesc* LOC14;
		NimStringDesc* LOC15;
		if (!!((megabytes == 0))) goto LA10;
		bs_98629 = nimInt64ToStr(kilobytes);
		LOC12 = 0;
		LOC13 = 0;
		...
		LOC15 = 0;
		LOC15 = copyStrLast(bs_98629, 0, 2);
...
appendString(LOC12, ((NimStringDesc*) &TMP4850));
	...
	LA10: ;
	{
		NimStringDesc* bs_98631;
		NimStringDesc* LOC19;
		NimStringDesc* LOC20;
		NimStringDesc* LOC21;
		NimStringDesc* LOC22;
		if (!!((kilobytes == 0))) goto LA17;
		bs_98631 = nimInt64ToStr(bytes);
		LOC19 = 0;
		LOC20 = 0;
		...
		LOC22 = 0;
		LOC22 = copyStrLast(bs_98631, 0, 2);
