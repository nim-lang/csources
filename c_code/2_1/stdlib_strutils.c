...
STRING_LITERAL(TMP155, "invalid format string", 21);
STRING_LITERAL(TMP1075, "invalid float: ", 15);
STRING_LITERAL(TMP1268, "invalid integer: ", 17);
STRING_LITERAL(TMP1411, "0123456789ABCDEF", 16);
STRING_LITERAL(TMP1413, "", 0);
STRING_LITERAL(TMP2114, "\\x", 2);
...
101}
;
STRING_LITERAL(TMP5293, "GB", 2);
STRING_LITERAL(TMP5294, "MB", 2);
STRING_LITERAL(TMP5295, "KB", 2);
STRING_LITERAL(TMP5296, "B", 1);
...
N_NOINLINE(void, invalidformatstring_102542)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_102547).Sup.message; (*e_102547).Sup.message = copyStringRC1(((NimStringDesc*) &TMP155));
...
appendString(LOC7, ((NimStringDesc*) &TMP1075));
appendString(LOC7, s);
...
appendString(LOC7, ((NimStringDesc*) &TMP1268));
appendString(LOC7, s);
	...
	result = mnewString(((NI) (len)));
	{
		...
		res_99620 = ((NI) (HEX3Atmp_99617));
		{
			while (1) {
				...
				result->data[j_99614] = ((NimStringDesc*) &TMP1411)->data[(NI64)(n & IL64(15))];
...
N_NIMCALL(NimStringDesc*, nsuReplaceStr)(NimStringDesc* s, NimStringDesc* sub, NimStringDesc* by) {
	...
	NimStringDesc* LOC8;
	result = 0;
	result = copyString(((NimStringDesc*) &TMP1413));
...
appendString(LOC20, ((NimStringDesc*) &TMP1268));
...
appendString(LOC19, ((NimStringDesc*) &TMP5295));
		result = LOC19;
	}
	goto LA1;
	LA17: ;
...
appendString(LOC24, ((NimStringDesc*) &TMP5296));
		result = LOC24;
	}
	LA1: ;
	return result;
