...
static NIM_CONST TY172865 TMP3059 = {
...
N_NIMCALL(NIM_BOOL, inset_219013)(tnode172659* s, tnode172659* elem) {
	...
	nimln(34, "nimsets.nim");
	{
		...
		internalerror_139369((*s).Info, ((NimStringDesc*) &TMP3058));		nimln(36, "nimsets.nim");
	...
	while (1) {
		...
		nimln(38, "nimsets.nim");
		{
			...
			nimln(39, "nimsets.nim");
			{
				...
				if (((TMP3059[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3060));
				if ((NU)(i_219090) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP3059[(*(*s).kindU.S6.Sons->data[i_219090]).Kind/8] &(1<<((*(*s).kindU.S6.Sons->data[i_219090]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3060));
...
N_NIMCALL(NIM_BOOL, someinset_219018)(tnode172659* s, tnode172659* a, tnode172659* b) {
	...
	nimln(63, "nimsets.nim");
	{
		...
		internalerror_139369((*s).Info, ((NimStringDesc*) &TMP3062));		nimln(65, "nimsets.nim");
	...
	while (1) {
		...
		nimln(67, "nimsets.nim");
		{
			...
			nimln(68, "nimsets.nim");
			{
				...
				if (((TMP3059[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3060));
				if ((NU)(i_219314) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP3059[(*(*s).kindU.S6.Sons->data[i_219314]).Kind/8] &(1<<((*(*s).kindU.S6.Sons->data[i_219314]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3060));
...
N_NIMCALL(void, tobitset_219002)(tnode172659* s, tbitset218010** b) {
	...
	while (1) {
		...
		nimln(82, "nimsets.nim");
		{
			...
			if (((TMP3059[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3060));
			if ((NU)(i_219467) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (((TMP3059[(*(*s).kindU.S6.Sons->data[i_219467]).Kind/8] &(1<<((*(*s).kindU.S6.Sons->data[i_219467]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3060));
			...
			while (1) {
				...
				bitsetincl_218045(b, (NI64)(TMP3065));				nimln(86, "nimsets.nim");
				j = addInt64(j, 1);
			} LA8: ;
		}		goto LA4;
		LA6: ;
		{
			...
			bitsetincl_218045(b, (NI64)(TMP3066));		}		LA4: ;
		nimln(1304, "system.nim");
...
N_NIMCALL(tnode172659*, totreeset_219562)(tbitset218010* s, ttype172693* settype, tlineinfo137509 info) {
	...
	while (1) {
		...
		if (!(e < ((NI64) ((NI32)(TMP3067))))) goto LA1;
		nimln(102, "nimsets.nim");
		{
			...
			nimln(109, "nimsets.nim");
			{
				...
				LOC19 = 0;
				LOC19 = newinttypenode_172915(((NU8) 6), (NI64)(TMP3069), elemtype);
			...
			LA17: ;
			{
				...
				LOC21 = 0;
				LOC21 = newinttypenode_172915(((NU8) 6), (NI64)(TMP3070), elemtype);
				addson_173048(n, LOC21);				nimln(115, "nimsets.nim");
				nimln(115, "nimsets.nim");
				nimln(115, "nimsets.nim");
				TMP3071 = addInt64(b, first);
				LOC22 = 0;
				LOC22 = newinttypenode_172915(((NU8) 6), (NI64)(TMP3071), elemtype);
...
N_NIMCALL(NI64, cardset_219063)(tnode172659* s) {
	...
	while (1) {
		...
		nimln(155, "nimsets.nim");
		{
			...
			if (((TMP3059[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3060));
			if ((NU)(i_219757) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (((TMP3059[(*(*s).kindU.S6.Sons->data[i_219757]).Kind/8] &(1<<((*(*s).kindU.S6.Sons->data[i_219757]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3060));
...
N_NIMCALL(NIM_BOOL, sethasrange_219029)(tnode172659* s) {
	...
	nimln(162, "nimsets.nim");
	{
		...
		internalerror_139369((*s).Info, ((NimStringDesc*) &TMP3076));		nimln(164, "nimsets.nim");
