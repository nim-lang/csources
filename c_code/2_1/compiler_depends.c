...
STRING_LITERAL(TMP4833, "$1 -> $2;$n", 11);
STRING_LITERAL(TMP4834, "digraph $1 {$n$2}$n", 19);
...
N_NIMCALL(void, adddependencyaux_538028)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	appf_179115(&gdotgraph_538023, ((NimStringDesc*) &TMP4833), LOC1, 2);
}
...
N_NIMCALL(void, generatedot_538009)(NimStringDesc* project) {
	...
	LOC3 = 0;
	LOC3 = noschangeFileExt(LOC2, ((NimStringDesc*) &TMP4835));
	LOC1[0] = torope_179076(LOC3);
	LOC1[1] = gdotgraph_538023;
	LOC4 = 0;
	LOC4 = ropef_179107(((NimStringDesc*) &TMP4834), LOC1, 2);
	LOC5 = 0;
	LOC5 = noschangeFileExt(project, ((NimStringDesc*) &TMP4836));
