...
N_NIMCALL(void, handlecmdline_537601)(void);
...
N_NIMCALL(NimStringDesc*, prependcurdir_537401)(NimStringDesc* f);
...
STRING_LITERAL(TMP2028, "", 0);
STRING_LITERAL(TMP2029, "-", 1);
STRING_LITERAL(TMP2030, "stdinfile", 9);
STRING_LITERAL(TMP2059, "nim.cfg", 7);
STRING_LITERAL(TMP2060, "nims", 4);
STRING_LITERAL(TMP3723, "config.nims", 11);
STRING_LITERAL(TMP5311, "./", 2);
STRING_LITERAL(TMP5312, "js", 2);
...
appendString(LOC7, ((NimStringDesc*) &TMP5311));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
{	{
		...
		writecommandlineusage_201005();
	}
	goto LA1;
	LA4: ;
	{
		NimStringDesc* scriptfile;
		processcmdline_531203(((NU8) 0), ((NimStringDesc*) &TMP2028));
		{
			NimStringDesc* LOC11;
			NimStringDesc* LOC12;
			if (!eqStrings(gprojectname_161199, ((NimStringDesc*) &TMP2029))) goto LA9;
			LOC11 = 0;
			LOC11 = gprojectname_161199; gprojectname_161199 = copyStringRC1(((NimStringDesc*) &TMP2030));
			if (LOC11) nimGCunrefNoCycle(LOC11);
			LOC12 = 0;
			LOC12 = gprojectfull_161201; gprojectfull_161201 = copyStringRC1(((NimStringDesc*) &TMP2030));
			if (LOC12) nimGCunrefNoCycle(LOC12);
			asgnRefNoCycle((void**) (&gprojectpath_161200), nosgetCurrentDir());
			gprojectisstdin_161202 = NIM_TRUE;
		}
		goto LA7;
		LA9: ;
		{
			...
			NimStringDesc* LOC20;
			NimStringDesc* LOC21;
			if (!!(((gprojectname_161199) && (gprojectname_161199)->Sup.len == 0))) goto LA14;
			pushSafePoint(&TMP2031);
			TMP2031.status = setjmp(TMP2031.context);
			if (TMP2031.status == 0) {
				asgnRefNoCycle((void**) (&gprojectfull_161201), canonicalizepath_161405(gprojectname_161199));
				popSafePoint();
			}
			else {
				popSafePoint();
				if (isObj(getCurrentException()->Sup.m_type, (&NTI3630))) {
					...
					TMP2031.status = 0;
					LOC19 = 0;
					LOC19 = gprojectfull_161201; gprojectfull_161201 = copyStringRC1(gprojectname_161199);
					if (LOC19) nimGCunrefNoCycle(LOC19);
					popCurrentException();
				}
			}
			if (TMP2031.status != 0) reraiseException();
			memset((void*)(&p), 0, sizeof(p));
			chckNil((void*)(&p));
			memset((void*)(&p), 0, sizeof(p));
			nossplitFile(gprojectfull_161201, (&p));
			LOC20 = 0;
			LOC20 = gprojectpath_161200; gprojectpath_161200 = copyStringRC1(p.Field0);
			if (LOC20) nimGCunrefNoCycle(LOC20);
			LOC21 = 0;
			LOC21 = gprojectname_161199; gprojectname_161199 = copyStringRC1(p.Field1);
		...
		LA7: ;
		loadconfigs_211603(((NimStringDesc*) &TMP2059));
		scriptfile = noschangeFileExt(gprojectfull_161201, ((NimStringDesc*) &TMP2060));
		{
			NIM_BOOL LOC25;
			LOC25 = 0;
			LOC25 = fileexists_121804(scriptfile);
			if (!LOC25) goto LA26;
			runnimscript_536202(scriptfile);
			{
				if (!eqStrings(scriptfile, gprojectfull_161201)) goto LA30;
				goto BeforeRet;
			}
			LA30: ;
		}
		...
		LA26: ;
		{
			...
			NimStringDesc* LOC37;
			LOC33 = 0;
			LOC33 = HEX2F_118465(gprojectpath_161200, ((NimStringDesc*) &TMP3723));
			LOC34 = 0;
			LOC34 = fileexists_121804(LOC33);
			if (!LOC34) goto LA35;
			LOC37 = 0;
			LOC37 = HEX2F_118465(gprojectpath_161200, ((NimStringDesc*) &TMP3723));
			runnimscript_536202(LOC37);
		}
		goto LA23;
		LA35: ;
		LA23: ;
		initvars_195834();
		processcmdline_531203(((NU8) 1), ((NimStringDesc*) &TMP2028));
		{
			if (!((command_161205) && (command_161205)->Sup.len == 0)) goto LA40;
			rawmessage_186612(((NU16) 184), command_161205);
		}
		LA40: ;
		maincommand_533610();
		{
			...
			NimStringDesc* LOC48;
			LOC44 = 0;
			LOC44 = ((goptions_161119 &(1U<<((NU)(((NU8) 12))&31U)))!=0);
			if (!(LOC44)) goto LA45;
			LOC44 = ((gnotes_184080 &((NU64)1<<((NU)((((NU16) 289)- 237))&63U)))!=0);
			LA45: ;
			if (!LOC44) goto LA46;
			LOC48 = 0;
		...
		LA46: ;
		{
			if (!(gerrorcounter_184081 == ((NI) 0))) goto LA51;
			{
				if (!((gglobaloptions_161121 &(1U<<((NU)(((NU8) 13))&31U)))!=0)) goto LA55;
				{
					NimStringDesc* ex;
					NimStringDesc* LOC70;
					NimStringDesc* LOC71;
					if (!(gcmd_161123 == ((NU8) 4))) goto LA59;
					ex = 0;
					{
						NimStringDesc* LOC65;
						if (!(((NI) 0) < (outfile_161127 ? outfile_161127->Sup.len : 0))) goto LA63;
						LOC65 = 0;
						LOC65 = prependcurdir_537401(outfile_161127);
					...
					LA63: ;
					{
						...
						NimStringDesc* LOC69;
						LOC67 = 0;
						LOC67 = noschangeFileExt(gprojectfull_161201, ((NimStringDesc*) &TMP5312));
						LOC68 = 0;
						LOC68 = prependcurdir_537401(LOC67);
						LOC69 = 0;
						LOC69 = completecfilepath_195854(LOC68, NIM_TRUE);
						ex = nospquoteShell(LOC69);
					}
					LA61: ;
					LOC70 = 0;
					LOC71 = 0;
					LOC71 = findnodejs_535003();
					LOC70 = rawNewString(LOC71->Sup.len + ex->Sup.len + arguments_202699->Sup.len + 2);
appendString(LOC70, LOC71);
appendString(LOC70, ((NimStringDesc*) &TMP5316));
appendString(LOC70, ex);
appendChar(LOC70, 32);
appendString(LOC70, arguments_202699);
					execexternalprogram_195881(LOC70, ((NU16) 284));
				}
				goto LA57;
				LA59: ;
				{
					...
					binpath = 0;
					{
						if (!(((NI) 0) < (outfile_161127 ? outfile_161127->Sup.len : 0))) goto LA75;
						binpath = prependcurdir_537401(outfile_161127);
					}
					goto LA73;
					LA75: ;
					{
						NimStringDesc* LOC78;
						LOC78 = 0;
						LOC78 = noschangeFileExt(gprojectfull_161201, ((NimStringDesc*) &TMP2028));
						binpath = prependcurdir_537401(LOC78);
					}
					LA73: ;
					ex = nospquoteShell(binpath);
					LOC79 = 0;
					LOC79 = rawNewString(ex->Sup.len + arguments_202699->Sup.len + 1);
appendString(LOC79, ex);
appendChar(LOC79, 32);
appendString(LOC79, arguments_202699);
					execexternalprogram_195881(LOC79, ((NU16) 284));
				}
				LA57: ;
			}
			LA55: ;
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	...
	initdefines_191184();
	handlecmdline_537601();
	msgquit_184152(((NI8) ((((NI) 0) < gerrorcounter_184081))));
}
