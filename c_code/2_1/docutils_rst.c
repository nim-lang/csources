...
typedef tkeyvaluepair120806 TY296074[34];
...
N_NIMCALL(void, TMP2321)(void* p, NI op);
N_NIMCALL(void, TMP2333)(void* p, NI op);
N_NIMCALL(void, TMP2334)(void* p, NI op);
N_NIMCALL(void, TMP2335)(void* p, NI op);
...
N_NIMCALL(void, TMP2354)(void* p, NI op);
...
N_NIMCALL(void, getthing_296138)(tlexer296118* l, ttoken296114* tok, TY90161 s);
...
STRING_LITERAL(TMP1987, "", 0);
STRING_LITERAL(TMP2068, "\001\001", 2);
NIM_CONST struct {
  TGenericSeq Sup;
  NI data[1];
} CNSTSEQ2338 = {{1, 1}, {0}};
NIM_CONST TY296698* TMP2336 = ((TY296698*)&CNSTSEQ2338);
STRING_LITERAL(TMP2341, "cannot open \'$1\'", 16);
STRING_LITERAL(TMP2342, "\'$1\' expected", 13);
STRING_LITERAL(TMP2343, "grid table is not implemented", 29);
STRING_LITERAL(TMP2344, "new section expected", 20);
STRING_LITERAL(TMP2345, "general parse error", 19);
STRING_LITERAL(TMP2346, "invalid directive: \'$1\'", 23);
STRING_LITERAL(TMP2347, "redefinition of label \'$1\'", 26);
STRING_LITERAL(TMP2348, "unknown substitution \'$1\'", 25);
STRING_LITERAL(TMP2349, "language \'$1\' not supported", 27);
NIM_CONST TY296045 messages_296044 = {((NimStringDesc*) &TMP2341),
...
;
STRING_LITERAL(TMP2350, "$1($2, $3) $4: $5", 17);
STRING_LITERAL(TMP2355, "\012", 1);
...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
static NIM_CONST TY90161 TMP2358 = {
0x00, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2359, "#", 1);
static NIM_CONST TY90161 TMP2360 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x03,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2361, "ii", 2);
STRING_LITERAL(TMP2362, " a", 2);
STRING_LITERAL(TMP2363, "i", 1);
STRING_LITERAL(TMP2364, "ai", 2);
STRING_LITERAL(TMP2365, "::", 2);
STRING_LITERAL(TMP2366, "+", 1);
STRING_LITERAL(TMP2367, "*", 1);
STRING_LITERAL(TMP2368, "-", 1);
STRING_LITERAL(TMP2369, "|", 1);
STRING_LITERAL(TMP2370, "..", 2);
STRING_LITERAL(TMP2371, ":w:", 3);
STRING_LITERAL(TMP2372, "(e) ", 4);
STRING_LITERAL(TMP2373, "+a+", 3);
STRING_LITERAL(TMP2374, "-w", 2);
STRING_LITERAL(TMP2375, "--w", 3);
STRING_LITERAL(TMP2376, "/w", 2);
STRING_LITERAL(TMP2377, "//w", 3);
STRING_LITERAL(TMP2378, "e) ", 3);
STRING_LITERAL(TMP2379, "e. ", 3);
STRING_LITERAL(TMP2380, "author", 6);
STRING_LITERAL(TMP2381, "authors", 7);
STRING_LITERAL(TMP2382, "code-block", 10);
STRING_LITERAL(TMP2383, "container", 9);
STRING_LITERAL(TMP2384, "contents", 8);
STRING_LITERAL(TMP2385, "figure", 6);
STRING_LITERAL(TMP2386, "image", 5);
STRING_LITERAL(TMP2387, "include", 7);
STRING_LITERAL(TMP2388, "index", 5);
STRING_LITERAL(TMP2389, "raw", 3);
STRING_LITERAL(TMP2390, "title", 5);
NIM_CONST TY299215 dirids_299214 = {((NimStringDesc*) &TMP1987),
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2392, "\\", 1);
STRING_LITERAL(TMP2393, "***", 3);
static NIM_CONST TY90161 TMP2394 = {
...
STRING_LITERAL(TMP2398, "**", 2);
STRING_LITERAL(TMP2399, "```", 3);
STRING_LITERAL(TMP2400, "`", 1);
STRING_LITERAL(TMP2401, "_", 1);
STRING_LITERAL(TMP2402, ">", 1);
STRING_LITERAL(TMP2403, "<", 1);
STRING_LITERAL(TMP2404, "idx", 3);
STRING_LITERAL(TMP2405, "literal", 7);
STRING_LITERAL(TMP2406, "strong", 6);
STRING_LITERAL(TMP2407, "emphasis", 8);
STRING_LITERAL(TMP2408, "sub", 3);
STRING_LITERAL(TMP2409, "subscript", 9);
STRING_LITERAL(TMP2410, "sup", 3);
STRING_LITERAL(TMP2411, "supscript", 9);
STRING_LITERAL(TMP2412, ":D", 2);
STRING_LITERAL(TMP2413, "icon_e_biggrin", 14);
STRING_LITERAL(TMP2414, ":-D", 3);
STRING_LITERAL(TMP2415, ":)", 2);
STRING_LITERAL(TMP2416, "icon_e_smile", 12);
STRING_LITERAL(TMP2417, ":-)", 3);
STRING_LITERAL(TMP2418, ";)", 2);
STRING_LITERAL(TMP2419, "icon_e_wink", 11);
STRING_LITERAL(TMP2420, ";-)", 3);
STRING_LITERAL(TMP2421, ":(", 2);
STRING_LITERAL(TMP2422, "icon_e_sad", 10);
STRING_LITERAL(TMP2423, ":-(", 3);
STRING_LITERAL(TMP2424, ":o", 2);
STRING_LITERAL(TMP2425, "icon_e_surprised", 16);
STRING_LITERAL(TMP2426, ":-o", 3);
STRING_LITERAL(TMP2427, ":shock:", 7);
STRING_LITERAL(TMP2428, "icon_eek", 8);
STRING_LITERAL(TMP2429, ":?", 2);
STRING_LITERAL(TMP2430, "icon_e_confused", 15);
STRING_LITERAL(TMP2431, ":-?", 3);
STRING_LITERAL(TMP2432, ":-/", 3);
STRING_LITERAL(TMP2433, "8-)", 3);
STRING_LITERAL(TMP2434, "icon_cool", 9);
STRING_LITERAL(TMP2435, ":lol:", 5);
STRING_LITERAL(TMP2436, "icon_lol", 8);
STRING_LITERAL(TMP2437, ":x", 2);
STRING_LITERAL(TMP2438, "icon_mad", 8);
STRING_LITERAL(TMP2439, ":-x", 3);
STRING_LITERAL(TMP2440, ":P", 2);
STRING_LITERAL(TMP2441, "icon_razz", 9);
STRING_LITERAL(TMP2442, ":-P", 3);
STRING_LITERAL(TMP2443, ":oops:", 6);
STRING_LITERAL(TMP2444, "icon_redface", 12);
STRING_LITERAL(TMP2445, ":cry:", 5);
STRING_LITERAL(TMP2446, "icon_cry", 8);
STRING_LITERAL(TMP2447, ":evil:", 6);
STRING_LITERAL(TMP2448, "icon_evil", 9);
STRING_LITERAL(TMP2449, ":twisted:", 9);
STRING_LITERAL(TMP2450, "icon_twisted", 12);
STRING_LITERAL(TMP2451, ":roll:", 6);
STRING_LITERAL(TMP2452, "icon_rolleyes", 13);
STRING_LITERAL(TMP2453, ":!:", 3);
STRING_LITERAL(TMP2454, "icon_exclaim", 12);
STRING_LITERAL(TMP2455, ":?:", 3);
STRING_LITERAL(TMP2456, "icon_question", 13);
STRING_LITERAL(TMP2457, ":idea:", 6);
STRING_LITERAL(TMP2458, "icon_idea", 9);
STRING_LITERAL(TMP2459, ":arrow:", 7);
STRING_LITERAL(TMP2460, "icon_arrow", 10);
STRING_LITERAL(TMP2461, ":|", 2);
STRING_LITERAL(TMP2462, "icon_neutral", 12);
STRING_LITERAL(TMP2463, ":-|", 3);
STRING_LITERAL(TMP2464, ":mrgreen:", 9);
STRING_LITERAL(TMP2465, "icon_mrgreen", 12);
STRING_LITERAL(TMP2466, ":geek:", 6);
STRING_LITERAL(TMP2467, "icon_e_geek", 11);
STRING_LITERAL(TMP2468, ":ugeek:", 7);
STRING_LITERAL(TMP2469, "icon_e_ugeek", 12);
NIM_CONST TY296074 smilies_296073 = {{((NimStringDesc*) &TMP2412),
...
STRING_LITERAL(TMP2471, "//", 2);
STRING_LITERAL(TMP2473, "http", 4);
STRING_LITERAL(TMP2474, "https", 5);
STRING_LITERAL(TMP2475, "ftp", 3);
STRING_LITERAL(TMP2476, "telnet", 6);
STRING_LITERAL(TMP2477, "file", 4);
NIM_CONST TY296821 TMP2472 = {((NimStringDesc*) &TMP2473),
((NimStringDesc*) &TMP2474),
((NimStringDesc*) &TMP2475),
((NimStringDesc*) &TMP2476),
((NimStringDesc*) &TMP2477)}
;
STRING_LITERAL(TMP2480, "html", 4);
STRING_LITERAL(TMP2481, "latex", 5);
STRING_LITERAL(TMP2482, " _", 2);
STRING_LITERAL(TMP2483, " |", 2);
STRING_LITERAL(TMP2484, "replace", 7);
STRING_LITERAL(TMP2485, " [", 2);
STRING_LITERAL(TMP2486, "]", 1);
NIM_CONST TY301290 wildcards_301289 = {((NimStringDesc*) &TMP2372),
...
N_NIMCALL(void, rstnodetorefnameaux_297163)(trstnode295009* n, NimStringDesc** r, NIM_BOOL* b) {
	{
		...
		i_297191 = 0;
		HEX3Atmp_297234 = 0;
		HEX3Atmp_297234 = (NI32)((*n).Text->Sup.len - 1);
		res_297236 = 0;
		while (1) {
			...
			case 65 ... 90:
			{
				...
				LA23: ;
				(*r) = addChar((*r), ((NIM_CHAR) (((NI) ((NI32)(((NI) ((NI32)(((NI) (((NU8)((*n).Text->data[i_297191])))) - 65))) + 97))))));
			}
			break;
			default:
			{
...
N_NIMCALL(void, initparser_297077)(trstparser296677* p, tsharedstate296673* sharedstate) {
	genericSeqAssign(&(*p).Indentstack, TMP2336, (&NTI296698));
	unsureAsgnRef((void**) &(*p).Tok, (ttokenseq296116*) newSeq((&NTI296116), 0));
	(*p).Idx = 0;
	unsureAsgnRef((void**) &(*p).Filename, copyString(((NimStringDesc*) &TMP1987)));
	(*p).Hastoc = NIM_FALSE;
	(*p).Col = 0;
	(*p).Line = 1;
...
static N_INLINE(void, writeln_137205)(FILE* f_137209, NimStringDesc** x_137213, NI x_137213Len0) {
	...
	write_10463(f_137209, ((NimStringDesc*) &TMP2355));
}
...
N_NIMCALL(void, defaultmsghandler_296803)(NimStringDesc* filename, NI line, NI col, NU8 msgkind, NimStringDesc* arg) {
	...
	LOC1[4] = copyString(a);
	message = nsuFormatOpenArray(((NimStringDesc*) &TMP2350), LOC1, 5);
	{
...
appendString(LOC1, ((NimStringDesc*) &TMP2355));
...
N_NIMCALL(void, rawgettok_296404)(tlexer296118* l, ttoken296114* tok) {
	NIM_CHAR c;
	unsureAsgnRef((void**) &(*tok).Symbol, copyString(((NimStringDesc*) &TMP1987)));
	(*tok).Ival = 0;
	c = (*l).Buf[(*l).Bufpos];
	switch (((NU8)(c))) {
	case 97 ... 122:
...
N_NIMCALL(NI, gettokens_296463)(NimStringDesc* buffer, NIM_BOOL skippounds, ttokenseq296116** tokens) {
	...
	while (1) {
		...
		rawgettok_296404(&l, &(*tokens)->data[(NI32)(length - 1)]);
		{
...
N_NIMCALL(void, popind_297032)(trstparser296677* p) {
	{
		...
		(*p).Indentstack = (TY296698*) setLengthSeq(&((*p).Indentstack)->Sup, sizeof(NI), (NI32)((*p).Indentstack->Sup.len - 1));
	}
	LA3: ;
}
...
N_NIMCALL(NIM_BOOL, match_297647)(trstparser296677* p, NI start, NimStringDesc* expr) {
	...
	while (1) {
		...
		case 101:
		{
			...
			if (LOC11) goto LA12;
			LOC11 = eqStrings((*p).Tok->data[j].Symbol, ((NimStringDesc*) &TMP2359));
			LA12: ;
			result = LOC11;
			{
				if (!result) goto LA15;
				...
				case 48 ... 57:
				{
					result = allcharsinset_89836((*p).Tok->data[j].Symbol, TMP2360);
				}
				break;
				default:
				{
...
N_NIMCALL(NIM_BOOL, islineblock_299652)(trstparser296677* p) {
	...
	if (!(LOC2)) goto LA3;
	LOC2 = eqStrings((*p).Tok->data[j].Symbol, ((NimStringDesc*) &TMP2369));
	LA3: ;
	LOC1 = LOC2;
	if (LOC1) goto LA4;
...
N_NIMCALL(NIM_BOOL, isdeflist_299676)(trstparser296677* p) {
	...
	LOC1 = LOC2;
	if (!(LOC1)) goto LA4;
	LOC1 = !(eqStrings((*p).Tok->data[(NI32)(j - 2)].Symbol, ((NimStringDesc*) &TMP2365)));
	LA4: ;
	result = LOC1;
	return result;
}
...
N_NIMCALL(NIM_BOOL, isoptionlist_299698)(trstparser296677* p) {
	...
	LOC2 = 0;
	LOC3 = 0;
	LOC3 = match_297647(p, (*p).Idx, ((NimStringDesc*) &TMP2374));
	if (LOC3) goto LA4;
	LOC3 = match_297647(p, (*p).Idx, ((NimStringDesc*) &TMP2375));
	LA4: ;
	LOC2 = LOC3;
	if (LOC2) goto LA5;
	LOC2 = match_297647(p, (*p).Idx, ((NimStringDesc*) &TMP2376));
	LA5: ;
	LOC1 = LOC2;
	if (LOC1) goto LA6;
	LOC1 = match_297647(p, (*p).Idx, ((NimStringDesc*) &TMP2377));
	LA6: ;
	result = LOC1;
	return result;
}
	...
	{
		{
			NIM_BOOL LOC4;
			LOC4 = 0;
			LOC4 = match_297647(p, (NI32)((*p).Idx + 1), ((NimStringDesc*) &TMP2361));
			if (!LOC4) goto LA5;
			result = ((NU8) 3);
		}
		goto LA2;
		LA5: ;
		{
			NIM_BOOL LOC8;
			LOC8 = 0;
			LOC8 = match_297647(p, (NI32)((*p).Idx + 1), ((NimStringDesc*) &TMP2362));
			if (!LOC8) goto LA9;
			result = ((NU8) 29);
		}
		goto LA2;
		LA9: ;
		{
			NIM_BOOL LOC12;
			LOC12 = 0;
			LOC12 = match_297647(p, (NI32)((*p).Idx + 1), ((NimStringDesc*) &TMP2363));
			if (!LOC12) goto LA13;
			result = ((NU8) 2);
		}
		goto LA2;
	...
	{
		{
			...
			LOC20 = 0;
			LOC20 = match_297647(p, LOC19, ((NimStringDesc*) &TMP2364));
			if (!LOC20) goto LA21;
			result = ((NU8) 1);
		}
		goto LA17;
		LA21: ;
		{
			if (!eqStrings((*p).Tok->data[(*p).Idx].Symbol, ((NimStringDesc*) &TMP2365))) goto LA24;
			result = ((NU8) 24);
		}
		goto LA17;
		LA24: ;
		{
			...
			if (LOC31) goto LA32;
			LOC31 = eqStrings((*p).Tok->data[(*p).Idx].Symbol, ((NimStringDesc*) &TMP2367));
			LA32: ;
			LOC30 = LOC31;
			if (LOC30) goto LA33;
			LOC30 = eqStrings((*p).Tok->data[(*p).Idx].Symbol, ((NimStringDesc*) &TMP2368));
			LA33: ;
			LOC28 = LOC30;
			LA29: ;
			LOC27 = LOC28;
		...
		LA35: ;
		{
			NIM_BOOL LOC38;
			LOC38 = 0;
			LOC38 = eqStrings((*p).Tok->data[(*p).Idx].Symbol, ((NimStringDesc*) &TMP2369));
			if (!(LOC38)) goto LA39;
		...
		LA40: ;
		{
			NIM_BOOL LOC43;
			LOC43 = 0;
			LOC43 = eqStrings((*p).Tok->data[(*p).Idx].Symbol, ((NimStringDesc*) &TMP2370));
			if (!(LOC43)) goto LA44;
		...
		LA45: ;
		{
			NIM_BOOL LOC48;
			LOC48 = 0;
			LOC48 = match_297647(p, (*p).Idx, ((NimStringDesc*) &TMP2371));
			if (!(LOC48)) goto LA49;
		...
		LA50: ;
		{
			NIM_BOOL LOC53;
			LOC53 = 0;
			LOC53 = match_297647(p, (*p).Idx, ((NimStringDesc*) &TMP2372));
			if (!LOC53) goto LA54;
			result = ((NU8) 7);
		}
		goto LA17;
		LA54: ;
		{
			NIM_BOOL LOC57;
			LOC57 = 0;
			LOC57 = match_297647(p, (*p).Idx, ((NimStringDesc*) &TMP2373));
			if (!LOC57) goto LA58;
			result = ((NU8) 30);
	...
	{
		{
			...
			LOC73 = 0;
			LOC73 = match_297647(p, LOC72, ((NimStringDesc*) &TMP2364));
			if (!LOC73) goto LA74;
			result = ((NU8) 1);
		}
		goto LA70;
		LA74: ;
		{
			NIM_BOOL LOC77;
			LOC77 = 0;
			LOC77 = match_297647(p, (*p).Idx, ((NimStringDesc*) &TMP2378));
			if (LOC77) goto LA78;
			LOC77 = match_297647(p, (*p).Idx, ((NimStringDesc*) &TMP2379));
			LA78: ;
			if (!LOC77) goto LA79;
			result = ((NU8) 7);
		}
...
N_NIMCALL(trstnode295009*, parseliteralblock_299488)(trstparser296677* p) {
	...
	n = newrstnode_295139(((NU8) 64), ((NimStringDesc*) &TMP1987));
	{
		NI indent;
...
appendString((*n).Text, ((NimStringDesc*) &TMP2355));
					LOC13 = 0;
...
N_NIMCALL(trstnode295009*, parsebulletlist_301002)(trstparser296677* p) {
	...
	result = NIM_NIL;
	{
		...
		pushind_297007(p, (*p).Tok->data[(NI32)((*p).Idx + 2)].Col);
		(*p).Idx += 2;
		while (1) {
			trstnode295009* item;
	...
	result = NIM_NIL;
	{
		...
		while (1) {
			...
			add_295163(result, item);
			{
				...
				LOC9 = LOC10;
				if (!(LOC9)) goto LA12;
				LOC9 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2369));
				LA12: ;
				LOC8 = LOC9;
				if (!(LOC8)) goto LA13;
				LOC8 = ((*p).Tok->data[(NI32)((*p).Idx + 2)].Kind == ((NU8) 2));
...
N_NIMCALL(NimStringDesc*, getdirective_298953)(trstparser296677* p) {
	...
	result = 0;
	{
		...
		while (1) {
			...
			{
				if (!eqStrings((*p).Tok->data[(*p).Idx].Symbol, ((NimStringDesc*) &TMP2365))) goto LA10;
				goto LA7;
			}
			LA10: ;
...
appendString(result, (*p).Tok->data[(*p).Idx].Symbol);
		...
		LA14: ;
		{
			if (!eqStrings((*p).Tok->data[(*p).Idx].Symbol, ((NimStringDesc*) &TMP2365))) goto LA18;
			(*p).Idx += 1;
			{
...
N_NIMCALL(NIM_BOOL, isinlinemarkupstart_297594)(trstparser296677* p, NimStringDesc* markup) {
	...
	LOC5 = LOC6;
	if (LOC5) goto LA8;
	LOC5 = ((TMP2391[((NU8)((*p).Tok->data[(NI32)((*p).Idx - 1)].Symbol->data[0]))/8] &(1<<(((NU8)((*p).Tok->data[(NI32)((*p).Idx - 1)].Symbol->data[0]))%8)))!=0);
	LA8: ;
	result = LOC5;
	{
		if (!!(result)) goto LA11;
	...
	LA15: ;
	{
		...
		{
			if (!eqStrings((*p).Tok->data[(NI32)((*p).Idx - 1)].Symbol, ((NimStringDesc*) &TMP2392))) goto LA23;
			result = NIM_FALSE;
		}
		goto LA21;
		LA23: ;
...
N_NIMCALL(NIM_BOOL, isinlinemarkupend_297544)(trstparser296677* p, NimStringDesc* markup) {
	...
	if (LOC9) goto LA10;
	LOC9 = ((TMP2394[((NU8)((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol->data[0]))/8] &(1<<(((NU8)((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol->data[0]))%8)))!=0);
	LA10: ;
	result = LOC9;
	{
		if (!!(result)) goto LA13;
	...
	LA13: ;
	{
		if (!(0 < (*p).Idx)) goto LA17;
		{
			NIM_BOOL LOC21;
			LOC21 = 0;
			LOC21 = !(eqStrings(markup, ((NimStringDesc*) &TMP2395)));
			if (!(LOC21)) goto LA22;
			LOC21 = eqStrings((*p).Tok->data[(NI32)((*p).Idx - 1)].Symbol, ((NimStringDesc*) &TMP2392));
			LA22: ;
			if (!LOC21) goto LA23;
			result = NIM_FALSE;
		}
...
N_NIMCALL(void, parsebackslash_298333)(trstparser296677* p, trstnode295009* father) {
	{
		trstnode295009* LOC5;
		if (!eqStrings((*p).Tok->data[(*p).Idx].Symbol, ((NimStringDesc*) &TMP2396))) goto LA3;
		LOC5 = 0;
		LOC5 = newrstnode_295139(((NU8) 64), ((NimStringDesc*) &TMP2392));
	...
	LA3: ;
	{
		if (!eqStrings((*p).Tok->data[(*p).Idx].Symbol, ((NimStringDesc*) &TMP2392))) goto LA7;
		(*p).Idx += 1;
		{
...
N_NIMCALL(void, parseuntil_298601)(trstparser296677* p, trstnode295009* father, NimStringDesc* postfix, NIM_BOOL interpretbackslash) {
	...
	while (1) {
		...
		case ((NU8) 1):
		{
			...
			LOC16 = 0;
			LOC16 = newrstnode_295139(((NU8) 64), ((NimStringDesc*) &TMP2397));
		...
		case ((NU8) 2):
		{
			...
			LOC22 = 0;
			LOC22 = newrstnode_295139(((NU8) 64), ((NimStringDesc*) &TMP2397));
...
N_NIMCALL(trstnode295009*, parsemarkdowncodeblock_298718)(trstparser296677* p) {
	...
	while (1) {
		...
		case ((NU8) 0):
		{
			rstmessage_296956(&(*p), ((NU8) 1), ((NimStringDesc*) &TMP2399));
			goto LA7;
		}
		break;
		case ((NU8) 5):
		{
			{
				if (!eqStrings((*p).Tok->data[(*p).Idx].Symbol, ((NimStringDesc*) &TMP2399))) goto LA12;
				(*p).Idx += 1;
				goto LA7;
			}
			goto LA10;
...
N_NIMCALL(void, fixupembeddedref_297834)(trstnode295009* n, trstnode295009* a, trstnode295009* b) {
	...
	LOC1 = 0;
	LOC1 = len_295080(n);
	HEX3Atmp_297880 = (NI32)(LOC1 - 2);
	res_297882 = HEX3Atmp_297880;
	while (1) {
		if (!(0 <= res_297882)) goto LA2;
		i_297851 = res_297882;
		{
			if (!eqStrings((*(*n).Sons->data[i_297851]).Text, ((NimStringDesc*) &TMP2403))) goto LA5;
			sep = i_297851;
			goto LA2;
		}
		LA5: ;
	...
	HEX3Atmp_297887 = 0;
	HEX3Atmp_297888 = 0;
	HEX3Atmp_297887 = (NI32)(sep + 1);
	LOC15 = 0;
	LOC15 = len_295080(n);
	HEX3Atmp_297888 = (NI32)(LOC15 - 2);
...
N_NIMCALL(void, setref_297354)(trstparser296677* p, NimStringDesc* key, trstnode295009* value) {
	...
	(*(*p).S).Refs = (TY296687*) setLengthSeq(&((*(*p).S).Refs)->Sup, sizeof(tsubstitution296671), (NI32)(length + 1));
	LOC12 = 0;
...
N_NIMCALL(trstnode295009*, parsepostfix_297897)(trstparser296677* p, trstnode295009* n) {
	...
	result = n;
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = isinlinemarkupend_297544(&(*p), ((NimStringDesc*) &TMP2401));
		if (!LOC3) goto LA4;
		(*p).Idx += 1;
		{
			NIM_BOOL LOC8;
			...
			trstnode295009* b;
			LOC8 = 0;
			LOC8 = eqStrings((*p).Tok->data[(NI32)((*p).Idx - 2)].Symbol, ((NimStringDesc*) &TMP2400));
			if (!(LOC8)) goto LA9;
			LOC8 = eqStrings((*p).Tok->data[(NI32)((*p).Idx - 3)].Symbol, ((NimStringDesc*) &TMP2402));
			LA9: ;
			if (!LOC8) goto LA10;
	...
	LA4: ;
	{
		NIM_BOOL LOC24;
		LOC24 = 0;
		LOC24 = match_297647(&(*p), (*p).Idx, ((NimStringDesc*) &TMP2371));
		if (!LOC24) goto LA25;
		{
			if (!eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2404))) goto LA29;
			(*n).Kind = ((NU8) 56);
		}
		goto LA27;
		LA29: ;
		{
			if (!eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2405))) goto LA32;
			(*n).Kind = ((NU8) 61);
		}
		goto LA27;
		LA32: ;
		{
			if (!eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2406))) goto LA35;
			(*n).Kind = ((NU8) 58);
		}
		goto LA27;
		LA35: ;
		{
			if (!eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2407))) goto LA38;
			(*n).Kind = ((NU8) 57);
		}
		goto LA27;
		LA38: ;
		{
			...
			if (LOC41) goto LA42;
			LOC41 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2409));
			LA42: ;
			if (!LOC41) goto LA43;
			(*n).Kind = ((NU8) 54);
		}
		...
		LA43: ;
		{
			...
			if (LOC46) goto LA47;
			LOC46 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2411));
			LA47: ;
			if (!LOC46) goto LA48;
			(*n).Kind = ((NU8) 55);
		}
		...
		LA48: ;
		{
			...
			add_295163(result, n);
			LOC51 = 0;
			LOC51 = newrstnode_295139(((NU8) 64), (*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol);
...
N_NIMCALL(NIM_BOOL, isurl_298201)(trstparser296677* p, NI i) {
	...
	LOC2 = 0;
	LOC3 = 0;
	LOC3 = eqStrings((*p).Tok->data[(NI32)(i + 1)].Symbol, ((NimStringDesc*) &TMP2470));
	if (!(LOC3)) goto LA4;
	LOC3 = eqStrings((*p).Tok->data[(NI32)(i + 2)].Symbol, ((NimStringDesc*) &TMP2471));
	LA4: ;
	LOC2 = LOC3;
	if (!(LOC2)) goto LA5;
	...
	LOC1 = LOC2;
	if (!(LOC1)) goto LA6;
	LOC1 = contains_298219(TMP2472, 5, (*p).Tok->data[i].Symbol);
	LA6: ;
	result = LOC1;
	return result;
}
...
N_NIMCALL(void, parseurl_298277)(trstparser296677* p, trstnode295009* father) {
	...
	LA4: ;
	{
		...
		(*p).Idx += 1;
		{
			if (!eqStrings((*p).Tok->data[(*p).Idx].Symbol, ((NimStringDesc*) &TMP2401))) goto LA18;
	...
	{
		{
			...
			trstnode295009* n;
			LOC4 = 0;
			LOC4 = isinlinemarkupstart_297594(&(*p), ((NimStringDesc*) &TMP2393));
			if (!LOC4) goto LA5;
			n = newrstnode_295097(((NU8) 59));
			parseuntil_298601(p, n, ((NimStringDesc*) &TMP2393), NIM_TRUE);
			add_295163(father, n);
		}
		goto LA2;
		LA5: ;
		{
			...
			trstnode295009* n;
			LOC8 = 0;
			LOC8 = isinlinemarkupstart_297594(&(*p), ((NimStringDesc*) &TMP2398));
			if (!LOC8) goto LA9;
			n = newrstnode_295097(((NU8) 58));
			parseuntil_298601(p, n, ((NimStringDesc*) &TMP2398), NIM_TRUE);
			add_295163(father, n);
		}
		goto LA2;
		LA9: ;
		{
			...
			trstnode295009* n;
			LOC12 = 0;
			LOC12 = isinlinemarkupstart_297594(&(*p), ((NimStringDesc*) &TMP2367));
			if (!LOC12) goto LA13;
			n = newrstnode_295097(((NU8) 57));
			parseuntil_298601(p, n, ((NimStringDesc*) &TMP2367), NIM_TRUE);
			add_295163(father, n);
		}
		goto LA2;
		LA13: ;
		{
			...
			if (!(LOC16)) goto LA17;
			LOC16 = eqStrings((*p).Tok->data[(*p).Idx].Symbol, ((NimStringDesc*) &TMP2399));
			LA17: ;
			if (!LOC16) goto LA18;
			(*p).Idx += 1;
			LOC20 = 0;
		...
		LA18: ;
		{
			...
			trstnode295009* n;
			LOC22 = 0;
			LOC22 = isinlinemarkupstart_297594(&(*p), ((NimStringDesc*) &TMP2395));
			if (!LOC22) goto LA23;
			n = newrstnode_295097(((NU8) 61));
			parseuntil_298601(p, n, ((NimStringDesc*) &TMP2395), NIM_FALSE);
			add_295163(father, n);
		}
		goto LA2;
		LA23: ;
		{
			...
			trstnode295009* n;
			LOC26 = 0;
			LOC26 = isinlinemarkupstart_297594(&(*p), ((NimStringDesc*) &TMP2400));
			if (!LOC26) goto LA27;
			n = newrstnode_295097(((NU8) 60));
			parseuntil_298601(p, n, ((NimStringDesc*) &TMP2400), NIM_TRUE);
			n = parsepostfix_297897(p, n);
			add_295163(father, n);
		}
		goto LA2;
		LA27: ;
		{
			...
			trstnode295009* n;
			LOC30 = 0;
			LOC30 = isinlinemarkupstart_297594(&(*p), ((NimStringDesc*) &TMP2369));
			if (!LOC30) goto LA31;
			n = newrstnode_295097(((NU8) 62));
			parseuntil_298601(p, n, ((NimStringDesc*) &TMP2369), NIM_FALSE);
			add_295163(father, n);
		}
		goto LA2;
		LA31: ;
...
N_NIMCALL(trstnode295009*, parsefield_299318)(trstparser296677* p) {
	...
	parseuntil_298601(p, fieldname, ((NimStringDesc*) &TMP2470), NIM_FALSE);
...
N_NIMCALL(trstnode295009*, parsefields_299348)(trstparser296677* p) {
	...
	LOC1 = ((*p).Idx == 0);
	if (!(LOC1)) goto LA2;
	LOC1 = eqStrings((*p).Tok->data[0].Symbol, ((NimStringDesc*) &TMP2470));
	LA2: ;
	atstart = LOC1;
	{
		NIM_BOOL LOC5;
		...
		if (!(LOC6)) goto LA7;
		LOC6 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2470));
		LA7: ;
		LOC5 = LOC6;
		if (LOC5) goto LA8;
		LOC5 = atstart;
		...
		while (1) {
			...
			add_295163(result, LOC21);
			{
				...
				LOC24 = LOC25;
				if (!(LOC24)) goto LA27;
				LOC24 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2470));
				LA27: ;
				if (!LOC24) goto LA28;
				(*p).Idx += 1;
			}
...
N_NIMCALL(trstnode295009*, parsedirective_301617)(trstparser296677* p, NU8 flags) {
	...
	add_295163(result, args);
	{
		if (!((flags &(1<<((((NU8) 1))&7)))!=0)) goto LA26;
		{
			...
			LOC30 = LOC31;
			if (!(LOC30)) goto LA33;
			LOC30 = eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2470));
			LA33: ;
			if (!LOC30) goto LA34;
	...
	{
		{
			...
			trstnode295009* LOC13;
			LOC9 = 0;
			LOC9 = getfieldvalue_296059(n, ((NimStringDesc*) &TMP2405));
...
N_NIMCALL(void, dirrawaux_302244)(trstparser296677* p, trstnode295009** result, NU8 kind, tsectionparser301608 contentparser) {
	NimStringDesc* filename;
	filename = getfieldvalue_296059((*result), ((NimStringDesc*) &TMP2477));
	{
		NimStringDesc* path;
...
N_NIMCALL(trstnode295009*, dirraw_302258)(trstparser296677* p) {
	...
	result = parsedirective_301617(p, 11);
	{
		if (!!(((*result).Sons->data[0] == NIM_NIL))) goto LA3;
		{
			NI LOC7;
			LOC7 = 0;
			LOC7 = nsuCmpIgnoreCase((*(*(*result).Sons->data[0]).Sons->data[0]).Text, ((NimStringDesc*) &TMP2480));
			if (!(LOC7 == 0)) goto LA8;
		...
		LA8: ;
		{
			NI LOC11;
			LOC11 = 0;
			LOC11 = nsuCmpIgnoreCase((*(*(*result).Sons->data[0]).Sons->data[0]).Text, ((NimStringDesc*) &TMP2481));
...
N_NIMCALL(trstnode295009*, dircodeblock_301827)(trstparser296677* p) {
	...
	LOC1 = 0;
	LOC1 = getfieldvalue_296059(result, ((NimStringDesc*) &TMP2477));
	filename = nsuStrip(LOC1, NIM_TRUE, NIM_TRUE);
	{
		NimStringDesc* path;
		trstnode295009* n;
...
N_NIMCALL(void, setsub_297300)(trstparser296677* p, NimStringDesc* key, trstnode295009* value) {
	...
	(*(*p).S).Subs = (TY296687*) setLengthSeq(&((*(*p).S).Subs)->Sup, sizeof(tsubstitution296671), (NI32)(length + 1));
	LOC6 = 0;
...
N_NIMCALL(trstnode295009*, parsedotdot_299483)(trstparser296677* p) {
	...
	LA3: ;
	{
		...
		NimStringDesc* LOC29;
		LOC22 = 0;
		LOC22 = match_297647(&(*p), (*p).Idx, ((NimStringDesc*) &TMP2482));
		if (!LOC22) goto LA23;
		(*p).Idx += 2;
		a = getreferencename_297441(p, ((NimStringDesc*) &TMP2470));
		{
	...
	LA23: ;
	{
		...
		NimStringDesc* LOC48;
		LOC31 = 0;
		LOC31 = match_297647(&(*p), (*p).Idx, ((NimStringDesc*) &TMP2483));
		if (!LOC31) goto LA32;
		(*p).Idx += 2;
		a = getreferencename_297441(p, ((NimStringDesc*) &TMP2369));
		b = 0;
		{
		...
		LA36: ;
		{
			NI LOC40;
			LOC40 = 0;
			LOC40 = nsuCmpIgnoreStyle((*p).Tok->data[(*p).Idx].Symbol, ((NimStringDesc*) &TMP2484));
			if (!(LOC40 == 0)) goto LA41;
			(*p).Idx += 1;
			expect_297521(p, ((NimStringDesc*) &TMP2365));
			b = untileol_297483(p);
		}
		goto LA38;
		LA41: ;
		{
			NI LOC44;
			LOC44 = 0;
			LOC44 = nsuCmpIgnoreStyle((*p).Tok->data[(*p).Idx].Symbol, ((NimStringDesc*) &TMP2386));
	...
	LA32: ;
	{
		...
		NimStringDesc* LOC57;
		LOC50 = 0;
		LOC50 = match_297647(&(*p), (*p).Idx, ((NimStringDesc*) &TMP2485));
		if (!LOC50) goto LA51;
		(*p).Idx += 2;
		a = getreferencename_297441(p, ((NimStringDesc*) &TMP2486));
		{
...
N_NIMCALL(trstnode295009*, parseenumlist_301284)(trstparser296677* p) {
	...
	} LA1: ;
	{
		...
		(*p).Idx += (NI32)(wildpos_301294[(w)- 0] + 3);
		j = tokenafternewline_299613(&(*p));
		{
			NIM_BOOL LOC13;
			LOC13 = 0;
			...
			while (1) {
				...
				add_295163(result, item);
				{
					...
					LOC20 = LOC21;
					if (!(LOC20)) goto LA23;
					LOC20 = match_297647(&(*p), (NI32)((*p).Idx + 1), wildcards_301289[(w)- 0]);
					LA23: ;
					if (!LOC20) goto LA24;
					(*p).Idx += (NI32)(wildpos_301294[(w)- 0] + 4);
				}
				goto LA18;
				LA24: ;
				{
...
N_NIMCALL(trstnode295009*, parsedefinitionlist_301193)(trstparser296677* p) {
	...
	j = (NI32)(LOC1 - 1);
	{
		...
		LOC4 = LOC5;
		if (!(LOC4)) goto LA10;
		LOC4 = !(eqStrings((*p).Tok->data[(NI32)(j - 1)].Symbol, ((NimStringDesc*) &TMP2365)));
		LA10: ;
		if (!LOC4) goto LA11;
		col = (*p).Tok->data[(*p).Idx].Col;
		...
		while (1) {
			...
			parseline_299296(p, a);
			{
				...
				LOC17 = LOC18;
				if (!(LOC17)) goto LA21;
				LOC17 = !(eqStrings((*p).Tok->data[(NI32)((*p).Idx + 1)].Symbol, ((NimStringDesc*) &TMP2365)));
				LA21: ;
				LOC16 = LOC17;
				if (!(LOC16)) goto LA22;
			...
			LA14: ;
			{
				...
				j = (NI32)(LOC32 - 1);
				{
					...
					LOC36 = LOC37;
					if (!(LOC36)) goto LA41;
					LOC36 = !(eqStrings((*p).Tok->data[(NI32)(j - 1)].Symbol, ((NimStringDesc*) &TMP2365)));
					LA41: ;
					LOC35 = LOC36;
					if (!(LOC35)) goto LA42;
	...
	while (1) {
		parseuntilnewline_299304(p, result);
		{
			...
			(*p).Idx += 1;
			{
				...
				LOC11 = 0;
				LOC11 = newrstnode_295139(((NU8) 64), ((NimStringDesc*) &TMP2397));
...
N_NIMCALL(void, getcolumns_300231)(trstparser296677* p, TY296698** cols) {
	...
	while (1) {
		...
		(*cols)->data[(NI32)(l - 1)] = tokend_300225(&(*p));
		(*p).Idx += 1;
		{
...
N_NIMCALL(trstnode295009*, parsesimpletable_300485)(trstparser296677* p) {
	...
	while (1) {
		...
		while (1) {
			...
			j_300640 = res_300807;
			LOC21 = 0;
			LOC21 = row->data[j_300640]; row->data[j_300640] = copyStringRC1(((NimStringDesc*) &TMP1987));
	...
	while (1) {
		{
			...
			c = newrstnode_295097(((NU8) 18));
			{
				NIM_BOOL LOC9;
				LOC9 = 0;
				LOC9 = match_297647(&(*p), (*p).Idx, ((NimStringDesc*) &TMP2377));
				if (!LOC9) goto LA10;
				(*p).Idx += 1;
			}
			LA10: ;
			...
			j = tokenafternewline_299613(&(*p));
			{
				...
				LA25: ;
				if (!LOC22) goto LA27;
				pushind_297007(p, (*p).Tok->data[(NI32)(j - 1)].Ival);
				parsesection_299312(p, b);
				popind_297032(p);
			}
			goto LA20;
		...
		case ((NU8) 1):
		{
			...
			LA5: ;
			{
				...
				case ((NU8) 40):
				{
					trstnode295009* LOC13;
					LOC13 = 0;
					LOC13 = newrstnode_295139(((NU8) 64), ((NimStringDesc*) &TMP2397));
					add_295163(result, LOC13);
				}
				break;
				case ((NU8) 26):
		...
		{
			{
				...
				LOC21 = 0;
				LOC22 = 0;
				LOC22 = eqStrings((*p).Tok->data[(*p).Idx].Symbol, ((NimStringDesc*) &TMP2365));
				if (!(LOC22)) goto LA23;
				...
				if (!LOC21) goto LA26;
				LOC28 = 0;
				LOC28 = newrstnode_295139(((NU8) 64), ((NimStringDesc*) &TMP2470));
...
static TNimNode* TMP2316[8];
static TNimNode* TMP2317[5];
static TNimNode* TMP2318[7];
NI TMP2320;
static char* NIM_CONST TMP2319[7] = {
"tkEof", 
"tkIndent", 
"tkWhite", 
"tkWord", 
...
"tkPunct", 
"tkOther"};
static TNimNode* TMP2322[9];
static TNimNode* TMP2323[4];
NI TMP2325;
static char* NIM_CONST TMP2324[4] = {
"roSkipPounds", 
"roSupportSmilies", 
"roSupportRawDirective", 
"roSupportMarkdown"};
static TNimNode* TMP2326[2];
static TNimNode* TMP2338[9];
NI TMP2340;
static char* NIM_CONST TMP2339[9] = {
"meCannotOpenFile", 
"meExpected", 
...
static TNimNode* TMP2351[3];
NI TMP2353;
static char* NIM_CONST TMP2352[3] = {
"Hint", 
"Warning", 
"Error"};
static TNimNode* TMP2356[6];
static TNimNode TMP870[64];
NTI296677.size = sizeof(trstparser296677);
NTI296677.kind = 17;
NTI296677.base = (&NTI2409);
TMP2316[0] = &TMP870[1];
TMP870[1].kind = 1;
TMP870[1].offset = offsetof(trstparser296677, Idx);
TMP870[1].typ = (&NTI106);
TMP870[1].name = "idx";
TMP2316[1] = &TMP870[2];
...
NTI296112.base = 0;
NTI296112.flags = 3;
for (TMP2320 = 0; TMP2320 < 7; TMP2320++) {
TMP870[TMP2320+5].kind = 1;
TMP870[TMP2320+5].offset = TMP2320;
TMP870[TMP2320+5].name = TMP2319[TMP2320];
TMP2318[TMP2320] = &TMP870[TMP2320+5];
}
TMP870[12].len = 7; TMP870[12].kind = 2; TMP870[12].sons = &TMP2318[0];
NTI296112.node = &TMP870[12];
TMP870[4].kind = 1;
TMP870[4].offset = offsetof(ttoken296114, Kind);
TMP870[4].typ = (&NTI296112);
TMP870[4].name = "kind";
TMP2317[1] = &TMP870[13];
TMP870[13].kind = 1;
TMP870[13].offset = offsetof(ttoken296114, Ival);
TMP870[13].typ = (&NTI106);
TMP870[13].name = "ival";
TMP2317[2] = &TMP870[14];
TMP870[14].kind = 1;
TMP870[14].offset = offsetof(ttoken296114, Symbol);
TMP870[14].typ = (&NTI143);
TMP870[14].name = "symbol";
TMP2317[3] = &TMP870[15];
TMP870[15].kind = 1;
TMP870[15].offset = offsetof(ttoken296114, Line);
TMP870[15].typ = (&NTI106);
TMP870[15].name = "line";
TMP2317[4] = &TMP870[16];
TMP870[16].kind = 1;
TMP870[16].offset = offsetof(ttoken296114, Col);
TMP870[16].typ = (&NTI106);
TMP870[16].name = "col";
TMP870[3].len = 5; TMP870[3].kind = 2; TMP870[3].sons = &TMP2317[0];
NTI296114.node = &TMP870[3];
NTI296116.size = sizeof(ttokenseq296116*);
NTI296116.kind = 24;
NTI296116.base = (&NTI296114);
NTI296116.flags = 2;
NTI296116.marker = TMP2321;
TMP870[2].kind = 1;
TMP870[2].offset = offsetof(trstparser296677, Tok);
TMP870[2].typ = (&NTI296116);
TMP870[2].name = "tok";
TMP2316[2] = &TMP870[17];
...
NTI296008.base = 0;
NTI296008.flags = 3;
for (TMP2325 = 0; TMP2325 < 4; TMP2325++) {
TMP870[TMP2325+20].kind = 1;
TMP870[TMP2325+20].offset = TMP2325;
TMP870[TMP2325+20].name = TMP2324[TMP2325];
TMP2323[TMP2325] = &TMP870[TMP2325+20];
}
TMP870[24].len = 4; TMP870[24].kind = 2; TMP870[24].sons = &TMP2323[0];
NTI296008.node = &TMP870[24];
NTI296010.size = sizeof(NU8);
NTI296010.kind = 19;
NTI296010.base = (&NTI296008);
NTI296010.flags = 3;
TMP870[25].len = 0; TMP870[25].kind = 0;
NTI296010.node = &TMP870[25];
TMP870[19].kind = 1;
TMP870[19].offset = offsetof(tsharedstate296673, Options);
TMP870[19].typ = (&NTI296010);
TMP870[19].name = "options";
TMP2322[1] = &TMP870[26];
TMP870[26].kind = 1;
TMP870[26].offset = offsetof(tsharedstate296673, Ulevel);
TMP870[26].typ = (&NTI106);
TMP870[26].name = "uLevel";
TMP2322[2] = &TMP870[27];
TMP870[27].kind = 1;
TMP870[27].offset = offsetof(tsharedstate296673, Olevel);
TMP870[27].typ = (&NTI106);
TMP870[27].name = "oLevel";
TMP2322[3] = &TMP870[28];
...
TMP2326[0] = &TMP870[30];
TMP870[30].kind = 1;
TMP870[30].offset = offsetof(tsubstitution296671, Key);
TMP870[30].typ = (&NTI143);
TMP870[30].name = "key";
TMP2326[1] = &TMP870[31];
TMP870[31].kind = 1;
TMP870[31].offset = offsetof(tsubstitution296671, Value);
TMP870[31].typ = (&NTI295005);
TMP870[31].name = "value";
TMP870[29].len = 2; TMP870[29].kind = 2; TMP870[29].sons = &TMP2326[0];
NTI296671.node = &TMP870[29];
NTI296687.size = sizeof(TY296687*);
NTI296687.kind = 24;
NTI296687.base = (&NTI296671);
NTI296687.flags = 2;
NTI296687.marker = TMP2333;
TMP870[28].kind = 1;
TMP870[28].offset = offsetof(tsharedstate296673, Subs);
TMP870[28].typ = (&NTI296687);
TMP870[28].name = "subs";
TMP2322[4] = &TMP870[32];
TMP870[32].kind = 1;
TMP870[32].offset = offsetof(tsharedstate296673, Refs);
TMP870[32].typ = (&NTI296687);
TMP870[32].name = "refs";
TMP2322[5] = &TMP870[33];
TMP870[33].kind = 1;
TMP870[33].offset = offsetof(tsharedstate296673, Underlinetolevel);
TMP870[33].typ = (&NTI90032);
TMP870[33].name = "underlineToLevel";
TMP2322[6] = &TMP870[34];
TMP870[34].kind = 1;
TMP870[34].offset = offsetof(tsharedstate296673, Overlinetolevel);
TMP870[34].typ = (&NTI90032);
TMP870[34].name = "overlineToLevel";
TMP2322[7] = &TMP870[35];
...
NTI296016.flags = 3;
TMP870[35].kind = 1;
TMP870[35].offset = offsetof(tsharedstate296673, Msghandler);
TMP870[35].typ = (&NTI296016);
TMP870[35].name = "msgHandler";
TMP2322[8] = &TMP870[36];
...
NTI296018.flags = 3;
TMP870[36].kind = 1;
TMP870[36].offset = offsetof(tsharedstate296673, Findfile);
TMP870[36].typ = (&NTI296018);
TMP870[36].name = "findFile";
TMP870[18].len = 9; TMP870[18].kind = 2; TMP870[18].sons = &TMP2322[0];
NTI296673.node = &TMP870[18];
NTI296675.size = sizeof(tsharedstate296673*);
NTI296675.kind = 22;
NTI296675.base = (&NTI296673);
NTI296675.flags = 2;
NTI296675.marker = TMP2334;
TMP870[17].kind = 1;
TMP870[17].offset = offsetof(trstparser296677, S);
TMP870[17].typ = (&NTI296675);
TMP870[17].name = "s";
TMP2316[3] = &TMP870[37];
...
NTI296698.flags = 2;
NTI296698.marker = TMP2335;
TMP870[37].kind = 1;
TMP870[37].offset = offsetof(trstparser296677, Indentstack);
TMP870[37].typ = (&NTI296698);
TMP870[37].name = "indentStack";
TMP2316[4] = &TMP870[38];
TMP870[38].kind = 1;
TMP870[38].offset = offsetof(trstparser296677, Filename);
TMP870[38].typ = (&NTI143);
TMP870[38].name = "filename";
TMP2316[5] = &TMP870[39];
TMP870[39].kind = 1;
TMP870[39].offset = offsetof(trstparser296677, Line);
TMP870[39].typ = (&NTI106);
TMP870[39].name = "line";
TMP2316[6] = &TMP870[40];
TMP870[40].kind = 1;
TMP870[40].offset = offsetof(trstparser296677, Col);
TMP870[40].typ = (&NTI106);
TMP870[40].name = "col";
TMP2316[7] = &TMP870[41];
TMP870[41].kind = 1;
TMP870[41].offset = offsetof(trstparser296677, Hastoc);
TMP870[41].typ = (&NTI134);
TMP870[41].name = "hasToc";
TMP870[0].len = 8; TMP870[0].kind = 2; TMP870[0].sons = &TMP2316[0];
NTI296677.node = &TMP870[0];
NTI296014.size = sizeof(NU8);
NTI296014.kind = 14;
NTI296014.base = 0;
NTI296014.flags = 3;
for (TMP2340 = 0; TMP2340 < 9; TMP2340++) {
TMP870[TMP2340+42].kind = 1;
TMP870[TMP2340+42].offset = TMP2340;
TMP870[TMP2340+42].name = TMP2339[TMP2340];
TMP2338[TMP2340] = &TMP870[TMP2340+42];
}
TMP870[51].len = 9; TMP870[51].kind = 2; TMP870[51].sons = &TMP2338[0];
NTI296014.node = &TMP870[51];
NTI296012.size = sizeof(NU8);
NTI296012.kind = 14;
NTI296012.base = 0;
NTI296012.flags = 3;
for (TMP2353 = 0; TMP2353 < 3; TMP2353++) {
TMP870[TMP2353+52].kind = 1;
TMP870[TMP2353+52].offset = TMP2353;
TMP870[TMP2353+52].name = TMP2352[TMP2353];
TMP2351[TMP2353] = &TMP870[TMP2353+52];
}
TMP870[55].len = 3; TMP870[55].kind = 2; TMP870[55].sons = &TMP2351[0];
NTI296012.node = &TMP870[55];
NTI296679.size = sizeof(eparseerror296679);
NTI296679.kind = 17;
NTI296679.base = (&NTI2453);
TMP870[56].len = 0; TMP870[56].kind = 2;
NTI296679.node = &TMP870[56];
NTI296836.size = sizeof(eparseerror296679*);
NTI296836.kind = 22;
NTI296836.base = (&NTI296679);
NTI296836.marker = TMP2354;
...
TMP2356[0] = &TMP870[58];
TMP870[58].kind = 1;
TMP870[58].offset = offsetof(tlexer296118, Buf);
TMP870[58].typ = (&NTI145);
TMP870[58].name = "buf";
TMP2356[1] = &TMP870[59];
TMP870[59].kind = 1;
TMP870[59].offset = offsetof(tlexer296118, Bufpos);
TMP870[59].typ = (&NTI106);
TMP870[59].name = "bufpos";
TMP2356[2] = &TMP870[60];
TMP870[60].kind = 1;
TMP870[60].offset = offsetof(tlexer296118, Line);
TMP870[60].typ = (&NTI106);
TMP870[60].name = "line";
TMP2356[3] = &TMP870[61];
TMP870[61].kind = 1;
TMP870[61].offset = offsetof(tlexer296118, Col);
TMP870[61].typ = (&NTI106);
TMP870[61].name = "col";
TMP2356[4] = &TMP870[62];
TMP870[62].kind = 1;
TMP870[62].offset = offsetof(tlexer296118, Baseindent);
TMP870[62].typ = (&NTI106);
TMP870[62].name = "baseIndent";
TMP2356[5] = &TMP870[63];
TMP870[63].kind = 1;
TMP870[63].offset = offsetof(tlexer296118, Skippounds);
TMP870[63].typ = (&NTI134);
TMP870[63].name = "skipPounds";
TMP870[57].len = 6; TMP870[57].kind = 2; TMP870[57].sons = &TMP2356[0];
NTI296118.node = &TMP870[57];
}
