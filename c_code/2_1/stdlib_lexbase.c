...
TMP2689[0] = &TMP852[1];
TMP852[1].kind = 1;
TMP852[1].offset = offsetof(baselexer292024, Bufpos);
TMP852[1].typ = (&NTI108);
TMP852[1].name = "bufpos";
TMP2689[1] = &TMP852[2];
TMP852[2].kind = 1;
TMP852[2].offset = offsetof(baselexer292024, Buf);
TMP852[2].typ = (&NTI151);
TMP852[2].name = "buf";
TMP2689[2] = &TMP852[3];
TMP852[3].kind = 1;
TMP852[3].offset = offsetof(baselexer292024, Buflen);
TMP852[3].typ = (&NTI108);
TMP852[3].name = "bufLen";
TMP2689[3] = &TMP852[4];
TMP852[4].kind = 1;
TMP852[4].offset = offsetof(baselexer292024, Input);
TMP852[4].typ = (&NTI135033);
TMP852[4].name = "input";
TMP2689[4] = &TMP852[5];
TMP852[5].kind = 1;
TMP852[5].offset = offsetof(baselexer292024, Linenumber);
TMP852[5].typ = (&NTI108);
TMP852[5].name = "lineNumber";
TMP2689[5] = &TMP852[6];
TMP852[6].kind = 1;
TMP852[6].offset = offsetof(baselexer292024, Sentinel);
TMP852[6].typ = (&NTI108);
TMP852[6].name = "sentinel";
TMP2689[6] = &TMP852[7];
TMP852[7].kind = 1;
TMP852[7].offset = offsetof(baselexer292024, Linestart);
TMP852[7].typ = (&NTI108);
TMP852[7].name = "lineStart";
TMP2689[7] = &TMP852[8];
TMP852[8].kind = 1;
TMP852[8].offset = offsetof(baselexer292024, Fileopened);
TMP852[8].typ = (&NTI138);
TMP852[8].name = "fileOpened";
TMP852[0].len = 8; TMP852[0].kind = 2; TMP852[0].sons = &TMP2689[0];
NTI292024.node = &TMP852[0];
}
