...
N_NIMCALL(NI, send_590493_170061329)(Socketimpl585404* socket0, void* data0, NI size0);
...
N_NIMCALL(NI, waitfor_589607_170061329)(Socketimpl585404* socket0, NF* waited0, NI timeout0, NI size0, NimStringDesc* funcname0);
...
static N_INLINE(void, HEX2BHEX3D_111703_1689653243)(NF* x0, NF y0);
...
N_NIMCALL(void, send_591002_170061329)(Socketimpl585404* socket0, NimStringDesc* data0, Socketflag585414Set flags0) {
	NI sent0;
{	sent0 = send_590493_170061329(socket0, ((void*) (data0->data)), (data0 ? data0->Sup.len : 0));
	{
		NI32 lasterror0;
...
appendString(LOC32, ((NimStringDesc*) &T170061329_10));
		...
		LOC33 = (NF)0;
		LOC33 = ntepochTime();
		HEX2BHEX3D_111703_1689653243(waited0, ((NF)(LOC33) - (NF)(starttime0)));
	}
	LA9: ;
	}BeforeRet: ;
	return result0;
...
{	waited0 = 0.0;
	(*line0) = setLengthStr((*line0), ((NI) 0));
	{
		while (1) {
			...
			c0 = (NIM_CHAR)0;
			LOC3 = (NI)0;
			LOC3 = waitfor_589607_170061329(socket0, (&waited0), timeout0, ((NI) 1), ((NimStringDesc*) &T170061329_11));
			...
			LA4: ;
			{
				...
				LOC20 = (NI)0;
				LOC20 = waitfor_589607_170061329(socket0, (&waited0), timeout0, ((NI) 1), ((NimStringDesc*) &T170061329_11));
