...
N_NIMCALL(NI, send_527678)(Socketimpl523404* socket, void* data, NI size);
...
N_NIMCALL(NI, waitfor_526807)(Socketimpl523404* socket, NF* waited, NI timeout, NI size, NimStringDesc* funcname);
...
N_NIMCALL(void, send_528202)(Socketimpl523404* socket, NimStringDesc* data, NU8 flags) {
	NI sent;
{	sent = send_527678(socket, ((void*) (data->data)), (data ? data->Sup.len : 0));
	{
		NI32 lasterror;
...
{	waited = 0.0;
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_526807(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5289));
			...
			LA4: ;
			{
				...
				LOC20 = 0;
				LOC20 = waitfor_526807(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5289));
