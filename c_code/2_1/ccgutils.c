...
appendString(LOC6, LOC7);
	...
	}
	{
		...
		i_544785 = 0;
		HEX3Atmp_544796 = 0;
		HEX3Atmp_544796 = (NI32)(name->Sup.len - 1);
		res_544799 = 1;
		{
			while (1) {
				NIM_CHAR c;
...
N_NIMCALL(trope178009*, makellvmstring_544816)(NimStringDesc* s) {
	...
	res = copyString(((NimStringDesc*) &TMP3934));
	{
		...
		i_544834 = 0;
		HEX3Atmp_544847 = 0;
		HEX3Atmp_544847 = (NI32)(s->Sup.len - 1);
		res_544850 = 0;
		{
			while (1) {
				...
				{
					trope178009* LOC8;
					if (!(((NI) ((NI32)((NI32)(i_544834 + 1) % 64))) == 0)) goto LA6;
					LOC8 = 0;
...
N_NIMCALL(NI64, hashstring_544156)(NimStringDesc* s) {
	...
	result = 0;
	{
		...
		b = 0;
		{
			...
			i_544173 = 0;
			HEX3Atmp_544242 = 0;
			HEX3Atmp_544242 = (NI32)(s->Sup.len - 1);
			res_544245 = 0;
			{
				while (1) {
	...
	LA3: ;
	{
		...
		a = ((NI32) 0);
		{
			...
			i_544195 = 0;
			HEX3Atmp_544249 = 0;
			HEX3Atmp_544249 = (NI32)(s->Sup.len - 1);
			res_544252 = 0;
			{
				while (1) {
