...
N_NIMCALL(void, rawimportsymbol_254235)(tcontext249019* c, tsym186843* s) {
	...
	LA13: ;
	{
		...
		nimln(93, "importer.nim");
		{
			...
			nimln(93, "importer.nim");
			LOC43 = 0;
			LOC43 = haspattern_193059(s);
			if (!LOC43) goto LA44;
			nimln(93, "importer.nim");
			addpattern_249538(c, s);
		}
		LA44: ;
	}
	LA11: ;
