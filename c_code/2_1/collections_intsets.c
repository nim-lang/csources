...
static N_INLINE(NIM_BOOL, mustrehash_169054)(NI length, NI counter);
...
static N_INLINE(NI, nexttry_169205)(NI h, NI maxhash);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NIMCALL(ttrunk169039*, intsetget_169212)(tintset169043 t, NI key);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(void, intsetrawinsert_169233)(tintset169043 t, ttrunkseq169041** data, ttrunk169039* desc);
...
N_NIMCALL(void, intsetenlarge_169604)(tintset169043* t);
N_NIMCALL(void, nimGCvisit)(void* d, NI op);
N_NIMCALL(void, TMP1923)(void* p, NI op);
N_NIMCALL(void, TMP1924)(void* p, NI op);
N_NIMCALL(void*, newSeq)(TNimType* typ, NI len);
N_NIMCALL(void, unsureAsgnRef)(void** dest, void* src);
N_NIMCALL(ttrunk169039*, intsetput_169661)(tintset169043* t, NI key);
...
N_NIMCALL(void, assign_169914)(tintset169043* dest, tintset169043 src);
N_NIMCALL(NimStringDesc*, HEX24_170076)(tintset169043 s);
N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src);
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src);
N_NIMCALL(NimStringDesc*, resizeString)(NimStringDesc* dest, NI addlen);
N_NIMCALL(NimStringDesc*, nimIntToStr)(NI x);
static N_INLINE(NIM_BOOL, empty_170096)(tintset169043 s);
STRING_LITERAL(TMP1910, "counter < length ", 17);
STRING_LITERAL(TMP1916, "not (data[h] == desc) ", 22);
STRING_LITERAL(TMP1917, "data[h] == nil ", 15);
STRING_LITERAL(TMP1926, "t.data[h] == nil ", 17);
STRING_LITERAL(TMP1927, "dest.data[h] == nil ", 20);
STRING_LITERAL(TMP1928, "{", 1);
STRING_LITERAL(TMP1929, ", ", 2);
STRING_LITERAL(TMP1930, "}", 1);
extern TFrame* frameptr_12037;
extern tgcheap40816 gch_40844;
TNimType NTI169039; /* TTrunk */
extern TNimType NTI105; /* int */
extern TNimType NTI21418; /* array[0..15, int] */
TNimType NTI169037; /* PTrunk */
TNimType NTI169041; /* TTrunkSeq */
TNimType NTI169043; /* TIntSet */
...
static N_INLINE(NIM_BOOL, mustrehash_169054)(NI length, NI counter) {
	...
	nimln(47, "intsets.nim");
	{
		...
		nimln(47, "intsets.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP1910));	}	LA3: ;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	LOC5 = 0;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	TMP1911 = mulInt(length, 2);
	nimln(48, "intsets.nim");
	TMP1912 = mulInt(counter, 3);
	LOC5 = ((NI32)(TMP1911) < (NI32)(TMP1912));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	TMP1913 = subInt(length, counter);
	LOC5 = ((NI32)(TMP1913) < 4);
	LA6: ;
	result = LOC5;
	popFrame();
...
static N_INLINE(NI, nexttry_169205)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1914 = mulInt(5, h);
	TMP1915 = addInt((NI32)(TMP1914), 1);
	result = (NI)((NI32)(TMP1915) & maxhash);
	popFrame();
	return result;
}
N_NIMCALL(ttrunk169039*, intsetget_169212)(tintset169043 t, NI key) {
...
N_NIMCALL(void, intsetrawinsert_169233)(tintset169043 t, ttrunkseq169041** data, ttrunk169039* desc) {
	...
	while (1) {
		...
		nimln(64, "intsets.nim");
		{
			...
			nimln(64, "intsets.nim");
			hiddenraiseassert_76017(((NimStringDesc*) &TMP1916));		}		LA4: ;
	...
	nimln(66, "intsets.nim");
	{
		...
		nimln(66, "intsets.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP1917));	}	LA8: ;
...
N_NIMCALL(void, intsetenlarge_169604)(tintset169043* t) {
	...
	nimln(72, "intsets.nim");
	nimln(72, "intsets.nim");
	TMP1918 = addInt((*t).Max, 1);
	TMP1919 = mulInt((NI32)(TMP1918), 2);
	TMP1920 = subInt((NI32)(TMP1919), 1);
	(*t).Max = (NI32)(TMP1920);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1921 = addInt((*t).Max, 1);
	n = (ttrunkseq169041*) newSeq((&NTI169041), (NI32)(TMP1921));
	i_169629 = 0;
	...
	while (1) {
		...
		nimln(75, "intsets.nim");
		{
			nimln(698, "system.nim");
			nimln(698, "system.nim");
			if ((NU)(i_169629) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			if (!!(((*t).Data->data[i_169629] == NIM_NIL))) goto LA4;
			nimln(75, "intsets.nim");
			if ((NU)(i_169629) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			intsetrawinsert_169233((*t), &n, (*t).Data->data[i_169629]);		}		LA4: ;
		nimln(1304, "system.nim");
		res_169656 = addInt(res_169656, 1);
	} LA1: ;
...
N_NIMCALL(ttrunk169039*, intsetput_169661)(tintset169043* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		nimln(84, "intsets.nim");
		nimln(84, "intsets.nim");
		TMP1925 = addInt((*t).Max, 1);
		LOC8 = 0;
		LOC8 = mustrehash_169054((NI32)(TMP1925), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
		intsetenlarge_169604(t);	}	LA9: ;
	...
	nimln(88, "intsets.nim");
	{
		...
		nimln(88, "intsets.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP1926));	}	LA14: ;
	nimln(89, "intsets.nim");
	result = (ttrunk169039*) newObj((&NTI169037), sizeof(ttrunk169039));
...
N_NIMCALL(NIM_BOOL, contains_169817)(tintset169043 s, NI key) {
	...
	nimln(97, "intsets.nim");
	t = intsetget_169212(s, (NI)((NU32)(key) >> (NU32)(9)));
...
N_NIMCALL(void, incl_169840)(tintset169043* s, NI key) {
	...
	nimln(106, "intsets.nim");
	t = intsetput_169661(s, (NI)((NU32)(key) >> (NU32)(9)));
...
N_NIMCALL(NIM_BOOL, containsorincl_169874)(tintset169043* s, NI key) {
	...
	LA3: ;
	{
		...
		incl_169840(s, key);		nimln(131, "intsets.nim");
		result = NIM_FALSE;
	}	LA1: ;
	popFrame();
	return result;
...
N_NIMCALL(void, initintset_169899)(tintset169043* Result) {
	...
	unsureAsgnRef((void**) &(*Result).Data, (ttrunkseq169041*) newSeq((&NTI169041), 8));
...
N_NIMCALL(void, assign_169914)(tintset169043* dest, tintset169043 src) {
	...
	nimln(145, "intsets.nim");
	unsureAsgnRef((void**) &(*dest).Data, (ttrunkseq169041*) newSeq((&NTI169041), src.Data->Sup.len));
	...
	while (1) {
		...
		nimln(152, "intsets.nim");
		{
			...
			nimln(152, "intsets.nim");
			hiddenraiseassert_76017(((NimStringDesc*) &TMP1927));		}		LA5: ;
		n = 0;
		nimln(155, "intsets.nim");
		n = (ttrunk169039*) newObj((&NTI169037), sizeof(ttrunk169039));
...
N_NIMCALL(NimStringDesc*, HEX24_170076)(tintset169043 s) {
	...
	NI key_170081;
	ttrunk169039* r_170084;
	nimfr("$", "intsets.nim")
	result = 0;
	nimln(183, "intsets.nim");
	result = copyString(((NimStringDesc*) &TMP1928));
	key_170081 = 0;
	...
	while (1) {
		...
		while (1) {
			...
			NI j_170090;
			nimln(169, "intsets.nim");
			if (!(i_170086 <= 15)) goto LA2;
			nimln(170, "intsets.nim");
			if ((NU)(i_170086) > (NU)(15)) raiseIndexError();
			w_170088 = (*r_170084).Bits[(i_170086)- 0];
			...
			while (1) {
				...
				nimln(175, "intsets.nim");
				{
					...
					nimln(698, "system.nim");
					nimln(175, "intsets.nim");
					if (!!((((NI) ((NI)(w_170088 & 1))) == 0))) goto LA6;
					nimln(176, "intsets.nim");
					nimln(176, "intsets.nim");
					nimln(176, "intsets.nim");
					nimln(176, "intsets.nim");
					nimln(176, "intsets.nim");
					key_170081 = (NI)((NI)((NU32)((*r_170084).Key) << (NU32)(9)) | (NI)((NU32)((NI)((NU32)(i_170086) << (NU32)(5))) + (NU32)(j_170090)));
...
appendString(result, ((NimStringDesc*) &TMP1929));
					}					LA10: ;
					nimln(186, "intsets.nim");
					nimln(186, "intsets.nim");
					LOC12 = 0;
					LOC12 = nimIntToStr(key_170081);
					result = resizeString(result, LOC12->Sup.len + 0);
appendString(result, LOC12);
				}				LA6: ;
				nimln(177, "intsets.nim");
				j_170090 = addInt(j_170090, 1);
				nimln(178, "intsets.nim");
				nimln(178, "intsets.nim");
				w_170088 = (NI)((NU32)(w_170088) >> (NU32)(1));
			} LA3: ;
			nimln(179, "intsets.nim");
			i_170086 = addInt(i_170086, 1);
		} LA2: ;
		nimln(180, "intsets.nim");
		r_170084 = (*r_170084).Next;
	} LA1: ;
	nimln(187, "intsets.nim");
	result = resizeString(result, 1);
appendString(result, ((NimStringDesc*) &TMP1930));
	popFrame();
	return result;
}
static N_INLINE(NIM_BOOL, empty_170096)(tintset169043 s) {
...
static TNimNode* TMP1922[3];
static TNimNode* TMP3348[4];
static TNimNode TMP1908[9];
NTI169039.size = sizeof(ttrunk169039);
NTI169039.kind = 18;
NTI169039.base = 0;
TMP1922[0] = &TMP1908[1];
TMP1908[1].kind = 1;
TMP1908[1].offset = offsetof(ttrunk169039, Next);
TMP1908[1].typ = (&NTI169037);
TMP1908[1].name = "next";
TMP1922[1] = &TMP1908[2];
TMP1908[2].kind = 1;
TMP1908[2].offset = offsetof(ttrunk169039, Key);
TMP1908[2].typ = (&NTI105);
TMP1908[2].name = "key";
TMP1922[2] = &TMP1908[3];
TMP1908[3].kind = 1;
TMP1908[3].offset = offsetof(ttrunk169039, Bits);
TMP1908[3].typ = (&NTI21418);
TMP1908[3].name = "bits";
TMP1908[0].len = 3; TMP1908[0].kind = 2; TMP1908[0].sons = &TMP1922[0];
NTI169039.node = &TMP1908[0];
NTI169037.size = sizeof(ttrunk169039*);
NTI169037.kind = 22;
NTI169037.base = (&NTI169039);
NTI169037.marker = TMP1923;
NTI169041.size = sizeof(ttrunkseq169041*);
NTI169041.kind = 24;
NTI169041.base = (&NTI169037);
NTI169041.flags = 2;
NTI169041.marker = TMP1924;
NTI169043.size = sizeof(tintset169043);
NTI169043.kind = 18;
NTI169043.base = 0;
NTI169043.flags = 2;
TMP3348[0] = &TMP1908[5];
TMP1908[5].kind = 1;
TMP1908[5].offset = offsetof(tintset169043, Counter);
TMP1908[5].typ = (&NTI105);
TMP1908[5].name = "counter";
TMP3348[1] = &TMP1908[6];
TMP1908[6].kind = 1;
TMP1908[6].offset = offsetof(tintset169043, Max);
TMP1908[6].typ = (&NTI105);
TMP1908[6].name = "max";
TMP3348[2] = &TMP1908[7];
TMP1908[7].kind = 1;
TMP1908[7].offset = offsetof(tintset169043, Head);
TMP1908[7].typ = (&NTI169037);
TMP1908[7].name = "head";
TMP3348[3] = &TMP1908[8];
TMP1908[8].kind = 1;
TMP1908[8].offset = offsetof(tintset169043, Data);
TMP1908[8].typ = (&NTI169041);
TMP1908[8].name = "data";
TMP1908[4].len = 4; TMP1908[4].kind = 2; TMP1908[4].sons = &TMP3348[0];
NTI169043.node = &TMP1908[4];
}
