...
N_NIMCALL(void, handlecmdline_535603)(void) {
	...
	{
		nimln(39, "nimrod.nim");
		processcmdline_529207(((NU8) 0), ((NimStringDesc*) &TMP7786));
		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP7787;
			TY109700 p;
		...
		initvars_173714();
		nimln(54, "nimrod.nim");
		processcmdline_529207(((NU8) 1), ((NimStringDesc*) &TMP7786));
		nimln(55, "nimrod.nim");
		maincommand_533011();
		nimln(56, "nimrod.nim");
		{
		...
		{
			nimln(58, "nimrod.nim");
			if (!(gerrorcounter_168182 == 0)) goto LA25;
			nimln(62, "nimrod.nim");
			{
				nimln(62, "nimrod.nim");
				...
				nimln(63, "nimrod.nim");
				{
					...
					nimln(65, "nimrod.nim");
					{
						...
						nimln(66, "nimrod.nim");
						LOC39 = 0;
						LOC39 = prependcurdir_535401(outfile_139117);
...
appendString(LOC44, arguments_529205);
				...
				LA33: ;
				{
					...
					nimln(73, "nimrod.nim");
					{
						...
						nimln(75, "nimrod.nim");
						binpath = prependcurdir_535401(outfile_139117);
					}
					goto LA46;
					LA48: ;
					{
...
N_NOINLINE(void, nimrodInit)(void) {
	...
	nimln(92, "nimrod.nim");
	nimln(92, "nimrod.nim");
	exit(((NI) (((NI8) ((0 < gerrorcounter_168182))))));
	popFrame();
}
