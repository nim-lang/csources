...
N_LIB_PRIVATE N_NIMCALL(void, newLine_wtdNGdPmHBG9cd6D9bP9abEiQ_2)(tyObject_TTmplParser_hVXV9cC75rOvsaODz9bp1zeg* p) {
	...
	LA4_: ;
	{
		...
		T10_ = spaces_JuXgKToWZhi41x7p8D3mDwastalgo(((NI) 2));
...
break;
		...
		LA28_: ;
		{
			...
			T40_ = spaces_JuXgKToWZhi41x7p8D3mDwastalgo(((NI) ((*p).indent)));
		...
		LA29_: ;
		{
			...
			T42_ = spaces_JuXgKToWZhi41x7p8D3mDwastalgo(((NI) ((*p).indent)));
		...
		LA30_: ;
		{
			...
			T45_ = spaces_JuXgKToWZhi41x7p8D3mDwastalgo(((NI) ((NI)((*p).indent - ((NI) 2)))));
		...
		LA31_: ;
		{
			...
			T48_ = spaces_JuXgKToWZhi41x7p8D3mDwastalgo(((NI) ((*p).indent)));
		...
		LA32_: ;
		{
			...
			T56_ = spaces_JuXgKToWZhi41x7p8D3mDwastalgo(((NI) ((*p).indent)));
	...
	LA16_: ;
	{
		...
		case ((tyEnum_TParseState_TMyoReN7VAtsUpVF9bL9cXRQ) 1):
		{
			...
			T60_ = spaces_JuXgKToWZhi41x7p8D3mDwastalgo(((NI) ((NI)((*p).indent + ((NI) 2)))));
		...
		case ((tyEnum_TParseState_TMyoReN7VAtsUpVF9bL9cXRQ) 0):
		{
			...
			T62_ = spaces_JuXgKToWZhi41x7p8D3mDwastalgo(((NI) ((*p).indent)));
