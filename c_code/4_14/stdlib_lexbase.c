...
N_LIB_PRIVATE N_NIMCALL(void, fillBuffer_CbKzA44X2DxZAmasZ72O9ag)(tyObject_BaseLexer_MAw8rJZtJ279bVV3TWMtXSg* L) {
	...
	LA3_: ;
	T5_ = (NI)0;
	T5_ = readData_TYaWywfT8qLRVVdONIVhkw_3((*L).input, ((void*) ((&(*L).buf[toCopy]))), (NI)((NI)((*L).sentinel + ((NI) 1)) * ((NI) 1)));
		...
		s -= ((NI) 1);
		{
			while (1) {
				...
				LA19_: ;
				{
					...
					(*L).buf = ((NCSTRING) (T22_));
					T23_ = (NI)0;
					T23_ = readData_TYaWywfT8qLRVVdONIVhkw_3((*L).input, ((void*) ((&(*L).buf[oldBufLen]))), (NI)(oldBufLen * ((NI) 1)));
