...
typedef NU16 tyEnum_TSpecialWord_w9aiPiu9cZjaWEB9aJgwcWW0A;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw*, newIdentCache_Y5daJTSUd79cza09cht1EK9cQ)(void) {
	...
	result = T1_;
	asgnRef((void**) (&(*result).idAnon), getIdent_uDz5mcDPddYz1vXwkXTNiQ(result, ((NimStringDesc*) &TM_L3r6bVdeFMiI9cwmLpWIeKw_4)));
	(*result).wordCounter = ((NI) 1);
	asgnRef((void**) (&(*result).idDelegator), getIdent_uDz5mcDPddYz1vXwkXTNiQ(result, ((NimStringDesc*) &TM_L3r6bVdeFMiI9cwmLpWIeKw_5)));
	asgnRef((void**) (&(*result).emptyIdent), getIdent_uDz5mcDPddYz1vXwkXTNiQ(result, ((NimStringDesc*) NIM_NIL)));
	{
		tyEnum_TSpecialWord_w9aiPiu9cZjaWEB9aJgwcWW0A s;
		NI res;
		s = (tyEnum_TSpecialWord_w9aiPiu9cZjaWEB9aJgwcWW0A)0;
		res = ((NI) 1);
		{
			while (1) {
				NI T5_;
				tyObject_TIdent_GufRQq9c0miSybX3zBD4tyA* T6_;
				if (!(res <= ((NI) 271))) goto LA4;
				s = ((tyEnum_TSpecialWord_w9aiPiu9cZjaWEB9aJgwcWW0A) (res));
				T5_ = (NI)0;
