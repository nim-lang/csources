...
TMP2677[0] = &TMP856[1];
TMP856[1].kind = 1;
TMP856[1].offset = offsetof(Baselexer246024, bufpos);
TMP856[1].typ = (&NTI108);
TMP856[1].name = "bufpos";
TMP2677[1] = &TMP856[2];
TMP856[2].kind = 1;
TMP856[2].offset = offsetof(Baselexer246024, buf);
TMP856[2].typ = (&NTI151);
TMP856[2].name = "buf";
TMP2677[2] = &TMP856[3];
TMP856[3].kind = 1;
TMP856[3].offset = offsetof(Baselexer246024, buflen);
TMP856[3].typ = (&NTI108);
TMP856[3].name = "bufLen";
TMP2677[3] = &TMP856[4];
TMP856[4].kind = 1;
TMP856[4].offset = offsetof(Baselexer246024, input);
TMP856[4].typ = (&NTI138025);
TMP856[4].name = "input";
TMP2677[4] = &TMP856[5];
TMP856[5].kind = 1;
TMP856[5].offset = offsetof(Baselexer246024, linenumber);
TMP856[5].typ = (&NTI108);
TMP856[5].name = "lineNumber";
TMP2677[5] = &TMP856[6];
TMP856[6].kind = 1;
TMP856[6].offset = offsetof(Baselexer246024, sentinel);
TMP856[6].typ = (&NTI108);
TMP856[6].name = "sentinel";
TMP2677[6] = &TMP856[7];
TMP856[7].kind = 1;
TMP856[7].offset = offsetof(Baselexer246024, linestart);
TMP856[7].typ = (&NTI108);
TMP856[7].name = "lineStart";
TMP2677[7] = &TMP856[8];
TMP856[8].kind = 1;
TMP856[8].offset = offsetof(Baselexer246024, fileopened);
TMP856[8].typ = (&NTI138);
TMP856[8].name = "fileOpened";
TMP856[0].len = 8; TMP856[0].kind = 2; TMP856[0].sons = &TMP2677[0];
NTI246024.node = &TMP856[0];
}
