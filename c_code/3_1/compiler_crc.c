...
NIM_CONST TY176066 crc32table_176065 = {((NI) 0),
((NI) 1996959894),
((NI) -301047508),
((NI) -1727442502),
((NI) 124634137),
...
{	result = 0;
	...
	result = ((NI32) -1);
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = open_13403(&bin, filename, ((NU8) 0), ((NI) -1));
		if (!!(LOC3)) goto LA4;
		goto BeforeRet;
	}
	LA4: ;
	...
	p = ((NI8*) (buf));
	{
		while (1) {
			NI readbytes;
			readbytes = readbuffer_13715(bin, buf, ((NI) 8000));
			{
				NI i_176649;
				NI HEX3Atmp_176654;
				NI res_176657;
				i_176649 = 0;
				HEX3Atmp_176654 = 0;
				HEX3Atmp_176654 = (NI32)(readbytes - ((NI) 1));
				res_176657 = ((NI) 0);
				{
					while (1) {
						if (!(res_176657 <= HEX3Atmp_176654)) goto LA10;
						i_176649 = res_176657;
						result = updatecrc32_176019(p[(i_176649)- 0], result);
						res_176657 += ((NI) 1);
					} LA10: ;
				}
			}
...
N_NIMCALL(NI32, HEX3EHEX3C_176535)(NI32 c, NimStringDesc* s) {
	...
	result = c;
	{
		...
		i_176550 = 0;
		HEX3Atmp_176552 = 0;
		HEX3Atmp_176552 = (NI32)(s->Sup.len - ((NI) 1));
		res_176555 = ((NI) 0);
		{
			while (1) {
				if (!(res_176555 <= HEX3Atmp_176552)) goto LA3;
				i_176550 = res_176555;
				result = updatecrc32_176026(s->data[i_176550], result);
				res_176555 += ((NI) 1);
			} LA3: ;
		}
	}
