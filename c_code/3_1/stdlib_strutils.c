...
STRING_LITERAL(TMP1262, "invalid integer: ", 17);
STRING_LITERAL(TMP1405, "0123456789ABCDEF", 16);
STRING_LITERAL(TMP1407, "", 0);
STRING_LITERAL(TMP2111, "\\x", 2);
...
101}
;
STRING_LITERAL(TMP5288, "GB", 2);
STRING_LITERAL(TMP5289, "MB", 2);
STRING_LITERAL(TMP5290, "KB", 2);
STRING_LITERAL(TMP5291, "B", 1);
...
N_NOINLINE(void, invalidformatstring_102542)(void) {
	...
	NimStringDesc* LOC1;
	e_102547 = 0;
	e_102547 = (Valueerror3646*) newObj((&NTI23825), sizeof(Valueerror3646));
...
N_NIMCALL(NF, nsuParseFloat)(NimStringDesc* s) {
	...
	L = npuParseFloat(s, (&result), ((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		e_99695 = 0;
		e_99695 = (Valueerror3646*) newObj((&NTI23825), sizeof(Valueerror3646));
...
N_NIMCALL(NI64, nsuParseBiggestInt)(NimStringDesc* s) {
	...
	L = npuParseBiggestInt(s, (&result), ((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		e_99675 = 0;
		e_99675 = (Valueerror3646*) newObj((&NTI23825), sizeof(Valueerror3646));
		(*e_99675).Sup.Sup.m_type = (&NTI3646);
		LOC7 = 0;
		LOC7 = rawNewString(s->Sup.len + 17);
appendString(LOC7, ((NimStringDesc*) &TMP1262));
appendString(LOC7, s);
	...
	result = mnewString(((NI) (len)));
	{
		...
		res_99620 = ((NI) (HEX3Atmp_99617));
		{
			while (1) {
				...
				result->data[j_99614] = ((NimStringDesc*) &TMP1405)->data[(NI64)(n & IL64(15))];
...
N_NIMCALL(NI, nsuParseInt)(NimStringDesc* s) {
	...
	L = npuParseInt(s, (&result), ((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		e_99655 = 0;
		e_99655 = (Valueerror3646*) newObj((&NTI23825), sizeof(Valueerror3646));
	...
	LA1: ;
	{
		while (1) {
			...
			default:
			{
				...
				NimStringDesc* LOC20;
				e_99823 = 0;
				e_99823 = (Valueerror3646*) newObj((&NTI23825), sizeof(Valueerror3646));
				(*e_99823).Sup.Sup.m_type = (&NTI3646);
				LOC20 = 0;
				LOC20 = rawNewString(s->Sup.len + 17);
appendString(LOC20, ((NimStringDesc*) &TMP1262));
...
appendString(LOC19, ((NimStringDesc*) &TMP5290));
		result = LOC19;
	}
	goto LA1;
	LA17: ;
...
appendString(LOC24, ((NimStringDesc*) &TMP5291));
		result = LOC24;
	}
	LA1: ;
	return result;
