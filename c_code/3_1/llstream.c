...
N_NIMCALL(NI, counttriples_174676)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1631 = addInt(i, 1);
			if ((NU)((NI32)(TMP1631)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI32)(TMP1631)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1632 = addInt(i, 2);
			if ((NU)((NI32)(TMP1632)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI32)(TMP1632)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
appendString((*s).S, ((NimStringDesc*) &TMP1635));
	...
	result = ((buflen <= (NI32)(TMP1636)) ? buflen : (NI32)(TMP1636));
...
N_NIMCALL(NI, llstreamread_174242)(tllstream174204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		result = ((buflen <= (NI32)(TMP1637)) ? buflen : (NI32)(TMP1637));
		nimln(136, "llstream.nim");
		{
			...
			if ((NU)((NI32)(TMP1638)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI32)(TMP1638)])), result);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_174254)(tllstream174204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI32)(TMP1641));
			nimln(222, "llstream.nim");
			nimln(222, "llstream.nim");
			TMP1642 = addInt(i, 0);
			if ((NU)((NI32)(TMP1642)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_10827((*s).F, ((void*) (&result->data[(NI32)(TMP1642)])), 2048);
