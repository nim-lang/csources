...
N_NIMCALL(NI, counttriples_179676)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1633 = addInt(i, 1);
			if ((NU)((NI32)(TMP1633)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI32)(TMP1633)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			...
			LOC4 = ((NU8)(s->data[(NI32)(TMP1634)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
appendString((*s).S, ((NimStringDesc*) &TMP1637));
	...
	result = ((buflen <= (NI32)(TMP1638)) ? buflen : (NI32)(TMP1638));
...
N_NIMCALL(NI, llstreamread_179242)(tllstream179204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		nimln(136, "llstream.nim");
		{
			...
			if ((NU)((NI32)(TMP1640)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI32)(TMP1640)])), result);
...
N_NIMCALL(void, llstreamwrite_179268)(tllstream179204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			(*s).S = setLengthStr((*s).S, (NI32)(TMP1641));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1642 = addInt(0, (*s).Wr);
			if ((NU)((NI32)(TMP1642)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI32)(TMP1642)])), buf, buflen);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_179254)(tllstream179204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI32)(TMP1643));
			nimln(222, "llstream.nim");
			nimln(222, "llstream.nim");
			TMP1644 = addInt(i, 0);
			if ((NU)((NI32)(TMP1644)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_11027((*s).F, ((void*) (&result->data[(NI32)(TMP1644)])), 2048);
