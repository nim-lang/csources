...
N_NIMCALL(tstringtable112610*, nstnewStringTableWithTableConstr)(TY87905* keyvaluepairs, NI keyvaluepairsLen0, NU8 mode);
...
N_NIMCALL(void, enlarge_112876)(tstringtable112610* t) {
	...
	n = (tkeyvaluepairseq112608*) newSeq((&NTI112608), (NI32)(TMP285));
	i_112907 = 0;
	HEX3Atmp_112921 = 0;
...
N_NIMCALL(tstringtable112610*, nstnewStringTableWithPairs)(NimStringDesc** keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	...
	while (1) {
		...
		nstPut(result, keyvaluepairs[i], keyvaluepairs[(NI32)(TMP297)]);		nimln(177, "strtabs.nim");
		i = addInt(i, 2);
	} LA1: ;
	popFrame();
	return result;
