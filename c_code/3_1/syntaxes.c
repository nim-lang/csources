...
N_NIMCALL(NIM_BOOL, containsshebang_219100)(NimStringDesc* s, NI i) {
	...
	nimln(83, "syntaxes.nim");
	{
		...
		nimln(83, "syntaxes.nim");
		TMP2696 = addInt(i, 1);
		if ((NU)((NI32)(TMP2696)) > (NU)(s->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(s->data[(NI32)(TMP2696)]) == (NU8)(33));
		LA4: ;
		if (!LOC3) goto LA5;
...
N_NIMCALL(tnode186813*, parsepipe_219138)(NimStringDesc* filename, tllstream174204* inputstream) {
	...
	nimln(91, "syntaxes.nim");
	{
		...
		nimln(98, "syntaxes.nim");
		{
			...
			nimln(98, "syntaxes.nim");
			TMP2698 = addInt(i, 1);
			if ((NU)((NI32)(TMP2698)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC14 = ((NU8)(line->data[(NI32)(TMP2698)]) == (NU8)(33));
			LA15: ;
			if (!LOC14) goto LA16;
