...
typedef N_NIMCALL_PTR(NIM_BOOL, tcompareproc118025) (tlistentry118017* entry, void* closure);
...
N_NIMCALL(tstrentry118019*, newstrentry_118263)(NimStringDesc* data);
...
N_NIMCALL(void, insertbefore_118444)(tlinkedlist118023* list, tlistentry118017* pos, tlistentry118017* entry);
...
N_NIMCALL(tlistentry118017*, find_118830)(tlinkedlist118023 list, tcompareproc118025 fn, void* closure);
STRING_LITERAL(TMP258, "list.tail.next == nil ", 22);
STRING_LITERAL(TMP262, "list.head.prev == nil ", 22);
STRING_LITERAL(TMP263, "pos != nil ", 11);
extern TFrame* frameptr_13238;
extern tgcheap43416 gch_43444;
extern TNimType NTI2409; /* TObject */
TNimType NTI118017; /* TListEntry */
TNimType NTI118015; /* PListEntry */
TNimType NTI118019; /* TStrEntry */
extern TNimType NTI143; /* string */
TNimType NTI118021; /* PStrEntry */
TNimType NTI118023; /* TLinkedList */
...
N_NIMCALL(NIM_BOOL, contains_118237)(tlinkedlist118023 list, NimStringDesc* data) {
	...
	while (1) {
		...
		{
			nimln(45, "lists.nim");
			if (it) chckObj((*it).Sup.m_type, (&NTI118019));
			if (!eqStrings((*((tstrentry118019*) (it))).Data, data)) goto LA4;
			nimln(46, "lists.nim");
			nimln(46, "lists.nim");
			result = NIM_TRUE;
			goto BeforeRet;
...
N_NIMCALL(tstrentry118019*, newstrentry_118263)(NimStringDesc* data) {
	tstrentry118019* result;
	NimStringDesc* LOC1;
	nimfr("newStrEntry", "lists.nim")
	result = 0;
	nimln(50, "lists.nim");
	result = (tstrentry118019*) newObj((&NTI118021), sizeof(tstrentry118019));
	(*result).Sup.Sup.m_type = (&NTI118019);
	nimln(51, "lists.nim");
	LOC1 = 0;
...
N_NIMCALL(void, appendstr_118285)(tlinkedlist118023* list, NimStringDesc* data) {
	tstrentry118019* LOC1;
	nimfr("appendStr", "lists.nim")
	nimln(54, "lists.nim");
	nimln(54, "lists.nim");
	LOC1 = 0;
	LOC1 = newstrentry_118263(data);
	append_118042(list, &LOC1->Sup);
	popFrame();
}
...
static TNimNode* TMP259[2];
static TNimNode* TMP3239[3];
static TNimNode TMP256[8];
NTI118017.size = sizeof(tlistentry118017);
NTI118017.kind = 17;
NTI118017.base = (&NTI2409);
TMP259[0] = &TMP256[1];
NTI118015.size = sizeof(tlistentry118017*);
NTI118015.kind = 22;
NTI118015.base = (&NTI118017);
NTI118015.marker = TMP260;
TMP256[1].kind = 1;
TMP256[1].offset = offsetof(tlistentry118017, Prev);
TMP256[1].typ = (&NTI118015);
TMP256[1].name = "prev";
TMP259[1] = &TMP256[2];
TMP256[2].kind = 1;
TMP256[2].offset = offsetof(tlistentry118017, Next);
TMP256[2].typ = (&NTI118015);
TMP256[2].name = "next";
TMP256[0].len = 2; TMP256[0].kind = 2; TMP256[0].sons = &TMP259[0];
NTI118017.node = &TMP256[0];
NTI118019.size = sizeof(tstrentry118019);
NTI118019.kind = 17;
NTI118019.base = (&NTI118017);
TMP256[3].kind = 1;
TMP256[3].offset = offsetof(tstrentry118019, Data);
TMP256[3].typ = (&NTI143);
TMP256[3].name = "data";
NTI118019.node = &TMP256[3];
NTI118021.size = sizeof(tstrentry118019*);
NTI118021.kind = 22;
NTI118021.base = (&NTI118019);
NTI118021.marker = TMP261;
NTI118023.size = sizeof(tlinkedlist118023);
NTI118023.kind = 18;
NTI118023.base = 0;
TMP3239[0] = &TMP256[5];
TMP256[5].kind = 1;
TMP256[5].offset = offsetof(tlinkedlist118023, Head);
TMP256[5].typ = (&NTI118015);
TMP256[5].name = "head";
TMP3239[1] = &TMP256[6];
TMP256[6].kind = 1;
TMP256[6].offset = offsetof(tlinkedlist118023, Tail);
TMP256[6].typ = (&NTI118015);
TMP256[6].name = "tail";
TMP3239[2] = &TMP256[7];
TMP256[7].kind = 1;
TMP256[7].offset = offsetof(tlinkedlist118023, Counter);
TMP256[7].typ = (&NTI106);
TMP256[7].name = "counter";
TMP256[4].len = 3; TMP256[4].kind = 2; TMP256[4].sons = &TMP3239[0];
NTI118023.node = &TMP256[4];
}
