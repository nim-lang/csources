...
static NIM_CONST TY171865 TMP5585 = {
...
N_NIMCALL(ttype171693*, getuniquetype_366401)(ttype171693* key) {
	...
	case ((NU8) 55):
	{
		...
		internalerror_138383(((NimStringDesc*) &TMP5589));	}	break;
	case ((NU8) 12):
	{
		nimln(92, "ccgutils.nim");
		internalerror_138383(((NimStringDesc*) &TMP5590));	}	break;
	case ((NU8) 11):
	case ((NU8) 13):
	case ((NU8) 15):
	case ((NU8) 47):
