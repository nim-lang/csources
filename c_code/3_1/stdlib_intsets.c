...
STRING_LITERAL(TMP1932, "length > counter ", 17);
STRING_LITERAL(TMP1938, "data[h] != desc ", 16);
STRING_LITERAL(TMP1939, "data[h] == nil ", 15);
STRING_LITERAL(TMP1948, "t.data[h] == nil ", 17);
STRING_LITERAL(TMP1949, "dest.data[h] == nil ", 20);
STRING_LITERAL(TMP1950, "{", 1);
STRING_LITERAL(TMP1951, ", ", 2);
...
extern TNimType NTI23018; /* array[0..15, int] */
...
static N_INLINE(NIM_BOOL, mustrehash_183058)(NI length, NI counter) {
	...
	nimln(47, "intsets.nim");
	{
		...
		nimln(47, "intsets.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP1932));
	}
	LA3: ;
	...
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	TMP1933 = mulInt(length, 2);
	nimln(48, "intsets.nim");
	TMP1934 = mulInt(counter, 3);
	LOC5 = ((NI32)(TMP1933) < (NI32)(TMP1934));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	TMP1935 = subInt(length, counter);
	LOC5 = ((NI32)(TMP1935) < 4);
	LA6: ;
	result = LOC5;
	popFrame();
...
static N_INLINE(NI, nexttry_183206)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1936 = mulInt(5, h);
	TMP1937 = addInt((NI32)(TMP1936), 1);
	result = (NI)((NI32)(TMP1937) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, intsetrawinsert_183239)(tintset183047 t, ttrunkseq183045** data, ttrunk183043* desc) {
	...
	while (1) {
		...
		nimln(64, "intsets.nim");
		{
			...
			nimln(64, "intsets.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP1938));
		}
		LA4: ;
	...
	nimln(66, "intsets.nim");
	{
		...
		nimln(66, "intsets.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP1939));
	}
	LA8: ;
...
N_NIMCALL(void, intsetenlarge_183621)(tintset183047* t) {
	...
	nimln(72, "intsets.nim");
	nimln(72, "intsets.nim");
	TMP1940 = addInt((*t).Max, 1);
	TMP1941 = mulInt((NI32)(TMP1940), 2);
	TMP1942 = subInt((NI32)(TMP1941), 1);
	(*t).Max = (NI32)(TMP1942);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1943 = addInt((*t).Max, 1);
	n = (ttrunkseq183045*) newSeq((&NTI183045), (NI32)(TMP1943));
	i_183655 = 0;
...
N_NIMCALL(ttrunk183043*, intsetput_183696)(tintset183047* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		nimln(84, "intsets.nim");
		nimln(84, "intsets.nim");
		TMP1947 = addInt((*t).Max, 1);
		LOC8 = 0;
		LOC8 = mustrehash_183058((NI32)(TMP1947), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
	...
	nimln(88, "intsets.nim");
	{
		...
		nimln(88, "intsets.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP1948));
	}
	LA14: ;
...
N_NIMCALL(NIM_BOOL, contains_183838)(tintset183047 s, NI key) {
	...
	nimln(97, "intsets.nim");
	t = intsetget_183213(s, (NI)((NU32)(key) >> (NU32)(9)));
...
N_NIMCALL(void, incl_183866)(tintset183047* s, NI key) {
	...
	nimln(106, "intsets.nim");
	t = intsetput_183696(s, (NI)((NU32)(key) >> (NU32)(9)));
...
N_NIMCALL(void, assign_183956)(tintset183047* dest, tintset183047 src) {
	...
	while (1) {
		...
		nimln(152, "intsets.nim");
		{
			...
			nimln(152, "intsets.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP1949));
		}
		LA5: ;
		n = 0;
...
N_NIMCALL(NimStringDesc*, HEX24_184322)(tintset183047 s) {
	...
	result = copyString(((NimStringDesc*) &TMP1950));
	key_184327 = 0;
	...
	while (1) {
		...
		while (1) {
			...
			NI j_184336;
			nimln(169, "intsets.nim");
			if (!(i_184332 <= 15)) goto LA2;
			nimln(170, "intsets.nim");
			if ((NU)(i_184332) > (NU)(15)) raiseIndexError();
			...
			while (1) {
				...
				nimln(175, "intsets.nim");
				{
					...
					nimln(176, "intsets.nim");
					nimln(176, "intsets.nim");
					key_184327 = (NI)((NI)((NU32)((*r_184330).Key) << (NU32)(9)) | (NI)((NU32)((NI)((NU32)(i_184332) << (NU32)(5))) + (NU32)(j_184336)));
...
appendString(result, ((NimStringDesc*) &TMP1951));
					}
					LA10: ;
...
appendString(result, LOC12);
				...
				nimln(178, "intsets.nim");
				w_184334 = (NI)((NU32)(w_184334) >> (NU32)(1));
			} LA3: ;
...
static TNimNode TMP1930[9];
NTI183043.size = sizeof(ttrunk183043);
NTI183043.kind = 18;
NTI183043.base = 0;
TMP1944[0] = &TMP1930[1];
TMP1930[1].kind = 1;
TMP1930[1].offset = offsetof(ttrunk183043, Next);
TMP1930[1].typ = (&NTI183041);
TMP1930[1].name = "next";
TMP1944[1] = &TMP1930[2];
TMP1930[2].kind = 1;
TMP1930[2].offset = offsetof(ttrunk183043, Key);
TMP1930[2].typ = (&NTI106);
TMP1930[2].name = "key";
TMP1944[2] = &TMP1930[3];
TMP1930[3].kind = 1;
TMP1930[3].offset = offsetof(ttrunk183043, Bits);
TMP1930[3].typ = (&NTI23018);
TMP1930[3].name = "bits";
TMP1930[0].len = 3; TMP1930[0].kind = 2; TMP1930[0].sons = &TMP1944[0];
NTI183043.node = &TMP1930[0];
NTI183041.size = sizeof(ttrunk183043*);
NTI183041.kind = 22;
NTI183041.base = (&NTI183043);
NTI183041.marker = TMP1945;
NTI183045.size = sizeof(ttrunkseq183045*);
NTI183045.kind = 24;
NTI183045.base = (&NTI183041);
NTI183045.flags = 2;
NTI183045.marker = TMP1946;
...
TMP3238[0] = &TMP1930[5];
TMP1930[5].kind = 1;
TMP1930[5].offset = offsetof(tintset183047, Counter);
TMP1930[5].typ = (&NTI106);
TMP1930[5].name = "counter";
TMP3238[1] = &TMP1930[6];
TMP1930[6].kind = 1;
TMP1930[6].offset = offsetof(tintset183047, Max);
TMP1930[6].typ = (&NTI106);
TMP1930[6].name = "max";
TMP3238[2] = &TMP1930[7];
TMP1930[7].kind = 1;
TMP1930[7].offset = offsetof(tintset183047, Head);
TMP1930[7].typ = (&NTI183041);
TMP1930[7].name = "head";
TMP3238[3] = &TMP1930[8];
TMP1930[8].kind = 1;
TMP1930[8].offset = offsetof(tintset183047, Data);
TMP1930[8].typ = (&NTI183045);
TMP1930[8].name = "data";
TMP1930[4].len = 4; TMP1930[4].kind = 2; TMP1930[4].sons = &TMP3238[0];
NTI183047.node = &TMP1930[4];
}
