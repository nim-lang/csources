...
N_NIMCALL(void, incl_210832)(Intset210035* s, NI key) {
	Trunk210031* t;
	NI u;
	t = intsetput_210661(s, (NI)((NU32)(key) >> (NU32)(((NI) 9))));
	u = (NI)(key & ((NI) 511));
...
N_NIMCALL(NIM_BOOL, containsorincl_210862)(Intset210035* s, NI key) {
	...
	Trunk210031* t;
	result = 0;
	t = intsetget_210206((*s), (NI)((NU32)(key) >> (NU32)(((NI) 9))));
	{
		NI u;
...
N_NIMCALL(void, assign_210910)(Intset210035* dest, Intset210035 src) {
	...
	it = src.head;
	{
		while (1) {
			...
			(*n).key = (*it).key;
			memcpy((void*)(*n).bits, (NIM_CONST void*)(*it).bits, sizeof(TY29818));
