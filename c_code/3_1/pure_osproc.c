...
N_NIMCALL(tfilestream143109*, newfilestream_143167)(FILE* f);
...
N_NIMCALL(tprocess144203*, startcmd_144428)(NimStringDesc* command, NU8 options) {
	...
	a = (TY9552*) newSeq((&NTI9552), (NI32)(TMP938));
	i_144473 = 0;
	HEX3Atmp_144475 = 0;
	...
	while (1) {
		...
		if ((NU)((NI32)(TMP940)) >= (NU)(a->Sup.len)) raiseIndexError();
		if ((NU)(i_144473) >= (NU)(c->Sup.len)) raiseIndexError();
		LOC2 = 0;
		LOC2 = a->data[(NI32)(TMP940)]; a->data[(NI32)(TMP940)] = copyStringRC1(c->data[i_144473]);
...
N_NIMCALL(NCSTRING*, tocstringarray_145626)(NimStringDesc** b, NI bLen0, NimStringDesc** a, NI aLen0) {
	...
	TMP957 = addInt((NI32)(TMP956), 1);
	TMP958 = mulInt((NI32)(TMP957), 4);
	LOC1 = 0;
	LOC1 = alloc0_4004((NI32)(TMP958));
	...
	while (1) {
		...
		memcpy(((void*) (result[(i_145654)- 0])), ((void*) (b[i_145654]->data)), (NI32)(TMP960));		nimln(1311, "system.nim");
	...
	while (1) {
		...
		if ((NU)((NI32)(TMP961)) > (NU)(50000)) raiseIndexError();
		nimln(576, "osproc.nim");
		nimln(576, "osproc.nim");
		nimln(576, "osproc.nim");
		...
		LOC5 = 0;
		LOC5 = alloc_4001((NI32)(TMP962));
		result[((NI32)(TMP961))- 0] = ((NCSTRING) (LOC5));
		nimln(577, "osproc.nim");
		nimln(577, "osproc.nim");
		nimln(577, "osproc.nim");
		TMP963 = addInt(i_145664, bLen0);
		if ((NU)((NI32)(TMP963)) > (NU)(50000)) raiseIndexError();
		if ((NU)(i_145664) >= (NU)(aLen0)) raiseIndexError();
		nimln(577, "osproc.nim");
		nimln(577, "osproc.nim");
		if ((NU)(i_145664) >= (NU)(aLen0)) raiseIndexError();
		TMP964 = addInt(a[i_145664]->Sup.len, 1);
		memcpy(((void*) (result[((NI32)(TMP963))- 0])), ((void*) (a[i_145664]->data)), (NI32)(TMP964));		nimln(1311, "system.nim");
...
N_NIMCALL(NCSTRING*, tocstringarray_145692)(tstringtable112610* t) {
	...
	TMP966 = mulInt((NI32)(TMP965), 4);
	LOC2 = 0;
	LOC2 = alloc0_4004((NI32)(TMP966));
...
appendString(LOC8, val_145699);
			...
			memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI32)(TMP969));			nimln(586, "osproc.nim");
			i = addInt(i, 1);
		}		LA6: ;
		nimln(1311, "system.nim");
...
N_NIMCALL(NCSTRING*, envtocstringarray_145723)(void) {
	...
	while (1) {
		...
		key_145727 = copyStrLast(environment_104029->data[i_145756], 0, (NI32)(TMP970));
		nimln(1152, "os.nim");
		nimln(1152, "os.nim");
		if ((NU)(i_145756) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1152, "os.nim");
		TMP971 = addInt(p_145762, 1);
		val_145728 = copyStr(environment_104029->data[i_145756], (NI32)(TMP971));
	...
	TMP973 = mulInt((NI32)(TMP972), 4);
	LOC2 = 0;
	LOC2 = alloc0_4004((NI32)(TMP973));
	result = ((NCSTRING*) (LOC2));
	...
	while (1) {
		...
		key_145741 = copyStrLast(environment_104029->data[i_145772], 0, (NI32)(TMP974));
		nimln(1152, "os.nim");
		nimln(1152, "os.nim");
		if ((NU)(i_145772) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1152, "os.nim");
		TMP975 = addInt(p_145778, 1);
		val_145742 = copyStr(environment_104029->data[i_145772], (NI32)(TMP975));
...
appendString(LOC4, val_145742);
		...
		memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI32)(TMP977));		nimln(597, "osproc.nim");
		i = addInt(i, 1);
		nimln(1311, "system.nim");
...
N_NIMCALL(void, pruneprocessset_146391)(TY145202** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(803, "osproc.nim");
		{
			...
			nimln(804, "osproc.nim");
			TMP983 = subInt(l, 1);
			if ((NU)((NI32)(TMP983)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRefNoCycle((void**) &(*s)->data[i], (*s)->data[(NI32)(TMP983)]);
...
N_NIMCALL(NI, select_145502)(TY145202** readfds, NI timeout) {
	...
	createfdset_146336(&rd, (*readfds), &m);	nimln(819, "osproc.nim");
	{
		...
		TMP985 = addInt(m, 1);
		LOC5 = 0;
		LOC5 = select(((int) ((NI32)(TMP985))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}	goto LA1;
	LA3: ;
	{
		...
		TMP986 = addInt(m, 1);
		LOC7 = 0;
		LOC7 = select(((int) ((NI32)(TMP986))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}	LA1: ;
