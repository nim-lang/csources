...
N_NIMCALL(void, fillbuffer_181072)(tbaselexer181018* l) {
	...
	nimln(85, "nimlexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI32)(TMP1649)])), (NI32)(TMP1650));
	}
	LA11: ;
	...
	TMP1652 = mulInt((NI32)(TMP1651), 1);
	LOC13 = 0;
	LOC13 = llstreamread_179242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI32)(TMP1652));
	TMP1653 = divInt(LOC13, 1);
	charsread = (NI32)(TMP1653);
	...
	nimln(91, "nimlexbase.nim");
	{
		...
		if (!(charsread < (NI32)(TMP1655))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI32)(TMP1657);
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				TMP1658 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4631(((void*) ((*l).Buf)), (NI32)(TMP1658));
				...
				nimln(110, "nimlexbase.nim");
				{
					...
					if (!!(((NI32)(TMP1659) == oldbuflen))) goto LA35;
					nimln(110, "nimlexbase.nim");
				...
				LOC37 = 0;
				LOC37 = llstreamread_179242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI32)(TMP1661));
...
N_NIMCALL(void, openbaselexer_181027)(tbaselexer181018* l, tllstream179204* inputstream, NI buflen) {
	...
	LOC5 = 0;
	LOC5 = alloc_4601((NI32)(TMP1671));
	(*l).Buf = ((NCSTRING) (LOC5));
	nimln(151, "nimlexbase.nim");
	nimln(151, "nimlexbase.nim");
	TMP1672 = subInt(buflen, 1);
	(*l).Sentinel = (NI32)(TMP1672);
...
N_NIMCALL(NI, getcolnumber_181045)(tbaselexer181018* l, NI pos) {
	...
	if ((NI32)(TMP1673) == (-2147483647 -1)) raiseOverflow();
	result = (NI32)abs((NI32)(TMP1673));
	popFrame();
	return result;
}
