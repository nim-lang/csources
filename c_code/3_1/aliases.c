...
STRING_LITERAL(TMP3039, "isPartOfAux(record case branch)", 31);
STRING_LITERAL(TMP3040, "isPartOfAux()", 13);
...
N_NIMCALL(NU8, ispartofaux_474029)(tnode224819* n, ttype224855* b, intset221056* marker) {
		...
		LA13: ;
		{
			...
			res_474298 = 1;
			{
				while (1) {
					...
					default:
					{
						internalerror_197989(((NimStringDesc*) &TMP3039));
					}
					break;
					}
					res_474298 += 1;
	...
	default:
	{
		internalerror_197970((*n).Info, ((NimStringDesc*) &TMP3040));
	}
	break;
	}
	BeforeRet: ;
