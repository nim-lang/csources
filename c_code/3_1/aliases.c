...
static NIM_CONST TY187025 TMP5608 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5609, "sons", 4);
STRING_LITERAL(TMP5611, "n.sons[0].kind == nkSym ", 24);
STRING_LITERAL(TMP5614, "isPartOfAux(record case branch)", 31);
static NIM_CONST TY187025 TMP5615 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5616, "sym", 3);
STRING_LITERAL(TMP5617, "isPartOfAux()", 13);
...
static N_INLINE(NI, sonslen_187191)(tnode186813* n) {
	...
	{
		nimln(1301, "ast.nim");
		if (((TMP5608[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP5609));
...
static N_INLINE(tnode186813*, lastson_187199)(tnode186813* n) {
	...
	TMP5613 = subInt(LOC1, 1);
	if ((NU)((NI32)(TMP5613)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI32)(TMP5613)];
	popFrame();
	return result;
}
...
N_NIMCALL(NU8, ispartofaux_411020)(tnode186813* n, ttype186847* b, tintset183047* marker) {
	...
	case ((NU8) 136):
	{
		...
		TMP5610 = subInt(LOC2, 1);
		HEX3Atmp_411311 = (NI32)(TMP5610);
	...
	case ((NU8) 137):
	{
		...
		TMP5612 = subInt(LOC17, 1);
		HEX3Atmp_411315 = (NI32)(TMP5612);
		nimln(1450, "system.nim");
		res_411317 = 1;
		nimln(1451, "system.nim");
		while (1) {
			...
			default:
			{
				...
				internalerror_164606(((NimStringDesc*) &TMP5614));
			}
			break;
			}
			nimln(1453, "system.nim");
	...
	case ((NU8) 3):
	{
		...
		if (!(((TMP5615[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5616));
	...
	default:
	{
		...
		internalerror_164591((*n).Info, ((NimStringDesc*) &TMP5617));
	}
	break;
	}
	BeforeRet: ;
...
static N_INLINE(ttype186847*, lastson_187203)(ttype186847* n) {
	...
	if ((NU)((NI32)(TMP5618)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP5618)];
	popFrame();
	return result;
}
...
N_NIMCALL(NU8, ispartofaux_411013)(ttype186847* a, ttype186847* b, tintset183047* marker) {
	...
	case ((NU8) 18):
	{
		...
		TMP5619 = subInt(LOC25, 1);
		HEX3Atmp_411395 = (NI32)(TMP5619);
		nimln(1450, "system.nim");
		res_411397 = 0;
		nimln(1451, "system.nim");
		while (1) {
...
N_NIMCALL(NU8, ispartof_411411)(tnode186813* a, tnode186813* b) {
	...
	nimln(94, "aliases.nim");
	{
		...
		case ((NU8) 3):
		{
			...
			{
				nimln(99, "aliases.nim");
				if (!(((TMP5615[(*a).Kind/8] &(1<<((*a).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5616));
				if (!(((TMP5615[(*b).Kind/8] &(1<<((*b).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5616));
		...
		case ((NU8) 45):
		{
			...
			nimln(128, "aliases.nim");
			{
				...
				nimln(130, "aliases.nim");
				{
					...
					if (!(((TMP5615[(*LOC81).Kind/8] &(1<<((*LOC81).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5616));
					nimln(130, "aliases.nim");
					LOC82 = 0;
					LOC82 = HEX5BHEX5D_187711(b, 1);
					if (!(((TMP5615[(*LOC82).Kind/8] &(1<<((*LOC82).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5616));
