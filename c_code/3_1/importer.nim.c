...
appendString(err, T18_);
		...
		asgnRef((void**) (&(*(*c).graph).importStack), (tySequence_48JTohSgTy339bRxHzUD8KA*) setLengthSeqV2(&((*(*c).graph).importStack)->Sup, (&NTI_48JTohSgTy339bRxHzUD8KA_), ((NI)chckRange(L, ((NI) 0), ((NI) 2147483647)))));
		{
			NIM_BOOL T25_;
			T25_ = (NIM_BOOL)0;
...
N_LIB_PRIVATE N_NIMCALL(void, rawImportSymbol_qTKM3Dk2MEIWKGK9aoCIRwg_2)(tyObject_TContext_C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w* s) {
	...
	strTableAdd_tyTgUybFIoow4CX2l5beug((&(*(*c).importTable).symbols), s);
	{
		...
		etyp = (*s).typ;
		{
			if (!((*etyp).kind == ((tyEnum_TTypeKind_9a3YiReNVD0IJHWFKgXRe9ag) 1) || (*etyp).kind == ((tyEnum_TTypeKind_9a3YiReNVD0IJHWFKgXRe9ag) 14))) goto LA19_;
			{
				NI j;
				NI colontmp_;
				NI i;
