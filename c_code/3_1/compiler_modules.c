...
N_NIMCALL(NU8, checkdepmem_523405)(NI32 fileidx);
...
STRING_LITERAL(TMP1501, "handleSymbolFile should have set the module\'s ID", 48);
STRING_LITERAL(TMP1506, "compiler/modules.nim", 20);
NIM_CONST TY86345 TMP1505 = {((NimStringDesc*) &TMP1506),
((NI) 41)}
;
STRING_LITERAL(TMP4263, "", 0);
STRING_LITERAL(TMP4264, "nim", 3);
STRING_LITERAL(TMP4265, "system.nim", 10);
STRING_LITERAL(TMP4976, "stdin", 5);
...
N_NIMCALL(void, docrc_523134)(NI32 fileidx) {
	{
		...
		LOC5 = 0;
		LOC5 = tofilename_164274(fileidx);
...
N_NIMCALL(Tsym191843*, newmodule_523646)(NI32 fileidx) {
	...
	(*result).Sup.id = ((NI) -1);
	(*result).kind = ((NU8) 6);
	filename = tofullpath_164284(fileidx);
	...
	asgnRefNoCycle((void**) (&(*result).name), getident_167463(LOC1.Field1));
	{
		...
		NIM_BOOL LOC6;
		LOC4 = 0;
		LOC4 = !(eqStrings((*(*result).name).s, ((NimStringDesc*) &TMP1427)));
		if (!(LOC4)) goto LA5;
		LOC6 = 0;
	...
	LA7: ;
	(*result).info = newlineinfo_163871(fileidx, ((NI) 1), ((NI) 1));
	LOC9 = 0;
...
N_NIMCALL(NIM_BOOL, crcchanged_523105)(NI32 fileidx) {
	...
	case ((NU8) 1):
	{
		...
		NimStringDesc* LOC11;
		LOC11 = 0;
		LOC11 = tofilename_164274(fileidx);
	...
	case ((NU8) 0):
	{
		NimStringDesc* LOC18;
		LOC18 = 0;
		LOC18 = tofilename_164274(fileidx);
		...
		gmemcachedata_523075->data[fileidx].needsrecompile = ((NU8) 3);
		{
			...
			L_523630 = (HEX3Atmp_523625 ? HEX3Atmp_523625->Sup.len : 0);
			{
				while (1) {
					...
					d = checkdepmem_523405(dep_523611);
					{
	...
	{
		{
			NU8 LOC25;
			LOC25 = 0;
			LOC25 = checkdepmem_523405(fileidx);
...
N_NIMCALL(void, wantmainmodule_523922)(void) {
	NimStringDesc* LOC5;
	{
		...
		fatal_165139(gcmdlineinfo_163926, ((NU16) 186), ((NimStringDesc*) &TMP4263));
	}
	LA3: ;
	LOC5 = 0;
	LOC5 = nosaddFileExt(gprojectfull_154236, ((NimStringDesc*) &TMP4264));
	gprojectmainidx_154237 = fileinfoidx_163858(LOC5);
}
...
N_NIMCALL(void, compilesystemmodule_523901)(void) {
	{
		...
		LOC5 = 0;
		LOC5 = HEX2F_119492(libpath_154233, ((NimStringDesc*) &TMP4265));
		systemfileidx_163435 = fileinfoidx_163858(LOC5);
		LOC6 = 0;
...
N_NIMCALL(void, compileproject_523985)(NI32 projectfileidx) {
	...
	LOC1 = 0;
	LOC1 = HEX2F_119492(libpath_154233, ((NimStringDesc*) &TMP4265));
	systemfileidx = fileinfoidx_163858(LOC1);
	{
...
N_NIMCALL(Tsym191843*, makestdinmodule_524003)(void) {
	...
	result = 0;
	{
		...
		LOC5 = 0;
		LOC5 = fileinfoidx_163858(((NimStringDesc*) &TMP4976));
...
N_NIMCALL(void, resetallmodules_523356)(void) {
	{
		...
		i_523368 = 0;
		HEX3Atmp_523383 = 0;
		HEX3Atmp_523383 = (gcompiledmodules_523055 ? (gcompiledmodules_523055->Sup.len-1) : -1);
		res_523386 = ((NI) 0);
		{
			while (1) {
				if (!(res_523386 <= HEX3Atmp_523383)) goto LA3;
				i_523368 = res_523386;
				{
...
TMP1078[0] = &TMP1076[1];
TMP1076[1].kind = 1;
TMP1076[1].offset = offsetof(Tmoduleinmemory523017, compiledat);
TMP1076[1].typ = (&NTI128);
TMP1076[1].name = "compiledAt";
TMP1078[1] = &TMP1076[2];
TMP1076[2].kind = 1;
TMP1076[2].offset = offsetof(Tmoduleinmemory523017, crc);
TMP1076[2].typ = (&NTI169015);
TMP1076[2].name = "crc";
TMP1078[2] = &TMP1076[3];
TMP1076[3].kind = 1;
TMP1076[3].offset = offsetof(Tmoduleinmemory523017, deps);
TMP1076[3].typ = (&NTI191933);
TMP1076[3].name = "deps";
TMP1078[3] = &TMP1076[4];
...
NTI523013.node = &TMP1076[10];
TMP1076[4].kind = 1;
TMP1076[4].offset = offsetof(Tmoduleinmemory523017, needsrecompile);
TMP1076[4].typ = (&NTI523013);
...
NTI523015.node = &TMP1076[16];
TMP1076[11].kind = 1;
TMP1076[11].offset = offsetof(Tmoduleinmemory523017, crcstatus);
TMP1076[11].typ = (&NTI523015);
TMP1076[11].name = "crcStatus";
TMP1076[0].len = 5; TMP1076[0].kind = 2; TMP1076[0].sons = &TMP1078[0];
NTI523017.node = &TMP1076[0];
NTI523056.size = sizeof(TY523056*);
NTI523056.kind = 24;
NTI523056.base = (&NTI523017);
NTI523056.flags = 2;
NTI523056.marker = TMP1085;
}
