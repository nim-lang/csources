...
N_NIMCALL(NU8, checkdepmem_529405)(NI32 fileidx);
...
STRING_LITERAL(TMP1445, "compiler/modules.nim", 20);
NIM_CONST TY85745 TMP1444 = {((NimStringDesc*) &TMP1445),
((NI) 41)}
;
STRING_LITERAL(TMP4216, "", 0);
STRING_LITERAL(TMP4217, "nim", 3);
STRING_LITERAL(TMP4218, "system.nim", 10);
STRING_LITERAL(TMP4933, "stdin", 5);
...
N_NIMCALL(void, docrc_529134)(NI32 fileidx) {
	{
		...
		LOC5 = 0;
		LOC5 = tofilename_181436(fileidx);
...
N_NIMCALL(tsym207843*, newmodule_529646)(NI32 fileidx) {
	...
	(*result).Sup.Id = ((NI) -1);
	(*result).Kind = ((NU8) 6);
	filename = tofullpath_181446(fileidx);
	...
	asgnRefNoCycle((void**) (&(*result).Name), getident_184463(LOC1.Field1));
	{
		...
		NIM_BOOL LOC6;
		LOC4 = 0;
		LOC4 = !(eqStrings((*(*result).Name).S, ((NimStringDesc*) &TMP1362)));
		if (!(LOC4)) goto LA5;
		LOC6 = 0;
	...
	LA7: ;
	(*result).Info = newlineinfo_180870(fileidx, ((NI) 1), ((NI) 1));
	LOC9 = 0;
	LOC9 = getpackagename_169825(filename);
	LOC10 = 0;
	LOC10 = getident_184463(LOC9);
	asgnRefNoCycle((void**) (&(*result).Owner), newsym_208656(((NU8) 24), LOC10, NIM_NIL, (*result).Info));
...
N_NIMCALL(NIM_BOOL, crcchanged_529105)(NI32 fileidx) {
	...
	case ((NU8) 1):
	{
		...
		NimStringDesc* LOC11;
		LOC11 = 0;
		LOC11 = tofilename_181436(fileidx);
	...
	case ((NU8) 0):
	{
		NimStringDesc* LOC18;
		LOC18 = 0;
		LOC18 = tofilename_181436(fileidx);
		...
		gmemcachedata_529075->data[fileidx].Needsrecompile = ((NU8) 3);
		{
			...
			l_529630 = HEX3Atmp_529625->Sup.len;
			{
				while (1) {
					...
					d = checkdepmem_529405(dep_529611);
					{
	...
	{
		{
			NU8 LOC25;
			LOC25 = 0;
			LOC25 = checkdepmem_529405(fileidx);
...
N_NIMCALL(void, wantmainmodule_529922)(void) {
	NimStringDesc* LOC5;
	{
		...
		fatal_182360(gcmdlineinfo_180925, ((NU16) 186), ((NimStringDesc*) &TMP4216));
	}
	LA3: ;
	LOC5 = 0;
	LOC5 = nosaddFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP4217));
	gprojectmainidx_169237 = fileinfoidx_180857(LOC5);
}
...
N_NIMCALL(void, compilesystemmodule_529901)(void) {
	{
		...
		LOC5 = 0;
		LOC5 = HEX2F_117492(libpath_169233, ((NimStringDesc*) &TMP4218));
		systemfileidx_180435 = fileinfoidx_180857(LOC5);
		LOC6 = 0;
...
N_NIMCALL(void, compileproject_529985)(NI32 projectfileidx) {
	...
	LOC1 = 0;
	LOC1 = HEX2F_117492(libpath_169233, ((NimStringDesc*) &TMP4218));
	systemfileidx = fileinfoidx_180857(LOC1);
	{
...
N_NIMCALL(tsym207843*, makestdinmodule_530003)(void) {
	...
	result = 0;
	{
		...
		LOC5 = 0;
		LOC5 = fileinfoidx_180857(((NimStringDesc*) &TMP4933));
...
N_NIMCALL(void, resetallmodules_529356)(void) {
	{
		...
		i_529368 = 0;
		HEX3Atmp_529383 = 0;
		HEX3Atmp_529383 = (gcompiledmodules_529055->Sup.len-1);
		res_529386 = ((NI) 0);
		{
			while (1) {
				if (!(res_529386 <= HEX3Atmp_529383)) goto LA3;
				i_529368 = res_529386;
				{
