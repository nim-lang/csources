...
N_NIMCALL(void, handleshortoption_527106)(toptparser526807* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_527002((*p).Cmd, i, &(*p).Val, TMP7626);
	}
	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser526807* p) {
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_527002((*p).Cmd, i, &(*p).Key, TMP7627);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_527002((*p).Cmd, i, &(*p).Val, TMP7626);
			}
			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_527002((*p).Cmd, i, &(*p).Key, TMP7626);
	}
	break;
	}
	BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser526807* p) {
	...
	LOC1 = 0;
	LOC1 = copyStrLast((*p).Cmd, (*p).Pos, (NI32)(TMP7628));
...
TMP7630[0] = &TMP7619[1];
TMP7619[1].kind = 1;
TMP7619[1].offset = offsetof(toptparser526807, Cmd);
TMP7619[1].typ = (&NTI143);
TMP7619[1].name = "cmd";
TMP7630[1] = &TMP7619[2];
TMP7619[2].kind = 1;
TMP7619[2].offset = offsetof(toptparser526807, Pos);
TMP7619[2].typ = (&NTI106);
TMP7619[2].name = "pos";
TMP7630[2] = &TMP7619[3];
TMP7619[3].kind = 1;
TMP7619[3].offset = offsetof(toptparser526807, Inshortstate);
...
NTI526805.node = &TMP7619[9];
TMP7619[4].kind = 1;
TMP7619[4].offset = offsetof(toptparser526807, Kind);
TMP7619[4].typ = (&NTI526805);
TMP7619[4].name = "kind";
TMP7630[4] = &TMP7619[10];
TMP7619[10].kind = 1;
TMP7619[10].offset = offsetof(toptparser526807, Key);
TMP7619[10].typ = (&NTI143);
TMP7619[10].name = "key";
TMP7630[5] = &TMP7619[11];
TMP7619[11].kind = 1;
TMP7619[11].offset = offsetof(toptparser526807, Val);
TMP7619[11].typ = (&NTI143);
TMP7619[11].name = "val";
TMP7619[0].len = 6; TMP7619[0].kind = 2; TMP7619[0].sons = &TMP7630[0];
NTI526807.node = &TMP7619[0];
}
