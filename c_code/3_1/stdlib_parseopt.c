...
N_NIMCALL(void, initoptparser_207030)(NimStringDesc* cmdline, optparser207011* Result) {
	...
	LA3: ;
	{
		unsureAsgnRef((void**) &(*Result).Cmd, copyString(((NimStringDesc*) &TMP1552)));
		{
			NI i_207046;
			NI HEX3Atmp_207049;
			NI res_207052;
			i_207046 = 0;
			HEX3Atmp_207049 = 0;
			HEX3Atmp_207049 = paramcount_123439();
			res_207052 = 1;
			{
				while (1) {
					NimStringDesc* LOC9;
					...
					LOC9 = 0;
					LOC10 = 0;
					LOC10 = paramstr_123409(i_207046);
					LOC11 = 0;
...
appendChar(LOC9, 32);
	...
	LA1: ;
	(*Result).Kind = ((NU8) 0);
	unsureAsgnRef((void**) &(*Result).Key, copyString(((NimStringDesc*) &TMP1556)));
	unsureAsgnRef((void**) &(*Result).Val, copyString(((NimStringDesc*) &TMP1556)));
}
...
N_NIMCALL(void, handleshortoption_207309)(optparser207011* p) {
	...
	}
	{
		...
		i = parseword_207204((*p).Cmd, i, &(*p).Val, TMP1557);
	}
	LA5: ;
	{
...
N_NIMCALL(void, nponext)(optparser207011* p) {
	...
	case 45:
	{
		i += 1;
		{
			...
			(*p).Kind = ((NU8) 2);
			i += 1;
			i = parseword_207204((*p).Cmd, i, &(*p).Key, TMP1558);
			{
				while (1) {
			...
			}
			{
				...
				(*p).Pos = parseword_207204((*p).Cmd, i, &(*p).Val, TMP1557);
			}
			goto LA15;
			LA17: ;
			{
	...
	{
		(*p).Kind = ((NU8) 1);
		(*p).Pos = parseword_207204((*p).Cmd, i, &(*p).Key, TMP1557);
	}
	break;
	}
	BeforeRet: ;
...
static TNimNode* TMP1548[6];
static TNimNode* TMP1549[4];
NI TMP1551;
static char* NIM_CONST TMP1550[4] = {
"cmdEnd", 
"cmdArgument", 
"cmdLongOption", 
"cmdShortOption"};
...
NTI207009.base = 0;
NTI207009.flags = 3;
for (TMP1551 = 0; TMP1551 < 4; TMP1551++) {
TMP702[TMP1551+5].kind = 1;
TMP702[TMP1551+5].offset = TMP1551;
TMP702[TMP1551+5].name = TMP1550[TMP1551];
TMP1549[TMP1551] = &TMP702[TMP1551+5];
}
TMP702[9].len = 4; TMP702[9].kind = 2; TMP702[9].sons = &TMP1549[0];
...
TMP702[11].name = "val";
TMP702[0].len = 6; TMP702[0].kind = 2; TMP702[0].sons = &TMP1548[0];
