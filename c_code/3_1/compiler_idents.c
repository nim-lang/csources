...
N_NIMCALL(NI, cmpignorestyle_140034)(NCSTRING a, NCSTRING b, NI blen);
...
N_NIMCALL(NI, cmpexact_140152)(NCSTRING a, NCSTRING b, NI blen);
...
STRING_LITERAL(TMP883, "id == 0 or id == result.id ", 27);
STRING_LITERAL(TMP887, ":anonymous", 10);
STRING_LITERAL(TMP888, ":delegator", 10);
NIM_BOOL firstchariscs_140023;
TY140026 buckets_140031;
extern TFrame* frameptr_12037;
NI wordcounter_140200;
extern tgcheap40816 gch_40844;
extern TNimType NTI1009; /* TObject */
TNimType NTI140011; /* TIdObj */
extern TNimType NTI105; /* int */
TNimType NTI140017; /* TIdent */
extern TNimType NTI142; /* string */
extern TNimType NTI110011; /* THash */
TNimType NTI140015; /* PIdent */
tident140017* idanon_140463;
tident140017* iddelegator_140465;
TNimType NTI140013; /* PIdObj */
...
N_NIMCALL(NI, cmpignorestyle_140034)(NCSTRING a, NCSTRING b, NI blen) {
	...
	nimln(32, "idents.nim");
	{
		if (!firstchariscs_140023) goto LA3;
		nimln(33, "idents.nim");
		{
	...
	while (1) {
		...
		nimln(43, "idents.nim");
		{
			...
			nimln(43, "idents.nim");
			nimln(43, "idents.nim");
			TMP879 = addInt(((NI) (((NU8)(aa)))), 32);
			aa = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP879), 0, 255))));
		}		LA16: ;
		nimln(44, "idents.nim");
		{
			NIM_BOOL LOC20;
			...
			nimln(44, "idents.nim");
			nimln(44, "idents.nim");
			TMP880 = addInt(((NI) (((NU8)(bb)))), 32);
			bb = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP880), 0, 255))));
		}		LA22: ;
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
		TMP881 = subInt(((NI) (((NU8)(aa)))), ((NI) (((NU8)(bb)))));
		result = (NI32)(TMP881);
		nimln(46, "idents.nim");
		{
			NIM_BOOL LOC26;
...
N_NIMCALL(NI, cmpexact_140152)(NCSTRING a, NCSTRING b, NI blen) {
	...
	while (1) {
		...
		nimln(59, "idents.nim");
		nimln(59, "idents.nim");
		TMP882 = subInt(((NI) (((NU8)(aa)))), ((NI) (((NU8)(bb)))));
		result = (NI32)(TMP882);
		nimln(60, "idents.nim");
		{
			NIM_BOOL LOC4;
...
N_NIMCALL(tident140017*, getident_140202)(NCSTRING identifier, NI length, NI h) {
	...
	while (1) {
		...
		LA5: ;
		{
			...
			nimln(82, "idents.nim");
			{
				...
				if (!!(LOC17)) goto LA19;
				nimln(82, "idents.nim");
				hiddenraiseassert_76017(((NimStringDesc*) &TMP883));			}			LA19: ;
			nimln(83, "idents.nim");
			id = (*result).Sup.Id;
		}		goto LA2;
		LA13: ;
	...
	nimln(89, "idents.nim");
	nimln(89, "idents.nim");
	TMP886 = subInt(length, 1);
	HEX3Atmp_140435 = (NI32)(TMP886);
	...
	nimln(92, "idents.nim");
	{
		...
		nimln(94, "idents.nim");
		nimln(94, "idents.nim");
		if (wordcounter_140200 == (-2147483647 -1)) raiseOverflow();
		(*result).Sup.Id = ((NI32)-(wordcounter_140200));
	}	goto LA22;
	LA24: ;
	{
		nimln(96, "idents.nim");
...
N_NIMCALL(tident140017*, getident_140443)(NimStringDesc* identifier) {
	...
	result = getident_140202(identifier->data, identifier->Sup.len, LOC1);
	popFrame();
	return result;
}
N_NIMCALL(tident140017*, getident_140449)(NimStringDesc* identifier, NI h) {
	...
	nimln(103, "idents.nim");
	result = getident_140202(identifier->data, identifier->Sup.len, h);
	popFrame();
	return result;
}
N_NIMCALL(NIM_BOOL, identeq_140456)(tident140017* id, NimStringDesc* name) {
...
N_NOINLINE(void, compileridentsInit)(void) {
	...
	nimln(66, "idents.nim");
	wordcounter_140200 = 1;
	nimln(108, "idents.nim");
	asgnRefNoCycle((void**) &idanon_140463, getident_140443(((NimStringDesc*) &TMP887)));
	nimln(109, "idents.nim");
	asgnRefNoCycle((void**) &iddelegator_140465, getident_140443(((NimStringDesc*) &TMP888)));
	popFrame();
}

N_NOINLINE(void, compileridentsDatInit)(void) {
static TNimNode* TMP884[3];
static TNimNode TMP877[5];
NTI140011.size = sizeof(tidobj140011);
NTI140011.kind = 17;
NTI140011.base = (&NTI1009);
NTI140011.flags = 3;
TMP877[0].kind = 1;
TMP877[0].offset = offsetof(tidobj140011, Id);
TMP877[0].typ = (&NTI105);
TMP877[0].name = "id";
NTI140011.node = &TMP877[0];
NTI140017.size = sizeof(tident140017);
NTI140017.kind = 17;
NTI140017.base = (&NTI140011);
NTI140017.flags = 2;
TMP884[0] = &TMP877[2];
TMP877[2].kind = 1;
TMP877[2].offset = offsetof(tident140017, S);
TMP877[2].typ = (&NTI142);
TMP877[2].name = "s";
TMP884[1] = &TMP877[3];
TMP877[3].kind = 1;
TMP877[3].offset = offsetof(tident140017, Next);
TMP877[3].typ = (&NTI140015);
TMP877[3].name = "next";
TMP884[2] = &TMP877[4];
TMP877[4].kind = 1;
TMP877[4].offset = offsetof(tident140017, H);
TMP877[4].typ = (&NTI110011);
TMP877[4].name = "h";
TMP877[1].len = 3; TMP877[1].kind = 2; TMP877[1].sons = &TMP884[0];
NTI140017.node = &TMP877[1];
NTI140015.size = sizeof(tident140017*);
NTI140015.kind = 22;
NTI140015.base = (&NTI140017);
NTI140015.flags = 2;
NTI140015.marker = TMP885;
NTI140013.size = sizeof(tidobj140011*);
NTI140013.kind = 22;
NTI140013.base = (&NTI140011);
NTI140013.flags = 2;
NTI140013.marker = TMP2012;
}
