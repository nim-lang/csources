...
N_NIMCALL(void, processimplicits_264633)(TY121008* implicits, NU8 nodekind, tpasscontext264005** a);
...
N_NIMCALL(void, openpasses_264316)(tpasscontext264005** a, tsym209848* module) {
	{
		...
		i_264333 = 0;
		HEX3Atmp_264342 = 0;
		HEX3Atmp_264342 = (NI32)(gpasseslen_264190 - 1);
		res_264345 = 0;
		{
			while (1) {
...
{	result = 0;
	m = n;
	{
		...
		i_264492 = 0;
		HEX3Atmp_264512 = 0;
		HEX3Atmp_264512 = (NI32)(gpasseslen_264190 - 1);
		res_264515 = 0;
		{
			while (1) {
...
N_NIMCALL(void, processimplicits_264633)(TY121008* implicits, NU8 nodekind, tpasscontext264005** a) {
	{
		...
		l_264661 = implicits->Sup.len;
		{
			while (1) {
				...
				importstmt = newnodei_210140(nodekind, gcmdlineinfo_182007);
				str = newstrnode_210120(((NU8) 20), module_264652);
				(*str).Info = gcmdlineinfo_182007;
...
N_NIMCALL(void, closepasses_264426)(tpasscontext264005** a) {
	...
	m = NIM_NIL;
	{
		...
		i_264443 = 0;
		HEX3Atmp_264453 = 0;
		HEX3Atmp_264453 = (NI32)(gpasseslen_264190 - 1);
		res_264456 = 0;
		{
			while (1) {
...
N_NIMCALL(void, openpassescached_264362)(tpasscontext264005** a, tsym209848* module, trodreader255030* rd) {
	{
		...
		i_264380 = 0;
		HEX3Atmp_264406 = 0;
		HEX3Atmp_264406 = (NI32)(gpasseslen_264190 - 1);
		res_264409 = 0;
		{
			while (1) {
...
N_NIMCALL(void, processtoplevelstmtcached_264532)(tnode209818* n, tpasscontext264005** a) {
	...
	m = n;
	{
		...
		i_264550 = 0;
		HEX3Atmp_264559 = 0;
		HEX3Atmp_264559 = (NI32)(gpasseslen_264190 - 1);
		res_264562 = 0;
		{
			while (1) {
...
N_NIMCALL(void, closepassescached_264579)(tpasscontext264005** a) {
	...
	m = NIM_NIL;
	{
		...
		i_264596 = 0;
		HEX3Atmp_264613 = 0;
		HEX3Atmp_264613 = (NI32)(gpasseslen_264190 - 1);
		res_264616 = 0;
		{
			while (1) {
...
{	memset((void*)(&p), 0, sizeof(p));
	...
	LA3: ;
	{
		...
		n = loadinitsection_255077(rd);
		{
			...
			HEX3Atmp_264808 = (NI32)(LOC37 - 1);
			res_264811 = 0;
			{
				while (1) {
					if (!(res_264811 <= HEX3Atmp_264808)) goto LA39;
					i_264797 = res_264811;
