...
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_6, "Failed to create the directory", 30);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_7, "invalid index", 13);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_8, "HOME", 4);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_9, "/", 1);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_10, "\012  0 <= bufsize ", 16);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_11, "PATH", 4);
...
N_NIMCALL(NIM_BOOL, existsorcreatedir_V86QyZrcGMPX0W9bv1Q53ww)(NimStringDesc* dir0) {
	...
	result0 = !(LOC1);
	{
		if (!result0) goto LA4;
		{
			...
			LOC11 = (*e_4he5nelRQAcl1XtPfaowrQ).Sup.Sup.message; (*e_4he5nelRQAcl1XtPfaowrQ).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_6));
		...
		i0 = ((NI) 0);
		{
			while (1) {
				...
				NimStringDesc* LOC14;
				{
					NIM_BOOL LOC10;
					LOC10 = (NIM_BOOL)0;
					LOC10 = HEX3DHEX3D_9ccNWqrTIE9bcAqE2Q0ro7zgos(genv0[(i0)- 0], NIM_NIL);
					if (!LOC10) goto LA11;
					goto LA6;
				}
				LA11: ;
				...
				LOC14 = environment_mlhK49b6YMgc9cgrcYkKq9a3g->data[environment_mlhK49b6YMgc9cgrcYkKq9a3g->Sup.len]; environment_mlhK49b6YMgc9cgrcYkKq9a3g->data[environment_mlhK49b6YMgc9cgrcYkKq9a3g->Sup.len] = copyStringRC1(LOC13);
...
{	result0 = (NimStringDesc*)0;
	...
	LOC2 = getenv_8zNgT9bxx7m9cTt2TeVdTdIw(((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_8));
			...
			LA7: ;
			{
				...
				err0 = oslasterror_pMOMIZAQaKFp1XoL58mjVg();
				{
					...
					bufsize0 = (NI)((NU32)(bufsize0) << (NU32)(((NI) 1)));
					{
						...
						raiseassert_PpfSiTIeNpMAb9a5o6SglJw_2(((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_10));
					}
					LA17: ;
					result0 = mnewString(((NI) (bufsize0)));
				}
...
{	result0 = (NimStringDesc*)0;
	...
	path0 = getenv_8zNgT9bxx7m9cTt2TeVdTdIw(((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_11));
	{
