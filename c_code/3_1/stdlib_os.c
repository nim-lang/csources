...
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_3, "Failed to create the directory", 30);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_4, "invalid index", 13);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_5, "\012  0 <= bufsize ", 16);
...
N_NIMCALL(NIM_BOOL, existsOrCreateDir_V86QyZrcGMPX0W9bv1Q53ww)(NimStringDesc* dir) {
	...
	result = !(T1_);
	{
		if (!result) goto LA4_;
		{
			...
			T11_ = (*e).Sup.Sup.message; (*e).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_3));
			...
			LA7_: ;
			{
				...
				err = osLastError_tNPXXFl9cb3BG0pJKzUn9bew();
				{
					...
					bufsize = (NI)((NU32)(bufsize) << (NU32)(((NI) 1)));
					{
						...
						raiseAssert_PpfSiTIeNpMAb9a5o6SglJw_2(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_5));
					}
					LA17_: ;
					result = mnewString(((NI) (bufsize)));
				}
