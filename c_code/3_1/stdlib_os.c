...
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_10, "\012  0 <= bufsize ", 16);
		...
		i = ((NI) 0);
		{
			while (1) {
				...
				NimStringDesc* T14_;
				{
					NIM_BOOL T10_;
					T10_ = (NIM_BOOL)0;
					T10_ = eqeq__9ccNWqrTIE9bcAqE2Q0ro7zgos(gEnv[(i)- 0], NIM_NIL);
					if (!T10_) goto LA11_;
					goto LA6;
				}
				LA11_: ;
			...
			LA7_: ;
			{
				...
				err = osLastError_YyC2FKP9bqQiUDq2XVqW9acA();
				{
					...
					bufsize = (NI)((NU32)(bufsize) << (NU32)(((NI) 1)));
					{
						...
						raiseAssert_PpfSiTIeNpMAb9a5o6SglJw_2(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_10));
					}
					LA17_: ;
					result = mnewString(((NI) (bufsize)));
				}
