...
N_NIMCALL(void, nossplitPath)(NimStringDesc* path, keyvaluepair131008* Result) {
	...
	seppos = -1;
	{
		...
		i_117131 = 0;
		HEX3Atmp_117147 = 0;
		HEX3Atmp_117147 = (NI32)(path->Sup.len - 1);
...
N_NIMCALL(NI, searchextpos_117351)(NimStringDesc* s) {
	...
	result = -1;
	{
		...
		i_117366 = 0;
		HEX3Atmp_117382 = 0;
		HEX3Atmp_117382 = (NI32)(s->Sup.len - 1);
...
N_NIMCALL(void, nossplitFile)(NimStringDesc* path, TY117404* Result) {
	...
	LA5: ;
	{
		...
		dotpos = path->Sup.len;
		{
			...
			i_117437 = 0;
			HEX3Atmp_117468 = 0;
			HEX3Atmp_117468 = (NI32)(path->Sup.len - 1);
				...
				while (1) {
					...
					i_117437 = res_117471;
					{
						if (!((NU8)(path->data[i_117437]) == (NU8)(46))) goto LA13;
						{
							...
							LOC17 = LOC18;
							if (!(LOC17)) goto LA20;
							LOC17 = !((((NU8)(path->data[(NI32)(i_117437 - 1)])) == ((NU8)(47)) || ((NU8)(path->data[(NI32)(i_117437 - 1)])) == ((NU8)(47))));
							LA20: ;
							if (!LOC17) goto LA21;
							dotpos = i_117437;
						}
...
N_NIMCALL(NI, parentdirpos_117166)(NimStringDesc* path) {
	...
	LA3: ;
	{
		...
		i_117196 = 0;
		HEX3Atmp_117212 = 0;
		HEX3Atmp_117212 = (NI32)(path->Sup.len - q);
...
N_NIMCALL(void, noscreateDir)(NimStringDesc* dir) {
	...
	omitnext = NIM_FALSE;
	{
		...
		i_121811 = 0;
		HEX3Atmp_121827 = 0;
		HEX3Atmp_121827 = (NI32)(dir->Sup.len - 1);
		res_121830 = 1;
		{
			while (1) {
				...
				i_121811 = res_121830;
				{
					...
					LA10: ;
					{
						NimStringDesc* LOC13;
						LOC13 = 0;
						LOC13 = copyStrLast(dir, 0, (NI32)(i_121811 - 1));
...
N_NIMCALL(NimStringDesc*, getenv_120242)(NimStringDesc* key) {
	...
	i = findenvvar_120205(key);
	{
		...
		result = copyStr(environment_119609->data[i], (NI32)(LOC5 + 1));
		goto BeforeRet;
	}
	goto LA1;
	LA3: ;
