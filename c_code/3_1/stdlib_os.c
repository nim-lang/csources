...
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_3, "/Users/andreasrumpf-mac/projects/nim/lib/pure/os.nim(282, 19) `"
"\0120 <= bufsize` ", 78);
...
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_9, "..", 2);
			...
			LA7_: ;
			{
				...
				err = osLastError_tNPXXFl9cb3BG0pJKzUn9bew();
				{
					...
					bufsize = (NI)((NU32)(bufsize) << (NU32)(((NI) 1)));
					{
						...
						failedAssertImpl_aDmpBTs9cPuXp0Mp9cfiNeyA(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_3));
					}
					LA17_: ;
					result = mnewString(((NI) (bufsize)));
				}
...
N_LIB_PRIVATE N_NIMCALL(void, nosremoveDir)(NimStringDesc* dir) {
	{
		...
		{
			TSafePoint TM_yu6cxgKBBXbNsTkT9cyMd4g_7;
			if (!!((d == NIM_NIL))) goto LA4_;
			pushSafePoint(&TM_yu6cxgKBBXbNsTkT9cyMd4g_7);
			TM_yu6cxgKBBXbNsTkT9cyMd4g_7.status = _setjmp(TM_yu6cxgKBBXbNsTkT9cyMd4g_7.context);
			if (TM_yu6cxgKBBXbNsTkT9cyMd4g_7.status == 0) {
				{
					while (1) {
						{
							struct dirent* x;
							...
							y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
							{
								...
								T16_ = (NIM_BOOL)0;
								T16_ = !(eqStrings(y, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_8)));
								if (!(T16_)) goto LA17_;
			...
			if (TM_yu6cxgKBBXbNsTkT9cyMd4g_7.status != 0) reraiseException();
		}
		LA4_: ;
	}
...
N_LIB_PRIVATE N_NIMCALL(void, nosmoveFile)(NimStringDesc* source, NimStringDesc* dest) {
	{
		NIM_BOOL T3_;
		TSafePoint TM_yu6cxgKBBXbNsTkT9cyMd4g_10;
		T3_ = (NIM_BOOL)0;
		T3_ = tryMoveFSObject_kAUHL0UShtIjkMl3w2BG3A(source, dest);
		if (!!(T3_)) goto LA4_;
		noscopyFile(source, dest);
		pushSafePoint(&TM_yu6cxgKBBXbNsTkT9cyMd4g_10);
		TM_yu6cxgKBBXbNsTkT9cyMd4g_10.status = _setjmp(TM_yu6cxgKBBXbNsTkT9cyMd4g_10.context);
		if (TM_yu6cxgKBBXbNsTkT9cyMd4g_10.status == 0) {
			...
			{
				NIM_BOOL T9_;
				TM_yu6cxgKBBXbNsTkT9cyMd4g_10.status = 0;
				T9_ = (NIM_BOOL)0;
		...
		if (TM_yu6cxgKBBXbNsTkT9cyMd4g_10.status != 0) reraiseException();
	}
	LA4_: ;
}
