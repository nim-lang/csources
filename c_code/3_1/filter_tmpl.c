...
#include <stdio.h>
typedef struct ttmplparser223017 ttmplparser223017;
...
N_NIMCALL(void, newline_223040)(ttmplparser223017* p);
...
static N_INLINE(NIM_BOOL, withinexpr_223168)(ttmplparser223017* p);
...
NIM_CONST TY123387 patternchars_223037 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0xFF, 0x03,
0xFE, 0xFF, 0xFF, 0x87, 0xFE, 0xFF, 0xFF, 0x07,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP2661, "\012", 1);
STRING_LITERAL(TMP2662, "", 0);
STRING_LITERAL(TMP2663, "end", 3);
STRING_LITERAL(TMP2664, "#end", 4);
static NIM_CONST TY123387 TMP2666 = {
...
STRING_LITERAL(TMP2670, "\\x", 2);
STRING_LITERAL(TMP2671, "\\\\", 2);
STRING_LITERAL(TMP2672, "\\\'", 2);
STRING_LITERAL(TMP2673, "\\\"", 2);
STRING_LITERAL(TMP2674, "}", 1);
STRING_LITERAL(TMP2675, "$", 1);
STRING_LITERAL(TMP2676, "\\n\"", 3);
STRING_LITERAL(TMP2677, "subschar", 8);
STRING_LITERAL(TMP2678, "metachar", 8);
STRING_LITERAL(TMP2679, "emit", 4);
STRING_LITERAL(TMP2680, "result.add", 10);
STRING_LITERAL(TMP2681, "conc", 4);
STRING_LITERAL(TMP2682, " & ", 3);
STRING_LITERAL(TMP2683, "tostring", 8);
...
N_NIMCALL(void, newline_223040)(ttmplparser223017* p) {
	...
	llstreamwrite_179258((*p).Outp, LOC1);
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		nimln(42, "filter_tmpl.nim");
		llstreamwrite_179258((*p).Outp, ((NimStringDesc*) &TMP2661));
	}
	LA4: ;
	nimln(43, "filter_tmpl.nim");
	{
		...
		llstreamwrite_179258((*p).Outp, LOC10);
...
N_NIMCALL(void, parseline_223177)(ttmplparser223017* p) {
	...
	LA6: ;
	{
		...
		keyw = copyString(((NimStringDesc*) &TMP2662));
		...
		case ((NU8) 20):
		{
			...
			LA19: ;
			{
				...
				localerror_168571((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP2663));
			}
			LA17: ;
			...
			llstreamwrite_179258((*p).Outp, ((NimStringDesc*) &TMP2664));
		}
		break;
		case ((NU8) 28):
		case ((NU8) 63):
		...
		case ((NU8) 24):
		{
			...
			nimln(99, "filter_tmpl.nim");
			nimln(99, "filter_tmpl.nim");
			TMP2665 = subInt((*p).Indent, 2);
			LOC27 = 0;
			LOC27 = nsuRepeatChar((NI32)(TMP2665), 32);
		...
		case ((NU8) 60):
		{
			...
			nimln(104, "filter_tmpl.nim");
			{
				...
				nimln(104, "filter_tmpl.nim");
				LOC34 = 0;
				LOC34 = contains_91258((*p).X, TMP2666);
				if (!!(LOC34)) goto LA35;
	...
	LA9: ;
	{
		...
		case ((NU8) 1):
		{
			...
			nimln(123, "filter_tmpl.nim");
			nimln(123, "filter_tmpl.nim");
			TMP2667 = addInt((*p).Indent, 2);
			LOC42 = 0;
			LOC42 = nsuRepeatChar((NI32)(TMP2667), 32);
		...
		case ((NU8) 0):
		{
			...
			llstreamwrite_179258((*p).Outp, ((NimStringDesc*) &TMP2669));
		...
		while (1) {
			...
			case 128 ... 255:
			{
				...
				llstreamwrite_179258((*p).Outp, ((NimStringDesc*) &TMP2670));
			...
			case 39:
			{
				...
				llstreamwrite_179258((*p).Outp, ((NimStringDesc*) &TMP2672));
			...
			case 34:
			{
				...
				llstreamwrite_179258((*p).Outp, ((NimStringDesc*) &TMP2673));
				...
				nimln(150, "filter_tmpl.nim");
				{
					...
					case 123:
					{
						...
						while (1) {
							...
							case 0:
							{
								...
								localerror_168571((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP2674));
					...
					default:
					{
						...
						LA76: ;
						{
							...
							localerror_168571((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP2675));
						}
						LA74: ;
					}
					break;
...
N_NIMCALL(tllstream179204*, filtertmpl_223007)(tllstream179204* stdin_223009, NimStringDesc* filename, tnode191813* call) {
	...
	p.Info = newlineinfo_167077(filename, 0, 0);
	nimln(208, "filter_tmpl.nim");
	p.Outp = llstreamopen_179218(((NimStringDesc*) &TMP2662));
	nimln(209, "filter_tmpl.nim");
	p.Inp = stdin_223009;
	nimln(210, "filter_tmpl.nim");
	p.Subschar = chararg_222014(call, ((NimStringDesc*) &TMP2677), 1, 36);
	nimln(211, "filter_tmpl.nim");
	p.Nimdirective = chararg_222014(call, ((NimStringDesc*) &TMP2678), 2, 35);
	nimln(212, "filter_tmpl.nim");
	p.Emit = strarg_222021(call, ((NimStringDesc*) &TMP2679), 3, ((NimStringDesc*) &TMP2680));
	nimln(213, "filter_tmpl.nim");
	p.Conc = strarg_222021(call, ((NimStringDesc*) &TMP2681), 4, ((NimStringDesc*) &TMP2682));
	nimln(214, "filter_tmpl.nim");
	p.Tostr = strarg_222021(call, ((NimStringDesc*) &TMP2683), 5, ((NimStringDesc*) &TMP2675));
	...
	while (1) {
		...
		nimln(217, "filter_tmpl.nim");
		TMP2684 = addInt(p.Info.Line, ((NI16) 1));
		if (TMP2684 < -32768 || TMP2684 > 32767) raiseOverflow();
		p.Info.Line = (NI16)(TMP2684);
