...
STRING_LITERAL(TMP2661, "end", 3);
STRING_LITERAL(TMP2662, "#end", 4);
static NIM_CONST TY122387 TMP2664 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x24,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2666, "\"", 1);
STRING_LITERAL(TMP2667, "(\"", 2);
STRING_LITERAL(TMP2668, "\\x", 2);
STRING_LITERAL(TMP2669, "\\\\", 2);
STRING_LITERAL(TMP2670, "\\\'", 2);
STRING_LITERAL(TMP2671, "\\\"", 2);
STRING_LITERAL(TMP2672, "}", 1);
STRING_LITERAL(TMP2673, "$", 1);
STRING_LITERAL(TMP2674, "\\n\"", 3);
STRING_LITERAL(TMP2675, "subschar", 8);
STRING_LITERAL(TMP2676, "metachar", 8);
STRING_LITERAL(TMP2677, "emit", 4);
STRING_LITERAL(TMP2678, "result.add", 10);
STRING_LITERAL(TMP2679, "conc", 4);
STRING_LITERAL(TMP2680, " & ", 3);
STRING_LITERAL(TMP2681, "tostring", 8);
...
N_NIMCALL(void, parseline_218177)(ttmplparser218017* p) {
	...
	LA6: ;
	{
		...
		case ((NU8) 24):
		{
			...
			LOC27 = 0;
			LOC27 = nsuRepeatChar((NI32)(TMP2663), 32);
	...
	LA9: ;
	{
		...
		case ((NU8) 1):
		{
			...
			LOC42 = 0;
			LOC42 = nsuRepeatChar((NI32)(TMP2665), 32);
...
N_NIMCALL(tllstream174204*, filtertmpl_218007)(tllstream174204* stdin_218009, NimStringDesc* filename, tnode186813* call) {
	...
	p.Outp = llstreamopen_174218(((NimStringDesc*) &TMP2660));
	nimln(209, "filter_tmpl.nim");
	p.Inp = stdin_218009;
	nimln(210, "filter_tmpl.nim");
	p.Subschar = chararg_217014(call, ((NimStringDesc*) &TMP2675), 1, 36);
	nimln(211, "filter_tmpl.nim");
	p.Nimdirective = chararg_217014(call, ((NimStringDesc*) &TMP2676), 2, 35);
	nimln(212, "filter_tmpl.nim");
	p.Emit = strarg_217021(call, ((NimStringDesc*) &TMP2677), 3, ((NimStringDesc*) &TMP2678));
	nimln(213, "filter_tmpl.nim");
	p.Conc = strarg_217021(call, ((NimStringDesc*) &TMP2679), 4, ((NimStringDesc*) &TMP2680));
	nimln(214, "filter_tmpl.nim");
	p.Tostr = strarg_217021(call, ((NimStringDesc*) &TMP2681), 5, ((NimStringDesc*) &TMP2673));
	...
	while (1) {
		...
		nimln(217, "filter_tmpl.nim");
		TMP2682 = addInt(p.Info.Line, ((NI16) 1));
		if (TMP2682 < -32768 || TMP2682 > 32767) raiseOverflow();
		p.Info.Line = (NI16)(TMP2682);
