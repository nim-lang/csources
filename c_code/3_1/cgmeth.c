					...
					while (1) {
						...
						j = i_419189;
						{
							while (1) {
								NI LOC14;
								LOC14 = 0;
								LOC14 = cmpsignatures_419111((*a)->data[(NI32)(j - h)], v, relevantcols);
		...
		res_419473 = 0;
		{
			while (1) {
				...
				cond = NIM_NIL;
				{
					...
					col_419286 = 0;
					HEX3Atmp_419458 = 0;
					HEX3Atmp_419458 = (NI32)(paramlen - 1);
					res_419461 = 1;
					{
						while (1) {
				...
				addson_225290(call, LOC24);
				{
					...
					col_419347 = 0;
					HEX3Atmp_419464 = 0;
					HEX3Atmp_419464 = (NI32)(paramlen - 1);
					res_419467 = 1;
					{
						while (1) {
							tnode224819* LOC28;
...
N_NIMCALL(tnode224819*, generatemethoddispatchers_419508)(void) {
	...
	result = newnode_225093(((NU8) 114));
	{
		...
		bucket_419534 = 0;
		HEX3Atmp_419558 = 0;
		HEX3Atmp_419558 = (NI32)(gmethods_418315->Sup.len - 1);
		res_419561 = 0;
		{
			while (1) {
