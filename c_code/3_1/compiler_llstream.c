...
N_NIMCALL(NI, counttriples_161462)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1602 = addInt(i, 1);
			if ((NU)((NI32)(TMP1602)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI32)(TMP1602)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1603 = addInt(i, 2);
			if ((NU)((NI32)(TMP1603)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI32)(TMP1603)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
appendString((*s).S, ((NimStringDesc*) &TMP1606));
	...
	result = ((buflen <= (NI32)(TMP1607)) ? buflen : (NI32)(TMP1607));
...
N_NIMCALL(NI, llstreamread_161242)(tllstream161204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		result = ((buflen <= (NI32)(TMP1608)) ? buflen : (NI32)(TMP1608));
		nimln(136, "llstream.nim");
		{
			...
			if ((NU)((NI32)(TMP1609)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI32)(TMP1609)])), result);			nimln(138, "llstream.nim");
			(*s).Rd = addInt((*s).Rd, result);
		}		LA5: ;
	}	break;
	case ((NU8) 2):
...
N_NIMCALL(void, llstreamwrite_161268)(tllstream161204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			(*s).S = setLengthStr((*s).S, (NI32)(TMP1610));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1611 = addInt(0, (*s).Wr);
			if ((NU)((NI32)(TMP1611)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI32)(TMP1611)])), buf, buflen);			nimln(202, "llstream.nim");
...
N_NIMCALL(NimStringDesc*, llstreamreadall_161254)(tllstream161204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI32)(TMP1612));
			nimln(223, "llstream.nim");
			nimln(223, "llstream.nim");
			TMP1613 = addInt(i, 0);
			if ((NU)((NI32)(TMP1613)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_9514((*s).F, ((void*) (&result->data[(NI32)(TMP1613)])), 2048);
