...
static N_INLINE(void, HEX2AHEX3D_86723)(NF* x_86729, NF y_86732);
...
STRING_LITERAL(TMP1130, "overflow", 8);
extern TFrame* frameptr_13238;
extern TNimType NTI18801; /* ref EOverflow */
...
N_NIMCALL(NI, rawparseint_86531)(NimStringDesc* s, NI64* b, NI start) {
	...
	nimln(200, "parseutils.nim");
	{
		...
		while (1) {
			...
			nimln(203, "parseutils.nim");
			nimln(203, "parseutils.nim");
			TMP1125 = mulInt64((*b), 10);
			nimln(203, "parseutils.nim");
			nimln(203, "parseutils.nim");
			if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
			TMP1126 = subInt(((NI) (((NU8)(s->data[i])))), 48);
			TMP1127 = subInt64((NI64)(TMP1125), ((NI64) ((NI32)(TMP1126))));
			(*b) = (NI64)(TMP1127);
		...
		nimln(206, "parseutils.nim");
		TMP1128 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP1128);
		nimln(207, "parseutils.nim");
		nimln(207, "parseutils.nim");
		TMP1129 = subInt(i, start);
		result = (NI32)(TMP1129);
	}
	LA10: ;
	popFrame();
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	nimln(228, "parseutils.nim");
	{
		...
		e_86686 = (EOverflow*) newObj((&NTI18801), sizeof(EOverflow));
		(*e_86686).Sup.Sup.Sup.Sup.m_type = (&NTI2445);
		nimln(1992, "system.nim");
		LOC9 = 0;
		LOC9 = (*e_86686).Sup.Sup.Sup.message; (*e_86686).Sup.Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1130));
...
N_NIMCALL(NI, npuParseBiggestFloat)(NimStringDesc* s, NF* number, NI start) {
	...
	nimln(261, "parseutils.nim");
	{
		...
		nimln(262, "parseutils.nim");
		{
			...
			nimln(262, "parseutils.nim");
			TMP1835 = addInt(i, 1);
			if ((NU)((NI32)(TMP1835)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC16 = ((NU8)(s->data[(NI32)(TMP1835)]) == (NU8)(65));
			if (LOC16) goto LA17;
			nimln(262, "parseutils.nim");
			nimln(262, "parseutils.nim");
			TMP1836 = addInt(i, 1);
			if ((NU)((NI32)(TMP1836)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC16 = ((NU8)(s->data[(NI32)(TMP1836)]) == (NU8)(97));
			LA17: ;
			if (!LOC16) goto LA18;
			nimln(263, "parseutils.nim");
			{
				...
				nimln(263, "parseutils.nim");
				TMP1837 = addInt(i, 2);
				if ((NU)((NI32)(TMP1837)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC22 = ((NU8)(s->data[(NI32)(TMP1837)]) == (NU8)(78));
				if (LOC22) goto LA23;
				nimln(263, "parseutils.nim");
				nimln(263, "parseutils.nim");
				TMP1838 = addInt(i, 2);
				if ((NU)((NI32)(TMP1838)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC22 = ((NU8)(s->data[(NI32)(TMP1838)]) == (NU8)(110));
				LA23: ;
				if (!LOC22) goto LA24;
				nimln(264, "parseutils.nim");
				{
					...
					if (!!((((NU8)(s->data[(NI32)(TMP1839)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI32)(TMP1839)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI32)(TMP1839)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI32)(TMP1839)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI32)(TMP1839)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI32)(TMP1839)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI32)(TMP1839)])) == ((NU8)(95))))) goto LA28;
					...
					nimln(266, "parseutils.nim");
					TMP1840 = addInt(i, 3);
					TMP1841 = subInt((NI32)(TMP1840), start);
					result = (NI32)(TMP1841);
					goto BeforeRet;
				}
				LA28: ;
	...
	nimln(268, "parseutils.nim");
	{
		...
		nimln(269, "parseutils.nim");
		{
			...
			LOC38 = ((NU8)(s->data[(NI32)(TMP1842)]) == (NU8)(78));
			if (LOC38) goto LA39;
			nimln(269, "parseutils.nim");
			nimln(269, "parseutils.nim");
			TMP1843 = addInt(i, 1);
			if ((NU)((NI32)(TMP1843)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC38 = ((NU8)(s->data[(NI32)(TMP1843)]) == (NU8)(110));
			LA39: ;
			if (!LOC38) goto LA40;
			nimln(270, "parseutils.nim");
			{
				...
				LOC44 = ((NU8)(s->data[(NI32)(TMP1844)]) == (NU8)(70));
				if (LOC44) goto LA45;
				nimln(270, "parseutils.nim");
				nimln(270, "parseutils.nim");
				TMP1845 = addInt(i, 2);
				if ((NU)((NI32)(TMP1845)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC44 = ((NU8)(s->data[(NI32)(TMP1845)]) == (NU8)(102));
				LA45: ;
				if (!LOC44) goto LA46;
				nimln(271, "parseutils.nim");
				{
					...
					if (!!((((NU8)(s->data[(NI32)(TMP1846)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI32)(TMP1846)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI32)(TMP1846)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI32)(TMP1846)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI32)(TMP1846)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI32)(TMP1846)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI32)(TMP1846)])) == ((NU8)(95))))) goto LA50;
					...
					nimln(273, "parseutils.nim");
					TMP1847 = addInt(i, 3);
					TMP1848 = subInt((NI32)(TMP1847), start);
					result = (NI32)(TMP1848);
					goto BeforeRet;
				}
				LA50: ;
	...
	while (1) {
		...
		nimln(278, "parseutils.nim");
		if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
		TMP1849 = subInt(((NI) (((NU8)(s->data[i])))), 48);
		(*number) = ((NF)(((NF)((*number)) * (NF)(1.0000000000000000e+001))) + (NF)(((double) (((NI) ((NI32)(TMP1849)))))));
	...
	nimln(282, "parseutils.nim");
	{
		...
		while (1) {
			...
			nimln(288, "parseutils.nim");
			if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
			TMP1850 = subInt(((NI) (((NU8)(s->data[i])))), 48);
			(*number) = ((NF)(((NF)((*number)) * (NF)(1.0000000000000000e+001))) + (NF)(((double) (((NI) ((NI32)(TMP1850)))))));
	...
	nimln(296, "parseutils.nim");
	{
		...
		while (1) {
			...
			nimln(306, "parseutils.nim");
			nimln(306, "parseutils.nim");
			TMP1851 = mulInt(exponent, 10);
			nimln(306, "parseutils.nim");
			if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
			TMP1852 = addInt((NI32)(TMP1851), ((NI) (((NU8)(s->data[i])))));
			TMP1853 = subInt((NI32)(TMP1852), 48);
			exponent = (NI32)(TMP1853);
