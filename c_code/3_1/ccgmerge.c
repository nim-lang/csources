...
STRING_LITERAL(TMP4027, "ccgmerge: \':\' expected", 22);
STRING_LITERAL(TMP4028, "NIM_merge_INFO", 14);
STRING_LITERAL(TMP4029, "typeCache", 9);
STRING_LITERAL(TMP4030, "declared", 8);
STRING_LITERAL(TMP4031, "typeInfo", 8);
STRING_LITERAL(TMP4032, "labels", 6);
STRING_LITERAL(TMP4033, "hasframe", 8);
STRING_LITERAL(TMP4034, "ccgmerge: \'{\' expected", 22);
STRING_LITERAL(TMP4035, "ccgmerge: unkown key: ", 22);
STRING_LITERAL(TMP4106, "ccgmerge: expected: /*\011NIM_merge_END:*/", 39);
STRING_LITERAL(TMP4107, "/*\011NIM_merge_END:*/", 19);
STRING_LITERAL(TMP4108, "", 0);
STRING_LITERAL(TMP4109, "NIM_merge_HEADERS", 17);
STRING_LITERAL(TMP4110, "NIM_merge_FORWARD_TYPES", 23);
STRING_LITERAL(TMP4111, "NIM_merge_TYPES", 15);
STRING_LITERAL(TMP4112, "NIM_merge_SEQ_TYPES", 19);
STRING_LITERAL(TMP4113, "NIM_merge_FIELD_INFO", 20);
STRING_LITERAL(TMP4114, "NIM_merge_TYPE_INFO", 19);
STRING_LITERAL(TMP4115, "NIM_merge_PROC_HEADERS", 22);
STRING_LITERAL(TMP4116, "NIM_merge_DATA", 14);
STRING_LITERAL(TMP4117, "NIM_merge_VARS", 14);
STRING_LITERAL(TMP4118, "NIM_merge_PROCS", 15);
STRING_LITERAL(TMP4119, "NIM_merge_INIT_PROC", 19);
STRING_LITERAL(TMP4120, "NIM_merge_TYPE_INIT1", 20);
STRING_LITERAL(TMP4121, "NIM_merge_TYPE_INIT2", 20);
STRING_LITERAL(TMP4122, "NIM_merge_TYPE_INIT3", 20);
STRING_LITERAL(TMP4123, "NIM_merge_DEBUG_INIT", 20);
STRING_LITERAL(TMP4124, "NIM_merge_DYNLIB_INIT", 21);
STRING_LITERAL(TMP4125, "NIM_merge_DYNLIB_DEINIT", 23);
NIM_CONST TY545013 cfilesectionnames_545012 = {((NimStringDesc*) &TMP4108),
...
;
STRING_LITERAL(TMP4126, "NIM_merge_PROC_LOCALS", 21);
STRING_LITERAL(TMP4127, "NIM_merge_PROC_INIT", 19);
STRING_LITERAL(TMP4128, "NIM_merge_PROC_BODY", 19);
NIM_CONST TY545019 cprocsectionnames_545018 = {((NimStringDesc*) &TMP4126),
((NimStringDesc*) &TMP4127),
((NimStringDesc*) &TMP4128)}
;
STRING_LITERAL(TMP4129, "ccgmerge: unknown section: ", 27);
STRING_LITERAL(TMP4130, "ccgmerge: \'*/\' expected", 23);
STRING_LITERAL(TMP4135, "/*\011", 3);
STRING_LITERAL(TMP4136, ":*/", 3);
STRING_LITERAL(TMP4146, "/*\011NIM_merge_INFO:", 18);
STRING_LITERAL(TMP4147, "typeCache:{", 11);
STRING_LITERAL(TMP4148, "declared:{", 10);
STRING_LITERAL(TMP4149, "typeInfo:{", 10);
STRING_LITERAL(TMP4150, "labels:", 7);
STRING_LITERAL(TMP4151, " hasframe:", 10);
STRING_LITERAL(TMP4152, "*/", 2);
...
N_NIMCALL(void, readkey_545535)(tbaselexer213024* l, NimStringDesc** result) {
	...
	}
	{
		...
		internalerror_197989(((NimStringDesc*) &TMP4027));
	}
	LA5: ;
	(*l).Bufpos = (NI32)(pos + 1);
}
...
N_NIMCALL(void, readtypecache_545607)(tbaselexer213024* l, tidtable224867* result) {
	{
		...
		internalerror_197989(((NimStringDesc*) &TMP4034));
	}
	LA3: ;
	(*l).Bufpos += 1;
	{
...
N_NIMCALL(void, processmergeinfo_545711)(tbaselexer213024* l, tcgen544035* m) {
	...
	k = rawNewString(9);
	{
		while (1) {
			...
			LA7: ;
			readkey_545535(l, &k);
			if (eqStrings(k, ((NimStringDesc*) &TMP4029))) goto LA9;
			if (eqStrings(k, ((NimStringDesc*) &TMP4030))) goto LA10;
			if (eqStrings(k, ((NimStringDesc*) &TMP4031))) goto LA11;
			if (eqStrings(k, ((NimStringDesc*) &TMP4032))) goto LA12;
...
appendString(LOC24, ((NimStringDesc*) &TMP4035));
...
N_NIMCALL(void, readmergeinfo_545815)(NimStringDesc* cfilename, tcgen544035* m) {
	...
	k = rawNewString(23);
	{
		while (1) {
			...
			readkey_545535(&l, &k);
			{
				if (!eqStrings(k, ((NimStringDesc*) &TMP4028))) goto LA13;
...
N_NIMCALL(NIM_BOOL, atendmark_545456)(NCSTRING buf, NI pos) {
	...
	s = 0;
	{
		while (1) {
			...
			LOC3 = (s < 19);
			if (!(LOC3)) goto LA4;
			LOC3 = ((NU8)(buf[(NI32)(pos + s)]) == (NU8)(((NimStringDesc*) &TMP4107)->data[s]));
			LA4: ;
			if (!LOC3) goto LA2;
			s += 1;
		} LA2: ;
...
appendString(r, tnl_174613);
			...
			case 0:
			{
				internalerror_197989(((NimStringDesc*) &TMP4106));
				goto LA1;
			}
			break;
			default:
...
appendString(LOC34, ((NimStringDesc*) &TMP4129));
appendString(LOC34, k);
			...
			LA18: ;
			{
				internalerror_197989(((NimStringDesc*) &TMP4130));
			}
			LA11: ;
		}
	} LA5: ;
...
N_NIMCALL(trope177009*, gensectionstart_545126)(NU8 ps) {
	...
	result = 0;
	{
		...
		app_177060(&result, ((NimStringDesc*) &TMP4135));
		app_177060(&result, cprocsectionnames_545018[(ps)- 0]);
		app_177060(&result, ((NimStringDesc*) &TMP4136));
...
appendString(LOC5, ((NimStringDesc*) &TMP4107));
...
N_NIMCALL(trope177009*, genmergeinfo_545329)(tcgen544035* m) {
	...
	LA3: ;
	s = copyString(((NimStringDesc*) &TMP4146));
	s = resizeString(s, tnl_174613->Sup.len + 0);
appendString(s, tnl_174613);
	s = resizeString(s, 11);
appendString(s, ((NimStringDesc*) &TMP4147));
	writetypecache_545224((*m).Typecache, &s);
	s = resizeString(s, 10);
appendString(s, ((NimStringDesc*) &TMP4148));
	writeintset_545271((*m).Declaredthings, &s);
	s = resizeString(s, 10);
appendString(s, ((NimStringDesc*) &TMP4149));
