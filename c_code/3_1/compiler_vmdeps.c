...
STRING_LITERAL(TMP2885, "none", 4);
STRING_LITERAL(TMP2886, "bool", 4);
STRING_LITERAL(TMP2887, "char", 4);
STRING_LITERAL(TMP2888, "nil", 3);
STRING_LITERAL(TMP2889, "expr", 4);
STRING_LITERAL(TMP2890, "stmt", 4);
STRING_LITERAL(TMP2891, "void", 4);
STRING_LITERAL(TMP2892, "array", 5);
STRING_LITERAL(TMP2893, "typeDesc", 8);
STRING_LITERAL(TMP2894, "typeDesc", 8);
STRING_LITERAL(TMP2895, "void", 4);
STRING_LITERAL(TMP2896, "distinct", 8);
STRING_LITERAL(TMP2897, "tuple", 5);
STRING_LITERAL(TMP2898, "set", 3);
STRING_LITERAL(TMP2899, "ptr", 3);
STRING_LITERAL(TMP2900, "ref", 3);
STRING_LITERAL(TMP2901, "var", 3);
STRING_LITERAL(TMP2902, "seq", 3);
STRING_LITERAL(TMP2903, "proc", 4);
STRING_LITERAL(TMP2904, "openArray", 9);
STRING_LITERAL(TMP2905, "range", 5);
STRING_LITERAL(TMP2906, "pointer", 7);
STRING_LITERAL(TMP2907, "string", 6);
STRING_LITERAL(TMP2908, "cstring", 7);
STRING_LITERAL(TMP2909, "int", 3);
STRING_LITERAL(TMP2910, "int8", 4);
STRING_LITERAL(TMP2911, "int16", 5);
STRING_LITERAL(TMP2912, "int32", 5);
STRING_LITERAL(TMP2913, "int64", 5);
STRING_LITERAL(TMP2914, "float", 5);
STRING_LITERAL(TMP2915, "float32", 7);
STRING_LITERAL(TMP2916, "float64", 7);
STRING_LITERAL(TMP2917, "float128", 8);
STRING_LITERAL(TMP2918, "uint", 4);
STRING_LITERAL(TMP2919, "uint8", 5);
STRING_LITERAL(TMP2920, "uint16", 6);
STRING_LITERAL(TMP2921, "uint32", 6);
STRING_LITERAL(TMP2922, "uint64", 6);
STRING_LITERAL(TMP2923, "bignum", 6);
STRING_LITERAL(TMP2924, "const", 5);
STRING_LITERAL(TMP2925, "mutable", 7);
STRING_LITERAL(TMP2926, "varargs", 7);
STRING_LITERAL(TMP2927, "iter", 4);
STRING_LITERAL(TMP2928, "error", 5);
STRING_LITERAL(TMP2929, "builtinTypeClass", 16);
STRING_LITERAL(TMP2930, "userTypeClass", 13);
STRING_LITERAL(TMP2931, "compositeTypeClass", 18);
STRING_LITERAL(TMP2932, "and", 3);
STRING_LITERAL(TMP2933, "or", 2);
STRING_LITERAL(TMP2934, "not", 3);
STRING_LITERAL(TMP2935, "anything", 8);
STRING_LITERAL(TMP2936, "static", 6);
STRING_LITERAL(TMP2940, "", 0);
STRING_LITERAL(TMP2951, "\012", 1);
...
N_NIMCALL(tnode207813*, atomictypex_395072)(NimStringDesc* name, ttype207849* t, tlineinfo180338 info) {
	...
	sym = newsym_208656(((NU8) 7), LOC1, (*t).Owner, info);
		...
		res_395138 = ((NI) 0);
		{
			while (1) {
				...
				i_395118 = res_395138;
				{
					...
					void_395131 = atomictypex_395072(((NimStringDesc*) &TMP2895), t, info);
...
N_NIMCALL(tnode207813*, maptypetoast_395085)(ttype207849* t, tlineinfo180338 info, NIM_BOOL allowrecursion) {
	...
	case ((NU8) 0):
	{
		result = atomictypex_395072(((NimStringDesc*) &TMP2885), t, info);
	}
	break;
	case ((NU8) 1):
	{
		result = atomictypex_395072(((NimStringDesc*) &TMP2886), t, info);
	}
	break;
	case ((NU8) 2):
	{
	...
	case ((NU8) 16):
	{
		...
		result = newnodeit_209807(((NU8) 42), info, t);
		LOC9 = 0;
		LOC9 = atomictypex_395072(((NimStringDesc*) &TMP2892), t, info);
	...
	{
		{
			...
			result = newnodeit_209807(((NU8) 42), info, t);
			LOC18 = 0;
			LOC18 = atomictypex_395072(((NimStringDesc*) &TMP2893), t, info);
		...
		LA16: ;
		{
			result = atomictypex_395072(((NimStringDesc*) &TMP2894), t, info);
		}
		LA13: ;
	}
	break;
	...
	{
		{
			...
			result = maptypetobracket_395093(((NimStringDesc*) &TMP2896), t, info);
		}
		goto LA31;
		LA33: ;
		{
	...
	case ((NU8) 18):
	{
		result = maptypetobracket_395093(((NimStringDesc*) &TMP2897), t, info);
	}
	break;
	case ((NU8) 19):
	{
	...
	case ((NU8) 20):
	{
		...
		result = newnodeit_209807(((NU8) 42), info, t);
		LOC61 = 0;
		LOC61 = atomictypex_395072(((NimStringDesc*) &TMP2905), t, info);
	...
	case ((NU8) 26):
	{
		result = atomictypex_395072(((NimStringDesc*) &TMP2906), t, info);
	}
	break;
	case ((NU8) 28):
	{
		result = atomictypex_395072(((NimStringDesc*) &TMP2907), t, info);
	}
	break;
	case ((NU8) 29):
	{
	...
	case ((NU8) 46):
	{
		result = maptypetobracket_395093(((NimStringDesc*) &TMP2924), t, info);
	}
	break;
	case ((NU8) 47):
	{
		result = maptypetobracket_395093(((NimStringDesc*) &TMP2925), t, info);
	}
	break;
	case ((NU8) 48):
	{
	...
	case ((NU8) 50):
	{
		result = atomictypex_395072(((NimStringDesc*) &TMP2928), t, info);
	}
	break;
	case ((NU8) 51):
	{
	...
	case ((NU8) 52):
	{
		result = maptypetobracket_395093(((NimStringDesc*) &TMP2930), t, info);
	}
	break;
	case ((NU8) 54):
	{
	...
	case ((NU8) 58):
	{
		result = atomictypex_395072(((NimStringDesc*) &TMP2935), t, info);
	}
	break;
	case ((NU8) 59):
	case ((NU8) 60):
	case ((NU8) 61):
	{
		...
		result = newnodeit_209807(((NU8) 42), info, t);
		LOC95 = 0;
		LOC95 = atomictypex_395072(((NimStringDesc*) &TMP2936), t, info);
...
N_NIMCALL(NimStringDesc*, opslurp_395044)(NimStringDesc* file, tlineinfo180338 info, tsym207843* module) {
	...
	TSafePoint TMP2939;
	result = 0;
	pushSafePoint(&TMP2939);
	TMP2939.status = _setjmp(TMP2939.context);
	if (TMP2939.status == 0) {
		...
		LOC3[0] = newstrnode_208644(((NU8) 20), filename);
		...
		if (isObj(getCurrentException()->Sup.m_type, (&NTI3431))) {
			...
			result = copyString(((NimStringDesc*) &TMP2940));
			popCurrentException();
		}
	}
	if (TMP2939.status != 0) reraiseException();
	return result;
}
...
appendString(result, ((NimStringDesc*) &TMP2951));
		} LA2: ;
	}
...
N_NIMCALL(NimStringDesc*, opgorge_395027)(NimStringDesc* cmd, NimStringDesc* input) {
	...
	TMP2941.status = _setjmp(TMP2941.context);
	if (TMP2941.status == 0) {
		processobj140402* p;
		TY234722 LOC2;
		memset((void*)LOC2, 0, sizeof(LOC2));
		p = nospstartProcess(cmd, ((NimStringDesc*) &TMP2940), LOC2, 0, NIM_NIL, 4);
		{
