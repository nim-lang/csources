...
N_NIMCALL(Memfile249202, open_249801)(NimStringDesc* filename, NU8 mode, NI mappedsize, NI offset, NI newfilesize) {
	...
	LA6: ;
	{
		...
		LA17: ;
		LOC20 = 0;
		LOC20 = oslasterror_121019();
		raiseoserror_121003(LOC20, ((NimStringDesc*) &TMP1564));
	}
	LA13: ;
	{
		if (!!((newfilesize == ((NI) -1)))) goto LA23;
		{
			...
			LA32: ;
			LOC35 = 0;
			LOC35 = oslasterror_121019();
			raiseoserror_121003(LOC35, ((NimStringDesc*) &TMP1564));
		}
		LA28: ;
	}
	LA23: ;
	...
	LA38: ;
	{
		...
		LA44: ;
		{
			...
			raiseoserror_121003(LOC52, ((NimStringDesc*) &TMP1564));
		}
		LA41: ;
	}
	LA36: ;
	...
	result.mem = mmap(NIM_NIL, result.size, LOC53, LOC59, result.handle, ((off_t) (offset)));
	{
		...
		LA71: ;
		LOC74 = 0;
		LOC74 = oslasterror_121019();
		raiseoserror_121003(LOC74, ((NimStringDesc*) &TMP1564));
	}
	LA67: ;
	return result;
}
...
N_NIMCALL(void, close_250242)(Memfile249202* f) {
	...
	{
		if (!error) goto LA11;
		raiseoserror_121003(lasterr, ((NimStringDesc*) &TMP1564));
	}
	LA11: ;
}
...
NTI249202.size = sizeof(Memfile249202);
NTI249202.kind = 18;
NTI249202.base = 0;
NTI249202.flags = 3;
TMP912[0] = &TMP898[1];
TMP898[1].kind = 1;
TMP898[1].offset = offsetof(Memfile249202, mem);
TMP898[1].typ = (&NTI142);
TMP898[1].name = "mem";
TMP912[1] = &TMP898[2];
TMP898[2].kind = 1;
TMP898[2].offset = offsetof(Memfile249202, size);
TMP898[2].typ = (&NTI104);
TMP898[2].name = "size";
TMP912[2] = &TMP898[3];
TMP898[3].kind = 1;
TMP898[3].offset = offsetof(Memfile249202, handle);
TMP898[3].typ = (&NTI7208);
TMP898[3].name = "handle";
TMP898[0].len = 3; TMP898[0].kind = 2; TMP898[0].sons = &TMP912[0];
NTI249202.node = &TMP898[0];
}
