...
STRING_LITERAL(TMP1657, "..", 2);
STRING_LITERAL(TMP1658, "head", 4);
...
{	result = 0;
	{
		if (!eqStrings(a, ((NimStringDesc*) &TMP1658))) goto LA3;
		result = NIM_FALSE;
		goto BeforeRet;
	}
	LA3: ;
...
N_NIMCALL(void, addpackage_173126)(Stringtableobj134012* packages, NimStringDesc* p) {
	...
	LA3: ;
	{
		nstPut(packages, name, ((NimStringDesc*) &TMP1658));
	}
	LA1: ;
}
				...
				while (1) {
					{
						...
						y_173312 = cstrToNimstr(((NCSTRING) ((*x_173310).d_name)));
						{
							...
							NU8 k_173316;
							LOC19 = 0;
							LOC19 = !(eqStrings(y_173312, ((NimStringDesc*) &TMP1656)));
							if (!(LOC19)) goto LA20;
							LOC19 = !(eqStrings(y_173312, ((NimStringDesc*) &TMP1657)));
							LA20: ;
							if (!LOC19) goto LA21;
							memset((void*)(&s_173314), 0, sizeof(s_173314));
							y_173312 = HEX2F_119492(dir, y_173312);
							k_173316 = ((NU8) 0);
							{
				...
				res_173330 = ((NI) 0);
				{
					while (1) {
						...
						h_173326 = res_173330;
						{
							...
							{
								if (!eqStrings(val_173324, ((NimStringDesc*) &TMP1658))) goto LA74;
