...
N_NIMCALL(void, merge_362843)(tsym191843** a_362851, NI a_362851Len0, tsym191843** b_362859, NI b_362859Len0, NI lo_362863, NI m_362865, NI hi_362867, TY362801 cmp_362875, NU8 order_362878) {
	...
	nimln(101, "algorithm.nim");
	{
		...
		if ((NU)((NI32)(TMP5095)) >= (NU)(a_362851Len0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp_362875.ClEnv? cmp_362875.ClPrc(a_362851[m_362865], a_362851[(NI32)(TMP5095)], cmp_362875.ClEnv):((TMP5096)(cmp_362875.ClPrc))(a_362851[m_362865], a_362851[(NI32)(TMP5095)]);
		LOC4 = 0;
...
N_NIMCALL(void, sort_362782)(tsym191843** a_362790, NI a_362790Len0, TY362801 cmp_362800, NU8 order_362803) {
	...
	nimln(155, "algorithm.nim");
	TMP5092 = divInt(n, 2);
	b = (tsymseq191815*) newSeq((&NTI191815), (NI32)(TMP5092));
	...
	while (1) {
		...
		while (1) {
			...
			nimln(160, "algorithm.nim");
			TMP5101 = addInt(m, s);
			merge_362843(a_362790, a_362790Len0, b->data, b->Sup.len, (((NI32)(TMP5100) >= 0) ? (NI32)(TMP5100) : 0), m, (NI32)(TMP5101), cmp_362800, order_362803);
...
N_NIMCALL(void, merge_366227)(tentry365566* a_366235, NI a_366235Len0, tentry365566* b_366243, NI b_366243Len0, NI lo_366247, NI m_366249, NI hi_366251, TY366185 cmp_366259, NU8 order_366262) {
	...
	nimln(101, "algorithm.nim");
	{
		...
		if ((NU)((NI32)(TMP5114)) >= (NU)(a_366235Len0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp_366259.ClEnv? cmp_366259.ClPrc(a_366235[m_366249], a_366235[(NI32)(TMP5114)], cmp_366259.ClEnv):((TMP5115)(cmp_366259.ClPrc))(a_366235[m_366249], a_366235[(NI32)(TMP5114)]);
		LOC4 = 0;
...
N_NIMCALL(void, sort_366166)(tentry365566* a_366174, NI a_366174Len0, TY366185 cmp_366184, NU8 order_366187) {
	...
	nimln(155, "algorithm.nim");
	TMP5111 = divInt(n, 2);
	b = (TY365573*) newSeq((&NTI365573), (NI32)(TMP5111));
	nimln(156, "algorithm.nim");
	s = 1;
	nimln(157, "algorithm.nim");
	while (1) {
		...
		while (1) {
			...
			nimln(160, "algorithm.nim");
			TMP5119 = addInt(m, s);
			merge_366227(a_366174, a_366174Len0, b->data, b->Sup.len, (((NI32)(TMP5118) >= 0) ? (NI32)(TMP5118) : 0), m, (NI32)(TMP5119), cmp_366184, order_366187);
			nimln(161, "algorithm.nim");
			nimln(161, "algorithm.nim");
			TMP5120 = mulInt(s, 2);
