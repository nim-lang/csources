...
N_NIMCALL(void, merge_357843)(tsym186843** a_357851, NI a_357851Len0, tsym186843** b_357859, NI b_357859Len0, NI lo_357863, NI m_357865, NI hi_357867, TY357801 cmp_357875, NU8 order_357878) {
	...
	nimln(101, "algorithm.nim");
	{
		...
		if ((NU)((NI32)(TMP5093)) >= (NU)(a_357851Len0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp_357875.ClEnv? cmp_357875.ClPrc(a_357851[m_357865], a_357851[(NI32)(TMP5093)], cmp_357875.ClEnv):((TMP5094)(cmp_357875.ClPrc))(a_357851[m_357865], a_357851[(NI32)(TMP5093)]);
		LOC4 = 0;
...
N_NIMCALL(void, sort_357782)(tsym186843** a_357790, NI a_357790Len0, TY357801 cmp_357800, NU8 order_357803) {
	...
	nimln(155, "algorithm.nim");
	TMP5090 = divInt(n, 2);
	b = (tsymseq186815*) newSeq((&NTI186815), (NI32)(TMP5090));
	...
	while (1) {
		...
		while (1) {
			...
			nimln(160, "algorithm.nim");
			TMP5099 = addInt(m, s);
			merge_357843(a_357790, a_357790Len0, b->data, b->Sup.len, (((NI32)(TMP5098) >= 0) ? (NI32)(TMP5098) : 0), m, (NI32)(TMP5099), cmp_357800, order_357803);
			nimln(161, "algorithm.nim");
			nimln(161, "algorithm.nim");
			TMP5100 = mulInt(s, 2);
			m = subInt(m, (NI32)(TMP5100));
		} LA2: ;
...
N_NIMCALL(void, merge_361227)(tentry360566* a_361235, NI a_361235Len0, tentry360566* b_361243, NI b_361243Len0, NI lo_361247, NI m_361249, NI hi_361251, TY361185 cmp_361259, NU8 order_361262) {
	...
	nimln(101, "algorithm.nim");
	{
		...
		if ((NU)((NI32)(TMP5112)) >= (NU)(a_361235Len0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp_361259.ClEnv? cmp_361259.ClPrc(a_361235[m_361249], a_361235[(NI32)(TMP5112)], cmp_361259.ClEnv):((TMP5113)(cmp_361259.ClPrc))(a_361235[m_361249], a_361235[(NI32)(TMP5112)]);
		LOC4 = 0;
...
N_NIMCALL(void, sort_361166)(tentry360566* a_361174, NI a_361174Len0, TY361185 cmp_361184, NU8 order_361187) {
	...
	nimln(155, "algorithm.nim");
	TMP5109 = divInt(n, 2);
	b = (TY360573*) newSeq((&NTI360573), (NI32)(TMP5109));
	nimln(156, "algorithm.nim");
	s = 1;
	nimln(157, "algorithm.nim");
	while (1) {
		...
		while (1) {
			...
			nimln(160, "algorithm.nim");
			TMP5115 = subInt(m, s);
			TMP5116 = addInt((NI32)(TMP5115), 1);
			nimln(160, "algorithm.nim");
			TMP5117 = addInt(m, s);
			merge_361227(a_361174, a_361174Len0, b->data, b->Sup.len, (((NI32)(TMP5116) >= 0) ? (NI32)(TMP5116) : 0), m, (NI32)(TMP5117), cmp_361184, order_361187);
			nimln(161, "algorithm.nim");
			nimln(161, "algorithm.nim");
			TMP5118 = mulInt(s, 2);
			m = subInt(m, (NI32)(TMP5118));
		} LA2: ;
		nimln(162, "algorithm.nim");
		nimln(162, "algorithm.nim");
		TMP5119 = mulInt(s, 2);
