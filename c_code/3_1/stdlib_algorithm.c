...
{	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI32)(m + ((NI) 1))], cmp.ClEnv):((TMP2659)(cmp.ClPrc))(a[m], a[(NI32)(m + ((NI) 1))]);
		LOC4 = 0;
...
{	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI32)(m + ((NI) 1))], cmp.ClEnv):((TMP4876)(cmp.ClPrc))(a[m], a[(NI32)(m + ((NI) 1))]);
		LOC4 = 0;
		LOC4 = HEX2A_325020(LOC3, order);
		if (!(LOC4 <= ((NI) 0))) goto LA5;
		goto BeforeRet;
...
N_NIMCALL(void, sort_330301)(NimStringDesc** a, NI aLen0, TY330308 cmp, NU8 order) {
	...
	n = aLen0;
	b = 0;
	b = (TY120208*) newSeq((&NTI120208), (NI32)(n / ((NI) 2)));
	s = ((NI) 1);
	{
		while (1) {
			NI m;
...
{	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI32)(m + ((NI) 1))], cmp.ClEnv):((TMP4880)(cmp.ClPrc))(a[m], a[(NI32)(m + ((NI) 1))]);
		LOC4 = 0;
		LOC4 = HEX2A_325020(LOC3, order);
		if (!(LOC4 <= ((NI) 0))) goto LA5;
		goto BeforeRet;
