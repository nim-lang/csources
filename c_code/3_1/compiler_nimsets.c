...
N_NIMCALL(Tnode213790*, totreeset_259251)(Tbitset258006* s, Ttype213828* settype, Tlineinfo181337 info);
...
N_NIMCALL(void, tobitset_259001)(Tnode213790* s, Tbitset258006** b) {
	...
	bitsetinit_258009(b, ((NI) (LOC1)));
	{
		...
		HEX3Atmp_259244 = (NI)(LOC3 - ((NI) 1));
		res_259247 = ((NI) 0);
		{
			while (1) {
				if (!(res_259247 <= HEX3Atmp_259244)) goto LA5;
				i_259215 = res_259247;
				{
	...
	e = IL64(0);
	{
		while (1) {
			if (!(e < ((NI64) ((NI)((s ? s->Sup.len : 0) * ((NI) 8)))))) goto LA2;
			{
				...
				b -= ((NI) 1);
				aa = newinttypenode_214666(((NU8) 6), (NI64)(a + first), elemtype);
				(*aa).info = info;
				{
					if (!(a == b)) goto LA19;
				...
				LA19: ;
				{
					...
					addson_215807(n, aa);
					bb = newinttypenode_214666(((NU8) 6), (NI64)(b + first), elemtype);
					(*bb).info = info;
					addson_215807(n, bb);
...
N_NIMCALL(Tnode213790*, diffsets_259030)(Tnode213790* a, Tnode213790* b) {
	...
	result = totreeset_259251(x, (*a).typ, (*a).info);
	return result;
}
...
N_NIMCALL(NI64, cardset_259050)(Tnode213790* s) {
	...
	result = IL64(0);
	{
		...
		HEX3Atmp_259459 = (NI)(LOC2 - ((NI) 1));
		res_259462 = ((NI) 0);
		{
			while (1) {
				if (!(res_259462 <= HEX3Atmp_259459)) goto LA4;
				i_259434 = res_259462;
				{
					NI64 LOC9;
					NI64 LOC10;
					if (!((*(*s).kindU.S6.sons->data[i_259434]).kind == ((NU8) 44))) goto LA7;
					LOC9 = 0;
					LOC9 = getordvalue_239118((*(*s).kindU.S6.sons->data[i_259434]).kindU.S6.sons->data[((NI) 1)]);
					LOC10 = 0;
					LOC10 = getordvalue_239118((*(*s).kindU.S6.sons->data[i_259434]).kindU.S6.sons->data[((NI) 0)]);
...
N_NIMCALL(Tnode213790*, complement_259392)(Tnode213790* a) {
	...
	tobitset_259001(a, (&x));
	{
		...
		i_259409 = 0;
		HEX3Atmp_259412 = 0;
		HEX3Atmp_259412 = (x ? (x->Sup.len-1) : -1);
		res_259415 = ((NI) 0);
		{
			while (1) {
				if (!(res_259415 <= HEX3Atmp_259412)) goto LA3;
				i_259409 = res_259415;
				x->data[i_259409] = (NI8)((NU8) ~(x->data[i_259409]));
				res_259415 += ((NI) 1);
			} LA3: ;
		}
	}
