...
STRING_LITERAL(TMP7227, "./", 2);
STRING_LITERAL(TMP7228, "", 0);
STRING_LITERAL(TMP7230, "nimrod.cfg", 10);
STRING_LITERAL(TMP7231, "js", 2);
STRING_LITERAL(TMP7232, "node ", 5);
...
appendString(LOC7, ((NimStringDesc*) &TMP7227));
appendString(LOC7, f);
		result = LOC7;
	}	LA1: ;
	popFrame();
...
N_NIMCALL(void, handlecmdline_423603)(void) {
	...
	{
		nimln(39, "nimrod.nim");
		processcmdline_418207(((NU8) 0), ((NimStringDesc*) &TMP7228));		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP7229;
			TY102259 p;
			NimStringDesc* LOC15;
			...
			nimln(41, "nimrod.nim");
			pushSafePoint(&TMP7229);
			TMP7229.status = setjmp(TMP7229.context);
			if (TMP7229.status == 0) {
				nimln(42, "nimrod.nim");
				...
				if (isObj(getCurrentException()->Sup.m_type, (&NTI1035))) {
					...
					popCurrentException();
				}			}			if (TMP7229.status != 0) reraiseException();
			nimln(45, "nimrod.nim");
			chckNil((void*)&p);
		...
		nimln(50, "nimrod.nim");
		loadconfigs_167607(((NimStringDesc*) &TMP7230));		nimln(53, "nimrod.nim");
		initvars_147647();		nimln(54, "nimrod.nim");
		processcmdline_418207(((NU8) 1), ((NimStringDesc*) &TMP7228));		nimln(55, "nimrod.nim");
		...
		nimln(58, "nimrod.nim");
		{
			...
			nimln(62, "nimrod.nim");
			{
				...
				nimln(63, "nimrod.nim");
				{
					...
					nimln(65, "nimrod.nim");
					LOC35 = 0;
					LOC35 = nosChangeFileExt(gprojectfull_114199, ((NimStringDesc*) &TMP7231));
					LOC36 = 0;
...
appendString(LOC38, ((NimStringDesc*) &TMP7232));
...
appendString(LOC38, arguments_418205);
				...
				LA33: ;
				{
					...
					nimln(69, "nimrod.nim");
					{
						...
						nimln(71, "nimrod.nim");
						binpath = prependcurdir_423401(outfile_114115);
					}					goto LA40;
					LA42: ;
					{
						NimStringDesc* LOC45;
						...
						nimln(74, "nimrod.nim");
						LOC45 = 0;
						LOC45 = nosChangeFileExt(gprojectfull_114199, ((NimStringDesc*) &TMP7228));
