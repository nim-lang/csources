...
STRING_LITERAL(TMP3009, "public implementation \'$1\' has non-public forward declaration i"
"n $2", 67);
...
appendString(LOC1, ((NimStringDesc*) &TMP3010));
appendString(LOC1, LOC3);
appendString(LOC1, ((NimStringDesc*) &TMP3011));
appendString(LOC1, LOC4);
appendString(LOC1, ((NimStringDesc*) &TMP3012));
	result = LOC1;
	return result;
}
				...
				{
					{
						...
						message = nsuFormatOpenArray(((NimStringDesc*) &TMP3009), LOC17, 2);
