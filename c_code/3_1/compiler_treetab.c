...
static NIM_CONST TY171865 TMP3138 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3139, "ident", 5);
static NIM_CONST TY171865 TMP3140 = {
...
N_NIMCALL(void, nodetablerawinsert_223411)(tnodepairseq171715** data, NI k, tnode171659* key, NI val) {
	...
	nimln(72, "treetab.nim");
	{
		...
		nimln(72, "treetab.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP3154));	}	LA4: ;
...
N_NIMCALL(void, nodetableput_223605)(tnodetable171717* t, tnode171659* key, NI val) {
	...
	LA3: ;
	{
		nimln(85, "treetab.nim");
		{
			...
			n = (tnodepairseq171715*) newSeq((&NTI171715), (NI32)(TMP3156));
			i_223836 = 0;
			HEX3Atmp_223874 = 0;
...
N_NIMCALL(NI, nodetabletestorset_223881)(tnodetable171717* t, tnode171659* key, NI val) {
	...
	LA3: ;
	{
		nimln(102, "treetab.nim");
		{
			...
			n = (tnodepairseq171715*) newSeq((&NTI171715), (NI32)(TMP3157));
			i_224036 = 0;
			HEX3Atmp_224074 = 0;
