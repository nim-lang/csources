...
N_NIMCALL(NI, nodetablerawget_261159)(Tnodetable213852 t, NI k, Tnode213790* key);
N_NIMCALL(NIM_BOOL, treesequivalent_261076)(Tnode213790* a, Tnode213790* b);
...
N_NIMCALL(void, nodetablerawinsert_261189)(Tnodepairseq213850** data, NI k, Tnode213790* key, NI val);
	...
	{
		{
			...
			HEX3Atmp_261069 = (NI)(LOC30 - ((NI) 1));
			res_261072 = ((NI) 0);
			{
				while (1) {
					NI LOC33;
					if (!(res_261072 <= HEX3Atmp_261069)) goto LA32;
					i_261062 = res_261072;
					LOC33 = 0;
		...
		{
			{
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					HEX3Atmp_261152 = (NI)(LOC26 - ((NI) 1));
					res_261155 = ((NI) 0);
					{
						while (1) {
							if (!(res_261155 <= HEX3Atmp_261152)) goto LA28;
							i_261148 = res_261155;
							{
								NIM_BOOL LOC31;
								LOC31 = 0;
								LOC31 = treesequivalent_261076((*a).kindU.S6.sons->data[i_261148], (*b).kindU.S6.sons->data[i_261148]);
								if (!!(LOC31)) goto LA32;
								goto BeforeRet;
							}
							LA32: ;
	...
	h = (NI)(k & (t.data ? (t.data->Sup.len-1) : -1));
	{
		while (1) {
			if (!!((t.data->data[h].key == NIM_NIL))) goto LA2;
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = treesequivalent_261076(t.data->data[h].key, key);
				LA6: ;
				if (!LOC5) goto LA7;
				result = h;
				goto BeforeRet;
...
N_NIMCALL(NI, nodetabletestorset_261682)(Tnodetable213852* t, Tnode213790* key, NI val) {
	...
	index = nodetablerawget_261159((*t), k, key);
	{
	...
	LA3: ;
	{
				...
				res_261878 = ((NI) 0);
				{
					while (1) {
						...
						i_261838 = res_261878;
						{
							...
							nodetablerawinsert_261189((&n), (*t).data->data[i_261838].h, (*t).data->data[i_261838].key, (*t).data->data[i_261838].val);
						}
						LA16: ;
						res_261878 += ((NI) 1);
					} LA13: ;
		...
		LA9: ;
		nodetablerawinsert_261189((&(*t).data), k, key, val);
		result = val;
		(*t).counter += ((NI) 1);
	}
	LA1: ;
