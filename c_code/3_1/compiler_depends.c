...
N_NIMCALL(void, adddependencyaux_414019)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	appf_121085(&gdotgraph_414016, ((NimStringDesc*) &TMP7005), LOC1, 2);	popFrame();
}
static N_INLINE(NI, sonslen_172022)(tnode171659* n) {
	NI result;
...
N_NIMCALL(void, generatedot_414006)(NimStringDesc* project) {
	...
	LOC4 = 0;
	LOC4 = ropef_121079(((NimStringDesc*) &TMP7010), LOC1, 2);
...
NTI414011.flags = 2;
TMP7003[0].kind = 1;
TMP7003[0].offset = offsetof(tgen414011, Module);
TMP7003[0].typ = (&NTI171657);
TMP7003[0].name = "module";
NTI414011.node = &TMP7003[0];
NTI414013.size = sizeof(tgen414011*);
NTI414013.kind = 22;
NTI414013.base = (&NTI414011);
NTI414013.flags = 2;
NTI414013.marker = TMP7013;
}
