...
N_NIMCALL(NimStringDesc*, removetrailingdirsep_136410)(NimStringDesc* path) {
	...
	nimln(206, "options.nim");
	{
		...
		LOC3 = ((NU8)(path->data[(NI32)(TMP412)]) == (NU8)(47));
		LA4: ;
		if (!LOC3) goto LA5;
		...
		result = copyStrLast(path, 0, (NI32)(TMP413));
	}
	goto LA1;
	LA5: ;
	{
...
N_NIMCALL(void, libcandidates_137321)(NimStringDesc* s, TY10865** dest) {
	...
	nimln(346, "options.nim");
	TMP429 = addInt(le, 1);
	ri = nsuFindChar(s, 41, (NI32)(TMP429));
	nimln(347, "options.nim");
	{
		...
		nimln(348, "options.nim");
		TMP430 = subInt(le, 1);
		prefix = copyStrLast(s, 0, (NI32)(TMP430));
		nimln(349, "options.nim");
		nimln(349, "options.nim");
		nimln(349, "options.nim");
		TMP431 = addInt(ri, 1);
		suffix = copyStr(s, (NI32)(TMP431));
		middle_137332 = 0;
		HEX3Atmp_137351 = 0;
		...
		nimln(350, "options.nim");
		TMP433 = subInt(ri, 1);
		HEX3Atmp_137351 = copyStrLast(s, (NI32)(TMP432), (NI32)(TMP433));
		...
		nimln(259, "strutils.nim");
		{
			...
			while (1) {
				...
				middle_137332 = copyStrLast(HEX3Atmp_137351, first_137355, (NI32)(TMP435));
...
N_NIMCALL(NimStringDesc*, canondynlibname_137360)(NimStringDesc* s) {
	...
	nimln(358, "options.nim");
	{
		...
		result = copyStrLast(s, start, (NI32)(TMP438));
	}
	goto LA7;
	LA9: ;
	{
