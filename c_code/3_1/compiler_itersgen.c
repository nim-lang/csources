...
{	result0 = (Tnode293802*)0;
	...
	t0 = skiptypes_297099_850551059((*LOC19).typ, 2304);
	{
		...
		Tnode293802* LOC27;
		LOC22 = (NIM_BOOL)0;
		LOC22 = !(((*t0).kind == ((Ttypekind293244) 22) || (*t0).kind == ((Ttypekind293244) 21)));
		if (LOC22) goto LA23;
		LOC24 = (Ttype293840*)0;
	...
	LA25: ;
	LOC28 = (Tnode293802*)0;
	LOC28 = getbody_336227_1724185294((*iter0).kindU.S4.sym);
	body0 = liftitertoproc_441395_2538784801((*iter0).kindU.S4.sym, LOC28, t0);
	LOC29 = (Tnode293802*)0;
	LOC29 = HEX5BHEX5D_294238_850551059(n0, ((NI) 3));
	prc0 = newsym_294684_850551059(((Tsymkind293435) 12), (*LOC29).kindU.S5.ident, (*(*iter0).kindU.S4.sym).owner, (*(*iter0).kindU.S4.sym).info);
