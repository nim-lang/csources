...
N_NIMCALL(void, patternerror_276038)(tnode171659* n);
...
static N_INLINE(void, add_276044)(NimStringDesc** code, NU8 op);
...
N_NIMCALL(void, compileconstraints_276094)(tnode171659* p, NimStringDesc** result);
...
N_NIMCALL(tnode171659*, semnodekindconstraints_276393)(tnode171659* p);
...
N_NIMCALL(NU8, checkforsideeffects_276708)(tnode171659* n);
static N_INLINE(NIM_BOOL, isroutine_176860)(tsym171689* s);
N_NIMCALL(NU8, isassignable_276902)(tsym171689* owner, tnode171659* n);
...
static NIM_CONST TY171865 TMP3814 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3815, "strVal", 6);
static NIM_CONST TY171865 TMP3816 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3817, "sons", 4);
static NIM_CONST TY171865 TMP3818 = {
...
NIM_CONST TY75888 TMP3834 = {((NimStringDesc*) &TMP3835),
100}
;
NIM_CONST TY75888 TMP3836 = {((NimStringDesc*) &TMP3835),
107}
;
STRING_LITERAL(TMP3837, "p.Kind == nkCurlyExpr ", 22);
STRING_LITERAL(TMP3838, "parameter pattern too complex", 29);
static NIM_CONST TY171865 TMP3839 = {
...
N_NIMCALL(void, patternerror_276038)(tnode171659* n) {
	...
	localerror_138349((*n).Info, ((NU16) 1), LOC1);	popFrame();
}
static N_INLINE(void, add_276044)(NimStringDesc** code, NU8 op) {
...
N_NIMCALL(void, compileconstraints_276094)(tnode171659* p, NimStringDesc** result) {
	...
	case ((NU8) 32):
	{
		...
		nimln(59, "parampatterns.nim");
		{
			...
			if (((TMP3816[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3817));
			if ((NU)(0) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
			patternerror_276038((*p).kindU.S6.Sons->data[0]);			nimln(61, "parampatterns.nim");
			goto BeforeRet;
		}		LA4: ;
		...
		nimln(63, "parampatterns.nim");
		{
			...
			nimln(64, "parampatterns.nim");
			{
				...
				compileconstraints_276094((*p).kindU.S6.Sons->data[1], result);				nimln(66, "parampatterns.nim");
				if (((TMP3816[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3817));
				if ((NU)(2) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
				compileconstraints_276094((*p).kindU.S6.Sons->data[2], result);				nimln(67, "parampatterns.nim");
				add_276044(result, ((NU8) 2));			}			goto LA11;
			LA15: ;
			{
				NIM_BOOL LOC18;
				...
				if (((TMP3816[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3817));
				if ((NU)(1) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
				compileconstraints_276094((*p).kindU.S6.Sons->data[1], result);				nimln(70, "parampatterns.nim");
				if (((TMP3816[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3817));
				if ((NU)(2) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
				compileconstraints_276094((*p).kindU.S6.Sons->data[2], result);				nimln(71, "parampatterns.nim");
				add_276044(result, ((NU8) 3));			}			goto LA11;
			LA20: ;
			{
				nimln(73, "parampatterns.nim");
				patternerror_276038(p);			}			LA11: ;
		}		goto LA6;
		LA9: ;
		{
			NIM_BOOL LOC24;
			...
			if (((TMP3816[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3817));
			if ((NU)(1) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
			compileconstraints_276094((*p).kindU.S6.Sons->data[1], result);			nimln(76, "parampatterns.nim");
			add_276044(result, ((NU8) 4));		}		goto LA6;
		LA29: ;
		{
			nimln(78, "parampatterns.nim");
			patternerror_276038(p);		}		LA6: ;
	}	break;
	case ((NU8) 53):
	case ((NU8) 37):
	{
		nimln(80, "parampatterns.nim");
		{
			...
			if (((TMP3816[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3817));
			if ((NU)(0) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
			compileconstraints_276094((*p).kindU.S6.Sons->data[0], result);		}		goto LA33;
		LA36: ;
		{
			nimln(83, "parampatterns.nim");
			patternerror_276038(p);		}		LA33: ;
	}	break;
	case ((NU8) 2):
	{
		NimStringDesc* spec;
...
break;
		...
		LA40: ;
		{
			...
			add_276044(result, ((NU8) 6));		}		goto LA52;
		LA41: ;
		{
			nimln(88, "parampatterns.nim");
			add_276044(result, ((NU8) 7));		}		goto LA52;
		LA42: ;
		{
			nimln(89, "parampatterns.nim");
			add_276044(result, ((NU8) 5));		}		goto LA52;
		LA43: ;
		{
			nimln(90, "parampatterns.nim");
			add_276044(result, ((NU8) 8));		}		goto LA52;
		LA44: ;
		{
			nimln(91, "parampatterns.nim");
			add_276044(result, ((NU8) 9));		}		goto LA52;
		LA45: ;
		{
		...
		LA47: ;
		{
			...
			add_276044(result, ((NU8) 12));		}		goto LA52;
		LA48: ;
		{
			nimln(95, "parampatterns.nim");
			add_276044(result, ((NU8) 13));		}		goto LA52;
		LA49: ;
		{
			nimln(96, "parampatterns.nim");
			add_276044(result, ((NU8) 14));		}		goto LA52;
		LA50: ;
		{
			nimln(97, "parampatterns.nim");
			add_276044(result, ((NU8) 15));		}		goto LA52;
		LA51: ;
		{
			NU8 i_276308;
			NU8 res_276382;
			...
			nimln(826, "msgs.nim");
			{
				...
				nimln(826, "msgs.nim");
				LOC69 = 0;
				LOC69 = HEX24_138459(TMP3834);
				internalerror_138383(LOC69);			}			LA67: ;
			i_276308 = 0;
			...
			while (1) {
				nimln(1309, "system.nim");
				if (!(res_276382 <= ((NU8) 22))) goto LA70;
				nimln(1308, "system.nim");
				i_276308 = res_276382;
				nimln(102, "parampatterns.nim");
				{
					...
					nimln(102, "parampatterns.nim");
					LOC73 = 0;
					LOC73 = copyStr(reprEnum(i_276308, (&NTI171313)), 2);
					LOC74 = 0;
					LOC74 = nsuCmpIgnoreStyle(LOC73, spec);
					if (!(LOC74 == 0)) goto LA75;
					nimln(103, "parampatterns.nim");
					add_276044(result, ((NU8) 10));					nimln(104, "parampatterns.nim");
					nimln(104, "parampatterns.nim");
					nimln(104, "parampatterns.nim");
					(*result) = addChar((*result), ((NIM_CHAR) (((NI) (i_276308)))));
					nimln(105, "parampatterns.nim");
					goto BeforeRet;
				}				LA75: ;
				nimln(1311, "system.nim");
				res_276382 = addInt(res_276382, 1);
			} LA70: ;
			nimln(826, "msgs.nim");
			{
				NimStringDesc* LOC81;
				...
				nimln(826, "msgs.nim");
				LOC81 = 0;
				LOC81 = HEX24_138459(TMP3836);
				internalerror_138383(LOC81);			}			LA79: ;
			i_276365 = 0;
			nimln(1308, "system.nim");
			res_276387 = ((NU8) 0);
			nimln(1309, "system.nim");
			while (1) {
				nimln(1309, "system.nim");
				if (!(res_276387 <= ((NU8) 153))) goto LA82;
				nimln(1308, "system.nim");
				i_276365 = res_276387;
				nimln(109, "parampatterns.nim");
				{
					...
					nimln(109, "parampatterns.nim");
					LOC85 = 0;
					LOC85 = nsuCmpIgnoreStyle(reprEnum(i_276365, (&NTI171022)), spec);
					if (!(LOC85 == 0)) goto LA86;
					nimln(110, "parampatterns.nim");
					add_276044(result, ((NU8) 11));					nimln(111, "parampatterns.nim");
					nimln(111, "parampatterns.nim");
					nimln(111, "parampatterns.nim");
					(*result) = addChar((*result), ((NIM_CHAR) (((NI) (i_276365)))));
					nimln(112, "parampatterns.nim");
					goto BeforeRet;
				}				LA86: ;
				nimln(1311, "system.nim");
				res_276387 = addInt(res_276387, 1);
			} LA82: ;
			nimln(113, "parampatterns.nim");
			patternerror_276038(p);		}		LA52: ;
	}	break;
	default:
	{
		nimln(115, "parampatterns.nim");
		patternerror_276038(p);	}	break;
	}
	BeforeRet: ;	popFrame();
}
static N_INLINE(tcell38848*, usrtocell_42239)(void* usr) {
...
N_NIMCALL(tnode171659*, semnodekindconstraints_276393)(tnode171659* p) {
	...
	nimln(120, "parampatterns.nim");
	{
		...
		nimln(120, "parampatterns.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP3837));	}	LA3: ;
	nimln(121, "parampatterns.nim");
	result = newnodei_171940(((NU8) 20), (*p).Info);
	...
	nimln(124, "parampatterns.nim");
	{
		...
		LOC10 = 0;
		LOC10 = len_172102(p);
		HEX3Atmp_276695 = subInt(LOC10, 1);
		nimln(1308, "system.nim");
		res_276697 = 1;
		nimln(1309, "system.nim");
		while (1) {
			nimln(1309, "system.nim");
			if (!(res_276697 <= HEX3Atmp_276695)) goto LA11;
			nimln(1308, "system.nim");
			i_276647 = res_276697;
			nimln(126, "parampatterns.nim");
			if (((TMP3816[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3817));
			if ((NU)(i_276647) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!(((TMP3814[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3815));
			compileconstraints_276094((*p).kindU.S6.Sons->data[i_276647], &(*result).kindU.S3.Strval);			nimln(1311, "system.nim");
			res_276697 = addInt(res_276697, 1);
		} LA11: ;
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_138369((*p).Info, ((NimStringDesc*) &TMP3838));		}		LA14: ;
	}	goto LA5;
	LA8: ;
	{
		nimln(130, "parampatterns.nim");
		patternerror_276038(p);	}	LA5: ;
	nimln(131, "parampatterns.nim");
	if (!(((TMP3814[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3815));
	add_276044(&(*result).kindU.S3.Strval, ((NU8) 1));	popFrame();
	return result;
}
static N_INLINE(NIM_BOOL, isroutine_176860)(tsym171689* s) {
	NIM_BOOL result;
...
N_NIMCALL(NU8, checkforsideeffects_276708)(tnode171659* n) {
	...
	case ((NU8) 32):
	{
		...
		nimln(143, "parampatterns.nim");
		{
			...
			LOC4 = isroutine_176860((*op).kindU.S4.Sym);
			LA5: ;
			if (!LOC4) goto LA6;
		...
		LOC16 = 0;
		LOC16 = len_172102(n);
		HEX3Atmp_276883 = subInt(LOC16, 1);
		nimln(1308, "system.nim");
		res_276885 = 0;
		nimln(1309, "system.nim");
		while (1) {
			NU8 ret;
			nimln(1309, "system.nim");
			if (!(res_276885 <= HEX3Atmp_276883)) goto LA17;
			nimln(1308, "system.nim");
			i_276792 = res_276885;
			nimln(157, "parampatterns.nim");
			if (((TMP3816[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3817));
			if ((NU)(i_276792) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			ret = checkforsideeffects_276708((*n).kindU.S6.Sons->data[i_276792]);
			...
			LA18: ;
			nimln(1311, "system.nim");
			res_276885 = addInt(res_276885, 1);
		} LA17: ;
	}	break;
	case ((NU8) 0) ... ((NU8) 23):
	{
	...
	default:
	{
		...
		LOC29 = 0;
		LOC29 = len_172102(n);
		HEX3Atmp_276887 = subInt(LOC29, 1);
		nimln(1308, "system.nim");
		res_276889 = 0;
		nimln(1309, "system.nim");
		while (1) {
			NU8 ret;
			nimln(1309, "system.nim");
			if (!(res_276889 <= HEX3Atmp_276887)) goto LA30;
			nimln(1308, "system.nim");
			i_276846 = res_276889;
			nimln(166, "parampatterns.nim");
			if (((TMP3816[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3817));
			if ((NU)(i_276846) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			ret = checkforsideeffects_276708((*n).kindU.S6.Sons->data[i_276846]);
			...
			LA31: ;
			nimln(1311, "system.nim");
			res_276889 = addInt(res_276889, 1);
		} LA30: ;
	}	break;
	}
	BeforeRet: ;	popFrame();
...
N_NIMCALL(NU8, isassignable_276902)(tsym171689* owner, tnode171659* n) {
	...
	case ((NU8) 45):
	{
		nimln(192, "parampatterns.nim");
		{
			...
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC18 = 0;
			LOC18 = skiptypes_200120((*(*n).kindU.S6.Sons->data[0]).Typ, IL64(211106232576000));
		...
		LA19: ;
		{
			...
			if (((TMP3816[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3817));
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			result = isassignable_276902(owner, (*n).kindU.S6.Sons->data[0]);
		}		LA16: ;
	...
	case ((NU8) 42):
	{
		nimln(200, "parampatterns.nim");
		{
			...
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC31 = 0;
			LOC31 = skiptypes_200120((*(*n).kindU.S6.Sons->data[0]).Typ, IL64(211106232576000));
	...
	case ((NU8) 60):
	{
		nimln(208, "parampatterns.nim");
		{
			...
			nimln(208, "parampatterns.nim");
			LOC38 = 0;
			LOC38 = skiptypes_200120((*n).Typ, IL64(211106247256064));
			if (!((*LOC38).Kind == ((NU8) 27) || (*LOC38).Kind == ((NU8) 18) || (*LOC38).Kind == ((NU8) 17))) goto LA39;
			nimln(210, "parampatterns.nim");
			if (((TMP3816[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3817));
			if ((NU)(1) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			result = isassignable_276902(owner, (*n).kindU.S6.Sons->data[1]);
		}		goto LA36;
		LA39: ;
		{
			NIM_BOOL LOC42;
			...
			if ((NU)(1) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			LOC42 = 0;
			LOC42 = comparetypes_206524((*n).Typ, (*(*n).kindU.S6.Sons->data[1]).Typ, ((NU8) 1), 0);
			if (!LOC42) goto LA43;
...
N_NIMCALL(NIM_BOOL, matchnodekinds_277175)(tnode171659* p, tnode171659* n) {
	...
	while (1) {
		...
		case ((NU8) 2):
		{
			...
			nimln(239, "parampatterns.nim");
			TMP3841 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3841)) > (NU)(64)) raiseIndexError();
			nimln(239, "parampatterns.nim");
			LOC4 = 0;
			nimln(239, "parampatterns.nim");
			TMP3842 = subInt(sp, 1);
			if ((NU)((NI32)(TMP3842)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI32)(TMP3842))- 0];
			if (LOC4) goto LA5;
			nimln(239, "parampatterns.nim");
			TMP3843 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3843)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI32)(TMP3843))- 0];
			LA5: ;
			stack[((NI32)(TMP3841))- 0] = LOC4;
		...
		case ((NU8) 3):
		{
			...
			nimln(242, "parampatterns.nim");
			TMP3844 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3844)) > (NU)(64)) raiseIndexError();
			nimln(242, "parampatterns.nim");
			LOC7 = 0;
			nimln(242, "parampatterns.nim");
			TMP3845 = subInt(sp, 1);
			if ((NU)((NI32)(TMP3845)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI32)(TMP3845))- 0];
			if (!(LOC7)) goto LA8;
			nimln(242, "parampatterns.nim");
			TMP3846 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3846)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI32)(TMP3846))- 0];
			LA8: ;
			stack[((NI32)(TMP3844))- 0] = LOC7;
		...
		case ((NU8) 4):
		{
			...
			stack[((NI32)(TMP3847))- 0] = !(stack[((NI32)(TMP3848))- 0]);
		}		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(251, "parampatterns.nim");
			TMP3849 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3849)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3849)])), ((NU8) 0), ((NU8) 22)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			nimln(255, "parampatterns.nim");
			TMP3850 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3850)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3850)])), ((NU8) 0), ((NU8) 153)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 12):
		{
			...
			LOC20 = 0;
			LOC20 = isassignable_276902(NIM_NIL, n);
		...
		case ((NU8) 13):
		{
			...
			nimln(259, "parampatterns.nim");
			LOC22 = 0;
			LOC22 = isassignable_276902(NIM_NIL, n);
		...
		case ((NU8) 14):
		{
			...
			nimln(260, "parampatterns.nim");
			LOC24 = 0;
			LOC24 = checkforsideeffects_276708(n);
		...
		case ((NU8) 15):
		{
			...
			LOC26 = 0;
			LOC26 = checkforsideeffects_276708(n);
