...
typedef struct Timeouterror584412 Timeouterror584412;
...
N_NIMCALL(Socketimpl584404*, newsocket_584674_170061329)(int fd0, Domain578604 domain0, Socktype578606 socktype0, Protocol578608 protocol0, NIM_BOOL buffered0);
N_NIMCALL(void*, newObj)(TNimType* typ0, NI size0);
N_NIMCALL(void, setsockoptint_582835_466562973)(int socket0, NI level0, NI optname0, NI optval0);
...
N_NIMCALL(NI, send_589493_170061329)(Socketimpl584404* socket0, void* data0, NI size0);
N_NIMCALL(NIM_BOOL, isdisconnectionerror_584476_170061329)(Socketflag584414Set flags0, NI32 lasterror0);
N_NIMCALL(void, socketerror_584470_170061329)(Socketimpl584404* socket0, NI err0, NIM_BOOL async0, NI32 lasterror0);
N_NIMCALL(NI32, getsocketerror_585201_170061329)(Socketimpl584404* socket0);
N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src0);
N_NIMCALL(void, acceptaddr_586009_170061329)(Socketimpl584404* server0, Socketimpl584404** client0, NimStringDesc** address0, Socketflag584414Set flags0);
...
N_NIMCALL(NI, waitfor_588607_170061329)(Socketimpl584404* socket0, NF* waited0, NI timeout0, NI size0, NimStringDesc* funcname0);
...
N_NIMCALL(NI, select_588001_170061329)(Socketimpl584404* readfd0, NI timeout0);
N_NIMCALL(NIM_BOOL, hasdatabuffered_587801_170061329)(Socketimpl584404* s0);
...
N_NIMCALL(NI, recv_588216_170061329)(Socketimpl584404* socket0, void* data0, NI size0);
N_NIMCALL(NI, readintobuf_588023_170061329)(Socketimpl584404* socket0, NI32 flags0);
N_NIMCALL(NI, peekchar_589236_170061329)(Socketimpl584404* socket0, NIM_CHAR* c0);
...
TNimNode* NimDT_584404_isbuffered[3];
...
N_NIMCALL(Socketimpl584404*, newsocket_584674_170061329)(int fd0, Domain578604 domain0, Socktype578606 socktype0, Protocol578608 protocol0, NIM_BOOL buffered0) {
	Socketimpl584404* result0;
	result0 = (Socketimpl584404*)0;
	result0 = (Socketimpl584404*) newObj((&NTI584406), sizeof(Socketimpl584404));
	(*result0).fd = fd0;
	...
	LA3: ;
	setsockoptint_582835_466562973(fd0, ((NI) (SOL_SOCKET)), ((NI) (SO_NOSIGPIPE)), ((NI) 1));
	return result0;
}
...
N_NIMCALL(NI, send_589493_170061329)(Socketimpl584404* socket0, void* data0, NI size0) {
	NI result0;
	result0 = (NI)0;
	result0 = send((*socket0).fd, data0, ((NI) (((int) (size0)))), ((NI32) 0));
	return result0;
}
...
N_NIMCALL(NIM_BOOL, isdisconnectionerror_584476_170061329)(Socketflag584414Set flags0, NI32 lasterror0) {
	...
	result0 = (NIM_BOOL)0;
	LOC1 = (NIM_BOOL)0;
	LOC1 = ((flags0 &(1U<<((NU)(((Socketflag584414) 1))&7U)))!=0);
	if (!(LOC1)) goto LA2;
...
N_NIMCALL(void, send_589802_170061329)(Socketimpl584404* socket0, NimStringDesc* data0, Socketflag584414Set flags0) {
	NI sent0;
{	sent0 = send_589493_170061329(socket0, ((void*) (data0->data)), (data0 ? data0->Sup.len : 0));
	{
		NI32 lasterror0;
		...
		lasterror0 = oslasterror_130619_2125978480();
		{
			NIM_BOOL LOC7;
			LOC7 = (NIM_BOOL)0;
			LOC7 = isdisconnectionerror_584476_170061329(flags0, lasterror0);
			if (!LOC7) goto LA8;
			goto BeforeRet;
		}
		LA8: ;
		socketerror_584470_170061329(socket0, ((NI) -1), NIM_FALSE, lasterror0);
	}
	LA3: ;
	{
		NI32 LOC14;
...
N_NIMCALL(void, acceptaddr_586009_170061329)(Socketimpl584404* server0, Socketimpl584404** client0, NimStringDesc** address0, Socketflag584414Set flags0) {
	...
	sock0 = accept((*server0).fd, ((struct sockaddr*) ((&sockaddress0))), (&addrlen0));
	{
		...
		err0 = oslasterror_130619_2125978480();
		{
			NIM_BOOL LOC7;
			LOC7 = (NIM_BOOL)0;
			LOC7 = isdisconnectionerror_584476_170061329(flags0, err0);
			if (!LOC7) goto LA8;
...
N_NIMCALL(void, T170061329_8)(void* p, NI op) {
	Timeouterror584412* a;
	a = (Timeouterror584412*)p;
...
{	result0 = (NI)0;
	...
	LA15: ;
	{
		...
		NF LOC33;
		{
			Timeouterror584412* e_588813_170061329;
			NimStringDesc* LOC22;
			if (!((NI)(timeout0 - ((NI) (((NF)((*waited0)) * (NF)(1.0000000000000000e+03))))) < ((NI) 1))) goto LA20;
			e_588813_170061329 = (Timeouterror584412*)0;
			e_588813_170061329 = (Timeouterror584412*) newObj((&NTI588814), sizeof(Timeouterror584412));
			(*e_588813_170061329).Sup.Sup.m_type = (&NTI584412);
...
appendString(LOC22, ((NimStringDesc*) &T170061329_10));
		...
		LA25: ;
		{
			Timeouterror584412* e_589006_170061329;
			NimStringDesc* LOC32;
			if (!!((selret0 == ((NI) 1)))) goto LA30;
			e_589006_170061329 = (Timeouterror584412*)0;
			e_589006_170061329 = (Timeouterror584412*) newObj((&NTI588814), sizeof(Timeouterror584412));
			(*e_589006_170061329).Sup.Sup.m_type = (&NTI584412);
...
{	waited0 = 0.0;
	(*line0) = setLengthStr((*line0), ((NI) 0));
	{
		while (1) {
			...
			c0 = (NIM_CHAR)0;
			LOC3 = (NI)0;
			LOC3 = waitfor_588607_170061329(socket0, (&waited0), timeout0, ((NI) 1), ((NimStringDesc*) &T170061329_11));
			n0 = recv_588216_170061329(socket0, ((void*) ((&c0))), ((NI) 1));
			{
				...
				lasterror0 = getsocketerror_585201_170061329(socket0);
				{
					NIM_BOOL LOC10;
					LOC10 = (NIM_BOOL)0;
					LOC10 = isdisconnectionerror_584476_170061329(flags0, lasterror0);
					if (!LOC10) goto LA11;
					(*line0) = setLengthStr((*line0), ((NI) 0));
					goto BeforeRet;
				}
				LA11: ;
				socketerror_584470_170061329(socket0, n0, NIM_FALSE, lasterror0);
			}
			goto LA4;
			LA6: ;
			{
			...
			LA4: ;
			{
				...
				LOC20 = (NI)0;
				LOC20 = waitfor_588607_170061329(socket0, (&waited0), timeout0, ((NI) 1), ((NimStringDesc*) &T170061329_11));
				...
				LA25: ;
				{
					...
					lasterror0 = getsocketerror_585201_170061329(socket0);
					{
						NIM_BOOL LOC33;
						LOC33 = (NIM_BOOL)0;
						LOC33 = isdisconnectionerror_584476_170061329(flags0, lasterror0);
						if (!LOC33) goto LA34;
						(*line0) = setLengthStr((*line0), ((NI) 0));
						goto BeforeRet;
					}
...
N_NIMCALL(void, close_586611_170061329)(Socketimpl584404* socket0) {
	...
	T170061329_13.status = _setjmp(T170061329_13.context);
...
NTI584404.size = sizeof(Socketimpl584404);
NTI584404.kind = 18;
NTI584404.base = 0;
NTI584404.flags = 3;
T170061329_2[0] = &T170061329_0[1];
T170061329_0[1].kind = 1;
T170061329_0[1].offset = offsetof(Socketimpl584404, fd);
T170061329_0[1].typ = (&NTI7408);
T170061329_0[1].name = "fd";
T170061329_2[1] = &T170061329_0[2];
T170061329_0[2].kind = 3;
T170061329_0[2].offset = offsetof(Socketimpl584404, isbuffered);
T170061329_0[2].typ = (&NTI130);
T170061329_0[2].name = "isBuffered";
T170061329_0[2].sons = &NimDT_584404_isbuffered[0];
T170061329_0[2].len = 2;
T170061329_3[0] = &T170061329_0[4];
NTI584418.size = sizeof(TY584418);
NTI584418.kind = 16;
NTI584418.base = (&NTI136);
NTI584418.flags = 3;
T170061329_0[4].kind = 1;
T170061329_0[4].offset = offsetof(Socketimpl584404, isbufferedU.S1.buffer);
T170061329_0[4].typ = (&NTI584418);
T170061329_0[4].name = "buffer";
T170061329_3[1] = &T170061329_0[5];
T170061329_0[5].kind = 1;
T170061329_0[5].offset = offsetof(Socketimpl584404, isbufferedU.S1.currpos);
T170061329_0[5].typ = (&NTI104);
T170061329_0[5].name = "currPos";
T170061329_3[2] = &T170061329_0[6];
T170061329_0[6].kind = 1;
T170061329_0[6].offset = offsetof(Socketimpl584404, isbufferedU.S1.buflen);
...
NTI584404.node = &T170061329_0[0];
NTI584406.size = sizeof(Socketimpl584404*);
NTI584406.kind = 22;
NTI584406.base = (&NTI584404);
NTI584406.flags = 2;
NTI584406.marker = T170061329_4;
NTI584412.size = sizeof(Timeouterror584412);
NTI584412.kind = 17;
NTI584412.base = (&NTI3624);
T170061329_0[12].len = 0; T170061329_0[12].kind = 2;
NTI584412.node = &T170061329_0[12];
NTI588814.size = sizeof(Timeouterror584412*);
NTI588814.kind = 22;
NTI588814.base = (&NTI584412);
