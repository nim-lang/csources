...
N_NIMCALL(void, TMP2673)(void* p, NI op);
...
NIM_CONST TY195485 msgkindtostr_195484 = {((NimStringDesc*) &TMP154),
...
NIM_CONST TY84735 TMP1042 = {((NimStringDesc*) &TMP1043),
865}
;
STRING_LITERAL(TMP1972, "\015\012", 2);
STRING_LITERAL(TMP2674, "suggest done", 12);
NIM_CONST TY84735 TMP3581 = {((NimStringDesc*) &TMP1043),
872}
;
...
static N_INLINE(void, writeln_170205)(FILE* f_170209, NimStringDesc** x_170213, NI x_170213Len0) {
	...
	write_12865(f_170209, ((NimStringDesc*) &TMP150));
}
		...
		res_197626 = 0;
		{
			while (1) {
				...
				i_197617 = res_197626;
				{
					...
					LOC12[3] = getmessagestr_197388(((NU16) 184), ((NimStringDesc*) &TMP142));
					LOC13 = 0;
		...
		if (TMP1032.status == 0) {
			{
				...
				f_198142 = open_12617(HEX3Atmp_198139, ((NU8) 0), 8000);
...
appendString(LOC12, ((NimStringDesc*) &TMP1972));
...
N_NIMCALL(void, clearbufferedmsgs_196449)(void) {
	genericSeqAssign(&bufferedmsgs_196438, NIM_NIL, (&NTI119608));
}
N_NIMCALL(void, TMP2673)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_196846)(void) {
	...
	LA3: ;
	{
		...
		LOC8 = 0;
		LOC8 = (*e_196850).Sup.message; (*e_196850).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2674));
...
NIM_EXTERNC N_NOINLINE(void, HEX00_msgsInit)(void) {
	...
	memset((void*)&LOC1, 0, sizeof(LOC1));
	newfileinfo_195702(((NimStringDesc*) &TMP142), ((NimStringDesc*) &TMP144), &LOC1);
	fileinfos_195642 = (TY195621*) incrSeq(&(fileinfos_195642)->Sup, sizeof(tfileinfo195537));
	...
	memset((void*)&LOC2, 0, sizeof(LOC2));
	newfileinfo_195702(((NimStringDesc*) &TMP142), ((NimStringDesc*) &TMP145), &LOC2);
	fileinfos_195642 = (TY195621*) incrSeq(&(fileinfos_195642)->Sup, sizeof(tfileinfo195537));
	...
	LOC3.ClPrc = ((TMP432) (HEX3Aanonymous_198178)); LOC3.ClEnv = NIM_NIL;
...
static TNimNode* TMP1964[275];
NI TMP1966;
static char* NIM_CONST TMP1965[275] = {
"errUnknown", 
"errIllFormedAstX", 
"errInternal", 
"errCannotOpenFile", 
...
TMP138[0] = &TMP19[1];
TMP19[1].kind = 1;
TMP19[1].offset = offsetof(tfileinfo195537, Fullpath);
TMP19[1].typ = (&NTI149);
TMP19[1].name = "fullPath";
TMP138[1] = &TMP19[2];
TMP19[2].kind = 1;
TMP19[2].offset = offsetof(tfileinfo195537, Projpath);
TMP19[2].typ = (&NTI149);
TMP19[2].name = "projPath";
TMP138[2] = &TMP19[3];
TMP19[3].kind = 1;
TMP19[3].offset = offsetof(tfileinfo195537, Shortname);
TMP19[3].typ = (&NTI149);
TMP19[3].name = "shortName";
TMP138[3] = &TMP19[4];
TMP19[4].kind = 1;
TMP19[4].offset = offsetof(tfileinfo195537, Quotedname);
...
NTI195552.flags = 2;
NTI195552.marker = TMP139;
TMP19[5].kind = 1;
TMP19[5].offset = offsetof(tfileinfo195537, Lines);
TMP19[5].typ = (&NTI195552);
TMP19[5].name = "lines";
TMP19[0].len = 5; TMP19[0].kind = 2; TMP19[0].sons = &TMP138[0];
NTI195537.node = &TMP19[0];
NTI195621.size = sizeof(TY195621*);
NTI195621.kind = 24;
NTI195621.base = (&NTI195537);
NTI195621.flags = 2;
NTI195621.marker = TMP140;
...
TMP146[0] = &TMP19[7];
TMP19[7].kind = 1;
TMP19[7].offset = offsetof(tlineinfo195539, Line);
TMP19[7].typ = (&NTI112);
TMP19[7].name = "line";
TMP146[1] = &TMP19[8];
TMP19[8].kind = 1;
TMP19[8].offset = offsetof(tlineinfo195539, Col);
TMP19[8].typ = (&NTI112);
TMP19[8].name = "col";
TMP146[2] = &TMP19[9];
TMP19[9].kind = 1;
TMP19[9].offset = offsetof(tlineinfo195539, Fileindex);
TMP19[9].typ = (&NTI114);
TMP19[9].name = "fileIndex";
TMP19[6].len = 3; TMP19[6].kind = 2; TMP19[6].sons = &TMP146[0];
NTI195539.node = &TMP19[6];
NTI196414.size = sizeof(TY196414*);
NTI196414.kind = 24;
NTI196414.base = (&NTI195539);
NTI196414.flags = 2;
NTI196414.marker = TMP147;
NTI195545.size = sizeof(erecoverableerror195545);
NTI195545.kind = 17;
NTI195545.base = (&NTI3249);
TMP19[10].len = 0; TMP19[10].kind = 2;
NTI195545.node = &TMP19[10];
NTI196253.size = sizeof(erecoverableerror195545*);
NTI196253.kind = 22;
NTI196253.base = (&NTI195545);
NTI196253.marker = TMP429;
NTI195205.size = sizeof(NU16);
NTI195205.kind = 14;
NTI195205.base = 0;
NTI195205.flags = 3;
for (TMP1966 = 0; TMP1966 < 275; TMP1966++) {
TMP19[TMP1966+11].kind = 1;
TMP19[TMP1966+11].offset = TMP1966;
TMP19[TMP1966+11].name = TMP1965[TMP1966];
TMP1964[TMP1966] = &TMP19[TMP1966+11];
}
TMP19[286].len = 275; TMP19[286].kind = 2; TMP19[286].sons = &TMP1964[0];
NTI195205.node = &TMP19[286];
