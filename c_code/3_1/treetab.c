...
static N_INLINE(NI, nexttry_200192)(NI h, NI maxhash) {
	...
	nimln(465, "astalgo.nim");
	TMP3203 = mulInt(5, h);
	TMP3204 = addInt((NI32)(TMP3203), 1);
	result = (NI)((NI32)(TMP3204) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(NI, nodetabletestorset_251928)(tnodetable191871* t, tnode191813* key, NI val) {
	...
	LA3: ;
	{
		nimln(102, "treetab.nim");
		{
			...
			n = (tnodepairseq191869*) newSeq((&NTI191869), (NI32)(TMP3208));
			i_252068 = 0;
			HEX3Atmp_252121 = 0;
