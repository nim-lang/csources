...
N_NOINLINE(void, raiserecoverableerror_182060)(NimStringDesc* msg) __attribute__((noreturn));
...
Tlineinfo181337 gcmdlineinfo_182046;
Tlineinfo181337 gcodegenlineinfo_182058;
NU64 gnotes_182080;
NI gerrorcounter_182081;
NI ghintcounter_182082;
NI gwarncounter_182083;
NI gerrormax_182084;
TY182093* msgcontext_182110;
TNimType NTI181337; /* TLineInfo */
extern TNimType NTI108; /* int16 */
extern TNimType NTI110; /* int32 */
TNimType NTI182093; /* seq[TLineInfo] */
Tlineinfo181337 lasterror_182111;
NU8 erroroutputs_182113;
TY182114 writelnhook_182117;
...
TNimType NTI182067; /* ref ERecoverableError */
...
TNimType NTI182164; /* ref ESuggestDone */
N_NIMCALL(void, TMP144)(void* p, NI op) {
	TY181350* a;
	NI LOC1;
	a = (TY181350*)p;
...
N_NIMCALL(void, writecontext_183130)(Tlineinfo181337 lastinfo) {
	...
	info = lastinfo;
	{
		...
		i_183153 = 0;
		HEX3Atmp_183606 = 0;
		HEX3Atmp_183606 = (NI)((msgcontext_182110 ? msgcontext_182110->Sup.len : 0) - ((NI) 1));
		res_183609 = ((NI) 0);
		{
			while (1) {
				...
				i_183153 = res_183609;
				{
					...
					LOC6 = 0;
					LOC7 = 0;
					LOC7 = HEX3DHEX3D_183125(msgcontext_182110->data[i_183153], lastinfo);
					LOC6 = !(LOC7);
					if (!(LOC6)) goto LA8;
					LOC9 = 0;
					LOC9 = HEX3DHEX3D_183125(msgcontext_182110->data[i_183153], info);
					LOC6 = !(LOC9);
					LA8: ;
					if (!LOC6) goto LA10;
					{
						NimStringDesc* s_183172;
						if (!!(writelnhook_182117.ClPrc == 0)) goto LA14;
						s_183172 = copyString(((NimStringDesc*) &TMP147));
						{
							...
							i_183605 = ((NI) 0);
							{
								while (1) {
									...
									LOC20[0] = tomsgfilename_182411(msgcontext_182110->data[i_183153]);
									LOC20[1] = coordtostr_182739(((NI) (msgcontext_182110->data[i_183153].line)));
									LOC20[2] = coordtostr_182739(((NI) ((NI16)(msgcontext_182110->data[i_183153].col + ((NI16) 1)))));
...
appendString(s_183172, arg_183174);
						...
						writelnhook_182117.ClEnv? writelnhook_182117.ClPrc(s_183172, writelnhook_182117.ClEnv):((TMP429)(writelnhook_182117.ClPrc))(s_183172);
					}
					goto LA12;
					LA14: ;
					{
						if (!((gglobaloptions_159121 &(1U<<((NU)(((NU8) 23))&31U)))!=0)) goto LA22;
						{
							TY183169 LOC28;
							TY183156 LOC29;
							if (!((erroroutputs_182113 &(1U<<((NU)(((NU8) 0))&7U)))!=0)) goto LA26;
							memset((void*)LOC28, 0, sizeof(LOC28));
							memset((void*)LOC29, 0, sizeof(LOC29));
							LOC29[0] = tomsgfilename_182411(msgcontext_182110->data[i_183153]);
							LOC29[1] = coordtostr_182739(((NI) (msgcontext_182110->data[i_183153].line)));
							LOC29[2] = coordtostr_182739(((NI) ((NI16)(msgcontext_182110->data[i_183153].col + ((NI16) 1)))));
					...
					{
						{
							if (!((erroroutputs_182113 &(1U<<((NU)(((NU8) 1))&7U)))!=0)) goto LA33;
							{
								TY183156 LOC39;
								NimStringDesc* LOC40;
								NimStringDesc* LOC41;
								...
								LOC39[0] = tomsgfilename_182411(msgcontext_182110->data[i_183153]);
								LOC39[1] = coordtostr_182739(((NI) (msgcontext_182110->data[i_183153].line)));
								LOC39[2] = coordtostr_182739(((NI) ((NI16)(msgcontext_182110->data[i_183153].col + ((NI16) 1)))));
								LOC40 = 0;
							...
							LA37: ;
							{
								...
								LOC44[0] = tomsgfilename_182411(msgcontext_182110->data[i_183153]);
								LOC44[1] = coordtostr_182739(((NI) (msgcontext_182110->data[i_183153].line)));
								LOC44[2] = coordtostr_182739(((NI) ((NI16)(msgcontext_182110->data[i_183153].col + ((NI16) 1)))));
				...
				LA10: ;
				info = msgcontext_182110->data[i_183153];
				res_183609 += ((NI) 1);
			} LA3: ;
		}
	}
...
N_NIMCALL(void, quit_182759)(NU16 msg) {
	{
		...
		LOC3 = LOC4;
		if (LOC3) goto LA6;
		LOC3 = ((gnotes_182080 &((NU64)1<<((NU)((((NU16) 288)- 237))&63U)))!=0);
		LA6: ;
		if (!LOC3) goto LA7;
		{
			NIM_BOOL LOC11;
			...
			if (!(LOC11)) goto LA12;
			LOC11 = writelnhook_182117.ClPrc == 0;
			LA12: ;
			if (!LOC11) goto LA13;
		...
		{
			{
				...
				if (!!(writelnhook_182117.ClPrc == 0)) goto LA18;
...
appendString(s_182803, arg_182805);
				...
				writelnhook_182117.ClEnv? writelnhook_182117.ClPrc(s_182803, writelnhook_182117.ClEnv):((TMP502)(writelnhook_182117.ClPrc))(s_182803);
			}
			goto LA16;
			LA18: ;
			{
				if (!((gglobaloptions_159121 &(1U<<((NU)(((NU8) 23))&31U)))!=0)) goto LA26;
				{
					TY182752 LOC32;
					NimStringDesc* LOC33;
					if (!((erroroutputs_182113 &(1U<<((NU)(((NU8) 0))&7U)))!=0)) goto LA30;
...
appendString(LOC33, ((NimStringDesc*) &TMP501));
			...
			{
				{
					if (!((erroroutputs_182113 &(1U<<((NU)(((NU8) 1))&7U)))!=0)) goto LA37;
					{
						NimStringDesc* LOC43;
...
N_NOINLINE(void, raiserecoverableerror_182060)(NimStringDesc* msg) {
	Erecoverableerror181343* e_182066;
	NimStringDesc* LOC1;
	e_182066 = 0;
	e_182066 = (Erecoverableerror181343*) newObj((&NTI182067), sizeof(Erecoverableerror181343));
	(*e_182066).Sup.Sup.Sup.m_type = (&NTI181343);
	LOC1 = 0;
	LOC1 = (*e_182066).Sup.Sup.message; (*e_182066).Sup.Sup.message = copyStringRC1(msg);
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_182066, "ERecoverableError");
}
...
N_NIMCALL(void, handleerror_183039)(NU16 msg, NU8 eh, NimStringDesc* s) {
	...
	LA5: ;
	{
		...
		LA14: ;
		if (!LOC13) goto LA15;
		gerrorcounter_182081 += ((NI) 1);
		gexitcode_159122 = ((NI8) 1);
		{
			if (!(gerrormax_182084 <= gerrorcounter_182081)) goto LA19;
			quit_182759(msg);
		}
		goto LA17;
		LA19: ;
		...
		LA24: ;
		{
			...
			raiserecoverableerror_182060(s);
		}
		goto LA17;
		LA27: ;
		LA17: ;
...
{	title = 0;
	...
	case ((NU16) 237) ... ((NU16) 267):
	{
		...
		LA6: ;
		{
			if (!!(((gnotes_182080 &((NU64)1<<((NU)((((NU16) (msg))- 237))&63U)))!=0))) goto LA10;
			goto BeforeRet;
		}
		LA10: ;
	...
	case ((NU16) 268) ... ((NU16) 290):
	{
		...
		LA16: ;
		{
			if (!!(((gnotes_182080 &((NU64)1<<((NU)((((NU16) (msg))- 237))&63U)))!=0))) goto LA20;
			goto BeforeRet;
		}
		LA20: ;
	...
	s_183747 = nsuFormatOpenArray(LOC22, args, argsLen0);
	{
		...
		if (!!(LOC25)) goto LA26;
		{
			if (!!((kind == NIM_NIL))) goto LA30;
			{
				...
				if (!!(writelnhook_182117.ClPrc == 0)) goto LA34;
...
appendString(s_183765, arg_183767);
				...
				writelnhook_182117.ClEnv? writelnhook_182117.ClPrc(s_183765, writelnhook_182117.ClEnv):((TMP492)(writelnhook_182117.ClPrc))(s_183765);
			}
			goto LA32;
			LA34: ;
			{
				...
				{
					TY183156 LOC47;
					if (!((erroroutputs_182113 &(1U<<((NU)(((NU8) 0))&7U)))!=0)) goto LA45;
			...
			{
				{
					if (!((erroroutputs_182113 &(1U<<((NU)(((NU8) 1))&7U)))!=0)) goto LA51;
					{
						NimStringDesc* LOC57;
		...
		{
			{
				...
				if (!!(writelnhook_182117.ClPrc == 0)) goto LA63;
...
appendString(s_184217, arg_184219);
				...
				writelnhook_182117.ClEnv? writelnhook_182117.ClPrc(s_184217, writelnhook_182117.ClEnv):((TMP493)(writelnhook_182117.ClPrc))(s_184217);
			}
			goto LA61;
			LA63: ;
			{
				...
				{
					TY183169 LOC76;
					if (!((erroroutputs_182113 &(1U<<((NU)(((NU8) 0))&7U)))!=0)) goto LA74;
			...
			{
				{
					if (!((erroroutputs_182113 &(1U<<((NU)(((NU8) 1))&7U)))!=0)) goto LA80;
					{
...
N_NIMCALL(void, msgwriteln_182449)(NimStringDesc* s, NU8 flags) {
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = !(writelnhook_182117.ClPrc == 0);
		if (!(LOC3)) goto LA4;
		LOC3 = !(((flags &(1U<<((NU)(((NU8) 1))&7U)))!=0));
		LA4: ;
		if (!LOC3) goto LA5;
		writelnhook_182117.ClEnv? writelnhook_182117.ClPrc(s, writelnhook_182117.ClEnv):((TMP1051)(writelnhook_182117.ClPrc))(s);
	}
	goto LA1;
	LA5: ;
	{
		...
		{
			TY182752 LOC16;
			if (!((erroroutputs_182113 &(1U<<((NU)(((NU8) 0))&7U)))!=0)) goto LA14;
	...
	LA10: ;
	{
		{
			TY182752 LOC22;
			if (!((erroroutputs_182113 &(1U<<((NU)(((NU8) 1))&7U)))!=0)) goto LA20;
		...
		if (TMP1053.status == 0) {
			{
				...
				line_186173 = 0;
				HEX3Atmp_186411 = 0;
				HEX3Atmp_186411 = tofullpath_182269(i.fileindex);
...
N_NIMCALL(void, limessage_184658)(Tlineinfo181337 info, NU16 msg, NimStringDesc* arg, NU8 eh) {
	...
	case ((NU16) 237) ... ((NU16) 267):
	{
		...
		if (LOC3) goto LA4;
		LOC3 = !(((gnotes_182080 &((NU64)1<<((NU)((((NU16) (msg))- 237))&63U)))!=0));
		LA4: ;
		ignoremsg = LOC3;
		{
	...
	case ((NU16) 268) ... ((NU16) 290):
	{
		...
		if (LOC10) goto LA11;
		LOC10 = !(((gnotes_182080 &((NU64)1<<((NU)((((NU16) (msg))- 237))&63U)))!=0));
		LA11: ;
		ignoremsg = LOC10;
		title = copyString(((NimStringDesc*) &TMP468));
		color = ((NU8) 32);
	...
	s_184765 = getmessagestr_182747(msg, arg);
	{
		...
		if (!LOC15) goto LA18;
		{
			if (!!((kind == NIM_NIL))) goto LA22;
			{
				...
				if (!!(writelnhook_182117.ClPrc == 0)) goto LA26;
...
appendString(s_184784, arg_184786);
				...
				writelnhook_182117.ClEnv? writelnhook_182117.ClPrc(s_184784, writelnhook_182117.ClEnv):((TMP1049)(writelnhook_182117.ClPrc))(s_184784);
			}
			goto LA24;
			LA26: ;
			{
				...
				{
					TY184781 LOC39;
					if (!((erroroutputs_182113 &(1U<<((NU)(((NU8) 0))&7U)))!=0)) goto LA37;
					memset((void*)LOC39, 0, sizeof(LOC39));
			...
			{
				{
					if (!((erroroutputs_182113 &(1U<<((NU)(((NU8) 1))&7U)))!=0)) goto LA43;
					{
						NimStringDesc* LOC49;
		...
		{
			{
				...
				if (!!(writelnhook_182117.ClPrc == 0)) goto LA55;
...
appendString(s_185418, arg_185420);
				...
				writelnhook_182117.ClEnv? writelnhook_182117.ClPrc(s_185418, writelnhook_182117.ClEnv):((TMP1050)(writelnhook_182117.ClPrc))(s_185418);
			}
			goto LA53;
			LA55: ;
			{
				...
				{
					TY183156 LOC68;
					if (!((erroroutputs_182113 &(1U<<((NU)(((NU8) 0))&7U)))!=0)) goto LA66;
					memset((void*)LOC68, 0, sizeof(LOC68));
			...
			{
				{
					if (!((erroroutputs_182113 &(1U<<((NU)(((NU8) 1))&7U)))!=0)) goto LA72;
					{
		...
		LA20: ;
		{
			...
			if (!(LOC82)) goto LA84;
			LOC82 = ((gnotes_182080 &((NU64)1<<((NU)((((NU16) 287)- 237))&63U)))!=0);
			LA84: ;
			if (!LOC82) goto LA85;
	...
	msgwriteln_182449(((NimStringDesc*) &TMP1931), 0);
	{
		...
		res_186648 = ((NI) 237);
		{
			while (1) {
				...
				{
					if (!((gnotes_182080 &((NU64)1<<((NU)((((NU16) (warn_186614))- 237))&63U)))!=0)) goto LA7;
	...
	msgwriteln_182449(((NimStringDesc*) &TMP1993), 0);
	{
		...
		res_186696 = ((NI) 268);
		{
			while (1) {
				...
				memset((void*)LOC4, 0, sizeof(LOC4));
				{
					if (!((gnotes_182080 &((NU64)1<<((NU)((((NU16) (hint_186662))- 237))&63U)))!=0)) goto LA7;
					LOC4[0] = copyString(((NimStringDesc*) &TMP1933));
				}
				goto LA5;
				LA7: ;
...
N_NIMCALL(void, suggestwriteln_182120)(NimStringDesc* s) {
	{
		if (!((erroroutputs_182113 &(1U<<((NU)(((NU8) 0))&7U)))!=0)) goto LA3;
		{
			TY182752 LOC9;
			if (!writelnhook_182117.ClPrc == 0) goto LA7;
		...
		LA7: ;
		{
			writelnhook_182117.ClEnv? writelnhook_182117.ClPrc(s, writelnhook_182117.ClEnv):((TMP2097)(writelnhook_182117.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, pushinfocontext_182209)(Tlineinfo181337 info) {
	msgcontext_182110 = (TY182093*) incrSeqV2(&(msgcontext_182110)->Sup, sizeof(Tlineinfo181337));
	msgcontext_182110->data[msgcontext_182110->Sup.len] = info;
	++msgcontext_182110->Sup.len;
}

N_NIMCALL(void, popinfocontext_182222)(void) {
	msgcontext_182110 = (TY182093*) setLengthSeq(&(msgcontext_182110)->Sup, sizeof(Tlineinfo181337), ((NI) ((NI)((msgcontext_182110 ? msgcontext_182110->Sup.len : 0) - ((NI) 1)))));
}
N_NIMCALL(void, TMP2821)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_182158)(void) {
	Esuggestdone181345* e_182163;
	NimStringDesc* LOC1;
	e_182163 = 0;
	e_182163 = (Esuggestdone181345*) newObj((&NTI182164), sizeof(Esuggestdone181345));
	(*e_182163).Sup.Sup.m_type = (&NTI181345);
	LOC1 = 0;
	LOC1 = (*e_182163).Sup.message; (*e_182163).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2822));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_182163, "ESuggestDone");
}
...
N_NIMCALL(Tlineinfo181337, getinfocontext_182242)(NI index) {
	...
	NI i;
	memset((void*)(&result), 0, sizeof(result));
	L = (msgcontext_182110 ? msgcontext_182110->Sup.len : 0);
	{
	...
	LA1: ;
	{
		...
		result = unknownlineinfo_182090();
	}
	goto LA6;
	LA8: ;
	{
		result = msgcontext_182110->data[i];
	}
	LA6: ;
	return result;
}
...
N_NIMCALL(NI, getinfocontextlen_182185)(void) {
	NI result;
{	result = 0;
	result = (msgcontext_182110 ? msgcontext_182110->Sup.len : 0);
	goto BeforeRet;
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, setinfocontextlen_182196)(NI L) {
	msgcontext_182110 = (TY182093*) setLengthSeq(&(msgcontext_182110)->Sup, sizeof(Tlineinfo181337), ((NI) (L)));
}
...
NIM_EXTERNC N_NOINLINE(void, compiler_msgsInit000)(void) {
	...
	++fileinfos_181629->Sup.len;
	gcmdlineinfo_182046 = newlineinfo_182024(((NI32) 0), ((NI) 1), ((NI) 1));
	memset((void*)(&LOC2), 0, sizeof(LOC2));
	...
	++fileinfos_181629->Sup.len;
	gcodegenlineinfo_182058 = newlineinfo_182024(((NI32) 1), ((NI) 1), ((NI) 1));
	gnotes_182080 = 0;
	LOC3 = 0;
	for (LOC3 = (((NU16) 237)- 237); LOC3 <= (((NU16) 255)- 237); LOC3++) 
gnotes_182080 |=((NU64)(1)<<((LOC3)%(sizeof(NU64)*8)));
	gnotes_182080 |=((NU64)(1)<<(((((NU16) 257)- 237))%(sizeof(NU64)*8)));
	gnotes_182080 |=((NU64)(1)<<(((((NU16) 261)- 237))%(sizeof(NU64)*8)));
	LOC4 = 0;
	for (LOC4 = (((NU16) 263)- 237); LOC4 <= (((NU16) 276)- 237); LOC4++) 
gnotes_182080 |=((NU64)(1)<<((LOC4)%(sizeof(NU64)*8)));
	LOC5 = 0;
	for (LOC5 = (((NU16) 281)- 237); LOC5 <= (((NU16) 283)- 237); LOC5++) 
gnotes_182080 |=((NU64)(1)<<((LOC5)%(sizeof(NU64)*8)));
	gnotes_182080 |=((NU64)(1)<<(((((NU16) 285)- 237))%(sizeof(NU64)*8)));
	gnotes_182080 |=((NU64)(1)<<(((((NU16) 290)- 237))%(sizeof(NU64)*8)));
	gerrorcounter_182081 = ((NI) 0);
	ghintcounter_182082 = ((NI) 0);
	gwarncounter_182083 = ((NI) 0);
	gerrormax_182084 = ((NI) 1);
	if (msgcontext_182110) nimGCunrefNoCycle(msgcontext_182110);
	msgcontext_182110 = (TY182093*) newSeqRC1((&NTI182093), 0);
	lasterror_182111 = unknownlineinfo_182090();
	erroroutputs_182113 = 3;
	memset((void*)(&LOC6), 0, sizeof(LOC6));
...
NTI182093.size = sizeof(TY182093*);
NTI182093.kind = 24;
NTI182093.base = (&NTI181337);
NTI182093.flags = 2;
NTI182093.marker = TMP152;
NTI181343.size = sizeof(Erecoverableerror181343);
NTI181343.kind = 17;
NTI181343.base = (&NTI3646);
TMP19[11].len = 0; TMP19[11].kind = 2;
NTI181343.node = &TMP19[11];
NTI182067.size = sizeof(Erecoverableerror181343*);
NTI182067.kind = 22;
NTI182067.base = (&NTI181343);
NTI182067.marker = TMP503;
...
NTI182164.size = sizeof(Esuggestdone181345*);
NTI182164.kind = 22;
NTI182164.base = (&NTI181345);
NTI182164.marker = TMP2821;
}
