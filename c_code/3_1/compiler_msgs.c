...
N_NIMCALL(void, suggestwriteln_182190)(NimStringDesc* s) {
	{
		...
		LA7: ;
		{
			writelnhook_182172.ClEnv? writelnhook_182172.ClPrc(s, writelnhook_182172.ClEnv):((TMP1987)(writelnhook_182172.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, clearbufferedmsgs_182182)(void) {
	genericSeqAssign((&bufferedmsgs_182166), NIM_NIL, (&NTI121008));
}
N_NIMCALL(void, TMP2704)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_182449)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_182453).Sup.message; (*e_182453).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2705));
	if (LOC1) nimGCunrefNoCycle(LOC1);
