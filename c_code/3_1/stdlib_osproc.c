...
N_NIMCALL(NCSTRING*, envtocstringarray_128804)(tstringtable122810* t) {
	...
	TMP362 = mulInt((NI32)(TMP361), 4);
	LOC2 = 0;
	LOC2 = alloc0_4616((NI32)(TMP362));
...
appendString(LOC8, val_128811);
			...
			memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI32)(TMP365));
...
N_NIMCALL(NCSTRING*, envtocstringarray_128841)(void) {
	...
	while (1) {
		...
		key_128845 = copyStrLast(environment_112006->data[i_128886], 0, (NI32)(TMP366));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_128886) >= (NU)(environment_112006->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP367 = addInt(p_128892, 1);
		val_128846 = copyStr(environment_112006->data[i_128886], (NI32)(TMP367));
	...
	TMP369 = mulInt((NI32)(TMP368), 4);
	LOC2 = 0;
	LOC2 = alloc0_4616((NI32)(TMP369));
	result = ((NCSTRING*) (LOC2));
	...
	while (1) {
		...
		key_128865 = copyStrLast(environment_112006->data[i_128902], 0, (NI32)(TMP370));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_128902) >= (NU)(environment_112006->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP371 = addInt(p_128908, 1);
		val_128866 = copyStr(environment_112006->data[i_128902], (NI32)(TMP371));
...
appendString(LOC4, val_128866);
		...
		memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI32)(TMP373));
...
N_NIMCALL(void, pruneprocessset_130834)(TY128403** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(924, "osproc.nim");
		{
			...
			nimln(925, "osproc.nim");
			TMP386 = subInt(l, 1);
			if ((NU)((NI32)(TMP386)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRef((void**) &(*s)->data[i], (*s)->data[(NI32)(TMP386)]);
...
N_NIMCALL(NI, select_128721)(TY128403** readfds, NI timeout) {
	...
	nimln(940, "osproc.nim");
	{
		...
		TMP388 = addInt(m, 1);
		LOC5 = 0;
		LOC5 = select(((int) ((NI32)(TMP388))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		TMP389 = addInt(m, 1);
		LOC7 = 0;
		LOC7 = select(((int) ((NI32)(TMP389))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
