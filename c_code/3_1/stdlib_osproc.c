...
N_NIMCALL(NCSTRING*, envtocstringarray_127804)(tstringtable121810* t) {
	...
	TMP361 = mulInt((NI32)(TMP360), 4);
	LOC2 = 0;
	LOC2 = alloc0_4616((NI32)(TMP361));
...
appendString(LOC8, val_127811);
			...
			memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI32)(TMP364));
...
N_NIMCALL(NCSTRING*, envtocstringarray_127841)(void) {
	...
	while (1) {
		...
		key_127845 = copyStrLast(environment_112006->data[i_127886], 0, (NI32)(TMP365));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_127886) >= (NU)(environment_112006->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP366 = addInt(p_127892, 1);
		val_127846 = copyStr(environment_112006->data[i_127886], (NI32)(TMP366));
	...
	TMP368 = mulInt((NI32)(TMP367), 4);
	LOC2 = 0;
	LOC2 = alloc0_4616((NI32)(TMP368));
	result = ((NCSTRING*) (LOC2));
	...
	while (1) {
		...
		key_127865 = copyStrLast(environment_112006->data[i_127902], 0, (NI32)(TMP369));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_127902) >= (NU)(environment_112006->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP370 = addInt(p_127908, 1);
		val_127866 = copyStr(environment_112006->data[i_127902], (NI32)(TMP370));
...
appendString(LOC4, val_127866);
		...
		memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI32)(TMP372));
...
N_NIMCALL(void, pruneprocessset_129834)(TY127403** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(924, "osproc.nim");
		{
			...
			nimln(925, "osproc.nim");
			TMP385 = subInt(l, 1);
			if ((NU)((NI32)(TMP385)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRef((void**) &(*s)->data[i], (*s)->data[(NI32)(TMP385)]);
...
N_NIMCALL(NI, select_127721)(TY127403** readfds, NI timeout) {
	...
	nimln(940, "osproc.nim");
	{
		...
		TMP387 = addInt(m, 1);
		LOC5 = 0;
		LOC5 = select(((int) ((NI32)(TMP387))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		TMP388 = addInt(m, 1);
		LOC7 = 0;
		LOC7 = select(((int) ((NI32)(TMP388))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
