...
static N_INLINE(tnode186813*, lastson_187199)(tnode186813* n) {
	...
	if ((NU)((NI32)(TMP5675)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI32)(TMP5675)];
	popFrame();
	return result;
}
...
N_NIMCALL(tsym186843*, ithfield_415007)(tnode186813* n, NI field) {
	...
	case ((NU8) 136):
	{
		...
		while (1) {
			...
			result = ithfield_415007((*n).kindU.S6.Sons->data[i_415024], (NI32)(TMP5671));
	...
	case ((NU8) 137):
	{
		...
		result = ithfield_415007((*n).kindU.S6.Sons->data[0], (NI32)(TMP5673));
		...
		while (1) {
			...
			case ((NU8) 88):
			{
				...
				result = ithfield_415007(LOC20, (NI32)(TMP5676));
