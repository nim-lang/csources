...
N_NIMCALL(void, send_192808)(tsocketimpl182607* socket, NimStringDesc* data) {
	NI sent;
	{
		...
		e_192814 = 0;
		e_192814 = (valueerror3249*) newObj((&NTI21401), sizeof(valueerror3249));
		(*e_192814).Sup.Sup.m_type = (&NTI3249);
		LOC5 = 0;
		LOC5 = (*e_192814).Sup.message; (*e_192814).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1970));
...
N_NIMCALL(void, readline_191447)(tsocketimpl182607* socket, NimStringDesc** line, NI timeout) {
	...
	(*line) = setLengthStr((*line), 0);
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_190618(socket, &waited, timeout, 1, ((NimStringDesc*) &TMP4840));
			...
			LA4: ;
			{
				...
				LOC15 = 0;
				LOC15 = waitfor_190618(socket, &waited, timeout, 1, ((NimStringDesc*) &TMP4840));
