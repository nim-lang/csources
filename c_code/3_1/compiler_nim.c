...
STRING_LITERAL(TMP2024, "", 0);
STRING_LITERAL(TMP2025, "-", 1);
STRING_LITERAL(TMP2026, "stdinfile", 9);
STRING_LITERAL(TMP2056, "nim.cfg", 7);
STRING_LITERAL(TMP2057, "nims", 4);
STRING_LITERAL(TMP3718, "config.nims", 11);
STRING_LITERAL(TMP5306, "./", 2);
STRING_LITERAL(TMP5307, "js", 2);
...
appendString(LOC7, ((NimStringDesc*) &TMP5306));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
{	{
	...
	LA4: ;
	{
		...
		scriptfile = noschangeFileExt(gprojectfull_159201, ((NimStringDesc*) &TMP2057));
		{
			...
			if (!LOC25) goto LA26;
			runnimscript_534202(scriptfile);
			{
		...
		maincommand_531610();
		{
			...
			if (!(LOC44)) goto LA45;
			LOC44 = ((gnotes_182080 &((NU64)1<<((NU)((((NU16) 289)- 237))&63U)))!=0);
			LA45: ;
			if (!LOC44) goto LA46;
			LOC48 = 0;
		...
		LA46: ;
		{
			if (!(gerrorcounter_182081 == ((NI) 0))) goto LA51;
			{
...
NIM_EXTERNC N_NOINLINE(void, nimInit000)(void) {
	...
	initdefines_189184();
	handlecmdline_535601();
	msgquit_182152(((NI8) ((((NI) 0) < gerrorcounter_182081))));
}
