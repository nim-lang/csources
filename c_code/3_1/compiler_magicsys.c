...
N_LIB_PRIVATE N_NIMCALL(void, addSonSkipIntLit_IsUgUD6jUR9cHf7wFXGXH2A)(tyObject_TType_v9ae2Dpu13OW2ZJ2U9bNMd9cQ* father, tyObject_TType_v9ae2Dpu13OW2ZJ2U9bNMd9cQ* son) {
	...
	asgnRefNoCycle((void**) (&(*father).sons->data[T1_]), s);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w*, getSysSym_9bvw79ck1FDiWpnBYh88rEfw)(tyObject_ModuleGraphcolonObjectType__RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TLineInfo_WGx4rAexNXnczy1Avn646Q info, NimStringDesc* name) {
	...
	result = strTableGet_0xgFDJUQtGGr2e0Sq9aLIhA((*(*g).systemModule)._Ukind.S3.tab, T1_);
	{
		NimStringDesc* T6_;
...
appendString(T6_, name);
		...
		asgnRefNoCycle((void**) (&(*result).typ), newType_dQhKkL6uAkw83dy6l4d7iQ(((tyEnum_TTypeKind_9a3YiReNVD0IJHWFKgXRe9ag) 50), (*g).systemModule));
	}
	LA4_: ;
	{
...
{	result = (tyObject_TType_v9ae2Dpu13OW2ZJ2U9bNMd9cQ*)0;
	result = (*g).sysTypes[(kind)- 0];
	{
		...
		{
			result = sysTypeFromName_tS9cwSHSUZLgy9baxOcGRlCQ(g, info, ((NimStringDesc*) &TM_X5WDdcxsp0AxLUoaF7I29bA_3));
		}
		break;
...
appendString(T26_, reprEnum((NI)kind, (&NTI_9a3YiReNVD0IJHWFKgXRe9ag_)));
		...
		asgnRefNoCycle((void**) (&(*g).sysTypes[(kind)- 0]), result);
	}
	LA3_: ;
	{
		NimStringDesc* T31_;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TType_v9ae2Dpu13OW2ZJ2U9bNMd9cQ*, getIntLitType_R31RMSlMd8WWIYpM0EKGkA)(tyObject_ModuleGraphcolonObjectType__RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* literal) {
	...
	NI64 value;
	result = (tyObject_TType_v9ae2Dpu13OW2ZJ2U9bNMd9cQ*)0;
	value = (*literal)._Ukind.S1.intVal;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = (IL64(-5) <= value);
		...
		result = (*g).intTypeCache[(((NI) (value)))- -5];
		{
			...
			asgnRefNoCycle((void**) (&(*g).intTypeCache[(((NI) (value)))- -5]), result);
		}
		LA9_: ;
	}
	goto LA1_;
...
{	result = (tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w*)0;
	...
	r = initIdentIter_S3q38waBmqwNs9b4pTwOCOQ((&ti), (*(*g).systemModule)._Ukind.S3.tab, id);
	{
		while (1) {
			...
			LA5_: ;
			r = nextIdentIter_jigDNlH3irWs400Ruq7RXw((&ti), (*(*g).systemModule)._Ukind.S3.tab);
		} LA2: ;
	}
	{
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TType_v9ae2Dpu13OW2ZJ2U9bNMd9cQ*, getFloatLitType_gbUDJnd8WM9alItYI0K5VKA)(tyObject_ModuleGraphcolonObjectType__RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* literal) {
	tyObject_TType_v9ae2Dpu13OW2ZJ2U9bNMd9cQ* result;
	result = (tyObject_TType_v9ae2Dpu13OW2ZJ2U9bNMd9cQ*)0;
	result = newSysType_gOfqIJRJ8PG2N9ckB0yWgsw(g, ((tyEnum_TTypeKind_9a3YiReNVD0IJHWFKgXRe9ag) 36), ((NI) 8));
	asgnRefNoCycle((void**) (&(*result).n), literal);
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(void, setIntLitType_JsZMQGDyZXnGr9cg0jxXW0w)(tyObject_ModuleGraphcolonObjectType__RZI3hCs0FTPYx8StfC81qQ* g, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* result) {
	...
	case ((NI) 4):
	{
		...
		LA7_: ;
		{
			asgnRefNoCycle((void**) (&(*result).typ), getSysType_VcTNc9cK1Ftuh0MFwOC9c0Tg(g, (*result).info, ((tyEnum_TTypeKind_9a3YiReNVD0IJHWFKgXRe9ag) 35)));
		}
		LA3_: ;
	}
	break;
	case ((NI) 2):
	{
		...
		LA15_: ;
		{
			...
			LA19_: ;
			if (!T18_) goto LA20_;
			asgnRefNoCycle((void**) (&(*result).typ), getSysType_VcTNc9cK1Ftuh0MFwOC9c0Tg(g, (*result).info, ((tyEnum_TTypeKind_9a3YiReNVD0IJHWFKgXRe9ag) 34)));
		}
		goto LA11_;
		LA20_: ;
		{
	...
	case ((NI) 1):
	{
		...
		LA28_: ;
		{
			...
			LA32_: ;
			if (!T31_) goto LA33_;
			asgnRefNoCycle((void**) (&(*result).typ), getSysType_VcTNc9cK1Ftuh0MFwOC9c0Tg(g, (*result).info, ((tyEnum_TTypeKind_9a3YiReNVD0IJHWFKgXRe9ag) 33)));
		}
		goto LA24_;
		LA33_: ;
		{
	...
	default:
	{
		internalError_yTu5SGHF0j0P9cQrqN7YylA((*g).config, (*result).info, ((NimStringDesc*) &TM_X5WDdcxsp0AxLUoaF7I29bA_27));
	}
	break;
	}
}
...
N_LIB_PRIVATE N_NIMCALL(void, resetSysTypes_SzzxPKUfKBxPbhpfi48YqA)(tyObject_ModuleGraphcolonObjectType__RZI3hCs0FTPYx8StfC81qQ* g) {
	asgnRefNoCycle((void**) (&(*g).systemModule), NIM_NIL);
	...
	initStrTable_dDG9ckEId9ai4WID9aLQcRYNg((&(*g).exposed));
	{
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				asgnRefNoCycle((void**) (&(*g).sysTypes[(i)- 0]), NIM_NIL);
				res += ((NI) 1);
			} LA3: ;
		}
	}
	{
		...
		res_2 = ((NI) -5);
		{
			while (1) {
				...
				i_2 = ((NI) (res_2));
				asgnRefNoCycle((void**) (&(*g).intTypeCache[(i_2)- -5]), NIM_NIL);
				res_2 += ((NI) 1);
			} LA6: ;
		}
	}
