...
STRING_LITERAL(TMP3323, "GetUniqueType", 13);
STRING_LITERAL(TMP3330, "N", 1);
STRING_LITERAL(TMP3331, "HEX", 3);
STRING_LITERAL(TMP3422, "\"", 1);
STRING_LITERAL(TMP3929, "c\"", 2);
STRING_LITERAL(TMP3930, "\\00\"", 4);
...
N_NIMCALL(ttype224855*, getuniquetype_543401)(ttype224855* key) {
	...
	case ((NU8) 58):
	{
		internalerror_197989(((NimStringDesc*) &TMP3323));
	}
	break;
	case ((NU8) 13):
	{
...
N_NIMCALL(NimStringDesc*, mangle_543763)(NimStringDesc* name) {
	...
	case 48 ... 57:
	{
		...
		LOC4 = 0;
		LOC4 = rawNewString(2);
appendString(LOC4, ((NimStringDesc*) &TMP3330));
...
appendString(LOC6, ((NimStringDesc*) &TMP3331));
...
appendString(LOC16, ((NimStringDesc*) &TMP3331));
...
N_NIMCALL(NimStringDesc*, makesinglelinecstring_543737)(NimStringDesc* s) {
	NimStringDesc* result;
	result = 0;
	result = copyString(((NimStringDesc*) &TMP3422));
	{
		NIM_CHAR c_543741;
		NI i_543745;
		NI l_543747;
...
N_NIMCALL(trope177009*, makellvmstring_543816)(NimStringDesc* s) {
	...
	result = 0;
	result = NIM_NIL;
	res = copyString(((NimStringDesc*) &TMP3929));
	{
		NI i_543834;
		NI HEX3Atmp_543847;
		NI res_543850;
...
appendString(res, ((NimStringDesc*) &TMP3930));
	LOC12 = 0;
