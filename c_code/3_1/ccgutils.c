...
static N_INLINE(ttype186847*, lastson_187203)(ttype186847* n) {
	...
	if ((NU)((NI32)(TMP6190)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP6190)];
	popFrame();
	return result;
}
...
N_NIMCALL(trope144007*, makellvmstring_464684)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(169, "ccgutils.nim");
		{
			...
			TMP6196 = modInt((NI32)(TMP6195), 64);
			if (!(((NI) ((NI32)(TMP6196))) == 0)) goto LA4;
