...
STRING_LITERAL(TMP4683, "", 0);
STRING_LITERAL(TMP4684, "Set-Cookie: ", 12);
STRING_LITERAL(TMP4685, "=", 1);
STRING_LITERAL(TMP4686, "; Domain=", 9);
STRING_LITERAL(TMP4687, "; Path=", 7);
STRING_LITERAL(TMP4688, "; Expires=", 10);
STRING_LITERAL(TMP4689, "ddd\',\' dd MMM yyyy HH:mm:ss \'UTC\'", 33);
...
N_NIMCALL(tstringtable122810*, parsecookies_339012)(NimStringDesc* s) {
	...
	while (1) {
		...
		TMP4682 = subInt(i, 1);
		LOC16 = 0;
		LOC16 = copyStrLast(s, valstart, (NI32)(TMP4682));
...
N_NIMCALL(NimStringDesc*, setcookie_339106)(NimStringDesc* key, NimStringDesc* value, NimStringDesc* domain, NimStringDesc* path, NimStringDesc* expires, NIM_BOOL noname) {
	...
	result = copyString(((NimStringDesc*) &TMP4683));
...
appendString(LOC5, ((NimStringDesc*) &TMP4685));
...
appendString(LOC10, ((NimStringDesc*) &TMP4686));
...
appendString(LOC15, ((NimStringDesc*) &TMP4687));
...
appendString(LOC20, ((NimStringDesc*) &TMP4688));
...
N_NIMCALL(NimStringDesc*, setcookie_339117)(NimStringDesc* key, NimStringDesc* value, ttimeinfo95003* expires, NimStringDesc* domain, NimStringDesc* path, NIM_BOOL noname) {
	...
	LOC1 = 0;
	LOC1 = format_96999(expires, ((NimStringDesc*) &TMP4689));
