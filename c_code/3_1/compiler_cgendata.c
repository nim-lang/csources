...
static N_INLINE(trope121007**, s_367161)(tcproc367025* p, NU8 s) {
	...
	if ((NU)((NI32)(TMP5608)) >= (NU)((*p).Blocks->Sup.len)) raiseIndexError();
	result = &(*p).Blocks->data[(NI32)(TMP5608)].Sections[(s)- 0];
	popFrame();
	return result;
}
static N_INLINE(trope121007**, procsec_367178)(tcproc367025* p, NU8 s) {
