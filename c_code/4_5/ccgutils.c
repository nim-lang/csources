...
static NIM_CONST TY187025 TMP6190 = {
...
N_NIMCALL(ttype186847*, getuniquetype_464401)(ttype186847* key) {
	...
	case ((NU8) 58):
	{
		...
		internalerror_164606(((NimStringDesc*) &TMP6194));
	}
	break;
	case ((NU8) 11):
	case ((NU8) 13):
...
appendString(result, LOC2);
		...
		nimln(2809, "system.nim");
		{
			...
			nimln(2809, "system.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP6197));
		}
		LA5: ;
	} LA1: ;
