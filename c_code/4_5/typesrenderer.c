...
static NIM_CONST TY187025 TMP4768 = {
...
static NIM_CONST TY187025 TMP4771 = {
...
appendString(LOC25, LOC27);
	...
	case ((NU8) 145):
	{
		...
		nimln(46, "typesrenderer.nim");
		{
			...
			nimln(46, "typesrenderer.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP4778));
		}
		LA32: ;
...
appendString(result, LOC71);
	...
	case ((NU8) 42):
	{
		...
		nimln(67, "typesrenderer.nim");
		{
			...
			nimln(67, "typesrenderer.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP4787));
		}
		LA78: ;
...
N_NIMCALL(void, renderparamtypes_339423)(TY10665** found, tnode186813* n) {
	...
	case ((NU8) 35):
	{
		...
		nimln(87, "typesrenderer.nim");
		{
			...
			nimln(87, "typesrenderer.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP4789));
		}
		LA9: ;
		...
		nimln(89, "typesrenderer.nim");
		{
			...
			LOC16 = 0;
			LOC16 = HEX5BHEX5D_187711(n, (NI32)(TMP4790));
			...
			LOC19 = 0;
			LOC19 = HEX5BHEX5D_187711(n, (NI32)(TMP4791));
			typ = (*LOC19).Typ;
