...
N_NIMCALL(Tsym191843*, getsyssym_238054)(NimStringDesc* name) {
	...
	result = strtableget_199111((*systemmodule_238019).kindU.S3.tab, LOC1);
	{
		...
		result = newsym_192656(((NU8) 0), LOC6, systemmodule_238019, (*systemmodule_238019).info);
...
{	result = 0;
	...
	rawmessage_164970(((NU16) 64), name);
	result = newsym_192656(((NU8) 0), id, systemmodule_238019, (*systemmodule_238019).info);
	asgnRefNoCycle((void**) (&(*result).typ), newtype_194144(((NU8) 50), systemmodule_238019));
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, setintlittype_238776)(Tnode191813* result) {
	...
	default:
	{
		internalerror_165215((*result).info, ((NimStringDesc*) &TMP3388));
	}
	break;
	}
}
