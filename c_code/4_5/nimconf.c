...
STRING_LITERAL(TMP1880, "/usr", 4);
STRING_LITERAL(TMP1881, "/usr/lib/nim", 12);
STRING_LITERAL(TMP1882, "/usr/local", 10);
STRING_LITERAL(TMP1883, "/usr/local/lib/nim", 18);
STRING_LITERAL(TMP1884, "lib", 3);
STRING_LITERAL(TMP1885, "@", 1);
STRING_LITERAL(TMP1886, "\')\'", 3);
STRING_LITERAL(TMP1887, "\':\'", 3);
STRING_LITERAL(TMP1888, "@if", 3);
STRING_LITERAL(TMP1889, "@end", 4);
STRING_LITERAL(TMP1890, "putenv", 6);
STRING_LITERAL(TMP1891, "prependenv", 10);
STRING_LITERAL(TMP1892, "appendenv", 9);
STRING_LITERAL(TMP1893, "-", 1);
STRING_LITERAL(TMP1894, "--", 2);
STRING_LITERAL(TMP1895, "", 0);
STRING_LITERAL(TMP1896, "\']\'", 3);
STRING_LITERAL(TMP1897, "&", 1);
STRING_LITERAL(TMP1898, "config", 6);
STRING_LITERAL(TMP1899, "etc", 3);
STRING_LITERAL(TMP1900, "/etc/", 5);
		...
		while (1) {
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = eqStrings((*(*tok).Ident).S, ((NimStringDesc*) &TMP1885));
				LA6: ;
				if (!LOC5) goto LA7;
				ppgettok_220009(l, tok);
				LOC9 = 0;
			...
			LA7: ;
			{
				...
				lexmessage_215280(&(*l), ((NU16) 23), ((NimStringDesc*) &TMP1889));
			}
			goto LA3;
			LA36: ;
			{
...
N_NIMCALL(void, parsedirective_220369)(tlexer215186* l, ttoken215184* tok) {
	...
	default:
	{
		...
		if (eqStrings(LOC13, ((NimStringDesc*) &TMP1890))) goto LA14;
		if (eqStrings(LOC13, ((NimStringDesc*) &TMP1891))) goto LA15;
		if (eqStrings(LOC13, ((NimStringDesc*) &TMP1892))) goto LA16;
		goto LA17;
		LA14: ;
		{
			NimStringDesc* key;
...
N_NIMCALL(void, conftok_220412)(tlexer215186* l, ttoken215184* tok) {
	ppgettok_220009(l, tok);
	{
		while (1) {
			...
			if (!(LOC3)) goto LA4;
			LOC3 = eqStrings((*(*tok).Ident).S, ((NimStringDesc*) &TMP1885));
			LA4: ;
			if (!LOC3) goto LA2;
...
N_NIMCALL(void, parseassignment_220485)(tlexer215186* l, ttoken215184* tok) {
	...
	NimStringDesc* val;
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = getident_200472(((NimStringDesc*) &TMP1893));
		LOC3 = ((*(*tok).Ident).Sup.Id == (*LOC4).Sup.Id);
		if (LOC3) goto LA5;
		LOC6 = 0;
		LOC6 = getident_200472(((NimStringDesc*) &TMP1894));
	...
	conftok_220412(l, tok);
	val = copyString(((NimStringDesc*) &TMP1895));
	{
		while (1) {
			NimStringDesc* LOC11;
...
appendString(val, LOC30);
		conftok_220412(l, tok);
		{
			while (1) {
				...
				if (!(LOC33)) goto LA34;
				LOC35 = 0;
				LOC35 = getident_200472(((NimStringDesc*) &TMP1897));
...
N_NIMCALL(NimStringDesc*, getsystemconfigpath_220652)(NimStringDesc* filename) {
	...
	LOC1[0] = copyString(p);
	LOC1[1] = copyString(((NimStringDesc*) &TMP1898));
	...
	result = nosjoinPathOpenArray(LOC1, 3);
	{
		...
		LOC7[0] = copyString(p);
		LOC7[1] = copyString(((NimStringDesc*) &TMP1899));
...
N_NIMCALL(void, loadconfigs_220811)(NimStringDesc* cfg) {
	NimStringDesc* pd;
	{
		...
		{
			NimStringDesc* LOC9;
			if (!eqStrings(prefix, ((NimStringDesc*) &TMP1880))) goto LA7;
			LOC9 = 0;
			LOC9 = libpath_169231; libpath_169231 = copyStringRC1(((NimStringDesc*) &TMP1881));
		...
		{
			NimStringDesc* LOC13;
			if (!eqStrings(prefix, ((NimStringDesc*) &TMP1882))) goto LA11;
			LOC13 = 0;
			LOC13 = libpath_169231; libpath_169231 = copyStringRC1(((NimStringDesc*) &TMP1883));
			if (LOC13) nimGCunrefNoCycle(LOC13);
		}
		goto LA5;
		LA11: ;
		{
			asgnRefNoCycle((void**) &libpath_169231, nosjoinPath(prefix, ((NimStringDesc*) &TMP1884)));
		}
		LA5: ;
	}
	LA3: ;
	...
	LA32: ;
	{
		...
		readconfigfile_220573(LOC74);
		{
			...
			projectconfig = noschangeFileExt(gprojectfull_169234, ((NimStringDesc*) &TMP1902));
			{
				NIM_BOOL LOC81;
				LOC81 = 0;
			...
			LA82: ;
			{
				NimStringDesc* LOC85;
				LOC85 = 0;
				LOC85 = noschangeFileExt(gprojectfull_169234, ((NimStringDesc*) &TMP1903));
