...
N_NIMCALL(void, jumptodirective_182185)(tlexer178176* l, ttoken178174* tok, NU8 dest) {
	...
	while (1) {
		...
		LA6: ;
		{
			...
			lexmessage_178246(&(*l), ((NU16) 23), ((NimStringDesc*) &TMP1907));
		}
		goto LA2;
		LA35: ;
		{
...
N_NIMCALL(void, parseassignment_182407)(tlexer178176* l, ttoken178174* tok) {
	...
	nimln(158, "nimconf.nim");
	{
		...
		nimln(158, "nimconf.nim");
		LOC4 = 0;
		LOC4 = getident_166456(((NimStringDesc*) &TMP1912));
		LOC3 = ((*(*tok).Ident).Sup.Id == (*LOC4).Sup.Id);
		if (LOC3) goto LA5;
		nimln(158, "nimconf.nim");
		nimln(158, "nimconf.nim");
		LOC6 = 0;
		LOC6 = getident_166456(((NimStringDesc*) &TMP1913));
...
appendString(val, LOC15);
		...
		LA18: ;
		{
			...
			lexmessage_178246(&(*l), ((NU16) 23), ((NimStringDesc*) &TMP1915));
		}
		LA16: ;
...
appendString(val, LOC29);
		...
		while (1) {
			...
			nimln(187, "nimconf.nim");
			LOC33 = 0;
			LOC33 = getident_166456(((NimStringDesc*) &TMP1916));
