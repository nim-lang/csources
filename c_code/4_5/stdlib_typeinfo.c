...
{	memset((void*)(&result0), 0, sizeof(result0));
	...
	case ((Tnimkind205003) 24):
	{
		...
		s0 = (*((void**) (x0.value)));
		{
			...
			e_206847_1760177012 = (Valueerror3646*) newObj((&NTI23025), sizeof(Valueerror3646));
		...
		LA15: ;
		result0 = newany_205836_1760177012(((void*) ((NI)(((NI) (s0)) + (NI)(((NI) 8) + (NI)(i0 * bs0))))), (*((TNimType*) (x0.rawtypeptr))).base);
		goto BeforeRet;
	}
	break;
	default:
