...
static NIM_CONST TY187025 TMP3276 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3277, "ident", 5);
static NIM_CONST TY187025 TMP3278 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3279, "sym", 3);
static NIM_CONST TY187025 TMP3280 = {
...
N_NIMCALL(NimStringDesc*, getmodulename_254012)(tnode186813* n) {
	...
	case ((NU8) 29):
	{
		...
		nimln(31, "importer.nim");
		{
			...
			nimln(31, "importer.nim");
			LOC9 = 0;
			LOC9 = getident_166456(((NimStringDesc*) &TMP3282));
	...
	nimln(71, "importer.nim");
	{
		...
		nimln(73, "importer.nim");
		{
			...
			while (1) {
				...
				if (!(((TMP3278[(*(*(*etyp).N).kindU.S6.Sons->data[j_254322]).Kind/8] &(1<<((*(*(*etyp).N).kindU.S6.Sons->data[j_254322]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3279));
				...
				nimln(76, "importer.nim");
				{
					...
					internalerror_164591((*s).Info, ((NimStringDesc*) &TMP3288));
				}
				LA25: ;
...
N_NIMCALL(void, importsymbol_254416)(tcontext249019* c, tnode186813* n, tsym186843* frommod) {
	...
	LA3: ;
	{
		...
		nimln(102, "importer.nim");
		{
			...
			internalerror_164591((*n).Info, ((NimStringDesc*) &TMP3290));
		}
		LA12: ;
...
N_NIMCALL(void, importforwarded_254633)(tcontext249019* c, tnode186813* n, tintset183047 exceptset) {
	...
	case ((NU8) 117):
	{
		...
		while (1) {
			...
			nimln(137, "importer.nim");
			{
				...
				nimln(137, "importer.nim");
				failedassertimpl_80021(((NimStringDesc*) &TMP3293));
			}
			LA10: ;
			nimln(138, "importer.nim");
			if (!(((TMP3278[(*a_254649).Kind/8] &(1<<((*a_254649).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3279));
	...
	case ((NU8) 118):
	{
		...
		localerror_164571((*n).Info, ((NU16) 4), ((NimStringDesc*) &TMP3294));
	}
	break;
	default:
	{
...
N_NIMCALL(tsym186843*, importmoduleas_254873)(tnode186813* n, tsym186843* realmodule) {
	...
	LA3: ;
	{
		...
		localerror_164571((*n).Info, ((NU16) 4), ((NimStringDesc*) &TMP3296));
	}
	goto LA1;
	LA9: ;
	{
