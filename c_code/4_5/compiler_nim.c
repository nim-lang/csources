...
STRING_LITERAL(TMP3720, "config.nims", 11);
STRING_LITERAL(TMP5308, "./", 2);
STRING_LITERAL(TMP5309, "js", 2);
...
appendString(LOC7, ((NimStringDesc*) &TMP5308));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
{	{
	...
	LA4: ;
	{
		...
		scriptfile = noschangeFileExt(gprojectfull_160201, ((NimStringDesc*) &TMP2059));
		{
			...
			if (!LOC25) goto LA26;
			runnimscript_535201(scriptfile);
			{
		...
		LA26: ;
		{
			...
			NimStringDesc* LOC37;
			LOC33 = 0;
			LOC33 = HEX2F_118465(gprojectpath_160200, ((NimStringDesc*) &TMP3720));
			LOC34 = 0;
			LOC34 = fileexists_121804(LOC33);
			if (!LOC34) goto LA35;
			LOC37 = 0;
			LOC37 = HEX2F_118465(gprojectpath_160200, ((NimStringDesc*) &TMP3720));
			runnimscript_535201(LOC37);
		}
		goto LA23;
		LA35: ;
		LA23: ;
			...
			if (!(gerrorcounter_183081 == ((NI) 0))) goto LA51;
			{
				if (!((gglobaloptions_160121 &(1U<<((NU)(((NU8) 13))&31U)))!=0)) goto LA55;
				{
					...
					LA63: ;
					{
						...
						NimStringDesc* LOC69;
						LOC67 = 0;
						LOC67 = noschangeFileExt(gprojectfull_160201, ((NimStringDesc*) &TMP5309));
						LOC68 = 0;
...
appendString(LOC70, ((NimStringDesc*) &TMP5313));
