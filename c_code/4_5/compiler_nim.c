...
N_NIMCALL(void, handlecmdline_528607)(void) {
	...
	LA4: ;
	{
		processcmdline_522209(((NU8) 0), ((NimStringDesc*) &TMP1870));
		{
			TSafePoint TMP1871;
			TY119589 p;
			NimStringDesc* LOC15;
		...
		LA7: ;
		loadconfigs_186811(((NimStringDesc*) &TMP1899));
		initvars_170876();
		processcmdline_522209(((NU8) 1), ((NimStringDesc*) &TMP1870));
		maincommand_525628();
		{
			NimStringDesc* LOC22;
		...
		LA20: ;
		{
			if (!(gerrorcounter_164019 == ((NI) 0))) goto LA25;
			{
				...
				{
					NimStringDesc* LOC35;
					if (!eqStrings(gprojectname_154234, ((NimStringDesc*) &TMP5024))) goto LA33;
					LOC35 = 0;
					LOC35 = gprojectfull_154236; gprojectfull_154236 = copyStringRC1(((NimStringDesc*) &TMP5025));
				...
				LA33: ;
				{
					...
					LA42: ;
					{
						...
						NimStringDesc* LOC48;
						LOC46 = 0;
						LOC46 = noschangeFileExt(gprojectfull_154236, ((NimStringDesc*) &TMP5027));
						LOC47 = 0;
...
appendString(LOC49, arguments_177723);
					execexternalprogram_170985(LOC49, ((NimStringDesc*) &TMP1870));
				}
				goto LA36;
				LA38: ;
				{
					...
					LA54: ;
					{
						NimStringDesc* LOC57;
						LOC57 = 0;
						LOC57 = noschangeFileExt(gprojectfull_154236, ((NimStringDesc*) &TMP1870));
...
appendString(LOC58, arguments_177723);
					execexternalprogram_170985(LOC58, ((NimStringDesc*) &TMP1870));
				}
				LA36: ;
			}
			LA29: ;
