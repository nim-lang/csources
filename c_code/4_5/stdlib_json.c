...
N_LIB_PRIVATE N_NIMCALL(tyObject_JsonNodeObj_df9bshXB7C9cTiWPIOtX3j1Q*, newJBool_bESUahFJIJ0RSySOPtSYZg_2)(NIM_BOOL b);
...
{	result = (NIM_BOOL)0;
	...
	LA12_: ;
	{
		...
		case ((tyEnum_JsonNodeKind_RUngo7nCHe6O8aBGIcrhtg) 6):
		{
			result = eqeq__fL0tq3d6JfMw9bvY7G6spBQ((*a).elems, (*b).elems);
		}
		break;
		case ((tyEnum_JsonNodeKind_RUngo7nCHe6O8aBGIcrhtg) 5):
		{
			{
				...
				NI T25_;
				T24_ = (NI)0;
				T24_ = len_YcGrPJJ4pElek9cAaf09a9bmQjson((*a).fields);
				T25_ = (NI)0;
				T25_ = len_YcGrPJJ4pElek9cAaf09a9bmQjson((*b).fields);
					...
					while (1) {
						...
						nxt = colontmp_.data->data[h].Field1;
						{
							...
							val = colontmp_.data->data[h].Field3;
							{
								NIM_BOOL T38_;
								T38_ = (NIM_BOOL)0;
								T38_ = hasKey_iqm6UDESHopNXjGmU4P7nA((*b).fields, key);
								if (!!(T38_)) goto LA39_;
								result = NIM_FALSE;
								goto BeforeRet_;
							}
							LA39_: ;
							{
								...
								T43_ = X5BX5D__3MszA1IsDLkWcBk0f4ZIOQ((&(*b).fields), key);
								T44_ = (NIM_BOOL)0;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_JsonNodeObj_df9bshXB7C9cTiWPIOtX3j1Q*, percent__8iXO9aRAijCPe58pujCBbuQ)(NimStringDesc* s) {
	...
	T1_ = (NimStringDesc*)0;
	T1_ = (*result).str; (*result).str = copyStringRC1(s);
...
N_LIB_PRIVATE N_NIMCALL(void, indent_1Ijhfzd9bSYvew1BrGtRO2g)(NimStringDesc** s, NI i) {
	NimStringDesc* T1_;
	T1_ = (NimStringDesc*)0;
	T1_ = spaces_B3MM9a2XlLe9ccyXfnm9b1MVgastalgo(((NI) (i)));
...
N_LIB_PRIVATE N_NIMCALL(void, toPretty_MHqQ3FKhfxfdLtBgX2QXeQ)(NimStringDesc** result, tyObject_JsonNodeObj_df9bshXB7C9cTiWPIOtX3j1Q* node, NI indent, NIM_BOOL ml, NIM_BOOL lstArr, NI currIndent) {
	...
	case ((tyEnum_JsonNodeKind_RUngo7nCHe6O8aBGIcrhtg) 5):
	{
		...
		LA4_: ;
		{
			...
			NI i;
			T8_ = (NI)0;
			T8_ = len_YcGrPJJ4pElek9cAaf09a9bmQjson((*node).fields);
...
appendString((*result), T46_);
	...
	case ((tyEnum_JsonNodeKind_RUngo7nCHe6O8aBGIcrhtg) 6):
	{
		...
		{
			NI T59_;
			T59_ = ((*node).elems ? (*node).elems->Sup.len : 0);
...
appendString((*result), ((NimStringDesc*) &TM_9b9bytt1stv9cZ8uqII7HFgew_16));
						...
						toPretty_MHqQ3FKhfxfdLtBgX2QXeQ(result, (*node).elems->data[i_2], indent, ml, NIM_TRUE, T70_);
						res += ((NI) 1);
					} LA65: ;
				}
			}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_JsonNodeObj_df9bshXB7C9cTiWPIOtX3j1Q*, parseJson_9cy3XTSABpD79aMQvc9csghxg)(tyObject_JsonParser_KWIQnzXEOUqdWsnCUL9atyQ* p) {
	...
	case ((tyEnum_TokKind_Q9c4KaNqJU4PbXaGht0C7iw) 5):
	{
		...
		result = newJBool_bESUahFJIJ0RSySOPtSYZg_2(NIM_TRUE);
	...
	case ((tyEnum_TokKind_Q9c4KaNqJU4PbXaGht0C7iw) 6):
	{
		...
		result = newJBool_bESUahFJIJ0RSySOPtSYZg_2(NIM_FALSE);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_JsonNodeObj_df9bshXB7C9cTiWPIOtX3j1Q*, parseFile_jHjkbBWx0TRN9bcGqTg49c4A)(NimStringDesc* filename) {
	...
	result = (tyObject_JsonNodeObj_df9bshXB7C9cTiWPIOtX3j1Q*)0;
	stream = newFileStream_2RQNkPbX1xhxP7cEoRpP5g(filename, ((tyEnum_FileMode_ZJfK20XeZ9bv2j1pZjw9aswg) 0), ((NI) -1));
	{
...
appendString(T5_, filename);
		...
		raiseExceptionEx((Exception*)e, "IOError", "parseFile", "../lib/pure/json.nim", 883);
	}
	LA3_: ;
