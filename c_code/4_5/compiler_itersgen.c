...
{	result = (tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*)0;
	...
	iter = (*n).sons->data[((NI) 1)];
	{
		...
		LA4_: ;
		if (!T3_) goto LA5_;
		localError_w3nlav3QVHhYSX6HNr5zYg((*(*c).graph).config, (*iter).info, ((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_2));
		goto BeforeRet_;
	}
	LA5_: ;
	{
		if (!((*(*n).sons->data[((NI) 2)]).typ == 0)) goto LA9_;
		localError_w3nlav3QVHhYSX6HNr5zYg((*(*c).graph).config, (*(*n).sons->data[((NI) 2)]).info, ((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_3));
		goto BeforeRet_;
	}
	LA9_: ;
	{
		if (!!(((*(*n).sons->data[((NI) 3)]).kind == ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 2)))) goto LA13_;
		localError_w3nlav3QVHhYSX6HNr5zYg((*(*c).graph).config, (*(*n).sons->data[((NI) 3)]).info, ((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_4));
		goto BeforeRet_;
	}
	LA13_: ;
	t = skipTypes_7vZ9a9bub9bucX5E73hsr9cjvg((*(*n).sons->data[((NI) 2)]).typ, 2304);
	{
		NIM_BOOL T17_;
		...
		LA18_: ;
		if (!T17_) goto LA20_;
		localError_w3nlav3QVHhYSX6HNr5zYg((*(*c).graph).config, (*(*n).sons->data[((NI) 2)]).info, ((NimStringDesc*) &TM_fVT8Frbe1eY8sI6VOwxZZg_5));
		goto BeforeRet_;
	}
	LA20_: ;
	body = liftIterToProc_t1WUr4lePynddtLnmYOFEQ((*c).graph, (*iter).sym, (*(*(*iter).sym).ast).sons->data[((NI) 6)], t);
	prc = newSym_ZQfOwiQo63qLga19cuF5r9cQ(((tyEnum_TSymKind_cNCW9acsSznmEccl1fgQwkw) 12), (*(*n).sons->data[((NI) 3)]).ident, (*(*iter).sym).owner, (*(*iter).sym).info, 0);
	asgnRef((void**) (&(*prc).typ), copyType_UkDKseEIJgQZ1cGmoQSskA((*(*iter).sym).typ, prc, NIM_FALSE));
	(*(*prc).typ).flags &= ~(((NU64)1) << ((((tyEnum_TTypeFlag_x2m5g1NpbmDig4wLT3Ylhw) 12)) % (sizeof(NU64)*8)));
	T22_ = (tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w*)0;
	T22_ = getEnvParam_ypCrx6fkmVfhsiJZgqHbwA((*iter).sym);
	...
	asgnRef((void**) (&(*prc).ast), newProcNode_Z1yyaAwEC9b9b62F39alzYZFw(((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 79), (*n).info, body, (*orig).sons->data[((NI) 3)], T24_, (*(*c).graph).emptyNode, (*(*c).graph).emptyNode, (*orig).sons->data[((NI) 4)], (*(*c).graph).emptyNode));
	add_gCCf68XrWL79bKes6htzFjQ((*prc).ast, (*(*(*iter).sym).ast).sons->data[((NI) 7)]);
	addInterfaceDecl_p3xfiTyUciYR9aCXKqFdP1Q_2(c, prc);
	}BeforeRet_: ;
	return result;
}
