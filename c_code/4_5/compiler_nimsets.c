...
N_NIMCALL(Tnode292802*, totreeset_340251_452470228)(Tbitset339004* s0, Ttype292840* settype0, Tlineinfo191336 info0);
...
N_NIMCALL(void, tobitset_340001_452470228)(Tnode292802* s0, Tbitset339004** b0) {
	...
	bitsetinit_339008_3966472399(b0, ((NI) (LOC1)));
	{
		...
		NI HEX3Atmp_340244_452470228;
		NI LOC3;
		NI res_340247_452470228;
		i_340215_452470228 = (NI)0;
		HEX3Atmp_340244_452470228 = (NI)0;
		LOC3 = (NI)0;
		LOC3 = sonslen_295351_850551059(s0);
		HEX3Atmp_340244_452470228 = (NI)(LOC3 - ((NI) 1));
		res_340247_452470228 = ((NI) 0);
		{
			while (1) {
				if (!(res_340247_452470228 <= HEX3Atmp_340244_452470228)) goto LA5;
				i_340215_452470228 = res_340247_452470228;
				{
	...
	e0 = IL64(0);
	{
		while (1) {
			if (!(e0 < ((NI64) ((NI)((s0 ? s0->Sup.len : 0) * ((NI) 8)))))) goto LA2;
			{
				...
				b0 -= ((NI) 1);
				aa0 = newinttypenode_293666_850551059(((Tnodekind292020) 6), (NI64)(a0 + first0), elemtype0);
				(*aa0).info = info0;
				{
					if (!(a0 == b0)) goto LA19;
				...
				LA19: ;
				{
					...
					bb0 = newinttypenode_293666_850551059(((Tnodekind292020) 6), (NI64)(b0 + first0), elemtype0);
					(*bb0).info = info0;
...
N_NIMCALL(Tnode292802*, diffsets_340030_452470228)(Tnode292802* a0, Tnode292802* b0) {
	...
	result0 = totreeset_340251_452470228(x0, (*a0).typ, (*a0).info);
	return result0;
}
...
N_NIMCALL(NI64, cardset_340050_452470228)(Tnode292802* s0) {
	...
	result0 = IL64(0);
	{
		NI i_340434_452470228;
		NI HEX3Atmp_340459_452470228;
		NI LOC2;
		NI res_340462_452470228;
		i_340434_452470228 = (NI)0;
		HEX3Atmp_340459_452470228 = (NI)0;
		LOC2 = (NI)0;
		LOC2 = sonslen_295351_850551059(s0);
		HEX3Atmp_340459_452470228 = (NI)(LOC2 - ((NI) 1));
		res_340462_452470228 = ((NI) 0);
		{
			while (1) {
				if (!(res_340462_452470228 <= HEX3Atmp_340459_452470228)) goto LA4;
				i_340434_452470228 = res_340462_452470228;
				{
					NI64 LOC9;
					NI64 LOC10;
					if (!((*(*s0).kindU.S6.sons->data[i_340434_452470228]).kind == ((Tnodekind292020) 44))) goto LA7;
					LOC9 = (NI64)0;
					LOC9 = getordvalue_320129_3876443242((*(*s0).kindU.S6.sons->data[i_340434_452470228]).kindU.S6.sons->data[((NI) 1)]);
					LOC10 = (NI64)0;
					LOC10 = getordvalue_320129_3876443242((*(*s0).kindU.S6.sons->data[i_340434_452470228]).kindU.S6.sons->data[((NI) 0)]);
...
N_NIMCALL(Tnode292802*, complement_340392_452470228)(Tnode292802* a0) {
	...
	tobitset_340001_452470228(a0, (&x0));
	{
		NI i_340409_452470228;
		NI HEX3Atmp_340412_452470228;
		NI res_340415_452470228;
		i_340409_452470228 = (NI)0;
		HEX3Atmp_340412_452470228 = (NI)0;
		HEX3Atmp_340412_452470228 = (x0 ? (x0->Sup.len-1) : -1);
		res_340415_452470228 = ((NI) 0);
		{
			while (1) {
				if (!(res_340415_452470228 <= HEX3Atmp_340412_452470228)) goto LA3;
				i_340409_452470228 = res_340415_452470228;
				x0->data[i_340409_452470228] = (NI8)((NU8) ~(x0->data[i_340409_452470228]));
				res_340415_452470228 += ((NI) 1);
			} LA3: ;
		}
	}
	result0 = totreeset_340251_452470228(x0, (*a0).typ, (*a0).info);
