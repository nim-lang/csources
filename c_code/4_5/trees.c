...
N_NIMCALL(tsym186843*, getopsym_220704)(tnode186813* op) {
	...
	LA3: ;
	{
		nimln(90, "trees.nim");
		{
			...
			if (!(LOC8 <= 0)) goto LA9;
			nimln(90, "trees.nim");
			internalerror_164591((*op).Info, ((NimStringDesc*) &TMP2731));
		}
		goto LA6;
		LA9: ;
		{
...
N_NIMCALL(tnode186813*, extractrange_221271)(NU8 k, tnode186813* n, NI a, NI b) {
	...
	result = newnodei_188803(k, (*n).Info, (NI32)(TMP2734));
	i_221288 = 0;
	HEX3Atmp_221317 = 0;
	nimln(168, "trees.nim");
	nimln(168, "trees.nim");
	TMP2735 = subInt(b, a);
	HEX3Atmp_221317 = (NI32)(TMP2735);
	nimln(1457, "system.nim");
	res_221319 = 0;
	nimln(1458, "system.nim");
	while (1) {
		...
		if (((TMP2715[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2716));
		nimln(168, "trees.nim");
		TMP2736 = addInt(i_221288, a);
		if ((NU)((NI32)(TMP2736)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
		asgnRefNoCycle((void**) &(*result).kindU.S6.Sons->data[i_221288], (*n).kindU.S6.Sons->data[(NI32)(TMP2736)]);
		nimln(1460, "system.nim");
