...
N_NIMCALL(NIM_BOOL, boolarg_217038)(Tnode191813* n, NimStringDesc* name, NI pos, NIM_BOOL default_217043) {
	...
	LA3: ;
	{
		...
		LOC6 = ((*x).kind == ((NU8) 2));
		if (!(LOC6)) goto LA7;
		LOC6 = identeq_167484((*x).kindU.S5.ident, ((NimStringDesc*) &TMP1425));
		LA7: ;
		if (!LOC6) goto LA8;
		result = NIM_TRUE;
	}
	...
	LA8: ;
	{
		...
		LOC11 = ((*x).kind == ((NU8) 2));
		if (!(LOC11)) goto LA12;
		LOC11 = identeq_167484((*x).kindU.S5.ident, ((NimStringDesc*) &TMP1426));
		LA12: ;
		if (!LOC11) goto LA13;
		result = NIM_FALSE;
	}
...
N_NIMCALL(Tllstream178204*, filterstrip_217012)(Tllstream178204* stdin_217014, NimStringDesc* filename, Tnode191813* call) {
	...
	NimStringDesc* line;
	result = 0;
	pattern = strarg_217029(call, ((NimStringDesc*) &TMP1423), ((NI) 1), ((NimStringDesc*) &TMP1424));
	leading = boolarg_217038(call, ((NimStringDesc*) &TMP1427), ((NI) 2), NIM_TRUE);
	trailing = boolarg_217038(call, ((NimStringDesc*) &TMP1428), ((NI) 3), NIM_TRUE);
	result = llstreamopen_178220(((NimStringDesc*) &TMP1424));
...
N_NIMCALL(Tllstream178204*, filterreplace_217004)(Tllstream178204* stdin_217006, NimStringDesc* filename, Tnode191813* call) {
	...
	NimStringDesc* line;
	result = 0;
	sub = strarg_217029(call, ((NimStringDesc*) &TMP1429), ((NI) 1), ((NimStringDesc*) &TMP1424));
	{
		if (!((sub ? sub->Sup.len : 0) == ((NI) 0))) goto LA3;
		invalidpragma_217047(call);
	}
	LA3: ;
	by = strarg_217029(call, ((NimStringDesc*) &TMP1430), ((NI) 2), ((NimStringDesc*) &TMP1424));
	result = llstreamopen_178220(((NimStringDesc*) &TMP1424));
	line = rawNewString(((NI) 80));
	{
		while (1) {
