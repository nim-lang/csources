...
N_NIMCALL(void, TMP1925)(void* p, NI op);
...
STRING_LITERAL(TMP1911, "counter < length ", 17);
STRING_LITERAL(TMP1917, "not (data[h] == desc) ", 22);
STRING_LITERAL(TMP1918, "data[h] == nil ", 15);
STRING_LITERAL(TMP1927, "t.data[h] == nil ", 17);
STRING_LITERAL(TMP1928, "dest.data[h] == nil ", 20);
...
static N_INLINE(NIM_BOOL, mustrehash_169054)(NI length, NI counter) {
	...
	nimln(47, "intsets.nim");
	{
		...
		nimln(47, "intsets.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP1911));	}	LA3: ;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	LOC5 = 0;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	TMP1912 = mulInt(length, 2);
	nimln(48, "intsets.nim");
	TMP1913 = mulInt(counter, 3);
	LOC5 = ((NI32)(TMP1912) < (NI32)(TMP1913));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	TMP1914 = subInt(length, counter);
	LOC5 = ((NI32)(TMP1914) < 4);
	LA6: ;
	result = LOC5;
	popFrame();
...
static N_INLINE(NI, nexttry_169205)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1915 = mulInt(5, h);
	TMP1916 = addInt((NI32)(TMP1915), 1);
	result = (NI)((NI32)(TMP1916) & maxhash);
	popFrame();
	return result;
}
N_NIMCALL(ttrunk169039*, intsetget_169212)(tintset169043 t, NI key) {
...
N_NIMCALL(void, intsetrawinsert_169233)(tintset169043 t, ttrunkseq169041** data, ttrunk169039* desc) {
	...
	while (1) {
		...
		nimln(64, "intsets.nim");
		{
			...
			nimln(64, "intsets.nim");
			hiddenraiseassert_76217(((NimStringDesc*) &TMP1917));		}		LA4: ;
	...
	nimln(66, "intsets.nim");
	{
		...
		nimln(66, "intsets.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP1918));	}	LA8: ;
...
N_NIMCALL(void, intsetenlarge_169604)(tintset169043* t) {
	...
	nimln(72, "intsets.nim");
	nimln(72, "intsets.nim");
	TMP1919 = addInt((*t).Max, 1);
	TMP1920 = mulInt((NI32)(TMP1919), 2);
	TMP1921 = subInt((NI32)(TMP1920), 1);
	(*t).Max = (NI32)(TMP1921);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1922 = addInt((*t).Max, 1);
	n = (ttrunkseq169041*) newSeq((&NTI169041), (NI32)(TMP1922));
	i_169629 = 0;
...
N_NIMCALL(ttrunk169039*, intsetput_169661)(tintset169043* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		nimln(84, "intsets.nim");
		nimln(84, "intsets.nim");
		TMP1926 = addInt((*t).Max, 1);
		LOC8 = 0;
		LOC8 = mustrehash_169054((NI32)(TMP1926), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
	...
	nimln(88, "intsets.nim");
	{
		...
		nimln(88, "intsets.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP1927));	}	LA14: ;
...
N_NIMCALL(void, assign_169914)(tintset169043* dest, tintset169043 src) {
	...
	while (1) {
		...
		nimln(152, "intsets.nim");
		{
			...
			nimln(152, "intsets.nim");
			hiddenraiseassert_76217(((NimStringDesc*) &TMP1928));		}		LA5: ;
		n = 0;
...
N_NIMCALL(NimStringDesc*, HEX24_170076)(tintset169043 s) {
	...
	result = copyString(((NimStringDesc*) &TMP1929));
	key_170081 = 0;
...
appendString(result, ((NimStringDesc*) &TMP1931));
	popFrame();
	return result;
}
static N_INLINE(NIM_BOOL, empty_170096)(tintset169043 s) {
...
static TNimNode* TMP1923[3];
static TNimNode* TMP3349[4];
static TNimNode TMP1909[9];
NTI169039.size = sizeof(ttrunk169039);
NTI169039.kind = 18;
NTI169039.base = 0;
TMP1923[0] = &TMP1909[1];
TMP1909[1].kind = 1;
TMP1909[1].offset = offsetof(ttrunk169039, Next);
TMP1909[1].typ = (&NTI169037);
TMP1909[1].name = "next";
TMP1923[1] = &TMP1909[2];
TMP1909[2].kind = 1;
TMP1909[2].offset = offsetof(ttrunk169039, Key);
TMP1909[2].typ = (&NTI105);
TMP1909[2].name = "key";
TMP1923[2] = &TMP1909[3];
TMP1909[3].kind = 1;
TMP1909[3].offset = offsetof(ttrunk169039, Bits);
TMP1909[3].typ = (&NTI21418);
TMP1909[3].name = "bits";
TMP1909[0].len = 3; TMP1909[0].kind = 2; TMP1909[0].sons = &TMP1923[0];
NTI169039.node = &TMP1909[0];
NTI169037.size = sizeof(ttrunk169039*);
NTI169037.kind = 22;
NTI169037.base = (&NTI169039);
NTI169037.marker = TMP1924;
NTI169041.size = sizeof(ttrunkseq169041*);
NTI169041.kind = 24;
NTI169041.base = (&NTI169037);
NTI169041.flags = 2;
NTI169041.marker = TMP1925;
...
TMP3349[0] = &TMP1909[5];
TMP1909[5].kind = 1;
TMP1909[5].offset = offsetof(tintset169043, Counter);
TMP1909[5].typ = (&NTI105);
TMP1909[5].name = "counter";
TMP3349[1] = &TMP1909[6];
TMP1909[6].kind = 1;
TMP1909[6].offset = offsetof(tintset169043, Max);
TMP1909[6].typ = (&NTI105);
TMP1909[6].name = "max";
TMP3349[2] = &TMP1909[7];
TMP1909[7].kind = 1;
TMP1909[7].offset = offsetof(tintset169043, Head);
TMP1909[7].typ = (&NTI169037);
TMP1909[7].name = "head";
TMP3349[3] = &TMP1909[8];
TMP1909[8].kind = 1;
TMP1909[8].offset = offsetof(tintset169043, Data);
TMP1909[8].typ = (&NTI169041);
TMP1909[8].name = "data";
TMP1909[4].len = 4; TMP1909[4].kind = 2; TMP1909[4].sons = &TMP3349[0];
NTI169043.node = &TMP1909[4];
}
