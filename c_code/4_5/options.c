...
static NIM_CONST TY122387 TMP442 = {
...
N_NIMCALL(NimStringDesc*, getgeneratedpath_136417)(void) {
	...
	LA3: ;
	{
		...
		result = HEX2F_109477(LOC6, ((NimStringDesc*) &TMP420));
	}
	LA1: ;
	popFrame();
	return result;
...
N_NIMCALL(NimStringDesc*, getpackagename_136811)(NimStringDesc* path) {
	...
	parents = 0;
	{
		...
		while (1) {
			...
			HEX3Atmp_136852 = HEX2F_109477(d_136817, ((NimStringDesc*) &TMP424));
			...
			nimln(1212, "os.nim");
			{
				...
				nimln(1213, "os.nim");
				nimln(1213, "os.nim");
				TMP425 = subInt(f_136854.gl_pathc, 1);
				HEX3Atmp_136860 = (NI32)(TMP425);
				...
				while (1) {
					...
					nimln(1214, "os.nim");
					{
						...
						nimln(1214, "os.nim");
						failedassertimpl_80021(((NimStringDesc*) &TMP426));
					}
					LA20: ;
					nimln(1215, "os.nim");
					nimln(1215, "os.nim");
...
static N_INLINE(void, writeln_137205)(FILE* f_137209, NimStringDesc** x_137213, NI x_137213Len0) {
	...
	nimln(172, "sysio.nim");
	write_10463(f_137209, ((NimStringDesc*) &TMP427));
	popFrame();
}
...
N_NIMCALL(void, libcandidates_137321)(NimStringDesc* s, TY10665** dest) {
	...
	nimln(347, "options.nim");
	{
		...
		nimln(350, "options.nim");
		TMP438 = subInt(ri, 1);
		HEX3Atmp_137351 = copyStrLast(s, (NI32)(TMP437), (NI32)(TMP438));
		...
		nimln(258, "strutils.nim");
		{
			...
			nimln(258, "strutils.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP439));
		}
		LA9: ;
		nimln(259, "strutils.nim");
		{
			...
			while (1) {
				...
				nimln(264, "strutils.nim");
				nimln(264, "strutils.nim");
				TMP440 = subInt(last_137353, 1);
				middle_137332 = copyStrLast(HEX3Atmp_137351, first_137355, (NI32)(TMP440));
...
N_NIMCALL(void, incldynliboverride_137369)(NimStringDesc* lib) {
	...
	nstPut(gdlloverrides_136204, LOC1, ((NimStringDesc*) &TMP444));
	popFrame();
}
...
N_NOINLINE(void, optionsInit)(void) {
	...
	LOC1 = 0;
	LOC1 = outfile_136117; outfile_136117 = copyStringRC1(((NimStringDesc*) &TMP402));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(104, "options.nim");
	LOC2 = 0;
	LOC2 = docseesrcurl_136118; docseesrcurl_136118 = copyStringRC1(((NimStringDesc*) &TMP402));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(106, "options.nim");
	LOC3 = 0;
	LOC3 = headerfile_136119; headerfile_136119 = copyStringRC1(((NimStringDesc*) &TMP402));
	if (LOC3) nimGCunrefNoCycle(LOC3);
	nimln(107, "options.nim");
	gverbosity_136120 = 1;
	nimln(110, "options.nim");
	LOC4 = 0;
	LOC4 = gevalexpr_136123; gevalexpr_136123 = copyStringRC1(((NimStringDesc*) &TMP402));
	...
	LOC5 = 0;
	LOC5 = libpath_136205; libpath_136205 = copyStringRC1(((NimStringDesc*) &TMP402));
	if (LOC5) nimGCunrefNoCycle(LOC5);
	nimln(151, "options.nim");
	LOC6 = 0;
	LOC6 = gprojectname_136206; gprojectname_136206 = copyStringRC1(((NimStringDesc*) &TMP402));
	if (LOC6) nimGCunrefNoCycle(LOC6);
	nimln(152, "options.nim");
	LOC7 = 0;
	LOC7 = gprojectpath_136207; gprojectpath_136207 = copyStringRC1(((NimStringDesc*) &TMP402));
	if (LOC7) nimGCunrefNoCycle(LOC7);
	nimln(153, "options.nim");
	LOC8 = 0;
	LOC8 = gprojectfull_136208; gprojectfull_136208 = copyStringRC1(((NimStringDesc*) &TMP402));
	if (LOC8) nimGCunrefNoCycle(LOC8);
	nimln(155, "options.nim");
	LOC9 = 0;
	LOC9 = optmainmodule_136210; optmainmodule_136210 = copyStringRC1(((NimStringDesc*) &TMP402));
	if (LOC9) nimGCunrefNoCycle(LOC9);
	nimln(156, "options.nim");
	LOC10 = 0;
	LOC10 = nimcachedir_136211; nimcachedir_136211 = copyStringRC1(((NimStringDesc*) &TMP402));
	if (LOC10) nimGCunrefNoCycle(LOC10);
	nimln(157, "options.nim");
	LOC11 = 0;
	LOC11 = command_136212; command_136212 = copyStringRC1(((NimStringDesc*) &TMP402));
