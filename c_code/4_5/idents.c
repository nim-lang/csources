...
STRING_LITERAL(TMP978, "(id == 0) or (id == result.id) ", 31);
STRING_LITERAL(TMP982, ":anonymous", 10);
STRING_LITERAL(TMP983, ":delegator", 10);
...
N_NIMCALL(NI, cmpignorestyle_170036)(NCSTRING a, NCSTRING b, NI blen) {
	...
	while (1) {
		...
		nimln(43, "idents.nim");
		{
			...
			nimln(43, "idents.nim");
			nimln(43, "idents.nim");
			TMP974 = addInt(((NI) (((NU8)(aa)))), 32);
			aa = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP974), 0, 255))));
		}
		LA16: ;
		nimln(44, "idents.nim");
		{
			...
			nimln(44, "idents.nim");
			nimln(44, "idents.nim");
			TMP975 = addInt(((NI) (((NU8)(bb)))), 32);
			bb = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP975), 0, 255))));
		}
		LA22: ;
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
		nimln(45, "idents.nim");
		TMP976 = subInt(((NI) (((NU8)(aa)))), ((NI) (((NU8)(bb)))));
		result = (NI32)(TMP976);
		nimln(46, "idents.nim");
		{
			NIM_BOOL LOC26;
...
N_NIMCALL(NI, cmpexact_170186)(NCSTRING a, NCSTRING b, NI blen) {
	...
	while (1) {
		...
		nimln(59, "idents.nim");
		nimln(59, "idents.nim");
		TMP977 = subInt(((NI) (((NU8)(aa)))), ((NI) (((NU8)(bb)))));
		result = (NI32)(TMP977);
		nimln(60, "idents.nim");
		{
			NIM_BOOL LOC4;
	...
	while (1) {
		...
		LA5: ;
		{
			...
			nimln(82, "idents.nim");
			{
				...
				if (!!(LOC17)) goto LA19;
				nimln(82, "idents.nim");
				failedassertimpl_80621(((NimStringDesc*) &TMP978));
			}
			LA19: ;
			nimln(83, "idents.nim");
			id = (*result).Sup.Id;
...
N_NOINLINE(void, identsInit)(void) {
	...
	asgnRefNoCycle((void**) &idanon_170476, getident_170456(((NimStringDesc*) &TMP982)));
	nimln(109, "idents.nim");
	asgnRefNoCycle((void**) &iddelegator_170478, getident_170456(((NimStringDesc*) &TMP983)));
	popFrame();
}

N_NOINLINE(void, identsDatInit)(void) {
static TNimNode* TMP979[3];
static TNimNode TMP972[5];
NTI170013.size = sizeof(tidobj170013);
NTI170013.kind = 17;
NTI170013.base = (&NTI2409);
NTI170013.flags = 1;
TMP972[0].kind = 1;
TMP972[0].offset = offsetof(tidobj170013, Id);
TMP972[0].typ = (&NTI106);
TMP972[0].name = "id";
NTI170013.node = &TMP972[0];
...
TMP979[0] = &TMP972[2];
TMP972[2].kind = 1;
TMP972[2].offset = offsetof(tident170019, S);
TMP972[2].typ = (&NTI143);
TMP972[2].name = "s";
TMP979[1] = &TMP972[3];
TMP972[3].kind = 1;
TMP972[3].offset = offsetof(tident170019, Next);
TMP972[3].typ = (&NTI170017);
TMP972[3].name = "next";
TMP979[2] = &TMP972[4];
TMP972[4].kind = 1;
TMP972[4].offset = offsetof(tident170019, H);
TMP972[4].typ = (&NTI120013);
TMP972[4].name = "h";
TMP972[1].len = 3; TMP972[1].kind = 2; TMP972[1].sons = &TMP979[0];
NTI170019.node = &TMP972[1];
NTI170017.size = sizeof(tident170019*);
NTI170017.kind = 22;
NTI170017.base = (&NTI170019);
NTI170017.flags = 2;
NTI170017.marker = TMP980;
NTI170015.size = sizeof(tidobj170013*);
NTI170015.kind = 22;
NTI170015.base = (&NTI170013);
NTI170015.marker = TMP2050;
}
