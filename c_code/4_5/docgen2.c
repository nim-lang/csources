...
N_NIMCALL(tnode186813*, close_521014)(tpasscontext245003* p, tnode186813* n) {
	...
	nimln(25, "docgen2.nim");
	{
		...
		writeoutput_343719((*g).Doc, LOC7, ((NimStringDesc*) &TMP7623), usewarning);
...
TMP7622[0] = &TMP7620[1];
TMP7620[1].kind = 1;
TMP7620[1].offset = offsetof(tgen521008, Doc);
TMP7620[1].typ = (&NTI340007);
TMP7620[1].name = "doc";
TMP7622[1] = &TMP7620[2];
TMP7620[2].kind = 1;
TMP7620[2].offset = offsetof(tgen521008, Module);
TMP7620[2].typ = (&NTI186811);
TMP7620[2].name = "module";
TMP7620[0].len = 2; TMP7620[0].kind = 2; TMP7620[0].sons = &TMP7622[0];
NTI521008.node = &TMP7620[0];
NTI521010.size = sizeof(tgen521008*);
NTI521010.kind = 22;
NTI521010.base = (&NTI521008);
NTI521010.marker = TMP7625;
}
