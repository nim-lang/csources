...
NIM_CONST TY219016 parsernames_219015 = {((NimStringDesc*) &TMP2688),
...
N_NIMCALL(tnode186813*, parseall_219049)(tparsers219029* p) {
	...
	case ((NU8) 3):
	{
		...
		internalerror_164606(((NimStringDesc*) &TMP2700));
...
N_NIMCALL(NIM_BOOL, containsshebang_219100)(NimStringDesc* s, NI i) {
	...
	nimln(83, "syntaxes.nim");
	{
		...
		nimln(83, "syntaxes.nim");
		TMP2701 = addInt(i, 1);
		if ((NU)((NI32)(TMP2701)) > (NU)(s->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(s->data[(NI32)(TMP2701)]) == (NU8)(33));
		LA4: ;
		if (!LOC3) goto LA5;
...
N_NIMCALL(tnode186813*, parsepipe_219138)(NimStringDesc* filename, tllstream174204* inputstream) {
	...
	nimln(91, "syntaxes.nim");
	{
		...
		nimln(98, "syntaxes.nim");
		{
			...
			nimln(98, "syntaxes.nim");
			TMP2703 = addInt(i, 1);
			if ((NU)((NI32)(TMP2703)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC14 = ((NU8)(line->data[(NI32)(TMP2703)]) == (NU8)(33));
			LA15: ;
			if (!LOC14) goto LA16;
...
N_NIMCALL(tllstream174204*, evalpipe_219461)(tparsers219029* p, tnode186813* n, NimStringDesc* filename, tllstream174204* start) {
	...
	nimln(151, "syntaxes.nim");
	{
		...
		if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP2706[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2707));
		LOC7 = identeq_166469((*(*n).kindU.S6.Sons->data[0]).kindU.S5.Ident, ((NimStringDesc*) &TMP2708));
		LA10: ;
		if (!LOC7) goto LA11;
		i_219550 = 0;
		nimln(1450, "system.nim");
...
NTI219005.node = &TMP2281[6];
TMP2281[1].kind = 1;
TMP2281[1].offset = offsetof(tparsers219029, Skin);
TMP2281[1].typ = (&NTI219005);
TMP2281[1].name = "skin";
TMP2696[1] = &TMP2281[7];
TMP2281[7].kind = 1;
TMP2281[7].offset = offsetof(tparsers219029, Parser);
TMP2281[7].typ = (&NTI204203);
TMP2281[7].name = "parser";
TMP2281[0].len = 2; TMP2281[0].kind = 2; TMP2281[0].sons = &TMP2696[0];
NTI219029.node = &TMP2281[0];
}
