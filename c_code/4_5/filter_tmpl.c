...
NIM_CONST TY122387 patternchars_218037 = {
...
static NIM_CONST TY122387 TMP2669 = {
...
N_NIMCALL(void, newline_218040)(ttmplparser218017* p) {
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		nimln(42, "filter_tmpl.nim");
		llstreamwrite_174258((*p).Outp, ((NimStringDesc*) &TMP2664));
	}
	LA4: ;
...
N_NIMCALL(void, parseline_218177)(ttmplparser218017* p) {
	...
	LA6: ;
	{
		...
		case ((NU8) 20):
		{
			...
			LA19: ;
			{
				...
				localerror_164571((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP2666));
			}
			LA17: ;
		...
		case ((NU8) 60):
		{
			...
			nimln(104, "filter_tmpl.nim");
			{
				...
				nimln(104, "filter_tmpl.nim");
				LOC34 = 0;
				LOC34 = contains_91258((*p).X, TMP2669);
				if (!!(LOC34)) goto LA35;
	...
	LA9: ;
	{
				...
				nimln(150, "filter_tmpl.nim");
				{
					...
					case 123:
					{
						...
						while (1) {
							...
							case 0:
							{
								...
								localerror_164571((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP2677));
					...
					default:
					{
						...
						LA76: ;
						{
							...
							localerror_164571((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP2678));
						}
						LA74: ;
					}
					break;
		...
		llstreamwrite_174258((*p).Outp, ((NimStringDesc*) &TMP2679));
	}
	LA2: ;
	popFrame();
}
...
N_NIMCALL(tllstream174204*, filtertmpl_218007)(tllstream174204* stdin_218009, NimStringDesc* filename, tnode186813* call) {
	...
	p.Outp = llstreamopen_174218(((NimStringDesc*) &TMP2665));
	nimln(209, "filter_tmpl.nim");
	p.Inp = stdin_218009;
	nimln(210, "filter_tmpl.nim");
	p.Subschar = chararg_217014(call, ((NimStringDesc*) &TMP2680), 1, 36);
	nimln(211, "filter_tmpl.nim");
	p.Nimdirective = chararg_217014(call, ((NimStringDesc*) &TMP2681), 2, 35);
	nimln(212, "filter_tmpl.nim");
	p.Emit = strarg_217021(call, ((NimStringDesc*) &TMP2682), 3, ((NimStringDesc*) &TMP2683));
	nimln(213, "filter_tmpl.nim");
	p.Conc = strarg_217021(call, ((NimStringDesc*) &TMP2684), 4, ((NimStringDesc*) &TMP2685));
	nimln(214, "filter_tmpl.nim");
	p.Tostr = strarg_217021(call, ((NimStringDesc*) &TMP2686), 5, ((NimStringDesc*) &TMP2678));
