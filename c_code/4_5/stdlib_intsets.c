...
N_NIMCALL(void, intsetenlarge_221614)(intset221056* t) {
	...
	n = (ttrunkseq221054*) newSeq((&NTI221054), (NI32)((*t).Max + 1));
	{
		NI i_221648;
		NI res_221686;
		i_221648 = 0;
...
N_NIMCALL(ttrunk221052*, intsetput_221703)(intset221056* t, NI key) {
	...
	}
	{
		NIM_BOOL LOC9;
		LOC9 = 0;
		LOC9 = mustrehash_221073((NI32)((*t).Max + 1), (*t).Counter);
		if (!LOC9) goto LA10;
...
N_NIMCALL(void, incl_221869)(intset221056* s, NI key) {
	ttrunk221052* t;
	NI u;
	t = intsetput_221703(s, (NI)((NU32)(key) >> (NU32)(9)));
	u = (NI)(key & 511);
...
N_NIMCALL(NIM_BOOL, containsorincl_221916)(intset221056* s, NI key) {
	...
	ttrunk221052* t;
	result = 0;
	t = intsetget_221220((*s), (NI)((NU32)(key) >> (NU32)(9)));
	{
		NI u;
