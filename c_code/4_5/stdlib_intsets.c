...
static N_INLINE(NIM_BOOL, mustrehash_183058)(NI length, NI counter) {
	...
	nimln(47, "intsets.nim");
	{
		...
		nimln(47, "intsets.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP1937));
	}
	LA3: ;
...
N_NIMCALL(void, intsetrawinsert_183239)(tintset183047 t, ttrunkseq183045** data, ttrunk183043* desc) {
	...
	while (1) {
		...
		nimln(64, "intsets.nim");
		{
			...
			nimln(64, "intsets.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP1943));
		}
		LA4: ;
	...
	nimln(66, "intsets.nim");
	{
		...
		nimln(66, "intsets.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP1944));
	}
	LA8: ;
...
N_NIMCALL(void, intsetenlarge_183621)(tintset183047* t) {
	...
	n = (ttrunkseq183045*) newSeq((&NTI183045), (NI32)(TMP1948));
	i_183655 = 0;
...
N_NIMCALL(ttrunk183043*, intsetput_183696)(tintset183047* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_183058((NI32)(TMP1952), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
	...
	nimln(88, "intsets.nim");
	{
		...
		nimln(88, "intsets.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP1953));
	}
	LA14: ;
...
N_NIMCALL(void, assign_183956)(tintset183047* dest, tintset183047 src) {
	...
	while (1) {
		...
		nimln(152, "intsets.nim");
		{
			...
			nimln(152, "intsets.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP1954));
		}
		LA5: ;
		n = 0;
...
TMP1949[0] = &TMP1935[1];
TMP1935[1].kind = 1;
TMP1935[1].offset = offsetof(ttrunk183043, Next);
TMP1935[1].typ = (&NTI183041);
TMP1935[1].name = "next";
TMP1949[1] = &TMP1935[2];
TMP1935[2].kind = 1;
TMP1935[2].offset = offsetof(ttrunk183043, Key);
TMP1935[2].typ = (&NTI106);
TMP1935[2].name = "key";
TMP1949[2] = &TMP1935[3];
TMP1935[3].kind = 1;
TMP1935[3].offset = offsetof(ttrunk183043, Bits);
TMP1935[3].typ = (&NTI22818);
TMP1935[3].name = "bits";
TMP1935[0].len = 3; TMP1935[0].kind = 2; TMP1935[0].sons = &TMP1949[0];
NTI183043.node = &TMP1935[0];
NTI183041.size = sizeof(ttrunk183043*);
NTI183041.kind = 22;
NTI183041.base = (&NTI183043);
NTI183041.marker = TMP1950;
NTI183045.size = sizeof(ttrunkseq183045*);
NTI183045.kind = 24;
NTI183045.base = (&NTI183041);
NTI183045.flags = 2;
NTI183045.marker = TMP1951;
...
TMP3243[0] = &TMP1935[5];
TMP1935[5].kind = 1;
TMP1935[5].offset = offsetof(tintset183047, Counter);
TMP1935[5].typ = (&NTI106);
TMP1935[5].name = "counter";
TMP3243[1] = &TMP1935[6];
TMP1935[6].kind = 1;
TMP1935[6].offset = offsetof(tintset183047, Max);
TMP1935[6].typ = (&NTI106);
TMP1935[6].name = "max";
TMP3243[2] = &TMP1935[7];
TMP1935[7].kind = 1;
TMP1935[7].offset = offsetof(tintset183047, Head);
TMP1935[7].typ = (&NTI183041);
TMP1935[7].name = "head";
TMP3243[3] = &TMP1935[8];
TMP1935[8].kind = 1;
TMP1935[8].offset = offsetof(tintset183047, Data);
TMP1935[8].typ = (&NTI183045);
TMP1935[8].name = "data";
TMP1935[4].len = 4; TMP1935[4].kind = 2; TMP1935[4].sons = &TMP3243[0];
NTI183047.node = &TMP1935[4];
}
