...
appendString(LOC1, ((NimStringDesc*) &TMP4997));
	send_519209((*HEX3Aenvp_522440).stdoutsocket522408, LOC1, 2);
}
...
N_NIMCALL(void, serve_522257)(TY522259 action) {
	...
	typ = getconfigvar_154340(((NimStringDesc*) &TMP4988));
	...
	LA2: ;
	{
		...
		p = getconfigvar_154340(((NimStringDesc*) &TMP4993));
		{
			NI LOC18;
		...
		LA14: ;
		LOC20 = 0;
		LOC20 = getconfigvar_154340(((NimStringDesc*) &TMP4994));
		...
		writelnhook_164066.ClPrc = LOC21.ClPrc;
		{
			while (1) {
				...
				action();
				gerrorcounter_164019 = ((NI) 0);
				send_519209((*HEX3Aenv_522449).stdoutsocket522408, ((NimStringDesc*) &TMP4997), 2);
