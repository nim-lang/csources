...
N_NIMCALL(void, send_527203)(Socketimpl522404* socket, NimStringDesc* data, NU8 flags);
...
extern TY183114 writelnhook_183117;
...
appendString(LOC1, ((NimStringDesc*) &TMP5281));
	send_527203((*HEX3Aenvp_530424).stdoutsocket530408, LOC1, 2);
}
	...
	LA2: ;
	{
		...
		writelnhook_183117.ClPrc = LOC21.ClPrc;
		{
			while (1) {
				...
				action();
				gerrorcounter_183081 = ((NI) 0);
				send_527203((*HEX3Aenv_530426).stdoutsocket530408, ((NimStringDesc*) &TMP5281), 2);
