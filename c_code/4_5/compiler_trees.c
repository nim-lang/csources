...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isCaseObj_FTbvAnf1y9b9c3Krp9bsHDTiw_4)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n);
					...
					res = ((NI) 0);
					{
						while (1) {
							...
							i = res;
							{
								NIM_BOOL T37_;
								T37_ = (NIM_BOOL)0;
								T37_ = exprStructuralEquivalent_XApnXRaD9btY9a4pkMO0ITTg((*a).sons->data[i], (*b).sons->data[i], strictSymEquality);
								if (!!(T37_)) goto LA38_;
								goto BeforeRet_;
							}
							LA38_: ;
...
N_LIB_PRIVATE N_NIMCALL(tyEnum_TSpecialWord_ycbpMCRV6Cd2eBh3X9biEiw, whichPragma_tadMdqrtQd2cek9aFwyE1XQ)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	LA1_: ;
	{
		...
		result = whichKeyword_6Crk8YhMgh1FqDtsVJsurA((*key).ident);
	}
	LA11_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*, flattenStmts_kDuk7Mp6Hb4CD2EwZbGQ3g)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	unnestStmts_9c5lwXyiq4AUtthHD0LdCvQ(n, result);
	{
		NI T3_;
		T3_ = (NI)0;
		T3_ = len_CdME9baJhvveuPEDZE9bXoxArenderer(result);
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				i = i_2;
				{
					NIM_BOOL T10_;
					T10_ = (NIM_BOOL)0;
					T10_ = isCaseObj_FTbvAnf1y9b9c3Krp9bsHDTiw_4((*n).sons->data[i]);
					if (!T10_) goto LA11_;
					result = NIM_TRUE;
					goto BeforeRet_;
				}
...
{	result = (NIM_BOOL)0;
	...
	{
		result = isDeepConstExpr_FTbvAnf1y9b9c3Krp9bsHDTiw_3((*n).sons->data[((NI) 1)]);
	}
	break;
	...
	case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 44):
	{
			...
			i_2 = colontmp_;
			{
				while (1) {
					...
					i = i_2;
					{
						NIM_BOOL T9_;
						T9_ = (NIM_BOOL)0;
						T9_ = isDeepConstExpr_FTbvAnf1y9b9c3Krp9bsHDTiw_3((*n).sons->data[i]);
						if (!!(T9_)) goto LA10_;
						result = NIM_FALSE;
						goto BeforeRet_;
					}
		...
		LA14_: ;
		{
			...
			LA19_: ;
			{
				...
				if (T23_) goto LA24_;
				T25_ = (NIM_BOOL)0;
				T25_ = isCaseObj_FTbvAnf1y9b9c3Krp9bsHDTiw_4((*t).n);
				T23_ = !(T25_);
				LA24_: ;
				if (!T23_) goto LA26_;
				result = NIM_TRUE;
