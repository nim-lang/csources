...
static NIM_CONST TY187025 TMP5613 = {
...
static NIM_CONST TY187025 TMP5620 = {
...
static N_INLINE(tnode186813*, lastson_187199)(tnode186813* n) {
	...
	if ((NU)((NI32)(TMP5618)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI32)(TMP5618)];
	popFrame();
	return result;
}
...
N_NIMCALL(NU8, ispartofaux_411020)(tnode186813* n, ttype186847* b, tintset183047* marker) {
	...
	case ((NU8) 137):
	{
		...
		nimln(29, "aliases.nim");
		{
			...
			nimln(29, "aliases.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP5616));
		}
		LA11: ;
		...
		while (1) {
			...
			default:
			{
				...
				internalerror_164606(((NimStringDesc*) &TMP5619));
			}
			break;
			}
			nimln(1453, "system.nim");
	...
	default:
	{
		...
		internalerror_164591((*n).Info, ((NimStringDesc*) &TMP5622));
	}
	break;
	}
	BeforeRet: ;
...
static N_INLINE(ttype186847*, lastson_187203)(ttype186847* n) {
	...
	if ((NU)((NI32)(TMP5623)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP5623)];
	popFrame();
	return result;
}
