...
static NIM_CONST TY192025 TMP5619 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5620, "sons", 4);
STRING_LITERAL(TMP5622, "n.sons[0].kind == nkSym ", 24);
STRING_LITERAL(TMP5625, "isPartOfAux(record case branch)", 31);
static NIM_CONST TY192025 TMP5626 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5627, "sym", 3);
STRING_LITERAL(TMP5628, "isPartOfAux()", 13);
...
static N_INLINE(tnode191813*, lastson_192199)(tnode191813* n) {
	...
	if ((NU)((NI32)(TMP5624)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI32)(TMP5624)];
	popFrame();
	return result;
}
...
N_NIMCALL(NU8, ispartofaux_416020)(tnode191813* n, ttype191847* b, tintset188047* marker) {
	...
	case ((NU8) 137):
	{
		...
		nimln(29, "aliases.nim");
		{
			...
			nimln(29, "aliases.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP5622));
		}
		LA11: ;
...
static N_INLINE(ttype191847*, lastson_192203)(ttype191847* n) {
	...
	TMP5629 = subInt(LOC1, 1);
	if ((NU)((NI32)(TMP5629)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP5629)];
	popFrame();
	return result;
}
