...
N_NIMCALL(void, serve_605259)(TY605261 action) {
	NimStringDesc* typ;
	typ = getconfigvar_169348(((NimStringDesc*) &TMP4828));
	...
	LA2: ;
	{
		...
		LA16: ;
		p = getconfigvar_169348(((NimStringDesc*) &TMP4836));
		{
			NI LOC23;
		...
		LA19: ;
		LOC25 = 0;
		LOC25 = getconfigvar_169348(((NimStringDesc*) &TMP4837));
		...
		stdoutsocket_196318 = (tsocketimpl182607*) newObjRC1((&NTI182609), sizeof(tsocketimpl182607));
		{
			while (1) {
				...
				gdirtyoriginalidx_169135 = ((NI32) 0);
				gerrorcounter_196306 = 0;
				send_193009(stdoutsocket_196318, ((NimStringDesc*) &TMP4845));
