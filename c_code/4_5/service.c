		...
		case ((NU8) 1):
		{
			...
			LA14: ;
			{
				...
				nimln(54, "service.nim");
				{
					...
					asgnRefNoCycle((void**) &gprojectname_136206, nosunixToNativePath(p.Key, ((NimStringDesc*) &TMP7638)));
...
N_NIMCALL(void, serve_524292)(TY524294 action) {
	...
	typ = getconfigvar_136311(((NimStringDesc*) &TMP7645));
	...
	LA2: ;
	{
		...
		p = getconfigvar_136311(((NimStringDesc*) &TMP7653));
		...
		nimln(90, "service.nim");
		LOC24 = 0;
		LOC24 = getconfigvar_136311(((NimStringDesc*) &TMP7654));
		...
		while (1) {
			...
			send_159605(stdoutsocket_163192, ((NimStringDesc*) &TMP7680));
...
N_NOINLINE(void, serviceInit)(void) {
	...
	LOC1 = 0;
	LOC1 = curcaascmd_524203; curcaascmd_524203 = copyStringRC1(((NimStringDesc*) &TMP7638));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(25, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_524204; lastcaascmd_524204 = copyStringRC1(((NimStringDesc*) &TMP7638));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(28, "service.nim");
	LOC3 = 0;
	LOC3 = arguments_524205; arguments_524205 = copyStringRC1(((NimStringDesc*) &TMP7638));
