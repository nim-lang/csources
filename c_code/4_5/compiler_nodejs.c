...
STRING_LITERAL(TMP5310, "nodejs", 6);
STRING_LITERAL(TMP5311, "node", 4);
STRING_LITERAL(TMP5312, "iojs", 4);

N_NIMCALL(NimStringDesc*, findnodejs_534003)(void) {
	NimStringDesc* result;
	result = 0;
	result = findexe_130801(((NimStringDesc*) &TMP5310));
	{
		if (!((result) && (result)->Sup.len == 0)) goto LA3;
		result = findexe_130801(((NimStringDesc*) &TMP5311));
	}
	LA3: ;
	{
