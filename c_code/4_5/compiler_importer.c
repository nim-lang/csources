...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w*, importModuleAs_ba7OzQFzICrAgiIt6PutIg)(tyObject_TContext_C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w* realModule);
...
N_LIB_PRIVATE N_NIMCALL(void, importAllSymbolsExcept_VkJ5Yfxurk8B6fbrJQREcQ)(tyObject_TContext_C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w* fromMod, tyObject_IntSet_PQrmFm4BXFkFSVOUl1ojSg* exceptSet);
...
N_LIB_PRIVATE N_NIMCALL(void, rawImportSymbol_76d9aAmJ09bg6HIM4yoqN0IA)(tyObject_TContext_C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w* s);
...
N_LIB_PRIVATE N_NIMCALL(void, importPureEnumField_BL6K9c8JjO6pkW9c9bdwe8NNA)(tyObject_TContext_C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w* s);
...
STRING_LITERAL(TM_NsDkQfDe2CjzDqtBRW9bqQg_8, " is deprecated", 14);
STRING_LITERAL(TM_NsDkQfDe2CjzDqtBRW9bqQg_9, "importAllSymbols: ", 18);
STRING_LITERAL(TM_NsDkQfDe2CjzDqtBRW9bqQg_10, " ", 1);
STRING_LITERAL(TM_NsDkQfDe2CjzDqtBRW9bqQg_11, "rawImportSymbol", 15);
STRING_LITERAL(TM_NsDkQfDe2CjzDqtBRW9bqQg_12, "importSymbol: 2", 15);
STRING_LITERAL(TM_NsDkQfDe2CjzDqtBRW9bqQg_13, "importSymbol: 3", 15);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*, transformImportAs_xmufAMBjGiK9cy1UljniTyg_2)(tyObject_TContext_C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	result = (tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*)0;
	{
		...
		add_gCCf68XrWL79bKes6htzFjQ(result, (*n).sons->data[((NI) 2)]);
	}
	goto LA1_;
	LA6_: ;
	{
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w*, importModuleAs_ba7OzQFzICrAgiIt6PutIg)(tyObject_TContext_C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w* realModule) {
	...
	LA3_: ;
	{
		...
		LA8_: ;
		if (!T6_) goto LA9_;
		localError_w3nlav3QVHhYSX6HNr5zYg((*(*c).graph).config, (*n).info, ((NimStringDesc*) &TM_NsDkQfDe2CjzDqtBRW9bqQg_5));
	}
	goto LA1_;
	LA9_: ;
	{
		if (!!(((*(*(*n).sons->data[((NI) 1)]).ident).Sup.id == (*(*realModule).name).Sup.id))) goto LA12_;
		result = createModuleAlias_rP1V2HHt4kHqu1N5aFN0Jw(realModule, (*(*n).sons->data[((NI) 1)]).ident, (*realModule).info, (*(*(*c).graph).config).options);
	}
	goto LA1_;
	LA12_: ;
	LA1_: ;
...
appendString(err, T18_);
		...
		result = importModuleAs_ba7OzQFzICrAgiIt6PutIg(c, n, T22_);
		asgnRef((void**) (&(*(*c).graph).importStack), (tySequence_48JTohSgTy339bRxHzUD8KA*) setLengthSeqV2(&((*(*c).graph).importStack)->Sup, (&NTI_48JTohSgTy339bRxHzUD8KA_), ((NI) (L))));
		{
			NIM_BOOL T25_;
			T25_ = (NIM_BOOL)0;
			...
			LA26_: ;
			if (!T25_) goto LA27_;
			localError_w3nlav3QVHhYSX6HNr5zYg((*(*c).graph).config, (*n).info, ((NimStringDesc*) &TM_NsDkQfDe2CjzDqtBRW9bqQg_6));
		}
		LA27_: ;
		{
...
appendString(T37_, ((NimStringDesc*) &TM_NsDkQfDe2CjzDqtBRW9bqQg_8));
				message_5K7hPSxmIuoAwPKVN0TTEA((*(*c).graph).config, (*n).info, ((tyEnum_TMsgKind_29cbg2fC1z5iM1PAI28kR5w) 15), T37_);
			}
			goto LA33_;
			LA35_: ;
			{
...
appendString(T39_, ((NimStringDesc*) &TM_NsDkQfDe2CjzDqtBRW9bqQg_8));
				message_5K7hPSxmIuoAwPKVN0TTEA((*(*c).graph).config, (*n).info, ((tyEnum_TMsgKind_29cbg2fC1z5iM1PAI28kR5w) 15), T39_);
			}
			LA33_: ;
		}
		LA31_: ;
		...
		T40_ = newSymNode_NJtIrnjsE5ii9ciiIDaE0HQ(result, (*n).info);
		add_gCCf68XrWL79bKes6htzFjQ(importStmtResult, T40_);
	}
	LA3_: ;
	return result;
}
				...
				res = ((NI) 0);
				{
					while (1) {
						...
						e = (*(*(*etyp).n).sons->data[j]).sym;
						{
							...
							internalError_D8dqnaUatN2bkUMHFGqMRA((*(*c).graph).config, (*s).info, ((NimStringDesc*) &TM_NsDkQfDe2CjzDqtBRW9bqQg_11));
						}
						LA27_: ;
						...
						} LA29: ;
						{
							if (!!((e == NIM_NIL))) goto LA37_;
							{
								...
								rawImportSymbol_76d9aAmJ09bg6HIM4yoqN0IA(c, e);
							}
							goto LA39_;
							LA41_: ;
							{
								importPureEnumField_BL6K9c8JjO6pkW9c9bdwe8NNA(c, e);
							}
							LA39_: ;
						}
						LA37_: ;
	...
	{
		{
			...
			addConverter_inNfCGikksRpQjXpo9c1Dng(c, s);
		}
		LA47_: ;
		{
			NIM_BOOL T51_;
			...
			if (!T51_) goto LA52_;
			addPattern_StB2JLqqxTehGDOv1QCzaw(c, s);
		}
		LA52_: ;
	}
	LA13_: ;
...
N_LIB_PRIVATE N_NIMCALL(void, importAllSymbolsExcept_VkJ5Yfxurk8B6fbrJQREcQ)(tyObject_TContext_C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w* fromMod, tyObject_IntSet_PQrmFm4BXFkFSVOUl1ojSg* exceptSet) {
	...
	s = initTabIter_MivcR840C8HhD7BQHi3G6A((&i), (*fromMod).tab);
	{
		while (1) {
...
appendString(T15_, ((NimStringDesc*) &TM_NsDkQfDe2CjzDqtBRW9bqQg_9));
appendString(T15_, reprEnum((NI)(*s).kind, (&NTI_cNCW9acsSznmEccl1fgQwkw_)));
appendString(T15_, ((NimStringDesc*) &TM_NsDkQfDe2CjzDqtBRW9bqQg_10));
appendString(T15_, (*(*s).name).s);
						internalError_D8dqnaUatN2bkUMHFGqMRA((*(*c).graph).config, (*s).info, T15_);
					}
					LA13_: ;
					{
						NIM_BOOL T18_;
						...
						LA19_: ;
						if (!T18_) goto LA21_;
						rawImportSymbol_76d9aAmJ09bg6HIM4yoqN0IA(c, s);
					}
					LA21_: ;
				}
				LA9_: ;
			...
			LA5_: ;
			s = nextIter_MivcR840C8HhD7BQHi3G6A_2((&i), (*fromMod).tab);
		} LA2: ;
	}
}
...
N_LIB_PRIVATE N_NIMCALL(void, impMod_YTCCnhjylgDJPhdgcPVaow)(tyObject_TContext_C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* it, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* importStmtResult) {
	...
	m = myImportModule_CVrUx9blms5FVPGpXYTGvdA(c, it_2, importStmtResult);
	{
		...
		addDecl_kIzwDef5z5q7A6T9a16wB8w(c, m, (*it_2).info);
		importAllSymbolsExcept_VkJ5Yfxurk8B6fbrJQREcQ(c, m, (&emptySet));
	}
	LA3_: ;
}
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				it = (*n).sons->data[i];
				{
					...
					if (!(T8_)) goto LA9_;
					T10_ = (NI)0;
					T10_ = len_CdME9baJhvveuPEDZE9bXoxArenderer(it);
					T8_ = (T10_ == ((NI) 3));
					LA9_: ;
					T7_ = T8_;
					if (!(T7_)) goto LA11_;
					T7_ = ((*(*it).sons->data[((NI) 2)]).kind == ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 41));
					LA11_: ;
					if (!T7_) goto LA12_;
					...
					add_gCCf68XrWL79bKes6htzFjQ(imp, sep);
					{
						...
						colontmp__2 = (*it).sons->data[((NI) 2)];
						{
							...
							i_2 = (NI)0;
							colontmp__3 = (NI)0;
							colontmp__3 = safeLen_CdME9baJhvveuPEDZE9bXoxA_2renderer(colontmp__2);
							i_3 = ((NI) 0);
							{
								while (1) {
									if (!(i_3 < colontmp__3)) goto LA17;
									i_2 = i_3;
									x = (*colontmp__2).sons->data[i_2];
									{
										NIM_BOOL T20_;
										...
										if (!(T20_)) goto LA21_;
										T20_ = eqStrings((*(*(*x).sons->data[((NI) 0)]).ident).s, ((NimStringDesc*) &TM_NsDkQfDe2CjzDqtBRW9bqQg_2));
										LA21_: ;
										if (!T20_) goto LA22_;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*, evalImportExcept_xmufAMBjGiK9cy1UljniTyg_3)(tyObject_TContext_C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	m = myImportModule_CVrUx9blms5FVPGpXYTGvdA(c, (*n).sons->data[((NI) 0)], result);
	{
		...
		if (!!((m == NIM_NIL))) goto LA3_;
		asgnRef((void**) (&(*n).sons->data[((NI) 0)]), newSymNode_UWZXukHA5As9aCftRHbafBg(m));
		addDecl_kIzwDef5z5q7A6T9a16wB8w(c, m, (*n).info);
		nimZeroMem((void*)(&T5_), sizeof(tyObject_IntSet_PQrmFm4BXFkFSVOUl1ojSg));
		readExceptSet_t9cI0oYChx2XYqk1hhh0lvA(c, n, (&T5_));
		importAllSymbolsExcept_VkJ5Yfxurk8B6fbrJQREcQ(c, m, (&T5_));
	}
	LA3_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(void, importSymbol_ncIWeYlZFEX0TM2Ytwb7Eg)(tyObject_TContext_C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w* fromMod) {
	...
	s = strTableGet_0xgFDJUQtGGr2e0Sq9aLIhA((*fromMod).tab, ident);
	{
	...
	{
		{
			...
			internalError_D8dqnaUatN2bkUMHFGqMRA((*(*c).graph).config, (*n).info, ((NimStringDesc*) &TM_NsDkQfDe2CjzDqtBRW9bqQg_12));
		}
		LA8_: ;
		switch ((*s).kind) {
		case ((tyEnum_TSymKind_cNCW9acsSznmEccl1fgQwkw) 12) ... ((tyEnum_TSymKind_cNCW9acsSznmEccl1fgQwkw) 18):
		{
			...
			tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w* e;
			nimZeroMem((void*)(&it), sizeof(tyObject_TIdentIter_Oi4goG2ACEsy9cyTe6OCPrA));
			e = initIdentIter_S3q38waBmqwNs9b4pTwOCOQ((&it), (*fromMod).tab, (*s).name);
			{
				while (1) {
					if (!!((e == NIM_NIL))) goto LA12;
					{
						if (!!(((*(*e).name).Sup.id == (*(*s).name).Sup.id))) goto LA15_;
						internalError_D8dqnaUatN2bkUMHFGqMRA((*(*c).graph).config, (*n).info, ((NimStringDesc*) &TM_NsDkQfDe2CjzDqtBRW9bqQg_13));
					}
					LA15_: ;
					rawImportSymbol_76d9aAmJ09bg6HIM4yoqN0IA(c, e);
					e = nextIdentIter_jigDNlH3irWs400Ruq7RXw((&it), (*fromMod).tab);
				} LA12: ;
			}
		}
		break;
	...
	LA1_: ;
	suggestSym_nUjK9c6nUBlRnsyc9a0Rm4jQsem((*(*c).graph).config, (*n).info, s, &(*(*c).graph).usageSym, NIM_FALSE);
}
		...
		addDecl_kIzwDef5z5q7A6T9a16wB8w(c, m, (*n).info);
		{
			...
			res = ((NI) 1);
			{
				while (1) {
					...
					i = res;
					{
						if (!!(((*(*n).sons->data[i]).kind == ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 23)))) goto LA11_;
...
N_LIB_PRIVATE N_NIMCALL(void, importAllSymbols_BYYWXXyrudFx4EKDsNazVQ)(tyObject_TContext_C9bB2okDBl3OKGUBiY5k5Ug* c, tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w* fromMod) {
	tyObject_IntSet_PQrmFm4BXFkFSVOUl1ojSg exceptSet;
	nimZeroMem((void*)(&exceptSet), sizeof(tyObject_IntSet_PQrmFm4BXFkFSVOUl1ojSg));
	importAllSymbolsExcept_VkJ5Yfxurk8B6fbrJQREcQ(c, fromMod, (&exceptSet));
}
