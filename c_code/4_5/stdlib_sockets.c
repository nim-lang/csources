...
N_NIMCALL(void, send_193009)(tsocketimpl182607* socket, NimStringDesc* data) {
	NI sent;
	{
		valueerror3249* e_193015;
		NimStringDesc* LOC5;
		if (!(*socket).Nonblocking) goto LA3;
		e_193015 = 0;
		e_193015 = (valueerror3249*) newObj((&NTI21201), sizeof(valueerror3249));
		(*e_193015).Sup.Sup.m_type = (&NTI3249);
		LOC5 = 0;
		LOC5 = (*e_193015).Sup.message; (*e_193015).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1973));
		if (LOC5) nimGCunrefNoCycle(LOC5);
		raiseException((Exception*)e_193015, "ValueError");
	}
	LA3: ;
