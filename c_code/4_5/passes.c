...
static NIM_CONST TY187025 TMP3174 = {
...
N_NIMCALL(void, processimplicits_245510)(TY10665* implicits, NU8 nodekind, tpasscontext245003** a) {
	...
	while (1) {
		...
		nimln(2800, "system.nim");
		{
			...
			nimln(2800, "system.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP3182));
		}
		LA9: ;
	} LA1: ;
	popFrame();
...
NTI245003.flags = 1;
TMP3109[0].kind = 1;
TMP3109[0].offset = offsetof(tpasscontext245003, Fromcache);
TMP3109[0].typ = (&NTI134);
TMP3109[0].name = "fromCache";
NTI245003.node = &TMP3109[0];
}
