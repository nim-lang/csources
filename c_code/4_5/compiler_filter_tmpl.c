...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP2592, "\012", 1);
STRING_LITERAL(TMP2593, "", 0);
STRING_LITERAL(TMP2594, "end", 3);
STRING_LITERAL(TMP2595, "#end", 4);
static NIM_CONST TY113118 TMP2597 = {
...
STRING_LITERAL(TMP2601, "\\x", 2);
STRING_LITERAL(TMP2602, "\\\\", 2);
STRING_LITERAL(TMP2603, "\\\'", 2);
STRING_LITERAL(TMP2604, "\\\"", 2);
STRING_LITERAL(TMP2605, "}", 1);
STRING_LITERAL(TMP2606, "$", 1);
STRING_LITERAL(TMP2607, "\\n\"", 3);
STRING_LITERAL(TMP2608, "subschar", 8);
STRING_LITERAL(TMP2609, "metachar", 8);
STRING_LITERAL(TMP2610, "emit", 4);
STRING_LITERAL(TMP2611, "result.add", 10);
STRING_LITERAL(TMP2612, "conc", 4);
STRING_LITERAL(TMP2613, " & ", 3);
STRING_LITERAL(TMP2614, "tostring", 8);
...
N_NIMCALL(void, newline_197039)(ttmplparser197016* p) {
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		nimln(42, "filter_tmpl.nim");
		llstreamwrite_162258((*p).Outp, ((NimStringDesc*) &TMP2592));	}	LA4: ;
...
N_NIMCALL(void, parseline_197134)(ttmplparser197016* p) {
	...
	LA6: ;
	{
		...
		keyw = copyString(((NimStringDesc*) &TMP2593));
		...
		case ((NU8) 20):
		{
			...
			LA19: ;
			{
				...
				localerror_139349((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP2594));			}			LA17: ;
			nimln(91, "filter_tmpl.nim");
			nimln(91, "filter_tmpl.nim");
			LOC22 = 0;
			LOC22 = nsuRepeatChar((*p).Indent, 32);
			llstreamwrite_162258((*p).Outp, LOC22);			nimln(92, "filter_tmpl.nim");
			llstreamwrite_162258((*p).Outp, ((NimStringDesc*) &TMP2595));		}		break;
		case ((NU8) 28):
		case ((NU8) 64):
		case ((NU8) 60):
		case ((NU8) 65):
		...
		case ((NU8) 24):
		{
			...
			nimln(99, "filter_tmpl.nim");
			nimln(99, "filter_tmpl.nim");
			TMP2596 = subInt((*p).Indent, 2);
			LOC27 = 0;
			LOC27 = nsuRepeatChar((NI32)(TMP2596), 32);
		...
		case ((NU8) 62):
		{
			...
			llstreamwrite_162258((*p).Outp, LOC31);			nimln(104, "filter_tmpl.nim");
			{
				...
				nimln(104, "filter_tmpl.nim");
				LOC34 = 0;
				LOC34 = contains_84683((*p).X, TMP2597);
				if (!!(LOC34)) goto LA35;
	...
	LA9: ;
	{
		...
		case ((NU8) 1):
		{
			...
			llstreamwrite_162258((*p).Outp, ((NimStringDesc*) &TMP2592));			nimln(123, "filter_tmpl.nim");
			nimln(123, "filter_tmpl.nim");
			nimln(123, "filter_tmpl.nim");
			TMP2598 = addInt((*p).Indent, 2);
			LOC42 = 0;
			LOC42 = nsuRepeatChar((NI32)(TMP2598), 32);
			llstreamwrite_162258((*p).Outp, LOC42);			nimln(124, "filter_tmpl.nim");
			llstreamwrite_162258((*p).Outp, ((NimStringDesc*) &TMP2599));		}		break;
		case ((NU8) 0):
		{
			NimStringDesc* LOC44;
			...
			llstreamwrite_162258((*p).Outp, ((NimStringDesc*) &TMP2600));			nimln(130, "filter_tmpl.nim");
		...
		while (1) {
			...
			case 128 ... 255:
			{
				...
				llstreamwrite_162258((*p).Outp, ((NimStringDesc*) &TMP2601));				nimln(138, "filter_tmpl.nim");
			...
			case 92:
			{
				...
				llstreamwrite_162258((*p).Outp, ((NimStringDesc*) &TMP2602));				nimln(142, "filter_tmpl.nim");
				j = addInt(j, 1);
			}			break;
			case 39:
			{
				nimln(144, "filter_tmpl.nim");
				llstreamwrite_162258((*p).Outp, ((NimStringDesc*) &TMP2603));				nimln(145, "filter_tmpl.nim");
				j = addInt(j, 1);
			}			break;
			case 34:
			{
				nimln(147, "filter_tmpl.nim");
				llstreamwrite_162258((*p).Outp, ((NimStringDesc*) &TMP2604));				nimln(148, "filter_tmpl.nim");
				j = addInt(j, 1);
			}			break;
			default:
			{
				nimln(150, "filter_tmpl.nim");
				{
					...
					case 123:
					{
						...
						while (1) {
							...
							case 0:
							{
								...
								localerror_139349((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP2605));								nimln(166, "filter_tmpl.nim");
								goto LA58;
							}							break;
							case 123:
							{
					...
					default:
					{
						...
						LA76: ;
						{
							...
							localerror_139349((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP2606));						}						LA74: ;
					}					break;
					}
				}				goto LA53;
				LA55: ;
		...
		llstreamwrite_162258((*p).Outp, ((NimStringDesc*) &TMP2607));	}	LA2: ;
	popFrame();
}
static N_INLINE(tlineinfo137509, newlineinfo_137986)(NimStringDesc* filename, NI line, NI col) {
...
N_NIMCALL(tllstream162204*, filtertmpl_197006)(tllstream162204* stdin_197008, NimStringDesc* filename, tnode172659* call) {
	...
	p.Outp = llstreamopen_162218(((NimStringDesc*) &TMP2593));
	nimln(209, "filter_tmpl.nim");
	p.Inp = stdin_197008;
	nimln(210, "filter_tmpl.nim");
	p.Subschar = chararg_196014(call, ((NimStringDesc*) &TMP2608), 1, 36);
	nimln(211, "filter_tmpl.nim");
	p.Nimdirective = chararg_196014(call, ((NimStringDesc*) &TMP2609), 2, 35);
	nimln(212, "filter_tmpl.nim");
	p.Emit = strarg_196021(call, ((NimStringDesc*) &TMP2610), 3, ((NimStringDesc*) &TMP2611));
	nimln(213, "filter_tmpl.nim");
	p.Conc = strarg_196021(call, ((NimStringDesc*) &TMP2612), 4, ((NimStringDesc*) &TMP2613));
	nimln(214, "filter_tmpl.nim");
	p.Tostr = strarg_196021(call, ((NimStringDesc*) &TMP2614), 5, ((NimStringDesc*) &TMP2606));
	...
	while (1) {
		...
		nimln(217, "filter_tmpl.nim");
		TMP2615 = addInt(p.Info.Line, ((NI16) 1));
		if (TMP2615 < -32768 || TMP2615 > 32767) raiseOverflow();
		p.Info.Line = (NI16)(TMP2615);
