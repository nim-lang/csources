...
static NIM_CONST TY192025 TMP2650 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2651, "sons", 4);
...
static NIM_CONST TY192025 TMP2657 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2658, "strVal", 6);
STRING_LITERAL(TMP2659, "true", 4);
STRING_LITERAL(TMP2660, "false", 5);
STRING_LITERAL(TMP2661, "startswith", 10);
STRING_LITERAL(TMP2662, "", 0);
STRING_LITERAL(TMP2663, "leading", 7);
STRING_LITERAL(TMP2664, "trailing", 8);
STRING_LITERAL(TMP2666, "sub", 3);
STRING_LITERAL(TMP2667, "by", 2);
...
static N_INLINE(NI, sonslen_192191)(tnode191813* n) {
	...
	{
		nimln(1300, "ast.nim");
		if (((TMP2650[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2651));
...
N_NIMCALL(tnode191813*, getarg_222042)(tnode191813* n, NimStringDesc* name, NI pos) {
	...
	TMP2652 = subInt(LOC5, 1);
	HEX3Atmp_222219 = (NI32)(TMP2652);
	...
	while (1) {
		...
		nimln(31, "filters.nim");
		{
			...
			nimln(32, "filters.nim");
			{
				...
				if (((TMP2650[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2651));
				if ((NU)(i_222074) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP2650[(*(*n).kindU.S6.Sons->data[i_222074]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_222074]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2651));
			...
			nimln(33, "filters.nim");
			{
				...
				if (((TMP2650[(*(*n).kindU.S6.Sons->data[i_222074]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_222074]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2651));
				if ((NU)(0) >= (NU)((*(*n).kindU.S6.Sons->data[i_222074]).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (!(((TMP2653[(*(*(*n).kindU.S6.Sons->data[i_222074]).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*(*n).kindU.S6.Sons->data[i_222074]).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2654));
				LOC17 = 0;
...
N_NIMCALL(NIM_BOOL, boolarg_222028)(tnode191813* n, NimStringDesc* name, NI pos, NIM_BOOL default_222033) {
	...
	LA3: ;
	{
		...
		LOC6 = identeq_170469((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2659));
		LA7: ;
		if (!LOC6) goto LA8;
		nimln(53, "filters.nim");
		result = NIM_TRUE;
	...
	LA8: ;
	{
		...
		nimln(54, "filters.nim");
		if (!(((TMP2653[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2654));
		LOC11 = identeq_170469((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2660));
		LA12: ;
		if (!LOC11) goto LA13;
		nimln(54, "filters.nim");
		result = NIM_FALSE;
...
N_NIMCALL(tllstream179204*, filterstrip_222008)(tllstream179204* stdin_222010, NimStringDesc* filename, tnode191813* call) {
	...
	pattern = strarg_222021(call, ((NimStringDesc*) &TMP2661), 1, ((NimStringDesc*) &TMP2662));
	nimln(59, "filters.nim");
	leading = boolarg_222028(call, ((NimStringDesc*) &TMP2663), 2, NIM_TRUE);
	nimln(60, "filters.nim");
	trailing = boolarg_222028(call, ((NimStringDesc*) &TMP2664), 3, NIM_TRUE);
	nimln(61, "filters.nim");
	result = llstreamopen_179218(((NimStringDesc*) &TMP2662));
...
N_NIMCALL(tllstream179204*, filterreplace_222002)(tllstream179204* stdin_222004, NimStringDesc* filename, tnode191813* call) {
	...
	sub = strarg_222021(call, ((NimStringDesc*) &TMP2666), 1, ((NimStringDesc*) &TMP2662));
	...
	by = strarg_222021(call, ((NimStringDesc*) &TMP2667), 2, ((NimStringDesc*) &TMP2662));
