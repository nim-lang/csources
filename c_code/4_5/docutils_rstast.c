...
appendString((*result), ind);
		...
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI32)(TMP3781), lvltochar_296257[((*n).Level)- 0]);
...
N_NIMCALL(tjsonnode291114*, renderrsttojsonnode_296567)(trstnode296009* node) {
	...
	nimln(295, "rstast.nim");
	{
		...
		add_292844(result, ((NimStringDesc*) &TMP3811), LOC6);
	}
	LA4: ;
	nimln(297, "rstast.nim");
	{
		...
		add_292844(result, ((NimStringDesc*) &TMP3812), LOC15);
	}
	LA12: ;
	popFrame();
	return result;
...
NTI296003.node = &TMP3611[67];
TMP3611[1].kind = 1;
TMP3611[1].offset = offsetof(trstnode296009, Kind);
TMP3611[1].typ = (&NTI296003);
TMP3611[1].name = "kind";
TMP3770[1] = &TMP3611[68];
TMP3611[68].kind = 1;
TMP3611[68].offset = offsetof(trstnode296009, Text);
TMP3611[68].typ = (&NTI143);
TMP3611[68].name = "text";
TMP3770[2] = &TMP3611[69];
TMP3611[69].kind = 1;
TMP3611[69].offset = offsetof(trstnode296009, Level);
TMP3611[69].typ = (&NTI106);
TMP3611[69].name = "level";
TMP3770[3] = &TMP3611[70];
TMP3611[70].kind = 1;
TMP3611[70].offset = offsetof(trstnode296009, Sons);
TMP3611[70].typ = (&NTI296084);
TMP3611[70].name = "sons";
TMP3611[0].len = 4; TMP3611[0].kind = 2; TMP3611[0].sons = &TMP3770[0];
NTI296009.node = &TMP3611[0];
NTI296005.size = sizeof(trstnode296009*);
NTI296005.kind = 22;
NTI296005.base = (&NTI296009);
NTI296005.flags = 2;
NTI296005.marker = TMP3775;
}
