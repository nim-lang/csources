...
N_LIB_PRIVATE N_NIMCALL(NI, fsReadData_TYaWywfT8qLRVVdONIVhkw)(tyObject_StreamObj_THYguAi9bSgidczZ3ywEIMQ* s, void* buffer, NI bufLen) {
	NI result;
	result = (NI)0;
	result = readBuffer_KlPu51VS9bI2c3McxFJupng_2((*((tyObject_FileStreamObj_9bEVSsOIpkY9cf5lCtaS39bPQ*) (s))).f, buffer, ((NI) (bufLen)));
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(void, fsWriteData_EOz6U9aIFgRtUqqdlm0VPhg_2)(tyObject_StreamObj_THYguAi9bSgidczZ3ywEIMQ* s, void* buffer, NI bufLen) {
	{
		...
		T3_ = (NI)0;
		T3_ = writeBuffer_KlPu51VS9bI2c3McxFJupng((*((tyObject_FileStreamObj_9bEVSsOIpkY9cf5lCtaS39bPQ*) (s))).f, buffer, ((NI) (bufLen)));
...
N_LIB_PRIVATE N_NIMCALL(NI, ssReadData_VwkmV0rE82KHQOm1pQyMKg)(tyObject_StreamObj_THYguAi9bSgidczZ3ywEIMQ* s, void* buffer, NI bufLen) {
	...
	result = ((bufLen <= (NI)(((*s_2).data ? (*s_2).data->Sup.len : 0) - (*s_2).pos)) ? bufLen : (NI)(((*s_2).data ? (*s_2).data->Sup.len : 0) - (*s_2).pos));
	{
		...
		copyMem_fPlwH3r9agN9aEHB6yCPMh0wsystem(buffer, ((void*) ((&(*s_2).data->data[(*s_2).pos]))), ((NI) (result)));
		(*s_2).pos += result;
	}
	goto LA1_;
	LA3_: ;
...
{	s_2 = ((tyObject_StringStreamObj_Olau5FPRehZBBEB77FHnfw*) (s));
	...
	LA7_: ;
	copyMem_fPlwH3r9agN9aEHB6yCPMh0wsystem(((void*) ((&(*s_2).data->data[(*s_2).pos]))), buffer, ((NI) (bufLen)));
	(*s_2).pos += bufLen;
	}BeforeRet_: ;
}
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readAll_KN3I0OGVr9bF9acs3y6DWpiA_2)(tyObject_StreamObj_THYguAi9bSgidczZ3ywEIMQ* s) {
	...
	result = (NimStringDesc*)0;
	{
		while (1) {
			...
			copyMem_fPlwH3r9agN9aEHB6yCPMh0wsystem(((void*) ((&result->data[prevLen]))), ((void*) ((&buffer[(((NI) 0))- 0]))), ((NI) (readBytes)));
			{
