...
static NIM_CONST TY187025 TMP3137 = {
...
N_NIMCALL(tsym186843*, getsyssym_241040)(NimStringDesc* name) {
	...
	if (!(((64 &(1<<(((*systemmodule_241017).Kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3113));
	nimln(39, "magicsys.nim");
	LOC1 = 0;
...
N_NIMCALL(void, setintlittype_241517)(tnode186813* result) {
	...
	default:
	{
		...
		internalerror_164591((*result).Info, ((NimStringDesc*) &TMP3139));
	}
	break;
	}
	popFrame();
