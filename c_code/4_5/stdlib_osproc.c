...
N_NIMCALL(NCSTRING*, envtocstringarray_5W8jibc9b9cn0LB5f6DkUbiA)(void) {
	...
	LOC5 = (void*)0;
	LOC5 = alloc0_4cubgSerkjpuLcj5MXjiLw(((NI) ((NI)((NI)(counter0 + ((NI) 1)) * ((NI) 4)))));
...
appendString(LOC10, val_l4zUk3N1L5q1rae9aqyrzlQ_2);
					x0 = LOC10;
					LOC11 = (void*)0;
					LOC11 = alloc_4cubgSerkjpuLcj5MXjiLw_2(((NI) ((NI)((x0 ? x0->Sup.len : 0) + ((NI) 1)))));
					result0[(i0)- 0] = ((NCSTRING) (LOC11));
					copymem_fPlwH3r9agN9aEHB6yCPMh0wsystem(((void*) (result0[(i0)- 0])), ((void*) ((&x0->data[((NI) 0)]))), ((NI) ((NI)((x0 ? x0->Sup.len : 0) + ((NI) 1)))));
					i0 += ((NI) 1);
...
N_NIMCALL(NCSTRING*, envtocstringarray_powWbjMeev5megN9bWVjfTw)(Stringtableobj_DKRIdH9c9cKI7YpQb9c0wKlEw* t0) {
	...
	LOC1 = nstlen(t0);
	LOC2 = (void*)0;
	LOC2 = alloc0_4cubgSerkjpuLcj5MXjiLw(((NI) ((NI)((NI)(LOC1 + ((NI) 1)) * ((NI) 4)))));
...
appendString(LOC11, val_l4zUk3N1L5q1rae9aqyrzlQ_3);
						x0 = LOC11;
						LOC12 = (void*)0;
						LOC12 = alloc_4cubgSerkjpuLcj5MXjiLw_2(((NI) ((NI)((x0 ? x0->Sup.len : 0) + ((NI) 1)))));
...
{	result0 = (NI)0;
	{
		...
		result0 = (NI)((NU32)(((NI) ((*p0).exitstatus))) >> (NU32)(((NI) 8)));
		goto BeforeRet;
	}
	LA3: ;
	{
