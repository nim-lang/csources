...
STRING_LITERAL(TMP2687, ".nimfix", 7);
STRING_LITERAL(TMP2695, "\015\012", 2);
STRING_LITERAL(TMP2696, "\012", 1);
...
N_NIMCALL(void, loadfile_293045)(tlineinfo195539 info) {
	...
	LA3: ;
	{
		...
		gsourcefiles_293040->data[i].Lines = (TY119408*) newSeqRC1((&NTI119408), 0);
		...
		gsourcefiles_293040->data[i].Isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP2687));
		{
			...
			res_293148 = rawNewString(80);
			{
				while (1) {
					...
					gsourcefiles_293040->data[i].Lines = (TY119408*) incrSeq(&(gsourcefiles_293040->data[i].Lines)->Sup, sizeof(NimStringDesc*));
					LOC15 = 0;
		...
		pos = lex.Bufpos;
		{
			while (1) {
				...
				case 13:
				{
					NimStringDesc* LOC20;
					LOC20 = 0;
					LOC20 = gsourcefiles_293040->data[i].Newline; gsourcefiles_293040->data[i].Newline = copyStringRC1(((NimStringDesc*) &TMP2695));
				...
				case 0:
				{
					NimStringDesc* LOC22;
					LOC22 = 0;
					LOC22 = gsourcefiles_293040->data[i].Newline; gsourcefiles_293040->data[i].Newline = copyStringRC1(((NimStringDesc*) &TMP2696));
...
N_NIMCALL(void, replacedeprecated_293247)(tlineinfo195539 info, tident200021* oldsym, tident200021* newsym) {
	...
	last = (NI32)((NI32)(first + LOC17) - 1);
	{
		...
		LOC21 = 0;
		LOC21 = HEX5BHEX5D_84158(line, LOC20);
		LOC22 = 0;
