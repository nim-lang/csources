...
N_NIMCALL(void, TMP1602)(void* p, NI op);
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY113118 TMP1606 = {
...
STRING_LITERAL(TMP1610, "... ", 4);
STRING_LITERAL(TMP1611, "\012", 1);
...
N_NIMCALL(tllstream162204*, llstreamopenstdin_162235)(void) {
	...
	LOC1 = 0;
	LOC1 = (*result).S; (*result).S = copyStringRC1(((NimStringDesc*) &TMP1603));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
N_NIMCALL(NIM_BOOL, endswithopr_162437)(NimStringDesc* x) {
	...
	result = endswith_162402(x, TMP1605);
	popFrame();
	return result;
}
static N_INLINE(NIM_BOOL, continueline_162443)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_162402(line, TMP1606);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(NI, counttriples_162462)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1607 = addInt(i, 1);
			if ((NU)((NI32)(TMP1607)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI32)(TMP1607)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1608 = addInt(i, 2);
			if ((NU)((NI32)(TMP1608)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI32)(TMP1608)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
N_NIMCALL(NI, llreadfromstdin_162501)(tllstream162204* s, void* buf, NI buflen) {
	...
	LOC1 = 0;
	LOC1 = (*s).S; (*s).S = copyStringRC1(((NimStringDesc*) &TMP1603));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	...
	while (1) {
		...
		LA6: ;
		{
			LOC3 = copyString(((NimStringDesc*) &TMP1610));
		}		LA4: ;
		LOC9 = 0;
...
appendString((*s).S, ((NimStringDesc*) &TMP1611));
	...
	result = ((buflen <= (NI32)(TMP1612)) ? buflen : (NI32)(TMP1612));
...
N_NIMCALL(NI, llstreamread_162242)(tllstream162204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		nimln(135, "llstream.nim");
		nimln(135, "llstream.nim");
		TMP1613 = subInt((*s).S->Sup.len, (*s).Rd);
		result = ((buflen <= (NI32)(TMP1613)) ? buflen : (NI32)(TMP1613));
		nimln(136, "llstream.nim");
		{
			...
			nimln(137, "llstream.nim");
			TMP1614 = addInt(0, (*s).Rd);
			if ((NU)((NI32)(TMP1614)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI32)(TMP1614)])), result);			nimln(138, "llstream.nim");
			(*s).Rd = addInt((*s).Rd, result);
		}		LA5: ;
	}	break;
	case ((NU8) 2):
...
N_NIMCALL(void, llstreamwriteln_162274)(tllstream162204* s, NimStringDesc* data) {
	...
	llstreamwrite_162258(s, ((NimStringDesc*) &TMP1611));	popFrame();
}
N_NIMCALL(void, llstreamwrite_162263)(tllstream162204* s, NIM_CHAR data) {
	NIM_CHAR c;
	nimfr("LLStreamWrite", "llstream.nim")
...
N_NIMCALL(void, llstreamwrite_162268)(tllstream162204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			nimln(200, "llstream.nim");
			nimln(200, "llstream.nim");
			TMP1615 = addInt((*s).S->Sup.len, buflen);
			(*s).S = setLengthStr((*s).S, (NI32)(TMP1615));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1616 = addInt(0, (*s).Wr);
			if ((NU)((NI32)(TMP1616)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI32)(TMP1616)])), buf, buflen);			nimln(202, "llstream.nim");
...
N_NIMCALL(NimStringDesc*, llstreamreadall_162254)(tllstream162204* s) {
	...
	case ((NU8) 3):
	{
		...
		result = copyString(((NimStringDesc*) &TMP1603));
	}	break;
	case ((NU8) 1):
	{
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			nimln(222, "llstream.nim");
			TMP1617 = addInt(i, 2048);
			result = setLengthStr(result, (NI32)(TMP1617));
			nimln(223, "llstream.nim");
			nimln(223, "llstream.nim");
			TMP1618 = addInt(i, 0);
			if ((NU)((NI32)(TMP1618)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_9514((*s).F, ((void*) (&result->data[(NI32)(TMP1618)])), 2048);
...
static TNimNode* TMP1598[6];
static TNimNode* TMP1599[4];
NI TMP1601;
static char* NIM_CONST TMP1600[4] = {
"llsNone", 
"llsString", 
"llsFile", 
"llsStdIn"};
static TNimNode TMP1596[12];
...
NTI162202.base = 0;
NTI162202.flags = 3;
for (TMP1601 = 0; TMP1601 < 4; TMP1601++) {
TMP1596[TMP1601+2].kind = 1;
TMP1596[TMP1601+2].offset = TMP1601;
TMP1596[TMP1601+2].name = TMP1600[TMP1601];
TMP1599[TMP1601] = &TMP1596[TMP1601+2];
}
TMP1596[6].len = 4; TMP1596[6].kind = 2; TMP1596[6].sons = &TMP1599[0];
NTI162202.node = &TMP1596[6];
TMP1596[1].kind = 1;
TMP1596[1].offset = offsetof(tllstream162204, Kind);
TMP1596[1].typ = (&NTI162202);
TMP1596[1].name = "kind";
TMP1598[1] = &TMP1596[7];
TMP1596[7].kind = 1;
TMP1596[7].offset = offsetof(tllstream162204, F);
TMP1596[7].typ = (&NTI9004);
TMP1596[7].name = "f";
TMP1598[2] = &TMP1596[8];
TMP1596[8].kind = 1;
TMP1596[8].offset = offsetof(tllstream162204, S);
TMP1596[8].typ = (&NTI142);
TMP1596[8].name = "s";
TMP1598[3] = &TMP1596[9];
TMP1596[9].kind = 1;
TMP1596[9].offset = offsetof(tllstream162204, Rd);
TMP1596[9].typ = (&NTI105);
TMP1596[9].name = "rd";
TMP1598[4] = &TMP1596[10];
TMP1596[10].kind = 1;
TMP1596[10].offset = offsetof(tllstream162204, Wr);
TMP1596[10].typ = (&NTI105);
TMP1596[10].name = "wr";
TMP1598[5] = &TMP1596[11];
TMP1596[11].kind = 1;
TMP1596[11].offset = offsetof(tllstream162204, Lineoffset);
TMP1596[11].typ = (&NTI105);
TMP1596[11].name = "lineOffset";
TMP1596[0].len = 6; TMP1596[0].kind = 2; TMP1596[0].sons = &TMP1598[0];
NTI162204.node = &TMP1596[0];
NTI162206.size = sizeof(tllstream162204*);
NTI162206.kind = 22;
NTI162206.base = (&NTI162204);
NTI162206.flags = 2;
NTI162206.marker = TMP1602;
}
