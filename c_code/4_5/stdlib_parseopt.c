...
static NIM_CONST TY122387 TMP7635 = {
0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY122387 TMP7636 = {
...
N_NIMCALL(void, initoptparser_522819)(NimStringDesc* cmdline, toptparser522807* Result) {
	...
	LA3: ;
	{
		...
		HEX3Atmp_522837 = paramcount_115233();
...
N_NIMCALL(void, handleshortoption_523106)(toptparser522807* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_523002((*p).Cmd, i, &(*p).Val, TMP7635);
	}
	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser522807* p) {
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_523002((*p).Cmd, i, &(*p).Key, TMP7636);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_523002((*p).Cmd, i, &(*p).Val, TMP7635);
			}
			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_523002((*p).Cmd, i, &(*p).Key, TMP7635);
	}
	break;
	}
	BeforeRet: ;
...
TMP7639[0] = &TMP7628[1];
TMP7628[1].kind = 1;
TMP7628[1].offset = offsetof(toptparser522807, Cmd);
TMP7628[1].typ = (&NTI143);
TMP7628[1].name = "cmd";
TMP7639[1] = &TMP7628[2];
TMP7628[2].kind = 1;
TMP7628[2].offset = offsetof(toptparser522807, Pos);
TMP7628[2].typ = (&NTI106);
TMP7628[2].name = "pos";
TMP7639[2] = &TMP7628[3];
TMP7628[3].kind = 1;
TMP7628[3].offset = offsetof(toptparser522807, Inshortstate);
...
NTI522805.node = &TMP7628[9];
TMP7628[4].kind = 1;
TMP7628[4].offset = offsetof(toptparser522807, Kind);
TMP7628[4].typ = (&NTI522805);
TMP7628[4].name = "kind";
TMP7639[4] = &TMP7628[10];
TMP7628[10].kind = 1;
TMP7628[10].offset = offsetof(toptparser522807, Key);
TMP7628[10].typ = (&NTI143);
TMP7628[10].name = "key";
TMP7639[5] = &TMP7628[11];
TMP7628[11].kind = 1;
TMP7628[11].offset = offsetof(toptparser522807, Val);
TMP7628[11].typ = (&NTI143);
TMP7628[11].name = "val";
TMP7628[0].len = 6; TMP7628[0].kind = 2; TMP7628[0].sons = &TMP7639[0];
NTI522807.node = &TMP7628[0];
}
