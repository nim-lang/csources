...
NIM_CONST TY85745 TMP3108 = {((NimStringDesc*) &TMP3109),
((NI) 100)}
;
NIM_CONST TY85745 TMP3110 = {((NimStringDesc*) &TMP3109),
((NI) 107)}
;
...
{	result = 0;
	...
	case ((NU8) 32):
	{
		...
		op = (*n).kindU.S6.Sons->data[((NI) 0)];
		{
			...
			LOC4 = ((*op).Kind == ((NU8) 3));
			if (!(LOC4)) goto LA5;
			LOC4 = isroutine_212564((*op).kindU.S4.Sym);
			LA5: ;
			if (!LOC4) goto LA6;
			s = (*op).kindU.S4.Sym;
			{
