...
NIM_CONST TY85745 TMP3031 = {((NimStringDesc*) &TMP3032),
100}
;
NIM_CONST TY85745 TMP3033 = {((NimStringDesc*) &TMP3032),
107}
;
...
{	result = 0;
	...
	case ((NU8) 32):
	{
		...
		op = (*n).kindU.S6.Sons->data[0];
		{
			...
			LOC4 = ((*op).Kind == ((NU8) 3));
			if (!(LOC4)) goto LA5;
			LOC4 = isroutine_215825((*op).kindU.S4.Sym);
			LA5: ;
			if (!LOC4) goto LA6;
			s = (*op).kindU.S4.Sym;
			{
...
N_NIMCALL(tnode209818*, semnodekindconstraints_292376)(tnode209818* p) {
	...
	(*result).kindU.S3.Strval = addChar((*result).kindU.S3.Strval, 1);
	{
		...
		}
		{
			...
			internalerror_183669((*p).Info, ((NimStringDesc*) &TMP3034));
		}
		LA12: ;
	}
	goto LA1;
