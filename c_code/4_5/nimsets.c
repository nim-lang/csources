...
static NIM_CONST TY187025 TMP3155 = {
...
N_NIMCALL(NIM_BOOL, inset_243013)(tnode186813* s, tnode186813* elem) {
	...
	nimln(34, "nimsets.nim");
	{
		...
		internalerror_164591((*s).Info, ((NimStringDesc*) &TMP3154));
	...
	while (1) {
		...
		nimln(38, "nimsets.nim");
		{
			...
			nimln(39, "nimsets.nim");
			{
				...
				if (((TMP3155[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3156));
				if ((NU)(i_243094) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP3155[(*(*s).kindU.S6.Sons->data[i_243094]).Kind/8] &(1<<((*(*s).kindU.S6.Sons->data[i_243094]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3156));
...
N_NIMCALL(NIM_BOOL, someinset_243018)(tnode186813* s, tnode186813* a, tnode186813* b) {
	...
	nimln(63, "nimsets.nim");
	{
		...
		internalerror_164591((*s).Info, ((NimStringDesc*) &TMP3158));
	...
	while (1) {
		...
		nimln(67, "nimsets.nim");
		{
			...
			nimln(68, "nimsets.nim");
			{
				...
				if (((TMP3155[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3156));
				if ((NU)(i_243368) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP3155[(*(*s).kindU.S6.Sons->data[i_243368]).Kind/8] &(1<<((*(*s).kindU.S6.Sons->data[i_243368]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3156));
...
N_NIMCALL(void, tobitset_243002)(tnode186813* s, tbitset242012** b) {
	...
	while (1) {
		...
		nimln(82, "nimsets.nim");
		{
			...
			if (((TMP3155[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3156));
			if ((NU)(i_243558) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (((TMP3155[(*(*s).kindU.S6.Sons->data[i_243558]).Kind/8] &(1<<((*(*s).kindU.S6.Sons->data[i_243558]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3156));
			...
			while (1) {
				...
				bitsetincl_242047(b, (NI64)(TMP3161));
	...
	while (1) {
		...
		nimln(102, "nimsets.nim");
		{
			...
			nimln(109, "nimsets.nim");
			{
				...
				LOC19 = 0;
				LOC19 = newinttypenode_187084(((NU8) 6), (NI64)(TMP3165), elemtype);
			...
			LA17: ;
			{
				...
				LOC21 = 0;
				LOC21 = newinttypenode_187084(((NU8) 6), (NI64)(TMP3166), elemtype);
				...
				LOC22 = 0;
				LOC22 = newinttypenode_187084(((NU8) 6), (NI64)(TMP3167), elemtype);
...
N_NIMCALL(NI64, cardset_243063)(tnode186813* s) {
	...
	while (1) {
		...
		nimln(155, "nimsets.nim");
		{
			...
			if (((TMP3155[(*s).Kind/8] &(1<<((*s).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3156));
			if ((NU)(i_243903) >= (NU)((*s).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (((TMP3155[(*(*s).kindU.S6.Sons->data[i_243903]).Kind/8] &(1<<((*(*s).kindU.S6.Sons->data[i_243903]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3156));
...
N_NIMCALL(NIM_BOOL, sethasrange_243029)(tnode186813* s) {
	...
	nimln(162, "nimsets.nim");
	{
		...
		internalerror_164591((*s).Info, ((NimStringDesc*) &TMP3172));
