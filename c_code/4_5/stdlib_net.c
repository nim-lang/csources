...
N_NIMCALL(NI32, getsocketerror_515001)(Socketimpl514407* socket) {
	...
	LA3: ;
	{
		...
		LOC9 = 0;
		LOC9 = (*e_515008).Sup.Sup.message; (*e_515008).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP4995));
...
N_NIMCALL(void, send_519209)(Socketimpl514407* socket, NimStringDesc* data, NU8 flags) {
	NI sent;
{	sent = send_518716(socket, ((void*) (data->data)), (data ? data->Sup.len : 0));
	...
	LA3: ;
	{
		Oserror3433* e_519220;
		NimStringDesc* LOC14;
		if (!!((sent == (data ? data->Sup.len : 0)))) goto LA12;
		e_519220 = 0;
		e_519220 = (Oserror3433*) newObj((&NTI116812), sizeof(Oserror3433));
		(*e_519220).Sup.Sup.Sup.m_type = (&NTI3433);
		LOC14 = 0;
		LOC14 = (*e_519220).Sup.Sup.message; (*e_519220).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP4996));
		if (LOC14) nimGCunrefNoCycle(LOC14);
		raiseException((Exception*)e_519220, "OSError");
	}
	LA12: ;
	}BeforeRet: ;
}
...
{	waited = 0.0;
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_517819(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5003));
			...
			LA4: ;
			{
				...
				LOC20 = 0;
				LOC20 = waitfor_517819(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5003));
