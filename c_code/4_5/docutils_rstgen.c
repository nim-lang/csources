...
STRING_LITERAL(TMP2106, "\012<h$1><a class=\"toc-backref\" id=\"$2\" href=\"#$2_toc\">$3</a></h$1"
">", 64);
STRING_LITERAL(TMP2107, "\\rsth$4{$3}\\label{$2}\012", 22);
STRING_LITERAL(TMP2108, "\012<h$1 id=\"$2\">$3</h$1>", 22);
STRING_LITERAL(TMP2109, "html", 4);
STRING_LITERAL(TMP2110, "\\", 1);
STRING_LITERAL(TMP2111, "\\\\", 2);
STRING_LITERAL(TMP2112, "\012", 1);
STRING_LITERAL(TMP2113, "\\n", 2);
STRING_LITERAL(TMP2114, "\011", 1);
STRING_LITERAL(TMP2115, "\\t", 2);
STRING_LITERAL(TMP2116, "<h$1 id=\"$2\"><center>$3</center></h$1>", 38);
STRING_LITERAL(TMP2117, "\\rstov$4{$3}\\label{$2}\012", 23);
STRING_LITERAL(TMP2118, "<hr />\012", 7);
STRING_LITERAL(TMP2119, "\\hrule\012", 7);
STRING_LITERAL(TMP2120, "<p>$1</p>\012", 10);
STRING_LITERAL(TMP2121, "$1\012\012", 4);
STRING_LITERAL(TMP2122, "<ul class=\"simple\">$1</ul>\012", 27);
STRING_LITERAL(TMP2123, "\\begin{itemize}$1\\end{itemize}\012", 31);
STRING_LITERAL(TMP2124, "<li>$1</li>\012", 12);
STRING_LITERAL(TMP2125, "\\item $1\012", 9);
STRING_LITERAL(TMP2126, "<ol class=\"simple\">$1</ol>\012", 27);
STRING_LITERAL(TMP2127, "\\begin{enumerate}$1\\end{enumerate}\012", 35);
STRING_LITERAL(TMP2128, "<dl class=\"docutils\">$1</dl>\012", 29);
STRING_LITERAL(TMP2129, "\\begin{description}$1\\end{description}\012", 39);
STRING_LITERAL(TMP2130, "<dt>$1</dt>\012", 12);
STRING_LITERAL(TMP2131, "\\item[$1] ", 10);
STRING_LITERAL(TMP2132, "<dd>$1</dd>\012", 12);
STRING_LITERAL(TMP2133, "$1\012", 3);
STRING_LITERAL(TMP2134, "<table class=\"docinfo\" frame=\"void\" rules=\"none\"><col class=\"do"
"cinfo-name\" /><col class=\"docinfo-content\" /><tbody valign=\"top\""
">$1</tbody></table>", 146);
STRING_LITERAL(TMP2135, " ", 1);
STRING_LITERAL(TMP2136, "&amp;", 5);
STRING_LITERAL(TMP2137, "&lt;", 4);
STRING_LITERAL(TMP2138, "&gt;", 4);
STRING_LITERAL(TMP2139, "&quot;", 6);
STRING_LITERAL(TMP2140, "\\_", 2);
STRING_LITERAL(TMP2141, "\\symbol{123}", 12);
STRING_LITERAL(TMP2142, "\\symbol{125}", 12);
STRING_LITERAL(TMP2143, "\\symbol{91}", 11);
STRING_LITERAL(TMP2144, "\\symbol{93}", 11);
STRING_LITERAL(TMP2145, "\\symbol{92}", 11);
STRING_LITERAL(TMP2146, "\\$", 2);
STRING_LITERAL(TMP2147, "\\&", 2);
STRING_LITERAL(TMP2148, "\\#", 2);
STRING_LITERAL(TMP2149, "\\%", 2);
STRING_LITERAL(TMP2150, "\\symbol{126}", 12);
STRING_LITERAL(TMP2151, "\\symbol{64}", 11);
STRING_LITERAL(TMP2152, "\\symbol{94}", 11);
STRING_LITERAL(TMP2153, "\\symbol{96}", 11);
STRING_LITERAL(TMP2154, "author", 6);
STRING_LITERAL(TMP2155, "authors", 7);
STRING_LITERAL(TMP2156, "version", 7);
STRING_LITERAL(TMP2157, "<tr>$1</tr>\012", 12);
STRING_LITERAL(TMP2158, "$1", 2);
STRING_LITERAL(TMP2159, "<th class=\"docinfo-name\">$1:</th>", 33);
STRING_LITERAL(TMP2160, "\\item[$1:]", 10);
STRING_LITERAL(TMP2161, "<td>$1</td>", 11);
STRING_LITERAL(TMP2162, " $1\012", 4);
STRING_LITERAL(TMP2163, "<table frame=\"void\">$1</table>", 30);
STRING_LITERAL(TMP2164, "\\begin{description}\012$1\\end{description}\012", 40);
STRING_LITERAL(TMP2165, "<th align=\"left\">$1</th>", 24);
STRING_LITERAL(TMP2166, "\\item[$1]", 9);
STRING_LITERAL(TMP2167, "<td align=\"left\">$1</td>\012", 25);
STRING_LITERAL(TMP2169, "false renderRstToOut", 20);
STRING_LITERAL(TMP2170, "<pre>$1</pre>\012", 14);
STRING_LITERAL(TMP2171, "\\begin{rstpre}\012$1\012\\end{rstpre}\012", 31);
STRING_LITERAL(TMP2172, "<p>$1</p>", 9);
STRING_LITERAL(TMP2173, "$1<br />", 8);
STRING_LITERAL(TMP2174, "$1\\\\\012", 5);
STRING_LITERAL(TMP2175, "<blockquote><p>$1</p></blockquote>\012", 35);
STRING_LITERAL(TMP2176, "\\begin{quote}$1\\end{quote}\012", 27);
STRING_LITERAL(TMP2177, "<table border=\"1\" class=\"docutils\">$1</table>", 45);
STRING_LITERAL(TMP2178, "\\begin{table}\\begin{rsttab}{", 28);
STRING_LITERAL(TMP2179, "|X", 2);
STRING_LITERAL(TMP2180, "|}\012\\hline\012$1\\end{rsttab}\\end{table}", 35);
STRING_LITERAL(TMP2181, " & ", 3);
STRING_LITERAL(TMP2182, "\\\\\012\\hline\012", 10);
STRING_LITERAL(TMP2183, "<tr>", 4);
STRING_LITERAL(TMP2184, "</tr>\012", 6);
STRING_LITERAL(TMP2185, "<th>$1</th>", 11);
STRING_LITERAL(TMP2186, "\\textbf{$1}", 11);
STRING_LITERAL(TMP2187, "<a class=\"reference external\" href=\"#$2\">$1</a>", 47);
STRING_LITERAL(TMP2188, "$1\\ref{$2}", 10);
STRING_LITERAL(TMP2189, "<a class=\"reference external\" href=\"$1\">$1</a>", 46);
STRING_LITERAL(TMP2190, "\\href{$1}{$1}", 13);
STRING_LITERAL(TMP2191, "<a class=\"reference external\" href=\"$2\">$1</a>", 46);
STRING_LITERAL(TMP2192, "\\href{$2}{$1}", 13);
STRING_LITERAL(TMP2194, "scale", 5);
STRING_LITERAL(TMP2195, " scale=\"$1\"", 11);
STRING_LITERAL(TMP2196, " scale=$1", 9);
STRING_LITERAL(TMP2197, "height", 6);
STRING_LITERAL(TMP2198, " height=\"$1\"", 12);
STRING_LITERAL(TMP2199, " height=$1", 10);
STRING_LITERAL(TMP2200, "width", 5);
STRING_LITERAL(TMP2201, " width=\"$1\"", 11);
STRING_LITERAL(TMP2202, " width=$1", 9);
STRING_LITERAL(TMP2203, "alt", 3);
STRING_LITERAL(TMP2204, " alt=\"$1\"", 9);
STRING_LITERAL(TMP2205, "align", 5);
STRING_LITERAL(TMP2206, " align=\"$1\"", 11);
STRING_LITERAL(TMP2207, "[$1]", 4);
STRING_LITERAL(TMP2208, "<img src=\"$1\"$2 />", 18);
STRING_LITERAL(TMP2209, "\\includegraphics$2{$1}", 22);
STRING_LITERAL(TMP2217, "<pre>", 5);
...
STRING_LITERAL(TMP2412, "</pre>", 6);
STRING_LITERAL(TMP2413, "\012\\end{rstpre}\012", 14);
STRING_LITERAL(TMP2414, "<div>$1</div>", 13);
STRING_LITERAL(TMP2415, "<div class=\"$1\">$2</div>", 24);
STRING_LITERAL(TMP2416, "$2", 2);
STRING_LITERAL(TMP2417, "|$1|", 4);
STRING_LITERAL(TMP2418, "<sub>$1</sub>", 13);
STRING_LITERAL(TMP2419, "\\rstsub{$1}", 11);
STRING_LITERAL(TMP2420, "<sup>$1</sup>", 13);
STRING_LITERAL(TMP2421, "\\rstsup{$1}", 11);
STRING_LITERAL(TMP2422, "<em>$1</em>", 11);
STRING_LITERAL(TMP2423, "\\emph{$1}", 9);
STRING_LITERAL(TMP2424, "<strong>$1</strong>", 19);
STRING_LITERAL(TMP2425, "<strong><em>$1</em></strong>", 28);
STRING_LITERAL(TMP2426, "\\textbf{emph{$1}}", 17);
STRING_LITERAL(TMP2427, "<cite>$1</cite>", 15);
STRING_LITERAL(TMP2430, "<span id=\"$1\">$2</span>", 23);
STRING_LITERAL(TMP2431, "$2\\label{$1}", 12);
STRING_LITERAL(TMP2432, "<tt class=\"docutils literal\"><span class=\"pre\">$1</span></tt>", 61);
STRING_LITERAL(TMP2433, "\\texttt{$1}", 11);
STRING_LITERAL(TMP2434, "<img src=\"/images/smilies/$1.gif\" width=\"15\" \012        height=\"1"
"7\" hspace=\"2\" vspace=\"2\" />", 90);
STRING_LITERAL(TMP2435, "\\includegraphics{$1}", 20);
...
N_NIMCALL(NimStringDesc*, quoteindexcolumn_356690)(NimStringDesc* text) {
	...
	result = 0;
	LOC1 = 0;
	LOC1 = nsuReplaceStr(text, ((NimStringDesc*) &TMP2110), ((NimStringDesc*) &TMP2111));
	LOC2 = 0;
	LOC2 = nsuReplaceStr(LOC1, ((NimStringDesc*) &TMP2112), ((NimStringDesc*) &TMP2113));
	result = nsuReplaceStr(LOC2, ((NimStringDesc*) &TMP2114), ((NimStringDesc*) &TMP2115));
	return result;
}
...
N_NIMCALL(void, setindexterm_356710)(trstgenerator356016* d, NimStringDesc* id, NimStringDesc* term, NimStringDesc* linktitle, NimStringDesc* linkdesc) {
	...
	htmlfile = noschangeFileExt(LOC1, ((NimStringDesc*) &TMP2109));
...
appendString(entry, ((NimStringDesc*) &TMP2112));
	{
...
N_NIMCALL(void, renderheadline_362281)(trstgenerator356016* d, trstnode341011* n, NimStringDesc** result) {
	...
	refname = rstnodetorefname_342060(n);
	{
		...
		dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2106), ((NimStringDesc*) &TMP2107), LOC11, 4);
	}
	goto LA5;
	LA7: ;
	{
		...
		dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2108), ((NimStringDesc*) &TMP2107), LOC13, 4);
	}
	LA5: ;
	LOC14 = 0;
...
appendString(LOC15, tmp);
	setindexterm_356710(d, refname, LOC14, LOC15, ((NimStringDesc*) &TMP2104));
}
...
N_NIMCALL(void, renderoverline_362425)(trstgenerator356016* d, trstnode341011* n, NimStringDesc** result) {
	...
	LA10: ;
	{
		...
		dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2116), ((NimStringDesc*) &TMP2117), LOC21, 4);
	}
	LA1: ;
}
		...
		j = 0;
		{
			while (1) {
				...
				k = nextsplitpoint_356349(s, j);
				{
					NIM_BOOL LOC9;
					LOC9 = 0;
					LOC9 = !(eqStrings(splitter_356332, ((NimStringDesc*) &TMP2135)));
					if (LOC9) goto LA10;
...
N_NIMCALL(void, renderfield_362927)(trstgenerator356016* d, trstnode341011* n, NimStringDesc** result) {
	...
	b = NIM_FALSE;
	{
		...
		fieldval = esc_356407((*d).Target, LOC6, -1);
		{
			...
			LOC9 = 0;
			LOC10 = 0;
			LOC10 = nsuCmpIgnoreStyle(fieldname, ((NimStringDesc*) &TMP2154));
			LOC9 = (LOC10 == 0);
			if (LOC9) goto LA11;
			LOC12 = 0;
			LOC12 = nsuCmpIgnoreStyle(fieldname, ((NimStringDesc*) &TMP2155));
			LOC9 = (LOC12 == 0);
			LA11: ;
			if (!LOC9) goto LA13;
			{
		...
		LA13: ;
		{
			NI LOC20;
			LOC20 = 0;
			LOC20 = nsuCmpIgnoreStyle(fieldname, ((NimStringDesc*) &TMP2156));
	...
	{
		if (!!(b)) goto LA29;
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2157), ((NimStringDesc*) &TMP2158), result);
	}
	LA29: ;
}
...
N_NIMCALL(void, renderimage_362598)(trstgenerator356016* d, trstnode341011* n, NimStringDesc** result) {
	...
	NimStringDesc* s;
	TY169969 LOC31;
	options = copyString(((NimStringDesc*) &TMP2104));
	s = getfieldvalue_342072(n, ((NimStringDesc*) &TMP2194));
	{
		...
		dispa_356544((*d).Target, &options, ((NimStringDesc*) &TMP2195), ((NimStringDesc*) &TMP2196), LOC5, 1);
	}
	LA3: ;
	s = getfieldvalue_342072(n, ((NimStringDesc*) &TMP2197));
	{
		...
		dispa_356544((*d).Target, &options, ((NimStringDesc*) &TMP2198), ((NimStringDesc*) &TMP2199), LOC10, 1);
	}
	LA8: ;
	s = getfieldvalue_342072(n, ((NimStringDesc*) &TMP2200));
	{
		...
		dispa_356544((*d).Target, &options, ((NimStringDesc*) &TMP2201), ((NimStringDesc*) &TMP2202), LOC15, 1);
	}
	LA13: ;
	s = getfieldvalue_342072(n, ((NimStringDesc*) &TMP2203));
	{
		...
		dispa_356544((*d).Target, &options, ((NimStringDesc*) &TMP2204), ((NimStringDesc*) &TMP2104), LOC20, 1);
	}
	LA18: ;
	s = getfieldvalue_342072(n, ((NimStringDesc*) &TMP2205));
	{
		TY197301 LOC25;
		if (!!(((s) && (s)->Sup.len == 0))) goto LA23;
		memset((void*)LOC25, 0, sizeof(LOC25));
		LOC25[0] = nsuStrip(s, NIM_TRUE, NIM_TRUE);
		dispa_356544((*d).Target, &options, ((NimStringDesc*) &TMP2206), ((NimStringDesc*) &TMP2104), LOC25, 1);
	}
	LA23: ;
	{
		TY197301 LOC30;
		...
		options = dispf_356521((*d).Target, ((NimStringDesc*) &TMP2158), ((NimStringDesc*) &TMP2207), LOC30, 1);
	}
	LA28: ;
	memset((void*)LOC31, 0, sizeof(LOC31));
	LOC31[0] = getargument_342079(n);
	LOC31[1] = copyString(options);
	dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2208), ((NimStringDesc*) &TMP2209), LOC31, 2);
	{
		NI LOC34;
		LOC34 = 0;
		LOC34 = len_341084(n);
...
N_NIMCALL(void, rendercodeblock_362662)(trstgenerator356016* d, trstnode341011* n, NimStringDesc** result) {
	...
	LA6: ;
	memset((void*)LOC11, 0, sizeof(LOC11));
	dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2217), ((NimStringDesc*) &TMP2218), LOC11, 0);
	{
...
appendString((*result), LOC24);
				...
				default:
				{
					...
					dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2377), ((NimStringDesc*) &TMP2378), LOC26, 2);
				}
				break;
				}
			}
	...
	dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2412), ((NimStringDesc*) &TMP2413), LOC28, 0);
	BeforeRet: ;
}
...
N_NIMCALL(void, rendercontainer_362866)(trstgenerator356016* d, trstnode341011* n, NimStringDesc** result) {
	...
	arg = nsuStrip(LOC1, NIM_TRUE, NIM_TRUE);
	{
		...
		dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2414), ((NimStringDesc*) &TMP2158), LOC6, 1);
	}
	goto LA2;
	LA4: ;
	{
		...
		dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2415), ((NimStringDesc*) &TMP2416), LOC8, 2);
	}
	LA2: ;
}
...
appendString(LOC8, LOC10);
	id = LOC8;
	term = copyString(((NimStringDesc*) &TMP2104));
	renderaux_356589(d, n_356874, &term);
	setindexterm_356710(d, id, term, (*d).Currentsection, ((NimStringDesc*) &TMP2104));
	memset((void*)LOC11, 0, sizeof(LOC11));
	LOC11[0] = copyString(id);
	LOC11[1] = copyString(term);
	dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2430), ((NimStringDesc*) &TMP2431), LOC11, 2);
}
...
N_NIMCALL(void, rendersmiley_362646)(trstgenerator356016* d, trstnode341011* n, NimStringDesc** result) {
	...
	dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2434), ((NimStringDesc*) &TMP2435), LOC1, 1);
}
...
N_NIMCALL(void, renderrsttoout_356579)(trstgenerator356016* d, trstnode341011* n, NimStringDesc** result) {
	...
	case ((NU8) 3):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2118), ((NimStringDesc*) &TMP2119), result);
	}
	break;
	case ((NU8) 4):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2120), ((NimStringDesc*) &TMP2121), result);
	}
	break;
	case ((NU8) 5):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2122), ((NimStringDesc*) &TMP2123), result);
	}
	break;
	case ((NU8) 6):
	case ((NU8) 8):
	...
	case ((NU8) 13):
	{
		...
		}
		{
			...
			dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2134), ((NimStringDesc*) &TMP2129), LOC26, 1);
		}
		LA24: ;
	}
	break;
	...
	case ((NU8) 15):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2159), ((NimStringDesc*) &TMP2160), result);
	}
	break;
	case ((NU8) 16):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2161), ((NimStringDesc*) &TMP2162), result);
	}
	break;
	case ((NU8) 51):
	{
	...
	case ((NU8) 23):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2167), ((NimStringDesc*) &TMP2162), result);
	}
	break;
	case ((NU8) 20):
	case ((NU8) 21):
	...
	{
		{
			...
			raiseassert_84747(((NimStringDesc*) &TMP2169));
		}
		LA38: ;
	}
	break;
	...
	case ((NU8) 26):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2172), ((NimStringDesc*) &TMP2121), result);
	}
	break;
	case ((NU8) 27):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2173), ((NimStringDesc*) &TMP2174), result);
	}
	break;
	case ((NU8) 28):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2175), ((NimStringDesc*) &TMP2176), result);
	}
	break;
	case ((NU8) 29):
	case ((NU8) 30):
...
appendString(LOC50, ((NimStringDesc*) &TMP2178));
appendString(LOC50, LOC51);
appendString(LOC50, ((NimStringDesc*) &TMP2180));
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2177), LOC50, result);
	}
	break;
	case ((NU8) 31):
	{
...
appendString((*result), ((NimStringDesc*) &TMP2184));
	...
	case ((NU8) 33):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2161), ((NimStringDesc*) &TMP2158), result);
	}
	break;
	case ((NU8) 32):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2185), ((NimStringDesc*) &TMP2186), result);
	}
	break;
	case ((NU8) 34):
	{
	...
	case ((NU8) 39):
	{
		...
		dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2187), ((NimStringDesc*) &TMP2188), LOC85, 2);
	}
	break;
	case ((NU8) 37):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2189), ((NimStringDesc*) &TMP2190), result);
	}
	break;
	case ((NU8) 38):
	{
		...
		NimStringDesc* tmp1;
		TY169969 LOC88;
		tmp0 = copyString(((NimStringDesc*) &TMP2104));
		tmp1 = copyString(((NimStringDesc*) &TMP2104));
		...
		dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2191), ((NimStringDesc*) &TMP2192), LOC88, 2);
	}
	break;
	case ((NU8) 41):
	case ((NU8) 42):
...
appendString((*result), LOC103);
	...
	case ((NU8) 52):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2417), ((NimStringDesc*) &TMP2417), result);
	}
	break;
	case ((NU8) 40):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2104), ((NimStringDesc*) &TMP2104), result);
	}
	break;
	case ((NU8) 53):
	{
		...
		dispa_356544((*d).Target, result, ((NimStringDesc*) &TMP2377), ((NimStringDesc*) &TMP2378), LOC110, 2);
	}
	break;
	case ((NU8) 54):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2418), ((NimStringDesc*) &TMP2419), result);
	}
	break;
	case ((NU8) 55):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2420), ((NimStringDesc*) &TMP2421), result);
	}
	break;
	case ((NU8) 57):
	{
	...
	case ((NU8) 58):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2424), ((NimStringDesc*) &TMP2186), result);
	}
	break;
	case ((NU8) 59):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2425), ((NimStringDesc*) &TMP2426), result);
	}
	break;
	case ((NU8) 60):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2427), ((NimStringDesc*) &TMP2423), result);
	}
	break;
	case ((NU8) 56):
	{
	...
	case ((NU8) 61):
	{
		renderaux_356629(d, n, ((NimStringDesc*) &TMP2432), ((NimStringDesc*) &TMP2433), result);
	}
	break;
	case ((NU8) 63):
	{
...
appendString((*result), LOC121);
	...
	case ((NU8) 43):
	{
		unsureAsgnRef((void**) &(*d).Meta[(((NU8) 1))- 0], copyString(((NimStringDesc*) &TMP2104)));
...
N_NIMCALL(void, initrstgenerator_356072)(trstgenerator356016* g, NU8 target, stringtableobj131012* config, NimStringDesc* filename, NU8 options, tfindfilehandler342023 findfile, tmsghandler342021 msghandler) {
	...
	(*g).Splitafter = 20;
	unsureAsgnRef((void**) &(*g).Theindex, copyString(((NimStringDesc*) &TMP2104)));
	(*g).Options = options;
	(*g).Findfile = findfile;
	unsureAsgnRef((void**) &(*g).Currentsection, copyString(((NimStringDesc*) &TMP2104)));
	...
	LA8: ;
	{
		...
		res_356270 = ((NU8) 0);
		{
			while (1) {
				...
				i_356266 = res_356270;
				unsureAsgnRef((void**) &(*g).Meta[(i_356266)- 0], copyString(((NimStringDesc*) &TMP2104)));
				res_356270 += 1;
			} LA12: ;
		}
	}
...
N_NIMCALL(NimStringDesc*, unquoteindexcolumn_356700)(NimStringDesc* text) {
	...
	result = 0;
	LOC1 = 0;
	LOC1 = nsuReplaceStr(text, ((NimStringDesc*) &TMP2115), ((NimStringDesc*) &TMP2114));
	LOC2 = 0;
	LOC2 = nsuReplaceStr(LOC1, ((NimStringDesc*) &TMP2113), ((NimStringDesc*) &TMP2112));
	result = nsuReplaceStr(LOC2, ((NimStringDesc*) &TMP2111), ((NimStringDesc*) &TMP2110));
	return result;
}
...
N_NIMCALL(NI, hash_357309)(tindexentry357264 x) {
	...
	LOC3 = 0;
	LOC3 = or_356568(x.Linktitle, ((NimStringDesc*) &TMP2104));
	LOC4 = 0;
	LOC4 = hash_128839(LOC3);
	result = HEX21HEX26_128025(result, LOC4);
	LOC5 = 0;
	LOC5 = or_356568(x.Linkdesc, ((NimStringDesc*) &TMP2104));
	LOC6 = 0;
...
N_NIMCALL(void, striptoclevel_357788)(NimStringDesc* s, TY357880* Result) {
	...
	unsureAsgnRef((void**) &(*Result).Field1, HEX5BHEX5D_84158(s, LOC8));
}
...
N_NIMCALL(NimStringDesc*, generatedocumentationindex_358231)(table357277 docs) {
	...
	TY358572 LOC13;
	result_358234 = 0;
	result_358234 = copyString(((NimStringDesc*) &TMP2104));
		...
		while (1) {
			...
			j = i;
			{
				while (1) {
					...
					LA15: ;
					{
						desc = copyString(((NimStringDesc*) &TMP2104));
					}
					LA13: ;
					{
						TY208063 LOC22;
