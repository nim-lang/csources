...
appendString(result, ((NimStringDesc*) &TMP3059));
		} LA2: ;
	}
	{
...
appendString(LOC6, LOC7);
	...
	{
		TSafePoint TMP3060;
		pushSafePoint(&TMP3060);
		TMP3060.status = _setjmp(TMP3060.context);
		if (TMP3060.status == 0) {
			Processobj149404* p;
			TY238694 LOC29;
		...
		if (TMP3060.status != 0) reraiseException();
	}
	LA1: ;
	}BeforeRet: ;
	return result;
