		...
		res_380139 = ((NI) 0);
		{
			while (1) {
				...
				i_380119 = res_380139;
				{
					...
					void_380132 = atomictypex_380072(((NimStringDesc*) &TMP2841), t, info);
...
N_NIMCALL(Tnode191813*, maptypetoast_380086)(Ttype191849* t, Tlineinfo163338 info, NIM_BOOL allowrecursion) {
	...
	case ((NU8) 16):
	{
		...
		result = newnodeit_193807(((NU8) 42), info, t);
		LOC9 = 0;
		LOC9 = atomictypex_380072(((NimStringDesc*) &TMP2838), t, info);
	...
	{
		{
			...
			result = newnodeit_193807(((NU8) 42), info, t);
			LOC18 = 0;
			LOC18 = atomictypex_380072(((NimStringDesc*) &TMP2839), t, info);
		...
		LA16: ;
		{
			result = atomictypex_380072(((NimStringDesc*) &TMP2840), t, info);
		}
		LA13: ;
	}
	break;
	...
	case ((NU8) 20):
	{
		...
		result = newnodeit_193807(((NU8) 42), info, t);
		LOC61 = 0;
		LOC61 = atomictypex_380072(((NimStringDesc*) &TMP2851), t, info);
	...
	case ((NU8) 50):
	{
		result = atomictypex_380072(((NimStringDesc*) &TMP2874), t, info);
	}
	break;
	case ((NU8) 51):
	{
	...
	case ((NU8) 58):
	{
		result = atomictypex_380072(((NimStringDesc*) &TMP2881), t, info);
	}
	break;
	case ((NU8) 59):
	case ((NU8) 60):
	case ((NU8) 61):
	{
		...
		result = newnodeit_193807(((NU8) 42), info, t);
		LOC96 = 0;
		LOC96 = atomictypex_380072(((NimStringDesc*) &TMP2882), t, info);
