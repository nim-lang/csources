...
static NIM_CONST TY187025 TMP5462 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5463, "sym", 3);
static NIM_CONST TY187025 TMP5464 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5465, "sons", 4);
STRING_LITERAL(TMP5467, "evaltempl.nim", 13);
NIM_CONST TY130008 TMP5466 = {((NimStringDesc*) &TMP5467),
39}
;
STRING_LITERAL(TMP5469, "", 0);
...
N_NIMCALL(tnode186813*, evaltemplateargs_390174)(tnode186813* n, tsym186843* s) {
	...
	nimln(65, "evaltempl.nim");
	{
		...
		if (!(f < a)) goto LA5;
		nimln(65, "evaltempl.nim");
		globalerror_164558((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP5469));
	}
	LA5: ;
	...
	while (1) {
		...
		LA10: ;
		{
			...
			if (!(((TMP5462[(*(*(*(*s).Typ).N).kindU.S6.Sons->data[i_390194]).Kind/8] &(1<<((*(*(*(*s).Typ).N).kindU.S6.Sons->data[i_390194]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5463));
		...
		nimln(70, "evaltempl.nim");
		{
			...
			localerror_164571((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP5469));
		}
		LA17: ;
...
N_NIMCALL(tnode186813*, evaltemplate_390275)(tnode186813* n, tsym186843* tmpl, tsym186843* gensymowner) {
	...
	nimln(79, "evaltempl.nim");
	{
		...
		globalerror_164558((*n).Info, ((NU16) 183), ((NimStringDesc*) &TMP5469));
