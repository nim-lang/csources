...
STRING_LITERAL(TMP2039, "@if", 3);
STRING_LITERAL(TMP2040, "@end", 4);
STRING_LITERAL(TMP2042, "putenv", 6);
STRING_LITERAL(TMP2043, "prependenv", 10);
STRING_LITERAL(TMP2044, "appendenv", 9);
STRING_LITERAL(TMP2045, "-", 1);
STRING_LITERAL(TMP2046, "--", 2);
STRING_LITERAL(TMP2047, "", 0);
STRING_LITERAL(TMP2048, "\']\'", 3);
STRING_LITERAL(TMP2049, "%=", 2);
STRING_LITERAL(TMP2050, "&", 1);
STRING_LITERAL(TMP2051, "config", 6);
STRING_LITERAL(TMP2052, "etc", 3);
STRING_LITERAL(TMP2053, "/etc/", 5);
STRING_LITERAL(TMP2055, "nimcfg", 6);
STRING_LITERAL(TMP2056, "nim.cfg", 7);
STRING_LITERAL(TMP2057, "nimrod.cfg", 10);
		...
		while (1) {
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = eqStrings((*(*tok).ident).s, ((NimStringDesc*) &TMP2036));
				LA6: ;
				if (!LOC5) goto LA7;
				ppgettok_210003(L, tok);
				LOC9 = 0;
			...
			LA7: ;
			{
				...
				lexmessage_205370((&(*L)), ((NU16) 24), ((NimStringDesc*) &TMP2040));
			}
			goto LA3;
			LA36: ;
			{
...
N_NIMCALL(void, parsedirective_210246)(Tlexer205173* L, Ttoken205169* tok) {
	...
	default:
	{
		...
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP2042))) goto LA15;
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP2043))) goto LA16;
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP2044))) goto LA17;
		goto LA18;
		LA15: ;
		{
			NimStringDesc* key;
...
N_NIMCALL(void, conftok_210275)(Tlexer205173* L, Ttoken205169* tok) {
	ppgettok_210003(L, tok);
	{
		while (1) {
			...
			if (!(LOC3)) goto LA4;
			LOC3 = eqStrings((*(*tok).ident).s, ((NimStringDesc*) &TMP2036));
			LA4: ;
			if (!LOC3) goto LA2;
...
N_NIMCALL(void, parseassignment_210319)(Tlexer205173* L, Ttoken205169* tok) {
	...
	Tident189012* LOC22;
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = getident_189441(((NimStringDesc*) &TMP2045));
		LOC3 = ((*(*tok).ident).Sup.id == (*LOC4).Sup.id);
		if (LOC3) goto LA5;
		LOC6 = 0;
		LOC6 = getident_189441(((NimStringDesc*) &TMP2046));
	...
	conftok_210275(L, tok);
	val = copyString(((NimStringDesc*) &TMP2047));
	{
		while (1) {
			NimStringDesc* LOC11;
...
appendString(val, LOC16);
		...
		LA19: ;
		{
			lexmessage_205370((&(*L)), ((NU16) 24), ((NimStringDesc*) &TMP2048));
		}
		LA17: ;
		val = addChar(val, 93);
	}
	LA14: ;
	LOC22 = 0;
	LOC22 = getident_189441(((NimStringDesc*) &TMP2049));
...
appendString(val, LOC33);
		conftok_210275(L, tok);
		{
			while (1) {
				...
				if (!(LOC36)) goto LA37;
				LOC38 = 0;
				LOC38 = getident_189441(((NimStringDesc*) &TMP2050));
...
N_NIMCALL(NimStringDesc*, getsystemconfigpath_210434)(NimStringDesc* filename) {
	...
	LOC1[0] = copyString(p);
	LOC1[1] = copyString(((NimStringDesc*) &TMP2051));
	...
	result = nosjoinPathOpenArray(LOC1, 3);
	{
		...
		LOC7[0] = copyString(p);
		LOC7[1] = copyString(((NimStringDesc*) &TMP2052));
...
appendString(LOC13, ((NimStringDesc*) &TMP2053));
	...
	LA18: ;
	{
		...
		readconfigfile_210382(LOC60);
		{
			...
			LA68: ;
			{
				...
				if (!!(LOC72)) goto LA73;
				projectconfig = noschangeFileExt(gprojectfull_160201, ((NimStringDesc*) &TMP2057));
				{
					NIM_BOOL LOC77;
					LOC77 = 0;
