...
STRING_LITERAL(TMP1898, "/usr", 4);
STRING_LITERAL(TMP1899, "/usr/lib/nim", 12);
STRING_LITERAL(TMP1900, "/usr/local", 10);
STRING_LITERAL(TMP1901, "/usr/local/lib/nim", 18);
STRING_LITERAL(TMP1902, "lib", 3);
...
STRING_LITERAL(TMP1919, "etc", 3);
STRING_LITERAL(TMP1920, "/etc/", 5);
STRING_LITERAL(TMP1922, "nimcfg", 6);
STRING_LITERAL(TMP1923, "nim.cfg", 7);
STRING_LITERAL(TMP1924, "nimrod.cfg", 10);
		...
		while (1) {
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = eqStrings((*(*tok).Ident).S, ((NimStringDesc*) &TMP1903));
				LA6: ;
				if (!LOC5) goto LA7;
				ppgettok_204009(l, tok);
				LOC9 = 0;
			...
			LA7: ;
			{
				...
				lexmessage_199289((&(*l)), ((NU16) 23), ((NimStringDesc*) &TMP1907));
			}
			goto LA3;
			LA36: ;
			{
...
N_NIMCALL(void, parsedirective_204369)(tlexer199190* l, ttoken199186* tok) {
	...
	default:
	{
		...
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP1909))) goto LA15;
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP1910))) goto LA16;
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP1911))) goto LA17;
		goto LA18;
		LA15: ;
		{
			NimStringDesc* key;
...
N_NIMCALL(void, conftok_204413)(tlexer199190* l, ttoken199186* tok) {
	ppgettok_204009(l, tok);
	{
		while (1) {
			...
			if (!(LOC3)) goto LA4;
			LOC3 = eqStrings((*(*tok).Ident).S, ((NimStringDesc*) &TMP1903));
			LA4: ;
			if (!LOC3) goto LA2;
...
N_NIMCALL(void, parseassignment_204486)(tlexer199190* l, ttoken199186* tok) {
	...
	tident185021* LOC22;
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = getident_185472(((NimStringDesc*) &TMP1912));
		LOC3 = ((*(*tok).Ident).Sup.Id == (*LOC4).Sup.Id);
		if (LOC3) goto LA5;
		LOC6 = 0;
		LOC6 = getident_185472(((NimStringDesc*) &TMP1913));
...
appendString(val, LOC16);
		...
		LA19: ;
		{
			lexmessage_199289((&(*l)), ((NU16) 23), ((NimStringDesc*) &TMP1915));
		}
		LA17: ;
		val = addChar(val, 93);
	}
	LA14: ;
	LOC22 = 0;
	LOC22 = getident_185472(((NimStringDesc*) &TMP1916));
...
appendString(val, LOC33);
		conftok_204413(l, tok);
		{
			while (1) {
				...
				if (!(LOC36)) goto LA37;
				LOC38 = 0;
				LOC38 = getident_185472(((NimStringDesc*) &TMP1917));
...
N_NIMCALL(NimStringDesc*, getsystemconfigpath_204655)(NimStringDesc* filename) {
	...
	result = nosjoinPathOpenArray(LOC1, 3);
	{
		...
		LOC7[0] = copyString(p);
		LOC7[1] = copyString(((NimStringDesc*) &TMP1919));
...
appendString(LOC13, ((NimStringDesc*) &TMP1920));
...
N_NIMCALL(void, loadconfigs_204811)(NimStringDesc* cfg) {
	NimStringDesc* pd;
	{
		...
		{
			NimStringDesc* LOC9;
			if (!eqStrings(prefix, ((NimStringDesc*) &TMP1898))) goto LA7;
			LOC9 = 0;
			LOC9 = libpath_170236; libpath_170236 = copyStringRC1(((NimStringDesc*) &TMP1899));
		...
		{
			NimStringDesc* LOC13;
			if (!eqStrings(prefix, ((NimStringDesc*) &TMP1900))) goto LA11;
			LOC13 = 0;
			LOC13 = libpath_170236; libpath_170236 = copyStringRC1(((NimStringDesc*) &TMP1901));
			if (LOC13) nimGCunrefNoCycle(LOC13);
		}
		goto LA5;
		LA11: ;
		{
			asgnRefNoCycle((void**) (&libpath_170236), nosjoinPath(prefix, ((NimStringDesc*) &TMP1902)));
		}
		LA5: ;
	}
	LA3: ;
	...
	LA32: ;
	{
		...
		readconfigfile_204576(LOC74);
		{
			...
			LA82: ;
			{
				...
				if (!!(LOC86)) goto LA87;
				projectconfig = noschangeFileExt(gprojectfull_170239, ((NimStringDesc*) &TMP1924));
				{
					NIM_BOOL LOC91;
					LOC91 = 0;
