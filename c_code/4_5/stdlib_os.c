...
STRING_LITERAL(TMP1079, "/proc/", 6);
STRING_LITERAL(TMP1080, "/path/a.out", 11);
...
STRING_LITERAL(TMP1939, "/.config/", 9);
...
N_NIMCALL(void, nossplitPath)(NimStringDesc* path, keyvaluepair131008* Result) {
	...
	seppos = ((NI) -1);
	{
		...
		i_117324 = 0;
		HEX3Atmp_117337 = 0;
		HEX3Atmp_117337 = (NI32)(path->Sup.len - ((NI) 1));
...
N_NIMCALL(NI, searchextpos_117536)(NimStringDesc* s) {
	...
	result = ((NI) -1);
	{
		...
		i_117551 = 0;
		HEX3Atmp_117564 = 0;
		HEX3Atmp_117564 = (NI32)(s->Sup.len - ((NI) 1));
...
N_NIMCALL(void, nossplitFile)(NimStringDesc* path, TY117589* Result) {
	...
	LA5: ;
	{
		...
		dotpos = path->Sup.len;
		{
			...
			i_117619 = 0;
			HEX3Atmp_117643 = 0;
			HEX3Atmp_117643 = (NI32)(path->Sup.len - ((NI) 1));
				...
				while (1) {
					...
					i_117619 = res_117646;
					{
						if (!((NU8)(path->data[i_117619]) == (NU8)(46))) goto LA13;
						{
							...
							LOC17 = LOC18;
							if (!(LOC17)) goto LA20;
							LOC17 = !((((NU8)(path->data[(NI32)(i_117619 - ((NI) 1))])) == ((NU8)(47)) || ((NU8)(path->data[(NI32)(i_117619 - ((NI) 1))])) == ((NU8)(47))));
							LA20: ;
							if (!LOC17) goto LA21;
							dotpos = i_117619;
						}
...
N_NIMCALL(NimStringDesc*, getapplaux_124204)(NimStringDesc* procpath) {
	...
	len = readlink(procpath->data, result->data, ((NI) 256));
	{
		...
		result = mnewString((NI32)(len + ((NI) 1)));
...
{	result = 0;
	...
	LOC7 = 0;
	LOC7 = (*e_123815).Sup.message; (*e_123815).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1082));
...
{	result = 0;
	i = findenvvar_120605(key);
	{
		...
		result = copyStr(environment_120009->data[i], (NI32)(LOC5 + ((NI) 1)));
		goto BeforeRet;
	}
	goto LA1;
	LA3: ;
...
{	result = 0;
	result = paramstr_123809(((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			p_124602 = 0;
			HEX3Atmp_124609 = 0;
			HEX3Atmp_124609 = getenv_120644(((NimStringDesc*) &TMP1083));
			last_124614 = ((NI) 0);
			{
				while (1) {
					NI first_124616;
					...
					{
						NimStringDesc* x;
						if (!(first_124616 <= (NI32)(last_124614 - ((NI) 1)))) goto LA18;
						p_124602 = copyStrLast(HEX3Atmp_124609, first_124616, (NI32)(last_124614 - ((NI) 1)));
...
appendString(LOC1, ((NimStringDesc*) &TMP1080));
	result = getapplaux_124204(LOC1);
	{
		if (!(result->Sup.len == ((NI) 0))) goto LA6;
...
{	result = 0;
	...
	LA5: ;
	{
		...
		i_117386 = 0;
		HEX3Atmp_117399 = 0;
		HEX3Atmp_117399 = (NI32)(path->Sup.len - q);
...
N_NIMCALL(void, noscreateDir)(NimStringDesc* dir) {
	...
	omitnext = NIM_FALSE;
	{
		...
		i_122211 = 0;
		HEX3Atmp_122224 = 0;
		HEX3Atmp_122224 = (NI32)(dir->Sup.len - ((NI) 1));
		res_122227 = ((NI) 1);
		{
			while (1) {
				...
				i_122211 = res_122227;
				{
					...
					LA10: ;
					{
						NimStringDesc* LOC13;
						LOC13 = 0;
						LOC13 = copyStrLast(dir, ((NI) 0), (NI32)(i_122211 - ((NI) 1)));
...
{	result = 0;
	LOC1 = 0;
	LOC2 = 0;
	LOC2 = getenv_120644(((NimStringDesc*) &TMP1699));
	LOC1 = rawNewString(LOC2->Sup.len + 1);
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP1700));
	result = LOC1;
	goto BeforeRet;
	}BeforeRet: ;
	return result;
...
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP1939));
	result = LOC1;
	goto BeforeRet;
	}BeforeRet: ;
	return result;
...
{	result = 0;
	...
	LA4: ;
	path = getenv_120644(((NimStringDesc*) &TMP1083));
	{
