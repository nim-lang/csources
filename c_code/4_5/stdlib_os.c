...
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_8, "/proc/", 6);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_9, "/path/a.out", 11);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_10, "invalid index", 13);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_11, "PATH", 4);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_12, "Failed to create the directory", 30);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_13, "\012  0 <= bufsize ", 16);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_14, "/.config/", 9);
...
{	result = (NimStringDesc*)0;
	...
	T7_ = (NimStringDesc*)0;
	T7_ = (*e).Sup.message; (*e).Sup.message = copyStringRC1(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_10));
...
{	result = (NimStringDesc*)0;
	result = paramStr_eYicl3uwirn1ppNz7OCowg(((NI) 0));
	{
		...
		if (!T3_) goto LA5_;
		{
			...
			colontmp_ = getEnv_8zNgT9bxx7m9cTt2TeVdTdIw(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_11));
			last = ((NI) 0);
			splits = ((NI) -1);
			{
...
appendString(T1_, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_8));
appendString(T1_, T3_);
appendString(T1_, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_9));
...
N_NIMCALL(NIM_BOOL, rawCreateDir_V86QyZrcGMPX0W9bv1Q53ww_2)(NimStringDesc* dir) {
	...
	LA6_: ;
	{
		NI32 T9_;
		T9_ = (NI32)0;
		T9_ = osLastError_YyC2FKP9bqQiUDq2XVqW9acA();
		raiseOSError_86HIIOlD5N61CWaO5GBgqA(T9_, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_3));
	}
	LA1_: ;
	return result;
}
...
N_NIMCALL(NIM_BOOL, existsOrCreateDir_V86QyZrcGMPX0W9bv1Q53ww)(NimStringDesc* dir) {
	...
	result = !(T1_);
	{
		if (!result) goto LA4_;
		{
			...
			T11_ = (*e).Sup.Sup.message; (*e).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_12));
			...
			LA7_: ;
			{
				...
				err = osLastError_YyC2FKP9bqQiUDq2XVqW9acA();
				{
					...
					bufsize = (NI)((NU32)(bufsize) << (NU32)(((NI) 1)));
					{
						...
						raiseAssert_PpfSiTIeNpMAb9a5o6SglJw_2(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_13));
					}
					LA17_: ;
					result = mnewString(((NI) (bufsize)));
				}
...
{	result = (NimStringDesc*)0;
	...
	path = getEnv_8zNgT9bxx7m9cTt2TeVdTdIw(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_11));
	{
...
N_NIMCALL(void, nosremoveDir)(NimStringDesc* dir) {
	{
		...
		d = opendir(dir->data);
		{
			TSafePoint TM_yu6cxgKBBXbNsTkT9cyMd4g_15;
			if (!!((d == NIM_NIL))) goto LA4_;
			pushSafePoint(&TM_yu6cxgKBBXbNsTkT9cyMd4g_15);
			TM_yu6cxgKBBXbNsTkT9cyMd4g_15.status = _setjmp(TM_yu6cxgKBBXbNsTkT9cyMd4g_15.context);
			if (TM_yu6cxgKBBXbNsTkT9cyMd4g_15.status == 0) {
				{
					while (1) {
						struct dirent* x;
						...
						y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
						{
							...
							T15_ = (NIM_BOOL)0;
							T15_ = !(eqStrings(y, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_16)));
							if (!(T15_)) goto LA16_;
							T15_ = !(eqStrings(y, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_17)));
							LA16_: ;
							if (!T15_) goto LA17_;
							memset((void*)(&s), 0, sizeof(s));
							{
			...
			if (TM_yu6cxgKBBXbNsTkT9cyMd4g_15.status != 0) reraiseException();
		}
		LA4_: ;
	}
...
N_NIMCALL(void, nosmoveFile)(NimStringDesc* source, NimStringDesc* dest) {
	{
		...
		err = osLastError_YyC2FKP9bqQiUDq2XVqW9acA();
		{
			TSafePoint TM_yu6cxgKBBXbNsTkT9cyMd4g_18;
			if (!(err == EXDEV)) goto LA8_;
			noscopyFile(source, dest);
			pushSafePoint(&TM_yu6cxgKBBXbNsTkT9cyMd4g_18);
			TM_yu6cxgKBBXbNsTkT9cyMd4g_18.status = _setjmp(TM_yu6cxgKBBXbNsTkT9cyMd4g_18.context);
			if (TM_yu6cxgKBBXbNsTkT9cyMd4g_18.status == 0) {
				...
				{
					NIM_BOOL T13_;
					TM_yu6cxgKBBXbNsTkT9cyMd4g_18.status = 0;
					T13_ = (NIM_BOOL)0;
			...
			if (TM_yu6cxgKBBXbNsTkT9cyMd4g_18.status != 0) reraiseException();
		}
		goto LA6_;
		LA8_: ;
		{
