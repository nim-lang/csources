...
N_NIMCALL(void, fillbuffer_203058)(Tbaselexer203015* L) {
	...
	LA3: ;
	LOC5 = 0;
	LOC5 = llstreamread_202530((*L).stream, ((void*) ((&(*L).buf[tocopy]))), (NI)((NI)((*L).sentinel + ((NI) 1)) * ((NI) 1)));
		...
		s -= ((NI) 1);
		{
			while (1) {
				...
				LA19: ;
				{
					...
					LOC23 = 0;
					LOC23 = llstreamread_202530((*L).stream, ((void*) ((&(*L).buf[oldbuflen]))), (NI)(oldbuflen * ((NI) 1)));
...
N_NIMCALL(NI, handlecr_203042)(Tbaselexer203015* L, NI pos) {
	...
	result = 0;
	(*L).linenumber += ((NI) 1);
	result = fillbaselexer_203809(L, pos);
	{
		if (!((NU8)((*L).buf[result]) == (NU8)(10))) goto LA3;
		result = fillbaselexer_203809(L, result);
	}
	LA3: ;
	return result;
}
...
NTI203015.size = sizeof(Tbaselexer203015);
NTI203015.kind = 17;
NTI203015.base = (&NTI3608);
TMP1209[0] = &TMP793[1];
TMP793[1].kind = 1;
TMP793[1].offset = offsetof(Tbaselexer203015, bufpos);
TMP793[1].typ = (&NTI104);
TMP793[1].name = "bufpos";
TMP1209[1] = &TMP793[2];
TMP793[2].kind = 1;
TMP793[2].offset = offsetof(Tbaselexer203015, buf);
TMP793[2].typ = (&NTI140);
TMP793[2].name = "buf";
TMP1209[2] = &TMP793[3];
TMP793[3].kind = 1;
TMP793[3].offset = offsetof(Tbaselexer203015, buflen);
TMP793[3].typ = (&NTI104);
TMP793[3].name = "bufLen";
TMP1209[3] = &TMP793[4];
TMP793[4].kind = 1;
TMP793[4].offset = offsetof(Tbaselexer203015, stream);
TMP793[4].typ = (&NTI202206);
TMP793[4].name = "stream";
TMP1209[4] = &TMP793[5];
TMP793[5].kind = 1;
TMP793[5].offset = offsetof(Tbaselexer203015, linenumber);
TMP793[5].typ = (&NTI104);
TMP793[5].name = "lineNumber";
TMP1209[5] = &TMP793[6];
TMP793[6].kind = 1;
TMP793[6].offset = offsetof(Tbaselexer203015, sentinel);
TMP793[6].typ = (&NTI104);
TMP793[6].name = "sentinel";
TMP1209[6] = &TMP793[7];
TMP793[7].kind = 1;
TMP793[7].offset = offsetof(Tbaselexer203015, linestart);
TMP793[7].typ = (&NTI104);
TMP793[7].name = "lineStart";
TMP793[0].len = 7; TMP793[0].kind = 2; TMP793[0].sons = &TMP1209[0];
NTI203015.node = &TMP793[0];
}
