...
NIM_CONST TY84735 TMP2990 = {((NimStringDesc*) &TMP2991),
100}
;
NIM_CONST TY84735 TMP2992 = {((NimStringDesc*) &TMP2991),
107}
;
...
N_NIMCALL(tnode224819*, semnodekindconstraints_320527)(tnode224819* p) {
	...
	(*result).kindU.S3.Strval = addChar((*result).kindU.S3.Strval, 1);
	{
		...
		}
		{
			...
			internalerror_197970((*p).Info, ((NimStringDesc*) &TMP2993));
		}
		LA12: ;
	}
	goto LA1;
