...
STRING_LITERAL(TMP1135, "overflow", 8);
...
N_NIMCALL(NI, rawparseint_86531)(NimStringDesc* s, NI64* b, NI start) {
	...
	nimln(200, "parseutils.nim");
	{
		...
		while (1) {
			...
			TMP1132 = subInt64((NI64)(TMP1130), ((NI64) ((NI32)(TMP1131))));
			(*b) = (NI64)(TMP1132);
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	nimln(228, "parseutils.nim");
	{
		...
		LOC9 = 0;
		LOC9 = (*e_86686).Sup.Sup.Sup.message; (*e_86686).Sup.Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1135));
...
N_NIMCALL(NI, npuParseBiggestFloat)(NimStringDesc* s, NF* number, NI start) {
	...
	nimln(261, "parseutils.nim");
	{
		...
		nimln(262, "parseutils.nim");
		{
			...
			LOC16 = ((NU8)(s->data[(NI32)(TMP1840)]) == (NU8)(65));
			if (LOC16) goto LA17;
			nimln(262, "parseutils.nim");
			nimln(262, "parseutils.nim");
			TMP1841 = addInt(i, 1);
			if ((NU)((NI32)(TMP1841)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC16 = ((NU8)(s->data[(NI32)(TMP1841)]) == (NU8)(97));
			LA17: ;
			if (!LOC16) goto LA18;
			nimln(263, "parseutils.nim");
			{
				...
				LOC22 = ((NU8)(s->data[(NI32)(TMP1842)]) == (NU8)(78));
				if (LOC22) goto LA23;
				nimln(263, "parseutils.nim");
				nimln(263, "parseutils.nim");
				TMP1843 = addInt(i, 2);
				if ((NU)((NI32)(TMP1843)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC22 = ((NU8)(s->data[(NI32)(TMP1843)]) == (NU8)(110));
				LA23: ;
				if (!LOC22) goto LA24;
				nimln(264, "parseutils.nim");
				{
					...
					if (!!((((NU8)(s->data[(NI32)(TMP1844)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI32)(TMP1844)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI32)(TMP1844)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI32)(TMP1844)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI32)(TMP1844)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI32)(TMP1844)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI32)(TMP1844)])) == ((NU8)(95))))) goto LA28;
					...
					nimln(266, "parseutils.nim");
					TMP1845 = addInt(i, 3);
					TMP1846 = subInt((NI32)(TMP1845), start);
					result = (NI32)(TMP1846);
					goto BeforeRet;
				}
				LA28: ;
	...
	nimln(268, "parseutils.nim");
	{
		...
		nimln(269, "parseutils.nim");
		{
			...
			LOC38 = ((NU8)(s->data[(NI32)(TMP1847)]) == (NU8)(78));
			if (LOC38) goto LA39;
			nimln(269, "parseutils.nim");
			nimln(269, "parseutils.nim");
			TMP1848 = addInt(i, 1);
			if ((NU)((NI32)(TMP1848)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC38 = ((NU8)(s->data[(NI32)(TMP1848)]) == (NU8)(110));
			LA39: ;
			if (!LOC38) goto LA40;
			nimln(270, "parseutils.nim");
			{
				...
				LOC44 = ((NU8)(s->data[(NI32)(TMP1849)]) == (NU8)(70));
				if (LOC44) goto LA45;
				nimln(270, "parseutils.nim");
				nimln(270, "parseutils.nim");
				TMP1850 = addInt(i, 2);
				if ((NU)((NI32)(TMP1850)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC44 = ((NU8)(s->data[(NI32)(TMP1850)]) == (NU8)(102));
				LA45: ;
				if (!LOC44) goto LA46;
				nimln(271, "parseutils.nim");
				{
					...
					if (!!((((NU8)(s->data[(NI32)(TMP1851)])) >= ((NU8)(97)) && ((NU8)(s->data[(NI32)(TMP1851)])) <= ((NU8)(122)) || ((NU8)(s->data[(NI32)(TMP1851)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI32)(TMP1851)])) <= ((NU8)(90)) || ((NU8)(s->data[(NI32)(TMP1851)])) >= ((NU8)(48)) && ((NU8)(s->data[(NI32)(TMP1851)])) <= ((NU8)(57)) || ((NU8)(s->data[(NI32)(TMP1851)])) == ((NU8)(95))))) goto LA50;
					...
					nimln(273, "parseutils.nim");
					TMP1852 = addInt(i, 3);
					TMP1853 = subInt((NI32)(TMP1852), start);
					result = (NI32)(TMP1853);
					goto BeforeRet;
				}
				LA50: ;
	...
	while (1) {
		...
		(*number) = ((NF)(((NF)((*number)) * (NF)(1.0000000000000000e+001))) + (NF)(((double) (((NI) ((NI32)(TMP1854)))))));
	...
	nimln(296, "parseutils.nim");
	{
		...
		while (1) {
			...
			nimln(306, "parseutils.nim");
			if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
			TMP1857 = addInt((NI32)(TMP1856), ((NI) (((NU8)(s->data[i])))));
			TMP1858 = subInt((NI32)(TMP1857), 48);
			exponent = (NI32)(TMP1858);
