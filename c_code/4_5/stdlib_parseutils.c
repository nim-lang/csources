...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	result = npuParseBiggestInt(s, (&res), start);
	{
		...
		if (!LOC3) goto LA7;
		e_94055 = 0;
		e_94055 = (Overflowerror3443*) newObj((&NTI22801), sizeof(Overflowerror3443));
		(*e_94055).Sup.Sup.Sup.m_type = (&NTI3443);
		LOC9 = 0;
		LOC9 = (*e_94055).Sup.Sup.message; (*e_94055).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1441));
