...
STRING_LITERAL(TMP5073, "", 0);
STRING_LITERAL(TMP5074, "*", 1);
STRING_LITERAL(TMP5075, "renderPlainSymbolName() with ", 29);
STRING_LITERAL(TMP5082, "ref.", 4);
STRING_LITERAL(TMP5083, "ptr.", 4);
STRING_LITERAL(TMP5084, "proc(", 5);
STRING_LITERAL(TMP5085, "tuple[", 6);
STRING_LITERAL(TMP5086, "renderParamTypes(found,n) with ", 31);
...
{	result = 0;
	result = copyString(((NimStringDesc*) &TMP5073));
	switch ((*n).kind) {
	case ((NU8) 31):
	{
		{
	...
	{
		{
			if (!!(eqStrings((*(*n).kindU.S5.ident).s, ((NimStringDesc*) &TMP5074)))) goto LA15;
...
appendString(LOC24, ((NimStringDesc*) &TMP5075));
...
appendString(LOC6, ((NimStringDesc*) &TMP5082));
...
appendString(LOC10, ((NimStringDesc*) &TMP5083));
appendString(LOC10, LOC12);
	...
	case ((NU8) 147):
	{
		...
		result = copyString(((NimStringDesc*) &TMP5084));
		{
			NI i_357418;
			NI HEX3Atmp_358202;
			NI LOC15;
...
appendString(LOC31, ((NimStringDesc*) &TMP5086));
