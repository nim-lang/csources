...
N_NIMCALL(void, fillbuffer_277084)(tbaselexer277029* l) {
	...
	nimln(77, "lexbase.nim");
	{
		...
		nimln(77, "lexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP3617));
	}
	LA3: ;
	...
	nimln(79, "lexbase.nim");
	{
		...
		nimln(79, "lexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP3620));
	}
	LA7: ;
	...
	LOC13 = 0;
	LOC13 = readdata_124733((*l).Input, ((void*) (&(*l).Buf[tocopy])), (NI32)(TMP3624));
	...
	LA16: ;
	{
		...
		while (1) {
			nimln(93, "lexbase.nim");
			{
				...
				nimln(93, "lexbase.nim");
				failedassertimpl_80021(((NimStringDesc*) &TMP3628));
			}
			LA22: ;
			...
			LA29: ;
			{
				...
				nimln(105, "lexbase.nim");
				{
					...
					nimln(105, "lexbase.nim");
					failedassertimpl_80021(((NimStringDesc*) &TMP3632));
				}
				LA35: ;
				...
				LOC37 = 0;
				LOC37 = readdata_124733((*l).Input, ((void*) (&(*l).Buf[oldbuflen])), (NI32)(TMP3633));
...
N_NIMCALL(NI, handlecr_277062)(tbaselexer277029* l, NI pos) {
	...
	nimln(125, "lexbase.nim");
	{
		...
		nimln(125, "lexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP3640));
	}
	LA3: ;
...
N_NIMCALL(NI, getcolnumber_277057)(tbaselexer277029* l, NI pos) {
	...
	if ((NI32)(TMP3646) == (-2147483647 -1)) raiseOverflow();
	result = (NI32)abs((NI32)(TMP3646));
	popFrame();
	return result;
}
...
TMP3757[0] = &TMP3615[1];
TMP3615[1].kind = 1;
TMP3615[1].offset = offsetof(tbaselexer277029, Bufpos);
TMP3615[1].typ = (&NTI106);
TMP3615[1].name = "bufpos";
TMP3757[1] = &TMP3615[2];
TMP3615[2].kind = 1;
TMP3615[2].offset = offsetof(tbaselexer277029, Buf);
TMP3615[2].typ = (&NTI145);
TMP3615[2].name = "buf";
TMP3757[2] = &TMP3615[3];
TMP3615[3].kind = 1;
TMP3615[3].offset = offsetof(tbaselexer277029, Buflen);
TMP3615[3].typ = (&NTI106);
TMP3615[3].name = "bufLen";
TMP3757[3] = &TMP3615[4];
TMP3615[4].kind = 1;
TMP3615[4].offset = offsetof(tbaselexer277029, Input);
TMP3615[4].typ = (&NTI124627);
TMP3615[4].name = "input";
TMP3757[4] = &TMP3615[5];
TMP3615[5].kind = 1;
TMP3615[5].offset = offsetof(tbaselexer277029, Linenumber);
TMP3615[5].typ = (&NTI106);
TMP3615[5].name = "lineNumber";
TMP3757[5] = &TMP3615[6];
TMP3615[6].kind = 1;
TMP3615[6].offset = offsetof(tbaselexer277029, Sentinel);
TMP3615[6].typ = (&NTI106);
TMP3615[6].name = "sentinel";
TMP3757[6] = &TMP3615[7];
TMP3615[7].kind = 1;
TMP3615[7].offset = offsetof(tbaselexer277029, Linestart);
TMP3615[7].typ = (&NTI106);
TMP3615[7].name = "lineStart";
TMP3757[7] = &TMP3615[8];
TMP3615[8].kind = 1;
TMP3615[8].offset = offsetof(tbaselexer277029, Fileopened);
TMP3615[8].typ = (&NTI134);
TMP3615[8].name = "fileOpened";
TMP3615[0].len = 8; TMP3615[0].kind = 2; TMP3615[0].sons = &TMP3757[0];
NTI277029.node = &TMP3615[0];
}
