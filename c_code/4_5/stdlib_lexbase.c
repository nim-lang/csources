...
N_NIMCALL(void, fillbuffer_282084)(tbaselexer282029* l) {
	...
	nimln(77, "lexbase.nim");
	{
		...
		nimln(77, "lexbase.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP3623));
	}
	LA3: ;
	...
	nimln(79, "lexbase.nim");
	{
		...
		nimln(79, "lexbase.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP3626));
	}
	LA7: ;
	...
	LA16: ;
	{
		...
		while (1) {
			nimln(93, "lexbase.nim");
			{
				...
				nimln(93, "lexbase.nim");
				failedassertimpl_80621(((NimStringDesc*) &TMP3634));
			}
			LA22: ;
...
N_NIMCALL(NI, fillbaselexer_282812)(tbaselexer282029* l, NI pos) {
	...
	nimln(115, "lexbase.nim");
	{
		...
		nimln(115, "lexbase.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP3644));
	}
	LA3: ;
...
N_NIMCALL(NI, handlelf_282068)(tbaselexer282029* l, NI pos) {
	...
	nimln(132, "lexbase.nim");
	{
		...
		nimln(132, "lexbase.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP3647));
	}
	LA3: ;
...
N_NIMCALL(NI, getcolnumber_282057)(tbaselexer282029* l, NI pos) {
	...
	if ((NI32)(TMP3652) == (-2147483647 -1)) raiseOverflow();
	result = (NI32)abs((NI32)(TMP3652));
	popFrame();
	return result;
}
