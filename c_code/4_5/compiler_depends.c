...
N_NIMCALL(void, adddependencyaux_507028)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	addf_162635(&gdotgraph_507023, ((NimStringDesc*) &TMP4956), LOC1, 2);
}
...
N_NIMCALL(void, generatedot_507009)(NimStringDesc* project) {
	...
	LOC4 = 0;
	LOC4 = HEX25_162235(((NimStringDesc*) &TMP4957), LOC1, 2);
	LOC5 = 0;
...
TMP1065[0].kind = 1;
TMP1065[0].offset = offsetof(Tgen507016, module);
TMP1065[0].typ = (&NTI191811);
TMP1065[0].name = "module";
NTI507016.node = &TMP1065[0];
NTI507018.size = sizeof(Tgen507016*);
NTI507018.kind = 22;
NTI507018.base = (&NTI507016);
NTI507018.marker = TMP4955;
}
