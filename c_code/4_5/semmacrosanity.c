...
static NIM_CONST TY187025 TMP5673 = {
...
static NIM_CONST TY187025 TMP5683 = {
...
N_NIMCALL(tsym186843*, ithfield_415007)(tnode186813* n, NI field) {
	...
	case ((NU8) 136):
	{
		...
		while (1) {
			...
			nimln(20, "semmacrosanity.nim");
			TMP5676 = subInt(field, i_415024);
			result = ithfield_415007((*n).kindU.S6.Sons->data[i_415024], (NI32)(TMP5676));
	...
	case ((NU8) 137):
	{
		...
		result = ithfield_415007((*n).kindU.S6.Sons->data[0], (NI32)(TMP5678));
		...
		while (1) {
			...
			case ((NU8) 88):
			{
				...
				result = ithfield_415007(LOC20, (NI32)(TMP5681));
			...
			default:
			{
				...
				internalerror_164591((*n).Info, ((NimStringDesc*) &TMP5682));
			}
			break;
			}
			nimln(1453, "system.nim");
