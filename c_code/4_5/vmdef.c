...
NTI248229.flags = 2;
NTI248229.marker = TMP3215;
TMP3212[1].kind = 1;
TMP3212[1].offset = offsetof(tctx248037, Code);
TMP3212[1].typ = (&NTI248229);
TMP3212[1].name = "code";
TMP3214[1] = &TMP3212[2];
TMP3212[2].kind = 1;
TMP3212[2].offset = offsetof(tctx248037, Debug);
TMP3212[2].typ = (&NTI163208);
TMP3212[2].name = "debug";
TMP3214[2] = &TMP3212[3];
TMP3212[3].kind = 1;
TMP3212[3].offset = offsetof(tctx248037, Globals);
TMP3212[3].typ = (&NTI186805);
TMP3212[3].name = "globals";
TMP3214[3] = &TMP3212[4];
TMP3212[4].kind = 1;
TMP3212[4].offset = offsetof(tctx248037, Constants);
TMP3212[4].typ = (&NTI186805);
TMP3212[4].name = "constants";
TMP3214[4] = &TMP3212[5];
TMP3212[5].kind = 1;
TMP3212[5].offset = offsetof(tctx248037, Types);
TMP3212[5].typ = (&NTI186845);
TMP3212[5].name = "types";
TMP3214[5] = &TMP3212[6];
TMP3212[6].kind = 1;
TMP3212[6].offset = offsetof(tctx248037, Currentexceptiona);
TMP3212[6].typ = (&NTI186805);
TMP3212[6].name = "currentExceptionA";
TMP3214[6] = &TMP3212[7];
TMP3212[7].kind = 1;
TMP3212[7].offset = offsetof(tctx248037, Currentexceptionb);
TMP3212[7].typ = (&NTI186805);
TMP3212[7].name = "currentExceptionB";
TMP3214[7] = &TMP3212[8];
TMP3212[8].kind = 1;
TMP3212[8].offset = offsetof(tctx248037, Exceptioninstr);
...
TMP3212[13].kind = 1;
TMP3212[13].offset = offsetof(tblock248023, Label);
TMP3212[13].typ = (&NTI186811);
...
NTI248198.flags = 2;
NTI248198.marker = TMP3218;
TMP3212[14].kind = 1;
TMP3212[14].offset = offsetof(tblock248023, Fixups);
TMP3212[14].typ = (&NTI248198);
TMP3212[14].name = "fixups";
TMP3212[12].len = 2; TMP3212[12].kind = 2; TMP3212[12].sons = &TMP3217[0];
NTI248023.node = &TMP3212[12];
NTI248217.size = sizeof(TY248217*);
NTI248217.kind = 24;
NTI248217.base = (&NTI248023);
NTI248217.flags = 2;
NTI248217.marker = TMP3219;
TMP3212[11].kind = 1;
TMP3212[11].offset = offsetof(pprocHEX3Aobjecttype248216, Blocks);
TMP3212[11].typ = (&NTI248217);
TMP3212[11].name = "blocks";
TMP3216[1] = &TMP3212[15];
TMP3212[15].kind = 1;
TMP3212[15].offset = offsetof(pprocHEX3Aobjecttype248216, Sym);
TMP3212[15].typ = (&NTI186811);
TMP3212[15].name = "sym";
...
TMP3212[18].kind = 1;
TMP3212[18].offset = offsetof(TY248223, Field0);
...
NTI248031.node = &TMP3212[28];
TMP3212[19].kind = 1;
TMP3212[19].offset = offsetof(TY248223, Field1);
TMP3212[19].typ = (&NTI248031);
TMP3212[19].name = "Field1";
TMP3212[17].len = 2; TMP3212[17].kind = 2; TMP3212[17].sons = &TMP3220[0];
NTI248223.node = &TMP3212[17];
NTI248220.size = sizeof(TY248220);
NTI248220.kind = 16;
NTI248220.base = (&NTI248223);
NTI248220.flags = 3;
TMP3212[16].kind = 1;
TMP3212[16].offset = offsetof(pprocHEX3Aobjecttype248216, Slots);
TMP3212[16].typ = (&NTI248220);
TMP3212[16].name = "slots";
TMP3216[3] = &TMP3212[29];
TMP3212[29].kind = 1;
TMP3212[29].offset = offsetof(pprocHEX3Aobjecttype248216, Maxslots);
TMP3212[29].typ = (&NTI106);
TMP3212[29].name = "maxSlots";
TMP3212[10].len = 4; TMP3212[10].kind = 2; TMP3212[10].sons = &TMP3216[0];
NTI248216.node = &TMP3212[10];
NTI248033.size = sizeof(pprocHEX3Aobjecttype248216*);
NTI248033.kind = 22;
NTI248033.base = (&NTI248216);
NTI248033.flags = 2;
NTI248033.marker = TMP3224;
TMP3212[9].kind = 1;
TMP3212[9].offset = offsetof(tctx248037, Prc);
TMP3212[9].typ = (&NTI248033);
TMP3212[9].name = "prc";
TMP3214[9] = &TMP3212[30];
TMP3212[30].kind = 1;
TMP3212[30].offset = offsetof(tctx248037, Module);
TMP3212[30].typ = (&NTI186811);
TMP3212[30].name = "module";
TMP3214[10] = &TMP3212[31];
TMP3212[31].kind = 1;
TMP3212[31].offset = offsetof(tctx248037, Callsite);
TMP3212[31].typ = (&NTI186805);
...
NTI248025.node = &TMP3212[38];
TMP3212[32].kind = 1;
TMP3212[32].offset = offsetof(tctx248037, Mode);
TMP3212[32].typ = (&NTI248025);
