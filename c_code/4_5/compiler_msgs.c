...
typedef N_CLOSURE_PTR(void, TMP2008) (NimStringDesc* output);
...
((NI) 875)}
;
STRING_LITERAL(TMP2729, "suggest done", 12);
STRING_LITERAL(TMP3132, "(", 1);
STRING_LITERAL(TMP3133, ",", 1);
STRING_LITERAL(TMP3134, ")", 1);
NIM_CONST TY85745 TMP3699 = {((NimStringDesc*) &TMP1051),
((NI) 882)}
;
...
N_NIMCALL(void, suggestwriteln_181085)(NimStringDesc* s) {
	{
		...
		LA7: ;
		{
			writelnhook_181067.ClEnv? writelnhook_181067.ClPrc(s, writelnhook_181067.ClEnv):((TMP2008)(writelnhook_181067.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, clearbufferedmsgs_181077)(void) {
	genericSeqAssign((&bufferedmsgs_181061), NIM_NIL, (&NTI120008));
}
N_NIMCALL(void, TMP2728)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_181295)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_181299).Sup.message; (*e_181299).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2729));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
static TNimNode* TMP2002[278];
NI TMP2004;
static char* NIM_CONST TMP2003[278] = {
"errUnknown", 
"errIllFormedAstX", 
"errInternal", 
"errCannotOpenFile", 
...
NTI180005.base = 0;
NTI180005.flags = 3;
for (TMP2004 = 0; TMP2004 < 278; TMP2004++) {
TMP19[TMP2004+12].kind = 1;
TMP19[TMP2004+12].offset = TMP2004;
TMP19[TMP2004+12].name = TMP2003[TMP2004];
TMP2002[TMP2004] = &TMP19[TMP2004+12];
}
TMP19[290].len = 278; TMP19[290].kind = 2; TMP19[290].sons = &TMP2002[0];
