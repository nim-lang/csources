...
N_NIMCALL(void, nodetablerawinsert_246514)(tnodepairseq186869** data, NI k, tnode186813* key, NI val) {
	...
	nimln(72, "treetab.nim");
	{
		...
		nimln(72, "treetab.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP3208));
	}
	LA4: ;
...
N_NIMCALL(void, nodetableput_246622)(tnodetable186871* t, tnode186813* key, NI val) {
	...
	LA3: ;
	{
		nimln(85, "treetab.nim");
		{
			...
			n = (tnodepairseq186869*) newSeq((&NTI186869), (NI32)(TMP3210));
			i_246868 = 0;
			HEX3Atmp_246921 = 0;
