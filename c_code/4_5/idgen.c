...
STRING_LITERAL(TMP1971, "nimrod.gid", 10);
STRING_LITERAL(TMP1972, "\012", 1);
...
static N_INLINE(void, setid_190444)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP1966 = addInt(id, 1);
	gfrontendid_190007 = ((gfrontendid_190007 >= (NI32)(TMP1966)) ? gfrontendid_190007 : (NI32)(TMP1966));
	popFrame();
}
...
N_NIMCALL(void, idsynchronizationpoint_190452)(NI idrange) {
	...
	TMP1969 = mulInt((NI32)(TMP1968), idrange);
	TMP1970 = addInt((NI32)(TMP1969), 1);
	gfrontendid_190007 = (NI32)(TMP1970);
	popFrame();
}
...
N_NIMCALL(NimStringDesc*, togid_190457)(NimStringDesc* f) {
	...
	result = 0;
	nimln(47, "idgen.nim");
	result = completegeneratedfilepath_139001(((NimStringDesc*) &TMP1971), NIM_TRUE);
	popFrame();
	return result;
}
