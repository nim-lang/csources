...
STRING_LITERAL(TMP467, "DOS", 3);
STRING_LITERAL(TMP468, "..", 2);
STRING_LITERAL(TMP469, "$1.dll", 6);
STRING_LITERAL(TMP470, "/", 1);
STRING_LITERAL(TMP471, ".obj", 4);
STRING_LITERAL(TMP472, "\015\012", 2);
STRING_LITERAL(TMP473, ";", 1);
STRING_LITERAL(TMP474, "\\", 1);
STRING_LITERAL(TMP475, ".bat", 4);
STRING_LITERAL(TMP476, ".", 1);
STRING_LITERAL(TMP477, ".exe", 4);
STRING_LITERAL(TMP478, "Windows", 7);
STRING_LITERAL(TMP479, "OS2", 3);
STRING_LITERAL(TMP480, "Linux", 5);
STRING_LITERAL(TMP481, "lib$1.so", 8);
STRING_LITERAL(TMP482, ".o", 2);
STRING_LITERAL(TMP483, "\012", 1);
STRING_LITERAL(TMP484, ":", 1);
STRING_LITERAL(TMP485, ".sh", 3);
STRING_LITERAL(TMP486, "", 0);
STRING_LITERAL(TMP487, "MorphOS", 7);
STRING_LITERAL(TMP488, "SkyOS", 5);
STRING_LITERAL(TMP489, "Solaris", 7);
STRING_LITERAL(TMP490, "Irix", 4);
STRING_LITERAL(TMP491, "NetBSD", 6);
STRING_LITERAL(TMP492, "FreeBSD", 7);
STRING_LITERAL(TMP493, "OpenBSD", 7);
STRING_LITERAL(TMP494, "AIX", 3);
STRING_LITERAL(TMP495, "PalmOS", 6);
STRING_LITERAL(TMP496, "QNX", 3);
STRING_LITERAL(TMP497, "Amiga", 5);
STRING_LITERAL(TMP498, "$1.library", 10);
STRING_LITERAL(TMP499, "Atari", 5);
STRING_LITERAL(TMP500, ".tpp", 4);
STRING_LITERAL(TMP501, "Netware", 7);
STRING_LITERAL(TMP502, "$1.nlm", 6);
STRING_LITERAL(TMP503, ".nlm", 4);
STRING_LITERAL(TMP504, "MacOS", 5);
STRING_LITERAL(TMP505, "::", 2);
STRING_LITERAL(TMP506, "$1Lib", 5);
STRING_LITERAL(TMP507, "\015", 1);
STRING_LITERAL(TMP508, ",", 1);
STRING_LITERAL(TMP509, "MacOSX", 6);
STRING_LITERAL(TMP510, "lib$1.dylib", 11);
STRING_LITERAL(TMP511, "Haiku", 5);
STRING_LITERAL(TMP512, "JS", 2);
STRING_LITERAL(TMP513, "NimrodVM", 8);
STRING_LITERAL(TMP514, "Standalone", 10);
NIM_CONST TY145064 os_145063 = {{((NimStringDesc*) &TMP467),
...
;
STRING_LITERAL(TMP515, "littleEndian", 12);
STRING_LITERAL(TMP516, "bigEndian", 9);
NIM_CONST TY145463 endiantostr_145462 = {((NimStringDesc*) &TMP515),
((NimStringDesc*) &TMP516)}
;
STRING_LITERAL(TMP517, "i386", 4);
STRING_LITERAL(TMP518, "m68k", 4);
STRING_LITERAL(TMP519, "alpha", 5);
STRING_LITERAL(TMP520, "powerpc", 7);
STRING_LITERAL(TMP521, "powerpc64", 9);
STRING_LITERAL(TMP522, "sparc", 5);
STRING_LITERAL(TMP523, "vm", 2);
STRING_LITERAL(TMP524, "ia64", 4);
STRING_LITERAL(TMP525, "amd64", 5);
STRING_LITERAL(TMP526, "mips", 4);
STRING_LITERAL(TMP527, "arm", 3);
STRING_LITERAL(TMP528, "js", 2);
STRING_LITERAL(TMP529, "nimrodvm", 8);
STRING_LITERAL(TMP530, "avr", 3);
NIM_CONST TY145469 cpu_145468 = {{((NimStringDesc*) &TMP517),
32,
((NU8) 0),
64,
32}
...
;
STRING_LITERAL(TMP531, "c != cpuNone ", 13);
STRING_LITERAL(TMP532, "o != osNone ", 12);
STRING_LITERAL(TMP536, "solaris", 7);
...
N_NIMCALL(void, settarget_145599)(NU8 o, NU8 c) {
	...
	nimln(198, "platform.nim");
	{
		...
		if (!!(!((c == ((NU8) 0))))) goto LA3;
		nimln(198, "platform.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP531));
	}
	LA3: ;
	nimln(199, "platform.nim");
	{
		...
		if (!!(!((o == ((NU8) 0))))) goto LA7;
		nimln(199, "platform.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP532));
	}
	LA7: ;
...
N_NOINLINE(void, platformInit)(void) {
	...
	hostcpu_145574 = nametocpu_145586(((NimStringDesc*) &TMP522));
	nimln(221, "platform.nim");
	hostos_145576 = nametoos_145582(((NimStringDesc*) &TMP536));
