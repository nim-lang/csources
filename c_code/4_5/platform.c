...
NIM_CONST TY141064 os_141063 = {{((NimStringDesc*) &TMP462),
...
NIM_CONST TY141463 endiantostr_141462 = {((NimStringDesc*) &TMP510),
...
NIM_CONST TY141469 cpu_141468 = {{((NimStringDesc*) &TMP512),
32,
((NU8) 0),
64,
32}
...
N_NIMCALL(void, settarget_141599)(NU8 o, NU8 c) {
	...
	nimln(198, "platform.nim");
	{
		...
		if (!!(!((c == ((NU8) 0))))) goto LA3;
		nimln(198, "platform.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP526));
	}
	LA3: ;
	...
	TMP528 = divInt(cpu_141468[(c)- 1].Field1, 8);
	intsize_141590 = (NI32)(TMP528);
	nimln(204, "platform.nim");
	nimln(204, "platform.nim");
	if (c < 1 || c > 14) raiseIndexError();
	TMP529 = divInt(cpu_141468[(c)- 1].Field3, 8);
	floatsize_141591 = (NI32)(TMP529);
	nimln(205, "platform.nim");
	nimln(205, "platform.nim");
	if (c < 1 || c > 14) raiseIndexError();
	TMP530 = divInt(cpu_141468[(c)- 1].Field4, 8);
	ptrsize_141592 = (NI32)(TMP530);
...
N_NOINLINE(void, platformInit)(void) {
	...
	hostos_141576 = nametoos_141582(((NimStringDesc*) &TMP531));
