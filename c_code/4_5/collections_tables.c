...
static N_INLINE(NIM_BOOL, mustrehash_117295)(NI length, NI counter) {
	...
	nimln(66, "tables.nim");
	{
		...
		nimln(66, "tables.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP374));	}	LA3: ;
	nimln(67, "tables.nim");
	nimln(67, "tables.nim");
	LOC5 = 0;
	nimln(67, "tables.nim");
...
N_NIMCALL(void, inittable_137534)(NI initialsize, ttable137540* Result) {
	...
	nimln(167, "tables.nim");
	{
		...
		if (!!(LOC3)) goto LA4;
		nimln(167, "tables.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP792));	}	LA4: ;
...
N_NIMCALL(void, enlarge_220767)(ttable220029* t) {
	...
	nimln(116, "tables.nim");
	nimln(116, "tables.nim");
	TMP3096 = mulInt((*t).Data->Sup.len, 2);
	n = (tkeyvaluepairseq220032*) newSeq((&NTI220032), (NI32)(TMP3096));
	i_220806 = 0;
	HEX3Atmp_220861 = 0;
	nimln(117, "tables.nim");
	nimln(117, "tables.nim");
...
N_NIMCALL(void, enlarge_221197)(ttable220059* t) {
	...
	nimln(116, "tables.nim");
	nimln(116, "tables.nim");
	TMP3105 = mulInt((*t).Data->Sup.len, 2);
	n = (tkeyvaluepairseq220062*) newSeq((&NTI220062), (NI32)(TMP3105));
	i_221236 = 0;
	HEX3Atmp_221291 = 0;
	nimln(117, "tables.nim");
	nimln(117, "tables.nim");
...
static TNimNode* TMP3088[2];
static TNimNode* TMP3090[3];
static TNimNode* TMP3094[2];
...
TMP370[15].len = 2; TMP370[15].kind = 2; TMP370[15].sons = &TMP3088[0];
...
TMP370[22].len = 2; TMP370[22].kind = 2; TMP370[22].sons = &TMP3094[0];
