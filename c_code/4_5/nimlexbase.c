...
N_NIMCALL(void, fillbuffer_176072)(tbaselexer176018* l) {
	...
	nimln(82, "nimlexbase.nim");
	{
		...
		nimln(82, "nimlexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP1648));
	}
	LA3: ;
	...
	nimln(84, "nimlexbase.nim");
	{
		...
		nimln(84, "nimlexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP1651));
	}
	LA7: ;
	...
	LOC13 = 0;
	LOC13 = llstreamread_174242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI32)(TMP1655));
	...
	LA16: ;
	{
		...
		while (1) {
			nimln(98, "nimlexbase.nim");
			{
				...
				nimln(98, "nimlexbase.nim");
				failedassertimpl_80021(((NimStringDesc*) &TMP1659));
			}
			LA22: ;
			...
			LA29: ;
			{
				...
				nimln(110, "nimlexbase.nim");
				{
					...
					nimln(110, "nimlexbase.nim");
					failedassertimpl_80021(((NimStringDesc*) &TMP1663));
				}
				LA35: ;
				...
				LOC37 = 0;
				LOC37 = llstreamread_174242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI32)(TMP1664));
...
N_NIMCALL(NI, fillbaselexer_176812)(tbaselexer176018* l, NI pos) {
	...
	nimln(120, "nimlexbase.nim");
	{
		...
		nimln(120, "nimlexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP1669));
	}
	LA3: ;
...
N_NIMCALL(NI, handlecr_176050)(tbaselexer176018* l, NI pos) {
	...
	nimln(130, "nimlexbase.nim");
	{
		...
		nimln(130, "nimlexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP1671));
	}
	LA3: ;
...
N_NIMCALL(NI, handlelf_176056)(tbaselexer176018* l, NI pos) {
	...
	nimln(137, "nimlexbase.nim");
	{
		...
		nimln(137, "nimlexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP1672));
	}
	LA3: ;
...
N_NIMCALL(void, openbaselexer_176027)(tbaselexer176018* l, tllstream174204* inputstream, NI buflen) {
	...
	nimln(147, "nimlexbase.nim");
	{
		...
		nimln(147, "nimlexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP1673));
	}
	LA3: ;
...
TMP1917[0] = &TMP1623[1];
TMP1623[1].kind = 1;
TMP1623[1].offset = offsetof(tbaselexer176018, Bufpos);
TMP1623[1].typ = (&NTI106);
TMP1623[1].name = "bufpos";
TMP1917[1] = &TMP1623[2];
TMP1623[2].kind = 1;
TMP1623[2].offset = offsetof(tbaselexer176018, Buf);
TMP1623[2].typ = (&NTI145);
TMP1623[2].name = "buf";
TMP1917[2] = &TMP1623[3];
TMP1623[3].kind = 1;
TMP1623[3].offset = offsetof(tbaselexer176018, Buflen);
TMP1623[3].typ = (&NTI106);
TMP1623[3].name = "bufLen";
TMP1917[3] = &TMP1623[4];
TMP1623[4].kind = 1;
TMP1623[4].offset = offsetof(tbaselexer176018, Stream);
TMP1623[4].typ = (&NTI174206);
TMP1623[4].name = "stream";
TMP1917[4] = &TMP1623[5];
TMP1623[5].kind = 1;
TMP1623[5].offset = offsetof(tbaselexer176018, Linenumber);
TMP1623[5].typ = (&NTI106);
TMP1623[5].name = "lineNumber";
TMP1917[5] = &TMP1623[6];
TMP1623[6].kind = 1;
TMP1623[6].offset = offsetof(tbaselexer176018, Sentinel);
TMP1623[6].typ = (&NTI106);
TMP1623[6].name = "sentinel";
TMP1917[6] = &TMP1623[7];
TMP1623[7].kind = 1;
TMP1623[7].offset = offsetof(tbaselexer176018, Linestart);
TMP1623[7].typ = (&NTI106);
TMP1623[7].name = "lineStart";
TMP1623[0].len = 7; TMP1623[0].kind = 2; TMP1623[0].sons = &TMP1917[0];
NTI176018.node = &TMP1623[0];
}
