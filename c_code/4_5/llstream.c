...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY122387 TMP1634 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
...
N_NIMCALL(NIM_BOOL, endswithopr_174646)(NimStringDesc* x) {
	...
	result = endswith_174602(x, TMP1634);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_174652)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_174602(line, TMP1635);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(void, llstreamwriteln_174274)(tllstream174204* s, NimStringDesc* data) {
	...
	llstreamwrite_174258(s, ((NimStringDesc*) &TMP1640));
	popFrame();
}
...
NTI174202.node = &TMP1625[6];
TMP1625[1].kind = 1;
TMP1625[1].offset = offsetof(tllstream174204, Kind);
TMP1625[1].typ = (&NTI174202);
TMP1625[1].name = "kind";
TMP1627[1] = &TMP1625[7];
TMP1625[7].kind = 1;
TMP1625[7].offset = offsetof(tllstream174204, F);
TMP1625[7].typ = (&NTI10004);
TMP1625[7].name = "f";
TMP1627[2] = &TMP1625[8];
TMP1625[8].kind = 1;
TMP1625[8].offset = offsetof(tllstream174204, S);
TMP1625[8].typ = (&NTI143);
TMP1625[8].name = "s";
TMP1627[3] = &TMP1625[9];
TMP1625[9].kind = 1;
TMP1625[9].offset = offsetof(tllstream174204, Rd);
TMP1625[9].typ = (&NTI106);
TMP1625[9].name = "rd";
TMP1627[4] = &TMP1625[10];
TMP1625[10].kind = 1;
TMP1625[10].offset = offsetof(tllstream174204, Wr);
TMP1625[10].typ = (&NTI106);
TMP1625[10].name = "wr";
TMP1627[5] = &TMP1625[11];
TMP1625[11].kind = 1;
TMP1625[11].offset = offsetof(tllstream174204, Lineoffset);
TMP1625[11].typ = (&NTI106);
TMP1625[11].name = "lineOffset";
TMP1625[0].len = 6; TMP1625[0].kind = 2; TMP1625[0].sons = &TMP1627[0];
NTI174204.node = &TMP1625[0];
NTI174206.size = sizeof(tllstream174204*);
NTI174206.kind = 22;
NTI174206.base = (&NTI174204);
NTI174206.marker = TMP1631;
}
