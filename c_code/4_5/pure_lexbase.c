...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4631, "L.sentinel < L.bufLen ", 22);
STRING_LITERAL(TMP4634, "0 <= toCopy ", 12);
STRING_LITERAL(TMP4642, "s < L.bufLen ", 13);
STRING_LITERAL(TMP4646, "L.bufLen - oldBufLen == oldBufLen ", 34);
STRING_LITERAL(TMP4652, "pos <= L.sentinel ", 18);
STRING_LITERAL(TMP4654, "L.buf[pos] == \'\\x0D\' ", 21);
STRING_LITERAL(TMP4655, "L.buf[pos] == \'\\x0A\' ", 21);
STRING_LITERAL(TMP4656, "0 < bufLen ", 11);
STRING_LITERAL(TMP4657, "not (input == nil) ", 19);
STRING_LITERAL(TMP4661, "", 0);
STRING_LITERAL(TMP4662, "\012", 1);
STRING_LITERAL(TMP4663, "^\012", 2);
...
N_NIMCALL(void, fillbuffer_291071)(tbaselexer291016* l) {
	...
	nimln(77, "lexbase.nim");
	{
		...
		nimln(77, "lexbase.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP4631));	}	LA3: ;
	nimln(78, "lexbase.nim");
	nimln(78, "lexbase.nim");
	nimln(78, "lexbase.nim");
	TMP4632 = subInt((*l).Buflen, (*l).Sentinel);
	TMP4633 = subInt((NI32)(TMP4632), 1);
	tocopy = (NI32)(TMP4633);
	nimln(79, "lexbase.nim");
	{
		...
		nimln(79, "lexbase.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP4634));	}	LA7: ;
	nimln(80, "lexbase.nim");
	{
		...
		nimln(81, "lexbase.nim");
		TMP4636 = mulInt(tocopy, 1);
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI32)(TMP4635)])), (NI32)(TMP4636));	}	LA11: ;
	...
	TMP4638 = mulInt((NI32)(TMP4637), 1);
	LOC13 = 0;
	LOC13 = readdata_143731((*l).Input, ((void*) (&(*l).Buf[tocopy])), (NI32)(TMP4638));
	TMP4639 = divInt(LOC13, 1);
	charsread = (NI32)(TMP4639);
	nimln(85, "lexbase.nim");
	nimln(85, "lexbase.nim");
	TMP4640 = addInt(tocopy, charsread);
	s = (NI32)(TMP4640);
	nimln(86, "lexbase.nim");
	{
		...
		nimln(86, "lexbase.nim");
		nimln(86, "lexbase.nim");
		TMP4641 = addInt((*l).Sentinel, 1);
		if (!(charsread < (NI32)(TMP4641))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			nimln(93, "lexbase.nim");
			{
				...
				nimln(93, "lexbase.nim");
				hiddenraiseassert_76217(((NimStringDesc*) &TMP4642));			}			LA22: ;
			...
			LA29: ;
			{
				...
				nimln(103, "lexbase.nim");
				TMP4643 = mulInt((*l).Buflen, 2);
				(*l).Buflen = (NI32)(TMP4643);
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				TMP4644 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4007(((void*) ((*l).Buf)), (NI32)(TMP4644));
				...
				nimln(105, "lexbase.nim");
				{
					...
					nimln(105, "lexbase.nim");
					nimln(105, "lexbase.nim");
					TMP4645 = subInt((*l).Buflen, oldbuflen);
					if (!!(((NI32)(TMP4645) == oldbuflen))) goto LA35;
					nimln(105, "lexbase.nim");
					hiddenraiseassert_76217(((NimStringDesc*) &TMP4646));				}				LA35: ;
				nimln(106, "lexbase.nim");
				nimln(107, "lexbase.nim");
				nimln(106, "lexbase.nim");
				nimln(107, "lexbase.nim");
				TMP4647 = mulInt(oldbuflen, 1);
				LOC37 = 0;
				LOC37 = readdata_143731((*l).Input, ((void*) (&(*l).Buf[oldbuflen])), (NI32)(TMP4647));
				TMP4648 = divInt(LOC37, 1);
				charsread = (NI32)(TMP4648);
				nimln(108, "lexbase.nim");
				{
					...
					(*l).Buf[(NI32)(TMP4649)] = 0;
					nimln(110, "lexbase.nim");
					nimln(110, "lexbase.nim");
					TMP4650 = addInt(oldbuflen, charsread);
					(*l).Sentinel = (NI32)(TMP4650);
					nimln(111, "lexbase.nim");
					goto LA19;
				}				LA40: ;
				nimln(112, "lexbase.nim");
				nimln(112, "lexbase.nim");
				TMP4651 = subInt((*l).Buflen, 1);
				s = (NI32)(TMP4651);
			}			LA27: ;
		} LA19: ;
	}	LA14: ;
...
N_NIMCALL(NI, fillbaselexer_291812)(tbaselexer291016* l, NI pos) {
	...
	nimln(115, "lexbase.nim");
	{
		...
		nimln(115, "lexbase.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP4652));	}	LA3: ;
...
N_NIMCALL(NI, handlecr_291049)(tbaselexer291016* l, NI pos) {
	...
	nimln(125, "lexbase.nim");
	{
		...
		nimln(125, "lexbase.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP4654));	}	LA3: ;
...
N_NIMCALL(NI, handlelf_291055)(tbaselexer291016* l, NI pos) {
	...
	nimln(132, "lexbase.nim");
	{
		...
		nimln(132, "lexbase.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP4655));	}	LA3: ;
...
N_NIMCALL(void, open_291026)(tbaselexer291016* l, tstream143629* input, NI buflen) {
	...
	nimln(142, "lexbase.nim");
	{
		...
		nimln(142, "lexbase.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP4656));	}	LA3: ;
	nimln(143, "lexbase.nim");
	{
		...
		nimln(143, "lexbase.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP4657));	}	LA7: ;
	...
	nimln(147, "lexbase.nim");
	nimln(147, "lexbase.nim");
	TMP4658 = mulInt(buflen, 1);
	LOC9 = 0;
	LOC9 = alloc_4001((NI32)(TMP4658));
	(*l).Buf = ((NCSTRING) (LOC9));
	nimln(148, "lexbase.nim");
	nimln(148, "lexbase.nim");
	TMP4659 = subInt(buflen, 1);
	(*l).Sentinel = (NI32)(TMP4659);
...
N_NIMCALL(NI, getcolnumber_291044)(tbaselexer291016* l, NI pos) {
	...
	nimln(155, "lexbase.nim");
	nimln(155, "lexbase.nim");
	TMP4660 = subInt(pos, (*l).Linestart);
	if ((NI32)(TMP4660) == (-2147483647 -1)) raiseOverflow();
	result = (NI32)abs((NI32)(TMP4660));
	popFrame();
	return result;
}
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src) {
...
N_NIMCALL(NimStringDesc*, getcurrentline_291039)(tbaselexer291016* l, NIM_BOOL marker) {
	...
	result = copyString(((NimStringDesc*) &TMP4661));
...
appendString(LOC6, ((NimStringDesc*) &TMP4663));
...
static TNimNode* TMP4770[8];
static TNimNode TMP4629[9];
...
TMP4770[0] = &TMP4629[1];
TMP4629[1].kind = 1;
TMP4629[1].offset = offsetof(tbaselexer291016, Bufpos);
TMP4629[1].typ = (&NTI105);
TMP4629[1].name = "bufpos";
TMP4770[1] = &TMP4629[2];
TMP4629[2].kind = 1;
TMP4629[2].offset = offsetof(tbaselexer291016, Buf);
TMP4629[2].typ = (&NTI144);
TMP4629[2].name = "buf";
TMP4770[2] = &TMP4629[3];
TMP4629[3].kind = 1;
TMP4629[3].offset = offsetof(tbaselexer291016, Buflen);
TMP4629[3].typ = (&NTI105);
TMP4629[3].name = "bufLen";
TMP4770[3] = &TMP4629[4];
TMP4629[4].kind = 1;
TMP4629[4].offset = offsetof(tbaselexer291016, Input);
TMP4629[4].typ = (&NTI143627);
TMP4629[4].name = "input";
TMP4770[4] = &TMP4629[5];
TMP4629[5].kind = 1;
TMP4629[5].offset = offsetof(tbaselexer291016, Linenumber);
TMP4629[5].typ = (&NTI105);
TMP4629[5].name = "LineNumber";
TMP4770[5] = &TMP4629[6];
TMP4629[6].kind = 1;
TMP4629[6].offset = offsetof(tbaselexer291016, Sentinel);
TMP4629[6].typ = (&NTI105);
TMP4629[6].name = "sentinel";
TMP4770[6] = &TMP4629[7];
TMP4629[7].kind = 1;
TMP4629[7].offset = offsetof(tbaselexer291016, Linestart);
TMP4629[7].typ = (&NTI105);
TMP4629[7].name = "lineStart";
TMP4770[7] = &TMP4629[8];
TMP4629[8].kind = 1;
TMP4629[8].offset = offsetof(tbaselexer291016, Fileopened);
TMP4629[8].typ = (&NTI133);
TMP4629[8].name = "fileOpened";
TMP4629[0].len = 8; TMP4629[0].kind = 2; TMP4629[0].sons = &TMP4770[0];
NTI291016.node = &TMP4629[0];
}
