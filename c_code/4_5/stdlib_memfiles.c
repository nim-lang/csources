...
STRING_LITERAL(TMP2964, "mappedSize > 0 ", 15);
STRING_LITERAL(TMP2965, "newFileSize == - 1 or mode != fmRead ", 37);
...
N_NIMCALL(void*, mapmem_238210)(tmemfile238204* m, NU8 mode, NI mappedsize, NI offset) {
	...
	nimln(52, "memfiles.nim");
	{
		...
		nimln(52, "memfiles.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP2964));
	}
	LA3: ;
...
N_NIMCALL(tmemfile238204, open_238803)(NimStringDesc* filename, NU8 mode, NI mappedsize, NI offset, NI newfilesize) {
	...
	nimln(95, "memfiles.nim");
	{
		...
		if (!!(LOC3)) goto LA5;
		nimln(95, "memfiles.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP2965));
	}
	LA5: ;
...
static TNimNode* TMP3046[3];
static TNimNode TMP2962[4];
...
TMP3046[0] = &TMP2962[1];
TMP2962[1].kind = 1;
TMP2962[1].offset = offsetof(tmemfile238204, Mem);
TMP2962[1].typ = (&NTI147);
TMP2962[1].name = "mem";
TMP3046[1] = &TMP2962[2];
TMP2962[2].kind = 1;
TMP2962[2].offset = offsetof(tmemfile238204, Size);
TMP2962[2].typ = (&NTI106);
TMP2962[2].name = "size";
TMP3046[2] = &TMP2962[3];
TMP2962[3].kind = 1;
TMP2962[3].offset = offsetof(tmemfile238204, Handle);
TMP2962[3].typ = (&NTI4409);
TMP2962[3].name = "handle";
TMP2962[0].len = 3; TMP2962[0].kind = 2; TMP2962[0].sons = &TMP3046[0];
NTI238204.node = &TMP2962[0];
}
