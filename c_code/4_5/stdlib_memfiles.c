...
N_NIMCALL(void*, mapmem_233210)(tmemfile233204* m, NU8 mode, NI mappedsize, NI offset) {
	...
	nimln(52, "memfiles.nim");
	{
		...
		nimln(52, "memfiles.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP2958));
	}
	LA3: ;
...
TMP3040[0] = &TMP2956[1];
TMP2956[1].kind = 1;
TMP2956[1].offset = offsetof(tmemfile233204, Mem);
TMP2956[1].typ = (&NTI147);
TMP2956[1].name = "mem";
TMP3040[1] = &TMP2956[2];
TMP2956[2].kind = 1;
TMP2956[2].offset = offsetof(tmemfile233204, Size);
TMP2956[2].typ = (&NTI106);
TMP2956[2].name = "size";
TMP3040[2] = &TMP2956[3];
TMP2956[3].kind = 1;
TMP2956[3].offset = offsetof(tmemfile233204, Handle);
TMP2956[3].typ = (&NTI4409);
TMP2956[3].name = "handle";
TMP2956[0].len = 3; TMP2956[0].kind = 2; TMP2956[0].sons = &TMP3040[0];
NTI233204.node = &TMP2956[0];
}
