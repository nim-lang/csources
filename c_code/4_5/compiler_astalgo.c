...
{	result = 0;
	{
		...
		res_199872 = start;
		{
			while (1) {
				...
				LA7: ;
				{
					internalerror_165215((*list).info, ((NimStringDesc*) &TMP2676));
				}
				LA5: ;
				res_199872 += ((NI) 1);
			} LA4: ;
	...
	{
		{
			...
			internalerror_165215((*n).info, ((NimStringDesc*) &TMP2957));
		}
		LA13: ;
		...
		LA17: ;
		{
			...
			res_199551 = ((NI) 1);
			{
				while (1) {
					...
					default:
					{
						internalerror_165215((*n).info, ((NimStringDesc*) &TMP2958));
					}
					break;
					}
					res_199551 += ((NI) 1);
...
TMP823[0] = &TMP793[1];
TMP793[1].kind = 1;
TMP793[1].offset = offsetof(Tiitable199274, counter);
TMP793[1].typ = (&NTI108);
...
TMP824[0] = &TMP793[4];
TMP793[4].kind = 1;
TMP793[4].offset = offsetof(Tiipair199270, key);
TMP793[4].typ = (&NTI108);
TMP793[4].name = "key";
TMP824[1] = &TMP793[5];
TMP793[5].kind = 1;
TMP793[5].offset = offsetof(Tiipair199270, val);
TMP793[5].typ = (&NTI108);
TMP793[5].name = "val";
TMP793[3].len = 2; TMP793[3].kind = 2; TMP793[3].sons = &TMP824[0];
NTI199270.node = &TMP793[3];
NTI199272.size = sizeof(Tiipairseq199272*);
NTI199272.kind = 24;
NTI199272.base = (&NTI199270);
NTI199272.flags = 2;
NTI199272.marker = TMP825;
TMP793[2].kind = 1;
TMP793[2].offset = offsetof(Tiitable199274, data);
TMP793[2].typ = (&NTI199272);
TMP793[2].name = "data";
TMP793[0].len = 2; TMP793[0].kind = 2; TMP793[0].sons = &TMP823[0];
NTI199274.node = &TMP793[0];
}
