...
N_NIMCALL(void, send_193009)(tsocketimpl182607* socket, NimStringDesc* data);
N_NIMCALL(TGenericSeq*, setLengthSeq)(TGenericSeq* seq, NI elemsize, NI newlen);
N_NIMCALL(void, genericSeqAssign)(void* dest, void* src_79604, TNimType* mt);
N_NIMCALL(void, TMP2676)(void* p, NI op);
...
865}
;
STRING_LITERAL(TMP1975, "\015\012", 2);
STRING_LITERAL(TMP2677, "suggest done", 12);
NIM_CONST TY84735 TMP3584 = {((NimStringDesc*) &TMP1043),
872}
;
...
static N_INLINE(void, writeln_170205)(FILE* f_170209, NimStringDesc** x_170213, NI x_170213Len0) {
	...
	write_12665(f_170209, ((NimStringDesc*) &TMP150));
}
...
appendString(LOC12, ((NimStringDesc*) &TMP1975));
			send_193009(stdoutsocket_196318, LOC12);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, clearbufferedmsgs_196449)(void) {
	genericSeqAssign(&bufferedmsgs_196438, NIM_NIL, (&NTI119408));
}
N_NIMCALL(void, TMP2676)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_196846)(void) {
	...
	LA3: ;
	{
		...
		LOC8 = 0;
		LOC8 = (*e_196850).Sup.message; (*e_196850).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2677));
...
static TNimNode* TMP1967[275];
NI TMP1969;
static char* NIM_CONST TMP1968[275] = {
"errUnknown", 
"errIllFormedAstX", 
"errInternal", 
"errCannotOpenFile", 
...
NTI195205.base = 0;
NTI195205.flags = 3;
for (TMP1969 = 0; TMP1969 < 275; TMP1969++) {
TMP19[TMP1969+11].kind = 1;
TMP19[TMP1969+11].offset = TMP1969;
TMP19[TMP1969+11].name = TMP1968[TMP1969];
TMP1967[TMP1969] = &TMP19[TMP1969+11];
}
TMP19[286].len = 275; TMP19[286].kind = 2; TMP19[286].sons = &TMP1967[0];
