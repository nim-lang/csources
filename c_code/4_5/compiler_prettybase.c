...
N_NIMCALL(void, loadfile_248043)(Tlineinfo163338 info) {
	...
	LA3: ;
	{
		...
		gsourcefiles_248038->data[i].lines = (TY122008*) newSeqRC1((&NTI122008), 0);
		...
		gsourcefiles_248038->data[i].isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP2679));
		{
			...
			res_248121 = rawNewString(((NI) 80));
			{
				while (1) {
					...
					gsourcefiles_248038->data[i].lines = (TY122008*) incrSeq(&(gsourcefiles_248038->data[i].lines)->Sup, sizeof(NimStringDesc*));
					LOC15 = 0;
		...
		pos = lex.bufpos;
		{
			while (1) {
				...
				case 13:
				{
					NimStringDesc* LOC21;
					LOC21 = 0;
					LOC21 = gsourcefiles_248038->data[i].newline; gsourcefiles_248038->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP2687));
				...
				case 0:
				{
					NimStringDesc* LOC23;
					LOC23 = 0;
					LOC23 = gsourcefiles_248038->data[i].newline; gsourcefiles_248038->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP2688));
...
{	loadfile_248043(info);
	...
	last = (NI)((NI)(first + LOC17) - ((NI) 1));
	{
		...
		LOC21 = 0;
		LOC21 = HEX5BHEX5D_85766(line, LOC20);
		LOC22 = 0;
