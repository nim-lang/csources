...
STRING_LITERAL(TMP2742, ".nimfix", 7);
STRING_LITERAL(TMP2750, "\015\012", 2);
STRING_LITERAL(TMP2751, "\012", 1);
...
N_NIMCALL(void, loadfile_263043)(tlineinfo180338 info) {
	...
	LA3: ;
	{
		...
		gsourcefiles_263038->data[i].Isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP2742));
		{
		...
		pos = lex.Bufpos;
		{
			while (1) {
				...
				case 13:
				{
					NimStringDesc* LOC21;
					LOC21 = 0;
					LOC21 = gsourcefiles_263038->data[i].Newline; gsourcefiles_263038->data[i].Newline = copyStringRC1(((NimStringDesc*) &TMP2750));
				...
				case 0:
				{
					NimStringDesc* LOC23;
					LOC23 = 0;
					LOC23 = gsourcefiles_263038->data[i].Newline; gsourcefiles_263038->data[i].Newline = copyStringRC1(((NimStringDesc*) &TMP2751));
