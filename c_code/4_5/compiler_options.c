...
N_NIMCALL(NimStringDesc*, removetrailingdirsep_114410)(NimStringDesc* path) {
	...
	nimln(205, "options.nim");
	{
		...
		if ((NU)((NI32)(TMP330)) > (NU)(path->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(path->data[(NI32)(TMP330)]) == (NU8)(47));
		LA4: ;
		if (!LOC3) goto LA5;
		...
		result = copyStrLast(path, 0, (NI32)(TMP331));
	}	goto LA1;
	LA5: ;
	{
...
N_NIMCALL(NimStringDesc*, getpackagename_114423)(NimStringDesc* path) {
	...
	nimln(217, "options.nim");
	{
		...
		if (!(((NU8)(path->data[(NI32)(TMP334)])) == ((NU8)(47)) || ((NU8)(path->data[(NI32)(TMP334)])) == ((NU8)(47)))) goto LA3;
		nimln(217, "options.nim");
		q = 2;
	}	LA3: ;
	i_114448 = 0;
	...
	while (1) {
		...
		nimln(219, "options.nim");
		{
			...
			LA12: ;
			{
				...
				nimln(222, "options.nim");
				TMP337 = subInt(b, 1);
				x = copyStrLast(path, (NI32)(TMP336), (NI32)(TMP337));
...
N_NIMCALL(void, libcandidates_114600)(NimStringDesc* s, TY9552** dest) {
	...
	nimln(300, "options.nim");
	TMP354 = addInt(le, 1);
	ri = nsuFindChar(s, 41, (NI32)(TMP354));
	nimln(301, "options.nim");
	{
		...
		nimln(302, "options.nim");
		TMP355 = subInt(le, 1);
		prefix = copyStrLast(s, 0, (NI32)(TMP355));
		nimln(303, "options.nim");
		nimln(303, "options.nim");
		nimln(303, "options.nim");
		TMP356 = addInt(ri, 1);
		suffix = copyStr(s, (NI32)(TMP356));
		middle_114611 = 0;
		HEX3Atmp_114626 = 0;
		...
		nimln(304, "options.nim");
		TMP358 = subInt(ri, 1);
		HEX3Atmp_114626 = copyStrLast(s, (NI32)(TMP357), (NI32)(TMP358));
		...
		nimln(248, "strutils.nim");
		{
			...
			nimln(248, "strutils.nim");
			hiddenraiseassert_76217(((NimStringDesc*) &TMP359));		}		LA9: ;
		nimln(249, "strutils.nim");
		{
			...
			while (1) {
				...
				middle_114611 = copyStrLast(HEX3Atmp_114626, first_114630, (NI32)(TMP360));
...
N_NIMCALL(NimStringDesc*, canondynlibname_114635)(NimStringDesc* s) {
	...
	nimln(312, "options.nim");
	{
		...
		result = copyStrLast(s, start, (NI32)(TMP363));
	}	goto LA7;
	LA9: ;
	{
