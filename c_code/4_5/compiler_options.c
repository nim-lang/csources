...
STRING_LITERAL(TMP1434, "*.nimble", 8);
STRING_LITERAL(TMP1435, "*.babel", 7);
STRING_LITERAL(TMP1436, "nimcache", 8);
STRING_LITERAL(TMP1438, "\012", 1);
STRING_LITERAL(TMP1439, "cannot create directory: ", 25);
STRING_LITERAL(TMP1486, "nim", 3);
STRING_LITERAL(TMP1864, "lib", 3);
static NIM_CONST TY178407 TMP1865 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x43, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP1866, "true", 4);
NU8 gidecmd_154115;
...
TY122008* commandargs_154259;
extern TNimType NTI122008; /* seq[string] */
NIM_BOOL gkeepcomments_154260;
TY122008* implicitimports_154280;
TY122008* implicitincludes_154300;
			...
			current_154888 = copyString(path);
			{
				while (1) {
					...
					parents += ((NI) 1);
					{
						...
						file_154841 = 0;
						HEX3Atmp_154855 = 0;
						HEX3Atmp_154855 = HEX2F_119292(d_154831, ((NimStringDesc*) &TMP1434));
					...
					}
					{
						...
						file_154842 = 0;
						HEX3Atmp_154871 = 0;
						HEX3Atmp_154871 = HEX2F_119292(d_154831, ((NimStringDesc*) &TMP1435));
...
N_NIMCALL(NimStringDesc*, getgeneratedpath_154428)(void) {
	...
	LA3: ;
	{
		...
		result = HEX2F_119292(LOC6, ((NimStringDesc*) &TMP1436));
	}
	LA1: ;
	return result;
}
...
static N_INLINE(void, writeln_155205)(FILE* f, NimStringDesc** x, NI xLen0) {
	...
	write_13457(f, ((NimStringDesc*) &TMP1438));
}
...
N_NIMCALL(NimStringDesc*, completegeneratedfilepath_155001)(NimStringDesc* f, NIM_BOOL createsubdir) {
	...
	subdir = getgeneratedpath_154428();
	{
		...
		pushSafePoint(&TMP1437);
		TMP1437.status = _setjmp(TMP1437.context);
		if (TMP1437.status == 0) {
			noscreateDir(subdir);
			popSafePoint();
		}
...
appendString(LOC10, ((NimStringDesc*) &TMP1439));
appendString(LOC10, subdir);
		...
		if (TMP1437.status != 0) reraiseException();
	}
	LA4: ;
...
N_NIMCALL(NimStringDesc*, findmodule_155351)(NimStringDesc* modulename, NimStringDesc* currentmodule) {
	...
	TY119589 LOC1;
	result = 0;
	m = nosaddFileExt(modulename, ((NimStringDesc*) &TMP1486));
	memset((void*)(&LOC1), 0, sizeof(LOC1));
...
N_NIMCALL(NimStringDesc*, canondynlibname_155459)(NimStringDesc* s) {
	...
	result = 0;
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = nsuStartsWith(s, ((NimStringDesc*) &TMP1864));
		if (!LOC3) goto LA4;
		start = ((NI) 3);
	}
	goto LA1;
	...
	LA1: ;
	ende = nsuFindCharSet(s, TMP1865, ((NI) 0));
	{
...
N_NIMCALL(void, incldynliboverride_155472)(NimStringDesc* lib) {
	...
	nstPut(gdlloverrides_154232, LOC1, ((NimStringDesc*) &TMP1866));
}
