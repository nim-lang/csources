...
N_NIMCALL(NimStringDesc*, setcookie_334117)(NimStringDesc* key, NimStringDesc* value, ttimeinfo95003* expires, NimStringDesc* domain, NimStringDesc* path, NIM_BOOL noname);
N_NIMCALL(NimStringDesc*, format_96999)(ttimeinfo95003* info, NimStringDesc* f);
STRING_LITERAL(TMP4686, "", 0);
STRING_LITERAL(TMP4687, "Set-Cookie: ", 12);
STRING_LITERAL(TMP4688, "=", 1);
STRING_LITERAL(TMP4689, "; Domain=", 9);
STRING_LITERAL(TMP4690, "; Path=", 7);
STRING_LITERAL(TMP4691, "; Expires=", 10);
STRING_LITERAL(TMP4692, "ddd\',\' dd MMM yyyy HH:mm:ss \'UTC\'", 33);
...
N_NIMCALL(tstringtable121810*, parsecookies_334012)(NimStringDesc* s) {
	...
	while (1) {
		...
		TMP4685 = subInt(i, 1);
		LOC16 = 0;
		LOC16 = copyStrLast(s, valstart, (NI32)(TMP4685));
...
N_NIMCALL(NimStringDesc*, setcookie_334106)(NimStringDesc* key, NimStringDesc* value, NimStringDesc* domain, NimStringDesc* path, NimStringDesc* expires, NIM_BOOL noname) {
	...
	result = copyString(((NimStringDesc*) &TMP4686));
...
appendString(LOC5, ((NimStringDesc*) &TMP4688));
...
appendString(LOC10, ((NimStringDesc*) &TMP4689));
...
appendString(LOC15, ((NimStringDesc*) &TMP4690));
...
appendString(LOC20, ((NimStringDesc*) &TMP4691));
...
N_NIMCALL(NimStringDesc*, setcookie_334117)(NimStringDesc* key, NimStringDesc* value, ttimeinfo95003* expires, NimStringDesc* domain, NimStringDesc* path, NIM_BOOL noname) {
	...
	LOC1 = 0;
	LOC1 = format_96999(expires, ((NimStringDesc*) &TMP4692));
