...
N_LIB_PRIVATE N_NIMCALL(void, annotateType_3vqehaz27L4f9a4jsACqXBg)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n, tyObject_TType_v9ae2Dpu13OW2ZJ2U9bNMd9cQ* t, tyObject_ConfigRefcolonObjectType__LaK09ayL9alwKUad7rts0rTw* conf);
...
{	result = (tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w*)0;
	...
	{
		{
			...
			res = ((NI) 0);
			{
				while (1) {
					...
					i = res;
					result = ithField_21EuTe7T3ZUxRBe5wCPmpg((*n).sons->data[i], field);
					{
	...
	case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 139):
	{
		...
		LA13_: ;
		result = ithField_21EuTe7T3ZUxRBe5wCPmpg((*n).sons->data[((NI) 0)], field);
		{
...
appendString(T9_, T10_);
						globalError_w3nlav3QVHhYSX6HNr5zYg_2(conf, (*n).info, T9_);
					}
					goto LA5_;
					LA7_: ;
					{
						{
							...
							internalError_dys2MtoFZDLw3XfiAfjOig(conf, T16_);
						}
						LA14_: ;
						annotateType_3vqehaz27L4f9a4jsACqXBg((*(*n).sons->data[i]).sons->data[((NI) 1)], (*field).typ, conf);
					}
					LA5_: ;
					i_2 += ((NI) 1);
				} LA4: ;
...
appendString(T30_, T31_);
							globalError_w3nlav3QVHhYSX6HNr5zYg_2(conf, (*n).info, T30_);
						}
						goto LA25_;
						LA28_: ;
						{
							annotateType_3vqehaz27L4f9a4jsACqXBg((*n).sons->data[i_3], (*x).sons->data[i_3], conf);
						}
						LA25_: ;
						i_4 += ((NI) 1);
					} LA24: ;
		...
		LA36_: ;
		{
			globalError_w3nlav3QVHhYSX6HNr5zYg_2(conf, (*n).info, ((NimStringDesc*) &TM_gkmEeaIyT0wHpJzs9ciIEJg_5));
		}
		LA18_: ;
	}
	break;
	case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 41):
	{
				...
				m = (tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*)0;
				{
					...
					i_6 = ((NI) 0);
					{
						while (1) {
							...
							annotateType_3vqehaz27L4f9a4jsACqXBg(m, T48_, conf);
							i_6 += ((NI) 1);
						} LA47: ;
					}
				}
		...
		LA42_: ;
		{
			globalError_w3nlav3QVHhYSX6HNr5zYg_2(conf, (*n).info, ((NimStringDesc*) &TM_gkmEeaIyT0wHpJzs9ciIEJg_6));
		}
		LA40_: ;
	}
	break;
	case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 39):
	{
				...
				m_2 = (tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*)0;
				{
					...
					i_8 = ((NI) 0);
					{
						while (1) {
							...
							annotateType_3vqehaz27L4f9a4jsACqXBg(m_2, T59_, conf);
							i_8 += ((NI) 1);
						} LA58: ;
					}
				}
		...
		LA53_: ;
		{
			globalError_w3nlav3QVHhYSX6HNr5zYg_2(conf, (*n).info, ((NimStringDesc*) &TM_gkmEeaIyT0wHpJzs9ciIEJg_7));
		}
		LA51_: ;
	}
	break;
	case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 16) ... ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 19):
	{
		...
		LA64_: ;
		{
			globalError_w3nlav3QVHhYSX6HNr5zYg_2(conf, (*n).info, ((NimStringDesc*) &TM_gkmEeaIyT0wHpJzs9ciIEJg_8));
		}
		LA62_: ;
	}
	break;
	case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 5) ... ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 15):
	{
		...
		LA70_: ;
		{
			globalError_w3nlav3QVHhYSX6HNr5zYg_2(conf, (*n).info, ((NimStringDesc*) &TM_gkmEeaIyT0wHpJzs9ciIEJg_9));
		}
		LA68_: ;
	}
	break;
	case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 20) ... ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 22):
	{
		...
		LA76_: ;
		{
			globalError_w3nlav3QVHhYSX6HNr5zYg_2(conf, (*n).info, ((NimStringDesc*) &TM_gkmEeaIyT0wHpJzs9ciIEJg_10));
		}
		LA74_: ;
	}
	break;
	case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 23):
	{
		...
		LA82_: ;
		{
			globalError_w3nlav3QVHhYSX6HNr5zYg_2(conf, (*n).info, ((NimStringDesc*) &TM_gkmEeaIyT0wHpJzs9ciIEJg_11));
		}
		LA80_: ;
	}
	break;
