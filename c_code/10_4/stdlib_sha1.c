...
static N_INLINE(void, swapEndian32_IzdisrH4sYnsItUtxSkomA_2sha1)(void* outp, void* inp) {
	NU32 tmp;
	tmp = (NU32)0;
	copyMem_fPlwH3r9agN9aEHB6yCPMh0wsystem(((void*) ((&tmp))), inp, ((NI) 4));
	tmp = __builtin_bswap32(tmp);
	copyMem_fPlwH3r9agN9aEHB6yCPMh0wsystem(outp, ((void*) ((&tmp))), ((NI) 4));
}
...
static N_INLINE(void, swapEndian64_IzdisrH4sYnsItUtxSkomA_4sha1)(void* outp, void* inp) {
	NU64 tmp;
	tmp = (NU64)0;
	copyMem_fPlwH3r9agN9aEHB6yCPMh0wsystem(((void*) ((&tmp))), inp, ((NI) 8));
	tmp = __builtin_bswap64(tmp);
	copyMem_fPlwH3r9agN9aEHB6yCPMh0wsystem(outp, ((void*) ((&tmp))), ((NI) 8));
}
