...
N_NIMCALL(void, handlecmdline_535603)(void) {
	...
	{
		nimln(39, "nimrod.nim");
		processcmdline_529207(((NU8) 0), ((NimStringDesc*) &TMP7782));
		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP7783;
			TY109700 p;
		...
		LA7: ;
		nimln(50, "nimrod.nim");
		loadconfigs_187607(((NimStringDesc*) &TMP7784));
		nimln(53, "nimrod.nim");
		initvars_172714();
		nimln(54, "nimrod.nim");
		processcmdline_529207(((NU8) 1), ((NimStringDesc*) &TMP7782));
		nimln(55, "nimrod.nim");
		maincommand_533011();
		nimln(56, "nimrod.nim");
		{
			...
			nimln(62, "nimrod.nim");
			{
				...
				nimln(63, "nimrod.nim");
				{
					...
					LA37: ;
					{
						...
						nimln(69, "nimrod.nim");
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_138208, ((NimStringDesc*) &TMP7785));
						LOC42 = 0;
...
appendString(LOC44, arguments_529205);
				...
				LA33: ;
				{
					...
					LA48: ;
					{
						...
						nimln(78, "nimrod.nim");
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_138208, ((NimStringDesc*) &TMP7782));
