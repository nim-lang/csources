...
N_NIMCALL(void, definesymbol_166006)(NimStringDesc* symbol) {
	...
	nstPut(gsymbols_166003, symbol, ((NimStringDesc*) &TMP982));
	popFrame();
}
...
N_NIMCALL(void, undefsymbol_166011)(NimStringDesc* symbol) {
	...
	nstPut(gsymbols_166003, symbol, ((NimStringDesc*) &TMP983));
	popFrame();
}
...
N_NIMCALL(NI, countdefinedsymbols_166042)(void) {
	...
	while (1) {
		...
		nimln(41, "strtabs.nim");
		{
			...
			{
				nimln(38, "condsyms.nim");
				if (!eqStrings(val_166046, ((NimStringDesc*) &TMP982))) goto LA8;
				nimln(38, "condsyms.nim");
...
N_NIMCALL(void, initdefines_166072)(void) {
	...
	case ((NU8) 7):
	{
		...
		definesymbol_166006(((NimStringDesc*) &TMP1002));
	...
	case ((NU8) 11):
	{
		...
		definesymbol_166006(((NimStringDesc*) &TMP1003));
	...
	case ((NU8) 18):
	{
		...
		definesymbol_166006(((NimStringDesc*) &TMP1004));
	}
	break;
	case ((NU8) 19):
	{
...
appendString(LOC13, LOC14);
	...
	nimln(90, "condsyms.nim");
	{
		...
		definesymbol_166006(((NimStringDesc*) &TMP1008));
	}
	LA18: ;
	popFrame();
}
