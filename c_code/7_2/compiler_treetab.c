...
N_NIMCALL(NIM_BOOL, treesequivalent_223181)(tnode171659* a, tnode171659* b);
static N_INLINE(NIM_BOOL, eqStrings)(NimStringDesc* a, NimStringDesc* b);
N_NIMCALL(NIM_BOOL, sametypeornil_204663)(ttype171693* a, ttype171693* b, NU8 flags);
N_NIMCALL(NI, nodetablerawget_223378)(tnodetable171717 t, NI k, tnode171659* key);
static N_INLINE(NI, nexttry_178196)(NI h, NI maxhash);
N_NIMCALL(NI, mulInt)(NI a, NI b);
N_NIMCALL(NI, nodetableget_223401)(tnodetable171717 t, tnode171659* key);
N_NIMCALL(void, nodetablerawinsert_223412)(tnodepairseq171715** data, NI k, tnode171659* key, NI val);
	...
	LA3: ;
	{
		...
		default:
		{
			nimln(49, "treetab.nim");
			{
				...
				HEX3Atmp_223371 = (NI64)(TMP3161);
				nimln(1301, "system.nim");
				res_223373 = 0;
				nimln(1302, "system.nim");
				while (1) {
					nimln(1302, "system.nim");
					if (!(res_223373 <= HEX3Atmp_223371)) goto LA26;
					nimln(1301, "system.nim");
					i_223348 = res_223373;
					nimln(51, "treetab.nim");
					{
						...
						if ((NU)(i_223348) >= (NU)((*a).kindU.S6.Sons->Sup.len)) raiseIndexError();
						if (((TMP3158[(*b).Kind/8] &(1<<((*b).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3159));
						if ((NU)(i_223348) >= (NU)((*b).kindU.S6.Sons->Sup.len)) raiseIndexError();
						LOC29 = 0;
						LOC29 = treesequivalent_223181((*a).kindU.S6.Sons->data[i_223348], (*b).kindU.S6.Sons->data[i_223348]);
						if (!!(LOC29)) goto LA30;
						nimln(51, "treetab.nim");
						goto BeforeRet;
					}					LA30: ;
					nimln(1304, "system.nim");
					res_223373 = addInt(res_223373, 1);
				} LA26: ;
...
N_NIMCALL(NI, nodetablerawget_223378)(tnodetable171717 t, NI k, tnode171659* key) {
	...
	while (1) {
		...
		nimln(58, "treetab.nim");
		{
			...
			nimln(58, "treetab.nim");
			if ((NU)(h) >= (NU)(t.Data->Sup.len)) raiseIndexError();
			LOC4 = treesequivalent_223181(t.Data->data[h].Key, key);
			LA5: ;
			if (!LOC4) goto LA6;
...
N_NIMCALL(NI, nodetableget_223401)(tnodetable171717 t, tnode171659* key) {
	...
	index = nodetablerawget_223378(t, LOC1, key);
...
N_NIMCALL(void, nodetableput_223605)(tnodetable171717* t, tnode171659* key, NI val) {
	...
	LA3: ;
	{
		nimln(85, "treetab.nim");
		{
			...
			n = (tnodepairseq171715*) newSeq((&NTI171715), (NI64)(TMP3166));
			i_223836 = 0;
			HEX3Atmp_223874 = 0;
...
N_NIMCALL(NI, nodetabletestorset_223881)(tnodetable171717* t, tnode171659* key, NI val) {
	...
	LA3: ;
	{
		nimln(102, "treetab.nim");
		{
			...
			n = (tnodepairseq171715*) newSeq((&NTI171715), (NI64)(TMP3167));
			i_224036 = 0;
			HEX3Atmp_224074 = 0;
