...
;
STRING_LITERAL(TMP121, "openbsd", 7);
...
N_NIMCALL(void, settarget_173621)(NU8 o, NU8 c) {
	...
	targetcpu_173587 = c;
	targetos_173589 = o;
	intsize_173610 = (NI64)(cpu_173480[(c)- 1].Field1 / 8);
	floatsize_173611 = (NI64)(cpu_173480[(c)- 1].Field3 / 8);
	ptrsize_173612 = (NI64)(cpu_173480[(c)- 1].Field4 / 8);
	LOC1 = 0;
	LOC1 = tnl_173613; tnl_173613 = copyStringRC1(os_173069[(o)- 1].Field5);
	if (LOC1) nimGCunrefNoCycle(LOC1);
}
NIM_EXTERNC N_NOINLINE(void, HEX00_platformInit)(void) {
	hostcpu_173588 = nametocpu_173604(((NimStringDesc*) &TMP67));
