...
N_NIMCALL(void, newrecropetostr_177492)(NimStringDesc** result, NI* resultlen, trope177009* r) {
	TY180353* stack;
	TY177515 LOC1;
	stack = (TY180353*) newSeq((&NTI180353), 1);
		...
		while (1) {
			...
			it = pop_177533((&stack));
			{
				while (1) {
					...
					stack = (TY180353*) incrSeq(&(stack)->Sup, sizeof(trope177009*));
	...
	num = 0;
	{
		while (1) {
			...
			if (!(i <= (NI64)(length - 1))) goto LA2;
			{
				...
				case 36:
				{
					app_177060(&result, ((NimStringDesc*) &TMP3373));
					i += 1;
				}
				break;
				case 35:
				...
				case 48 ... 57:
				{
					...
					num = j;
					{
						...
						LOC22 = 0;
						LOC22 = nimIntToStr(j);
						errorhandler_177143.ClEnv? errorhandler_177143.ClPrc(((NU8) 1), LOC22, NIM_FALSE, errorhandler_177143.ClEnv):((TMP3374)(errorhandler_177143.ClPrc))(((NU8) 1), LOC22, NIM_FALSE);
					}
					goto LA18;
					LA20: ;
					{
				...
				default:
				{
					...
					errorhandler_177143.ClEnv? errorhandler_177143.ClPrc(((NU8) 1), LOC27, NIM_FALSE, errorhandler_177143.ClEnv):((TMP3375)(errorhandler_177143.ClPrc))(((NU8) 1), LOC27, NIM_FALSE);
				}
				break;
				}
			}
...
N_NIMCALL(void, writerope_178423)(trope177009* head, NimStringDesc* filename, NIM_BOOL usewarning) {
	...
	LA4: ;
	{
		errorhandler_177143.ClEnv? errorhandler_177143.ClPrc(((NU8) 0), filename, usewarning, errorhandler_177143.ClEnv):((TMP4194)(errorhandler_177143.ClPrc))(((NU8) 0), filename, usewarning);
	}
	LA1: ;
}
...
NIM_EXTERNC N_NOINLINE(void, compiler_ropesInit)(void) {
	...
	asgnRefNoCycle((void**) (&rnl_178454), newrope_177176(tnl_174629));
	asgnRefNoCycle((void**) (&softrnl_178455), newrope_177176(tnl_174629));
}
