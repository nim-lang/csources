...
N_NIMCALL(tsym223849*, ithfield_477012)(tnode223819* n, NI field) {
	...
	{
		{
			...
			HEX3Atmp_477188 = (NI64)(LOC3 - 1);
			res_477191 = 0;
			{
				while (1) {
					if (!(res_477191 <= HEX3Atmp_477188)) goto LA5;
					i_477029 = res_477191;
					result = ithfield_477012((*n).kindU.S6.Sons->data[i_477029], (NI64)(field - i_477029));
					{
	...
	case ((NU8) 137):
	{
		...
		LA13: ;
		result = ithfield_477012((*n).kindU.S6.Sons->data[0], (NI64)(field - 1));
		{
			...
			res_477197 = 1;
			{
				while (1) {
					...
					case ((NU8) 88):
					{
						...
						result = ithfield_477012(LOC24, (NI64)(field - 1));
						{
