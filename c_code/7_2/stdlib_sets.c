...
static N_INLINE(NIM_BOOL, mustrehash_133316)(NI length, NI counter);
...
static N_INLINE(NI, nexttry_133406)(NI h, NI maxhash);
...
static N_INLINE(NI, nexttry_133406)(NI h, NI maxhash) {
	...
	nimln(51, "sets.nim");
	TMP400 = mulInt(5, h);
	TMP401 = addInt((NI64)(TMP400), 1);
	result = (NI)((NI64)(TMP401) & maxhash);
	popFrame();
	return result;
}
