...
N_NIMCALL(NI, rawget_130420)(stringtableobj130012* t, NimStringDesc* key);
N_NIMCALL(NI, myhash_130171)(stringtableobj130012* t, NimStringDesc* key);
...
N_NIMCALL(NIM_BOOL, mycmp_130182)(stringtableobj130012* t, NimStringDesc* a, NimStringDesc* b);
...
static N_INLINE(NI, nexttry_130409)(NI h, NI maxhash);
N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src);
N_NIMCALL(NimStringDesc*, copyStringRC1)(NimStringDesc* src);
N_NIMCALL(NIM_BOOL, mustrehash_130194)(NI length, NI counter);
N_NIMCALL(void, enlarge_130520)(stringtableobj130012* t);
N_NIMCALL(void*, newSeq)(TNimType* typ, NI len);
N_NIMCALL(void, rawinsert_130498)(stringtableobj130012* t, keyvaluepairseq130010** data, NimStringDesc* key, NimStringDesc* val);
static N_INLINE(void, asgnRefNoCycle)(void** dest, void* src);
STRING_LITERAL(TMP1348, "", 0);
extern TNimType NTI3211; /* RootObj */
TNimType NTI130012; /* StringTableObj */
extern TNimType NTI108; /* int */
TNimType NTI130008; /* KeyValuePair */
extern TNimType NTI149; /* string */
TNimType NTI130010; /* KeyValuePairSeq */
TNimType NTI130006; /* StringTableMode */
TNimType NTI130014; /* StringTableRef */
extern tgcheap46816 gch_46844;
N_NIMCALL(void, TMP42)(void* p, NI op) {
	keyvaluepairseq130010* a;
	NI LOC1;
	a = (keyvaluepairseq130010*)p;
	LOC1 = 0;
...
N_NIMCALL(void, TMP46)(void* p, NI op) {
	stringtableobj130012* a;
	a = (stringtableobj130012*)p;
...
N_NIMCALL(stringtableobj130012*, nstnewStringTable)(NU8 mode) {
	stringtableobj130012* result;
	result = 0;
	result = (stringtableobj130012*) newObj((&NTI130014), sizeof(stringtableobj130012));
	(*result).Sup.m_type = (&NTI130012);
	(*result).Mode = mode;
	(*result).Counter = 0;
	if ((*result).Data) nimGCunrefNoCycle((*result).Data);
	(*result).Data = (keyvaluepairseq130010*) newSeqRC1((&NTI130010), 64);
	return result;
}
...
N_NIMCALL(NI, myhash_130171)(stringtableobj130012* t, NimStringDesc* key) {
	...
	case ((NU8) 0):
	{
		result = hash_127839(key);
	}
	break;
	case ((NU8) 1):
	{
		result = hashignorecase_127977(key);
	}
	break;
	case ((NU8) 2):
	{
		result = hashignorestyle_127885(key);
	}
	break;
	}
	return result;
	...
	h = (NI)(LOC1 & ((*t).Data->Sup.len-1));
	{
		while (1) {
			if (!!((*t).Data->data[h].Field0 == 0)) goto LA3;
			{
				NIM_BOOL LOC6;
				LOC6 = 0;
				LOC6 = mycmp_130182(t, (*t).Data->data[h].Field0, key);
				if (!LOC6) goto LA7;
				result = h;
				goto BeforeRet;
			}
			LA7: ;
			h = nexttry_130409(h, ((*t).Data->Sup.len-1));
		} LA3: ;
	}
	result = -1;
	BeforeRet: ;
...
N_NIMCALL(void, rawinsert_130498)(stringtableobj130012* t, keyvaluepairseq130010** data, NimStringDesc* key, NimStringDesc* val) {
	...
	h = (NI)(LOC1 & ((*data)->Sup.len-1));
	{
		while (1) {
			...
			h = nexttry_130409(h, ((*data)->Sup.len-1));
		} LA3: ;
	}
	LOC4 = 0;
...
N_NIMCALL(void, enlarge_130520)(stringtableobj130012* t) {
	keyvaluepairseq130010* n;
	keyvaluepairseq130010* LOC8;
	n = 0;
	n = (keyvaluepairseq130010*) newSeq((&NTI130010), (NI64)((*t).Data->Sup.len * 2));
	{
		NI i_130563;
		NI HEX3Atmp_130582;
		NI res_130585;
		i_130563 = 0;
		HEX3Atmp_130582 = 0;
		HEX3Atmp_130582 = ((*t).Data->Sup.len-1);
		res_130585 = 0;
		{
			while (1) {
				if (!(res_130585 <= HEX3Atmp_130582)) goto LA3;
				i_130563 = res_130585;
				{
					if (!!((*t).Data->data[i_130563].Field0 == 0)) goto LA6;
					rawinsert_130498(t, &n, (*t).Data->data[i_130563].Field0, (*t).Data->data[i_130563].Field1);
				}
				LA6: ;
				res_130585 += 1;
			} LA3: ;
	...
	{
		{
			NIM_BOOL LOC9;
			LOC9 = 0;
			LOC9 = mustrehash_130194((*t).Data->Sup.len, (*t).Counter);
			if (!LOC9) goto LA10;
			enlarge_130520(t);
		}
		LA10: ;
		rawinsert_130498(t, &(*t).Data, key, val);
		(*t).Counter += 1;
	}
	LA1: ;
}
...
NTI130012.size = sizeof(stringtableobj130012);
NTI130012.kind = 17;
NTI130012.base = (&NTI3211);
TMP40[0] = &TMP25[1];
TMP25[1].kind = 1;
TMP25[1].offset = offsetof(stringtableobj130012, Counter);
TMP25[1].typ = (&NTI108);
TMP25[1].name = "counter";
TMP40[1] = &TMP25[2];
NTI130008.size = sizeof(keyvaluepair130008);
NTI130008.kind = 18;
NTI130008.base = 0;
NTI130008.flags = 2;
TMP41[0] = &TMP25[4];
TMP25[4].kind = 1;
TMP25[4].offset = offsetof(keyvaluepair130008, Field0);
TMP25[4].typ = (&NTI149);
TMP25[4].name = "Field0";
TMP41[1] = &TMP25[5];
TMP25[5].kind = 1;
TMP25[5].offset = offsetof(keyvaluepair130008, Field1);
TMP25[5].typ = (&NTI149);
TMP25[5].name = "Field1";
TMP25[3].len = 2; TMP25[3].kind = 2; TMP25[3].sons = &TMP41[0];
NTI130008.node = &TMP25[3];
NTI130010.size = sizeof(keyvaluepairseq130010*);
NTI130010.kind = 24;
NTI130010.base = (&NTI130008);
NTI130010.flags = 2;
NTI130010.marker = TMP42;
TMP25[2].kind = 1;
TMP25[2].offset = offsetof(stringtableobj130012, Data);
TMP25[2].typ = (&NTI130010);
TMP25[2].name = "data";
TMP40[2] = &TMP25[6];
NTI130006.size = sizeof(NU8);
NTI130006.kind = 14;
NTI130006.base = 0;
NTI130006.flags = 3;
...
NTI130006.node = &TMP25[10];
TMP25[6].kind = 1;
TMP25[6].offset = offsetof(stringtableobj130012, Mode);
TMP25[6].typ = (&NTI130006);
TMP25[6].name = "mode";
TMP25[0].len = 3; TMP25[0].kind = 2; TMP25[0].sons = &TMP40[0];
NTI130012.node = &TMP25[0];
NTI130014.size = sizeof(stringtableobj130012*);
NTI130014.kind = 22;
NTI130014.base = (&NTI130012);
NTI130014.marker = TMP46;
}
