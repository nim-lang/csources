...
STRING_LITERAL(TMP1555, "key not found: ", 15);
STRING_LITERAL(TMP1797, "", 0);
STRING_LITERAL(TMP2040, "format string: key not found: ", 30);
...
appendString(LOC6, ((NimStringDesc*) &TMP1555));
...
appendString(LOC1, ((NimStringDesc*) &TMP2040));
appendString(LOC1, s);
