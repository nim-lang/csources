...
typedef struct erecoverableerror180346 erecoverableerror180346;
typedef struct valueerror3449 valueerror3449;
typedef struct Exception Exception;
typedef struct TNimObject TNimObject;
typedef struct slice182555 slice182555;
typedef struct TSafePoint TSafePoint;
typedef struct TY85545 TY85545;
typedef struct esuggestdone180348 esuggestdone180348;
...
typedef NimStringDesc* TY180287[277];
struct  TNimObject  {
TNimType* m_type;
};
struct  Exception  {
...
struct  erecoverableerror180346  {
  valueerror3449 Sup;
};
...
N_NIMCALL(void, newfileinfo_180502)(NimStringDesc* fullpath, NimStringDesc* projpath, tfileinfo180338* Result);
...
N_NIMCALL(void, HEX3Aanonymous_182877)(NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
N_NIMCALL(void, internalerror_182688)(NimStringDesc* errmsg);
N_NIMCALL(void, writecontext_182231)(tlineinfo180340 lastinfo);
...
N_NIMCALL(NimStringDesc*, tomsgfilename_181831)(tlineinfo180340 info);
N_NIMCALL(NimStringDesc*, coordtostr_182057)(NI coord);
N_NIMCALL(NimStringDesc*, nimIntToStr)(NI x);
N_NIMCALL(NimStringDesc*, getmessagestr_182077)(NU16 msg, NimStringDesc* arg);
...
N_NIMCALL(NIM_BOOL, ignoremsgbecauseofidetools_182284)(NU16 msg);
N_NIMCALL(void, handleerror_182100)(NU16 msg, NU8 eh, NimStringDesc* s);
N_NIMCALL(void, writestacktrace_16007)(void);
N_NOINLINE(void, raiserecoverableerror_181059)(NimStringDesc* msg);
...
N_NIMCALL(void, limessage_182456)(tlineinfo180340 info, NU16 msg, NimStringDesc* arg, NU8 eh);
static N_INLINE(NIM_BOOL, contains_182566)(slice182555 s_182572, NU16 value_182575);
static N_INLINE(slice182555, HEX2EHEX2E_182546)(NU16 a_182550, NU16 b_182552);
N_NIMCALL(void, writesurroundingsrc_182429)(tlineinfo180340 info);
...
N_NIMCALL(NI32, fileinfoidx_180547)(NimStringDesc* filename, NIM_BOOL* isknownfile);
...
NIM_CONST TY180287 msgkindtostr_180286 = {((NimStringDesc*) &TMP152),
...
875}
;
table180378 filenametoindextbl_180420;
extern TNimType NTI180378; /* Table */
TY180421* fileinfos_180442;
TNimType NTI180338; /* TFileInfo */
extern TNimType NTI149; /* string */
extern TNimType NTI177007; /* PRope */
TNimType NTI180353; /* seq[PRope] */
TNimType NTI180421; /* seq[TFileInfo] */
extern tgcheap47616 gch_47644;
NI32 systemfileidx_180443;
extern NimStringDesc* tnl_174629;
extern NU32 gglobaloptions_169128;
tlineinfo180340 gcmdlineinfo_181006;
tlineinfo180340 gcodegenlineinfo_181052;
NU64 gnotes_181117;
NI gerrorcounter_181118;
NI ghintcounter_181119;
NI gwarncounter_181120;
NI gerrormax_181121;
TY181139* msgcontext_181160;
TNimType NTI180340; /* TLineInfo */
extern TNimType NTI112; /* int16 */
extern TNimType NTI114; /* int32 */
TNimType NTI181139; /* seq[TLineInfo] */
tlineinfo180340 lasterror_181161;
TY119808* bufferedmsgs_181163;
NU8 erroroutputs_181165;
TY181166 writelnhook_181169;
tlineinfo180340 gtrackpos_181904;
...
TNimType NTI180346; /* ERecoverableError */
TNimType NTI181065; /* ref ERecoverableError */
...
TNimType NTI180334; /* TNoteKind */
TNimType NTI180336; /* TNoteKinds */
extern TNimType NTI119808; /* seq[string] */
extern TNimType NTI3427; /* Exception */
TNimType NTI180348; /* ESuggestDone */
TNimType NTI181451; /* ref ESuggestDone */
N_NIMCALL(void, TMP137)(void* p, NI op) {
	TY180353* a;
	NI LOC1;
	a = (TY180353*)p;
...
N_NIMCALL(trope177009*, makecstring_180459)(NimStringDesc* s) {
	...
	res = copyString(((NimStringDesc*) &TMP141));
	{
		...
		i_180477 = 0;
		HEX3Atmp_180482 = 0;
		HEX3Atmp_180482 = (NI64)(s->Sup.len - 1);
		res_180485 = 0;
		{
			while (1) {
				NimStringDesc* LOC9;
				if (!(res_180485 <= HEX3Atmp_180482)) goto LA3;
				i_180477 = res_180485;
				{
					trope177009* LOC8;
					if (!(((NI) ((NI64)((NI64)(i_180477 + 1) % 64))) == 0)) goto LA6;
					res = addChar(res, 34);
...
appendString(res, tnl_174629);
				...
				LA6: ;
				LOC9 = 0;
				LOC9 = tocchar_180449(s->data[i_180477]);
...
N_NIMCALL(void, newfileinfo_180502)(NimStringDesc* fullpath, NimStringDesc* projpath, tfileinfo180338* Result) {
	...
	unsureAsgnRef((void**) (&(*Result).Quotedname), makecstring_180459(filename));
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		...
		LA4: ;
		if (!LOC3) goto LA5;
		unsureAsgnRef((void**) (&(*Result).Lines), (TY180353*) newSeq((&NTI180353), 0));
	}
	LA5: ;
}
...
static N_INLINE(void, writeln_170205)(FILE* f_170209, NimStringDesc** x_170213, NI x_170213Len0) {
	...
	write_13265(f_170209, ((NimStringDesc*) &TMP148));
}
...
N_NIMCALL(void, msgwriteln_181947)(NimStringDesc* s) {
	{
		...
		{
			TY181990 LOC9;
			if (!((erroroutputs_181165 &(1<<((((NU8) 1))&7)))!=0)) goto LA7;
			memset((void*)LOC9, 0, sizeof(LOC9));
			LOC9[0] = copyString(s);
			writeln_170205(stderr, LOC9, 1);
		}
		LA7: ;
	}
	goto LA1;
	LA3: ;
	{
		{
			TY181990 LOC15;
			if (!((erroroutputs_181165 &(1<<((((NU8) 0))&7)))!=0)) goto LA13;
			memset((void*)LOC15, 0, sizeof(LOC15));
			LOC15[0] = copyString(s);
			writeln_170205(stdout, LOC15, 1);
		}
		LA13: ;
	}
	LA1: ;
	{
		if (!((erroroutputs_181165 &(1<<((((NU8) 2))&7)))!=0)) goto LA18;
		safeadd_181242((&bufferedmsgs_181163), s);
	}
	LA18: ;
}
...
N_NIMCALL(NimStringDesc*, tomsgfilename_181831)(tlineinfo180340 info) {
	...
	LA3: ;
	{
		...
		result = copyString(fileinfos_180442->data[info.Fileindex].Fullpath);
	}
	goto LA1;
	LA6: ;
	{
		result = copyString(fileinfos_180442->data[info.Fileindex].Projpath);
	}
	LA1: ;
	return result;
}
...
N_NIMCALL(NimStringDesc*, msgkindtostring_182067)(NU16 kind) {
	NimStringDesc* result;
	result = 0;
	result = copyString(msgkindtostr_180286[(kind)- 0]);
	return result;
}
...
N_NIMCALL(NimStringDesc*, getmessagestr_182077)(NU16 msg, NimStringDesc* arg) {
	...
	result = 0;
	LOC1 = 0;
	LOC1 = msgkindtostring_182067(msg);
...
N_NIMCALL(void, writecontext_182231)(tlineinfo180340 lastinfo) {
	...
	info = lastinfo;
	{
		...
		i_182258 = 0;
		HEX3Atmp_182264 = 0;
		HEX3Atmp_182264 = (NI64)(msgcontext_181160->Sup.len - 1);
		res_182267 = 0;
		{
			while (1) {
				if (!(res_182267 <= HEX3Atmp_182264)) goto LA3;
				i_182258 = res_182267;
				{
					NIM_BOOL LOC6;
					NIM_BOOL LOC7;
					...
					LOC6 = 0;
					LOC7 = 0;
					LOC7 = HEX3DHEX3D_182220(msgcontext_181160->data[i_182258], lastinfo);
					LOC6 = !(LOC7);
					if (!(LOC6)) goto LA8;
					LOC9 = 0;
					LOC9 = HEX3DHEX3D_182220(msgcontext_181160->data[i_182258], info);
					LOC6 = !(LOC9);
					LA8: ;
					if (!LOC6) goto LA10;
					memset((void*)LOC12, 0, sizeof(LOC12));
					LOC12[0] = tomsgfilename_181831(msgcontext_181160->data[i_182258]);
					LOC12[1] = coordtostr_182057(((NI) (msgcontext_181160->data[i_182258].Line)));
					LOC12[2] = coordtostr_182057(((NI) (msgcontext_181160->data[i_182258].Col)));
					LOC12[3] = getmessagestr_182077(((NU16) 184), ((NimStringDesc*) &TMP140));
					LOC13 = 0;
					LOC13 = nsuFormatOpenArray(((NimStringDesc*) &TMP150), LOC12, 4);
					msgwriteln_181947(LOC13);
				}
				LA10: ;
				info = msgcontext_181160->data[i_182258];
				res_182267 += 1;
			} LA3: ;
		}
	}
...
N_NIMCALL(void, TMP429)(void* p, NI op) {
	erecoverableerror180346* a;
	a = (erecoverableerror180346*)p;
...
N_NOINLINE(void, raiserecoverableerror_181059)(NimStringDesc* msg) {
	erecoverableerror180346* e_181064;
	NimStringDesc* LOC1;
	e_181064 = 0;
	e_181064 = (erecoverableerror180346*) newObj((&NTI181065), sizeof(erecoverableerror180346));
	(*e_181064).Sup.Sup.Sup.m_type = (&NTI180346);
	LOC1 = 0;
	LOC1 = (*e_181064).Sup.Sup.message; (*e_181064).Sup.Sup.message = copyStringRC1(msg);
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_181064, "ERecoverableError");
}
...
N_NIMCALL(void, handleerror_182100)(NU16 msg, NU8 eh, NimStringDesc* s) {
	...
	LA5: ;
	{
		...
		LA18: ;
		if (!LOC17) goto LA19;
		gerrorcounter_181118 += 1;
		gexitcode_169129 = ((NI8) 1);
		{
			if (!(gerrormax_181121 <= gerrorcounter_181118)) goto LA23;
			{
				NIM_BOOL LOC27;
				NIM_BOOL LOC28;
				LOC27 = 0;
		...
		LA36: ;
		{
			...
			raiserecoverableerror_181059(s);
		}
		goto LA21;
		LA47: ;
		LA21: ;
...
{	frmt = 0;
	...
	case ((NU16) 230) ... ((NU16) 259):
	{
		...
		LA6: ;
		{
			if (!!(((gnotes_181117 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0))) goto LA10;
			goto BeforeRet;
		}
		LA10: ;
		LOC12 = unknownlineinfo_181130();
		writecontext_182231(LOC12);
		frmt = copyString(((NimStringDesc*) &TMP427));
		gwarncounter_181120 += 1;
	}
	break;
	case ((NU16) 260) ... ((NU16) 276):
	{
		...
		LA16: ;
		{
			if (!!(((gnotes_181117 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0))) goto LA20;
			goto BeforeRet;
		}
		LA20: ;
		frmt = copyString(((NimStringDesc*) &TMP428));
		ghintcounter_181119 += 1;
	}
	break;
	}
	LOC22 = 0;
	LOC22 = msgkindtostring_182067(msg);
	LOC23 = 0;
	...
	s = nsuFormatSingleElem(frmt, LOC23);
	{
		NIM_BOOL LOC26;
		LOC26 = 0;
		LOC26 = ignoremsgbecauseofidetools_182284(msg);
		if (!!(LOC26)) goto LA27;
		msgwriteln_181947(s);
	}
	LA27: ;
	handleerror_182100(msg, ((NU8) 1), s);
	}BeforeRet: ;
}
...
N_NIMCALL(void, rawmessage_182415)(NU16 msg, NimStringDesc* arg) {
	...
	rawmessage_182325(msg, LOC1, 1);
}

N_NIMCALL(void, internalerror_182688)(NimStringDesc* errmsg) {
	tlineinfo180340 LOC5;
{	{
		if (!(gcmd_169130 == ((NU8) 14))) goto LA3;
		goto BeforeRet;
	}
	LA3: ;
	LOC5 = unknownlineinfo_181130();
	writecontext_182231(LOC5);
	rawmessage_182415(((NU16) 2), errmsg);
	}BeforeRet: ;
}
...
N_NIMCALL(NimStringDesc*, tofullpathconsiderdirty_181807)(NI32 fileidx) {
	...
	LA3: ;
	{
		if (!!(fileinfos_180442->data[fileidx].Dirtyfile == 0)) goto LA6;
		result = copyString(fileinfos_180442->data[fileidx].Dirtyfile);
	}
	goto LA1;
	LA6: ;
	{
		result = copyString(fileinfos_180442->data[fileidx].Fullpath);
	}
	LA1: ;
	return result;
}
...
static N_INLINE(NIM_BOOL, contains_182566)(slice182555 s_182572, NU16 value_182575) {
	...
	result = 0;
	LOC1 = 0;
	LOC1 = (s_182572.A <= value_182575);
	if (!(LOC1)) goto LA2;
	LOC1 = (value_182575 <= s_182572.B);
	LA2: ;
	result = LOC1;
	return result;
}
...
N_NIMCALL(void, addsourceline_182724)(NI32 fileidx, NimStringDesc* line) {
	...
	fileinfos_180442->data[fileidx].Lines = (TY180353*) incrSeq(&(fileinfos_180442->data[fileidx].Lines)->Sup, sizeof(trope177009*));
	asgnRefNoCycle((void**) (&fileinfos_180442->data[fileidx].Lines->data[fileinfos_180442->data[fileidx].Lines->Sup.len-1]), LOC1);
}
...
{	result = 0;
	...
	LA3: ;
	{
		...
		if (!(LOC7)) goto LA8;
		LOC7 = (fileinfos_180442->data[i.Fileindex].Lines->Sup.len == 0);
		LA8: ;
		if (!LOC7) goto LA9;
		...
		if (TMP1039.status == 0) {
			{
				NimStringDesc* line_182782;
				NimStringDesc* HEX3Atmp_182838;
				FILE* f_182841;
				NimStringDesc* res_182843;
				line_182782 = 0;
				HEX3Atmp_182838 = 0;
				HEX3Atmp_182838 = tofullpath_181637(i.Fileindex);
				f_182841 = open_13017(HEX3Atmp_182838, ((NU8) 0), 8000);
				res_182843 = rawNewString(80);
				{
					while (1) {
						NIM_BOOL LOC15;
						LOC15 = 0;
						LOC15 = readline_13289(f_182841, (&res_182843));
						if (!LOC15) goto LA14;
						line_182782 = res_182843;
						addsourceline_182724(i.Fileindex, line_182782);
					} LA14: ;
				}
				fclose(f_182841);
			}
	...
	{
		NimStringDesc* LOC22;
		if (!!((((NI) (i.Fileindex)) < fileinfos_180442->Sup.len))) goto LA20;
		LOC22 = 0;
		LOC22 = HEX24_182808(TMP1049);
		internalerror_182688(LOC22);
	}
	LA20: ;
	{
		if (!(fileinfos_180442->data[i.Fileindex].Lines->Sup.len < ((NI) (i.Line)))) goto LA25;
		result = NIM_NIL;
		goto BeforeRet;
	}
	LA25: ;
	result = fileinfos_180442->data[i.Fileindex].Lines->data[(NI16)(i.Line - ((NI16) 1))];
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, limessage_182456)(tlineinfo180340 info, NU16 msg, NimStringDesc* arg, NU8 eh) {
	...
	case ((NU16) 0) ... ((NU16) 229):
	{
		writecontext_182231(info);
		frmt = copyString(((NimStringDesc*) &TMP1034));
		lasterror_181161 = info;
	}
	break;
	case ((NU16) 230) ... ((NU16) 259):
	{
		...
		if (LOC3) goto LA4;
		LOC3 = !(((gnotes_181117 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0));
		LA4: ;
		ignoremsg = LOC3;
		{
	...
	case ((NU16) 260) ... ((NU16) 276):
	{
		...
		if (LOC10) goto LA11;
		LOC10 = !(((gnotes_181117 &(IL64(1)<<(((((NU16) (msg))- 230))&IL64(63))))!=0));
		LA11: ;
		ignoremsg = LOC10;
	...
	memset((void*)LOC12, 0, sizeof(LOC12));
	LOC12[0] = tomsgfilename_181831(info);
	LOC12[1] = coordtostr_182057(((NI) (info.Line)));
	LOC12[2] = coordtostr_182057(((NI) (info.Col)));
	LOC12[3] = getmessagestr_182077(msg, arg);
	s = nsuFormatOpenArray(frmt, LOC12, 4);
	{
		...
		if (!(LOC15)) goto LA16;
		LOC17 = 0;
		LOC17 = ignoremsgbecauseofidetools_182284(msg);
		LOC15 = !(LOC17);
		LA16: ;
		if (!LOC15) goto LA18;
		msgwriteln_181947(s);
		{
			...
			slice182555 LOC24;
			LOC22 = 0;
			LOC22 = (2 <= gverbosity_169137);
			if (!(LOC22)) goto LA23;
			LOC24 = HEX2EHEX2E_182546(((NU16) 0), ((NU16) 229));
			LOC22 = contains_182566(LOC24, msg);
			LA23: ;
			if (!LOC22) goto LA25;
			writesurroundingsrc_182429(info);
		}
		LA25: ;
	}
	LA18: ;
	handleerror_182100(msg, eh, s);
}

N_NIMCALL(void, message_182658)(tlineinfo180340 info, NU16 msg, NimStringDesc* arg) {
	limessage_182456(info, msg, arg, ((NU8) 0));
}
...
{	{
	...
	LA3: ;
	writecontext_182231(info);
	limessage_182456(info, ((NU16) 2), errmsg, ((NU8) 1));
	}BeforeRet: ;
}
...
N_NIMCALL(NI32, fileinfoidx_180547)(NimStringDesc* filename, NIM_BOOL* isknownfile) {
	...
	if (TMP1075.status == 0) {
		canon = canonicalizepath_169393(filename);
		shallow_86424((&canon));
		popSafePoint();
	}
	else {
	...
	if (TMP1075.status != 0) reraiseException();
	{
		NIM_BOOL LOC6;
		LOC6 = 0;
		LOC6 = haskey_180558(filenametoindextbl_180420, canon);
		if (!LOC6) goto LA7;
		result = HEX5BHEX5D_180619(filenametoindextbl_180420, canon);
	}
	goto LA4;
	LA7: ;
	{
		NimStringDesc* LOC10;
		tfileinfo180338 LOC16;
		(*isknownfile) = NIM_FALSE;
		result = ((NI32) (fileinfos_180442->Sup.len));
		LOC10 = 0;
		{
		...
		newfileinfo_180502(canon, LOC10, (&LOC16));
		fileinfos_180442 = (TY180421*) incrSeq(&(fileinfos_180442)->Sup, sizeof(tfileinfo180338));
		genericAssign((void*)(&fileinfos_180442->data[fileinfos_180442->Sup.len-1]), (void*)(&LOC16), (&NTI180338));
		HEX5BHEX5DHEX3D_180681((&filenametoindextbl_180420), canon, result);
	}
	LA4: ;
	return result;
}
...
N_NIMCALL(NI32, fileinfoidx_180930)(NimStringDesc* filename) {
	...
	result = 0;
	dummy = 0;
	result = fileinfoidx_180547(filename, (&dummy));
	return result;
}
...
N_NIMCALL(NimStringDesc*, tofilename_181625)(NI32 fileidx) {
	...
	LA3: ;
	{
		result = copyString(fileinfos_180442->data[fileidx].Projpath);
	}
	LA1: ;
	return result;
}
...
N_NIMCALL(void, setdirtyfile_181649)(NI32 fileidx, NimStringDesc* filename) {
	NimStringDesc* LOC1;
	LOC1 = 0;
	LOC1 = fileinfos_180442->data[fileidx].Dirtyfile; fileinfos_180442->data[fileidx].Dirtyfile = copyStringRC1(filename);
	if (LOC1) nimGCunrefNoCycle(LOC1);
}

N_NIMCALL(void, suggestwriteln_181187)(NimStringDesc* s) {
	{
		if (!((erroroutputs_181165 &(1<<((((NU8) 0))&7)))!=0)) goto LA3;
		{
			TY181990 LOC9;
			if (!writelnhook_181169.ClPrc == 0) goto LA7;
			memset((void*)LOC9, 0, sizeof(LOC9));
			LOC9[0] = copyString(s);
		...
		LA7: ;
		{
			writelnhook_181169.ClEnv? writelnhook_181169.ClPrc(s, writelnhook_181169.ClEnv):((TMP1989)(writelnhook_181169.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
	{
		if (!((erroroutputs_181165 &(1<<((((NU8) 2))&7)))!=0)) goto LA13;
		safeadd_181242((&bufferedmsgs_181163), s);
	}
	LA13: ;
}
...
N_NIMCALL(void, globalerror_182616)(tlineinfo180340 info, NU16 msg, NimStringDesc* arg) {
	limessage_182456(info, msg, arg, ((NU8) 2));
}

N_NIMCALL(void, pushinfocontext_181530)(tlineinfo180340 info) {
	msgcontext_181160 = (TY181139*) incrSeq(&(msgcontext_181160)->Sup, sizeof(tlineinfo180340));
	msgcontext_181160->data[msgcontext_181160->Sup.len-1] = info;
}

N_NIMCALL(void, popinfocontext_181557)(void) {
	msgcontext_181160 = (TY181139*) setLengthSeq(&(msgcontext_181160)->Sup, sizeof(tlineinfo180340), (NI64)(msgcontext_181160->Sup.len - 1));
}

N_NIMCALL(void, clearbufferedmsgs_181179)(void) {
	genericSeqAssign((&bufferedmsgs_181163), NIM_NIL, (&NTI119808));
}
N_NIMCALL(void, TMP2706)(void* p, NI op) {
	esuggestdone180348* a;
	a = (esuggestdone180348*)p;
...
N_NIMCALL(void, suggestquit_181446)(void) {
	esuggestdone180348* e_181450;
	NimStringDesc* LOC1;
	e_181450 = 0;
	e_181450 = (esuggestdone180348*) newObj((&NTI181451), sizeof(esuggestdone180348));
	(*e_181450).Sup.Sup.m_type = (&NTI180348);
	LOC1 = 0;
	LOC1 = (*e_181450).Sup.message; (*e_181450).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2707));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_181450, "ESuggestDone");
}

N_NIMCALL(void, globalerror_182627)(tlineinfo180340 info, NimStringDesc* arg) {
	limessage_182456(info, ((NU16) 4), arg, ((NU8) 2));
}
...
N_NIMCALL(NimStringDesc*, formatmsg_182439)(tlineinfo180340 info, NU16 msg, NimStringDesc* arg) {
	...
	LOC4[0] = tomsgfilename_181831(info);
	LOC4[1] = coordtostr_182057(((NI) (info.Line)));
	LOC4[2] = coordtostr_182057(((NI) (info.Col)));
	LOC4[3] = getmessagestr_182077(msg, arg);
	result = nsuFormatOpenArray(frmt, LOC4, 4);
	return result;
}

N_NIMCALL(void, localerror_182648)(tlineinfo180340 info, NimStringDesc* arg) {
	limessage_182456(info, ((NU16) 4), arg, ((NU8) 0));
}

N_NIMCALL(void, fatal_182605)(tlineinfo180340 info, NU16 msg, NimStringDesc* arg) {
	limessage_182456(info, msg, arg, ((NU8) 1));
}
...
N_NIMCALL(tlineinfo180340, getinfocontext_181592)(NI index) {
	...
	LA1: ;
	{
		...
		result = unknownlineinfo_181130();
	}
	goto LA6;
	LA8: ;
	{
		result = msgcontext_181160->data[i];
	}
	LA6: ;
	return result;
}
...
N_NIMCALL(NimStringDesc*, HEX24_181883)(tlineinfo180340 info) {
	NimStringDesc* result;
	result = 0;
	result = tofilelinecol_181873(info);
	return result;
}
...
N_NIMCALL(NI, getinfocontextlen_181485)(void) {
	NI result;
{	result = 0;
	result = msgcontext_181160->Sup.len;
	goto BeforeRet;
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, setinfocontextlen_181505)(NI l) {
	msgcontext_181160 = (TY181139*) setLengthSeq(&(msgcontext_181160)->Sup, sizeof(tlineinfo180340), l);
}
...
N_NIMCALL(trope177009*, quotedfilename_182860)(tlineinfo180340 i) {
	...
	result = 0;
	{
		...
		LOC5 = 0;
		LOC5 = HEX24_182808(TMP3624);
		internalerror_182688(LOC5);
	}
	LA3: ;
	result = fileinfos_180442->data[i.Fileindex].Quotedname;
	return result;
}
...
NIM_EXTERNC N_NOINLINE(void, compiler_msgsInit)(void) {
	tfileinfo180338 LOC1;
	tfileinfo180338 LOC2;
	TY177138 LOC3;
	chckNil((void*)(&filenametoindextbl_180420));
	genericReset((void*)(&filenametoindextbl_180420), (&NTI180378));
	inittable_180370(64, (&filenametoindextbl_180420));
	if (fileinfos_180442) nimGCunrefNoCycle(fileinfos_180442);
	fileinfos_180442 = (TY180421*) newSeqRC1((&NTI180421), 0);
	memset((void*)(&LOC1), 0, sizeof(LOC1));
	newfileinfo_180502(((NimStringDesc*) &TMP140), ((NimStringDesc*) &TMP142), (&LOC1));
	fileinfos_180442 = (TY180421*) incrSeq(&(fileinfos_180442)->Sup, sizeof(tfileinfo180338));
	genericAssign((void*)(&fileinfos_180442->data[fileinfos_180442->Sup.len-1]), (void*)(&LOC1), (&NTI180338));
	gcmdlineinfo_181006 = newlineinfo_180943(((NI32) 0), 1, 1);
	memset((void*)(&LOC2), 0, sizeof(LOC2));
	newfileinfo_180502(((NimStringDesc*) &TMP140), ((NimStringDesc*) &TMP143), (&LOC2));
	fileinfos_180442 = (TY180421*) incrSeq(&(fileinfos_180442)->Sup, sizeof(tfileinfo180338));
	genericAssign((void*)(&fileinfos_180442->data[fileinfos_180442->Sup.len-1]), (void*)(&LOC2), (&NTI180338));
	gcodegenlineinfo_181052 = newlineinfo_180943(((NI32) 1), 1, 1);
	gnotes_181117 = IL64(140737439596543);
	gerrorcounter_181118 = 0;
	ghintcounter_181119 = 0;
	gwarncounter_181120 = 0;
	gerrormax_181121 = 1;
	if (msgcontext_181160) nimGCunrefNoCycle(msgcontext_181160);
	msgcontext_181160 = (TY181139*) newSeqRC1((&NTI181139), 0);
	lasterror_181161 = unknownlineinfo_181130();
	erroroutputs_181165 = 3;
	memset((void*)(&LOC3), 0, sizeof(LOC3));
	LOC3.ClPrc = ((TMP432) (HEX3Aanonymous_182877)); LOC3.ClEnv = NIM_NIL;
...
NTI180338.size = sizeof(tfileinfo180338);
NTI180338.kind = 18;
NTI180338.base = 0;
NTI180338.flags = 2;
TMP136[0] = &TMP19[1];
TMP19[1].kind = 1;
TMP19[1].offset = offsetof(tfileinfo180338, Fullpath);
TMP19[1].typ = (&NTI149);
TMP19[1].name = "fullPath";
TMP136[1] = &TMP19[2];
TMP19[2].kind = 1;
TMP19[2].offset = offsetof(tfileinfo180338, Projpath);
TMP19[2].typ = (&NTI149);
TMP19[2].name = "projPath";
TMP136[2] = &TMP19[3];
TMP19[3].kind = 1;
TMP19[3].offset = offsetof(tfileinfo180338, Shortname);
TMP19[3].typ = (&NTI149);
TMP19[3].name = "shortName";
TMP136[3] = &TMP19[4];
TMP19[4].kind = 1;
TMP19[4].offset = offsetof(tfileinfo180338, Quotedname);
TMP19[4].typ = (&NTI177007);
TMP19[4].name = "quotedName";
TMP136[4] = &TMP19[5];
NTI180353.size = sizeof(TY180353*);
NTI180353.kind = 24;
NTI180353.base = (&NTI177007);
NTI180353.flags = 2;
NTI180353.marker = TMP137;
TMP19[5].kind = 1;
TMP19[5].offset = offsetof(tfileinfo180338, Lines);
TMP19[5].typ = (&NTI180353);
TMP19[5].name = "lines";
TMP136[5] = &TMP19[6];
TMP19[6].kind = 1;
TMP19[6].offset = offsetof(tfileinfo180338, Dirtyfile);
TMP19[6].typ = (&NTI149);
TMP19[6].name = "dirtyfile";
TMP19[0].len = 6; TMP19[0].kind = 2; TMP19[0].sons = &TMP136[0];
NTI180338.node = &TMP19[0];
NTI180421.size = sizeof(TY180421*);
NTI180421.kind = 24;
NTI180421.base = (&NTI180338);
NTI180421.flags = 2;
NTI180421.marker = TMP138;
NTI180340.size = sizeof(tlineinfo180340);
NTI180340.kind = 18;
NTI180340.base = 0;
NTI180340.flags = 3;
TMP144[0] = &TMP19[8];
TMP19[8].kind = 1;
TMP19[8].offset = offsetof(tlineinfo180340, Line);
TMP19[8].typ = (&NTI112);
TMP19[8].name = "line";
TMP144[1] = &TMP19[9];
TMP19[9].kind = 1;
TMP19[9].offset = offsetof(tlineinfo180340, Col);
TMP19[9].typ = (&NTI112);
TMP19[9].name = "col";
TMP144[2] = &TMP19[10];
TMP19[10].kind = 1;
TMP19[10].offset = offsetof(tlineinfo180340, Fileindex);
TMP19[10].typ = (&NTI114);
TMP19[10].name = "fileIndex";
TMP19[7].len = 3; TMP19[7].kind = 2; TMP19[7].sons = &TMP144[0];
NTI180340.node = &TMP19[7];
NTI181139.size = sizeof(TY181139*);
NTI181139.kind = 24;
NTI181139.base = (&NTI180340);
NTI181139.flags = 2;
NTI181139.marker = TMP145;
NTI180346.size = sizeof(erecoverableerror180346);
NTI180346.kind = 17;
NTI180346.base = (&NTI3449);
TMP19[11].len = 0; TMP19[11].kind = 2;
NTI180346.node = &TMP19[11];
NTI181065.size = sizeof(erecoverableerror180346*);
NTI181065.kind = 22;
NTI181065.base = (&NTI180346);
NTI181065.marker = TMP429;
...
NTI180005.node = &TMP19[289];
NTI180334.size = sizeof(NU16);
NTI180334.kind = 20;
NTI180334.base = (&NTI180005);
NTI180334.flags = 3;
NTI180336.size = sizeof(NU64);
NTI180336.kind = 19;
NTI180336.base = (&NTI180334);
NTI180336.flags = 3;
TMP19[290].len = 230; TMP19[290].kind = 0;
NTI180336.node = &TMP19[290];
NTI180348.size = sizeof(esuggestdone180348);
NTI180348.kind = 17;
NTI180348.base = (&NTI3427);
TMP19[291].len = 0; TMP19[291].kind = 2;
NTI180348.node = &TMP19[291];
NTI181451.size = sizeof(esuggestdone180348*);
NTI181451.kind = 22;
NTI181451.base = (&NTI180348);
NTI181451.marker = TMP2706;
}
