...
static NIM_CONST TY113118 TMP935 = {
...
static NIM_CONST TY113118 TMP940 = {
0x00, 0x00, 0x00, 0x00, 0x20, 0xE8, 0xFF, 0x27,
0xFF, 0xFF, 0xFF, 0x87, 0xFE, 0xFF, 0xFF, 0x07,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
...
NIM_CONST TY114486 TMP987 = {((NimStringDesc*) &TMP988),
...
N_NIMCALL(tprocess144203*, startcmd_144428)(NimStringDesc* command, NU8 options) {
	...
	while (1) {
		...
		LOC2 = 0;
		LOC2 = a->data[(NI64)(TMP948)]; a->data[(NI64)(TMP948)] = copyStringRC1(c->data[i_144473]);
...
N_NIMCALL(NCSTRING*, tocstringarray_145626)(NimStringDesc** b, NI bLen0, NimStringDesc** a, NI aLen0) {
	...
	while (1) {
		...
		memcpy(((void*) (result[(i_145654)- 0])), ((void*) (b[i_145654]->data)), (NI64)(TMP968));		nimln(1311, "system.nim");
	...
	while (1) {
		...
		memcpy(((void*) (result[((NI64)(TMP971))- 0])), ((void*) (a[i_145664]->data)), (NI64)(TMP972));		nimln(1311, "system.nim");
...
N_NIMCALL(NCSTRING*, envtocstringarray_145723)(void) {
	...
	while (1) {
		...
		key_145727 = copyStrLast(environment_104029->data[i_145756], 0, (NI64)(TMP978));
		nimln(1152, "os.nim");
		nimln(1152, "os.nim");
		if ((NU)(i_145756) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1152, "os.nim");
		TMP979 = addInt(p_145762, 1);
		val_145728 = copyStr(environment_104029->data[i_145756], (NI64)(TMP979));
	...
	while (1) {
		...
		key_145741 = copyStrLast(environment_104029->data[i_145772], 0, (NI64)(TMP982));
		nimln(1152, "os.nim");
		nimln(1152, "os.nim");
		if ((NU)(i_145772) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1152, "os.nim");
		TMP983 = addInt(p_145778, 1);
		val_145742 = copyStr(environment_104029->data[i_145772], (NI64)(TMP983));
