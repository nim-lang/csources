...
N_NIMCALL(void, renderparamtypes_358233)(TY125202** found, Tnode214790* n);
N_NIMCALL(NimStringDesc*, rendertype_356209)(Tnode214790* n);
...
STRING_LITERAL(TMP5074, "", 0);
STRING_LITERAL(TMP5075, "*", 1);
STRING_LITERAL(TMP5076, "renderPlainSymbolName() with ", 29);
STRING_LITERAL(TMP5083, "ref.", 4);
STRING_LITERAL(TMP5084, "ptr.", 4);
STRING_LITERAL(TMP5085, "proc(", 5);
STRING_LITERAL(TMP5086, "tuple[", 6);
STRING_LITERAL(TMP5087, "renderParamTypes(found,n) with ", 31);
...
{	result = 0;
	result = copyString(((NimStringDesc*) &TMP5074));
	switch ((*n).kind) {
	case ((NU8) 31):
	{
		{
			...
			LOC3 = 0;
			LOC3 = len_215059(n);
			HEX3Atmp_356202 = (LOC3 - 1);
			res_356205 = ((NI) 0);
			{
				while (1) {
					NI LOC6;
					Tnode214790* LOC7;
					if (!(res_356205 <= HEX3Atmp_356202)) goto LA5;
					i_356026 = res_356205;
					LOC6 = 0;
					LOC6 = len_215059(n);
					LOC7 = 0;
					LOC7 = HEX5BHEX5D_215238(n, (LOC6 - 1));
					result = renderplainsymbolname_356004(LOC7);
					{
	...
	{
		{
			if (!!(eqStrings((*(*n).kindU.S5.ident).s, ((NimStringDesc*) &TMP5075)))) goto LA15;
	...
	case ((NU8) 3):
	{
		result = renderdefinitionname_233113((*n).kindU.S4.sym, NIM_TRUE);
	}
	break;
	case ((NU8) 43):
	{
		Tnode214790* LOC19;
		LOC19 = 0;
		LOC19 = HEX5BHEX5D_215238(n, ((NI) 0));
		result = renderplainsymbolname_356004(LOC19);
	}
	break;
	case ((NU8) 53):
	{
		...
		LOC21 = len_215059(n);
		LOC22 = 0;
		LOC22 = HEX5BHEX5D_215238(n, (LOC21 - 1));
		result = renderplainsymbolname_356004(LOC22);
	}
	break;
	default:
	{
		NimStringDesc* LOC24;
		LOC24 = 0;
		LOC24 = rawNewString(reprEnum((*n).kind, (&NTI214020))->Sup.len + 29);
appendString(LOC24, ((NimStringDesc*) &TMP5076));
appendString(LOC24, reprEnum((*n).kind, (&NTI214020)));
		internalerror_187100((*n).info, LOC24);
	}
	break;
	}
	}BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, rendertype_356209)(Tnode214790* n) {
	...
	case ((NU8) 3):
	{
		result = typetostring_240017((*(*n).kindU.S4.sym).typ, ((NU8) 0));
	}
	break;
	case ((NU8) 143):
	{
		Tnode214790* LOC4;
		LOC4 = 0;
		LOC4 = HEX5BHEX5D_215238(n, ((NI) 0));
		result = rendertype_356209(LOC4);
	}
	break;
	case ((NU8) 141):
	{
		...
		LOC8 = 0;
		LOC8 = rendertype_356209(LOC7);
		LOC6 = rawNewString(LOC8->Sup.len + 4);
appendString(LOC6, ((NimStringDesc*) &TMP5083));
appendString(LOC6, LOC8);
	...
	case ((NU8) 142):
	{
		...
		LOC12 = 0;
		LOC12 = rendertype_356209(LOC11);
		LOC10 = rawNewString(LOC12->Sup.len + 4);
appendString(LOC10, ((NimStringDesc*) &TMP5084));
appendString(LOC10, LOC12);
	...
	{
		Tnode214790* params;
		params = HEX5BHEX5D_215238(n, ((NI) 0));
		result = copyString(((NimStringDesc*) &TMP5085));
		{
			NI i_357418;
			NI HEX3Atmp_358202;
			NI LOC15;
			...
			HEX3Atmp_358202 = 0;
			LOC15 = 0;
			LOC15 = len_215059(params);
			HEX3Atmp_358202 = (LOC15 - 1);
			res_358205 = ((NI) 1);
			{
				while (1) {
					NimStringDesc* LOC18;
					Tnode214790* LOC19;
					NimStringDesc* LOC20;
					if (!(res_358205 <= HEX3Atmp_358202)) goto LA17;
					i_357418 = res_358205;
					LOC18 = 0;
					LOC19 = 0;
					LOC19 = HEX5BHEX5D_215238(params, i_357418);
					LOC20 = 0;
					LOC20 = rendertype_356209(LOC19);
...
appendString(result, LOC18);
	...
	case ((NU8) 35):
	{
		...
		LOC23 = 0;
		LOC23 = HEX5BHEX5D_215238(n, typepos);
		typestr = rendertype_356209(LOC23);
		result = copyString(typestr);
		{
			...
			i_357620 = 0;
			HEX3Atmp_358210 = 0;
			HEX3Atmp_358210 = (typepos - 1);
			res_358213 = ((NI) 1);
			{
				while (1) {
					NimStringDesc* LOC27;
					if (!(res_358213 <= HEX3Atmp_358210)) goto LA26;
					i_357620 = res_358213;
					LOC27 = 0;
...
appendString(result, LOC27);
	...
	case ((NU8) 134):
	{
		result = copyString(((NimStringDesc*) &TMP5086));
		{
			NI i_357818;
			NI HEX3Atmp_358218;
			NI LOC30;
			...
			res_358221 = ((NI) 0);
			{
				while (1) {
					...
					Tnode214790* LOC34;
					NimStringDesc* LOC35;
					if (!(res_358221 <= HEX3Atmp_358218)) goto LA32;
					i_357818 = res_358221;
					LOC33 = 0;
					LOC34 = 0;
					LOC34 = HEX5BHEX5D_215238(n, i_357818);
					LOC35 = 0;
					LOC35 = rendertype_356209(LOC34);
...
appendString(result, LOC33);
	...
	case ((NU8) 42):
	{
		...
		LOC37 = 0;
		LOC38 = 0;
		LOC38 = HEX5BHEX5D_215238(n, ((NI) 0));
		LOC39 = 0;
		LOC39 = rendertype_356209(LOC38);
		...
		result = LOC37;
		{
			...
			res_358229 = ((NI) 1);
			{
				while (1) {
					...
					Tnode214790* LOC45;
					NimStringDesc* LOC46;
					if (!(res_358229 <= HEX3Atmp_358226)) goto LA43;
					i_358018 = res_358229;
					LOC44 = 0;
					LOC45 = 0;
					LOC45 = HEX5BHEX5D_215238(n, i_358018);
					LOC46 = 0;
					LOC46 = rendertype_356209(LOC45);
...
{	switch ((*n).kind) {
	...
	{
		{
			...
			LOC3 = 0;
			LOC3 = len_215059(n);
			HEX3Atmp_358619 = (LOC3 - 1);
			res_358622 = ((NI) 1);
			{
				while (1) {
					Tnode214790* LOC6;
					if (!(res_358622 <= HEX3Atmp_358619)) goto LA5;
					i_358256 = res_358622;
					LOC6 = 0;
					LOC6 = HEX5BHEX5D_215238(n, i_358256);
					renderparamtypes_358233(found, LOC6);
					res_358622 += ((NI) 1);
				} LA5: ;
			}
		}
	...
	case ((NU8) 35):
	{
		...
		LOC9 = 0;
		LOC9 = HEX5BHEX5D_215238(n, typepos);
		typestr = rendertype_356209(LOC9);
		{
			NIM_BOOL LOC12;
			Tnode214790* LOC14;
			Ttype214828* typ;
			...
			if (!(LOC12)) goto LA13;
			LOC14 = 0;
			LOC14 = HEX5BHEX5D_215238(n, (NI)(typepos + ((NI) 1)));
			LOC12 = !(((*LOC14).kind == ((NU8) 1)));
			LA13: ;
			if (!LOC12) goto LA15;
			LOC17 = 0;
			LOC17 = HEX5BHEX5D_215238(n, (NI)(typepos + ((NI) 1)));
			typ = (*LOC17).typ;
			{
				if (!!(typ == 0)) goto LA20;
				typestr = typetostring_240017(typ, ((NU8) 2));
			}
			LA20: ;
			{
		...
		LA15: ;
		{
			...
			i_358437 = 0;
			HEX3Atmp_358627 = 0;
			HEX3Atmp_358627 = (typepos - 1);
			res_358630 = ((NI) 0);
			{
				while (1) {
					NimStringDesc* LOC29;
					if (!(res_358630 <= HEX3Atmp_358627)) goto LA28;
					i_358437 = res_358630;
	...
	default:
	{
		NimStringDesc* LOC31;
		LOC31 = 0;
		LOC31 = rawNewString(reprEnum((*n).kind, (&NTI214020))->Sup.len + 31);
appendString(LOC31, ((NimStringDesc*) &TMP5087));
appendString(LOC31, reprEnum((*n).kind, (&NTI214020)));
		internalerror_187100((*n).info, LOC31);
	}
	break;
	}
	}BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, renderparamtypes_358634)(Tnode214790* n, NimStringDesc* sep) {
	...
	renderparamtypes_358233((&found), n);
	{
