...
N_NIMCALL(void, renderparamtypes_365467)(TY119808** found, tnode208818* n);
N_NIMCALL(NimStringDesc*, rendertype_363222)(tnode208818* n);
...
{	result = 0;
	...
	{
		{
			...
			LOC3 = 0;
			LOC3 = len_209366(n);
			HEX3Atmp_363202 = (LOC3 - 1);
			res_363205 = 0;
			{
				while (1) {
					NI LOC6;
					tnode208818* LOC7;
					if (!(res_363205 <= HEX3Atmp_363202)) goto LA5;
					i_363039 = res_363205;
					LOC6 = 0;
					LOC6 = len_209366(n);
					LOC7 = 0;
					LOC7 = HEX5BHEX5D_209659(n, (LOC6 - 1));
					result = renderplainsymbolname_363013(LOC7);
					{
	...
	case ((NU8) 3):
	{
		result = renderdefinitionname_232143((*n).kindU.S4.Sym, NIM_TRUE);
	}
	break;
	case ((NU8) 43):
	{
		tnode208818* LOC19;
		LOC19 = 0;
		LOC19 = HEX5BHEX5D_209659(n, 0);
		result = renderplainsymbolname_363013(LOC19);
	}
	break;
	case ((NU8) 53):
	{
		...
		LOC21 = len_209366(n);
		LOC22 = 0;
		LOC22 = HEX5BHEX5D_209659(n, (LOC21 - 1));
		result = renderplainsymbolname_363013(LOC22);
	}
	break;
	default:
	{
...
appendString(LOC24, reprEnum((*n).Kind, (&NTI208029)));
		internalerror_182669((*n).Info, LOC24);
	}
	break;
	}
	}BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, rendertype_363222)(tnode208818* n) {
	...
	case ((NU8) 3):
	{
		result = typetostring_241032((*(*n).kindU.S4.Sym).Typ, ((NU8) 0));
	}
	break;
	case ((NU8) 142):
	{
		tnode208818* LOC4;
		LOC4 = 0;
		LOC4 = HEX5BHEX5D_209659(n, 0);
		result = rendertype_363222(LOC4);
	}
	break;
	case ((NU8) 140):
	{
...
appendString(LOC10, LOC12);
	...
	case ((NU8) 146):
	{
		...
		result = copyString(((NimStringDesc*) &TMP4677));
		{
			...
			HEX3Atmp_365402 = 0;
			LOC15 = 0;
			LOC15 = len_209366(params);
			HEX3Atmp_365402 = (LOC15 - 1);
			res_365405 = 1;
			{
				while (1) {
					NimStringDesc* LOC18;
					tnode208818* LOC19;
					NimStringDesc* LOC20;
					if (!(res_365405 <= HEX3Atmp_365402)) goto LA17;
					i_364422 = res_365405;
					LOC18 = 0;
					LOC19 = 0;
					LOC19 = HEX5BHEX5D_209659(params, i_364422);
					LOC20 = 0;
					LOC20 = rendertype_363222(LOC19);
...
appendString(result, LOC18);
	...
	case ((NU8) 35):
	{
		...
		LOC23 = 0;
		LOC23 = HEX5BHEX5D_209659(n, typepos);
		typestr = rendertype_363222(LOC23);
		result = copyString(typestr);
		{
			...
			i_364624 = 0;
			HEX3Atmp_365408 = 0;
			HEX3Atmp_365408 = (typepos - 1);
			res_365411 = 1;
			{
				while (1) {
					NimStringDesc* LOC27;
					if (!(res_365411 <= HEX3Atmp_365408)) goto LA26;
					i_364624 = res_365411;
					LOC27 = 0;
		...
		result = copyString(((NimStringDesc*) &TMP4678));
		{
			...
			res_365417 = 0;
			{
				while (1) {
					...
					tnode208818* LOC34;
					NimStringDesc* LOC35;
					if (!(res_365417 <= HEX3Atmp_365414)) goto LA32;
					i_365022 = res_365417;
					LOC33 = 0;
					LOC34 = 0;
					LOC34 = HEX5BHEX5D_209659(n, i_365022);
					LOC35 = 0;
					LOC35 = rendertype_363222(LOC34);
...
appendString(result, LOC33);
	...
	case ((NU8) 42):
	{
		...
		LOC37 = 0;
		LOC38 = 0;
		LOC38 = HEX5BHEX5D_209659(n, 0);
		LOC39 = 0;
		LOC39 = rendertype_363222(LOC38);
		...
		result = LOC37;
		{
			...
			res_365423 = 1;
			{
				while (1) {
					...
					tnode208818* LOC45;
					NimStringDesc* LOC46;
					if (!(res_365423 <= HEX3Atmp_365420)) goto LA43;
					i_365222 = res_365423;
					LOC44 = 0;
					LOC45 = 0;
					LOC45 = HEX5BHEX5D_209659(n, i_365222);
					LOC46 = 0;
					LOC46 = rendertype_363222(LOC45);
...
{	switch ((*n).Kind) {
	...
	{
		{
			...
			LOC3 = 0;
			LOC3 = len_209366(n);
			HEX3Atmp_365827 = (LOC3 - 1);
			res_365830 = 1;
			{
				while (1) {
					tnode208818* LOC6;
					if (!(res_365830 <= HEX3Atmp_365827)) goto LA5;
					i_365494 = res_365830;
					LOC6 = 0;
					LOC6 = HEX5BHEX5D_209659(n, i_365494);
					renderparamtypes_365467(found, LOC6);
					res_365830 += 1;
				} LA5: ;
			}
		}
	...
	case ((NU8) 35):
	{
		...
		typepos = (NI64)(LOC8 - 2);
		LOC9 = 0;
		LOC9 = HEX5BHEX5D_209659(n, typepos);
		typestr = rendertype_363222(LOC9);
		{
			NIM_BOOL LOC12;
			tnode208818* LOC14;
			ttype208854* typ;
			...
			if (!(LOC12)) goto LA13;
			LOC14 = 0;
			LOC14 = HEX5BHEX5D_209659(n, (NI64)(typepos + 1));
			LOC12 = !(((*LOC14).Kind == ((NU8) 1)));
			LA13: ;
			if (!LOC12) goto LA15;
			LOC17 = 0;
			LOC17 = HEX5BHEX5D_209659(n, (NI64)(typepos + 1));
			typ = (*LOC17).Typ;
			{
				if (!!(typ == 0)) goto LA20;
				typestr = typetostring_241032(typ, ((NU8) 2));
			}
			LA20: ;
			{
		...
		LA15: ;
		{
			...
			i_365646 = 0;
			HEX3Atmp_365833 = 0;
			HEX3Atmp_365833 = (typepos - 1);
			res_365836 = 0;
			{
				while (1) {
					NimStringDesc* LOC29;
					if (!(res_365836 <= HEX3Atmp_365833)) goto LA28;
					i_365646 = res_365836;
...
appendString(LOC31, reprEnum((*n).Kind, (&NTI208029)));
		internalerror_182669((*n).Info, LOC31);
	}
	break;
	}
	}BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, renderparamtypes_365862)(tnode208818* n, NimStringDesc* sep) {
	...
	renderparamtypes_365467((&found), n);
	{
