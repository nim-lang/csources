...
N_NIMCALL(NU8, checkforsideeffects_319747)(tnode223819* n);
...
N_NIMCALL(void, compileconstraints_319129)(tnode223819* p, NimStringDesc** result);
N_NIMCALL(void, patternerror_319051)(tnode223819* n);
...
static N_INLINE(void, add_319061)(NimStringDesc** code, NU8 op);
...
STRING_LITERAL(TMP2979, "atom", 4);
STRING_LITERAL(TMP2980, "lit", 3);
STRING_LITERAL(TMP2981, "sym", 3);
STRING_LITERAL(TMP2982, "ident", 5);
STRING_LITERAL(TMP2983, "call", 4);
STRING_LITERAL(TMP2984, "alias", 5);
STRING_LITERAL(TMP2985, "noalias", 7);
STRING_LITERAL(TMP2986, "lvalue", 6);
STRING_LITERAL(TMP2987, "local", 5);
STRING_LITERAL(TMP2988, "sideeffect", 10);
STRING_LITERAL(TMP2989, "nosideeffect", 12);
STRING_LITERAL(TMP2991, "parampatterns.nim", 17);
NIM_CONST TY84535 TMP2990 = {((NimStringDesc*) &TMP2991),
100}
;
NIM_CONST TY84535 TMP2992 = {((NimStringDesc*) &TMP2991),
107}
;
STRING_LITERAL(TMP2993, "parameter pattern too complex", 29);
	...
	{
		{
			ttype223855* LOC18;
			LOC18 = 0;
			LOC18 = skiptypes_228245((*(*n).kindU.S6.Sons->data[0]).Typ, IL64(211106232576000));
		...
		LA19: ;
		{
			result = isassignable_320003(owner, (*n).kindU.S6.Sons->data[0]);
		}
		LA16: ;
		{
			NIM_BOOL LOC24;
	...
	{
		{
			ttype223855* LOC31;
			LOC31 = 0;
			LOC31 = skiptypes_228245((*(*n).kindU.S6.Sons->data[0]).Typ, IL64(211106232576000));
	...
	{
		{
			ttype223855* LOC38;
			LOC38 = 0;
			LOC38 = skiptypes_228245((*n).Typ, IL64(211106247256064));
			if (!((134610944 &(IL64(1)<<(((*LOC38).Kind)&IL64(63))))!=0)) goto LA39;
			result = isassignable_320003(owner, (*n).kindU.S6.Sons->data[1]);
		}
		goto LA36;
		LA39: ;
		{
			NIM_BOOL LOC42;
			LOC42 = 0;
			LOC42 = comparetypes_267771((*n).Typ, (*(*n).kindU.S6.Sons->data[1]).Typ, ((NU8) 1), 0);
			if (!LOC42) goto LA43;
			result = isassignable_320003(owner, (*n).kindU.S6.Sons->data[1]);
		}
		goto LA36;
...
N_NIMCALL(NU8, checkforsideeffects_319747)(tnode223819* n) {
	...
	case ((NU8) 32):
	{
		...
		op = (*n).kindU.S6.Sons->data[0];
		{
			...
			LOC4 = ((*op).Kind == ((NU8) 3));
			if (!(LOC4)) goto LA5;
			LOC4 = isroutine_230781((*op).kindU.S4.Sym);
			LA5: ;
			if (!LOC4) goto LA6;
			s = (*op).kindU.S4.Sym;
			{
		...
		LA2: ;
		{
			...
			LOC17 = 0;
			LOC17 = len_224367(n);
			HEX3Atmp_319959 = (LOC17 - 1);
			res_319962 = 0;
			{
				while (1) {
					NU8 ret;
					if (!(res_319962 <= HEX3Atmp_319959)) goto LA19;
					i_319851 = res_319962;
					ret = checkforsideeffects_319747((*n).kindU.S6.Sons->data[i_319851]);
					{
	...
	{
		{
			...
			LOC32 = 0;
			LOC32 = len_224367(n);
			HEX3Atmp_319965 = (LOC32 - 1);
			res_319968 = 0;
			{
				while (1) {
					NU8 ret;
					if (!(res_319968 <= HEX3Atmp_319965)) goto LA34;
					i_319915 = res_319968;
					ret = checkforsideeffects_319747((*n).kindU.S6.Sons->data[i_319915]);
					{
	...
	pc = 1;
	{
		while (1) {
			...
			case ((NU8) 12):
			{
				NU8 LOC21;
				LOC21 = 0;
				LOC21 = isassignable_320003(NIM_NIL, n);
			...
			case ((NU8) 13):
			{
				NU8 LOC23;
				LOC23 = 0;
				LOC23 = isassignable_320003(NIM_NIL, n);
			...
			case ((NU8) 14):
			{
				NU8 LOC25;
				LOC25 = 0;
				LOC25 = checkforsideeffects_319747(n);
			...
			case ((NU8) 15):
			{
				NU8 LOC27;
				LOC27 = 0;
				LOC27 = checkforsideeffects_319747(n);
...
N_NIMCALL(void, patternerror_319051)(tnode223819* n) {
	...
	localerror_196938((*n).Info, ((NU16) 1), LOC1);
}
...
N_NIMCALL(void, compileconstraints_319129)(tnode223819* p, NimStringDesc** result) {
	...
	case ((NU8) 32):
	{
		tident199021* op;
		{
			...
			patternerror_319051((*p).kindU.S6.Sons->data[0]);
			goto BeforeRet;
		}
		LA4: ;
		op = (*(*p).kindU.S6.Sons->data[0]).kindU.S5.Ident;
		{
			...
			if (!(LOC8 == 3)) goto LA9;
			{
				NIM_BOOL LOC13;
				LOC13 = 0;
				LOC13 = eqStrings((*op).S, ((NimStringDesc*) &TMP2976));
				if (LOC13) goto LA14;
				LOC13 = ((*op).Sup.Id == 46);
				LA14: ;
				if (!LOC13) goto LA15;
				compileconstraints_319129((*p).kindU.S6.Sons->data[1], result);
				compileconstraints_319129((*p).kindU.S6.Sons->data[2], result);
				add_319061(result, ((NU8) 2));
			}
			goto LA11;
			LA15: ;
			{
				NIM_BOOL LOC18;
				LOC18 = 0;
				LOC18 = eqStrings((*op).S, ((NimStringDesc*) &TMP2977));
				if (LOC18) goto LA19;
				LOC18 = ((*op).Sup.Id == 2);
				LA19: ;
				if (!LOC18) goto LA20;
				compileconstraints_319129((*p).kindU.S6.Sons->data[1], result);
				compileconstraints_319129((*p).kindU.S6.Sons->data[2], result);
				add_319061(result, ((NU8) 3));
			}
			goto LA11;
			LA20: ;
			{
				patternerror_319051(p);
			}
			LA11: ;
		}
		goto LA6;
		LA9: ;
		{
			...
			if (!(LOC24)) goto LA26;
			LOC27 = 0;
			LOC27 = eqStrings((*op).S, ((NimStringDesc*) &TMP2978));
			if (LOC27) goto LA28;
			LOC27 = ((*op).Sup.Id == 42);
			LA28: ;
			LOC24 = LOC27;
	...
	{
		{
			...
			compileconstraints_319129((*p).kindU.S6.Sons->data[0], result);
		}
		goto LA33;
		LA36: ;
		{
	...
	case ((NU8) 2):
	{
		...
		case 2: 
if (eqStrings(spec, ((NimStringDesc*) &TMP2989))) goto LA50;
break;
		case 4: 
if (eqStrings(spec, ((NimStringDesc*) &TMP2981))) goto LA42;
if (eqStrings(spec, ((NimStringDesc*) &TMP2986))) goto LA47;
if (eqStrings(spec, ((NimStringDesc*) &TMP2988))) goto LA49;
break;
		case 6: 
if (eqStrings(spec, ((NimStringDesc*) &TMP2982))) goto LA43;
break;
		case 10: 
if (eqStrings(spec, ((NimStringDesc*) &TMP2985))) goto LA46;
break;
		case 11: 
if (eqStrings(spec, ((NimStringDesc*) &TMP2979))) goto LA40;
break;
		case 12: 
if (eqStrings(spec, ((NimStringDesc*) &TMP2980))) goto LA41;
break;
		case 13: 
if (eqStrings(spec, ((NimStringDesc*) &TMP2983))) goto LA44;
break;
		case 14: 
if (eqStrings(spec, ((NimStringDesc*) &TMP2984))) goto LA45;
if (eqStrings(spec, ((NimStringDesc*) &TMP2987))) goto LA48;
break;
		}
		goto LA51;
		LA40: ;
		{
			add_319061(result, ((NU8) 6));
		}
		goto LA52;
		LA41: ;
		{
			add_319061(result, ((NU8) 7));
		}
		goto LA52;
		LA42: ;
		{
			add_319061(result, ((NU8) 5));
		}
		goto LA52;
		LA43: ;
		{
			add_319061(result, ((NU8) 8));
		}
		goto LA52;
		LA44: ;
		{
			add_319061(result, ((NU8) 9));
		}
		goto LA52;
		LA45: ;
		{
		...
		LA47: ;
		{
			add_319061(result, ((NU8) 12));
		}
		goto LA52;
		LA48: ;
		{
			add_319061(result, ((NU8) 13));
		}
		goto LA52;
		LA49: ;
		{
			add_319061(result, ((NU8) 14));
		}
		goto LA52;
		LA50: ;
		{
			add_319061(result, ((NU8) 15));
		}
		goto LA52;
		LA51: ;
		{
			{
				...
				LOC69 = 0;
				LOC69 = HEX24_197109(TMP2990);
				internalerror_196989(LOC69);
			}
			LA67: ;
			{
				NU8 i_319398;
				...
				{
					while (1) {
						if (!(res_319494 <= ((NU8) 25))) goto LA72;
						i_319398 = res_319494;
						{
							NimStringDesc* LOC75;
							NI LOC76;
							LOC75 = 0;
							LOC75 = copyStr(reprEnum(i_319398, (&NTI223445)), 2);
							LOC76 = 0;
							LOC76 = nsuCmpIgnoreStyle(LOC75, spec);
							if (!(LOC76 == 0)) goto LA77;
							add_319061(result, ((NU8) 10));
							(*result) = addChar((*result), ((NIM_CHAR) (((NI) (i_319398)))));
							goto BeforeRet;
						}
						LA77: ;
						res_319494 += 1;
			...
			}
			{
				...
				LOC83 = 0;
				LOC83 = HEX24_197109(TMP2992);
				internalerror_196989(LOC83);
			}
			LA81: ;
			{
				NU8 i_319473;
				...
				{
					while (1) {
						if (!(res_319501 <= ((NU8) 156))) goto LA86;
						i_319473 = res_319501;
						{
							NI LOC89;
							LOC89 = 0;
							LOC89 = nsuCmpIgnoreStyle(reprEnum(i_319473, (&NTI223029)), spec);
							if (!(LOC89 == 0)) goto LA90;
							add_319061(result, ((NU8) 11));
							(*result) = addChar((*result), ((NIM_CHAR) (((NI) (i_319473)))));
							goto BeforeRet;
						}
						LA90: ;
						res_319501 += 1;
...
N_NIMCALL(tnode223819*, semnodekindconstraints_319527)(tnode223819* p) {
	tnode223819* result;
	result = 0;
	result = newnodei_224141(((NU8) 20), (*p).Info);
	...
	(*result).kindU.S3.Strval = addChar((*result).kindU.S3.Strval, 1);
	{
		...
		if (!(2 <= LOC3)) goto LA4;
		{
			...
			LOC7 = 0;
			LOC7 = len_224367(p);
			HEX3Atmp_319719 = (LOC7 - 1);
			res_319722 = 1;
			{
				while (1) {
					if (!(res_319722 <= HEX3Atmp_319719)) goto LA9;
					i_319658 = res_319722;
					compileconstraints_319129((*p).kindU.S6.Sons->data[i_319658], &(*result).kindU.S3.Strval);
					res_319722 += 1;
				} LA9: ;
			}
		}
		{
			...
			internalerror_196970((*p).Info, ((NimStringDesc*) &TMP2993));
		}
		LA12: ;
	}
	goto LA1;
	...
	LA1: ;
	add_319061(&(*result).kindU.S3.Strval, ((NU8) 1));
	return result;
}
