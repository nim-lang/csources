...
N_LIB_PRIVATE N_NIMCALL(void, fillBuffer_m9bpQUVeRkyuyv4zAGVgY9bw)(tyObject_BaseLexer_MAw8rJZtJ279bVV3TWMtXSg* L) {
	...
	LA7_: ;
	{
		...
		moveMem_i80o3k0SgEI5gTRCzYdyWA_2system(((void*) ((&(*L).buf->data[((NI) 0)]))), ((void*) ((&(*L).buf->data[(NI)(TM_k6p5NxDJat9aTyZxfZjCDJQ_11)]))), ((NI)chckRange(toCopy, ((NI) 0), ((NI) IL64(9223372036854775807)))));
	}
	LA11_: ;
	...
	charsRead = readDataStr_78VQwN48e7jIIL2Q9bINIFw_2((*L).input, (&(*L).buf), T13_);
		...
		s = (NI)(TM_k6p5NxDJat9aTyZxfZjCDJQ_17);
		{
			while (1) {
				...
				LA31_: ;
				{
					...
					unsureAsgnRef((void**) (&(*L).buf), setLengthStr((*L).buf, ((NI)chckRange((NI)(TM_k6p5NxDJat9aTyZxfZjCDJQ_20), ((NI) 0), ((NI) IL64(9223372036854775807))))));
					...
					charsRead = readDataStr_78VQwN48e7jIIL2Q9bINIFw_2((*L).input, (&(*L).buf), T34_);
					{
...
N_LIB_PRIVATE N_NIMCALL(NI, getColNumber_KUMaHICF9bUPO7tt6hrBs3g)(tyObject_BaseLexer_MAw8rJZtJ279bVV3TWMtXSg* L, NI pos) {
	...
	if ((NI)(TM_k6p5NxDJat9aTyZxfZjCDJQ_34) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
...
N_LIB_PRIVATE N_NIMCALL(void, close_m9bpQUVeRkyuyv4zAGVgY9bw_3)(tyObject_BaseLexer_MAw8rJZtJ279bVV3TWMtXSg* L) {
	close_y1KA3B0U09bKtU09am9a9avRYQ_3((*L).input);
}
