...
appendString((*result), ind);
		...
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI64)(TMP3785), lvltochar_301257[((*n).Level)- 0]);
...
N_NIMCALL(tjsonnode296114*, renderrsttojsonnode_301567)(trstnode301009* node) {
	...
	nimln(295, "rstast.nim");
	{
		...
		add_297844(result, ((NimStringDesc*) &TMP3815), LOC6);
	}
	LA4: ;
	nimln(297, "rstast.nim");
	{
		...
		add_297844(result, ((NimStringDesc*) &TMP3816), LOC15);
	}
	LA12: ;
	popFrame();
	return result;
...
NTI301003.node = &TMP3615[67];
TMP3615[1].kind = 1;
TMP3615[1].offset = offsetof(trstnode301009, Kind);
TMP3615[1].typ = (&NTI301003);
TMP3615[1].name = "kind";
TMP3774[1] = &TMP3615[68];
TMP3615[68].kind = 1;
TMP3615[68].offset = offsetof(trstnode301009, Text);
TMP3615[68].typ = (&NTI143);
TMP3615[68].name = "text";
TMP3774[2] = &TMP3615[69];
TMP3615[69].kind = 1;
TMP3615[69].offset = offsetof(trstnode301009, Level);
TMP3615[69].typ = (&NTI106);
TMP3615[69].name = "level";
TMP3774[3] = &TMP3615[70];
TMP3615[70].kind = 1;
TMP3615[70].offset = offsetof(trstnode301009, Sons);
TMP3615[70].typ = (&NTI301084);
TMP3615[70].name = "sons";
TMP3615[0].len = 4; TMP3615[0].kind = 2; TMP3615[0].sons = &TMP3774[0];
NTI301009.node = &TMP3615[0];
NTI301005.size = sizeof(trstnode301009*);
NTI301005.kind = 22;
NTI301005.base = (&NTI301009);
NTI301005.flags = 2;
NTI301005.marker = TMP3779;
}
