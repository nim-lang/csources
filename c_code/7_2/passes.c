...
static NIM_CONST TY192025 TMP3178 = {
...
N_NIMCALL(void, openpasses_250277)(tpasscontext250003** a, tsym191843* module) {
	...
	nimln(112, "passes.nim");
	TMP3180 = subInt(gpasseslen_250179, 1);
	HEX3Atmp_250302 = (NI64)(TMP3180);
...
N_NIMCALL(void, openpassescached_250309)(tpasscontext250003** a, tsym191843* module, trodreader240024* rd) {
	...
	nimln(118, "passes.nim");
	TMP3181 = subInt(gpasseslen_250179, 1);
	HEX3Atmp_250352 = (NI64)(TMP3181);
	nimln(1451, "system.nim");
	res_250354 = 0;
	nimln(1452, "system.nim");
	while (1) {
...
NTI250003.flags = 1;
TMP3113[0].kind = 1;
TMP3113[0].offset = offsetof(tpasscontext250003, Fromcache);
TMP3113[0].typ = (&NTI134);
TMP3113[0].name = "fromCache";
NTI250003.node = &TMP3113[0];
}
