...
N_NIMCALL(pid_t, startprocessauxfork_129001)(tstartprocessdata128915* data);
N_NIMCALL(void, oserror_107205)(NI32 errorcode);
N_NIMCALL(NI32, oslasterror_107231)(void);
static N_INLINE(void, pushSafePoint)(TSafePoint* s);
N_CDECL(void, startprocessafterfork_129004)(tstartprocessdata128915* data);
...
N_NIMCALL(pid_t, startprocessauxfork_129001)(tstartprocessdata128915* data) {
	...
	if (TMP377.status == 0) {
		...
		nimln(778, "osproc.nim");
		{
			...
			startprocessafterfork_129004(&datacopy);
...
N_NIMCALL(tprocess127402*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, tstringtable122810* env, NU8 options) {
	...
	if (TMP381.status == 0) {
		...
		if (TMP382.status == 0) {
			...
			pid = startprocessauxfork_129001(&data);
