...
N_LIB_PRIVATE N_NIMCALL(void, newLine_Seop6SJMf7a68kj2jl0nsQ_2)(tyObject_TTmplParser_hVXV9cC75rOvsaODz9bp1zeg* p) {
	NimStringDesc* T1_;
	T1_ = (NimStringDesc*)0;
	T1_ = nsuRepeatChar(41, ((NI)chckRange((*p).emitPar, ((NI) 0), ((NI) IL64(9223372036854775807)))));
	...
	LA4_: ;
	{
		...
		T10_ = spaces_rssDy7zs9cDeoYTeCoIy0Wgstrutils(((NI) 2));
...
break;
		...
		LA28_: ;
		{
			...
			T40_ = spaces_rssDy7zs9cDeoYTeCoIy0Wgstrutils(((NI)chckRange((*p).indent, ((NI) 0), ((NI) IL64(9223372036854775807)))));
		...
		LA29_: ;
		{
			...
			T42_ = spaces_rssDy7zs9cDeoYTeCoIy0Wgstrutils(((NI)chckRange((*p).indent, ((NI) 0), ((NI) IL64(9223372036854775807)))));
		...
		LA30_: ;
		{
			...
			T45_ = spaces_rssDy7zs9cDeoYTeCoIy0Wgstrutils(((NI)chckRange((NI)(TM_paI0W78l0CRDBLjAHJxn6w_51), ((NI) 0), ((NI) IL64(9223372036854775807)))));
		...
		LA31_: ;
		{
			...
			T48_ = spaces_rssDy7zs9cDeoYTeCoIy0Wgstrutils(((NI)chckRange((*p).indent, ((NI) 0), ((NI) IL64(9223372036854775807)))));
		...
		LA32_: ;
		{
			...
			T56_ = spaces_rssDy7zs9cDeoYTeCoIy0Wgstrutils(((NI)chckRange((*p).indent, ((NI) 0), ((NI) IL64(9223372036854775807)))));
	...
	LA16_: ;
	{
		...
		case ((tyEnum_TParseState_TMyoReN7VAtsUpVF9bL9cXRQ) 1):
		{
			...
			T60_ = spaces_rssDy7zs9cDeoYTeCoIy0Wgstrutils(((NI)chckRange((NI)(TM_paI0W78l0CRDBLjAHJxn6w_54), ((NI) 0), ((NI) IL64(9223372036854775807)))));
		...
		case ((tyEnum_TParseState_TMyoReN7VAtsUpVF9bL9cXRQ) 0):
		{
			...
			T62_ = spaces_rssDy7zs9cDeoYTeCoIy0Wgstrutils(((NI)chckRange((*p).indent, ((NI) 0), ((NI) IL64(9223372036854775807)))));
