			...
			if (TM_asNQM9aynXXg9ccUABbReyew_6.status == 0) {
				{
					while (1) {
						...
						y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
						{
							...
							T19_ = (NIM_BOOL)0;
							T19_ = !(eqStrings(y, ((NimStringDesc*) &TM_asNQM9aynXXg9ccUABbReyew_7)));
							if (!(T19_)) goto LA20_;
							T19_ = !(eqStrings(y, ((NimStringDesc*) &TM_asNQM9aynXXg9ccUABbReyew_8)));
							LA20_: ;
							if (!T19_) goto LA21_;
							...
							k_2 = ((tyEnum_PathComponent_9c1SIU9cO1wHcl09b703A9cDrg) 0);
							{
								int T29_;
								T29_ = (int)0;
								T29_ = lstat(nimToCStringConv(path), (&s));
	...
	}
	{
		...
		p_2 = (NimStringDesc*)0;
		{
			...
			val = (NimStringDesc*)0;
			{
				...
				h = (NI)0;
				colontmp_ = (NI)0;
				T53_ = (((*packages).data ? (*packages).data->Sup.len : 0)-1);
				colontmp_ = T53_;
				res = ((NI) 0);
				{
					while (1) {
						...
						h = res;
						{
							...
							if (!(*packages).data->data[h].Field2) goto LA58_;
							if ((NU)(h) >= (NU)((*packages).data ? (*packages).data->Sup.len : 0)) raiseIndexError2(h,((*packages).data ? (*packages).data->Sup.len : 0)-1);
							...
							LA62_: ;
							{
								...
								T65_ = rawNewString((key ? key->Sup.len : 0) + (val ? val->Sup.len : 0) + 1);
