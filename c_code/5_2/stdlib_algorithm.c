...
typedef N_CLOSURE_PTR(NI, TMP2663) (tsym207843* x_366784, tsym207843* y_366786);
...
typedef N_CLOSURE_PTR(NI, TMP4881) (NimStringDesc* x_330365, NimStringDesc* y_330367);
typedef struct {
...
typedef N_CLOSURE_PTR(NI, TMP4885) (tindexentry327398* x_328753, tindexentry327398* y_328755);
struct  TNimObject  {
TNimType* m_type;
};
struct  tidobj184015  {
...
{	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI64)(m + ((NI) 1))], cmp.ClEnv):((TMP2662)(cmp.ClPrc))(a[m], a[(NI64)(m + ((NI) 1))]);
		LOC4 = 0;
	...
	k = lo;
	{
		while (1) {
			...
			if (!LOC11) goto LA10;
			{
				...
				NI LOC16;
				LOC15 = 0;
				LOC15 = cmp.ClEnv? cmp.ClPrc(b[i], a[j], cmp.ClEnv):((TMP2663)(cmp.ClPrc))(b[i], a[j]);
				LOC16 = 0;
...
{	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc((&a[m]), (&a[(NI64)(m + ((NI) 1))]), cmp.ClEnv):((TMP4884)(cmp.ClPrc))((&a[m]), (&a[(NI64)(m + ((NI) 1))]));
		LOC4 = 0;
		LOC4 = HEX2A_325020(LOC3, order);
		if (!(LOC4 <= ((NI) 0))) goto LA5;
		goto BeforeRet;
	...
	k = lo;
	{
		while (1) {
			...
			if (!LOC11) goto LA10;
			{
				...
				NI LOC16;
				LOC15 = 0;
				LOC15 = cmp.ClEnv? cmp.ClPrc((&b[i]), (&a[j]), cmp.ClEnv):((TMP4885)(cmp.ClPrc))((&b[i]), (&a[j]));
				LOC16 = 0;
				LOC16 = HEX2A_325020(LOC15, order);
				if (!(LOC16 <= ((NI) 0))) goto LA17;
