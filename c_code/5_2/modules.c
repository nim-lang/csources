...
STRING_LITERAL(TMP4107, "nim", 3);
STRING_LITERAL(TMP4108, "system.nim", 10);
STRING_LITERAL(TMP4823, "stdin", 5);
...
N_NIMCALL(void, wantmainmodule_607014)(void) {
	NimStringDesc* LOC5;
	{
		...
		fatal_197906(gcmdlineinfo_196191, ((NU16) 186), ((NimStringDesc*) &TMP4106));
	}
	LA3: ;
	LOC5 = 0;
	LOC5 = nosaddFileExt(gprojectfull_169234, ((NimStringDesc*) &TMP4107));
...
N_NIMCALL(void, compilesystemmodule_606988)(void) {
	{
		...
		LOC5 = 0;
		LOC5 = HEX2F_116899(libpath_169231, ((NimStringDesc*) &TMP4108));
...
N_NIMCALL(void, compileproject_607073)(NI32 projectfileidx) {
	...
	LOC1 = 0;
	LOC1 = HEX2F_116899(libpath_169231, ((NimStringDesc*) &TMP4108));
...
N_NIMCALL(tsym224849*, makestdinmodule_607093)(void) {
	...
	result = 0;
	{
		...
		LOC5 = 0;
		LOC5 = fileinfoidx_195747(((NimStringDesc*) &TMP4823));
