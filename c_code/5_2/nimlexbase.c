...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP1648, "L.sentinel < L.bufLen ", 22);
STRING_LITERAL(TMP1651, "toCopy >= 0 ", 12);
STRING_LITERAL(TMP1659, "s < L.bufLen ", 13);
STRING_LITERAL(TMP1663, "L.bufLen - oldBufLen == oldBufLen ", 34);
STRING_LITERAL(TMP1669, "pos <= L.sentinel ", 18);
STRING_LITERAL(TMP1671, "L.buf[pos] == CR ", 17);
STRING_LITERAL(TMP1672, "L.buf[pos] == LF ", 17);
STRING_LITERAL(TMP1673, "bufLen > 0 ", 11);
STRING_LITERAL(TMP1677, "", 0);
STRING_LITERAL(TMP1678, "\012", 1);
STRING_LITERAL(TMP1679, "^\012", 2);
...
N_NIMCALL(void, fillbuffer_175072)(tbaselexer175018* l) {
	...
	nimln(82, "nimlexbase.nim");
	{
		...
		nimln(82, "nimlexbase.nim");
		failedassertimpl_79821(((NimStringDesc*) &TMP1648));
	}
	LA3: ;
	nimln(83, "nimlexbase.nim");
	nimln(83, "nimlexbase.nim");
	nimln(83, "nimlexbase.nim");
	TMP1649 = subInt((*l).Buflen, (*l).Sentinel);
	TMP1650 = subInt((NI64)(TMP1649), 1);
	tocopy = (NI64)(TMP1650);
	...
	nimln(85, "nimlexbase.nim");
	{
		...
		nimln(86, "nimlexbase.nim");
		TMP1653 = mulInt(tocopy, 1);
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP1652)])), (NI64)(TMP1653));
	}
	LA11: ;
	...
	nimln(89, "nimlexbase.nim");
	nimln(89, "nimlexbase.nim");
	TMP1654 = addInt((*l).Sentinel, 1);
	TMP1655 = mulInt((NI64)(TMP1654), 1);
	LOC13 = 0;
	LOC13 = llstreamread_173242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP1655));
	TMP1656 = divInt(LOC13, 1);
	charsread = (NI64)(TMP1656);
	nimln(90, "nimlexbase.nim");
	nimln(90, "nimlexbase.nim");
	TMP1657 = addInt(tocopy, charsread);
	s = (NI64)(TMP1657);
	nimln(91, "nimlexbase.nim");
	{
		...
		if (!(charsread < (NI64)(TMP1658))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			nimln(98, "nimlexbase.nim");
			{
				...
				nimln(98, "nimlexbase.nim");
				failedassertimpl_79821(((NimStringDesc*) &TMP1659));
			}
			LA22: ;
			...
			LA29: ;
			{
				...
				nimln(108, "nimlexbase.nim");
				TMP1660 = mulInt((*l).Buflen, 2);
				(*l).Buflen = (NI64)(TMP1660);
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				TMP1661 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4631(((void*) ((*l).Buf)), (NI64)(TMP1661));
				...
				nimln(110, "nimlexbase.nim");
				{
					...
					nimln(110, "nimlexbase.nim");
					nimln(110, "nimlexbase.nim");
					TMP1662 = subInt((*l).Buflen, oldbuflen);
					if (!!(((NI64)(TMP1662) == oldbuflen))) goto LA35;
					nimln(110, "nimlexbase.nim");
					failedassertimpl_79821(((NimStringDesc*) &TMP1663));
				}
				LA35: ;
				...
				nimln(111, "nimlexbase.nim");
				nimln(112, "nimlexbase.nim");
				TMP1664 = mulInt(oldbuflen, 1);
				LOC37 = 0;
				LOC37 = llstreamread_173242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP1664));
				TMP1665 = divInt(LOC37, 1);
				charsread = (NI64)(TMP1665);
				nimln(113, "nimlexbase.nim");
				{
					...
					nimln(114, "nimlexbase.nim");
					TMP1666 = addInt(oldbuflen, charsread);
					(*l).Buf[(NI64)(TMP1666)] = 0;
					nimln(115, "nimlexbase.nim");
					nimln(115, "nimlexbase.nim");
					TMP1667 = addInt(oldbuflen, charsread);
					(*l).Sentinel = (NI64)(TMP1667);
...
N_NIMCALL(NI, fillbaselexer_175812)(tbaselexer175018* l, NI pos) {
	...
	nimln(120, "nimlexbase.nim");
	{
		...
		nimln(120, "nimlexbase.nim");
		failedassertimpl_79821(((NimStringDesc*) &TMP1669));
	}
	LA3: ;
...
N_NIMCALL(NI, handlecr_175050)(tbaselexer175018* l, NI pos) {
	...
	nimln(130, "nimlexbase.nim");
	{
		...
		nimln(130, "nimlexbase.nim");
		failedassertimpl_79821(((NimStringDesc*) &TMP1671));
	}
	LA3: ;
...
N_NIMCALL(void, openbaselexer_175027)(tbaselexer175018* l, tllstream173204* inputstream, NI buflen) {
	...
	nimln(150, "nimlexbase.nim");
	nimln(150, "nimlexbase.nim");
	TMP1674 = mulInt(buflen, 1);
	LOC5 = 0;
	LOC5 = alloc_4601((NI64)(TMP1674));
	(*l).Buf = ((NCSTRING) (LOC5));
	nimln(151, "nimlexbase.nim");
	nimln(151, "nimlexbase.nim");
	TMP1675 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP1675);
...
N_NIMCALL(NI, getcolnumber_175045)(tbaselexer175018* l, NI pos) {
	...
	nimln(159, "nimlexbase.nim");
	nimln(159, "nimlexbase.nim");
	TMP1676 = subInt(pos, (*l).Linestart);
	if ((NI64)(TMP1676) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP1676));
	popFrame();
	return result;
}
...
N_NIMCALL(NimStringDesc*, getcurrentline_175040)(tbaselexer175018* l, NIM_BOOL marker) {
	...
	result = copyString(((NimStringDesc*) &TMP1677));
...
appendString(result, ((NimStringDesc*) &TMP1678));
...
appendString(LOC6, ((NimStringDesc*) &TMP1679));
...
static TNimNode* TMP1917[7];
static TNimNode TMP1623[8];
NTI175018.size = sizeof(tbaselexer175018);
NTI175018.kind = 17;
NTI175018.base = (&NTI2409);
TMP1917[0] = &TMP1623[1];
TMP1623[1].kind = 1;
TMP1623[1].offset = offsetof(tbaselexer175018, Bufpos);
TMP1623[1].typ = (&NTI106);
TMP1623[1].name = "bufpos";
TMP1917[1] = &TMP1623[2];
TMP1623[2].kind = 1;
TMP1623[2].offset = offsetof(tbaselexer175018, Buf);
TMP1623[2].typ = (&NTI145);
TMP1623[2].name = "buf";
TMP1917[2] = &TMP1623[3];
TMP1623[3].kind = 1;
TMP1623[3].offset = offsetof(tbaselexer175018, Buflen);
TMP1623[3].typ = (&NTI106);
TMP1623[3].name = "bufLen";
TMP1917[3] = &TMP1623[4];
TMP1623[4].kind = 1;
TMP1623[4].offset = offsetof(tbaselexer175018, Stream);
TMP1623[4].typ = (&NTI173206);
TMP1623[4].name = "stream";
TMP1917[4] = &TMP1623[5];
TMP1623[5].kind = 1;
TMP1623[5].offset = offsetof(tbaselexer175018, Linenumber);
TMP1623[5].typ = (&NTI106);
TMP1623[5].name = "lineNumber";
TMP1917[5] = &TMP1623[6];
TMP1623[6].kind = 1;
TMP1623[6].offset = offsetof(tbaselexer175018, Sentinel);
TMP1623[6].typ = (&NTI106);
TMP1623[6].name = "sentinel";
TMP1917[6] = &TMP1623[7];
TMP1623[7].kind = 1;
TMP1623[7].offset = offsetof(tbaselexer175018, Linestart);
TMP1623[7].typ = (&NTI106);
TMP1623[7].name = "lineStart";
TMP1623[0].len = 7; TMP1623[0].kind = 2; TMP1623[0].sons = &TMP1917[0];
NTI175018.node = &TMP1623[0];
}
