...
N_NIMCALL(void, TMP7020)(void* p, NI op);
...
STRING_LITERAL(TMP7012, "$1 -> $2;$n", 11);
static NIM_CONST TY171865 TMP7013 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7014, "sons", 4);
STRING_LITERAL(TMP7017, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP7018, "", 0);
STRING_LITERAL(TMP7019, "dot", 3);
...
N_NIMCALL(void, adddependencyaux_414019)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	appf_121085(&gdotgraph_414016, ((NimStringDesc*) &TMP7012), LOC1, 2);	popFrame();
}
static N_INLINE(NI, sonslen_172022)(tnode171659* n) {
	NI result;
	...
	{
		nimln(1209, "ast.nim");
		if (((TMP7013[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7014));
...
N_NIMCALL(tnode171659*, adddotdependency_414031)(tpasscontext222003* c, tnode171659* n) {
	...
	case ((NU8) 115):
	{
		...
		TMP7015 = subInt(LOC2, 1);
		HEX3Atmp_414092 = (NI64)(TMP7015);
	...
	case ((NU8) 126):
	{
		...
		TMP7016 = subInt(LOC6, 1);
		HEX3Atmp_414096 = (NI64)(TMP7016);
		nimln(1301, "system.nim");
		res_414098 = 0;
		nimln(1302, "system.nim");
		while (1) {
...
N_NIMCALL(void, generatedot_414006)(NimStringDesc* project) {
	...
	LOC3 = 0;
	LOC3 = nosChangeFileExt(LOC2, ((NimStringDesc*) &TMP7018));
	LOC1[0] = torope_121058(LOC3);
	LOC1[1] = gdotgraph_414016;
	LOC4 = 0;
	LOC4 = ropef_121079(((NimStringDesc*) &TMP7017), LOC1, 2);
	nimln(47, "depends.nim");
	LOC5 = 0;
	LOC5 = nosChangeFileExt(project, ((NimStringDesc*) &TMP7019));
...
static TNimNode TMP7010[1];
NTI414011.size = sizeof(tgen414011);
NTI414011.kind = 17;
NTI414011.base = (&NTI222003);
NTI414011.flags = 2;
TMP7010[0].kind = 1;
TMP7010[0].offset = offsetof(tgen414011, Module);
TMP7010[0].typ = (&NTI171657);
TMP7010[0].name = "module";
NTI414011.node = &TMP7010[0];
NTI414013.size = sizeof(tgen414011*);
NTI414013.kind = 22;
NTI414013.base = (&NTI414011);
NTI414013.flags = 2;
NTI414013.marker = TMP7020;
}
