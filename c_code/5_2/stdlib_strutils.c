...
N_NIMCALL(NimStringDesc*, nsuToBin)(NI64 x, NI len) {
	...
	result = mnewString(((NI) (len)));
	{
		...
		j_101612 = 0;
		HEX3Atmp_101625 = 0;
		HEX3Atmp_101625 = (NI)(((NI) (len)) - ((NI) 1));
		res_101628 = ((NI) (HEX3Atmp_101625));
		{
			while (1) {
				if (!(((NI) 0) <= res_101628)) goto LA3;
				j_101612 = ((NI) (res_101628));
...
N_NIMCALL(NimStringDesc*, nsuToOct)(NI64 x, NI len) {
	...
	result = mnewString(((NI) (len)));
	{
		...
		j_101412 = 0;
		HEX3Atmp_101425 = 0;
		HEX3Atmp_101425 = (NI)(((NI) (len)) - ((NI) 1));
		res_101428 = ((NI) (HEX3Atmp_101425));
		{
			while (1) {
				if (!(((NI) 0) <= res_101428)) goto LA3;
				j_101412 = ((NI) (res_101428));
...
appendString(result, prefix);
	{
		...
		c_101701 = 0;
		i_101713 = ((NI) 0);
		L_101715 = (s ? s->Sup.len : 0);
		{
			while (1) {
				if (!(i_101713 < L_101715)) goto LA3;
				c_101701 = s->data[i_101713];
				switch (((NU8)(c_101701))) {
				case 0 ... 31:
				case 128 ... 255:
				{
...
appendString(result, ((NimStringDesc*) &TMP2113));
					LOC5 = 0;
					LOC5 = nsuToHex(((NI64) (((NU8)(c_101701)))), ((NI) 2));
...
appendString(result, ((NimStringDesc*) &TMP2116));
				...
				default:
				{
					result = addChar(result, c_101701);
				}
				break;
				}
				i_101713 += ((NI) 1);
...
N_NIMCALL(NimStringDesc*, nsuInsertSep)(NimStringDesc* s, NIM_CHAR sep, NI digits) {
	...
	L -= ((NI) 1);
	{
		...
		i_101658 = 0;
		HEX3Atmp_101687 = 0;
		HEX3Atmp_101687 = (NI)((s ? s->Sup.len : 0) - ((NI) 1));
		res_101690 = HEX3Atmp_101687;
		{
			while (1) {
				if (!(((NI) 0) <= res_101690)) goto LA3;
				i_101658 = res_101690;
				{
