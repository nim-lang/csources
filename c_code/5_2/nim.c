...
STRING_LITERAL(TMP1904, "nim.cfg", 7);
STRING_LITERAL(TMP4862, "./", 2);
STRING_LITERAL(TMP4863, "js", 2);
STRING_LITERAL(TMP4864, "node ", 5);
...
appendString(LOC7, ((NimStringDesc*) &TMP4862));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
N_NIMCALL(void, handlecmdline_611607)(void) {
	...
	LA4: ;
	{
		processcmdline_605209(((NU8) 0), ((NimStringDesc*) &TMP1878));
		{
			TSafePoint TMP1879;
			TY117204 p;
			NimStringDesc* LOC15;
			...
			pushSafePoint(&TMP1879);
			TMP1879.status = _setjmp(TMP1879.context);
			if (TMP1879.status == 0) {
			...
			if (TMP1879.status != 0) reraiseException();
		...
		LA7: ;
		loadconfigs_220811(((NimStringDesc*) &TMP1904));
		initvars_202820();
		processcmdline_605209(((NU8) 1), ((NimStringDesc*) &TMP1878));
		maincommand_609027();
		{
			NimStringDesc* LOC22;
			...
			if (!(gerrorcounter_196303 == 0)) goto LA25;
			{
				if (!((gglobaloptions_169118 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				{
					...
					LA37: ;
					{
						...
						NimStringDesc* LOC43;
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_169234, ((NimStringDesc*) &TMP4863));
						LOC42 = 0;
...
appendString(LOC44, ((NimStringDesc*) &TMP4864));
appendString(LOC44, ex);
appendChar(LOC44, 32);
appendString(LOC44, arguments_210144);
					execexternalprogram_202907(LOC44, ((NimStringDesc*) &TMP1878));
				}
				goto LA31;
				LA33: ;
				{
					...
					LA48: ;
					{
						NimStringDesc* LOC51;
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_169234, ((NimStringDesc*) &TMP1878));
...
appendString(LOC52, arguments_210144);
					execexternalprogram_202907(LOC52, ((NimStringDesc*) &TMP1878));
				}
				LA31: ;
			}
			LA29: ;
