...
static NIM_CONST TY171865 TMP3145 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3146, "ident", 5);
static NIM_CONST TY171865 TMP3147 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3148, "sym", 3);
static NIM_CONST TY171865 TMP3149 = {
0xE0, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3150, "intVal", 6);
static NIM_CONST TY171865 TMP3151 = {
0x00, 0x00, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3152, "floatVal", 8);
static NIM_CONST TY171865 TMP3153 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3154, "strVal", 6);
static NIM_CONST TY171865 TMP3155 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3156, "sons", 4);
STRING_LITERAL(TMP3161, "data[h].key == nil ", 19);
STRING_LITERAL(TMP3162, "not (t.data[index].key == nil) ", 31);
...
N_NIMCALL(NI, hashtree_223018)(tnode171659* n) {
	...
	default:
	{
		...
		TMP3157 = subInt(LOC25, 1);
		HEX3Atmp_223174 = (NI64)(TMP3157);
	...
	LA3: ;
	{
		...
		default:
		{
			nimln(49, "treetab.nim");
			{
				...
				TMP3158 = subInt(LOC25, 1);
				HEX3Atmp_223371 = (NI64)(TMP3158);
				nimln(1301, "system.nim");
				res_223373 = 0;
				nimln(1302, "system.nim");
				while (1) {
...
static N_INLINE(NI, nexttry_178196)(NI h, NI maxhash) {
	...
	nimln(452, "astalgo.nim");
	TMP3159 = mulInt(5, h);
	TMP3160 = addInt((NI64)(TMP3159), 1);
	result = (NI)((NI64)(TMP3160) & maxhash);
	popFrame();
	return result;
}
N_NIMCALL(NI, nodetablerawget_223378)(tnodetable171717 t, NI k, tnode171659* key) {
...
N_NIMCALL(void, nodetablerawinsert_223412)(tnodepairseq171715** data, NI k, tnode171659* key, NI val) {
	...
	nimln(72, "treetab.nim");
	{
		...
		nimln(72, "treetab.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP3161));	}	LA4: ;
...
N_NIMCALL(void, nodetableput_223605)(tnodetable171717* t, tnode171659* key, NI val) {
	...
	nimln(81, "treetab.nim");
	{
		...
		nimln(82, "treetab.nim");
		{
			...
			nimln(82, "treetab.nim");
			hiddenraiseassert_76017(((NimStringDesc*) &TMP3162));		}		LA7: ;
	...
	LA3: ;
	{
		nimln(85, "treetab.nim");
		{
			...
			nimln(86, "treetab.nim");
			nimln(86, "treetab.nim");
			TMP3163 = mulInt((*t).Data->Sup.len, 2);
			n = (tnodepairseq171715*) newSeq((&NTI171715), (NI64)(TMP3163));
			i_223836 = 0;
			HEX3Atmp_223874 = 0;
...
N_NIMCALL(NI, nodetabletestorset_223881)(tnodetable171717* t, tnode171659* key, NI val) {
	...
	LA3: ;
	{
		nimln(102, "treetab.nim");
		{
			...
			nimln(103, "treetab.nim");
			nimln(103, "treetab.nim");
			TMP3164 = mulInt((*t).Data->Sup.len, 2);
			n = (tnodepairseq171715*) newSeq((&NTI171715), (NI64)(TMP3164));
			i_224036 = 0;
			HEX3Atmp_224074 = 0;
