...
STRING_LITERAL(TMP3098, "atom", 4);
STRING_LITERAL(TMP3099, "lit", 3);
STRING_LITERAL(TMP3100, "sym", 3);
STRING_LITERAL(TMP3101, "ident", 5);
STRING_LITERAL(TMP3102, "call", 4);
STRING_LITERAL(TMP3103, "alias", 5);
STRING_LITERAL(TMP3104, "noalias", 7);
STRING_LITERAL(TMP3105, "lvalue", 6);
STRING_LITERAL(TMP3106, "local", 5);
STRING_LITERAL(TMP3107, "sideeffect", 10);
STRING_LITERAL(TMP3108, "nosideeffect", 12);
STRING_LITERAL(TMP3110, "compiler/parampatterns.nim", 26);
NIM_CONST TY85545 TMP3109 = {((NimStringDesc*) &TMP3110),
((NI) 100)}
;
NIM_CONST TY85545 TMP3111 = {((NimStringDesc*) &TMP3110),
((NI) 107)}
;
STRING_LITERAL(TMP3112, "parameter pattern too complex", 29);
...
{	switch ((*p).Kind) {
	...
	case ((NU8) 32):
	{
		...
		op = (*(*p).kindU.S6.Sons->data[((NI) 0)]).kindU.S5.Ident;
		{
			...
			if (!(LOC8 == ((NI) 3))) goto LA9;
			{
				NIM_BOOL LOC13;
				LOC13 = 0;
				LOC13 = eqStrings((*op).S, ((NimStringDesc*) &TMP3095));
				if (LOC13) goto LA14;
			...
			LA15: ;
			{
				NIM_BOOL LOC18;
				LOC18 = 0;
				LOC18 = eqStrings((*op).S, ((NimStringDesc*) &TMP3096));
				if (LOC18) goto LA19;
		...
		LA9: ;
		{
			...
			if (!(LOC24)) goto LA26;
			LOC27 = 0;
			LOC27 = eqStrings((*op).S, ((NimStringDesc*) &TMP3097));
			if (LOC27) goto LA28;
	...
	case ((NU8) 2):
	{
		...
		case 2: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3108))) goto LA50;
break;
		case 4: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3100))) goto LA42;
if (eqStrings(spec, ((NimStringDesc*) &TMP3105))) goto LA47;
if (eqStrings(spec, ((NimStringDesc*) &TMP3107))) goto LA49;
break;
		case 6: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3101))) goto LA43;
break;
		case 10: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3104))) goto LA46;
break;
		case 11: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3098))) goto LA40;
break;
		case 12: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3099))) goto LA41;
break;
		case 13: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3102))) goto LA44;
break;
		case 14: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3103))) goto LA45;
if (eqStrings(spec, ((NimStringDesc*) &TMP3106))) goto LA48;
break;
		}
		goto LA51;
		LA40: ;
...
N_NIMCALL(tnode207813*, semnodekindconstraints_283686)(tnode207813* p) {
	...
	(*result).kindU.S3.Strval = addChar((*result).kindU.S3.Strval, 1);
	{
		...
		}
		{
			...
			internalerror_182424((*p).Info, ((NimStringDesc*) &TMP3112));
		}
		LA12: ;
	}
	goto LA1;
