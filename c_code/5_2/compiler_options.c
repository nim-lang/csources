...
static TNimNode* TMP1989[22];
NI TMP1991;
static char* NIM_CONST TMP1990[22] = {
"optNone", 
"optObjCheck", 
"optFieldCheck", 
"optRangeCheck", 
...
"optImplicitStatic", 
"optPatterns"};
static TNimNode* TMP2990[32];
NI TMP2992;
static char* NIM_CONST TMP2991[32] = {
"gloptNone", 
"optForceFullMake", 
"optDeadCodeElim", 
"optListCmd", 
...
"optGenIndex", 
"optEmbedOrigSrc"};
static TNimNode* TMP3001[20];
NI TMP3003;
static char* NIM_CONST TMP3002[20] = {
"cmdNone", 
"cmdCompileToC", 
"cmdCompileToCpp", 
"cmdCompileToOC", 
...
NTI114009.base = 0;
NTI114009.flags = 3;
for (TMP1991 = 0; TMP1991 < 22; TMP1991++) {
TMP256[TMP1991+0].kind = 1;
TMP256[TMP1991+0].offset = TMP1991;
TMP256[TMP1991+0].name = TMP1990[TMP1991];
TMP1989[TMP1991] = &TMP256[TMP1991+0];
}
TMP256[22].len = 22; TMP256[22].kind = 2; TMP256[22].sons = &TMP1989[0];
...
NTI114013.base = 0;
NTI114013.flags = 3;
for (TMP2992 = 0; TMP2992 < 32; TMP2992++) {
TMP256[TMP2992+24].kind = 1;
TMP256[TMP2992+24].offset = TMP2992;
TMP256[TMP2992+24].name = TMP2991[TMP2992];
TMP2990[TMP2992] = &TMP256[TMP2992+24];
}
TMP256[56].len = 32; TMP256[56].kind = 2; TMP256[56].sons = &TMP2990[0];
NTI114013.node = &TMP256[56];
NTI114017.size = sizeof(NU8);
NTI114017.kind = 14;
NTI114017.base = 0;
NTI114017.flags = 3;
for (TMP3003 = 0; TMP3003 < 20; TMP3003++) {
TMP256[TMP3003+57].kind = 1;
TMP256[TMP3003+57].offset = TMP3003;
TMP256[TMP3003+57].name = TMP3002[TMP3003];
TMP3001[TMP3003] = &TMP256[TMP3003+57];
}
TMP256[77].len = 20; TMP256[77].kind = 2; TMP256[77].sons = &TMP3001[0];
