...
STRING_LITERAL(TMP2718, "getSymFromList", 14);
STRING_LITERAL(TMP3203, "lookupInRecord", 14);
STRING_LITERAL(TMP3204, "lookupInRecord(record case branch)", 34);
STRING_LITERAL(TMP3205, "lookupInRecord()", 16);
...
N_NIMCALL(void, strtableenlarge_223228)(tstrtable209822* t) {
	...
	tsymseq209820* LOC8;
	n = 0;
	n = (tsymseq209820*) newSeq((&NTI209820), (NI64)((*t).Data->Sup.len * 2));
	{
		NI i_223272;
		NI HEX3Atmp_223308;
		NI res_223311;
	...
	unsureAsgnRef((void**) (&(*x).Data), (tiipairseq218272*) newSeq((&NTI218272), 8));
	{
		...
		res_225831 = 0;
		{
			while (1) {
				...
				i_225827 = res_225831;
				(*x).Data->data[i_225827].Key = (IL64(-9223372036854775807) - IL64(1));
				res_225831 += 1;
			} LA3: ;
		}
	}
	...
	{
		{
			...
			if (!LOC8) goto LA9;
			n = 0;
			n = (tiipairseq218272*) newSeq((&NTI218272), (NI64)((*t).Data->Sup.len * 2));
			{
				NI i_226452;
				NI HEX3Atmp_226497;
				NI res_226500;
				...
				res_226500 = 0;
				{
					while (1) {
						...
						i_226452 = res_226500;
						n->data[i_226452].Key = (IL64(-9223372036854775807) - IL64(1));
						res_226500 += 1;
					} LA13: ;
				}
			}
			{
				...
				res_226506 = 0;
				{
					while (1) {
						...
						i_226465 = res_226506;
						{
							if (!!(((*t).Data->data[i_226465].Key == (IL64(-9223372036854775807) - IL64(1))))) goto LA19;
	...
	{
		{
			...
			LOC8 = mustrehash_218249((*t).Data->Sup.len, (*t).Counter);
			if (!LOC8) goto LA9;
			n = (tidpairseq209864*) newSeq((&NTI209864), (NI64)((*t).Data->Sup.len * 2));
			{
				NI i_224851;
				NI HEX3Atmp_225032;
				NI res_225035;
...
{	result = 0;
	{
		...
		res_218877 = start;
		{
			while (1) {
				...
				LA7: ;
				{
					internalerror_183669((*list).Info, ((NimStringDesc*) &TMP2718));
				}
				LA5: ;
				res_218877 += 1;
			} LA4: ;
	...
	{
		{
			...
			if (!LOC8) goto LA9;
			n = 0;
			n = (tidnodepairseq209870*) newSeq((&NTI209870), (NI64)((*t).Data->Sup.len * 2));
			{
				NI i_225652;
				NI HEX3Atmp_225701;
				NI res_225704;
...
{	result = 0;
	...
	{
		{
			...
			internalerror_183669((*n).Info, ((NimStringDesc*) &TMP3203));
		}
		LA13: ;
		...
		LA17: ;
		{
			...
			res_218588 = 1;
			{
				while (1) {
					...
					default:
					{
						internalerror_183669((*n).Info, ((NimStringDesc*) &TMP3204));
					}
					break;
					}
					res_218588 += 1;
	...
	default:
	{
		internalerror_183669((*n).Info, ((NimStringDesc*) &TMP3205));
	}
	break;
	}
	}BeforeRet: ;
