...
STRING_LITERAL(TMP3279, "lookupInRecord", 14);
STRING_LITERAL(TMP3280, "lookupInRecord(record case branch)", 34);
STRING_LITERAL(TMP3281, "lookupInRecord()", 16);
...
{	result = 0;
	...
	default:
	{
		internalerror_182424((*n).Info, ((NimStringDesc*) &TMP3281));
	}
	break;
	}
	}BeforeRet: ;
