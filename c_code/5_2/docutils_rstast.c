...
43}
;
STRING_LITERAL(TMP3871, "\012", 1);
STRING_LITERAL(TMP3873, "", 0);
STRING_LITERAL(TMP3875, "\012\012", 2);
STRING_LITERAL(TMP3877, "* ", 2);
STRING_LITERAL(TMP3878, "(#) ", 4);
STRING_LITERAL(TMP3879, "  ", 2);
STRING_LITERAL(TMP3883, "| ", 2);
STRING_LITERAL(TMP3884, "`", 1);
STRING_LITERAL(TMP3885, "`_", 2);
STRING_LITERAL(TMP3886, " <", 2);
STRING_LITERAL(TMP3887, ">`_", 3);
STRING_LITERAL(TMP3888, "`:", 2);
STRING_LITERAL(TMP3889, "`:sub:", 6);
STRING_LITERAL(TMP3890, "`:sup:", 6);
STRING_LITERAL(TMP3891, "`:idx:", 6);
STRING_LITERAL(TMP3892, "*", 1);
STRING_LITERAL(TMP3893, "**", 2);
STRING_LITERAL(TMP3894, "***", 3);
STRING_LITERAL(TMP3895, "``", 2);
STRING_LITERAL(TMP3896, "\\", 1);
STRING_LITERAL(TMP3897, "\\\\", 2);
STRING_LITERAL(TMP3898, ".. index::\012", 11);
STRING_LITERAL(TMP3899, ".. contents::", 13);
STRING_LITERAL(TMP3900, "Error: cannot render: ", 22);
...
N_NIMCALL(trstnode278018*, lastson_278145)(trstnode278018* n) {
	...
	nimln(87, "rstast.nim");
	nimln(87, "rstast.nim");
	TMP3869 = subInt((*n).Sons->Sup.len, 1);
	if ((NU)((NI64)(TMP3869)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP3869)];
	popFrame();
	return result;
}
static N_INLINE(void, asgnRefNoCycle)(void** dest, void* src) {
...
N_NIMCALL(void, renderrstsons_278210)(trendercontext278198* d, trstnode278018* n, NimStringDesc** result) {
	...
	LOC1 = 0;
	LOC1 = len_278089(n);
	TMP3870 = subInt(LOC1, 1);
	HEX3Atmp_278227 = (NI64)(TMP3870);
...
appendString((*result), ind);
		...
		nimln(123, "rstast.nim");
		TMP3872 = subInt((*result)->Sup.len, oldlen);
		headlinelen = (NI64)(TMP3872);
...
appendString((*result), ind);
		...
		headline = copyString(((NimStringDesc*) &TMP3873));
		nimln(133, "rstast.nim");
		renderrstsons_278210(d, n, &headline);		nimln(135, "rstast.nim");
		nimln(135, "rstast.nim");
		nimln(135, "rstast.nim");
		TMP3874 = subInt(headline->Sup.len, (*d).Indent);
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI64)(TMP3874), lvltochar_278241[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		nimln(146, "rstast.nim");
		nimln(146, "rstast.nim");
		TMP3876 = subInt(78, (*d).Indent);
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI64)(TMP3876), 45);
...
appendString((*result), ind);
	...
	case ((NU8) 6):
	{
		...
		tmp = copyString(((NimStringDesc*) &TMP3873));
...
appendString((*result), ((NimStringDesc*) &TMP3879));
	...
	case ((NU8) 14):
	{
		...
		nimln(191, "rstast.nim");
		nimln(191, "rstast.nim");
		TMP3880 = addInt(tmp->Sup.len, 3);
		l = (((NI64)(TMP3880) >= 30) ? (NI64)(TMP3880) : 30);
...
appendString((*result), tmp);
		...
		nimln(199, "rstast.nim");
		nimln(199, "rstast.nim");
		TMP3881 = subInt(l, tmp->Sup.len);
		TMP3882 = subInt((NI64)(TMP3881), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI64)(TMP3882), 32);
...
appendString((*result), (*n).Text);
	...
	case ((NU8) 64):
	{
		nimln(265, "rstast.nim");
		{
			...
			if (!(LOC48)) goto LA49;
			nimln(265, "rstast.nim");
			LOC48 = eqStrings((*n).Text, ((NimStringDesc*) &TMP3896));
			LA49: ;
			if (!LOC48) goto LA50;
...
appendString((*result), ((NimStringDesc*) &TMP3899));
	}	break;
	default:
	{
		NimStringDesc* LOC60;
...
appendString(LOC60, ((NimStringDesc*) &TMP3900));
...
static TNimNode* TMP3863[4];
static TNimNode* TMP3864[65];
NI TMP3866;
static char* NIM_CONST TMP3865[65] = {
"rnInner", 
"rnHeadline", 
"rnOverline", 
"rnTransition", 
...
NTI278012.base = 0;
NTI278012.flags = 3;
for (TMP3866 = 0; TMP3866 < 65; TMP3866++) {
TMP3861[TMP3866+2].kind = 1;
TMP3861[TMP3866+2].offset = TMP3866;
TMP3861[TMP3866+2].name = TMP3865[TMP3866];
TMP3864[TMP3866] = &TMP3861[TMP3866+2];
}
TMP3861[67].len = 65; TMP3861[67].kind = 2; TMP3861[67].sons = &TMP3864[0];
NTI278012.node = &TMP3861[67];
TMP3861[1].kind = 1;
TMP3861[1].offset = offsetof(trstnode278018, Kind);
TMP3861[1].typ = (&NTI278012);
TMP3861[1].name = "kind";
TMP3863[1] = &TMP3861[68];
TMP3861[68].kind = 1;
TMP3861[68].offset = offsetof(trstnode278018, Text);
TMP3861[68].typ = (&NTI142);
TMP3861[68].name = "text";
TMP3863[2] = &TMP3861[69];
TMP3861[69].kind = 1;
TMP3861[69].offset = offsetof(trstnode278018, Level);
TMP3861[69].typ = (&NTI105);
TMP3861[69].name = "level";
TMP3863[3] = &TMP3861[70];
TMP3861[70].kind = 1;
TMP3861[70].offset = offsetof(trstnode278018, Sons);
TMP3861[70].typ = (&NTI278093);
TMP3861[70].name = "sons";
TMP3861[0].len = 4; TMP3861[0].kind = 2; TMP3861[0].sons = &TMP3863[0];
NTI278018.node = &TMP3861[0];
NTI278014.size = sizeof(trstnode278018*);
NTI278014.kind = 22;
NTI278014.base = (&NTI278018);
NTI278014.flags = 2;
NTI278014.marker = TMP3868;
}
