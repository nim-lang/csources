...
STRING_LITERAL(TMP4953, "No valid socket error code available", 36);
STRING_LITERAL(TMP4954, "Could not send all data.", 24);
STRING_LITERAL(TMP4956, "", 0);
STRING_LITERAL(TMP4958, "Call to \'", 9);
STRING_LITERAL(TMP4959, "\' timed out.", 12);
STRING_LITERAL(TMP4961, "readLine", 8);
STRING_LITERAL(TMP4962, "\015\012", 2);
...
N_NIMCALL(NI32, getsocketerror_521001)(socketimpl520407* socket) {
	...
	LA3: ;
	{
		...
		LOC9 = 0;
		LOC9 = (*e_521008).Sup.Sup.message; (*e_521008).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP4953));
...
{	sent = send_524715(socket, ((void*) (data->data)), data->Sup.len);
	...
	LA3: ;
	{
		oserror3433* e_525219;
		NimStringDesc* LOC14;
		if (!!((sent == data->Sup.len))) goto LA12;
		e_525219 = 0;
		e_525219 = (oserror3433*) newObj((&NTI114812), sizeof(oserror3433));
		(*e_525219).Sup.Sup.Sup.m_type = (&NTI3433);
		LOC14 = 0;
		LOC14 = (*e_525219).Sup.Sup.message; (*e_525219).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP4954));
		if (LOC14) nimGCunrefNoCycle(LOC14);
		raiseException((Exception*)e_525219, "OSError");
	}
	LA12: ;
	}BeforeRet: ;
}
...
N_NIMCALL(void, accept_522401)(socketimpl520407* server, socketimpl520407** client, NU8 flags) {
	...
	addrdummy = copyString(((NimStringDesc*) &TMP4956));
...
{	waited = 0.0;
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_523818(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP4961));
			...
			LA4: ;
			{
				...
				LOC20 = 0;
				LOC20 = waitfor_523818(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP4961));
...
appendString((*line), ((NimStringDesc*) &TMP4962));
				}
				LA38: ;
				goto BeforeRet;
			}
...
N_NIMCALL(void, close_522417)(socketimpl520407* socket) {
	TSafePoint TMP4963;
	pushSafePoint(&TMP4963);
	TMP4963.status = _setjmp(TMP4963.context);
	if (TMP4963.status == 0) {
		popSafePoint();
	}
	else {
	...
	if (TMP4963.status != 0) reraiseException();
}
...
TMP989[3].len = 3; TMP989[3].kind = 2; TMP989[3].sons = &TMP4943[0];
