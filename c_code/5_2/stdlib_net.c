...
N_NIMCALL(void, TMP5000)(void* p, NI op);
...
STRING_LITERAL(TMP4996, "No valid socket error code available", 36);
STRING_LITERAL(TMP4997, "Could not send all data.", 24);
STRING_LITERAL(TMP4999, "", 0);
STRING_LITERAL(TMP5001, "Call to \'", 9);
STRING_LITERAL(TMP5002, "\' timed out.", 12);
STRING_LITERAL(TMP5004, "readLine", 8);
STRING_LITERAL(TMP5005, "\015\012", 2);
...
N_NIMCALL(NI32, getsocketerror_514001)(Socketimpl513407* socket) {
	...
	LA3: ;
	{
		...
		LOC9 = 0;
		LOC9 = (*e_514008).Sup.Sup.message; (*e_514008).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP4996));
...
{	sent = send_517715(socket, ((void*) (data->data)), (data ? data->Sup.len : 0));
	...
	LA3: ;
	{
		...
		LOC14 = 0;
		LOC14 = (*e_518219).Sup.Sup.message; (*e_518219).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP4997));
...
N_NIMCALL(void, accept_515401)(Socketimpl513407* server, Socketimpl513407** client, NU8 flags) {
	...
	addrdummy = copyString(((NimStringDesc*) &TMP4999));
...
{	waited = 0.0;
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_516818(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5004));
			...
			LA4: ;
			{
				...
				LOC20 = 0;
				LOC20 = waitfor_516818(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5004));
...
appendString((*line), ((NimStringDesc*) &TMP5005));
				}
				LA38: ;
				goto BeforeRet;
			}
...
N_NIMCALL(void, close_515417)(Socketimpl513407* socket) {
	TSafePoint TMP5006;
	pushSafePoint(&TMP5006);
	TMP5006.status = _setjmp(TMP5006.context);
	if (TMP5006.status == 0) {
		popSafePoint();
	}
	else {
	...
	if (TMP5006.status != 0) reraiseException();
}
...
TMP1071[3].len = 3; TMP1071[3].kind = 2; TMP1071[3].sons = &TMP4986[0];
