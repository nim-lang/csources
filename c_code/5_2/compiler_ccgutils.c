...
static NIM_CONST TY171865 TMP5592 = {
...
static N_INLINE(ttype171693*, lastson_172034)(ttype171693* n) {
	...
	if ((NU)((NI64)(TMP5598)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP5598)];
	popFrame();
	return result;
}
N_NIMCALL(ttype171693*, getuniquetype_366401)(ttype171693* key) {
	...
	case ((NU8) 55):
	{
		...
		internalerror_138383(((NimStringDesc*) &TMP5596));	}	break;
	case ((NU8) 12):
	{
		nimln(92, "ccgutils.nim");
		internalerror_138383(((NimStringDesc*) &TMP5597));	}	break;
	case ((NU8) 11):
	case ((NU8) 13):
	case ((NU8) 15):
	case ((NU8) 47):
...
N_NIMCALL(trope121007*, makellvmstring_366621)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(170, "ccgutils.nim");
		{
			...
			nimln(170, "ccgutils.nim");
			nimln(170, "ccgutils.nim");
			TMP5602 = addInt(i_366636, 1);
			TMP5603 = modInt((NI64)(TMP5602), 64);
			if (!(((NI) ((NI64)(TMP5603))) == 0)) goto LA4;
