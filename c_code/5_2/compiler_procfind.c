...
N_NIMCALL(tyObject_TSym_AXG7xcvKqaxY6koRX1xkCw*, searchForProcNew_XUBQS3wiYN5kYQxrNN9awNQ_2)(tyObject_TContext_5TfOJKwTttj3W1t1tMzWUQ* c, tyObject_TScope_1cQRXW6aAknk7ywAwjH3nw* scope, tyObject_TSym_AXG7xcvKqaxY6koRX1xkCw* fn);
	...
	result = initIdentIter_mWFOqJ9be21lsluYGFm6uRA((&it), (*scope).symbols, (*fn).name);
	{
		while (1) {
			if (!!((result == NIM_NIL))) goto LA2;
			{
				...
				{
					localError_VpilfPWbplGz6ny7O9cfr2g((*fn).info, ((tyEnum_TMsgKind_IGAWgv9aR2KqPKJfPZPEWaw) 69), (*(*fn).name).s);
					goto BeforeRet_;
				}
				break;
...
N_NIMCALL(tyObject_TSym_AXG7xcvKqaxY6koRX1xkCw*, searchForProc_XUBQS3wiYN5kYQxrNN9awNQ)(tyObject_TContext_5TfOJKwTttj3W1t1tMzWUQ* c, tyObject_TScope_1cQRXW6aAknk7ywAwjH3nw* scope, tyObject_TSym_AXG7xcvKqaxY6koRX1xkCw* fn) {
	tyObject_TSym_AXG7xcvKqaxY6koRX1xkCw* result;
	result = (tyObject_TSym_AXG7xcvKqaxY6koRX1xkCw*)0;
