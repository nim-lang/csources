...
static NIM_CONST TY171865 TMP3699 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3700, "sons", 4);
STRING_LITERAL(TMP3702, "equalGenericParams", 18);
static NIM_CONST TY171865 TMP3703 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3704, "sym", 3);
...
static N_INLINE(NI, sonslen_172022)(tnode171659* n) {
	...
	{
		nimln(1209, "ast.nim");
		if (((TMP3699[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3700));
...
N_NIMCALL(NIM_BOOL, equalgenericparams_269010)(tnode171659* proca, tnode171659* procb) {
	...
	TMP3701 = subInt(LOC7, 1);
	HEX3Atmp_269134 = (NI64)(TMP3701);
	...
	while (1) {
		...
		nimln(19, "procfind.nim");
		{
			nimln(698, "system.nim");
			nimln(698, "system.nim");
			if (((TMP3699[(*proca).Kind/8] &(1<<((*proca).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3700));
			...
			internalerror_138369((*proca).Info, ((NimStringDesc*) &TMP3702));			nimln(21, "procfind.nim");
			goto BeforeRet;
		}		LA11: ;
		nimln(22, "procfind.nim");
		{
			nimln(698, "system.nim");
			nimln(698, "system.nim");
			if (((TMP3699[(*procb).Kind/8] &(1<<((*procb).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3700));
			...
			internalerror_138369((*procb).Info, ((NimStringDesc*) &TMP3702));			nimln(24, "procfind.nim");
			goto BeforeRet;
		}		LA15: ;
		nimln(25, "procfind.nim");
		if (((TMP3699[(*proca).Kind/8] &(1<<((*proca).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3700));
		if ((NU)(i_269024) >= (NU)((*proca).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3703[(*(*proca).kindU.S6.Sons->data[i_269024]).Kind/8] &(1<<((*(*proca).kindU.S6.Sons->data[i_269024]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3704));
		a = (*(*proca).kindU.S6.Sons->data[i_269024]).kindU.S4.Sym;
		nimln(26, "procfind.nim");
		if (((TMP3699[(*procb).Kind/8] &(1<<((*procb).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3700));
		if ((NU)(i_269024) >= (NU)((*procb).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3703[(*(*procb).kindU.S6.Sons->data[i_269024]).Kind/8] &(1<<((*(*procb).kindU.S6.Sons->data[i_269024]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3704));
	...
	nimln(39, "procfind.nim");
	{
		...
		while (1) {
			...
			nimln(44, "procfind.nim");
			{
				...
				if (((TMP3699[(*(*result).Ast).Kind/8] &(1<<((*(*result).Ast).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3700));
				if ((NU)(2) >= (NU)((*(*result).Ast).kindU.S6.Sons->Sup.len)) raiseIndexError();
				genr = (*(*result).Ast).kindU.S6.Sons->data[2];
				nimln(46, "procfind.nim");
				if (((TMP3699[(*(*fn).Ast).Kind/8] &(1<<((*(*fn).Ast).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3700));
