...
STRING_LITERAL(TMP1318, "", 0);
STRING_LITERAL(TMP1319, "subschar", 8);
STRING_LITERAL(TMP1320, "metachar", 8);
STRING_LITERAL(TMP1321, "emit", 4);
STRING_LITERAL(TMP1322, "result.add", 10);
STRING_LITERAL(TMP1323, "conc", 4);
STRING_LITERAL(TMP1324, " & ", 3);
STRING_LITERAL(TMP1325, "tostring", 8);
STRING_LITERAL(TMP1326, "$", 1);
STRING_LITERAL(TMP1327, "\012", 1);
STRING_LITERAL(TMP1329, "end", 3);
STRING_LITERAL(TMP1330, "#end", 4);
static NIM_CONST TY211607 TMP1331 = {
...
N_NIMCALL(void, parseline_257174)(ttmplparser257020* p) {
	...
	LA7: ;
	{
		...
		d = j;
		keyw = copyString(((NimStringDesc*) &TMP1318));
		{
			while (1) {
		...
		case ((NU8) 20):
		{
			...
			{
				(*p).Info.Col = ((NI16) (j));
				localerror_197938((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP1329));
			}
			LA20: ;
			LOC25 = 0;
		...
		case ((NU8) 59):
		{
			...
			llstreamwrite_211278((*p).Outp, LOC34);
			{
				NIM_BOOL LOC37;
				LOC37 = 0;
				LOC37 = contains_97229((*p).X, TMP1331);
				if (!!(LOC37)) goto LA38;
				(*p).Indent += 2;
			}
			LA38: ;
				...
				{
					{
						...
						case 123:
						{
							...
							curly = 0;
							{
								while (1) {
									...
									case 0:
									{
										localerror_197938((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP1338));
										goto LA62;
									}
									break;
									case 123:
						...
						default:
						{
							...
							{
								(*p).Info.Col = ((NI16) (j));
								localerror_197938((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP1326));
							}
							LA80: ;
						}
						break;
...
N_NIMCALL(tllstream211204*, filtertmpl_257009)(tllstream211204* stdin_257011, NimStringDesc* filename, tnode224819* call) {
	...
	p.Outp = llstreamopen_211220(((NimStringDesc*) &TMP1318));
	p.Inp = stdin_257011;
	p.Subschar = chararg_256020(call, ((NimStringDesc*) &TMP1319), 1, 36);
	p.Nimdirective = chararg_256020(call, ((NimStringDesc*) &TMP1320), 2, 35);
	p.Emit = strarg_256029(call, ((NimStringDesc*) &TMP1321), 3, ((NimStringDesc*) &TMP1322));
	p.Conc = strarg_256029(call, ((NimStringDesc*) &TMP1323), 4, ((NimStringDesc*) &TMP1324));
	p.Tostr = strarg_256029(call, ((NimStringDesc*) &TMP1325), 5, ((NimStringDesc*) &TMP1326));
