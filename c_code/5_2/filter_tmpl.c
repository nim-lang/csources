...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP2664, "\012", 1);
STRING_LITERAL(TMP2665, "", 0);
STRING_LITERAL(TMP2666, "end", 3);
STRING_LITERAL(TMP2667, "#end", 4);
static NIM_CONST TY121387 TMP2669 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x24,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2671, "\"", 1);
...
STRING_LITERAL(TMP2679, "\\n\"", 3);
STRING_LITERAL(TMP2680, "subschar", 8);
STRING_LITERAL(TMP2681, "metachar", 8);
STRING_LITERAL(TMP2682, "emit", 4);
STRING_LITERAL(TMP2683, "result.add", 10);
STRING_LITERAL(TMP2684, "conc", 4);
STRING_LITERAL(TMP2685, " & ", 3);
STRING_LITERAL(TMP2686, "tostring", 8);
...
N_NIMCALL(void, newline_217040)(ttmplparser217017* p) {
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		nimln(42, "filter_tmpl.nim");
		llstreamwrite_173258((*p).Outp, ((NimStringDesc*) &TMP2664));
	}
	LA4: ;
...
N_NIMCALL(void, parseline_217177)(ttmplparser217017* p) {
	...
	LA6: ;
	{
		...
		keyw = copyString(((NimStringDesc*) &TMP2665));
		...
		case ((NU8) 20):
		{
			...
			LA19: ;
			{
				...
				localerror_163571((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP2666));
			}
			LA17: ;
		...
		case ((NU8) 24):
		{
			...
			nimln(99, "filter_tmpl.nim");
			nimln(99, "filter_tmpl.nim");
			TMP2668 = subInt((*p).Indent, 2);
			LOC27 = 0;
			LOC27 = nsuRepeatChar((NI64)(TMP2668), 32);
		...
		case ((NU8) 60):
		{
			...
			nimln(104, "filter_tmpl.nim");
			{
				...
				nimln(104, "filter_tmpl.nim");
				LOC34 = 0;
				LOC34 = contains_90258((*p).X, TMP2669);
				if (!!(LOC34)) goto LA35;
	...
	LA9: ;
	{
		...
		case ((NU8) 1):
		{
			...
			nimln(123, "filter_tmpl.nim");
			nimln(123, "filter_tmpl.nim");
			TMP2670 = addInt((*p).Indent, 2);
			LOC42 = 0;
			LOC42 = nsuRepeatChar((NI64)(TMP2670), 32);
			llstreamwrite_173258((*p).Outp, LOC42);
			nimln(124, "filter_tmpl.nim");
			llstreamwrite_173258((*p).Outp, ((NimStringDesc*) &TMP2671));
		}
		break;
		case ((NU8) 0):
		{
			...
			llstreamwrite_173258((*p).Outp, ((NimStringDesc*) &TMP2672));
		...
		while (1) {
			...
			case 128 ... 255:
			{
				...
				llstreamwrite_173258((*p).Outp, ((NimStringDesc*) &TMP2673));
				...
				nimln(150, "filter_tmpl.nim");
				{
					...
					case 123:
					{
						...
						while (1) {
							...
							case 0:
							{
								...
								localerror_163571((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP2677));
					...
					default:
					{
						...
						LA76: ;
						{
							...
							localerror_163571((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP2678));
						}
						LA74: ;
					}
					break;
...
N_NIMCALL(tllstream173204*, filtertmpl_217007)(tllstream173204* stdin_217009, NimStringDesc* filename, tnode185813* call) {
	...
	p.Outp = llstreamopen_173218(((NimStringDesc*) &TMP2665));
	nimln(209, "filter_tmpl.nim");
	p.Inp = stdin_217009;
	nimln(210, "filter_tmpl.nim");
	p.Subschar = chararg_216014(call, ((NimStringDesc*) &TMP2680), 1, 36);
	nimln(211, "filter_tmpl.nim");
	p.Nimdirective = chararg_216014(call, ((NimStringDesc*) &TMP2681), 2, 35);
	nimln(212, "filter_tmpl.nim");
	p.Emit = strarg_216021(call, ((NimStringDesc*) &TMP2682), 3, ((NimStringDesc*) &TMP2683));
	nimln(213, "filter_tmpl.nim");
	p.Conc = strarg_216021(call, ((NimStringDesc*) &TMP2684), 4, ((NimStringDesc*) &TMP2685));
	nimln(214, "filter_tmpl.nim");
	p.Tostr = strarg_216021(call, ((NimStringDesc*) &TMP2686), 5, ((NimStringDesc*) &TMP2678));
	...
	while (1) {
		...
		nimln(217, "filter_tmpl.nim");
		TMP2687 = addInt(p.Info.Line, ((NI16) 1));
		if (TMP2687 < -32768 || TMP2687 > 32767) raiseOverflow();
		p.Info.Line = (NI16)(TMP2687);
