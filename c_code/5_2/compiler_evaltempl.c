...
STRING_LITERAL(TMP2854, "", 0);
STRING_LITERAL(TMP2856, "compiler/evaltempl.nim", 22);
NIM_CONST TY85545 TMP2855 = {((NimStringDesc*) &TMP2856),
39}
;
...
N_NIMCALL(tnode209818*, evaltemplateargs_414205)(tnode209818* n, tsym209848* s) {
	...
	{
		if (!(f < a)) goto LA5;
		globalerror_183616((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP2854));
	}
	LA5: ;
		...
		res_414265 = 1;
		{
			while (1) {
				...
				LA10: ;
				{
					...
					LA18: ;
					if (!LOC17) goto LA19;
					localerror_183637((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP2854));
				}
				LA19: ;
...
N_NIMCALL(tnode209818*, evaltemplate_414286)(tnode209818* n, tsym209848* tmpl, tsym209848* gensymowner) {
	...
	evaltemplatecounter_414282 += 1;
	{
		...
		globalerror_183616((*n).Info, ((NU16) 183), ((NimStringDesc*) &TMP2854));
		result = n;
	}
	LA3: ;
