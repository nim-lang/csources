...
((NI) 41)}
;
STRING_LITERAL(TMP3721, "system.nim", 10);
STRING_LITERAL(TMP4538, "", 0);
STRING_LITERAL(TMP4539, "nim", 3);
...
N_NIMCALL(void, compilesystemmodule_531856)(void) {
	{
		...
		LOC5 = 0;
		LOC5 = HEX2F_118465(libpath_160198, ((NimStringDesc*) &TMP3721));
...
N_NIMCALL(void, wantmainmodule_531871)(void) {
	NimStringDesc* LOC5;
	{
		...
		fatal_187066(gcmdlineinfo_183045, ((NU16) 191), ((NimStringDesc*) &TMP4538));
	}
	LA3: ;
	LOC5 = 0;
	LOC5 = nosaddFileExt(gprojectfull_160201, ((NimStringDesc*) &TMP4539));
...
N_NIMCALL(void, compileproject_531877)(NI32 projectfileidx) {
	...
	LOC1 = 0;
	LOC1 = HEX2F_118465(libpath_160198, ((NimStringDesc*) &TMP3721));
...
N_NIMCALL(Tsym214822*, makestdinmodule_531889)(void) {
	Tsym214822* result;
	result = 0;
	result = makemodule_531884(((NimStringDesc*) &TMP5256));
	return result;
}
