...
STRING_LITERAL(TMP1973, "This function cannot be used on non-blocking sockets.", 53);
STRING_LITERAL(TMP1974, "Could not send all data.", 24);
TNimNode* NimDT_182607_isbuffered[3];
STRING_LITERAL(TMP4839, "", 0);
STRING_LITERAL(TMP4841, "Call to \'", 9);
STRING_LITERAL(TMP4842, "\' timed out.", 12);
STRING_LITERAL(TMP4844, "readLine", 8);
...
N_NIMCALL(void, send_193008)(tsocketimpl182607* socket, NimStringDesc* data) {
	NI sent;
	{
		...
		LOC5 = 0;
		LOC5 = (*e_193014).Sup.message; (*e_193014).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1973));
	...
	LA8: ;
	{
		...
		LOC15 = 0;
		LOC15 = (*e_193203).Sup.Sup.message; (*e_193203).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1974));
...
N_NIMCALL(void, acceptaddr_185248)(tsocketimpl182607* server, tsocketimpl182607** client, NimStringDesc** address) {
	...
	sock_185260 = accept((*server).Fd, ((struct sockaddr*) (&sockaddress_185256)), &addrlen_185258);
	{
		...
		err_185262 = oslasterror_114641();
		{
			...
			unsureAsgnRef((void**) &(*address), copyString(((NimStringDesc*) &TMP4839)));
			goto BeforeRet;
		}
		goto LA5;
		LA9: ;
...
N_NIMCALL(void, accept_186401)(tsocketimpl182607* server, tsocketimpl182607** client) {
	...
	addrdummy = copyString(((NimStringDesc*) &TMP4839));
...
N_NIMCALL(void, readline_191447)(tsocketimpl182607* socket, NimStringDesc** line, NI timeout) {
	...
	(*line) = setLengthStr((*line), 0);
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_190617(socket, &waited, timeout, 1, ((NimStringDesc*) &TMP4844));
			...
			LA4: ;
			{
				...
				LOC15 = 0;
				LOC15 = waitfor_190617(socket, &waited, timeout, 1, ((NimStringDesc*) &TMP4844));
...
appendString((*line), ((NimStringDesc*) &TMP4845));
				}
				LA28: ;
				goto BeforeRet;
			}
...
TMP126[3].len = 3; TMP126[3].kind = 2; TMP126[3].sons = &TMP4835[0];
