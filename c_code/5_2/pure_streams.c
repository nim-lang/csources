...
N_NIMCALL(void, writeln_142778)(tstream142629* s, NimStringDesc** args, NI argsLen0) {
	...
	write_142772(s, ((NimStringDesc*) &TMP922));	popFrame();
}
N_NIMCALL(NIM_CHAR, readchar_142808)(tstream142629* s) {
	NIM_CHAR result;
...
N_NIMCALL(void, read_142821)(tstream142629* s, NIM_BOOL* result) {
	...
	nimln(117, "streams.nim");
	{
		...
		LOC6 = 0;
		LOC6 = neweio_142607(((NimStringDesc*) &TMP923));
		nimln(118, "streams.nim");
...
N_NIMCALL(NI, ssreaddata_143038)(tstream142629* s_143040, void* buffer, NI buflen) {
	...
	result = ((buflen <= (NI64)(TMP927)) ? buflen : (NI64)(TMP927));
...
N_NIMCALL(void, fswritedata_143161)(tstream142629* s, void* buffer, NI buflen) {
	...
	nimln(260, "streams.nim");
	{
		...
		LOC6 = 0;
		LOC6 = neweio_142607(((NimStringDesc*) &TMP930));
		nimln(261, "streams.nim");
		raiseException((E_Base*)LOC6, "EIO");
	}	LA4: ;
	popFrame();
...
NTI142630.flags = 3;
TMP920[1].kind = 1;
TMP920[1].offset = offsetof(tstream142629, Closeimpl);
TMP920[1].typ = (&NTI142630);
...
NTI142634.flags = 3;
TMP920[2].kind = 1;
TMP920[2].offset = offsetof(tstream142629, Atendimpl);
TMP920[2].typ = (&NTI142634);
...
NTI142638.flags = 3;
TMP920[3].kind = 1;
TMP920[3].offset = offsetof(tstream142629, Setpositionimpl);
TMP920[3].typ = (&NTI142638);
...
NTI142643.flags = 3;
TMP920[4].kind = 1;
TMP920[4].offset = offsetof(tstream142629, Getpositionimpl);
TMP920[4].typ = (&NTI142643);
...
NTI142647.flags = 3;
TMP920[5].kind = 1;
TMP920[5].offset = offsetof(tstream142629, Readdataimpl);
TMP920[5].typ = (&NTI142647);
...
NTI142653.flags = 3;
TMP920[6].kind = 1;
TMP920[6].offset = offsetof(tstream142629, Writedataimpl);
TMP920[6].typ = (&NTI142653);
...
NTI142659.flags = 3;
TMP920[7].kind = 1;
TMP920[7].offset = offsetof(tstream142629, Flushimpl);
TMP920[7].typ = (&NTI142659);
TMP920[7].name = "flushImpl";
TMP920[0].len = 7; TMP920[0].kind = 2; TMP920[0].sons = &TMP925[0];
NTI142629.node = &TMP920[0];
