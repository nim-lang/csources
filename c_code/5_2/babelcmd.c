...
STRING_LITERAL(TMP1428, "head", 4);
STRING_LITERAL(TMP1431, ".", 1);
STRING_LITERAL(TMP1432, "..", 2);
STRING_LITERAL(TMP1436, ".nim", 4);
...
N_NIMCALL(NIM_BOOL, HEX3CHEX2E_175054)(NimStringDesc* a, NimStringDesc* b) {
	...
	{
		nimln(28, "babelcmd.nim");
		if (!eqStrings(a, ((NimStringDesc*) &TMP1428))) goto LA3;
		nimln(28, "babelcmd.nim");
		nimln(28, "babelcmd.nim");
		result = NIM_FALSE;
		goto BeforeRet;
...
N_NIMCALL(void, addpackage_175137)(tstringtable122810* packages, NimStringDesc* p) {
	...
	nimln(48, "babelcmd.nim");
	TMP1429 = subInt(x, 1);
	name = copyStrLast(p, 0, (NI64)(TMP1429));
	nimln(49, "babelcmd.nim");
	{
		...
		nimln(50, "babelcmd.nim");
		TMP1430 = addInt(x, 1);
		version = copyStr(p, (NI64)(TMP1430));
	...
	LA3: ;
	{
		...
		nstPut(packages, name, ((NimStringDesc*) &TMP1428));
	}
	LA1: ;
	popFrame();
}
	...
	nimln(1263, "os.nim");
	{
		...
		while (1) {
			...
			nimln(1268, "os.nim");
			{
				...
				nimln(1268, "os.nim");
				nimln(1268, "os.nim");
				LOC12 = !(eqStrings(y_175194, ((NimStringDesc*) &TMP1431)));
				if (!(LOC12)) goto LA13;
				nimln(1268, "os.nim");
				nimln(1268, "os.nim");
				LOC12 = !(eqStrings(y_175194, ((NimStringDesc*) &TMP1432)));
				LA13: ;
				if (!LOC12) goto LA14;
				...
				nimln(69, "babelcmd.nim");
				{
					...
					if (!(LOC33)) goto LA34;
					nimln(69, "babelcmd.nim");
					LOC33 = nsuEndsWith(path_175179, ((NimStringDesc*) &TMP1436));
					LA34: ;
					if (!LOC33) goto LA35;
