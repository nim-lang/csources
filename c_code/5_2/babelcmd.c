...
STRING_LITERAL(TMP1423, "head", 4);
STRING_LITERAL(TMP1426, ".", 1);
STRING_LITERAL(TMP1427, "..", 2);
STRING_LITERAL(TMP1431, ".nim", 4);
...
N_NIMCALL(void, addpackage_170137)(tstringtable120810* packages, NimStringDesc* p) {
	...
	nimln(48, "babelcmd.nim");
	TMP1424 = subInt(x, 1);
	name = copyStrLast(p, 0, (NI64)(TMP1424));
	nimln(49, "babelcmd.nim");
	{
		...
		nimln(50, "babelcmd.nim");
		TMP1425 = addInt(x, 1);
		version = copyStr(p, (NI64)(TMP1425));
	...
	LA3: ;
	{
		...
		nstPut(packages, name, ((NimStringDesc*) &TMP1423));
	}
	LA1: ;
	popFrame();
}
	...
	nimln(1263, "os.nim");
	{
		...
		while (1) {
			...
			nimln(1268, "os.nim");
			{
				...
				nimln(1268, "os.nim");
				nimln(1268, "os.nim");
				LOC12 = !(eqStrings(y_170194, ((NimStringDesc*) &TMP1426)));
				if (!(LOC12)) goto LA13;
				nimln(1268, "os.nim");
				nimln(1268, "os.nim");
				LOC12 = !(eqStrings(y_170194, ((NimStringDesc*) &TMP1427)));
				LA13: ;
				if (!LOC12) goto LA14;
				...
				nimln(69, "babelcmd.nim");
				{
					...
					if (!(LOC33)) goto LA34;
					nimln(69, "babelcmd.nim");
					LOC33 = nsuEndsWith(path_170179, ((NimStringDesc*) &TMP1431));
					LA34: ;
					if (!LOC33) goto LA35;
		...
		nimln(1263, "os.nim");
		{
			...
			while (1) {
				...
				nimln(1268, "os.nim");
				{
					...
					nimln(1268, "os.nim");
					nimln(1268, "os.nim");
					LOC18 = !(eqStrings(y_170208, ((NimStringDesc*) &TMP1426)));
					if (!(LOC18)) goto LA19;
					nimln(1268, "os.nim");
					nimln(1268, "os.nim");
					LOC18 = !(eqStrings(y_170208, ((NimStringDesc*) &TMP1427)));
					LA19: ;
					if (!LOC18) goto LA20;
...
N_NIMCALL(void, addpathrec_170216)(NimStringDesc* dir, tlineinfo161527 info) {
	...
	nimln(1263, "os.nim");
	{
		...
		while (1) {
			...
			nimln(1268, "os.nim");
			{
				...
				nimln(1268, "os.nim");
				nimln(1268, "os.nim");
				LOC16 = !(eqStrings(y_170269, ((NimStringDesc*) &TMP1426)));
				if (!(LOC16)) goto LA17;
				nimln(1268, "os.nim");
				nimln(1268, "os.nim");
				LOC16 = !(eqStrings(y_170269, ((NimStringDesc*) &TMP1427)));
				LA17: ;
				if (!LOC16) goto LA18;
	...
	while (1) {
		...
		nimln(41, "strtabs.nim");
		{
			...
			{
				nimln(58, "babelcmd.nim");
				if (!eqStrings(val_170277, ((NimStringDesc*) &TMP1423))) goto LA49;
