...
N_NIMCALL(NIM_BOOL, endswithopr_161437)(NimStringDesc* x) {
	...
	result = endswith_161402(x, TMP1607);
	popFrame();
	return result;
}
static N_INLINE(NIM_BOOL, continueline_161443)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_161402(line, TMP1608);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(NI, counttriples_161462)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1609 = addInt(i, 1);
			if ((NU)((NI64)(TMP1609)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI64)(TMP1609)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1610 = addInt(i, 2);
			if ((NU)((NI64)(TMP1610)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI64)(TMP1610)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
appendString((*s).S, ((NimStringDesc*) &TMP1613));
	...
	result = ((buflen <= (NI64)(TMP1614)) ? buflen : (NI64)(TMP1614));
...
N_NIMCALL(NI, llstreamread_161242)(tllstream161204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		result = ((buflen <= (NI64)(TMP1615)) ? buflen : (NI64)(TMP1615));
		nimln(136, "llstream.nim");
		{
			...
			if ((NU)((NI64)(TMP1616)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI64)(TMP1616)])), result);			nimln(138, "llstream.nim");
			(*s).Rd = addInt((*s).Rd, result);
		}		LA5: ;
	}	break;
	case ((NU8) 2):
...
N_NIMCALL(void, llstreamwriteln_161274)(tllstream161204* s, NimStringDesc* data) {
	...
	llstreamwrite_161258(s, ((NimStringDesc*) &TMP1613));	popFrame();
}
N_NIMCALL(void, llstreamwrite_161263)(tllstream161204* s, NIM_CHAR data) {
	NIM_CHAR c;
	nimfr("LLStreamWrite", "llstream.nim")
...
N_NIMCALL(void, llstreamwrite_161268)(tllstream161204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			(*s).S = setLengthStr((*s).S, (NI64)(TMP1617));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1618 = addInt(0, (*s).Wr);
			if ((NU)((NI64)(TMP1618)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI64)(TMP1618)])), buf, buflen);			nimln(202, "llstream.nim");
...
N_NIMCALL(NimStringDesc*, llstreamreadall_161254)(tllstream161204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI64)(TMP1619));
			nimln(223, "llstream.nim");
			nimln(223, "llstream.nim");
			TMP1620 = addInt(i, 0);
			if ((NU)((NI64)(TMP1620)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_9514((*s).F, ((void*) (&result->data[(NI64)(TMP1620)])), 2048);
...
NTI161202.node = &TMP1598[6];
TMP1598[1].kind = 1;
TMP1598[1].offset = offsetof(tllstream161204, Kind);
TMP1598[1].typ = (&NTI161202);
TMP1598[1].name = "kind";
TMP1600[1] = &TMP1598[7];
TMP1598[7].kind = 1;
TMP1598[7].offset = offsetof(tllstream161204, F);
TMP1598[7].typ = (&NTI9004);
TMP1598[7].name = "f";
TMP1600[2] = &TMP1598[8];
TMP1598[8].kind = 1;
TMP1598[8].offset = offsetof(tllstream161204, S);
TMP1598[8].typ = (&NTI142);
TMP1598[8].name = "s";
TMP1600[3] = &TMP1598[9];
TMP1598[9].kind = 1;
TMP1598[9].offset = offsetof(tllstream161204, Rd);
TMP1598[9].typ = (&NTI105);
TMP1598[9].name = "rd";
TMP1600[4] = &TMP1598[10];
TMP1598[10].kind = 1;
TMP1598[10].offset = offsetof(tllstream161204, Wr);
TMP1598[10].typ = (&NTI105);
TMP1598[10].name = "wr";
TMP1600[5] = &TMP1598[11];
TMP1598[11].kind = 1;
TMP1598[11].offset = offsetof(tllstream161204, Lineoffset);
TMP1598[11].typ = (&NTI105);
TMP1598[11].name = "lineOffset";
TMP1598[0].len = 6; TMP1598[0].kind = 2; TMP1598[0].sons = &TMP1600[0];
NTI161204.node = &TMP1598[0];
NTI161206.size = sizeof(tllstream161204*);
NTI161206.kind = 22;
NTI161206.base = (&NTI161204);
NTI161206.flags = 2;
NTI161206.marker = TMP1604;
}
