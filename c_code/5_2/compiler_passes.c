...
static NIM_CONST TY171865 TMP3128 = {
...
NTI222003.flags = 3;
TMP3016[0].kind = 1;
TMP3016[0].offset = offsetof(tpasscontext222003, Fromcache);
TMP3016[0].typ = (&NTI133);
TMP3016[0].name = "fromCache";
NTI222003.node = &TMP3016[0];
}
