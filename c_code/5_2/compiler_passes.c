...
STRING_LITERAL(TMP1447, "stdinfile", 9);
...
{	memset((void*)(&p), 0, sizeof(p));
	...
	fileidx = ((NI32) ((*module).Position));
	{
		...
		openpasses_256292(a, module);
		{
			...
			{
				NimStringDesc* LOC13;
				if (!eqStrings((*(*module).Name).S, ((NimStringDesc*) &TMP1446))) goto LA11;
				LOC13 = 0;
				LOC13 = (*(*module).Name).S; (*(*module).Name).S = copyStringRC1(((NimStringDesc*) &TMP1447));
