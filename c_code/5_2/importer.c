...
STRING_LITERAL(TMP3296, "as", 2);
STRING_LITERAL(TMP3297, " ", 1);
STRING_LITERAL(TMP3298, ".", 1);
STRING_LITERAL(TMP3299, "/", 1);
STRING_LITERAL(TMP3300, "invalid module name: \'$1\'", 25);
STRING_LITERAL(TMP3301, "module alias must be an identifier", 34);
STRING_LITERAL(TMP3302, "A module cannot import itself", 29);
STRING_LITERAL(TMP3303, "importAllSymbols: ", 18);
STRING_LITERAL(TMP3304, "rawImportSymbol", 15);
STRING_LITERAL(TMP3306, "importSymbol: 2", 15);
STRING_LITERAL(TMP3307, "importSymbol: 3", 15);
...
N_NIMCALL(NimStringDesc*, getmodulename_297018)(tnode224819* n) {
	...
	case ((NU8) 22):
	{
		result = nosunixToNativePath((*n).kindU.S3.Strval, ((NimStringDesc*) &TMP3295));
	}
	break;
	case ((NU8) 2):
	{
	...
	case ((NU8) 29):
	{
		NimStringDesc* LOC12;
		{
			...
			if (!(LOC7)) goto LA8;
			LOC9 = 0;
			LOC9 = getident_200472(((NimStringDesc*) &TMP3296));
		...
		result = nsuReplaceStr(LOC12, ((NimStringDesc*) &TMP3297), ((NimStringDesc*) &TMP3295));
	}
	break;
	case ((NU8) 45):
	{
		...
		result = nsuReplaceStr(LOC14, ((NimStringDesc*) &TMP3298), ((NimStringDesc*) &TMP3299));
	}
	break;
	case ((NU8) 78):
	{
	...
	default:
	{
		...
		LOC18 = 0;
		LOC18 = nsuFormatSingleElem(((NimStringDesc*) &TMP3300), LOC17);
				...
				res_297427 = 0;
				{
					while (1) {
						...
						e = (*(*(*etyp).N).kindU.S6.Sons->data[j_297336]).kindU.S4.Sym;
						{
							...
							internalerror_197970((*s).Info, ((NimStringDesc*) &TMP3304));
						}
						LA27: ;
