...
static N_INLINE(NIM_BOOL, mustrehash_188058)(NI length, NI counter) {
	...
	LOC5 = ((NI64)(TMP1944) < (NI64)(TMP1945));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
...
static N_INLINE(NI, nexttry_188206)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1947 = mulInt(5, h);
	TMP1948 = addInt((NI64)(TMP1947), 1);
	result = (NI)((NI64)(TMP1948) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, intsetenlarge_188621)(tintset188047* t) {
	...
	TMP1952 = mulInt((NI64)(TMP1951), 2);
	TMP1953 = subInt((NI64)(TMP1952), 1);
	(*t).Max = (NI64)(TMP1953);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1954 = addInt((*t).Max, 1);
	n = (ttrunkseq188045*) newSeq((&NTI188045), (NI64)(TMP1954));
	i_188655 = 0;
...
N_NIMCALL(ttrunk188043*, intsetput_188696)(tintset188047* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_188058((NI64)(TMP1958), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
