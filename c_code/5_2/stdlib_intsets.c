...
static N_INLINE(NIM_BOOL, mustrehash_182058)(NI length, NI counter) {
	...
	LOC5 = ((NI64)(TMP1938) < (NI64)(TMP1939));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
...
static N_INLINE(NI, nexttry_182206)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1941 = mulInt(5, h);
	TMP1942 = addInt((NI64)(TMP1941), 1);
	result = (NI)((NI64)(TMP1942) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, intsetenlarge_182621)(tintset182047* t) {
	...
	TMP1946 = mulInt((NI64)(TMP1945), 2);
	TMP1947 = subInt((NI64)(TMP1946), 1);
	(*t).Max = (NI64)(TMP1947);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1948 = addInt((*t).Max, 1);
	n = (ttrunkseq182045*) newSeq((&NTI182045), (NI64)(TMP1948));
	i_182655 = 0;
...
N_NIMCALL(ttrunk182043*, intsetput_182696)(tintset182047* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_182058((NI64)(TMP1952), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
