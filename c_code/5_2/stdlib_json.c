...
N_NIMCALL(void, nl_339305)(NimStringDesc** s, NIM_BOOL ml) {
	{
		if (!ml) goto LA3;
		(*s) = resizeString((*s), 1);
appendString((*s), ((NimStringDesc*) &TMP4738));
	}
	LA3: ;
}
...
N_NIMCALL(NimStringDesc*, pretty_339621)(jsonnodeobj335042* node, NI indent) {
	NimStringDesc* result;
	result = 0;
	result = copyString(((NimStringDesc*) &TMP4737));
...
static TNimNode* TMP4726[7];
NI TMP4728;
static char* NIM_CONST TMP4727[7] = {
"JNull", 
"JBool", 
"JInt", 
"JFloat", 
...
NTI335038.base = 0;
NTI335038.flags = 3;
for (TMP4728 = 0; TMP4728 < 7; TMP4728++) {
TMP876[TMP4728+1].kind = 1;
TMP876[TMP4728+1].offset = TMP4728;
TMP876[TMP4728+1].name = TMP4727[TMP4728];
TMP4726[TMP4728] = &TMP876[TMP4728+1];
}
TMP876[8].len = 7; TMP876[8].kind = 2; TMP876[8].sons = &TMP4726[0];
...
TMP876[15].len = 2; TMP876[15].kind = 2; TMP876[15].sons = &TMP4729[0];
NTI335611.node = &TMP876[15];
NTI335057.size = sizeof(TY335057*);
NTI335057.kind = 24;
NTI335057.base = (&NTI335611);
NTI335057.flags = 2;
NTI335057.marker = TMP4730;
TMP876[14].kind = 1;
