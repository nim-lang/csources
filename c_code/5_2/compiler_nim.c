...
STRING_LITERAL(TMP4983, "stdinfile", 9);
STRING_LITERAL(TMP4984, "./", 2);
STRING_LITERAL(TMP4985, "js", 2);
STRING_LITERAL(TMP4988, " ", 1);
...
appendString(LOC7, ((NimStringDesc*) &TMP4984));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
	...
	LA4: ;
	{
		...
		LA20: ;
		{
			if (!(gerrorcounter_181015 == ((NI) 0))) goto LA25;
			{
				...
				{
					NimStringDesc* LOC35;
					if (!eqStrings(gprojectname_169234, ((NimStringDesc*) &TMP4982))) goto LA33;
					LOC35 = 0;
					LOC35 = gprojectfull_169236; gprojectfull_169236 = copyStringRC1(((NimStringDesc*) &TMP4983));
				...
				LA33: ;
				{
					...
					LA42: ;
					{
						...
						NimStringDesc* LOC48;
						LOC46 = 0;
						LOC46 = noschangeFileExt(gprojectfull_169236, ((NimStringDesc*) &TMP4985));
						LOC47 = 0;
...
appendString(LOC49, ((NimStringDesc*) &TMP4988));
