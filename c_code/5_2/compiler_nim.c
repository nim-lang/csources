...
STRING_LITERAL(TMP1925, "nim.cfg", 7);
STRING_LITERAL(TMP4896, "./", 2);
STRING_LITERAL(TMP4897, "js", 2);
...
appendString(LOC7, ((NimStringDesc*) &TMP4896));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
N_NIMCALL(void, handlecmdline_558607)(void) {
	...
	LA4: ;
	{
		processcmdline_552209(((NU8) 0), ((NimStringDesc*) &TMP1896));
		{
			TSafePoint TMP1897;
			TY118604 p;
			NimStringDesc* LOC15;
			...
			pushSafePoint(&TMP1897);
			TMP1897.status = _setjmp(TMP1897.context);
			if (TMP1897.status == 0) {
			...
			if (TMP1897.status != 0) reraiseException();
		...
		LA7: ;
		loadconfigs_204811(((NimStringDesc*) &TMP1925));
		initvars_187817();
		processcmdline_552209(((NU8) 1), ((NimStringDesc*) &TMP1896));
		maincommand_555627();
		{
			NimStringDesc* LOC22;
			...
			if (!(gerrorcounter_182118 == 0)) goto LA25;
			{
				if (!((gglobaloptions_170128 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				{
					...
					LA37: ;
					{
						...
						NimStringDesc* LOC43;
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_170239, ((NimStringDesc*) &TMP4897));
						LOC42 = 0;
...
appendString(LOC44, ((NimStringDesc*) &TMP4900));
appendString(LOC44, ex);
appendChar(LOC44, 32);
appendString(LOC44, arguments_195081);
					execexternalprogram_187929(LOC44, ((NimStringDesc*) &TMP1896));
				}
				goto LA31;
				LA33: ;
				{
					...
					LA49: ;
					{
						NimStringDesc* LOC52;
						LOC52 = 0;
						LOC52 = noschangeFileExt(gprojectfull_170239, ((NimStringDesc*) &TMP1896));
...
appendString(LOC53, arguments_195081);
					execexternalprogram_187929(LOC53, ((NimStringDesc*) &TMP1896));
				}
				LA31: ;
			}
			LA29: ;
