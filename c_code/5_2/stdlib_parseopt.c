...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY123387 TMP7635 = {
...
appendChar(LOC7, 32);
	...
	unsureAsgnRef((void**) &(*Result).Key, copyString(((NimStringDesc*) &TMP7633)));
	nimln(57, "parseopt.nim");
	unsureAsgnRef((void**) &(*Result).Val, copyString(((NimStringDesc*) &TMP7633)));
	popFrame();
}
...
N_NIMCALL(void, handleshortoption_528106)(toptparser527807* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_528002((*p).Cmd, i, &(*p).Val, TMP7634);
	}
	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser527807* p) {
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_528002((*p).Cmd, i, &(*p).Key, TMP7635);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_528002((*p).Cmd, i, &(*p).Val, TMP7634);
			}
			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_528002((*p).Cmd, i, &(*p).Key, TMP7634);
	}
	break;
	}
	BeforeRet: ;
...
static TNimNode* TMP7638[6];
static TNimNode* TMP7639[4];
NI TMP7641;
static char* NIM_CONST TMP7640[4] = {
"cmdEnd", 
"cmdArgument", 
"cmdLongoption", 
"cmdShortOption"};
...
TMP7638[0] = &TMP7628[1];
TMP7628[1].kind = 1;
TMP7628[1].offset = offsetof(toptparser527807, Cmd);
TMP7628[1].typ = (&NTI143);
TMP7628[1].name = "cmd";
TMP7638[1] = &TMP7628[2];
TMP7628[2].kind = 1;
TMP7628[2].offset = offsetof(toptparser527807, Pos);
TMP7628[2].typ = (&NTI106);
TMP7628[2].name = "pos";
TMP7638[2] = &TMP7628[3];
TMP7628[3].kind = 1;
TMP7628[3].offset = offsetof(toptparser527807, Inshortstate);
...
NTI527805.base = 0;
NTI527805.flags = 3;
for (TMP7641 = 0; TMP7641 < 4; TMP7641++) {
TMP7628[TMP7641+5].kind = 1;
TMP7628[TMP7641+5].offset = TMP7641;
TMP7628[TMP7641+5].name = TMP7640[TMP7641];
TMP7639[TMP7641] = &TMP7628[TMP7641+5];
}
TMP7628[9].len = 4; TMP7628[9].kind = 2; TMP7628[9].sons = &TMP7639[0];
NTI527805.node = &TMP7628[9];
TMP7628[4].kind = 1;
TMP7628[4].offset = offsetof(toptparser527807, Kind);
TMP7628[4].typ = (&NTI527805);
TMP7628[4].name = "kind";
TMP7638[4] = &TMP7628[10];
TMP7628[10].kind = 1;
TMP7628[10].offset = offsetof(toptparser527807, Key);
TMP7628[10].typ = (&NTI143);
TMP7628[10].name = "key";
TMP7638[5] = &TMP7628[11];
TMP7628[11].kind = 1;
TMP7628[11].offset = offsetof(toptparser527807, Val);
TMP7628[11].typ = (&NTI143);
TMP7628[11].name = "val";
TMP7628[0].len = 6; TMP7628[0].kind = 2; TMP7628[0].sons = &TMP7638[0];
NTI527807.node = &TMP7628[0];
}
