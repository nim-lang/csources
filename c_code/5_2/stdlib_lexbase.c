...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3623, "L.sentinel < L.bufLen ", 22);
STRING_LITERAL(TMP3626, "toCopy >= 0 ", 12);
STRING_LITERAL(TMP3634, "s < L.bufLen ", 13);
STRING_LITERAL(TMP3638, "L.bufLen - oldBufLen == oldBufLen ", 34);
STRING_LITERAL(TMP3644, "pos <= L.sentinel ", 18);
STRING_LITERAL(TMP3646, "L.buf[pos] == \'\\x0D\' ", 21);
STRING_LITERAL(TMP3647, "L.buf[pos] == \'\\x0A\' ", 21);
STRING_LITERAL(TMP3648, "bufLen > 0 ", 11);
STRING_LITERAL(TMP3649, "input != nil ", 13);
STRING_LITERAL(TMP3653, "", 0);
STRING_LITERAL(TMP3654, "\012", 1);
STRING_LITERAL(TMP3655, "^\012", 2);
...
N_NIMCALL(void, fillbuffer_282084)(tbaselexer282029* l) {
	...
	nimln(80, "lexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP3627)])), (NI64)(TMP3628));
	}
	LA11: ;
	...
	TMP3630 = mulInt((NI64)(TMP3629), 1);
	LOC13 = 0;
	LOC13 = readdata_125733((*l).Input, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP3630));
	...
	nimln(86, "lexbase.nim");
	{
		...
		if (!(charsread < (NI64)(TMP3633))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI64)(TMP3635);
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				TMP3636 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4631(((void*) ((*l).Buf)), (NI64)(TMP3636));
				...
				nimln(105, "lexbase.nim");
				{
					...
					if (!!(((NI64)(TMP3637) == oldbuflen))) goto LA35;
					nimln(105, "lexbase.nim");
				...
				LOC37 = 0;
				LOC37 = readdata_125733((*l).Input, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP3639));
				TMP3640 = divInt(LOC37, 1);
				charsread = (NI64)(TMP3640);
...
N_NIMCALL(void, open_282039)(tbaselexer282029* l, tstream125629* input, NI buflen) {
	...
	LOC9 = 0;
	LOC9 = alloc_4601((NI64)(TMP3650));
	(*l).Buf = ((NCSTRING) (LOC9));
	nimln(148, "lexbase.nim");
	nimln(148, "lexbase.nim");
	TMP3651 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP3651);
...
N_NIMCALL(NI, getcolnumber_282057)(tbaselexer282029* l, NI pos) {
	...
	nimln(155, "lexbase.nim");
	nimln(155, "lexbase.nim");
	TMP3652 = subInt(pos, (*l).Linestart);
	if ((NI64)(TMP3652) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP3652));
	popFrame();
	return result;
}
...
N_NIMCALL(NimStringDesc*, getcurrentline_282052)(tbaselexer282029* l, NIM_BOOL marker) {
	...
	result = copyString(((NimStringDesc*) &TMP3653));
...
appendString(LOC6, ((NimStringDesc*) &TMP3655));
...
static TNimNode* TMP3763[8];
static TNimNode TMP3621[9];
NTI282029.size = sizeof(tbaselexer282029);
NTI282029.kind = 17;
NTI282029.base = (&NTI2409);
TMP3763[0] = &TMP3621[1];
TMP3621[1].kind = 1;
TMP3621[1].offset = offsetof(tbaselexer282029, Bufpos);
TMP3621[1].typ = (&NTI106);
TMP3621[1].name = "bufpos";
TMP3763[1] = &TMP3621[2];
TMP3621[2].kind = 1;
TMP3621[2].offset = offsetof(tbaselexer282029, Buf);
TMP3621[2].typ = (&NTI145);
TMP3621[2].name = "buf";
TMP3763[2] = &TMP3621[3];
TMP3621[3].kind = 1;
TMP3621[3].offset = offsetof(tbaselexer282029, Buflen);
TMP3621[3].typ = (&NTI106);
TMP3621[3].name = "bufLen";
TMP3763[3] = &TMP3621[4];
TMP3621[4].kind = 1;
TMP3621[4].offset = offsetof(tbaselexer282029, Input);
TMP3621[4].typ = (&NTI125627);
TMP3621[4].name = "input";
TMP3763[4] = &TMP3621[5];
TMP3621[5].kind = 1;
TMP3621[5].offset = offsetof(tbaselexer282029, Linenumber);
TMP3621[5].typ = (&NTI106);
TMP3621[5].name = "lineNumber";
TMP3763[5] = &TMP3621[6];
TMP3621[6].kind = 1;
TMP3621[6].offset = offsetof(tbaselexer282029, Sentinel);
TMP3621[6].typ = (&NTI106);
TMP3621[6].name = "sentinel";
TMP3763[6] = &TMP3621[7];
TMP3621[7].kind = 1;
TMP3621[7].offset = offsetof(tbaselexer282029, Linestart);
TMP3621[7].typ = (&NTI106);
TMP3621[7].name = "lineStart";
TMP3763[7] = &TMP3621[8];
TMP3621[8].kind = 1;
TMP3621[8].offset = offsetof(tbaselexer282029, Fileopened);
TMP3621[8].typ = (&NTI134);
TMP3621[8].name = "fileOpened";
TMP3621[0].len = 8; TMP3621[0].kind = 2; TMP3621[0].sons = &TMP3763[0];
NTI282029.node = &TMP3621[0];
}
