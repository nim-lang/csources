...
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3578, "strVal", 6);
static NIM_CONST TY192025 TMP3579 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3580, "sons", 4);
static NIM_CONST TY192025 TMP3581 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3582, "ident", 5);
STRING_LITERAL(TMP3583, "|", 1);
STRING_LITERAL(TMP3584, "&", 1);
STRING_LITERAL(TMP3585, "~", 1);
STRING_LITERAL(TMP3586, "atom", 4);
STRING_LITERAL(TMP3587, "lit", 3);
STRING_LITERAL(TMP3588, "sym", 3);
STRING_LITERAL(TMP3589, "ident", 5);
STRING_LITERAL(TMP3590, "call", 4);
STRING_LITERAL(TMP3591, "alias", 5);
STRING_LITERAL(TMP3592, "noalias", 7);
STRING_LITERAL(TMP3593, "lvalue", 6);
STRING_LITERAL(TMP3594, "local", 5);
STRING_LITERAL(TMP3595, "sideeffect", 10);
STRING_LITERAL(TMP3596, "nosideeffect", 12);
STRING_LITERAL(TMP3598, "parampatterns.nim", 17);
NIM_CONST TY131008 TMP3597 = {((NimStringDesc*) &TMP3598),
100}
;
NIM_CONST TY131008 TMP3599 = {((NimStringDesc*) &TMP3598),
107}
;
STRING_LITERAL(TMP3600, "p.kind == nkCurlyExpr ", 22);
STRING_LITERAL(TMP3601, "parameter pattern too complex", 29);
static NIM_CONST TY192025 TMP3602 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3603, "sym", 3);
...
N_NIMCALL(NU8, whichalias_280061)(tsym191843* p) {
	...
	nimln(51, "parampatterns.nim");
	{
		...
		nimln(52, "parampatterns.nim");
		if (!(((TMP3577[(*(*p).Constraint).Kind/8] &(1<<((*(*p).Constraint).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3578));
...
static N_INLINE(NI, len_192274)(tnode191813* n) {
	...
	{
		nimln(957, "ast.nim");
		if (((TMP3579[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3580));
...
N_NIMCALL(void, compileconstraints_280106)(tnode191813* p, NimStringDesc** result) {
	...
	case ((NU8) 32):
	{
		...
		if (((TMP3579[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3580));
		if ((NU)(0) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3581[(*(*p).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*p).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3582));
		...
		nimln(63, "parampatterns.nim");
		{
			...
			nimln(64, "parampatterns.nim");
			{
				...
				LOC13 = 0;
				nimln(64, "parampatterns.nim");
				LOC13 = eqStrings((*op).S, ((NimStringDesc*) &TMP3583));
				if (LOC13) goto LA14;
				nimln(64, "parampatterns.nim");
				LOC13 = ((*op).Sup.Id == 47);
				LA14: ;
			...
			LA15: ;
			{
				...
				LOC18 = 0;
				nimln(68, "parampatterns.nim");
				LOC18 = eqStrings((*op).S, ((NimStringDesc*) &TMP3584));
				if (LOC18) goto LA19;
				nimln(68, "parampatterns.nim");
				LOC18 = ((*op).Sup.Id == 2);
				LA19: ;
		...
		LA9: ;
		{
			...
			LOC27 = 0;
			nimln(74, "parampatterns.nim");
			LOC27 = eqStrings((*op).S, ((NimStringDesc*) &TMP3585));
			if (LOC27) goto LA28;
			nimln(74, "parampatterns.nim");
			LOC27 = ((*op).Sup.Id == 43);
			LA28: ;
	...
	case ((NU8) 2):
	{
		...
		case 2: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3596))) goto LA50;
break;
		case 4: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3588))) goto LA42;
if (eqStrings(spec, ((NimStringDesc*) &TMP3593))) goto LA47;
if (eqStrings(spec, ((NimStringDesc*) &TMP3595))) goto LA49;
break;
		case 6: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3589))) goto LA43;
break;
		case 10: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3592))) goto LA46;
break;
		case 11: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3586))) goto LA40;
break;
		case 12: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3587))) goto LA41;
break;
		case 13: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3590))) goto LA44;
break;
		case 14: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3591))) goto LA45;
if (eqStrings(spec, ((NimStringDesc*) &TMP3594))) goto LA48;
break;
		}
		goto LA51;
		LA40: ;
...
N_NIMCALL(tnode191813*, semnodekindconstraints_280472)(tnode191813* p) {
	...
	nimln(120, "parampatterns.nim");
	{
		...
		nimln(120, "parampatterns.nim");
		failedassertimpl_80421(((NimStringDesc*) &TMP3600));
	}
	LA3: ;
	nimln(121, "parampatterns.nim");
	result = newnodei_192109(((NU8) 20), (*p).Info);
	nimln(122, "parampatterns.nim");
	if (!(((TMP3577[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3578));
	nimln(122, "parampatterns.nim");
	...
	nimln(124, "parampatterns.nim");
	{
		...
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_168591((*p).Info, ((NimStringDesc*) &TMP3601));
		}
		LA14: ;
	}
	goto LA5;
...
N_NIMCALL(NU8, checkforsideeffects_280740)(tnode191813* n) {
	...
	case ((NU8) 32):
	{
		...
		nimln(143, "parampatterns.nim");
		{
			...
			if (!(LOC4)) goto LA5;
			nimln(143, "parampatterns.nim");
			if (!(((TMP3602[(*op).Kind/8] &(1<<((*op).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3603));
...
N_NIMCALL(NU8, isassignable_280970)(tsym191843* owner, tnode191813* n) {
	...
	case ((NU8) 45):
	{
		...
		nimln(197, "parampatterns.nim");
		{
			...
			if (!(((TMP3602[(*(*n).kindU.S6.Sons->data[1]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[1]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3603));
...
N_NIMCALL(NIM_BOOL, matchnodekinds_281344)(tnode191813* p, tnode191813* n) {
	...
	while (1) {
		...
		case ((NU8) 2):
		{
			...
			LOC4 = stack[((NI64)(TMP3605))- 0];
			if (LOC4) goto LA5;
			nimln(242, "parampatterns.nim");
			TMP3606 = subInt(sp, 2);
			if ((NU)((NI64)(TMP3606)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI64)(TMP3606))- 0];
			LA5: ;
			stack[((NI64)(TMP3604))- 0] = LOC4;
		...
		case ((NU8) 3):
		{
			...
			LOC7 = stack[((NI64)(TMP3608))- 0];
			if (!(LOC7)) goto LA8;
			nimln(245, "parampatterns.nim");
			TMP3609 = subInt(sp, 2);
			if ((NU)((NI64)(TMP3609)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI64)(TMP3609))- 0];
			LA8: ;
			stack[((NI64)(TMP3607))- 0] = LOC7;
		...
		case ((NU8) 4):
		{
			...
			stack[((NI64)(TMP3610))- 0] = !(stack[((NI64)(TMP3611))- 0]);
		}
		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(254, "parampatterns.nim");
			TMP3612 = addInt(pc, 1);
			if ((NU)((NI64)(TMP3612)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3612)])), ((NU8) 0), ((NU8) 24)));
			nimln(233, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			nimln(258, "parampatterns.nim");
			TMP3613 = addInt(pc, 1);
			if ((NU)((NI64)(TMP3613)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3613)])), ((NU8) 0), ((NU8) 156)));
			nimln(233, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
	...
	nimln(266, "parampatterns.nim");
	TMP3614 = subInt(sp, 1);
	if ((NU)((NI64)(TMP3614)) > (NU)(64)) raiseIndexError();
	result = stack[((NI64)(TMP3614))- 0];
	popFrame();
	return result;
}
