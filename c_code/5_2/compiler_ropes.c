...
typedef N_CLOSURE_PTR(void, TMP3375) (NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
typedef N_CLOSURE_PTR(void, TMP3376) (NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
typedef N_CLOSURE_PTR(void, TMP4195) (NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
	...
	num = 0;
	{
		while (1) {
			...
			if (!(i <= (NI64)(length - 1))) goto LA2;
			{
				...
				case 36:
				{
					app_178060(&result, ((NimStringDesc*) &TMP3374));
					i += 1;
				}
				break;
				case 35:
				...
				case 48 ... 57:
				{
					...
					num = j;
					{
						...
						LOC22 = 0;
						LOC22 = nimIntToStr(j);
						errorhandler_178143.ClEnv? errorhandler_178143.ClPrc(((NU8) 1), LOC22, NIM_FALSE, errorhandler_178143.ClEnv):((TMP3375)(errorhandler_178143.ClPrc))(((NU8) 1), LOC22, NIM_FALSE);
					}
					goto LA18;
					LA20: ;
					{
				...
				default:
				{
					...
					errorhandler_178143.ClEnv? errorhandler_178143.ClPrc(((NU8) 1), LOC27, NIM_FALSE, errorhandler_178143.ClEnv):((TMP3376)(errorhandler_178143.ClPrc))(((NU8) 1), LOC27, NIM_FALSE);
				}
				break;
				}
			}
...
N_NIMCALL(void, writerope_179423)(trope178009* head, NimStringDesc* filename, NIM_BOOL usewarning) {
	...
	LA4: ;
	{
		errorhandler_178143.ClEnv? errorhandler_178143.ClPrc(((NU8) 0), filename, usewarning, errorhandler_178143.ClEnv):((TMP4195)(errorhandler_178143.ClPrc))(((NU8) 0), filename, usewarning);
	}
	LA1: ;
}
