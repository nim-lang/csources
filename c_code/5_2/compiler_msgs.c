...
typedef N_CLOSURE_PTR(void, TMP2099) (NimStringDesc* output);
...
((NI) 1017)}
;
STRING_LITERAL(TMP1934, "Warnings:", 9);
STRING_LITERAL(TMP1935, "  [$1] $2", 9);
STRING_LITERAL(TMP1936, "x", 1);
STRING_LITERAL(TMP1937, " ", 1);
STRING_LITERAL(TMP1996, "Hints:", 6);
...
;
STRING_LITERAL(TMP2824, "suggest done", 12);
STRING_LITERAL(TMP3274, "(", 1);
STRING_LITERAL(TMP3275, ",", 1);
STRING_LITERAL(TMP3276, ")", 1);
NIM_CONST TY88487 TMP4016 = {((NimStringDesc*) &TMP1065),
((NI) 1024)}
;
...
N_NIMCALL(void, listwarnings_187434)(void) {
	msgwriteln_183449(((NimStringDesc*) &TMP1934), 0);
	{
		NU16 warn_187614;
		NI res_187648;
		warn_187614 = 0;
		res_187648 = ((NI) 237);
		{
			while (1) {
				...
				LOC10 = 0;
				LOC10 = nsuFormatOpenArray(((NimStringDesc*) &TMP1935), LOC4, 2);
...
N_NIMCALL(void, listhints_187651)(void) {
	msgwriteln_183449(((NimStringDesc*) &TMP1996), 0);
	{
		NU16 hint_187662;
		NI res_187696;
		hint_187662 = 0;
...
N_NIMCALL(void, suggestwriteln_183117)(NimStringDesc* s) {
	{
		...
		LA7: ;
		{
			writelnhook_183114.ClEnv? writelnhook_183114.ClPrc(s, writelnhook_183114.ClEnv):((TMP2099)(writelnhook_183114.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, suggestquit_183155)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_183160).Sup.message; (*e_183160).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2824));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
static TNimNode* TMP2092[291];
NI TMP2094;
static char* NIM_CONST TMP2093[291] = {
"errUnknown", 
"errIllFormedAstX", 
"errInternal", 
"errCannotOpenFile", 
...
NTI182002.base = 0;
NTI182002.flags = 3;
for (TMP2094 = 0; TMP2094 < 291; TMP2094++) {
TMP19[TMP2094+12].kind = 1;
TMP19[TMP2094+12].offset = TMP2094;
TMP19[TMP2094+12].name = TMP2093[TMP2094];
TMP2092[TMP2094] = &TMP19[TMP2094+12];
}
TMP19[303].len = 291; TMP19[303].kind = 2; TMP19[303].sons = &TMP2092[0];
