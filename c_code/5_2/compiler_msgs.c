...
N_NIMCALL(void, suggestwriteln_182187)(NimStringDesc* s) {
	{
		...
		LA7: ;
		{
			writelnhook_182169.ClEnv? writelnhook_182169.ClPrc(s, writelnhook_182169.ClEnv):((TMP1990)(writelnhook_182169.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, clearbufferedmsgs_182179)(void) {
	genericSeqAssign((&bufferedmsgs_182163), NIM_NIL, (&NTI120808));
}
N_NIMCALL(void, TMP2707)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_182446)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_182450).Sup.message; (*e_182450).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2708));
	if (LOC1) nimGCunrefNoCycle(LOC1);
