...
N_NIMCALL(void, suggestwriteln_181082)(NimStringDesc* s) {
	{
		...
		LA7: ;
		{
			writelnhook_181064.ClEnv? writelnhook_181064.ClPrc(s, writelnhook_181064.ClEnv):((TMP2008)(writelnhook_181064.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, suggestquit_181292)(void) {
	...
	LOC1 = 0;
	LOC1 = (*e_181296).Sup.message; (*e_181296).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2729));
	if (LOC1) nimGCunrefNoCycle(LOC1);
