...
N_NIMCALL(pid_t, startprocessauxfork_127001)(tstartprocessdata126915* data);
N_NIMCALL(void, oserror_106205)(NI32 errorcode);
N_NIMCALL(NI32, oslasterror_106231)(void);
static N_INLINE(void, pushSafePoint)(TSafePoint* s);
N_CDECL(void, startprocessafterfork_127004)(tstartprocessdata126915* data);
...
N_NIMCALL(pid_t, startprocessauxfork_127001)(tstartprocessdata126915* data) {
	...
	if (TMP377.status == 0) {
		...
		nimln(778, "osproc.nim");
		{
			...
			startprocessafterfork_127004(&datacopy);
...
N_NIMCALL(tprocess125402*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, tstringtable120810* env, NU8 options) {
	...
	if (TMP381.status == 0) {
		...
		if (TMP382.status == 0) {
			...
			pid = startprocessauxfork_127001(&data);
