...
static N_INLINE(tnode185813*, lastson_186199)(tnode185813* n) {
	...
	if ((NU)((NI64)(TMP5680)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI64)(TMP5680)];
	popFrame();
	return result;
}
...
N_NIMCALL(tsym185843*, ithfield_414007)(tnode185813* n, NI field) {
	...
	case ((NU8) 136):
	{
		...
		while (1) {
			...
			result = ithfield_414007((*n).kindU.S6.Sons->data[i_414024], (NI64)(TMP5676));
	...
	case ((NU8) 137):
	{
		...
		result = ithfield_414007((*n).kindU.S6.Sons->data[0], (NI64)(TMP5678));
		...
		while (1) {
			...
			case ((NU8) 88):
			{
				...
				result = ithfield_414007(LOC20, (NI64)(TMP5681));
