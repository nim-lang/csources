...
STRING_LITERAL(TMP3179, "ithField", 8);
STRING_LITERAL(TMP3180, "ithField(record case branch)", 28);
STRING_LITERAL(TMP3181, "invalid field at index ", 23);
STRING_LITERAL(TMP3182, "() must have an object or tuple type", 36);
STRING_LITERAL(TMP3183, "[] must have some form of array type", 36);
STRING_LITERAL(TMP3184, "{} must have the set type", 25);
STRING_LITERAL(TMP3185, "float literal must have some float type", 39);
STRING_LITERAL(TMP3186, "integer literal must have some int type", 39);
STRING_LITERAL(TMP3187, "string literal must be of some string type", 42);
STRING_LITERAL(TMP3188, "nil literal must be of some pointer type", 40);
	...
	{
		{
			...
			internalerror_183669((*n).Info, ((NimStringDesc*) &TMP3179));
		}
		LA13: ;
		...
		LA17: ;
		{
			...
			res_432119 = 1;
			{
				while (1) {
					...
					default:
					{
						internalerror_183669((*n).Info, ((NimStringDesc*) &TMP3180));
					}
					break;
					}
					res_432119 += 1;
...
appendString(LOC14, ((NimStringDesc*) &TMP3181));
...
appendString(LOC29, ((NimStringDesc*) &TMP3181));
appendString(LOC29, LOC30);
	...
	case ((NU8) 16) ... ((NU8) 19):
	{
		...
		LA65: ;
		{
			globalerror_183627((*n).Info, ((NimStringDesc*) &TMP3185));
		}
		LA63: ;
	}
	break;
	case ((NU8) 5) ... ((NU8) 15):
	{
		...
		LA71: ;
		{
			globalerror_183627((*n).Info, ((NimStringDesc*) &TMP3186));
		}
		LA69: ;
	}
	break;
	case ((NU8) 20) ... ((NU8) 22):
	{
		...
		LA77: ;
		{
			globalerror_183627((*n).Info, ((NimStringDesc*) &TMP3187));
		}
		LA75: ;
	}
	break;
	case ((NU8) 23):
	{
		...
		LA83: ;
		{
			globalerror_183627((*n).Info, ((NimStringDesc*) &TMP3188));
		}
		LA81: ;
	}
	break;
