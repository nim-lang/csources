...
STRING_LITERAL(TMP4798, "$1 -> $2;$n", 11);
STRING_LITERAL(TMP4800, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP4801, "", 0);
STRING_LITERAL(TMP4802, "dot", 3);
...
N_NIMCALL(void, adddependencyaux_603028)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	appf_177115(&gdotgraph_603023, ((NimStringDesc*) &TMP4798), LOC1, 2);
}
...
N_NIMCALL(void, generatedot_603009)(NimStringDesc* project) {
	...
	LOC3 = 0;
	LOC3 = noschangeFileExt(LOC2, ((NimStringDesc*) &TMP4801));
	LOC1[0] = torope_177076(LOC3);
	LOC1[1] = gdotgraph_603023;
	LOC4 = 0;
	LOC4 = ropef_177107(((NimStringDesc*) &TMP4800), LOC1, 2);
	LOC5 = 0;
	LOC5 = noschangeFileExt(project, ((NimStringDesc*) &TMP4802));
