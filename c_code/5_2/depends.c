...
N_NIMCALL(void, adddependencyaux_525020)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	appf_148085(&gdotgraph_525017, ((NimStringDesc*) &TMP7611), LOC1, 2);
	popFrame();
}
