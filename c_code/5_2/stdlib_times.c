...
N_NIMCALL(void, tmtotimeinfo_101848)(struct tm* tm, NIM_BOOL local, timeinfo101205* Result) {
	...
	LA4: ;
	{
		LOC1.Tzname = copyString(((NimStringDesc*) &TMP3069));
	}
	LA2: ;
	{
		if (!local) goto LA16;
...
static TNimNode* TMP3062[11];
static TNimNode* TMP3063[12];
NI TMP3065;
static char* NIM_CONST TMP3064[12] = {
"mJan", 
"mFeb", 
"mMar", 
"mApr", 
...
"mNov", 
"mDec"};
static TNimNode* TMP3066[7];
NI TMP3068;
static char* NIM_CONST TMP3067[7] = {
"dMon", 
"dTue", 
"dWed", 
"dThu", 
...
NTI101006.base = 0;
NTI101006.flags = 3;
for (TMP3065 = 0; TMP3065 < 12; TMP3065++) {
TMP15[TMP3065+6].kind = 1;
TMP15[TMP3065+6].offset = TMP3065;
TMP15[TMP3065+6].name = TMP3064[TMP3065];
TMP3063[TMP3065] = &TMP15[TMP3065+6];
}
TMP15[18].len = 12; TMP15[18].kind = 2; TMP15[18].sons = &TMP3063[0];
...
NTI101008.base = 0;
NTI101008.flags = 3;
for (TMP3068 = 0; TMP3068 < 7; TMP3068++) {
TMP15[TMP3068+21].kind = 1;
TMP15[TMP3068+21].offset = TMP3068;
TMP15[TMP3068+21].name = TMP3067[TMP3068];
TMP3066[TMP3068] = &TMP15[TMP3068+21];
}
TMP15[28].len = 7; TMP15[28].kind = 2; TMP15[28].sons = &TMP3066[0];
...
TMP15[0].len = 11; TMP15[0].kind = 2; TMP15[0].sons = &TMP3062[0];
