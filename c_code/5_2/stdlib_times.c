...
typedef struct Timeinfo114803 Timeinfo114803;
...
typedef Weekday114405 TY115654[7];
struct Keyvaluepair152604 {
NimStringDesc* Field0;
NimStringDesc* Field1;
};
N_NIMCALL(void, getlocaltime_114843_2726502234)(time_t t0, Timeinfo114803* Result);
N_NIMCALL(void, tmtotimeinfo_115647_2726502234)(struct tm* tm0, NIM_BOOL local0, Timeinfo114803* Result);
N_NIMCALL(void, gettzname_114891_2726502234)(Keyvaluepair152604* Result);
...
N_NIMCALL(time_t, gettime_114841_2726502234)(void);
...
NIM_CONST TY115654 weekdays_115652_2726502234 = {((Weekday114405) 6),
((Weekday114405) 0),
((Weekday114405) 1),
((Weekday114405) 2),
((Weekday114405) 3),
...
TNimType NTI114803; /* TimeInfo */
extern TNimType NTI104; /* int */
TNimType NTI114806; /* range 0..61(int) */
TNimType NTI114808; /* range 0..59(int) */
TNimType NTI114810; /* range 0..23(int) */
TNimType NTI114813; /* range 1..31(int) */
TNimType NTI114403; /* Month */
TNimType NTI114405; /* WeekDay */
TNimType NTI114818; /* range 0..365(int) */
...
N_NIMCALL(void, tmtotimeinfo_115647_2726502234)(struct tm* tm0, NIM_BOOL local0, Timeinfo114803* Result) {
	...
	LOC1.weekday = weekdays_115652_2726502234[(((NI) ((*tm0).tm_wday)))- 0];
	...
	LOC1.isdst = (((NI32) 0) < (*tm0).tm_isdst);
	{
		if (!local0) goto LA4;
		{
			...
			gettzname_114891_2726502234((&LOC10));
		...
		LA8: ;
		{
			...
			gettzname_114891_2726502234((&LOC12));
	...
	{
		if (!local0) goto LA16;
		LOC1.timezone = ((NI64)-((*tm0).tm_gmtoff));
	}
	goto LA14;
	LA16: ;
	{
	...
	LA14: ;
	genericShallowAssign((void*)Result, (void*)(&LOC1), (&NTI114803));
}
...
N_NIMCALL(void, getlocaltime_114843_2726502234)(time_t t0, Timeinfo114803* Result) {
	...
	lt0 = localtime((&a0));
	chckNil((void*)Result);
	genericReset((void*)Result, (&NTI114803));
	(*Result).Sup.m_type = (&NTI114803);
	tmtotimeinfo_115647_2726502234((&(*lt0)), NIM_TRUE, Result);
}
...
N_NIMCALL(NimStringDesc*, ntgetDateStr)(void) {
	...
	ti0.Sup.m_type = (&NTI114803);
	LOC1 = (time_t)0;
	LOC1 = gettime_114841_2726502234();
	chckNil((void*)(&ti0));
	memset((void*)(&ti0), 0, sizeof(ti0));
	ti0.Sup.m_type = (&NTI114803);
	getlocaltime_114843_2726502234(LOC1, (&ti0));
...
NTI114803.size = sizeof(Timeinfo114803);
NTI114803.kind = 17;
NTI114803.base = (&NTI3608);
T2726502234_2[0] = &T2726502234_0[1];
NTI114806.size = sizeof(NI);
NTI114806.kind = 20;
NTI114806.base = (&NTI104);
NTI114806.flags = 3;
T2726502234_0[1].kind = 1;
T2726502234_0[1].offset = offsetof(Timeinfo114803, second);
T2726502234_0[1].typ = (&NTI114806);
T2726502234_0[1].name = "second";
T2726502234_2[1] = &T2726502234_0[2];
NTI114808.size = sizeof(NI);
NTI114808.kind = 20;
NTI114808.base = (&NTI104);
NTI114808.flags = 3;
T2726502234_0[2].kind = 1;
T2726502234_0[2].offset = offsetof(Timeinfo114803, minute);
T2726502234_0[2].typ = (&NTI114808);
T2726502234_0[2].name = "minute";
T2726502234_2[2] = &T2726502234_0[3];
NTI114810.size = sizeof(NI);
NTI114810.kind = 20;
NTI114810.base = (&NTI104);
NTI114810.flags = 3;
T2726502234_0[3].kind = 1;
T2726502234_0[3].offset = offsetof(Timeinfo114803, hour);
T2726502234_0[3].typ = (&NTI114810);
T2726502234_0[3].name = "hour";
T2726502234_2[3] = &T2726502234_0[4];
NTI114813.size = sizeof(NI);
NTI114813.kind = 20;
NTI114813.base = (&NTI104);
NTI114813.flags = 3;
T2726502234_0[4].kind = 1;
T2726502234_0[4].offset = offsetof(Timeinfo114803, monthday);
T2726502234_0[4].typ = (&NTI114813);
...
NTI114803.node = &T2726502234_0[0];
}
