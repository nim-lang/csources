...
static N_INLINE(NIM_BOOL, mustrehash_168054)(NI length, NI counter) {
	...
	LOC5 = ((NI64)(TMP1914) < (NI64)(TMP1915));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
...
static N_INLINE(NI, nexttry_168205)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1917 = mulInt(5, h);
	TMP1918 = addInt((NI64)(TMP1917), 1);
	result = (NI)((NI64)(TMP1918) & maxhash);
	popFrame();
	return result;
}
N_NIMCALL(ttrunk168039*, intsetget_168212)(tintset168043* t, NI key) {
...
N_NIMCALL(void, intsetenlarge_168604)(tintset168043* t) {
	...
	TMP1922 = mulInt((NI64)(TMP1921), 2);
	TMP1923 = subInt((NI64)(TMP1922), 1);
	(*t).Max = (NI64)(TMP1923);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1924 = addInt((*t).Max, 1);
	n = (ttrunkseq168041*) newSeq((&NTI168041), (NI64)(TMP1924));
	i_168629 = 0;
...
N_NIMCALL(ttrunk168039*, intsetput_168661)(tintset168043* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_168054((NI64)(TMP1928), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
...
TMP1925[0] = &TMP1911[1];
TMP1911[1].kind = 1;
TMP1911[1].offset = offsetof(ttrunk168039, Next);
TMP1911[1].typ = (&NTI168037);
TMP1911[1].name = "next";
TMP1925[1] = &TMP1911[2];
TMP1911[2].kind = 1;
TMP1911[2].offset = offsetof(ttrunk168039, Key);
TMP1911[2].typ = (&NTI105);
TMP1911[2].name = "key";
TMP1925[2] = &TMP1911[3];
TMP1911[3].kind = 1;
TMP1911[3].offset = offsetof(ttrunk168039, Bits);
TMP1911[3].typ = (&NTI21418);
TMP1911[3].name = "bits";
TMP1911[0].len = 3; TMP1911[0].kind = 2; TMP1911[0].sons = &TMP1925[0];
NTI168039.node = &TMP1911[0];
NTI168037.size = sizeof(ttrunk168039*);
NTI168037.kind = 22;
NTI168037.base = (&NTI168039);
NTI168037.marker = TMP1926;
NTI168041.size = sizeof(ttrunkseq168041*);
NTI168041.kind = 24;
NTI168041.base = (&NTI168037);
NTI168041.flags = 2;
NTI168041.marker = TMP1927;
...
TMP3351[0] = &TMP1911[5];
TMP1911[5].kind = 1;
TMP1911[5].offset = offsetof(tintset168043, Counter);
TMP1911[5].typ = (&NTI105);
TMP1911[5].name = "counter";
TMP3351[1] = &TMP1911[6];
TMP1911[6].kind = 1;
TMP1911[6].offset = offsetof(tintset168043, Max);
TMP1911[6].typ = (&NTI105);
TMP1911[6].name = "max";
TMP3351[2] = &TMP1911[7];
TMP1911[7].kind = 1;
TMP1911[7].offset = offsetof(tintset168043, Head);
TMP1911[7].typ = (&NTI168037);
TMP1911[7].name = "head";
TMP3351[3] = &TMP1911[8];
TMP1911[8].kind = 1;
TMP1911[8].offset = offsetof(tintset168043, Data);
TMP1911[8].typ = (&NTI168041);
TMP1911[8].name = "data";
TMP1911[4].len = 4; TMP1911[4].kind = 2; TMP1911[4].sons = &TMP3351[0];
NTI168043.node = &TMP1911[4];
}
