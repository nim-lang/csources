...
STRING_LITERAL(TMP2866, "newFileSize == -1 or not (mode == fmRead) ", 42);
...
N_NIMCALL(tmemfile209204, open_209210)(NimStringDesc* filename, NU8 mode, NI mappedsize, NI offset, NI newfilesize) {
	...
	nimln(45, "memfiles.nim");
	{
		...
		if (!!(LOC3)) goto LA5;
		nimln(45, "memfiles.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP2866));	}	LA5: ;
...
static TNimNode* TMP2947[3];
static TNimNode TMP2864[4];
...
TMP2947[0] = &TMP2864[1];
TMP2864[1].kind = 1;
TMP2864[1].offset = offsetof(tmemfile209204, Mem);
TMP2864[1].typ = (&NTI146);
TMP2864[1].name = "mem";
TMP2947[1] = &TMP2864[2];
TMP2864[2].kind = 1;
TMP2864[2].offset = offsetof(tmemfile209204, Size);
TMP2864[2].typ = (&NTI105);
TMP2864[2].name = "size";
TMP2947[2] = &TMP2864[3];
TMP2864[3].kind = 1;
TMP2864[3].offset = offsetof(tmemfile209204, Handle);
TMP2864[3].typ = (&NTI3809);
TMP2864[3].name = "handle";
TMP2864[0].len = 3; TMP2864[0].kind = 2; TMP2864[0].sons = &TMP2947[0];
NTI209204.node = &TMP2864[0];
}
