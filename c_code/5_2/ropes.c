...
typedef N_CLOSURE_PTR(void, TMP571) (NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
...
N_NIMCALL(void, TMP544)(void* p, NI op);
...
STRING_LITERAL(TMP545, "ropeInvariant(result) ", 22);
STRING_LITERAL(TMP552, "it.data != nil ", 15);
STRING_LITERAL(TMP553, "resultLen <= len(result) ", 25);
STRING_LITERAL(TMP554, "", 0);
STRING_LITERAL(TMP556, "it != nil ", 10);
STRING_LITERAL(TMP559, "$", 1);
...
N_NIMCALL(void, ropeseqinsert_148403)(tropeseq148009** rs, trope148007* r, NI at) {
	...
	nimln(164, "ropes.nim");
	{
		...
		(*rs) = (tropeseq148009*) setLengthSeq(&((*rs))->Sup, sizeof(trope148007*), ((NI) ((NI64)(TMP546))));
	}
	goto LA1;
	LA3: ;
	{
		...
		(*rs) = (tropeseq148009*) setLengthSeq(&((*rs))->Sup, sizeof(trope148007*), (NI64)(TMP547));
	}
	LA1: ;
	i_148467 = 0;
	HEX3Atmp_148468 = 0;
	...
	HEX3Atmp_148468 = ((NI) ((NI64)(TMP548)));
	...
	while (1) {
		...
		if ((NU)((NI64)(TMP549)) >= (NU)((*rs)->Sup.len)) raiseIndexError();
		asgnRefNoCycle((void**) &(*rs)->data[i_148467], (*rs)->data[(NI64)(TMP549)]);
...
N_NIMCALL(trope148007*, con_148020)(trope148007* a, trope148007* b) {
	...
	LA6: ;
	{
		...
		nimln(197, "ropes.nim");
		nimln(197, "ropes.nim");
		TMP555 = addInt((*a).Length, (*b).Length);
		(*result).Length = (NI64)(TMP555);
		nimln(198, "ropes.nim");
...
N_NIMCALL(trope148007*, ropef_148079)(NimStringDesc* frmt, trope148007** args, NI argsLen0) {
	...
	while (1) {
		...
		nimln(248, "ropes.nim");
		{
			...
			case 48 ... 57:
			{
				...
				while (1) {
					...
					nimln(261, "ropes.nim");
					if ((NU)(i) > (NU)(frmt->Sup.len)) raiseIndexError();
					TMP561 = addInt((NI64)(TMP560), ((NI) (((NU8)(frmt->data[i])))));
					TMP562 = subInt((NI64)(TMP561), 48);
					j = (NI64)(TMP562);
					nimln(262, "ropes.nim");
					i = addInt(i, 1);
					nimln(263, "ropes.nim");
				...
				LA18: ;
				{
					...
					nimln(268, "ropes.nim");
					TMP567 = subInt(j, 1);
					if ((NU)((NI64)(TMP567)) >= (NU)(argsLen0)) raiseIndexError();
					app_148040(&result, args[(NI64)(TMP567)]);
				}
				LA16: ;
			}
			break;
		...
		nimln(281, "ropes.nim");
		{
			...
			nimln(281, "ropes.nim");
			TMP569 = subInt(i, 1);
			if (!(start <= (NI64)(TMP569))) goto LA34;
			nimln(282, "ropes.nim");
			nimln(282, "ropes.nim");
			nimln(282, "ropes.nim");
			TMP570 = subInt(i, 1);
			LOC36 = 0;
			LOC36 = copyStrLast(frmt, start, (NI64)(TMP570));
...
N_NIMCALL(NIM_BOOL, auxropeequalsfile_150014)(trope148007* r, FILE** bin, void* buf) {
	...
	nimln(303, "ropes.nim");
	{
		...
		nimln(304, "ropes.nim");
		{
			...
			nimln(305, "ropes.nim");
			errorhandler_148108.ClEnv? errorhandler_148108.ClPrc(((NU8) 2), (*r).Data, NIM_FALSE, errorhandler_148108.ClEnv):((TMP571)(errorhandler_148108.ClPrc))(((NU8) 2), (*r).Data, NIM_FALSE);
			nimln(306, "ropes.nim");
			goto BeforeRet;
		}
		LA7: ;
...
N_NIMCALL(NI32, crcfromropeaux_150038)(trope148007* r, NI32 startval) {
	...
	nimln(327, "ropes.nim");
	{
		...
		nimln(329, "ropes.nim");
		nimln(329, "ropes.nim");
		TMP572 = subInt((*r).Data->Sup.len, 1);
		HEX3Atmp_150056 = (NI64)(TMP572);
		nimln(1451, "system.nim");
		res_150058 = 0;
		nimln(1452, "system.nim");
		while (1) {
...
static TNimNode* TMP543[4];
static TNimNode TMP463[5];
...
TMP543[0] = &TMP463[1];
TMP463[1].kind = 1;
TMP463[1].offset = offsetof(trope148007, Left);
TMP463[1].typ = (&NTI148005);
TMP463[1].name = "left";
TMP543[1] = &TMP463[2];
TMP463[2].kind = 1;
TMP463[2].offset = offsetof(trope148007, Right);
TMP463[2].typ = (&NTI148005);
TMP463[2].name = "right";
TMP543[2] = &TMP463[3];
TMP463[3].kind = 1;
TMP463[3].offset = offsetof(trope148007, Length);
TMP463[3].typ = (&NTI106);
TMP463[3].name = "length";
TMP543[3] = &TMP463[4];
TMP463[4].kind = 1;
TMP463[4].offset = offsetof(trope148007, Data);
TMP463[4].typ = (&NTI143);
TMP463[4].name = "data";
TMP463[0].len = 4; TMP463[0].kind = 2; TMP463[0].sons = &TMP543[0];
NTI148007.node = &TMP463[0];
NTI148005.size = sizeof(trope148007*);
NTI148005.kind = 22;
NTI148005.base = (&NTI148007);
NTI148005.flags = 2;
NTI148005.marker = TMP544;
NTI148009.size = sizeof(tropeseq148009*);
NTI148009.kind = 24;
NTI148009.base = (&NTI148005);
NTI148009.flags = 2;
NTI148009.marker = TMP551;
}
