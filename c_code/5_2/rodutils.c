...
STRING_LITERAL(TMP1404, "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", 62);
STRING_LITERAL(TMP3494, "NAN", 3);
STRING_LITERAL(TMP3495, "0.0", 3);
STRING_LITERAL(TMP3496, "INF", 3);
STRING_LITERAL(TMP3497, "-INF", 4);
...
N_NIMCALL(void, encodevintaux_233275)(NI x, NimStringDesc** result) {
	...
	idx_233287 = ((NI) (rem_233285));
	{
		...
		d_233281 = ((NimStringDesc*) &TMP1404)->data[idx_233287];
	}
	goto LA6;
	LA8: ;
	{
...
N_NIMCALL(void, encodevbiggestintaux_233234)(NI64 x, NimStringDesc** result) {
	...
	idx_233246 = ((NI) (rem_233244));
	{
		...
		d_233240 = ((NimStringDesc*) &TMP1404)->data[idx_233246];
	}
	goto LA6;
	LA8: ;
	{
