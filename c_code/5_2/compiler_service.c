...
STRING_LITERAL(TMP5274, "server.type", 11);
STRING_LITERAL(TMP5275, "stdin", 5);
STRING_LITERAL(TMP5276, "tcp", 3);
STRING_LITERAL(TMP5277, "quit", 4);
STRING_LITERAL(TMP5279, "server.port", 11);
STRING_LITERAL(TMP5280, "server.address", 14);
STRING_LITERAL(TMP5283, "\015\012", 2);
STRING_LITERAL(TMP5291, "Invalid server.type:", 20);
...
N_NIMCALL(void, serve_530236)(TY530238 action) {
	...
	typ = getconfigvar_160282(((NimStringDesc*) &TMP5274));
	if (eqStrings(typ, ((NimStringDesc*) &TMP5275))) goto LA1;
	if (eqStrings(typ, ((NimStringDesc*) &TMP5276))) goto LA2;
	...
	{
		{
			while (1) {
				...
				{
					if (!eqStrings(line, ((NimStringDesc*) &TMP5277))) goto LA10;
					exit(((NI) 0));
				}
				LA10: ;
				LOC12 = 0;
	...
	LA2: ;
	{
		...
		p = getconfigvar_160282(((NimStringDesc*) &TMP5279));
		{
			NI LOC18;
		...
		LA14: ;
		LOC20 = 0;
		LOC20 = getconfigvar_160282(((NimStringDesc*) &TMP5280));
		...
		writelnhook_183114.ClPrc = LOC21.ClPrc;
		{
			while (1) {
				...
				action();
				gerrorcounter_183078 = ((NI) 0);
				send_527202((*HEX3Aenv_530426).stdoutsocket530408, ((NimStringDesc*) &TMP5283), 2);
	...
	LA3: ;
	{
		printf("%s%s\012", ((NimStringDesc*) &TMP5291)? (((NimStringDesc*) &TMP5291))->data:"nil", typ? (typ)->data:"nil");
		fflush(stdout);
...
TMP1187[0].len = 2; TMP1187[0].kind = 2; TMP1187[0].sons = &TMP5260[0];
NTI530421.node = &TMP1187[0];
NTI530420.size = sizeof(TY530421*);
NTI530420.kind = 22;
NTI530420.base = (&NTI530421);
NTI530420.flags = 2;
NTI530420.marker = TMP5273;
}
