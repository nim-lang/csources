...
static N_INLINE(tnode191813*, lastson_192199)(tnode191813* n) {
	...
	if ((NU)((NI64)(TMP5624)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI64)(TMP5624)];
	popFrame();
	return result;
}
...
static N_INLINE(ttype191847*, lastson_192203)(ttype191847* n) {
	...
	if ((NU)((NI64)(TMP5629)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP5629)];
	popFrame();
	return result;
}
