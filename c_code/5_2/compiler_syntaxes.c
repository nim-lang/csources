...
NIM_CONST TY197015 parsernames_197014 = {((NimStringDesc*) &TMP2618),
...
NIM_CONST TY197020 filternames_197019 = {((NimStringDesc*) &TMP2621),
...
static NIM_CONST TY171865 TMP2635 = {
...
N_NIMCALL(tnode171659*, parseall_197046)(tparsers197026* p) {
	...
	case ((NU8) 2):
	{
		...
		internalerror_138383(((NimStringDesc*) &TMP2629));		nimln(63, "syntaxes.nim");
...
N_NIMCALL(tnode171659*, parsetoplevelstmt_197051)(tparsers197026* p) {
	...
	case ((NU8) 2):
	{
		...
		internalerror_138383(((NimStringDesc*) &TMP2629));		nimln(74, "syntaxes.nim");
		result = emptynode_172505;
	}	break;
	}
	popFrame();
...
N_NIMCALL(NIM_BOOL, containsshebang_197097)(NimStringDesc* s, NI i) {
	...
	nimln(84, "syntaxes.nim");
	{
		...
		nimln(84, "syntaxes.nim");
		TMP2630 = addInt(i, 1);
		if ((NU)((NI64)(TMP2630)) > (NU)(s->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(s->data[(NI64)(TMP2630)]) == (NU8)(33));
		LA4: ;
		if (!LOC3) goto LA5;
...
N_NIMCALL(tnode171659*, parsepipe_197126)(NimStringDesc* filename, tllstream161204* inputstream) {
	...
	nimln(92, "syntaxes.nim");
	{
		...
		nimln(99, "syntaxes.nim");
		{
			...
			nimln(99, "syntaxes.nim");
			TMP2632 = addInt(i, 1);
			if ((NU)((NI64)(TMP2632)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC14 = ((NU8)(line->data[(NI64)(TMP2632)]) == (NU8)(33));
			LA15: ;
			if (!LOC14) goto LA16;
...
NTI197005.node = &TMP2254[5];
TMP2254[1].kind = 1;
TMP2254[1].offset = offsetof(tparsers197026, Skin);
TMP2254[1].typ = (&NTI197005);
TMP2254[1].name = "skin";
TMP2625[1] = &TMP2254[6];
TMP2254[6].kind = 1;
TMP2254[6].offset = offsetof(tparsers197026, Parser);
TMP2254[6].typ = (&NTI185203);
TMP2254[6].name = "parser";
TMP2254[0].len = 2; TMP2254[0].kind = 2; TMP2254[0].sons = &TMP2625[0];
NTI197026.node = &TMP2254[0];
}
