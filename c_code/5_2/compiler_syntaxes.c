...
STRING_LITERAL(TMP1328, "none", 4);
STRING_LITERAL(TMP1329, "stdtmpl", 7);
STRING_LITERAL(TMP1330, "replace", 7);
STRING_LITERAL(TMP1331, "strip", 5);
NIM_CONST TY234026 filternames_234025 = {((NimStringDesc*) &TMP1328),
((NimStringDesc*) &TMP1329),
((NimStringDesc*) &TMP1330),
((NimStringDesc*) &TMP1331)}
;
STRING_LITERAL(TMP1332, "standard", 8);
STRING_LITERAL(TMP1333, "strongspaces", 12);
STRING_LITERAL(TMP1334, "braces", 6);
STRING_LITERAL(TMP1335, "endx", 4);
NIM_CONST TY234020 parsernames_234019 = {((NimStringDesc*) &TMP1332),
((NimStringDesc*) &TMP1333),
((NimStringDesc*) &TMP1334),
((NimStringDesc*) &TMP1335)}
;
STRING_LITERAL(TMP1366, "parser to implement", 19);
...
{	result = 0;
	...
	LA3: ;
	{
		...
		LOC7 = LOC8;
		if (!(LOC7)) goto LA10;
		LOC7 = identeq_184484((*(*n).kindU.S6.Sons->data[((NI) 0)]).kindU.S5.Ident, ((NimStringDesc*) &TMP1218));
		LA10: ;
		if (!LOC7) goto LA11;
		{
			NI i_234786;
...
N_NIMCALL(tnode207813*, parseall_234063)(tparsers234035* p) {
	...
	case ((NU8) 3):
	{
		internalerror_182443(((NimStringDesc*) &TMP1366));
		result = emptynode_208807;
	}
	break;
	}
