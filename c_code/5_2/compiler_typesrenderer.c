...
N_NIMCALL(void, renderparamtypes_366467)(TY120808** found, tnode209818* n);
...
STRING_LITERAL(TMP4667, "", 0);
STRING_LITERAL(TMP4668, "*", 1);
STRING_LITERAL(TMP4669, "renderPlainSymbolName() with ", 29);
STRING_LITERAL(TMP4676, "ref.", 4);
STRING_LITERAL(TMP4677, "ptr.", 4);
STRING_LITERAL(TMP4678, "proc(", 5);
STRING_LITERAL(TMP4679, "tuple[", 6);
STRING_LITERAL(TMP4680, "renderParamTypes(found,n) with ", 31);
...
{	result = 0;
	result = copyString(((NimStringDesc*) &TMP4667));
	switch ((*n).Kind) {
	case ((NU8) 31):
	{
		{
	...
	{
		{
			if (!!(eqStrings((*(*n).kindU.S5.Ident).S, ((NimStringDesc*) &TMP4668)))) goto LA15;
...
appendString(LOC24, ((NimStringDesc*) &TMP4669));
...
appendString(LOC6, ((NimStringDesc*) &TMP4676));
...
appendString(LOC10, ((NimStringDesc*) &TMP4677));
...
appendString(result, LOC27);
	...
	case ((NU8) 134):
	{
		result = copyString(((NimStringDesc*) &TMP4679));
		{
			NI i_366022;
			NI HEX3Atmp_366414;
			NI LOC30;
		...
		LA15: ;
		{
			...
			res_366836 = 0;
			{
				while (1) {
					...
					i_366646 = res_366836;
					(*found) = (TY120808*) incrSeq(&((*found))->Sup, sizeof(NimStringDesc*));
					LOC29 = 0;
...
appendString(LOC31, ((NimStringDesc*) &TMP4680));
...
N_NIMCALL(NimStringDesc*, renderparamtypes_366862)(tnode209818* n, NimStringDesc* sep) {
	...
	result = 0;
	result = copyString(((NimStringDesc*) &TMP4667));
	found = (TY120808*) newSeq((&NTI120808), 0);
