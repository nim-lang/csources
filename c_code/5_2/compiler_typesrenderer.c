...
STRING_LITERAL(TMP5075, "", 0);
STRING_LITERAL(TMP5076, "*", 1);
STRING_LITERAL(TMP5077, "renderPlainSymbolName() with ", 29);
STRING_LITERAL(TMP5084, "ref.", 4);
STRING_LITERAL(TMP5085, "ptr.", 4);
STRING_LITERAL(TMP5086, "proc(", 5);
STRING_LITERAL(TMP5087, "tuple[", 6);
STRING_LITERAL(TMP5088, "renderParamTypes(found,n) with ", 31);
...
{	result = 0;
	result = copyString(((NimStringDesc*) &TMP5075));
	switch ((*n).kind) {
	case ((NU8) 31):
	{
		{
	...
	{
		{
			if (!!(eqStrings((*(*n).kindU.S5.ident).s, ((NimStringDesc*) &TMP5076)))) goto LA15;
...
appendString(LOC24, ((NimStringDesc*) &TMP5077));
...
appendString(LOC6, ((NimStringDesc*) &TMP5084));
...
appendString(LOC10, ((NimStringDesc*) &TMP5085));
...
appendString(LOC31, ((NimStringDesc*) &TMP5088));
