...
N_NIMCALL(void, hexchar_177058)(NIM_CHAR c, NI* xi) {
	...
	case 48 ... 57:
	{
		...
		(*xi) = (NI)((NI)((NU64)((*xi)) << (NU64)(4)) | ((NI) ((NI64)(TMP2071))));
	}	break;
	case 97 ... 102:
	{
		NI TMP2072;
		...
		TMP2073 = addInt(((NI) ((NI64)(TMP2072))), 10);
		(*xi) = (NI)((NI)((NU64)((*xi)) << (NU64)(4)) | ((NI) ((NI64)(TMP2073))));
	}	break;
	case 65 ... 70:
	{
		NI TMP2074;
		...
		TMP2075 = addInt(((NI) ((NI64)(TMP2074))), 10);
		(*xi) = (NI)((NI)((NU64)((*xi)) << (NU64)(4)) | ((NI) ((NI64)(TMP2075))));
	}	break;
	default:
	{
	}	break;
...
N_NIMCALL(NimStringDesc*, decodestr_177114)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 92:
		{
			...
			nimln(49, "rodutils.nim");
			TMP2077 = subInt(i, 2);
			hexchar_177058(s[(NI64)(TMP2077)], &xi);			nimln(50, "rodutils.nim");
			nimln(50, "rodutils.nim");
			TMP2078 = subInt(i, 1);
			hexchar_177058(s[(NI64)(TMP2078)], &xi);			nimln(51, "rodutils.nim");
...
N_NIMCALL(void, encodevbiggestintaux_177161)(NI64 x, NimStringDesc** result) {
	...
	nimln(70, "rodutils.nim");
	TMP2079 = modInt64(v_177169, 190);
	rem_177171 = (NI64)(TMP2079);
	...
	LA3: ;
	{
		...
		nimln(76, "rodutils.nim");
		TMP2081 = divInt64(v_177169, 190);
		v_177169 = (NI64)(TMP2081);
	}	LA1: ;
	...
	nimln(78, "rodutils.nim");
	{
		...
		nimln(78, "rodutils.nim");
		if ((NU)(idx_177173) > (NU)(((NimStringDesc*) &TMP2082)->Sup.len)) raiseIndexError();
		d_177167 = ((NimStringDesc*) &TMP2082)->data[idx_177173];
	}	goto LA6;
	LA8: ;
	{
		NI TMP2083;
		...
		nimln(79, "rodutils.nim");
		nimln(79, "rodutils.nim");
		TMP2083 = subInt(idx_177173, 62);
		TMP2084 = addInt((NI64)(TMP2083), 128);
		d_177167 = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP2084), 0, 255))));
	}	LA6: ;
...
N_NIMCALL(void, encodevintaux_177193)(NI x, NimStringDesc** result) {
	...
	nimln(70, "rodutils.nim");
	nimln(70, "rodutils.nim");
	TMP2085 = modInt(v_177201, 190);
	rem_177203 = (NI64)(TMP2085);
	nimln(71, "rodutils.nim");
	{
		NI TMP2086;
		nimln(71, "rodutils.nim");
		...
		nimln(73, "rodutils.nim");
		nimln(73, "rodutils.nim");
		TMP2086 = divInt(v_177201, 190);
		if ((NI64)(TMP2086) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
		v_177201 = ((NI64)-((NI64)(TMP2086)));
		nimln(74, "rodutils.nim");
		nimln(74, "rodutils.nim");
	...
	LA3: ;
	{
		...
		nimln(76, "rodutils.nim");
		nimln(76, "rodutils.nim");
		TMP2087 = divInt(v_177201, 190);
		v_177201 = (NI64)(TMP2087);
	}	LA1: ;
	nimln(77, "rodutils.nim");
	...
	nimln(78, "rodutils.nim");
	{
		...
		nimln(78, "rodutils.nim");
		if ((NU)(idx_177205) > (NU)(((NimStringDesc*) &TMP2082)->Sup.len)) raiseIndexError();
		d_177199 = ((NimStringDesc*) &TMP2082)->data[idx_177205];
	}	goto LA6;
	LA8: ;
	{
		NI TMP2088;
		...
		nimln(79, "rodutils.nim");
		nimln(79, "rodutils.nim");
		TMP2088 = subInt(idx_177205, 62);
		TMP2089 = addInt((NI64)(TMP2088), 128);
		d_177199 = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP2089), 0, 255))));
	}	LA6: ;
	nimln(80, "rodutils.nim");
	{
		nimln(698, "system.nim");
...
N_NIMCALL(NI, decodevint_177239)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 48 ... 57:
		{
			...
			nimln(110, "rodutils.nim");
			nimln(110, "rodutils.nim");
			TMP2092 = subInt(((NI) (((NU8)(s[i_177246])))), 48);
			TMP2093 = subInt((NI64)(TMP2091), ((NI) ((NI64)(TMP2092))));
			result = (NI64)(TMP2093);
		}		break;
		case 97 ... 122:
		{
			...
			nimln(111, "rodutils.nim");
			nimln(111, "rodutils.nim");
			TMP2095 = subInt(((NI) (((NU8)(s[i_177246])))), 97);
			TMP2096 = addInt(((NI) ((NI64)(TMP2095))), 10);
			TMP2097 = subInt((NI64)(TMP2094), ((NI) ((NI64)(TMP2096))));
			result = (NI64)(TMP2097);
		}		break;
		case 65 ... 90:
		{
			...
			nimln(112, "rodutils.nim");
			nimln(112, "rodutils.nim");
			TMP2099 = subInt(((NI) (((NU8)(s[i_177246])))), 65);
			TMP2100 = addInt(((NI) ((NI64)(TMP2099))), 36);
			TMP2101 = subInt((NI64)(TMP2098), ((NI) ((NI64)(TMP2100))));
			result = (NI64)(TMP2101);
		}		break;
		case 128 ... 255:
		{
			...
			nimln(113, "rodutils.nim");
			nimln(113, "rodutils.nim");
			TMP2103 = subInt(((NI) (((NU8)(s[i_177246])))), 128);
			TMP2104 = addInt(((NI) ((NI64)(TMP2103))), 62);
			TMP2105 = subInt((NI64)(TMP2102), ((NI) ((NI64)(TMP2104))));
			result = (NI64)(TMP2105);
		}		break;
		default:
		{
	...
	nimln(116, "rodutils.nim");
	nimln(116, "rodutils.nim");
	TMP2106 = mulInt(result, sign_177248);
	result = (NI)((NU64)((NI64)(TMP2106)) - (NU64)(5));
...
N_NIMCALL(NI64, decodevbiggestint_177495)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 48 ... 57:
		{
			...
			nimln(110, "rodutils.nim");
			nimln(110, "rodutils.nim");
			TMP2108 = subInt(((NI) (((NU8)(s[i_177502])))), 48);
			TMP2109 = subInt64((NI64)(TMP2107), ((NI64) ((NI64)(TMP2108))));
			result = (NI64)(TMP2109);
		}		break;
		case 97 ... 122:
		{
			...
			nimln(111, "rodutils.nim");
			nimln(111, "rodutils.nim");
			TMP2111 = subInt(((NI) (((NU8)(s[i_177502])))), 97);
			TMP2112 = addInt(((NI) ((NI64)(TMP2111))), 10);
			TMP2113 = subInt64((NI64)(TMP2110), ((NI64) ((NI64)(TMP2112))));
			result = (NI64)(TMP2113);
		}		break;
		case 65 ... 90:
		{
			...
			nimln(112, "rodutils.nim");
			nimln(112, "rodutils.nim");
			TMP2115 = subInt(((NI) (((NU8)(s[i_177502])))), 65);
			TMP2116 = addInt(((NI) ((NI64)(TMP2115))), 36);
			TMP2117 = subInt64((NI64)(TMP2114), ((NI64) ((NI64)(TMP2116))));
			result = (NI64)(TMP2117);
		}		break;
		case 128 ... 255:
		{
			...
			nimln(113, "rodutils.nim");
			nimln(113, "rodutils.nim");
			TMP2119 = subInt(((NI) (((NU8)(s[i_177502])))), 128);
			TMP2120 = addInt(((NI) ((NI64)(TMP2119))), 62);
			TMP2121 = subInt64((NI64)(TMP2118), ((NI64) ((NI64)(TMP2120))));
			result = (NI64)(TMP2121);
		}		break;
		default:
		{
	...
	nimln(116, "rodutils.nim");
	nimln(116, "rodutils.nim");
	TMP2122 = mulInt64(result, ((NI64) (sign_177504)));
