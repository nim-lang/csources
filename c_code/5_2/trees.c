...
N_NIMCALL(tnode224819*, extractrange_260419)(NU8 k, tnode224819* n, NI a, NI b) {
	tnode224819* result;
	result = 0;
	result = newnodei_227007(k, (*n).Info, (NI64)((NI64)(b - a) + 1));
	{
		NI i_260436;
		NI HEX3Atmp_260466;
		NI res_260469;
		i_260436 = 0;
		HEX3Atmp_260466 = 0;
		HEX3Atmp_260466 = (NI64)(b - a);
		res_260469 = 0;
		{
			while (1) {
				if (!(res_260469 <= HEX3Atmp_260466)) goto LA3;
				i_260436 = res_260469;
				asgnRefNoCycle((void**) &(*result).kindU.S6.Sons->data[i_260436], (*n).kindU.S6.Sons->data[(NI64)(i_260436 + a)]);
				res_260469 += 1;
			} LA3: ;
		}
	}
