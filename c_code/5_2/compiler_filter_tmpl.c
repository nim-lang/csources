...
STRING_LITERAL(TMP1521, "", 0);
STRING_LITERAL(TMP1522, "subschar", 8);
STRING_LITERAL(TMP1523, "metachar", 8);
STRING_LITERAL(TMP1524, "emit", 4);
STRING_LITERAL(TMP1525, "result.add", 10);
STRING_LITERAL(TMP1526, "conc", 4);
STRING_LITERAL(TMP1527, " & ", 3);
STRING_LITERAL(TMP1528, "tostring", 8);
STRING_LITERAL(TMP1529, "$", 1);
STRING_LITERAL(TMP1530, "\012", 1);
STRING_LITERAL(TMP1532, "end", 3);
STRING_LITERAL(TMP1533, "#end", 4);
static NIM_CONST TY202404 TMP1534 = {
...
N_NIMCALL(void, newline_237032)(Ttmplparser237011* p) {
	...
	(*p).emitpar = ((NI) 0);
	{
		...
		llstreamwrite_202593((*p).outp, ((NimStringDesc*) &TMP1530));
	}
	LA4: ;
	{
		NimStringDesc* LOC10;
...
N_NIMCALL(void, parseline_237110)(Ttmplparser237011* p) {
	...
	LA7: ;
	{
		...
		d = j;
		keyw = copyString(((NimStringDesc*) &TMP1521));
		{
			while (1) {
		...
		case ((NU16) 22):
		{
			...
			{
				(*p).info.col = ((NI16) (j));
				localerror_187080((*p).info, ((NU16) 167), ((NimStringDesc*) &TMP1532));
			}
			LA20: ;
			LOC25 = 0;
			LOC25 = nsuRepeatChar(32, ((NI) ((*p).indent)));
			llstreamwrite_202593((*p).outp, LOC25);
			llstreamwrite_202593((*p).outp, ((NimStringDesc*) &TMP1533));
		}
		break;
		case ((NU16) 31):
		case ((NU16) 65):
		...
		case ((NU16) 62):
		{
			...
			llstreamwrite_202593((*p).outp, LOC34);
			{
				NIM_BOOL LOC37;
				LOC37 = 0;
				LOC37 = contains_101033((*p).x, TMP1534);
				if (!!(LOC37)) goto LA38;
				(*p).indent += ((NI) 2);
			}
			LA38: ;
	...
	LA10: ;
	{
		...
		(*p).state = ((NU8) 1);
		{
			while (1) {
				...
				case 34:
				{
					llstreamwrite_202593((*p).outp, ((NimStringDesc*) &TMP1540));
					j += ((NI) 1);
				}
				break;
				default:
				{
					{
						...
						case 123:
						{
							...
							curly = ((NI) 0);
							{
								while (1) {
									...
									case 0:
									{
										localerror_187080((*p).info, ((NU16) 193), ((NimStringDesc*) &TMP1541));
										goto LA62;
									}
									break;
									case 123:
						...
						default:
						{
							...
							{
								(*p).info.col = ((NI16) (j));
								localerror_187080((*p).info, ((NU16) 171), ((NimStringDesc*) &TMP1529));
							}
							LA80: ;
						}
						break;
		...
		llstreamwrite_202593((*p).outp, ((NimStringDesc*) &TMP1542));
	}
	LA3: ;
}
...
N_NIMCALL(Tllstream202204*, filtertmpl_237003)(Tllstream202204* stdin_237005, NimStringDesc* filename, Tnode214790* call) {
	...
	p.outp = llstreamopen_202217(((NimStringDesc*) &TMP1521));
	p.inp = stdin_237005;
	p.subschar = chararg_236011(call, ((NimStringDesc*) &TMP1522), ((NI) 1), 36);
	p.nimdirective = chararg_236011(call, ((NimStringDesc*) &TMP1523), ((NI) 2), 35);
	p.emit = strarg_236017(call, ((NimStringDesc*) &TMP1524), ((NI) 3), ((NimStringDesc*) &TMP1525));
	p.conc = strarg_236017(call, ((NimStringDesc*) &TMP1526), ((NI) 4), ((NimStringDesc*) &TMP1527));
	p.tostr = strarg_236017(call, ((NimStringDesc*) &TMP1528), ((NI) 5), ((NimStringDesc*) &TMP1529));
