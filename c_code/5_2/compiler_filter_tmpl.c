...
STRING_LITERAL(TMP1338, "metachar", 8);
STRING_LITERAL(TMP1339, "emit", 4);
STRING_LITERAL(TMP1340, "result.add", 10);
STRING_LITERAL(TMP1341, "conc", 4);
STRING_LITERAL(TMP1342, " & ", 3);
STRING_LITERAL(TMP1343, "tostring", 8);
STRING_LITERAL(TMP1344, "$", 1);
STRING_LITERAL(TMP1345, "\012", 1);
STRING_LITERAL(TMP1347, "end", 3);
STRING_LITERAL(TMP1348, "#end", 4);
static NIM_CONST TY194407 TMP1349 = {
...
STRING_LITERAL(TMP1352, "\\x", 2);
STRING_LITERAL(TMP1353, "\\\\", 2);
STRING_LITERAL(TMP1354, "\\\'", 2);
STRING_LITERAL(TMP1355, "\\\"", 2);
STRING_LITERAL(TMP1356, "}", 1);
STRING_LITERAL(TMP1357, "\\n\"", 3);
...
N_NIMCALL(void, parseline_233149)(ttmplparser233020* p) {
	...
	LA7: ;
	{
		...
		d = j;
		keyw = copyString(((NimStringDesc*) &TMP1336));
		{
			while (1) {
		...
		case ((NU8) 21):
		{
			...
			{
				(*p).Info.Col = ((NI16) (j));
				localerror_182392((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP1347));
			}
			LA20: ;
			LOC25 = 0;
		...
		case ((NU8) 61):
		{
			...
			llstreamwrite_194665((*p).Outp, LOC34);
			{
				NIM_BOOL LOC37;
				LOC37 = 0;
				LOC37 = contains_97907((*p).X, TMP1349);
				if (!!(LOC37)) goto LA38;
				(*p).Indent += ((NI) 2);
			}
			LA38: ;
	...
	LA10: ;
	{
		...
		(*p).State = ((NU8) 1);
		{
			while (1) {
				...
				case 34:
				{
					llstreamwrite_194665((*p).Outp, ((NimStringDesc*) &TMP1355));
					j += ((NI) 1);
				}
				break;
				default:
				{
					{
						...
						case 123:
						{
							...
							curly = ((NI) 0);
							{
								while (1) {
									...
									case 0:
									{
										localerror_182392((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP1356));
										goto LA62;
									}
									break;
									case 123:
						...
						default:
						{
							...
							{
								(*p).Info.Col = ((NI16) (j));
								localerror_182392((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP1344));
							}
							LA80: ;
						}
						break;
		...
		llstreamwrite_194665((*p).Outp, ((NimStringDesc*) &TMP1357));
	}
	LA3: ;
}
...
N_NIMCALL(tllstream194204*, filtertmpl_233009)(tllstream194204* stdin_233011, NimStringDesc* filename, tnode207813* call) {
	...
	p.Outp = llstreamopen_194220(((NimStringDesc*) &TMP1336));
	p.Inp = stdin_233011;
	p.Subschar = chararg_232020(call, ((NimStringDesc*) &TMP1337), ((NI) 1), 36);
	p.Nimdirective = chararg_232020(call, ((NimStringDesc*) &TMP1338), ((NI) 2), 35);
	p.Emit = strarg_232029(call, ((NimStringDesc*) &TMP1339), ((NI) 3), ((NimStringDesc*) &TMP1340));
	p.Conc = strarg_232029(call, ((NimStringDesc*) &TMP1341), ((NI) 4), ((NimStringDesc*) &TMP1342));
	p.Tostr = strarg_232029(call, ((NimStringDesc*) &TMP1343), ((NI) 5), ((NimStringDesc*) &TMP1344));
