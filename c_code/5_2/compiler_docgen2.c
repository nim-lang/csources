...
N_NIMCALL(tnode171659*, close_415013)(tpasscontext222003* p, tnode171659* n) {
	...
	nimln(25, "docgen2.nim");
	{
		...
		writeoutput_310043((*g).Doc, LOC7, ((NimStringDesc*) &TMP7024), usewarning);		nimln(27, "docgen2.nim");
		pushSafePoint(&TMP7025);
		TMP7025.status = setjmp(TMP7025.context);
		if (TMP7025.status == 0) {
			...
			if (isObj(getCurrentException()->Sup.m_type, (&NTI1033))) {
				TMP7025.status = 0;
				popCurrentException();
			}		}		if (TMP7025.status != 0) reraiseException();
	}	LA5: ;
	popFrame();
	return result;
}
...
static TNimNode* TMP7023[2];
static TNimNode TMP7021[3];
...
TMP7023[0] = &TMP7021[1];
TMP7021[1].kind = 1;
TMP7021[1].offset = offsetof(tgen415007, Doc);
TMP7021[1].typ = (&NTI307007);
TMP7021[1].name = "doc";
TMP7023[1] = &TMP7021[2];
TMP7021[2].kind = 1;
TMP7021[2].offset = offsetof(tgen415007, Module);
TMP7021[2].typ = (&NTI171657);
TMP7021[2].name = "module";
TMP7021[0].len = 2; TMP7021[0].kind = 2; TMP7021[0].sons = &TMP7023[0];
NTI415007.node = &TMP7021[0];
NTI415009.size = sizeof(tgen415007*);
NTI415009.kind = 22;
NTI415009.base = (&NTI415007);
NTI415009.flags = 2;
NTI415009.marker = TMP7026;
}
