...
N_NIMCALL(tnode209818*, close_538018)(tpasscontext264005* p, tnode209818* n) {
	...
	usewarning = !((((*(*g).Module).Flags &(1<<((((NU8) 12))&31)))!=0));
	{
		...
		writeoutput_370404((*g).Doc, LOC7, ((NimStringDesc*) &TMP4755), usewarning);
		pushSafePoint(&TMP4756);
		TMP4756.status = _setjmp(TMP4756.context);
		if (TMP4756.status == 0) {
