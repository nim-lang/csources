...
N_NIMCALL(void, fillbuffer_178097)(Tbaselexer178024* L) {
	...
	LA3: ;
	LOC5 = 0;
	LOC5 = llstreamread_177584((*L).stream, ((void*) ((&(*L).buf[tocopy]))), (NI)((NI)((*L).sentinel + ((NI) 1)) * ((NI) 1)));
		...
		s -= ((NI) 1);
		{
			while (1) {
				...
				LA19: ;
				{
					...
					LOC23 = 0;
					LOC23 = llstreamread_177584((*L).stream, ((void*) ((&(*L).buf[oldbuflen]))), (NI)(oldbuflen * ((NI) 1)));
...
TMP1091[0] = &TMP711[1];
TMP711[1].kind = 1;
TMP711[1].offset = offsetof(Tbaselexer178024, bufpos);
TMP711[1].typ = (&NTI108);
TMP711[1].name = "bufpos";
TMP1091[1] = &TMP711[2];
TMP711[2].kind = 1;
TMP711[2].offset = offsetof(Tbaselexer178024, buf);
TMP711[2].typ = (&NTI151);
TMP711[2].name = "buf";
TMP1091[2] = &TMP711[3];
TMP711[3].kind = 1;
TMP711[3].offset = offsetof(Tbaselexer178024, buflen);
TMP711[3].typ = (&NTI108);
TMP711[3].name = "bufLen";
TMP1091[3] = &TMP711[4];
TMP711[4].kind = 1;
TMP711[4].offset = offsetof(Tbaselexer178024, stream);
TMP711[4].typ = (&NTI177206);
TMP711[4].name = "stream";
TMP1091[4] = &TMP711[5];
TMP711[5].kind = 1;
TMP711[5].offset = offsetof(Tbaselexer178024, linenumber);
TMP711[5].typ = (&NTI108);
TMP711[5].name = "lineNumber";
TMP1091[5] = &TMP711[6];
TMP711[6].kind = 1;
TMP711[6].offset = offsetof(Tbaselexer178024, sentinel);
TMP711[6].typ = (&NTI108);
TMP711[6].name = "sentinel";
TMP1091[6] = &TMP711[7];
TMP711[7].kind = 1;
TMP711[7].offset = offsetof(Tbaselexer178024, linestart);
TMP711[7].typ = (&NTI108);
TMP711[7].name = "lineStart";
TMP711[0].len = 7; TMP711[0].kind = 2; TMP711[0].sons = &TMP1091[0];
NTI178024.node = &TMP711[0];
}
