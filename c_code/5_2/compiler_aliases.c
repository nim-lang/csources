...
STRING_LITERAL(TMP3361, "isPartOfAux(record case branch)", 31);
STRING_LITERAL(TMP3362, "isPartOfAux()", 13);
...
{	result = 0;
		...
		LA13: ;
		{
			...
			res_415248 = ((NI) 1);
			{
				while (1) {
					...
					default:
					{
						internalerror_187113(((NimStringDesc*) &TMP3361));
					}
					break;
					}
					res_415248 += ((NI) 1);
	...
	default:
	{
		internalerror_187100((*n).info, ((NimStringDesc*) &TMP3362));
	}
	break;
	}
	}BeforeRet: ;
