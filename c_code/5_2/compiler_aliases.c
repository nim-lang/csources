...
static NIM_CONST TY171865 TMP5027 = {
...
static N_INLINE(tnode171659*, lastson_172030)(tnode171659* n) {
	...
	if ((NU)((NI64)(TMP5032)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI64)(TMP5032)];
	popFrame();
	return result;
}
N_NIMCALL(NU8, ispartofaux_325019)(tnode171659* n, ttype171693* b, tintset168043* marker) {
	...
	case ((NU8) 134):
	{
		...
		while (1) {
			...
			default:
			{
				...
				internalerror_138383(((NimStringDesc*) &TMP5033));			}			break;
			}
			nimln(1304, "system.nim");
	...
	default:
	{
		...
		internalerror_138369((*n).Info, ((NimStringDesc*) &TMP5036));	}	break;
	}
	BeforeRet: ;	popFrame();
	return result;
}
...
static N_INLINE(ttype171693*, lastson_172034)(ttype171693* n) {
	...
	if ((NU)((NI64)(TMP5037)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP5037)];
	popFrame();
	return result;
}
N_NIMCALL(NU8, ispartofaux_325012)(ttype171693* a, ttype171693* b, tintset168043* marker) {
