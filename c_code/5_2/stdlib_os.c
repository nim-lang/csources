...
STRING_LITERAL(TMP1231, "/proc/", 6);
STRING_LITERAL(TMP1232, "/file", 5);
STRING_LITERAL(TMP1234, "invalid index", 13);
STRING_LITERAL(TMP1235, "PATH", 4);
STRING_LITERAL(TMP1790, "HOME", 4);
STRING_LITERAL(TMP1791, "/", 1);
STRING_LITERAL(TMP2054, "/.config/", 9);
STRING_LITERAL(TMP3669, ".", 1);
STRING_LITERAL(TMP3670, "..", 2);
...
N_NIMCALL(NimStringDesc*, nosexpandFilename)(NimStringDesc* filename) {
	...
	r = realpath(filename->data, result->data);
	{
		...
		raiseoserror_120803(LOC5, ((NimStringDesc*) &TMP146));
	}
	LA3: ;
	LOC6 = 0;
...
{	result = 0;
	...
	LOC7 = 0;
	LOC7 = (*e_131414).Sup.message; (*e_131414).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1234));
...
{	result = 0;
	result = paramstr_131407(((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			p_132202 = 0;
			HEX3Atmp_132209 = 0;
			HEX3Atmp_132209 = getenv_125825(((NimStringDesc*) &TMP1235));
			last_132214 = ((NI) 0);
			{
				while (1) {
					NI first_132216;
...
N_NIMCALL(void, rawcreatedir_127631)(NimStringDesc* dir) {
	{
		...
		raiseoserror_120803(LOC8, ((NimStringDesc*) &TMP146));
	}
	LA6: ;
}
...
{	result = 0;
	LOC1 = 0;
	LOC2 = 0;
	LOC2 = getenv_125825(((NimStringDesc*) &TMP1790));
	LOC1 = rawNewString(LOC2->Sup.len + 1);
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP1791));
	result = LOC1;
	goto BeforeRet;
	}BeforeRet: ;
	return result;
...
appendString(LOC7, val);
	...
	LA1: ;
	{
		...
		raiseoserror_120803(LOC14, ((NimStringDesc*) &TMP146));
	}
	LA12: ;
}
...
{	result = 0;
	...
	LA4: ;
	path = getenv_125825(((NimStringDesc*) &TMP1235));
	{
...
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &TMP2054));
	result = LOC1;
	goto BeforeRet;
	}BeforeRet: ;
	return result;
...
N_NOINLINE(void, nosraiseOSError)(NimStringDesc* msg) {
	{
		...
		LA7: ;
		{
			NimStringDesc* LOC11;
			LOC11 = 0;
			LOC11 = (*e_120408).Sup.Sup.message; (*e_120408).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP1228));
				...
				while (1) {
					{
						...
						y_127626 = cstrToNimstr(((NCSTRING) ((*x_127624).d_name)));
						{
							...
							NU8 k_127630;
							LOC15 = 0;
							LOC15 = !(eqStrings(y_127626, ((NimStringDesc*) &TMP3669)));
							if (!(LOC15)) goto LA16;
...
N_NIMCALL(void, noscopyFile)(NimStringDesc* source, NimStringDesc* dest) {
	...
	s = 0;
	{
		...
		LOC6 = 0;
		LOC6 = oslasterror_120819();
		raiseoserror_120803(LOC6, ((NimStringDesc*) &TMP146));
	}
	LA4: ;
	{
		NIM_BOOL LOC9;
		...
		raiseoserror_120803(LOC12, ((NimStringDesc*) &TMP146));
	}
	LA10: ;
		...
		while (1) {
			...
			bytesread = readbuffer_15554(s, buf, ((NI) 8000));
			{
				...
				byteswritten = writebuffer_15576(d, buf, ((NI) (bytesread)));
				{
					...
					raiseoserror_120803(LOC23, ((NimStringDesc*) &TMP146));
				}
				LA21: ;
			}
			LA17: ;
