...
NIM_CONST TY177510 Cpu_177496_4151366050 = {{((NimStringDesc*) &T4151366050_3),
((NI) 32),
((Tendian177474) 0),
((NI) 64),
((NI) 32)}
...
NIM_CONST TY177082 Os_177068_4151366050 = {{((NimStringDesc*) &T4151366050_22),
...
;
STRING_LITERAL(T4151366050_72, "freebsd", 7);
Tsystemcpu177452 targetcpu_177627_4151366050;
Tsystemcpu177452 hostcpu_177628_4151366050;
Tsystemos177004 targetos_177629_4151366050;
Tsystemos177004 hostos_177630_4151366050;
NI intsize_177641_4151366050;
NI floatsize_177642_4151366050;
NI ptrsize_177643_4151366050;
NimStringDesc* tnl_177644_4151366050;
...
N_NIMCALL(void, settarget_177649_4151366050)(Tsystemos177004 o0, Tsystemcpu177452 c0) {
	NimStringDesc* LOC1;
	targetcpu_177627_4151366050 = c0;
	targetos_177629_4151366050 = o0;
	intsize_177641_4151366050 = (NI)(Cpu_177496_4151366050[(c0)- 1].Field1 / ((NI) 8));
	floatsize_177642_4151366050 = (NI)(Cpu_177496_4151366050[(c0)- 1].Field3 / ((NI) 8));
	ptrsize_177643_4151366050 = (NI)(Cpu_177496_4151366050[(c0)- 1].Field4 / ((NI) 8));
	LOC1 = (NimStringDesc*)0;
	LOC1 = tnl_177644_4151366050; tnl_177644_4151366050 = copyStringRC1(Os_177068_4151366050[(o0)- 1].Field5);
	if (LOC1) nimGCunrefNoCycle(LOC1);
}
NIM_EXTERNC N_NOINLINE(void, compiler_platformInit000)(void) {
nimRegisterGlobalMarker(T4151366050_2);
	hostcpu_177628_4151366050 = nametocpu_177638_4151366050(((NimStringDesc*) &T4151366050_12));
	hostos_177630_4151366050 = nametoos_177635_4151366050(((NimStringDesc*) &T4151366050_72));
	settarget_177649_4151366050(hostos_177630_4151366050, hostcpu_177628_4151366050);
}
