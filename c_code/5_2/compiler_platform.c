...
N_NIMCALL(void, settarget_175637)(NU8 o, NU8 c) {
	...
	targetcpu_175603 = c;
	targetos_175605 = o;
	intsize_175626 = (NI64)(cpu_175496[(c)- 1].Field1 / 8);
	floatsize_175627 = (NI64)(cpu_175496[(c)- 1].Field3 / 8);
	ptrsize_175628 = (NI64)(cpu_175496[(c)- 1].Field4 / 8);
	LOC1 = 0;
...
NIM_EXTERNC N_NOINLINE(void, compiler_platformInit)(void) {
	hostcpu_175604 = nametocpu_175620(((NimStringDesc*) &TMP67));
