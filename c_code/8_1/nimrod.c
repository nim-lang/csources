...
N_NIMCALL(void, handlecmdline_528603)(void);
...
STRING_LITERAL(TMP7786, "./", 2);
STRING_LITERAL(TMP7787, "", 0);
STRING_LITERAL(TMP7789, "nimrod.cfg", 10);
STRING_LITERAL(TMP7790, "js", 2);
STRING_LITERAL(TMP7791, "node ", 5);
...
extern NimStringDesc* arguments_522205;
...
appendString(LOC7, ((NimStringDesc*) &TMP7786));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
N_NIMCALL(void, handlecmdline_528603)(void) {
	...
	nimln(35, "nimrod.nim");
	{
		...
		nimln(35, "nimrod.nim");
		LOC3 = 0;
		LOC3 = paramcount_113233();
		if (!(LOC3 == 0)) goto LA4;
		nimln(36, "nimrod.nim");
		writecommandlineusage_170002();
	}
	goto LA1;
	LA4: ;
	{
		nimln(39, "nimrod.nim");
		processcmdline_522207(((NU8) 0), ((NimStringDesc*) &TMP7787));
		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP7788;
			TY107700 p;
			...
			nimln(40, "nimrod.nim");
			nimln(40, "nimrod.nim");
			if (!!(((gprojectname_134206) && (gprojectname_134206)->Sup.len == 0))) goto LA9;
			nimln(41, "nimrod.nim");
			pushSafePoint(&TMP7788);
			TMP7788.status = setjmp(TMP7788.context);
			if (TMP7788.status == 0) {
				nimln(42, "nimrod.nim");
				asgnRefNoCycle((void**) &gprojectfull_134208, canonicalizepath_134335(gprojectname_134206));
				popSafePoint();
			}
			else {
				popSafePoint();
				...
				if (isObj(getCurrentException()->Sup.m_type, (&NTI2435))) {
					...
					nimln(44, "nimrod.nim");
					LOC14 = 0;
					LOC14 = gprojectfull_134208; gprojectfull_134208 = copyStringRC1(gprojectname_134206);
			...
			nossplitFile(gprojectfull_134208, &p);
			nimln(46, "nimrod.nim");
			LOC15 = 0;
			LOC15 = gprojectpath_134207; gprojectpath_134207 = copyStringRC1(p.Field0);
			if (LOC15) nimGCunrefNoCycle(LOC15);
			nimln(47, "nimrod.nim");
			LOC16 = 0;
			LOC16 = gprojectname_134206; gprojectname_134206 = copyStringRC1(p.Field1);
		...
		{
			nimln(49, "nimrod.nim");
			asgnRefNoCycle((void**) &gprojectpath_134207, nosgetCurrentDir());
		}
		LA7: ;
		nimln(50, "nimrod.nim");
		loadconfigs_180607(((NimStringDesc*) &TMP7789));
		nimln(53, "nimrod.nim");
		initvars_166714();
		nimln(54, "nimrod.nim");
		processcmdline_522207(((NU8) 1), ((NimStringDesc*) &TMP7787));
		nimln(55, "nimrod.nim");
		maincommand_526011();
		nimln(56, "nimrod.nim");
		{
		...
		{
			nimln(58, "nimrod.nim");
			if (!(gerrorcounter_161182 == 0)) goto LA25;
			nimln(62, "nimrod.nim");
			{
				nimln(62, "nimrod.nim");
				if (!((gglobaloptions_134111 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				nimln(63, "nimrod.nim");
				{
					NimStringDesc* ex;
					NimStringDesc* LOC44;
					nimln(63, "nimrod.nim");
					if (!(gcmd_134113 == ((NU8) 4))) goto LA33;
					ex = 0;
					nimln(65, "nimrod.nim");
					{
						NimStringDesc* LOC39;
						nimln(65, "nimrod.nim");
						nimln(65, "nimrod.nim");
						if (!(0 < outfile_134117->Sup.len)) goto LA37;
						nimln(66, "nimrod.nim");
						nimln(66, "nimrod.nim");
						LOC39 = 0;
						LOC39 = prependcurdir_528401(outfile_134117);
					...
					LA37: ;
					{
						...
						nimln(69, "nimrod.nim");
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_134208, ((NimStringDesc*) &TMP7790));
						LOC42 = 0;
						LOC42 = prependcurdir_528401(LOC41);
						LOC43 = 0;
						LOC43 = completecfilepath_166753(LOC42, NIM_TRUE);
					...
					nimln(70, "nimrod.nim");
					LOC44 = 0;
					LOC44 = rawNewString(ex->Sup.len + arguments_522205->Sup.len + 6);
appendString(LOC44, ((NimStringDesc*) &TMP7791));
appendString(LOC44, ex);
appendChar(LOC44, 32);
appendString(LOC44, arguments_522205);
					execexternalprogram_166785(LOC44);
				}
				goto LA31;
				LA33: ;
				{
					...
					nimln(73, "nimrod.nim");
					{
						nimln(73, "nimrod.nim");
						nimln(73, "nimrod.nim");
						if (!(0 < outfile_134117->Sup.len)) goto LA48;
						nimln(75, "nimrod.nim");
						binpath = prependcurdir_528401(outfile_134117);
					}
					goto LA46;
					LA48: ;
					{
						...
						nimln(78, "nimrod.nim");
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_134208, ((NimStringDesc*) &TMP7787));
						binpath = prependcurdir_528401(LOC51);
					}
					LA46: ;
					nimln(79, "nimrod.nim");
					...
					nimln(80, "nimrod.nim");
					LOC52 = 0;
					LOC52 = rawNewString(ex->Sup.len + arguments_522205->Sup.len + 1);
appendString(LOC52, ex);
appendChar(LOC52, 32);
appendString(LOC52, arguments_522205);
					execexternalprogram_166785(LOC52);
				}
				LA31: ;
			}
			LA29: ;
...
N_NOINLINE(void, nimrodInit)(void) {
	...
	initdefines_165072();
	nimln(91, "nimrod.nim");
	handlecmdline_528603();
	nimln(92, "nimrod.nim");
	nimln(92, "nimrod.nim");
	exit(((NI) (((NI8) ((0 < gerrorcounter_161182))))));
	popFrame();
}
