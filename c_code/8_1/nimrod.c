...
N_NIMCALL(NimStringDesc*, prependcurdir_533401)(NimStringDesc* f);
...
N_NIMCALL(void, handlecmdline_533603)(void);
...
STRING_LITERAL(TMP7781, "./", 2);
STRING_LITERAL(TMP7782, "", 0);
STRING_LITERAL(TMP7784, "nimrod.cfg", 10);
STRING_LITERAL(TMP7785, "js", 2);
STRING_LITERAL(TMP7786, "node ", 5);
...
extern NimStringDesc* arguments_527205;
...
appendString(LOC7, ((NimStringDesc*) &TMP7781));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
N_NIMCALL(void, handlecmdline_533603)(void) {
	...
	nimln(35, "nimrod.nim");
	{
		...
		if (!(LOC3 == 0)) goto LA4;
		nimln(36, "nimrod.nim");
		writecommandlineusage_175002();
	}
	goto LA1;
	LA4: ;
	{
		nimln(39, "nimrod.nim");
		processcmdline_527207(((NU8) 0), ((NimStringDesc*) &TMP7782));
		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP7783;
			TY108700 p;
			...
			nimln(41, "nimrod.nim");
			pushSafePoint(&TMP7783);
			TMP7783.status = setjmp(TMP7783.context);
			if (TMP7783.status == 0) {
				nimln(42, "nimrod.nim");
			...
			if (TMP7783.status != 0) reraiseException();
			nimln(45, "nimrod.nim");
			chckNil((void*)&p);
		...
		LA7: ;
		nimln(50, "nimrod.nim");
		loadconfigs_186607(((NimStringDesc*) &TMP7784));
		nimln(53, "nimrod.nim");
		initvars_171714();
		nimln(54, "nimrod.nim");
		processcmdline_527207(((NU8) 1), ((NimStringDesc*) &TMP7782));
		nimln(55, "nimrod.nim");
		maincommand_531011();
		nimln(56, "nimrod.nim");
		{
		...
		{
			nimln(58, "nimrod.nim");
			if (!(gerrorcounter_166182 == 0)) goto LA25;
			nimln(62, "nimrod.nim");
			{
				nimln(62, "nimrod.nim");
				...
				nimln(63, "nimrod.nim");
				{
					...
					nimln(65, "nimrod.nim");
					{
						...
						nimln(66, "nimrod.nim");
						LOC39 = 0;
						LOC39 = prependcurdir_533401(outfile_137117);
					...
					LA37: ;
					{
						...
						nimln(69, "nimrod.nim");
						LOC41 = 0;
						LOC41 = noschangeFileExt(gprojectfull_137208, ((NimStringDesc*) &TMP7785));
						LOC42 = 0;
						LOC42 = prependcurdir_533401(LOC41);
						LOC43 = 0;
						LOC43 = completecfilepath_171753(LOC42, NIM_TRUE);
					...
					nimln(70, "nimrod.nim");
					LOC44 = 0;
					LOC44 = rawNewString(ex->Sup.len + arguments_527205->Sup.len + 6);
appendString(LOC44, ((NimStringDesc*) &TMP7786));
appendString(LOC44, ex);
appendChar(LOC44, 32);
appendString(LOC44, arguments_527205);
					execexternalprogram_171785(LOC44);
				}
				goto LA31;
				LA33: ;
				{
					...
					nimln(73, "nimrod.nim");
					{
						...
						nimln(75, "nimrod.nim");
						binpath = prependcurdir_533401(outfile_137117);
					}
					goto LA46;
					LA48: ;
					{
						...
						nimln(78, "nimrod.nim");
						LOC51 = 0;
						LOC51 = noschangeFileExt(gprojectfull_137208, ((NimStringDesc*) &TMP7782));
						binpath = prependcurdir_533401(LOC51);
					}
					LA46: ;
					nimln(79, "nimrod.nim");
					...
					nimln(80, "nimrod.nim");
					LOC52 = 0;
					LOC52 = rawNewString(ex->Sup.len + arguments_527205->Sup.len + 1);
appendString(LOC52, ex);
appendChar(LOC52, 32);
appendString(LOC52, arguments_527205);
					execexternalprogram_171785(LOC52);
				}
				LA31: ;
			}
			LA29: ;
...
N_NOINLINE(void, nimrodInit)(void) {
	...
	initdefines_170072();
	nimln(91, "nimrod.nim");
	handlecmdline_533603();
	nimln(92, "nimrod.nim");
	nimln(92, "nimrod.nim");
	exit(((NI) (((NI8) ((0 < gerrorcounter_166182))))));
	popFrame();
}
