...
N_NIMCALL(NI, parseword_526002)(NimStringDesc* s, NI i, NimStringDesc** w, TY122387 delim);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(NimStringDesc*, addChar)(NimStringDesc* s, NIM_CHAR c);
N_NIMCALL(void, handleshortoption_526106)(toptparser525807* p);
...
N_NIMCALL(void, initoptparser_525819)(NimStringDesc* cmdline, toptparser525807* Result) {
	...
	LA3: ;
	{
		...
		unsureAsgnRef((void**) &(*Result).Cmd, copyString(((NimStringDesc*) &TMP7628)));
		i_525835 = 0;
		HEX3Atmp_525837 = 0;
		nimln(53, "parseopt.nim");
		HEX3Atmp_525837 = paramcount_114233();
		...
		while (1) {
			...
			NimStringDesc* LOC9;
			nimln(1452, "system.nim");
			if (!(res_525839 <= HEX3Atmp_525837)) goto LA6;
			nimln(1451, "system.nim");
			i_525835 = res_525839;
...
appendChar(LOC7, 32);
			...
			res_525839 = addInt(res_525839, 1);
		} LA6: ;
	}
	LA1: ;
	...
	unsureAsgnRef((void**) &(*Result).Key, copyString(((NimStringDesc*) &TMP7631)));
	nimln(57, "parseopt.nim");
	unsureAsgnRef((void**) &(*Result).Val, copyString(((NimStringDesc*) &TMP7631)));
	popFrame();
}
...
N_NIMCALL(void, handleshortoption_526106)(toptparser525807* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_526002((*p).Cmd, i, &(*p).Val, TMP7632);
	}
	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser525807* p) {
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_526002((*p).Cmd, i, &(*p).Key, TMP7633);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_526002((*p).Cmd, i, &(*p).Val, TMP7632);
			}
			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_526002((*p).Cmd, i, &(*p).Key, TMP7632);
	}
	break;
	}
	BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser525807* p) {
	...
	nimln(128, "parseopt.nim");
	nimln(128, "parseopt.nim");
	TMP7634 = subInt((*p).Cmd->Sup.len, 1);
	LOC1 = 0;
	LOC1 = copyStrLast((*p).Cmd, (*p).Pos, (NI32)(TMP7634));
...
static TNimNode* TMP7636[6];
static TNimNode* TMP7637[4];
NI TMP7639;
static char* NIM_CONST TMP7638[4] = {
"cmdEnd", 
"cmdArgument", 
"cmdLongoption", 
"cmdShortOption"};
static TNimNode TMP7626[12];
NTI525807.size = sizeof(toptparser525807);
NTI525807.kind = 17;
NTI525807.base = (&NTI2409);
TMP7636[0] = &TMP7626[1];
TMP7626[1].kind = 1;
TMP7626[1].offset = offsetof(toptparser525807, Cmd);
TMP7626[1].typ = (&NTI143);
TMP7626[1].name = "cmd";
TMP7636[1] = &TMP7626[2];
TMP7626[2].kind = 1;
TMP7626[2].offset = offsetof(toptparser525807, Pos);
TMP7626[2].typ = (&NTI106);
TMP7626[2].name = "pos";
TMP7636[2] = &TMP7626[3];
TMP7626[3].kind = 1;
TMP7626[3].offset = offsetof(toptparser525807, Inshortstate);
TMP7626[3].typ = (&NTI134);
TMP7626[3].name = "inShortState";
TMP7636[3] = &TMP7626[4];
NTI525805.size = sizeof(NU8);
NTI525805.kind = 14;
NTI525805.base = 0;
NTI525805.flags = 3;
for (TMP7639 = 0; TMP7639 < 4; TMP7639++) {
TMP7626[TMP7639+5].kind = 1;
TMP7626[TMP7639+5].offset = TMP7639;
TMP7626[TMP7639+5].name = TMP7638[TMP7639];
TMP7637[TMP7639] = &TMP7626[TMP7639+5];
}
TMP7626[9].len = 4; TMP7626[9].kind = 2; TMP7626[9].sons = &TMP7637[0];
NTI525805.node = &TMP7626[9];
TMP7626[4].kind = 1;
TMP7626[4].offset = offsetof(toptparser525807, Kind);
TMP7626[4].typ = (&NTI525805);
TMP7626[4].name = "kind";
TMP7636[4] = &TMP7626[10];
TMP7626[10].kind = 1;
TMP7626[10].offset = offsetof(toptparser525807, Key);
TMP7626[10].typ = (&NTI143);
TMP7626[10].name = "key";
TMP7636[5] = &TMP7626[11];
TMP7626[11].kind = 1;
TMP7626[11].offset = offsetof(toptparser525807, Val);
TMP7626[11].typ = (&NTI143);
TMP7626[11].name = "val";
TMP7626[0].len = 6; TMP7626[0].kind = 2; TMP7626[0].sons = &TMP7636[0];
NTI525807.node = &TMP7626[0];
}
