...
static N_INLINE(tnode190813*, lastson_191199)(tnode190813* n) {
	...
	if ((NU)((NI32)(TMP5684)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI32)(TMP5684)];
	popFrame();
	return result;
}
...
N_NIMCALL(tsym190843*, ithfield_419007)(tnode190813* n, NI field) {
	...
	case ((NU8) 136):
	{
		...
		while (1) {
			...
			result = ithfield_419007((*n).kindU.S6.Sons->data[i_419024], (NI32)(TMP5680));
	...
	case ((NU8) 137):
	{
		...
		result = ithfield_419007((*n).kindU.S6.Sons->data[0], (NI32)(TMP5682));
		...
		while (1) {
			...
			case ((NU8) 88):
			{
				...
				result = ithfield_419007(LOC20, (NI32)(TMP5685));
