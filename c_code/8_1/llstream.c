...
N_NIMCALL(NI, counttriples_172676)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			nimln(109, "llstream.nim");
			TMP1639 = addInt(i, 1);
			if ((NU)((NI32)(TMP1639)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC5 = ((NU8)(s->data[(NI32)(TMP1639)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			...
			LOC4 = ((NU8)(s->data[(NI32)(TMP1640)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
appendString((*s).S, ((NimStringDesc*) &TMP1643));
	...
	result = ((buflen <= (NI32)(TMP1644)) ? buflen : (NI32)(TMP1644));
...
N_NIMCALL(NI, llstreamread_172242)(tllstream172204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		nimln(136, "llstream.nim");
		{
			...
			memcpy(buf, ((void*) (&(*s).S->data[(NI32)(TMP1646)])), result);
...
N_NIMCALL(void, llstreamwrite_172268)(tllstream172204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			(*s).S = setLengthStr((*s).S, (NI32)(TMP1647));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1648 = addInt(0, (*s).Wr);
			if ((NU)((NI32)(TMP1648)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI32)(TMP1648)])), buf, buflen);
...
N_NIMCALL(NimStringDesc*, llstreamreadall_172254)(tllstream172204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI32)(TMP1649));
			nimln(222, "llstream.nim");
			nimln(222, "llstream.nim");
			TMP1650 = addInt(i, 0);
			if ((NU)((NI32)(TMP1650)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_10627((*s).F, ((void*) (&result->data[(NI32)(TMP1650)])), 2048);
