...
N_NIMCALL(NCSTRING*, envtocstringarray_127841)(void) {
	...
	while (1) {
		...
		key_127845 = copyStrLast(environment_110806->data[i_127886], 0, (NI32)(TMP367));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_127886) >= (NU)(environment_110806->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP368 = addInt(p_127892, 1);
		val_127846 = copyStr(environment_110806->data[i_127886], (NI32)(TMP368));
	...
	while (1) {
		...
		key_127865 = copyStrLast(environment_110806->data[i_127902], 0, (NI32)(TMP371));
		nimln(1184, "os.nim");
		nimln(1184, "os.nim");
		if ((NU)(i_127902) >= (NU)(environment_110806->Sup.len)) raiseIndexError();
		nimln(1184, "os.nim");
		TMP372 = addInt(p_127908, 1);
		val_127866 = copyStr(environment_110806->data[i_127902], (NI32)(TMP372));
