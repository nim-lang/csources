...
typedef struct tgen524008 tgen524008;
...
NIM_CONST tpass249015 docgen2pass_524084 = {myopen_524058,
NIM_NIL,
processnode_524050,
close_524014}
;
extern TNimType NTI249003; /* TPassContext */
TNimType NTI524008; /* TGen */
...
N_NIMCALL(tnode190813*, close_524014)(tpasscontext249003* p, tnode190813* n) {
	...
	if (p) chckObj((*p).Sup.m_type, (&NTI524008));
	g = ((tgen524008*) (p));
	...
	nimln(25, "docgen2.nim");
	{
		...
		nimln(26, "docgen2.nim");
		LOC7 = 0;
		LOC7 = tofilename_166780(((NI32) ((*(*g).Module).Position)));
...
N_NIMCALL(tnode190813*, processnode_524050)(tpasscontext249003* c, tnode190813* n) {
	...
	if (c) chckObj((*c).Sup.m_type, (&NTI524008));
	g = ((tgen524008*) (c));
...
N_NIMCALL(tpasscontext249003*, myopen_524058)(tsym190843* module) {
	...
	g = (tgen524008*) newObj((&NTI524010), sizeof(tgen524008));
	(*g).Sup.Sup.m_type = (&NTI524008);
	nimln(40, "docgen2.nim");
	asgnRefNoCycle((void**) &(*g).Module, module);
	nimln(41, "docgen2.nim");
	nimln(41, "docgen2.nim");
	LOC1 = 0;
	LOC1 = tofilename_166780(((NI32) ((*module).Position)));
...
NTI524008.size = sizeof(tgen524008);
NTI524008.kind = 17;
NTI524008.base = (&NTI249003);
TMP7620[0] = &TMP7618[1];
TMP7618[1].kind = 1;
TMP7618[1].offset = offsetof(tgen524008, Doc);
TMP7618[1].typ = (&NTI344007);
TMP7618[1].name = "doc";
TMP7620[1] = &TMP7618[2];
TMP7618[2].kind = 1;
TMP7618[2].offset = offsetof(tgen524008, Module);
TMP7618[2].typ = (&NTI190811);
TMP7618[2].name = "module";
TMP7618[0].len = 2; TMP7618[0].kind = 2; TMP7618[0].sons = &TMP7620[0];
NTI524008.node = &TMP7618[0];
NTI524010.size = sizeof(tgen524008*);
NTI524010.kind = 22;
NTI524010.base = (&NTI524008);
NTI524010.marker = TMP7623;
}
