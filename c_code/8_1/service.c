...
typedef struct toptparser525807 toptparser525807;
...
N_NIMCALL(void, processcmdline_527207)(NU8 pass, NimStringDesc* cmd);
N_NIMCALL(void, initoptparser_525819)(NimStringDesc* cmdline, toptparser525807* Result);
N_NOINLINE(void, chckNil)(void* p);
N_NIMCALL(void, nponext)(toptparser525807* p);
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser525807* p);
...
NimStringDesc* curcaascmd_527203;
extern TFrame* frameptr_13238;
extern tgcheap43816 gch_43844;
NimStringDesc* lastcaascmd_527204;
NimStringDesc* arguments_527205;
extern TNimType NTI525807; /* TOptParser */
...
extern tsocketimpl152605* invalidsocket_152678;
extern tsocketimpl152605* stdoutsocket_166192;
...
N_NIMCALL(void, processcmdline_527207)(NU8 pass, NimStringDesc* cmd) {
	...
	p.Sup.m_type = (&NTI525807);
	initoptparser_525819(cmd, &p);
...
appendString(LOC8, p.Val);
				...
				processswitch_175016(key, val, pass, gcmdlineinfo_166104);
			}
			goto LA4;
			LA6: ;
			{
				nimln(48, "service.nim");
				processswitch_175016(p.Key, p.Val, pass, gcmdlineinfo_166104);
			}
			LA4: ;
		}
		break;
		case ((NU8) 1):
		{
			...
			LA14: ;
			{
				nimln(53, "service.nim");
				{
					...
					nimln(53, "service.nim");
					commandargs_137234 = (TY10865*) incrSeq(&(commandargs_137234)->Sup, sizeof(NimStringDesc*));
					LOC22 = 0;
				...
				nimln(54, "service.nim");
				{
					...
					asgnRefNoCycle((void**) &gprojectname_137206, nosunixToNativePath(p.Key, ((NimStringDesc*) &TMP7635)));
					nimln(57, "service.nim");
					asgnRefNoCycle((void**) &arguments_527205, npocmdLineRest(&p));
	...
	nimln(61, "service.nim");
	{
		...
		nimln(62, "service.nim");
		{
			...
			nimln(62, "service.nim");
			nimln(62, "service.nim");
			LOC33 = !(((arguments_527205) && (arguments_527205)->Sup.len == 0));
			LA34: ;
			if (!LOC33) goto LA35;
			nimln(63, "service.nim");
			memset((void*)LOC37, 0, sizeof(LOC37));
			rawmessage_167292(((NU16) 57), LOC37, 0);
		}
		LA35: ;
	}
	LA29: ;
...
N_NIMCALL(void, serve_527292)(TY527294 action) {
	...
	typ = getconfigvar_137311(((NimStringDesc*) &TMP7642));
	...
	LA1: ;
	{
		...
		while (1) {
			...
			LOC11 = 0;
			LOC11 = curcaascmd_527203; curcaascmd_527203 = copyStringRC1(line);
			if (LOC11) nimGCunrefNoCycle(LOC11);
			nimln(68, "service.nim");
			processcmdline_527207(((NU8) 1), line);
	...
	LA2: ;
	{
		tsocketimpl152605* server;
		NimStringDesc* p;
		NU16 port;
		NimStringDesc* LOC24;
		NimStringDesc* inp;
		nimln(86, "service.nim");
		server = socket_153402(((NU8) 2), ((NU8) 1), ((NU8) 6), NIM_TRUE);
		nimln(87, "service.nim");
		{
			NI32 LOC17;
			nimln(87, "service.nim");
			if (!(server == invalidsocket_152678)) goto LA15;
			nimln(87, "service.nim");
			nimln(87, "service.nim");
			LOC17 = 0;
		...
		p = getconfigvar_137311(((NimStringDesc*) &TMP7650));
		...
		nimln(90, "service.nim");
		LOC24 = 0;
		LOC24 = getconfigvar_137311(((NimStringDesc*) &TMP7651));
		bindaddr_154584(server, port, LOC24);
		nimln(91, "service.nim");
		inp = copyString(((NimStringDesc*) &TMP7635));
		nimln(92, "service.nim");
		listen_154405(server, SOMAXCONN);
		nimln(93, "service.nim");
		if (stdoutsocket_166192) nimGCunrefNoCycle(stdoutsocket_166192);
		stdoutsocket_166192 = (tsocketimpl152605*) newObjRC1((&NTI152607), sizeof(tsocketimpl152605));
		nimln(94, "service.nim");
		while (1) {
			NimStringDesc* LOC26;
			nimln(95, "service.nim");
			accept_156201(server, &stdoutsocket_166192);
			nimln(96, "service.nim");
			readline_161033(stdoutsocket_166192, &inp, -1);
			nimln(67, "service.nim");
			LOC26 = 0;
			LOC26 = curcaascmd_527203; curcaascmd_527203 = copyStringRC1(inp);
			if (LOC26) nimGCunrefNoCycle(LOC26);
			nimln(68, "service.nim");
			processcmdline_527207(((NU8) 1), inp);
			nimln(69, "service.nim");
			action();
			nimln(70, "service.nim");
			gdirtybufferidx_137127 = ((NI32) 0);
			...
			send_162604(stdoutsocket_166192, ((NimStringDesc*) &TMP7677));
			nimln(99, "service.nim");
			close_156266(stdoutsocket_166192);
		}
	}
	goto LA4;
	LA3: ;
...
N_NOINLINE(void, serviceInit)(void) {
	...
	LOC1 = 0;
	LOC1 = curcaascmd_527203; curcaascmd_527203 = copyStringRC1(((NimStringDesc*) &TMP7635));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(25, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_527204; lastcaascmd_527204 = copyStringRC1(((NimStringDesc*) &TMP7635));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(28, "service.nim");
	LOC3 = 0;
	LOC3 = arguments_527205; arguments_527205 = copyStringRC1(((NimStringDesc*) &TMP7635));
