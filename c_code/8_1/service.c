...
N_NIMCALL(void, processcmdline_522207)(NU8 pass, NimStringDesc* cmd);
...
NimStringDesc* curcaascmd_522203;
extern TFrame* frameptr_13038;
extern tgcheap43216 gch_43244;
NimStringDesc* lastcaascmd_522204;
NimStringDesc* arguments_522205;
extern TNimType NTI520807; /* TOptParser */
...
extern tsocketimpl147605* invalidsocket_147678;
extern tsocketimpl147605* stdoutsocket_161192;
...
N_NIMCALL(void, processcmdline_522207)(NU8 pass, NimStringDesc* cmd) {
	...
	p.Sup.m_type = (&NTI520807);
	initoptparser_520819(cmd, &p);
	...
	while (1) {
		...
		case ((NU8) 3):
		{
			...
			nimln(43, "service.nim");
			{
				...
				key = copyStrLast(p.Key, 0, (NI32)(TMP7645));
				...
				LOC9 = 0;
				LOC9 = copyStr(p.Key, (NI32)(TMP7646));
...
appendString(LOC8, p.Val);
				...
				processswitch_170016(key, val, pass, gcmdlineinfo_161104);
			}
			goto LA4;
			LA6: ;
			{
				nimln(48, "service.nim");
				processswitch_170016(p.Key, p.Val, pass, gcmdlineinfo_161104);
			}
			LA4: ;
		}
		break;
		case ((NU8) 1):
		{
			nimln(50, "service.nim");
			{
				...
				LOC16 = 0;
				LOC16 = command_134212; command_134212 = copyStringRC1(p.Key);
			...
			LA14: ;
			{
				nimln(53, "service.nim");
				{
					...
					nimln(53, "service.nim");
					commandargs_134234 = (TY10665*) incrSeq(&(commandargs_134234)->Sup, sizeof(NimStringDesc*));
					LOC22 = 0;
					LOC22 = commandargs_134234->data[commandargs_134234->Sup.len-1]; commandargs_134234->data[commandargs_134234->Sup.len-1] = copyStringRC1(p.Key);
				...
				nimln(54, "service.nim");
				{
					...
					asgnRefNoCycle((void**) &gprojectname_134206, nosunixToNativePath(p.Key, ((NimStringDesc*) &TMP7640)));
					nimln(57, "service.nim");
					asgnRefNoCycle((void**) &arguments_522205, npocmdLineRest(&p));
	...
	nimln(61, "service.nim");
	{
		...
		nimln(62, "service.nim");
		{
			...
			nimln(62, "service.nim");
			nimln(62, "service.nim");
			LOC33 = !(((gglobaloptions_134111 &(1<<((((NU8) 13))&31)))!=0));
			if (!(LOC33)) goto LA34;
			nimln(62, "service.nim");
			nimln(62, "service.nim");
			LOC33 = !(((arguments_522205) && (arguments_522205)->Sup.len == 0));
			LA34: ;
			if (!LOC33) goto LA35;
			nimln(63, "service.nim");
			memset((void*)LOC37, 0, sizeof(LOC37));
			rawmessage_162292(((NU16) 57), LOC37, 0);
		}
		LA35: ;
	}
	LA29: ;
...
N_NIMCALL(void, serve_522292)(TY522294 action) {
	...
	typ = getconfigvar_134311(((NimStringDesc*) &TMP7647));
	...
	LA1: ;
	{
		...
		while (1) {
			...
			LOC11 = 0;
			LOC11 = curcaascmd_522203; curcaascmd_522203 = copyStringRC1(line);
			if (LOC11) nimGCunrefNoCycle(LOC11);
			nimln(68, "service.nim");
			processcmdline_522207(((NU8) 1), line);
	...
	LA2: ;
	{
		tsocketimpl147605* server;
		NimStringDesc* p;
		NU16 port;
		NimStringDesc* LOC24;
		NimStringDesc* inp;
		nimln(86, "service.nim");
		server = socket_148402(((NU8) 2), ((NU8) 1), ((NU8) 6), NIM_TRUE);
		nimln(87, "service.nim");
		{
			NI32 LOC17;
			nimln(87, "service.nim");
			if (!(server == invalidsocket_147678)) goto LA15;
			nimln(87, "service.nim");
			nimln(87, "service.nim");
			LOC17 = 0;
		...
		p = getconfigvar_134311(((NimStringDesc*) &TMP7655));
		...
		nimln(90, "service.nim");
		LOC24 = 0;
		LOC24 = getconfigvar_134311(((NimStringDesc*) &TMP7656));
		bindaddr_149584(server, port, LOC24);
		nimln(91, "service.nim");
		inp = copyString(((NimStringDesc*) &TMP7640));
		nimln(92, "service.nim");
		listen_149405(server, SOMAXCONN);
		nimln(93, "service.nim");
		if (stdoutsocket_161192) nimGCunrefNoCycle(stdoutsocket_161192);
		stdoutsocket_161192 = (tsocketimpl147605*) newObjRC1((&NTI147607), sizeof(tsocketimpl147605));
		nimln(94, "service.nim");
		while (1) {
			NimStringDesc* LOC26;
			nimln(95, "service.nim");
			accept_151201(server, &stdoutsocket_161192);
			nimln(96, "service.nim");
			readline_156033(stdoutsocket_161192, &inp, -1);
			nimln(67, "service.nim");
			LOC26 = 0;
			LOC26 = curcaascmd_522203; curcaascmd_522203 = copyStringRC1(inp);
			if (LOC26) nimGCunrefNoCycle(LOC26);
			nimln(68, "service.nim");
			processcmdline_522207(((NU8) 1), inp);
			nimln(69, "service.nim");
			action();
			nimln(70, "service.nim");
			gdirtybufferidx_134127 = ((NI32) 0);
			...
			send_157604(stdoutsocket_161192, ((NimStringDesc*) &TMP7682));
			nimln(99, "service.nim");
			close_151266(stdoutsocket_161192);
		}
	}
	goto LA4;
	LA3: ;
...
N_NOINLINE(void, serviceInit)(void) {
	...
	LOC1 = 0;
	LOC1 = curcaascmd_522203; curcaascmd_522203 = copyStringRC1(((NimStringDesc*) &TMP7640));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(25, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_522204; lastcaascmd_522204 = copyStringRC1(((NimStringDesc*) &TMP7640));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(28, "service.nim");
	LOC3 = 0;
	LOC3 = arguments_522205; arguments_522205 = copyStringRC1(((NimStringDesc*) &TMP7640));
