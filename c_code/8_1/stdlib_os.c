...
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_6, "invalid index", 13);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_7, "PATH", 4);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_8, "Failed to create the directory", 30);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_9, "HOME", 4);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_10, "/", 1);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_11, "\012  0 <= bufsize ", 16);
NIM_CONST TY_nHXaesL0DJZHyVS07ARPRA Exeexts_ONrgkgAZ9bh6KVTWl4XeOSw = {((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_3)}
;
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_12, "/.config/", 9);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_14, ".", 1);
STRING_LITERAL(T_yu6cxgKBBXbNsTkT9cyMd4g_15, "..", 2);
static N_NIMCALL(void, Marker_TY_sM4lkSb7zS6F7OVMvW9cffQ)(void* p, NI op) {
...
{	result0 = (NimStringDesc*)0;
	...
	LOC7 = (NimStringDesc*)0;
	LOC7 = (*e_9c9avxASFO8rHZknrsDnVzEA).Sup.message; (*e_9c9avxASFO8rHZknrsDnVzEA).Sup.message = copyStringRC1(((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_6));
...
{	result0 = (NimStringDesc*)0;
	result0 = paramstr_eYicl3uwirn1ppNz7OCowg(((NI) 0));
	{
		...
		if (!LOC3) goto LA5;
		{
			...
			HEX3Atmp_FJT9c9bnJ3EGi20yEwysG8Fg = getenv_8zNgT9bxx7m9cTt2TeVdTdIw(((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_7));
...
N_NIMCALL(NIM_BOOL, existsorcreatedir_V86QyZrcGMPX0W9bv1Q53ww)(NimStringDesc* dir0) {
	...
	result0 = !(LOC1);
	{
		if (!result0) goto LA4;
		{
			...
			LOC11 = (*e_4he5nelRQAcl1XtPfaowrQ).Sup.Sup.message; (*e_4he5nelRQAcl1XtPfaowrQ).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_8));
...
{	result0 = (NimStringDesc*)0;
	...
	LOC2 = getenv_8zNgT9bxx7m9cTt2TeVdTdIw(((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_9));
	LOC1 = rawNewString(LOC2->Sup.len + 1);
appendString(LOC1, LOC2);
appendString(LOC1, ((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_10));
	result0 = LOC1;
	goto BeforeRet;
	}BeforeRet: ;
	return result0;
			...
			LA7: ;
			{
				...
				err0 = oslasterror_pMOMIZAQaKFp1XoL58mjVg();
				{
					...
					bufsize0 = (NI)((NU32)(bufsize0) << (NU32)(((NI) 1)));
					{
						...
						raiseassert_PpfSiTIeNpMAb9a5o6SglJw_2(((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_11));
					}
					LA17: ;
					result0 = mnewString(((NI) (bufsize0)));
				}
...
{	result0 = (NimStringDesc*)0;
	...
	path0 = getenv_8zNgT9bxx7m9cTt2TeVdTdIw(((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_7));
	{
...
N_NIMCALL(void, nosremoveDir)(NimStringDesc* dir0) {
	{
		...
		{
			TSafePoint T_yu6cxgKBBXbNsTkT9cyMd4g_13;
			if (!!((d_Snew50d2sxhgjxplaladWA == NIM_NIL))) goto LA4;
			pushSafePoint(&T_yu6cxgKBBXbNsTkT9cyMd4g_13);
			T_yu6cxgKBBXbNsTkT9cyMd4g_13.status = setjmp(T_yu6cxgKBBXbNsTkT9cyMd4g_13.context);
			if (T_yu6cxgKBBXbNsTkT9cyMd4g_13.status == 0) {
				{
					while (1) {
						...
						y_nqt04gTLPSvk7lCmOg2cqg = cstrToNimstr(((NCSTRING) ((*x_aQYTEBuHrMi9cGfwwrddjfg).d_name)));
						{
							...
							LOC15 = (NIM_BOOL)0;
							LOC15 = !(eqStrings(y_nqt04gTLPSvk7lCmOg2cqg, ((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_14)));
							if (!(LOC15)) goto LA16;
							LOC15 = !(eqStrings(y_nqt04gTLPSvk7lCmOg2cqg, ((NimStringDesc*) &T_yu6cxgKBBXbNsTkT9cyMd4g_15)));
							LA16: ;
							if (!LOC15) goto LA17;
			...
			if (T_yu6cxgKBBXbNsTkT9cyMd4g_13.status != 0) reraiseException();
		}
		LA4: ;
	}
