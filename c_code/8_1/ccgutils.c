...
static N_INLINE(ttype184847*, lastson_185203)(ttype184847* n) {
	...
	if ((NU)((NI32)(TMP6198)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP6198)];
	popFrame();
	return result;
}
...
N_NIMCALL(trope142007*, makellvmstring_462684)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(169, "ccgutils.nim");
		{
			...
			TMP6204 = modInt((NI32)(TMP6203), 64);
			if (!(((NI) ((NI32)(TMP6204))) == 0)) goto LA4;
