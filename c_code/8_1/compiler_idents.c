...
N_NOINLINE(void, compileridentsInit)(void) {
	...
	asgnRefNoCycle((void**) &idanon_140463, getident_140443(((NimStringDesc*) &TMP895)));
	nimln(109, "idents.nim");
	asgnRefNoCycle((void**) &iddelegator_140465, getident_140443(((NimStringDesc*) &TMP896)));
	popFrame();
}
...
NTI140011.flags = 3;
TMP885[0].kind = 1;
TMP885[0].offset = offsetof(tidobj140011, Id);
TMP885[0].typ = (&NTI105);
TMP885[0].name = "id";
NTI140011.node = &TMP885[0];
...
TMP892[0] = &TMP885[2];
TMP885[2].kind = 1;
TMP885[2].offset = offsetof(tident140017, S);
TMP885[2].typ = (&NTI142);
TMP885[2].name = "s";
TMP892[1] = &TMP885[3];
TMP885[3].kind = 1;
TMP885[3].offset = offsetof(tident140017, Next);
TMP885[3].typ = (&NTI140015);
TMP885[3].name = "next";
TMP892[2] = &TMP885[4];
TMP885[4].kind = 1;
TMP885[4].offset = offsetof(tident140017, H);
TMP885[4].typ = (&NTI109011);
TMP885[4].name = "h";
TMP885[1].len = 3; TMP885[1].kind = 2; TMP885[1].sons = &TMP892[0];
NTI140017.node = &TMP885[1];
NTI140015.size = sizeof(tident140017*);
NTI140015.kind = 22;
NTI140015.base = (&NTI140017);
NTI140015.flags = 2;
NTI140015.marker = TMP893;
NTI140013.size = sizeof(tidobj140011*);
NTI140013.kind = 22;
NTI140013.base = (&NTI140011);
NTI140013.flags = 2;
NTI140013.marker = TMP2022;
}
