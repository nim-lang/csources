	...
	case ((NU8) 3):
	{
		...
		nimln(31, "evaltempl.nim");
		{
			...
			LA8: ;
			{
				...
				LA30: ;
				LOC35 = 0;
				LOC35 = newsymnode_192723(x, LOC29);
...
N_NIMCALL(tnode190813*, evaltemplate_394275)(tnode190813* n, tsym190843* tmpl, tsym190843* gensymowner) {
	...
	body = getbody_242244(tmpl);
	nimln(91, "evaltempl.nim");
	{
		NIM_BOOL LOC7;
		nimln(91, "evaltempl.nim");
		LOC7 = 0;
		LOC7 = isatom_197186(body);
		if (!LOC7) goto LA8;
