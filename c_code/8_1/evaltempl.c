	...
	case ((NU8) 3):
	{
		...
		nimln(31, "evaltempl.nim");
		{
			...
			LA8: ;
			{
				...
				LA30: ;
				LOC35 = 0;
				LOC35 = newsymnode_186723(x, LOC29);
...
N_NIMCALL(tnode184813*, evaltemplate_388275)(tnode184813* n, tsym184843* tmpl, tsym184843* gensymowner) {
	...
	body = getbody_236244(tmpl);
	nimln(91, "evaltempl.nim");
	{
		NIM_BOOL LOC7;
		nimln(91, "evaltempl.nim");
		LOC7 = 0;
		LOC7 = isatom_191186(body);
		if (!LOC7) goto LA8;
