	...
	case ((NU8) 3):
	{
		...
		s = (*templ).kindU.S4.Sym;
		{
			...
			LA8: ;
			{
				...
				LA33: ;
				LOC38 = 0;
				LOC38 = newsymnode_225755(x, LOC32);
...
N_NIMCALL(tnode223819*, evaltemplate_450334)(tnode223819* n, tsym223849* tmpl, tsym223849* gensymowner) {
	...
	body = getbody_277270(tmpl);
	{
		NIM_BOOL LOC7;
		LOC7 = 0;
		LOC7 = isatom_230962(body);
		if (!LOC7) goto LA8;
