...
N_NIMCALL(void, md5Init_TD1qNpCBAlKjZlVJ9cbPeVg)(MD5Context_oMciKUdSdCaIeMtcxbiPOw* c) {
	...
	zeroMem_7EL8Zq3xF2ujDWgp3bAEogsystem(((void*) ((*c).buffer)), ((NI) (((NI)sizeof(TY_w5VB8h5K8DB3oWrO5U2wqg)))));
}
	...
	j = ((NI) 0);
	{
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				i = ((NI) (res));
				dest[(i)- 0] = (unsigned int)((unsigned int)((unsigned int)(((NU32) (((NU8)(src[j])))) | (NU32)((NU32)(((NU32) (((NU8)(src[(NI)(j + ((NI) 1))]))))) << (NU32)(((NI) 8)))) | (NU32)((NU32)(((NU32) (((NU8)(src[(NI)(j + ((NI) 2))]))))) << (NU32)(((NI) 16)))) | (NU32)((NU32)(((NU32) (((NU8)(src[(NI)(j + ((NI) 3))]))))) << (NU32)(((NI) 24))));
				j += ((NI) 4);
				res += ((NI) 1);
			} LA3: ;
		}
...
N_NIMCALL(void, transform_BVJTPXCwb2rPwlDOJoCtcQ)(void* buffer, NU32* state) {
	TY_U0SiHM0pVagA9c71oWelQMA myBlock;
	NU32 a;
	NU32 b;
	NU32 c;
	NU32 d;
...
N_NIMCALL(void, md5Update_2rxQixjUkbT0w5WdNOCwMw)(MD5Context_oMciKUdSdCaIeMtcxbiPOw* c, NCSTRING input, NI len) {
	...
	NI PartLen;
	input_2 = input;
	Index = ((NI) ((unsigned int)((NU32)((NU32)((*c).count[(((NI) 0))- 0]) >> (NU32)(((NI) 3))) & ((NI) 63))));
	(*c).count[(((NI) 0))- 0] = (unsigned int)((NU32)((*c).count[(((NI) 0))- 0]) + (NU32)((NU32)((NU32)(((NU32) (len))) << (NU32)(((NI) 3)))));
	{
	...
	LA3_: ;
	(*c).count[(((NI) 1))- 0] = (unsigned int)((NU32)((*c).count[(((NI) 1))- 0]) + (NU32)((NU32)((NU32)(((NU32) (len))) >> (NU32)(((NI) 29)))));
	...
	i = ((NI) 0);
	{
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				dest[(NI)(i + ((NI) 1))] = ((NU8) ((unsigned int)((NU32)((NU32)(src[j]) >> (NU32)(((NI) 8))) & ((NU32) 255))));
				dest[(NI)(i + ((NI) 2))] = ((NU8) ((unsigned int)((NU32)((NU32)(src[j]) >> (NU32)(((NI) 16))) & ((NU32) 255))));
				dest[(NI)(i + ((NI) 3))] = ((NU8) ((unsigned int)((NU32)((NU32)(src[j]) >> (NU32)(((NI) 24))) & ((NU32) 255))));
				i += ((NI) 4);
				res += ((NI) 1);
			} LA3: ;
		}
...
N_NIMCALL(void, md5Final_QVR9bnyINbQRLkYQjTeezvw)(MD5Context_oMciKUdSdCaIeMtcxbiPOw* c, NU8* digest) {
	TY_cdsir9aPB24hAk6k77P9b9bCA Bits;
	NI PadLen;
	NI Index;
...
"\000", PadLen);
	...
	zeroMem_7EL8Zq3xF2ujDWgp3bAEogsystem(((void*) (c)), ((NI) (((NI)sizeof(MD5Context_oMciKUdSdCaIeMtcxbiPOw)))));
}
NIM_EXTERNC N_NOINLINE(void, stdlib_md5Init000)(void) {
}

NIM_EXTERNC N_NOINLINE(void, stdlib_md5DatInit000)(void) {
NTI_qtqsWM5aXmcpMIVmvq3kAA_.size = sizeof(TY_qtqsWM5aXmcpMIVmvq3kAA);
