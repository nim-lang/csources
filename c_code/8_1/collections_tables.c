...
N_NIMCALL(void, enlarge_136840)(ttable136540* t) {
	...
	n = (tkeyvaluepairseq136543*) newSeq((&NTI136543), (NI32)(TMP813));
	i_136879 = 0;
	HEX3Atmp_136934 = 0;
...
N_NIMCALL(void, enlarge_219767)(ttable219029* t) {
	...
	n = (tkeyvaluepairseq219032*) newSeq((&NTI219032), (NI32)(TMP3101));
	i_219806 = 0;
	HEX3Atmp_219861 = 0;
	nimln(117, "tables.nim");
	nimln(117, "tables.nim");
...
N_NIMCALL(void, enlarge_220197)(ttable219059* t) {
	...
	n = (tkeyvaluepairseq219062*) newSeq((&NTI219062), (NI32)(TMP3110));
	i_220236 = 0;
	HEX3Atmp_220291 = 0;
	nimln(117, "tables.nim");
	nimln(117, "tables.nim");
...
TMP801[0] = &TMP373[9];
TMP373[9].kind = 1;
TMP373[9].offset = offsetof(ttable136540, Data);
TMP373[9].typ = (&NTI136543);
TMP373[9].name = "data";
TMP801[1] = &TMP373[10];
TMP373[10].kind = 1;
TMP373[10].offset = offsetof(ttable136540, Counter);
TMP373[10].typ = (&NTI105);
TMP373[10].name = "counter";
TMP373[8].len = 2; TMP373[8].kind = 2; TMP373[8].sons = &TMP801[0];
NTI136540.node = &TMP373[8];
...
TMP3086[0] = &TMP373[12];
TMP373[12].kind = 1;
TMP373[12].offset = offsetof(tkeyvaluepair219065, Field0);
TMP373[12].typ = (&NTI116005);
TMP373[12].name = "Field0";
TMP3086[1] = &TMP373[13];
TMP373[13].kind = 1;
TMP373[13].offset = offsetof(tkeyvaluepair219065, Field1);
TMP373[13].typ = (&NTI219009);
TMP373[13].name = "Field1";
TMP3086[2] = &TMP373[14];
TMP373[14].kind = 1;
TMP373[14].offset = offsetof(tkeyvaluepair219065, Field2);
TMP373[14].typ = (&NTI219007);
TMP373[14].name = "Field2";
TMP373[11].len = 3; TMP373[11].kind = 2; TMP373[11].sons = &TMP3086[0];
NTI219065.node = &TMP373[11];
NTI219062.size = sizeof(tkeyvaluepairseq219062*);
NTI219062.kind = 24;
NTI219062.base = (&NTI219065);
NTI219062.flags = 2;
NTI219062.marker = TMP3092;
...
TMP3093[0] = &TMP373[16];
TMP373[16].kind = 1;
TMP373[16].offset = offsetof(ttable219059, Data);
TMP373[16].typ = (&NTI219062);
TMP373[16].name = "data";
TMP3093[1] = &TMP373[17];
TMP373[17].kind = 1;
TMP373[17].offset = offsetof(ttable219059, Counter);
TMP373[17].typ = (&NTI105);
TMP373[17].name = "counter";
TMP373[15].len = 2; TMP373[15].kind = 2; TMP373[15].sons = &TMP3093[0];
NTI219059.node = &TMP373[15];
...
TMP3099[0] = &TMP373[23];
TMP373[23].kind = 1;
TMP373[23].offset = offsetof(ttable219029, Data);
TMP373[23].typ = (&NTI219032);
TMP373[23].name = "data";
TMP3099[1] = &TMP373[24];
TMP373[24].kind = 1;
TMP373[24].offset = offsetof(ttable219029, Counter);
TMP373[24].typ = (&NTI105);
TMP373[24].name = "counter";
TMP373[22].len = 2; TMP373[22].kind = 2; TMP373[22].sons = &TMP3099[0];
NTI219029.node = &TMP373[22];
}
