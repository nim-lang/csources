...
N_NIMCALL(NU8, checkforsideeffects_279740)(tnode190813* n) {
	...
	case ((NU8) 32):
	{
		...
		nimln(143, "parampatterns.nim");
		{
			...
			LOC4 = isroutine_197040((*op).kindU.S4.Sym);
			LA5: ;
			if (!LOC4) goto LA6;
...
N_NIMCALL(NIM_BOOL, matchnodekinds_280344)(tnode190813* p, tnode190813* n) {
	...
	while (1) {
		...
		case ((NU8) 2):
		{
			...
			LOC4 = stack[((NI32)(TMP3603))- 0];
			if (LOC4) goto LA5;
			nimln(242, "parampatterns.nim");
			TMP3604 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3604)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI32)(TMP3604))- 0];
			LA5: ;
			stack[((NI32)(TMP3602))- 0] = LOC4;
		...
		case ((NU8) 3):
		{
			...
			LOC7 = stack[((NI32)(TMP3606))- 0];
			if (!(LOC7)) goto LA8;
			nimln(245, "parampatterns.nim");
			TMP3607 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3607)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI32)(TMP3607))- 0];
			LA8: ;
			stack[((NI32)(TMP3605))- 0] = LOC7;
		...
		case ((NU8) 4):
		{
			...
			stack[((NI32)(TMP3608))- 0] = !(stack[((NI32)(TMP3609))- 0]);
		}
		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(254, "parampatterns.nim");
			TMP3610 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3610)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3610)])), ((NU8) 0), ((NU8) 24)));
			nimln(233, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			nimln(258, "parampatterns.nim");
			TMP3611 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3611)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3611)])), ((NU8) 0), ((NU8) 156)));
			nimln(233, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
