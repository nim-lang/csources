...
N_NIMCALL(NI, cmpignorestyle_164036)(NCSTRING a, NCSTRING b, NI blen);
...
N_NIMCALL(NI, cmpexact_164186)(NCSTRING a, NCSTRING b, NI blen);
...
NIM_BOOL firstchariscs_164025;
TY164028 buckets_164033;
extern TFrame* frameptr_13038;
NI wordcounter_164248;
extern tgcheap43216 gch_43244;
extern TNimType NTI2409; /* TObject */
TNimType NTI164013; /* TIdObj */
extern TNimType NTI106; /* int */
TNimType NTI164019; /* TIdent */
extern TNimType NTI143; /* string */
extern TNimType NTI117013; /* THash */
TNimType NTI164017; /* PIdent */
tident164019* idanon_164476;
tident164019* iddelegator_164478;
TNimType NTI164015; /* PIdObj */
...
N_NIMCALL(NI, cmpignorestyle_164036)(NCSTRING a, NCSTRING b, NI blen) {
	...
	nimln(32, "idents.nim");
	{
		if (!firstchariscs_164025) goto LA3;
		nimln(33, "idents.nim");
		{
			nimln(33, "idents.nim");
			nimln(33, "idents.nim");
...
N_NIMCALL(tident164019*, getident_164250)(NCSTRING identifier, NI length, NI h) {
	...
	while (1) {
		...
		nimln(74, "idents.nim");
		{
			...
			nimln(74, "idents.nim");
			LOC4 = 0;
			LOC4 = cmpexact_164186((*result).S->data, identifier, length);
			if (!(LOC4 == 0)) goto LA5;
			nimln(75, "idents.nim");
			{
				nimln(75, "idents.nim");
				...
				nimln(78, "idents.nim");
				asgnRefNoCycle((void**) &(*result).Next, buckets_164033[(idx)- 0]);
				nimln(79, "idents.nim");
				asgnRefNoCycle((void**) &buckets_164033[(idx)- 0], result);
			}
			LA9: ;
			nimln(80, "idents.nim");
			goto BeforeRet;
		...
		LA5: ;
		{
			...
			nimln(81, "idents.nim");
			LOC12 = 0;
			LOC12 = cmpignorestyle_164036((*result).S->data, identifier, length);
			...
			nimln(82, "idents.nim");
			{
				...
				if (!!(LOC17)) goto LA19;
				nimln(82, "idents.nim");
				failedassertimpl_79821(((NimStringDesc*) &TMP976));
			}
			LA19: ;
			nimln(83, "idents.nim");
			id = (*result).Sup.Id;
	...
	nimln(86, "idents.nim");
	result = (tident164019*) newObj((&NTI164017), sizeof(tident164019));
	(*result).Sup.Sup.m_type = (&NTI164019);
	nimln(87, "idents.nim");
	(*result).H = h;
	nimln(88, "idents.nim");
	nimln(88, "idents.nim");
	...
	HEX3Atmp_164448 = (NI32)(TMP979);
	nimln(1450, "system.nim");
	res_164450 = 0;
	nimln(1451, "system.nim");
	while (1) {
		nimln(1451, "system.nim");
		if (!(res_164450 <= HEX3Atmp_164448)) goto LA21;
		nimln(1450, "system.nim");
		i_164429 = res_164450;
		nimln(89, "idents.nim");
		if ((NU)(i_164429) > (NU)((*result).S->Sup.len)) raiseIndexError();
		(*result).S->data[i_164429] = identifier[i_164429];
		nimln(1453, "system.nim");
		res_164450 = addInt(res_164450, 1);
	} LA21: ;
	nimln(90, "idents.nim");
	asgnRefNoCycle((void**) &(*result).Next, buckets_164033[(idx)- 0]);
	nimln(91, "idents.nim");
	...
	nimln(92, "idents.nim");
	{
		...
		if (!(id == 0)) goto LA24;
		nimln(93, "idents.nim");
		wordcounter_164248 = addInt(wordcounter_164248, 1);
		nimln(94, "idents.nim");
		nimln(94, "idents.nim");
		if (wordcounter_164248 == (-2147483647 -1)) raiseOverflow();
		(*result).Sup.Id = ((NI32)-(wordcounter_164248));
	}
	goto LA22;
	LA24: ;
	{
...
N_NIMCALL(tident164019*, getident_164456)(NimStringDesc* identifier) {
	...
	LOC1 = 0;
	LOC1 = hashignorestyle_117859(identifier);
	result = getident_164250(identifier->data, identifier->Sup.len, LOC1);
	popFrame();
	return result;
}
...
N_NIMCALL(tident164019*, getident_164462)(NimStringDesc* identifier, NI h) {
	...
	nimln(103, "idents.nim");
	result = getident_164250(identifier->data, identifier->Sup.len, h);
	popFrame();
	return result;
}
...
N_NOINLINE(void, identsInit)(void) {
	...
	nimln(66, "idents.nim");
	wordcounter_164248 = 1;
	nimln(108, "idents.nim");
	asgnRefNoCycle((void**) &idanon_164476, getident_164456(((NimStringDesc*) &TMP980)));
	nimln(109, "idents.nim");
	asgnRefNoCycle((void**) &iddelegator_164478, getident_164456(((NimStringDesc*) &TMP981)));
	popFrame();
}
...
NTI164013.size = sizeof(tidobj164013);
NTI164013.kind = 17;
NTI164013.base = (&NTI2409);
NTI164013.flags = 1;
TMP970[0].kind = 1;
TMP970[0].offset = offsetof(tidobj164013, Id);
TMP970[0].typ = (&NTI106);
TMP970[0].name = "id";
NTI164013.node = &TMP970[0];
NTI164019.size = sizeof(tident164019);
NTI164019.kind = 17;
NTI164019.base = (&NTI164013);
NTI164019.flags = 2;
TMP977[0] = &TMP970[2];
TMP970[2].kind = 1;
TMP970[2].offset = offsetof(tident164019, S);
TMP970[2].typ = (&NTI143);
TMP970[2].name = "s";
TMP977[1] = &TMP970[3];
TMP970[3].kind = 1;
TMP970[3].offset = offsetof(tident164019, Next);
TMP970[3].typ = (&NTI164017);
TMP970[3].name = "next";
TMP977[2] = &TMP970[4];
TMP970[4].kind = 1;
TMP970[4].offset = offsetof(tident164019, H);
TMP970[4].typ = (&NTI117013);
TMP970[4].name = "h";
TMP970[1].len = 3; TMP970[1].kind = 2; TMP970[1].sons = &TMP977[0];
NTI164019.node = &TMP970[1];
NTI164017.size = sizeof(tident164019*);
NTI164017.kind = 22;
NTI164017.base = (&NTI164019);
NTI164017.flags = 2;
NTI164017.marker = TMP978;
NTI164015.size = sizeof(tidobj164013*);
NTI164015.kind = 22;
NTI164015.base = (&NTI164013);
NTI164015.marker = TMP2047;
}
