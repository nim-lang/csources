...
N_NIMCALL(trstnode278018*, lastson_278145)(trstnode278018* n) {
	...
	if ((NU)((NI32)(TMP3872)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP3872)];
	popFrame();
	return result;
}
static N_INLINE(void, asgnRefNoCycle)(void** dest, void* src) {
...
appendString((*result), ind);
		...
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI32)(TMP3877), lvltochar_278241[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI32)(TMP3879), 45);
...
appendString((*result), ((NimStringDesc*) &TMP3882));
	...
	case ((NU8) 14):
	{
		...
		l = (((NI32)(TMP3883) >= 30) ? (NI32)(TMP3883) : 30);
...
appendString((*result), tmp);
		...
		TMP3885 = subInt((NI32)(TMP3884), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI32)(TMP3885), 32);
