...
N_NOINLINE(void, raiserecoverableerror_183060)(NimStringDesc* msg) __attribute__((noreturn));
...
Tlineinfo182337 gcmdlineinfo_183046;
Tlineinfo182337 gcodegenlineinfo_183058;
NU64 gnotes_183080;
NI gerrorcounter_183081;
NI ghintcounter_183082;
NI gwarncounter_183083;
NI gerrormax_183084;
TY183093* msgcontext_183110;
TNimType NTI182337; /* TLineInfo */
extern TNimType NTI108; /* int16 */
extern TNimType NTI110; /* int32 */
TNimType NTI183093; /* seq[TLineInfo] */
Tlineinfo182337 lasterror_183111;
NU8 erroroutputs_183113;
TY183114 writelnhook_183117;
...
TNimType NTI183067; /* ref ERecoverableError */
...
TNimType NTI183164; /* ref ESuggestDone */
N_NIMCALL(void, TMP144)(void* p, NI op) {
	TY182350* a;
	NI LOC1;
	a = (TY182350*)p;
...
N_NIMCALL(void, writecontext_184130)(Tlineinfo182337 lastinfo) {
	...
	info = lastinfo;
	{
		...
		i_184153 = 0;
		HEX3Atmp_184606 = 0;
		HEX3Atmp_184606 = (NI)((msgcontext_183110 ? msgcontext_183110->Sup.len : 0) - ((NI) 1));
		res_184609 = ((NI) 0);
		{
			while (1) {
				...
				i_184153 = res_184609;
				{
					...
					LOC6 = 0;
					LOC7 = 0;
					LOC7 = HEX3DHEX3D_184125(msgcontext_183110->data[i_184153], lastinfo);
					LOC6 = !(LOC7);
					if (!(LOC6)) goto LA8;
					LOC9 = 0;
					LOC9 = HEX3DHEX3D_184125(msgcontext_183110->data[i_184153], info);
					LOC6 = !(LOC9);
					LA8: ;
					if (!LOC6) goto LA10;
					{
						NimStringDesc* s_184172;
						if (!!(writelnhook_183117.ClPrc == 0)) goto LA14;
						s_184172 = copyString(((NimStringDesc*) &TMP147));
						{
							...
							i_184605 = ((NI) 0);
							{
								while (1) {
									...
									LOC20[0] = tomsgfilename_183411(msgcontext_183110->data[i_184153]);
									LOC20[1] = coordtostr_183739(((NI) (msgcontext_183110->data[i_184153].line)));
									LOC20[2] = coordtostr_183739(((NI) ((NI16)(msgcontext_183110->data[i_184153].col + ((NI16) 1)))));
...
appendString(s_184172, arg_184174);
						...
						writelnhook_183117.ClEnv? writelnhook_183117.ClPrc(s_184172, writelnhook_183117.ClEnv):((TMP429)(writelnhook_183117.ClPrc))(s_184172);
					}
					goto LA12;
					LA14: ;
					{
						if (!((gglobaloptions_160121 &(1U<<((NU)(((NU8) 23))&31U)))!=0)) goto LA22;
						{
							TY184169 LOC28;
							TY184156 LOC29;
							if (!((erroroutputs_183113 &(1U<<((NU)(((NU8) 0))&7U)))!=0)) goto LA26;
							memset((void*)LOC28, 0, sizeof(LOC28));
							memset((void*)LOC29, 0, sizeof(LOC29));
							LOC29[0] = tomsgfilename_183411(msgcontext_183110->data[i_184153]);
							LOC29[1] = coordtostr_183739(((NI) (msgcontext_183110->data[i_184153].line)));
							LOC29[2] = coordtostr_183739(((NI) ((NI16)(msgcontext_183110->data[i_184153].col + ((NI16) 1)))));
					...
					{
						{
							if (!((erroroutputs_183113 &(1U<<((NU)(((NU8) 1))&7U)))!=0)) goto LA33;
							{
								TY184156 LOC39;
								NimStringDesc* LOC40;
								NimStringDesc* LOC41;
								...
								LOC39[0] = tomsgfilename_183411(msgcontext_183110->data[i_184153]);
								LOC39[1] = coordtostr_183739(((NI) (msgcontext_183110->data[i_184153].line)));
								LOC39[2] = coordtostr_183739(((NI) ((NI16)(msgcontext_183110->data[i_184153].col + ((NI16) 1)))));
								LOC40 = 0;
							...
							LA37: ;
							{
								...
								LOC44[0] = tomsgfilename_183411(msgcontext_183110->data[i_184153]);
								LOC44[1] = coordtostr_183739(((NI) (msgcontext_183110->data[i_184153].line)));
								LOC44[2] = coordtostr_183739(((NI) ((NI16)(msgcontext_183110->data[i_184153].col + ((NI16) 1)))));
				...
				LA10: ;
				info = msgcontext_183110->data[i_184153];
				res_184609 += ((NI) 1);
			} LA3: ;
		}
	}
...
N_NIMCALL(void, quit_183759)(NU16 msg) {
	{
		...
		LOC3 = LOC4;
		if (LOC3) goto LA6;
		LOC3 = ((gnotes_183080 &((NU64)1<<((NU)((((NU16) 288)- 237))&63U)))!=0);
		LA6: ;
		if (!LOC3) goto LA7;
		{
			NIM_BOOL LOC11;
			...
			if (!(LOC11)) goto LA12;
			LOC11 = writelnhook_183117.ClPrc == 0;
			LA12: ;
			if (!LOC11) goto LA13;
		...
		{
			{
				...
				if (!!(writelnhook_183117.ClPrc == 0)) goto LA18;
...
appendString(s_183803, arg_183805);
				...
				writelnhook_183117.ClEnv? writelnhook_183117.ClPrc(s_183803, writelnhook_183117.ClEnv):((TMP502)(writelnhook_183117.ClPrc))(s_183803);
			}
			goto LA16;
			LA18: ;
			{
				if (!((gglobaloptions_160121 &(1U<<((NU)(((NU8) 23))&31U)))!=0)) goto LA26;
				{
					TY183752 LOC32;
					NimStringDesc* LOC33;
					if (!((erroroutputs_183113 &(1U<<((NU)(((NU8) 0))&7U)))!=0)) goto LA30;
...
appendString(LOC33, ((NimStringDesc*) &TMP501));
			...
			{
				{
					if (!((erroroutputs_183113 &(1U<<((NU)(((NU8) 1))&7U)))!=0)) goto LA37;
					{
						NimStringDesc* LOC43;
...
N_NOINLINE(void, raiserecoverableerror_183060)(NimStringDesc* msg) {
	Erecoverableerror182343* e_183066;
	NimStringDesc* LOC1;
	e_183066 = 0;
	e_183066 = (Erecoverableerror182343*) newObj((&NTI183067), sizeof(Erecoverableerror182343));
	(*e_183066).Sup.Sup.Sup.m_type = (&NTI182343);
	LOC1 = 0;
	LOC1 = (*e_183066).Sup.Sup.message; (*e_183066).Sup.Sup.message = copyStringRC1(msg);
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_183066, "ERecoverableError");
}
...
N_NIMCALL(void, handleerror_184039)(NU16 msg, NU8 eh, NimStringDesc* s) {
	...
	LA5: ;
	{
		...
		LA14: ;
		if (!LOC13) goto LA15;
		gerrorcounter_183081 += ((NI) 1);
		gexitcode_160122 = ((NI8) 1);
		{
			if (!(gerrormax_183084 <= gerrorcounter_183081)) goto LA19;
			quit_183759(msg);
		}
		goto LA17;
		LA19: ;
		...
		LA24: ;
		{
			...
			raiserecoverableerror_183060(s);
		}
		goto LA17;
		LA27: ;
		LA17: ;
...
{	title = 0;
	...
	case ((NU16) 237) ... ((NU16) 267):
	{
		...
		LA6: ;
		{
			if (!!(((gnotes_183080 &((NU64)1<<((NU)((((NU16) (msg))- 237))&63U)))!=0))) goto LA10;
			goto BeforeRet;
		}
		LA10: ;
	...
	case ((NU16) 268) ... ((NU16) 290):
	{
		...
		LA16: ;
		{
			if (!!(((gnotes_183080 &((NU64)1<<((NU)((((NU16) (msg))- 237))&63U)))!=0))) goto LA20;
			goto BeforeRet;
		}
		LA20: ;
	...
	s_184747 = nsuFormatOpenArray(LOC22, args, argsLen0);
	{
		...
		if (!!(LOC25)) goto LA26;
		{
			if (!!((kind == NIM_NIL))) goto LA30;
			{
				...
				if (!!(writelnhook_183117.ClPrc == 0)) goto LA34;
...
appendString(s_184765, arg_184767);
				...
				writelnhook_183117.ClEnv? writelnhook_183117.ClPrc(s_184765, writelnhook_183117.ClEnv):((TMP492)(writelnhook_183117.ClPrc))(s_184765);
			}
			goto LA32;
			LA34: ;
			{
				...
				{
					TY184156 LOC47;
					if (!((erroroutputs_183113 &(1U<<((NU)(((NU8) 0))&7U)))!=0)) goto LA45;
			...
			{
				{
					if (!((erroroutputs_183113 &(1U<<((NU)(((NU8) 1))&7U)))!=0)) goto LA51;
					{
						NimStringDesc* LOC57;
		...
		{
			{
				...
				if (!!(writelnhook_183117.ClPrc == 0)) goto LA63;
...
appendString(s_185217, arg_185219);
				...
				writelnhook_183117.ClEnv? writelnhook_183117.ClPrc(s_185217, writelnhook_183117.ClEnv):((TMP493)(writelnhook_183117.ClPrc))(s_185217);
			}
			goto LA61;
			LA63: ;
			{
				...
				{
					TY184169 LOC76;
					if (!((erroroutputs_183113 &(1U<<((NU)(((NU8) 0))&7U)))!=0)) goto LA74;
			...
			{
				{
					if (!((erroroutputs_183113 &(1U<<((NU)(((NU8) 1))&7U)))!=0)) goto LA80;
					{
...
N_NIMCALL(void, msgwriteln_183449)(NimStringDesc* s, NU8 flags) {
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
		LOC3 = !(writelnhook_183117.ClPrc == 0);
		if (!(LOC3)) goto LA4;
		LOC3 = !(((flags &(1U<<((NU)(((NU8) 1))&7U)))!=0));
		LA4: ;
		if (!LOC3) goto LA5;
		writelnhook_183117.ClEnv? writelnhook_183117.ClPrc(s, writelnhook_183117.ClEnv):((TMP1051)(writelnhook_183117.ClPrc))(s);
	}
	goto LA1;
	LA5: ;
	{
		...
		{
			TY183752 LOC16;
			if (!((erroroutputs_183113 &(1U<<((NU)(((NU8) 0))&7U)))!=0)) goto LA14;
	...
	LA10: ;
	{
		{
			TY183752 LOC22;
			if (!((erroroutputs_183113 &(1U<<((NU)(((NU8) 1))&7U)))!=0)) goto LA20;
		...
		if (TMP1053.status == 0) {
			{
				...
				line_187173 = 0;
				HEX3Atmp_187411 = 0;
				HEX3Atmp_187411 = tofullpath_183269(i.fileindex);
...
N_NIMCALL(void, limessage_185658)(Tlineinfo182337 info, NU16 msg, NimStringDesc* arg, NU8 eh) {
	...
	case ((NU16) 237) ... ((NU16) 267):
	{
		...
		if (LOC3) goto LA4;
		LOC3 = !(((gnotes_183080 &((NU64)1<<((NU)((((NU16) (msg))- 237))&63U)))!=0));
		LA4: ;
		ignoremsg = LOC3;
		{
	...
	case ((NU16) 268) ... ((NU16) 290):
	{
		...
		if (LOC10) goto LA11;
		LOC10 = !(((gnotes_183080 &((NU64)1<<((NU)((((NU16) (msg))- 237))&63U)))!=0));
		LA11: ;
		ignoremsg = LOC10;
		title = copyString(((NimStringDesc*) &TMP468));
		color = ((NU8) 32);
	...
	s_185765 = getmessagestr_183747(msg, arg);
	{
		...
		if (!LOC15) goto LA18;
		{
			if (!!((kind == NIM_NIL))) goto LA22;
			{
				...
				if (!!(writelnhook_183117.ClPrc == 0)) goto LA26;
...
appendString(s_185784, arg_185786);
				...
				writelnhook_183117.ClEnv? writelnhook_183117.ClPrc(s_185784, writelnhook_183117.ClEnv):((TMP1049)(writelnhook_183117.ClPrc))(s_185784);
			}
			goto LA24;
			LA26: ;
			{
				...
				{
					TY185781 LOC39;
					if (!((erroroutputs_183113 &(1U<<((NU)(((NU8) 0))&7U)))!=0)) goto LA37;
					memset((void*)LOC39, 0, sizeof(LOC39));
			...
			{
				{
					if (!((erroroutputs_183113 &(1U<<((NU)(((NU8) 1))&7U)))!=0)) goto LA43;
					{
						NimStringDesc* LOC49;
		...
		{
			{
				...
				if (!!(writelnhook_183117.ClPrc == 0)) goto LA55;
...
appendString(s_186418, arg_186420);
				...
				writelnhook_183117.ClEnv? writelnhook_183117.ClPrc(s_186418, writelnhook_183117.ClEnv):((TMP1050)(writelnhook_183117.ClPrc))(s_186418);
			}
			goto LA53;
			LA55: ;
			{
				...
				{
					TY184156 LOC68;
					if (!((erroroutputs_183113 &(1U<<((NU)(((NU8) 0))&7U)))!=0)) goto LA66;
					memset((void*)LOC68, 0, sizeof(LOC68));
			...
			{
				{
					if (!((erroroutputs_183113 &(1U<<((NU)(((NU8) 1))&7U)))!=0)) goto LA72;
					{
		...
		LA20: ;
		{
			...
			if (!(LOC82)) goto LA84;
			LOC82 = ((gnotes_183080 &((NU64)1<<((NU)((((NU16) 287)- 237))&63U)))!=0);
			LA84: ;
			if (!LOC82) goto LA85;
	...
	msgwriteln_183449(((NimStringDesc*) &TMP1933), 0);
	{
		...
		res_187648 = ((NI) 237);
		{
			while (1) {
				...
				{
					if (!((gnotes_183080 &((NU64)1<<((NU)((((NU16) (warn_187614))- 237))&63U)))!=0)) goto LA7;
	...
	msgwriteln_183449(((NimStringDesc*) &TMP1995), 0);
	{
		...
		res_187696 = ((NI) 268);
		{
			while (1) {
				...
				memset((void*)LOC4, 0, sizeof(LOC4));
				{
					if (!((gnotes_183080 &((NU64)1<<((NU)((((NU16) (hint_187662))- 237))&63U)))!=0)) goto LA7;
					LOC4[0] = copyString(((NimStringDesc*) &TMP1935));
				}
				goto LA5;
				LA7: ;
...
N_NIMCALL(void, suggestwriteln_183120)(NimStringDesc* s) {
	{
		if (!((erroroutputs_183113 &(1U<<((NU)(((NU8) 0))&7U)))!=0)) goto LA3;
		{
			TY183752 LOC9;
			if (!writelnhook_183117.ClPrc == 0) goto LA7;
		...
		LA7: ;
		{
			writelnhook_183117.ClEnv? writelnhook_183117.ClPrc(s, writelnhook_183117.ClEnv):((TMP2098)(writelnhook_183117.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, pushinfocontext_183209)(Tlineinfo182337 info) {
	msgcontext_183110 = (TY183093*) incrSeqV2(&(msgcontext_183110)->Sup, sizeof(Tlineinfo182337));
	msgcontext_183110->data[msgcontext_183110->Sup.len] = info;
	++msgcontext_183110->Sup.len;
}

N_NIMCALL(void, popinfocontext_183222)(void) {
	msgcontext_183110 = (TY183093*) setLengthSeq(&(msgcontext_183110)->Sup, sizeof(Tlineinfo182337), ((NI) ((NI)((msgcontext_183110 ? msgcontext_183110->Sup.len : 0) - ((NI) 1)))));
}
N_NIMCALL(void, TMP2822)(void* p, NI op) {
...
N_NIMCALL(void, suggestquit_183158)(void) {
	Esuggestdone182345* e_183163;
	NimStringDesc* LOC1;
	e_183163 = 0;
	e_183163 = (Esuggestdone182345*) newObj((&NTI183164), sizeof(Esuggestdone182345));
	(*e_183163).Sup.Sup.m_type = (&NTI182345);
	LOC1 = 0;
	LOC1 = (*e_183163).Sup.message; (*e_183163).Sup.message = copyStringRC1(((NimStringDesc*) &TMP2823));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	raiseException((Exception*)e_183163, "ESuggestDone");
}
...
N_NIMCALL(Tlineinfo182337, getinfocontext_183242)(NI index) {
	...
	NI i;
	memset((void*)(&result), 0, sizeof(result));
	L = (msgcontext_183110 ? msgcontext_183110->Sup.len : 0);
	{
	...
	LA1: ;
	{
		...
		result = unknownlineinfo_183090();
	}
	goto LA6;
	LA8: ;
	{
		result = msgcontext_183110->data[i];
	}
	LA6: ;
	return result;
}
...
N_NIMCALL(NI, getinfocontextlen_183185)(void) {
	NI result;
{	result = 0;
	result = (msgcontext_183110 ? msgcontext_183110->Sup.len : 0);
	goto BeforeRet;
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, setinfocontextlen_183196)(NI L) {
	msgcontext_183110 = (TY183093*) setLengthSeq(&(msgcontext_183110)->Sup, sizeof(Tlineinfo182337), ((NI) (L)));
}
...
NIM_EXTERNC N_NOINLINE(void, compiler_msgsInit000)(void) {
	...
	++fileinfos_182629->Sup.len;
	gcmdlineinfo_183046 = newlineinfo_183024(((NI32) 0), ((NI) 1), ((NI) 1));
	memset((void*)(&LOC2), 0, sizeof(LOC2));
	...
	++fileinfos_182629->Sup.len;
	gcodegenlineinfo_183058 = newlineinfo_183024(((NI32) 1), ((NI) 1), ((NI) 1));
	gnotes_183080 = 0;
	LOC3 = 0;
	for (LOC3 = (((NU16) 237)- 237); LOC3 <= (((NU16) 255)- 237); LOC3++) 
gnotes_183080 |=((NU64)(1)<<((LOC3)%(sizeof(NU64)*8)));
	gnotes_183080 |=((NU64)(1)<<(((((NU16) 257)- 237))%(sizeof(NU64)*8)));
	gnotes_183080 |=((NU64)(1)<<(((((NU16) 261)- 237))%(sizeof(NU64)*8)));
	LOC4 = 0;
	for (LOC4 = (((NU16) 263)- 237); LOC4 <= (((NU16) 276)- 237); LOC4++) 
gnotes_183080 |=((NU64)(1)<<((LOC4)%(sizeof(NU64)*8)));
	LOC5 = 0;
	for (LOC5 = (((NU16) 281)- 237); LOC5 <= (((NU16) 283)- 237); LOC5++) 
gnotes_183080 |=((NU64)(1)<<((LOC5)%(sizeof(NU64)*8)));
	gnotes_183080 |=((NU64)(1)<<(((((NU16) 285)- 237))%(sizeof(NU64)*8)));
	gnotes_183080 |=((NU64)(1)<<(((((NU16) 290)- 237))%(sizeof(NU64)*8)));
	gerrorcounter_183081 = ((NI) 0);
	ghintcounter_183082 = ((NI) 0);
	gwarncounter_183083 = ((NI) 0);
	gerrormax_183084 = ((NI) 1);
	if (msgcontext_183110) nimGCunrefNoCycle(msgcontext_183110);
	msgcontext_183110 = (TY183093*) newSeqRC1((&NTI183093), 0);
	lasterror_183111 = unknownlineinfo_183090();
	erroroutputs_183113 = 3;
	memset((void*)(&LOC6), 0, sizeof(LOC6));
...
NTI183093.size = sizeof(TY183093*);
NTI183093.kind = 24;
NTI183093.base = (&NTI182337);
NTI183093.flags = 2;
NTI183093.marker = TMP152;
NTI182343.size = sizeof(Erecoverableerror182343);
NTI182343.kind = 17;
NTI182343.base = (&NTI3646);
TMP19[11].len = 0; TMP19[11].kind = 2;
NTI182343.node = &TMP19[11];
NTI183067.size = sizeof(Erecoverableerror182343*);
NTI183067.kind = 22;
NTI183067.base = (&NTI182343);
NTI183067.marker = TMP503;
...
NTI183164.size = sizeof(Esuggestdone182345*);
NTI183164.kind = 22;
NTI183164.base = (&NTI182345);
NTI183164.marker = TMP2822;
}
