...
N_NIMCALL(NI, waitfor_189618)(tsocketimpl181607* socket, NF* waited, NI timeout, NI size, NimStringDesc* funcname);
...
N_NIMCALL(NI, select_189107)(TY190015** readfds, NI timeout);
...
N_NIMCALL(void, createfdset_188418)(fd_set* fd, TY190015* s, NI* m);
...
N_NIMCALL(NI, readintobuf_189168)(tsocketimpl181607* socket, NI32 flags);
...
N_NIMCALL(NI, select_189107)(TY190015** readfds, NI timeout) {
	...
	m = 0;
	createfdset_188418(&rd, (*readfds), &m);
	{
		int LOC9;
...
appendString(LOC22, ((NimStringDesc*) &TMP4841));
		...
		selret = select_189107(&s, (NI32)(timeout - ((NI) (((NF)((*waited)) * (NF)(1.0000000000000000e+003))))));
		{
			NI32 LOC28;
...
N_NIMCALL(NI, recv_189302)(tsocketimpl181607* socket, void* data, NI size) {
	...
	LA3: ;
	{
		...
		if (!(*socket).Isbuffered) goto LA7;
		{
			...
			res = readintobuf_189168(socket, ((NI32) 0));
			{
				if (!(res <= 0)) goto LA15;
				{
...
N_NIMCALL(void, readline_190447)(tsocketimpl181607* socket, NimStringDesc** line, NI timeout) {
	...
	(*line) = setLengthStr((*line), 0);
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_189618(socket, &waited, timeout, 1, ((NimStringDesc*) &TMP4843));
			...
			LA4: ;
			{
				...
				LOC15 = 0;
				LOC15 = waitfor_189618(socket, &waited, timeout, 1, ((NimStringDesc*) &TMP4843));
