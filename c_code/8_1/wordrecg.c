...
NIM_CONST TY173327 specialwords_173326 = {((NimStringDesc*) &TMP1171),
...
N_NIMCALL(NI, findstr_173334)(NimStringDesc** a, NI aLen0, NimStringDesc* s) {
	...
	nimln(172, "wordrecg.nim");
	HEX3Atmp_173353 = (aLen0-1);
	nimln(1451, "system.nim");
	res_173355 = 0;
	nimln(1452, "system.nim");
	while (1) {
		nimln(1452, "system.nim");
		if (!(res_173355 <= HEX3Atmp_173353)) goto LA1;
		nimln(1451, "system.nim");
		i_173352 = res_173355;
		nimln(173, "wordrecg.nim");
		{
			...
			nimln(173, "wordrecg.nim");
			nimln(173, "wordrecg.nim");
			if ((NU)(i_173352) >= (NU)(aLen0)) raiseIndexError();
			LOC4 = 0;
			LOC4 = nsuCmpIgnoreStyle(a[i_173352], s);
			if (!(LOC4 == 0)) goto LA5;
		...
		res_173355 = addInt(res_173355, 1);
	} LA1: ;
...
N_NIMCALL(NU8, whichkeyword_173367)(NimStringDesc* id) {
	...
	nimln(182, "wordrecg.nim");
	LOC1 = 0;
	LOC1 = getident_169456(id);
	result = whichkeyword_173360(LOC1);
	popFrame();
	return result;
}
...
N_NIMCALL(void, initspecials_173373)(void) {
	...
	while (1) {
		...
		tident169019* LOC3;
		nimln(1452, "system.nim");
		if (!(res_173440 <= ((NU8) 251))) goto LA1;
		nimln(1451, "system.nim");
		s_173430 = res_173440;
		...
		nimln(187, "wordrecg.nim");
		LOC2 = 0;
		LOC2 = hashignorestyle_119859(specialwords_173326[(s_173430)- 0]);
		LOC3 = 0;
		LOC3 = getident_169462(specialwords_173326[(s_173430)- 0], LOC2);
		nimln(187, "wordrecg.nim");
		(*LOC3).Sup.Id = ((NI) (s_173430));
		nimln(1454, "system.nim");
		res_173440 = addInt(res_173440, 1);
	} LA1: ;
	popFrame();
}
