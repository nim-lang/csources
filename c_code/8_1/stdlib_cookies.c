...
N_NIMCALL(NimStringDesc*, setcookie_338106)(NimStringDesc* key, NimStringDesc* value, NimStringDesc* domain, NimStringDesc* path, NimStringDesc* expires, NIM_BOOL noname);
N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src);
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src);
N_NIMCALL(NimStringDesc*, resizeString)(NimStringDesc* dest, NI addlen);
N_NIMCALL(NimStringDesc*, rawNewString)(NI space);
N_NIMCALL(NimStringDesc*, setcookie_338117)(NimStringDesc* key, NimStringDesc* value, ttimeinfo95003* expires, NimStringDesc* domain, NimStringDesc* path, NIM_BOOL noname);
N_NIMCALL(NimStringDesc*, format_96999)(ttimeinfo95003* info, NimStringDesc* f);
STRING_LITERAL(TMP4690, "", 0);
STRING_LITERAL(TMP4691, "Set-Cookie: ", 12);
STRING_LITERAL(TMP4692, "=", 1);
STRING_LITERAL(TMP4693, "; Domain=", 9);
STRING_LITERAL(TMP4694, "; Path=", 7);
STRING_LITERAL(TMP4695, "; Expires=", 10);
STRING_LITERAL(TMP4696, "ddd\',\' dd MMM yyyy HH:mm:ss \'UTC\'", 33);
...
N_NIMCALL(tstringtable121810*, parsecookies_338012)(NimStringDesc* s) {
	...
	while (1) {
		...
		TMP4689 = subInt(i, 1);
		LOC16 = 0;
		LOC16 = copyStrLast(s, valstart, (NI32)(TMP4689));
...
N_NIMCALL(NimStringDesc*, setcookie_338117)(NimStringDesc* key, NimStringDesc* value, ttimeinfo95003* expires, NimStringDesc* domain, NimStringDesc* path, NIM_BOOL noname) {
	...
	LOC1 = 0;
	LOC1 = format_96999(expires, ((NimStringDesc*) &TMP4696));
	result = setcookie_338106(key, value, domain, path, LOC1, noname);
	goto BeforeRet;
	BeforeRet: ;
	popFrame();
	return result;
