...
N_NIMCALL(void, addpackage_150103)(tstringtable111610* packages, NimStringDesc* p);
...
N_NIMCALL(void, addpackage_150103)(tstringtable111610* packages, NimStringDesc* p) {
	...
	nimln(48, "babelcmd.nim");
	TMP1404 = subInt(x, 1);
	name = copyStrLast(p, 0, (NI32)(TMP1404));
	nimln(49, "babelcmd.nim");
	{
		...
		nimln(50, "babelcmd.nim");
		TMP1405 = addInt(x, 1);
		version = copyStr(p, (NI32)(TMP1405));
	...
	nimln(1228, "os.nim");
	{
		...
		while (1) {
			...
			nimln(1233, "os.nim");
			{
				...
				nimln(698, "system.nim");
				nimln(698, "system.nim");
				LOC12 = !(eqStrings(y_150158, ((NimStringDesc*) &TMP1406)));
				if (!(LOC12)) goto LA13;
				nimln(698, "system.nim");
				nimln(698, "system.nim");
				LOC12 = !(eqStrings(y_150158, ((NimStringDesc*) &TMP1407)));
				LA13: ;
				if (!LOC12) goto LA14;
				memset((void*)&s_150160, 0, sizeof(s_150160));
				nimln(1235, "os.nim");
				y_150158 = HEX2F_101067(dir, y_150158);
				nimln(1236, "os.nim");
				{
					int LOC18;
					nimln(1236, "os.nim");
				...
				nimln(69, "babelcmd.nim");
				{
					...
					if (!(LOC33)) goto LA34;
					nimln(69, "babelcmd.nim");
					LOC33 = nsuEndsWith(path_150144, ((NimStringDesc*) &TMP1411));
					LA34: ;
					if (!LOC33) goto LA35;
		...
		nimln(1228, "os.nim");
		{
			...
			while (1) {
				...
				nimln(1233, "os.nim");
				{
					...
					nimln(698, "system.nim");
					nimln(698, "system.nim");
					LOC18 = !(eqStrings(y_150172, ((NimStringDesc*) &TMP1406)));
					if (!(LOC18)) goto LA19;
					nimln(698, "system.nim");
					nimln(698, "system.nim");
					LOC18 = !(eqStrings(y_150172, ((NimStringDesc*) &TMP1407)));
					LA19: ;
					if (!LOC18) goto LA20;
					memset((void*)&s_150174, 0, sizeof(s_150174));
					nimln(1235, "os.nim");
					y_150172 = HEX2F_101067(p, y_150172);
					nimln(1236, "os.nim");
					{
						int LOC24;
						nimln(1236, "os.nim");
...
N_NIMCALL(void, addpathrec_150180)(NimStringDesc* dir, tlineinfo136509 info) {
	...
	nimln(1228, "os.nim");
	{
		...
		while (1) {
			...
			nimln(1233, "os.nim");
			{
				...
				nimln(698, "system.nim");
				nimln(698, "system.nim");
				LOC16 = !(eqStrings(y_150223, ((NimStringDesc*) &TMP1406)));
				if (!(LOC16)) goto LA17;
				nimln(698, "system.nim");
				nimln(698, "system.nim");
				LOC16 = !(eqStrings(y_150223, ((NimStringDesc*) &TMP1407)));
				LA17: ;
				if (!LOC16) goto LA18;
				memset((void*)&s_150225, 0, sizeof(s_150225));
				nimln(1235, "os.nim");
				y_150223 = HEX2F_101067(dir, y_150223);
				nimln(1236, "os.nim");
				{
					int LOC22;
					nimln(1236, "os.nim");
	...
	while (1) {
		...
		nimln(41, "strtabs.nim");
		{
			...
			{
				nimln(58, "babelcmd.nim");
				if (!eqStrings(val_150231, ((NimStringDesc*) &TMP1403))) goto LA49;
