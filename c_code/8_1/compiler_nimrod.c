...
extern NimStringDesc* arguments_418205;
...
N_NIMCALL(void, handlecmdline_423603)(void) {
	...
	nimln(35, "nimrod.nim");
	{
		...
		if (!(LOC3 == 0)) goto LA4;
		nimln(36, "nimrod.nim");
		writecommandlineusage_151002();	}	goto LA1;
	LA4: ;
	{
		nimln(39, "nimrod.nim");
		processcmdline_418207(((NU8) 0), ((NimStringDesc*) &TMP7237));		nimln(40, "nimrod.nim");
		{
			TSafePoint TMP7238;
			TY101259 p;
			NimStringDesc* LOC15;
		...
		nimln(50, "nimrod.nim");
		loadconfigs_167607(((NimStringDesc*) &TMP7239));		nimln(53, "nimrod.nim");
		initvars_147647();		nimln(54, "nimrod.nim");
		processcmdline_418207(((NU8) 1), ((NimStringDesc*) &TMP7237));		nimln(55, "nimrod.nim");
		maincommand_421811();		nimln(56, "nimrod.nim");
		{
			NimStringDesc* LOC22;
		...
		{
			nimln(58, "nimrod.nim");
			if (!(gerrorcounter_137074 == 0)) goto LA25;
			nimln(62, "nimrod.nim");
			{
				...
				nimln(63, "nimrod.nim");
				{
					...
					LOC37 = 0;
					LOC37 = completecfilepath_147681(LOC36, NIM_TRUE);
					ex = nospquoteShell(LOC37);
					nimln(66, "nimrod.nim");
					nimln(66, "nimrod.nim");
					LOC38 = 0;
					LOC38 = rawNewString(ex->Sup.len + arguments_418205->Sup.len + 6);
appendString(LOC38, ((NimStringDesc*) &TMP7241));
appendString(LOC38, ex);
appendChar(LOC38, 32);
appendString(LOC38, arguments_418205);
					execexternalprogram_147713(LOC38);				}				goto LA31;
				LA33: ;
				{
					...
					nimln(69, "nimrod.nim");
					{
						...
						nimln(71, "nimrod.nim");
						binpath = prependcurdir_423401(outfile_113115);
					}					goto LA40;
					LA42: ;
					{
						NimStringDesc* LOC45;
						...
						binpath = prependcurdir_423401(LOC45);
					}					LA40: ;
					nimln(75, "nimrod.nim");
					...
					nimln(76, "nimrod.nim");
					LOC46 = 0;
					LOC46 = rawNewString(ex->Sup.len + arguments_418205->Sup.len + 1);
appendString(LOC46, ex);
appendChar(LOC46, 32);
appendString(LOC46, arguments_418205);
					execexternalprogram_147713(LOC46);				}				LA31: ;
			}			LA29: ;
		}		LA25: ;
	}	LA1: ;
	popFrame();
...
N_NOINLINE(void, nimrodInit)(void) {
	...
	initdefines_141065();	nimln(87, "nimrod.nim");
	handlecmdline_423603();	nimln(88, "nimrod.nim");
	nimln(706, "system.nim");
	exit(((NI) (((NI8) ((0 < gerrorcounter_137074))))));	popFrame();
}
