...
NIM_CONST TY144064 os_144063 = {{((NimStringDesc*) &TMP465),
...
NIM_CONST TY144463 endiantostr_144462 = {((NimStringDesc*) &TMP513),
...
NIM_CONST TY144469 cpu_144468 = {{((NimStringDesc*) &TMP515),
32,
((NU8) 0),
64,
32}
...
N_NIMCALL(void, settarget_144599)(NU8 o, NU8 c) {
	...
	TMP531 = divInt(cpu_144468[(c)- 1].Field1, 8);
	intsize_144590 = (NI32)(TMP531);
	nimln(204, "platform.nim");
	nimln(204, "platform.nim");
	if (c < 1 || c > 14) raiseIndexError();
	TMP532 = divInt(cpu_144468[(c)- 1].Field3, 8);
	floatsize_144591 = (NI32)(TMP532);
	nimln(205, "platform.nim");
	nimln(205, "platform.nim");
	if (c < 1 || c > 14) raiseIndexError();
	TMP533 = divInt(cpu_144468[(c)- 1].Field4, 8);
	ptrsize_144592 = (NI32)(TMP533);
	nimln(206, "platform.nim");
	if (o < 1 || o > 23) raiseIndexError();
	LOC9 = 0;
	LOC9 = tnl_144593; tnl_144593 = copyStringRC1(os_144063[(o)- 1].Field5);
...
N_NIMCALL(NU8, nametoos_144582)(NimStringDesc* name) {
	...
	while (1) {
		...
		nimln(210, "platform.nim");
		{
			...
			nimln(210, "platform.nim");
			nimln(210, "platform.nim");
			if (i_145072 < 1 || i_145072 > 23) raiseIndexError();
			LOC4 = 0;
			LOC4 = nsuCmpIgnoreStyle(name, os_144063[(i_145072)- 1].Field0);
			if (!(LOC4 == 0)) goto LA5;
		...
		res_145075 = addInt(res_145075, 1);
	} LA1: ;
...
N_NIMCALL(NU8, nametocpu_144586)(NimStringDesc* name) {
	...
	while (1) {
		...
		nimln(216, "platform.nim");
		{
			...
			nimln(216, "platform.nim");
			nimln(216, "platform.nim");
			if (i_145140 < 1 || i_145140 > 14) raiseIndexError();
			LOC4 = 0;
			LOC4 = nsuCmpIgnoreStyle(name, cpu_144468[(i_145140)- 1].Field0);
			if (!(LOC4 == 0)) goto LA5;
		...
		LA5: ;
		nimln(1454, "system.nim");
		res_145143 = addInt(res_145143, 1);
	} LA1: ;
...
N_NOINLINE(void, platformInit)(void) {
	...
	hostcpu_144574 = nametocpu_144586(((NimStringDesc*) &TMP515));
	nimln(221, "platform.nim");
	hostos_144576 = nametoos_144582(((NimStringDesc*) &TMP534));
	nimln(223, "platform.nim");
	settarget_144599(hostos_144576, hostcpu_144574);
	popFrame();
}
