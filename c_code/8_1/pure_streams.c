...
N_NIMCALL(NI, fsreaddata_143152)(tstream142629* s, void* buffer, NI buflen);
N_NIMCALL(NI, readbuffer_9514)(FILE* f, void* buffer, NI len);
N_NIMCALL(void, fswritedata_143160)(tstream142629* s, void* buffer, NI buflen);
...
N_NIMCALL(tfilestream143109*, newfilestream_143167)(FILE* f) {
	...
	(*result).Sup.Readdataimpl = fsreaddata_143152;
	nimln(272, "streams.nim");
	(*result).Sup.Writedataimpl = fswritedata_143160;
