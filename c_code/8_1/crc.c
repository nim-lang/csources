...
N_NIMCALL(NI32, strcrc32_146027)(NimStringDesc* s) {
	...
	HEX3Atmp_146482 = (NI32)(TMP537);
	nimln(1451, "system.nim");
	res_146484 = 0;
	nimln(1452, "system.nim");
	while (1) {
		nimln(1452, "system.nim");
		if (!(res_146484 <= HEX3Atmp_146482)) goto LA1;
		nimln(1451, "system.nim");
		i_146481 = res_146484;
		nimln(86, "crc.nim");
		if ((NU)(i_146481) > (NU)(s->Sup.len)) raiseIndexError();
		result = updatecrc32_146017(s->data[i_146481], result);
		nimln(1454, "system.nim");
		res_146484 = addInt(res_146484, 1);
	} LA1: ;
	popFrame();
	return result;
}
...
N_NIMCALL(NI32, HEX3EHEX3C_146489)(NI32 c, NimStringDesc* s) {
	...
	HEX3Atmp_146505 = (NI32)(TMP538);
	nimln(1458, "system.nim");
	res_146507 = 0;
	nimln(1459, "system.nim");
	while (1) {
		nimln(1459, "system.nim");
		if (!(res_146507 <= HEX3Atmp_146505)) goto LA1;
		nimln(1458, "system.nim");
		i_146504 = res_146507;
		nimln(90, "crc.nim");
		if ((NU)(i_146504) > (NU)(s->Sup.len)) raiseIndexError();
		result = updatecrc32_146017(s->data[i_146504], result);
		nimln(1461, "system.nim");
		res_146507 = addInt(res_146507, 1);
	} LA1: ;
	popFrame();
	return result;
}
...
N_NIMCALL(NI32, crcfrombuf_146022)(void* buf, NI length) {
	...
	HEX3Atmp_146539 = (NI32)(TMP539);
	nimln(1451, "system.nim");
	res_146541 = 0;
	nimln(1452, "system.nim");
	while (1) {
		nimln(1452, "system.nim");
		if (!(res_146541 <= HEX3Atmp_146539)) goto LA1;
		nimln(1451, "system.nim");
		i_146537 = res_146541;
		nimln(99, "crc.nim");
		if ((NU)(i_146537) > (NU)(10000000)) raiseIndexError();
		result = updatecrc32_146012(p[(i_146537)- 0], result);
		nimln(1454, "system.nim");
		res_146541 = addInt(res_146541, 1);
	} LA1: ;
	popFrame();
	return result;
}
...
N_NIMCALL(NI32, crcfromfile_146031)(NimStringDesc* filename) {
	...
	while (1) {
		...
		HEX3Atmp_146572 = (NI32)(TMP540);
		nimln(1451, "system.nim");
		res_146574 = 0;
		nimln(1452, "system.nim");
		while (1) {
			nimln(1452, "system.nim");
			if (!(res_146574 <= HEX3Atmp_146572)) goto LA7;
			nimln(1451, "system.nim");
			i_146569 = res_146574;
			nimln(113, "crc.nim");
			if ((NU)(i_146569) > (NU)(10000000)) raiseIndexError();
			result = updatecrc32_146012(p[(i_146569)- 0], result);
			nimln(1454, "system.nim");
			res_146574 = addInt(res_146574, 1);
		} LA7: ;
		nimln(114, "crc.nim");
		{
			nimln(114, "crc.nim");
