...
N_NIMCALL(NI, hashdata_109058)(void* data, NI size);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NOINLINE(void, raiseOverflow)(void);
static N_INLINE(NI, subInt)(NI a, NI b);
static N_INLINE(NI, hash_109401)(void* x);
static N_INLINE(NI, hash_109801)(NI x);
static N_INLINE(NI, hash_109807)(NI64 x);
static N_INLINE(NI, hash_109813)(NIM_CHAR x);
...
static N_INLINE(NI, hash_110002)(NF x);
extern TFrame* frameptr_12037;
TNimType NTI109011; /* THash */
...
N_NIMCALL(NI, hashdata_109058)(void* data, NI size) {
	...
	while (1) {
		...
		nimln(46, "hashes.nim");
		nimln(46, "hashes.nim");
		h = HEX21HEX26_109013(h, ((NI) (((NU8)(p[i])))));
		nimln(47, "hashes.nim");
		i = addInt(i, 1);
		nimln(48, "hashes.nim");
		s = subInt(s, 1);
...
N_NIMCALL(NI, hash_109826)(NimStringDesc* x) {
	...
	HEX3Atmp_109849 = (NI32)(TMP270);
	nimln(1308, "system.nim");
	res_109851 = 0;
	nimln(1309, "system.nim");
	while (1) {
		nimln(1309, "system.nim");
		if (!(res_109851 <= HEX3Atmp_109849)) goto LA1;
		nimln(1308, "system.nim");
		i_109840 = res_109851;
		nimln(94, "hashes.nim");
		nimln(94, "hashes.nim");
		if ((NU)(i_109840) > (NU)(x->Sup.len)) raiseIndexError();
		h = HEX21HEX26_109013(h, ((NI) (((NU8)(x->data[i_109840])))));
		nimln(1311, "system.nim");
		res_109851 = addInt(res_109851, 1);
	} LA1: ;
	nimln(95, "hashes.nim");
	result = HEX21HEX24_109036(h);
	popFrame();
...
N_NIMCALL(NI, hashignorestyle_109856)(NimStringDesc* x) {
	...
	HEX3Atmp_109916 = (NI32)(TMP271);
	nimln(1308, "system.nim");
	res_109918 = 0;
	nimln(1309, "system.nim");
	while (1) {
		nimln(1309, "system.nim");
		if (!(res_109918 <= HEX3Atmp_109916)) goto LA1;
		nimln(1308, "system.nim");
		i_109870 = res_109918;
		{
			NIM_CHAR c;
			nimln(101, "hashes.nim");
			if ((NU)(i_109870) > (NU)(x->Sup.len)) raiseIndexError();
			c = x->data[i_109870];
		...
		nimln(1311, "system.nim");
		res_109918 = addInt(res_109918, 1);
	} LA1: ;
...
N_NIMCALL(NI, hashignorecase_109924)(NimStringDesc* x) {
	...
	while (1) {
		NIM_CHAR c;
		nimln(1309, "system.nim");
		if (!(res_109985 <= HEX3Atmp_109983)) goto LA1;
		nimln(1308, "system.nim");
		i_109938 = res_109985;
		nimln(113, "hashes.nim");
		if ((NU)(i_109938) > (NU)(x->Sup.len)) raiseIndexError();
		c = x->data[i_109938];
		...
		h = HEX21HEX26_109013(h, ((NI) (((NU8)(c)))));
		nimln(1311, "system.nim");
		res_109985 = addInt(res_109985, 1);
	} LA1: ;
