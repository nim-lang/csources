...
appendString(LOC1, ((NimStringDesc*) &T3526807654_16));
	send_589002_170061329((*HEX3Aenvp_592424_3526807654).stdoutsocket592408, LOC1, 2);
}
	...
	{
		{
			while (1) {
				NimStringDesc* line0;
				NimStringDesc* LOC12;
				line0 = readline_15312_1689653243(stdin);
				{
	...
	LA2: ;
	{
		...
		writelnhook_192110_155036129.ClPrc = LOC21.ClPrc;
		{
			while (1) {
				...
				action0();
				gerrorcounter_192072_155036129 = ((NI) 0);
				send_589002_170061329((*HEX3Aenv_592426_3526807654).stdoutsocket592408, ((NimStringDesc*) &T3526807654_16), 2);
