...
static N_INLINE(NIM_BOOL, mustrehash_181058)(NI length, NI counter);
...
static N_INLINE(NI, nexttry_181206)(NI h, NI maxhash);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NIMCALL(ttrunk181043*, intsetget_181213)(tintset181047 t, NI key);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(void, intsetrawinsert_181239)(tintset181047 t, ttrunkseq181045** data, ttrunk181043* desc);
...
N_NIMCALL(void, intsetenlarge_181621)(tintset181047* t);
N_NIMCALL(void, nimGCvisit)(void* d, NI op);
N_NIMCALL(void, TMP1953)(void* p, NI op);
N_NIMCALL(void, TMP1954)(void* p, NI op);
N_NIMCALL(void*, newSeq)(TNimType* typ, NI len);
N_NIMCALL(void, unsureAsgnRef)(void** dest, void* src);
N_NIMCALL(ttrunk181043*, intsetput_181696)(tintset181047* t, NI key);
...
N_NIMCALL(void, assign_181956)(tintset181047* dest, tintset181047 src);
N_NIMCALL(NimStringDesc*, HEX24_182322)(tintset181047 s);
...
TNimType NTI181043; /* TTrunk */
extern TNimType NTI106; /* int */
extern TNimType NTI22818; /* array[0..15, int] */
TNimType NTI181041; /* PTrunk */
TNimType NTI181045; /* TTrunkSeq */
TNimType NTI181047; /* TIntSet */
...
N_NIMCALL(void, intsetenlarge_181621)(tintset181047* t) {
	...
	n = (ttrunkseq181045*) newSeq((&NTI181045), (NI32)(TMP1951));
	i_181655 = 0;
	...
	while (1) {
		...
		nimln(75, "intsets.nim");
		{
			nimln(75, "intsets.nim");
			nimln(75, "intsets.nim");
			if ((NU)(i_181655) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			if (!!(((*t).Data->data[i_181655] == NIM_NIL))) goto LA4;
			nimln(75, "intsets.nim");
			if ((NU)(i_181655) >= (NU)((*t).Data->Sup.len)) raiseIndexError();
			intsetrawinsert_181239((*t), &n, (*t).Data->data[i_181655]);
		}
		LA4: ;
		nimln(1453, "system.nim");
		res_181691 = addInt(res_181691, 1);
	} LA1: ;
...
N_NIMCALL(ttrunk181043*, intsetput_181696)(tintset181047* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_181058((NI32)(TMP1955), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
		intsetenlarge_181621(t);
	}
	LA9: ;
	...
	result = (ttrunk181043*) newObj((&NTI181041), sizeof(ttrunk181043));
...
N_NIMCALL(NIM_BOOL, contains_181838)(tintset181047 s, NI key) {
	...
	nimln(97, "intsets.nim");
	t = intsetget_181213(s, (NI)((NU32)(key) >> (NU32)(9)));
...
N_NIMCALL(void, incl_181866)(tintset181047* s, NI key) {
	...
	nimln(106, "intsets.nim");
	t = intsetput_181696(s, (NI)((NU32)(key) >> (NU32)(9)));
...
N_NIMCALL(void, initintset_181935)(tintset181047* Result) {
	...
	unsureAsgnRef((void**) &(*Result).Data, (ttrunkseq181045*) newSeq((&NTI181045), 8));
...
N_NIMCALL(void, assign_181956)(tintset181047* dest, tintset181047 src) {
	...
	nimln(145, "intsets.nim");
	unsureAsgnRef((void**) &(*dest).Data, (ttrunkseq181045*) newSeq((&NTI181045), src.Data->Sup.len));
	...
	while (1) {
		...
		n = (ttrunk181043*) newObj((&NTI181041), sizeof(ttrunk181043));
...
N_NIMCALL(NimStringDesc*, HEX24_182322)(tintset181047 s) {
	...
	while (1) {
		...
		while (1) {
			...
			NI j_182336;
			nimln(169, "intsets.nim");
			if (!(i_182332 <= 15)) goto LA2;
			nimln(170, "intsets.nim");
			if ((NU)(i_182332) > (NU)(15)) raiseIndexError();
			w_182334 = (*r_182330).Bits[(i_182332)- 0];
			...
			while (1) {
				...
				nimln(175, "intsets.nim");
				{
					...
					nimln(175, "intsets.nim");
					nimln(175, "intsets.nim");
					if (!!((((NI) ((NI)(w_182334 & 1))) == 0))) goto LA6;
					nimln(176, "intsets.nim");
					nimln(176, "intsets.nim");
					nimln(176, "intsets.nim");
					nimln(176, "intsets.nim");
					nimln(176, "intsets.nim");
					key_182327 = (NI)((NI)((NU32)((*r_182330).Key) << (NU32)(9)) | (NI)((NU32)((NI)((NU32)(i_182332) << (NU32)(5))) + (NU32)(j_182336)));
...
NTI181043.size = sizeof(ttrunk181043);
NTI181043.kind = 18;
NTI181043.base = 0;
TMP1952[0] = &TMP1938[1];
TMP1938[1].kind = 1;
TMP1938[1].offset = offsetof(ttrunk181043, Next);
TMP1938[1].typ = (&NTI181041);
TMP1938[1].name = "next";
TMP1952[1] = &TMP1938[2];
TMP1938[2].kind = 1;
TMP1938[2].offset = offsetof(ttrunk181043, Key);
TMP1938[2].typ = (&NTI106);
TMP1938[2].name = "key";
TMP1952[2] = &TMP1938[3];
TMP1938[3].kind = 1;
TMP1938[3].offset = offsetof(ttrunk181043, Bits);
TMP1938[3].typ = (&NTI22818);
TMP1938[3].name = "bits";
TMP1938[0].len = 3; TMP1938[0].kind = 2; TMP1938[0].sons = &TMP1952[0];
NTI181043.node = &TMP1938[0];
NTI181041.size = sizeof(ttrunk181043*);
NTI181041.kind = 22;
NTI181041.base = (&NTI181043);
NTI181041.marker = TMP1953;
NTI181045.size = sizeof(ttrunkseq181045*);
NTI181045.kind = 24;
NTI181045.base = (&NTI181041);
NTI181045.flags = 2;
NTI181045.marker = TMP1954;
NTI181047.size = sizeof(tintset181047);
NTI181047.kind = 18;
NTI181047.base = 0;
NTI181047.flags = 2;
TMP3246[0] = &TMP1938[5];
TMP1938[5].kind = 1;
TMP1938[5].offset = offsetof(tintset181047, Counter);
TMP1938[5].typ = (&NTI106);
TMP1938[5].name = "counter";
TMP3246[1] = &TMP1938[6];
TMP1938[6].kind = 1;
TMP1938[6].offset = offsetof(tintset181047, Max);
TMP1938[6].typ = (&NTI106);
TMP1938[6].name = "max";
TMP3246[2] = &TMP1938[7];
TMP1938[7].kind = 1;
TMP1938[7].offset = offsetof(tintset181047, Head);
TMP1938[7].typ = (&NTI181041);
TMP1938[7].name = "head";
TMP3246[3] = &TMP1938[8];
TMP1938[8].kind = 1;
TMP1938[8].offset = offsetof(tintset181047, Data);
TMP1938[8].typ = (&NTI181045);
TMP1938[8].name = "data";
TMP1938[4].len = 4; TMP1938[4].kind = 2; TMP1938[4].sons = &TMP3246[0];
NTI181047.node = &TMP1938[4];
}
