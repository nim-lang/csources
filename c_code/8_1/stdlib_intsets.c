...
N_NIMCALL(void, intsetenlarge_205614)(intset205056* t) {
	...
	n = (ttrunkseq205054*) newSeq((&NTI205054), (NI32)((*t).Max + 1));
	{
		NI i_205648;
		NI res_205686;
		i_205648 = 0;
...
{	result = 0;
	...
	}
	{
		NIM_BOOL LOC9;
		LOC9 = 0;
		LOC9 = mustrehash_205073((NI32)((*t).Max + 1), (*t).Counter);
		if (!LOC9) goto LA10;
...
N_NIMCALL(void, incl_205869)(intset205056* s, NI key) {
	ttrunk205052* t;
	NI u;
	t = intsetput_205703(s, (NI)((NU32)(key) >> (NU32)(9)));
	u = (NI)(key & 511);
...
N_NIMCALL(NIM_BOOL, containsorincl_205916)(intset205056* s, NI key) {
	...
	ttrunk205052* t;
	result = 0;
	t = intsetget_205220((*s), (NI)((NU32)(key) >> (NU32)(9)));
	{
		NI u;
