...
N_NIMCALL(ttrunk220052*, intsetget_220220)(intset220056 t, NI key);
static N_INLINE(NI, nexttry_220209)(NI h, NI maxhash);
N_NIMCALL(void, incl_220869)(intset220056* s, NI key);
N_NIMCALL(ttrunk220052*, intsetput_220703)(intset220056* t, NI key);
static N_INLINE(NIM_BOOL, mustrehash_220073)(NI length, NI counter);
N_NIMCALL(void, intsetenlarge_220614)(intset220056* t);
N_NIMCALL(void, intsetrawinsert_220256)(intset220056 t, ttrunkseq220054** data, ttrunk220052* desc);
...
TNimType NTI220052; /* TTrunk */
extern TNimType NTI26220; /* array[0..15, int] */
TNimType NTI220050; /* PTrunk */
TNimType NTI220054; /* TTrunkSeq */
...
N_NIMCALL(void, initintset_220950)(intset220056* Result) {
	unsureAsgnRef((void**) &(*Result).Data, (ttrunkseq220054*) newSeq((&NTI220054), 8));
	(*Result).Max = 7;
	(*Result).Counter = 0;
...
N_NIMCALL(void, intsetenlarge_220614)(intset220056* t) {
	ttrunkseq220054* n;
	NI oldmax;
	ttrunkseq220054* LOC8;
	n = 0;
	oldmax = (*t).Max;
	(*t).Max = (NI32)((NI32)((NI32)((*t).Max + 1) * 2) - 1);
	n = (ttrunkseq220054*) newSeq((&NTI220054), (NI32)((*t).Max + 1));
	{
		NI i_220648;
		NI res_220686;
		i_220648 = 0;
		...
		{
			while (1) {
				if (!(res_220686 <= oldmax)) goto LA3;
				i_220648 = res_220686;
				{
					if (!!(((*t).Data->data[i_220648] == NIM_NIL))) goto LA6;
					intsetrawinsert_220256((*t), &n, (*t).Data->data[i_220648]);
				}
				LA6: ;
				res_220686 += 1;
			} LA3: ;
...
N_NIMCALL(ttrunk220052*, intsetput_220703)(intset220056* t, NI key) {
	...
	}
	{
		NIM_BOOL LOC9;
		LOC9 = 0;
		LOC9 = mustrehash_220073((NI32)((*t).Max + 1), (*t).Counter);
		if (!LOC9) goto LA10;
	...
	result = (ttrunk220052*) newObj((&NTI220050), sizeof(ttrunk220052));
...
N_NIMCALL(void, incl_220869)(intset220056* s, NI key) {
	ttrunk220052* t;
	NI u;
	t = intsetput_220703(s, (NI)((NU32)(key) >> (NU32)(9)));
	u = (NI)(key & 511);
...
N_NIMCALL(NIM_BOOL, containsorincl_220916)(intset220056* s, NI key) {
	...
	ttrunk220052* t;
	result = 0;
	t = intsetget_220220((*s), (NI)((NU32)(key) >> (NU32)(9)));
	{
		NI u;
...
N_NIMCALL(void, assign_220975)(intset220056* dest, intset220056 src) {
	...
	(*dest).Max = src.Max;
	unsureAsgnRef((void**) &(*dest).Data, (ttrunkseq220054*) newSeq((&NTI220054), src.Data->Sup.len));
	it = src.Head;
	{
		while (1) {
			NI h;
			...
			h = (NI)((*it).Key & (*dest).Max);
			{
				while (1) {
					...
					h = nexttry_220209(h, (*dest).Max);
				} LA4: ;
			}
			n = 0;
			n = (ttrunk220052*) newObj((&NTI220050), sizeof(ttrunk220052));
...
TMP960[0] = &TMP719[1];
TMP719[1].kind = 1;
TMP719[1].offset = offsetof(intset220056, Counter);
TMP719[1].typ = (&NTI108);
TMP719[1].name = "counter";
TMP960[1] = &TMP719[2];
TMP719[2].kind = 1;
TMP719[2].offset = offsetof(intset220056, Max);
TMP719[2].typ = (&NTI108);
TMP719[2].name = "max";
TMP960[2] = &TMP719[3];
NTI220052.size = sizeof(ttrunk220052);
NTI220052.kind = 18;
NTI220052.base = 0;
TMP961[0] = &TMP719[5];
TMP719[5].kind = 1;
TMP719[5].offset = offsetof(ttrunk220052, Next);
TMP719[5].typ = (&NTI220050);
TMP719[5].name = "next";
TMP961[1] = &TMP719[6];
TMP719[6].kind = 1;
TMP719[6].offset = offsetof(ttrunk220052, Key);
TMP719[6].typ = (&NTI108);
TMP719[6].name = "key";
TMP961[2] = &TMP719[7];
TMP719[7].kind = 1;
TMP719[7].offset = offsetof(ttrunk220052, Bits);
TMP719[7].typ = (&NTI26220);
TMP719[7].name = "bits";
TMP719[4].len = 3; TMP719[4].kind = 2; TMP719[4].sons = &TMP961[0];
NTI220052.node = &TMP719[4];
NTI220050.size = sizeof(ttrunk220052*);
NTI220050.kind = 22;
NTI220050.base = (&NTI220052);
NTI220050.marker = TMP962;
TMP719[3].kind = 1;
TMP719[3].offset = offsetof(intset220056, Head);
TMP719[3].typ = (&NTI220050);
TMP719[3].name = "head";
TMP960[3] = &TMP719[8];
NTI220054.size = sizeof(ttrunkseq220054*);
NTI220054.kind = 24;
NTI220054.base = (&NTI220050);
NTI220054.flags = 2;
NTI220054.marker = TMP963;
TMP719[8].kind = 1;
TMP719[8].offset = offsetof(intset220056, Data);
TMP719[8].typ = (&NTI220054);
TMP719[8].name = "data";
TMP719[0].len = 4; TMP719[0].kind = 2; TMP719[0].sons = &TMP960[0];
NTI220056.node = &TMP719[0];
}
