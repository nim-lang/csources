...
static NIM_CONST TY171865 TMP3449 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3450, "sym", 3);
static NIM_CONST TY171865 TMP3451 = {
...
N_NIMCALL(tnode171659*, evaltemplateargs_251201)(tnode171659* n, tsym171689* s) {
	...
	nimln(86, "evaltempl.nim");
	{
		...
		if (!(f < a)) goto LA5;
		nimln(86, "evaltempl.nim");
		globalerror_138336((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP3456));	}	LA5: ;
	...
	while (1) {
		...
		LA10: ;
		{
			...
			if (!(((TMP3449[(*(*(*(*s).Typ).N).kindU.S6.Sons->data[i_251218]).Kind/8] &(1<<((*(*(*(*s).Typ).N).kindU.S6.Sons->data[i_251218]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3450));
		...
		nimln(91, "evaltempl.nim");
		{
			...
			localerror_138349((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP3456));		}		LA17: ;
...
N_NIMCALL(tnode171659*, evaltemplate_251285)(tnode171659* n, tsym171689* tmpl, tsym171689* gensymowner) {
	...
	nimln(100, "evaltempl.nim");
	{
		...
		globalerror_138336((*n).Info, ((NU16) 183), ((NimStringDesc*) &TMP3456));		nimln(102, "evaltempl.nim");
		result = n;
	}	LA3: ;
