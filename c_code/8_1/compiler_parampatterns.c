...
NIM_CONST TY88687 TMP3304 = {((NimStringDesc*) &TMP3305),
((NI) 100)}
;
NIM_CONST TY88687 TMP3306 = {((NimStringDesc*) &TMP3305),
((NI) 107)}
;
...
{	result = 0;
	...
	case ((NU8) 32):
	{
		...
		op = (*n).kindU.S6.sons->data[((NI) 0)];
		{
			...
			LOC4 = ((*op).kind == ((NU8) 3));
			if (!(LOC4)) goto LA5;
			LOC4 = isroutine_219396((*op).kindU.S4.sym);
			LA5: ;
			if (!LOC4) goto LA6;
			s = (*op).kindU.S4.sym;
			{
