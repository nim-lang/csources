	...
	nimln(168, "passes.nim");
	{
		...
		while (1) {
			...
			openparsers_197034(&p, fileidx, s);			nimln(181, "passes.nim");
			{
				...
				processimplicits_222443(implicitimports_113242, ((NU8) 115), a);				nimln(187, "passes.nim");
				processimplicits_222443(implicitincludes_113261, ((NU8) 120), a);			}			LA17: ;
