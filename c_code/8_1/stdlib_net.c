...
N_NIMCALL(NI, send_547721)(socketimpl543407* socket, void* data, NI size);
...
N_NIMCALL(NI, waitfor_546818)(socketimpl543407* socket, NF* waited, NI timeout, NI size, NimStringDesc* funcname);
...
N_NIMCALL(void, send_548208)(socketimpl543407* socket, NimStringDesc* data, NU8 flags) {
	NI sent;
{	sent = send_547721(socket, ((void*) (data->data)), data->Sup.len);
	{
		NI32 lasterror;
		if (!(sent < 0)) goto LA3;
...
appendString(LOC22, ((NimStringDesc*) &TMP4875));
		...
		selret = select_546207(socket, (NI32)(timeout - ((NI) (((NF)((*waited)) * (NF)(1.0000000000000000e+03))))));
		{
			NI32 LOC27;
...
{	waited = 0.0;
	(*line) = setLengthStr((*line), 0);
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_546818(socket, (&waited), timeout, 1, ((NimStringDesc*) &TMP4877));
			...
			LA4: ;
			{
				...
				LOC20 = 0;
				LOC20 = waitfor_546818(socket, (&waited), timeout, 1, ((NimStringDesc*) &TMP4877));
