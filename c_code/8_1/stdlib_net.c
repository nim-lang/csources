...
N_NIMCALL(NI, send_588493_170061329)(Socketimpl583404* socket0, void* data0, NI size0);
...
N_NIMCALL(NI, waitfor_587607_170061329)(Socketimpl583404* socket0, NF* waited0, NI timeout0, NI size0, NimStringDesc* funcname0);
...
N_NIMCALL(void, send_589002_170061329)(Socketimpl583404* socket0, NimStringDesc* data0, Socketflag583414Set flags0) {
	NI sent0;
{	sent0 = send_588493_170061329(socket0, ((void*) (data0->data)), (data0 ? data0->Sup.len : 0));
	{
		NI32 lasterror0;
...
{	waited0 = 0.0;
	(*line0) = setLengthStr((*line0), ((NI) 0));
	{
		while (1) {
			...
			c0 = (NIM_CHAR)0;
			LOC3 = (NI)0;
			LOC3 = waitfor_587607_170061329(socket0, (&waited0), timeout0, ((NI) 1), ((NimStringDesc*) &T170061329_11));
			...
			LA4: ;
			{
				...
				LOC20 = (NI)0;
				LOC20 = waitfor_587607_170061329(socket0, (&waited0), timeout0, ((NI) 1), ((NimStringDesc*) &T170061329_11));
