...
N_NIMCALL(tstringtable111610*, nstnewStringTableWithTableConstr)(TY87905* keyvaluepairs, NI keyvaluepairsLen0, NU8 mode);
...
extern TNimType NTI87905; /* tuple[nonDST: string, DST: string] */
...
N_NIMCALL(void, enlarge_111876)(tstringtable111610* t) {
	...
	n = (tkeyvaluepairseq111608*) newSeq((&NTI111608), (NI32)(TMP287));
	i_111907 = 0;
	HEX3Atmp_111921 = 0;
...
N_NIMCALL(tstringtable111610*, nstnewStringTableWithPairs)(NimStringDesc** keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	...
	while (1) {
		...
		nstPut(result, keyvaluepairs[i], keyvaluepairs[(NI32)(TMP299)]);		nimln(177, "strtabs.nim");
		i = addInt(i, 2);
	} LA1: ;
	popFrame();
	return result;
