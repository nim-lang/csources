...
#include <stdio.h>
typedef struct ttmplparser216017 ttmplparser216017;
...
N_NIMCALL(void, newline_216040)(ttmplparser216017* p);
N_NIMCALL(void, llstreamwrite_172258)(tllstream172204* s, NimStringDesc* data);
N_NIMCALL(NimStringDesc*, nsuRepeatChar)(NI count, NIM_CHAR c);
static N_INLINE(void, nimFrame)(TFrame* s);
static N_INLINE(void, popFrame)(void);
N_NIMCALL(void, scanpar_216047)(ttmplparser216017* p, NI d);
N_NOINLINE(void, raiseIndexError)(void);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NOINLINE(void, raiseOverflow)(void);
static N_INLINE(NI, subInt)(NI a, NI b);
static N_INLINE(NIM_BOOL, withinexpr_216168)(ttmplparser216017* p);
N_NIMCALL(void, parseline_216177)(ttmplparser216017* p);
N_NIMCALL(NimStringDesc*, copyString)(NimStringDesc* src);
N_NIMCALL(NimStringDesc*, addChar)(NimStringDesc* s, NIM_CHAR c);
N_NIMCALL(NIM_BOOL, endswithopr_172646)(NimStringDesc* x);
...
N_NIMCALL(void, llstreamwrite_172263)(tllstream172204* s, NIM_CHAR data);
...
NIM_CONST TY120387 patternchars_216037 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0xFF, 0x03,
0xFE, 0xFF, 0xFF, 0x87, 0xFE, 0xFF, 0xFF, 0x07,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP2667, "\012", 1);
STRING_LITERAL(TMP2668, "", 0);
STRING_LITERAL(TMP2669, "end", 3);
STRING_LITERAL(TMP2670, "#end", 4);
static NIM_CONST TY120387 TMP2672 = {
...
STRING_LITERAL(TMP2676, "\\x", 2);
STRING_LITERAL(TMP2677, "\\\\", 2);
STRING_LITERAL(TMP2678, "\\\'", 2);
STRING_LITERAL(TMP2679, "\\\"", 2);
STRING_LITERAL(TMP2680, "}", 1);
STRING_LITERAL(TMP2681, "$", 1);
STRING_LITERAL(TMP2682, "\\n\"", 3);
STRING_LITERAL(TMP2683, "subschar", 8);
STRING_LITERAL(TMP2684, "metachar", 8);
STRING_LITERAL(TMP2685, "emit", 4);
STRING_LITERAL(TMP2686, "result.add", 10);
STRING_LITERAL(TMP2687, "conc", 4);
STRING_LITERAL(TMP2688, " & ", 3);
STRING_LITERAL(TMP2689, "tostring", 8);
...
N_NIMCALL(void, newline_216040)(ttmplparser216017* p) {
	...
	llstreamwrite_172258((*p).Outp, LOC1);
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		nimln(42, "filter_tmpl.nim");
		llstreamwrite_172258((*p).Outp, ((NimStringDesc*) &TMP2667));
	}
	LA4: ;
	nimln(43, "filter_tmpl.nim");
	{
		...
		llstreamwrite_172258((*p).Outp, LOC10);
...
N_NIMCALL(void, parseline_216177)(ttmplparser216017* p) {
	...
	LA6: ;
	{
		...
		keyw = copyString(((NimStringDesc*) &TMP2668));
		...
		LOC13 = 0;
		nimln(83, "filter_tmpl.nim");
		LOC13 = withinexpr_216168(&(*p));
		if (LOC13) goto LA14;
		nimln(83, "filter_tmpl.nim");
		LOC13 = endswithopr_172646((*p).X);
		LA14: ;
		(*p).Pendingexprline = LOC13;
		nimln(84, "filter_tmpl.nim");
		nimln(84, "filter_tmpl.nim");
		LOC15 = 0;
		LOC15 = whichkeyword_168367(keyw);
		switch (LOC15) {
		case ((NU8) 20):
		{
			NimStringDesc* LOC22;
			...
			LA19: ;
			{
				...
				localerror_162571((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP2669));
			}
			LA17: ;
			...
			llstreamwrite_172258((*p).Outp, LOC22);
			nimln(92, "filter_tmpl.nim");
			llstreamwrite_172258((*p).Outp, ((NimStringDesc*) &TMP2670));
		}
		break;
		case ((NU8) 28):
		case ((NU8) 63):
		...
		case ((NU8) 39):
		{
			...
			llstreamwrite_172258((*p).Outp, LOC24);
			nimln(96, "filter_tmpl.nim");
			nimln(96, "filter_tmpl.nim");
			LOC25 = 0;
			LOC25 = copyStr((*p).X, d);
			llstreamwrite_172258((*p).Outp, LOC25);
		...
		case ((NU8) 24):
		{
			...
			nimln(99, "filter_tmpl.nim");
			nimln(99, "filter_tmpl.nim");
			TMP2671 = subInt((*p).Indent, 2);
			LOC27 = 0;
			LOC27 = nsuRepeatChar((NI32)(TMP2671), 32);
			llstreamwrite_172258((*p).Outp, LOC27);
			nimln(100, "filter_tmpl.nim");
			nimln(100, "filter_tmpl.nim");
			LOC28 = 0;
			LOC28 = copyStr((*p).X, d);
			llstreamwrite_172258((*p).Outp, LOC28);
		}
		break;
		case ((NU8) 37):
		case ((NU8) 62):
		...
		case ((NU8) 60):
		{
			...
			llstreamwrite_172258((*p).Outp, LOC30);
			nimln(103, "filter_tmpl.nim");
			nimln(103, "filter_tmpl.nim");
			LOC31 = 0;
			LOC31 = copyStr((*p).X, d);
			llstreamwrite_172258((*p).Outp, LOC31);
			nimln(104, "filter_tmpl.nim");
			{
				...
				nimln(104, "filter_tmpl.nim");
				LOC34 = 0;
				LOC34 = contains_90258((*p).X, TMP2672);
				if (!!(LOC34)) goto LA35;
		...
		default:
		{
			...
			llstreamwrite_172258((*p).Outp, LOC38);
			nimln(109, "filter_tmpl.nim");
			nimln(109, "filter_tmpl.nim");
			LOC39 = 0;
			LOC39 = copyStr((*p).X, d);
			llstreamwrite_172258((*p).Outp, LOC39);
		}
		break;
		}
	...
	LA9: ;
	{
		...
		case ((NU8) 1):
		{
			...
			llstreamwrite_172258((*p).Outp, (*p).Conc);
			nimln(122, "filter_tmpl.nim");
			llstreamwrite_172258((*p).Outp, ((NimStringDesc*) &TMP2667));
			nimln(123, "filter_tmpl.nim");
			nimln(123, "filter_tmpl.nim");
			nimln(123, "filter_tmpl.nim");
			TMP2673 = addInt((*p).Indent, 2);
			LOC42 = 0;
			LOC42 = nsuRepeatChar((NI32)(TMP2673), 32);
			llstreamwrite_172258((*p).Outp, LOC42);
			nimln(124, "filter_tmpl.nim");
			llstreamwrite_172258((*p).Outp, ((NimStringDesc*) &TMP2674));
		}
		break;
		case ((NU8) 0):
		{
			...
			llstreamwrite_172258((*p).Outp, LOC44);
			nimln(128, "filter_tmpl.nim");
			llstreamwrite_172258((*p).Outp, (*p).Emit);
			nimln(129, "filter_tmpl.nim");
			llstreamwrite_172258((*p).Outp, ((NimStringDesc*) &TMP2675));
		...
		while (1) {
			...
			case 128 ... 255:
			{
				...
				llstreamwrite_172258((*p).Outp, ((NimStringDesc*) &TMP2676));
				...
				llstreamwrite_172258((*p).Outp, LOC48);
			...
			case 92:
			{
				...
				llstreamwrite_172258((*p).Outp, ((NimStringDesc*) &TMP2677));
			...
			case 39:
			{
				...
				llstreamwrite_172258((*p).Outp, ((NimStringDesc*) &TMP2678));
			...
			case 34:
			{
				...
				llstreamwrite_172258((*p).Outp, ((NimStringDesc*) &TMP2679));
			...
			default:
			{
				nimln(150, "filter_tmpl.nim");
				{
					...
					case 123:
					{
						...
						llstreamwrite_172263((*p).Outp, 34);
						nimln(157, "filter_tmpl.nim");
						llstreamwrite_172258((*p).Outp, (*p).Conc);
						nimln(158, "filter_tmpl.nim");
						llstreamwrite_172258((*p).Outp, (*p).Tostr);
						nimln(159, "filter_tmpl.nim");
						llstreamwrite_172263((*p).Outp, 40);
						...
						while (1) {
							...
							case 0:
							{
								...
								localerror_162571((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP2680));
							...
							case 123:
							{
								...
								llstreamwrite_172263((*p).Outp, 123);
							}
							break;
							case 125:
							{
								...
								llstreamwrite_172263((*p).Outp, 125);
							}
							break;
							default:
							{
								...
								if ((NU)(j) > (NU)((*p).X->Sup.len)) raiseIndexError();
								llstreamwrite_172263((*p).Outp, (*p).X->data[j]);
						...
						llstreamwrite_172263((*p).Outp, 41);
					...
					default:
					{
						nimln(194, "filter_tmpl.nim");
						{
							...
							llstreamwrite_172263((*p).Outp, (*p).Subschar);
						...
						LA76: ;
						{
							...
							localerror_162571((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP2681));
						}
						LA74: ;
					}
					break;
		...
		llstreamwrite_172258((*p).Outp, ((NimStringDesc*) &TMP2682));
	}
	LA2: ;
	popFrame();
}
...
N_NIMCALL(tllstream172204*, filtertmpl_216007)(tllstream172204* stdin_216009, NimStringDesc* filename, tnode184813* call) {
	...
	p.Info = newlineinfo_161077(filename, 0, 0);
	nimln(208, "filter_tmpl.nim");
	p.Outp = llstreamopen_172218(((NimStringDesc*) &TMP2668));
	nimln(209, "filter_tmpl.nim");
	p.Inp = stdin_216009;
	nimln(210, "filter_tmpl.nim");
	p.Subschar = chararg_215014(call, ((NimStringDesc*) &TMP2683), 1, 36);
	nimln(211, "filter_tmpl.nim");
	p.Nimdirective = chararg_215014(call, ((NimStringDesc*) &TMP2684), 2, 35);
	nimln(212, "filter_tmpl.nim");
	p.Emit = strarg_215021(call, ((NimStringDesc*) &TMP2685), 3, ((NimStringDesc*) &TMP2686));
	nimln(213, "filter_tmpl.nim");
	p.Conc = strarg_215021(call, ((NimStringDesc*) &TMP2687), 4, ((NimStringDesc*) &TMP2688));
	nimln(214, "filter_tmpl.nim");
	p.Tostr = strarg_215021(call, ((NimStringDesc*) &TMP2689), 5, ((NimStringDesc*) &TMP2681));
	...
	while (1) {
		...
		nimln(216, "filter_tmpl.nim");
		LOC2 = 0;
		LOC2 = llstreamreadline_172248(p.Inp, &p.X);
		if (!LOC2) goto LA1;
		nimln(217, "filter_tmpl.nim");
		nimln(217, "filter_tmpl.nim");
		TMP2690 = addInt(p.Info.Line, ((NI16) 1));
		if (TMP2690 < -32768 || TMP2690 > 32767) raiseOverflow();
		p.Info.Line = (NI16)(TMP2690);
