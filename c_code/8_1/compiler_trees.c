...
N_NIMCALL(tnode208818*, extractrange_240825)(NU8 k, tnode208818* n, NI a, NI b) {
	tnode208818* result;
	result = 0;
	result = newnodei_210807(k, (*n).Info, (NI32)((NI32)(b - a) + 1));
	{
		NI i_240842;
		NI HEX3Atmp_240846;
		NI res_240849;
		i_240842 = 0;
		HEX3Atmp_240846 = 0;
		HEX3Atmp_240846 = (NI32)(b - a);
		res_240849 = 0;
		{
			while (1) {
				if (!(res_240849 <= HEX3Atmp_240846)) goto LA3;
				i_240842 = res_240849;
				asgnRefNoCycle((void**) (&(*result).kindU.S6.Sons->data[i_240842]), (*n).kindU.S6.Sons->data[(NI32)(i_240842 + a)]);
				res_240849 += 1;
			} LA3: ;
		}
	}
