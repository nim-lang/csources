...
extern TNimType NTI94105; /* tuple[nonDST: string, DST: string] */
...
static N_INLINE(NI, nexttry_120006)(NI h, NI maxhash) {
	...
	nimln(89, "strtabs.nim");
	TMP282 = mulInt(5, h);
	TMP283 = addInt((NI32)(TMP282), 1);
	result = (NI)((NI32)(TMP283) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, enlarge_120081)(tstringtable119810* t) {
	...
	n = (tkeyvaluepairseq119808*) newSeq((&NTI119808), (NI32)(TMP287));
	i_120124 = 0;
	HEX3Atmp_120142 = 0;
...
N_NIMCALL(tstringtable119810*, nstnewStringTableWithPairs)(NimStringDesc** keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	...
	while (1) {
		...
		nimln(176, "strtabs.nim");
		TMP299 = addInt(i, 1);
		if ((NU)((NI32)(TMP299)) >= (NU)(keyvaluepairsLen0)) raiseIndexError();
		nstPut(result, keyvaluepairs[i], keyvaluepairs[(NI32)(TMP299)]);
