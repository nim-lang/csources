...
NIM_CONST TY197015 parsernames_197014 = {((NimStringDesc*) &TMP2621),
...
N_NIMCALL(tnode171659*, parseall_197046)(tparsers197026* p) {
	...
	case ((NU8) 2):
	{
		...
		internalerror_138383(((NimStringDesc*) &TMP2632));		nimln(63, "syntaxes.nim");
...
N_NIMCALL(tnode171659*, parsetoplevelstmt_197051)(tparsers197026* p) {
	...
	case ((NU8) 2):
	{
		...
		internalerror_138383(((NimStringDesc*) &TMP2632));		nimln(74, "syntaxes.nim");
		result = emptynode_172505;
	}	break;
	}
	popFrame();
...
N_NIMCALL(tllstream161204*, evalpipe_197391)(tparsers197026* p, tnode171659* n, NimStringDesc* filename, tllstream161204* start) {
	...
	nimln(152, "syntaxes.nim");
	{
		...
		if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP2638[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2639));
		LOC7 = identeq_140456((*(*n).kindU.S6.Sons->data[0]).kindU.S5.Ident, ((NimStringDesc*) &TMP2640));
		LA10: ;
		if (!LOC7) goto LA11;
		i_197465 = 0;
		nimln(1301, "system.nim");
...
NTI197005.node = &TMP2257[5];
TMP2257[1].kind = 1;
TMP2257[1].offset = offsetof(tparsers197026, Skin);
TMP2257[1].typ = (&NTI197005);
TMP2257[1].name = "skin";
TMP2628[1] = &TMP2257[6];
TMP2257[6].kind = 1;
TMP2257[6].offset = offsetof(tparsers197026, Parser);
TMP2257[6].typ = (&NTI185203);
TMP2257[6].name = "parser";
TMP2257[0].len = 2; TMP2257[0].kind = 2; TMP2257[0].sons = &TMP2628[0];
NTI197026.node = &TMP2257[0];
}
