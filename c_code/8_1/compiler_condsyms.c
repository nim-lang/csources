...
tstringtable111610* gsymbols_141003;
...
N_NIMCALL(void, definesymbol_141006)(NimStringDesc* symbol) {
	...
	nstPut(gsymbols_141003, symbol, ((NimStringDesc*) &TMP897));	popFrame();
}
N_NIMCALL(void, undefsymbol_141011)(NimStringDesc* symbol) {
	nimfr("UndefSymbol", "condsyms.nim")
	nimln(23, "condsyms.nim");
	nstPut(gsymbols_141003, symbol, ((NimStringDesc*) &TMP898));	popFrame();
}
static N_INLINE(NIM_BOOL, eqStrings)(NimStringDesc* a, NimStringDesc* b) {
	NIM_BOOL result;
	NIM_BOOL LOC11;
...
N_NIMCALL(NI, countdefinedsymbols_141041)(void) {
	...
	while (1) {
		...
		nimln(41, "strtabs.nim");
		{
			...
			{
				nimln(38, "condsyms.nim");
				if (!eqStrings(val_141045, ((NimStringDesc*) &TMP897))) goto LA8;
				nimln(38, "condsyms.nim");
...
N_NIMCALL(void, initdefines_141065)(void) {
	...
	definesymbol_141006(((NimStringDesc*) &TMP899));	nimln(44, "condsyms.nim");
	definesymbol_141006(((NimStringDesc*) &TMP900));	nimln(45, "condsyms.nim");
	definesymbol_141006(((NimStringDesc*) &TMP901));	nimln(46, "condsyms.nim");
	definesymbol_141006(((NimStringDesc*) &TMP902));	nimln(47, "condsyms.nim");
	definesymbol_141006(((NimStringDesc*) &TMP903));	nimln(48, "condsyms.nim");
	definesymbol_141006(((NimStringDesc*) &TMP904));	nimln(49, "condsyms.nim");
	definesymbol_141006(((NimStringDesc*) &TMP905));	nimln(52, "condsyms.nim");
	switch (targetcpu_118560) {
	case ((NU8) 1):
	{
		nimln(53, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP906));	}	break;
	case ((NU8) 8):
	{
		nimln(54, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP907));	}	break;
	case ((NU8) 9):
	{
	...
	case ((NU8) 1):
	{
		...
		definesymbol_141006(((NimStringDesc*) &TMP909));	}	break;
	case ((NU8) 2):
	{
		nimln(61, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP910));		nimln(62, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP911));	}	break;
	case ((NU8) 4):
	case ((NU8) 5):
	case ((NU8) 6):
	case ((NU8) 8):
	...
	case ((NU8) 20):
	{
		...
		definesymbol_141006(((NimStringDesc*) &TMP912));		nimln(67, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP913));	}	break;
	case ((NU8) 7):
	{
		nimln(69, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP914));		nimln(70, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP912));		nimln(71, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP913));	}	break;
	case ((NU8) 9):
	case ((NU8) 10):
	case ((NU8) 11):
	{
		...
		definesymbol_141006(((NimStringDesc*) &TMP912));		nimln(74, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP915));		nimln(75, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP913));	}	break;
	case ((NU8) 18):
	{
		nimln(77, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP916));	}	break;
	case ((NU8) 19):
	{
		nimln(79, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP916));		nimln(80, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP912));		nimln(81, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP913));	}	break;
	default:
	{
	}	break;
...
appendString(LOC13, LOC14);
	...
	if (targetcpu_118560 < 1 || targetcpu_118560 > 14) raiseIndexError();
	definesymbol_141006(cpu_118460[(targetcpu_118560)- 1].Field0);	nimln(86, "condsyms.nim");
	if (targetos_118562 < 1 || targetos_118562 > 23) raiseIndexError();
	definesymbol_141006(os_118061[(targetos_118562)- 1].Field0);	nimln(87, "condsyms.nim");
	{
		nimln(87, "condsyms.nim");
		if (targetos_118562 < 1 || targetos_118562 > 23) raiseIndexError();
		if (!((os_118061[(targetos_118562)- 1].Field12 &(1<<((((NU8) 3))&7)))!=0)) goto LA18;
		nimln(88, "condsyms.nim");
		definesymbol_141006(((NimStringDesc*) &TMP918));	}	LA18: ;
	popFrame();
