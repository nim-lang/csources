...
N_NIMCALL(NCSTRING*, tocstringarray_145692)(tstringtable111610* t);
...
N_NIMCALL(tprocess144203*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, tstringtable111610* env, NU8 options);
...
NIM_CONST TY112118 safeunixchars_144238 = {
...
N_NIMCALL(tprocess144203*, startcmd_144428)(NimStringDesc* command, NU8 options) {
	...
	a = (TY9552*) newSeq((&NTI9552), (NI32)(TMP946));
	i_144473 = 0;
	HEX3Atmp_144475 = 0;
	...
	while (1) {
		...
		nimln(138, "osproc.nim");
		nimln(138, "osproc.nim");
		TMP948 = subInt(i_144473, 1);
		if ((NU)((NI32)(TMP948)) >= (NU)(a->Sup.len)) raiseIndexError();
		if ((NU)(i_144473) >= (NU)(c->Sup.len)) raiseIndexError();
		LOC2 = 0;
		LOC2 = a->data[(NI32)(TMP948)]; a->data[(NI32)(TMP948)] = copyStringRC1(c->data[i_144473]);
...
N_NIMCALL(NCSTRING*, tocstringarray_145626)(NimStringDesc** b, NI bLen0, NimStringDesc** a, NI aLen0) {
	...
	TMP965 = addInt((NI32)(TMP964), 1);
	TMP966 = mulInt((NI32)(TMP965), 4);
	LOC1 = 0;
	LOC1 = alloc0_4004((NI32)(TMP966));
	...
	while (1) {
		...
		TMP967 = addInt(b[i_145654]->Sup.len, 1);
		LOC3 = 0;
		LOC3 = alloc_4001((NI32)(TMP967));
		...
		nimln(574, "osproc.nim");
		if ((NU)(i_145654) >= (NU)(bLen0)) raiseIndexError();
		TMP968 = addInt(b[i_145654]->Sup.len, 1);
		memcpy(((void*) (result[(i_145654)- 0])), ((void*) (b[i_145654]->data)), (NI32)(TMP968));		nimln(1311, "system.nim");
	...
	while (1) {
		...
		nimln(576, "osproc.nim");
		nimln(576, "osproc.nim");
		TMP969 = addInt(i_145664, bLen0);
		if ((NU)((NI32)(TMP969)) > (NU)(50000)) raiseIndexError();
		nimln(576, "osproc.nim");
		nimln(576, "osproc.nim");
		nimln(576, "osproc.nim");
		if ((NU)(i_145664) >= (NU)(aLen0)) raiseIndexError();
		TMP970 = addInt(a[i_145664]->Sup.len, 1);
		LOC5 = 0;
		LOC5 = alloc_4001((NI32)(TMP970));
		result[((NI32)(TMP969))- 0] = ((NCSTRING) (LOC5));
		nimln(577, "osproc.nim");
		nimln(577, "osproc.nim");
		nimln(577, "osproc.nim");
		TMP971 = addInt(i_145664, bLen0);
		if ((NU)((NI32)(TMP971)) > (NU)(50000)) raiseIndexError();
		if ((NU)(i_145664) >= (NU)(aLen0)) raiseIndexError();
		nimln(577, "osproc.nim");
		nimln(577, "osproc.nim");
		if ((NU)(i_145664) >= (NU)(aLen0)) raiseIndexError();
		TMP972 = addInt(a[i_145664]->Sup.len, 1);
		memcpy(((void*) (result[((NI32)(TMP971))- 0])), ((void*) (a[i_145664]->data)), (NI32)(TMP972));		nimln(1311, "system.nim");
...
N_NIMCALL(NCSTRING*, tocstringarray_145692)(tstringtable111610* t) {
	...
	TMP974 = mulInt((NI32)(TMP973), 4);
	LOC2 = 0;
	LOC2 = alloc0_4004((NI32)(TMP974));
...
appendString(LOC8, val_145699);
			...
			memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI32)(TMP977));			nimln(586, "osproc.nim");
			i = addInt(i, 1);
		}		LA6: ;
		nimln(1311, "system.nim");
...
N_NIMCALL(NCSTRING*, envtocstringarray_145723)(void) {
	...
	val_145728 = 0;
	nimln(1148, "os.nim");
	getenvvarsc_103202();	i_145756 = 0;
	HEX3Atmp_145758 = 0;
	nimln(1149, "os.nim");
	nimln(1149, "os.nim");
	HEX3Atmp_145758 = (environment_103029->Sup.len-1);
	nimln(1308, "system.nim");
	res_145760 = 0;
	nimln(1309, "system.nim");
	while (1) {
		...
		i_145756 = res_145760;
		nimln(1150, "os.nim");
		if ((NU)(i_145756) >= (NU)(environment_103029->Sup.len)) raiseIndexError();
		p_145762 = nsuFindChar(environment_103029->data[i_145756], 61, 0);
		nimln(1151, "os.nim");
		nimln(1151, "os.nim");
		if ((NU)(i_145756) >= (NU)(environment_103029->Sup.len)) raiseIndexError();
		nimln(1151, "os.nim");
		TMP978 = subInt(p_145762, 1);
		key_145727 = copyStrLast(environment_103029->data[i_145756], 0, (NI32)(TMP978));
		nimln(1152, "os.nim");
		nimln(1152, "os.nim");
		if ((NU)(i_145756) >= (NU)(environment_103029->Sup.len)) raiseIndexError();
		nimln(1152, "os.nim");
		TMP979 = addInt(p_145762, 1);
		val_145728 = copyStr(environment_103029->data[i_145756], (NI32)(TMP979));
	...
	TMP981 = mulInt((NI32)(TMP980), 4);
	LOC2 = 0;
	LOC2 = alloc0_4004((NI32)(TMP981));
	result = ((NCSTRING*) (LOC2));
	...
	val_145742 = 0;
	nimln(1148, "os.nim");
	getenvvarsc_103202();	i_145772 = 0;
	HEX3Atmp_145774 = 0;
	nimln(1149, "os.nim");
	nimln(1149, "os.nim");
	HEX3Atmp_145774 = (environment_103029->Sup.len-1);
	nimln(1308, "system.nim");
	res_145776 = 0;
	nimln(1309, "system.nim");
	while (1) {
		...
		i_145772 = res_145776;
		nimln(1150, "os.nim");
		if ((NU)(i_145772) >= (NU)(environment_103029->Sup.len)) raiseIndexError();
		p_145778 = nsuFindChar(environment_103029->data[i_145772], 61, 0);
		nimln(1151, "os.nim");
		nimln(1151, "os.nim");
		if ((NU)(i_145772) >= (NU)(environment_103029->Sup.len)) raiseIndexError();
		nimln(1151, "os.nim");
		TMP982 = subInt(p_145778, 1);
		key_145741 = copyStrLast(environment_103029->data[i_145772], 0, (NI32)(TMP982));
		nimln(1152, "os.nim");
		nimln(1152, "os.nim");
		if ((NU)(i_145772) >= (NU)(environment_103029->Sup.len)) raiseIndexError();
		nimln(1152, "os.nim");
		TMP983 = addInt(p_145778, 1);
		val_145742 = copyStr(environment_103029->data[i_145772], (NI32)(TMP983));
...
appendString(LOC4, val_145742);
		...
		memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI32)(TMP985));		nimln(597, "osproc.nim");
		i = addInt(i, 1);
		nimln(1311, "system.nim");
...
appendString(LOC67, LOC69);
		...
		LA76: ;
		{
			...
			a = tocstringarray_145626(TMP987, 2, LOC88, 1);
...
N_NIMCALL(void, pruneprocessset_146395)(TY145202** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(803, "osproc.nim");
		{
			...
			nimln(804, "osproc.nim");
			TMP993 = subInt(l, 1);
			if ((NU)((NI32)(TMP993)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRefNoCycle((void**) &(*s)->data[i], (*s)->data[(NI32)(TMP993)]);
...
N_NIMCALL(NI, select_145502)(TY145202** readfds, NI timeout) {
	...
	createfdset_146340(&rd, (*readfds), &m);	nimln(819, "osproc.nim");
	{
		...
		TMP995 = addInt(m, 1);
		LOC5 = 0;
		LOC5 = select(((int) ((NI32)(TMP995))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}	goto LA1;
	LA3: ;
	{
		...
		TMP996 = addInt(m, 1);
		LOC7 = 0;
		LOC7 = select(((int) ((NI32)(TMP996))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}	LA1: ;
...
TMP950[0] = &TMP921[1];
TMP921[1].kind = 1;
TMP921[1].offset = offsetof(tprocess144203, Inhandle);
TMP921[1].typ = (&NTI9008);
TMP921[1].name = "inHandle";
TMP950[1] = &TMP921[2];
TMP921[2].kind = 1;
TMP921[2].offset = offsetof(tprocess144203, Outhandle);
TMP921[2].typ = (&NTI9008);
TMP921[2].name = "outHandle";
TMP950[2] = &TMP921[3];
TMP921[3].kind = 1;
TMP921[3].offset = offsetof(tprocess144203, Errhandle);
TMP921[3].typ = (&NTI9008);
TMP921[3].name = "errHandle";
TMP950[3] = &TMP921[4];
TMP921[4].kind = 1;
TMP921[4].offset = offsetof(tprocess144203, Instream);
TMP921[4].typ = (&NTI142627);
TMP921[4].name = "inStream";
TMP950[4] = &TMP921[5];
TMP921[5].kind = 1;
TMP921[5].offset = offsetof(tprocess144203, Outstream);
TMP921[5].typ = (&NTI142627);
TMP921[5].name = "outStream";
TMP950[5] = &TMP921[6];
TMP921[6].kind = 1;
TMP921[6].offset = offsetof(tprocess144203, Errstream);
TMP921[6].typ = (&NTI142627);
TMP921[6].name = "errStream";
TMP950[6] = &TMP921[7];
TMP921[7].kind = 1;
TMP921[7].offset = offsetof(tprocess144203, Id);
TMP921[7].typ = (&NTI91457);
TMP921[7].name = "id";
TMP950[7] = &TMP921[8];
TMP921[8].kind = 1;
TMP921[8].offset = offsetof(tprocess144203, Exitcode);
TMP921[8].typ = (&NTI3809);
TMP921[8].name = "exitCode";
TMP921[0].len = 8; TMP921[0].kind = 2; TMP921[0].sons = &TMP950[0];
NTI144203.node = &TMP921[0];
NTI144205.size = sizeof(tprocess144203*);
NTI144205.kind = 22;
NTI144205.base = (&NTI144203);
NTI144205.flags = 2;
NTI144205.marker = TMP952;
NTI145202.size = sizeof(TY145202*);
NTI145202.kind = 24;
NTI145202.base = (&NTI144205);
NTI145202.flags = 2;
NTI145202.marker = TMP953;
}
