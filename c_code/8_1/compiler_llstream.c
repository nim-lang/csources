...
N_NIMCALL(NIM_BOOL, endswith_161402)(NimStringDesc* x, TY112118 s);
...
NIM_CONST TY112118 linecontinuationoprs_161432 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
NIM_CONST TY112118 additionallinecontinuationoprs_161434 = {
...
N_NIMCALL(NIM_BOOL, endswithopr_161437)(NimStringDesc* x) {
	...
	result = endswith_161402(x, TMP1610);
	popFrame();
	return result;
}
static N_INLINE(NIM_BOOL, continueline_161443)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_161402(line, TMP1611);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(void, llstreamwriteln_161274)(tllstream161204* s, NimStringDesc* data) {
	...
	llstreamwrite_161258(s, ((NimStringDesc*) &TMP1616));	popFrame();
}
N_NIMCALL(void, llstreamwrite_161263)(tllstream161204* s, NIM_CHAR data) {
	NIM_CHAR c;
	nimfr("LLStreamWrite", "llstream.nim")
...
NTI161202.node = &TMP1601[6];
TMP1601[1].kind = 1;
TMP1601[1].offset = offsetof(tllstream161204, Kind);
TMP1601[1].typ = (&NTI161202);
TMP1601[1].name = "kind";
TMP1603[1] = &TMP1601[7];
TMP1601[7].kind = 1;
TMP1601[7].offset = offsetof(tllstream161204, F);
TMP1601[7].typ = (&NTI9004);
TMP1601[7].name = "f";
TMP1603[2] = &TMP1601[8];
TMP1601[8].kind = 1;
TMP1601[8].offset = offsetof(tllstream161204, S);
TMP1601[8].typ = (&NTI142);
TMP1601[8].name = "s";
TMP1603[3] = &TMP1601[9];
TMP1601[9].kind = 1;
TMP1601[9].offset = offsetof(tllstream161204, Rd);
TMP1601[9].typ = (&NTI105);
TMP1601[9].name = "rd";
TMP1603[4] = &TMP1601[10];
TMP1601[10].kind = 1;
TMP1601[10].offset = offsetof(tllstream161204, Wr);
TMP1601[10].typ = (&NTI105);
TMP1601[10].name = "wr";
TMP1603[5] = &TMP1601[11];
TMP1601[11].kind = 1;
TMP1601[11].offset = offsetof(tllstream161204, Lineoffset);
TMP1601[11].typ = (&NTI105);
TMP1601[11].name = "lineOffset";
TMP1601[0].len = 6; TMP1601[0].kind = 2; TMP1601[0].sons = &TMP1603[0];
NTI161204.node = &TMP1601[0];
NTI161206.size = sizeof(tllstream161204*);
NTI161206.kind = 22;
NTI161206.base = (&NTI161204);
NTI161206.flags = 2;
NTI161206.marker = TMP1607;
}
