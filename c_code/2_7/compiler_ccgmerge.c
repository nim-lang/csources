...
STRING_LITERAL(TMP4072, "NIM_merge_INFO", 14);
STRING_LITERAL(TMP4073, "typeCache", 9);
STRING_LITERAL(TMP4074, "declared", 8);
STRING_LITERAL(TMP4075, "typeInfo", 8);
STRING_LITERAL(TMP4076, "labels", 6);
STRING_LITERAL(TMP4077, "hasframe", 8);
STRING_LITERAL(TMP4078, "ccgmerge: \'{\' expected", 22);
STRING_LITERAL(TMP4079, "ccgmerge: unkown key: ", 22);
STRING_LITERAL(TMP4148, "ccgmerge: expected: /*\011NIM_merge_END:*/", 39);
STRING_LITERAL(TMP4149, "/*\011NIM_merge_END:*/", 19);
STRING_LITERAL(TMP4150, "", 0);
STRING_LITERAL(TMP4151, "NIM_merge_HEADERS", 17);
STRING_LITERAL(TMP4152, "NIM_merge_FORWARD_TYPES", 23);
STRING_LITERAL(TMP4153, "NIM_merge_TYPES", 15);
STRING_LITERAL(TMP4154, "NIM_merge_SEQ_TYPES", 19);
STRING_LITERAL(TMP4155, "NIM_merge_FIELD_INFO", 20);
STRING_LITERAL(TMP4156, "NIM_merge_TYPE_INFO", 19);
STRING_LITERAL(TMP4157, "NIM_merge_PROC_HEADERS", 22);
STRING_LITERAL(TMP4158, "NIM_merge_DATA", 14);
STRING_LITERAL(TMP4159, "NIM_merge_VARS", 14);
STRING_LITERAL(TMP4160, "NIM_merge_PROCS", 15);
STRING_LITERAL(TMP4161, "NIM_merge_INIT_PROC", 19);
STRING_LITERAL(TMP4162, "NIM_merge_TYPE_INIT1", 20);
STRING_LITERAL(TMP4163, "NIM_merge_TYPE_INIT2", 20);
STRING_LITERAL(TMP4164, "NIM_merge_TYPE_INIT3", 20);
STRING_LITERAL(TMP4165, "NIM_merge_DEBUG_INIT", 20);
STRING_LITERAL(TMP4166, "NIM_merge_DYNLIB_INIT", 21);
STRING_LITERAL(TMP4167, "NIM_merge_DYNLIB_DEINIT", 23);
NIM_CONST TY487013 cfilesectionnames_487012 = {((NimStringDesc*) &TMP4150),
...
;
STRING_LITERAL(TMP4168, "NIM_merge_PROC_LOCALS", 21);
STRING_LITERAL(TMP4169, "NIM_merge_PROC_INIT", 19);
STRING_LITERAL(TMP4170, "NIM_merge_PROC_BODY", 19);
NIM_CONST TY487019 cprocsectionnames_487018 = {((NimStringDesc*) &TMP4168),
((NimStringDesc*) &TMP4169),
((NimStringDesc*) &TMP4170)}
;
STRING_LITERAL(TMP4171, "ccgmerge: unknown section: ", 27);
STRING_LITERAL(TMP4172, "ccgmerge: \'*/\' expected", 23);
STRING_LITERAL(TMP4176, "/*\011", 3);
STRING_LITERAL(TMP4177, ":*/", 3);
STRING_LITERAL(TMP4185, "/*\011NIM_merge_INFO:", 18);
STRING_LITERAL(TMP4186, "typeCache:{", 11);
STRING_LITERAL(TMP4187, "declared:{", 10);
STRING_LITERAL(TMP4188, "typeInfo:{", 10);
STRING_LITERAL(TMP4189, "labels:", 7);
STRING_LITERAL(TMP4190, " hasframe:", 10);
...
N_NIMCALL(void, readkey_487535)(tbaselexer198024* l, NimStringDesc** result) {
	...
	}
	{
		...
		internalerror_184688(((NimStringDesc*) &TMP4071));
	}
	LA5: ;
	(*l).Bufpos = (NI32)(pos + 1);
}
...
N_NIMCALL(void, readtypecache_487607)(tbaselexer198024* l, tidtable210866* result) {
	{
		...
		internalerror_184688(((NimStringDesc*) &TMP4078));
	}
	LA3: ;
	(*l).Bufpos += 1;
	{
...
N_NIMCALL(void, processmergeinfo_487711)(tbaselexer198024* l, tcgen486035* m) {
	...
	k = rawNewString(9);
	{
		while (1) {
			...
			LA7: ;
			readkey_487535(l, (&k));
			if (eqStrings(k, ((NimStringDesc*) &TMP4073))) goto LA9;
			if (eqStrings(k, ((NimStringDesc*) &TMP4074))) goto LA10;
			if (eqStrings(k, ((NimStringDesc*) &TMP4075))) goto LA11;
			if (eqStrings(k, ((NimStringDesc*) &TMP4076))) goto LA12;
			if (eqStrings(k, ((NimStringDesc*) &TMP4077))) goto LA13;
			goto LA14;
			LA9: ;
			{
...
appendString(LOC24, ((NimStringDesc*) &TMP4079));
...
N_NIMCALL(NIM_BOOL, atendmark_487456)(NCSTRING buf, NI pos) {
	...
	s = 0;
	{
		while (1) {
			...
			LOC3 = (s < 19);
			if (!(LOC3)) goto LA4;
			LOC3 = ((NU8)(buf[(NI32)(pos + s)]) == (NU8)(((NimStringDesc*) &TMP4149)->data[s]));
			LA4: ;
			if (!LOC3) goto LA2;
			s += 1;
		} LA2: ;
...
appendString(r, tnl_176629);
			...
			case 0:
			{
				internalerror_184688(((NimStringDesc*) &TMP4148));
				goto LA1;
			}
			break;
			default:
...
appendString(LOC34, ((NimStringDesc*) &TMP4171));
appendString(LOC34, k);
			...
			LA18: ;
			{
				internalerror_184688(((NimStringDesc*) &TMP4172));
			}
			LA11: ;
		}
	} LA5: ;
...
N_NIMCALL(trope179009*, gensectionstart_487126)(NU8 ps) {
	...
	result = 0;
	{
		...
		app_179060(&result, ((NimStringDesc*) &TMP4176));
		app_179060(&result, cprocsectionnames_487018[(ps)- 0]);
		app_179060(&result, ((NimStringDesc*) &TMP4177));
...
appendString(LOC5, ((NimStringDesc*) &TMP4149));
...
{	result = 0;
	...
	LA3: ;
	s = copyString(((NimStringDesc*) &TMP4185));
	s = resizeString(s, tnl_176629->Sup.len + 0);
appendString(s, tnl_176629);
	s = resizeString(s, 11);
...
appendString(s, tnl_176629);
	s = resizeString(s, 2);
appendString(s, ((NimStringDesc*) &TMP4191));
