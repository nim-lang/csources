	...
	p = ((NI8*) (buf));
	{
		while (1) {
			...
			readbytes = readbuffer_13515(bin, buf, ((NI) 8000));
			{
				...
				i_177649 = 0;
				HEX3Atmp_177654 = 0;
				HEX3Atmp_177654 = (NI32)(readbytes - ((NI) 1));
				res_177657 = ((NI) 0);
				{
					while (1) {
						if (!(res_177657 <= HEX3Atmp_177654)) goto LA10;
						i_177649 = res_177657;
						result = updatecrc32_177019(p[(i_177649)- 0], result);
						res_177657 += ((NI) 1);
					} LA10: ;
				}
			}
...
N_NIMCALL(NI32, HEX3EHEX3C_177535)(NI32 c, NimStringDesc* s) {
	...
	result = c;
	{
		...
		i_177550 = 0;
		HEX3Atmp_177552 = 0;
		HEX3Atmp_177552 = (NI32)(s->Sup.len - ((NI) 1));
		res_177555 = ((NI) 0);
		{
			while (1) {
				if (!(res_177555 <= HEX3Atmp_177552)) goto LA3;
				i_177550 = res_177555;
				result = updatecrc32_177026(s->data[i_177550], result);
				res_177555 += ((NI) 1);
			} LA3: ;
		}
	}
