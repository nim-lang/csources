		...
		res_240636 = ((NI) 0);
		{
			while (1) {
				...
				i_240608 = res_240636;
				{
					...
					LOC9 = 0;
					LOC9 = getordvalue_221178((*(*s).kindU.S6.sons->data[i_240608]).kindU.S6.sons->data[((NI) 1)]);
					LOC10 = 0;
					LOC10 = getordvalue_221178((*(*s).kindU.S6.sons->data[i_240608]).kindU.S6.sons->data[((NI) 0)]);
