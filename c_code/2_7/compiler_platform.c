...
;
STRING_LITERAL(TM_LEa0rTUoGHqcCT74IoUuTg_78, "linux", 5);
static N_NIMCALL(void, TM_LEa0rTUoGHqcCT74IoUuTg_2)(void) {
...
nimRegisterGlobalMarker(TM_LEa0rTUoGHqcCT74IoUuTg_2);
	hostCPU_NC5ykU0V2OtuVwnPAFnkrg = nameToCPU_JQ5BAe9a4dm5IfbYpemguNA(((NimStringDesc*) &TM_LEa0rTUoGHqcCT74IoUuTg_14));
