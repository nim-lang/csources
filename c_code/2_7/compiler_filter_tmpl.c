...
static NIM_CONST TY178407 TMP1415 = {
...
N_NIMCALL(void, parseline_218149)(Ttmplparser218020* p) {
	...
	LA7: ;
	{
		...
		case ((NU16) 22):
		{
			...
			{
				(*p).info.col = ((NI16) (j));
				localerror_165171((*p).info, ((NU16) 163), ((NimStringDesc*) &TMP1413));
			}
			LA20: ;
			LOC25 = 0;
		...
		case ((NU16) 62):
		{
			...
			llstreamwrite_178665((*p).outp, LOC34);
			{
				NIM_BOOL LOC37;
				LOC37 = 0;
				LOC37 = contains_98373((*p).x, TMP1415);
				if (!!(LOC37)) goto LA38;
				(*p).indent += ((NI) 2);
			}
			LA38: ;
	...
	LA10: ;
	{
		...
		(*p).state = ((NU8) 1);
		{
			while (1) {
				...
				case 34:
				{
					llstreamwrite_178665((*p).outp, ((NimStringDesc*) &TMP1421));
					j += ((NI) 1);
				}
				break;
				default:
				{
					{
						...
						case 123:
						{
							...
							curly = ((NI) 0);
							{
								while (1) {
									...
									case 0:
									{
										localerror_165171((*p).info, ((NU16) 188), ((NimStringDesc*) &TMP1422));
										goto LA62;
									}
									break;
									case 123:
						...
						default:
						{
							...
							{
								(*p).info.col = ((NI16) (j));
								localerror_165171((*p).info, ((NU16) 167), ((NimStringDesc*) &TMP1410));
							}
							LA80: ;
						}
						break;
		...
		llstreamwrite_178665((*p).outp, ((NimStringDesc*) &TMP1423));
	}
	LA3: ;
}
...
N_NIMCALL(Tllstream178204*, filtertmpl_218009)(Tllstream178204* stdin_218011, NimStringDesc* filename, Tnode191813* call) {
	...
	p.outp = llstreamopen_178220(((NimStringDesc*) &TMP1402));
	p.inp = stdin_218011;
	p.subschar = chararg_217020(call, ((NimStringDesc*) &TMP1403), ((NI) 1), 36);
	p.nimdirective = chararg_217020(call, ((NimStringDesc*) &TMP1404), ((NI) 2), 35);
	p.emit = strarg_217029(call, ((NimStringDesc*) &TMP1405), ((NI) 3), ((NimStringDesc*) &TMP1406));
	p.conc = strarg_217029(call, ((NimStringDesc*) &TMP1407), ((NI) 4), ((NimStringDesc*) &TMP1408));
	p.tostr = strarg_217029(call, ((NimStringDesc*) &TMP1409), ((NI) 5), ((NimStringDesc*) &TMP1410));
