...
static TNimNode* TMP832[3];
static TNimNode TMP816[4];
...
TMP832[2] = &TMP816[3];
TMP816[3].kind = 1;
TMP816[3].offset = offsetof(memfile254208, Handle);
TMP816[3].typ = (&NTI5811);
TMP816[3].name = "handle";
TMP816[0].len = 3; TMP816[0].kind = 2; TMP816[0].sons = &TMP832[0];
