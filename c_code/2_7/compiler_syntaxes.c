...
NIM_CONST TY219026 filternames_219025 = {((NimStringDesc*) &TMP1394),
...
NIM_CONST TY219020 parsernames_219019 = {((NimStringDesc*) &TMP1398),
...
{	result = 0;
	...
	LA3: ;
	{
		...
		LOC7 = LOC8;
		if (!(LOC7)) goto LA10;
		LOC7 = identeq_167484((*(*n).kindU.S6.sons->data[((NI) 0)]).kindU.S5.ident, ((NimStringDesc*) &TMP1284));
		LA10: ;
		if (!LOC7) goto LA11;
		{
			NI i_219778;
...
N_NIMCALL(Tnode191813*, parseall_219063)(Tparsers219035* p) {
	...
	case ((NU8) 3):
	{
		internalerror_165234(((NimStringDesc*) &TMP1432));
		result = emptynode_192807;
	}
	break;
	}
...
NTI219007.node = &TMP799[6];
TMP799[1].kind = 1;
TMP799[1].offset = offsetof(Tparsers219035, skin);
TMP799[1].typ = (&NTI219007);
TMP799[1].name = "skin";
TMP1088[1] = &TMP799[7];
TMP799[7].kind = 1;
TMP799[7].offset = offsetof(Tparsers219035, parser);
TMP799[7].typ = (&NTI207205);
TMP799[7].name = "parser";
TMP799[0].len = 2; TMP799[0].kind = 2; TMP799[0].sons = &TMP1088[0];
NTI219035.node = &TMP799[0];
}
