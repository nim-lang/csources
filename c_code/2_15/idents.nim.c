...
typedef NU16 tyEnum_TSpecialWord_HREcCSXql5vNjdyc0yvpoQ;
...
N_LIB_PRIVATE N_NIMCALL(NI, cmpExact_Jbw1CiaNJLYIkwEiKlU3qg)(NCSTRING a, NCSTRING b, NI blen);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TIdent_GufRQq9c0miSybX3zBD4tyA*, getIdent_FXltLmSJ6smaT7i9cc3lKRw)(tyObject_IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw* ic, NimStringDesc* identifier, NI h);
...
STRING_LITERAL(TM_L3r6bVdeFMiI9cwmLpWIeKw_14, "/Users/andreasrumpf-mac/projects/nim/compiler/idents.nim(83, 13"
") `(id == 0) or (id == result.id)` ", 98);
STRING_LITERAL(TM_L3r6bVdeFMiI9cwmLpWIeKw_17, ":anonymous", 10);
STRING_LITERAL(TM_L3r6bVdeFMiI9cwmLpWIeKw_18, ":delegator", 10);
...
N_LIB_PRIVATE N_NIMCALL(NI, cmpExact_Jbw1CiaNJLYIkwEiKlU3qg)(NCSTRING a, NCSTRING b, NI blen) {
	...
	result = ((NI) 1);
	{
		while (1) {
			NIM_CHAR aa;
			NIM_CHAR bb;
			NI TM_L3r6bVdeFMiI9cwmLpWIeKw_4;
			NI TM_L3r6bVdeFMiI9cwmLpWIeKw_5;
			NI TM_L3r6bVdeFMiI9cwmLpWIeKw_6;
			if (!(j < blen)) goto LA2;
			aa = a[i];
			bb = b[j];
			TM_L3r6bVdeFMiI9cwmLpWIeKw_4 = subInt(((NU8)(aa)), ((NU8)(bb)));
			result = (NI)(TM_L3r6bVdeFMiI9cwmLpWIeKw_4);
			{
				NIM_BOOL T5_;
				T5_ = (NIM_BOOL)0;
				T5_ = !((result == ((NI) 0)));
			...
			LA7_: ;
			TM_L3r6bVdeFMiI9cwmLpWIeKw_5 = addInt(i, ((NI) 1));
			i = (NI)(TM_L3r6bVdeFMiI9cwmLpWIeKw_5);
			TM_L3r6bVdeFMiI9cwmLpWIeKw_6 = addInt(j, ((NI) 1));
			j = (NI)(TM_L3r6bVdeFMiI9cwmLpWIeKw_6);
		} LA2: ;
	} LA1: ;
	{
...
{	result = (NI)0;
	...
	result = ((NI) 1);
	{
		while (1) {
			NIM_CHAR aa;
			NIM_CHAR bb;
			NI TM_L3r6bVdeFMiI9cwmLpWIeKw_11;
			NI TM_L3r6bVdeFMiI9cwmLpWIeKw_12;
			NI TM_L3r6bVdeFMiI9cwmLpWIeKw_13;
			if (!(j < blen)) goto LA6;
			{
				while (1) {
					NI TM_L3r6bVdeFMiI9cwmLpWIeKw_7;
					if (!((NU8)(a[i]) == (NU8)(95))) goto LA8;
					TM_L3r6bVdeFMiI9cwmLpWIeKw_7 = addInt(i, ((NI) 1));
					i = (NI)(TM_L3r6bVdeFMiI9cwmLpWIeKw_7);
				} LA8: ;
			}
			{
				while (1) {
					NI TM_L3r6bVdeFMiI9cwmLpWIeKw_8;
					if (!((NU8)(b[j]) == (NU8)(95))) goto LA10;
					TM_L3r6bVdeFMiI9cwmLpWIeKw_8 = addInt(j, ((NI) 1));
					j = (NI)(TM_L3r6bVdeFMiI9cwmLpWIeKw_8);
				} LA10: ;
			}
			aa = a[i];
			bb = b[j];
			{
				NIM_BOOL T13_;
				NI TM_L3r6bVdeFMiI9cwmLpWIeKw_9;
				T13_ = (NIM_BOOL)0;
				T13_ = ((NU8)(65) <= (NU8)(aa));
				if (!(T13_)) goto LA14_;
				T13_ = ((NU8)(aa) <= (NU8)(90));
				LA14_: ;
				if (!T13_) goto LA15_;
				TM_L3r6bVdeFMiI9cwmLpWIeKw_9 = addInt(((NU8)(aa)), ((NI) 32));
				aa = ((NIM_CHAR) (((NI)chckRange((NI)(TM_L3r6bVdeFMiI9cwmLpWIeKw_9), ((NI) 0), ((NI) 255)))));
			}
			LA15_: ;
			{
				NIM_BOOL T19_;
				NI TM_L3r6bVdeFMiI9cwmLpWIeKw_10;
				T19_ = (NIM_BOOL)0;
				T19_ = ((NU8)(65) <= (NU8)(bb));
				if (!(T19_)) goto LA20_;
				T19_ = ((NU8)(bb) <= (NU8)(90));
				LA20_: ;
				if (!T19_) goto LA21_;
				TM_L3r6bVdeFMiI9cwmLpWIeKw_10 = addInt(((NU8)(bb)), ((NI) 32));
				bb = ((NIM_CHAR) (((NI)chckRange((NI)(TM_L3r6bVdeFMiI9cwmLpWIeKw_10), ((NI) 0), ((NI) 255)))));
			}
			LA21_: ;
			TM_L3r6bVdeFMiI9cwmLpWIeKw_11 = subInt(((NU8)(aa)), ((NU8)(bb)));
			result = (NI)(TM_L3r6bVdeFMiI9cwmLpWIeKw_11);
			{
				NIM_BOOL T25_;
				T25_ = (NIM_BOOL)0;
				T25_ = !((result == ((NI) 0)));
			...
			LA27_: ;
			TM_L3r6bVdeFMiI9cwmLpWIeKw_12 = addInt(i, ((NI) 1));
			i = (NI)(TM_L3r6bVdeFMiI9cwmLpWIeKw_12);
			TM_L3r6bVdeFMiI9cwmLpWIeKw_13 = addInt(j, ((NI) 1));
			j = (NI)(TM_L3r6bVdeFMiI9cwmLpWIeKw_13);
		} LA6: ;
	} LA5: ;
	{
...
{	result = (tyObject_TIdent_GufRQq9c0miSybX3zBD4tyA*)0;
	idx = (NI)(h & ((NI) 8191));
	if ((NU)(idx) > (NU)(8191)) raiseIndexError2(idx, 8191);
	...
	id = ((NI) 0);
	{
		while (1) {
			if (!!((result == NIM_NIL))) goto LA2;
			{
				NI T5_;
				T5_ = (NI)0;
				T5_ = cmpExact_Jbw1CiaNJLYIkwEiKlU3qg(nimToCStringConv((*result).s), identifier, length);
			...
			LA6_: ;
			{
				NI T13_;
				T13_ = (NI)0;
				T13_ = cmpIgnoreStyle_Jbw1CiaNJLYIkwEiKlU3qg_2(nimToCStringConv((*result).s), identifier, length);
				if (!(T13_ == ((NI) 0))) goto LA14_;
				{
					...
					T18_ = (id == ((NI) 0));
					if (T18_) goto LA19_;
					T18_ = (id == (*result).Sup.id);
					LA19_: ;
					if (!!(T18_)) goto LA20_;
					failedAssertImpl_W9cjVocn1tjhW7p7xohJj6A(((NimStringDesc*) &TM_L3r6bVdeFMiI9cwmLpWIeKw_14));
				}
				LA20_: ;
				id = (*result).Sup.id;
			}
	...
	(*result).h = h;
	asgnRef((void**) (&(*result).s), mnewString(((NI)chckRange(length, ((NI) 0), ((NI) IL64(9223372036854775807))))));
	{
		NI i;
		NI i_2;
		i = (NI)0;
		...
		{
			while (1) {
				NI TM_L3r6bVdeFMiI9cwmLpWIeKw_15;
				if (!(i_2 < length)) goto LA24;
				i = i_2;
				if ((NU)(i) >= (NU)((*result).s ? (*result).s->Sup.len : 0)) raiseIndexError2(i,((*result).s ? (*result).s->Sup.len : 0)-1);
				(*result).s->data[i] = identifier[i];
				TM_L3r6bVdeFMiI9cwmLpWIeKw_15 = addInt(i_2, ((NI) 1));
				i_2 = (NI)(TM_L3r6bVdeFMiI9cwmLpWIeKw_15);
			} LA24: ;
		}
	}
	if ((NU)(idx) > (NU)(8191)) raiseIndexError2(idx, 8191);
	...
	asgnRef((void**) (&(*ic).buckets[(idx)- 0]), result);
	{
		NI TM_L3r6bVdeFMiI9cwmLpWIeKw_16;
		if (!(id == ((NI) 0))) goto LA27_;
		TM_L3r6bVdeFMiI9cwmLpWIeKw_16 = addInt((*ic).wordCounter, ((NI) 1));
		(*ic).wordCounter = (NI)(TM_L3r6bVdeFMiI9cwmLpWIeKw_16);
		if ((*ic).wordCounter == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TIdent_GufRQq9c0miSybX3zBD4tyA*, getIdent_9coBOmdXN09be4rJvXK6fQGQ)(tyObject_IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw* ic, NimStringDesc* identifier) {
	...
	result = (tyObject_TIdent_GufRQq9c0miSybX3zBD4tyA*)0;
	T1_ = (NI)0;
	T1_ = hashIgnoreStyle_6PCYkKlCNhq9cnRLnqWKkwQ_3(identifier);
	result = getIdent_jPDJlJukeiI0s9cOWXczqWg(ic, nimToCStringConv(identifier), (identifier ? identifier->Sup.len : 0), T1_);
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(tyEnum_TSpecialWord_ycbpMCRV6Cd2eBh3X9biEiw, whichKeyword_sZUQNPhNGEM8MllfcWvRiw)(tyObject_TIdent_GufRQq9c0miSybX3zBD4tyA* id) {
	...
	LA3_: ;
	{
		result = ((tyEnum_TSpecialWord_ycbpMCRV6Cd2eBh3X9biEiw)chckRange((*id).Sup.id, ((tyEnum_TSpecialWord_ycbpMCRV6Cd2eBh3X9biEiw) 0), ((tyEnum_TSpecialWord_ycbpMCRV6Cd2eBh3X9biEiw) 274)));
	}
	LA1_: ;
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TIdent_GufRQq9c0miSybX3zBD4tyA*, getIdent_FXltLmSJ6smaT7i9cc3lKRw)(tyObject_IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw* ic, NimStringDesc* identifier, NI h) {
	tyObject_TIdent_GufRQq9c0miSybX3zBD4tyA* result;
	result = (tyObject_TIdent_GufRQq9c0miSybX3zBD4tyA*)0;
	result = getIdent_jPDJlJukeiI0s9cOWXczqWg(ic, nimToCStringConv(identifier), (identifier ? identifier->Sup.len : 0), h);
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(tyObject_IdentCachecolonObjectType__TzLHS09bRH9a0TYLs39cqcNaw*, newIdentCache_C9aDMlmEchTc9anNE0BtBTYg)(void) {
	...
	result = T1_;
	asgnRef((void**) (&(*result).idAnon), getIdent_9coBOmdXN09be4rJvXK6fQGQ(result, ((NimStringDesc*) &TM_L3r6bVdeFMiI9cwmLpWIeKw_17)));
	(*result).wordCounter = ((NI) 1);
	asgnRef((void**) (&(*result).idDelegator), getIdent_9coBOmdXN09be4rJvXK6fQGQ(result, ((NimStringDesc*) &TM_L3r6bVdeFMiI9cwmLpWIeKw_18)));
	asgnRef((void**) (&(*result).emptyIdent), getIdent_9coBOmdXN09be4rJvXK6fQGQ(result, ((NimStringDesc*) NIM_NIL)));
	{
		tyEnum_TSpecialWord_HREcCSXql5vNjdyc0yvpoQ s;
		NI res;
		s = (tyEnum_TSpecialWord_HREcCSXql5vNjdyc0yvpoQ)0;
		res = ((NI) 1);
		{
			while (1) {
				NI T5_;
				tyObject_TIdent_GufRQq9c0miSybX3zBD4tyA* T6_;
				NI TM_L3r6bVdeFMiI9cwmLpWIeKw_19;
				if (!(res <= ((NI) 274))) goto LA4;
				s = ((tyEnum_TSpecialWord_HREcCSXql5vNjdyc0yvpoQ)chckRange(res, ((tyEnum_TSpecialWord_HREcCSXql5vNjdyc0yvpoQ) 0), ((tyEnum_TSpecialWord_HREcCSXql5vNjdyc0yvpoQ) 274)));
				T5_ = (NI)0;
				T5_ = hashIgnoreStyle_6PCYkKlCNhq9cnRLnqWKkwQ_3(specialWords_jS3I1dUcvbZAEuApBSUHng[(s)- 0]);
				T6_ = (tyObject_TIdent_GufRQq9c0miSybX3zBD4tyA*)0;
				T6_ = getIdent_FXltLmSJ6smaT7i9cc3lKRw(result, specialWords_jS3I1dUcvbZAEuApBSUHng[(s)- 0], T5_);
				(*T6_).Sup.id = s;
				TM_L3r6bVdeFMiI9cwmLpWIeKw_19 = addInt(res, ((NI) 1));
				res = (NI)(TM_L3r6bVdeFMiI9cwmLpWIeKw_19);
			} LA4: ;
		}
	}
	return result;
...
static TNimNode* TM_L3r6bVdeFMiI9cwmLpWIeKw_2_3[3];
static TNimNode* TM_L3r6bVdeFMiI9cwmLpWIeKw_3_5[5];
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_2_3[0] = &TM_L3r6bVdeFMiI9cwmLpWIeKw_0[2];
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_2_3[1] = &TM_L3r6bVdeFMiI9cwmLpWIeKw_0[3];
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_2_3[2] = &TM_L3r6bVdeFMiI9cwmLpWIeKw_0[4];
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_0[1].len = 3; TM_L3r6bVdeFMiI9cwmLpWIeKw_0[1].kind = 2; TM_L3r6bVdeFMiI9cwmLpWIeKw_0[1].sons = &TM_L3r6bVdeFMiI9cwmLpWIeKw_2_3[0];
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_3_5[0] = &TM_L3r6bVdeFMiI9cwmLpWIeKw_0[6];
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_3_5[1] = &TM_L3r6bVdeFMiI9cwmLpWIeKw_0[7];
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_3_5[2] = &TM_L3r6bVdeFMiI9cwmLpWIeKw_0[8];
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_3_5[3] = &TM_L3r6bVdeFMiI9cwmLpWIeKw_0[9];
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_3_5[4] = &TM_L3r6bVdeFMiI9cwmLpWIeKw_0[10];
...
TM_L3r6bVdeFMiI9cwmLpWIeKw_0[5].len = 5; TM_L3r6bVdeFMiI9cwmLpWIeKw_0[5].kind = 2; TM_L3r6bVdeFMiI9cwmLpWIeKw_0[5].sons = &TM_L3r6bVdeFMiI9cwmLpWIeKw_3_5[0];
