...
N_NIMCALL(tnode186813*, extractrange_221271)(NU8 k, tnode186813* n, NI a, NI b) {
	...
	nimln(167, "trees.nim");
	TMP2728 = subInt(b, a);
	TMP2729 = addInt((NI64)(TMP2728), 1);
	result = newnodei_188803(k, (*n).Info, (NI64)(TMP2729));
	i_221288 = 0;
	HEX3Atmp_221317 = 0;
	nimln(168, "trees.nim");
	nimln(168, "trees.nim");
	TMP2730 = subInt(b, a);
	HEX3Atmp_221317 = (NI64)(TMP2730);
	nimln(1457, "system.nim");
	res_221319 = 0;
	nimln(1458, "system.nim");
	while (1) {
		...
		if ((NU)((NI64)(TMP2731)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
		asgnRefNoCycle((void**) &(*result).kindU.S6.Sons->data[i_221288], (*n).kindU.S6.Sons->data[(NI64)(TMP2731)]);
		nimln(1460, "system.nim");
