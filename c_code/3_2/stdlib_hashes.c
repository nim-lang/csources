	...
	while (1) {
		...
		i_120874 = res_120929;
		{
			...
			nimln(104, "hashes.nim");
			{
				...
				nimln(105, "hashes.nim");
				nimln(105, "hashes.nim");
				TMP271 = addInt(((NI) (((NU8)(c)))), 32);
				c = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP271), 0, 255))));
			}
			LA9: ;
...
N_NIMCALL(NI, hashignorecase_120935)(NimStringDesc* x) {
	...
	while (1) {
		...
		nimln(114, "hashes.nim");
		{
			...
			c = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP273), 0, 255))));
		}
		LA4: ;
