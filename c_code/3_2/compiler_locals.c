...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*, semLocals_xRvvbI9bSWX9aGV1K2WmJX9bQ)(tyObject_TContext_5TfOJKwTttj3W1t1tMzWUQ* c, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n);
...
STRING_LITERAL(TM_tdBuY2ZF9bI7pxZ6PYkeTmw_2, "stdlib", 6);
STRING_LITERAL(TM_tdBuY2ZF9bI7pxZ6PYkeTmw_3, "system", 6);
STRING_LITERAL(TM_tdBuY2ZF9bI7pxZ6PYkeTmw_4, "locals", 6);
...
static N_INLINE(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*, newDeref_HtAG89bn1UDHEhRcS27NOXQlocals)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n) {
	...
	result = newNodeIT_lbGnVdZM6n2HPza7jVIlww(((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 65), (*n).info, (*(*n).typ).sons->data[((NI) 0)]);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*, semLocals_xRvvbI9bSWX9aGV1K2WmJX9bQ)(tyObject_TContext_5TfOJKwTttj3W1t1tMzWUQ* c, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* n) {
	tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* result;
	NI counter;
	tyObject_TType_LTUWCZolpovw9cWE3JBWSUw* tupleType;
	result = (tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*)0;
	counter = ((NI) 0);
	tupleType = newTypeS_9cQrDprXawJ1DKOUTsPNMTg(((tyEnum_TTypeKind_9a3YiReNVD0IJHWFKgXRe9ag) 18), c);
	result = newNodeIT_lbGnVdZM6n2HPza7jVIlww(((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 37), (*n).info, tupleType);
	asgnRefNoCycle((void**) (&(*tupleType).n), newNodeI_PIqgSH9b0m7nFpOyXf9cpz5w(((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 138), (*n).info));
	{
					...
					s = initTabIter_4ygtuv45J5xOJG1H4GUF9bA((&it_2), colontmp__2);
					{
						while (1) {
							...
							it = s;
							{
								...
								tyObject_TSym_AXG7xcvKqaxY6koRX1xkCw* T18_;
								...
								T15_ = skipTypes_pLCdCGDuirMe9cspwviV9aVA((*it).typ, 8390656);
								T13_ = !(((IL64(1153202979717775816) &((NU64)1<<((NU)((*T15_).kind)&63U)))!=0));
								LA14_: ;
								if (!T13_) goto LA16_;
								T18_ = (tyObject_TSym_AXG7xcvKqaxY6koRX1xkCw*)0;
								T18_ = getCurrOwner_VOSuHEX7JwrA8h7zpogoNQ(c);
								field = newSym_2uJTpCZGZAi7a4eAm1ds8Q(((tyEnum_TSymKind_cNCW9acsSznmEccl1fgQwkw) 19), (*it).name, T18_, (*n).info);
								asgnRefNoCycle((void**) (&(*field).typ), skipTypes_pLCdCGDuirMe9cspwviV9aVA((*it).typ, 8390656));
								(*field).position = counter;
								counter += ((NI) 1);
								T19_ = (tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw*)0;
								T19_ = newSymNode_1ARBpggFQuvUDBVYjBelcw(field);
								addSon_gCCf68XrWL79bKes6htzFjQ((*tupleType).n, T19_);
								addSonSkipIntLit_d0ho9bIGF3YeWTv0iA2z9awA(tupleType, (*field).typ);
								a = newSymNode_slQ2jWOFI1ND3N9c79b7b18g(it, (*result).info);
								{
									tyObject_TType_LTUWCZolpovw9cWE3JBWSUw* T22_;
									T22_ = (tyObject_TType_LTUWCZolpovw9cWE3JBWSUw*)0;
									T22_ = skipTypes_pLCdCGDuirMe9cspwviV9aVA((*it).typ, 2048);
...
NIM_EXTERNC N_NOINLINE(void, compiler_localsInit000)(void) {
	registerPlugin_h1PkaRVFQiAFyRVfvAMHBA(((NimStringDesc*) &TM_tdBuY2ZF9bI7pxZ6PYkeTmw_2), ((NimStringDesc*) &TM_tdBuY2ZF9bI7pxZ6PYkeTmw_3), ((NimStringDesc*) &TM_tdBuY2ZF9bI7pxZ6PYkeTmw_4), semLocals_xRvvbI9bSWX9aGV1K2WmJX9bQ);
}
