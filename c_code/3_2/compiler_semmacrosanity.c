	...
	{
		{
			...
			internalerror_165215((*n).info, ((NimStringDesc*) &TMP3281));
		}
		LA13: ;
		...
		LA17: ;
		{
			...
			res_402106 = ((NI) 1);
			{
				while (1) {
					...
					default:
					{
						internalerror_165215((*n).info, ((NimStringDesc*) &TMP3282));
					}
					break;
					}
					res_402106 += ((NI) 1);
...
appendString(LOC29, LOC30);
		...
		LA35: ;
		{
			globalerror_165161((*n).info, ((NimStringDesc*) &TMP3284));
		}
		LA2: ;
	}
	break;
	case ((NU8) 41):
	{
		...
		LA41: ;
		{
			globalerror_165161((*n).info, ((NimStringDesc*) &TMP3285));
		}
		LA39: ;
	}
	break;
	case ((NU8) 39):
	{
		...
		LA53: ;
		{
			globalerror_165161((*n).info, ((NimStringDesc*) &TMP3286));
		}
		LA51: ;
	}
	break;
