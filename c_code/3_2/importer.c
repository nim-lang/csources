...
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3271, "strVal", 6);
STRING_LITERAL(TMP3272, "", 0);
static NIM_CONST TY192025 TMP3273 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3274, "ident", 5);
static NIM_CONST TY192025 TMP3275 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3276, "sym", 3);
static NIM_CONST TY192025 TMP3277 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3278, "sons", 4);
STRING_LITERAL(TMP3279, "as", 2);
STRING_LITERAL(TMP3280, " ", 1);
STRING_LITERAL(TMP3281, ".", 1);
STRING_LITERAL(TMP3282, "/", 1);
STRING_LITERAL(TMP3283, "invalid module name: \'$1\'", 25);
STRING_LITERAL(TMP3285, "rawImportSymbol", 15);
STRING_LITERAL(TMP3286, "tab", 3);
STRING_LITERAL(TMP3287, "importSymbol: 2", 15);
STRING_LITERAL(TMP3288, "importSymbol: 3", 15);
STRING_LITERAL(TMP3289, "importAllSymbols: ", 18);
STRING_LITERAL(TMP3290, "a.kind == nkSym ", 16);
STRING_LITERAL(TMP3291, "\'export except\' not implemented", 31);
STRING_LITERAL(TMP3293, "module alias must be an identifier", 34);
...
N_NIMCALL(NimStringDesc*, getmodulename_259012)(tnode191813* n) {
	...
	case ((NU8) 22):
	{
		...
		result = nosunixToNativePath((*n).kindU.S3.Strval, ((NimStringDesc*) &TMP3272));
	}
	break;
	case ((NU8) 2):
	{
	...
	case ((NU8) 29):
	{
		...
		nimln(31, "importer.nim");
		{
			...
			if (((TMP3277[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3278));
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!(((TMP3273[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3274));
			nimln(31, "importer.nim");
			LOC9 = 0;
			LOC9 = getident_170456(((NimStringDesc*) &TMP3279));
		...
		result = nsuReplaceStr(LOC13, ((NimStringDesc*) &TMP3280), ((NimStringDesc*) &TMP3272));
	}
	break;
	case ((NU8) 45):
	{
		...
		result = nsuReplaceStr(LOC15, ((NimStringDesc*) &TMP3281), ((NimStringDesc*) &TMP3282));
	}
	break;
	case ((NU8) 78):
	{
	...
	default:
	{
		...
		LOC19 = 0;
		LOC19 = nsuFormatSingleElem(((NimStringDesc*) &TMP3283), LOC18);
		localerror_168571((*n).Info, ((NU16) 4), LOC19);
		nimln(46, "importer.nim");
		result = copyString(((NimStringDesc*) &TMP3272));
	}
	break;
	}
	BeforeRet: ;
...
static N_INLINE(NIM_BOOL, haspattern_198060)(tsym191843* s) {
	...
	nimln(1518, "ast.nim");
	nimln(1518, "ast.nim");
	if (((TMP3277[(*(*s).Ast).Kind/8] &(1<<((*(*s).Ast).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3278));
...
N_NIMCALL(void, rawimportsymbol_259235)(tcontext254019* c, tsym191843* s) {
	...
	nimln(71, "importer.nim");
	{
		...
		nimln(73, "importer.nim");
		{
			...
			TMP3284 = subInt(LOC21, 1);
			HEX3Atmp_259408 = (NI64)(TMP3284);
			...
			while (1) {
				...
				if (((TMP3277[(*(*etyp).N).Kind/8] &(1<<((*(*etyp).N).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3278));
				if ((NU)(j_259322) >= (NU)((*(*etyp).N).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (!(((TMP3275[(*(*(*etyp).N).kindU.S6.Sons->data[j_259322]).Kind/8] &(1<<((*(*(*etyp).N).kindU.S6.Sons->data[j_259322]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3276));
				...
				nimln(76, "importer.nim");
				{
					...
					internalerror_168591((*s).Info, ((NimStringDesc*) &TMP3285));
				}
				LA25: ;
...
N_NIMCALL(void, importsymbol_259416)(tcontext254019* c, tnode191813* n, tsym191843* frommod) {
	...
	if (!(((64 &(1<<(((*frommod).Kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3286));
		...
		case ((NU8) 16):
		{
			...
			while (1) {
				...
				nimln(111, "importer.nim");
				{
					...
					nimln(111, "importer.nim");
					internalerror_168591((*n).Info, ((NimStringDesc*) &TMP3288));
				}
				LA18: ;
...
appendString(LOC14, ((NimStringDesc*) &TMP3289));
...
N_NIMCALL(void, importforwarded_259633)(tcontext254019* c, tnode191813* n, tintset188047* exceptset) {
	...
	case ((NU8) 117):
	{
		...
		while (1) {
			...
			nimln(137, "importer.nim");
			{
				...
				nimln(137, "importer.nim");
				failedassertimpl_80621(((NimStringDesc*) &TMP3290));
			}
			LA10: ;
			nimln(138, "importer.nim");
			if (!(((TMP3275[(*a_259649).Kind/8] &(1<<((*a_259649).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3276));
	...
	case ((NU8) 118):
	{
		...
		localerror_168571((*n).Info, ((NU16) 4), ((NimStringDesc*) &TMP3291));
	}
	break;
	default:
	{
		...
		TMP3292 = subInt(LOC24, 1);
		HEX3Atmp_259865 = (NI64)(TMP3292);
		nimln(1458, "system.nim");
		res_259867 = 0;
		nimln(1459, "system.nim");
		while (1) {
...
N_NIMCALL(tsym191843*, importmoduleas_259873)(tnode191813* n, tsym191843* realmodule) {
	...
	LA3: ;
	{
		...
		localerror_168571((*n).Info, ((NU16) 4), ((NimStringDesc*) &TMP3293));
	}
	goto LA1;
	LA9: ;
	{
		...
		if (((TMP3277[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3278));
		if ((NU)(1) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3273[(*(*n).kindU.S6.Sons->data[1]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[1]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3274));
...
N_NIMCALL(tnode191813*, evalimportexcept_260170)(tcontext254019* c, tnode191813* n) {
	...
	nimln(191, "importer.nim");
	{
		...
		LOC5 = 0;
		LOC5 = sonslen_192191(n);
		TMP3296 = subInt(LOC5, 1);
		HEX3Atmp_260251 = (NI64)(TMP3296);
		nimln(1451, "system.nim");
		res_260253 = 1;
		nimln(1452, "system.nim");
		while (1) {
