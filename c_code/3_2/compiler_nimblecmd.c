...
{	result = 0;
	{
		if (!eqStrings(a, ((NimStringDesc*) &TMP1702))) goto LA3;
		result = NIM_FALSE;
		goto BeforeRet;
	}
	LA3: ;
...
N_NIMCALL(void, addpackage_189126)(stringtableobj131012* packages, NimStringDesc* p) {
	...
	LA3: ;
	{
		nstPut(packages, name, ((NimStringDesc*) &TMP1702));
	}
	LA1: ;
}
				...
				while (1) {
					{
						...
						y_189312 = cstrToNimstr(((NCSTRING) ((*x_189310).d_name)));
						{
							...
							NU8 k_189316;
							LOC19 = 0;
							LOC19 = !(eqStrings(y_189312, ((NimStringDesc*) &TMP1700)));
							if (!(LOC19)) goto LA20;
							LOC19 = !(eqStrings(y_189312, ((NimStringDesc*) &TMP1701)));
							LA20: ;
							if (!LOC19) goto LA21;
							memset((void*)(&s_189314), 0, sizeof(s_189314));
							y_189312 = HEX2F_117492(dir, y_189312);
							k_189316 = ((NU8) 0);
							{
				...
				res_189330 = ((NI) 0);
				{
					while (1) {
						...
						h_189326 = res_189330;
						{
							...
							{
								if (!eqStrings(val_189324, ((NimStringDesc*) &TMP1702))) goto LA74;
