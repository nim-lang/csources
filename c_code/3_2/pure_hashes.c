...
N_NIMCALL(NI, hash_110826)(NimStringDesc* x) {
	...
	nimln(93, "hashes.nim");
	nimln(93, "hashes.nim");
	TMP268 = subInt(x->Sup.len, 1);
	HEX3Atmp_110849 = (NI64)(TMP268);
...
N_NIMCALL(NI, hashignorestyle_110856)(NimStringDesc* x) {
	...
	nimln(100, "hashes.nim");
	nimln(100, "hashes.nim");
	TMP269 = subInt(x->Sup.len, 1);
	HEX3Atmp_110916 = (NI64)(TMP269);
	nimln(1308, "system.nim");
	res_110918 = 0;
	nimln(1309, "system.nim");
	while (1) {
		...
		i_110870 = res_110918;
		{
			...
			nimln(104, "hashes.nim");
			{
				...
				nimln(105, "hashes.nim");
				nimln(105, "hashes.nim");
				TMP270 = addInt(((NI) (((NU8)(c)))), 32);
				c = ((NIM_CHAR) (((NI)chckRange((NI64)(TMP270), 0, 255))));
			}			LA9: ;
