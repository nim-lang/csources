		...
		getenvvarsc_119802();
		{
			...
			res_141899 = 0;
			{
				while (1) {
					...
					key_141859 = copyStrLast(environment_119609->data[i_141895], 0, (NI64)(p_141901 - 1));
					val_141860 = copyStr(environment_119609->data[i_141895], (NI64)(p_141901 + 1));
					counter += 1;
					res_141899 += 1;
				} LA4: ;
			}
		...
		getenvvarsc_119802();
		{
			...
			res_141918 = 0;
			{
				while (1) {
					...
					key_141875 = copyStrLast(environment_119609->data[i_141914], 0, (NI64)(p_141920 - 1));
					val_141876 = copyStr(environment_119609->data[i_141914], (NI64)(p_141920 + 1));
					LOC10 = 0;
