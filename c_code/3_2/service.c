	...
	while (1) {
		...
		case ((NU8) 3):
		{
			...
			nimln(43, "service.nim");
			{
				...
				key = copyStrLast(p.Key, 0, (NI64)(TMP7634));
				...
				LOC9 = 0;
				LOC9 = copyStr(p.Key, (NI64)(TMP7635));
...
N_NIMCALL(void, serve_529292)(TY529294 action) {
	...
	LA2: ;
	{
		...
		while (1) {
			...
			send_163403(stdoutsocket_167189, ((NimStringDesc*) &TMP7671));
...
N_NOINLINE(void, serviceInit)(void) {
	...
	LOC1 = 0;
	LOC1 = curcaascmd_529203; curcaascmd_529203 = copyStringRC1(((NimStringDesc*) &TMP7629));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(25, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_529204; lastcaascmd_529204 = copyStringRC1(((NimStringDesc*) &TMP7629));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(28, "service.nim");
	LOC3 = 0;
	LOC3 = arguments_529205; arguments_529205 = copyStringRC1(((NimStringDesc*) &TMP7629));
