...
static NIM_CONST TY192025 TMP3568 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3569, "strVal", 6);
static NIM_CONST TY192025 TMP3570 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3571, "sons", 4);
static NIM_CONST TY192025 TMP3572 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3573, "ident", 5);
STRING_LITERAL(TMP3574, "|", 1);
STRING_LITERAL(TMP3575, "&", 1);
STRING_LITERAL(TMP3576, "~", 1);
STRING_LITERAL(TMP3577, "atom", 4);
STRING_LITERAL(TMP3578, "lit", 3);
STRING_LITERAL(TMP3579, "sym", 3);
STRING_LITERAL(TMP3580, "ident", 5);
STRING_LITERAL(TMP3581, "call", 4);
STRING_LITERAL(TMP3582, "alias", 5);
STRING_LITERAL(TMP3583, "noalias", 7);
STRING_LITERAL(TMP3584, "lvalue", 6);
STRING_LITERAL(TMP3585, "local", 5);
STRING_LITERAL(TMP3586, "sideeffect", 10);
STRING_LITERAL(TMP3587, "nosideeffect", 12);
STRING_LITERAL(TMP3589, "parampatterns.nim", 17);
NIM_CONST TY131009 TMP3588 = {((NimStringDesc*) &TMP3589),
100}
;
NIM_CONST TY131009 TMP3590 = {((NimStringDesc*) &TMP3589),
107}
;
STRING_LITERAL(TMP3591, "p.kind == nkCurlyExpr ", 22);
STRING_LITERAL(TMP3592, "parameter pattern too complex", 29);
static NIM_CONST TY192025 TMP3593 = {
...
N_NIMCALL(NIM_BOOL, matchnodekinds_281344)(tnode191813* p, tnode191813* n) {
	...
	while (1) {
		...
		case ((NU8) 2):
		{
			...
			LOC4 = stack[((NI64)(TMP3597))- 0];
			LA5: ;
			stack[((NI64)(TMP3595))- 0] = LOC4;
		...
		case ((NU8) 3):
		{
			...
			LOC7 = stack[((NI64)(TMP3600))- 0];
			LA8: ;
			stack[((NI64)(TMP3598))- 0] = LOC7;
		...
		case ((NU8) 4):
		{
			...
			stack[((NI64)(TMP3601))- 0] = !(stack[((NI64)(TMP3602))- 0]);
		}
		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3603)])), ((NU8) 0), ((NU8) 24)));
			nimln(233, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			nimln(258, "parampatterns.nim");
			TMP3604 = addInt(pc, 1);
			if ((NU)((NI64)(TMP3604)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3604)])), ((NU8) 0), ((NU8) 156)));
			nimln(233, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
