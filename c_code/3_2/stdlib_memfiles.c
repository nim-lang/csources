...
N_NIMCALL(void*, mapmem_233210)(tmemfile233204* m, NU8 mode, NI mappedsize, NI offset);
...
N_NIMCALL(void, unmapmem_233605)(tmemfile233204* f, void* p, NI size);
...
static TNimNode* TMP3035[3];
static TNimNode TMP2951[4];
NTI233204.size = sizeof(tmemfile233204);
NTI233204.kind = 18;
NTI233204.base = 0;
NTI233204.flags = 3;
TMP3035[0] = &TMP2951[1];
TMP2951[1].kind = 1;
TMP2951[1].offset = offsetof(tmemfile233204, Mem);
TMP2951[1].typ = (&NTI147);
TMP2951[1].name = "mem";
TMP3035[1] = &TMP2951[2];
TMP2951[2].kind = 1;
TMP2951[2].offset = offsetof(tmemfile233204, Size);
TMP2951[2].typ = (&NTI106);
TMP2951[2].name = "size";
TMP3035[2] = &TMP2951[3];
TMP2951[3].kind = 1;
TMP2951[3].offset = offsetof(tmemfile233204, Handle);
TMP2951[3].typ = (&NTI4409);
TMP2951[3].name = "handle";
TMP2951[0].len = 3; TMP2951[0].kind = 2; TMP2951[0].sons = &TMP3035[0];
NTI233204.node = &TMP2951[0];
}
