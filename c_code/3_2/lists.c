...
STRING_LITERAL(TMP259, "list.tail.next == nil ", 22);
STRING_LITERAL(TMP263, "list.head.prev == nil ", 22);
STRING_LITERAL(TMP264, "pos != nil ", 11);
...
N_NIMCALL(void, append_119042)(tlinkedlist119023* list, tlistentry119017* entry) {
	...
	nimln(36, "lists.nim");
	{
		...
		nimln(37, "lists.nim");
		{
			...
			nimln(37, "lists.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP259));
		}
		LA7: ;
		nimln(38, "lists.nim");
...
N_NIMCALL(void, prepend_119300)(tlinkedlist119023* list, tlistentry119017* entry) {
	...
	nimln(64, "lists.nim");
	{
		...
		nimln(65, "lists.nim");
		{
			...
			nimln(65, "lists.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP263));
		}
		LA7: ;
		nimln(66, "lists.nim");
...
N_NIMCALL(void, insertbefore_119444)(tlinkedlist119023* list, tlistentry119017* pos, tlistentry119017* entry) {
	...
	nimln(74, "lists.nim");
	{
		...
		nimln(74, "lists.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP264));
	}
	LA3: ;
	nimln(75, "lists.nim");
	{
...
static TNimNode* TMP260[2];
static TNimNode* TMP3241[3];
...
NTI119015.marker = TMP261;
TMP257[1].kind = 1;
TMP257[1].offset = offsetof(tlistentry119017, Prev);
TMP257[1].typ = (&NTI119015);
TMP257[1].name = "prev";
TMP260[1] = &TMP257[2];
TMP257[2].kind = 1;
TMP257[2].offset = offsetof(tlistentry119017, Next);
TMP257[2].typ = (&NTI119015);
TMP257[2].name = "next";
TMP257[0].len = 2; TMP257[0].kind = 2; TMP257[0].sons = &TMP260[0];
NTI119017.node = &TMP257[0];
NTI119019.size = sizeof(tstrentry119019);
NTI119019.kind = 17;
NTI119019.base = (&NTI119017);
TMP257[3].kind = 1;
TMP257[3].offset = offsetof(tstrentry119019, Data);
TMP257[3].typ = (&NTI143);
TMP257[3].name = "data";
NTI119019.node = &TMP257[3];
NTI119021.size = sizeof(tstrentry119019*);
NTI119021.kind = 22;
NTI119021.base = (&NTI119019);
NTI119021.marker = TMP262;
NTI119023.size = sizeof(tlinkedlist119023);
NTI119023.kind = 18;
NTI119023.base = 0;
TMP3241[0] = &TMP257[5];
TMP257[5].kind = 1;
TMP257[5].offset = offsetof(tlinkedlist119023, Head);
TMP257[5].typ = (&NTI119015);
TMP257[5].name = "head";
TMP3241[1] = &TMP257[6];
TMP257[6].kind = 1;
TMP257[6].offset = offsetof(tlinkedlist119023, Tail);
TMP257[6].typ = (&NTI119015);
TMP257[6].name = "tail";
TMP3241[2] = &TMP257[7];
TMP257[7].kind = 1;
TMP257[7].offset = offsetof(tlinkedlist119023, Counter);
TMP257[7].typ = (&NTI106);
TMP257[7].name = "counter";
TMP257[4].len = 3; TMP257[4].kind = 2; TMP257[4].sons = &TMP3241[0];
NTI119023.node = &TMP257[4];
}
