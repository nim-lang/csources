...
typedef N_CLOSURE_PTR(NI, TMP2608) (tsym224849* x_411707, tsym224849* y_411709);
typedef N_CLOSURE_PTR(NI, TMP2609) (tsym224849* x_411707, tsym224849* y_411709);
...
typedef N_CLOSURE_PTR(NI, TMP4759) (NimStringDesc* x_360639, NimStringDesc* y_360641);
typedef N_CLOSURE_PTR(NI, TMP4760) (NimStringDesc* x_360639, NimStringDesc* y_360641);
...
typedef N_CLOSURE_PTR(NI, TMP4763) (tindexentry357264* x_358641, tindexentry357264* y_358643);
typedef N_CLOSURE_PTR(NI, TMP4764) (tindexentry357264* x_358641, tindexentry357264* y_358643);
struct  tentry414478  {
NI Pos;
tsym224849* Sym;
};
...
typedef N_CLOSURE_PTR(NI, TMP4822) (tentry414478 x_415213, tentry414478 y_415215);
typedef N_CLOSURE_PTR(NI, TMP4823) (tentry414478 x_415213, tentry414478 y_415215);
struct  TNimObject  {
TNimType* m_type;
};
struct  tidobj200015  {
...
N_NIMCALL(void, merge_411680)(tsym224849** a_411688, NI a_411688Len0, tsym224849** b_411696, NI b_411696Len0, NI lo_411700, NI m_411702, NI hi_411704, TY411638 cmp_411712, NU8 order_411715) {
	...
	NI k;
	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp_411712.ClEnv? cmp_411712.ClPrc(a_411688[m_411702], a_411688[(NI64)(m_411702 + 1)], cmp_411712.ClEnv):((TMP2608)(cmp_411712.ClPrc))(a_411688[m_411702], a_411688[(NI64)(m_411702 + 1)]);
		LOC4 = 0;
	...
	k = lo_411700;
	{
		while (1) {
			...
			if (!LOC11) goto LA10;
			{
				...
				NI LOC16;
				LOC15 = 0;
				LOC15 = cmp_411712.ClEnv? cmp_411712.ClPrc(b_411696[i], a_411688[j], cmp_411712.ClEnv):((TMP2609)(cmp_411712.ClPrc))(b_411696[i], a_411688[j]);
				LOC16 = 0;
...
N_NIMCALL(void, merge_360612)(NimStringDesc** a_360620, NI a_360620Len0, NimStringDesc** b_360628, NI b_360628Len0, NI lo_360632, NI m_360634, NI hi_360636, TY360570 cmp_360644, NU8 order_360647) {
	...
	NI k;
	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp_360644.ClEnv? cmp_360644.ClPrc(a_360620[m_360634], a_360620[(NI64)(m_360634 + 1)], cmp_360644.ClEnv):((TMP4759)(cmp_360644.ClPrc))(a_360620[m_360634], a_360620[(NI64)(m_360634 + 1)]);
		LOC4 = 0;
	...
	k = lo_360632;
	{
		while (1) {
			...
			if (!LOC11) goto LA10;
			{
				...
				NI LOC16;
				LOC15 = 0;
				LOC15 = cmp_360644.ClEnv? cmp_360644.ClPrc(b_360628[i], a_360620[j], cmp_360644.ClEnv):((TMP4760)(cmp_360644.ClPrc))(b_360628[i], a_360620[j]);
				LOC16 = 0;
...
N_NIMCALL(void, sort_360551)(NimStringDesc** a_360559, NI a_360559Len0, TY360570 cmp_360569, NU8 order_360572) {
	...
	n = a_360559Len0;
	b = 0;
	b = (TY119608*) newSeq((&NTI119608), (NI64)(n / 2));
	s = 1;
	{
		while (1) {
			NI m;
...
N_NIMCALL(void, merge_358614)(tindexentry357264* a_358622, NI a_358622Len0, tindexentry357264* b_358630, NI b_358630Len0, NI lo_358634, NI m_358636, NI hi_358638, TY358572 cmp_358646, NU8 order_358649) {
	...
	NI k;
	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp_358646.ClEnv? cmp_358646.ClPrc(&a_358622[m_358636], &a_358622[(NI64)(m_358636 + 1)], cmp_358646.ClEnv):((TMP4763)(cmp_358646.ClPrc))(&a_358622[m_358636], &a_358622[(NI64)(m_358636 + 1)]);
		LOC4 = 0;
	...
	k = lo_358634;
	{
		while (1) {
			...
			if (!LOC11) goto LA10;
			{
				...
				NI LOC16;
				LOC15 = 0;
				LOC15 = cmp_358646.ClEnv? cmp_358646.ClPrc(&b_358630[i], &a_358622[j], cmp_358646.ClEnv):((TMP4764)(cmp_358646.ClPrc))(&b_358630[i], &a_358622[j]);
				LOC16 = 0;
...
N_NIMCALL(void, merge_415186)(tentry414478* a_415194, NI a_415194Len0, tentry414478* b_415202, NI b_415202Len0, NI lo_415206, NI m_415208, NI hi_415210, TY415144 cmp_415218, NU8 order_415221) {
	...
	NI k;
	{
		...
		NI LOC4;
		LOC3 = 0;
		LOC3 = cmp_415218.ClEnv? cmp_415218.ClPrc(a_415194[m_415208], a_415194[(NI64)(m_415208 + 1)], cmp_415218.ClEnv):((TMP4822)(cmp_415218.ClPrc))(a_415194[m_415208], a_415194[(NI64)(m_415208 + 1)]);
		LOC4 = 0;
	...
	k = lo_415206;
	{
		while (1) {
			...
			if (!LOC11) goto LA10;
			{
				...
				NI LOC16;
				LOC15 = 0;
				LOC15 = cmp_415218.ClEnv? cmp_415218.ClPrc(b_415202[i], a_415194[j], cmp_415218.ClEnv):((TMP4823)(cmp_415218.ClPrc))(b_415202[i], a_415194[j]);
				LOC16 = 0;
