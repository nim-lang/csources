...
N_NIMCALL(NI, send_525677)(Socketimpl521404* socket, void* data, NI size);
...
N_NIMCALL(NI, waitfor_524806)(Socketimpl521404* socket, NF* waited, NI timeout, NI size, NimStringDesc* funcname);
...
N_NIMCALL(void, send_526001)(Socketimpl521404* socket, NimStringDesc* data, NU8 flags) {
	NI sent;
{	sent = send_525677(socket, ((void*) (data->data)), (data ? data->Sup.len : 0));
	{
		NI32 lasterror;
...
{	waited = 0.0;
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		while (1) {
			...
			c = 0;
			LOC3 = 0;
			LOC3 = waitfor_524806(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5284));
			...
			LA4: ;
			{
				...
				LOC20 = 0;
				LOC20 = waitfor_524806(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP5284));
