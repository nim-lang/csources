...
STRING_LITERAL(TMP2681, "getSymFromList", 14);
STRING_LITERAL(TMP3155, "lookupInRecord", 14);
STRING_LITERAL(TMP3156, "lookupInRecord(record case branch)", 34);
STRING_LITERAL(TMP3157, "lookupInRecord()", 16);
	...
	result = 0;
	{
		...
		res_235114 = start;
		{
			while (1) {
				...
				LA7: ;
				{
					internalerror_197970((*list).Info, ((NimStringDesc*) &TMP2681));
				}
				LA5: ;
				res_235114 += 1;
			} LA4: ;
...
N_NIMCALL(tsym224849*, lookupinrecord_234236)(tnode224819* n, tident200021* field) {
	...
	{
		{
			...
			internalerror_197970((*n).Info, ((NimStringDesc*) &TMP3155));
		}
		LA13: ;
		...
		LA17: ;
		{
			...
			res_234860 = 1;
			{
				while (1) {
					...
					default:
					{
						internalerror_197970((*n).Info, ((NimStringDesc*) &TMP3156));
					}
					break;
					}
					res_234860 += 1;
	...
	default:
	{
		internalerror_197970((*n).Info, ((NimStringDesc*) &TMP3157));
	}
	break;
	}
	BeforeRet: ;
