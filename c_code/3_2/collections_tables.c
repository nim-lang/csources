...
static N_INLINE(NI, nexttry_117405)(NI h, NI maxhash) {
	...
	nimln(70, "tables.nim");
	TMP373 = mulInt(5, h);
	TMP374 = addInt((NI64)(TMP373), 1);
	result = (NI)((NI64)(TMP374) & maxhash);
	popFrame();
	return result;
}N_NIMCALL(void, TMP792)(void* p, NI op) {
...
N_NIMCALL(void, enlarge_136840)(ttable136540* t) {
	...
	n = (tkeyvaluepairseq136543*) newSeq((&NTI136543), (NI64)(TMP805));
	i_136879 = 0;
	HEX3Atmp_136934 = 0;
...
N_NIMCALL(void, enlarge_219767)(ttable219029* t) {
	...
	n = (tkeyvaluepairseq219032*) newSeq((&NTI219032), (NI64)(TMP3091));
	i_219806 = 0;
	HEX3Atmp_219861 = 0;
	nimln(117, "tables.nim");
	nimln(117, "tables.nim");
...
N_NIMCALL(void, enlarge_220197)(ttable219059* t) {
	...
	n = (tkeyvaluepairseq219062*) newSeq((&NTI219062), (NI64)(TMP3100));
	i_220236 = 0;
	HEX3Atmp_220291 = 0;
	nimln(117, "tables.nim");
	nimln(117, "tables.nim");
