...
N_NIMCALL(void, renderparamtypes_395467)(TY119608** found, tnode224819* n);
...
STRING_LITERAL(TMP4629, "*", 1);
STRING_LITERAL(TMP4630, "renderPlainSymbolName() with ", 29);
STRING_LITERAL(TMP4637, "ref.", 4);
STRING_LITERAL(TMP4638, "ptr.", 4);
STRING_LITERAL(TMP4639, "proc(", 5);
STRING_LITERAL(TMP4640, "tuple[", 6);
STRING_LITERAL(TMP4641, "renderParamTypes(found,n) with ", 31);
...
N_NIMCALL(NimStringDesc*, renderplainsymbolname_393013)(tnode224819* n) {
	...
	{
		{
			if (!!(eqStrings((*(*n).kindU.S5.Ident).S, ((NimStringDesc*) &TMP4629)))) goto LA15;
...
appendString(LOC24, ((NimStringDesc*) &TMP4630));
...
appendString(LOC6, ((NimStringDesc*) &TMP4637));
...
appendString(LOC10, ((NimStringDesc*) &TMP4638));
appendString(LOC10, LOC12);
	...
	case ((NU8) 145):
	{
		...
		result = copyString(((NimStringDesc*) &TMP4639));
		{
			NI i_394422;
			NI HEX3Atmp_395402;
			NI LOC15;
...
appendString(result, LOC27);
	...
	case ((NU8) 133):
	{
		result = copyString(((NimStringDesc*) &TMP4640));
		{
			NI i_395022;
			NI HEX3Atmp_395414;
			NI LOC30;
		...
		LA15: ;
		{
			...
			res_395836 = 0;
			{
				while (1) {
					...
					i_395646 = res_395836;
					(*found) = (TY119608*) incrSeq(&((*found))->Sup, sizeof(NimStringDesc*));
					LOC29 = 0;
...
appendString(LOC31, ((NimStringDesc*) &TMP4641));
...
N_NIMCALL(NimStringDesc*, renderparamtypes_395862)(tnode224819* n, NimStringDesc* sep) {
	...
	result = 0;
	result = copyString(((NimStringDesc*) &TMP4628));
	found = (TY119608*) newSeq((&NTI119608), 0);
