...
N_NIMCALL(void, renderparamtypes_344423)(TY11065** found, tnode191813* n);
...
STRING_LITERAL(TMP4762, "", 0);
static NIM_CONST TY192025 TMP4763 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4764, "sons", 4);
static NIM_CONST TY192025 TMP4765 = {
...
static NIM_CONST TY192025 TMP4768 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4769, "sym", 3);
STRING_LITERAL(TMP4770, "renderPlainSymbolName() with ", 29);
STRING_LITERAL(TMP4771, "not result.isNil ", 17);
STRING_LITERAL(TMP4772, "len(n) == 1 ", 12);
STRING_LITERAL(TMP4773, "ref.", 4);
STRING_LITERAL(TMP4774, "ptr.", 4);
STRING_LITERAL(TMP4775, "len(n) > 1 ", 11);
STRING_LITERAL(TMP4776, "params.kind == nkFormalParams ", 30);
STRING_LITERAL(TMP4777, "len(params) > 0 ", 16);
STRING_LITERAL(TMP4778, "proc(", 5);
STRING_LITERAL(TMP4779, "len(n) >= 3 ", 12);
STRING_LITERAL(TMP4781, "n[i].kind == nkIdent ", 21);
STRING_LITERAL(TMP4782, "len(n) > 0 ", 11);
STRING_LITERAL(TMP4783, "tuple[", 6);
STRING_LITERAL(TMP4784, "len(n) >= 2 ", 12);
STRING_LITERAL(TMP4786, "typePos > 0 ", 12);
STRING_LITERAL(TMP4789, "renderParamTypes(found,n) with ", 31);
...
N_NIMCALL(NimStringDesc*, renderplainsymbolname_342007)(tnode191813* n) {
	...
	case ((NU8) 2):
	{
		nimln(19, "typesrenderer.nim");
		{
			nimln(19, "typesrenderer.nim");
			nimln(19, "typesrenderer.nim");
			if (!(((TMP4765[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4766));
			if (!!(eqStrings((*(*n).kindU.S5.Ident).S, ((NimStringDesc*) &TMP4767)))) goto LA13;
...
appendString(LOC22, reprEnum((*n).Kind, (&NTI191023)));
	...
	nimln(29, "typesrenderer.nim");
	{
		...
		nimln(29, "typesrenderer.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP4771));
	}
	LA25: ;
	BeforeRet: ;
	popFrame();
...
N_NIMCALL(NimStringDesc*, rendertype_342208)(tnode191813* n) {
	...
	case ((NU8) 141):
	{
		...
		nimln(37, "typesrenderer.nim");
		{
			...
			if (!!((LOC6 == 1))) goto LA7;
			nimln(37, "typesrenderer.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP4772));
		}
		LA7: ;
...
appendString(LOC16, ((NimStringDesc*) &TMP4773));
...
appendString(LOC25, ((NimStringDesc*) &TMP4774));
appendString(LOC25, LOC27);
	...
	case ((NU8) 145):
	{
		...
		nimln(46, "typesrenderer.nim");
		{
			...
			nimln(46, "typesrenderer.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP4775));
		}
		LA32: ;
		...
		nimln(48, "typesrenderer.nim");
		{
			...
			nimln(48, "typesrenderer.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP4776));
		}
		LA36: ;
		nimln(49, "typesrenderer.nim");
		{
			...
			nimln(49, "typesrenderer.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP4777));
		}
		LA41: ;
...
appendString(result, LOC45);
	...
	case ((NU8) 35):
	{
		...
		nimln(54, "typesrenderer.nim");
		{
			...
			nimln(54, "typesrenderer.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP4779));
		}
		LA52: ;
		...
		LOC54 = 0;
		LOC54 = len_192274(n);
		TMP4780 = subInt(LOC54, 2);
		typepos = (NI64)(TMP4780);
...
appendString(result, LOC62);
	...
	case ((NU8) 133):
	{
		...
		nimln(62, "typesrenderer.nim");
		{
			...
			nimln(62, "typesrenderer.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP4782));
		}
		LA67: ;
...
N_NIMCALL(void, renderparamtypes_344423)(TY11065** found, tnode191813* n) {
	...
	case ((NU8) 35):
	{
		...
		LOC6 = 0;
		LOC6 = len_192274(n);
		TMP4785 = subInt(LOC6, 2);
		typepos = (NI64)(TMP4785);
		...
		nimln(89, "typesrenderer.nim");
		{
			...
			LOC16 = 0;
			LOC16 = HEX5BHEX5D_192711(n, (NI64)(TMP4787));
			...
			nimln(91, "typesrenderer.nim");
			nimln(91, "typesrenderer.nim");
			TMP4788 = addInt(typepos, 1);
			LOC19 = 0;
			LOC19 = HEX5BHEX5D_192711(n, (NI64)(TMP4788));
			typ = (*LOC19).Typ;
		...
		while (1) {
			...
			(*found) = (TY11065*) incrSeq(&((*found))->Sup, sizeof(NimStringDesc*));
			LOC34 = 0;
...
appendString(LOC36, ((NimStringDesc*) &TMP4789));
...
N_NIMCALL(NimStringDesc*, renderparamtypes_344847)(tnode191813* n, NimStringDesc* sep) {
	...
	found = (TY11065*) newSeq((&NTI11065), 0);
