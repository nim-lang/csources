...
extern TNimType NTI23018; /* array[0..7, int] */
...
static N_INLINE(NIM_BOOL, mustrehash_183058)(NI length, NI counter) {
	...
	LOC5 = ((NI64)(TMP1933) < (NI64)(TMP1934));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
...
static N_INLINE(NI, nexttry_183206)(NI h, NI maxhash) {
	...
	result = (NI)((NI64)(TMP1937) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, intsetenlarge_183621)(tintset183047* t) {
	...
	TMP1941 = mulInt((NI64)(TMP1940), 2);
	TMP1942 = subInt((NI64)(TMP1941), 1);
	(*t).Max = (NI64)(TMP1942);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1943 = addInt((*t).Max, 1);
	n = (ttrunkseq183045*) newSeq((&NTI183045), (NI64)(TMP1943));
	i_183655 = 0;
...
N_NIMCALL(ttrunk183043*, intsetput_183696)(tintset183047* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_183058((NI64)(TMP1947), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
