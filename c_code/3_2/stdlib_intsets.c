...
STRING_LITERAL(TMP1934, "length > counter ", 17);
STRING_LITERAL(TMP1940, "data[h] != desc ", 16);
STRING_LITERAL(TMP1941, "data[h] == nil ", 15);
STRING_LITERAL(TMP1950, "t.data[h] == nil ", 17);
STRING_LITERAL(TMP1951, "dest.data[h] == nil ", 20);
STRING_LITERAL(TMP1952, "{", 1);
STRING_LITERAL(TMP1953, ", ", 2);
STRING_LITERAL(TMP1954, "}", 1);
extern TFrame* frameptr_13438;
extern tgcheap44016 gch_44044;
TNimType NTI188043; /* TTrunk */
extern TNimType NTI106; /* int */
extern TNimType NTI23618; /* array[0..7, int] */
...
static N_INLINE(NIM_BOOL, mustrehash_188058)(NI length, NI counter) {
	...
	nimln(47, "intsets.nim");
	{
		...
		nimln(47, "intsets.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP1934));
	}
	LA3: ;
	...
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	TMP1935 = mulInt(length, 2);
	nimln(48, "intsets.nim");
	TMP1936 = mulInt(counter, 3);
	LOC5 = ((NI64)(TMP1935) < (NI64)(TMP1936));
	if (LOC5) goto LA6;
	nimln(48, "intsets.nim");
	nimln(48, "intsets.nim");
	TMP1937 = subInt(length, counter);
	LOC5 = ((NI64)(TMP1937) < 4);
	LA6: ;
	result = LOC5;
	popFrame();
...
static N_INLINE(NI, nexttry_188206)(NI h, NI maxhash) {
	...
	nimln(51, "intsets.nim");
	TMP1938 = mulInt(5, h);
	TMP1939 = addInt((NI64)(TMP1938), 1);
	result = (NI)((NI64)(TMP1939) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, intsetrawinsert_188239)(tintset188047* t, ttrunkseq188045** data, ttrunk188043* desc) {
	...
	while (1) {
		...
		nimln(64, "intsets.nim");
		{
			...
			nimln(64, "intsets.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP1940));
		}
		LA4: ;
	...
	nimln(66, "intsets.nim");
	{
		...
		nimln(66, "intsets.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP1941));
	}
	LA8: ;
...
N_NIMCALL(void, intsetenlarge_188621)(tintset188047* t) {
	...
	nimln(72, "intsets.nim");
	nimln(72, "intsets.nim");
	TMP1942 = addInt((*t).Max, 1);
	TMP1943 = mulInt((NI64)(TMP1942), 2);
	TMP1944 = subInt((NI64)(TMP1943), 1);
	(*t).Max = (NI64)(TMP1944);
	nimln(73, "intsets.nim");
	nimln(73, "intsets.nim");
	TMP1945 = addInt((*t).Max, 1);
	n = (ttrunkseq188045*) newSeq((&NTI188045), (NI64)(TMP1945));
	i_188655 = 0;
...
N_NIMCALL(ttrunk188043*, intsetput_188696)(tintset188047* t, NI key) {
	...
	nimln(84, "intsets.nim");
	{
		...
		LOC8 = 0;
		LOC8 = mustrehash_188058((NI64)(TMP1949), (*t).Counter);
		if (!LOC8) goto LA9;
		nimln(84, "intsets.nim");
	...
	nimln(88, "intsets.nim");
	{
		...
		nimln(88, "intsets.nim");
		failedassertimpl_80621(((NimStringDesc*) &TMP1950));
	}
	LA14: ;
...
N_NIMCALL(NIM_BOOL, contains_188838)(tintset188047* s, NI key) {
	...
	nimln(97, "intsets.nim");
	t = intsetget_188213(s, (NI)((NU64)(key) >> (NU64)(9)));
...
N_NIMCALL(void, incl_188866)(tintset188047* s, NI key) {
	...
	nimln(106, "intsets.nim");
	t = intsetput_188696(s, (NI)((NU64)(key) >> (NU64)(9)));
...
N_NIMCALL(void, assign_188956)(tintset188047* dest, tintset188047* src) {
	...
	while (1) {
		...
		nimln(152, "intsets.nim");
		{
			...
			nimln(152, "intsets.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP1951));
		}
		LA5: ;
		n = 0;
...
N_NIMCALL(NimStringDesc*, HEX24_189322)(tintset188047* s) {
	...
	result = copyString(((NimStringDesc*) &TMP1952));
	key_189327 = 0;
	...
	while (1) {
		...
		while (1) {
			...
			NI j_189336;
			nimln(169, "intsets.nim");
			if (!(i_189332 <= 7)) goto LA2;
			nimln(170, "intsets.nim");
			if ((NU)(i_189332) > (NU)(7)) raiseIndexError();
			...
			while (1) {
				...
				nimln(175, "intsets.nim");
				{
					...
					nimln(176, "intsets.nim");
					nimln(176, "intsets.nim");
					key_189327 = (NI)((NI)((NU64)((*r_189330).Key) << (NU64)(9)) | (NI)((NU64)((NI)((NU64)(i_189332) << (NU64)(6))) + (NU64)(j_189336)));
...
appendString(result, LOC12);
				...
				nimln(178, "intsets.nim");
				w_189334 = (NI)((NU64)(w_189334) >> (NU64)(1));
			} LA3: ;
...
appendString(result, ((NimStringDesc*) &TMP1954));
	popFrame();
	return result;
}
...
static TNimNode* TMP3240[4];
static TNimNode TMP1932[9];
NTI188043.size = sizeof(ttrunk188043);
NTI188043.kind = 18;
NTI188043.base = 0;
TMP1946[0] = &TMP1932[1];
TMP1932[1].kind = 1;
TMP1932[1].offset = offsetof(ttrunk188043, Next);
TMP1932[1].typ = (&NTI188041);
TMP1932[1].name = "next";
TMP1946[1] = &TMP1932[2];
TMP1932[2].kind = 1;
TMP1932[2].offset = offsetof(ttrunk188043, Key);
TMP1932[2].typ = (&NTI106);
TMP1932[2].name = "key";
TMP1946[2] = &TMP1932[3];
TMP1932[3].kind = 1;
TMP1932[3].offset = offsetof(ttrunk188043, Bits);
TMP1932[3].typ = (&NTI23618);
TMP1932[3].name = "bits";
TMP1932[0].len = 3; TMP1932[0].kind = 2; TMP1932[0].sons = &TMP1946[0];
NTI188043.node = &TMP1932[0];
NTI188041.size = sizeof(ttrunk188043*);
NTI188041.kind = 22;
NTI188041.base = (&NTI188043);
NTI188041.marker = TMP1947;
NTI188045.size = sizeof(ttrunkseq188045*);
NTI188045.kind = 24;
NTI188045.base = (&NTI188041);
NTI188045.flags = 2;
NTI188045.marker = TMP1948;
...
TMP3240[0] = &TMP1932[5];
TMP1932[5].kind = 1;
TMP1932[5].offset = offsetof(tintset188047, Counter);
TMP1932[5].typ = (&NTI106);
TMP1932[5].name = "counter";
TMP3240[1] = &TMP1932[6];
TMP1932[6].kind = 1;
TMP1932[6].offset = offsetof(tintset188047, Max);
TMP1932[6].typ = (&NTI106);
TMP1932[6].name = "max";
TMP3240[2] = &TMP1932[7];
TMP1932[7].kind = 1;
TMP1932[7].offset = offsetof(tintset188047, Head);
TMP1932[7].typ = (&NTI188041);
TMP1932[7].name = "head";
TMP3240[3] = &TMP1932[8];
TMP1932[8].kind = 1;
TMP1932[8].offset = offsetof(tintset188047, Data);
TMP1932[8].typ = (&NTI188045);
TMP1932[8].name = "data";
TMP1932[4].len = 4; TMP1932[4].kind = 2; TMP1932[4].sons = &TMP3240[0];
NTI188047.node = &TMP1932[4];
}
