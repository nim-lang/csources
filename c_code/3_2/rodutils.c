...
STRING_LITERAL(TMP1399, "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", 62);
STRING_LITERAL(TMP3490, "NAN", 3);
STRING_LITERAL(TMP3491, "0.0", 3);
STRING_LITERAL(TMP3492, "INF", 3);
STRING_LITERAL(TMP3493, "-INF", 4);
...
N_NIMCALL(NI, decodevint_233359)(NCSTRING s, NI* pos) {
	...
	result = 0;
	{
		while (1) {
			...
			case 48 ... 57:
			{
				result = (NI64)((NI64)(result * 190) - ((NI) ((NI64)(((NI) (((NU8)(s[i_233366])))) - 48))));
			}
			break;
			case 97 ... 122:
			{
				result = (NI64)((NI64)(result * 190) - ((NI) ((NI64)(((NI) ((NI64)(((NI) (((NU8)(s[i_233366])))) - 97))) + 10))));
			}
			break;
			case 65 ... 90:
			{
				result = (NI64)((NI64)(result * 190) - ((NI) ((NI64)(((NI) ((NI64)(((NI) (((NU8)(s[i_233366])))) - 65))) + 36))));
			}
			break;
			case 128 ... 255:
			{
				result = (NI64)((NI64)(result * 190) - ((NI) ((NI64)(((NI) ((NI64)(((NI) (((NU8)(s[i_233366])))) - 128))) + 62))));
			}
			break;
			default:
			{
	...
	result = (NI)((NU64)((NI64)(result * sign_233368)) - (NU64)(5));
	(*pos) = i_233366;
	return result;
}
	...
	result = copyString(((NimStringDesc*) &TMP1378));
	{
		while (1) {
			...
			case 92:
			{
				...
				i += 3;
				xi = 0;
				hexchar_233089(s[(NI64)(i - 2)], &xi);
				hexchar_233089(s[(NI64)(i - 1)], &xi);
...
N_NIMCALL(void, encodevintaux_233275)(NI x, NimStringDesc** result) {
	...
	d_233281 = 0;
	v_233283 = x;
	rem_233285 = (NI64)(v_233283 % 190);
	{
		if (!(((NI) (rem_233285)) < 0)) goto LA3;
		(*result) = addChar((*result), 45);
		v_233283 = ((NI64)-((NI64)(v_233283 / 190)));
		rem_233285 = ((NI64)-(((NI) (rem_233285))));
	}
	goto LA1;
	LA3: ;
	{
		v_233283 = (NI64)(v_233283 / 190);
	}
	LA1: ;
	idx_233287 = ((NI) (rem_233285));
	{
		if (!(idx_233287 < 62)) goto LA8;
		d_233281 = ((NimStringDesc*) &TMP1399)->data[idx_233287];
	}
	goto LA6;
	LA8: ;
	{
		d_233281 = ((NIM_CHAR) (((NI) ((NI64)((NI64)(idx_233287 - 62) + 128)))));
	}
	LA6: ;
	{
...
N_NIMCALL(void, encodevint_233304)(NI x, NimStringDesc** result) {
	encodevintaux_233275((NI)((NU64)(x) + (NU64)(5)), result);
}
...
N_NIMCALL(NI64, decodevbiggestint_233518)(NCSTRING s, NI* pos) {
	...
	result = 0;
	{
		while (1) {
			...
			case 48 ... 57:
			{
				result = (NI64)((NI64)(result * 190) - ((NI64) ((NI64)(((NI) (((NU8)(s[i_233525])))) - 48))));
			}
			break;
			case 97 ... 122:
			{
				result = (NI64)((NI64)(result * 190) - ((NI64) ((NI64)(((NI) ((NI64)(((NI) (((NU8)(s[i_233525])))) - 97))) + 10))));
			}
			break;
			case 65 ... 90:
			{
				result = (NI64)((NI64)(result * 190) - ((NI64) ((NI64)(((NI) ((NI64)(((NI) (((NU8)(s[i_233525])))) - 65))) + 36))));
			}
			break;
			case 128 ... 255:
			{
				result = (NI64)((NI64)(result * 190) - ((NI64) ((NI64)(((NI) ((NI64)(((NI) (((NU8)(s[i_233525])))) - 128))) + 62))));
			}
			break;
			default:
			{
...
N_NIMCALL(NimStringDesc*, tostrmaxprecision_233024)(NF f) {
	...
	{
		if (!(f == 0.0)) goto LA6;
		result = copyString(((NimStringDesc*) &TMP3491));
	}
	goto LA1;
	LA6: ;
	{
		...
		{
			if (!(0.0 < f)) goto LA13;
			result = copyString(((NimStringDesc*) &TMP3492));
		}
		goto LA11;
		LA13: ;
		{
...
N_NIMCALL(void, encodestr_233042)(NimStringDesc* s, NimStringDesc** result) {
	{
		...
		i_233059 = 0;
		HEX3Atmp_233069 = 0;
		HEX3Atmp_233069 = (NI64)(s->Sup.len - 1);
		res_233072 = 0;
		{
			while (1) {
...
N_NIMCALL(void, encodevbiggestintaux_233234)(NI64 x, NimStringDesc** result) {
	...
	idx_233246 = ((NI) (rem_233244));
	{
		...
		d_233240 = ((NimStringDesc*) &TMP1399)->data[idx_233246];
	}
	goto LA6;
	LA8: ;
	{
		d_233240 = ((NIM_CHAR) (((NI) ((NI64)((NI64)(idx_233246 - 62) + 128)))));
	}
	LA6: ;
	{
