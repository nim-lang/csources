...
STRING_LITERAL(TMP263, "not (pos == nil) ", 17);
...
N_NIMCALL(void, append_109039)(tlinkedlist109020* list, tlistentry109014* entry) {
	...
	nimln(36, "lists.nim");
	{
		...
		nimln(37, "lists.nim");
		{
			...
			nimln(37, "lists.nim");
			hiddenraiseassert_76017(((NimStringDesc*) &TMP258));		}		LA7: ;
		nimln(38, "lists.nim");
...
N_NIMCALL(void, prepend_109269)(tlinkedlist109020* list, tlistentry109014* entry) {
	...
	nimln(64, "lists.nim");
	{
		...
		nimln(65, "lists.nim");
		{
			...
			nimln(65, "lists.nim");
			hiddenraiseassert_76017(((NimStringDesc*) &TMP262));		}		LA7: ;
		nimln(66, "lists.nim");
...
N_NIMCALL(void, insertbefore_109422)(tlinkedlist109020* list, tlistentry109014* pos, tlistentry109014* entry) {
	...
	nimln(74, "lists.nim");
	{
		...
		nimln(74, "lists.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP263));	}	LA3: ;
	nimln(75, "lists.nim");
	{
		nimln(75, "lists.nim");
...
NTI109012.marker = TMP260;
TMP256[1].kind = 1;
TMP256[1].offset = offsetof(tlistentry109014, Prev);
TMP256[1].typ = (&NTI109012);
TMP256[1].name = "prev";
TMP259[1] = &TMP256[2];
TMP256[2].kind = 1;
TMP256[2].offset = offsetof(tlistentry109014, Next);
TMP256[2].typ = (&NTI109012);
TMP256[2].name = "next";
TMP256[0].len = 2; TMP256[0].kind = 2; TMP256[0].sons = &TMP259[0];
NTI109014.node = &TMP256[0];
NTI109016.size = sizeof(tstrentry109016);
NTI109016.kind = 17;
NTI109016.base = (&NTI109014);
NTI109016.flags = 2;
TMP256[3].kind = 1;
TMP256[3].offset = offsetof(tstrentry109016, Data);
TMP256[3].typ = (&NTI142);
TMP256[3].name = "data";
NTI109016.node = &TMP256[3];
NTI109018.size = sizeof(tstrentry109016*);
NTI109018.kind = 22;
NTI109018.base = (&NTI109016);
NTI109018.flags = 2;
NTI109018.marker = TMP261;
...
TMP3572[0] = &TMP256[5];
TMP256[5].kind = 1;
TMP256[5].offset = offsetof(tlinkedlist109020, Head);
TMP256[5].typ = (&NTI109012);
TMP256[5].name = "head";
TMP3572[1] = &TMP256[6];
TMP256[6].kind = 1;
TMP256[6].offset = offsetof(tlinkedlist109020, Tail);
TMP256[6].typ = (&NTI109012);
TMP256[6].name = "tail";
TMP3572[2] = &TMP256[7];
TMP256[7].kind = 1;
TMP256[7].offset = offsetof(tlinkedlist109020, Counter);
TMP256[7].typ = (&NTI105);
TMP256[7].name = "Counter";
TMP256[4].len = 3; TMP256[4].kind = 2; TMP256[4].sons = &TMP3572[0];
NTI109020.node = &TMP256[4];
}
