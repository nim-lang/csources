...
N_NIMCALL(void, TMP4952)(void* p, NI op);
...
STRING_LITERAL(TMP4953, "$1 -> $2;$n", 11);
STRING_LITERAL(TMP4954, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP4955, "", 0);
STRING_LITERAL(TMP4956, "dot", 3);
...
N_NIMCALL(void, adddependencyaux_507028)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	addf_162635(&gdotgraph_507023, ((NimStringDesc*) &TMP4953), LOC1, 2);
}
...
N_NIMCALL(void, generatedot_507009)(NimStringDesc* project) {
	...
	LOC3 = 0;
	LOC3 = noschangeFileExt(LOC2, ((NimStringDesc*) &TMP4955));
	LOC1[0] = rope_161320(LOC3);
	LOC1[1] = gdotgraph_507023;
	LOC4 = 0;
	LOC4 = HEX25_162235(((NimStringDesc*) &TMP4954), LOC1, 2);
	LOC5 = 0;
	LOC5 = noschangeFileExt(project, ((NimStringDesc*) &TMP4956));
