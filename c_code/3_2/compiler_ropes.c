...
typedef N_CLOSURE_PTR(void, TMP3490) (NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
typedef N_CLOSURE_PTR(void, TMP3491) (NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
typedef N_CLOSURE_PTR(void, TMP3492) (NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
typedef N_CLOSURE_PTR(void, TMP3493) (NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
typedef N_CLOSURE_PTR(void, TMP4315) (NU8 err, NimStringDesc* msg, NIM_BOOL usewarning);
	...
	num = ((NI) 0);
	{
		while (1) {
			...
			if (!(i < length)) goto LA2;
			{
				...
				case 36:
				{
					add_161545(&result, ((NimStringDesc*) &TMP3489));
					i += ((NI) 1);
				}
				break;
				case 35:
				...
				case 48 ... 57:
				{
					...
					num = j;
					{
						...
						LOC20 = 0;
						LOC20 = nimIntToStr(j);
						errorhandler_161028.ClEnv? errorhandler_161028.ClPrc(((NU8) 1), LOC20, NIM_FALSE, errorhandler_161028.ClEnv):((TMP3490)(errorhandler_161028.ClPrc))(((NU8) 1), LOC20, NIM_FALSE);
					}
					goto LA16;
					LA18: ;
					{
				...
				case 123:
				{
					...
					LA27: ;
					{
						...
						errorhandler_161028.ClEnv? errorhandler_161028.ClPrc(((NU8) 1), LOC30, NIM_FALSE, errorhandler_161028.ClEnv):((TMP3491)(errorhandler_161028.ClPrc))(((NU8) 1), LOC30, NIM_FALSE);
					}
					LA25: ;
					{
						NimStringDesc* LOC35;
						...
						LOC35 = 0;
						LOC35 = nimIntToStr(j);
						errorhandler_161028.ClEnv? errorhandler_161028.ClPrc(((NU8) 1), LOC35, NIM_FALSE, errorhandler_161028.ClEnv):((TMP3492)(errorhandler_161028.ClPrc))(((NU8) 1), LOC35, NIM_FALSE);
					}
					goto LA31;
					LA33: ;
					{
				...
				default:
				{
					...
					errorhandler_161028.ClEnv? errorhandler_161028.ClPrc(((NU8) 1), LOC40, NIM_FALSE, errorhandler_161028.ClEnv):((TMP3493)(errorhandler_161028.ClPrc))(((NU8) 1), LOC40, NIM_FALSE);
				}
				break;
				}
			}
...
N_NIMCALL(void, writerope_162105)(Ropeobj161009* head, NimStringDesc* filename, NIM_BOOL usewarning) {
	...
	LA4: ;
	{
		errorhandler_161028.ClEnv? errorhandler_161028.ClPrc(((NU8) 0), filename, usewarning, errorhandler_161028.ClEnv):((TMP4315)(errorhandler_161028.ClPrc))(((NU8) 0), filename, usewarning);
	}
	LA1: ;
}
...
{	result = 0;
	...
	LOC26 = 0;
	LOC26 = readbuffer_13715(f, ((void*) ((&buf[(((NI) 0))- 0]))), ((NI) 1));
	result = (LOC26 == ((NI) 0));
	}BeforeRet: ;
	return result;
}
