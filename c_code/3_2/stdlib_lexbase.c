...
NIM_CONST TY122387 newlines_277024 = {
...
STRING_LITERAL(TMP3643, "\012", 1);
STRING_LITERAL(TMP3644, "^\012", 2);
...
N_NIMCALL(void, fillbuffer_277084)(tbaselexer277029* l) {
	...
	nimln(77, "lexbase.nim");
	{
		...
		nimln(77, "lexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP3612));
	}
	LA3: ;
	...
	nimln(79, "lexbase.nim");
	{
		...
		nimln(79, "lexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP3615));
	}
	LA7: ;
	...
	LOC13 = 0;
	LOC13 = readdata_124733((*l).Input, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP3619));
	...
	LA16: ;
	{
		...
		while (1) {
			nimln(93, "lexbase.nim");
			{
				...
				nimln(93, "lexbase.nim");
				failedassertimpl_80021(((NimStringDesc*) &TMP3623));
			}
			LA22: ;
			...
			LA29: ;
			{
				...
				nimln(105, "lexbase.nim");
				{
					...
					nimln(105, "lexbase.nim");
					failedassertimpl_80021(((NimStringDesc*) &TMP3627));
				}
				LA35: ;
				...
				LOC37 = 0;
				LOC37 = readdata_124733((*l).Input, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP3628));
...
N_NIMCALL(NI, handlecr_277062)(tbaselexer277029* l, NI pos) {
	...
	nimln(125, "lexbase.nim");
	{
		...
		nimln(125, "lexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP3635));
	}
	LA3: ;
...
N_NIMCALL(NI, handlelf_277068)(tbaselexer277029* l, NI pos) {
	...
	nimln(132, "lexbase.nim");
	{
		...
		nimln(132, "lexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP3636));
	}
	LA3: ;
...
N_NIMCALL(void, open_277039)(tbaselexer277029* l, tstream124629* input, NI buflen) {
	...
	nimln(142, "lexbase.nim");
	{
		...
		nimln(142, "lexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP3637));
	}
	LA3: ;
	nimln(143, "lexbase.nim");
	{
		...
		nimln(143, "lexbase.nim");
		failedassertimpl_80021(((NimStringDesc*) &TMP3638));
	}
	LA7: ;
...
TMP3752[0] = &TMP3610[1];
TMP3610[1].kind = 1;
TMP3610[1].offset = offsetof(tbaselexer277029, Bufpos);
TMP3610[1].typ = (&NTI106);
TMP3610[1].name = "bufpos";
TMP3752[1] = &TMP3610[2];
TMP3610[2].kind = 1;
TMP3610[2].offset = offsetof(tbaselexer277029, Buf);
TMP3610[2].typ = (&NTI145);
TMP3610[2].name = "buf";
TMP3752[2] = &TMP3610[3];
TMP3610[3].kind = 1;
TMP3610[3].offset = offsetof(tbaselexer277029, Buflen);
TMP3610[3].typ = (&NTI106);
TMP3610[3].name = "bufLen";
TMP3752[3] = &TMP3610[4];
TMP3610[4].kind = 1;
TMP3610[4].offset = offsetof(tbaselexer277029, Input);
TMP3610[4].typ = (&NTI124627);
TMP3610[4].name = "input";
TMP3752[4] = &TMP3610[5];
TMP3610[5].kind = 1;
TMP3610[5].offset = offsetof(tbaselexer277029, Linenumber);
TMP3610[5].typ = (&NTI106);
TMP3610[5].name = "lineNumber";
TMP3752[5] = &TMP3610[6];
TMP3610[6].kind = 1;
TMP3610[6].offset = offsetof(tbaselexer277029, Sentinel);
TMP3610[6].typ = (&NTI106);
TMP3610[6].name = "sentinel";
TMP3752[6] = &TMP3610[7];
TMP3610[7].kind = 1;
TMP3610[7].offset = offsetof(tbaselexer277029, Linestart);
TMP3610[7].typ = (&NTI106);
TMP3610[7].name = "lineStart";
TMP3752[7] = &TMP3610[8];
TMP3610[8].kind = 1;
TMP3610[8].offset = offsetof(tbaselexer277029, Fileopened);
TMP3610[8].typ = (&NTI134);
TMP3610[8].name = "fileOpened";
TMP3610[0].len = 8; TMP3610[0].kind = 2; TMP3610[0].sons = &TMP3752[0];
NTI277029.node = &TMP3610[0];
}
