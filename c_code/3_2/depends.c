...
STRING_LITERAL(TMP4794, "$1 -> $2;$n", 11);
STRING_LITERAL(TMP4796, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP4797, "", 0);
STRING_LITERAL(TMP4798, "dot", 3);
...
N_NIMCALL(void, adddependencyaux_603028)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	appf_177115(&gdotgraph_603023, ((NimStringDesc*) &TMP4794), LOC1, 2);
}
...
N_NIMCALL(void, generatedot_603009)(NimStringDesc* project) {
	...
	LOC3 = 0;
	LOC3 = noschangeFileExt(LOC2, ((NimStringDesc*) &TMP4797));
	LOC1[0] = torope_177076(LOC3);
	LOC1[1] = gdotgraph_603023;
	LOC4 = 0;
	LOC4 = ropef_177107(((NimStringDesc*) &TMP4796), LOC1, 2);
	LOC5 = 0;
	LOC5 = noschangeFileExt(project, ((NimStringDesc*) &TMP4798));
