...
N_NIMCALL(tnode209818*, extractrange_241825)(NU8 k, tnode209818* n, NI a, NI b) {
	tnode209818* result;
	result = 0;
	result = newnodei_211807(k, (*n).Info, (NI64)((NI64)(b - a) + 1));
	{
		NI i_241842;
		NI HEX3Atmp_241846;
		NI res_241849;
		i_241842 = 0;
		HEX3Atmp_241846 = 0;
		HEX3Atmp_241846 = (NI64)(b - a);
		res_241849 = 0;
		{
			while (1) {
				if (!(res_241849 <= HEX3Atmp_241846)) goto LA3;
				i_241842 = res_241849;
				asgnRefNoCycle((void**) (&(*result).kindU.S6.Sons->data[i_241842]), (*n).kindU.S6.Sons->data[(NI64)(i_241842 + a)]);
				res_241849 += 1;
			} LA3: ;
		}
	}
