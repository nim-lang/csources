...
extern TNimType NTI95106; /* tuple[nonDST: string, DST: string] */
...
N_NIMCALL(void, enlarge_122081)(tstringtable121810* t) {
	...
	n = (tkeyvaluepairseq121808*) newSeq((&NTI121808), (NI64)(TMP285));
	i_122124 = 0;
	HEX3Atmp_122142 = 0;
...
N_NIMCALL(tstringtable121810*, nstnewStringTableWithPairs)(NimStringDesc** keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	...
	while (1) {
		...
		nstPut(result, keyvaluepairs[i], keyvaluepairs[(NI64)(TMP297)]);
