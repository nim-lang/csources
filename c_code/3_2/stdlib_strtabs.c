...
N_NIMCALL(void, enlarge_123081)(tstringtable122810* t) {
	...
	n = (tkeyvaluepairseq122808*) newSeq((&NTI122808), (NI64)(TMP286));
	i_123124 = 0;
	HEX3Atmp_123142 = 0;
...
N_NIMCALL(tstringtable122810*, nstnewStringTableWithPairs)(NimStringDesc** keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	...
	while (1) {
		...
		nimln(176, "strtabs.nim");
		TMP298 = addInt(i, 1);
		if ((NU)((NI64)(TMP298)) >= (NU)(keyvaluepairsLen0)) raiseIndexError();
		nstPut(result, keyvaluepairs[i], keyvaluepairs[(NI64)(TMP298)]);
...
N_NIMCALL(NimStringDesc*, nstFormat)(NimStringDesc* f, tstringtable122810* t, NU8 flags) {
	...
	while (1) {
		...
		nimln(197, "strtabs.nim");
		{
			...
			nimln(198, "strtabs.nim");
			TMP299 = addInt(i, 1);
			if ((NU)((NI64)(TMP299)) > (NU)(f->Sup.len)) raiseIndexError();
			switch (((NU8)(f->data[(NI64)(TMP299)]))) {
			case 36:
			{
			...
			case 123:
			{
				...
				TMP302 = subInt(j, 1);
				LOC11 = 0;
				LOC11 = copyStrLast(f, (NI64)(TMP301), (NI64)(TMP302));
				LOC12 = 0;
...
appendString(result, LOC12);
			...
			case 95:
			{
				...
				TMP306 = subInt(j, 1);
				LOC17 = 0;
				LOC17 = copyStrLast(f, (NI64)(TMP305), (NI64)(TMP306));
				LOC18 = 0;
