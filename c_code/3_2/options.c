...
STRING_LITERAL(TMP415, "nimcache", 8);
STRING_LITERAL(TMP419, "*.babel", 7);
STRING_LITERAL(TMP421, "f.gl_pathv[i] != nil ", 21);
STRING_LITERAL(TMP422, "\012", 1);
STRING_LITERAL(TMP426, "cannot create directory: ", 25);
STRING_LITERAL(TMP428, "nim", 3);
STRING_LITERAL(TMP434, "\'\\0\' != sep ", 12);
STRING_LITERAL(TMP436, "lib", 3);
static NIM_CONST TY122387 TMP437 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x43, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP439, "true", 4);
NU32 goptions_136108;
NU32 gglobaloptions_136111;
NI8 gexitcode_136112;
NU8 gcmd_136113;
NU8 gselectedgc_136114;
tlinkedlist118023 searchpaths_136115;
tlinkedlist118023 lazypaths_136116;
...
tstringtable121810* gconfigvars_136203;
tstringtable121810* gdlloverrides_136204;
...
TY10865* commandargs_136234;
extern TNimType NTI10865; /* seq[string] */
NIM_BOOL gkeepcomments_136235;
TY10865* implicitimports_136257;
TY10865* implicitincludes_136279;
tstringtable121810* packagecache_136601;
...
N_NIMCALL(NimStringDesc*, removetrailingdirsep_136410)(NimStringDesc* path) {
	...
	nimln(206, "options.nim");
	{
		...
		LOC3 = ((NU8)(path->data[(NI64)(TMP412)]) == (NU8)(47));
		LA4: ;
		if (!LOC3) goto LA5;
		...
		nimln(207, "options.nim");
		nimln(207, "options.nim");
		TMP413 = subInt(path->Sup.len, 2);
		result = copyStrLast(path, 0, (NI64)(TMP413));
	}
	goto LA1;
	LA5: ;
	{
...
N_NIMCALL(NimStringDesc*, getgeneratedpath_136417)(void) {
	...
	LA3: ;
	{
		...
		result = HEX2F_109677(LOC6, ((NimStringDesc*) &TMP415));
	}
	LA1: ;
	popFrame();
	return result;
...
N_NIMCALL(NimStringDesc*, getpackagename_136811)(NimStringDesc* path) {
	...
	parents = 0;
	{
		...
		while (1) {
			...
			HEX3Atmp_136852 = HEX2F_109677(d_136817, ((NimStringDesc*) &TMP419));
			...
			nimln(1212, "os.nim");
			{
				...
				nimln(1213, "os.nim");
				nimln(1213, "os.nim");
				TMP420 = subInt(f_136854.gl_pathc, 1);
				HEX3Atmp_136860 = (NI64)(TMP420);
				...
				while (1) {
					...
					nimln(1214, "os.nim");
					{
						...
						nimln(1214, "os.nim");
						failedassertimpl_80021(((NimStringDesc*) &TMP421));
					}
					LA20: ;
					nimln(1215, "os.nim");
					nimln(1215, "os.nim");
	...
	nimln(245, "options.nim");
	{
		...
		nimln(245, "options.nim");
		result = copyString(((NimStringDesc*) &TMP400));
	}
	LA25: ;
	d_136835 = 0;
	nimln(227, "options.nim");
...
static N_INLINE(void, writeln_137205)(FILE* f_137209, NimStringDesc** x_137213, NI x_137213Len0) {
	...
	nimln(172, "sysio.nim");
	write_10663(f_137209, ((NimStringDesc*) &TMP422));
	popFrame();
}
...
N_NIMCALL(NimStringDesc*, completegeneratedfilepath_137001)(NimStringDesc* f, NIM_BOOL createsubdir) {
	...
	nimln(293, "options.nim");
	{
		...
		pushSafePoint(&TMP423);
		TMP423.status = setjmp(TMP423.context);
		if (TMP423.status == 0) {
...
appendString(LOC10, ((NimStringDesc*) &TMP426));
appendString(LOC10, subdir);
		...
		if (TMP423.status != 0) reraiseException();
	}
	LA4: ;
...
N_NIMCALL(NimStringDesc*, rawfindfile_137266)(NimStringDesc* f) {
	...
	it_137274 = ((tstrentry118019*) (searchpaths_136115.Head));
	...
	while (1) {
		...
		if ((*it_137274).Sup.Next) chckObj((*(*it_137274).Sup.Next).Sup.m_type, (&NTI118019));
		it_137274 = ((tstrentry118019*) ((*it_137274).Sup.Next));
	} LA1: ;
...
N_NIMCALL(NimStringDesc*, rawfindfile2_137278)(NimStringDesc* f) {
	...
	if (lazypaths_136116.Head) chckObj((*lazypaths_136116.Head).Sup.m_type, (&NTI118019));
	it = ((tstrentry118019*) (lazypaths_136116.Head));
	...
	while (1) {
		...
		nimln(321, "options.nim");
		{
			...
			bringtofront_118758(&lazypaths_136116, &it->Sup);
...
N_NIMCALL(NimStringDesc*, findmodule_137312)(NimStringDesc* modulename, NimStringDesc* currentmodule) {
	...
	m = nosaddFileExt(modulename, ((NimStringDesc*) &TMP428));
...
N_NIMCALL(void, libcandidates_137321)(NimStringDesc* s, TY10865** dest) {
	...
	nimln(346, "options.nim");
	TMP429 = addInt(le, 1);
	ri = nsuFindChar(s, 41, (NI64)(TMP429));
	nimln(347, "options.nim");
	{
		...
		nimln(348, "options.nim");
		TMP430 = subInt(le, 1);
		prefix = copyStrLast(s, 0, (NI64)(TMP430));
		nimln(349, "options.nim");
		nimln(349, "options.nim");
		nimln(349, "options.nim");
		TMP431 = addInt(ri, 1);
		suffix = copyStr(s, (NI64)(TMP431));
		middle_137332 = 0;
		HEX3Atmp_137351 = 0;
		...
		nimln(350, "options.nim");
		TMP433 = subInt(ri, 1);
		HEX3Atmp_137351 = copyStrLast(s, (NI64)(TMP432), (NI64)(TMP433));
		...
		nimln(258, "strutils.nim");
		{
			...
			nimln(258, "strutils.nim");
			failedassertimpl_80021(((NimStringDesc*) &TMP434));
		}
		LA9: ;
		nimln(259, "strutils.nim");
		{
			...
			while (1) {
				...
				nimln(264, "strutils.nim");
				nimln(264, "strutils.nim");
				TMP435 = subInt(last_137353, 1);
				middle_137332 = copyStrLast(HEX3Atmp_137351, first_137355, (NI64)(TMP435));
...
N_NIMCALL(NimStringDesc*, canondynlibname_137360)(NimStringDesc* s) {
	...
	nimln(356, "options.nim");
	{
		...
		nimln(356, "options.nim");
		LOC3 = 0;
		LOC3 = nsuStartsWith(s, ((NimStringDesc*) &TMP436));
		if (!LOC3) goto LA4;
		start = 3;
	}
	goto LA1;
	...
	ende = nsuFindCharSet(s, TMP437, 0);
	nimln(358, "options.nim");
	{
		...
		nimln(359, "options.nim");
		nimln(359, "options.nim");
		TMP438 = subInt(ende, 1);
		result = copyStrLast(s, start, (NI64)(TMP438));
	}
	goto LA7;
	LA9: ;
	{
...
N_NIMCALL(void, incldynliboverride_137369)(NimStringDesc* lib) {
	...
	nstPut(gdlloverrides_136204, LOC1, ((NimStringDesc*) &TMP439));
	popFrame();
}
...
N_NOINLINE(void, optionsInit)(void) {
	...
	LOC1 = 0;
	LOC1 = outfile_136117; outfile_136117 = copyStringRC1(((NimStringDesc*) &TMP400));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(104, "options.nim");
	LOC2 = 0;
	LOC2 = docseesrcurl_136118; docseesrcurl_136118 = copyStringRC1(((NimStringDesc*) &TMP400));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(106, "options.nim");
	LOC3 = 0;
	LOC3 = headerfile_136119; headerfile_136119 = copyStringRC1(((NimStringDesc*) &TMP400));
	if (LOC3) nimGCunrefNoCycle(LOC3);
	nimln(107, "options.nim");
	gverbosity_136120 = 1;
	nimln(110, "options.nim");
	LOC4 = 0;
	LOC4 = gevalexpr_136123; gevalexpr_136123 = copyStringRC1(((NimStringDesc*) &TMP400));
	...
	LOC5 = 0;
	LOC5 = libpath_136205; libpath_136205 = copyStringRC1(((NimStringDesc*) &TMP400));
	if (LOC5) nimGCunrefNoCycle(LOC5);
	nimln(151, "options.nim");
	LOC6 = 0;
	LOC6 = gprojectname_136206; gprojectname_136206 = copyStringRC1(((NimStringDesc*) &TMP400));
	if (LOC6) nimGCunrefNoCycle(LOC6);
	nimln(152, "options.nim");
	LOC7 = 0;
	LOC7 = gprojectpath_136207; gprojectpath_136207 = copyStringRC1(((NimStringDesc*) &TMP400));
	if (LOC7) nimGCunrefNoCycle(LOC7);
	nimln(153, "options.nim");
	LOC8 = 0;
	LOC8 = gprojectfull_136208; gprojectfull_136208 = copyStringRC1(((NimStringDesc*) &TMP400));
	if (LOC8) nimGCunrefNoCycle(LOC8);
	nimln(155, "options.nim");
	LOC9 = 0;
	LOC9 = optmainmodule_136210; optmainmodule_136210 = copyStringRC1(((NimStringDesc*) &TMP400));
	if (LOC9) nimGCunrefNoCycle(LOC9);
	nimln(156, "options.nim");
	LOC10 = 0;
	LOC10 = nimcachedir_136211; nimcachedir_136211 = copyStringRC1(((NimStringDesc*) &TMP400));
	if (LOC10) nimGCunrefNoCycle(LOC10);
	nimln(157, "options.nim");
	LOC11 = 0;
	LOC11 = command_136212; command_136212 = copyStringRC1(((NimStringDesc*) &TMP400));
	if (LOC11) nimGCunrefNoCycle(LOC11);
	nimln(158, "options.nim");
	if (commandargs_136234) nimGCunrefNoCycle(commandargs_136234);
	commandargs_136234 = (TY10865*) newSeqRC1((&NTI10865), 0);
	...
	implicitimports_136257 = (TY10865*) newSeqRC1((&NTI10865), 0);
	nimln(161, "options.nim");
	if (implicitincludes_136279) nimGCunrefNoCycle(implicitincludes_136279);
	implicitincludes_136279 = (TY10865*) newSeqRC1((&NTI10865), 0);
...
static TNimNode* TMP2008[22];
NI TMP2010;
static char* NIM_CONST TMP2009[22] = {
"optNone", 
"optObjCheck", 
"optFieldCheck", 
"optRangeCheck", 
...
NTI136010.base = 0;
NTI136010.flags = 3;
for (TMP2010 = 0; TMP2010 < 22; TMP2010++) {
TMP254[TMP2010+0].kind = 1;
TMP254[TMP2010+0].offset = TMP2010;
TMP254[TMP2010+0].name = TMP2009[TMP2010];
TMP2008[TMP2010] = &TMP254[TMP2010+0];
}
TMP254[22].len = 22; TMP254[22].kind = 2; TMP254[22].sons = &TMP2008[0];
NTI136010.node = &TMP254[22];
NTI136105.size = sizeof(NU32);
NTI136105.kind = 19;
NTI136105.base = (&NTI136010);
NTI136105.flags = 3;
TMP254[23].len = 0; TMP254[23].kind = 0;
NTI136105.node = &TMP254[23];
NTI136014.size = sizeof(NU8);
NTI136014.kind = 14;
NTI136014.base = 0;
NTI136014.flags = 3;
for (TMP3080 = 0; TMP3080 < 32; TMP3080++) {
TMP254[TMP3080+24].kind = 1;
TMP254[TMP3080+24].offset = TMP3080;
TMP254[TMP3080+24].name = TMP3079[TMP3080];
TMP3078[TMP3080] = &TMP254[TMP3080+24];
}
TMP254[56].len = 32; TMP254[56].kind = 2; TMP254[56].sons = &TMP3078[0];
NTI136014.node = &TMP254[56];
NTI136018.size = sizeof(NU8);
NTI136018.kind = 14;
NTI136018.base = 0;
NTI136018.flags = 3;
for (TMP3091 = 0; TMP3091 < 20; TMP3091++) {
TMP254[TMP3091+57].kind = 1;
TMP254[TMP3091+57].offset = TMP3091;
TMP254[TMP3091+57].name = TMP3090[TMP3091];
TMP3089[TMP3091] = &TMP254[TMP3091+57];
}
TMP254[77].len = 20; TMP254[77].kind = 2; TMP254[77].sons = &TMP3089[0];
NTI136018.node = &TMP254[77];
}
