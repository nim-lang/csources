...
N_NIMCALL(void, processimplicits_250510)(TY11065* implicits, NU8 nodekind, tpasscontext250003** a);
...
static NIM_CONST TY192025 TMP3171 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3172, "sons", 4);
STRING_LITERAL(TMP3179, "(len|len|len|len|len)(a) (==|==|==|==|==|==|==|==|==|==|==|==|="
...
N_NIMCALL(NIM_BOOL, astneeded_250081)(tsym191843* s) {
	...
	nimln(73, "passes.nim");
	{
		...
		if (!(LOC3)) goto LA8;
		nimln(76, "passes.nim");
		if (((TMP3171[(*(*s).Ast).Kind/8] &(1<<((*(*s).Ast).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3172));
...
N_NIMCALL(void, openpasses_250277)(tpasscontext250003** a, tsym191843* module) {
	...
	nimln(112, "passes.nim");
	TMP3173 = subInt(gpasseslen_250179, 1);
	HEX3Atmp_250302 = (NI64)(TMP3173);
...
N_NIMCALL(void, openpassescached_250309)(tpasscontext250003** a, tsym191843* module, trodreader240024* rd) {
	...
	nimln(118, "passes.nim");
	TMP3174 = subInt(gpasseslen_250179, 1);
	HEX3Atmp_250352 = (NI64)(TMP3174);
	nimln(1451, "system.nim");
	res_250354 = 0;
	nimln(1452, "system.nim");
	while (1) {
...
N_NIMCALL(void, closepasses_250359)(tpasscontext250003** a) {
	...
	nimln(128, "passes.nim");
	TMP3175 = subInt(gpasseslen_250179, 1);
	HEX3Atmp_250385 = (NI64)(TMP3175);
	nimln(1451, "system.nim");
	res_250387 = 0;
	nimln(1452, "system.nim");
	while (1) {
...
N_NIMCALL(NIM_BOOL, processtoplevelstmt_250392)(tnode191813* n, tpasscontext250003** a) {
	...
	nimln(135, "passes.nim");
	TMP3176 = subInt(gpasseslen_250179, 1);
	HEX3Atmp_250430 = (NI64)(TMP3176);
	nimln(1451, "system.nim");
	res_250432 = 0;
	nimln(1452, "system.nim");
	while (1) {
...
N_NIMCALL(void, processtoplevelstmtcached_250437)(tnode191813* n, tpasscontext250003** a) {
	...
	nimln(144, "passes.nim");
	TMP3177 = subInt(gpasseslen_250179, 1);
	HEX3Atmp_250463 = (NI64)(TMP3177);
	nimln(1451, "system.nim");
	res_250465 = 0;
	nimln(1452, "system.nim");
	while (1) {
...
N_NIMCALL(void, closepassescached_250470)(tpasscontext250003** a) {
	...
	nimln(149, "passes.nim");
	TMP3178 = subInt(gpasseslen_250179, 1);
	HEX3Atmp_250503 = (NI64)(TMP3178);
	nimln(1451, "system.nim");
	res_250505 = 0;
	nimln(1452, "system.nim");
	while (1) {
...
N_NIMCALL(void, processimplicits_250510)(TY11065* implicits, NU8 nodekind, tpasscontext250003** a) {
	...
	while (1) {
		...
		importstmt = newnodei_192109(nodekind, gcmdlineinfo_167103);
		nimln(158, "passes.nim");
		str = newstrnode_192095(((NU8) 20), module_250529);
		nimln(159, "passes.nim");
		(*str).Info = gcmdlineinfo_167103;
		...
		nimln(2798, "system.nim");
		{
			...
			nimln(2798, "system.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP3179));
		}
		LA9: ;
	} LA1: ;
	popFrame();
...
N_NIMCALL(void, processmodule_250049)(tsym191843* module, tllstream179204* stream, trodreader240024* rd) {
	...
	LA3: ;
	{
		...
		TMP3180 = subInt(LOC34, 1);
		HEX3Atmp_250675 = (NI64)(TMP3180);
		nimln(1451, "system.nim");
		res_250677 = 0;
		nimln(1452, "system.nim");
		while (1) {
			nimln(1452, "system.nim");
			if (!(res_250677 <= HEX3Atmp_250675)) goto LA35;
			nimln(1451, "system.nim");
			i_250655 = res_250677;
			nimln(203, "passes.nim");
			if (((TMP3171[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3172));
			...
			nimln(1454, "system.nim");
			res_250677 = addInt(res_250677, 1);
		} LA35: ;
...
static TNimNode TMP3106[1];
NTI250003.size = sizeof(tpasscontext250003);
NTI250003.kind = 17;
NTI250003.base = (&NTI2409);
NTI250003.flags = 1;
TMP3106[0].kind = 1;
TMP3106[0].offset = offsetof(tpasscontext250003, Fromcache);
TMP3106[0].typ = (&NTI134);
TMP3106[0].name = "fromCache";
NTI250003.node = &TMP3106[0];
}
