...
appendString(LOC6, LOC7);
	...
	}
	{
		...
		i_543785 = 0;
		HEX3Atmp_543796 = 0;
		HEX3Atmp_543796 = (NI64)(name->Sup.len - 1);
		res_543799 = 1;
		{
			while (1) {
				NIM_CHAR c;
...
N_NIMCALL(trope177009*, makellvmstring_543816)(NimStringDesc* s) {
	...
	res = copyString(((NimStringDesc*) &TMP3929));
	{
		...
		i_543834 = 0;
		HEX3Atmp_543847 = 0;
		HEX3Atmp_543847 = (NI64)(s->Sup.len - 1);
		res_543850 = 0;
		{
			while (1) {
				...
				{
					trope177009* LOC8;
					if (!(((NI) ((NI64)((NI64)(i_543834 + 1) % 64))) == 0)) goto LA6;
					LOC8 = 0;
...
N_NIMCALL(NI64, hashstring_543156)(NimStringDesc* s) {
	...
	result = 0;
	{
		...
		b = 0;
		{
			...
			i_543173 = 0;
			HEX3Atmp_543242 = 0;
			HEX3Atmp_543242 = (NI64)(s->Sup.len - 1);
			res_543245 = 0;
			{
				while (1) {
	...
	LA3: ;
	{
		...
		a = ((NI32) 0);
		{
			...
			i_543195 = 0;
			HEX3Atmp_543249 = 0;
			HEX3Atmp_543249 = (NI64)(s->Sup.len - 1);
			res_543252 = 0;
			{
				while (1) {
