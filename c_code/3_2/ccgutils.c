...
static NIM_CONST TY192025 TMP6187 = {
...
STRING_LITERAL(TMP6195, "", 0);
STRING_LITERAL(TMP6196, "N", 1);
STRING_LITERAL(TMP6197, "HEX", 3);
...
static N_INLINE(ttype191847*, lastson_192203)(ttype191847* n) {
	...
	if ((NU)((NI64)(TMP6192)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP6192)];
	popFrame();
	return result;
}
...
N_NIMCALL(ttype191847*, getuniquetype_469401)(ttype191847* key) {
	...
	case ((NU8) 58):
	{
		...
		internalerror_168606(((NimStringDesc*) &TMP6191));
	}
	break;
	case ((NU8) 11):
	case ((NU8) 13):
...
appendString(result, LOC2);
		...
		nimln(2807, "system.nim");
		{
			...
			nimln(2807, "system.nim");
			failedassertimpl_80621(((NimStringDesc*) &TMP6194));
		}
		LA5: ;
	} LA1: ;
...
N_NIMCALL(NimStringDesc*, mangle_469684)(NimStringDesc* name) {
	...
	result = copyString(((NimStringDesc*) &TMP6195));
	...
	case 48 ... 57:
	{
		...
		if ((NU)(0) > (NU)(name->Sup.len)) raiseIndexError();
		LOC4 = rawNewString(2);
appendString(LOC4, ((NimStringDesc*) &TMP6196));
...
appendString(LOC6, LOC7);
	...
	nimln(173, "ccgutils.nim");
	nimln(173, "ccgutils.nim");
	TMP6198 = subInt(name->Sup.len, 1);
	HEX3Atmp_469716 = (NI64)(TMP6198);
	nimln(1458, "system.nim");
	res_469718 = 1;
	nimln(1459, "system.nim");
	while (1) {
...
appendString(LOC14, ((NimStringDesc*) &TMP6197));
