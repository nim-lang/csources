	...
	LA3_: ;
	{
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				i = res;
				{
					if (!((*(*s)._Ukind.S6.sons->data[i]).kind == ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 44))) goto LA11_;
					{
						NIM_BOOL T15_;
						T15_ = (NIM_BOOL)0;
						T15_ = leValue_1Qdwg1ZguEjbL3mmgPJD3w_2((*(*s)._Ukind.S6.sons->data[i])._Ukind.S6.sons->data[((NI) 0)], elem);
						if (!(T15_)) goto LA16_;
						T15_ = leValue_1Qdwg1ZguEjbL3mmgPJD3w_2(elem, (*(*s)._Ukind.S6.sons->data[i])._Ukind.S6.sons->data[((NI) 1)]);
						LA16_: ;
						if (!T15_) goto LA17_;
						result = NIM_TRUE;
						goto BeforeRet_;
				...
				{
					{
						NIM_BOOL T22_;
						T22_ = (NIM_BOOL)0;
						T22_ = sameValue_1Qdwg1ZguEjbL3mmgPJD3w((*s)._Ukind.S6.sons->data[i], elem);
						if (!T22_) goto LA23_;
						result = NIM_TRUE;
						goto BeforeRet_;
					}
	...
	bitSetInit_9bKA1DbmAErHy3uIMkQY9bUQ(b, ((NI) (T1_)));
	{
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				i = res;
				{
					if (!((*(*s)._Ukind.S6.sons->data[i]).kind == ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 44))) goto LA8_;
					j = getOrdValue_k4X4XP9cdVXYioHD9akA9bVbQ((*(*s)._Ukind.S6.sons->data[i])._Ukind.S6.sons->data[((NI) 0)]);
					{
						while (1) {
							NI64 T12_;
							T12_ = (NI64)0;
							T12_ = getOrdValue_k4X4XP9cdVXYioHD9akA9bVbQ((*(*s)._Ukind.S6.sons->data[i])._Ukind.S6.sons->data[((NI) 1)]);
							if (!(j <= T12_)) goto LA11;
				...
				LA8_: ;
				{
					NI64 T14_;
					T14_ = (NI64)0;
					T14_ = getOrdValue_k4X4XP9cdVXYioHD9akA9bVbQ((*s)._Ukind.S6.sons->data[i]);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, overlap_GLYFox9ciWitxKuirhftGHg)(tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* a, tyObject_TNode_bROa11lyF5vxEN9aYNbHmhw* b) {
	...
	result = (NIM_BOOL)0;
	{
		if (!((*a).kind == ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 44))) goto LA3_;
		{
			...
			T9_ = (NIM_BOOL)0;
			T9_ = leValue_1Qdwg1ZguEjbL3mmgPJD3w_2((*a)._Ukind.S6.sons->data[((NI) 0)], (*b)._Ukind.S6.sons->data[((NI) 1)]);
			if (!(T9_)) goto LA10_;
			T9_ = leValue_1Qdwg1ZguEjbL3mmgPJD3w_2((*b)._Ukind.S6.sons->data[((NI) 0)], (*a)._Ukind.S6.sons->data[((NI) 1)]);
			LA10_: ;
			result = T9_;
		}
		goto LA5_;
		LA7_: ;
		{
			NIM_BOOL T12_;
			T12_ = (NIM_BOOL)0;
			T12_ = leValue_1Qdwg1ZguEjbL3mmgPJD3w_2((*a)._Ukind.S6.sons->data[((NI) 0)], b);
			if (!(T12_)) goto LA13_;
			T12_ = leValue_1Qdwg1ZguEjbL3mmgPJD3w_2(b, (*a)._Ukind.S6.sons->data[((NI) 1)]);
			LA13_: ;
			result = T12_;
		}
		LA5_: ;
	...
	{
		{
			...
			T19_ = (NIM_BOOL)0;
			T19_ = leValue_1Qdwg1ZguEjbL3mmgPJD3w_2((*b)._Ukind.S6.sons->data[((NI) 0)], a);
			if (!(T19_)) goto LA20_;
			T19_ = leValue_1Qdwg1ZguEjbL3mmgPJD3w_2(a, (*b)._Ukind.S6.sons->data[((NI) 1)]);
			LA20_: ;
			result = T19_;
		}
		goto LA15_;
