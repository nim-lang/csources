	...
	result = (tyEnum_TAnalysisResult_p9a9bcrXoRmLT4eUuwrDq9b4w)0;
	{
		...
		case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 42):
		{
			result = isPartOf_1otDDZAmvFsmbqPyFytXFg((*a).sons->data[((NI) 0)], (*b).sons->data[((NI) 0)]);
			{
				...
				T24_ = (NIM_BOOL)0;
				T25_ = (NI)0;
				T25_ = len_CdME9baJhvveuPEDZE9bXoxArenderer(a);
				T24_ = (((NI) 2) <= T25_);
				if (!(T24_)) goto LA26_;
				T27_ = (NI)0;
				T27_ = len_CdME9baJhvveuPEDZE9bXoxArenderer(b);
				T24_ = (((NI) 2) <= T27_);
				LA26_: ;
				if (!T24_) goto LA28_;
				{
					...
					if (!(T33_)) goto LA34_;
					T33_ = isDeepConstExpr_FTbvAnf1y9b9c3Krp9bsHDTiw_3((*a).sons->data[((NI) 1)]);
					LA34_: ;
					T32_ = T33_;
					if (!(T32_)) goto LA35_;
					T32_ = isDeepConstExpr_FTbvAnf1y9b9c3Krp9bsHDTiw_3((*b).sons->data[((NI) 1)]);
					LA35_: ;
					if (!T32_) goto LA36_;
					{
	...
	LA3_: ;
	{
		...
		case ((tyEnum_TNodeKind_G4E4Gxe7oI2Cm03rkiOzQw) 38):
		{
			result = ((tyEnum_TAnalysisResult_p9a9bcrXoRmLT4eUuwrDq9b4w) 0);
			{
				...
				i = (NI)0;
				colontmp_ = (NI)0;
				colontmp_ = len_CdME9baJhvveuPEDZE9bXoxArenderer(b);
				i_2 = ((NI) 1);
				{
					while (1) {
