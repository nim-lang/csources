...
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_2, "paramCount is not implemented on Nintendo Switch", 48);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_3, "paramStr is not implemented on Nintendo Switch", 46);
STRING_LITERAL(TM_yu6cxgKBBXbNsTkT9cyMd4g_4, "POSIX command line not supported", 32);
...
N_LIB_PRIVATE N_NIMCALL(NI, paramCount_5cCEQwTkCbJelL53mLWVJA)(void) {
	...
	T1_ = (NimStringDesc*)0;
	T1_ = (*e).Sup.Sup.message; (*e).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_2));
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nosgetAppFilename)(void) {
	NimStringDesc* result;
	result = (NimStringDesc*)0;
	raiseOSError_bEwAamo1N7TKcaU9akpiyIg(((NI32) -1), ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_4));
	{
					...
					while (1) {
						{
							...
							y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
							{
								...
								T16_ = (NIM_BOOL)0;
								T16_ = !(eqStrings(y, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_10)));
								if (!(T16_)) goto LA17_;
								T16_ = !(eqStrings(y, ((NimStringDesc*) &TM_yu6cxgKBBXbNsTkT9cyMd4g_11)));
								LA17_: ;
								if (!T16_) goto LA18_;
								nimZeroMem((void*)(&s), sizeof(struct stat));
								{
...
N_LIB_PRIVATE N_NIMCALL(void, nosmoveFile)(NimStringDesc* source, NimStringDesc* dest) {
	{
		...
		TM_yu6cxgKBBXbNsTkT9cyMd4g_12.status = setjmp(TM_yu6cxgKBBXbNsTkT9cyMd4g_12.context);
							...
							y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
							{
								...
								k = ((tyEnum_PathComponent_9c1SIU9cO1wHcl09b703A9cDrg) 0);
								{
									...
									case ((tyEnum_PathComponent_9c1SIU9cO1wHcl09b703A9cDrg) 0):
									{
										...
										T43_ = slash__lXoMhn1ZYc9cAJa9bfA61msg(dest, noSource);
										noscopyFile(path, T43_);
									}
									break;
									case ((tyEnum_PathComponent_9c1SIU9cO1wHcl09b703A9cDrg) 2):
									{
										...
										T45_ = slash__lXoMhn1ZYc9cAJa9bfA61msg(dest, noSource);
										noscopyDir(path, T45_);
									}
									break;
									default:
									{
								...
								LA26_: ;
								{
									int T49_;
									T49_ = (int)0;
									T49_ = lstat(nimToCStringConv(y), (&s));
								...
								kind = k;
								path = y;
								noSource_2 = substr_9bUFQ4OV1temcDF0GZp317g(path, (NI)((source ? source->Sup.len : 0) + ((NI) 1)));
								switch (kind) {
								case ((tyEnum_PathComponent_9c1SIU9cO1wHcl09b703A9cDrg) 0):
								{
									NimStringDesc* T62_;
									T62_ = (NimStringDesc*)0;
									T62_ = slash__lXoMhn1ZYc9cAJa9bfA61msg(dest, noSource_2);
									noscopyFile(path, T62_);
								}
								break;
								case ((tyEnum_PathComponent_9c1SIU9cO1wHcl09b703A9cDrg) 2):
								{
									...
									T64_ = slash__lXoMhn1ZYc9cAJa9bfA61msg(dest, noSource_2);
									noscopyDir(path, T64_);
								}
								break;
								default:
								{
