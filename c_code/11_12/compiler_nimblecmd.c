...
N_LIB_PRIVATE N_NIMCALL(void, addPathRec_zF8MHK7eYq19aFj9bmQFntWQ)(tyObject_ConfigRefcolonObjectType__LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* dir, tyObject_TLineInfo_WGx4rAexNXnczy1Avn646Q info);
...
N_LIB_PRIVATE N_NIMCALL(void, addPackage_81JUW4iTI4Oli9c6CHG79bAg)(tyObject_ConfigRefcolonObjectType__LaK09ayL9alwKUad7rts0rTw* conf, tyObject_StringTableObj_V5PVrt9bIxZEeV7lfvqqtNg* packages, NimStringDesc* p, tyObject_TLineInfo_WGx4rAexNXnczy1Avn646Q info);
...
N_LIB_PRIVATE N_NIMCALL(void, addNimblePath_2dssmu0EFJwDduwmfPARvQ)(tyObject_ConfigRefcolonObjectType__LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* p, tyObject_TLineInfo_WGx4rAexNXnczy1Avn646Q info);
...
N_LIB_PRIVATE N_NIMCALL(void, addNimblePath_2dssmu0EFJwDduwmfPARvQ)(tyObject_ConfigRefcolonObjectType__LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* p, tyObject_TLineInfo_WGx4rAexNXnczy1Avn646Q info) {
	...
	result = NIM_NIL;
	{
		...
		colontmp_ = slash__BsTQv9c9anbxt9bKmR0aN1elQ(p, ((NimStringDesc*) &TM_asNQM9aynXXg9ccUABbReyew_9));
	...
	nimbleLinks = result;
	{
		...
		T24_ = readFile_cisNPM68uOwBvpMG5Dxmkg(nimbleLinks->data[((NI) 0)]);
		...
		path = copyString(nimbleLinkLines->data[((NI) 1)]);
		{
			...
			if (!!(T27_)) goto LA28_;
			path = slash__BsTQv9c9anbxt9bKmR0aN1elQ(p, path);
		}
		LA28_: ;
	}
	LA22_: ;
	{
		...
		if (!!(T32_)) goto LA33_;
		message_5K7hPSxmIuoAwPKVN0TTEA(conf, info, ((tyEnum_TMsgKind_29cbg2fC1z5iM1PAI28kR5w) 55), path);
					...
					while (1) {
						{
							...
							y = cstrToNimstr(((NCSTRING) ((*x).d_name)));
							{
								...
								path = slash__BsTQv9c9anbxt9bKmR0aN1elQ(dir, y);
								{
								...
								k_2 = ((tyEnum_PathComponent_9c1SIU9cO1wHcl09b703A9cDrg) 0);
								{
									...
									LA34_: ;
									{
										if (!((*x).d_type == ((NI8) 10))) goto LA38_;
										{
											NIM_BOOL T42_;
											T42_ = (NIM_BOOL)0;
											T42_ = dirExists_wf0Ae3eLXw0lSNEFJMV3ognimblecmd(path);
											if (!T42_) goto LA43_;
									...
									p = y;
									{
										...
										LA49_: ;
										if (!T48_) goto LA50_;
										addPackage_81JUW4iTI4Oli9c6CHG79bAg(conf, packages, p, info);
									}
									LA50_: ;
									goto LA13;
								}
								...
								LA60_: ;
								{
									...
									if (!T63_) goto LA64_;
									k_2 = getSymlinkFileKind_4ZlT7J43hhVxIqUd9anSuBg(path);
								}
								goto LA57_;
								LA64_: ;
								LA57_: ;
...
appendString(T90_, val);
							...
							LA85_: ;
							p_2 = res_2;
							addNimblePath_2dssmu0EFJwDduwmfPARvQ(conf, p_2, info);
						}
						LA83_: ;
						res += ((NI) 1);
					} LA80: ;
...
N_LIB_PRIVATE N_NIMCALL(void, nimblePath_kR9bnkw7G6W3ncs01m68O7g)(tyObject_ConfigRefcolonObjectType__LaK09ayL9alwKUad7rts0rTw* conf, NimStringDesc* path, tyObject_TLineInfo_WGx4rAexNXnczy1Avn646Q info) {
	addPathRec_zF8MHK7eYq19aFj9bmQFntWQ(conf, path, info);
	addNimblePath_2dssmu0EFJwDduwmfPARvQ(conf, path, info);
}
