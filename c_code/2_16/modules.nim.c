...
N_LIB_PRIVATE N_NIMCALL(void, partialInitModule_eelaJUyoBMuhkxminjeGOw)(tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w* result, tyObject_ModuleGraphcolonObjectType__RZI3hCs0FTPYx8StfC81qQ* graph, NI32 fileIdx, NimStringDesc* filename) {
	...
	(*result).position = ((NI) (fileIdx));
	{
		...
		asgnRef((void**) (&(*graph).modules), (tySequence_DfgJFJEYoj4YBAHLZPl5lQ*) setLengthSeqV2(&((*graph).modules)->Sup, (&NTI_DfgJFJEYoj4YBAHLZPl5lQ_), ((NI)chckRange((NI)(TM_M5T16KOkc0tDi9bZeKl6v1w_7), ((NI) 0), ((NI) IL64(9223372036854775807))))));
	}
	LA22_: ;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w*, importModule_eaYLAZLmi86rX9aH754cWPA)(tyObject_ModuleGraphcolonObjectType__RZI3hCs0FTPYx8StfC81qQ* graph, tyObject_TSym_JpsEh5i1AcKChGYbg7aV4w* s, NI32 fileIdx) {
	...
	addDep_cCI0fqtTipEqkPEycgnc9cg(graph, s, fileIdx);
	{
		...
		T11_ = mgetOrPut_zZWWGOWkKOEGJoEiQeIHZA((&(*graph).importDeps), ((NI32)chckRange((*s).position, ((NI32) (-2147483647 -1)), ((NI32) 2147483647))), T10_);
