...
#include <stdio.h>
typedef struct ttmplparser195016 ttmplparser195016;
...
N_NIMCALL(void, newline_195039)(ttmplparser195016* p);
...
N_NIMCALL(void, scanpar_195046)(ttmplparser195016* p, NI d);
N_NOINLINE(void, raiseIndexError)(void);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NOINLINE(void, raiseOverflow)(void);
static N_INLINE(NI, subInt)(NI a, NI b);
static N_INLINE(NIM_BOOL, withinexpr_195125)(ttmplparser195016* p);
N_NIMCALL(void, parseline_195134)(ttmplparser195016* p);
...
NIM_CONST TY112118 patternchars_195036 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0xFF, 0x03,
0xFE, 0xFF, 0xFF, 0x87, 0xFE, 0xFF, 0xFF, 0x07,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP2597, "\012", 1);
STRING_LITERAL(TMP2598, "", 0);
STRING_LITERAL(TMP2599, "end", 3);
STRING_LITERAL(TMP2600, "#end", 4);
static NIM_CONST TY112118 TMP2602 = {
...
STRING_LITERAL(TMP2612, "\\n\"", 3);
STRING_LITERAL(TMP2613, "subschar", 8);
STRING_LITERAL(TMP2614, "metachar", 8);
STRING_LITERAL(TMP2615, "emit", 4);
STRING_LITERAL(TMP2616, "result.add", 10);
STRING_LITERAL(TMP2617, "conc", 4);
STRING_LITERAL(TMP2618, " & ", 3);
STRING_LITERAL(TMP2619, "tostring", 8);
...
N_NIMCALL(void, newline_195039)(ttmplparser195016* p) {
	...
	llstreamwrite_160258((*p).Outp, LOC1);	nimln(41, "filter_tmpl.nim");
	(*p).Emitpar = 0;
	nimln(42, "filter_tmpl.nim");
	{
		...
		nimln(42, "filter_tmpl.nim");
		llstreamwrite_160258((*p).Outp, ((NimStringDesc*) &TMP2597));	}	LA4: ;
	nimln(43, "filter_tmpl.nim");
	{
		...
		llstreamwrite_160258((*p).Outp, LOC10);		nimln(45, "filter_tmpl.nim");
...
N_NIMCALL(void, parseline_195134)(ttmplparser195016* p) {
	...
	LA6: ;
	{
		...
		newline_195039(p);		nimln(74, "filter_tmpl.nim");
		j = addInt(j, 1);
		...
		scanpar_195046(p, j);		nimln(83, "filter_tmpl.nim");
		nimln(83, "filter_tmpl.nim");
		LOC13 = 0;
		nimln(83, "filter_tmpl.nim");
		LOC13 = withinexpr_195125(&(*p));
		if (LOC13) goto LA14;
		nimln(83, "filter_tmpl.nim");
		LOC13 = endswithopr_160437((*p).X);
		LA14: ;
		(*p).Pendingexprline = LOC13;
		nimln(84, "filter_tmpl.nim");
		nimln(84, "filter_tmpl.nim");
		LOC15 = 0;
		LOC15 = whichkeyword_148353(keyw);
		switch (LOC15) {
		case ((NU8) 20):
		{
			NimStringDesc* LOC22;
			...
			LA19: ;
			{
				...
				localerror_137349((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP2599));			}			LA17: ;
			nimln(91, "filter_tmpl.nim");
			nimln(91, "filter_tmpl.nim");
			LOC22 = 0;
			LOC22 = nsuRepeatChar((*p).Indent, 32);
			llstreamwrite_160258((*p).Outp, LOC22);			nimln(92, "filter_tmpl.nim");
			llstreamwrite_160258((*p).Outp, ((NimStringDesc*) &TMP2600));		}		break;
		case ((NU8) 28):
		case ((NU8) 64):
		case ((NU8) 60):
		case ((NU8) 65):
		...
		case ((NU8) 39):
		{
			...
			llstreamwrite_160258((*p).Outp, LOC24);			nimln(96, "filter_tmpl.nim");
			nimln(96, "filter_tmpl.nim");
			LOC25 = 0;
			LOC25 = copyStr((*p).X, d);
			llstreamwrite_160258((*p).Outp, LOC25);			nimln(97, "filter_tmpl.nim");
		...
		case ((NU8) 24):
		{
			...
			LOC27 = 0;
			LOC27 = nsuRepeatChar((NI64)(TMP2601), 32);
			llstreamwrite_160258((*p).Outp, LOC27);			nimln(100, "filter_tmpl.nim");
			nimln(100, "filter_tmpl.nim");
			LOC28 = 0;
			LOC28 = copyStr((*p).X, d);
			llstreamwrite_160258((*p).Outp, LOC28);		}		break;
		case ((NU8) 37):
		case ((NU8) 63):
		case ((NU8) 11):
		case ((NU8) 62):
		{
			...
			llstreamwrite_160258((*p).Outp, LOC30);			nimln(103, "filter_tmpl.nim");
			nimln(103, "filter_tmpl.nim");
			LOC31 = 0;
			LOC31 = copyStr((*p).X, d);
			llstreamwrite_160258((*p).Outp, LOC31);			nimln(104, "filter_tmpl.nim");
			{
				NIM_BOOL LOC34;
		...
		default:
		{
			...
			llstreamwrite_160258((*p).Outp, LOC38);			nimln(109, "filter_tmpl.nim");
			nimln(109, "filter_tmpl.nim");
			LOC39 = 0;
			LOC39 = copyStr((*p).X, d);
			llstreamwrite_160258((*p).Outp, LOC39);		}		break;
		}
	...
	LA9: ;
	{
		...
		case ((NU8) 1):
		{
			...
			llstreamwrite_160258((*p).Outp, (*p).Conc);			nimln(122, "filter_tmpl.nim");
			llstreamwrite_160258((*p).Outp, ((NimStringDesc*) &TMP2597));			nimln(123, "filter_tmpl.nim");
			nimln(123, "filter_tmpl.nim");
			nimln(123, "filter_tmpl.nim");
			TMP2603 = addInt((*p).Indent, 2);
			LOC42 = 0;
			LOC42 = nsuRepeatChar((NI64)(TMP2603), 32);
			llstreamwrite_160258((*p).Outp, LOC42);			nimln(124, "filter_tmpl.nim");
			llstreamwrite_160258((*p).Outp, ((NimStringDesc*) &TMP2604));		}		break;
		case ((NU8) 0):
		{
			NimStringDesc* LOC44;
			nimln(126, "filter_tmpl.nim");
			newline_195039(p);			nimln(127, "filter_tmpl.nim");
			nimln(127, "filter_tmpl.nim");
			LOC44 = 0;
			LOC44 = nsuRepeatChar((*p).Indent, 32);
			llstreamwrite_160258((*p).Outp, LOC44);			nimln(128, "filter_tmpl.nim");
			llstreamwrite_160258((*p).Outp, (*p).Emit);			nimln(129, "filter_tmpl.nim");
			llstreamwrite_160258((*p).Outp, ((NimStringDesc*) &TMP2605));			nimln(130, "filter_tmpl.nim");
		...
		while (1) {
			...
			case 128 ... 255:
			{
				...
				llstreamwrite_160258((*p).Outp, ((NimStringDesc*) &TMP2606));				nimln(138, "filter_tmpl.nim");
				nimln(138, "filter_tmpl.nim");
				nimln(138, "filter_tmpl.nim");
				if ((NU)(j) > (NU)((*p).X->Sup.len)) raiseIndexError();
				LOC48 = 0;
				LOC48 = nsuToHex(((NI64) (((NU8)((*p).X->data[j])))), 2);
				llstreamwrite_160258((*p).Outp, LOC48);				nimln(139, "filter_tmpl.nim");
				j = addInt(j, 1);
			}			break;
			case 92:
			{
				nimln(141, "filter_tmpl.nim");
				llstreamwrite_160258((*p).Outp, ((NimStringDesc*) &TMP2607));				nimln(142, "filter_tmpl.nim");
				j = addInt(j, 1);
			}			break;
			case 39:
			{
				nimln(144, "filter_tmpl.nim");
				llstreamwrite_160258((*p).Outp, ((NimStringDesc*) &TMP2608));				nimln(145, "filter_tmpl.nim");
				j = addInt(j, 1);
			}			break;
			case 34:
			{
				nimln(147, "filter_tmpl.nim");
				llstreamwrite_160258((*p).Outp, ((NimStringDesc*) &TMP2609));				nimln(148, "filter_tmpl.nim");
				j = addInt(j, 1);
			}			break;
			default:
			{
				nimln(150, "filter_tmpl.nim");
				{
					...
					case 123:
					{
						...
						llstreamwrite_160263((*p).Outp, 34);						nimln(157, "filter_tmpl.nim");
						llstreamwrite_160258((*p).Outp, (*p).Conc);						nimln(158, "filter_tmpl.nim");
						llstreamwrite_160258((*p).Outp, (*p).Tostr);						nimln(159, "filter_tmpl.nim");
						llstreamwrite_160263((*p).Outp, 40);						nimln(160, "filter_tmpl.nim");
						j = addInt(j, 1);
						...
						while (1) {
							...
							case 0:
							{
								...
								localerror_137349((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP2610));								nimln(166, "filter_tmpl.nim");
								goto LA58;
							}							break;
							case 123:
							{
								...
								llstreamwrite_160263((*p).Outp, 123);							}							break;
							case 125:
							{
								...
								llstreamwrite_160263((*p).Outp, 125);							}							break;
							default:
							{
								nimln(177, "filter_tmpl.nim");
								if ((NU)(j) > (NU)((*p).X->Sup.len)) raiseIndexError();
								llstreamwrite_160263((*p).Outp, (*p).X->data[j]);								nimln(178, "filter_tmpl.nim");
								j = addInt(j, 1);
							}							break;
							}
						} LA58: ;
						nimln(179, "filter_tmpl.nim");
						llstreamwrite_160263((*p).Outp, 41);						nimln(180, "filter_tmpl.nim");
						llstreamwrite_160258((*p).Outp, (*p).Conc);						nimln(181, "filter_tmpl.nim");
						llstreamwrite_160263((*p).Outp, 34);					}					break;
					case 97 ... 122:
					case 65 ... 90:
					case 128 ... 255:
					{
						nimln(183, "filter_tmpl.nim");
						llstreamwrite_160263((*p).Outp, 34);						nimln(184, "filter_tmpl.nim");
						llstreamwrite_160258((*p).Outp, (*p).Conc);						nimln(185, "filter_tmpl.nim");
						llstreamwrite_160258((*p).Outp, (*p).Tostr);						nimln(186, "filter_tmpl.nim");
						llstreamwrite_160263((*p).Outp, 40);						nimln(187, "filter_tmpl.nim");
						while (1) {
							nimln(730, "system.nim");
							if ((NU)(j) > (NU)((*p).X->Sup.len)) raiseIndexError();
							...
							if ((NU)(j) > (NU)((*p).X->Sup.len)) raiseIndexError();
							llstreamwrite_160263((*p).Outp, (*p).X->data[j]);							nimln(189, "filter_tmpl.nim");
							j = addInt(j, 1);
						} LA72: ;
						nimln(190, "filter_tmpl.nim");
						llstreamwrite_160263((*p).Outp, 41);						nimln(191, "filter_tmpl.nim");
						llstreamwrite_160258((*p).Outp, (*p).Conc);						nimln(192, "filter_tmpl.nim");
						llstreamwrite_160263((*p).Outp, 34);					}					break;
					default:
					{
						nimln(194, "filter_tmpl.nim");
						{
							...
							llstreamwrite_160263((*p).Outp, (*p).Subschar);							nimln(196, "filter_tmpl.nim");
							j = addInt(j, 1);
						}						goto LA74;
						LA76: ;
						{
							...
							localerror_137349((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP2611));						}						LA74: ;
					}					break;
					}
				}				goto LA53;
				LA55: ;
				{
					...
					if ((NU)(j) > (NU)((*p).X->Sup.len)) raiseIndexError();
					llstreamwrite_160263((*p).Outp, (*p).X->data[j]);					nimln(202, "filter_tmpl.nim");
					j = addInt(j, 1);
				}				LA53: ;
			}			break;
			}
		...
		llstreamwrite_160258((*p).Outp, ((NimStringDesc*) &TMP2612));	}	LA2: ;
	popFrame();
}
static N_INLINE(tlineinfo135509, newlineinfo_135985)(NimStringDesc* filename, NI line, NI col) {
...
N_NIMCALL(tllstream160204*, filtertmpl_195006)(tllstream160204* stdin_195008, NimStringDesc* filename, tnode170659* call) {
	...
	p.Info = newlineinfo_135985(filename, 0, 0);
	nimln(208, "filter_tmpl.nim");
	p.Outp = llstreamopen_160218(((NimStringDesc*) &TMP2598));
	nimln(209, "filter_tmpl.nim");
	p.Inp = stdin_195008;
	nimln(210, "filter_tmpl.nim");
	p.Subschar = chararg_194014(call, ((NimStringDesc*) &TMP2613), 1, 36);
	nimln(211, "filter_tmpl.nim");
	p.Nimdirective = chararg_194014(call, ((NimStringDesc*) &TMP2614), 2, 35);
	nimln(212, "filter_tmpl.nim");
	p.Emit = strarg_194021(call, ((NimStringDesc*) &TMP2615), 3, ((NimStringDesc*) &TMP2616));
	nimln(213, "filter_tmpl.nim");
	p.Conc = strarg_194021(call, ((NimStringDesc*) &TMP2617), 4, ((NimStringDesc*) &TMP2618));
	nimln(214, "filter_tmpl.nim");
	p.Tostr = strarg_194021(call, ((NimStringDesc*) &TMP2619), 5, ((NimStringDesc*) &TMP2611));
	...
	while (1) {
		...
		nimln(216, "filter_tmpl.nim");
		LOC2 = 0;
		LOC2 = llstreamreadline_160248(p.Inp, &p.X);
		if (!LOC2) goto LA1;
		nimln(217, "filter_tmpl.nim");
		nimln(217, "filter_tmpl.nim");
		TMP2620 = addInt(p.Info.Line, ((NI16) 1));
		if (TMP2620 < -32768 || TMP2620 > 32767) raiseOverflow();
		p.Info.Line = (NI16)(TMP2620);
		nimln(218, "filter_tmpl.nim");
		parseline_195134(&p);	} LA1: ;
	nimln(219, "filter_tmpl.nim");
	newline_195039(&p);	nimln(220, "filter_tmpl.nim");
	result = p.Outp;
	nimln(221, "filter_tmpl.nim");
	llstreamclose_160238(p.Inp);	popFrame();
	return result;
