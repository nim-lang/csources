...
typedef struct trendercontext277198 trendercontext277198;
...
typedef NIM_CHAR TY277242[9];
struct trendercontext277198 {
NI Indent;
NI Verbatim;
};
...
N_NIMCALL(void, renderrstsons_277210)(trendercontext277198* d, trstnode277018* n, NimStringDesc** result);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NIMCALL(void, renderrsttorst_277202)(trendercontext277198* d, trstnode277018* n, NimStringDesc** result);
...
N_NIMCALL(void, renderrsttorst_277445)(trstnode277018* n, NimStringDesc** result);
NIM_CONST TY277242 lvltochar_277241 = {33,
61,
45,
126,
96,
...
TNimType NTI277018; /* TRSTNode */
TNimType NTI277012; /* TRstNodeKind */
extern TNimType NTI142; /* string */
extern TNimType NTI105; /* int */
extern TNimType NTI277093; /* seq[PRSTNode] */
TNimType NTI277014; /* PRSTNode */
...
N_NIMCALL(trstnode277018*, newrstnode_277103)(NU8 kind) {
	...
	result = 0;
	nimln(78, "rstast.nim");
	result = (trstnode277018*) newObj((&NTI277014), sizeof(trstnode277018));
	nimln(79, "rstast.nim");
	if ((*result).Sons) nimGCunrefNoCycle((*result).Sons);
	(*result).Sons = (TY277093*) newSeqRC1((&NTI277093), 0);
	nimln(80, "rstast.nim");
	(*result).Kind = kind;
	popFrame();
	return result;
...
N_NIMCALL(void, add_277159)(trstnode277018* father, trstnode277018* son) {
	...
	nimln(90, "rstast.nim");
	(*father).Sons = (TY277093*) incrSeq(&((*father).Sons)->Sup, sizeof(trstnode277018*));
...
N_NIMCALL(void, renderrstsons_277210)(trendercontext277198* d, trstnode277018* n, NimStringDesc** result) {
	...
	HEX3Atmp_277227 = (NI64)(TMP3873);
	nimln(1301, "system.nim");
	res_277229 = 0;
	nimln(1302, "system.nim");
	while (1) {
		nimln(1302, "system.nim");
		if (!(res_277229 <= HEX3Atmp_277227)) goto LA2;
		nimln(1301, "system.nim");
		i_277226 = res_277229;
		nimln(105, "rstast.nim");
		if ((NU)(i_277226) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
		renderrsttorst_277202(d, (*n).Sons->data[i_277226], result);		nimln(1304, "system.nim");
		res_277229 = addInt(res_277229, 1);
	} LA2: ;
	popFrame();
}
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src) {
...
N_NIMCALL(void, renderrsttorst_277202)(trendercontext277198* d, trstnode277018* n, NimStringDesc** result) {
	...
	case ((NU8) 0):
	{
		...
		renderrstsons_277210(d, n, result);	}	break;
	case ((NU8) 1):
	{
		NI oldlen;
		NI headlinelen;
...
appendString((*result), ind);
		...
		renderrstsons_277210(d, n, result);		nimln(123, "rstast.nim");
...
appendString((*result), ind);
		...
		LOC7 = 0;
		LOC7 = nsuRepeatChar(headlinelen, lvltochar_277241[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		renderrstsons_277210(d, n, &headline);		nimln(135, "rstast.nim");
		nimln(135, "rstast.nim");
		nimln(135, "rstast.nim");
		TMP3877 = subInt(headline->Sup.len, (*d).Indent);
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI64)(TMP3877), lvltochar_277241[((*n).Level)- 0]);
...
appendString((*result), ind);
	...
	case ((NU8) 6):
	{
		...
		renderrstsons_277210(d, n, &tmp);		nimln(156, "rstast.nim");
		{
...
appendString((*result), tmp);
	...
	case ((NU8) 8):
	{
		...
		renderrstsons_277210(d, n, &tmp);		nimln(166, "rstast.nim");
		{
			nimln(706, "system.nim");
...
appendString((*result), ((NimStringDesc*) &TMP3882));
		...
		renderrstsons_277210(d, n, result);		nimln(186, "rstast.nim");
		(*d).Indent = subInt((*d).Indent, 2);
	}	break;
	case ((NU8) 14):
	{
		...
		if ((NU)(0) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
		renderrsttorst_277202(d, (*n).Sons->data[0], &tmp);		nimln(191, "rstast.nim");
...
appendString((*result), LOC30);
		...
		renderrsttorst_277202(d, (*n).Sons->data[1], result);		nimln(202, "rstast.nim");
...
appendString((*result), ((NimStringDesc*) &TMP3886));
	...
	case ((NU8) 28):
	{
		...
		renderrstsons_277210(d, n, result);		nimln(211, "rstast.nim");
		(*d).Indent = subInt((*d).Indent, 2);
	}	break;
	case ((NU8) 39):
	{
...
appendString((*result), ((NimStringDesc*) &TMP3887));
		...
		renderrstsons_277210(d, n, result);		nimln(215, "rstast.nim");
		(*result) = resizeString((*result), 2);
appendString((*result), ((NimStringDesc*) &TMP3888));
	...
	case ((NU8) 38):
	{
		...
		if ((NU)(0) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
		renderrsttorst_277202(d, (*n).Sons->data[0], result);		nimln(219, "rstast.nim");
		(*result) = resizeString((*result), 2);
appendString((*result), ((NimStringDesc*) &TMP3889));
		nimln(220, "rstast.nim");
		if ((NU)(1) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
		renderrsttorst_277202(d, (*n).Sons->data[1], result);		nimln(221, "rstast.nim");
...
appendString((*result), ((NimStringDesc*) &TMP3890));
	...
	case ((NU8) 53):
	{
		...
		if ((NU)(0) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
		renderrsttorst_277202(d, (*n).Sons->data[0], result);		nimln(225, "rstast.nim");
		(*result) = resizeString((*result), 2);
appendString((*result), ((NimStringDesc*) &TMP3891));
		nimln(226, "rstast.nim");
		if ((NU)(1) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
		renderrsttorst_277202(d, (*n).Sons->data[1], result);		nimln(227, "rstast.nim");
		(*result) = addChar((*result), 58);
	}	break;
	case ((NU8) 54):
	{
		...
		renderrstsons_277210(d, n, result);		nimln(231, "rstast.nim");
...
appendString((*result), ((NimStringDesc*) &TMP3892));
	...
	case ((NU8) 55):
	{
		...
		renderrstsons_277210(d, n, result);		nimln(235, "rstast.nim");
		(*result) = resizeString((*result), 6);
appendString((*result), ((NimStringDesc*) &TMP3893));
	...
	case ((NU8) 56):
	{
		...
		renderrstsons_277210(d, n, result);		nimln(239, "rstast.nim");
		(*result) = resizeString((*result), 6);
...
appendString((*result), ((NimStringDesc*) &TMP3895));
		...
		renderrstsons_277210(d, n, result);		nimln(243, "rstast.nim");
		(*result) = resizeString((*result), 1);
appendString((*result), ((NimStringDesc*) &TMP3895));
	}	break;
	case ((NU8) 58):
...
appendString((*result), ((NimStringDesc*) &TMP3896));
		...
		renderrstsons_277210(d, n, result);		nimln(247, "rstast.nim");
		(*result) = resizeString((*result), 2);
appendString((*result), ((NimStringDesc*) &TMP3896));
	}	break;
	case ((NU8) 59):
...
appendString((*result), ((NimStringDesc*) &TMP3897));
		...
		renderrstsons_277210(d, n, result);		nimln(251, "rstast.nim");
		(*result) = resizeString((*result), 3);
appendString((*result), ((NimStringDesc*) &TMP3897));
	}	break;
	case ((NU8) 60):
	{
		...
		renderrstsons_277210(d, n, result);		nimln(255, "rstast.nim");
		(*result) = addChar((*result), 96);
	}	break;
	case ((NU8) 61):
	{
...
appendString((*result), ((NimStringDesc*) &TMP3898));
		...
		renderrstsons_277210(d, n, result);		nimln(260, "rstast.nim");
		(*result) = resizeString((*result), 2);
appendString((*result), ((NimStringDesc*) &TMP3898));
...
appendString((*result), ((NimStringDesc*) &TMP3901));
		...
		nimln(275, "rstast.nim");
		{
			...
			nimln(275, "rstast.nim");
			if ((NU)(2) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
			renderrstsons_277210(d, (*n).Sons->data[2], result);		}		LA56: ;
...
appendString((*result), ((NimStringDesc*) &TMP3902));
	...
	default:
	{
		...
		LOC60 = 0;
		nimln(282, "rstast.nim");
		LOC60 = rawNewString(reprEnum((*n).Kind, (&NTI277012))->Sup.len + 22);
appendString(LOC60, ((NimStringDesc*) &TMP3903));
appendString(LOC60, reprEnum((*n).Kind, (&NTI277012)));
...
N_NIMCALL(void, renderrsttorst_277445)(trstnode277018* n, NimStringDesc** result) {
	trendercontext277198 d;
	nimfr("renderRstToRst", "rstast.nim")
	memset((void*)&d, 0, sizeof(d));
	nimln(287, "rstast.nim");
	renderrsttorst_277202(&d, n, result);	popFrame();
...
NTI277018.size = sizeof(trstnode277018);
NTI277018.kind = 18;
NTI277018.base = 0;
NTI277018.flags = 2;
TMP3866[0] = &TMP3864[1];
NTI277012.size = sizeof(NU8);
NTI277012.kind = 14;
NTI277012.base = 0;
NTI277012.flags = 3;
...
NTI277012.node = &TMP3864[67];
TMP3864[1].kind = 1;
TMP3864[1].offset = offsetof(trstnode277018, Kind);
TMP3864[1].typ = (&NTI277012);
TMP3864[1].name = "kind";
TMP3866[1] = &TMP3864[68];
TMP3864[68].kind = 1;
TMP3864[68].offset = offsetof(trstnode277018, Text);
TMP3864[68].typ = (&NTI142);
TMP3864[68].name = "text";
TMP3866[2] = &TMP3864[69];
TMP3864[69].kind = 1;
TMP3864[69].offset = offsetof(trstnode277018, Level);
TMP3864[69].typ = (&NTI105);
TMP3864[69].name = "level";
TMP3866[3] = &TMP3864[70];
TMP3864[70].kind = 1;
TMP3864[70].offset = offsetof(trstnode277018, Sons);
TMP3864[70].typ = (&NTI277093);
TMP3864[70].name = "sons";
TMP3864[0].len = 4; TMP3864[0].kind = 2; TMP3864[0].sons = &TMP3866[0];
NTI277018.node = &TMP3864[0];
NTI277014.size = sizeof(trstnode277018*);
NTI277014.kind = 22;
NTI277014.base = (&NTI277018);
NTI277014.flags = 2;
NTI277014.marker = TMP3871;
}
