...
43}
;
STRING_LITERAL(TMP3869, "\012", 1);
STRING_LITERAL(TMP3871, "", 0);
STRING_LITERAL(TMP3873, "\012\012", 2);
STRING_LITERAL(TMP3875, "* ", 2);
STRING_LITERAL(TMP3876, "(#) ", 4);
STRING_LITERAL(TMP3877, "  ", 2);
STRING_LITERAL(TMP3881, "| ", 2);
STRING_LITERAL(TMP3882, "`", 1);
STRING_LITERAL(TMP3883, "`_", 2);
STRING_LITERAL(TMP3884, " <", 2);
STRING_LITERAL(TMP3885, ">`_", 3);
STRING_LITERAL(TMP3886, "`:", 2);
STRING_LITERAL(TMP3887, "`:sub:", 6);
STRING_LITERAL(TMP3888, "`:sup:", 6);
STRING_LITERAL(TMP3889, "`:idx:", 6);
STRING_LITERAL(TMP3890, "*", 1);
STRING_LITERAL(TMP3891, "**", 2);
STRING_LITERAL(TMP3892, "***", 3);
STRING_LITERAL(TMP3893, "``", 2);
STRING_LITERAL(TMP3894, "\\", 1);
STRING_LITERAL(TMP3895, "\\\\", 2);
STRING_LITERAL(TMP3896, ".. index::\012", 11);
STRING_LITERAL(TMP3897, ".. contents::", 13);
STRING_LITERAL(TMP3898, "Error: cannot render: ", 22);
...
N_NIMCALL(trstnode278018*, lastson_278145)(trstnode278018* n) {
	...
	nimln(87, "rstast.nim");
	nimln(87, "rstast.nim");
	TMP3867 = subInt((*n).Sons->Sup.len, 1);
	if ((NU)((NI64)(TMP3867)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP3867)];
	popFrame();
	return result;
}
static N_INLINE(void, asgnRefNoCycle)(void** dest, void* src) {
...
N_NIMCALL(void, renderrstsons_278210)(trendercontext278198* d, trstnode278018* n, NimStringDesc** result) {
	...
	LOC1 = 0;
	LOC1 = len_278089(n);
	TMP3868 = subInt(LOC1, 1);
	HEX3Atmp_278227 = (NI64)(TMP3868);
...
appendString((*result), ((NimStringDesc*) &TMP3869));
...
appendString((*result), ind);
		...
		nimln(123, "rstast.nim");
		TMP3870 = subInt((*result)->Sup.len, oldlen);
		headlinelen = (NI64)(TMP3870);
...
appendString((*result), ind);
		...
		headline = copyString(((NimStringDesc*) &TMP3871));
		nimln(133, "rstast.nim");
		renderrstsons_278210(d, n, &headline);		nimln(135, "rstast.nim");
		nimln(135, "rstast.nim");
		nimln(135, "rstast.nim");
		TMP3872 = subInt(headline->Sup.len, (*d).Indent);
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI64)(TMP3872), lvltochar_278241[((*n).Level)- 0]);
...
appendString((*result), ((NimStringDesc*) &TMP3873));
...
appendString((*result), ind);
		...
		nimln(146, "rstast.nim");
		nimln(146, "rstast.nim");
		TMP3874 = subInt(78, (*d).Indent);
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI64)(TMP3874), 45);
...
appendString((*result), ind);
	...
	case ((NU8) 6):
	{
		...
		tmp = copyString(((NimStringDesc*) &TMP3871));
...
appendString((*result), ((NimStringDesc*) &TMP3877));
	...
	case ((NU8) 14):
	{
		...
		nimln(191, "rstast.nim");
		nimln(191, "rstast.nim");
		TMP3878 = addInt(tmp->Sup.len, 3);
		l = (((NI64)(TMP3878) >= 30) ? (NI64)(TMP3878) : 30);
...
appendString((*result), tmp);
		...
		nimln(199, "rstast.nim");
		nimln(199, "rstast.nim");
		TMP3879 = subInt(l, tmp->Sup.len);
		TMP3880 = subInt((NI64)(TMP3879), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI64)(TMP3880), 32);
...
appendString((*result), (*n).Text);
	...
	case ((NU8) 64):
	{
		nimln(265, "rstast.nim");
		{
			...
			if (!(LOC48)) goto LA49;
			nimln(265, "rstast.nim");
			LOC48 = eqStrings((*n).Text, ((NimStringDesc*) &TMP3894));
			LA49: ;
			if (!LOC48) goto LA50;
...
appendString(LOC60, ((NimStringDesc*) &TMP3898));
...
static TNimNode* TMP3861[4];
static TNimNode* TMP3862[65];
NI TMP3864;
static char* NIM_CONST TMP3863[65] = {
"rnInner", 
"rnHeadline", 
"rnOverline", 
"rnTransition", 
...
NTI278012.base = 0;
NTI278012.flags = 3;
for (TMP3864 = 0; TMP3864 < 65; TMP3864++) {
TMP3859[TMP3864+2].kind = 1;
TMP3859[TMP3864+2].offset = TMP3864;
TMP3859[TMP3864+2].name = TMP3863[TMP3864];
TMP3862[TMP3864] = &TMP3859[TMP3864+2];
}
TMP3859[67].len = 65; TMP3859[67].kind = 2; TMP3859[67].sons = &TMP3862[0];
NTI278012.node = &TMP3859[67];
TMP3859[1].kind = 1;
TMP3859[1].offset = offsetof(trstnode278018, Kind);
TMP3859[1].typ = (&NTI278012);
TMP3859[1].name = "kind";
TMP3861[1] = &TMP3859[68];
TMP3859[68].kind = 1;
TMP3859[68].offset = offsetof(trstnode278018, Text);
TMP3859[68].typ = (&NTI142);
TMP3859[68].name = "text";
TMP3861[2] = &TMP3859[69];
TMP3859[69].kind = 1;
TMP3859[69].offset = offsetof(trstnode278018, Level);
TMP3859[69].typ = (&NTI105);
TMP3859[69].name = "level";
TMP3861[3] = &TMP3859[70];
TMP3859[70].kind = 1;
TMP3859[70].offset = offsetof(trstnode278018, Sons);
TMP3859[70].typ = (&NTI278093);
TMP3859[70].name = "sons";
TMP3859[0].len = 4; TMP3859[0].kind = 2; TMP3859[0].sons = &TMP3861[0];
NTI278018.node = &TMP3859[0];
NTI278014.size = sizeof(trstnode278018*);
NTI278014.kind = 22;
NTI278014.base = (&NTI278018);
NTI278014.flags = 2;
NTI278014.marker = TMP3866;
}
