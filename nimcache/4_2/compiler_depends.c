...
static NIM_CONST TY171865 TMP7011 = {
...
N_NIMCALL(void, adddependencyaux_414019)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	appf_121085(&gdotgraph_414016, ((NimStringDesc*) &TMP7010), LOC1, 2);	popFrame();
}
static N_INLINE(NI, sonslen_172022)(tnode171659* n) {
	NI result;
...
NTI414011.flags = 2;
TMP7008[0].kind = 1;
TMP7008[0].offset = offsetof(tgen414011, Module);
TMP7008[0].typ = (&NTI171657);
TMP7008[0].name = "module";
NTI414011.node = &TMP7008[0];
NTI414013.size = sizeof(tgen414011*);
NTI414013.kind = 22;
NTI414013.base = (&NTI414011);
NTI414013.flags = 2;
NTI414013.marker = TMP7018;
}
