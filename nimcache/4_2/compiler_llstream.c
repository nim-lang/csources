...
N_NIMCALL(NIM_BOOL, endswithopr_161437)(NimStringDesc* x) {
	...
	result = endswith_161402(x, TMP1605);
	popFrame();
	return result;
}
static N_INLINE(NIM_BOOL, continueline_161443)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_161402(line, TMP1606);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(NI, counttriples_161462)(NimStringDesc* s) {
	...
	while (1) {
		...
		nimln(109, "llstream.nim");
		{
			...
			LOC5 = ((NU8)(s->data[(NI64)(TMP1607)]) == (NU8)(34));
			LA6: ;
			LOC4 = LOC5;
			if (!(LOC4)) goto LA7;
			nimln(109, "llstream.nim");
			nimln(109, "llstream.nim");
			TMP1608 = addInt(i, 2);
			if ((NU)((NI64)(TMP1608)) > (NU)(s->Sup.len)) raiseIndexError();
			LOC4 = ((NU8)(s->data[(NI64)(TMP1608)]) == (NU8)(34));
			LA7: ;
			if (!LOC4) goto LA8;
...
N_NIMCALL(NI, llstreamread_161242)(tllstream161204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		result = ((buflen <= (NI64)(TMP1613)) ? buflen : (NI64)(TMP1613));
		nimln(136, "llstream.nim");
		{
			...
			if ((NU)((NI64)(TMP1614)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) (&(*s).S->data[(NI64)(TMP1614)])), result);			nimln(138, "llstream.nim");
			(*s).Rd = addInt((*s).Rd, result);
		}		LA5: ;
	}	break;
	case ((NU8) 2):
...
N_NIMCALL(void, llstreamwriteln_161274)(tllstream161204* s, NimStringDesc* data) {
	...
	llstreamwrite_161258(s, ((NimStringDesc*) &TMP1611));	popFrame();
}
N_NIMCALL(void, llstreamwrite_161263)(tllstream161204* s, NIM_CHAR data) {
	NIM_CHAR c;
	nimfr("LLStreamWrite", "llstream.nim")
...
N_NIMCALL(void, llstreamwrite_161268)(tllstream161204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(199, "llstream.nim");
		{
			...
			(*s).S = setLengthStr((*s).S, (NI64)(TMP1615));
			nimln(201, "llstream.nim");
			nimln(201, "llstream.nim");
			TMP1616 = addInt(0, (*s).Wr);
			if ((NU)((NI64)(TMP1616)) > (NU)((*s).S->Sup.len)) raiseIndexError();
			memcpy(((void*) (&(*s).S->data[(NI64)(TMP1616)])), buf, buflen);			nimln(202, "llstream.nim");
...
N_NIMCALL(NimStringDesc*, llstreamreadall_161254)(tllstream161204* s) {
	...
	case ((NU8) 2):
	{
		...
		while (1) {
			...
			result = setLengthStr(result, (NI64)(TMP1617));
			nimln(223, "llstream.nim");
			nimln(223, "llstream.nim");
			TMP1618 = addInt(i, 0);
			if ((NU)((NI64)(TMP1618)) > (NU)(result->Sup.len)) raiseIndexError();
			bytes = readbuffer_9514((*s).F, ((void*) (&result->data[(NI64)(TMP1618)])), 2048);
...
NTI161202.node = &TMP1596[6];
TMP1596[1].kind = 1;
TMP1596[1].offset = offsetof(tllstream161204, Kind);
TMP1596[1].typ = (&NTI161202);
TMP1596[1].name = "kind";
TMP1598[1] = &TMP1596[7];
TMP1596[7].kind = 1;
TMP1596[7].offset = offsetof(tllstream161204, F);
TMP1596[7].typ = (&NTI9004);
TMP1596[7].name = "f";
TMP1598[2] = &TMP1596[8];
TMP1596[8].kind = 1;
TMP1596[8].offset = offsetof(tllstream161204, S);
TMP1596[8].typ = (&NTI142);
TMP1596[8].name = "s";
TMP1598[3] = &TMP1596[9];
TMP1596[9].kind = 1;
TMP1596[9].offset = offsetof(tllstream161204, Rd);
TMP1596[9].typ = (&NTI105);
TMP1596[9].name = "rd";
TMP1598[4] = &TMP1596[10];
TMP1596[10].kind = 1;
TMP1596[10].offset = offsetof(tllstream161204, Wr);
TMP1596[10].typ = (&NTI105);
TMP1596[10].name = "wr";
TMP1598[5] = &TMP1596[11];
TMP1596[11].kind = 1;
TMP1596[11].offset = offsetof(tllstream161204, Lineoffset);
TMP1596[11].typ = (&NTI105);
TMP1596[11].name = "lineOffset";
TMP1596[0].len = 6; TMP1596[0].kind = 2; TMP1596[0].sons = &TMP1598[0];
NTI161204.node = &TMP1596[0];
NTI161206.size = sizeof(tllstream161204*);
NTI161206.kind = 22;
NTI161206.base = (&NTI161204);
NTI161206.flags = 2;
NTI161206.marker = TMP1602;
}
