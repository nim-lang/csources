...
N_NIMCALL(void, fillbuffer_291071)(tbaselexer291016* l) {
	...
	nimln(80, "lexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI32)(TMP4640)])), (NI32)(TMP4641));	}	LA11: ;
	...
	TMP4643 = mulInt((NI32)(TMP4642), 1);
	LOC13 = 0;
	LOC13 = readdata_143731((*l).Input, ((void*) (&(*l).Buf[tocopy])), (NI32)(TMP4643));
	TMP4644 = divInt(LOC13, 1);
	charsread = (NI32)(TMP4644);
	...
	nimln(86, "lexbase.nim");
	{
		...
		if (!(charsread < (NI32)(TMP4646))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI32)(TMP4648);
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				TMP4649 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4007(((void*) ((*l).Buf)), (NI32)(TMP4649));
				...
				nimln(105, "lexbase.nim");
				{
					...
					if (!!(((NI32)(TMP4650) == oldbuflen))) goto LA35;
					nimln(105, "lexbase.nim");
				...
				LOC37 = 0;
				LOC37 = readdata_143731((*l).Input, ((void*) (&(*l).Buf[oldbuflen])), (NI32)(TMP4652));
				TMP4653 = divInt(LOC37, 1);
				charsread = (NI32)(TMP4653);
...
N_NIMCALL(void, open_291026)(tbaselexer291016* l, tstream143629* input, NI buflen) {
	...
	LOC9 = 0;
	LOC9 = alloc_4001((NI32)(TMP4663));
	(*l).Buf = ((NCSTRING) (LOC9));
	nimln(148, "lexbase.nim");
	nimln(148, "lexbase.nim");
	TMP4664 = subInt(buflen, 1);
	(*l).Sentinel = (NI32)(TMP4664);
...
N_NIMCALL(NI, getcolnumber_291044)(tbaselexer291016* l, NI pos) {
	...
	if ((NI32)(TMP4665) == (-2147483647 -1)) raiseOverflow();
	result = (NI32)abs((NI32)(TMP4665));
	popFrame();
	return result;
}
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src) {
...
TMP4775[0] = &TMP4634[1];
TMP4634[1].kind = 1;
TMP4634[1].offset = offsetof(tbaselexer291016, Bufpos);
TMP4634[1].typ = (&NTI105);
TMP4634[1].name = "bufpos";
TMP4775[1] = &TMP4634[2];
TMP4634[2].kind = 1;
TMP4634[2].offset = offsetof(tbaselexer291016, Buf);
TMP4634[2].typ = (&NTI144);
TMP4634[2].name = "buf";
TMP4775[2] = &TMP4634[3];
TMP4634[3].kind = 1;
TMP4634[3].offset = offsetof(tbaselexer291016, Buflen);
TMP4634[3].typ = (&NTI105);
TMP4634[3].name = "bufLen";
TMP4775[3] = &TMP4634[4];
TMP4634[4].kind = 1;
TMP4634[4].offset = offsetof(tbaselexer291016, Input);
TMP4634[4].typ = (&NTI143627);
TMP4634[4].name = "input";
TMP4775[4] = &TMP4634[5];
TMP4634[5].kind = 1;
TMP4634[5].offset = offsetof(tbaselexer291016, Linenumber);
TMP4634[5].typ = (&NTI105);
TMP4634[5].name = "LineNumber";
TMP4775[5] = &TMP4634[6];
TMP4634[6].kind = 1;
TMP4634[6].offset = offsetof(tbaselexer291016, Sentinel);
TMP4634[6].typ = (&NTI105);
TMP4634[6].name = "sentinel";
TMP4775[6] = &TMP4634[7];
TMP4634[7].kind = 1;
TMP4634[7].offset = offsetof(tbaselexer291016, Linestart);
TMP4634[7].typ = (&NTI105);
TMP4634[7].name = "lineStart";
TMP4775[7] = &TMP4634[8];
TMP4634[8].kind = 1;
TMP4634[8].offset = offsetof(tbaselexer291016, Fileopened);
TMP4634[8].typ = (&NTI133);
TMP4634[8].name = "fileOpened";
TMP4634[0].len = 8; TMP4634[0].kind = 2; TMP4634[0].sons = &TMP4775[0];
NTI291016.node = &TMP4634[0];
}
