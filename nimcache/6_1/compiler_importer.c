...
static NIM_CONST TY172865 TMP3609 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3610, "ident", 5);
static NIM_CONST TY172865 TMP3611 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3612, "sym", 3);
static NIM_CONST TY172865 TMP3613 = {
...
N_NIMCALL(NimStringDesc*, getmodulename_266012)(tnode172659* n) {
	...
	case ((NU8) 29):
	{
		...
		nimln(31, "importer.nim");
		{
			...
			nimln(31, "importer.nim");
			LOC9 = 0;
			LOC9 = getident_141443(((NimStringDesc*) &TMP3615));
	...
	strtableadd_179078(&(*(*c).Importtable).Symbols, s);	nimln(71, "importer.nim");
	{
		...
		nimln(73, "importer.nim");
		{
			...
			while (1) {
				...
				if (!(((TMP3611[(*(*(*etyp).N).kindU.S6.Sons->data[j_266258]).Kind/8] &(1<<((*(*(*etyp).N).kindU.S6.Sons->data[j_266258]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3612));
				...
				nimln(76, "importer.nim");
				{
					...
					internalerror_139369((*s).Info, ((NimStringDesc*) &TMP3622));				}				LA25: ;
...
N_NIMCALL(void, importsymbol_266334)(tcontext263019* c, tnode172659* n, tsym172689* frommod) {
	...
	LA3: ;
	{
		...
		nimln(102, "importer.nim");
		{
			...
			internalerror_139369((*n).Info, ((NimStringDesc*) &TMP3624));		}		LA12: ;
		...
		case ((NU8) 15):
		{
			...
			while (1) {
				...
				nimln(111, "importer.nim");
				{
					...
					nimln(111, "importer.nim");
					internalerror_139369((*n).Info, ((NimStringDesc*) &TMP3625));				}				LA18: ;
...
N_NIMCALL(void, importforwarded_266511)(tcontext263019* c, tnode172659* n, tintset169043 exceptset) {
	...
	case ((NU8) 117):
	{
		...
		while (1) {
			...
			if (!(((TMP3611[(*a_266524).Kind/8] &(1<<((*a_266524).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3612));
	...
	case ((NU8) 118):
	{
		...
		localerror_139349((*n).Info, ((NU16) 4), ((NimStringDesc*) &TMP3628));	}	break;
	default:
	{
		NI i_266630;
		NI HEX3Atmp_266648;
...
N_NIMCALL(tsym172689*, importmoduleas_266656)(tnode172659* n, tsym172689* realmodule) {
	...
	LA3: ;
	{
		...
		localerror_139349((*n).Info, ((NU16) 4), ((NimStringDesc*) &TMP3630));	}	goto LA1;
	LA9: ;
	{
		nimln(698, "system.nim");
		nimln(698, "system.nim");
