...
N_NIMCALL(void, newline_196039)(ttmplparser196016* p) {
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		nimln(42, "filter_tmpl.nim");
		llstreamwrite_161258((*p).Outp, ((NimStringDesc*) &TMP2597));	}	LA4: ;
...
N_NIMCALL(void, parseline_196134)(ttmplparser196016* p) {
	...
	LA6: ;
	{
		...
		case ((NU8) 20):
		{
			...
			LA19: ;
			{
				...
				localerror_138349((*p).Info, ((NU16) 163), ((NimStringDesc*) &TMP2599));			}			LA17: ;
			nimln(91, "filter_tmpl.nim");
			nimln(91, "filter_tmpl.nim");
			LOC22 = 0;
			LOC22 = nsuRepeatChar((*p).Indent, 32);
			llstreamwrite_161258((*p).Outp, LOC22);			nimln(92, "filter_tmpl.nim");
			llstreamwrite_161258((*p).Outp, ((NimStringDesc*) &TMP2600));		}		break;
		case ((NU8) 28):
		case ((NU8) 64):
		case ((NU8) 60):
		case ((NU8) 65):
	...
	LA9: ;
	{
		...
		case ((NU8) 1):
		{
			...
			llstreamwrite_161258((*p).Outp, ((NimStringDesc*) &TMP2597));			nimln(123, "filter_tmpl.nim");
			...
			llstreamwrite_161258((*p).Outp, ((NimStringDesc*) &TMP2604));		}		break;
		case ((NU8) 0):
		{
			NimStringDesc* LOC44;
			...
			llstreamwrite_161258((*p).Outp, ((NimStringDesc*) &TMP2605));			nimln(130, "filter_tmpl.nim");
		...
		while (1) {
			...
			case 128 ... 255:
			{
				...
				llstreamwrite_161258((*p).Outp, ((NimStringDesc*) &TMP2606));				nimln(138, "filter_tmpl.nim");
			...
			case 92:
			{
				...
				llstreamwrite_161258((*p).Outp, ((NimStringDesc*) &TMP2607));				nimln(142, "filter_tmpl.nim");
				j = addInt(j, 1);
			}			break;
			case 39:
			{
				nimln(144, "filter_tmpl.nim");
				llstreamwrite_161258((*p).Outp, ((NimStringDesc*) &TMP2608));				nimln(145, "filter_tmpl.nim");
				j = addInt(j, 1);
			}			break;
			case 34:
			{
				nimln(147, "filter_tmpl.nim");
				llstreamwrite_161258((*p).Outp, ((NimStringDesc*) &TMP2609));				nimln(148, "filter_tmpl.nim");
				j = addInt(j, 1);
			}			break;
			default:
			{
				nimln(150, "filter_tmpl.nim");
				{
					...
					case 123:
					{
						...
						while (1) {
							...
							case 0:
							{
								...
								localerror_138349((*p).Info, ((NU16) 188), ((NimStringDesc*) &TMP2610));								nimln(166, "filter_tmpl.nim");
								goto LA58;
							}							break;
							case 123:
							{
					...
					default:
					{
						...
						LA76: ;
						{
							...
							localerror_138349((*p).Info, ((NU16) 167), ((NimStringDesc*) &TMP2611));						}						LA74: ;
					}					break;
					}
				}				goto LA53;
				LA55: ;
		...
		llstreamwrite_161258((*p).Outp, ((NimStringDesc*) &TMP2612));	}	LA2: ;
	popFrame();
}
static N_INLINE(tlineinfo136509, newlineinfo_136985)(NimStringDesc* filename, NI line, NI col) {
...
N_NIMCALL(tllstream161204*, filtertmpl_196006)(tllstream161204* stdin_196008, NimStringDesc* filename, tnode171659* call) {
	...
	p.Outp = llstreamopen_161218(((NimStringDesc*) &TMP2598));
	nimln(209, "filter_tmpl.nim");
	p.Inp = stdin_196008;
	nimln(210, "filter_tmpl.nim");
	p.Subschar = chararg_195014(call, ((NimStringDesc*) &TMP2613), 1, 36);
	nimln(211, "filter_tmpl.nim");
	p.Nimdirective = chararg_195014(call, ((NimStringDesc*) &TMP2614), 2, 35);
	nimln(212, "filter_tmpl.nim");
	p.Emit = strarg_195021(call, ((NimStringDesc*) &TMP2615), 3, ((NimStringDesc*) &TMP2616));
	nimln(213, "filter_tmpl.nim");
	p.Conc = strarg_195021(call, ((NimStringDesc*) &TMP2617), 4, ((NimStringDesc*) &TMP2618));
	nimln(214, "filter_tmpl.nim");
	p.Tostr = strarg_195021(call, ((NimStringDesc*) &TMP2619), 5, ((NimStringDesc*) &TMP2611));
