...
STRING_LITERAL(TMP379, "DOS", 3);
STRING_LITERAL(TMP380, "..", 2);
STRING_LITERAL(TMP381, "$1.dll", 6);
STRING_LITERAL(TMP382, "/", 1);
STRING_LITERAL(TMP383, ".obj", 4);
STRING_LITERAL(TMP384, "\015\012", 2);
STRING_LITERAL(TMP385, ";", 1);
STRING_LITERAL(TMP386, "\\", 1);
STRING_LITERAL(TMP387, ".bat", 4);
STRING_LITERAL(TMP388, ".", 1);
STRING_LITERAL(TMP389, ".exe", 4);
STRING_LITERAL(TMP390, "Windows", 7);
STRING_LITERAL(TMP391, "OS2", 3);
STRING_LITERAL(TMP392, "Linux", 5);
STRING_LITERAL(TMP393, "lib$1.so", 8);
STRING_LITERAL(TMP394, ".o", 2);
STRING_LITERAL(TMP395, "\012", 1);
STRING_LITERAL(TMP396, ":", 1);
STRING_LITERAL(TMP397, ".sh", 3);
STRING_LITERAL(TMP398, "", 0);
STRING_LITERAL(TMP399, "MorphOS", 7);
STRING_LITERAL(TMP400, "SkyOS", 5);
STRING_LITERAL(TMP401, "Solaris", 7);
STRING_LITERAL(TMP402, "Irix", 4);
STRING_LITERAL(TMP403, "NetBSD", 6);
STRING_LITERAL(TMP404, "FreeBSD", 7);
STRING_LITERAL(TMP405, "OpenBSD", 7);
STRING_LITERAL(TMP406, "AIX", 3);
STRING_LITERAL(TMP407, "PalmOS", 6);
STRING_LITERAL(TMP408, "QNX", 3);
STRING_LITERAL(TMP409, "Amiga", 5);
STRING_LITERAL(TMP410, "$1.library", 10);
STRING_LITERAL(TMP411, "Atari", 5);
STRING_LITERAL(TMP412, ".tpp", 4);
STRING_LITERAL(TMP413, "Netware", 7);
STRING_LITERAL(TMP414, "$1.nlm", 6);
STRING_LITERAL(TMP415, ".nlm", 4);
STRING_LITERAL(TMP416, "MacOS", 5);
STRING_LITERAL(TMP417, "::", 2);
STRING_LITERAL(TMP418, "$1Lib", 5);
STRING_LITERAL(TMP419, "\015", 1);
STRING_LITERAL(TMP420, ",", 1);
STRING_LITERAL(TMP421, "MacOSX", 6);
STRING_LITERAL(TMP422, "lib$1.dylib", 11);
STRING_LITERAL(TMP423, "Haiku", 5);
STRING_LITERAL(TMP424, "JS", 2);
STRING_LITERAL(TMP425, "NimrodVM", 8);
STRING_LITERAL(TMP426, "Standalone", 10);
NIM_CONST TY119062 os_119061 = {{((NimStringDesc*) &TMP379),
...
;
STRING_LITERAL(TMP427, "littleEndian", 12);
STRING_LITERAL(TMP428, "bigEndian", 9);
NIM_CONST TY119456 endiantostr_119455 = {((NimStringDesc*) &TMP427),
((NimStringDesc*) &TMP428)}
;
STRING_LITERAL(TMP429, "i386", 4);
STRING_LITERAL(TMP430, "m68k", 4);
STRING_LITERAL(TMP431, "alpha", 5);
STRING_LITERAL(TMP432, "powerpc", 7);
STRING_LITERAL(TMP433, "powerpc64", 9);
STRING_LITERAL(TMP434, "sparc", 5);
STRING_LITERAL(TMP435, "vm", 2);
STRING_LITERAL(TMP436, "ia64", 4);
STRING_LITERAL(TMP437, "amd64", 5);
STRING_LITERAL(TMP438, "mips", 4);
STRING_LITERAL(TMP439, "arm", 3);
STRING_LITERAL(TMP440, "js", 2);
STRING_LITERAL(TMP441, "nimrodvm", 8);
STRING_LITERAL(TMP442, "avr", 3);
NIM_CONST TY119461 cpu_119460 = {{((NimStringDesc*) &TMP429),
32,
((NU8) 0),
64,
32}
...
;
STRING_LITERAL(TMP443, "not (c == cpuNone) ", 19);
STRING_LITERAL(TMP444, "not (o == osNone) ", 18);
STRING_LITERAL(TMP448, "macosx", 6);
...
N_NIMCALL(void, settarget_119586)(NU8 o, NU8 c) {
	...
	nimln(198, "platform.nim");
	{
		...
		if (!!(!((c == ((NU8) 0))))) goto LA3;
		nimln(198, "platform.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP443));	}	LA3: ;
	nimln(199, "platform.nim");
	{
		...
		if (!!(!((o == ((NU8) 0))))) goto LA7;
		nimln(199, "platform.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP444));	}	LA7: ;
	...
	TMP445 = divInt(cpu_119460[(c)- 1].Field1, 8);
	intsize_119577 = (NI64)(TMP445);
	nimln(204, "platform.nim");
	nimln(204, "platform.nim");
	if (c < 1 || c > 14) raiseIndexError();
	TMP446 = divInt(cpu_119460[(c)- 1].Field3, 8);
	floatsize_119578 = (NI64)(TMP446);
	nimln(205, "platform.nim");
	nimln(205, "platform.nim");
	if (c < 1 || c > 14) raiseIndexError();
	TMP447 = divInt(cpu_119460[(c)- 1].Field4, 8);
	ptrsize_119579 = (NI64)(TMP447);
...
N_NIMCALL(NU8, nametocpu_119573)(NimStringDesc* name) {
	...
	hostos_119563 = nametoos_119569(((NimStringDesc*) &TMP448));
