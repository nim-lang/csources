...
N_NIMCALL(void, TMP945)(void* p, NI op);
...
static NIM_CONST TY113118 TMP927 = {
0x00, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP928, "", 0);
STRING_LITERAL(TMP929, "\"", 1);
STRING_LITERAL(TMP930, "\\\"", 2);
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP933, "\'", 1);
STRING_LITERAL(TMP937, "\'\"\'\"\'", 5);
STRING_LITERAL(TMP941, "0 < n ", 6);
STRING_LITERAL(TMP953, "", 0);
STRING_LITERAL(TMP954, "\012", 1);
STRING_LITERAL(TMP955, " ", 1);
STRING_LITERAL(TMP967, "=", 1);
STRING_LITERAL(TMP979, "sh", 2);
STRING_LITERAL(TMP980, "-c", 2);
NIM_CONST TY114486 TMP978 = {((NimStringDesc*) &TMP979),
((NimStringDesc*) &TMP980)}
;
NIM_CONST TY75888 TMP987 = {((NimStringDesc*) &TMP953),
-1}
;
...
N_NIMCALL(NimStringDesc*, nospquoteShellWindows)(NimStringDesc* s) {
	...
	needquote = LOC1;
	nimln(50, "osproc.nim");
	result = copyString(((NimStringDesc*) &TMP928));
	nimln(51, "osproc.nim");
	backslashbuff = copyString(((NimStringDesc*) &TMP928));
	nimln(52, "osproc.nim");
	{
		if (!needquote) goto LA5;
		nimln(53, "osproc.nim");
		result = resizeString(result, 1);
appendString(result, ((NimStringDesc*) &TMP929));
	}	LA5: ;
	c_144228 = 0;
...
appendString(result, ((NimStringDesc*) &TMP930));
		}		goto LA8;
		LA13: ;
		{
			nimln(64, "osproc.nim");
...
N_NIMCALL(NimStringDesc*, nospquoteShellPosix)(NimStringDesc* s) {
	...
	nimln(77, "osproc.nim");
	{
		...
		nimln(78, "osproc.nim");
		nimln(78, "osproc.nim");
		result = copyString(((NimStringDesc*) &TMP931));
		goto BeforeRet;
	}	LA3: ;
	nimln(80, "osproc.nim");
	safe = allcharsinset_84306(s, TMP932);
	nimln(82, "osproc.nim");
	{
		if (!safe) goto LA7;
		nimln(83, "osproc.nim");
	...
	LA7: ;
	{
		...
		nimln(85, "osproc.nim");
		LOC11 = 0;
		LOC11 = nsuReplaceStr(s, ((NimStringDesc*) &TMP933), ((NimStringDesc*) &TMP937));
		LOC10 = rawNewString(LOC11->Sup.len + 2);
appendString(LOC10, ((NimStringDesc*) &TMP933));
...
N_NIMCALL(tprocess144203*, startcmd_144428)(NimStringDesc* command, NU8 options) {
	...
	nimln(137, "osproc.nim");
	nimln(137, "osproc.nim");
	TMP938 = subInt(c->Sup.len, 1);
	a = (TY9552*) newSeq((&NTI9552), (NI64)(TMP938));
	i_144473 = 0;
	HEX3Atmp_144475 = 0;
	nimln(138, "osproc.nim");
	nimln(138, "osproc.nim");
	nimln(138, "osproc.nim");
	TMP939 = subInt(c->Sup.len, 1);
	HEX3Atmp_144475 = (NI64)(TMP939);
	...
	while (1) {
		...
		nimln(138, "osproc.nim");
		nimln(138, "osproc.nim");
		TMP940 = subInt(i_144473, 1);
		if ((NU)((NI64)(TMP940)) >= (NU)(a->Sup.len)) raiseIndexError();
		if ((NU)(i_144473) >= (NU)(c->Sup.len)) raiseIndexError();
		LOC2 = 0;
		LOC2 = a->data[(NI64)(TMP940)]; a->data[(NI64)(TMP940)] = copyStringRC1(c->data[i_144473]);
	...
	result = nospstartProcess(c->data[0], ((NimStringDesc*) &TMP928), a->data, a->Sup.len, NIM_NIL, options);
	popFrame();
	return result;
}
N_NIMCALL(NI, nospprocessID)(tprocess144203* p) {
...
N_NIMCALL(NI, nospcountProcessors)(void) {
	...
	numcpu = 0;
	len = 0;
	nimln(229, "osproc.nim");
	mib[(0)- 0] = ((int) 6);
	nimln(230, "osproc.nim");
	mib[(1)- 0] = ((int) 25);
	nimln(231, "osproc.nim");
	len = 8;
	nimln(232, "osproc.nim");
	nimln(232, "osproc.nim");
	LOC1 = 0;
	LOC1 = sysctl(mib, ((int) 2), ((void*) (&numcpu)), &len, NIM_NIL, 0);
	nimln(233, "osproc.nim");
	{
		int LOC6;
		nimln(233, "osproc.nim");
		if (!(numcpu < 1)) goto LA4;
		nimln(234, "osproc.nim");
		mib[(1)- 0] = ((int) 3);
...
N_NIMCALL(NI, nospexecProcesses)(NimStringDesc** cmds, NI cmdsLen0, NU8 options_144823, NI n) {
	...
	nimln(257, "osproc.nim");
	{
		...
		if (!!((0 < n))) goto LA3;
		nimln(257, "osproc.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP941));	}	LA3: ;
...
N_NIMCALL(NimStringDesc*, nospexecProcess)(NimStringDesc* command, NU8 options) {
	...
	result = copyString(((NimStringDesc*) &TMP953));
...
N_NIMCALL(NCSTRING*, tocstringarray_145626)(NimStringDesc** b, NI bLen0, NimStringDesc** a, NI aLen0) {
	...
	nimln(571, "osproc.nim");
	nimln(571, "osproc.nim");
	TMP956 = addInt(aLen0, bLen0);
	TMP957 = addInt((NI64)(TMP956), 1);
	TMP958 = mulInt((NI64)(TMP957), 8);
	LOC1 = 0;
	LOC1 = alloc0_4004((NI64)(TMP958));
	...
	while (1) {
		...
		TMP959 = addInt(b[i_145654]->Sup.len, 1);
		LOC3 = 0;
		LOC3 = alloc_4001((NI64)(TMP959));
		...
		nimln(574, "osproc.nim");
		if ((NU)(i_145654) >= (NU)(bLen0)) raiseIndexError();
		TMP960 = addInt(b[i_145654]->Sup.len, 1);
		memcpy(((void*) (result[(i_145654)- 0])), ((void*) (b[i_145654]->data)), (NI64)(TMP960));		nimln(1311, "system.nim");
	...
	while (1) {
		...
		nimln(576, "osproc.nim");
		nimln(576, "osproc.nim");
		TMP961 = addInt(i_145664, bLen0);
		if ((NU)((NI64)(TMP961)) > (NU)(50000)) raiseIndexError();
		nimln(576, "osproc.nim");
		nimln(576, "osproc.nim");
		nimln(576, "osproc.nim");
		if ((NU)(i_145664) >= (NU)(aLen0)) raiseIndexError();
		TMP962 = addInt(a[i_145664]->Sup.len, 1);
		LOC5 = 0;
		LOC5 = alloc_4001((NI64)(TMP962));
		result[((NI64)(TMP961))- 0] = ((NCSTRING) (LOC5));
		nimln(577, "osproc.nim");
		nimln(577, "osproc.nim");
		nimln(577, "osproc.nim");
		TMP963 = addInt(i_145664, bLen0);
		if ((NU)((NI64)(TMP963)) > (NU)(50000)) raiseIndexError();
		if ((NU)(i_145664) >= (NU)(aLen0)) raiseIndexError();
		nimln(577, "osproc.nim");
		nimln(577, "osproc.nim");
		if ((NU)(i_145664) >= (NU)(aLen0)) raiseIndexError();
		TMP964 = addInt(a[i_145664]->Sup.len, 1);
		memcpy(((void*) (result[((NI64)(TMP963))- 0])), ((void*) (a[i_145664]->data)), (NI64)(TMP964));		nimln(1311, "system.nim");
...
N_NIMCALL(NCSTRING*, tocstringarray_145692)(tstringtable112610* t) {
	...
	LOC1 = 0;
	LOC1 = nstlen(t);
	TMP965 = addInt(LOC1, 1);
	TMP966 = mulInt((NI64)(TMP965), 8);
	LOC2 = 0;
	LOC2 = alloc0_4004((NI64)(TMP966));
...
appendString(LOC8, ((NimStringDesc*) &TMP967));
appendString(LOC8, val_145699);
			...
			nimln(584, "osproc.nim");
			nimln(584, "osproc.nim");
			TMP968 = addInt(x->Sup.len, 1);
			LOC9 = 0;
			LOC9 = alloc_4001((NI64)(TMP968));
			...
			nimln(585, "osproc.nim");
			nimln(585, "osproc.nim");
			TMP969 = addInt(x->Sup.len, 1);
			memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI64)(TMP969));			nimln(586, "osproc.nim");
			i = addInt(i, 1);
		}		LA6: ;
		nimln(1311, "system.nim");
...
N_NIMCALL(NCSTRING*, envtocstringarray_145723)(void) {
	...
	while (1) {
		...
		if ((NU)(i_145756) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1151, "os.nim");
		TMP970 = subInt(p_145762, 1);
		key_145727 = copyStrLast(environment_104029->data[i_145756], 0, (NI64)(TMP970));
		nimln(1152, "os.nim");
		nimln(1152, "os.nim");
		if ((NU)(i_145756) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1152, "os.nim");
		TMP971 = addInt(p_145762, 1);
		val_145728 = copyStr(environment_104029->data[i_145756], (NI64)(TMP971));
	...
	nimln(591, "osproc.nim");
	nimln(591, "osproc.nim");
	TMP972 = addInt(counter, 1);
	TMP973 = mulInt((NI64)(TMP972), 8);
	LOC2 = 0;
	LOC2 = alloc0_4004((NI64)(TMP973));
	result = ((NCSTRING*) (LOC2));
	...
	while (1) {
		...
		if ((NU)(i_145772) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1151, "os.nim");
		TMP974 = subInt(p_145778, 1);
		key_145741 = copyStrLast(environment_104029->data[i_145772], 0, (NI64)(TMP974));
		nimln(1152, "os.nim");
		nimln(1152, "os.nim");
		if ((NU)(i_145772) >= (NU)(environment_104029->Sup.len)) raiseIndexError();
		nimln(1152, "os.nim");
		TMP975 = addInt(p_145778, 1);
		val_145742 = copyStr(environment_104029->data[i_145772], (NI64)(TMP975));
		nimln(594, "osproc.nim");
		nimln(594, "osproc.nim");
		LOC4 = 0;
		LOC4 = rawNewString(key_145741->Sup.len + val_145742->Sup.len + 1);
appendString(LOC4, key_145741);
appendString(LOC4, ((NimStringDesc*) &TMP967));
appendString(LOC4, val_145742);
		...
		memcpy(((void*) (result[(i)- 0])), ((void*) (&x->data[0])), (NI64)(TMP977));		nimln(597, "osproc.nim");
		i = addInt(i, 1);
		nimln(1311, "system.nim");
...
N_NIMCALL(tprocess144203*, nospstartProcess)(NimStringDesc* command, NimStringDesc* workingdir, NimStringDesc** args, NI argsLen0, tstringtable112610* env, NU8 options) {
	...
	LA115: ;
	{
		...
		a = tocstringarray_145626(TMP978, 2, LOC119, 1);
	...
	nimln(699, "osproc.nim");
	{
		...
		nimln(700, "osproc.nim");
		LOC131 = 0;
		LOC131 = nsuJoinSep(args, argsLen0, ((NimStringDesc*) &TMP955));
		printf("%s%s%s\012", (command)->data, (((NimStringDesc*) &TMP955))->data, (LOC131)->data);
	}	LA129: ;
...
N_NIMCALL(void, pruneprocessset_146391)(TY145202** s, fd_set* fd) {
	...
	while (1) {
		...
		nimln(803, "osproc.nim");
		{
			...
			nimln(804, "osproc.nim");
			TMP983 = subInt(l, 1);
			if ((NU)((NI64)(TMP983)) >= (NU)((*s)->Sup.len)) raiseIndexError();
			asgnRefNoCycle((void**) &(*s)->data[i], (*s)->data[(NI64)(TMP983)]);
...
N_NIMCALL(NI, select_145502)(TY145202** readfds, NI timeout) {
	...
	nimln(813, "osproc.nim");
	TMP984 = mulInt(timeout, 1000);
	tv.tv_usec = (NI64)(TMP984);
	...
	createfdset_146336(&rd, (*readfds), &m);	nimln(819, "osproc.nim");
	{
		...
		TMP985 = addInt(m, 1);
		LOC5 = 0;
		LOC5 = select(((int)chckRange((NI64)(TMP985), ((int) (-2147483647 -1)), ((int) 2147483647))), &rd, NIM_NIL, NIM_NIL, &tv);
		result = ((NI) (LOC5));
	}	goto LA1;
	LA3: ;
	{
		...
		TMP986 = addInt(m, 1);
		LOC7 = 0;
		LOC7 = select(((int)chckRange((NI64)(TMP986), ((int) (-2147483647 -1)), ((int) 2147483647))), &rd, NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}	LA1: ;
...
N_NIMCALL(void, execcmdex_146602)(NimStringDesc* command, NU8 options, TY75888* Result) {
	...
	unsureAsgnRef((void**) &(*Result).Field0, copyString(TMP987.Field0));
	(*Result).Field1 = TMP987.Field1;
...
appendString((*Result).Field0, ((NimStringDesc*) &TMP954));
		}		goto LA2;
		LA5: ;
		{
...
static TNimNode* TMP942[8];
static TNimNode TMP913[9];
...
TMP942[0] = &TMP913[1];
TMP913[1].kind = 1;
TMP913[1].offset = offsetof(tprocess144203, Inhandle);
TMP913[1].typ = (&NTI9008);
TMP913[1].name = "inHandle";
TMP942[1] = &TMP913[2];
TMP913[2].kind = 1;
TMP913[2].offset = offsetof(tprocess144203, Outhandle);
TMP913[2].typ = (&NTI9008);
TMP913[2].name = "outHandle";
TMP942[2] = &TMP913[3];
TMP913[3].kind = 1;
TMP913[3].offset = offsetof(tprocess144203, Errhandle);
TMP913[3].typ = (&NTI9008);
TMP913[3].name = "errHandle";
TMP942[3] = &TMP913[4];
TMP913[4].kind = 1;
TMP913[4].offset = offsetof(tprocess144203, Instream);
TMP913[4].typ = (&NTI142627);
TMP913[4].name = "inStream";
TMP942[4] = &TMP913[5];
TMP913[5].kind = 1;
TMP913[5].offset = offsetof(tprocess144203, Outstream);
TMP913[5].typ = (&NTI142627);
TMP913[5].name = "outStream";
TMP942[5] = &TMP913[6];
TMP913[6].kind = 1;
TMP913[6].offset = offsetof(tprocess144203, Errstream);
TMP913[6].typ = (&NTI142627);
TMP913[6].name = "errStream";
TMP942[6] = &TMP913[7];
TMP913[7].kind = 1;
TMP913[7].offset = offsetof(tprocess144203, Id);
TMP913[7].typ = (&NTI91457);
TMP913[7].name = "id";
TMP942[7] = &TMP913[8];
TMP913[8].kind = 1;
TMP913[8].offset = offsetof(tprocess144203, Exitcode);
TMP913[8].typ = (&NTI3809);
TMP913[8].name = "exitCode";
TMP913[0].len = 8; TMP913[0].kind = 2; TMP913[0].sons = &TMP942[0];
NTI144203.node = &TMP913[0];
NTI144205.size = sizeof(tprocess144203*);
NTI144205.kind = 22;
NTI144205.base = (&NTI144203);
NTI144205.flags = 2;
NTI144205.marker = TMP944;
NTI145202.size = sizeof(TY145202*);
NTI145202.kind = 24;
NTI145202.base = (&NTI144205);
NTI145202.flags = 2;
NTI145202.marker = TMP945;
}
