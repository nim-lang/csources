...
N_NIMCALL(void, sort_319717)(tsym171689** a, NI aLen0, TY319724 cmp, NU8 order) {
	...
	nimln(125, "algorithm.nim");
	TMP4969 = divInt(n, 2);
	b = (tsymseq171661*) newSeq((&NTI171661), (NI64)(TMP4969));
	...
	while (1) {
		...
		while (1) {
			...
			nimln(130, "algorithm.nim");
			TMP4978 = addInt(m, s);
			merge_319761(a, aLen0, b->data, b->Sup.len, (((NI64)(TMP4977) >= 0) ? (NI64)(TMP4977) : 0), m, (NI64)(TMP4978), cmp, order);			nimln(131, "algorithm.nim");
...
N_NIMCALL(void, sort_322424)(tentry321943* a, NI aLen0, TY322431 cmp, NU8 order) {
	...
	nimln(125, "algorithm.nim");
	TMP4988 = divInt(n, 2);
	b = (TY321950*) newSeq((&NTI321950), (NI64)(TMP4988));
	nimln(126, "algorithm.nim");
	s = 1;
	nimln(127, "algorithm.nim");
	while (1) {
		...
		while (1) {
			...
			nimln(130, "algorithm.nim");
			TMP4996 = addInt(m, s);
			merge_322468(a, aLen0, b->data, b->Sup.len, (((NI64)(TMP4995) >= 0) ? (NI64)(TMP4995) : 0), m, (NI64)(TMP4996), cmp, order);			nimln(131, "algorithm.nim");
			nimln(131, "algorithm.nim");
			TMP4997 = mulInt(s, 2);
