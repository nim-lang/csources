...
STRING_LITERAL(TMP7004, "logpass: context is not nil", 27);
NIM_CONST tpass223015 verbosepass_414044 = {verboseopen_414006,
NIM_NIL,
verboseprocess_414013,
NIM_NIL}
;
static NIM_CONST TY172865 TMP7005 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7006, "sons", 4);
static NIM_CONST TY172865 TMP7008 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7009, "sym", 3);
...
N_NIMCALL(tnode172659*, verboseprocess_414013)(tpasscontext223003* context, tnode172659* n) {
	...
	nimln(22, "passaux.nim");
	{
		...
		nimln(22, "passaux.nim");
		internalerror_139383(((NimStringDesc*) &TMP7004));	}	LA3: ;
...
static N_INLINE(NI, sonslen_173022)(tnode172659* n) {
	...
	{
		nimln(1209, "ast.nim");
		if (((TMP7005[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7006));
...
N_NIMCALL(tnode172659*, cleanup_414046)(tpasscontext223003* c, tnode172659* n) {
	...
	case ((NU8) 114):
	{
		...
		TMP7007 = subInt(LOC8, 1);
		HEX3Atmp_414157 = (NI32)(TMP7007);
	...
	case ((NU8) 80):
	{
		nimln(39, "passaux.nim");
		{
			...
			if (((TMP7005[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7006));
			if ((NU)(0) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!(((TMP7008[(*(*n).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7009));
			...
			nimln(41, "passaux.nim");
			{
				...
				if (((TMP7005[(*(*s).Ast).Kind/8] &(1<<((*(*s).Ast).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7006));
