...
N_NIMCALL(void, handleshortoption_417876)(toptparser417607* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_417802((*p).Cmd, i, &(*p).Val, TMP7036);
	}	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser417607* p) {
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_417802((*p).Cmd, i, &(*p).Key, TMP7037);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_417802((*p).Cmd, i, &(*p).Val, TMP7036);
			}			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_417802((*p).Cmd, i, &(*p).Key, TMP7036);
	}	break;
	}
	BeforeRet: ;	popFrame();
}
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser417607* p) {
	...
	LOC1 = 0;
	LOC1 = copyStrLast((*p).Cmd, (*p).Pos, (NI32)(TMP7038));
...
TMP7040[0] = &TMP7029[1];
TMP7029[1].kind = 1;
TMP7029[1].offset = offsetof(toptparser417607, Cmd);
TMP7029[1].typ = (&NTI142);
TMP7029[1].name = "cmd";
TMP7040[1] = &TMP7029[2];
TMP7029[2].kind = 1;
TMP7029[2].offset = offsetof(toptparser417607, Pos);
TMP7029[2].typ = (&NTI105);
TMP7029[2].name = "pos";
TMP7040[2] = &TMP7029[3];
TMP7029[3].kind = 1;
TMP7029[3].offset = offsetof(toptparser417607, Inshortstate);
...
NTI417605.node = &TMP7029[9];
TMP7029[4].kind = 1;
TMP7029[4].offset = offsetof(toptparser417607, Kind);
TMP7029[4].typ = (&NTI417605);
TMP7029[4].name = "kind";
TMP7040[4] = &TMP7029[10];
TMP7029[10].kind = 1;
TMP7029[10].offset = offsetof(toptparser417607, Key);
TMP7029[10].typ = (&NTI142);
TMP7029[10].name = "key";
TMP7040[5] = &TMP7029[11];
TMP7029[11].kind = 1;
TMP7029[11].offset = offsetof(toptparser417607, Val);
TMP7029[11].typ = (&NTI142);
TMP7029[11].name = "val";
TMP7029[0].len = 6; TMP7029[0].kind = 2; TMP7029[0].sons = &TMP7040[0];
NTI417607.node = &TMP7029[0];
}
