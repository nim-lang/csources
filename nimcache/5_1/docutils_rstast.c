...
N_NIMCALL(trstnode279018*, lastson_279145)(trstnode279018* n) {
	...
	if ((NU)((NI32)(TMP3869)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP3869)];
	popFrame();
	return result;
}
static N_INLINE(void, asgnRefNoCycle)(void** dest, void* src) {
...
appendString((*result), ind);
		...
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI32)(TMP3874), lvltochar_279241[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI32)(TMP3876), 45);
...
appendString((*result), ((NimStringDesc*) &TMP3879));
	...
	case ((NU8) 14):
	{
		...
		l = (((NI32)(TMP3880) >= 30) ? (NI32)(TMP3880) : 30);
...
appendString((*result), tmp);
		...
		TMP3882 = subInt((NI32)(TMP3881), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI32)(TMP3882), 32);
...
NTI279012.node = &TMP3861[67];
TMP3861[1].kind = 1;
TMP3861[1].offset = offsetof(trstnode279018, Kind);
TMP3861[1].typ = (&NTI279012);
TMP3861[1].name = "kind";
TMP3863[1] = &TMP3861[68];
TMP3861[68].kind = 1;
TMP3861[68].offset = offsetof(trstnode279018, Text);
TMP3861[68].typ = (&NTI142);
TMP3861[68].name = "text";
TMP3863[2] = &TMP3861[69];
TMP3861[69].kind = 1;
TMP3861[69].offset = offsetof(trstnode279018, Level);
TMP3861[69].typ = (&NTI105);
TMP3861[69].name = "level";
TMP3863[3] = &TMP3861[70];
TMP3861[70].kind = 1;
TMP3861[70].offset = offsetof(trstnode279018, Sons);
TMP3861[70].typ = (&NTI279093);
TMP3861[70].name = "sons";
TMP3861[0].len = 4; TMP3861[0].kind = 2; TMP3861[0].sons = &TMP3863[0];
NTI279018.node = &TMP3861[0];
NTI279014.size = sizeof(trstnode279018*);
NTI279014.kind = 22;
NTI279014.base = (&NTI279018);
NTI279014.flags = 2;
NTI279014.marker = TMP3868;
}
