...
static NIM_CONST TY172865 TMP5027 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5028, "sons", 4);
STRING_LITERAL(TMP5030, "n.sons[0].Kind == nkSym ", 24);
STRING_LITERAL(TMP5033, "isPartOfAux(record case branch)", 31);
static NIM_CONST TY172865 TMP5034 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP5035, "sym", 3);
STRING_LITERAL(TMP5036, "isPartOfAux()", 13);
...
static N_INLINE(tnode172659*, lastson_173030)(tnode172659* n) {
	...
	TMP5032 = subInt(LOC1, 1);
	if ((NU)((NI32)(TMP5032)) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
	result = (*n).kindU.S6.Sons->data[(NI32)(TMP5032)];
	popFrame();
	return result;
}
N_NIMCALL(NU8, ispartofaux_326019)(tnode172659* n, ttype172693* b, tintset169043* marker) {
	...
	case ((NU8) 133):
	{
		...
		TMP5029 = subInt(LOC2, 1);
		HEX3Atmp_326271 = (NI32)(TMP5029);
	...
	case ((NU8) 134):
	{
		...
		nimln(29, "aliases.nim");
		{
			...
			nimln(29, "aliases.nim");
			hiddenraiseassert_76017(((NimStringDesc*) &TMP5030));		}		LA11: ;
		...
		TMP5031 = subInt(LOC17, 1);
		HEX3Atmp_326275 = (NI32)(TMP5031);
		nimln(1301, "system.nim");
		res_326277 = 1;
		nimln(1302, "system.nim");
		while (1) {
			...
			default:
			{
				...
				internalerror_139383(((NimStringDesc*) &TMP5033));			}			break;
			}
			nimln(1304, "system.nim");
	...
	case ((NU8) 3):
	{
		...
		if (!(((TMP5034[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5035));
		result = ispartofaux_326012((*(*n).kindU.S4.Sym).Typ, b, marker);
	}	break;
	default:
	{
		nimln(40, "aliases.nim");
		internalerror_139369((*n).Info, ((NimStringDesc*) &TMP5036));	}	break;
	}
	BeforeRet: ;	popFrame();
	return result;
}
...
static N_INLINE(ttype172693*, lastson_173034)(ttype172693* n) {
	...
	TMP5037 = subInt(LOC1, 1);
	if ((NU)((NI32)(TMP5037)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP5037)];
	popFrame();
	return result;
}
N_NIMCALL(NU8, ispartofaux_326012)(ttype172693* a, ttype172693* b, tintset169043* marker) {
	...
	case ((NU8) 18):
	{
		...
		TMP5038 = subInt(LOC25, 1);
		HEX3Atmp_326340 = (NI32)(TMP5038);
		nimln(1301, "system.nim");
		res_326342 = 0;
		nimln(1302, "system.nim");
		while (1) {
		...
		case ((NU8) 45):
		{
			...
			nimln(128, "aliases.nim");
			{
				...
				nimln(130, "aliases.nim");
				{
					...
					if (!(((TMP5034[(*LOC81).Kind/8] &(1<<((*LOC81).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5035));
					nimln(130, "aliases.nim");
					LOC82 = 0;
					LOC82 = HEX5BHEX5D_173475(b, 1);
					if (!(((TMP5034[(*LOC82).Kind/8] &(1<<((*LOC82).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP5035));
