...
N_NIMCALL(NI, hashdata_111058)(void* data, NI size);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NOINLINE(void, raiseOverflow)(void);
static N_INLINE(NI, subInt)(NI a, NI b);
static N_INLINE(NI, hash_111401)(void* x);
static N_INLINE(NI, hash_111801)(NI x);
static N_INLINE(NI, hash_111807)(NI64 x);
static N_INLINE(NI, hash_111813)(NIM_CHAR x);
...
static N_INLINE(NI, hash_112002)(NF x);
extern TFrame* frameptr_12037;
TNimType NTI111011; /* THash */
...
N_NIMCALL(NI, hashdata_111058)(void* data, NI size) {
	...
	while (1) {
		...
		nimln(46, "hashes.nim");
		nimln(46, "hashes.nim");
		h = HEX21HEX26_111013(h, ((NI) (((NU8)(p[i])))));
		nimln(47, "hashes.nim");
		i = addInt(i, 1);
		nimln(48, "hashes.nim");
		s = subInt(s, 1);
...
N_NIMCALL(NI, hash_111826)(NimStringDesc* x) {
	...
	nimln(93, "hashes.nim");
	nimln(93, "hashes.nim");
	TMP283 = subInt(x->Sup.len, 1);
	HEX3Atmp_111849 = (NI32)(TMP283);
	nimln(1308, "system.nim");
	res_111851 = 0;
	nimln(1309, "system.nim");
	while (1) {
		nimln(1309, "system.nim");
		if (!(res_111851 <= HEX3Atmp_111849)) goto LA1;
		nimln(1308, "system.nim");
		i_111840 = res_111851;
		nimln(94, "hashes.nim");
		nimln(94, "hashes.nim");
		if ((NU)(i_111840) > (NU)(x->Sup.len)) raiseIndexError();
		h = HEX21HEX26_111013(h, ((NI) (((NU8)(x->data[i_111840])))));
		nimln(1311, "system.nim");
		res_111851 = addInt(res_111851, 1);
	} LA1: ;
	nimln(95, "hashes.nim");
	result = HEX21HEX24_111036(h);
	popFrame();
...
N_NIMCALL(NI, hashignorestyle_111856)(NimStringDesc* x) {
	...
	nimln(100, "hashes.nim");
	nimln(100, "hashes.nim");
	TMP284 = subInt(x->Sup.len, 1);
	HEX3Atmp_111916 = (NI32)(TMP284);
	nimln(1308, "system.nim");
	res_111918 = 0;
	nimln(1309, "system.nim");
	while (1) {
		nimln(1309, "system.nim");
		if (!(res_111918 <= HEX3Atmp_111916)) goto LA1;
		nimln(1308, "system.nim");
		i_111870 = res_111918;
		{
			NIM_CHAR c;
			nimln(101, "hashes.nim");
			if ((NU)(i_111870) > (NU)(x->Sup.len)) raiseIndexError();
			c = x->data[i_111870];
			...
			nimln(104, "hashes.nim");
			{
				...
				nimln(105, "hashes.nim");
				nimln(105, "hashes.nim");
				TMP285 = addInt(((NI) (((NU8)(c)))), 32);
				c = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP285), 0, 255))));
			}			LA9: ;
		...
		nimln(1311, "system.nim");
		res_111918 = addInt(res_111918, 1);
	} LA1: ;
...
N_NIMCALL(NI, hashignorecase_111924)(NimStringDesc* x) {
	...
	while (1) {
		NIM_CHAR c;
		nimln(1309, "system.nim");
		if (!(res_111985 <= HEX3Atmp_111983)) goto LA1;
		nimln(1308, "system.nim");
		i_111938 = res_111985;
		nimln(113, "hashes.nim");
		if ((NU)(i_111938) > (NU)(x->Sup.len)) raiseIndexError();
		c = x->data[i_111938];
		...
		h = HEX21HEX26_111013(h, ((NI) (((NU8)(c)))));
		nimln(1311, "system.nim");
		res_111985 = addInt(res_111985, 1);
	} LA1: ;
