...
typedef N_CLOSURE_PTR(NI, TMP4978) (tsym172689* x, tsym172689* y);
...
typedef N_CLOSURE_PTR(NI, TMP4998) (tentry322943 x, tentry322943 y);
struct TNimObject {
TNimType* m_type;
};
struct tidobj141011 {
...
N_NIMCALL(void, merge_320761)(tsym172689** a, NI aLen0, tsym172689** b, NI bLen0, NI lo, NI m, NI hi, TY320724 cmp, NU8 order) {
	...
	nimln(71, "algorithm.nim");
	{
		...
		nimln(71, "algorithm.nim");
		TMP4977 = addInt(m, 1);
		if ((NU)((NI32)(TMP4977)) >= (NU)(aLen0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI32)(TMP4977)], cmp.ClEnv) : ((TMP4978)(cmp.ClPrc))(a[m], a[(NI32)(TMP4977)]);
		LOC4 = 0;
...
N_NIMCALL(void, sort_320717)(tsym172689** a, NI aLen0, TY320724 cmp, NU8 order) {
	...
	nimln(125, "algorithm.nim");
	TMP4974 = divInt(n, 2);
	b = (tsymseq172661*) newSeq((&NTI172661), (NI32)(TMP4974));
	...
	while (1) {
		...
		while (1) {
			...
			nimln(130, "algorithm.nim");
			TMP4981 = subInt(m, s);
			TMP4982 = addInt((NI32)(TMP4981), 1);
			nimln(130, "algorithm.nim");
			TMP4983 = addInt(m, s);
			merge_320761(a, aLen0, b->data, b->Sup.len, (((NI32)(TMP4982) >= 0) ? (NI32)(TMP4982) : 0), m, (NI32)(TMP4983), cmp, order);			nimln(131, "algorithm.nim");
			nimln(131, "algorithm.nim");
			TMP4984 = mulInt(s, 2);
			m = subInt(m, (NI32)(TMP4984));
		} LA2: ;
...
N_NIMCALL(void, merge_323468)(tentry322943* a, NI aLen0, tentry322943* b, NI bLen0, NI lo, NI m, NI hi, TY323431 cmp, NU8 order) {
	...
	nimln(71, "algorithm.nim");
	{
		...
		nimln(71, "algorithm.nim");
		TMP4996 = addInt(m, 1);
		if ((NU)((NI32)(TMP4996)) >= (NU)(aLen0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI32)(TMP4996)], cmp.ClEnv) : ((TMP4997)(cmp.ClPrc))(a[m], a[(NI32)(TMP4996)]);
		LOC4 = 0;
		LOC4 = HEX2A_318040(LOC3, order);
		if (!(LOC4 <= 0)) goto LA5;
		nimln(71, "algorithm.nim");
...
N_NIMCALL(void, sort_323424)(tentry322943* a, NI aLen0, TY323431 cmp, NU8 order) {
	...
	nimln(125, "algorithm.nim");
	TMP4993 = divInt(n, 2);
	b = (TY322950*) newSeq((&NTI322950), (NI32)(TMP4993));
	nimln(126, "algorithm.nim");
	s = 1;
	nimln(127, "algorithm.nim");
	while (1) {
		...
		while (1) {
			...
			nimln(130, "algorithm.nim");
			TMP4999 = subInt(m, s);
			TMP5000 = addInt((NI32)(TMP4999), 1);
			nimln(130, "algorithm.nim");
			TMP5001 = addInt(m, s);
			merge_323468(a, aLen0, b->data, b->Sup.len, (((NI32)(TMP5000) >= 0) ? (NI32)(TMP5000) : 0), m, (NI32)(TMP5001), cmp, order);			nimln(131, "algorithm.nim");
			nimln(131, "algorithm.nim");
			TMP5002 = mulInt(s, 2);
			m = subInt(m, (NI32)(TMP5002));
		} LA2: ;
		nimln(132, "algorithm.nim");
		nimln(132, "algorithm.nim");
		TMP5003 = mulInt(s, 2);
