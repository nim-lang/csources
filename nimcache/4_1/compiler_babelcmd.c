...
N_NIMCALL(void, addpackage_151103)(tstringtable112610* packages, NimStringDesc* p) {
	...
	nimln(48, "babelcmd.nim");
	TMP1399 = subInt(x, 1);
	name = copyStrLast(p, 0, (NI32)(TMP1399));
	nimln(49, "babelcmd.nim");
	{
		...
		nimln(50, "babelcmd.nim");
		TMP1400 = addInt(x, 1);
		version = copyStr(p, (NI32)(TMP1400));
	...
	nimln(1228, "os.nim");
	{
		...
		while (1) {
			...
			nimln(1233, "os.nim");
			{
				...
				nimln(698, "system.nim");
				nimln(698, "system.nim");
				LOC12 = !(eqStrings(y_151158, ((NimStringDesc*) &TMP1402)));
				LA13: ;
				if (!LOC12) goto LA14;
				...
				nimln(69, "babelcmd.nim");
				{
					...
					if (!(LOC33)) goto LA34;
					nimln(69, "babelcmd.nim");
					LOC33 = nsuEndsWith(path_151144, ((NimStringDesc*) &TMP1406));
					LA34: ;
					if (!LOC33) goto LA35;
		...
		nimln(1228, "os.nim");
		{
			...
			while (1) {
				...
				nimln(1233, "os.nim");
				{
					...
					nimln(698, "system.nim");
					nimln(698, "system.nim");
					LOC18 = !(eqStrings(y_151172, ((NimStringDesc*) &TMP1402)));
					LA19: ;
					if (!LOC18) goto LA20;
...
N_NIMCALL(void, addpathrec_151180)(NimStringDesc* dir, tlineinfo137509 info) {
	...
	nimln(1228, "os.nim");
	{
		...
		while (1) {
			...
			nimln(1233, "os.nim");
			{
				...
				nimln(698, "system.nim");
				nimln(698, "system.nim");
				LOC16 = !(eqStrings(y_151223, ((NimStringDesc*) &TMP1402)));
				LA17: ;
				if (!LOC16) goto LA18;
	...
	while (1) {
		...
		nimln(41, "strtabs.nim");
		{
			...
			{
				nimln(58, "babelcmd.nim");
				if (!eqStrings(val_151231, ((NimStringDesc*) &TMP1398))) goto LA49;
