...
N_NIMCALL(void, hexchar_178058)(NIM_CHAR c, NI* xi) {
	...
	case 48 ... 57:
	{
		...
		(*xi) = (NI)((NI)((NU32)((*xi)) << (NU32)(4)) | ((NI) ((NI32)(TMP2069))));
	}	break;
	case 97 ... 102:
	{
		NI TMP2070;
		...
		TMP2071 = addInt(((NI) ((NI32)(TMP2070))), 10);
...
N_NIMCALL(NimStringDesc*, decodestr_178114)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 92:
		{
			...
			nimln(49, "rodutils.nim");
			TMP2075 = subInt(i, 2);
			hexchar_178058(s[(NI32)(TMP2075)], &xi);			nimln(50, "rodutils.nim");
			nimln(50, "rodutils.nim");
			TMP2076 = subInt(i, 1);
			hexchar_178058(s[(NI32)(TMP2076)], &xi);			nimln(51, "rodutils.nim");
...
N_NIMCALL(void, encodevbiggestintaux_178161)(NI64 x, NimStringDesc** result) {
	...
	nimln(70, "rodutils.nim");
	TMP2077 = modInt64(v_178169, 190);
	rem_178171 = (NI64)(TMP2077);
	...
	LA3: ;
	{
		...
		nimln(76, "rodutils.nim");
		TMP2079 = divInt64(v_178169, 190);
		v_178169 = (NI64)(TMP2079);
	}	LA1: ;
	...
	nimln(78, "rodutils.nim");
	{
		...
		nimln(78, "rodutils.nim");
		if ((NU)(idx_178173) > (NU)(((NimStringDesc*) &TMP2080)->Sup.len)) raiseIndexError();
		d_178167 = ((NimStringDesc*) &TMP2080)->data[idx_178173];
	}	goto LA6;
	LA8: ;
	{
		NI TMP2081;
		...
		nimln(79, "rodutils.nim");
		nimln(79, "rodutils.nim");
		TMP2081 = subInt(idx_178173, 62);
		TMP2082 = addInt((NI32)(TMP2081), 128);
		d_178167 = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP2082), 0, 255))));
	}	LA6: ;
...
N_NIMCALL(void, encodevintaux_178193)(NI x, NimStringDesc** result) {
	...
	nimln(70, "rodutils.nim");
	nimln(70, "rodutils.nim");
	TMP2083 = modInt(v_178201, 190);
	rem_178203 = (NI32)(TMP2083);
	nimln(71, "rodutils.nim");
	{
		NI TMP2084;
		nimln(71, "rodutils.nim");
		...
		if ((NI32)(TMP2084) == (-2147483647 -1)) raiseOverflow();
		v_178201 = ((NI32)-((NI32)(TMP2084)));
		nimln(74, "rodutils.nim");
		nimln(74, "rodutils.nim");
	...
	LA3: ;
	{
		...
		nimln(76, "rodutils.nim");
		nimln(76, "rodutils.nim");
		TMP2085 = divInt(v_178201, 190);
		v_178201 = (NI32)(TMP2085);
	}	LA1: ;
	nimln(77, "rodutils.nim");
	...
	nimln(78, "rodutils.nim");
	{
		...
		nimln(78, "rodutils.nim");
		if ((NU)(idx_178205) > (NU)(((NimStringDesc*) &TMP2080)->Sup.len)) raiseIndexError();
		d_178199 = ((NimStringDesc*) &TMP2080)->data[idx_178205];
	}	goto LA6;
	LA8: ;
	{
		NI TMP2086;
		...
		nimln(79, "rodutils.nim");
		nimln(79, "rodutils.nim");
		TMP2086 = subInt(idx_178205, 62);
		TMP2087 = addInt((NI32)(TMP2086), 128);
		d_178199 = ((NIM_CHAR) (((NI)chckRange((NI32)(TMP2087), 0, 255))));
	}	LA6: ;
	nimln(80, "rodutils.nim");
	{
		nimln(698, "system.nim");
...
N_NIMCALL(NI, decodevint_178239)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 48 ... 57:
		{
			...
			nimln(110, "rodutils.nim");
			nimln(110, "rodutils.nim");
			TMP2090 = subInt(((NI) (((NU8)(s[i_178246])))), 48);
			TMP2091 = subInt((NI32)(TMP2089), ((NI) ((NI32)(TMP2090))));
			result = (NI32)(TMP2091);
		}		break;
		case 97 ... 122:
		{
			...
			nimln(111, "rodutils.nim");
			nimln(111, "rodutils.nim");
			TMP2093 = subInt(((NI) (((NU8)(s[i_178246])))), 97);
			TMP2094 = addInt(((NI) ((NI32)(TMP2093))), 10);
			TMP2095 = subInt((NI32)(TMP2092), ((NI) ((NI32)(TMP2094))));
			result = (NI32)(TMP2095);
		}		break;
		case 65 ... 90:
		{
			...
			nimln(112, "rodutils.nim");
			nimln(112, "rodutils.nim");
			TMP2097 = subInt(((NI) (((NU8)(s[i_178246])))), 65);
			TMP2098 = addInt(((NI) ((NI32)(TMP2097))), 36);
			TMP2099 = subInt((NI32)(TMP2096), ((NI) ((NI32)(TMP2098))));
			result = (NI32)(TMP2099);
		}		break;
		case 128 ... 255:
		{
			...
			nimln(113, "rodutils.nim");
			nimln(113, "rodutils.nim");
			TMP2101 = subInt(((NI) (((NU8)(s[i_178246])))), 128);
			TMP2102 = addInt(((NI) ((NI32)(TMP2101))), 62);
			TMP2103 = subInt((NI32)(TMP2100), ((NI) ((NI32)(TMP2102))));
			result = (NI32)(TMP2103);
		}		break;
		default:
		{
	...
	nimln(116, "rodutils.nim");
	nimln(116, "rodutils.nim");
	TMP2104 = mulInt(result, sign_178248);
	result = (NI)((NU32)((NI32)(TMP2104)) - (NU32)(5));
...
N_NIMCALL(NI64, decodevbiggestint_178495)(NCSTRING s, NI* pos) {
	...
	while (1) {
		...
		case 48 ... 57:
		{
			...
			nimln(110, "rodutils.nim");
			nimln(110, "rodutils.nim");
			TMP2106 = subInt(((NI) (((NU8)(s[i_178502])))), 48);
			TMP2107 = subInt64((NI64)(TMP2105), ((NI64) ((NI32)(TMP2106))));
			result = (NI64)(TMP2107);
		}		break;
		case 97 ... 122:
		{
			...
			nimln(111, "rodutils.nim");
			nimln(111, "rodutils.nim");
			TMP2109 = subInt(((NI) (((NU8)(s[i_178502])))), 97);
			TMP2110 = addInt(((NI) ((NI32)(TMP2109))), 10);
			TMP2111 = subInt64((NI64)(TMP2108), ((NI64) ((NI32)(TMP2110))));
			result = (NI64)(TMP2111);
		}		break;
		case 65 ... 90:
		{
			...
			nimln(112, "rodutils.nim");
			nimln(112, "rodutils.nim");
			TMP2113 = subInt(((NI) (((NU8)(s[i_178502])))), 65);
			TMP2114 = addInt(((NI) ((NI32)(TMP2113))), 36);
			TMP2115 = subInt64((NI64)(TMP2112), ((NI64) ((NI32)(TMP2114))));
			result = (NI64)(TMP2115);
		}		break;
		case 128 ... 255:
		{
			...
			nimln(113, "rodutils.nim");
			nimln(113, "rodutils.nim");
			TMP2117 = subInt(((NI) (((NU8)(s[i_178502])))), 128);
			TMP2118 = addInt(((NI) ((NI32)(TMP2117))), 62);
			TMP2119 = subInt64((NI64)(TMP2116), ((NI64) ((NI32)(TMP2118))));
			result = (NI64)(TMP2119);
		}		break;
		default:
		{
	...
	nimln(116, "rodutils.nim");
	nimln(116, "rodutils.nim");
	TMP2120 = mulInt64(result, ((NI64) (sign_178504)));
