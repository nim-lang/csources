...
static NIM_CONST TY171865 TMP3125 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3126, "sons", 4);
...
N_NIMCALL(NIM_BOOL, astneeded_222081)(tsym171689* s) {
	...
	nimln(73, "passes.nim");
	{
		...
		if (!(LOC3)) goto LA8;
		nimln(76, "passes.nim");
		if (((TMP3125[(*(*s).Ast).Kind/8] &(1<<((*(*s).Ast).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3126));
...
N_NIMCALL(void, closepasses_222312)(tpasscontext222003** a) {
	...
	nimln(127, "passes.nim");
	TMP3129 = subInt(gpasseslen_222161, 1);
	HEX3Atmp_222334 = (NI64)(TMP3129);
	nimln(1301, "system.nim");
	res_222336 = 0;
	nimln(1302, "system.nim");
	while (1) {
...
N_NIMCALL(NIM_BOOL, processtoplevelstmt_222341)(tnode171659* n, tpasscontext222003** a) {
	...
	nimln(134, "passes.nim");
	TMP3130 = subInt(gpasseslen_222161, 1);
	HEX3Atmp_222372 = (NI64)(TMP3130);
	nimln(1301, "system.nim");
	res_222374 = 0;
	nimln(1302, "system.nim");
	while (1) {
...
N_NIMCALL(void, processtoplevelstmtcached_222379)(tnode171659* n, tpasscontext222003** a) {
	...
	nimln(143, "passes.nim");
	TMP3131 = subInt(gpasseslen_222161, 1);
	HEX3Atmp_222401 = (NI64)(TMP3131);
	nimln(1301, "system.nim");
	res_222403 = 0;
	nimln(1302, "system.nim");
	while (1) {
...
N_NIMCALL(void, closepassescached_222408)(tpasscontext222003** a) {
	...
	nimln(148, "passes.nim");
	TMP3132 = subInt(gpasseslen_222161, 1);
	HEX3Atmp_222436 = (NI64)(TMP3132);
	nimln(1301, "system.nim");
	res_222438 = 0;
	nimln(1302, "system.nim");
	while (1) {
...
static N_INLINE(NI, sonslen_172022)(tnode171659* n) {
	...
	{
		nimln(1209, "ast.nim");
		if (((TMP3125[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3126));
...
N_NIMCALL(void, processmodule_222049)(tsym171689* module, tllstream161204* stream, trodreader211023* rd) {
	...
	LA3: ;
	{
		...
		TMP3133 = subInt(LOC34, 1);
		HEX3Atmp_222577 = (NI64)(TMP3133);
		nimln(1301, "system.nim");
		res_222579 = 0;
		nimln(1302, "system.nim");
		while (1) {
...
static TNimNode TMP3013[1];
NTI222003.size = sizeof(tpasscontext222003);
NTI222003.kind = 17;
NTI222003.base = (&NTI1009);
NTI222003.flags = 3;
TMP3013[0].kind = 1;
TMP3013[0].offset = offsetof(tpasscontext222003, Fromcache);
TMP3013[0].typ = (&NTI133);
TMP3013[0].name = "fromCache";
NTI222003.node = &TMP3013[0];
}
