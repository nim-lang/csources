...
N_NIMCALL(trstnode278018*, lastson_278145)(trstnode278018* n) {
	...
	if ((NU)((NI64)(TMP3866)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI64)(TMP3866)];
	popFrame();
	return result;
}
static N_INLINE(void, asgnRefNoCycle)(void** dest, void* src) {
...
appendString((*result), ind);
		...
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI64)(TMP3871), lvltochar_278241[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI64)(TMP3873), 45);
...
appendString((*result), ((NimStringDesc*) &TMP3876));
	...
	case ((NU8) 14):
	{
		...
		l = (((NI64)(TMP3877) >= 30) ? (NI64)(TMP3877) : 30);
...
appendString((*result), tmp);
		...
		TMP3879 = subInt((NI64)(TMP3878), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI64)(TMP3879), 32);
...
NTI278012.node = &TMP3858[67];
TMP3858[1].kind = 1;
TMP3858[1].offset = offsetof(trstnode278018, Kind);
TMP3858[1].typ = (&NTI278012);
TMP3858[1].name = "kind";
TMP3860[1] = &TMP3858[68];
TMP3858[68].kind = 1;
TMP3858[68].offset = offsetof(trstnode278018, Text);
TMP3858[68].typ = (&NTI142);
TMP3858[68].name = "text";
TMP3860[2] = &TMP3858[69];
TMP3858[69].kind = 1;
TMP3858[69].offset = offsetof(trstnode278018, Level);
TMP3858[69].typ = (&NTI105);
TMP3858[69].name = "level";
TMP3860[3] = &TMP3858[70];
TMP3858[70].kind = 1;
TMP3858[70].offset = offsetof(trstnode278018, Sons);
TMP3858[70].typ = (&NTI278093);
TMP3858[70].name = "sons";
TMP3858[0].len = 4; TMP3858[0].kind = 2; TMP3858[0].sons = &TMP3860[0];
NTI278018.node = &TMP3858[0];
NTI278014.size = sizeof(trstnode278018*);
NTI278014.kind = 22;
NTI278014.base = (&NTI278018);
NTI278014.flags = 2;
NTI278014.marker = TMP3865;
}
