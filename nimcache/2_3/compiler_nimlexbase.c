...
N_NIMCALL(void, fillbuffer_162072)(tbaselexer162018* l) {
	...
	nimln(82, "nimlexbase.nim");
	{
		...
		nimln(82, "nimlexbase.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP1618));	}	LA3: ;
	nimln(83, "nimlexbase.nim");
	nimln(83, "nimlexbase.nim");
	nimln(83, "nimlexbase.nim");
	TMP1619 = subInt((*l).Buflen, (*l).Sentinel);
	TMP1620 = subInt((NI64)(TMP1619), 1);
	tocopy = (NI64)(TMP1620);
	nimln(84, "nimlexbase.nim");
	{
		...
		nimln(84, "nimlexbase.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP1621));	}	LA7: ;
	nimln(85, "nimlexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI64)(TMP1622)])), (NI64)(TMP1623));	}	LA11: ;
	...
	TMP1625 = mulInt((NI64)(TMP1624), 1);
	LOC13 = 0;
	LOC13 = llstreamread_161242((*l).Stream, ((void*) (&(*l).Buf[tocopy])), (NI64)(TMP1625));
	TMP1626 = divInt(LOC13, 1);
	charsread = (NI64)(TMP1626);
	...
	nimln(91, "nimlexbase.nim");
	{
		...
		if (!(charsread < (NI64)(TMP1628))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			nimln(98, "nimlexbase.nim");
			{
				...
				nimln(98, "nimlexbase.nim");
				hiddenraiseassert_76017(((NimStringDesc*) &TMP1629));			}			LA22: ;
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI64)(TMP1630);
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				nimln(109, "nimlexbase.nim");
				TMP1631 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4007(((void*) ((*l).Buf)), (NI64)(TMP1631));
				...
				nimln(110, "nimlexbase.nim");
				{
					...
					if (!!(((NI64)(TMP1632) == oldbuflen))) goto LA35;
					nimln(110, "nimlexbase.nim");
					hiddenraiseassert_76017(((NimStringDesc*) &TMP1633));				}				LA35: ;
				...
				LOC37 = 0;
				LOC37 = llstreamread_161242((*l).Stream, ((void*) (&(*l).Buf[oldbuflen])), (NI64)(TMP1634));
				TMP1635 = divInt(LOC37, 1);
				charsread = (NI64)(TMP1635);
...
N_NIMCALL(NI, handlecr_162050)(tbaselexer162018* l, NI pos) {
	...
	nimln(130, "nimlexbase.nim");
	{
		...
		nimln(130, "nimlexbase.nim");
		hiddenraiseassert_76017(((NimStringDesc*) &TMP1641));	}	LA3: ;
...
N_NIMCALL(void, openbaselexer_162027)(tbaselexer162018* l, tllstream161204* inputstream, NI buflen) {
	...
	LOC5 = 0;
	LOC5 = alloc_4001((NI64)(TMP1644));
	(*l).Buf = ((NCSTRING) (LOC5));
	nimln(151, "nimlexbase.nim");
	nimln(151, "nimlexbase.nim");
	TMP1645 = subInt(buflen, 1);
	(*l).Sentinel = (NI64)(TMP1645);
...
N_NIMCALL(NI, getcolnumber_162045)(tbaselexer162018* l, NI pos) {
	...
	if ((NI64)(TMP1646) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = (NI64)abs((NI64)(TMP1646));
	popFrame();
	return result;
}
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src) {
...
TMP1887[0] = &TMP1593[1];
TMP1593[1].kind = 1;
TMP1593[1].offset = offsetof(tbaselexer162018, Bufpos);
TMP1593[1].typ = (&NTI105);
TMP1593[1].name = "bufpos";
TMP1887[1] = &TMP1593[2];
TMP1593[2].kind = 1;
TMP1593[2].offset = offsetof(tbaselexer162018, Buf);
TMP1593[2].typ = (&NTI144);
TMP1593[2].name = "buf";
TMP1887[2] = &TMP1593[3];
TMP1593[3].kind = 1;
TMP1593[3].offset = offsetof(tbaselexer162018, Buflen);
TMP1593[3].typ = (&NTI105);
TMP1593[3].name = "bufLen";
TMP1887[3] = &TMP1593[4];
TMP1593[4].kind = 1;
TMP1593[4].offset = offsetof(tbaselexer162018, Stream);
TMP1593[4].typ = (&NTI161206);
TMP1593[4].name = "stream";
TMP1887[4] = &TMP1593[5];
TMP1593[5].kind = 1;
TMP1593[5].offset = offsetof(tbaselexer162018, Linenumber);
TMP1593[5].typ = (&NTI105);
TMP1593[5].name = "LineNumber";
TMP1887[5] = &TMP1593[6];
TMP1593[6].kind = 1;
TMP1593[6].offset = offsetof(tbaselexer162018, Sentinel);
TMP1593[6].typ = (&NTI105);
TMP1593[6].name = "sentinel";
TMP1887[6] = &TMP1593[7];
TMP1593[7].kind = 1;
TMP1593[7].offset = offsetof(tbaselexer162018, Linestart);
TMP1593[7].typ = (&NTI105);
TMP1593[7].name = "lineStart";
TMP1593[0].len = 7; TMP1593[0].kind = 2; TMP1593[0].sons = &TMP1887[0];
NTI162018.node = &TMP1593[0];
}
