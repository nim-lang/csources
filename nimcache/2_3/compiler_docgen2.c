...
N_NIMCALL(tnode171659*, close_415013)(tpasscontext222003* p, tnode171659* n) {
	...
	nimln(25, "docgen2.nim");
	{
		...
		writeoutput_310043((*g).Doc, LOC7, ((NimStringDesc*) &TMP7021), usewarning);		nimln(27, "docgen2.nim");
...
TMP7020[0] = &TMP7018[1];
TMP7018[1].kind = 1;
TMP7018[1].offset = offsetof(tgen415007, Doc);
TMP7018[1].typ = (&NTI307007);
TMP7018[1].name = "doc";
TMP7020[1] = &TMP7018[2];
TMP7018[2].kind = 1;
TMP7018[2].offset = offsetof(tgen415007, Module);
TMP7018[2].typ = (&NTI171657);
TMP7018[2].name = "module";
TMP7018[0].len = 2; TMP7018[0].kind = 2; TMP7018[0].sons = &TMP7020[0];
NTI415007.node = &TMP7018[0];
NTI415009.size = sizeof(tgen415007*);
NTI415009.kind = 22;
NTI415009.base = (&NTI415007);
NTI415009.flags = 2;
NTI415009.marker = TMP7023;
}
