...
N_NIMCALL(NI, parseword_417802)(NimStringDesc* s, NI i, NimStringDesc** w, TY113118 delim);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(NimStringDesc*, addChar)(NimStringDesc* s, NIM_CHAR c);
N_NIMCALL(void, handleshortoption_417876)(toptparser417607* p);
...
STRING_LITERAL(TMP7029, "", 0);
STRING_LITERAL(TMP7033, "", 0);
static NIM_CONST TY113118 TMP7034 = {
0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY113118 TMP7035 = {
...
N_NIMCALL(void, initoptparser_417619)(NimStringDesc* cmdline, toptparser417607* Result) {
	...
	LA3: ;
	{
		...
		unsureAsgnRef((void**) &(*Result).Cmd, copyString(((NimStringDesc*) &TMP7029)));
		i_417632 = 0;
		HEX3Atmp_417634 = 0;
...
appendChar(LOC7, 32);
	...
	unsureAsgnRef((void**) &(*Result).Key, copyString(((NimStringDesc*) &TMP7033)));
	nimln(57, "parseopt.nim");
	unsureAsgnRef((void**) &(*Result).Val, copyString(((NimStringDesc*) &TMP7033)));
	popFrame();
}
N_NIMCALL(NI, parseword_417802)(NimStringDesc* s, NI i, NimStringDesc** w, TY113118 delim) {
	NI result;
...
N_NIMCALL(void, handleshortoption_417876)(toptparser417607* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_417802((*p).Cmd, i, &(*p).Val, TMP7034);
	}	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser417607* p) {
	...
	nimln(99, "parseopt.nim");
	{
		...
		handleshortoption_417876(p);		nimln(101, "parseopt.nim");
		goto BeforeRet;
	}	LA4: ;
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_417802((*p).Cmd, i, &(*p).Key, TMP7035);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_417802((*p).Cmd, i, &(*p).Val, TMP7034);
			}			goto LA13;
			LA15: ;
			{
		...
		LA10: ;
		{
			...
			handleshortoption_417876(p);		}		LA8: ;
	}	break;
	default:
	{
		...
		(*p).Pos = parseword_417802((*p).Cmd, i, &(*p).Key, TMP7034);
	}	break;
	}
	BeforeRet: ;	popFrame();
}
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser417607* p) {
	...
	nimln(128, "parseopt.nim");
	nimln(128, "parseopt.nim");
	TMP7036 = subInt((*p).Cmd->Sup.len, 1);
	LOC1 = 0;
	LOC1 = copyStrLast((*p).Cmd, (*p).Pos, (NI32)(TMP7036));
...
static TNimNode* TMP7038[6];
static TNimNode* TMP7039[4];
NI TMP7041;
static char* NIM_CONST TMP7040[4] = {
"cmdEnd", 
"cmdArgument", 
"cmdLongoption", 
"cmdShortOption"};
static TNimNode TMP7027[12];
NTI417607.size = sizeof(toptparser417607);
NTI417607.kind = 17;
NTI417607.base = (&NTI1009);
NTI417607.flags = 2;
TMP7038[0] = &TMP7027[1];
TMP7027[1].kind = 1;
TMP7027[1].offset = offsetof(toptparser417607, Cmd);
TMP7027[1].typ = (&NTI142);
TMP7027[1].name = "cmd";
TMP7038[1] = &TMP7027[2];
TMP7027[2].kind = 1;
TMP7027[2].offset = offsetof(toptparser417607, Pos);
TMP7027[2].typ = (&NTI105);
TMP7027[2].name = "pos";
TMP7038[2] = &TMP7027[3];
TMP7027[3].kind = 1;
TMP7027[3].offset = offsetof(toptparser417607, Inshortstate);
TMP7027[3].typ = (&NTI133);
TMP7027[3].name = "inShortState";
TMP7038[3] = &TMP7027[4];
NTI417605.size = sizeof(NU8);
NTI417605.kind = 14;
NTI417605.base = 0;
NTI417605.flags = 3;
for (TMP7041 = 0; TMP7041 < 4; TMP7041++) {
TMP7027[TMP7041+5].kind = 1;
TMP7027[TMP7041+5].offset = TMP7041;
TMP7027[TMP7041+5].name = TMP7040[TMP7041];
TMP7039[TMP7041] = &TMP7027[TMP7041+5];
}
TMP7027[9].len = 4; TMP7027[9].kind = 2; TMP7027[9].sons = &TMP7039[0];
NTI417605.node = &TMP7027[9];
TMP7027[4].kind = 1;
TMP7027[4].offset = offsetof(toptparser417607, Kind);
TMP7027[4].typ = (&NTI417605);
TMP7027[4].name = "kind";
TMP7038[4] = &TMP7027[10];
TMP7027[10].kind = 1;
TMP7027[10].offset = offsetof(toptparser417607, Key);
TMP7027[10].typ = (&NTI142);
TMP7027[10].name = "key";
TMP7038[5] = &TMP7027[11];
TMP7027[11].kind = 1;
TMP7027[11].offset = offsetof(toptparser417607, Val);
TMP7027[11].typ = (&NTI142);
TMP7027[11].name = "val";
TMP7027[0].len = 6; TMP7027[0].kind = 2; TMP7027[0].sons = &TMP7038[0];
NTI417607.node = &TMP7027[0];
}
