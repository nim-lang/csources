...
N_NIMCALL(void, settarget_119586)(NU8 o, NU8 c) {
	...
	nimln(198, "platform.nim");
	{
		...
		if (!!(!((c == ((NU8) 0))))) goto LA3;
		nimln(198, "platform.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP448));	}	LA3: ;
	nimln(199, "platform.nim");
	{
		...
		if (!!(!((o == ((NU8) 0))))) goto LA7;
		nimln(199, "platform.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP449));	}	LA7: ;
...
N_NIMCALL(NU8, nametocpu_119573)(NimStringDesc* name) {
	...
	hostcpu_119561 = nametocpu_119573(((NimStringDesc*) &TMP439));
