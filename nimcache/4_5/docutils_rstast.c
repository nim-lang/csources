...
N_NIMCALL(trstnode279018*, lastson_279145)(trstnode279018* n) {
	...
	if ((NU)((NI32)(TMP3867)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP3867)];
	popFrame();
	return result;
}
static N_INLINE(void, asgnRefNoCycle)(void** dest, void* src) {
...
appendString((*result), ind);
		...
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI32)(TMP3872), lvltochar_279241[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI32)(TMP3874), 45);
...
appendString((*result), ((NimStringDesc*) &TMP3877));
	...
	case ((NU8) 14):
	{
		...
		l = (((NI32)(TMP3878) >= 30) ? (NI32)(TMP3878) : 30);
...
appendString((*result), tmp);
		...
		TMP3880 = subInt((NI32)(TMP3879), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI32)(TMP3880), 32);
...
NTI279012.node = &TMP3859[67];
TMP3859[1].kind = 1;
TMP3859[1].offset = offsetof(trstnode279018, Kind);
TMP3859[1].typ = (&NTI279012);
TMP3859[1].name = "kind";
TMP3861[1] = &TMP3859[68];
TMP3859[68].kind = 1;
TMP3859[68].offset = offsetof(trstnode279018, Text);
TMP3859[68].typ = (&NTI142);
TMP3859[68].name = "text";
TMP3861[2] = &TMP3859[69];
TMP3859[69].kind = 1;
TMP3859[69].offset = offsetof(trstnode279018, Level);
TMP3859[69].typ = (&NTI105);
TMP3859[69].name = "level";
TMP3861[3] = &TMP3859[70];
TMP3859[70].kind = 1;
TMP3859[70].offset = offsetof(trstnode279018, Sons);
TMP3859[70].typ = (&NTI279093);
TMP3859[70].name = "sons";
TMP3859[0].len = 4; TMP3859[0].kind = 2; TMP3859[0].sons = &TMP3861[0];
NTI279018.node = &TMP3859[0];
NTI279014.size = sizeof(trstnode279018*);
NTI279014.kind = 22;
NTI279014.base = (&NTI279018);
NTI279014.flags = 2;
NTI279014.marker = TMP3866;
}
