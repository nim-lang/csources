...
static NIM_CONST TY172865 TMP2571 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2572, "sons", 4);
static NIM_CONST TY172865 TMP2574 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2575, "ident", 5);
static NIM_CONST TY172865 TMP2576 = {
0xE0, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2577, "intVal", 6);
static NIM_CONST TY172865 TMP2578 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2579, "strVal", 6);
STRING_LITERAL(TMP2580, "true", 4);
STRING_LITERAL(TMP2581, "false", 5);
STRING_LITERAL(TMP2582, "startswith", 10);
STRING_LITERAL(TMP2583, "", 0);
STRING_LITERAL(TMP2584, "leading", 7);
STRING_LITERAL(TMP2585, "trailing", 8);
STRING_LITERAL(TMP2587, "sub", 3);
STRING_LITERAL(TMP2588, "by", 2);
...
static N_INLINE(NI, sonslen_173022)(tnode172659* n) {
	...
	{
		nimln(1209, "ast.nim");
		if (((TMP2571[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2572));
...
N_NIMCALL(tnode172659*, getarg_196042)(tnode172659* n, NimStringDesc* name, NI pos) {
	...
	TMP2573 = subInt(LOC5, 1);
	HEX3Atmp_196184 = (NI32)(TMP2573);
	...
	while (1) {
		...
		nimln(31, "filters.nim");
		{
			...
			nimln(32, "filters.nim");
			{
				...
				if (((TMP2571[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2572));
				if ((NU)(i_196068) >= (NU)((*n).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (((TMP2571[(*(*n).kindU.S6.Sons->data[i_196068]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_196068]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2572));
			...
			nimln(33, "filters.nim");
			{
				...
				if (((TMP2571[(*(*n).kindU.S6.Sons->data[i_196068]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[i_196068]).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP2572));
				if ((NU)(0) >= (NU)((*(*n).kindU.S6.Sons->data[i_196068]).kindU.S6.Sons->Sup.len)) raiseIndexError();
				if (!(((TMP2574[(*(*(*n).kindU.S6.Sons->data[i_196068]).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*(*n).kindU.S6.Sons->data[i_196068]).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2575));
				LOC17 = 0;
...
N_NIMCALL(NIM_CHAR, chararg_196014)(tnode172659* n, NimStringDesc* name, NI pos, NIM_CHAR default_196019) {
	...
	LA3: ;
	{
		...
		nimln(41, "filters.nim");
		nimln(41, "filters.nim");
		if (!(((TMP2576[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2577));
...
N_NIMCALL(NimStringDesc*, strarg_196021)(tnode172659* n, NimStringDesc* name, NI pos, NimStringDesc* default_196026) {
	...
	LA3: ;
	{
		...
		if (!(((TMP2578[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2579));
...
N_NIMCALL(NIM_BOOL, boolarg_196028)(tnode172659* n, NimStringDesc* name, NI pos, NIM_BOOL default_196033) {
	...
	LA3: ;
	{
		...
		LOC6 = identeq_141456((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2580));
		LA7: ;
		if (!LOC6) goto LA8;
		nimln(53, "filters.nim");
		result = NIM_TRUE;
	...
	LA8: ;
	{
		...
		nimln(54, "filters.nim");
		if (!(((TMP2574[(*x).Kind/8] &(1<<((*x).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP2575));
		LOC11 = identeq_141456((*x).kindU.S5.Ident, ((NimStringDesc*) &TMP2581));
		LA12: ;
		if (!LOC11) goto LA13;
		nimln(54, "filters.nim");
		result = NIM_FALSE;
...
N_NIMCALL(tllstream162204*, filterstrip_196008)(tllstream162204* stdin_196010, NimStringDesc* filename, tnode172659* call) {
	...
	pattern = strarg_196021(call, ((NimStringDesc*) &TMP2582), 1, ((NimStringDesc*) &TMP2583));
	nimln(59, "filters.nim");
	leading = boolarg_196028(call, ((NimStringDesc*) &TMP2584), 2, NIM_TRUE);
	nimln(60, "filters.nim");
	trailing = boolarg_196028(call, ((NimStringDesc*) &TMP2585), 3, NIM_TRUE);
	nimln(61, "filters.nim");
	result = llstreamopen_162218(((NimStringDesc*) &TMP2583));
...
N_NIMCALL(tllstream162204*, filterreplace_196002)(tllstream162204* stdin_196004, NimStringDesc* filename, tnode172659* call) {
	...
	sub = strarg_196021(call, ((NimStringDesc*) &TMP2587), 1, ((NimStringDesc*) &TMP2583));
	...
	by = strarg_196021(call, ((NimStringDesc*) &TMP2588), 2, ((NimStringDesc*) &TMP2583));
