...
static N_INLINE(trope121007**, s_367161)(tcproc367025* p, NU8 s) {
	...
	if ((NU)((NI64)(TMP5612)) >= (NU)((*p).Blocks->Sup.len)) raiseIndexError();
	result = &(*p).Blocks->data[(NI64)(TMP5612)].Sections[(s)- 0];
	popFrame();
	return result;
}
static N_INLINE(trope121007**, procsec_367178)(tcproc367025* p, NU8 s) {
...
TMP5604[0] = &TMP5602[1];
TMP5602[1].kind = 1;
TMP5602[1].offset = offsetof(tcgen367029, Module);
TMP5602[1].typ = (&NTI171657);
TMP5602[1].name = "module";
TMP5604[1] = &TMP5602[2];
TMP5602[2].kind = 1;
TMP5602[2].offset = offsetof(tcgen367029, Filename);
...
NTI367013.flags = 2;
TMP5602[3].kind = 1;
TMP5602[3].offset = offsetof(tcgen367029, S);
TMP5602[3].typ = (&NTI367013);
TMP5602[3].name = "s";
TMP5604[3] = &TMP5602[4];
TMP5602[4].kind = 1;
TMP5602[4].offset = offsetof(tcgen367029, Preventstacktrace);
TMP5602[4].typ = (&NTI133);
TMP5602[4].name = "PreventStackTrace";
TMP5604[4] = &TMP5602[5];
TMP5602[5].kind = 1;
TMP5602[5].offset = offsetof(tcgen367029, Usesthreadvars);
TMP5602[5].typ = (&NTI133);
TMP5602[5].name = "usesThreadVars";
TMP5604[5] = &TMP5602[6];
TMP5602[6].kind = 1;
TMP5602[6].offset = offsetof(tcgen367029, Framedeclared);
TMP5602[6].typ = (&NTI133);
TMP5602[6].name = "FrameDeclared";
TMP5604[6] = &TMP5602[7];
TMP5602[7].kind = 1;
TMP5602[7].offset = offsetof(tcgen367029, Isheaderfile);
TMP5602[7].typ = (&NTI133);
TMP5602[7].name = "isHeaderFile";
TMP5604[7] = &TMP5602[8];
TMP5602[8].kind = 1;
TMP5602[8].offset = offsetof(tcgen367029, Includesstringh);
TMP5602[8].typ = (&NTI133);
TMP5602[8].name = "includesStringh";
TMP5604[8] = &TMP5602[9];
TMP5602[9].kind = 1;
TMP5602[9].offset = offsetof(tcgen367029, Cfilename);
TMP5602[9].typ = (&NTI142);
TMP5602[9].name = "cfilename";
TMP5604[9] = &TMP5602[10];
TMP5602[10].kind = 1;
TMP5602[10].offset = offsetof(tcgen367029, Typecache);
TMP5602[10].typ = (&NTI171705);
TMP5602[10].name = "typeCache";
TMP5604[10] = &TMP5602[11];
TMP5602[11].kind = 1;
TMP5602[11].offset = offsetof(tcgen367029, Forwtypecache);
TMP5602[11].typ = (&NTI171705);
TMP5602[11].name = "forwTypeCache";
TMP5604[11] = &TMP5602[12];
TMP5602[12].kind = 1;
TMP5602[12].offset = offsetof(tcgen367029, Declaredthings);
TMP5602[12].typ = (&NTI168043);
TMP5602[12].name = "declaredThings";
TMP5604[12] = &TMP5602[13];
TMP5602[13].kind = 1;
TMP5602[13].offset = offsetof(tcgen367029, Declaredprotos);
TMP5602[13].typ = (&NTI168043);
TMP5602[13].name = "declaredProtos";
TMP5604[13] = &TMP5602[14];
TMP5602[14].kind = 1;
TMP5602[14].offset = offsetof(tcgen367029, Headerfiles);
TMP5602[14].typ = (&NTI109020);
TMP5602[14].name = "headerFiles";
TMP5604[14] = &TMP5602[15];
TMP5602[15].kind = 1;
TMP5602[15].offset = offsetof(tcgen367029, Typeinfomarker);
TMP5602[15].typ = (&NTI168043);
...
TMP5602[18].kind = 1;
TMP5602[18].offset = offsetof(tcproc367025, Prc);
TMP5602[18].typ = (&NTI171657);
TMP5602[18].name = "prc";
TMP5605[1] = &TMP5602[19];
TMP5602[19].kind = 1;
TMP5602[19].offset = offsetof(tcproc367025, Beforeretneeded);
TMP5602[19].typ = (&NTI133);
TMP5602[19].name = "BeforeRetNeeded";
TMP5605[2] = &TMP5602[20];
TMP5602[20].kind = 1;
TMP5602[20].offset = offsetof(tcproc367025, Threadvaraccessed);
TMP5602[20].typ = (&NTI133);
TMP5602[20].name = "ThreadVarAccessed";
TMP5605[3] = &TMP5602[21];
TMP5602[21].kind = 1;
TMP5602[21].offset = offsetof(tcproc367025, Nestedtrystmts);
TMP5602[21].typ = (&NTI171653);
TMP5602[21].name = "nestedTryStmts";
TMP5605[4] = &TMP5602[22];
TMP5602[22].kind = 1;
TMP5602[22].offset = offsetof(tcproc367025, Inexceptblock);
TMP5602[22].typ = (&NTI105);
TMP5602[22].name = "inExceptBlock";
TMP5605[5] = &TMP5602[23];
TMP5602[23].kind = 1;
TMP5602[23].offset = offsetof(tcproc367025, Labels);
TMP5602[23].typ = (&NTI1005);
...
TMP5602[26].kind = 1;
TMP5602[26].offset = offsetof(tblock367023, Id);
TMP5602[26].typ = (&NTI105);
TMP5602[26].name = "id";
TMP5606[1] = &TMP5602[27];
TMP5602[27].kind = 1;
TMP5602[27].offset = offsetof(tblock367023, Label);
...
NTI367017.flags = 2;
TMP5602[28].kind = 1;
TMP5602[28].offset = offsetof(tblock367023, Sections);
TMP5602[28].typ = (&NTI367017);
TMP5602[28].name = "sections";
TMP5606[3] = &TMP5602[29];
TMP5602[29].kind = 1;
TMP5602[29].offset = offsetof(tblock367023, Isloop);
TMP5602[29].typ = (&NTI133);
TMP5602[29].name = "isLoop";
TMP5606[4] = &TMP5602[30];
TMP5602[30].kind = 1;
TMP5602[30].offset = offsetof(tblock367023, Nestedtrystmts);
TMP5602[30].typ = (&NTI109);
TMP5602[30].name = "nestedTryStmts";
TMP5606[5] = &TMP5602[31];
TMP5602[31].kind = 1;
TMP5602[31].offset = offsetof(tblock367023, Framelen);
TMP5602[31].typ = (&NTI109);
TMP5602[31].name = "frameLen";
TMP5602[25].len = 6; TMP5602[25].kind = 2; TMP5602[25].sons = &TMP5606[0];
NTI367023.node = &TMP5602[25];
NTI367090.size = sizeof(TY367090*);
NTI367090.kind = 24;
NTI367090.base = (&NTI367023);
NTI367090.flags = 2;
NTI367090.marker = TMP5607;
TMP5602[24].kind = 1;
TMP5602[24].offset = offsetof(tcproc367025, Blocks);
TMP5602[24].typ = (&NTI367090);
TMP5602[24].name = "blocks";
TMP5605[7] = &TMP5602[32];
TMP5602[32].kind = 1;
TMP5602[32].offset = offsetof(tcproc367025, Breakidx);
TMP5602[32].typ = (&NTI105);
TMP5602[32].name = "breakIdx";
TMP5605[8] = &TMP5602[33];
TMP5602[33].kind = 1;
TMP5602[33].offset = offsetof(tcproc367025, Options);
TMP5602[33].typ = (&NTI114104);
TMP5602[33].name = "options";
TMP5605[9] = &TMP5602[34];
TMP5602[34].kind = 1;
TMP5602[34].offset = offsetof(tcproc367025, Maxframelen);
TMP5602[34].typ = (&NTI105);
TMP5602[34].name = "maxFrameLen";
TMP5605[10] = &TMP5602[35];
TMP5602[35].kind = 1;
TMP5602[35].offset = offsetof(tcproc367025, Module);
TMP5602[35].typ = (&NTI367019);
TMP5602[35].name = "module";
TMP5605[11] = &TMP5602[36];
TMP5602[36].kind = 1;
TMP5602[36].offset = offsetof(tcproc367025, Withinloop);
TMP5602[36].typ = (&NTI105);
TMP5602[36].name = "withinLoop";
TMP5605[12] = &TMP5602[37];
TMP5602[37].kind = 1;
TMP5602[37].offset = offsetof(tcproc367025, Gcframeid);
TMP5602[37].typ = (&NTI1005);
TMP5602[37].name = "gcFrameId";
TMP5605[13] = &TMP5602[38];
TMP5602[38].kind = 1;
TMP5602[38].offset = offsetof(tcproc367025, Gcframetype);
TMP5602[38].typ = (&NTI121005);
TMP5602[38].name = "gcFrameType";
TMP5602[17].len = 14; TMP5602[17].kind = 2; TMP5602[17].sons = &TMP5605[0];
NTI367025.node = &TMP5602[17];
NTI367021.size = sizeof(tcproc367025*);
NTI367021.kind = 22;
NTI367021.base = (&NTI367025);
NTI367021.marker = TMP5608;
TMP5602[16].kind = 1;
TMP5602[16].offset = offsetof(tcgen367029, Initproc);
TMP5602[16].typ = (&NTI367021);
TMP5602[16].name = "initProc";
TMP5604[16] = &TMP5602[39];
TMP5602[39].kind = 1;
TMP5602[39].offset = offsetof(tcgen367029, Postinitproc);
TMP5602[39].typ = (&NTI367021);
TMP5602[39].name = "postInitProc";
TMP5604[17] = &TMP5602[40];
TMP5602[40].kind = 1;
TMP5602[40].offset = offsetof(tcgen367029, Preinitproc);
TMP5602[40].typ = (&NTI367021);
TMP5602[40].name = "preInitProc";
TMP5604[18] = &TMP5602[41];
TMP5602[41].kind = 1;
TMP5602[41].offset = offsetof(tcgen367029, Typestack);
TMP5602[41].typ = (&NTI171691);
TMP5602[41].name = "typeStack";
TMP5604[19] = &TMP5602[42];
TMP5602[42].kind = 1;
TMP5602[42].offset = offsetof(tcgen367029, Datacache);
TMP5602[42].typ = (&NTI171717);
TMP5602[42].name = "dataCache";
TMP5604[20] = &TMP5602[43];
TMP5602[43].kind = 1;
TMP5602[43].offset = offsetof(tcgen367029, Forwardedprocs);
TMP5602[43].typ = (&NTI171661);
TMP5602[43].name = "forwardedProcs";
TMP5604[21] = &TMP5602[44];
TMP5602[44].kind = 1;
TMP5602[44].offset = offsetof(tcgen367029, Typenodes);
TMP5602[44].typ = (&NTI105);
TMP5602[44].name = "typeNodes";
TMP5604[22] = &TMP5602[45];
TMP5602[45].kind = 1;
TMP5602[45].offset = offsetof(tcgen367029, Nimtypes);
TMP5602[45].typ = (&NTI105);
TMP5602[45].name = "nimTypes";
TMP5604[23] = &TMP5602[46];
TMP5602[46].kind = 1;
TMP5602[46].offset = offsetof(tcgen367029, Typenodesname);
TMP5602[46].typ = (&NTI121005);
TMP5602[46].name = "typeNodesName";
TMP5604[24] = &TMP5602[47];
TMP5602[47].kind = 1;
TMP5602[47].offset = offsetof(tcgen367029, Nimtypesname);
TMP5602[47].typ = (&NTI121005);
TMP5602[47].name = "nimTypesName";
TMP5604[25] = &TMP5602[48];
TMP5602[48].kind = 1;
TMP5602[48].offset = offsetof(tcgen367029, Labels);
TMP5602[48].typ = (&NTI1005);
