...
STRING_LITERAL(TMP7009, "$1 -> $2;$n", 11);
static NIM_CONST TY171865 TMP7010 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7011, "sons", 4);
STRING_LITERAL(TMP7014, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP7015, "", 0);
STRING_LITERAL(TMP7016, "dot", 3);
...
N_NIMCALL(void, adddependencyaux_414019)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	appf_121085(&gdotgraph_414016, ((NimStringDesc*) &TMP7009), LOC1, 2);	popFrame();
}
static N_INLINE(NI, sonslen_172022)(tnode171659* n) {
	NI result;
...
static TNimNode TMP7007[1];
NTI414011.size = sizeof(tgen414011);
NTI414011.kind = 17;
NTI414011.base = (&NTI222003);
NTI414011.flags = 2;
TMP7007[0].kind = 1;
TMP7007[0].offset = offsetof(tgen414011, Module);
TMP7007[0].typ = (&NTI171657);
TMP7007[0].name = "module";
NTI414011.node = &TMP7007[0];
NTI414013.size = sizeof(tgen414011*);
NTI414013.kind = 22;
NTI414013.base = (&NTI414011);
NTI414013.flags = 2;
NTI414013.marker = TMP7017;
}
