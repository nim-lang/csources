...
static NIM_CONST TY171865 TMP3820 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3821, "sons", 4);
static NIM_CONST TY171865 TMP3822 = {
...
static NIM_CONST TY171865 TMP3843 = {
...
N_NIMCALL(tnode171659*, semnodekindconstraints_276393)(tnode171659* p) {
	...
	nimln(124, "parampatterns.nim");
	{
		...
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_138369((*p).Info, ((NimStringDesc*) &TMP3842));		}		LA14: ;
	}	goto LA5;
	LA8: ;
	{
...
N_NIMCALL(NIM_BOOL, matchnodekinds_277175)(tnode171659* p, tnode171659* n) {
	...
	while (1) {
		...
		case ((NU8) 4):
		{
			...
			stack[((NI64)(TMP3851))- 0] = !(stack[((NI64)(TMP3852))- 0]);
		}		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(251, "parampatterns.nim");
			TMP3853 = addInt(pc, 1);
			if ((NU)((NI64)(TMP3853)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3853)])), ((NU8) 0), ((NU8) 22)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3854)])), ((NU8) 0), ((NU8) 153)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
