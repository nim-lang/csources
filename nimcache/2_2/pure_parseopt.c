...
N_NIMCALL(void, handleshortoption_416876)(toptparser416607* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_416802((*p).Cmd, i, &(*p).Val, TMP7033);
	}	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser416607* p) {
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_416802((*p).Cmd, i, &(*p).Key, TMP7034);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_416802((*p).Cmd, i, &(*p).Val, TMP7033);
			}			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_416802((*p).Cmd, i, &(*p).Key, TMP7033);
	}	break;
	}
	BeforeRet: ;	popFrame();
}
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(toptparser416607* p) {
	...
	LOC1 = 0;
	LOC1 = copyStrLast((*p).Cmd, (*p).Pos, (NI64)(TMP7035));
...
TMP7037[0] = &TMP7026[1];
TMP7026[1].kind = 1;
TMP7026[1].offset = offsetof(toptparser416607, Cmd);
TMP7026[1].typ = (&NTI142);
TMP7026[1].name = "cmd";
TMP7037[1] = &TMP7026[2];
TMP7026[2].kind = 1;
TMP7026[2].offset = offsetof(toptparser416607, Pos);
TMP7026[2].typ = (&NTI105);
TMP7026[2].name = "pos";
TMP7037[2] = &TMP7026[3];
TMP7026[3].kind = 1;
TMP7026[3].offset = offsetof(toptparser416607, Inshortstate);
...
NTI416605.node = &TMP7026[9];
TMP7026[4].kind = 1;
TMP7026[4].offset = offsetof(toptparser416607, Kind);
TMP7026[4].typ = (&NTI416605);
TMP7026[4].name = "kind";
TMP7037[4] = &TMP7026[10];
TMP7026[10].kind = 1;
TMP7026[10].offset = offsetof(toptparser416607, Key);
TMP7026[10].typ = (&NTI142);
TMP7026[10].name = "key";
TMP7037[5] = &TMP7026[11];
TMP7026[11].kind = 1;
TMP7026[11].offset = offsetof(toptparser416607, Val);
TMP7026[11].typ = (&NTI142);
TMP7026[11].name = "val";
TMP7026[0].len = 6; TMP7026[0].kind = 2; TMP7026[0].sons = &TMP7037[0];
NTI416607.node = &TMP7026[0];
}
