...
N_NIMCALL(void, definesymbol_142006)(NimStringDesc* symbol) {
	...
	nstPut(gsymbols_142003, symbol, ((NimStringDesc*) &TMP893));	popFrame();
}
N_NIMCALL(void, undefsymbol_142011)(NimStringDesc* symbol) {
...
N_NIMCALL(NI, countdefinedsymbols_142041)(void) {
	...
	while (1) {
		...
		nimln(41, "strtabs.nim");
		{
			...
			{
				nimln(38, "condsyms.nim");
				if (!eqStrings(val_142045, ((NimStringDesc*) &TMP893))) goto LA8;
				nimln(38, "condsyms.nim");
...
N_NIMCALL(void, initdefines_142065)(void) {
	...
	definesymbol_142006(((NimStringDesc*) &TMP895));	nimln(44, "condsyms.nim");
	definesymbol_142006(((NimStringDesc*) &TMP896));	nimln(45, "condsyms.nim");
	definesymbol_142006(((NimStringDesc*) &TMP897));	nimln(46, "condsyms.nim");
	definesymbol_142006(((NimStringDesc*) &TMP898));	nimln(47, "condsyms.nim");
	definesymbol_142006(((NimStringDesc*) &TMP899));	nimln(48, "condsyms.nim");
	definesymbol_142006(((NimStringDesc*) &TMP900));	nimln(49, "condsyms.nim");
	definesymbol_142006(((NimStringDesc*) &TMP901));	nimln(52, "condsyms.nim");
	switch (targetcpu_119560) {
	case ((NU8) 1):
	{
		nimln(53, "condsyms.nim");
		definesymbol_142006(((NimStringDesc*) &TMP902));	}	break;
	case ((NU8) 8):
	{
	...
	case ((NU8) 2):
	{
		...
		definesymbol_142006(((NimStringDesc*) &TMP906));		nimln(62, "condsyms.nim");
	...
	case ((NU8) 20):
	{
		...
		definesymbol_142006(((NimStringDesc*) &TMP908));		nimln(67, "condsyms.nim");
		definesymbol_142006(((NimStringDesc*) &TMP909));	}	break;
	case ((NU8) 7):
	{
		nimln(69, "condsyms.nim");
		definesymbol_142006(((NimStringDesc*) &TMP910));		nimln(70, "condsyms.nim");
		definesymbol_142006(((NimStringDesc*) &TMP908));		nimln(71, "condsyms.nim");
		definesymbol_142006(((NimStringDesc*) &TMP909));	}	break;
	case ((NU8) 9):
	case ((NU8) 10):
	case ((NU8) 11):
	{
		...
		definesymbol_142006(((NimStringDesc*) &TMP908));		nimln(74, "condsyms.nim");
		definesymbol_142006(((NimStringDesc*) &TMP911));		nimln(75, "condsyms.nim");
		definesymbol_142006(((NimStringDesc*) &TMP909));	}	break;
	case ((NU8) 18):
	{
		nimln(77, "condsyms.nim");
		definesymbol_142006(((NimStringDesc*) &TMP912));	}	break;
	case ((NU8) 19):
	{
		nimln(79, "condsyms.nim");
		definesymbol_142006(((NimStringDesc*) &TMP912));		nimln(80, "condsyms.nim");
		definesymbol_142006(((NimStringDesc*) &TMP908));		nimln(81, "condsyms.nim");
		definesymbol_142006(((NimStringDesc*) &TMP909));	}	break;
	default:
	{
	}	break;
...
appendString(LOC13, LOC14);
	...
	definesymbol_142006(os_119061[(targetos_119562)- 1].Field0);	nimln(87, "condsyms.nim");
	{
		...
		definesymbol_142006(((NimStringDesc*) &TMP914));	}	LA18: ;
	popFrame();
