...
appendString((*result), ind);
		...
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI32)(TMP3877), lvltochar_279241[((*n).Level)- 0]);
...
NTI279012.node = &TMP3864[67];
TMP3864[1].kind = 1;
TMP3864[1].offset = offsetof(trstnode279018, Kind);
TMP3864[1].typ = (&NTI279012);
TMP3864[1].name = "kind";
TMP3866[1] = &TMP3864[68];
TMP3864[68].kind = 1;
TMP3864[68].offset = offsetof(trstnode279018, Text);
TMP3864[68].typ = (&NTI142);
TMP3864[68].name = "text";
TMP3866[2] = &TMP3864[69];
TMP3864[69].kind = 1;
TMP3864[69].offset = offsetof(trstnode279018, Level);
TMP3864[69].typ = (&NTI105);
TMP3864[69].name = "level";
TMP3866[3] = &TMP3864[70];
TMP3864[70].kind = 1;
TMP3864[70].offset = offsetof(trstnode279018, Sons);
TMP3864[70].typ = (&NTI279093);
TMP3864[70].name = "sons";
TMP3864[0].len = 4; TMP3864[0].kind = 2; TMP3864[0].sons = &TMP3866[0];
NTI279018.node = &TMP3864[0];
NTI279014.size = sizeof(trstnode279018*);
NTI279014.kind = 22;
NTI279014.base = (&NTI279018);
NTI279014.flags = 2;
NTI279014.marker = TMP3871;
}
