...
extern tsocketimpl123605* stdoutsocket_137084;
	...
	while (1) {
		...
		case ((NU8) 3):
		{
			...
			nimln(43, "service.nim");
			{
				...
				key = copyStrLast(p.Key, 0, (NI32)(TMP7046));
				...
				LOC9 = 0;
				LOC9 = copyStr(p.Key, (NI32)(TMP7047));
...
appendString(LOC8, p.Val);
				...
				processswitch_151016(key, val, pass, gcmdlineinfo_137009);			}			goto LA4;
			LA6: ;
			{
				nimln(48, "service.nim");
				processswitch_151016(p.Key, p.Val, pass, gcmdlineinfo_137009);			}			LA4: ;
		}		break;
		case ((NU8) 1):
		{
...
N_NIMCALL(void, serve_418277)(TY418279 action) {
	...
	LA2: ;
	{
		...
		if (stdoutsocket_137084) nimGCunrefNoCycle(stdoutsocket_137084);
		stdoutsocket_137084 = (tsocketimpl123605*) newObjRC1((&NTI123607), sizeof(tsocketimpl123605));
		nimln(93, "service.nim");
		while (1) {
			NimStringDesc* LOC21;
			nimln(94, "service.nim");
			accept_127201(server, &stdoutsocket_137084);			nimln(95, "service.nim");
			readline_131830(stdoutsocket_137084, &inp, -1);			nimln(67, "service.nim");
			LOC21 = 0;
			...
			send_133404(stdoutsocket_137084, ((NimStringDesc*) &TMP7082));			nimln(98, "service.nim");
			close_127258(stdoutsocket_137084);		}	}	goto LA4;
	LA3: ;
	{
	...
	LOC1 = 0;
	LOC1 = curcaascmd_418203; curcaascmd_418203 = copyStringRC1(((NimStringDesc*) &TMP7041));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(25, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_418204; lastcaascmd_418204 = copyStringRC1(((NimStringDesc*) &TMP7041));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(28, "service.nim");
	LOC3 = 0;
	LOC3 = arguments_418205; arguments_418205 = copyStringRC1(((NimStringDesc*) &TMP7041));
