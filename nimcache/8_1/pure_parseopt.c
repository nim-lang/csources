...
N_NIMCALL(NI, parseword_416802)(NimStringDesc* s, NI i, NimStringDesc** w, TY112118 delim);
...
N_NIMCALL(void, initoptparser_416619)(NimStringDesc* cmdline, toptparser416607* Result) {
	...
	LA3: ;
	{
		...
		HEX3Atmp_416634 = paramcount_106029();
...
N_NIMCALL(void, handleshortoption_416876)(toptparser416607* p) {
	...
	nimln(82, "parseopt.nim");
	{
		...
		i = parseword_416802((*p).Cmd, i, &(*p).Val, TMP7038);
	}	LA4: ;
...
N_NIMCALL(void, nponext)(toptparser416607* p) {
	...
	case 45:
	{
		...
		nimln(107, "parseopt.nim");
		{
			...
			i = parseword_416802((*p).Cmd, i, &(*p).Key, TMP7039);
			...
			nimln(112, "parseopt.nim");
			{
				...
				(*p).Pos = parseword_416802((*p).Cmd, i, &(*p).Val, TMP7038);
			}			goto LA13;
			LA15: ;
			{
	...
	default:
	{
		...
		(*p).Pos = parseword_416802((*p).Cmd, i, &(*p).Key, TMP7038);
	}	break;
	}
	BeforeRet: ;	popFrame();
}
...
TMP7042[0] = &TMP7032[1];
TMP7032[1].kind = 1;
TMP7032[1].offset = offsetof(toptparser416607, Cmd);
TMP7032[1].typ = (&NTI142);
TMP7032[1].name = "cmd";
TMP7042[1] = &TMP7032[2];
TMP7032[2].kind = 1;
TMP7032[2].offset = offsetof(toptparser416607, Pos);
TMP7032[2].typ = (&NTI105);
TMP7032[2].name = "pos";
TMP7042[2] = &TMP7032[3];
TMP7032[3].kind = 1;
TMP7032[3].offset = offsetof(toptparser416607, Inshortstate);
...
NTI416605.node = &TMP7032[9];
TMP7032[4].kind = 1;
TMP7032[4].offset = offsetof(toptparser416607, Kind);
TMP7032[4].typ = (&NTI416605);
TMP7032[4].name = "kind";
TMP7042[4] = &TMP7032[10];
TMP7032[10].kind = 1;
TMP7032[10].offset = offsetof(toptparser416607, Key);
TMP7032[10].typ = (&NTI142);
TMP7032[10].name = "key";
TMP7042[5] = &TMP7032[11];
TMP7032[11].kind = 1;
TMP7032[11].offset = offsetof(toptparser416607, Val);
TMP7032[11].typ = (&NTI142);
TMP7032[11].name = "val";
TMP7032[0].len = 6; TMP7032[0].kind = 2; TMP7032[0].sons = &TMP7042[0];
NTI416607.node = &TMP7032[0];
}
