...
N_NIMCALL(void, setintlittype_216430)(tnode171659* result);
...
static NIM_CONST TY171865 TMP3047 = {
...
N_NIMCALL(tsym171689*, getsyssym_216037)(NimStringDesc* name) {
	...
	if (!(((64 &(1<<(((*systemmodule_216014).Kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3023));
	nimln(39, "magicsys.nim");
	LOC1 = 0;
...
N_NIMCALL(ttype171693*, getsystype_216021)(NU8 kind) {
	...
	nimln(63, "magicsys.nim");
	{
		...
		case ((NU8) 39):
		{
			...
			result = systypefromname_216173(((NimStringDesc*) &TMP3037));
		}		break;
		case ((NU8) 1):
		{
			nimln(79, "magicsys.nim");
			result = systypefromname_216173(((NimStringDesc*) &TMP3038));
		}		break;
		case ((NU8) 2):
		{
			nimln(80, "magicsys.nim");
			result = systypefromname_216173(((NimStringDesc*) &TMP3039));
		}		break;
		case ((NU8) 28):
		{
			nimln(81, "magicsys.nim");
			result = systypefromname_216173(((NimStringDesc*) &TMP3040));
		}		break;
		case ((NU8) 29):
		{
			nimln(82, "magicsys.nim");
			result = systypefromname_216173(((NimStringDesc*) &TMP3041));
		}		break;
		case ((NU8) 26):
		{
			nimln(83, "magicsys.nim");
			result = systypefromname_216173(((NimStringDesc*) &TMP3042));
		}		break;
		case ((NU8) 5):
		{
			nimln(84, "magicsys.nim");
			result = newsystype_216066(((NU8) 5), ptrsize_118579);
		}		break;
		default:
		{
			NimStringDesc* LOC26;
...
N_NIMCALL(ttype171693*, getintlittype_216317)(tnode171659* literal) {
	...
	nimln(106, "magicsys.nim");
	{
		...
		result = inttypecache_216243[(((NI)chckRange64(value, (-2147483647 -1), 2147483647)))- -5];
		nimln(108, "magicsys.nim");
		{
			...
			if (((NI)chckRange64(value, (-2147483647 -1), 2147483647)) < -5 || ((NI)chckRange64(value, (-2147483647 -1), 2147483647)) > 64) raiseIndexError();
			asgnRefNoCycle((void**) &inttypecache_216243[(((NI)chckRange64(value, (-2147483647 -1), 2147483647)))- -5], result);
		}		LA9: ;
	}	goto LA1;
	LA5: ;
	{
...
N_NIMCALL(void, setintlittype_216430)(tnode171659* result) {
	...
	default:
	{
		...
		internalerror_138369((*result).Info, ((NimStringDesc*) &TMP3049));	}	break;
	}
	popFrame();
}
N_NIMCALL(tsym171689*, getcompilerproc_216025)(NimStringDesc* name) {
