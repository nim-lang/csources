...
static NIM_CONST TY171865 TMP3824 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3825, "strVal", 6);
static NIM_CONST TY171865 TMP3826 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3827, "sons", 4);
static NIM_CONST TY171865 TMP3828 = {
...
static NIM_CONST TY171865 TMP3849 = {
...
N_NIMCALL(tnode171659*, semnodekindconstraints_276393)(tnode171659* p) {
	...
	nimln(124, "parampatterns.nim");
	{
		...
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_138369((*p).Info, ((NimStringDesc*) &TMP3848));		}		LA14: ;
	}	goto LA5;
	LA8: ;
	{
...
N_NIMCALL(NIM_BOOL, matchnodekinds_277175)(tnode171659* p, tnode171659* n) {
	...
	while (1) {
		...
		case ((NU8) 2):
		{
			...
			LOC4 = stack[((NI32)(TMP3852))- 0];
			if (LOC4) goto LA5;
			nimln(239, "parampatterns.nim");
			TMP3853 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3853)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI32)(TMP3853))- 0];
			LA5: ;
			stack[((NI32)(TMP3851))- 0] = LOC4;
		...
		case ((NU8) 3):
		{
			...
			nimln(242, "parampatterns.nim");
			TMP3854 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3854)) > (NU)(64)) raiseIndexError();
			nimln(242, "parampatterns.nim");
			LOC7 = 0;
			nimln(242, "parampatterns.nim");
			TMP3855 = subInt(sp, 1);
			if ((NU)((NI32)(TMP3855)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI32)(TMP3855))- 0];
			if (!(LOC7)) goto LA8;
			nimln(242, "parampatterns.nim");
			TMP3856 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3856)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI32)(TMP3856))- 0];
			LA8: ;
			stack[((NI32)(TMP3854))- 0] = LOC7;
		...
		case ((NU8) 4):
		{
			...
			nimln(244, "parampatterns.nim");
			TMP3857 = subInt(sp, 1);
			if ((NU)((NI32)(TMP3857)) > (NU)(64)) raiseIndexError();
			nimln(244, "parampatterns.nim");
			nimln(244, "parampatterns.nim");
			TMP3858 = subInt(sp, 1);
			if ((NU)((NI32)(TMP3858)) > (NU)(64)) raiseIndexError();
			stack[((NI32)(TMP3857))- 0] = !(stack[((NI32)(TMP3858))- 0]);
		}		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(251, "parampatterns.nim");
			TMP3859 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3859)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3859)])), ((NU8) 0), ((NU8) 22)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			nimln(255, "parampatterns.nim");
			TMP3860 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3860)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3860)])), ((NU8) 0), ((NU8) 153)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
	...
	nimln(263, "parampatterns.nim");
	TMP3861 = subInt(sp, 1);
	if ((NU)((NI32)(TMP3861)) > (NU)(64)) raiseIndexError();
	result = stack[((NI32)(TMP3861))- 0];
	popFrame();
	return result;
