...
static N_INLINE(void, setid_170432)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP1939 = addInt(id, 1);
	gfrontendid_170006 = ((gfrontendid_170006 >= (NI32)(TMP1939)) ? gfrontendid_170006 : (NI32)(TMP1939));
	popFrame();
}
static N_INLINE(NI, divInt)(NI a, NI b) {
	NI result;
