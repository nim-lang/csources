...
NIM_CONST tpass222015 docgen2pass_415073 = {myopen_415051,
NIM_NIL,
processnode_415043,
close_415013}
;
...
N_NIMCALL(tnode171659*, close_415013)(tpasscontext222003* p, tnode171659* n) {
	...
	nimln(25, "docgen2.nim");
	{
		...
		nimln(913, "ast.nim");
		LOC7 = 0;
		LOC7 = tofilename_137700(((NI32) ((*(*g).Module).Position)));
		writeoutput_310043((*g).Doc, LOC7, ((NimStringDesc*) &TMP7027), usewarning);		nimln(27, "docgen2.nim");
...
N_NIMCALL(tpasscontext222003*, myopen_415051)(tsym171689* module) {
	...
	nimln(913, "ast.nim");
	LOC1 = 0;
	LOC1 = tofilename_137700(((NI32) ((*module).Position)));
	d = newdocumentor_307038(LOC1, gconfigvars_113194);
...
TMP7026[0] = &TMP7024[1];
TMP7024[1].kind = 1;
TMP7024[1].offset = offsetof(tgen415007, Doc);
TMP7024[1].typ = (&NTI307007);
TMP7024[1].name = "doc";
TMP7026[1] = &TMP7024[2];
TMP7024[2].kind = 1;
TMP7024[2].offset = offsetof(tgen415007, Module);
TMP7024[2].typ = (&NTI171657);
TMP7024[2].name = "module";
TMP7024[0].len = 2; TMP7024[0].kind = 2; TMP7024[0].sons = &TMP7026[0];
NTI415007.node = &TMP7024[0];
NTI415009.size = sizeof(tgen415007*);
NTI415009.kind = 22;
NTI415009.base = (&NTI415007);
NTI415009.flags = 2;
NTI415009.marker = TMP7029;
}
