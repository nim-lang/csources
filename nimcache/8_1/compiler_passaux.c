...
NIM_NIL}
;
static NIM_CONST TY171865 TMP7008 = {
...
N_NIMCALL(tnode171659*, verboseprocess_413013)(tpasscontext222003* context, tnode171659* n) {
	...
	nimln(22, "passaux.nim");
	{
		...
		nimln(22, "passaux.nim");
		internalerror_138383(((NimStringDesc*) &TMP7007));	}	LA3: ;
	nimln(23, "passaux.nim");
	{
		...
		gnotes_137073 |=((NI64)(1)<<(((((NU16) 254)- 222))%(sizeof(NI64)*8)));
