...
typedef N_NIMCALL_PTR(NIM_BOOL, tcompareproc108022) (tlistentry108014* entry, void* closure);
...
N_NIMCALL(tstrentry108016*, newstrentry_108236)(NimStringDesc* data);
...
N_NIMCALL(void, prepend_108269)(tlinkedlist108020* list, tlistentry108014* entry);
N_NIMCALL(void, prependstr_108415)(tlinkedlist108020* list, NimStringDesc* data);
N_NIMCALL(void, insertbefore_108422)(tlinkedlist108020* list, tlistentry108014* pos, tlistentry108014* entry);
...
N_NIMCALL(tlistentry108014*, find_108825)(tlinkedlist108020 list, tcompareproc108022 fn, void* closure);
...
TNimType NTI108014; /* TListEntry */
TNimType NTI108012; /* PListEntry */
TNimType NTI108016; /* TStrEntry */
extern TNimType NTI142; /* string */
TNimType NTI108018; /* PStrEntry */
TNimType NTI108020; /* TLinkedList */
...
N_NIMCALL(NIM_BOOL, contains_108215)(tlinkedlist108020 list, NimStringDesc* data) {
	...
	while (1) {
		...
		{
			nimln(45, "lists.nim");
			if (it) chckObj((*it).Sup.m_type, (&NTI108016));
			if (!eqStrings((*((tstrentry108016*) (it))).Data, data)) goto LA4;
			nimln(46, "lists.nim");
			nimln(46, "lists.nim");
			result = NIM_TRUE;
			goto BeforeRet;
...
N_NIMCALL(tstrentry108016*, newstrentry_108236)(NimStringDesc* data) {
	tstrentry108016* result;
	NimStringDesc* LOC1;
	nimfr("newStrEntry", "lists.nim")
	result = 0;
	nimln(50, "lists.nim");
	result = (tstrentry108016*) newObj((&NTI108018), sizeof(tstrentry108016));
	(*result).Sup.Sup.m_type = (&NTI108016);
	nimln(51, "lists.nim");
	LOC1 = 0;
...
N_NIMCALL(void, appendstr_108254)(tlinkedlist108020* list, NimStringDesc* data) {
	tstrentry108016* LOC1;
	nimfr("AppendStr", "lists.nim")
	nimln(54, "lists.nim");
	nimln(54, "lists.nim");
	LOC1 = 0;
	LOC1 = newstrentry_108236(data);
	append_108039(list, &LOC1->Sup);	popFrame();
}
N_NIMCALL(NIM_BOOL, includestr_108261)(tlinkedlist108020* list, NimStringDesc* data) {
	NIM_BOOL result;
	...
	nimln(57, "lists.nim");
	{
		...
		nimln(57, "lists.nim");
		LOC3 = 0;
		LOC3 = contains_108215((*list), data);
		if (!LOC3) goto LA4;
		nimln(57, "lists.nim");
		nimln(57, "lists.nim");
		result = NIM_TRUE;
	...
	nimln(58, "lists.nim");
	appendstr_108254(list, data);	BeforeRet: ;	popFrame();
	return result;
}
N_NIMCALL(void, prepend_108269)(tlinkedlist108020* list, tlistentry108014* entry) {
...
N_NIMCALL(void, prependstr_108415)(tlinkedlist108020* list, NimStringDesc* data) {
	...
	LOC1 = 0;
	LOC1 = newstrentry_108236(data);
	prepend_108269(list, &LOC1->Sup);	popFrame();
}
N_NIMCALL(void, insertbefore_108422)(tlinkedlist108020* list, tlistentry108014* pos, tlistentry108014* entry) {
	...
	nimln(75, "lists.nim");
	{
		...
		nimln(76, "lists.nim");
		prepend_108269(list, entry);	}	goto LA5;
	LA7: ;
	{
		nimln(78, "lists.nim");
		(*list).Counter = addInt((*list).Counter, 1);
...
N_NIMCALL(void, bringtofront_108699)(tlinkedlist108020* list, tlistentry108014* entry) {
	...
	nimln(95, "lists.nim");
	remove_108636(list, entry);	nimln(96, "lists.nim");
	prepend_108269(list, entry);	popFrame();
}
N_NIMCALL(void, excludestr_108803)(tlinkedlist108020* list, NimStringDesc* data) {
	tlistentry108014* it;
...
NTI108014.size = sizeof(tlistentry108014);
NTI108014.kind = 17;
NTI108014.base = (&NTI1009);
TMP261[0] = &TMP258[1];
NTI108012.size = sizeof(tlistentry108014*);
NTI108012.kind = 22;
NTI108012.base = (&NTI108014);
NTI108012.marker = TMP262;
TMP258[1].kind = 1;
TMP258[1].offset = offsetof(tlistentry108014, Prev);
TMP258[1].typ = (&NTI108012);
TMP258[1].name = "prev";
TMP261[1] = &TMP258[2];
TMP258[2].kind = 1;
TMP258[2].offset = offsetof(tlistentry108014, Next);
TMP258[2].typ = (&NTI108012);
TMP258[2].name = "next";
TMP258[0].len = 2; TMP258[0].kind = 2; TMP258[0].sons = &TMP261[0];
NTI108014.node = &TMP258[0];
NTI108016.size = sizeof(tstrentry108016);
NTI108016.kind = 17;
NTI108016.base = (&NTI108014);
NTI108016.flags = 2;
TMP258[3].kind = 1;
TMP258[3].offset = offsetof(tstrentry108016, Data);
TMP258[3].typ = (&NTI142);
TMP258[3].name = "data";
NTI108016.node = &TMP258[3];
NTI108018.size = sizeof(tstrentry108016*);
NTI108018.kind = 22;
NTI108018.base = (&NTI108016);
NTI108018.flags = 2;
NTI108018.marker = TMP263;
NTI108020.size = sizeof(tlinkedlist108020);
NTI108020.kind = 18;
NTI108020.base = 0;
NTI108020.flags = 2;
TMP3582[0] = &TMP258[5];
TMP258[5].kind = 1;
TMP258[5].offset = offsetof(tlinkedlist108020, Head);
TMP258[5].typ = (&NTI108012);
TMP258[5].name = "head";
TMP3582[1] = &TMP258[6];
TMP258[6].kind = 1;
TMP258[6].offset = offsetof(tlinkedlist108020, Tail);
TMP258[6].typ = (&NTI108012);
TMP258[6].name = "tail";
TMP3582[2] = &TMP258[7];
TMP258[7].kind = 1;
TMP258[7].offset = offsetof(tlinkedlist108020, Counter);
TMP258[7].typ = (&NTI105);
TMP258[7].name = "Counter";
TMP258[4].len = 3; TMP258[4].kind = 2; TMP258[4].sons = &TMP3582[0];
NTI108020.node = &TMP258[4];
}
