...
N_NIMCALL(trstnode278018*, lastson_278145)(trstnode278018* n) {
	...
	if ((NU)((NI32)(TMP3862)) >= (NU)((*n).Sons->Sup.len)) raiseIndexError();
	result = (*n).Sons->data[(NI32)(TMP3862)];
	popFrame();
	return result;
}
static N_INLINE(void, asgnRefNoCycle)(void** dest, void* src) {
...
appendString((*result), ind);
		...
		if ((NU)((*n).Level) > (NU)(8)) raiseIndexError();
		lvl = nsuRepeatChar((NI32)(TMP3867), lvltochar_278241[((*n).Level)- 0]);
...
appendString((*result), ind);
		...
		LOC10 = 0;
		LOC10 = nsuRepeatChar((NI32)(TMP3869), 45);
...
appendString((*result), ((NimStringDesc*) &TMP3872));
	...
	case ((NU8) 14):
	{
		...
		l = (((NI32)(TMP3873) >= 30) ? (NI32)(TMP3873) : 30);
...
appendString((*result), tmp);
		...
		TMP3875 = subInt((NI32)(TMP3874), 2);
		LOC30 = 0;
		LOC30 = nsuRepeatChar((NI32)(TMP3875), 32);
