...
STRING_LITERAL(TMP7039, "server.type", 11);
STRING_LITERAL(TMP7040, "stdin", 5);
STRING_LITERAL(TMP7041, "tcp", 3);
STRING_LITERAL(TMP7042, "quit", 4);
STRING_LITERAL(TMP7047, "server.port", 11);
STRING_LITERAL(TMP7048, "server.address", 14);
STRING_LITERAL(TMP7073, "\015\012", 2);
STRING_LITERAL(TMP7074, "Invalid server.type:", 20);
...
extern tsocketimpl124605* stdoutsocket_137084;
	...
	while (1) {
		...
		case ((NU8) 3):
		{
			...
			nimln(43, "service.nim");
			{
				...
				nimln(44, "service.nim");
				nimln(44, "service.nim");
				TMP7037 = subInt(bracketle, 1);
				key = copyStrLast(p.Key, 0, (NI32)(TMP7037));
				nimln(45, "service.nim");
				nimln(45, "service.nim");
				LOC8 = 0;
				nimln(45, "service.nim");
				nimln(45, "service.nim");
				TMP7038 = addInt(bracketle, 1);
				LOC9 = 0;
				LOC9 = copyStr(p.Key, (NI32)(TMP7038));
...
N_NIMCALL(void, serve_418277)(TY418279 action) {
	...
	LA2: ;
	{
		...
		stdoutsocket_137084 = (tsocketimpl124605*) newObjRC1((&NTI124607), sizeof(tsocketimpl124605));
		nimln(93, "service.nim");
		while (1) {
			NimStringDesc* LOC21;
			nimln(94, "service.nim");
			accept_128201(server, &stdoutsocket_137084);			nimln(95, "service.nim");
			readline_132830(stdoutsocket_137084, &inp, -1);			nimln(67, "service.nim");
			LOC21 = 0;
			...
			send_134204(stdoutsocket_137084, ((NimStringDesc*) &TMP7073));			nimln(98, "service.nim");
			close_128258(stdoutsocket_137084);		}	}	goto LA4;
	LA3: ;
	{
	...
	LOC1 = 0;
	LOC1 = curcaascmd_418203; curcaascmd_418203 = copyStringRC1(((NimStringDesc*) &TMP7032));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(25, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_418204; lastcaascmd_418204 = copyStringRC1(((NimStringDesc*) &TMP7032));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	nimln(28, "service.nim");
	LOC3 = 0;
	LOC3 = arguments_418205; arguments_418205 = copyStringRC1(((NimStringDesc*) &TMP7032));
