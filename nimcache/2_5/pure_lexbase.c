...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4630, "L.sentinel < L.bufLen ", 22);
STRING_LITERAL(TMP4633, "0 <= toCopy ", 12);
STRING_LITERAL(TMP4641, "s < L.bufLen ", 13);
STRING_LITERAL(TMP4645, "L.bufLen - oldBufLen == oldBufLen ", 34);
STRING_LITERAL(TMP4651, "pos <= L.sentinel ", 18);
STRING_LITERAL(TMP4653, "L.buf[pos] == \'\\x0D\' ", 21);
STRING_LITERAL(TMP4654, "L.buf[pos] == \'\\x0A\' ", 21);
STRING_LITERAL(TMP4655, "0 < bufLen ", 11);
STRING_LITERAL(TMP4656, "not (input == nil) ", 19);
STRING_LITERAL(TMP4660, "", 0);
STRING_LITERAL(TMP4661, "\012", 1);
STRING_LITERAL(TMP4662, "^\012", 2);
...
N_NIMCALL(void, fillbuffer_291071)(tbaselexer291016* l) {
	...
	nimln(77, "lexbase.nim");
	{
		...
		nimln(77, "lexbase.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP4630));	}	LA3: ;
	nimln(78, "lexbase.nim");
	nimln(78, "lexbase.nim");
	nimln(78, "lexbase.nim");
	TMP4631 = subInt((*l).Buflen, (*l).Sentinel);
	TMP4632 = subInt((NI32)(TMP4631), 1);
	tocopy = (NI32)(TMP4632);
	nimln(79, "lexbase.nim");
	{
		...
		nimln(79, "lexbase.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP4633));	}	LA7: ;
	nimln(80, "lexbase.nim");
	{
		...
		memmove(((void*) ((*l).Buf)), ((void*) (&(*l).Buf[(NI32)(TMP4634)])), (NI32)(TMP4635));	}	LA11: ;
	...
	TMP4637 = mulInt((NI32)(TMP4636), 1);
	LOC13 = 0;
	LOC13 = readdata_143731((*l).Input, ((void*) (&(*l).Buf[tocopy])), (NI32)(TMP4637));
	TMP4638 = divInt(LOC13, 1);
	charsread = (NI32)(TMP4638);
	...
	nimln(86, "lexbase.nim");
	{
		...
		if (!(charsread < (NI32)(TMP4640))) goto LA16;
	...
	LA16: ;
	{
		...
		while (1) {
			nimln(93, "lexbase.nim");
			{
				...
				nimln(93, "lexbase.nim");
				hiddenraiseassert_76217(((NimStringDesc*) &TMP4641));			}			LA22: ;
			...
			LA29: ;
			{
				...
				(*l).Buflen = (NI32)(TMP4642);
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				nimln(104, "lexbase.nim");
				TMP4643 = mulInt((*l).Buflen, 1);
				LOC32 = 0;
				LOC32 = realloc_4007(((void*) ((*l).Buf)), (NI32)(TMP4643));
				...
				nimln(105, "lexbase.nim");
				{
					...
					if (!!(((NI32)(TMP4644) == oldbuflen))) goto LA35;
					nimln(105, "lexbase.nim");
					hiddenraiseassert_76217(((NimStringDesc*) &TMP4645));				}				LA35: ;
				...
				LOC37 = 0;
				LOC37 = readdata_143731((*l).Input, ((void*) (&(*l).Buf[oldbuflen])), (NI32)(TMP4646));
				TMP4647 = divInt(LOC37, 1);
				charsread = (NI32)(TMP4647);
...
N_NIMCALL(NI, fillbaselexer_291812)(tbaselexer291016* l, NI pos) {
	...
	nimln(115, "lexbase.nim");
	{
		...
		nimln(115, "lexbase.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP4651));	}	LA3: ;
...
N_NIMCALL(NI, handlecr_291049)(tbaselexer291016* l, NI pos) {
	...
	nimln(125, "lexbase.nim");
	{
		...
		nimln(125, "lexbase.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP4653));	}	LA3: ;
...
N_NIMCALL(void, open_291026)(tbaselexer291016* l, tstream143629* input, NI buflen) {
	...
	nimln(143, "lexbase.nim");
	{
		...
		nimln(143, "lexbase.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP4656));	}	LA7: ;
	...
	LOC9 = 0;
	LOC9 = alloc_4001((NI32)(TMP4657));
	(*l).Buf = ((NCSTRING) (LOC9));
	nimln(148, "lexbase.nim");
	nimln(148, "lexbase.nim");
	TMP4658 = subInt(buflen, 1);
	(*l).Sentinel = (NI32)(TMP4658);
...
N_NIMCALL(NI, getcolnumber_291044)(tbaselexer291016* l, NI pos) {
	...
	nimln(155, "lexbase.nim");
	nimln(155, "lexbase.nim");
	TMP4659 = subInt(pos, (*l).Linestart);
	if ((NI32)(TMP4659) == (-2147483647 -1)) raiseOverflow();
	result = (NI32)abs((NI32)(TMP4659));
	popFrame();
	return result;
}
static N_INLINE(void, appendString)(NimStringDesc* dest, NimStringDesc* src) {
...
N_NIMCALL(NimStringDesc*, getcurrentline_291039)(tbaselexer291016* l, NIM_BOOL marker) {
	...
	result = copyString(((NimStringDesc*) &TMP4660));
...
appendString(LOC6, ((NimStringDesc*) &TMP4662));
...
static TNimNode* TMP4769[8];
static TNimNode TMP4628[9];
...
TMP4769[0] = &TMP4628[1];
TMP4628[1].kind = 1;
TMP4628[1].offset = offsetof(tbaselexer291016, Bufpos);
TMP4628[1].typ = (&NTI105);
TMP4628[1].name = "bufpos";
TMP4769[1] = &TMP4628[2];
TMP4628[2].kind = 1;
TMP4628[2].offset = offsetof(tbaselexer291016, Buf);
TMP4628[2].typ = (&NTI144);
TMP4628[2].name = "buf";
TMP4769[2] = &TMP4628[3];
TMP4628[3].kind = 1;
TMP4628[3].offset = offsetof(tbaselexer291016, Buflen);
TMP4628[3].typ = (&NTI105);
TMP4628[3].name = "bufLen";
TMP4769[3] = &TMP4628[4];
TMP4628[4].kind = 1;
TMP4628[4].offset = offsetof(tbaselexer291016, Input);
TMP4628[4].typ = (&NTI143627);
TMP4628[4].name = "input";
TMP4769[4] = &TMP4628[5];
TMP4628[5].kind = 1;
TMP4628[5].offset = offsetof(tbaselexer291016, Linenumber);
TMP4628[5].typ = (&NTI105);
TMP4628[5].name = "LineNumber";
TMP4769[5] = &TMP4628[6];
TMP4628[6].kind = 1;
TMP4628[6].offset = offsetof(tbaselexer291016, Sentinel);
TMP4628[6].typ = (&NTI105);
TMP4628[6].name = "sentinel";
TMP4769[6] = &TMP4628[7];
TMP4628[7].kind = 1;
TMP4628[7].offset = offsetof(tbaselexer291016, Linestart);
TMP4628[7].typ = (&NTI105);
TMP4628[7].name = "lineStart";
TMP4769[7] = &TMP4628[8];
TMP4628[8].kind = 1;
TMP4628[8].offset = offsetof(tbaselexer291016, Fileopened);
TMP4628[8].typ = (&NTI133);
TMP4628[8].name = "fileOpened";
TMP4628[0].len = 8; TMP4628[0].kind = 2; TMP4628[0].sons = &TMP4769[0];
NTI291016.node = &TMP4628[0];
}
