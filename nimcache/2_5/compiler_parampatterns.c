...
static NIM_CONST TY172865 TMP3818 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3819, "strVal", 6);
static NIM_CONST TY172865 TMP3820 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3821, "sons", 4);
static NIM_CONST TY172865 TMP3822 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3823, "ident", 5);
STRING_LITERAL(TMP3824, "|", 1);
STRING_LITERAL(TMP3825, "&", 1);
STRING_LITERAL(TMP3826, "~", 1);
STRING_LITERAL(TMP3827, "atom", 4);
STRING_LITERAL(TMP3828, "lit", 3);
STRING_LITERAL(TMP3829, "sym", 3);
STRING_LITERAL(TMP3830, "ident", 5);
STRING_LITERAL(TMP3831, "call", 4);
STRING_LITERAL(TMP3832, "alias", 5);
STRING_LITERAL(TMP3833, "noalias", 7);
STRING_LITERAL(TMP3834, "lvalue", 6);
STRING_LITERAL(TMP3835, "local", 5);
STRING_LITERAL(TMP3836, "sideeffect", 10);
STRING_LITERAL(TMP3837, "nosideeffect", 12);
STRING_LITERAL(TMP3839, "compiler/parampatterns.nim", 26);
NIM_CONST TY76088 TMP3838 = {((NimStringDesc*) &TMP3839),
100}
;
NIM_CONST TY76088 TMP3840 = {((NimStringDesc*) &TMP3839),
107}
;
STRING_LITERAL(TMP3841, "p.Kind == nkCurlyExpr ", 22);
STRING_LITERAL(TMP3842, "parameter pattern too complex", 29);
static NIM_CONST TY172865 TMP3843 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3844, "sym", 3);
...
N_NIMCALL(NU8, whichalias_277058)(tsym172689* p) {
	...
	nimln(51, "parampatterns.nim");
	{
		...
		nimln(52, "parampatterns.nim");
		if (!(((TMP3818[(*(*p).Constraint).Kind/8] &(1<<((*(*p).Constraint).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3819));
...
static N_INLINE(NI, len_173102)(tnode172659* n) {
	...
	{
		nimln(873, "ast.nim");
		if (((TMP3820[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3821));
...
N_NIMCALL(void, compileconstraints_277094)(tnode172659* p, NimStringDesc** result) {
	...
	case ((NU8) 32):
	{
		...
		nimln(59, "parampatterns.nim");
		{
			nimln(698, "system.nim");
			nimln(698, "system.nim");
			if (((TMP3820[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3821));
		...
		if (((TMP3820[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3821));
		if ((NU)(0) >= (NU)((*p).kindU.S6.Sons->Sup.len)) raiseIndexError();
		if (!(((TMP3822[(*(*p).kindU.S6.Sons->data[0]).Kind/8] &(1<<((*(*p).kindU.S6.Sons->data[0]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3823));
		...
		nimln(63, "parampatterns.nim");
		{
			...
			nimln(64, "parampatterns.nim");
			{
				...
				LOC13 = 0;
				nimln(64, "parampatterns.nim");
				LOC13 = eqStrings((*op).S, ((NimStringDesc*) &TMP3824));
				if (LOC13) goto LA14;
				nimln(64, "parampatterns.nim");
				LOC13 = ((*op).Sup.Id == 48);
				LA14: ;
			...
			LA15: ;
			{
				...
				LOC18 = 0;
				nimln(68, "parampatterns.nim");
				LOC18 = eqStrings((*op).S, ((NimStringDesc*) &TMP3825));
				if (LOC18) goto LA19;
				nimln(68, "parampatterns.nim");
				LOC18 = ((*op).Sup.Id == 2);
				LA19: ;
		...
		LA9: ;
		{
			...
			LOC27 = 0;
			nimln(74, "parampatterns.nim");
			LOC27 = eqStrings((*op).S, ((NimStringDesc*) &TMP3826));
			if (LOC27) goto LA28;
			nimln(74, "parampatterns.nim");
			LOC27 = ((*op).Sup.Id == 44);
			LA28: ;
	...
	case ((NU8) 2):
	{
		...
		if (!(((TMP3822[(*p).Kind/8] &(1<<((*p).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3823));
		spec = nsuNormalize((*(*p).kindU.S5.Ident).S);
		nimln(86, "parampatterns.nim");
		switch (hashString(spec) & 15) {
		case 1: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3837))) goto LA50;
break;
		case 3: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3833))) goto LA46;
if (eqStrings(spec, ((NimStringDesc*) &TMP3834))) goto LA47;
if (eqStrings(spec, ((NimStringDesc*) &TMP3836))) goto LA49;
break;
		case 4: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3829))) goto LA42;
break;
		case 6: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3830))) goto LA43;
if (eqStrings(spec, ((NimStringDesc*) &TMP3835))) goto LA48;
break;
		case 11: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3827))) goto LA40;
break;
		case 12: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3828))) goto LA41;
break;
		case 13: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3831))) goto LA44;
break;
		case 14: 
if (eqStrings(spec, ((NimStringDesc*) &TMP3832))) goto LA45;
break;
		}
		goto LA51;
		LA40: ;
...
N_NIMCALL(tnode172659*, semnodekindconstraints_277393)(tnode172659* p) {
	...
	nimln(120, "parampatterns.nim");
	{
		...
		nimln(120, "parampatterns.nim");
		hiddenraiseassert_76217(((NimStringDesc*) &TMP3841));	}	LA3: ;
	nimln(121, "parampatterns.nim");
	result = newnodei_172940(((NU8) 20), (*p).Info);
	nimln(122, "parampatterns.nim");
	if (!(((TMP3818[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3819));
	nimln(122, "parampatterns.nim");
	...
	nimln(124, "parampatterns.nim");
	{
		...
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_139369((*p).Info, ((NimStringDesc*) &TMP3842));		}		LA14: ;
	}	goto LA5;
	LA8: ;
	{
...
N_NIMCALL(NU8, checkforsideeffects_277708)(tnode172659* n) {
	...
	case ((NU8) 32):
	{
		...
		nimln(143, "parampatterns.nim");
		{
			...
			if (!(LOC4)) goto LA5;
			nimln(143, "parampatterns.nim");
			if (!(((TMP3843[(*op).Kind/8] &(1<<((*op).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3844));
...
N_NIMCALL(NU8, isassignable_277902)(tsym172689* owner, tnode172659* n) {
	...
	case ((NU8) 3):
	{
		...
		{
			nimln(730, "system.nim");
			if (!(((TMP3843[(*n).Kind/8] &(1<<((*n).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3844));
	...
	case ((NU8) 45):
	{
		...
		nimln(197, "parampatterns.nim");
		{
			...
			if (!(((TMP3843[(*(*n).kindU.S6.Sons->data[1]).Kind/8] &(1<<((*(*n).kindU.S6.Sons->data[1]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3844));
...
N_NIMCALL(NIM_BOOL, matchnodekinds_278175)(tnode172659* p, tnode172659* n) {
	...
	while (1) {
		...
		case ((NU8) 2):
		{
			...
			nimln(239, "parampatterns.nim");
			TMP3845 = subInt(sp, 2);
			if ((NU)((NI32)(TMP3845)) > (NU)(64)) raiseIndexError();
			nimln(239, "parampatterns.nim");
			LOC4 = 0;
			nimln(239, "parampatterns.nim");
			TMP3846 = subInt(sp, 1);
			if ((NU)((NI32)(TMP3846)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI32)(TMP3846))- 0];
			if (LOC4) goto LA5;
			nimln(239, "parampatterns.nim");
			TMP3847 = subInt(sp, 2);
		...
		case ((NU8) 4):
		{
			...
			stack[((NI32)(TMP3851))- 0] = !(stack[((NI32)(TMP3852))- 0]);
		}		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(251, "parampatterns.nim");
			TMP3853 = addInt(pc, 1);
			if ((NU)((NI32)(TMP3853)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3853)])), ((NU8) 0), ((NU8) 22)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			kind = ((NU8)chckRange(((NU8)(code->data[(NI32)(TMP3854)])), ((NU8) 0), ((NU8) 153)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
	...
	nimln(263, "parampatterns.nim");
	TMP3855 = subInt(sp, 1);
	if ((NU)((NI32)(TMP3855)) > (NU)(64)) raiseIndexError();
	result = stack[((NI32)(TMP3855))- 0];
	popFrame();
	return result;
