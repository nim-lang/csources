...
static N_INLINE(NI, nexttry_117405)(NI h, NI maxhash) {
	...
	nimln(70, "tables.nim");
	TMP378 = mulInt(5, h);
	TMP379 = addInt((NI64)(TMP378), 1);
	result = (NI)((NI64)(TMP379) & maxhash);
	popFrame();
	return result;
}N_NIMCALL(void, TMP797)(void* p, NI op) {
...
N_NIMCALL(void, enlarge_136840)(ttable136540* t) {
	...
	n = (tkeyvaluepairseq136543*) newSeq((&NTI136543), (NI64)(TMP810));
	i_136879 = 0;
	HEX3Atmp_136934 = 0;
...
N_NIMCALL(void, enlarge_219767)(ttable219029* t) {
	...
	n = (tkeyvaluepairseq219032*) newSeq((&NTI219032), (NI64)(TMP3098));
	i_219806 = 0;
	HEX3Atmp_219861 = 0;
	nimln(117, "tables.nim");
	nimln(117, "tables.nim");
...
N_NIMCALL(void, enlarge_220197)(ttable219059* t) {
	...
	n = (tkeyvaluepairseq219062*) newSeq((&NTI219062), (NI64)(TMP3107));
	i_220236 = 0;
	HEX3Atmp_220291 = 0;
	nimln(117, "tables.nim");
	nimln(117, "tables.nim");
...
TMP798[0] = &TMP370[9];
TMP370[9].kind = 1;
TMP370[9].offset = offsetof(ttable136540, Data);
TMP370[9].typ = (&NTI136543);
TMP370[9].name = "data";
TMP798[1] = &TMP370[10];
TMP370[10].kind = 1;
TMP370[10].offset = offsetof(ttable136540, Counter);
TMP370[10].typ = (&NTI105);
TMP370[10].name = "counter";
TMP370[8].len = 2; TMP370[8].kind = 2; TMP370[8].sons = &TMP798[0];
NTI136540.node = &TMP370[8];
...
TMP3083[0] = &TMP370[12];
TMP370[12].kind = 1;
TMP370[12].offset = offsetof(tkeyvaluepair219065, Field0);
TMP370[12].typ = (&NTI117005);
TMP370[12].name = "Field0";
TMP3083[1] = &TMP370[13];
TMP370[13].kind = 1;
TMP370[13].offset = offsetof(tkeyvaluepair219065, Field1);
TMP370[13].typ = (&NTI219009);
TMP370[13].name = "Field1";
TMP3083[2] = &TMP370[14];
TMP370[14].kind = 1;
TMP370[14].offset = offsetof(tkeyvaluepair219065, Field2);
TMP370[14].typ = (&NTI219007);
TMP370[14].name = "Field2";
TMP370[11].len = 3; TMP370[11].kind = 2; TMP370[11].sons = &TMP3083[0];
NTI219065.node = &TMP370[11];
NTI219062.size = sizeof(tkeyvaluepairseq219062*);
NTI219062.kind = 24;
NTI219062.base = (&NTI219065);
NTI219062.flags = 2;
NTI219062.marker = TMP3089;
...
TMP3090[0] = &TMP370[16];
TMP370[16].kind = 1;
TMP370[16].offset = offsetof(ttable219059, Data);
TMP370[16].typ = (&NTI219062);
TMP370[16].name = "data";
TMP3090[1] = &TMP370[17];
TMP370[17].kind = 1;
TMP370[17].offset = offsetof(ttable219059, Counter);
TMP370[17].typ = (&NTI105);
TMP370[17].name = "counter";
TMP370[15].len = 2; TMP370[15].kind = 2; TMP370[15].sons = &TMP3090[0];
NTI219059.node = &TMP370[15];
...
TMP3096[0] = &TMP370[23];
TMP370[23].kind = 1;
TMP370[23].offset = offsetof(ttable219029, Data);
TMP370[23].typ = (&NTI219032);
TMP370[23].name = "data";
TMP3096[1] = &TMP370[24];
TMP370[24].kind = 1;
TMP370[24].offset = offsetof(ttable219029, Counter);
TMP370[24].typ = (&NTI105);
TMP370[24].name = "counter";
TMP370[22].len = 2; TMP370[22].kind = 2; TMP370[22].sons = &TMP3096[0];
NTI219029.node = &TMP370[22];
}
