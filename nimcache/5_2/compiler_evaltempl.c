...
static NIM_CONST TY171865 TMP3446 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3447, "sym", 3);
static NIM_CONST TY171865 TMP3448 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3449, "sons", 4);
STRING_LITERAL(TMP3451, "compiler/evaltempl.nim", 22);
NIM_CONST TY75888 TMP3450 = {((NimStringDesc*) &TMP3451),
34}
;
...
N_NIMCALL(void, evaltemplateaux_251012)(tnode171659* templ, tnode171659* actual, templctx251007* c, tnode171659* result) {
	...
	case ((NU8) 3):
	{
		...
		nimln(26, "evaltempl.nim");
		{
			...
			nimln(27, "evaltempl.nim");
			{
				...
				if (((TMP3448[(*actual).Kind/8] &(1<<((*actual).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3449));
	...
	default:
	{
		...
		TMP3452 = subInt(LOC35, 1);
		HEX3Atmp_251118 = (NI64)(TMP3452);
		...
		while (1) {
			...
			if (((TMP3448[(*templ).Kind/8] &(1<<((*templ).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3449));
...
N_NIMCALL(tnode171659*, evaltemplateargs_251201)(tnode171659* n, tsym171689* s) {
	...
	nimln(86, "evaltempl.nim");
	{
		...
		if (!(f < a)) goto LA5;
		nimln(86, "evaltempl.nim");
		globalerror_138336((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP3453));	}	LA5: ;
	...
	while (1) {
		...
		{
			nimln(90, "evaltempl.nim");
			if (((TMP3448[(*(*(*s).Typ).N).Kind/8] &(1<<((*(*(*s).Typ).N).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3449));
			if ((NU)(i_251218) >= (NU)((*(*(*s).Typ).N).kindU.S6.Sons->Sup.len)) raiseIndexError();
			if (!(((TMP3446[(*(*(*(*s).Typ).N).kindU.S6.Sons->data[i_251218]).Kind/8] &(1<<((*(*(*(*s).Typ).N).kindU.S6.Sons->data[i_251218]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3447));
		...
		nimln(91, "evaltempl.nim");
		{
			...
			localerror_138349((*n).Info, ((NU16) 133), ((NimStringDesc*) &TMP3453));		}		LA17: ;
...
N_NIMCALL(tnode171659*, evaltemplate_251285)(tnode171659* n, tsym171689* tmpl, tsym171689* gensymowner) {
	...
	nimln(100, "evaltempl.nim");
	{
		...
		globalerror_138336((*n).Info, ((NU16) 183), ((NimStringDesc*) &TMP3453));		nimln(102, "evaltempl.nim");
		result = n;
	}	LA3: ;
	...
	nimln(112, "evaltempl.nim");
	{
		...
		evaltemplateaux_251012(body, args, &ctx, result);		nimln(115, "evaltempl.nim");
		{
			...
			nimln(115, "evaltempl.nim");
			if (((TMP3448[(*result).Kind/8] &(1<<((*result).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3449));
	...
	LA8: ;
	{
		...
		TMP3455 = subInt(LOC18, 1);
		HEX3Atmp_251353 = (NI64)(TMP3455);
		nimln(1301, "system.nim");
		res_251355 = 0;
		nimln(1302, "system.nim");
		while (1) {
			...
			if (((TMP3448[(*body).Kind/8] &(1<<((*body).Kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3449));
