...
static NIM_CONST TY171865 TMP3825 = {
...
static NIM_CONST TY171865 TMP3846 = {
...
N_NIMCALL(tnode171659*, semnodekindconstraints_276393)(tnode171659* p) {
	...
	nimln(124, "parampatterns.nim");
	{
		...
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_138369((*p).Info, ((NimStringDesc*) &TMP3845));		}		LA14: ;
	}	goto LA5;
	LA8: ;
	{
...
N_NIMCALL(NIM_BOOL, matchnodekinds_277175)(tnode171659* p, tnode171659* n) {
	...
	while (1) {
		...
		case ((NU8) 2):
		{
			...
			LOC4 = stack[((NI64)(TMP3849))- 0];
			if (LOC4) goto LA5;
			nimln(239, "parampatterns.nim");
			TMP3850 = subInt(sp, 2);
			if ((NU)((NI64)(TMP3850)) > (NU)(64)) raiseIndexError();
			LOC4 = stack[((NI64)(TMP3850))- 0];
			LA5: ;
			stack[((NI64)(TMP3848))- 0] = LOC4;
		...
		case ((NU8) 3):
		{
			...
			LOC7 = stack[((NI64)(TMP3852))- 0];
			if (!(LOC7)) goto LA8;
			nimln(242, "parampatterns.nim");
			TMP3853 = subInt(sp, 2);
			if ((NU)((NI64)(TMP3853)) > (NU)(64)) raiseIndexError();
			LOC7 = stack[((NI64)(TMP3853))- 0];
			LA8: ;
			stack[((NI64)(TMP3851))- 0] = LOC7;
		...
		case ((NU8) 4):
		{
			...
			stack[((NI64)(TMP3854))- 0] = !(stack[((NI64)(TMP3855))- 0]);
		}		break;
		case ((NU8) 5):
		{
		...
		case ((NU8) 10):
		{
			...
			nimln(251, "parampatterns.nim");
			TMP3856 = addInt(pc, 1);
			if ((NU)((NI64)(TMP3856)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3856)])), ((NU8) 0), ((NU8) 22)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
		...
		case ((NU8) 11):
		{
			...
			nimln(255, "parampatterns.nim");
			TMP3857 = addInt(pc, 1);
			if ((NU)((NI64)(TMP3857)) > (NU)(code->Sup.len)) raiseIndexError();
			kind = ((NU8)chckRange(((NU8)(code->data[(NI64)(TMP3857)])), ((NU8) 0), ((NU8) 153)));
			nimln(230, "parampatterns.nim");
			if ((NU)(sp) > (NU)(64)) raiseIndexError();
