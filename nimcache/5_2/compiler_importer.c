...
static NIM_CONST TY171865 TMP3610 = {
...
N_NIMCALL(NimStringDesc*, getmodulename_265012)(tnode171659* n) {
	...
	case ((NU8) 29):
	{
		...
		nimln(31, "importer.nim");
		{
			...
			nimln(31, "importer.nim");
			LOC9 = 0;
			LOC9 = getident_140443(((NimStringDesc*) &TMP3612));
	...
	strtableadd_178078(&(*(*c).Importtable).Symbols, s);	nimln(71, "importer.nim");
	{
		...
		nimln(73, "importer.nim");
		{
			...
			while (1) {
				...
				if (!(((TMP3608[(*(*(*etyp).N).kindU.S6.Sons->data[j_265258]).Kind/8] &(1<<((*(*(*etyp).N).kindU.S6.Sons->data[j_265258]).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3609));
				...
				nimln(76, "importer.nim");
				{
					...
					internalerror_138369((*s).Info, ((NimStringDesc*) &TMP3619));				}				LA25: ;
...
N_NIMCALL(void, importsymbol_265334)(tcontext262019* c, tnode171659* n, tsym171689* frommod) {
	...
	LA3: ;
	{
		...
		nimln(102, "importer.nim");
		{
			...
			internalerror_138369((*n).Info, ((NimStringDesc*) &TMP3621));		}		LA12: ;
		...
		case ((NU8) 15):
		{
			...
			while (1) {
				...
				nimln(111, "importer.nim");
				{
					...
					nimln(111, "importer.nim");
					internalerror_138369((*n).Info, ((NimStringDesc*) &TMP3622));				}				LA18: ;
...
N_NIMCALL(void, importforwarded_265511)(tcontext262019* c, tnode171659* n, tintset168043* exceptset) {
	...
	case ((NU8) 117):
	{
		...
		while (1) {
			...
			if (!(((TMP3608[(*a_265524).Kind/8] &(1<<((*a_265524).Kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3609));
	...
	case ((NU8) 118):
	{
		...
		localerror_138349((*n).Info, ((NU16) 4), ((NimStringDesc*) &TMP3625));	}	break;
	default:
	{
		NI i_265630;
		NI HEX3Atmp_265648;
...
N_NIMCALL(tsym171689*, importmoduleas_265656)(tnode171659* n, tsym171689* realmodule) {
	...
	LA3: ;
	{
		...
		localerror_138349((*n).Info, ((NU16) 4), ((NimStringDesc*) &TMP3627));	}	goto LA1;
	LA9: ;
	{
		nimln(698, "system.nim");
		nimln(698, "system.nim");
